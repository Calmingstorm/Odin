...
... (truncated)`:s}function kd(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function eg(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function M_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const P_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=te(()=>{const D=e.value.uptime_seconds||0,J=Math.floor(D/86400),$=Math.floor(D%86400/3600),V=Math.floor(D%3600/60),N=[];return J>0&&N.push(`${J}d`),$>0&&N.push(`${$}h`),(N.length===0||J===0&&$===0)&&N.push(`${V}m`),N.join(" ")}),p=te(()=>{const D=e.value.uptime_seconds||0;return 125.66*(1-Math.min(D/86400,1))}),m=te(()=>{const D=e.value;return[{label:"Guilds",value:D.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:D.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:D.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${D.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:D.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:D.loop_count>0?"text-green-400":"",highlight:D.loop_count>0},{label:"Agents",value:D.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:D.agent_count>0?`${D.agent_count} total`:"",subColor:"text-gray-500",highlight:(D.agent_running??0)>0},{label:"Processes",value:D.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:D.process_count>0?`${D.process_count} total`:"",subColor:"text-gray-500",highlight:(D.process_running??0)>0},{label:"Schedules",value:D.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(D.schedule_failing>0?`${D.schedule_failing} failing`:"")+(D.schedule_failing>0&&D.schedule_paused>0?", ":"")+(D.schedule_paused>0?`${D.schedule_paused} paused`:"")||void 0,subColor:D.schedule_failing>0?"text-red-400":"text-yellow-400",color:D.schedule_failing>0?"text-red-400":"",highlight:D.schedule_failing>0},{label:"Users",value:D.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=te(()=>{const D=e.value,J=[];return J.push({label:"Bot",status:D.status==="online"?"ok":"warn",detail:D.status==="online"?"Online":"Starting"}),(D.schedule_failing||0)>0?J.push({label:"Schedules",status:"error",detail:`${D.schedule_failing} failing`}):(D.schedule_count||0)>0&&J.push({label:"Schedules",status:"ok",detail:`${D.schedule_count} configured`}),(D.loop_count||0)>0&&J.push({label:"Loops",status:"ok",detail:`${D.loop_count} active`}),(D.agent_running||0)>0&&J.push({label:"Agents",status:"ok",detail:`${D.agent_running} running`}),(D.process_running||0)>0&&J.push({label:"Processes",status:"ok",detail:`${D.process_running} running`}),J});async function k(){try{e.value=await G.get("/api/status"),s.value=null}catch(D){s.value=D.message}finally{t.value=!1}}async function T(){a.value=!0;try{n.value=await G.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function b(){l.value=!0;try{i.value=await G.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function v(){try{const D=await G.get("/api/knowledge");c.value=(Array.isArray(D)?D:[]).reduce((J,$)=>J+($.chunks||0),0)}catch{c.value=null}}async function x(){try{const D=await G.get("/api/agents");r.value=D.filter(J=>J.status==="running")}catch{}}async function C(){u.value={...u.value,reload:!0};try{await G.post("/api/reload"),ke.success("Config reloaded")}catch(D){ke.error(D.message)}u.value={...u.value,reload:!1}}async function I(){if(!await is({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const J=e.value.session_count;e.value={...e.value,session_count:0};try{const $=await G.post("/api/sessions/clear-all");ke.success(`Cleared ${$.count} session${$.count!==1?"s":""}`),await k()}catch($){e.value={...e.value,session_count:J},ke.error($.message)}u.value={...u.value,clearSessions:!1}}async function O(){if(!await is({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const J=e.value.loop_count;e.value={...e.value,loop_count:0};try{const $=await G.post("/api/loops/stop-all");ke.success($.result),await k()}catch($){e.value={...e.value,loop_count:J},ke.error($.message)}u.value={...u.value,stopLoops:!1}}function S(){t.value=!0,s.value=null,k(),T(),b(),x()}let R=null,L=null,B=null;function P(D){if(D.payload&&D.payload.tool_name){const J={...D.payload,_isNew:!0,_key:++d};n.value.unshift(J),n.value.length>10&&n.value.pop(),o.value++,J.error&&(i.value.unshift(J),i.value.length>5&&i.value.pop()),setTimeout(()=>{J._isNew=!1},1500),clearTimeout(B),B=setTimeout(()=>{o.value=0},1e4)}}return Ue(async()=>{await Promise.all([k(),T(),b(),x(),v()]),R=setInterval(k,15e3),L=setInterval(x,1e4),Ge.subscribe("events",P)}),ft(()=>{R&&clearInterval(R),L&&clearInterval(L),clearTimeout(B),Ge.unsubscribe("events",P)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:m,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:T,fetchStatus:k,formatTime:Cc,formatDuration:Ca,retry:S,reloadConfig:C,clearSessions:I,stopAllLoops:O}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function wd(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function F_(e){if(Array.isArray(e))return e}function $_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function U_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function B_(e,t){return F_(e)||$_(e,t)||H_(e,t)||U_()}function H_(e,t){if(e){if(typeof e=="string")return wd(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?wd(e,t):void 0}}const tg=Object.entries,Sd=Object.setPrototypeOf,V_=Object.isFrozen,j_=Object.getPrototypeOf,z_=Object.getOwnPropertyDescriptor;let qt=Object.freeze,hs=Object.seal,na=Object.create,sg=typeof Reflect<"u"&&Reflect,xo=sg.apply,_o=sg.construct;qt||(qt=function(t){return t});hs||(hs=function(t){return t});xo||(xo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});_o||(_o=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Ps=vt(Array.prototype.forEach),K_=vt(Array.prototype.lastIndexOf),Td=vt(Array.prototype.pop),Qn=vt(Array.prototype.push),q_=vt(Array.prototype.splice),Ht=Array.isArray,Ga=vt(String.prototype.toLowerCase),Lr=vt(String.prototype.toString),Cd=vt(String.prototype.match),Xn=vt(String.prototype.replace),Ed=vt(String.prototype.indexOf),G_=vt(String.prototype.trim),W_=vt(Number.prototype.toString),Z_=vt(Boolean.prototype.toString),Ad=typeof BigInt>"u"?null:vt(BigInt.prototype.toString),Rd=typeof Symbol>"u"?null:vt(Symbol.prototype.toString),lt=vt(Object.prototype.hasOwnProperty),Ba=vt(Object.prototype.toString),Et=vt(RegExp.prototype.test),Sn=J_(TypeError);function vt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return xo(e,t,n)}}function J_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return _o(e,s)}}function Oe(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Ga;if(Sd&&Sd(e,null),!Ht(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(V_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function Y_(e){for(let t=0;t<e.length;t++)lt(e,t)||(e[t]=null);return e}function Dt(e){const t=na(null);for(const n of tg(e)){var s=B_(n,2);const a=s[0],i=s[1];lt(e,a)&&(Ht(i)?t[a]=Y_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Dt(i):t[a]=i)}return t}function Q_(e){switch(typeof e){case"string":return e;case"number":return W_(e);case"boolean":return Z_(e);case"bigint":return Ad?Ad(e):"0";case"symbol":return Rd?Rd(e):"Symbol()";case"undefined":return Ba(e);case"function":case"object":{if(e===null)return Ba(e);const t=e,s=Ss(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Ba(n)}return Ba(e)}default:return Ba(e)}}function Ss(e,t){for(;e!==null;){const n=z_(e,t);if(n){if(n.get)return vt(n.get);if(typeof n.value=="function")return vt(n.value)}e=j_(e)}function s(){return null}return s}function X_(e){try{return Et(e,""),!0}catch{return!1}}const Id=qt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Dr=qt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Mr=qt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ek=qt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Pr=qt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),tk=qt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Nd=qt(["#text"]),Od=qt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Fr=qt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Ld=qt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ji=qt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),sk=hs(/{{[\w\W]*|^[\w\W]*}}/g),nk=hs(/<%[\w\W]*|^[\w\W]*%>/g),ak=hs(/\${[\w\W]*/g),ik=hs(/^data-[\-\w.\u00B7-\uFFFF]+$/),lk=hs(/^aria-[\-\w]+$/),Dd=hs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),rk=hs(/^(?:\w+script|data):/i),ok=hs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ck=hs(/^html$/i),uk=hs(/^[a-z][.\w]*(-[.\w]+)+$/i),ks={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},dk=function(){return typeof window>"u"?null:window},fk=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Md=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function ng(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:dk();const t=me=>ng(me);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==ks.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=Ss(f,"cloneNode"),m=Ss(f,"remove"),g=Ss(f,"nextSibling"),k=Ss(f,"childNodes"),T=Ss(f,"parentNode"),b=Ss(f,"shadowRoot"),v=Ss(f,"attributes"),x=l&&l.prototype?Ss(l.prototype,"nodeType"):null,C=l&&l.prototype?Ss(l.prototype,"nodeName"):null;if(typeof i=="function"){const me=s.createElement("template");me.content&&me.content.ownerDocument&&(s=me.content.ownerDocument)}let I,O="",S,R=!1,L=0;const B=function(){if(L>0)throw Sn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},P=function(_){B(),L++;try{return I.createHTML(_)}finally{L--}},D=function(_){B(),L++;try{return I.createScriptURL(_)}finally{L--}},J=function(){return R||(S=fk(d,a),R=!0),S},$=s,V=$.implementation,N=$.createNodeIterator,w=$.createDocumentFragment,z=$.getElementsByTagName,re=n.importNode;let oe=Md();t.isSupported=typeof tg=="function"&&typeof T=="function"&&V&&V.createHTMLDocument!==void 0;const W=sk,he=nk,X=ak,ce=ik,Ne=lk,j=rk,de=ok,le=uk;let ve=Dd,be=null;const Me=Oe({},[...Id,...Dr,...Mr,...Pr,...Nd]);let y=null;const E=Oe({},[...Od,...Fr,...Ld,...Ji]);let M=Object.seal(na(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Z=null,A=null;const F=Object.seal(na(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Y=!0,Q=!0,se=!1,ee=!0,ge=!1,ie=!0,fe=!1,_e=!1,Te=!1,Re=!1,U=!1,ue=!1,xe=!0,K=!1;const ye="user-content-";let Be=!0,bt=!1,st={},Ye=null;const sn=Oe({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let xn=null;const Li=Oe({},["audio","video","img","source","image","track"]);let Na=null;const Di=Oe({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Kn="http://www.w3.org/1998/Math/MathML",qn="http://www.w3.org/2000/svg",Ot="http://www.w3.org/1999/xhtml";let gs=Ot,nn=!1,Oa=null;const Mi=Oe({},[Kn,qn,Ot],Lr);let H=Oe({},["mi","mo","mn","ms","mtext"]),ne=Oe({},["annotation-xml"]);const Ce=Oe({},["title","style","font","a","script"]);let Ke=null;const it=["application/xhtml+xml","text/html"],Gt="text/html";let nt=null,Gn=null;const vg=s.createElement("form"),Fc=function(_){return _ instanceof RegExp||_ instanceof Function},dr=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Gn&&Gn===_)return;(!_||typeof _!="object")&&(_={}),_=Dt(_),Ke=it.indexOf(_.PARSER_MEDIA_TYPE)===-1?Gt:_.PARSER_MEDIA_TYPE,nt=Ke==="application/xhtml+xml"?Lr:Ga,be=lt(_,"ALLOWED_TAGS")&&Ht(_.ALLOWED_TAGS)?Oe({},_.ALLOWED_TAGS,nt):Me,y=lt(_,"ALLOWED_ATTR")&&Ht(_.ALLOWED_ATTR)?Oe({},_.ALLOWED_ATTR,nt):E,Oa=lt(_,"ALLOWED_NAMESPACES")&&Ht(_.ALLOWED_NAMESPACES)?Oe({},_.ALLOWED_NAMESPACES,Lr):Mi,Na=lt(_,"ADD_URI_SAFE_ATTR")&&Ht(_.ADD_URI_SAFE_ATTR)?Oe(Dt(Di),_.ADD_URI_SAFE_ATTR,nt):Di,xn=lt(_,"ADD_DATA_URI_TAGS")&&Ht(_.ADD_DATA_URI_TAGS)?Oe(Dt(Li),_.ADD_DATA_URI_TAGS,nt):Li,Ye=lt(_,"FORBID_CONTENTS")&&Ht(_.FORBID_CONTENTS)?Oe({},_.FORBID_CONTENTS,nt):sn,Z=lt(_,"FORBID_TAGS")&&Ht(_.FORBID_TAGS)?Oe({},_.FORBID_TAGS,nt):Dt({}),A=lt(_,"FORBID_ATTR")&&Ht(_.FORBID_ATTR)?Oe({},_.FORBID_ATTR,nt):Dt({}),st=lt(_,"USE_PROFILES")?_.USE_PROFILES&&typeof _.USE_PROFILES=="object"?Dt(_.USE_PROFILES):_.USE_PROFILES:!1,Y=_.ALLOW_ARIA_ATTR!==!1,Q=_.ALLOW_DATA_ATTR!==!1,se=_.ALLOW_UNKNOWN_PROTOCOLS||!1,ee=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ge=_.SAFE_FOR_TEMPLATES||!1,ie=_.SAFE_FOR_XML!==!1,fe=_.WHOLE_DOCUMENT||!1,Re=_.RETURN_DOM||!1,U=_.RETURN_DOM_FRAGMENT||!1,ue=_.RETURN_TRUSTED_TYPE||!1,Te=_.FORCE_BODY||!1,xe=_.SANITIZE_DOM!==!1,K=_.SANITIZE_NAMED_PROPS||!1,Be=_.KEEP_CONTENT!==!1,bt=_.IN_PLACE||!1,ve=X_(_.ALLOWED_URI_REGEXP)?_.ALLOWED_URI_REGEXP:Dd,gs=typeof _.NAMESPACE=="string"?_.NAMESPACE:Ot,H=lt(_,"MATHML_TEXT_INTEGRATION_POINTS")&&_.MATHML_TEXT_INTEGRATION_POINTS&&typeof _.MATHML_TEXT_INTEGRATION_POINTS=="object"?Dt(_.MATHML_TEXT_INTEGRATION_POINTS):Oe({},["mi","mo","mn","ms","mtext"]),ne=lt(_,"HTML_INTEGRATION_POINTS")&&_.HTML_INTEGRATION_POINTS&&typeof _.HTML_INTEGRATION_POINTS=="object"?Dt(_.HTML_INTEGRATION_POINTS):Oe({},["annotation-xml"]);const q=lt(_,"CUSTOM_ELEMENT_HANDLING")&&_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING=="object"?Dt(_.CUSTOM_ELEMENT_HANDLING):na(null);if(M=na(null),lt(q,"tagNameCheck")&&Fc(q.tagNameCheck)&&(M.tagNameCheck=q.tagNameCheck),lt(q,"attributeNameCheck")&&Fc(q.attributeNameCheck)&&(M.attributeNameCheck=q.attributeNameCheck),lt(q,"allowCustomizedBuiltInElements")&&typeof q.allowCustomizedBuiltInElements=="boolean"&&(M.allowCustomizedBuiltInElements=q.allowCustomizedBuiltInElements),ge&&(Q=!1),U&&(Re=!0),st&&(be=Oe({},Nd),y=na(null),st.html===!0&&(Oe(be,Id),Oe(y,Od)),st.svg===!0&&(Oe(be,Dr),Oe(y,Fr),Oe(y,Ji)),st.svgFilters===!0&&(Oe(be,Mr),Oe(y,Fr),Oe(y,Ji)),st.mathMl===!0&&(Oe(be,Pr),Oe(y,Ld),Oe(y,Ji))),F.tagCheck=null,F.attributeCheck=null,lt(_,"ADD_TAGS")&&(typeof _.ADD_TAGS=="function"?F.tagCheck=_.ADD_TAGS:Ht(_.ADD_TAGS)&&(be===Me&&(be=Dt(be)),Oe(be,_.ADD_TAGS,nt))),lt(_,"ADD_ATTR")&&(typeof _.ADD_ATTR=="function"?F.attributeCheck=_.ADD_ATTR:Ht(_.ADD_ATTR)&&(y===E&&(y=Dt(y)),Oe(y,_.ADD_ATTR,nt))),lt(_,"ADD_URI_SAFE_ATTR")&&Ht(_.ADD_URI_SAFE_ATTR)&&Oe(Na,_.ADD_URI_SAFE_ATTR,nt),lt(_,"FORBID_CONTENTS")&&Ht(_.FORBID_CONTENTS)&&(Ye===sn&&(Ye=Dt(Ye)),Oe(Ye,_.FORBID_CONTENTS,nt)),lt(_,"ADD_FORBID_CONTENTS")&&Ht(_.ADD_FORBID_CONTENTS)&&(Ye===sn&&(Ye=Dt(Ye)),Oe(Ye,_.ADD_FORBID_CONTENTS,nt)),Be&&(be["#text"]=!0),fe&&Oe(be,["html","head","body"]),be.table&&(Oe(be,["tbody"]),delete Z.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ae=I;I=_.TRUSTED_TYPES_POLICY;try{O=P("")}catch(Se){throw I=ae,Se}}else _.TRUSTED_TYPES_POLICY===null?(I=void 0,O=""):(I===void 0&&(I=J()),I&&typeof O=="string"&&(O=P("")));(oe.uponSanitizeElement.length>0||oe.uponSanitizeAttribute.length>0)&&be===Me&&(be=Dt(be)),oe.uponSanitizeAttribute.length>0&&y===E&&(y=Dt(y)),qt&&qt(_),Gn=_},$c=Oe({},[...Dr,...Mr,...ek]),Uc=Oe({},[...Pr,...tk]),bg=function(_){let q=T(_);(!q||!q.tagName)&&(q={namespaceURI:gs,tagName:"template"});const ae=Ga(_.tagName),Se=Ga(q.tagName);return Oa[_.namespaceURI]?_.namespaceURI===qn?q.namespaceURI===Ot?ae==="svg":q.namespaceURI===Kn?ae==="svg"&&(Se==="annotation-xml"||H[Se]):!!$c[ae]:_.namespaceURI===Kn?q.namespaceURI===Ot?ae==="math":q.namespaceURI===qn?ae==="math"&&ne[Se]:!!Uc[ae]:_.namespaceURI===Ot?q.namespaceURI===qn&&!ne[Se]||q.namespaceURI===Kn&&!H[Se]?!1:!Uc[ae]&&(Ce[ae]||!$c[ae]):!!(Ke==="application/xhtml+xml"&&Oa[_.namespaceURI]):!1},ms=function(_){Qn(t.removed,{element:_});try{T(_).removeChild(_)}catch{if(m(_),!T(_))throw Sn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Bc=function(_){const q=k?k(_):_.childNodes;if(q){const Se=[];Ps(q,Ae=>{Qn(Se,Ae)}),Ps(Se,Ae=>{try{m(Ae)}catch{}})}const ae=v?v(_):null;if(ae)for(let Se=ae.length-1;Se>=0;--Se){const Ae=ae[Se],Le=Ae&&Ae.name;if(typeof Le=="string")try{_.removeAttribute(Le)}catch{}}},_n=function(_,q){try{Qn(t.removed,{attribute:q.getAttributeNode(_),from:q})}catch{Qn(t.removed,{attribute:null,from:q})}if(q.removeAttribute(_),_==="is")if(Re||U)try{ms(q)}catch{}else try{q.setAttribute(_,"")}catch{}},yg=function(_){const q=v?v(_):_.attributes;if(q)for(let ae=q.length-1;ae>=0;--ae){const Se=q[ae],Ae=Se&&Se.name;if(!(typeof Ae!="string"||y[nt(Ae)]))try{_.removeAttribute(Ae)}catch{}}},xg=function(_){const q=[_];for(;q.length>0;){const ae=q.pop();(x?x(ae):ae.nodeType)===ks.element&&yg(ae);const Ae=k?k(ae):ae.childNodes;if(Ae)for(let Le=Ae.length-1;Le>=0;--Le)q.push(Ae[Le])}},Hc=function(_){let q=null,ae=null;if(Te)_="<remove></remove>"+_;else{const Le=Cd(_,/^[\r\n\t ]+/);ae=Le&&Le[0]}Ke==="application/xhtml+xml"&&gs===Ot&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const Se=I?P(_):_;if(gs===Ot)try{q=new u().parseFromString(Se,Ke)}catch{}if(!q||!q.documentElement){q=V.createDocument(gs,"template",null);try{q.documentElement.innerHTML=nn?O:Se}catch{}}const Ae=q.body||q.documentElement;return _&&ae&&Ae.insertBefore(s.createTextNode(ae),Ae.childNodes[0]||null),gs===Ot?z.call(q,fe?"html":"body")[0]:fe?q.documentElement:Ae},Vc=function(_){return N.call(_.ownerDocument||_,_,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},fr=function(_){var q,ae;_.normalize();const Se=N.call(_.ownerDocument||_,_,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Ae=Se.nextNode();for(;Ae;){let yt=Ae.data;Ps([W,he,X],Qe=>{yt=Xn(yt,Qe," ")}),Ae.data=yt,Ae=Se.nextNode()}const Le=(q=(ae=_.querySelectorAll)===null||ae===void 0?void 0:ae.call(_,"template"))!==null&&q!==void 0?q:[];Ps(Array.from(Le),yt=>{Wn(yt.content)&&fr(yt.content)})},Pi=function(_){const q=C?C(_):null;return typeof q!="string"||nt(q)!=="form"?!1:typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||_.attributes!==v(_)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function"||_.nodeType!==x(_)||_.childNodes!==k(_)},Wn=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return x(_)===ks.documentFragment}catch{return!1}},La=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return typeof x(_)=="number"}catch{return!1}};function Os(me,_,q){Ps(me,ae=>{ae.call(t,_,q,Gn)})}const jc=function(_){let q=null;if(Os(oe.beforeSanitizeElements,_,null),Pi(_))return ms(_),!0;const ae=nt(C?C(_):_.nodeName);if(Os(oe.uponSanitizeElement,_,{tagName:ae,allowedTags:be}),ie&&_.hasChildNodes()&&!La(_.firstElementChild)&&Et(/<[/\w!]/g,_.innerHTML)&&Et(/<[/\w!]/g,_.textContent)||ie&&_.namespaceURI===Ot&&ae==="style"&&La(_.firstElementChild)||_.nodeType===ks.progressingInstruction||ie&&_.nodeType===ks.comment&&Et(/<[/\w]/g,_.data))return ms(_),!0;if(Z[ae]||!(F.tagCheck instanceof Function&&F.tagCheck(ae))&&!be[ae]){if(!Z[ae]&&Kc(ae)&&(M.tagNameCheck instanceof RegExp&&Et(M.tagNameCheck,ae)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ae)))return!1;if(Be&&!Ye[ae]){const Ae=T(_),Le=k(_);if(Le&&Ae){const yt=Le.length;for(let Qe=yt-1;Qe>=0;--Qe){const ct=bt?Le[Qe]:p(Le[Qe],!0);Ae.insertBefore(ct,g(_))}}}return ms(_),!0}return(x?x(_):_.nodeType)===ks.element&&!bg(_)||(ae==="noscript"||ae==="noembed"||ae==="noframes")&&Et(/<\/no(script|embed|frames)/i,_.innerHTML)?(ms(_),!0):(ge&&_.nodeType===ks.text&&(q=_.textContent,Ps([W,he,X],Ae=>{q=Xn(q,Ae," ")}),_.textContent!==q&&(Qn(t.removed,{element:_.cloneNode()}),_.textContent=q)),Os(oe.afterSanitizeElements,_,null),!1)},zc=function(_,q,ae){if(A[q]||xe&&(q==="id"||q==="name")&&(ae in s||ae in vg))return!1;const Se=y[q]||F.attributeCheck instanceof Function&&F.attributeCheck(q,_);if(!(Q&&!A[q]&&Et(ce,q))){if(!(Y&&Et(Ne,q))){if(!Se||A[q]){if(!(Kc(_)&&(M.tagNameCheck instanceof RegExp&&Et(M.tagNameCheck,_)||M.tagNameCheck instanceof Function&&M.tagNameCheck(_))&&(M.attributeNameCheck instanceof RegExp&&Et(M.attributeNameCheck,q)||M.attributeNameCheck instanceof Function&&M.attributeNameCheck(q,_))||q==="is"&&M.allowCustomizedBuiltInElements&&(M.tagNameCheck instanceof RegExp&&Et(M.tagNameCheck,ae)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ae))))return!1}else if(!Na[q]){if(!Et(ve,Xn(ae,de,""))){if(!((q==="src"||q==="xlink:href"||q==="href")&&_!=="script"&&Ed(ae,"data:")===0&&xn[_])){if(!(se&&!Et(j,Xn(ae,de,"")))){if(ae)return!1}}}}}}return!0},_g=Oe({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Kc=function(_){return!_g[Ga(_)]&&Et(le,_)},qc=function(_){Os(oe.beforeSanitizeAttributes,_,null);const q=_.attributes;if(!q||Pi(_))return;const ae={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let Se=q.length;for(;Se--;){const Ae=q[Se],Le=Ae.name,yt=Ae.namespaceURI,Qe=Ae.value,ct=nt(Le),an=Qe;let wt=Le==="value"?an:G_(an);if(ae.attrName=ct,ae.attrValue=wt,ae.keepAttr=!0,ae.forceKeepAttr=void 0,Os(oe.uponSanitizeAttribute,_,ae),wt=ae.attrValue,K&&(ct==="id"||ct==="name")&&Ed(wt,ye)!==0&&(_n(Le,_),wt=ye+wt),ie&&Et(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,wt)){_n(Le,_);continue}if(ct==="attributename"&&Cd(wt,"href")){_n(Le,_);continue}if(ae.forceKeepAttr)continue;if(!ae.keepAttr){_n(Le,_);continue}if(!ee&&Et(/\/>/i,wt)){_n(Le,_);continue}ge&&Ps([W,he,X],Wc=>{wt=Xn(wt,Wc," ")});const Gc=nt(_.nodeName);if(!zc(Gc,ct,wt)){_n(Le,_);continue}if(I&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!yt)switch(d.getAttributeType(Gc,ct)){case"TrustedHTML":{wt=P(wt);break}case"TrustedScriptURL":{wt=D(wt);break}}if(wt!==an)try{yt?_.setAttributeNS(yt,Le,wt):_.setAttribute(Le,wt),Pi(_)?ms(_):Td(t.removed)}catch{_n(Le,_)}}Os(oe.afterSanitizeAttributes,_,null)},Fi=function(_){let q=null;const ae=Vc(_);for(Os(oe.beforeSanitizeShadowDOM,_,null);q=ae.nextNode();)if(Os(oe.uponSanitizeShadowNode,q,null),jc(q),qc(q),Wn(q.content)&&Fi(q.content),(x?x(q):q.nodeType)===ks.element){const Ae=b?b(q):q.shadowRoot;Wn(Ae)&&(pr(Ae),Fi(Ae))}Os(oe.afterSanitizeShadowDOM,_,null)},pr=function(_){const q=[{node:_,shadow:null}];for(;q.length>0;){const ae=q.pop();if(ae.shadow){Fi(ae.shadow);continue}const Se=ae.node,Le=(x?x(Se):Se.nodeType)===ks.element,yt=k?k(Se):Se.childNodes;if(yt)for(let Qe=yt.length-1;Qe>=0;--Qe)q.push({node:yt[Qe],shadow:null});if(Le){const Qe=C?C(Se):null;if(typeof Qe=="string"&&nt(Qe)==="template"){const ct=Se.content;Wn(ct)&&q.push({node:ct,shadow:null})}}if(Le){const Qe=b?b(Se):Se.shadowRoot;Wn(Qe)&&q.push({node:null,shadow:Qe},{node:Qe,shadow:null})}}};return t.sanitize=function(me){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},q=null,ae=null,Se=null,Ae=null;if(nn=!me,nn&&(me="<!-->"),typeof me!="string"&&!La(me)&&(me=Q_(me),typeof me!="string"))throw Sn("dirty is not a string, aborting");if(!t.isSupported)return me;_e||dr(_),t.removed=[];const Le=bt&&typeof me!="string"&&La(me);if(Le){const ct=C?C(me):me.nodeName;if(typeof ct=="string"){const an=nt(ct);if(!be[an]||Z[an])throw Sn("root node is forbidden and cannot be sanitized in-place")}if(Pi(me))throw Sn("root node is clobbered and cannot be sanitized in-place");try{pr(me)}catch(an){throw Bc(me),an}}else if(La(me))q=Hc("<!---->"),ae=q.ownerDocument.importNode(me,!0),ae.nodeType===ks.element&&ae.nodeName==="BODY"||ae.nodeName==="HTML"?q=ae:q.appendChild(ae),pr(ae);else{if(!Re&&!ge&&!fe&&me.indexOf("<")===-1)return I&&ue?P(me):me;if(q=Hc(me),!q)return Re?null:ue?O:""}q&&Te&&ms(q.firstChild);const yt=Vc(Le?me:q);try{for(;Se=yt.nextNode();)jc(Se),qc(Se),Wn(Se.content)&&Fi(Se.content)}catch(ct){throw Le&&Bc(me),ct}if(Le)return Ps(t.removed,ct=>{ct.element&&xg(ct.element)}),ge&&fr(me),me;if(Re){if(ge&&fr(q),U)for(Ae=w.call(q.ownerDocument);q.firstChild;)Ae.appendChild(q.firstChild);else Ae=q;return(y.shadowroot||y.shadowrootmode)&&(Ae=re.call(n,Ae,!0)),Ae}let Qe=fe?q.outerHTML:q.innerHTML;return fe&&be["!doctype"]&&q.ownerDocument&&q.ownerDocument.doctype&&q.ownerDocument.doctype.name&&Et(ck,q.ownerDocument.doctype.name)&&(Qe="<!DOCTYPE "+q.ownerDocument.doctype.name+`>
`+Qe),ge&&Ps([W,he,X],ct=>{Qe=Xn(Qe,ct," ")}),I&&ue?P(Qe):Qe},t.setConfig=function(){let me=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};dr(me),_e=!0},t.clearConfig=function(){Gn=null,_e=!1,I=S,O=""},t.isValidAttribute=function(me,_,q){Gn||dr({});const ae=nt(me),Se=nt(_);return zc(ae,Se,q)},t.addHook=function(me,_){typeof _=="function"&&Qn(oe[me],_)},t.removeHook=function(me,_){if(_!==void 0){const q=K_(oe[me],_);return q===-1?void 0:q_(oe[me],q,1)[0]}return Td(oe[me])},t.removeHooks=function(me){oe[me]=[]},t.removeAllHooks=function(){oe=Md()},t}var Pd=ng();function Ac(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var zn=Ac();function ag(e){zn=e}var si={exec:()=>null};function We(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(zt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var zt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},pk=/^(?:[ \t]*(?:\n|$))+/,hk=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,gk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Oi=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,mk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Rc=/(?:[*+-]|\d{1,9}[.)])/,ig=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,lg=We(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),vk=We(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ic=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,bk=/^[^\n]+/,Nc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,yk=We(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Nc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),xk=We(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Rc).getRegex(),or="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Oc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_k=We("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Oc).replace("tag",or).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),rg=We(Ic).replace("hr",Oi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex(),kk=We(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",rg).getRegex(),Lc={blockquote:kk,code:hk,def:yk,fences:gk,heading:mk,hr:Oi,html:_k,lheading:lg,list:xk,newline:pk,paragraph:rg,table:si,text:bk},Fd=We("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Oi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex(),wk={...Lc,lheading:vk,table:Fd,paragraph:We(Ic).replace("hr",Oi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Fd).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex()},Sk={...Lc,html:We(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Oc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:si,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:We(Ic).replace("hr",Oi).replace("heading",` *#{1,6} *[^
...
`,e=e.substring(f.length+1),o=!0),!o){const T=this.rules.other.nextBulletRegex(m),b=this.rules.other.hrRegex(m),v=this.rules.other.fencesBeginRegex(m),x=this.rules.other.headingBeginRegex(m),C=this.rules.other.htmlBeginRegex(m);for(;e;){const I=e.split(`
`,1)[0];let O;if(f=I,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),O=f):O=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||C.test(f)||T.test(f)||b.test(f))break;if(O.search(this.rules.other.nonSpaceChar)>=m||!f.trim())u+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Ts(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Un=new Wk;function ze(e,t){return Un.parse(e,t)}ze.options=ze.setOptions=function(e){return Un.setOptions(e),ze.defaults=Un.defaults,ag(ze.defaults),ze};ze.getDefaults=Ac;ze.defaults=zn;ze.use=function(...e){return Un.use(...e),ze.defaults=Un.defaults,ag(ze.defaults),ze};ze.walkTokens=function(e,t){return Un.walkTokens(e,t)};ze.parseInline=Un.parseInline;ze.Parser=Ks;ze.parser=Ks.parse;ze.Renderer=Ml;ze.TextRenderer=Pc;ze.Lexer=zs;ze.lexer=zs.lex;ze.Tokenizer=Dl;ze.Hooks=il;ze.parse=ze;ze.options;ze.setOptions;ze.use;ze.walkTokens;ze.parseInline;Ks.parse;zs.lex;const Zk={breaks:!0,gfm:!0};function Vd(e){if(!e)return"";try{if(typeof ze<"u"&&ze.parse){const t=ze.parse(e,Zk);return typeof Pd<"u"?Pd.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Jk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Yk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Qk(e){return Yk[e]||"wrench"}const Xk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function jd(e){if(!e)return[];const t=e.match(Xk);return t?[...new Set(t)]:[]}const ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=te(()=>t.value.trim().length>0&&!s.value),d=te(()=>{const $=Ge.state;return $==="connected"?"Connected":$==="reconnecting"?"Reconnecting…":$==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=te(()=>{const $=Math.floor(i.value/4)%f.length,V=i.value;return V>3?`${f[$]} (${V}s)`:f[0]});function m(){Tt(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const $=a.value;$.style.height="auto",$.style.height=Math.min($.scrollHeight,120)+"px"}function k($,V,N={}){const w={id:++o,role:$,content:V,timestamp:Date.now(),html:$==="bot"?Vd(V):"",tools_used:N.tools_used||[],is_error:N.is_error||!1,images:$==="bot"?jd(V):[],files:N.files||[],_showTools:!1};return e.value.push(w),m(),$==="bot"&&Tt(()=>T()),w}function T(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(V=>{V.setAttribute("data-copy","true"),V.style.position="relative";const N=document.createElement("button");N.className="chat-code-copy",N.textContent="Copy",N.addEventListener("click",()=>{const w=V.querySelector("code"),z=w?w.textContent:V.textContent;navigator.clipboard.writeText(z).then(()=>{N.textContent="Copied!",setTimeout(()=>{N.textContent="Copy"},1500)}).catch(()=>{})}),V.appendChild(N)})}function b($){if($===0)return!0;const V=e.value[$-1],N=e.value[$],w=new Date(V.timestamp).toDateString(),z=new Date(N.timestamp).toDateString();return w!==z}function v($){const V=new Date($),N=new Date;if(V.toDateString()===N.toDateString())return"Today";const w=new Date(N);return w.setDate(w.getDate()-1),V.toDateString()===w.toDateString()?"Yesterday":V.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x($){t.value=$,Tt(()=>B())}function C($){window.open($,"_blank","noopener")}function I($){$.target.style.display="none"}function O(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function S(){r&&(clearInterval(r),r=null),i.value=0}function R($){s.value&&(s.value=!1,S(),$.type==="chat_response"?k("bot",$.content,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]}):$.type==="chat_error"&&k("bot",$.error||"Unknown error",{is_error:!0}),Tt(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}async function L($){try{const V=await G.post("/api/chat",{content:$,channel_id:l.value});k("bot",V.response,{tools_used:V.tools_used||[],is_error:V.is_error||!1,files:V.files||[]})}catch(V){k("bot",V.message||"Failed to send message",{is_error:!0})}}async function B(){const $=t.value.trim();!$||s.value||(k("user",$),t.value="",s.value=!0,O(),a.value&&(a.value.style.height="auto"),Ge.connected?Ge.sendChat($,{channelId:l.value})?D():(await L($),s.value=!1,S()):(await L($),s.value=!1,S()),Tt(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}let P=null;ns(s,$=>{$||P&&(clearTimeout(P),P=null)});function D(){P=setTimeout(()=>{s.value&&(s.value=!1,S(),k("bot","Response timed out. Try again.",{is_error:!0}))},12e4)}async function J(){try{if(!l.value){const V=await G.get("/api/auth/session");l.value=V.channel_id||V.user_id||"web-user"}const $=await G.get("/api/sessions/"+encodeURIComponent(l.value));if($&&$.messages&&$.messages.length>0){for(const V of $.messages){const N=V.role==="user"?"user":"bot";let w=V.content||"";if(N==="user"){const re=w.match(/^\[.*?\]:\s*/);re&&(w=w.slice(re[0].length))}if(!w.trim())continue;const z={id:++o,role:N,content:w,timestamp:V.timestamp?V.timestamp*1e3:Date.now(),html:N==="bot"?Vd(w):"",tools_used:[],is_error:!1,images:N==="bot"?jd(w):[],files:[],_showTools:!1};e.value.push(z)}Tt(()=>{m(),T()})}}catch{}}return Ue(()=>{Ge.subscribe("chat",R),J(),Tt(()=>{var $;return($=a.value)==null?void 0:$.focus()})}),ft(()=>{Ge.unsubscribe("chat",R),P&&clearTimeout(P),S()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:B,autoResize:g,formatTime:Jk,formatDate:v,showDateSeparator:b,useSuggestion:x,openImage:C,onImageError:I,getToolIcon:Qk}}},ur={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=A_(),s=Yh(),n=te({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=te(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=te(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});ns(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var u;return(u=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:u.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}Ue(()=>{Ge.on("events",a),i=setInterval(l,500)}),ft(()=>{Ge.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=null;const r=te(()=>e.value.filter(T=>T.status==="running").length),o=te(()=>e.value.filter(T=>T.status==="completed").length),c=te(()=>e.value.filter(T=>["failed","timeout","killed"].includes(T.status)).length),u=te(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),d=te(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(T=>["failed","timeout","killed"].includes(T.status)):e.value.filter(T=>T.status===i.value));function f(T){return Math.min(100,Math.round(T.iteration_count/30*100))}async function p(T=!1){T=T===!0,T||(t.value=!0);try{const b=await G.get("/api/agents");e.value=Array.isArray(b)?b:[],s.value=null}catch(b){T||(s.value=b.message)}T||(t.value=!1)}async function m(T){const b=e.value.find(x=>x.id===T);if(await is({title:"Kill agent",message:`Kill agent "${(b==null?void 0:b.label)||T}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=T;try{await G.del(`/api/agents/${encodeURIComponent(T)}`),ke.success("Agent killed"),await p()}catch(x){ke.error(x.message||"Failed to kill agent")}n.value=null}}function g(){k(),a.value&&(l=setInterval(()=>{a.value&&p(!0)},5e3))}function k(){l&&(clearInterval(l),l=null)}return Ue(()=>{p(),g()}),ft(()=>{k()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:u,filteredAgents:d,formatTs:Ia,formatDuration:Ca,progressPercent:f,fetchAgents:p,killAgent:m,startAutoRefresh:g,stopAutoRefresh:k}}},nw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=te(()=>e.value.reduce((I,O)=>I+(O.iteration_count||0),0)),d=te(()=>e.value.filter(I=>I.status==="running").length);function f(I){return I==="running"?"loop-status-running":I==="error"?"loop-status-error":"loop-status-stopped"}function p(I){return I==="running"?"badge-success":I==="error"?"badge-danger":I==="completed"?"badge-info":"badge-warning"}function m(I){return I==="act"?"badge-warning":I==="silent"?"badge-info":"badge-success"}function g(I){c.value={...c.value,[I]:!c.value[I]}}async function k(I=!1){I=I===!0,I||(t.value=!0);try{e.value=await G.get("/api/loops"),s.value=null}catch(O){I||(s.value=O.message)}I||(t.value=!1)}async function T(){l.value=null;const I=a.value;if(!I.goal.trim()){l.value="Goal is required";return}if(!I.channel_id.trim()){l.value="Channel ID is required";return}const O={goal:I.goal.trim(),channel_id:I.channel_id.trim(),interval_seconds:I.interval_seconds||60,mode:I.mode,max_iterations:I.max_iterations||50};I.stop_condition.trim()&&(O.stop_condition=I.stop_condition.trim()),i.value=!0;try{const S=await G.post("/api/loops",O);ke.success(`Loop started: ${S.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await k()}catch(S){l.value=S.message}i.value=!1}async function b(I){if(await is({title:"Stop loop",message:`Stop loop ${I}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=I;try{await G.del(`/api/loops/${encodeURIComponent(I)}`),ke.success("Loop stopped"),await k()}catch(S){ke.error(S.message||"Failed to stop loop")}r.value=null}}async function v(I){o.value=I;try{await G.post(`/api/loops/${encodeURIComponent(I)}/restart`),ke.success("Loop restarted"),await k()}catch(O){ke.error(O.message||"Failed to restart loop")}o.value=null}function x(I){I.payload&&(I.payload.loop_id||I.payload.type==="loop")&&k(!0)}let C=null;return Ue(()=>{k(),Ge.subscribe("events",x),C=setInterval(()=>{k(!0)},5e3)}),ft(()=>{Ge.unsubscribe("events",x),C&&clearInterval(C)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:Ca,formatAge:Qh,toggleHistory:g,fetchLoops:k,doCreate:T,doStop:b,doRestart:v}}},aw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),m=h(null),g=h([]),k=h(!1),T=te(()=>e.value.filter(N=>N.cron&&!N.one_time).length),b=te(()=>e.value.filter(N=>N.one_time).length),v=te(()=>e.value.filter(N=>N.trigger).length),x=te(()=>e.value.filter(N=>N.paused).length),C=te(()=>e.value.filter(N=>N.consecutive_failures>0).length);function I(N){if(!N)return"-";const w=Date.now(),re=(new Date(N).getTime()-w)/1e3;if(re<0)return"overdue";if(re<60)return"in < 1 min";if(re<3600)return`in ${Math.floor(re/60)} min`;if(re<86400){const W=Math.floor(re/3600),he=Math.floor(re%3600/60);return he>0?`in ${W}h ${he}m`:`in ${W}h`}const oe=Math.floor(re/86400);return`in ${oe} day${oe!==1?"s":""}`}function O(N){return N==null?"-":N<1e3?`${N}ms`:N<6e4?`${(N/1e3).toFixed(1)}s`:Ca(N/1e3)}function S(){r.value=null}async function R(){const N=a.value.cron.trim();if(N){o.value=!0;try{r.value=await G.post("/api/schedules/validate-cron",{expression:N})}catch(w){r.value={valid:!1,error:w.message}}o.value=!1}}async function L(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(N){s.value=N.message}t.value=!1}async function B(N){if(m.value===N){m.value=null,g.value=[];return}m.value=N,k.value=!0,g.value=[];try{g.value=await G.get(`/api/schedules/${encodeURIComponent(N)}/history?limit=10`)}catch{g.value=[]}k.value=!1}async function P(){l.value=null;const N=a.value;if(!N.description.trim()){l.value="Description is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}if(!N.cron.trim()&&!N.run_at.trim()){l.value="Cron expression or run_at time is required";return}const w={description:N.description.trim(),action:N.action,channel_id:N.channel_id.trim()};if(N.cron.trim()&&(w.cron=N.cron.trim()),N.run_at.trim()&&(w.run_at=N.run_at.trim()),N.action==="reminder"&&N.message.trim()&&(w.message=N.message.trim()),N.action==="check"&&(N.tool_name.trim()&&(w.tool_name=N.tool_name.trim()),N.tool_input_str.trim()))try{w.tool_input=JSON.parse(N.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",w),ke.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await L()}catch(z){l.value=z.message}i.value=!1}async function D(N){u.value=N;try{const w=await G.post(`/api/schedules/${encodeURIComponent(N)}/run`);if(w.status==="failure")ke.error(`Execution failed: ${w.error||"unknown error"}`);else{const z=w.warning?`Executed (${w.warning})`:"Executed successfully";ke.success(z)}await L()}catch(w){ke.error(w.message||"Failed to trigger")}u.value=null}async function J(N){f.value=N.id;const w=!N.paused;try{await G.put(`/api/schedules/${encodeURIComponent(N.id)}`,{paused:w}),ke.success(w?"Schedule paused":"Schedule resumed"),await L()}catch(z){ke.error(z.message||"Failed to update schedule")}f.value=null}async function $(N){p.value=N;try{await G.post(`/api/schedules/${encodeURIComponent(N)}/reset-failures`),ke.success("Failure counters reset"),await L()}catch(w){ke.error(w.message||"Failed to reset")}p.value=null}async function V(N){const w=e.value.find(re=>re.id===N);if(await is({title:"Delete schedule",message:`Delete "${(w==null?void 0:w.description)||N}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=N;try{await G.del(`/api/schedules/${encodeURIComponent(N)}`),ke.success("Schedule deleted"),await L()}catch(re){ke.error(re.message||"Failed to delete schedule")}d.value=null}}return Ue(()=>{L()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:m,history:g,historyLoading:k,cronCount:T,oneTimeCount:b,webhookCount:v,pausedCount:x,failingCount:C,formatTs:Ia,formatAge:Qh,formatFuture:I,formatMs:O,formatDuration:Ca,onCronInput:S,validateCron:R,toggleExpand:B,fetchSchedules:L,doCreate:P,doRunNow:D,doTogglePause:J,doResetFailures:$,doDelete:V}}},lw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=zd,g=ow,k=h([]),T=h(!1),b=h(""),v=h("flat"),x=h(new Set),C=h(""),I=h(""),O=h(""),S=h(null),R=h(!1);function L(){try{const U=localStorage.getItem("odin-session-presets");U&&(k.value=JSON.parse(U))}catch{}}function B(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const P=te(()=>d.value.trim()!==""||u.value!=="all"),D=te(()=>{let U=[...e.value];const ue=zd.find(Be=>Be.id===u.value),xe=ue?ue.filters:{};if(xe.source&&(U=U.filter(Be=>Be.source===xe.source)),xe.minMessages&&(U=U.filter(Be=>Be.message_count>=xe.minMessages)),xe.hasCompaction&&(U=U.filter(Be=>Be.has_summary)),xe.maxAge!=null){const Be=Date.now()/1e3;U=U.filter(bt=>bt.last_active&&Be-bt.last_active<=xe.maxAge)}if(d.value.trim()){const Be=d.value.toLowerCase().trim();U=U.filter(bt=>(bt.channel_id||"").toLowerCase().includes(Be)||(bt.last_user_id||"").toLowerCase().includes(Be)||(bt.source||"").toLowerCase().includes(Be))}const K=f.value,ye=p.value?1:-1;return U.sort((Be,bt)=>{const st=Be[K]||0,Ye=bt[K]||0;return(st-Ye)*ye}),U}),J=te(()=>{if(!a.value||!a.value.messages)return[];const U=a.value.messages;if(U.length===0)return[];const ue=[];let xe=[];for(const K of U)K.role==="user"&&xe.length>0&&(ue.push(xe),xe=[]),xe.push(K);return xe.length>0&&ue.push(xe),ue}),$=te(()=>D.value.length>0&&o.value.size===D.value.length);function V(U){const ue=U.find(xe=>xe.role==="user");if(ue&&ue.content){const xe=ue.content.slice(0,120);return xe.length<ue.content.length?xe+"...":xe}return"(no user message)"}function N(U){const ue=new Set(x.value);ue.has(U)?ue.delete(U):ue.add(U),x.value=ue}function w(U){u.value=U}function z(U){u.value=U.id,U.filters.searchQuery!=null&&(d.value=U.filters.searchQuery),U.filters.sortBy&&(f.value=U.filters.sortBy)}function re(){if(!b.value.trim())return;const U={id:"custom-"+Date.now(),name:b.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,U],B(),T.value=!1,b.value=""}function oe(U){k.value=k.value.filter(ue=>ue.id!==U),B(),u.value===U&&(u.value="all")}function W(){u.value="all",d.value="",f.value="last_active",p.value=!1}function he(U){if(!U)return"—";const ue=Date.now()/1e3-U;if(ue<60)return"just now";if(ue<3600){const K=Math.floor(ue/60);return`${K} minute${K!==1?"s":""} ago`}if(ue<86400){const K=Math.floor(ue/3600);return`${K} hour${K!==1?"s":""} ago`}const xe=Math.floor(ue/86400);return`${xe} day${xe!==1?"s":""} ago`}function X(U){if(!U)return"";try{return new Date(U*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ce(U){if(!U)return"";try{return new Date(U*1e3).toLocaleString()}catch{return""}}function Ne(U){return U==="user"?"bg-gray-900/50 border border-gray-800":U==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function j(U){return U==="user"?"sess-msg-user":U==="assistant"?"sess-msg-assistant":"sess-msg-system"}function de(U){return U==="user"?"badge-info":U==="assistant"?"badge-success":"badge-warning"}function le(U){return U==="user"?"sess-dot-user":U==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ve(U){return U==="user"?"text-cyan-400":U==="assistant"?"text-indigo-400":"text-gray-500"}function be(U){return U?U.length>2e3?U.slice(0,2e3)+`
... (truncated)`:U:""}async function Me(){const U=C.value.trim();if(U){R.value=!0;try{let ue=`/api/sessions/search?q=${encodeURIComponent(U)}&limit=50`;I.value.trim()&&(ue+=`&channel_id=${encodeURIComponent(I.value.trim())}`),O.value.trim()&&(ue+=`&user_id=${encodeURIComponent(O.value.trim())}`);const xe=await G.get(ue);S.value=xe.results||[]}catch{S.value=[]}R.value=!1}}function y(){C.value="",I.value="",O.value="",S.value=null}function E(U){return U?U.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(U){return U==="user"?"fts-result-user":U==="assistant"?"fts-result-assistant":U==="summary"?"fts-result-summary":U==="fts"?"fts-result-fts":U==="channel"?"fts-result-channel":"fts-result-default"}function Z(U){return U==="user"?"badge-info":U==="assistant"?"badge-success":U==="summary"?"badge-warning":U==="fts"?"badge-success":"badge-info"}async function A(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(U){s.value=U.message}t.value=!1}function F(){s.value=null,A()}async function Y(U){if(n.value===U){n.value=null,a.value=null,x.value=new Set;return}n.value=U,a.value=null,i.value=!0,x.value=new Set;try{a.value=await G.get(`/api/sessions/${encodeURIComponent(U)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Q(U){const ue=new Set(o.value);ue.has(U)?ue.delete(U):ue.add(U),o.value=ue}function se(){$.value?o.value=new Set:o.value=new Set(D.value.map(U=>U.channel_id))}function ee(U){l.value=U}async function ge(){if(l.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await A()}catch(U){s.value=U.message||"Failed to clear session"}r.value=!1,l.value=null}}function ie(){c.value=!0}async function fe(){if(o.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await A()}catch(U){s.value=U.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function _e(U,ue){const xe=G._token;let K=`/api/sessions/${encodeURIComponent(U)}/export?format=${ue}`;xe&&(K+=`&token=${encodeURIComponent(xe)}`);const ye=document.createElement("a");ye.href=K,ye.download=`session-${U}.${ue==="text"?"txt":"json"}`,document.body.appendChild(ye),ye.click(),document.body.removeChild(ye)}let Te=null;function Re(U){U.payload&&U.payload.channel_id&&(clearTimeout(Te),Te=setTimeout(()=>{A(),n.value&&U.payload.channel_id===n.value&&G.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(ue=>{a.value=ue}).catch(()=>{})},2e3))}return Ue(()=>{L(),A(),Ge.subscribe("events",Re)}),ft(()=>{Ge.unsubscribe("events",Re),clearTimeout(Te)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:$,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:D,hasActiveFilters:P,customPresets:k,showSavePreset:T,newPresetName:b,threadView:v,threads:J,collapsedThreads:x,ftsQuery:C,ftsChannelId:I,ftsUserId:O,ftsResults:S,ftsSearching:R,formatAge:he,formatTimestamp:X,formatFullTimestamp:ce,messageClass:Ne,threadMsgClass:j,roleBadge:de,roleDotClass:le,roleLabelClass:ve,truncateContent:be,threadSummary:V,fetchSessions:A,retry:F,toggleSession:Y,toggleSelect:Q,toggleSelectAll:se,confirmClear:ee,clearSession:ge,confirmBulkClear:ie,doBulkClear:fe,exportSession:_e,applyPreset:w,applyCustomPreset:z,saveCustomPreset:re,removeCustomPreset:oe,resetFilters:W,toggleThread:N,runFtsSearch:Me,clearFtsSearch:y,highlightSnippet:E,ftsResultClass:M,ftsTypeBadge:Z}}},uw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:M_}}},dw={components:{ContextAssemblyPanel:uw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(O){if(!O)return"—";try{const S=new Date(O);return isNaN(S.getTime())?O:S.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return O}}function f(O){return!O&&O!==0?"—":O<1e3?O+"ms":(O/1e3).toFixed(1)+"s"}function p(O){return!O&&O!==0?"—":O>=1e3?(O/1e3).toFixed(1)+"k":String(O)}function m(O){if(!O)return"";if(typeof O=="string")return O;try{return JSON.stringify(O,null,2)}catch{return String(O)}}function g(O){a.value===O?a.value=null:(a.value=O,c.value={})}function k(O,S){const R=O+"-"+S;c.value={...c.value,[R]:!c.value[R]}}function T(O,S){return!!c.value[O+"-"+S]}function b(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,C()}async function v(){try{const O=await G.get("/api/trajectories");e.value=O.files||[],o.value=O.count||0}catch{}}let x=0;async function C(){const O=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const S=await G.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(O!==x)return;let R=S.entries||[];u.value.tool_name&&(R=R.filter(L=>(L.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(R=R.filter(L=>L.is_error)),u.value.channel_id&&(R=R.filter(L=>L.channel_id===u.value.channel_id)),u.value.user_id&&(R=R.filter(L=>L.user_id===u.value.user_id)),t.value=R}else{const S=new URLSearchParams;u.value.channel_id&&S.set("channel_id",u.value.channel_id),u.value.user_id&&S.set("user_id",u.value.user_id),u.value.tool_name&&S.set("tool_name",u.value.tool_name),u.value.errors_only&&S.set("errors_only","true"),S.set("limit",String(u.value.limit));const R=S.toString(),L=await G.get(`/api/trajectories/search/query?${R}`);if(O!==x)return;t.value=L.results||[]}}catch(S){if(O!==x)return;n.value=S.message}O===x&&(s.value=!1)}async function I(){if(!l.value.trim())return;const O=++x;s.value=!0,n.value=null,c.value={};try{const S=await G.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(O!==x)return;i.value=S.entry||null,i.value||(n.value="No trace found for this message ID")}catch(S){if(O!==x)return;S.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=S.message}O===x&&(s.value=!1)}return Ue(async()=>{await v(),await C()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:m,truncateBlock:Xh,toggleExpand:g,toggleIteration:k,isIterationExpanded:T,clearFilters:b,fetchFiles:v,fetchTraces:C,lookupMessage:I}}},fw={template:`
...
`)}const vw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),k=h(null),T=h(!1),b=te(()=>e.value.length),v=te(()=>e.value.reduce((X,ce)=>X+(ce.execution_count||0),0)),x=te(()=>e.value.reduce((X,ce)=>X+L(ce.code),0)),C=te(()=>{if(!l.value)return e.value;const X=l.value.toLowerCase();return e.value.filter(ce=>ce.name.toLowerCase().includes(X)||(ce.description||"").toLowerCase().includes(X))}),I=te(()=>d.value?d.value.split(`
`).length:0),O=te(()=>{const X=Math.max(I.value,1);return Array.from({length:X},(ce,Ne)=>Ne+1).join(`
`)}),S=te(()=>{const X=d.value.trim();return X?X.includes("SKILL_DEFINITION")?X.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function R(X){return gw(X)}function L(X){return X?X.split(`
`).length:0}function B(X){return mw(X)}function P(X){n.value={...n.value,[X]:!n.value[X]}}async function D(X){try{await navigator.clipboard.writeText(X);const ce=e.value.find(Ne=>Ne.code===X);ce&&(r.value=ce.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function J(X){if(X.key==="Tab"){X.preventDefault();const ce=X.target,Ne=ce.selectionStart,j=ce.selectionEnd;d.value=d.value.substring(0,Ne)+"    "+d.value.substring(j),Tt(()=>{ce.selectionStart=ce.selectionEnd=Ne+4})}}function $(X){const ce=X.target.previousElementSibling;ce&&(ce.scrollTop=X.target.scrollTop)}async function V(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function N(X){i.value=X,delete a.value[X],a.value={...a.value};try{const ce=await G.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:ce}}catch(ce){a.value={...a.value,[X]:{result:ce.message,is_error:!0}}}i.value=null}function w(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function z(X){o.value=!0,c.value="edit",u.value=X.name,d.value=X.code||"",f.value=null,p.value=null}function re(){o.value=!1,f.value=null,p.value=null}async function oe(){f.value=null,p.value=null;const X=u.value.trim(),ce=d.value.trim();if(!X){f.value="Name is required";return}if(!ce){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:X,code:ce}),p.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(X)}`,{code:ce}),p.value="Skill updated successfully"),await V(),setTimeout(()=>{o.value=!1},800)}catch(Ne){f.value=Ne.message}m.value=!1}function W(X){k.value=X}async function he(){if(k.value){T.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(k.value)}`),await V()}catch{}T.value=!1,k.value=null}}return Ue(()=>{V()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:k,deleting:T,enabledCount:b,totalExecutions:v,totalLines:x,displayedSkills:C,editLineCount:I,editorLineNums:O,editValidation:S,highlight:R,truncate:Ec,formatTs:Ia,countLines:L,getLineNumbers:B,toggleCode:P,copyCode:D,handleEditorKey:J,syncScroll:$,fetchSkills:V,testSkill:N,showCreate:w,editSkill:z,cancelEdit:re,saveSkill:oe,confirmDelete:W,doDelete:he}}};function bw(e,t){if(!e||!t)return kd(e);const s=kd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let k=null;const T=h(null),b=h(!1),v=h({}),x=h({}),C=h(null),I=h(null),O=te(()=>e.value.reduce((w,z)=>w+(z.chunks||0),0)),S=te(()=>new Set(e.value.map(z=>z.uploader).filter(Boolean)).size);function R(w,z){const re=x.value[z];if(!re||re.length===0)return 0;const oe=Math.max(...re.map(W=>W.char_count||0));return oe===0?0:Math.round(w.char_count/oe*100)}async function L(){t.value=!0,s.value=null;try{const w=await G.get("/api/knowledge");e.value=Array.isArray(w)?w:[]}catch(w){s.value=w.message}t.value=!1}async function B(w){if(v.value[w]){v.value[w]=!1,I.value=null;return}if(v.value[w]=!0,!(x.value[w]||C.value===w)){C.value=w;try{const z=await G.get(`/api/knowledge/${encodeURIComponent(w)}/chunks`);x.value[w]=Array.isArray(z)?z:[]}catch(z){x.value[w]=[],ke.error(`Failed to load chunks: ${z.message}`)}C.value=null}}async function P(){const w=n.value.trim();if(w){i.value=!0,r.value=null,l.value=w;try{const z=await G.get(`/api/knowledge/search?q=${encodeURIComponent(w)}`);a.value=Array.isArray(z)?z:[]}catch(z){a.value=[],r.value=z.message||"Search failed"}i.value=!1}}function D(){a.value=null,n.value="",r.value=null}async function J(){d.value=null,f.value=null;const w=c.value.trim(),z=u.value.trim();if(!w){d.value="Source name is required";return}if(!z){d.value="Content is required";return}p.value=!0;try{const re=await G.post("/api/knowledge",{source:w,content:z});f.value=`Ingested ${re.chunks||0} chunks from "${w}"`,c.value="",u.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(re){d.value=re.message}p.value=!1}async function $(w){m.value=w,g.value=null,k&&(clearTimeout(k),k=null);try{const z=await G.post(`/api/knowledge/${encodeURIComponent(w)}/reingest`);g.value={source:w,error:!1,message:`Re-ingested ${z.chunks||0} chunks`},delete x.value[w],await L(),k=setTimeout(()=>{g.value=null,k=null},3e3)}catch(z){g.value={source:w,error:!0,message:z.message}}m.value=null}function V(w){T.value=w}async function N(){if(T.value){b.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(T.value)}`),delete x.value[T.value],await L()}catch{}b.value=!1,T.value=null}}return Ue(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:T,deleting:b,expanded:v,sourceChunks:x,loadingChunks:C,selectedChunk:I,totalChunks:O,uploaderCount:S,truncate:Ec,formatTs:Ia,highlightTerms:bw,chunkBarWidth:R,fetchSources:L,toggleSource:B,doSearch:P,clearSearch:D,doIngest:J,doReingest:$,confirmDelete:V,doDelete:N}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),k=h(null),T=h(new Set),b=h(null),v=h(!1),x=h(!1),C=te(()=>e.value.reduce((W,he)=>W+he.count,0)),I=te(()=>T.value.size);function O(W){const he=t.value[W];if(!he)return[];if(!l.value.trim())return he;const X=l.value.trim().toLowerCase();return he.filter(ce=>ce.key.toLowerCase().includes(X)||ce.value&&ce.value.toLowerCase().includes(X))}function S(W,he){return T.value.has(W+"/"+he)}function R(W,he){const X=W+"/"+he,ce=new Set(T.value);ce.has(X)?ce.delete(X):ce.add(X),T.value=ce}function L(W){const he=t.value[W];return!he||he.length===0?!1:he.every(X=>T.value.has(W+"/"+X.key))}function B(W,he){const X=t.value[W];if(!X)return;const ce=new Set(T.value);for(const Ne of X){const j=W+"/"+Ne.key;he?ce.add(j):ce.delete(j)}T.value=ce}async function P(){s.value=!0,n.value=null;try{const W=await G.get("/api/memory");e.value=Object.entries(W).map(([he,X])=>({name:he,keys:X.keys||[],count:X.count||0}))}catch(W){n.value=W.message}s.value=!1}async function D(W){if(a.value[W]){a.value[W]=!1;return}a.value[W]=!0;const he=e.value.find(ce=>ce.name===W);if(!he||t.value[W]||i.value===W)return;i.value=W;const X=await Promise.all(he.keys.map(async ce=>{try{const Ne=await G.get(`/api/memory/${encodeURIComponent(W)}/${encodeURIComponent(ce)}`);return{key:ce,value:Ne.value||""}}catch{return{key:ce,value:"(error loading)"}}}));t.value[W]=X,i.value=null}function J(W,he,X){f.value=W+"/"+he,p.value=X}async function $(W,he){m.value=!0,g.value=null;try{await G.put(`/api/memory/${encodeURIComponent(W)}/${encodeURIComponent(he)}`,{value:p.value});const X=t.value[W];if(X){const ce=X.find(Ne=>Ne.key===he);ce&&(ce.value=p.value)}f.value=null}catch(X){g.value=`Failed to save: ${X.message||"unknown error"}`}m.value=!1}async function V(W,he){try{await navigator.clipboard.writeText(he.value),k.value=W+"/"+he.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function N(){u.value=null,d.value=null;const W=o.value.scope.trim(),he=o.value.key.trim(),X=o.value.value.trim();if(!W){u.value="Scope is required";return}if(!he){u.value="Key is required";return}if(!X){u.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(W)}/${encodeURIComponent(he)}`,{value:X}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(ce){u.value=ce.message}c.value=!1}function w(W,he){b.value={scope:W,key:he}}async function z(){if(!b.value)return;v.value=!0,g.value=null;const{scope:W,key:he}=b.value;try{await G.del(`/api/memory/${encodeURIComponent(W)}/${encodeURIComponent(he)}`);const X=t.value[W];X&&(t.value[W]=X.filter(j=>j.key!==he));const ce=e.value.find(j=>j.name===W);ce&&(ce.count--,ce.keys=ce.keys.filter(j=>j!==he));const Ne=new Set(T.value);Ne.delete(W+"/"+he),T.value=Ne}catch(X){g.value=`Failed to delete: ${X.message||"unknown error"}`}v.value=!1,b.value=null}function re(){x.value=!0}async function oe(){v.value=!0,g.value=null;const W=[];for(const he of T.value){const X=he.indexOf("/");W.push({scope:he.slice(0,X),key:he.slice(X+1)})}try{await G.post("/api/memory/bulk-delete",{entries:W}),T.value=new Set,t.value={},await P()}catch(he){g.value=`Bulk delete failed: ${he.message||"unknown error"}`}v.value=!1,x.value=!1}return Ue(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:k,selected:T,selectedCount:I,totalEntries:C,deleteTarget:b,deleting:v,showBulkDelete:x,fetchMemory:P,toggleScope:D,startEdit:J,doEdit:$,copyValue:V,doAdd:N,confirmDelete:w,doDelete:z,confirmBulkDelete:re,doBulkDelete:oe,isSelected:S,toggleSelect:R,isScopeAllSelected:L,toggleSelectAll:B,filteredEntries:O}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=te(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=te(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await G.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return Ue(()=>{c(),i=setInterval(c,3e4)}),ft(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:eg,refresh:u,retry:d}}},Rw=["INFO","WARNING","ERROR"],Iw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Ur=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Nw=[50,100,200,500],Ow={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(Ge.state||"disconnected"),c=te(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,m=Rw,g=Iw,k=Ur,T=h("all"),b=h(""),v=h([]),x=h(!1),C=h(""),I=h([]);function O(){try{const H=localStorage.getItem("odin-log-presets");H&&(v.value=JSON.parse(H))}catch{}}function S(){try{localStorage.setItem("odin-log-presets",JSON.stringify(v.value))}catch{}}const R=te(()=>a.value!==""||i.value.trim()!==""||b.value!==""),L=te(()=>{const H=Ur.find(ne=>ne.value===b.value);return H?H.label:""}),B=te(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(H){return H.message}}),P=24,D=te(()=>{if(t.value.length===0)return[];const H=[],ne=new Date,Ce=3600*1e3;for(let Ke=P-1;Ke>=0;Ke--){const it=new Date(ne.getTime()-(Ke+1)*Ce),Gt=new Date(ne.getTime()-Ke*Ce);H.push({start:it,end:Gt,label:N(it,Gt),shortLabel:Gt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Ke of t.value){if(!Ke._time)continue;const it=Ke._time.getTime();for(const Gt of H)if(it>=Gt.start.getTime()&&it<Gt.end.getTime()){Gt.total++,Ke.level==="ERROR"?Gt.errors++:Ke.level==="WARNING"?Gt.warnings++:Gt.info++;break}}return H}),J=te(()=>{let H=1;for(const ne of D.value)ne.total>H&&(H=ne.total);return H}),$=te(()=>D.value.length===0?"":"Last 24 hours"),V=te(()=>Math.ceil(P/8));function N(H,ne){const Ce={hour:"2-digit",minute:"2-digit"};return H.toLocaleTimeString([],Ce)+" - "+ne.toLocaleTimeString([],Ce)}function w(H,ne){return!ne||!H?"0px":Math.max(2,H/ne*100)+"%"}function z(H){const ne=re.value.findIndex(Ce=>Ce._time&&Ce._time.getTime()>=H.start.getTime()&&Ce._time.getTime()<H.end.getTime());if(ne>=0&&u.value){const Ce=u.value.querySelectorAll(".log-line");Ce[ne]&&(Ce[ne].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const re=te(()=>{let H=t.value;if(a.value&&(H=H.filter(ne=>(ne.level||"INFO")===a.value)),b.value){const ne=Ur.find(Ce=>Ce.value===b.value);if(ne&&ne.seconds){const Ce=new Date(Date.now()-ne.seconds*1e3);H=H.filter(Ke=>Ke._time&&Ke._time>=Ce)}}if(i.value&&!B.value)if(l.value)try{const ne=new RegExp(i.value,"i");H=H.filter(Ce=>{const Ke=Ce.text||Ce.raw||"",it=Ce.tool||"";return ne.test(Ke)||ne.test(it)})}catch{}else{const ne=i.value.toLowerCase();H=H.filter(Ce=>{const Ke=(Ce.text||Ce.raw||"").toLowerCase(),it=(Ce.tool||"").toLowerCase();return Ke.includes(ne)||it.includes(ne)})}return H});function oe(H){if(H.type==="log"&&H.line)try{const ne=typeof H.line=="string"?JSON.parse(H.line):H.line,Ce=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Ce.toLocaleTimeString(),_time:Ce,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(H.line),tool:"",raw:String(H.line)}}if(H.payload){const ne=H.payload,Ce=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Ce.toLocaleTimeString(),_time:Ce,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}return typeof H=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:H,tool:"",raw:H}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(H),tool:"",raw:null}}function W(H){const ne=oe(H);if(s.value){I.value.push(ne);return}he(ne)}function he(H){t.value.push(H),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&Tt(()=>X())}function X(){const H=u.value;if(H){const ne=H.scrollHeight-H.scrollTop-H.clientHeight;H.scrollTo({top:H.scrollHeight,behavior:ne<500?"smooth":"instant"})}}function ce(){n.value=!0,d.value=!1,Tt(()=>X())}function Ne(){const H=u.value;if(!H)return;const ne=H.scrollHeight-H.scrollTop-H.clientHeight<40;d.value=!ne&&t.value.length>0,!ne&&n.value&&(n.value=!1)}function j(){if(s.value=!s.value,!s.value&&I.value.length>0){for(const H of I.value)he(H);I.value=[]}}function de(){t.value=[],I.value=[],d.value=!1}function le(){let H;e.value==="search"?H=ue.value.map(it=>{const Gt=it.error?"ERROR":"INFO",nt=it.tool_name?`[${it.tool_name}] `:"";return`${it.timestamp||""} ${Gt} ${nt}${it.result_summary||it.message||""}`}).join(`
`):H=re.value.map(it=>`${it.ts} ${it.level} ${it.text}`).join(`
`);const ne=new Blob([H],{type:"text/plain"}),Ce=URL.createObjectURL(ne),Ke=document.createElement("a");Ke.href=Ce,Ke.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ke.click(),URL.revokeObjectURL(Ce)}function ve(H,ne){const Ce=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(Ce).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function be(H){a.value=a.value===H?"":H,T.value="all"}function Me(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function E(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function M(H){T.value=H.id;const ne=H.filters;a.value=ne.level||"",b.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function Z(H){T.value=H.id,a.value=H.filters.level||"",b.value=H.filters.timeRange||"",i.value=H.filters.text||""}function A(){if(!C.value.trim())return;const H={id:"custom-"+Date.now(),name:C.value.trim(),filters:{level:a.value,timeRange:b.value,text:i.value}};v.value=[...v.value,H],S(),x.value=!1,C.value=""}function F(H){v.value=v.value.filter(ne=>ne.id!==H),S(),T.value===H&&(T.value="all")}const Y=h("all"),Q=h(""),se=h(""),ee=h(""),ge=h(""),ie=h(""),fe=h(100),_e=Nw,Te=h(!1),Re=h(!1),U=h(""),ue=h([]),xe=h(null),K=h(null);function ye(){e.value="search",xe.value||Be()}async function Be(){try{xe.value=await G.get("/api/logs/stats")}catch{}}function bt(){const H=ie.value;if(!H){ee.value="",ge.value="";return}const Ce={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(Ce){const Ke=new Date(Date.now()-Ce*1e3);ee.value=st(Ke),ge.value=""}}function st(H){const ne=Ce=>String(Ce).padStart(2,"0");return`${H.getFullYear()}-${ne(H.getMonth()+1)}-${ne(H.getDate())}T${ne(H.getHours())}:${ne(H.getMinutes())}`}function Ye(H){if(!H)return"";const ne=new Date(H);return isNaN(ne.getTime())?"":ne.toISOString()}async function sn(){Te.value=!0,U.value="",Re.value=!0,K.value=null;try{const H=new URLSearchParams;Y.value&&Y.value!=="all"&&H.set("level",Y.value),Q.value&&H.set("tool",Q.value),se.value&&H.set("q",se.value);const ne=Ye(ee.value),Ce=Ye(ge.value);ne&&H.set("start",ne),Ce&&H.set("end",Ce),H.set("limit",String(fe.value));const Ke=await G.get(`/api/logs/search?${H.toString()}`);ue.value=Ke.entries||[]}catch(H){U.value=H.message||"Search failed",ue.value=[]}finally{Te.value=!1}}function xn(){Y.value="all",Q.value="",se.value="",ee.value="",ge.value="",ie.value="",fe.value=100,ue.value=[],Re.value=!1,U.value="",K.value=null}function Li(H){K.value=K.value===H?null:H}function Na(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function Di(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function Kn(H){return H.error?"log-line-error":"text-gray-300"}function qn(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let Ot=null,gs=null,nn=!1;function Oa(){nn||(nn=!0,Ge.subscribe("logs",W),r.value=Ge.connected,o.value=Ge.state||"disconnected",Ot=Ge.onStateChange,gs=(H,ne)=>{o.value=H,r.value=H==="connected",Ot&&Ot(H,ne)},Ge.onStateChange=gs)}function Mi(){nn&&(nn=!1,Ge.unsubscribe("logs",W),Ge.onStateChange===gs&&(Ge.onStateChange=Ot),gs=null,Ot=null)}return Ue(O),Uo(Oa),Bo(Mi),ft(Mi),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:re,pauseBuffer:I,showJumpBottom:d,copiedIndex:f,regexError:B,levels:m,logPresets:g,timeRanges:k,timeRange:b,activeLogPreset:T,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:C,hasActiveLogFilters:R,timeRangeLabel:L,timelineBuckets:D,timelineMax:J,timelineSpanLabel:$,timelineLabelSkip:V,togglePause:j,clearLogs:de,exportLogs:le,logLineClass:Me,levelClass:y,levelChipClass:E,toggleLevel:be,copyLine:ve,jumpToBottom:ce,onScroll:Ne,applyLogPreset:M,applyCustomLogPreset:Z,saveLogCustomPreset:A,removeLogCustomPreset:F,segmentHeight:w,jumpToTimelineBucket:z,searchLevel:Y,searchTool:Q,searchKeyword:se,searchStart:ee,searchEnd:ge,searchTimePreset:ie,searchLimit:fe,searchLimits:_e,searching:Te,searchRan:Re,searchError:U,searchResults:ue,searchStats:xe,expandedSearch:K,switchToSearch:ye,runSearch:sn,clearSearchFilters:xn,toggleSearchExpand:Li,formatSearchTs:Na,searchEntryText:Di,searchLogLineClass:Kn,formatJson:qn,applySearchTimePreset:bt}}},Lw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Br=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],gg="••••••••",Pw=50;function Fw(e){return Lw.has(e)}function $w(e){return e===gg}function Qi(e){return JSON.parse(JSON.stringify(e))}function Mn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Mn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Mn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Kd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Mn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Mn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=te(()=>d.value.length>0),m=te(()=>f.value.length>0),g=te(()=>r.value&&t.value?t.value:e.value),k=te(()=>!e.value||!t.value?!1:!Mn(e.value,t.value)),T=te(()=>!e.value||!t.value?0:Kd(e.value,t.value).length),b=te(()=>{if(!r.value||!t.value)return{};const A={};for(const F of Object.keys(t.value)){const Y=t.value[F];if(typeof Y=="object"&&Y!==null&&!Array.isArray(Y))for(const Q of Object.keys(Y)){const se=Bw(F,Q,Y[Q]);se&&(A[F+"."+Q]=se)}}return A}),v=te(()=>Object.keys(b.value).length>0),x=te(()=>e.value?Object.keys(e.value).length:0),C=te(()=>O.value.length),I=te(()=>!e.value||!t.value?[]:Kd(e.value,t.value)),O=te(()=>e.value?Br.map(A=>({...A,sections:A.sections.filter(F=>F in e.value)})).filter(A=>A.sections.length>0):[]),S=te(()=>{if(!e.value)return[];const A=new Set(Br.flatMap(F=>F.sections));return Object.keys(e.value).filter(F=>!A.has(F))});function R(A){return g.value?g.value[A]:null}function L(A){return!e.value||!t.value?!1:!Mn(e.value[A],t.value[A])}function B(A){return A.sections.some(F=>L(F))}function P(A,F){if(!e.value||!t.value)return!1;const Y=e.value[A],Q=t.value[A];return!Y||!Q?!1:!Mn(Y[F],Q[F])}function D(A){return t.value?t.value[A]:e.value[A]}function J(A,F){const Y=t.value||e.value;return Y[A]?Y[A][F]:void 0}function $(A,F){const Y=r.value&&t.value?t.value:e.value;return Y[A]?Y[A][F]:!1}function V(A,F){return b.value[A+"."+F]||null}function N(A,F){return Dw[A+"."+F]||null}function w(A,F,Y){t.value&&(F===null?t.value[A]=Y:(t.value[A]||(t.value[A]={}),t.value[A][F]=Y),t.value={...t.value})}function z(A,F,Y){if(!t.value)return;const Q=Qi(t.value);w(A,F,Y),d.value.push(Q),d.value.length>Pw&&d.value.shift(),f.value=[]}function re(A,F,Y){try{const Q=JSON.parse(Y);z(A,F,Q)}catch{}}function oe(){d.value.length!==0&&(f.value.push(Qi(t.value)),t.value=d.value.pop())}function W(){f.value.length!==0&&(d.value.push(Qi(t.value)),t.value=f.value.pop())}function he(A,F,Y){if(!t.value||!t.value[A])return;const Q=[...t.value[A][F]];Q.splice(Y,1),z(A,F,Q)}function X(A,F){if(!t.value||!t.value[A])return;const Y=[...t.value[A][F]||[]],Q=prompt("Enter new value:");Q!==null&&(Y.push(Q),z(A,F,Y))}function ce(A){a.value={...a.value,[A]:!a.value[A]}}function Ne(A){l.value={...l.value,[A]:!l.value[A]}}function j(A){i.value={...i.value,[A]:!i.value[A]}}function de(A){try{return JSON.stringify(A,null,2)}catch{return String(A)}}function le(A){return A==null?"null":typeof A=="object"?JSON.stringify(A,null,2):String(A)}function ve(A,F){c.value={type:A,message:F},setTimeout(()=>{c.value=null},3e3)}function be(){t.value=Qi(e.value),r.value=!0,d.value=[],f.value=[]}function Me(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function E(){if(!(!k.value||v.value)){o.value=!0;try{const A=Uw(e.value,t.value);if(Object.keys(A).length===0){ve("success","No changes to save."),o.value=!1;return}const F=await G.put("/api/config",A);e.value=F,r.value=!1,t.value=null,d.value=[],f.value=[],ve("success","Config saved successfully.")}catch(A){ve("error",A.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await G.get("/api/config");for(const A of Object.keys(e.value))a.value[A]===void 0&&(a.value[A]=!0);for(const A of Br)l.value[A.key]===void 0&&(l.value[A.key]=!0)}catch(A){n.value=A.message}s.value=!1}function Z(A){if(!r.value)return;const F=A.target;F instanceof HTMLElement&&(F.matches("input, textarea, select")||F.isContentEditable)||((A.ctrlKey||A.metaKey)&&!A.shiftKey&&A.key.toLowerCase()==="z"?(A.preventDefault(),oe()):(A.ctrlKey||A.metaKey)&&(A.key==="y"||A.shiftKey&&A.key==="z"||A.shiftKey&&A.key==="Z")&&(A.preventDefault(),W()))}return Ue(()=>{M(),document.addEventListener("keydown",Z)}),ft(()=>{document.removeEventListener("keydown",Z)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:v,changeCount:T,REDACTED:gg,showDiffModal:u,diffEntries:I,canUndo:p,canRedo:m,sectionCount:x,groupCount:C,visibleGroups:O,ungroupedSections:S,validationErrors:b,isSensitiveKey:Fw,isRedacted:$w,sectionChanged:L,groupChanged:B,fieldChanged:P,getDisplay:R,getEdited:D,getEditedField:J,getDisplayBool:$,pushEdit:z,pushEditJson:re,getValidationError:V,getEnumOptions:N,removeArrayItem:he,addArrayItem:X,toggleSection:ce,toggleGroup:Ne,toggleNested:j,formatJson:de,formatDiffVal:le,showToast:ve,showDiff:y,fetchConfig:M,startEdit:be,cancelEdit:Me,saveConfig:E,undo:oe,redo:W}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=te(()=>{const w={};for(const z of u.value)w[z.id]=z;return w});function p(w){return f.value[w]||null}const m=te(()=>/^\d{15,25}$/.test(r.value.trim())),g=te(()=>{if(o.value){if(k.value[c.value])return"host-user-option-"+c.value;if(m.value)return"host-user-option-raw"}}),k=te(()=>{const w=r.value.toLowerCase().trim();return w?u.value.filter(z=>!i.value[z.id]&&(z.display_name.toLowerCase().includes(w)||z.username.toLowerCase().includes(w)||z.id.includes(w))):u.value.filter(z=>!i.value[z.id])});function T(w,z){return w?w.allowed_hosts===null||w.allowed_hosts===void 0?{allowed_hosts:[...z],default_host:w.default_host||"",allow_all:!0}:{allowed_hosts:w.allowed_hosts,default_host:w.default_host||"",allow_all:!1}:{allowed_hosts:[...z],default_host:z[0]||"",allow_all:!0}}async function b(){e.value=!0,t.value="";try{const w=await G.get("/api/host-access");s.value=w,n.value=w.available_hosts||[],a.value=T(w.default_policy,n.value);const z=w.users||{},re={};for(const[oe,W]of Object.entries(z))re[oe]=T(W,n.value);i.value=re}catch(w){t.value=w.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await G.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const w=a.value.allow_all?null:a.value.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:w,default_host:a.value.default_host}),ke.success("Default policy updated")}catch(w){ke.error(w.message||"Failed to save")}}function x(w,z){a.value.allow_all=!1,z?a.value.allowed_hosts.includes(w)||a.value.allowed_hosts.push(w):(a.value.allowed_hosts=a.value.allowed_hosts.filter(re=>re!==w),a.value.default_host===w&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function C(w){const z=i.value[w];if(z)try{const re=z.allow_all?null:z.allowed_hosts;await G.put(`/api/host-access/user/${w}`,{allowed_hosts:re,default_host:z.default_host});const oe=p(w);ke.success(`Updated access for ${oe?oe.display_name:w}`)}catch(re){ke.error(re.message||"Failed to save")}}function I(w,z,re){const oe=i.value[w];oe&&(oe.allow_all=!1,re?oe.allowed_hosts.includes(z)||oe.allowed_hosts.push(z):(oe.allowed_hosts=oe.allowed_hosts.filter(W=>W!==z),oe.default_host===z&&(oe.default_host=oe.allowed_hosts[0]||"")),C(w))}function O(w,z){const re=i.value[w];re&&(re.default_host=z,C(w))}function S(){l.value=!0,r.value="",c.value=0,Tt(()=>{d.value&&d.value.focus()})}function R(){o.value=!0,c.value=0}function L(){c.value<k.value.length-1&&c.value++}function B(){c.value>0&&c.value--}function P(){const w=k.value[c.value];if(w){J(w);return}m.value&&D()}function D(){const w=r.value.trim();/^\d{15,25}$/.test(w)&&(i.value[w]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(w),r.value="",o.value=!1,l.value=!1)}function J(w){i.value[w.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(w.id),r.value="",o.value=!1,l.value=!1}function $(){o.value=!1}function V(){setTimeout(()=>{o.value=!1},150)}async function N(w){const z=p(w);if(await is({title:"Remove user override",message:`Remove the host access override for ${z?z.display_name:w}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await G.del(`/api/host-access/user/${w}`),delete i.value[w],ke.success(`Removed override for ${z?z.display_name:w}`)}catch(oe){ke.error(oe.message||"Failed to delete")}}return Ue(b),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:k,isRawId:m,activeOptionId:g,searchInput:d,fetchData:b,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:I,setUserDefault:O,openAddUser:S,deleteUser:N,onSearchInput:R,highlightNext:L,highlightPrev:B,selectHighlighted:P,selectMember:J,closeDropdown:$,onBlur:V,addRawId:D}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=te(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=te(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(S){return S==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":S==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const S=await G.get("/api/tokens");s.value=S.tokens||[],n.value=S.available_hosts||[]}catch(S){t.value=S.message||"Failed to load tokens"}finally{e.value=!1}}function g(S){return!S||!S.trim()?[]:S.split(",").map(R=>R.trim()).filter(Boolean)}function k(S,R){const L=c.value.allowed_hosts;if(R&&!L.includes(S)&&L.push(S),!R){const B=L.indexOf(S);B>=0&&L.splice(B,1)}}function T(S,R){const L=u.value.allowed_hosts;if(R&&!L.includes(S)&&L.push(S),!R){const B=L.indexOf(S);B>=0&&L.splice(B,1)}}async function b(){var S;i.value=!0;try{const R=g(c.value.allowed_tools_str),L=c.value.host_mode,B=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:R.length?R:[]};B!==null&&(P.allowed_hosts=B),P.default_host=c.value.default_host||"";const D=await G.post("/api/tokens",P);l.value=D.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ke.success("Token created"),await m()}catch(R){ke.error(((S=R.data)==null?void 0:S.error)||R.message||"Failed to create token")}finally{i.value=!1}}function v(S){r.value=S;const R=S.allowed_hosts;let L="default";R==null?L="default":Array.isArray(R)&&R.length===0?L="none":Array.isArray(R)&&(L="select"),u.value={username:S.username||"",tier:S.tier||"admin",label:S.label||"",host_mode:L,allowed_hosts:Array.isArray(R)?[...R]:[],default_host:S.default_host||"",allowed_tools_str:(S.allowed_tools||[]).join(", ")}}async function x(){var S;if(r.value){o.value=!0;try{const R=g(u.value.allowed_tools_str),L=u.value.host_mode,B={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:R};L==="none"?B.allowed_hosts=[]:L==="select"?B.allowed_hosts=u.value.allowed_hosts:B.allowed_hosts=null,B.default_host=u.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,ke.success("Token updated"),await m()}catch(R){ke.error(((S=R.data)==null?void 0:S.error)||R.message||"Failed to update")}finally{o.value=!1}}}async function C(S){var L;if(await is({title:"Regenerate token",message:`Regenerate token for ${S.username||S.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await G.post("/api/tokens/"+encodeURIComponent(S.user_id)+"/regenerate");l.value=B.token,ke.success("Token regenerated")}catch(B){ke.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to regenerate")}}async function I(S){var L;if(await is({title:"Delete token",message:`Delete token for ${S.username||S.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(S.user_id)),ke.success("Token deleted"),await m()}catch(B){ke.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return Ue(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:k,toggleEditHost:T,createToken:b,startEdit:v,saveEdit:x,confirmRegenerate:C,confirmDelete:I,copyToken:O}}};function Hr(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Kw={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5","gpt-5","gpt-5-mini","gpt-4.1","gpt-4o"],i=te(()=>{const K=n.value.model;return K&&!a.includes(K)?[K,...a]:a}),l=te(()=>{const K=n.value.agent_model;return K&&!a.includes(K)?[K,...a]:a}),r=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),o=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h(!1),m=h(!1),g=h(!1),k=h({configured:!1}),T=h([]),b=h(""),v=h(!1),x=h(!1),C=h({configured:!1}),I=h([]),O=h(""),S=h(!1),R=h(!1),L=h(!0),B=h(""),P=h({configured:!1,accounts:[]}),D=h(null),J=h(null),$=h(""),V=h(null),N=h(!1),w=h(null),z=h(null),re=h("");let oe=null;function W(K,ye="success"){ke(K,ye==="error"?"error":"success")}function he(K){if(!K)return"?";const ye=K/(1024*1024*1024);return ye>=1?ye.toFixed(1)+" GB":(K/(1024*1024)).toFixed(0)+" MB"}async function X(){e.value=!0,await Promise.all([ce(),Ne(),Me(),j()]),e.value=!1}async function ce(){try{const K=await G.get("/api/llm/status");t.value=K,s.value=K.active_provider||"codex",K.codex&&!F.pending()&&(n.value.enabled=K.codex.enabled,n.value.model=K.codex.model||"gpt-5.5",n.value.reasoning_effort=K.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=K.codex.agent_reasoning_effort||"",n.value.agent_model=K.codex.agent_model||"",n.value.max_tokens=K.codex.max_tokens||4096),K.ollama&&!Y.pending()&&(r.value.enabled=K.ollama.enabled,r.value.base_url=K.ollama.base_url||"",r.value.model=K.ollama.model||"",r.value.max_tokens=K.ollama.max_tokens||4096),K.kimi&&!Q.pending()&&(o.value.enabled=K.kimi.enabled,o.value.model=K.kimi.model||"",o.value.max_tokens=K.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Ne(){try{if(k.value=await G.get("/api/ollama/status"),k.value.model&&(b.value=k.value.model),k.value.configured)try{const K=await G.get("/api/ollama/models");T.value=K.models||[]}catch{T.value=[]}else if(r.value.base_url)try{const K=await G.post("/api/ollama/probe-models",{base_url:r.value.base_url});T.value=K.models||[]}catch{T.value=[]}}catch{k.value={configured:!1}}}async function j(){L.value=!0,B.value="";try{P.value=await G.get("/api/codex/status")}catch(K){B.value=K.message||"Failed to fetch Codex status"}finally{L.value=!1}}async function de(){const K=t.value?t.value.active_provider:"codex";g.value=!0;try{const ye=await G.post("/api/llm/switch",{provider:s.value});ye.error?(s.value=K,W(ye.error,"error")):(W("Switched to "+s.value+" ("+ye.model+")"),await X())}catch(ye){s.value=K,W(ye.message||"Switch failed","error")}finally{g.value=!1}}async function le(){v.value=!0;try{const K=await G.post("/api/ollama/reload");W(K.configured?"Ollama reloaded":K.reason||"Ollama not configured",K.configured?"success":"error"),await X()}catch(K){W(K.message||"Reload failed","error")}finally{v.value=!1}}async function ve(){x.value=!0;try{await G.post("/api/ollama/model",{model:b.value}),W("Model set to "+b.value),await X()}catch(K){W(K.message||"Failed","error")}finally{x.value=!1}}async function be(){const K=r.value.base_url;if(!K){W("Enter a base URL first","error");return}m.value=!0;try{const ye=await G.post("/api/ollama/probe-models",{base_url:K});T.value=ye.models||[],T.value.length?(W(T.value.length+" model(s) found"),!r.value.model&&T.value.length&&(r.value.model=T.value[0].name)):W("No models found at "+K,"error")}catch(ye){W(ye.message||"Could not reach Ollama","error")}finally{m.value=!1}}async function Me(){try{if(C.value=await G.get("/api/kimi/status"),C.value.model&&(O.value=C.value.model),C.value.configured)try{const K=await G.get("/api/kimi/models");I.value=K.models||[]}catch{I.value=[]}}catch{C.value={configured:!1}}}async function y(){S.value=!0;try{const K=await G.post("/api/kimi/reload");W(K.configured?"Kimi reloaded":K.reason||"Kimi not configured",K.configured?"success":"error"),await X()}catch(K){W(K.message||"Reload failed","error")}finally{S.value=!1}}async function E(){R.value=!0;try{await G.post("/api/kimi/model",{model:O.value}),W("Model set to "+O.value),await X()}catch(K){W(K.message||"Failed","error")}finally{R.value=!1}}async function M(){if(d.value){F();return}d.value=!0;try{await G.put("/api/llm/codex/config",n.value),W("Codex config saved"),await Promise.all([ce(),j()])}catch(K){W(K.message||"Failed","error"),await Promise.all([ce(),j()])}finally{d.value=!1}}async function Z(){if(f.value){Y();return}f.value=!0;try{const K={...r.value},ye=c.value?r.value.api_key:null;ye===null&&delete K.api_key,await G.put("/api/llm/ollama/config",K),W("Ollama config saved"),ye!==null&&r.value.api_key===ye&&(r.value.api_key="",c.value=!1),await Promise.all([ce(),Ne()])}catch(K){W(K.message||"Failed","error")}finally{f.value=!1}}async function A(){if(p.value){Q();return}p.value=!0;try{const K={...o.value},ye=u.value?o.value.api_key:null;ye===null&&delete K.api_key,await G.put("/api/llm/kimi/config",K),W("Kimi config saved"),ye!==null&&o.value.api_key===ye&&(o.value.api_key="",u.value=!1),await Promise.all([ce(),Me()])}catch(K){W(K.message||"Failed","error")}finally{p.value=!1}}const F=Hr(M),Y=Hr(Z),Q=Hr(A),se=()=>(F.cancel(),M()),ee=()=>(Y.cancel(),Z()),ge=()=>(Q.cancel(),A());async function ie(K){try{await G.post("/api/codex/account/"+K+"/activate"),W("Active account switched"),await j()}catch(ye){W(ye.message||"Failed","error")}}async function fe(K){D.value=K;try{await G.post("/api/codex/account/"+K+"/refresh"),W("Token refreshed"),await j()}catch(ye){W(ye.message||"Refresh failed","error")}finally{D.value=null}}function _e(K,ye){J.value=K,$.value=ye||""}async function Te(K){try{await G.put("/api/codex/account/"+K+"/label",{label:$.value}),W("Label updated"),J.value=null,await j()}catch(ye){W(ye.message||"Failed","error")}}async function Re(K,ye){if(await is({title:"Delete Codex account",message:`Delete ${ye||"account #"+(K+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/codex/account/"+K),W("Deleted. Pool reloaded."),await j()}catch(bt){W(bt.message||"Failed","error")}}async function U(){N.value=!0;try{const K=await G.post("/api/codex/device-code");w.value=K,V.value="pending",ue(K)}catch(K){W(K.message||"Failed","error")}finally{N.value=!1}}async function ue(K){oe={cancelled:!1};const ye=oe;try{const Be=await G.post("/api/codex/device-poll",{device_auth_id:K.device_auth_id,user_code:K.user_code,interval:K.interval});if(ye.cancelled)return;z.value=Be,V.value="success",await X()}catch(Be){if(ye.cancelled)return;re.value=Be.message||"Device login failed",V.value="error"}}function xe(){oe&&(oe.cancelled=!0),V.value=null,w.value=null}return Ue(X),ft(()=>{oe&&(oe.cancelled=!0),F.cancel(),Y.cancel(),Q.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:g,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,ollamaForm:r,kimiForm:o,savingCodex:d,savingOllama:f,savingKimi:p,probingOllama:m,ollamaKeyDirty:c,kimiKeyDirty:u,ollamaStatus:k,ollamaModels:T,ollamaSelectedModel:b,reloading:v,settingModel:x,kimiStatus:C,kimiModels:I,kimiSelectedModel:O,reloadingKimi:S,settingKimiModel:R,codexLoading:L,codexError:B,codexData:P,refreshing:D,editingLabel:J,labelValue:$,deviceState:V,deviceLoading:N,deviceInfo:w,deviceResult:z,deviceError:re,fetchAll:X,switchProvider:de,reloadOllama:le,setOllamaModel:ve,reloadKimi:y,setKimiModel:E,probeOllamaModels:be,saveCodexConfig:M,saveOllamaConfig:Z,saveKimiConfig:A,saveCodexConfigDebounced:F,saveOllamaConfigDebounced:Y,saveKimiConfigDebounced:Q,saveCodexConfigNow:se,saveOllamaConfigNow:ee,saveKimiConfigNow:ge,activateAccount:ie,refreshAccount:fe,startEditLabel:_e,saveLabel:Te,deleteAccount:Re,startDeviceLogin:U,cancelDeviceLogin:xe,formatSize:he}}},qd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function qw(e){return qd[e]||qd[(e||"").toLowerCase()]||"text-gray-400"}const Gw={template:`
  ...
  `},Zw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Ow},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:Kw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},pt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),mg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:pt("/operations","live")},{path:"/agents",redirect:pt("/operations","agents")},{path:"/loops",redirect:pt("/operations","loops")},{path:"/processes",redirect:pt("/operations","processes")},{path:"/schedules",redirect:pt("/operations","schedules")},{path:"/audit",redirect:pt("/history","audit")},{path:"/sessions",redirect:pt("/history","sessions")},{path:"/traces",redirect:pt("/history","traces")},{path:"/usage",redirect:pt("/history","usage")},{path:"/tools",redirect:pt("/capabilities","tools")},{path:"/skills",redirect:pt("/capabilities","skills")},{path:"/knowledge",redirect:pt("/capabilities","knowledge")},{path:"/memory",redirect:pt("/capabilities","memory")},{path:"/learned",redirect:pt("/capabilities","learned")},{path:"/health",redirect:pt("/system","health")},{path:"/resources",redirect:pt("/system","resources")},{path:"/logs",redirect:pt("/system","logs")},{path:"/config",redirect:pt("/system","config")},{path:"/host-access",redirect:pt("/system","host-access")},{path:"/internals",redirect:pt("/system","internals")}],ni=E_({history:i_(),routes:mg});ni.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const m=h("starting"),g=h(""),k=mg.filter(N=>N.meta),T=te(()=>["Workspace","Operate","Observe","Manage"].map(N=>({name:N,routes:k.filter(w=>w.meta.section===N)})).filter(N=>N.routes.length)),b=te(()=>{var N;return((N=ni.currentRoute.value.meta)==null?void 0:N.label)||"Odin"}),v=te(()=>{var N;return((N=ni.currentRoute.value.meta)==null?void 0:N.section)||"Management"}),x=te(()=>{var N;return((N=ni.currentRoute.value.meta)==null?void 0:N.description)||"Management console"});G.onSessionExpired=()=>{t.value=!0,Ge.disconnect(),G.setToken(""),e.value="login"};function C(N){var w;if((N.ctrlKey||N.metaKey)&&N.key.toLowerCase()==="k"){e.value==="ready"&&(N.preventDefault(),xd());return}if(n.value&&N.key==="Tab"){const z=[...((w=a.value)==null?void 0:w.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(z.length){const re=z[0],oe=z[z.length-1];if(N.shiftKey&&(document.activeElement===re||!a.value.contains(document.activeElement))){N.preventDefault(),oe.focus();return}if(!N.shiftKey&&(document.activeElement===oe||!a.value.contains(document.activeElement))){N.preventDefault(),re.focus();return}}}if(N.key==="Escape"&&n.value){n.value=!1,N.preventDefault();return}if(N.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(N.target.tagName)){N.preventDefault();const z=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');z&&z.focus()}}function I(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Ue(async()=>{document.addEventListener("keydown",C),r=window.matchMedia("(max-width: 900px)"),I(),r.addEventListener("change",I);const N=await G.check();N.ok?(e.value="ready",$()):N.needsAuth?e.value="login":(e.value="ready",$())});function O(){t.value=!1,e.value="ready",$()}async function S(){await G.logout(),Ge.disconnect(),e.value="login"}function R(){s.value=!s.value}function L(){n.value=!n.value}ns(n,async N=>{var w,z;if(N)o=document.activeElement,await Tt(),(z=(w=a.value)==null?void 0:w.querySelector(".nav-item"))==null||z.focus();else if(o!=null&&o.isConnected){const re=o;o=null,requestAnimationFrame(()=>re.focus())}});const B=te(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(N,w="info",z=3e3){f.value={text:N,level:w},clearTimeout(p),p=setTimeout(()=>{f.value=null},z)}let D=null,J=!1;function $(){Ge.onStatusChange=N=>{c.value=N},Ge.onStateChange=(N,w)=>{u.value=N,d.value=w.latency??-1,N==="connected"?(J&&P("Connection restored","success"),J=!0):N==="reconnecting"&&w.attempt===1&&P("Connection lost — reconnecting…","warn")},Ge.connect(),V(),D&&clearInterval(D),D=setInterval(V,15e3)}async function V(){try{const N=await G.get("/api/status");m.value=N.status==="online"?"online":"starting";const w=N.uptime_seconds||0,z=Math.floor(w/3600),re=Math.floor(w%3600/60);g.value=`${z}h ${re}m uptime`}catch{m.value="offline",g.value=""}}return ft(()=>{D&&clearInterval(D),Ge.disconnect(),document.removeEventListener("keydown",C),r==null||r.removeEventListener("change",I)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:B,wsToast:f,botStatus:m,botUptime:g,navRoutes:k,navGroups:T,currentPage:b,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:O,logout:S,toggleSidebar:R,toggleMobileNavigation:L,openPalette:xd}}},yn=wl(Yw);yn.component("odin-icon",O_);yn.component("login-screen",Jw);yn.component("toast-container",yx);yn.component("confirm-host",xx);yn.component("command-palette",N_);yn.directive("modal-focus",D_);yn.use(ni);yn.mount("#app");
