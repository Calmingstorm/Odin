...
`).replace(/\n$/,""),d=Vm(c,br.previewLines,br.previewChars),u=t.kind==="audit_preview"?(f=t.metadata)==null?void 0:f.source:t.metadata,p=u&&(t.kind==="process_output"||u.kind==="process_output")?`PID ${u.pid??"?"} ${u.status??""}${Number.isInteger(u.exit_code)?` exit ${u.exit_code}`:""}`.trim():t.kind==="agent_result"&&(u!=null&&u.status)?`agent ${u.status}`:"";return{promoted:r,chars:i,lines:l,envelope:o,kind:t.kind,formatted:c,preview:d,outcome:p,header:t.header,summary:a.replace(/\n/g," "),warnings:Nw(t)}}const Mw={name:"CompactOutput",props:{value:{default:""},rawValue:{default:void 0},label:{type:String,default:"Output"},hasContext:{type:Boolean,default:!1}},setup(e){const t=h(!1),s=h(!0),n=h(!1),a=h(""),i=h(null),l=h(null),o=h(!1),r=Z(()=>Dw(e.value)),c=Z(()=>{const b=e.rawValue===void 0?e.value:e.rawValue;return typeof b=="string"?b:JSON.stringify(b,null,2)??""}),d=Z(()=>n.value?c.value:r.value.formatted),u=Z(()=>r.value.promoted&&r.value.preview.folded||o.value),p=Z(()=>t.value?!!d.value:r.value.promoted),f=Z(()=>p.value?"":r.value.summary);let m;function v(){if(t.value)return;const b=r.value.promoted?i.value:l.value;o.value=!!(b&&(b.scrollHeight>b.clientHeight+1||b.scrollWidth>b.clientWidth+1))}function w(){m==null||m.disconnect();for(const b of[i.value,l.value])b&&(m==null||m.observe(b));v()}function L(){t.value=!t.value,t.value||(n.value=!1)}function x(){n.value=!n.value,t.value=!0,a.value=""}async function g(){const b=e.value;try{await navigator.clipboard.writeText(d.value),b===e.value&&(a.value="Copied")}catch{b===e.value&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,n.value=!1,a.value=""}),Mt([i,l,t,s,r],()=>Rt(w),{flush:"post"}),je(()=>{m=new ResizeObserver(v),w()}),ht(()=>m==null?void 0:m.disconnect()),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,previewElement:i,summaryElement:l,model:r,body:d,canExpand:u,showBody:p,headerSummary:f,toggleExpanded:L,toggleRaw:x,copyOutput:g}},template:`
    ...
    </section>`},Yo={name:"ToolOutput",components:{CompactOutput:Mw},props:{value:{default:""},label:{type:String,default:"Output"},presentation:{type:String,default:"inspector"},rawValue:{default:void 0},hasContext:{type:Boolean,default:!1}},setup(e){const t=h(!1),s=h(!0),n=h(!1),a=h(""),i=Z(()=>jm(e.value)),l=Z(()=>n.value?[{label:"Raw received value",text:i.value.raw}]:i.value.sections),o=Z(()=>{let u=30,p=6e3;return l.value.map(f=>{const m=Vm(f.text,u,p);return u=Math.max(0,u-m.lines),p=Math.max(0,p-m.chars),{...f,display:t.value?f.text:m.text,folded:m.folded}})}),r=Z(()=>o.value.some(u=>u.folded)),c=Z(()=>n.value?i.value.raw:l.value.map(u=>u.label?`${u.label}
${u.text}`:u.text).join(`
...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(a.value="Copied")}catch{e.value===u&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,a.value=""}),Mt(n,()=>{t.value=!1,a.value=""}),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},Pw={components:{ToolOutput:Yo},setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(p){var v,w,L,x,g,b,C,T,R,S,y;const f=p.payload||p,m=f.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(m)&&!(f.agent_id||(v=f.metadata)!=null&&v.agent_id))&&!(["loop_tool_start","loop_tool"].includes(m)&&!(f.call_id||(w=f.metadata)!=null&&w.call_id))){if(m==="tool_start"||m==="loop_tool_start"){const A=f.call_id||((L=f.metadata)==null?void 0:L.call_id)||null,F=f.agent_id||((x=f.metadata)==null?void 0:x.agent_id)||"",k={callId:A,agentId:F,agentLabel:f.agent_label||((g=f.metadata)==null?void 0:g.agent_label)||"",toolInput:f.tool_input,id:A?`${F}:${A}`:`${f.action}-${Date.now()}`,tool:f.action,actor:f.actor||"",channel:f.channel_id||"",iteration:f.iteration??((b=f.metadata)==null?void 0:b.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(k);return}if(m==="tool_end"||m==="loop_tool"){const A=f.call_id||((C=f.metadata)==null?void 0:C.call_id)||null,F=f.agent_id||((T=f.metadata)==null?void 0:T.agent_id)||"";let k=-1;if(A&&(k=e.value.findIndex(M=>M.callId===A&&M.agentId===F&&M.status==="running")),k<0&&!A)for(let M=e.value.length-1;M>=0;M--){const V=e.value[M];if(V.tool===f.action&&V.agentId===F&&V.status==="running"){k=M;break}}if(k>=0){const M=e.value[k];M.status=f.error||(R=f.metadata)!=null&&R.error||["error","failed","cancelled","denied","outcome_unknown"].includes(f.status||((S=f.metadata)==null?void 0:S.status))?"error":"success",M.elapsed=f.duration_ms??((y=f.metadata)==null?void 0:y.elapsed_ms)??Date.now()-M.startTime,M.result=f.detail||"",M.fadingOut=!0,setTimeout(()=>{const V=e.value.indexOf(M);V>=0&&e.value.splice(V,1),t.value.unshift(M),t.value.length>n&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const A=f.call_id||f.tool_name||"unknown";if(f.finished){const F={...s.value};delete F[A],s.value=F}else{const k=((s.value[A]||"")+(f.chunk||"")).split(`
`);s.value={...s.value,[A]:k.slice(-30).join(`
`)}}return}}}let i=null;function l(){const p=Date.now();e.value.forEach(f=>{f.status==="running"&&(f.elapsed=p-f.startTime)})}let o=!1;function r(){o||(o=!0,Ye.on("events",a),i||(i=setInterval(l,500)))}function c(){o&&(o=!1,Ye.off("events",a),i&&(clearInterval(i),i=null))}je(r),os(r),Yt(c),ht(c);function d(p){return p<1e3?`${p}ms`:`${(p/1e3).toFixed(1)}s`}function u(p){return p==="running"?"clock":p==="success"?"success":p==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
...
... (truncated)`:s}function np(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function bd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Wm=Symbol("agent-detail-cancelled"),Bw=15e3;function Uw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((f,m)=>{r=f,c=m});function u(f,m){o||(o=!0,l!==null&&a(l),l=null,(f?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return o||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Wm),i==null||i.abort()}}}function Zm({state:e,requestDetail:t,timeoutMs:s=Bw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const w=Uw(L=>t(p,{signal:L}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=w.cancel,v.promise=(async()=>{let L=null,x=null;try{L=await w.promise}catch(g){x=g}L!==Wm&&(l!==v||e.detailId!==p||(l=null,!x&&(L===null||typeof L!="object")&&(x=new Error(`${n} response was empty or invalid`)),x?e.detail===null&&(e.detailError=(x==null?void 0:x.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=L,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function Hw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const zw={components:{ToolOutput:Yo},template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const o=Z(()=>e.value.filter(O=>O.status==="running").length),r=Z(()=>e.value.filter(O=>O.status==="completed").length),c=Z(()=>e.value.filter(O=>["failed","timeout","killed"].includes(O.status)).length),d=Z(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=Z(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(O=>["failed","timeout","killed"].includes(O.status)):e.value.filter(O=>O.status===i.value));function p(O){const U=Number(O.max_iterations)||0;return U<=0?0:Math.min(100,Math.round(O.iteration_count/U*100))}function f(O){return(Number(O.max_iterations)||0)>0}function m(O,U){return O?O==="N/A"?"N/A":U==="current_inheritance"?`inherit (currently ${O})`:O:"unknown"}function v(O){return m(O.display_model,O.display_model_source||O.display_source)}function w(O){return m(O.display_reasoning_effort,O.display_reasoning_effort_source||O.display_source)}function L(O){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[O]||""}const x=h(null),g=h(null),b=h(!1),C=h(null),T=h(""),S=Zm({state:{get detail(){return x.value},set detail(O){x.value=O},get detailId(){return g.value},set detailId(O){g.value=O},get detailLoading(){return b.value},set detailLoading(O){b.value=O},get detailError(){return C.value},set detailError(O){C.value=O}},requestDetail:(O,{signal:U})=>j.get(`/api/agents/${encodeURIComponent(O)}`,{signal:U})});async function y(O){T.value="",await S.open(O.id)}function A(){S.close(),T.value=""}async function F(){await S.refresh()}async function k(O,U){try{await navigator.clipboard.writeText(U||""),T.value=O,setTimeout(()=>{T.value===O&&(T.value="")},1500)}catch{ye.error("Copy failed")}}async function M(O=!1){O=O===!0,O||(t.value=!0);try{const U=await j.get("/api/agents");e.value=Array.isArray(U)?U:[],s.value=null}catch(U){O||(s.value=U.message)}O||(t.value=!1)}async function V(O){const U=e.value.find(B=>B.id===O);if(await qt({title:"Kill agent",message:`Kill agent "${(U==null?void 0:U.label)||O}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=O;try{await j.del(`/api/agents/${encodeURIComponent(O)}`),ye.success("Agent killed"),await M()}catch(B){ye.error(B.message||"Failed to kill agent")}n.value=null}}const W=Hw({isEnabled:()=>a.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!g.value,refreshDetail:F});function D(){W.start()}function I(){W.stop()}return Mt(a,()=>W.sync()),je(()=>{l=!0,M(),D()}),os(()=>{l=!0,M(!0),D()}),Yt(()=>{l=!1,I()}),ht(()=>{l=!1,I(),S.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:Aa,formatDuration:ui,progressPercent:p,hasProgress:f,displayModelText:v,displayEffortText:w,displaySourceLabel:L,detail:x,detailId:g,detailLoading:b,detailError:C,copied:T,openDetail:y,closeDetail:A,copyText:k,fetchAgents:M,killAgent:V,startAutoRefresh:D,stopAutoRefresh:I}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),o=h(null),r=h(null),c=h(null),d=h(null),u=h(!1),p=h(null),f=h("");let m=!1;const w=Zm({state:{get detail(){return c.value},set detail(I){c.value=I},get detailId(){return d.value},set detailId(I){d.value=I},get detailLoading(){return u.value},set detailLoading(I){u.value=I},get detailError(){return p.value},set detailError(I){p.value=I}},detailLabel:"Loop detail",requestDetail:(I,{signal:O})=>j.get(`/api/loops/${encodeURIComponent(I)}?limit=100`,{signal:O})});async function L(I){f.value="",await w.open(I.id)}function x(){w.close(),f.value=""}async function g(I,O){try{await navigator.clipboard.writeText(O||""),f.value=I,setTimeout(()=>{f.value===I&&(f.value="")},1500)}catch{ye.error("Copy failed")}}const b=Z(()=>e.value.reduce((I,O)=>I+(O.iteration_count||0),0)),C=Z(()=>e.value.filter(I=>I.status==="running").length);function T(I){return I==="running"?"loop-status-running":I==="error"?"loop-status-error":"loop-status-stopped"}function R(I){return I==="running"?"badge-success":I==="error"?"badge-danger":I==="completed"?"badge-info":"badge-warning"}function S(I){return I==="act"?"badge-warning":I==="silent"?"badge-info":"badge-success"}async function y(I=!1){I=I===!0,I||(t.value=!0);try{const O=await j.get("/api/loops");e.value=Array.isArray(O)?O:[],s.value=null}catch(O){I||(s.value=O.message)}I||(t.value=!1)}async function A(){l.value=null;const I=a.value;if(!I.goal.trim()){l.value="Goal is required";return}if(!I.channel_id.trim()){l.value="Channel ID is required";return}const O={goal:I.goal.trim(),channel_id:I.channel_id.trim(),interval_seconds:I.interval_seconds||60,mode:I.mode,max_iterations:I.max_iterations||50};I.stop_condition.trim()&&(O.stop_condition=I.stop_condition.trim()),i.value=!0;try{const U=await j.post("/api/loops",O);ye.success(`Loop started: ${U.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await y()}catch(U){l.value=U.message}i.value=!1}async function F(I){if(await qt({title:"Stop loop",message:`Stop loop ${I}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=I;try{await j.del(`/api/loops/${encodeURIComponent(I)}`),ye.success("Loop stopped"),await y()}catch(U){ye.error(U.message||"Failed to stop loop")}o.value=null}}async function k(I){r.value=I;try{await j.post(`/api/loops/${encodeURIComponent(I)}/restart`),ye.success("Loop restarted"),await y()}catch(O){ye.error(O.message||"Failed to restart loop")}r.value=null}function M(I){m&&I.payload&&(I.payload.loop_id||I.payload.type==="loop")&&(y(!0),d.value&&w.refresh())}let V=null;function W(){V!==null&&clearInterval(V),V=null}function D(){W(),m&&(V=setInterval(()=>{y(!0),d.value&&w.refresh()},5e3))}return je(()=>{m=!0,y(),Ye.subscribe("events",M),D()}),os(()=>{m=!0,y(!0),D()}),Yt(()=>{m=!1,W()}),ht(()=>{m=!1,Ye.unsubscribe("events",M),W(),w.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:f,totalIterations:b,runningCount:C,statusDotClass:T,statusBadge:R,modeBadge:S,formatAge:qm,formatDuration:ui,formatTs:Aa,formatTokens:Km,openDetail:L,closeDetail:x,copyText:g,fetchLoops:y,doCreate:A,doStop:F,doRestart:k}}},Vw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),o=h(null),r=Z(()=>Ww(a.value.run_at));Mt(()=>a.value.run_at,()=>{o.value=null});const c=Z(()=>{var re;const G=r.value;return G.state==="ok"?G.instant:G.state==="ambiguous"&&o.value!==null&&((re=G.options[o.value])==null?void 0:re.instant)||null}),d=Z(()=>{const G=c.value;return G?`${G.toLocaleString()} local — ${G.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=h(null),v=h(null),w=h(null),L=h(null),x=h(null),g=h(null),b=h([]),C=h(!1),T=h("");let R=0;const S=Z(()=>e.value.filter(G=>G.cron&&!G.one_time).length),y=Z(()=>e.value.filter(G=>G.one_time).length),A=Z(()=>e.value.filter(G=>G.trigger).length),F=Z(()=>e.value.filter(G=>G.paused).length),k=Z(()=>e.value.filter(G=>G.consecutive_failures>0).length);function M(G){if(!G)return"-";const re=Date.now(),Ie=(new Date(G).getTime()-re)/1e3;if(Ie<0)return"overdue";if(Ie<60)return"in < 1 min";if(Ie<3600)return`in ${Math.floor(Ie/60)} min`;if(Ie<86400){const P=Math.floor(Ie/3600),z=Math.floor(Ie%3600/60);return z>0?`in ${P}h ${z}m`:`in ${P}h`}const _=Math.floor(Ie/86400);return`in ${_} day${_!==1?"s":""}`}function V(G){return G==null?"-":G<1e3?`${G}ms`:G<6e4?`${(G/1e3).toFixed(1)}s`:ui(G/1e3)}function W(G=a.value.cron){a.value.cron=G,ap(a.value,"cron"),u.value=null}function D(G=a.value.run_at){a.value.run_at=G,ap(a.value,"run_at"),u.value=null}async function I(){const G=a.value.cron.trim();if(G){p.value=!0;try{u.value=await j.post("/api/schedules/validate-cron",{expression:G})}catch(re){u.value={valid:!1,error:re.message}}p.value=!1}}async function O(){t.value=!0,s.value=null;try{e.value=await j.get("/api/schedules")}catch(G){s.value=G.message}t.value=!1}async function U(G){if(g.value===G){g.value=null,b.value=[];return}g.value=G,C.value=!0,b.value=[];const re=++R;try{const pe=await j.get(`/api/schedules/${encodeURIComponent(G)}/history?limit=10`);if(re!==R||g.value!==G)return;b.value=pe,T.value=""}catch(pe){if(re!==R||g.value!==G)return;b.value=[],T.value=pe.message||"Failed to load execution history"}re===R&&(C.value=!1)}async function J(){l.value=null;const G=a.value;if(!G.description.trim()){l.value="Description is required";return}if(!G.channel_id.trim()){l.value="Channel ID is required";return}if(!G.cron.trim()&&!G.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(G.cron.trim()&&G.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const re={description:G.description.trim(),action:G.action,channel_id:G.channel_id.trim()};if(G.cron.trim()&&(re.cron=G.cron.trim()),G.run_at.trim()){const pe=r.value;if(pe.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(pe.state==="invalid"){l.value="One-time run time is not a valid date";return}const Ie=c.value;if(pe.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Ie){l.value="One-time run time could not be resolved";return}re.run_at=Ie.toISOString()}if(G.action==="reminder"&&G.message.trim()&&(re.message=G.message.trim()),G.action==="check"&&(G.tool_name.trim()&&(re.tool_name=G.tool_name.trim()),G.report_format&&(re.report_format=G.report_format),G.tool_input_str.trim()))try{re.tool_input=JSON.parse(G.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await j.post("/api/schedules",re),ye.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await O()}catch(pe){l.value=pe.message}i.value=!1}async function B(G){m.value=G;try{const re=await j.post(`/api/schedules/${encodeURIComponent(G)}/run`);if(re.status==="failure")ye.error(`Execution failed: ${re.error||"unknown error"}`);else{const pe=re.warning?`Executed (${re.warning})`:"Executed successfully";ye.success(pe)}await O()}catch(re){ye.error(re.message||"Failed to trigger")}m.value=null}async function q(G){w.value=G.id;const re=!G.paused;try{await j.put(`/api/schedules/${encodeURIComponent(G.id)}`,{paused:re}),ye.success(re?"Schedule paused":"Schedule resumed"),await O()}catch(pe){ye.error(pe.message||"Failed to update schedule")}w.value=null}const ee=new Map;function Y(G,re){const pe=ee.get(G.id);pe&&clearTimeout(pe.timer);const Ie={run:()=>ce(G,re),timer:null};Ie.timer=setTimeout(()=>{ee.delete(G.id),Ie.run()},500),ee.set(G.id,Ie)}async function ce(G,re){x.value=G.id;try{await j.put(`/api/schedules/${encodeURIComponent(G.id)}`,{report_format:re}),ye.success(re?"Structured report enabled":"Plain-text report enabled")}catch(pe){ye.error(`Update failed: ${pe.message}`)}finally{await O(),x.value=null}}function Ne(){for(const[G,re]of[...ee])clearTimeout(re.timer),ee.delete(G),re.run()}async function X(G){L.value=G;try{await j.post(`/api/schedules/${encodeURIComponent(G)}/reset-failures`),ye.success("Failure counters reset"),await O()}catch(re){ye.error(re.message||"Failed to reset")}L.value=null}async function ge(G){const re=e.value.find(Ie=>Ie.id===G);if(await qt({title:"Delete schedule",message:`Delete "${(re==null?void 0:re.description)||G}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=G;try{await j.del(`/api/schedules/${encodeURIComponent(G)}`),ye.success("Schedule deleted"),await O()}catch(Ie){ye.error(Ie.message||"Failed to delete schedule")}v.value=null}}return je(()=>{O()}),ht(Ne),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:f,runningId:m,deletingId:v,togglingId:w,resettingId:L,reportUpdatingId:x,flushReportFormatTimers:Ne,expandedId:g,history:b,historyLoading:C,historyError:T,cronCount:S,oneTimeCount:y,webhookCount:A,pausedCount:F,failingCount:k,formatTs:Aa,formatAge:qm,formatFuture:M,formatMs:V,formatDuration:ui,onCronInput:W,onRunAtInput:D,validateCron:I,toggleExpand:U,fetchSchedules:O,doCreate:J,doRunNow:B,doTogglePause:q,doUpdateReportFormat:Y,doResetFailures:X,doDelete:ge}}},Jm=[{id:"live",label:"Live",component:Pw},{id:"agents",label:"Agents",component:zw},{id:"loops",label:"Loops",component:jw},{id:"processes",label:"Processes",component:Vw},{id:"schedules",label:"Schedules",component:Zw}],Jw={components:{TabbedPage:Jo},setup(){return{tabs:Jm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h({tool:"",user:"",keyword:"",date:"",limit:50});function i(m){if(!m)return"";if(typeof m=="string")return m;try{return JSON.stringify(m,null,2)}catch{return String(m)}}function l(m){n.value=n.value===m?null:m}function o(){a.value={tool:"",user:"",keyword:"",date:"",limit:50},f()}let r=0;const c=h(!1),d=h(null),u=h(null);async function p(){c.value=!0,u.value=null;try{d.value=await j.get("/api/audit/verify")}catch(m){m.status===409&&m.data&&typeof m.data=="object"?d.value=m.data.availability==="not_enabled"?{...m.data,not_enabled:!0}:m.data:(d.value=null,u.value=m.message||"verification request failed")}c.value=!1}async function f(){const m=++r;t.value=!0,s.value=null,n.value=null;try{const v=new URLSearchParams;a.value.tool&&v.set("tool",a.value.tool),a.value.user&&v.set("user",a.value.user),a.value.keyword&&v.set("q",a.value.keyword),a.value.date&&v.set("date",a.value.date),v.set("limit",String(a.value.limit));const w=v.toString(),L=await j.get(`/api/audit${w?"?"+w:""}`);if(m!==r)return;e.value=Array.isArray(L)?L:[]}catch(v){if(m!==r)return;s.value=v.message}m===r&&(t.value=!1)}return je(()=>{f()}),{entries:e,loading:t,error:s,expandedIdx:n,filters:a,formatTs:Aa,formatDetail:i,truncateBlock:Gm,toggleExpand:l,clearFilters:o,fetchAudit:f,verifying:c,verifyResult:d,verifyError:u,verifyIntegrity:p}}},ip=[{id:"all",name:"All Sessions",icon:"list",filters:{}},{id:"active",name:"Recently Active",icon:"activity",filters:{minAge:0,maxAge:3600}},{id:"discord",name:"Discord Only",icon:"message",filters:{source:"discord"}},{id:"web",name:"Web Only",icon:"globe",filters:{source:"web"}},{id:"long",name:"Long Conversations",icon:"book",filters:{minMessages:10}},{id:"compacted",name:"Compacted",icon:"archive",filters:{hasCompaction:!0}}],Qw=[{value:"last_active",label:"Last Active"},{value:"created_at",label:"Created"},{value:"message_count",label:"Message Count"}],Xw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const o=h(null),r=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),m=h(!1),v=ip,w=Qw,L=h([]),x=h(!1),g=h(""),b=h("flat"),C=h(new Set),T=h(""),R=h(""),S=h(""),y=h(null),A=h(!1),F=h(""),k=h(!1);let M=0;Mt([T,R,S],()=>{M++,A.value=!1,F.value="",k.value=y.value!==null},{flush:"sync"});function V(){try{const ae=localStorage.getItem("odin-session-presets");ae&&(L.value=JSON.parse(ae))}catch{}}function W(){try{localStorage.setItem("odin-session-presets",JSON.stringify(L.value))}catch{}}const D=Z(()=>p.value.trim()!==""||u.value!=="all"),I=Z(()=>{let ae=[...e.value];const Se=ip.find(Ve=>Ve.id===u.value),Le=Se?Se.filters:{};if(Le.source&&(ae=ae.filter(Ve=>Ve.source===Le.source)),Le.minMessages&&(ae=ae.filter(Ve=>Ve.message_count>=Le.minMessages)),Le.hasCompaction&&(ae=ae.filter(Ve=>Ve.has_summary)),Le.maxAge!=null){const Ve=Date.now()/1e3;ae=ae.filter(Ft=>Ft.last_active&&Ve-Ft.last_active<=Le.maxAge)}if(p.value.trim()){const Ve=p.value.toLowerCase().trim();ae=ae.filter(Ft=>(Ft.channel_id||"").toLowerCase().includes(Ve)||(Ft.last_user_id||"").toLowerCase().includes(Ve)||(Ft.source||"").toLowerCase().includes(Ve))}const Ke=f.value,Et=m.value?1:-1;return ae.sort((Ve,Ft)=>{const Ht=Ve[Ke]||0,rs=Ft[Ke]||0;return(Ht-rs)*Et}),ae}),O=Z(()=>{if(!a.value||!a.value.messages)return[];const ae=a.value.messages;if(ae.length===0)return[];const Se=[];let Le=[];for(const Ke of ae)Ke.role==="user"&&Le.length>0&&(Se.push(Le),Le=[]),Le.push(Ke);return Le.length>0&&Se.push(Le),Se}),U=Z(()=>I.value.length>0&&c.value.size===I.value.length);function J(ae){const Se=ae.find(Le=>Le.role==="user");if(Se&&Se.content){const Le=Se.content.slice(0,120);return Le.length<Se.content.length?Le+"...":Le}return"(no user message)"}function B(ae){const Se=new Set(C.value);Se.has(ae)?Se.delete(ae):Se.add(ae),C.value=Se}function q(ae){u.value=ae}function ee(ae){u.value=ae.id,ae.filters.searchQuery!=null&&(p.value=ae.filters.searchQuery),ae.filters.sortBy&&(f.value=ae.filters.sortBy)}function Y(){if(!g.value.trim())return;const ae={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};L.value=[...L.value,ae],W(),x.value=!1,g.value=""}function ce(ae){L.value=L.value.filter(Se=>Se.id!==ae),W(),u.value===ae&&(u.value="all")}function Ne(){u.value="all",p.value="",f.value="last_active",m.value=!1}function X(ae){if(!ae)return"—";const Se=Date.now()/1e3-ae;if(Se<60)return"just now";if(Se<3600){const Ke=Math.floor(Se/60);return`${Ke} minute${Ke!==1?"s":""} ago`}if(Se<86400){const Ke=Math.floor(Se/3600);return`${Ke} hour${Ke!==1?"s":""} ago`}const Le=Math.floor(Se/86400);return`${Le} day${Le!==1?"s":""} ago`}function ge(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function G(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString()}catch{return""}}function re(ae){return ae==="user"?"bg-gray-900/50 border border-gray-800":ae==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function pe(ae){return ae==="user"?"sess-msg-user":ae==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Ie(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":"badge-warning"}function _(ae){return ae==="user"?"sess-dot-user":ae==="assistant"?"sess-dot-assistant":"sess-dot-system"}function P(ae){return ae==="user"?"text-cyan-400":ae==="assistant"?"text-indigo-400":"text-gray-500"}function z(ae){return ae?ae.length>2e3?ae.slice(0,2e3)+`
... (truncated)`:ae:""}async function le(){const ae=T.value.trim();if(!ae)return;const Se=++M;A.value=!0,F.value="",k.value=y.value!==null;try{let Le=`/api/sessions/search?q=${encodeURIComponent(ae)}&limit=50`;R.value.trim()&&(Le+=`&channel_id=${encodeURIComponent(R.value.trim())}`),S.value.trim()&&(Le+=`&user_id=${encodeURIComponent(S.value.trim())}`);const Ke=await j.get(Le);if(Se!==M)return;y.value=Ke.results||[],k.value=!1}catch(Le){if(Se!==M)return;F.value=Le.message||"Search failed. Please retry."}finally{Se===M&&(A.value=!1)}}function ne(){M++,T.value="",R.value="",S.value="",y.value=null,F.value="",k.value=!1,A.value=!1}function ie(ae){return ae?ae.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function fe(ae){return ae==="user"?"fts-result-user":ae==="assistant"?"fts-result-assistant":ae==="summary"?"fts-result-summary":ae==="fts"?"fts-result-fts":ae==="channel"?"fts-result-channel":"fts-result-default"}function ue(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":ae==="summary"?"badge-warning":ae==="fts"?"badge-success":"badge-info"}let de=0;async function oe(){const ae=++de;t.value=!0,s.value=null;try{const Se=await j.get("/api/sessions");if(ae!==de)return;e.value=Se}catch(Se){if(ae!==de)return;s.value=Se.message}ae===de&&(t.value=!1)}function xe(){s.value=null,oe()}async function me(ae){if(n.value===ae){n.value=null,a.value=null,C.value=new Set;return}n.value=ae,a.value=null,i.value=!0,C.value=new Set;const Se=++l;try{const Le=await j.get(`/api/sessions/${encodeURIComponent(ae)}`);Se===l&&n.value===ae&&(a.value=Le)}catch(Le){Se===l&&n.value===ae&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{Se===l&&(i.value=!1)}}function _e(ae){const Se=new Set(c.value);Se.has(ae)?Se.delete(ae):Se.add(ae),c.value=Se}function Re(){U.value?c.value=new Set:c.value=new Set(I.value.map(ae=>ae.channel_id))}function $(ae){o.value=ae}async function ve(){if(o.value){r.value=!0;try{await j.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await oe()}catch(ae){s.value=ae.message||"Failed to clear session"}r.value=!1,o.value=null}}function ke(){d.value=!0}async function Oe(){if(c.value.size!==0){r.value=!0;try{await j.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await oe()}catch(ae){s.value=ae.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Pe(ae,Se){const Le=`/api/sessions/${encodeURIComponent(ae)}/export?format=${Se}`;try{const Ke=await j.getBlob(Le),Et=URL.createObjectURL(Ke),Ve=document.createElement("a");Ve.href=Et,Ve.download=`session-${ae}.${Se==="text"?"txt":"json"}`,Ve.click(),URL.revokeObjectURL(Et)}catch(Ke){s.value=Ke.message||"Failed to export session"}}let dt=null;function st(ae){ae.payload&&ae.payload.channel_id&&(clearTimeout(dt),dt=setTimeout(()=>{if(oe(),n.value&&ae.payload.channel_id===n.value){const Se=n.value,Le=l;j.get(`/api/sessions/${encodeURIComponent(Se)}`).then(Ke=>{Le!==l||n.value!==Se||(a.value=Ke)}).catch(()=>{})}},2e3))}let _t=!1,Ot=null;function rt(){_t||(_t=!0,oe(),Ye.subscribe("events",st),Ot=Ye.onReconnected(()=>oe()))}je(()=>{V(),rt()}),os(()=>{rt()});function Qe(){_t&&(_t=!1,Ye.unsubscribe("events",st),Ot&&(Ot(),Ot=null),clearTimeout(dt))}return Yt(Qe),ht(Qe),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:U,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:m,filterPresets:v,sortOptions:w,filteredSessions:I,hasActiveFilters:D,customPresets:L,showSavePreset:x,newPresetName:g,threadView:b,threads:O,collapsedThreads:C,ftsQuery:T,ftsChannelId:R,ftsUserId:S,ftsResults:y,ftsSearching:A,ftsError:F,ftsStale:k,formatAge:X,formatTimestamp:ge,formatFullTimestamp:G,messageClass:re,threadMsgClass:pe,roleBadge:Ie,roleDotClass:_,roleLabelClass:P,truncateContent:z,threadSummary:J,fetchSessions:oe,retry:xe,toggleSession:me,toggleSelect:_e,toggleSelectAll:Re,confirmClear:$,clearSession:ve,confirmBulkClear:ke,doBulkClear:Oe,exportSession:Pe,applyPreset:q,applyCustomPreset:ee,saveCustomPreset:Y,removeCustomPreset:ce,resetFilters:Ne,toggleThread:B,runFtsSearch:le,clearFtsSearch:ne,highlightSnippet:ie,ftsResultClass:fe,ftsTypeBadge:ue}}},ek={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:Km}}},tk={components:{ContextAssemblyPanel:ek},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),o=h(""),r=h(0),c=h({}),d=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(R){if(!R)return"—";try{const S=new Date(R);return isNaN(S.getTime())?R:S.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return R}}function p(R){return!R&&R!==0?"—":R<1e3?R+"ms":(R/1e3).toFixed(1)+"s"}function f(R){return!R&&R!==0?"—":R>=1e3?(R/1e3).toFixed(1)+"k":String(R)}function m(R){if(!R)return"";if(typeof R=="string")return R;try{return JSON.stringify(R,null,2)}catch{return String(R)}}function v(R){a.value===R?a.value=null:(a.value=R,c.value={})}function w(R,S){const y=R+"-"+S;c.value={...c.value,[y]:!c.value[y]}}function L(R,S){return!!c.value[R+"-"+S]}function x(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,C()}async function g(){try{const R=await j.get("/api/trajectories");e.value=R.files||[],r.value=R.count||0}catch{}}let b=0;async function C(){const R=++b;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(o.value){const S=await j.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(R!==b)return;let y=S.entries||[];d.value.tool_name&&(y=y.filter(A=>(A.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(y=y.filter(A=>A.is_error)),d.value.channel_id&&(y=y.filter(A=>A.channel_id===d.value.channel_id)),d.value.user_id&&(y=y.filter(A=>A.user_id===d.value.user_id)),t.value=y}else{const S=new URLSearchParams;d.value.channel_id&&S.set("channel_id",d.value.channel_id),d.value.user_id&&S.set("user_id",d.value.user_id),d.value.tool_name&&S.set("tool_name",d.value.tool_name),d.value.errors_only&&S.set("errors_only","true"),S.set("limit",String(d.value.limit));const y=S.toString(),A=await j.get(`/api/trajectories/search/query?${y}`);if(R!==b)return;t.value=A.results||[]}}catch(S){if(R!==b)return;n.value=S.message}R===b&&(s.value=!1)}async function T(){if(!l.value.trim())return;const R=++b;s.value=!0,n.value=null,c.value={};try{const S=await j.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(R!==b)return;i.value=S.entry||null,i.value||(n.value="No trace found for this message ID")}catch(S){if(R!==b)return;S.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=S.message}R===b&&(s.value=!1)}return je(async()=>{await g(),await C()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:f,formatJSON:m,truncateBlock:Gm,toggleExpand:v,toggleIteration:w,isIterationExpanded:L,clearFilters:x,fetchFiles:g,fetchTraces:C,lookupMessage:T}}};function sk(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function nk(e){return e?`${e.approximate?"~":""}${bd(e.total||0)}`:"0"}const ak={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=h("7d"),i=h(0),l=h(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=Z(()=>n.value.work||{}),f=Z(()=>Math.max(1,...(n.value.activity_over_time||[]).map(T=>Number(T.count||0)))),m=Z(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),v=T=>({height:`${Math.max(4,Math.round(Number(T||0)/f.value*100))}%`}),w=Z(()=>s.value&&l.value-i.value>3e4);async function L(){const T=++d,R=a.value;try{const S=await j.get(`/api/usage?range=${encodeURIComponent(R)}`);if(T!==d||R!==a.value)return;n.value=S,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(S){T===d&&(t.value=S.message)}finally{T===d&&(e.value=!1)}}function x(T){a.value=T,e.value=!s.value,L()}function g(){e.value=!0,L()}function b(){c||(c=!0,L(),o=setInterval(L,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function C(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return je(b),os(b),Yt(C),ht(C),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:w,fmtNum:bd,fmtDuration:sk,tokenLabel:nk,activityTrackStyle:m,activityBar:v,selectRange:x,retry:g}}},Ym=[{id:"audit",label:"Audit",component:Yw},{id:"sessions",label:"Sessions",component:Xw},{id:"traces",label:"Traces",component:tk},{id:"usage",label:"Usage & Activity",component:ak}],ik={components:{TabbedPage:Jo},setup(){return{tabs:Ym}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},yr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],lk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),o=h(null),r=h(null),c=h(!1),d=h(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(y){return y.source!=="builtin"?"":u[y.state]||""}function f(y,A){const F=y&&Array.isArray(y.tools)?y.tools:null;if(c.value=!!F,r.value=F?!!y.global_enabled:null,!F){e.value=A.map(V=>({...V,source:"unknown",enabled:void 0,state:null}));return}const k=new Set(F.map(V=>V.name)),M=A.filter(V=>!k.has(V.name)).map(V=>({...V,source:V.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...F.map(V=>({...V,source:"builtin"})),...M]}async function m(y,A){if(d.value.has(y.name))return;const F=!!A.target.checked,k=new Set(d.value);k.add(y.name),d.value=k;try{const M=await j.post(`/api/tools/builtins/${encodeURIComponent(y.name)}/enabled`,{enabled:F});f(M,e.value),s.value=null;try{const V=await j.get("/api/tools");f(M,V)}catch(V){console.warn("Built-in toggle committed; visible catalog refresh failed",V)}}catch(M){A.target.checked=!!y.enabled,s.value=M.message||`Failed to toggle ${y.name}`}finally{const M=new Set(d.value);M.delete(y.name),d.value=M}}const v=Z(()=>e.value.filter(y=>y.source==="builtin"&&y.is_core).length),w=Z(()=>e.value.filter(y=>y.source==="skill").length),L=Z(()=>Object.values(a.value).reduce((y,A)=>y+A,0));function x(y){for(const A of yr)if(A.id!=="other"&&A.match(y))return A.id;return"other"}const g=Z(()=>{let y=e.value;if(n.value){const A=n.value.toLowerCase();y=y.filter(F=>F.name.toLowerCase().includes(A)||(F.description||"").toLowerCase().includes(A))}return o.value&&(y=y.filter(A=>x(A.name)===o.value)),y}),b=Z(()=>{const y=new Set;for(const A of e.value)y.add(x(A.name));return yr.filter(A=>y.has(A.id))}),C=Z(()=>{const y=g.value,A={};for(const k of y){const M=x(k.name);A[M]||(A[M]=[]),A[M].push(k)}const F=[];for(const k of yr)A[k.id]&&A[k.id].length>0&&F.push({label:k.label,icon:k.icon,tools:A[k.id].sort((M,V)=>M.name.localeCompare(V.name))});return F});function T(y){i.value={...i.value,[y]:!i.value[y]}}async function R(){t.value=!0,s.value=null;try{const[y,A,F]=await Promise.all([j.get("/api/tools"),j.get("/api/tools/stats").catch(()=>({})),j.get("/api/tools/builtins").catch(()=>null)]);f(F,y),a.value=A||{}}catch(y){s.value=y.message}t.value=!1}function S(){R()}return je(()=>{R()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:w,totalUsage:L,filteredTools:g,groupedTools:C,usedCategories:b,stateBadge:p,applyInventory:f,toggleBuiltinTool:m,truncate:gd,toggleExpand:T,refresh:S}}};function ok(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function rk(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function F(Y){return rk(Y)}function k(Y){n.value={...n.value,[Y]:!n.value[Y]}}async function M(Y){try{await navigator.clipboard.writeText(Y);const ce=e.value.find(Ne=>Ne.code===Y);ce&&(o.value=ce.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function V(Y){if(Y.key==="Tab"){Y.preventDefault();const ce=Y.target,Ne=ce.selectionStart,X=ce.selectionEnd;u.value=u.value.substring(0,Ne)+"    "+u.value.substring(X),Rt(()=>{ce.selectionStart=ce.selectionEnd=Ne+4})}}function W(Y){const ce=Y.target.previousElementSibling;ce&&(ce.scrollTop=Y.target.scrollTop)}async function D(){t.value=!0,s.value=null;try{e.value=await j.get("/api/skills")}catch(Y){s.value=Y.message}t.value=!1}async function I(Y){i.value=Y,delete a.value[Y],a.value={...a.value};try{const ce=await j.post(`/api/skills/${encodeURIComponent(Y)}/test`);a.value={...a.value,[Y]:ce}}catch(ce){a.value={...a.value,[Y]:{result:ce.message,is_error:!0}}}i.value=null}function O(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function U(Y){r.value=!0,c.value="edit",d.value=Y.name,u.value=Y.code||"",p.value=null,f.value=null}function J(){r.value=!1,p.value=null,f.value=null}async function B(){p.value=null,f.value=null;const Y=d.value.trim(),ce=u.value.trim();if(!Y){p.value="Name is required";return}if(!ce){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await j.post("/api/skills",{name:Y,code:ce}),f.value="Skill created successfully"):(await j.put(`/api/skills/${encodeURIComponent(Y)}`,{code:ce}),f.value="Skill updated successfully"),await D(),setTimeout(()=>{r.value=!1},800)}catch(Ne){p.value=Ne.message}m.value=!1}function q(Y){w.value=Y}async function ee(){if(w.value){L.value=!0;try{await j.del(`/api/skills/${encodeURIComponent(w.value)}`),await D()}catch(Y){ye.error(`Failed to delete skill: ${Y.message||"unknown error"}`)}L.value=!1,w.value=null}}return je(()=>{D()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:v,deleteTarget:w,deleting:L,enabledCount:x,totalExecutions:g,totalLines:b,displayedSkills:C,editLineCount:T,editorLineNums:R,editValidation:S,highlight:y,truncate:gd,formatTs:Aa,countLines:A,getLineNumbers:F,toggleCode:k,copyCode:M,handleEditorKey:V,syncScroll:W,fetchSkills:D,testSkill:I,showCreate:O,editSkill:U,cancelEdit:J,saveSkill:B,confirmDelete:q,doDelete:ee}}};class Fs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const dk=/^[A-Za-z_][A-Za-z0-9_]*$/;function lp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function op(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Fs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Fs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Fs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Fs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function uk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function pk(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Fs("Server name is required.","name");if(a.length>128||!dk.test(a))throw new Fs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Fs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=lp(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Fs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Fs("An HTTP endpoint is required for this connection.","url");if(d&&!uk(d))throw new Fs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Fs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=lp(e.allowlistText));const r=op(e.headerRows,e.headersRemove,"Header"),c=op(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function fk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function hk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function mk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const vk=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function gk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const bk=1e4,yk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function xr(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function xk(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const _k={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),o=h({}),r=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),m=h(xr()),v=h(""),w=h(!1);let L=null,x=0,g=!1,b=!1;const C=vk,T=Z(()=>{var $;return(($=e.value)==null?void 0:$.servers)||[]}),R=Z(()=>{var $;return!!(($=e.value)!=null&&$.enabled)}),S=Z(()=>{var $,ve,ke,Oe;return{serverCount:(($=e.value)==null?void 0:$.server_count)||0,enabledCount:((ve=e.value)==null?void 0:ve.enabled_server_count)||0,connectedCount:((ke=e.value)==null?void 0:ke.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),y=Z(()=>{var $;return(($=f.value)==null?void 0:$.header_keys)||[]}),A=Z(()=>{var $;return(($=f.value)==null?void 0:$.env_keys)||[]}),F=Z(()=>{var $;return u.value==="edit"&&(($=f.value)==null?void 0:$.transport)==="http"}),k=Z(()=>u.value==="add"||!F.value),M=Z(()=>F.value?"Replace endpoint URL":"Endpoint URL"),V=Z(()=>F.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function W(){D(),L=window.setInterval(()=>I({quiet:!0}),bk)}function D(){L&&window.clearInterval(L),L=null}async function I({quiet:$=!1}={}){const ve=++x;$||(t.value=!0);try{const ke=await j.get("/api/mcp/status");if(ve!==x||!g)return;e.value=ke,n.value="";const Oe=new Set((ke.servers||[]).map(Pe=>Pe.name));i.value=new Set([...i.value].filter(Pe=>Oe.has(Pe)))}catch(ke){ve===x&&g&&(n.value=ke.message||"Failed to load MCP status")}finally{ve===x&&(t.value=!1)}}function O($){return s.value||a.value.has($)}function U($,ve){const ke=new Set(a.value);ve?ke.add($):ke.delete($),a.value=ke}function J($){return hk($.state)}function B($){if(J($)==="disabled"){if(!$.enabled)return"Disabled — server switch off";if(!R.value)return"Disabled — global MCP is off"}return yk[J($)]}function q($){return $.transport==="http"?"Streamable HTTP":"stdio"}function ee($){return $.negotiated_version?`${$.era?`${String($.era).charAt(0).toUpperCase()}${String($.era).slice(1)}`:"Protocol"} · ${$.negotiated_version}`:"Not negotiated"}function Y($){return $.discovered_count?`${$.published_count||0} published · ${$.excluded_count||0} excluded`:"No tools discovered"}const ce=h(new Set);async function Ne($,ve){if(ce.value.has($.name))return;const ke=!!ve.target.checked,Oe=new Set(ce.value);Oe.add($.name),ce.value=Oe;try{const Pe=await j.post(`/api/mcp/servers/${encodeURIComponent($.name)}/enabled`,{enabled:ke});Pe&&Array.isArray(Pe.servers)?e.value=Pe:await I({quiet:!0})}catch(Pe){ve.target.checked=!!$.enabled,ye.error(Pe.message||`Failed to toggle ${$.name}`)}finally{const Pe=new Set(ce.value);Pe.delete($.name),ce.value=Pe}}async function X($){if($!==R.value&&!(!$&&!await qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await j.post("/api/mcp/enabled",{enabled:$}),ye.success($?"MCP enabled":"MCP disabled"),await I({quiet:!0})}catch(ve){ye.error(ve.message||"Failed to update MCP state"),await I({quiet:!0})}finally{s.value=!1}}}async function ge($){U($.name,!0);try{await j.post(`/api/mcp/servers/${encodeURIComponent($.name)}/reconnect`,{}),ye.success(`Reconnected ${$.name}`)}catch(ve){ye.error(ve.message||`Failed to reconnect ${$.name}`)}finally{U($.name,!1),await I({quiet:!0})}}async function G($){U($.name,!0);try{await j.post(`/api/mcp/servers/${encodeURIComponent($.name)}/refresh-tools`,{}),ye.success(`Refreshed tools from ${$.name}`),await Ie($.name,!0)}catch(ve){ye.error(ve.message||`Failed to refresh ${$.name}`)}finally{U($.name,!1),await I({quiet:!0})}}async function re($){if(await qt({title:`Remove ${$.name}`,message:`Remove this saved MCP server? Its ${$.published_count||0} published tool${$.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){U($.name,!0);try{await j.del(`/api/mcp/servers/${encodeURIComponent($.name)}`),ye.success(`Removed ${$.name}`),delete o.value[$.name]}catch(ke){ye.error(ke.message||`Failed to remove ${$.name}`)}finally{U($.name,!1),await I({quiet:!0})}}}async function pe($){const ve=new Set(i.value);if(ve.has($.name)){ve.delete($.name),i.value=ve;return}ve.add($.name),i.value=ve,Object.hasOwn(o.value,$.name)||await Ie($.name)}async function Ie($,ve=!1){if(!ve&&Object.hasOwn(o.value,$))return;const ke=new Set(c.value);ke.add($),c.value=ke,r.value={...r.value,[$]:""};try{const Oe=await j.get(`/api/mcp/servers/${encodeURIComponent($)}/tools`);o.value={...o.value,[$]:Oe.tools||[]}}catch(Oe){r.value={...r.value,[$]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(c.value);Oe.delete($),c.value=Oe}}function _($){return(o.value[$]||[]).filter(ve=>mk(ve,l.value[$]))}function P($,ve){l.value={...l.value,[$]:ve}}function z(){u.value="add",p.value="",f.value=null,m.value=xr(),v.value="",d.value=!0}function le($){u.value="edit",p.value=$.name,f.value=$,m.value={...xr(),name:$.name,enabled:!!$.enabled,transport:$.transport||"stdio"},v.value="",d.value=!0}function ne(){w.value||(d.value=!1)}function ie($){d.value&&gk($)}function fe($){const ve=$==="headers"?"headerRows":"envRows";m.value[ve].push({key:"",value:""})}function ue($,ve){const ke=$==="headers"?"headerRows":"envRows";m.value[ke].splice(ve,1)}function de($,ve){const ke=$==="headers"?"headersRemove":"envRemove",Oe=m.value[ke];m.value[ke]=Oe.includes(ve)?Oe.filter(Pe=>Pe!==ve):[...Oe,ve]}async function oe(){var ve,ke;v.value="";let $;try{$=pk(m.value,{mode:u.value,originalTransport:((ve=f.value)==null?void 0:ve.transport)||""})}catch(Oe){v.value=Oe instanceof Fs?Oe.message:"Invalid MCP server configuration",await Rt(),(ke=document.querySelector(".mcp-editor"))==null||ke.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&fk($,f.value)&&!await qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){w.value=!0;try{u.value==="add"?await j.post("/api/mcp/servers",$):await j.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,$),ye.success(u.value==="add"?`Saved ${$.name}`:`Updated ${p.value}`),d.value=!1,await I({quiet:!0})}catch(Oe){v.value=Oe.message||"Failed to save MCP server"}finally{w.value=!1}}}let xe=null;function me($){`${($==null?void 0:$.event)||""} ${($==null?void 0:$.type)||""} ${($==null?void 0:$.tool)||""} ${($==null?void 0:$.message)||""}`.toLowerCase().includes("mcp")&&(xe&&window.clearTimeout(xe),xe=window.setTimeout(()=>I({quiet:!0}),200))}function _e(){g||(g=!0,b||(Ye.subscribe("events",me),b=!0),I(),W())}function Re(){g=!1,D(),xe&&window.clearTimeout(xe),xe=null,b&&(Ye.unsubscribe("events",me),b=!1)}return je(_e),os(_e),Yt(Re),ht(Re),{status:e,loading:t,mutating:s,pageError:n,servers:T,masterEnabled:R,aggregate:S,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:m,formError:v,saving:w,editorGroups:C,configuredHeaderKeys:y,configuredEnvKeys:A,savedHttpEndpoint:F,endpointRequired:k,endpointFieldLabel:M,endpointPlaceholder:V,refreshAll:I,busy:O,serverState:J,stateLabel:B,transportLabel:q,protocolLabel:ee,toolSummary:Y,formatAge:xk,setMasterEnabled:X,togglePending:ce,toggleServerEnabled:Ne,reconnect:ge,refreshTools:G,removeServer:re,toggleTools:pe,filteredTools:_,setToolQuery:P,openAdd:z,openEdit:le,closeEditor:ne,jumpToEditorGroup:ie,addSecretRow:fe,removeSecretRow:ue,toggleSecretRemoval:de,saveServer:oe}}};function wk(e,t){if(!e||!t)return np(e);const s=np(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const kk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),o=h(null),r=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),v=h(null);let w=null;const L=h(null),x=h(!1),g=h({}),b=h({}),C=h({}),T=h({}),R=new Map,S=h(null),y=Z(()=>e.value.reduce((B,q)=>B+(q.chunks||0),0)),A=Z(()=>new Set(e.value.map(q=>q.uploader).filter(Boolean)).size);function F(B,q){const ee=b.value[q];if(!ee||ee.length===0)return 0;const Y=Math.max(...ee.map(ce=>ce.char_count||0));return Y===0?0:Math.round(B.char_count/Y*100)}async function k(){t.value=!0,s.value=null;try{const B=await j.get("/api/knowledge");e.value=Array.isArray(B)?B:[]}catch(B){s.value=B.message}t.value=!1}async function M(B){if(g.value[B]){g.value[B]=!1,S.value=null;return}if(g.value[B]=!0,Object.prototype.hasOwnProperty.call(b.value,B))return;if(R.has(B))return R.get(B);const q={...T.value,[B]:!0};T.value=q;const ee={...C.value};delete ee[B],C.value=ee;const Y=j.get(`/api/knowledge/${encodeURIComponent(B)}/chunks`).then(ce=>{b.value={...b.value,[B]:Array.isArray(ce)?ce:[]}}).catch(ce=>{C.value={...C.value,[B]:ce.message||"load failed"}}).finally(()=>{if(R.get(B)!==Y)return;R.delete(B);const ce={...T.value};delete ce[B],T.value=ce});return R.set(B,Y),Y}let V=0;async function W(){const B=n.value.trim();if(!B)return;const q=++V;i.value=!0,o.value=null,l.value=B;try{const ee=await j.get(`/api/knowledge/search?q=${encodeURIComponent(B)}`);if(q!==V)return;a.value=Array.isArray(ee)?ee:[]}catch(ee){if(q!==V)return;a.value=[],o.value=ee.message||"Search failed"}q===V&&(i.value=!1)}function D(){V+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function I(){u.value=null,p.value=null;const B=c.value.trim(),q=d.value.trim();if(!B){u.value="Source name is required";return}if(!q){u.value="Content is required";return}f.value=!0;try{const ee=await j.post("/api/knowledge",{source:B,content:q});p.value=`Ingested ${ee.chunks||0} chunks from "${B}"`,c.value="",d.value="",b.value={},await k(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(ee){u.value=ee.message}f.value=!1}async function O(B){m.value=B,v.value=null,w&&(clearTimeout(w),w=null);try{const q=await j.post(`/api/knowledge/${encodeURIComponent(B)}/reingest`);v.value={source:B,error:!1,message:`Re-ingested ${q.chunks||0} chunks`},delete b.value[B],await k(),w=setTimeout(()=>{v.value=null,w=null},3e3)}catch(q){v.value={source:B,error:!0,message:q.message}}m.value=null}function U(B){L.value=B}async function J(){if(L.value){x.value=!0;try{await j.del(`/api/knowledge/${encodeURIComponent(L.value)}`),delete b.value[L.value],await k()}catch(B){ye.error(`Failed to delete source: ${B.message||"unknown error"}`)}x.value=!1,L.value=null}}return je(()=>{k()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:v,deleteTarget:L,deleting:x,expanded:g,sourceChunks:b,chunkErrors:C,loadingChunks:T,selectedChunk:S,totalChunks:y,uploaderCount:A,truncate:gd,formatTs:Aa,highlightTerms:wk,chunkBarWidth:F,fetchSources:k,toggleSource:M,doSearch:W,clearSearch:D,doIngest:I,doReingest:O,confirmDelete:U,doDelete:J}}},Sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),o=h(!1),r=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),m=h(!1),v=h(null),w=h(null),L=h(new Set),x=h(null),g=h(!1),b=h(!1),C=Z(()=>e.value.reduce((q,ee)=>q+ee.count,0)),T=Z(()=>L.value.size);function R(q){const ee=t.value[q];if(!ee)return[];if(!l.value.trim())return ee;const Y=l.value.trim().toLowerCase();return ee.filter(ce=>ce.key.toLowerCase().includes(Y)||ce.value&&ce.value.toLowerCase().includes(Y))}function S(q,ee){return L.value.has(q+"/"+ee)}function y(q,ee){const Y=q+"/"+ee,ce=new Set(L.value);ce.has(Y)?ce.delete(Y):ce.add(Y),L.value=ce}function A(q){const ee=t.value[q];return!ee||ee.length===0?!1:ee.every(Y=>L.value.has(q+"/"+Y.key))}function F(q,ee){const Y=t.value[q];if(!Y)return;const ce=new Set(L.value);for(const Ne of Y){const X=q+"/"+Ne.key;ee?ce.add(X):ce.delete(X)}L.value=ce}async function k(){s.value=!0,n.value=null;try{const q=await j.get("/api/memory");e.value=Object.entries(q).map(([ee,Y])=>({name:ee,keys:Y.keys||[],count:Y.count||0}))}catch(q){n.value=q.message}s.value=!1}async function M(q){if(a.value[q]){a.value[q]=!1;return}a.value[q]=!0;const ee=e.value.find(ce=>ce.name===q);if(!ee||t.value[q]||i.value===q)return;i.value=q;let Y;try{const Ne=(await j.get(`/api/memory/${encodeURIComponent(q)}`)).entries||{};Y=ee.keys.map(X=>Object.prototype.hasOwnProperty.call(Ne,X)?{key:X,value:Ne[X]||"",failed:!1}:{key:X,value:"",failed:!0,error:"Not found in scope"})}catch(ce){Y=ee.keys.map(Ne=>({key:Ne,value:"",failed:!0,error:ce.message||"Failed to load"}))}t.value[q]=Y,i.value=null}function V(q,ee,Y){p.value=q+"/"+ee,f.value=Y}async function W(q,ee){m.value=!0,v.value=null;try{await j.put(`/api/memory/${encodeURIComponent(q)}/${encodeURIComponent(ee)}`,{value:f.value});const Y=t.value[q];if(Y){const ce=Y.find(Ne=>Ne.key===ee);ce&&(ce.value=f.value)}p.value=null}catch(Y){v.value=`Failed to save: ${Y.message||"unknown error"}`}m.value=!1}async function D(q,ee){try{await navigator.clipboard.writeText(ee.value),w.value=q+"/"+ee.key,setTimeout(()=>{w.value=null},1500)}catch{}}async function I(){d.value=null,u.value=null;const q=r.value.scope.trim(),ee=r.value.key.trim(),Y=r.value.value.trim();if(!q){d.value="Scope is required";return}if(!ee){d.value="Key is required";return}if(!Y){d.value="Value is required";return}c.value=!0;try{await j.put(`/api/memory/${encodeURIComponent(q)}/${encodeURIComponent(ee)}`,{value:Y}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await k(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ce){d.value=ce.message}c.value=!1}function O(q,ee){x.value={scope:q,key:ee}}async function U(){if(!x.value)return;g.value=!0,v.value=null;const{scope:q,key:ee}=x.value;try{await j.del(`/api/memory/${encodeURIComponent(q)}/${encodeURIComponent(ee)}`);const Y=t.value[q];Y&&(t.value[q]=Y.filter(X=>X.key!==ee));const ce=e.value.find(X=>X.name===q);ce&&(ce.count--,ce.keys=ce.keys.filter(X=>X!==ee));const Ne=new Set(L.value);Ne.delete(q+"/"+ee),L.value=Ne}catch(Y){v.value=`Failed to delete: ${Y.message||"unknown error"}`}g.value=!1,x.value=null}function J(){b.value=!0}async function B(){g.value=!0,v.value=null;const q=[];for(const ee of L.value){const Y=ee.indexOf("/");q.push({scope:ee.slice(0,Y),key:ee.slice(Y+1)})}try{await j.post("/api/memory/bulk-delete",{entries:q}),L.value=new Set,t.value={},await k()}catch(ee){v.value=`Bulk delete failed: ${ee.message||"unknown error"}`}g.value=!1,b.value=!1}return je(()=>{k()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:m,actionError:v,copied:w,selected:L,selectedCount:T,totalEntries:C,deleteTarget:x,deleting:g,showBulkDelete:b,fetchMemory:k,toggleScope:M,startEdit:V,doEdit:W,copyValue:D,doAdd:I,confirmDelete:O,doDelete:U,confirmBulkDelete:J,doBulkDelete:B,isSelected:S,toggleSelect:y,isScopeAllSelected:A,toggleSelectAll:F,filteredEntries:R}}},Tk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),o=Z(()=>[...new Set(e.value.map(w=>w.category))].sort()),r=Z(()=>{const v={};return e.value.forEach(w=>{v[w.category]=(v[w.category]||0)+1}),v}),c=Z(()=>a.value?e.value.filter(v=>v.category===a.value):e.value);function d(v){return v==="correction"?"badge-warning":v==="operational"?"badge-info":v==="preference"?"badge-success":"badge-info"}function u(v){i.value=v.key,l.value=v.content}async function p(v){try{await j.put("/api/learned/"+encodeURIComponent(v),{content:l.value}),i.value=null,ye.success("Entry updated"),await m()}catch(w){ye.error(w.message||"Failed to save entry")}}async function f(v){if(await qt({title:"Delete learned entry",message:`Delete "${v}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await j.del("/api/learned/"+encodeURIComponent(v)),ye.success("Entry deleted"),await m()}catch(L){ye.error(L.message||"Failed to delete entry")}}async function m(){s.value=!0,n.value=null;try{const v=await j.get("/api/learned");e.value=v.entries||[],t.value={last_reflection:v.last_reflection,count:v.count}}catch(v){n.value=v.message}s.value=!1}return je(m),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:o,catCounts:r,filtered:c,catBadge:d,formatTs:Aa,startEdit:u,saveEdit:p,deleteEntry:f,fetchEntries:m}}},Qm=[{id:"tools",label:"Tools",component:lk},{id:"skills",label:"Skills",component:ck},{id:"mcp-servers",label:"MCP Servers",component:_k},{id:"knowledge",label:"Knowledge",component:kk},{id:"memory",label:"Memory",component:Sk},{id:"learned",label:"Learned",component:Tk}],Ck={components:{TabbedPage:Jo},setup(){return{tabs:Qm}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Ek={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Ak={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},Rk={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},Ik={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h(!1),a=h(!1),i=Z(()=>e.value.components||[]),l=Z(()=>Rk[e.value.overall]||"text-gray-400"),o=Z(()=>e.value.overall==="healthy"?"success":e.value.overall==="degraded"?"warning":e.value.overall==="unhealthy"?"error":"minus"),r=Z(()=>{const T=e.value.overall;return T==="healthy"?"All Systems Healthy":T==="degraded"?"Some Systems Degraded":T==="unhealthy"?"System Issues Detected":"Unknown"});function c(T){return Ek[T]||"text-gray-400"}function d(T){return Ak[T]||"info"}function u(T){return T==="ok"?"badge-success":T==="degraded"?"badge-warning":T==="down"?"badge-danger":"badge-info"}function p(T){return T==="closed"?"text-green-400":T==="half_open"?"text-yellow-400":T==="open"?"text-red-400":"text-gray-400"}function f(T){return T.replace(/_/g," ").replace(/\b\w/g,R=>R.toUpperCase())}function m(T){if(!T)return"—";try{return new Date(T).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return T}}function v(T){return T>=1e6?(T/1e6).toFixed(1)+"M":T>=1e3?(T/1e3).toFixed(1)+"K":String(T)}async function w(){a.value=!0;try{e.value=await j.get("/api/health/components"),s.value=null,n.value=!0}catch(T){s.value=T.message}finally{t.value=!1,a.value=!1}}function L(){t.value=!0,s.value=null,w()}let x=null,g=!1;function b(){g||(g=!0,w(),x||(x=setInterval(w,3e4)))}function C(){g&&(g=!1,x&&(clearInterval(x),x=null))}return je(b),os(b),Yt(C),ht(C),{data:e,hasData:n,loading:t,error:s,refreshing:a,components:i,overallColor:l,overallIcon:o,overallLabel:r,statusColor:c,statusIcon:d,badgeClass:u,circuitColor:p,formatName:f,formatTime:m,formatNumber:v,fetchHealth:w,retry:L}}},Ok={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h(!1),a=h("sessions"),i=h(null);let l=null;const o=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=Z(()=>{if(!i.value||!i.value.collected_at)return"";try{return new Date(i.value.collected_at).toLocaleTimeString()}catch{return""}}),c=Z(()=>{if(!i.value)return[];const w=i.value,L=w.storage_total_bytes||1;return[{label:"Session Persistence",mb:w.sessions.persist_dir.total_mb,bytes:w.sessions.persist_dir.total_bytes,files:w.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(w.sessions.persist_dir.total_bytes/L*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:w.knowledge.db_file.total_mb,bytes:w.knowledge.db_file.total_bytes,files:w.knowledge.db_file.file_count,pct:Math.min(100,Math.round(w.knowledge.db_file.total_bytes/L*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:w.trajectories.message_dir.total_mb,bytes:w.trajectories.message_dir.total_bytes,files:w.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(w.trajectories.message_dir.total_bytes/L*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:w.trajectories.agent_dir.total_mb,bytes:w.trajectories.agent_dir.total_bytes,files:w.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(w.trajectories.agent_dir.total_bytes/L*100)),color:"res-bar-amber"}]});async function d(){try{const w=await j.get("/api/resource-usage");i.value=w,t.value=null,s.value=!0}catch(w){t.value=w.message||"Failed to load resource usage"}finally{e.value=!1,n.value=!1}}async function u(){n.value=!0,await d()}function p(){e.value=!0,t.value=null,d()}let f=!1;function m(){f||(f=!0,d(),l||(l=setInterval(d,3e4)))}function v(){f&&(f=!1,l&&(clearInterval(l),l=null))}return je(m),os(m),Yt(v),ht(v),{hasData:s,loading:e,error:t,refreshing:n,data:i,activeTab:a,tabs:o,collectedAt:r,storageItems:c,fmtNum:bd,refresh:u,retry:p}}},Lk=new Set(["timestamp","type","level","tool_name","action","method","path","status","success","execution_time_ms","duration_ms","metadata","audit_metadata","turn","tool_input","audit_observer","_hmac","_prev_hmac","agent_id","agent_label","parent_agent_id","root_agent_id","originating_turn_id","turn_id","iteration","call_id","result_summary","detail","message","diff","error"]),Nk=new Set(["agent_id","agent_label","label","parent_agent_id","root_agent_id","originating_turn_id","turn_id","iteration","call_id","status","duration_ms","tool_input_keys","audit_observer","_hmac","_prev_hmac"]);function Dk(e){const t={};for(const s of["metadata","audit_metadata"]){if(!(e!=null&&e[s])||typeof e[s]!="object")continue;const n=Object.fromEntries(Object.entries(e[s]).filter(([a])=>!Nk.has(a)));Object.keys(n).length&&(t[s]=n)}return Object.keys(t).length?rl(t):""}function Mk(e){var a,i,l;const t=e.record;if(!t)return{body:e.text,action:"",status:"",duration:null};let s;for(const o of["result_summary","detail","message","diff","error"])if(t[o]!==void 0&&t[o]!==null&&t[o]!==""){s=t[o];break}if(s===void 0&&((a=t.metadata)!=null&&a.error)&&(s=t.metadata.error),s===void 0){const o=Object.fromEntries(Object.entries(t).filter(([r])=>!Lk.has(r)));s=Object.keys(o).length?rl(o):""}const n=t.status??((i=t.metadata)==null?void 0:i.status)??(t.error||t.success===!1?"failed":t.success===!0?"success":"");return{body:s,action:t.tool_name||t.action||(t.method?`${t.method} ${t.path||""}`.trim():t.type||""),status:n,duration:t.execution_time_ms??t.duration_ms??((l=t.metadata)==null?void 0:l.duration_ms)??null}}const Pk={components:{ToolOutput:Yo},props:{entry:{type:Object,required:!0}},emits:["copy"],setup(e){const t=Z(()=>Mk(e.entry)),s=Z(()=>{var i;return rl(((i=e.entry.record)==null?void 0:i.tool_input)??"")}),n=Z(()=>{var i,l,o;return rl(((i=e.entry.record)==null?void 0:i.error)||((o=(l=e.entry.record)==null?void 0:l.metadata)==null?void 0:o.error)||"")}),a=Z(()=>Dk(e.entry.record));return{display:t,argumentsText:s,errorText:n,metadataText:a}},template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]);let s=0;const n=h(!1),a=h(!1),i=h(!0),l=h(""),o=h(""),r=h(!1),c=h(!1),d=h(Ye.state||"disconnected"),u=Z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),p=h(null),f=h(!1),m=h(null),v=2e3,w=Uk,L=Hk,x=_r,g=h("all"),b=h(""),C=h([]),T=h(!1),R=h(""),S=h([]);function y(){try{const te=localStorage.getItem("odin-log-presets");te&&(C.value=JSON.parse(te))}catch{}}function A(){try{localStorage.setItem("odin-log-presets",JSON.stringify(C.value))}catch{}}const F=Z(()=>l.value!==""||o.value.trim()!==""||b.value!==""),k=Z(()=>{const te=_r.find(we=>we.value===b.value);return te?te.label:""}),M=Z(()=>{if(!r.value||!o.value)return null;try{return new RegExp(o.value,"i"),null}catch(te){return te.message}}),V=24,W=Z(()=>{if(q.value.length===0)return[];const te=[],we=new Date,$e=3600*1e3;for(let Ze=V-1;Ze>=0;Ze--){const wt=new Date(we.getTime()-(Ze+1)*$e),ut=new Date(we.getTime()-Ze*$e);te.push({start:wt,end:ut,label:U(wt,ut),shortLabel:ut.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Ze of q.value){if(!Ze._time)continue;const wt=Ze._time.getTime();for(const ut of te)if(wt>=ut.start.getTime()&&wt<ut.end.getTime()){ut.total++,Ze.level==="ERROR"?ut.errors++:Ze.level==="WARNING"?ut.warnings++:ut.info++;break}}return te}),D=Z(()=>{let te=1;for(const we of W.value)we.total>te&&(te=we.total);return te}),I=Z(()=>{if(W.value.length===0)return"";const te=q.value.map(Ze=>Ze._time&&Ze._time.getTime()).filter(Boolean);if(te.length===0)return"";const we=new Date(Math.min(...te));return`${q.value.length} shown, oldest ${we.toLocaleTimeString()}`}),O=Z(()=>Math.ceil(V/8));function U(te,we){const $e={hour:"2-digit",minute:"2-digit"};return te.toLocaleTimeString([],$e)+" - "+we.toLocaleTimeString([],$e)}function J(te,we){return!we||!te?"0px":Math.max(2,te/we*100)+"%"}function B(te){const we=q.value.findIndex($e=>$e._time&&$e._time.getTime()>=te.start.getTime()&&$e._time.getTime()<te.end.getTime());if(we>=0&&p.value){const $e=p.value.querySelector('[data-log-id="'+q.value[we].id+'"]');$e&&($e.scrollIntoView({behavior:"smooth",block:"center"}),i.value=!1)}}const q=Z(()=>{let te=t.value;if(l.value&&(te=te.filter(we=>(we.level||"INFO")===l.value)),b.value){const we=_r.find($e=>$e.value===b.value);if(we&&we.seconds){const $e=new Date(Date.now()-we.seconds*1e3);te=te.filter(Ze=>Ze._time&&Ze._time>=$e)}}if(o.value&&!M.value)if(r.value)try{const we=new RegExp(o.value,"i");te=te.filter($e=>{const Ze=$e.searchText,wt=$e.tool||"";return we.test(Ze)||we.test(wt)})}catch{}else{const we=o.value.toLowerCase();te=te.filter($e=>{const Ze=$e.searchText.toLowerCase(),wt=($e.tool||"").toLowerCase();return Ze.includes(we)||wt.includes(we)})}return te}),ee=Z(()=>Bk(q.value));function Y(te){const we=$k(te,++s);if(a.value){S.value.push(we);return}ce(we)}function ce(te){t.value.push(te),t.value.length>v&&(t.value=t.value.slice(-v)),i.value&&Rt(()=>Ne())}function Ne(te=!1){const we=p.value;we&&we.scrollTo({top:we.scrollHeight,behavior:te?"smooth":"instant"})}function X(){i.value=!0,f.value=!1,Rt(()=>Ne(!0))}const ge=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function G(){const te=p.value;if(!te)return;const we=te.scrollHeight-te.scrollTop-te.clientHeight<40;f.value=!i.value&&!we&&t.value.length>0,_.value&&re()}function re(){const te=p.value;!te||!i.value||te.scrollHeight-te.scrollTop-te.clientHeight>=40&&(i.value=!1,f.value=t.value.length>0)}function pe(){i.value&&requestAnimationFrame(re)}function Ie(te){ge.has(te.key)&&pe()}const _=h(!1);function P(){i.value&&(_.value=!0,requestAnimationFrame(re))}function z(){_.value&&(_.value=!1,re())}function le(){i.value&&(f.value=!1,Rt(()=>Ne()))}function ne(){if(a.value=!a.value,!a.value&&S.value.length>0){for(const te of S.value)ce(te);S.value=[]}}function ie(){t.value=[],S.value=[],f.value=!1}function fe(){let te;e.value==="search"?te=Le.value.map(wt=>{const ut=wt.error?"ERROR":"INFO",$n=wt.tool_name?`[${wt.tool_name}] `:"";return`${wt.timestamp||""} ${ut} ${$n}${wt.result_summary||wt.message||""}`}).join(`
`):te=q.value.map(rp).join(`

`);const we=new Blob([te],{type:"text/plain"}),$e=URL.createObjectURL(we),Ze=document.createElement("a");Ze.href=$e,Ze.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ze.click(),URL.revokeObjectURL($e)}function ue(te){const we=rp(te);navigator.clipboard.writeText(we).then(()=>{m.value=te.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function de(te){l.value=l.value===te?"":te,g.value="all"}function oe(te){return te.level==="ERROR"?"log-line-error":te.level==="WARNING"?"log-line-warning":"text-gray-300"}function xe(te){return te==="ERROR"?"text-red-500 font-semibold":te==="WARNING"?"text-yellow-500":"text-blue-500"}function me(te){return te==="ERROR"?"log-chip-error":te==="WARNING"?"log-chip-warning":"log-chip-info"}function _e(te){g.value=te.id;const we=te.filters;l.value=we.level||"",b.value=we.timeRange||"",o.value=we.text||"",we.levels&&(l.value=we.levels[0]||""),we.hasToolName&&(o.value="")}function Re(te){g.value=te.id,l.value=te.filters.level||"",b.value=te.filters.timeRange||"",o.value=te.filters.text||""}function $(){if(!R.value.trim())return;const te={id:"custom-"+Date.now(),name:R.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};C.value=[...C.value,te],A(),T.value=!1,R.value=""}function ve(te){C.value=C.value.filter(we=>we.id!==te),A(),g.value===te&&(g.value="all")}const ke=h("all"),Oe=h(""),Pe=h(""),dt=h(""),st=h(""),_t=h(""),Ot=h(100),rt=zk,Qe=h(!1),ae=h(!1),Se=h(""),Le=h([]),Ke=h(null),Et=h(null);function Ve(){e.value="search",Ke.value||Ft()}async function Ft(){try{Ke.value=await j.get("/api/logs/stats")}catch{}}function Ht(){const te=_t.value;if(!te){dt.value="",st.value="";return}const $e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[te];if($e){const Ze=new Date(Date.now()-$e*1e3);dt.value=rs(Ze),st.value=""}}function rs(te){const we=$e=>String($e).padStart(2,"0");return`${te.getFullYear()}-${we(te.getMonth()+1)}-${we(te.getDate())}T${we(te.getHours())}:${we(te.getMinutes())}`}function Zs(te){if(!te)return"";const we=new Date(te);return isNaN(we.getTime())?"":we.toISOString()}async function ks(){Qe.value=!0,Se.value="",ae.value=!0,Et.value=null;try{const te=new URLSearchParams;ke.value&&ke.value!=="all"&&te.set("level",ke.value),Oe.value&&te.set("tool",Oe.value),Pe.value&&te.set("q",Pe.value);const we=Zs(dt.value),$e=Zs(st.value);we&&te.set("start",we),$e&&te.set("end",$e),te.set("limit",String(Ot.value));const Ze=await j.get(`/api/logs/search?${te.toString()}`);Le.value=Ze.entries||[]}catch(te){Se.value=te.message||"Search failed",Le.value=[]}finally{Qe.value=!1}}function sa(){ke.value="all",Oe.value="",Pe.value="",dt.value="",st.value="",_t.value="",Ot.value=100,Le.value=[],ae.value=!1,Se.value="",Et.value=null}function Js(te){Et.value=Et.value===te?null:te}function Ls(te){if(!te.timestamp)return"";try{return new Date(te.timestamp).toLocaleString()}catch{return te.timestamp}}function Pn(te){return te.type==="web_action"?`${te.status||""} (${te.execution_time_ms||0}ms)`:(te.result_summary||"").slice(0,200)}function Ss(te){return te.error?"log-line-error":"text-gray-300"}function Fn(te){try{return JSON.stringify(te,null,2)}catch{return String(te)}}let zt=null,Xe=!1;function Ns(){Xe||(Xe=!0,Ye.subscribe("logs",Y),c.value=Ye.connected,d.value=Ye.state||"disconnected",zt=Ye.onState(te=>{d.value=te,c.value=te==="connected"}))}function Ds(){Xe&&(Xe=!1,Ye.unsubscribe("logs",Y),zt&&(zt(),zt=null))}return je(()=>{y(),window.addEventListener("pointerup",z),window.addEventListener("pointercancel",z)}),os(Ns),Yt(Ds),ht(()=>{Ds(),window.removeEventListener("pointerup",z),window.removeEventListener("pointercancel",z)}),{mode:e,logs:t,paused:a,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:n,groupedLogs:ee,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:q,pauseBuffer:S,showJumpBottom:f,copiedIndex:m,regexError:M,levels:w,logPresets:L,timeRanges:x,timeRange:b,activeLogPreset:g,customLogPresets:C,showSaveLogPreset:T,newLogPresetName:R,hasActiveLogFilters:F,timeRangeLabel:k,timelineBuckets:W,timelineMax:D,timelineSpanLabel:I,timelineLabelSkip:O,togglePause:ne,clearLogs:ie,exportLogs:fe,logLineClass:oe,levelClass:xe,levelChipClass:me,toggleLevel:de,copyLine:ue,jumpToBottom:X,onScroll:G,onUserScrollIntent:pe,onUserScrollKey:Ie,onAutoScrollToggle:le,onPointerDown:P,applyLogPreset:_e,applyCustomLogPreset:Re,saveLogCustomPreset:$,removeLogCustomPreset:ve,segmentHeight:J,jumpToTimelineBucket:B,searchLevel:ke,searchTool:Oe,searchKeyword:Pe,searchStart:dt,searchEnd:st,searchTimePreset:_t,searchLimit:Ot,searchLimits:rt,searching:Qe,searchRan:ae,searchError:Se,searchResults:Le,searchStats:Ke,expandedSearch:Et,switchToSearch:Ve,runSearch:ks,clearSearchFilters:sa,toggleSearchExpand:Js,formatSearchTs:Ls,searchEntryText:Pn,searchLogLineClass:Ss,formatJson:Fn,applySearchTimePreset:Ht}}};function Dl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const Vk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function qk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Xa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","computer","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Gk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},wr=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),Kk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function cp(e){return Kk.some(t=>e===t||e.startsWith(`${t}.`))}const Xm="odin_config_center_expanded_v1",ev="odin_config_center_category_v1",Wk=50,Zk=650,kr=()=>j.get("/api/config/meta");function ca(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ui(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ma(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Jk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function Yk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function tv(e,t){if(Ui(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ca(t);const n={};for(const[a,i]of Object.entries(t)){const l=tv(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function Qk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=tv(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function sv(e,t,s,n){if(Ui(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)sv(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function Xk(){try{const e=JSON.parse(localStorage.getItem(Xm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function eS(){try{const e=localStorage.getItem(ev);return Xa.some(t=>t.key===e)?e:Xa[0].key}catch{return Xa[0].key}}const tS={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),o=h(null),r=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(eS()),m=h(Xk()),v=h({}),w=h({}),L=h(""),x=h({}),g=h({}),b=h([]),C=h([]),T=h(!1),R=h(!1),S=h(!1);let y=null,A=null,F={path:null,at:0},k=0;const M=Z(()=>{var E;return(((E=t.value)==null?void 0:E.fields)||[]).filter(H=>!wr.has(H.path.split(".")[0])&&!cp(H.path))}),V=Z(()=>new Map(M.value.map(E=>[E.path,E]))),W=Z(()=>J.value.reduce((E,H)=>E+H.sections.length,0)),D=Z(()=>M.value.length),I=Z(()=>Vk),O=Z(()=>b.value.length>0),U=Z(()=>C.value.length>0),J=Z(()=>{if(!e.value)return[];const E=new Set(Xa.flatMap(Ee=>Ee.sections)),H=Xa.map(Ee=>({...Ee,sections:Ee.sections.filter(ct=>Object.hasOwn(e.value,ct)&&!wr.has(ct))})).filter(Ee=>Ee.sections.length),Q=Object.keys(e.value).filter(Ee=>!E.has(Ee)&&!wr.has(Ee));return Q.length&&H.push({key:"other",label:"Other",icon:"folder",sections:Q}),H}),B=Z(()=>e.value?{...e.value,...v.value}:null),q=Z(()=>{if(!e.value)return[];const E=[];for(const[H,Q]of Object.entries(v.value))sv(e.value[H],Q,H,E);return E.filter(H=>!Ui(H.oldVal,H.newVal)).map(H=>{const Q=P(H.path);return{...H,label:(Q==null?void 0:Q.label)||Ma(H.path.split(".").at(-1)),apply_mode:(Q==null?void 0:Q.apply_mode)||de(H.path.split(".")[0])}})}),ee=Z(()=>q.value.length>0),Y=Z(()=>q.value.length),ce=Z(()=>new Set(q.value.map(E=>E.path.split(".")[0])).size),Ne=Z(()=>!!u.value||p.value!=="all"),X=Z(()=>{const E={...g.value};for(const H of q.value){const Q=P(H.path),Ee=mi(Q,H.newVal);Ee&&(E[H.path]=Ee)}return E}),ge=Z(()=>Object.keys(X.value).length>0),G=Z(()=>e.value?(Ne.value?J.value:J.value.filter(H=>H.key===f.value)).map(H=>({...H,sections:H.sections.filter(Q=>Qe(Q))})).filter(H=>H.sections.length):[]),re=Z(()=>{const E=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],H=new Map(E.map(Q=>[Q,[]]));for(const Q of q.value){const Ee=H.has(Q.apply_mode)?Q.apply_mode:"restart";H.get(Ee).push(Q)}return E.filter(Q=>H.get(Q).length).map(Q=>({key:Q,label:Qt(Q),entries:H.get(Q)}))}),pe=Z(()=>q.value.filter(E=>E.apply_mode==="restart").length),Ie=Z(()=>M.value.filter(E=>E.pending_restart)),_=Z(()=>Ie.value.length);function P(E){const H=V.value.get(E);return H?{...H,apply_details:Dl([H])}:null}function z(E){const H=`${E}.`;return M.value.filter(Q=>Q.path===E||Q.path.startsWith(H))}function le(){return M.value.some(E=>E.path==="tools.hosts"||E.path.startsWith("tools.hosts."))}function ne(){var Q,Ee;const E=((Ee=(Q=e.value)==null?void 0:Q.tools)==null?void 0:Ee.hosts)||{},H=Object.keys(E).length;return`${H} host${H===1?"":"s"} configured.`}function ie(E){return z(E).length}function fe(E){return Ma(E)}function ue(E){const H=z(E);if(!H.length)return`${Ma(E)} configuration.`;const Q=H.find(Ts=>Ts.sensitivity==="public"&&Ts.description)||H.find(Ts=>Ts.description),Ee=(Q==null?void 0:Q.description)||"";return Ee.match(/setting for (.+)\.$/i)?`${Ma(E)} settings and runtime behaviour.`:Ee}function de(E){const H=[...new Set(z(E).map(Q=>Q.apply_mode))];return H.length===1?H[0]:H.includes("restart")?"restart":H.includes("activation_required")?"activation_required":H[0]||"restart"}function oe(E){const H=[...new Set(z(E).map(Q=>Qt(Q.apply_mode)))];return H.length?H.length===1?H[0]:`Mixed apply behaviour: ${H.join(" · ")}`:""}function xe(E){return Dl(z(E))}function me(E){var H;return Object.hasOwn(v.value,E)?v.value[E]:(H=e.value)==null?void 0:H[E]}function _e(){const E=me("mcp")||{},H=Object.keys(E.servers||{}).length;return`${E.enabled?"Globally enabled":"Globally disabled"} · ${H} configured server${H===1?"":"s"}.`}function Re(E,H){return H.split(".").reduce((Q,Ee)=>Q==null?void 0:Q[Ee],E)}function $(E){const H=B.value;return z(E).filter(Q=>cp(Q.path)?!1:Q.path.split(".").length<=2?!0:!Q.path.includes(".*")).map(Q=>({...Q,key:Q.path.split(".").at(-1),value:Re(H,Q.path),apply_details:Dl([Q]),editor:Q.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ve(E){const H=E.path.split(".");return H.length>2?H.slice(0,2).join("."):null}function ke(E){const H=new Map;for(const Q of $(E)){const Ee=ve(Q),ct=Ee||`${E}.__root`;H.has(ct)||H.set(ct,{key:ct,path:Ee,entries:[]}),H.get(ct).entries.push(Q)}return[...H.values()].map(Q=>{const Ee=Q.entries.find(ct=>ct.group_description);return{...Q,label:Q.path?Ma(Q.path.split(".").at(-1)):null,description:(Ee==null?void 0:Ee.group_description)||null,apply_details:Dl(Q.entries),runtime_summaries:Pe(Q.entries)}})}function Oe(E){return{save:E.save_effect||(E.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:E.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[E.apply_mode]||"Effective runtime state is not currently observable."}}function Pe(E){const H=new Map;for(const Q of E){const Ee=Oe(Q),ct=`${Q.apply_mode}|${Ee.save}|${Ee.runtime}`;H.has(ct)||H.set(ct,{key:ct,label:Qt(Q.apply_mode),save:Ee.save,runtime:Ee.runtime})}return[...H.values()]}function dt(E){if(st(E))return E.runtime_effect||E.activation_policy||"";if(E.apply_mode==="activation_required"){const H=E.activation_policy||E.runtime_effect;return H?`Not active after saving. No activation control exists in this release. ${H}`:"Not active after saving; no activation control exists in this release."}return""}function st(E){return E.action_available===!0&&!!(E.action_label&&E.action_endpoint)}async function _t(E){if(st(E))try{if(Et(E.path))throw new Error("Save this setting before applying its action.");const H=String(E.action_method||"POST").toLowerCase(),Q={post:j.post.bind(j),put:j.put.bind(j),delete:j.del.bind(j)}[H];if(!Q)throw new Error("Unsupported configuration action");await Q(E.action_endpoint,E.action_body||void 0),await De(),Xt("success",`${E.action_label} completed.`)}catch(H){Xt("error",H.message||`${E.action_label} failed`)}}function Ot(E,H){return[E.label,E.path,E.description,...E.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(H)}function rt(E){const H=u.value.trim().toLowerCase();return H?z(E).filter(Q=>Ot(Q,H)):[]}function Qe(E){const H=z(E);if(p.value!=="all"&&!H.some(Ee=>Ee.apply_state===p.value))return!1;const Q=u.value.trim().toLowerCase();return!Q||`${fe(E)} ${E}`.toLowerCase().includes(Q)?!0:H.some(Ee=>Ot(Ee,Q))}function ae(E,H){return z(E).filter(Q=>Q.apply_state===H).length}function Se(E){return E==="all"?D.value:M.value.filter(H=>H.apply_state===E).length}function Le(E){const H=E.sections.flatMap(Q=>z(Q));return{fields:H.length,modified:q.value.filter(Q=>E.sections.includes(Q.path.split(".")[0])).length,pending_restart:H.filter(Q=>Q.apply_state==="pending_restart").length,invalid:H.filter(Q=>Q.apply_state==="invalid").length,dormant:H.filter(Q=>Q.apply_state==="dormant").length}}function Ke(E){var H;return Object.hasOwn(v.value,E)&&!Ui((H=e.value)==null?void 0:H[E],v.value[E])}function Et(E){return q.value.some(H=>H.path===E||H.path.startsWith(`${E}.`))}function Ve(E){f.value=E,u.value="",p.value="all";try{localStorage.setItem(ev,E)}catch{}}function Ft(E){p.value=E}function Ht(){u.value="",p.value="all"}function rs(E){var H;return((H=J.value.find(Q=>Q.sections.includes(E)))==null?void 0:H.sections)||[]}function Zs(E){const H=rs(E),Q=H.find(Ee=>m.value[Ee]===!0);return Q||H.find(Ee=>m.value[Ee]!==!1)||null}function ks(E){return u.value&&!S.value&&Qe(E)?!0:S.value?Zs(E)===E:Object.hasOwn(m.value,E)?m.value[E]===!0:!0}function sa(E){const H=!ks(E);if(S.value){const Q={...m.value};for(const Ee of rs(E))Q[Ee]===!0&&(Q[Ee]=!1);Q[E]=H,m.value=Q;return}m.value={...m.value,[E]:H}}function Js(){b.value.push(ca(v.value)),b.value.length>Wk&&b.value.shift(),C.value=[]}function Ls(){ee.value&&(Js(),v.value={},g.value={},T.value=!1)}function Pn(E,H=!1){const Q=Date.now();if(H&&F.path===E&&Q-F.at<Zk){F.at=Q;return}Js(),F={path:E,at:Q}}function Ss(E,H,Q){if(!H.length)return Q;const Ee=ca(E??{});let ct=Ee;for(let Ts=0;Ts<H.length-1;Ts+=1){const pn=H[Ts];ct[pn]=ca(ct[pn]??{}),ct=ct[pn]}return ct[H.at(-1)]=Q,Ee}function Fn(E){var H;return Object.hasOwn(v.value,E)?v.value[E]:ca((H=e.value)==null?void 0:H[E])}function zt(E,H,Q={}){var Ad;const[Ee,...ct]=E.path.split(".");Pn(E.path,!!Q.coalesce);const Ts=Fn(Ee),pn=ct.length?Ss(Ts,ct,H):H,aa={...v.value};if(Ui(pn,(Ad=e.value)==null?void 0:Ad[Ee])?delete aa[Ee]:aa[Ee]=pn,v.value=aa,g.value[E.path]){const Rd={...g.value};delete Rd[E.path],g.value=Rd}}function Xe(E){F={path:null,at:0},w.value={...w.value,[E]:String(Re(B.value,E)??"")}}function Ns(E){if(F={path:null,at:0},!Object.hasOwn(w.value,E))return;const H={...w.value};delete H[E],w.value=H}function Ds(E){const H=w.value[E.path];if(F={path:null,at:0},H===""){g.value={...g.value,[E.path]:"Enter a number."};return}const Q=Number(H);if(Number.isNaN(Q)||E.type==="integer"&&!Number.isInteger(Q)){g.value={...g.value,[E.path]:E.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ee={...w.value};delete Ee[E.path],w.value=Ee,zt(E,Q,{coalesce:!0})}function te(E){return Object.hasOwn(w.value,E.path)?w.value[E.path]:E.value??""}function we(E,H){if(w.value={...w.value,[E.path]:H},H===""){g.value={...g.value,[E.path]:"Enter a number."};return}const Q=Number(H);if(!Number.isFinite(Q)||E.type==="integer"&&!Number.isInteger(Q)){g.value={...g.value,[E.path]:E.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[E.path]){const Ee={...g.value};delete Ee[E.path],g.value=Ee}zt(E,Q,{coalesce:!0})}function $e(E){const H=Number.parseInt(L.value,10);if(!Number.isInteger(H)||H<1){g.value={...g.value,[E.path]:"Warning thresholds must be positive whole numbers."};return}const Q=[...new Set([...E.value||[],H])].sort((Ee,ct)=>ct-Ee);L.value="",zt(E,Q)}function Ze(E,H){zt(E,(E.value||[]).filter(Q=>Q!==H))}function wt(E){return E.apply_mode==="live_read"?"Odin reads the saved file value on next use.":E.apply_mode==="live_for_new_work"?"New work uses the saved file value.":E.apply_mode==="live_apply"?E.apply_handler?`Apply the saved value through ${E.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":E.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":E.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":E.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ut(E){return E.type==="array"&&Array.isArray(E.value)&&!E.structured_container&&!E.structured_container_child&&E.sensitivity==="public"&&E.value.every(H=>["string","number","boolean"].includes(typeof H))}function $n(E){const H=String(x.value[E.path]??"").trim();if(!H)return;const Q=[...new Set([...E.value||[],H])];x.value={...x.value,[E.path]:""},zt(E,Q)}function js(E,H){zt(E,(E.value||[]).filter(Q=>Q!==H))}function mi(E,H){var Ee;if(!E)return null;if((Ee=E.enum)!=null&&Ee.length&&!E.enum.includes(H))return`Choose one of: ${E.enum.join(", ")}`;if(E.path==="agents.final_warning_iterations"&&(!Array.isArray(H)||!H.length))return"Add at least one warning threshold.";const Q=E.constraints||{};if((E.type==="integer"||E.type==="number")&&typeof H=="number"){if(Q.minimum!==void 0&&H<Q.minimum)return`Must be at least ${Q.minimum}${E.unit?` ${E.unit}`:""}`;if(Q.maximum!==void 0&&H>Q.maximum)return`Must be at most ${Q.maximum}${E.unit?` ${E.unit}`:""}`}return null}function vi(E){return X.value[E.path]||null}function Ia(E){const H=`${E}.`;return Object.keys(X.value).some(Q=>Q===E||Q.startsWith(H))}function na(){b.value.length&&(C.value.push(ca(v.value)),v.value=b.value.pop(),g.value={},w.value={},F={path:null,at:0})}function Bn(){C.value.length&&(b.value.push(ca(v.value)),v.value=C.value.pop(),g.value={},w.value={},F={path:null,at:0})}function Un(){!ee.value||ge.value||(T.value=!0,R.value=!1)}function Ys(){T.value=!1}function dn(){Ls()}function Qt(E){return Gk[E]||Ma(E||"unknown")}function Oa(E){return`apply-${String(E||"unknown").replaceAll("_","-")}`}function K(E){return`cfgc-field-${E.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function be(E){return`${K(E)}-input`}function Ae(E){const H=document.getElementById(K(E))||document.getElementById(K(E.split(".").slice(0,2).join(".")));H==null||H.scrollIntoView({behavior:"smooth",block:"center"})}function Xt(E,H){l.value={type:E,message:H},window.setTimeout(()=>{var Q;((Q=l.value)==null?void 0:Q.message)===H&&(l.value=null)},3500)}function un(){r.value=!1,p.value="pending_restart",u.value="";const E=qk(n.value);E&&(E.scrollTop=0)}function Hn(){r.value=!1}function Te(E=1800){A&&window.clearTimeout(A),A=window.setTimeout(N,E)}async function N(){if(c.value){if(k+=1,k>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await kr(),_.value===0){c.value=!1,d.value=null,Xt("success","Odin restarted and the saved startup settings are active.");return}}catch{}Te(2e3)}}async function se(){if(!c.value){d.value=null;try{await j.post("/api/restart",{}),c.value=!0,k=0,r.value=!1,Te()}catch(E){d.value=E.message||"Odin could not schedule a restart."}}}async function he(){if(!(!ee.value||ge.value||a.value)){a.value=!0;try{const E=Qk(e.value,v.value),H=await j.put("/api/config",E);e.value=H,v.value={},b.value=[],C.value=[],g.value={},T.value=!1;try{t.value=await kr(),o.value=null,r.value=_.value>0,Xt("success",_.value?`Configuration saved. ${_.value} setting${_.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(Q){o.value=Q.message||"Unknown metadata error.",Xt("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(E){Xt("error",E.message||"Configuration could not be saved")}finally{a.value=!1}}}async function De(){var E,H;if(!ee.value){s.value=!0,i.value=null;try{const Q=await j.get("/api/config"),Ee=await kr();e.value=Q,t.value=Ee,o.value=null;const ct=J.value;if(ct.some(Ts=>Ts.key===f.value)||(f.value=((E=ct[0])==null?void 0:E.key)||Xa[0].key),S.value){const pn=(((H=ct.find(aa=>aa.key===f.value))==null?void 0:H.sections)||[]).find(aa=>m.value[aa]===!0);m.value=pn?{...m.value,[pn]:!0}:{}}}catch(Q){i.value=Q.message||"Unknown configuration error"}finally{s.value=!1}}}function Fe(E){if(T.value||!(E.ctrlKey||E.metaKey))return;const H=E.target;H instanceof HTMLElement&&(H.matches("input, textarea, select")||H.isContentEditable)||(!E.shiftKey&&E.key.toLowerCase()==="z"?(E.preventDefault(),na()):(E.key.toLowerCase()==="y"||E.shiftKey&&E.key.toLowerCase()==="z")&&(E.preventDefault(),Bn()))}function Ue(E){S.value=E.matches}Mt(m,E=>{try{localStorage.setItem(Xm,JSON.stringify(E))}catch{}},{deep:!0});let yt=!1;function it(){yt||(yt=!0,document.addEventListener("keydown",Fe))}function vt(){yt&&(yt=!1,document.removeEventListener("keydown",Fe))}return je(()=>{var E;De(),it(),y=window.matchMedia("(max-width: 760px)"),Ue(y),(E=y.addEventListener)==null||E.call(y,"change",Ue)}),os(it),Yt(vt),ht(()=>{var E;vt(),(E=y==null?void 0:y.removeEventListener)==null||E.call(y,"change",Ue),A&&window.clearTimeout(A)}),{armKeydown:it,disarmKeydown:vt,handleKeydown:Fe,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:T,mobileOverflowOpen:R,warningThresholdInput:L,arrayInputs:x,healthFilters:I,visibleCategories:J,displayGroups:G,reviewGroups:re,sectionCount:W,fieldCount:D,hasChanges:ee,changeCount:Y,changedSectionCount:ce,hasDraftErrors:ge,canUndo:O,canRedo:U,globalFilterActive:Ne,reviewRestartCount:pe,pendingRestartCount:_,pendingRestartFields:Ie,healthCount:Se,categoryStats:Le,selectCategory:Ve,selectHealthFilter:Ft,clearFilters:Ht,sectionLabel:fe,sectionDescription:ue,sectionFieldCount:ie,sectionHealthCount:ae,sectionApplySummary:oe,sectionApplyDetails:xe,sectionEntries:$,fieldGroups:ke,sectionSearchHits:rt,mcpConfigSummary:_e,fieldRuntimeCopy:Oe,fieldSpecificRuntimeNote:dt,hasHonestAction:st,runFieldAction:_t,hasHostsCollection:le,hostsConfigSummary:ne,sectionChanged:Ke,fieldChanged:Et,isSectionExpanded:ks,toggleSection:sa,discardAllDrafts:Ls,setFieldValue:zt,setNumberFieldValue:we,numberInputValue:te,beginInputEdit:Xe,endTextInputEdit:Ns,endInputEdit:Ds,addWarningThreshold:$e,removeWarningThreshold:Ze,isScalarArray:ut,addScalarArrayItem:$n,removeScalarArrayItem:js,fieldError:vi,sectionHasErrors:Ia,undo:na,redo:Bn,openReview:Un,closeReview:Ys,mobileCancel:dn,applyModeLabel:Qt,applyClass:Oa,compactValue:Jk,formatValue:Yk,structuredApplyCopy:wt,fieldId:K,fieldInputId:be,focusField:Ae,fetchConfig:De,saveConfig:he,restartOdin:se,restartLater:Hn,reviewPendingRestart:un}}},sS=/^\d{15,25}$/;function nv(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const av={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=Z(()=>new Set((e.excludedIds||[]).map(String))),o=Z(()=>{const C=s.value.toLowerCase().trim();return(e.members||[]).filter(T=>l.value.has(String(T.id))?!1:C?u(T).toLowerCase().includes(C)||String(T.username||"").toLowerCase().includes(C)||String(T.id).includes(C):!0)}),r=Z(()=>{const C=s.value.trim();return o.value.length===0&&sS.test(C)&&!l.value.has(C)?C:""}),c=Z(()=>o.value.length+(r.value?1:0)),d=Z(()=>{if(n.value){if(o.value[a.value])return`${e.optionsId}-${a.value}`;if(r.value&&a.value===o.value.length)return`${e.optionsId}-raw`}});function u(C){return nv(C)}function p(){n.value=!0,a.value=0}function f(){p()}function m(){const C=Math.max(c.value-1,0);a.value=Math.min(a.value+1,C)}function v(){a.value=Math.max(a.value-1,0)}function w(){const C=o.value[a.value];C?L(C):r.value&&a.value===o.value.length&&x(r.value)}function L(C){x(String(C.id))}function x(C){t("select",C),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function b(){setTimeout(g,150)}return je(()=>{e.autofocus&&Rt(()=>{var C;return(C=i.value)==null?void 0:C.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:m,highlightPrevious:v,selectHighlighted:w,selectMember:L,selectId:x,closeOptions:g,onBlur:b}}};function dp(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const nS={components:{DiscordUserCombobox:av},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h(null),i=h(null),l=h(!1),o=h(null),r=h({}),c=h([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=Z(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),f=Z(()=>new Map(c.value.map(D=>[String(D.id),D])));function m(D){return D.config&&D.config.enabled!==void 0?D.config.enabled:!0}function v(D){return dp(D,"require_mention",a.value)}function w(D){return dp(D,"respond_to_bots",a.value)}function L(D){return D.config&&Object.keys(D.config).length>0}function x(D){n.value[D]=!n.value[D]}function g(D){const I=D.discord||{};return{allowed_users:[...I.allowed_users||[]],channels:[...I.channels||[]],respond_to_bots:!!I.respond_to_bots,require_mention:!!I.require_mention,ignore_bot_ids:[...I.ignore_bot_ids||[]]}}async function b({showLoading:D=!0}={}){const I=++d;D&&(t.value=!0),s.value=null;try{const O=await j.get("/api/discord/guilds");I===d&&(e.value=O)}catch(O){I===d&&(s.value=O.message)}finally{D&&I===d&&(t.value=!1)}}async function C(){t.value=!0,s.value=null;try{const[D,I,O]=await Promise.all([j.get("/api/discord/guilds"),j.get("/api/discord/members").catch(()=>[]),j.get("/api/config")]),U=g(O),J=p.value;a.value=U,J||(i.value=JSON.parse(JSON.stringify(U))),c.value=I,e.value=D,o.value=null}catch(D){s.value=D.message}finally{t.value=!1}}let T=Promise.resolve();const R=h(new Set);function S(D,I){const O=new Set(R.value);O.add(D),R.value=O;const U=T.then(I);return T=U.catch(()=>{}),U.finally(()=>{const J=new Set(R.value);J.delete(D),R.value=J})}function y(D,I,O,U){const J=(U==null?void 0:U.target)??null;return S(`guild:${D}:${I}`,async()=>{try{await j.put("/api/discord/guild/"+D+"/config",{[I]:O}),await b({showLoading:!1})}catch(B){s.value=B.message,J&&typeof O=="boolean"&&(J.checked=!O)}})}function A(D,I,O,U,J){const B=(J==null?void 0:J.target)??null;return S(`channel:${D}:${O}`,async()=>{try{await j.put("/api/discord/channel/"+D+"/config",{[O]:U}),await b({showLoading:!1})}catch(q){s.value=q.message,B&&typeof U=="boolean"&&(B.checked=!U)}})}function F(D,I){return S(`channel:${D}:clear`,async()=>{try{await j.put("/api/discord/channel/"+D+"/config",{clear:!0}),await b({showLoading:!1})}catch(O){s.value=O.message}})}function k(D,I){const O=String(I);if(!D.userAutocomplete)return O;const U=f.value.get(O);return U?nv(U):O}function M(D,I=null){const O=String(I??r.value[D]??"").trim();!O||i.value[D].includes(O)||(i.value[D]=[...i.value[D],O],r.value={...r.value,[D]:""})}function V(D,I){i.value[D]=i.value[D].filter(O=>O!==I)}async function W(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const I=(await j.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...I.allowed_users||[]],channels:[...I.channels||[]],respond_to_bots:!!I.respond_to_bots,require_mention:!!I.require_mention,ignore_bot_ids:[...I.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(D){o.value=D.message||"Global defaults could not be saved."}finally{l.value=!1}}}return je(C),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:w,hasOverride:L,toggleGuild:x,fetchAll:C,fetchGuilds:b,setGuildConfig:y,setChannelConfig:A,clearOverride:F,mutationPending:R,globalItemLabel:k,addGlobalItem:M,removeGlobalItem:V,saveGlobalDefaults:W}}},Cs=e=>e==null?e:JSON.parse(JSON.stringify(e));function aS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let f=null;const m=new Map;function v(T){d+=1;const R=c.then(T,T);return c=R.catch(()=>{}),R}function w(T,R){f=Cs(T),m.clear();for(const[S,y]of Object.entries(R||{}))m.set(S,Cs(y))}function L(T){const R=Cs(T),S=++u;return v(async()=>{try{await e(Cs(R)),f=Cs(R),S===u&&n(Cs(R))}catch(y){S===u&&(a(Cs(f)),r(y,{kind:"default"}))}})}function x(T,R){const S=Cs(R),y=(p.get(T)||0)+1;return p.set(T,y),v(async()=>{try{await t(T,Cs(S)),m.set(T,Cs(S)),y===p.get(T)&&i(T,Cs(S))}catch(A){y===p.get(T)&&(l(T,Cs(m.get(T)??null)),r(A,{kind:"user",uid:T}))}})}function g(T){const R=(p.get(T)||0)+1;return p.set(T,R),v(async()=>{try{await s(T),m.delete(T),R===p.get(T)&&o(T)}catch(S){R===p.get(T)&&(l(T,Cs(m.get(T)??null)),r(S,{kind:"delete",uid:T}))}})}async function b(){for(;;){const T=c;if(await T,T===c)return d}}async function C(T){for(;;){const R=await b(),S=await T();if(R===d)return S}}return{seed:w,saveDefault:L,saveUser:x,deleteUser:g,whenIdle:b,readSnapshot:C,get revision(){return d}}}const iS={components:{DiscordUserCombobox:av},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({}),i=h({allowed_hosts:[],default_host:""}),l=h({}),o=h(!1),r=h([]),c=Z(()=>{const k={};for(const M of r.value)k[M.id]=M;return k});function d(k){return c.value[k]||null}function u(k,M){return k?k.allowed_hosts===null||k.allowed_hosts===void 0?{allowed_hosts:[...M],default_host:k.default_host||"",allow_all:!0}:{allowed_hosts:k.allowed_hosts,default_host:k.default_host||"",allow_all:!1}:{allowed_hosts:[...M],default_host:M[0]||"",allow_all:!0}}const p=aS({applyDefault:async k=>{const M=k.allow_all?null:k.allowed_hosts;await j.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:k.default_host})},applyUser:async(k,M)=>{const V=M.allow_all?null:M.allowed_hosts;await j.put(`/api/host-access/user/${k}`,{allowed_hosts:V,default_host:M.default_host})},applyDelete:k=>j.del(`/api/host-access/user/${k}`),onDefaultConfirmed:()=>ye.success("Default policy updated"),onDefaultRollback:k=>{k&&(i.value=k)},onUserConfirmed:k=>{const M=d(k);ye.success(`Updated access for ${M?M.display_name:k}`)},onUserRollback:(k,M)=>{const V={...l.value};M?V[k]=M:delete V[k],l.value=V},onUserDeleted:k=>{const M={...l.value};delete M[k],l.value=M},onError:(k,M)=>{var W;const V=M.uid?` ${((W=d(M.uid))==null?void 0:W.display_name)||M.uid}`:"";ye.error(`${k.message||"Failed to save"} — reverted${V}`)}});let f=0;async function m(){const k=++f;e.value=!0,t.value="";try{const M=await p.readSnapshot(()=>j.get("/api/host-access"));if(k!==f)return;s.value=M,n.value=M.available_hosts||[],a.value=M.host_descriptions||{},i.value=u(M.default_policy,n.value);const V=M.users||{},W={};for(const[D,I]of Object.entries(V))W[D]=u(I,n.value);l.value=W,p.seed(i.value,W)}catch(M){k===f&&(t.value=M.message||"Failed to fetch host access data")}finally{k===f&&(e.value=!1)}try{const M=await j.get("/api/discord/members")||[];k===f&&(r.value=M)}catch{k===f&&(r.value=[])}}const v=500,w=new Map;function L(k,M){const V=w.get(k);V&&clearTimeout(V.timer);const W={run:M,timer:null};W.timer=setTimeout(()=>{w.delete(k),M()},v),w.set(k,W)}function x(k){const M=w.get(k);M&&(clearTimeout(M.timer),w.delete(k))}function g(){for(const[k,M]of[...w])clearTimeout(M.timer),w.delete(k),M.run()}function b(){L("default",()=>p.saveDefault(i.value))}function C(k,M){i.value.allow_all=!1,M?i.value.allowed_hosts.includes(k)||i.value.allowed_hosts.push(k):(i.value.allowed_hosts=i.value.allowed_hosts.filter(V=>V!==k),i.value.default_host===k&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function T(k){L(`user:${k}`,()=>{const M=l.value[k];M&&p.saveUser(k,M)})}function R(k,M,V){const W=l.value[k];W&&(W.allow_all=!1,V?W.allowed_hosts.includes(M)||W.allowed_hosts.push(M):(W.allowed_hosts=W.allowed_hosts.filter(D=>D!==M),W.default_host===M&&(W.default_host=W.allowed_hosts[0]||"")),T(k))}function S(k,M){const V=l.value[k];V&&(V.default_host=M,T(k))}function y(){o.value=!0}function A(k){!/^\d{15,25}$/.test(k)||l.value[k]||(l.value[k]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},p.saveUser(k,l.value[k]),o.value=!1)}async function F(k){const M=d(k);await qt({title:"Remove user override",message:`Remove the host access override for ${M?M.display_name:k}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(x(`user:${k}`),await p.deleteUser(k),l.value[k]||ye.success(`Removed override for ${M?M.display_name:k}`))}return je(m),Yt(g),ht(g),{loading:e,error:t,data:s,availableHosts:n,hostDescriptions:a,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:b,toggleDefaultHost:C,getMember:d,toggleUserHost:R,setUserDefault:S,openAddUser:y,addUserById:A,deleteUser:F,flushPendingSaves:g}}},lS={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=h([]),t=h(!1),s=h(""),n=h([]),a=h(!1),i=h(!1),l=h(1),o=h(""),r=h(!1),c=h(null),d=h(""),u=h([]),p=h(!1),f=h(null),m=h(""),v=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),w=h(v()),L=Z(()=>["127.0.0.1","localhost","::1"].includes(w.value.address));async function x(){t.value=!0,s.value="";try{const W=await j.get("/api/hosts");e.value=W.hosts||[],o.value=W.default_host||"",r.value=!!W.tofu_enabled}catch(W){s.value=W.message}finally{t.value=!1}}async function g(){try{await j.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),ye.success("Host settings saved and published live"),await x()}catch(W){ye.error(W.message)}}function b(){d.value="",u.value=[],p.value=!1,f.value=null,c.value=null,m.value="",l.value=1,a.value=!0}function C(){i.value=!1,w.value=v(),b()}function T(W){i.value=!0,w.value={...v(),...W},b()}async function R(){try{c.value=await j.get("/api/hosts/public-key")}catch(W){ye.error(W.message)}}async function S(W){try{const D=await j.post("/api/hosts/"+encodeURIComponent(W.alias)+"/import-legacy",{});i.value=!0,w.value={...v(),...W,trust_mode:"pinned"},b(),d.value=D.candidate_token,u.value=D.fingerprints||[],m.value=u.value.join(`
`),l.value=4,ye.info("Imported existing known_hosts trust. Test before activation.")}catch(D){ye.error(D.message)}}async function y(){try{const W=m.value.split(/\s+/).filter(Boolean),D={...w.value,expected_fingerprints:W,candidate_fingerprints:u.value},I=await j.post("/api/hosts/candidates",D);if(d.value=I.candidate_token,u.value=I.fingerprints||[],w.value.trust_mode==="tofu"&&D.candidate_fingerprints.length===0){w.value.confirm_tofu=!1,ye.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(W){ye.error(W.message)}}async function A(){var W,D;p.value=!1,f.value=null;try{const I=await j.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!I.tested,f.value=I.last_test,p.value&&(l.value=5)}catch(I){const O=(W=I.data)==null?void 0:W.last_test;O&&typeof O=="object"&&!Array.isArray(O)&&(f.value=O);const U=(D=f.value)==null?void 0:D.detail;ye.error(typeof U=="string"&&U.trim()?U:I.message)}}async function F(){try{await j.post("/api/hosts/candidates/"+d.value+"/commit",{}),ye.success("Host saved and published live"),a.value=!1,await x()}catch(W){ye.error(W.message)}}async function k(W){try{await j.post("/api/hosts/"+encodeURIComponent(W.alias)+"/enabled",{enabled:!W.enabled}),await x()}catch(D){ye.error(D.message)}}async function M(W){var D;if(await qt("Delete host "+W.alias+"? Dependencies will block deletion.")){n.value=[];try{await j.del("/api/hosts/"+encodeURIComponent(W.alias)),await x()}catch(I){n.value=Array.isArray((D=I.data)==null?void 0:D.pending_references)?I.data.pending_references:[],ye.error(I.message)}}}async function V(W){if(await qt("Force revoke "+W.alias+"? Remote outcomes may be unknown."))try{await j.post("/api/hosts/"+encodeURIComponent(W.alias)+"/force-revoke",{}),await x()}catch(D){ye.error(D.message)}}return je(x),{hosts:e,loading:t,error:s,pendingReferences:n,wizard:a,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:w,isLocal:L,keyInfo:c,candidate:d,observed:u,tested:p,testResult:f,fingerprintsText:m,load:x,saveSettings:g,beginAdd:C,beginEdit:T,loadKey:R,importLegacy:S,prepare:y,testConnection:A,commit:F,toggle:k,remove:M,forceRevoke:V}}},oS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),o=h(null),r=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=Z(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=Z(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(S){return S==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":S==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const S=await j.get("/api/tokens");s.value=S.tokens||[],n.value=S.available_hosts||[]}catch(S){t.value=S.message||"Failed to load tokens"}finally{e.value=!1}}function v(S){return!S||!S.trim()?[]:S.split(",").map(y=>y.trim()).filter(Boolean)}function w(S,y){const A=c.value.allowed_hosts;if(y&&!A.includes(S)&&A.push(S),!y){const F=A.indexOf(S);F>=0&&A.splice(F,1)}}function L(S,y){const A=d.value.allowed_hosts;if(y&&!A.includes(S)&&A.push(S),!y){const F=A.indexOf(S);F>=0&&A.splice(F,1)}}async function x(){var S;i.value=!0;try{const y=v(c.value.allowed_tools_str),A=c.value.host_mode,F=A==="none"?[]:A==="select"?c.value.allowed_hosts:null,k={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:y.length?y:[]};F!==null&&(k.allowed_hosts=F),k.default_host=c.value.default_host||"";const M=await j.post("/api/tokens",k);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ye.success("Token created"),await m()}catch(y){ye.error(((S=y.data)==null?void 0:S.error)||y.message||"Failed to create token")}finally{i.value=!1}}function g(S){o.value=S;const y=S.allowed_hosts;let A="default";y==null?A="default":Array.isArray(y)&&y.length===0?A="none":Array.isArray(y)&&(A="select"),d.value={username:S.username||"",tier:S.tier||"admin",label:S.label||"",host_mode:A,allowed_hosts:Array.isArray(y)?[...y]:[],default_host:S.default_host||"",allowed_tools_str:(S.allowed_tools||[]).join(", ")}}async function b(){var S;if(o.value){r.value=!0;try{const y=v(d.value.allowed_tools_str),A=d.value.host_mode,F={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:y};A==="none"?F.allowed_hosts=[]:A==="select"?F.allowed_hosts=d.value.allowed_hosts:F.allowed_hosts=null,F.default_host=d.value.default_host||"",await j.put("/api/tokens/"+encodeURIComponent(o.value.user_id),F),o.value=null,ye.success("Token updated"),await m()}catch(y){ye.error(((S=y.data)==null?void 0:S.error)||y.message||"Failed to update")}finally{r.value=!1}}}async function C(S){var A;if(await qt({title:"Regenerate token",message:`Regenerate token for ${S.username||S.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const F=await j.post("/api/tokens/"+encodeURIComponent(S.user_id)+"/regenerate");l.value=F.token,ye.success("Token regenerated")}catch(F){ye.error(((A=F.data)==null?void 0:A.error)||F.message||"Failed to regenerate")}}async function T(S){var A;if(await qt({title:"Delete token",message:`Delete token for ${S.username||S.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await j.del("/api/tokens/"+encodeURIComponent(S.user_id)),ye.success("Token deleted"),await m()}catch(F){ye.error(((A=F.data)==null?void 0:A.error)||F.message||"Failed to delete")}}async function R(){if(l.value)try{await navigator.clipboard.writeText(l.value),ye.success("Copied to clipboard")}catch{ye.error("Copy failed — select and copy manually")}}return je(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:f,toggleCreateHost:w,toggleEditHost:L,createToken:x,startEdit:g,saveEdit:b,confirmRegenerate:C,confirmDelete:T,copyToken:R}}},rS=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),cS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),dS=Object.freeze(["enabled","base_url","model","max_tokens"]),uS=Object.freeze(["enabled","model","max_tokens"]);function Qo(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function up(e){return Qo(e,rS)}function pp(e){return Qo(e,cS)}function pS(e,{includeApiKey:t=!1}={}){const s=Qo(e,dS);return t&&(s.api_key=e.api_key),s}function fS(e){return{timeout:e.timeout}}function hS(e,{includeApiKey:t=!1}={}){const s=Qo(e,uS);return t&&(s.api_key=e.api_key),s}function mS(e){return{timeout:e.timeout}}function Ml(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const vS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("codex"),a=h({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],l=Z(()=>{const K=a.value.model;return K&&!i.includes(K)?[K,...i]:i}),o=Z(()=>{const K=a.value.agent_model;return K&&K!=="auto"&&!i.includes(K)?[K,...i]:i}),r={"gpt-5.5":["max"],"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},c=(K,be)=>!!K&&!!be&&(r[K]||[]).includes(be),d=K=>!c(a.value.model,K)&&!(a.value.agent_reasoning_effort===""&&c(a.value.agent_model,K)),u=K=>{const be=a.value.agent_model;return be==="auto"?!0:!c(be||a.value.model,K)},p=Z(()=>{const K=a.value.agent_reasoning_effort;return K==="auto"?null:K||a.value.reasoning_effort}),f=K=>c(K,a.value.reasoning_effort)||a.value.agent_model===""&&c(K,p.value),m=K=>c(K,p.value),v=h({enabled:!1,model:"gpt-5.6-luna"}),w=h({unavailable_reason:null}),L=Z(()=>{const K=v.value.model;return K&&!i.includes(K)?[K,...i]:i});function x(K){const be=K.target.value;v.value.enabled=be!=="",be!==""&&(v.value.model=be),te()}const g=h(!1),b=h({codex:!1,ollama:!1,kimi:!1}),C=h(null),T=h(!1),R=h(""),S=h(null),y=h(!1);let A=0;const F=Z(()=>{var K;return Object.entries(((K=C.value)==null?void 0:K.models)||{}).map(([be,Ae])=>{var Xt,un,Hn;return{model:be,floor:Ae.floor,override:Ae.override,effectiveBudget:(Xt=Ae.effective)==null?void 0:Xt.effective_budget,configuredPrimaryChars:(un=Ae.configured)==null?void 0:un.primary_chars,primaryChars:(Hn=Ae.effective)==null?void 0:Hn.primary_chars,provenance:Ae.provenance,clampExpiresAt:Ae.clamp_expires_at,densityPriorMilli:Ae.density_prior_milli,densityScope:Ae.density_scope,workloadCalibration:Ae.workload_calibration}})}),k=Z(()=>{var K;return((K=C.value)==null?void 0:K.clamps)||[]}),M=Z(()=>{var K,be;return((be=(K=C.value)==null?void 0:K.models)==null?void 0:be[a.value.model])||null}),V=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),W=h({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),D=h(!1),I=h(!1),O=h(!1),U=h(!1),J=h(!1),B=h(!1),q=h(!1),ee=h({configured:null}),Y=h(!1),ce=h([]),Ne=h(""),X=h(!1),ge=h(!1),G=h({configured:null}),re=h(!1),pe=h([]),Ie=h(""),_=h(!1),P=h(!1),z=h(!0),le=h(""),ne=h({configured:null,accounts:[]}),ie=h(null),fe=h(null),ue=h(""),de=h(null),oe=h(!1),xe=h(null),me=h(null),_e=h("");let Re=null;function $(K,be="success"){ye(K,be==="error"?"error":"success")}function ve(K){if(!K)return"?";const be=K/(1024*1024*1024);return be>=1?be.toFixed(1)+" GB":(K/(1024*1024)).toFixed(0)+" MB"}function ke(K){return Number.isFinite(Number(K))?Number(K).toLocaleString():"—"}function Oe(K){return K==null?"automatic (model-derived)":Number(K).toLocaleString()+" characters"}function Pe(K){const be=new Date(K);return Number.isNaN(be.getTime())?"unknown":be.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function dt(K){return typeof K=="string"&&K.length>12?K.slice(0,8)+"…"+K.slice(-4):K}function st(K){return typeof K!="number"||!Number.isFinite(K)?"—":(K/1e3).toFixed(2)}function _t(K){return K==="temporary learned clamp"?"is-clamp":K==="override"?"is-override":"is-built-in"}function Ot(K){const be=a.value.context_budget_overrides[K.model];return K.floor!=null&&Number.isFinite(Number(be))&&Number(be)>K.floor}function rt(K,be){const Ae={...a.value.context_budget_overrides};be.target.value===""?delete Ae[K]:Ae[K]=Number(be.target.value),a.value.context_budget_overrides=Ae,y.value=!0}function Qe(K){a.value.context_utilization=K.target.value===""?"":Number(K.target.value),y.value=!0}function ae(K){const be={...a.value.context_budget_overrides};delete be[K],a.value.context_budget_overrides=be,y.value=!0}async function Se(){e.value=!0,await Promise.all([Le(),Et(),ks(),Ve(),Ke()]),e.value=!1}async function Le({preserveBasic:K=!1,preserveAdvanced:be=!1}={}){try{const Ae=await j.get("/api/llm/status");t.value=Ae,s.value=!1,n.value=Ae.active_provider||"codex",Ae.codex&&!Ds.pending()&&(K||(a.value.enabled=Ae.codex.enabled,a.value.model=Ae.codex.model||"gpt-5.6-sol",a.value.reasoning_effort=Ae.codex.reasoning_effort||"medium",a.value.agent_reasoning_effort=Ae.codex.agent_reasoning_effort||"",a.value.agent_model=Ae.codex.agent_model||""),be||(a.value.request_timeout_seconds=Ae.codex.request_timeout_seconds??a.value.request_timeout_seconds,a.value.stream_stall_timeout_seconds=Ae.codex.stream_stall_timeout_seconds??a.value.stream_stall_timeout_seconds,a.value.retry={...a.value.retry,...Ae.codex.retry||{}},a.value.connection_pool={...a.value.connection_pool,...Ae.codex.connection_pool||{}},a.value.context_compression={...a.value.context_compression,...Ae.codex.context_compression||{}},!y.value&&!O.value&&(a.value.context_budget_overrides={...Ae.codex.context_budget_overrides||{}},a.value.context_utilization=Ae.codex.context_utilization??a.value.context_utilization))),Ae.ollama&&!we.pending()&&(K||(V.value.enabled=Ae.ollama.enabled,V.value.base_url=Ae.ollama.base_url||"",V.value.model=Ae.ollama.model||"",V.value.max_tokens=Ae.ollama.max_tokens||4096),be||(V.value.timeout=Ae.ollama.timeout??V.value.timeout)),Ae.kimi&&!$e.pending()&&(K||(W.value.enabled=Ae.kimi.enabled,W.value.model=Ae.kimi.model||"",W.value.max_tokens=Ae.kimi.max_tokens||4096),be||(W.value.timeout=Ae.kimi.timeout??W.value.timeout)),Ae.auxiliary&&(w.value=Ae.auxiliary,te.pending()||(v.value.enabled=Ae.auxiliary.enabled,v.value.model=Ae.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function Ke(){const K=++A;T.value=!0,R.value="";try{const be=await j.get("/api/context/windows");if(K!==A)return;C.value=be,!O.value&&!y.value&&(a.value.context_budget_overrides=Object.fromEntries(Object.entries(be.models||{}).filter(([,Ae])=>Ae.override!=null).map(([Ae,Xt])=>[Ae,Xt.override])),a.value.context_utilization=be.utilization??a.value.context_utilization)}catch(be){K===A&&(R.value=be.message||"Failed to load context budgets")}finally{K===A&&(T.value=!1)}}async function Et(){try{if(ee.value=await j.get("/api/ollama/status"),Y.value=!1,ee.value.model&&(Ne.value=ee.value.model),ee.value.configured)try{const K=await j.get("/api/ollama/models");ce.value=K.models||[]}catch{ce.value=[]}else if(V.value.base_url)try{const K=await j.post("/api/ollama/probe-models",{base_url:V.value.base_url});ce.value=K.models||[]}catch{ce.value=[]}}catch{Y.value=!0}}async function Ve(){z.value=!0,le.value="";try{ne.value=await j.get("/api/codex/status")}catch(K){le.value=K.message||"Failed to fetch Codex status"}finally{z.value=!1}}async function Ft(){const K=t.value?t.value.active_provider:"codex";q.value=!0;try{const be=await j.post("/api/llm/switch",{provider:n.value});be.error?(n.value=K,$(be.error,"error")):($("Switched to "+n.value+" ("+be.model+")"),await Se())}catch(be){n.value=K,$(be.message||"Switch failed","error")}finally{q.value=!1}}async function Ht(){X.value=!0;try{const K=await j.post("/api/ollama/reload");$(K.configured?"Ollama reloaded":K.reason||"Ollama not configured",K.configured?"success":"error"),await Se()}catch(K){$(K.message||"Reload failed","error")}finally{X.value=!1}}async function rs(){ge.value=!0;try{await j.post("/api/ollama/model",{model:Ne.value}),$("Model set to "+Ne.value),await Se()}catch(K){$(K.message||"Failed","error")}finally{ge.value=!1}}async function Zs(){const K=V.value.base_url;if(!K){$("Enter a base URL first","error");return}B.value=!0;try{const be=await j.post("/api/ollama/probe-models",{base_url:K});ce.value=be.models||[],ce.value.length?($(ce.value.length+" model(s) found"),!V.value.model&&ce.value.length&&(V.value.model=ce.value[0].name)):$("No models found at "+K,"error")}catch(be){$(be.message||"Could not reach Ollama","error")}finally{B.value=!1}}async function ks(){try{if(G.value=await j.get("/api/kimi/status"),re.value=!1,G.value.model&&(Ie.value=G.value.model),G.value.configured)try{const K=await j.get("/api/kimi/models");pe.value=K.models||[]}catch{pe.value=[]}}catch{re.value=!0}}async function sa(){_.value=!0;try{const K=await j.post("/api/kimi/reload");$(K.configured?"Kimi reloaded":K.reason||"Kimi not configured",K.configured?"success":"error"),await Se()}catch(K){$(K.message||"Reload failed","error")}finally{_.value=!1}}async function Js(){P.value=!0;try{await j.post("/api/kimi/model",{model:Ie.value}),$("Model set to "+Ie.value),await Se()}catch(K){$(K.message||"Failed","error")}finally{P.value=!1}}async function Ls(){if(O.value){Ds();return}O.value=!0;const K=up(a.value);try{await j.put("/api/llm/codex/config",K),$("Codex config saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ve()])}catch(be){$(be.message||"Failed","error");const Ae=JSON.stringify(up(a.value))!==JSON.stringify(K);await Promise.all([Le({preserveBasic:Ae,preserveAdvanced:!0}),Ve()])}finally{O.value=!1}}async function Pn(){if(O.value)return;O.value=!0;const K=pp(a.value);try{await j.put("/api/llm/codex/config",K),JSON.stringify({context_budget_overrides:a.value.context_budget_overrides,context_utilization:a.value.context_utilization})===JSON.stringify({context_budget_overrides:K.context_budget_overrides,context_utilization:K.context_utilization})&&(y.value=!1),$("Codex advanced settings saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ve(),Ke()])}catch(be){$(be.message||"Failed","error");const Ae=JSON.stringify(pp(a.value))!==JSON.stringify(K);await Promise.all([Le({preserveBasic:!0,preserveAdvanced:Ae}),Ve(),Ke()])}finally{O.value=!1}}async function Ss(){if(U.value){we();return}U.value=!0;try{const K=D.value?V.value.api_key:null,be=pS(V.value,{includeApiKey:K!==null});await j.put("/api/llm/ollama/config",be),$("Ollama config saved"),K!==null&&V.value.api_key===K&&(V.value.api_key="",D.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(K){$(K.message||"Failed","error")}finally{U.value=!1}}async function Fn(){if(!U.value){U.value=!0;try{await j.put("/api/llm/ollama/config",fS(V.value)),$("Ollama timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(K){$(K.message||"Failed","error")}finally{U.value=!1}}}async function zt(){if(J.value){$e();return}J.value=!0;try{const K=I.value?W.value.api_key:null,be=hS(W.value,{includeApiKey:K!==null});await j.put("/api/llm/kimi/config",be),$("Kimi config saved"),K!==null&&W.value.api_key===K&&(W.value.api_key="",I.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(K){$(K.message||"Failed","error")}finally{J.value=!1}}async function Xe(){if(!J.value){J.value=!0;try{await j.put("/api/llm/kimi/config",mS(W.value)),$("Kimi timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(K){$(K.message||"Failed","error")}finally{J.value=!1}}}async function Ns(){if(g.value){te();return}g.value=!0;try{await j.put("/api/llm/auxiliary/config",v.value),$("Auxiliary config saved"),await Le()}catch(K){$(K.message||"Failed","error"),await Le()}finally{g.value=!1}}const Ds=Ml(Ls),te=Ml(Ns),we=Ml(Ss),$e=Ml(zt),Ze=()=>(Ds.cancel(),Ls()),wt=()=>(we.cancel(),Ss()),ut=()=>($e.cancel(),zt()),$n=()=>Pn(),js=()=>Fn(),mi=()=>Xe();async function vi(K){const be=K.account_key+":"+K.model;S.value=be;try{const Ae=await j.post("/api/context/windows/clear",{account_key:K.account_key,model:K.model});$(Ae.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Ke()}catch(Ae){$(Ae.message||"Failed to clear clamp","error"),await Ke()}finally{S.value=null}}async function Ia(K){try{await j.post("/api/codex/account/"+K+"/activate"),$("Active account switched"),await Ve()}catch(be){$(be.message||"Failed","error")}}async function na(K){ie.value=K;try{await j.post("/api/codex/account/"+K+"/refresh"),$("Token refreshed"),await Ve()}catch(be){$(be.message||"Refresh failed","error")}finally{ie.value=null}}function Bn(K,be){fe.value=K,ue.value=be||""}async function Un(K){try{await j.put("/api/codex/account/"+K+"/label",{label:ue.value}),$("Label updated"),fe.value=null,await Ve()}catch(be){$(be.message||"Failed","error")}}async function Ys(K,be){if(await qt({title:"Delete Codex account",message:`Delete ${be||"account #"+(K+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await j.del("/api/codex/account/"+K),$("Deleted. Pool reloaded."),await Ve()}catch(Xt){$(Xt.message||"Failed","error")}}async function dn(){oe.value=!0;try{const K=await j.post("/api/codex/device-code");xe.value=K,de.value="pending",Qt(K)}catch(K){$(K.message||"Failed","error")}finally{oe.value=!1}}async function Qt(K){Re={cancelled:!1};const be=Re;try{const Ae=await j.post("/api/codex/device-poll",{device_auth_id:K.device_auth_id,user_code:K.user_code,interval:K.interval});if(be.cancelled)return;me.value=Ae,de.value="success",await Se()}catch(Ae){if(be.cancelled)return;_e.value=Ae.message||"Device login failed",de.value="error"}}function Oa(){Re&&(Re.cancelled=!0),de.value=null,xe.value=null}return je(Se),ht(()=>{Re&&(Re.cancelled=!0),Ds.cancel(),te.cancel(),we.cancel(),$e.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:n,switching:q,advancedOpen:b,codexForm:a,codexModelOptions:l,codexAgentModelOptions:o,mainEffortAllowed:d,agentEffortAllowed:u,mainModelOptionDisabled:f,agentModelOptionDisabled:m,auxForm:v,auxData:w,auxModelOptions:L,onAuxModelChange:x,savingAux:g,saveAuxConfigDebounced:te,ollamaForm:V,kimiForm:W,savingCodex:O,savingOllama:U,savingKimi:J,probingOllama:B,ollamaKeyDirty:D,kimiKeyDirty:I,fetchCodexStatus:Ve,ollamaStatus:ee,ollamaStatusLoadFailed:Y,ollamaModels:ce,ollamaSelectedModel:Ne,reloading:X,settingModel:ge,kimiStatus:G,kimiStatusLoadFailed:re,kimiModels:pe,kimiSelectedModel:Ie,reloadingKimi:_,settingKimiModel:P,codexLoading:z,codexError:le,codexData:ne,refreshing:ie,editingLabel:fe,labelValue:ue,contextWindows:C,contextWindowsLoading:T,contextWindowsError:R,contextBudgetRows:F,activeClampRows:k,activeContextBudget:M,clearingClamp:S,contextPolicyDirty:y,deviceState:de,deviceLoading:oe,deviceInfo:xe,deviceResult:me,deviceError:_e,fetchAll:Se,fetchLLMStatus:Le,fetchOllamaStatus:Et,fetchKimiStatus:ks,switchProvider:Ft,reloadOllama:Ht,setOllamaModel:rs,reloadKimi:sa,setKimiModel:Js,probeOllamaModels:Zs,saveCodexConfig:Ls,saveOllamaConfig:Ss,saveKimiConfig:zt,saveCodexAdvancedConfig:Pn,saveOllamaAdvancedConfig:Fn,saveKimiAdvancedConfig:Xe,saveCodexConfigDebounced:Ds,saveOllamaConfigDebounced:we,saveKimiConfigDebounced:$e,saveCodexConfigNow:Ze,saveOllamaConfigNow:wt,saveKimiConfigNow:ut,saveCodexAdvancedConfigNow:$n,saveOllamaAdvancedConfigNow:js,saveKimiAdvancedConfigNow:mi,activateAccount:Ia,refreshAccount:na,startEditLabel:Bn,saveLabel:Un,deleteAccount:Ys,startDeviceLogin:dn,cancelDeviceLogin:Oa,formatSize:ve,fetchContextWindows:Ke,clearContextClamp:vi,setContextOverride:rt,setContextUtilization:Qe,resetContextOverride:ae,overrideAboveFloor:Ot,formatCount:ke,formatContextCeiling:Oe,formatExpiry:Pe,shortAccountKey:dt,provenanceClass:_t,formatDensity:st}}},fp={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function gS(e){return fp[e]||fp[(e||"").toLowerCase()]||"text-gray-400"}const bS={template:`
  ...
  `,setup(){const e=h(!0),t=h({}),s=h([]),n=h({}),a=h({}),i=h(null),l=h(null),o=h(null),r=h(null),c=h(null),d=Z(()=>{var T;return Object.values(((T=i.value)==null?void 0:T.totals)||{}).reduce((R,S)=>R+Number(S||0),0)}),u=h(""),p=h(0),f=h([]),m=Z(()=>f.value.map(T=>`${T.label} (${T.path}${T.reason?`: ${T.reason}`:""})`).join("; ")),v=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let w=null;async function L(){var A;const T=await Promise.allSettled(v.map(F=>j.get(F.path))),R=F=>T[F].status==="fulfilled"?T[F].value:null;t.value=R(0)||{};const S=R(1);s.value=Array.isArray(S)?S:S&&S.subsystems||[],n.value=R(2)||{},a.value=R(3)||{},i.value=R(4),l.value=R(5),o.value=R(6),r.value=R(7),c.value=R(8);const y=T.filter(F=>F.status==="rejected");if(f.value=T.flatMap((F,k)=>{var M;return F.status==="rejected"?[{...v[k],reason:((M=F.reason)==null?void 0:M.message)||"request failed"}]:[]}),p.value=f.value.length,y.length===T.length){const F=(A=y[0])==null?void 0:A.reason;u.value=(F==null?void 0:F.message)||"Failed to load internals"}else u.value="";e.value=!1}function x(){e.value=!0,u.value="",L()}let g=!1;function b(){g||(g=!0,L(),w||(w=setInterval(L,3e4)))}function C(){g&&(g=!1,w&&(clearInterval(w),w=null))}return je(b),os(b),Yt(C),ht(C),{loading:e,error:u,failedCount:p,failedEndpoints:f,failedEndpointSummary:m,endpoints:v,retry:x,startup:t,subsystems:s,sshPool:n,httpPool:a,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:o,freshnessStats:r,governorStats:c,statusColor:gS,formatAgeSeconds:$w}}},yS=1e4,hp=3e4;function ki(e,t){return Math.max(0,e-t)}function Sr(e,t){return new Set((e.operations||[]).map(n=>n.state)).has("MANUAL_RESOLUTION_REQUIRED")?0:e.expired_lease||e.status==="ACTIVE"&&(!e.lease_expires_at||e.lease_expires_at<t)?1:e.status==="SUSPENDED"?2:e.status==="ACTIVE"?3:4}const xS=[{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],_S={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(null),t=h(""),s=h(null),n=h(!1),a=h(0),i=h(null),l=h(""),o=h(null),r=h(!1),c=h(0),d=h(Date.now());let u=null,p=0,f=0;async function m(){const I=++p;n.value=!0;try{const O=await j.get("/api/turn-state/turns?limit=100");if(I!==p)return;t.value=O.availability,e.value=O.availability==="available"?O.data:null,s.value=null,a.value=Date.now()}catch(O){if(I!==p)return;s.value=O.message||"Turn-state read failed",O.status===503&&(t.value="unavailable")}I===p&&(n.value=!1)}async function v(){const I=++f;r.value=!0;try{const O=await j.get("/api/turn-state/capacity-breakers");if(I!==f)return;l.value=O.availability,i.value=O.availability==="available"?O.data:null,o.value=null,c.value=Date.now()}catch(O){if(I!==f)return;o.value=O.message||"Breaker read failed",O.status===503&&(l.value="unavailable")}I===f&&(r.value=!1)}function w(){m(),v()}const L=Z(()=>e.value!==null&&ki(d.value,a.value)>hp),x=Z(()=>i.value!==null&&ki(d.value,c.value)>hp),g=Z(()=>L.value||x.value),b=Z(()=>Math.round(ki(d.value,a.value)/1e3)),C=Z(()=>Math.round(ki(d.value,c.value)/1e3));function T(I){return Sr(I,d.value/1e3)}function R(I){return xS[T(I)]}const S=Z(()=>{var U;const I=[...((U=e.value)==null?void 0:U.turns)||[]],O=d.value/1e3;return I.sort((J,B)=>Sr(J,O)-Sr(B,O)||(B.last_progress_at||0)-(J.last_progress_at||0))});function y(I){return I.state==="closed"?"badge-success":I.state==="probing"?"badge-warning":"badge-danger"}function A(I){if(I.state==="closed")return"—";const O=ki(d.value,c.value)/1e3,U=Math.max(0,(I.cooldown_remaining_seconds||0)-O);return U>0?`${Math.ceil(U)}s`:I.state==="probing"?"probe in flight":"probe eligible"}function F(I){if(!I)return"";const O=Math.max(0,Math.round(d.value/1e3-I));if(O<90)return`${O}s ago`;const U=Math.round(O/60);return U<90?`${U}m ago`:`${Math.round(U/60)}h ago`}let k=null,M=null,V=!1;function W(){V||(V=!0,w(),k=setInterval(w,yS),u=setInterval(()=>{d.value=Date.now()},1e3),M=Ye.onReconnected(w))}function D(){V&&(V=!1,k&&(clearInterval(k),k=null),u&&(clearInterval(u),u=null),M&&(M(),M=null))}return je(W),os(W),Yt(D),ht(D),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:L,breakersStale:x,anyStale:g,turnsAgeSeconds:b,breakersAgeSeconds:C,sortedTurns:S,priorityOf:T,priorityBadge:R,breakerBadge:y,cooldownLabel:A,ageLabel:F,fetchTurns:m,fetchBreakers:v,refreshAll:w,arm:W,disarm:D}}},wS={setup(){const e=h(""),t=h(""),s=h(!1),n=h(""),a=h(!1),i=h(!1),l=h(!1),o=h(null),r=h(!1);async function c(){a.value=!0,o.value=null,r.value=!1;try{const u=await j.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{a.value=!1}}async function d(){if(await qt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await j.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return je(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},kS={template:`
    ...
    </section>`,setup(){const e=h({state:"unknown",available:!1}),t=h(!1),s=h(!1),n=h(!1),a=h(!1),i=h(!1),l=h(!1),o=h(""),r=h(!1),c=h(!1),d=h(null),u=h(""),p=h(!1),f=h(Date.now()),m=h(""),v=h(null);let w=0,L=null,x=!1,g=j.token,b=0;const C=B=>B===!0?"Enabled":B===!1?"Disabled":"Unknown",T=Z(()=>{const B=e.value.restart_required;return Array.isArray(B)?B.length?B.join(", "):"None reported":B===!0?"Pending; restart required":B===!1?"None reported":"Unknown"}),R=Z(()=>{var q,ee;const B=Date.parse(((q=d.value)==null?void 0:q.captured_at)||"");return Number.isFinite(B)&&f.value<B+Math.min(1e4,((ee=d.value)==null?void 0:ee.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function S(){u.value&&URL.revokeObjectURL(u.value),u.value="",d.value=null}function y(){w++,S(),v.value=null,s.value=!1,i.value=!1,l.value=!1}function A(B,q){return x&&B===w&&q===j.token}function F(B){y(),c.value=!1;const q=B.status||(B.name==="AuthError"?401:0);e.value={available:!1,state:q===503?"unavailable":"unknown"},o.value=q===401||q===403||q===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":q===410?"Evidence or artifact expired. Observe or prepare the export again.":q===503?"Computer use is disabled or unavailable.":"Request failed; outcome unknown. Refresh status. No action was replayed."}async function k(){if(t.value||r.value||n.value||a.value||!x)return;const B=w,q=j.token;t.value=!0,b=Date.now();try{const ee=await j.get("/api/computer");if(!A(B,q))return;M(ee)}catch(ee){A(B,q)&&F(ee)}finally{t.value=!1}}function M(B){(e.value.session_id&&e.value.session_id!==B.session_id||e.value.generation!=null&&e.value.generation!==B.generation)&&y(),e.value=B,c.value=!0,o.value=""}async function V(B){if(!x||!c.value||r.value||n.value||a.value)return;y();const q=w,ee=j.token;r.value=!0;try{if(await j.post("/api/computer/enabled",{enabled:B}),!A(q,ee))return;const Y=await j.get("/api/computer");A(q,ee)&&M(Y)}catch(Y){A(q,ee)&&F(Y)}finally{r.value=!1}}async function W(B){y();const q=w,ee=j.token,Y=B==="stop"?n:a;Y.value=!0;try{const ce=await j.post("/api/computer/"+B,{});A(q,ee)&&M(ce)}catch(ce){A(q,ee)&&F(ce)}finally{Y.value=!1}}async function D(){var ee;S(),p.value=!1;const B=w,q=j.token;s.value=!0;try{const Y=await j.post("/api/computer/observe",{});if(!A(B,q))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((ee=Y.frame)==null?void 0:ee.evidence_id)||""))throw new Error("Invalid evidence");const ce=await j.getBlob("/api/computer/evidence/"+Y.frame.evidence_id);if(!A(B,q))return;if(!["image/png","image/jpeg"].includes(ce.type)||ce.size>2097152||!Number.isFinite(Date.parse(Y.frame.expires_at))||Date.parse(Y.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");d.value=Y.frame,u.value=URL.createObjectURL(ce),o.value=""}catch(Y){A(B,q)&&F(Y)}finally{B===w&&(s.value=!1)}}async function I(){v.value=null;const B=w,q=j.token;i.value=!0;try{const ee=await j.post("/api/computer/export",{name:m.value});A(B,q)&&(v.value=ee,o.value="")}catch(ee){A(B,q)&&F(ee)}finally{B===w&&(i.value=!1)}}async function O(){const B=w,q=j.token,ee=v.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((ee==null?void 0:ee.artifact_id)||""))throw new Error("Invalid export");const Y=await j.getBlob("/api/computer/download/"+ee.artifact_id);if(!A(B,q))return;const ce=URL.createObjectURL(Y),Ne=document.createElement("a");Ne.href=ce,Ne.download=ee.name,Ne.click(),setTimeout(()=>URL.revokeObjectURL(ce),1e3)}catch(Y){A(B,q)&&F(Y)}finally{B===w&&(l.value=!1)}}function U(){x||(x=!0,k(),L=setInterval(()=>{f.value=Date.now(),g!==j.token&&(g=j.token,y(),c.value=!1,e.value={state:"unknown",available:!1}),d.value&&Date.parse(d.value.expires_at)<=f.value&&(S(),p.value=!0),v.value&&Date.parse(v.value.expires_at)<=f.value&&(v.value=null),f.value-b>=5e3&&k()},500))}function J(){x=!1,clearInterval(L),L=null,y(),c.value=!1}return je(U),os(U),Yt(J),ht(J),{status:e,loading:t,observing:s,stopping:n,pausing:a,exporting:i,downloading:l,error:o,frame:d,frameUrl:u,frameExpired:p,freshness:R,name:m,artifact:v,refresh:k,control:W,observe:D,clearFrame:S,exportFile:I,download:O,toggling:r,adminReady:c,enabledLabel:C,restartSettings:T,setEnabled:V}}},iv=[{id:"health",label:"Health",component:Ik},{id:"resources",label:"Resources",component:Ok},{id:"logs",label:"Logs",component:jk},{id:"config",label:"Config",component:tS},{id:"discord",label:"Discord",component:nS},{id:"hosts",label:"Hosts",component:lS},{id:"host-access",label:"Host Access",component:iS},{id:"api-tokens",label:"API Tokens",component:oS},{id:"llm",label:"LLM Config",component:vS},{id:"internals",label:"Internals",component:bS},{id:"turn-state",label:"Turn State",component:_S},{id:"computer",label:"Computer",component:kS},{id:"update",label:"Update",component:wS}],SS={components:{TabbedPage:Jo},setup(){return{tabs:iv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Pl=(e,t,s,n)=>n.map(({id:a,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:a}}})),TS=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Pl("Operations","operations","/operations",Jm),...Pl("History","history","/history",Ym),...Pl("Capabilities","capabilities","/capabilities",Qm),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Pl("System","system","/system",iv)],bs=ea({open:!1,query:"",selected:0});function mp(){bs.query="",bs.selected=0,bs.open=!0}function Tr(){bs.open=!1}function CS(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const ES={setup(){const e=zm(),t=h(null),s=Z(()=>{const i=bs.query.trim().toLowerCase();return TS.map(l=>({...l,_score:CS(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Mt(()=>bs.open,async i=>{var l;i&&(await Rt(),(l=t.value)==null||l.focus())}),Mt(()=>bs.query,()=>{bs.selected=0});function n(i){Tr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Tr();return}if(i.key==="ArrowDown")i.preventDefault(),bs.selected=Math.min(bs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),bs.selected=Math.max(bs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[bs.selected];l&&n(l)}}return{state:bs,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Tr}},template:`
    <transition name="modal">
  ...
  `},uc={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(uc));const AS={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>si("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[si("path",{d:uc[e.name]||uc.info})])}},RS=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function vp(e){return[...e.querySelectorAll(RS)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const IS={mounted(e){const t=document.activeElement,s=n=>{if(n.key!=="Tab")return;const a=vp(e);if(!a.length){n.preventDefault(),e.focus();return}const i=a[0],l=a[a.length-1];n.shiftKey&&document.activeElement===i?(n.preventDefault(),l.focus()):!n.shiftKey&&document.activeElement===l&&(n.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||vp(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},OS={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),o=h(!1),r=h([]),c=h(0),d=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const f=Z(()=>{const J=e.value.uptime_seconds||0,B=Math.floor(J/86400),q=Math.floor(J%86400/3600),ee=Math.floor(J%3600/60),Y=[];return B>0&&Y.push(`${B}d`),q>0&&Y.push(`${q}h`),(Y.length===0||B===0&&q===0)&&Y.push(`${ee}m`),Y.join(" ")}),m=Z(()=>{const J=e.value.uptime_seconds||0;return 125.66*(1-Math.min(J/86400,1))}),v=Z(()=>{const J=e.value;return[{label:"Guilds",value:J.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:J.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:J.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${J.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:J.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:J.loop_count>0?"text-green-400":"",highlight:J.loop_count>0},{label:"Agents",value:J.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:J.agent_count>0?`${J.agent_count} total`:"",subColor:"text-gray-500",highlight:(J.agent_running??0)>0},{label:"Processes",value:J.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:J.process_count>0?`${J.process_count} total`:"",subColor:"text-gray-500",highlight:(J.process_running??0)>0},{label:"Schedules",value:J.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(J.schedule_failing>0?`${J.schedule_failing} failing`:"")+(J.schedule_failing>0&&J.schedule_paused>0?", ":"")+(J.schedule_paused>0?`${J.schedule_paused} paused`:"")||void 0,subColor:J.schedule_failing>0?"text-red-400":"text-yellow-400",color:J.schedule_failing>0?"text-red-400":"",highlight:J.schedule_failing>0},{label:"Users",value:J.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),w=Z(()=>{const J=e.value,B=[];return B.push({label:"Bot",status:J.status==="online"?"ok":"warn",detail:J.status==="online"?"Online":"Starting"}),(J.schedule_failing||0)>0?B.push({label:"Schedules",status:"error",detail:`${J.schedule_failing} failing`}):(J.schedule_count||0)>0&&B.push({label:"Schedules",status:"ok",detail:`${J.schedule_count} configured`}),(J.loop_count||0)>0&&B.push({label:"Loops",status:"ok",detail:`${J.loop_count} active`}),(J.agent_running||0)>0&&B.push({label:"Agents",status:"ok",detail:`${J.agent_running} running`}),(J.process_running||0)>0&&B.push({label:"Processes",status:"ok",detail:`${J.process_running} running`}),B});async function L(){try{e.value=await j.get("/api/status"),s.value=null}catch(J){s.value=J.message}finally{t.value=!1}}let x=0,g=0,b=0,C=0;function T(J,B){const q=new Set;return[...B,...J].filter(ee=>{const Y=ee._hmac||JSON.stringify([ee.timestamp,ee.tool_name,ee.user_id,ee.result_summary,ee.error]);return q.has(Y)?!1:(q.add(Y),!0)})}async function R(){const J=++x,B=b;a.value=!0;try{const q=await j.get("/api/audit?limit=10");if(J!==x)return;const ee=B===b?[]:n.value.filter(Y=>(Y._liveEpoch||0)>B);n.value=T(q,ee).slice(0,10),c.value=ee.length}catch{}J===x&&(a.value=!1)}async function S(){const J=++g,B=C;l.value=!0;try{const q=await j.get("/api/audit?error_only=1&limit=5");if(J!==g)return;const ee=B===C?[]:i.value.filter(Y=>(Y._liveErrorEpoch||0)>B);i.value=T(q,ee).slice(0,5),o.value=!1}catch{if(J!==g)return;o.value=B===C||i.value.length===0}J===g&&(l.value=!1)}async function y(){try{const J=await j.get("/api/knowledge");d.value=(Array.isArray(J)?J:[]).reduce((B,q)=>B+(q.chunks||0),0)}catch{d.value=null}}async function A(){try{const J=await j.get("/api/agents");r.value=J.filter(B=>B.status==="running")}catch{}}async function F(){u.value={...u.value,reload:!0};try{await j.post("/api/reload"),ye.success("Config reloaded")}catch(J){ye.error(J.message)}u.value={...u.value,reload:!1}}async function k(){if(!await qt({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const B=e.value.session_count;e.value={...e.value,session_count:0};try{const q=await j.post("/api/sessions/clear-all");ye.success(`Cleared ${q.count} session${q.count!==1?"s":""}`),await L()}catch(q){e.value={...e.value,session_count:B},ye.error(q.message)}u.value={...u.value,clearSessions:!1}}async function M(){if(!await qt({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const B=e.value.loop_count;e.value={...e.value,loop_count:0};try{const q=await j.post("/api/loops/stop-all");ye.success(q.result),await L()}catch(q){e.value={...e.value,loop_count:B},ye.error(q.message)}u.value={...u.value,stopLoops:!1}}function V(){t.value=!0,s.value=null,L(),R(),S(),A()}let W=null,D=null,I=null;function O(J){if(J.payload&&J.payload.tool_name){b+=1;const B={...J.payload,_isNew:!0,_key:++p,_liveEpoch:b};n.value.unshift(B),n.value.length>10&&n.value.pop(),c.value++,B.error&&(C+=1,B._liveErrorEpoch=C,o.value=!1,i.value.unshift(B),i.value.length>5&&i.value.pop()),setTimeout(()=>{B._isNew=!1},1500),clearTimeout(I),I=setTimeout(()=>{c.value=0},1e4)}}let U=null;return je(async()=>{await Promise.all([L(),R(),S(),A(),y()]),W=setInterval(L,15e3),D=setInterval(A,1e4),Ye.subscribe("events",O),U=Ye.onReconnected(()=>{R(),S()})}),ht(()=>{W&&clearInterval(W),D&&clearInterval(D),clearTimeout(I),Ye.unsubscribe("events",O),U&&(U(),U=null)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:m,stats:v,healthIndicators:w,activity:n,activityLoading:a,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:R,fetchErrors:S,fetchStatus:L,onEvent:O,formatTime:Fw,formatDuration:ui,retry:V,reloadConfig:F,clearSessions:k,stopAllLoops:M}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function gp(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function LS(e){if(Array.isArray(e))return e}function NS(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(n=i.call(s)).done)&&(o.push(n.value),o.length!==t);r=!0);}catch(d){c=!0,a=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return o}}function DS(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function MS(e,t){return LS(e)||NS(e,t)||PS(e,t)||DS()}function PS(e,t){if(e){if(typeof e=="string")return gp(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?gp(e,t):void 0}}const lv=Object.entries,bp=Object.setPrototypeOf,FS=Object.isFrozen,$S=Object.getPrototypeOf,BS=Object.getOwnPropertyDescriptor;let ms=Object.freeze,zs=Object.seal,Ha=Object.create,ov=typeof Reflect<"u"&&Reflect,pc=ov.apply,fc=ov.construct;ms||(ms=function(t){return t});zs||(zs=function(t){return t});pc||(pc=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});fc||(fc=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const vn=Pt(Array.prototype.forEach),US=Pt(Array.prototype.lastIndexOf),yp=Pt(Array.prototype.pop),Pa=Pt(Array.prototype.push),HS=Pt(Array.prototype.splice),ds=Array.isArray,Oi=Pt(String.prototype.toLowerCase),Cr=Pt(String.prototype.toString),xp=Pt(String.prototype.match),Fa=Pt(String.prototype.replace),_p=Pt(String.prototype.indexOf),zS=Pt(String.prototype.trim),jS=Pt(Number.prototype.toString),VS=Pt(Boolean.prototype.toString),wp=typeof BigInt>"u"?null:Pt(BigInt.prototype.toString),kp=typeof Symbol>"u"?null:Pt(Symbol.prototype.toString),St=Pt(Object.prototype.hasOwnProperty),Si=Pt(Object.prototype.toString),Gt=Pt(RegExp.prototype.test),oa=qS(TypeError);function Pt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return pc(e,t,n)}}function qS(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return fc(e,s)}}function ze(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Oi;if(bp&&bp(e,null),!ds(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(FS(t)||(t[n]=i),a=i)}e[a]=!0}return e}function GS(e){for(let t=0;t<e.length;t++)St(e,t)||(e[t]=null);return e}function ts(e){const t=Ha(null);for(const n of lv(e)){var s=MS(n,2);const a=s[0],i=s[1];St(e,a)&&(ds(i)?t[a]=GS(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=ts(i):t[a]=i)}return t}function KS(e){switch(typeof e){case"string":return e;case"number":return jS(e);case"boolean":return VS(e);case"bigint":return wp?wp(e):"0";case"symbol":return kp?kp(e):"Symbol()";case"undefined":return Si(e);case"function":case"object":{if(e===null)return Si(e);const t=e,s=en(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Si(n)}return Si(e)}default:return Si(e)}}function en(e,t){for(;e!==null;){const n=BS(e,t);if(n){if(n.get)return Pt(n.get);if(typeof n.value=="function")return Pt(n.value)}e=$S(e)}function s(){return null}return s}function WS(e){try{return Gt(e,""),!0}catch{return!1}}const Sp=ms(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Er=ms(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ar=ms(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ZS=ms(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Rr=ms(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),JS=ms(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Tp=ms(["#text"]),Cp=ms(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Ir=ms(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Ep=ms(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Fl=ms(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),YS=zs(/{{[\w\W]*|^[\w\W]*}}/g),QS=zs(/<%[\w\W]*|^[\w\W]*%>/g),XS=zs(/\${[\w\W]*/g),e1=zs(/^data-[\-\w.\u00B7-\uFFFF]+$/),t1=zs(/^aria-[\-\w]+$/),Ap=zs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),s1=zs(/^(?:\w+script|data):/i),n1=zs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),a1=zs(/^html$/i),i1=zs(/^[a-z][.\w]*(-[.\w]+)+$/i),Qs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},l1=function(){return typeof window>"u"?null:window},o1=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Rp=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function rv(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:l1();const t=Te=>rv(Te);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Qs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,f=en(p,"cloneNode"),m=en(p,"remove"),v=en(p,"nextSibling"),w=en(p,"childNodes"),L=en(p,"parentNode"),x=en(p,"shadowRoot"),g=en(p,"attributes"),b=l&&l.prototype?en(l.prototype,"nodeType"):null,C=l&&l.prototype?en(l.prototype,"nodeName"):null;if(typeof i=="function"){const Te=s.createElement("template");Te.content&&Te.content.ownerDocument&&(s=Te.content.ownerDocument)}let T,R="",S,y=!1,A=0;const F=function(){if(A>0)throw oa('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},k=function(N){F(),A++;try{return T.createHTML(N)}finally{A--}},M=function(N){F(),A++;try{return T.createScriptURL(N)}finally{A--}},V=function(){return y||(S=o1(u,a),y=!0),S},W=s,D=W.implementation,I=W.createNodeIterator,O=W.createDocumentFragment,U=W.getElementsByTagName,J=n.importNode;let B=Rp();t.isSupported=typeof lv=="function"&&typeof L=="function"&&D&&D.createHTMLDocument!==void 0;const q=YS,ee=QS,Y=XS,ce=e1,Ne=t1,X=s1,ge=n1,G=i1;let re=Ap,pe=null;const Ie=ze({},[...Sp,...Er,...Ar,...Rr,...Tp]);let _=null;const P=ze({},[...Cp,...Ir,...Ep,...Fl]);let z=Object.seal(Ha(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),le=null,ne=null;const ie=Object.seal(Ha(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let fe=!0,ue=!0,de=!1,oe=!0,xe=!1,me=!0,_e=!1,Re=!1,$=!1,ve=!1,ke=!1,Oe=!1,Pe=!0,dt=!1;const st="user-content-";let _t=!0,Ot=!1,rt={},Qe=null;const ae=ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Se=null;const Le=ze({},["audio","video","img","source","image","track"]);let Ke=null;const Et=ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ve="http://www.w3.org/1998/Math/MathML",Ft="http://www.w3.org/2000/svg",Ht="http://www.w3.org/1999/xhtml";let rs=Ht,Zs=!1,ks=null;const sa=ze({},[Ve,Ft,Ht],Cr);let Js=ze({},["mi","mo","mn","ms","mtext"]),Ls=ze({},["annotation-xml"]);const Pn=ze({},["title","style","font","a","script"]);let Ss=null;const Fn=["application/xhtml+xml","text/html"],zt="text/html";let Xe=null,Ns=null;const Ds=s.createElement("form"),te=function(N){return N instanceof RegExp||N instanceof Function},we=function(){let N=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ns&&Ns===N)return;(!N||typeof N!="object")&&(N={}),N=ts(N),Ss=Fn.indexOf(N.PARSER_MEDIA_TYPE)===-1?zt:N.PARSER_MEDIA_TYPE,Xe=Ss==="application/xhtml+xml"?Cr:Oi,pe=St(N,"ALLOWED_TAGS")&&ds(N.ALLOWED_TAGS)?ze({},N.ALLOWED_TAGS,Xe):Ie,_=St(N,"ALLOWED_ATTR")&&ds(N.ALLOWED_ATTR)?ze({},N.ALLOWED_ATTR,Xe):P,ks=St(N,"ALLOWED_NAMESPACES")&&ds(N.ALLOWED_NAMESPACES)?ze({},N.ALLOWED_NAMESPACES,Cr):sa,Ke=St(N,"ADD_URI_SAFE_ATTR")&&ds(N.ADD_URI_SAFE_ATTR)?ze(ts(Et),N.ADD_URI_SAFE_ATTR,Xe):Et,Se=St(N,"ADD_DATA_URI_TAGS")&&ds(N.ADD_DATA_URI_TAGS)?ze(ts(Le),N.ADD_DATA_URI_TAGS,Xe):Le,Qe=St(N,"FORBID_CONTENTS")&&ds(N.FORBID_CONTENTS)?ze({},N.FORBID_CONTENTS,Xe):ae,le=St(N,"FORBID_TAGS")&&ds(N.FORBID_TAGS)?ze({},N.FORBID_TAGS,Xe):ts({}),ne=St(N,"FORBID_ATTR")&&ds(N.FORBID_ATTR)?ze({},N.FORBID_ATTR,Xe):ts({}),rt=St(N,"USE_PROFILES")?N.USE_PROFILES&&typeof N.USE_PROFILES=="object"?ts(N.USE_PROFILES):N.USE_PROFILES:!1,fe=N.ALLOW_ARIA_ATTR!==!1,ue=N.ALLOW_DATA_ATTR!==!1,de=N.ALLOW_UNKNOWN_PROTOCOLS||!1,oe=N.ALLOW_SELF_CLOSE_IN_ATTR!==!1,xe=N.SAFE_FOR_TEMPLATES||!1,me=N.SAFE_FOR_XML!==!1,_e=N.WHOLE_DOCUMENT||!1,ve=N.RETURN_DOM||!1,ke=N.RETURN_DOM_FRAGMENT||!1,Oe=N.RETURN_TRUSTED_TYPE||!1,$=N.FORCE_BODY||!1,Pe=N.SANITIZE_DOM!==!1,dt=N.SANITIZE_NAMED_PROPS||!1,_t=N.KEEP_CONTENT!==!1,Ot=N.IN_PLACE||!1,re=WS(N.ALLOWED_URI_REGEXP)?N.ALLOWED_URI_REGEXP:Ap,rs=typeof N.NAMESPACE=="string"?N.NAMESPACE:Ht,Js=St(N,"MATHML_TEXT_INTEGRATION_POINTS")&&N.MATHML_TEXT_INTEGRATION_POINTS&&typeof N.MATHML_TEXT_INTEGRATION_POINTS=="object"?ts(N.MATHML_TEXT_INTEGRATION_POINTS):ze({},["mi","mo","mn","ms","mtext"]),Ls=St(N,"HTML_INTEGRATION_POINTS")&&N.HTML_INTEGRATION_POINTS&&typeof N.HTML_INTEGRATION_POINTS=="object"?ts(N.HTML_INTEGRATION_POINTS):ze({},["annotation-xml"]);const se=St(N,"CUSTOM_ELEMENT_HANDLING")&&N.CUSTOM_ELEMENT_HANDLING&&typeof N.CUSTOM_ELEMENT_HANDLING=="object"?ts(N.CUSTOM_ELEMENT_HANDLING):Ha(null);if(z=Ha(null),St(se,"tagNameCheck")&&te(se.tagNameCheck)&&(z.tagNameCheck=se.tagNameCheck),St(se,"attributeNameCheck")&&te(se.attributeNameCheck)&&(z.attributeNameCheck=se.attributeNameCheck),St(se,"allowCustomizedBuiltInElements")&&typeof se.allowCustomizedBuiltInElements=="boolean"&&(z.allowCustomizedBuiltInElements=se.allowCustomizedBuiltInElements),xe&&(ue=!1),ke&&(ve=!0),rt&&(pe=ze({},Tp),_=Ha(null),rt.html===!0&&(ze(pe,Sp),ze(_,Cp)),rt.svg===!0&&(ze(pe,Er),ze(_,Ir),ze(_,Fl)),rt.svgFilters===!0&&(ze(pe,Ar),ze(_,Ir),ze(_,Fl)),rt.mathMl===!0&&(ze(pe,Rr),ze(_,Ep),ze(_,Fl))),ie.tagCheck=null,ie.attributeCheck=null,St(N,"ADD_TAGS")&&(typeof N.ADD_TAGS=="function"?ie.tagCheck=N.ADD_TAGS:ds(N.ADD_TAGS)&&(pe===Ie&&(pe=ts(pe)),ze(pe,N.ADD_TAGS,Xe))),St(N,"ADD_ATTR")&&(typeof N.ADD_ATTR=="function"?ie.attributeCheck=N.ADD_ATTR:ds(N.ADD_ATTR)&&(_===P&&(_=ts(_)),ze(_,N.ADD_ATTR,Xe))),St(N,"ADD_URI_SAFE_ATTR")&&ds(N.ADD_URI_SAFE_ATTR)&&ze(Ke,N.ADD_URI_SAFE_ATTR,Xe),St(N,"FORBID_CONTENTS")&&ds(N.FORBID_CONTENTS)&&(Qe===ae&&(Qe=ts(Qe)),ze(Qe,N.FORBID_CONTENTS,Xe)),St(N,"ADD_FORBID_CONTENTS")&&ds(N.ADD_FORBID_CONTENTS)&&(Qe===ae&&(Qe=ts(Qe)),ze(Qe,N.ADD_FORBID_CONTENTS,Xe)),_t&&(pe["#text"]=!0),_e&&ze(pe,["html","head","body"]),pe.table&&(ze(pe,["tbody"]),delete le.tbody),N.TRUSTED_TYPES_POLICY){if(typeof N.TRUSTED_TYPES_POLICY.createHTML!="function")throw oa('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof N.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw oa('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const he=T;T=N.TRUSTED_TYPES_POLICY;try{R=k("")}catch(De){throw T=he,De}}else N.TRUSTED_TYPES_POLICY===null?(T=void 0,R=""):(T===void 0&&(T=V()),T&&typeof R=="string"&&(R=k("")));(B.uponSanitizeElement.length>0||B.uponSanitizeAttribute.length>0)&&pe===Ie&&(pe=ts(pe)),B.uponSanitizeAttribute.length>0&&_===P&&(_=ts(_)),ms&&ms(N),Ns=N},$e=ze({},[...Er,...Ar,...ZS]),Ze=ze({},[...Rr,...JS]),wt=function(N){let se=L(N);(!se||!se.tagName)&&(se={namespaceURI:rs,tagName:"template"});const he=Oi(N.tagName),De=Oi(se.tagName);return ks[N.namespaceURI]?N.namespaceURI===Ft?se.namespaceURI===Ht?he==="svg":se.namespaceURI===Ve?he==="svg"&&(De==="annotation-xml"||Js[De]):!!$e[he]:N.namespaceURI===Ve?se.namespaceURI===Ht?he==="math":se.namespaceURI===Ft?he==="math"&&Ls[De]:!!Ze[he]:N.namespaceURI===Ht?se.namespaceURI===Ft&&!Ls[De]||se.namespaceURI===Ve&&!Js[De]?!1:!Ze[he]&&(Pn[he]||!$e[he]):!!(Ss==="application/xhtml+xml"&&ks[N.namespaceURI]):!1},ut=function(N){Pa(t.removed,{element:N});try{L(N).removeChild(N)}catch{if(m(N),!L(N))throw oa("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},$n=function(N){const se=w?w(N):N.childNodes;if(se){const De=[];vn(se,Fe=>{Pa(De,Fe)}),vn(De,Fe=>{try{m(Fe)}catch{}})}const he=g?g(N):null;if(he)for(let De=he.length-1;De>=0;--De){const Fe=he[De],Ue=Fe&&Fe.name;if(typeof Ue=="string")try{N.removeAttribute(Ue)}catch{}}},js=function(N,se){try{Pa(t.removed,{attribute:se.getAttributeNode(N),from:se})}catch{Pa(t.removed,{attribute:null,from:se})}if(se.removeAttribute(N),N==="is")if(ve||ke)try{ut(se)}catch{}else try{se.setAttribute(N,"")}catch{}},mi=function(N){const se=g?g(N):N.attributes;if(se)for(let he=se.length-1;he>=0;--he){const De=se[he],Fe=De&&De.name;if(!(typeof Fe!="string"||_[Xe(Fe)]))try{N.removeAttribute(Fe)}catch{}}},vi=function(N){const se=[N];for(;se.length>0;){const he=se.pop();(b?b(he):he.nodeType)===Qs.element&&mi(he);const Fe=w?w(he):he.childNodes;if(Fe)for(let Ue=Fe.length-1;Ue>=0;--Ue)se.push(Fe[Ue])}},Ia=function(N){let se=null,he=null;if($)N="<remove></remove>"+N;else{const Ue=xp(N,/^[\r\n\t ]+/);he=Ue&&Ue[0]}Ss==="application/xhtml+xml"&&rs===Ht&&(N='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+N+"</body></html>");const De=T?k(N):N;if(rs===Ht)try{se=new d().parseFromString(De,Ss)}catch{}if(!se||!se.documentElement){se=D.createDocument(rs,"template",null);try{se.documentElement.innerHTML=Zs?R:De}catch{}}const Fe=se.body||se.documentElement;return N&&he&&Fe.insertBefore(s.createTextNode(he),Fe.childNodes[0]||null),rs===Ht?U.call(se,_e?"html":"body")[0]:_e?se.documentElement:Fe},na=function(N){return I.call(N.ownerDocument||N,N,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},Bn=function(N){var se,he;N.normalize();const De=I.call(N.ownerDocument||N,N,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let Fe=De.nextNode();for(;Fe;){let yt=Fe.data;vn([q,ee,Y],it=>{yt=Fa(yt,it," ")}),Fe.data=yt,Fe=De.nextNode()}const Ue=(se=(he=N.querySelectorAll)===null||he===void 0?void 0:he.call(N,"template"))!==null&&se!==void 0?se:[];vn(Array.from(Ue),yt=>{Ys(yt.content)&&Bn(yt.content)})},Un=function(N){const se=C?C(N):null;return typeof se!="string"||Xe(se)!=="form"?!1:typeof N.nodeName!="string"||typeof N.textContent!="string"||typeof N.removeChild!="function"||N.attributes!==g(N)||typeof N.removeAttribute!="function"||typeof N.setAttribute!="function"||typeof N.namespaceURI!="string"||typeof N.insertBefore!="function"||typeof N.hasChildNodes!="function"||N.nodeType!==b(N)||N.childNodes!==w(N)},Ys=function(N){if(!b||typeof N!="object"||N===null)return!1;try{return b(N)===Qs.documentFragment}catch{return!1}},dn=function(N){if(!b||typeof N!="object"||N===null)return!1;try{return typeof b(N)=="number"}catch{return!1}};function Qt(Te,N,se){vn(Te,he=>{he.call(t,N,se,Ns)})}const Oa=function(N){let se=null;if(Qt(B.beforeSanitizeElements,N,null),Un(N))return ut(N),!0;const he=Xe(C?C(N):N.nodeName);if(Qt(B.uponSanitizeElement,N,{tagName:he,allowedTags:pe}),me&&N.hasChildNodes()&&!dn(N.firstElementChild)&&Gt(/<[/\w!]/g,N.innerHTML)&&Gt(/<[/\w!]/g,N.textContent)||me&&N.namespaceURI===Ht&&he==="style"&&dn(N.firstElementChild)||N.nodeType===Qs.progressingInstruction||me&&N.nodeType===Qs.comment&&Gt(/<[/\w]/g,N.data))return ut(N),!0;if(le[he]||!(ie.tagCheck instanceof Function&&ie.tagCheck(he))&&!pe[he]){if(!le[he]&&Ae(he)&&(z.tagNameCheck instanceof RegExp&&Gt(z.tagNameCheck,he)||z.tagNameCheck instanceof Function&&z.tagNameCheck(he)))return!1;if(_t&&!Qe[he]){const Fe=L(N),Ue=w(N);if(Ue&&Fe){const yt=Ue.length;for(let it=yt-1;it>=0;--it){const vt=Ot?Ue[it]:f(Ue[it],!0);Fe.insertBefore(vt,v(N))}}}return ut(N),!0}return(b?b(N):N.nodeType)===Qs.element&&!wt(N)||(he==="noscript"||he==="noembed"||he==="noframes")&&Gt(/<\/no(script|embed|frames)/i,N.innerHTML)?(ut(N),!0):(xe&&N.nodeType===Qs.text&&(se=N.textContent,vn([q,ee,Y],Fe=>{se=Fa(se,Fe," ")}),N.textContent!==se&&(Pa(t.removed,{element:N.cloneNode()}),N.textContent=se)),Qt(B.afterSanitizeElements,N,null),!1)},K=function(N,se,he){if(ne[se]||Pe&&(se==="id"||se==="name")&&(he in s||he in Ds))return!1;const De=_[se]||ie.attributeCheck instanceof Function&&ie.attributeCheck(se,N);if(!(ue&&!ne[se]&&Gt(ce,se))){if(!(fe&&Gt(Ne,se))){if(!De||ne[se]){if(!(Ae(N)&&(z.tagNameCheck instanceof RegExp&&Gt(z.tagNameCheck,N)||z.tagNameCheck instanceof Function&&z.tagNameCheck(N))&&(z.attributeNameCheck instanceof RegExp&&Gt(z.attributeNameCheck,se)||z.attributeNameCheck instanceof Function&&z.attributeNameCheck(se,N))||se==="is"&&z.allowCustomizedBuiltInElements&&(z.tagNameCheck instanceof RegExp&&Gt(z.tagNameCheck,he)||z.tagNameCheck instanceof Function&&z.tagNameCheck(he))))return!1}else if(!Ke[se]){if(!Gt(re,Fa(he,ge,""))){if(!((se==="src"||se==="xlink:href"||se==="href")&&N!=="script"&&_p(he,"data:")===0&&Se[N])){if(!(de&&!Gt(X,Fa(he,ge,"")))){if(he)return!1}}}}}}return!0},be=ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Ae=function(N){return!be[Oi(N)]&&Gt(G,N)},Xt=function(N){Qt(B.beforeSanitizeAttributes,N,null);const se=N.attributes;if(!se||Un(N))return;const he={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:_,forceKeepAttr:void 0};let De=se.length;for(;De--;){const Fe=se[De],Ue=Fe.name,yt=Fe.namespaceURI,it=Fe.value,vt=Xe(Ue),E=it;let H=Ue==="value"?E:zS(E);if(he.attrName=vt,he.attrValue=H,he.keepAttr=!0,he.forceKeepAttr=void 0,Qt(B.uponSanitizeAttribute,N,he),H=he.attrValue,dt&&(vt==="id"||vt==="name")&&_p(H,st)!==0&&(js(Ue,N),H=st+H),me&&Gt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,H)){js(Ue,N);continue}if(vt==="attributename"&&xp(H,"href")){js(Ue,N);continue}if(he.forceKeepAttr)continue;if(!he.keepAttr){js(Ue,N);continue}if(!oe&&Gt(/\/>/i,H)){js(Ue,N);continue}xe&&vn([q,ee,Y],Ee=>{H=Fa(H,Ee," ")});const Q=Xe(N.nodeName);if(!K(Q,vt,H)){js(Ue,N);continue}if(T&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!yt)switch(u.getAttributeType(Q,vt)){case"TrustedHTML":{H=k(H);break}case"TrustedScriptURL":{H=M(H);break}}if(H!==E)try{yt?N.setAttributeNS(yt,Ue,H):N.setAttribute(Ue,H),Un(N)?ut(N):yp(t.removed)}catch{js(Ue,N)}}Qt(B.afterSanitizeAttributes,N,null)},un=function(N){let se=null;const he=na(N);for(Qt(B.beforeSanitizeShadowDOM,N,null);se=he.nextNode();)if(Qt(B.uponSanitizeShadowNode,se,null),Oa(se),Xt(se),Ys(se.content)&&un(se.content),(b?b(se):se.nodeType)===Qs.element){const Fe=x?x(se):se.shadowRoot;Ys(Fe)&&(Hn(Fe),un(Fe))}Qt(B.afterSanitizeShadowDOM,N,null)},Hn=function(N){const se=[{node:N,shadow:null}];for(;se.length>0;){const he=se.pop();if(he.shadow){un(he.shadow);continue}const De=he.node,Ue=(b?b(De):De.nodeType)===Qs.element,yt=w?w(De):De.childNodes;if(yt)for(let it=yt.length-1;it>=0;--it)se.push({node:yt[it],shadow:null});if(Ue){const it=C?C(De):null;if(typeof it=="string"&&Xe(it)==="template"){const vt=De.content;Ys(vt)&&se.push({node:vt,shadow:null})}}if(Ue){const it=x?x(De):De.shadowRoot;Ys(it)&&se.push({node:null,shadow:it},{node:it,shadow:null})}}};return t.sanitize=function(Te){let N=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},se=null,he=null,De=null,Fe=null;if(Zs=!Te,Zs&&(Te="<!-->"),typeof Te!="string"&&!dn(Te)&&(Te=KS(Te),typeof Te!="string"))throw oa("dirty is not a string, aborting");if(!t.isSupported)return Te;Re||we(N),t.removed=[];const Ue=Ot&&typeof Te!="string"&&dn(Te);if(Ue){const vt=C?C(Te):Te.nodeName;if(typeof vt=="string"){const E=Xe(vt);if(!pe[E]||le[E])throw oa("root node is forbidden and cannot be sanitized in-place")}if(Un(Te))throw oa("root node is clobbered and cannot be sanitized in-place");try{Hn(Te)}catch(E){throw $n(Te),E}}else if(dn(Te))se=Ia("<!---->"),he=se.ownerDocument.importNode(Te,!0),he.nodeType===Qs.element&&he.nodeName==="BODY"||he.nodeName==="HTML"?se=he:se.appendChild(he),Hn(he);else{if(!ve&&!xe&&!_e&&Te.indexOf("<")===-1)return T&&Oe?k(Te):Te;if(se=Ia(Te),!se)return ve?null:Oe?R:""}se&&$&&ut(se.firstChild);const yt=na(Ue?Te:se);try{for(;De=yt.nextNode();)Oa(De),Xt(De),Ys(De.content)&&un(De.content)}catch(vt){throw Ue&&$n(Te),vt}if(Ue)return vn(t.removed,vt=>{vt.element&&vi(vt.element)}),xe&&Bn(Te),Te;if(ve){if(xe&&Bn(se),ke)for(Fe=O.call(se.ownerDocument);se.firstChild;)Fe.appendChild(se.firstChild);else Fe=se;return(_.shadowroot||_.shadowrootmode)&&(Fe=J.call(n,Fe,!0)),Fe}let it=_e?se.outerHTML:se.innerHTML;return _e&&pe["!doctype"]&&se.ownerDocument&&se.ownerDocument.doctype&&se.ownerDocument.doctype.name&&Gt(a1,se.ownerDocument.doctype.name)&&(it="<!DOCTYPE "+se.ownerDocument.doctype.name+`>
`+it),xe&&vn([q,ee,Y],vt=>{it=Fa(it,vt," ")}),T&&Oe?k(it):it},t.setConfig=function(){let Te=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};we(Te),Re=!0},t.clearConfig=function(){Ns=null,Re=!1,T=S,R=""},t.isValidAttribute=function(Te,N,se){Ns||we({});const he=Xe(Te),De=Xe(N);return K(he,De,se)},t.addHook=function(Te,N){typeof N=="function"&&Pa(B[Te],N)},t.removeHook=function(Te,N){if(N!==void 0){const se=US(B[Te],N);return se===-1?void 0:HS(B[Te],se,1)[0]}return yp(B[Te])},t.removeHooks=function(Te){B[Te]=[]},t.removeAllHooks=function(){B=Rp()},t}var Ip=rv();function yd(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ra=yd();function cv(e){Ra=e}var Hi={exec:()=>null};function ot(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(fs.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var fs={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},r1=/^(?:[ \t]*(?:\n|$))+/,c1=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,d1=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,yl=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,u1=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,xd=/(?:[*+-]|\d{1,9}[.)])/,dv=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,uv=ot(dv).replace(/bull/g,xd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),p1=ot(dv).replace(/bull/g,xd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),_d=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,f1=/^[^\n]+/,wd=/(?!\s*\])(?:\\.|[^\[\]\\])+/,h1=ot(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",wd).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),m1=ot(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,xd).getRegex(),Xo="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",kd=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,v1=ot("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",kd).replace("tag",Xo).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),pv=ot(_d).replace("hr",yl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xo).getRegex(),g1=ot(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",pv).getRegex(),Sd={blockquote:g1,code:c1,def:h1,fences:d1,heading:u1,hr:yl,html:v1,lheading:uv,list:m1,newline:r1,paragraph:pv,table:Hi,text:f1},Op=ot("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",yl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xo).getRegex(),b1={...Sd,lheading:p1,table:Op,paragraph:ot(_d).replace("hr",yl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Op).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Xo).getRegex()},y1={...Sd,html:ot(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",kd).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Hi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ot(_d).replace("hr",yl).replace("heading",` *#{1,6} *[^
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+tn(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ka=new j1;function at(e,t){return ka.parse(e,t)}at.options=at.setOptions=function(e){return ka.setOptions(e),at.defaults=ka.defaults,cv(at.defaults),at};at.getDefaults=yd;at.defaults=Ra;at.use=function(...e){return ka.use(...e),at.defaults=ka.defaults,cv(at.defaults),at};at.walkTokens=function(e,t){return ka.walkTokens(e,t)};at.parseInline=ka.parseInline;at.Parser=Tn;at.parser=Tn.parse;at.Renderer=ko;at.TextRenderer=Ed;at.Lexer=Sn;at.lexer=Sn.lex;at.Tokenizer=wo;at.Hooks=ql;at.parse=at;at.options;at.setOptions;at.use;at.walkTokens;at.parseInline;Tn.parse;Sn.lex;const V1={breaks:!0,gfm:!0};function Pp(e){if(!e)return"";try{if(typeof at<"u"&&at.parse){const t=at.parse(e,V1);return typeof Ip<"u"?Ip.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function q1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const G1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function K1(e){return G1[e]||"wrench"}const W1=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Fp(e){if(!e)return[];const t=e.match(W1);return t?[...new Set(t)]:[]}const Z1={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(""),a=h(null),i=h(null),l=h(0),o=h("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=Z(()=>t.value.trim().length>0&&!s.value),p=h(Ye.state||"disconnected");let f=null;const m=Z(()=>{const D=p.value;return D==="connected"?"Connected":D==="reconnecting"?"Reconnecting…":D==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],w=Z(()=>{const D=Math.floor(l.value/4)%v.length,I=l.value;return I>3?`${v[D]} (${I}s)`:v[0]});function L(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function x(){if(!i.value)return;const D=i.value;D.style.height="auto",D.style.height=Math.min(D.scrollHeight,120)+"px"}function g(D,I,O={}){const U={id:++c,role:D,content:I,timestamp:Date.now(),html:D==="bot"?Pp(I):"",tools_used:O.tools_used||[],is_error:O.is_error||!1,images:D==="bot"?Fp(I):[],files:O.files||[],_showTools:!1};return e.value.push(U),L(),D==="bot"&&Rt(()=>b()),U}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(I=>{I.setAttribute("data-copy","true"),I.style.position="relative";const O=document.createElement("button");O.className="chat-code-copy",O.textContent="Copy",O.addEventListener("click",()=>{const U=I.querySelector("code"),J=U?U.textContent:I.textContent;navigator.clipboard.writeText(J).then(()=>{O.textContent="Copied!",setTimeout(()=>{O.textContent="Copy"},1500)}).catch(()=>{})}),I.appendChild(O)})}function C(D){if(D===0)return!0;const I=e.value[D-1],O=e.value[D],U=new Date(I.timestamp).toDateString(),J=new Date(O.timestamp).toDateString();return U!==J}function T(D){const I=new Date(D),O=new Date;if(I.toDateString()===O.toDateString())return"Today";const U=new Date(O);return U.setDate(U.getDate()-1),I.toDateString()===U.toDateString()?"Yesterday":I.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function R(D){t.value=D,Rt(()=>V())}function S(D){window.open(D,"_blank","noopener")}function y(D){D.target.style.display="none"}function A(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function F(){r&&(clearInterval(r),r=null),l.value=0}function k(D){s.value&&(s.value=!1,F(),D.type==="chat_response"?g("bot",D.content,{tools_used:D.tools_used||[],is_error:D.is_error||!1,files:D.files||[]}):D.type==="chat_error"&&g("bot",D.error||"Unknown error",{is_error:!0}),Rt(()=>{var I;return(I=i.value)==null?void 0:I.focus()}))}async function M(D){try{const I=await j.post("/api/chat",{content:D,channel_id:o.value});g("bot",I.response,{tools_used:I.tools_used||[],is_error:I.is_error||!1,files:I.files||[]})}catch(I){g("bot",I.message||"Failed to send message",{is_error:!0})}}async function V(){const D=t.value.trim();if(!D||s.value)return;g("user",D),t.value="",s.value=!0,A(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(D,{channelId:o.value})||(await M(D),s.value=!1,F()),Rt(()=>{var O;return(O=i.value)==null?void 0:O.focus()})}async function W(){n.value="";try{if(!o.value){const I=await j.get("/api/auth/session");o.value=I.channel_id||I.user_id||"web-user"}const D=await j.get("/api/sessions/"+encodeURIComponent(o.value));if(D&&D.messages&&D.messages.length>0){for(const I of D.messages){const O=I.role==="user"?"user":"bot";let U=I.content||"";if(O==="user"){const B=U.match(/^\[.*?\]:\s*/);B&&(U=U.slice(B[0].length))}if(!U.trim())continue;const J={id:++c,role:O,content:U,timestamp:I.timestamp?I.timestamp*1e3:Date.now(),html:O==="bot"?Pp(U):"",tools_used:[],is_error:!1,images:O==="bot"?Fp(U):[],files:[],_showTools:!1};e.value.push(J)}Rt(()=>{L(),b()})}}catch(D){D&&D.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",ye.error(n.value))}}return je(()=>{Ye.subscribe("chat",k),p.value=Ye.state||"disconnected",f=Ye.onState(D=>{p.value=D}),W(),Rt(()=>{var D;return(D=i.value)==null?void 0:D.focus()})}),ht(()=>{Ye.unsubscribe("chat",k),f&&(f(),f=null),F()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:w,suggestions:d,send:V,autoResize:x,formatTime:q1,formatDate:T,showDateSeparator:C,useSuggestion:R,openImage:S,onImageError:y,getToolIcon:K1,loadHistory:W}}},J1={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),o=h(!1),r=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),m=Z(()=>e.value==="custom"),v=Z(()=>[...i.value,...l.value]),w=Z(()=>l.value.includes(e.value)),L=Z(()=>{var S;return m.value?t.value||"Odin":((S=a.value[e.value])==null?void 0:S.name)||e.value}),x=Z(()=>{var S;return m.value?s.value||"(empty — will use Odin default)":((S=a.value[e.value])==null?void 0:S.identity)||""}),g=Z(()=>{var S;return m.value?n.value||"(empty — will use Odin default)":((S=a.value[e.value])==null?void 0:S.voice)||""});async function b(){d.value=!0;try{const S=await j.get("/api/personality");e.value=S.preset||"odin",t.value=S.custom_name||"",s.value=S.custom_identity||"",n.value=S.custom_voice||"",a.value=S.presets||{},i.value=S.builtin_presets||[],l.value=S.user_presets||[]}catch(S){c.value=S.message}finally{d.value=!1}}async function C(){o.value=!0,c.value=null,r.value=!1;try{await j.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(S){c.value=S.message}finally{o.value=!1}}async function T(){const S=u.value.trim();if(S){f.value=!0,c.value=null;try{await j.post("/api/personality/presets",{name:S,display_name:L.value,identity:x.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=S.toLowerCase().replace(/ /g,"_")}catch(y){c.value=y.message}finally{f.value=!1}}}async function R(){if(await qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await j.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(y){c.value=y.message}}}return je(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:w,previewName:L,previewIdentity:x,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:C,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:T,deletePreset:R,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),xv=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:OS,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:Z1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:Jw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:ik,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Ck,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:J1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:SS,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/hosts",redirect:kt("/system","hosts")},{path:"/internals",redirect:kt("/system","internals")}],zi=Tw({history:nw(),routes:xv});zi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Y1={template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=h(""),s=h(null),n=h(!1),a=h(!1);async function i(){n.value=!0,s.value=null;try{j.setPersist(a.value),await j.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{n.value=!1}}return{token:t,error:s,busy:n,persist:a,login:i}}},Q1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let o=null,r=null;const c=h(!1),d=h("disconnected"),u=h(-1),p=h(null);let f=null;const m=h("starting"),v=h(""),w=xv.filter(U=>U.meta),L=Z(()=>["Workspace","Operate","Observe","Manage"].map(U=>({name:U,routes:w.filter(J=>J.meta.section===U)})).filter(U=>U.routes.length)),x=Z(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.label)||"Odin"}),g=Z(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.section)||"Management"}),b=Z(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.description)||"Management console"});function C(){Ye.disconnect(),V&&(clearInterval(V),V=null)}j.onSessionExpired=()=>{t.value=!0,C(),j.setToken(""),e.value="login"};function T(U){var J;if((U.ctrlKey||U.metaKey)&&U.key.toLowerCase()==="k"){e.value==="ready"&&(U.preventDefault(),mp());return}if(n.value&&U.key==="Tab"){const B=[...((J=a.value)==null?void 0:J.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(B.length){const q=B[0],ee=B[B.length-1];if(U.shiftKey&&(document.activeElement===q||!a.value.contains(document.activeElement))){U.preventDefault(),ee.focus();return}if(!U.shiftKey&&(document.activeElement===ee||!a.value.contains(document.activeElement))){U.preventDefault(),q.focus();return}}}if(U.key==="Escape"&&n.value){n.value=!1,U.preventDefault();return}if(U.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(U.target.tagName)){U.preventDefault();const B=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');B&&B.focus()}}function R(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}je(async()=>{document.addEventListener("keydown",T),o=window.matchMedia("(max-width: 900px)"),R(),o.addEventListener("change",R);const U=await j.check();U.ok?(e.value="ready",I()):U.needsAuth?e.value="login":(e.value="ready",I())});function S(){t.value=!1,e.value="ready",I()}async function y(){C(),e.value="login",await j.logout()}function A(){s.value=!s.value}function F(){n.value=!n.value}Mt(n,async U=>{var J,B;if(U)r=document.activeElement,await Rt(),(B=(J=a.value)==null?void 0:J.querySelector(".nav-item"))==null||B.focus();else if(r!=null&&r.isConnected){const q=r;r=null,requestAnimationFrame(()=>q.focus())}});const k=Z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(U,J="info",B=3e3){p.value={text:U,level:J},clearTimeout(f),f=setTimeout(()=>{p.value=null},B)}let V=null,W=!1,D=[];function I(){for(const U of D)U();D=[Ye.onStatus(U=>{c.value=U}),Ye.onLatencyChange(U=>{u.value=U}),Ye.onState((U,J)=>{d.value=U,U==="connected"?(W&&M("Connection restored","success"),W=!0):U==="reconnecting"&&J.attempt===1&&M("Connection lost — reconnecting…","warn")})],Ye.connect(),O(),V&&clearInterval(V),V=setInterval(O,15e3)}async function O(){try{const U=await j.get("/api/status");m.value=U.status==="online"?"online":"starting";const J=U.uptime_seconds||0,B=Math.floor(J/3600),q=Math.floor(J%3600/60);v.value=`${B}h ${q}m uptime`}catch{m.value="offline",v.value=""}}return ht(()=>{V&&clearInterval(V);for(const U of D)U();D=[],Ye.disconnect(),document.removeEventListener("keydown",T),o==null||o.removeEventListener("change",R)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:k,wsToast:p,botStatus:m,botUptime:v,navRoutes:w,navGroups:L,currentPage:x,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:S,logout:y,toggleSidebar:A,toggleMobileNavigation:F,openPalette:mp}}},ta=co(Q1);ta.component("odin-icon",AS);ta.component("login-screen",Y1);ta.component("toast-container",g_);ta.component("confirm-host",b_);ta.component("command-palette",ES);ta.directive("modal-focus",IS);ta.use(zi);ta.mount("#app");
