...
`,e=e.substring(f.length+1),o=!0),!o){const E=this.rules.other.nextBulletRegex(m),v=this.rules.other.hrRegex(m),b=this.rules.other.fencesBeginRegex(m),x=this.rules.other.headingBeginRegex(m),A=this.rules.other.htmlBeginRegex(m);for(;e;){const T=e.split(`
`,1)[0];let N;if(f=T,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),N=f):N=f.replace(this.rules.other.tabCharGlobal,"    "),b.test(f)||x.test(f)||A.test(f)||E.test(f)||v.test(f))break;if(N.search(this.rules.other.nonSpaceChar)>=m||!f.trim())u+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+ws(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Pn=new jk;function je(e,t){return Pn.parse(e,t)}je.options=je.setOptions=function(e){return Pn.setOptions(e),je.defaults=Pn.defaults,Qh(je.defaults),je};je.getDefaults=_c;je.defaults=Un;je.use=function(...e){return Pn.use(...e),je.defaults=Pn.defaults,Qh(je.defaults),je};je.walkTokens=function(e,t){return Pn.walkTokens(e,t)};je.parseInline=Pn.parseInline;je.Parser=Vs;je.parser=Vs.parse;je.Renderer=Al;je.TextRenderer=Rc;je.Lexer=js;je.lexer=js.lex;je.Tokenizer=El;je.Hooks=Xi;je.parse=je;je.options;je.setOptions;je.use;je.walkTokens;je.parseInline;Vs.parse;js.lex;const Vk={breaks:!0,gfm:!0};function Dd(e){if(!e)return"";try{if(typeof je<"u"&&je.parse){const t=je.parse(e,Vk);return typeof Cd<"u"?Cd.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function qk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Od={run_command:"⌘",ssh_command:"⌘",run_script:"⌘",read_file:"📄",write_file:"✏️",list_directory:"📂",search_knowledge:"🔍",ingest_document:"📚",generate_image:"🎨",analyze_image:"🖼️",analyze_pdf:"📃",browser_screenshot:"🌐",manage_process:"⚙️"};function zk(e){return Od[e]?Od[e]:"🔧"}const Gk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Ld(e){if(!e)return[];const t=e.match(Gk);return t?[...new Set(t)]:[]}const Kk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=te(()=>t.value.trim().length>0&&!s.value),d=te(()=>{const $=qe.state;return $==="connected"?"Connected":$==="reconnecting"?"Reconnecting…":$==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=te(()=>{const $=Math.floor(i.value/4)%f.length,V=i.value;return V>3?`${f[$]} (${V}s)`:f[0]});function m(){Et(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const $=a.value;$.style.height="auto",$.style.height=Math.min($.scrollHeight,120)+"px"}function S($,V,M={}){const O={id:++o,role:$,content:V,timestamp:Date.now(),html:$==="bot"?Dd(V):"",tools_used:M.tools_used||[],is_error:M.is_error||!1,images:$==="bot"?Ld(V):[],files:M.files||[],_showTools:!1};return e.value.push(O),m(),$==="bot"&&Et(()=>E()),O}function E(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(V=>{V.setAttribute("data-copy","true"),V.style.position="relative";const M=document.createElement("button");M.className="chat-code-copy",M.textContent="Copy",M.addEventListener("click",()=>{const O=V.querySelector("code"),K=O?O.textContent:V.textContent;navigator.clipboard.writeText(K).then(()=>{M.textContent="Copied!",setTimeout(()=>{M.textContent="Copy"},1500)}).catch(()=>{})}),V.appendChild(M)})}function v($){if($===0)return!0;const V=e.value[$-1],M=e.value[$],O=new Date(V.timestamp).toDateString(),K=new Date(M.timestamp).toDateString();return O!==K}function b($){const V=new Date($),M=new Date;if(V.toDateString()===M.toDateString())return"Today";const O=new Date(M);return O.setDate(O.getDate()-1),V.toDateString()===O.toDateString()?"Yesterday":V.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x($){t.value=$,Et(()=>U())}function A($){window.open($,"_blank","noopener")}function T($){$.target.style.display="none"}function N(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function w(){r&&(clearInterval(r),r=null),i.value=0}function _($){s.value&&(s.value=!1,w(),$.type==="chat_response"?S("bot",$.content,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]}):$.type==="chat_error"&&S("bot",$.error||"Unknown error",{is_error:!0}),Et(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}async function I($){try{const V=await G.post("/api/chat",{content:$,channel_id:l.value});S("bot",V.response,{tools_used:V.tools_used||[],is_error:V.is_error||!1,files:V.files||[]})}catch(V){S("bot",V.message||"Failed to send message",{is_error:!0})}}async function U(){const $=t.value.trim();!$||s.value||(S("user",$),t.value="",s.value=!0,N(),a.value&&(a.value.style.height="auto"),qe.connected?qe.sendChat($,{channelId:l.value})?L():(await I($),s.value=!1,w()):(await I($),s.value=!1,w()),Et(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}let D=null;ds(s,$=>{$||D&&(clearTimeout(D),D=null)});function L(){D=setTimeout(()=>{s.value&&(s.value=!1,w(),S("bot","Response timed out. Try again.",{is_error:!0}))},12e4)}async function J(){try{if(!l.value){const V=await G.get("/api/auth/session");l.value=V.channel_id||V.user_id||"web-user"}const $=await G.get("/api/sessions/"+encodeURIComponent(l.value));if($&&$.messages&&$.messages.length>0){for(const V of $.messages){const M=V.role==="user"?"user":"bot";let O=V.content||"";if(M==="user"){const ve=O.match(/^\[.*?\]:\s*/);ve&&(O=O.slice(ve[0].length))}if(!O.trim())continue;const K={id:++o,role:M,content:O,timestamp:V.timestamp?V.timestamp*1e3:Date.now(),html:M==="bot"?Dd(O):"",tools_used:[],is_error:!1,images:M==="bot"?Ld(O):[],files:[],_showTools:!1};e.value.push(K)}Et(()=>{m(),E()})}}catch{}}return $e(()=>{qe.subscribe("chat",_),J(),Et(()=>{var $;return($=a.value)==null?void 0:$.focus()})}),ft(()=>{qe.unsubscribe("chat",_),D&&clearTimeout(D),w()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:U,autoResize:g,formatTime:qk,formatDate:b,showDateSeparator:v,useSuggestion:x,openImage:A,onImageError:T,getToolIcon:zk}}},ir={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=S_(),s=qh(),n=te({get(){var r;const l=t.query.tab;return l&&e.tabs.some(o=>o.id===l)?l:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(l){s.replace({query:{...t.query,tab:l}})}}),a=te(()=>{const l=e.tabs.find(r=>r.id===n.value);return(l==null?void 0:l.component)||null}),i=te(()=>{const l=e.tabs.find(r=>r.id===n.value);return(l==null?void 0:l.label)||""});return ds(i,l=>{e.groupLabel&&l&&(document.title=`Odin — ${e.groupLabel} › ${l}`)},{immediate:!0}),{activeTab:n,activeComponent:a,activeLabel:i}},template:`
    <div>
  ...
  `},Wk={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(c){var f,p,m;const u=c.payload||c,d=u.type||c.type;if(d==="tool_start"){const g={id:`${u.action}-${Date.now()}`,tool:u.action,actor:u.actor||"",channel:u.channel_id||"",iteration:((f=u.metadata)==null?void 0:f.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(g);return}if(d==="tool_end"){const g=e.value.findIndex(S=>S.tool===u.action&&S.status==="running");if(g>=0){const S=e.value[g];S.status=(p=u.metadata)!=null&&p.error?"error":"success",S.elapsed=((m=u.metadata)==null?void 0:m.elapsed_ms)||Date.now()-S.startTime,S.result=u.detail||"",S.fadingOut=!0,setTimeout(()=>{const E=e.value.indexOf(S);E>=0&&e.value.splice(E,1),t.value.unshift(S),t.value.length>n&&t.value.pop()},5e3)}return}if(d==="tool_stream"){const g=u.tool_name||"unknown";if(u.finished)delete s.value[g];else{const E=((s.value[g]||"")+(u.chunk||"")).split(`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}$e(()=>{qe.on("events",a),i=setInterval(l,500)}),ft(()=>{qe.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"⏳":c==="success"?"✅":c==="error"?"❌":"⭕"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},Jk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=te(()=>e.value.reduce((T,N)=>T+(N.iteration_count||0),0)),d=te(()=>e.value.filter(T=>T.status==="running").length);function f(T){return T==="running"?"loop-status-running":T==="error"?"loop-status-error":"loop-status-stopped"}function p(T){return T==="running"?"badge-success":T==="error"?"badge-danger":T==="completed"?"badge-info":"badge-warning"}function m(T){return T==="act"?"badge-warning":T==="silent"?"badge-info":"badge-success"}function g(T){c.value={...c.value,[T]:!c.value[T]}}async function S(T=!1){T=T===!0,T||(t.value=!0);try{e.value=await G.get("/api/loops"),s.value=null}catch(N){T||(s.value=N.message)}T||(t.value=!1)}async function E(){l.value=null;const T=a.value;if(!T.goal.trim()){l.value="Goal is required";return}if(!T.channel_id.trim()){l.value="Channel ID is required";return}const N={goal:T.goal.trim(),channel_id:T.channel_id.trim(),interval_seconds:T.interval_seconds||60,mode:T.mode,max_iterations:T.max_iterations||50};T.stop_condition.trim()&&(N.stop_condition=T.stop_condition.trim()),i.value=!0;try{const w=await G.post("/api/loops",N);ke.success(`Loop started: ${w.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await S()}catch(w){l.value=w.message}i.value=!1}async function v(T){if(await ns({title:"Stop loop",message:`Stop loop ${T}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=T;try{await G.del(`/api/loops/${encodeURIComponent(T)}`),ke.success("Loop stopped"),await S()}catch(w){ke.error(w.message||"Failed to stop loop")}r.value=null}}async function b(T){o.value=T;try{await G.post(`/api/loops/${encodeURIComponent(T)}/restart`),ke.success("Loop restarted"),await S()}catch(N){ke.error(N.message||"Failed to restart loop")}o.value=null}function x(T){T.payload&&(T.payload.loop_id||T.payload.type==="loop")&&S(!0)}let A=null;return $e(()=>{S(),qe.subscribe("events",x),A=setInterval(()=>{d.value>0&&S(!0)},5e3)}),ft(()=>{qe.unsubscribe("events",x),A&&clearInterval(A)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:sr,formatAge:zh,toggleHistory:g,fetchLoops:S,doCreate:E,doStop:v,doRestart:b}}},Qk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=te(()=>e.value.filter(g=>g.status==="running").length),r=te(()=>e.value.filter(g=>g.status!=="running").length);function o(g){return g==="running"?"loop-status-running":g==="failed"||g==="error"?"loop-status-error":"loop-status-stopped"}function c(g){return g==="running"?"badge-success":g==="completed"||g==="exited"?"badge-info":g==="killed"||g==="error"||g==="failed"?"badge-danger":"badge-warning"}async function u(g=!1){g=g===!0,g||(t.value=!0);try{e.value=await G.get("/api/processes"),s.value=null}catch(S){g||(s.value=S.message)}g||(t.value=!1)}function d(){f(),n.value&&(a=setInterval(()=>{t.value||u(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}ds(n,g=>{g?d():f()});async function p(g){if(await ns({title:"Kill process",message:`Kill process ${g}?`,confirmLabel:"Kill",danger:!0})){i.value=g;try{await G.del(`/api/processes/${g}`),ke.success(`Process ${g} killed`),await u()}catch(E){ke.error(E.message||"Failed to kill process")}i.value=null}}function m(g){g.payload&&(g.payload.pid||g.payload.type==="process")&&u(!0)}return $e(()=>{u(),qe.subscribe("events",m),d()}),ft(()=>{qe.unsubscribe("events",m),f()}),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:sr,fetchProcesses:u,doKill:p}}},Xk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=te(()=>e.value.filter(_=>_.cron&&!_.one_time).length),m=te(()=>e.value.filter(_=>_.one_time).length),g=te(()=>e.value.filter(_=>_.trigger).length),S=te(()=>e.value.filter(_=>_.paused).length);function E(_){if(!_)return"-";const I=Date.now(),D=(new Date(_).getTime()-I)/1e3;if(D<0)return"overdue";if(D<60)return"in < 1 min";if(D<3600)return`in ${Math.floor(D/60)} min`;if(D<86400){const J=Math.floor(D/3600),$=Math.floor(D%3600/60);return $>0?`in ${J}h ${$}m`:`in ${J}h`}const L=Math.floor(D/86400);return`in ${L} day${L!==1?"s":""}`}function v(){r.value=null}async function b(){const _=a.value.cron.trim();if(_){o.value=!0;try{r.value=await G.post("/api/schedules/validate-cron",{expression:_})}catch(I){r.value={valid:!1,error:I.message}}o.value=!1}}async function x(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(_){s.value=_.message}t.value=!1}async function A(){l.value=null;const _=a.value;if(!_.description.trim()){l.value="Description is required";return}if(!_.channel_id.trim()){l.value="Channel ID is required";return}if(!_.cron.trim()&&!_.run_at.trim()){l.value="Cron expression or run_at time is required";return}const I={description:_.description.trim(),action:_.action,channel_id:_.channel_id.trim()};if(_.cron.trim()&&(I.cron=_.cron.trim()),_.run_at.trim()&&(I.run_at=_.run_at.trim()),_.action==="reminder"&&_.message.trim()&&(I.message=_.message.trim()),_.action==="check"&&(_.tool_name.trim()&&(I.tool_name=_.tool_name.trim()),_.tool_input_str.trim()))try{I.tool_input=JSON.parse(_.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",I),ke.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await x()}catch(U){l.value=U.message}i.value=!1}async function T(_){u.value=_;try{const I=await G.post(`/api/schedules/${encodeURIComponent(_)}/run`);if(I.status==="failure")ke.error(`Execution failed: ${I.error||"unknown error"}`);else{const U=I.warning?`Executed (${I.warning})`:"Executed successfully";ke.success(U)}await x()}catch(I){ke.error(I.message||"Failed to trigger")}u.value=null}async function N(_){f.value=_.id;const I=!_.paused;try{await G.put(`/api/schedules/${encodeURIComponent(_.id)}`,{paused:I}),ke.success(I?"Schedule paused":"Schedule resumed"),await x()}catch(U){ke.error(U.message||"Failed to update schedule")}f.value=null}async function w(_){const I=e.value.find(D=>D.id===_);if(await ns({title:"Delete schedule",message:`Delete "${(I==null?void 0:I.description)||_}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=_;try{await G.del(`/api/schedules/${encodeURIComponent(_)}`),ke.success("Schedule deleted"),await x()}catch(D){ke.error(D.message||"Failed to delete schedule")}d.value=null}}return $e(()=>{x()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,cronCount:p,oneTimeCount:m,webhookCount:g,pausedCount:S,formatTs:Sa,formatAge:zh,formatFuture:E,onCronInput:v,validateCron:b,fetchSchedules:x,doCreate:A,doRunNow:T,doTogglePause:N,doDelete:w}}},Zk={components:{TabbedPage:ir},setup(){return{tabs:[{id:"live",label:"Live",component:Wk},{id:"agents",label:"Agents",component:Jk},{id:"loops",label:"Loops",component:Yk},{id:"processes",label:"Processes",component:Qk},{id:"schedules",label:"Schedules",component:Xk}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},ew={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=Pd,g=tw,S=h([]),E=h(!1),v=h(""),b=h("flat"),x=h(new Set),A=h(""),T=h(""),N=h(""),w=h(null),_=h(!1);function I(){try{const H=localStorage.getItem("odin-session-presets");H&&(S.value=JSON.parse(H))}catch{}}function U(){try{localStorage.setItem("odin-session-presets",JSON.stringify(S.value))}catch{}}const D=te(()=>d.value.trim()!==""||u.value!=="all"),L=te(()=>{let H=[...e.value];const ce=Pd.find(Ke=>Ke.id===u.value),ye=ce?ce.filters:{};if(ye.source&&(H=H.filter(Ke=>Ke.source===ye.source)),ye.minMessages&&(H=H.filter(Ke=>Ke.message_count>=ye.minMessages)),ye.hasCompaction&&(H=H.filter(Ke=>Ke.has_summary)),ye.maxAge!=null){const Ke=Date.now()/1e3;H=H.filter(St=>St.last_active&&Ke-St.last_active<=ye.maxAge)}if(d.value.trim()){const Ke=d.value.toLowerCase().trim();H=H.filter(St=>(St.channel_id||"").toLowerCase().includes(Ke)||(St.last_user_id||"").toLowerCase().includes(Ke)||(St.source||"").toLowerCase().includes(Ke))}const Me=f.value,Je=p.value?1:-1;return H.sort((Ke,St)=>{const st=Ke[Me]||0,Ye=St[Me]||0;return(st-Ye)*Je}),H}),J=te(()=>{if(!a.value||!a.value.messages)return[];const H=a.value.messages;if(H.length===0)return[];const ce=[];let ye=[];for(const Me of H)Me.role==="user"&&ye.length>0&&(ce.push(ye),ye=[]),ye.push(Me);return ye.length>0&&ce.push(ye),ce}),$=te(()=>L.value.length>0&&o.value.size===L.value.length);function V(H){const ce=H.find(ye=>ye.role==="user");if(ce&&ce.content){const ye=ce.content.slice(0,120);return ye.length<ce.content.length?ye+"...":ye}return"(no user message)"}function M(H){const ce=new Set(x.value);ce.has(H)?ce.delete(H):ce.add(H),x.value=ce}function O(H){u.value=H}function K(H){u.value=H.id,H.filters.searchQuery!=null&&(d.value=H.filters.searchQuery),H.filters.sortBy&&(f.value=H.filters.sortBy)}function ve(){if(!v.value.trim())return;const H={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};S.value=[...S.value,H],U(),E.value=!1,v.value=""}function me(H){S.value=S.value.filter(ce=>ce.id!==H),U(),u.value===H&&(u.value="all")}function ie(){u.value="all",d.value="",f.value="last_active",p.value=!1}function he(H){if(!H)return"—";const ce=Date.now()/1e3-H;if(ce<60)return"just now";if(ce<3600){const Me=Math.floor(ce/60);return`${Me} minute${Me!==1?"s":""} ago`}if(ce<86400){const Me=Math.floor(ce/3600);return`${Me} hour${Me!==1?"s":""} ago`}const ye=Math.floor(ce/86400);return`${ye} day${ye!==1?"s":""} ago`}function X(H){if(!H)return"";try{return new Date(H*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ue(H){if(!H)return"";try{return new Date(H*1e3).toLocaleString()}catch{return""}}function Ie(H){return H==="user"?"bg-gray-900/50 border border-gray-800":H==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function q(H){return H==="user"?"sess-msg-user":H==="assistant"?"sess-msg-assistant":"sess-msg-system"}function re(H){return H==="user"?"badge-info":H==="assistant"?"badge-success":"badge-warning"}function le(H){return H==="user"?"sess-dot-user":H==="assistant"?"sess-dot-assistant":"sess-dot-system"}function pe(H){return H==="user"?"text-cyan-400":H==="assistant"?"text-indigo-400":"text-gray-500"}function ge(H){return H?H.length>2e3?H.slice(0,2e3)+`
... (truncated)`:H:""}async function Le(){const H=A.value.trim();if(H){_.value=!0;try{let ce=`/api/sessions/search?q=${encodeURIComponent(H)}&limit=50`;T.value.trim()&&(ce+=`&channel_id=${encodeURIComponent(T.value.trim())}`),N.value.trim()&&(ce+=`&user_id=${encodeURIComponent(N.value.trim())}`);const ye=await G.get(ce);w.value=ye.results||[]}catch{w.value=[]}_.value=!1}}function y(){A.value="",T.value="",N.value="",w.value=null}function C(H){return H?H.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function P(H){return H==="user"?"bg-gray-900/50 border-gray-800":H==="assistant"?"bg-indigo-950/30 border-indigo-900/30":H==="summary"?"bg-amber-950/20 border-amber-900/30":H==="fts"?"bg-emerald-950/20 border-emerald-900/30":H==="channel"?"bg-purple-950/20 border-purple-900/30":"bg-gray-900/30 border-gray-800/50"}function W(H){return H==="user"?"badge-info":H==="assistant"?"badge-success":H==="summary"?"badge-warning":H==="fts"?"badge-success":"badge-info"}async function R(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(H){s.value=H.message}t.value=!1}function F(){s.value=null,R()}async function Y(H){if(n.value===H){n.value=null,a.value=null,x.value=new Set;return}n.value=H,a.value=null,i.value=!0,x.value=new Set;try{a.value=await G.get(`/api/sessions/${encodeURIComponent(H)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Z(H){const ce=new Set(o.value);ce.has(H)?ce.delete(H):ce.add(H),o.value=ce}function se(){$.value?o.value=new Set:o.value=new Set(L.value.map(H=>H.channel_id))}function Q(H){l.value=H}async function B(){if(l.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await R()}catch(H){s.value=H.message||"Failed to clear session"}r.value=!1,l.value=null}}function ee(){c.value=!0}async function oe(){if(o.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await R()}catch(H){s.value=H.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function be(H,ce){const ye=G._token;let Me=`/api/sessions/${encodeURIComponent(H)}/export?format=${ce}`;ye&&(Me+=`&token=${encodeURIComponent(ye)}`);const Je=document.createElement("a");Je.href=Me,Je.download=`session-${H}.${ce==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let Te=null;function Ae(H){H.payload&&H.payload.channel_id&&(clearTimeout(Te),Te=setTimeout(()=>{R(),n.value&&H.payload.channel_id===n.value&&G.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(ce=>{a.value=ce}).catch(()=>{})},2e3))}return $e(()=>{I(),R(),qe.subscribe("events",Ae)}),ft(()=>{qe.unsubscribe("events",Ae),clearTimeout(Te)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:$,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:L,hasActiveFilters:D,customPresets:S,showSavePreset:E,newPresetName:v,threadView:b,threads:J,collapsedThreads:x,ftsQuery:A,ftsChannelId:T,ftsUserId:N,ftsResults:w,ftsSearching:_,formatAge:he,formatTimestamp:X,formatFullTimestamp:ue,messageClass:Ie,threadMsgClass:q,roleBadge:re,roleDotClass:le,roleLabelClass:pe,truncateContent:ge,threadSummary:V,fetchSessions:R,retry:F,toggleSession:Y,toggleSelect:Z,toggleSelectAll:se,confirmClear:Q,clearSession:B,confirmBulkClear:ee,doBulkClear:oe,exportSession:be,applyPreset:O,applyCustomPreset:K,saveCustomPreset:ve,removeCustomPreset:me,resetFilters:ie,toggleThread:M,runFtsSearch:Le,clearFtsSearch:y,highlightSnippet:C,ftsResultClass:P,ftsTypeBadge:W}}},nw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:R_}}},aw={components:{ContextAssemblyPanel:nw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(N){if(!N)return"—";try{const w=new Date(N);return isNaN(w.getTime())?N:w.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return N}}function f(N){return!N&&N!==0?"—":N<1e3?N+"ms":(N/1e3).toFixed(1)+"s"}function p(N){return!N&&N!==0?"—":N>=1e3?(N/1e3).toFixed(1)+"k":String(N)}function m(N){if(!N)return"";if(typeof N=="string")return N;try{return JSON.stringify(N,null,2)}catch{return String(N)}}function g(N){a.value===N?a.value=null:(a.value=N,c.value={})}function S(N,w){const _=N+"-"+w;c.value={...c.value,[_]:!c.value[_]}}function E(N,w){return!!c.value[N+"-"+w]}function v(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,A()}async function b(){try{const N=await G.get("/api/trajectories");e.value=N.files||[],o.value=N.count||0}catch{}}let x=0;async function A(){const N=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const w=await G.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(N!==x)return;let _=w.entries||[];u.value.tool_name&&(_=_.filter(I=>(I.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(_=_.filter(I=>I.is_error)),u.value.channel_id&&(_=_.filter(I=>I.channel_id===u.value.channel_id)),u.value.user_id&&(_=_.filter(I=>I.user_id===u.value.user_id)),t.value=_}else{const w=new URLSearchParams;u.value.channel_id&&w.set("channel_id",u.value.channel_id),u.value.user_id&&w.set("user_id",u.value.user_id),u.value.tool_name&&w.set("tool_name",u.value.tool_name),u.value.errors_only&&w.set("errors_only","true"),w.set("limit",String(u.value.limit));const _=w.toString(),I=await G.get(`/api/trajectories/search/query?${_}`);if(N!==x)return;t.value=I.results||[]}}catch(w){if(N!==x)return;n.value=w.message}N===x&&(s.value=!1)}async function T(){if(!l.value.trim())return;const N=++x;s.value=!0,n.value=null,c.value={};try{const w=await G.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(N!==x)return;i.value=w.entry||null,i.value||(n.value="No trace found for this message ID")}catch(w){if(N!==x)return;w.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=w.message}N===x&&(s.value=!1)}return $e(async()=>{await b(),await A()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:m,truncateBlock:Gh,toggleExpand:g,toggleIteration:S,isIterationExpanded:E,clearFilters:v,fetchFiles:b,fetchTraces:A,lookupMessage:T}}},iw={template:`
...
`)}const uw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),S=h(null),E=h(!1),v=te(()=>e.value.length),b=te(()=>e.value.reduce((X,ue)=>X+(ue.execution_count||0),0)),x=te(()=>e.value.reduce((X,ue)=>X+I(ue.code),0)),A=te(()=>{if(!l.value)return e.value;const X=l.value.toLowerCase();return e.value.filter(ue=>ue.name.toLowerCase().includes(X)||(ue.description||"").toLowerCase().includes(X))}),T=te(()=>d.value?d.value.split(`
`).length:0),N=te(()=>{const X=Math.max(T.value,1);return Array.from({length:X},(ue,Ie)=>Ie+1).join(`
`)}),w=te(()=>{const X=d.value.trim();return X?X.includes("SKILL_DEFINITION")?X.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function _(X){return ow(X)}function I(X){return X?X.split(`
`).length:0}function U(X){return cw(X)}function D(X){n.value={...n.value,[X]:!n.value[X]}}async function L(X){try{await navigator.clipboard.writeText(X);const ue=e.value.find(Ie=>Ie.code===X);ue&&(r.value=ue.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function J(X){if(X.key==="Tab"){X.preventDefault();const ue=X.target,Ie=ue.selectionStart,q=ue.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(q),Et(()=>{ue.selectionStart=ue.selectionEnd=Ie+4})}}function $(X){const ue=X.target.previousElementSibling;ue&&(ue.scrollTop=X.target.scrollTop)}async function V(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function M(X){i.value=X,delete a.value[X],a.value={...a.value};try{const ue=await G.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:ue}}catch(ue){a.value={...a.value,[X]:{result:ue.message,is_error:!0}}}i.value=null}function O(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function K(X){o.value=!0,c.value="edit",u.value=X.name,d.value=X.code||"",f.value=null,p.value=null}function ve(){o.value=!1,f.value=null,p.value=null}async function me(){f.value=null,p.value=null;const X=u.value.trim(),ue=d.value.trim();if(!X){f.value="Name is required";return}if(!ue){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:X,code:ue}),p.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(X)}`,{code:ue}),p.value="Skill updated successfully"),await V(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}m.value=!1}function ie(X){S.value=X}async function he(){if(S.value){E.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(S.value)}`),await V()}catch{}E.value=!1,S.value=null}}return $e(()=>{V()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:S,deleting:E,enabledCount:v,totalExecutions:b,totalLines:x,displayedSkills:A,editLineCount:T,editorLineNums:N,editValidation:w,highlight:_,truncate:xc,formatTs:Sa,countLines:I,getLineNumbers:U,toggleCode:D,copyCode:L,handleEditorKey:J,syncScroll:$,fetchSkills:V,testSkill:M,showCreate:O,editSkill:K,cancelEdit:ve,saveSkill:me,confirmDelete:ie,doDelete:he}}};function dw(e,t){if(!e||!t)return fd(e);const s=fd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const fw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let S=null;const E=h(null),v=h(!1),b=h({}),x=h({}),A=h(null),T=h(null),N=te(()=>e.value.reduce((O,K)=>O+(K.chunks||0),0)),w=te(()=>new Set(e.value.map(K=>K.uploader).filter(Boolean)).size);function _(O,K){const ve=x.value[K];if(!ve||ve.length===0)return 0;const me=Math.max(...ve.map(ie=>ie.char_count||0));return me===0?0:Math.round(O.char_count/me*100)}async function I(){t.value=!0,s.value=null;try{const O=await G.get("/api/knowledge");e.value=Array.isArray(O)?O:[]}catch(O){s.value=O.message}t.value=!1}async function U(O){if(b.value[O]){b.value[O]=!1,T.value=null;return}if(b.value[O]=!0,!(x.value[O]||A.value===O)){A.value=O;try{const K=await G.get(`/api/knowledge/${encodeURIComponent(O)}/chunks`);x.value[O]=Array.isArray(K)?K:[]}catch(K){x.value[O]=[],ke.error(`Failed to load chunks: ${K.message}`)}A.value=null}}async function D(){const O=n.value.trim();if(O){i.value=!0,r.value=null,l.value=O;try{const K=await G.get(`/api/knowledge/search?q=${encodeURIComponent(O)}`);a.value=Array.isArray(K)?K:[]}catch(K){a.value=[],r.value=K.message||"Search failed"}i.value=!1}}function L(){a.value=null,n.value="",r.value=null}async function J(){d.value=null,f.value=null;const O=c.value.trim(),K=u.value.trim();if(!O){d.value="Source name is required";return}if(!K){d.value="Content is required";return}p.value=!0;try{const ve=await G.post("/api/knowledge",{source:O,content:K});f.value=`Ingested ${ve.chunks||0} chunks from "${O}"`,c.value="",u.value="",x.value={},await I(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(ve){d.value=ve.message}p.value=!1}async function $(O){m.value=O,g.value=null,S&&(clearTimeout(S),S=null);try{const K=await G.post(`/api/knowledge/${encodeURIComponent(O)}/reingest`);g.value={source:O,error:!1,message:`Re-ingested ${K.chunks||0} chunks`},delete x.value[O],await I(),S=setTimeout(()=>{g.value=null,S=null},3e3)}catch(K){g.value={source:O,error:!0,message:K.message}}m.value=null}function V(O){E.value=O}async function M(){if(E.value){v.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(E.value)}`),delete x.value[E.value],await I()}catch{}v.value=!1,E.value=null}}return $e(()=>{I()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:E,deleting:v,expanded:b,sourceChunks:x,loadingChunks:A,selectedChunk:T,totalChunks:N,uploaderCount:w,truncate:xc,formatTs:Sa,highlightTerms:dw,chunkBarWidth:_,fetchSources:I,toggleSource:U,doSearch:D,clearSearch:L,doIngest:J,doReingest:$,confirmDelete:V,doDelete:M}}},pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),S=h(null),E=h(new Set),v=h(null),b=h(!1),x=h(!1),A=te(()=>e.value.reduce((ie,he)=>ie+he.count,0)),T=te(()=>E.value.size);function N(ie){const he=t.value[ie];if(!he)return[];if(!l.value.trim())return he;const X=l.value.trim().toLowerCase();return he.filter(ue=>ue.key.toLowerCase().includes(X)||ue.value&&ue.value.toLowerCase().includes(X))}function w(ie,he){return E.value.has(ie+"/"+he)}function _(ie,he){const X=ie+"/"+he,ue=new Set(E.value);ue.has(X)?ue.delete(X):ue.add(X),E.value=ue}function I(ie){const he=t.value[ie];return!he||he.length===0?!1:he.every(X=>E.value.has(ie+"/"+X.key))}function U(ie,he){const X=t.value[ie];if(!X)return;const ue=new Set(E.value);for(const Ie of X){const q=ie+"/"+Ie.key;he?ue.add(q):ue.delete(q)}E.value=ue}async function D(){s.value=!0,n.value=null;try{const ie=await G.get("/api/memory");e.value=Object.entries(ie).map(([he,X])=>({name:he,keys:X.keys||[],count:X.count||0}))}catch(ie){n.value=ie.message}s.value=!1}async function L(ie){if(a.value[ie]){a.value[ie]=!1;return}a.value[ie]=!0;const he=e.value.find(ue=>ue.name===ie);if(!he||t.value[ie]||i.value===ie)return;i.value=ie;const X=await Promise.all(he.keys.map(async ue=>{try{const Ie=await G.get(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(ue)}`);return{key:ue,value:Ie.value||""}}catch{return{key:ue,value:"(error loading)"}}}));t.value[ie]=X,i.value=null}function J(ie,he,X){f.value=ie+"/"+he,p.value=X}async function $(ie,he){m.value=!0,g.value=null;try{await G.put(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(he)}`,{value:p.value});const X=t.value[ie];if(X){const ue=X.find(Ie=>Ie.key===he);ue&&(ue.value=p.value)}f.value=null}catch(X){g.value=`Failed to save: ${X.message||"unknown error"}`}m.value=!1}async function V(ie,he){try{await navigator.clipboard.writeText(he.value),S.value=ie+"/"+he.key,setTimeout(()=>{S.value=null},1500)}catch{}}async function M(){u.value=null,d.value=null;const ie=o.value.scope.trim(),he=o.value.key.trim(),X=o.value.value.trim();if(!ie){u.value="Scope is required";return}if(!he){u.value="Key is required";return}if(!X){u.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(he)}`,{value:X}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await D(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(ue){u.value=ue.message}c.value=!1}function O(ie,he){v.value={scope:ie,key:he}}async function K(){if(!v.value)return;b.value=!0,g.value=null;const{scope:ie,key:he}=v.value;try{await G.del(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(he)}`);const X=t.value[ie];X&&(t.value[ie]=X.filter(q=>q.key!==he));const ue=e.value.find(q=>q.name===ie);ue&&(ue.count--,ue.keys=ue.keys.filter(q=>q!==he));const Ie=new Set(E.value);Ie.delete(ie+"/"+he),E.value=Ie}catch(X){g.value=`Failed to delete: ${X.message||"unknown error"}`}b.value=!1,v.value=null}function ve(){x.value=!0}async function me(){b.value=!0,g.value=null;const ie=[];for(const he of E.value){const X=he.indexOf("/");ie.push({scope:he.slice(0,X),key:he.slice(X+1)})}try{await G.post("/api/memory/bulk-delete",{entries:ie}),E.value=new Set,t.value={},await D()}catch(he){g.value=`Bulk delete failed: ${he.message||"unknown error"}`}b.value=!1,x.value=!1}return $e(()=>{D()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:S,selected:E,selectedCount:T,totalEntries:A,deleteTarget:v,deleting:b,showBulkDelete:x,fetchMemory:D,toggleScope:L,startEdit:J,doEdit:$,copyValue:V,doAdd:M,confirmDelete:O,doDelete:K,confirmBulkDelete:ve,doBulkDelete:me,isSelected:w,toggleSelect:_,isScopeAllSelected:I,toggleSelectAll:U,filteredEntries:N}}},hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=te(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=te(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await G.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return $e(()=>{c(),i=setInterval(c,3e4)}),ft(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:Kh,refresh:u,retry:d}}},kw=["INFO","WARNING","ERROR"],ww=[{id:"all",name:"All Logs",icon:"☰",filters:{}},{id:"errors",name:"Errors Only",icon:"❌",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"⚠",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"🔧",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"🔥",filters:{level:"ERROR",timeRange:"last_1h"}}],Mr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Sw=[50,100,200,500],Tw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(qe.state||"disconnected"),c=te(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,m=kw,g=ww,S=Mr,E=h("all"),v=h(""),b=h([]),x=h(!1),A=h(""),T=h([]);function N(){try{const j=localStorage.getItem("odin-log-presets");j&&(b.value=JSON.parse(j))}catch{}}function w(){try{localStorage.setItem("odin-log-presets",JSON.stringify(b.value))}catch{}}const _=te(()=>a.value!==""||i.value.trim()!==""||v.value!==""),I=te(()=>{const j=Mr.find(ne=>ne.value===v.value);return j?j.label:""}),U=te(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(j){return j.message}}),D=24,L=te(()=>{if(t.value.length===0)return[];const j=[],ne=new Date,xe=3600*1e3;for(let Qe=D-1;Qe>=0;Qe--){const nt=new Date(ne.getTime()-(Qe+1)*xe),Nt=new Date(ne.getTime()-Qe*xe);j.push({start:nt,end:Nt,label:M(nt,Nt),shortLabel:Nt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Qe of t.value){if(!Qe._time)continue;const nt=Qe._time.getTime();for(const Nt of j)if(nt>=Nt.start.getTime()&&nt<Nt.end.getTime()){Nt.total++,Qe.level==="ERROR"?Nt.errors++:Qe.level==="WARNING"?Nt.warnings++:Nt.info++;break}}return j}),J=te(()=>{let j=1;for(const ne of L.value)ne.total>j&&(j=ne.total);return j}),$=te(()=>L.value.length===0?"":"Last 24 hours"),V=te(()=>Math.ceil(D/8));function M(j,ne){const xe={hour:"2-digit",minute:"2-digit"};return j.toLocaleTimeString([],xe)+" - "+ne.toLocaleTimeString([],xe)}function O(j,ne){return!ne||!j?"0px":Math.max(2,j/ne*100)+"%"}function K(j){const ne=ve.value.findIndex(xe=>xe._time&&xe._time.getTime()>=j.start.getTime()&&xe._time.getTime()<j.end.getTime());if(ne>=0&&u.value){const xe=u.value.querySelectorAll(".log-line");xe[ne]&&(xe[ne].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const ve=te(()=>{let j=t.value;if(a.value&&(j=j.filter(ne=>(ne.level||"INFO")===a.value)),v.value){const ne=Mr.find(xe=>xe.value===v.value);if(ne&&ne.seconds){const xe=new Date(Date.now()-ne.seconds*1e3);j=j.filter(Qe=>Qe._time&&Qe._time>=xe)}}if(i.value&&!U.value)if(l.value)try{const ne=new RegExp(i.value,"i");j=j.filter(xe=>{const Qe=xe.text||xe.raw||"",nt=xe.tool||"";return ne.test(Qe)||ne.test(nt)})}catch{}else{const ne=i.value.toLowerCase();j=j.filter(xe=>{const Qe=(xe.text||xe.raw||"").toLowerCase(),nt=(xe.tool||"").toLowerCase();return Qe.includes(ne)||nt.includes(ne)})}return j});function me(j){if(j.type==="log"&&j.line)try{const ne=typeof j.line=="string"?JSON.parse(j.line):j.line,xe=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:xe.toLocaleTimeString(),_time:xe,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(j.line),tool:"",raw:String(j.line)}}if(j.payload){const ne=j.payload,xe=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:xe.toLocaleTimeString(),_time:xe,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}return typeof j=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:j,tool:"",raw:j}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(j),tool:"",raw:null}}function ie(j){const ne=me(j);if(s.value){T.value.push(ne);return}he(ne)}function he(j){t.value.push(j),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&Et(()=>X())}function X(){const j=u.value;if(j){const ne=j.scrollHeight-j.scrollTop-j.clientHeight;j.scrollTo({top:j.scrollHeight,behavior:ne<500?"smooth":"instant"})}}function ue(){n.value=!0,d.value=!1,Et(()=>X())}function Ie(){const j=u.value;if(!j)return;const ne=j.scrollHeight-j.scrollTop-j.clientHeight<40;d.value=!ne&&t.value.length>0,!ne&&n.value&&(n.value=!1)}function q(){if(s.value=!s.value,!s.value&&T.value.length>0){for(const j of T.value)he(j);T.value=[]}}function re(){t.value=[],T.value=[],d.value=!1}function le(){let j;e.value==="search"?j=ce.value.map(nt=>{const Nt=nt.error?"ERROR":"INFO",lr=nt.tool_name?`[${nt.tool_name}] `:"";return`${nt.timestamp||""} ${Nt} ${lr}${nt.result_summary||nt.message||""}`}).join(`
`):j=ve.value.map(nt=>`${nt.ts} ${nt.level} ${nt.text}`).join(`
`);const ne=new Blob([j],{type:"text/plain"}),xe=URL.createObjectURL(ne),Qe=document.createElement("a");Qe.href=xe,Qe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Qe.click(),URL.revokeObjectURL(xe)}function pe(j,ne){const xe=`${j.ts} ${j.level} ${j.text||j.raw||""}`;navigator.clipboard.writeText(xe).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function ge(j){a.value=a.value===j?"":j,E.value="all"}function Le(j){return j.level==="ERROR"?"log-line-error":j.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(j){return j==="ERROR"?"text-red-500 font-semibold":j==="WARNING"?"text-yellow-500":"text-blue-500"}function C(j){return j==="ERROR"?"log-chip-error":j==="WARNING"?"log-chip-warning":"log-chip-info"}function P(j){E.value=j.id;const ne=j.filters;a.value=ne.level||"",v.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function W(j){E.value=j.id,a.value=j.filters.level||"",v.value=j.filters.timeRange||"",i.value=j.filters.text||""}function R(){if(!A.value.trim())return;const j={id:"custom-"+Date.now(),name:A.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};b.value=[...b.value,j],w(),x.value=!1,A.value=""}function F(j){b.value=b.value.filter(ne=>ne.id!==j),w(),E.value===j&&(E.value="all")}const Y=h("all"),Z=h(""),se=h(""),Q=h(""),B=h(""),ee=h(""),oe=h(100),be=Sw,Te=h(!1),Ae=h(!1),H=h(""),ce=h([]),ye=h(null),Me=h(null);function Je(){e.value="search",ye.value||Ke()}async function Ke(){try{ye.value=await G.get("/api/logs/stats")}catch{}}function St(){const j=ee.value;if(!j){Q.value="",B.value="";return}const xe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[j];if(xe){const Qe=new Date(Date.now()-xe*1e3);Q.value=st(Qe),B.value=""}}function st(j){const ne=xe=>String(xe).padStart(2,"0");return`${j.getFullYear()}-${ne(j.getMonth()+1)}-${ne(j.getDate())}T${ne(j.getHours())}:${ne(j.getMinutes())}`}function Ye(j){if(!j)return"";const ne=new Date(j);return isNaN(ne.getTime())?"":ne.toISOString()}async function en(){Te.value=!0,H.value="",Ae.value=!0,Me.value=null;try{const j=new URLSearchParams;Y.value&&Y.value!=="all"&&j.set("level",Y.value),Z.value&&j.set("tool",Z.value),se.value&&j.set("q",se.value);const ne=Ye(Q.value),xe=Ye(B.value);ne&&j.set("start",ne),xe&&j.set("end",xe),j.set("limit",String(oe.value));const Qe=await G.get(`/api/logs/search?${j.toString()}`);ce.value=Qe.entries||[]}catch(j){H.value=j.message||"Search failed",ce.value=[]}finally{Te.value=!1}}function mn(){Y.value="all",Z.value="",se.value="",Q.value="",B.value="",ee.value="",oe.value=100,ce.value=[],Ae.value=!1,H.value="",Me.value=null}function Ei(j){Me.value=Me.value===j?null:j}function Ca(j){if(!j.timestamp)return"";try{return new Date(j.timestamp).toLocaleString()}catch{return j.timestamp}}function Ai(j){return j.type==="web_action"?`${j.status||""} (${j.execution_time_ms||0}ms)`:(j.result_summary||"").slice(0,200)}function Hn(j){return j.error?"log-line-error":"text-gray-300"}function jn(j){try{return JSON.stringify(j,null,2)}catch{return String(j)}}let Gt=null;return $e(()=>{N(),qe.subscribe("logs",ie),r.value=qe.connected,o.value=qe.state||"disconnected",Gt=qe.onStateChange;const j=qe.onStateChange;qe.onStateChange=(ne,xe)=>{o.value=ne,r.value=ne==="connected",j&&j(ne,xe)}}),ft(()=>{qe.unsubscribe("logs",ie),Gt!==void 0&&(qe.onStateChange=Gt)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ve,pauseBuffer:T,showJumpBottom:d,copiedIndex:f,regexError:U,levels:m,logPresets:g,timeRanges:S,timeRange:v,activeLogPreset:E,customLogPresets:b,showSaveLogPreset:x,newLogPresetName:A,hasActiveLogFilters:_,timeRangeLabel:I,timelineBuckets:L,timelineMax:J,timelineSpanLabel:$,timelineLabelSkip:V,togglePause:q,clearLogs:re,exportLogs:le,logLineClass:Le,levelClass:y,levelChipClass:C,toggleLevel:ge,copyLine:pe,jumpToBottom:ue,onScroll:Ie,applyLogPreset:P,applyCustomLogPreset:W,saveLogCustomPreset:R,removeLogCustomPreset:F,segmentHeight:O,jumpToTimelineBucket:K,searchLevel:Y,searchTool:Z,searchKeyword:se,searchStart:Q,searchEnd:B,searchTimePreset:ee,searchLimit:oe,searchLimits:be,searching:Te,searchRan:Ae,searchError:H,searchResults:ce,searchStats:ye,expandedSearch:Me,switchToSearch:Je,runSearch:en,clearSearchFilters:mn,toggleSearchExpand:Ei,formatSearchTs:Ca,searchEntryText:Ai,searchLogLineClass:Hn,formatJson:jn,applySearchTimePreset:St}}},Cw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Ew={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Aw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1“128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"monitoring.cooldown_minutes":{type:"number",min:0,message:"Must be non-negative"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Fr=[{key:"core",label:"Core",icon:"⚙",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"🧠",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"💾",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"🔗",sections:["webhook","monitoring","observability","email","voice","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"🛠",sections:["tools"]},{key:"ui",label:"Web UI",icon:"🌐",sections:["web"]},{key:"automation",label:"Automation",icon:"🔄",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"🔌",sections:["issue_tracker"]}],og="••••••••",Rw=50;function Iw(e){return Cw.has(e)}function Nw(e){return e===og}function zi(e){return JSON.parse(JSON.stringify(e))}function Nn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Dw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Nn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Ow(e,t,s){const n=Aw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Md(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Nn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Lw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=te(()=>d.value.length>0),m=te(()=>f.value.length>0),g=te(()=>r.value&&t.value?t.value:e.value),S=te(()=>!e.value||!t.value?!1:!Nn(e.value,t.value)),E=te(()=>!e.value||!t.value?0:Md(e.value,t.value).length),v=te(()=>{if(!r.value||!t.value)return{};const R={};for(const F of Object.keys(t.value)){const Y=t.value[F];if(typeof Y=="object"&&Y!==null&&!Array.isArray(Y))for(const Z of Object.keys(Y)){const se=Ow(F,Z,Y[Z]);se&&(R[F+"."+Z]=se)}}return R}),b=te(()=>Object.keys(v.value).length>0),x=te(()=>e.value?Object.keys(e.value).length:0),A=te(()=>N.value.length),T=te(()=>!e.value||!t.value?[]:Md(e.value,t.value)),N=te(()=>e.value?Fr.map(R=>({...R,sections:R.sections.filter(F=>F in e.value)})).filter(R=>R.sections.length>0):[]),w=te(()=>{if(!e.value)return[];const R=new Set(Fr.flatMap(F=>F.sections));return Object.keys(e.value).filter(F=>!R.has(F))});function _(R){return g.value?g.value[R]:null}function I(R){return!e.value||!t.value?!1:!Nn(e.value[R],t.value[R])}function U(R){return R.sections.some(F=>I(F))}function D(R,F){if(!e.value||!t.value)return!1;const Y=e.value[R],Z=t.value[R];return!Y||!Z?!1:!Nn(Y[F],Z[F])}function L(R){return t.value?t.value[R]:e.value[R]}function J(R,F){const Y=t.value||e.value;return Y[R]?Y[R][F]:void 0}function $(R,F){const Y=r.value&&t.value?t.value:e.value;return Y[R]?Y[R][F]:!1}function V(R,F){return v.value[R+"."+F]||null}function M(R,F){return Ew[R+"."+F]||null}function O(R,F,Y){t.value&&(F===null?t.value[R]=Y:(t.value[R]||(t.value[R]={}),t.value[R][F]=Y),t.value={...t.value})}function K(R,F,Y){if(!t.value)return;const Z=zi(t.value);O(R,F,Y),d.value.push(Z),d.value.length>Rw&&d.value.shift(),f.value=[]}function ve(R,F,Y){try{const Z=JSON.parse(Y);K(R,F,Z)}catch{}}function me(){d.value.length!==0&&(f.value.push(zi(t.value)),t.value=d.value.pop())}function ie(){f.value.length!==0&&(d.value.push(zi(t.value)),t.value=f.value.pop())}function he(R,F,Y){if(!t.value||!t.value[R])return;const Z=[...t.value[R][F]];Z.splice(Y,1),K(R,F,Z)}function X(R,F){if(!t.value||!t.value[R])return;const Y=[...t.value[R][F]||[]],Z=prompt("Enter new value:");Z!==null&&(Y.push(Z),K(R,F,Y))}function ue(R){a.value={...a.value,[R]:!a.value[R]}}function Ie(R){l.value={...l.value,[R]:!l.value[R]}}function q(R){i.value={...i.value,[R]:!i.value[R]}}function re(R){try{return JSON.stringify(R,null,2)}catch{return String(R)}}function le(R){return R==null?"null":typeof R=="object"?JSON.stringify(R,null,2):String(R)}function pe(R,F){c.value={type:R,message:F},setTimeout(()=>{c.value=null},3e3)}function ge(){t.value=zi(e.value),r.value=!0,d.value=[],f.value=[]}function Le(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function C(){if(!(!S.value||b.value)){o.value=!0;try{const R=Dw(e.value,t.value);if(Object.keys(R).length===0){pe("success","No changes to save."),o.value=!1;return}const F=await G.put("/api/config",R);e.value=F,r.value=!1,t.value=null,d.value=[],f.value=[],pe("success","Config saved successfully.")}catch(R){pe("error",R.message||"Failed to save config")}o.value=!1}}async function P(){s.value=!0,n.value=null;try{e.value=await G.get("/api/config");for(const R of Object.keys(e.value))a.value[R]===void 0&&(a.value[R]=!0);for(const R of Fr)l.value[R.key]===void 0&&(l.value[R.key]=!0)}catch(R){n.value=R.message}s.value=!1}function W(R){r.value&&((R.ctrlKey||R.metaKey)&&!R.shiftKey&&R.key==="z"?(R.preventDefault(),me()):(R.ctrlKey||R.metaKey)&&(R.key==="y"||R.shiftKey&&R.key==="z"||R.shiftKey&&R.key==="Z")&&(R.preventDefault(),ie()))}return $e(()=>{P(),document.addEventListener("keydown",W)}),ft(()=>{document.removeEventListener("keydown",W)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:S,hasErrors:b,changeCount:E,REDACTED:og,showDiffModal:u,diffEntries:T,canUndo:p,canRedo:m,sectionCount:x,groupCount:A,visibleGroups:N,ungroupedSections:w,validationErrors:v,isSensitiveKey:Iw,isRedacted:Nw,sectionChanged:I,groupChanged:U,fieldChanged:D,getDisplay:_,getEdited:L,getEditedField:J,getDisplayBool:$,pushEdit:K,pushEditJson:ve,getValidationError:V,getEnumOptions:M,removeArrayItem:he,addArrayItem:X,toggleSection:ue,toggleGroup:Ie,toggleNested:q,formatJson:re,formatDiffVal:le,showToast:pe,showDiff:y,fetchConfig:P,startEdit:ge,cancelEdit:Le,saveConfig:C,undo:me,redo:ie}}},Pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=te(()=>{const M={};for(const O of u.value)M[O.id]=O;return M});function p(M){return f.value[M]||null}const m=te(()=>/^\d{15,25}$/.test(r.value.trim())),g=te(()=>{const M=r.value.toLowerCase().trim();return M?u.value.filter(O=>!i.value[O.id]&&(O.display_name.toLowerCase().includes(M)||O.username.toLowerCase().includes(M)||O.id.includes(M))):u.value.filter(O=>!i.value[O.id])});function S(M,O){return M?M.allowed_hosts===null||M.allowed_hosts===void 0?{allowed_hosts:[...O],default_host:M.default_host||"",allow_all:!0}:{allowed_hosts:M.allowed_hosts,default_host:M.default_host||"",allow_all:!1}:{allowed_hosts:[...O],default_host:O[0]||"",allow_all:!0}}async function E(){e.value=!0,t.value="";try{const M=await G.get("/api/host-access");s.value=M,n.value=M.available_hosts||[],a.value=S(M.default_policy,n.value);const O=M.users||{},K={};for(const[ve,me]of Object.entries(O))K[ve]=S(me,n.value);i.value=K}catch(M){t.value=M.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await G.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const M=a.value.allow_all?null:a.value.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:a.value.default_host}),ke.success("Default policy updated")}catch(M){ke.error(M.message||"Failed to save")}}function b(M,O){a.value.allow_all=!1,O?a.value.allowed_hosts.includes(M)||a.value.allowed_hosts.push(M):(a.value.allowed_hosts=a.value.allowed_hosts.filter(K=>K!==M),a.value.default_host===M&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function x(M){const O=i.value[M];if(O)try{const K=O.allow_all?null:O.allowed_hosts;await G.put(`/api/host-access/user/${M}`,{allowed_hosts:K,default_host:O.default_host});const ve=p(M);ke.success(`Updated access for ${ve?ve.display_name:M}`)}catch(K){ke.error(K.message||"Failed to save")}}function A(M,O,K){const ve=i.value[M];ve&&(ve.allow_all=!1,K?ve.allowed_hosts.includes(O)||ve.allowed_hosts.push(O):(ve.allowed_hosts=ve.allowed_hosts.filter(me=>me!==O),ve.default_host===O&&(ve.default_host=ve.allowed_hosts[0]||"")),x(M))}function T(M,O){const K=i.value[M];K&&(K.default_host=O,x(M))}function N(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function w(){o.value=!0,c.value=0}function _(){c.value<g.value.length-1&&c.value++}function I(){c.value>0&&c.value--}function U(){const M=g.value[c.value];if(M){L(M);return}m.value&&D()}function D(){const M=r.value.trim();/^\d{15,25}$/.test(M)&&(i.value[M]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(M),r.value="",o.value=!1,l.value=!1)}function L(M){i.value[M.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(M.id),r.value="",o.value=!1,l.value=!1}function J(){o.value=!1}function $(){setTimeout(()=>{o.value=!1},150)}async function V(M){const O=p(M);if(await ns({title:"Remove user override",message:`Remove the host access override for ${O?O.display_name:M}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await G.del(`/api/host-access/user/${M}`),delete i.value[M],ke.success(`Removed override for ${O?O.display_name:M}`)}catch(ve){ke.error(ve.message||"Failed to delete")}}return $e(E),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:g,isRawId:m,searchInput:d,fetchData:E,saveDefaultPolicy:v,toggleDefaultHost:b,getMember:p,toggleUserHost:A,setUserDefault:T,openAddUser:N,deleteUser:V,onSearchInput:w,highlightNext:_,highlightPrev:I,selectHighlighted:U,selectMember:L,closeDropdown:J,onBlur:$,addRawId:D}}},Fw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=te(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=te(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(w){return w==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":w==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const w=await G.get("/api/tokens");s.value=w.tokens||[],n.value=w.available_hosts||[]}catch(w){t.value=w.message||"Failed to load tokens"}finally{e.value=!1}}function g(w){return!w||!w.trim()?[]:w.split(",").map(_=>_.trim()).filter(Boolean)}function S(w,_){const I=c.value.allowed_hosts;if(_&&!I.includes(w)&&I.push(w),!_){const U=I.indexOf(w);U>=0&&I.splice(U,1)}}function E(w,_){const I=u.value.allowed_hosts;if(_&&!I.includes(w)&&I.push(w),!_){const U=I.indexOf(w);U>=0&&I.splice(U,1)}}async function v(){var w;i.value=!0;try{const _=g(c.value.allowed_tools_str),I=c.value.host_mode,U=I==="none"?[]:I==="select"?c.value.allowed_hosts:null,D={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:_.length?_:[]};U!==null&&(D.allowed_hosts=U),D.default_host=c.value.default_host||"";const L=await G.post("/api/tokens",D);l.value=L.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ke.success("Token created"),await m()}catch(_){ke.error(((w=_.data)==null?void 0:w.error)||_.message||"Failed to create token")}finally{i.value=!1}}function b(w){r.value=w;const _=w.allowed_hosts;let I="default";_==null?I="default":Array.isArray(_)&&_.length===0?I="none":Array.isArray(_)&&(I="select"),u.value={username:w.username||"",tier:w.tier||"admin",label:w.label||"",host_mode:I,allowed_hosts:Array.isArray(_)?[..._]:[],default_host:w.default_host||"",allowed_tools_str:(w.allowed_tools||[]).join(", ")}}async function x(){var w;if(r.value){o.value=!0;try{const _=g(u.value.allowed_tools_str),I=u.value.host_mode,U={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:_};I==="none"?U.allowed_hosts=[]:I==="select"?U.allowed_hosts=u.value.allowed_hosts:U.allowed_hosts=null,U.default_host=u.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),U),r.value=null,ke.success("Token updated"),await m()}catch(_){ke.error(((w=_.data)==null?void 0:w.error)||_.message||"Failed to update")}finally{o.value=!1}}}async function A(w){var I;if(await ns({title:"Regenerate token",message:`Regenerate token for ${w.username||w.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const U=await G.post("/api/tokens/"+encodeURIComponent(w.user_id)+"/regenerate");l.value=U.token,ke.success("Token regenerated")}catch(U){ke.error(((I=U.data)==null?void 0:I.error)||U.message||"Failed to regenerate")}}async function T(w){var I;if(await ns({title:"Delete token",message:`Delete token for ${w.username||w.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(w.user_id)),ke.success("Token deleted"),await m()}catch(U){ke.error(((I=U.data)==null?void 0:I.error)||U.message||"Failed to delete")}}async function N(){if(l.value)try{await navigator.clipboard.writeText(l.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return $e(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:S,toggleEditHost:E,createToken:v,startEdit:b,saveEdit:x,confirmRegenerate:A,confirmDelete:T,copyToken:N}}},$w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096}),a=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),i=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),l=h(!1),r=h(!1),o=h(!1),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h({configured:!1}),m=h([]),g=h(""),S=h(!1),E=h(!1),v=h({configured:!1}),b=h([]),x=h(""),A=h(!1),T=h(!1),N=h(!0),w=h(""),_=h({configured:!1,accounts:[]}),I=h(null),U=h(null),D=h(""),L=h(null),J=h(!1),$=h(null),V=h(null),M=h("");let O=null;function K(B,ee="success"){ke(B,ee==="error"?"error":"success")}function ve(B){if(!B)return"?";const ee=B/(1024*1024*1024);return ee>=1?ee.toFixed(1)+" GB":(B/(1024*1024)).toFixed(0)+" MB"}async function me(){e.value=!0,await Promise.all([ie(),he(),le(),X()]),e.value=!1}async function ie(){try{const B=await G.get("/api/llm/status");t.value=B,s.value=B.active_provider||"codex",B.codex&&(n.value.enabled=B.codex.enabled,n.value.model=B.codex.model||"gpt-5.5",n.value.max_tokens=B.codex.max_tokens||4096),B.ollama&&(a.value.enabled=B.ollama.enabled,a.value.base_url=B.ollama.base_url||"",a.value.model=B.ollama.model||"",a.value.max_tokens=B.ollama.max_tokens||4096),B.kimi&&(i.value.enabled=B.kimi.enabled,i.value.model=B.kimi.model||"",i.value.max_tokens=B.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function he(){try{if(p.value=await G.get("/api/ollama/status"),p.value.model&&(g.value=p.value.model),p.value.configured)try{const B=await G.get("/api/ollama/models");m.value=B.models||[]}catch{m.value=[]}else if(a.value.base_url)try{const B=await G.post("/api/ollama/probe-models",{base_url:a.value.base_url});m.value=B.models||[]}catch{m.value=[]}}catch{p.value={configured:!1}}}async function X(){N.value=!0,w.value="";try{_.value=await G.get("/api/codex/status")}catch(B){w.value=B.message||"Failed to fetch Codex status"}finally{N.value=!1}}async function ue(){const B=t.value?t.value.active_provider:"codex";f.value=!0;try{const ee=await G.post("/api/llm/switch",{provider:s.value});ee.error?(s.value=B,K(ee.error,"error")):(K("Switched to "+s.value+" ("+ee.model+")"),await me())}catch(ee){s.value=B,K(ee.message||"Switch failed","error")}finally{f.value=!1}}async function Ie(){S.value=!0;try{const B=await G.post("/api/ollama/reload");K(B.configured?"Ollama reloaded":B.reason||"Ollama not configured",B.configured?"success":"error"),await me()}catch(B){K(B.message||"Reload failed","error")}finally{S.value=!1}}async function q(){E.value=!0;try{await G.post("/api/ollama/model",{model:g.value}),K("Model set to "+g.value),await me()}catch(B){K(B.message||"Failed","error")}finally{E.value=!1}}async function re(){const B=a.value.base_url;if(!B){K("Enter a base URL first","error");return}d.value=!0;try{const ee=await G.post("/api/ollama/probe-models",{base_url:B});m.value=ee.models||[],m.value.length?(K(m.value.length+" model(s) found"),!a.value.model&&m.value.length&&(a.value.model=m.value[0].name)):K("No models found at "+B,"error")}catch(ee){K(ee.message||"Could not reach Ollama","error")}finally{d.value=!1}}async function le(){try{if(v.value=await G.get("/api/kimi/status"),v.value.model&&(x.value=v.value.model),v.value.configured)try{const B=await G.get("/api/kimi/models");b.value=B.models||[]}catch{b.value=[]}}catch{v.value={configured:!1}}}async function pe(){A.value=!0;try{const B=await G.post("/api/kimi/reload");K(B.configured?"Kimi reloaded":B.reason||"Kimi not configured",B.configured?"success":"error"),await me()}catch(B){K(B.message||"Reload failed","error")}finally{A.value=!1}}async function ge(){T.value=!0;try{await G.post("/api/kimi/model",{model:x.value}),K("Model set to "+x.value),await me()}catch(B){K(B.message||"Failed","error")}finally{T.value=!1}}async function Le(){o.value=!0;try{await G.put("/api/llm/codex/config",n.value),K("Codex config saved"),await me()}catch(B){K(B.message||"Failed","error")}finally{o.value=!1}}async function y(){c.value=!0;try{const B={...a.value};l.value||delete B.api_key,await G.put("/api/llm/ollama/config",B),K("Ollama config saved"),a.value.api_key="",l.value=!1,await me()}catch(B){K(B.message||"Failed","error")}finally{c.value=!1}}async function C(){u.value=!0;try{const B={...i.value};r.value||delete B.api_key,await G.put("/api/llm/kimi/config",B),K("Kimi config saved"),i.value.api_key="",r.value=!1,await me()}catch(B){K(B.message||"Failed","error")}finally{u.value=!1}}async function P(B){try{await G.post("/api/codex/account/"+B+"/activate"),K("Active account switched"),await X()}catch(ee){K(ee.message||"Failed","error")}}async function W(B){I.value=B;try{await G.post("/api/codex/account/"+B+"/refresh"),K("Token refreshed"),await X()}catch(ee){K(ee.message||"Refresh failed","error")}finally{I.value=null}}function R(B,ee){U.value=B,D.value=ee||""}async function F(B){try{await G.put("/api/codex/account/"+B+"/label",{label:D.value}),K("Label updated"),U.value=null,await X()}catch(ee){K(ee.message||"Failed","error")}}async function Y(B,ee){if(await ns({title:"Delete Codex account",message:`Delete ${ee||"account #"+(B+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/codex/account/"+B),K("Deleted. Pool reloaded."),await X()}catch(be){K(be.message||"Failed","error")}}async function Z(){J.value=!0;try{const B=await G.post("/api/codex/device-code");$.value=B,L.value="pending",se(B)}catch(B){K(B.message||"Failed","error")}finally{J.value=!1}}async function se(B){O={cancelled:!1};const ee=O;try{const oe=await G.post("/api/codex/device-poll",{device_auth_id:B.device_auth_id,user_code:B.user_code,interval:B.interval});if(ee.cancelled)return;V.value=oe,L.value="success",await me()}catch(oe){if(ee.cancelled)return;M.value=oe.message||"Device login failed",L.value="error"}}function Q(){O&&(O.cancelled=!0),L.value=null,$.value=null}return $e(me),ft(()=>{O&&(O.cancelled=!0)}),{loading:e,llmStatus:t,selectedProvider:s,switching:f,codexForm:n,ollamaForm:a,kimiForm:i,savingCodex:o,savingOllama:c,savingKimi:u,probingOllama:d,ollamaKeyDirty:l,kimiKeyDirty:r,ollamaStatus:p,ollamaModels:m,ollamaSelectedModel:g,reloading:S,settingModel:E,kimiStatus:v,kimiModels:b,kimiSelectedModel:x,reloadingKimi:A,settingKimiModel:T,codexLoading:N,codexError:w,codexData:_,refreshing:I,editingLabel:U,labelValue:D,deviceState:L,deviceLoading:J,deviceInfo:$,deviceResult:V,deviceError:M,fetchAll:me,switchProvider:ue,reloadOllama:Ie,setOllamaModel:q,reloadKimi:pe,setKimiModel:ge,probeOllamaModels:re,saveCodexConfig:Le,saveOllamaConfig:y,saveKimiConfig:C,activateAccount:P,refreshAccount:W,startEditLabel:R,saveLabel:F,deleteAccount:Y,startDeviceLogin:Z,cancelDeviceLogin:Q,formatSize:ve}}},Fd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Bw(e){return Fd[e]||Fd[(e||"").toLowerCase()]||"text-gray-400"}const Uw={template:`
  ...
  `},jw={components:{TabbedPage:ir},setup(){return{tabs:[{id:"health",label:"Health",component:xw},{id:"resources",label:"Resources",component:_w},{id:"logs",label:"Logs",component:Tw},{id:"config",label:"Config",component:Lw},{id:"discord",label:"Discord",component:Pw},{id:"host-access",label:"Host Access",component:Mw},{id:"api-tokens",label:"API Tokens",component:Fw},{id:"llm",label:"LLM Config",component:$w},{id:"internals",label:"Internals",component:Uw},{id:"update",label:"Update",component:Hw}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},cg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:I_,meta:{label:"Dashboard",icon:"📊"}},{path:"/chat",component:Kk,meta:{label:"Chat",icon:"💭"}},{path:"/operations",component:Zk,meta:{label:"Operations",icon:"🎯"}},{path:"/history",component:lw,meta:{label:"History",icon:"📝"}},{path:"/capabilities",component:gw,meta:{label:"Capabilities",icon:"🔧"}},{path:"/personality",component:mw,meta:{label:"Personality",icon:"🎭"}},{path:"/system",component:jw,meta:{label:"System",icon:"⚙️"}},{path:"/execution",redirect:{path:"/operations",query:{tab:"live"}}},{path:"/agents",redirect:{path:"/operations",query:{tab:"agents"}}},{path:"/loops",redirect:{path:"/operations",query:{tab:"loops"}}},{path:"/processes",redirect:{path:"/operations",query:{tab:"processes"}}},{path:"/schedules",redirect:{path:"/operations",query:{tab:"schedules"}}},{path:"/audit",redirect:{path:"/history",query:{tab:"audit"}}},{path:"/sessions",redirect:{path:"/history",query:{tab:"sessions"}}},{path:"/traces",redirect:{path:"/history",query:{tab:"traces"}}},{path:"/usage",redirect:{path:"/history",query:{tab:"usage"}}},{path:"/tools",redirect:{path:"/capabilities",query:{tab:"tools"}}},{path:"/skills",redirect:{path:"/capabilities",query:{tab:"skills"}}},{path:"/knowledge",redirect:{path:"/capabilities",query:{tab:"knowledge"}}},{path:"/memory",redirect:{path:"/capabilities",query:{tab:"memory"}}},{path:"/health",redirect:{path:"/system",query:{tab:"health"}}},{path:"/resources",redirect:{path:"/system",query:{tab:"resources"}}},{path:"/logs",redirect:{path:"/system",query:{tab:"logs"}}},{path:"/config",redirect:{path:"/system",query:{tab:"config"}}},{path:"/host-access",redirect:{path:"/system",query:{tab:"host-access"}}},{path:"/internals",redirect:{path:"/system",query:{tab:"internals"}}}],ug=w_({history:t_(),routes:cg});ug.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Vw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(!1),i=h("disconnected"),l=h(-1),r=h(null);let o=null;const c=h("starting"),u=h(""),d=cg.filter(T=>T.meta);G.onSessionExpired=()=>{t.value=!0,qe.disconnect(),G.setToken(""),e.value="login"};function f(T){if((T.ctrlKey||T.metaKey)&&T.key.toLowerCase()==="k"){e.value==="ready"&&(T.preventDefault(),C_());return}if(T.key==="Escape"&&n.value){n.value=!1,T.preventDefault();return}if(T.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(T.target.tagName)){T.preventDefault();const N=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');N&&N.focus()}}$e(async()=>{document.addEventListener("keydown",f);const T=await G.check();T.ok?(e.value="ready",x()):T.needsAuth?e.value="login":(e.value="ready",x())});function p(){t.value=!1,e.value="ready",x()}async function m(){await G.logout(),qe.disconnect(),e.value="login"}function g(){s.value=!s.value}const S=te(()=>{switch(i.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function E(T,N="info",w=3e3){r.value={text:T,level:N},clearTimeout(o),o=setTimeout(()=>{r.value=null},w)}let v=null,b=!1;function x(){qe.onStatusChange=T=>{a.value=T},qe.onStateChange=(T,N)=>{i.value=T,l.value=N.latency??-1,T==="connected"?(b&&E("Connection restored","success"),b=!0):T==="reconnecting"&&N.attempt===1&&E("Connection lost — reconnecting…","warn")},qe.connect(),A(),v&&clearInterval(v),v=setInterval(A,15e3)}async function A(){try{const T=await G.get("/api/status");c.value=T.status==="online"?"online":"starting";const N=T.uptime_seconds||0,w=Math.floor(N/3600),_=Math.floor(N%3600/60);u.value=`${w}h ${_}m uptime`}catch{c.value="offline",u.value=""}}return ft(()=>{v&&clearInterval(v),qe.disconnect(),document.removeEventListener("keydown",f)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:a,wsState:i,wsLatency:l,wsLabel:S,wsToast:r,botStatus:c,botUptime:u,navRoutes:d,onLogin:p,logout:m,toggleSidebar:g}}},Ta=ml(qw);Ta.component("login-screen",Vw);Ta.component("toast-container",g0);Ta.component("confirm-host",m0);Ta.component("command-palette",A_);Ta.use(ug);Ta.mount("#app");
