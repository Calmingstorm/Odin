...
`,-1)}f0(e.hoists,t),i(),a("return ")}function hr(e,t,{helper:s,push:n,newline:a,isTS:i}){const l=s(t==="filter"?Qc:t==="component"?Jc:Yc);for(let o=0;o<e.length;o++){let r=e[o];const c=r.endsWith("__self");c&&(r=r.slice(0,-6)),n(`const ${al(r,t)} = ${l}(${JSON.stringify(r)}${c?", true":""})${i?"!":""}`),o<e.length-1&&a()}}function f0(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:n}=t;n();for(let a=0;a<e.length;a++){const i=e[a];i&&(s(`const _hoisted_${a+1} = `),ls(i,t),n())}t.pure=!1}function ud(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),bl(e,t,s),s&&t.deindent(),t.push("]")}function bl(e,t,s=!1,n=!0){const{push:a,newline:i}=t;for(let l=0;l<e.length;l++){const o=e[l];Ue(o)?a(o,-3):Ce(o)?ud(o,t):ls(o,t),l<e.length-1&&(s?(n&&a(","),i()):n&&a(", "))}}function ls(e,t){if(Ue(e)){t.push(e,-3);return}if(os(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:ls(e.codegenNode,t);break;case 2:h0(e,t);break;case 4:hm(e,t);break;case 5:m0(e,t);break;case 12:ls(e.codegenNode,t);break;case 8:mm(e,t);break;case 3:g0(e,t);break;case 13:b0(e,t);break;case 14:x0(e,t);break;case 15:_0(e,t);break;case 17:w0(e,t);break;case 18:k0(e,t);break;case 19:S0(e,t);break;case 20:T0(e,t);break;case 21:bl(e.body,t,!0,!1);break}}function h0(e,t){t.push(JSON.stringify(e.content),-3,e)}function hm(e,t){const{content:s,isStatic:n}=e;t.push(n?JSON.stringify(s):s,-3,e)}function m0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(Ko),s(`${n(Vo)}(`),ls(e.content,t),s(")")}function mm(e,t){for(let s=0;s<e.children.length;s++){const n=e.children[s];Ue(n)?t.push(n,-3):ls(n,t)}}function v0(e,t){const{push:s}=t;if(e.type===8)s("["),mm(e,t),s("]");else if(e.isStatic){const n=rd(e.content)?e.content:JSON.stringify(e.content);s(n,-2,e)}else s(`[${e.content}]`,-3,e)}function g0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(Ko),s(`${n(vl)}(${JSON.stringify(e.content)})`,-3,e)}function b0(e,t){const{push:s,helper:n,pure:a}=t,{tag:i,props:l,children:o,patchFlag:r,dynamicProps:c,directives:d,isBlock:u,disableTracking:p,isComponent:h}=e;let m;r&&(m=String(r)),d&&s(n(Xc)+"("),u&&s(`(${n(wa)}(${p?"true":""}), `),a&&s(Ko);const g=u?ri(t.inSSR,h):oi(t.inSSR,h);s(n(g)+"(",-2,e),bl(y0([i,l,o,m,c]),t),s(")"),u&&s(")"),d&&(s(", "),ls(d,t),s(")"))}function y0(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function x0(e,t){const{push:s,helper:n,pure:a}=t,i=Ue(e.callee)?e.callee:n(e.callee);a&&s(Ko),s(i+"(",-2,e),bl(e.arguments,t),s(")")}function _0(e,t){const{push:s,indent:n,deindent:a,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const o=l.length>1||!1;s(o?"{":"{ "),o&&n();for(let r=0;r<l.length;r++){const{key:c,value:d}=l[r];v0(c,t),s(": "),ls(d,t),r<l.length-1&&(s(","),i())}o&&a(),s(o?"}":" }")}function w0(e,t){ud(e.elements,t)}function k0(e,t){const{push:s,indent:n,deindent:a}=t,{params:i,returns:l,body:o,newline:r,isSlot:c}=e;c&&s(`_${ii[ad]}(`),s("(",-2,e),Ce(i)?bl(i,t):i&&ls(i,t),s(") => "),(r||o)&&(s("{"),n()),l?(r&&s("return "),Ce(l)?ud(l,t):ls(l,t)):o&&ls(o,t),(r||o)&&(a(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function S0(e,t){const{test:s,consequent:n,alternate:a,newline:i}=e,{push:l,indent:o,deindent:r,newline:c}=t;if(s.type===4){const u=!rd(s.content);u&&l("("),hm(s,t),u&&l(")")}else l("("),ls(s,t),l(")");i&&o(),t.indentLevel++,i||l(" "),l("? "),ls(n,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const d=a.type===19;d||t.indentLevel++,ls(a,t),d||t.indentLevel--,i&&r(!0)}function T0(e,t){const{push:s,helper:n,indent:a,deindent:i,newline:l}=t,{needPauseTracking:o,needArraySpread:r}=e;r&&s("[...("),s(`_cache[${e.index}] || (`),o&&(a(),s(`${n(ho)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),ls(e.value,t),o&&(s(`).cacheIndex = ${e.index},`),l(),s(`${n(ho)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),r&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const C0=pm(/^(?:if|else|else-if)$/,(e,t,s)=>E0(e,t,s,(n,a,i)=>{const l=s.parent.children;let o=l.indexOf(n),r=0;for(;o-->=0;){const c=l[o];c&&c.type===9&&(r+=c.branches.length)}return()=>{if(i)n.codegenNode=Ru(a,r,s);else{const c=A0(n.codegenNode);c.alternate=Ru(a,r+n.branches.length-1,s)}}}));function E0(e,t,s,n){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const a=t.exp?t.exp.loc:e.loc;s.onError(bt(28,t.loc)),t.exp=He("true",!1,a)}if(t.name==="if"){const a=Au(e,t),i={type:9,loc:e0(e.loc),branches:[a]};if(s.replaceNode(i),n)return n(i,a,!0)}else{const a=s.parent.children;let i=a.indexOf(e);for(;i-->=-1;){const l=a[i];if(l&&nm(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(bt(30,e.loc)),s.removeNode();const o=Au(e,t);l.branches.push(o);const r=n&&n(l,o,!1);Go(o,s),r&&r(),s.currentNode=null}else s.onError(bt(30,e.loc));break}}}function Au(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!$s(e,"for")?e.children:[e],userKey:qo(e,"key"),isTemplateIf:s}}function Ru(e,t,s){return e.condition?Yr(e.condition,Iu(e,t,s),Ht(s.helper(vl),['""',"true"])):Iu(e,t,s)}function Iu(e,t,s){const{helper:n}=s,a=Dt("key",He(`${t}`,!1,Ls,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const r=l.codegenNode;return bo(r,a,s),r}else return sl(s,n(el),Us([a]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const r=l.codegenNode,c=Vx(r);return c.type===13&&ld(c,s),bo(c,a,s),r}}function A0(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const R0=pm("for",(e,t,s)=>{const{helper:n,removeHelper:a}=s;return I0(e,t,s,i=>{const l=Ht(n(ed),[i.source]),o=vo(e),r=$s(e,"memo"),c=qo(e,"key",!1,!0);c&&c.type;let d=c&&(c.type===6?c.value?He(c.value.content,!0):void 0:c.exp);const u=d?Dt("key",d):null,p=i.source.type===4&&i.source.constType>0,h=p?64:c?128:256;return i.codegenNode=sl(s,n(el),void 0,l,h,void 0,void 0,!0,!p,!1,e.loc),()=>{let m;const{children:g}=i,w=g.length!==1||g[0].type!==1,N=go(e)?e:o&&e.children.length===1&&go(e.children[0])?e.children[0]:null;if(N?(m=N.codegenNode,o&&u&&bo(m,u,s)):w?m=sl(s,n(el),u?Us([u]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(m=g[0].codegenNode,o&&u&&bo(m,u,s),m.isBlock!==!p&&(m.isBlock?(a(wa),a(ri(s.inSSR,m.isComponent))):a(oi(s.inSSR,m.isComponent))),m.isBlock=!p,m.isBlock?(n(wa),n(ri(s.inSSR,m.isComponent))):n(oi(s.inSSR,m.isComponent))),r){const x=li(ec(i.parseResult,[He("_cached")]));x.body=Lx([Gs(["const _memo = (",r.exp,")"]),Gs(["if (_cached && _cached.el",...d?[" && _cached.key === ",d]:[],` && ${s.helperString(Jh)}(_cached, _memo)) return _cached`]),Gs(["const _item = ",m]),He("_item.memo = _memo"),He("return _item")]),l.arguments.push(x,He("_cache"),He(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(li(ec(i.parseResult),m,!0))}})});function I0(e,t,s,n){if(!t.exp){s.onError(bt(31,t.loc));return}const a=t.forParseResult;if(!a){s.onError(bt(32,t.loc));return}vm(a);const{addIdentifiers:i,removeIdentifiers:l,scopes:o}=s,{source:r,value:c,key:d,index:u}=a,p={type:11,loc:t.loc,source:r,valueAlias:c,keyAlias:d,objectIndexAlias:u,parseResult:a,children:vo(e)?e.children:[e]};s.replaceNode(p),o.vFor++;const h=n&&n(p);return()=>{o.vFor--,h&&h()}}function vm(e,t){e.finalized||(e.finalized=!0)}function ec({value:e,key:t,index:s},n=[]){return O0([e,t,s,...n])}function O0(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,n)=>s||He("_".repeat(n+1),!1))}const Ou=He("undefined",!1),L0=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=$s(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},N0=(e,t,s,n)=>li(e,s,!1,!0,s.length?s[0].loc:n);function D0(e,t,s=N0){t.helper(ad);const{children:n,loc:a}=e,i=[],l=[];let o=t.scopes.vSlot>0||t.scopes.vFor>0;const r=$s(e,"slot",!0);if(r){const{arg:w,exp:N}=r;w&&!_s(w)&&(o=!0),i.push(Dt(w||He("default",!0),s(N,void 0,n,a)))}let c=!1,d=!1;const u=[],p=new Set;let h=0;for(let w=0;w<n.length;w++){const N=n[w];let x;if(!vo(N)||!(x=$s(N,"slot",!0))){N.type!==3&&u.push(N);continue}if(r){t.onError(bt(37,x.loc));break}c=!0;const{children:b,loc:y}=N,{arg:A=He("default",!0),exp:S,loc:L}=x;let R;_s(A)?R=A?A.content:"default":o=!0;const _=$s(N,"for"),D=s(S,_,b,y);let U,T;if(U=$s(N,"if"))o=!0,l.push(Yr(U.exp,Ll(A,D,h++),Ou));else if(T=$s(N,/^else(?:-if)?$/,!0)){let M=w,j;for(;M--&&(j=n[M],!!nm(j)););if(j&&vo(j)&&$s(j,/^(?:else-)?if$/)){let J=l[l.length-1];for(;J.alternate.type===19;)J=J.alternate;J.alternate=T.exp?Yr(T.exp,Ll(A,D,h++),Ou):Ll(A,D,h++)}else t.onError(bt(30,T.loc))}else if(_){o=!0;const M=_.forParseResult;M?(vm(M),l.push(Ht(t.helper(ed),[M.source,li(ec(M),Ll(A,D),!0)]))):t.onError(bt(32,_.loc))}else{if(R){if(p.has(R)){t.onError(bt(38,L));continue}p.add(R),R==="default"&&(d=!0)}i.push(Dt(A,D))}}if(!r){const w=(N,x)=>{const b=s(N,void 0,x,a);return t.compatConfig&&(b.isNonScopedSlot=!0),Dt("default",b)};c?u.length&&!u.every(cd)&&(d?t.onError(bt(39,u[0].loc)):i.push(w(void 0,u))):i.push(w(void 0,n))}const m=o?2:ql(e.children)?3:1;let g=Us(i.concat(Dt("_",He(m+"",!1))),a);return l.length&&(g=Ht(t.helper(Wh),[g,ba(l)])),{slots:g,hasDynamicSlots:o}}function Ll(e,t,s){const n=[Dt("name",e),Dt("fn",t)];return s!=null&&n.push(Dt("key",He(String(s),!0))),Us(n)}function ql(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||ql(s.children))return!0;break;case 9:if(ql(s.branches))return!0;break;case 10:case 11:if(ql(s.children))return!0;break}}return!1}const gm=new WeakMap,P0=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:n,props:a}=e,i=e.tagType===1;let l=i?M0(e,t):`"${n}"`;const o=tt(l)&&l.callee===Zc;let r,c,d=0,u,p,h,m=o||l===$i||l===qc||!i&&(n==="svg"||n==="foreignObject"||n==="math");if(a.length>0){const g=bm(e,t,void 0,i,o);r=g.props,d=g.patchFlag,p=g.dynamicPropNames;const w=g.directives;h=w&&w.length?ba(w.map(N=>$0(N,t))):void 0,g.shouldUseBlock&&(m=!0)}if(e.children.length>0)if(l===po&&(m=!0,d|=1024),i&&l!==$i&&l!==po){const{slots:w,hasDynamicSlots:N}=D0(e,t);c=w,N&&(d|=1024)}else if(e.children.length===1&&l!==$i){const w=e.children[0],N=w.type,x=N===5||N===8;x&&Rs(w,t)===0&&(d|=1),x||N===2?c=w:c=e.children}else c=e.children;p&&p.length&&(u=U0(p)),e.codegenNode=sl(t,l,r,c,d===0?void 0:d,u,h,!!m,!1,i,e.loc)};function M0(e,t,s=!1){let{tag:n}=e;const a=tc(n),i=qo(e,"is",!1,!0);if(i)if(a||ya("COMPILER_IS_ON_ELEMENT",t)){let o;if(i.type===6?o=i.value&&He(i.value.content,!0):(o=i.exp,o||(o=He("is",!1,i.arg.loc))),o)return Ht(t.helper(Zc),[o])}else i.type===6&&i.value.content.startsWith("vue:")&&(n=i.value.content.slice(4));const l=Yh(n)||t.isBuiltInComponent(n);return l?(s||t.helper(l),l):(t.helper(Jc),t.components.add(n),al(n,"component"))}function bm(e,t,s=e.props,n,a,i=!1){const{tag:l,loc:o,children:r}=e;let c=[];const d=[],u=[],p=r.length>0;let h=!1,m=0,g=!1,w=!1,N=!1,x=!1,b=!1,y=!1;const A=[],S=D=>{c.length&&(d.push(Us(Lu(c),o)),c=[]),D&&d.push(D)},L=()=>{t.scopes.vFor>0&&c.push(Dt(He("ref_for",!0),He("true")))},R=({key:D,value:U})=>{if(_s(D)){const T=D.content,M=Sa(T);if(M&&(!n||a)&&T.toLowerCase()!=="onclick"&&T!=="onUpdate:modelValue"&&!Cn(T)&&(x=!0),M&&Cn(T)&&(y=!0),M&&U.type===14&&(U=U.arguments[0]),U.type===20||(U.type===4||U.type===8)&&Rs(U,t)>0)return;T==="ref"?g=!0:T==="class"?w=!0:T==="style"?N=!0:T!=="key"&&!A.includes(T)&&A.push(T),n&&(T==="class"||T==="style")&&!A.includes(T)&&A.push(T)}else b=!0};for(let D=0;D<s.length;D++){const U=s[D];if(U.type===6){const{loc:T,name:M,nameLoc:j,value:J}=U;let E=!0;if(M==="ref"&&(g=!0,L()),M==="is"&&(tc(l)||J&&J.content.startsWith("vue:")||ya("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(Dt(He(M,!0,j),He(J?J.content:"",E,J?J.loc:T)))}else{const{name:T,arg:M,exp:j,loc:J,modifiers:E}=U,k=T==="bind",C=T==="on";if(T==="slot"){n||t.onError(bt(40,J));continue}if(T==="once"||T==="memo"||T==="is"||k&&ua(M,"is")&&(tc(l)||ya("COMPILER_IS_ON_ELEMENT",t))||C&&i)continue;if((k&&ua(M,"key")||C&&p&&ua(M,"vue:before-update"))&&(h=!0),k&&ua(M,"ref")&&L(),!M&&(k||C)){if(b=!0,j)if(k){if(S(),ya("COMPILER_V_BIND_OBJECT_ORDER",t)){d.unshift(j);continue}L(),S(),d.push(j)}else S({type:14,loc:J,callee:t.helper(nd),arguments:n?[j]:[j,"true"]});else t.onError(bt(k?34:35,J));continue}k&&E.some(W=>W.content==="prop")&&(m|=32);const $=t.directiveTransforms[T];if($){const{props:W,needRuntime:G}=$(U,e,t);!i&&W.forEach(R),C&&M&&!_s(M)?S(Us(W,o)):c.push(...W),G&&(u.push(U),os(G)&&gm.set(U,G))}else Rv(T)||(u.push(U),p&&(h=!0))}}let _;if(d.length?(S(),d.length>1?_=Ht(t.helper(fo),d,o):_=d[0]):c.length&&(_=Us(Lu(c),o)),b?m|=16:(w&&!n&&(m|=2),N&&!n&&(m|=4),A.length&&(m|=8),x&&(m|=32)),!h&&(m===0||m===32)&&(g||y||u.length>0)&&(m|=512),!t.inSSR&&_)switch(_.type){case 15:let D=-1,U=-1,T=!1;for(let J=0;J<_.properties.length;J++){const E=_.properties[J].key;_s(E)?E.content==="class"?D=J:E.content==="style"&&(U=J):E.isHandlerKey||(T=!0)}const M=_.properties[D],j=_.properties[U];T?_=Ht(t.helper(tl),[_]):(M&&!_s(M.value)&&(M.value=Ht(t.helper(td),[M.value])),j&&(N||j.value.type===4&&j.value.content.trim()[0]==="["||j.value.type===17)&&(j.value=Ht(t.helper(sd),[j.value])));break;case 14:break;default:_=Ht(t.helper(tl),[Ht(t.helper(gl),[_])]);break}return{props:_,directives:u,patchFlag:m,dynamicPropNames:A,shouldUseBlock:h}}function Lu(e){const t=new Map,s=[];for(let n=0;n<e.length;n++){const a=e[n];if(a.key.type===8||!a.key.isStatic){s.push(a);continue}const i=a.key.content,l=t.get(i);l?(i==="style"||i==="class"||Sa(i))&&F0(l,a):(t.set(i,a),s.push(a))}return s}function F0(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=ba([e.value,t.value],e.loc)}function $0(e,t){const s=[],n=gm.get(e);n?s.push(t.helperString(n)):(t.helper(Yc),t.directives.add(e.name),s.push(al(e.name,"directive")));const{loc:a}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=He("true",!1,a);s.push(Us(e.modifiers.map(l=>Dt(l,i)),a))}return ba(s,e.loc)}function U0(e){let t="[";for(let s=0,n=e.length;s<n;s++)t+=JSON.stringify(e[s]),s<n-1&&(t+=", ");return t+"]"}function tc(e){return e==="component"||e==="Component"}const B0=(e,t)=>{if(go(e)){const{children:s,loc:n}=e,{slotName:a,slotProps:i}=H0(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",a,"{}","undefined","true"];let o=2;i&&(l[2]=i,o=3),s.length&&(l[3]=li([],s,!1,!1,n),o=4),t.scopeId&&!t.slotted&&(o=5),l.splice(o),e.codegenNode=Ht(t.helper(Kh),l,n)}};function H0(e,t){let s='"default"',n;const a=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=pt(l.name),a.push(l)));else if(l.name==="bind"&&ua(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const o=pt(l.arg.content);s=l.exp=He(o,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&_s(l.arg)&&(l.arg.content=pt(l.arg.content)),a.push(l)}if(a.length>0){const{props:i,directives:l}=bm(e,t,a,!1,!1);n=i,l.length&&t.onError(bt(36,l[0].loc))}return{slotName:s,slotProps:n}}const ym=(e,t,s,n)=>{const{loc:a,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(bt(35,a));let o;if(l.type===4)if(l.isStatic){let u=l.content;u.startsWith("vue:")&&(u=`vnode-${u.slice(4)}`);const p=t.tagType!==0||u.startsWith("vnode")||!/[A-Z]/.test(u)?Ga(pt(u)):`on:${u}`;o=He(p,!0,l.loc)}else o=Gs([`${s.helperString(Zr)}(`,l,")"]);else o=l,o.children.unshift(`${s.helperString(Zr)}(`),o.children.push(")");let r=e.exp;r&&!r.content.trim()&&(r=void 0);let c=s.cacheHandlers&&!r&&!s.inVOnce;if(r){const u=em(r),p=!(u||Bx(r)),h=r.content.includes(";");(p||c&&u)&&(r=Gs([`${p?"$event":"(...args)"} => ${h?"{":"("}`,r,h?"}":")"]))}let d={props:[Dt(o,r||He("() => {}",!1,a))]};return n&&(d=n(d)),c&&(d.props[0].value=s.cache(d.props[0].value)),d.props.forEach(u=>u.key.isHandlerKey=!0),d},z0=(e,t,s)=>{const{modifiers:n,loc:a}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),n.some(o=>o.content==="camel")&&(i.type===4?i.isStatic?i.content=pt(i.content):i.content=`${s.helperString(Jr)}(${i.content})`:(i.children.unshift(`${s.helperString(Jr)}(`),i.children.push(")"))),s.inSSR||(n.some(o=>o.content==="prop")&&Nu(i,"."),n.some(o=>o.content==="attr")&&Nu(i,"^")),{props:[Dt(i,l)]}},Nu=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},j0=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let n,a=!1;for(let i=0;i<s.length;i++){const l=s[i];if(fr(l)){a=!0;for(let o=i+1;o<s.length;o++){const r=s[o];if(fr(r))n||(n=s[i]=Gs([l],l.loc)),n.children.push(" + ",r),s.splice(o,1),o--;else{n=void 0;break}}}}if(!(!a||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(fr(l)||l.type===8){const o=[];(l.type!==2||l.content!==" ")&&o.push(l),!t.ssr&&Rs(l,t)===0&&o.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:Ht(t.helper(Wc),o)}}}}},Du=new WeakSet,V0=(e,t)=>{if(e.type===1&&$s(e,"once",!0))return Du.has(e)||t.inVOnce||t.inSSR?void 0:(Du.add(e),t.inVOnce=!0,t.helper(ho),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},xm=(e,t,s)=>{const{exp:n,arg:a}=e;if(!n)return s.onError(bt(41,e.loc)),_i();const i=n.loc.source.trim(),l=n.type===4?n.content:i,o=s.bindingMetadata[i];if(o==="props"||o==="props-aliased")return s.onError(bt(44,n.loc)),_i();if(o==="literal-const"||o==="setup-const")return s.onError(bt(45,n.loc)),_i();if(!l.trim()||!em(n))return s.onError(bt(42,n.loc)),_i();const r=a||He("modelValue",!0),c=a?_s(a)?`onUpdate:${pt(a.content)}`:Gs(['"onUpdate:" + ',a]):"onUpdate:modelValue";let d;const u=s.isTS?"($event: any)":"$event";d=Gs([`${u} => ((`,n,") = $event)"]);const p=[Dt(r,e.exp),Dt(c,d)];if(e.modifiers.length&&t.tagType===1){const h=e.modifiers.map(g=>g.content).map(g=>(rd(g)?g:JSON.stringify(g))+": true").join(", "),m=a?_s(a)?`${a.content}Modifiers`:Gs([a,' + "Modifiers"']):"modelModifiers";p.push(Dt(m,He(`{ ${h} }`,!1,e.loc,2)))}return _i(p)};function _i(e=[]){return{props:e}}const q0=/[\w).+\-_$\]]/,G0=(e,t)=>{ya("COMPILER_FILTERS",t)&&(e.type===5?yo(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&yo(s.exp,t)}))};function yo(e,t){if(e.type===4)Pu(e,t);else for(let s=0;s<e.children.length;s++){const n=e.children[s];typeof n=="object"&&(n.type===4?Pu(n,t):n.type===8?yo(e,t):n.type===5&&yo(n.content,t))}}function Pu(e,t){const s=e.content;let n=!1,a=!1,i=!1,l=!1,o=0,r=0,c=0,d=0,u,p,h,m,g=[];for(h=0;h<s.length;h++)if(p=u,u=s.charCodeAt(h),n)u===39&&p!==92&&(n=!1);else if(a)u===34&&p!==92&&(a=!1);else if(i)u===96&&p!==92&&(i=!1);else if(l)u===47&&p!==92&&(l=!1);else if(u===124&&s.charCodeAt(h+1)!==124&&s.charCodeAt(h-1)!==124&&!o&&!r&&!c)m===void 0?(d=h+1,m=s.slice(0,h).trim()):w();else{switch(u){case 34:a=!0;break;case 39:n=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:r++;break;case 93:r--;break;case 123:o++;break;case 125:o--;break}if(u===47){let N=h-1,x;for(;N>=0&&(x=s.charAt(N),x===" ");N--);(!x||!q0.test(x))&&(l=!0)}}m===void 0?m=s.slice(0,h).trim():d!==0&&w();function w(){g.push(s.slice(d,h).trim()),d=h+1}if(g.length){for(h=0;h<g.length;h++)m=K0(m,g[h],t);e.content=m,e.ast=void 0}}function K0(e,t,s){s.helper(Qc);const n=t.indexOf("(");if(n<0)return s.filters.add(t),`${al(t,"filter")}(${e})`;{const a=t.slice(0,n),i=t.slice(n+1);return s.filters.add(a),`${al(a,"filter")}(${e}${i!==")"?","+i:i}`}}const Mu=new WeakSet,W0=(e,t)=>{if(e.type===1){const s=$s(e,"memo");return!s||Mu.has(e)||t.inSSR?void 0:(Mu.add(e),()=>{const n=e.codegenNode||t.currentNode.codegenNode;n&&n.type===13&&(e.tagType!==1&&ld(n,t),e.codegenNode=Ht(t.helper(id),[s.exp,li(void 0,n),"_cache",String(t.cached.length)]),t.cached.push(null))})}},J0=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const n=s.arg;if(n.type!==4||!n.isStatic)t.onError(bt(53,n.loc)),s.exp=He("",!0,n.loc);else{const a=pt(n.content);(Qh.test(a[0])||a[0]==="-")&&(s.exp=He(a,!1,n.loc))}}}};function Z0(e){return[[J0,V0,C0,W0,R0,G0,B0,P0,L0,j0],{on:ym,bind:z0,model:xm}]}function Y0(e,t={}){const s=t.onError||od,n=t.mode==="module";t.prefixIdentifiers===!0?s(bt(48)):n&&s(bt(49));const a=!1;t.cacheHandlers&&s(bt(50)),t.scopeId&&!n&&s(bt(51));const i=qe({},t,{prefixIdentifiers:a}),l=Ue(e)?n0(e,i):e,[o,r]=Z0();return o0(l,qe({},i,{nodeTransforms:[...o,...t.nodeTransforms||[]],directiveTransforms:qe({},r,t.directiveTransforms||{})})),u0(l,i)}const Q0=()=>({props:[]});/**
 ...
 * @license MIT
 */const Ba=typeof document<"u";function Om(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function x_(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&Om(e.default)}const lt=Object.assign;function mr(e,t){const s={};for(const n in t){const a=t[n];s[n]=Ws(a)?a.map(e):e(a)}return s}const Ui=()=>{},Ws=Array.isArray;function Bu(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}const Lm=/#/g,__=/&/g,w_=/\//g,k_=/=/g,S_=/\?/g,Nm=/\+/g,T_=/%5B/g,C_=/%5D/g,Dm=/%5E/g,E_=/%60/g,Pm=/%7B/g,A_=/%7C/g,Mm=/%7D/g,R_=/%20/g;function fd(e){return e==null?"":encodeURI(""+e).replace(A_,"|").replace(T_,"[").replace(C_,"]")}function I_(e){return fd(e).replace(Pm,"{").replace(Mm,"}").replace(Dm,"^")}function nc(e){return fd(e).replace(Nm,"%2B").replace(R_,"+").replace(Lm,"%23").replace(__,"%26").replace(E_,"`").replace(Pm,"{").replace(Mm,"}").replace(Dm,"^")}function O_(e){return nc(e).replace(k_,"%3D")}function L_(e){return fd(e).replace(Lm,"%23").replace(S_,"%3F")}function N_(e){return L_(e).replace(w_,"%2F")}function ll(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const D_=/\/$/,P_=e=>e.replace(D_,"");function vr(e,t,s="/"){let n,a={},i="",l="";const o=t.indexOf("#");let r=t.indexOf("?");return r=o>=0&&r>o?-1:r,r>=0&&(n=t.slice(0,r),i=t.slice(r,o>0?o:t.length),a=e(i.slice(1))),o>=0&&(n=n||t.slice(0,o),l=t.slice(o,t.length)),n=U_(n??t,s),{fullPath:n+i+l,path:n,query:a,hash:ll(l)}}function M_(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function Hu(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function F_(e,t,s){const n=t.matched.length-1,a=s.matched.length-1;return n>-1&&n===a&&ci(t.matched[n],s.matched[a])&&Fm(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function ci(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function Fm(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!$_(e[s],t[s]))return!1;return!0}function $_(e,t){return Ws(e)?zu(e,t):Ws(t)?zu(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function zu(e,t){return Ws(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function U_(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),a=n[n.length-1];(a===".."||a===".")&&n.push("");let i=s.length-1,l,o;for(l=0;l<n.length;l++)if(o=n[l],o!==".")if(o==="..")i>1&&i--;else break;return s.slice(0,i).join("/")+"/"+n.slice(l).join("/")}const Vn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let ac=(function(e){return e.pop="pop",e.push="push",e})({}),gr=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function B_(e){if(!e)if(Ba){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),P_(e)}const H_=/^[^#]+#/;function z_(e,t){return e.replace(H_,"#")+t}function j_(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const Jo=()=>({left:window.scrollX,top:window.scrollY});function V_(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),a=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!a)return;t=j_(a,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function ju(e,t){return(history.state?history.state.position-t:-1)+e}const ic=new Map;function q_(e,t){ic.set(e,t)}function G_(e){const t=ic.get(e);return ic.delete(e),t}function K_(e){return typeof e=="string"||e&&typeof e=="object"}function $m(e){return typeof e=="string"||typeof e=="symbol"}let Tt=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const Um=Symbol("");Tt.MATCHER_NOT_FOUND+"",Tt.NAVIGATION_GUARD_REDIRECT+"",Tt.NAVIGATION_ABORTED+"",Tt.NAVIGATION_CANCELLED+"",Tt.NAVIGATION_DUPLICATED+"";function di(e,t){return lt(new Error,{type:e,[Um]:!0},t)}function mn(e,t){return e instanceof Error&&Um in e&&(t==null||!!(e.type&t))}const W_=["params","query","hash"];function J_(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of W_)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}function Z_(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const a=s[n].replace(Nm," "),i=a.indexOf("="),l=ll(i<0?a:a.slice(0,i)),o=i<0?null:ll(a.slice(i+1));if(l in t){let r=t[l];Ws(r)||(r=t[l]=[r]),r.push(o)}else t[l]=o}return t}function Vu(e){let t="";for(let s in e){const n=e[s];if(s=O_(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(Ws(n)?n.map(a=>a&&nc(a)):[n&&nc(n)]).forEach(a=>{a!==void 0&&(t+=(t.length?"&":"")+s,a!=null&&(t+="="+a))})}return t}function Y_(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=Ws(n)?n.map(a=>a==null?null:""+a):n==null?n:""+n)}return t}const Q_=Symbol(""),qu=Symbol(""),Zo=Symbol(""),hd=Symbol(""),lc=Symbol("");function wi(){let e=[];function t(n){return e.push(n),()=>{const a=e.indexOf(n);a>-1&&e.splice(a,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function Zn(e,t,s,n,a,i=l=>l()){const l=n&&(n.enterCallbacks[a]=n.enterCallbacks[a]||[]);return()=>new Promise((o,r)=>{const c=p=>{p===!1?r(di(Tt.NAVIGATION_ABORTED,{from:s,to:t})):p instanceof Error?r(p):K_(p)?r(di(Tt.NAVIGATION_GUARD_REDIRECT,{from:t,to:p})):(l&&n.enterCallbacks[a]===l&&typeof p=="function"&&l.push(p),o())},d=i(()=>e.call(n&&n.instances[a],t,s,c));let u=Promise.resolve(d);e.length<3&&(u=u.then(c)),u.catch(p=>r(p))})}function br(e,t,s,n,a=i=>i()){const i=[];for(const l of e)for(const o in l.components){let r=l.components[o];if(!(t!=="beforeRouteEnter"&&!l.instances[o]))if(Om(r)){const c=(r.__vccOpts||r)[t];c&&i.push(Zn(c,s,n,l,o,a))}else{let c=r();i.push(()=>c.then(d=>{if(!d)throw new Error(`Couldn't resolve component "${o}" at "${l.path}"`);const u=x_(d)?d.default:d;l.mods[o]=d,l.components[o]=u;const p=(u.__vccOpts||u)[t];return p&&Zn(p,s,n,l,o,a)()}))}}return i}function X_(e,t){const s=[],n=[],a=[],i=Math.max(t.matched.length,e.matched.length);for(let l=0;l<i;l++){const o=t.matched[l];o&&(e.matched.find(c=>ci(c,o))?n.push(o):s.push(o));const r=e.matched[l];r&&(t.matched.find(c=>ci(c,r))||a.push(r))}return[s,n,a]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let ew=()=>location.protocol+"//"+location.host;function Bm(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,o=a.slice(l);return o[0]!=="/"&&(o="/"+o),Hu(o,"")}return Hu(s,e)+n+a}function tw(e,t,s,n){let a=[],i=[],l=null;const o=({state:p})=>{const h=Bm(e,location),m=s.value,g=t.value;let w=0;if(p){if(s.value=h,t.value=p,l&&l===m){l=null;return}w=g?p.position-g.position:0}else n(h);a.forEach(N=>{N(s.value,m,{delta:w,type:ac.pop,direction:w?w>0?gr.forward:gr.back:gr.unknown})})};function r(){l=s.value}function c(p){a.push(p);const h=()=>{const m=a.indexOf(p);m>-1&&a.splice(m,1)};return i.push(h),h}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(lt({},p.state,{scroll:Jo()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",o),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",o),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:r,listen:c,destroy:u}}function Gu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?Jo():null}}function sw(e){const{history:t,location:s}=window,n={value:Bm(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(r,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+r:ew()+e+r;try{t[d?"replaceState":"pushState"](c,"",p),a.value=c}catch(h){console.error(h),s[d?"replace":"assign"](p)}}function l(r,c){i(r,lt({},t.state,Gu(a.value.back,r,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=r}function o(r,c){const d=lt({},a.value,t.state,{forward:r,scroll:Jo()});i(d.current,d,!0),i(r,lt({},Gu(n.value,r,null),{position:d.position+1},c),!1),n.value=r}return{location:n,state:a,push:o,replace:l}}function nw(e){e=B_(e);const t=sw(e),s=tw(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=lt({location:"",base:e,go:n,createHref:z_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function aw(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),nw(e)}let fa=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Ut=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Ut||{});const iw={type:fa.Static,value:""},lw=/[a-zA-Z0-9_]/;function ow(e){if(!e)return[[]];if(e==="/")return[[iw]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(h){throw new Error(`ERR (${s})/"${c}": ${h}`)}let s=Ut.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let o=0,r,c="",d="";function u(){c&&(s===Ut.Static?i.push({type:fa.Static,value:c}):s===Ut.Param||s===Ut.ParamRegExp||s===Ut.ParamRegExpEnd?(i.length>1&&(r==="*"||r==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:fa.Param,value:c,regexp:d,repeatable:r==="*"||r==="+",optional:r==="*"||r==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=r}for(;o<e.length;){if(r=e[o++],r==="\\"&&s!==Ut.ParamRegExp){n=s,s=Ut.EscapeNext;continue}switch(s){case Ut.Static:r==="/"?(c&&u(),l()):r===":"?(u(),s=Ut.Param):p();break;case Ut.EscapeNext:p(),s=n;break;case Ut.Param:r==="("?s=Ut.ParamRegExp:lw.test(r)?p():(u(),s=Ut.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--);break;case Ut.ParamRegExp:r===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+r:s=Ut.ParamRegExpEnd:d+=r;break;case Ut.ParamRegExpEnd:u(),s=Ut.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--,d="";break;default:t("Unknown state");break}}return s===Ut.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const Ku="[^/]+?",rw={sensitive:!1,strict:!1,start:!0,end:!0};var us=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(us||{});const cw=/[.+*?^${}()[\]/\\]/g;function dw(e,t){const s=lt({},rw,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[us.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const p=c[u];let h=us.Segment+(s.sensitive?us.BonusCaseSensitive:0);if(p.type===fa.Static)u||(a+="/"),a+=p.value.replace(cw,"\\$&"),h+=us.Static;else if(p.type===fa.Param){const{value:m,repeatable:g,optional:w,regexp:N}=p;i.push({name:m,repeatable:g,optional:w});const x=N||Ku;if(x!==Ku){h+=us.BonusCustomRegExp;try{`${x}`}catch(y){throw new Error(`Invalid custom RegExp for param "${m}" (${x}): `+y.message)}}let b=g?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;u||(b=w&&c.length<2?`(?:/${b})`:"/"+b),w&&(b+="?"),a+=b,h+=us.Dynamic,w&&(h+=us.BonusOptional),g&&(h+=us.BonusRepeatable),x===".*"&&(h+=us.BonusWildcard)}d.push(h)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=us.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function o(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const h=d[p]||"",m=i[p-1];u[m.name]=h&&m.repeatable?h.split("/"):h}return u}function r(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const h of p)if(h.type===fa.Static)d+=h.value;else if(h.type===fa.Param){const{value:m,repeatable:g,optional:w}=h,N=m in c?c[m]:"";if(Ws(N)&&!g)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const x=Ws(N)?N.join("/"):N;if(!x)if(w)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${m}"`);d+=x}}return d||"/"}return{re:l,score:n,keys:i,parse:o,stringify:r}}function uw(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===us.Static+us.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===us.Static+us.Segment?1:-1:0}function Hm(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=uw(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Wu(n))return 1;if(Wu(a))return-1}return a.length-n.length}function Wu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const pw={strict:!1,end:!0,sensitive:!1};function fw(e,t,s){const n=dw(ow(e.path),s),a=lt(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function hw(e,t){const s=[],n=new Map;t=Bu(pw,t);function a(u){return n.get(u)}function i(u,p,h){const m=!h,g=Zu(u);g.aliasOf=h&&h.record;const w=Bu(t,u),N=[g];if("alias"in u){const y=typeof u.alias=="string"?[u.alias]:u.alias;for(const A of y)N.push(Zu(lt({},g,{components:h?h.record.components:g.components,path:A,aliasOf:h?h.record:g})))}let x,b;for(const y of N){const{path:A}=y;if(p&&A[0]!=="/"){const S=p.record.path,L=S[S.length-1]==="/"?"":"/";y.path=p.record.path+(A&&L+A)}if(x=fw(y,p,w),h?h.alias.push(x):(b=b||x,b!==x&&b.alias.push(x),m&&u.name&&!Yu(x)&&l(u.name)),zm(x)&&r(x),g.children){const S=g.children;for(let L=0;L<S.length;L++)i(S[L],x,h&&h.children[L])}h=h||x}return b?()=>{l(b)}:Ui}function l(u){if($m(u)){const p=n.get(u);p&&(n.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function o(){return s}function r(u){const p=gw(u,s);s.splice(p,0,u),u.record.name&&!Yu(u)&&n.set(u.record.name,u)}function c(u,p){let h,m={},g,w;if("name"in u&&u.name){if(h=n.get(u.name),!h)throw di(Tt.MATCHER_NOT_FOUND,{location:u});w=h.record.name,m=lt(Ju(p.params,h.keys.filter(b=>!b.optional).concat(h.parent?h.parent.keys.filter(b=>b.optional):[]).map(b=>b.name)),u.params&&Ju(u.params,h.keys.map(b=>b.name))),g=h.stringify(m)}else if(u.path!=null)g=u.path,h=s.find(b=>b.re.test(g)),h&&(m=h.parse(g),w=h.record.name);else{if(h=p.name?n.get(p.name):s.find(b=>b.re.test(p.path)),!h)throw di(Tt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});w=h.record.name,m=lt({},p.params,u.params),g=h.stringify(m)}const N=[];let x=h;for(;x;)N.unshift(x.record),x=x.parent;return{name:w,path:g,params:m,matched:N,meta:vw(N)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:o,getRecordMatcher:a}}function Ju(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Zu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:mw(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function mw(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function Yu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function vw(e){return e.reduce((t,s)=>lt(t,s.meta),{})}function gw(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;Hm(e,t[i])<0?n=i:s=i+1}const a=bw(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function bw(e){let t=e;for(;t=t.parent;)if(zm(t)&&Hm(e,t)===0)return t}function zm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Qu(e){const t=Bs(Zo),s=Bs(hd),n=q(()=>{const r=ln(e.to);return t.resolve(r)}),a=q(()=>{const{matched:r}=n.value,{length:c}=r,d=r[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(ci.bind(null,d));if(p>-1)return p;const h=Xu(r[c-2]);return c>1&&Xu(d)===h&&u[u.length-1].path!==h?u.findIndex(ci.bind(null,r[c-2])):p}),i=q(()=>a.value>-1&&kw(s.params,n.value.params)),l=q(()=>a.value>-1&&a.value===s.matched.length-1&&Fm(s.params,n.value.params));function o(r={}){if(ww(r)){const c=t[ln(e.replace)?"replace":"push"](ln(e.to)).catch(Ui);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:q(()=>n.value.href),isActive:i,isExactActive:l,navigate:o}}function yw(e){return e.length===1?e[0]:e}const xw=fl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Qu,setup(e,{slots:t}){const s=ea(Qu(e)),{options:n}=Bs(Zo),a=q(()=>({[ep(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[ep(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&yw(t.default(s));return e.custom?i:si("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),_w=xw;function ww(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function kw(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Ws(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function Xu(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const ep=(e,t,s)=>e??t??s,Sw=fl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Bs(lc),a=q(()=>e.route||n.value),i=Bs(qu,0),l=q(()=>{let c=ln(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),o=q(()=>a.value.matched[l.value]);Di(qu,q(()=>l.value+1)),Di(Q_,o),Di(lc,a);const r=f();return Mt(()=>[r.value,o.value,e.name],([c,d,u],[p,h,m])=>{d&&(d.instances[u]=c,h&&h!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=h.leaveGuards),d.updateGuards.size||(d.updateGuards=h.updateGuards))),c&&d&&(!h||!ci(d,h)||!p)&&(d.enterCallbacks[u]||[]).forEach(g=>g(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=o.value,p=u&&u.components[d];if(!p)return tp(s.default,{Component:p,route:c});const h=u.props[d],m=h?h===!0?c.params:typeof h=="function"?h(c):h:null,w=si(p,lt({},m,t,{onVnodeUnmounted:N=>{N.component.isUnmounted&&(u.instances[d]=null)},ref:r}));return tp(s.default,{Component:w,route:c})||w}}});function tp(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Tw=Sw;function Cw(e){const t=hw(e.routes,e),s=e.parseQuery||Z_,n=e.stringifyQuery||Vu,a=e.history,i=wi(),l=wi(),o=wi(),r=Sc(Vn);let c=Vn;Ba&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=mr.bind(null,Y=>""+Y),u=mr.bind(null,N_),p=mr.bind(null,ll);function h(Y,ge){let V,re;return $m(Y)?(V=t.getRecordMatcher(Y),re=ge):re=Y,t.addRoute(re,V)}function m(Y){const ge=t.getRecordMatcher(Y);ge&&t.removeRoute(ge)}function g(){return t.getRoutes().map(Y=>Y.record)}function w(Y){return!!t.getRecordMatcher(Y)}function N(Y,ge){if(ge=lt({},ge||r.value),typeof Y=="string"){const I=vr(s,Y,ge.path),F=t.resolve({path:I.path},ge),ee=a.createHref(I.fullPath);return lt(I,F,{params:p(F.params),hash:ll(I.hash),redirectedFrom:void 0,href:ee})}let V;if(Y.path!=null)V=lt({},Y,{path:vr(s,Y.path,ge.path).path});else{const I=lt({},Y.params);for(const F in I)I[F]==null&&delete I[F];V=lt({},Y,{params:u(I)}),ge.params=u(ge.params)}const re=t.resolve(V,ge),ue=Y.hash||"";re.params=d(p(re.params));const Ie=M_(n,lt({},Y,{hash:I_(ue),path:re.path})),v=a.createHref(Ie);return lt({fullPath:Ie,hash:ue,query:n===Vu?Y_(Y.query):Y.query||{}},re,{redirectedFrom:void 0,href:v})}function x(Y){return typeof Y=="string"?vr(s,Y,r.value.path):lt({},Y)}function b(Y,ge){if(c!==Y)return di(Tt.NAVIGATION_CANCELLED,{from:ge,to:Y})}function y(Y){return L(Y)}function A(Y){return y(lt(x(Y),{replace:!0}))}function S(Y,ge){const V=Y.matched[Y.matched.length-1];if(V&&V.redirect){const{redirect:re}=V;let ue=typeof re=="function"?re(Y,ge):re;return typeof ue=="string"&&(ue=ue.includes("?")||ue.includes("#")?ue=x(ue):{path:ue},ue.params={}),lt({query:Y.query,hash:Y.hash,params:ue.path!=null?{}:Y.params},ue)}}function L(Y,ge){const V=c=N(Y),re=r.value,ue=Y.state,Ie=Y.force,v=Y.replace===!0,I=S(V,re);if(I)return L(lt(x(I),{state:typeof I=="object"?lt({},ue,I.state):ue,force:Ie,replace:v}),ge||V);const F=V;F.redirectedFrom=ge;let ee;return!Ie&&F_(n,re,V)&&(ee=di(Tt.NAVIGATION_DUPLICATED,{to:F,from:re}),G(re,re,!0,!1)),(ee?Promise.resolve(ee):D(F,re)).catch(X=>mn(X)?mn(X,Tt.NAVIGATION_GUARD_REDIRECT)?X:W(X):C(X,F,re)).then(X=>{if(X){if(mn(X,Tt.NAVIGATION_GUARD_REDIRECT))return L(lt({replace:v},x(X.to),{state:typeof X.to=="object"?lt({},ue,X.to.state):ue,force:Ie}),ge||F)}else X=T(F,re,!0,v,ue);return U(F,re,X),X})}function R(Y,ge){const V=b(Y,ge);return V?Promise.reject(V):Promise.resolve()}function _(Y){const ge=se.values().next().value;return ge&&typeof ge.runWithContext=="function"?ge.runWithContext(Y):Y()}function D(Y,ge){let V;const[re,ue,Ie]=X_(Y,ge);V=br(re.reverse(),"beforeRouteLeave",Y,ge);for(const I of re)I.leaveGuards.forEach(F=>{V.push(Zn(F,Y,ge))});const v=R.bind(null,Y,ge);return V.push(v),Ne(V).then(()=>{V=[];for(const I of i.list())V.push(Zn(I,Y,ge));return V.push(v),Ne(V)}).then(()=>{V=br(ue,"beforeRouteUpdate",Y,ge);for(const I of ue)I.updateGuards.forEach(F=>{V.push(Zn(F,Y,ge))});return V.push(v),Ne(V)}).then(()=>{V=[];for(const I of Ie)if(I.beforeEnter)if(Ws(I.beforeEnter))for(const F of I.beforeEnter)V.push(Zn(F,Y,ge));else V.push(Zn(I.beforeEnter,Y,ge));return V.push(v),Ne(V)}).then(()=>(Y.matched.forEach(I=>I.enterCallbacks={}),V=br(Ie,"beforeRouteEnter",Y,ge,_),V.push(v),Ne(V))).then(()=>{V=[];for(const I of l.list())V.push(Zn(I,Y,ge));return V.push(v),Ne(V)}).catch(I=>mn(I,Tt.NAVIGATION_CANCELLED)?I:Promise.reject(I))}function U(Y,ge,V){o.list().forEach(re=>_(()=>re(Y,ge,V)))}function T(Y,ge,V,re,ue){const Ie=b(Y,ge);if(Ie)return Ie;const v=ge===Vn,I=Ba?history.state:{};V&&(re||v?a.replace(Y.fullPath,lt({scroll:v&&I&&I.scroll},ue)):a.push(Y.fullPath,ue)),r.value=Y,G(Y,ge,V,v),W()}let M;function j(){M||(M=a.listen((Y,ge,V)=>{if(!ce.listening)return;const re=N(Y),ue=S(re,ce.currentRoute.value);if(ue){L(lt(ue,{replace:!0,force:!0}),re).catch(Ui);return}c=re;const Ie=r.value;Ba&&q_(ju(Ie.fullPath,V.delta),Jo()),D(re,Ie).catch(v=>mn(v,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_CANCELLED)?v:mn(v,Tt.NAVIGATION_GUARD_REDIRECT)?(L(lt(x(v.to),{force:!0}),re).then(I=>{mn(I,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_DUPLICATED)&&!V.delta&&V.type===ac.pop&&a.go(-1,!1)}).catch(Ui),Promise.reject()):(V.delta&&a.go(-V.delta,!1),C(v,re,Ie))).then(v=>{v=v||T(re,Ie,!1),v&&(V.delta&&!mn(v,Tt.NAVIGATION_CANCELLED)?a.go(-V.delta,!1):V.type===ac.pop&&mn(v,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),U(re,Ie,v)}).catch(Ui)}))}let J=wi(),E=wi(),k;function C(Y,ge,V){W(Y);const re=E.list();return re.length?re.forEach(ue=>ue(Y,ge,V)):console.error(Y),Promise.reject(Y)}function $(){return k&&r.value!==Vn?Promise.resolve():new Promise((Y,ge)=>{J.add([Y,ge])})}function W(Y){return k||(k=!Y,j(),J.list().forEach(([ge,V])=>Y?V(Y):ge()),J.reset()),Y}function G(Y,ge,V,re){const{scrollBehavior:ue}=e;if(!Ba||!ue)return Promise.resolve();const Ie=!V&&G_(ju(Y.fullPath,0))||(re||!V)&&history.state&&history.state.scroll||null;return Rt().then(()=>ue(Y,ge,Ie)).then(v=>v&&V_(v)).catch(v=>C(v,Y,ge))}const Z=Y=>a.go(Y);let oe;const se=new Set,ce={currentRoute:r,listening:!0,addRoute:h,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:w,getRoutes:g,resolve:N,options:e,push:y,replace:A,go:Z,back:()=>Z(-1),forward:()=>Z(1),beforeEach:i.add,beforeResolve:l.add,afterEach:o.add,onError:E.add,isReady:$,install(Y){Y.component("RouterLink",_w),Y.component("RouterView",Tw),Y.config.globalProperties.$router=ce,Object.defineProperty(Y.config.globalProperties,"$route",{enumerable:!0,get:()=>ln(r)}),Ba&&!oe&&r.value===Vn&&(oe=!0,y(a.location).catch(re=>{}));const ge={};for(const re in Vn)Object.defineProperty(ge,re,{get:()=>r.value[re],enumerable:!0});Y.provide(Zo,ce),Y.provide(hd,kc(ge)),Y.provide(lc,r);const V=Y.unmount;se.add(Y),Y.unmount=function(){se.delete(Y),se.size<1&&(c=Vn,M&&M(),M=null,r.value=Vn,oe=!1,k=!1),V()}}};function Ne(Y){return Y.reduce((ge,V)=>ge.then(()=>_(V)),Promise.resolve())}return ce}function jm(){return Bs(Zo)}function Ew(e){return Bs(hd)}const Yo={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=Ew(),s=jm(),n=q({get(){var r;const o=t.query.tab;return o&&e.tabs.some(c=>c.id===o)?o:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(o){s.replace({query:{...t.query,tab:o}})}}),a=q(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.component)||null}),i=q(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.label)||""});Mt(i,o=>{e.groupLabel&&o&&(document.title=`Odin — ${e.groupLabel} › ${o}`)},{immediate:!0});function l(o,r){if(!["ArrowLeft","ArrowRight","Home","End"].includes(o.key))return;o.preventDefault();let c=r;o.key==="ArrowRight"&&(c=(r+1)%e.tabs.length),o.key==="ArrowLeft"&&(c=(r-1+e.tabs.length)%e.tabs.length),o.key==="Home"&&(c=0),o.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`).length:0,o=!["text","json"].includes(t.kind),r=l>=2||i>yr.inlineChars||o&&a.length>0,c=s.filter(m=>m.text).map(m=>{let g=m.text;try{g=JSON.stringify(JSON.parse(g),null,2)}catch{}return m.label?`${m.label}
${g}`:g}).join(`

`).replace(/\n$/,""),d=qm(c,yr.previewLines,yr.previewChars),u=t.kind==="audit_preview"?(h=t.metadata)==null?void 0:h.source:t.metadata,p=u&&(t.kind==="process_output"||u.kind==="process_output")?`PID ${u.pid??"?"} ${u.status??""}${Number.isInteger(u.exit_code)?` exit ${u.exit_code}`:""}`.trim():t.kind==="agent_result"&&(u!=null&&u.status)?`agent ${u.status}`:"";return{promoted:r,chars:i,lines:l,envelope:o,kind:t.kind,formatted:c,preview:d,outcome:p,header:t.header,summary:a.replace(/\n/g," "),warnings:Dw(t)}}const Mw={name:"CompactOutput",props:{value:{default:""},rawValue:{default:void 0},label:{type:String,default:"Output"},hasContext:{type:Boolean,default:!1}},setup(e){const t=f(!1),s=f(!0),n=f(!1),a=f(""),i=f(null),l=f(null),o=f(!1),r=q(()=>Pw(e.value)),c=q(()=>{const y=e.rawValue===void 0?e.value:e.rawValue;return typeof y=="string"?y:JSON.stringify(y,null,2)??""}),d=q(()=>n.value?c.value:r.value.formatted),u=q(()=>r.value.promoted&&r.value.preview.folded||o.value),p=q(()=>t.value?!!d.value:r.value.promoted),h=q(()=>p.value?"":r.value.summary);let m;function g(){if(t.value)return;const y=r.value.promoted?i.value:l.value;o.value=!!(y&&(y.scrollHeight>y.clientHeight+1||y.scrollWidth>y.clientWidth+1))}function w(){m==null||m.disconnect();for(const y of[i.value,l.value])y&&(m==null||m.observe(y));g()}function N(){t.value=!t.value,t.value||(n.value=!1)}function x(){n.value=!n.value,t.value=!0,a.value=""}async function b(){const y=e.value;try{await navigator.clipboard.writeText(d.value),y===e.value&&(a.value="Copied")}catch{y===e.value&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,n.value=!1,a.value=""}),Mt([i,l,t,s,r],()=>Rt(w),{flush:"post"}),je(()=>{m=new ResizeObserver(g),w()}),ft(()=>m==null?void 0:m.disconnect()),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,previewElement:i,summaryElement:l,model:r,body:d,canExpand:u,showBody:p,headerSummary:h,toggleExpanded:N,toggleRaw:x,copyOutput:b}},template:`
    ...
    </section>`},Qo={name:"ToolOutput",components:{CompactOutput:Mw},props:{value:{default:""},label:{type:String,default:"Output"},presentation:{type:String,default:"inspector"},rawValue:{default:void 0},hasContext:{type:Boolean,default:!1}},setup(e){const t=f(!1),s=f(!0),n=f(!1),a=f(""),i=q(()=>Vm(e.value)),l=q(()=>n.value?[{label:"Raw received value",text:i.value.raw}]:i.value.sections),o=q(()=>{let u=30,p=6e3;return l.value.map(h=>{const m=qm(h.text,u,p);return u=Math.max(0,u-m.lines),p=Math.max(0,p-m.chars),{...h,display:t.value?h.text:m.text,folded:m.folded}})}),r=q(()=>o.value.some(u=>u.folded)),c=q(()=>n.value?i.value.raw:l.value.map(u=>u.label?`${u.label}
${u.text}`:u.text).join(`
...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(a.value="Copied")}catch{e.value===u&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,a.value=""}),Mt(n,()=>{t.value=!1,a.value=""}),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},Fw={components:{ToolOutput:Qo},setup(){const e=f([]),t=f([]),s=f({}),n=50;function a(p){var g,w,N,x,b,y,A,S,L,R,_;const h=p.payload||p,m=h.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(m)&&!(h.agent_id||(g=h.metadata)!=null&&g.agent_id))&&!(["loop_tool_start","loop_tool"].includes(m)&&!(h.call_id||(w=h.metadata)!=null&&w.call_id))){if(m==="tool_start"||m==="loop_tool_start"){const D=h.call_id||((N=h.metadata)==null?void 0:N.call_id)||null,U=h.agent_id||((x=h.metadata)==null?void 0:x.agent_id)||"",T={callId:D,agentId:U,agentLabel:h.agent_label||((b=h.metadata)==null?void 0:b.agent_label)||"",toolInput:h.tool_input,id:D?`${U}:${D}`:`${h.action}-${Date.now()}`,tool:h.action,actor:h.actor||"",channel:h.channel_id||"",iteration:h.iteration??((y=h.metadata)==null?void 0:y.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(T);return}if(m==="tool_end"||m==="loop_tool"){const D=h.call_id||((A=h.metadata)==null?void 0:A.call_id)||null,U=h.agent_id||((S=h.metadata)==null?void 0:S.agent_id)||"";let T=-1;if(D&&(T=e.value.findIndex(M=>M.callId===D&&M.agentId===U&&M.status==="running")),T<0&&!D)for(let M=e.value.length-1;M>=0;M--){const j=e.value[M];if(j.tool===h.action&&j.agentId===U&&j.status==="running"){T=M;break}}if(T>=0){const M=e.value[T];M.status=h.error||(L=h.metadata)!=null&&L.error||["error","failed","cancelled","denied","outcome_unknown"].includes(h.status||((R=h.metadata)==null?void 0:R.status))?"error":"success",M.elapsed=h.execution_time_ms??h.duration_ms??((_=h.metadata)==null?void 0:_.elapsed_ms)??Date.now()-M.startTime,M.result=h.result_summary??h.detail??"",M.fadingOut=!0,setTimeout(()=>{const j=e.value.indexOf(M);j>=0&&e.value.splice(j,1),t.value.unshift(M),t.value.length>n&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const D=h.call_id||h.tool_name||"unknown";if(h.finished){const U={...s.value};delete U[D],s.value=U}else{const T=((s.value[D]||"")+(h.chunk||"")).split(`
...
`)}}return}}}let i=null;function l(){const p=Date.now();e.value.forEach(h=>{h.status==="running"&&(h.elapsed=p-h.startTime)})}let o=!1;function r(){o||(o=!0,Ye.on("events",a),i||(i=setInterval(l,500)))}function c(){o&&(o=!1,Ye.off("events",a),i&&(clearInterval(i),i=null))}je(r),Qt(r),Gt(c),ft(c);function d(p){return p<1e3?`${p}ms`:`${(p/1e3).toFixed(1)}s`}function u(p){return p==="running"?"clock":p==="success"?"success":p==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
  ...
  `};function vd(e){if(e instanceof Date)return e;if(typeof e=="string"){const t=new Date(e);return isNaN(t.getTime())?null:t}return typeof e=="number"&&isFinite(e)?new Date(e<1e12?e*1e3:e):null}function Aa(e){const t=vd(e);return t?t.toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"}):"—"}function $w(e){const t=vd(e);return t?t.toLocaleTimeString():"—"}function Gm(e){const t=vd(e);if(!t)return"—";const s=Math.max(0,Math.floor((Date.now()-t.getTime())/1e3));return s<60?`${s}s ago`:s<3600?`${Math.floor(s/60)}m ago`:s<86400?`${Math.floor(s/3600)}h ago`:`${Math.floor(s/86400)}d ago`}function Uw(e){if(e==null||!isFinite(e))return"—";const t=Math.max(0,Math.floor(Number(e)));return t<60?"less than 1 min ago":t<3600?`${Math.floor(t/60)} min ago`:t<86400?`${Math.floor(t/3600)} hr ago`:`${Math.floor(t/86400)} day ago`}function ui(e){if(e==null||!isFinite(e))return"—";const t=Math.max(0,Math.round(e));if(t<60)return`${t}s`;if(t<3600){const a=Math.floor(t/60),i=t%60;return i?`${a}m ${i}s`:`${a}m`}const s=Math.floor(t/3600),n=Math.floor(t%3600/60);return n?`${s}h ${n}m`:`${s}h`}function gd(e,t=200){const s=String(e??"");return s.length>t?s.slice(0,t)+"…":s}function Km(e,t=5e3){const s=String(e??"");return s.length>t?s.slice(0,t)+`
... (truncated)`:s}function np(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function bd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Wm(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Jm=Symbol("agent-detail-cancelled"),Bw=15e3;function Hw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((h,m)=>{r=h,c=m});function u(h,m){o||(o=!0,l!==null&&a(l),l=null,(h?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(h){u(!1,h)}return o||Promise.resolve(p).then(h=>u(!0,h),h=>u(!1,h)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const h=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${h}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Jm),i==null||i.abort()}}}function Zm({state:e,requestDetail:t,timeoutMs:s=Bw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:h,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const g={agentId:p,cancel:null,promise:null};l=g,h?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const w=Hw(N=>t(p,{signal:N}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return g.cancel=w.cancel,g.promise=(async()=>{let N=null,x=null;try{N=await w.promise}catch(b){x=b}N!==Jm&&(l!==g||e.detailId!==p||(l=null,!x&&(N===null||typeof N!="object")&&(x=new Error(`${n} response was empty or invalid`)),x?e.detail===null&&(e.detailError=(x==null?void 0:x.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=N,e.detailError=null),e.detailLoading=!1))})(),g.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function zw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const jw={components:{ToolOutput:Qo},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),h=f("");let m=!1;const w=Zm({state:{get detail(){return c.value},set detail(k){c.value=k},get detailId(){return d.value},set detailId(k){d.value=k},get detailLoading(){return u.value},set detailLoading(k){u.value=k},get detailError(){return p.value},set detailError(k){p.value=k}},detailLabel:"Loop detail",requestDetail:(k,{signal:C})=>z.get(`/api/loops/${encodeURIComponent(k)}?limit=100`,{signal:C})});async function N(k){h.value="",await w.open(k.id)}function x(){w.close(),h.value=""}async function b(k,C){try{await navigator.clipboard.writeText(C||""),h.value=k,setTimeout(()=>{h.value===k&&(h.value="")},1500)}catch{ye.error("Copy failed")}}const y=q(()=>e.value.reduce((k,C)=>k+(C.iteration_count||0),0)),A=q(()=>e.value.filter(k=>k.status==="running").length);function S(k){return k==="running"?"loop-status-running":k==="error"?"loop-status-error":"loop-status-stopped"}function L(k){return k==="running"?"badge-success":k==="error"?"badge-danger":k==="completed"?"badge-info":"badge-warning"}function R(k){return k==="act"?"badge-warning":k==="silent"?"badge-info":"badge-success"}async function _(k=!1){k=k===!0,k||(t.value=!0);try{const C=await z.get("/api/loops");e.value=Array.isArray(C)?C:[],s.value=null}catch(C){k||(s.value=C.message)}k||(t.value=!1)}async function D(){l.value=null;const k=a.value;if(!k.goal.trim()){l.value="Goal is required";return}if(!k.channel_id.trim()){l.value="Channel ID is required";return}const C={goal:k.goal.trim(),channel_id:k.channel_id.trim(),interval_seconds:k.interval_seconds||60,mode:k.mode,max_iterations:k.max_iterations||50};k.stop_condition.trim()&&(C.stop_condition=k.stop_condition.trim()),i.value=!0;try{const $=await z.post("/api/loops",C);ye.success(`Loop started: ${$.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await _()}catch($){l.value=$.message}i.value=!1}async function U(k){if(await qt({title:"Stop loop",message:`Stop loop ${k}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=k;try{await z.del(`/api/loops/${encodeURIComponent(k)}`),ye.success("Loop stopped"),await _()}catch($){ye.error($.message||"Failed to stop loop")}o.value=null}}async function T(k){r.value=k;try{await z.post(`/api/loops/${encodeURIComponent(k)}/restart`),ye.success("Loop restarted"),await _()}catch(C){ye.error(C.message||"Failed to restart loop")}r.value=null}function M(k){m&&k.payload&&(k.payload.loop_id||k.payload.type==="loop")&&(_(!0),d.value&&w.refresh())}let j=null;function J(){j!==null&&clearInterval(j),j=null}function E(){J(),m&&(j=setInterval(()=>{_(!0),d.value&&w.refresh()},5e3))}return je(()=>{m=!0,_(),Ye.subscribe("events",M),E()}),Qt(()=>{m=!0,_(!0),E()}),Gt(()=>{m=!1,J()}),ft(()=>{m=!1,Ye.unsubscribe("events",M),J(),w.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:h,totalIterations:y,runningCount:A,statusDotClass:S,statusBadge:L,modeBadge:R,formatAge:Gm,formatDuration:ui,formatTs:Aa,formatTokens:Wm,openDetail:N,closeDetail:x,copyText:b,fetchLoops:_,doCreate:D,doStop:U,doRestart:T}}},qw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=f(!1),l=f(null),o=f(null),r=q(()=>Jw(a.value.run_at));Mt(()=>a.value.run_at,()=>{o.value=null});const c=q(()=>{var re;const V=r.value;return V.state==="ok"?V.instant:V.state==="ambiguous"&&o.value!==null&&((re=V.options[o.value])==null?void 0:re.instant)||null}),d=q(()=>{const V=c.value;return V?`${V.toLocaleString()} local — ${V.toISOString()} UTC`:""}),u=f(null),p=f(!1),h=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=f(null),g=f(null),w=f(null),N=f(null),x=f(null),b=f(null),y=f([]),A=f(!1),S=f("");let L=0;const R=q(()=>e.value.filter(V=>V.cron&&!V.one_time).length),_=q(()=>e.value.filter(V=>V.one_time).length),D=q(()=>e.value.filter(V=>V.trigger).length),U=q(()=>e.value.filter(V=>V.paused).length),T=q(()=>e.value.filter(V=>V.consecutive_failures>0).length);function M(V){if(!V)return"-";const re=Date.now(),Ie=(new Date(V).getTime()-re)/1e3;if(Ie<0)return"overdue";if(Ie<60)return"in < 1 min";if(Ie<3600)return`in ${Math.floor(Ie/60)} min`;if(Ie<86400){const I=Math.floor(Ie/3600),F=Math.floor(Ie%3600/60);return F>0?`in ${I}h ${F}m`:`in ${I}h`}const v=Math.floor(Ie/86400);return`in ${v} day${v!==1?"s":""}`}function j(V){return V==null?"-":V<1e3?`${V}ms`:V<6e4?`${(V/1e3).toFixed(1)}s`:ui(V/1e3)}function J(V=a.value.cron){a.value.cron=V,ap(a.value,"cron"),u.value=null}function E(V=a.value.run_at){a.value.run_at=V,ap(a.value,"run_at"),u.value=null}async function k(){const V=a.value.cron.trim();if(V){p.value=!0;try{u.value=await z.post("/api/schedules/validate-cron",{expression:V})}catch(re){u.value={valid:!1,error:re.message}}p.value=!1}}async function C(){t.value=!0,s.value=null;try{e.value=await z.get("/api/schedules")}catch(V){s.value=V.message}t.value=!1}async function $(V){if(b.value===V){b.value=null,y.value=[];return}b.value=V,A.value=!0,y.value=[];const re=++L;try{const ue=await z.get(`/api/schedules/${encodeURIComponent(V)}/history?limit=10`);if(re!==L||b.value!==V)return;y.value=ue,S.value=""}catch(ue){if(re!==L||b.value!==V)return;y.value=[],S.value=ue.message||"Failed to load execution history"}re===L&&(A.value=!1)}async function W(){l.value=null;const V=a.value;if(!V.description.trim()){l.value="Description is required";return}if(!V.channel_id.trim()){l.value="Channel ID is required";return}if(!V.cron.trim()&&!V.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(V.cron.trim()&&V.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const re={description:V.description.trim(),action:V.action,channel_id:V.channel_id.trim()};if(V.cron.trim()&&(re.cron=V.cron.trim()),V.run_at.trim()){const ue=r.value;if(ue.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(ue.state==="invalid"){l.value="One-time run time is not a valid date";return}const Ie=c.value;if(ue.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Ie){l.value="One-time run time could not be resolved";return}re.run_at=Ie.toISOString()}if(V.action==="reminder"&&V.message.trim()&&(re.message=V.message.trim()),V.action==="check"&&(V.tool_name.trim()&&(re.tool_name=V.tool_name.trim()),V.report_format&&(re.report_format=V.report_format),V.tool_input_str.trim()))try{re.tool_input=JSON.parse(V.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await z.post("/api/schedules",re),ye.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await C()}catch(ue){l.value=ue.message}i.value=!1}async function G(V){m.value=V;try{const re=await z.post(`/api/schedules/${encodeURIComponent(V)}/run`);if(re.status==="failure")ye.error(`Execution failed: ${re.error||"unknown error"}`);else{const ue=re.warning?`Executed (${re.warning})`:"Executed successfully";ye.success(ue)}await C()}catch(re){ye.error(re.message||"Failed to trigger")}m.value=null}async function Z(V){w.value=V.id;const re=!V.paused;try{await z.put(`/api/schedules/${encodeURIComponent(V.id)}`,{paused:re}),ye.success(re?"Schedule paused":"Schedule resumed"),await C()}catch(ue){ye.error(ue.message||"Failed to update schedule")}w.value=null}const oe=new Map;function se(V,re){const ue=oe.get(V.id);ue&&clearTimeout(ue.timer);const Ie={run:()=>ce(V,re),timer:null};Ie.timer=setTimeout(()=>{oe.delete(V.id),Ie.run()},500),oe.set(V.id,Ie)}async function ce(V,re){x.value=V.id;try{await z.put(`/api/schedules/${encodeURIComponent(V.id)}`,{report_format:re}),ye.success(re?"Structured report enabled":"Plain-text report enabled")}catch(ue){ye.error(`Update failed: ${ue.message}`)}finally{await C(),x.value=null}}function Ne(){for(const[V,re]of[...oe])clearTimeout(re.timer),oe.delete(V),re.run()}async function Y(V){N.value=V;try{await z.post(`/api/schedules/${encodeURIComponent(V)}/reset-failures`),ye.success("Failure counters reset"),await C()}catch(re){ye.error(re.message||"Failed to reset")}N.value=null}async function ge(V){const re=e.value.find(Ie=>Ie.id===V);if(await qt({title:"Delete schedule",message:`Delete "${(re==null?void 0:re.description)||V}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){g.value=V;try{await z.del(`/api/schedules/${encodeURIComponent(V)}`),ye.success("Schedule deleted"),await C()}catch(Ie){ye.error(Ie.message||"Failed to delete schedule")}g.value=null}}return je(()=>{C()}),ft(Ne),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:h,runningId:m,deletingId:g,togglingId:w,resettingId:N,reportUpdatingId:x,flushReportFormatTimers:Ne,expandedId:b,history:y,historyLoading:A,historyError:S,cronCount:R,oneTimeCount:_,webhookCount:D,pausedCount:U,failingCount:T,formatTs:Aa,formatAge:Gm,formatFuture:M,formatMs:j,formatDuration:ui,onCronInput:J,onRunAtInput:E,validateCron:k,toggleExpand:$,fetchSchedules:C,doCreate:W,doRunNow:G,doTogglePause:Z,doUpdateReportFormat:se,doResetFailures:Y,doDelete:ge}}},Ym=[{id:"live",label:"Live",component:Fw},{id:"agents",label:"Agents",component:jw},{id:"loops",label:"Loops",component:Vw},{id:"processes",label:"Processes",component:qw},{id:"schedules",label:"Schedules",component:Zw}],Yw={components:{TabbedPage:Yo},setup(){return{tabs:Ym}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Qw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
... (truncated)`:ie:""}async function ee(){const ie=S.value.trim();if(!ie)return;const Se=++M;D.value=!0,U.value="",T.value=_.value!==null;try{let Le=`/api/sessions/search?q=${encodeURIComponent(ie)}&limit=50`;L.value.trim()&&(Le+=`&channel_id=${encodeURIComponent(L.value.trim())}`),R.value.trim()&&(Le+=`&user_id=${encodeURIComponent(R.value.trim())}`);const Ke=await z.get(Le);if(Se!==M)return;_.value=Ke.results||[],T.value=!1}catch(Le){if(Se!==M)return;U.value=Le.message||"Search failed. Please retry."}finally{Se===M&&(D.value=!1)}}function X(){M++,S.value="",L.value="",R.value="",_.value=null,U.value="",T.value=!1,D.value=!1}function ae(ie){return ie?ie.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function fe(ie){return ie==="user"?"fts-result-user":ie==="assistant"?"fts-result-assistant":ie==="summary"?"fts-result-summary":ie==="fts"?"fts-result-fts":ie==="channel"?"fts-result-channel":"fts-result-default"}function pe(ie){return ie==="user"?"badge-info":ie==="assistant"?"badge-success":ie==="summary"?"badge-warning":ie==="fts"?"badge-success":"badge-info"}let de=0;async function le(){const ie=++de;t.value=!0,s.value=null;try{const Se=await z.get("/api/sessions");if(ie!==de)return;e.value=Se}catch(Se){if(ie!==de)return;s.value=Se.message}ie===de&&(t.value=!1)}function xe(){s.value=null,le()}async function me(ie){if(n.value===ie){n.value=null,a.value=null,A.value=new Set;return}n.value=ie,a.value=null,i.value=!0,A.value=new Set;const Se=++l;try{const Le=await z.get(`/api/sessions/${encodeURIComponent(ie)}`);Se===l&&n.value===ie&&(a.value=Le)}catch(Le){Se===l&&n.value===ie&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{Se===l&&(i.value=!1)}}function _e(ie){const Se=new Set(c.value);Se.has(ie)?Se.delete(ie):Se.add(ie),c.value=Se}function Re(){$.value?c.value=new Set:c.value=new Set(k.value.map(ie=>ie.channel_id))}function B(ie){o.value=ie}async function ve(){if(o.value){r.value=!0;try{await z.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await le()}catch(ie){s.value=ie.message||"Failed to clear session"}r.value=!1,o.value=null}}function ke(){d.value=!0}async function Oe(){if(c.value.size!==0){r.value=!0;try{await z.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await le()}catch(ie){s.value=ie.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Me(ie,Se){const Le=`/api/sessions/${encodeURIComponent(ie)}/export?format=${Se}`;try{const Ke=await z.getBlob(Le),Et=URL.createObjectURL(Ke),Ve=document.createElement("a");Ve.href=Et,Ve.download=`session-${ie}.${Se==="text"?"txt":"json"}`,Ve.click(),URL.revokeObjectURL(Et)}catch(Ke){s.value=Ke.message||"Failed to export session"}}let dt=null;function st(ie){ie.payload&&ie.payload.channel_id&&(clearTimeout(dt),dt=setTimeout(()=>{if(le(),n.value&&ie.payload.channel_id===n.value){const Se=n.value,Le=l;z.get(`/api/sessions/${encodeURIComponent(Se)}`).then(Ke=>{Le!==l||n.value!==Se||(a.value=Ke)}).catch(()=>{})}},2e3))}let _t=!1,Ot=null;function rt(){_t||(_t=!0,le(),Ye.subscribe("events",st),Ot=Ye.onReconnected(()=>le()))}je(()=>{j(),rt()}),Qt(()=>{rt()});function Qe(){_t&&(_t=!1,Ye.unsubscribe("events",st),Ot&&(Ot(),Ot=null),clearTimeout(dt))}return Gt(Qe),ft(Qe),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:$,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:h,sortAsc:m,filterPresets:g,sortOptions:w,filteredSessions:k,hasActiveFilters:E,customPresets:N,showSavePreset:x,newPresetName:b,threadView:y,threads:C,collapsedThreads:A,ftsQuery:S,ftsChannelId:L,ftsUserId:R,ftsResults:_,ftsSearching:D,ftsError:U,ftsStale:T,formatAge:Y,formatTimestamp:ge,formatFullTimestamp:V,messageClass:re,threadMsgClass:ue,roleBadge:Ie,roleDotClass:v,roleLabelClass:I,truncateContent:F,threadSummary:W,fetchSessions:le,retry:xe,toggleSession:me,toggleSelect:_e,toggleSelectAll:Re,confirmClear:B,clearSession:ve,confirmBulkClear:ke,doBulkClear:Oe,exportSession:Me,applyPreset:Z,applyCustomPreset:oe,saveCustomPreset:se,removeCustomPreset:ce,resetFilters:Ne,toggleThread:G,runFtsSearch:ee,clearFtsSearch:X,highlightSnippet:ae,ftsResultClass:fe,ftsTypeBadge:pe}}},tk={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:Wm}}},sk={components:{ContextAssemblyPanel:tk},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),n=f(null),a=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(L){if(!L)return"—";try{const R=new Date(L);return isNaN(R.getTime())?L:R.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return L}}function p(L){return!L&&L!==0?"—":L<1e3?L+"ms":(L/1e3).toFixed(1)+"s"}function h(L){return!L&&L!==0?"—":L>=1e3?(L/1e3).toFixed(1)+"k":String(L)}function m(L){if(!L)return"";if(typeof L=="string")return L;try{return JSON.stringify(L,null,2)}catch{return String(L)}}function g(L){a.value===L?a.value=null:(a.value=L,c.value={})}function w(L,R){const _=L+"-"+R;c.value={...c.value,[_]:!c.value[_]}}function N(L,R){return!!c.value[L+"-"+R]}function x(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,A()}async function b(){try{const L=await z.get("/api/trajectories");e.value=L.files||[],r.value=L.count||0}catch{}}let y=0;async function A(){const L=++y;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(o.value){const R=await z.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(L!==y)return;let _=R.entries||[];d.value.tool_name&&(_=_.filter(D=>(D.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(_=_.filter(D=>D.is_error)),d.value.channel_id&&(_=_.filter(D=>D.channel_id===d.value.channel_id)),d.value.user_id&&(_=_.filter(D=>D.user_id===d.value.user_id)),t.value=_}else{const R=new URLSearchParams;d.value.channel_id&&R.set("channel_id",d.value.channel_id),d.value.user_id&&R.set("user_id",d.value.user_id),d.value.tool_name&&R.set("tool_name",d.value.tool_name),d.value.errors_only&&R.set("errors_only","true"),R.set("limit",String(d.value.limit));const _=R.toString(),D=await z.get(`/api/trajectories/search/query?${_}`);if(L!==y)return;t.value=D.results||[]}}catch(R){if(L!==y)return;n.value=R.message}L===y&&(s.value=!1)}async function S(){if(!l.value.trim())return;const L=++y;s.value=!0,n.value=null,c.value={};try{const R=await z.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(L!==y)return;i.value=R.entry||null,i.value||(n.value="No trace found for this message ID")}catch(R){if(L!==y)return;R.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=R.message}L===y&&(s.value=!1)}return je(async()=>{await b(),await A()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:h,formatJSON:m,truncateBlock:Km,toggleExpand:g,toggleIteration:w,isIterationExpanded:N,clearFilters:x,fetchFiles:b,fetchTraces:A,lookupMessage:S}}};function nk(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function ak(e){return e?`${e.approximate?"~":""}${bd(e.total||0)}`:"0"}const ik={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=q(()=>n.value.work||{}),h=q(()=>Math.max(1,...(n.value.activity_over_time||[]).map(S=>Number(S.count||0)))),m=q(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),g=S=>({height:`${Math.max(4,Math.round(Number(S||0)/h.value*100))}%`}),w=q(()=>s.value&&l.value-i.value>3e4);async function N(){const S=++d,L=a.value;try{const R=await z.get(`/api/usage?range=${encodeURIComponent(L)}`);if(S!==d||L!==a.value)return;n.value=R,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(R){S===d&&(t.value=R.message)}finally{S===d&&(e.value=!1)}}function x(S){a.value=S,e.value=!s.value,N()}function b(){e.value=!0,N()}function y(){c||(c=!0,N(),o=setInterval(N,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function A(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return je(y),Qt(y),Gt(A),ft(A),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:w,fmtNum:bd,fmtDuration:nk,tokenLabel:ak,activityTrackStyle:m,activityBar:g,selectRange:x,retry:b}}},Qm=[{id:"audit",label:"Audit",component:Qw},{id:"sessions",label:"Sessions",component:ek},{id:"traces",label:"Traces",component:sk},{id:"usage",label:"Usage & Activity",component:ik}],lk={components:{TabbedPage:Yo},setup(){return{tabs:Qm}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},xr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],ok={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(_){return _.source!=="builtin"?"":u[_.state]||""}function h(_,D){const U=_&&Array.isArray(_.tools)?_.tools:null;if(c.value=!!U,r.value=U?!!_.global_enabled:null,!U){e.value=D.map(j=>({...j,source:"unknown",enabled:void 0,state:null}));return}const T=new Set(U.map(j=>j.name)),M=D.filter(j=>!T.has(j.name)).map(j=>({...j,source:j.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...U.map(j=>({...j,source:"builtin"})),...M]}async function m(_,D){if(d.value.has(_.name))return;const U=!!D.target.checked,T=new Set(d.value);T.add(_.name),d.value=T;try{const M=await z.post(`/api/tools/builtins/${encodeURIComponent(_.name)}/enabled`,{enabled:U});h(M,e.value),s.value=null;try{const j=await z.get("/api/tools");h(M,j)}catch(j){console.warn("Built-in toggle committed; visible catalog refresh failed",j)}}catch(M){D.target.checked=!!_.enabled,s.value=M.message||`Failed to toggle ${_.name}`}finally{const M=new Set(d.value);M.delete(_.name),d.value=M}}const g=q(()=>e.value.filter(_=>_.source==="builtin"&&_.is_core).length),w=q(()=>e.value.filter(_=>_.source==="skill").length),N=q(()=>Object.values(a.value).reduce((_,D)=>_+D,0));function x(_){for(const D of xr)if(D.id!=="other"&&D.match(_))return D.id;return"other"}const b=q(()=>{let _=e.value;if(n.value){const D=n.value.toLowerCase();_=_.filter(U=>U.name.toLowerCase().includes(D)||(U.description||"").toLowerCase().includes(D))}return o.value&&(_=_.filter(D=>x(D.name)===o.value)),_}),y=q(()=>{const _=new Set;for(const D of e.value)_.add(x(D.name));return xr.filter(D=>_.has(D.id))}),A=q(()=>{const _=b.value,D={};for(const T of _){const M=x(T.name);D[M]||(D[M]=[]),D[M].push(T)}const U=[];for(const T of xr)D[T.id]&&D[T.id].length>0&&U.push({label:T.label,icon:T.icon,tools:D[T.id].sort((M,j)=>M.name.localeCompare(j.name))});return U});function S(_){i.value={...i.value,[_]:!i.value[_]}}async function L(){t.value=!0,s.value=null;try{const[_,D,U]=await Promise.all([z.get("/api/tools"),z.get("/api/tools/stats").catch(()=>({})),z.get("/api/tools/builtins").catch(()=>null)]);h(U,_),a.value=D||{}}catch(_){s.value=_.message}t.value=!1}function R(){L()}return je(()=>{L()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:g,skillCount:w,totalUsage:N,filteredTools:b,groupedTools:A,usedCategories:y,stateBadge:p,applyInventory:h,toggleBuiltinTool:m,truncate:gd,toggleExpand:S,refresh:R}}};function rk(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function ck(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function U(se){return ck(se)}function T(se){n.value={...n.value,[se]:!n.value[se]}}async function M(se){try{await navigator.clipboard.writeText(se);const ce=e.value.find(Ne=>Ne.code===se);ce&&(o.value=ce.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function j(se){if(se.key==="Tab"){se.preventDefault();const ce=se.target,Ne=ce.selectionStart,Y=ce.selectionEnd;u.value=u.value.substring(0,Ne)+"    "+u.value.substring(Y),Rt(()=>{ce.selectionStart=ce.selectionEnd=Ne+4})}}function J(se){const ce=se.target.previousElementSibling;ce&&(ce.scrollTop=se.target.scrollTop)}async function E(){t.value=!0,s.value=null;try{e.value=await z.get("/api/skills")}catch(se){s.value=se.message}t.value=!1}async function k(se){i.value=se,delete a.value[se],a.value={...a.value};try{const ce=await z.post(`/api/skills/${encodeURIComponent(se)}/test`);a.value={...a.value,[se]:ce}}catch(ce){a.value={...a.value,[se]:{result:ce.message,is_error:!0}}}i.value=null}function C(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,h.value=null}function $(se){r.value=!0,c.value="edit",d.value=se.name,u.value=se.code||"",p.value=null,h.value=null}function W(){r.value=!1,p.value=null,h.value=null}async function G(){p.value=null,h.value=null;const se=d.value.trim(),ce=u.value.trim();if(!se){p.value="Name is required";return}if(!ce){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await z.post("/api/skills",{name:se,code:ce}),h.value="Skill created successfully"):(await z.put(`/api/skills/${encodeURIComponent(se)}`,{code:ce}),h.value="Skill updated successfully"),await E(),setTimeout(()=>{r.value=!1},800)}catch(Ne){p.value=Ne.message}m.value=!1}function Z(se){w.value=se}async function oe(){if(w.value){N.value=!0;try{await z.del(`/api/skills/${encodeURIComponent(w.value)}`),await E()}catch(se){ye.error(`Failed to delete skill: ${se.message||"unknown error"}`)}N.value=!1,w.value=null}}return je(()=>{E()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:h,saving:m,editorRef:g,deleteTarget:w,deleting:N,enabledCount:x,totalExecutions:b,totalLines:y,displayedSkills:A,editLineCount:S,editorLineNums:L,editValidation:R,highlight:_,truncate:gd,formatTs:Aa,countLines:D,getLineNumbers:U,toggleCode:T,copyCode:M,handleEditorKey:j,syncScroll:J,fetchSkills:E,testSkill:k,showCreate:C,editSkill:$,cancelEdit:W,saveSkill:G,confirmDelete:Z,doDelete:oe}}};class Fs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const uk=/^[A-Za-z_][A-Za-z0-9_]*$/;function lp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function op(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Fs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Fs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Fs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Fs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function pk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function fk(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Fs("Server name is required.","name");if(a.length>128||!uk.test(a))throw new Fs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Fs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=lp(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Fs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Fs("An HTTP endpoint is required for this connection.","url");if(d&&!pk(d))throw new Fs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Fs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=lp(e.allowlistText));const r=op(e.headerRows,e.headersRemove,"Header"),c=op(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function hk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function mk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function vk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const gk=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function bk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const yk=1e4,xk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function _r(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function _k(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const wk={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),n=f(""),a=f(new Set),i=f(new Set),l=f({}),o=f({}),r=f({}),c=f(new Set),d=f(!1),u=f("add"),p=f(""),h=f(null),m=f(_r()),g=f(""),w=f(!1);let N=null,x=0,b=!1,y=!1;const A=gk,S=q(()=>{var B;return((B=e.value)==null?void 0:B.servers)||[]}),L=q(()=>{var B;return!!((B=e.value)!=null&&B.enabled)}),R=q(()=>{var B,ve,ke,Oe;return{serverCount:((B=e.value)==null?void 0:B.server_count)||0,enabledCount:((ve=e.value)==null?void 0:ve.enabled_server_count)||0,connectedCount:((ke=e.value)==null?void 0:ke.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),_=q(()=>{var B;return((B=h.value)==null?void 0:B.header_keys)||[]}),D=q(()=>{var B;return((B=h.value)==null?void 0:B.env_keys)||[]}),U=q(()=>{var B;return u.value==="edit"&&((B=h.value)==null?void 0:B.transport)==="http"}),T=q(()=>u.value==="add"||!U.value),M=q(()=>U.value?"Replace endpoint URL":"Endpoint URL"),j=q(()=>U.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function J(){E(),N=window.setInterval(()=>k({quiet:!0}),yk)}function E(){N&&window.clearInterval(N),N=null}async function k({quiet:B=!1}={}){const ve=++x;B||(t.value=!0);try{const ke=await z.get("/api/mcp/status");if(ve!==x||!b)return;e.value=ke,n.value="";const Oe=new Set((ke.servers||[]).map(Me=>Me.name));i.value=new Set([...i.value].filter(Me=>Oe.has(Me)))}catch(ke){ve===x&&b&&(n.value=ke.message||"Failed to load MCP status")}finally{ve===x&&(t.value=!1)}}function C(B){return s.value||a.value.has(B)}function $(B,ve){const ke=new Set(a.value);ve?ke.add(B):ke.delete(B),a.value=ke}function W(B){return mk(B.state)}function G(B){if(W(B)==="disabled"){if(!B.enabled)return"Disabled — server switch off";if(!L.value)return"Disabled — global MCP is off"}return xk[W(B)]}function Z(B){return B.transport==="http"?"Streamable HTTP":"stdio"}function oe(B){return B.negotiated_version?`${B.era?`${String(B.era).charAt(0).toUpperCase()}${String(B.era).slice(1)}`:"Protocol"} · ${B.negotiated_version}`:"Not negotiated"}function se(B){return B.discovered_count?`${B.published_count||0} published · ${B.excluded_count||0} excluded`:"No tools discovered"}const ce=f(new Set);async function Ne(B,ve){if(ce.value.has(B.name))return;const ke=!!ve.target.checked,Oe=new Set(ce.value);Oe.add(B.name),ce.value=Oe;try{const Me=await z.post(`/api/mcp/servers/${encodeURIComponent(B.name)}/enabled`,{enabled:ke});Me&&Array.isArray(Me.servers)?e.value=Me:await k({quiet:!0})}catch(Me){ve.target.checked=!!B.enabled,ye.error(Me.message||`Failed to toggle ${B.name}`)}finally{const Me=new Set(ce.value);Me.delete(B.name),ce.value=Me}}async function Y(B){if(B!==L.value&&!(!B&&!await qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await z.post("/api/mcp/enabled",{enabled:B}),ye.success(B?"MCP enabled":"MCP disabled"),await k({quiet:!0})}catch(ve){ye.error(ve.message||"Failed to update MCP state"),await k({quiet:!0})}finally{s.value=!1}}}async function ge(B){$(B.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent(B.name)}/reconnect`,{}),ye.success(`Reconnected ${B.name}`)}catch(ve){ye.error(ve.message||`Failed to reconnect ${B.name}`)}finally{$(B.name,!1),await k({quiet:!0})}}async function V(B){$(B.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent(B.name)}/refresh-tools`,{}),ye.success(`Refreshed tools from ${B.name}`),await Ie(B.name,!0)}catch(ve){ye.error(ve.message||`Failed to refresh ${B.name}`)}finally{$(B.name,!1),await k({quiet:!0})}}async function re(B){if(await qt({title:`Remove ${B.name}`,message:`Remove this saved MCP server? Its ${B.published_count||0} published tool${B.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){$(B.name,!0);try{await z.del(`/api/mcp/servers/${encodeURIComponent(B.name)}`),ye.success(`Removed ${B.name}`),delete o.value[B.name]}catch(ke){ye.error(ke.message||`Failed to remove ${B.name}`)}finally{$(B.name,!1),await k({quiet:!0})}}}async function ue(B){const ve=new Set(i.value);if(ve.has(B.name)){ve.delete(B.name),i.value=ve;return}ve.add(B.name),i.value=ve,Object.hasOwn(o.value,B.name)||await Ie(B.name)}async function Ie(B,ve=!1){if(!ve&&Object.hasOwn(o.value,B))return;const ke=new Set(c.value);ke.add(B),c.value=ke,r.value={...r.value,[B]:""};try{const Oe=await z.get(`/api/mcp/servers/${encodeURIComponent(B)}/tools`);o.value={...o.value,[B]:Oe.tools||[]}}catch(Oe){r.value={...r.value,[B]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(c.value);Oe.delete(B),c.value=Oe}}function v(B){return(o.value[B]||[]).filter(ve=>vk(ve,l.value[B]))}function I(B,ve){l.value={...l.value,[B]:ve}}function F(){u.value="add",p.value="",h.value=null,m.value=_r(),g.value="",d.value=!0}function ee(B){u.value="edit",p.value=B.name,h.value=B,m.value={..._r(),name:B.name,enabled:!!B.enabled,transport:B.transport||"stdio"},g.value="",d.value=!0}function X(){w.value||(d.value=!1)}function ae(B){d.value&&bk(B)}function fe(B){const ve=B==="headers"?"headerRows":"envRows";m.value[ve].push({key:"",value:""})}function pe(B,ve){const ke=B==="headers"?"headerRows":"envRows";m.value[ke].splice(ve,1)}function de(B,ve){const ke=B==="headers"?"headersRemove":"envRemove",Oe=m.value[ke];m.value[ke]=Oe.includes(ve)?Oe.filter(Me=>Me!==ve):[...Oe,ve]}async function le(){var ve,ke;g.value="";let B;try{B=fk(m.value,{mode:u.value,originalTransport:((ve=h.value)==null?void 0:ve.transport)||""})}catch(Oe){g.value=Oe instanceof Fs?Oe.message:"Invalid MCP server configuration",await Rt(),(ke=document.querySelector(".mcp-editor"))==null||ke.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&hk(B,h.value)&&!await qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){w.value=!0;try{u.value==="add"?await z.post("/api/mcp/servers",B):await z.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,B),ye.success(u.value==="add"?`Saved ${B.name}`:`Updated ${p.value}`),d.value=!1,await k({quiet:!0})}catch(Oe){g.value=Oe.message||"Failed to save MCP server"}finally{w.value=!1}}}let xe=null;function me(B){`${(B==null?void 0:B.event)||""} ${(B==null?void 0:B.type)||""} ${(B==null?void 0:B.tool)||""} ${(B==null?void 0:B.message)||""}`.toLowerCase().includes("mcp")&&(xe&&window.clearTimeout(xe),xe=window.setTimeout(()=>k({quiet:!0}),200))}function _e(){b||(b=!0,y||(Ye.subscribe("events",me),y=!0),k(),J())}function Re(){b=!1,E(),xe&&window.clearTimeout(xe),xe=null,y&&(Ye.unsubscribe("events",me),y=!1)}return je(_e),Qt(_e),Gt(Re),ft(Re),{status:e,loading:t,mutating:s,pageError:n,servers:S,masterEnabled:L,aggregate:R,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:h,form:m,formError:g,saving:w,editorGroups:A,configuredHeaderKeys:_,configuredEnvKeys:D,savedHttpEndpoint:U,endpointRequired:T,endpointFieldLabel:M,endpointPlaceholder:j,refreshAll:k,busy:C,serverState:W,stateLabel:G,transportLabel:Z,protocolLabel:oe,toolSummary:se,formatAge:_k,setMasterEnabled:Y,togglePending:ce,toggleServerEnabled:Ne,reconnect:ge,refreshTools:V,removeServer:re,toggleTools:ue,filteredTools:v,setToolQuery:I,openAdd:F,openEdit:ee,closeEditor:X,jumpToEditorGroup:ae,addSecretRow:fe,removeSecretRow:pe,toggleSecretRemoval:de,saveServer:le}}};function kk(e,t){if(!e||!t)return np(e);const s=np(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),h=f(!1),m=f(null),g=f(null);let w=null;const N=f(null),x=f(!1),b=f({}),y=f({}),A=f({}),S=f({}),L=new Map,R=f(null),_=q(()=>e.value.reduce((G,Z)=>G+(Z.chunks||0),0)),D=q(()=>new Set(e.value.map(Z=>Z.uploader).filter(Boolean)).size);function U(G,Z){const oe=y.value[Z];if(!oe||oe.length===0)return 0;const se=Math.max(...oe.map(ce=>ce.char_count||0));return se===0?0:Math.round(G.char_count/se*100)}async function T(){t.value=!0,s.value=null;try{const G=await z.get("/api/knowledge");e.value=Array.isArray(G)?G:[]}catch(G){s.value=G.message}t.value=!1}async function M(G){if(b.value[G]){b.value[G]=!1,R.value=null;return}if(b.value[G]=!0,Object.prototype.hasOwnProperty.call(y.value,G))return;if(L.has(G))return L.get(G);const Z={...S.value,[G]:!0};S.value=Z;const oe={...A.value};delete oe[G],A.value=oe;const se=z.get(`/api/knowledge/${encodeURIComponent(G)}/chunks`).then(ce=>{y.value={...y.value,[G]:Array.isArray(ce)?ce:[]}}).catch(ce=>{A.value={...A.value,[G]:ce.message||"load failed"}}).finally(()=>{if(L.get(G)!==se)return;L.delete(G);const ce={...S.value};delete ce[G],S.value=ce});return L.set(G,se),se}let j=0;async function J(){const G=n.value.trim();if(!G)return;const Z=++j;i.value=!0,o.value=null,l.value=G;try{const oe=await z.get(`/api/knowledge/search?q=${encodeURIComponent(G)}`);if(Z!==j)return;a.value=Array.isArray(oe)?oe:[]}catch(oe){if(Z!==j)return;a.value=[],o.value=oe.message||"Search failed"}Z===j&&(i.value=!1)}function E(){j+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function k(){u.value=null,p.value=null;const G=c.value.trim(),Z=d.value.trim();if(!G){u.value="Source name is required";return}if(!Z){u.value="Content is required";return}h.value=!0;try{const oe=await z.post("/api/knowledge",{source:G,content:Z});p.value=`Ingested ${oe.chunks||0} chunks from "${G}"`,c.value="",d.value="",y.value={},await T(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(oe){u.value=oe.message}h.value=!1}async function C(G){m.value=G,g.value=null,w&&(clearTimeout(w),w=null);try{const Z=await z.post(`/api/knowledge/${encodeURIComponent(G)}/reingest`);g.value={source:G,error:!1,message:`Re-ingested ${Z.chunks||0} chunks`},delete y.value[G],await T(),w=setTimeout(()=>{g.value=null,w=null},3e3)}catch(Z){g.value={source:G,error:!0,message:Z.message}}m.value=null}function $(G){N.value=G}async function W(){if(N.value){x.value=!0;try{await z.del(`/api/knowledge/${encodeURIComponent(N.value)}`),delete y.value[N.value],await T()}catch(G){ye.error(`Failed to delete source: ${G.message||"unknown error"}`)}x.value=!1,N.value=null}}return je(()=>{T()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:h,reingesting:m,reingestResult:g,deleteTarget:N,deleting:x,expanded:b,sourceChunks:y,chunkErrors:A,loadingChunks:S,selectedChunk:R,totalChunks:_,uploaderCount:D,truncate:gd,formatTs:Aa,highlightTerms:kk,chunkBarWidth:U,fetchSources:T,toggleSource:M,doSearch:J,clearSearch:E,doIngest:k,doReingest:C,confirmDelete:$,doDelete:W}}},Tk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),n=f(null),a=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),h=f(""),m=f(!1),g=f(null),w=f(null),N=f(new Set),x=f(null),b=f(!1),y=f(!1),A=q(()=>e.value.reduce((Z,oe)=>Z+oe.count,0)),S=q(()=>N.value.size);function L(Z){const oe=t.value[Z];if(!oe)return[];if(!l.value.trim())return oe;const se=l.value.trim().toLowerCase();return oe.filter(ce=>ce.key.toLowerCase().includes(se)||ce.value&&ce.value.toLowerCase().includes(se))}function R(Z,oe){return N.value.has(Z+"/"+oe)}function _(Z,oe){const se=Z+"/"+oe,ce=new Set(N.value);ce.has(se)?ce.delete(se):ce.add(se),N.value=ce}function D(Z){const oe=t.value[Z];return!oe||oe.length===0?!1:oe.every(se=>N.value.has(Z+"/"+se.key))}function U(Z,oe){const se=t.value[Z];if(!se)return;const ce=new Set(N.value);for(const Ne of se){const Y=Z+"/"+Ne.key;oe?ce.add(Y):ce.delete(Y)}N.value=ce}async function T(){s.value=!0,n.value=null;try{const Z=await z.get("/api/memory");e.value=Object.entries(Z).map(([oe,se])=>({name:oe,keys:se.keys||[],count:se.count||0}))}catch(Z){n.value=Z.message}s.value=!1}async function M(Z){if(a.value[Z]){a.value[Z]=!1;return}a.value[Z]=!0;const oe=e.value.find(ce=>ce.name===Z);if(!oe||t.value[Z]||i.value===Z)return;i.value=Z;let se;try{const Ne=(await z.get(`/api/memory/${encodeURIComponent(Z)}`)).entries||{};se=oe.keys.map(Y=>Object.prototype.hasOwnProperty.call(Ne,Y)?{key:Y,value:Ne[Y]||"",failed:!1}:{key:Y,value:"",failed:!0,error:"Not found in scope"})}catch(ce){se=oe.keys.map(Ne=>({key:Ne,value:"",failed:!0,error:ce.message||"Failed to load"}))}t.value[Z]=se,i.value=null}function j(Z,oe,se){p.value=Z+"/"+oe,h.value=se}async function J(Z,oe){m.value=!0,g.value=null;try{await z.put(`/api/memory/${encodeURIComponent(Z)}/${encodeURIComponent(oe)}`,{value:h.value});const se=t.value[Z];if(se){const ce=se.find(Ne=>Ne.key===oe);ce&&(ce.value=h.value)}p.value=null}catch(se){g.value=`Failed to save: ${se.message||"unknown error"}`}m.value=!1}async function E(Z,oe){try{await navigator.clipboard.writeText(oe.value),w.value=Z+"/"+oe.key,setTimeout(()=>{w.value=null},1500)}catch{}}async function k(){d.value=null,u.value=null;const Z=r.value.scope.trim(),oe=r.value.key.trim(),se=r.value.value.trim();if(!Z){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!se){d.value="Value is required";return}c.value=!0;try{await z.put(`/api/memory/${encodeURIComponent(Z)}/${encodeURIComponent(oe)}`,{value:se}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await T(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ce){d.value=ce.message}c.value=!1}function C(Z,oe){x.value={scope:Z,key:oe}}async function $(){if(!x.value)return;b.value=!0,g.value=null;const{scope:Z,key:oe}=x.value;try{await z.del(`/api/memory/${encodeURIComponent(Z)}/${encodeURIComponent(oe)}`);const se=t.value[Z];se&&(t.value[Z]=se.filter(Y=>Y.key!==oe));const ce=e.value.find(Y=>Y.name===Z);ce&&(ce.count--,ce.keys=ce.keys.filter(Y=>Y!==oe));const Ne=new Set(N.value);Ne.delete(Z+"/"+oe),N.value=Ne}catch(se){g.value=`Failed to delete: ${se.message||"unknown error"}`}b.value=!1,x.value=null}function W(){y.value=!0}async function G(){b.value=!0,g.value=null;const Z=[];for(const oe of N.value){const se=oe.indexOf("/");Z.push({scope:oe.slice(0,se),key:oe.slice(se+1)})}try{await z.post("/api/memory/bulk-delete",{entries:Z}),N.value=new Set,t.value={},await T()}catch(oe){g.value=`Bulk delete failed: ${oe.message||"unknown error"}`}b.value=!1,y.value=!1}return je(()=>{T()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:h,saving:m,actionError:g,copied:w,selected:N,selectedCount:S,totalEntries:A,deleteTarget:x,deleting:b,showBulkDelete:y,fetchMemory:T,toggleScope:M,startEdit:j,doEdit:J,copyValue:E,doAdd:k,confirmDelete:C,doDelete:$,confirmBulkDelete:W,doBulkDelete:G,isSelected:R,toggleSelect:_,isScopeAllSelected:D,toggleSelectAll:U,filteredEntries:L}}},Ck={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=f([]),t=f(null),s=f(!0),n=f(null),a=f(null),i=f(null),l=f(""),o=q(()=>[...new Set(e.value.map(w=>w.category))].sort()),r=q(()=>{const g={};return e.value.forEach(w=>{g[w.category]=(g[w.category]||0)+1}),g}),c=q(()=>a.value?e.value.filter(g=>g.category===a.value):e.value);function d(g){return g==="correction"?"badge-warning":g==="operational"?"badge-info":g==="preference"?"badge-success":"badge-info"}function u(g){i.value=g.key,l.value=g.content}async function p(g){try{await z.put("/api/learned/"+encodeURIComponent(g),{content:l.value}),i.value=null,ye.success("Entry updated"),await m()}catch(w){ye.error(w.message||"Failed to save entry")}}async function h(g){if(await qt({title:"Delete learned entry",message:`Delete "${g}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/learned/"+encodeURIComponent(g)),ye.success("Entry deleted"),await m()}catch(N){ye.error(N.message||"Failed to delete entry")}}async function m(){s.value=!0,n.value=null;try{const g=await z.get("/api/learned");e.value=g.entries||[],t.value={last_reflection:g.last_reflection,count:g.count}}catch(g){n.value=g.message}s.value=!1}return je(m),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:o,catCounts:r,filtered:c,catBadge:d,formatTs:Aa,startEdit:u,saveEdit:p,deleteEntry:h,fetchEntries:m}}},Xm=[{id:"tools",label:"Tools",component:ok},{id:"skills",label:"Skills",component:dk},{id:"mcp-servers",label:"MCP Servers",component:wk},{id:"knowledge",label:"Knowledge",component:Sk},{id:"memory",label:"Memory",component:Tk},{id:"learned",label:"Learned",component:Ck}],Ek={components:{TabbedPage:Yo},setup(){return{tabs:Xm}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Ak={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Rk={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},Ik={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},Ok={template:`
    ...
    </div>`,setup(){const e=f({}),t=f(!0),s=f(null),n=f(!1),a=f(!1),i=q(()=>e.value.components||[]),l=q(()=>Ik[e.value.overall]||"text-gray-400"),o=q(()=>e.value.overall==="healthy"?"success":e.value.overall==="degraded"?"warning":e.value.overall==="unhealthy"?"error":"minus"),r=q(()=>{const S=e.value.overall;return S==="healthy"?"All Systems Healthy":S==="degraded"?"Some Systems Degraded":S==="unhealthy"?"System Issues Detected":"Unknown"});function c(S){return Ak[S]||"text-gray-400"}function d(S){return Rk[S]||"info"}function u(S){return S==="ok"?"badge-success":S==="degraded"?"badge-warning":S==="down"?"badge-danger":"badge-info"}function p(S){return S==="closed"?"text-green-400":S==="half_open"?"text-yellow-400":S==="open"?"text-red-400":"text-gray-400"}function h(S){return S.replace(/_/g," ").replace(/\b\w/g,L=>L.toUpperCase())}function m(S){if(!S)return"—";try{return new Date(S).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return S}}function g(S){return S>=1e6?(S/1e6).toFixed(1)+"M":S>=1e3?(S/1e3).toFixed(1)+"K":String(S)}async function w(){a.value=!0;try{e.value=await z.get("/api/health/components"),s.value=null,n.value=!0}catch(S){s.value=S.message}finally{t.value=!1,a.value=!1}}function N(){t.value=!0,s.value=null,w()}let x=null,b=!1;function y(){b||(b=!0,w(),x||(x=setInterval(w,3e4)))}function A(){b&&(b=!1,x&&(clearInterval(x),x=null))}return je(y),Qt(y),Gt(A),ft(A),{data:e,hasData:n,loading:t,error:s,refreshing:a,components:i,overallColor:l,overallIcon:o,overallLabel:r,statusColor:c,statusIcon:d,badgeClass:u,circuitColor:p,formatName:h,formatTime:m,formatNumber:g,fetchHealth:w,retry:N}}},Lk={template:`
...
`);const we=new Blob([te],{type:"text/plain"}),$e=URL.createObjectURL(we),Je=document.createElement("a");Je.href=$e,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL($e)}function pe(te){const we=rp(te);navigator.clipboard.writeText(we).then(()=>{m.value=te.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function de(te){l.value=l.value===te?"":te,b.value="all"}function le(te){return te.level==="ERROR"?"log-line-error":te.level==="WARNING"?"log-line-warning":"text-gray-300"}function xe(te){return te==="ERROR"?"text-red-500 font-semibold":te==="WARNING"?"text-yellow-500":"text-blue-500"}function me(te){return te==="ERROR"?"log-chip-error":te==="WARNING"?"log-chip-warning":"log-chip-info"}function _e(te){b.value=te.id;const we=te.filters;l.value=we.level||"",y.value=we.timeRange||"",o.value=we.text||"",we.levels&&(l.value=we.levels[0]||""),we.hasToolName&&(o.value="")}function Re(te){b.value=te.id,l.value=te.filters.level||"",y.value=te.filters.timeRange||"",o.value=te.filters.text||""}function B(){if(!L.value.trim())return;const te={id:"custom-"+Date.now(),name:L.value.trim(),filters:{level:l.value,timeRange:y.value,text:o.value}};A.value=[...A.value,te],D(),S.value=!1,L.value=""}function ve(te){A.value=A.value.filter(we=>we.id!==te),D(),b.value===te&&(b.value="all")}const ke=f("all"),Oe=f(""),Me=f(""),dt=f(""),st=f(""),_t=f(""),Ot=f(100),rt=jk,Qe=f(!1),ie=f(!1),Se=f(""),Le=f([]),Ke=f(null),Et=f(null);function Ve(){e.value="search",Ke.value||$t()}async function $t(){try{Ke.value=await z.get("/api/logs/stats")}catch{}}function zt(){const te=_t.value;if(!te){dt.value="",st.value="";return}const $e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[te];if($e){const Je=new Date(Date.now()-$e*1e3);dt.value=rs(Je),st.value=""}}function rs(te){const we=$e=>String($e).padStart(2,"0");return`${te.getFullYear()}-${we(te.getMonth()+1)}-${we(te.getDate())}T${we(te.getHours())}:${we(te.getMinutes())}`}function Js(te){if(!te)return"";const we=new Date(te);return isNaN(we.getTime())?"":we.toISOString()}async function ks(){Qe.value=!0,Se.value="",ie.value=!0,Et.value=null;try{const te=new URLSearchParams;ke.value&&ke.value!=="all"&&te.set("level",ke.value),Oe.value&&te.set("tool",Oe.value),Me.value&&te.set("q",Me.value);const we=Js(dt.value),$e=Js(st.value);we&&te.set("start",we),$e&&te.set("end",$e),te.set("limit",String(Ot.value));const Je=await z.get(`/api/logs/search?${te.toString()}`);Le.value=Je.entries||[]}catch(te){Se.value=te.message||"Search failed",Le.value=[]}finally{Qe.value=!1}}function sa(){ke.value="all",Oe.value="",Me.value="",dt.value="",st.value="",_t.value="",Ot.value=100,Le.value=[],ie.value=!1,Se.value="",Et.value=null}function Zs(te){Et.value=Et.value===te?null:te}function Ns(te){if(!te.timestamp)return"";try{return new Date(te.timestamp).toLocaleString()}catch{return te.timestamp}}function Mn(te){return te.type==="web_action"?`${te.status||""} (${te.execution_time_ms||0}ms)`:(te.result_summary||"").slice(0,200)}function Ss(te){return te.error?"log-line-error":"text-gray-300"}function Fn(te){try{return JSON.stringify(te,null,2)}catch{return String(te)}}let Lt=null,Xe=!1;function Ts(){Xe||(Xe=!0,Ye.subscribe("logs",se),c.value=Ye.connected,d.value=Ye.state||"disconnected",Lt=Ye.onState(te=>{d.value=te,c.value=te==="connected"}))}function Ds(){Xe&&(Xe=!1,Ye.unsubscribe("logs",se),Lt&&(Lt(),Lt=null))}return je(()=>{_(),window.addEventListener("pointerup",F),window.addEventListener("pointercancel",F)}),Qt(Ts),Gt(Ds),ft(()=>{Ds(),window.removeEventListener("pointerup",F),window.removeEventListener("pointercancel",F)}),{mode:e,logs:t,paused:a,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:n,groupedLogs:oe,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:Z,pauseBuffer:R,showJumpBottom:h,copiedIndex:m,regexError:M,levels:w,logPresets:N,timeRanges:x,timeRange:y,activeLogPreset:b,customLogPresets:A,showSaveLogPreset:S,newLogPresetName:L,hasActiveLogFilters:U,timeRangeLabel:T,timelineBuckets:J,timelineMax:E,timelineSpanLabel:k,timelineLabelSkip:C,togglePause:X,clearLogs:ae,exportLogs:fe,logLineClass:le,levelClass:xe,levelChipClass:me,toggleLevel:de,copyLine:pe,jumpToBottom:Y,onScroll:V,onUserScrollIntent:ue,onUserScrollKey:Ie,onAutoScrollToggle:ee,onPointerDown:I,applyLogPreset:_e,applyCustomLogPreset:Re,saveLogCustomPreset:B,removeLogCustomPreset:ve,segmentHeight:W,jumpToTimelineBucket:G,searchLevel:ke,searchTool:Oe,searchKeyword:Me,searchStart:dt,searchEnd:st,searchTimePreset:_t,searchLimit:Ot,searchLimits:rt,searching:Qe,searchRan:ie,searchError:Se,searchResults:Le,searchStats:Ke,expandedSearch:Et,switchToSearch:Ve,runSearch:ks,clearSearchFilters:sa,toggleSearchExpand:Zs,formatSearchTs:Ns,searchEntryText:Mn,searchLogLineClass:Ss,formatJson:Fn,applySearchTimePreset:zt}}};function Dl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const qk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function Gk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Xa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Kk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},Pl=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord","computer"]),Wk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function cp(e){return Wk.some(t=>e===t||e.startsWith(`${t}.`))}const ev="odin_config_center_expanded_v1",tv="odin_config_center_category_v1",Jk=50,Zk=650,kr=()=>z.get("/api/config/meta");function ca(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Bi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Pa(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Yk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function Qk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function sv(e,t){if(Bi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ca(t);const n={};for(const[a,i]of Object.entries(t)){const l=sv(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function Xk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=sv(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function nv(e,t,s,n){if(Bi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)nv(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function eS(){try{const e=JSON.parse(localStorage.getItem(ev)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function tS(){try{const e=localStorage.getItem(tv);return Xa.some(t=>t.key===e)?e:Xa[0].key}catch{return Xa[0].key}}const sS={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),n=f(null),a=f(!1),i=f(null),l=f(null),o=f(null),r=f(!1),c=f(!1),d=f(null),u=f(""),p=f("all"),h=f(tS()),m=f(eS()),g=f({}),w=f({}),N=f(""),x=f({}),b=f({}),y=f([]),A=f([]),S=f(!1),L=f(!1),R=f(!1);let _=null,D=null,U={path:null,at:0},T=0;const M=q(()=>{var O;return(((O=t.value)==null?void 0:O.fields)||[]).filter(H=>!Pl.has(H.path.split(".")[0])&&!cp(H.path))}),j=q(()=>new Map(M.value.map(O=>[O.path,O]))),J=q(()=>W.value.reduce((O,H)=>O+H.sections.length,0)),E=q(()=>M.value.length),k=q(()=>qk),C=q(()=>y.value.length>0),$=q(()=>A.value.length>0),W=q(()=>{if(!e.value)return[];const O=new Set(Xa.flatMap(Ee=>Ee.sections)),H=Xa.map(Ee=>({...Ee,sections:Ee.sections.filter(ct=>Object.hasOwn(e.value,ct)&&!Pl.has(ct))})).filter(Ee=>Ee.sections.length),Q=Object.keys(e.value).filter(Ee=>!O.has(Ee)&&!Pl.has(Ee));return Q.length&&H.push({key:"other",label:"Other",icon:"folder",sections:Q}),H}),G=q(()=>e.value?{...e.value,...g.value}:null),Z=q(()=>{if(!e.value)return[];const O=[];for(const[H,Q]of Object.entries(g.value))nv(e.value[H],Q,H,O);return O.filter(H=>!Bi(H.oldVal,H.newVal)).map(H=>{const Q=I(H.path);return{...H,label:(Q==null?void 0:Q.label)||Pa(H.path.split(".").at(-1)),apply_mode:(Q==null?void 0:Q.apply_mode)||de(H.path.split(".")[0])}})}),oe=q(()=>Z.value.length>0),se=q(()=>Z.value.length),ce=q(()=>new Set(Z.value.map(O=>O.path.split(".")[0])).size),Ne=q(()=>!!u.value||p.value!=="all"),Y=q(()=>{const O={...b.value};for(const H of Z.value){const Q=I(H.path),Ee=mi(Q,H.newVal);Ee&&(O[H.path]=Ee)}return O}),ge=q(()=>Object.keys(Y.value).length>0),V=q(()=>e.value?(Ne.value?W.value:W.value.filter(H=>H.key===h.value)).map(H=>({...H,sections:H.sections.filter(Q=>Qe(Q))})).filter(H=>H.sections.length):[]),re=q(()=>{const O=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],H=new Map(O.map(Q=>[Q,[]]));for(const Q of Z.value){const Ee=H.has(Q.apply_mode)?Q.apply_mode:"restart";H.get(Ee).push(Q)}return O.filter(Q=>H.get(Q).length).map(Q=>({key:Q,label:Xt(Q),entries:H.get(Q)}))}),ue=q(()=>Z.value.filter(O=>O.apply_mode==="restart").length),Ie=q(()=>M.value.filter(O=>O.pending_restart)),v=q(()=>Ie.value.length);function I(O){const H=j.value.get(O);return H?{...H,apply_details:Dl([H])}:null}function F(O){const H=`${O}.`;return M.value.filter(Q=>Q.path===O||Q.path.startsWith(H))}function ee(){return M.value.some(O=>O.path==="tools.hosts"||O.path.startsWith("tools.hosts."))}function X(){var Q,Ee;const O=((Ee=(Q=e.value)==null?void 0:Q.tools)==null?void 0:Ee.hosts)||{},H=Object.keys(O).length;return`${H} host${H===1?"":"s"} configured.`}function ae(O){return F(O).length}function fe(O){return Pa(O)}function pe(O){const H=F(O);if(!H.length)return`${Pa(O)} configuration.`;const Q=H.find(Cs=>Cs.sensitivity==="public"&&Cs.description)||H.find(Cs=>Cs.description),Ee=(Q==null?void 0:Q.description)||"";return Ee.match(/setting for (.+)\.$/i)?`${Pa(O)} settings and runtime behaviour.`:Ee}function de(O){const H=[...new Set(F(O).map(Q=>Q.apply_mode))];return H.length===1?H[0]:H.includes("restart")?"restart":H.includes("activation_required")?"activation_required":H[0]||"restart"}function le(O){const H=[...new Set(F(O).map(Q=>Xt(Q.apply_mode)))];return H.length?H.length===1?H[0]:`Mixed apply behaviour: ${H.join(" · ")}`:""}function xe(O){return Dl(F(O))}function me(O){var H;return Object.hasOwn(g.value,O)?g.value[O]:(H=e.value)==null?void 0:H[O]}function _e(){const O=me("mcp")||{},H=Object.keys(O.servers||{}).length;return`${O.enabled?"Globally enabled":"Globally disabled"} · ${H} configured server${H===1?"":"s"}.`}function Re(O,H){return H.split(".").reduce((Q,Ee)=>Q==null?void 0:Q[Ee],O)}function B(O){const H=G.value;return F(O).filter(Q=>cp(Q.path)?!1:Q.path.split(".").length<=2?!0:!Q.path.includes(".*")).map(Q=>({...Q,key:Q.path.split(".").at(-1),value:Re(H,Q.path),apply_details:Dl([Q]),editor:Q.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ve(O){const H=O.path.split(".");return H.length>2?H.slice(0,2).join("."):null}function ke(O){const H=new Map;for(const Q of B(O)){const Ee=ve(Q),ct=Ee||`${O}.__root`;H.has(ct)||H.set(ct,{key:ct,path:Ee,entries:[]}),H.get(ct).entries.push(Q)}return[...H.values()].map(Q=>{const Ee=Q.entries.find(ct=>ct.group_description);return{...Q,label:Q.path?Pa(Q.path.split(".").at(-1)):null,description:(Ee==null?void 0:Ee.group_description)||null,apply_details:Dl(Q.entries),runtime_summaries:Me(Q.entries)}})}function Oe(O){return{save:O.save_effect||(O.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:O.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[O.apply_mode]||"Effective runtime state is not currently observable."}}function Me(O){const H=new Map;for(const Q of O){const Ee=Oe(Q),ct=`${Q.apply_mode}|${Ee.save}|${Ee.runtime}`;H.has(ct)||H.set(ct,{key:ct,label:Xt(Q.apply_mode),save:Ee.save,runtime:Ee.runtime})}return[...H.values()]}function dt(O){if(st(O))return O.runtime_effect||O.activation_policy||"";if(O.apply_mode==="activation_required"){const H=O.activation_policy||O.runtime_effect;return H?`Not active after saving. No activation control exists in this release. ${H}`:"Not active after saving; no activation control exists in this release."}return""}function st(O){return O.action_available===!0&&!!(O.action_label&&O.action_endpoint)}async function _t(O){if(st(O))try{if(Et(O.path))throw new Error("Save this setting before applying its action.");const H=String(O.action_method||"POST").toLowerCase(),Q={post:z.post.bind(z),put:z.put.bind(z),delete:z.del.bind(z)}[H];if(!Q)throw new Error("Unsupported configuration action");await Q(O.action_endpoint,O.action_body||void 0),await De(),es("success",`${O.action_label} completed.`)}catch(H){es("error",H.message||`${O.action_label} failed`)}}function Ot(O,H){return[O.label,O.path,O.description,...O.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(H)}function rt(O){const H=u.value.trim().toLowerCase();return H?F(O).filter(Q=>Ot(Q,H)):[]}function Qe(O){const H=F(O);if(p.value!=="all"&&!H.some(Ee=>Ee.apply_state===p.value))return!1;const Q=u.value.trim().toLowerCase();return!Q||`${fe(O)} ${O}`.toLowerCase().includes(Q)?!0:H.some(Ee=>Ot(Ee,Q))}function ie(O,H){return F(O).filter(Q=>Q.apply_state===H).length}function Se(O){return O==="all"?E.value:M.value.filter(H=>H.apply_state===O).length}function Le(O){const H=O.sections.flatMap(Q=>F(Q));return{fields:H.length,modified:Z.value.filter(Q=>O.sections.includes(Q.path.split(".")[0])).length,pending_restart:H.filter(Q=>Q.apply_state==="pending_restart").length,invalid:H.filter(Q=>Q.apply_state==="invalid").length,dormant:H.filter(Q=>Q.apply_state==="dormant").length}}function Ke(O){var H;return Object.hasOwn(g.value,O)&&!Bi((H=e.value)==null?void 0:H[O],g.value[O])}function Et(O){return Z.value.some(H=>H.path===O||H.path.startsWith(`${O}.`))}function Ve(O){h.value=O,u.value="",p.value="all";try{localStorage.setItem(tv,O)}catch{}}function $t(O){p.value=O}function zt(){u.value="",p.value="all"}function rs(O){var H;return((H=W.value.find(Q=>Q.sections.includes(O)))==null?void 0:H.sections)||[]}function Js(O){const H=rs(O),Q=H.find(Ee=>m.value[Ee]===!0);return Q||H.find(Ee=>m.value[Ee]!==!1)||null}function ks(O){return u.value&&!R.value&&Qe(O)?!0:R.value?Js(O)===O:Object.hasOwn(m.value,O)?m.value[O]===!0:!0}function sa(O){const H=!ks(O);if(R.value){const Q={...m.value};for(const Ee of rs(O))Q[Ee]===!0&&(Q[Ee]=!1);Q[O]=H,m.value=Q;return}m.value={...m.value,[O]:H}}function Zs(){y.value.push(ca(g.value)),y.value.length>Jk&&y.value.shift(),A.value=[]}function Ns(){oe.value&&(Zs(),g.value={},b.value={},S.value=!1)}function Mn(O,H=!1){const Q=Date.now();if(H&&U.path===O&&Q-U.at<Zk){U.at=Q;return}Zs(),U={path:O,at:Q}}function Ss(O,H,Q){if(!H.length)return Q;const Ee=ca(O??{});let ct=Ee;for(let Cs=0;Cs<H.length-1;Cs+=1){const pn=H[Cs];ct[pn]=ca(ct[pn]??{}),ct=ct[pn]}return ct[H.at(-1)]=Q,Ee}function Fn(O){var H;return Object.hasOwn(g.value,O)?g.value[O]:ca((H=e.value)==null?void 0:H[O])}function Lt(O,H,Q={}){var Ad;if(Pl.has(O.path.split(".")[0]))return;const[Ee,...ct]=O.path.split(".");Mn(O.path,!!Q.coalesce);const Cs=Fn(Ee),pn=ct.length?Ss(Cs,ct,H):H,aa={...g.value};if(Bi(pn,(Ad=e.value)==null?void 0:Ad[Ee])?delete aa[Ee]:aa[Ee]=pn,g.value=aa,b.value[O.path]){const Rd={...b.value};delete Rd[O.path],b.value=Rd}}function Xe(O){U={path:null,at:0},w.value={...w.value,[O]:String(Re(G.value,O)??"")}}function Ts(O){if(U={path:null,at:0},!Object.hasOwn(w.value,O))return;const H={...w.value};delete H[O],w.value=H}function Ds(O){const H=w.value[O.path];if(U={path:null,at:0},H===""){if(O.nullable){Ts(O.path),Lt(O,null,{coalesce:!0});return}b.value={...b.value,[O.path]:"Enter a number."};return}const Q=Number(H);if(Number.isNaN(Q)||O.type==="integer"&&!Number.isInteger(Q)){b.value={...b.value,[O.path]:O.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ee={...w.value};delete Ee[O.path],w.value=Ee,Lt(O,Q,{coalesce:!0})}function te(O){return Object.hasOwn(w.value,O.path)?w.value[O.path]:O.value??""}function we(O,H){if(w.value={...w.value,[O.path]:H},H===""){if(O.nullable){Lt(O,null,{coalesce:!0});return}b.value={...b.value,[O.path]:"Enter a number."};return}const Q=Number(H);if(!Number.isFinite(Q)||O.type==="integer"&&!Number.isInteger(Q)){b.value={...b.value,[O.path]:O.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(b.value[O.path]){const Ee={...b.value};delete Ee[O.path],b.value=Ee}Lt(O,Q,{coalesce:!0})}function $e(O){const H=Number.parseInt(N.value,10);if(!Number.isInteger(H)||H<1){b.value={...b.value,[O.path]:"Warning thresholds must be positive whole numbers."};return}const Q=[...new Set([...O.value||[],H])].sort((Ee,ct)=>ct-Ee);N.value="",Lt(O,Q)}function Je(O,H){Lt(O,(O.value||[]).filter(Q=>Q!==H))}function wt(O){return O.apply_mode==="live_read"?"Odin reads the saved file value on next use.":O.apply_mode==="live_for_new_work"?"New work uses the saved file value.":O.apply_mode==="live_apply"?O.apply_handler?`Apply the saved value through ${O.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":O.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":O.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":O.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ut(O){return O.type==="array"&&Array.isArray(O.value)&&!O.structured_container&&!O.structured_container_child&&O.sensitivity==="public"&&O.value.every(H=>["string","number","boolean"].includes(typeof H))}function $n(O){const H=String(x.value[O.path]??"").trim();if(!H)return;const Q=[...new Set([...O.value||[],H])];x.value={...x.value,[O.path]:""},Lt(O,Q)}function js(O,H){Lt(O,(O.value||[]).filter(Q=>Q!==H))}function mi(O,H){var Ee;if(!O)return null;if((Ee=O.enum)!=null&&Ee.length&&!O.enum.includes(H))return`Choose one of: ${O.enum.join(", ")}`;if(O.path==="agents.final_warning_iterations"&&(!Array.isArray(H)||!H.length))return"Add at least one warning threshold.";const Q=O.constraints||{};if((O.type==="integer"||O.type==="number")&&typeof H=="number"){if(Q.minimum!==void 0&&H<Q.minimum)return`Must be at least ${Q.minimum}${O.unit?` ${O.unit}`:""}`;if(Q.maximum!==void 0&&H>Q.maximum)return`Must be at most ${Q.maximum}${O.unit?` ${O.unit}`:""}`}return null}function vi(O){return Y.value[O.path]||null}function Ia(O){const H=`${O}.`;return Object.keys(Y.value).some(Q=>Q===O||Q.startsWith(H))}function na(){y.value.length&&(A.value.push(ca(g.value)),g.value=y.value.pop(),b.value={},w.value={},U={path:null,at:0})}function Un(){A.value.length&&(y.value.push(ca(g.value)),g.value=A.value.pop(),b.value={},w.value={},U={path:null,at:0})}function Bn(){!oe.value||ge.value||(S.value=!0,L.value=!1)}function Ys(){S.value=!1}function dn(){Ns()}function Xt(O){return Kk[O]||Pa(O||"unknown")}function Oa(O){return`apply-${String(O||"unknown").replaceAll("_","-")}`}function K(O){return`cfgc-field-${O.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function be(O){return`${K(O)}-input`}function Ae(O){const H=document.getElementById(K(O))||document.getElementById(K(O.split(".").slice(0,2).join(".")));H==null||H.scrollIntoView({behavior:"smooth",block:"center"})}function es(O,H){l.value={type:O,message:H},window.setTimeout(()=>{var Q;((Q=l.value)==null?void 0:Q.message)===H&&(l.value=null)},3500)}function un(){r.value=!1,p.value="pending_restart",u.value="";const O=Gk(n.value);O&&(O.scrollTop=0)}function Hn(){r.value=!1}function Te(O=1800){D&&window.clearTimeout(D),D=window.setTimeout(P,O)}async function P(){if(c.value){if(T+=1,T>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await kr(),v.value===0){c.value=!1,d.value=null,es("success","Odin restarted and the saved startup settings are active.");return}}catch{}Te(2e3)}}async function ne(){if(!c.value){d.value=null;try{await z.post("/api/restart",{}),c.value=!0,T=0,r.value=!1,Te()}catch(O){d.value=O.message||"Odin could not schedule a restart."}}}async function he(){if(!(!oe.value||ge.value||a.value)){a.value=!0;try{const O=Xk(e.value,g.value),H=await z.put("/api/config",O);e.value=H,g.value={},y.value=[],A.value=[],b.value={},S.value=!1;try{t.value=await kr(),o.value=null,r.value=v.value>0,es("success",v.value?`Configuration saved. ${v.value} setting${v.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(Q){o.value=Q.message||"Unknown metadata error.",es("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(O){es("error",O.message||"Configuration could not be saved")}finally{a.value=!1}}}async function De(){var O,H;if(!oe.value){s.value=!0,i.value=null;try{const Q=await z.get("/api/config"),Ee=await kr();e.value=Q,t.value=Ee,o.value=null;const ct=W.value;if(ct.some(Cs=>Cs.key===h.value)||(h.value=((O=ct[0])==null?void 0:O.key)||Xa[0].key),R.value){const pn=(((H=ct.find(aa=>aa.key===h.value))==null?void 0:H.sections)||[]).find(aa=>m.value[aa]===!0);m.value=pn?{...m.value,[pn]:!0}:{}}}catch(Q){i.value=Q.message||"Unknown configuration error"}finally{s.value=!1}}}function Fe(O){if(S.value||!(O.ctrlKey||O.metaKey))return;const H=O.target;H instanceof HTMLElement&&(H.matches("input, textarea, select")||H.isContentEditable)||(!O.shiftKey&&O.key.toLowerCase()==="z"?(O.preventDefault(),na()):(O.key.toLowerCase()==="y"||O.shiftKey&&O.key.toLowerCase()==="z")&&(O.preventDefault(),Un()))}function Be(O){R.value=O.matches}Mt(m,O=>{try{localStorage.setItem(ev,JSON.stringify(O))}catch{}},{deep:!0});let yt=!1;function it(){yt||(yt=!0,document.addEventListener("keydown",Fe))}function vt(){yt&&(yt=!1,document.removeEventListener("keydown",Fe))}return je(()=>{var O;De(),it(),_=window.matchMedia("(max-width: 760px)"),Be(_),(O=_.addEventListener)==null||O.call(_,"change",Be)}),Qt(it),Gt(vt),ft(()=>{var O;vt(),(O=_==null?void 0:_.removeEventListener)==null||O.call(_,"change",Be),D&&window.clearTimeout(D)}),{armKeydown:it,disarmKeydown:vt,handleKeydown:Fe,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:h,reviewOpen:S,mobileOverflowOpen:L,warningThresholdInput:N,arrayInputs:x,healthFilters:k,visibleCategories:W,displayGroups:V,reviewGroups:re,sectionCount:J,fieldCount:E,hasChanges:oe,changeCount:se,changedSectionCount:ce,hasDraftErrors:ge,canUndo:C,canRedo:$,globalFilterActive:Ne,reviewRestartCount:ue,pendingRestartCount:v,pendingRestartFields:Ie,healthCount:Se,categoryStats:Le,selectCategory:Ve,selectHealthFilter:$t,clearFilters:zt,sectionLabel:fe,sectionDescription:pe,sectionFieldCount:ae,sectionHealthCount:ie,sectionApplySummary:le,sectionApplyDetails:xe,sectionEntries:B,fieldGroups:ke,sectionSearchHits:rt,mcpConfigSummary:_e,fieldRuntimeCopy:Oe,fieldSpecificRuntimeNote:dt,hasHonestAction:st,runFieldAction:_t,hasHostsCollection:ee,hostsConfigSummary:X,sectionChanged:Ke,fieldChanged:Et,isSectionExpanded:ks,toggleSection:sa,discardAllDrafts:Ns,setFieldValue:Lt,setNumberFieldValue:we,numberInputValue:te,beginInputEdit:Xe,endTextInputEdit:Ts,endInputEdit:Ds,addWarningThreshold:$e,removeWarningThreshold:Je,isScalarArray:ut,addScalarArrayItem:$n,removeScalarArrayItem:js,fieldError:vi,sectionHasErrors:Ia,undo:na,redo:Un,openReview:Bn,closeReview:Ys,mobileCancel:dn,applyModeLabel:Xt,applyClass:Oa,compactValue:Yk,formatValue:Qk,structuredApplyCopy:wt,fieldId:K,fieldInputId:be,focusField:Ae,fetchConfig:De,saveConfig:he,restartOdin:ne,restartLater:Hn,reviewPendingRestart:un}}},nS=/^\d{15,25}$/;function av(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const iv={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),n=f(!1),a=f(0),i=f(null),l=q(()=>new Set((e.excludedIds||[]).map(String))),o=q(()=>{const A=s.value.toLowerCase().trim();return(e.members||[]).filter(S=>l.value.has(String(S.id))?!1:A?u(S).toLowerCase().includes(A)||String(S.username||"").toLowerCase().includes(A)||String(S.id).includes(A):!0)}),r=q(()=>{const A=s.value.trim();return o.value.length===0&&nS.test(A)&&!l.value.has(A)?A:""}),c=q(()=>o.value.length+(r.value?1:0)),d=q(()=>{if(n.value){if(o.value[a.value])return`${e.optionsId}-${a.value}`;if(r.value&&a.value===o.value.length)return`${e.optionsId}-raw`}});function u(A){return av(A)}function p(){n.value=!0,a.value=0}function h(){p()}function m(){const A=Math.max(c.value-1,0);a.value=Math.min(a.value+1,A)}function g(){a.value=Math.max(a.value-1,0)}function w(){const A=o.value[a.value];A?N(A):r.value&&a.value===o.value.length&&x(r.value)}function N(A){x(String(A.id))}function x(A){t("select",A),s.value="",n.value=!1,a.value=0}function b(){n.value=!1}function y(){setTimeout(b,150)}return je(()=>{e.autofocus&&Rt(()=>{var A;return(A=i.value)==null?void 0:A.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:h,highlightNext:m,highlightPrevious:g,selectHighlighted:w,selectMember:N,selectId:x,closeOptions:b,onBlur:y}}};function dp(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const aS={components:{DiscordUserCombobox:iv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f(!0),s=f(null),n=f({}),a=f(null),i=f(null),l=f(!1),o=f(null),r=f({}),c=f([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=q(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),h=q(()=>new Map(c.value.map(E=>[String(E.id),E])));function m(E){return E.config&&E.config.enabled!==void 0?E.config.enabled:!0}function g(E){return dp(E,"require_mention",a.value)}function w(E){return dp(E,"respond_to_bots",a.value)}function N(E){return E.config&&Object.keys(E.config).length>0}function x(E){n.value[E]=!n.value[E]}function b(E){const k=E.discord||{};return{allowed_users:[...k.allowed_users||[]],channels:[...k.channels||[]],respond_to_bots:!!k.respond_to_bots,require_mention:!!k.require_mention,ignore_bot_ids:[...k.ignore_bot_ids||[]]}}async function y({showLoading:E=!0}={}){const k=++d;E&&(t.value=!0),s.value=null;try{const C=await z.get("/api/discord/guilds");k===d&&(e.value=C)}catch(C){k===d&&(s.value=C.message)}finally{E&&k===d&&(t.value=!1)}}async function A(){t.value=!0,s.value=null;try{const[E,k,C]=await Promise.all([z.get("/api/discord/guilds"),z.get("/api/discord/members").catch(()=>[]),z.get("/api/config")]),$=b(C),W=p.value;a.value=$,W||(i.value=JSON.parse(JSON.stringify($))),c.value=k,e.value=E,o.value=null}catch(E){s.value=E.message}finally{t.value=!1}}let S=Promise.resolve();const L=f(new Set);function R(E,k){const C=new Set(L.value);C.add(E),L.value=C;const $=S.then(k);return S=$.catch(()=>{}),$.finally(()=>{const W=new Set(L.value);W.delete(E),L.value=W})}function _(E,k,C,$){const W=($==null?void 0:$.target)??null;return R(`guild:${E}:${k}`,async()=>{try{await z.put("/api/discord/guild/"+E+"/config",{[k]:C}),await y({showLoading:!1})}catch(G){s.value=G.message,W&&typeof C=="boolean"&&(W.checked=!C)}})}function D(E,k,C,$,W){const G=(W==null?void 0:W.target)??null;return R(`channel:${E}:${C}`,async()=>{try{await z.put("/api/discord/channel/"+E+"/config",{[C]:$}),await y({showLoading:!1})}catch(Z){s.value=Z.message,G&&typeof $=="boolean"&&(G.checked=!$)}})}function U(E,k){return R(`channel:${E}:clear`,async()=>{try{await z.put("/api/discord/channel/"+E+"/config",{clear:!0}),await y({showLoading:!1})}catch(C){s.value=C.message}})}function T(E,k){const C=String(k);if(!E.userAutocomplete)return C;const $=h.value.get(C);return $?av($):C}function M(E,k=null){const C=String(k??r.value[E]??"").trim();!C||i.value[E].includes(C)||(i.value[E]=[...i.value[E],C],r.value={...r.value,[E]:""})}function j(E,k){i.value[E]=i.value[E].filter(C=>C!==k)}async function J(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const k=(await z.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...k.allowed_users||[]],channels:[...k.channels||[]],respond_to_bots:!!k.respond_to_bots,require_mention:!!k.require_mention,ignore_bot_ids:[...k.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(E){o.value=E.message||"Global defaults could not be saved."}finally{l.value=!1}}}return je(A),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:g,guildBots:w,hasOverride:N,toggleGuild:x,fetchAll:A,fetchGuilds:y,setGuildConfig:_,setChannelConfig:D,clearOverride:U,mutationPending:L,globalItemLabel:T,addGlobalItem:M,removeGlobalItem:j,saveGlobalDefaults:J}}},Es=e=>e==null?e:JSON.parse(JSON.stringify(e));function iS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let h=null;const m=new Map;function g(S){d+=1;const L=c.then(S,S);return c=L.catch(()=>{}),L}function w(S,L){h=Es(S),m.clear();for(const[R,_]of Object.entries(L||{}))m.set(R,Es(_))}function N(S){const L=Es(S),R=++u;return g(async()=>{try{await e(Es(L)),h=Es(L),R===u&&n(Es(L))}catch(_){R===u&&(a(Es(h)),r(_,{kind:"default"}))}})}function x(S,L){const R=Es(L),_=(p.get(S)||0)+1;return p.set(S,_),g(async()=>{try{await t(S,Es(R)),m.set(S,Es(R)),_===p.get(S)&&i(S,Es(R))}catch(D){_===p.get(S)&&(l(S,Es(m.get(S)??null)),r(D,{kind:"user",uid:S}))}})}function b(S){const L=(p.get(S)||0)+1;return p.set(S,L),g(async()=>{try{await s(S),m.delete(S),L===p.get(S)&&o(S)}catch(R){L===p.get(S)&&(l(S,Es(m.get(S)??null)),r(R,{kind:"delete",uid:S}))}})}async function y(){for(;;){const S=c;if(await S,S===c)return d}}async function A(S){for(;;){const L=await y(),R=await S();if(L===d)return R}}return{seed:w,saveDefault:N,saveUser:x,deleteUser:b,whenIdle:y,readSnapshot:A,get revision(){return d}}}const lS={components:{DiscordUserCombobox:iv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=q(()=>{const T={};for(const M of r.value)T[M.id]=M;return T});function d(T){return c.value[T]||null}function u(T,M){return T?T.allowed_hosts===null||T.allowed_hosts===void 0?{allowed_hosts:[...M],default_host:T.default_host||"",allow_all:!0}:{allowed_hosts:T.allowed_hosts,default_host:T.default_host||"",allow_all:!1}:{allowed_hosts:[...M],default_host:M[0]||"",allow_all:!0}}const p=iS({applyDefault:async T=>{const M=T.allow_all?null:T.allowed_hosts;await z.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:T.default_host})},applyUser:async(T,M)=>{const j=M.allow_all?null:M.allowed_hosts;await z.put(`/api/host-access/user/${T}`,{allowed_hosts:j,default_host:M.default_host})},applyDelete:T=>z.del(`/api/host-access/user/${T}`),onDefaultConfirmed:()=>ye.success("Default policy updated"),onDefaultRollback:T=>{T&&(i.value=T)},onUserConfirmed:T=>{const M=d(T);ye.success(`Updated access for ${M?M.display_name:T}`)},onUserRollback:(T,M)=>{const j={...l.value};M?j[T]=M:delete j[T],l.value=j},onUserDeleted:T=>{const M={...l.value};delete M[T],l.value=M},onError:(T,M)=>{var J;const j=M.uid?` ${((J=d(M.uid))==null?void 0:J.display_name)||M.uid}`:"";ye.error(`${T.message||"Failed to save"} — reverted${j}`)}});let h=0;async function m(){const T=++h;e.value=!0,t.value="";try{const M=await p.readSnapshot(()=>z.get("/api/host-access"));if(T!==h)return;s.value=M,n.value=M.available_hosts||[],a.value=M.host_descriptions||{},i.value=u(M.default_policy,n.value);const j=M.users||{},J={};for(const[E,k]of Object.entries(j))J[E]=u(k,n.value);l.value=J,p.seed(i.value,J)}catch(M){T===h&&(t.value=M.message||"Failed to fetch host access data")}finally{T===h&&(e.value=!1)}try{const M=await z.get("/api/discord/members")||[];T===h&&(r.value=M)}catch{T===h&&(r.value=[])}}const g=500,w=new Map;function N(T,M){const j=w.get(T);j&&clearTimeout(j.timer);const J={run:M,timer:null};J.timer=setTimeout(()=>{w.delete(T),M()},g),w.set(T,J)}function x(T){const M=w.get(T);M&&(clearTimeout(M.timer),w.delete(T))}function b(){for(const[T,M]of[...w])clearTimeout(M.timer),w.delete(T),M.run()}function y(){N("default",()=>p.saveDefault(i.value))}function A(T,M){i.value.allow_all=!1,M?i.value.allowed_hosts.includes(T)||i.value.allowed_hosts.push(T):(i.value.allowed_hosts=i.value.allowed_hosts.filter(j=>j!==T),i.value.default_host===T&&(i.value.default_host=i.value.allowed_hosts[0]||"")),y()}function S(T){N(`user:${T}`,()=>{const M=l.value[T];M&&p.saveUser(T,M)})}function L(T,M,j){const J=l.value[T];J&&(J.allow_all=!1,j?J.allowed_hosts.includes(M)||J.allowed_hosts.push(M):(J.allowed_hosts=J.allowed_hosts.filter(E=>E!==M),J.default_host===M&&(J.default_host=J.allowed_hosts[0]||"")),S(T))}function R(T,M){const j=l.value[T];j&&(j.default_host=M,S(T))}function _(){o.value=!0}function D(T){!/^\d{15,25}$/.test(T)||l.value[T]||(l.value[T]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},p.saveUser(T,l.value[T]),o.value=!1)}async function U(T){const M=d(T);await qt({title:"Remove user override",message:`Remove the host access override for ${M?M.display_name:T}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(x(`user:${T}`),await p.deleteUser(T),l.value[T]||ye.success(`Removed override for ${M?M.display_name:T}`))}return je(m),Gt(b),ft(b),{loading:e,error:t,data:s,availableHosts:n,hostDescriptions:a,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:y,toggleDefaultHost:A,getMember:d,toggleUserHost:L,setUserDefault:R,openAddUser:_,addUserById:D,deleteUser:U,flushPendingSaves:b}}},oS={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=f([]),t=f(!1),s=f(""),n=f([]),a=f(!1),i=f(!1),l=f(1),o=f(""),r=f(!1),c=f(null),d=f(""),u=f([]),p=f(!1),h=f(null),m=f(""),g=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),w=f(g()),N=q(()=>["127.0.0.1","localhost","::1"].includes(w.value.address));async function x(){t.value=!0,s.value="";try{const J=await z.get("/api/hosts");e.value=J.hosts||[],o.value=J.default_host||"",r.value=!!J.tofu_enabled}catch(J){s.value=J.message}finally{t.value=!1}}async function b(){try{await z.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),ye.success("Host settings saved and published live"),await x()}catch(J){ye.error(J.message)}}function y(){d.value="",u.value=[],p.value=!1,h.value=null,c.value=null,m.value="",l.value=1,a.value=!0}function A(){i.value=!1,w.value=g(),y()}function S(J){i.value=!0,w.value={...g(),...J},y()}async function L(){try{c.value=await z.get("/api/hosts/public-key")}catch(J){ye.error(J.message)}}async function R(J){try{const E=await z.post("/api/hosts/"+encodeURIComponent(J.alias)+"/import-legacy",{});i.value=!0,w.value={...g(),...J,trust_mode:"pinned"},y(),d.value=E.candidate_token,u.value=E.fingerprints||[],m.value=u.value.join(`
`),l.value=4,ye.info("Imported existing known_hosts trust. Test before activation.")}catch(E){ye.error(E.message)}}async function _(){try{const J=m.value.split(/\s+/).filter(Boolean),E={...w.value,expected_fingerprints:J,candidate_fingerprints:u.value},k=await z.post("/api/hosts/candidates",E);if(d.value=k.candidate_token,u.value=k.fingerprints||[],w.value.trust_mode==="tofu"&&E.candidate_fingerprints.length===0){w.value.confirm_tofu=!1,ye.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(J){ye.error(J.message)}}async function D(){var J,E;p.value=!1,h.value=null;try{const k=await z.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!k.tested,h.value=k.last_test,p.value&&(l.value=5)}catch(k){const C=(J=k.data)==null?void 0:J.last_test;C&&typeof C=="object"&&!Array.isArray(C)&&(h.value=C);const $=(E=h.value)==null?void 0:E.detail;ye.error(typeof $=="string"&&$.trim()?$:k.message)}}async function U(){try{await z.post("/api/hosts/candidates/"+d.value+"/commit",{}),ye.success("Host saved and published live"),a.value=!1,await x()}catch(J){ye.error(J.message)}}async function T(J){try{await z.post("/api/hosts/"+encodeURIComponent(J.alias)+"/enabled",{enabled:!J.enabled}),await x()}catch(E){ye.error(E.message)}}async function M(J){var E;if(await qt("Delete host "+J.alias+"? Dependencies will block deletion.")){n.value=[];try{await z.del("/api/hosts/"+encodeURIComponent(J.alias)),await x()}catch(k){n.value=Array.isArray((E=k.data)==null?void 0:E.pending_references)?k.data.pending_references:[],ye.error(k.message)}}}async function j(J){if(await qt("Force revoke "+J.alias+"? Remote outcomes may be unknown."))try{await z.post("/api/hosts/"+encodeURIComponent(J.alias)+"/force-revoke",{}),await x()}catch(E){ye.error(E.message)}}return je(x),{hosts:e,loading:t,error:s,pendingReferences:n,wizard:a,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:w,isLocal:N,keyInfo:c,candidate:d,observed:u,tested:p,testResult:h,fingerprintsText:m,load:x,saveSettings:b,beginAdd:A,beginEdit:S,loadKey:L,importLegacy:R,prepare:_,testConnection:D,commit:U,toggle:T,remove:M,forceRevoke:j}}},rS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=q(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=q(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function h(R){return R==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":R==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const R=await z.get("/api/tokens");s.value=R.tokens||[],n.value=R.available_hosts||[]}catch(R){t.value=R.message||"Failed to load tokens"}finally{e.value=!1}}function g(R){return!R||!R.trim()?[]:R.split(",").map(_=>_.trim()).filter(Boolean)}function w(R,_){const D=c.value.allowed_hosts;if(_&&!D.includes(R)&&D.push(R),!_){const U=D.indexOf(R);U>=0&&D.splice(U,1)}}function N(R,_){const D=d.value.allowed_hosts;if(_&&!D.includes(R)&&D.push(R),!_){const U=D.indexOf(R);U>=0&&D.splice(U,1)}}async function x(){var R;i.value=!0;try{const _=g(c.value.allowed_tools_str),D=c.value.host_mode,U=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,T={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:_.length?_:[]};U!==null&&(T.allowed_hosts=U),T.default_host=c.value.default_host||"";const M=await z.post("/api/tokens",T);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ye.success("Token created"),await m()}catch(_){ye.error(((R=_.data)==null?void 0:R.error)||_.message||"Failed to create token")}finally{i.value=!1}}function b(R){o.value=R;const _=R.allowed_hosts;let D="default";_==null?D="default":Array.isArray(_)&&_.length===0?D="none":Array.isArray(_)&&(D="select"),d.value={username:R.username||"",tier:R.tier||"admin",label:R.label||"",host_mode:D,allowed_hosts:Array.isArray(_)?[..._]:[],default_host:R.default_host||"",allowed_tools_str:(R.allowed_tools||[]).join(", ")}}async function y(){var R;if(o.value){r.value=!0;try{const _=g(d.value.allowed_tools_str),D=d.value.host_mode,U={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:_};D==="none"?U.allowed_hosts=[]:D==="select"?U.allowed_hosts=d.value.allowed_hosts:U.allowed_hosts=null,U.default_host=d.value.default_host||"",await z.put("/api/tokens/"+encodeURIComponent(o.value.user_id),U),o.value=null,ye.success("Token updated"),await m()}catch(_){ye.error(((R=_.data)==null?void 0:R.error)||_.message||"Failed to update")}finally{r.value=!1}}}async function A(R){var D;if(await qt({title:"Regenerate token",message:`Regenerate token for ${R.username||R.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const U=await z.post("/api/tokens/"+encodeURIComponent(R.user_id)+"/regenerate");l.value=U.token,ye.success("Token regenerated")}catch(U){ye.error(((D=U.data)==null?void 0:D.error)||U.message||"Failed to regenerate")}}async function S(R){var D;if(await qt({title:"Delete token",message:`Delete token for ${R.username||R.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/tokens/"+encodeURIComponent(R.user_id)),ye.success("Token deleted"),await m()}catch(U){ye.error(((D=U.data)==null?void 0:D.error)||U.message||"Failed to delete")}}async function L(){if(l.value)try{await navigator.clipboard.writeText(l.value),ye.success("Copied to clipboard")}catch{ye.error("Copy failed — select and copy manually")}}return je(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:h,toggleCreateHost:w,toggleEditHost:N,createToken:x,startEdit:b,saveEdit:y,confirmRegenerate:A,confirmDelete:S,copyToken:L}}},cS=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),dS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),uS=Object.freeze(["enabled","base_url","model","max_tokens"]),pS=Object.freeze(["enabled","model","max_tokens"]);function Xo(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function up(e){return Xo(e,cS)}function pp(e){return Xo(e,dS)}function fS(e,{includeApiKey:t=!1}={}){const s=Xo(e,uS);return t&&(s.api_key=e.api_key),s}function hS(e){return{timeout:e.timeout}}function mS(e,{includeApiKey:t=!1}={}){const s=Xo(e,pS);return t&&(s.api_key=e.api_key),s}function vS(e){return{timeout:e.timeout}}function Ml(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const gS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(!0),t=f({}),s=f([]),n=f({}),a=f({}),i=f(null),l=f(null),o=f(null),r=f(null),c=f(null),d=q(()=>{var S;return Object.values(((S=i.value)==null?void 0:S.totals)||{}).reduce((L,R)=>L+Number(R||0),0)}),u=f(""),p=f(0),h=f([]),m=q(()=>h.value.map(S=>`${S.label} (${S.path}${S.reason?`: ${S.reason}`:""})`).join("; ")),g=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let w=null;async function N(){var D;const S=await Promise.allSettled(g.map(U=>z.get(U.path))),L=U=>S[U].status==="fulfilled"?S[U].value:null;t.value=L(0)||{};const R=L(1);s.value=Array.isArray(R)?R:R&&R.subsystems||[],n.value=L(2)||{},a.value=L(3)||{},i.value=L(4),l.value=L(5),o.value=L(6),r.value=L(7),c.value=L(8);const _=S.filter(U=>U.status==="rejected");if(h.value=S.flatMap((U,T)=>{var M;return U.status==="rejected"?[{...g[T],reason:((M=U.reason)==null?void 0:M.message)||"request failed"}]:[]}),p.value=h.value.length,_.length===S.length){const U=(D=_[0])==null?void 0:D.reason;u.value=(U==null?void 0:U.message)||"Failed to load internals"}else u.value="";e.value=!1}function x(){e.value=!0,u.value="",N()}let b=!1;function y(){b||(b=!0,N(),w||(w=setInterval(N,3e4)))}function A(){b&&(b=!1,w&&(clearInterval(w),w=null))}return je(y),Qt(y),Gt(A),ft(A),{loading:e,error:u,failedCount:p,failedEndpoints:h,failedEndpointSummary:m,endpoints:g,retry:x,startup:t,subsystems:s,sshPool:n,httpPool:a,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:o,freshnessStats:r,governorStats:c,statusColor:bS,formatAgeSeconds:Uw}}},xS=1e4,hp=3e4;function ki(e,t){return Math.max(0,e-t)}function Sr(e,t){return new Set((e.operations||[]).map(n=>n.state)).has("MANUAL_RESOLUTION_REQUIRED")?0:e.expired_lease||e.status==="ACTIVE"&&(!e.lease_expires_at||e.lease_expires_at<t)?1:e.status==="SUSPENDED"?2:e.status==="ACTIVE"?3:4}const _S=[{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],wS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(null),t=f(""),s=f(null),n=f(!1),a=f(0),i=f(null),l=f(""),o=f(null),r=f(!1),c=f(0),d=f(Date.now());let u=null,p=0,h=0;async function m(){const k=++p;n.value=!0;try{const C=await z.get("/api/turn-state/turns?limit=100");if(k!==p)return;t.value=C.availability,e.value=C.availability==="available"?C.data:null,s.value=null,a.value=Date.now()}catch(C){if(k!==p)return;s.value=C.message||"Turn-state read failed",C.status===503&&(t.value="unavailable")}k===p&&(n.value=!1)}async function g(){const k=++h;r.value=!0;try{const C=await z.get("/api/turn-state/capacity-breakers");if(k!==h)return;l.value=C.availability,i.value=C.availability==="available"?C.data:null,o.value=null,c.value=Date.now()}catch(C){if(k!==h)return;o.value=C.message||"Breaker read failed",C.status===503&&(l.value="unavailable")}k===h&&(r.value=!1)}function w(){m(),g()}const N=q(()=>e.value!==null&&ki(d.value,a.value)>hp),x=q(()=>i.value!==null&&ki(d.value,c.value)>hp),b=q(()=>N.value||x.value),y=q(()=>Math.round(ki(d.value,a.value)/1e3)),A=q(()=>Math.round(ki(d.value,c.value)/1e3));function S(k){return Sr(k,d.value/1e3)}function L(k){return _S[S(k)]}const R=q(()=>{var $;const k=[...(($=e.value)==null?void 0:$.turns)||[]],C=d.value/1e3;return k.sort((W,G)=>Sr(W,C)-Sr(G,C)||(G.last_progress_at||0)-(W.last_progress_at||0))});function _(k){return k.state==="closed"?"badge-success":k.state==="probing"?"badge-warning":"badge-danger"}function D(k){if(k.state==="closed")return"—";const C=ki(d.value,c.value)/1e3,$=Math.max(0,(k.cooldown_remaining_seconds||0)-C);return $>0?`${Math.ceil($)}s`:k.state==="probing"?"probe in flight":"probe eligible"}function U(k){if(!k)return"";const C=Math.max(0,Math.round(d.value/1e3-k));if(C<90)return`${C}s ago`;const $=Math.round(C/60);return $<90?`${$}m ago`:`${Math.round($/60)}h ago`}let T=null,M=null,j=!1;function J(){j||(j=!0,w(),T=setInterval(w,xS),u=setInterval(()=>{d.value=Date.now()},1e3),M=Ye.onReconnected(w))}function E(){j&&(j=!1,T&&(clearInterval(T),T=null),u&&(clearInterval(u),u=null),M&&(M(),M=null))}return je(J),Qt(J),Gt(E),ft(E),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:N,breakersStale:x,anyStale:b,turnsAgeSeconds:y,breakersAgeSeconds:A,sortedTurns:R,priorityOf:S,priorityBadge:L,breakerBadge:_,cooldownLabel:D,ageLabel:U,fetchTurns:m,fetchBreakers:g,refreshAll:w,arm:J,disarm:E}}},kS={setup(){const e=f(""),t=f(""),s=f(!1),n=f(""),a=f(!1),i=f(!1),l=f(!1),o=f(null),r=f(!1);async function c(){a.value=!0,o.value=null,r.value=!1;try{const u=await z.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{a.value=!1}}async function d(){if(await qt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await z.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return je(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},mp=e=>JSON.parse(JSON.stringify(e)),SS=(e,t)=>JSON.stringify(e)===JSON.stringify(t),TS={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=f([]),n=f({}),a=f({}),i=f(!1),l=f(!1),o=f(!1),r=f(!1),c=f(!1),d=f(""),u=f("");let p=!1,h=0,m=null;const g=(E,k)=>p&&h===E&&z.token===k,w=E=>"computer-provisioning-"+E.key,N=E=>E===null?"Unset":E===""?"Empty":JSON.stringify(E),x=E=>{const k=a.value[E.key];return E.type==="array"?String(k||"").split(/\r?\n/).map(C=>C.trim()).filter(Boolean):["integer","number"].includes(E.type)?k===""||k==null?null:Number(k):k},b=q(()=>s.value.map(E=>({...E,value:x(E)})).filter(E=>!SS(E.value,n.value[E.key]))),y=q(()=>s.value.filter(E=>E.pending_restart).map(E=>E.label)),A=q(()=>s.value.some(E=>E.apply_state==="unknown")),S=q(()=>{const E={};for(const k of s.value){const C=x(k),$=k.constraints||{};["integer","number"].includes(k.type)&&(C===null&&!k.nullable?E[k.key]="A number is required.":C!==null&&(!Number.isFinite(C)||k.type==="integer"&&!Number.isInteger(C)||$.minimum!=null&&C<$.minimum||$.maximum!=null&&C>$.maximum)&&(E[k.key]="Enter a number within the allowed range.")),k.key==="monitor_names"&&(C.length>16||new Set(C).size!==C.length||C.some(W=>!/^[A-Za-z0-9_.-]{1,64}$/.test(W)))&&(E[k.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return E}),L=q(()=>Object.keys(S.value).length>0);function R(E,k){a.value[E.key]=k,u.value=""}function _(){a.value=Object.fromEntries(s.value.map(E=>[E.key,E.type==="array"?n.value[E.key].join(`
`):n.value[E.key]])),r.value=!1}async function D(E,k){const[C,$]=await Promise.all([z.get("/api/config"),z.get("/api/config/meta")]);if(!g(E,k))return!1;const W=($.fields||[]).filter(G=>/^computer\.[^.]+$/.test(G.path)&&G.path!=="computer.enabled"&&G.sensitivity==="public"&&G.apply_mode==="restart");if(!C.computer||!W.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=W.map(G=>({...G,key:G.path.split(".")[1]})),n.value=Object.fromEntries(s.value.map(G=>[G.key,mp(C.computer[G.key])])),_(),m=k,i.value=!0,c.value=!1,!0}async function U(){if(!p||l.value||o.value)return;const E=++h,k=z.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await D(E,k)}catch(C){g(E,k)&&(c.value=!0,d.value=C.message||"Could not load provisioning. No changes were sent.")}finally{g(E,k)&&(l.value=!1)}}function T(){i.value&&!l.value&&!o.value&&!c.value&&b.value.length&&!L.value&&(r.value=!0)}async function M(){if(!p||!i.value||!r.value||o.value||l.value||c.value||L.value||!b.value.length)return;if(m!==z.token){J(),j();return}const E={computer:Object.fromEntries(b.value.map(W=>[W.key,mp(W.value)]))},k=h,C=z.token;o.value=!0,d.value="",u.value="";let $=!1;try{if(await z.put("/api/config",E),$=!0,!g(k,C))return;await D(k,C)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(W){g(k,C)&&(c.value=!0,r.value=!1,d.value=$?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${W.status===400?": "+W.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{g(k,C)&&(o.value=!1)}}function j(){p||(p=!0,U())}function J(){p=!1,h++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,m=null,s.value=[],n.value={},a.value={},d.value="",u.value=""}return je(j),Qt(j),Gt(J),ft(J),{fields:s,original:n,draft:a,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:y,effectiveUnknown:A,changes:b,validation:S,invalid:L,fieldId:w,format:N,edit:R,discard:_,load:U,openReview:T,save:M}}},CS={components:{ComputerProvisioning:TS},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),n=f(!1),a=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(""),p=f(null),h=f(""),m=f(!1),g=f(Date.now()),w=f(""),N=f(null);let x=0,b=null,y=!1,A=z.token,S=0;const L=v=>v===!0?"Enabled":v===!1?"Disabled":"Unknown",R=q(()=>{var v;return((v=e.value.backend)==null?void 0:v.environment)==="existing_session"}),_=q(()=>{var I;const v=Date.parse(((I=e.value.accessibility)==null?void 0:I.checked_at)||"");return Number.isFinite(v)&&g.value-v<15e3&&g.value>=v-5e3}),D=q(()=>{var v;return _.value?L((v=e.value.accessibility)==null?void 0:v.enabled):"Unknown / not current"}),U=q(()=>{var v;return _.value?((v=e.value.accessibility)==null?void 0:v.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),T=q(()=>Object.entries(e.value.input_limits||{}).filter(([,v])=>typeof v=="number"&&Number.isFinite(v)).map(([v,I])=>`${v}: ${I}`).join(", ")),M=q(()=>{var I;const v=(I=e.value.application_provenance)==null?void 0:I.script_identity;return typeof v=="string"?v:!v||typeof v!="object"?"Not observed":`${v.interpreter_basename||"Unknown interpreter"}; argv digest ${v.argv_digest||"not recorded"}; ${v.verified===!0?"verified":"not verified"}`}),j=q(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(v=>v&&typeof v.id=="string"&&typeof v.label=="string"&&["supported","capture_only"].includes(v.input)).slice(0,16):[]),J=q(()=>{const v=e.value.restart_required;return Array.isArray(v)?v.length?v.join(", "):"None reported":v===!0?"Pending; restart required":v===!1?"None reported":"Unknown"}),E=q(()=>{var I,F;const v=Date.parse(((I=p.value)==null?void 0:I.captured_at)||"");return Number.isFinite(v)&&g.value<v+Math.min(1e4,((F=p.value)==null?void 0:F.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function k(){h.value&&URL.revokeObjectURL(h.value),h.value="",p.value=null}function C(){x++,k(),N.value=null,u.value="",s.value=!1,i.value=!1,l.value=!1}function $(v,I){return y&&v===x&&I===z.token}function W(v){var F,ee;C(),c.value=!1;const I=v.status||(v.name==="AuthError"?401:0);e.value={available:!1,state:I===503?"unavailable":"unknown"},o.value=I===401||I===403||I===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":I===410?"Evidence or artifact expired. Observe or prepare the export again.":I===503?"Computer use is disabled or unavailable.":"Request failed; outcome unknown. Refresh status. No action was replayed.",![401,403,404].includes(I)&&typeof((F=v.data)==null?void 0:F.code)=="string"&&/^[a-z_]{1,64}$/.test(v.data.code)&&typeof((ee=v.data)==null?void 0:ee.error)=="string"&&(o.value=v.data.error.slice(0,512))}async function G(){if(t.value||r.value||n.value||a.value||d.value||!y)return;const v=x,I=z.token;t.value=!0,S=Date.now();try{const F=await z.get("/api/computer");if(!$(v,I))return;Z(F)}catch(F){$(v,I)&&W(F)}finally{t.value=!1}}function Z(v){(e.value.session_id&&e.value.session_id!==v.session_id||e.value.generation!=null&&e.value.generation!==v.generation||e.value.session_generation!=null&&e.value.session_generation!==v.session_generation)&&C(),e.value=v,c.value=!0,o.value=""}async function oe(v){if(!y||!c.value||r.value||n.value||a.value)return;C();const I=x,F=z.token;r.value=!0;try{if(await z.post("/api/computer/enabled",{enabled:v}),!$(I,F))return;const ee=await z.get("/api/computer");$(I,F)&&Z(ee)}catch(ee){$(I,F)&&W(ee)}finally{r.value=!1}}async function se(v){C();const I=x,F=z.token,ee=v==="stop"?n:a;ee.value=!0;try{const X=await z.post("/api/computer/"+v,{});if($(I,F)){e.value={...e.value,...X};const ae=await z.get("/api/computer");$(I,F)&&Z(ae)}}catch(X){$(I,F)&&W(X)}finally{ee.value=!1}}async function ce(){return Y(!1)}async function Ne(){return Y(!0)}async function Y(v){if(!y||!c.value||d.value||e.value.state!=="quarantined")return;const I={session_id:e.value.session_id,generation:e.value.session_generation};if(!I.session_id||!Number.isInteger(I.generation))return;if(v){if(u.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+I.session_id)return;I.acknowledgment=u.value}C();const F=x,ee=z.token;d.value=!0;try{const X=await z.post(v?"/api/computer/reconcile":"/api/computer/recover",I);$(F,ee)&&Z(X)}catch(X){$(F,ee)&&W(X)}finally{d.value=!1}}async function ge(){var F;k(),m.value=!1;const v=x,I=z.token;s.value=!0;try{const ee=await z.post("/api/computer/observe",{});if(!$(v,I))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((F=ee.frame)==null?void 0:F.evidence_id)||""))throw new Error("Invalid evidence");const X=await z.getBlob("/api/computer/evidence/"+ee.frame.evidence_id);if(!$(v,I))return;if(!["image/png","image/jpeg"].includes(X.type)||X.size>2097152||!Number.isFinite(Date.parse(ee.frame.expires_at))||Date.parse(ee.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");p.value=ee.frame,h.value=URL.createObjectURL(X),o.value=""}catch(ee){$(v,I)&&W(ee)}finally{v===x&&(s.value=!1)}}async function V(){N.value=null;const v=x,I=z.token;i.value=!0;try{const F=await z.post("/api/computer/export",{name:w.value});$(v,I)&&(N.value=F,o.value="")}catch(F){$(v,I)&&W(F)}finally{v===x&&(i.value=!1)}}async function re(){const v=x,I=z.token,F=N.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((F==null?void 0:F.artifact_id)||""))throw new Error("Invalid export");const ee=await z.getBlob("/api/computer/download/"+F.artifact_id);if(!$(v,I))return;const X=URL.createObjectURL(ee),ae=document.createElement("a");ae.href=X,ae.download=F.name,ae.click(),setTimeout(()=>URL.revokeObjectURL(X),1e3)}catch(ee){$(v,I)&&W(ee)}finally{v===x&&(l.value=!1)}}function ue(){y||(y=!0,G(),b=setInterval(()=>{g.value=Date.now(),A!==z.token&&(A=z.token,C(),c.value=!1,e.value={state:"unknown",available:!1}),p.value&&Date.parse(p.value.expires_at)<=g.value&&(k(),m.value=!0),N.value&&Date.parse(N.value.expires_at)<=g.value&&(N.value=null),g.value-S>=5e3&&G()},500))}function Ie(){y=!1,clearInterval(b),b=null,C(),c.value=!1}return je(ue),Qt(ue),Gt(Ie),ft(Ie),{status:e,loading:t,observing:s,stopping:n,pausing:a,exporting:i,downloading:l,error:o,frame:p,frameUrl:h,frameExpired:m,freshness:E,name:w,artifact:N,refresh:G,control:se,observe:ge,clearFrame:k,exportFile:V,download:re,toggling:r,adminReady:c,enabledLabel:L,restartSettings:J,setEnabled:oe,recovering:d,recover:ce,reconcile:Ne,reconciliationAck:u,applicationProfiles:j,attached:R,scriptIdentity:M,inputLimits:T,accessibilityLabel:D,accessibilityDetail:U}}},lv=[{id:"health",label:"Health",component:Ok},{id:"resources",label:"Resources",component:Lk},{id:"logs",label:"Logs",component:Vk},{id:"config",label:"Config",component:sS},{id:"discord",label:"Discord",component:aS},{id:"hosts",label:"Hosts",component:oS},{id:"host-access",label:"Host Access",component:lS},{id:"api-tokens",label:"API Tokens",component:rS},{id:"llm",label:"LLM Config",component:gS},{id:"internals",label:"Internals",component:yS},{id:"turn-state",label:"Turn State",component:wS},{id:"computer",label:"Computer",component:CS},{id:"update",label:"Update",component:kS}],ES={components:{TabbedPage:Yo},setup(){return{tabs:lv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Fl=(e,t,s,n)=>n.map(({id:a,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:a}}})),AS=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Fl("Operations","operations","/operations",Ym),...Fl("History","history","/history",Qm),...Fl("Capabilities","capabilities","/capabilities",Xm),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Fl("System","system","/system",lv)],bs=ea({open:!1,query:"",selected:0});function vp(){bs.query="",bs.selected=0,bs.open=!0}function Tr(){bs.open=!1}function RS(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const IS={setup(){const e=jm(),t=f(null),s=q(()=>{const i=bs.query.trim().toLowerCase();return AS.map(l=>({...l,_score:RS(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Mt(()=>bs.open,async i=>{var l;i&&(await Rt(),(l=t.value)==null||l.focus())}),Mt(()=>bs.query,()=>{bs.selected=0});function n(i){Tr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Tr();return}if(i.key==="ArrowDown")i.preventDefault(),bs.selected=Math.min(bs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),bs.selected=Math.max(bs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[bs.selected];l&&n(l)}}return{state:bs,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Tr}},template:`
    <transition name="modal">
...
`+s.join(`
`),g=this.blockquote(m);i[i.length-1]=g,n=n.substring(0,n.length-h.raw.length)+g.raw,a=a.substring(0,a.length-h.text.length)+g.text;break}else if((p==null?void 0:p.type)==="list"){const h=p,m=h.raw+`
`+s.join(`
`),g=this.list(m);i[i.length-1]=g,n=n.substring(0,n.length-p.raw.length)+g.raw,a=a.substring(0,a.length-h.raw.length)+g.raw,s=m.substring(i.at(-1).raw.length).split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+tn(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ka=new G1;function at(e,t){return ka.parse(e,t)}at.options=at.setOptions=function(e){return ka.setOptions(e),at.defaults=ka.defaults,dv(at.defaults),at};at.getDefaults=yd;at.defaults=Ra;at.use=function(...e){return ka.use(...e),at.defaults=ka.defaults,dv(at.defaults),at};at.walkTokens=function(e,t){return ka.walkTokens(e,t)};at.parseInline=ka.parseInline;at.Parser=Tn;at.parser=Tn.parse;at.Renderer=So;at.TextRenderer=Ed;at.Lexer=Sn;at.lexer=Sn.lex;at.Tokenizer=ko;at.Hooks=Gl;at.parse=at;at.options;at.setOptions;at.use;at.walkTokens;at.parseInline;Tn.parse;Sn.lex;const K1={breaks:!0,gfm:!0};function Fp(e){if(!e)return"";try{if(typeof at<"u"&&at.parse){const t=at.parse(e,K1);return typeof Op<"u"?Op.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function W1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const J1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Z1(e){return J1[e]||"wrench"}const Y1=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function $p(e){if(!e)return[];const t=e.match(Y1);return t?[...new Set(t)]:[]}const Q1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),n=f(""),a=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=q(()=>t.value.trim().length>0&&!s.value),p=f(Ye.state||"disconnected");let h=null;const m=q(()=>{const E=p.value;return E==="connected"?"Connected":E==="reconnecting"?"Reconnecting…":E==="connecting"?"Connecting…":"REST fallback"}),g=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],w=q(()=>{const E=Math.floor(l.value/4)%g.length,k=l.value;return k>3?`${g[E]} (${k}s)`:g[0]});function N(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function x(){if(!i.value)return;const E=i.value;E.style.height="auto",E.style.height=Math.min(E.scrollHeight,120)+"px"}function b(E,k,C={}){const $={id:++c,role:E,content:k,timestamp:Date.now(),html:E==="bot"?Fp(k):"",tools_used:C.tools_used||[],is_error:C.is_error||!1,images:E==="bot"?$p(k):[],files:C.files||[],_showTools:!1};return e.value.push($),N(),E==="bot"&&Rt(()=>y()),$}function y(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(k=>{k.setAttribute("data-copy","true"),k.style.position="relative";const C=document.createElement("button");C.className="chat-code-copy",C.textContent="Copy",C.addEventListener("click",()=>{const $=k.querySelector("code"),W=$?$.textContent:k.textContent;navigator.clipboard.writeText(W).then(()=>{C.textContent="Copied!",setTimeout(()=>{C.textContent="Copy"},1500)}).catch(()=>{})}),k.appendChild(C)})}function A(E){if(E===0)return!0;const k=e.value[E-1],C=e.value[E],$=new Date(k.timestamp).toDateString(),W=new Date(C.timestamp).toDateString();return $!==W}function S(E){const k=new Date(E),C=new Date;if(k.toDateString()===C.toDateString())return"Today";const $=new Date(C);return $.setDate($.getDate()-1),k.toDateString()===$.toDateString()?"Yesterday":k.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function L(E){t.value=E,Rt(()=>j())}function R(E){window.open(E,"_blank","noopener")}function _(E){E.target.style.display="none"}function D(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function U(){r&&(clearInterval(r),r=null),l.value=0}function T(E){s.value&&(s.value=!1,U(),E.type==="chat_response"?b("bot",E.content,{tools_used:E.tools_used||[],is_error:E.is_error||!1,files:E.files||[]}):E.type==="chat_error"&&b("bot",E.error||"Unknown error",{is_error:!0}),Rt(()=>{var k;return(k=i.value)==null?void 0:k.focus()}))}async function M(E){try{const k=await z.post("/api/chat",{content:E,channel_id:o.value});b("bot",k.response,{tools_used:k.tools_used||[],is_error:k.is_error||!1,files:k.files||[]})}catch(k){b("bot",k.message||"Failed to send message",{is_error:!0})}}async function j(){const E=t.value.trim();if(!E||s.value)return;b("user",E),t.value="",s.value=!0,D(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(E,{channelId:o.value})||(await M(E),s.value=!1,U()),Rt(()=>{var C;return(C=i.value)==null?void 0:C.focus()})}async function J(){n.value="";try{if(!o.value){const k=await z.get("/api/auth/session");o.value=k.channel_id||k.user_id||"web-user"}const E=await z.get("/api/sessions/"+encodeURIComponent(o.value));if(E&&E.messages&&E.messages.length>0){for(const k of E.messages){const C=k.role==="user"?"user":"bot";let $=k.content||"";if(C==="user"){const G=$.match(/^\[.*?\]:\s*/);G&&($=$.slice(G[0].length))}if(!$.trim())continue;const W={id:++c,role:C,content:$,timestamp:k.timestamp?k.timestamp*1e3:Date.now(),html:C==="bot"?Fp($):"",tools_used:[],is_error:!1,images:C==="bot"?$p($):[],files:[],_showTools:!1};e.value.push(W)}Rt(()=>{N(),y()})}}catch(E){E&&E.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",ye.error(n.value))}}return je(()=>{Ye.subscribe("chat",T),p.value=Ye.state||"disconnected",h=Ye.onState(E=>{p.value=E}),J(),Rt(()=>{var E;return(E=i.value)==null?void 0:E.focus()})}),ft(()=>{Ye.unsubscribe("chat",T),h&&(h(),h=null),U()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:w,suggestions:d,send:j,autoResize:x,formatTime:W1,formatDate:S,showDateSeparator:A,useSuggestion:L,openImage:R,onImageError:_,getToolIcon:Z1,loadHistory:J}}},X1={setup(){const e=f("odin"),t=f(""),s=f(""),n=f(""),a=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),h=f(!1),m=q(()=>e.value==="custom"),g=q(()=>[...i.value,...l.value]),w=q(()=>l.value.includes(e.value)),N=q(()=>{var R;return m.value?t.value||"Odin":((R=a.value[e.value])==null?void 0:R.name)||e.value}),x=q(()=>{var R;return m.value?s.value||"(empty — will use Odin default)":((R=a.value[e.value])==null?void 0:R.identity)||""}),b=q(()=>{var R;return m.value?n.value||"(empty — will use Odin default)":((R=a.value[e.value])==null?void 0:R.voice)||""});async function y(){d.value=!0;try{const R=await z.get("/api/personality");e.value=R.preset||"odin",t.value=R.custom_name||"",s.value=R.custom_identity||"",n.value=R.custom_voice||"",a.value=R.presets||{},i.value=R.builtin_presets||[],l.value=R.user_presets||[]}catch(R){c.value=R.message}finally{d.value=!1}}async function A(){o.value=!0,c.value=null,r.value=!1;try{await z.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(R){c.value=R.message}finally{o.value=!1}}async function S(){const R=u.value.trim();if(R){h.value=!0,c.value=null;try{await z.post("/api/personality/presets",{name:R,display_name:N.value,identity:x.value,voice:b.value}),p.value=!1,u.value="",await y(),e.value=R.toLowerCase().replace(/ /g,"_")}catch(_){c.value=_.message}finally{h.value=!1}}}async function L(){if(await qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await z.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await y(),e.value="odin"}catch(_){c.value=_.message}}}return je(y),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:g,isCustom:m,isUserPreset:w,previewName:N,previewIdentity:x,previewVoice:b,saving:o,saved:r,error:c,loading:d,save:A,showSavePreset:p,newPresetName:u,savingPreset:h,saveAsPreset:S,deletePreset:L,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),_v=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:DS,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:Q1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:Yw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:lk,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Ek,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:X1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:ES,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/hosts",redirect:kt("/system","hosts")},{path:"/internals",redirect:kt("/system","internals")}],zi=Cw({history:aw(),routes:_v});zi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const eT={template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=f(""),s=f(null),n=f(!1),a=f(!1);async function i(){n.value=!0,s.value=null;try{z.setPersist(a.value),await z.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{n.value=!1}}return{token:t,error:s,busy:n,persist:a,login:i}}},tT={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),n=f(!1),a=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let h=null;const m=f("starting"),g=f(""),w=_v.filter($=>$.meta),N=q(()=>["Workspace","Operate","Observe","Manage"].map($=>({name:$,routes:w.filter(W=>W.meta.section===$)})).filter($=>$.routes.length)),x=q(()=>{var $;return(($=zi.currentRoute.value.meta)==null?void 0:$.label)||"Odin"}),b=q(()=>{var $;return(($=zi.currentRoute.value.meta)==null?void 0:$.section)||"Management"}),y=q(()=>{var $;return(($=zi.currentRoute.value.meta)==null?void 0:$.description)||"Management console"});function A(){Ye.disconnect(),j&&(clearInterval(j),j=null)}z.onSessionExpired=()=>{t.value=!0,A(),z.setToken(""),e.value="login"};function S($){var W;if(($.ctrlKey||$.metaKey)&&$.key.toLowerCase()==="k"){e.value==="ready"&&($.preventDefault(),vp());return}if(n.value&&$.key==="Tab"){const G=[...((W=a.value)==null?void 0:W.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(G.length){const Z=G[0],oe=G[G.length-1];if($.shiftKey&&(document.activeElement===Z||!a.value.contains(document.activeElement))){$.preventDefault(),oe.focus();return}if(!$.shiftKey&&(document.activeElement===oe||!a.value.contains(document.activeElement))){$.preventDefault(),Z.focus();return}}}if($.key==="Escape"&&n.value){n.value=!1,$.preventDefault();return}if($.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes($.target.tagName)){$.preventDefault();const G=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');G&&G.focus()}}function L(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}je(async()=>{document.addEventListener("keydown",S),o=window.matchMedia("(max-width: 900px)"),L(),o.addEventListener("change",L);const $=await z.check();$.ok?(e.value="ready",k()):$.needsAuth?e.value="login":(e.value="ready",k())});function R(){t.value=!1,e.value="ready",k()}async function _(){A(),e.value="login",await z.logout()}function D(){s.value=!s.value}function U(){n.value=!n.value}Mt(n,async $=>{var W,G;if($)r=document.activeElement,await Rt(),(G=(W=a.value)==null?void 0:W.querySelector(".nav-item"))==null||G.focus();else if(r!=null&&r.isConnected){const Z=r;r=null,requestAnimationFrame(()=>Z.focus())}});const T=q(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M($,W="info",G=3e3){p.value={text:$,level:W},clearTimeout(h),h=setTimeout(()=>{p.value=null},G)}let j=null,J=!1,E=[];function k(){for(const $ of E)$();E=[Ye.onStatus($=>{c.value=$}),Ye.onLatencyChange($=>{u.value=$}),Ye.onState(($,W)=>{d.value=$,$==="connected"?(J&&M("Connection restored","success"),J=!0):$==="reconnecting"&&W.attempt===1&&M("Connection lost — reconnecting…","warn")})],Ye.connect(),C(),j&&clearInterval(j),j=setInterval(C,15e3)}async function C(){try{const $=await z.get("/api/status");m.value=$.status==="online"?"online":"starting";const W=$.uptime_seconds||0,G=Math.floor(W/3600),Z=Math.floor(W%3600/60);g.value=`${G}h ${Z}m uptime`}catch{m.value="offline",g.value=""}}return ft(()=>{j&&clearInterval(j);for(const $ of E)$();E=[],Ye.disconnect(),document.removeEventListener("keydown",S),o==null||o.removeEventListener("change",L)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:T,wsToast:p,botStatus:m,botUptime:g,navRoutes:w,navGroups:N,currentPage:x,currentSection:b,currentDescription:y,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:R,logout:_,toggleSidebar:D,toggleMobileNavigation:U,openPalette:vp}}},ta=uo(tT);ta.component("odin-icon",OS);ta.component("login-screen",eT);ta.component("toast-container",b_);ta.component("confirm-host",y_);ta.component("command-palette",IS);ta.directive("modal-focus",NS);ta.use(zi);ta.mount("#app");
