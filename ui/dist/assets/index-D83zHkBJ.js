...
`).length:0}function L(j){return w1(j)}function w(j){a.value={...a.value,[j]:!a.value[j]}}async function I(j){try{await navigator.clipboard.writeText(j);const ye=e.value.find(Oe=>Oe.code===j);ye&&(o.value=ye.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function K(j){if(j.key==="Tab"){j.preventDefault();const ye=j.target,Oe=ye.selectionStart,ne=ye.selectionEnd;u.value=u.value.substring(0,Oe)+"    "+u.value.substring(ne),zt(()=>{ye.selectionStart=ye.selectionEnd=Oe+4})}}function G(j){const ye=j.target.previousElementSibling;ye&&(ye.scrollTop=j.target.scrollTop)}async function M(){t.value=!0,s.value=null;try{e.value=await z.get("/api/skills")}catch(j){s.value=j.message}t.value=!1}async function O(j){i.value=j,delete n.value[j],n.value={...n.value};try{const ye=await z.post(`/api/skills/${encodeURIComponent(j)}/test`);n.value={...n.value,[j]:ye}}catch(ye){n.value={...n.value,[j]:{result:ye.message,is_error:!0}}}i.value=null}function $(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,m.value=null}function re(j){r.value=!0,c.value="edit",d.value=j.name,u.value=j.code||"",p.value=null,m.value=null}function ce(){r.value=!1,p.value=null,m.value=null}async function Z(){p.value=null,m.value=null;const j=d.value.trim(),ye=u.value.trim();if(!j){p.value="Name is required";return}if(!ye){p.value="Code is required";return}h.value=!0;try{c.value==="create"?(await z.post("/api/skills",{name:j,code:ye}),m.value="Skill created successfully"):(await z.put(`/api/skills/${encodeURIComponent(j)}`,{code:ye}),m.value="Skill updated successfully"),await M(),setTimeout(()=>{r.value=!1},800)}catch(Oe){p.value=Oe.message}h.value=!1}function J(j){R.value=j}async function se(){if(R.value){k.value=!0;try{await z.del(`/api/skills/${encodeURIComponent(R.value)}`),await M()}catch(j){ke.error(`Failed to delete skill: ${j.message||"unknown error"}`)}k.value=!1,R.value=null}}return tt(()=>{M()}),{skills:e,loading:t,error:s,showCode:a,testResults:n,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:m,saving:h,editorRef:y,deleteTarget:R,deleting:k,enabledCount:b,totalExecutions:g,totalLines:x,displayedSkills:S,editLineCount:_,editorLineNums:E,editValidation:N,highlight:A,truncate:Lu,formatTs:ni,countLines:P,getLineNumbers:L,toggleCode:w,copyCode:I,handleEditorKey:K,syncScroll:G,fetchSkills:M,testSkill:O,showCreate:$,editSkill:re,cancelEdit:ce,saveSkill:Z,confirmDelete:J,doDelete:se}}};class ta extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const S1=/^[A-Za-z_][A-Za-z0-9_]*$/;function Lf(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Nf(e,t,s){const a={},n=[...new Set((t||[]).map(l=>String(l)))],i=new Set(n);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new ta(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new ta(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(a,o))throw new ta(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new ta(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");a[o]=r}}return{set:a,remove:n}}function C1(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function T1(e,{mode:t="add",originalTransport:s=""}={}){const a=t==="add",n=String(e.name||"").trim();if(!n)throw new ta("Server name is required.","name");if(n.length>128||!S1.test(n))throw new ta("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!a&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(a&&(o.name=n),i==="stdio"){const d=String(e.command||"").trim();if((a||l)&&!d)throw new ta("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(a||e.replaceArgs)&&(o.args=Lf(e.argsText)),a||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new ta("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((a||l)&&!d)throw new ta("An HTTP endpoint is required for this connection.","url");if(d&&!C1(d))throw new ta("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(a||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new ta("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(a||e.replaceAllowlist)&&(o.tool_allowlist=Lf(e.allowlistText));const r=Nf(e.headerRows,e.headersRemove,"Header"),c=Nf(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function E1(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function A1(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function R1(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(a=>String(a).toLowerCase().includes(s)):!0}const I1=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function O1(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(a=>(a=window.matchMedia)==null?void 0:a.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const n=t.querySelector(".mcp-editor-groups"),i=n==null?void 0:n.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const L1=1e4,N1=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function Mc(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function M1(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const D1={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),a=f(!1),n=f(""),i=f({max_published_tools_per_server:"",max_published_tools_global:""}),l=f(new Set),o=H(()=>Object.keys(i.value).every(Y=>{var Ee;return Number.isInteger((Ee=e.value)==null?void 0:Ee[Y])})),r=f(""),c=f(new Set),d=f(new Set),u=f({}),p=f({}),m=f({}),h=f(new Set),y=f(!1),R=f("add"),k=f(""),b=f(null),g=f(Mc()),x=f(""),S=f(!1);let _=null,E=0,N=!1,A=!1;const P=I1,L=H(()=>{var Y;return((Y=e.value)==null?void 0:Y.servers)||[]}),w=H(()=>{var Y;return!!((Y=e.value)!=null&&Y.enabled)}),I=H(()=>{var Y,Ee,Ae,Me;return{serverCount:((Y=e.value)==null?void 0:Y.server_count)||0,enabledCount:((Ee=e.value)==null?void 0:Ee.enabled_server_count)||0,connectedCount:((Ae=e.value)==null?void 0:Ae.connected_count)||0,toolCount:((Me=e.value)==null?void 0:Me.published_tool_count)||0}}),K=H(()=>{var Y;return((Y=b.value)==null?void 0:Y.header_keys)||[]}),G=H(()=>{var Y;return((Y=b.value)==null?void 0:Y.env_keys)||[]}),M=H(()=>{var Y;return R.value==="edit"&&((Y=b.value)==null?void 0:Y.transport)==="http"}),O=H(()=>R.value==="add"||!M.value),$=H(()=>M.value?"Replace endpoint URL":"Endpoint URL"),re=H(()=>M.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function ce(){Z(),_=window.setInterval(()=>J({quiet:!0}),L1)}function Z(){_&&window.clearInterval(_),_=null}async function J({quiet:Y=!1}={}){if(a.value)return;const Ee=++E;Y||(t.value=!0);try{const Ae=await z.get("/api/mcp/status");if(Ee!==E||!N)return;e.value=Ae;for(const ee of Object.keys(i.value))!l.value.has(ee)&&Number.isInteger(Ae[ee])&&(i.value[ee]=String(Ae[ee]));r.value="";const Me=new Set((Ae.servers||[]).map(ee=>ee.name));d.value=new Set([...d.value].filter(ee=>Me.has(ee)))}catch(Ae){Ee===E&&N&&(r.value=Ae.message||"Failed to load MCP status")}finally{Ee===E&&(t.value=!1)}}function se(Y){return s.value||c.value.has(Y)}function j(Y,Ee){const Ae=new Set(c.value);Ee?Ae.add(Y):Ae.delete(Y),c.value=Ae}function ye(Y){return A1(Y.state)}function Oe(Y){if(ye(Y)==="disabled"){if(!Y.enabled)return"Disabled — server switch off";if(!w.value)return"Disabled — global MCP is off"}return N1[ye(Y)]}function ne(Y){return Y.transport==="http"?"Streamable HTTP":"stdio"}function ie(Y){return Y.negotiated_version?`${Y.era?`${String(Y.era).charAt(0).toUpperCase()}${String(Y.era).slice(1)}`:"Protocol"} · ${Y.negotiated_version}`:"Not negotiated"}function ve(Y){return Y.discovered_count?`${Y.published_count||0} published · ${Y.excluded_count||0} excluded`:"No tools discovered"}const be=f(new Set);async function ge(Y,Ee){if(be.value.has(Y.name))return;const Ae=!!Ee.target.checked,Me=new Set(be.value);Me.add(Y.name),be.value=Me;try{const ee=await z.post(`/api/mcp/servers/${encodeURIComponent(Y.name)}/enabled`,{enabled:Ae});ee&&Array.isArray(ee.servers)?e.value=ee:await J({quiet:!0})}catch(ee){Ee.target.checked=!!Y.enabled,ke.error(ee.message||`Failed to toggle ${Y.name}`)}finally{const ee=new Set(be.value);ee.delete(Y.name),be.value=ee}}function Ne(Y,Ee){var Me;i.value[Y]=Ee;const Ae=new Set(l.value);Ee===String((Me=e.value)==null?void 0:Me[Y])?Ae.delete(Y):Ae.add(Y),l.value=Ae,n.value=""}async function T(){if(s.value||!o.value||!l.value.size)return;const Y={};for(const Ee of l.value){const Ae=Number(i.value[Ee]),Me=Ee==="max_published_tools_per_server"?128:256;if(!Number.isInteger(Ae)||Ae<1||Ae>Me){n.value=`Enter a whole number between 1 and ${Me}.`;return}Y[Ee]=Ae}a.value=!0,s.value=!0,n.value="",++E,t.value=!1;try{const Ee=await z.post("/api/mcp/limits",Y);e.value=Ee;for(const Ae of Object.keys(i.value))Number.isInteger(Ee[Ae])&&(i.value[Ae]=String(Ee[Ae]));l.value=new Set,ke.success("MCP limits saved. Applied at the next publication or tools refresh.")}catch(Ee){n.value=Ee.message||"Failed to save MCP publication limits"}finally{a.value=!1,s.value=!1,await J({quiet:!0})}}async function F(Y){if(Y!==w.value&&!(!Y&&!await os({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await z.post("/api/mcp/enabled",{enabled:Y}),ke.success(Y?"MCP enabled":"MCP disabled"),await J({quiet:!0})}catch(Ee){ke.error(Ee.message||"Failed to update MCP state"),await J({quiet:!0})}finally{s.value=!1}}}async function W(Y){j(Y.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent(Y.name)}/reconnect`,{}),ke.success(`Reconnected ${Y.name}`)}catch(Ee){ke.error(Ee.message||`Failed to reconnect ${Y.name}`)}finally{j(Y.name,!1),await J({quiet:!0})}}async function me(Y){j(Y.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent(Y.name)}/refresh-tools`,{}),ke.success(`Refreshed tools from ${Y.name}`),await _e(Y.name,!0)}catch(Ee){ke.error(Ee.message||`Failed to refresh ${Y.name}`)}finally{j(Y.name,!1),await J({quiet:!0})}}async function de(Y){if(await os({title:`Remove ${Y.name}`,message:`Remove this saved MCP server? Its ${Y.published_count||0} published tool${Y.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){j(Y.name,!0);try{await z.del(`/api/mcp/servers/${encodeURIComponent(Y.name)}`),ke.success(`Removed ${Y.name}`),delete p.value[Y.name]}catch(Ae){ke.error(Ae.message||`Failed to remove ${Y.name}`)}finally{j(Y.name,!1),await J({quiet:!0})}}}async function fe(Y){const Ee=new Set(d.value);if(Ee.has(Y.name)){Ee.delete(Y.name),d.value=Ee;return}Ee.add(Y.name),d.value=Ee,Object.hasOwn(p.value,Y.name)||await _e(Y.name)}async function _e(Y,Ee=!1){if(!Ee&&Object.hasOwn(p.value,Y))return;const Ae=new Set(h.value);Ae.add(Y),h.value=Ae,m.value={...m.value,[Y]:""};try{const Me=await z.get(`/api/mcp/servers/${encodeURIComponent(Y)}/tools`);p.value={...p.value,[Y]:Me.tools||[]}}catch(Me){m.value={...m.value,[Y]:Me.message||"Failed to load tools"}}finally{const Me=new Set(h.value);Me.delete(Y),h.value=Me}}function V(Y){return(p.value[Y]||[]).filter(Ee=>R1(Ee,u.value[Y]))}function te(Y,Ee){u.value={...u.value,[Y]:Ee}}function X(){R.value="add",k.value="",b.value=null,g.value=Mc(),x.value="",y.value=!0}function xe(Y){R.value="edit",k.value=Y.name,b.value=Y,g.value={...Mc(),name:Y.name,enabled:!!Y.enabled,transport:Y.transport||"stdio"},x.value="",y.value=!0}function U(){S.value||(y.value=!1)}function ue(Y){y.value&&O1(Y)}function oe(Y){const Ee=Y==="headers"?"headerRows":"envRows";g.value[Ee].push({key:"",value:""})}function he(Y,Ee){const Ae=Y==="headers"?"headerRows":"envRows";g.value[Ae].splice(Ee,1)}function Fe(Y,Ee){const Ae=Y==="headers"?"headersRemove":"envRemove",Me=g.value[Ae];g.value[Ae]=Me.includes(Ee)?Me.filter(ee=>ee!==Ee):[...Me,Ee]}async function qe(){var Ee,Ae;x.value="";let Y;try{Y=T1(g.value,{mode:R.value,originalTransport:((Ee=b.value)==null?void 0:Ee.transport)||""})}catch(Me){x.value=Me instanceof ta?Me.message:"Invalid MCP server configuration",await zt(),(Ae=document.querySelector(".mcp-editor"))==null||Ae.scrollTo({top:0,behavior:"smooth"});return}if(!(R.value==="edit"&&E1(Y,b.value)&&!await os({title:`Change ${k.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){S.value=!0;try{R.value==="add"?await z.post("/api/mcp/servers",Y):await z.put(`/api/mcp/servers/${encodeURIComponent(k.value)}`,Y),ke.success(R.value==="add"?`Saved ${Y.name}`:`Updated ${k.value}`),y.value=!1,await J({quiet:!0})}catch(Me){x.value=Me.message||"Failed to save MCP server"}finally{S.value=!1}}}let $e=null;function Ke(Y){`${(Y==null?void 0:Y.event)||""} ${(Y==null?void 0:Y.type)||""} ${(Y==null?void 0:Y.tool)||""} ${(Y==null?void 0:Y.message)||""}`.toLowerCase().includes("mcp")&&($e&&window.clearTimeout($e),$e=window.setTimeout(()=>J({quiet:!0}),200))}function at(){N||(N=!0,A||(ut.subscribe("events",Ke),A=!0),J(),ce())}function Xe(){N=!1,Z(),$e&&window.clearTimeout($e),$e=null,A&&(ut.unsubscribe("events",Ke),A=!1)}return tt(at),rs(at),Kt(Xe),xt(Xe),{status:e,loading:t,mutating:s,pageError:r,servers:L,masterEnabled:w,aggregate:I,limitsSaving:a,limitsError:n,limitsAvailable:o,limitDraft:i,limitDirty:l,editLimit:Ne,saveLimits:T,expandedServers:d,toolQueries:u,toolErrors:m,toolsLoading:h,editorOpen:y,editorMode:R,editingName:k,editingServer:b,form:g,formError:x,saving:S,editorGroups:P,configuredHeaderKeys:K,configuredEnvKeys:G,savedHttpEndpoint:M,endpointRequired:O,endpointFieldLabel:$,endpointPlaceholder:re,refreshAll:J,busy:se,serverState:ye,stateLabel:Oe,transportLabel:ne,protocolLabel:ie,toolSummary:ve,formatAge:M1,setMasterEnabled:F,togglePending:be,toggleServerEnabled:ge,reconnect:W,refreshTools:me,removeServer:de,toggleTools:fe,filteredTools:V,setToolQuery:te,openAdd:X,openEdit:xe,closeEditor:U,jumpToEditorGroup:ue,addSecretRow:oe,removeSecretRow:he,toggleSecretRemoval:Fe,saveServer:qe}}};function P1(e,t){if(!e||!t)return Tf(e);const s=Tf(e),a=t.trim().split(/\s+/).filter(Boolean);if(!a.length)return s;const n=a.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${n})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const $1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
