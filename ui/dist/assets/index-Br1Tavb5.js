...
... (truncated)`:s}function fd(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Kh(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function R_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const I_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=te(()=>{const M=e.value.uptime_seconds||0,Y=Math.floor(M/86400),B=Math.floor(M%86400/3600),N=Math.floor(M%3600/60),L=[];return Y>0&&L.push(`${Y}d`),B>0&&L.push(`${B}h`),(L.length===0||Y===0&&B===0)&&L.push(`${N}m`),L.join(" ")}),p=te(()=>{const M=e.value.uptime_seconds||0;return 125.66*(1-Math.min(M/86400,1))}),m=te(()=>{const M=e.value;return[{label:"Guilds",value:M.guild_count??0,icon:"⌂",iconColor:"text-blue-400"},{label:"Sessions",value:M.session_count??0,icon:"☰",iconColor:"text-yellow-400"},{label:"Tools",value:M.tool_count??0,icon:"⚒",iconColor:"text-purple-400",sub:`${M.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:M.loop_count??0,icon:"⟳",iconColor:"text-green-400",color:M.loop_count>0?"text-green-400":"",highlight:M.loop_count>0},{label:"Agents",value:M.agent_running??0,icon:"⚓",iconColor:"text-cyan-400",sub:M.agent_count>0?`${M.agent_count} total`:"",subColor:"text-gray-500",highlight:(M.agent_running??0)>0},{label:"Processes",value:M.process_running??0,icon:"⚙",iconColor:"text-orange-400",sub:M.process_count>0?`${M.process_count} total`:"",subColor:"text-gray-500",highlight:(M.process_running??0)>0},{label:"Schedules",value:M.schedule_count??0,icon:"⏰",iconColor:"text-amber-400"},{label:"Users",value:M.user_count??0,icon:"☺",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"≡",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[],{label:"Alerts",value:M.monitoring&&M.monitoring.active_alerts||0,icon:"⚑",iconColor:"text-red-400",color:M.monitoring&&M.monitoring.active_alerts>0?"text-red-400":"",highlight:M.monitoring&&M.monitoring.active_alerts>0}]}),g=te(()=>{const M=e.value,Y=[];Y.push({label:"Bot",status:M.status==="online"?"ok":"warn",detail:M.status==="online"?"Online":"Starting"});const B=M.monitoring||{};if(B.enabled){const N=B.active_alerts>0;Y.push({label:"Monitoring",status:N?"error":"ok",detail:N?`${B.active_alerts} alert${B.active_alerts>1?"s":""}`:`${B.checks} checks`})}return(M.loop_count||0)>0&&Y.push({label:"Loops",status:"ok",detail:`${M.loop_count} active`}),(M.agent_running||0)>0&&Y.push({label:"Agents",status:"ok",detail:`${M.agent_running} running`}),(M.process_running||0)>0&&Y.push({label:"Processes",status:"ok",detail:`${M.process_running} running`}),Y});async function k(){try{e.value=await K.get("/api/status"),s.value=null}catch(M){s.value=M.message}finally{t.value=!1}}async function E(){a.value=!0;try{n.value=await K.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function v(){l.value=!0;try{i.value=await K.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function b(){try{const M=await K.get("/api/knowledge");c.value=(Array.isArray(M)?M:[]).reduce((Y,B)=>Y+(B.chunks||0),0)}catch{c.value=null}}async function x(){try{const M=await K.get("/api/agents");r.value=M.filter(Y=>Y.status==="running")}catch{}}async function A(){u.value={...u.value,reload:!0};try{await K.post("/api/reload"),xe.success("Config reloaded")}catch(M){xe.error(M.message)}u.value={...u.value,reload:!1}}async function S(){if(!await ns({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const Y=e.value.session_count;e.value={...e.value,session_count:0};try{const B=await K.post("/api/sessions/clear-all");xe.success(`Cleared ${B.count} session${B.count!==1?"s":""}`),await k()}catch(B){e.value={...e.value,session_count:Y},xe.error(B.message)}u.value={...u.value,clearSessions:!1}}async function I(){if(!await ns({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const Y=e.value.loop_count;e.value={...e.value,loop_count:0};try{const B=await K.post("/api/loops/stop-all");xe.success(B.result),await k()}catch(B){e.value={...e.value,loop_count:Y},xe.error(B.message)}u.value={...u.value,stopLoops:!1}}function w(){t.value=!0,s.value=null,k(),E(),v(),x()}let T=null,D=null,V=null;function F(M){if(M.payload&&M.payload.tool_name){const Y={...M.payload,_isNew:!0,_key:++d};n.value.unshift(Y),n.value.length>10&&n.value.pop(),o.value++,Y.error&&(i.value.unshift(Y),i.value.length>5&&i.value.pop()),setTimeout(()=>{Y._isNew=!1},1500),clearTimeout(V),V=setTimeout(()=>{o.value=0},1e4)}}return $e(async()=>{await Promise.all([k(),E(),v(),x(),b()]),T=setInterval(k,15e3),D=setInterval(x,1e4),qe.subscribe("events",F)}),ft(()=>{T&&clearInterval(T),D&&clearInterval(D),clearTimeout(V),qe.unsubscribe("events",F)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:m,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:E,fetchStatus:k,formatTime:yc,formatDuration:_a,retry:w,reloadConfig:A,clearSessions:S,stopAllLoops:I}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function pd(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function N_(e){if(Array.isArray(e))return e}function D_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function O_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function L_(e,t){return N_(e)||D_(e,t)||P_(e,t)||O_()}function P_(e,t){if(e){if(typeof e=="string")return pd(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?pd(e,t):void 0}}const Wh=Object.entries,hd=Object.setPrototypeOf,M_=Object.isFrozen,F_=Object.getPrototypeOf,$_=Object.getOwnPropertyDescriptor;let zt=Object.freeze,ps=Object.seal,Zn=Object.create,Jh=typeof Reflect<"u"&&Reflect,go=Jh.apply,mo=Jh.construct;zt||(zt=function(t){return t});ps||(ps=function(t){return t});go||(go=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});mo||(mo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Ls=mt(Array.prototype.forEach),B_=mt(Array.prototype.lastIndexOf),gd=mt(Array.prototype.pop),Wn=mt(Array.prototype.push),U_=mt(Array.prototype.splice),Ut=Array.isArray,Va=mt(String.prototype.toLowerCase),Ir=mt(String.prototype.toString),md=mt(String.prototype.match),Jn=mt(String.prototype.replace),vd=mt(String.prototype.indexOf),H_=mt(String.prototype.trim),j_=mt(Number.prototype.toString),V_=mt(Boolean.prototype.toString),bd=typeof BigInt>"u"?null:mt(BigInt.prototype.toString),yd=typeof Symbol>"u"?null:mt(Symbol.prototype.toString),lt=mt(Object.prototype.hasOwnProperty),Ma=mt(Object.prototype.toString),Tt=mt(RegExp.prototype.test),xn=q_(TypeError);function mt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return go(e,t,n)}}function q_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return mo(e,s)}}function Re(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Va;if(hd&&hd(e,null),!Ut(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(M_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function z_(e){for(let t=0;t<e.length;t++)lt(e,t)||(e[t]=null);return e}function Ot(e){const t=Zn(null);for(const n of Wh(e)){var s=L_(n,2);const a=s[0],i=s[1];lt(e,a)&&(Ut(i)?t[a]=z_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Ot(i):t[a]=i)}return t}function G_(e){switch(typeof e){case"string":return e;case"number":return j_(e);case"boolean":return V_(e);case"bigint":return bd?bd(e):"0";case"symbol":return yd?yd(e):"Symbol()";case"undefined":return Ma(e);case"function":case"object":{if(e===null)return Ma(e);const t=e,s=ks(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Ma(n)}return Ma(e)}default:return Ma(e)}}function ks(e,t){for(;e!==null;){const n=$_(e,t);if(n){if(n.get)return mt(n.get);if(typeof n.value=="function")return mt(n.value)}e=F_(e)}function s(){return null}return s}function K_(e){try{return Tt(e,""),!0}catch{return!1}}const xd=zt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Nr=zt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Dr=zt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),W_=zt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Or=zt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),J_=zt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),_d=zt(["#text"]),kd=zt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Lr=zt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),wd=zt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),qi=zt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Y_=ps(/{{[\w\W]*|^[\w\W]*}}/g),Q_=ps(/<%[\w\W]*|^[\w\W]*%>/g),X_=ps(/\${[\w\W]*/g),Z_=ps(/^data-[\-\w.\u00B7-\uFFFF]+$/),ek=ps(/^aria-[\-\w]+$/),Sd=ps(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),tk=ps(/^(?:\w+script|data):/i),sk=ps(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),nk=ps(/^html$/i),ak=ps(/^[a-z][.\w]*(-[.\w]+)+$/i),xs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},ik=function(){return typeof window>"u"?null:window},lk=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Td=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Yh(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:ik();const t=fe=>Yh(fe);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==xs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=ks(f,"cloneNode"),m=ks(f,"remove"),g=ks(f,"nextSibling"),k=ks(f,"childNodes"),E=ks(f,"parentNode"),v=ks(f,"shadowRoot"),b=ks(f,"attributes"),x=l&&l.prototype?ks(l.prototype,"nodeType"):null,A=l&&l.prototype?ks(l.prototype,"nodeName"):null;if(typeof i=="function"){const fe=s.createElement("template");fe.content&&fe.content.ownerDocument&&(s=fe.content.ownerDocument)}let S,I="",w,T=!1,D=0;const V=function(){if(D>0)throw xn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},F=function(_){V(),D++;try{return S.createHTML(_)}finally{D--}},M=function(_){V(),D++;try{return S.createScriptURL(_)}finally{D--}},Y=function(){return T||(w=lk(d,a),T=!0),w},B=s,N=B.implementation,L=B.createNodeIterator,O=B.createDocumentFragment,q=B.getElementsByTagName,ve=n.importNode;let me=Td();t.isSupported=typeof Wh=="function"&&typeof E=="function"&&N&&N.createHTMLDocument!==void 0;const ie=Y_,he=Q_,X=X_,ue=Z_,Ie=ek,z=tk,re=sk,le=ak;let pe=Sd,ge=null;const Le=Re({},[...xd,...Nr,...Dr,...Or,..._d]);let y=null;const C=Re({},[...kd,...Lr,...wd,...qi]);let P=Object.seal(Zn(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),W=null,R=null;const $=Object.seal(Zn(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let J=!0,Z=!0,se=!1,Q=!0,U=!1,ee=!0,oe=!1,be=!1,Te=!1,Ae=!1,H=!1,ce=!1,ye=!0,Me=!1;const Je="user-content-";let Ke=!0,St=!1,st={},Ye=null;const en=Re({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let mn=null;const Ai=Re({},["audio","video","img","source","image","track"]);let Ea=null;const Ri=Re({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Hn="http://www.w3.org/1998/Math/MathML",jn="http://www.w3.org/2000/svg",Gt="http://www.w3.org/1999/xhtml";let j=Gt,ne=!1,_e=null;const Qe=Re({},[Hn,jn,Gt],Ir);let nt=Re({},["mi","mo","mn","ms","mtext"]),Nt=Re({},["annotation-xml"]);const lr=Re({},["title","style","font","a","script"]);let Aa=null;const dg=["application/xhtml+xml","text/html"],fg="text/html";let it=null,Vn=null;const pg=s.createElement("form"),Ic=function(_){return _ instanceof RegExp||_ instanceof Function},rr=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Vn&&Vn===_)return;(!_||typeof _!="object")&&(_={}),_=Ot(_),Aa=dg.indexOf(_.PARSER_MEDIA_TYPE)===-1?fg:_.PARSER_MEDIA_TYPE,it=Aa==="application/xhtml+xml"?Ir:Va,ge=lt(_,"ALLOWED_TAGS")&&Ut(_.ALLOWED_TAGS)?Re({},_.ALLOWED_TAGS,it):Le,y=lt(_,"ALLOWED_ATTR")&&Ut(_.ALLOWED_ATTR)?Re({},_.ALLOWED_ATTR,it):C,_e=lt(_,"ALLOWED_NAMESPACES")&&Ut(_.ALLOWED_NAMESPACES)?Re({},_.ALLOWED_NAMESPACES,Ir):Qe,Ea=lt(_,"ADD_URI_SAFE_ATTR")&&Ut(_.ADD_URI_SAFE_ATTR)?Re(Ot(Ri),_.ADD_URI_SAFE_ATTR,it):Ri,mn=lt(_,"ADD_DATA_URI_TAGS")&&Ut(_.ADD_DATA_URI_TAGS)?Re(Ot(Ai),_.ADD_DATA_URI_TAGS,it):Ai,Ye=lt(_,"FORBID_CONTENTS")&&Ut(_.FORBID_CONTENTS)?Re({},_.FORBID_CONTENTS,it):en,W=lt(_,"FORBID_TAGS")&&Ut(_.FORBID_TAGS)?Re({},_.FORBID_TAGS,it):Ot({}),R=lt(_,"FORBID_ATTR")&&Ut(_.FORBID_ATTR)?Re({},_.FORBID_ATTR,it):Ot({}),st=lt(_,"USE_PROFILES")?_.USE_PROFILES&&typeof _.USE_PROFILES=="object"?Ot(_.USE_PROFILES):_.USE_PROFILES:!1,J=_.ALLOW_ARIA_ATTR!==!1,Z=_.ALLOW_DATA_ATTR!==!1,se=_.ALLOW_UNKNOWN_PROTOCOLS||!1,Q=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,U=_.SAFE_FOR_TEMPLATES||!1,ee=_.SAFE_FOR_XML!==!1,oe=_.WHOLE_DOCUMENT||!1,Ae=_.RETURN_DOM||!1,H=_.RETURN_DOM_FRAGMENT||!1,ce=_.RETURN_TRUSTED_TYPE||!1,Te=_.FORCE_BODY||!1,ye=_.SANITIZE_DOM!==!1,Me=_.SANITIZE_NAMED_PROPS||!1,Ke=_.KEEP_CONTENT!==!1,St=_.IN_PLACE||!1,pe=K_(_.ALLOWED_URI_REGEXP)?_.ALLOWED_URI_REGEXP:Sd,j=typeof _.NAMESPACE=="string"?_.NAMESPACE:Gt,nt=lt(_,"MATHML_TEXT_INTEGRATION_POINTS")&&_.MATHML_TEXT_INTEGRATION_POINTS&&typeof _.MATHML_TEXT_INTEGRATION_POINTS=="object"?Ot(_.MATHML_TEXT_INTEGRATION_POINTS):Re({},["mi","mo","mn","ms","mtext"]),Nt=lt(_,"HTML_INTEGRATION_POINTS")&&_.HTML_INTEGRATION_POINTS&&typeof _.HTML_INTEGRATION_POINTS=="object"?Ot(_.HTML_INTEGRATION_POINTS):Re({},["annotation-xml"]);const G=lt(_,"CUSTOM_ELEMENT_HANDLING")&&_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING=="object"?Ot(_.CUSTOM_ELEMENT_HANDLING):Zn(null);if(P=Zn(null),lt(G,"tagNameCheck")&&Ic(G.tagNameCheck)&&(P.tagNameCheck=G.tagNameCheck),lt(G,"attributeNameCheck")&&Ic(G.attributeNameCheck)&&(P.attributeNameCheck=G.attributeNameCheck),lt(G,"allowCustomizedBuiltInElements")&&typeof G.allowCustomizedBuiltInElements=="boolean"&&(P.allowCustomizedBuiltInElements=G.allowCustomizedBuiltInElements),U&&(Z=!1),H&&(Ae=!0),st&&(ge=Re({},_d),y=Zn(null),st.html===!0&&(Re(ge,xd),Re(y,kd)),st.svg===!0&&(Re(ge,Nr),Re(y,Lr),Re(y,qi)),st.svgFilters===!0&&(Re(ge,Dr),Re(y,Lr),Re(y,qi)),st.mathMl===!0&&(Re(ge,Or),Re(y,wd),Re(y,qi))),$.tagCheck=null,$.attributeCheck=null,lt(_,"ADD_TAGS")&&(typeof _.ADD_TAGS=="function"?$.tagCheck=_.ADD_TAGS:Ut(_.ADD_TAGS)&&(ge===Le&&(ge=Ot(ge)),Re(ge,_.ADD_TAGS,it))),lt(_,"ADD_ATTR")&&(typeof _.ADD_ATTR=="function"?$.attributeCheck=_.ADD_ATTR:Ut(_.ADD_ATTR)&&(y===C&&(y=Ot(y)),Re(y,_.ADD_ATTR,it))),lt(_,"ADD_URI_SAFE_ATTR")&&Ut(_.ADD_URI_SAFE_ATTR)&&Re(Ea,_.ADD_URI_SAFE_ATTR,it),lt(_,"FORBID_CONTENTS")&&Ut(_.FORBID_CONTENTS)&&(Ye===en&&(Ye=Ot(Ye)),Re(Ye,_.FORBID_CONTENTS,it)),lt(_,"ADD_FORBID_CONTENTS")&&Ut(_.ADD_FORBID_CONTENTS)&&(Ye===en&&(Ye=Ot(Ye)),Re(Ye,_.ADD_FORBID_CONTENTS,it)),Ke&&(ge["#text"]=!0),oe&&Re(ge,["html","head","body"]),ge.table&&(Re(ge,["tbody"]),delete W.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw xn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw xn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ae=S;S=_.TRUSTED_TYPES_POLICY;try{I=F("")}catch(we){throw S=ae,we}}else _.TRUSTED_TYPES_POLICY===null?(S=void 0,I=""):(S===void 0&&(S=Y()),S&&typeof I=="string"&&(I=F("")));(me.uponSanitizeElement.length>0||me.uponSanitizeAttribute.length>0)&&ge===Le&&(ge=Ot(ge)),me.uponSanitizeAttribute.length>0&&y===C&&(y=Ot(y)),zt&&zt(_),Vn=_},Nc=Re({},[...Nr,...Dr,...W_]),Dc=Re({},[...Or,...J_]),hg=function(_){let G=E(_);(!G||!G.tagName)&&(G={namespaceURI:j,tagName:"template"});const ae=Va(_.tagName),we=Va(G.tagName);return _e[_.namespaceURI]?_.namespaceURI===jn?G.namespaceURI===Gt?ae==="svg":G.namespaceURI===Hn?ae==="svg"&&(we==="annotation-xml"||nt[we]):!!Nc[ae]:_.namespaceURI===Hn?G.namespaceURI===Gt?ae==="math":G.namespaceURI===jn?ae==="math"&&Nt[we]:!!Dc[ae]:_.namespaceURI===Gt?G.namespaceURI===jn&&!Nt[we]||G.namespaceURI===Hn&&!nt[we]?!1:!Dc[ae]&&(lr[ae]||!Nc[ae]):!!(Aa==="application/xhtml+xml"&&_e[_.namespaceURI]):!1},hs=function(_){Wn(t.removed,{element:_});try{E(_).removeChild(_)}catch{if(m(_),!E(_))throw xn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Oc=function(_){const G=k?k(_):_.childNodes;if(G){const we=[];Ls(G,Ce=>{Wn(we,Ce)}),Ls(we,Ce=>{try{m(Ce)}catch{}})}const ae=b?b(_):null;if(ae)for(let we=ae.length-1;we>=0;--we){const Ce=ae[we],Ne=Ce&&Ce.name;if(typeof Ne=="string")try{_.removeAttribute(Ne)}catch{}}},vn=function(_,G){try{Wn(t.removed,{attribute:G.getAttributeNode(_),from:G})}catch{Wn(t.removed,{attribute:null,from:G})}if(G.removeAttribute(_),_==="is")if(Ae||H)try{hs(G)}catch{}else try{G.setAttribute(_,"")}catch{}},gg=function(_){const G=b?b(_):_.attributes;if(G)for(let ae=G.length-1;ae>=0;--ae){const we=G[ae],Ce=we&&we.name;if(!(typeof Ce!="string"||y[it(Ce)]))try{_.removeAttribute(Ce)}catch{}}},mg=function(_){const G=[_];for(;G.length>0;){const ae=G.pop();(x?x(ae):ae.nodeType)===xs.element&&gg(ae);const Ce=k?k(ae):ae.childNodes;if(Ce)for(let Ne=Ce.length-1;Ne>=0;--Ne)G.push(Ce[Ne])}},Lc=function(_){let G=null,ae=null;if(Te)_="<remove></remove>"+_;else{const Ne=md(_,/^[\r\n\t ]+/);ae=Ne&&Ne[0]}Aa==="application/xhtml+xml"&&j===Gt&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const we=S?F(_):_;if(j===Gt)try{G=new u().parseFromString(we,Aa)}catch{}if(!G||!G.documentElement){G=N.createDocument(j,"template",null);try{G.documentElement.innerHTML=ne?I:we}catch{}}const Ce=G.body||G.documentElement;return _&&ae&&Ce.insertBefore(s.createTextNode(ae),Ce.childNodes[0]||null),j===Gt?q.call(G,oe?"html":"body")[0]:oe?G.documentElement:Ce},Pc=function(_){return L.call(_.ownerDocument||_,_,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},or=function(_){var G,ae;_.normalize();const we=L.call(_.ownerDocument||_,_,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Ce=we.nextNode();for(;Ce;){let vt=Ce.data;Ls([ie,he,X],Xe=>{vt=Jn(vt,Xe," ")}),Ce.data=vt,Ce=we.nextNode()}const Ne=(G=(ae=_.querySelectorAll)===null||ae===void 0?void 0:ae.call(_,"template"))!==null&&G!==void 0?G:[];Ls(Array.from(Ne),vt=>{qn(vt.content)&&or(vt.content)})},Ii=function(_){const G=A?A(_):null;return typeof G!="string"||it(G)!=="form"?!1:typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||_.attributes!==b(_)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function"||_.nodeType!==x(_)||_.childNodes!==k(_)},qn=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return x(_)===xs.documentFragment}catch{return!1}},Ra=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return typeof x(_)=="number"}catch{return!1}};function Is(fe,_,G){Ls(fe,ae=>{ae.call(t,_,G,Vn)})}const Mc=function(_){let G=null;if(Is(me.beforeSanitizeElements,_,null),Ii(_))return hs(_),!0;const ae=it(A?A(_):_.nodeName);if(Is(me.uponSanitizeElement,_,{tagName:ae,allowedTags:ge}),ee&&_.hasChildNodes()&&!Ra(_.firstElementChild)&&Tt(/<[/\w!]/g,_.innerHTML)&&Tt(/<[/\w!]/g,_.textContent)||ee&&_.namespaceURI===Gt&&ae==="style"&&Ra(_.firstElementChild)||_.nodeType===xs.progressingInstruction||ee&&_.nodeType===xs.comment&&Tt(/<[/\w]/g,_.data))return hs(_),!0;if(W[ae]||!($.tagCheck instanceof Function&&$.tagCheck(ae))&&!ge[ae]){if(!W[ae]&&$c(ae)&&(P.tagNameCheck instanceof RegExp&&Tt(P.tagNameCheck,ae)||P.tagNameCheck instanceof Function&&P.tagNameCheck(ae)))return!1;if(Ke&&!Ye[ae]){const Ce=E(_),Ne=k(_);if(Ne&&Ce){const vt=Ne.length;for(let Xe=vt-1;Xe>=0;--Xe){const ct=St?Ne[Xe]:p(Ne[Xe],!0);Ce.insertBefore(ct,g(_))}}}return hs(_),!0}return(x?x(_):_.nodeType)===xs.element&&!hg(_)||(ae==="noscript"||ae==="noembed"||ae==="noframes")&&Tt(/<\/no(script|embed|frames)/i,_.innerHTML)?(hs(_),!0):(U&&_.nodeType===xs.text&&(G=_.textContent,Ls([ie,he,X],Ce=>{G=Jn(G,Ce," ")}),_.textContent!==G&&(Wn(t.removed,{element:_.cloneNode()}),_.textContent=G)),Is(me.afterSanitizeElements,_,null),!1)},Fc=function(_,G,ae){if(R[G]||ye&&(G==="id"||G==="name")&&(ae in s||ae in pg))return!1;const we=y[G]||$.attributeCheck instanceof Function&&$.attributeCheck(G,_);if(!(Z&&!R[G]&&Tt(ue,G))){if(!(J&&Tt(Ie,G))){if(!we||R[G]){if(!($c(_)&&(P.tagNameCheck instanceof RegExp&&Tt(P.tagNameCheck,_)||P.tagNameCheck instanceof Function&&P.tagNameCheck(_))&&(P.attributeNameCheck instanceof RegExp&&Tt(P.attributeNameCheck,G)||P.attributeNameCheck instanceof Function&&P.attributeNameCheck(G,_))||G==="is"&&P.allowCustomizedBuiltInElements&&(P.tagNameCheck instanceof RegExp&&Tt(P.tagNameCheck,ae)||P.tagNameCheck instanceof Function&&P.tagNameCheck(ae))))return!1}else if(!Ea[G]){if(!Tt(pe,Jn(ae,re,""))){if(!((G==="src"||G==="xlink:href"||G==="href")&&_!=="script"&&vd(ae,"data:")===0&&mn[_])){if(!(se&&!Tt(z,Jn(ae,re,"")))){if(ae)return!1}}}}}}return!0},vg=Re({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),$c=function(_){return!vg[Va(_)]&&Tt(le,_)},Bc=function(_){Is(me.beforeSanitizeAttributes,_,null);const G=_.attributes;if(!G||Ii(_))return;const ae={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let we=G.length;for(;we--;){const Ce=G[we],Ne=Ce.name,vt=Ce.namespaceURI,Xe=Ce.value,ct=it(Ne),tn=Xe;let _t=Ne==="value"?tn:H_(tn);if(ae.attrName=ct,ae.attrValue=_t,ae.keepAttr=!0,ae.forceKeepAttr=void 0,Is(me.uponSanitizeAttribute,_,ae),_t=ae.attrValue,Me&&(ct==="id"||ct==="name")&&vd(_t,Je)!==0&&(vn(Ne,_),_t=Je+_t),ee&&Tt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,_t)){vn(Ne,_);continue}if(ct==="attributename"&&md(_t,"href")){vn(Ne,_);continue}if(ae.forceKeepAttr)continue;if(!ae.keepAttr){vn(Ne,_);continue}if(!Q&&Tt(/\/>/i,_t)){vn(Ne,_);continue}U&&Ls([ie,he,X],Hc=>{_t=Jn(_t,Hc," ")});const Uc=it(_.nodeName);if(!Fc(Uc,ct,_t)){vn(Ne,_);continue}if(S&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!vt)switch(d.getAttributeType(Uc,ct)){case"TrustedHTML":{_t=F(_t);break}case"TrustedScriptURL":{_t=M(_t);break}}if(_t!==tn)try{vt?_.setAttributeNS(vt,Ne,_t):_.setAttribute(Ne,_t),Ii(_)?hs(_):gd(t.removed)}catch{vn(Ne,_)}}Is(me.afterSanitizeAttributes,_,null)},Ni=function(_){let G=null;const ae=Pc(_);for(Is(me.beforeSanitizeShadowDOM,_,null);G=ae.nextNode();)if(Is(me.uponSanitizeShadowNode,G,null),Mc(G),Bc(G),qn(G.content)&&Ni(G.content),(x?x(G):G.nodeType)===xs.element){const Ce=v?v(G):G.shadowRoot;qn(Ce)&&(cr(Ce),Ni(Ce))}Is(me.afterSanitizeShadowDOM,_,null)},cr=function(_){const G=[{node:_,shadow:null}];for(;G.length>0;){const ae=G.pop();if(ae.shadow){Ni(ae.shadow);continue}const we=ae.node,Ne=(x?x(we):we.nodeType)===xs.element,vt=k?k(we):we.childNodes;if(vt)for(let Xe=vt.length-1;Xe>=0;--Xe)G.push({node:vt[Xe],shadow:null});if(Ne){const Xe=A?A(we):null;if(typeof Xe=="string"&&it(Xe)==="template"){const ct=we.content;qn(ct)&&G.push({node:ct,shadow:null})}}if(Ne){const Xe=v?v(we):we.shadowRoot;qn(Xe)&&G.push({node:null,shadow:Xe},{node:Xe,shadow:null})}}};return t.sanitize=function(fe){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},G=null,ae=null,we=null,Ce=null;if(ne=!fe,ne&&(fe="<!-->"),typeof fe!="string"&&!Ra(fe)&&(fe=G_(fe),typeof fe!="string"))throw xn("dirty is not a string, aborting");if(!t.isSupported)return fe;be||rr(_),t.removed=[];const Ne=St&&typeof fe!="string"&&Ra(fe);if(Ne){const ct=A?A(fe):fe.nodeName;if(typeof ct=="string"){const tn=it(ct);if(!ge[tn]||W[tn])throw xn("root node is forbidden and cannot be sanitized in-place")}if(Ii(fe))throw xn("root node is clobbered and cannot be sanitized in-place");try{cr(fe)}catch(tn){throw Oc(fe),tn}}else if(Ra(fe))G=Lc("<!---->"),ae=G.ownerDocument.importNode(fe,!0),ae.nodeType===xs.element&&ae.nodeName==="BODY"||ae.nodeName==="HTML"?G=ae:G.appendChild(ae),cr(ae);else{if(!Ae&&!U&&!oe&&fe.indexOf("<")===-1)return S&&ce?F(fe):fe;if(G=Lc(fe),!G)return Ae?null:ce?I:""}G&&Te&&hs(G.firstChild);const vt=Pc(Ne?fe:G);try{for(;we=vt.nextNode();)Mc(we),Bc(we),qn(we.content)&&Ni(we.content)}catch(ct){throw Ne&&Oc(fe),ct}if(Ne)return Ls(t.removed,ct=>{ct.element&&mg(ct.element)}),U&&or(fe),fe;if(Ae){if(U&&or(G),H)for(Ce=O.call(G.ownerDocument);G.firstChild;)Ce.appendChild(G.firstChild);else Ce=G;return(y.shadowroot||y.shadowrootmode)&&(Ce=ve.call(n,Ce,!0)),Ce}let Xe=oe?G.outerHTML:G.innerHTML;return oe&&ge["!doctype"]&&G.ownerDocument&&G.ownerDocument.doctype&&G.ownerDocument.doctype.name&&Tt(nk,G.ownerDocument.doctype.name)&&(Xe="<!DOCTYPE "+G.ownerDocument.doctype.name+`>
`+Xe),U&&Ls([ie,he,X],ct=>{Xe=Jn(Xe,ct," ")}),S&&ce?F(Xe):Xe},t.setConfig=function(){let fe=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};rr(fe),be=!0},t.clearConfig=function(){Vn=null,be=!1,S=w,I=""},t.isValidAttribute=function(fe,_,G){Vn||rr({});const ae=it(fe),we=it(_);return Fc(ae,we,G)},t.addHook=function(fe,_){typeof _=="function"&&Wn(me[fe],_)},t.removeHook=function(fe,_){if(_!==void 0){const G=B_(me[fe],_);return G===-1?void 0:U_(me[fe],G,1)[0]}return gd(me[fe])},t.removeHooks=function(fe){me[fe]=[]},t.removeAllHooks=function(){me=Td()},t}var Cd=Yh();function _c(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Un=_c();function Qh(e){Un=e}var Xa={exec:()=>null};function ze(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Vt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var Vt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},rk=/^(?:[ \t]*(?:\n|$))+/,ok=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ck=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ei=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,uk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,kc=/(?:[*+-]|\d{1,9}[.)])/,Xh=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Zh=ze(Xh).replace(/bull/g,kc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),dk=ze(Xh).replace(/bull/g,kc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),wc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,fk=/^[^\n]+/,Sc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,pk=ze(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Sc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),hk=ze(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,kc).getRegex(),nr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Tc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,gk=ze("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Tc).replace("tag",nr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),eg=ze(wc).replace("hr",Ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex(),mk=ze(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",eg).getRegex(),Cc={blockquote:mk,code:ok,def:pk,fences:ck,heading:uk,hr:Ei,html:gk,lheading:Zh,list:hk,newline:rk,paragraph:eg,table:Xa,text:fk},Ed=ze("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex(),vk={...Cc,lheading:dk,table:Ed,paragraph:ze(wc).replace("hr",Ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ed).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex()},bk={...Cc,html:ze(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Tc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Xa,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ze(wc).replace("hr",Ei).replace("heading",` *#{1,6} *[^
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+ws(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Pn=new jk;function je(e,t){return Pn.parse(e,t)}je.options=je.setOptions=function(e){return Pn.setOptions(e),je.defaults=Pn.defaults,Qh(je.defaults),je};je.getDefaults=_c;je.defaults=Un;je.use=function(...e){return Pn.use(...e),je.defaults=Pn.defaults,Qh(je.defaults),je};je.walkTokens=function(e,t){return Pn.walkTokens(e,t)};je.parseInline=Pn.parseInline;je.Parser=Vs;je.parser=Vs.parse;je.Renderer=Rl;je.TextRenderer=Rc;je.Lexer=js;je.lexer=js.lex;je.Tokenizer=Al;je.Hooks=Zi;je.parse=je;je.options;je.setOptions;je.use;je.walkTokens;je.parseInline;Vs.parse;js.lex;const Vk={breaks:!0,gfm:!0};function Dd(e){if(!e)return"";try{if(typeof je<"u"&&je.parse){const t=je.parse(e,Vk);return typeof Cd<"u"?Cd.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function qk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Od={run_command:"⌘",ssh_command:"⌘",run_script:"⌘",read_file:"📄",write_file:"✏️",list_directory:"📂",search_knowledge:"🔍",ingest_document:"📚",generate_image:"🎨",analyze_image:"🖼️",analyze_pdf:"📃",browser_screenshot:"🌐",manage_process:"⚙️"};function zk(e){return Od[e]?Od[e]:"🔧"}const Gk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Ld(e){if(!e)return[];const t=e.match(Gk);return t?[...new Set(t)]:[]}const Kk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=te(()=>t.value.trim().length>0&&!s.value),d=te(()=>{const B=qe.state;return B==="connected"?"Connected":B==="reconnecting"?"Reconnecting…":B==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=te(()=>{const B=Math.floor(i.value/4)%f.length,N=i.value;return N>3?`${f[B]} (${N}s)`:f[0]});function m(){Et(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const B=a.value;B.style.height="auto",B.style.height=Math.min(B.scrollHeight,120)+"px"}function k(B,N,L={}){const O={id:++o,role:B,content:N,timestamp:Date.now(),html:B==="bot"?Dd(N):"",tools_used:L.tools_used||[],is_error:L.is_error||!1,images:B==="bot"?Ld(N):[],files:L.files||[],_showTools:!1};return e.value.push(O),m(),B==="bot"&&Et(()=>E()),O}function E(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(N=>{N.setAttribute("data-copy","true"),N.style.position="relative";const L=document.createElement("button");L.className="chat-code-copy",L.textContent="Copy",L.addEventListener("click",()=>{const O=N.querySelector("code"),q=O?O.textContent:N.textContent;navigator.clipboard.writeText(q).then(()=>{L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},1500)}).catch(()=>{})}),N.appendChild(L)})}function v(B){if(B===0)return!0;const N=e.value[B-1],L=e.value[B],O=new Date(N.timestamp).toDateString(),q=new Date(L.timestamp).toDateString();return O!==q}function b(B){const N=new Date(B),L=new Date;if(N.toDateString()===L.toDateString())return"Today";const O=new Date(L);return O.setDate(O.getDate()-1),N.toDateString()===O.toDateString()?"Yesterday":N.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(B){t.value=B,Et(()=>V())}function A(B){window.open(B,"_blank","noopener")}function S(B){B.target.style.display="none"}function I(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function w(){r&&(clearInterval(r),r=null),i.value=0}function T(B){s.value&&(s.value=!1,w(),B.type==="chat_response"?k("bot",B.content,{tools_used:B.tools_used||[],is_error:B.is_error||!1,files:B.files||[]}):B.type==="chat_error"&&k("bot",B.error||"Unknown error",{is_error:!0}),Et(()=>{var N;return(N=a.value)==null?void 0:N.focus()}))}async function D(B){try{const N=await K.post("/api/chat",{content:B,channel_id:l.value});k("bot",N.response,{tools_used:N.tools_used||[],is_error:N.is_error||!1,files:N.files||[]})}catch(N){k("bot",N.message||"Failed to send message",{is_error:!0})}}async function V(){const B=t.value.trim();!B||s.value||(k("user",B),t.value="",s.value=!0,I(),a.value&&(a.value.style.height="auto"),qe.connected?qe.sendChat(B,{channelId:l.value})?M():(await D(B),s.value=!1,w()):(await D(B),s.value=!1,w()),Et(()=>{var N;return(N=a.value)==null?void 0:N.focus()}))}let F=null;ds(s,B=>{B||F&&(clearTimeout(F),F=null)});function M(){F=setTimeout(()=>{s.value&&(s.value=!1,w(),k("bot","Response timed out. Try again.",{is_error:!0}))},12e4)}async function Y(){try{if(!l.value){const N=await K.get("/api/auth/session");l.value=N.channel_id||N.user_id||"web-user"}const B=await K.get("/api/sessions/"+encodeURIComponent(l.value));if(B&&B.messages&&B.messages.length>0){for(const N of B.messages){const L=N.role==="user"?"user":"bot";let O=N.content||"";if(L==="user"){const ve=O.match(/^\[.*?\]:\s*/);ve&&(O=O.slice(ve[0].length))}if(!O.trim())continue;const q={id:++o,role:L,content:O,timestamp:N.timestamp?N.timestamp*1e3:Date.now(),html:L==="bot"?Dd(O):"",tools_used:[],is_error:!1,images:L==="bot"?Ld(O):[],files:[],_showTools:!1};e.value.push(q)}Et(()=>{m(),E()})}}catch{}}return $e(()=>{qe.subscribe("chat",T),Y(),Et(()=>{var B;return(B=a.value)==null?void 0:B.focus()})}),ft(()=>{qe.unsubscribe("chat",T),F&&clearTimeout(F),w()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:V,autoResize:g,formatTime:qk,formatDate:b,showDateSeparator:v,useSuggestion:x,openImage:A,onImageError:S,getToolIcon:zk}}},ir={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=S_(),s=qh(),n=te({get(){var r;const l=t.query.tab;return l&&e.tabs.some(o=>o.id===l)?l:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(l){s.replace({query:{...t.query,tab:l}})}}),a=te(()=>{const l=e.tabs.find(r=>r.id===n.value);return(l==null?void 0:l.component)||null}),i=te(()=>{const l=e.tabs.find(r=>r.id===n.value);return(l==null?void 0:l.label)||""});return ds(i,l=>{e.groupLabel&&l&&(document.title=`Odin — ${e.groupLabel} › ${l}`)},{immediate:!0}),{activeTab:n,activeComponent:a,activeLabel:i}},template:`
    <div>
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}$e(()=>{qe.on("events",a),i=setInterval(l,500)}),ft(()=>{qe.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"⏳":c==="success"?"✅":c==="error"?"❌":"⭕"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},Jk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=te(()=>e.value.reduce((S,I)=>S+(I.iteration_count||0),0)),d=te(()=>e.value.filter(S=>S.status==="running").length);function f(S){return S==="running"?"loop-status-running":S==="error"?"loop-status-error":"loop-status-stopped"}function p(S){return S==="running"?"badge-success":S==="error"?"badge-danger":S==="completed"?"badge-info":"badge-warning"}function m(S){return S==="act"?"badge-warning":S==="silent"?"badge-info":"badge-success"}function g(S){c.value={...c.value,[S]:!c.value[S]}}async function k(S=!1){S=S===!0,S||(t.value=!0);try{e.value=await K.get("/api/loops"),s.value=null}catch(I){S||(s.value=I.message)}S||(t.value=!1)}async function E(){l.value=null;const S=a.value;if(!S.goal.trim()){l.value="Goal is required";return}if(!S.channel_id.trim()){l.value="Channel ID is required";return}const I={goal:S.goal.trim(),channel_id:S.channel_id.trim(),interval_seconds:S.interval_seconds||60,mode:S.mode,max_iterations:S.max_iterations||50};S.stop_condition.trim()&&(I.stop_condition=S.stop_condition.trim()),i.value=!0;try{const w=await K.post("/api/loops",I);xe.success(`Loop started: ${w.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await k()}catch(w){l.value=w.message}i.value=!1}async function v(S){if(await ns({title:"Stop loop",message:`Stop loop ${S}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=S;try{await K.del(`/api/loops/${encodeURIComponent(S)}`),xe.success("Loop stopped"),await k()}catch(w){xe.error(w.message||"Failed to stop loop")}r.value=null}}async function b(S){o.value=S;try{await K.post(`/api/loops/${encodeURIComponent(S)}/restart`),xe.success("Loop restarted"),await k()}catch(I){xe.error(I.message||"Failed to restart loop")}o.value=null}function x(S){S.payload&&(S.payload.loop_id||S.payload.type==="loop")&&k(!0)}let A=null;return $e(()=>{k(),qe.subscribe("events",x),A=setInterval(()=>{d.value>0&&k(!0)},5e3)}),ft(()=>{qe.unsubscribe("events",x),A&&clearInterval(A)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:_a,formatAge:zh,toggleHistory:g,fetchLoops:k,doCreate:E,doStop:v,doRestart:b}}},Qk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),m=h(null),g=h([]),k=h(!1),E=te(()=>e.value.filter(N=>N.cron&&!N.one_time).length),v=te(()=>e.value.filter(N=>N.one_time).length),b=te(()=>e.value.filter(N=>N.paused).length),x=te(()=>e.value.filter(N=>N.consecutive_failures>0).length);function A(N){if(!N)return"-";const L=Date.now(),q=(new Date(N).getTime()-L)/1e3;if(q<0)return"overdue";if(q<60)return"in < 1 min";if(q<3600)return`in ${Math.floor(q/60)} min`;if(q<86400){const me=Math.floor(q/3600),ie=Math.floor(q%3600/60);return ie>0?`in ${me}h ${ie}m`:`in ${me}h`}const ve=Math.floor(q/86400);return`in ${ve} day${ve!==1?"s":""}`}function S(N){return N==null?"-":N<1e3?`${N}ms`:N<6e4?`${(N/1e3).toFixed(1)}s`:_a(N/1e3)}function I(){r.value=null}async function w(){const N=a.value.cron.trim();if(N){o.value=!0;try{r.value=await K.post("/api/schedules/validate-cron",{expression:N})}catch(L){r.value={valid:!1,error:L.message}}o.value=!1}}async function T(){t.value=!0,s.value=null;try{e.value=await K.get("/api/schedules")}catch(N){s.value=N.message}t.value=!1}async function D(N){if(m.value===N){m.value=null,g.value=[];return}m.value=N,k.value=!0,g.value=[];try{g.value=await K.get(`/api/schedules/${encodeURIComponent(N)}/history?limit=10`)}catch{g.value=[]}k.value=!1}async function V(){l.value=null;const N=a.value;if(!N.description.trim()){l.value="Description is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}if(!N.cron.trim()&&!N.run_at.trim()){l.value="Cron expression or run_at time is required";return}const L={description:N.description.trim(),action:N.action,channel_id:N.channel_id.trim()};if(N.cron.trim()&&(L.cron=N.cron.trim()),N.run_at.trim()&&(L.run_at=N.run_at.trim()),N.action==="reminder"&&N.message.trim()&&(L.message=N.message.trim()),N.action==="check"&&(N.tool_name.trim()&&(L.tool_name=N.tool_name.trim()),N.tool_input_str.trim()))try{L.tool_input=JSON.parse(N.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await K.post("/api/schedules",L),xe.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await T()}catch(O){l.value=O.message}i.value=!1}async function F(N){u.value=N;try{const L=await K.post(`/api/schedules/${encodeURIComponent(N)}/run`);if(L.status==="failure")xe.error(`Execution failed: ${L.error||"unknown error"}`);else{const O=L.warning?`Executed (${L.warning})`:"Executed successfully";xe.success(O)}await T()}catch(L){xe.error(L.message||"Failed to trigger")}u.value=null}async function M(N){f.value=N.id;const L=!N.paused;try{await K.put(`/api/schedules/${encodeURIComponent(N.id)}`,{paused:L}),xe.success(L?"Schedule paused":"Schedule resumed"),await T()}catch(O){xe.error(O.message||"Failed to update schedule")}f.value=null}async function Y(N){p.value=N;try{await K.post(`/api/schedules/${encodeURIComponent(N)}/reset-failures`),xe.success("Failure counters reset"),await T()}catch(L){xe.error(L.message||"Failed to reset")}p.value=null}async function B(N){const L=e.value.find(q=>q.id===N);if(await ns({title:"Delete schedule",message:`Delete "${(L==null?void 0:L.description)||N}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=N;try{await K.del(`/api/schedules/${encodeURIComponent(N)}`),xe.success("Schedule deleted"),await T()}catch(q){xe.error(q.message||"Failed to delete schedule")}d.value=null}}return $e(()=>{T()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:m,history:g,historyLoading:k,cronCount:E,oneTimeCount:v,pausedCount:b,failingCount:x,formatTs:Ta,formatAge:zh,formatFuture:A,formatMs:S,formatDuration:_a,onCronInput:I,validateCron:w,toggleExpand:D,fetchSchedules:T,doCreate:V,doRunNow:F,doTogglePause:M,doResetFailures:Y,doDelete:B}}},Zk={components:{TabbedPage:ir},setup(){return{tabs:[{id:"live",label:"Live",component:Wk},{id:"agents",label:"Agents",component:Jk},{id:"loops",label:"Loops",component:Yk},{id:"processes",label:"Processes",component:Qk},{id:"schedules",label:"Schedules",component:Xk}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},ew={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=Pd,g=tw,k=h([]),E=h(!1),v=h(""),b=h("flat"),x=h(new Set),A=h(""),S=h(""),I=h(""),w=h(null),T=h(!1);function D(){try{const H=localStorage.getItem("odin-session-presets");H&&(k.value=JSON.parse(H))}catch{}}function V(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const F=te(()=>d.value.trim()!==""||u.value!=="all"),M=te(()=>{let H=[...e.value];const ce=Pd.find(Ke=>Ke.id===u.value),ye=ce?ce.filters:{};if(ye.source&&(H=H.filter(Ke=>Ke.source===ye.source)),ye.minMessages&&(H=H.filter(Ke=>Ke.message_count>=ye.minMessages)),ye.hasCompaction&&(H=H.filter(Ke=>Ke.has_summary)),ye.maxAge!=null){const Ke=Date.now()/1e3;H=H.filter(St=>St.last_active&&Ke-St.last_active<=ye.maxAge)}if(d.value.trim()){const Ke=d.value.toLowerCase().trim();H=H.filter(St=>(St.channel_id||"").toLowerCase().includes(Ke)||(St.last_user_id||"").toLowerCase().includes(Ke)||(St.source||"").toLowerCase().includes(Ke))}const Me=f.value,Je=p.value?1:-1;return H.sort((Ke,St)=>{const st=Ke[Me]||0,Ye=St[Me]||0;return(st-Ye)*Je}),H}),Y=te(()=>{if(!a.value||!a.value.messages)return[];const H=a.value.messages;if(H.length===0)return[];const ce=[];let ye=[];for(const Me of H)Me.role==="user"&&ye.length>0&&(ce.push(ye),ye=[]),ye.push(Me);return ye.length>0&&ce.push(ye),ce}),B=te(()=>M.value.length>0&&o.value.size===M.value.length);function N(H){const ce=H.find(ye=>ye.role==="user");if(ce&&ce.content){const ye=ce.content.slice(0,120);return ye.length<ce.content.length?ye+"...":ye}return"(no user message)"}function L(H){const ce=new Set(x.value);ce.has(H)?ce.delete(H):ce.add(H),x.value=ce}function O(H){u.value=H}function q(H){u.value=H.id,H.filters.searchQuery!=null&&(d.value=H.filters.searchQuery),H.filters.sortBy&&(f.value=H.filters.sortBy)}function ve(){if(!v.value.trim())return;const H={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,H],V(),E.value=!1,v.value=""}function me(H){k.value=k.value.filter(ce=>ce.id!==H),V(),u.value===H&&(u.value="all")}function ie(){u.value="all",d.value="",f.value="last_active",p.value=!1}function he(H){if(!H)return"—";const ce=Date.now()/1e3-H;if(ce<60)return"just now";if(ce<3600){const Me=Math.floor(ce/60);return`${Me} minute${Me!==1?"s":""} ago`}if(ce<86400){const Me=Math.floor(ce/3600);return`${Me} hour${Me!==1?"s":""} ago`}const ye=Math.floor(ce/86400);return`${ye} day${ye!==1?"s":""} ago`}function X(H){if(!H)return"";try{return new Date(H*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ue(H){if(!H)return"";try{return new Date(H*1e3).toLocaleString()}catch{return""}}function Ie(H){return H==="user"?"bg-gray-900/50 border border-gray-800":H==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function z(H){return H==="user"?"sess-msg-user":H==="assistant"?"sess-msg-assistant":"sess-msg-system"}function re(H){return H==="user"?"badge-info":H==="assistant"?"badge-success":"badge-warning"}function le(H){return H==="user"?"sess-dot-user":H==="assistant"?"sess-dot-assistant":"sess-dot-system"}function pe(H){return H==="user"?"text-cyan-400":H==="assistant"?"text-indigo-400":"text-gray-500"}function ge(H){return H?H.length>2e3?H.slice(0,2e3)+`
... (truncated)`:H:""}async function Le(){const H=A.value.trim();if(H){T.value=!0;try{let ce=`/api/sessions/search?q=${encodeURIComponent(H)}&limit=50`;S.value.trim()&&(ce+=`&channel_id=${encodeURIComponent(S.value.trim())}`),I.value.trim()&&(ce+=`&user_id=${encodeURIComponent(I.value.trim())}`);const ye=await K.get(ce);w.value=ye.results||[]}catch{w.value=[]}T.value=!1}}function y(){A.value="",S.value="",I.value="",w.value=null}function C(H){return H?H.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function P(H){return H==="user"?"bg-gray-900/50 border-gray-800":H==="assistant"?"bg-indigo-950/30 border-indigo-900/30":H==="summary"?"bg-amber-950/20 border-amber-900/30":H==="fts"?"bg-emerald-950/20 border-emerald-900/30":H==="channel"?"bg-purple-950/20 border-purple-900/30":"bg-gray-900/30 border-gray-800/50"}function W(H){return H==="user"?"badge-info":H==="assistant"?"badge-success":H==="summary"?"badge-warning":H==="fts"?"badge-success":"badge-info"}async function R(){t.value=!0,s.value=null;try{e.value=await K.get("/api/sessions")}catch(H){s.value=H.message}t.value=!1}function $(){s.value=null,R()}async function J(H){if(n.value===H){n.value=null,a.value=null,x.value=new Set;return}n.value=H,a.value=null,i.value=!0,x.value=new Set;try{a.value=await K.get(`/api/sessions/${encodeURIComponent(H)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Z(H){const ce=new Set(o.value);ce.has(H)?ce.delete(H):ce.add(H),o.value=ce}function se(){B.value?o.value=new Set:o.value=new Set(M.value.map(H=>H.channel_id))}function Q(H){l.value=H}async function U(){if(l.value){r.value=!0;try{await K.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await R()}catch(H){s.value=H.message||"Failed to clear session"}r.value=!1,l.value=null}}function ee(){c.value=!0}async function oe(){if(o.value.size!==0){r.value=!0;try{await K.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await R()}catch(H){s.value=H.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function be(H,ce){const ye=K._token;let Me=`/api/sessions/${encodeURIComponent(H)}/export?format=${ce}`;ye&&(Me+=`&token=${encodeURIComponent(ye)}`);const Je=document.createElement("a");Je.href=Me,Je.download=`session-${H}.${ce==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let Te=null;function Ae(H){H.payload&&H.payload.channel_id&&(clearTimeout(Te),Te=setTimeout(()=>{R(),n.value&&H.payload.channel_id===n.value&&K.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(ce=>{a.value=ce}).catch(()=>{})},2e3))}return $e(()=>{D(),R(),qe.subscribe("events",Ae)}),ft(()=>{qe.unsubscribe("events",Ae),clearTimeout(Te)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:B,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:M,hasActiveFilters:F,customPresets:k,showSavePreset:E,newPresetName:v,threadView:b,threads:Y,collapsedThreads:x,ftsQuery:A,ftsChannelId:S,ftsUserId:I,ftsResults:w,ftsSearching:T,formatAge:he,formatTimestamp:X,formatFullTimestamp:ue,messageClass:Ie,threadMsgClass:z,roleBadge:re,roleDotClass:le,roleLabelClass:pe,truncateContent:ge,threadSummary:N,fetchSessions:R,retry:$,toggleSession:J,toggleSelect:Z,toggleSelectAll:se,confirmClear:Q,clearSession:U,confirmBulkClear:ee,doBulkClear:oe,exportSession:be,applyPreset:O,applyCustomPreset:q,saveCustomPreset:ve,removeCustomPreset:me,resetFilters:ie,toggleThread:L,runFtsSearch:Le,clearFtsSearch:y,highlightSnippet:C,ftsResultClass:P,ftsTypeBadge:W}}},nw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:R_}}},aw={components:{ContextAssemblyPanel:nw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(I){if(!I)return"—";try{const w=new Date(I);return isNaN(w.getTime())?I:w.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return I}}function f(I){return!I&&I!==0?"—":I<1e3?I+"ms":(I/1e3).toFixed(1)+"s"}function p(I){return!I&&I!==0?"—":I>=1e3?(I/1e3).toFixed(1)+"k":String(I)}function m(I){if(!I)return"";if(typeof I=="string")return I;try{return JSON.stringify(I,null,2)}catch{return String(I)}}function g(I){a.value===I?a.value=null:(a.value=I,c.value={})}function k(I,w){const T=I+"-"+w;c.value={...c.value,[T]:!c.value[T]}}function E(I,w){return!!c.value[I+"-"+w]}function v(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,A()}async function b(){try{const I=await K.get("/api/trajectories");e.value=I.files||[],o.value=I.count||0}catch{}}let x=0;async function A(){const I=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const w=await K.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(I!==x)return;let T=w.entries||[];u.value.tool_name&&(T=T.filter(D=>(D.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(T=T.filter(D=>D.is_error)),u.value.channel_id&&(T=T.filter(D=>D.channel_id===u.value.channel_id)),u.value.user_id&&(T=T.filter(D=>D.user_id===u.value.user_id)),t.value=T}else{const w=new URLSearchParams;u.value.channel_id&&w.set("channel_id",u.value.channel_id),u.value.user_id&&w.set("user_id",u.value.user_id),u.value.tool_name&&w.set("tool_name",u.value.tool_name),u.value.errors_only&&w.set("errors_only","true"),w.set("limit",String(u.value.limit));const T=w.toString(),D=await K.get(`/api/trajectories/search/query?${T}`);if(I!==x)return;t.value=D.results||[]}}catch(w){if(I!==x)return;n.value=w.message}I===x&&(s.value=!1)}async function S(){if(!l.value.trim())return;const I=++x;s.value=!0,n.value=null,c.value={};try{const w=await K.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(I!==x)return;i.value=w.entry||null,i.value||(n.value="No trace found for this message ID")}catch(w){if(I!==x)return;w.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=w.message}I===x&&(s.value=!1)}return $e(async()=>{await b(),await A()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:m,truncateBlock:Gh,toggleExpand:g,toggleIteration:k,isIterationExpanded:E,clearFilters:v,fetchFiles:b,fetchTraces:A,lookupMessage:S}}},iw={template:`
...
`)}const uw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),k=h(null),E=h(!1),v=te(()=>e.value.length),b=te(()=>e.value.reduce((X,ue)=>X+(ue.execution_count||0),0)),x=te(()=>e.value.reduce((X,ue)=>X+D(ue.code),0)),A=te(()=>{if(!l.value)return e.value;const X=l.value.toLowerCase();return e.value.filter(ue=>ue.name.toLowerCase().includes(X)||(ue.description||"").toLowerCase().includes(X))}),S=te(()=>d.value?d.value.split(`
`).length:0),I=te(()=>{const X=Math.max(S.value,1);return Array.from({length:X},(ue,Ie)=>Ie+1).join(`
`)}),w=te(()=>{const X=d.value.trim();return X?X.includes("SKILL_DEFINITION")?X.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function T(X){return ow(X)}function D(X){return X?X.split(`
`).length:0}function V(X){return cw(X)}function F(X){n.value={...n.value,[X]:!n.value[X]}}async function M(X){try{await navigator.clipboard.writeText(X);const ue=e.value.find(Ie=>Ie.code===X);ue&&(r.value=ue.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function Y(X){if(X.key==="Tab"){X.preventDefault();const ue=X.target,Ie=ue.selectionStart,z=ue.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(z),Et(()=>{ue.selectionStart=ue.selectionEnd=Ie+4})}}function B(X){const ue=X.target.previousElementSibling;ue&&(ue.scrollTop=X.target.scrollTop)}async function N(){t.value=!0,s.value=null;try{e.value=await K.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function L(X){i.value=X,delete a.value[X],a.value={...a.value};try{const ue=await K.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:ue}}catch(ue){a.value={...a.value,[X]:{result:ue.message,is_error:!0}}}i.value=null}function O(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function q(X){o.value=!0,c.value="edit",u.value=X.name,d.value=X.code||"",f.value=null,p.value=null}function ve(){o.value=!1,f.value=null,p.value=null}async function me(){f.value=null,p.value=null;const X=u.value.trim(),ue=d.value.trim();if(!X){f.value="Name is required";return}if(!ue){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await K.post("/api/skills",{name:X,code:ue}),p.value="Skill created successfully"):(await K.put(`/api/skills/${encodeURIComponent(X)}`,{code:ue}),p.value="Skill updated successfully"),await N(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}m.value=!1}function ie(X){k.value=X}async function he(){if(k.value){E.value=!0;try{await K.del(`/api/skills/${encodeURIComponent(k.value)}`),await N()}catch{}E.value=!1,k.value=null}}return $e(()=>{N()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:k,deleting:E,enabledCount:v,totalExecutions:b,totalLines:x,displayedSkills:A,editLineCount:S,editorLineNums:I,editValidation:w,highlight:T,truncate:xc,formatTs:Ta,countLines:D,getLineNumbers:V,toggleCode:F,copyCode:M,handleEditorKey:Y,syncScroll:B,fetchSkills:N,testSkill:L,showCreate:O,editSkill:q,cancelEdit:ve,saveSkill:me,confirmDelete:ie,doDelete:he}}};function dw(e,t){if(!e||!t)return fd(e);const s=fd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const fw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let k=null;const E=h(null),v=h(!1),b=h({}),x=h({}),A=h(null),S=h(null),I=te(()=>e.value.reduce((O,q)=>O+(q.chunks||0),0)),w=te(()=>new Set(e.value.map(q=>q.uploader).filter(Boolean)).size);function T(O,q){const ve=x.value[q];if(!ve||ve.length===0)return 0;const me=Math.max(...ve.map(ie=>ie.char_count||0));return me===0?0:Math.round(O.char_count/me*100)}async function D(){t.value=!0,s.value=null;try{const O=await K.get("/api/knowledge");e.value=Array.isArray(O)?O:[]}catch(O){s.value=O.message}t.value=!1}async function V(O){if(b.value[O]){b.value[O]=!1,S.value=null;return}if(b.value[O]=!0,!(x.value[O]||A.value===O)){A.value=O;try{const q=await K.get(`/api/knowledge/${encodeURIComponent(O)}/chunks`);x.value[O]=Array.isArray(q)?q:[]}catch(q){x.value[O]=[],xe.error(`Failed to load chunks: ${q.message}`)}A.value=null}}async function F(){const O=n.value.trim();if(O){i.value=!0,r.value=null,l.value=O;try{const q=await K.get(`/api/knowledge/search?q=${encodeURIComponent(O)}`);a.value=Array.isArray(q)?q:[]}catch(q){a.value=[],r.value=q.message||"Search failed"}i.value=!1}}function M(){a.value=null,n.value="",r.value=null}async function Y(){d.value=null,f.value=null;const O=c.value.trim(),q=u.value.trim();if(!O){d.value="Source name is required";return}if(!q){d.value="Content is required";return}p.value=!0;try{const ve=await K.post("/api/knowledge",{source:O,content:q});f.value=`Ingested ${ve.chunks||0} chunks from "${O}"`,c.value="",u.value="",x.value={},await D(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(ve){d.value=ve.message}p.value=!1}async function B(O){m.value=O,g.value=null,k&&(clearTimeout(k),k=null);try{const q=await K.post(`/api/knowledge/${encodeURIComponent(O)}/reingest`);g.value={source:O,error:!1,message:`Re-ingested ${q.chunks||0} chunks`},delete x.value[O],await D(),k=setTimeout(()=>{g.value=null,k=null},3e3)}catch(q){g.value={source:O,error:!0,message:q.message}}m.value=null}function N(O){E.value=O}async function L(){if(E.value){v.value=!0;try{await K.del(`/api/knowledge/${encodeURIComponent(E.value)}`),delete x.value[E.value],await D()}catch{}v.value=!1,E.value=null}}return $e(()=>{D()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:E,deleting:v,expanded:b,sourceChunks:x,loadingChunks:A,selectedChunk:S,totalChunks:I,uploaderCount:w,truncate:xc,formatTs:Ta,highlightTerms:dw,chunkBarWidth:T,fetchSources:D,toggleSource:V,doSearch:F,clearSearch:M,doIngest:Y,doReingest:B,confirmDelete:N,doDelete:L}}},pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),k=h(null),E=h(new Set),v=h(null),b=h(!1),x=h(!1),A=te(()=>e.value.reduce((ie,he)=>ie+he.count,0)),S=te(()=>E.value.size);function I(ie){const he=t.value[ie];if(!he)return[];if(!l.value.trim())return he;const X=l.value.trim().toLowerCase();return he.filter(ue=>ue.key.toLowerCase().includes(X)||ue.value&&ue.value.toLowerCase().includes(X))}function w(ie,he){return E.value.has(ie+"/"+he)}function T(ie,he){const X=ie+"/"+he,ue=new Set(E.value);ue.has(X)?ue.delete(X):ue.add(X),E.value=ue}function D(ie){const he=t.value[ie];return!he||he.length===0?!1:he.every(X=>E.value.has(ie+"/"+X.key))}function V(ie,he){const X=t.value[ie];if(!X)return;const ue=new Set(E.value);for(const Ie of X){const z=ie+"/"+Ie.key;he?ue.add(z):ue.delete(z)}E.value=ue}async function F(){s.value=!0,n.value=null;try{const ie=await K.get("/api/memory");e.value=Object.entries(ie).map(([he,X])=>({name:he,keys:X.keys||[],count:X.count||0}))}catch(ie){n.value=ie.message}s.value=!1}async function M(ie){if(a.value[ie]){a.value[ie]=!1;return}a.value[ie]=!0;const he=e.value.find(ue=>ue.name===ie);if(!he||t.value[ie]||i.value===ie)return;i.value=ie;const X=await Promise.all(he.keys.map(async ue=>{try{const Ie=await K.get(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(ue)}`);return{key:ue,value:Ie.value||""}}catch{return{key:ue,value:"(error loading)"}}}));t.value[ie]=X,i.value=null}function Y(ie,he,X){f.value=ie+"/"+he,p.value=X}async function B(ie,he){m.value=!0,g.value=null;try{await K.put(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(he)}`,{value:p.value});const X=t.value[ie];if(X){const ue=X.find(Ie=>Ie.key===he);ue&&(ue.value=p.value)}f.value=null}catch(X){g.value=`Failed to save: ${X.message||"unknown error"}`}m.value=!1}async function N(ie,he){try{await navigator.clipboard.writeText(he.value),k.value=ie+"/"+he.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function L(){u.value=null,d.value=null;const ie=o.value.scope.trim(),he=o.value.key.trim(),X=o.value.value.trim();if(!ie){u.value="Scope is required";return}if(!he){u.value="Key is required";return}if(!X){u.value="Value is required";return}c.value=!0;try{await K.put(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(he)}`,{value:X}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await F(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(ue){u.value=ue.message}c.value=!1}function O(ie,he){v.value={scope:ie,key:he}}async function q(){if(!v.value)return;b.value=!0,g.value=null;const{scope:ie,key:he}=v.value;try{await K.del(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(he)}`);const X=t.value[ie];X&&(t.value[ie]=X.filter(z=>z.key!==he));const ue=e.value.find(z=>z.name===ie);ue&&(ue.count--,ue.keys=ue.keys.filter(z=>z!==he));const Ie=new Set(E.value);Ie.delete(ie+"/"+he),E.value=Ie}catch(X){g.value=`Failed to delete: ${X.message||"unknown error"}`}b.value=!1,v.value=null}function ve(){x.value=!0}async function me(){b.value=!0,g.value=null;const ie=[];for(const he of E.value){const X=he.indexOf("/");ie.push({scope:he.slice(0,X),key:he.slice(X+1)})}try{await K.post("/api/memory/bulk-delete",{entries:ie}),E.value=new Set,t.value={},await F()}catch(he){g.value=`Bulk delete failed: ${he.message||"unknown error"}`}b.value=!1,x.value=!1}return $e(()=>{F()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:k,selected:E,selectedCount:S,totalEntries:A,deleteTarget:v,deleting:b,showBulkDelete:x,fetchMemory:F,toggleScope:M,startEdit:Y,doEdit:B,copyValue:N,doAdd:L,confirmDelete:O,doDelete:q,confirmBulkDelete:ve,doBulkDelete:me,isSelected:w,toggleSelect:T,isScopeAllSelected:D,toggleSelectAll:V,filteredEntries:I}}},hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=te(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=te(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await K.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return $e(()=>{c(),i=setInterval(c,3e4)}),ft(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:Kh,refresh:u,retry:d}}},kw=["INFO","WARNING","ERROR"],ww=[{id:"all",name:"All Logs",icon:"☰",filters:{}},{id:"errors",name:"Errors Only",icon:"❌",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"⚠",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"🔧",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"🔥",filters:{level:"ERROR",timeRange:"last_1h"}}],Mr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Sw=[50,100,200,500],Tw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(qe.state||"disconnected"),c=te(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,m=kw,g=ww,k=Mr,E=h("all"),v=h(""),b=h([]),x=h(!1),A=h(""),S=h([]);function I(){try{const j=localStorage.getItem("odin-log-presets");j&&(b.value=JSON.parse(j))}catch{}}function w(){try{localStorage.setItem("odin-log-presets",JSON.stringify(b.value))}catch{}}const T=te(()=>a.value!==""||i.value.trim()!==""||v.value!==""),D=te(()=>{const j=Mr.find(ne=>ne.value===v.value);return j?j.label:""}),V=te(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(j){return j.message}}),F=24,M=te(()=>{if(t.value.length===0)return[];const j=[],ne=new Date,_e=3600*1e3;for(let Qe=F-1;Qe>=0;Qe--){const nt=new Date(ne.getTime()-(Qe+1)*_e),Nt=new Date(ne.getTime()-Qe*_e);j.push({start:nt,end:Nt,label:L(nt,Nt),shortLabel:Nt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Qe of t.value){if(!Qe._time)continue;const nt=Qe._time.getTime();for(const Nt of j)if(nt>=Nt.start.getTime()&&nt<Nt.end.getTime()){Nt.total++,Qe.level==="ERROR"?Nt.errors++:Qe.level==="WARNING"?Nt.warnings++:Nt.info++;break}}return j}),Y=te(()=>{let j=1;for(const ne of M.value)ne.total>j&&(j=ne.total);return j}),B=te(()=>M.value.length===0?"":"Last 24 hours"),N=te(()=>Math.ceil(F/8));function L(j,ne){const _e={hour:"2-digit",minute:"2-digit"};return j.toLocaleTimeString([],_e)+" - "+ne.toLocaleTimeString([],_e)}function O(j,ne){return!ne||!j?"0px":Math.max(2,j/ne*100)+"%"}function q(j){const ne=ve.value.findIndex(_e=>_e._time&&_e._time.getTime()>=j.start.getTime()&&_e._time.getTime()<j.end.getTime());if(ne>=0&&u.value){const _e=u.value.querySelectorAll(".log-line");_e[ne]&&(_e[ne].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const ve=te(()=>{let j=t.value;if(a.value&&(j=j.filter(ne=>(ne.level||"INFO")===a.value)),v.value){const ne=Mr.find(_e=>_e.value===v.value);if(ne&&ne.seconds){const _e=new Date(Date.now()-ne.seconds*1e3);j=j.filter(Qe=>Qe._time&&Qe._time>=_e)}}if(i.value&&!V.value)if(l.value)try{const ne=new RegExp(i.value,"i");j=j.filter(_e=>{const Qe=_e.text||_e.raw||"",nt=_e.tool||"";return ne.test(Qe)||ne.test(nt)})}catch{}else{const ne=i.value.toLowerCase();j=j.filter(_e=>{const Qe=(_e.text||_e.raw||"").toLowerCase(),nt=(_e.tool||"").toLowerCase();return Qe.includes(ne)||nt.includes(ne)})}return j});function me(j){if(j.type==="log"&&j.line)try{const ne=typeof j.line=="string"?JSON.parse(j.line):j.line,_e=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:_e.toLocaleTimeString(),_time:_e,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(j.line),tool:"",raw:String(j.line)}}if(j.payload){const ne=j.payload,_e=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:_e.toLocaleTimeString(),_time:_e,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}return typeof j=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:j,tool:"",raw:j}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(j),tool:"",raw:null}}function ie(j){const ne=me(j);if(s.value){S.value.push(ne);return}he(ne)}function he(j){t.value.push(j),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&Et(()=>X())}function X(){const j=u.value;if(j){const ne=j.scrollHeight-j.scrollTop-j.clientHeight;j.scrollTo({top:j.scrollHeight,behavior:ne<500?"smooth":"instant"})}}function ue(){n.value=!0,d.value=!1,Et(()=>X())}function Ie(){const j=u.value;if(!j)return;const ne=j.scrollHeight-j.scrollTop-j.clientHeight<40;d.value=!ne&&t.value.length>0,!ne&&n.value&&(n.value=!1)}function z(){if(s.value=!s.value,!s.value&&S.value.length>0){for(const j of S.value)he(j);S.value=[]}}function re(){t.value=[],S.value=[],d.value=!1}function le(){let j;e.value==="search"?j=ce.value.map(nt=>{const Nt=nt.error?"ERROR":"INFO",lr=nt.tool_name?`[${nt.tool_name}] `:"";return`${nt.timestamp||""} ${Nt} ${lr}${nt.result_summary||nt.message||""}`}).join(`
`):j=ve.value.map(nt=>`${nt.ts} ${nt.level} ${nt.text}`).join(`
`);const ne=new Blob([j],{type:"text/plain"}),_e=URL.createObjectURL(ne),Qe=document.createElement("a");Qe.href=_e,Qe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Qe.click(),URL.revokeObjectURL(_e)}function pe(j,ne){const _e=`${j.ts} ${j.level} ${j.text||j.raw||""}`;navigator.clipboard.writeText(_e).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function ge(j){a.value=a.value===j?"":j,E.value="all"}function Le(j){return j.level==="ERROR"?"log-line-error":j.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(j){return j==="ERROR"?"text-red-500 font-semibold":j==="WARNING"?"text-yellow-500":"text-blue-500"}function C(j){return j==="ERROR"?"log-chip-error":j==="WARNING"?"log-chip-warning":"log-chip-info"}function P(j){E.value=j.id;const ne=j.filters;a.value=ne.level||"",v.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function W(j){E.value=j.id,a.value=j.filters.level||"",v.value=j.filters.timeRange||"",i.value=j.filters.text||""}function R(){if(!A.value.trim())return;const j={id:"custom-"+Date.now(),name:A.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};b.value=[...b.value,j],w(),x.value=!1,A.value=""}function $(j){b.value=b.value.filter(ne=>ne.id!==j),w(),E.value===j&&(E.value="all")}const J=h("all"),Z=h(""),se=h(""),Q=h(""),U=h(""),ee=h(""),oe=h(100),be=Sw,Te=h(!1),Ae=h(!1),H=h(""),ce=h([]),ye=h(null),Me=h(null);function Je(){e.value="search",ye.value||Ke()}async function Ke(){try{ye.value=await K.get("/api/logs/stats")}catch{}}function St(){const j=ee.value;if(!j){Q.value="",U.value="";return}const _e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[j];if(_e){const Qe=new Date(Date.now()-_e*1e3);Q.value=st(Qe),U.value=""}}function st(j){const ne=_e=>String(_e).padStart(2,"0");return`${j.getFullYear()}-${ne(j.getMonth()+1)}-${ne(j.getDate())}T${ne(j.getHours())}:${ne(j.getMinutes())}`}function Ye(j){if(!j)return"";const ne=new Date(j);return isNaN(ne.getTime())?"":ne.toISOString()}async function en(){Te.value=!0,H.value="",Ae.value=!0,Me.value=null;try{const j=new URLSearchParams;J.value&&J.value!=="all"&&j.set("level",J.value),Z.value&&j.set("tool",Z.value),se.value&&j.set("q",se.value);const ne=Ye(Q.value),_e=Ye(U.value);ne&&j.set("start",ne),_e&&j.set("end",_e),j.set("limit",String(oe.value));const Qe=await K.get(`/api/logs/search?${j.toString()}`);ce.value=Qe.entries||[]}catch(j){H.value=j.message||"Search failed",ce.value=[]}finally{Te.value=!1}}function mn(){J.value="all",Z.value="",se.value="",Q.value="",U.value="",ee.value="",oe.value=100,ce.value=[],Ae.value=!1,H.value="",Me.value=null}function Ai(j){Me.value=Me.value===j?null:j}function Ea(j){if(!j.timestamp)return"";try{return new Date(j.timestamp).toLocaleString()}catch{return j.timestamp}}function Ri(j){return j.type==="web_action"?`${j.status||""} (${j.execution_time_ms||0}ms)`:(j.result_summary||"").slice(0,200)}function Hn(j){return j.error?"log-line-error":"text-gray-300"}function jn(j){try{return JSON.stringify(j,null,2)}catch{return String(j)}}let Gt=null;return $e(()=>{I(),qe.subscribe("logs",ie),r.value=qe.connected,o.value=qe.state||"disconnected",Gt=qe.onStateChange;const j=qe.onStateChange;qe.onStateChange=(ne,_e)=>{o.value=ne,r.value=ne==="connected",j&&j(ne,_e)}}),ft(()=>{qe.unsubscribe("logs",ie),Gt!==void 0&&(qe.onStateChange=Gt)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ve,pauseBuffer:S,showJumpBottom:d,copiedIndex:f,regexError:V,levels:m,logPresets:g,timeRanges:k,timeRange:v,activeLogPreset:E,customLogPresets:b,showSaveLogPreset:x,newLogPresetName:A,hasActiveLogFilters:T,timeRangeLabel:D,timelineBuckets:M,timelineMax:Y,timelineSpanLabel:B,timelineLabelSkip:N,togglePause:z,clearLogs:re,exportLogs:le,logLineClass:Le,levelClass:y,levelChipClass:C,toggleLevel:ge,copyLine:pe,jumpToBottom:ue,onScroll:Ie,applyLogPreset:P,applyCustomLogPreset:W,saveLogCustomPreset:R,removeLogCustomPreset:$,segmentHeight:O,jumpToTimelineBucket:q,searchLevel:J,searchTool:Z,searchKeyword:se,searchStart:Q,searchEnd:U,searchTimePreset:ee,searchLimit:oe,searchLimits:be,searching:Te,searchRan:Ae,searchError:H,searchResults:ce,searchStats:ye,expandedSearch:Me,switchToSearch:Je,runSearch:en,clearSearchFilters:mn,toggleSearchExpand:Ai,formatSearchTs:Ea,searchEntryText:Ri,searchLogLineClass:Hn,formatJson:jn,applySearchTimePreset:St}}},Cw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Ew={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Aw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1“128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"monitoring.cooldown_minutes":{type:"number",min:0,message:"Must be non-negative"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Fr=[{key:"core",label:"Core",icon:"⚙",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"🧠",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"💾",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"🔗",sections:["webhook","monitoring","observability","email","voice","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"🛠",sections:["tools"]},{key:"ui",label:"Web UI",icon:"🌐",sections:["web"]},{key:"automation",label:"Automation",icon:"🔄",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"🔌",sections:["issue_tracker"]}],og="••••••••",Rw=50;function Iw(e){return Cw.has(e)}function Nw(e){return e===og}function Gi(e){return JSON.parse(JSON.stringify(e))}function Nn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Dw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Nn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Ow(e,t,s){const n=Aw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Md(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Nn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Lw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=te(()=>d.value.length>0),m=te(()=>f.value.length>0),g=te(()=>r.value&&t.value?t.value:e.value),k=te(()=>!e.value||!t.value?!1:!Nn(e.value,t.value)),E=te(()=>!e.value||!t.value?0:Md(e.value,t.value).length),v=te(()=>{if(!r.value||!t.value)return{};const R={};for(const $ of Object.keys(t.value)){const J=t.value[$];if(typeof J=="object"&&J!==null&&!Array.isArray(J))for(const Z of Object.keys(J)){const se=Ow($,Z,J[Z]);se&&(R[$+"."+Z]=se)}}return R}),b=te(()=>Object.keys(v.value).length>0),x=te(()=>e.value?Object.keys(e.value).length:0),A=te(()=>I.value.length),S=te(()=>!e.value||!t.value?[]:Md(e.value,t.value)),I=te(()=>e.value?Fr.map(R=>({...R,sections:R.sections.filter($=>$ in e.value)})).filter(R=>R.sections.length>0):[]),w=te(()=>{if(!e.value)return[];const R=new Set(Fr.flatMap($=>$.sections));return Object.keys(e.value).filter($=>!R.has($))});function T(R){return g.value?g.value[R]:null}function D(R){return!e.value||!t.value?!1:!Nn(e.value[R],t.value[R])}function V(R){return R.sections.some($=>D($))}function F(R,$){if(!e.value||!t.value)return!1;const J=e.value[R],Z=t.value[R];return!J||!Z?!1:!Nn(J[$],Z[$])}function M(R){return t.value?t.value[R]:e.value[R]}function Y(R,$){const J=t.value||e.value;return J[R]?J[R][$]:void 0}function B(R,$){const J=r.value&&t.value?t.value:e.value;return J[R]?J[R][$]:!1}function N(R,$){return v.value[R+"."+$]||null}function L(R,$){return Ew[R+"."+$]||null}function O(R,$,J){t.value&&($===null?t.value[R]=J:(t.value[R]||(t.value[R]={}),t.value[R][$]=J),t.value={...t.value})}function q(R,$,J){if(!t.value)return;const Z=Gi(t.value);O(R,$,J),d.value.push(Z),d.value.length>Rw&&d.value.shift(),f.value=[]}function ve(R,$,J){try{const Z=JSON.parse(J);q(R,$,Z)}catch{}}function me(){d.value.length!==0&&(f.value.push(Gi(t.value)),t.value=d.value.pop())}function ie(){f.value.length!==0&&(d.value.push(Gi(t.value)),t.value=f.value.pop())}function he(R,$,J){if(!t.value||!t.value[R])return;const Z=[...t.value[R][$]];Z.splice(J,1),q(R,$,Z)}function X(R,$){if(!t.value||!t.value[R])return;const J=[...t.value[R][$]||[]],Z=prompt("Enter new value:");Z!==null&&(J.push(Z),q(R,$,J))}function ue(R){a.value={...a.value,[R]:!a.value[R]}}function Ie(R){l.value={...l.value,[R]:!l.value[R]}}function z(R){i.value={...i.value,[R]:!i.value[R]}}function re(R){try{return JSON.stringify(R,null,2)}catch{return String(R)}}function le(R){return R==null?"null":typeof R=="object"?JSON.stringify(R,null,2):String(R)}function pe(R,$){c.value={type:R,message:$},setTimeout(()=>{c.value=null},3e3)}function ge(){t.value=Gi(e.value),r.value=!0,d.value=[],f.value=[]}function Le(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function C(){if(!(!k.value||b.value)){o.value=!0;try{const R=Dw(e.value,t.value);if(Object.keys(R).length===0){pe("success","No changes to save."),o.value=!1;return}const $=await K.put("/api/config",R);e.value=$,r.value=!1,t.value=null,d.value=[],f.value=[],pe("success","Config saved successfully.")}catch(R){pe("error",R.message||"Failed to save config")}o.value=!1}}async function P(){s.value=!0,n.value=null;try{e.value=await K.get("/api/config");for(const R of Object.keys(e.value))a.value[R]===void 0&&(a.value[R]=!0);for(const R of Fr)l.value[R.key]===void 0&&(l.value[R.key]=!0)}catch(R){n.value=R.message}s.value=!1}function W(R){r.value&&((R.ctrlKey||R.metaKey)&&!R.shiftKey&&R.key==="z"?(R.preventDefault(),me()):(R.ctrlKey||R.metaKey)&&(R.key==="y"||R.shiftKey&&R.key==="z"||R.shiftKey&&R.key==="Z")&&(R.preventDefault(),ie()))}return $e(()=>{P(),document.addEventListener("keydown",W)}),ft(()=>{document.removeEventListener("keydown",W)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:b,changeCount:E,REDACTED:og,showDiffModal:u,diffEntries:S,canUndo:p,canRedo:m,sectionCount:x,groupCount:A,visibleGroups:I,ungroupedSections:w,validationErrors:v,isSensitiveKey:Iw,isRedacted:Nw,sectionChanged:D,groupChanged:V,fieldChanged:F,getDisplay:T,getEdited:M,getEditedField:Y,getDisplayBool:B,pushEdit:q,pushEditJson:ve,getValidationError:N,getEnumOptions:L,removeArrayItem:he,addArrayItem:X,toggleSection:ue,toggleGroup:Ie,toggleNested:z,formatJson:re,formatDiffVal:le,showToast:pe,showDiff:y,fetchConfig:P,startEdit:ge,cancelEdit:Le,saveConfig:C,undo:me,redo:ie}}},Pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=te(()=>{const L={};for(const O of u.value)L[O.id]=O;return L});function p(L){return f.value[L]||null}const m=te(()=>/^\d{15,25}$/.test(r.value.trim())),g=te(()=>{const L=r.value.toLowerCase().trim();return L?u.value.filter(O=>!i.value[O.id]&&(O.display_name.toLowerCase().includes(L)||O.username.toLowerCase().includes(L)||O.id.includes(L))):u.value.filter(O=>!i.value[O.id])});function k(L,O){return L?L.allowed_hosts===null||L.allowed_hosts===void 0?{allowed_hosts:[...O],default_host:L.default_host||"",allow_all:!0}:{allowed_hosts:L.allowed_hosts,default_host:L.default_host||"",allow_all:!1}:{allowed_hosts:[...O],default_host:O[0]||"",allow_all:!0}}async function E(){e.value=!0,t.value="";try{const L=await K.get("/api/host-access");s.value=L,n.value=L.available_hosts||[],a.value=k(L.default_policy,n.value);const O=L.users||{},q={};for(const[ve,me]of Object.entries(O))q[ve]=k(me,n.value);i.value=q}catch(L){t.value=L.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await K.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const L=a.value.allow_all?null:a.value.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:L,default_host:a.value.default_host}),xe.success("Default policy updated")}catch(L){xe.error(L.message||"Failed to save")}}function b(L,O){a.value.allow_all=!1,O?a.value.allowed_hosts.includes(L)||a.value.allowed_hosts.push(L):(a.value.allowed_hosts=a.value.allowed_hosts.filter(q=>q!==L),a.value.default_host===L&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function x(L){const O=i.value[L];if(O)try{const q=O.allow_all?null:O.allowed_hosts;await K.put(`/api/host-access/user/${L}`,{allowed_hosts:q,default_host:O.default_host});const ve=p(L);xe.success(`Updated access for ${ve?ve.display_name:L}`)}catch(q){xe.error(q.message||"Failed to save")}}function A(L,O,q){const ve=i.value[L];ve&&(ve.allow_all=!1,q?ve.allowed_hosts.includes(O)||ve.allowed_hosts.push(O):(ve.allowed_hosts=ve.allowed_hosts.filter(me=>me!==O),ve.default_host===O&&(ve.default_host=ve.allowed_hosts[0]||"")),x(L))}function S(L,O){const q=i.value[L];q&&(q.default_host=O,x(L))}function I(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function w(){o.value=!0,c.value=0}function T(){c.value<g.value.length-1&&c.value++}function D(){c.value>0&&c.value--}function V(){const L=g.value[c.value];if(L){M(L);return}m.value&&F()}function F(){const L=r.value.trim();/^\d{15,25}$/.test(L)&&(i.value[L]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(L),r.value="",o.value=!1,l.value=!1)}function M(L){i.value[L.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(L.id),r.value="",o.value=!1,l.value=!1}function Y(){o.value=!1}function B(){setTimeout(()=>{o.value=!1},150)}async function N(L){const O=p(L);if(await ns({title:"Remove user override",message:`Remove the host access override for ${O?O.display_name:L}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await K.del(`/api/host-access/user/${L}`),delete i.value[L],xe.success(`Removed override for ${O?O.display_name:L}`)}catch(ve){xe.error(ve.message||"Failed to delete")}}return $e(E),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:g,isRawId:m,searchInput:d,fetchData:E,saveDefaultPolicy:v,toggleDefaultHost:b,getMember:p,toggleUserHost:A,setUserDefault:S,openAddUser:I,deleteUser:N,onSearchInput:w,highlightNext:T,highlightPrev:D,selectHighlighted:V,selectMember:M,closeDropdown:Y,onBlur:B,addRawId:F}}},Fw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=te(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=te(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(w){return w==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":w==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const w=await K.get("/api/tokens");s.value=w.tokens||[],n.value=w.available_hosts||[]}catch(w){t.value=w.message||"Failed to load tokens"}finally{e.value=!1}}function g(w){return!w||!w.trim()?[]:w.split(",").map(T=>T.trim()).filter(Boolean)}function k(w,T){const D=c.value.allowed_hosts;if(T&&!D.includes(w)&&D.push(w),!T){const V=D.indexOf(w);V>=0&&D.splice(V,1)}}function E(w,T){const D=u.value.allowed_hosts;if(T&&!D.includes(w)&&D.push(w),!T){const V=D.indexOf(w);V>=0&&D.splice(V,1)}}async function v(){var w;i.value=!0;try{const T=g(c.value.allowed_tools_str),D=c.value.host_mode,V=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,F={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:T.length?T:[]};V!==null&&(F.allowed_hosts=V),F.default_host=c.value.default_host||"";const M=await K.post("/api/tokens",F);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,xe.success("Token created"),await m()}catch(T){xe.error(((w=T.data)==null?void 0:w.error)||T.message||"Failed to create token")}finally{i.value=!1}}function b(w){r.value=w;const T=w.allowed_hosts;let D="default";T==null?D="default":Array.isArray(T)&&T.length===0?D="none":Array.isArray(T)&&(D="select"),u.value={username:w.username||"",tier:w.tier||"admin",label:w.label||"",host_mode:D,allowed_hosts:Array.isArray(T)?[...T]:[],default_host:w.default_host||"",allowed_tools_str:(w.allowed_tools||[]).join(", ")}}async function x(){var w;if(r.value){o.value=!0;try{const T=g(u.value.allowed_tools_str),D=u.value.host_mode,V={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:T};D==="none"?V.allowed_hosts=[]:D==="select"?V.allowed_hosts=u.value.allowed_hosts:V.allowed_hosts=null,V.default_host=u.value.default_host||"",await K.put("/api/tokens/"+encodeURIComponent(r.value.user_id),V),r.value=null,xe.success("Token updated"),await m()}catch(T){xe.error(((w=T.data)==null?void 0:w.error)||T.message||"Failed to update")}finally{o.value=!1}}}async function A(w){var D;if(await ns({title:"Regenerate token",message:`Regenerate token for ${w.username||w.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const V=await K.post("/api/tokens/"+encodeURIComponent(w.user_id)+"/regenerate");l.value=V.token,xe.success("Token regenerated")}catch(V){xe.error(((D=V.data)==null?void 0:D.error)||V.message||"Failed to regenerate")}}async function S(w){var D;if(await ns({title:"Delete token",message:`Delete token for ${w.username||w.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/tokens/"+encodeURIComponent(w.user_id)),xe.success("Token deleted"),await m()}catch(V){xe.error(((D=V.data)==null?void 0:D.error)||V.message||"Failed to delete")}}async function I(){if(l.value)try{await navigator.clipboard.writeText(l.value),xe.success("Copied to clipboard")}catch{xe.error("Copy failed — select and copy manually")}}return $e(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:k,toggleEditHost:E,createToken:v,startEdit:b,saveEdit:x,confirmRegenerate:A,confirmDelete:S,copyToken:I}}},$w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096}),a=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),i=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),l=h(!1),r=h(!1),o=h(!1),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h({configured:!1}),m=h([]),g=h(""),k=h(!1),E=h(!1),v=h({configured:!1}),b=h([]),x=h(""),A=h(!1),S=h(!1),I=h(!0),w=h(""),T=h({configured:!1,accounts:[]}),D=h(null),V=h(null),F=h(""),M=h(null),Y=h(!1),B=h(null),N=h(null),L=h("");let O=null;function q(U,ee="success"){xe(U,ee==="error"?"error":"success")}function ve(U){if(!U)return"?";const ee=U/(1024*1024*1024);return ee>=1?ee.toFixed(1)+" GB":(U/(1024*1024)).toFixed(0)+" MB"}async function me(){e.value=!0,await Promise.all([ie(),he(),le(),X()]),e.value=!1}async function ie(){try{const U=await K.get("/api/llm/status");t.value=U,s.value=U.active_provider||"codex",U.codex&&(n.value.enabled=U.codex.enabled,n.value.model=U.codex.model||"gpt-5.5",n.value.max_tokens=U.codex.max_tokens||4096),U.ollama&&(a.value.enabled=U.ollama.enabled,a.value.base_url=U.ollama.base_url||"",a.value.model=U.ollama.model||"",a.value.max_tokens=U.ollama.max_tokens||4096),U.kimi&&(i.value.enabled=U.kimi.enabled,i.value.model=U.kimi.model||"",i.value.max_tokens=U.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function he(){try{if(p.value=await K.get("/api/ollama/status"),p.value.model&&(g.value=p.value.model),p.value.configured)try{const U=await K.get("/api/ollama/models");m.value=U.models||[]}catch{m.value=[]}else if(a.value.base_url)try{const U=await K.post("/api/ollama/probe-models",{base_url:a.value.base_url});m.value=U.models||[]}catch{m.value=[]}}catch{p.value={configured:!1}}}async function X(){I.value=!0,w.value="";try{T.value=await K.get("/api/codex/status")}catch(U){w.value=U.message||"Failed to fetch Codex status"}finally{I.value=!1}}async function ue(){const U=t.value?t.value.active_provider:"codex";f.value=!0;try{const ee=await K.post("/api/llm/switch",{provider:s.value});ee.error?(s.value=U,q(ee.error,"error")):(q("Switched to "+s.value+" ("+ee.model+")"),await me())}catch(ee){s.value=U,q(ee.message||"Switch failed","error")}finally{f.value=!1}}async function Ie(){k.value=!0;try{const U=await K.post("/api/ollama/reload");q(U.configured?"Ollama reloaded":U.reason||"Ollama not configured",U.configured?"success":"error"),await me()}catch(U){q(U.message||"Reload failed","error")}finally{k.value=!1}}async function z(){E.value=!0;try{await K.post("/api/ollama/model",{model:g.value}),q("Model set to "+g.value),await me()}catch(U){q(U.message||"Failed","error")}finally{E.value=!1}}async function re(){const U=a.value.base_url;if(!U){q("Enter a base URL first","error");return}d.value=!0;try{const ee=await K.post("/api/ollama/probe-models",{base_url:U});m.value=ee.models||[],m.value.length?(q(m.value.length+" model(s) found"),!a.value.model&&m.value.length&&(a.value.model=m.value[0].name)):q("No models found at "+U,"error")}catch(ee){q(ee.message||"Could not reach Ollama","error")}finally{d.value=!1}}async function le(){try{if(v.value=await K.get("/api/kimi/status"),v.value.model&&(x.value=v.value.model),v.value.configured)try{const U=await K.get("/api/kimi/models");b.value=U.models||[]}catch{b.value=[]}}catch{v.value={configured:!1}}}async function pe(){A.value=!0;try{const U=await K.post("/api/kimi/reload");q(U.configured?"Kimi reloaded":U.reason||"Kimi not configured",U.configured?"success":"error"),await me()}catch(U){q(U.message||"Reload failed","error")}finally{A.value=!1}}async function ge(){S.value=!0;try{await K.post("/api/kimi/model",{model:x.value}),q("Model set to "+x.value),await me()}catch(U){q(U.message||"Failed","error")}finally{S.value=!1}}async function Le(){o.value=!0;try{await K.put("/api/llm/codex/config",n.value),q("Codex config saved"),await me()}catch(U){q(U.message||"Failed","error")}finally{o.value=!1}}async function y(){c.value=!0;try{const U={...a.value};l.value||delete U.api_key,await K.put("/api/llm/ollama/config",U),q("Ollama config saved"),a.value.api_key="",l.value=!1,await me()}catch(U){q(U.message||"Failed","error")}finally{c.value=!1}}async function C(){u.value=!0;try{const U={...i.value};r.value||delete U.api_key,await K.put("/api/llm/kimi/config",U),q("Kimi config saved"),i.value.api_key="",r.value=!1,await me()}catch(U){q(U.message||"Failed","error")}finally{u.value=!1}}async function P(U){try{await K.post("/api/codex/account/"+U+"/activate"),q("Active account switched"),await X()}catch(ee){q(ee.message||"Failed","error")}}async function W(U){D.value=U;try{await K.post("/api/codex/account/"+U+"/refresh"),q("Token refreshed"),await X()}catch(ee){q(ee.message||"Refresh failed","error")}finally{D.value=null}}function R(U,ee){V.value=U,F.value=ee||""}async function $(U){try{await K.put("/api/codex/account/"+U+"/label",{label:F.value}),q("Label updated"),V.value=null,await X()}catch(ee){q(ee.message||"Failed","error")}}async function J(U,ee){if(await ns({title:"Delete Codex account",message:`Delete ${ee||"account #"+(U+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+U),q("Deleted. Pool reloaded."),await X()}catch(be){q(be.message||"Failed","error")}}async function Z(){Y.value=!0;try{const U=await K.post("/api/codex/device-code");B.value=U,M.value="pending",se(U)}catch(U){q(U.message||"Failed","error")}finally{Y.value=!1}}async function se(U){O={cancelled:!1};const ee=O;try{const oe=await K.post("/api/codex/device-poll",{device_auth_id:U.device_auth_id,user_code:U.user_code,interval:U.interval});if(ee.cancelled)return;N.value=oe,M.value="success",await me()}catch(oe){if(ee.cancelled)return;L.value=oe.message||"Device login failed",M.value="error"}}function Q(){O&&(O.cancelled=!0),M.value=null,B.value=null}return $e(me),ft(()=>{O&&(O.cancelled=!0)}),{loading:e,llmStatus:t,selectedProvider:s,switching:f,codexForm:n,ollamaForm:a,kimiForm:i,savingCodex:o,savingOllama:c,savingKimi:u,probingOllama:d,ollamaKeyDirty:l,kimiKeyDirty:r,ollamaStatus:p,ollamaModels:m,ollamaSelectedModel:g,reloading:k,settingModel:E,kimiStatus:v,kimiModels:b,kimiSelectedModel:x,reloadingKimi:A,settingKimiModel:S,codexLoading:I,codexError:w,codexData:T,refreshing:D,editingLabel:V,labelValue:F,deviceState:M,deviceLoading:Y,deviceInfo:B,deviceResult:N,deviceError:L,fetchAll:me,switchProvider:ue,reloadOllama:Ie,setOllamaModel:z,reloadKimi:pe,setKimiModel:ge,probeOllamaModels:re,saveCodexConfig:Le,saveOllamaConfig:y,saveKimiConfig:C,activateAccount:P,refreshAccount:W,startEditLabel:R,saveLabel:$,deleteAccount:J,startDeviceLogin:Z,cancelDeviceLogin:Q,formatSize:ve}}},Fd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Bw(e){return Fd[e]||Fd[(e||"").toLowerCase()]||"text-gray-400"}const Uw={template:`
