 ...
 */let R_=()=>location.protocol+"//"+location.host;function mm(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),xu(r,"")}return xu(s,e)+n+a}function I_(e,t,s,n){let a=[],i=[],l=null;const r=({state:p})=>{const f=mm(e,location),v=s.value,b=t.value;let E=0;if(p){if(s.value=f,t.value=p,l&&l===v){l=null;return}E=b?p.position-b.position:0}else n(f);a.forEach(O=>{O(s.value,v,{delta:E,type:Vo.pop,direction:E?E>0?no.forward:no.back:no.unknown})})};function o(){l=s.value}function c(p){a.push(p);const f=()=>{const v=a.indexOf(p);v>-1&&a.splice(v,1)};return i.push(f),f}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(nt({},p.state,{scroll:Pr()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:o,listen:c,destroy:u}}function Tu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?Pr():null}}function O_(e){const{history:t,location:s}=window,n={value:mm(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+o:R_()+e+o;try{t[d?"replaceState":"pushState"](c,"",p),a.value=c}catch(f){console.error(f),s[d?"replace":"assign"](p)}}function l(o,c){i(o,nt({},t.state,Tu(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const d=nt({},a.value,t.state,{forward:o,scroll:Pr()});i(d.current,d,!0),i(o,nt({},Tu(n.value,o,null),{position:d.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function N_(e){e=m_(e);const t=O_(e),s=I_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=nt({location:"",base:e,go:n,createHref:g_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function L_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),N_(e)}let aa=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var It=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(It||{});const M_={type:aa.Static,value:""},D_=/[a-zA-Z0-9_]/;function P_(e){if(!e)return[[]];if(e==="/")return[[M_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(f){throw new Error(`ERR (${s})/"${c}": ${f}`)}let s=It.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",d="";function u(){c&&(s===It.Static?i.push({type:aa.Static,value:c}):s===It.Param||s===It.ParamRegExp||s===It.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:aa.Param,value:c,regexp:d,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==It.ParamRegExp){n=s,s=It.EscapeNext;continue}switch(s){case It.Static:o==="/"?(c&&u(),l()):o===":"?(u(),s=It.Param):p();break;case It.EscapeNext:p(),s=n;break;case It.Param:o==="("?s=It.ParamRegExp:D_.test(o)?p():(u(),s=It.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case It.ParamRegExp:o===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+o:s=It.ParamRegExpEnd:d+=o;break;case It.ParamRegExpEnd:u(),s=It.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,d="";break;default:t("Unknown state");break}}return s===It.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const Cu="[^/]+?",F_={sensitive:!1,strict:!1,start:!0,end:!0};var ts=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(ts||{});const $_=/[.+*?^${}()[\]/\\]/g;function U_(e,t){const s=nt({},F_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[ts.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const p=c[u];let f=ts.Segment+(s.sensitive?ts.BonusCaseSensitive:0);if(p.type===aa.Static)u||(a+="/"),a+=p.value.replace($_,"\\$&"),f+=ts.Static;else if(p.type===aa.Param){const{value:v,repeatable:b,optional:E,regexp:O}=p;i.push({name:v,repeatable:b,optional:E});const y=O||Cu;if(y!==Cu){f+=ts.BonusCustomRegExp;try{`${y}`}catch(x){throw new Error(`Invalid custom RegExp for param "${v}" (${y}): `+x.message)}}let m=b?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(m=E&&c.length<2?`(?:/${m})`:"/"+m),E&&(m+="?"),a+=m,f+=ts.Dynamic,E&&(f+=ts.BonusOptional),b&&(f+=ts.BonusRepeatable),y===".*"&&(f+=ts.BonusWildcard)}d.push(f)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=ts.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const f=d[p]||"",v=i[p-1];u[v.name]=f&&v.repeatable?f.split("/"):f}return u}function o(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const f of p)if(f.type===aa.Static)d+=f.value;else if(f.type===aa.Param){const{value:v,repeatable:b,optional:E}=f,O=v in c?c[v]:"";if(js(O)&&!b)throw new Error(`Provided param "${v}" is an array but it is not repeatable (* or + modifiers)`);const y=js(O)?O.join("/"):O;if(!y)if(E)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${v}"`);d+=y}}return d||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function B_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===ts.Static+ts.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===ts.Static+ts.Segment?1:-1:0}function vm(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=B_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Eu(n))return 1;if(Eu(a))return-1}return a.length-n.length}function Eu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const H_={strict:!1,end:!0,sensitive:!1};function z_(e,t,s){const n=U_(P_(e.path),s),a=nt(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function j_(e,t){const s=[],n=new Map;t=yu(H_,t);function a(u){return n.get(u)}function i(u,p,f){const v=!f,b=Ru(u);b.aliasOf=f&&f.record;const E=yu(t,u),O=[b];if("alias"in u){const x=typeof u.alias=="string"?[u.alias]:u.alias;for(const S of x)O.push(Ru(nt({},b,{components:f?f.record.components:b.components,path:S,aliasOf:f?f.record:b})))}let y,m;for(const x of O){const{path:S}=x;if(p&&S[0]!=="/"){const g=p.record.path,k=g[g.length-1]==="/"?"":"/";x.path=p.record.path+(S&&k+S)}if(y=z_(x,p,E),f?f.alias.push(y):(m=m||y,m!==y&&m.alias.push(y),v&&u.name&&!Iu(y)&&l(u.name)),gm(y)&&o(y),b.children){const g=b.children;for(let k=0;k<g.length;k++)i(g[k],y,f&&f.children[k])}f=f||y}return m?()=>{l(m)}:Ii}function l(u){if(fm(u)){const p=n.get(u);p&&(n.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function r(){return s}function o(u){const p=G_(u,s);s.splice(p,0,u),u.record.name&&!Iu(u)&&n.set(u.record.name,u)}function c(u,p){let f,v={},b,E;if("name"in u&&u.name){if(f=n.get(u.name),!f)throw ti(bt.MATCHER_NOT_FOUND,{location:u});E=f.record.name,v=nt(Au(p.params,f.keys.filter(m=>!m.optional).concat(f.parent?f.parent.keys.filter(m=>m.optional):[]).map(m=>m.name)),u.params&&Au(u.params,f.keys.map(m=>m.name))),b=f.stringify(v)}else if(u.path!=null)b=u.path,f=s.find(m=>m.re.test(b)),f&&(v=f.parse(b),E=f.record.name);else{if(f=p.name?n.get(p.name):s.find(m=>m.re.test(p.path)),!f)throw ti(bt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});E=f.record.name,v=nt({},p.params,u.params),b=f.stringify(v)}const O=[];let y=f;for(;y;)O.unshift(y.record),y=y.parent;return{name:E,path:b,params:v,matched:O,meta:q_(O)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:r,getRecordMatcher:a}}function Au(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Ru(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:V_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function V_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function Iu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function q_(e){return e.reduce((t,s)=>nt(t,s.meta),{})}function G_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;vm(e,t[i])<0?n=i:s=i+1}const a=K_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function K_(e){let t=e;for(;t=t.parent;)if(gm(t)&&vm(e,t)===0)return t}function gm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Ou(e){const t=Ns(Fr),s=Ns(Jc),n=K(()=>{const o=en(e.to);return t.resolve(o)}),a=K(()=>{const{matched:o}=n.value,{length:c}=o,d=o[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(ei.bind(null,d));if(p>-1)return p;const f=Nu(o[c-2]);return c>1&&Nu(d)===f&&u[u.length-1].path!==f?u.findIndex(ei.bind(null,o[c-2])):p}),i=K(()=>a.value>-1&&Q_(s.params,n.value.params)),l=K(()=>a.value>-1&&a.value===s.matched.length-1&&pm(s.params,n.value.params));function r(o={}){if(Y_(o)){const c=t[en(e.replace)?"replace":"push"](en(e.to)).catch(Ii);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:K(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function W_(e){return e.length===1?e[0]:e}const Z_=sl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Ou,setup(e,{slots:t}){const s=zn(Ou(e)),{options:n}=Ns(Fr),a=K(()=>({[Lu(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[Lu(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&W_(t.default(s));return e.custom?i:Ka("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),J_=Z_;function Y_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function Q_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!js(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function Nu(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Lu=(e,t,s)=>e??t??s,X_=sl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Ns(Go),a=K(()=>e.route||n.value),i=Ns(Su,0),l=K(()=>{let c=en(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),r=K(()=>a.value.matched[l.value]);Ti(Su,K(()=>l.value+1)),Ti(E_,r),Ti(Go,a);const o=h();return as(()=>[o.value,r.value,e.name],([c,d,u],[p,f,v])=>{d&&(d.instances[u]=c,f&&f!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=f.leaveGuards),d.updateGuards.size||(d.updateGuards=f.updateGuards))),c&&d&&(!f||!ei(d,f)||!p)&&(d.enterCallbacks[u]||[]).forEach(b=>b(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=r.value,p=u&&u.components[d];if(!p)return Mu(s.default,{Component:p,route:c});const f=u.props[d],v=f?f===!0?c.params:typeof f=="function"?f(c):f:null,E=Ka(p,nt({},v,t,{onVnodeUnmounted:O=>{O.component.isUnmounted&&(u.instances[d]=null)},ref:o}));return Mu(s.default,{Component:E,route:c})||E}}});function Mu(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const ew=X_;function tw(e){const t=j_(e.routes,e),s=e.parseQuery||T_,n=e.stringifyQuery||ku,a=e.history,i=hi(),l=hi(),r=hi(),o=lc(Nn);let c=Nn;Oa&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=to.bind(null,B=>""+B),u=to.bind(null,o_),p=to.bind(null,Yi);function f(B,ie){let le,_e;return fm(B)?(le=t.getRecordMatcher(B),_e=ie):_e=B,t.addRoute(_e,le)}function v(B){const ie=t.getRecordMatcher(B);ie&&t.removeRoute(ie)}function b(){return t.getRoutes().map(B=>B.record)}function E(B){return!!t.getRecordMatcher(B)}function O(B,ie){if(ie=nt({},ie||o.value),typeof B=="string"){const L=so(s,B,ie.path),$=t.resolve({path:L.path},ie),te=a.createHref(L.fullPath);return nt(L,$,{params:p($.params),hash:Yi(L.hash),redirectedFrom:void 0,href:te})}let le;if(B.path!=null)le=nt({},B,{path:so(s,B.path,ie.path).path});else{const L=nt({},B.params);for(const $ in L)L[$]==null&&delete L[$];le=nt({},B,{params:u(L)}),ie.params=u(ie.params)}const _e=t.resolve(le,ie),ye=B.hash||"";_e.params=d(p(_e.params));const $e=u_(n,nt({},B,{hash:i_(ye),path:_e.path})),w=a.createHref($e);return nt({fullPath:$e,hash:ye,query:n===ku?C_(B.query):B.query||{}},_e,{redirectedFrom:void 0,href:w})}function y(B){return typeof B=="string"?so(s,B,o.value.path):nt({},B)}function m(B,ie){if(c!==B)return ti(bt.NAVIGATION_CANCELLED,{from:ie,to:B})}function x(B){return k(B)}function S(B){return x(nt(y(B),{replace:!0}))}function g(B,ie){const le=B.matched[B.matched.length-1];if(le&&le.redirect){const{redirect:_e}=le;let ye=typeof _e=="function"?_e(B,ie):_e;return typeof ye=="string"&&(ye=ye.includes("?")||ye.includes("#")?ye=y(ye):{path:ye},ye.params={}),nt({query:B.query,hash:B.hash,params:ye.path!=null?{}:B.params},ye)}}function k(B,ie){const le=c=O(B),_e=o.value,ye=B.state,$e=B.force,w=B.replace===!0,L=g(le,_e);if(L)return k(nt(y(L),{state:typeof L=="object"?nt({},ye,L.state):ye,force:$e,replace:w}),ie||le);const $=le;$.redirectedFrom=ie;let te;return!$e&&p_(n,_e,le)&&(te=ti(bt.NAVIGATION_DUPLICATED,{to:$,from:_e}),Ee(_e,_e,!0,!1)),(te?Promise.resolve(te):D($,_e)).catch(Y=>rn(Y)?rn(Y,bt.NAVIGATION_GUARD_REDIRECT)?Y:Ce(Y):I(Y,$,_e)).then(Y=>{if(Y){if(rn(Y,bt.NAVIGATION_GUARD_REDIRECT))return k(nt({replace:w},y(Y.to),{state:typeof Y.to=="object"?nt({},ye,Y.to.state):ye,force:$e}),ie||$)}else Y=P($,_e,!0,w,ye);return H($,_e,Y),Y})}function T(B,ie){const le=m(B,ie);return le?Promise.reject(le):Promise.resolve()}function C(B){const ie=ne.values().next().value;return ie&&typeof ie.runWithContext=="function"?ie.runWithContext(B):B()}function D(B,ie){let le;const[_e,ye,$e]=A_(B,ie);le=ao(_e.reverse(),"beforeRouteLeave",B,ie);for(const L of _e)L.leaveGuards.forEach($=>{le.push($n($,B,ie))});const w=T.bind(null,B,ie);return le.push(w),Z(le).then(()=>{le=[];for(const L of i.list())le.push($n(L,B,ie));return le.push(w),Z(le)}).then(()=>{le=ao(ye,"beforeRouteUpdate",B,ie);for(const L of ye)L.updateGuards.forEach($=>{le.push($n($,B,ie))});return le.push(w),Z(le)}).then(()=>{le=[];for(const L of $e)if(L.beforeEnter)if(js(L.beforeEnter))for(const $ of L.beforeEnter)le.push($n($,B,ie));else le.push($n(L.beforeEnter,B,ie));return le.push(w),Z(le)}).then(()=>(B.matched.forEach(L=>L.enterCallbacks={}),le=ao($e,"beforeRouteEnter",B,ie,C),le.push(w),Z(le))).then(()=>{le=[];for(const L of l.list())le.push($n(L,B,ie));return le.push(w),Z(le)}).catch(L=>rn(L,bt.NAVIGATION_CANCELLED)?L:Promise.reject(L))}function H(B,ie,le){r.list().forEach(_e=>C(()=>_e(B,ie,le)))}function P(B,ie,le,_e,ye){const $e=m(B,ie);if($e)return $e;const w=ie===Nn,L=Oa?history.state:{};le&&(_e||w?a.replace(B.fullPath,nt({scroll:w&&L&&L.scroll},ye)):a.push(B.fullPath,ye)),o.value=B,Ee(B,ie,le,w),Ce()}let R;function V(){R||(R=a.listen((B,ie,le)=>{if(!be.listening)return;const _e=O(B),ye=g(_e,be.currentRoute.value);if(ye){k(nt(ye,{replace:!0,force:!0}),_e).catch(Ii);return}c=_e;const $e=o.value;Oa&&x_(wu($e.fullPath,le.delta),Pr()),D(_e,$e).catch(w=>rn(w,bt.NAVIGATION_ABORTED|bt.NAVIGATION_CANCELLED)?w:rn(w,bt.NAVIGATION_GUARD_REDIRECT)?(k(nt(y(w.to),{force:!0}),_e).then(L=>{rn(L,bt.NAVIGATION_ABORTED|bt.NAVIGATION_DUPLICATED)&&!le.delta&&le.type===Vo.pop&&a.go(-1,!1)}).catch(Ii),Promise.reject()):(le.delta&&a.go(-le.delta,!1),I(w,_e,$e))).then(w=>{w=w||P(_e,$e,!1),w&&(le.delta&&!rn(w,bt.NAVIGATION_CANCELLED)?a.go(-le.delta,!1):le.type===Vo.pop&&rn(w,bt.NAVIGATION_ABORTED|bt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),H(_e,$e,w)}).catch(Ii)}))}let X=hi(),U=hi(),N;function I(B,ie,le){Ce(B);const _e=U.list();return _e.length?_e.forEach(ye=>ye(B,ie,le)):console.error(B),Promise.reject(B)}function W(){return N&&o.value!==Nn?Promise.resolve():new Promise((B,ie)=>{X.add([B,ie])})}function Ce(B){return N||(N=!B,V(),X.list().forEach(([ie,le])=>B?le(B):ie()),X.reset()),B}function Ee(B,ie,le,_e){const{scrollBehavior:ye}=e;if(!Oa||!ye)return Promise.resolve();const $e=!le&&__(wu(B.fullPath,0))||(_e||!le)&&history.state&&history.state.scroll||null;return Ct().then(()=>ye(B,ie,$e)).then(w=>w&&y_(w)).catch(w=>I(w,B,ie))}const re=B=>a.go(B);let ge;const ne=new Set,be={currentRoute:o,listening:!0,addRoute:f,removeRoute:v,clearRoutes:t.clearRoutes,hasRoute:E,getRoutes:b,resolve:O,options:e,push:x,replace:S,go:re,back:()=>re(-1),forward:()=>re(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:U.add,isReady:W,install(B){B.component("RouterLink",J_),B.component("RouterView",ew),B.config.globalProperties.$router=be,Object.defineProperty(B.config.globalProperties,"$route",{enumerable:!0,get:()=>en(o)}),Oa&&!ge&&o.value===Nn&&(ge=!0,x(a.location).catch(_e=>{}));const ie={};for(const _e in Nn)Object.defineProperty(ie,_e,{get:()=>o.value[_e],enumerable:!0});B.provide(Fr,be),B.provide(Jc,ic(ie)),B.provide(Go,o);const le=B.unmount;ne.add(B),B.unmount=function(){ne.delete(B),ne.size<1&&(c=Nn,R&&R(),R=null,o.value=Nn,ge=!1,N=!1),le()}}};function Z(B){return B.reduce((ie,le)=>ie.then(()=>C(le)),Promise.resolve())}return be}function bm(){return Ns(Fr)}function sw(e){return Ns(Jc)}const $r={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=sw(),s=bm(),n=K({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=K(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=K(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});as(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},nw={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(p){var b,E,O,y,m;const f=p.payload||p,v=f.type||p.type;if(v==="tool_start"){const x=((b=f.metadata)==null?void 0:b.call_id)||null,S={callId:x,id:x||`${f.action}-${Date.now()}`,tool:f.action,actor:f.actor||"",channel:f.channel_id||"",iteration:((E=f.metadata)==null?void 0:E.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(S);return}if(v==="tool_end"){const x=((O=f.metadata)==null?void 0:O.call_id)||null;let S=-1;if(x&&(S=e.value.findIndex(g=>g.callId===x&&g.status==="running")),S<0&&!x)for(let g=e.value.length-1;g>=0;g--){const k=e.value[g];if(k.tool===f.action&&k.status==="running"){S=g;break}}if(S>=0){const g=e.value[S];g.status=(y=f.metadata)!=null&&y.error?"error":"success",g.elapsed=((m=f.metadata)==null?void 0:m.elapsed_ms)||Date.now()-g.startTime,g.result=f.detail||"",g.fadingOut=!0,setTimeout(()=>{const k=e.value.indexOf(g);k>=0&&e.value.splice(k,1),t.value.unshift(g),t.value.length>n&&t.value.pop()},5e3)}return}if(v==="tool_stream"){const x=f.call_id||f.tool_name||"unknown";if(f.finished){const S={...s.value};delete S[x],s.value=S}else{const g=((s.value[x]||"")+(f.chunk||"")).split(`
`);s.value={...s.value,[x]:g.slice(-30).join(`
...
... (truncated)`:s}function Du(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function wm(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Sm=Symbol("agent-detail-cancelled"),iw=15e3;function lw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((f,v)=>{o=f,c=v});function u(f,v){r||(r=!0,l!==null&&a(l),l=null,(f?o:c)(v))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return r||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sm),i==null||i.abort()}}}function Tm({state:e,requestDetail:t,timeoutMs:s=iw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const p=l;l=null,p==null||p.cancel()}function o(p,{initial:f,coalesce:v}){if(!p)return Promise.resolve();if(v&&l&&l.agentId===p&&e.detailId===p)return l.promise;r();const b={agentId:p,cancel:null,promise:null};l=b,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const E=lw(O=>t(p,{signal:O}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return b.cancel=E.cancel,b.promise=(async()=>{let O=null,y=null;try{O=await E.promise}catch(m){y=m}O!==Sm&&(l!==b||e.detailId!==p||(l=null,!y&&(O===null||typeof O!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=O,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,o(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?o(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function rw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const ow={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const r=h(null),o=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),v=h(!1),b=Fu,E=bw,O=h([]),y=h(!1),m=h(""),x=h("flat"),S=h(new Set),g=h(""),k=h(""),T=h(""),C=h(null),D=h(!1);function H(){try{const J=localStorage.getItem("odin-session-presets");J&&(O.value=JSON.parse(J))}catch{}}function P(){try{localStorage.setItem("odin-session-presets",JSON.stringify(O.value))}catch{}}const R=K(()=>p.value.trim()!==""||u.value!=="all"),V=K(()=>{let J=[...e.value];const Te=Fu.find(Ue=>Ue.id===u.value),Ie=Te?Te.filters:{};if(Ie.source&&(J=J.filter(Ue=>Ue.source===Ie.source)),Ie.minMessages&&(J=J.filter(Ue=>Ue.message_count>=Ie.minMessages)),Ie.hasCompaction&&(J=J.filter(Ue=>Ue.has_summary)),Ie.maxAge!=null){const Ue=Date.now()/1e3;J=J.filter(mt=>mt.last_active&&Ue-mt.last_active<=Ie.maxAge)}if(p.value.trim()){const Ue=p.value.toLowerCase().trim();J=J.filter(mt=>(mt.channel_id||"").toLowerCase().includes(Ue)||(mt.last_user_id||"").toLowerCase().includes(Ue)||(mt.source||"").toLowerCase().includes(Ue))}const Me=f.value,Ge=v.value?1:-1;return J.sort((Ue,mt)=>{const Yt=Ue[Me]||0,Ds=mt[Me]||0;return(Yt-Ds)*Ge}),J}),X=K(()=>{if(!a.value||!a.value.messages)return[];const J=a.value.messages;if(J.length===0)return[];const Te=[];let Ie=[];for(const Me of J)Me.role==="user"&&Ie.length>0&&(Te.push(Ie),Ie=[]),Ie.push(Me);return Ie.length>0&&Te.push(Ie),Te}),U=K(()=>V.value.length>0&&c.value.size===V.value.length);function N(J){const Te=J.find(Ie=>Ie.role==="user");if(Te&&Te.content){const Ie=Te.content.slice(0,120);return Ie.length<Te.content.length?Ie+"...":Ie}return"(no user message)"}function I(J){const Te=new Set(S.value);Te.has(J)?Te.delete(J):Te.add(J),S.value=Te}function W(J){u.value=J}function Ce(J){u.value=J.id,J.filters.searchQuery!=null&&(p.value=J.filters.searchQuery),J.filters.sortBy&&(f.value=J.filters.sortBy)}function Ee(){if(!m.value.trim())return;const J={id:"custom-"+Date.now(),name:m.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};O.value=[...O.value,J],P(),y.value=!1,m.value=""}function re(J){O.value=O.value.filter(Te=>Te.id!==J),P(),u.value===J&&(u.value="all")}function ge(){u.value="all",p.value="",f.value="last_active",v.value=!1}function ne(J){if(!J)return"—";const Te=Date.now()/1e3-J;if(Te<60)return"just now";if(Te<3600){const Me=Math.floor(Te/60);return`${Me} minute${Me!==1?"s":""} ago`}if(Te<86400){const Me=Math.floor(Te/3600);return`${Me} hour${Me!==1?"s":""} ago`}const Ie=Math.floor(Te/86400);return`${Ie} day${Ie!==1?"s":""} ago`}function be(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Z(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString()}catch{return""}}function B(J){return J==="user"?"bg-gray-900/50 border border-gray-800":J==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ie(J){return J==="user"?"sess-msg-user":J==="assistant"?"sess-msg-assistant":"sess-msg-system"}function le(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":"badge-warning"}function _e(J){return J==="user"?"sess-dot-user":J==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ye(J){return J==="user"?"text-cyan-400":J==="assistant"?"text-indigo-400":"text-gray-500"}function $e(J){return J?J.length>2e3?J.slice(0,2e3)+`
... (truncated)`:J:""}async function w(){const J=g.value.trim();if(J){D.value=!0;try{let Te=`/api/sessions/search?q=${encodeURIComponent(J)}&limit=50`;k.value.trim()&&(Te+=`&channel_id=${encodeURIComponent(k.value.trim())}`),T.value.trim()&&(Te+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Ie=await G.get(Te);C.value=Ie.results||[]}catch{C.value=[]}D.value=!1}}function L(){g.value="",k.value="",T.value="",C.value=null}function $(J){return J?J.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function te(J){return J==="user"?"fts-result-user":J==="assistant"?"fts-result-assistant":J==="summary"?"fts-result-summary":J==="fts"?"fts-result-fts":J==="channel"?"fts-result-channel":"fts-result-default"}function Y(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":J==="summary"?"badge-warning":J==="fts"?"badge-success":"badge-info"}async function ee(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(J){s.value=J.message}t.value=!1}function he(){s.value=null,ee()}async function de(J){if(n.value===J){n.value=null,a.value=null,S.value=new Set;return}n.value=J,a.value=null,i.value=!0,S.value=new Set;const Te=++l;try{const Ie=await G.get(`/api/sessions/${encodeURIComponent(J)}`);Te===l&&n.value===J&&(a.value=Ie)}catch(Ie){Te===l&&n.value===J&&(a.value={messages:[],summary:"",error:Ie.message||"Failed to load session"})}finally{Te===l&&(i.value=!1)}}function oe(J){const Te=new Set(c.value);Te.has(J)?Te.delete(J):Te.add(J),c.value=Te}function se(){U.value?c.value=new Set:c.value=new Set(V.value.map(J=>J.channel_id))}function ae(J){r.value=J}async function me(){if(r.value){o.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await ee()}catch(J){s.value=J.message||"Failed to clear session"}o.value=!1,r.value=null}}function F(){d.value=!0}async function ce(){if(c.value.size!==0){o.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await ee()}catch(J){s.value=J.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}async function xe(J,Te){const Ie=`/api/sessions/${encodeURIComponent(J)}/export?format=${Te}`;try{const Me=await G.getBlob(Ie),Ge=URL.createObjectURL(Me),Ue=document.createElement("a");Ue.href=Ge,Ue.download=`session-${J}.${Te==="text"?"txt":"json"}`,Ue.click(),URL.revokeObjectURL(Ge)}catch(Me){s.value=Me.message||"Failed to export session"}}let Se=null;function Le(J){J.payload&&J.payload.channel_id&&(clearTimeout(Se),Se=setTimeout(()=>{if(ee(),n.value&&J.payload.channel_id===n.value){const Te=n.value,Ie=l;G.get(`/api/sessions/${encodeURIComponent(Te)}`).then(Me=>{Ie!==l||n.value!==Te||(a.value=Me)}).catch(()=>{})}},2e3))}let ze=!1;function qe(){ze||(ze=!0,ee(),je.subscribe("events",Le))}Ze(()=>{H(),qe()}),ws(()=>{qe()});function dt(){ze&&(ze=!1,je.unsubscribe("events",Le),clearTimeout(Se))}return ks(dt),xt(dt),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:U,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:v,filterPresets:b,sortOptions:E,filteredSessions:V,hasActiveFilters:R,customPresets:O,showSavePreset:y,newPresetName:m,threadView:x,threads:X,collapsedThreads:S,ftsQuery:g,ftsChannelId:k,ftsUserId:T,ftsResults:C,ftsSearching:D,formatAge:ne,formatTimestamp:be,formatFullTimestamp:Z,messageClass:B,threadMsgClass:ie,roleBadge:le,roleDotClass:_e,roleLabelClass:ye,truncateContent:$e,threadSummary:N,fetchSessions:ee,retry:he,toggleSession:de,toggleSelect:oe,toggleSelectAll:se,confirmClear:ae,clearSession:me,confirmBulkClear:F,doBulkClear:ce,exportSession:xe,applyPreset:W,applyCustomPreset:Ce,saveCustomPreset:Ee,removeCustomPreset:re,resetFilters:ge,toggleThread:I,runFtsSearch:w,clearFtsSearch:L,highlightSnippet:$,ftsResultClass:te,ftsTypeBadge:Y}}},xw={props:["trace"],template:`
...
`)}const Ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),d=h(""),u=h(""),p=h(null),f=h(null),v=h(!1),b=h(null),E=h(null),O=h(!1),y=K(()=>e.value.length),m=K(()=>e.value.reduce((ne,be)=>ne+(be.execution_count||0),0)),x=K(()=>e.value.reduce((ne,be)=>ne+D(be.code),0)),S=K(()=>{if(!l.value)return e.value;const ne=l.value.toLowerCase();return e.value.filter(be=>be.name.toLowerCase().includes(ne)||(be.description||"").toLowerCase().includes(ne))}),g=K(()=>u.value?u.value.split(`
`).length:0),k=K(()=>{const ne=Math.max(g.value,1);return Array.from({length:ne},(be,Z)=>Z+1).join(`
...
`).length:0}function H(ne){return Cw(ne)}function P(ne){n.value={...n.value,[ne]:!n.value[ne]}}async function R(ne){try{await navigator.clipboard.writeText(ne);const be=e.value.find(Z=>Z.code===ne);be&&(r.value=be.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function V(ne){if(ne.key==="Tab"){ne.preventDefault();const be=ne.target,Z=be.selectionStart,B=be.selectionEnd;u.value=u.value.substring(0,Z)+"    "+u.value.substring(B),Ct(()=>{be.selectionStart=be.selectionEnd=Z+4})}}function X(ne){const be=ne.target.previousElementSibling;be&&(be.scrollTop=ne.target.scrollTop)}async function U(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(ne){s.value=ne.message}t.value=!1}async function N(ne){i.value=ne,delete a.value[ne],a.value={...a.value};try{const be=await G.post(`/api/skills/${encodeURIComponent(ne)}/test`);a.value={...a.value,[ne]:be}}catch(be){a.value={...a.value,[ne]:{result:be.message,is_error:!0}}}i.value=null}function I(){o.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function W(ne){o.value=!0,c.value="edit",d.value=ne.name,u.value=ne.code||"",p.value=null,f.value=null}function Ce(){o.value=!1,p.value=null,f.value=null}async function Ee(){p.value=null,f.value=null;const ne=d.value.trim(),be=u.value.trim();if(!ne){p.value="Name is required";return}if(!be){p.value="Code is required";return}v.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:ne,code:be}),f.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(ne)}`,{code:be}),f.value="Skill updated successfully"),await U(),setTimeout(()=>{o.value=!1},800)}catch(Z){p.value=Z.message}v.value=!1}function re(ne){E.value=ne}async function ge(){if(E.value){O.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(E.value)}`),await U()}catch(ne){Re.error(`Failed to delete skill: ${ne.message||"unknown error"}`)}O.value=!1,E.value=null}}return Ze(()=>{U()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:v,editorRef:b,deleteTarget:E,deleting:O,enabledCount:y,totalExecutions:m,totalLines:x,displayedSkills:S,editLineCount:g,editorLineNums:k,editValidation:T,highlight:C,truncate:Qc,formatTs:ba,countLines:D,getLineNumbers:H,toggleCode:P,copyCode:R,handleEditorKey:V,syncScroll:X,fetchSkills:U,testSkill:N,showCreate:I,editSkill:W,cancelEdit:Ce,saveSkill:Ee,confirmDelete:re,doDelete:ge}}};class Rs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Aw=/^[A-Za-z_][A-Za-z0-9_]*$/;function $u(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Uu(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const r=String((l==null?void 0:l.key)||"").trim(),o=String((l==null?void 0:l.value)??"");if(!(!r&&!o)){if(!r)throw new Rs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(r))throw new Rs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,r))throw new Rs(`${s} key “${r}” appears more than once.`,"authentication");if(i.has(r))throw new Rs(`${s} key “${r}” cannot be replaced and removed in the same save.`,"authentication");n[r]=o}}return{set:n,remove:a}}function Rw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Iw(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Rs("Server name is required.","name");if(a.length>128||!Aw.test(a))throw new Rs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,r={enabled:!!e.enabled,transport:i};if(n&&(r.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Rs("An executable path is required for a new stdio connection.","command");if(d&&(r.command=d),(n||e.replaceArgs)&&(r.args=$u(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Rs("Working directory must be an absolute path.","cwd");r.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Rs("An HTTP endpoint is required for this connection.","url");if(d&&!Rw(d))throw new Rs("Endpoint must be a valid http:// or https:// URL.","url");d&&(r.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Rs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");r.timeout_seconds=d}(n||e.replaceAllowlist)&&(r.tool_allowlist=$u(e.allowlistText));const o=Uu(e.headerRows,e.headersRemove,"Header"),c=Uu(e.envRows,e.envRemove,"Environment variable");return Object.keys(o.set).length&&(r.headers_set=o.set),o.remove.length&&(r.headers_remove=o.remove),Object.keys(c.set).length&&(r.env_set=c.set),c.remove.length&&(r.env_remove=c.remove),r}function Ow(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function Nw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Lw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const Mw=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function Dw(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Pw=1e4,Fw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function lo(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function $w(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Uw={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),r=h({}),o=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),v=h(lo()),b=h(""),E=h(!1);let O=null,y=0,m=!1,x=!1;const S=Mw,g=K(()=>{var F;return((F=e.value)==null?void 0:F.servers)||[]}),k=K(()=>{var F;return!!((F=e.value)!=null&&F.enabled)}),T=K(()=>{var F,ce,xe,Se;return{serverCount:((F=e.value)==null?void 0:F.server_count)||0,enabledCount:((ce=e.value)==null?void 0:ce.enabled_server_count)||0,connectedCount:((xe=e.value)==null?void 0:xe.connected_count)||0,toolCount:((Se=e.value)==null?void 0:Se.published_tool_count)||0}}),C=K(()=>{var F;return((F=f.value)==null?void 0:F.header_keys)||[]}),D=K(()=>{var F;return((F=f.value)==null?void 0:F.env_keys)||[]}),H=K(()=>{var F;return u.value==="edit"&&((F=f.value)==null?void 0:F.transport)==="http"}),P=K(()=>u.value==="add"||!H.value),R=K(()=>H.value?"Replace endpoint URL":"Endpoint URL"),V=K(()=>H.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function X(){U(),O=window.setInterval(()=>N({quiet:!0}),Pw)}function U(){O&&window.clearInterval(O),O=null}async function N({quiet:F=!1}={}){const ce=++y;F||(t.value=!0);try{const xe=await G.get("/api/mcp/status");if(ce!==y||!m)return;e.value=xe,n.value="";const Se=new Set((xe.servers||[]).map(Le=>Le.name));i.value=new Set([...i.value].filter(Le=>Se.has(Le)))}catch(xe){ce===y&&m&&(n.value=xe.message||"Failed to load MCP status")}finally{ce===y&&(t.value=!1)}}function I(F){return s.value||a.value.has(F)}function W(F,ce){const xe=new Set(a.value);ce?xe.add(F):xe.delete(F),a.value=xe}function Ce(F){return Nw(F.state)}function Ee(F){return Fw[Ce(F)]}function re(F){return F.transport==="http"?"Streamable HTTP":"stdio"}function ge(F){return F.negotiated_version?`${F.era?`${String(F.era).charAt(0).toUpperCase()}${String(F.era).slice(1)}`:"Protocol"} · ${F.negotiated_version}`:"Not negotiated"}function ne(F){return F.discovered_count?`${F.published_count||0} published · ${F.excluded_count||0} excluded`:"No tools discovered"}async function be(F){if(F!==k.value&&!(!F&&!await Zt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await G.post("/api/mcp/enabled",{enabled:F}),Re.success(F?"MCP enabled":"MCP disabled"),await N({quiet:!0})}catch(ce){Re.error(ce.message||"Failed to update MCP state"),await N({quiet:!0})}finally{s.value=!1}}}async function Z(F){W(F.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/reconnect`,{}),Re.success(`Reconnected ${F.name}`)}catch(ce){Re.error(ce.message||`Failed to reconnect ${F.name}`)}finally{W(F.name,!1),await N({quiet:!0})}}async function B(F){W(F.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/refresh-tools`,{}),Re.success(`Refreshed tools from ${F.name}`),await _e(F.name,!0)}catch(ce){Re.error(ce.message||`Failed to refresh ${F.name}`)}finally{W(F.name,!1),await N({quiet:!0})}}async function ie(F){if(await Zt({title:`Remove ${F.name}`,message:`Remove this saved MCP server? Its ${F.published_count||0} published tool${F.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){W(F.name,!0);try{await G.del(`/api/mcp/servers/${encodeURIComponent(F.name)}`),Re.success(`Removed ${F.name}`),delete r.value[F.name]}catch(xe){Re.error(xe.message||`Failed to remove ${F.name}`)}finally{W(F.name,!1),await N({quiet:!0})}}}async function le(F){const ce=new Set(i.value);if(ce.has(F.name)){ce.delete(F.name),i.value=ce;return}ce.add(F.name),i.value=ce,Object.hasOwn(r.value,F.name)||await _e(F.name)}async function _e(F,ce=!1){if(!ce&&Object.hasOwn(r.value,F))return;const xe=new Set(c.value);xe.add(F),c.value=xe,o.value={...o.value,[F]:""};try{const Se=await G.get(`/api/mcp/servers/${encodeURIComponent(F)}/tools`);r.value={...r.value,[F]:Se.tools||[]}}catch(Se){o.value={...o.value,[F]:Se.message||"Failed to load tools"}}finally{const Se=new Set(c.value);Se.delete(F),c.value=Se}}function ye(F){return(r.value[F]||[]).filter(ce=>Lw(ce,l.value[F]))}function $e(F,ce){l.value={...l.value,[F]:ce}}function w(){u.value="add",p.value="",f.value=null,v.value=lo(),b.value="",d.value=!0}function L(F){u.value="edit",p.value=F.name,f.value=F,v.value={...lo(),name:F.name,enabled:!!F.enabled,transport:F.transport||"stdio"},b.value="",d.value=!0}function $(){E.value||(d.value=!1)}function te(F){d.value&&Dw(F)}function Y(F){const ce=F==="headers"?"headerRows":"envRows";v.value[ce].push({key:"",value:""})}function ee(F,ce){const xe=F==="headers"?"headerRows":"envRows";v.value[xe].splice(ce,1)}function he(F,ce){const xe=F==="headers"?"headersRemove":"envRemove",Se=v.value[xe];v.value[xe]=Se.includes(ce)?Se.filter(Le=>Le!==ce):[...Se,ce]}async function de(){var ce,xe;b.value="";let F;try{F=Iw(v.value,{mode:u.value,originalTransport:((ce=f.value)==null?void 0:ce.transport)||""})}catch(Se){b.value=Se instanceof Rs?Se.message:"Invalid MCP server configuration",await Ct(),(xe=document.querySelector(".mcp-editor"))==null||xe.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Ow(F,f.value)&&!await Zt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){E.value=!0;try{u.value==="add"?await G.post("/api/mcp/servers",F):await G.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,F),Re.success(u.value==="add"?`Saved ${F.name}`:`Updated ${p.value}`),d.value=!1,await N({quiet:!0})}catch(Se){b.value=Se.message||"Failed to save MCP server"}finally{E.value=!1}}}let oe=null;function se(F){`${(F==null?void 0:F.event)||""} ${(F==null?void 0:F.type)||""} ${(F==null?void 0:F.tool)||""} ${(F==null?void 0:F.message)||""}`.toLowerCase().includes("mcp")&&(oe&&window.clearTimeout(oe),oe=window.setTimeout(()=>N({quiet:!0}),200))}function ae(){m||(m=!0,x||(je.subscribe("events",se),x=!0),N(),X())}function me(){m=!1,U(),oe&&window.clearTimeout(oe),oe=null,x&&(je.unsubscribe("events",se),x=!1)}return Ze(ae),ws(ae),ks(me),xt(me),{status:e,loading:t,mutating:s,pageError:n,servers:g,masterEnabled:k,aggregate:T,expandedServers:i,toolQueries:l,toolErrors:o,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,form:v,formError:b,saving:E,editorGroups:S,configuredHeaderKeys:C,configuredEnvKeys:D,savedHttpEndpoint:H,endpointRequired:P,endpointFieldLabel:R,endpointPlaceholder:V,refreshAll:N,busy:I,serverState:Ce,stateLabel:Ee,transportLabel:re,protocolLabel:ge,toolSummary:ne,formatAge:$w,setMasterEnabled:be,reconnect:Z,refreshTools:B,removeServer:ie,toggleTools:le,filteredTools:ye,setToolQuery:$e,openAdd:w,openEdit:L,closeEditor:$,jumpToEditorGroup:te,addSecretRow:Y,removeSecretRow:ee,toggleSecretRemoval:he,saveServer:de}}};function Bw(e,t){if(!e||!t)return Du(e);const s=Du(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),v=h(null),b=h(null);let E=null;const O=h(null),y=h(!1),m=h({}),x=h({}),S=h(null),g=h(null),k=K(()=>e.value.reduce((I,W)=>I+(W.chunks||0),0)),T=K(()=>new Set(e.value.map(W=>W.uploader).filter(Boolean)).size);function C(I,W){const Ce=x.value[W];if(!Ce||Ce.length===0)return 0;const Ee=Math.max(...Ce.map(re=>re.char_count||0));return Ee===0?0:Math.round(I.char_count/Ee*100)}async function D(){t.value=!0,s.value=null;try{const I=await G.get("/api/knowledge");e.value=Array.isArray(I)?I:[]}catch(I){s.value=I.message}t.value=!1}async function H(I){if(m.value[I]){m.value[I]=!1,g.value=null;return}if(m.value[I]=!0,!(x.value[I]||S.value===I)){S.value=I;try{const W=await G.get(`/api/knowledge/${encodeURIComponent(I)}/chunks`);x.value[I]=Array.isArray(W)?W:[]}catch(W){x.value[I]=[],Re.error(`Failed to load chunks: ${W.message}`)}S.value=null}}async function P(){const I=n.value.trim();if(I){i.value=!0,r.value=null,l.value=I;try{const W=await G.get(`/api/knowledge/search?q=${encodeURIComponent(I)}`);a.value=Array.isArray(W)?W:[]}catch(W){a.value=[],r.value=W.message||"Search failed"}i.value=!1}}function R(){a.value=null,n.value="",r.value=null}async function V(){u.value=null,p.value=null;const I=c.value.trim(),W=d.value.trim();if(!I){u.value="Source name is required";return}if(!W){u.value="Content is required";return}f.value=!0;try{const Ce=await G.post("/api/knowledge",{source:I,content:W});p.value=`Ingested ${Ce.chunks||0} chunks from "${I}"`,c.value="",d.value="",x.value={},await D(),setTimeout(()=>{o.value=!1,p.value=null},1500)}catch(Ce){u.value=Ce.message}f.value=!1}async function X(I){v.value=I,b.value=null,E&&(clearTimeout(E),E=null);try{const W=await G.post(`/api/knowledge/${encodeURIComponent(I)}/reingest`);b.value={source:I,error:!1,message:`Re-ingested ${W.chunks||0} chunks`},delete x.value[I],await D(),E=setTimeout(()=>{b.value=null,E=null},3e3)}catch(W){b.value={source:I,error:!0,message:W.message}}v.value=null}function U(I){O.value=I}async function N(){if(O.value){y.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(O.value)}`),delete x.value[O.value],await D()}catch(I){Re.error(`Failed to delete source: ${I.message||"unknown error"}`)}y.value=!1,O.value=null}}return Ze(()=>{D()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:v,reingestResult:b,deleteTarget:O,deleting:y,expanded:m,sourceChunks:x,loadingChunks:S,selectedChunk:g,totalChunks:k,uploaderCount:T,truncate:Qc,formatTs:ba,highlightTerms:Bw,chunkBarWidth:C,fetchSources:D,toggleSource:H,doSearch:P,clearSearch:R,doIngest:V,doReingest:X,confirmDelete:U,doDelete:N}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),v=h(!1),b=h(null),E=h(null),O=h(new Set),y=h(null),m=h(!1),x=h(!1),S=K(()=>e.value.reduce((re,ge)=>re+ge.count,0)),g=K(()=>O.value.size);function k(re){const ge=t.value[re];if(!ge)return[];if(!l.value.trim())return ge;const ne=l.value.trim().toLowerCase();return ge.filter(be=>be.key.toLowerCase().includes(ne)||be.value&&be.value.toLowerCase().includes(ne))}function T(re,ge){return O.value.has(re+"/"+ge)}function C(re,ge){const ne=re+"/"+ge,be=new Set(O.value);be.has(ne)?be.delete(ne):be.add(ne),O.value=be}function D(re){const ge=t.value[re];return!ge||ge.length===0?!1:ge.every(ne=>O.value.has(re+"/"+ne.key))}function H(re,ge){const ne=t.value[re];if(!ne)return;const be=new Set(O.value);for(const Z of ne){const B=re+"/"+Z.key;ge?be.add(B):be.delete(B)}O.value=be}async function P(){s.value=!0,n.value=null;try{const re=await G.get("/api/memory");e.value=Object.entries(re).map(([ge,ne])=>({name:ge,keys:ne.keys||[],count:ne.count||0}))}catch(re){n.value=re.message}s.value=!1}async function R(re){if(a.value[re]){a.value[re]=!1;return}a.value[re]=!0;const ge=e.value.find(be=>be.name===re);if(!ge||t.value[re]||i.value===re)return;i.value=re;let ne;try{const Z=(await G.get(`/api/memory/${encodeURIComponent(re)}`)).entries||{};ne=ge.keys.map(B=>Object.prototype.hasOwnProperty.call(Z,B)?{key:B,value:Z[B]||"",failed:!1}:{key:B,value:"",failed:!0,error:"Not found in scope"})}catch(be){ne=ge.keys.map(Z=>({key:Z,value:"",failed:!0,error:be.message||"Failed to load"}))}t.value[re]=ne,i.value=null}function V(re,ge,ne){p.value=re+"/"+ge,f.value=ne}async function X(re,ge){v.value=!0,b.value=null;try{await G.put(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(ge)}`,{value:f.value});const ne=t.value[re];if(ne){const be=ne.find(Z=>Z.key===ge);be&&(be.value=f.value)}p.value=null}catch(ne){b.value=`Failed to save: ${ne.message||"unknown error"}`}v.value=!1}async function U(re,ge){try{await navigator.clipboard.writeText(ge.value),E.value=re+"/"+ge.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function N(){d.value=null,u.value=null;const re=o.value.scope.trim(),ge=o.value.key.trim(),ne=o.value.value.trim();if(!re){d.value="Scope is required";return}if(!ge){d.value="Key is required";return}if(!ne){d.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(ge)}`,{value:ne}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(be){d.value=be.message}c.value=!1}function I(re,ge){y.value={scope:re,key:ge}}async function W(){if(!y.value)return;m.value=!0,b.value=null;const{scope:re,key:ge}=y.value;try{await G.del(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(ge)}`);const ne=t.value[re];ne&&(t.value[re]=ne.filter(B=>B.key!==ge));const be=e.value.find(B=>B.name===re);be&&(be.count--,be.keys=be.keys.filter(B=>B!==ge));const Z=new Set(O.value);Z.delete(re+"/"+ge),O.value=Z}catch(ne){b.value=`Failed to delete: ${ne.message||"unknown error"}`}m.value=!1,y.value=null}function Ce(){x.value=!0}async function Ee(){m.value=!0,b.value=null;const re=[];for(const ge of O.value){const ne=ge.indexOf("/");re.push({scope:ge.slice(0,ne),key:ge.slice(ne+1)})}try{await G.post("/api/memory/bulk-delete",{entries:re}),O.value=new Set,t.value={},await P()}catch(ge){b.value=`Bulk delete failed: ${ge.message||"unknown error"}`}m.value=!1,x.value=!1}return Ze(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:v,actionError:b,copied:E,selected:O,selectedCount:g,totalEntries:S,deleteTarget:y,deleting:m,showBulkDelete:x,fetchMemory:P,toggleScope:R,startEdit:V,doEdit:X,copyValue:U,doAdd:N,confirmDelete:I,doDelete:W,confirmBulkDelete:Ce,doBulkDelete:Ee,isSelected:T,toggleSelect:C,isScopeAllSelected:D,toggleSelectAll:H,filteredEntries:k}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=K(()=>[...new Set(e.value.map(E=>E.category))].sort()),o=K(()=>{const b={};return e.value.forEach(E=>{b[E.category]=(b[E.category]||0)+1}),b}),c=K(()=>a.value?e.value.filter(b=>b.category===a.value):e.value);function d(b){return b==="correction"?"badge-warning":b==="operational"?"badge-info":b==="preference"?"badge-success":"badge-info"}function u(b){i.value=b.key,l.value=b.content}async function p(b){try{await G.put("/api/learned/"+encodeURIComponent(b),{content:l.value}),i.value=null,Re.success("Entry updated"),await v()}catch(E){Re.error(E.message||"Failed to save entry")}}async function f(b){if(await Zt({title:"Delete learned entry",message:`Delete "${b}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/learned/"+encodeURIComponent(b)),Re.success("Entry deleted"),await v()}catch(O){Re.error(O.message||"Failed to delete entry")}}async function v(){s.value=!0,n.value=null;try{const b=await G.get("/api/learned");e.value=b.entries||[],t.value={last_reflection:b.last_reflection,count:b.count}}catch(b){n.value=b.message}s.value=!1}return Ze(v),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:d,formatTs:ba,startEdit:u,saveEdit:p,deleteEntry:f,fetchEntries:v}}},Am=[{id:"tools",label:"Tools",component:Sw},{id:"skills",label:"Skills",component:Ew},{id:"mcp-servers",label:"MCP Servers",component:Uw},{id:"knowledge",label:"Knowledge",component:Hw},{id:"memory",label:"Memory",component:zw},{id:"learned",label:"Learned",component:jw}],Vw={components:{TabbedPage:$r},setup(){return{tabs:Am}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},qw={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Gw={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},Kw={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},Ww={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h(!1),a=h(!1),i=K(()=>e.value.components||[]),l=K(()=>Kw[e.value.overall]||"text-gray-400"),r=K(()=>e.value.overall==="healthy"?"success":e.value.overall==="degraded"?"warning":e.value.overall==="unhealthy"?"error":"minus"),o=K(()=>{const g=e.value.overall;return g==="healthy"?"All Systems Healthy":g==="degraded"?"Some Systems Degraded":g==="unhealthy"?"System Issues Detected":"Unknown"});function c(g){return qw[g]||"text-gray-400"}function d(g){return Gw[g]||"info"}function u(g){return g==="ok"?"badge-success":g==="degraded"?"badge-warning":g==="down"?"badge-danger":"badge-info"}function p(g){return g==="closed"?"text-green-400":g==="half_open"?"text-yellow-400":g==="open"?"text-red-400":"text-gray-400"}function f(g){return g.replace(/_/g," ").replace(/\b\w/g,k=>k.toUpperCase())}function v(g){if(!g)return"—";try{return new Date(g).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return g}}function b(g){return g>=1e6?(g/1e6).toFixed(1)+"M":g>=1e3?(g/1e3).toFixed(1)+"K":String(g)}async function E(){a.value=!0;try{e.value=await G.get("/api/health/components"),s.value=null,n.value=!0}catch(g){s.value=g.message}finally{t.value=!1,a.value=!1}}function O(){t.value=!0,s.value=null,E()}let y=null,m=!1;function x(){m||(m=!0,E(),y||(y=setInterval(E,3e4)))}function S(){m&&(m=!1,y&&(clearInterval(y),y=null))}return Ze(x),ws(x),ks(S),xt(S),{data:e,hasData:n,loading:t,error:s,refreshing:a,components:i,overallColor:l,overallIcon:r,overallLabel:o,statusColor:c,statusIcon:d,badgeClass:u,circuitColor:p,formatName:f,formatTime:v,formatNumber:b,fetchHealth:E,retry:O}}},Zw={template:`
...
`);const ue=new Blob([q],{type:"text/plain"}),Oe=URL.createObjectURL(ue),Je=document.createElement("a");Je.href=Oe,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL(Oe)}function ee(q,ue){const Oe=`${q.ts} ${q.level} ${q.text||q.raw||""}`;navigator.clipboard.writeText(Oe).then(()=>{p.value=ue,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function he(q){a.value=a.value===q?"":q,O.value="all"}function de(q){return q.level==="ERROR"?"log-line-error":q.level==="WARNING"?"log-line-warning":"text-gray-300"}function oe(q){return q==="ERROR"?"text-red-500 font-semibold":q==="WARNING"?"text-yellow-500":"text-blue-500"}function se(q){return q==="ERROR"?"log-chip-error":q==="WARNING"?"log-chip-warning":"log-chip-info"}function ae(q){O.value=q.id;const ue=q.filters;a.value=ue.level||"",y.value=ue.timeRange||"",i.value=ue.text||"",ue.levels&&(a.value=ue.levels[0]||""),ue.hasToolName&&(i.value="")}function me(q){O.value=q.id,a.value=q.filters.level||"",y.value=q.filters.timeRange||"",i.value=q.filters.text||""}function F(){if(!S.value.trim())return;const q={id:"custom-"+Date.now(),name:S.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};m.value=[...m.value,q],T(),x.value=!1,S.value=""}function ce(q){m.value=m.value.filter(ue=>ue.id!==q),T(),O.value===q&&(O.value="all")}const xe=h("all"),Se=h(""),Le=h(""),ze=h(""),qe=h(""),dt=h(""),J=h(100),Te=Qw,Ie=h(!1),Me=h(!1),Ge=h(""),Ue=h([]),mt=h(null),Yt=h(null);function Ds(){e.value="search",mt.value||An()}async function An(){try{mt.value=await G.get("/api/logs/stats")}catch{}}function Ts(){const q=dt.value;if(!q){ze.value="",qe.value="";return}const Oe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[q];if(Oe){const Je=new Date(Date.now()-Oe*1e3);ze.value=Ps(Je),qe.value=""}}function Ps(q){const ue=Oe=>String(Oe).padStart(2,"0");return`${q.getFullYear()}-${ue(q.getMonth()+1)}-${ue(q.getDate())}T${ue(q.getHours())}:${ue(q.getMinutes())}`}function Pt(q){if(!q)return"";const ue=new Date(q);return isNaN(ue.getTime())?"":ue.toISOString()}async function Qt(){Ie.value=!0,Ge.value="",Me.value=!0,Yt.value=null;try{const q=new URLSearchParams;xe.value&&xe.value!=="all"&&q.set("level",xe.value),Se.value&&q.set("tool",Se.value),Le.value&&q.set("q",Le.value);const ue=Pt(ze.value),Oe=Pt(qe.value);ue&&q.set("start",ue),Oe&&q.set("end",Oe),q.set("limit",String(J.value));const Je=await G.get(`/api/logs/search?${q.toString()}`);Ue.value=Je.entries||[]}catch(q){Ge.value=q.message||"Search failed",Ue.value=[]}finally{Ie.value=!1}}function Vs(){xe.value="all",Se.value="",Le.value="",ze.value="",qe.value="",dt.value="",J.value=100,Ue.value=[],Me.value=!1,Ge.value="",Yt.value=null}function Cs(q){Yt.value=Yt.value===q?null:q}function nn(q){if(!q.timestamp)return"";try{return new Date(q.timestamp).toLocaleString()}catch{return q.timestamp}}function Fs(q){return q.type==="web_action"?`${q.status||""} (${q.execution_time_ms||0}ms)`:(q.result_summary||"").slice(0,200)}function qs(q){return q.error?"log-line-error":"text-gray-300"}function Vn(q){try{return JSON.stringify(q,null,2)}catch{return String(q)}}let ut=null,rs=null,os=!1;function Qe(){os||(os=!0,je.subscribe("logs",re),r.value=je.connected,o.value=je.state||"disconnected",ut=je.onStateChange,rs=(q,ue)=>{o.value=q,r.value=q==="connected",ut&&ut(q,ue)},je.onStateChange=rs)}function vs(){os&&(os=!1,je.unsubscribe("logs",re),je.onStateChange===rs&&(je.onStateChange=ut),rs=null,ut=null)}return Ze(()=>{k(),window.addEventListener("pointerup",w),window.addEventListener("pointercancel",w)}),ws(Qe),ks(vs),xt(()=>{vs(),window.removeEventListener("pointerup",w),window.removeEventListener("pointercancel",w)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:Ce,pauseBuffer:g,showJumpBottom:u,copiedIndex:p,regexError:H,levels:v,logPresets:b,timeRanges:E,timeRange:y,activeLogPreset:O,customLogPresets:m,showSaveLogPreset:x,newLogPresetName:S,hasActiveLogFilters:C,timeRangeLabel:D,timelineBuckets:R,timelineMax:V,timelineSpanLabel:X,timelineLabelSkip:U,togglePause:$,clearLogs:te,exportLogs:Y,logLineClass:de,levelClass:oe,levelChipClass:se,toggleLevel:he,copyLine:ee,jumpToBottom:be,onScroll:B,onUserScrollIntent:le,onUserScrollKey:_e,onAutoScrollToggle:L,onPointerDown:$e,applyLogPreset:ae,applyCustomLogPreset:me,saveLogCustomPreset:F,removeLogCustomPreset:ce,segmentHeight:I,jumpToTimelineBucket:W,searchLevel:xe,searchTool:Se,searchKeyword:Le,searchStart:ze,searchEnd:qe,searchTimePreset:dt,searchLimit:J,searchLimits:Te,searching:Ie,searchRan:Me,searchError:Ge,searchResults:Ue,searchStats:mt,expandedSearch:Yt,switchToSearch:Ds,runSearch:Qt,clearSearchFilters:Vs,toggleSearchExpand:Cs,formatSearchTs:nn,searchEntryText:Fs,searchLogLineClass:qs,formatJson:Vn,applySearchTimePreset:Ts}}};function Sl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const ek=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function tk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const r=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(r)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Va=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],sk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},oo=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),nk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Bu(e){return nk.some(t=>e===t||e.startsWith(`${t}.`))}const Rm="odin_config_center_expanded_v1",Im="odin_config_center_category_v1",ak=50,ik=650,co=()=>G.get("/api/config/meta");function ea(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Oi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ca(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function lk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function rk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Om(e,t){if(Oi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ea(t);const n={};for(const[a,i]of Object.entries(t)){const l=Om(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function ok(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Om(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Nm(e,t,s,n){if(Oi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Nm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function ck(){try{const e=JSON.parse(localStorage.getItem(Rm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function dk(){try{const e=localStorage.getItem(Im);return Va.some(t=>t.key===e)?e:Va[0].key}catch{return Va[0].key}}const uk={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),r=h(null),o=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(dk()),v=h(ck()),b=h({}),E=h({}),O=h(""),y=h({}),m=h({}),x=h([]),S=h([]),g=h(!1),k=h(!1),T=h(!1);let C=null,D=null,H={path:null,at:0},P=0;const R=K(()=>{var _;return(((_=t.value)==null?void 0:_.fields)||[]).filter(M=>!oo.has(M.path.split(".")[0])&&!Bu(M.path))}),V=K(()=>new Map(R.value.map(_=>[_.path,_]))),X=K(()=>Ce.value.reduce((_,M)=>_+M.sections.length,0)),U=K(()=>R.value.length),N=K(()=>ek),I=K(()=>x.value.length>0),W=K(()=>S.value.length>0),Ce=K(()=>{if(!e.value)return[];const _=new Set(Va.flatMap(pe=>pe.sections)),M=Va.map(pe=>({...pe,sections:pe.sections.filter(De=>Object.hasOwn(e.value,De)&&!oo.has(De))})).filter(pe=>pe.sections.length),j=Object.keys(e.value).filter(pe=>!_.has(pe)&&!oo.has(pe));return j.length&&M.push({key:"other",label:"Other",icon:"folder",sections:j}),M}),Ee=K(()=>e.value?{...e.value,...b.value}:null),re=K(()=>{if(!e.value)return[];const _=[];for(const[M,j]of Object.entries(b.value))Nm(e.value[M],j,M,_);return _.filter(M=>!Oi(M.oldVal,M.newVal)).map(M=>{const j=L(M.path);return{...M,label:(j==null?void 0:j.label)||Ca(M.path.split(".").at(-1)),apply_mode:(j==null?void 0:j.apply_mode)||he(M.path.split(".")[0])}})}),ge=K(()=>re.value.length>0),ne=K(()=>re.value.length),be=K(()=>new Set(re.value.map(_=>_.path.split(".")[0])).size),Z=K(()=>!!u.value||p.value!=="all"),B=K(()=>{const _={...m.value};for(const M of re.value){const j=L(M.path),pe=xa(j,M.newVal);pe&&(_[M.path]=pe)}return _}),ie=K(()=>Object.keys(B.value).length>0),le=K(()=>e.value?(Z.value?Ce.value:Ce.value.filter(M=>M.key===f.value)).map(M=>({...M,sections:M.sections.filter(j=>Ie(j))})).filter(M=>M.sections.length):[]),_e=K(()=>{const _=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],M=new Map(_.map(j=>[j,[]]));for(const j of re.value){const pe=M.has(j.apply_mode)?j.apply_mode:"restart";M.get(pe).push(j)}return _.filter(j=>M.get(j).length).map(j=>({key:j,label:ve(j),entries:M.get(j)}))}),ye=K(()=>re.value.filter(_=>_.apply_mode==="restart").length),$e=K(()=>R.value.filter(_=>_.pending_restart)),w=K(()=>$e.value.length);function L(_){const M=V.value.get(_);return M?{...M,apply_details:Sl([M])}:null}function $(_){const M=`${_}.`;return R.value.filter(j=>j.path===_||j.path.startsWith(M))}function te(_){return $(_).length}function Y(_){return Ca(_)}function ee(_){const M=$(_);if(!M.length)return`${Ca(_)} configuration.`;const j=M.find(vt=>vt.sensitivity==="public"&&vt.description)||M.find(vt=>vt.description),pe=(j==null?void 0:j.description)||"";return pe.match(/setting for (.+)\.$/i)?`${Ca(_)} settings and runtime behaviour.`:pe}function he(_){const M=[...new Set($(_).map(j=>j.apply_mode))];return M.length===1?M[0]:M.includes("restart")?"restart":M.includes("activation_required")?"activation_required":M[0]||"restart"}function de(_){const M=[...new Set($(_).map(j=>ve(j.apply_mode)))];return M.length?M.length===1?M[0]:`Mixed apply behaviour: ${M.join(" · ")}`:""}function oe(_){return Sl($(_))}function se(_){var M;return Object.hasOwn(b.value,_)?b.value[_]:(M=e.value)==null?void 0:M[_]}function ae(){const _=se("mcp")||{},M=Object.keys(_.servers||{}).length;return`${_.enabled?"Globally enabled":"Globally disabled"} · ${M} configured server${M===1?"":"s"}.`}function me(_,M){return M.split(".").reduce((j,pe)=>j==null?void 0:j[pe],_)}function F(_){const M=Ee.value;return $(_).filter(j=>Bu(j.path)?!1:j.path.split(".").length<=2?!0:!j.path.includes(".*")).map(j=>({...j,key:j.path.split(".").at(-1),value:me(M,j.path),apply_details:Sl([j]),editor:j.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ce(_){const M=_.path.split(".");return M.length>2?M.slice(0,2).join("."):null}function xe(_){const M=new Map;for(const j of F(_)){const pe=ce(j),De=pe||`${_}.__root`;M.has(De)||M.set(De,{key:De,path:pe,entries:[]}),M.get(De).entries.push(j)}return[...M.values()].map(j=>{const pe=j.entries.find(De=>De.group_description);return{...j,label:j.path?Ca(j.path.split(".").at(-1)):null,description:(pe==null?void 0:pe.group_description)||null,apply_details:Sl(j.entries),runtime_summaries:Le(j.entries)}})}function Se(_){return{save:_.save_effect||(_.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:_.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[_.apply_mode]||"Effective runtime state is not currently observable."}}function Le(_){const M=new Map;for(const j of _){const pe=Se(j),De=`${j.apply_mode}|${pe.save}|${pe.runtime}`;M.has(De)||M.set(De,{key:De,label:ve(j.apply_mode),save:pe.save,runtime:pe.runtime})}return[...M.values()]}function ze(_){if(qe(_))return _.runtime_effect||_.activation_policy||"";if(_.apply_mode==="activation_required"){const M=_.activation_policy||_.runtime_effect;return M?`Not active after saving. No activation control exists in this release. ${M}`:"Not active after saving; no activation control exists in this release."}return""}function qe(_){return _.action_available===!0&&!!(_.action_label&&_.action_endpoint)}async function dt(_){if(qe(_))try{if(Yt(_.path))throw new Error("Save this setting before applying its action.");const M=String(_.action_method||"POST").toLowerCase(),j={post:G.post.bind(G),put:G.put.bind(G),delete:G.del.bind(G)}[M];if(!j)throw new Error("Unsupported configuration action");await j(_.action_endpoint,_.action_body||void 0),await Q(),Rn("success",`${_.action_label} completed.`)}catch(M){Rn("error",M.message||`${_.action_label} failed`)}}function J(_,M){return[_.label,_.path,_.description,..._.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(M)}function Te(_){const M=u.value.trim().toLowerCase();return M?$(_).filter(j=>J(j,M)):[]}function Ie(_){const M=$(_);if(p.value!=="all"&&!M.some(pe=>pe.apply_state===p.value))return!1;const j=u.value.trim().toLowerCase();return!j||`${Y(_)} ${_}`.toLowerCase().includes(j)?!0:M.some(pe=>J(pe,j))}function Me(_,M){return $(_).filter(j=>j.apply_state===M).length}function Ge(_){return _==="all"?U.value:R.value.filter(M=>M.apply_state===_).length}function Ue(_){const M=_.sections.flatMap(j=>$(j));return{fields:M.length,modified:re.value.filter(j=>_.sections.includes(j.path.split(".")[0])).length,pending_restart:M.filter(j=>j.apply_state==="pending_restart").length,invalid:M.filter(j=>j.apply_state==="invalid").length,dormant:M.filter(j=>j.apply_state==="dormant").length}}function mt(_){var M;return Object.hasOwn(b.value,_)&&!Oi((M=e.value)==null?void 0:M[_],b.value[_])}function Yt(_){return re.value.some(M=>M.path===_||M.path.startsWith(`${_}.`))}function Ds(_){f.value=_,u.value="",p.value="all";try{localStorage.setItem(Im,_)}catch{}}function An(_){p.value=_}function Ts(){u.value="",p.value="all"}function Ps(_){var M;return((M=Ce.value.find(j=>j.sections.includes(_)))==null?void 0:M.sections)||[]}function Pt(_){const M=Ps(_),j=M.find(pe=>v.value[pe]===!0);return j||M.find(pe=>v.value[pe]!==!1)||null}function Qt(_){return u.value&&!T.value&&Ie(_)?!0:T.value?Pt(_)===_:Object.hasOwn(v.value,_)?v.value[_]===!0:!0}function Vs(_){const M=!Qt(_);if(T.value){const j={...v.value};for(const pe of Ps(_))j[pe]===!0&&(j[pe]=!1);j[_]=M,v.value=j;return}v.value={...v.value,[_]:M}}function Cs(){x.value.push(ea(b.value)),x.value.length>ak&&x.value.shift(),S.value=[]}function nn(){ge.value&&(Cs(),b.value={},m.value={},g.value=!1)}function Fs(_,M=!1){const j=Date.now();if(M&&H.path===_&&j-H.at<ik){H.at=j;return}Cs(),H={path:_,at:j}}function qs(_,M,j){if(!M.length)return j;const pe=ea(_??{});let De=pe;for(let vt=0;vt<M.length-1;vt+=1){const it=M[vt];De[it]=ea(De[it]??{}),De=De[it]}return De[M.at(-1)]=j,pe}function Vn(_){var M;return Object.hasOwn(b.value,_)?b.value[_]:ea((M=e.value)==null?void 0:M[_])}function ut(_,M,j={}){var oi;const[pe,...De]=_.path.split(".");Fs(_.path,!!j.coalesce);const vt=Vn(pe),it=De.length?qs(vt,De,M):M,Gs={...b.value};if(Oi(it,(oi=e.value)==null?void 0:oi[pe])?delete Gs[pe]:Gs[pe]=it,b.value=Gs,m.value[_.path]){const od={...m.value};delete od[_.path],m.value=od}}function rs(_){H={path:null,at:0},E.value={...E.value,[_]:String(me(Ee.value,_)??"")}}function os(_){if(H={path:null,at:0},!Object.hasOwn(E.value,_))return;const M={...E.value};delete M[_],E.value=M}function Qe(_){const M=E.value[_.path];if(H={path:null,at:0},M===""){m.value={...m.value,[_.path]:"Enter a number."};return}const j=Number(M);if(Number.isNaN(j)||_.type==="integer"&&!Number.isInteger(j)){m.value={...m.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a number."};return}const pe={...E.value};delete pe[_.path],E.value=pe,ut(_,j,{coalesce:!0})}function vs(_){return Object.hasOwn(E.value,_.path)?E.value[_.path]:_.value??""}function q(_,M){if(E.value={...E.value,[_.path]:M},M===""){m.value={...m.value,[_.path]:"Enter a number."};return}const j=Number(M);if(!Number.isFinite(j)||_.type==="integer"&&!Number.isInteger(j)){m.value={...m.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(m.value[_.path]){const pe={...m.value};delete pe[_.path],m.value=pe}ut(_,j,{coalesce:!0})}function ue(_){const M=Number.parseInt(O.value,10);if(!Number.isInteger(M)||M<1){m.value={...m.value,[_.path]:"Warning thresholds must be positive whole numbers."};return}const j=[...new Set([..._.value||[],M])].sort((pe,De)=>De-pe);O.value="",ut(_,j)}function Oe(_,M){ut(_,(_.value||[]).filter(j=>j!==M))}function Je(_){return _.apply_mode==="live_read"?"Odin reads the saved file value on next use.":_.apply_mode==="live_for_new_work"?"New work uses the saved file value.":_.apply_mode==="live_apply"?_.apply_handler?`Apply the saved value through ${_.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":_.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":_.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":_.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function rt(_){return _.type==="array"&&Array.isArray(_.value)&&!_.structured_container&&!_.structured_container_child&&_.sensitivity==="public"&&_.value.every(M=>["string","number","boolean"].includes(typeof M))}function Lt(_){const M=String(y.value[_.path]??"").trim();if(!M)return;const j=[...new Set([..._.value||[],M])];y.value={...y.value,[_.path]:""},ut(_,j)}function Ft(_,M){ut(_,(_.value||[]).filter(j=>j!==M))}function xa(_,M){var pe;if(!_)return null;if((pe=_.enum)!=null&&pe.length&&!_.enum.includes(M))return`Choose one of: ${_.enum.join(", ")}`;if(_.path==="agents.final_warning_iterations"&&(!Array.isArray(M)||!M.length))return"Add at least one warning threshold.";const j=_.constraints||{};if((_.type==="integer"||_.type==="number")&&typeof M=="number"){if(j.minimum!==void 0&&M<j.minimum)return`Must be at least ${j.minimum}${_.unit?` ${_.unit}`:""}`;if(j.maximum!==void 0&&M>j.maximum)return`Must be at most ${j.maximum}${_.unit?` ${_.unit}`:""}`}return null}function $s(_){return B.value[_.path]||null}function li(_){const M=`${_}.`;return Object.keys(B.value).some(j=>j===_||j.startsWith(M))}function _a(){x.value.length&&(S.value.push(ea(b.value)),b.value=x.value.pop(),m.value={},E.value={},H={path:null,at:0})}function qn(){S.value.length&&(x.value.push(ea(b.value)),b.value=S.value.pop(),m.value={},E.value={},H={path:null,at:0})}function wa(){!ge.value||ie.value||(g.value=!0,k.value=!1)}function Gn(){g.value=!1}function z(){nn()}function ve(_){return sk[_]||Ca(_||"unknown")}function Ae(_){return`apply-${String(_||"unknown").replaceAll("_","-")}`}function _t(_){return`cfgc-field-${_.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function Kn(_){return`${_t(_)}-input`}function Wn(_){const M=document.getElementById(_t(_))||document.getElementById(_t(_.split(".").slice(0,2).join(".")));M==null||M.scrollIntoView({behavior:"smooth",block:"center"})}function Rn(_,M){l.value={type:_,message:M},window.setTimeout(()=>{var j;((j=l.value)==null?void 0:j.message)===M&&(l.value=null)},3500)}function cl(){o.value=!1,p.value="pending_restart",u.value="";const _=tk(n.value);_&&(_.scrollTop=0)}function dl(){o.value=!1}function Zn(_=1800){D&&window.clearTimeout(D),D=window.setTimeout(ri,_)}async function ri(){if(c.value){if(P+=1,P>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await co(),w.value===0){c.value=!1,d.value=null,Rn("success","Odin restarted and the saved startup settings are active.");return}}catch{}Zn(2e3)}}async function we(){if(!c.value){d.value=null;try{await G.post("/api/restart",{}),c.value=!0,P=0,o.value=!1,Zn()}catch(_){d.value=_.message||"Odin could not schedule a restart."}}}async function A(){if(!(!ge.value||ie.value||a.value)){a.value=!0;try{const _=ok(e.value,b.value),M=await G.put("/api/config",_);e.value=M,b.value={},x.value=[],S.value=[],m.value={},g.value=!1;try{t.value=await co(),r.value=null,o.value=w.value>0,Rn("success",w.value?`Configuration saved. ${w.value} setting${w.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(j){r.value=j.message||"Unknown metadata error.",Rn("error",`Configuration saved, but apply status could not be refreshed: ${r.value}`)}}catch(_){Rn("error",_.message||"Configuration could not be saved")}finally{a.value=!1}}}async function Q(){var _,M;if(!ge.value){s.value=!0,i.value=null;try{const j=await G.get("/api/config"),pe=await co();e.value=j,t.value=pe,r.value=null;const De=Ce.value;if(De.some(vt=>vt.key===f.value)||(f.value=((_=De[0])==null?void 0:_.key)||Va[0].key),T.value){const it=(((M=De.find(Gs=>Gs.key===f.value))==null?void 0:M.sections)||[]).find(Gs=>v.value[Gs]===!0);v.value=it?{...v.value,[it]:!0}:{}}}catch(j){i.value=j.message||"Unknown configuration error"}finally{s.value=!1}}}function fe(_){if(g.value||!(_.ctrlKey||_.metaKey))return;const M=_.target;M instanceof HTMLElement&&(M.matches("input, textarea, select")||M.isContentEditable)||(!_.shiftKey&&_.key.toLowerCase()==="z"?(_.preventDefault(),_a()):(_.key.toLowerCase()==="y"||_.shiftKey&&_.key.toLowerCase()==="z")&&(_.preventDefault(),qn()))}function Ne(_){T.value=_.matches}return as(v,_=>{try{localStorage.setItem(Rm,JSON.stringify(_))}catch{}},{deep:!0}),Ze(()=>{var _;Q(),document.addEventListener("keydown",fe),C=window.matchMedia("(max-width: 760px)"),Ne(C),(_=C.addEventListener)==null||_.call(C,"change",Ne)}),xt(()=>{var _;document.removeEventListener("keydown",fe),(_=C==null?void 0:C.removeEventListener)==null||_.call(C,"change",Ne),D&&window.clearTimeout(D)}),{config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:r,restartPromptOpen:o,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:g,mobileOverflowOpen:k,warningThresholdInput:O,arrayInputs:y,healthFilters:N,visibleCategories:Ce,displayGroups:le,reviewGroups:_e,sectionCount:X,fieldCount:U,hasChanges:ge,changeCount:ne,changedSectionCount:be,hasDraftErrors:ie,canUndo:I,canRedo:W,globalFilterActive:Z,reviewRestartCount:ye,pendingRestartCount:w,pendingRestartFields:$e,healthCount:Ge,categoryStats:Ue,selectCategory:Ds,selectHealthFilter:An,clearFilters:Ts,sectionLabel:Y,sectionDescription:ee,sectionFieldCount:te,sectionHealthCount:Me,sectionApplySummary:de,sectionApplyDetails:oe,sectionEntries:F,fieldGroups:xe,sectionSearchHits:Te,mcpConfigSummary:ae,fieldRuntimeCopy:Se,fieldSpecificRuntimeNote:ze,hasHonestAction:qe,runFieldAction:dt,sectionChanged:mt,fieldChanged:Yt,isSectionExpanded:Qt,toggleSection:Vs,discardAllDrafts:nn,setFieldValue:ut,setNumberFieldValue:q,numberInputValue:vs,beginInputEdit:rs,endTextInputEdit:os,endInputEdit:Qe,addWarningThreshold:ue,removeWarningThreshold:Oe,isScalarArray:rt,addScalarArrayItem:Lt,removeScalarArrayItem:Ft,fieldError:$s,sectionHasErrors:li,undo:_a,redo:qn,openReview:wa,closeReview:Gn,mobileCancel:z,applyModeLabel:ve,applyClass:Ae,compactValue:lk,formatValue:rk,structuredApplyCopy:Je,fieldId:_t,fieldInputId:Kn,focusField:Wn,fetchConfig:Q,saveConfig:A,restartOdin:we,restartLater:dl,reviewPendingRestart:cl}}},pk=/^\d{15,25}$/;function Lm(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Mm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=K(()=>new Set((e.excludedIds||[]).map(String))),r=K(()=>{const S=s.value.toLowerCase().trim();return(e.members||[]).filter(g=>l.value.has(String(g.id))?!1:S?u(g).toLowerCase().includes(S)||String(g.username||"").toLowerCase().includes(S)||String(g.id).includes(S):!0)}),o=K(()=>{const S=s.value.trim();return r.value.length===0&&pk.test(S)&&!l.value.has(S)?S:""}),c=K(()=>r.value.length+(o.value?1:0)),d=K(()=>{if(n.value){if(r.value[a.value])return`${e.optionsId}-${a.value}`;if(o.value&&a.value===r.value.length)return`${e.optionsId}-raw`}});function u(S){return Lm(S)}function p(){n.value=!0,a.value=0}function f(){p()}function v(){const S=Math.max(c.value-1,0);a.value=Math.min(a.value+1,S)}function b(){a.value=Math.max(a.value-1,0)}function E(){const S=r.value[a.value];S?O(S):o.value&&a.value===r.value.length&&y(o.value)}function O(S){y(String(S.id))}function y(S){t("select",S),s.value="",n.value=!1,a.value=0}function m(){n.value=!1}function x(){setTimeout(m,150)}return Ze(()=>{e.autofocus&&Ct(()=>{var S;return(S=i.value)==null?void 0:S.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:r,rawId:o,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:v,highlightPrevious:b,selectHighlighted:E,selectMember:O,selectId:y,closeOptions:m,onBlur:x}}};function Hu(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const fk={components:{DiscordUserCombobox:Mm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h([]),o=K(()=>{const g={};for(const k of r.value)g[k.id]=k;return g});function c(g){return o.value[g]||null}function d(g,k){return g?g.allowed_hosts===null||g.allowed_hosts===void 0?{allowed_hosts:[...k],default_host:g.default_host||"",allow_all:!0}:{allowed_hosts:g.allowed_hosts,default_host:g.default_host||"",allow_all:!1}:{allowed_hosts:[...k],default_host:k[0]||"",allow_all:!0}}const u=hk({applyDefault:async g=>{const k=g.allow_all?null:g.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:k,default_host:g.default_host})},applyUser:async(g,k)=>{const T=k.allow_all?null:k.allowed_hosts;await G.put(`/api/host-access/user/${g}`,{allowed_hosts:T,default_host:k.default_host})},applyDelete:g=>G.del(`/api/host-access/user/${g}`),onDefaultConfirmed:()=>Re.success("Default policy updated"),onDefaultRollback:g=>{g&&(a.value=g)},onUserConfirmed:g=>{const k=c(g);Re.success(`Updated access for ${k?k.display_name:g}`)},onUserRollback:(g,k)=>{const T={...i.value};k?T[g]=k:delete T[g],i.value=T},onUserDeleted:g=>{const k={...i.value};delete k[g],i.value=k},onError:(g,k)=>{var C;const T=k.uid?` ${((C=c(k.uid))==null?void 0:C.display_name)||k.uid}`:"";Re.error(`${g.message||"Failed to save"} — reverted${T}`)}});let p=0;async function f(){const g=++p;e.value=!0,t.value="";try{const k=await u.readSnapshot(()=>G.get("/api/host-access"));if(g!==p)return;s.value=k,n.value=k.available_hosts||[],a.value=d(k.default_policy,n.value);const T=k.users||{},C={};for(const[D,H]of Object.entries(T))C[D]=d(H,n.value);i.value=C,u.seed(a.value,C)}catch(k){g===p&&(t.value=k.message||"Failed to fetch host access data")}finally{g===p&&(e.value=!1)}try{const k=await G.get("/api/discord/members")||[];g===p&&(r.value=k)}catch{g===p&&(r.value=[])}}function v(){u.saveDefault(a.value)}function b(g,k){a.value.allow_all=!1,k?a.value.allowed_hosts.includes(g)||a.value.allowed_hosts.push(g):(a.value.allowed_hosts=a.value.allowed_hosts.filter(T=>T!==g),a.value.default_host===g&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}function E(g){const k=i.value[g];k&&u.saveUser(g,k)}function O(g,k,T){const C=i.value[g];C&&(C.allow_all=!1,T?C.allowed_hosts.includes(k)||C.allowed_hosts.push(k):(C.allowed_hosts=C.allowed_hosts.filter(D=>D!==k),C.default_host===k&&(C.default_host=C.allowed_hosts[0]||"")),E(g))}function y(g,k){const T=i.value[g];T&&(T.default_host=k,E(g))}function m(){l.value=!0}function x(g){!/^\d{15,25}$/.test(g)||i.value[g]||(i.value[g]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},E(g),l.value=!1)}async function S(g){const k=c(g);await Zt({title:"Remove user override",message:`Remove the host access override for ${k?k.display_name:g}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await u.deleteUser(g),i.value[g]||Re.success(`Removed override for ${k?k.display_name:g}`))}return Ze(f),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,members:r,fetchData:f,saveDefaultPolicy:v,toggleDefaultHost:b,getMember:c,toggleUserHost:O,setUserDefault:y,openAddUser:m,addUserById:x,deleteUser:S}}},vk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=K(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=K(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function v(){e.value=!0,t.value="";try{const T=await G.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function b(T){return!T||!T.trim()?[]:T.split(",").map(C=>C.trim()).filter(Boolean)}function E(T,C){const D=c.value.allowed_hosts;if(C&&!D.includes(T)&&D.push(T),!C){const H=D.indexOf(T);H>=0&&D.splice(H,1)}}function O(T,C){const D=d.value.allowed_hosts;if(C&&!D.includes(T)&&D.push(T),!C){const H=D.indexOf(T);H>=0&&D.splice(H,1)}}async function y(){var T;i.value=!0;try{const C=b(c.value.allowed_tools_str),D=c.value.host_mode,H=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:C.length?C:[]};H!==null&&(P.allowed_hosts=H),P.default_host=c.value.default_host||"";const R=await G.post("/api/tokens",P);l.value=R.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Re.success("Token created"),await v()}catch(C){Re.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to create token")}finally{i.value=!1}}function m(T){r.value=T;const C=T.allowed_hosts;let D="default";C==null?D="default":Array.isArray(C)&&C.length===0?D="none":Array.isArray(C)&&(D="select"),d.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:D,allowed_hosts:Array.isArray(C)?[...C]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const C=b(d.value.allowed_tools_str),D=d.value.host_mode,H={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:C};D==="none"?H.allowed_hosts=[]:D==="select"?H.allowed_hosts=d.value.allowed_hosts:H.allowed_hosts=null,H.default_host=d.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,Re.success("Token updated"),await v()}catch(C){Re.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to update")}finally{o.value=!1}}}async function S(T){var D;if(await Zt({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await G.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=H.token,Re.success("Token regenerated")}catch(H){Re.error(((D=H.data)==null?void 0:D.error)||H.message||"Failed to regenerate")}}async function g(T){var D;if(await Zt({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(T.user_id)),Re.success("Token deleted"),await v()}catch(H){Re.error(((D=H.data)==null?void 0:D.error)||H.message||"Failed to delete")}}async function k(){if(l.value)try{await navigator.clipboard.writeText(l.value),Re.success("Copied to clipboard")}catch{Re.error("Copy failed — select and copy manually")}}return Ze(v),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:v,tierBadge:f,toggleCreateHost:E,toggleEditHost:O,createToken:y,startEdit:m,saveEdit:x,confirmRegenerate:S,confirmDelete:g,copyToken:k}}},gk=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),bk=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),yk=Object.freeze(["enabled","base_url","model","max_tokens"]),xk=Object.freeze(["enabled","model","max_tokens"]);function Ur(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function zu(e){return Ur(e,gk)}function ju(e){return Ur(e,bk)}function _k(e,{includeApiKey:t=!1}={}){const s=Ur(e,yk);return t&&(s.api_key=e.api_key),s}function wk(e){return{timeout:e.timeout}}function kk(e,{includeApiKey:t=!1}={}){const s=Ur(e,xk);return t&&(s.api_key=e.api_key),s}function Sk(e){return{timeout:e.timeout}}function Tl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Tk={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=K(()=>{const z=n.value.model;return z&&!a.includes(z)?[z,...a]:a}),l=K(()=>{const z=n.value.agent_model;return z&&z!=="auto"&&!a.includes(z)?[z,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=K(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=K(()=>{const z=n.value.agent_model;return z==="auto"?!0:!r.includes(z||n.value.model)}),d=K(()=>{const z=n.value.agent_reasoning_effort;return z==="auto"?!1:(z||n.value.reasoning_effort)==="max"}),u=z=>r.includes(z)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),p=z=>r.includes(z)&&d.value,f=h({enabled:!1,model:"gpt-5.6-luna"}),v=h({unavailable_reason:null}),b=K(()=>{const z=f.value.model;return z&&!a.includes(z)?[z,...a]:a});function E(z){const ve=z.target.value;f.value.enabled=ve!=="",ve!==""&&(f.value.model=ve),rs()}const O=h(!1),y=h({codex:!1,ollama:!1,kimi:!1}),m=h(null),x=h(!1),S=h(""),g=h(null),k=h(!1);let T=0;const C=K(()=>{var z;return Object.entries(((z=m.value)==null?void 0:z.models)||{}).map(([ve,Ae])=>{var _t,Kn,Wn;return{model:ve,floor:Ae.floor,override:Ae.override,effectiveBudget:(_t=Ae.effective)==null?void 0:_t.effective_budget,configuredPrimaryChars:(Kn=Ae.configured)==null?void 0:Kn.primary_chars,primaryChars:(Wn=Ae.effective)==null?void 0:Wn.primary_chars,provenance:Ae.provenance,clampExpiresAt:Ae.clamp_expires_at}})}),D=K(()=>{var z;return((z=m.value)==null?void 0:z.clamps)||[]}),H=K(()=>{var z,ve;return((ve=(z=m.value)==null?void 0:z.models)==null?void 0:ve[n.value.model])||null}),P=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),R=h({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),V=h(!1),X=h(!1),U=h(!1),N=h(!1),I=h(!1),W=h(!1),Ce=h(!1),Ee=h({configured:!1}),re=h([]),ge=h(""),ne=h(!1),be=h(!1),Z=h({configured:!1}),B=h([]),ie=h(""),le=h(!1),_e=h(!1),ye=h(!0),$e=h(""),w=h({configured:!1,accounts:[]}),L=h(null),$=h(null),te=h(""),Y=h(null),ee=h(!1),he=h(null),de=h(null),oe=h("");let se=null;function ae(z,ve="success"){Re(z,ve==="error"?"error":"success")}function me(z){if(!z)return"?";const ve=z/(1024*1024*1024);return ve>=1?ve.toFixed(1)+" GB":(z/(1024*1024)).toFixed(0)+" MB"}function F(z){return Number.isFinite(Number(z))?Number(z).toLocaleString():"—"}function ce(z){return z==null?"automatic (model-derived)":Number(z).toLocaleString()+" characters"}function xe(z){const ve=new Date(z);return Number.isNaN(ve.getTime())?"unknown":ve.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function Se(z){return typeof z=="string"&&z.length>12?z.slice(0,8)+"…"+z.slice(-4):z}function Le(z){return z==="temporary learned clamp"?"is-clamp":z==="override"?"is-override":"is-built-in"}function ze(z){const ve=n.value.context_budget_overrides[z.model];return z.floor!=null&&Number.isFinite(Number(ve))&&Number(ve)>z.floor}function qe(z,ve){const Ae={...n.value.context_budget_overrides};ve.target.value===""?delete Ae[z]:Ae[z]=Number(ve.target.value),n.value.context_budget_overrides=Ae,k.value=!0}function dt(z){n.value.context_utilization=z.target.value===""?"":Number(z.target.value),k.value=!0}function J(z){const ve={...n.value.context_budget_overrides};delete ve[z],n.value.context_budget_overrides=ve,k.value=!0}async function Te(){e.value=!0,await Promise.all([Ie(),Ge(),Ts(),Ue(),Me()]),e.value=!1}async function Ie({preserveBasic:z=!1,preserveAdvanced:ve=!1}={}){try{const Ae=await G.get("/api/llm/status");t.value=Ae,s.value=Ae.active_provider||"codex",Ae.codex&&!ut.pending()&&(z||(n.value.enabled=Ae.codex.enabled,n.value.model=Ae.codex.model||"gpt-5.6-sol",n.value.reasoning_effort=Ae.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=Ae.codex.agent_reasoning_effort||"",n.value.agent_model=Ae.codex.agent_model||""),ve||(n.value.request_timeout_seconds=Ae.codex.request_timeout_seconds??n.value.request_timeout_seconds,n.value.stream_stall_timeout_seconds=Ae.codex.stream_stall_timeout_seconds??n.value.stream_stall_timeout_seconds,n.value.retry={...n.value.retry,...Ae.codex.retry||{}},n.value.connection_pool={...n.value.connection_pool,...Ae.codex.connection_pool||{}},n.value.context_compression={...n.value.context_compression,...Ae.codex.context_compression||{}},!k.value&&!U.value&&(n.value.context_budget_overrides={...Ae.codex.context_budget_overrides||{}},n.value.context_utilization=Ae.codex.context_utilization??n.value.context_utilization))),Ae.ollama&&!os.pending()&&(z||(P.value.enabled=Ae.ollama.enabled,P.value.base_url=Ae.ollama.base_url||"",P.value.model=Ae.ollama.model||"",P.value.max_tokens=Ae.ollama.max_tokens||4096),ve||(P.value.timeout=Ae.ollama.timeout??P.value.timeout)),Ae.kimi&&!Qe.pending()&&(z||(R.value.enabled=Ae.kimi.enabled,R.value.model=Ae.kimi.model||"",R.value.max_tokens=Ae.kimi.max_tokens||4096),ve||(R.value.timeout=Ae.kimi.timeout??R.value.timeout)),Ae.auxiliary&&(v.value=Ae.auxiliary,rs.pending()||(f.value.enabled=Ae.auxiliary.enabled,f.value.model=Ae.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Me(){const z=++T;x.value=!0,S.value="";try{const ve=await G.get("/api/context/windows");if(z!==T)return;m.value=ve,!U.value&&!k.value&&(n.value.context_budget_overrides=Object.fromEntries(Object.entries(ve.models||{}).filter(([,Ae])=>Ae.override!=null).map(([Ae,_t])=>[Ae,_t.override])),n.value.context_utilization=ve.utilization??n.value.context_utilization)}catch(ve){z===T&&(S.value=ve.message||"Failed to load context budgets")}finally{z===T&&(x.value=!1)}}async function Ge(){try{if(Ee.value=await G.get("/api/ollama/status"),Ee.value.model&&(ge.value=Ee.value.model),Ee.value.configured)try{const z=await G.get("/api/ollama/models");re.value=z.models||[]}catch{re.value=[]}else if(P.value.base_url)try{const z=await G.post("/api/ollama/probe-models",{base_url:P.value.base_url});re.value=z.models||[]}catch{re.value=[]}}catch{Ee.value={configured:!1}}}async function Ue(){ye.value=!0,$e.value="";try{w.value=await G.get("/api/codex/status")}catch(z){$e.value=z.message||"Failed to fetch Codex status"}finally{ye.value=!1}}async function mt(){const z=t.value?t.value.active_provider:"codex";Ce.value=!0;try{const ve=await G.post("/api/llm/switch",{provider:s.value});ve.error?(s.value=z,ae(ve.error,"error")):(ae("Switched to "+s.value+" ("+ve.model+")"),await Te())}catch(ve){s.value=z,ae(ve.message||"Switch failed","error")}finally{Ce.value=!1}}async function Yt(){ne.value=!0;try{const z=await G.post("/api/ollama/reload");ae(z.configured?"Ollama reloaded":z.reason||"Ollama not configured",z.configured?"success":"error"),await Te()}catch(z){ae(z.message||"Reload failed","error")}finally{ne.value=!1}}async function Ds(){be.value=!0;try{await G.post("/api/ollama/model",{model:ge.value}),ae("Model set to "+ge.value),await Te()}catch(z){ae(z.message||"Failed","error")}finally{be.value=!1}}async function An(){const z=P.value.base_url;if(!z){ae("Enter a base URL first","error");return}W.value=!0;try{const ve=await G.post("/api/ollama/probe-models",{base_url:z});re.value=ve.models||[],re.value.length?(ae(re.value.length+" model(s) found"),!P.value.model&&re.value.length&&(P.value.model=re.value[0].name)):ae("No models found at "+z,"error")}catch(ve){ae(ve.message||"Could not reach Ollama","error")}finally{W.value=!1}}async function Ts(){try{if(Z.value=await G.get("/api/kimi/status"),Z.value.model&&(ie.value=Z.value.model),Z.value.configured)try{const z=await G.get("/api/kimi/models");B.value=z.models||[]}catch{B.value=[]}}catch{Z.value={configured:!1}}}async function Ps(){le.value=!0;try{const z=await G.post("/api/kimi/reload");ae(z.configured?"Kimi reloaded":z.reason||"Kimi not configured",z.configured?"success":"error"),await Te()}catch(z){ae(z.message||"Reload failed","error")}finally{le.value=!1}}async function Pt(){_e.value=!0;try{await G.post("/api/kimi/model",{model:ie.value}),ae("Model set to "+ie.value),await Te()}catch(z){ae(z.message||"Failed","error")}finally{_e.value=!1}}async function Qt(){if(U.value){ut();return}U.value=!0;const z=zu(n.value);try{await G.put("/api/llm/codex/config",z),ae("Codex config saved"),await Promise.all([Ie({preserveBasic:!0,preserveAdvanced:!0}),Ue()])}catch(ve){ae(ve.message||"Failed","error");const Ae=JSON.stringify(zu(n.value))!==JSON.stringify(z);await Promise.all([Ie({preserveBasic:Ae,preserveAdvanced:!0}),Ue()])}finally{U.value=!1}}async function Vs(){if(U.value)return;U.value=!0;const z=ju(n.value);try{await G.put("/api/llm/codex/config",z),JSON.stringify({context_budget_overrides:n.value.context_budget_overrides,context_utilization:n.value.context_utilization})===JSON.stringify({context_budget_overrides:z.context_budget_overrides,context_utilization:z.context_utilization})&&(k.value=!1),ae("Codex advanced settings saved"),await Promise.all([Ie({preserveBasic:!0,preserveAdvanced:!0}),Ue(),Me()])}catch(ve){ae(ve.message||"Failed","error");const Ae=JSON.stringify(ju(n.value))!==JSON.stringify(z);await Promise.all([Ie({preserveBasic:!0,preserveAdvanced:Ae}),Ue(),Me()])}finally{U.value=!1}}async function Cs(){if(N.value){os();return}N.value=!0;try{const z=V.value?P.value.api_key:null,ve=_k(P.value,{includeApiKey:z!==null});await G.put("/api/llm/ollama/config",ve),ae("Ollama config saved"),z!==null&&P.value.api_key===z&&(P.value.api_key="",V.value=!1),await Promise.all([Ie({preserveBasic:!0,preserveAdvanced:!0}),Ge()])}catch(z){ae(z.message||"Failed","error")}finally{N.value=!1}}async function nn(){if(!N.value){N.value=!0;try{await G.put("/api/llm/ollama/config",wk(P.value)),ae("Ollama timeout saved"),await Promise.all([Ie({preserveBasic:!0,preserveAdvanced:!0}),Ge()])}catch(z){ae(z.message||"Failed","error")}finally{N.value=!1}}}async function Fs(){if(I.value){Qe();return}I.value=!0;try{const z=X.value?R.value.api_key:null,ve=kk(R.value,{includeApiKey:z!==null});await G.put("/api/llm/kimi/config",ve),ae("Kimi config saved"),z!==null&&R.value.api_key===z&&(R.value.api_key="",X.value=!1),await Promise.all([Ie({preserveBasic:!0,preserveAdvanced:!0}),Ts()])}catch(z){ae(z.message||"Failed","error")}finally{I.value=!1}}async function qs(){if(!I.value){I.value=!0;try{await G.put("/api/llm/kimi/config",Sk(R.value)),ae("Kimi timeout saved"),await Promise.all([Ie({preserveBasic:!0,preserveAdvanced:!0}),Ts()])}catch(z){ae(z.message||"Failed","error")}finally{I.value=!1}}}async function Vn(){if(O.value){rs();return}O.value=!0;try{await G.put("/api/llm/auxiliary/config",f.value),ae("Auxiliary config saved"),await Ie()}catch(z){ae(z.message||"Failed","error"),await Ie()}finally{O.value=!1}}const ut=Tl(Qt),rs=Tl(Vn),os=Tl(Cs),Qe=Tl(Fs),vs=()=>(ut.cancel(),Qt()),q=()=>(os.cancel(),Cs()),ue=()=>(Qe.cancel(),Fs()),Oe=()=>Vs(),Je=()=>nn(),rt=()=>qs();async function Lt(z){const ve=z.account_key+":"+z.model;g.value=ve;try{const Ae=await G.post("/api/context/windows/clear",{account_key:z.account_key,model:z.model});ae(Ae.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Me()}catch(Ae){ae(Ae.message||"Failed to clear clamp","error"),await Me()}finally{g.value=null}}async function Ft(z){try{await G.post("/api/codex/account/"+z+"/activate"),ae("Active account switched"),await Ue()}catch(ve){ae(ve.message||"Failed","error")}}async function xa(z){L.value=z;try{await G.post("/api/codex/account/"+z+"/refresh"),ae("Token refreshed"),await Ue()}catch(ve){ae(ve.message||"Refresh failed","error")}finally{L.value=null}}function $s(z,ve){$.value=z,te.value=ve||""}async function li(z){try{await G.put("/api/codex/account/"+z+"/label",{label:te.value}),ae("Label updated"),$.value=null,await Ue()}catch(ve){ae(ve.message||"Failed","error")}}async function _a(z,ve){if(await Zt({title:"Delete Codex account",message:`Delete ${ve||"account #"+(z+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/codex/account/"+z),ae("Deleted. Pool reloaded."),await Ue()}catch(_t){ae(_t.message||"Failed","error")}}async function qn(){ee.value=!0;try{const z=await G.post("/api/codex/device-code");he.value=z,Y.value="pending",wa(z)}catch(z){ae(z.message||"Failed","error")}finally{ee.value=!1}}async function wa(z){se={cancelled:!1};const ve=se;try{const Ae=await G.post("/api/codex/device-poll",{device_auth_id:z.device_auth_id,user_code:z.user_code,interval:z.interval});if(ve.cancelled)return;de.value=Ae,Y.value="success",await Te()}catch(Ae){if(ve.cancelled)return;oe.value=Ae.message||"Device login failed",Y.value="error"}}function Gn(){se&&(se.cancelled=!0),Y.value=null,he.value=null}return Ze(Te),xt(()=>{se&&(se.cancelled=!0),ut.cancel(),rs.cancel(),os.cancel(),Qe.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:Ce,advancedOpen:y,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:p,auxForm:f,auxData:v,auxModelOptions:b,onAuxModelChange:E,savingAux:O,saveAuxConfigDebounced:rs,ollamaForm:P,kimiForm:R,savingCodex:U,savingOllama:N,savingKimi:I,probingOllama:W,ollamaKeyDirty:V,kimiKeyDirty:X,ollamaStatus:Ee,ollamaModels:re,ollamaSelectedModel:ge,reloading:ne,settingModel:be,kimiStatus:Z,kimiModels:B,kimiSelectedModel:ie,reloadingKimi:le,settingKimiModel:_e,codexLoading:ye,codexError:$e,codexData:w,refreshing:L,editingLabel:$,labelValue:te,contextWindows:m,contextWindowsLoading:x,contextWindowsError:S,contextBudgetRows:C,activeClampRows:D,activeContextBudget:H,clearingClamp:g,contextPolicyDirty:k,deviceState:Y,deviceLoading:ee,deviceInfo:he,deviceResult:de,deviceError:oe,fetchAll:Te,switchProvider:mt,reloadOllama:Yt,setOllamaModel:Ds,reloadKimi:Ps,setKimiModel:Pt,probeOllamaModels:An,saveCodexConfig:Qt,saveOllamaConfig:Cs,saveKimiConfig:Fs,saveCodexAdvancedConfig:Vs,saveOllamaAdvancedConfig:nn,saveKimiAdvancedConfig:qs,saveCodexConfigDebounced:ut,saveOllamaConfigDebounced:os,saveKimiConfigDebounced:Qe,saveCodexConfigNow:vs,saveOllamaConfigNow:q,saveKimiConfigNow:ue,saveCodexAdvancedConfigNow:Oe,saveOllamaAdvancedConfigNow:Je,saveKimiAdvancedConfigNow:rt,activateAccount:Ft,refreshAccount:xa,startEditLabel:$s,saveLabel:li,deleteAccount:_a,startDeviceLogin:qn,cancelDeviceLogin:Gn,formatSize:me,fetchContextWindows:Me,clearContextClamp:Lt,setContextOverride:qe,setContextUtilization:dt,resetContextOverride:J,overrideAboveFloor:ze,formatCount:F,formatContextCeiling:ce,formatExpiry:xe,shortAccountKey:Se,provenanceClass:Le}}},Vu={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Ck(e){return Vu[e]||Vu[(e||"").toLowerCase()]||"text-gray-400"}const Ek={template:`
...
`+s.join(`
`),b=this.blockquote(v);i[i.length-1]=b,n=n.substring(0,n.length-f.raw.length)+b.raw,a=a.substring(0,a.length-f.text.length)+b.text;break}else if((p==null?void 0:p.type)==="list"){const f=p,v=f.raw+`
`+s.join(`
`),b=this.list(v);i[i.length-1]=b,n=n.substring(0,n.length-p.raw.length)+b.raw,a=a.substring(0,a.length-f.raw.length)+b.raw,s=v.substring(i.at(-1).raw.length).split(`
