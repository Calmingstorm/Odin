...
`)}}return}}let i=null;function l(){const p=Date.now();e.value.forEach(f=>{f.status==="running"&&(f.elapsed=p-f.startTime)})}let r=!1;function o(){r||(r=!0,Ve.on("events",a),i||(i=setInterval(l,500)))}function c(){r&&(r=!1,Ve.off("events",a),i&&(clearInterval(i),i=null))}Ze(o),ws(o),ks(c),xt(c);function d(p){return p<1e3?`${p}ms`:`${(p/1e3).toFixed(1)}s`}function u(p){return p==="running"?"clock":p==="success"?"success":p==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
...
... (truncated)`:s}function Du(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function wm(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Sm=Symbol("agent-detail-cancelled"),iw=15e3;function lw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((f,g)=>{o=f,c=g});function u(f,g){r||(r=!0,l!==null&&a(l),l=null,(f?o:c)(g))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return r||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sm),i==null||i.abort()}}}function Tm({state:e,requestDetail:t,timeoutMs:s=iw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const p=l;l=null,p==null||p.cancel()}function o(p,{initial:f,coalesce:g}){if(!p)return Promise.resolve();if(g&&l&&l.agentId===p&&e.detailId===p)return l.promise;r();const b={agentId:p,cancel:null,promise:null};l=b,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const E=lw(O=>t(p,{signal:O}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return b.cancel=E.cancel,b.promise=(async()=>{let O=null,y=null;try{O=await E.promise}catch(m){y=m}O!==Sm&&(l!==b||e.detailId!==p||(l=null,!y&&(O===null||typeof O!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=O,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,o(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?o(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function rw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const ow={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h(null),d=h(null),u=h(!1),p=h(null),f=h("");let g=!1;const E=Tm({state:{get detail(){return c.value},set detail(L){c.value=L},get detailId(){return d.value},set detailId(L){d.value=L},get detailLoading(){return u.value},set detailLoading(L){u.value=L},get detailError(){return p.value},set detailError(L){p.value=L}},detailLabel:"Loop detail",requestDetail:(L,{signal:I})=>G.get(`/api/loops/${encodeURIComponent(L)}?limit=100`,{signal:I})});async function O(L){f.value="",await E.open(L.id)}function y(){E.close(),f.value=""}async function m(L,I){try{await navigator.clipboard.writeText(I||""),f.value=L,setTimeout(()=>{f.value===L&&(f.value="")},1500)}catch{Ie.error("Copy failed")}}const x=K(()=>e.value.reduce((L,I)=>L+(I.iteration_count||0),0)),S=K(()=>e.value.filter(L=>L.status==="running").length);function v(L){return L==="running"?"loop-status-running":L==="error"?"loop-status-error":"loop-status-stopped"}function k(L){return L==="running"?"badge-success":L==="error"?"badge-danger":L==="completed"?"badge-info":"badge-warning"}function T(L){return L==="act"?"badge-warning":L==="silent"?"badge-info":"badge-success"}async function C(L=!1){L=L===!0,L||(t.value=!0);try{const I=await G.get("/api/loops");e.value=Array.isArray(I)?I:[],s.value=null}catch(I){L||(s.value=I.message)}L||(t.value=!1)}async function D(){l.value=null;const L=a.value;if(!L.goal.trim()){l.value="Goal is required";return}if(!L.channel_id.trim()){l.value="Channel ID is required";return}const I={goal:L.goal.trim(),channel_id:L.channel_id.trim(),interval_seconds:L.interval_seconds||60,mode:L.mode,max_iterations:L.max_iterations||50};L.stop_condition.trim()&&(I.stop_condition=L.stop_condition.trim()),i.value=!0;try{const W=await G.post("/api/loops",I);Ie.success(`Loop started: ${W.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await C()}catch(W){l.value=W.message}i.value=!1}async function B(L){if(await Zt({title:"Stop loop",message:`Stop loop ${L}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=L;try{await G.del(`/api/loops/${encodeURIComponent(L)}`),Ie.success("Loop stopped"),await C()}catch(W){Ie.error(W.message||"Failed to stop loop")}r.value=null}}async function P(L){o.value=L;try{await G.post(`/api/loops/${encodeURIComponent(L)}/restart`),Ie.success("Loop restarted"),await C()}catch(I){Ie.error(I.message||"Failed to restart loop")}o.value=null}function R(L){g&&L.payload&&(L.payload.loop_id||L.payload.type==="loop")&&(C(!0),d.value&&E.refresh())}let V=null;function X(){V!==null&&clearInterval(V),V=null}function $(){X(),g&&(V=setInterval(()=>{C(!0),d.value&&E.refresh()},5e3))}return Ze(()=>{g=!0,C(),Ve.subscribe("events",R),$()}),ws(()=>{g=!0,C(!0),$()}),ks(()=>{g=!1,X()}),xt(()=>{g=!1,Ve.unsubscribe("events",R),X(),E.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:p,copied:f,totalIterations:x,runningCount:S,statusDotClass:v,statusBadge:k,modeBadge:T,formatAge:xm,formatDuration:si,formatTs:ba,formatTokens:km,openDetail:O,closeDetail:y,copyText:m,fetchLoops:C,doCreate:D,doStop:B,doRestart:P}}},dw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),r=h(null),o=K(()=>hw(a.value.run_at));as(()=>a.value.run_at,()=>{r.value=null});const c=K(()=>{var U;const Z=o.value;return Z.state==="ok"?Z.instant:Z.state==="ambiguous"&&r.value!==null&&((U=Z.options[r.value])==null?void 0:U.instant)||null}),d=K(()=>{const Z=c.value;return Z?`${Z.toLocaleString()} local — ${Z.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],g=h(null),b=h(null),E=h(null),O=h(null),y=h(null),m=h(null),x=h([]),S=h(!1),v=h("");let k=0;const T=K(()=>e.value.filter(Z=>Z.cron&&!Z.one_time).length),C=K(()=>e.value.filter(Z=>Z.one_time).length),D=K(()=>e.value.filter(Z=>Z.trigger).length),B=K(()=>e.value.filter(Z=>Z.paused).length),P=K(()=>e.value.filter(Z=>Z.consecutive_failures>0).length);function R(Z){if(!Z)return"-";const U=Date.now(),le=(new Date(Z).getTime()-U)/1e3;if(le<0)return"overdue";if(le<60)return"in < 1 min";if(le<3600)return`in ${Math.floor(le/60)} min`;if(le<86400){const ye=Math.floor(le/3600),Be=Math.floor(le%3600/60);return Be>0?`in ${ye}h ${Be}m`:`in ${ye}h`}const _e=Math.floor(le/86400);return`in ${_e} day${_e!==1?"s":""}`}function V(Z){return Z==null?"-":Z<1e3?`${Z}ms`:Z<6e4?`${(Z/1e3).toFixed(1)}s`:si(Z/1e3)}function X(Z=a.value.cron){a.value.cron=Z,Pu(a.value,"cron"),u.value=null}function $(Z=a.value.run_at){a.value.run_at=Z,Pu(a.value,"run_at"),u.value=null}async function L(){const Z=a.value.cron.trim();if(Z){p.value=!0;try{u.value=await G.post("/api/schedules/validate-cron",{expression:Z})}catch(U){u.value={valid:!1,error:U.message}}p.value=!1}}async function I(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(Z){s.value=Z.message}t.value=!1}async function W(Z){if(m.value===Z){m.value=null,x.value=[];return}m.value=Z,S.value=!0,x.value=[];const U=++k;try{const ie=await G.get(`/api/schedules/${encodeURIComponent(Z)}/history?limit=10`);if(U!==k||m.value!==Z)return;x.value=ie,v.value=""}catch(ie){if(U!==k||m.value!==Z)return;x.value=[],v.value=ie.message||"Failed to load execution history"}U===k&&(S.value=!1)}async function Ce(){l.value=null;const Z=a.value;if(!Z.description.trim()){l.value="Description is required";return}if(!Z.channel_id.trim()){l.value="Channel ID is required";return}if(!Z.cron.trim()&&!Z.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(Z.cron.trim()&&Z.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const U={description:Z.description.trim(),action:Z.action,channel_id:Z.channel_id.trim()};if(Z.cron.trim()&&(U.cron=Z.cron.trim()),Z.run_at.trim()){const ie=o.value;if(ie.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(ie.state==="invalid"){l.value="One-time run time is not a valid date";return}const le=c.value;if(ie.state==="ambiguous"&&r.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!le){l.value="One-time run time could not be resolved";return}U.run_at=le.toISOString()}if(Z.action==="reminder"&&Z.message.trim()&&(U.message=Z.message.trim()),Z.action==="check"&&(Z.tool_name.trim()&&(U.tool_name=Z.tool_name.trim()),Z.report_format&&(U.report_format=Z.report_format),Z.tool_input_str.trim()))try{U.tool_input=JSON.parse(Z.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",U),Ie.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await I()}catch(ie){l.value=ie.message}i.value=!1}async function Ee(Z){g.value=Z;try{const U=await G.post(`/api/schedules/${encodeURIComponent(Z)}/run`);if(U.status==="failure")Ie.error(`Execution failed: ${U.error||"unknown error"}`);else{const ie=U.warning?`Executed (${U.warning})`:"Executed successfully";Ie.success(ie)}await I()}catch(U){Ie.error(U.message||"Failed to trigger")}g.value=null}async function re(Z){E.value=Z.id;const U=!Z.paused;try{await G.put(`/api/schedules/${encodeURIComponent(Z.id)}`,{paused:U}),Ie.success(U?"Schedule paused":"Schedule resumed"),await I()}catch(ie){Ie.error(ie.message||"Failed to update schedule")}E.value=null}async function be(Z,U){y.value=Z.id;try{await G.put(`/api/schedules/${encodeURIComponent(Z.id)}`,{report_format:U}),Ie.success(U?"Structured report enabled":"Plain-text report enabled")}catch(ie){Ie.error(`Update failed: ${ie.message}`)}finally{await I(),y.value=null}}async function se(Z){O.value=Z;try{await G.post(`/api/schedules/${encodeURIComponent(Z)}/reset-failures`),Ie.success("Failure counters reset"),await I()}catch(U){Ie.error(U.message||"Failed to reset")}O.value=null}async function ge(Z){const U=e.value.find(le=>le.id===Z);if(await Zt({title:"Delete schedule",message:`Delete "${(U==null?void 0:U.description)||Z}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){b.value=Z;try{await G.del(`/api/schedules/${encodeURIComponent(Z)}`),Ie.success("Schedule deleted"),await I()}catch(le){Ie.error(le.message||"Failed to delete schedule")}b.value=null}}return Ze(()=>{I()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:o,runAtOccurrence:r,cronResult:u,validatingCron:p,cronPresets:f,runningId:g,deletingId:b,togglingId:E,resettingId:O,reportUpdatingId:y,expandedId:m,history:x,historyLoading:S,historyError:v,cronCount:T,oneTimeCount:C,webhookCount:D,pausedCount:B,failingCount:P,formatTs:ba,formatAge:xm,formatFuture:R,formatMs:V,formatDuration:si,onCronInput:X,onRunAtInput:$,validateCron:L,toggleExpand:W,fetchSchedules:I,doCreate:Ce,doRunNow:Ee,doTogglePause:re,doUpdateReportFormat:be,doResetFailures:se,doDelete:ge}}},Cm=[{id:"live",label:"Live",component:nw},{id:"agents",label:"Agents",component:ow},{id:"loops",label:"Loops",component:cw},{id:"processes",label:"Processes",component:dw},{id:"schedules",label:"Schedules",component:mw}],gw={components:{TabbedPage:$r},setup(){return{tabs:Cm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const r=h(null),o=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),g=h(!1),b=Fu,E=bw,O=h([]),y=h(!1),m=h(""),x=h("flat"),S=h(new Set),v=h(""),k=h(""),T=h(""),C=h(null),D=h(!1);function B(){try{const J=localStorage.getItem("odin-session-presets");J&&(O.value=JSON.parse(J))}catch{}}function P(){try{localStorage.setItem("odin-session-presets",JSON.stringify(O.value))}catch{}}const R=K(()=>p.value.trim()!==""||u.value!=="all"),V=K(()=>{let J=[...e.value];const Te=Fu.find(He=>He.id===u.value),Le=Te?Te.filters:{};if(Le.source&&(J=J.filter(He=>He.source===Le.source)),Le.minMessages&&(J=J.filter(He=>He.message_count>=Le.minMessages)),Le.hasCompaction&&(J=J.filter(He=>He.has_summary)),Le.maxAge!=null){const He=Date.now()/1e3;J=J.filter(mt=>mt.last_active&&He-mt.last_active<=Le.maxAge)}if(p.value.trim()){const He=p.value.toLowerCase().trim();J=J.filter(mt=>(mt.channel_id||"").toLowerCase().includes(He)||(mt.last_user_id||"").toLowerCase().includes(He)||(mt.source||"").toLowerCase().includes(He))}const Pe=f.value,Ge=g.value?1:-1;return J.sort((He,mt)=>{const Yt=He[Pe]||0,Ds=mt[Pe]||0;return(Yt-Ds)*Ge}),J}),X=K(()=>{if(!a.value||!a.value.messages)return[];const J=a.value.messages;if(J.length===0)return[];const Te=[];let Le=[];for(const Pe of J)Pe.role==="user"&&Le.length>0&&(Te.push(Le),Le=[]),Le.push(Pe);return Le.length>0&&Te.push(Le),Te}),$=K(()=>V.value.length>0&&c.value.size===V.value.length);function L(J){const Te=J.find(Le=>Le.role==="user");if(Te&&Te.content){const Le=Te.content.slice(0,120);return Le.length<Te.content.length?Le+"...":Le}return"(no user message)"}function I(J){const Te=new Set(S.value);Te.has(J)?Te.delete(J):Te.add(J),S.value=Te}function W(J){u.value=J}function Ce(J){u.value=J.id,J.filters.searchQuery!=null&&(p.value=J.filters.searchQuery),J.filters.sortBy&&(f.value=J.filters.sortBy)}function Ee(){if(!m.value.trim())return;const J={id:"custom-"+Date.now(),name:m.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};O.value=[...O.value,J],P(),y.value=!1,m.value=""}function re(J){O.value=O.value.filter(Te=>Te.id!==J),P(),u.value===J&&(u.value="all")}function be(){u.value="all",p.value="",f.value="last_active",g.value=!1}function se(J){if(!J)return"—";const Te=Date.now()/1e3-J;if(Te<60)return"just now";if(Te<3600){const Pe=Math.floor(Te/60);return`${Pe} minute${Pe!==1?"s":""} ago`}if(Te<86400){const Pe=Math.floor(Te/3600);return`${Pe} hour${Pe!==1?"s":""} ago`}const Le=Math.floor(Te/86400);return`${Le} day${Le!==1?"s":""} ago`}function ge(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Z(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString()}catch{return""}}function U(J){return J==="user"?"bg-gray-900/50 border border-gray-800":J==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ie(J){return J==="user"?"sess-msg-user":J==="assistant"?"sess-msg-assistant":"sess-msg-system"}function le(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":"badge-warning"}function _e(J){return J==="user"?"sess-dot-user":J==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ye(J){return J==="user"?"text-cyan-400":J==="assistant"?"text-indigo-400":"text-gray-500"}function Be(J){return J?J.length>2e3?J.slice(0,2e3)+`
... (truncated)`:J:""}async function w(){const J=v.value.trim();if(J){D.value=!0;try{let Te=`/api/sessions/search?q=${encodeURIComponent(J)}&limit=50`;k.value.trim()&&(Te+=`&channel_id=${encodeURIComponent(k.value.trim())}`),T.value.trim()&&(Te+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Le=await G.get(Te);C.value=Le.results||[]}catch{C.value=[]}D.value=!1}}function N(){v.value="",k.value="",T.value="",C.value=null}function F(J){return J?J.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function te(J){return J==="user"?"fts-result-user":J==="assistant"?"fts-result-assistant":J==="summary"?"fts-result-summary":J==="fts"?"fts-result-fts":J==="channel"?"fts-result-channel":"fts-result-default"}function Y(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":J==="summary"?"badge-warning":J==="fts"?"badge-success":"badge-info"}async function ee(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(J){s.value=J.message}t.value=!1}function he(){s.value=null,ee()}async function ce(J){if(n.value===J){n.value=null,a.value=null,S.value=new Set;return}n.value=J,a.value=null,i.value=!0,S.value=new Set;const Te=++l;try{const Le=await G.get(`/api/sessions/${encodeURIComponent(J)}`);Te===l&&n.value===J&&(a.value=Le)}catch(Le){Te===l&&n.value===J&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{Te===l&&(i.value=!1)}}function oe(J){const Te=new Set(c.value);Te.has(J)?Te.delete(J):Te.add(J),c.value=Te}function ne(){$.value?c.value=new Set:c.value=new Set(V.value.map(J=>J.channel_id))}function ae(J){r.value=J}async function me(){if(r.value){o.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await ee()}catch(J){s.value=J.message||"Failed to clear session"}o.value=!1,r.value=null}}function xe(){d.value=!0}async function Oe(){if(c.value.size!==0){o.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await ee()}catch(J){s.value=J.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}async function H(J,Te){const Le=`/api/sessions/${encodeURIComponent(J)}/export?format=${Te}`;try{const Pe=await G.getBlob(Le),Ge=URL.createObjectURL(Pe),He=document.createElement("a");He.href=Ge,He.download=`session-${J}.${Te==="text"?"txt":"json"}`,He.click(),URL.revokeObjectURL(Ge)}catch(Pe){s.value=Pe.message||"Failed to export session"}}let de=null;function we(J){J.payload&&J.payload.channel_id&&(clearTimeout(de),de=setTimeout(()=>{if(ee(),n.value&&J.payload.channel_id===n.value){const Te=n.value,Le=l;G.get(`/api/sessions/${encodeURIComponent(Te)}`).then(Pe=>{Le!==l||n.value!==Te||(a.value=Pe)}).catch(()=>{})}},2e3))}let Re=!1;function Me(){Re||(Re=!0,ee(),Ve.subscribe("events",we))}Ze(()=>{B(),Me()}),ws(()=>{Me()});function dt(){Re&&(Re=!1,Ve.unsubscribe("events",we),clearTimeout(de))}return ks(dt),xt(dt),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:$,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:g,filterPresets:b,sortOptions:E,filteredSessions:V,hasActiveFilters:R,customPresets:O,showSavePreset:y,newPresetName:m,threadView:x,threads:X,collapsedThreads:S,ftsQuery:v,ftsChannelId:k,ftsUserId:T,ftsResults:C,ftsSearching:D,formatAge:se,formatTimestamp:ge,formatFullTimestamp:Z,messageClass:U,threadMsgClass:ie,roleBadge:le,roleDotClass:_e,roleLabelClass:ye,truncateContent:Be,threadSummary:L,fetchSessions:ee,retry:he,toggleSession:ce,toggleSelect:oe,toggleSelectAll:ne,confirmClear:ae,clearSession:me,confirmBulkClear:xe,doBulkClear:Oe,exportSession:H,applyPreset:W,applyCustomPreset:Ce,saveCustomPreset:Ee,removeCustomPreset:re,resetFilters:be,toggleThread:I,runFtsSearch:w,clearFtsSearch:N,highlightSnippet:F,ftsResultClass:te,ftsTypeBadge:Y}}},xw={props:["trace"],template:`
...
`).length:0}function B(se){return Cw(se)}function P(se){n.value={...n.value,[se]:!n.value[se]}}async function R(se){try{await navigator.clipboard.writeText(se);const ge=e.value.find(Z=>Z.code===se);ge&&(r.value=ge.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function V(se){if(se.key==="Tab"){se.preventDefault();const ge=se.target,Z=ge.selectionStart,U=ge.selectionEnd;u.value=u.value.substring(0,Z)+"    "+u.value.substring(U),Ct(()=>{ge.selectionStart=ge.selectionEnd=Z+4})}}function X(se){const ge=se.target.previousElementSibling;ge&&(ge.scrollTop=se.target.scrollTop)}async function $(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(se){s.value=se.message}t.value=!1}async function L(se){i.value=se,delete a.value[se],a.value={...a.value};try{const ge=await G.post(`/api/skills/${encodeURIComponent(se)}/test`);a.value={...a.value,[se]:ge}}catch(ge){a.value={...a.value,[se]:{result:ge.message,is_error:!0}}}i.value=null}function I(){o.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function W(se){o.value=!0,c.value="edit",d.value=se.name,u.value=se.code||"",p.value=null,f.value=null}function Ce(){o.value=!1,p.value=null,f.value=null}async function Ee(){p.value=null,f.value=null;const se=d.value.trim(),ge=u.value.trim();if(!se){p.value="Name is required";return}if(!ge){p.value="Code is required";return}g.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:se,code:ge}),f.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(se)}`,{code:ge}),f.value="Skill updated successfully"),await $(),setTimeout(()=>{o.value=!1},800)}catch(Z){p.value=Z.message}g.value=!1}function re(se){E.value=se}async function be(){if(E.value){O.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(E.value)}`),await $()}catch(se){Ie.error(`Failed to delete skill: ${se.message||"unknown error"}`)}O.value=!1,E.value=null}}return Ze(()=>{$()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:g,editorRef:b,deleteTarget:E,deleting:O,enabledCount:y,totalExecutions:m,totalLines:x,displayedSkills:S,editLineCount:v,editorLineNums:k,editValidation:T,highlight:C,truncate:Qc,formatTs:ba,countLines:D,getLineNumbers:B,toggleCode:P,copyCode:R,handleEditorKey:V,syncScroll:X,fetchSkills:$,testSkill:L,showCreate:I,editSkill:W,cancelEdit:Ce,saveSkill:Ee,confirmDelete:re,doDelete:be}}};class Rs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Aw=/^[A-Za-z_][A-Za-z0-9_]*$/;function $u(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Uu(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const r=String((l==null?void 0:l.key)||"").trim(),o=String((l==null?void 0:l.value)??"");if(!(!r&&!o)){if(!r)throw new Rs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(r))throw new Rs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,r))throw new Rs(`${s} key “${r}” appears more than once.`,"authentication");if(i.has(r))throw new Rs(`${s} key “${r}” cannot be replaced and removed in the same save.`,"authentication");n[r]=o}}return{set:n,remove:a}}function Rw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Iw(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Rs("Server name is required.","name");if(a.length>128||!Aw.test(a))throw new Rs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,r={enabled:!!e.enabled,transport:i};if(n&&(r.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Rs("An executable path is required for a new stdio connection.","command");if(d&&(r.command=d),(n||e.replaceArgs)&&(r.args=$u(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Rs("Working directory must be an absolute path.","cwd");r.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Rs("An HTTP endpoint is required for this connection.","url");if(d&&!Rw(d))throw new Rs("Endpoint must be a valid http:// or https:// URL.","url");d&&(r.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Rs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");r.timeout_seconds=d}(n||e.replaceAllowlist)&&(r.tool_allowlist=$u(e.allowlistText));const o=Uu(e.headerRows,e.headersRemove,"Header"),c=Uu(e.envRows,e.envRemove,"Environment variable");return Object.keys(o.set).length&&(r.headers_set=o.set),o.remove.length&&(r.headers_remove=o.remove),Object.keys(c.set).length&&(r.env_set=c.set),c.remove.length&&(r.env_remove=c.remove),r}function Ow(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function Lw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Nw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const Mw=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function Dw(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Pw=1e4,Fw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function lo(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function $w(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Uw={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),r=h({}),o=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),g=h(lo()),b=h(""),E=h(!1);let O=null,y=0,m=!1,x=!1;const S=Mw,v=K(()=>{var H;return((H=e.value)==null?void 0:H.servers)||[]}),k=K(()=>{var H;return!!((H=e.value)!=null&&H.enabled)}),T=K(()=>{var H,de,we,Re;return{serverCount:((H=e.value)==null?void 0:H.server_count)||0,enabledCount:((de=e.value)==null?void 0:de.enabled_server_count)||0,connectedCount:((we=e.value)==null?void 0:we.connected_count)||0,toolCount:((Re=e.value)==null?void 0:Re.published_tool_count)||0}}),C=K(()=>{var H;return((H=f.value)==null?void 0:H.header_keys)||[]}),D=K(()=>{var H;return((H=f.value)==null?void 0:H.env_keys)||[]}),B=K(()=>{var H;return u.value==="edit"&&((H=f.value)==null?void 0:H.transport)==="http"}),P=K(()=>u.value==="add"||!B.value),R=K(()=>B.value?"Replace endpoint URL":"Endpoint URL"),V=K(()=>B.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function X(){$(),O=window.setInterval(()=>L({quiet:!0}),Pw)}function $(){O&&window.clearInterval(O),O=null}async function L({quiet:H=!1}={}){const de=++y;H||(t.value=!0);try{const we=await G.get("/api/mcp/status");if(de!==y||!m)return;e.value=we,n.value="";const Re=new Set((we.servers||[]).map(Me=>Me.name));i.value=new Set([...i.value].filter(Me=>Re.has(Me)))}catch(we){de===y&&m&&(n.value=we.message||"Failed to load MCP status")}finally{de===y&&(t.value=!1)}}function I(H){return s.value||a.value.has(H)}function W(H,de){const we=new Set(a.value);de?we.add(H):we.delete(H),a.value=we}function Ce(H){return Lw(H.state)}function Ee(H){if(Ce(H)==="disabled"){if(!H.enabled)return"Disabled — server switch off";if(!k.value)return"Disabled — global MCP is off"}return Fw[Ce(H)]}function re(H){return H.transport==="http"?"Streamable HTTP":"stdio"}function be(H){return H.negotiated_version?`${H.era?`${String(H.era).charAt(0).toUpperCase()}${String(H.era).slice(1)}`:"Protocol"} · ${H.negotiated_version}`:"Not negotiated"}function se(H){return H.discovered_count?`${H.published_count||0} published · ${H.excluded_count||0} excluded`:"No tools discovered"}const ge=h(new Set);async function Z(H,de){if(ge.value.has(H.name))return;const we=!!de.target.checked,Re=new Set(ge.value);Re.add(H.name),ge.value=Re;try{const Me=await G.post(`/api/mcp/servers/${encodeURIComponent(H.name)}/enabled`,{enabled:we});Me&&Array.isArray(Me.servers)?e.value=Me:await L({quiet:!0})}catch(Me){de.target.checked=!!H.enabled,Ie.error(Me.message||`Failed to toggle ${H.name}`)}finally{const Me=new Set(ge.value);Me.delete(H.name),ge.value=Me}}async function U(H){if(H!==k.value&&!(!H&&!await Zt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await G.post("/api/mcp/enabled",{enabled:H}),Ie.success(H?"MCP enabled":"MCP disabled"),await L({quiet:!0})}catch(de){Ie.error(de.message||"Failed to update MCP state"),await L({quiet:!0})}finally{s.value=!1}}}async function ie(H){W(H.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(H.name)}/reconnect`,{}),Ie.success(`Reconnected ${H.name}`)}catch(de){Ie.error(de.message||`Failed to reconnect ${H.name}`)}finally{W(H.name,!1),await L({quiet:!0})}}async function le(H){W(H.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(H.name)}/refresh-tools`,{}),Ie.success(`Refreshed tools from ${H.name}`),await Be(H.name,!0)}catch(de){Ie.error(de.message||`Failed to refresh ${H.name}`)}finally{W(H.name,!1),await L({quiet:!0})}}async function _e(H){if(await Zt({title:`Remove ${H.name}`,message:`Remove this saved MCP server? Its ${H.published_count||0} published tool${H.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){W(H.name,!0);try{await G.del(`/api/mcp/servers/${encodeURIComponent(H.name)}`),Ie.success(`Removed ${H.name}`),delete r.value[H.name]}catch(we){Ie.error(we.message||`Failed to remove ${H.name}`)}finally{W(H.name,!1),await L({quiet:!0})}}}async function ye(H){const de=new Set(i.value);if(de.has(H.name)){de.delete(H.name),i.value=de;return}de.add(H.name),i.value=de,Object.hasOwn(r.value,H.name)||await Be(H.name)}async function Be(H,de=!1){if(!de&&Object.hasOwn(r.value,H))return;const we=new Set(c.value);we.add(H),c.value=we,o.value={...o.value,[H]:""};try{const Re=await G.get(`/api/mcp/servers/${encodeURIComponent(H)}/tools`);r.value={...r.value,[H]:Re.tools||[]}}catch(Re){o.value={...o.value,[H]:Re.message||"Failed to load tools"}}finally{const Re=new Set(c.value);Re.delete(H),c.value=Re}}function w(H){return(r.value[H]||[]).filter(de=>Nw(de,l.value[H]))}function N(H,de){l.value={...l.value,[H]:de}}function F(){u.value="add",p.value="",f.value=null,g.value=lo(),b.value="",d.value=!0}function te(H){u.value="edit",p.value=H.name,f.value=H,g.value={...lo(),name:H.name,enabled:!!H.enabled,transport:H.transport||"stdio"},b.value="",d.value=!0}function Y(){E.value||(d.value=!1)}function ee(H){d.value&&Dw(H)}function he(H){const de=H==="headers"?"headerRows":"envRows";g.value[de].push({key:"",value:""})}function ce(H,de){const we=H==="headers"?"headerRows":"envRows";g.value[we].splice(de,1)}function oe(H,de){const we=H==="headers"?"headersRemove":"envRemove",Re=g.value[we];g.value[we]=Re.includes(de)?Re.filter(Me=>Me!==de):[...Re,de]}async function ne(){var de,we;b.value="";let H;try{H=Iw(g.value,{mode:u.value,originalTransport:((de=f.value)==null?void 0:de.transport)||""})}catch(Re){b.value=Re instanceof Rs?Re.message:"Invalid MCP server configuration",await Ct(),(we=document.querySelector(".mcp-editor"))==null||we.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Ow(H,f.value)&&!await Zt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){E.value=!0;try{u.value==="add"?await G.post("/api/mcp/servers",H):await G.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,H),Ie.success(u.value==="add"?`Saved ${H.name}`:`Updated ${p.value}`),d.value=!1,await L({quiet:!0})}catch(Re){b.value=Re.message||"Failed to save MCP server"}finally{E.value=!1}}}let ae=null;function me(H){`${(H==null?void 0:H.event)||""} ${(H==null?void 0:H.type)||""} ${(H==null?void 0:H.tool)||""} ${(H==null?void 0:H.message)||""}`.toLowerCase().includes("mcp")&&(ae&&window.clearTimeout(ae),ae=window.setTimeout(()=>L({quiet:!0}),200))}function xe(){m||(m=!0,x||(Ve.subscribe("events",me),x=!0),L(),X())}function Oe(){m=!1,$(),ae&&window.clearTimeout(ae),ae=null,x&&(Ve.unsubscribe("events",me),x=!1)}return Ze(xe),ws(xe),ks(Oe),xt(Oe),{status:e,loading:t,mutating:s,pageError:n,servers:v,masterEnabled:k,aggregate:T,expandedServers:i,toolQueries:l,toolErrors:o,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:g,formError:b,saving:E,editorGroups:S,configuredHeaderKeys:C,configuredEnvKeys:D,savedHttpEndpoint:B,endpointRequired:P,endpointFieldLabel:R,endpointPlaceholder:V,refreshAll:L,busy:I,serverState:Ce,stateLabel:Ee,transportLabel:re,protocolLabel:be,toolSummary:se,formatAge:$w,setMasterEnabled:U,togglePending:ge,toggleServerEnabled:Z,reconnect:ie,refreshTools:le,removeServer:_e,toggleTools:ye,filteredTools:w,setToolQuery:N,openAdd:F,openEdit:te,closeEditor:Y,jumpToEditorGroup:ee,addSecretRow:he,removeSecretRow:ce,toggleSecretRemoval:oe,saveServer:ne}}};function Bw(e,t){if(!e||!t)return Du(e);const s=Du(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),g=h(null),b=h(null);let E=null;const O=h(null),y=h(!1),m=h({}),x=h({}),S=h(null),v=h(null),k=K(()=>e.value.reduce((I,W)=>I+(W.chunks||0),0)),T=K(()=>new Set(e.value.map(W=>W.uploader).filter(Boolean)).size);function C(I,W){const Ce=x.value[W];if(!Ce||Ce.length===0)return 0;const Ee=Math.max(...Ce.map(re=>re.char_count||0));return Ee===0?0:Math.round(I.char_count/Ee*100)}async function D(){t.value=!0,s.value=null;try{const I=await G.get("/api/knowledge");e.value=Array.isArray(I)?I:[]}catch(I){s.value=I.message}t.value=!1}async function B(I){if(m.value[I]){m.value[I]=!1,v.value=null;return}if(m.value[I]=!0,!(x.value[I]||S.value===I)){S.value=I;try{const W=await G.get(`/api/knowledge/${encodeURIComponent(I)}/chunks`);x.value[I]=Array.isArray(W)?W:[]}catch(W){x.value[I]=[],Ie.error(`Failed to load chunks: ${W.message}`)}S.value=null}}async function P(){const I=n.value.trim();if(I){i.value=!0,r.value=null,l.value=I;try{const W=await G.get(`/api/knowledge/search?q=${encodeURIComponent(I)}`);a.value=Array.isArray(W)?W:[]}catch(W){a.value=[],r.value=W.message||"Search failed"}i.value=!1}}function R(){a.value=null,n.value="",r.value=null}async function V(){u.value=null,p.value=null;const I=c.value.trim(),W=d.value.trim();if(!I){u.value="Source name is required";return}if(!W){u.value="Content is required";return}f.value=!0;try{const Ce=await G.post("/api/knowledge",{source:I,content:W});p.value=`Ingested ${Ce.chunks||0} chunks from "${I}"`,c.value="",d.value="",x.value={},await D(),setTimeout(()=>{o.value=!1,p.value=null},1500)}catch(Ce){u.value=Ce.message}f.value=!1}async function X(I){g.value=I,b.value=null,E&&(clearTimeout(E),E=null);try{const W=await G.post(`/api/knowledge/${encodeURIComponent(I)}/reingest`);b.value={source:I,error:!1,message:`Re-ingested ${W.chunks||0} chunks`},delete x.value[I],await D(),E=setTimeout(()=>{b.value=null,E=null},3e3)}catch(W){b.value={source:I,error:!0,message:W.message}}g.value=null}function $(I){O.value=I}async function L(){if(O.value){y.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(O.value)}`),delete x.value[O.value],await D()}catch(I){Ie.error(`Failed to delete source: ${I.message||"unknown error"}`)}y.value=!1,O.value=null}}return Ze(()=>{D()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:g,reingestResult:b,deleteTarget:O,deleting:y,expanded:m,sourceChunks:x,loadingChunks:S,selectedChunk:v,totalChunks:k,uploaderCount:T,truncate:Qc,formatTs:ba,highlightTerms:Bw,chunkBarWidth:C,fetchSources:D,toggleSource:B,doSearch:P,clearSearch:R,doIngest:V,doReingest:X,confirmDelete:$,doDelete:L}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),g=h(!1),b=h(null),E=h(null),O=h(new Set),y=h(null),m=h(!1),x=h(!1),S=K(()=>e.value.reduce((re,be)=>re+be.count,0)),v=K(()=>O.value.size);function k(re){const be=t.value[re];if(!be)return[];if(!l.value.trim())return be;const se=l.value.trim().toLowerCase();return be.filter(ge=>ge.key.toLowerCase().includes(se)||ge.value&&ge.value.toLowerCase().includes(se))}function T(re,be){return O.value.has(re+"/"+be)}function C(re,be){const se=re+"/"+be,ge=new Set(O.value);ge.has(se)?ge.delete(se):ge.add(se),O.value=ge}function D(re){const be=t.value[re];return!be||be.length===0?!1:be.every(se=>O.value.has(re+"/"+se.key))}function B(re,be){const se=t.value[re];if(!se)return;const ge=new Set(O.value);for(const Z of se){const U=re+"/"+Z.key;be?ge.add(U):ge.delete(U)}O.value=ge}async function P(){s.value=!0,n.value=null;try{const re=await G.get("/api/memory");e.value=Object.entries(re).map(([be,se])=>({name:be,keys:se.keys||[],count:se.count||0}))}catch(re){n.value=re.message}s.value=!1}async function R(re){if(a.value[re]){a.value[re]=!1;return}a.value[re]=!0;const be=e.value.find(ge=>ge.name===re);if(!be||t.value[re]||i.value===re)return;i.value=re;let se;try{const Z=(await G.get(`/api/memory/${encodeURIComponent(re)}`)).entries||{};se=be.keys.map(U=>Object.prototype.hasOwnProperty.call(Z,U)?{key:U,value:Z[U]||"",failed:!1}:{key:U,value:"",failed:!0,error:"Not found in scope"})}catch(ge){se=be.keys.map(Z=>({key:Z,value:"",failed:!0,error:ge.message||"Failed to load"}))}t.value[re]=se,i.value=null}function V(re,be,se){p.value=re+"/"+be,f.value=se}async function X(re,be){g.value=!0,b.value=null;try{await G.put(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(be)}`,{value:f.value});const se=t.value[re];if(se){const ge=se.find(Z=>Z.key===be);ge&&(ge.value=f.value)}p.value=null}catch(se){b.value=`Failed to save: ${se.message||"unknown error"}`}g.value=!1}async function $(re,be){try{await navigator.clipboard.writeText(be.value),E.value=re+"/"+be.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function L(){d.value=null,u.value=null;const re=o.value.scope.trim(),be=o.value.key.trim(),se=o.value.value.trim();if(!re){d.value="Scope is required";return}if(!be){d.value="Key is required";return}if(!se){d.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(be)}`,{value:se}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(ge){d.value=ge.message}c.value=!1}function I(re,be){y.value={scope:re,key:be}}async function W(){if(!y.value)return;m.value=!0,b.value=null;const{scope:re,key:be}=y.value;try{await G.del(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(be)}`);const se=t.value[re];se&&(t.value[re]=se.filter(U=>U.key!==be));const ge=e.value.find(U=>U.name===re);ge&&(ge.count--,ge.keys=ge.keys.filter(U=>U!==be));const Z=new Set(O.value);Z.delete(re+"/"+be),O.value=Z}catch(se){b.value=`Failed to delete: ${se.message||"unknown error"}`}m.value=!1,y.value=null}function Ce(){x.value=!0}async function Ee(){m.value=!0,b.value=null;const re=[];for(const be of O.value){const se=be.indexOf("/");re.push({scope:be.slice(0,se),key:be.slice(se+1)})}try{await G.post("/api/memory/bulk-delete",{entries:re}),O.value=new Set,t.value={},await P()}catch(be){b.value=`Bulk delete failed: ${be.message||"unknown error"}`}m.value=!1,x.value=!1}return Ze(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:g,actionError:b,copied:E,selected:O,selectedCount:v,totalEntries:S,deleteTarget:y,deleting:m,showBulkDelete:x,fetchMemory:P,toggleScope:R,startEdit:V,doEdit:X,copyValue:$,doAdd:L,confirmDelete:I,doDelete:W,confirmBulkDelete:Ce,doBulkDelete:Ee,isSelected:T,toggleSelect:C,isScopeAllSelected:D,toggleSelectAll:B,filteredEntries:k}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const ue=new Blob([q],{type:"text/plain"}),Ne=URL.createObjectURL(ue),Je=document.createElement("a");Je.href=Ne,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL(Ne)}function ee(q,ue){const Ne=`${q.ts} ${q.level} ${q.text||q.raw||""}`;navigator.clipboard.writeText(Ne).then(()=>{p.value=ue,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function he(q){a.value=a.value===q?"":q,O.value="all"}function ce(q){return q.level==="ERROR"?"log-line-error":q.level==="WARNING"?"log-line-warning":"text-gray-300"}function oe(q){return q==="ERROR"?"text-red-500 font-semibold":q==="WARNING"?"text-yellow-500":"text-blue-500"}function ne(q){return q==="ERROR"?"log-chip-error":q==="WARNING"?"log-chip-warning":"log-chip-info"}function ae(q){O.value=q.id;const ue=q.filters;a.value=ue.level||"",y.value=ue.timeRange||"",i.value=ue.text||"",ue.levels&&(a.value=ue.levels[0]||""),ue.hasToolName&&(i.value="")}function me(q){O.value=q.id,a.value=q.filters.level||"",y.value=q.filters.timeRange||"",i.value=q.filters.text||""}function xe(){if(!S.value.trim())return;const q={id:"custom-"+Date.now(),name:S.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};m.value=[...m.value,q],T(),x.value=!1,S.value=""}function Oe(q){m.value=m.value.filter(ue=>ue.id!==q),T(),O.value===q&&(O.value="all")}const H=h("all"),de=h(""),we=h(""),Re=h(""),Me=h(""),dt=h(""),J=h(100),Te=Qw,Le=h(!1),Pe=h(!1),Ge=h(""),He=h([]),mt=h(null),Yt=h(null);function Ds(){e.value="search",mt.value||An()}async function An(){try{mt.value=await G.get("/api/logs/stats")}catch{}}function Ts(){const q=dt.value;if(!q){Re.value="",Me.value="";return}const Ne={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[q];if(Ne){const Je=new Date(Date.now()-Ne*1e3);Re.value=Ps(Je),Me.value=""}}function Ps(q){const ue=Ne=>String(Ne).padStart(2,"0");return`${q.getFullYear()}-${ue(q.getMonth()+1)}-${ue(q.getDate())}T${ue(q.getHours())}:${ue(q.getMinutes())}`}function Pt(q){if(!q)return"";const ue=new Date(q);return isNaN(ue.getTime())?"":ue.toISOString()}async function Qt(){Le.value=!0,Ge.value="",Pe.value=!0,Yt.value=null;try{const q=new URLSearchParams;H.value&&H.value!=="all"&&q.set("level",H.value),de.value&&q.set("tool",de.value),we.value&&q.set("q",we.value);const ue=Pt(Re.value),Ne=Pt(Me.value);ue&&q.set("start",ue),Ne&&q.set("end",Ne),q.set("limit",String(J.value));const Je=await G.get(`/api/logs/search?${q.toString()}`);He.value=Je.entries||[]}catch(q){Ge.value=q.message||"Search failed",He.value=[]}finally{Le.value=!1}}function Vs(){H.value="all",de.value="",we.value="",Re.value="",Me.value="",dt.value="",J.value=100,He.value=[],Pe.value=!1,Ge.value="",Yt.value=null}function Cs(q){Yt.value=Yt.value===q?null:q}function nn(q){if(!q.timestamp)return"";try{return new Date(q.timestamp).toLocaleString()}catch{return q.timestamp}}function Fs(q){return q.type==="web_action"?`${q.status||""} (${q.execution_time_ms||0}ms)`:(q.result_summary||"").slice(0,200)}function qs(q){return q.error?"log-line-error":"text-gray-300"}function Vn(q){try{return JSON.stringify(q,null,2)}catch{return String(q)}}let ut=null,rs=null,os=!1;function Qe(){os||(os=!0,Ve.subscribe("logs",re),r.value=Ve.connected,o.value=Ve.state||"disconnected",ut=Ve.onStateChange,rs=(q,ue)=>{o.value=q,r.value=q==="connected",ut&&ut(q,ue)},Ve.onStateChange=rs)}function gs(){os&&(os=!1,Ve.unsubscribe("logs",re),Ve.onStateChange===rs&&(Ve.onStateChange=ut),rs=null,ut=null)}return Ze(()=>{k(),window.addEventListener("pointerup",w),window.addEventListener("pointercancel",w)}),ws(Qe),ks(gs),xt(()=>{gs(),window.removeEventListener("pointerup",w),window.removeEventListener("pointercancel",w)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:Ce,pauseBuffer:v,showJumpBottom:u,copiedIndex:p,regexError:B,levels:g,logPresets:b,timeRanges:E,timeRange:y,activeLogPreset:O,customLogPresets:m,showSaveLogPreset:x,newLogPresetName:S,hasActiveLogFilters:C,timeRangeLabel:D,timelineBuckets:R,timelineMax:V,timelineSpanLabel:X,timelineLabelSkip:$,togglePause:F,clearLogs:te,exportLogs:Y,logLineClass:ce,levelClass:oe,levelChipClass:ne,toggleLevel:he,copyLine:ee,jumpToBottom:ge,onScroll:U,onUserScrollIntent:le,onUserScrollKey:_e,onAutoScrollToggle:N,onPointerDown:Be,applyLogPreset:ae,applyCustomLogPreset:me,saveLogCustomPreset:xe,removeLogCustomPreset:Oe,segmentHeight:I,jumpToTimelineBucket:W,searchLevel:H,searchTool:de,searchKeyword:we,searchStart:Re,searchEnd:Me,searchTimePreset:dt,searchLimit:J,searchLimits:Te,searching:Le,searchRan:Pe,searchError:Ge,searchResults:He,searchStats:mt,expandedSearch:Yt,switchToSearch:Ds,runSearch:Qt,clearSearchFilters:Vs,toggleSearchExpand:Cs,formatSearchTs:nn,searchEntryText:Fs,searchLogLineClass:qs,formatJson:Vn,applySearchTimePreset:Ts}}};function Sl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const ek=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function tk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const r=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(r)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Va=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],sk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},oo=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),nk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Bu(e){return nk.some(t=>e===t||e.startsWith(`${t}.`))}const Rm="odin_config_center_expanded_v1",Im="odin_config_center_category_v1",ak=50,ik=650,co=()=>G.get("/api/config/meta");function ea(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Oi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ca(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function lk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function rk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Om(e,t){if(Oi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ea(t);const n={};for(const[a,i]of Object.entries(t)){const l=Om(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function ok(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Om(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Lm(e,t,s,n){if(Oi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Lm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function ck(){try{const e=JSON.parse(localStorage.getItem(Rm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function dk(){try{const e=localStorage.getItem(Im);return Va.some(t=>t.key===e)?e:Va[0].key}catch{return Va[0].key}}const uk={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),r=h(null),o=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(dk()),g=h(ck()),b=h({}),E=h({}),O=h(""),y=h({}),m=h({}),x=h([]),S=h([]),v=h(!1),k=h(!1),T=h(!1);let C=null,D=null,B={path:null,at:0},P=0;const R=K(()=>{var _;return(((_=t.value)==null?void 0:_.fields)||[]).filter(M=>!oo.has(M.path.split(".")[0])&&!Bu(M.path))}),V=K(()=>new Map(R.value.map(_=>[_.path,_]))),X=K(()=>Ce.value.reduce((_,M)=>_+M.sections.length,0)),$=K(()=>R.value.length),L=K(()=>ek),I=K(()=>x.value.length>0),W=K(()=>S.value.length>0),Ce=K(()=>{if(!e.value)return[];const _=new Set(Va.flatMap(pe=>pe.sections)),M=Va.map(pe=>({...pe,sections:pe.sections.filter(Fe=>Object.hasOwn(e.value,Fe)&&!oo.has(Fe))})).filter(pe=>pe.sections.length),j=Object.keys(e.value).filter(pe=>!_.has(pe)&&!oo.has(pe));return j.length&&M.push({key:"other",label:"Other",icon:"folder",sections:j}),M}),Ee=K(()=>e.value?{...e.value,...b.value}:null),re=K(()=>{if(!e.value)return[];const _=[];for(const[M,j]of Object.entries(b.value))Lm(e.value[M],j,M,_);return _.filter(M=>!Oi(M.oldVal,M.newVal)).map(M=>{const j=N(M.path);return{...M,label:(j==null?void 0:j.label)||Ca(M.path.split(".").at(-1)),apply_mode:(j==null?void 0:j.apply_mode)||he(M.path.split(".")[0])}})}),be=K(()=>re.value.length>0),se=K(()=>re.value.length),ge=K(()=>new Set(re.value.map(_=>_.path.split(".")[0])).size),Z=K(()=>!!u.value||p.value!=="all"),U=K(()=>{const _={...m.value};for(const M of re.value){const j=N(M.path),pe=xa(j,M.newVal);pe&&(_[M.path]=pe)}return _}),ie=K(()=>Object.keys(U.value).length>0),le=K(()=>e.value?(Z.value?Ce.value:Ce.value.filter(M=>M.key===f.value)).map(M=>({...M,sections:M.sections.filter(j=>Le(j))})).filter(M=>M.sections.length):[]),_e=K(()=>{const _=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],M=new Map(_.map(j=>[j,[]]));for(const j of re.value){const pe=M.has(j.apply_mode)?j.apply_mode:"restart";M.get(pe).push(j)}return _.filter(j=>M.get(j).length).map(j=>({key:j,label:ve(j),entries:M.get(j)}))}),ye=K(()=>re.value.filter(_=>_.apply_mode==="restart").length),Be=K(()=>R.value.filter(_=>_.pending_restart)),w=K(()=>Be.value.length);function N(_){const M=V.value.get(_);return M?{...M,apply_details:Sl([M])}:null}function F(_){const M=`${_}.`;return R.value.filter(j=>j.path===_||j.path.startsWith(M))}function te(_){return F(_).length}function Y(_){return Ca(_)}function ee(_){const M=F(_);if(!M.length)return`${Ca(_)} configuration.`;const j=M.find(gt=>gt.sensitivity==="public"&&gt.description)||M.find(gt=>gt.description),pe=(j==null?void 0:j.description)||"";return pe.match(/setting for (.+)\.$/i)?`${Ca(_)} settings and runtime behaviour.`:pe}function he(_){const M=[...new Set(F(_).map(j=>j.apply_mode))];return M.length===1?M[0]:M.includes("restart")?"restart":M.includes("activation_required")?"activation_required":M[0]||"restart"}function ce(_){const M=[...new Set(F(_).map(j=>ve(j.apply_mode)))];return M.length?M.length===1?M[0]:`Mixed apply behaviour: ${M.join(" · ")}`:""}function oe(_){return Sl(F(_))}function ne(_){var M;return Object.hasOwn(b.value,_)?b.value[_]:(M=e.value)==null?void 0:M[_]}function ae(){const _=ne("mcp")||{},M=Object.keys(_.servers||{}).length;return`${_.enabled?"Globally enabled":"Globally disabled"} · ${M} configured server${M===1?"":"s"}.`}function me(_,M){return M.split(".").reduce((j,pe)=>j==null?void 0:j[pe],_)}function xe(_){const M=Ee.value;return F(_).filter(j=>Bu(j.path)?!1:j.path.split(".").length<=2?!0:!j.path.includes(".*")).map(j=>({...j,key:j.path.split(".").at(-1),value:me(M,j.path),apply_details:Sl([j]),editor:j.path==="agents.final_warning_iterations"?"warning-chips":null}))}function Oe(_){const M=_.path.split(".");return M.length>2?M.slice(0,2).join("."):null}function H(_){const M=new Map;for(const j of xe(_)){const pe=Oe(j),Fe=pe||`${_}.__root`;M.has(Fe)||M.set(Fe,{key:Fe,path:pe,entries:[]}),M.get(Fe).entries.push(j)}return[...M.values()].map(j=>{const pe=j.entries.find(Fe=>Fe.group_description);return{...j,label:j.path?Ca(j.path.split(".").at(-1)):null,description:(pe==null?void 0:pe.group_description)||null,apply_details:Sl(j.entries),runtime_summaries:we(j.entries)}})}function de(_){return{save:_.save_effect||(_.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:_.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[_.apply_mode]||"Effective runtime state is not currently observable."}}function we(_){const M=new Map;for(const j of _){const pe=de(j),Fe=`${j.apply_mode}|${pe.save}|${pe.runtime}`;M.has(Fe)||M.set(Fe,{key:Fe,label:ve(j.apply_mode),save:pe.save,runtime:pe.runtime})}return[...M.values()]}function Re(_){if(Me(_))return _.runtime_effect||_.activation_policy||"";if(_.apply_mode==="activation_required"){const M=_.activation_policy||_.runtime_effect;return M?`Not active after saving. No activation control exists in this release. ${M}`:"Not active after saving; no activation control exists in this release."}return""}function Me(_){return _.action_available===!0&&!!(_.action_label&&_.action_endpoint)}async function dt(_){if(Me(_))try{if(Yt(_.path))throw new Error("Save this setting before applying its action.");const M=String(_.action_method||"POST").toLowerCase(),j={post:G.post.bind(G),put:G.put.bind(G),delete:G.del.bind(G)}[M];if(!j)throw new Error("Unsupported configuration action");await j(_.action_endpoint,_.action_body||void 0),await Q(),Rn("success",`${_.action_label} completed.`)}catch(M){Rn("error",M.message||`${_.action_label} failed`)}}function J(_,M){return[_.label,_.path,_.description,..._.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(M)}function Te(_){const M=u.value.trim().toLowerCase();return M?F(_).filter(j=>J(j,M)):[]}function Le(_){const M=F(_);if(p.value!=="all"&&!M.some(pe=>pe.apply_state===p.value))return!1;const j=u.value.trim().toLowerCase();return!j||`${Y(_)} ${_}`.toLowerCase().includes(j)?!0:M.some(pe=>J(pe,j))}function Pe(_,M){return F(_).filter(j=>j.apply_state===M).length}function Ge(_){return _==="all"?$.value:R.value.filter(M=>M.apply_state===_).length}function He(_){const M=_.sections.flatMap(j=>F(j));return{fields:M.length,modified:re.value.filter(j=>_.sections.includes(j.path.split(".")[0])).length,pending_restart:M.filter(j=>j.apply_state==="pending_restart").length,invalid:M.filter(j=>j.apply_state==="invalid").length,dormant:M.filter(j=>j.apply_state==="dormant").length}}function mt(_){var M;return Object.hasOwn(b.value,_)&&!Oi((M=e.value)==null?void 0:M[_],b.value[_])}function Yt(_){return re.value.some(M=>M.path===_||M.path.startsWith(`${_}.`))}function Ds(_){f.value=_,u.value="",p.value="all";try{localStorage.setItem(Im,_)}catch{}}function An(_){p.value=_}function Ts(){u.value="",p.value="all"}function Ps(_){var M;return((M=Ce.value.find(j=>j.sections.includes(_)))==null?void 0:M.sections)||[]}function Pt(_){const M=Ps(_),j=M.find(pe=>g.value[pe]===!0);return j||M.find(pe=>g.value[pe]!==!1)||null}function Qt(_){return u.value&&!T.value&&Le(_)?!0:T.value?Pt(_)===_:Object.hasOwn(g.value,_)?g.value[_]===!0:!0}function Vs(_){const M=!Qt(_);if(T.value){const j={...g.value};for(const pe of Ps(_))j[pe]===!0&&(j[pe]=!1);j[_]=M,g.value=j;return}g.value={...g.value,[_]:M}}function Cs(){x.value.push(ea(b.value)),x.value.length>ak&&x.value.shift(),S.value=[]}function nn(){be.value&&(Cs(),b.value={},m.value={},v.value=!1)}function Fs(_,M=!1){const j=Date.now();if(M&&B.path===_&&j-B.at<ik){B.at=j;return}Cs(),B={path:_,at:j}}function qs(_,M,j){if(!M.length)return j;const pe=ea(_??{});let Fe=pe;for(let gt=0;gt<M.length-1;gt+=1){const it=M[gt];Fe[it]=ea(Fe[it]??{}),Fe=Fe[it]}return Fe[M.at(-1)]=j,pe}function Vn(_){var M;return Object.hasOwn(b.value,_)?b.value[_]:ea((M=e.value)==null?void 0:M[_])}function ut(_,M,j={}){var oi;const[pe,...Fe]=_.path.split(".");Fs(_.path,!!j.coalesce);const gt=Vn(pe),it=Fe.length?qs(gt,Fe,M):M,Gs={...b.value};if(Oi(it,(oi=e.value)==null?void 0:oi[pe])?delete Gs[pe]:Gs[pe]=it,b.value=Gs,m.value[_.path]){const od={...m.value};delete od[_.path],m.value=od}}function rs(_){B={path:null,at:0},E.value={...E.value,[_]:String(me(Ee.value,_)??"")}}function os(_){if(B={path:null,at:0},!Object.hasOwn(E.value,_))return;const M={...E.value};delete M[_],E.value=M}function Qe(_){const M=E.value[_.path];if(B={path:null,at:0},M===""){m.value={...m.value,[_.path]:"Enter a number."};return}const j=Number(M);if(Number.isNaN(j)||_.type==="integer"&&!Number.isInteger(j)){m.value={...m.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a number."};return}const pe={...E.value};delete pe[_.path],E.value=pe,ut(_,j,{coalesce:!0})}function gs(_){return Object.hasOwn(E.value,_.path)?E.value[_.path]:_.value??""}function q(_,M){if(E.value={...E.value,[_.path]:M},M===""){m.value={...m.value,[_.path]:"Enter a number."};return}const j=Number(M);if(!Number.isFinite(j)||_.type==="integer"&&!Number.isInteger(j)){m.value={...m.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(m.value[_.path]){const pe={...m.value};delete pe[_.path],m.value=pe}ut(_,j,{coalesce:!0})}function ue(_){const M=Number.parseInt(O.value,10);if(!Number.isInteger(M)||M<1){m.value={...m.value,[_.path]:"Warning thresholds must be positive whole numbers."};return}const j=[...new Set([..._.value||[],M])].sort((pe,Fe)=>Fe-pe);O.value="",ut(_,j)}function Ne(_,M){ut(_,(_.value||[]).filter(j=>j!==M))}function Je(_){return _.apply_mode==="live_read"?"Odin reads the saved file value on next use.":_.apply_mode==="live_for_new_work"?"New work uses the saved file value.":_.apply_mode==="live_apply"?_.apply_handler?`Apply the saved value through ${_.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":_.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":_.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":_.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function rt(_){return _.type==="array"&&Array.isArray(_.value)&&!_.structured_container&&!_.structured_container_child&&_.sensitivity==="public"&&_.value.every(M=>["string","number","boolean"].includes(typeof M))}function Nt(_){const M=String(y.value[_.path]??"").trim();if(!M)return;const j=[...new Set([..._.value||[],M])];y.value={...y.value,[_.path]:""},ut(_,j)}function Ft(_,M){ut(_,(_.value||[]).filter(j=>j!==M))}function xa(_,M){var pe;if(!_)return null;if((pe=_.enum)!=null&&pe.length&&!_.enum.includes(M))return`Choose one of: ${_.enum.join(", ")}`;if(_.path==="agents.final_warning_iterations"&&(!Array.isArray(M)||!M.length))return"Add at least one warning threshold.";const j=_.constraints||{};if((_.type==="integer"||_.type==="number")&&typeof M=="number"){if(j.minimum!==void 0&&M<j.minimum)return`Must be at least ${j.minimum}${_.unit?` ${_.unit}`:""}`;if(j.maximum!==void 0&&M>j.maximum)return`Must be at most ${j.maximum}${_.unit?` ${_.unit}`:""}`}return null}function $s(_){return U.value[_.path]||null}function li(_){const M=`${_}.`;return Object.keys(U.value).some(j=>j===_||j.startsWith(M))}function _a(){x.value.length&&(S.value.push(ea(b.value)),b.value=x.value.pop(),m.value={},E.value={},B={path:null,at:0})}function qn(){S.value.length&&(x.value.push(ea(b.value)),b.value=S.value.pop(),m.value={},E.value={},B={path:null,at:0})}function wa(){!be.value||ie.value||(v.value=!0,k.value=!1)}function Gn(){v.value=!1}function z(){nn()}function ve(_){return sk[_]||Ca(_||"unknown")}function Ae(_){return`apply-${String(_||"unknown").replaceAll("_","-")}`}function _t(_){return`cfgc-field-${_.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function Kn(_){return`${_t(_)}-input`}function Wn(_){const M=document.getElementById(_t(_))||document.getElementById(_t(_.split(".").slice(0,2).join(".")));M==null||M.scrollIntoView({behavior:"smooth",block:"center"})}function Rn(_,M){l.value={type:_,message:M},window.setTimeout(()=>{var j;((j=l.value)==null?void 0:j.message)===M&&(l.value=null)},3500)}function cl(){o.value=!1,p.value="pending_restart",u.value="";const _=tk(n.value);_&&(_.scrollTop=0)}function dl(){o.value=!1}function Zn(_=1800){D&&window.clearTimeout(D),D=window.setTimeout(ri,_)}async function ri(){if(c.value){if(P+=1,P>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await co(),w.value===0){c.value=!1,d.value=null,Rn("success","Odin restarted and the saved startup settings are active.");return}}catch{}Zn(2e3)}}async function ke(){if(!c.value){d.value=null;try{await G.post("/api/restart",{}),c.value=!0,P=0,o.value=!1,Zn()}catch(_){d.value=_.message||"Odin could not schedule a restart."}}}async function A(){if(!(!be.value||ie.value||a.value)){a.value=!0;try{const _=ok(e.value,b.value),M=await G.put("/api/config",_);e.value=M,b.value={},x.value=[],S.value=[],m.value={},v.value=!1;try{t.value=await co(),r.value=null,o.value=w.value>0,Rn("success",w.value?`Configuration saved. ${w.value} setting${w.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(j){r.value=j.message||"Unknown metadata error.",Rn("error",`Configuration saved, but apply status could not be refreshed: ${r.value}`)}}catch(_){Rn("error",_.message||"Configuration could not be saved")}finally{a.value=!1}}}async function Q(){var _,M;if(!be.value){s.value=!0,i.value=null;try{const j=await G.get("/api/config"),pe=await co();e.value=j,t.value=pe,r.value=null;const Fe=Ce.value;if(Fe.some(gt=>gt.key===f.value)||(f.value=((_=Fe[0])==null?void 0:_.key)||Va[0].key),T.value){const it=(((M=Fe.find(Gs=>Gs.key===f.value))==null?void 0:M.sections)||[]).find(Gs=>g.value[Gs]===!0);g.value=it?{...g.value,[it]:!0}:{}}}catch(j){i.value=j.message||"Unknown configuration error"}finally{s.value=!1}}}function fe(_){if(v.value||!(_.ctrlKey||_.metaKey))return;const M=_.target;M instanceof HTMLElement&&(M.matches("input, textarea, select")||M.isContentEditable)||(!_.shiftKey&&_.key.toLowerCase()==="z"?(_.preventDefault(),_a()):(_.key.toLowerCase()==="y"||_.shiftKey&&_.key.toLowerCase()==="z")&&(_.preventDefault(),qn()))}function De(_){T.value=_.matches}return as(g,_=>{try{localStorage.setItem(Rm,JSON.stringify(_))}catch{}},{deep:!0}),Ze(()=>{var _;Q(),document.addEventListener("keydown",fe),C=window.matchMedia("(max-width: 760px)"),De(C),(_=C.addEventListener)==null||_.call(C,"change",De)}),xt(()=>{var _;document.removeEventListener("keydown",fe),(_=C==null?void 0:C.removeEventListener)==null||_.call(C,"change",De),D&&window.clearTimeout(D)}),{config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:r,restartPromptOpen:o,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:v,mobileOverflowOpen:k,warningThresholdInput:O,arrayInputs:y,healthFilters:L,visibleCategories:Ce,displayGroups:le,reviewGroups:_e,sectionCount:X,fieldCount:$,hasChanges:be,changeCount:se,changedSectionCount:ge,hasDraftErrors:ie,canUndo:I,canRedo:W,globalFilterActive:Z,reviewRestartCount:ye,pendingRestartCount:w,pendingRestartFields:Be,healthCount:Ge,categoryStats:He,selectCategory:Ds,selectHealthFilter:An,clearFilters:Ts,sectionLabel:Y,sectionDescription:ee,sectionFieldCount:te,sectionHealthCount:Pe,sectionApplySummary:ce,sectionApplyDetails:oe,sectionEntries:xe,fieldGroups:H,sectionSearchHits:Te,mcpConfigSummary:ae,fieldRuntimeCopy:de,fieldSpecificRuntimeNote:Re,hasHonestAction:Me,runFieldAction:dt,sectionChanged:mt,fieldChanged:Yt,isSectionExpanded:Qt,toggleSection:Vs,discardAllDrafts:nn,setFieldValue:ut,setNumberFieldValue:q,numberInputValue:gs,beginInputEdit:rs,endTextInputEdit:os,endInputEdit:Qe,addWarningThreshold:ue,removeWarningThreshold:Ne,isScalarArray:rt,addScalarArrayItem:Nt,removeScalarArrayItem:Ft,fieldError:$s,sectionHasErrors:li,undo:_a,redo:qn,openReview:wa,closeReview:Gn,mobileCancel:z,applyModeLabel:ve,applyClass:Ae,compactValue:lk,formatValue:rk,structuredApplyCopy:Je,fieldId:_t,fieldInputId:Kn,focusField:Wn,fetchConfig:Q,saveConfig:A,restartOdin:ke,restartLater:dl,reviewPendingRestart:cl}}},pk=/^\d{15,25}$/;function Nm(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Mm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=K(()=>new Set((e.excludedIds||[]).map(String))),r=K(()=>{const S=s.value.toLowerCase().trim();return(e.members||[]).filter(v=>l.value.has(String(v.id))?!1:S?u(v).toLowerCase().includes(S)||String(v.username||"").toLowerCase().includes(S)||String(v.id).includes(S):!0)}),o=K(()=>{const S=s.value.trim();return r.value.length===0&&pk.test(S)&&!l.value.has(S)?S:""}),c=K(()=>r.value.length+(o.value?1:0)),d=K(()=>{if(n.value){if(r.value[a.value])return`${e.optionsId}-${a.value}`;if(o.value&&a.value===r.value.length)return`${e.optionsId}-raw`}});function u(S){return Nm(S)}function p(){n.value=!0,a.value=0}function f(){p()}function g(){const S=Math.max(c.value-1,0);a.value=Math.min(a.value+1,S)}function b(){a.value=Math.max(a.value-1,0)}function E(){const S=r.value[a.value];S?O(S):o.value&&a.value===r.value.length&&y(o.value)}function O(S){y(String(S.id))}function y(S){t("select",S),s.value="",n.value=!1,a.value=0}function m(){n.value=!1}function x(){setTimeout(m,150)}return Ze(()=>{e.autofocus&&Ct(()=>{var S;return(S=i.value)==null?void 0:S.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:r,rawId:o,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:g,highlightPrevious:b,selectHighlighted:E,selectMember:O,selectId:y,closeOptions:m,onBlur:x}}};function Hu(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const fk={components:{DiscordUserCombobox:Mm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=K(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=K(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function g(){e.value=!0,t.value="";try{const T=await G.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function b(T){return!T||!T.trim()?[]:T.split(",").map(C=>C.trim()).filter(Boolean)}function E(T,C){const D=c.value.allowed_hosts;if(C&&!D.includes(T)&&D.push(T),!C){const B=D.indexOf(T);B>=0&&D.splice(B,1)}}function O(T,C){const D=d.value.allowed_hosts;if(C&&!D.includes(T)&&D.push(T),!C){const B=D.indexOf(T);B>=0&&D.splice(B,1)}}async function y(){var T;i.value=!0;try{const C=b(c.value.allowed_tools_str),D=c.value.host_mode,B=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:C.length?C:[]};B!==null&&(P.allowed_hosts=B),P.default_host=c.value.default_host||"";const R=await G.post("/api/tokens",P);l.value=R.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Ie.success("Token created"),await g()}catch(C){Ie.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to create token")}finally{i.value=!1}}function m(T){r.value=T;const C=T.allowed_hosts;let D="default";C==null?D="default":Array.isArray(C)&&C.length===0?D="none":Array.isArray(C)&&(D="select"),d.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:D,allowed_hosts:Array.isArray(C)?[...C]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const C=b(d.value.allowed_tools_str),D=d.value.host_mode,B={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:C};D==="none"?B.allowed_hosts=[]:D==="select"?B.allowed_hosts=d.value.allowed_hosts:B.allowed_hosts=null,B.default_host=d.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,Ie.success("Token updated"),await g()}catch(C){Ie.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to update")}finally{o.value=!1}}}async function S(T){var D;if(await Zt({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await G.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=B.token,Ie.success("Token regenerated")}catch(B){Ie.error(((D=B.data)==null?void 0:D.error)||B.message||"Failed to regenerate")}}async function v(T){var D;if(await Zt({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(T.user_id)),Ie.success("Token deleted"),await g()}catch(B){Ie.error(((D=B.data)==null?void 0:D.error)||B.message||"Failed to delete")}}async function k(){if(l.value)try{await navigator.clipboard.writeText(l.value),Ie.success("Copied to clipboard")}catch{Ie.error("Copy failed — select and copy manually")}}return Ze(g),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:g,tierBadge:f,toggleCreateHost:E,toggleEditHost:O,createToken:y,startEdit:m,saveEdit:x,confirmRegenerate:S,confirmDelete:v,copyToken:k}}},vk=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),bk=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),yk=Object.freeze(["enabled","base_url","model","max_tokens"]),xk=Object.freeze(["enabled","model","max_tokens"]);function Ur(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function zu(e){return Ur(e,vk)}function ju(e){return Ur(e,bk)}function _k(e,{includeApiKey:t=!1}={}){const s=Ur(e,yk);return t&&(s.api_key=e.api_key),s}function wk(e){return{timeout:e.timeout}}function kk(e,{includeApiKey:t=!1}={}){const s=Ur(e,xk);return t&&(s.api_key=e.api_key),s}function Sk(e){return{timeout:e.timeout}}function Tl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Tk={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=K(()=>{const z=n.value.model;return z&&!a.includes(z)?[z,...a]:a}),l=K(()=>{const z=n.value.agent_model;return z&&z!=="auto"&&!a.includes(z)?[z,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=K(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=K(()=>{const z=n.value.agent_model;return z==="auto"?!0:!r.includes(z||n.value.model)}),d=K(()=>{const z=n.value.agent_reasoning_effort;return z==="auto"?!1:(z||n.value.reasoning_effort)==="max"}),u=z=>r.includes(z)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),p=z=>r.includes(z)&&d.value,f=h({enabled:!1,model:"gpt-5.6-luna"}),g=h({unavailable_reason:null}),b=K(()=>{const z=f.value.model;return z&&!a.includes(z)?[z,...a]:a});function E(z){const ve=z.target.value;f.value.enabled=ve!=="",ve!==""&&(f.value.model=ve),rs()}const O=h(!1),y=h({codex:!1,ollama:!1,kimi:!1}),m=h(null),x=h(!1),S=h(""),v=h(null),k=h(!1);let T=0;const C=K(()=>{var z;return Object.entries(((z=m.value)==null?void 0:z.models)||{}).map(([ve,Ae])=>{var _t,Kn,Wn;return{model:ve,floor:Ae.floor,override:Ae.override,effectiveBudget:(_t=Ae.effective)==null?void 0:_t.effective_budget,configuredPrimaryChars:(Kn=Ae.configured)==null?void 0:Kn.primary_chars,primaryChars:(Wn=Ae.effective)==null?void 0:Wn.primary_chars,provenance:Ae.provenance,clampExpiresAt:Ae.clamp_expires_at}})}),D=K(()=>{var z;return((z=m.value)==null?void 0:z.clamps)||[]}),B=K(()=>{var z,ve;return((ve=(z=m.value)==null?void 0:z.models)==null?void 0:ve[n.value.model])||null}),P=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),R=h({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),V=h(!1),X=h(!1),$=h(!1),L=h(!1),I=h(!1),W=h(!1),Ce=h(!1),Ee=h({configured:!1}),re=h([]),be=h(""),se=h(!1),ge=h(!1),Z=h({configured:!1}),U=h([]),ie=h(""),le=h(!1),_e=h(!1),ye=h(!0),Be=h(""),w=h({configured:!1,accounts:[]}),N=h(null),F=h(null),te=h(""),Y=h(null),ee=h(!1),he=h(null),ce=h(null),oe=h("");let ne=null;function ae(z,ve="success"){Ie(z,ve==="error"?"error":"success")}function me(z){if(!z)return"?";const ve=z/(1024*1024*1024);return ve>=1?ve.toFixed(1)+" GB":(z/(1024*1024)).toFixed(0)+" MB"}function xe(z){return Number.isFinite(Number(z))?Number(z).toLocaleString():"—"}function Oe(z){return z==null?"automatic (model-derived)":Number(z).toLocaleString()+" characters"}function H(z){const ve=new Date(z);return Number.isNaN(ve.getTime())?"unknown":ve.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function de(z){return typeof z=="string"&&z.length>12?z.slice(0,8)+"…"+z.slice(-4):z}function we(z){return z==="temporary learned clamp"?"is-clamp":z==="override"?"is-override":"is-built-in"}function Re(z){const ve=n.value.context_budget_overrides[z.model];return z.floor!=null&&Number.isFinite(Number(ve))&&Number(ve)>z.floor}function Me(z,ve){const Ae={...n.value.context_budget_overrides};ve.target.value===""?delete Ae[z]:Ae[z]=Number(ve.target.value),n.value.context_budget_overrides=Ae,k.value=!0}function dt(z){n.value.context_utilization=z.target.value===""?"":Number(z.target.value),k.value=!0}function J(z){const ve={...n.value.context_budget_overrides};delete ve[z],n.value.context_budget_overrides=ve,k.value=!0}async function Te(){e.value=!0,await Promise.all([Le(),Ge(),Ts(),He(),Pe()]),e.value=!1}async function Le({preserveBasic:z=!1,preserveAdvanced:ve=!1}={}){try{const Ae=await G.get("/api/llm/status");t.value=Ae,s.value=Ae.active_provider||"codex",Ae.codex&&!ut.pending()&&(z||(n.value.enabled=Ae.codex.enabled,n.value.model=Ae.codex.model||"gpt-5.6-sol",n.value.reasoning_effort=Ae.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=Ae.codex.agent_reasoning_effort||"",n.value.agent_model=Ae.codex.agent_model||""),ve||(n.value.request_timeout_seconds=Ae.codex.request_timeout_seconds??n.value.request_timeout_seconds,n.value.stream_stall_timeout_seconds=Ae.codex.stream_stall_timeout_seconds??n.value.stream_stall_timeout_seconds,n.value.retry={...n.value.retry,...Ae.codex.retry||{}},n.value.connection_pool={...n.value.connection_pool,...Ae.codex.connection_pool||{}},n.value.context_compression={...n.value.context_compression,...Ae.codex.context_compression||{}},!k.value&&!$.value&&(n.value.context_budget_overrides={...Ae.codex.context_budget_overrides||{}},n.value.context_utilization=Ae.codex.context_utilization??n.value.context_utilization))),Ae.ollama&&!os.pending()&&(z||(P.value.enabled=Ae.ollama.enabled,P.value.base_url=Ae.ollama.base_url||"",P.value.model=Ae.ollama.model||"",P.value.max_tokens=Ae.ollama.max_tokens||4096),ve||(P.value.timeout=Ae.ollama.timeout??P.value.timeout)),Ae.kimi&&!Qe.pending()&&(z||(R.value.enabled=Ae.kimi.enabled,R.value.model=Ae.kimi.model||"",R.value.max_tokens=Ae.kimi.max_tokens||4096),ve||(R.value.timeout=Ae.kimi.timeout??R.value.timeout)),Ae.auxiliary&&(g.value=Ae.auxiliary,rs.pending()||(f.value.enabled=Ae.auxiliary.enabled,f.value.model=Ae.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Pe(){const z=++T;x.value=!0,S.value="";try{const ve=await G.get("/api/context/windows");if(z!==T)return;m.value=ve,!$.value&&!k.value&&(n.value.context_budget_overrides=Object.fromEntries(Object.entries(ve.models||{}).filter(([,Ae])=>Ae.override!=null).map(([Ae,_t])=>[Ae,_t.override])),n.value.context_utilization=ve.utilization??n.value.context_utilization)}catch(ve){z===T&&(S.value=ve.message||"Failed to load context budgets")}finally{z===T&&(x.value=!1)}}async function Ge(){try{if(Ee.value=await G.get("/api/ollama/status"),Ee.value.model&&(be.value=Ee.value.model),Ee.value.configured)try{const z=await G.get("/api/ollama/models");re.value=z.models||[]}catch{re.value=[]}else if(P.value.base_url)try{const z=await G.post("/api/ollama/probe-models",{base_url:P.value.base_url});re.value=z.models||[]}catch{re.value=[]}}catch{Ee.value={configured:!1}}}async function He(){ye.value=!0,Be.value="";try{w.value=await G.get("/api/codex/status")}catch(z){Be.value=z.message||"Failed to fetch Codex status"}finally{ye.value=!1}}async function mt(){const z=t.value?t.value.active_provider:"codex";Ce.value=!0;try{const ve=await G.post("/api/llm/switch",{provider:s.value});ve.error?(s.value=z,ae(ve.error,"error")):(ae("Switched to "+s.value+" ("+ve.model+")"),await Te())}catch(ve){s.value=z,ae(ve.message||"Switch failed","error")}finally{Ce.value=!1}}async function Yt(){se.value=!0;try{const z=await G.post("/api/ollama/reload");ae(z.configured?"Ollama reloaded":z.reason||"Ollama not configured",z.configured?"success":"error"),await Te()}catch(z){ae(z.message||"Reload failed","error")}finally{se.value=!1}}async function Ds(){ge.value=!0;try{await G.post("/api/ollama/model",{model:be.value}),ae("Model set to "+be.value),await Te()}catch(z){ae(z.message||"Failed","error")}finally{ge.value=!1}}async function An(){const z=P.value.base_url;if(!z){ae("Enter a base URL first","error");return}W.value=!0;try{const ve=await G.post("/api/ollama/probe-models",{base_url:z});re.value=ve.models||[],re.value.length?(ae(re.value.length+" model(s) found"),!P.value.model&&re.value.length&&(P.value.model=re.value[0].name)):ae("No models found at "+z,"error")}catch(ve){ae(ve.message||"Could not reach Ollama","error")}finally{W.value=!1}}async function Ts(){try{if(Z.value=await G.get("/api/kimi/status"),Z.value.model&&(ie.value=Z.value.model),Z.value.configured)try{const z=await G.get("/api/kimi/models");U.value=z.models||[]}catch{U.value=[]}}catch{Z.value={configured:!1}}}async function Ps(){le.value=!0;try{const z=await G.post("/api/kimi/reload");ae(z.configured?"Kimi reloaded":z.reason||"Kimi not configured",z.configured?"success":"error"),await Te()}catch(z){ae(z.message||"Reload failed","error")}finally{le.value=!1}}async function Pt(){_e.value=!0;try{await G.post("/api/kimi/model",{model:ie.value}),ae("Model set to "+ie.value),await Te()}catch(z){ae(z.message||"Failed","error")}finally{_e.value=!1}}async function Qt(){if($.value){ut();return}$.value=!0;const z=zu(n.value);try{await G.put("/api/llm/codex/config",z),ae("Codex config saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),He()])}catch(ve){ae(ve.message||"Failed","error");const Ae=JSON.stringify(zu(n.value))!==JSON.stringify(z);await Promise.all([Le({preserveBasic:Ae,preserveAdvanced:!0}),He()])}finally{$.value=!1}}async function Vs(){if($.value)return;$.value=!0;const z=ju(n.value);try{await G.put("/api/llm/codex/config",z),JSON.stringify({context_budget_overrides:n.value.context_budget_overrides,context_utilization:n.value.context_utilization})===JSON.stringify({context_budget_overrides:z.context_budget_overrides,context_utilization:z.context_utilization})&&(k.value=!1),ae("Codex advanced settings saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),He(),Pe()])}catch(ve){ae(ve.message||"Failed","error");const Ae=JSON.stringify(ju(n.value))!==JSON.stringify(z);await Promise.all([Le({preserveBasic:!0,preserveAdvanced:Ae}),He(),Pe()])}finally{$.value=!1}}async function Cs(){if(L.value){os();return}L.value=!0;try{const z=V.value?P.value.api_key:null,ve=_k(P.value,{includeApiKey:z!==null});await G.put("/api/llm/ollama/config",ve),ae("Ollama config saved"),z!==null&&P.value.api_key===z&&(P.value.api_key="",V.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ge()])}catch(z){ae(z.message||"Failed","error")}finally{L.value=!1}}async function nn(){if(!L.value){L.value=!0;try{await G.put("/api/llm/ollama/config",wk(P.value)),ae("Ollama timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ge()])}catch(z){ae(z.message||"Failed","error")}finally{L.value=!1}}}async function Fs(){if(I.value){Qe();return}I.value=!0;try{const z=X.value?R.value.api_key:null,ve=kk(R.value,{includeApiKey:z!==null});await G.put("/api/llm/kimi/config",ve),ae("Kimi config saved"),z!==null&&R.value.api_key===z&&(R.value.api_key="",X.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ts()])}catch(z){ae(z.message||"Failed","error")}finally{I.value=!1}}async function qs(){if(!I.value){I.value=!0;try{await G.put("/api/llm/kimi/config",Sk(R.value)),ae("Kimi timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ts()])}catch(z){ae(z.message||"Failed","error")}finally{I.value=!1}}}async function Vn(){if(O.value){rs();return}O.value=!0;try{await G.put("/api/llm/auxiliary/config",f.value),ae("Auxiliary config saved"),await Le()}catch(z){ae(z.message||"Failed","error"),await Le()}finally{O.value=!1}}const ut=Tl(Qt),rs=Tl(Vn),os=Tl(Cs),Qe=Tl(Fs),gs=()=>(ut.cancel(),Qt()),q=()=>(os.cancel(),Cs()),ue=()=>(Qe.cancel(),Fs()),Ne=()=>Vs(),Je=()=>nn(),rt=()=>qs();async function Nt(z){const ve=z.account_key+":"+z.model;v.value=ve;try{const Ae=await G.post("/api/context/windows/clear",{account_key:z.account_key,model:z.model});ae(Ae.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Pe()}catch(Ae){ae(Ae.message||"Failed to clear clamp","error"),await Pe()}finally{v.value=null}}async function Ft(z){try{await G.post("/api/codex/account/"+z+"/activate"),ae("Active account switched"),await He()}catch(ve){ae(ve.message||"Failed","error")}}async function xa(z){N.value=z;try{await G.post("/api/codex/account/"+z+"/refresh"),ae("Token refreshed"),await He()}catch(ve){ae(ve.message||"Refresh failed","error")}finally{N.value=null}}function $s(z,ve){F.value=z,te.value=ve||""}async function li(z){try{await G.put("/api/codex/account/"+z+"/label",{label:te.value}),ae("Label updated"),F.value=null,await He()}catch(ve){ae(ve.message||"Failed","error")}}async function _a(z,ve){if(await Zt({title:"Delete Codex account",message:`Delete ${ve||"account #"+(z+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/codex/account/"+z),ae("Deleted. Pool reloaded."),await He()}catch(_t){ae(_t.message||"Failed","error")}}async function qn(){ee.value=!0;try{const z=await G.post("/api/codex/device-code");he.value=z,Y.value="pending",wa(z)}catch(z){ae(z.message||"Failed","error")}finally{ee.value=!1}}async function wa(z){ne={cancelled:!1};const ve=ne;try{const Ae=await G.post("/api/codex/device-poll",{device_auth_id:z.device_auth_id,user_code:z.user_code,interval:z.interval});if(ve.cancelled)return;ce.value=Ae,Y.value="success",await Te()}catch(Ae){if(ve.cancelled)return;oe.value=Ae.message||"Device login failed",Y.value="error"}}function Gn(){ne&&(ne.cancelled=!0),Y.value=null,he.value=null}return Ze(Te),xt(()=>{ne&&(ne.cancelled=!0),ut.cancel(),rs.cancel(),os.cancel(),Qe.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:Ce,advancedOpen:y,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:p,auxForm:f,auxData:g,auxModelOptions:b,onAuxModelChange:E,savingAux:O,saveAuxConfigDebounced:rs,ollamaForm:P,kimiForm:R,savingCodex:$,savingOllama:L,savingKimi:I,probingOllama:W,ollamaKeyDirty:V,kimiKeyDirty:X,ollamaStatus:Ee,ollamaModels:re,ollamaSelectedModel:be,reloading:se,settingModel:ge,kimiStatus:Z,kimiModels:U,kimiSelectedModel:ie,reloadingKimi:le,settingKimiModel:_e,codexLoading:ye,codexError:Be,codexData:w,refreshing:N,editingLabel:F,labelValue:te,contextWindows:m,contextWindowsLoading:x,contextWindowsError:S,contextBudgetRows:C,activeClampRows:D,activeContextBudget:B,clearingClamp:v,contextPolicyDirty:k,deviceState:Y,deviceLoading:ee,deviceInfo:he,deviceResult:ce,deviceError:oe,fetchAll:Te,switchProvider:mt,reloadOllama:Yt,setOllamaModel:Ds,reloadKimi:Ps,setKimiModel:Pt,probeOllamaModels:An,saveCodexConfig:Qt,saveOllamaConfig:Cs,saveKimiConfig:Fs,saveCodexAdvancedConfig:Vs,saveOllamaAdvancedConfig:nn,saveKimiAdvancedConfig:qs,saveCodexConfigDebounced:ut,saveOllamaConfigDebounced:os,saveKimiConfigDebounced:Qe,saveCodexConfigNow:gs,saveOllamaConfigNow:q,saveKimiConfigNow:ue,saveCodexAdvancedConfigNow:Ne,saveOllamaAdvancedConfigNow:Je,saveKimiAdvancedConfigNow:rt,activateAccount:Ft,refreshAccount:xa,startEditLabel:$s,saveLabel:li,deleteAccount:_a,startDeviceLogin:qn,cancelDeviceLogin:Gn,formatSize:me,fetchContextWindows:Pe,clearContextClamp:Nt,setContextOverride:Me,setContextUtilization:dt,resetContextOverride:J,overrideAboveFloor:Re,formatCount:xe,formatContextCeiling:Oe,formatExpiry:H,shortAccountKey:de,provenanceClass:we}}},Vu={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Ck(e){return Vu[e]||Vu[(e||"").toLowerCase()]||"text-gray-400"}const Ek={template:`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Js(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},fa=new WS;function st(e,t){return fa.parse(e,t)}st.options=st.setOptions=function(e){return fa.setOptions(e),st.defaults=fa.defaults,Um(st.defaults),st};st.getDefaults=Xc;st.defaults=ya;st.use=function(...e){return fa.use(...e),st.defaults=fa.defaults,Um(st.defaults),st};st.walkTokens=function(e,t){return fa.walkTokens(e,t)};st.parseInline=fa.parseInline;st.Parser=vn;st.parser=vn.parse;st.Renderer=ur;st.TextRenderer=rd;st.Lexer=gn;st.lexer=gn.lex;st.Tokenizer=dr;st.Hooks=Dl;st.parse=st;st.options;st.setOptions;st.use;st.walkTokens;st.parseInline;vn.parse;gn.lex;const ZS={breaks:!0,gfm:!0};function pp(e){if(!e)return"";try{if(typeof st<"u"&&st.parse){const t=st.parse(e,ZS);return typeof lp<"u"?lp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function JS(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const YS={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function QS(e){return YS[e]||"wrench"}const XS=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function fp(e){if(!e)return[];const t=e.match(XS);return t?[...new Set(t)]:[]}const e1={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],d=K(()=>t.value.trim().length>0&&!s.value),u=h(Ve.state||"disconnected");let p=null,f=null;const g=K(()=>{const $=u.value;return $==="connected"?"Connected":$==="reconnecting"?"Reconnecting…":$==="connecting"?"Connecting…":"REST fallback"}),b=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],E=K(()=>{const $=Math.floor(i.value/4)%b.length,L=i.value;return L>3?`${b[$]} (${L}s)`:b[0]});function O(){Ct(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!a.value)return;const $=a.value;$.style.height="auto",$.style.height=Math.min($.scrollHeight,120)+"px"}function m($,L,I={}){const W={id:++o,role:$,content:L,timestamp:Date.now(),html:$==="bot"?pp(L):"",tools_used:I.tools_used||[],is_error:I.is_error||!1,images:$==="bot"?fp(L):[],files:I.files||[],_showTools:!1};return e.value.push(W),O(),$==="bot"&&Ct(()=>x()),W}function x(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(L=>{L.setAttribute("data-copy","true"),L.style.position="relative";const I=document.createElement("button");I.className="chat-code-copy",I.textContent="Copy",I.addEventListener("click",()=>{const W=L.querySelector("code"),Ce=W?W.textContent:L.textContent;navigator.clipboard.writeText(Ce).then(()=>{I.textContent="Copied!",setTimeout(()=>{I.textContent="Copy"},1500)}).catch(()=>{})}),L.appendChild(I)})}function S($){if($===0)return!0;const L=e.value[$-1],I=e.value[$],W=new Date(L.timestamp).toDateString(),Ce=new Date(I.timestamp).toDateString();return W!==Ce}function v($){const L=new Date($),I=new Date;if(L.toDateString()===I.toDateString())return"Today";const W=new Date(I);return W.setDate(W.getDate()-1),L.toDateString()===W.toDateString()?"Yesterday":L.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function k($){t.value=$,Ct(()=>V())}function T($){window.open($,"_blank","noopener")}function C($){$.target.style.display="none"}function D(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function B(){r&&(clearInterval(r),r=null),i.value=0}function P($){s.value&&(s.value=!1,B(),$.type==="chat_response"?m("bot",$.content,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]}):$.type==="chat_error"&&m("bot",$.error||"Unknown error",{is_error:!0}),Ct(()=>{var L;return(L=a.value)==null?void 0:L.focus()}))}async function R($){try{const L=await G.post("/api/chat",{content:$,channel_id:l.value});m("bot",L.response,{tools_used:L.tools_used||[],is_error:L.is_error||!1,files:L.files||[]})}catch(L){m("bot",L.message||"Failed to send message",{is_error:!0})}}async function V(){const $=t.value.trim();if(!$||s.value)return;m("user",$),t.value="",s.value=!0,D(),a.value&&(a.value.style.height="auto"),Ve.connected&&Ve.sendChat($,{channelId:l.value})||(await R($),s.value=!1,B()),Ct(()=>{var I;return(I=a.value)==null?void 0:I.focus()})}async function X(){try{if(!l.value){const L=await G.get("/api/auth/session");l.value=L.channel_id||L.user_id||"web-user"}const $=await G.get("/api/sessions/"+encodeURIComponent(l.value));if($&&$.messages&&$.messages.length>0){for(const L of $.messages){const I=L.role==="user"?"user":"bot";let W=L.content||"";if(I==="user"){const Ee=W.match(/^\[.*?\]:\s*/);Ee&&(W=W.slice(Ee[0].length))}if(!W.trim())continue;const Ce={id:++o,role:I,content:W,timestamp:L.timestamp?L.timestamp*1e3:Date.now(),html:I==="bot"?pp(W):"",tools_used:[],is_error:!1,images:I==="bot"?fp(W):[],files:[],_showTools:!1};e.value.push(Ce)}Ct(()=>{O(),x()})}}catch{}}return Ze(()=>{Ve.subscribe("chat",P),u.value=Ve.state||"disconnected",p=Ve.onStateChange,f=($,L)=>{u.value=$,p&&p($,L)},Ve.onStateChange=f,X(),Ct(()=>{var $;return($=a.value)==null?void 0:$.focus()})}),xt(()=>{Ve.unsubscribe("chat",P),Ve.onStateChange===f&&(Ve.onStateChange=p),B()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:d,wsStatus:g,typingText:E,suggestions:c,send:V,autoResize:y,formatTime:JS,formatDate:v,showDateSeparator:S,useSuggestion:k,openImage:T,onImageError:C,getToolIcon:QS}}},t1={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),g=K(()=>e.value==="custom"),b=K(()=>[...i.value,...l.value]),E=K(()=>l.value.includes(e.value)),O=K(()=>{var T;return g.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),y=K(()=>{var T;return g.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),m=K(()=>{var T;return g.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function x(){d.value=!0;try{const T=await G.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{d.value=!1}}async function S(){r.value=!0,c.value=null,o.value=!1;try{await G.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(T){c.value=T.message}finally{r.value=!1}}async function v(){const T=u.value.trim();if(T){f.value=!0,c.value=null;try{await G.post("/api/personality/presets",{name:T,display_name:O.value,identity:y.value,voice:m.value}),p.value=!1,u.value="",await x(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(C){c.value=C.message}finally{f.value=!1}}}async function k(){if(await Zt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await G.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(C){c.value=C.message}}}return Ze(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:b,isCustom:g,isUserPreset:E,previewName:O,previewIdentity:y,previewVoice:m,saving:r,saved:o,error:c,loading:d,save:S,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:v,deletePreset:k,builtinPresets:i,userPresets:l}},template:`
  ...
  `},wt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Jm=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:Pk,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:e1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:gw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:kw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Vw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:t1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Rk,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:wt("/operations","live")},{path:"/agents",redirect:wt("/operations","agents")},{path:"/loops",redirect:wt("/operations","loops")},{path:"/processes",redirect:wt("/operations","processes")},{path:"/schedules",redirect:wt("/operations","schedules")},{path:"/audit",redirect:wt("/history","audit")},{path:"/sessions",redirect:wt("/history","sessions")},{path:"/traces",redirect:wt("/history","traces")},{path:"/usage",redirect:wt("/history","usage")},{path:"/tools",redirect:wt("/capabilities","tools")},{path:"/skills",redirect:wt("/capabilities","skills")},{path:"/mcp",redirect:wt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:wt("/capabilities","knowledge")},{path:"/memory",redirect:wt("/capabilities","memory")},{path:"/learned",redirect:wt("/capabilities","learned")},{path:"/health",redirect:wt("/system","health")},{path:"/resources",redirect:wt("/system","resources")},{path:"/logs",redirect:wt("/system","logs")},{path:"/config",redirect:wt("/system","config")},{path:"/host-access",redirect:wt("/system","host-access")},{path:"/internals",redirect:wt("/system","internals")}],Ni=tw({history:N_(),routes:Jm});Ni.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const s1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),d=h("disconnected"),u=h(-1),p=h(null);let f=null;const g=h("starting"),b=h(""),E=Jm.filter(L=>L.meta),O=K(()=>["Workspace","Operate","Observe","Manage"].map(L=>({name:L,routes:E.filter(I=>I.meta.section===L)})).filter(L=>L.routes.length)),y=K(()=>{var L;return((L=Ni.currentRoute.value.meta)==null?void 0:L.label)||"Odin"}),m=K(()=>{var L;return((L=Ni.currentRoute.value.meta)==null?void 0:L.section)||"Management"}),x=K(()=>{var L;return((L=Ni.currentRoute.value.meta)==null?void 0:L.description)||"Management console"});G.onSessionExpired=()=>{t.value=!0,Ve.disconnect(),G.setToken(""),e.value="login"};function S(L){var I;if((L.ctrlKey||L.metaKey)&&L.key.toLowerCase()==="k"){e.value==="ready"&&(L.preventDefault(),qu());return}if(n.value&&L.key==="Tab"){const W=[...((I=a.value)==null?void 0:I.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(W.length){const Ce=W[0],Ee=W[W.length-1];if(L.shiftKey&&(document.activeElement===Ce||!a.value.contains(document.activeElement))){L.preventDefault(),Ee.focus();return}if(!L.shiftKey&&(document.activeElement===Ee||!a.value.contains(document.activeElement))){L.preventDefault(),Ce.focus();return}}}if(L.key==="Escape"&&n.value){n.value=!1,L.preventDefault();return}if(L.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(L.target.tagName)){L.preventDefault();const W=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');W&&W.focus()}}function v(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Ze(async()=>{document.addEventListener("keydown",S),r=window.matchMedia("(max-width: 900px)"),v(),r.addEventListener("change",v);const L=await G.check();L.ok?(e.value="ready",X()):L.needsAuth?e.value="login":(e.value="ready",X())});function k(){t.value=!1,e.value="ready",X()}async function T(){await G.logout(),Ve.disconnect(),e.value="login"}function C(){s.value=!s.value}function D(){n.value=!n.value}as(n,async L=>{var I,W;if(L)o=document.activeElement,await Ct(),(W=(I=a.value)==null?void 0:I.querySelector(".nav-item"))==null||W.focus();else if(o!=null&&o.isConnected){const Ce=o;o=null,requestAnimationFrame(()=>Ce.focus())}});const B=K(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(L,I="info",W=3e3){p.value={text:L,level:I},clearTimeout(f),f=setTimeout(()=>{p.value=null},W)}let R=null,V=!1;function X(){Ve.onStatusChange=L=>{c.value=L},Ve.onLatency=L=>{u.value=L},Ve.onStateChange=(L,I)=>{d.value=L,L==="connected"?(V&&P("Connection restored","success"),V=!0):L==="reconnecting"&&I.attempt===1&&P("Connection lost — reconnecting…","warn")},Ve.connect(),$(),R&&clearInterval(R),R=setInterval($,15e3)}async function $(){try{const L=await G.get("/api/status");g.value=L.status==="online"?"online":"starting";const I=L.uptime_seconds||0,W=Math.floor(I/3600),Ce=Math.floor(I%3600/60);b.value=`${W}h ${Ce}m uptime`}catch{g.value="offline",b.value=""}}return xt(()=>{R&&clearInterval(R),Ve.disconnect(),document.removeEventListener("keydown",S),r==null||r.removeEventListener("change",v)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:B,wsToast:p,botStatus:g,botUptime:b,navRoutes:E,navGroups:O,currentPage:y,currentSection:m,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:k,logout:T,toggleSidebar:C,toggleMobileNavigation:D,openPalette:qu}}},jn=Xl(n1);jn.component("odin-icon",Nk);jn.component("login-screen",s1);jn.component("toast-container",K0);jn.component("confirm-host",W0);jn.component("command-palette",Lk);jn.directive("modal-focus",Dk);jn.use(Ni);jn.mount("#app");
