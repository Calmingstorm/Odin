...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(a.value="Copied")}catch{e.value===u&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,a.value=""}),Mt(n,()=>{t.value=!1,a.value=""}),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},Pw={components:{ToolOutput:Yo},setup(){const e=f([]),t=f([]),s=f({}),n=50;function a(p){var v,w,R,x,g,b,T,S,A,C,y;const h=p.payload||p,m=h.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(m)&&!(h.agent_id||(v=h.metadata)!=null&&v.agent_id))&&!(["loop_tool_start","loop_tool"].includes(m)&&!(h.call_id||(w=h.metadata)!=null&&w.call_id))){if(m==="tool_start"||m==="loop_tool_start"){const I=h.call_id||((R=h.metadata)==null?void 0:R.call_id)||null,F=h.agent_id||((x=h.metadata)==null?void 0:x.agent_id)||"",k={callId:I,agentId:F,agentLabel:h.agent_label||((g=h.metadata)==null?void 0:g.agent_label)||"",toolInput:h.tool_input,id:I?`${F}:${I}`:`${h.action}-${Date.now()}`,tool:h.action,actor:h.actor||"",channel:h.channel_id||"",iteration:h.iteration??((b=h.metadata)==null?void 0:b.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(k);return}if(m==="tool_end"||m==="loop_tool"){const I=h.call_id||((T=h.metadata)==null?void 0:T.call_id)||null,F=h.agent_id||((S=h.metadata)==null?void 0:S.agent_id)||"";let k=-1;if(I&&(k=e.value.findIndex(M=>M.callId===I&&M.agentId===F&&M.status==="running")),k<0&&!I)for(let M=e.value.length-1;M>=0;M--){const j=e.value[M];if(j.tool===h.action&&j.agentId===F&&j.status==="running"){k=M;break}}if(k>=0){const M=e.value[k];M.status=h.error||(A=h.metadata)!=null&&A.error||["error","failed","cancelled","denied","outcome_unknown"].includes(h.status||((C=h.metadata)==null?void 0:C.status))?"error":"success",M.elapsed=h.duration_ms??((y=h.metadata)==null?void 0:y.elapsed_ms)??Date.now()-M.startTime,M.result=h.detail||"",M.fadingOut=!0,setTimeout(()=>{const j=e.value.indexOf(M);j>=0&&e.value.splice(j,1),t.value.unshift(M),t.value.length>n&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const I=h.call_id||h.tool_name||"unknown";if(h.finished){const F={...s.value};delete F[I],s.value=F}else{const k=((s.value[I]||"")+(h.chunk||"")).split(`
`);s.value={...s.value,[I]:k.slice(-30).join(`
...
... (truncated)`:s}function np(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function bd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Wm=Symbol("agent-detail-cancelled"),Bw=15e3;function Uw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((h,m)=>{r=h,c=m});function u(h,m){o||(o=!0,l!==null&&a(l),l=null,(h?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(h){u(!1,h)}return o||Promise.resolve(p).then(h=>u(!0,h),h=>u(!1,h)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const h=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${h}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Wm),i==null||i.abort()}}}function Zm({state:e,requestDetail:t,timeoutMs:s=Bw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:h,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,h?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const w=Uw(R=>t(p,{signal:R}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=w.cancel,v.promise=(async()=>{let R=null,x=null;try{R=await w.promise}catch(g){x=g}R!==Wm&&(l!==v||e.detailId!==p||(l=null,!x&&(R===null||typeof R!="object")&&(x=new Error(`${n} response was empty or invalid`)),x?e.detail===null&&(e.detailError=(x==null?void 0:x.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=R,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function Hw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const zw={components:{ToolOutput:Yo},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(null),a=f(!0),i=f("all");let l=!1;const o=W(()=>e.value.filter(L=>L.status==="running").length),r=W(()=>e.value.filter(L=>L.status==="completed").length),c=W(()=>e.value.filter(L=>["failed","timeout","killed"].includes(L.status)).length),d=W(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=W(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(L=>["failed","timeout","killed"].includes(L.status)):e.value.filter(L=>L.status===i.value));function p(L){const B=Number(L.max_iterations)||0;return B<=0?0:Math.min(100,Math.round(L.iteration_count/B*100))}function h(L){return(Number(L.max_iterations)||0)>0}function m(L,B){return L?L==="N/A"?"N/A":B==="current_inheritance"?`inherit (currently ${L})`:L:"unknown"}function v(L){return m(L.display_model,L.display_model_source||L.display_source)}function w(L){return m(L.display_reasoning_effort,L.display_reasoning_effort_source||L.display_source)}function R(L){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[L]||""}const x=f(null),g=f(null),b=f(!1),T=f(null),S=f(""),C=Zm({state:{get detail(){return x.value},set detail(L){x.value=L},get detailId(){return g.value},set detailId(L){g.value=L},get detailLoading(){return b.value},set detailLoading(L){b.value=L},get detailError(){return T.value},set detailError(L){T.value=L}},requestDetail:(L,{signal:B})=>z.get(`/api/agents/${encodeURIComponent(L)}`,{signal:B})});async function y(L){S.value="",await C.open(L.id)}function I(){C.close(),S.value=""}async function F(){await C.refresh()}async function k(L,B){try{await navigator.clipboard.writeText(B||""),S.value=L,setTimeout(()=>{S.value===L&&(S.value="")},1500)}catch{ye.error("Copy failed")}}async function M(L=!1){L=L===!0,L||(t.value=!0);try{const B=await z.get("/api/agents");e.value=Array.isArray(B)?B:[],s.value=null}catch(B){L||(s.value=B.message)}L||(t.value=!1)}async function j(L){const B=e.value.find(Z=>Z.id===L);if(await qt({title:"Kill agent",message:`Kill agent "${(B==null?void 0:B.label)||L}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=L;try{await z.del(`/api/agents/${encodeURIComponent(L)}`),ye.success("Agent killed"),await M()}catch(Z){ye.error(Z.message||"Failed to kill agent")}n.value=null}}const K=Hw({isEnabled:()=>a.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!g.value,refreshDetail:F});function D(){K.start()}function O(){K.stop()}return Mt(a,()=>K.sync()),je(()=>{l=!0,M(),D()}),os(()=>{l=!0,M(!0),D()}),Yt(()=>{l=!1,O()}),ht(()=>{l=!1,O(),C.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:Aa,formatDuration:ui,progressPercent:p,hasProgress:h,displayModelText:v,displayEffortText:w,displaySourceLabel:R,detail:x,detailId:g,detailLoading:b,detailError:T,copied:S,openDetail:y,closeDetail:I,copyText:k,fetchAgents:M,killAgent:j,startAutoRefresh:D,stopAutoRefresh:O}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),h=f("");let m=!1;const w=Zm({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return p.value},set detailError(O){p.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:L})=>z.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:L})});async function R(O){h.value="",await w.open(O.id)}function x(){w.close(),h.value=""}async function g(O,L){try{await navigator.clipboard.writeText(L||""),h.value=O,setTimeout(()=>{h.value===O&&(h.value="")},1500)}catch{ye.error("Copy failed")}}const b=W(()=>e.value.reduce((O,L)=>O+(L.iteration_count||0),0)),T=W(()=>e.value.filter(O=>O.status==="running").length);function S(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function A(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function C(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function y(O=!1){O=O===!0,O||(t.value=!0);try{const L=await z.get("/api/loops");e.value=Array.isArray(L)?L:[],s.value=null}catch(L){O||(s.value=L.message)}O||(t.value=!1)}async function I(){l.value=null;const O=a.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const L={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&(L.stop_condition=O.stop_condition.trim()),i.value=!0;try{const B=await z.post("/api/loops",L);ye.success(`Loop started: ${B.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await y()}catch(B){l.value=B.message}i.value=!1}async function F(O){if(await qt({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=O;try{await z.del(`/api/loops/${encodeURIComponent(O)}`),ye.success("Loop stopped"),await y()}catch(B){ye.error(B.message||"Failed to stop loop")}o.value=null}}async function k(O){r.value=O;try{await z.post(`/api/loops/${encodeURIComponent(O)}/restart`),ye.success("Loop restarted"),await y()}catch(L){ye.error(L.message||"Failed to restart loop")}r.value=null}function M(O){m&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(y(!0),d.value&&w.refresh())}let j=null;function K(){j!==null&&clearInterval(j),j=null}function D(){K(),m&&(j=setInterval(()=>{y(!0),d.value&&w.refresh()},5e3))}return je(()=>{m=!0,y(),Ye.subscribe("events",M),D()}),os(()=>{m=!0,y(!0),D()}),Yt(()=>{m=!1,K()}),ht(()=>{m=!1,Ye.unsubscribe("events",M),K(),w.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:h,totalIterations:b,runningCount:T,statusDotClass:S,statusBadge:A,modeBadge:C,formatAge:qm,formatDuration:ui,formatTs:Aa,formatTokens:Km,openDetail:R,closeDetail:x,copyText:g,fetchLoops:y,doCreate:I,doStop:F,doRestart:k}}},Vw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=f(!1),l=f(null),o=f(null),r=W(()=>Ww(a.value.run_at));Mt(()=>a.value.run_at,()=>{o.value=null});const c=W(()=>{var ce;const V=r.value;return V.state==="ok"?V.instant:V.state==="ambiguous"&&o.value!==null&&((ce=V.options[o.value])==null?void 0:ce.instant)||null}),d=W(()=>{const V=c.value;return V?`${V.toLocaleString()} local — ${V.toISOString()} UTC`:""}),u=f(null),p=f(!1),h=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=f(null),v=f(null),w=f(null),R=f(null),x=f(null),g=f(null),b=f([]),T=f(!1),S=f("");let A=0;const C=W(()=>e.value.filter(V=>V.cron&&!V.one_time).length),y=W(()=>e.value.filter(V=>V.one_time).length),I=W(()=>e.value.filter(V=>V.trigger).length),F=W(()=>e.value.filter(V=>V.paused).length),k=W(()=>e.value.filter(V=>V.consecutive_failures>0).length);function M(V){if(!V)return"-";const ce=Date.now(),Oe=(new Date(V).getTime()-ce)/1e3;if(Oe<0)return"overdue";if(Oe<60)return"in < 1 min";if(Oe<3600)return`in ${Math.floor(Oe/60)} min`;if(Oe<86400){const P=Math.floor(Oe/3600),H=Math.floor(Oe%3600/60);return H>0?`in ${P}h ${H}m`:`in ${P}h`}const _=Math.floor(Oe/86400);return`in ${_} day${_!==1?"s":""}`}function j(V){return V==null?"-":V<1e3?`${V}ms`:V<6e4?`${(V/1e3).toFixed(1)}s`:ui(V/1e3)}function K(V=a.value.cron){a.value.cron=V,ap(a.value,"cron"),u.value=null}function D(V=a.value.run_at){a.value.run_at=V,ap(a.value,"run_at"),u.value=null}async function O(){const V=a.value.cron.trim();if(V){p.value=!0;try{u.value=await z.post("/api/schedules/validate-cron",{expression:V})}catch(ce){u.value={valid:!1,error:ce.message}}p.value=!1}}async function L(){t.value=!0,s.value=null;try{e.value=await z.get("/api/schedules")}catch(V){s.value=V.message}t.value=!1}async function B(V){if(g.value===V){g.value=null,b.value=[];return}g.value=V,T.value=!0,b.value=[];const ce=++A;try{const pe=await z.get(`/api/schedules/${encodeURIComponent(V)}/history?limit=10`);if(ce!==A||g.value!==V)return;b.value=pe,S.value=""}catch(pe){if(ce!==A||g.value!==V)return;b.value=[],S.value=pe.message||"Failed to load execution history"}ce===A&&(T.value=!1)}async function Y(){l.value=null;const V=a.value;if(!V.description.trim()){l.value="Description is required";return}if(!V.channel_id.trim()){l.value="Channel ID is required";return}if(!V.cron.trim()&&!V.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(V.cron.trim()&&V.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const ce={description:V.description.trim(),action:V.action,channel_id:V.channel_id.trim()};if(V.cron.trim()&&(ce.cron=V.cron.trim()),V.run_at.trim()){const pe=r.value;if(pe.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(pe.state==="invalid"){l.value="One-time run time is not a valid date";return}const Oe=c.value;if(pe.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Oe){l.value="One-time run time could not be resolved";return}ce.run_at=Oe.toISOString()}if(V.action==="reminder"&&V.message.trim()&&(ce.message=V.message.trim()),V.action==="check"&&(V.tool_name.trim()&&(ce.tool_name=V.tool_name.trim()),V.report_format&&(ce.report_format=V.report_format),V.tool_input_str.trim()))try{ce.tool_input=JSON.parse(V.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await z.post("/api/schedules",ce),ye.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await L()}catch(pe){l.value=pe.message}i.value=!1}async function Z(V){m.value=V;try{const ce=await z.post(`/api/schedules/${encodeURIComponent(V)}/run`);if(ce.status==="failure")ye.error(`Execution failed: ${ce.error||"unknown error"}`);else{const pe=ce.warning?`Executed (${ce.warning})`:"Executed successfully";ye.success(pe)}await L()}catch(ce){ye.error(ce.message||"Failed to trigger")}m.value=null}async function X(V){w.value=V.id;const ce=!V.paused;try{await z.put(`/api/schedules/${encodeURIComponent(V.id)}`,{paused:ce}),ye.success(ce?"Schedule paused":"Schedule resumed"),await L()}catch(pe){ye.error(pe.message||"Failed to update schedule")}w.value=null}const J=new Map;function G(V,ce){const pe=J.get(V.id);pe&&clearTimeout(pe.timer);const Oe={run:()=>ne(V,ce),timer:null};Oe.timer=setTimeout(()=>{J.delete(V.id),Oe.run()},500),J.set(V.id,Oe)}async function ne(V,ce){x.value=V.id;try{await z.put(`/api/schedules/${encodeURIComponent(V.id)}`,{report_format:ce}),ye.success(ce?"Structured report enabled":"Plain-text report enabled")}catch(pe){ye.error(`Update failed: ${pe.message}`)}finally{await L(),x.value=null}}function xe(){for(const[V,ce]of[...J])clearTimeout(ce.timer),J.delete(V),ce.run()}async function Q(V){R.value=V;try{await z.post(`/api/schedules/${encodeURIComponent(V)}/reset-failures`),ye.success("Failure counters reset"),await L()}catch(ce){ye.error(ce.message||"Failed to reset")}R.value=null}async function fe(V){const ce=e.value.find(Oe=>Oe.id===V);if(await qt({title:"Delete schedule",message:`Delete "${(ce==null?void 0:ce.description)||V}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=V;try{await z.del(`/api/schedules/${encodeURIComponent(V)}`),ye.success("Schedule deleted"),await L()}catch(Oe){ye.error(Oe.message||"Failed to delete schedule")}v.value=null}}return je(()=>{L()}),ht(xe),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:h,runningId:m,deletingId:v,togglingId:w,resettingId:R,reportUpdatingId:x,flushReportFormatTimers:xe,expandedId:g,history:b,historyLoading:T,historyError:S,cronCount:C,oneTimeCount:y,webhookCount:I,pausedCount:F,failingCount:k,formatTs:Aa,formatAge:qm,formatFuture:M,formatMs:j,formatDuration:ui,onCronInput:K,onRunAtInput:D,validateCron:O,toggleExpand:B,fetchSchedules:L,doCreate:Y,doRunNow:Z,doTogglePause:X,doUpdateReportFormat:G,doResetFailures:Q,doDelete:fe}}},Jm=[{id:"live",label:"Live",component:Pw},{id:"agents",label:"Agents",component:zw},{id:"loops",label:"Loops",component:jw},{id:"processes",label:"Processes",component:Vw},{id:"schedules",label:"Schedules",component:Zw}],Jw={components:{TabbedPage:Jo},setup(){return{tabs:Jm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(null),a=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),h=f("last_active"),m=f(!1),v=ip,w=Qw,R=f([]),x=f(!1),g=f(""),b=f("flat"),T=f(new Set),S=f(""),A=f(""),C=f(""),y=f(null),I=f(!1),F=f(""),k=f(!1);let M=0;Mt([S,A,C],()=>{M++,I.value=!1,F.value="",k.value=y.value!==null},{flush:"sync"});function j(){try{const ie=localStorage.getItem("odin-session-presets");ie&&(R.value=JSON.parse(ie))}catch{}}function K(){try{localStorage.setItem("odin-session-presets",JSON.stringify(R.value))}catch{}}const D=W(()=>p.value.trim()!==""||u.value!=="all"),O=W(()=>{let ie=[...e.value];const Te=ip.find(Ve=>Ve.id===u.value),Ne=Te?Te.filters:{};if(Ne.source&&(ie=ie.filter(Ve=>Ve.source===Ne.source)),Ne.minMessages&&(ie=ie.filter(Ve=>Ve.message_count>=Ne.minMessages)),Ne.hasCompaction&&(ie=ie.filter(Ve=>Ve.has_summary)),Ne.maxAge!=null){const Ve=Date.now()/1e3;ie=ie.filter(Ft=>Ft.last_active&&Ve-Ft.last_active<=Ne.maxAge)}if(p.value.trim()){const Ve=p.value.toLowerCase().trim();ie=ie.filter(Ft=>(Ft.channel_id||"").toLowerCase().includes(Ve)||(Ft.last_user_id||"").toLowerCase().includes(Ve)||(Ft.source||"").toLowerCase().includes(Ve))}const Ke=h.value,Et=m.value?1:-1;return ie.sort((Ve,Ft)=>{const Ht=Ve[Ke]||0,rs=Ft[Ke]||0;return(Ht-rs)*Et}),ie}),L=W(()=>{if(!a.value||!a.value.messages)return[];const ie=a.value.messages;if(ie.length===0)return[];const Te=[];let Ne=[];for(const Ke of ie)Ke.role==="user"&&Ne.length>0&&(Te.push(Ne),Ne=[]),Ne.push(Ke);return Ne.length>0&&Te.push(Ne),Te}),B=W(()=>O.value.length>0&&c.value.size===O.value.length);function Y(ie){const Te=ie.find(Ne=>Ne.role==="user");if(Te&&Te.content){const Ne=Te.content.slice(0,120);return Ne.length<Te.content.length?Ne+"...":Ne}return"(no user message)"}function Z(ie){const Te=new Set(T.value);Te.has(ie)?Te.delete(ie):Te.add(ie),T.value=Te}function X(ie){u.value=ie}function J(ie){u.value=ie.id,ie.filters.searchQuery!=null&&(p.value=ie.filters.searchQuery),ie.filters.sortBy&&(h.value=ie.filters.sortBy)}function G(){if(!g.value.trim())return;const ie={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:h.value}};R.value=[...R.value,ie],K(),x.value=!1,g.value=""}function ne(ie){R.value=R.value.filter(Te=>Te.id!==ie),K(),u.value===ie&&(u.value="all")}function xe(){u.value="all",p.value="",h.value="last_active",m.value=!1}function Q(ie){if(!ie)return"—";const Te=Date.now()/1e3-ie;if(Te<60)return"just now";if(Te<3600){const Ke=Math.floor(Te/60);return`${Ke} minute${Ke!==1?"s":""} ago`}if(Te<86400){const Ke=Math.floor(Te/3600);return`${Ke} hour${Ke!==1?"s":""} ago`}const Ne=Math.floor(Te/86400);return`${Ne} day${Ne!==1?"s":""} ago`}function fe(ie){if(!ie)return"";try{return new Date(ie*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function V(ie){if(!ie)return"";try{return new Date(ie*1e3).toLocaleString()}catch{return""}}function ce(ie){return ie==="user"?"bg-gray-900/50 border border-gray-800":ie==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function pe(ie){return ie==="user"?"sess-msg-user":ie==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Oe(ie){return ie==="user"?"badge-info":ie==="assistant"?"badge-success":"badge-warning"}function _(ie){return ie==="user"?"sess-dot-user":ie==="assistant"?"sess-dot-assistant":"sess-dot-system"}function P(ie){return ie==="user"?"text-cyan-400":ie==="assistant"?"text-indigo-400":"text-gray-500"}function H(ie){return ie?ie.length>2e3?ie.slice(0,2e3)+`
... (truncated)`:ie:""}async function oe(){const ie=S.value.trim();if(!ie)return;const Te=++M;I.value=!0,F.value="",k.value=y.value!==null;try{let Ne=`/api/sessions/search?q=${encodeURIComponent(ie)}&limit=50`;A.value.trim()&&(Ne+=`&channel_id=${encodeURIComponent(A.value.trim())}`),C.value.trim()&&(Ne+=`&user_id=${encodeURIComponent(C.value.trim())}`);const Ke=await z.get(Ne);if(Te!==M)return;y.value=Ke.results||[],k.value=!1}catch(Ne){if(Te!==M)return;F.value=Ne.message||"Search failed. Please retry."}finally{Te===M&&(I.value=!1)}}function ae(){M++,S.value="",A.value="",C.value="",y.value=null,F.value="",k.value=!1,I.value=!1}function le(ie){return ie?ie.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function he(ie){return ie==="user"?"fts-result-user":ie==="assistant"?"fts-result-assistant":ie==="summary"?"fts-result-summary":ie==="fts"?"fts-result-fts":ie==="channel"?"fts-result-channel":"fts-result-default"}function ue(ie){return ie==="user"?"badge-info":ie==="assistant"?"badge-success":ie==="summary"?"badge-warning":ie==="fts"?"badge-success":"badge-info"}let de=0;async function re(){const ie=++de;t.value=!0,s.value=null;try{const Te=await z.get("/api/sessions");if(ie!==de)return;e.value=Te}catch(Te){if(ie!==de)return;s.value=Te.message}ie===de&&(t.value=!1)}function _e(){s.value=null,re()}async function ve(ie){if(n.value===ie){n.value=null,a.value=null,T.value=new Set;return}n.value=ie,a.value=null,i.value=!0,T.value=new Set;const Te=++l;try{const Ne=await z.get(`/api/sessions/${encodeURIComponent(ie)}`);Te===l&&n.value===ie&&(a.value=Ne)}catch(Ne){Te===l&&n.value===ie&&(a.value={messages:[],summary:"",error:Ne.message||"Failed to load session"})}finally{Te===l&&(i.value=!1)}}function we(ie){const Te=new Set(c.value);Te.has(ie)?Te.delete(ie):Te.add(ie),c.value=Te}function Ie(){B.value?c.value=new Set:c.value=new Set(O.value.map(ie=>ie.channel_id))}function $(ie){o.value=ie}async function ge(){if(o.value){r.value=!0;try{await z.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await re()}catch(ie){s.value=ie.message||"Failed to clear session"}r.value=!1,o.value=null}}function Se(){d.value=!0}async function Le(){if(c.value.size!==0){r.value=!0;try{await z.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await re()}catch(ie){s.value=ie.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Pe(ie,Te){const Ne=`/api/sessions/${encodeURIComponent(ie)}/export?format=${Te}`;try{const Ke=await z.getBlob(Ne),Et=URL.createObjectURL(Ke),Ve=document.createElement("a");Ve.href=Et,Ve.download=`session-${ie}.${Te==="text"?"txt":"json"}`,Ve.click(),URL.revokeObjectURL(Et)}catch(Ke){s.value=Ke.message||"Failed to export session"}}let dt=null;function st(ie){ie.payload&&ie.payload.channel_id&&(clearTimeout(dt),dt=setTimeout(()=>{if(re(),n.value&&ie.payload.channel_id===n.value){const Te=n.value,Ne=l;z.get(`/api/sessions/${encodeURIComponent(Te)}`).then(Ke=>{Ne!==l||n.value!==Te||(a.value=Ke)}).catch(()=>{})}},2e3))}let _t=!1,Ot=null;function rt(){_t||(_t=!0,re(),Ye.subscribe("events",st),Ot=Ye.onReconnected(()=>re()))}je(()=>{j(),rt()}),os(()=>{rt()});function Qe(){_t&&(_t=!1,Ye.unsubscribe("events",st),Ot&&(Ot(),Ot=null),clearTimeout(dt))}return Yt(Qe),ht(Qe),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:B,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:h,sortAsc:m,filterPresets:v,sortOptions:w,filteredSessions:O,hasActiveFilters:D,customPresets:R,showSavePreset:x,newPresetName:g,threadView:b,threads:L,collapsedThreads:T,ftsQuery:S,ftsChannelId:A,ftsUserId:C,ftsResults:y,ftsSearching:I,ftsError:F,ftsStale:k,formatAge:Q,formatTimestamp:fe,formatFullTimestamp:V,messageClass:ce,threadMsgClass:pe,roleBadge:Oe,roleDotClass:_,roleLabelClass:P,truncateContent:H,threadSummary:Y,fetchSessions:re,retry:_e,toggleSession:ve,toggleSelect:we,toggleSelectAll:Ie,confirmClear:$,clearSession:ge,confirmBulkClear:Se,doBulkClear:Le,exportSession:Pe,applyPreset:X,applyCustomPreset:J,saveCustomPreset:G,removeCustomPreset:ne,resetFilters:xe,toggleThread:Z,runFtsSearch:oe,clearFtsSearch:ae,highlightSnippet:le,ftsResultClass:he,ftsTypeBadge:ue}}},ek={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:Km}}},tk={components:{ContextAssemblyPanel:ek},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),n=f(null),a=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(A){if(!A)return"—";try{const C=new Date(A);return isNaN(C.getTime())?A:C.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return A}}function p(A){return!A&&A!==0?"—":A<1e3?A+"ms":(A/1e3).toFixed(1)+"s"}function h(A){return!A&&A!==0?"—":A>=1e3?(A/1e3).toFixed(1)+"k":String(A)}function m(A){if(!A)return"";if(typeof A=="string")return A;try{return JSON.stringify(A,null,2)}catch{return String(A)}}function v(A){a.value===A?a.value=null:(a.value=A,c.value={})}function w(A,C){const y=A+"-"+C;c.value={...c.value,[y]:!c.value[y]}}function R(A,C){return!!c.value[A+"-"+C]}function x(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,T()}async function g(){try{const A=await z.get("/api/trajectories");e.value=A.files||[],r.value=A.count||0}catch{}}let b=0;async function T(){const A=++b;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(o.value){const C=await z.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(A!==b)return;let y=C.entries||[];d.value.tool_name&&(y=y.filter(I=>(I.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(y=y.filter(I=>I.is_error)),d.value.channel_id&&(y=y.filter(I=>I.channel_id===d.value.channel_id)),d.value.user_id&&(y=y.filter(I=>I.user_id===d.value.user_id)),t.value=y}else{const C=new URLSearchParams;d.value.channel_id&&C.set("channel_id",d.value.channel_id),d.value.user_id&&C.set("user_id",d.value.user_id),d.value.tool_name&&C.set("tool_name",d.value.tool_name),d.value.errors_only&&C.set("errors_only","true"),C.set("limit",String(d.value.limit));const y=C.toString(),I=await z.get(`/api/trajectories/search/query?${y}`);if(A!==b)return;t.value=I.results||[]}}catch(C){if(A!==b)return;n.value=C.message}A===b&&(s.value=!1)}async function S(){if(!l.value.trim())return;const A=++b;s.value=!0,n.value=null,c.value={};try{const C=await z.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(A!==b)return;i.value=C.entry||null,i.value||(n.value="No trace found for this message ID")}catch(C){if(A!==b)return;C.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=C.message}A===b&&(s.value=!1)}return je(async()=>{await g(),await T()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:h,formatJSON:m,truncateBlock:Gm,toggleExpand:v,toggleIteration:w,isIterationExpanded:R,clearFilters:x,fetchFiles:g,fetchTraces:T,lookupMessage:S}}};function sk(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function nk(e){return e?`${e.approximate?"~":""}${bd(e.total||0)}`:"0"}const ak={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=W(()=>n.value.work||{}),h=W(()=>Math.max(1,...(n.value.activity_over_time||[]).map(S=>Number(S.count||0)))),m=W(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),v=S=>({height:`${Math.max(4,Math.round(Number(S||0)/h.value*100))}%`}),w=W(()=>s.value&&l.value-i.value>3e4);async function R(){const S=++d,A=a.value;try{const C=await z.get(`/api/usage?range=${encodeURIComponent(A)}`);if(S!==d||A!==a.value)return;n.value=C,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(C){S===d&&(t.value=C.message)}finally{S===d&&(e.value=!1)}}function x(S){a.value=S,e.value=!s.value,R()}function g(){e.value=!0,R()}function b(){c||(c=!0,R(),o=setInterval(R,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function T(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return je(b),os(b),Yt(T),ht(T),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:w,fmtNum:bd,fmtDuration:sk,tokenLabel:nk,activityTrackStyle:m,activityBar:v,selectRange:x,retry:g}}},Ym=[{id:"audit",label:"Audit",component:Yw},{id:"sessions",label:"Sessions",component:Xw},{id:"traces",label:"Traces",component:tk},{id:"usage",label:"Usage & Activity",component:ak}],ik={components:{TabbedPage:Jo},setup(){return{tabs:Ym}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},yr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],lk={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(y){return y.source!=="builtin"?"":u[y.state]||""}function h(y,I){const F=y&&Array.isArray(y.tools)?y.tools:null;if(c.value=!!F,r.value=F?!!y.global_enabled:null,!F){e.value=I.map(j=>({...j,source:"unknown",enabled:void 0,state:null}));return}const k=new Set(F.map(j=>j.name)),M=I.filter(j=>!k.has(j.name)).map(j=>({...j,source:j.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...F.map(j=>({...j,source:"builtin"})),...M]}async function m(y,I){if(d.value.has(y.name))return;const F=!!I.target.checked,k=new Set(d.value);k.add(y.name),d.value=k;try{const M=await z.post(`/api/tools/builtins/${encodeURIComponent(y.name)}/enabled`,{enabled:F});h(M,e.value),s.value=null;try{const j=await z.get("/api/tools");h(M,j)}catch(j){console.warn("Built-in toggle committed; visible catalog refresh failed",j)}}catch(M){I.target.checked=!!y.enabled,s.value=M.message||`Failed to toggle ${y.name}`}finally{const M=new Set(d.value);M.delete(y.name),d.value=M}}const v=W(()=>e.value.filter(y=>y.source==="builtin"&&y.is_core).length),w=W(()=>e.value.filter(y=>y.source==="skill").length),R=W(()=>Object.values(a.value).reduce((y,I)=>y+I,0));function x(y){for(const I of yr)if(I.id!=="other"&&I.match(y))return I.id;return"other"}const g=W(()=>{let y=e.value;if(n.value){const I=n.value.toLowerCase();y=y.filter(F=>F.name.toLowerCase().includes(I)||(F.description||"").toLowerCase().includes(I))}return o.value&&(y=y.filter(I=>x(I.name)===o.value)),y}),b=W(()=>{const y=new Set;for(const I of e.value)y.add(x(I.name));return yr.filter(I=>y.has(I.id))}),T=W(()=>{const y=g.value,I={};for(const k of y){const M=x(k.name);I[M]||(I[M]=[]),I[M].push(k)}const F=[];for(const k of yr)I[k.id]&&I[k.id].length>0&&F.push({label:k.label,icon:k.icon,tools:I[k.id].sort((M,j)=>M.name.localeCompare(j.name))});return F});function S(y){i.value={...i.value,[y]:!i.value[y]}}async function A(){t.value=!0,s.value=null;try{const[y,I,F]=await Promise.all([z.get("/api/tools"),z.get("/api/tools/stats").catch(()=>({})),z.get("/api/tools/builtins").catch(()=>null)]);h(F,y),a.value=I||{}}catch(y){s.value=y.message}t.value=!1}function C(){A()}return je(()=>{A()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:w,totalUsage:R,filteredTools:g,groupedTools:T,usedCategories:b,stateBadge:p,applyInventory:h,toggleBuiltinTool:m,truncate:gd,toggleExpand:S,refresh:C}}};function ok(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function rk(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function F(G){return rk(G)}function k(G){n.value={...n.value,[G]:!n.value[G]}}async function M(G){try{await navigator.clipboard.writeText(G);const ne=e.value.find(xe=>xe.code===G);ne&&(o.value=ne.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function j(G){if(G.key==="Tab"){G.preventDefault();const ne=G.target,xe=ne.selectionStart,Q=ne.selectionEnd;u.value=u.value.substring(0,xe)+"    "+u.value.substring(Q),Rt(()=>{ne.selectionStart=ne.selectionEnd=xe+4})}}function K(G){const ne=G.target.previousElementSibling;ne&&(ne.scrollTop=G.target.scrollTop)}async function D(){t.value=!0,s.value=null;try{e.value=await z.get("/api/skills")}catch(G){s.value=G.message}t.value=!1}async function O(G){i.value=G,delete a.value[G],a.value={...a.value};try{const ne=await z.post(`/api/skills/${encodeURIComponent(G)}/test`);a.value={...a.value,[G]:ne}}catch(ne){a.value={...a.value,[G]:{result:ne.message,is_error:!0}}}i.value=null}function L(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,h.value=null}function B(G){r.value=!0,c.value="edit",d.value=G.name,u.value=G.code||"",p.value=null,h.value=null}function Y(){r.value=!1,p.value=null,h.value=null}async function Z(){p.value=null,h.value=null;const G=d.value.trim(),ne=u.value.trim();if(!G){p.value="Name is required";return}if(!ne){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await z.post("/api/skills",{name:G,code:ne}),h.value="Skill created successfully"):(await z.put(`/api/skills/${encodeURIComponent(G)}`,{code:ne}),h.value="Skill updated successfully"),await D(),setTimeout(()=>{r.value=!1},800)}catch(xe){p.value=xe.message}m.value=!1}function X(G){w.value=G}async function J(){if(w.value){R.value=!0;try{await z.del(`/api/skills/${encodeURIComponent(w.value)}`),await D()}catch(G){ye.error(`Failed to delete skill: ${G.message||"unknown error"}`)}R.value=!1,w.value=null}}return je(()=>{D()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:h,saving:m,editorRef:v,deleteTarget:w,deleting:R,enabledCount:x,totalExecutions:g,totalLines:b,displayedSkills:T,editLineCount:S,editorLineNums:A,editValidation:C,highlight:y,truncate:gd,formatTs:Aa,countLines:I,getLineNumbers:F,toggleCode:k,copyCode:M,handleEditorKey:j,syncScroll:K,fetchSkills:D,testSkill:O,showCreate:L,editSkill:B,cancelEdit:Y,saveSkill:Z,confirmDelete:X,doDelete:J}}};class Fs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const dk=/^[A-Za-z_][A-Za-z0-9_]*$/;function lp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function op(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Fs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Fs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Fs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Fs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function uk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function pk(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Fs("Server name is required.","name");if(a.length>128||!dk.test(a))throw new Fs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Fs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=lp(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Fs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Fs("An HTTP endpoint is required for this connection.","url");if(d&&!uk(d))throw new Fs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Fs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=lp(e.allowlistText));const r=op(e.headerRows,e.headersRemove,"Header"),c=op(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function fk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function hk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function mk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const vk=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function gk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const bk=1e4,yk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function xr(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function xk(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const _k={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),n=f(""),a=f(new Set),i=f(new Set),l=f({}),o=f({}),r=f({}),c=f(new Set),d=f(!1),u=f("add"),p=f(""),h=f(null),m=f(xr()),v=f(""),w=f(!1);let R=null,x=0,g=!1,b=!1;const T=vk,S=W(()=>{var $;return(($=e.value)==null?void 0:$.servers)||[]}),A=W(()=>{var $;return!!(($=e.value)!=null&&$.enabled)}),C=W(()=>{var $,ge,Se,Le;return{serverCount:(($=e.value)==null?void 0:$.server_count)||0,enabledCount:((ge=e.value)==null?void 0:ge.enabled_server_count)||0,connectedCount:((Se=e.value)==null?void 0:Se.connected_count)||0,toolCount:((Le=e.value)==null?void 0:Le.published_tool_count)||0}}),y=W(()=>{var $;return(($=h.value)==null?void 0:$.header_keys)||[]}),I=W(()=>{var $;return(($=h.value)==null?void 0:$.env_keys)||[]}),F=W(()=>{var $;return u.value==="edit"&&(($=h.value)==null?void 0:$.transport)==="http"}),k=W(()=>u.value==="add"||!F.value),M=W(()=>F.value?"Replace endpoint URL":"Endpoint URL"),j=W(()=>F.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function K(){D(),R=window.setInterval(()=>O({quiet:!0}),bk)}function D(){R&&window.clearInterval(R),R=null}async function O({quiet:$=!1}={}){const ge=++x;$||(t.value=!0);try{const Se=await z.get("/api/mcp/status");if(ge!==x||!g)return;e.value=Se,n.value="";const Le=new Set((Se.servers||[]).map(Pe=>Pe.name));i.value=new Set([...i.value].filter(Pe=>Le.has(Pe)))}catch(Se){ge===x&&g&&(n.value=Se.message||"Failed to load MCP status")}finally{ge===x&&(t.value=!1)}}function L($){return s.value||a.value.has($)}function B($,ge){const Se=new Set(a.value);ge?Se.add($):Se.delete($),a.value=Se}function Y($){return hk($.state)}function Z($){if(Y($)==="disabled"){if(!$.enabled)return"Disabled — server switch off";if(!A.value)return"Disabled — global MCP is off"}return yk[Y($)]}function X($){return $.transport==="http"?"Streamable HTTP":"stdio"}function J($){return $.negotiated_version?`${$.era?`${String($.era).charAt(0).toUpperCase()}${String($.era).slice(1)}`:"Protocol"} · ${$.negotiated_version}`:"Not negotiated"}function G($){return $.discovered_count?`${$.published_count||0} published · ${$.excluded_count||0} excluded`:"No tools discovered"}const ne=f(new Set);async function xe($,ge){if(ne.value.has($.name))return;const Se=!!ge.target.checked,Le=new Set(ne.value);Le.add($.name),ne.value=Le;try{const Pe=await z.post(`/api/mcp/servers/${encodeURIComponent($.name)}/enabled`,{enabled:Se});Pe&&Array.isArray(Pe.servers)?e.value=Pe:await O({quiet:!0})}catch(Pe){ge.target.checked=!!$.enabled,ye.error(Pe.message||`Failed to toggle ${$.name}`)}finally{const Pe=new Set(ne.value);Pe.delete($.name),ne.value=Pe}}async function Q($){if($!==A.value&&!(!$&&!await qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await z.post("/api/mcp/enabled",{enabled:$}),ye.success($?"MCP enabled":"MCP disabled"),await O({quiet:!0})}catch(ge){ye.error(ge.message||"Failed to update MCP state"),await O({quiet:!0})}finally{s.value=!1}}}async function fe($){B($.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent($.name)}/reconnect`,{}),ye.success(`Reconnected ${$.name}`)}catch(ge){ye.error(ge.message||`Failed to reconnect ${$.name}`)}finally{B($.name,!1),await O({quiet:!0})}}async function V($){B($.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent($.name)}/refresh-tools`,{}),ye.success(`Refreshed tools from ${$.name}`),await Oe($.name,!0)}catch(ge){ye.error(ge.message||`Failed to refresh ${$.name}`)}finally{B($.name,!1),await O({quiet:!0})}}async function ce($){if(await qt({title:`Remove ${$.name}`,message:`Remove this saved MCP server? Its ${$.published_count||0} published tool${$.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){B($.name,!0);try{await z.del(`/api/mcp/servers/${encodeURIComponent($.name)}`),ye.success(`Removed ${$.name}`),delete o.value[$.name]}catch(Se){ye.error(Se.message||`Failed to remove ${$.name}`)}finally{B($.name,!1),await O({quiet:!0})}}}async function pe($){const ge=new Set(i.value);if(ge.has($.name)){ge.delete($.name),i.value=ge;return}ge.add($.name),i.value=ge,Object.hasOwn(o.value,$.name)||await Oe($.name)}async function Oe($,ge=!1){if(!ge&&Object.hasOwn(o.value,$))return;const Se=new Set(c.value);Se.add($),c.value=Se,r.value={...r.value,[$]:""};try{const Le=await z.get(`/api/mcp/servers/${encodeURIComponent($)}/tools`);o.value={...o.value,[$]:Le.tools||[]}}catch(Le){r.value={...r.value,[$]:Le.message||"Failed to load tools"}}finally{const Le=new Set(c.value);Le.delete($),c.value=Le}}function _($){return(o.value[$]||[]).filter(ge=>mk(ge,l.value[$]))}function P($,ge){l.value={...l.value,[$]:ge}}function H(){u.value="add",p.value="",h.value=null,m.value=xr(),v.value="",d.value=!0}function oe($){u.value="edit",p.value=$.name,h.value=$,m.value={...xr(),name:$.name,enabled:!!$.enabled,transport:$.transport||"stdio"},v.value="",d.value=!0}function ae(){w.value||(d.value=!1)}function le($){d.value&&gk($)}function he($){const ge=$==="headers"?"headerRows":"envRows";m.value[ge].push({key:"",value:""})}function ue($,ge){const Se=$==="headers"?"headerRows":"envRows";m.value[Se].splice(ge,1)}function de($,ge){const Se=$==="headers"?"headersRemove":"envRemove",Le=m.value[Se];m.value[Se]=Le.includes(ge)?Le.filter(Pe=>Pe!==ge):[...Le,ge]}async function re(){var ge,Se;v.value="";let $;try{$=pk(m.value,{mode:u.value,originalTransport:((ge=h.value)==null?void 0:ge.transport)||""})}catch(Le){v.value=Le instanceof Fs?Le.message:"Invalid MCP server configuration",await Rt(),(Se=document.querySelector(".mcp-editor"))==null||Se.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&fk($,h.value)&&!await qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){w.value=!0;try{u.value==="add"?await z.post("/api/mcp/servers",$):await z.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,$),ye.success(u.value==="add"?`Saved ${$.name}`:`Updated ${p.value}`),d.value=!1,await O({quiet:!0})}catch(Le){v.value=Le.message||"Failed to save MCP server"}finally{w.value=!1}}}let _e=null;function ve($){`${($==null?void 0:$.event)||""} ${($==null?void 0:$.type)||""} ${($==null?void 0:$.tool)||""} ${($==null?void 0:$.message)||""}`.toLowerCase().includes("mcp")&&(_e&&window.clearTimeout(_e),_e=window.setTimeout(()=>O({quiet:!0}),200))}function we(){g||(g=!0,b||(Ye.subscribe("events",ve),b=!0),O(),K())}function Ie(){g=!1,D(),_e&&window.clearTimeout(_e),_e=null,b&&(Ye.unsubscribe("events",ve),b=!1)}return je(we),os(we),Yt(Ie),ht(Ie),{status:e,loading:t,mutating:s,pageError:n,servers:S,masterEnabled:A,aggregate:C,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:h,form:m,formError:v,saving:w,editorGroups:T,configuredHeaderKeys:y,configuredEnvKeys:I,savedHttpEndpoint:F,endpointRequired:k,endpointFieldLabel:M,endpointPlaceholder:j,refreshAll:O,busy:L,serverState:Y,stateLabel:Z,transportLabel:X,protocolLabel:J,toolSummary:G,formatAge:xk,setMasterEnabled:Q,togglePending:ne,toggleServerEnabled:xe,reconnect:fe,refreshTools:V,removeServer:ce,toggleTools:pe,filteredTools:_,setToolQuery:P,openAdd:H,openEdit:oe,closeEditor:ae,jumpToEditorGroup:le,addSecretRow:he,removeSecretRow:ue,toggleSecretRemoval:de,saveServer:re}}};function wk(e,t){if(!e||!t)return np(e);const s=np(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const kk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),h=f(!1),m=f(null),v=f(null);let w=null;const R=f(null),x=f(!1),g=f({}),b=f({}),T=f({}),S=f({}),A=new Map,C=f(null),y=W(()=>e.value.reduce((Z,X)=>Z+(X.chunks||0),0)),I=W(()=>new Set(e.value.map(X=>X.uploader).filter(Boolean)).size);function F(Z,X){const J=b.value[X];if(!J||J.length===0)return 0;const G=Math.max(...J.map(ne=>ne.char_count||0));return G===0?0:Math.round(Z.char_count/G*100)}async function k(){t.value=!0,s.value=null;try{const Z=await z.get("/api/knowledge");e.value=Array.isArray(Z)?Z:[]}catch(Z){s.value=Z.message}t.value=!1}async function M(Z){if(g.value[Z]){g.value[Z]=!1,C.value=null;return}if(g.value[Z]=!0,Object.prototype.hasOwnProperty.call(b.value,Z))return;if(A.has(Z))return A.get(Z);const X={...S.value,[Z]:!0};S.value=X;const J={...T.value};delete J[Z],T.value=J;const G=z.get(`/api/knowledge/${encodeURIComponent(Z)}/chunks`).then(ne=>{b.value={...b.value,[Z]:Array.isArray(ne)?ne:[]}}).catch(ne=>{T.value={...T.value,[Z]:ne.message||"load failed"}}).finally(()=>{if(A.get(Z)!==G)return;A.delete(Z);const ne={...S.value};delete ne[Z],S.value=ne});return A.set(Z,G),G}let j=0;async function K(){const Z=n.value.trim();if(!Z)return;const X=++j;i.value=!0,o.value=null,l.value=Z;try{const J=await z.get(`/api/knowledge/search?q=${encodeURIComponent(Z)}`);if(X!==j)return;a.value=Array.isArray(J)?J:[]}catch(J){if(X!==j)return;a.value=[],o.value=J.message||"Search failed"}X===j&&(i.value=!1)}function D(){j+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function O(){u.value=null,p.value=null;const Z=c.value.trim(),X=d.value.trim();if(!Z){u.value="Source name is required";return}if(!X){u.value="Content is required";return}h.value=!0;try{const J=await z.post("/api/knowledge",{source:Z,content:X});p.value=`Ingested ${J.chunks||0} chunks from "${Z}"`,c.value="",d.value="",b.value={},await k(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(J){u.value=J.message}h.value=!1}async function L(Z){m.value=Z,v.value=null,w&&(clearTimeout(w),w=null);try{const X=await z.post(`/api/knowledge/${encodeURIComponent(Z)}/reingest`);v.value={source:Z,error:!1,message:`Re-ingested ${X.chunks||0} chunks`},delete b.value[Z],await k(),w=setTimeout(()=>{v.value=null,w=null},3e3)}catch(X){v.value={source:Z,error:!0,message:X.message}}m.value=null}function B(Z){R.value=Z}async function Y(){if(R.value){x.value=!0;try{await z.del(`/api/knowledge/${encodeURIComponent(R.value)}`),delete b.value[R.value],await k()}catch(Z){ye.error(`Failed to delete source: ${Z.message||"unknown error"}`)}x.value=!1,R.value=null}}return je(()=>{k()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:h,reingesting:m,reingestResult:v,deleteTarget:R,deleting:x,expanded:g,sourceChunks:b,chunkErrors:T,loadingChunks:S,selectedChunk:C,totalChunks:y,uploaderCount:I,truncate:gd,formatTs:Aa,highlightTerms:wk,chunkBarWidth:F,fetchSources:k,toggleSource:M,doSearch:K,clearSearch:D,doIngest:O,doReingest:L,confirmDelete:B,doDelete:Y}}},Sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),n=f(null),a=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),h=f(""),m=f(!1),v=f(null),w=f(null),R=f(new Set),x=f(null),g=f(!1),b=f(!1),T=W(()=>e.value.reduce((X,J)=>X+J.count,0)),S=W(()=>R.value.size);function A(X){const J=t.value[X];if(!J)return[];if(!l.value.trim())return J;const G=l.value.trim().toLowerCase();return J.filter(ne=>ne.key.toLowerCase().includes(G)||ne.value&&ne.value.toLowerCase().includes(G))}function C(X,J){return R.value.has(X+"/"+J)}function y(X,J){const G=X+"/"+J,ne=new Set(R.value);ne.has(G)?ne.delete(G):ne.add(G),R.value=ne}function I(X){const J=t.value[X];return!J||J.length===0?!1:J.every(G=>R.value.has(X+"/"+G.key))}function F(X,J){const G=t.value[X];if(!G)return;const ne=new Set(R.value);for(const xe of G){const Q=X+"/"+xe.key;J?ne.add(Q):ne.delete(Q)}R.value=ne}async function k(){s.value=!0,n.value=null;try{const X=await z.get("/api/memory");e.value=Object.entries(X).map(([J,G])=>({name:J,keys:G.keys||[],count:G.count||0}))}catch(X){n.value=X.message}s.value=!1}async function M(X){if(a.value[X]){a.value[X]=!1;return}a.value[X]=!0;const J=e.value.find(ne=>ne.name===X);if(!J||t.value[X]||i.value===X)return;i.value=X;let G;try{const xe=(await z.get(`/api/memory/${encodeURIComponent(X)}`)).entries||{};G=J.keys.map(Q=>Object.prototype.hasOwnProperty.call(xe,Q)?{key:Q,value:xe[Q]||"",failed:!1}:{key:Q,value:"",failed:!0,error:"Not found in scope"})}catch(ne){G=J.keys.map(xe=>({key:xe,value:"",failed:!0,error:ne.message||"Failed to load"}))}t.value[X]=G,i.value=null}function j(X,J,G){p.value=X+"/"+J,h.value=G}async function K(X,J){m.value=!0,v.value=null;try{await z.put(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(J)}`,{value:h.value});const G=t.value[X];if(G){const ne=G.find(xe=>xe.key===J);ne&&(ne.value=h.value)}p.value=null}catch(G){v.value=`Failed to save: ${G.message||"unknown error"}`}m.value=!1}async function D(X,J){try{await navigator.clipboard.writeText(J.value),w.value=X+"/"+J.key,setTimeout(()=>{w.value=null},1500)}catch{}}async function O(){d.value=null,u.value=null;const X=r.value.scope.trim(),J=r.value.key.trim(),G=r.value.value.trim();if(!X){d.value="Scope is required";return}if(!J){d.value="Key is required";return}if(!G){d.value="Value is required";return}c.value=!0;try{await z.put(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(J)}`,{value:G}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await k(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ne){d.value=ne.message}c.value=!1}function L(X,J){x.value={scope:X,key:J}}async function B(){if(!x.value)return;g.value=!0,v.value=null;const{scope:X,key:J}=x.value;try{await z.del(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(J)}`);const G=t.value[X];G&&(t.value[X]=G.filter(Q=>Q.key!==J));const ne=e.value.find(Q=>Q.name===X);ne&&(ne.count--,ne.keys=ne.keys.filter(Q=>Q!==J));const xe=new Set(R.value);xe.delete(X+"/"+J),R.value=xe}catch(G){v.value=`Failed to delete: ${G.message||"unknown error"}`}g.value=!1,x.value=null}function Y(){b.value=!0}async function Z(){g.value=!0,v.value=null;const X=[];for(const J of R.value){const G=J.indexOf("/");X.push({scope:J.slice(0,G),key:J.slice(G+1)})}try{await z.post("/api/memory/bulk-delete",{entries:X}),R.value=new Set,t.value={},await k()}catch(J){v.value=`Bulk delete failed: ${J.message||"unknown error"}`}g.value=!1,b.value=!1}return je(()=>{k()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:h,saving:m,actionError:v,copied:w,selected:R,selectedCount:S,totalEntries:T,deleteTarget:x,deleting:g,showBulkDelete:b,fetchMemory:k,toggleScope:M,startEdit:j,doEdit:K,copyValue:D,doAdd:O,confirmDelete:L,doDelete:B,confirmBulkDelete:Y,doBulkDelete:Z,isSelected:C,toggleSelect:y,isScopeAllSelected:I,toggleSelectAll:F,filteredEntries:A}}},Tk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f(!1),a=f("sessions"),i=f(null);let l=null;const o=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=W(()=>{if(!i.value||!i.value.collected_at)return"";try{return new Date(i.value.collected_at).toLocaleTimeString()}catch{return""}}),c=W(()=>{if(!i.value)return[];const w=i.value,R=w.storage_total_bytes||1;return[{label:"Session Persistence",mb:w.sessions.persist_dir.total_mb,bytes:w.sessions.persist_dir.total_bytes,files:w.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(w.sessions.persist_dir.total_bytes/R*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:w.knowledge.db_file.total_mb,bytes:w.knowledge.db_file.total_bytes,files:w.knowledge.db_file.file_count,pct:Math.min(100,Math.round(w.knowledge.db_file.total_bytes/R*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:w.trajectories.message_dir.total_mb,bytes:w.trajectories.message_dir.total_bytes,files:w.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(w.trajectories.message_dir.total_bytes/R*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:w.trajectories.agent_dir.total_mb,bytes:w.trajectories.agent_dir.total_bytes,files:w.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(w.trajectories.agent_dir.total_bytes/R*100)),color:"res-bar-amber"}]});async function d(){try{const w=await z.get("/api/resource-usage");i.value=w,t.value=null,s.value=!0}catch(w){t.value=w.message||"Failed to load resource usage"}finally{e.value=!1,n.value=!1}}async function u(){n.value=!0,await d()}function p(){e.value=!0,t.value=null,d()}let h=!1;function m(){h||(h=!0,d(),l||(l=setInterval(d,3e4)))}function v(){h&&(h=!1,l&&(clearInterval(l),l=null))}return je(m),os(m),Yt(v),ht(v),{hasData:s,loading:e,error:t,refreshing:n,data:i,activeTab:a,tabs:o,collectedAt:r,storageItems:c,fmtNum:bd,refresh:u,retry:p}}},Lk=new Set(["timestamp","type","level","tool_name","action","method","path","status","success","execution_time_ms","duration_ms","metadata","audit_metadata","turn","tool_input","audit_observer","_hmac","_prev_hmac","agent_id","agent_label","parent_agent_id","root_agent_id","originating_turn_id","turn_id","iteration","call_id","result_summary","detail","message","diff","error"]),Nk=new Set(["agent_id","agent_label","label","parent_agent_id","root_agent_id","originating_turn_id","turn_id","iteration","call_id","status","duration_ms","tool_input_keys","audit_observer","_hmac","_prev_hmac"]);function Dk(e){const t={};for(const s of["metadata","audit_metadata"]){if(!(e!=null&&e[s])||typeof e[s]!="object")continue;const n=Object.fromEntries(Object.entries(e[s]).filter(([a])=>!Nk.has(a)));Object.keys(n).length&&(t[s]=n)}return Object.keys(t).length?rl(t):""}function Mk(e){var a,i,l;const t=e.record;if(!t)return{body:e.text,action:"",status:"",duration:null};let s;for(const o of["result_summary","detail","message","diff","error"])if(t[o]!==void 0&&t[o]!==null&&t[o]!==""){s=t[o];break}if(s===void 0&&((a=t.metadata)!=null&&a.error)&&(s=t.metadata.error),s===void 0){const o=Object.fromEntries(Object.entries(t).filter(([r])=>!Lk.has(r)));s=Object.keys(o).length?rl(o):""}const n=t.status??((i=t.metadata)==null?void 0:i.status)??(t.error||t.success===!1?"failed":t.success===!0?"success":"");return{body:s,action:t.tool_name||t.action||(t.method?`${t.method} ${t.path||""}`.trim():t.type||""),status:n,duration:t.execution_time_ms??t.duration_ms??((l=t.metadata)==null?void 0:l.duration_ms)??null}}const Pk={components:{ToolOutput:Yo},props:{entry:{type:Object,required:!0}},emits:["copy"],setup(e){const t=W(()=>Mk(e.entry)),s=W(()=>{var i;return rl(((i=e.entry.record)==null?void 0:i.tool_input)??"")}),n=W(()=>{var i,l,o;return rl(((i=e.entry.record)==null?void 0:i.error)||((o=(l=e.entry.record)==null?void 0:l.metadata)==null?void 0:o.error)||"")}),a=W(()=>Dk(e.entry.record));return{display:t,argumentsText:s,errorText:n,metadataText:a}},template:`
    ...
    </div>`,setup(){const e=f("live"),t=f([]);let s=0;const n=f(!1),a=f(!1),i=f(!0),l=f(""),o=f(""),r=f(!1),c=f(!1),d=f(Ye.state||"disconnected"),u=W(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),p=f(null),h=f(!1),m=f(null),v=2e3,w=Uk,R=Hk,x=_r,g=f("all"),b=f(""),T=f([]),S=f(!1),A=f(""),C=f([]);function y(){try{const te=localStorage.getItem("odin-log-presets");te&&(T.value=JSON.parse(te))}catch{}}function I(){try{localStorage.setItem("odin-log-presets",JSON.stringify(T.value))}catch{}}const F=W(()=>l.value!==""||o.value.trim()!==""||b.value!==""),k=W(()=>{const te=_r.find(ke=>ke.value===b.value);return te?te.label:""}),M=W(()=>{if(!r.value||!o.value)return null;try{return new RegExp(o.value,"i"),null}catch(te){return te.message}}),j=24,K=W(()=>{if(X.value.length===0)return[];const te=[],ke=new Date,$e=3600*1e3;for(let Ze=j-1;Ze>=0;Ze--){const wt=new Date(ke.getTime()-(Ze+1)*$e),ut=new Date(ke.getTime()-Ze*$e);te.push({start:wt,end:ut,label:B(wt,ut),shortLabel:ut.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Ze of X.value){if(!Ze._time)continue;const wt=Ze._time.getTime();for(const ut of te)if(wt>=ut.start.getTime()&&wt<ut.end.getTime()){ut.total++,Ze.level==="ERROR"?ut.errors++:Ze.level==="WARNING"?ut.warnings++:ut.info++;break}}return te}),D=W(()=>{let te=1;for(const ke of K.value)ke.total>te&&(te=ke.total);return te}),O=W(()=>{if(K.value.length===0)return"";const te=X.value.map(Ze=>Ze._time&&Ze._time.getTime()).filter(Boolean);if(te.length===0)return"";const ke=new Date(Math.min(...te));return`${X.value.length} shown, oldest ${ke.toLocaleTimeString()}`}),L=W(()=>Math.ceil(j/8));function B(te,ke){const $e={hour:"2-digit",minute:"2-digit"};return te.toLocaleTimeString([],$e)+" - "+ke.toLocaleTimeString([],$e)}function Y(te,ke){return!ke||!te?"0px":Math.max(2,te/ke*100)+"%"}function Z(te){const ke=X.value.findIndex($e=>$e._time&&$e._time.getTime()>=te.start.getTime()&&$e._time.getTime()<te.end.getTime());if(ke>=0&&p.value){const $e=p.value.querySelector('[data-log-id="'+X.value[ke].id+'"]');$e&&($e.scrollIntoView({behavior:"smooth",block:"center"}),i.value=!1)}}const X=W(()=>{let te=t.value;if(l.value&&(te=te.filter(ke=>(ke.level||"INFO")===l.value)),b.value){const ke=_r.find($e=>$e.value===b.value);if(ke&&ke.seconds){const $e=new Date(Date.now()-ke.seconds*1e3);te=te.filter(Ze=>Ze._time&&Ze._time>=$e)}}if(o.value&&!M.value)if(r.value)try{const ke=new RegExp(o.value,"i");te=te.filter($e=>{const Ze=$e.searchText,wt=$e.tool||"";return ke.test(Ze)||ke.test(wt)})}catch{}else{const ke=o.value.toLowerCase();te=te.filter($e=>{const Ze=$e.searchText.toLowerCase(),wt=($e.tool||"").toLowerCase();return Ze.includes(ke)||wt.includes(ke)})}return te}),J=W(()=>Bk(X.value));function G(te){const ke=$k(te,++s);if(a.value){C.value.push(ke);return}ne(ke)}function ne(te){t.value.push(te),t.value.length>v&&(t.value=t.value.slice(-v)),i.value&&Rt(()=>xe())}function xe(te=!1){const ke=p.value;ke&&ke.scrollTo({top:ke.scrollHeight,behavior:te?"smooth":"instant"})}function Q(){i.value=!0,h.value=!1,Rt(()=>xe(!0))}const fe=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function V(){const te=p.value;if(!te)return;const ke=te.scrollHeight-te.scrollTop-te.clientHeight<40;h.value=!i.value&&!ke&&t.value.length>0,_.value&&ce()}function ce(){const te=p.value;!te||!i.value||te.scrollHeight-te.scrollTop-te.clientHeight>=40&&(i.value=!1,h.value=t.value.length>0)}function pe(){i.value&&requestAnimationFrame(ce)}function Oe(te){fe.has(te.key)&&pe()}const _=f(!1);function P(){i.value&&(_.value=!0,requestAnimationFrame(ce))}function H(){_.value&&(_.value=!1,ce())}function oe(){i.value&&(h.value=!1,Rt(()=>xe()))}function ae(){if(a.value=!a.value,!a.value&&C.value.length>0){for(const te of C.value)ne(te);C.value=[]}}function le(){t.value=[],C.value=[],h.value=!1}function he(){let te;e.value==="search"?te=Ne.value.map(wt=>{const ut=wt.error?"ERROR":"INFO",$n=wt.tool_name?`[${wt.tool_name}] `:"";return`${wt.timestamp||""} ${ut} ${$n}${wt.result_summary||wt.message||""}`}).join(`
`):te=X.value.map(rp).join(`

`);const ke=new Blob([te],{type:"text/plain"}),$e=URL.createObjectURL(ke),Ze=document.createElement("a");Ze.href=$e,Ze.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ze.click(),URL.revokeObjectURL($e)}function ue(te){const ke=rp(te);navigator.clipboard.writeText(ke).then(()=>{m.value=te.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function de(te){l.value=l.value===te?"":te,g.value="all"}function re(te){return te.level==="ERROR"?"log-line-error":te.level==="WARNING"?"log-line-warning":"text-gray-300"}function _e(te){return te==="ERROR"?"text-red-500 font-semibold":te==="WARNING"?"text-yellow-500":"text-blue-500"}function ve(te){return te==="ERROR"?"log-chip-error":te==="WARNING"?"log-chip-warning":"log-chip-info"}function we(te){g.value=te.id;const ke=te.filters;l.value=ke.level||"",b.value=ke.timeRange||"",o.value=ke.text||"",ke.levels&&(l.value=ke.levels[0]||""),ke.hasToolName&&(o.value="")}function Ie(te){g.value=te.id,l.value=te.filters.level||"",b.value=te.filters.timeRange||"",o.value=te.filters.text||""}function $(){if(!A.value.trim())return;const te={id:"custom-"+Date.now(),name:A.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};T.value=[...T.value,te],I(),S.value=!1,A.value=""}function ge(te){T.value=T.value.filter(ke=>ke.id!==te),I(),g.value===te&&(g.value="all")}const Se=f("all"),Le=f(""),Pe=f(""),dt=f(""),st=f(""),_t=f(""),Ot=f(100),rt=zk,Qe=f(!1),ie=f(!1),Te=f(""),Ne=f([]),Ke=f(null),Et=f(null);function Ve(){e.value="search",Ke.value||Ft()}async function Ft(){try{Ke.value=await z.get("/api/logs/stats")}catch{}}function Ht(){const te=_t.value;if(!te){dt.value="",st.value="";return}const $e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[te];if($e){const Ze=new Date(Date.now()-$e*1e3);dt.value=rs(Ze),st.value=""}}function rs(te){const ke=$e=>String($e).padStart(2,"0");return`${te.getFullYear()}-${ke(te.getMonth()+1)}-${ke(te.getDate())}T${ke(te.getHours())}:${ke(te.getMinutes())}`}function Zs(te){if(!te)return"";const ke=new Date(te);return isNaN(ke.getTime())?"":ke.toISOString()}async function ks(){Qe.value=!0,Te.value="",ie.value=!0,Et.value=null;try{const te=new URLSearchParams;Se.value&&Se.value!=="all"&&te.set("level",Se.value),Le.value&&te.set("tool",Le.value),Pe.value&&te.set("q",Pe.value);const ke=Zs(dt.value),$e=Zs(st.value);ke&&te.set("start",ke),$e&&te.set("end",$e),te.set("limit",String(Ot.value));const Ze=await z.get(`/api/logs/search?${te.toString()}`);Ne.value=Ze.entries||[]}catch(te){Te.value=te.message||"Search failed",Ne.value=[]}finally{Qe.value=!1}}function sa(){Se.value="all",Le.value="",Pe.value="",dt.value="",st.value="",_t.value="",Ot.value=100,Ne.value=[],ie.value=!1,Te.value="",Et.value=null}function Js(te){Et.value=Et.value===te?null:te}function Ls(te){if(!te.timestamp)return"";try{return new Date(te.timestamp).toLocaleString()}catch{return te.timestamp}}function Pn(te){return te.type==="web_action"?`${te.status||""} (${te.execution_time_ms||0}ms)`:(te.result_summary||"").slice(0,200)}function Ss(te){return te.error?"log-line-error":"text-gray-300"}function Fn(te){try{return JSON.stringify(te,null,2)}catch{return String(te)}}let zt=null,Xe=!1;function Ns(){Xe||(Xe=!0,Ye.subscribe("logs",G),c.value=Ye.connected,d.value=Ye.state||"disconnected",zt=Ye.onState(te=>{d.value=te,c.value=te==="connected"}))}function Ds(){Xe&&(Xe=!1,Ye.unsubscribe("logs",G),zt&&(zt(),zt=null))}return je(()=>{y(),window.addEventListener("pointerup",H),window.addEventListener("pointercancel",H)}),os(Ns),Yt(Ds),ht(()=>{Ds(),window.removeEventListener("pointerup",H),window.removeEventListener("pointercancel",H)}),{mode:e,logs:t,paused:a,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:n,groupedLogs:J,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:X,pauseBuffer:C,showJumpBottom:h,copiedIndex:m,regexError:M,levels:w,logPresets:R,timeRanges:x,timeRange:b,activeLogPreset:g,customLogPresets:T,showSaveLogPreset:S,newLogPresetName:A,hasActiveLogFilters:F,timeRangeLabel:k,timelineBuckets:K,timelineMax:D,timelineSpanLabel:O,timelineLabelSkip:L,togglePause:ae,clearLogs:le,exportLogs:he,logLineClass:re,levelClass:_e,levelChipClass:ve,toggleLevel:de,copyLine:ue,jumpToBottom:Q,onScroll:V,onUserScrollIntent:pe,onUserScrollKey:Oe,onAutoScrollToggle:oe,onPointerDown:P,applyLogPreset:we,applyCustomLogPreset:Ie,saveLogCustomPreset:$,removeLogCustomPreset:ge,segmentHeight:Y,jumpToTimelineBucket:Z,searchLevel:Se,searchTool:Le,searchKeyword:Pe,searchStart:dt,searchEnd:st,searchTimePreset:_t,searchLimit:Ot,searchLimits:rt,searching:Qe,searchRan:ie,searchError:Te,searchResults:Ne,searchStats:Ke,expandedSearch:Et,switchToSearch:Ve,runSearch:ks,clearSearchFilters:sa,toggleSearchExpand:Js,formatSearchTs:Ls,searchEntryText:Pn,searchLogLineClass:Ss,formatJson:Fn,applySearchTimePreset:Ht}}};function Dl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const Vk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function qk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Xa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","computer","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Gk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},wr=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),Kk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function cp(e){return Kk.some(t=>e===t||e.startsWith(`${t}.`))}const Xm="odin_config_center_expanded_v1",ev="odin_config_center_category_v1",Wk=50,Zk=650,kr=()=>z.get("/api/config/meta");function ca(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ui(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ma(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Jk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function Yk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function tv(e,t){if(Ui(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ca(t);const n={};for(const[a,i]of Object.entries(t)){const l=tv(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function Qk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=tv(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function sv(e,t,s,n){if(Ui(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)sv(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function Xk(){try{const e=JSON.parse(localStorage.getItem(Xm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function eS(){try{const e=localStorage.getItem(ev);return Xa.some(t=>t.key===e)?e:Xa[0].key}catch{return Xa[0].key}}const tS={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),n=f(null),a=f(!1),i=f(null),l=f(null),o=f(null),r=f(!1),c=f(!1),d=f(null),u=f(""),p=f("all"),h=f(eS()),m=f(Xk()),v=f({}),w=f({}),R=f(""),x=f({}),g=f({}),b=f([]),T=f([]),S=f(!1),A=f(!1),C=f(!1);let y=null,I=null,F={path:null,at:0},k=0;const M=W(()=>{var E;return(((E=t.value)==null?void 0:E.fields)||[]).filter(U=>!wr.has(U.path.split(".")[0])&&!cp(U.path))}),j=W(()=>new Map(M.value.map(E=>[E.path,E]))),K=W(()=>Y.value.reduce((E,U)=>E+U.sections.length,0)),D=W(()=>M.value.length),O=W(()=>Vk),L=W(()=>b.value.length>0),B=W(()=>T.value.length>0),Y=W(()=>{if(!e.value)return[];const E=new Set(Xa.flatMap(Ae=>Ae.sections)),U=Xa.map(Ae=>({...Ae,sections:Ae.sections.filter(ct=>Object.hasOwn(e.value,ct)&&!wr.has(ct))})).filter(Ae=>Ae.sections.length),ee=Object.keys(e.value).filter(Ae=>!E.has(Ae)&&!wr.has(Ae));return ee.length&&U.push({key:"other",label:"Other",icon:"folder",sections:ee}),U}),Z=W(()=>e.value?{...e.value,...v.value}:null),X=W(()=>{if(!e.value)return[];const E=[];for(const[U,ee]of Object.entries(v.value))sv(e.value[U],ee,U,E);return E.filter(U=>!Ui(U.oldVal,U.newVal)).map(U=>{const ee=P(U.path);return{...U,label:(ee==null?void 0:ee.label)||Ma(U.path.split(".").at(-1)),apply_mode:(ee==null?void 0:ee.apply_mode)||de(U.path.split(".")[0])}})}),J=W(()=>X.value.length>0),G=W(()=>X.value.length),ne=W(()=>new Set(X.value.map(E=>E.path.split(".")[0])).size),xe=W(()=>!!u.value||p.value!=="all"),Q=W(()=>{const E={...g.value};for(const U of X.value){const ee=P(U.path),Ae=mi(ee,U.newVal);Ae&&(E[U.path]=Ae)}return E}),fe=W(()=>Object.keys(Q.value).length>0),V=W(()=>e.value?(xe.value?Y.value:Y.value.filter(U=>U.key===h.value)).map(U=>({...U,sections:U.sections.filter(ee=>Qe(ee))})).filter(U=>U.sections.length):[]),ce=W(()=>{const E=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],U=new Map(E.map(ee=>[ee,[]]));for(const ee of X.value){const Ae=U.has(ee.apply_mode)?ee.apply_mode:"restart";U.get(Ae).push(ee)}return E.filter(ee=>U.get(ee).length).map(ee=>({key:ee,label:Qt(ee),entries:U.get(ee)}))}),pe=W(()=>X.value.filter(E=>E.apply_mode==="restart").length),Oe=W(()=>M.value.filter(E=>E.pending_restart)),_=W(()=>Oe.value.length);function P(E){const U=j.value.get(E);return U?{...U,apply_details:Dl([U])}:null}function H(E){const U=`${E}.`;return M.value.filter(ee=>ee.path===E||ee.path.startsWith(U))}function oe(){return M.value.some(E=>E.path==="tools.hosts"||E.path.startsWith("tools.hosts."))}function ae(){var ee,Ae;const E=((Ae=(ee=e.value)==null?void 0:ee.tools)==null?void 0:Ae.hosts)||{},U=Object.keys(E).length;return`${U} host${U===1?"":"s"} configured.`}function le(E){return H(E).length}function he(E){return Ma(E)}function ue(E){const U=H(E);if(!U.length)return`${Ma(E)} configuration.`;const ee=U.find(Ts=>Ts.sensitivity==="public"&&Ts.description)||U.find(Ts=>Ts.description),Ae=(ee==null?void 0:ee.description)||"";return Ae.match(/setting for (.+)\.$/i)?`${Ma(E)} settings and runtime behaviour.`:Ae}function de(E){const U=[...new Set(H(E).map(ee=>ee.apply_mode))];return U.length===1?U[0]:U.includes("restart")?"restart":U.includes("activation_required")?"activation_required":U[0]||"restart"}function re(E){const U=[...new Set(H(E).map(ee=>Qt(ee.apply_mode)))];return U.length?U.length===1?U[0]:`Mixed apply behaviour: ${U.join(" · ")}`:""}function _e(E){return Dl(H(E))}function ve(E){var U;return Object.hasOwn(v.value,E)?v.value[E]:(U=e.value)==null?void 0:U[E]}function we(){const E=ve("mcp")||{},U=Object.keys(E.servers||{}).length;return`${E.enabled?"Globally enabled":"Globally disabled"} · ${U} configured server${U===1?"":"s"}.`}function Ie(E,U){return U.split(".").reduce((ee,Ae)=>ee==null?void 0:ee[Ae],E)}function $(E){const U=Z.value;return H(E).filter(ee=>cp(ee.path)?!1:ee.path.split(".").length<=2?!0:!ee.path.includes(".*")).map(ee=>({...ee,key:ee.path.split(".").at(-1),value:Ie(U,ee.path),apply_details:Dl([ee]),editor:ee.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ge(E){const U=E.path.split(".");return U.length>2?U.slice(0,2).join("."):null}function Se(E){const U=new Map;for(const ee of $(E)){const Ae=ge(ee),ct=Ae||`${E}.__root`;U.has(ct)||U.set(ct,{key:ct,path:Ae,entries:[]}),U.get(ct).entries.push(ee)}return[...U.values()].map(ee=>{const Ae=ee.entries.find(ct=>ct.group_description);return{...ee,label:ee.path?Ma(ee.path.split(".").at(-1)):null,description:(Ae==null?void 0:Ae.group_description)||null,apply_details:Dl(ee.entries),runtime_summaries:Pe(ee.entries)}})}function Le(E){return{save:E.save_effect||(E.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:E.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[E.apply_mode]||"Effective runtime state is not currently observable."}}function Pe(E){const U=new Map;for(const ee of E){const Ae=Le(ee),ct=`${ee.apply_mode}|${Ae.save}|${Ae.runtime}`;U.has(ct)||U.set(ct,{key:ct,label:Qt(ee.apply_mode),save:Ae.save,runtime:Ae.runtime})}return[...U.values()]}function dt(E){if(st(E))return E.runtime_effect||E.activation_policy||"";if(E.apply_mode==="activation_required"){const U=E.activation_policy||E.runtime_effect;return U?`Not active after saving. No activation control exists in this release. ${U}`:"Not active after saving; no activation control exists in this release."}return""}function st(E){return E.action_available===!0&&!!(E.action_label&&E.action_endpoint)}async function _t(E){if(st(E))try{if(Et(E.path))throw new Error("Save this setting before applying its action.");const U=String(E.action_method||"POST").toLowerCase(),ee={post:z.post.bind(z),put:z.put.bind(z),delete:z.del.bind(z)}[U];if(!ee)throw new Error("Unsupported configuration action");await ee(E.action_endpoint,E.action_body||void 0),await De(),Xt("success",`${E.action_label} completed.`)}catch(U){Xt("error",U.message||`${E.action_label} failed`)}}function Ot(E,U){return[E.label,E.path,E.description,...E.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(U)}function rt(E){const U=u.value.trim().toLowerCase();return U?H(E).filter(ee=>Ot(ee,U)):[]}function Qe(E){const U=H(E);if(p.value!=="all"&&!U.some(Ae=>Ae.apply_state===p.value))return!1;const ee=u.value.trim().toLowerCase();return!ee||`${he(E)} ${E}`.toLowerCase().includes(ee)?!0:U.some(Ae=>Ot(Ae,ee))}function ie(E,U){return H(E).filter(ee=>ee.apply_state===U).length}function Te(E){return E==="all"?D.value:M.value.filter(U=>U.apply_state===E).length}function Ne(E){const U=E.sections.flatMap(ee=>H(ee));return{fields:U.length,modified:X.value.filter(ee=>E.sections.includes(ee.path.split(".")[0])).length,pending_restart:U.filter(ee=>ee.apply_state==="pending_restart").length,invalid:U.filter(ee=>ee.apply_state==="invalid").length,dormant:U.filter(ee=>ee.apply_state==="dormant").length}}function Ke(E){var U;return Object.hasOwn(v.value,E)&&!Ui((U=e.value)==null?void 0:U[E],v.value[E])}function Et(E){return X.value.some(U=>U.path===E||U.path.startsWith(`${E}.`))}function Ve(E){h.value=E,u.value="",p.value="all";try{localStorage.setItem(ev,E)}catch{}}function Ft(E){p.value=E}function Ht(){u.value="",p.value="all"}function rs(E){var U;return((U=Y.value.find(ee=>ee.sections.includes(E)))==null?void 0:U.sections)||[]}function Zs(E){const U=rs(E),ee=U.find(Ae=>m.value[Ae]===!0);return ee||U.find(Ae=>m.value[Ae]!==!1)||null}function ks(E){return u.value&&!C.value&&Qe(E)?!0:C.value?Zs(E)===E:Object.hasOwn(m.value,E)?m.value[E]===!0:!0}function sa(E){const U=!ks(E);if(C.value){const ee={...m.value};for(const Ae of rs(E))ee[Ae]===!0&&(ee[Ae]=!1);ee[E]=U,m.value=ee;return}m.value={...m.value,[E]:U}}function Js(){b.value.push(ca(v.value)),b.value.length>Wk&&b.value.shift(),T.value=[]}function Ls(){J.value&&(Js(),v.value={},g.value={},S.value=!1)}function Pn(E,U=!1){const ee=Date.now();if(U&&F.path===E&&ee-F.at<Zk){F.at=ee;return}Js(),F={path:E,at:ee}}function Ss(E,U,ee){if(!U.length)return ee;const Ae=ca(E??{});let ct=Ae;for(let Ts=0;Ts<U.length-1;Ts+=1){const pn=U[Ts];ct[pn]=ca(ct[pn]??{}),ct=ct[pn]}return ct[U.at(-1)]=ee,Ae}function Fn(E){var U;return Object.hasOwn(v.value,E)?v.value[E]:ca((U=e.value)==null?void 0:U[E])}function zt(E,U,ee={}){var Ad;const[Ae,...ct]=E.path.split(".");Pn(E.path,!!ee.coalesce);const Ts=Fn(Ae),pn=ct.length?Ss(Ts,ct,U):U,aa={...v.value};if(Ui(pn,(Ad=e.value)==null?void 0:Ad[Ae])?delete aa[Ae]:aa[Ae]=pn,v.value=aa,g.value[E.path]){const Rd={...g.value};delete Rd[E.path],g.value=Rd}}function Xe(E){F={path:null,at:0},w.value={...w.value,[E]:String(Ie(Z.value,E)??"")}}function Ns(E){if(F={path:null,at:0},!Object.hasOwn(w.value,E))return;const U={...w.value};delete U[E],w.value=U}function Ds(E){const U=w.value[E.path];if(F={path:null,at:0},U===""){g.value={...g.value,[E.path]:"Enter a number."};return}const ee=Number(U);if(Number.isNaN(ee)||E.type==="integer"&&!Number.isInteger(ee)){g.value={...g.value,[E.path]:E.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ae={...w.value};delete Ae[E.path],w.value=Ae,zt(E,ee,{coalesce:!0})}function te(E){return Object.hasOwn(w.value,E.path)?w.value[E.path]:E.value??""}function ke(E,U){if(w.value={...w.value,[E.path]:U},U===""){g.value={...g.value,[E.path]:"Enter a number."};return}const ee=Number(U);if(!Number.isFinite(ee)||E.type==="integer"&&!Number.isInteger(ee)){g.value={...g.value,[E.path]:E.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[E.path]){const Ae={...g.value};delete Ae[E.path],g.value=Ae}zt(E,ee,{coalesce:!0})}function $e(E){const U=Number.parseInt(R.value,10);if(!Number.isInteger(U)||U<1){g.value={...g.value,[E.path]:"Warning thresholds must be positive whole numbers."};return}const ee=[...new Set([...E.value||[],U])].sort((Ae,ct)=>ct-Ae);R.value="",zt(E,ee)}function Ze(E,U){zt(E,(E.value||[]).filter(ee=>ee!==U))}function wt(E){return E.apply_mode==="live_read"?"Odin reads the saved file value on next use.":E.apply_mode==="live_for_new_work"?"New work uses the saved file value.":E.apply_mode==="live_apply"?E.apply_handler?`Apply the saved value through ${E.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":E.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":E.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":E.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ut(E){return E.type==="array"&&Array.isArray(E.value)&&!E.structured_container&&!E.structured_container_child&&E.sensitivity==="public"&&E.value.every(U=>["string","number","boolean"].includes(typeof U))}function $n(E){const U=String(x.value[E.path]??"").trim();if(!U)return;const ee=[...new Set([...E.value||[],U])];x.value={...x.value,[E.path]:""},zt(E,ee)}function js(E,U){zt(E,(E.value||[]).filter(ee=>ee!==U))}function mi(E,U){var Ae;if(!E)return null;if((Ae=E.enum)!=null&&Ae.length&&!E.enum.includes(U))return`Choose one of: ${E.enum.join(", ")}`;if(E.path==="agents.final_warning_iterations"&&(!Array.isArray(U)||!U.length))return"Add at least one warning threshold.";const ee=E.constraints||{};if((E.type==="integer"||E.type==="number")&&typeof U=="number"){if(ee.minimum!==void 0&&U<ee.minimum)return`Must be at least ${ee.minimum}${E.unit?` ${E.unit}`:""}`;if(ee.maximum!==void 0&&U>ee.maximum)return`Must be at most ${ee.maximum}${E.unit?` ${E.unit}`:""}`}return null}function vi(E){return Q.value[E.path]||null}function Ia(E){const U=`${E}.`;return Object.keys(Q.value).some(ee=>ee===E||ee.startsWith(U))}function na(){b.value.length&&(T.value.push(ca(v.value)),v.value=b.value.pop(),g.value={},w.value={},F={path:null,at:0})}function Bn(){T.value.length&&(b.value.push(ca(v.value)),v.value=T.value.pop(),g.value={},w.value={},F={path:null,at:0})}function Un(){!J.value||fe.value||(S.value=!0,A.value=!1)}function Ys(){S.value=!1}function dn(){Ls()}function Qt(E){return Gk[E]||Ma(E||"unknown")}function Oa(E){return`apply-${String(E||"unknown").replaceAll("_","-")}`}function q(E){return`cfgc-field-${E.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function be(E){return`${q(E)}-input`}function Re(E){const U=document.getElementById(q(E))||document.getElementById(q(E.split(".").slice(0,2).join(".")));U==null||U.scrollIntoView({behavior:"smooth",block:"center"})}function Xt(E,U){l.value={type:E,message:U},window.setTimeout(()=>{var ee;((ee=l.value)==null?void 0:ee.message)===U&&(l.value=null)},3500)}function un(){r.value=!1,p.value="pending_restart",u.value="";const E=qk(n.value);E&&(E.scrollTop=0)}function Hn(){r.value=!1}function Ce(E=1800){I&&window.clearTimeout(I),I=window.setTimeout(N,E)}async function N(){if(c.value){if(k+=1,k>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await kr(),_.value===0){c.value=!1,d.value=null,Xt("success","Odin restarted and the saved startup settings are active.");return}}catch{}Ce(2e3)}}async function se(){if(!c.value){d.value=null;try{await z.post("/api/restart",{}),c.value=!0,k=0,r.value=!1,Ce()}catch(E){d.value=E.message||"Odin could not schedule a restart."}}}async function me(){if(!(!J.value||fe.value||a.value)){a.value=!0;try{const E=Qk(e.value,v.value),U=await z.put("/api/config",E);e.value=U,v.value={},b.value=[],T.value=[],g.value={},S.value=!1;try{t.value=await kr(),o.value=null,r.value=_.value>0,Xt("success",_.value?`Configuration saved. ${_.value} setting${_.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(ee){o.value=ee.message||"Unknown metadata error.",Xt("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(E){Xt("error",E.message||"Configuration could not be saved")}finally{a.value=!1}}}async function De(){var E,U;if(!J.value){s.value=!0,i.value=null;try{const ee=await z.get("/api/config"),Ae=await kr();e.value=ee,t.value=Ae,o.value=null;const ct=Y.value;if(ct.some(Ts=>Ts.key===h.value)||(h.value=((E=ct[0])==null?void 0:E.key)||Xa[0].key),C.value){const pn=(((U=ct.find(aa=>aa.key===h.value))==null?void 0:U.sections)||[]).find(aa=>m.value[aa]===!0);m.value=pn?{...m.value,[pn]:!0}:{}}}catch(ee){i.value=ee.message||"Unknown configuration error"}finally{s.value=!1}}}function Fe(E){if(S.value||!(E.ctrlKey||E.metaKey))return;const U=E.target;U instanceof HTMLElement&&(U.matches("input, textarea, select")||U.isContentEditable)||(!E.shiftKey&&E.key.toLowerCase()==="z"?(E.preventDefault(),na()):(E.key.toLowerCase()==="y"||E.shiftKey&&E.key.toLowerCase()==="z")&&(E.preventDefault(),Bn()))}function Ue(E){C.value=E.matches}Mt(m,E=>{try{localStorage.setItem(Xm,JSON.stringify(E))}catch{}},{deep:!0});let yt=!1;function it(){yt||(yt=!0,document.addEventListener("keydown",Fe))}function vt(){yt&&(yt=!1,document.removeEventListener("keydown",Fe))}return je(()=>{var E;De(),it(),y=window.matchMedia("(max-width: 760px)"),Ue(y),(E=y.addEventListener)==null||E.call(y,"change",Ue)}),os(it),Yt(vt),ht(()=>{var E;vt(),(E=y==null?void 0:y.removeEventListener)==null||E.call(y,"change",Ue),I&&window.clearTimeout(I)}),{armKeydown:it,disarmKeydown:vt,handleKeydown:Fe,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:h,reviewOpen:S,mobileOverflowOpen:A,warningThresholdInput:R,arrayInputs:x,healthFilters:O,visibleCategories:Y,displayGroups:V,reviewGroups:ce,sectionCount:K,fieldCount:D,hasChanges:J,changeCount:G,changedSectionCount:ne,hasDraftErrors:fe,canUndo:L,canRedo:B,globalFilterActive:xe,reviewRestartCount:pe,pendingRestartCount:_,pendingRestartFields:Oe,healthCount:Te,categoryStats:Ne,selectCategory:Ve,selectHealthFilter:Ft,clearFilters:Ht,sectionLabel:he,sectionDescription:ue,sectionFieldCount:le,sectionHealthCount:ie,sectionApplySummary:re,sectionApplyDetails:_e,sectionEntries:$,fieldGroups:Se,sectionSearchHits:rt,mcpConfigSummary:we,fieldRuntimeCopy:Le,fieldSpecificRuntimeNote:dt,hasHonestAction:st,runFieldAction:_t,hasHostsCollection:oe,hostsConfigSummary:ae,sectionChanged:Ke,fieldChanged:Et,isSectionExpanded:ks,toggleSection:sa,discardAllDrafts:Ls,setFieldValue:zt,setNumberFieldValue:ke,numberInputValue:te,beginInputEdit:Xe,endTextInputEdit:Ns,endInputEdit:Ds,addWarningThreshold:$e,removeWarningThreshold:Ze,isScalarArray:ut,addScalarArrayItem:$n,removeScalarArrayItem:js,fieldError:vi,sectionHasErrors:Ia,undo:na,redo:Bn,openReview:Un,closeReview:Ys,mobileCancel:dn,applyModeLabel:Qt,applyClass:Oa,compactValue:Jk,formatValue:Yk,structuredApplyCopy:wt,fieldId:q,fieldInputId:be,focusField:Re,fetchConfig:De,saveConfig:me,restartOdin:se,restartLater:Hn,reviewPendingRestart:un}}},sS=/^\d{15,25}$/;function nv(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const av={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(){const e=f([]),t=f(!0),s=f(null),n=f({}),a=f(null),i=f(null),l=f(!1),o=f(null),r=f({}),c=f([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=W(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),h=W(()=>new Map(c.value.map(D=>[String(D.id),D])));function m(D){return D.config&&D.config.enabled!==void 0?D.config.enabled:!0}function v(D){return dp(D,"require_mention",a.value)}function w(D){return dp(D,"respond_to_bots",a.value)}function R(D){return D.config&&Object.keys(D.config).length>0}function x(D){n.value[D]=!n.value[D]}function g(D){const O=D.discord||{};return{allowed_users:[...O.allowed_users||[]],channels:[...O.channels||[]],respond_to_bots:!!O.respond_to_bots,require_mention:!!O.require_mention,ignore_bot_ids:[...O.ignore_bot_ids||[]]}}async function b({showLoading:D=!0}={}){const O=++d;D&&(t.value=!0),s.value=null;try{const L=await z.get("/api/discord/guilds");O===d&&(e.value=L)}catch(L){O===d&&(s.value=L.message)}finally{D&&O===d&&(t.value=!1)}}async function T(){t.value=!0,s.value=null;try{const[D,O,L]=await Promise.all([z.get("/api/discord/guilds"),z.get("/api/discord/members").catch(()=>[]),z.get("/api/config")]),B=g(L),Y=p.value;a.value=B,Y||(i.value=JSON.parse(JSON.stringify(B))),c.value=O,e.value=D,o.value=null}catch(D){s.value=D.message}finally{t.value=!1}}let S=Promise.resolve();const A=f(new Set);function C(D,O){const L=new Set(A.value);L.add(D),A.value=L;const B=S.then(O);return S=B.catch(()=>{}),B.finally(()=>{const Y=new Set(A.value);Y.delete(D),A.value=Y})}function y(D,O,L,B){const Y=(B==null?void 0:B.target)??null;return C(`guild:${D}:${O}`,async()=>{try{await z.put("/api/discord/guild/"+D+"/config",{[O]:L}),await b({showLoading:!1})}catch(Z){s.value=Z.message,Y&&typeof L=="boolean"&&(Y.checked=!L)}})}function I(D,O,L,B,Y){const Z=(Y==null?void 0:Y.target)??null;return C(`channel:${D}:${L}`,async()=>{try{await z.put("/api/discord/channel/"+D+"/config",{[L]:B}),await b({showLoading:!1})}catch(X){s.value=X.message,Z&&typeof B=="boolean"&&(Z.checked=!B)}})}function F(D,O){return C(`channel:${D}:clear`,async()=>{try{await z.put("/api/discord/channel/"+D+"/config",{clear:!0}),await b({showLoading:!1})}catch(L){s.value=L.message}})}function k(D,O){const L=String(O);if(!D.userAutocomplete)return L;const B=h.value.get(L);return B?nv(B):L}function M(D,O=null){const L=String(O??r.value[D]??"").trim();!L||i.value[D].includes(L)||(i.value[D]=[...i.value[D],L],r.value={...r.value,[D]:""})}function j(D,O){i.value[D]=i.value[D].filter(L=>L!==O)}async function K(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const O=(await z.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...O.allowed_users||[]],channels:[...O.channels||[]],respond_to_bots:!!O.respond_to_bots,require_mention:!!O.require_mention,ignore_bot_ids:[...O.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(D){o.value=D.message||"Global defaults could not be saved."}finally{l.value=!1}}}return je(T),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:w,hasOverride:R,toggleGuild:x,fetchAll:T,fetchGuilds:b,setGuildConfig:y,setChannelConfig:I,clearOverride:F,mutationPending:A,globalItemLabel:k,addGlobalItem:M,removeGlobalItem:j,saveGlobalDefaults:K}}},Cs=e=>e==null?e:JSON.parse(JSON.stringify(e));function aS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let h=null;const m=new Map;function v(S){d+=1;const A=c.then(S,S);return c=A.catch(()=>{}),A}function w(S,A){h=Cs(S),m.clear();for(const[C,y]of Object.entries(A||{}))m.set(C,Cs(y))}function R(S){const A=Cs(S),C=++u;return v(async()=>{try{await e(Cs(A)),h=Cs(A),C===u&&n(Cs(A))}catch(y){C===u&&(a(Cs(h)),r(y,{kind:"default"}))}})}function x(S,A){const C=Cs(A),y=(p.get(S)||0)+1;return p.set(S,y),v(async()=>{try{await t(S,Cs(C)),m.set(S,Cs(C)),y===p.get(S)&&i(S,Cs(C))}catch(I){y===p.get(S)&&(l(S,Cs(m.get(S)??null)),r(I,{kind:"user",uid:S}))}})}function g(S){const A=(p.get(S)||0)+1;return p.set(S,A),v(async()=>{try{await s(S),m.delete(S),A===p.get(S)&&o(S)}catch(C){A===p.get(S)&&(l(S,Cs(m.get(S)??null)),r(C,{kind:"delete",uid:S}))}})}async function b(){for(;;){const S=c;if(await S,S===c)return d}}async function T(S){for(;;){const A=await b(),C=await S();if(A===d)return C}}return{seed:w,saveDefault:R,saveUser:x,deleteUser:g,whenIdle:b,readSnapshot:T,get revision(){return d}}}const iS={components:{DiscordUserCombobox:av},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=W(()=>{const k={};for(const M of r.value)k[M.id]=M;return k});function d(k){return c.value[k]||null}function u(k,M){return k?k.allowed_hosts===null||k.allowed_hosts===void 0?{allowed_hosts:[...M],default_host:k.default_host||"",allow_all:!0}:{allowed_hosts:k.allowed_hosts,default_host:k.default_host||"",allow_all:!1}:{allowed_hosts:[...M],default_host:M[0]||"",allow_all:!0}}const p=aS({applyDefault:async k=>{const M=k.allow_all?null:k.allowed_hosts;await z.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:k.default_host})},applyUser:async(k,M)=>{const j=M.allow_all?null:M.allowed_hosts;await z.put(`/api/host-access/user/${k}`,{allowed_hosts:j,default_host:M.default_host})},applyDelete:k=>z.del(`/api/host-access/user/${k}`),onDefaultConfirmed:()=>ye.success("Default policy updated"),onDefaultRollback:k=>{k&&(i.value=k)},onUserConfirmed:k=>{const M=d(k);ye.success(`Updated access for ${M?M.display_name:k}`)},onUserRollback:(k,M)=>{const j={...l.value};M?j[k]=M:delete j[k],l.value=j},onUserDeleted:k=>{const M={...l.value};delete M[k],l.value=M},onError:(k,M)=>{var K;const j=M.uid?` ${((K=d(M.uid))==null?void 0:K.display_name)||M.uid}`:"";ye.error(`${k.message||"Failed to save"} — reverted${j}`)}});let h=0;async function m(){const k=++h;e.value=!0,t.value="";try{const M=await p.readSnapshot(()=>z.get("/api/host-access"));if(k!==h)return;s.value=M,n.value=M.available_hosts||[],a.value=M.host_descriptions||{},i.value=u(M.default_policy,n.value);const j=M.users||{},K={};for(const[D,O]of Object.entries(j))K[D]=u(O,n.value);l.value=K,p.seed(i.value,K)}catch(M){k===h&&(t.value=M.message||"Failed to fetch host access data")}finally{k===h&&(e.value=!1)}try{const M=await z.get("/api/discord/members")||[];k===h&&(r.value=M)}catch{k===h&&(r.value=[])}}const v=500,w=new Map;function R(k,M){const j=w.get(k);j&&clearTimeout(j.timer);const K={run:M,timer:null};K.timer=setTimeout(()=>{w.delete(k),M()},v),w.set(k,K)}function x(k){const M=w.get(k);M&&(clearTimeout(M.timer),w.delete(k))}function g(){for(const[k,M]of[...w])clearTimeout(M.timer),w.delete(k),M.run()}function b(){R("default",()=>p.saveDefault(i.value))}function T(k,M){i.value.allow_all=!1,M?i.value.allowed_hosts.includes(k)||i.value.allowed_hosts.push(k):(i.value.allowed_hosts=i.value.allowed_hosts.filter(j=>j!==k),i.value.default_host===k&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function S(k){R(`user:${k}`,()=>{const M=l.value[k];M&&p.saveUser(k,M)})}function A(k,M,j){const K=l.value[k];K&&(K.allow_all=!1,j?K.allowed_hosts.includes(M)||K.allowed_hosts.push(M):(K.allowed_hosts=K.allowed_hosts.filter(D=>D!==M),K.default_host===M&&(K.default_host=K.allowed_hosts[0]||"")),S(k))}function C(k,M){const j=l.value[k];j&&(j.default_host=M,S(k))}function y(){o.value=!0}function I(k){!/^\d{15,25}$/.test(k)||l.value[k]||(l.value[k]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},p.saveUser(k,l.value[k]),o.value=!1)}async function F(k){const M=d(k);await qt({title:"Remove user override",message:`Remove the host access override for ${M?M.display_name:k}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(x(`user:${k}`),await p.deleteUser(k),l.value[k]||ye.success(`Removed override for ${M?M.display_name:k}`))}return je(m),Yt(g),ht(g),{loading:e,error:t,data:s,availableHosts:n,hostDescriptions:a,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:b,toggleDefaultHost:T,getMember:d,toggleUserHost:A,setUserDefault:C,openAddUser:y,addUserById:I,deleteUser:F,flushPendingSaves:g}}},lS={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=f([]),t=f(!1),s=f(""),n=f([]),a=f(!1),i=f(!1),l=f(1),o=f(""),r=f(!1),c=f(null),d=f(""),u=f([]),p=f(!1),h=f(null),m=f(""),v=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),w=f(v()),R=W(()=>["127.0.0.1","localhost","::1"].includes(w.value.address));async function x(){t.value=!0,s.value="";try{const K=await z.get("/api/hosts");e.value=K.hosts||[],o.value=K.default_host||"",r.value=!!K.tofu_enabled}catch(K){s.value=K.message}finally{t.value=!1}}async function g(){try{await z.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),ye.success("Host settings saved and published live"),await x()}catch(K){ye.error(K.message)}}function b(){d.value="",u.value=[],p.value=!1,h.value=null,c.value=null,m.value="",l.value=1,a.value=!0}function T(){i.value=!1,w.value=v(),b()}function S(K){i.value=!0,w.value={...v(),...K},b()}async function A(){try{c.value=await z.get("/api/hosts/public-key")}catch(K){ye.error(K.message)}}async function C(K){try{const D=await z.post("/api/hosts/"+encodeURIComponent(K.alias)+"/import-legacy",{});i.value=!0,w.value={...v(),...K,trust_mode:"pinned"},b(),d.value=D.candidate_token,u.value=D.fingerprints||[],m.value=u.value.join(`
`),l.value=4,ye.info("Imported existing known_hosts trust. Test before activation.")}catch(D){ye.error(D.message)}}async function y(){try{const K=m.value.split(/\s+/).filter(Boolean),D={...w.value,expected_fingerprints:K,candidate_fingerprints:u.value},O=await z.post("/api/hosts/candidates",D);if(d.value=O.candidate_token,u.value=O.fingerprints||[],w.value.trust_mode==="tofu"&&D.candidate_fingerprints.length===0){w.value.confirm_tofu=!1,ye.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(K){ye.error(K.message)}}async function I(){var K,D;p.value=!1,h.value=null;try{const O=await z.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!O.tested,h.value=O.last_test,p.value&&(l.value=5)}catch(O){const L=(K=O.data)==null?void 0:K.last_test;L&&typeof L=="object"&&!Array.isArray(L)&&(h.value=L);const B=(D=h.value)==null?void 0:D.detail;ye.error(typeof B=="string"&&B.trim()?B:O.message)}}async function F(){try{await z.post("/api/hosts/candidates/"+d.value+"/commit",{}),ye.success("Host saved and published live"),a.value=!1,await x()}catch(K){ye.error(K.message)}}async function k(K){try{await z.post("/api/hosts/"+encodeURIComponent(K.alias)+"/enabled",{enabled:!K.enabled}),await x()}catch(D){ye.error(D.message)}}async function M(K){var D;if(await qt("Delete host "+K.alias+"? Dependencies will block deletion.")){n.value=[];try{await z.del("/api/hosts/"+encodeURIComponent(K.alias)),await x()}catch(O){n.value=Array.isArray((D=O.data)==null?void 0:D.pending_references)?O.data.pending_references:[],ye.error(O.message)}}}async function j(K){if(await qt("Force revoke "+K.alias+"? Remote outcomes may be unknown."))try{await z.post("/api/hosts/"+encodeURIComponent(K.alias)+"/force-revoke",{}),await x()}catch(D){ye.error(D.message)}}return je(x),{hosts:e,loading:t,error:s,pendingReferences:n,wizard:a,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:w,isLocal:R,keyInfo:c,candidate:d,observed:u,tested:p,testResult:h,fingerprintsText:m,load:x,saveSettings:g,beginAdd:T,beginEdit:S,loadKey:A,importLegacy:C,prepare:y,testConnection:I,commit:F,toggle:k,remove:M,forceRevoke:j}}},oS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=W(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=W(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function h(C){return C==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":C==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const C=await z.get("/api/tokens");s.value=C.tokens||[],n.value=C.available_hosts||[]}catch(C){t.value=C.message||"Failed to load tokens"}finally{e.value=!1}}function v(C){return!C||!C.trim()?[]:C.split(",").map(y=>y.trim()).filter(Boolean)}function w(C,y){const I=c.value.allowed_hosts;if(y&&!I.includes(C)&&I.push(C),!y){const F=I.indexOf(C);F>=0&&I.splice(F,1)}}function R(C,y){const I=d.value.allowed_hosts;if(y&&!I.includes(C)&&I.push(C),!y){const F=I.indexOf(C);F>=0&&I.splice(F,1)}}async function x(){var C;i.value=!0;try{const y=v(c.value.allowed_tools_str),I=c.value.host_mode,F=I==="none"?[]:I==="select"?c.value.allowed_hosts:null,k={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:y.length?y:[]};F!==null&&(k.allowed_hosts=F),k.default_host=c.value.default_host||"";const M=await z.post("/api/tokens",k);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ye.success("Token created"),await m()}catch(y){ye.error(((C=y.data)==null?void 0:C.error)||y.message||"Failed to create token")}finally{i.value=!1}}function g(C){o.value=C;const y=C.allowed_hosts;let I="default";y==null?I="default":Array.isArray(y)&&y.length===0?I="none":Array.isArray(y)&&(I="select"),d.value={username:C.username||"",tier:C.tier||"admin",label:C.label||"",host_mode:I,allowed_hosts:Array.isArray(y)?[...y]:[],default_host:C.default_host||"",allowed_tools_str:(C.allowed_tools||[]).join(", ")}}async function b(){var C;if(o.value){r.value=!0;try{const y=v(d.value.allowed_tools_str),I=d.value.host_mode,F={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:y};I==="none"?F.allowed_hosts=[]:I==="select"?F.allowed_hosts=d.value.allowed_hosts:F.allowed_hosts=null,F.default_host=d.value.default_host||"",await z.put("/api/tokens/"+encodeURIComponent(o.value.user_id),F),o.value=null,ye.success("Token updated"),await m()}catch(y){ye.error(((C=y.data)==null?void 0:C.error)||y.message||"Failed to update")}finally{r.value=!1}}}async function T(C){var I;if(await qt({title:"Regenerate token",message:`Regenerate token for ${C.username||C.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const F=await z.post("/api/tokens/"+encodeURIComponent(C.user_id)+"/regenerate");l.value=F.token,ye.success("Token regenerated")}catch(F){ye.error(((I=F.data)==null?void 0:I.error)||F.message||"Failed to regenerate")}}async function S(C){var I;if(await qt({title:"Delete token",message:`Delete token for ${C.username||C.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/tokens/"+encodeURIComponent(C.user_id)),ye.success("Token deleted"),await m()}catch(F){ye.error(((I=F.data)==null?void 0:I.error)||F.message||"Failed to delete")}}async function A(){if(l.value)try{await navigator.clipboard.writeText(l.value),ye.success("Copied to clipboard")}catch{ye.error("Copy failed — select and copy manually")}}return je(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:h,toggleCreateHost:w,toggleEditHost:R,createToken:x,startEdit:g,saveEdit:b,confirmRegenerate:T,confirmDelete:S,copyToken:A}}},rS=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),cS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),dS=Object.freeze(["enabled","base_url","model","max_tokens"]),uS=Object.freeze(["enabled","model","max_tokens"]);function Qo(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function up(e){return Qo(e,rS)}function pp(e){return Qo(e,cS)}function pS(e,{includeApiKey:t=!1}={}){const s=Qo(e,dS);return t&&(s.api_key=e.api_key),s}function fS(e){return{timeout:e.timeout}}function hS(e,{includeApiKey:t=!1}={}){const s=Qo(e,uS);return t&&(s.api_key=e.api_key),s}function mS(e){return{timeout:e.timeout}}function Ml(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const vS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f("codex"),a=f({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],l=W(()=>{const q=a.value.model;return q&&!i.includes(q)?[q,...i]:i}),o=W(()=>{const q=a.value.agent_model;return q&&q!=="auto"&&!i.includes(q)?[q,...i]:i}),r={"gpt-5.5":["max"],"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},c=(q,be)=>!!q&&!!be&&(r[q]||[]).includes(be),d=q=>!c(a.value.model,q)&&!(a.value.agent_reasoning_effort===""&&c(a.value.agent_model,q)),u=q=>{const be=a.value.agent_model;return be==="auto"?!0:!c(be||a.value.model,q)},p=W(()=>{const q=a.value.agent_reasoning_effort;return q==="auto"?null:q||a.value.reasoning_effort}),h=q=>c(q,a.value.reasoning_effort)||a.value.agent_model===""&&c(q,p.value),m=q=>c(q,p.value),v=f({enabled:!1,model:"gpt-5.6-luna"}),w=f({unavailable_reason:null}),R=W(()=>{const q=v.value.model;return q&&!i.includes(q)?[q,...i]:i});function x(q){const be=q.target.value;v.value.enabled=be!=="",be!==""&&(v.value.model=be),te()}const g=f(!1),b=f({codex:!1,ollama:!1,kimi:!1}),T=f(null),S=f(!1),A=f(""),C=f(null),y=f(!1);let I=0;const F=W(()=>{var q;return Object.entries(((q=T.value)==null?void 0:q.models)||{}).map(([be,Re])=>{var Xt,un,Hn;return{model:be,floor:Re.floor,override:Re.override,effectiveBudget:(Xt=Re.effective)==null?void 0:Xt.effective_budget,configuredPrimaryChars:(un=Re.configured)==null?void 0:un.primary_chars,primaryChars:(Hn=Re.effective)==null?void 0:Hn.primary_chars,provenance:Re.provenance,clampExpiresAt:Re.clamp_expires_at,densityPriorMilli:Re.density_prior_milli,densityScope:Re.density_scope,workloadCalibration:Re.workload_calibration}})}),k=W(()=>{var q;return((q=T.value)==null?void 0:q.clamps)||[]}),M=W(()=>{var q,be;return((be=(q=T.value)==null?void 0:q.models)==null?void 0:be[a.value.model])||null}),j=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),K=f({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),D=f(!1),O=f(!1),L=f(!1),B=f(!1),Y=f(!1),Z=f(!1),X=f(!1),J=f({configured:null}),G=f(!1),ne=f([]),xe=f(""),Q=f(!1),fe=f(!1),V=f({configured:null}),ce=f(!1),pe=f([]),Oe=f(""),_=f(!1),P=f(!1),H=f(!0),oe=f(""),ae=f({configured:null,accounts:[]}),le=f(null),he=f(null),ue=f(""),de=f(null),re=f(!1),_e=f(null),ve=f(null),we=f("");let Ie=null;function $(q,be="success"){ye(q,be==="error"?"error":"success")}function ge(q){if(!q)return"?";const be=q/(1024*1024*1024);return be>=1?be.toFixed(1)+" GB":(q/(1024*1024)).toFixed(0)+" MB"}function Se(q){return Number.isFinite(Number(q))?Number(q).toLocaleString():"—"}function Le(q){return q==null?"automatic (model-derived)":Number(q).toLocaleString()+" characters"}function Pe(q){const be=new Date(q);return Number.isNaN(be.getTime())?"unknown":be.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function dt(q){return typeof q=="string"&&q.length>12?q.slice(0,8)+"…"+q.slice(-4):q}function st(q){return typeof q!="number"||!Number.isFinite(q)?"—":(q/1e3).toFixed(2)}function _t(q){return q==="temporary learned clamp"?"is-clamp":q==="override"?"is-override":"is-built-in"}function Ot(q){const be=a.value.context_budget_overrides[q.model];return q.floor!=null&&Number.isFinite(Number(be))&&Number(be)>q.floor}function rt(q,be){const Re={...a.value.context_budget_overrides};be.target.value===""?delete Re[q]:Re[q]=Number(be.target.value),a.value.context_budget_overrides=Re,y.value=!0}function Qe(q){a.value.context_utilization=q.target.value===""?"":Number(q.target.value),y.value=!0}function ie(q){const be={...a.value.context_budget_overrides};delete be[q],a.value.context_budget_overrides=be,y.value=!0}async function Te(){e.value=!0,await Promise.all([Ne(),Et(),ks(),Ve(),Ke()]),e.value=!1}async function Ne({preserveBasic:q=!1,preserveAdvanced:be=!1}={}){try{const Re=await z.get("/api/llm/status");t.value=Re,s.value=!1,n.value=Re.active_provider||"codex",Re.codex&&!Ds.pending()&&(q||(a.value.enabled=Re.codex.enabled,a.value.model=Re.codex.model||"gpt-5.6-sol",a.value.reasoning_effort=Re.codex.reasoning_effort||"medium",a.value.agent_reasoning_effort=Re.codex.agent_reasoning_effort||"",a.value.agent_model=Re.codex.agent_model||""),be||(a.value.request_timeout_seconds=Re.codex.request_timeout_seconds??a.value.request_timeout_seconds,a.value.stream_stall_timeout_seconds=Re.codex.stream_stall_timeout_seconds??a.value.stream_stall_timeout_seconds,a.value.retry={...a.value.retry,...Re.codex.retry||{}},a.value.connection_pool={...a.value.connection_pool,...Re.codex.connection_pool||{}},a.value.context_compression={...a.value.context_compression,...Re.codex.context_compression||{}},!y.value&&!L.value&&(a.value.context_budget_overrides={...Re.codex.context_budget_overrides||{}},a.value.context_utilization=Re.codex.context_utilization??a.value.context_utilization))),Re.ollama&&!ke.pending()&&(q||(j.value.enabled=Re.ollama.enabled,j.value.base_url=Re.ollama.base_url||"",j.value.model=Re.ollama.model||"",j.value.max_tokens=Re.ollama.max_tokens||4096),be||(j.value.timeout=Re.ollama.timeout??j.value.timeout)),Re.kimi&&!$e.pending()&&(q||(K.value.enabled=Re.kimi.enabled,K.value.model=Re.kimi.model||"",K.value.max_tokens=Re.kimi.max_tokens||4096),be||(K.value.timeout=Re.kimi.timeout??K.value.timeout)),Re.auxiliary&&(w.value=Re.auxiliary,te.pending()||(v.value.enabled=Re.auxiliary.enabled,v.value.model=Re.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function Ke(){const q=++I;S.value=!0,A.value="";try{const be=await z.get("/api/context/windows");if(q!==I)return;T.value=be,!L.value&&!y.value&&(a.value.context_budget_overrides=Object.fromEntries(Object.entries(be.models||{}).filter(([,Re])=>Re.override!=null).map(([Re,Xt])=>[Re,Xt.override])),a.value.context_utilization=be.utilization??a.value.context_utilization)}catch(be){q===I&&(A.value=be.message||"Failed to load context budgets")}finally{q===I&&(S.value=!1)}}async function Et(){try{if(J.value=await z.get("/api/ollama/status"),G.value=!1,J.value.model&&(xe.value=J.value.model),J.value.configured)try{const q=await z.get("/api/ollama/models");ne.value=q.models||[]}catch{ne.value=[]}else if(j.value.base_url)try{const q=await z.post("/api/ollama/probe-models",{base_url:j.value.base_url});ne.value=q.models||[]}catch{ne.value=[]}}catch{G.value=!0}}async function Ve(){H.value=!0,oe.value="";try{ae.value=await z.get("/api/codex/status")}catch(q){oe.value=q.message||"Failed to fetch Codex status"}finally{H.value=!1}}async function Ft(){const q=t.value?t.value.active_provider:"codex";X.value=!0;try{const be=await z.post("/api/llm/switch",{provider:n.value});be.error?(n.value=q,$(be.error,"error")):($("Switched to "+n.value+" ("+be.model+")"),await Te())}catch(be){n.value=q,$(be.message||"Switch failed","error")}finally{X.value=!1}}async function Ht(){Q.value=!0;try{const q=await z.post("/api/ollama/reload");$(q.configured?"Ollama reloaded":q.reason||"Ollama not configured",q.configured?"success":"error"),await Te()}catch(q){$(q.message||"Reload failed","error")}finally{Q.value=!1}}async function rs(){fe.value=!0;try{await z.post("/api/ollama/model",{model:xe.value}),$("Model set to "+xe.value),await Te()}catch(q){$(q.message||"Failed","error")}finally{fe.value=!1}}async function Zs(){const q=j.value.base_url;if(!q){$("Enter a base URL first","error");return}Z.value=!0;try{const be=await z.post("/api/ollama/probe-models",{base_url:q});ne.value=be.models||[],ne.value.length?($(ne.value.length+" model(s) found"),!j.value.model&&ne.value.length&&(j.value.model=ne.value[0].name)):$("No models found at "+q,"error")}catch(be){$(be.message||"Could not reach Ollama","error")}finally{Z.value=!1}}async function ks(){try{if(V.value=await z.get("/api/kimi/status"),ce.value=!1,V.value.model&&(Oe.value=V.value.model),V.value.configured)try{const q=await z.get("/api/kimi/models");pe.value=q.models||[]}catch{pe.value=[]}}catch{ce.value=!0}}async function sa(){_.value=!0;try{const q=await z.post("/api/kimi/reload");$(q.configured?"Kimi reloaded":q.reason||"Kimi not configured",q.configured?"success":"error"),await Te()}catch(q){$(q.message||"Reload failed","error")}finally{_.value=!1}}async function Js(){P.value=!0;try{await z.post("/api/kimi/model",{model:Oe.value}),$("Model set to "+Oe.value),await Te()}catch(q){$(q.message||"Failed","error")}finally{P.value=!1}}async function Ls(){if(L.value){Ds();return}L.value=!0;const q=up(a.value);try{await z.put("/api/llm/codex/config",q),$("Codex config saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Ve()])}catch(be){$(be.message||"Failed","error");const Re=JSON.stringify(up(a.value))!==JSON.stringify(q);await Promise.all([Ne({preserveBasic:Re,preserveAdvanced:!0}),Ve()])}finally{L.value=!1}}async function Pn(){if(L.value)return;L.value=!0;const q=pp(a.value);try{await z.put("/api/llm/codex/config",q),JSON.stringify({context_budget_overrides:a.value.context_budget_overrides,context_utilization:a.value.context_utilization})===JSON.stringify({context_budget_overrides:q.context_budget_overrides,context_utilization:q.context_utilization})&&(y.value=!1),$("Codex advanced settings saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Ve(),Ke()])}catch(be){$(be.message||"Failed","error");const Re=JSON.stringify(pp(a.value))!==JSON.stringify(q);await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:Re}),Ve(),Ke()])}finally{L.value=!1}}async function Ss(){if(B.value){ke();return}B.value=!0;try{const q=D.value?j.value.api_key:null,be=pS(j.value,{includeApiKey:q!==null});await z.put("/api/llm/ollama/config",be),$("Ollama config saved"),q!==null&&j.value.api_key===q&&(j.value.api_key="",D.value=!1),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(q){$(q.message||"Failed","error")}finally{B.value=!1}}async function Fn(){if(!B.value){B.value=!0;try{await z.put("/api/llm/ollama/config",fS(j.value)),$("Ollama timeout saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(q){$(q.message||"Failed","error")}finally{B.value=!1}}}async function zt(){if(Y.value){$e();return}Y.value=!0;try{const q=O.value?K.value.api_key:null,be=hS(K.value,{includeApiKey:q!==null});await z.put("/api/llm/kimi/config",be),$("Kimi config saved"),q!==null&&K.value.api_key===q&&(K.value.api_key="",O.value=!1),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(q){$(q.message||"Failed","error")}finally{Y.value=!1}}async function Xe(){if(!Y.value){Y.value=!0;try{await z.put("/api/llm/kimi/config",mS(K.value)),$("Kimi timeout saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(q){$(q.message||"Failed","error")}finally{Y.value=!1}}}async function Ns(){if(g.value){te();return}g.value=!0;try{await z.put("/api/llm/auxiliary/config",v.value),$("Auxiliary config saved"),await Ne()}catch(q){$(q.message||"Failed","error"),await Ne()}finally{g.value=!1}}const Ds=Ml(Ls),te=Ml(Ns),ke=Ml(Ss),$e=Ml(zt),Ze=()=>(Ds.cancel(),Ls()),wt=()=>(ke.cancel(),Ss()),ut=()=>($e.cancel(),zt()),$n=()=>Pn(),js=()=>Fn(),mi=()=>Xe();async function vi(q){const be=q.account_key+":"+q.model;C.value=be;try{const Re=await z.post("/api/context/windows/clear",{account_key:q.account_key,model:q.model});$(Re.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Ke()}catch(Re){$(Re.message||"Failed to clear clamp","error"),await Ke()}finally{C.value=null}}async function Ia(q){try{await z.post("/api/codex/account/"+q+"/activate"),$("Active account switched"),await Ve()}catch(be){$(be.message||"Failed","error")}}async function na(q){le.value=q;try{await z.post("/api/codex/account/"+q+"/refresh"),$("Token refreshed"),await Ve()}catch(be){$(be.message||"Refresh failed","error")}finally{le.value=null}}function Bn(q,be){he.value=q,ue.value=be||""}async function Un(q){try{await z.put("/api/codex/account/"+q+"/label",{label:ue.value}),$("Label updated"),he.value=null,await Ve()}catch(be){$(be.message||"Failed","error")}}async function Ys(q,be){if(await qt({title:"Delete Codex account",message:`Delete ${be||"account #"+(q+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/codex/account/"+q),$("Deleted. Pool reloaded."),await Ve()}catch(Xt){$(Xt.message||"Failed","error")}}async function dn(){re.value=!0;try{const q=await z.post("/api/codex/device-code");_e.value=q,de.value="pending",Qt(q)}catch(q){$(q.message||"Failed","error")}finally{re.value=!1}}async function Qt(q){Ie={cancelled:!1};const be=Ie;try{const Re=await z.post("/api/codex/device-poll",{device_auth_id:q.device_auth_id,user_code:q.user_code,interval:q.interval});if(be.cancelled)return;ve.value=Re,de.value="success",await Te()}catch(Re){if(be.cancelled)return;we.value=Re.message||"Device login failed",de.value="error"}}function Oa(){Ie&&(Ie.cancelled=!0),de.value=null,_e.value=null}return je(Te),ht(()=>{Ie&&(Ie.cancelled=!0),Ds.cancel(),te.cancel(),ke.cancel(),$e.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:n,switching:X,advancedOpen:b,codexForm:a,codexModelOptions:l,codexAgentModelOptions:o,mainEffortAllowed:d,agentEffortAllowed:u,mainModelOptionDisabled:h,agentModelOptionDisabled:m,auxForm:v,auxData:w,auxModelOptions:R,onAuxModelChange:x,savingAux:g,saveAuxConfigDebounced:te,ollamaForm:j,kimiForm:K,savingCodex:L,savingOllama:B,savingKimi:Y,probingOllama:Z,ollamaKeyDirty:D,kimiKeyDirty:O,fetchCodexStatus:Ve,ollamaStatus:J,ollamaStatusLoadFailed:G,ollamaModels:ne,ollamaSelectedModel:xe,reloading:Q,settingModel:fe,kimiStatus:V,kimiStatusLoadFailed:ce,kimiModels:pe,kimiSelectedModel:Oe,reloadingKimi:_,settingKimiModel:P,codexLoading:H,codexError:oe,codexData:ae,refreshing:le,editingLabel:he,labelValue:ue,contextWindows:T,contextWindowsLoading:S,contextWindowsError:A,contextBudgetRows:F,activeClampRows:k,activeContextBudget:M,clearingClamp:C,contextPolicyDirty:y,deviceState:de,deviceLoading:re,deviceInfo:_e,deviceResult:ve,deviceError:we,fetchAll:Te,fetchLLMStatus:Ne,fetchOllamaStatus:Et,fetchKimiStatus:ks,switchProvider:Ft,reloadOllama:Ht,setOllamaModel:rs,reloadKimi:sa,setKimiModel:Js,probeOllamaModels:Zs,saveCodexConfig:Ls,saveOllamaConfig:Ss,saveKimiConfig:zt,saveCodexAdvancedConfig:Pn,saveOllamaAdvancedConfig:Fn,saveKimiAdvancedConfig:Xe,saveCodexConfigDebounced:Ds,saveOllamaConfigDebounced:ke,saveKimiConfigDebounced:$e,saveCodexConfigNow:Ze,saveOllamaConfigNow:wt,saveKimiConfigNow:ut,saveCodexAdvancedConfigNow:$n,saveOllamaAdvancedConfigNow:js,saveKimiAdvancedConfigNow:mi,activateAccount:Ia,refreshAccount:na,startEditLabel:Bn,saveLabel:Un,deleteAccount:Ys,startDeviceLogin:dn,cancelDeviceLogin:Oa,formatSize:ge,fetchContextWindows:Ke,clearContextClamp:vi,setContextOverride:rt,setContextUtilization:Qe,resetContextOverride:ie,overrideAboveFloor:Ot,formatCount:Se,formatContextCeiling:Le,formatExpiry:Pe,shortAccountKey:dt,provenanceClass:_t,formatDensity:st}}},fp={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function gS(e){return fp[e]||fp[(e||"").toLowerCase()]||"text-gray-400"}const bS={template:`
  ...
  `},kS={template:`
    ...
    </section>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),n=f(!1),a=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(null),p=f(""),h=f(!1),m=f(Date.now()),v=f(""),w=f(null);let R=0,x=null,g=!1,b=z.token,T=0;const S=J=>J===!0?"Enabled":J===!1?"Disabled":"Unknown",A=W(()=>{const J=e.value.restart_required;return Array.isArray(J)?J.length?J.join(", "):"None reported":J===!0?"Pending; restart required":J===!1?"None reported":"Unknown"}),C=W(()=>{var G,ne;const J=Date.parse(((G=u.value)==null?void 0:G.captured_at)||"");return Number.isFinite(J)&&m.value<J+Math.min(1e4,((ne=u.value)==null?void 0:ne.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function y(){p.value&&URL.revokeObjectURL(p.value),p.value="",u.value=null}function I(){R++,y(),w.value=null,s.value=!1,i.value=!1,l.value=!1}function F(J,G){return g&&J===R&&G===z.token}function k(J){I(),c.value=!1;const G=J.status||(J.name==="AuthError"?401:0);e.value={available:!1,state:G===503?"unavailable":"unknown"},o.value=G===401||G===403||G===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":G===410?"Evidence or artifact expired. Observe or prepare the export again.":G===503?"Computer use is disabled or unavailable.":"Request failed; outcome unknown. Refresh status. No action was replayed."}async function M(){if(t.value||r.value||n.value||a.value||d.value||!g)return;const J=R,G=z.token;t.value=!0,T=Date.now();try{const ne=await z.get("/api/computer");if(!F(J,G))return;j(ne)}catch(ne){F(J,G)&&k(ne)}finally{t.value=!1}}function j(J){(e.value.session_id&&e.value.session_id!==J.session_id||e.value.generation!=null&&e.value.generation!==J.generation||e.value.session_generation!=null&&e.value.session_generation!==J.session_generation)&&I(),e.value=J,c.value=!0,o.value=""}async function K(J){if(!g||!c.value||r.value||n.value||a.value)return;I();const G=R,ne=z.token;r.value=!0;try{if(await z.post("/api/computer/enabled",{enabled:J}),!F(G,ne))return;const xe=await z.get("/api/computer");F(G,ne)&&j(xe)}catch(xe){F(G,ne)&&k(xe)}finally{r.value=!1}}async function D(J){I();const G=R,ne=z.token,xe=J==="stop"?n:a;xe.value=!0;try{const Q=await z.post("/api/computer/"+J,{});if(F(G,ne)){e.value={...e.value,...Q};const fe=await z.get("/api/computer");F(G,ne)&&j(fe)}}catch(Q){F(G,ne)&&k(Q)}finally{xe.value=!1}}async function O(){if(!g||!c.value||d.value||e.value.state!=="quarantined")return;const J={session_id:e.value.session_id,generation:e.value.session_generation};if(!J.session_id||!Number.isInteger(J.generation))return;I();const G=R,ne=z.token;d.value=!0;try{const xe=await z.post("/api/computer/recover",J);F(G,ne)&&j(xe)}catch(xe){F(G,ne)&&k(xe)}finally{d.value=!1}}async function L(){var ne;y(),h.value=!1;const J=R,G=z.token;s.value=!0;try{const xe=await z.post("/api/computer/observe",{});if(!F(J,G))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((ne=xe.frame)==null?void 0:ne.evidence_id)||""))throw new Error("Invalid evidence");const Q=await z.getBlob("/api/computer/evidence/"+xe.frame.evidence_id);if(!F(J,G))return;if(!["image/png","image/jpeg"].includes(Q.type)||Q.size>2097152||!Number.isFinite(Date.parse(xe.frame.expires_at))||Date.parse(xe.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");u.value=xe.frame,p.value=URL.createObjectURL(Q),o.value=""}catch(xe){F(J,G)&&k(xe)}finally{J===R&&(s.value=!1)}}async function B(){w.value=null;const J=R,G=z.token;i.value=!0;try{const ne=await z.post("/api/computer/export",{name:v.value});F(J,G)&&(w.value=ne,o.value="")}catch(ne){F(J,G)&&k(ne)}finally{J===R&&(i.value=!1)}}async function Y(){const J=R,G=z.token,ne=w.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((ne==null?void 0:ne.artifact_id)||""))throw new Error("Invalid export");const xe=await z.getBlob("/api/computer/download/"+ne.artifact_id);if(!F(J,G))return;const Q=URL.createObjectURL(xe),fe=document.createElement("a");fe.href=Q,fe.download=ne.name,fe.click(),setTimeout(()=>URL.revokeObjectURL(Q),1e3)}catch(xe){F(J,G)&&k(xe)}finally{J===R&&(l.value=!1)}}function Z(){g||(g=!0,M(),x=setInterval(()=>{m.value=Date.now(),b!==z.token&&(b=z.token,I(),c.value=!1,e.value={state:"unknown",available:!1}),u.value&&Date.parse(u.value.expires_at)<=m.value&&(y(),h.value=!0),w.value&&Date.parse(w.value.expires_at)<=m.value&&(w.value=null),m.value-T>=5e3&&M()},500))}function X(){g=!1,clearInterval(x),x=null,I(),c.value=!1}return je(Z),os(Z),Yt(X),ht(X),{status:e,loading:t,observing:s,stopping:n,pausing:a,exporting:i,downloading:l,error:o,frame:u,frameUrl:p,frameExpired:h,freshness:C,name:v,artifact:w,refresh:M,control:D,observe:L,clearFrame:y,exportFile:B,download:Y,toggling:r,adminReady:c,enabledLabel:S,restartSettings:A,setEnabled:K,recovering:d,recover:O}}},iv=[{id:"health",label:"Health",component:Ik},{id:"resources",label:"Resources",component:Ok},{id:"logs",label:"Logs",component:jk},{id:"config",label:"Config",component:tS},{id:"discord",label:"Discord",component:nS},{id:"hosts",label:"Hosts",component:lS},{id:"host-access",label:"Host Access",component:iS},{id:"api-tokens",label:"API Tokens",component:oS},{id:"llm",label:"LLM Config",component:vS},{id:"internals",label:"Internals",component:bS},{id:"turn-state",label:"Turn State",component:_S},{id:"computer",label:"Computer",component:kS},{id:"update",label:"Update",component:wS}],SS={components:{TabbedPage:Jo},setup(){return{tabs:iv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Pl=(e,t,s,n)=>n.map(({id:a,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:a}}})),TS=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Pl("Operations","operations","/operations",Jm),...Pl("History","history","/history",Ym),...Pl("Capabilities","capabilities","/capabilities",Qm),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Pl("System","system","/system",iv)],bs=ea({open:!1,query:"",selected:0});function mp(){bs.query="",bs.selected=0,bs.open=!0}function Tr(){bs.open=!1}function CS(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const ES={setup(){const e=zm(),t=f(null),s=W(()=>{const i=bs.query.trim().toLowerCase();return TS.map(l=>({...l,_score:CS(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Mt(()=>bs.open,async i=>{var l;i&&(await Rt(),(l=t.value)==null||l.focus())}),Mt(()=>bs.query,()=>{bs.selected=0});function n(i){Tr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Tr();return}if(i.key==="ArrowDown")i.preventDefault(),bs.selected=Math.min(bs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),bs.selected=Math.max(bs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[bs.selected];l&&n(l)}}return{state:bs,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Tr}},template:`
    <transition name="modal">
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+tn(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ka=new j1;function at(e,t){return ka.parse(e,t)}at.options=at.setOptions=function(e){return ka.setOptions(e),at.defaults=ka.defaults,cv(at.defaults),at};at.getDefaults=yd;at.defaults=Ra;at.use=function(...e){return ka.use(...e),at.defaults=ka.defaults,cv(at.defaults),at};at.walkTokens=function(e,t){return ka.walkTokens(e,t)};at.parseInline=ka.parseInline;at.Parser=Tn;at.parser=Tn.parse;at.Renderer=ko;at.TextRenderer=Ed;at.Lexer=Sn;at.lexer=Sn.lex;at.Tokenizer=wo;at.Hooks=ql;at.parse=at;at.options;at.setOptions;at.use;at.walkTokens;at.parseInline;Tn.parse;Sn.lex;const V1={breaks:!0,gfm:!0};function Pp(e){if(!e)return"";try{if(typeof at<"u"&&at.parse){const t=at.parse(e,V1);return typeof Ip<"u"?Ip.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function q1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const G1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function K1(e){return G1[e]||"wrench"}const W1=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Fp(e){if(!e)return[];const t=e.match(W1);return t?[...new Set(t)]:[]}const Z1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),n=f(""),a=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=W(()=>t.value.trim().length>0&&!s.value),p=f(Ye.state||"disconnected");let h=null;const m=W(()=>{const D=p.value;return D==="connected"?"Connected":D==="reconnecting"?"Reconnecting…":D==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],w=W(()=>{const D=Math.floor(l.value/4)%v.length,O=l.value;return O>3?`${v[D]} (${O}s)`:v[0]});function R(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function x(){if(!i.value)return;const D=i.value;D.style.height="auto",D.style.height=Math.min(D.scrollHeight,120)+"px"}function g(D,O,L={}){const B={id:++c,role:D,content:O,timestamp:Date.now(),html:D==="bot"?Pp(O):"",tools_used:L.tools_used||[],is_error:L.is_error||!1,images:D==="bot"?Fp(O):[],files:L.files||[],_showTools:!1};return e.value.push(B),R(),D==="bot"&&Rt(()=>b()),B}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(O=>{O.setAttribute("data-copy","true"),O.style.position="relative";const L=document.createElement("button");L.className="chat-code-copy",L.textContent="Copy",L.addEventListener("click",()=>{const B=O.querySelector("code"),Y=B?B.textContent:O.textContent;navigator.clipboard.writeText(Y).then(()=>{L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},1500)}).catch(()=>{})}),O.appendChild(L)})}function T(D){if(D===0)return!0;const O=e.value[D-1],L=e.value[D],B=new Date(O.timestamp).toDateString(),Y=new Date(L.timestamp).toDateString();return B!==Y}function S(D){const O=new Date(D),L=new Date;if(O.toDateString()===L.toDateString())return"Today";const B=new Date(L);return B.setDate(B.getDate()-1),O.toDateString()===B.toDateString()?"Yesterday":O.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function A(D){t.value=D,Rt(()=>j())}function C(D){window.open(D,"_blank","noopener")}function y(D){D.target.style.display="none"}function I(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function F(){r&&(clearInterval(r),r=null),l.value=0}function k(D){s.value&&(s.value=!1,F(),D.type==="chat_response"?g("bot",D.content,{tools_used:D.tools_used||[],is_error:D.is_error||!1,files:D.files||[]}):D.type==="chat_error"&&g("bot",D.error||"Unknown error",{is_error:!0}),Rt(()=>{var O;return(O=i.value)==null?void 0:O.focus()}))}async function M(D){try{const O=await z.post("/api/chat",{content:D,channel_id:o.value});g("bot",O.response,{tools_used:O.tools_used||[],is_error:O.is_error||!1,files:O.files||[]})}catch(O){g("bot",O.message||"Failed to send message",{is_error:!0})}}async function j(){const D=t.value.trim();if(!D||s.value)return;g("user",D),t.value="",s.value=!0,I(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(D,{channelId:o.value})||(await M(D),s.value=!1,F()),Rt(()=>{var L;return(L=i.value)==null?void 0:L.focus()})}async function K(){n.value="";try{if(!o.value){const O=await z.get("/api/auth/session");o.value=O.channel_id||O.user_id||"web-user"}const D=await z.get("/api/sessions/"+encodeURIComponent(o.value));if(D&&D.messages&&D.messages.length>0){for(const O of D.messages){const L=O.role==="user"?"user":"bot";let B=O.content||"";if(L==="user"){const Z=B.match(/^\[.*?\]:\s*/);Z&&(B=B.slice(Z[0].length))}if(!B.trim())continue;const Y={id:++c,role:L,content:B,timestamp:O.timestamp?O.timestamp*1e3:Date.now(),html:L==="bot"?Pp(B):"",tools_used:[],is_error:!1,images:L==="bot"?Fp(B):[],files:[],_showTools:!1};e.value.push(Y)}Rt(()=>{R(),b()})}}catch(D){D&&D.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",ye.error(n.value))}}return je(()=>{Ye.subscribe("chat",k),p.value=Ye.state||"disconnected",h=Ye.onState(D=>{p.value=D}),K(),Rt(()=>{var D;return(D=i.value)==null?void 0:D.focus()})}),ht(()=>{Ye.unsubscribe("chat",k),h&&(h(),h=null),F()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:w,suggestions:d,send:j,autoResize:x,formatTime:q1,formatDate:S,showDateSeparator:T,useSuggestion:A,openImage:C,onImageError:y,getToolIcon:K1,loadHistory:K}}},J1={setup(){const e=f("odin"),t=f(""),s=f(""),n=f(""),a=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),h=f(!1),m=W(()=>e.value==="custom"),v=W(()=>[...i.value,...l.value]),w=W(()=>l.value.includes(e.value)),R=W(()=>{var C;return m.value?t.value||"Odin":((C=a.value[e.value])==null?void 0:C.name)||e.value}),x=W(()=>{var C;return m.value?s.value||"(empty — will use Odin default)":((C=a.value[e.value])==null?void 0:C.identity)||""}),g=W(()=>{var C;return m.value?n.value||"(empty — will use Odin default)":((C=a.value[e.value])==null?void 0:C.voice)||""});async function b(){d.value=!0;try{const C=await z.get("/api/personality");e.value=C.preset||"odin",t.value=C.custom_name||"",s.value=C.custom_identity||"",n.value=C.custom_voice||"",a.value=C.presets||{},i.value=C.builtin_presets||[],l.value=C.user_presets||[]}catch(C){c.value=C.message}finally{d.value=!1}}async function T(){o.value=!0,c.value=null,r.value=!1;try{await z.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(C){c.value=C.message}finally{o.value=!1}}async function S(){const C=u.value.trim();if(C){h.value=!0,c.value=null;try{await z.post("/api/personality/presets",{name:C,display_name:R.value,identity:x.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=C.toLowerCase().replace(/ /g,"_")}catch(y){c.value=y.message}finally{h.value=!1}}}async function A(){if(await qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await z.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(y){c.value=y.message}}}return je(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:w,previewName:R,previewIdentity:x,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:T,showSavePreset:p,newPresetName:u,savingPreset:h,saveAsPreset:S,deletePreset:A,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),xv=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:OS,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:Z1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:Jw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:ik,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Ck,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:J1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:SS,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/hosts",redirect:kt("/system","hosts")},{path:"/internals",redirect:kt("/system","internals")}],zi=Tw({history:nw(),routes:xv});zi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Y1={template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=f(""),s=f(null),n=f(!1),a=f(!1);async function i(){n.value=!0,s.value=null;try{z.setPersist(a.value),await z.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{n.value=!1}}return{token:t,error:s,busy:n,persist:a,login:i}}},Q1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),n=f(!1),a=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let h=null;const m=f("starting"),v=f(""),w=xv.filter(B=>B.meta),R=W(()=>["Workspace","Operate","Observe","Manage"].map(B=>({name:B,routes:w.filter(Y=>Y.meta.section===B)})).filter(B=>B.routes.length)),x=W(()=>{var B;return((B=zi.currentRoute.value.meta)==null?void 0:B.label)||"Odin"}),g=W(()=>{var B;return((B=zi.currentRoute.value.meta)==null?void 0:B.section)||"Management"}),b=W(()=>{var B;return((B=zi.currentRoute.value.meta)==null?void 0:B.description)||"Management console"});function T(){Ye.disconnect(),j&&(clearInterval(j),j=null)}z.onSessionExpired=()=>{t.value=!0,T(),z.setToken(""),e.value="login"};function S(B){var Y;if((B.ctrlKey||B.metaKey)&&B.key.toLowerCase()==="k"){e.value==="ready"&&(B.preventDefault(),mp());return}if(n.value&&B.key==="Tab"){const Z=[...((Y=a.value)==null?void 0:Y.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(Z.length){const X=Z[0],J=Z[Z.length-1];if(B.shiftKey&&(document.activeElement===X||!a.value.contains(document.activeElement))){B.preventDefault(),J.focus();return}if(!B.shiftKey&&(document.activeElement===J||!a.value.contains(document.activeElement))){B.preventDefault(),X.focus();return}}}if(B.key==="Escape"&&n.value){n.value=!1,B.preventDefault();return}if(B.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(B.target.tagName)){B.preventDefault();const Z=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');Z&&Z.focus()}}function A(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}je(async()=>{document.addEventListener("keydown",S),o=window.matchMedia("(max-width: 900px)"),A(),o.addEventListener("change",A);const B=await z.check();B.ok?(e.value="ready",O()):B.needsAuth?e.value="login":(e.value="ready",O())});function C(){t.value=!1,e.value="ready",O()}async function y(){T(),e.value="login",await z.logout()}function I(){s.value=!s.value}function F(){n.value=!n.value}Mt(n,async B=>{var Y,Z;if(B)r=document.activeElement,await Rt(),(Z=(Y=a.value)==null?void 0:Y.querySelector(".nav-item"))==null||Z.focus();else if(r!=null&&r.isConnected){const X=r;r=null,requestAnimationFrame(()=>X.focus())}});const k=W(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(B,Y="info",Z=3e3){p.value={text:B,level:Y},clearTimeout(h),h=setTimeout(()=>{p.value=null},Z)}let j=null,K=!1,D=[];function O(){for(const B of D)B();D=[Ye.onStatus(B=>{c.value=B}),Ye.onLatencyChange(B=>{u.value=B}),Ye.onState((B,Y)=>{d.value=B,B==="connected"?(K&&M("Connection restored","success"),K=!0):B==="reconnecting"&&Y.attempt===1&&M("Connection lost — reconnecting…","warn")})],Ye.connect(),L(),j&&clearInterval(j),j=setInterval(L,15e3)}async function L(){try{const B=await z.get("/api/status");m.value=B.status==="online"?"online":"starting";const Y=B.uptime_seconds||0,Z=Math.floor(Y/3600),X=Math.floor(Y%3600/60);v.value=`${Z}h ${X}m uptime`}catch{m.value="offline",v.value=""}}return ht(()=>{j&&clearInterval(j);for(const B of D)B();D=[],Ye.disconnect(),document.removeEventListener("keydown",S),o==null||o.removeEventListener("change",A)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:k,wsToast:p,botStatus:m,botUptime:v,navRoutes:w,navGroups:R,currentPage:x,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:C,logout:y,toggleSidebar:I,toggleMobileNavigation:F,openPalette:mp}}},ta=co(Q1);ta.component("odin-icon",AS);ta.component("login-screen",Y1);ta.component("toast-container",g_);ta.component("confirm-host",b_);ta.component("command-palette",ES);ta.directive("modal-focus",IS);ta.use(zi);ta.mount("#app");
