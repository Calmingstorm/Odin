 ...
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let m_=()=>location.protocol+"//"+location.host;function sg(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),du(r,"")}return du(s,e)+n+a}function v_(e,t,s,n){let a=[],i=[],l=null;const r=({state:f})=>{const p=sg(e,location),g=s.value,m=t.value;let C=0;if(f){if(s.value=p,t.value=f,l&&l===g){l=null;return}C=m?f.position-m.position:0}else n(p);a.forEach(E=>{E(s.value,g,{delta:C,type:Co.pop,direction:C?C>0?Vr.forward:Vr.back:Vr.unknown})})};function o(){l=s.value}function c(f){a.push(f);const p=()=>{const g=a.indexOf(f);g>-1&&a.splice(g,1)};return i.push(p),p}function d(){if(document.visibilityState==="hidden"){const{history:f}=window;if(!f.state)return;f.replaceState(nt({},f.state,{scroll:yr()}),"")}}function u(){for(const f of i)f();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:o,listen:c,destroy:u}}function gu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?yr():null}}function b_(e){const{history:t,location:s}=window,n={value:sg(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,d){const u=e.indexOf("#"),f=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+o:m_()+e+o;try{t[d?"replaceState":"pushState"](c,"",f),a.value=c}catch(p){console.error(p),s[d?"replace":"assign"](f)}}function l(o,c){i(o,nt({},t.state,gu(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const d=nt({},a.value,t.state,{forward:o,scroll:yr()});i(d.current,d,!0),i(o,nt({},gu(n.value,o,null),{position:d.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function y_(e){e=s_(e);const t=b_(e),s=v_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=nt({location:"",base:e,go:n,createHref:a_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function x_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),y_(e)}let Kn=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Rt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Rt||{});const __={type:Kn.Static,value:""},k_=/[a-zA-Z0-9_]/;function w_(e){if(!e)return[[]];if(e==="/")return[[__]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(p){throw new Error(`ERR (${s})/"${c}": ${p}`)}let s=Rt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",d="";function u(){c&&(s===Rt.Static?i.push({type:Kn.Static,value:c}):s===Rt.Param||s===Rt.ParamRegExp||s===Rt.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Kn.Param,value:c,regexp:d,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function f(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==Rt.ParamRegExp){n=s,s=Rt.EscapeNext;continue}switch(s){case Rt.Static:o==="/"?(c&&u(),l()):o===":"?(u(),s=Rt.Param):f();break;case Rt.EscapeNext:f(),s=n;break;case Rt.Param:o==="("?s=Rt.ParamRegExp:k_.test(o)?f():(u(),s=Rt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case Rt.ParamRegExp:o===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+o:s=Rt.ParamRegExpEnd:d+=o;break;case Rt.ParamRegExpEnd:u(),s=Rt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,d="";break;default:t("Unknown state");break}}return s===Rt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const mu="[^/]+?",S_={sensitive:!1,strict:!1,start:!0,end:!0};var Jt=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Jt||{});const T_=/[.+*?^${}()[\]/\\]/g;function C_(e,t){const s=nt({},S_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[Jt.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const f=c[u];let p=Jt.Segment+(s.sensitive?Jt.BonusCaseSensitive:0);if(f.type===Kn.Static)u||(a+="/"),a+=f.value.replace(T_,"\\$&"),p+=Jt.Static;else if(f.type===Kn.Param){const{value:g,repeatable:m,optional:C,regexp:E}=f;i.push({name:g,repeatable:m,optional:C});const y=E||mu;if(y!==mu){p+=Jt.BonusCustomRegExp;try{`${y}`}catch(x){throw new Error(`Invalid custom RegExp for param "${g}" (${y}): `+x.message)}}let v=m?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(v=C&&c.length<2?`(?:/${v})`:"/"+v),C&&(v+="?"),a+=v,p+=Jt.Dynamic,C&&(p+=Jt.BonusOptional),m&&(p+=Jt.BonusRepeatable),y===".*"&&(p+=Jt.BonusWildcard)}d.push(p)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=Jt.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const d=c.match(l),u={};if(!d)return null;for(let f=1;f<d.length;f++){const p=d[f]||"",g=i[f-1];u[g.name]=p&&g.repeatable?p.split("/"):p}return u}function o(c){let d="",u=!1;for(const f of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const p of f)if(p.type===Kn.Static)d+=p.value;else if(p.type===Kn.Param){const{value:g,repeatable:m,optional:C}=p,E=g in c?c[g]:"";if(Ms(E)&&!m)throw new Error(`Provided param "${g}" is an array but it is not repeatable (* or + modifiers)`);const y=Ms(E)?E.join("/"):E;if(!y)if(C)f.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${g}"`);d+=y}}return d||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function E_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Jt.Static+Jt.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Jt.Static+Jt.Segment?1:-1:0}function ng(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=E_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(vu(n))return 1;if(vu(a))return-1}return a.length-n.length}function vu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const A_={strict:!1,end:!0,sensitive:!1};function R_(e,t,s){const n=C_(w_(e.path),s),a=nt(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function I_(e,t){const s=[],n=new Map;t=cu(A_,t);function a(u){return n.get(u)}function i(u,f,p){const g=!p,m=yu(u);m.aliasOf=p&&p.record;const C=cu(t,u),E=[m];if("alias"in u){const x=typeof u.alias=="string"?[u.alias]:u.alias;for(const _ of x)E.push(yu(nt({},m,{components:p?p.record.components:m.components,path:_,aliasOf:p?p.record:m})))}let y,v;for(const x of E){const{path:_}=x;if(f&&_[0]!=="/"){const A=f.record.path,O=A[A.length-1]==="/"?"":"/";x.path=f.record.path+(_&&O+_)}if(y=R_(x,f,C),p?p.alias.push(y):(v=v||y,v!==y&&v.alias.push(y),g&&u.name&&!xu(y)&&l(u.name)),ag(y)&&o(y),m.children){const A=m.children;for(let O=0;O<A.length;O++)i(A[O],y,p&&p.children[O])}p=p||y}return v?()=>{l(v)}:mi}function l(u){if(eg(u)){const f=n.get(u);f&&(n.delete(u),s.splice(s.indexOf(f),1),f.children.forEach(l),f.alias.forEach(l))}else{const f=s.indexOf(u);f>-1&&(s.splice(f,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function r(){return s}function o(u){const f=N_(u,s);s.splice(f,0,u),u.record.name&&!xu(u)&&n.set(u.record.name,u)}function c(u,f){let p,g={},m,C;if("name"in u&&u.name){if(p=n.get(u.name),!p)throw Va(mt.MATCHER_NOT_FOUND,{location:u});C=p.record.name,g=nt(bu(f.params,p.keys.filter(v=>!v.optional).concat(p.parent?p.parent.keys.filter(v=>v.optional):[]).map(v=>v.name)),u.params&&bu(u.params,p.keys.map(v=>v.name))),m=p.stringify(g)}else if(u.path!=null)m=u.path,p=s.find(v=>v.re.test(m)),p&&(g=p.parse(m),C=p.record.name);else{if(p=f.name?n.get(f.name):s.find(v=>v.re.test(f.path)),!p)throw Va(mt.MATCHER_NOT_FOUND,{location:u,currentLocation:f});C=p.record.name,g=nt({},f.params,u.params),m=p.stringify(g)}const E=[];let y=p;for(;y;)E.unshift(y.record),y=y.parent;return{name:C,path:m,params:g,matched:E,meta:L_(E)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:r,getRecordMatcher:a}}function bu(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function yu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:O_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function O_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function xu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function L_(e){return e.reduce((t,s)=>nt(t,s.meta),{})}function N_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;ng(e,t[i])<0?n=i:s=i+1}const a=D_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function D_(e){let t=e;for(;t=t.parent;)if(ag(t)&&ng(e,t)===0)return t}function ag({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function _u(e){const t=Ts(xr),s=Ts(Lc),n=ee(()=>{const o=Gs(e.to);return t.resolve(o)}),a=ee(()=>{const{matched:o}=n.value,{length:c}=o,d=o[c-1],u=s.matched;if(!d||!u.length)return-1;const f=u.findIndex(Ha.bind(null,d));if(f>-1)return f;const p=ku(o[c-2]);return c>1&&ku(d)===p&&u[u.length-1].path!==p?u.findIndex(Ha.bind(null,o[c-2])):f}),i=ee(()=>a.value>-1&&U_(s.params,n.value.params)),l=ee(()=>a.value>-1&&a.value===s.matched.length-1&&Xh(s.params,n.value.params));function r(o={}){if($_(o)){const c=t[Gs(e.replace)?"replace":"push"](Gs(e.to)).catch(mi);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:ee(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function M_(e){return e.length===1?e[0]:e}const P_=Vi({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:_u,setup(e,{slots:t}){const s=Fn(_u(e)),{options:n}=Ts(xr),a=ee(()=>({[wu(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[wu(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&M_(t.default(s));return e.custom?i:Da("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),F_=P_;function $_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function U_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Ms(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function ku(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const wu=(e,t,s)=>e??t??s,B_=Vi({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Ts(Ao),a=ee(()=>e.route||n.value),i=Ts(hu,0),l=ee(()=>{let c=Gs(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),r=ee(()=>a.value.matched[l.value]);ui(hu,ee(()=>l.value+1)),ui(h_,r),ui(Ao,a);const o=h();return ds(()=>[o.value,r.value,e.name],([c,d,u],[f,p,g])=>{d&&(d.instances[u]=c,p&&p!==d&&c&&c===f&&(d.leaveGuards.size||(d.leaveGuards=p.leaveGuards),d.updateGuards.size||(d.updateGuards=p.updateGuards))),c&&d&&(!p||!Ha(d,p)||!f)&&(d.enterCallbacks[u]||[]).forEach(m=>m(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=r.value,f=u&&u.components[d];if(!f)return Su(s.default,{Component:f,route:c});const p=u.props[d],g=p?p===!0?c.params:typeof p=="function"?p(c):p:null,C=Da(f,nt({},g,t,{onVnodeUnmounted:E=>{E.component.isUnmounted&&(u.instances[d]=null)},ref:o}));return Su(s.default,{Component:C,route:c})||C}}});function Su(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const H_=B_;function V_(e){const t=I_(e.routes,e),s=e.parseQuery||f_,n=e.stringifyQuery||pu,a=e.history,i=Xa(),l=Xa(),r=Xa(),o=Vo(Cn);let c=Cn;ba&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Br.bind(null,z=>""+z),u=Br.bind(null,Z0),f=Br.bind(null,Fi);function p(z,pe){let de,xe;return eg(z)?(de=t.getRecordMatcher(z),xe=pe):xe=z,t.addRoute(xe,de)}function g(z){const pe=t.getRecordMatcher(z);pe&&t.removeRoute(pe)}function m(){return t.getRoutes().map(z=>z.record)}function C(z){return!!t.getRecordMatcher(z)}function E(z,pe){if(pe=nt({},pe||o.value),typeof z=="string"){const R=Hr(s,z,pe.path),F=t.resolve({path:R.path},pe),X=a.createHref(R.fullPath);return nt(R,F,{params:f(F.params),hash:Fi(R.hash),redirectedFrom:void 0,href:X})}let de;if(z.path!=null)de=nt({},z,{path:Hr(s,z.path,pe.path).path});else{const R=nt({},z.params);for(const F in R)R[F]==null&&delete R[F];de=nt({},z,{params:u(R)}),pe.params=u(pe.params)}const xe=t.resolve(de,pe),me=z.hash||"";xe.params=d(f(xe.params));const Be=Q0(n,nt({},z,{hash:G0(me),path:xe.path})),b=a.createHref(Be);return nt({fullPath:Be,hash:me,query:n===pu?p_(z.query):z.query||{}},xe,{redirectedFrom:void 0,href:b})}function y(z){return typeof z=="string"?Hr(s,z,o.value.path):nt({},z)}function v(z,pe){if(c!==z)return Va(mt.NAVIGATION_CANCELLED,{from:pe,to:z})}function x(z){return O(z)}function _(z){return x(nt(y(z),{replace:!0}))}function A(z,pe){const de=z.matched[z.matched.length-1];if(de&&de.redirect){const{redirect:xe}=de;let me=typeof xe=="function"?xe(z,pe):xe;return typeof me=="string"&&(me=me.includes("?")||me.includes("#")?me=y(me):{path:me},me.params={}),nt({query:z.query,hash:z.hash,params:me.path!=null?{}:z.params},me)}}function O(z,pe){const de=c=E(z),xe=o.value,me=z.state,Be=z.force,b=z.replace===!0,R=A(de,xe);if(R)return O(nt(y(R),{state:typeof R=="object"?nt({},me,R.state):me,force:Be,replace:b}),pe||de);const F=de;F.redirectedFrom=pe;let X;return!Be&&X0(n,xe,de)&&(X=Va(mt.NAVIGATION_DUPLICATED,{to:F,from:xe}),W(xe,xe,!0,!1)),(X?Promise.resolve(X):L(F,xe)).catch(Z=>en(Z)?en(Z,mt.NAVIGATION_GUARD_REDIRECT)?Z:B(Z):T(Z,F,xe)).then(Z=>{if(Z){if(en(Z,mt.NAVIGATION_GUARD_REDIRECT))return O(nt({replace:b},y(Z.to),{state:typeof Z.to=="object"?nt({},me,Z.to.state):me,force:Be}),pe||F)}else Z=M(F,xe,!0,b,me);return H(F,xe,Z),Z})}function w(z,pe){const de=v(z,pe);return de?Promise.reject(de):Promise.resolve()}function S(z){const pe=Q.values().next().value;return pe&&typeof pe.runWithContext=="function"?pe.runWithContext(z):z()}function L(z,pe){let de;const[xe,me,Be]=g_(z,pe);de=jr(xe.reverse(),"beforeRouteLeave",z,pe);for(const R of xe)R.leaveGuards.forEach(F=>{de.push(Nn(F,z,pe))});const b=w.bind(null,z,pe);return de.push(b),Fe(de).then(()=>{de=[];for(const R of i.list())de.push(Nn(R,z,pe));return de.push(b),Fe(de)}).then(()=>{de=jr(me,"beforeRouteUpdate",z,pe);for(const R of me)R.updateGuards.forEach(F=>{de.push(Nn(F,z,pe))});return de.push(b),Fe(de)}).then(()=>{de=[];for(const R of Be)if(R.beforeEnter)if(Ms(R.beforeEnter))for(const F of R.beforeEnter)de.push(Nn(F,z,pe));else de.push(Nn(R.beforeEnter,z,pe));return de.push(b),Fe(de)}).then(()=>(z.matched.forEach(R=>R.enterCallbacks={}),de=jr(Be,"beforeRouteEnter",z,pe,S),de.push(b),Fe(de))).then(()=>{de=[];for(const R of l.list())de.push(Nn(R,z,pe));return de.push(b),Fe(de)}).catch(R=>en(R,mt.NAVIGATION_CANCELLED)?R:Promise.reject(R))}function H(z,pe,de){r.list().forEach(xe=>S(()=>xe(z,pe,de)))}function M(z,pe,de,xe,me){const Be=v(z,pe);if(Be)return Be;const b=pe===Cn,R=ba?history.state:{};de&&(xe||b?a.replace(z.fullPath,nt({scroll:b&&R&&R.scroll},me)):a.push(z.fullPath,me)),o.value=z,W(z,pe,de,b),B()}let D;function K(){D||(D=a.listen((z,pe,de)=>{if(!he.listening)return;const xe=E(z),me=A(xe,he.currentRoute.value);if(me){O(nt(me,{replace:!0,force:!0}),xe).catch(mi);return}c=xe;const Be=o.value;ba&&r_(fu(Be.fullPath,de.delta),yr()),L(xe,Be).catch(b=>en(b,mt.NAVIGATION_ABORTED|mt.NAVIGATION_CANCELLED)?b:en(b,mt.NAVIGATION_GUARD_REDIRECT)?(O(nt(y(b.to),{force:!0}),xe).then(R=>{en(R,mt.NAVIGATION_ABORTED|mt.NAVIGATION_DUPLICATED)&&!de.delta&&de.type===Co.pop&&a.go(-1,!1)}).catch(mi),Promise.reject()):(de.delta&&a.go(-de.delta,!1),T(b,xe,Be))).then(b=>{b=b||M(xe,Be,!1),b&&(de.delta&&!en(b,mt.NAVIGATION_CANCELLED)?a.go(-de.delta,!1):de.type===Co.pop&&en(b,mt.NAVIGATION_ABORTED|mt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),H(xe,Be,b)}).catch(mi)}))}let ne=Xa(),$=Xa(),I;function T(z,pe,de){B(z);const xe=$.list();return xe.length?xe.forEach(me=>me(z,pe,de)):console.error(z),Promise.reject(z)}function N(){return I&&o.value!==Cn?Promise.resolve():new Promise((z,pe)=>{ne.add([z,pe])})}function B(z){return I||(I=!z,K(),ne.list().forEach(([pe,de])=>z?de(z):pe()),ne.reset()),z}function W(z,pe,de,xe){const{scrollBehavior:me}=e;if(!ba||!me)return Promise.resolve();const Be=!de&&o_(fu(z.fullPath,0))||(xe||!de)&&history.state&&history.state.scroll||null;return Ot().then(()=>me(z,pe,Be)).then(b=>b&&l_(b)).catch(b=>T(b,z,pe))}const te=z=>a.go(z);let oe;const Q=new Set,he={currentRoute:o,listening:!0,addRoute:p,removeRoute:g,clearRoutes:t.clearRoutes,hasRoute:C,getRoutes:m,resolve:E,options:e,push:x,replace:_,go:te,back:()=>te(-1),forward:()=>te(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:$.add,isReady:N,install(z){z.component("RouterLink",F_),z.component("RouterView",H_),z.config.globalProperties.$router=he,Object.defineProperty(z.config.globalProperties,"$route",{enumerable:!0,get:()=>Gs(o)}),ba&&!oe&&o.value===Cn&&(oe=!0,x(a.location).catch(xe=>{}));const pe={};for(const xe in Cn)Object.defineProperty(pe,xe,{get:()=>o.value[xe],enumerable:!0});z.provide(xr,he),z.provide(Lc,Ho(pe)),z.provide(Ao,o);const de=z.unmount;Q.add(z),z.unmount=function(){Q.delete(z),Q.size<1&&(c=Cn,D&&D(),D=null,o.value=Cn,oe=!1,I=!1),de()}}};function Fe(z){return z.reduce((pe,de)=>pe.then(()=>S(de)),Promise.resolve())}return he}function ig(){return Ts(xr)}function j_(e){return Ts(Lc)}const z_=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...["Live","Agents","Loops","Processes","Schedules"].map(e=>({group:"Operations",label:e,icon:"operations",to:{path:"/operations",query:{tab:e.toLowerCase()}}})),...["Audit","Sessions","Traces","Usage"].map(e=>({group:"History",label:e,icon:"history",to:{path:"/history",query:{tab:e.toLowerCase()}}})),...["Tools","Skills","Knowledge","Memory","Learned"].map(e=>({group:"Capabilities",label:e,icon:"capabilities",to:{path:"/capabilities",query:{tab:e.toLowerCase()}}})),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...[["Health","health"],["Resources","resources"],["Logs","logs"],["Config","config"],["Discord","discord"],["Host Access","host-access"],["API Tokens","api-tokens"],["LLM Config","llm"],["Internals","internals"],["Update","update"]].map(([e,t])=>({group:"System",label:e,icon:"system",to:{path:"/system",query:{tab:t}}}))],is=Fn({open:!1,query:"",selected:0});function Tu(){is.query="",is.selected=0,is.open=!0}function zr(){is.open=!1}function q_(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const G_={setup(){const e=ig(),t=h(null),s=ee(()=>{const i=is.query.trim().toLowerCase();return z_.map(l=>({...l,_score:q_(l,i)})).filter(l=>l._score>0).sort((l,r)=>r._score-l._score)});ds(()=>is.open,async i=>{var l;i&&(await Ot(),(l=t.value)==null||l.focus())}),ds(()=>is.query,()=>{is.selected=0});function n(i){zr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),zr();return}if(i.key==="ArrowDown")i.preventDefault(),is.selected=Math.min(is.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),is.selected=Math.max(is.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[is.selected];l&&n(l)}}return{state:is,results:s,inputEl:t,go:n,onKeydown:a,closePalette:zr}},template:`
    <transition name="modal">
...
... (truncated)`:s}function Eu(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function og(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function cg(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const J_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),d=h({reload:!1,clearSessions:!1,stopLoops:!1});let u=0;const f=ee(()=>{const D=e.value.uptime_seconds||0,K=Math.floor(D/86400),ne=Math.floor(D%86400/3600),$=Math.floor(D%3600/60),I=[];return K>0&&I.push(`${K}d`),ne>0&&I.push(`${ne}h`),(I.length===0||K===0&&ne===0)&&I.push(`${$}m`),I.join(" ")}),p=ee(()=>{const D=e.value.uptime_seconds||0;return 125.66*(1-Math.min(D/86400,1))}),g=ee(()=>{const D=e.value;return[{label:"Guilds",value:D.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:D.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:D.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${D.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:D.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:D.loop_count>0?"text-green-400":"",highlight:D.loop_count>0},{label:"Agents",value:D.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:D.agent_count>0?`${D.agent_count} total`:"",subColor:"text-gray-500",highlight:(D.agent_running??0)>0},{label:"Processes",value:D.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:D.process_count>0?`${D.process_count} total`:"",subColor:"text-gray-500",highlight:(D.process_running??0)>0},{label:"Schedules",value:D.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(D.schedule_failing>0?`${D.schedule_failing} failing`:"")+(D.schedule_failing>0&&D.schedule_paused>0?", ":"")+(D.schedule_paused>0?`${D.schedule_paused} paused`:"")||void 0,subColor:D.schedule_failing>0?"text-red-400":"text-yellow-400",color:D.schedule_failing>0?"text-red-400":"",highlight:D.schedule_failing>0},{label:"Users",value:D.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),m=ee(()=>{const D=e.value,K=[];return K.push({label:"Bot",status:D.status==="online"?"ok":"warn",detail:D.status==="online"?"Online":"Starting"}),(D.schedule_failing||0)>0?K.push({label:"Schedules",status:"error",detail:`${D.schedule_failing} failing`}):(D.schedule_count||0)>0&&K.push({label:"Schedules",status:"ok",detail:`${D.schedule_count} configured`}),(D.loop_count||0)>0&&K.push({label:"Loops",status:"ok",detail:`${D.loop_count} active`}),(D.agent_running||0)>0&&K.push({label:"Agents",status:"ok",detail:`${D.agent_running} running`}),(D.process_running||0)>0&&K.push({label:"Processes",status:"ok",detail:`${D.process_running} running`}),K});async function C(){try{e.value=await Y.get("/api/status"),s.value=null}catch(D){s.value=D.message}finally{t.value=!1}}async function E(){a.value=!0;try{n.value=await Y.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function y(){l.value=!0;try{i.value=await Y.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function v(){try{const D=await Y.get("/api/knowledge");c.value=(Array.isArray(D)?D:[]).reduce((K,ne)=>K+(ne.chunks||0),0)}catch{c.value=null}}async function x(){try{const D=await Y.get("/api/agents");r.value=D.filter(K=>K.status==="running")}catch{}}async function _(){d.value={...d.value,reload:!0};try{await Y.post("/api/reload"),Se.success("Config reloaded")}catch(D){Se.error(D.message)}d.value={...d.value,reload:!1}}async function A(){if(!await bs({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;d.value={...d.value,clearSessions:!0};const K=e.value.session_count;e.value={...e.value,session_count:0};try{const ne=await Y.post("/api/sessions/clear-all");Se.success(`Cleared ${ne.count} session${ne.count!==1?"s":""}`),await C()}catch(ne){e.value={...e.value,session_count:K},Se.error(ne.message)}d.value={...d.value,clearSessions:!1}}async function O(){if(!await bs({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;d.value={...d.value,stopLoops:!0};const K=e.value.loop_count;e.value={...e.value,loop_count:0};try{const ne=await Y.post("/api/loops/stop-all");Se.success(ne.result),await C()}catch(ne){e.value={...e.value,loop_count:K},Se.error(ne.message)}d.value={...d.value,stopLoops:!1}}function w(){t.value=!0,s.value=null,C(),E(),y(),x()}let S=null,L=null,H=null;function M(D){if(D.payload&&D.payload.tool_name){const K={...D.payload,_isNew:!0,_key:++u};n.value.unshift(K),n.value.length>10&&n.value.pop(),o.value++,K.error&&(i.value.unshift(K),i.value.length>5&&i.value.pop()),setTimeout(()=>{K._isNew=!1},1500),clearTimeout(H),H=setTimeout(()=>{o.value=0},1e4)}}return Je(async()=>{await Promise.all([C(),E(),y(),x(),v()]),S=setInterval(C,15e3),L=setInterval(x,1e4),We.subscribe("events",M)}),_t(()=>{S&&clearInterval(S),L&&clearInterval(L),clearTimeout(H),We.unsubscribe("events",M)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:g,healthIndicators:m,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:d,fetchActivity:E,fetchStatus:C,formatTime:Dc,formatDuration:ja,retry:w,reloadConfig:_,clearSessions:A,stopAllLoops:O}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Au(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function Y_(e){if(Array.isArray(e))return e}function Q_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(d){c=!0,a=d}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function X_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function ek(e,t){return Y_(e)||Q_(e,t)||tk(e,t)||X_()}function tk(e,t){if(e){if(typeof e=="string")return Au(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Au(e,t):void 0}}const dg=Object.entries,Ru=Object.setPrototypeOf,sk=Object.isFrozen,nk=Object.getPrototypeOf,ak=Object.getOwnPropertyDescriptor;let es=Object.freeze,Es=Object.seal,ya=Object.create,ug=typeof Reflect<"u"&&Reflect,Io=ug.apply,Oo=ug.construct;es||(es=function(t){return t});Es||(Es=function(t){return t});Io||(Io=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});Oo||(Oo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const tn=Ct(Array.prototype.forEach),ik=Ct(Array.prototype.lastIndexOf),Iu=Ct(Array.prototype.pop),ha=Ct(Array.prototype.push),lk=Ct(Array.prototype.splice),Zt=Array.isArray,oi=Ct(String.prototype.toLowerCase),qr=Ct(String.prototype.toString),Ou=Ct(String.prototype.match),ga=Ct(String.prototype.replace),Lu=Ct(String.prototype.indexOf),rk=Ct(String.prototype.trim),ok=Ct(Number.prototype.toString),ck=Ct(Boolean.prototype.toString),Nu=typeof BigInt>"u"?null:Ct(BigInt.prototype.toString),Du=typeof Symbol>"u"?null:Ct(Symbol.prototype.toString),gt=Ct(Object.prototype.hasOwnProperty),ei=Ct(Object.prototype.toString),Pt=Ct(RegExp.prototype.test),Vn=dk(TypeError);function Ct(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return Io(e,t,n)}}function dk(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return Oo(e,s)}}function He(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:oi;if(Ru&&Ru(e,null),!Zt(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(sk(t)||(t[n]=i),a=i)}e[a]=!0}return e}function uk(e){for(let t=0;t<e.length;t++)gt(e,t)||(e[t]=null);return e}function Vt(e){const t=ya(null);for(const n of dg(e)){var s=ek(n,2);const a=s[0],i=s[1];gt(e,a)&&(Zt(i)?t[a]=uk(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Vt(i):t[a]=i)}return t}function fk(e){switch(typeof e){case"string":return e;case"number":return ok(e);case"boolean":return ck(e);case"bigint":return Nu?Nu(e):"0";case"symbol":return Du?Du(e):"Symbol()";case"undefined":return ei(e);case"function":case"object":{if(e===null)return ei(e);const t=e,s=Hs(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:ei(n)}return ei(e)}default:return ei(e)}}function Hs(e,t){for(;e!==null;){const n=ak(e,t);if(n){if(n.get)return Ct(n.get);if(typeof n.value=="function")return Ct(n.value)}e=nk(e)}function s(){return null}return s}function pk(e){try{return Pt(e,""),!0}catch{return!1}}const Mu=es(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Gr=es(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Kr=es(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),hk=es(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Wr=es(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),gk=es(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Pu=es(["#text"]),Fu=es(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Zr=es(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),$u=es(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),cl=es(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),mk=Es(/{{[\w\W]*|^[\w\W]*}}/g),vk=Es(/<%[\w\W]*|^[\w\W]*%>/g),bk=Es(/\${[\w\W]*/g),yk=Es(/^data-[\-\w.\u00B7-\uFFFF]+$/),xk=Es(/^aria-[\-\w]+$/),Uu=Es(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),_k=Es(/^(?:\w+script|data):/i),kk=Es(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),wk=Es(/^html$/i),Sk=Es(/^[a-z][.\w]*(-[.\w]+)+$/i),$s={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},Tk=function(){return typeof window>"u"?null:window},Ck=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Bu=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function fg(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Tk();const t=be=>fg(be);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==$s.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,f=r.prototype,p=Hs(f,"cloneNode"),g=Hs(f,"remove"),m=Hs(f,"nextSibling"),C=Hs(f,"childNodes"),E=Hs(f,"parentNode"),y=Hs(f,"shadowRoot"),v=Hs(f,"attributes"),x=l&&l.prototype?Hs(l.prototype,"nodeType"):null,_=l&&l.prototype?Hs(l.prototype,"nodeName"):null;if(typeof i=="function"){const be=s.createElement("template");be.content&&be.content.ownerDocument&&(s=be.content.ownerDocument)}let A,O="",w,S=!1,L=0;const H=function(){if(L>0)throw Vn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},M=function(k){H(),L++;try{return A.createHTML(k)}finally{L--}},D=function(k){H(),L++;try{return A.createScriptURL(k)}finally{L--}},K=function(){return S||(w=Ck(u,a),S=!0),w},ne=s,$=ne.implementation,I=ne.createNodeIterator,T=ne.createDocumentFragment,N=ne.getElementsByTagName,B=n.importNode;let W=Bu();t.isSupported=typeof dg=="function"&&typeof E=="function"&&$&&$.createHTMLDocument!==void 0;const te=mk,oe=vk,Q=bk,he=yk,Fe=xk,z=_k,pe=kk,de=Sk;let xe=Uu,me=null;const Be=He({},[...Mu,...Gr,...Kr,...Wr,...Pu]);let b=null;const R=He({},[...Fu,...Zr,...$u,...cl]);let F=Object.seal(ya(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),X=null,Z=null;const J=Object.seal(ya(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let ue=!0,re=!0,ie=!1,se=!0,ye=!1,fe=!0,ge=!1,ke=!1,Te=!1,Re=!1,Ne=!1,Pe=!1,Ve=!0,st=!1;const V="user-content-";let _e=!0,Ie=!1,De={},ze=null;const Ye=He({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let ht=null;const ts=He({},["audio","video","img","source","image","track"]);let Is=null;const Ps=He({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Fs="http://www.w3.org/1998/Math/MathML",us="http://www.w3.org/2000/svg",q="http://www.w3.org/1999/xhtml";let Ee=q,fs=!1,Zs=null;const ca=He({},[Fs,us,q],qr);let kn=He({},["mi","mo","mn","ms","mtext"]),Js=He({},["annotation-xml"]);const P=He({},["title","style","font","a","script"]);let j=null;const ae=["application/xhtml+xml","text/html"],we="text/html";let Ce=null,Et=null;const U=s.createElement("form"),le=function(k){return k instanceof RegExp||k instanceof Function},Oe=function(){let k=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Et&&Et===k)return;(!k||typeof k!="object")&&(k={}),k=Vt(k),j=ae.indexOf(k.PARSER_MEDIA_TYPE)===-1?we:k.PARSER_MEDIA_TYPE,Ce=j==="application/xhtml+xml"?qr:oi,me=gt(k,"ALLOWED_TAGS")&&Zt(k.ALLOWED_TAGS)?He({},k.ALLOWED_TAGS,Ce):Be,b=gt(k,"ALLOWED_ATTR")&&Zt(k.ALLOWED_ATTR)?He({},k.ALLOWED_ATTR,Ce):R,Zs=gt(k,"ALLOWED_NAMESPACES")&&Zt(k.ALLOWED_NAMESPACES)?He({},k.ALLOWED_NAMESPACES,qr):ca,Is=gt(k,"ADD_URI_SAFE_ATTR")&&Zt(k.ADD_URI_SAFE_ATTR)?He(Vt(Ps),k.ADD_URI_SAFE_ATTR,Ce):Ps,ht=gt(k,"ADD_DATA_URI_TAGS")&&Zt(k.ADD_DATA_URI_TAGS)?He(Vt(ts),k.ADD_DATA_URI_TAGS,Ce):ts,ze=gt(k,"FORBID_CONTENTS")&&Zt(k.FORBID_CONTENTS)?He({},k.FORBID_CONTENTS,Ce):Ye,X=gt(k,"FORBID_TAGS")&&Zt(k.FORBID_TAGS)?He({},k.FORBID_TAGS,Ce):Vt({}),Z=gt(k,"FORBID_ATTR")&&Zt(k.FORBID_ATTR)?He({},k.FORBID_ATTR,Ce):Vt({}),De=gt(k,"USE_PROFILES")?k.USE_PROFILES&&typeof k.USE_PROFILES=="object"?Vt(k.USE_PROFILES):k.USE_PROFILES:!1,ue=k.ALLOW_ARIA_ATTR!==!1,re=k.ALLOW_DATA_ATTR!==!1,ie=k.ALLOW_UNKNOWN_PROTOCOLS||!1,se=k.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ye=k.SAFE_FOR_TEMPLATES||!1,fe=k.SAFE_FOR_XML!==!1,ge=k.WHOLE_DOCUMENT||!1,Re=k.RETURN_DOM||!1,Ne=k.RETURN_DOM_FRAGMENT||!1,Pe=k.RETURN_TRUSTED_TYPE||!1,Te=k.FORCE_BODY||!1,Ve=k.SANITIZE_DOM!==!1,st=k.SANITIZE_NAMED_PROPS||!1,_e=k.KEEP_CONTENT!==!1,Ie=k.IN_PLACE||!1,xe=pk(k.ALLOWED_URI_REGEXP)?k.ALLOWED_URI_REGEXP:Uu,Ee=typeof k.NAMESPACE=="string"?k.NAMESPACE:q,kn=gt(k,"MATHML_TEXT_INTEGRATION_POINTS")&&k.MATHML_TEXT_INTEGRATION_POINTS&&typeof k.MATHML_TEXT_INTEGRATION_POINTS=="object"?Vt(k.MATHML_TEXT_INTEGRATION_POINTS):He({},["mi","mo","mn","ms","mtext"]),Js=gt(k,"HTML_INTEGRATION_POINTS")&&k.HTML_INTEGRATION_POINTS&&typeof k.HTML_INTEGRATION_POINTS=="object"?Vt(k.HTML_INTEGRATION_POINTS):He({},["annotation-xml"]);const G=gt(k,"CUSTOM_ELEMENT_HANDLING")&&k.CUSTOM_ELEMENT_HANDLING&&typeof k.CUSTOM_ELEMENT_HANDLING=="object"?Vt(k.CUSTOM_ELEMENT_HANDLING):ya(null);if(F=ya(null),gt(G,"tagNameCheck")&&le(G.tagNameCheck)&&(F.tagNameCheck=G.tagNameCheck),gt(G,"attributeNameCheck")&&le(G.attributeNameCheck)&&(F.attributeNameCheck=G.attributeNameCheck),gt(G,"allowCustomizedBuiltInElements")&&typeof G.allowCustomizedBuiltInElements=="boolean"&&(F.allowCustomizedBuiltInElements=G.allowCustomizedBuiltInElements),ye&&(re=!1),Ne&&(Re=!0),De&&(me=He({},Pu),b=ya(null),De.html===!0&&(He(me,Mu),He(b,Fu)),De.svg===!0&&(He(me,Gr),He(b,Zr),He(b,cl)),De.svgFilters===!0&&(He(me,Kr),He(b,Zr),He(b,cl)),De.mathMl===!0&&(He(me,Wr),He(b,$u),He(b,cl))),J.tagCheck=null,J.attributeCheck=null,gt(k,"ADD_TAGS")&&(typeof k.ADD_TAGS=="function"?J.tagCheck=k.ADD_TAGS:Zt(k.ADD_TAGS)&&(me===Be&&(me=Vt(me)),He(me,k.ADD_TAGS,Ce))),gt(k,"ADD_ATTR")&&(typeof k.ADD_ATTR=="function"?J.attributeCheck=k.ADD_ATTR:Zt(k.ADD_ATTR)&&(b===R&&(b=Vt(b)),He(b,k.ADD_ATTR,Ce))),gt(k,"ADD_URI_SAFE_ATTR")&&Zt(k.ADD_URI_SAFE_ATTR)&&He(Is,k.ADD_URI_SAFE_ATTR,Ce),gt(k,"FORBID_CONTENTS")&&Zt(k.FORBID_CONTENTS)&&(ze===Ye&&(ze=Vt(ze)),He(ze,k.FORBID_CONTENTS,Ce)),gt(k,"ADD_FORBID_CONTENTS")&&Zt(k.ADD_FORBID_CONTENTS)&&(ze===Ye&&(ze=Vt(ze)),He(ze,k.ADD_FORBID_CONTENTS,Ce)),_e&&(me["#text"]=!0),ge&&He(me,["html","head","body"]),me.table&&(He(me,["tbody"]),delete X.tbody),k.TRUSTED_TYPES_POLICY){if(typeof k.TRUSTED_TYPES_POLICY.createHTML!="function")throw Vn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof k.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Vn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ce=A;A=k.TRUSTED_TYPES_POLICY;try{O=M("")}catch(Le){throw A=ce,Le}}else k.TRUSTED_TYPES_POLICY===null?(A=void 0,O=""):(A===void 0&&(A=K()),A&&typeof O=="string"&&(O=M("")));(W.uponSanitizeElement.length>0||W.uponSanitizeAttribute.length>0)&&me===Be&&(me=Vt(me)),W.uponSanitizeAttribute.length>0&&b===R&&(b=Vt(b)),es&&es(k),Et=k},lt=He({},[...Gr,...Kr,...hk]),pt=He({},[...Wr,...gk]),ss=function(k){let G=E(k);(!G||!G.tagName)&&(G={namespaceURI:Ee,tagName:"template"});const ce=oi(k.tagName),Le=oi(G.tagName);return Zs[k.namespaceURI]?k.namespaceURI===us?G.namespaceURI===q?ce==="svg":G.namespaceURI===Fs?ce==="svg"&&(Le==="annotation-xml"||kn[Le]):!!lt[ce]:k.namespaceURI===Fs?G.namespaceURI===q?ce==="math":G.namespaceURI===us?ce==="math"&&Js[Le]:!!pt[ce]:k.namespaceURI===q?G.namespaceURI===us&&!Js[Le]||G.namespaceURI===Fs&&!kn[Le]?!1:!pt[ce]&&(P[ce]||!lt[ce]):!!(j==="application/xhtml+xml"&&Zs[k.namespaceURI]):!1},ps=function(k){ha(t.removed,{element:k});try{E(k).removeChild(k)}catch{if(g(k),!E(k))throw Vn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},qc=function(k){const G=C?C(k):k.childNodes;if(G){const Le=[];tn(G,$e=>{ha(Le,$e)}),tn(Le,$e=>{try{g($e)}catch{}})}const ce=v?v(k):null;if(ce)for(let Le=ce.length-1;Le>=0;--Le){const $e=ce[Le],je=$e&&$e.name;if(typeof je=="string")try{k.removeAttribute(je)}catch{}}},Un=function(k,G){try{ha(t.removed,{attribute:G.getAttributeNode(k),from:G})}catch{ha(t.removed,{attribute:null,from:G})}if(G.removeAttribute(k),k==="is")if(Re||Ne)try{ps(G)}catch{}else try{G.setAttribute(k,"")}catch{}},Dg=function(k){const G=v?v(k):k.attributes;if(G)for(let ce=G.length-1;ce>=0;--ce){const Le=G[ce],$e=Le&&Le.name;if(!(typeof $e!="string"||b[Ce($e)]))try{k.removeAttribute($e)}catch{}}},Mg=function(k){const G=[k];for(;G.length>0;){const ce=G.pop();(x?x(ce):ce.nodeType)===$s.element&&Dg(ce);const $e=C?C(ce):ce.childNodes;if($e)for(let je=$e.length-1;je>=0;--je)G.push($e[je])}},Gc=function(k){let G=null,ce=null;if(Te)k="<remove></remove>"+k;else{const je=Ou(k,/^[\r\n\t ]+/);ce=je&&je[0]}j==="application/xhtml+xml"&&Ee===q&&(k='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+k+"</body></html>");const Le=A?M(k):k;if(Ee===q)try{G=new d().parseFromString(Le,j)}catch{}if(!G||!G.documentElement){G=$.createDocument(Ee,"template",null);try{G.documentElement.innerHTML=fs?O:Le}catch{}}const $e=G.body||G.documentElement;return k&&ce&&$e.insertBefore(s.createTextNode(ce),$e.childNodes[0]||null),Ee===q?N.call(G,ge?"html":"body")[0]:ge?G.documentElement:$e},Kc=function(k){return I.call(k.ownerDocument||k,k,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},Sr=function(k){var G,ce;k.normalize();const Le=I.call(k.ownerDocument||k,k,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let $e=Le.nextNode();for(;$e;){let At=$e.data;tn([te,oe,Q],ot=>{At=ga(At,ot," ")}),$e.data=At,$e=Le.nextNode()}const je=(G=(ce=k.querySelectorAll)===null||ce===void 0?void 0:ce.call(k,"template"))!==null&&G!==void 0?G:[];tn(Array.from(je),At=>{da(At.content)&&Sr(At.content)})},Zi=function(k){const G=_?_(k):null;return typeof G!="string"||Ce(G)!=="form"?!1:typeof k.nodeName!="string"||typeof k.textContent!="string"||typeof k.removeChild!="function"||k.attributes!==v(k)||typeof k.removeAttribute!="function"||typeof k.setAttribute!="function"||typeof k.namespaceURI!="string"||typeof k.insertBefore!="function"||typeof k.hasChildNodes!="function"||k.nodeType!==x(k)||k.childNodes!==C(k)},da=function(k){if(!x||typeof k!="object"||k===null)return!1;try{return x(k)===$s.documentFragment}catch{return!1}},Ka=function(k){if(!x||typeof k!="object"||k===null)return!1;try{return typeof x(k)=="number"}catch{return!1}};function Ys(be,k,G){tn(be,ce=>{ce.call(t,k,G,Et)})}const Wc=function(k){let G=null;if(Ys(W.beforeSanitizeElements,k,null),Zi(k))return ps(k),!0;const ce=Ce(_?_(k):k.nodeName);if(Ys(W.uponSanitizeElement,k,{tagName:ce,allowedTags:me}),fe&&k.hasChildNodes()&&!Ka(k.firstElementChild)&&Pt(/<[/\w!]/g,k.innerHTML)&&Pt(/<[/\w!]/g,k.textContent)||fe&&k.namespaceURI===q&&ce==="style"&&Ka(k.firstElementChild)||k.nodeType===$s.progressingInstruction||fe&&k.nodeType===$s.comment&&Pt(/<[/\w]/g,k.data))return ps(k),!0;if(X[ce]||!(J.tagCheck instanceof Function&&J.tagCheck(ce))&&!me[ce]){if(!X[ce]&&Jc(ce)&&(F.tagNameCheck instanceof RegExp&&Pt(F.tagNameCheck,ce)||F.tagNameCheck instanceof Function&&F.tagNameCheck(ce)))return!1;if(_e&&!ze[ce]){const $e=E(k),je=C(k);if(je&&$e){const At=je.length;for(let ot=At-1;ot>=0;--ot){const bt=Ie?je[ot]:p(je[ot],!0);$e.insertBefore(bt,m(k))}}}return ps(k),!0}return(x?x(k):k.nodeType)===$s.element&&!ss(k)||(ce==="noscript"||ce==="noembed"||ce==="noframes")&&Pt(/<\/no(script|embed|frames)/i,k.innerHTML)?(ps(k),!0):(ye&&k.nodeType===$s.text&&(G=k.textContent,tn([te,oe,Q],$e=>{G=ga(G,$e," ")}),k.textContent!==G&&(ha(t.removed,{element:k.cloneNode()}),k.textContent=G)),Ys(W.afterSanitizeElements,k,null),!1)},Zc=function(k,G,ce){if(Z[G]||Ve&&(G==="id"||G==="name")&&(ce in s||ce in U))return!1;const Le=b[G]||J.attributeCheck instanceof Function&&J.attributeCheck(G,k);if(!(re&&!Z[G]&&Pt(he,G))){if(!(ue&&Pt(Fe,G))){if(!Le||Z[G]){if(!(Jc(k)&&(F.tagNameCheck instanceof RegExp&&Pt(F.tagNameCheck,k)||F.tagNameCheck instanceof Function&&F.tagNameCheck(k))&&(F.attributeNameCheck instanceof RegExp&&Pt(F.attributeNameCheck,G)||F.attributeNameCheck instanceof Function&&F.attributeNameCheck(G,k))||G==="is"&&F.allowCustomizedBuiltInElements&&(F.tagNameCheck instanceof RegExp&&Pt(F.tagNameCheck,ce)||F.tagNameCheck instanceof Function&&F.tagNameCheck(ce))))return!1}else if(!Is[G]){if(!Pt(xe,ga(ce,pe,""))){if(!((G==="src"||G==="xlink:href"||G==="href")&&k!=="script"&&Lu(ce,"data:")===0&&ht[k])){if(!(ie&&!Pt(z,ga(ce,pe,"")))){if(ce)return!1}}}}}}return!0},Pg=He({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Jc=function(k){return!Pg[oi(k)]&&Pt(de,k)},Yc=function(k){Ys(W.beforeSanitizeAttributes,k,null);const G=k.attributes;if(!G||Zi(k))return;const ce={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:b,forceKeepAttr:void 0};let Le=G.length;for(;Le--;){const $e=G[Le],je=$e.name,At=$e.namespaceURI,ot=$e.value,bt=Ce(je),wn=ot;let Nt=je==="value"?wn:rk(wn);if(ce.attrName=bt,ce.attrValue=Nt,ce.keepAttr=!0,ce.forceKeepAttr=void 0,Ys(W.uponSanitizeAttribute,k,ce),Nt=ce.attrValue,st&&(bt==="id"||bt==="name")&&Lu(Nt,V)!==0&&(Un(je,k),Nt=V+Nt),fe&&Pt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Nt)){Un(je,k);continue}if(bt==="attributename"&&Ou(Nt,"href")){Un(je,k);continue}if(ce.forceKeepAttr)continue;if(!ce.keepAttr){Un(je,k);continue}if(!se&&Pt(/\/>/i,Nt)){Un(je,k);continue}ye&&tn([te,oe,Q],Xc=>{Nt=ga(Nt,Xc," ")});const Qc=Ce(k.nodeName);if(!Zc(Qc,bt,Nt)){Un(je,k);continue}if(A&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!At)switch(u.getAttributeType(Qc,bt)){case"TrustedHTML":{Nt=M(Nt);break}case"TrustedScriptURL":{Nt=D(Nt);break}}if(Nt!==wn)try{At?k.setAttributeNS(At,je,Nt):k.setAttribute(je,Nt),Zi(k)?ps(k):Iu(t.removed)}catch{Un(je,k)}}Ys(W.afterSanitizeAttributes,k,null)},Ji=function(k){let G=null;const ce=Kc(k);for(Ys(W.beforeSanitizeShadowDOM,k,null);G=ce.nextNode();)if(Ys(W.uponSanitizeShadowNode,G,null),Wc(G),Yc(G),da(G.content)&&Ji(G.content),(x?x(G):G.nodeType)===$s.element){const $e=y?y(G):G.shadowRoot;da($e)&&(Tr($e),Ji($e))}Ys(W.afterSanitizeShadowDOM,k,null)},Tr=function(k){const G=[{node:k,shadow:null}];for(;G.length>0;){const ce=G.pop();if(ce.shadow){Ji(ce.shadow);continue}const Le=ce.node,je=(x?x(Le):Le.nodeType)===$s.element,At=C?C(Le):Le.childNodes;if(At)for(let ot=At.length-1;ot>=0;--ot)G.push({node:At[ot],shadow:null});if(je){const ot=_?_(Le):null;if(typeof ot=="string"&&Ce(ot)==="template"){const bt=Le.content;da(bt)&&G.push({node:bt,shadow:null})}}if(je){const ot=y?y(Le):Le.shadowRoot;da(ot)&&G.push({node:null,shadow:ot},{node:ot,shadow:null})}}};return t.sanitize=function(be){let k=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},G=null,ce=null,Le=null,$e=null;if(fs=!be,fs&&(be="<!-->"),typeof be!="string"&&!Ka(be)&&(be=fk(be),typeof be!="string"))throw Vn("dirty is not a string, aborting");if(!t.isSupported)return be;ke||Oe(k),t.removed=[];const je=Ie&&typeof be!="string"&&Ka(be);if(je){const bt=_?_(be):be.nodeName;if(typeof bt=="string"){const wn=Ce(bt);if(!me[wn]||X[wn])throw Vn("root node is forbidden and cannot be sanitized in-place")}if(Zi(be))throw Vn("root node is clobbered and cannot be sanitized in-place");try{Tr(be)}catch(wn){throw qc(be),wn}}else if(Ka(be))G=Gc("<!---->"),ce=G.ownerDocument.importNode(be,!0),ce.nodeType===$s.element&&ce.nodeName==="BODY"||ce.nodeName==="HTML"?G=ce:G.appendChild(ce),Tr(ce);else{if(!Re&&!ye&&!ge&&be.indexOf("<")===-1)return A&&Pe?M(be):be;if(G=Gc(be),!G)return Re?null:Pe?O:""}G&&Te&&ps(G.firstChild);const At=Kc(je?be:G);try{for(;Le=At.nextNode();)Wc(Le),Yc(Le),da(Le.content)&&Ji(Le.content)}catch(bt){throw je&&qc(be),bt}if(je)return tn(t.removed,bt=>{bt.element&&Mg(bt.element)}),ye&&Sr(be),be;if(Re){if(ye&&Sr(G),Ne)for($e=T.call(G.ownerDocument);G.firstChild;)$e.appendChild(G.firstChild);else $e=G;return(b.shadowroot||b.shadowrootmode)&&($e=B.call(n,$e,!0)),$e}let ot=ge?G.outerHTML:G.innerHTML;return ge&&me["!doctype"]&&G.ownerDocument&&G.ownerDocument.doctype&&G.ownerDocument.doctype.name&&Pt(wk,G.ownerDocument.doctype.name)&&(ot="<!DOCTYPE "+G.ownerDocument.doctype.name+`>
`+ot),ye&&tn([te,oe,Q],bt=>{ot=ga(ot,bt," ")}),A&&Pe?M(ot):ot},t.setConfig=function(){let be=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Oe(be),ke=!0},t.clearConfig=function(){Et=null,ke=!1,A=w,O=""},t.isValidAttribute=function(be,k,G){Et||Oe({});const ce=Ce(be),Le=Ce(k);return Zc(ce,Le,G)},t.addHook=function(be,k){typeof k=="function"&&ha(W[be],k)},t.removeHook=function(be,k){if(k!==void 0){const G=ik(W[be],k);return G===-1?void 0:lk(W[be],G,1)[0]}return Iu(W[be])},t.removeHooks=function(be){W[be]=[]},t.removeAllHooks=function(){W=Bu()},t}var Hu=fg();function Pc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var oa=Pc();function pg(e){oa=e}var vi={exec:()=>null};function at(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Qt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var Qt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},Ek=/^(?:[ \t]*(?:\n|$))+/,Ak=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Rk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Wi=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ik=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Fc=/(?:[*+-]|\d{1,9}[.)])/,hg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,gg=at(hg).replace(/bull/g,Fc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Ok=at(hg).replace(/bull/g,Fc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),$c=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Lk=/^[^\n]+/,Uc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Nk=at(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Uc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Dk=at(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Fc).getRegex(),_r="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Bc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Mk=at("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Bc).replace("tag",_r).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),mg=at($c).replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_r).getRegex(),Pk=at(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",mg).getRegex(),Hc={blockquote:Pk,code:Ak,def:Nk,fences:Rk,heading:Ik,hr:Wi,html:Mk,lheading:gg,list:Dk,newline:Ek,paragraph:mg,table:vi,text:Lk},Vu=at("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_r).getRegex(),Fk={...Hc,lheading:Ok,table:Vu,paragraph:at($c).replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Vu).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_r).getRegex()},$k={...Hc,html:at(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Bc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:vi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:at($c).replace("hr",Wi).replace("heading",` *#{1,6} *[^
]`).replace("lheading",gg).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Uk=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Bk=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,vg=/^( {2,}|\\)\n(?!\s*$)/,Hk=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,kr=/[\p{P}\p{S}]/u,Vc=/[\s\p{P}\p{S}]/u,bg=/[^\s\p{P}\p{S}]/u,Vk=at(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Vc).getRegex(),yg=/(?!~)[\p{P}\p{S}]/u,jk=/(?!~)[\s\p{P}\p{S}]/u,zk=/(?:[^\s\p{P}\p{S}]|~)/u,qk=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,xg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Gk=at(xg,"u").replace(/punct/g,kr).getRegex(),Kk=at(xg,"u").replace(/punct/g,yg).getRegex(),_g="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Wk=at(_g,"gu").replace(/notPunctSpace/g,bg).replace(/punctSpace/g,Vc).replace(/punct/g,kr).getRegex(),Zk=at(_g,"gu").replace(/notPunctSpace/g,zk).replace(/punctSpace/g,jk).replace(/punct/g,yg).getRegex(),Jk=at("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,bg).replace(/punctSpace/g,Vc).replace(/punct/g,kr).getRegex(),Yk=at(/\\(punct)/,"gu").replace(/punct/g,kr).getRegex(),Qk=at(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Xk=at(Bc).replace("(?:-->|$)","-->").getRegex(),ew=at("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Xk).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Gl=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,tw=at(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Gl).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),kg=at(/^!?\[(label)\]\[(ref)\]/).replace("label",Gl).replace("ref",Uc).getRegex(),wg=at(/^!?\[(ref)\](?:\[\])?/).replace("ref",Uc).getRegex(),sw=at("reflink|nolink(?!\\()","g").replace("reflink",kg).replace("nolink",wg).getRegex(),jc={_backpedal:vi,anyPunctuation:Yk,autolink:Qk,blockSkip:qk,br:vg,code:Bk,del:vi,emStrongLDelim:Gk,emStrongRDelimAst:Wk,emStrongRDelimUnd:Jk,escape:Uk,link:tw,nolink:wg,punctuation:Vk,reflink:kg,reflinkSearch:sw,tag:ew,text:Hk,url:vi},nw={...jc,link:at(/^!?\[(label)\]\((.*?)\)/).replace("label",Gl).getRegex(),reflink:at(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Gl).getRegex()},Lo={...jc,emStrongRDelimAst:Zk,emStrongLDelim:Kk,url:at(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},aw={...Lo,br:at(vg).replace("{2,}","*").getRegex(),text:at(Lo.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},dl={normal:Hc,gfm:Fk,pedantic:$k},ti={normal:jc,gfm:Lo,breaks:aw,pedantic:nw},iw={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ju=e=>iw[e];function Vs(e,t){if(t){if(Qt.escapeTest.test(e))return e.replace(Qt.escapeReplace,ju)}else if(Qt.escapeTestNoEncode.test(e))return e.replace(Qt.escapeReplaceNoEncode,ju);return e}function zu(e){try{e=encodeURI(e).replace(Qt.percentDecode,"%")}catch{return null}return e}function qu(e,t){var i;const s=e.replace(Qt.findPipe,(l,r,o)=>{let c=!1,d=r;for(;--d>=0&&o[d]==="\\";)c=!c;return c?"|":" |"}),n=s.split(Qt.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(Qt.slashPipe,"|");return n}function si(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function lw(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function Gu(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function rw(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const s=t[0],n=rw(s,t[3]||"",this.rules);return{type:"code",raw:s,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:n}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let s=t[2].trim();if(this.rules.other.endingHash.test(s)){const n=si(s,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(s=n.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:si(t[0],`
...
`,e=e.substring(f.length+1),o=!0),!o){const E=this.rules.other.nextBulletRegex(g),y=this.rules.other.hrRegex(g),v=this.rules.other.fencesBeginRegex(g),x=this.rules.other.headingBeginRegex(g),_=this.rules.other.htmlBeginRegex(g);for(;e;){const A=e.split(`
`,1)[0];let O;if(f=A,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),O=f):O=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||_.test(f)||E.test(f)||y.test(f))break;if(O.search(this.rules.other.nonSpaceChar)>=g||!f.trim())d+=`
`+O.slice(g);else{if(p||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||v.test(u)||x.test(u)||y.test(u))break;d+=`
`+f}!p&&!f.trim()&&(p=!0),c+=A+`
`,e=e.substring(A.length+1),u=O.slice(g)}}a.loose||(l?a.loose=!0:this.rules.other.doubleBlankLine.test(c)&&(l=!0));let m=null,C;this.options.gfm&&(m=this.rules.other.listIsTask.exec(d),m&&(C=m[0]!=="[ ] ",d=d.replace(this.rules.other.listReplaceTask,""))),a.items.push({type:"list_item",raw:c,task:!!m,checked:C,loose:!1,text:d,tokens:[]}),a.raw+=c}const r=a.items.at(-1);if(r)r.raw=r.raw.trimEnd(),r.text=r.text.trimEnd();else return;a.raw=a.raw.trimEnd();for(let o=0;o<a.items.length;o++)if(this.lexer.state.top=!1,a.items[o].tokens=this.lexer.blockTokens(a.items[o].text,[]),!a.loose){const c=a.items[o].tokens.filter(u=>u.type==="space"),d=c.length>0&&c.some(u=>this.rules.other.anyLine.test(u.raw));a.loose=d}if(a.loose)for(let o=0;o<a.items.length;o++)a.items[o].loose=!0;return a}}html(e){const t=this.rules.block.html.exec(e);if(t)return{type:"html",block:!0,raw:t[0],pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:t[0]}}def(e){const t=this.rules.block.def.exec(e);if(t){const s=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),n=t[2]?t[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",a=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:s,raw:t[0],href:n,title:a}}}table(e){var l;const t=this.rules.block.table.exec(e);if(!t||!this.rules.other.tableDelimiter.test(t[2]))return;const s=qu(t[1]),n=t[2].replace(this.rules.other.tableAlignChars,"").split("|"),a=(l=t[3])!=null&&l.trim()?t[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Vs(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},sa=new ow;function tt(e,t){return sa.parse(e,t)}tt.options=tt.setOptions=function(e){return sa.setOptions(e),tt.defaults=sa.defaults,pg(tt.defaults),tt};tt.getDefaults=Pc;tt.defaults=oa;tt.use=function(...e){return sa.use(...e),tt.defaults=sa.defaults,pg(tt.defaults),tt};tt.walkTokens=function(e,t){return sa.walkTokens(e,t)};tt.parseInline=sa.parseInline;tt.Parser=un;tt.parser=un.parse;tt.Renderer=Wl;tt.TextRenderer=zc;tt.Lexer=dn;tt.lexer=dn.lex;tt.Tokenizer=Kl;tt.Hooks=bl;tt.parse=tt;tt.options;tt.setOptions;tt.use;tt.walkTokens;tt.parseInline;un.parse;dn.lex;const cw={breaks:!0,gfm:!0};function Ku(e){if(!e)return"";try{if(typeof tt<"u"&&tt.parse){const t=tt.parse(e,cw);return typeof Hu<"u"?Hu.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function dw(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const uw={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function fw(e){return uw[e]||"wrench"}const pw=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Wu(e){if(!e)return[];const t=e.match(pw);return t?[...new Set(t)]:[]}const hw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],d=ee(()=>t.value.trim().length>0&&!s.value),u=h(We.state||"disconnected");let f=null,p=null;const g=ee(()=>{const $=u.value;return $==="connected"?"Connected":$==="reconnecting"?"Reconnecting…":$==="connecting"?"Connecting…":"REST fallback"}),m=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],C=ee(()=>{const $=Math.floor(i.value/4)%m.length,I=i.value;return I>3?`${m[$]} (${I}s)`:m[0]});function E(){Ot(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!a.value)return;const $=a.value;$.style.height="auto",$.style.height=Math.min($.scrollHeight,120)+"px"}function v($,I,T={}){const N={id:++o,role:$,content:I,timestamp:Date.now(),html:$==="bot"?Ku(I):"",tools_used:T.tools_used||[],is_error:T.is_error||!1,images:$==="bot"?Wu(I):[],files:T.files||[],_showTools:!1};return e.value.push(N),E(),$==="bot"&&Ot(()=>x()),N}function x(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(I=>{I.setAttribute("data-copy","true"),I.style.position="relative";const T=document.createElement("button");T.className="chat-code-copy",T.textContent="Copy",T.addEventListener("click",()=>{const N=I.querySelector("code"),B=N?N.textContent:I.textContent;navigator.clipboard.writeText(B).then(()=>{T.textContent="Copied!",setTimeout(()=>{T.textContent="Copy"},1500)}).catch(()=>{})}),I.appendChild(T)})}function _($){if($===0)return!0;const I=e.value[$-1],T=e.value[$],N=new Date(I.timestamp).toDateString(),B=new Date(T.timestamp).toDateString();return N!==B}function A($){const I=new Date($),T=new Date;if(I.toDateString()===T.toDateString())return"Today";const N=new Date(T);return N.setDate(N.getDate()-1),I.toDateString()===N.toDateString()?"Yesterday":I.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function O($){t.value=$,Ot(()=>K())}function w($){window.open($,"_blank","noopener")}function S($){$.target.style.display="none"}function L(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function H(){r&&(clearInterval(r),r=null),i.value=0}function M($){s.value&&(s.value=!1,H(),$.type==="chat_response"?v("bot",$.content,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]}):$.type==="chat_error"&&v("bot",$.error||"Unknown error",{is_error:!0}),Ot(()=>{var I;return(I=a.value)==null?void 0:I.focus()}))}async function D($){try{const I=await Y.post("/api/chat",{content:$,channel_id:l.value});v("bot",I.response,{tools_used:I.tools_used||[],is_error:I.is_error||!1,files:I.files||[]})}catch(I){v("bot",I.message||"Failed to send message",{is_error:!0})}}async function K(){const $=t.value.trim();if(!$||s.value)return;v("user",$),t.value="",s.value=!0,L(),a.value&&(a.value.style.height="auto"),We.connected&&We.sendChat($,{channelId:l.value})||(await D($),s.value=!1,H()),Ot(()=>{var T;return(T=a.value)==null?void 0:T.focus()})}async function ne(){try{if(!l.value){const I=await Y.get("/api/auth/session");l.value=I.channel_id||I.user_id||"web-user"}const $=await Y.get("/api/sessions/"+encodeURIComponent(l.value));if($&&$.messages&&$.messages.length>0){for(const I of $.messages){const T=I.role==="user"?"user":"bot";let N=I.content||"";if(T==="user"){const W=N.match(/^\[.*?\]:\s*/);W&&(N=N.slice(W[0].length))}if(!N.trim())continue;const B={id:++o,role:T,content:N,timestamp:I.timestamp?I.timestamp*1e3:Date.now(),html:T==="bot"?Ku(N):"",tools_used:[],is_error:!1,images:T==="bot"?Wu(N):[],files:[],_showTools:!1};e.value.push(B)}Ot(()=>{E(),x()})}}catch{}}return Je(()=>{We.subscribe("chat",M),u.value=We.state||"disconnected",f=We.onStateChange,p=($,I)=>{u.value=$,f&&f($,I)},We.onStateChange=p,ne(),Ot(()=>{var $;return($=a.value)==null?void 0:$.focus()})}),_t(()=>{We.unsubscribe("chat",M),We.onStateChange===p&&(We.onStateChange=f),H()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:d,wsStatus:g,typingText:C,suggestions:c,send:K,autoResize:y,formatTime:dw,formatDate:A,showDateSeparator:_,useSuggestion:O,openImage:w,onImageError:S,getToolIcon:fw}}},wr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=j_(),s=ig(),n=ee({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});ds(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},gw={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(f){var m,C,E,y,v;const p=f.payload||f,g=p.type||f.type;if(g==="tool_start"){const x=((m=p.metadata)==null?void 0:m.call_id)||null,_={callId:x,id:x||`${p.action}-${Date.now()}`,tool:p.action,actor:p.actor||"",channel:p.channel_id||"",iteration:((C=p.metadata)==null?void 0:C.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(_);return}if(g==="tool_end"){const x=((E=p.metadata)==null?void 0:E.call_id)||null;let _=-1;if(x&&(_=e.value.findIndex(A=>A.callId===x&&A.status==="running")),_<0&&!x)for(let A=e.value.length-1;A>=0;A--){const O=e.value[A];if(O.tool===p.action&&O.status==="running"){_=A;break}}if(_>=0){const A=e.value[_];A.status=(y=p.metadata)!=null&&y.error?"error":"success",A.elapsed=((v=p.metadata)==null?void 0:v.elapsed_ms)||Date.now()-A.startTime,A.result=p.detail||"",A.fadingOut=!0,setTimeout(()=>{const O=e.value.indexOf(A);O>=0&&e.value.splice(O,1),t.value.unshift(A),t.value.length>n&&t.value.pop()},5e3)}return}if(g==="tool_stream"){const x=p.call_id||p.tool_name||"unknown";if(p.finished){const _={...s.value};delete _[x],s.value=_}else{const A=((s.value[x]||"")+(p.chunk||"")).split(`
`);s.value={...s.value,[x]:A.slice(-30).join(`
`)}}return}}let i=null;function l(){const f=Date.now();e.value.forEach(p=>{p.status==="running"&&(p.elapsed=f-p.startTime)})}let r=!1;function o(){r||(r=!0,We.on("events",a),i||(i=setInterval(l,500)))}function c(){r&&(r=!1,We.off("events",a),i&&(clearInterval(i),i=null))}Je(o),As(o),Rs(c),_t(c);function d(f){return f<1e3?`${f}ms`:`${(f/1e3).toFixed(1)}s`}function u(f){return f==="running"?"clock":f==="success"?"success":f==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
  ...
  `},Sg=Symbol("agent-detail-cancelled"),mw=15e3;function vw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((p,g)=>{o=p,c=g});function u(p,g){r||(r=!0,l!==null&&a(l),l=null,(p?o:c)(g))}let f;try{f=e(i==null?void 0:i.signal)}catch(p){u(!1,p)}return r||Promise.resolve(f).then(p=>u(!0,p),p=>u(!1,p)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const p=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${p}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sg),i==null||i.abort()}}}function Tg({state:e,requestDetail:t,timeoutMs:s=mw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const f=l;l=null,f==null||f.cancel()}function o(f,{initial:p,coalesce:g}){if(!f)return Promise.resolve();if(g&&l&&l.agentId===f&&e.detailId===f)return l.promise;r();const m={agentId:f,cancel:null,promise:null};l=m,p?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const C=vw(E=>t(f,{signal:E}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return m.cancel=C.cancel,m.promise=(async()=>{let E=null,y=null;try{E=await C.promise}catch(v){y=v}E!==Sg&&(l!==m||e.detailId!==f||(l=null,!y&&(E===null||typeof E!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=E,e.detailError=null),e.detailLoading=!1))})(),m.promise}function c(f){return e.detailId=f,o(f,{initial:!0,coalesce:!1})}function d(){const f=e.detailId;return f?o(f,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function bw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const yw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const r=ee(()=>e.value.filter(T=>T.status==="running").length),o=ee(()=>e.value.filter(T=>T.status==="completed").length),c=ee(()=>e.value.filter(T=>["failed","timeout","killed"].includes(T.status)).length),d=ee(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),u=ee(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(T=>["failed","timeout","killed"].includes(T.status)):e.value.filter(T=>T.status===i.value));function f(T){const N=Number(T.max_iterations)||0;return N<=0?0:Math.min(100,Math.round(T.iteration_count/N*100))}function p(T){return(Number(T.max_iterations)||0)>0}function g(T,N){return T?T==="N/A"?"N/A":N==="current_inheritance"?`inherit (currently ${T})`:T:"unknown"}function m(T){return g(T.display_model,T.display_model_source||T.display_source)}function C(T){return g(T.display_reasoning_effort,T.display_reasoning_effort_source||T.display_source)}function E(T){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[T]||""}const y=h(null),v=h(null),x=h(!1),_=h(null),A=h(""),w=Tg({state:{get detail(){return y.value},set detail(T){y.value=T},get detailId(){return v.value},set detailId(T){v.value=T},get detailLoading(){return x.value},set detailLoading(T){x.value=T},get detailError(){return _.value},set detailError(T){_.value=T}},requestDetail:(T,{signal:N})=>Y.get(`/api/agents/${encodeURIComponent(T)}`,{signal:N})});async function S(T){A.value="",await w.open(T.id)}function L(){w.close(),A.value=""}async function H(){await w.refresh()}async function M(T,N){try{await navigator.clipboard.writeText(N||""),A.value=T,setTimeout(()=>{A.value===T&&(A.value="")},1500)}catch{Se.error("Copy failed")}}async function D(T=!1){T=T===!0,T||(t.value=!0);try{const N=await Y.get("/api/agents");e.value=Array.isArray(N)?N:[],s.value=null}catch(N){T||(s.value=N.message)}T||(t.value=!1)}async function K(T){const N=e.value.find(W=>W.id===T);if(await bs({title:"Kill agent",message:`Kill agent "${(N==null?void 0:N.label)||T}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=T;try{await Y.del(`/api/agents/${encodeURIComponent(T)}`),Se.success("Agent killed"),await D()}catch(W){Se.error(W.message||"Failed to kill agent")}n.value=null}}const ne=bw({isEnabled:()=>a.value&&l,refreshList:()=>D(!0),hasOpenDetail:()=>!!v.value,refreshDetail:H});function $(){ne.start()}function I(){ne.stop()}return ds(a,()=>ne.sync()),Je(()=>{l=!0,D(),$()}),As(()=>{l=!0,D(!0),$()}),Rs(()=>{l=!1,I()}),_t(()=>{l=!1,I(),w.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ra,formatDuration:ja,progressPercent:f,hasProgress:p,displayModelText:m,displayEffortText:C,displaySourceLabel:E,detail:y,detailId:v,detailLoading:x,detailError:_,copied:A,openDetail:S,closeDetail:L,copyText:M,fetchAgents:D,killAgent:K,startAutoRefresh:$,stopAutoRefresh:I}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h(null),d=h(null),u=h(!1),f=h(null),p=h("");let g=!1;const C=Tg({state:{get detail(){return c.value},set detail(I){c.value=I},get detailId(){return d.value},set detailId(I){d.value=I},get detailLoading(){return u.value},set detailLoading(I){u.value=I},get detailError(){return f.value},set detailError(I){f.value=I}},detailLabel:"Loop detail",requestDetail:(I,{signal:T})=>Y.get(`/api/loops/${encodeURIComponent(I)}?limit=100`,{signal:T})});async function E(I){p.value="",await C.open(I.id)}function y(){C.close(),p.value=""}async function v(I,T){try{await navigator.clipboard.writeText(T||""),p.value=I,setTimeout(()=>{p.value===I&&(p.value="")},1500)}catch{Se.error("Copy failed")}}const x=ee(()=>e.value.reduce((I,T)=>I+(T.iteration_count||0),0)),_=ee(()=>e.value.filter(I=>I.status==="running").length);function A(I){return I==="running"?"loop-status-running":I==="error"?"loop-status-error":"loop-status-stopped"}function O(I){return I==="running"?"badge-success":I==="error"?"badge-danger":I==="completed"?"badge-info":"badge-warning"}function w(I){return I==="act"?"badge-warning":I==="silent"?"badge-info":"badge-success"}async function S(I=!1){I=I===!0,I||(t.value=!0);try{const T=await Y.get("/api/loops");e.value=Array.isArray(T)?T:[],s.value=null}catch(T){I||(s.value=T.message)}I||(t.value=!1)}async function L(){l.value=null;const I=a.value;if(!I.goal.trim()){l.value="Goal is required";return}if(!I.channel_id.trim()){l.value="Channel ID is required";return}const T={goal:I.goal.trim(),channel_id:I.channel_id.trim(),interval_seconds:I.interval_seconds||60,mode:I.mode,max_iterations:I.max_iterations||50};I.stop_condition.trim()&&(T.stop_condition=I.stop_condition.trim()),i.value=!0;try{const N=await Y.post("/api/loops",T);Se.success(`Loop started: ${N.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await S()}catch(N){l.value=N.message}i.value=!1}async function H(I){if(await bs({title:"Stop loop",message:`Stop loop ${I}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=I;try{await Y.del(`/api/loops/${encodeURIComponent(I)}`),Se.success("Loop stopped"),await S()}catch(N){Se.error(N.message||"Failed to stop loop")}r.value=null}}async function M(I){o.value=I;try{await Y.post(`/api/loops/${encodeURIComponent(I)}/restart`),Se.success("Loop restarted"),await S()}catch(T){Se.error(T.message||"Failed to restart loop")}o.value=null}function D(I){g&&I.payload&&(I.payload.loop_id||I.payload.type==="loop")&&(S(!0),d.value&&C.refresh())}let K=null;function ne(){K!==null&&clearInterval(K),K=null}function $(){ne(),g&&(K=setInterval(()=>{S(!0),d.value&&C.refresh()},5e3))}return Je(()=>{g=!0,S(),We.subscribe("events",D),$()}),As(()=>{g=!0,S(!0),$()}),Rs(()=>{g=!1,ne()}),_t(()=>{g=!1,We.unsubscribe("events",D),ne(),C.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:f,copied:p,totalIterations:x,runningCount:_,statusDotClass:A,statusBadge:O,modeBadge:w,formatAge:lg,formatDuration:ja,formatTs:ra,formatTokens:cg,openDetail:E,closeDetail:y,copyText:v,fetchLoops:S,doCreate:L,doStop:H,doRestart:M}}},_w={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=ee(()=>e.value.filter(y=>y.status==="running").length),r=ee(()=>e.value.filter(y=>y.status!=="running").length);function o(y){return y==="running"?"loop-status-running":y==="failed"||y==="error"?"loop-status-error":"loop-status-stopped"}function c(y){return y==="running"?"badge-success":y==="completed"||y==="exited"?"badge-info":y==="killed"||y==="error"||y==="failed"?"badge-danger":"badge-warning"}async function d(y=!1){y=y===!0,y||(t.value=!0);try{e.value=await Y.get("/api/processes"),s.value=null}catch(v){y||(s.value=v.message)}y||(t.value=!1)}function u(){f(),n.value&&(a=setInterval(()=>{t.value||d(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}ds(n,y=>{y?u():f()});async function p(y){if(await bs({title:"Kill process",message:`Kill process ${y}?`,confirmLabel:"Kill",danger:!0})){i.value=y;try{await Y.del(`/api/processes/${y}`),Se.success(`Process ${y} killed`),await d()}catch(x){Se.error(x.message||"Failed to kill process")}i.value=null}}function g(y){y.payload&&(y.payload.pid||y.payload.type==="process")&&d(!0)}let m=!1;function C(){m||(m=!0,d(),We.subscribe("events",g),u())}function E(){m&&(m=!1,We.unsubscribe("events",g),f())}return Je(C),As(C),Rs(E),_t(E),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:ja,fetchProcesses:d,doKill:p}}},kw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],d=h(null),u=h(null),f=h(null),p=h(null),g=h(null),m=h([]),C=h(!1),E=h("");let y=0;const v=ee(()=>e.value.filter(N=>N.cron&&!N.one_time).length),x=ee(()=>e.value.filter(N=>N.one_time).length),_=ee(()=>e.value.filter(N=>N.trigger).length),A=ee(()=>e.value.filter(N=>N.paused).length),O=ee(()=>e.value.filter(N=>N.consecutive_failures>0).length);function w(N){if(!N)return"-";const B=Date.now(),te=(new Date(N).getTime()-B)/1e3;if(te<0)return"overdue";if(te<60)return"in < 1 min";if(te<3600)return`in ${Math.floor(te/60)} min`;if(te<86400){const Q=Math.floor(te/3600),he=Math.floor(te%3600/60);return he>0?`in ${Q}h ${he}m`:`in ${Q}h`}const oe=Math.floor(te/86400);return`in ${oe} day${oe!==1?"s":""}`}function S(N){return N==null?"-":N<1e3?`${N}ms`:N<6e4?`${(N/1e3).toFixed(1)}s`:ja(N/1e3)}function L(){r.value=null}async function H(){const N=a.value.cron.trim();if(N){o.value=!0;try{r.value=await Y.post("/api/schedules/validate-cron",{expression:N})}catch(B){r.value={valid:!1,error:B.message}}o.value=!1}}async function M(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/schedules")}catch(N){s.value=N.message}t.value=!1}async function D(N){if(g.value===N){g.value=null,m.value=[];return}g.value=N,C.value=!0,m.value=[];const B=++y;try{const W=await Y.get(`/api/schedules/${encodeURIComponent(N)}/history?limit=10`);if(B!==y||g.value!==N)return;m.value=W,E.value=""}catch(W){if(B!==y||g.value!==N)return;m.value=[],E.value=W.message||"Failed to load execution history"}B===y&&(C.value=!1)}async function K(){l.value=null;const N=a.value;if(!N.description.trim()){l.value="Description is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}if(!N.cron.trim()&&!N.run_at.trim()){l.value="Cron expression or run_at time is required";return}const B={description:N.description.trim(),action:N.action,channel_id:N.channel_id.trim()};if(N.cron.trim()&&(B.cron=N.cron.trim()),N.run_at.trim()&&(B.run_at=N.run_at.trim()),N.action==="reminder"&&N.message.trim()&&(B.message=N.message.trim()),N.action==="check"&&(N.tool_name.trim()&&(B.tool_name=N.tool_name.trim()),N.tool_input_str.trim()))try{B.tool_input=JSON.parse(N.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await Y.post("/api/schedules",B),Se.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await M()}catch(W){l.value=W.message}i.value=!1}async function ne(N){d.value=N;try{const B=await Y.post(`/api/schedules/${encodeURIComponent(N)}/run`);if(B.status==="failure")Se.error(`Execution failed: ${B.error||"unknown error"}`);else{const W=B.warning?`Executed (${B.warning})`:"Executed successfully";Se.success(W)}await M()}catch(B){Se.error(B.message||"Failed to trigger")}d.value=null}async function $(N){f.value=N.id;const B=!N.paused;try{await Y.put(`/api/schedules/${encodeURIComponent(N.id)}`,{paused:B}),Se.success(B?"Schedule paused":"Schedule resumed"),await M()}catch(W){Se.error(W.message||"Failed to update schedule")}f.value=null}async function I(N){p.value=N;try{await Y.post(`/api/schedules/${encodeURIComponent(N)}/reset-failures`),Se.success("Failure counters reset"),await M()}catch(B){Se.error(B.message||"Failed to reset")}p.value=null}async function T(N){const B=e.value.find(te=>te.id===N);if(await bs({title:"Delete schedule",message:`Delete "${(B==null?void 0:B.description)||N}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){u.value=N;try{await Y.del(`/api/schedules/${encodeURIComponent(N)}`),Se.success("Schedule deleted"),await M()}catch(te){Se.error(te.message||"Failed to delete schedule")}u.value=null}}return Je(()=>{M()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:d,deletingId:u,togglingId:f,resettingId:p,expandedId:g,history:m,historyLoading:C,historyError:E,cronCount:v,oneTimeCount:x,webhookCount:_,pausedCount:A,failingCount:O,formatTs:ra,formatAge:lg,formatFuture:w,formatMs:S,formatDuration:ja,onCronInput:L,validateCron:H,toggleExpand:D,fetchSchedules:M,doCreate:K,doRunNow:ne,doTogglePause:$,doResetFailures:I,doDelete:T}}},ww={components:{TabbedPage:wr},setup(){return{tabs:[{id:"live",label:"Live",component:gw},{id:"agents",label:"Agents",component:yw},{id:"loops",label:"Loops",component:xw},{id:"processes",label:"Processes",component:_w},{id:"schedules",label:"Schedules",component:kw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Sw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const r=h(null),o=h(!1),c=h(new Set),d=h(!1),u=h("all"),f=h(""),p=h("last_active"),g=h(!1),m=Zu,C=Tw,E=h([]),y=h(!1),v=h(""),x=h("flat"),_=h(new Set),A=h(""),O=h(""),w=h(""),S=h(null),L=h(!1);function H(){try{const V=localStorage.getItem("odin-session-presets");V&&(E.value=JSON.parse(V))}catch{}}function M(){try{localStorage.setItem("odin-session-presets",JSON.stringify(E.value))}catch{}}const D=ee(()=>f.value.trim()!==""||u.value!=="all"),K=ee(()=>{let V=[...e.value];const _e=Zu.find(Ye=>Ye.id===u.value),Ie=_e?_e.filters:{};if(Ie.source&&(V=V.filter(Ye=>Ye.source===Ie.source)),Ie.minMessages&&(V=V.filter(Ye=>Ye.message_count>=Ie.minMessages)),Ie.hasCompaction&&(V=V.filter(Ye=>Ye.has_summary)),Ie.maxAge!=null){const Ye=Date.now()/1e3;V=V.filter(ht=>ht.last_active&&Ye-ht.last_active<=Ie.maxAge)}if(f.value.trim()){const Ye=f.value.toLowerCase().trim();V=V.filter(ht=>(ht.channel_id||"").toLowerCase().includes(Ye)||(ht.last_user_id||"").toLowerCase().includes(Ye)||(ht.source||"").toLowerCase().includes(Ye))}const De=p.value,ze=g.value?1:-1;return V.sort((Ye,ht)=>{const ts=Ye[De]||0,Is=ht[De]||0;return(ts-Is)*ze}),V}),ne=ee(()=>{if(!a.value||!a.value.messages)return[];const V=a.value.messages;if(V.length===0)return[];const _e=[];let Ie=[];for(const De of V)De.role==="user"&&Ie.length>0&&(_e.push(Ie),Ie=[]),Ie.push(De);return Ie.length>0&&_e.push(Ie),_e}),$=ee(()=>K.value.length>0&&c.value.size===K.value.length);function I(V){const _e=V.find(Ie=>Ie.role==="user");if(_e&&_e.content){const Ie=_e.content.slice(0,120);return Ie.length<_e.content.length?Ie+"...":Ie}return"(no user message)"}function T(V){const _e=new Set(_.value);_e.has(V)?_e.delete(V):_e.add(V),_.value=_e}function N(V){u.value=V}function B(V){u.value=V.id,V.filters.searchQuery!=null&&(f.value=V.filters.searchQuery),V.filters.sortBy&&(p.value=V.filters.sortBy)}function W(){if(!v.value.trim())return;const V={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:f.value,sortBy:p.value}};E.value=[...E.value,V],M(),y.value=!1,v.value=""}function te(V){E.value=E.value.filter(_e=>_e.id!==V),M(),u.value===V&&(u.value="all")}function oe(){u.value="all",f.value="",p.value="last_active",g.value=!1}function Q(V){if(!V)return"—";const _e=Date.now()/1e3-V;if(_e<60)return"just now";if(_e<3600){const De=Math.floor(_e/60);return`${De} minute${De!==1?"s":""} ago`}if(_e<86400){const De=Math.floor(_e/3600);return`${De} hour${De!==1?"s":""} ago`}const Ie=Math.floor(_e/86400);return`${Ie} day${Ie!==1?"s":""} ago`}function he(V){if(!V)return"";try{return new Date(V*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Fe(V){if(!V)return"";try{return new Date(V*1e3).toLocaleString()}catch{return""}}function z(V){return V==="user"?"bg-gray-900/50 border border-gray-800":V==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function pe(V){return V==="user"?"sess-msg-user":V==="assistant"?"sess-msg-assistant":"sess-msg-system"}function de(V){return V==="user"?"badge-info":V==="assistant"?"badge-success":"badge-warning"}function xe(V){return V==="user"?"sess-dot-user":V==="assistant"?"sess-dot-assistant":"sess-dot-system"}function me(V){return V==="user"?"text-cyan-400":V==="assistant"?"text-indigo-400":"text-gray-500"}function Be(V){return V?V.length>2e3?V.slice(0,2e3)+`
... (truncated)`:V:""}async function b(){const V=A.value.trim();if(V){L.value=!0;try{let _e=`/api/sessions/search?q=${encodeURIComponent(V)}&limit=50`;O.value.trim()&&(_e+=`&channel_id=${encodeURIComponent(O.value.trim())}`),w.value.trim()&&(_e+=`&user_id=${encodeURIComponent(w.value.trim())}`);const Ie=await Y.get(_e);S.value=Ie.results||[]}catch{S.value=[]}L.value=!1}}function R(){A.value="",O.value="",w.value="",S.value=null}function F(V){return V?V.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function X(V){return V==="user"?"fts-result-user":V==="assistant"?"fts-result-assistant":V==="summary"?"fts-result-summary":V==="fts"?"fts-result-fts":V==="channel"?"fts-result-channel":"fts-result-default"}function Z(V){return V==="user"?"badge-info":V==="assistant"?"badge-success":V==="summary"?"badge-warning":V==="fts"?"badge-success":"badge-info"}async function J(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/sessions")}catch(V){s.value=V.message}t.value=!1}function ue(){s.value=null,J()}async function re(V){if(n.value===V){n.value=null,a.value=null,_.value=new Set;return}n.value=V,a.value=null,i.value=!0,_.value=new Set;const _e=++l;try{const Ie=await Y.get(`/api/sessions/${encodeURIComponent(V)}`);_e===l&&n.value===V&&(a.value=Ie)}catch(Ie){_e===l&&n.value===V&&(a.value={messages:[],summary:"",error:Ie.message||"Failed to load session"})}finally{_e===l&&(i.value=!1)}}function ie(V){const _e=new Set(c.value);_e.has(V)?_e.delete(V):_e.add(V),c.value=_e}function se(){$.value?c.value=new Set:c.value=new Set(K.value.map(V=>V.channel_id))}function ye(V){r.value=V}async function fe(){if(r.value){o.value=!0;try{await Y.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await J()}catch(V){s.value=V.message||"Failed to clear session"}o.value=!1,r.value=null}}function ge(){d.value=!0}async function ke(){if(c.value.size!==0){o.value=!0;try{await Y.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await J()}catch(V){s.value=V.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}function Te(V,_e){const Ie=Y._token;let De=`/api/sessions/${encodeURIComponent(V)}/export?format=${_e}`;Ie&&(De+=`&token=${encodeURIComponent(Ie)}`);const ze=document.createElement("a");ze.href=De,ze.download=`session-${V}.${_e==="text"?"txt":"json"}`,document.body.appendChild(ze),ze.click(),document.body.removeChild(ze)}let Re=null;function Ne(V){V.payload&&V.payload.channel_id&&(clearTimeout(Re),Re=setTimeout(()=>{if(J(),n.value&&V.payload.channel_id===n.value){const _e=n.value,Ie=l;Y.get(`/api/sessions/${encodeURIComponent(_e)}`).then(De=>{Ie!==l||n.value!==_e||(a.value=De)}).catch(()=>{})}},2e3))}let Pe=!1;function Ve(){Pe||(Pe=!0,J(),We.subscribe("events",Ne))}Je(()=>{H(),Ve()}),As(()=>{Ve()});function st(){Pe&&(Pe=!1,We.unsubscribe("events",Ne),clearTimeout(Re))}return Rs(st),_t(st),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:$,bulkClearing:d,activePreset:u,searchQuery:f,sortBy:p,sortAsc:g,filterPresets:m,sortOptions:C,filteredSessions:K,hasActiveFilters:D,customPresets:E,showSavePreset:y,newPresetName:v,threadView:x,threads:ne,collapsedThreads:_,ftsQuery:A,ftsChannelId:O,ftsUserId:w,ftsResults:S,ftsSearching:L,formatAge:Q,formatTimestamp:he,formatFullTimestamp:Fe,messageClass:z,threadMsgClass:pe,roleBadge:de,roleDotClass:xe,roleLabelClass:me,truncateContent:Be,threadSummary:I,fetchSessions:J,retry:ue,toggleSession:re,toggleSelect:ie,toggleSelectAll:se,confirmClear:ye,clearSession:fe,confirmBulkClear:ge,doBulkClear:ke,exportSession:Te,applyPreset:N,applyCustomPreset:B,saveCustomPreset:W,removeCustomPreset:te,resetFilters:oe,toggleThread:T,runFtsSearch:b,clearFtsSearch:R,highlightSnippet:F,ftsResultClass:X,ftsTypeBadge:Z}}},Ew={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:cg}}},Aw={components:{ContextAssemblyPanel:Ew},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),d=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(O){if(!O)return"—";try{const w=new Date(O);return isNaN(w.getTime())?O:w.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return O}}function f(O){return!O&&O!==0?"—":O<1e3?O+"ms":(O/1e3).toFixed(1)+"s"}function p(O){return!O&&O!==0?"—":O>=1e3?(O/1e3).toFixed(1)+"k":String(O)}function g(O){if(!O)return"";if(typeof O=="string")return O;try{return JSON.stringify(O,null,2)}catch{return String(O)}}function m(O){a.value===O?a.value=null:(a.value=O,c.value={})}function C(O,w){const S=O+"-"+w;c.value={...c.value,[S]:!c.value[S]}}function E(O,w){return!!c.value[O+"-"+w]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,_()}async function v(){try{const O=await Y.get("/api/trajectories");e.value=O.files||[],o.value=O.count||0}catch{}}let x=0;async function _(){const O=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const w=await Y.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${d.value.limit}`);if(O!==x)return;let S=w.entries||[];d.value.tool_name&&(S=S.filter(L=>(L.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(S=S.filter(L=>L.is_error)),d.value.channel_id&&(S=S.filter(L=>L.channel_id===d.value.channel_id)),d.value.user_id&&(S=S.filter(L=>L.user_id===d.value.user_id)),t.value=S}else{const w=new URLSearchParams;d.value.channel_id&&w.set("channel_id",d.value.channel_id),d.value.user_id&&w.set("user_id",d.value.user_id),d.value.tool_name&&w.set("tool_name",d.value.tool_name),d.value.errors_only&&w.set("errors_only","true"),w.set("limit",String(d.value.limit));const S=w.toString(),L=await Y.get(`/api/trajectories/search/query?${S}`);if(O!==x)return;t.value=L.results||[]}}catch(w){if(O!==x)return;n.value=w.message}O===x&&(s.value=!1)}async function A(){if(!l.value.trim())return;const O=++x;s.value=!0,n.value=null,c.value={};try{const w=await Y.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(O!==x)return;i.value=w.entry||null,i.value||(n.value="No trace found for this message ID")}catch(w){if(O!==x)return;w.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=w.message}O===x&&(s.value=!1)}return Je(async()=>{await v(),await _()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:d,expandedIterations:c,formatTs:u,formatDuration:f,formatTokens:p,formatJSON:g,truncateBlock:rg,toggleExpand:m,toggleIteration:C,isIterationExpanded:E,clearFilters:y,fetchFiles:v,fetchTraces:_,lookupMessage:A}}},Rw={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),n=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),a=h("user");let i=null;const l=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],r=ee(()=>[...s.value.recent||[]].reverse()),o=async()=>{try{const p=await Y.get("/api/usage");s.value=p,n.value=p.totals||n.value,t.value=null}catch(p){t.value=p.message}finally{e.value=!1}},c=()=>{e.value=!0,o()};let d=!1;function u(){d||(d=!0,o(),i||(i=setInterval(o,15e3)))}function f(){d&&(d=!1,i&&(clearInterval(i),i=null))}return Je(u),As(u),Rs(f),_t(f),{loading:e,error:t,data:s,totals:n,activeTab:a,tabs:l,recentReversed:r,fmtNum:og,formatTime:Dc,retry:c}}},Iw={components:{TabbedPage:wr},setup(){return{tabs:[{id:"audit",label:"Audit",component:Sw},{id:"sessions",label:"Sessions",component:Cw},{id:"traces",label:"Traces",component:Aw},{id:"usage",label:"Usage",component:Rw}]}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Jr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Ow={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),r=h(null),o=ee(()=>e.value.filter(y=>y.is_core).length),c=ee(()=>e.value.filter(y=>!y.is_core).length),d=ee(()=>Object.values(a.value).reduce((y,v)=>y+v,0));function u(y){for(const v of Jr)if(v.id!=="other"&&v.match(y))return v.id;return"other"}const f=ee(()=>{let y=e.value;if(n.value){const v=n.value.toLowerCase();y=y.filter(x=>x.name.toLowerCase().includes(v)||(x.description||"").toLowerCase().includes(v))}return r.value&&(y=y.filter(v=>u(v.name)===r.value)),y}),p=ee(()=>{const y=new Set;for(const v of e.value)y.add(u(v.name));return Jr.filter(v=>y.has(v.id))}),g=ee(()=>{const y=f.value,v={};for(const _ of y){const A=u(_.name);v[A]||(v[A]=[]),v[A].push(_)}const x=[];for(const _ of Jr)v[_.id]&&v[_.id].length>0&&x.push({label:_.label,icon:_.icon,tools:v[_.id].sort((A,O)=>A.name.localeCompare(O.name))});return x});function m(y){i.value={...i.value,[y]:!i.value[y]}}async function C(){t.value=!0,s.value=null;try{const[y,v]=await Promise.all([Y.get("/api/tools"),Y.get("/api/tools/stats").catch(()=>({}))]);e.value=y,a.value=v||{};const x=Object.values(v||{}).filter(_=>_>0).sort((_,A)=>_-A)}catch(y){s.value=y.message}t.value=!1}function E(){C()}return Je(()=>{C()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,coreCount:o,skillCount:c,totalUsage:d,filteredTools:f,groupedTools:g,usedCategories:p,truncate:Mc,toggleExpand:m,refresh:E}}};function Lw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Nw(e){if(!e)return"1";const t=e.split(`
...
`)}const Dw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),d=h(""),u=h(""),f=h(null),p=h(null),g=h(!1),m=h(null),C=h(null),E=h(!1),y=ee(()=>e.value.length),v=ee(()=>e.value.reduce((Q,he)=>Q+(he.execution_count||0),0)),x=ee(()=>e.value.reduce((Q,he)=>Q+L(he.code),0)),_=ee(()=>{if(!l.value)return e.value;const Q=l.value.toLowerCase();return e.value.filter(he=>he.name.toLowerCase().includes(Q)||(he.description||"").toLowerCase().includes(Q))}),A=ee(()=>u.value?u.value.split(`
`).length:0),O=ee(()=>{const Q=Math.max(A.value,1);return Array.from({length:Q},(he,Fe)=>Fe+1).join(`
`)}),w=ee(()=>{const Q=u.value.trim();return Q?Q.includes("SKILL_DEFINITION")?Q.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function S(Q){return Lw(Q)}function L(Q){return Q?Q.split(`
`).length:0}function H(Q){return Nw(Q)}function M(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function D(Q){try{await navigator.clipboard.writeText(Q);const he=e.value.find(Fe=>Fe.code===Q);he&&(r.value=he.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function K(Q){if(Q.key==="Tab"){Q.preventDefault();const he=Q.target,Fe=he.selectionStart,z=he.selectionEnd;u.value=u.value.substring(0,Fe)+"    "+u.value.substring(z),Ot(()=>{he.selectionStart=he.selectionEnd=Fe+4})}}function ne(Q){const he=Q.target.previousElementSibling;he&&(he.scrollTop=Q.target.scrollTop)}async function $(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function I(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const he=await Y.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:he}}catch(he){a.value={...a.value,[Q]:{result:he.message,is_error:!0}}}i.value=null}function T(){o.value=!0,c.value="create",d.value="",u.value="",f.value=null,p.value=null}function N(Q){o.value=!0,c.value="edit",d.value=Q.name,u.value=Q.code||"",f.value=null,p.value=null}function B(){o.value=!1,f.value=null,p.value=null}async function W(){f.value=null,p.value=null;const Q=d.value.trim(),he=u.value.trim();if(!Q){f.value="Name is required";return}if(!he){f.value="Code is required";return}g.value=!0;try{c.value==="create"?(await Y.post("/api/skills",{name:Q,code:he}),p.value="Skill created successfully"):(await Y.put(`/api/skills/${encodeURIComponent(Q)}`,{code:he}),p.value="Skill updated successfully"),await $(),setTimeout(()=>{o.value=!1},800)}catch(Fe){f.value=Fe.message}g.value=!1}function te(Q){C.value=Q}async function oe(){if(C.value){E.value=!0;try{await Y.del(`/api/skills/${encodeURIComponent(C.value)}`),await $()}catch(Q){Se.error(`Failed to delete skill: ${Q.message||"unknown error"}`)}E.value=!1,C.value=null}}return Je(()=>{$()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:f,editSuccess:p,saving:g,editorRef:m,deleteTarget:C,deleting:E,enabledCount:y,totalExecutions:v,totalLines:x,displayedSkills:_,editLineCount:A,editorLineNums:O,editValidation:w,highlight:S,truncate:Mc,formatTs:ra,countLines:L,getLineNumbers:H,toggleCode:M,copyCode:D,handleEditorKey:K,syncScroll:ne,fetchSkills:$,testSkill:I,showCreate:T,editSkill:N,cancelEdit:B,saveSkill:W,confirmDelete:te,doDelete:oe}}};function Mw(e,t){if(!e||!t)return Eu(e);const s=Eu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),f=h(null),p=h(!1),g=h(null),m=h(null);let C=null;const E=h(null),y=h(!1),v=h({}),x=h({}),_=h(null),A=h(null),O=ee(()=>e.value.reduce((T,N)=>T+(N.chunks||0),0)),w=ee(()=>new Set(e.value.map(N=>N.uploader).filter(Boolean)).size);function S(T,N){const B=x.value[N];if(!B||B.length===0)return 0;const W=Math.max(...B.map(te=>te.char_count||0));return W===0?0:Math.round(T.char_count/W*100)}async function L(){t.value=!0,s.value=null;try{const T=await Y.get("/api/knowledge");e.value=Array.isArray(T)?T:[]}catch(T){s.value=T.message}t.value=!1}async function H(T){if(v.value[T]){v.value[T]=!1,A.value=null;return}if(v.value[T]=!0,!(x.value[T]||_.value===T)){_.value=T;try{const N=await Y.get(`/api/knowledge/${encodeURIComponent(T)}/chunks`);x.value[T]=Array.isArray(N)?N:[]}catch(N){x.value[T]=[],Se.error(`Failed to load chunks: ${N.message}`)}_.value=null}}async function M(){const T=n.value.trim();if(T){i.value=!0,r.value=null,l.value=T;try{const N=await Y.get(`/api/knowledge/search?q=${encodeURIComponent(T)}`);a.value=Array.isArray(N)?N:[]}catch(N){a.value=[],r.value=N.message||"Search failed"}i.value=!1}}function D(){a.value=null,n.value="",r.value=null}async function K(){u.value=null,f.value=null;const T=c.value.trim(),N=d.value.trim();if(!T){u.value="Source name is required";return}if(!N){u.value="Content is required";return}p.value=!0;try{const B=await Y.post("/api/knowledge",{source:T,content:N});f.value=`Ingested ${B.chunks||0} chunks from "${T}"`,c.value="",d.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(B){u.value=B.message}p.value=!1}async function ne(T){g.value=T,m.value=null,C&&(clearTimeout(C),C=null);try{const N=await Y.post(`/api/knowledge/${encodeURIComponent(T)}/reingest`);m.value={source:T,error:!1,message:`Re-ingested ${N.chunks||0} chunks`},delete x.value[T],await L(),C=setTimeout(()=>{m.value=null,C=null},3e3)}catch(N){m.value={source:T,error:!0,message:N.message}}g.value=null}function $(T){E.value=T}async function I(){if(E.value){y.value=!0;try{await Y.del(`/api/knowledge/${encodeURIComponent(E.value)}`),delete x.value[E.value],await L()}catch(T){Se.error(`Failed to delete source: ${T.message||"unknown error"}`)}y.value=!1,E.value=null}}return Je(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:f,ingesting:p,reingesting:g,reingestResult:m,deleteTarget:E,deleting:y,expanded:v,sourceChunks:x,loadingChunks:_,selectedChunk:A,totalChunks:O,uploaderCount:w,truncate:Mc,formatTs:ra,highlightTerms:Mw,chunkBarWidth:S,fetchSources:L,toggleSource:H,doSearch:M,clearSearch:D,doIngest:K,doReingest:ne,confirmDelete:$,doDelete:I}}},Fw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),f=h(null),p=h(""),g=h(!1),m=h(null),C=h(null),E=h(new Set),y=h(null),v=h(!1),x=h(!1),_=ee(()=>e.value.reduce((te,oe)=>te+oe.count,0)),A=ee(()=>E.value.size);function O(te){const oe=t.value[te];if(!oe)return[];if(!l.value.trim())return oe;const Q=l.value.trim().toLowerCase();return oe.filter(he=>he.key.toLowerCase().includes(Q)||he.value&&he.value.toLowerCase().includes(Q))}function w(te,oe){return E.value.has(te+"/"+oe)}function S(te,oe){const Q=te+"/"+oe,he=new Set(E.value);he.has(Q)?he.delete(Q):he.add(Q),E.value=he}function L(te){const oe=t.value[te];return!oe||oe.length===0?!1:oe.every(Q=>E.value.has(te+"/"+Q.key))}function H(te,oe){const Q=t.value[te];if(!Q)return;const he=new Set(E.value);for(const Fe of Q){const z=te+"/"+Fe.key;oe?he.add(z):he.delete(z)}E.value=he}async function M(){s.value=!0,n.value=null;try{const te=await Y.get("/api/memory");e.value=Object.entries(te).map(([oe,Q])=>({name:oe,keys:Q.keys||[],count:Q.count||0}))}catch(te){n.value=te.message}s.value=!1}async function D(te){if(a.value[te]){a.value[te]=!1;return}a.value[te]=!0;const oe=e.value.find(he=>he.name===te);if(!oe||t.value[te]||i.value===te)return;i.value=te;const Q=await Promise.all(oe.keys.map(async he=>{try{const Fe=await Y.get(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(he)}`);return{key:he,value:Fe.value||""}}catch{return{key:he,value:"(error loading)"}}}));t.value[te]=Q,i.value=null}function K(te,oe,Q){f.value=te+"/"+oe,p.value=Q}async function ne(te,oe){g.value=!0,m.value=null;try{await Y.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`,{value:p.value});const Q=t.value[te];if(Q){const he=Q.find(Fe=>Fe.key===oe);he&&(he.value=p.value)}f.value=null}catch(Q){m.value=`Failed to save: ${Q.message||"unknown error"}`}g.value=!1}async function $(te,oe){try{await navigator.clipboard.writeText(oe.value),C.value=te+"/"+oe.key,setTimeout(()=>{C.value=null},1500)}catch{}}async function I(){d.value=null,u.value=null;const te=o.value.scope.trim(),oe=o.value.key.trim(),Q=o.value.value.trim();if(!te){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!Q){d.value="Value is required";return}c.value=!0;try{await Y.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`,{value:Q}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await M(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(he){d.value=he.message}c.value=!1}function T(te,oe){y.value={scope:te,key:oe}}async function N(){if(!y.value)return;v.value=!0,m.value=null;const{scope:te,key:oe}=y.value;try{await Y.del(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`);const Q=t.value[te];Q&&(t.value[te]=Q.filter(z=>z.key!==oe));const he=e.value.find(z=>z.name===te);he&&(he.count--,he.keys=he.keys.filter(z=>z!==oe));const Fe=new Set(E.value);Fe.delete(te+"/"+oe),E.value=Fe}catch(Q){m.value=`Failed to delete: ${Q.message||"unknown error"}`}v.value=!1,y.value=null}function B(){x.value=!0}async function W(){v.value=!0,m.value=null;const te=[];for(const oe of E.value){const Q=oe.indexOf("/");te.push({scope:oe.slice(0,Q),key:oe.slice(Q+1)})}try{await Y.post("/api/memory/bulk-delete",{entries:te}),E.value=new Set,t.value={},await M()}catch(oe){m.value=`Bulk delete failed: ${oe.message||"unknown error"}`}v.value=!1,x.value=!1}return Je(()=>{M()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:f,editValue:p,saving:g,actionError:m,copied:C,selected:E,selectedCount:A,totalEntries:_,deleteTarget:y,deleting:v,showBulkDelete:x,fetchMemory:M,toggleScope:D,startEdit:K,doEdit:ne,copyValue:$,doAdd:I,confirmDelete:T,doDelete:N,confirmBulkDelete:B,doBulkDelete:W,isSelected:w,toggleSelect:S,isScopeAllSelected:L,toggleSelectAll:H,filteredEntries:O}}},$w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=ee(()=>[...new Set(e.value.map(C=>C.category))].sort()),o=ee(()=>{const m={};return e.value.forEach(C=>{m[C.category]=(m[C.category]||0)+1}),m}),c=ee(()=>a.value?e.value.filter(m=>m.category===a.value):e.value);function d(m){return m==="correction"?"badge-warning":m==="operational"?"badge-info":m==="preference"?"badge-success":"badge-info"}function u(m){i.value=m.key,l.value=m.content}async function f(m){try{await Y.put("/api/learned/"+encodeURIComponent(m),{content:l.value}),i.value=null,Se.success("Entry updated"),await g()}catch(C){Se.error(C.message||"Failed to save entry")}}async function p(m){if(await bs({title:"Delete learned entry",message:`Delete "${m}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/learned/"+encodeURIComponent(m)),Se.success("Entry deleted"),await g()}catch(E){Se.error(E.message||"Failed to delete entry")}}async function g(){s.value=!0,n.value=null;try{const m=await Y.get("/api/learned");e.value=m.entries||[],t.value={last_reflection:m.last_reflection,count:m.count}}catch(m){n.value=m.message}s.value=!1}return Je(g),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:d,formatTs:ra,startEdit:u,saveEdit:f,deleteEntry:p,fetchEntries:g}}},Uw={components:{TabbedPage:wr},setup(){return{tabs:[{id:"tools",label:"Tools",component:Ow},{id:"skills",label:"Skills",component:Dw},{id:"knowledge",label:"Knowledge",component:Pw},{id:"memory",label:"Memory",component:Fw},{id:"learned",label:"Learned",component:$w}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Bw={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),d=h(!0),u=h(""),f=h(!1),p=h(!1),g=ee(()=>e.value==="custom"),m=ee(()=>[...i.value,...l.value]),C=ee(()=>l.value.includes(e.value)),E=ee(()=>{var w;return g.value?t.value||"Odin":((w=a.value[e.value])==null?void 0:w.name)||e.value}),y=ee(()=>{var w;return g.value?s.value||"(empty — will use Odin default)":((w=a.value[e.value])==null?void 0:w.identity)||""}),v=ee(()=>{var w;return g.value?n.value||"(empty — will use Odin default)":((w=a.value[e.value])==null?void 0:w.voice)||""});async function x(){d.value=!0;try{const w=await Y.get("/api/personality");e.value=w.preset||"odin",t.value=w.custom_name||"",s.value=w.custom_identity||"",n.value=w.custom_voice||"",a.value=w.presets||{},i.value=w.builtin_presets||[],l.value=w.user_presets||[]}catch(w){c.value=w.message}finally{d.value=!1}}async function _(){r.value=!0,c.value=null,o.value=!1;try{await Y.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(w){c.value=w.message}finally{r.value=!1}}async function A(){const w=u.value.trim();if(w){p.value=!0,c.value=null;try{await Y.post("/api/personality/presets",{name:w,display_name:E.value,identity:y.value,voice:v.value}),f.value=!1,u.value="",await x(),e.value=w.toLowerCase().replace(/ /g,"_")}catch(S){c.value=S.message}finally{p.value=!1}}}async function O(){if(await bs({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await Y.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(S){c.value=S.message}}}return Je(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:m,isCustom:g,isUserPreset:C,previewName:E,previewIdentity:y,previewVoice:v,saving:r,saved:o,error:c,loading:d,save:_,showSavePreset:f,newPresetName:u,savingPreset:p,saveAsPreset:A,deletePreset:O,builtinPresets:i,userPresets:l}},template:`
  ...
  `},Hw={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Vw={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},jw={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},zw={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h(!1),a=ee(()=>e.value.components||[]),i=ee(()=>jw[e.value.overall]||"text-gray-400"),l=ee(()=>e.value.overall==="healthy"?"success":e.value.overall==="degraded"?"warning":e.value.overall==="unhealthy"?"error":"minus"),r=ee(()=>{const _=e.value.overall;return _==="healthy"?"All Systems Healthy":_==="degraded"?"Some Systems Degraded":_==="unhealthy"?"System Issues Detected":"Unknown"});function o(_){return Hw[_]||"text-gray-400"}function c(_){return Vw[_]||"info"}function d(_){return _==="ok"?"badge-success":_==="degraded"?"badge-warning":_==="down"?"badge-danger":"badge-info"}function u(_){return _==="closed"?"text-green-400":_==="half_open"?"text-yellow-400":_==="open"?"text-red-400":"text-gray-400"}function f(_){return _.replace(/_/g," ").replace(/\b\w/g,A=>A.toUpperCase())}function p(_){if(!_)return"—";try{return new Date(_).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return _}}function g(_){return _>=1e6?(_/1e6).toFixed(1)+"M":_>=1e3?(_/1e3).toFixed(1)+"K":String(_)}async function m(){n.value=!0;try{e.value=await Y.get("/api/health/components"),s.value=null}catch(_){s.value=_.message}finally{t.value=!1,n.value=!1}}function C(){t.value=!0,s.value=null,m()}let E=null,y=!1;function v(){y||(y=!0,m(),E||(E=setInterval(m,3e4)))}function x(){y&&(y=!1,E&&(clearInterval(E),E=null))}return Je(v),As(v),Rs(x),_t(x),{data:e,loading:t,error:s,refreshing:n,components:a,overallColor:i,overallIcon:l,overallLabel:r,statusColor:o,statusIcon:c,badgeClass:d,circuitColor:u,formatName:f,formatTime:p,formatNumber:g,fetchHealth:m,retry:C}}},qw={template:`
...
`);const le=new Blob([U],{type:"text/plain"}),Oe=URL.createObjectURL(le),lt=document.createElement("a");lt.href=Oe,lt.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,lt.click(),URL.revokeObjectURL(Oe)}function J(U,le){const Oe=`${U.ts} ${U.level} ${U.text||U.raw||""}`;navigator.clipboard.writeText(Oe).then(()=>{f.value=le,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function ue(U){a.value=a.value===U?"":U,E.value="all"}function re(U){return U.level==="ERROR"?"log-line-error":U.level==="WARNING"?"log-line-warning":"text-gray-300"}function ie(U){return U==="ERROR"?"text-red-500 font-semibold":U==="WARNING"?"text-yellow-500":"text-blue-500"}function se(U){return U==="ERROR"?"log-chip-error":U==="WARNING"?"log-chip-warning":"log-chip-info"}function ye(U){E.value=U.id;const le=U.filters;a.value=le.level||"",y.value=le.timeRange||"",i.value=le.text||"",le.levels&&(a.value=le.levels[0]||""),le.hasToolName&&(i.value="")}function fe(U){E.value=U.id,a.value=U.filters.level||"",y.value=U.filters.timeRange||"",i.value=U.filters.text||""}function ge(){if(!_.value.trim())return;const U={id:"custom-"+Date.now(),name:_.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};v.value=[...v.value,U],w(),x.value=!1,_.value=""}function ke(U){v.value=v.value.filter(le=>le.id!==U),w(),E.value===U&&(E.value="all")}const Te=h("all"),Re=h(""),Ne=h(""),Pe=h(""),Ve=h(""),st=h(""),V=h(100),_e=Ww,Ie=h(!1),De=h(!1),ze=h(""),Ye=h([]),ht=h(null),ts=h(null);function Is(){e.value="search",ht.value||Ps()}async function Ps(){try{ht.value=await Y.get("/api/logs/stats")}catch{}}function Fs(){const U=st.value;if(!U){Pe.value="",Ve.value="";return}const Oe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[U];if(Oe){const lt=new Date(Date.now()-Oe*1e3);Pe.value=us(lt),Ve.value=""}}function us(U){const le=Oe=>String(Oe).padStart(2,"0");return`${U.getFullYear()}-${le(U.getMonth()+1)}-${le(U.getDate())}T${le(U.getHours())}:${le(U.getMinutes())}`}function q(U){if(!U)return"";const le=new Date(U);return isNaN(le.getTime())?"":le.toISOString()}async function Ee(){Ie.value=!0,ze.value="",De.value=!0,ts.value=null;try{const U=new URLSearchParams;Te.value&&Te.value!=="all"&&U.set("level",Te.value),Re.value&&U.set("tool",Re.value),Ne.value&&U.set("q",Ne.value);const le=q(Pe.value),Oe=q(Ve.value);le&&U.set("start",le),Oe&&U.set("end",Oe),U.set("limit",String(V.value));const lt=await Y.get(`/api/logs/search?${U.toString()}`);Ye.value=lt.entries||[]}catch(U){ze.value=U.message||"Search failed",Ye.value=[]}finally{Ie.value=!1}}function fs(){Te.value="all",Re.value="",Ne.value="",Pe.value="",Ve.value="",st.value="",V.value=100,Ye.value=[],De.value=!1,ze.value="",ts.value=null}function Zs(U){ts.value=ts.value===U?null:U}function ca(U){if(!U.timestamp)return"";try{return new Date(U.timestamp).toLocaleString()}catch{return U.timestamp}}function kn(U){return U.type==="web_action"?`${U.status||""} (${U.execution_time_ms||0}ms)`:(U.result_summary||"").slice(0,200)}function Js(U){return U.error?"log-line-error":"text-gray-300"}function P(U){try{return JSON.stringify(U,null,2)}catch{return String(U)}}let j=null,ae=null,we=!1;function Ce(){we||(we=!0,We.subscribe("logs",te),r.value=We.connected,o.value=We.state||"disconnected",j=We.onStateChange,ae=(U,le)=>{o.value=U,r.value=U==="connected",j&&j(U,le)},We.onStateChange=ae)}function Et(){we&&(we=!1,We.unsubscribe("logs",te),We.onStateChange===ae&&(We.onStateChange=j),ae=null,j=null)}return Je(()=>{O(),window.addEventListener("pointerup",b),window.addEventListener("pointercancel",b)}),As(Ce),Rs(Et),_t(()=>{Et(),window.removeEventListener("pointerup",b),window.removeEventListener("pointercancel",b)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:B,pauseBuffer:A,showJumpBottom:u,copiedIndex:f,regexError:H,levels:g,logPresets:m,timeRanges:C,timeRange:y,activeLogPreset:E,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:_,hasActiveLogFilters:S,timeRangeLabel:L,timelineBuckets:D,timelineMax:K,timelineSpanLabel:ne,timelineLabelSkip:$,togglePause:F,clearLogs:X,exportLogs:Z,logLineClass:re,levelClass:ie,levelChipClass:se,toggleLevel:ue,copyLine:J,jumpToBottom:he,onScroll:z,onUserScrollIntent:de,onUserScrollKey:xe,onAutoScrollToggle:R,onPointerDown:Be,applyLogPreset:ye,applyCustomLogPreset:fe,saveLogCustomPreset:ge,removeLogCustomPreset:ke,segmentHeight:T,jumpToTimelineBucket:N,searchLevel:Te,searchTool:Re,searchKeyword:Ne,searchStart:Pe,searchEnd:Ve,searchTimePreset:st,searchLimit:V,searchLimits:_e,searching:Ie,searchRan:De,searchError:ze,searchResults:Ye,searchStats:ht,expandedSearch:ts,switchToSearch:Is,runSearch:Ee,clearSearchFilters:fs,toggleSearchExpand:Zs,formatSearchTs:ca,searchEntryText:kn,searchLogLineClass:Js,formatJson:P,applySearchTimePreset:Fs}}},Cg="••••••••",Jw={timezone:{apply_mode:"restart",description:"Locale and scheduling defaults used across Odin."},discord:{apply_mode:"live_read",description:"Global Discord defaults. Guild and channel overrides take precedence."},llm_provider:{apply_mode:"live_apply",owner:"llm",description:"Active language-model provider and failover ownership."},openai_codex:{apply_mode:"live_apply",owner:"llm",description:"Codex models, reasoning, transport, and pool behaviour."},ollama:{apply_mode:"restart",owner:"llm",description:"Local or remote Ollama provider settings."},kimi:{apply_mode:"restart",owner:"llm",description:"Kimi provider settings and request limits."},context:{apply_mode:"restart",description:"System-prompt sources and prompt-budget controls."},sessions:{apply_mode:"restart",description:"Conversation persistence, retention, and history limits."},tools:{apply_mode:"restart",description:"Execution policy, hosts, timeouts, pools, and recovery."},logging:{apply_mode:"restart",description:"Runtime log verbosity and storage policy."},usage:{apply_mode:"activation_required",description:"Usage accounting and durable history storage."},webhook:{apply_mode:"restart",description:"Inbound webhook listener and authentication policy."},learning:{apply_mode:"restart",description:"Reflection, consolidation, and learned-context limits."},observability:{apply_mode:"live_read",description:"Metrics, tracing, and failure-classification controls."},email:{apply_mode:"restart",description:"SMTP and IMAP behaviour for email tools."},search:{apply_mode:"restart",description:"Knowledge and history search backends."},browser:{apply_mode:"restart",description:"Browser automation limits and viewport defaults."},permissions:{apply_mode:"restart",description:"Default and per-user execution policy."},comfyui:{apply_mode:"live_read",description:"ComfyUI image backend connection settings."},image:{apply_mode:"live_read",description:"Image routing and native generation policy."},web:{apply_mode:"restart",description:"Management API listener, authentication, and sessions."},attachments:{apply_mode:"live_read",description:"Attachment limits, paths, and cleanup policy."},personality:{apply_mode:"live_read",owner:"personality",description:"Response identity, style, and personality presets."},reaction_triggers:{apply_mode:"activation_required",owner:"reaction_triggers",description:"Discord reaction event automation."},message_triggers:{apply_mode:"activation_required",owner:"message_triggers",description:"Discord message event automation."},mcp:{apply_mode:"activation_required",owner:"mcp",description:"Model Context Protocol servers and tool publication."},slack:{apply_mode:"restart",description:"Slack destinations and internal alert forwarding."},issue_tracker:{apply_mode:"activation_required",owner:"issue_tracker",description:"Issue tracker provider and tool lifecycle."},audit:{apply_mode:"restart",description:"Audit signing, verification, and retention."},agents:{apply_mode:"live_for_new_work",description:"Spawned-agent budgets, inheritance, and tree limits."},grafana_alerts:{apply_mode:"activation_required",owner:"grafana_alerts",description:"Grafana alert intake, routing, and remediation."},outbound_webhooks:{apply_mode:"live_apply",owner:"outbound_webhooks",description:"Outbound event targets, delivery, and safety policy."},graceful_degradation:{apply_mode:"activation_required",description:"Subsystem failure thresholds and request guarding."},llm_recovery:{apply_mode:"restart",description:"Provider recovery, breaker, and retry policy."},turn_state:{apply_mode:"restart",description:"Durable turn checkpoints, expiry, and resume behaviour."}},Ju={timezone:{label:"Timezone",description:"Timezone used in prompts and scheduled-time parsing.",consumers:[{name:"Prompt context",apply_mode:"live_read",detail:"Future prompts read the configured value."},{name:"Time parser",apply_mode:"restart",detail:"The parser currently captures the boot value."}],restart_reason:"The scheduling parser captures timezone during startup."},"discord.token":{owner:"secrets",sensitivity:"sensitive",description:"Write-only Discord bot credential."},"discord.allowed_users":{description:"Global allowlist of Discord user IDs. An empty list allows all users."},"discord.channels":{description:"Global allowlist of Discord channel IDs. An empty list allows all channels."},"discord.require_mention":{description:"Require a mention by default unless a guild or channel override says otherwise."},"discord.respond_to_bots":{description:"Allow replies to bot-authored messages by default."},"llm_provider.active_provider":{enum:["codex","ollama","kimi"],description:"Provider used for new primary requests."},"openai_codex.enabled":{apply_mode:"live_apply",description:"Enable or disable the primary Codex client through the dedicated Codex reload path."},"openai_codex.model":{apply_mode:"live_apply",description:"Primary Codex model. Spawned agents may inherit it directly; chat and loops require a Codex reload.",consumers:[{name:"Spawned agents inheriting the main model",apply_mode:"live_read",detail:"Future agent generations read the configured model at call time."},{name:"Chat and autonomous loops",apply_mode:"live_apply",detail:"The dedicated Codex endpoint reloads the live client."}]},"openai_codex.max_tokens":{apply_mode:"live_apply",constraints:{minimum:1,maximum:128e3},unit:"tokens",description:"Maximum Codex response tokens; requires the dedicated Codex reload path."},"openai_codex.reasoning_effort":{apply_mode:"live_apply",description:"Main Codex reasoning effort; requires the dedicated Codex reload path."},"openai_codex.agent_reasoning_effort":{apply_mode:"live_read",description:"Reasoning policy for spawned-agent generations; future generations read it at call time."},"openai_codex.agent_model":{apply_mode:"live_read",description:"Model policy for spawned-agent generations; future generations read it at call time."},"openai_codex.credentials_path":{owner:"secrets",sensitivity:"sensitive",apply_mode:"restart",description:"Write-only Codex credential-store path; an existing client cannot switch stores live.",restart_reason:"The credential pool is constructed from this path when the Codex client starts."},"openai_codex.request_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Whole-request timeout; requires the dedicated Codex reload path."},"openai_codex.stream_stall_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Maximum silent-stream interval; requires the dedicated Codex reload path."},"openai_codex.retry.max_retries":{apply_mode:"live_apply",description:"Retry-attempt ceiling; requires the dedicated Codex reload path."},"openai_codex.retry.base_delay":{apply_mode:"live_apply",unit:"seconds",description:"Initial retry delay; requires the dedicated Codex reload path."},"openai_codex.retry.max_delay":{apply_mode:"live_apply",unit:"seconds",description:"Maximum retry delay; requires the dedicated Codex reload path."},"openai_codex.connection_pool.max_connections":{apply_mode:"restart",description:"Maximum Codex transport connections.",restart_reason:"Connection-pool sizing is fixed when the live client transport is constructed."},"openai_codex.connection_pool.keepalive_timeout":{apply_mode:"restart",unit:"seconds",description:"Codex connection keepalive timeout.",restart_reason:"Connection-pool keepalive policy is fixed when the live client transport is constructed."},"openai_codex.context_compression.enabled":{apply_mode:"restart",description:"Enable context compression for chat and agent tool loops.",restart_reason:"The context-compressor holder is constructed at startup and has no live apply path."},"openai_codex.context_compression.max_context_chars":{apply_mode:"restart",unit:"characters",description:"Context size at which compression begins.",restart_reason:"The context-compressor holder retains its startup configuration."},"openai_codex.context_compression.keep_recent_iterations":{apply_mode:"restart",unit:"iterations",description:"Recent tool iterations preserved during compression.",restart_reason:"The context-compressor holder retains its startup configuration."},"logging.level":{enum:["DEBUG","INFO","WARNING","ERROR","CRITICAL"],description:"Minimum runtime log level."},"browser.default_timeout_ms":{constraints:{minimum:1e3},unit:"ms",description:"Default browser operation timeout."},"browser.viewport_width":{constraints:{minimum:100,maximum:7680},unit:"px"},"browser.viewport_height":{constraints:{minimum:100,maximum:4320},unit:"px"},"sessions.max_history":{constraints:{minimum:1,maximum:1e4},unit:"messages"},"sessions.max_age_hours":{constraints:{minimum:1},unit:"hours"},"tools.command_timeout_seconds":{constraints:{minimum:10,maximum:3600},unit:"seconds"},"agents.max_children_per_agent":{apply_mode:"activation_required",description:"Child limit adopted by newly spawned parent agents after explicit activation.",activation_policy:"Explicitly apply the configured limit after reviewing worst-case tree breadth."},"context.max_system_prompt_tokens":{apply_mode:"activation_required",description:"Optional hard budget for future assembled system prompts.",activation_policy:"Preview mandatory prompt usage and omissions before applying the budget."},"usage.directory":{apply_mode:"activation_required",description:"Target for durable usage history; currently no durable store is active.",activation_policy:"Validate the path and explicitly enable durable usage history."},"slack.forward_alerts":{apply_mode:"activation_required",description:"Forward normalized internal alerts to tested Slack destinations.",activation_policy:"Requires an effective notifier, tested destination, and activation receipt."},"grafana_alerts.enabled":{apply_mode:"activation_required",description:"Adopt explicit Grafana processing control without changing legacy webhook behaviour on upgrade.",activation_policy:"Explicit adoption preserves working legacy-control installations."},"graceful_degradation.enabled":{apply_mode:"activation_required",description:"Allow subsystem guards to short-circuit calls while a dependency is unhealthy.",activation_policy:"Explicit adoption resolves the legacy always-on behaviour."}},Yw=["tools.enabled","tools.max_tool_iterations_chat","tools.max_tool_iterations_loop","learning.loop_reflection_enabled","turn_state.retention"],Qw=new Set(["token","api_token","api_key","password","secret","credentials_path","ssh_key_path","hmac_key","webhook_urls","headers","env"]);function ni(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Xw(e){return Array.isArray(e)?"array":e===null?"null":Number.isInteger(e)?"integer":typeof e=="number"?"number":typeof e=="boolean"?"boolean":typeof e=="object"?"object":"string"}function Eg(e,t="",s=[]){if(e&&typeof e=="object"&&!Array.isArray(e)){const n=Object.entries(e);n.length===0&&t&&s.push([t,e]);for(const[a,i]of n)Eg(i,t?`${t}.${a}`:a,s);return s}return t&&s.push([t,e]),s}function e1(e){return e.split(".").some(s=>Qw.has(s))}function t1(e){return Ju[e]?Ju[e]:e.startsWith("mcp.servers.")&&(e.endsWith(".headers")||e.endsWith(".env"))?{owner:"secrets",sensitivity:"secret_container"}:e.startsWith("outbound_webhooks.targets.")&&e.endsWith(".secret")?{owner:"secrets",sensitivity:"sensitive"}:e.startsWith("outbound_webhooks.targets.")&&(e.endsWith(".scrub_secrets")||e.endsWith(".verify_ssl"))?{apply_mode:"activation_required",activation_policy:"Review this target and acknowledge the target-bound safety override."}:{}}function Ag(e){return e==null||e===""?!1:Array.isArray(e)?e.length>0:typeof e=="object"?Object.keys(e).length>0:!0}function Yu(e,t){return t==="public"?e:e&&typeof e=="object"?Array.isArray(e)?[]:{}:Ag(e)?Cg:""}function s1(e){return e.valid===!1?"invalid":e.pending_restart?"pending_restart":e.drift?"drift":e.apply_mode==="activation_required"||e.apply_mode==="dormant"?"dormant":"applied"}function n1(e,t){const s=e.split(".")[0],n=e.split(".").at(-1),a=Jw[s]||{apply_mode:"restart",description:`${ni(s)} configuration.`},i=t1(e),l=i.sensitivity||(e1(e)?"sensitive":"public");let r=i.apply_mode||a.apply_mode;Yw.some(p=>e===p||e.startsWith(`${p}.`))&&(r="live_read");const o=i.owner||a.owner||(l==="public"?"config":"secrets"),c=Yu(t,l),d=Yu(t,l),u=Ag(t)&&!(l!=="public"&&t===Cg),f={path:e,owner:o,label:i.label||ni(n),description:i.description||`${ni(n)} setting for ${ni(s)}.`,aliases:i.aliases||[],unit:i.unit||null,examples:i.examples||[],type:i.type||Xw(t),enum:i.enum||null,constraints:i.constraints||{},default:i.default??null,sensitivity:l,secret_route:l==="public"?null:`/api/config/secrets/${encodeURIComponent(e)}`,apply_mode:r,apply_handler:i.apply_handler||null,consumers:i.consumers||[],restart_reason:i.restart_reason||(r==="restart"?`${ni(s)} is currently constructed during startup.`:null),activation_policy:i.activation_policy||(r==="activation_required"?"Saving configuration does not enable this feature. Explicit activation is required.":null),desired:c,effective:d,configured:u,provenance:u?"config_file":"unset",valid:!0,validation_errors:[],pending_restart:!1,drift:!1,last_apply:null};return f.apply_state=s1(f),f}function a1(e){const t={applied:0,pending_restart:0,dormant:0,invalid:0,drift:0};for(const s of e)Object.hasOwn(t,s.apply_state)&&(t[s.apply_state]+=1);return t}function i1(e){const t=Eg(e||{}).map(([s,n])=>n1(s,n));return{schema_version:1,revision:"local-fixture",generated_at:null,fields:t,status:{counts:a1(t),persistence_error:null,unsafe_overrides:[],desired_revision:null,effective_revision:null}}}const Oa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["personality","context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],l1=[{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Activation required",short:"Dormant",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"}],r1={live_read:"Applies immediately",live_apply:"Reloads live",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Activation required",legacy_control:"Legacy control",dormant:"Not wired"},Qu={llm:{label:"LLM Config",href:"#/system?tab=llm",description:"This section has one canonical editor so provider changes use the safe switch and reload paths."},personality:{label:"Personality",href:"#/personality",description:"Personality presets and the active profile are managed on the dedicated Personality page."},discord:{label:"Discord overrides",href:"#/system?tab=discord",description:"Guild and channel overrides take precedence over these global defaults."},secrets:{label:"Secret controls",href:"#/system?tab=config",description:"Secret values are write-only and use dedicated set and clear flows."}},Rg="odin_config_center_expanded_v1",Ig="odin_config_center_category_v1",o1=50,Xu=e=>Promise.resolve(i1(e));function Rn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function bi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Us(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function c1(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function d1(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Og(e,t){if(bi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Rn(t);const n={};for(const[a,i]of Object.entries(t)){const l=Og(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function u1(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Og(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Lg(e,t,s,n){if(bi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Lg(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function f1(){try{const e=JSON.parse(localStorage.getItem(Rg)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function p1(){try{const e=localStorage.getItem(Ig);return Oa.some(t=>t.key===e)?e:Oa[0].key}catch{return Oa[0].key}}const h1={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(!1),a=h(null),i=h(null),l=h(""),r=h("all"),o=h(p1()),c=h(f1()),d=h({}),u=h(null),f=h(void 0),p=h(!1),g=h({}),m=h([]),C=h([]),E=h(!1),y=h(!1),v=h(!1);let x=null;const _=ee(()=>{var P;return((P=t.value)==null?void 0:P.fields)||[]}),A=ee(()=>new Map(_.value.map(P=>[P.path,P]))),O=ee(()=>e.value?Object.keys(e.value).length:0),w=ee(()=>_.value.length),S=ee(()=>l1),L=ee(()=>m.value.length>0),H=ee(()=>C.value.length>0),M=ee(()=>{if(!e.value)return[];const P=new Set(Oa.flatMap(we=>we.sections)),j=Oa.map(we=>({...we,sections:we.sections.filter(Ce=>Object.hasOwn(e.value,Ce))})).filter(we=>we.sections.length),ae=Object.keys(e.value).filter(we=>!P.has(we));return ae.length&&j.push({key:"other",label:"Other",icon:"folder",sections:ae}),j}),D=ee(()=>{if(!e.value)return[];const P=[];for(const[j,ae]of Object.entries(d.value))Lg(e.value[j],ae,j,P);return P.filter(j=>!bi(j.oldVal,j.newVal)).map(j=>{const ae=oe(j.path);return{...j,label:(ae==null?void 0:ae.label)||Us(j.path.split(".").at(-1)),apply_mode:(ae==null?void 0:ae.apply_mode)||pe(j.path.split(".")[0])}})}),K=ee(()=>D.value.length>0),ne=ee(()=>D.value.length),$=ee(()=>new Set(D.value.map(P=>P.path.split(".")[0])).size),I=ee(()=>!!l.value||r.value!=="all"),T=ee(()=>{const P={...g.value};for(const j of D.value){const ae=oe(j.path),we=_e(ae,j.newVal);we&&(P[j.path]=we)}return P}),N=ee(()=>Object.keys(T.value).length>0),B=ee(()=>e.value?(I.value?M.value:M.value.filter(j=>j.key===o.value)).map(j=>({...j,sections:j.sections.filter(ae=>X(ae))})).filter(j=>j.sections.length):[]),W=ee(()=>{const P=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],j=new Map(P.map(ae=>[ae,[]]));for(const ae of D.value){const we=j.has(ae.apply_mode)?ae.apply_mode:"restart";j.get(we).push(ae)}return P.filter(ae=>j.get(ae).length).map(ae=>({key:ae,label:Ps(ae),entries:j.get(ae)}))}),te=ee(()=>D.value.filter(P=>P.apply_mode==="restart").length);function oe(P){var Et;if(A.value.has(P))return A.value.get(P);const j=`${P}.`,ae=_.value.filter(U=>U.path.startsWith(j));if(!ae.length)return null;const we=ae.some(U=>U.sensitivity!=="public")?"secret_container":"public",Ce=[...new Set(ae.map(U=>U.apply_mode))];return{path:P,label:Us(P.split(".").at(-1)),description:ae[0].description,type:"object",sensitivity:we,configured:ae.some(U=>U.configured),provenance:((Et=ae.find(U=>U.provenance!=="unset"))==null?void 0:Et.provenance)||"unset",apply_mode:Ce.length===1?Ce[0]:pe(P.split(".")[0]),constraints:{},enum:null}}function Q(P){const j=`${P}.`;return _.value.filter(ae=>ae.path===P||ae.path.startsWith(j))}function he(P){return Q(P).length}function Fe(P){return Us(P)}function z(P){const j=Q(P);if(!j.length)return`${Us(P)} configuration.`;const ae=j.find(Et=>Et.sensitivity==="public"&&Et.description)||j.find(Et=>Et.description),we=(ae==null?void 0:ae.description)||"";return we.match(/setting for (.+)\.$/i)?`${Us(P)} settings and runtime behaviour.`:we}function pe(P){const j=[...new Set(Q(P).map(ae=>ae.apply_mode))];return j.length===1?j[0]:j.includes("restart")?"restart":j.includes("activation_required")?"activation_required":j[0]||"restart"}function de(P){const j=[...new Set(Q(P).map(ae=>Ps(ae.apply_mode)))];return j.length?j.length===1?j[0]:`Mixed apply behaviour: ${j.join(" · ")}`:""}function xe(P){const j=Q(P),ae=j.map(U=>U.owner).filter(U=>U&&U!=="config"&&U!=="secrets");if(!ae.length)return null;const we=ae.reduce((U,le)=>({...U,[le]:(U[le]||0)+1}),{}),[Ce,Et]=Object.entries(we).sort((U,le)=>le[1]-U[1])[0];return Et>=Math.max(1,j.length-1)&&Qu[Ce]?Ce:null}function me(P){return Qu[P]||{label:Us(P),href:"#/system?tab=config",description:"This feature uses a dedicated configuration and activation panel."}}function Be(P){var j;return Object.hasOwn(d.value,P)?d.value[P]:(j=e.value)==null?void 0:j[P]}function b(P){const j=Be(P);return(j&&typeof j=="object"&&!Array.isArray(j)?Object.entries(j).map(([we,Ce])=>({key:we,path:`${P}.${we}`,value:Ce})):[{key:null,path:P,value:j}]).map(we=>{const Ce=oe(we.path)||{};return{...Ce,...we,label:Ce.label||(we.key===null?Fe(P):Us(we.key)),description:Ce.description||`${Us(we.key||P)} setting for ${Us(P)}.`,apply_mode:Ce.apply_mode||pe(P),sensitivity:Ce.sensitivity||"public",constraints:Ce.constraints||{},configured:Ce.configured??!0,provenance:Ce.provenance||"config_file"}})}function R(P,j){return[P.label,P.path,P.description,...P.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(j)}function F(P){const j=l.value.trim().toLowerCase();return j?Q(P).filter(ae=>R(ae,j)):[]}function X(P){const j=Q(P);if(r.value!=="all"&&!j.some(we=>we.apply_state===r.value))return!1;const ae=l.value.trim().toLowerCase();return!ae||`${Fe(P)} ${P}`.toLowerCase().includes(ae)?!0:j.some(we=>R(we,ae))}function Z(P,j){return Q(P).filter(ae=>ae.apply_state===j).length}function J(P){var j,ae,we;return P==="all"?w.value:((we=(ae=(j=t.value)==null?void 0:j.status)==null?void 0:ae.counts)==null?void 0:we[P])??_.value.filter(Ce=>Ce.apply_state===P).length}function ue(P){const j=P.sections.flatMap(ae=>Q(ae));return{fields:j.length,modified:D.value.filter(ae=>P.sections.includes(ae.path.split(".")[0])).length,pending_restart:j.filter(ae=>ae.apply_state==="pending_restart").length,invalid:j.filter(ae=>ae.apply_state==="invalid").length,dormant:j.filter(ae=>ae.apply_state==="dormant").length}}function re(P){var j;return Object.hasOwn(d.value,P)&&!bi((j=e.value)==null?void 0:j[P],d.value[P])}function ie(P){return D.value.some(j=>j.path===P||j.path.startsWith(`${P}.`))}function se(P){o.value=P,l.value="",r.value="all";try{localStorage.setItem(Ig,P)}catch{}}function ye(P){r.value=P}function fe(){l.value="",r.value="all"}function ge(P){return c.value[P]?!0:!!(l.value&&!v.value&&X(P))}function ke(P){const j=!ge(P);v.value&&j?c.value={[P]:!0}:c.value={...c.value,[P]:j}}function Te(){m.value.push(Rn(d.value)),m.value.length>o1&&m.value.shift(),C.value=[]}function Re(P){u.value!==P&&(u.value=P,p.value=Object.hasOwn(d.value,P),f.value=p.value?Rn(d.value[P]):void 0,p.value||(d.value={...d.value,[P]:Rn(e.value[P])}),c.value=v.value?{[P]:!0}:{...c.value,[P]:!0})}function Ne(P){if(!De(P)){if(bi(d.value[P],e.value[P])){const j={...d.value};delete j[P],d.value=j}u.value=null,f.value=void 0,p.value=!1}}function Pe(P){const j={...d.value};p.value?j[P]=Rn(f.value):delete j[P],d.value=j,u.value=null,f.value=void 0,p.value=!1;const ae=`${P}.`;g.value=Object.fromEntries(Object.entries(g.value).filter(([we])=>we!==P&&!we.startsWith(ae)))}function Ve(){!K.value&&!u.value||(Te(),d.value={},u.value=null,f.value=void 0,p.value=!1,g.value={},E.value=!1)}function st(P,j){const ae=P.path.split(".")[0];if(u.value!==ae)return;Te();const we=Rn(d.value[ae]);if(P.key===null?d.value={...d.value,[ae]:j}:(we[P.key]=j,d.value={...d.value,[ae]:we}),g.value[P.path]){const Ce={...g.value};delete Ce[P.path],g.value=Ce}}function V(P,j){try{const ae=JSON.parse(j),we={...g.value};delete we[P.path],g.value=we,st(P,ae)}catch(ae){g.value={...g.value,[P.path]:`Invalid JSON: ${ae.message}`}}}function _e(P,j){var we;if(!P)return null;if((we=P.enum)!=null&&we.length&&!P.enum.includes(j))return`Choose one of: ${P.enum.join(", ")}`;const ae=P.constraints||{};if((P.type==="integer"||P.type==="number")&&typeof j=="number"){if(ae.minimum!==void 0&&j<ae.minimum)return`Must be at least ${ae.minimum}${P.unit?` ${P.unit}`:""}`;if(ae.maximum!==void 0&&j>ae.maximum)return`Must be at most ${ae.maximum}${P.unit?` ${P.unit}`:""}`}return null}function Ie(P){return T.value[P.path]||null}function De(P){const j=`${P}.`;return Object.keys(T.value).some(ae=>ae===P||ae.startsWith(j))}function ze(){m.value.length&&(C.value.push(Rn(d.value)),d.value=m.value.pop(),g.value={})}function Ye(){C.value.length&&(m.value.push(Rn(d.value)),d.value=C.value.pop(),g.value={})}function ht(){!K.value||N.value||(u.value&&Ne(u.value),E.value=!0,y.value=!1)}function ts(){E.value=!1}function Is(){u.value?Pe(u.value):Ve()}function Ps(P){return r1[P]||Us(P||"unknown")}function Fs(P){return`apply-${String(P||"unknown").replaceAll("_","-")}`}function us(P){return`cfgc-field-${P.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function q(P){return`${us(P)}-input`}function Ee(P){const j=document.getElementById(us(P))||document.getElementById(us(P.split(".").slice(0,2).join(".")));j==null||j.scrollIntoView({behavior:"smooth",block:"center"})}function fs(P,j){i.value={type:P,message:j},window.setTimeout(()=>{var ae;((ae=i.value)==null?void 0:ae.message)===j&&(i.value=null)},3500)}async function Zs(){if(!(!K.value||N.value||n.value)){n.value=!0;try{const P=u1(e.value,d.value),j=await Y.put("/api/config",P);e.value=j,t.value=await Xu(j),d.value={},u.value=null,f.value=void 0,p.value=!1,m.value=[],C.value=[],g.value={},E.value=!1,fs("success","Configuration saved. Apply status has been refreshed.")}catch(P){fs("error",P.message||"Configuration could not be saved")}finally{n.value=!1}}}async function ca(){var P;if(!K.value){s.value=!0,a.value=null;try{const j=await Y.get("/api/config"),ae=await Xu(j);e.value=j,t.value=ae;const we=M.value;we.some(Ce=>Ce.key===o.value)||(o.value=((P=we[0])==null?void 0:P.key)||Oa[0].key)}catch(j){a.value=j.message||"Unknown configuration error"}finally{s.value=!1}}}function kn(P){if(E.value||!(P.ctrlKey||P.metaKey))return;const j=P.target;j instanceof HTMLElement&&(j.matches("input, textarea, select")||j.isContentEditable)||(!P.shiftKey&&P.key.toLowerCase()==="z"?(P.preventDefault(),ze()):(P.key.toLowerCase()==="y"||P.shiftKey&&P.key.toLowerCase()==="z")&&(P.preventDefault(),Ye()))}function Js(P){if(v.value=P.matches,P.matches){const j=Object.keys(c.value).find(ae=>c.value[ae]);c.value=j?{[j]:!0}:{}}}return ds(c,P=>{try{localStorage.setItem(Rg,JSON.stringify(P))}catch{}},{deep:!0}),Je(()=>{var P;ca(),document.addEventListener("keydown",kn),x=window.matchMedia("(max-width: 760px)"),Js(x),(P=x.addEventListener)==null||P.call(x,"change",Js)}),_t(()=>{var P;document.removeEventListener("keydown",kn),(P=x==null?void 0:x.removeEventListener)==null||P.call(x,"change",Js)}),{config:e,meta:t,loading:s,saving:n,error:a,toast:i,searchQuery:l,healthFilter:r,activeCategory:o,editingSection:u,reviewOpen:E,mobileOverflowOpen:y,healthFilters:S,visibleCategories:M,displayGroups:B,reviewGroups:W,sectionCount:O,fieldCount:w,hasChanges:K,changeCount:ne,changedSectionCount:$,hasDraftErrors:N,canUndo:L,canRedo:H,globalFilterActive:I,reviewRestartCount:te,healthCount:J,categoryStats:ue,selectCategory:se,selectHealthFilter:ye,clearFilters:fe,sectionLabel:Fe,sectionDescription:z,sectionFieldCount:he,sectionHealthCount:Z,sectionApplySummary:de,sectionOwner:xe,ownerInfo:me,sectionEntries:b,sectionSearchHits:F,sectionChanged:re,fieldChanged:ie,isSectionExpanded:ge,toggleSection:ke,startSectionDraft:Re,finishSectionDraft:Ne,cancelSectionDraft:Pe,discardAllDrafts:Ve,setFieldValue:st,setJsonFieldValue:V,fieldError:Ie,sectionHasErrors:De,undo:ze,redo:Ye,openReview:ht,closeReview:ts,mobileCancel:Is,applyModeLabel:Ps,applyClass:Fs,compactValue:c1,formatValue:d1,fieldId:us,fieldInputId:q,focusField:Ee,fetchConfig:ca,saveConfig:Zs}}},g1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({});function a(p){return p.config&&p.config.enabled!==void 0?p.config.enabled:!0}function i(p){return p.config&&p.config.require_mention!==void 0?p.config.require_mention:!1}function l(p){return p.config&&p.config.respond_to_bots!==void 0?p.config.respond_to_bots:!1}function r(p){return p.config&&Object.keys(p.config).length>0}function o(p){n.value[p]=!n.value[p]}async function c(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/discord/guilds")}catch(p){s.value=p.message}t.value=!1}async function d(p,g,m){try{await Y.put("/api/discord/guild/"+p+"/config",{[g]:m}),await c()}catch(C){s.value=C.message}}async function u(p,g,m,C){try{await Y.put("/api/discord/channel/"+p+"/config",{[m]:C}),await c()}catch(E){s.value=E.message}}async function f(p,g){try{await Y.put("/api/discord/channel/"+p+"/config",{clear:!0}),await c()}catch(m){s.value=m.message}}return Je(c),{guilds:e,loading:t,error:s,expanded:n,guildEnabled:a,guildMention:i,guildBots:l,hasOverride:r,toggleGuild:o,fetchGuilds:c,setGuildConfig:d,setChannelConfig:u,clearOverride:f}}},hs=e=>e==null?e:JSON.parse(JSON.stringify(e));function m1({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:r=()=>{},onError:o=()=>{}}){let c=Promise.resolve(),d=0,u=0;const f=new Map;let p=null;const g=new Map;function m(A){d+=1;const O=c.then(A,A);return c=O.catch(()=>{}),O}function C(A,O){p=hs(A),g.clear();for(const[w,S]of Object.entries(O||{}))g.set(w,hs(S))}function E(A){const O=hs(A),w=++u;return m(async()=>{try{await e(hs(O)),p=hs(O),w===u&&n(hs(O))}catch(S){w===u&&(a(hs(p)),o(S,{kind:"default"}))}})}function y(A,O){const w=hs(O),S=(f.get(A)||0)+1;return f.set(A,S),m(async()=>{try{await t(A,hs(w)),g.set(A,hs(w)),S===f.get(A)&&i(A,hs(w))}catch(L){S===f.get(A)&&(l(A,hs(g.get(A)??null)),o(L,{kind:"user",uid:A}))}})}function v(A){const O=(f.get(A)||0)+1;return f.set(A,O),m(async()=>{try{await s(A),g.delete(A),O===f.get(A)&&r(A)}catch(w){O===f.get(A)&&(l(A,hs(g.get(A)??null)),o(w,{kind:"delete",uid:A}))}})}async function x(){for(;;){const A=c;if(await A,A===c)return d}}async function _(A){for(;;){const O=await x(),w=await A();if(O===d)return w}}return{seed:C,saveDefault:E,saveUser:y,deleteUser:v,whenIdle:x,readSnapshot:_,get revision(){return d}}}const v1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),d=h([]),u=h(null),f=ee(()=>{const B={};for(const W of d.value)B[W.id]=W;return B});function p(B){return f.value[B]||null}const g=ee(()=>/^\d{15,25}$/.test(r.value.trim())),m=ee(()=>{if(o.value){if(C.value[c.value])return"host-user-option-"+c.value;if(g.value)return"host-user-option-raw"}}),C=ee(()=>{const B=r.value.toLowerCase().trim();return B?d.value.filter(W=>!i.value[W.id]&&(W.display_name.toLowerCase().includes(B)||W.username.toLowerCase().includes(B)||W.id.includes(B))):d.value.filter(W=>!i.value[W.id])});function E(B,W){return B?B.allowed_hosts===null||B.allowed_hosts===void 0?{allowed_hosts:[...W],default_host:B.default_host||"",allow_all:!0}:{allowed_hosts:B.allowed_hosts,default_host:B.default_host||"",allow_all:!1}:{allowed_hosts:[...W],default_host:W[0]||"",allow_all:!0}}const y=m1({applyDefault:async B=>{const W=B.allow_all?null:B.allowed_hosts;await Y.put("/api/host-access/default-policy",{allowed_hosts:W,default_host:B.default_host})},applyUser:async(B,W)=>{const te=W.allow_all?null:W.allowed_hosts;await Y.put(`/api/host-access/user/${B}`,{allowed_hosts:te,default_host:W.default_host})},applyDelete:B=>Y.del(`/api/host-access/user/${B}`),onDefaultConfirmed:()=>Se.success("Default policy updated"),onDefaultRollback:B=>{B&&(a.value=B)},onUserConfirmed:B=>{const W=p(B);Se.success(`Updated access for ${W?W.display_name:B}`)},onUserRollback:(B,W)=>{const te={...i.value};W?te[B]=W:delete te[B],i.value=te},onUserDeleted:B=>{const W={...i.value};delete W[B],i.value=W},onError:(B,W)=>{var oe;const te=W.uid?` ${((oe=p(W.uid))==null?void 0:oe.display_name)||W.uid}`:"";Se.error(`${B.message||"Failed to save"} — reverted${te}`)}});let v=0;async function x(){const B=++v;e.value=!0,t.value="";try{const W=await y.readSnapshot(()=>Y.get("/api/host-access"));if(B!==v)return;s.value=W,n.value=W.available_hosts||[],a.value=E(W.default_policy,n.value);const te=W.users||{},oe={};for(const[Q,he]of Object.entries(te))oe[Q]=E(he,n.value);i.value=oe,y.seed(a.value,oe)}catch(W){B===v&&(t.value=W.message||"Failed to fetch host access data")}finally{B===v&&(e.value=!1)}try{const W=await Y.get("/api/discord/members")||[];B===v&&(d.value=W)}catch{B===v&&(d.value=[])}}function _(){y.saveDefault(a.value)}function A(B,W){a.value.allow_all=!1,W?a.value.allowed_hosts.includes(B)||a.value.allowed_hosts.push(B):(a.value.allowed_hosts=a.value.allowed_hosts.filter(te=>te!==B),a.value.default_host===B&&(a.value.default_host=a.value.allowed_hosts[0]||"")),_()}function O(B){const W=i.value[B];W&&y.saveUser(B,W)}function w(B,W,te){const oe=i.value[B];oe&&(oe.allow_all=!1,te?oe.allowed_hosts.includes(W)||oe.allowed_hosts.push(W):(oe.allowed_hosts=oe.allowed_hosts.filter(Q=>Q!==W),oe.default_host===W&&(oe.default_host=oe.allowed_hosts[0]||"")),O(B))}function S(B,W){const te=i.value[B];te&&(te.default_host=W,O(B))}function L(){l.value=!0,r.value="",c.value=0,Ot(()=>{u.value&&u.value.focus()})}function H(){o.value=!0,c.value=0}function M(){c.value<C.value.length-1&&c.value++}function D(){c.value>0&&c.value--}function K(){const B=C.value[c.value];if(B){$(B);return}g.value&&ne()}function ne(){const B=r.value.trim();/^\d{15,25}$/.test(B)&&(i.value[B]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},O(B),r.value="",o.value=!1,l.value=!1)}function $(B){i.value[B.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},O(B.id),r.value="",o.value=!1,l.value=!1}function I(){o.value=!1}function T(){setTimeout(()=>{o.value=!1},150)}async function N(B){const W=p(B);await bs({title:"Remove user override",message:`Remove the host access override for ${W?W.display_name:B}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await y.deleteUser(B),i.value[B]||Se.success(`Removed override for ${W?W.display_name:B}`))}return Je(x),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:d,filteredMembers:C,isRawId:g,activeOptionId:m,searchInput:u,fetchData:x,saveDefaultPolicy:_,toggleDefaultHost:A,getMember:p,toggleUserHost:w,setUserDefault:S,openAddUser:L,deleteUser:N,onSearchInput:H,highlightNext:M,highlightPrev:D,selectHighlighted:K,selectMember:$,closeDropdown:I,onBlur:T,addRawId:ne}}},b1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=ee(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=ee(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function p(w){return w==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":w==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function g(){e.value=!0,t.value="";try{const w=await Y.get("/api/tokens");s.value=w.tokens||[],n.value=w.available_hosts||[]}catch(w){t.value=w.message||"Failed to load tokens"}finally{e.value=!1}}function m(w){return!w||!w.trim()?[]:w.split(",").map(S=>S.trim()).filter(Boolean)}function C(w,S){const L=c.value.allowed_hosts;if(S&&!L.includes(w)&&L.push(w),!S){const H=L.indexOf(w);H>=0&&L.splice(H,1)}}function E(w,S){const L=d.value.allowed_hosts;if(S&&!L.includes(w)&&L.push(w),!S){const H=L.indexOf(w);H>=0&&L.splice(H,1)}}async function y(){var w;i.value=!0;try{const S=m(c.value.allowed_tools_str),L=c.value.host_mode,H=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,M={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:S.length?S:[]};H!==null&&(M.allowed_hosts=H),M.default_host=c.value.default_host||"";const D=await Y.post("/api/tokens",M);l.value=D.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Se.success("Token created"),await g()}catch(S){Se.error(((w=S.data)==null?void 0:w.error)||S.message||"Failed to create token")}finally{i.value=!1}}function v(w){r.value=w;const S=w.allowed_hosts;let L="default";S==null?L="default":Array.isArray(S)&&S.length===0?L="none":Array.isArray(S)&&(L="select"),d.value={username:w.username||"",tier:w.tier||"admin",label:w.label||"",host_mode:L,allowed_hosts:Array.isArray(S)?[...S]:[],default_host:w.default_host||"",allowed_tools_str:(w.allowed_tools||[]).join(", ")}}async function x(){var w;if(r.value){o.value=!0;try{const S=m(d.value.allowed_tools_str),L=d.value.host_mode,H={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:S};L==="none"?H.allowed_hosts=[]:L==="select"?H.allowed_hosts=d.value.allowed_hosts:H.allowed_hosts=null,H.default_host=d.value.default_host||"",await Y.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,Se.success("Token updated"),await g()}catch(S){Se.error(((w=S.data)==null?void 0:w.error)||S.message||"Failed to update")}finally{o.value=!1}}}async function _(w){var L;if(await bs({title:"Regenerate token",message:`Regenerate token for ${w.username||w.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await Y.post("/api/tokens/"+encodeURIComponent(w.user_id)+"/regenerate");l.value=H.token,Se.success("Token regenerated")}catch(H){Se.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to regenerate")}}async function A(w){var L;if(await bs({title:"Delete token",message:`Delete token for ${w.username||w.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/tokens/"+encodeURIComponent(w.user_id)),Se.success("Token deleted"),await g()}catch(H){Se.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),Se.success("Copied to clipboard")}catch{Se.error("Copy failed — select and copy manually")}}return Je(g),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:f,fetchData:g,tierBadge:p,toggleCreateHost:C,toggleEditHost:E,createToken:y,startEdit:v,saveEdit:x,confirmRegenerate:_,confirmDelete:A,copyToken:O}}};function ul(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const y1={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=ee(()=>{const q=n.value.model;return q&&!a.includes(q)?[q,...a]:a}),l=ee(()=>{const q=n.value.agent_model;return q&&q!=="auto"&&!a.includes(q)?[q,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=ee(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=ee(()=>{const q=n.value.agent_model;return q==="auto"?!0:!r.includes(q||n.value.model)}),d=ee(()=>{const q=n.value.agent_reasoning_effort;return q==="auto"?!1:(q||n.value.reasoning_effort)==="max"}),u=q=>r.includes(q)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),f=q=>r.includes(q)&&d.value,p=h({enabled:!1,model:"gpt-5.6-luna"}),g=h({unavailable_reason:null}),m=ee(()=>{const q=p.value.model;return q&&!a.includes(q)?[q,...a]:a});function C(q){const Ee=q.target.value;p.value.enabled=Ee!=="",Ee!==""&&(p.value.model=Ee),Ve()}const E=h(!1),y=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),v=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),x=h(!1),_=h(!1),A=h(!1),O=h(!1),w=h(!1),S=h(!1),L=h(!1),H=h({configured:!1}),M=h([]),D=h(""),K=h(!1),ne=h(!1),$=h({configured:!1}),I=h([]),T=h(""),N=h(!1),B=h(!1),W=h(!0),te=h(""),oe=h({configured:!1,accounts:[]}),Q=h(null),he=h(null),Fe=h(""),z=h(null),pe=h(!1),de=h(null),xe=h(null),me=h("");let Be=null;function b(q,Ee="success"){Se(q,Ee==="error"?"error":"success")}function R(q){if(!q)return"?";const Ee=q/(1024*1024*1024);return Ee>=1?Ee.toFixed(1)+" GB":(q/(1024*1024)).toFixed(0)+" MB"}async function F(){e.value=!0,await Promise.all([X(),Z(),ye(),J()]),e.value=!1}async function X(){try{const q=await Y.get("/api/llm/status");t.value=q,s.value=q.active_provider||"codex",q.codex&&!Pe.pending()&&(n.value.enabled=q.codex.enabled,n.value.model=q.codex.model||"gpt-5.5",n.value.reasoning_effort=q.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=q.codex.agent_reasoning_effort||"",n.value.agent_model=q.codex.agent_model||"",n.value.max_tokens=q.codex.max_tokens||4096),q.ollama&&!st.pending()&&(y.value.enabled=q.ollama.enabled,y.value.base_url=q.ollama.base_url||"",y.value.model=q.ollama.model||"",y.value.max_tokens=q.ollama.max_tokens||4096),q.kimi&&!V.pending()&&(v.value.enabled=q.kimi.enabled,v.value.model=q.kimi.model||"",v.value.max_tokens=q.kimi.max_tokens||4096),q.auxiliary&&(g.value=q.auxiliary,Ve.pending()||(p.value.enabled=q.auxiliary.enabled,p.value.model=q.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Z(){try{if(H.value=await Y.get("/api/ollama/status"),H.value.model&&(D.value=H.value.model),H.value.configured)try{const q=await Y.get("/api/ollama/models");M.value=q.models||[]}catch{M.value=[]}else if(y.value.base_url)try{const q=await Y.post("/api/ollama/probe-models",{base_url:y.value.base_url});M.value=q.models||[]}catch{M.value=[]}}catch{H.value={configured:!1}}}async function J(){W.value=!0,te.value="";try{oe.value=await Y.get("/api/codex/status")}catch(q){te.value=q.message||"Failed to fetch Codex status"}finally{W.value=!1}}async function ue(){const q=t.value?t.value.active_provider:"codex";L.value=!0;try{const Ee=await Y.post("/api/llm/switch",{provider:s.value});Ee.error?(s.value=q,b(Ee.error,"error")):(b("Switched to "+s.value+" ("+Ee.model+")"),await F())}catch(Ee){s.value=q,b(Ee.message||"Switch failed","error")}finally{L.value=!1}}async function re(){K.value=!0;try{const q=await Y.post("/api/ollama/reload");b(q.configured?"Ollama reloaded":q.reason||"Ollama not configured",q.configured?"success":"error"),await F()}catch(q){b(q.message||"Reload failed","error")}finally{K.value=!1}}async function ie(){ne.value=!0;try{await Y.post("/api/ollama/model",{model:D.value}),b("Model set to "+D.value),await F()}catch(q){b(q.message||"Failed","error")}finally{ne.value=!1}}async function se(){const q=y.value.base_url;if(!q){b("Enter a base URL first","error");return}S.value=!0;try{const Ee=await Y.post("/api/ollama/probe-models",{base_url:q});M.value=Ee.models||[],M.value.length?(b(M.value.length+" model(s) found"),!y.value.model&&M.value.length&&(y.value.model=M.value[0].name)):b("No models found at "+q,"error")}catch(Ee){b(Ee.message||"Could not reach Ollama","error")}finally{S.value=!1}}async function ye(){try{if($.value=await Y.get("/api/kimi/status"),$.value.model&&(T.value=$.value.model),$.value.configured)try{const q=await Y.get("/api/kimi/models");I.value=q.models||[]}catch{I.value=[]}}catch{$.value={configured:!1}}}async function fe(){N.value=!0;try{const q=await Y.post("/api/kimi/reload");b(q.configured?"Kimi reloaded":q.reason||"Kimi not configured",q.configured?"success":"error"),await F()}catch(q){b(q.message||"Reload failed","error")}finally{N.value=!1}}async function ge(){B.value=!0;try{await Y.post("/api/kimi/model",{model:T.value}),b("Model set to "+T.value),await F()}catch(q){b(q.message||"Failed","error")}finally{B.value=!1}}async function ke(){if(A.value){Pe();return}A.value=!0;try{await Y.put("/api/llm/codex/config",n.value),b("Codex config saved"),await Promise.all([X(),J()])}catch(q){b(q.message||"Failed","error"),await Promise.all([X(),J()])}finally{A.value=!1}}async function Te(){if(O.value){st();return}O.value=!0;try{const q={...y.value},Ee=x.value?y.value.api_key:null;Ee===null&&delete q.api_key,await Y.put("/api/llm/ollama/config",q),b("Ollama config saved"),Ee!==null&&y.value.api_key===Ee&&(y.value.api_key="",x.value=!1),await Promise.all([X(),Z()])}catch(q){b(q.message||"Failed","error")}finally{O.value=!1}}async function Re(){if(w.value){V();return}w.value=!0;try{const q={...v.value},Ee=_.value?v.value.api_key:null;Ee===null&&delete q.api_key,await Y.put("/api/llm/kimi/config",q),b("Kimi config saved"),Ee!==null&&v.value.api_key===Ee&&(v.value.api_key="",_.value=!1),await Promise.all([X(),ye()])}catch(q){b(q.message||"Failed","error")}finally{w.value=!1}}async function Ne(){if(E.value){Ve();return}E.value=!0;try{await Y.put("/api/llm/auxiliary/config",p.value),b("Auxiliary config saved"),await X()}catch(q){b(q.message||"Failed","error"),await X()}finally{E.value=!1}}const Pe=ul(ke),Ve=ul(Ne),st=ul(Te),V=ul(Re),_e=()=>(Pe.cancel(),ke()),Ie=()=>(st.cancel(),Te()),De=()=>(V.cancel(),Re());async function ze(q){try{await Y.post("/api/codex/account/"+q+"/activate"),b("Active account switched"),await J()}catch(Ee){b(Ee.message||"Failed","error")}}async function Ye(q){Q.value=q;try{await Y.post("/api/codex/account/"+q+"/refresh"),b("Token refreshed"),await J()}catch(Ee){b(Ee.message||"Refresh failed","error")}finally{Q.value=null}}function ht(q,Ee){he.value=q,Fe.value=Ee||""}async function ts(q){try{await Y.put("/api/codex/account/"+q+"/label",{label:Fe.value}),b("Label updated"),he.value=null,await J()}catch(Ee){b(Ee.message||"Failed","error")}}async function Is(q,Ee){if(await bs({title:"Delete Codex account",message:`Delete ${Ee||"account #"+(q+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/codex/account/"+q),b("Deleted. Pool reloaded."),await J()}catch(Zs){b(Zs.message||"Failed","error")}}async function Ps(){pe.value=!0;try{const q=await Y.post("/api/codex/device-code");de.value=q,z.value="pending",Fs(q)}catch(q){b(q.message||"Failed","error")}finally{pe.value=!1}}async function Fs(q){Be={cancelled:!1};const Ee=Be;try{const fs=await Y.post("/api/codex/device-poll",{device_auth_id:q.device_auth_id,user_code:q.user_code,interval:q.interval});if(Ee.cancelled)return;xe.value=fs,z.value="success",await F()}catch(fs){if(Ee.cancelled)return;me.value=fs.message||"Device login failed",z.value="error"}}function us(){Be&&(Be.cancelled=!0),z.value=null,de.value=null}return Je(F),_t(()=>{Be&&(Be.cancelled=!0),Pe.cancel(),Ve.cancel(),st.cancel(),V.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:L,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:f,auxForm:p,auxData:g,auxModelOptions:m,onAuxModelChange:C,savingAux:E,saveAuxConfigDebounced:Ve,ollamaForm:y,kimiForm:v,savingCodex:A,savingOllama:O,savingKimi:w,probingOllama:S,ollamaKeyDirty:x,kimiKeyDirty:_,ollamaStatus:H,ollamaModels:M,ollamaSelectedModel:D,reloading:K,settingModel:ne,kimiStatus:$,kimiModels:I,kimiSelectedModel:T,reloadingKimi:N,settingKimiModel:B,codexLoading:W,codexError:te,codexData:oe,refreshing:Q,editingLabel:he,labelValue:Fe,deviceState:z,deviceLoading:pe,deviceInfo:de,deviceResult:xe,deviceError:me,fetchAll:F,switchProvider:ue,reloadOllama:re,setOllamaModel:ie,reloadKimi:fe,setKimiModel:ge,probeOllamaModels:se,saveCodexConfig:ke,saveOllamaConfig:Te,saveKimiConfig:Re,saveCodexConfigDebounced:Pe,saveOllamaConfigDebounced:st,saveKimiConfigDebounced:V,saveCodexConfigNow:_e,saveOllamaConfigNow:Ie,saveKimiConfigNow:De,activateAccount:ze,refreshAccount:Ye,startEditLabel:ht,saveLabel:ts,deleteAccount:Is,startDeviceLogin:Ps,cancelDeviceLogin:us,formatSize:R}}},ef={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function x1(e){return ef[e]||ef[(e||"").toLowerCase()]||"text-gray-400"}const _1={template:`
  ...
  `},w1={components:{TabbedPage:wr},setup(){return{tabs:[{id:"health",label:"Health",component:zw},{id:"resources",label:"Resources",component:qw},{id:"logs",label:"Logs",component:Zw},{id:"config",label:"Config",component:h1},{id:"discord",label:"Discord",component:g1},{id:"host-access",label:"Host Access",component:v1},{id:"api-tokens",label:"API Tokens",component:b1},{id:"llm",label:"LLM Config",component:y1},{id:"internals",label:"Internals",component:_1},{id:"update",label:"Update",component:k1}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Ng=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:J_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:hw,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:ww,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:Iw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Uw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:Bw,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:w1,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/internals",redirect:kt("/system","internals")}],yi=V_({history:x_(),routes:Ng});yi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const S1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),d=h("disconnected"),u=h(-1),f=h(null);let p=null;const g=h("starting"),m=h(""),C=Ng.filter(I=>I.meta),E=ee(()=>["Workspace","Operate","Observe","Manage"].map(I=>({name:I,routes:C.filter(T=>T.meta.section===I)})).filter(I=>I.routes.length)),y=ee(()=>{var I;return((I=yi.currentRoute.value.meta)==null?void 0:I.label)||"Odin"}),v=ee(()=>{var I;return((I=yi.currentRoute.value.meta)==null?void 0:I.section)||"Management"}),x=ee(()=>{var I;return((I=yi.currentRoute.value.meta)==null?void 0:I.description)||"Management console"});Y.onSessionExpired=()=>{t.value=!0,We.disconnect(),Y.setToken(""),e.value="login"};function _(I){var T;if((I.ctrlKey||I.metaKey)&&I.key.toLowerCase()==="k"){e.value==="ready"&&(I.preventDefault(),Tu());return}if(n.value&&I.key==="Tab"){const N=[...((T=a.value)==null?void 0:T.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(N.length){const B=N[0],W=N[N.length-1];if(I.shiftKey&&(document.activeElement===B||!a.value.contains(document.activeElement))){I.preventDefault(),W.focus();return}if(!I.shiftKey&&(document.activeElement===W||!a.value.contains(document.activeElement))){I.preventDefault(),B.focus();return}}}if(I.key==="Escape"&&n.value){n.value=!1,I.preventDefault();return}if(I.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(I.target.tagName)){I.preventDefault();const N=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');N&&N.focus()}}function A(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Je(async()=>{document.addEventListener("keydown",_),r=window.matchMedia("(max-width: 900px)"),A(),r.addEventListener("change",A);const I=await Y.check();I.ok?(e.value="ready",ne()):I.needsAuth?e.value="login":(e.value="ready",ne())});function O(){t.value=!1,e.value="ready",ne()}async function w(){await Y.logout(),We.disconnect(),e.value="login"}function S(){s.value=!s.value}function L(){n.value=!n.value}ds(n,async I=>{var T,N;if(I)o=document.activeElement,await Ot(),(N=(T=a.value)==null?void 0:T.querySelector(".nav-item"))==null||N.focus();else if(o!=null&&o.isConnected){const B=o;o=null,requestAnimationFrame(()=>B.focus())}});const H=ee(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(I,T="info",N=3e3){f.value={text:I,level:T},clearTimeout(p),p=setTimeout(()=>{f.value=null},N)}let D=null,K=!1;function ne(){We.onStatusChange=I=>{c.value=I},We.onStateChange=(I,T)=>{d.value=I,u.value=T.latency??-1,I==="connected"?(K&&M("Connection restored","success"),K=!0):I==="reconnecting"&&T.attempt===1&&M("Connection lost — reconnecting…","warn")},We.connect(),$(),D&&clearInterval(D),D=setInterval($,15e3)}async function $(){try{const I=await Y.get("/api/status");g.value=I.status==="online"?"online":"starting";const T=I.uptime_seconds||0,N=Math.floor(T/3600),B=Math.floor(T%3600/60);m.value=`${N}h ${B}m uptime`}catch{g.value="offline",m.value=""}}return _t(()=>{D&&clearInterval(D),We.disconnect(),document.removeEventListener("keydown",_),r==null||r.removeEventListener("change",A)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:H,wsToast:f,botStatus:g,botUptime:m,navRoutes:C,navGroups:E,currentPage:y,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:O,logout:w,toggleSidebar:S,toggleMobileNavigation:L,openPalette:Tu}}},$n=Pl(T1);$n.component("odin-icon",K_);$n.component("login-screen",S1);$n.component("toast-container",D0);$n.component("confirm-host",M0);$n.component("command-palette",G_);$n.directive("modal-focus",Z_);$n.use(yi);$n.mount("#app");
