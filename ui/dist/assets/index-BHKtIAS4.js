 ...
 */let R_=()=>location.protocol+"//"+location.host;function mm(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),xu(r,"")}return xu(s,e)+n+a}function I_(e,t,s,n){let a=[],i=[],l=null;const r=({state:p})=>{const f=mm(e,location),m=s.value,b=t.value;let E=0;if(p){if(s.value=f,t.value=p,l&&l===m){l=null;return}E=b?p.position-b.position:0}else n(f);a.forEach(R=>{R(s.value,m,{delta:E,type:Vo.pop,direction:E?E>0?no.forward:no.back:no.unknown})})};function o(){l=s.value}function c(p){a.push(p);const f=()=>{const m=a.indexOf(p);m>-1&&a.splice(m,1)};return i.push(f),f}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(st({},p.state,{scroll:Dr()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:o,listen:c,destroy:u}}function Tu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?Dr():null}}function O_(e){const{history:t,location:s}=window,n={value:mm(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+o:R_()+e+o;try{t[d?"replaceState":"pushState"](c,"",p),a.value=c}catch(f){console.error(f),s[d?"replace":"assign"](p)}}function l(o,c){i(o,st({},t.state,Tu(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const d=st({},a.value,t.state,{forward:o,scroll:Dr()});i(d.current,d,!0),i(o,st({},Tu(n.value,o,null),{position:d.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function L_(e){e=m_(e);const t=O_(e),s=I_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=st({location:"",base:e,go:n,createHref:g_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function N_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),L_(e)}let la=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Ot=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Ot||{});const M_={type:la.Static,value:""},P_=/[a-zA-Z0-9_]/;function D_(e){if(!e)return[[]];if(e==="/")return[[M_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(f){throw new Error(`ERR (${s})/"${c}": ${f}`)}let s=Ot.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",d="";function u(){c&&(s===Ot.Static?i.push({type:la.Static,value:c}):s===Ot.Param||s===Ot.ParamRegExp||s===Ot.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:la.Param,value:c,regexp:d,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==Ot.ParamRegExp){n=s,s=Ot.EscapeNext;continue}switch(s){case Ot.Static:o==="/"?(c&&u(),l()):o===":"?(u(),s=Ot.Param):p();break;case Ot.EscapeNext:p(),s=n;break;case Ot.Param:o==="("?s=Ot.ParamRegExp:P_.test(o)?p():(u(),s=Ot.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case Ot.ParamRegExp:o===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+o:s=Ot.ParamRegExpEnd:d+=o;break;case Ot.ParamRegExpEnd:u(),s=Ot.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,d="";break;default:t("Unknown state");break}}return s===Ot.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const Cu="[^/]+?",F_={sensitive:!1,strict:!1,start:!0,end:!0};var ss=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(ss||{});const $_=/[.+*?^${}()[\]/\\]/g;function B_(e,t){const s=st({},F_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[ss.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const p=c[u];let f=ss.Segment+(s.sensitive?ss.BonusCaseSensitive:0);if(p.type===la.Static)u||(a+="/"),a+=p.value.replace($_,"\\$&"),f+=ss.Static;else if(p.type===la.Param){const{value:m,repeatable:b,optional:E,regexp:R}=p;i.push({name:m,repeatable:b,optional:E});const S=R||Cu;if(S!==Cu){f+=ss.BonusCustomRegExp;try{`${S}`}catch(x){throw new Error(`Invalid custom RegExp for param "${m}" (${S}): `+x.message)}}let g=b?`((?:${S})(?:/(?:${S}))*)`:`(${S})`;u||(g=E&&c.length<2?`(?:/${g})`:"/"+g),E&&(g+="?"),a+=g,f+=ss.Dynamic,E&&(f+=ss.BonusOptional),b&&(f+=ss.BonusRepeatable),S===".*"&&(f+=ss.BonusWildcard)}d.push(f)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=ss.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const f=d[p]||"",m=i[p-1];u[m.name]=f&&m.repeatable?f.split("/"):f}return u}function o(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const f of p)if(f.type===la.Static)d+=f.value;else if(f.type===la.Param){const{value:m,repeatable:b,optional:E}=f,R=m in c?c[m]:"";if(Hs(R)&&!b)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const S=Hs(R)?R.join("/"):R;if(!S)if(E)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${m}"`);d+=S}}return d||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function U_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===ss.Static+ss.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===ss.Static+ss.Segment?1:-1:0}function vm(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=U_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Eu(n))return 1;if(Eu(a))return-1}return a.length-n.length}function Eu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const H_={strict:!1,end:!0,sensitive:!1};function z_(e,t,s){const n=B_(D_(e.path),s),a=st(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function j_(e,t){const s=[],n=new Map;t=yu(H_,t);function a(u){return n.get(u)}function i(u,p,f){const m=!f,b=Ru(u);b.aliasOf=f&&f.record;const E=yu(t,u),R=[b];if("alias"in u){const x=typeof u.alias=="string"?[u.alias]:u.alias;for(const C of x)R.push(Ru(st({},b,{components:f?f.record.components:b.components,path:C,aliasOf:f?f.record:b})))}let S,g;for(const x of R){const{path:C}=x;if(p&&C[0]!=="/"){const v=p.record.path,w=v[v.length-1]==="/"?"":"/";x.path=p.record.path+(C&&w+C)}if(S=z_(x,p,E),f?f.alias.push(S):(g=g||S,g!==S&&g.alias.push(S),m&&u.name&&!Iu(S)&&l(u.name)),gm(S)&&o(S),b.children){const v=b.children;for(let w=0;w<v.length;w++)i(v[w],S,f&&f.children[w])}f=f||S}return g?()=>{l(g)}:Li}function l(u){if(fm(u)){const p=n.get(u);p&&(n.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function r(){return s}function o(u){const p=G_(u,s);s.splice(p,0,u),u.record.name&&!Iu(u)&&n.set(u.record.name,u)}function c(u,p){let f,m={},b,E;if("name"in u&&u.name){if(f=n.get(u.name),!f)throw ni(yt.MATCHER_NOT_FOUND,{location:u});E=f.record.name,m=st(Au(p.params,f.keys.filter(g=>!g.optional).concat(f.parent?f.parent.keys.filter(g=>g.optional):[]).map(g=>g.name)),u.params&&Au(u.params,f.keys.map(g=>g.name))),b=f.stringify(m)}else if(u.path!=null)b=u.path,f=s.find(g=>g.re.test(b)),f&&(m=f.parse(b),E=f.record.name);else{if(f=p.name?n.get(p.name):s.find(g=>g.re.test(p.path)),!f)throw ni(yt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});E=f.record.name,m=st({},p.params,u.params),b=f.stringify(m)}const R=[];let S=f;for(;S;)R.unshift(S.record),S=S.parent;return{name:E,path:b,params:m,matched:R,meta:q_(R)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:r,getRecordMatcher:a}}function Au(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Ru(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:V_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function V_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function Iu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function q_(e){return e.reduce((t,s)=>st(t,s.meta),{})}function G_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;vm(e,t[i])<0?n=i:s=i+1}const a=K_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function K_(e){let t=e;for(;t=t.parent;)if(gm(t)&&vm(e,t)===0)return t}function gm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Ou(e){const t=Is(Fr),s=Is(Jc),n=Z(()=>{const o=en(e.to);return t.resolve(o)}),a=Z(()=>{const{matched:o}=n.value,{length:c}=o,d=o[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(si.bind(null,d));if(p>-1)return p;const f=Lu(o[c-2]);return c>1&&Lu(d)===f&&u[u.length-1].path!==f?u.findIndex(si.bind(null,o[c-2])):p}),i=Z(()=>a.value>-1&&Q_(s.params,n.value.params)),l=Z(()=>a.value>-1&&a.value===s.matched.length-1&&pm(s.params,n.value.params));function r(o={}){if(Y_(o)){const c=t[en(e.replace)?"replace":"push"](en(e.to)).catch(Li);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:Z(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function W_(e){return e.length===1?e[0]:e}const Z_=al({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Ou,setup(e,{slots:t}){const s=jn(Ou(e)),{options:n}=Is(Fr),a=Z(()=>({[Nu(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[Nu(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&W_(t.default(s));return e.custom?i:Za("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),J_=Z_;function Y_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function Q_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Hs(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function Lu(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Nu=(e,t,s)=>e??t??s,X_=al({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Is(Go),a=Z(()=>e.route||n.value),i=Is(Su,0),l=Z(()=>{let c=en(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),r=Z(()=>a.value.matched[l.value]);Ei(Su,Z(()=>l.value+1)),Ei(E_,r),Ei(Go,a);const o=h();return is(()=>[o.value,r.value,e.name],([c,d,u],[p,f,m])=>{d&&(d.instances[u]=c,f&&f!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=f.leaveGuards),d.updateGuards.size||(d.updateGuards=f.updateGuards))),c&&d&&(!f||!si(d,f)||!p)&&(d.enterCallbacks[u]||[]).forEach(b=>b(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=r.value,p=u&&u.components[d];if(!p)return Mu(s.default,{Component:p,route:c});const f=u.props[d],m=f?f===!0?c.params:typeof f=="function"?f(c):f:null,E=Za(p,st({},m,t,{onVnodeUnmounted:R=>{R.component.isUnmounted&&(u.instances[d]=null)},ref:o}));return Mu(s.default,{Component:E,route:c})||E}}});function Mu(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const ew=X_;function tw(e){const t=j_(e.routes,e),s=e.parseQuery||T_,n=e.stringifyQuery||ku,a=e.history,i=vi(),l=vi(),r=vi(),o=lc(Nn);let c=Nn;Na&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=to.bind(null,H=>""+H),u=to.bind(null,o_),p=to.bind(null,Xi);function f(H,re){let ce,Ce;return fm(H)?(ce=t.getRecordMatcher(H),Ce=re):Ce=H,t.addRoute(Ce,ce)}function m(H){const re=t.getRecordMatcher(H);re&&t.removeRoute(re)}function b(){return t.getRoutes().map(H=>H.record)}function E(H){return!!t.getRecordMatcher(H)}function R(H,re){if(re=st({},re||o.value),typeof H=="string"){const O=so(s,H,re.path),B=t.resolve({path:O.path},re),ae=a.createHref(O.fullPath);return st(O,B,{params:p(B.params),hash:Xi(O.hash),redirectedFrom:void 0,href:ae})}let ce;if(H.path!=null)ce=st({},H,{path:so(s,H.path,re.path).path});else{const O=st({},H.params);for(const B in O)O[B]==null&&delete O[B];ce=st({},H,{params:u(O)}),re.params=u(re.params)}const Ce=t.resolve(ce,re),we=H.hash||"";Ce.params=d(p(Ce.params));const Be=u_(n,st({},H,{hash:i_(we),path:Ce.path})),k=a.createHref(Be);return st({fullPath:Be,hash:we,query:n===ku?C_(H.query):H.query||{}},Ce,{redirectedFrom:void 0,href:k})}function S(H){return typeof H=="string"?so(s,H,o.value.path):st({},H)}function g(H,re){if(c!==H)return ni(yt.NAVIGATION_CANCELLED,{from:re,to:H})}function x(H){return w(H)}function C(H){return x(st(S(H),{replace:!0}))}function v(H,re){const ce=H.matched[H.matched.length-1];if(ce&&ce.redirect){const{redirect:Ce}=ce;let we=typeof Ce=="function"?Ce(H,re):Ce;return typeof we=="string"&&(we=we.includes("?")||we.includes("#")?we=S(we):{path:we},we.params={}),st({query:H.query,hash:H.hash,params:we.path!=null?{}:H.params},we)}}function w(H,re){const ce=c=R(H),Ce=o.value,we=H.state,Be=H.force,k=H.replace===!0,O=v(ce,Ce);if(O)return w(st(S(O),{state:typeof O=="object"?st({},we,O.state):we,force:Be,replace:k}),re||ce);const B=ce;B.redirectedFrom=re;let ae;return!Be&&p_(n,Ce,ce)&&(ae=ni(yt.NAVIGATION_DUPLICATED,{to:B,from:Ce}),ie(Ce,Ce,!0,!1)),(ae?Promise.resolve(ae):I(B,Ce)).catch(Q=>on(Q)?on(Q,yt.NAVIGATION_GUARD_REDIRECT)?Q:W(Q):P(Q,B,Ce)).then(Q=>{if(Q){if(on(Q,yt.NAVIGATION_GUARD_REDIRECT))return w(st({replace:k},S(Q.to),{state:typeof Q.to=="object"?st({},we,Q.to.state):we,force:Be}),re||B)}else Q=F(B,Ce,!0,k,we);return $(B,Ce,Q),Q})}function T(H,re){const ce=g(H,re);return ce?Promise.reject(ce):Promise.resolve()}function y(H){const re=X.values().next().value;return re&&typeof re.runWithContext=="function"?re.runWithContext(H):H()}function I(H,re){let ce;const[Ce,we,Be]=A_(H,re);ce=ao(Ce.reverse(),"beforeRouteLeave",H,re);for(const O of Ce)O.leaveGuards.forEach(B=>{ce.push(Bn(B,H,re))});const k=T.bind(null,H,re);return ce.push(k),Y(ce).then(()=>{ce=[];for(const O of i.list())ce.push(Bn(O,H,re));return ce.push(k),Y(ce)}).then(()=>{ce=ao(we,"beforeRouteUpdate",H,re);for(const O of we)O.updateGuards.forEach(B=>{ce.push(Bn(B,H,re))});return ce.push(k),Y(ce)}).then(()=>{ce=[];for(const O of Be)if(O.beforeEnter)if(Hs(O.beforeEnter))for(const B of O.beforeEnter)ce.push(Bn(B,H,re));else ce.push(Bn(O.beforeEnter,H,re));return ce.push(k),Y(ce)}).then(()=>(H.matched.forEach(O=>O.enterCallbacks={}),ce=ao(Be,"beforeRouteEnter",H,re,y),ce.push(k),Y(ce))).then(()=>{ce=[];for(const O of l.list())ce.push(Bn(O,H,re));return ce.push(k),Y(ce)}).catch(O=>on(O,yt.NAVIGATION_CANCELLED)?O:Promise.reject(O))}function $(H,re,ce){r.list().forEach(Ce=>y(()=>Ce(H,re,ce)))}function F(H,re,ce,Ce,we){const Be=g(H,re);if(Be)return Be;const k=re===Nn,O=Na?history.state:{};ce&&(Ce||k?a.replace(H.fullPath,st({scroll:k&&O&&O.scroll},we)):a.push(H.fullPath,we)),o.value=H,ie(H,re,ce,k),W()}let M;function V(){M||(M=a.listen((H,re,ce)=>{if(!ye.listening)return;const Ce=R(H),we=v(Ce,ye.currentRoute.value);if(we){w(st(we,{replace:!0,force:!0}),Ce).catch(Li);return}c=Ce;const Be=o.value;Na&&x_(wu(Be.fullPath,ce.delta),Dr()),I(Ce,Be).catch(k=>on(k,yt.NAVIGATION_ABORTED|yt.NAVIGATION_CANCELLED)?k:on(k,yt.NAVIGATION_GUARD_REDIRECT)?(w(st(S(k.to),{force:!0}),Ce).then(O=>{on(O,yt.NAVIGATION_ABORTED|yt.NAVIGATION_DUPLICATED)&&!ce.delta&&ce.type===Vo.pop&&a.go(-1,!1)}).catch(Li),Promise.reject()):(ce.delta&&a.go(-ce.delta,!1),P(k,Ce,Be))).then(k=>{k=k||F(Ce,Be,!1),k&&(ce.delta&&!on(k,yt.NAVIGATION_CANCELLED)?a.go(-ce.delta,!1):ce.type===Vo.pop&&on(k,yt.NAVIGATION_ABORTED|yt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),$(Ce,Be,k)}).catch(Li)}))}let ne=vi(),U=vi(),D;function P(H,re,ce){W(H);const Ce=U.list();return Ce.length?Ce.forEach(we=>we(H,re,ce)):console.error(H),Promise.reject(H)}function L(){return D&&o.value!==Nn?Promise.resolve():new Promise((H,re)=>{ne.add([H,re])})}function W(H){return D||(D=!H,V(),ne.list().forEach(([re,ce])=>H?ce(H):re()),ne.reset()),H}function ie(H,re,ce,Ce){const{scrollBehavior:we}=e;if(!Na||!we)return Promise.resolve();const Be=!ce&&__(wu(H.fullPath,0))||(Ce||!ce)&&history.state&&history.state.scroll||null;return Ct().then(()=>we(H,re,Be)).then(k=>k&&y_(k)).catch(k=>P(k,H,re))}const te=H=>a.go(H);let oe;const X=new Set,ye={currentRoute:o,listening:!0,addRoute:f,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:E,getRoutes:b,resolve:R,options:e,push:x,replace:C,go:te,back:()=>te(-1),forward:()=>te(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:U.add,isReady:L,install(H){H.component("RouterLink",J_),H.component("RouterView",ew),H.config.globalProperties.$router=ye,Object.defineProperty(H.config.globalProperties,"$route",{enumerable:!0,get:()=>en(o)}),Na&&!oe&&o.value===Nn&&(oe=!0,x(a.location).catch(Ce=>{}));const re={};for(const Ce in Nn)Object.defineProperty(re,Ce,{get:()=>o.value[Ce],enumerable:!0});H.provide(Fr,ye),H.provide(Jc,ic(re)),H.provide(Go,o);const ce=H.unmount;X.add(H),H.unmount=function(){X.delete(H),X.size<1&&(c=Nn,M&&M(),M=null,o.value=Nn,oe=!1,D=!1),ce()}}};function Y(H){return H.reduce((re,ce)=>re.then(()=>y(ce)),Promise.resolve())}return ye}function bm(){return Is(Fr)}function sw(e){return Is(Jc)}const $r={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=sw(),s=bm(),n=Z({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=Z(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=Z(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});is(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},nw={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(p){var b,E,R,S,g;const f=p.payload||p,m=f.type||p.type;if(m==="tool_start"){const x=((b=f.metadata)==null?void 0:b.call_id)||null,C={callId:x,id:x||`${f.action}-${Date.now()}`,tool:f.action,actor:f.actor||"",channel:f.channel_id||"",iteration:((E=f.metadata)==null?void 0:E.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(C);return}if(m==="tool_end"){const x=((R=f.metadata)==null?void 0:R.call_id)||null;let C=-1;if(x&&(C=e.value.findIndex(v=>v.callId===x&&v.status==="running")),C<0&&!x)for(let v=e.value.length-1;v>=0;v--){const w=e.value[v];if(w.tool===f.action&&w.status==="running"){C=v;break}}if(C>=0){const v=e.value[C];v.status=(S=f.metadata)!=null&&S.error?"error":"success",v.elapsed=((g=f.metadata)==null?void 0:g.elapsed_ms)||Date.now()-v.startTime,v.result=f.detail||"",v.fadingOut=!0,setTimeout(()=>{const w=e.value.indexOf(v);w>=0&&e.value.splice(w,1),t.value.unshift(v),t.value.length>n&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const x=f.call_id||f.tool_name||"unknown";if(f.finished){const C={...s.value};delete C[x],s.value=C}else{const v=((s.value[x]||"")+(f.chunk||"")).split(`
...
... (truncated)`:s}function Pu(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function wm(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Sm=Symbol("agent-detail-cancelled"),iw=15e3;function lw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((f,m)=>{o=f,c=m});function u(f,m){r||(r=!0,l!==null&&a(l),l=null,(f?o:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return r||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sm),i==null||i.abort()}}}function Tm({state:e,requestDetail:t,timeoutMs:s=iw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const p=l;l=null,p==null||p.cancel()}function o(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;r();const b={agentId:p,cancel:null,promise:null};l=b,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const E=lw(R=>t(p,{signal:R}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return b.cancel=E.cancel,b.promise=(async()=>{let R=null,S=null;try{R=await E.promise}catch(g){S=g}R!==Sm&&(l!==b||e.detailId!==p||(l=null,!S&&(R===null||typeof R!="object")&&(S=new Error(`${n} response was empty or invalid`)),S?e.detail===null&&(e.detailError=(S==null?void 0:S.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=R,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,o(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?o(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function rw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const ow={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const r=Z(()=>e.value.filter(P=>P.status==="running").length),o=Z(()=>e.value.filter(P=>P.status==="completed").length),c=Z(()=>e.value.filter(P=>["failed","timeout","killed"].includes(P.status)).length),d=Z(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),u=Z(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(P=>["failed","timeout","killed"].includes(P.status)):e.value.filter(P=>P.status===i.value));function p(P){const L=Number(P.max_iterations)||0;return L<=0?0:Math.min(100,Math.round(P.iteration_count/L*100))}function f(P){return(Number(P.max_iterations)||0)>0}function m(P,L){return P?P==="N/A"?"N/A":L==="current_inheritance"?`inherit (currently ${P})`:P:"unknown"}function b(P){return m(P.display_model,P.display_model_source||P.display_source)}function E(P){return m(P.display_reasoning_effort,P.display_reasoning_effort_source||P.display_source)}function R(P){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[P]||""}const S=h(null),g=h(null),x=h(!1),C=h(null),v=h(""),T=Tm({state:{get detail(){return S.value},set detail(P){S.value=P},get detailId(){return g.value},set detailId(P){g.value=P},get detailLoading(){return x.value},set detailLoading(P){x.value=P},get detailError(){return C.value},set detailError(P){C.value=P}},requestDetail:(P,{signal:L})=>K.get(`/api/agents/${encodeURIComponent(P)}`,{signal:L})});async function y(P){v.value="",await T.open(P.id)}function I(){T.close(),v.value=""}async function $(){await T.refresh()}async function F(P,L){try{await navigator.clipboard.writeText(L||""),v.value=P,setTimeout(()=>{v.value===P&&(v.value="")},1500)}catch{Oe.error("Copy failed")}}async function M(P=!1){P=P===!0,P||(t.value=!0);try{const L=await K.get("/api/agents");e.value=Array.isArray(L)?L:[],s.value=null}catch(L){P||(s.value=L.message)}P||(t.value=!1)}async function V(P){const L=e.value.find(ie=>ie.id===P);if(await Jt({title:"Kill agent",message:`Kill agent "${(L==null?void 0:L.label)||P}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=P;try{await K.del(`/api/agents/${encodeURIComponent(P)}`),Oe.success("Agent killed"),await M()}catch(ie){Oe.error(ie.message||"Failed to kill agent")}n.value=null}}const ne=rw({isEnabled:()=>a.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!g.value,refreshDetail:$});function U(){ne.start()}function D(){ne.stop()}return is(a,()=>ne.sync()),Ke(()=>{l=!0,M(),U()}),_s(()=>{l=!0,M(!0),U()}),ws(()=>{l=!1,D()}),_t(()=>{l=!1,D(),T.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:xa,formatDuration:ai,progressPercent:p,hasProgress:f,displayModelText:b,displayEffortText:E,displaySourceLabel:R,detail:S,detailId:g,detailLoading:x,detailError:C,copied:v,openDetail:y,closeDetail:I,copyText:F,fetchAgents:M,killAgent:V,startAutoRefresh:U,stopAutoRefresh:D}}},cw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h(null),d=h(null),u=h(!1),p=h(null),f=h("");let m=!1;const E=Tm({state:{get detail(){return c.value},set detail(D){c.value=D},get detailId(){return d.value},set detailId(D){d.value=D},get detailLoading(){return u.value},set detailLoading(D){u.value=D},get detailError(){return p.value},set detailError(D){p.value=D}},detailLabel:"Loop detail",requestDetail:(D,{signal:P})=>K.get(`/api/loops/${encodeURIComponent(D)}?limit=100`,{signal:P})});async function R(D){f.value="",await E.open(D.id)}function S(){E.close(),f.value=""}async function g(D,P){try{await navigator.clipboard.writeText(P||""),f.value=D,setTimeout(()=>{f.value===D&&(f.value="")},1500)}catch{Oe.error("Copy failed")}}const x=Z(()=>e.value.reduce((D,P)=>D+(P.iteration_count||0),0)),C=Z(()=>e.value.filter(D=>D.status==="running").length);function v(D){return D==="running"?"loop-status-running":D==="error"?"loop-status-error":"loop-status-stopped"}function w(D){return D==="running"?"badge-success":D==="error"?"badge-danger":D==="completed"?"badge-info":"badge-warning"}function T(D){return D==="act"?"badge-warning":D==="silent"?"badge-info":"badge-success"}async function y(D=!1){D=D===!0,D||(t.value=!0);try{const P=await K.get("/api/loops");e.value=Array.isArray(P)?P:[],s.value=null}catch(P){D||(s.value=P.message)}D||(t.value=!1)}async function I(){l.value=null;const D=a.value;if(!D.goal.trim()){l.value="Goal is required";return}if(!D.channel_id.trim()){l.value="Channel ID is required";return}const P={goal:D.goal.trim(),channel_id:D.channel_id.trim(),interval_seconds:D.interval_seconds||60,mode:D.mode,max_iterations:D.max_iterations||50};D.stop_condition.trim()&&(P.stop_condition=D.stop_condition.trim()),i.value=!0;try{const L=await K.post("/api/loops",P);Oe.success(`Loop started: ${L.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await y()}catch(L){l.value=L.message}i.value=!1}async function $(D){if(await Jt({title:"Stop loop",message:`Stop loop ${D}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=D;try{await K.del(`/api/loops/${encodeURIComponent(D)}`),Oe.success("Loop stopped"),await y()}catch(L){Oe.error(L.message||"Failed to stop loop")}r.value=null}}async function F(D){o.value=D;try{await K.post(`/api/loops/${encodeURIComponent(D)}/restart`),Oe.success("Loop restarted"),await y()}catch(P){Oe.error(P.message||"Failed to restart loop")}o.value=null}function M(D){m&&D.payload&&(D.payload.loop_id||D.payload.type==="loop")&&(y(!0),d.value&&E.refresh())}let V=null;function ne(){V!==null&&clearInterval(V),V=null}function U(){ne(),m&&(V=setInterval(()=>{y(!0),d.value&&E.refresh()},5e3))}return Ke(()=>{m=!0,y(),Ye.subscribe("events",M),U()}),_s(()=>{m=!0,y(!0),U()}),ws(()=>{m=!1,ne()}),_t(()=>{m=!1,Ye.unsubscribe("events",M),ne(),E.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:p,copied:f,totalIterations:x,runningCount:C,statusDotClass:v,statusBadge:w,modeBadge:T,formatAge:xm,formatDuration:ai,formatTs:xa,formatTokens:km,openDetail:R,closeDetail:S,copyText:g,fetchLoops:y,doCreate:I,doStop:$,doRestart:F}}},dw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),r=h(null),o=Z(()=>hw(a.value.run_at));is(()=>a.value.run_at,()=>{r.value=null});const c=Z(()=>{var H;const Y=o.value;return Y.state==="ok"?Y.instant:Y.state==="ambiguous"&&r.value!==null&&((H=Y.options[r.value])==null?void 0:H.instant)||null}),d=Z(()=>{const Y=c.value;return Y?`${Y.toLocaleString()} local — ${Y.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=h(null),b=h(null),E=h(null),R=h(null),S=h(null),g=h(null),x=h([]),C=h(!1),v=h("");let w=0;const T=Z(()=>e.value.filter(Y=>Y.cron&&!Y.one_time).length),y=Z(()=>e.value.filter(Y=>Y.one_time).length),I=Z(()=>e.value.filter(Y=>Y.trigger).length),$=Z(()=>e.value.filter(Y=>Y.paused).length),F=Z(()=>e.value.filter(Y=>Y.consecutive_failures>0).length);function M(Y){if(!Y)return"-";const H=Date.now(),ce=(new Date(Y).getTime()-H)/1e3;if(ce<0)return"overdue";if(ce<60)return"in < 1 min";if(ce<3600)return`in ${Math.floor(ce/60)} min`;if(ce<86400){const we=Math.floor(ce/3600),Be=Math.floor(ce%3600/60);return Be>0?`in ${we}h ${Be}m`:`in ${we}h`}const Ce=Math.floor(ce/86400);return`in ${Ce} day${Ce!==1?"s":""}`}function V(Y){return Y==null?"-":Y<1e3?`${Y}ms`:Y<6e4?`${(Y/1e3).toFixed(1)}s`:ai(Y/1e3)}function ne(Y=a.value.cron){a.value.cron=Y,Du(a.value,"cron"),u.value=null}function U(Y=a.value.run_at){a.value.run_at=Y,Du(a.value,"run_at"),u.value=null}async function D(){const Y=a.value.cron.trim();if(Y){p.value=!0;try{u.value=await K.post("/api/schedules/validate-cron",{expression:Y})}catch(H){u.value={valid:!1,error:H.message}}p.value=!1}}async function P(){t.value=!0,s.value=null;try{e.value=await K.get("/api/schedules")}catch(Y){s.value=Y.message}t.value=!1}async function L(Y){if(g.value===Y){g.value=null,x.value=[];return}g.value=Y,C.value=!0,x.value=[];const H=++w;try{const re=await K.get(`/api/schedules/${encodeURIComponent(Y)}/history?limit=10`);if(H!==w||g.value!==Y)return;x.value=re,v.value=""}catch(re){if(H!==w||g.value!==Y)return;x.value=[],v.value=re.message||"Failed to load execution history"}H===w&&(C.value=!1)}async function W(){l.value=null;const Y=a.value;if(!Y.description.trim()){l.value="Description is required";return}if(!Y.channel_id.trim()){l.value="Channel ID is required";return}if(!Y.cron.trim()&&!Y.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(Y.cron.trim()&&Y.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const H={description:Y.description.trim(),action:Y.action,channel_id:Y.channel_id.trim()};if(Y.cron.trim()&&(H.cron=Y.cron.trim()),Y.run_at.trim()){const re=o.value;if(re.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(re.state==="invalid"){l.value="One-time run time is not a valid date";return}const ce=c.value;if(re.state==="ambiguous"&&r.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!ce){l.value="One-time run time could not be resolved";return}H.run_at=ce.toISOString()}if(Y.action==="reminder"&&Y.message.trim()&&(H.message=Y.message.trim()),Y.action==="check"&&(Y.tool_name.trim()&&(H.tool_name=Y.tool_name.trim()),Y.report_format&&(H.report_format=Y.report_format),Y.tool_input_str.trim()))try{H.tool_input=JSON.parse(Y.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await K.post("/api/schedules",H),Oe.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await P()}catch(re){l.value=re.message}i.value=!1}async function ie(Y){m.value=Y;try{const H=await K.post(`/api/schedules/${encodeURIComponent(Y)}/run`);if(H.status==="failure")Oe.error(`Execution failed: ${H.error||"unknown error"}`);else{const re=H.warning?`Executed (${H.warning})`:"Executed successfully";Oe.success(re)}await P()}catch(H){Oe.error(H.message||"Failed to trigger")}m.value=null}async function te(Y){E.value=Y.id;const H=!Y.paused;try{await K.put(`/api/schedules/${encodeURIComponent(Y.id)}`,{paused:H}),Oe.success(H?"Schedule paused":"Schedule resumed"),await P()}catch(re){Oe.error(re.message||"Failed to update schedule")}E.value=null}async function oe(Y,H){S.value=Y.id;try{await K.put(`/api/schedules/${encodeURIComponent(Y.id)}`,{report_format:H}),Oe.success(H?"Structured report enabled":"Plain-text report enabled")}catch(re){Oe.error(`Update failed: ${re.message}`)}finally{await P(),S.value=null}}async function X(Y){R.value=Y;try{await K.post(`/api/schedules/${encodeURIComponent(Y)}/reset-failures`),Oe.success("Failure counters reset"),await P()}catch(H){Oe.error(H.message||"Failed to reset")}R.value=null}async function ye(Y){const H=e.value.find(ce=>ce.id===Y);if(await Jt({title:"Delete schedule",message:`Delete "${(H==null?void 0:H.description)||Y}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){b.value=Y;try{await K.del(`/api/schedules/${encodeURIComponent(Y)}`),Oe.success("Schedule deleted"),await P()}catch(ce){Oe.error(ce.message||"Failed to delete schedule")}b.value=null}}return Ke(()=>{P()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:o,runAtOccurrence:r,cronResult:u,validatingCron:p,cronPresets:f,runningId:m,deletingId:b,togglingId:E,resettingId:R,reportUpdatingId:S,expandedId:g,history:x,historyLoading:C,historyError:v,cronCount:T,oneTimeCount:y,webhookCount:I,pausedCount:$,failingCount:F,formatTs:xa,formatAge:xm,formatFuture:M,formatMs:V,formatDuration:ai,onCronInput:ne,onRunAtInput:U,validateCron:D,toggleExpand:L,fetchSchedules:P,doCreate:W,doRunNow:ie,doTogglePause:te,doUpdateReportFormat:oe,doResetFailures:X,doDelete:ye}}},Cm=[{id:"live",label:"Live",component:nw},{id:"agents",label:"Agents",component:ow},{id:"loops",label:"Loops",component:cw},{id:"processes",label:"Processes",component:dw},{id:"schedules",label:"Schedules",component:mw}],vw={components:{TabbedPage:$r},setup(){return{tabs:Cm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},gw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const r=h(null),o=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),m=h(!1),b=Fu,E=bw,R=h([]),S=h(!1),g=h(""),x=h("flat"),C=h(new Set),v=h(""),w=h(""),T=h(""),y=h(null),I=h(!1);function $(){try{const ee=localStorage.getItem("odin-session-presets");ee&&(R.value=JSON.parse(ee))}catch{}}function F(){try{localStorage.setItem("odin-session-presets",JSON.stringify(R.value))}catch{}}const M=Z(()=>p.value.trim()!==""||u.value!=="all"),V=Z(()=>{let ee=[...e.value];const _e=Fu.find(qe=>qe.id===u.value),Ee=_e?_e.filters:{};if(Ee.source&&(ee=ee.filter(qe=>qe.source===Ee.source)),Ee.minMessages&&(ee=ee.filter(qe=>qe.message_count>=Ee.minMessages)),Ee.hasCompaction&&(ee=ee.filter(qe=>qe.has_summary)),Ee.maxAge!=null){const qe=Date.now()/1e3;ee=ee.filter(ot=>ot.last_active&&qe-ot.last_active<=Ee.maxAge)}if(p.value.trim()){const qe=p.value.toLowerCase().trim();ee=ee.filter(ot=>(ot.channel_id||"").toLowerCase().includes(qe)||(ot.last_user_id||"").toLowerCase().includes(qe)||(ot.source||"").toLowerCase().includes(qe))}const Ue=f.value,mt=m.value?1:-1;return ee.sort((qe,ot)=>{const zs=qe[Ue]||0,Ss=ot[Ue]||0;return(zs-Ss)*mt}),ee}),ne=Z(()=>{if(!a.value||!a.value.messages)return[];const ee=a.value.messages;if(ee.length===0)return[];const _e=[];let Ee=[];for(const Ue of ee)Ue.role==="user"&&Ee.length>0&&(_e.push(Ee),Ee=[]),Ee.push(Ue);return Ee.length>0&&_e.push(Ee),_e}),U=Z(()=>V.value.length>0&&c.value.size===V.value.length);function D(ee){const _e=ee.find(Ee=>Ee.role==="user");if(_e&&_e.content){const Ee=_e.content.slice(0,120);return Ee.length<_e.content.length?Ee+"...":Ee}return"(no user message)"}function P(ee){const _e=new Set(C.value);_e.has(ee)?_e.delete(ee):_e.add(ee),C.value=_e}function L(ee){u.value=ee}function W(ee){u.value=ee.id,ee.filters.searchQuery!=null&&(p.value=ee.filters.searchQuery),ee.filters.sortBy&&(f.value=ee.filters.sortBy)}function ie(){if(!g.value.trim())return;const ee={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};R.value=[...R.value,ee],F(),S.value=!1,g.value=""}function te(ee){R.value=R.value.filter(_e=>_e.id!==ee),F(),u.value===ee&&(u.value="all")}function oe(){u.value="all",p.value="",f.value="last_active",m.value=!1}function X(ee){if(!ee)return"—";const _e=Date.now()/1e3-ee;if(_e<60)return"just now";if(_e<3600){const Ue=Math.floor(_e/60);return`${Ue} minute${Ue!==1?"s":""} ago`}if(_e<86400){const Ue=Math.floor(_e/3600);return`${Ue} hour${Ue!==1?"s":""} ago`}const Ee=Math.floor(_e/86400);return`${Ee} day${Ee!==1?"s":""} ago`}function ye(ee){if(!ee)return"";try{return new Date(ee*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Y(ee){if(!ee)return"";try{return new Date(ee*1e3).toLocaleString()}catch{return""}}function H(ee){return ee==="user"?"bg-gray-900/50 border border-gray-800":ee==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function re(ee){return ee==="user"?"sess-msg-user":ee==="assistant"?"sess-msg-assistant":"sess-msg-system"}function ce(ee){return ee==="user"?"badge-info":ee==="assistant"?"badge-success":"badge-warning"}function Ce(ee){return ee==="user"?"sess-dot-user":ee==="assistant"?"sess-dot-assistant":"sess-dot-system"}function we(ee){return ee==="user"?"text-cyan-400":ee==="assistant"?"text-indigo-400":"text-gray-500"}function Be(ee){return ee?ee.length>2e3?ee.slice(0,2e3)+`
... (truncated)`:ee:""}async function k(){const ee=v.value.trim();if(ee){I.value=!0;try{let _e=`/api/sessions/search?q=${encodeURIComponent(ee)}&limit=50`;w.value.trim()&&(_e+=`&channel_id=${encodeURIComponent(w.value.trim())}`),T.value.trim()&&(_e+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Ee=await K.get(_e);y.value=Ee.results||[]}catch{y.value=[]}I.value=!1}}function O(){v.value="",w.value="",T.value="",y.value=null}function B(ee){return ee?ee.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function ae(ee){return ee==="user"?"fts-result-user":ee==="assistant"?"fts-result-assistant":ee==="summary"?"fts-result-summary":ee==="fts"?"fts-result-fts":ee==="channel"?"fts-result-channel":"fts-result-default"}function Q(ee){return ee==="user"?"badge-info":ee==="assistant"?"badge-success":ee==="summary"?"badge-warning":ee==="fts"?"badge-success":"badge-info"}let se=0;async function fe(){const ee=++se;t.value=!0,s.value=null;try{const _e=await K.get("/api/sessions");if(ee!==se)return;e.value=_e}catch(_e){if(ee!==se)return;s.value=_e.message}ee===se&&(t.value=!1)}function ue(){s.value=null,fe()}async function pe(ee){if(n.value===ee){n.value=null,a.value=null,C.value=new Set;return}n.value=ee,a.value=null,i.value=!0,C.value=new Set;const _e=++l;try{const Ee=await K.get(`/api/sessions/${encodeURIComponent(ee)}`);_e===l&&n.value===ee&&(a.value=Ee)}catch(Ee){_e===l&&n.value===ee&&(a.value={messages:[],summary:"",error:Ee.message||"Failed to load session"})}finally{_e===l&&(i.value=!1)}}function le(ee){const _e=new Set(c.value);_e.has(ee)?_e.delete(ee):_e.add(ee),c.value=_e}function ke(){U.value?c.value=new Set:c.value=new Set(V.value.map(ee=>ee.channel_id))}function be(ee){r.value=ee}async function xe(){if(r.value){o.value=!0;try{await K.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await fe()}catch(ee){s.value=ee.message||"Failed to clear session"}o.value=!1,r.value=null}}function de(){d.value=!0}async function z(){if(c.value.size!==0){o.value=!0;try{await K.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await fe()}catch(ee){s.value=ee.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}async function me(ee,_e){const Ee=`/api/sessions/${encodeURIComponent(ee)}/export?format=${_e}`;try{const Ue=await K.getBlob(Ee),mt=URL.createObjectURL(Ue),qe=document.createElement("a");qe.href=mt,qe.download=`session-${ee}.${_e==="text"?"txt":"json"}`,qe.click(),URL.revokeObjectURL(mt)}catch(Ue){s.value=Ue.message||"Failed to export session"}}let Te=null;function Le(ee){ee.payload&&ee.payload.channel_id&&(clearTimeout(Te),Te=setTimeout(()=>{if(fe(),n.value&&ee.payload.channel_id===n.value){const _e=n.value,Ee=l;K.get(`/api/sessions/${encodeURIComponent(_e)}`).then(Ue=>{Ee!==l||n.value!==_e||(a.value=Ue)}).catch(()=>{})}},2e3))}let Me=!1,rt=null;function at(){Me||(Me=!0,fe(),Ye.subscribe("events",Le),rt=Ye.onReconnected(()=>fe()))}Ke(()=>{$(),at()}),_s(()=>{at()});function Mt(){Me&&(Me=!1,Ye.unsubscribe("events",Le),rt&&(rt(),rt=null),clearTimeout(Te))}return ws(Mt),_t(Mt),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:U,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:m,filterPresets:b,sortOptions:E,filteredSessions:V,hasActiveFilters:M,customPresets:R,showSavePreset:S,newPresetName:g,threadView:x,threads:ne,collapsedThreads:C,ftsQuery:v,ftsChannelId:w,ftsUserId:T,ftsResults:y,ftsSearching:I,formatAge:X,formatTimestamp:ye,formatFullTimestamp:Y,messageClass:H,threadMsgClass:re,roleBadge:ce,roleDotClass:Ce,roleLabelClass:we,truncateContent:Be,threadSummary:D,fetchSessions:fe,retry:ue,toggleSession:pe,toggleSelect:le,toggleSelectAll:ke,confirmClear:be,clearSession:xe,confirmBulkClear:de,doBulkClear:z,exportSession:me,applyPreset:L,applyCustomPreset:W,saveCustomPreset:ie,removeCustomPreset:te,resetFilters:oe,toggleThread:P,runFtsSearch:k,clearFtsSearch:O,highlightSnippet:B,ftsResultClass:ae,ftsTypeBadge:Q}}},xw={props:["trace"],template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),a=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),i=h("user");let l=null;const r=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],o=Z(()=>[...n.value.recent||[]].reverse()),c=async()=>{try{const m=await K.get("/api/usage");n.value=m,a.value=m.totals||a.value,t.value=null,s.value=!0}catch(m){t.value=m.message}finally{e.value=!1}},d=()=>{e.value=!0,c()};let u=!1;function p(){u||(u=!0,c(),l||(l=setInterval(c,15e3)))}function f(){u&&(u=!1,l&&(clearInterval(l),l=null))}return Ke(p),_s(p),ws(f),_t(f),{hasData:s,loading:e,error:t,data:n,totals:a,activeTab:i,tabs:r,recentReversed:o,fmtNum:wm,formatTime:ym,retry:d}}},Em=[{id:"audit",label:"Audit",component:gw},{id:"sessions",label:"Sessions",component:yw},{id:"traces",label:"Traces",component:_w},{id:"usage",label:"Usage",component:ww}],kw={components:{TabbedPage:$r},setup(){return{tabs:Em}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},io=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),r=h(null),o=h(null),c=h(!1),d=h(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(y){return y.source!=="builtin"?"":u[y.state]||""}function f(y,I){const $=y&&Array.isArray(y.tools)?y.tools:null;if(c.value=!!$,o.value=$?!!y.global_enabled:null,!$){e.value=I.map(V=>({...V,source:"unknown",enabled:void 0,state:null}));return}const F=new Set($.map(V=>V.name)),M=I.filter(V=>!F.has(V.name)).map(V=>({...V,source:V.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...$.map(V=>({...V,source:"builtin"})),...M]}async function m(y,I){if(d.value.has(y.name))return;const $=!!I.target.checked,F=new Set(d.value);F.add(y.name),d.value=F;try{const M=await K.post(`/api/tools/builtins/${encodeURIComponent(y.name)}/enabled`,{enabled:$});f(M,e.value),s.value=null;try{const V=await K.get("/api/tools");f(M,V)}catch(V){console.warn("Built-in toggle committed; visible catalog refresh failed",V)}}catch(M){I.target.checked=!!y.enabled,s.value=M.message||`Failed to toggle ${y.name}`}finally{const M=new Set(d.value);M.delete(y.name),d.value=M}}const b=Z(()=>e.value.filter(y=>y.source==="builtin"&&y.is_core).length),E=Z(()=>e.value.filter(y=>y.source==="skill").length),R=Z(()=>Object.values(a.value).reduce((y,I)=>y+I,0));function S(y){for(const I of io)if(I.id!=="other"&&I.match(y))return I.id;return"other"}const g=Z(()=>{let y=e.value;if(n.value){const I=n.value.toLowerCase();y=y.filter($=>$.name.toLowerCase().includes(I)||($.description||"").toLowerCase().includes(I))}return r.value&&(y=y.filter(I=>S(I.name)===r.value)),y}),x=Z(()=>{const y=new Set;for(const I of e.value)y.add(S(I.name));return io.filter(I=>y.has(I.id))}),C=Z(()=>{const y=g.value,I={};for(const F of y){const M=S(F.name);I[M]||(I[M]=[]),I[M].push(F)}const $=[];for(const F of io)I[F.id]&&I[F.id].length>0&&$.push({label:F.label,icon:F.icon,tools:I[F.id].sort((M,V)=>M.name.localeCompare(V.name))});return $});function v(y){i.value={...i.value,[y]:!i.value[y]}}async function w(){t.value=!0,s.value=null;try{const[y,I,$]=await Promise.all([K.get("/api/tools"),K.get("/api/tools/stats").catch(()=>({})),K.get("/api/tools/builtins").catch(()=>null)]);f($,y),a.value=I||{}}catch(y){s.value=y.message}t.value=!1}function T(){w()}return Ke(()=>{w()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,globalEnabled:o,inventoryAvailable:c,togglePending:d,coreCount:b,skillCount:E,totalUsage:R,filteredTools:g,groupedTools:C,usedCategories:x,stateBadge:p,applyInventory:f,toggleBuiltinTool:m,truncate:Qc,toggleExpand:v,refresh:T}}};function Tw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Cw(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function $(X){return Cw(X)}function F(X){n.value={...n.value,[X]:!n.value[X]}}async function M(X){try{await navigator.clipboard.writeText(X);const ye=e.value.find(Y=>Y.code===X);ye&&(r.value=ye.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function V(X){if(X.key==="Tab"){X.preventDefault();const ye=X.target,Y=ye.selectionStart,H=ye.selectionEnd;u.value=u.value.substring(0,Y)+"    "+u.value.substring(H),Ct(()=>{ye.selectionStart=ye.selectionEnd=Y+4})}}function ne(X){const ye=X.target.previousElementSibling;ye&&(ye.scrollTop=X.target.scrollTop)}async function U(){t.value=!0,s.value=null;try{e.value=await K.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function D(X){i.value=X,delete a.value[X],a.value={...a.value};try{const ye=await K.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:ye}}catch(ye){a.value={...a.value,[X]:{result:ye.message,is_error:!0}}}i.value=null}function P(){o.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function L(X){o.value=!0,c.value="edit",d.value=X.name,u.value=X.code||"",p.value=null,f.value=null}function W(){o.value=!1,p.value=null,f.value=null}async function ie(){p.value=null,f.value=null;const X=d.value.trim(),ye=u.value.trim();if(!X){p.value="Name is required";return}if(!ye){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await K.post("/api/skills",{name:X,code:ye}),f.value="Skill created successfully"):(await K.put(`/api/skills/${encodeURIComponent(X)}`,{code:ye}),f.value="Skill updated successfully"),await U(),setTimeout(()=>{o.value=!1},800)}catch(Y){p.value=Y.message}m.value=!1}function te(X){E.value=X}async function oe(){if(E.value){R.value=!0;try{await K.del(`/api/skills/${encodeURIComponent(E.value)}`),await U()}catch(X){Oe.error(`Failed to delete skill: ${X.message||"unknown error"}`)}R.value=!1,E.value=null}}return Ke(()=>{U()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:b,deleteTarget:E,deleting:R,enabledCount:S,totalExecutions:g,totalLines:x,displayedSkills:C,editLineCount:v,editorLineNums:w,editValidation:T,highlight:y,truncate:Qc,formatTs:xa,countLines:I,getLineNumbers:$,toggleCode:F,copyCode:M,handleEditorKey:V,syncScroll:ne,fetchSkills:U,testSkill:D,showCreate:P,editSkill:L,cancelEdit:W,saveSkill:ie,confirmDelete:te,doDelete:oe}}};class Es extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Aw=/^[A-Za-z_][A-Za-z0-9_]*$/;function $u(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Bu(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const r=String((l==null?void 0:l.key)||"").trim(),o=String((l==null?void 0:l.value)??"");if(!(!r&&!o)){if(!r)throw new Es(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(r))throw new Es(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,r))throw new Es(`${s} key “${r}” appears more than once.`,"authentication");if(i.has(r))throw new Es(`${s} key “${r}” cannot be replaced and removed in the same save.`,"authentication");n[r]=o}}return{set:n,remove:a}}function Rw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Iw(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Es("Server name is required.","name");if(a.length>128||!Aw.test(a))throw new Es("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,r={enabled:!!e.enabled,transport:i};if(n&&(r.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Es("An executable path is required for a new stdio connection.","command");if(d&&(r.command=d),(n||e.replaceArgs)&&(r.args=$u(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Es("Working directory must be an absolute path.","cwd");r.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Es("An HTTP endpoint is required for this connection.","url");if(d&&!Rw(d))throw new Es("Endpoint must be a valid http:// or https:// URL.","url");d&&(r.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Es("Timeout must be a whole number from 1 to 3600 seconds.","timeout");r.timeout_seconds=d}(n||e.replaceAllowlist)&&(r.tool_allowlist=$u(e.allowlistText));const o=Bu(e.headerRows,e.headersRemove,"Header"),c=Bu(e.envRows,e.envRemove,"Environment variable");return Object.keys(o.set).length&&(r.headers_set=o.set),o.remove.length&&(r.headers_remove=o.remove),Object.keys(c.set).length&&(r.env_set=c.set),c.remove.length&&(r.env_remove=c.remove),r}function Ow(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function Lw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Nw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const Mw=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function Pw(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Dw=1e4,Fw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function lo(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function $w(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Bw={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),r=h({}),o=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),m=h(lo()),b=h(""),E=h(!1);let R=null,S=0,g=!1,x=!1;const C=Mw,v=Z(()=>{var z;return((z=e.value)==null?void 0:z.servers)||[]}),w=Z(()=>{var z;return!!((z=e.value)!=null&&z.enabled)}),T=Z(()=>{var z,me,Te,Le;return{serverCount:((z=e.value)==null?void 0:z.server_count)||0,enabledCount:((me=e.value)==null?void 0:me.enabled_server_count)||0,connectedCount:((Te=e.value)==null?void 0:Te.connected_count)||0,toolCount:((Le=e.value)==null?void 0:Le.published_tool_count)||0}}),y=Z(()=>{var z;return((z=f.value)==null?void 0:z.header_keys)||[]}),I=Z(()=>{var z;return((z=f.value)==null?void 0:z.env_keys)||[]}),$=Z(()=>{var z;return u.value==="edit"&&((z=f.value)==null?void 0:z.transport)==="http"}),F=Z(()=>u.value==="add"||!$.value),M=Z(()=>$.value?"Replace endpoint URL":"Endpoint URL"),V=Z(()=>$.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function ne(){U(),R=window.setInterval(()=>D({quiet:!0}),Dw)}function U(){R&&window.clearInterval(R),R=null}async function D({quiet:z=!1}={}){const me=++S;z||(t.value=!0);try{const Te=await K.get("/api/mcp/status");if(me!==S||!g)return;e.value=Te,n.value="";const Le=new Set((Te.servers||[]).map(Me=>Me.name));i.value=new Set([...i.value].filter(Me=>Le.has(Me)))}catch(Te){me===S&&g&&(n.value=Te.message||"Failed to load MCP status")}finally{me===S&&(t.value=!1)}}function P(z){return s.value||a.value.has(z)}function L(z,me){const Te=new Set(a.value);me?Te.add(z):Te.delete(z),a.value=Te}function W(z){return Lw(z.state)}function ie(z){if(W(z)==="disabled"){if(!z.enabled)return"Disabled — server switch off";if(!w.value)return"Disabled — global MCP is off"}return Fw[W(z)]}function te(z){return z.transport==="http"?"Streamable HTTP":"stdio"}function oe(z){return z.negotiated_version?`${z.era?`${String(z.era).charAt(0).toUpperCase()}${String(z.era).slice(1)}`:"Protocol"} · ${z.negotiated_version}`:"Not negotiated"}function X(z){return z.discovered_count?`${z.published_count||0} published · ${z.excluded_count||0} excluded`:"No tools discovered"}const ye=h(new Set);async function Y(z,me){if(ye.value.has(z.name))return;const Te=!!me.target.checked,Le=new Set(ye.value);Le.add(z.name),ye.value=Le;try{const Me=await K.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/enabled`,{enabled:Te});Me&&Array.isArray(Me.servers)?e.value=Me:await D({quiet:!0})}catch(Me){me.target.checked=!!z.enabled,Oe.error(Me.message||`Failed to toggle ${z.name}`)}finally{const Me=new Set(ye.value);Me.delete(z.name),ye.value=Me}}async function H(z){if(z!==w.value&&!(!z&&!await Jt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await K.post("/api/mcp/enabled",{enabled:z}),Oe.success(z?"MCP enabled":"MCP disabled"),await D({quiet:!0})}catch(me){Oe.error(me.message||"Failed to update MCP state"),await D({quiet:!0})}finally{s.value=!1}}}async function re(z){L(z.name,!0);try{await K.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/reconnect`,{}),Oe.success(`Reconnected ${z.name}`)}catch(me){Oe.error(me.message||`Failed to reconnect ${z.name}`)}finally{L(z.name,!1),await D({quiet:!0})}}async function ce(z){L(z.name,!0);try{await K.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/refresh-tools`,{}),Oe.success(`Refreshed tools from ${z.name}`),await Be(z.name,!0)}catch(me){Oe.error(me.message||`Failed to refresh ${z.name}`)}finally{L(z.name,!1),await D({quiet:!0})}}async function Ce(z){if(await Jt({title:`Remove ${z.name}`,message:`Remove this saved MCP server? Its ${z.published_count||0} published tool${z.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){L(z.name,!0);try{await K.del(`/api/mcp/servers/${encodeURIComponent(z.name)}`),Oe.success(`Removed ${z.name}`),delete r.value[z.name]}catch(Te){Oe.error(Te.message||`Failed to remove ${z.name}`)}finally{L(z.name,!1),await D({quiet:!0})}}}async function we(z){const me=new Set(i.value);if(me.has(z.name)){me.delete(z.name),i.value=me;return}me.add(z.name),i.value=me,Object.hasOwn(r.value,z.name)||await Be(z.name)}async function Be(z,me=!1){if(!me&&Object.hasOwn(r.value,z))return;const Te=new Set(c.value);Te.add(z),c.value=Te,o.value={...o.value,[z]:""};try{const Le=await K.get(`/api/mcp/servers/${encodeURIComponent(z)}/tools`);r.value={...r.value,[z]:Le.tools||[]}}catch(Le){o.value={...o.value,[z]:Le.message||"Failed to load tools"}}finally{const Le=new Set(c.value);Le.delete(z),c.value=Le}}function k(z){return(r.value[z]||[]).filter(me=>Nw(me,l.value[z]))}function O(z,me){l.value={...l.value,[z]:me}}function B(){u.value="add",p.value="",f.value=null,m.value=lo(),b.value="",d.value=!0}function ae(z){u.value="edit",p.value=z.name,f.value=z,m.value={...lo(),name:z.name,enabled:!!z.enabled,transport:z.transport||"stdio"},b.value="",d.value=!0}function Q(){E.value||(d.value=!1)}function se(z){d.value&&Pw(z)}function fe(z){const me=z==="headers"?"headerRows":"envRows";m.value[me].push({key:"",value:""})}function ue(z,me){const Te=z==="headers"?"headerRows":"envRows";m.value[Te].splice(me,1)}function pe(z,me){const Te=z==="headers"?"headersRemove":"envRemove",Le=m.value[Te];m.value[Te]=Le.includes(me)?Le.filter(Me=>Me!==me):[...Le,me]}async function le(){var me,Te;b.value="";let z;try{z=Iw(m.value,{mode:u.value,originalTransport:((me=f.value)==null?void 0:me.transport)||""})}catch(Le){b.value=Le instanceof Es?Le.message:"Invalid MCP server configuration",await Ct(),(Te=document.querySelector(".mcp-editor"))==null||Te.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Ow(z,f.value)&&!await Jt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){E.value=!0;try{u.value==="add"?await K.post("/api/mcp/servers",z):await K.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,z),Oe.success(u.value==="add"?`Saved ${z.name}`:`Updated ${p.value}`),d.value=!1,await D({quiet:!0})}catch(Le){b.value=Le.message||"Failed to save MCP server"}finally{E.value=!1}}}let ke=null;function be(z){`${(z==null?void 0:z.event)||""} ${(z==null?void 0:z.type)||""} ${(z==null?void 0:z.tool)||""} ${(z==null?void 0:z.message)||""}`.toLowerCase().includes("mcp")&&(ke&&window.clearTimeout(ke),ke=window.setTimeout(()=>D({quiet:!0}),200))}function xe(){g||(g=!0,x||(Ye.subscribe("events",be),x=!0),D(),ne())}function de(){g=!1,U(),ke&&window.clearTimeout(ke),ke=null,x&&(Ye.unsubscribe("events",be),x=!1)}return Ke(xe),_s(xe),ws(de),_t(de),{status:e,loading:t,mutating:s,pageError:n,servers:v,masterEnabled:w,aggregate:T,expandedServers:i,toolQueries:l,toolErrors:o,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:m,formError:b,saving:E,editorGroups:C,configuredHeaderKeys:y,configuredEnvKeys:I,savedHttpEndpoint:$,endpointRequired:F,endpointFieldLabel:M,endpointPlaceholder:V,refreshAll:D,busy:P,serverState:W,stateLabel:ie,transportLabel:te,protocolLabel:oe,toolSummary:X,formatAge:$w,setMasterEnabled:H,togglePending:ye,toggleServerEnabled:Y,reconnect:re,refreshTools:ce,removeServer:Ce,toggleTools:we,filteredTools:k,setToolQuery:O,openAdd:B,openEdit:ae,closeEditor:Q,jumpToEditorGroup:se,addSecretRow:fe,removeSecretRow:ue,toggleSecretRemoval:pe,saveServer:le}}};function Uw(e,t){if(!e||!t)return Pu(e);const s=Pu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),b=h(null);let E=null;const R=h(null),S=h(!1),g=h({}),x=h({}),C=h({}),v=h({}),w=new Map,T=h(null),y=Z(()=>e.value.reduce((W,ie)=>W+(ie.chunks||0),0)),I=Z(()=>new Set(e.value.map(ie=>ie.uploader).filter(Boolean)).size);function $(W,ie){const te=x.value[ie];if(!te||te.length===0)return 0;const oe=Math.max(...te.map(X=>X.char_count||0));return oe===0?0:Math.round(W.char_count/oe*100)}async function F(){t.value=!0,s.value=null;try{const W=await K.get("/api/knowledge");e.value=Array.isArray(W)?W:[]}catch(W){s.value=W.message}t.value=!1}async function M(W){if(g.value[W]){g.value[W]=!1,T.value=null;return}if(g.value[W]=!0,Object.prototype.hasOwnProperty.call(x.value,W))return;if(w.has(W))return w.get(W);const ie={...v.value,[W]:!0};v.value=ie;const te={...C.value};delete te[W],C.value=te;const oe=K.get(`/api/knowledge/${encodeURIComponent(W)}/chunks`).then(X=>{x.value={...x.value,[W]:Array.isArray(X)?X:[]}}).catch(X=>{C.value={...C.value,[W]:X.message||"load failed"}}).finally(()=>{if(w.get(W)!==oe)return;w.delete(W);const X={...v.value};delete X[W],v.value=X});return w.set(W,oe),oe}async function V(){const W=n.value.trim();if(W){i.value=!0,r.value=null,l.value=W;try{const ie=await K.get(`/api/knowledge/search?q=${encodeURIComponent(W)}`);a.value=Array.isArray(ie)?ie:[]}catch(ie){a.value=[],r.value=ie.message||"Search failed"}i.value=!1}}function ne(){a.value=null,n.value="",r.value=null}async function U(){u.value=null,p.value=null;const W=c.value.trim(),ie=d.value.trim();if(!W){u.value="Source name is required";return}if(!ie){u.value="Content is required";return}f.value=!0;try{const te=await K.post("/api/knowledge",{source:W,content:ie});p.value=`Ingested ${te.chunks||0} chunks from "${W}"`,c.value="",d.value="",x.value={},await F(),setTimeout(()=>{o.value=!1,p.value=null},1500)}catch(te){u.value=te.message}f.value=!1}async function D(W){m.value=W,b.value=null,E&&(clearTimeout(E),E=null);try{const ie=await K.post(`/api/knowledge/${encodeURIComponent(W)}/reingest`);b.value={source:W,error:!1,message:`Re-ingested ${ie.chunks||0} chunks`},delete x.value[W],await F(),E=setTimeout(()=>{b.value=null,E=null},3e3)}catch(ie){b.value={source:W,error:!0,message:ie.message}}m.value=null}function P(W){R.value=W}async function L(){if(R.value){S.value=!0;try{await K.del(`/api/knowledge/${encodeURIComponent(R.value)}`),delete x.value[R.value],await F()}catch(W){Oe.error(`Failed to delete source: ${W.message||"unknown error"}`)}S.value=!1,R.value=null}}return Ke(()=>{F()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:b,deleteTarget:R,deleting:S,expanded:g,sourceChunks:x,chunkErrors:C,loadingChunks:v,selectedChunk:T,totalChunks:y,uploaderCount:I,truncate:Qc,formatTs:xa,highlightTerms:Uw,chunkBarWidth:$,fetchSources:F,toggleSource:M,doSearch:V,clearSearch:ne,doIngest:U,doReingest:D,confirmDelete:P,doDelete:L}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),m=h(!1),b=h(null),E=h(null),R=h(new Set),S=h(null),g=h(!1),x=h(!1),C=Z(()=>e.value.reduce((te,oe)=>te+oe.count,0)),v=Z(()=>R.value.size);function w(te){const oe=t.value[te];if(!oe)return[];if(!l.value.trim())return oe;const X=l.value.trim().toLowerCase();return oe.filter(ye=>ye.key.toLowerCase().includes(X)||ye.value&&ye.value.toLowerCase().includes(X))}function T(te,oe){return R.value.has(te+"/"+oe)}function y(te,oe){const X=te+"/"+oe,ye=new Set(R.value);ye.has(X)?ye.delete(X):ye.add(X),R.value=ye}function I(te){const oe=t.value[te];return!oe||oe.length===0?!1:oe.every(X=>R.value.has(te+"/"+X.key))}function $(te,oe){const X=t.value[te];if(!X)return;const ye=new Set(R.value);for(const Y of X){const H=te+"/"+Y.key;oe?ye.add(H):ye.delete(H)}R.value=ye}async function F(){s.value=!0,n.value=null;try{const te=await K.get("/api/memory");e.value=Object.entries(te).map(([oe,X])=>({name:oe,keys:X.keys||[],count:X.count||0}))}catch(te){n.value=te.message}s.value=!1}async function M(te){if(a.value[te]){a.value[te]=!1;return}a.value[te]=!0;const oe=e.value.find(ye=>ye.name===te);if(!oe||t.value[te]||i.value===te)return;i.value=te;let X;try{const Y=(await K.get(`/api/memory/${encodeURIComponent(te)}`)).entries||{};X=oe.keys.map(H=>Object.prototype.hasOwnProperty.call(Y,H)?{key:H,value:Y[H]||"",failed:!1}:{key:H,value:"",failed:!0,error:"Not found in scope"})}catch(ye){X=oe.keys.map(Y=>({key:Y,value:"",failed:!0,error:ye.message||"Failed to load"}))}t.value[te]=X,i.value=null}function V(te,oe,X){p.value=te+"/"+oe,f.value=X}async function ne(te,oe){m.value=!0,b.value=null;try{await K.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`,{value:f.value});const X=t.value[te];if(X){const ye=X.find(Y=>Y.key===oe);ye&&(ye.value=f.value)}p.value=null}catch(X){b.value=`Failed to save: ${X.message||"unknown error"}`}m.value=!1}async function U(te,oe){try{await navigator.clipboard.writeText(oe.value),E.value=te+"/"+oe.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function D(){d.value=null,u.value=null;const te=o.value.scope.trim(),oe=o.value.key.trim(),X=o.value.value.trim();if(!te){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!X){d.value="Value is required";return}c.value=!0;try{await K.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`,{value:X}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await F(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(ye){d.value=ye.message}c.value=!1}function P(te,oe){S.value={scope:te,key:oe}}async function L(){if(!S.value)return;g.value=!0,b.value=null;const{scope:te,key:oe}=S.value;try{await K.del(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`);const X=t.value[te];X&&(t.value[te]=X.filter(H=>H.key!==oe));const ye=e.value.find(H=>H.name===te);ye&&(ye.count--,ye.keys=ye.keys.filter(H=>H!==oe));const Y=new Set(R.value);Y.delete(te+"/"+oe),R.value=Y}catch(X){b.value=`Failed to delete: ${X.message||"unknown error"}`}g.value=!1,S.value=null}function W(){x.value=!0}async function ie(){g.value=!0,b.value=null;const te=[];for(const oe of R.value){const X=oe.indexOf("/");te.push({scope:oe.slice(0,X),key:oe.slice(X+1)})}try{await K.post("/api/memory/bulk-delete",{entries:te}),R.value=new Set,t.value={},await F()}catch(oe){b.value=`Bulk delete failed: ${oe.message||"unknown error"}`}g.value=!1,x.value=!1}return Ke(()=>{F()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:m,actionError:b,copied:E,selected:R,selectedCount:v,totalEntries:C,deleteTarget:S,deleting:g,showBulkDelete:x,fetchMemory:F,toggleScope:M,startEdit:V,doEdit:ne,copyValue:U,doAdd:D,confirmDelete:P,doDelete:L,confirmBulkDelete:W,doBulkDelete:ie,isSelected:T,toggleSelect:y,isScopeAllSelected:I,toggleSelectAll:$,filteredEntries:w}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h(!1),a=h("sessions"),i=h(null);let l=null;const r=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],o=Z(()=>{if(!i.value||!i.value.collected_at)return"";try{return new Date(i.value.collected_at).toLocaleTimeString()}catch{return""}}),c=Z(()=>{if(!i.value)return[];const E=i.value,R=E.storage_total_bytes||1;return[{label:"Session Persistence",mb:E.sessions.persist_dir.total_mb,bytes:E.sessions.persist_dir.total_bytes,files:E.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(E.sessions.persist_dir.total_bytes/R*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:E.knowledge.db_file.total_mb,bytes:E.knowledge.db_file.total_bytes,files:E.knowledge.db_file.file_count,pct:Math.min(100,Math.round(E.knowledge.db_file.total_bytes/R*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:E.trajectories.message_dir.total_mb,bytes:E.trajectories.message_dir.total_bytes,files:E.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(E.trajectories.message_dir.total_bytes/R*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:E.trajectories.agent_dir.total_mb,bytes:E.trajectories.agent_dir.total_bytes,files:E.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(E.trajectories.agent_dir.total_bytes/R*100)),color:"res-bar-amber"}]});async function d(){try{const E=await K.get("/api/resource-usage");i.value=E,t.value=null,s.value=!0}catch(E){t.value=E.message||"Failed to load resource usage"}finally{e.value=!1,n.value=!1}}async function u(){n.value=!0,await d()}function p(){e.value=!0,t.value=null,d()}let f=!1;function m(){f||(f=!0,d(),l||(l=setInterval(d,3e4)))}function b(){f&&(f=!1,l&&(clearInterval(l),l=null))}return Ke(m),_s(m),ws(b),_t(b),{hasData:s,loading:e,error:t,refreshing:n,data:i,activeTab:a,tabs:r,collectedAt:o,storageItems:c,fmtNum:wm,refresh:u,retry:p}}},Jw=["INFO","WARNING","ERROR"],Yw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],ro=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Qw=[50,100,200,500],Xw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(Ye.state||"disconnected"),c=Z(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),d=h(null),u=h(!1),p=h(null),f=2e3,m=Jw,b=Yw,E=ro,R=h("all"),S=h(""),g=h([]),x=h(!1),C=h(""),v=h([]);function w(){try{const G=localStorage.getItem("odin-log-presets");G&&(g.value=JSON.parse(G))}catch{}}function T(){try{localStorage.setItem("odin-log-presets",JSON.stringify(g.value))}catch{}}const y=Z(()=>a.value!==""||i.value.trim()!==""||S.value!==""),I=Z(()=>{const G=ro.find(he=>he.value===S.value);return G?G.label:""}),$=Z(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(G){return G.message}}),F=24,M=Z(()=>{if(W.value.length===0)return[];const G=[],he=new Date,Ne=3600*1e3;for(let We=F-1;We>=0;We--){const ct=new Date(he.getTime()-(We+1)*Ne),It=new Date(he.getTime()-We*Ne);G.push({start:ct,end:It,label:D(ct,It),shortLabel:It.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const We of W.value){if(!We._time)continue;const ct=We._time.getTime();for(const It of G)if(ct>=It.start.getTime()&&ct<It.end.getTime()){It.total++,We.level==="ERROR"?It.errors++:We.level==="WARNING"?It.warnings++:It.info++;break}}return G}),V=Z(()=>{let G=1;for(const he of M.value)he.total>G&&(G=he.total);return G}),ne=Z(()=>{if(M.value.length===0)return"";const G=W.value.map(We=>We._time&&We._time.getTime()).filter(Boolean);if(G.length===0)return"";const he=new Date(Math.min(...G));return`${W.value.length} shown, oldest ${he.toLocaleTimeString()}`}),U=Z(()=>Math.ceil(F/8));function D(G,he){const Ne={hour:"2-digit",minute:"2-digit"};return G.toLocaleTimeString([],Ne)+" - "+he.toLocaleTimeString([],Ne)}function P(G,he){return!he||!G?"0px":Math.max(2,G/he*100)+"%"}function L(G){const he=W.value.findIndex(Ne=>Ne._time&&Ne._time.getTime()>=G.start.getTime()&&Ne._time.getTime()<G.end.getTime());if(he>=0&&d.value){const Ne=d.value.querySelectorAll(".log-line");Ne[he]&&(Ne[he].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const W=Z(()=>{let G=t.value;if(a.value&&(G=G.filter(he=>(he.level||"INFO")===a.value)),S.value){const he=ro.find(Ne=>Ne.value===S.value);if(he&&he.seconds){const Ne=new Date(Date.now()-he.seconds*1e3);G=G.filter(We=>We._time&&We._time>=Ne)}}if(i.value&&!$.value)if(l.value)try{const he=new RegExp(i.value,"i");G=G.filter(Ne=>{const We=Ne.text||Ne.raw||"",ct=Ne.tool||"";return he.test(We)||he.test(ct)})}catch{}else{const he=i.value.toLowerCase();G=G.filter(Ne=>{const We=(Ne.text||Ne.raw||"").toLowerCase(),ct=(Ne.tool||"").toLowerCase();return We.includes(he)||ct.includes(he)})}return G});function ie(G){if(G.type==="log"&&G.line)try{const he=typeof G.line=="string"?JSON.parse(G.line):G.line,Ne=he.timestamp?new Date(he.timestamp):new Date;return{ts:Ne.toLocaleTimeString(),_time:Ne,level:he.error?"ERROR":"INFO",text:he.tool_name?`[${he.tool_name}] ${he.result_summary||""}`.trim():he.message||JSON.stringify(he),tool:he.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(G.line),tool:"",raw:String(G.line)}}if(G.payload){const he=G.payload,Ne=he.timestamp?new Date(he.timestamp):new Date;return{ts:Ne.toLocaleTimeString(),_time:Ne,level:he.error?"ERROR":"INFO",text:he.tool_name?`[${he.tool_name}] ${he.result_summary||""}`.trim():he.message||JSON.stringify(he),tool:he.tool_name||"",raw:null}}return typeof G=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:G,tool:"",raw:G}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(G),tool:"",raw:null}}function te(G){const he=ie(G);if(s.value){v.value.push(he);return}oe(he)}function oe(G){t.value.push(G),t.value.length>f&&(t.value=t.value.slice(-f)),n.value&&Ct(()=>X())}function X(G=!1){const he=d.value;he&&he.scrollTo({top:he.scrollHeight,behavior:G?"smooth":"instant"})}function ye(){n.value=!0,u.value=!1,Ct(()=>X(!0))}const Y=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function H(){const G=d.value;if(!G)return;const he=G.scrollHeight-G.scrollTop-G.clientHeight<40;u.value=!n.value&&!he&&t.value.length>0,we.value&&re()}function re(){const G=d.value;!G||!n.value||G.scrollHeight-G.scrollTop-G.clientHeight>=40&&(n.value=!1,u.value=t.value.length>0)}function ce(){n.value&&requestAnimationFrame(re)}function Ce(G){Y.has(G.key)&&ce()}const we=h(!1);function Be(){n.value&&(we.value=!0,requestAnimationFrame(re))}function k(){we.value&&(we.value=!1,re())}function O(){n.value&&(u.value=!1,Ct(()=>X()))}function B(){if(s.value=!s.value,!s.value&&v.value.length>0){for(const G of v.value)oe(G);v.value=[]}}function ae(){t.value=[],v.value=[],u.value=!1}function Q(){let G;e.value==="search"?G=Ue.value.map(ct=>{const It=ct.error?"ERROR":"INFO",Gn=ct.tool_name?`[${ct.tool_name}] `:"";return`${ct.timestamp||""} ${It} ${Gn}${ct.result_summary||ct.message||""}`}).join(`
`):G=W.value.map(ct=>`${ct.ts} ${ct.level} ${ct.text}`).join(`
`);const he=new Blob([G],{type:"text/plain"}),Ne=URL.createObjectURL(he),We=document.createElement("a");We.href=Ne,We.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,We.click(),URL.revokeObjectURL(Ne)}function se(G,he){const Ne=`${G.ts} ${G.level} ${G.text||G.raw||""}`;navigator.clipboard.writeText(Ne).then(()=>{p.value=he,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function fe(G){a.value=a.value===G?"":G,R.value="all"}function ue(G){return G.level==="ERROR"?"log-line-error":G.level==="WARNING"?"log-line-warning":"text-gray-300"}function pe(G){return G==="ERROR"?"text-red-500 font-semibold":G==="WARNING"?"text-yellow-500":"text-blue-500"}function le(G){return G==="ERROR"?"log-chip-error":G==="WARNING"?"log-chip-warning":"log-chip-info"}function ke(G){R.value=G.id;const he=G.filters;a.value=he.level||"",S.value=he.timeRange||"",i.value=he.text||"",he.levels&&(a.value=he.levels[0]||""),he.hasToolName&&(i.value="")}function be(G){R.value=G.id,a.value=G.filters.level||"",S.value=G.filters.timeRange||"",i.value=G.filters.text||""}function xe(){if(!C.value.trim())return;const G={id:"custom-"+Date.now(),name:C.value.trim(),filters:{level:a.value,timeRange:S.value,text:i.value}};g.value=[...g.value,G],T(),x.value=!1,C.value=""}function de(G){g.value=g.value.filter(he=>he.id!==G),T(),R.value===G&&(R.value="all")}const z=h("all"),me=h(""),Te=h(""),Le=h(""),Me=h(""),rt=h(""),at=h(100),Mt=Qw,ee=h(!1),_e=h(!1),Ee=h(""),Ue=h([]),mt=h(null),qe=h(null);function ot(){e.value="search",mt.value||zs()}async function zs(){try{mt.value=await K.get("/api/logs/stats")}catch{}}function Ss(){const G=rt.value;if(!G){Le.value="",Me.value="";return}const Ne={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[G];if(Ne){const We=new Date(Date.now()-Ne*1e3);Le.value=Ns(We),Me.value=""}}function Ns(G){const he=Ne=>String(Ne).padStart(2,"0");return`${G.getFullYear()}-${he(G.getMonth()+1)}-${he(G.getDate())}T${he(G.getHours())}:${he(G.getMinutes())}`}function Ft(G){if(!G)return"";const he=new Date(G);return isNaN(he.getTime())?"":he.toISOString()}async function jt(){ee.value=!0,Ee.value="",_e.value=!0,qe.value=null;try{const G=new URLSearchParams;z.value&&z.value!=="all"&&G.set("level",z.value),me.value&&G.set("tool",me.value),Te.value&&G.set("q",Te.value);const he=Ft(Le.value),Ne=Ft(Me.value);he&&G.set("start",he),Ne&&G.set("end",Ne),G.set("limit",String(at.value));const We=await K.get(`/api/logs/search?${G.toString()}`);Ue.value=We.entries||[]}catch(G){Ee.value=G.message||"Search failed",Ue.value=[]}finally{ee.value=!1}}function nn(){z.value="all",me.value="",Te.value="",Le.value="",Me.value="",rt.value="",at.value=100,Ue.value=[],_e.value=!1,Ee.value="",qe.value=null}function js(G){qe.value=qe.value===G?null:G}function Vs(G){if(!G.timestamp)return"";try{return new Date(G.timestamp).toLocaleString()}catch{return G.timestamp}}function qs(G){return G.type==="web_action"?`${G.status||""} (${G.execution_time_ms||0}ms)`:(G.result_summary||"").slice(0,200)}function Ms(G){return G.error?"log-line-error":"text-gray-300"}function Rn(G){try{return JSON.stringify(G,null,2)}catch{return String(G)}}let vt=null,Ps=!1;function qn(){Ps||(Ps=!0,Ye.subscribe("logs",te),r.value=Ye.connected,o.value=Ye.state||"disconnected",vt=Ye.onState(G=>{o.value=G,r.value=G==="connected"}))}function Je(){Ps&&(Ps=!1,Ye.unsubscribe("logs",te),vt&&(vt(),vt=null))}return Ke(()=>{w(),window.addEventListener("pointerup",k),window.addEventListener("pointercancel",k)}),_s(qn),ws(Je),_t(()=>{Je(),window.removeEventListener("pointerup",k),window.removeEventListener("pointercancel",k)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:W,pauseBuffer:v,showJumpBottom:u,copiedIndex:p,regexError:$,levels:m,logPresets:b,timeRanges:E,timeRange:S,activeLogPreset:R,customLogPresets:g,showSaveLogPreset:x,newLogPresetName:C,hasActiveLogFilters:y,timeRangeLabel:I,timelineBuckets:M,timelineMax:V,timelineSpanLabel:ne,timelineLabelSkip:U,togglePause:B,clearLogs:ae,exportLogs:Q,logLineClass:ue,levelClass:pe,levelChipClass:le,toggleLevel:fe,copyLine:se,jumpToBottom:ye,onScroll:H,onUserScrollIntent:ce,onUserScrollKey:Ce,onAutoScrollToggle:O,onPointerDown:Be,applyLogPreset:ke,applyCustomLogPreset:be,saveLogCustomPreset:xe,removeLogCustomPreset:de,segmentHeight:P,jumpToTimelineBucket:L,searchLevel:z,searchTool:me,searchKeyword:Te,searchStart:Le,searchEnd:Me,searchTimePreset:rt,searchLimit:at,searchLimits:Mt,searching:ee,searchRan:_e,searchError:Ee,searchResults:Ue,searchStats:mt,expandedSearch:qe,switchToSearch:ot,runSearch:jt,clearSearchFilters:nn,toggleSearchExpand:js,formatSearchTs:Vs,searchEntryText:qs,searchLogLineClass:Ms,formatJson:Rn,applySearchTimePreset:Ss}}};function Sl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const ek=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function tk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const r=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(r)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Ga=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],sk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},oo=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),nk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Uu(e){return nk.some(t=>e===t||e.startsWith(`${t}.`))}const Rm="odin_config_center_expanded_v1",Im="odin_config_center_category_v1",ak=50,ik=650,co=()=>K.get("/api/config/meta");function sa(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ni(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Aa(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function lk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function rk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Om(e,t){if(Ni(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return sa(t);const n={};for(const[a,i]of Object.entries(t)){const l=Om(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function ok(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Om(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Lm(e,t,s,n){if(Ni(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Lm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function ck(){try{const e=JSON.parse(localStorage.getItem(Rm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function dk(){try{const e=localStorage.getItem(Im);return Ga.some(t=>t.key===e)?e:Ga[0].key}catch{return Ga[0].key}}const uk={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),r=h(null),o=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(dk()),m=h(ck()),b=h({}),E=h({}),R=h(""),S=h({}),g=h({}),x=h([]),C=h([]),v=h(!1),w=h(!1),T=h(!1);let y=null,I=null,$={path:null,at:0},F=0;const M=Z(()=>{var _;return(((_=t.value)==null?void 0:_.fields)||[]).filter(N=>!oo.has(N.path.split(".")[0])&&!Uu(N.path))}),V=Z(()=>new Map(M.value.map(_=>[_.path,_]))),ne=Z(()=>W.value.reduce((_,N)=>_+N.sections.length,0)),U=Z(()=>M.value.length),D=Z(()=>ek),P=Z(()=>x.value.length>0),L=Z(()=>C.value.length>0),W=Z(()=>{if(!e.value)return[];const _=new Set(Ga.flatMap(ve=>ve.sections)),N=Ga.map(ve=>({...ve,sections:ve.sections.filter(De=>Object.hasOwn(e.value,De)&&!oo.has(De))})).filter(ve=>ve.sections.length),q=Object.keys(e.value).filter(ve=>!_.has(ve)&&!oo.has(ve));return q.length&&N.push({key:"other",label:"Other",icon:"folder",sections:q}),N}),ie=Z(()=>e.value?{...e.value,...b.value}:null),te=Z(()=>{if(!e.value)return[];const _=[];for(const[N,q]of Object.entries(b.value))Lm(e.value[N],q,N,_);return _.filter(N=>!Ni(N.oldVal,N.newVal)).map(N=>{const q=O(N.path);return{...N,label:(q==null?void 0:q.label)||Aa(N.path.split(".").at(-1)),apply_mode:(q==null?void 0:q.apply_mode)||fe(N.path.split(".")[0])}})}),oe=Z(()=>te.value.length>0),X=Z(()=>te.value.length),ye=Z(()=>new Set(te.value.map(_=>_.path.split(".")[0])).size),Y=Z(()=>!!u.value||p.value!=="all"),H=Z(()=>{const _={...g.value};for(const N of te.value){const q=O(N.path),ve=wa(q,N.newVal);ve&&(_[N.path]=ve)}return _}),re=Z(()=>Object.keys(H.value).length>0),ce=Z(()=>e.value?(Y.value?W.value:W.value.filter(N=>N.key===f.value)).map(N=>({...N,sections:N.sections.filter(q=>ee(q))})).filter(N=>N.sections.length):[]),Ce=Z(()=>{const _=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],N=new Map(_.map(q=>[q,[]]));for(const q of te.value){const ve=N.has(q.apply_mode)?q.apply_mode:"restart";N.get(ve).push(q)}return _.filter(q=>N.get(q).length).map(q=>({key:q,label:ms(q),entries:N.get(q)}))}),we=Z(()=>te.value.filter(_=>_.apply_mode==="restart").length),Be=Z(()=>M.value.filter(_=>_.pending_restart)),k=Z(()=>Be.value.length);function O(_){const N=V.value.get(_);return N?{...N,apply_details:Sl([N])}:null}function B(_){const N=`${_}.`;return M.value.filter(q=>q.path===_||q.path.startsWith(N))}function ae(_){return B(_).length}function Q(_){return Aa(_)}function se(_){const N=B(_);if(!N.length)return`${Aa(_)} configuration.`;const q=N.find(gt=>gt.sensitivity==="public"&&gt.description)||N.find(gt=>gt.description),ve=(q==null?void 0:q.description)||"";return ve.match(/setting for (.+)\.$/i)?`${Aa(_)} settings and runtime behaviour.`:ve}function fe(_){const N=[...new Set(B(_).map(q=>q.apply_mode))];return N.length===1?N[0]:N.includes("restart")?"restart":N.includes("activation_required")?"activation_required":N[0]||"restart"}function ue(_){const N=[...new Set(B(_).map(q=>ms(q.apply_mode)))];return N.length?N.length===1?N[0]:`Mixed apply behaviour: ${N.join(" · ")}`:""}function pe(_){return Sl(B(_))}function le(_){var N;return Object.hasOwn(b.value,_)?b.value[_]:(N=e.value)==null?void 0:N[_]}function ke(){const _=le("mcp")||{},N=Object.keys(_.servers||{}).length;return`${_.enabled?"Globally enabled":"Globally disabled"} · ${N} configured server${N===1?"":"s"}.`}function be(_,N){return N.split(".").reduce((q,ve)=>q==null?void 0:q[ve],_)}function xe(_){const N=ie.value;return B(_).filter(q=>Uu(q.path)?!1:q.path.split(".").length<=2?!0:!q.path.includes(".*")).map(q=>({...q,key:q.path.split(".").at(-1),value:be(N,q.path),apply_details:Sl([q]),editor:q.path==="agents.final_warning_iterations"?"warning-chips":null}))}function de(_){const N=_.path.split(".");return N.length>2?N.slice(0,2).join("."):null}function z(_){const N=new Map;for(const q of xe(_)){const ve=de(q),De=ve||`${_}.__root`;N.has(De)||N.set(De,{key:De,path:ve,entries:[]}),N.get(De).entries.push(q)}return[...N.values()].map(q=>{const ve=q.entries.find(De=>De.group_description);return{...q,label:q.path?Aa(q.path.split(".").at(-1)):null,description:(ve==null?void 0:ve.group_description)||null,apply_details:Sl(q.entries),runtime_summaries:Te(q.entries)}})}function me(_){return{save:_.save_effect||(_.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:_.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[_.apply_mode]||"Effective runtime state is not currently observable."}}function Te(_){const N=new Map;for(const q of _){const ve=me(q),De=`${q.apply_mode}|${ve.save}|${ve.runtime}`;N.has(De)||N.set(De,{key:De,label:ms(q.apply_mode),save:ve.save,runtime:ve.runtime})}return[...N.values()]}function Le(_){if(Me(_))return _.runtime_effect||_.activation_policy||"";if(_.apply_mode==="activation_required"){const N=_.activation_policy||_.runtime_effect;return N?`Not active after saving. No activation control exists in this release. ${N}`:"Not active after saving; no activation control exists in this release."}return""}function Me(_){return _.action_available===!0&&!!(_.action_label&&_.action_endpoint)}async function rt(_){if(Me(_))try{if(qe(_.path))throw new Error("Save this setting before applying its action.");const N=String(_.action_method||"POST").toLowerCase(),q={post:K.post.bind(K),put:K.put.bind(K),delete:K.del.bind(K)}[N];if(!q)throw new Error("Unsupported configuration action");await q(_.action_endpoint,_.action_body||void 0),await J(),Xt("success",`${_.action_label} completed.`)}catch(N){Xt("error",N.message||`${_.action_label} failed`)}}function at(_,N){return[_.label,_.path,_.description,..._.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(N)}function Mt(_){const N=u.value.trim().toLowerCase();return N?B(_).filter(q=>at(q,N)):[]}function ee(_){const N=B(_);if(p.value!=="all"&&!N.some(ve=>ve.apply_state===p.value))return!1;const q=u.value.trim().toLowerCase();return!q||`${Q(_)} ${_}`.toLowerCase().includes(q)?!0:N.some(ve=>at(ve,q))}function _e(_,N){return B(_).filter(q=>q.apply_state===N).length}function Ee(_){return _==="all"?U.value:M.value.filter(N=>N.apply_state===_).length}function Ue(_){const N=_.sections.flatMap(q=>B(q));return{fields:N.length,modified:te.value.filter(q=>_.sections.includes(q.path.split(".")[0])).length,pending_restart:N.filter(q=>q.apply_state==="pending_restart").length,invalid:N.filter(q=>q.apply_state==="invalid").length,dormant:N.filter(q=>q.apply_state==="dormant").length}}function mt(_){var N;return Object.hasOwn(b.value,_)&&!Ni((N=e.value)==null?void 0:N[_],b.value[_])}function qe(_){return te.value.some(N=>N.path===_||N.path.startsWith(`${_}.`))}function ot(_){f.value=_,u.value="",p.value="all";try{localStorage.setItem(Im,_)}catch{}}function zs(_){p.value=_}function Ss(){u.value="",p.value="all"}function Ns(_){var N;return((N=W.value.find(q=>q.sections.includes(_)))==null?void 0:N.sections)||[]}function Ft(_){const N=Ns(_),q=N.find(ve=>m.value[ve]===!0);return q||N.find(ve=>m.value[ve]!==!1)||null}function jt(_){return u.value&&!T.value&&ee(_)?!0:T.value?Ft(_)===_:Object.hasOwn(m.value,_)?m.value[_]===!0:!0}function nn(_){const N=!jt(_);if(T.value){const q={...m.value};for(const ve of Ns(_))q[ve]===!0&&(q[ve]=!1);q[_]=N,m.value=q;return}m.value={...m.value,[_]:N}}function js(){x.value.push(sa(b.value)),x.value.length>ak&&x.value.shift(),C.value=[]}function Vs(){oe.value&&(js(),b.value={},g.value={},v.value=!1)}function qs(_,N=!1){const q=Date.now();if(N&&$.path===_&&q-$.at<ik){$.at=q;return}js(),$={path:_,at:q}}function Ms(_,N,q){if(!N.length)return q;const ve=sa(_??{});let De=ve;for(let gt=0;gt<N.length-1;gt+=1){const it=N[gt];De[it]=sa(De[it]??{}),De=De[it]}return De[N.at(-1)]=q,ve}function Rn(_){var N;return Object.hasOwn(b.value,_)?b.value[_]:sa((N=e.value)==null?void 0:N[_])}function vt(_,N,q={}){var di;const[ve,...De]=_.path.split(".");qs(_.path,!!q.coalesce);const gt=Rn(ve),it=De.length?Ms(gt,De,N):N,Gs={...b.value};if(Ni(it,(di=e.value)==null?void 0:di[ve])?delete Gs[ve]:Gs[ve]=it,b.value=Gs,g.value[_.path]){const od={...g.value};delete od[_.path],g.value=od}}function Ps(_){$={path:null,at:0},E.value={...E.value,[_]:String(be(ie.value,_)??"")}}function qn(_){if($={path:null,at:0},!Object.hasOwn(E.value,_))return;const N={...E.value};delete N[_],E.value=N}function Je(_){const N=E.value[_.path];if($={path:null,at:0},N===""){g.value={...g.value,[_.path]:"Enter a number."};return}const q=Number(N);if(Number.isNaN(q)||_.type==="integer"&&!Number.isInteger(q)){g.value={...g.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a number."};return}const ve={...E.value};delete ve[_.path],E.value=ve,vt(_,q,{coalesce:!0})}function G(_){return Object.hasOwn(E.value,_.path)?E.value[_.path]:_.value??""}function he(_,N){if(E.value={...E.value,[_.path]:N},N===""){g.value={...g.value,[_.path]:"Enter a number."};return}const q=Number(N);if(!Number.isFinite(q)||_.type==="integer"&&!Number.isInteger(q)){g.value={...g.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[_.path]){const ve={...g.value};delete ve[_.path],g.value=ve}vt(_,q,{coalesce:!0})}function Ne(_){const N=Number.parseInt(R.value,10);if(!Number.isInteger(N)||N<1){g.value={...g.value,[_.path]:"Warning thresholds must be positive whole numbers."};return}const q=[...new Set([..._.value||[],N])].sort((ve,De)=>De-ve);R.value="",vt(_,q)}function We(_,N){vt(_,(_.value||[]).filter(q=>q!==N))}function ct(_){return _.apply_mode==="live_read"?"Odin reads the saved file value on next use.":_.apply_mode==="live_for_new_work"?"New work uses the saved file value.":_.apply_mode==="live_apply"?_.apply_handler?`Apply the saved value through ${_.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":_.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":_.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":_.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function It(_){return _.type==="array"&&Array.isArray(_.value)&&!_.structured_container&&!_.structured_container_child&&_.sensitivity==="public"&&_.value.every(N=>["string","number","boolean"].includes(typeof N))}function Gn(_){const N=String(S.value[_.path]??"").trim();if(!N)return;const q=[...new Set([..._.value||[],N])];S.value={...S.value,[_.path]:""},vt(_,q)}function Qt(_,N){vt(_,(_.value||[]).filter(q=>q!==N))}function wa(_,N){var ve;if(!_)return null;if((ve=_.enum)!=null&&ve.length&&!_.enum.includes(N))return`Choose one of: ${_.enum.join(", ")}`;if(_.path==="agents.final_warning_iterations"&&(!Array.isArray(N)||!N.length))return"Add at least one warning threshold.";const q=_.constraints||{};if((_.type==="integer"||_.type==="number")&&typeof N=="number"){if(q.minimum!==void 0&&N<q.minimum)return`Must be at least ${q.minimum}${_.unit?` ${_.unit}`:""}`;if(q.maximum!==void 0&&N>q.maximum)return`Must be at most ${q.maximum}${_.unit?` ${_.unit}`:""}`}return null}function Ds(_){return H.value[_.path]||null}function oi(_){const N=`${_}.`;return Object.keys(H.value).some(q=>q===_||q.startsWith(N))}function ka(){x.value.length&&(C.value.push(sa(b.value)),b.value=x.value.pop(),g.value={},E.value={},$={path:null,at:0})}function Kn(){C.value.length&&(x.value.push(sa(b.value)),b.value=C.value.pop(),g.value={},E.value={},$={path:null,at:0})}function Sa(){!oe.value||re.value||(v.value=!0,w.value=!1)}function Wn(){v.value=!1}function In(){Vs()}function ms(_){return sk[_]||Aa(_||"unknown")}function an(_){return`apply-${String(_||"unknown").replaceAll("_","-")}`}function j(_){return`cfgc-field-${_.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function Se(_){return`${j(_)}-input`}function Ie(_){const N=document.getElementById(j(_))||document.getElementById(j(_.split(".").slice(0,2).join(".")));N==null||N.scrollIntoView({behavior:"smooth",block:"center"})}function Xt(_,N){l.value={type:_,message:N},window.setTimeout(()=>{var q;((q=l.value)==null?void 0:q.message)===N&&(l.value=null)},3500)}function Zn(){o.value=!1,p.value="pending_restart",u.value="";const _=tk(n.value);_&&(_.scrollTop=0)}function Jn(){o.value=!1}function Yn(_=1800){I&&window.clearTimeout(I),I=window.setTimeout(ci,_)}async function ci(){if(c.value){if(F+=1,F>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await co(),k.value===0){c.value=!1,d.value=null,Xt("success","Odin restarted and the saved startup settings are active.");return}}catch{}Yn(2e3)}}async function Ae(){if(!c.value){d.value=null;try{await K.post("/api/restart",{}),c.value=!0,F=0,o.value=!1,Yn()}catch(_){d.value=_.message||"Odin could not schedule a restart."}}}async function A(){if(!(!oe.value||re.value||a.value)){a.value=!0;try{const _=ok(e.value,b.value),N=await K.put("/api/config",_);e.value=N,b.value={},x.value=[],C.value=[],g.value={},v.value=!1;try{t.value=await co(),r.value=null,o.value=k.value>0,Xt("success",k.value?`Configuration saved. ${k.value} setting${k.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(q){r.value=q.message||"Unknown metadata error.",Xt("error",`Configuration saved, but apply status could not be refreshed: ${r.value}`)}}catch(_){Xt("error",_.message||"Configuration could not be saved")}finally{a.value=!1}}}async function J(){var _,N;if(!oe.value){s.value=!0,i.value=null;try{const q=await K.get("/api/config"),ve=await co();e.value=q,t.value=ve,r.value=null;const De=W.value;if(De.some(gt=>gt.key===f.value)||(f.value=((_=De[0])==null?void 0:_.key)||Ga[0].key),T.value){const it=(((N=De.find(Gs=>Gs.key===f.value))==null?void 0:N.sections)||[]).find(Gs=>m.value[Gs]===!0);m.value=it?{...m.value,[it]:!0}:{}}}catch(q){i.value=q.message||"Unknown configuration error"}finally{s.value=!1}}}function ge(_){if(v.value||!(_.ctrlKey||_.metaKey))return;const N=_.target;N instanceof HTMLElement&&(N.matches("input, textarea, select")||N.isContentEditable)||(!_.shiftKey&&_.key.toLowerCase()==="z"?(_.preventDefault(),ka()):(_.key.toLowerCase()==="y"||_.shiftKey&&_.key.toLowerCase()==="z")&&(_.preventDefault(),Kn()))}function Pe(_){T.value=_.matches}return is(m,_=>{try{localStorage.setItem(Rm,JSON.stringify(_))}catch{}},{deep:!0}),Ke(()=>{var _;J(),document.addEventListener("keydown",ge),y=window.matchMedia("(max-width: 760px)"),Pe(y),(_=y.addEventListener)==null||_.call(y,"change",Pe)}),_t(()=>{var _;document.removeEventListener("keydown",ge),(_=y==null?void 0:y.removeEventListener)==null||_.call(y,"change",Pe),I&&window.clearTimeout(I)}),{config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:r,restartPromptOpen:o,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:v,mobileOverflowOpen:w,warningThresholdInput:R,arrayInputs:S,healthFilters:D,visibleCategories:W,displayGroups:ce,reviewGroups:Ce,sectionCount:ne,fieldCount:U,hasChanges:oe,changeCount:X,changedSectionCount:ye,hasDraftErrors:re,canUndo:P,canRedo:L,globalFilterActive:Y,reviewRestartCount:we,pendingRestartCount:k,pendingRestartFields:Be,healthCount:Ee,categoryStats:Ue,selectCategory:ot,selectHealthFilter:zs,clearFilters:Ss,sectionLabel:Q,sectionDescription:se,sectionFieldCount:ae,sectionHealthCount:_e,sectionApplySummary:ue,sectionApplyDetails:pe,sectionEntries:xe,fieldGroups:z,sectionSearchHits:Mt,mcpConfigSummary:ke,fieldRuntimeCopy:me,fieldSpecificRuntimeNote:Le,hasHonestAction:Me,runFieldAction:rt,sectionChanged:mt,fieldChanged:qe,isSectionExpanded:jt,toggleSection:nn,discardAllDrafts:Vs,setFieldValue:vt,setNumberFieldValue:he,numberInputValue:G,beginInputEdit:Ps,endTextInputEdit:qn,endInputEdit:Je,addWarningThreshold:Ne,removeWarningThreshold:We,isScalarArray:It,addScalarArrayItem:Gn,removeScalarArrayItem:Qt,fieldError:Ds,sectionHasErrors:oi,undo:ka,redo:Kn,openReview:Sa,closeReview:Wn,mobileCancel:In,applyModeLabel:ms,applyClass:an,compactValue:lk,formatValue:rk,structuredApplyCopy:ct,fieldId:j,fieldInputId:Se,focusField:Ie,fetchConfig:J,saveConfig:A,restartOdin:Ae,restartLater:Jn,reviewPendingRestart:Zn}}},pk=/^\d{15,25}$/;function Nm(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Mm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=Z(()=>new Set((e.excludedIds||[]).map(String))),r=Z(()=>{const C=s.value.toLowerCase().trim();return(e.members||[]).filter(v=>l.value.has(String(v.id))?!1:C?u(v).toLowerCase().includes(C)||String(v.username||"").toLowerCase().includes(C)||String(v.id).includes(C):!0)}),o=Z(()=>{const C=s.value.trim();return r.value.length===0&&pk.test(C)&&!l.value.has(C)?C:""}),c=Z(()=>r.value.length+(o.value?1:0)),d=Z(()=>{if(n.value){if(r.value[a.value])return`${e.optionsId}-${a.value}`;if(o.value&&a.value===r.value.length)return`${e.optionsId}-raw`}});function u(C){return Nm(C)}function p(){n.value=!0,a.value=0}function f(){p()}function m(){const C=Math.max(c.value-1,0);a.value=Math.min(a.value+1,C)}function b(){a.value=Math.max(a.value-1,0)}function E(){const C=r.value[a.value];C?R(C):o.value&&a.value===r.value.length&&S(o.value)}function R(C){S(String(C.id))}function S(C){t("select",C),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function x(){setTimeout(g,150)}return Ke(()=>{e.autofocus&&Ct(()=>{var C;return(C=i.value)==null?void 0:C.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:r,rawId:o,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:m,highlightPrevious:b,selectHighlighted:E,selectMember:R,selectId:S,closeOptions:g,onBlur:x}}};function Hu(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const fk={components:{DiscordUserCombobox:Mm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h(null),i=h(null),l=h(!1),r=h(null),o=h({}),c=h([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=Z(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),f=Z(()=>new Map(c.value.map(M=>[String(M.id),M])));function m(M){return M.config&&M.config.enabled!==void 0?M.config.enabled:!0}function b(M){return Hu(M,"require_mention",a.value)}function E(M){return Hu(M,"respond_to_bots",a.value)}function R(M){return M.config&&Object.keys(M.config).length>0}function S(M){n.value[M]=!n.value[M]}function g(M){const V=M.discord||{};return{allowed_users:[...V.allowed_users||[]],channels:[...V.channels||[]],respond_to_bots:!!V.respond_to_bots,require_mention:!!V.require_mention,ignore_bot_ids:[...V.ignore_bot_ids||[]]}}async function x({showLoading:M=!0}={}){const V=++d;M&&(t.value=!0),s.value=null;try{const ne=await K.get("/api/discord/guilds");V===d&&(e.value=ne)}catch(ne){V===d&&(s.value=ne.message)}finally{M&&V===d&&(t.value=!1)}}async function C(){t.value=!0,s.value=null;try{const[M,V,ne]=await Promise.all([K.get("/api/discord/guilds"),K.get("/api/discord/members").catch(()=>[]),K.get("/api/config")]),U=g(ne),D=p.value;a.value=U,D||(i.value=JSON.parse(JSON.stringify(U))),c.value=V,e.value=M,r.value=null}catch(M){s.value=M.message}finally{t.value=!1}}async function v(M,V,ne){try{await K.put("/api/discord/guild/"+M+"/config",{[V]:ne}),await x({showLoading:!1})}catch(U){s.value=U.message}}async function w(M,V,ne,U){try{await K.put("/api/discord/channel/"+M+"/config",{[ne]:U}),await x({showLoading:!1})}catch(D){s.value=D.message}}async function T(M,V){try{await K.put("/api/discord/channel/"+M+"/config",{clear:!0}),await x({showLoading:!1})}catch(ne){s.value=ne.message}}function y(M,V){const ne=String(V);if(!M.userAutocomplete)return ne;const U=f.value.get(ne);return U?Nm(U):ne}function I(M,V=null){const ne=String(V??o.value[M]??"").trim();!ne||i.value[M].includes(ne)||(i.value[M]=[...i.value[M],ne],o.value={...o.value,[M]:""})}function $(M,V){i.value[M]=i.value[M].filter(ne=>ne!==V)}async function F(){if(!(!p.value||l.value)){l.value=!0,r.value=null;try{const V=(await K.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...V.allowed_users||[]],channels:[...V.channels||[]],respond_to_bots:!!V.respond_to_bots,require_mention:!!V.require_mention,ignore_bot_ids:[...V.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(M){r.value=M.message||"Global defaults could not be saved."}finally{l.value=!1}}}return Ke(C),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:r,globalArrayInputs:o,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:b,guildBots:E,hasOverride:R,toggleGuild:S,fetchAll:C,fetchGuilds:x,setGuildConfig:v,setChannelConfig:w,clearOverride:T,globalItemLabel:y,addGlobalItem:I,removeGlobalItem:$,saveGlobalDefaults:F}}},vs=e=>e==null?e:JSON.parse(JSON.stringify(e));function hk({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:r=()=>{},onError:o=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let f=null;const m=new Map;function b(v){d+=1;const w=c.then(v,v);return c=w.catch(()=>{}),w}function E(v,w){f=vs(v),m.clear();for(const[T,y]of Object.entries(w||{}))m.set(T,vs(y))}function R(v){const w=vs(v),T=++u;return b(async()=>{try{await e(vs(w)),f=vs(w),T===u&&n(vs(w))}catch(y){T===u&&(a(vs(f)),o(y,{kind:"default"}))}})}function S(v,w){const T=vs(w),y=(p.get(v)||0)+1;return p.set(v,y),b(async()=>{try{await t(v,vs(T)),m.set(v,vs(T)),y===p.get(v)&&i(v,vs(T))}catch(I){y===p.get(v)&&(l(v,vs(m.get(v)??null)),o(I,{kind:"user",uid:v}))}})}function g(v){const w=(p.get(v)||0)+1;return p.set(v,w),b(async()=>{try{await s(v),m.delete(v),w===p.get(v)&&r(v)}catch(T){w===p.get(v)&&(l(v,vs(m.get(v)??null)),o(T,{kind:"delete",uid:v}))}})}async function x(){for(;;){const v=c;if(await v,v===c)return d}}async function C(v){for(;;){const w=await x(),T=await v();if(w===d)return T}}return{seed:E,saveDefault:R,saveUser:S,deleteUser:g,whenIdle:x,readSnapshot:C,get revision(){return d}}}const mk={components:{DiscordUserCombobox:Mm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h([]),o=Z(()=>{const v={};for(const w of r.value)v[w.id]=w;return v});function c(v){return o.value[v]||null}function d(v,w){return v?v.allowed_hosts===null||v.allowed_hosts===void 0?{allowed_hosts:[...w],default_host:v.default_host||"",allow_all:!0}:{allowed_hosts:v.allowed_hosts,default_host:v.default_host||"",allow_all:!1}:{allowed_hosts:[...w],default_host:w[0]||"",allow_all:!0}}const u=hk({applyDefault:async v=>{const w=v.allow_all?null:v.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:w,default_host:v.default_host})},applyUser:async(v,w)=>{const T=w.allow_all?null:w.allowed_hosts;await K.put(`/api/host-access/user/${v}`,{allowed_hosts:T,default_host:w.default_host})},applyDelete:v=>K.del(`/api/host-access/user/${v}`),onDefaultConfirmed:()=>Oe.success("Default policy updated"),onDefaultRollback:v=>{v&&(a.value=v)},onUserConfirmed:v=>{const w=c(v);Oe.success(`Updated access for ${w?w.display_name:v}`)},onUserRollback:(v,w)=>{const T={...i.value};w?T[v]=w:delete T[v],i.value=T},onUserDeleted:v=>{const w={...i.value};delete w[v],i.value=w},onError:(v,w)=>{var y;const T=w.uid?` ${((y=c(w.uid))==null?void 0:y.display_name)||w.uid}`:"";Oe.error(`${v.message||"Failed to save"} — reverted${T}`)}});let p=0;async function f(){const v=++p;e.value=!0,t.value="";try{const w=await u.readSnapshot(()=>K.get("/api/host-access"));if(v!==p)return;s.value=w,n.value=w.available_hosts||[],a.value=d(w.default_policy,n.value);const T=w.users||{},y={};for(const[I,$]of Object.entries(T))y[I]=d($,n.value);i.value=y,u.seed(a.value,y)}catch(w){v===p&&(t.value=w.message||"Failed to fetch host access data")}finally{v===p&&(e.value=!1)}try{const w=await K.get("/api/discord/members")||[];v===p&&(r.value=w)}catch{v===p&&(r.value=[])}}function m(){u.saveDefault(a.value)}function b(v,w){a.value.allow_all=!1,w?a.value.allowed_hosts.includes(v)||a.value.allowed_hosts.push(v):(a.value.allowed_hosts=a.value.allowed_hosts.filter(T=>T!==v),a.value.default_host===v&&(a.value.default_host=a.value.allowed_hosts[0]||"")),m()}function E(v){const w=i.value[v];w&&u.saveUser(v,w)}function R(v,w,T){const y=i.value[v];y&&(y.allow_all=!1,T?y.allowed_hosts.includes(w)||y.allowed_hosts.push(w):(y.allowed_hosts=y.allowed_hosts.filter(I=>I!==w),y.default_host===w&&(y.default_host=y.allowed_hosts[0]||"")),E(v))}function S(v,w){const T=i.value[v];T&&(T.default_host=w,E(v))}function g(){l.value=!0}function x(v){!/^\d{15,25}$/.test(v)||i.value[v]||(i.value[v]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},E(v),l.value=!1)}async function C(v){const w=c(v);await Jt({title:"Remove user override",message:`Remove the host access override for ${w?w.display_name:v}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await u.deleteUser(v),i.value[v]||Oe.success(`Removed override for ${w?w.display_name:v}`))}return Ke(f),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,members:r,fetchData:f,saveDefaultPolicy:m,toggleDefaultHost:b,getMember:c,toggleUserHost:R,setUserDefault:S,openAddUser:g,addUserById:x,deleteUser:C}}},vk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=Z(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=Z(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const T=await K.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function b(T){return!T||!T.trim()?[]:T.split(",").map(y=>y.trim()).filter(Boolean)}function E(T,y){const I=c.value.allowed_hosts;if(y&&!I.includes(T)&&I.push(T),!y){const $=I.indexOf(T);$>=0&&I.splice($,1)}}function R(T,y){const I=d.value.allowed_hosts;if(y&&!I.includes(T)&&I.push(T),!y){const $=I.indexOf(T);$>=0&&I.splice($,1)}}async function S(){var T;i.value=!0;try{const y=b(c.value.allowed_tools_str),I=c.value.host_mode,$=I==="none"?[]:I==="select"?c.value.allowed_hosts:null,F={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:y.length?y:[]};$!==null&&(F.allowed_hosts=$),F.default_host=c.value.default_host||"";const M=await K.post("/api/tokens",F);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Oe.success("Token created"),await m()}catch(y){Oe.error(((T=y.data)==null?void 0:T.error)||y.message||"Failed to create token")}finally{i.value=!1}}function g(T){r.value=T;const y=T.allowed_hosts;let I="default";y==null?I="default":Array.isArray(y)&&y.length===0?I="none":Array.isArray(y)&&(I="select"),d.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:I,allowed_hosts:Array.isArray(y)?[...y]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const y=b(d.value.allowed_tools_str),I=d.value.host_mode,$={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:y};I==="none"?$.allowed_hosts=[]:I==="select"?$.allowed_hosts=d.value.allowed_hosts:$.allowed_hosts=null,$.default_host=d.value.default_host||"",await K.put("/api/tokens/"+encodeURIComponent(r.value.user_id),$),r.value=null,Oe.success("Token updated"),await m()}catch(y){Oe.error(((T=y.data)==null?void 0:T.error)||y.message||"Failed to update")}finally{o.value=!1}}}async function C(T){var I;if(await Jt({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const $=await K.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=$.token,Oe.success("Token regenerated")}catch($){Oe.error(((I=$.data)==null?void 0:I.error)||$.message||"Failed to regenerate")}}async function v(T){var I;if(await Jt({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/tokens/"+encodeURIComponent(T.user_id)),Oe.success("Token deleted"),await m()}catch($){Oe.error(((I=$.data)==null?void 0:I.error)||$.message||"Failed to delete")}}async function w(){if(l.value)try{await navigator.clipboard.writeText(l.value),Oe.success("Copied to clipboard")}catch{Oe.error("Copy failed — select and copy manually")}}return Ke(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:f,toggleCreateHost:E,toggleEditHost:R,createToken:S,startEdit:g,saveEdit:x,confirmRegenerate:C,confirmDelete:v,copyToken:w}}},gk=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),bk=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),yk=Object.freeze(["enabled","base_url","model","max_tokens"]),xk=Object.freeze(["enabled","model","max_tokens"]);function Br(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function zu(e){return Br(e,gk)}function ju(e){return Br(e,bk)}function _k(e,{includeApiKey:t=!1}={}){const s=Br(e,yk);return t&&(s.api_key=e.api_key),s}function wk(e){return{timeout:e.timeout}}function kk(e,{includeApiKey:t=!1}={}){const s=Br(e,xk);return t&&(s.api_key=e.api_key),s}function Sk(e){return{timeout:e.timeout}}function Tl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Tk={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("codex"),a=h({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],l=Z(()=>{const j=a.value.model;return j&&!i.includes(j)?[j,...i]:i}),r=Z(()=>{const j=a.value.agent_model;return j&&j!=="auto"&&!i.includes(j)?[j,...i]:i}),o=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],c=Z(()=>!o.includes(a.value.model)&&!(o.includes(a.value.agent_model)&&a.value.agent_reasoning_effort==="")),d=Z(()=>{const j=a.value.agent_model;return j==="auto"?!0:!o.includes(j||a.value.model)}),u=Z(()=>{const j=a.value.agent_reasoning_effort;return j==="auto"?!1:(j||a.value.reasoning_effort)==="max"}),p=j=>o.includes(j)&&(a.value.reasoning_effort==="max"||a.value.agent_model===""&&u.value),f=j=>o.includes(j)&&u.value,m=h({enabled:!1,model:"gpt-5.6-luna"}),b=h({unavailable_reason:null}),E=Z(()=>{const j=m.value.model;return j&&!i.includes(j)?[j,...i]:i});function R(j){const Se=j.target.value;m.value.enabled=Se!=="",Se!==""&&(m.value.model=Se),G()}const S=h(!1),g=h({codex:!1,ollama:!1,kimi:!1}),x=h(null),C=h(!1),v=h(""),w=h(null),T=h(!1);let y=0;const I=Z(()=>{var j;return Object.entries(((j=x.value)==null?void 0:j.models)||{}).map(([Se,Ie])=>{var Xt,Zn,Jn;return{model:Se,floor:Ie.floor,override:Ie.override,effectiveBudget:(Xt=Ie.effective)==null?void 0:Xt.effective_budget,configuredPrimaryChars:(Zn=Ie.configured)==null?void 0:Zn.primary_chars,primaryChars:(Jn=Ie.effective)==null?void 0:Jn.primary_chars,provenance:Ie.provenance,clampExpiresAt:Ie.clamp_expires_at}})}),$=Z(()=>{var j;return((j=x.value)==null?void 0:j.clamps)||[]}),F=Z(()=>{var j,Se;return((Se=(j=x.value)==null?void 0:j.models)==null?void 0:Se[a.value.model])||null}),M=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),V=h({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),ne=h(!1),U=h(!1),D=h(!1),P=h(!1),L=h(!1),W=h(!1),ie=h(!1),te=h({configured:null}),oe=h(!1),X=h([]),ye=h(""),Y=h(!1),H=h(!1),re=h({configured:null}),ce=h(!1),Ce=h([]),we=h(""),Be=h(!1),k=h(!1),O=h(!0),B=h(""),ae=h({configured:null,accounts:[]}),Q=h(null),se=h(null),fe=h(""),ue=h(null),pe=h(!1),le=h(null),ke=h(null),be=h("");let xe=null;function de(j,Se="success"){Oe(j,Se==="error"?"error":"success")}function z(j){if(!j)return"?";const Se=j/(1024*1024*1024);return Se>=1?Se.toFixed(1)+" GB":(j/(1024*1024)).toFixed(0)+" MB"}function me(j){return Number.isFinite(Number(j))?Number(j).toLocaleString():"—"}function Te(j){return j==null?"automatic (model-derived)":Number(j).toLocaleString()+" characters"}function Le(j){const Se=new Date(j);return Number.isNaN(Se.getTime())?"unknown":Se.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function Me(j){return typeof j=="string"&&j.length>12?j.slice(0,8)+"…"+j.slice(-4):j}function rt(j){return j==="temporary learned clamp"?"is-clamp":j==="override"?"is-override":"is-built-in"}function at(j){const Se=a.value.context_budget_overrides[j.model];return j.floor!=null&&Number.isFinite(Number(Se))&&Number(Se)>j.floor}function Mt(j,Se){const Ie={...a.value.context_budget_overrides};Se.target.value===""?delete Ie[j]:Ie[j]=Number(Se.target.value),a.value.context_budget_overrides=Ie,T.value=!0}function ee(j){a.value.context_utilization=j.target.value===""?"":Number(j.target.value),T.value=!0}function _e(j){const Se={...a.value.context_budget_overrides};delete Se[j],a.value.context_budget_overrides=Se,T.value=!0}async function Ee(){e.value=!0,await Promise.all([Ue(),qe(),jt(),ot(),mt()]),e.value=!1}async function Ue({preserveBasic:j=!1,preserveAdvanced:Se=!1}={}){try{const Ie=await K.get("/api/llm/status");t.value=Ie,s.value=!1,n.value=Ie.active_provider||"codex",Ie.codex&&!Je.pending()&&(j||(a.value.enabled=Ie.codex.enabled,a.value.model=Ie.codex.model||"gpt-5.6-sol",a.value.reasoning_effort=Ie.codex.reasoning_effort||"medium",a.value.agent_reasoning_effort=Ie.codex.agent_reasoning_effort||"",a.value.agent_model=Ie.codex.agent_model||""),Se||(a.value.request_timeout_seconds=Ie.codex.request_timeout_seconds??a.value.request_timeout_seconds,a.value.stream_stall_timeout_seconds=Ie.codex.stream_stall_timeout_seconds??a.value.stream_stall_timeout_seconds,a.value.retry={...a.value.retry,...Ie.codex.retry||{}},a.value.connection_pool={...a.value.connection_pool,...Ie.codex.connection_pool||{}},a.value.context_compression={...a.value.context_compression,...Ie.codex.context_compression||{}},!T.value&&!D.value&&(a.value.context_budget_overrides={...Ie.codex.context_budget_overrides||{}},a.value.context_utilization=Ie.codex.context_utilization??a.value.context_utilization))),Ie.ollama&&!he.pending()&&(j||(M.value.enabled=Ie.ollama.enabled,M.value.base_url=Ie.ollama.base_url||"",M.value.model=Ie.ollama.model||"",M.value.max_tokens=Ie.ollama.max_tokens||4096),Se||(M.value.timeout=Ie.ollama.timeout??M.value.timeout)),Ie.kimi&&!Ne.pending()&&(j||(V.value.enabled=Ie.kimi.enabled,V.value.model=Ie.kimi.model||"",V.value.max_tokens=Ie.kimi.max_tokens||4096),Se||(V.value.timeout=Ie.kimi.timeout??V.value.timeout)),Ie.auxiliary&&(b.value=Ie.auxiliary,G.pending()||(m.value.enabled=Ie.auxiliary.enabled,m.value.model=Ie.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function mt(){const j=++y;C.value=!0,v.value="";try{const Se=await K.get("/api/context/windows");if(j!==y)return;x.value=Se,!D.value&&!T.value&&(a.value.context_budget_overrides=Object.fromEntries(Object.entries(Se.models||{}).filter(([,Ie])=>Ie.override!=null).map(([Ie,Xt])=>[Ie,Xt.override])),a.value.context_utilization=Se.utilization??a.value.context_utilization)}catch(Se){j===y&&(v.value=Se.message||"Failed to load context budgets")}finally{j===y&&(C.value=!1)}}async function qe(){try{if(te.value=await K.get("/api/ollama/status"),oe.value=!1,te.value.model&&(ye.value=te.value.model),te.value.configured)try{const j=await K.get("/api/ollama/models");X.value=j.models||[]}catch{X.value=[]}else if(M.value.base_url)try{const j=await K.post("/api/ollama/probe-models",{base_url:M.value.base_url});X.value=j.models||[]}catch{X.value=[]}}catch{oe.value=!0}}async function ot(){O.value=!0,B.value="";try{ae.value=await K.get("/api/codex/status")}catch(j){B.value=j.message||"Failed to fetch Codex status"}finally{O.value=!1}}async function zs(){const j=t.value?t.value.active_provider:"codex";ie.value=!0;try{const Se=await K.post("/api/llm/switch",{provider:n.value});Se.error?(n.value=j,de(Se.error,"error")):(de("Switched to "+n.value+" ("+Se.model+")"),await Ee())}catch(Se){n.value=j,de(Se.message||"Switch failed","error")}finally{ie.value=!1}}async function Ss(){Y.value=!0;try{const j=await K.post("/api/ollama/reload");de(j.configured?"Ollama reloaded":j.reason||"Ollama not configured",j.configured?"success":"error"),await Ee()}catch(j){de(j.message||"Reload failed","error")}finally{Y.value=!1}}async function Ns(){H.value=!0;try{await K.post("/api/ollama/model",{model:ye.value}),de("Model set to "+ye.value),await Ee()}catch(j){de(j.message||"Failed","error")}finally{H.value=!1}}async function Ft(){const j=M.value.base_url;if(!j){de("Enter a base URL first","error");return}W.value=!0;try{const Se=await K.post("/api/ollama/probe-models",{base_url:j});X.value=Se.models||[],X.value.length?(de(X.value.length+" model(s) found"),!M.value.model&&X.value.length&&(M.value.model=X.value[0].name)):de("No models found at "+j,"error")}catch(Se){de(Se.message||"Could not reach Ollama","error")}finally{W.value=!1}}async function jt(){try{if(re.value=await K.get("/api/kimi/status"),ce.value=!1,re.value.model&&(we.value=re.value.model),re.value.configured)try{const j=await K.get("/api/kimi/models");Ce.value=j.models||[]}catch{Ce.value=[]}}catch{ce.value=!0}}async function nn(){Be.value=!0;try{const j=await K.post("/api/kimi/reload");de(j.configured?"Kimi reloaded":j.reason||"Kimi not configured",j.configured?"success":"error"),await Ee()}catch(j){de(j.message||"Reload failed","error")}finally{Be.value=!1}}async function js(){k.value=!0;try{await K.post("/api/kimi/model",{model:we.value}),de("Model set to "+we.value),await Ee()}catch(j){de(j.message||"Failed","error")}finally{k.value=!1}}async function Vs(){if(D.value){Je();return}D.value=!0;const j=zu(a.value);try{await K.put("/api/llm/codex/config",j),de("Codex config saved"),await Promise.all([Ue({preserveBasic:!0,preserveAdvanced:!0}),ot()])}catch(Se){de(Se.message||"Failed","error");const Ie=JSON.stringify(zu(a.value))!==JSON.stringify(j);await Promise.all([Ue({preserveBasic:Ie,preserveAdvanced:!0}),ot()])}finally{D.value=!1}}async function qs(){if(D.value)return;D.value=!0;const j=ju(a.value);try{await K.put("/api/llm/codex/config",j),JSON.stringify({context_budget_overrides:a.value.context_budget_overrides,context_utilization:a.value.context_utilization})===JSON.stringify({context_budget_overrides:j.context_budget_overrides,context_utilization:j.context_utilization})&&(T.value=!1),de("Codex advanced settings saved"),await Promise.all([Ue({preserveBasic:!0,preserveAdvanced:!0}),ot(),mt()])}catch(Se){de(Se.message||"Failed","error");const Ie=JSON.stringify(ju(a.value))!==JSON.stringify(j);await Promise.all([Ue({preserveBasic:!0,preserveAdvanced:Ie}),ot(),mt()])}finally{D.value=!1}}async function Ms(){if(P.value){he();return}P.value=!0;try{const j=ne.value?M.value.api_key:null,Se=_k(M.value,{includeApiKey:j!==null});await K.put("/api/llm/ollama/config",Se),de("Ollama config saved"),j!==null&&M.value.api_key===j&&(M.value.api_key="",ne.value=!1),await Promise.all([Ue({preserveBasic:!0,preserveAdvanced:!0}),qe()])}catch(j){de(j.message||"Failed","error")}finally{P.value=!1}}async function Rn(){if(!P.value){P.value=!0;try{await K.put("/api/llm/ollama/config",wk(M.value)),de("Ollama timeout saved"),await Promise.all([Ue({preserveBasic:!0,preserveAdvanced:!0}),qe()])}catch(j){de(j.message||"Failed","error")}finally{P.value=!1}}}async function vt(){if(L.value){Ne();return}L.value=!0;try{const j=U.value?V.value.api_key:null,Se=kk(V.value,{includeApiKey:j!==null});await K.put("/api/llm/kimi/config",Se),de("Kimi config saved"),j!==null&&V.value.api_key===j&&(V.value.api_key="",U.value=!1),await Promise.all([Ue({preserveBasic:!0,preserveAdvanced:!0}),jt()])}catch(j){de(j.message||"Failed","error")}finally{L.value=!1}}async function Ps(){if(!L.value){L.value=!0;try{await K.put("/api/llm/kimi/config",Sk(V.value)),de("Kimi timeout saved"),await Promise.all([Ue({preserveBasic:!0,preserveAdvanced:!0}),jt()])}catch(j){de(j.message||"Failed","error")}finally{L.value=!1}}}async function qn(){if(S.value){G();return}S.value=!0;try{await K.put("/api/llm/auxiliary/config",m.value),de("Auxiliary config saved"),await Ue()}catch(j){de(j.message||"Failed","error"),await Ue()}finally{S.value=!1}}const Je=Tl(Vs),G=Tl(qn),he=Tl(Ms),Ne=Tl(vt),We=()=>(Je.cancel(),Vs()),ct=()=>(he.cancel(),Ms()),It=()=>(Ne.cancel(),vt()),Gn=()=>qs(),Qt=()=>Rn(),wa=()=>Ps();async function Ds(j){const Se=j.account_key+":"+j.model;w.value=Se;try{const Ie=await K.post("/api/context/windows/clear",{account_key:j.account_key,model:j.model});de(Ie.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await mt()}catch(Ie){de(Ie.message||"Failed to clear clamp","error"),await mt()}finally{w.value=null}}async function oi(j){try{await K.post("/api/codex/account/"+j+"/activate"),de("Active account switched"),await ot()}catch(Se){de(Se.message||"Failed","error")}}async function ka(j){Q.value=j;try{await K.post("/api/codex/account/"+j+"/refresh"),de("Token refreshed"),await ot()}catch(Se){de(Se.message||"Refresh failed","error")}finally{Q.value=null}}function Kn(j,Se){se.value=j,fe.value=Se||""}async function Sa(j){try{await K.put("/api/codex/account/"+j+"/label",{label:fe.value}),de("Label updated"),se.value=null,await ot()}catch(Se){de(Se.message||"Failed","error")}}async function Wn(j,Se){if(await Jt({title:"Delete Codex account",message:`Delete ${Se||"account #"+(j+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+j),de("Deleted. Pool reloaded."),await ot()}catch(Xt){de(Xt.message||"Failed","error")}}async function In(){pe.value=!0;try{const j=await K.post("/api/codex/device-code");le.value=j,ue.value="pending",ms(j)}catch(j){de(j.message||"Failed","error")}finally{pe.value=!1}}async function ms(j){xe={cancelled:!1};const Se=xe;try{const Ie=await K.post("/api/codex/device-poll",{device_auth_id:j.device_auth_id,user_code:j.user_code,interval:j.interval});if(Se.cancelled)return;ke.value=Ie,ue.value="success",await Ee()}catch(Ie){if(Se.cancelled)return;be.value=Ie.message||"Device login failed",ue.value="error"}}function an(){xe&&(xe.cancelled=!0),ue.value=null,le.value=null}return Ke(Ee),_t(()=>{xe&&(xe.cancelled=!0),Je.cancel(),G.cancel(),he.cancel(),Ne.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:n,switching:ie,advancedOpen:g,codexForm:a,codexModelOptions:l,codexAgentModelOptions:r,mainMaxAllowed:c,agentMaxAllowed:d,mainModelOptionDisabled:p,agentModelOptionDisabled:f,auxForm:m,auxData:b,auxModelOptions:E,onAuxModelChange:R,savingAux:S,saveAuxConfigDebounced:G,ollamaForm:M,kimiForm:V,savingCodex:D,savingOllama:P,savingKimi:L,probingOllama:W,ollamaKeyDirty:ne,kimiKeyDirty:U,fetchCodexStatus:ot,ollamaStatus:te,ollamaStatusLoadFailed:oe,ollamaModels:X,ollamaSelectedModel:ye,reloading:Y,settingModel:H,kimiStatus:re,kimiStatusLoadFailed:ce,kimiModels:Ce,kimiSelectedModel:we,reloadingKimi:Be,settingKimiModel:k,codexLoading:O,codexError:B,codexData:ae,refreshing:Q,editingLabel:se,labelValue:fe,contextWindows:x,contextWindowsLoading:C,contextWindowsError:v,contextBudgetRows:I,activeClampRows:$,activeContextBudget:F,clearingClamp:w,contextPolicyDirty:T,deviceState:ue,deviceLoading:pe,deviceInfo:le,deviceResult:ke,deviceError:be,fetchAll:Ee,fetchLLMStatus:Ue,fetchOllamaStatus:qe,fetchKimiStatus:jt,switchProvider:zs,reloadOllama:Ss,setOllamaModel:Ns,reloadKimi:nn,setKimiModel:js,probeOllamaModels:Ft,saveCodexConfig:Vs,saveOllamaConfig:Ms,saveKimiConfig:vt,saveCodexAdvancedConfig:qs,saveOllamaAdvancedConfig:Rn,saveKimiAdvancedConfig:Ps,saveCodexConfigDebounced:Je,saveOllamaConfigDebounced:he,saveKimiConfigDebounced:Ne,saveCodexConfigNow:We,saveOllamaConfigNow:ct,saveKimiConfigNow:It,saveCodexAdvancedConfigNow:Gn,saveOllamaAdvancedConfigNow:Qt,saveKimiAdvancedConfigNow:wa,activateAccount:oi,refreshAccount:ka,startEditLabel:Kn,saveLabel:Sa,deleteAccount:Wn,startDeviceLogin:In,cancelDeviceLogin:an,formatSize:z,fetchContextWindows:mt,clearContextClamp:Ds,setContextOverride:Mt,setContextUtilization:ee,resetContextOverride:_e,overrideAboveFloor:at,formatCount:me,formatContextCeiling:Te,formatExpiry:Le,shortAccountKey:Me,provenanceClass:rt}}},Vu={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Ck(e){return Vu[e]||Vu[(e||"").toLowerCase()]||"text-gray-400"}const Ek={template:`
  ...
  `},Ko={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(Ko));const Nk={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>Za("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[Za("path",{d:Ko[e.name]||Ko.info})])}},Mk=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function Gu(e){return[...e.querySelectorAll(Mk)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const Pk={mounted(e){const t=document.activeElement,s=n=>{if(n.key!=="Tab")return;const a=Gu(e);if(!a.length){n.preventDefault(),e.focus();return}const i=a[0],l=a[a.length-1];n.shiftKey&&document.activeElement===i?(n.preventDefault(),l.focus()):!n.shiftKey&&document.activeElement===l&&(n.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||Gu(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},Dk={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h(!1),o=h([]),c=h(0),d=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const f=Z(()=>{const L=e.value.uptime_seconds||0,W=Math.floor(L/86400),ie=Math.floor(L%86400/3600),te=Math.floor(L%3600/60),oe=[];return W>0&&oe.push(`${W}d`),ie>0&&oe.push(`${ie}h`),(oe.length===0||W===0&&ie===0)&&oe.push(`${te}m`),oe.join(" ")}),m=Z(()=>{const L=e.value.uptime_seconds||0;return 125.66*(1-Math.min(L/86400,1))}),b=Z(()=>{const L=e.value;return[{label:"Guilds",value:L.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:L.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:L.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${L.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:L.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:L.loop_count>0?"text-green-400":"",highlight:L.loop_count>0},{label:"Agents",value:L.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:L.agent_count>0?`${L.agent_count} total`:"",subColor:"text-gray-500",highlight:(L.agent_running??0)>0},{label:"Processes",value:L.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:L.process_count>0?`${L.process_count} total`:"",subColor:"text-gray-500",highlight:(L.process_running??0)>0},{label:"Schedules",value:L.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(L.schedule_failing>0?`${L.schedule_failing} failing`:"")+(L.schedule_failing>0&&L.schedule_paused>0?", ":"")+(L.schedule_paused>0?`${L.schedule_paused} paused`:"")||void 0,subColor:L.schedule_failing>0?"text-red-400":"text-yellow-400",color:L.schedule_failing>0?"text-red-400":"",highlight:L.schedule_failing>0},{label:"Users",value:L.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),E=Z(()=>{const L=e.value,W=[];return W.push({label:"Bot",status:L.status==="online"?"ok":"warn",detail:L.status==="online"?"Online":"Starting"}),(L.schedule_failing||0)>0?W.push({label:"Schedules",status:"error",detail:`${L.schedule_failing} failing`}):(L.schedule_count||0)>0&&W.push({label:"Schedules",status:"ok",detail:`${L.schedule_count} configured`}),(L.loop_count||0)>0&&W.push({label:"Loops",status:"ok",detail:`${L.loop_count} active`}),(L.agent_running||0)>0&&W.push({label:"Agents",status:"ok",detail:`${L.agent_running} running`}),(L.process_running||0)>0&&W.push({label:"Processes",status:"ok",detail:`${L.process_running} running`}),W});async function R(){try{e.value=await K.get("/api/status"),s.value=null}catch(L){s.value=L.message}finally{t.value=!1}}let S=0,g=0,x=0;function C(L,W){const ie=new Set;return[...W,...L].filter(te=>{const oe=te._hmac||JSON.stringify([te.timestamp,te.tool_name,te.user_id,te.result_summary,te.error]);return ie.has(oe)?!1:(ie.add(oe),!0)})}async function v(){const L=++S,W=x;a.value=!0;try{const ie=await K.get("/api/audit?limit=10");if(L!==S)return;const te=W===x?[]:n.value.filter(oe=>(oe._liveEpoch||0)>W);n.value=C(ie,te).slice(0,10),c.value=te.length}catch{}L===S&&(a.value=!1)}async function w(){const L=++g,W=x;l.value=!0;try{const ie=await K.get("/api/audit?error_only=1&limit=5");if(L!==g)return;const te=W===x?[]:i.value.filter(oe=>(oe._liveEpoch||0)>W&&oe.error);i.value=C(ie,te).slice(0,5),r.value=!1}catch{if(L!==g)return;r.value=W===x||i.value.length===0}L===g&&(l.value=!1)}async function T(){try{const L=await K.get("/api/knowledge");d.value=(Array.isArray(L)?L:[]).reduce((W,ie)=>W+(ie.chunks||0),0)}catch{d.value=null}}async function y(){try{const L=await K.get("/api/agents");o.value=L.filter(W=>W.status==="running")}catch{}}async function I(){u.value={...u.value,reload:!0};try{await K.post("/api/reload"),Oe.success("Config reloaded")}catch(L){Oe.error(L.message)}u.value={...u.value,reload:!1}}async function $(){if(!await Jt({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const W=e.value.session_count;e.value={...e.value,session_count:0};try{const ie=await K.post("/api/sessions/clear-all");Oe.success(`Cleared ${ie.count} session${ie.count!==1?"s":""}`),await R()}catch(ie){e.value={...e.value,session_count:W},Oe.error(ie.message)}u.value={...u.value,clearSessions:!1}}async function F(){if(!await Jt({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const W=e.value.loop_count;e.value={...e.value,loop_count:0};try{const ie=await K.post("/api/loops/stop-all");Oe.success(ie.result),await R()}catch(ie){e.value={...e.value,loop_count:W},Oe.error(ie.message)}u.value={...u.value,stopLoops:!1}}function M(){t.value=!0,s.value=null,R(),v(),w(),y()}let V=null,ne=null,U=null;function D(L){if(L.payload&&L.payload.tool_name){x+=1;const W={...L.payload,_isNew:!0,_key:++p,_liveEpoch:x};n.value.unshift(W),n.value.length>10&&n.value.pop(),c.value++,W.error&&(r.value=!1,i.value.unshift(W),i.value.length>5&&i.value.pop()),setTimeout(()=>{W._isNew=!1},1500),clearTimeout(U),U=setTimeout(()=>{c.value=0},1e4)}}let P=null;return Ke(async()=>{await Promise.all([R(),v(),w(),y(),T()]),V=setInterval(R,15e3),ne=setInterval(y,1e4),Ye.subscribe("events",D),P=Ye.onReconnected(()=>{v(),w()})}),_t(()=>{V&&clearInterval(V),ne&&clearInterval(ne),clearTimeout(U),Ye.unsubscribe("events",D),P&&(P(),P=null)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:m,stats:b,healthIndicators:E,activity:n,activityLoading:a,newEventCount:c,errors:i,errorsLoading:l,errorsError:r,agents:o,actionLoading:u,fetchActivity:v,fetchErrors:w,fetchStatus:R,onEvent:D,formatTime:ym,formatDuration:ai,retry:M,reloadConfig:I,clearSessions:$,stopAllLoops:F}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Ku(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function Fk(e){if(Array.isArray(e))return e}function $k(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(d){c=!0,a=d}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function Bk(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Uk(e,t){return Fk(e)||$k(e,t)||Hk(e,t)||Bk()}function Hk(e,t){if(e){if(typeof e=="string")return Ku(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Ku(e,t):void 0}}const Dm=Object.entries,Wu=Object.setPrototypeOf,zk=Object.isFrozen,jk=Object.getPrototypeOf,Vk=Object.getOwnPropertyDescriptor;let rs=Object.freeze,Ls=Object.seal,Ma=Object.create,Fm=typeof Reflect<"u"&&Reflect,Wo=Fm.apply,Zo=Fm.construct;rs||(rs=function(t){return t});Ls||(Ls=function(t){return t});Wo||(Wo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});Zo||(Zo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const cn=Rt(Array.prototype.forEach),qk=Rt(Array.prototype.lastIndexOf),Zu=Rt(Array.prototype.pop),Ra=Rt(Array.prototype.push),Gk=Rt(Array.prototype.splice),ts=Array.isArray,Si=Rt(String.prototype.toLowerCase),po=Rt(String.prototype.toString),Ju=Rt(String.prototype.match),Ia=Rt(String.prototype.replace),Yu=Rt(String.prototype.indexOf),Kk=Rt(String.prototype.trim),Wk=Rt(Number.prototype.toString),Zk=Rt(Boolean.prototype.toString),Qu=typeof BigInt>"u"?null:Rt(BigInt.prototype.toString),Xu=typeof Symbol>"u"?null:Rt(Symbol.prototype.toString),bt=Rt(Object.prototype.hasOwnProperty),gi=Rt(Object.prototype.toString),$t=Rt(RegExp.prototype.test),ea=Jk(TypeError);function Rt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return Wo(e,t,n)}}function Jk(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return Zo(e,s)}}function ze(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Si;if(Wu&&Wu(e,null),!ts(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(zk(t)||(t[n]=i),a=i)}e[a]=!0}return e}function Yk(e){for(let t=0;t<e.length;t++)bt(e,t)||(e[t]=null);return e}function qt(e){const t=Ma(null);for(const n of Dm(e)){var s=Uk(n,2);const a=s[0],i=s[1];bt(e,a)&&(ts(i)?t[a]=Yk(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=qt(i):t[a]=i)}return t}function Qk(e){switch(typeof e){case"string":return e;case"number":return Wk(e);case"boolean":return Zk(e);case"bigint":return Qu?Qu(e):"0";case"symbol":return Xu?Xu(e):"Symbol()";case"undefined":return gi(e);case"function":case"object":{if(e===null)return gi(e);const t=e,s=Zs(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:gi(n)}return gi(e)}default:return gi(e)}}function Zs(e,t){for(;e!==null;){const n=Vk(e,t);if(n){if(n.get)return Rt(n.get);if(typeof n.value=="function")return Rt(n.value)}e=jk(e)}function s(){return null}return s}function Xk(e){try{return $t(e,""),!0}catch{return!1}}const ep=rs(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),fo=rs(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ho=rs(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),eS=rs(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),mo=rs(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),tS=rs(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),tp=rs(["#text"]),sp=rs(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),vo=rs(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),np=rs(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),El=rs(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),sS=Ls(/{{[\w\W]*|^[\w\W]*}}/g),nS=Ls(/<%[\w\W]*|^[\w\W]*%>/g),aS=Ls(/\${[\w\W]*/g),iS=Ls(/^data-[\-\w.\u00B7-\uFFFF]+$/),lS=Ls(/^aria-[\-\w]+$/),ap=Ls(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),rS=Ls(/^(?:\w+script|data):/i),oS=Ls(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),cS=Ls(/^html$/i),dS=Ls(/^[a-z][.\w]*(-[.\w]+)+$/i),Ks={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},uS=function(){return typeof window>"u"?null:window},pS=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},ip=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function $m(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:uS();const t=Ae=>$m(Ae);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Ks.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=r.prototype,f=Zs(p,"cloneNode"),m=Zs(p,"remove"),b=Zs(p,"nextSibling"),E=Zs(p,"childNodes"),R=Zs(p,"parentNode"),S=Zs(p,"shadowRoot"),g=Zs(p,"attributes"),x=l&&l.prototype?Zs(l.prototype,"nodeType"):null,C=l&&l.prototype?Zs(l.prototype,"nodeName"):null;if(typeof i=="function"){const Ae=s.createElement("template");Ae.content&&Ae.content.ownerDocument&&(s=Ae.content.ownerDocument)}let v,w="",T,y=!1,I=0;const $=function(){if(I>0)throw ea('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},F=function(A){$(),I++;try{return v.createHTML(A)}finally{I--}},M=function(A){$(),I++;try{return v.createScriptURL(A)}finally{I--}},V=function(){return y||(T=pS(u,a),y=!0),T},ne=s,U=ne.implementation,D=ne.createNodeIterator,P=ne.createDocumentFragment,L=ne.getElementsByTagName,W=n.importNode;let ie=ip();t.isSupported=typeof Dm=="function"&&typeof R=="function"&&U&&U.createHTMLDocument!==void 0;const te=sS,oe=nS,X=aS,ye=iS,Y=lS,H=rS,re=oS,ce=dS;let Ce=ap,we=null;const Be=ze({},[...ep,...fo,...ho,...mo,...tp]);let k=null;const O=ze({},[...sp,...vo,...np,...El]);let B=Object.seal(Ma(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ae=null,Q=null;const se=Object.seal(Ma(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let fe=!0,ue=!0,pe=!1,le=!0,ke=!1,be=!0,xe=!1,de=!1,z=!1,me=!1,Te=!1,Le=!1,Me=!0,rt=!1;const at="user-content-";let Mt=!0,ee=!1,_e={},Ee=null;const Ue=ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let mt=null;const qe=ze({},["audio","video","img","source","image","track"]);let ot=null;const zs=ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ss="http://www.w3.org/1998/Math/MathML",Ns="http://www.w3.org/2000/svg",Ft="http://www.w3.org/1999/xhtml";let jt=Ft,nn=!1,js=null;const Vs=ze({},[Ss,Ns,Ft],po);let qs=ze({},["mi","mo","mn","ms","mtext"]),Ms=ze({},["annotation-xml"]);const Rn=ze({},["title","style","font","a","script"]);let vt=null;const Ps=["application/xhtml+xml","text/html"],qn="text/html";let Je=null,G=null;const he=s.createElement("form"),Ne=function(A){return A instanceof RegExp||A instanceof Function},We=function(){let A=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(G&&G===A)return;(!A||typeof A!="object")&&(A={}),A=qt(A),vt=Ps.indexOf(A.PARSER_MEDIA_TYPE)===-1?qn:A.PARSER_MEDIA_TYPE,Je=vt==="application/xhtml+xml"?po:Si,we=bt(A,"ALLOWED_TAGS")&&ts(A.ALLOWED_TAGS)?ze({},A.ALLOWED_TAGS,Je):Be,k=bt(A,"ALLOWED_ATTR")&&ts(A.ALLOWED_ATTR)?ze({},A.ALLOWED_ATTR,Je):O,js=bt(A,"ALLOWED_NAMESPACES")&&ts(A.ALLOWED_NAMESPACES)?ze({},A.ALLOWED_NAMESPACES,po):Vs,ot=bt(A,"ADD_URI_SAFE_ATTR")&&ts(A.ADD_URI_SAFE_ATTR)?ze(qt(zs),A.ADD_URI_SAFE_ATTR,Je):zs,mt=bt(A,"ADD_DATA_URI_TAGS")&&ts(A.ADD_DATA_URI_TAGS)?ze(qt(qe),A.ADD_DATA_URI_TAGS,Je):qe,Ee=bt(A,"FORBID_CONTENTS")&&ts(A.FORBID_CONTENTS)?ze({},A.FORBID_CONTENTS,Je):Ue,ae=bt(A,"FORBID_TAGS")&&ts(A.FORBID_TAGS)?ze({},A.FORBID_TAGS,Je):qt({}),Q=bt(A,"FORBID_ATTR")&&ts(A.FORBID_ATTR)?ze({},A.FORBID_ATTR,Je):qt({}),_e=bt(A,"USE_PROFILES")?A.USE_PROFILES&&typeof A.USE_PROFILES=="object"?qt(A.USE_PROFILES):A.USE_PROFILES:!1,fe=A.ALLOW_ARIA_ATTR!==!1,ue=A.ALLOW_DATA_ATTR!==!1,pe=A.ALLOW_UNKNOWN_PROTOCOLS||!1,le=A.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ke=A.SAFE_FOR_TEMPLATES||!1,be=A.SAFE_FOR_XML!==!1,xe=A.WHOLE_DOCUMENT||!1,me=A.RETURN_DOM||!1,Te=A.RETURN_DOM_FRAGMENT||!1,Le=A.RETURN_TRUSTED_TYPE||!1,z=A.FORCE_BODY||!1,Me=A.SANITIZE_DOM!==!1,rt=A.SANITIZE_NAMED_PROPS||!1,Mt=A.KEEP_CONTENT!==!1,ee=A.IN_PLACE||!1,Ce=Xk(A.ALLOWED_URI_REGEXP)?A.ALLOWED_URI_REGEXP:ap,jt=typeof A.NAMESPACE=="string"?A.NAMESPACE:Ft,qs=bt(A,"MATHML_TEXT_INTEGRATION_POINTS")&&A.MATHML_TEXT_INTEGRATION_POINTS&&typeof A.MATHML_TEXT_INTEGRATION_POINTS=="object"?qt(A.MATHML_TEXT_INTEGRATION_POINTS):ze({},["mi","mo","mn","ms","mtext"]),Ms=bt(A,"HTML_INTEGRATION_POINTS")&&A.HTML_INTEGRATION_POINTS&&typeof A.HTML_INTEGRATION_POINTS=="object"?qt(A.HTML_INTEGRATION_POINTS):ze({},["annotation-xml"]);const J=bt(A,"CUSTOM_ELEMENT_HANDLING")&&A.CUSTOM_ELEMENT_HANDLING&&typeof A.CUSTOM_ELEMENT_HANDLING=="object"?qt(A.CUSTOM_ELEMENT_HANDLING):Ma(null);if(B=Ma(null),bt(J,"tagNameCheck")&&Ne(J.tagNameCheck)&&(B.tagNameCheck=J.tagNameCheck),bt(J,"attributeNameCheck")&&Ne(J.attributeNameCheck)&&(B.attributeNameCheck=J.attributeNameCheck),bt(J,"allowCustomizedBuiltInElements")&&typeof J.allowCustomizedBuiltInElements=="boolean"&&(B.allowCustomizedBuiltInElements=J.allowCustomizedBuiltInElements),ke&&(ue=!1),Te&&(me=!0),_e&&(we=ze({},tp),k=Ma(null),_e.html===!0&&(ze(we,ep),ze(k,sp)),_e.svg===!0&&(ze(we,fo),ze(k,vo),ze(k,El)),_e.svgFilters===!0&&(ze(we,ho),ze(k,vo),ze(k,El)),_e.mathMl===!0&&(ze(we,mo),ze(k,np),ze(k,El))),se.tagCheck=null,se.attributeCheck=null,bt(A,"ADD_TAGS")&&(typeof A.ADD_TAGS=="function"?se.tagCheck=A.ADD_TAGS:ts(A.ADD_TAGS)&&(we===Be&&(we=qt(we)),ze(we,A.ADD_TAGS,Je))),bt(A,"ADD_ATTR")&&(typeof A.ADD_ATTR=="function"?se.attributeCheck=A.ADD_ATTR:ts(A.ADD_ATTR)&&(k===O&&(k=qt(k)),ze(k,A.ADD_ATTR,Je))),bt(A,"ADD_URI_SAFE_ATTR")&&ts(A.ADD_URI_SAFE_ATTR)&&ze(ot,A.ADD_URI_SAFE_ATTR,Je),bt(A,"FORBID_CONTENTS")&&ts(A.FORBID_CONTENTS)&&(Ee===Ue&&(Ee=qt(Ee)),ze(Ee,A.FORBID_CONTENTS,Je)),bt(A,"ADD_FORBID_CONTENTS")&&ts(A.ADD_FORBID_CONTENTS)&&(Ee===Ue&&(Ee=qt(Ee)),ze(Ee,A.ADD_FORBID_CONTENTS,Je)),Mt&&(we["#text"]=!0),xe&&ze(we,["html","head","body"]),we.table&&(ze(we,["tbody"]),delete ae.tbody),A.TRUSTED_TYPES_POLICY){if(typeof A.TRUSTED_TYPES_POLICY.createHTML!="function")throw ea('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof A.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw ea('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ge=v;v=A.TRUSTED_TYPES_POLICY;try{w=F("")}catch(Pe){throw v=ge,Pe}}else A.TRUSTED_TYPES_POLICY===null?(v=void 0,w=""):(v===void 0&&(v=V()),v&&typeof w=="string"&&(w=F("")));(ie.uponSanitizeElement.length>0||ie.uponSanitizeAttribute.length>0)&&we===Be&&(we=qt(we)),ie.uponSanitizeAttribute.length>0&&k===O&&(k=qt(k)),rs&&rs(A),G=A},ct=ze({},[...fo,...ho,...eS]),It=ze({},[...mo,...tS]),Gn=function(A){let J=R(A);(!J||!J.tagName)&&(J={namespaceURI:jt,tagName:"template"});const ge=Si(A.tagName),Pe=Si(J.tagName);return js[A.namespaceURI]?A.namespaceURI===Ns?J.namespaceURI===Ft?ge==="svg":J.namespaceURI===Ss?ge==="svg"&&(Pe==="annotation-xml"||qs[Pe]):!!ct[ge]:A.namespaceURI===Ss?J.namespaceURI===Ft?ge==="math":J.namespaceURI===Ns?ge==="math"&&Ms[Pe]:!!It[ge]:A.namespaceURI===Ft?J.namespaceURI===Ns&&!Ms[Pe]||J.namespaceURI===Ss&&!qs[Pe]?!1:!It[ge]&&(Rn[ge]||!ct[ge]):!!(vt==="application/xhtml+xml"&&js[A.namespaceURI]):!1},Qt=function(A){Ra(t.removed,{element:A});try{R(A).removeChild(A)}catch{if(m(A),!R(A))throw ea("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},wa=function(A){const J=E?E(A):A.childNodes;if(J){const Pe=[];cn(J,_=>{Ra(Pe,_)}),cn(Pe,_=>{try{m(_)}catch{}})}const ge=g?g(A):null;if(ge)for(let Pe=ge.length-1;Pe>=0;--Pe){const _=ge[Pe],N=_&&_.name;if(typeof N=="string")try{A.removeAttribute(N)}catch{}}},Ds=function(A,J){try{Ra(t.removed,{attribute:J.getAttributeNode(A),from:J})}catch{Ra(t.removed,{attribute:null,from:J})}if(J.removeAttribute(A),A==="is")if(me||Te)try{Qt(J)}catch{}else try{J.setAttribute(A,"")}catch{}},oi=function(A){const J=g?g(A):A.attributes;if(J)for(let ge=J.length-1;ge>=0;--ge){const Pe=J[ge],_=Pe&&Pe.name;if(!(typeof _!="string"||k[Je(_)]))try{A.removeAttribute(_)}catch{}}},ka=function(A){const J=[A];for(;J.length>0;){const ge=J.pop();(x?x(ge):ge.nodeType)===Ks.element&&oi(ge);const _=E?E(ge):ge.childNodes;if(_)for(let N=_.length-1;N>=0;--N)J.push(_[N])}},Kn=function(A){let J=null,ge=null;if(z)A="<remove></remove>"+A;else{const N=Ju(A,/^[\r\n\t ]+/);ge=N&&N[0]}vt==="application/xhtml+xml"&&jt===Ft&&(A='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+A+"</body></html>");const Pe=v?F(A):A;if(jt===Ft)try{J=new d().parseFromString(Pe,vt)}catch{}if(!J||!J.documentElement){J=U.createDocument(jt,"template",null);try{J.documentElement.innerHTML=nn?w:Pe}catch{}}const _=J.body||J.documentElement;return A&&ge&&_.insertBefore(s.createTextNode(ge),_.childNodes[0]||null),jt===Ft?L.call(J,xe?"html":"body")[0]:xe?J.documentElement:_},Sa=function(A){return D.call(A.ownerDocument||A,A,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},Wn=function(A){var J,ge;A.normalize();const Pe=D.call(A.ownerDocument||A,A,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let _=Pe.nextNode();for(;_;){let q=_.data;cn([te,oe,X],ve=>{q=Ia(q,ve," ")}),_.data=q,_=Pe.nextNode()}const N=(J=(ge=A.querySelectorAll)===null||ge===void 0?void 0:ge.call(A,"template"))!==null&&J!==void 0?J:[];cn(Array.from(N),q=>{ms(q.content)&&Wn(q.content)})},In=function(A){const J=C?C(A):null;return typeof J!="string"||Je(J)!=="form"?!1:typeof A.nodeName!="string"||typeof A.textContent!="string"||typeof A.removeChild!="function"||A.attributes!==g(A)||typeof A.removeAttribute!="function"||typeof A.setAttribute!="function"||typeof A.namespaceURI!="string"||typeof A.insertBefore!="function"||typeof A.hasChildNodes!="function"||A.nodeType!==x(A)||A.childNodes!==E(A)},ms=function(A){if(!x||typeof A!="object"||A===null)return!1;try{return x(A)===Ks.documentFragment}catch{return!1}},an=function(A){if(!x||typeof A!="object"||A===null)return!1;try{return typeof x(A)=="number"}catch{return!1}};function j(Ae,A,J){cn(Ae,ge=>{ge.call(t,A,J,G)})}const Se=function(A){let J=null;if(j(ie.beforeSanitizeElements,A,null),In(A))return Qt(A),!0;const ge=Je(C?C(A):A.nodeName);if(j(ie.uponSanitizeElement,A,{tagName:ge,allowedTags:we}),be&&A.hasChildNodes()&&!an(A.firstElementChild)&&$t(/<[/\w!]/g,A.innerHTML)&&$t(/<[/\w!]/g,A.textContent)||be&&A.namespaceURI===Ft&&ge==="style"&&an(A.firstElementChild)||A.nodeType===Ks.progressingInstruction||be&&A.nodeType===Ks.comment&&$t(/<[/\w]/g,A.data))return Qt(A),!0;if(ae[ge]||!(se.tagCheck instanceof Function&&se.tagCheck(ge))&&!we[ge]){if(!ae[ge]&&Zn(ge)&&(B.tagNameCheck instanceof RegExp&&$t(B.tagNameCheck,ge)||B.tagNameCheck instanceof Function&&B.tagNameCheck(ge)))return!1;if(Mt&&!Ee[ge]){const _=R(A),N=E(A);if(N&&_){const q=N.length;for(let ve=q-1;ve>=0;--ve){const De=ee?N[ve]:f(N[ve],!0);_.insertBefore(De,b(A))}}}return Qt(A),!0}return(x?x(A):A.nodeType)===Ks.element&&!Gn(A)||(ge==="noscript"||ge==="noembed"||ge==="noframes")&&$t(/<\/no(script|embed|frames)/i,A.innerHTML)?(Qt(A),!0):(ke&&A.nodeType===Ks.text&&(J=A.textContent,cn([te,oe,X],_=>{J=Ia(J,_," ")}),A.textContent!==J&&(Ra(t.removed,{element:A.cloneNode()}),A.textContent=J)),j(ie.afterSanitizeElements,A,null),!1)},Ie=function(A,J,ge){if(Q[J]||Me&&(J==="id"||J==="name")&&(ge in s||ge in he))return!1;const Pe=k[J]||se.attributeCheck instanceof Function&&se.attributeCheck(J,A);if(!(ue&&!Q[J]&&$t(ye,J))){if(!(fe&&$t(Y,J))){if(!Pe||Q[J]){if(!(Zn(A)&&(B.tagNameCheck instanceof RegExp&&$t(B.tagNameCheck,A)||B.tagNameCheck instanceof Function&&B.tagNameCheck(A))&&(B.attributeNameCheck instanceof RegExp&&$t(B.attributeNameCheck,J)||B.attributeNameCheck instanceof Function&&B.attributeNameCheck(J,A))||J==="is"&&B.allowCustomizedBuiltInElements&&(B.tagNameCheck instanceof RegExp&&$t(B.tagNameCheck,ge)||B.tagNameCheck instanceof Function&&B.tagNameCheck(ge))))return!1}else if(!ot[J]){if(!$t(Ce,Ia(ge,re,""))){if(!((J==="src"||J==="xlink:href"||J==="href")&&A!=="script"&&Yu(ge,"data:")===0&&mt[A])){if(!(pe&&!$t(H,Ia(ge,re,"")))){if(ge)return!1}}}}}}return!0},Xt=ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Zn=function(A){return!Xt[Si(A)]&&$t(ce,A)},Jn=function(A){j(ie.beforeSanitizeAttributes,A,null);const J=A.attributes;if(!J||In(A))return;const ge={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:k,forceKeepAttr:void 0};let Pe=J.length;for(;Pe--;){const _=J[Pe],N=_.name,q=_.namespaceURI,ve=_.value,De=Je(N),gt=ve;let it=N==="value"?gt:Kk(gt);if(ge.attrName=De,ge.attrValue=it,ge.keepAttr=!0,ge.forceKeepAttr=void 0,j(ie.uponSanitizeAttribute,A,ge),it=ge.attrValue,rt&&(De==="id"||De==="name")&&Yu(it,at)!==0&&(Ds(N,A),it=at+it),be&&$t(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,it)){Ds(N,A);continue}if(De==="attributename"&&Ju(it,"href")){Ds(N,A);continue}if(ge.forceKeepAttr)continue;if(!ge.keepAttr){Ds(N,A);continue}if(!le&&$t(/\/>/i,it)){Ds(N,A);continue}ke&&cn([te,oe,X],di=>{it=Ia(it,di," ")});const Gs=Je(A.nodeName);if(!Ie(Gs,De,it)){Ds(N,A);continue}if(v&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!q)switch(u.getAttributeType(Gs,De)){case"TrustedHTML":{it=F(it);break}case"TrustedScriptURL":{it=M(it);break}}if(it!==gt)try{q?A.setAttributeNS(q,N,it):A.setAttribute(N,it),In(A)?Qt(A):Zu(t.removed)}catch{Ds(N,A)}}j(ie.afterSanitizeAttributes,A,null)},Yn=function(A){let J=null;const ge=Sa(A);for(j(ie.beforeSanitizeShadowDOM,A,null);J=ge.nextNode();)if(j(ie.uponSanitizeShadowNode,J,null),Se(J),Jn(J),ms(J.content)&&Yn(J.content),(x?x(J):J.nodeType)===Ks.element){const _=S?S(J):J.shadowRoot;ms(_)&&(ci(_),Yn(_))}j(ie.afterSanitizeShadowDOM,A,null)},ci=function(A){const J=[{node:A,shadow:null}];for(;J.length>0;){const ge=J.pop();if(ge.shadow){Yn(ge.shadow);continue}const Pe=ge.node,N=(x?x(Pe):Pe.nodeType)===Ks.element,q=E?E(Pe):Pe.childNodes;if(q)for(let ve=q.length-1;ve>=0;--ve)J.push({node:q[ve],shadow:null});if(N){const ve=C?C(Pe):null;if(typeof ve=="string"&&Je(ve)==="template"){const De=Pe.content;ms(De)&&J.push({node:De,shadow:null})}}if(N){const ve=S?S(Pe):Pe.shadowRoot;ms(ve)&&J.push({node:null,shadow:ve},{node:ve,shadow:null})}}};return t.sanitize=function(Ae){let A=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},J=null,ge=null,Pe=null,_=null;if(nn=!Ae,nn&&(Ae="<!-->"),typeof Ae!="string"&&!an(Ae)&&(Ae=Qk(Ae),typeof Ae!="string"))throw ea("dirty is not a string, aborting");if(!t.isSupported)return Ae;de||We(A),t.removed=[];const N=ee&&typeof Ae!="string"&&an(Ae);if(N){const De=C?C(Ae):Ae.nodeName;if(typeof De=="string"){const gt=Je(De);if(!we[gt]||ae[gt])throw ea("root node is forbidden and cannot be sanitized in-place")}if(In(Ae))throw ea("root node is clobbered and cannot be sanitized in-place");try{ci(Ae)}catch(gt){throw wa(Ae),gt}}else if(an(Ae))J=Kn("<!---->"),ge=J.ownerDocument.importNode(Ae,!0),ge.nodeType===Ks.element&&ge.nodeName==="BODY"||ge.nodeName==="HTML"?J=ge:J.appendChild(ge),ci(ge);else{if(!me&&!ke&&!xe&&Ae.indexOf("<")===-1)return v&&Le?F(Ae):Ae;if(J=Kn(Ae),!J)return me?null:Le?w:""}J&&z&&Qt(J.firstChild);const q=Sa(N?Ae:J);try{for(;Pe=q.nextNode();)Se(Pe),Jn(Pe),ms(Pe.content)&&Yn(Pe.content)}catch(De){throw N&&wa(Ae),De}if(N)return cn(t.removed,De=>{De.element&&ka(De.element)}),ke&&Wn(Ae),Ae;if(me){if(ke&&Wn(J),Te)for(_=P.call(J.ownerDocument);J.firstChild;)_.appendChild(J.firstChild);else _=J;return(k.shadowroot||k.shadowrootmode)&&(_=W.call(n,_,!0)),_}let ve=xe?J.outerHTML:J.innerHTML;return xe&&we["!doctype"]&&J.ownerDocument&&J.ownerDocument.doctype&&J.ownerDocument.doctype.name&&$t(cS,J.ownerDocument.doctype.name)&&(ve="<!DOCTYPE "+J.ownerDocument.doctype.name+`>
`+ve),ke&&cn([te,oe,X],De=>{ve=Ia(ve,De," ")}),v&&Le?F(ve):ve},t.setConfig=function(){let Ae=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};We(Ae),de=!0},t.clearConfig=function(){G=null,de=!1,v=T,w=""},t.isValidAttribute=function(Ae,A,J){G||We({});const ge=Je(Ae),Pe=Je(A);return Ie(ge,Pe,J)},t.addHook=function(Ae,A){typeof A=="function"&&Ra(ie[Ae],A)},t.removeHook=function(Ae,A){if(A!==void 0){const J=qk(ie[Ae],A);return J===-1?void 0:Gk(ie[Ae],J,1)[0]}return Zu(ie[Ae])},t.removeHooks=function(Ae){ie[Ae]=[]},t.removeAllHooks=function(){ie=ip()},t}var lp=$m();function Xc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var _a=Xc();function Bm(e){_a=e}var Mi={exec:()=>null};function nt(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(as.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var as={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},fS=/^(?:[ \t]*(?:\n|$))+/,hS=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,mS=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,dl=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,vS=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ed=/(?:[*+-]|\d{1,9}[.)])/,Um=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Hm=nt(Um).replace(/bull/g,ed).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),gS=nt(Um).replace(/bull/g,ed).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),td=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,bS=/^[^\n]+/,sd=/(?!\s*\])(?:\\.|[^\[\]\\])+/,yS=nt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",sd).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),xS=nt(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ed).getRegex(),Ur="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",nd=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_S=nt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",nd).replace("tag",Ur).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),zm=nt(td).replace("hr",dl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ur).getRegex(),wS=nt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",zm).getRegex(),ad={blockquote:wS,code:hS,def:yS,fences:mS,heading:vS,hr:dl,html:_S,lheading:Hm,list:xS,newline:fS,paragraph:zm,table:Mi,text:bS},rp=nt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",dl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ur).getRegex(),kS={...ad,lheading:gS,table:rp,paragraph:nt(td).replace("hr",dl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",rp).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ur).getRegex()},SS={...ad,html:nt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",nd).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Mi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:nt(td).replace("hr",dl).replace("heading",` *#{1,6} *[^
...
`,e=e.substring(p.length+1),o=!0),!o){const R=this.rules.other.nextBulletRegex(m),S=this.rules.other.hrRegex(m),g=this.rules.other.fencesBeginRegex(m),x=this.rules.other.headingBeginRegex(m),C=this.rules.other.htmlBeginRegex(m);for(;e;){const v=e.split(`
`,1)[0];let w;if(p=v,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),w=p):w=p.replace(this.rules.other.tabCharGlobal,"    "),g.test(p)||x.test(p)||C.test(p)||R.test(p)||S.test(p))break;if(w.search(this.rules.other.nonSpaceChar)>=m||!p.trim())d+=`
`+w.slice(m);else{if(f||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||g.test(u)||x.test(u)||S.test(u))break;d+=`
`+p}!f&&!p.trim()&&(f=!0),c+=v+`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Js(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ma=new WS;function tt(e,t){return ma.parse(e,t)}tt.options=tt.setOptions=function(e){return ma.setOptions(e),tt.defaults=ma.defaults,Bm(tt.defaults),tt};tt.getDefaults=Xc;tt.defaults=_a;tt.use=function(...e){return ma.use(...e),tt.defaults=ma.defaults,Bm(tt.defaults),tt};tt.walkTokens=function(e,t){return ma.walkTokens(e,t)};tt.parseInline=ma.parseInline;tt.Parser=bn;tt.parser=bn.parse;tt.Renderer=ur;tt.TextRenderer=rd;tt.Lexer=gn;tt.lexer=gn.lex;tt.Tokenizer=dr;tt.Hooks=Pl;tt.parse=tt;tt.options;tt.setOptions;tt.use;tt.walkTokens;tt.parseInline;bn.parse;gn.lex;const ZS={breaks:!0,gfm:!0};function pp(e){if(!e)return"";try{if(typeof tt<"u"&&tt.parse){const t=tt.parse(e,ZS);return typeof lp<"u"?lp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function JS(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const YS={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function QS(e){return YS[e]||"wrench"}const XS=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function fp(e){if(!e)return[];const t=e.match(XS);return t?[...new Set(t)]:[]}const e1={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(""),a=h(null),i=h(null),l=h(0),r=h("");let o=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=Z(()=>t.value.trim().length>0&&!s.value),p=h(Ye.state||"disconnected");let f=null;const m=Z(()=>{const U=p.value;return U==="connected"?"Connected":U==="reconnecting"?"Reconnecting…":U==="connecting"?"Connecting…":"REST fallback"}),b=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],E=Z(()=>{const U=Math.floor(l.value/4)%b.length,D=l.value;return D>3?`${b[U]} (${D}s)`:b[0]});function R(){Ct(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function S(){if(!i.value)return;const U=i.value;U.style.height="auto",U.style.height=Math.min(U.scrollHeight,120)+"px"}function g(U,D,P={}){const L={id:++c,role:U,content:D,timestamp:Date.now(),html:U==="bot"?pp(D):"",tools_used:P.tools_used||[],is_error:P.is_error||!1,images:U==="bot"?fp(D):[],files:P.files||[],_showTools:!1};return e.value.push(L),R(),U==="bot"&&Ct(()=>x()),L}function x(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(D=>{D.setAttribute("data-copy","true"),D.style.position="relative";const P=document.createElement("button");P.className="chat-code-copy",P.textContent="Copy",P.addEventListener("click",()=>{const L=D.querySelector("code"),W=L?L.textContent:D.textContent;navigator.clipboard.writeText(W).then(()=>{P.textContent="Copied!",setTimeout(()=>{P.textContent="Copy"},1500)}).catch(()=>{})}),D.appendChild(P)})}function C(U){if(U===0)return!0;const D=e.value[U-1],P=e.value[U],L=new Date(D.timestamp).toDateString(),W=new Date(P.timestamp).toDateString();return L!==W}function v(U){const D=new Date(U),P=new Date;if(D.toDateString()===P.toDateString())return"Today";const L=new Date(P);return L.setDate(L.getDate()-1),D.toDateString()===L.toDateString()?"Yesterday":D.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function w(U){t.value=U,Ct(()=>V())}function T(U){window.open(U,"_blank","noopener")}function y(U){U.target.style.display="none"}function I(){l.value=0,o=setInterval(()=>{l.value++},1e3)}function $(){o&&(clearInterval(o),o=null),l.value=0}function F(U){s.value&&(s.value=!1,$(),U.type==="chat_response"?g("bot",U.content,{tools_used:U.tools_used||[],is_error:U.is_error||!1,files:U.files||[]}):U.type==="chat_error"&&g("bot",U.error||"Unknown error",{is_error:!0}),Ct(()=>{var D;return(D=i.value)==null?void 0:D.focus()}))}async function M(U){try{const D=await K.post("/api/chat",{content:U,channel_id:r.value});g("bot",D.response,{tools_used:D.tools_used||[],is_error:D.is_error||!1,files:D.files||[]})}catch(D){g("bot",D.message||"Failed to send message",{is_error:!0})}}async function V(){const U=t.value.trim();if(!U||s.value)return;g("user",U),t.value="",s.value=!0,I(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(U,{channelId:r.value})||(await M(U),s.value=!1,$()),Ct(()=>{var P;return(P=i.value)==null?void 0:P.focus()})}async function ne(){n.value="";try{if(!r.value){const D=await K.get("/api/auth/session");r.value=D.channel_id||D.user_id||"web-user"}const U=await K.get("/api/sessions/"+encodeURIComponent(r.value));if(U&&U.messages&&U.messages.length>0){for(const D of U.messages){const P=D.role==="user"?"user":"bot";let L=D.content||"";if(P==="user"){const ie=L.match(/^\[.*?\]:\s*/);ie&&(L=L.slice(ie[0].length))}if(!L.trim())continue;const W={id:++c,role:P,content:L,timestamp:D.timestamp?D.timestamp*1e3:Date.now(),html:P==="bot"?pp(L):"",tools_used:[],is_error:!1,images:P==="bot"?fp(L):[],files:[],_showTools:!1};e.value.push(W)}Ct(()=>{R(),x()})}}catch(U){U&&U.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",Oe.error(n.value))}}return Ke(()=>{Ye.subscribe("chat",F),p.value=Ye.state||"disconnected",f=Ye.onState(U=>{p.value=U}),ne(),Ct(()=>{var U;return(U=i.value)==null?void 0:U.focus()})}),_t(()=>{Ye.unsubscribe("chat",F),f&&(f(),f=null),$()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:E,suggestions:d,send:V,autoResize:S,formatTime:JS,formatDate:v,showDateSeparator:C,useSuggestion:w,openImage:T,onImageError:y,getToolIcon:QS,loadHistory:ne}}},t1={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),m=Z(()=>e.value==="custom"),b=Z(()=>[...i.value,...l.value]),E=Z(()=>l.value.includes(e.value)),R=Z(()=>{var T;return m.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),S=Z(()=>{var T;return m.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),g=Z(()=>{var T;return m.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function x(){d.value=!0;try{const T=await K.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{d.value=!1}}async function C(){r.value=!0,c.value=null,o.value=!1;try{await K.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(T){c.value=T.message}finally{r.value=!1}}async function v(){const T=u.value.trim();if(T){f.value=!0,c.value=null;try{await K.post("/api/personality/presets",{name:T,display_name:R.value,identity:S.value,voice:g.value}),p.value=!1,u.value="",await x(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(y){c.value=y.message}finally{f.value=!1}}}async function w(){if(await Jt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await K.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(y){c.value=y.message}}}return Ke(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:b,isCustom:m,isUserPreset:E,previewName:R,previewIdentity:S,previewVoice:g,saving:r,saved:o,error:c,loading:d,save:C,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:v,deletePreset:w,builtinPresets:i,userPresets:l}},template:`
  ...
  `},wt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Jm=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:Dk,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:e1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:vw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:kw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Vw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:t1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Rk,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:wt("/operations","live")},{path:"/agents",redirect:wt("/operations","agents")},{path:"/loops",redirect:wt("/operations","loops")},{path:"/processes",redirect:wt("/operations","processes")},{path:"/schedules",redirect:wt("/operations","schedules")},{path:"/audit",redirect:wt("/history","audit")},{path:"/sessions",redirect:wt("/history","sessions")},{path:"/traces",redirect:wt("/history","traces")},{path:"/usage",redirect:wt("/history","usage")},{path:"/tools",redirect:wt("/capabilities","tools")},{path:"/skills",redirect:wt("/capabilities","skills")},{path:"/mcp",redirect:wt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:wt("/capabilities","knowledge")},{path:"/memory",redirect:wt("/capabilities","memory")},{path:"/learned",redirect:wt("/capabilities","learned")},{path:"/health",redirect:wt("/system","health")},{path:"/resources",redirect:wt("/system","resources")},{path:"/logs",redirect:wt("/system","logs")},{path:"/config",redirect:wt("/system","config")},{path:"/host-access",redirect:wt("/system","host-access")},{path:"/internals",redirect:wt("/system","internals")}],Pi=tw({history:N_(),routes:Jm});Pi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const s1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),d=h("disconnected"),u=h(-1),p=h(null);let f=null;const m=h("starting"),b=h(""),E=Jm.filter(L=>L.meta),R=Z(()=>["Workspace","Operate","Observe","Manage"].map(L=>({name:L,routes:E.filter(W=>W.meta.section===L)})).filter(L=>L.routes.length)),S=Z(()=>{var L;return((L=Pi.currentRoute.value.meta)==null?void 0:L.label)||"Odin"}),g=Z(()=>{var L;return((L=Pi.currentRoute.value.meta)==null?void 0:L.section)||"Management"}),x=Z(()=>{var L;return((L=Pi.currentRoute.value.meta)==null?void 0:L.description)||"Management console"});function C(){Ye.disconnect(),V&&(clearInterval(V),V=null)}K.onSessionExpired=()=>{t.value=!0,C(),K.setToken(""),e.value="login"};function v(L){var W;if((L.ctrlKey||L.metaKey)&&L.key.toLowerCase()==="k"){e.value==="ready"&&(L.preventDefault(),qu());return}if(n.value&&L.key==="Tab"){const ie=[...((W=a.value)==null?void 0:W.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(ie.length){const te=ie[0],oe=ie[ie.length-1];if(L.shiftKey&&(document.activeElement===te||!a.value.contains(document.activeElement))){L.preventDefault(),oe.focus();return}if(!L.shiftKey&&(document.activeElement===oe||!a.value.contains(document.activeElement))){L.preventDefault(),te.focus();return}}}if(L.key==="Escape"&&n.value){n.value=!1,L.preventDefault();return}if(L.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(L.target.tagName)){L.preventDefault();const ie=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');ie&&ie.focus()}}function w(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Ke(async()=>{document.addEventListener("keydown",v),r=window.matchMedia("(max-width: 900px)"),w(),r.addEventListener("change",w);const L=await K.check();L.ok?(e.value="ready",D()):L.needsAuth?e.value="login":(e.value="ready",D())});function T(){t.value=!1,e.value="ready",D()}async function y(){C(),e.value="login",await K.logout()}function I(){s.value=!s.value}function $(){n.value=!n.value}is(n,async L=>{var W,ie;if(L)o=document.activeElement,await Ct(),(ie=(W=a.value)==null?void 0:W.querySelector(".nav-item"))==null||ie.focus();else if(o!=null&&o.isConnected){const te=o;o=null,requestAnimationFrame(()=>te.focus())}});const F=Z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(L,W="info",ie=3e3){p.value={text:L,level:W},clearTimeout(f),f=setTimeout(()=>{p.value=null},ie)}let V=null,ne=!1,U=[];function D(){for(const L of U)L();U=[Ye.onStatus(L=>{c.value=L}),Ye.onLatencyChange(L=>{u.value=L}),Ye.onState((L,W)=>{d.value=L,L==="connected"?(ne&&M("Connection restored","success"),ne=!0):L==="reconnecting"&&W.attempt===1&&M("Connection lost — reconnecting…","warn")})],Ye.connect(),P(),V&&clearInterval(V),V=setInterval(P,15e3)}async function P(){try{const L=await K.get("/api/status");m.value=L.status==="online"?"online":"starting";const W=L.uptime_seconds||0,ie=Math.floor(W/3600),te=Math.floor(W%3600/60);b.value=`${ie}h ${te}m uptime`}catch{m.value="offline",b.value=""}}return _t(()=>{V&&clearInterval(V);for(const L of U)L();U=[],Ye.disconnect(),document.removeEventListener("keydown",v),r==null||r.removeEventListener("change",w)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:F,wsToast:p,botStatus:m,botUptime:b,navRoutes:E,navGroups:R,currentPage:S,currentSection:g,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:T,logout:y,toggleSidebar:I,toggleMobileNavigation:$,openPalette:qu}}},Vn=Xl(n1);Vn.component("odin-icon",Nk);Vn.component("login-screen",s1);Vn.component("toast-container",K0);Vn.component("confirm-host",W0);Vn.component("command-palette",Lk);Vn.directive("modal-focus",Pk);Vn.use(Pi);Vn.mount("#app");
