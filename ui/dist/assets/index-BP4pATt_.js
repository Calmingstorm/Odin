var kg=Object.defineProperty;var wg=(e,t,s)=>t in e?kg(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var Ze=(e,t,s)=>wg(e,typeof t!="symbol"?t+"":t,s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();class Sg{constructor(){this._persist=localStorage.getItem("odin_persist")==="1",this._token=this._persist?localStorage.getItem("odin_token")||"":sessionStorage.getItem("odin_token")||"";const t=this._persist?localStorage:sessionStorage;this._sessionTimeout=parseInt(t.getItem("odin_session_timeout")||"0",10),this._lastActivity=Date.now(),this._activityTimer=null,this.onSessionExpired=null,this._token&&this._sessionTimeout>0&&this._startActivityMonitor()}get token(){return this._token}get sessionTimeout(){return this._sessionTimeout}setToken(t,s=0){if(this._token=t,this._sessionTimeout=s,this._lastActivity=Date.now(),t){const n=this._persist?localStorage:sessionStorage;n.setItem("odin_token",t),this._persist&&localStorage.setItem("odin_persist","1"),s>0?n.setItem("odin_session_timeout",String(s)):n.removeItem("odin_session_timeout"),this._startActivityMonitor()}else sessionStorage.removeItem("odin_token"),sessionStorage.removeItem("odin_session_timeout"),localStorage.removeItem("odin_token"),localStorage.removeItem("odin_persist"),localStorage.removeItem("odin_session_timeout"),this._stopActivityMonitor()}setPersist(t){this._persist=t}_startActivityMonitor(){this._stopActivityMonitor(),!(this._sessionTimeout<=0)&&(this._activityTimer=setInterval(()=>{(Date.now()-this._lastActivity)/1e3>=this._sessionTimeout&&(this._stopActivityMonitor(),this.onSessionExpired&&this.onSessionExpired())},1e4))}_stopActivityMonitor(){this._activityTimer&&(clearInterval(this._activityTimer),this._activityTimer=null)}_headers(t={}){const s={"Content-Type":"application/json",...t};return this._token&&(s.Authorization=`Bearer ${this._token}`),s}async _request(t,s,n=null){this._lastActivity=Date.now();const a={method:t,headers:this._headers()};n!==null&&(a.body=JSON.stringify(n));const i=await fetch(s,a);if(i.status===401)throw new hr("Unauthorized");const l=await i.json().catch(()=>null);if(!i.ok){const r=(l==null?void 0:l.error)||`HTTP ${i.status}`;throw new Tg(r,i.status,l)}return l}get(t){return this._request("GET",t)}post(t,s){return this._request("POST",t,s)}put(t,s){return this._request("PUT",t,s)}del(t){return this._request("DELETE",t)}async login(t){const s=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})}),n=await s.json().catch(()=>null);if(!s.ok)throw new hr((n==null?void 0:n.error)||"Login failed");return this.setToken(n.session_id,n.timeout_seconds||0),n}async logout(){try{await this.post("/api/auth/logout",{})}catch{}this.setToken("")}async check(){try{return await this.get("/api/status"),{ok:!0,needsAuth:!1}}catch(t){return t instanceof hr?{ok:!1,needsAuth:!0}:{ok:!1,needsAuth:!1,error:t.message}}}}class hr extends Error{constructor(t){super(t),this.name="AuthError"}}class Tg extends Error{constructor(t,s,n){super(t),this.name="ApiError",this.status=s,this.data=n}}class Cg{constructor(t){this._api=t,this._ws=null,this._handlers={logs:[],events:[],chat:[]},this._reconnectDelay=1e3,this._maxReconnectDelay=3e4,this._shouldConnect=!1,this._subscriptions=new Set,this._reconnectAttempt=0,this._lastPongTime=0,this._pingInterval=null,this._latency=-1,this._state="disconnected",this.onStatusChange=null,this.onStateChange=null}get connected(){var t;return((t=this._ws)==null?void 0:t.readyState)===WebSocket.OPEN}get state(){return this._state}get reconnectAttempt(){return this._reconnectAttempt}get latency(){return this._latency}connect(){this._shouldConnect=!0,this._setState("connecting"),this._open()}disconnect(){this._shouldConnect=!1,this._reconnectAttempt=0,this._latency=-1,this._stopPing(),this._ws&&(this._ws.close(),this._ws=null),this._setState("disconnected")}_setState(t){this._state!==t&&(this._state=t,this.onStateChange&&this.onStateChange(t,{attempt:this._reconnectAttempt,latency:this._latency}))}_startPing(){this._stopPing(),this._pingInterval=setInterval(()=>{if(this.connected)try{this._ws.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}},15e3)}_stopPing(){this._pingInterval&&(clearInterval(this._pingInterval),this._pingInterval=null)}subscribe(t,s){this._handlers[t]||(this._handlers[t]=[]),this._handlers[t].push(s),t!=="chat"&&(this._subscriptions.add(t),this.connected&&this._ws.send(JSON.stringify({subscribe:t})))}unsubscribe(t,s){const n=this._handlers[t];if(n){const a=n.indexOf(s);a>=0&&n.splice(a,1),n.length===0&&t!=="chat"&&(this._subscriptions.delete(t),this.connected&&this._ws.send(JSON.stringify({unsubscribe:t})))}}on(t,s){return this.subscribe(t,s)}off(t,s){return this.unsubscribe(t,s)}sendChat(t,{channelId:s,userId:n,username:a}={}){return this.connected?(this._ws.send(JSON.stringify({type:"chat",content:t,channel_id:s||"web-default",user_id:n||void 0,username:a||void 0})),!0):!1}_open(){if(this._ws)return;let s=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/api/ws`;this._api.token&&(s+=`?token=${encodeURIComponent(this._api.token)}`),this._ws=new WebSocket(s),this._ws.onopen=()=>{this._reconnectDelay=1e3,this._reconnectAttempt=0;for(const n of this._subscriptions)this._ws.send(JSON.stringify({subscribe:n}));this._startPing(),this._setState("connected"),this.onStatusChange&&this.onStatusChange(!0)},this._ws.onmessage=n=>{let a;try{a=JSON.parse(n.data)}catch{return}const i=a.type;if(i==="pong"){a.ts&&(this._latency=Date.now()-a.ts,this._lastPongTime=Date.now());return}if(i==="log")for(const l of this._handlers.logs||[])l(a);else if(i==="event")for(const l of this._handlers.events||[])l(a);else if(i==="chat_response"||i==="chat_error")for(const l of this._handlers.chat||[])l(a)},this._ws.onclose=()=>{this._ws=null,this._stopPing(),this._latency=-1,this.onStatusChange&&this.onStatusChange(!1),this._shouldConnect?(this._reconnectAttempt++,this._setState("reconnecting"),setTimeout(()=>this._open(),this._reconnectDelay),this._reconnectDelay=Math.min(this._reconnectDelay*2,this._maxReconnectDelay)):this._setState("disconnected")},this._ws.onerror=()=>{}}}const K=new Sg,qe=new Cg(K);/**
* @vue/shared v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function ls(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const Me={},la=[],Nt=()=>{},aa=()=>!1,Bn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Pl=e=>e.startsWith("onUpdate:"),Oe=Object.assign,To=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Eg=Object.prototype.hasOwnProperty,He=(e,t)=>Eg.call(e,t),fe=Array.isArray,ra=e=>Ea(e)==="[object Map]",Hn=e=>Ea(e)==="[object Set]",Zc=e=>Ea(e)==="[object Date]",Ag=e=>Ea(e)==="[object RegExp]",_e=e=>typeof e=="function",Te=e=>typeof e=="string",Ut=e=>typeof e=="symbol",Be=e=>e!==null&&typeof e=="object",Co=e=>(Be(e)||_e(e))&&_e(e.then)&&_e(e.catch),Gd=Object.prototype.toString,Ea=e=>Gd.call(e),Rg=e=>Ea(e).slice(8,-1),Fl=e=>Ea(e)==="[object Object]",$l=e=>Te(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Ks=ls(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ig=ls("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),Ul=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Ng=/-\w/g,Ge=Ul(e=>e.replace(Ng,t=>t.slice(1).toUpperCase())),Lg=/\B([A-Z])/g,Qt=Ul(e=>e.replace(Lg,"-$1").toLowerCase()),Vn=Ul(e=>e.charAt(0).toUpperCase()+e.slice(1)),oa=Ul(e=>e?`on${Vn(e)}`:""),wt=(e,t)=>!Object.is(e,t),ca=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},Wd=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Bl=e=>{const t=parseFloat(e);return isNaN(t)?e:t},ll=e=>{const t=Te(e)?Number(e):NaN;return isNaN(t)?e:t};let Jc;const Hl=()=>Jc||(Jc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Og(e,t){return e+JSON.stringify(t,(s,n)=>typeof n=="function"?n.toString():n)}const Dg="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol",Mg=ls(Dg);function ki(e){if(fe(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],a=Te(n)?Zd(n):ki(n);if(a)for(const i in a)t[i]=a[i]}return t}else if(Te(e)||Be(e))return e}const Pg=/;(?![^(]*\))/g,Fg=/:([^]+)/,$g=/\/\*[^]*?\*\//g;function Zd(e){const t={};return e.replace($g,"").split(Pg).forEach(s=>{if(s){const n=s.split(Fg);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function wi(e){let t="";if(Te(e))t=e;else if(fe(e))for(let s=0;s<e.length;s++){const n=wi(e[s]);n&&(t+=n+" ")}else if(Be(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function Ug(e){if(!e)return null;let{class:t,style:s}=e;return t&&!Te(t)&&(e.class=wi(t)),s&&(e.style=ki(s)),e}const Bg="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",Hg="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",Vg="annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics",jg="area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr",zg=ls(Bg),qg=ls(Hg),Kg=ls(Vg),Gg=ls(jg),Wg="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Zg=ls(Wg);function Jd(e){return!!e||e===""}function Jg(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=Js(e[n],t[n]);return s}function Js(e,t){if(e===t)return!0;let s=Zc(e),n=Zc(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=Ut(e),n=Ut(t),s||n)return e===t;if(s=fe(e),n=fe(t),s||n)return s&&n?Jg(e,t):!1;if(s=Be(e),n=Be(t),s||n){if(!s||!n)return!1;const a=Object.keys(e).length,i=Object.keys(t).length;if(a!==i)return!1;for(const l in e){const r=e.hasOwnProperty(l),o=t.hasOwnProperty(l);if(r&&!o||!r&&o||!Js(e[l],t[l]))return!1}}return String(e)===String(t)}function Vl(e,t){return e.findIndex(s=>Js(s,t))}const Yd=e=>!!(e&&e.__v_isRef===!0),Qd=e=>Te(e)?e:e==null?"":fe(e)||Be(e)&&(e.toString===Gd||!_e(e.toString))?Yd(e)?Qd(e.value):JSON.stringify(e,Xd,2):String(e),Xd=(e,t)=>Yd(t)?Xd(e,t.value):ra(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,a],i)=>(s[gr(n,i)+" =>"]=a,s),{})}:Hn(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>gr(s))}:Ut(t)?gr(t):Be(t)&&!fe(t)&&!Fl(t)?String(t):t,gr=(e,t="")=>{var s;return Ut(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};function Yg(e){return e==null?"initial":typeof e=="string"?e===""?" ":e:String(e)}/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let xt;class Eo{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&xt&&(xt.active?(this.parent=xt,this.index=(xt.scopes||(xt.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=xt;try{return xt=this,t()}finally{xt=s}}}on(){++this._on===1&&(this.prevScope=xt,xt=this)}off(){if(this._on>0&&--this._on===0){if(xt===this)xt=this.prevScope;else{let t=xt;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0}}}function Qg(e){return new Eo(e)}function ef(){return xt}function Xg(e,t=!1){xt&&xt.cleanups.push(e)}let Xe;const mr=new WeakSet;class ai{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,xt&&(xt.active?xt.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,mr.has(this)&&(mr.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||sf(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Yc(this),nf(this);const t=Xe,s=bs;Xe=this,bs=!0;try{return this.fn()}finally{af(this),Xe=t,bs=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Io(t);this.deps=this.depsTail=void 0,Yc(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?mr.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){jr(this)&&this.run()}get dirty(){return jr(this)}}let tf=0,Wa,Za;function sf(e,t=!1){if(e.flags|=8,t){e.next=Za,Za=e;return}e.next=Wa,Wa=e}function Ao(){tf++}function Ro(){if(--tf>0)return;if(Za){let t=Za;for(Za=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;Wa;){let t=Wa;for(Wa=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function nf(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function af(e){let t,s=e.depsTail,n=s;for(;n;){const a=n.prevDep;n.version===-1?(n===s&&(s=a),Io(n),em(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=a}e.deps=t,e.depsTail=s}function jr(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(lf(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function lf(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===ii)||(e.globalVersion=ii,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!jr(e))))return;e.flags|=2;const t=e.dep,s=Xe,n=bs;Xe=e,bs=!0;try{nf(e);const a=e.fn(e._value);(t.version===0||wt(a,e._value))&&(e.flags|=128,e._value=a,t.version++)}catch(a){throw t.version++,a}finally{Xe=s,bs=n,af(e),e.flags&=-3}}function Io(e,t=!1){const{dep:s,prevSub:n,nextSub:a}=e;if(n&&(n.nextSub=a,e.prevSub=void 0),a&&(a.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let i=s.computed.deps;i;i=i.nextDep)Io(i,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function em(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}function tm(e,t){e.effect instanceof ai&&(e=e.effect.fn);const s=new ai(e);t&&Oe(s,t);try{s.run()}catch(a){throw s.stop(),a}const n=s.run.bind(s);return n.effect=s,n}function sm(e){e.effect.stop()}let bs=!0;const rf=[];function Ys(){rf.push(bs),bs=!1}function Qs(){const e=rf.pop();bs=e===void 0?!0:e}function Yc(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=Xe;Xe=void 0;try{t()}finally{Xe=s}}}let ii=0;class nm{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class jl{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!Xe||!bs||Xe===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==Xe)s=this.activeLink=new nm(Xe,this),Xe.deps?(s.prevDep=Xe.depsTail,Xe.depsTail.nextDep=s,Xe.depsTail=s):Xe.deps=Xe.depsTail=s,of(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=Xe.depsTail,s.nextDep=void 0,Xe.depsTail.nextDep=s,Xe.depsTail=s,Xe.deps===s&&(Xe.deps=n)}return s}trigger(t){this.version++,ii++,this.notify(t)}notify(t){Ao();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Ro()}}}function of(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)of(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const rl=new WeakMap,In=Symbol(""),zr=Symbol(""),li=Symbol("");function Pt(e,t,s){if(bs&&Xe){let n=rl.get(e);n||rl.set(e,n=new Map);let a=n.get(s);a||(n.set(s,a=new jl),a.map=n,a.key=s),a.track()}}function Hs(e,t,s,n,a,i){const l=rl.get(e);if(!l){ii++;return}const r=o=>{o&&o.trigger()};if(Ao(),t==="clear")l.forEach(r);else{const o=fe(e),c=o&&$l(s);if(o&&s==="length"){const u=Number(n);l.forEach((d,f)=>{(f==="length"||f===li||!Ut(f)&&f>=u)&&r(d)})}else switch((s!==void 0||l.has(void 0))&&r(l.get(s)),c&&r(l.get(li)),t){case"add":o?c&&r(l.get("length")):(r(l.get(In)),ra(e)&&r(l.get(zr)));break;case"delete":o||(r(l.get(In)),ra(e)&&r(l.get(zr)));break;case"set":ra(e)&&r(l.get(In));break}}Ro()}function am(e,t){const s=rl.get(e);return s&&s.get(t)}function Zn(e){const t=Fe(e);return t===e?t:(Pt(t,"iterate",li),es(e)?t:t.map(xs))}function zl(e){return Pt(e=Fe(e),"iterate",li),e}function As(e,t){return Is(e)?ga(Gs(e)?xs(t):t):xs(t)}const im={__proto__:null,[Symbol.iterator](){return vr(this,Symbol.iterator,e=>As(this,e))},concat(...e){return Zn(this).concat(...e.map(t=>fe(t)?Zn(t):t))},entries(){return vr(this,"entries",e=>(e[1]=As(this,e[1]),e))},every(e,t){return Os(this,"every",e,t,void 0,arguments)},filter(e,t){return Os(this,"filter",e,t,s=>s.map(n=>As(this,n)),arguments)},find(e,t){return Os(this,"find",e,t,s=>As(this,s),arguments)},findIndex(e,t){return Os(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return Os(this,"findLast",e,t,s=>As(this,s),arguments)},findLastIndex(e,t){return Os(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return Os(this,"forEach",e,t,void 0,arguments)},includes(...e){return br(this,"includes",e)},indexOf(...e){return br(this,"indexOf",e)},join(e){return Zn(this).join(e)},lastIndexOf(...e){return br(this,"lastIndexOf",e)},map(e,t){return Os(this,"map",e,t,void 0,arguments)},pop(){return Da(this,"pop")},push(...e){return Da(this,"push",e)},reduce(e,...t){return Qc(this,"reduce",e,t)},reduceRight(e,...t){return Qc(this,"reduceRight",e,t)},shift(){return Da(this,"shift")},some(e,t){return Os(this,"some",e,t,void 0,arguments)},splice(...e){return Da(this,"splice",e)},toReversed(){return Zn(this).toReversed()},toSorted(e){return Zn(this).toSorted(e)},toSpliced(...e){return Zn(this).toSpliced(...e)},unshift(...e){return Da(this,"unshift",e)},values(){return vr(this,"values",e=>As(this,e))}};function vr(e,t,s){const n=zl(e),a=n[t]();return n!==e&&!es(e)&&(a._next=a.next,a.next=()=>{const i=a._next();return i.done||(i.value=s(i.value)),i}),a}const lm=Array.prototype;function Os(e,t,s,n,a,i){const l=zl(e),r=l!==e&&!es(e),o=l[t];if(o!==lm[t]){const d=o.apply(e,i);return r?xs(d):d}let c=s;l!==e&&(r?c=function(d,f){return s.call(this,As(e,d),f,e)}:s.length>2&&(c=function(d,f){return s.call(this,d,f,e)}));const u=o.call(l,c,n);return r&&a?a(u):u}function Qc(e,t,s,n){const a=zl(e),i=a!==e&&!es(e);let l=s,r=!1;a!==e&&(i?(r=n.length===0,l=function(c,u,d){return r&&(r=!1,c=As(e,c)),s.call(this,c,As(e,u),d,e)}):s.length>3&&(l=function(c,u,d){return s.call(this,c,u,d,e)}));const o=a[t](l,...n);return r?As(e,o):o}function br(e,t,s){const n=Fe(e);Pt(n,"iterate",li);const a=n[t](...s);return(a===-1||a===!1)&&Si(s[0])?(s[0]=Fe(s[0]),n[t](...s)):a}function Da(e,t,s=[]){Ys(),Ao();const n=Fe(e)[t].apply(e,s);return Ro(),Qs(),n}const rm=ls("__proto__,__v_isRef,__isVue"),cf=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Ut));function om(e){Ut(e)||(e=String(e));const t=Fe(this);return Pt(t,"has",e),t.hasOwnProperty(e)}class uf{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const a=this._isReadonly,i=this._isShallow;if(s==="__v_isReactive")return!a;if(s==="__v_isReadonly")return a;if(s==="__v_isShallow")return i;if(s==="__v_raw")return n===(a?i?mf:gf:i?hf:pf).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const l=fe(t);if(!a){let o;if(l&&(o=im[s]))return o;if(s==="hasOwnProperty")return om}const r=Reflect.get(t,s,mt(t)?t:n);if((Ut(s)?cf.has(s):rm(s))||(a||Pt(t,"get",s),i))return r;if(mt(r)){const o=l&&$l(s)?r:r.value;return a&&Be(o)?ol(o):o}return Be(r)?a?ol(r):bn(r):r}}class df extends uf{constructor(t=!1){super(!1,t)}set(t,s,n,a){let i=t[s];const l=fe(t)&&$l(s);if(!this._isShallow){const c=Is(i);if(!es(n)&&!Is(n)&&(i=Fe(i),n=Fe(n)),!l&&mt(i)&&!mt(n))return c||(i.value=n),!0}const r=l?Number(s)<t.length:He(t,s),o=Reflect.set(t,s,n,mt(t)?t:a);return t===Fe(a)&&(r?wt(n,i)&&Hs(t,"set",s,n):Hs(t,"add",s,n)),o}deleteProperty(t,s){const n=He(t,s);t[s];const a=Reflect.deleteProperty(t,s);return a&&n&&Hs(t,"delete",s,void 0),a}has(t,s){const n=Reflect.has(t,s);return(!Ut(s)||!cf.has(s))&&Pt(t,"has",s),n}ownKeys(t){return Pt(t,"iterate",fe(t)?"length":In),Reflect.ownKeys(t)}}class ff extends uf{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const cm=new df,um=new ff,dm=new df(!0),fm=new ff(!0),qr=e=>e,$i=e=>Reflect.getPrototypeOf(e);function pm(e,t,s){return function(...n){const a=this.__v_raw,i=Fe(a),l=ra(i),r=e==="entries"||e===Symbol.iterator&&l,o=e==="keys"&&l,c=a[e](...n),u=s?qr:t?ga:xs;return!t&&Pt(i,"iterate",o?zr:In),Oe(Object.create(c),{next(){const{value:d,done:f}=c.next();return f?{value:d,done:f}:{value:r?[u(d[0]),u(d[1])]:u(d),done:f}}})}}function Ui(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function hm(e,t){const s={get(a){const i=this.__v_raw,l=Fe(i),r=Fe(a);e||(wt(a,r)&&Pt(l,"get",a),Pt(l,"get",r));const{has:o}=$i(l),c=t?qr:e?ga:xs;if(o.call(l,a))return c(i.get(a));if(o.call(l,r))return c(i.get(r));i!==l&&i.get(a)},get size(){const a=this.__v_raw;return!e&&Pt(Fe(a),"iterate",In),a.size},has(a){const i=this.__v_raw,l=Fe(i),r=Fe(a);return e||(wt(a,r)&&Pt(l,"has",a),Pt(l,"has",r)),a===r?i.has(a):i.has(a)||i.has(r)},forEach(a,i){const l=this,r=l.__v_raw,o=Fe(r),c=t?qr:e?ga:xs;return!e&&Pt(o,"iterate",In),r.forEach((u,d)=>a.call(i,c(u),c(d),l))}};return Oe(s,e?{add:Ui("add"),set:Ui("set"),delete:Ui("delete"),clear:Ui("clear")}:{add(a){const i=Fe(this),l=$i(i),r=Fe(a),o=!t&&!es(a)&&!Is(a)?r:a;return l.has.call(i,o)||wt(a,o)&&l.has.call(i,a)||wt(r,o)&&l.has.call(i,r)||(i.add(o),Hs(i,"add",o,o)),this},set(a,i){!t&&!es(i)&&!Is(i)&&(i=Fe(i));const l=Fe(this),{has:r,get:o}=$i(l);let c=r.call(l,a);c||(a=Fe(a),c=r.call(l,a));const u=o.call(l,a);return l.set(a,i),c?wt(i,u)&&Hs(l,"set",a,i):Hs(l,"add",a,i),this},delete(a){const i=Fe(this),{has:l,get:r}=$i(i);let o=l.call(i,a);o||(a=Fe(a),o=l.call(i,a)),r&&r.call(i,a);const c=i.delete(a);return o&&Hs(i,"delete",a,void 0),c},clear(){const a=Fe(this),i=a.size!==0,l=a.clear();return i&&Hs(a,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(a=>{s[a]=pm(a,e,t)}),s}function ql(e,t){const s=hm(e,t);return(n,a,i)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?n:Reflect.get(He(s,a)&&a in n?s:n,a,i)}const gm={get:ql(!1,!1)},mm={get:ql(!1,!0)},vm={get:ql(!0,!1)},bm={get:ql(!0,!0)},pf=new WeakMap,hf=new WeakMap,gf=new WeakMap,mf=new WeakMap;function ym(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function bn(e){return Is(e)?e:Kl(e,!1,cm,gm,pf)}function No(e){return Kl(e,!1,dm,mm,hf)}function ol(e){return Kl(e,!0,um,vm,gf)}function xm(e){return Kl(e,!0,fm,bm,mf)}function Kl(e,t,s,n,a){if(!Be(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const i=a.get(e);if(i)return i;const l=ym(Rg(e));if(l===0)return e;const r=new Proxy(e,l===2?n:s);return a.set(e,r),r}function Gs(e){return Is(e)?Gs(e.__v_raw):!!(e&&e.__v_isReactive)}function Is(e){return!!(e&&e.__v_isReadonly)}function es(e){return!!(e&&e.__v_isShallow)}function Si(e){return e?!!e.__v_raw:!1}function Fe(e){const t=e&&e.__v_raw;return t?Fe(t):e}function vf(e){return!He(e,"__v_skip")&&Object.isExtensible(e)&&Wd(e,"__v_skip",!0),e}const xs=e=>Be(e)?bn(e):e,ga=e=>Be(e)?ol(e):e;function mt(e){return e?e.__v_isRef===!0:!1}function h(e){return bf(e,!1)}function Lo(e){return bf(e,!0)}function bf(e,t){return mt(e)?e:new _m(e,t)}class _m{constructor(t,s){this.dep=new jl,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:Fe(t),this._value=s?t:xs(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||es(t)||Is(t);t=n?t:Fe(t),wt(t,s)&&(this._rawValue=t,this._value=n?t:xs(t),this.dep.trigger())}}function km(e){e.dep&&e.dep.trigger()}function Rs(e){return mt(e)?e.value:e}function wm(e){return _e(e)?e():Rs(e)}const Sm={get:(e,t,s)=>t==="__v_raw"?e:Rs(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const a=e[t];return mt(a)&&!mt(s)?(a.value=s,!0):Reflect.set(e,t,s,n)}};function Oo(e){return Gs(e)?e:new Proxy(e,Sm)}class Tm{constructor(t){this.__v_isRef=!0,this._value=void 0;const s=this.dep=new jl,{get:n,set:a}=t(s.track.bind(s),s.trigger.bind(s));this._get=n,this._set=a}get value(){return this._value=this._get()}set value(t){this._set(t)}}function yf(e){return new Tm(e)}function Cm(e){const t=fe(e)?new Array(e.length):{};for(const s in e)t[s]=xf(e,s);return t}class Em{constructor(t,s,n){this._object=t,this._defaultValue=n,this.__v_isRef=!0,this._value=void 0,this._key=Ut(s)?s:String(s),this._raw=Fe(t);let a=!0,i=t;if(!fe(t)||Ut(this._key)||!$l(this._key))do a=!Si(i)||es(i);while(a&&(i=i.__v_raw));this._shallow=a}get value(){let t=this._object[this._key];return this._shallow&&(t=Rs(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&mt(this._raw[this._key])){const s=this._object[this._key];if(mt(s)){s.value=t;return}}this._object[this._key]=t}get dep(){return am(this._raw,this._key)}}class Am{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function Rm(e,t,s){return mt(e)?e:_e(e)?new Am(e):Be(e)&&arguments.length>1?xf(e,t,s):h(e)}function xf(e,t,s){return new Em(e,t,s)}class Im{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new jl(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=ii-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&Xe!==this)return sf(this,!0),!0}get value(){const t=this.dep.track();return lf(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Nm(e,t,s=!1){let n,a;return _e(e)?n=e:(n=e.get,a=e.set),new Im(n,a,s)}const Lm={GET:"get",HAS:"has",ITERATE:"iterate"},Om={SET:"set",ADD:"add",DELETE:"delete",CLEAR:"clear"},Bi={},cl=new WeakMap;let dn;function Dm(){return dn}function _f(e,t=!1,s=dn){if(s){let n=cl.get(s);n||cl.set(s,n=[]),n.push(e)}}function Mm(e,t,s=Me){const{immediate:n,deep:a,once:i,scheduler:l,augmentJob:r,call:o}=s,c=x=>a?x:es(x)||a===!1||a===0?Vs(x,1):Vs(x);let u,d,f,p,m=!1,g=!1;if(mt(e)?(d=()=>e.value,m=es(e)):Gs(e)?(d=()=>c(e),m=!0):fe(e)?(g=!0,m=e.some(x=>Gs(x)||es(x)),d=()=>e.map(x=>{if(mt(x))return x.value;if(Gs(x))return c(x);if(_e(x))return o?o(x,2):x()})):_e(e)?t?d=o?()=>o(e,2):e:d=()=>{if(f){Ys();try{f()}finally{Qs()}}const x=dn;dn=u;try{return o?o(e,3,[p]):e(p)}finally{dn=x}}:d=Nt,t&&a){const x=d,R=a===!0?1/0:a;d=()=>Vs(x(),R)}const w=ef(),A=()=>{u.stop(),w&&w.active&&To(w.effects,u)};if(i&&t){const x=t;t=(...R)=>{const L=x(...R);return A(),L}}let b=g?new Array(e.length).fill(Bi):Bi;const v=x=>{if(!(!(u.flags&1)||!u.dirty&&!x))if(t){const R=u.run();if(x||a||m||(g?R.some((L,O)=>wt(L,b[O])):wt(R,b))){f&&f();const L=dn;dn=u;try{const O=[R,b===Bi?void 0:g&&b[0]===Bi?[]:b,p];b=R,o?o(t,3,O):t(...O)}finally{dn=L}}}else u.run()};return r&&r(v),u=new ai(d),u.scheduler=l?()=>l(v,!1):v,p=x=>_f(x,!1,u),f=u.onStop=()=>{const x=cl.get(u);if(x){if(o)o(x,4);else for(const R of x)R();cl.delete(u)}},t?n?v(!0):b=u.run():l?l(v.bind(null,!0),!0):u.run(),A.pause=u.pause.bind(u),A.resume=u.resume.bind(u),A.stop=A,A}function Vs(e,t=1/0,s){if(t<=0||!Be(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,mt(e))Vs(e.value,t,s);else if(fe(e))for(let n=0;n<e.length;n++)Vs(e[n],t,s);else if(Hn(e)||ra(e))e.forEach(n=>{Vs(n,t,s)});else if(Fl(e)){for(const n in e)Vs(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&Vs(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const kf=[];function Pm(e){kf.push(e)}function Fm(){kf.pop()}function $m(e,t){}const Um={SETUP_FUNCTION:0,0:"SETUP_FUNCTION",RENDER_FUNCTION:1,1:"RENDER_FUNCTION",NATIVE_EVENT_HANDLER:5,5:"NATIVE_EVENT_HANDLER",COMPONENT_EVENT_HANDLER:6,6:"COMPONENT_EVENT_HANDLER",VNODE_HOOK:7,7:"VNODE_HOOK",DIRECTIVE_HOOK:8,8:"DIRECTIVE_HOOK",TRANSITION_HOOK:9,9:"TRANSITION_HOOK",APP_ERROR_HANDLER:10,10:"APP_ERROR_HANDLER",APP_WARN_HANDLER:11,11:"APP_WARN_HANDLER",FUNCTION_REF:12,12:"FUNCTION_REF",ASYNC_COMPONENT_LOADER:13,13:"ASYNC_COMPONENT_LOADER",SCHEDULER:14,14:"SCHEDULER",COMPONENT_UPDATE:15,15:"COMPONENT_UPDATE",APP_UNMOUNT_CLEANUP:16,16:"APP_UNMOUNT_CLEANUP"},Bm={sp:"serverPrefetch hook",bc:"beforeCreate hook",c:"created hook",bm:"beforeMount hook",m:"mounted hook",bu:"beforeUpdate hook",u:"updated",bum:"beforeUnmount hook",um:"unmounted hook",a:"activated hook",da:"deactivated hook",ec:"errorCaptured hook",rtc:"renderTracked hook",rtg:"renderTriggered hook",0:"setup function",1:"render function",2:"watcher getter",3:"watcher callback",4:"watcher cleanup function",5:"native event handler",6:"component event handler",7:"vnode hook",8:"directive hook",9:"transition hook",10:"app errorHandler",11:"app warnHandler",12:"ref function",13:"async component loader",14:"scheduler flush",15:"component update",16:"app unmount cleanup function"};function Aa(e,t,s,n){try{return n?e(...n):e()}catch(a){jn(a,t,s)}}function as(e,t,s,n){if(_e(e)){const a=Aa(e,t,s,n);return a&&Co(a)&&a.catch(i=>{jn(i,t,s)}),a}if(fe(e)){const a=[];for(let i=0;i<e.length;i++)a.push(as(e[i],t,s,n));return a}}function jn(e,t,s,n=!0){const a=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=t&&t.appContext.config||Me;if(t){let r=t.parent;const o=t.proxy,c=`https://vuejs.org/error-reference/#runtime-${s}`;for(;r;){const u=r.ec;if(u){for(let d=0;d<u.length;d++)if(u[d](e,o,c)===!1)return}r=r.parent}if(i){Ys(),Aa(i,null,10,[e,o,c]),Qs();return}}Hm(e,s,a,n,l)}function Hm(e,t,s,n=!0,a=!1){if(a)throw e;console.error(e)}const jt=[];let Cs=-1;const ua=[];let fn=null,ea=0;const wf=Promise.resolve();let ul=null;function St(e){const t=ul||wf;return e?t.then(this?e.bind(this):e):t}function Vm(e){let t=Cs+1,s=jt.length;for(;t<s;){const n=t+s>>>1,a=jt[n],i=oi(a);i<e||i===e&&a.flags&2?t=n+1:s=n}return t}function Do(e){if(!(e.flags&1)){const t=oi(e),s=jt[jt.length-1];!s||!(e.flags&2)&&t>=oi(s)?jt.push(e):jt.splice(Vm(t),0,e),e.flags|=1,Sf()}}function Sf(){ul||(ul=wf.then(Tf))}function ri(e){fe(e)?ua.push(...e):fn&&e.id===-1?fn.splice(ea+1,0,e):e.flags&1||(ua.push(e),e.flags|=1),Sf()}function Xc(e,t,s=Cs+1){for(;s<jt.length;s++){const n=jt[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;jt.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function dl(e){if(ua.length){const t=[...new Set(ua)].sort((s,n)=>oi(s)-oi(n));if(ua.length=0,fn){fn.push(...t);return}for(fn=t,ea=0;ea<fn.length;ea++){const s=fn[ea];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}fn=null,ea=0}}const oi=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Tf(e){try{for(Cs=0;Cs<jt.length;Cs++){const t=jt[Cs];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Aa(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Cs<jt.length;Cs++){const t=jt[Cs];t&&(t.flags&=-2)}Cs=-1,jt.length=0,dl(),ul=null,(jt.length||ua.length)&&Tf()}}let ta,Hi=[];function Cf(e,t){var s,n;ta=e,ta?(ta.enabled=!0,Hi.forEach(({event:a,args:i})=>ta.emit(a,...i)),Hi=[]):typeof window<"u"&&window.HTMLElement&&!((n=(s=window.navigator)==null?void 0:s.userAgent)!=null&&n.includes("jsdom"))?((t.__VUE_DEVTOOLS_HOOK_REPLAY__=t.__VUE_DEVTOOLS_HOOK_REPLAY__||[]).push(i=>{Cf(i,t)}),setTimeout(()=>{ta||(t.__VUE_DEVTOOLS_HOOK_REPLAY__=null,Hi=[])},3e3)):Hi=[]}let It=null,Gl=null;function ci(e){const t=It;return It=e,Gl=e&&e.type.__scopeId||null,t}function jm(e){Gl=e}function zm(){Gl=null}const qm=e=>Mo;function Mo(e,t=It,s){if(!t||e._n)return e;const n=(...a)=>{n._d&&pi(-1);const i=ci(t);let l;try{l=e(...a)}finally{ci(i),n._d&&pi(1)}return l};return n._n=!0,n._c=!0,n._d=!0,n}function Km(e,t){if(It===null)return e;const s=Ai(It),n=e.dirs||(e.dirs=[]);for(let a=0;a<t.length;a++){let[i,l,r,o=Me]=t[a];i&&(_e(i)&&(i={mounted:i,updated:i}),i.deep&&Vs(l),n.push({dir:i,instance:s,value:l,oldValue:void 0,arg:r,modifiers:o}))}return e}function Es(e,t,s,n){const a=e.dirs,i=t&&t.dirs;for(let l=0;l<a.length;l++){const r=a[l];i&&(r.oldValue=i[l].value);let o=r.dir[n];o&&(Ys(),as(o,s,8,[e.el,r,e,t]),Qs())}}function Ja(e,t){if(Rt){let s=Rt.provides;const n=Rt.parent&&Rt.parent.provides;n===s&&(s=Rt.provides=Object.create(n)),s[e]=t}}function fs(e,t,s=!1){const n=qt();if(n||Nn){let a=Nn?Nn._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(a&&e in a)return a[e];if(arguments.length>1)return s&&_e(t)?t.call(n&&n.proxy):t}}function Gm(){return!!(qt()||Nn)}const Ef=Symbol.for("v-scx"),Af=()=>fs(Ef);function Wm(e,t){return Ti(e,null,t)}function Zm(e,t){return Ti(e,null,{flush:"post"})}function Rf(e,t){return Ti(e,null,{flush:"sync"})}function ns(e,t,s){return Ti(e,t,s)}function Ti(e,t,s=Me){const{immediate:n,deep:a,flush:i,once:l}=s,r=Oe({},s),o=t&&n||!t&&i!=="post";let c;if(Fn){if(i==="sync"){const p=Af();c=p.__watcherHandles||(p.__watcherHandles=[])}else if(!o){const p=()=>{};return p.stop=Nt,p.resume=Nt,p.pause=Nt,p}}const u=Rt;r.call=(p,m,g)=>as(p,u,m,g);let d=!1;i==="post"?r.scheduler=p=>{ht(p,u&&u.suspense)}:i!=="sync"&&(d=!0,r.scheduler=(p,m)=>{m?p():Do(p)}),r.augmentJob=p=>{t&&(p.flags|=4),d&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const f=Mm(e,t,r);return Fn&&(c?c.push(f):o&&f()),f}function Jm(e,t,s){const n=this.proxy,a=Te(e)?e.includes(".")?If(n,e):()=>n[e]:e.bind(n,n);let i;_e(t)?i=t:(i=t.handler,s=t);const l=Ra(this),r=Ti(a,i.bind(n),s);return l(),r}function If(e,t){const s=t.split(".");return()=>{let n=e;for(let a=0;a<s.length&&n;a++)n=n[s[a]];return n}}const cn=new WeakMap,Nf=Symbol("_vte"),Lf=e=>e.__isTeleport,Cn=e=>e&&(e.disabled||e.disabled===""),Ym=e=>e&&(e.defer||e.defer===""),eu=e=>typeof SVGElement<"u"&&e instanceof SVGElement,tu=e=>typeof MathMLElement=="function"&&e instanceof MathMLElement,Kr=(e,t)=>{const s=e&&e.to;return Te(s)?t?t(s):null:s},Qm={name:"Teleport",__isTeleport:!0,process(e,t,s,n,a,i,l,r,o,c){const{mc:u,pc:d,pbc:f,o:{insert:p,querySelector:m,createText:g,createComment:w,parentNode:A}}=c,b=Cn(t.props);let{dynamicChildren:v}=t;const x=(O,S,I)=>{O.shapeFlag&16&&u(O.children,S,I,a,i,l,r,o)},R=(O=t)=>{const S=Cn(O.props),I=O.target=Kr(O.props,m),D=Gr(I,O,g,p);I&&(l!=="svg"&&eu(I)?l="svg":l!=="mathml"&&tu(I)&&(l="mathml"),a&&a.isCE&&(a.ce._teleportTargets||(a.ce._teleportTargets=new Set)).add(I),S||(x(O,I,D),ja(O,!1)))},L=O=>{const S=()=>{if(cn.get(O)===S){if(cn.delete(O),Cn(O.props)){const I=A(O.el)||s;x(O,I,O.anchor),ja(O,!0)}R(O)}};cn.set(O,S),ht(S,i)};if(e==null){const O=t.el=g(""),S=t.anchor=g("");if(p(O,s,n),p(S,s,n),Ym(t.props)||i&&i.pendingBranch){L(t);return}b&&(x(t,s,S),ja(t,!0)),R()}else{t.el=e.el;const O=t.anchor=e.anchor,S=cn.get(e);if(S){S.flags|=8,cn.delete(e),L(t);return}t.targetStart=e.targetStart;const I=t.target=e.target,D=t.targetAnchor=e.targetAnchor,B=Cn(e.props),F=B?s:I,M=B?O:D;if(l==="svg"||eu(I)?l="svg":(l==="mathml"||tu(I))&&(l="mathml"),v?(f(e.dynamicChildren,v,F,a,i,l,r),Wo(e,t,!0)):o||d(e,t,F,M,a,i,l,r,!1),b)B?t.props&&e.props&&t.props.to!==e.props.to&&(t.props.to=e.props.to):Vi(t,s,O,c,1);else if((t.props&&t.props.to)!==(e.props&&e.props.to)){const W=t.target=Kr(t.props,m);W&&Vi(t,W,null,c,0)}else B&&Vi(t,I,D,c,1);ja(t,b)}},remove(e,t,s,{um:n,o:{remove:a}},i){const{shapeFlag:l,children:r,anchor:o,targetStart:c,targetAnchor:u,target:d,props:f}=e,p=i||!Cn(f),m=cn.get(e);if(m&&(m.flags|=8,cn.delete(e)),d&&(a(c),a(u)),i&&a(o),!m&&l&16)for(let g=0;g<r.length;g++){const w=r[g];n(w,t,s,p,!!w.dynamicChildren)}},move:Vi,hydrate:Xm};function Vi(e,t,s,{o:{insert:n},m:a},i=2){i===0&&n(e.targetAnchor,t,s);const{el:l,anchor:r,shapeFlag:o,children:c,props:u}=e,d=i===2;if(d&&n(l,t,s),!cn.has(e)&&(!d||Cn(u))&&o&16)for(let f=0;f<c.length;f++)a(c[f],t,s,2);d&&n(r,t,s)}function Xm(e,t,s,n,a,i,{o:{nextSibling:l,parentNode:r,querySelector:o,insert:c,createText:u}},d){function f(w,A){let b=A;for(;b;){if(b&&b.nodeType===8){if(b.data==="teleport start anchor")t.targetStart=b;else if(b.data==="teleport anchor"){t.targetAnchor=b,w._lpa=t.targetAnchor&&l(t.targetAnchor);break}}b=l(b)}}function p(w,A){A.anchor=d(l(w),A,r(w),s,n,a,i)}const m=t.target=Kr(t.props,o),g=Cn(t.props);if(m){const w=m._lpa||m.firstChild;t.shapeFlag&16&&(g?(p(e,t),f(m,w),t.targetAnchor||Gr(m,t,u,c,r(e)===m?e:null)):(t.anchor=l(e),f(m,w),t.targetAnchor||Gr(m,t,u,c),d(w&&l(w),t,m,s,n,a,i))),ja(t,g)}else g&&t.shapeFlag&16&&(p(e,t),t.targetStart=e,t.targetAnchor=l(e));return t.anchor&&l(t.anchor)}const ev=Qm;function ja(e,t){const s=e.ctx;if(s&&s.ut){let n,a;for(t?(n=e.el,a=e.anchor):(n=e.targetStart,a=e.targetAnchor);n&&n!==a;)n.nodeType===1&&n.setAttribute("data-v-owner",s.uid),n=n.nextSibling;s.ut()}}function Gr(e,t,s,n,a=null){const i=t.targetStart=s(""),l=t.targetAnchor=s("");return i[Nf]=l,e&&(n(i,e,a),n(l,e,a)),l}const cs=Symbol("_leaveCb"),Ma=Symbol("_enterCb");function Po(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return $e(()=>{e.isMounted=!0}),Yl(()=>{e.isUnmounting=!0}),e}const os=[Function,Array],Fo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:os,onEnter:os,onAfterEnter:os,onEnterCancelled:os,onBeforeLeave:os,onLeave:os,onAfterLeave:os,onLeaveCancelled:os,onBeforeAppear:os,onAppear:os,onAfterAppear:os,onAppearCancelled:os},Of=e=>{const t=e.subTree;return t.component?Of(t.component):t},tv={name:"BaseTransition",props:Fo,setup(e,{slots:t}){const s=qt(),n=Po();return()=>{const a=t.default&&Wl(t.default(),!0),i=a&&a.length?Df(a):s.subTree?mp():void 0;if(!i)return;const l=Fe(e),{mode:r}=l;if(n.isLeaving)return yr(i);const o=su(i);if(!o)return yr(i);let c=ma(o,l,n,s,d=>c=d);o.type!==dt&&Xs(o,c);let u=s.subTree&&su(s.subTree);if(u&&u.type!==dt&&!vs(u,o)&&Of(s).type!==dt){let d=ma(u,l,n,s);if(Xs(u,d),r==="out-in"&&o.type!==dt)return n.isLeaving=!0,d.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete d.afterLeave,u=void 0},yr(i);r==="in-out"&&o.type!==dt?d.delayLeave=(f,p,m)=>{const g=Pf(n,u);g[String(u.key)]=u,f[cs]=()=>{p(),f[cs]=void 0,delete c.delayedLeave,u=void 0},c.delayedLeave=()=>{m(),delete c.delayedLeave,u=void 0}}:u=void 0}else u&&(u=void 0);return i}}};function Df(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==dt){t=s;break}}return t}const Mf=tv;function Pf(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function ma(e,t,s,n,a){const{appear:i,mode:l,persisted:r=!1,onBeforeEnter:o,onEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:f,onLeave:p,onAfterLeave:m,onLeaveCancelled:g,onBeforeAppear:w,onAppear:A,onAfterAppear:b,onAppearCancelled:v}=t,x=String(e.key),R=Pf(s,e),L=(I,D)=>{I&&as(I,n,9,D)},O=(I,D)=>{const B=D[1];L(I,D),fe(I)?I.every(F=>F.length<=1)&&B():I.length<=1&&B()},S={mode:l,persisted:r,beforeEnter(I){let D=o;if(!s.isMounted)if(i)D=w||o;else return;I[cs]&&I[cs](!0);const B=R[x];B&&vs(e,B)&&B.el[cs]&&B.el[cs](),L(D,[I])},enter(I){if(R[x]===e)return;let D=c,B=u,F=d;if(!s.isMounted)if(i)D=A||c,B=b||u,F=v||d;else return;let M=!1;I[Ma]=U=>{M||(M=!0,U?L(F,[I]):L(B,[I]),S.delayedLeave&&S.delayedLeave(),I[Ma]=void 0)};const W=I[Ma].bind(null,!1);D?O(D,[I,W]):W()},leave(I,D){const B=String(e.key);if(I[Ma]&&I[Ma](!0),s.isUnmounting)return D();L(f,[I]);let F=!1;I[cs]=W=>{F||(F=!0,D(),W?L(g,[I]):L(m,[I]),I[cs]=void 0,R[B]===e&&delete R[B])};const M=I[cs].bind(null,!1);R[B]=e,p?O(p,[I,M]):M()},clone(I){const D=ma(I,t,s,n,a);return a&&a(D),D}};return S}function yr(e){if(Ei(e))return e=Ns(e),e.children=null,e}function su(e){if(!Ei(e))return Lf(e.type)&&e.children?Df(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&_e(s.default))return s.default()}}function Xs(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Xs(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Wl(e,t=!1,s){let n=[],a=0;for(let i=0;i<e.length;i++){let l=e[i];const r=s==null?l.key:String(s)+String(l.key!=null?l.key:i);l.type===Tt?(l.patchFlag&128&&a++,n=n.concat(Wl(l.children,t,r))):(t||l.type!==dt)&&n.push(r!=null?Ns(l,{key:r}):l)}if(a>1)for(let i=0;i<n.length;i++)n[i].patchFlag=-2;return n}function Ci(e,t){return _e(e)?Oe({name:e.name},t,{setup:e}):e}function sv(){const e=qt();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function $o(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function nv(e){const t=qt(),s=Lo(null);if(t){const a=t.refs===Me?t.refs={}:t.refs;Object.defineProperty(a,e,{enumerable:!0,get:()=>s.value,set:i=>s.value=i})}return s}function nu(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const fl=new WeakMap;function da(e,t,s,n,a=!1){if(fe(e)){e.forEach((g,w)=>da(g,t&&(fe(t)?t[w]:t),s,n,a));return}if(Ws(n)&&!a){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&da(e,t,s,n.component.subTree);return}const i=n.shapeFlag&4?Ai(n.component):n.el,l=a?null:i,{i:r,r:o}=e,c=t&&t.r,u=r.refs===Me?r.refs={}:r.refs,d=r.setupState,f=Fe(d),p=d===Me?aa:g=>nu(u,g)?!1:He(f,g),m=(g,w)=>!(w&&nu(u,w));if(c!=null&&c!==o){if(au(t),Te(c))u[c]=null,p(c)&&(d[c]=null);else if(mt(c)){const g=t;m(c,g.k)&&(c.value=null),g.k&&(u[g.k]=null)}}if(_e(o))Aa(o,r,12,[l,u]);else{const g=Te(o),w=mt(o);if(g||w){const A=()=>{if(e.f){const b=g?p(o)?d[o]:u[o]:m()||!e.k?o.value:u[e.k];if(a)fe(b)&&To(b,i);else if(fe(b))b.includes(i)||b.push(i);else if(g)u[o]=[i],p(o)&&(d[o]=u[o]);else{const v=[i];m(o,e.k)&&(o.value=v),e.k&&(u[e.k]=v)}}else g?(u[o]=l,p(o)&&(d[o]=l)):w&&(m(o,e.k)&&(o.value=l),e.k&&(u[e.k]=l))};if(l){const b=()=>{A(),fl.delete(e)};b.id=-1,fl.set(e,b),ht(b,s)}else au(e),A()}}}function au(e){const t=fl.get(e);t&&(t.flags|=8,fl.delete(e))}let iu=!1;const Jn=()=>{iu||(console.error("Hydration completed but contains mismatches."),iu=!0)},av=e=>e.namespaceURI.includes("svg")&&e.tagName!=="foreignObject",iv=e=>e.namespaceURI.includes("MathML"),ji=e=>{if(e.nodeType===1){if(av(e))return"svg";if(iv(e))return"mathml"}},ia=e=>e.nodeType===8;function lv(e){const{mt:t,p:s,o:{patchProp:n,createText:a,nextSibling:i,parentNode:l,remove:r,insert:o,createComment:c}}=e,u=(v,x)=>{if(!x.hasChildNodes()){s(null,v,x),dl(),x._vnode=v;return}d(x.firstChild,v,null,null,null),dl(),x._vnode=v},d=(v,x,R,L,O,S=!1)=>{S=S||!!x.dynamicChildren;const I=ia(v)&&v.data==="[",D=()=>g(v,x,R,L,O,I),{type:B,ref:F,shapeFlag:M,patchFlag:W}=x;let U=v.nodeType;x.el=v,W===-2&&(S=!1,x.dynamicChildren=null);let j=null;switch(B){case gn:U!==3?x.children===""?(o(x.el=a(""),l(v),v),j=v):j=D():(v.data!==x.children&&(Jn(),v.data=x.children),j=i(v));break;case dt:b(v)?(j=i(v),A(x.el=v.content.firstChild,v,R)):U!==8||I?j=D():j=i(v);break;case Ln:if(I&&(v=i(v),U=v.nodeType),U===1||U===3){j=v;const _=!x.children.length;for(let N=0;N<x.staticCount;N++)_&&(x.children+=j.nodeType===1?j.outerHTML:j.data),N===x.staticCount-1&&(x.anchor=j),j=i(j);return I?i(j):j}else D();break;case Tt:I?j=m(v,x,R,L,O,S):j=D();break;default:if(M&1)(U!==1||x.type.toLowerCase()!==v.tagName.toLowerCase())&&!b(v)?j=D():j=f(v,x,R,L,O,S);else if(M&6){x.slotScopeIds=O;const _=l(v);if(I?j=w(v):ia(v)&&v.data==="teleport start"?j=w(v,v.data,"teleport end"):j=i(v),t(x,_,null,R,L,ji(_),S),Ws(x)&&!x.type.__asyncResolved){let N;I?(N=at(Tt),N.anchor=j?j.previousSibling:_.lastChild):N=v.nodeType===3?Jo(""):at("div"),N.el=v,x.component.subTree=N}}else M&64?U!==8?j=D():j=x.type.hydrate(v,x,R,L,O,S,e,p):M&128&&(j=x.type.hydrate(v,x,R,L,ji(l(v)),O,S,e,d))}return F!=null&&da(F,null,L,x),j},f=(v,x,R,L,O,S)=>{S=S||!!x.dynamicChildren;const{type:I,props:D,patchFlag:B,shapeFlag:F,dirs:M,transition:W}=x,U=I==="input"||I==="option";if(U||B!==-1){M&&Es(x,null,R,"created");let j=!1;if(b(v)){j=rp(null,W)&&R&&R.vnode.props&&R.vnode.props.appear;const N=v.content.firstChild;if(j){const V=N.getAttribute("class");V&&(N.$cls=V),W.beforeEnter(N)}A(N,v,R),x.el=v=N}if(F&16&&!(D&&(D.innerHTML||D.textContent))){let N=p(v.firstChild,x,v,R,L,O,S);for(N&&!zi(v,1)&&Jn();N;){const V=N;N=N.nextSibling,r(V)}}else if(F&8){let N=x.children;N[0]===`
`&&(v.tagName==="PRE"||v.tagName==="TEXTAREA")&&(N=N.slice(1));const{textContent:V}=v;V!==N&&V!==N.replace(/\r\n|\r/g,`
`)&&(zi(v,0)||Jn(),v.textContent=x.children)}if(D){if(U||!S||B&48){const N=v.tagName.includes("-");for(const V in D)(U&&(V.endsWith("value")||V==="indeterminate")||Bn(V)&&!Ks(V)||V[0]==="."||N&&!Ks(V))&&n(v,V,null,D[V],void 0,R)}else if(D.onClick)n(v,"onClick",null,D.onClick,void 0,R);else if(B&4&&Gs(D.style))for(const N in D.style)D.style[N]}let _;(_=D&&D.onVnodeBeforeMount)&&Zt(_,R,x),M&&Es(x,null,R,"beforeMount"),((_=D&&D.onVnodeMounted)||M||j)&&dp(()=>{_&&Zt(_,R,x),j&&W.enter(v),M&&Es(x,null,R,"mounted")},L)}return v.nextSibling},p=(v,x,R,L,O,S,I)=>{I=I||!!x.dynamicChildren;const D=x.children,B=D.length;let F=!1;for(let M=0;M<B;M++){const W=I?D[M]:D[M]=Yt(D[M]),U=W.type===gn;v?(U&&!I&&M+1<B&&Yt(D[M+1]).type===gn&&(o(a(v.data.slice(W.children.length)),R,i(v)),v.data=W.children),v=d(v,W,L,O,S,I)):U&&!W.children?o(W.el=a(""),R):(F||(F=!0,zi(R,1)||Jn()),s(null,W,R,null,L,O,ji(R),S))}return v},m=(v,x,R,L,O,S)=>{const{slotScopeIds:I}=x;I&&(O=O?O.concat(I):I);const D=l(v),B=p(i(v),x,D,R,L,O,S);return B&&ia(B)&&B.data==="]"?i(x.anchor=B):(Jn(),o(x.anchor=c("]"),D,B),B)},g=(v,x,R,L,O,S)=>{if(zi(v.parentElement,1)||Jn(),x.el=null,S){const B=w(v);for(;;){const F=i(v);if(F&&F!==B)r(F);else break}}const I=i(v),D=l(v);return r(v),s(null,x,D,I,R,L,ji(D),O),R&&(R.vnode.el=x.el,Xl(R,x.el)),I},w=(v,x="[",R="]")=>{let L=0;for(;v;)if(v=i(v),v&&ia(v)&&(v.data===x&&L++,v.data===R)){if(L===0)return i(v);L--}return v},A=(v,x,R)=>{const L=x.parentNode;L&&L.replaceChild(v,x);let O=R;for(;O;)O.vnode.el===x&&(O.vnode.el=O.subTree.el=v),O=O.parent},b=v=>v.nodeType===1&&v.tagName==="TEMPLATE";return[u,d]}const lu="data-allow-mismatch",rv={0:"text",1:"children",2:"class",3:"style",4:"attribute"};function zi(e,t){if(t===0||t===1)for(;e&&!e.hasAttribute(lu);)e=e.parentElement;const s=e&&e.getAttribute(lu);if(s==null)return!1;if(s==="")return!0;{const n=s.split(",");return t===0&&n.includes("children")?!0:n.includes(rv[t])}}const ov=Hl().requestIdleCallback||(e=>setTimeout(e,1)),cv=Hl().cancelIdleCallback||(e=>clearTimeout(e)),uv=(e=1e4)=>t=>{const s=ov(t,{timeout:e});return()=>cv(s)};function dv(e){const{top:t,left:s,bottom:n,right:a}=e.getBoundingClientRect(),{innerHeight:i,innerWidth:l}=window;return(t>0&&t<i||n>0&&n<i)&&(s>0&&s<l||a>0&&a<l)}const fv=e=>(t,s)=>{const n=new IntersectionObserver(a=>{for(const i of a)if(i.isIntersecting){n.disconnect(),t();break}},e);return s(a=>{if(a instanceof Element){if(dv(a))return t(),n.disconnect(),!1;n.observe(a)}}),()=>n.disconnect()},pv=e=>t=>{if(e){const s=matchMedia(e);if(s.matches)t();else return s.addEventListener("change",t,{once:!0}),()=>s.removeEventListener("change",t)}},hv=(e=[])=>(t,s)=>{Te(e)&&(e=[e]);let n=!1;const a=l=>{n||(n=!0,i(),t(),l.target.dispatchEvent(new l.constructor(l.type,l)))},i=()=>{s(l=>{for(const r of e)l.removeEventListener(r,a)})};return s(l=>{for(const r of e)l.addEventListener(r,a,{once:!0})}),i};function gv(e,t){if(ia(e)&&e.data==="["){let s=1,n=e.nextSibling;for(;n;){if(n.nodeType===1){if(t(n)===!1)break}else if(ia(n))if(n.data==="]"){if(--s===0)break}else n.data==="["&&s++;n=n.nextSibling}}else t(e)}const Ws=e=>!!e.type.__asyncLoader;function mv(e){_e(e)&&(e={loader:e});const{loader:t,loadingComponent:s,errorComponent:n,delay:a=200,hydrate:i,timeout:l,suspensible:r=!0,onError:o}=e;let c=null,u,d=0;const f=()=>(d++,c=null,p()),p=()=>{let m;return c||(m=c=t().catch(g=>{if(g=g instanceof Error?g:new Error(String(g)),o)return new Promise((w,A)=>{o(g,()=>w(f()),()=>A(g),d+1)});throw g}).then(g=>m!==c&&c?c:(g&&(g.__esModule||g[Symbol.toStringTag]==="Module")&&(g=g.default),u=g,g)))};return Ci({name:"AsyncComponentWrapper",__asyncLoader:p,__asyncHydrate(m,g,w){let A=!1;(g.bu||(g.bu=[])).push(()=>A=!0);const b=()=>{A||w()},v=i?()=>{const x=i(b,R=>gv(m,R));x&&(g.bum||(g.bum=[])).push(x)}:b;u?v():p().then(()=>!g.isUnmounted&&v())},get __asyncResolved(){return u},setup(){const m=Rt;if($o(m),u)return()=>qi(u,m);const g=R=>{c=null,jn(R,m,13,!n)};if(r&&m.suspense||Fn)return p().then(R=>()=>qi(R,m)).catch(R=>(g(R),()=>n?at(n,{error:R}):null));const w=h(!1),A=h(),b=h(!!a);let v,x;return ft(()=>{v!=null&&clearTimeout(v),x!=null&&clearTimeout(x)}),a&&(x=setTimeout(()=>{m.isUnmounted||(b.value=!1)},a)),l!=null&&(v=setTimeout(()=>{if(!m.isUnmounted&&!w.value&&!A.value){const R=new Error(`Async component timed out after ${l}ms.`);g(R),A.value=R}},l)),p().then(()=>{m.isUnmounted||(w.value=!0,m.parent&&Ei(m.parent.vnode)&&m.parent.update())}).catch(R=>{if(m.isUnmounted){c=null;return}g(R),A.value=R}),()=>{if(w.value&&u)return qi(u,m);if(A.value&&n)return at(n,{error:A.value});if(s&&!b.value)return qi(s,m)}}})}function qi(e,t){const{ref:s,props:n,children:a,ce:i}=t.vnode,l=at(e,n,a);return l.ref=s,l.ce=i,delete t.vnode.ce,l}const Ei=e=>e.type.__isKeepAlive,vv={name:"KeepAlive",__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){const s=qt(),n=s.ctx;if(!n.renderer)return()=>{const b=t.default&&t.default();return b&&b.length===1?b[0]:b};const a=new Map,i=new Set;let l=null;const r=s.suspense,{renderer:{p:o,m:c,um:u,o:{createElement:d}}}=n,f=d("div");n.activate=(b,v,x,R,L)=>{const O=b.component;c(b,v,x,0,r),o(O.vnode,b,v,x,O,r,R,b.slotScopeIds,L),ht(()=>{O.isDeactivated=!1,O.a&&ca(O.a);const S=b.props&&b.props.onVnodeMounted;S&&Zt(S,O.parent,b)},r)},n.deactivate=b=>{const v=b.component;hl(v.m),hl(v.a),c(b,f,null,1,r),ht(()=>{v.da&&ca(v.da);const x=b.props&&b.props.onVnodeUnmounted;x&&Zt(x,v.parent,b),v.isDeactivated=!0},r)};function p(b){xr(b),u(b,s,r,!0)}function m(b){a.forEach((v,x)=>{const R=so(Ws(v)?v.type.__asyncResolved||{}:v.type);R&&!b(R)&&g(x)})}function g(b){const v=a.get(b);v&&(!l||!vs(v,l))?p(v):l&&xr(l),a.delete(b),i.delete(b)}ns(()=>[e.include,e.exclude],([b,v])=>{b&&m(x=>za(b,x)),v&&m(x=>!za(v,x))},{flush:"post",deep:!0});let w=null;const A=()=>{w!=null&&(gl(s.subTree.type)?ht(()=>{a.set(w,Ki(s.subTree))},s.subTree.suspense):a.set(w,Ki(s.subTree)))};return $e(A),Jl(A),Yl(()=>{a.forEach(b=>{const{subTree:v,suspense:x}=s,R=Ki(v);if(b.type===R.type&&b.key===R.key){xr(R);const L=R.component.da;L&&ht(L,x);return}p(b)})}),()=>{if(w=null,!t.default)return l=null;const b=t.default(),v=b[0];if(b.length>1)return l=null,b;if(!en(v)||!(v.shapeFlag&4)&&!(v.shapeFlag&128))return l=null,v;let x=Ki(v);if(x.type===dt)return l=null,x;const R=x.type,L=so(Ws(x)?x.type.__asyncResolved||{}:R),{include:O,exclude:S,max:I}=e;if(O&&(!L||!za(O,L))||S&&L&&za(S,L))return x.shapeFlag&=-257,l=x,v;const D=x.key==null?R:x.key,B=a.get(D);return x.el&&(x=Ns(x),v.shapeFlag&128&&(v.ssContent=x)),w=D,B?(x.el=B.el,x.component=B.component,x.transition&&Xs(x,x.transition),x.shapeFlag|=512,i.delete(D),i.add(D)):(i.add(D),I&&i.size>parseInt(I,10)&&g(i.values().next().value)),x.shapeFlag|=256,l=x,gl(v.type)?v:x}}},bv=vv;function za(e,t){return fe(e)?e.some(s=>za(s,t)):Te(e)?e.split(",").includes(t):Ag(e)?(e.lastIndex=0,e.test(t)):!1}function Uo(e,t){Ff(e,"a",t)}function Bo(e,t){Ff(e,"da",t)}function Ff(e,t,s=Rt){const n=e.__wdc||(e.__wdc=()=>{let a=s;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if(Zl(t,n,s),s){let a=s.parent;for(;a&&a.parent;)Ei(a.parent.vnode)&&yv(n,t,s,a),a=a.parent}}function yv(e,t,s,n){const a=Zl(t,e,n,!0);ft(()=>{To(n[t],a)},s)}function xr(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function Ki(e){return e.shapeFlag&128?e.ssContent:e}function Zl(e,t,s=Rt,n=!1){if(s){const a=s[e]||(s[e]=[]),i=t.__weh||(t.__weh=(...l)=>{Ys();const r=Ra(s),o=as(t,s,e,l);return r(),Qs(),o});return n?a.unshift(i):a.push(i),i}}const tn=e=>(t,s=Rt)=>{(!Fn||e==="sp")&&Zl(e,(...n)=>t(...n),s)},$f=tn("bm"),$e=tn("m"),Ho=tn("bu"),Jl=tn("u"),Yl=tn("bum"),ft=tn("um"),Uf=tn("sp"),Bf=tn("rtg"),Hf=tn("rtc");function Vf(e,t=Rt){Zl("ec",e,t)}const Vo="components",xv="directives";function _v(e,t){return jo(Vo,e,!0,t)||e}const jf=Symbol.for("v-ndc");function kv(e){return Te(e)?jo(Vo,e,!1)||e:e||jf}function wv(e){return jo(xv,e)}function jo(e,t,s=!0,n=!1){const a=It||Rt;if(a){const i=a.type;if(e===Vo){const r=so(i,!1);if(r&&(r===t||r===Ge(t)||r===Vn(Ge(t))))return i}const l=ru(a[e]||i[e],t)||ru(a.appContext[e],t);return!l&&n?i:l}}function ru(e,t){return e&&(e[t]||e[Ge(t)]||e[Vn(Ge(t))])}function Sv(e,t,s,n){let a;const i=s&&s[n],l=fe(e);if(l||Te(e)){const r=l&&Gs(e);let o=!1,c=!1;r&&(o=!es(e),c=Is(e),e=zl(e)),a=new Array(e.length);for(let u=0,d=e.length;u<d;u++)a[u]=t(o?c?ga(xs(e[u])):xs(e[u]):e[u],u,void 0,i&&i[u])}else if(typeof e=="number"){a=new Array(e);for(let r=0;r<e;r++)a[r]=t(r+1,r,void 0,i&&i[r])}else if(Be(e))if(e[Symbol.iterator])a=Array.from(e,(r,o)=>t(r,o,void 0,i&&i[o]));else{const r=Object.keys(e);a=new Array(r.length);for(let o=0,c=r.length;o<c;o++){const u=r[o];a[o]=t(e[u],u,o,i&&i[o])}}else a=[];return s&&(s[n]=a),a}function Tv(e,t){for(let s=0;s<t.length;s++){const n=t[s];if(fe(n))for(let a=0;a<n.length;a++)e[n[a].name]=n[a].fn;else n&&(e[n.name]=n.key?(...a)=>{const i=n.fn(...a);return i&&(i.key=n.key),i}:n.fn)}return e}function Cv(e,t,s={},n,a){if(It.ce||It.parent&&Ws(It.parent)&&It.parent.ce){const c=Object.keys(s).length>0;return t!=="default"&&(s.name=t),fi(),ml(Tt,null,[at("slot",s,n&&n())],c?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),fi();const l=i&&zo(i(s)),r=s.key||l&&l.key,o=ml(Tt,{key:(r&&!Ut(r)?r:`_${t}`)+(!l&&n?"_fb":"")},l||(n?n():[]),l&&e._===1?64:-2);return!a&&o.scopeId&&(o.slotScopeIds=[o.scopeId+"-s"]),i&&i._c&&(i._d=!0),o}function zo(e){return e.some(t=>en(t)?!(t.type===dt||t.type===Tt&&!zo(t.children)):!0)?e:null}function Ev(e,t){const s={};for(const n in e)s[t&&/[A-Z]/.test(n)?`on:${n}`:oa(n)]=e[n];return s}const Wr=e=>e?yp(e)?Ai(e):Wr(e.parent):null,Ya=Oe(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Wr(e.parent),$root:e=>Wr(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>qo(e),$forceUpdate:e=>e.f||(e.f=()=>{Do(e.update)}),$nextTick:e=>e.n||(e.n=St.bind(e.proxy)),$watch:e=>Jm.bind(e)}),_r=(e,t)=>e!==Me&&!e.__isScriptSetup&&He(e,t),Zr={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:a,props:i,accessCache:l,type:r,appContext:o}=e;if(t[0]!=="$"){const f=l[t];if(f!==void 0)switch(f){case 1:return n[t];case 2:return a[t];case 4:return s[t];case 3:return i[t]}else{if(_r(n,t))return l[t]=1,n[t];if(a!==Me&&He(a,t))return l[t]=2,a[t];if(He(i,t))return l[t]=3,i[t];if(s!==Me&&He(s,t))return l[t]=4,s[t];Jr&&(l[t]=0)}}const c=Ya[t];let u,d;if(c)return t==="$attrs"&&Pt(e.attrs,"get",""),c(e);if((u=r.__cssModules)&&(u=u[t]))return u;if(s!==Me&&He(s,t))return l[t]=4,s[t];if(d=o.config.globalProperties,He(d,t))return d[t]},set({_:e},t,s){const{data:n,setupState:a,ctx:i}=e;return _r(a,t)?(a[t]=s,!0):n!==Me&&He(n,t)?(n[t]=s,!0):He(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:a,props:i,type:l}},r){let o;return!!(s[r]||e!==Me&&r[0]!=="$"&&He(e,r)||_r(t,r)||He(i,r)||He(n,r)||He(Ya,r)||He(a.config.globalProperties,r)||(o=l.__cssModules)&&o[r])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:He(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}},Av=Oe({},Zr,{get(e,t){if(t!==Symbol.unscopables)return Zr.get(e,t,e)},has(e,t){return t[0]!=="_"&&!Mg(t)}});function Rv(){return null}function Iv(){return null}function Nv(e){}function Lv(e){}function Ov(){return null}function Dv(){}function Mv(e,t){return null}function Pv(){return zf().slots}function Fv(){return zf().attrs}function zf(e){const t=qt();return t.setupContext||(t.setupContext=wp(t))}function ui(e){return fe(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}function $v(e,t){const s=ui(e);for(const n in t){if(n.startsWith("__skip"))continue;let a=s[n];a?fe(a)||_e(a)?a=s[n]={type:a,default:t[n]}:a.default=t[n]:a===null&&(a=s[n]={default:t[n]}),a&&t[`__skip_${n}`]&&(a.skipFactory=!0)}return s}function Uv(e,t){return!e||!t?e||t:fe(e)&&fe(t)?e.concat(t):Oe({},ui(e),ui(t))}function Bv(e,t){const s={};for(const n in e)t.includes(n)||Object.defineProperty(s,n,{enumerable:!0,get:()=>e[n]});return s}function Hv(e){const t=qt(),s=Fn;let n=e();hi(),s&&pa(!1);const a=()=>{Ra(t),s&&pa(!0)},i=()=>{qt()!==t&&t.scope.off(),hi(),s&&pa(!1)};return Co(n)&&(n=n.catch(l=>{throw a(),Promise.resolve().then(()=>Promise.resolve().then(i)),l})),[n,()=>{a(),Promise.resolve().then(i)}]}let Jr=!0;function Vv(e){const t=qo(e),s=e.proxy,n=e.ctx;Jr=!1,t.beforeCreate&&ou(t.beforeCreate,e,"bc");const{data:a,computed:i,methods:l,watch:r,provide:o,inject:c,created:u,beforeMount:d,mounted:f,beforeUpdate:p,updated:m,activated:g,deactivated:w,beforeDestroy:A,beforeUnmount:b,destroyed:v,unmounted:x,render:R,renderTracked:L,renderTriggered:O,errorCaptured:S,serverPrefetch:I,expose:D,inheritAttrs:B,components:F,directives:M,filters:W}=t;if(c&&jv(c,n,null),l)for(const _ in l){const N=l[_];_e(N)&&(n[_]=N.bind(s))}if(a){const _=a.call(s,s);Be(_)&&(e.data=bn(_))}if(Jr=!0,i)for(const _ in i){const N=i[_],V=_e(N)?N.bind(s,s):_e(N.get)?N.get.bind(s,s):Nt,re=!_e(N)&&_e(N.set)?N.set.bind(s):Nt,ve=ee({get:V,set:re});Object.defineProperty(n,_,{enumerable:!0,configurable:!0,get:()=>ve.value,set:se=>ve.value=se})}if(r)for(const _ in r)qf(r[_],n,s,_);if(o){const _=_e(o)?o.call(s):o;Reflect.ownKeys(_).forEach(N=>{Ja(N,_[N])})}u&&ou(u,e,"c");function j(_,N){fe(N)?N.forEach(V=>_(V.bind(s))):N&&_(N.bind(s))}if(j($f,d),j($e,f),j(Ho,p),j(Jl,m),j(Uo,g),j(Bo,w),j(Vf,S),j(Hf,L),j(Bf,O),j(Yl,b),j(ft,x),j(Uf,I),fe(D))if(D.length){const _=e.exposed||(e.exposed={});D.forEach(N=>{Object.defineProperty(_,N,{get:()=>s[N],set:V=>s[N]=V,enumerable:!0})})}else e.exposed||(e.exposed={});R&&e.render===Nt&&(e.render=R),B!=null&&(e.inheritAttrs=B),F&&(e.components=F),M&&(e.directives=M),I&&$o(e)}function jv(e,t,s=Nt){fe(e)&&(e=Yr(e));for(const n in e){const a=e[n];let i;Be(a)?"default"in a?i=fs(a.from||n,a.default,!0):i=fs(a.from||n):i=fs(a),mt(i)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):t[n]=i}}function ou(e,t,s){as(fe(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function qf(e,t,s,n){let a=n.includes(".")?If(s,n):()=>s[n];if(Te(e)){const i=t[e];_e(i)&&ns(a,i)}else if(_e(e))ns(a,e.bind(s));else if(Be(e))if(fe(e))e.forEach(i=>qf(i,t,s,n));else{const i=_e(e.handler)?e.handler.bind(s):t[e.handler];_e(i)&&ns(a,i,e)}}function qo(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:a,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,r=i.get(t);let o;return r?o=r:!a.length&&!s&&!n?o=t:(o={},a.length&&a.forEach(c=>pl(o,c,l,!0)),pl(o,t,l)),Be(t)&&i.set(t,o),o}function pl(e,t,s,n=!1){const{mixins:a,extends:i}=t;i&&pl(e,i,s,!0),a&&a.forEach(l=>pl(e,l,s,!0));for(const l in t)if(!(n&&l==="expose")){const r=zv[l]||s&&s[l];e[l]=r?r(e[l],t[l]):t[l]}return e}const zv={data:cu,props:uu,emits:uu,methods:qa,computed:qa,beforeCreate:Bt,created:Bt,beforeMount:Bt,mounted:Bt,beforeUpdate:Bt,updated:Bt,beforeDestroy:Bt,beforeUnmount:Bt,destroyed:Bt,unmounted:Bt,activated:Bt,deactivated:Bt,errorCaptured:Bt,serverPrefetch:Bt,components:qa,directives:qa,watch:Kv,provide:cu,inject:qv};function cu(e,t){return t?e?function(){return Oe(_e(e)?e.call(this,this):e,_e(t)?t.call(this,this):t)}:t:e}function qv(e,t){return qa(Yr(e),Yr(t))}function Yr(e){if(fe(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Bt(e,t){return e?[...new Set([].concat(e,t))]:t}function qa(e,t){return e?Oe(Object.create(null),e,t):t}function uu(e,t){return e?fe(e)&&fe(t)?[...new Set([...e,...t])]:Oe(Object.create(null),ui(e),ui(t??{})):t}function Kv(e,t){if(!e)return t;if(!t)return e;const s=Oe(Object.create(null),e);for(const n in t)s[n]=Bt(e[n],t[n]);return s}function Kf(){return{app:null,config:{isNativeTag:aa,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Gv=0;function Wv(e,t){return function(n,a=null){_e(n)||(n=Oe({},n)),a!=null&&!Be(a)&&(a=null);const i=Kf(),l=new WeakSet,r=[];let o=!1;const c=i.app={_uid:Gv++,_component:n,_props:a,_container:null,_context:i,_instance:null,version:Tp,get config(){return i.config},set config(u){},use(u,...d){return l.has(u)||(u&&_e(u.install)?(l.add(u),u.install(c,...d)):_e(u)&&(l.add(u),u(c,...d))),c},mixin(u){return i.mixins.includes(u)||i.mixins.push(u),c},component(u,d){return d?(i.components[u]=d,c):i.components[u]},directive(u,d){return d?(i.directives[u]=d,c):i.directives[u]},mount(u,d,f){if(!o){const p=c._ceVNode||at(n,a);return p.appContext=i,f===!0?f="svg":f===!1&&(f=void 0),d&&t?t(p,u):e(p,u,f),o=!0,c._container=u,u.__vue_app__=c,Ai(p.component)}},onUnmount(u){r.push(u)},unmount(){o&&(as(r,c._instance,16),e(null,c._container),delete c._container.__vue_app__)},provide(u,d){return i.provides[u]=d,c},runWithContext(u){const d=Nn;Nn=c;try{return u()}finally{Nn=d}}};return c}}let Nn=null;function Zv(e,t,s=Me){const n=qt(),a=Ge(t),i=Qt(t),l=Gf(e,a),r=yf((o,c)=>{let u,d=Me,f;return Rf(()=>{const p=e[a];wt(u,p)&&(u=p,c())}),{get(){return o(),s.get?s.get(u):u},set(p){const m=s.set?s.set(p):p;if(!wt(m,u)&&!(d!==Me&&wt(p,d)))return;const g=n.vnode.props,w=!!(g&&(t in g||a in g||i in g)&&(`onUpdate:${t}`in g||`onUpdate:${a}`in g||`onUpdate:${i}`in g));w||(u=p,c()),n.emit(`update:${t}`,m),wt(p,d)&&(wt(p,m)&&!wt(m,f)||w&&d!==Me&&!wt(m,u))&&c(),d=p,f=m}}});return r[Symbol.iterator]=()=>{let o=0;return{next(){return o<2?{value:o++?l||Me:r,done:!1}:{done:!0}}}},r}const Gf=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Ge(t)}Modifiers`]||e[`${Qt(t)}Modifiers`];function Jv(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||Me;let a=s;const i=t.startsWith("update:"),l=i&&Gf(n,t.slice(7));l&&(l.trim&&(a=s.map(u=>Te(u)?u.trim():u)),l.number&&(a=s.map(Bl)));let r,o=n[r=oa(t)]||n[r=oa(Ge(t))];!o&&i&&(o=n[r=oa(Qt(t))]),o&&as(o,e,6,a);const c=n[r+"Once"];if(c){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,as(c,e,6,a)}}const Yv=new WeakMap;function Wf(e,t,s=!1){const n=s?Yv:t.emitsCache,a=n.get(e);if(a!==void 0)return a;const i=e.emits;let l={},r=!1;if(!_e(e)){const o=c=>{const u=Wf(c,t,!0);u&&(r=!0,Oe(l,u))};!s&&t.mixins.length&&t.mixins.forEach(o),e.extends&&o(e.extends),e.mixins&&e.mixins.forEach(o)}return!i&&!r?(Be(e)&&n.set(e,null),null):(fe(i)?i.forEach(o=>l[o]=null):Oe(l,i),Be(e)&&n.set(e,l),l)}function Ql(e,t){return!e||!Bn(t)?!1:(t=t.slice(2).replace(/Once$/,""),He(e,t[0].toLowerCase()+t.slice(1))||He(e,Qt(t))||He(e,t))}function Xi(e){const{type:t,vnode:s,proxy:n,withProxy:a,propsOptions:[i],slots:l,attrs:r,emit:o,render:c,renderCache:u,props:d,data:f,setupState:p,ctx:m,inheritAttrs:g}=e,w=ci(e);let A,b;try{if(s.shapeFlag&4){const x=a||n,R=x;A=Yt(c.call(R,x,u,d,p,f,m)),b=r}else{const x=t;A=Yt(x.length>1?x(d,{attrs:r,slots:l,emit:o}):x(d,null)),b=t.props?r:Xv(r)}}catch(x){Qa.length=0,jn(x,e,1),A=at(dt)}let v=A;if(b&&g!==!1){const x=Object.keys(b),{shapeFlag:R}=v;x.length&&R&7&&(i&&x.some(Pl)&&(b=eb(b,i)),v=Ns(v,b,!1,!0))}return s.dirs&&(v=Ns(v,null,!1,!0),v.dirs=v.dirs?v.dirs.concat(s.dirs):s.dirs),s.transition&&Xs(v,s.transition),A=v,ci(w),A}function Qv(e,t=!0){let s;for(let n=0;n<e.length;n++){const a=e[n];if(en(a)){if(a.type!==dt||a.children==="v-if"){if(s)return;s=a}}else return}return s}const Xv=e=>{let t;for(const s in e)(s==="class"||s==="style"||Bn(s))&&((t||(t={}))[s]=e[s]);return t},eb=(e,t)=>{const s={};for(const n in e)(!Pl(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function tb(e,t,s){const{props:n,children:a,component:i}=e,{props:l,children:r,patchFlag:o}=t,c=i.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&o>=0){if(o&1024)return!0;if(o&16)return n?du(n,l,c):!!l;if(o&8){const u=t.dynamicProps;for(let d=0;d<u.length;d++){const f=u[d];if(Zf(l,n,f)&&!Ql(c,f))return!0}}}else return(a||r)&&(!r||!r.$stable)?!0:n===l?!1:n?l?du(n,l,c):!0:!!l;return!1}function du(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let a=0;a<n.length;a++){const i=n[a];if(Zf(t,e,i)&&!Ql(s,i))return!0}return!1}function Zf(e,t,s){const n=e[s],a=t[s];return s==="style"&&Be(n)&&Be(a)?!Js(n,a):n!==a}function Xl({vnode:e,parent:t,suspense:s},n){for(;t;){const a=t.subTree;if(a.suspense&&a.suspense.activeBranch===e&&(a.suspense.vnode.el=a.el=n,e=a),a===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const Jf={},Yf=()=>Object.create(Jf),Qf=e=>Object.getPrototypeOf(e)===Jf;function sb(e,t,s,n=!1){const a={},i=Yf();e.propsDefaults=Object.create(null),Xf(e,t,a,i);for(const l in e.propsOptions[0])l in a||(a[l]=void 0);s?e.props=n?a:No(a):e.type.props?e.props=a:e.props=i,e.attrs=i}function nb(e,t,s,n){const{props:a,attrs:i,vnode:{patchFlag:l}}=e,r=Fe(a),[o]=e.propsOptions;let c=!1;if((n||l>0)&&!(l&16)){if(l&8){const u=e.vnode.dynamicProps;for(let d=0;d<u.length;d++){let f=u[d];if(Ql(e.emitsOptions,f))continue;const p=t[f];if(o)if(He(i,f))p!==i[f]&&(i[f]=p,c=!0);else{const m=Ge(f);a[m]=Qr(o,r,m,p,e,!1)}else p!==i[f]&&(i[f]=p,c=!0)}}}else{Xf(e,t,a,i)&&(c=!0);let u;for(const d in r)(!t||!He(t,d)&&((u=Qt(d))===d||!He(t,u)))&&(o?s&&(s[d]!==void 0||s[u]!==void 0)&&(a[d]=Qr(o,r,d,void 0,e,!0)):delete a[d]);if(i!==r)for(const d in i)(!t||!He(t,d))&&(delete i[d],c=!0)}c&&Hs(e.attrs,"set","")}function Xf(e,t,s,n){const[a,i]=e.propsOptions;let l=!1,r;if(t)for(let o in t){if(Ks(o))continue;const c=t[o];let u;a&&He(a,u=Ge(o))?!i||!i.includes(u)?s[u]=c:(r||(r={}))[u]=c:Ql(e.emitsOptions,o)||(!(o in n)||c!==n[o])&&(n[o]=c,l=!0)}if(i){const o=Fe(s),c=r||Me;for(let u=0;u<i.length;u++){const d=i[u];s[d]=Qr(a,o,d,c[d],e,!He(c,d))}}return l}function Qr(e,t,s,n,a,i){const l=e[s];if(l!=null){const r=He(l,"default");if(r&&n===void 0){const o=l.default;if(l.type!==Function&&!l.skipFactory&&_e(o)){const{propsDefaults:c}=a;if(s in c)n=c[s];else{const u=Ra(a);n=c[s]=o.call(null,t),u()}}else n=o;a.ce&&a.ce._setProp(s,n)}l[0]&&(i&&!r?n=!1:l[1]&&(n===""||n===Qt(s))&&(n=!0))}return n}const ab=new WeakMap;function ep(e,t,s=!1){const n=s?ab:t.propsCache,a=n.get(e);if(a)return a;const i=e.props,l={},r=[];let o=!1;if(!_e(e)){const u=d=>{o=!0;const[f,p]=ep(d,t,!0);Oe(l,f),p&&r.push(...p)};!s&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!i&&!o)return Be(e)&&n.set(e,la),la;if(fe(i))for(let u=0;u<i.length;u++){const d=Ge(i[u]);fu(d)&&(l[d]=Me)}else if(i)for(const u in i){const d=Ge(u);if(fu(d)){const f=i[u],p=l[d]=fe(f)||_e(f)?{type:f}:Oe({},f),m=p.type;let g=!1,w=!0;if(fe(m))for(let A=0;A<m.length;++A){const b=m[A],v=_e(b)&&b.name;if(v==="Boolean"){g=!0;break}else v==="String"&&(w=!1)}else g=_e(m)&&m.name==="Boolean";p[0]=g,p[1]=w,(g||He(p,"default"))&&r.push(d)}}const c=[l,r];return Be(e)&&n.set(e,c),c}function fu(e){return e[0]!=="$"&&!Ks(e)}const Ko=e=>e==="_"||e==="_ctx"||e==="$stable",Go=e=>fe(e)?e.map(Yt):[Yt(e)],ib=(e,t,s)=>{if(t._n)return t;const n=Mo((...a)=>Go(t(...a)),s);return n._c=!1,n},tp=(e,t,s)=>{const n=e._ctx;for(const a in e){if(Ko(a))continue;const i=e[a];if(_e(i))t[a]=ib(a,i,n);else if(i!=null){const l=Go(i);t[a]=()=>l}}},sp=(e,t)=>{const s=Go(t);e.slots.default=()=>s},np=(e,t,s)=>{for(const n in t)(s||!Ko(n))&&(e[n]=t[n])},lb=(e,t,s)=>{const n=e.slots=Yf();if(e.vnode.shapeFlag&32){const a=t._;a?(np(n,t,s),s&&Wd(n,"_",a,!0)):tp(t,n)}else t&&sp(e,t)},rb=(e,t,s)=>{const{vnode:n,slots:a}=e;let i=!0,l=Me;if(n.shapeFlag&32){const r=t._;r?s&&r===1?i=!1:np(a,t,s):(i=!t.$stable,tp(t,a)),l=t}else t&&(sp(e,t),l={default:1});if(i)for(const r in a)!Ko(r)&&l[r]==null&&delete a[r]},ht=dp;function ap(e){return lp(e)}function ip(e){return lp(e,lv)}function lp(e,t){const s=Hl();s.__VUE__=!0;const{insert:n,remove:a,patchProp:i,createElement:l,createText:r,createComment:o,setText:c,setElementText:u,parentNode:d,nextSibling:f,setScopeId:p=Nt,insertStaticContent:m}=e,g=(y,T,P,G=null,E=null,$=null,Z=void 0,X=null,te=!!T.dynamicChildren)=>{if(y===T)return;y&&!vs(y,T)&&(G=z(y),se(y,E,$,!0),y=null),T.patchFlag===-2&&(te=!1,T.dynamicChildren=null);const{type:Y,ref:pe,shapeFlag:ie}=T;switch(Y){case gn:w(y,T,P,G);break;case dt:A(y,T,P,G);break;case Ln:y==null&&b(T,P,G,Z);break;case Tt:F(y,T,P,G,E,$,Z,X,te);break;default:ie&1?R(y,T,P,G,E,$,Z,X,te):ie&6?M(y,T,P,G,E,$,Z,X,te):(ie&64||ie&128)&&Y.process(y,T,P,G,E,$,Z,X,te,ge)}pe!=null&&E?da(pe,y&&y.ref,$,T||y,!T):pe==null&&y&&y.ref!=null&&da(y.ref,null,$,y,!0)},w=(y,T,P,G)=>{if(y==null)n(T.el=r(T.children),P,G);else{const E=T.el=y.el;T.children!==y.children&&c(E,T.children)}},A=(y,T,P,G)=>{y==null?n(T.el=o(T.children||""),P,G):T.el=y.el},b=(y,T,P,G)=>{[y.el,y.anchor]=m(y.children,T,P,G,y.el,y.anchor)},v=({el:y,anchor:T},P,G)=>{let E;for(;y&&y!==T;)E=f(y),n(y,P,G),y=E;n(T,P,G)},x=({el:y,anchor:T})=>{let P;for(;y&&y!==T;)P=f(y),a(y),y=P;a(T)},R=(y,T,P,G,E,$,Z,X,te)=>{if(T.type==="svg"?Z="svg":T.type==="math"&&(Z="mathml"),y==null)L(T,P,G,E,$,Z,X,te);else{const Y=y.el&&y.el._isVueCE?y.el:null;try{Y&&Y._beginPatch(),I(y,T,E,$,Z,X,te)}finally{Y&&Y._endPatch()}}},L=(y,T,P,G,E,$,Z,X)=>{let te,Y;const{props:pe,shapeFlag:ie,transition:ue,dirs:ye}=y;if(te=y.el=l(y.type,$,pe&&pe.is,pe),ie&8?u(te,y.children):ie&16&&S(y.children,te,null,G,E,kr(y,$),Z,X),ye&&Es(y,null,G,"created"),O(te,y,y.scopeId,Z,G),pe){for(const Ee in pe)Ee!=="value"&&!Ks(Ee)&&i(te,Ee,null,pe[Ee],$,G);"value"in pe&&i(te,"value",null,pe.value,$),(Y=pe.onVnodeBeforeMount)&&Zt(Y,G,y)}ye&&Es(y,null,G,"beforeMount");const we=rp(E,ue);we&&ue.beforeEnter(te),n(te,T,P),((Y=pe&&pe.onVnodeMounted)||we||ye)&&ht(()=>{try{Y&&Zt(Y,G,y),we&&ue.enter(te),ye&&Es(y,null,G,"mounted")}finally{}},E)},O=(y,T,P,G,E)=>{if(P&&p(y,P),G)for(let $=0;$<G.length;$++)p(y,G[$]);if(E){let $=E.subTree;if(T===$||gl($.type)&&($.ssContent===T||$.ssFallback===T)){const Z=E.vnode;O(y,Z,Z.scopeId,Z.slotScopeIds,E.parent)}}},S=(y,T,P,G,E,$,Z,X,te=0)=>{for(let Y=te;Y<y.length;Y++){const pe=y[Y]=X?Us(y[Y]):Yt(y[Y]);g(null,pe,T,P,G,E,$,Z,X)}},I=(y,T,P,G,E,$,Z)=>{const X=T.el=y.el;let{patchFlag:te,dynamicChildren:Y,dirs:pe}=T;te|=y.patchFlag&16;const ie=y.props||Me,ue=T.props||Me;let ye;if(P&&kn(P,!1),(ye=ue.onVnodeBeforeUpdate)&&Zt(ye,P,T,y),pe&&Es(T,y,P,"beforeUpdate"),P&&kn(P,!0),(ie.innerHTML&&ue.innerHTML==null||ie.textContent&&ue.textContent==null)&&u(X,""),Y?D(y.dynamicChildren,Y,X,P,G,kr(T,E),$):Z||N(y,T,X,null,P,G,kr(T,E),$,!1),te>0){if(te&16)B(X,ie,ue,P,E);else if(te&2&&ie.class!==ue.class&&i(X,"class",null,ue.class,E),te&4&&i(X,"style",ie.style,ue.style,E),te&8){const we=T.dynamicProps;for(let Ee=0;Ee<we.length;Ee++){const C=we[Ee],Q=ie[C],be=ue[C];(be!==Q||C==="value")&&i(X,C,Q,be,E,P)}}te&1&&y.children!==T.children&&u(X,T.children)}else!Z&&Y==null&&B(X,ie,ue,P,E);((ye=ue.onVnodeUpdated)||pe)&&ht(()=>{ye&&Zt(ye,P,T,y),pe&&Es(T,y,P,"updated")},G)},D=(y,T,P,G,E,$,Z)=>{for(let X=0;X<T.length;X++){const te=y[X],Y=T[X],pe=te.el&&(te.type===Tt||!vs(te,Y)||te.shapeFlag&198)?d(te.el):P;g(te,Y,pe,null,G,E,$,Z,!0)}},B=(y,T,P,G,E)=>{if(T!==P){if(T!==Me)for(const $ in T)!Ks($)&&!($ in P)&&i(y,$,T[$],null,E,G);for(const $ in P){if(Ks($))continue;const Z=P[$],X=T[$];Z!==X&&$!=="value"&&i(y,$,X,Z,E,G)}"value"in P&&i(y,"value",T.value,P.value,E)}},F=(y,T,P,G,E,$,Z,X,te)=>{const Y=T.el=y?y.el:r(""),pe=T.anchor=y?y.anchor:r("");let{patchFlag:ie,dynamicChildren:ue,slotScopeIds:ye}=T;ye&&(X=X?X.concat(ye):ye),y==null?(n(Y,P,G),n(pe,P,G),S(T.children||[],P,pe,E,$,Z,X,te)):ie>0&&ie&64&&ue&&y.dynamicChildren&&y.dynamicChildren.length===ue.length?(D(y.dynamicChildren,ue,P,E,$,Z,X),(T.key!=null||E&&T===E.subTree)&&Wo(y,T,!0)):N(y,T,P,pe,E,$,Z,X,te)},M=(y,T,P,G,E,$,Z,X,te)=>{T.slotScopeIds=X,y==null?T.shapeFlag&512?E.ctx.activate(T,P,G,Z,te):W(T,P,G,E,$,Z,te):U(y,T,te)},W=(y,T,P,G,E,$,Z)=>{const X=y.component=bp(y,G,E);if(Ei(y)&&(X.ctx.renderer=ge),xp(X,!1,Z),X.asyncDep){if(E&&E.registerDep(X,j,Z),!y.el){const te=X.subTree=at(dt);A(null,te,T,P),y.placeholder=te.el}}else j(X,y,T,P,E,$,Z)},U=(y,T,P)=>{const G=T.component=y.component;if(tb(y,T,P))if(G.asyncDep&&!G.asyncResolved){_(G,T,P);return}else G.next=T,G.update();else T.el=y.el,G.vnode=T},j=(y,T,P,G,E,$,Z)=>{const X=()=>{if(y.isMounted){let{next:ie,bu:ue,u:ye,parent:we,vnode:Ee}=y;{const Je=op(y);if(Je){ie&&(ie.el=Ee.el,_(y,ie,Z)),Je.asyncDep.then(()=>{ht(()=>{y.isUnmounted||Y()},E)});return}}let C=ie,Q;kn(y,!1),ie?(ie.el=Ee.el,_(y,ie,Z)):ie=Ee,ue&&ca(ue),(Q=ie.props&&ie.props.onVnodeBeforeUpdate)&&Zt(Q,we,ie,Ee),kn(y,!0);const be=Xi(y),De=y.subTree;y.subTree=be,g(De,be,d(De.el),z(De),y,E,$),ie.el=be.el,C===null&&Xl(y,be.el),ye&&ht(ye,E),(Q=ie.props&&ie.props.onVnodeUpdated)&&ht(()=>Zt(Q,we,ie,Ee),E)}else{let ie;const{el:ue,props:ye}=T,{bm:we,m:Ee,parent:C,root:Q,type:be}=y,De=Ws(T);if(kn(y,!1),we&&ca(we),!De&&(ie=ye&&ye.onVnodeBeforeMount)&&Zt(ie,C,T),kn(y,!0),ue&&Le){const Je=()=>{y.subTree=Xi(y),Le(ue,y.subTree,y,E,null)};De&&be.__asyncHydrate?be.__asyncHydrate(ue,y,Je):Je()}else{Q.ce&&Q.ce._hasShadowRoot()&&Q.ce._injectChildStyle(be,y.parent?y.parent.type:void 0);const Je=y.subTree=Xi(y);g(null,Je,P,G,y,E,$),T.el=Je.el}if(Ee&&ht(Ee,E),!De&&(ie=ye&&ye.onVnodeMounted)){const Je=T;ht(()=>Zt(ie,C,Je),E)}(T.shapeFlag&256||C&&Ws(C.vnode)&&C.vnode.shapeFlag&256)&&y.a&&ht(y.a,E),y.isMounted=!0,T=P=G=null}};y.scope.on();const te=y.effect=new ai(X);y.scope.off();const Y=y.update=te.run.bind(te),pe=y.job=te.runIfDirty.bind(te);pe.i=y,pe.id=y.uid,te.scheduler=()=>Do(pe),kn(y,!0),Y()},_=(y,T,P)=>{T.component=y;const G=y.vnode.props;y.vnode=T,y.next=null,nb(y,T.props,G,P),rb(y,T.children,P),Ys(),Xc(y),Qs()},N=(y,T,P,G,E,$,Z,X,te=!1)=>{const Y=y&&y.children,pe=y?y.shapeFlag:0,ie=T.children,{patchFlag:ue,shapeFlag:ye}=T;if(ue>0){if(ue&128){re(Y,ie,P,G,E,$,Z,X,te);return}else if(ue&256){V(Y,ie,P,G,E,$,Z,X,te);return}}ye&8?(pe&16&&Ie(Y,E,$),ie!==Y&&u(P,ie)):pe&16?ye&16?re(Y,ie,P,G,E,$,Z,X,te):Ie(Y,E,$,!0):(pe&8&&u(P,""),ye&16&&S(ie,P,G,E,$,Z,X,te))},V=(y,T,P,G,E,$,Z,X,te)=>{y=y||la,T=T||la;const Y=y.length,pe=T.length,ie=Math.min(Y,pe);let ue;for(ue=0;ue<ie;ue++){const ye=T[ue]=te?Us(T[ue]):Yt(T[ue]);g(y[ue],ye,P,null,E,$,Z,X,te)}Y>pe?Ie(y,E,$,!0,!1,ie):S(T,P,G,E,$,Z,X,te,ie)},re=(y,T,P,G,E,$,Z,X,te)=>{let Y=0;const pe=T.length;let ie=y.length-1,ue=pe-1;for(;Y<=ie&&Y<=ue;){const ye=y[Y],we=T[Y]=te?Us(T[Y]):Yt(T[Y]);if(vs(ye,we))g(ye,we,P,null,E,$,Z,X,te);else break;Y++}for(;Y<=ie&&Y<=ue;){const ye=y[ie],we=T[ue]=te?Us(T[ue]):Yt(T[ue]);if(vs(ye,we))g(ye,we,P,null,E,$,Z,X,te);else break;ie--,ue--}if(Y>ie){if(Y<=ue){const ye=ue+1,we=ye<pe?T[ye].el:G;for(;Y<=ue;)g(null,T[Y]=te?Us(T[Y]):Yt(T[Y]),P,we,E,$,Z,X,te),Y++}}else if(Y>ue)for(;Y<=ie;)se(y[Y],E,$,!0),Y++;else{const ye=Y,we=Y,Ee=new Map;for(Y=we;Y<=ue;Y++){const st=T[Y]=te?Us(T[Y]):Yt(T[Y]);st.key!=null&&Ee.set(st.key,Y)}let C,Q=0;const be=ue-we+1;let De=!1,Je=0;const We=new Array(be);for(Y=0;Y<be;Y++)We[Y]=0;for(Y=ye;Y<=ie;Y++){const st=y[Y];if(Q>=be){se(st,E,$,!0);continue}let Ye;if(st.key!=null)Ye=Ee.get(st.key);else for(C=we;C<=ue;C++)if(We[C-we]===0&&vs(st,T[C])){Ye=C;break}Ye===void 0?se(st,E,$,!0):(We[Ye-we]=Y+1,Ye>=Je?Je=Ye:De=!0,g(st,T[Ye],P,null,E,$,Z,X,te),Q++)}const Ct=De?ob(We):la;for(C=Ct.length-1,Y=be-1;Y>=0;Y--){const st=we+Y,Ye=T[st],sn=T[st+1],xn=st+1<pe?sn.el||cp(sn):G;We[Y]===0?g(null,Ye,P,xn,E,$,Z,X,te):De&&(C<0||Y!==Ct[C]?ve(Ye,P,xn,2):C--)}}},ve=(y,T,P,G,E=null)=>{const{el:$,type:Z,transition:X,children:te,shapeFlag:Y}=y;if(Y&6){ve(y.component.subTree,T,P,G);return}if(Y&128){y.suspense.move(T,P,G);return}if(Y&64){Z.move(y,T,P,ge);return}if(Z===Tt){n($,T,P);for(let ie=0;ie<te.length;ie++)ve(te[ie],T,P,G);n(y.anchor,T,P);return}if(Z===Ln){v(y,T,P);return}if(G!==2&&Y&1&&X)if(G===0)X.persisted&&!$[cs]?n($,T,P):(X.beforeEnter($),n($,T,P),ht(()=>X.enter($),E));else{const{leave:ie,delayLeave:ue,afterLeave:ye}=X,we=()=>{y.ctx.isUnmounted?a($):n($,T,P)},Ee=()=>{const C=$._isLeaving||!!$[cs];$._isLeaving&&$[cs](!0),X.persisted&&!C?we():ie($,()=>{we(),ye&&ye()})};ue?ue($,we,Ee):Ee()}else n($,T,P)},se=(y,T,P,G=!1,E=!1)=>{const{type:$,props:Z,ref:X,children:te,dynamicChildren:Y,shapeFlag:pe,patchFlag:ie,dirs:ue,cacheIndex:ye,memo:we}=y;if(ie===-2&&(E=!1),X!=null&&(Ys(),da(X,null,P,y,!0),Qs()),ye!=null&&(T.renderCache[ye]=void 0),pe&256){T.ctx.deactivate(y);return}const Ee=pe&1&&ue,C=!Ws(y);let Q;if(C&&(Q=Z&&Z.onVnodeBeforeUnmount)&&Zt(Q,T,y),pe&6)ce(y.component,P,G);else{if(pe&128){y.suspense.unmount(P,G);return}Ee&&Es(y,null,T,"beforeUnmount"),pe&64?y.type.remove(y,T,P,ge,G):Y&&!Y.hasOnce&&($!==Tt||ie>0&&ie&64)?Ie(Y,T,P,!1,!0):($===Tt&&ie&384||!E&&pe&16)&&Ie(te,T,P),G&&de(y)}const be=we!=null&&ye==null;(C&&(Q=Z&&Z.onVnodeUnmounted)||Ee||be)&&ht(()=>{Q&&Zt(Q,T,y),Ee&&Es(y,null,T,"unmounted"),be&&(y.el=null)},P)},de=y=>{const{type:T,el:P,anchor:G,transition:E}=y;if(T===Tt){J(P,G);return}if(T===Ln){x(y);return}const $=()=>{a(P),E&&!E.persisted&&E.afterLeave&&E.afterLeave()};if(y.shapeFlag&1&&E&&!E.persisted){const{leave:Z,delayLeave:X}=E,te=()=>Z(P,$);X?X(y.el,$,te):te()}else $()},J=(y,T)=>{let P;for(;y!==T;)P=f(y),a(y),y=P;a(T)},ce=(y,T,P)=>{const{bum:G,scope:E,job:$,subTree:Z,um:X,m:te,a:Y}=y;hl(te),hl(Y),G&&ca(G),E.stop(),$&&($.flags|=8,se(Z,y,T,P)),X&&ht(X,T),ht(()=>{y.isUnmounted=!0},T)},Ie=(y,T,P,G=!1,E=!1,$=0)=>{for(let Z=$;Z<y.length;Z++)se(y[Z],T,P,G,E)},z=y=>{if(y.shapeFlag&6)return z(y.component.subTree);if(y.shapeFlag&128)return y.suspense.next();const T=f(y.anchor||y.el),P=T&&T[Nf];return P?f(P):T};let oe=!1;const le=(y,T,P)=>{let G;y==null?T._vnode&&(se(T._vnode,null,null,!0),G=T._vnode.component):g(T._vnode||null,y,T,null,null,null,P),T._vnode=y,oe||(oe=!0,Xc(G),dl(),oe=!1)},ge={p:g,um:se,m:ve,r:de,mt:W,mc:S,pc:N,pbc:D,n:z,o:e};let me,Le;return t&&([me,Le]=t(ge)),{render:le,hydrate:me,createApp:Wv(le,me)}}function kr({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function kn({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function rp(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function Wo(e,t,s=!1){const n=e.children,a=t.children;if(fe(n)&&fe(a))for(let i=0;i<n.length;i++){const l=n[i];let r=a[i];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=a[i]=Us(a[i]),r.el=l.el),!s&&r.patchFlag!==-2&&Wo(l,r)),r.type===gn&&(r.patchFlag===-1&&(r=a[i]=Us(r)),r.el=l.el),r.type===dt&&!r.el&&(r.el=l.el)}}function ob(e){const t=e.slice(),s=[0];let n,a,i,l,r;const o=e.length;for(n=0;n<o;n++){const c=e[n];if(c!==0){if(a=s[s.length-1],e[a]<c){t[n]=a,s.push(n);continue}for(i=0,l=s.length-1;i<l;)r=i+l>>1,e[s[r]]<c?i=r+1:l=r;c<e[s[i]]&&(i>0&&(t[n]=s[i-1]),s[i]=n)}}for(i=s.length,l=s[i-1];i-- >0;)s[i]=l,l=t[l];return s}function op(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:op(t)}function hl(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function cp(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?cp(t.subTree):null}const gl=e=>e.__isSuspense;let Xr=0;const cb={name:"Suspense",__isSuspense:!0,process(e,t,s,n,a,i,l,r,o,c){if(e==null)db(t,s,n,a,i,l,r,o,c);else{if(i&&i.deps>0&&!e.suspense.isInFallback){t.suspense=e.suspense,t.suspense.vnode=t,t.el=e.el;return}fb(e,t,s,n,a,l,r,o,c)}},hydrate:pb,normalize:hb},ub=cb;function di(e,t){const s=e.props&&e.props[t];_e(s)&&s()}function db(e,t,s,n,a,i,l,r,o){const{p:c,o:{createElement:u}}=o,d=u("div"),f=e.suspense=up(e,a,n,t,d,s,i,l,r,o);c(null,f.pendingBranch=e.ssContent,d,null,n,f,i,l),f.deps>0?(di(e,"onPending"),di(e,"onFallback"),c(null,e.ssFallback,t,s,n,null,i,l),fa(f,e.ssFallback)):f.resolve(!1,!0)}function fb(e,t,s,n,a,i,l,r,{p:o,um:c,o:{createElement:u}}){const d=t.suspense=e.suspense;d.vnode=t,t.el=e.el;const f=t.ssContent,p=t.ssFallback,{activeBranch:m,pendingBranch:g,isInFallback:w,isHydrating:A}=d;if(g)d.pendingBranch=f,vs(g,f)?(o(g,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():w&&(A||(o(m,p,s,n,a,null,i,l,r),fa(d,p)))):(d.pendingId=Xr++,A?(d.isHydrating=!1,d.activeBranch=g):c(g,a,d),d.deps=0,d.effects.length=0,d.hiddenContainer=u("div"),w?(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():(o(m,p,s,n,a,null,i,l,r),fa(d,p))):m&&vs(m,f)?(o(m,f,s,n,a,d,i,l,r),d.resolve(!0)):(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0&&d.resolve()));else if(m&&vs(m,f))o(m,f,s,n,a,d,i,l,r),fa(d,f);else if(di(t,"onPending"),d.pendingBranch=f,f.shapeFlag&512?d.pendingId=f.component.suspenseId:d.pendingId=Xr++,o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0)d.resolve();else{const{timeout:b,pendingId:v}=d;b>0?setTimeout(()=>{d.pendingId===v&&d.fallback(p)},b):b===0&&d.fallback(p)}}function up(e,t,s,n,a,i,l,r,o,c,u=!1){const{p:d,m:f,um:p,n:m,o:{parentNode:g,remove:w}}=c;let A;const b=gb(e);b&&t&&t.pendingBranch&&(A=t.pendingId,t.deps++);const v=e.props?ll(e.props.timeout):void 0,x=i,R={vnode:e,parent:t,parentComponent:s,namespace:l,container:n,hiddenContainer:a,deps:0,pendingId:Xr++,timeout:typeof v=="number"?v:-1,activeBranch:null,isFallbackMountPending:!1,pendingBranch:null,isInFallback:!u,isHydrating:u,isUnmounted:!1,effects:[],resolve(L=!1,O=!1){const{vnode:S,activeBranch:I,pendingBranch:D,pendingId:B,effects:F,parentComponent:M,container:W,isInFallback:U}=R;let j=!1;if(R.isHydrating)R.isHydrating=!1;else if(!L){j=I&&D.transition&&D.transition.mode==="out-in";let V=!1;j&&(I.transition.afterLeave=()=>{B===R.pendingId&&(f(D,W,i===x&&!V?m(I):i,0),ri(F),U&&S.ssFallback&&(S.ssFallback.el=null))}),I&&!R.isFallbackMountPending&&(g(I.el)===W&&(i=m(I),V=!0),p(I,M,R,!0),!j&&U&&S.ssFallback&&ht(()=>S.ssFallback.el=null,R)),j||f(D,W,i,0)}R.isFallbackMountPending=!1,fa(R,D),R.pendingBranch=null,R.isInFallback=!1;let _=R.parent,N=!1;for(;_;){if(_.pendingBranch){_.effects.push(...F),N=!0;break}_=_.parent}!N&&!j&&ri(F),R.effects=[],b&&t&&t.pendingBranch&&A===t.pendingId&&(t.deps--,t.deps===0&&!O&&t.resolve()),di(S,"onResolve")},fallback(L){if(!R.pendingBranch)return;const{vnode:O,activeBranch:S,parentComponent:I,container:D,namespace:B}=R;di(O,"onFallback");const F=m(S),M=()=>{R.isFallbackMountPending=!1,R.isInFallback&&(d(null,L,D,F,I,null,B,r,o),fa(R,L))},W=L.transition&&L.transition.mode==="out-in";W&&(R.isFallbackMountPending=!0,S.transition.afterLeave=M),R.isInFallback=!0,p(S,I,null,!0),W||M()},move(L,O,S){R.activeBranch&&f(R.activeBranch,L,O,S),R.container=L},next(){return R.activeBranch&&m(R.activeBranch)},registerDep(L,O,S){const I=!!R.pendingBranch;I&&R.deps++;const D=L.vnode.el;L.asyncDep.catch(B=>{jn(B,L,0)}).then(B=>{if(L.isUnmounted||R.isUnmounted||R.pendingId!==L.suspenseId)return;hi(),L.asyncResolved=!0;const{vnode:F}=L;eo(L,B,!1),D&&(F.el=D);const M=!D&&L.subTree.el;O(L,F,g(D||L.subTree.el),D?null:m(L.subTree),R,l,S),M&&(F.placeholder=null,w(M)),Xl(L,F.el),I&&--R.deps===0&&R.resolve()})},unmount(L,O){R.isUnmounted=!0,R.activeBranch&&p(R.activeBranch,s,L,O),R.pendingBranch&&p(R.pendingBranch,s,L,O)}};return R}function pb(e,t,s,n,a,i,l,r,o){const c=t.suspense=up(t,n,s,e.parentNode,document.createElement("div"),null,a,i,l,r,!0),u=o(e,c.pendingBranch=t.ssContent,s,c,i,l);return c.deps===0&&c.resolve(!1,!0),u}function hb(e){const{shapeFlag:t,children:s}=e,n=t&32;e.ssContent=pu(n?s.default:s),e.ssFallback=n?pu(s.fallback):at(dt)}function pu(e){let t;if(_e(e)){const s=Pn&&e._c;s&&(e._d=!1,fi()),e=e(),s&&(e._d=!0,t=Ft,fp())}return fe(e)&&(e=Qv(e)),e=Yt(e),t&&!e.dynamicChildren&&(e.dynamicChildren=t.filter(s=>s!==e)),e}function dp(e,t){t&&t.pendingBranch?fe(e)?t.effects.push(...e):t.effects.push(e):ri(e)}function fa(e,t){e.activeBranch=t;const{vnode:s,parentComponent:n}=e;let a=t.el;for(;!a&&t.component;)t=t.component.subTree,a=t.el;s.el=a,n&&n.subTree===s&&(n.vnode.el=a,Xl(n,a))}function gb(e){const t=e.props&&e.props.suspensible;return t!=null&&t!==!1}const Tt=Symbol.for("v-fgt"),gn=Symbol.for("v-txt"),dt=Symbol.for("v-cmt"),Ln=Symbol.for("v-stc"),Qa=[];let Ft=null;function fi(e=!1){Qa.push(Ft=e?null:[])}function fp(){Qa.pop(),Ft=Qa[Qa.length-1]||null}let Pn=1;function pi(e,t=!1){Pn+=e,e<0&&Ft&&t&&(Ft.hasOnce=!0)}function pp(e){return e.dynamicChildren=Pn>0?Ft||la:null,fp(),Pn>0&&Ft&&Ft.push(e),e}function mb(e,t,s,n,a,i){return pp(Zo(e,t,s,n,a,i,!0))}function ml(e,t,s,n,a){return pp(at(e,t,s,n,a,!0))}function en(e){return e?e.__v_isVNode===!0:!1}function vs(e,t){return e.type===t.type&&e.key===t.key}function vb(e){}const hp=({key:e})=>e??null,el=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?Te(e)||mt(e)||_e(e)?{i:It,r:e,k:t,f:!!s}:e:null);function Zo(e,t=null,s=null,n=0,a=null,i=e===Tt?0:1,l=!1,r=!1){const o={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&hp(t),ref:t&&el(t),scopeId:Gl,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:n,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:It};return r?(Yo(o,s),i&128&&e.normalize(o)):s&&(o.shapeFlag|=Te(s)?8:16),Pn>0&&!l&&Ft&&(o.patchFlag>0||i&6)&&o.patchFlag!==32&&Ft.push(o),o}const at=bb;function bb(e,t=null,s=null,n=0,a=null,i=!1){if((!e||e===jf)&&(e=dt),en(e)){const r=Ns(e,t,!0);return s&&Yo(r,s),Pn>0&&!i&&Ft&&(r.shapeFlag&6?Ft[Ft.indexOf(e)]=r:Ft.push(r)),r.patchFlag=-2,r}if(Tb(e)&&(e=e.__vccOpts),t){t=gp(t);let{class:r,style:o}=t;r&&!Te(r)&&(t.class=wi(r)),Be(o)&&(Si(o)&&!fe(o)&&(o=Oe({},o)),t.style=ki(o))}const l=Te(e)?1:gl(e)?128:Lf(e)?64:Be(e)?4:_e(e)?2:0;return Zo(e,t,s,n,a,l,i,!0)}function gp(e){return e?Si(e)||Qf(e)?Oe({},e):e:null}function Ns(e,t,s=!1,n=!1){const{props:a,ref:i,patchFlag:l,children:r,transition:o}=e,c=t?vp(a||{},t):a,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&hp(c),ref:t&&t.ref?s&&i?fe(i)?i.concat(el(t)):[i,el(t)]:el(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:r,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==Tt?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:o,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Ns(e.ssContent),ssFallback:e.ssFallback&&Ns(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return o&&n&&Xs(u,o.clone(u)),u}function Jo(e=" ",t=0){return at(gn,null,e,t)}function yb(e,t){const s=at(Ln,null,e);return s.staticCount=t,s}function mp(e="",t=!1){return t?(fi(),ml(dt,null,e)):at(dt,null,e)}function Yt(e){return e==null||typeof e=="boolean"?at(dt):fe(e)?at(Tt,null,e.slice()):en(e)?Us(e):at(gn,null,String(e))}function Us(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Ns(e)}function Yo(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(fe(t))s=16;else if(typeof t=="object")if(n&65){const a=t.default;a&&(a._c&&(a._d=!1),Yo(e,a()),a._c&&(a._d=!0));return}else{s=32;const a=t._;!a&&!Qf(t)?t._ctx=It:a===3&&It&&(It.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else _e(t)?(t={default:t,_ctx:It},s=32):(t=String(t),n&64?(s=16,t=[Jo(t)]):s=8);e.children=t,e.shapeFlag|=s}function vp(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const a in n)if(a==="class")t.class!==n.class&&(t.class=wi([t.class,n.class]));else if(a==="style")t.style=ki([t.style,n.style]);else if(Bn(a)){const i=t[a],l=n[a];l&&i!==l&&!(fe(i)&&i.includes(l))?t[a]=i?[].concat(i,l):l:l==null&&i==null&&!Pl(a)&&(t[a]=l)}else a!==""&&(t[a]=n[a])}return t}function Zt(e,t,s,n=null){as(e,t,7,[s,n])}const xb=Kf();let _b=0;function bp(e,t,s){const n=e.type,a=(t?t.appContext:e.appContext)||xb,i={uid:_b++,vnode:e,type:n,parent:t,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Eo(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(a.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:ep(n,a),emitsOptions:Wf(n,a),emit:null,emitted:null,propsDefaults:Me,inheritAttrs:n.inheritAttrs,ctx:Me,data:Me,props:Me,attrs:Me,slots:Me,refs:Me,setupState:Me,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=Jv.bind(null,i),e.ce&&e.ce(i),i}let Rt=null;const qt=()=>Rt||It;let vl,pa;{const e=Hl(),t=(s,n)=>{let a;return(a=e[s])||(a=e[s]=[]),a.push(n),i=>{a.length>1?a.forEach(l=>l(i)):a[0](i)}};vl=t("__VUE_INSTANCE_SETTERS__",s=>Rt=s),pa=t("__VUE_SSR_SETTERS__",s=>Fn=s)}const Ra=e=>{const t=Rt;return vl(e),e.scope.on(),()=>{e.scope.off(),vl(t)}},hi=()=>{Rt&&Rt.scope.off(),vl(null)};function yp(e){return e.vnode.shapeFlag&4}let Fn=!1;function xp(e,t=!1,s=!1){t&&pa(t);const{props:n,children:a}=e.vnode,i=yp(e);sb(e,n,i,t),lb(e,a,s||t);const l=i?kb(e,t):void 0;return t&&pa(!1),l}function kb(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Zr);const{setup:n}=s;if(n){Ys();const a=e.setupContext=n.length>1?wp(e):null,i=Ra(e),l=Aa(n,e,0,[e.props,a]),r=Co(l);if(Qs(),i(),(r||e.sp)&&!Ws(e)&&$o(e),r){if(l.then(hi,hi),t)return l.then(o=>{eo(e,o,t)}).catch(o=>{jn(o,e,0)});e.asyncDep=l}else eo(e,l,t)}else kp(e,t)}function eo(e,t,s){_e(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Be(t)&&(e.setupState=Oo(t)),kp(e,s)}let bl,to;function _p(e){bl=e,to=t=>{t.render._rc&&(t.withProxy=new Proxy(t.ctx,Av))}}const wb=()=>!bl;function kp(e,t,s){const n=e.type;if(!e.render){if(!t&&bl&&!n.render){const a=n.template||qo(e).template;if(a){const{isCustomElement:i,compilerOptions:l}=e.appContext.config,{delimiters:r,compilerOptions:o}=n,c=Oe(Oe({isCustomElement:i,delimiters:r},l),o);n.render=bl(a,c)}}e.render=n.render||Nt,to&&to(e)}{const a=Ra(e);Ys();try{Vv(e)}finally{Qs(),a()}}}const Sb={get(e,t){return Pt(e,"get",""),e[t]}};function wp(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Sb),slots:e.slots,emit:e.emit,expose:t}}function Ai(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Oo(vf(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Ya)return Ya[s](e)},has(t,s){return s in t||s in Ya}})):e.proxy}function so(e,t=!0){return _e(e)?e.displayName||e.name:e.name||t&&e.__name}function Tb(e){return _e(e)&&"__vccOpts"in e}const ee=(e,t)=>Nm(e,t,Fn);function va(e,t,s){try{pi(-1);const n=arguments.length;return n===2?Be(t)&&!fe(t)?en(t)?at(e,null,[t]):at(e,t):at(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&en(s)&&(s=[s]),at(e,t,s))}finally{pi(1)}}function Cb(){}function Eb(e,t,s,n){const a=s[n];if(a&&Sp(a,e))return a;const i=t();return i.memo=e.slice(),i.cacheIndex=n,s[n]=i}function Sp(e,t){const s=e.memo;if(s.length!=t.length)return!1;for(let n=0;n<s.length;n++)if(wt(s[n],t[n]))return!1;return Pn>0&&Ft&&Ft.push(e),!0}const Tp="3.5.38",Ab=Nt,Rb=Bm,Ib=ta,Nb=Cf,Lb={createComponentInstance:bp,setupComponent:xp,renderComponentRoot:Xi,setCurrentRenderingInstance:ci,isVNode:en,normalizeVNode:Yt,getComponentPublicInstance:Ai,ensureValidVNode:zo,pushWarningContext:Pm,popWarningContext:Fm},Ob=Lb,Db=null,Mb=null,Pb=null;/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let no;const hu=typeof window<"u"&&window.trustedTypes;if(hu)try{no=hu.createPolicy("vue",{createHTML:e=>e})}catch{}const Cp=no?e=>no.createHTML(e):e=>e,Fb="http://www.w3.org/2000/svg",$b="http://www.w3.org/1998/Math/MathML",$s=typeof document<"u"?document:null,gu=$s&&$s.createElement("template"),Ep={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const a=t==="svg"?$s.createElementNS(Fb,e):t==="mathml"?$s.createElementNS($b,e):s?$s.createElement(e,{is:s}):$s.createElement(e);return e==="select"&&n&&n.multiple!=null&&a.setAttribute("multiple",n.multiple),a},createText:e=>$s.createTextNode(e),createComment:e=>$s.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>$s.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,a,i){const l=s?s.previousSibling:t.lastChild;if(a&&(a===i||a.nextSibling))for(;t.insertBefore(a.cloneNode(!0),s),!(a===i||!(a=a.nextSibling)););else{gu.innerHTML=Cp(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const r=gu.content;if(n==="svg"||n==="mathml"){const o=r.firstChild;for(;o.firstChild;)r.appendChild(o.firstChild);r.removeChild(o)}t.insertBefore(r,s)}return[l?l.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},ln="transition",Pa="animation",ba=Symbol("_vtc"),Ap={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Rp=Oe({},Fo,Ap),Ub=e=>(e.displayName="Transition",e.props=Rp,e),Bb=Ub((e,{slots:t})=>va(Mf,Ip(e),t)),wn=(e,t=[])=>{fe(e)?e.forEach(s=>s(...t)):e&&e(...t)},mu=e=>e?fe(e)?e.some(t=>t.length>1):e.length>1:!1;function Ip(e){const t={};for(const F in e)F in Ap||(t[F]=e[F]);if(e.css===!1)return t;const{name:s="v",type:n,duration:a,enterFromClass:i=`${s}-enter-from`,enterActiveClass:l=`${s}-enter-active`,enterToClass:r=`${s}-enter-to`,appearFromClass:o=i,appearActiveClass:c=l,appearToClass:u=r,leaveFromClass:d=`${s}-leave-from`,leaveActiveClass:f=`${s}-leave-active`,leaveToClass:p=`${s}-leave-to`}=e,m=Hb(a),g=m&&m[0],w=m&&m[1],{onBeforeEnter:A,onEnter:b,onEnterCancelled:v,onLeave:x,onLeaveCancelled:R,onBeforeAppear:L=A,onAppear:O=b,onAppearCancelled:S=v}=t,I=(F,M,W,U)=>{F._enterCancelled=U,un(F,M?u:r),un(F,M?c:l),W&&W()},D=(F,M)=>{F._isLeaving=!1,un(F,d),un(F,p),un(F,f),M&&M()},B=F=>(M,W)=>{const U=F?O:b,j=()=>I(M,F,W);wn(U,[M,j]),vu(()=>{un(M,F?o:i),ws(M,F?u:r),mu(U)||bu(M,n,g,j)})};return Oe(t,{onBeforeEnter(F){wn(A,[F]),ws(F,i),ws(F,l)},onBeforeAppear(F){wn(L,[F]),ws(F,o),ws(F,c)},onEnter:B(!1),onAppear:B(!0),onLeave(F,M){F._isLeaving=!0;const W=()=>D(F,M);ws(F,d),F._enterCancelled?(ws(F,f),ao(F)):(ao(F),ws(F,f)),vu(()=>{F._isLeaving&&(un(F,d),ws(F,p),mu(x)||bu(F,n,w,W))}),wn(x,[F,W])},onEnterCancelled(F){I(F,!1,void 0,!0),wn(v,[F])},onAppearCancelled(F){I(F,!0,void 0,!0),wn(S,[F])},onLeaveCancelled(F){D(F),wn(R,[F])}})}function Hb(e){if(e==null)return null;if(Be(e))return[wr(e.enter),wr(e.leave)];{const t=wr(e);return[t,t]}}function wr(e){return ll(e)}function ws(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ba]||(e[ba]=new Set)).add(t)}function un(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[ba];s&&(s.delete(t),s.size||(e[ba]=void 0))}function vu(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Vb=0;function bu(e,t,s,n){const a=e._endId=++Vb,i=()=>{a===e._endId&&n()};if(s!=null)return setTimeout(i,s);const{type:l,timeout:r,propCount:o}=Np(e,t);if(!l)return n();const c=l+"end";let u=0;const d=()=>{e.removeEventListener(c,f),i()},f=p=>{p.target===e&&++u>=o&&d()};setTimeout(()=>{u<o&&d()},r+1),e.addEventListener(c,f)}function Np(e,t){const s=window.getComputedStyle(e),n=m=>(s[m]||"").split(", "),a=n(`${ln}Delay`),i=n(`${ln}Duration`),l=yu(a,i),r=n(`${Pa}Delay`),o=n(`${Pa}Duration`),c=yu(r,o);let u=null,d=0,f=0;t===ln?l>0&&(u=ln,d=l,f=i.length):t===Pa?c>0&&(u=Pa,d=c,f=o.length):(d=Math.max(l,c),u=d>0?l>c?ln:Pa:null,f=u?u===ln?i.length:o.length:0);const p=u===ln&&/\b(?:transform|all)(?:,|$)/.test(n(`${ln}Property`).toString());return{type:u,timeout:d,propCount:f,hasTransform:p}}function yu(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>xu(s)+xu(e[n])))}function xu(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function ao(e){return(e?e.ownerDocument:document).body.offsetHeight}function jb(e,t,s){const n=e[ba];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const yl=Symbol("_vod"),Qo=Symbol("_vsh"),Lp={name:"show",beforeMount(e,{value:t},{transition:s}){e[yl]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):Fa(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),Fa(e,!0),n.enter(e)):n.leave(e,()=>{Fa(e,!1)}):Fa(e,t))},beforeUnmount(e,{value:t}){Fa(e,t)}};function Fa(e,t){e.style.display=t?e[yl]:"none",e[Qo]=!t}function zb(){Lp.getSSRProps=({value:e})=>{if(!e)return{style:{display:"none"}}}}const Op=Symbol("");function qb(e){const t=qt();if(!t)return;const s=t.ut=(a=e(t.proxy))=>{Array.from(document.querySelectorAll(`[data-v-owner="${t.uid}"]`)).forEach(i=>xl(i,a))},n=()=>{const a=e(t.proxy);t.ce?xl(t.ce,a):io(t.subTree,a),s(a)};Ho(()=>{ri(n)}),$e(()=>{ns(n,Nt,{flush:"post"});const a=new MutationObserver(n);a.observe(t.subTree.el.parentNode,{childList:!0}),ft(()=>a.disconnect())})}function io(e,t){if(e.shapeFlag&128){const s=e.suspense;e=s.activeBranch,s.pendingBranch&&!s.isHydrating&&s.effects.push(()=>{io(s.activeBranch,t)})}for(;e.component;)e=e.component.subTree;if(e.shapeFlag&1&&e.el)xl(e.el,t);else if(e.type===Tt)e.children.forEach(s=>io(s,t));else if(e.type===Ln){let{el:s,anchor:n}=e;for(;s&&(xl(s,t),s!==n);)s=s.nextSibling}}function xl(e,t){if(e.nodeType===1){const s=e.style;let n="";for(const a in t){const i=Yg(t[a]);s.setProperty(`--${a}`,i),n+=`--${a}: ${i};`}s[Op]=n}}const Kb=/(?:^|;)\s*display\s*:/;function Gb(e,t,s){const n=e.style,a=Te(s);let i=!1;if(s&&!a){if(t)if(Te(t))for(const l of t.split(";")){const r=l.slice(0,l.indexOf(":")).trim();s[r]==null&&Ka(n,r,"")}else for(const l in t)s[l]==null&&Ka(n,l,"");for(const l in s){l==="display"&&(i=!0);const r=s[l];r!=null?Zb(e,l,!Te(t)&&t?t[l]:void 0,r)||Ka(n,l,r):Ka(n,l,"")}}else if(a){if(t!==s){const l=n[Op];l&&(s+=";"+l),n.cssText=s,i=Kb.test(s)}}else t&&e.removeAttribute("style");yl in e&&(e[yl]=i?n.display:"",e[Qo]&&(n.display="none"))}const _u=/\s*!important$/;function Ka(e,t,s){if(fe(s))s.forEach(n=>Ka(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Wb(e,t);_u.test(s)?e.setProperty(Qt(n),s.replace(_u,""),"important"):e[n]=s}}const ku=["Webkit","Moz","ms"],Sr={};function Wb(e,t){const s=Sr[t];if(s)return s;let n=Ge(t);if(n!=="filter"&&n in e)return Sr[t]=n;n=Vn(n);for(let a=0;a<ku.length;a++){const i=ku[a]+n;if(i in e)return Sr[t]=i}return t}function Zb(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&Te(n)&&s===n}const wu="http://www.w3.org/1999/xlink";function Su(e,t,s,n,a,i=Zg(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(wu,t.slice(6,t.length)):e.setAttributeNS(wu,t,s):s==null||i&&!Jd(s)?e.removeAttribute(t):e.setAttribute(t,i?"":Ut(s)?String(s):s)}function Tu(e,t,s,n,a){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?Cp(s):s);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const r=i==="OPTION"?e.getAttribute("value")||"":e.value,o=s==null?e.type==="checkbox"?"on":"":String(s);(r!==o||!("_value"in e))&&(e.value=o),s==null&&e.removeAttribute(t),e._value=s;return}let l=!1;if(s===""||s==null){const r=typeof e[t];r==="boolean"?s=Jd(s):s==null&&r==="string"?(s="",l=!0):r==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(a||t)}function js(e,t,s,n){e.addEventListener(t,s,n)}function Jb(e,t,s,n){e.removeEventListener(t,s,n)}const Cu=Symbol("_vei");function Yb(e,t,s,n,a=null){const i=e[Cu]||(e[Cu]={}),l=i[t];if(n&&l)l.value=n;else{const[r,o]=Qb(t);if(n){const c=i[t]=t0(n,a);js(e,r,c,o)}else l&&(Jb(e,r,l,o),i[t]=void 0)}}const Eu=/(?:Once|Passive|Capture)$/;function Qb(e){let t;if(Eu.test(e)){t={};let n;for(;n=e.match(Eu);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Qt(e.slice(2)),t]}let Tr=0;const Xb=Promise.resolve(),e0=()=>Tr||(Xb.then(()=>Tr=0),Tr=Date.now());function t0(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const a=s.value;if(fe(a)){const i=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{i.call(n),n._stopped=!0};const l=a.slice(),r=[n];for(let o=0;o<l.length&&!n._stopped;o++){const c=l[o];c&&as(c,t,5,r)}}else as(a,t,5,[n])};return s.value=e,s.attached=e0(),s}const Au=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Dp=(e,t,s,n,a,i)=>{const l=a==="svg";t==="class"?jb(e,n,l):t==="style"?Gb(e,s,n):Bn(t)?Pl(t)||Yb(e,t,s,n,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):s0(e,t,n,l))?(Tu(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Su(e,t,n,l,i,t!=="value")):e._isVueCE&&(n0(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!Te(n)))?Tu(e,Ge(t),n,i,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Su(e,t,n,l))};function s0(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Au(t)&&_e(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const a=e.tagName;if(a==="IMG"||a==="VIDEO"||a==="CANVAS"||a==="SOURCE")return!1}return Au(t)&&Te(s)?!1:t in e}function n0(e,t){const s=e._def.props;if(!s)return!1;const n=Ge(t);return Array.isArray(s)?s.some(a=>Ge(a)===n):Object.keys(s).some(a=>Ge(a)===n)}const Ru={};function Mp(e,t,s){let n=Ci(e,t);Fl(n)&&(n=Oe({},n,t));class a extends er{constructor(l){super(n,l,s)}}return a.def=n,a}const a0=((e,t)=>Mp(e,t,Wp)),i0=typeof HTMLElement<"u"?HTMLElement:class{};class er extends i0{constructor(t,s={},n=wl){super(),this._def=t,this._props=s,this._createApp=n,this._isVueCE=!0,this._instance=null,this._app=null,this._nonce=this._def.nonce,this._connected=!1,this._resolved=!1,this._patching=!1,this._dirty=!1,this._numberProps=null,this._styleChildren=new WeakSet,this._styleAnchors=new WeakMap,this._ob=null,this.shadowRoot&&n!==wl?this._root=this.shadowRoot:t.shadowRoot!==!1?(this.attachShadow(Oe({},t.shadowRootOptions,{mode:"open"})),this._root=this.shadowRoot):this._root=this}connectedCallback(){if(!this.isConnected)return;!this.shadowRoot&&!this._resolved&&this._parseSlots(),this._connected=!0;let t=this;for(;t=t&&(t.assignedSlot||t.parentNode||t.host);)if(t instanceof er){this._parent=t;break}this._instance||(this._resolved?this._mount(this._def):t&&t._pendingResolve?this._pendingResolve=t._pendingResolve.then(()=>{this._pendingResolve=void 0,this._resolveDef()}):this._resolveDef())}_setParent(t=this._parent){t&&(this._instance.parent=t._instance,this._inheritParentContext(t))}_inheritParentContext(t=this._parent){t&&this._app&&Object.setPrototypeOf(this._app._context.provides,t._instance.provides)}disconnectedCallback(){this._connected=!1,St(()=>{this._connected||(this._ob&&(this._ob.disconnect(),this._ob=null),this._app&&this._app.unmount(),this._instance&&(this._instance.ce=void 0),this._app=this._instance=null,this._teleportTargets&&(this._teleportTargets.clear(),this._teleportTargets=void 0))})}_processMutations(t){for(const s of t)this._setAttr(s.attributeName)}_resolveDef(){if(this._pendingResolve)return;for(let n=0;n<this.attributes.length;n++)this._setAttr(this.attributes[n].name);this._ob=new MutationObserver(this._processMutations.bind(this)),this._ob.observe(this,{attributes:!0});const t=(n,a=!1)=>{this._resolved=!0,this._pendingResolve=void 0;const{props:i,styles:l}=n;let r;if(i&&!fe(i))for(const o in i){const c=i[o];(c===Number||c&&c.type===Number)&&(o in this._props&&(this._props[o]=ll(this._props[o])),(r||(r=Object.create(null)))[Ge(o)]=!0)}this._numberProps=r,this._resolveProps(n),this.shadowRoot&&this._applyStyles(l),this._mount(n)},s=this._def.__asyncLoader;s?this._pendingResolve=s().then(n=>{n.configureApp=this._def.configureApp,t(this._def=n,!0)}):t(this._def)}_mount(t){this._app=this._createApp(t),this._inheritParentContext(),t.configureApp&&t.configureApp(this._app),this._app._ceVNode=this._createVNode(),this._app.mount(this._root);const s=this._instance&&this._instance.exposed;if(s)for(const n in s)He(this,n)||Object.defineProperty(this,n,{get:()=>Rs(s[n])})}_resolveProps(t){const{props:s}=t,n=fe(s)?s:Object.keys(s||{});for(const a of Object.keys(this))a[0]!=="_"&&n.includes(a)&&this._setProp(a,this[a]);for(const a of n.map(Ge))Object.defineProperty(this,a,{get(){return this._getProp(a)},set(i){this._setProp(a,i,!0,!this._patching)}})}_setAttr(t){if(t.startsWith("data-v-"))return;const s=this.hasAttribute(t);let n=s?this.getAttribute(t):Ru;const a=Ge(t);s&&this._numberProps&&this._numberProps[a]&&(n=ll(n)),this._setProp(a,n,!1,!0)}_getProp(t){return this._props[t]}_setProp(t,s,n=!0,a=!1){if(s!==this._props[t]&&(this._dirty=!0,s===Ru?delete this._props[t]:(this._props[t]=s,t==="key"&&this._app&&(this._app._ceVNode.key=s)),a&&this._instance&&this._update(),n)){const i=this._ob;i&&(this._processMutations(i.takeRecords()),i.disconnect()),s===!0?this.setAttribute(Qt(t),""):typeof s=="string"||typeof s=="number"?this.setAttribute(Qt(t),s+""):s||this.removeAttribute(Qt(t)),i&&i.observe(this,{attributes:!0})}}_update(){const t=this._createVNode();this._app&&(t.appContext=this._app._context),Gp(t,this._root)}_createVNode(){const t={};this.shadowRoot||(t.onVnodeMounted=t.onVnodeUpdated=this._renderSlots.bind(this));const s=at(this._def,Oe(t,this._props));return this._instance||(s.ce=n=>{this._instance=n,n.ce=this,n.isCE=!0;const a=(i,l)=>{this.dispatchEvent(new CustomEvent(i,Fl(l[0])?Oe({detail:l},l[0]):{detail:l}))};n.emit=(i,...l)=>{a(i,l),Qt(i)!==i&&a(Qt(i),l)},this._setParent()}),s}_applyStyles(t,s,n){if(!t)return;if(s){if(s===this._def||this._styleChildren.has(s))return;this._styleChildren.add(s)}const a=this._nonce,i=this.shadowRoot,l=n?this._getStyleAnchor(n)||this._getStyleAnchor(this._def):this._getRootStyleInsertionAnchor(i);let r=null;for(let o=t.length-1;o>=0;o--){const c=document.createElement("style");a&&c.setAttribute("nonce",a),c.textContent=t[o],i.insertBefore(c,r||l),r=c,o===0&&(n||this._styleAnchors.set(this._def,c),s&&this._styleAnchors.set(s,c))}}_getStyleAnchor(t){if(!t)return null;const s=this._styleAnchors.get(t);return s&&s.parentNode===this.shadowRoot?s:(s&&this._styleAnchors.delete(t),null)}_getRootStyleInsertionAnchor(t){for(let s=0;s<t.childNodes.length;s++){const n=t.childNodes[s];if(!(n instanceof HTMLStyleElement))return n}return null}_parseSlots(){const t=this._slots={};let s;for(;s=this.firstChild;){const n=s.nodeType===1&&s.getAttribute("slot")||"default";(t[n]||(t[n]=[])).push(s),this.removeChild(s)}}_renderSlots(){const t=this._getSlots(),s=this._instance.type.__scopeId;for(let n=0;n<t.length;n++){const a=t[n],i=a.getAttribute("name")||"default",l=this._slots[i],r=a.parentNode;if(l)for(const o of l){if(s&&o.nodeType===1){const c=s+"-s",u=document.createTreeWalker(o,1);o.setAttribute(c,"");let d;for(;d=u.nextNode();)d.setAttribute(c,"")}r.insertBefore(o,a)}else for(;a.firstChild;)r.insertBefore(a.firstChild,a);r.removeChild(a)}}_getSlots(){const t=[this];this._teleportTargets&&t.push(...this._teleportTargets);const s=new Set;for(const n of t){const a=n.querySelectorAll("slot");for(let i=0;i<a.length;i++)s.add(a[i])}return Array.from(s)}_injectChildStyle(t,s){this._applyStyles(t.styles,t,s)}_beginPatch(){this._patching=!0,this._dirty=!1}_endPatch(){this._patching=!1,this._dirty&&this._instance&&this._update()}_hasShadowRoot(){return this._def.shadowRoot!==!1}_removeChildStyle(t){}}function Pp(e){const t=qt(),s=t&&t.ce;return s||null}function l0(){const e=Pp();return e&&e.shadowRoot}function r0(e="$style"){{const t=qt();if(!t)return Me;const s=t.type.__cssModules;if(!s)return Me;const n=s[e];return n||Me}}const Fp=new WeakMap,$p=new WeakMap,_l=Symbol("_moveCb"),Iu=Symbol("_enterCb"),o0=e=>(delete e.props.mode,e),c0=o0({name:"TransitionGroup",props:Oe({},Rp,{tag:String,moveClass:String}),setup(e,{slots:t}){const s=qt(),n=Po();let a,i;return Jl(()=>{if(!a.length)return;const l=e.moveClass||`${e.name||"v"}-move`;if(!h0(a[0].el,s.vnode.el,l)){a=[];return}a.forEach(d0),a.forEach(f0);const r=a.filter(p0);ao(s.vnode.el),r.forEach(o=>{const c=o.el,u=c.style;ws(c,l),u.transform=u.webkitTransform=u.transitionDuration="";const d=c[_l]=f=>{f&&f.target!==c||(!f||f.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",d),c[_l]=null,un(c,l))};c.addEventListener("transitionend",d)}),a=[]}),()=>{const l=Fe(e),r=Ip(l);let o=l.tag||Tt;if(a=[],i)for(let c=0;c<i.length;c++){const u=i[c];u.el&&u.el instanceof Element&&!u.el[Qo]&&(a.push(u),Xs(u,ma(u,r,n,s)),Fp.set(u,Up(u.el)))}i=t.default?Wl(t.default()):[];for(let c=0;c<i.length;c++){const u=i[c];u.key!=null&&Xs(u,ma(u,r,n,s))}return at(o,null,i)}}}),u0=c0;function d0(e){const t=e.el;t[_l]&&t[_l](),t[Iu]&&t[Iu]()}function f0(e){$p.set(e,Up(e.el))}function p0(e){const t=Fp.get(e),s=$p.get(e),n=t.left-s.left,a=t.top-s.top;if(n||a){const i=e.el,l=i.style,r=i.getBoundingClientRect();let o=1,c=1;return i.offsetWidth&&(o=r.width/i.offsetWidth),i.offsetHeight&&(c=r.height/i.offsetHeight),(!Number.isFinite(o)||o===0)&&(o=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(o-1)<.01&&(o=1),Math.abs(c-1)<.01&&(c=1),l.transform=l.webkitTransform=`translate(${n/o}px,${a/c}px)`,l.transitionDuration="0s",e}}function Up(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function h0(e,t,s){const n=e.cloneNode(),a=e[ba];a&&a.forEach(r=>{r.split(/\s+/).forEach(o=>o&&n.classList.remove(o))}),s.split(/\s+/).forEach(r=>r&&n.classList.add(r)),n.style.display="none";const i=t.nodeType===1?t:t.parentNode;i.appendChild(n);const{hasTransform:l}=Np(n);return i.removeChild(n),l}const vn=e=>{const t=e.props["onUpdate:modelValue"]||!1;return fe(t)?s=>ca(t,s):t};function g0(e){e.target.composing=!0}function Nu(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const ps=Symbol("_assign");function Lu(e,t,s){return t&&(e=e.trim()),s&&(e=Bl(e)),e}const kl={created(e,{modifiers:{lazy:t,trim:s,number:n}},a){e[ps]=vn(a);const i=n||a.props&&a.props.type==="number";js(e,t?"change":"input",l=>{l.target.composing||e[ps](Lu(e.value,s,i))}),(s||i)&&js(e,"change",()=>{e.value=Lu(e.value,s,i)}),t||(js(e,"compositionstart",g0),js(e,"compositionend",Nu),js(e,"change",Nu))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:n,trim:a,number:i}},l){if(e[ps]=vn(l),e.composing)return;const r=(i||e.type==="number")&&!/^0\d/.test(e.value)?Bl(e.value):e.value,o=t??"";if(r===o)return;const c=e.getRootNode();(c instanceof Document||c instanceof ShadowRoot)&&c.activeElement===e&&e.type!=="range"&&(n&&t===s||a&&e.value.trim()===o)||(e.value=o)}},Xo={deep:!0,created(e,t,s){e[ps]=vn(s),js(e,"change",()=>{const n=e._modelValue,a=ya(e),i=e.checked,l=e[ps];if(fe(n)){const r=Vl(n,a),o=r!==-1;if(i&&!o)l(n.concat(a));else if(!i&&o){const c=[...n];c.splice(r,1),l(c)}}else if(Hn(n)){const r=new Set(n);i?r.add(a):r.delete(a),l(r)}else l(Hp(e,i))})},mounted:Ou,beforeUpdate(e,t,s){e[ps]=vn(s),Ou(e,t,s)}};function Ou(e,{value:t,oldValue:s},n){e._modelValue=t;let a;if(fe(t))a=Vl(t,n.props.value)>-1;else if(Hn(t))a=t.has(n.props.value);else{if(t===s)return;a=Js(t,Hp(e,!0))}e.checked!==a&&(e.checked=a)}const ec={created(e,{value:t},s){e.checked=Js(t,s.props.value),e[ps]=vn(s),js(e,"change",()=>{e[ps](ya(e))})},beforeUpdate(e,{value:t,oldValue:s},n){e[ps]=vn(n),t!==s&&(e.checked=Js(t,n.props.value))}},Bp={deep:!0,created(e,{value:t,modifiers:{number:s}},n){const a=Hn(t);js(e,"change",()=>{const i=Array.prototype.filter.call(e.options,l=>l.selected).map(l=>s?Bl(ya(l)):ya(l));e[ps](e.multiple?a?new Set(i):i:i[0]),e._assigning=!0,St(()=>{e._assigning=!1})}),e[ps]=vn(n)},mounted(e,{value:t}){Du(e,t)},beforeUpdate(e,t,s){e[ps]=vn(s)},updated(e,{value:t}){e._assigning||Du(e,t)}};function Du(e,t){const s=e.multiple,n=fe(t);if(!(s&&!n&&!Hn(t))){for(let a=0,i=e.options.length;a<i;a++){const l=e.options[a],r=ya(l);if(s)if(n){const o=typeof r;o==="string"||o==="number"?l.selected=t.some(c=>String(c)===String(r)):l.selected=Vl(t,r)>-1}else l.selected=t.has(r);else if(Js(ya(l),t)){e.selectedIndex!==a&&(e.selectedIndex=a);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function ya(e){return"_value"in e?e._value:e.value}function Hp(e,t){const s=t?"_trueValue":"_falseValue";return s in e?e[s]:t}const Vp={created(e,t,s){Gi(e,t,s,null,"created")},mounted(e,t,s){Gi(e,t,s,null,"mounted")},beforeUpdate(e,t,s,n){Gi(e,t,s,n,"beforeUpdate")},updated(e,t,s,n){Gi(e,t,s,n,"updated")}};function jp(e,t){switch(e){case"SELECT":return Bp;case"TEXTAREA":return kl;default:switch(t){case"checkbox":return Xo;case"radio":return ec;default:return kl}}}function Gi(e,t,s,n,a){const l=jp(e.tagName,s.props&&s.props.type)[a];l&&l(e,t,s,n)}function m0(){kl.getSSRProps=({value:e})=>({value:e}),ec.getSSRProps=({value:e},t)=>{if(t.props&&Js(t.props.value,e))return{checked:!0}},Xo.getSSRProps=({value:e},t)=>{if(fe(e)){if(t.props&&Vl(e,t.props.value)>-1)return{checked:!0}}else if(Hn(e)){if(t.props&&e.has(t.props.value))return{checked:!0}}else if(e)return{checked:!0}},Vp.getSSRProps=(e,t)=>{if(typeof t.type!="string")return;const s=jp(t.type.toUpperCase(),t.props&&t.props.type);if(s.getSSRProps)return s.getSSRProps(e,t)}}const v0=["ctrl","shift","alt","meta"],b0={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>v0.some(s=>e[`${s}Key`]&&!t.includes(s))},y0=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((a,...i)=>{for(let l=0;l<t.length;l++){const r=b0[t[l]];if(r&&r(a,t))return}return e(a,...i)}))},x0={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},_0=(e,t)=>{const s=e._withKeys||(e._withKeys={}),n=t.join(".");return s[n]||(s[n]=(a=>{if(!("key"in a))return;const i=Qt(a.key);if(t.some(l=>l===i||x0[l]===i))return e(a)}))},zp=Oe({patchProp:Dp},Ep);let Xa,Mu=!1;function qp(){return Xa||(Xa=ap(zp))}function Kp(){return Xa=Mu?Xa:ip(zp),Mu=!0,Xa}const Gp=((...e)=>{qp().render(...e)}),k0=((...e)=>{Kp().hydrate(...e)}),wl=((...e)=>{const t=qp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Jp(n);if(!a)return;const i=t._component;!_e(i)&&!i.render&&!i.template&&(i.template=a.innerHTML),a.nodeType===1&&(a.textContent="");const l=s(a,!1,Zp(a));return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),l},t}),Wp=((...e)=>{const t=Kp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Jp(n);if(a)return s(a,!0,Zp(a))},t});function Zp(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Jp(e){return Te(e)?document.querySelector(e):e}let Pu=!1;const w0=()=>{Pu||(Pu=!0,m0(),zb())},S0=Object.freeze(Object.defineProperty({__proto__:null,BaseTransition:Mf,BaseTransitionPropsValidators:Fo,Comment:dt,DeprecationTypes:Pb,EffectScope:Eo,ErrorCodes:Um,ErrorTypeStrings:Rb,Fragment:Tt,KeepAlive:bv,ReactiveEffect:ai,Static:Ln,Suspense:ub,Teleport:ev,Text:gn,TrackOpTypes:Lm,Transition:Bb,TransitionGroup:u0,TriggerOpTypes:Om,VueElement:er,assertNumber:$m,callWithAsyncErrorHandling:as,callWithErrorHandling:Aa,camelize:Ge,capitalize:Vn,cloneVNode:Ns,compatUtils:Mb,computed:ee,createApp:wl,createBlock:ml,createCommentVNode:mp,createElementBlock:mb,createElementVNode:Zo,createHydrationRenderer:ip,createPropsRestProxy:Bv,createRenderer:ap,createSSRApp:Wp,createSlots:Tv,createStaticVNode:yb,createTextVNode:Jo,createVNode:at,customRef:yf,defineAsyncComponent:mv,defineComponent:Ci,defineCustomElement:Mp,defineEmits:Iv,defineExpose:Nv,defineModel:Dv,defineOptions:Lv,defineProps:Rv,defineSSRCustomElement:a0,defineSlots:Ov,devtools:Ib,effect:tm,effectScope:Qg,getCurrentInstance:qt,getCurrentScope:ef,getCurrentWatcher:Dm,getTransitionRawChildren:Wl,guardReactiveProps:gp,h:va,handleError:jn,hasInjectionContext:Gm,hydrate:k0,hydrateOnIdle:uv,hydrateOnInteraction:hv,hydrateOnMediaQuery:pv,hydrateOnVisible:fv,initCustomFormatter:Cb,initDirectivesForSSR:w0,inject:fs,isMemoSame:Sp,isProxy:Si,isReactive:Gs,isReadonly:Is,isRef:mt,isRuntimeOnly:wb,isShallow:es,isVNode:en,markRaw:vf,mergeDefaults:$v,mergeModels:Uv,mergeProps:vp,nextTick:St,nodeOps:Ep,normalizeClass:wi,normalizeProps:Ug,normalizeStyle:ki,onActivated:Uo,onBeforeMount:$f,onBeforeUnmount:Yl,onBeforeUpdate:Ho,onDeactivated:Bo,onErrorCaptured:Vf,onMounted:$e,onRenderTracked:Hf,onRenderTriggered:Bf,onScopeDispose:Xg,onServerPrefetch:Uf,onUnmounted:ft,onUpdated:Jl,onWatcherCleanup:_f,openBlock:fi,patchProp:Dp,popScopeId:zm,provide:Ja,proxyRefs:Oo,pushScopeId:jm,queuePostFlushCb:ri,reactive:bn,readonly:ol,ref:h,registerRuntimeCompiler:_p,render:Gp,renderList:Sv,renderSlot:Cv,resolveComponent:_v,resolveDirective:wv,resolveDynamicComponent:kv,resolveFilter:Db,resolveTransitionHooks:ma,setBlockTracking:pi,setDevtoolsHook:Nb,setTransitionHooks:Xs,shallowReactive:No,shallowReadonly:xm,shallowRef:Lo,ssrContextKey:Ef,ssrUtils:Ob,stop:sm,toDisplayString:Qd,toHandlerKey:oa,toHandlers:Ev,toRaw:Fe,toRef:Rm,toRefs:Cm,toValue:wm,transformVNodeArgs:vb,triggerRef:km,unref:Rs,useAttrs:Fv,useCssModule:r0,useCssVars:qb,useHost:Pp,useId:sv,useModel:Zv,useSSRContext:Af,useShadowRoot:l0,useSlots:Pv,useTemplateRef:nv,useTransitionState:Po,vModelCheckbox:Xo,vModelDynamic:Vp,vModelRadio:ec,vModelSelect:Bp,vModelText:kl,vShow:Lp,version:Tp,warn:Ab,watch:ns,watchEffect:Wm,watchPostEffect:Zm,watchSyncEffect:Rf,withAsyncContext:Hv,withCtx:Mo,withDefaults:Mv,withDirectives:Km,withKeys:_0,withMemo:Eb,withModifiers:y0,withScopeId:qm},Symbol.toStringTag,{value:"Module"}));/**
* @vue/compiler-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const gi=Symbol(""),ei=Symbol(""),tc=Symbol(""),Sl=Symbol(""),Yp=Symbol(""),$n=Symbol(""),Qp=Symbol(""),Xp=Symbol(""),sc=Symbol(""),nc=Symbol(""),Ri=Symbol(""),ac=Symbol(""),eh=Symbol(""),ic=Symbol(""),lc=Symbol(""),rc=Symbol(""),oc=Symbol(""),cc=Symbol(""),uc=Symbol(""),th=Symbol(""),sh=Symbol(""),tr=Symbol(""),Tl=Symbol(""),dc=Symbol(""),fc=Symbol(""),mi=Symbol(""),Ii=Symbol(""),pc=Symbol(""),lo=Symbol(""),T0=Symbol(""),ro=Symbol(""),Cl=Symbol(""),C0=Symbol(""),E0=Symbol(""),hc=Symbol(""),A0=Symbol(""),R0=Symbol(""),gc=Symbol(""),nh=Symbol(""),xa={[gi]:"Fragment",[ei]:"Teleport",[tc]:"Suspense",[Sl]:"KeepAlive",[Yp]:"BaseTransition",[$n]:"openBlock",[Qp]:"createBlock",[Xp]:"createElementBlock",[sc]:"createVNode",[nc]:"createElementVNode",[Ri]:"createCommentVNode",[ac]:"createTextVNode",[eh]:"createStaticVNode",[ic]:"resolveComponent",[lc]:"resolveDynamicComponent",[rc]:"resolveDirective",[oc]:"resolveFilter",[cc]:"withDirectives",[uc]:"renderList",[th]:"renderSlot",[sh]:"createSlots",[tr]:"toDisplayString",[Tl]:"mergeProps",[dc]:"normalizeClass",[fc]:"normalizeStyle",[mi]:"normalizeProps",[Ii]:"guardReactiveProps",[pc]:"toHandlers",[lo]:"camelize",[T0]:"capitalize",[ro]:"toHandlerKey",[Cl]:"setBlockTracking",[C0]:"pushScopeId",[E0]:"popScopeId",[hc]:"withCtx",[A0]:"unref",[R0]:"isRef",[gc]:"withMemo",[nh]:"isMemoSame"};function I0(e){Object.getOwnPropertySymbols(e).forEach(t=>{xa[t]=e[t]})}const rs={start:{line:1,column:1,offset:0},end:{line:1,column:1,offset:0},source:""};function N0(e,t=""){return{type:0,source:t,children:e,helpers:new Set,components:[],directives:[],hoists:[],imports:[],cached:[],temps:0,codegenNode:void 0,loc:rs}}function vi(e,t,s,n,a,i,l,r=!1,o=!1,c=!1,u=rs){return e&&(r?(e.helper($n),e.helper(wa(e.inSSR,c))):e.helper(ka(e.inSSR,c)),l&&e.helper(cc)),{type:13,tag:t,props:s,children:n,patchFlag:a,dynamicProps:i,directives:l,isBlock:r,disableTracking:o,isComponent:c,loc:u}}function On(e,t=rs){return{type:17,loc:t,elements:e}}function ds(e,t=rs){return{type:15,loc:t,properties:e}}function gt(e,t){return{type:16,loc:rs,key:Te(e)?Ae(e,!0):e,value:t}}function Ae(e,t=!1,s=rs,n=0){return{type:4,loc:s,content:e,isStatic:t,constType:t?3:n}}function ys(e,t=rs){return{type:8,loc:t,children:e}}function _t(e,t=[],s=rs){return{type:14,loc:s,callee:e,arguments:t}}function _a(e,t=void 0,s=!1,n=!1,a=rs){return{type:18,params:e,returns:t,newline:s,isSlot:n,loc:a}}function oo(e,t,s,n=!0){return{type:19,test:e,consequent:t,alternate:s,newline:n,loc:rs}}function L0(e,t,s=!1,n=!1){return{type:20,index:e,value:t,needPauseTracking:s,inVOnce:n,needArraySpread:!1,loc:rs}}function O0(e){return{type:21,body:e,loc:rs}}function ka(e,t){return e||t?sc:nc}function wa(e,t){return e||t?Qp:Xp}function mc(e,{helper:t,removeHelper:s,inSSR:n}){e.isBlock||(e.isBlock=!0,s(ka(n,e.isComponent)),t($n),t(wa(n,e.isComponent)))}const Fu=new Uint8Array([123,123]),$u=new Uint8Array([125,125]);function Uu(e){return e>=97&&e<=122||e>=65&&e<=90}function ts(e){return e===32||e===10||e===9||e===12||e===13}function rn(e){return e===47||e===62||ts(e)}function El(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t}const Ot={Cdata:new Uint8Array([67,68,65,84,65,91]),CdataEnd:new Uint8Array([93,93,62]),CommentEnd:new Uint8Array([45,45,62]),ScriptEnd:new Uint8Array([60,47,115,99,114,105,112,116]),StyleEnd:new Uint8Array([60,47,115,116,121,108,101]),TitleEnd:new Uint8Array([60,47,116,105,116,108,101]),TextareaEnd:new Uint8Array([60,47,116,101,120,116,97,114,101,97])};class D0{constructor(t,s){this.stack=t,this.cbs=s,this.state=1,this.buffer="",this.sectionStart=0,this.index=0,this.entityStart=0,this.baseState=1,this.inRCDATA=!1,this.inXML=!1,this.inVPre=!1,this.newlines=[],this.mode=0,this.delimiterOpen=Fu,this.delimiterClose=$u,this.delimiterIndex=-1,this.currentSequence=void 0,this.sequenceIndex=0}get inSFCRoot(){return this.mode===2&&this.stack.length===0}reset(){this.state=1,this.mode=0,this.buffer="",this.sectionStart=0,this.index=0,this.baseState=1,this.inRCDATA=!1,this.currentSequence=void 0,this.newlines.length=0,this.delimiterOpen=Fu,this.delimiterClose=$u}getPos(t){let s=1,n=t+1;const a=this.newlines.length;let i=-1;if(a>100){let l=-1,r=a;for(;l+1<r;){const o=l+r>>>1;this.newlines[o]<t?l=o:r=o}i=l}else for(let l=a-1;l>=0;l--)if(t>this.newlines[l]){i=l;break}return i>=0&&(s=i+2,n=t-this.newlines[i]),{column:n,line:s,offset:t}}peek(){return this.buffer.charCodeAt(this.index+1)}stateText(t){t===60?(this.index>this.sectionStart&&this.cbs.ontext(this.sectionStart,this.index),this.state=5,this.sectionStart=this.index):!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t))}stateInterpolationOpen(t){if(t===this.delimiterOpen[this.delimiterIndex])if(this.delimiterIndex===this.delimiterOpen.length-1){const s=this.index+1-this.delimiterOpen.length;s>this.sectionStart&&this.cbs.ontext(this.sectionStart,s),this.state=3,this.sectionStart=s}else this.delimiterIndex++;else this.inRCDATA?(this.state=32,this.stateInRCDATA(t)):(this.state=1,this.stateText(t))}stateInterpolation(t){t===this.delimiterClose[0]&&(this.state=4,this.delimiterIndex=0,this.stateInterpolationClose(t))}stateInterpolationClose(t){t===this.delimiterClose[this.delimiterIndex]?this.delimiterIndex===this.delimiterClose.length-1?(this.cbs.oninterpolation(this.sectionStart,this.index+1),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):this.delimiterIndex++:(this.state=3,this.stateInterpolation(t))}stateSpecialStartSequence(t){const s=this.sequenceIndex===this.currentSequence.length;if(!(s?rn(t):(t|32)===this.currentSequence[this.sequenceIndex]))this.inRCDATA=!1;else if(!s){this.sequenceIndex++;return}this.sequenceIndex=0,this.state=6,this.stateInTagName(t)}stateInRCDATA(t){if(this.sequenceIndex===this.currentSequence.length){if(t===62||ts(t)){const s=this.index-this.currentSequence.length;if(this.sectionStart<s){const n=this.index;this.index=s,this.cbs.ontext(this.sectionStart,s),this.index=n}this.sectionStart=s+2,this.stateInClosingTagName(t),this.inRCDATA=!1;return}this.sequenceIndex=0}(t|32)===this.currentSequence[this.sequenceIndex]?this.sequenceIndex+=1:this.sequenceIndex===0?this.currentSequence===Ot.TitleEnd||this.currentSequence===Ot.TextareaEnd&&!this.inSFCRoot?!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t)):this.fastForwardTo(60)&&(this.sequenceIndex=1):this.sequenceIndex=+(t===60)}stateCDATASequence(t){t===Ot.Cdata[this.sequenceIndex]?++this.sequenceIndex===Ot.Cdata.length&&(this.state=28,this.currentSequence=Ot.CdataEnd,this.sequenceIndex=0,this.sectionStart=this.index+1):(this.sequenceIndex=0,this.state=23,this.stateInDeclaration(t))}fastForwardTo(t){for(;++this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);if(s===10&&this.newlines.push(this.index),s===t)return!0}return this.index=this.buffer.length-1,!1}stateInCommentLike(t){t===this.currentSequence[this.sequenceIndex]?++this.sequenceIndex===this.currentSequence.length&&(this.currentSequence===Ot.CdataEnd?this.cbs.oncdata(this.sectionStart,this.index-2):this.cbs.oncomment(this.sectionStart,this.index-2),this.sequenceIndex=0,this.sectionStart=this.index+1,this.state=1):this.sequenceIndex===0?this.fastForwardTo(this.currentSequence[0])&&(this.sequenceIndex=1):t!==this.currentSequence[this.sequenceIndex-1]&&(this.sequenceIndex=0)}startSpecial(t,s){this.enterRCDATA(t,s),this.state=31}enterRCDATA(t,s){this.inRCDATA=!0,this.currentSequence=t,this.sequenceIndex=s}stateBeforeTagName(t){t===33?(this.state=22,this.sectionStart=this.index+1):t===63?(this.state=24,this.sectionStart=this.index+1):Uu(t)?(this.sectionStart=this.index,this.mode===0?this.state=6:this.inSFCRoot?this.state=34:this.inXML?this.state=6:t===116?this.state=30:this.state=t===115?29:6):t===47?this.state=8:(this.state=1,this.stateText(t))}stateInTagName(t){rn(t)&&this.handleTagName(t)}stateInSFCRootTagName(t){if(rn(t)){const s=this.buffer.slice(this.sectionStart,this.index);s!=="template"&&this.enterRCDATA(El("</"+s),0),this.handleTagName(t)}}handleTagName(t){this.cbs.onopentagname(this.sectionStart,this.index),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)}stateBeforeClosingTagName(t){ts(t)||(t===62?(this.state=1,this.sectionStart=this.index+1):(this.state=Uu(t)?9:27,this.sectionStart=this.index))}stateInClosingTagName(t){(t===62||ts(t))&&(this.cbs.onclosetag(this.sectionStart,this.index),this.sectionStart=-1,this.state=10,this.stateAfterClosingTagName(t))}stateAfterClosingTagName(t){t===62&&(this.state=1,this.sectionStart=this.index+1)}stateBeforeAttrName(t){t===62?(this.cbs.onopentagend(this.index),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):t===47?this.state=7:t===60&&this.peek()===47?(this.cbs.onopentagend(this.index),this.state=5,this.sectionStart=this.index):ts(t)||this.handleAttrStart(t)}handleAttrStart(t){t===118&&this.peek()===45?(this.state=13,this.sectionStart=this.index):t===46||t===58||t===64||t===35?(this.cbs.ondirname(this.index,this.index+1),this.state=14,this.sectionStart=this.index+1):(this.state=12,this.sectionStart=this.index)}stateInSelfClosingTag(t){t===62?(this.cbs.onselfclosingtag(this.index),this.state=1,this.sectionStart=this.index+1,this.inRCDATA=!1):ts(t)||(this.state=11,this.stateBeforeAttrName(t))}stateInAttrName(t){(t===61||rn(t))&&(this.cbs.onattribname(this.sectionStart,this.index),this.handleAttrNameEnd(t))}stateInDirName(t){t===61||rn(t)?(this.cbs.ondirname(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===58?(this.cbs.ondirname(this.sectionStart,this.index),this.state=14,this.sectionStart=this.index+1):t===46&&(this.cbs.ondirname(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDirArg(t){t===61||rn(t)?(this.cbs.ondirarg(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===91?this.state=15:t===46&&(this.cbs.ondirarg(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDynamicDirArg(t){t===93?this.state=14:(t===61||rn(t))&&(this.cbs.ondirarg(this.sectionStart,this.index+1),this.handleAttrNameEnd(t))}stateInDirModifier(t){t===61||rn(t)?(this.cbs.ondirmodifier(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===46&&(this.cbs.ondirmodifier(this.sectionStart,this.index),this.sectionStart=this.index+1)}handleAttrNameEnd(t){this.sectionStart=this.index,this.state=17,this.cbs.onattribnameend(this.index),this.stateAfterAttrName(t)}stateAfterAttrName(t){t===61?this.state=18:t===47||t===62?(this.cbs.onattribend(0,this.sectionStart),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)):ts(t)||(this.cbs.onattribend(0,this.sectionStart),this.handleAttrStart(t))}stateBeforeAttrValue(t){t===34?(this.state=19,this.sectionStart=this.index+1):t===39?(this.state=20,this.sectionStart=this.index+1):ts(t)||(this.sectionStart=this.index,this.state=21,this.stateInAttrValueNoQuotes(t))}handleInAttrValue(t,s){(t===s||this.fastForwardTo(s))&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(s===34?3:2,this.index+1),this.state=11)}stateInAttrValueDoubleQuotes(t){this.handleInAttrValue(t,34)}stateInAttrValueSingleQuotes(t){this.handleInAttrValue(t,39)}stateInAttrValueNoQuotes(t){ts(t)||t===62?(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(1,this.index),this.state=11,this.stateBeforeAttrName(t)):(t===39||t===60||t===61||t===96)&&this.cbs.onerr(18,this.index)}stateBeforeDeclaration(t){t===91?(this.state=26,this.sequenceIndex=0):this.state=t===45?25:23}stateInDeclaration(t){(t===62||this.fastForwardTo(62))&&(this.state=1,this.sectionStart=this.index+1)}stateInProcessingInstruction(t){(t===62||this.fastForwardTo(62))&&(this.cbs.onprocessinginstruction(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeComment(t){t===45?(this.state=28,this.currentSequence=Ot.CommentEnd,this.sequenceIndex=2,this.sectionStart=this.index+1):this.state=23}stateInSpecialComment(t){(t===62||this.fastForwardTo(62))&&(this.cbs.oncomment(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeSpecialS(t){t===Ot.ScriptEnd[3]?this.startSpecial(Ot.ScriptEnd,4):t===Ot.StyleEnd[3]?this.startSpecial(Ot.StyleEnd,4):(this.state=6,this.stateInTagName(t))}stateBeforeSpecialT(t){t===Ot.TitleEnd[3]?this.startSpecial(Ot.TitleEnd,4):t===Ot.TextareaEnd[3]?this.startSpecial(Ot.TextareaEnd,4):(this.state=6,this.stateInTagName(t))}startEntity(){}stateInEntity(){}parse(t){for(this.buffer=t;this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);switch(s===10&&this.state!==33&&this.newlines.push(this.index),this.state){case 1:{this.stateText(s);break}case 2:{this.stateInterpolationOpen(s);break}case 3:{this.stateInterpolation(s);break}case 4:{this.stateInterpolationClose(s);break}case 31:{this.stateSpecialStartSequence(s);break}case 32:{this.stateInRCDATA(s);break}case 26:{this.stateCDATASequence(s);break}case 19:{this.stateInAttrValueDoubleQuotes(s);break}case 12:{this.stateInAttrName(s);break}case 13:{this.stateInDirName(s);break}case 14:{this.stateInDirArg(s);break}case 15:{this.stateInDynamicDirArg(s);break}case 16:{this.stateInDirModifier(s);break}case 28:{this.stateInCommentLike(s);break}case 27:{this.stateInSpecialComment(s);break}case 11:{this.stateBeforeAttrName(s);break}case 6:{this.stateInTagName(s);break}case 34:{this.stateInSFCRootTagName(s);break}case 9:{this.stateInClosingTagName(s);break}case 5:{this.stateBeforeTagName(s);break}case 17:{this.stateAfterAttrName(s);break}case 20:{this.stateInAttrValueSingleQuotes(s);break}case 18:{this.stateBeforeAttrValue(s);break}case 8:{this.stateBeforeClosingTagName(s);break}case 10:{this.stateAfterClosingTagName(s);break}case 29:{this.stateBeforeSpecialS(s);break}case 30:{this.stateBeforeSpecialT(s);break}case 21:{this.stateInAttrValueNoQuotes(s);break}case 7:{this.stateInSelfClosingTag(s);break}case 23:{this.stateInDeclaration(s);break}case 22:{this.stateBeforeDeclaration(s);break}case 25:{this.stateBeforeComment(s);break}case 24:{this.stateInProcessingInstruction(s);break}case 33:{this.stateInEntity();break}}this.index++}this.cleanup(),this.finish()}cleanup(){this.sectionStart!==this.index&&(this.state===1||this.state===32&&this.sequenceIndex===0?(this.cbs.ontext(this.sectionStart,this.index),this.sectionStart=this.index):(this.state===19||this.state===20||this.state===21)&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=this.index))}finish(){this.handleTrailingData(),this.cbs.onend()}handleTrailingData(){const t=this.buffer.length;this.sectionStart>=t||(this.state===28?this.currentSequence===Ot.CdataEnd?this.cbs.oncdata(this.sectionStart,t):this.cbs.oncomment(this.sectionStart,t):this.state===6||this.state===11||this.state===18||this.state===17||this.state===12||this.state===13||this.state===14||this.state===15||this.state===16||this.state===20||this.state===19||this.state===21||this.state===9||this.cbs.ontext(this.sectionStart,t))}emitCodePoint(t,s){}}function Bu(e,{compatConfig:t}){const s=t&&t[e];return e==="MODE"?s||3:s}function Dn(e,t){const s=Bu("MODE",t),n=Bu(e,t);return s===3?n===!0:n!==!1}function bi(e,t,s,...n){return Dn(e,t)}function vc(e){throw e}function ah(e){}function tt(e,t,s,n){const a=`https://vuejs.org/error-reference/#compiler-${e}`,i=new SyntaxError(String(a));return i.code=e,i.loc=t,i}const Xt=e=>e.type===4&&e.isStatic;function ih(e){switch(e){case"Teleport":case"teleport":return ei;case"Suspense":case"suspense":return tc;case"KeepAlive":case"keep-alive":return Sl;case"BaseTransition":case"base-transition":return Yp}}const M0=/^$|^\d|[^\$\w\xA0-\uFFFF]/,bc=e=>!M0.test(e),lh=/[A-Za-z_$\xA0-\uFFFF]/,P0=/[\.\?\w$\xA0-\uFFFF]/,F0=/\s+[.[]\s*|\s*[.[]\s+/g,rh=e=>e.type===4?e.content:e.loc.source,$0=e=>{const t=rh(e).trim().replace(F0,r=>r.trim());let s=0,n=[],a=0,i=0,l=null;for(let r=0;r<t.length;r++){const o=t.charAt(r);switch(s){case 0:if(o==="[")n.push(s),s=1,a++;else if(o==="(")n.push(s),s=2,i++;else if(!(r===0?lh:P0).test(o))return!1;break;case 1:o==="'"||o==='"'||o==="`"?(n.push(s),s=3,l=o):o==="["?a++:o==="]"&&(--a||(s=n.pop()));break;case 2:if(o==="'"||o==='"'||o==="`")n.push(s),s=3,l=o;else if(o==="(")i++;else if(o===")"){if(r===t.length-1)return!1;--i||(s=n.pop())}break;case 3:o===l&&(s=n.pop(),l=null);break}}return!a&&!i},oh=$0,U0=/^\s*(?:async\s*)?(?:\([^)]*?\)|[\w$_]+)\s*(?::[^=]+)?=>|^\s*(?:async\s+)?function(?:\s+[\w$]+)?\s*\(/,B0=e=>U0.test(rh(e)),H0=B0;function us(e,t,s=!1){for(let n=0;n<e.props.length;n++){const a=e.props[n];if(a.type===7&&(s||a.exp)&&(Te(t)?a.name===t:t.test(a.name)))return a}}function sr(e,t,s=!1,n=!1){for(let a=0;a<e.props.length;a++){const i=e.props[a];if(i.type===6){if(s)continue;if(i.name===t&&(i.value||n))return i}else if(i.name==="bind"&&(i.exp||n)&&En(i.arg,t))return i}}function En(e,t){return!!(e&&Xt(e)&&e.content===t)}function V0(e){return e.props.some(t=>t.type===7&&t.name==="bind"&&(!t.arg||t.arg.type!==4||!t.arg.isStatic))}function Cr(e){return e.type===5||e.type===2}function Hu(e){return e.type===7&&e.name==="pre"}function j0(e){return e.type===7&&e.name==="slot"}function Al(e){return e.type===1&&e.tagType===3}function Rl(e){return e.type===1&&e.tagType===2}const z0=new Set([mi,Ii]);function ch(e,t=[]){if(e&&!Te(e)&&e.type===14){const s=e.callee;if(!Te(s)&&z0.has(s))return ch(e.arguments[0],t.concat(e))}return[e,t]}function Il(e,t,s){let n,a=e.type===13?e.props:e.arguments[2],i=[],l;if(a&&!Te(a)&&a.type===14){const r=ch(a);a=r[0],i=r[1],l=i[i.length-1]}if(a==null||Te(a))n=ds([t]);else if(a.type===14){const r=a.arguments[0];!Te(r)&&r.type===15?Vu(t,r)||r.properties.unshift(t):a.callee===pc?n=_t(s.helper(Tl),[ds([t]),a]):a.arguments.unshift(ds([t])),!n&&(n=a)}else a.type===15?(Vu(t,a)||a.properties.unshift(t),n=a):(n=_t(s.helper(Tl),[ds([t]),a]),l&&l.callee===Ii&&(l=i[i.length-2]));e.type===13?l?l.arguments[0]=n:e.props=n:l?l.arguments[0]=n:e.arguments[2]=n}function Vu(e,t){let s=!1;if(e.key.type===4){const n=e.key.content;s=t.properties.some(a=>a.key.type===4&&a.key.content===n)}return s}function yi(e,t){return`_${t}_${e.replace(/[^\w]/g,(s,n)=>s==="-"?"_":e.charCodeAt(n).toString())}`}function q0(e){return e.type===14&&e.callee===gc?e.arguments[1].returns:e}const K0=/([\s\S]*?)\s+(?:in|of)\s+(\S[\s\S]*)/;function uh(e){for(let t=0;t<e.length;t++)if(!ts(e.charCodeAt(t)))return!1;return!0}function yc(e){return e.type===2&&uh(e.content)||e.type===12&&yc(e.content)}function dh(e){return e.type===3||yc(e)}const fh={parseMode:"base",ns:0,delimiters:["{{","}}"],getNamespace:()=>0,isVoidTag:aa,isPreTag:aa,isIgnoreNewlineTag:aa,isCustomElement:aa,onError:vc,onWarn:ah,comments:!1,prefixIdentifiers:!1};let Ue=fh,xi=null,Zs="",Mt=null,Pe=null,Wt="",Fs=-1,Tn=-1,xc=0,pn=!1,co=null;const et=[],ot=new D0(et,{onerr:Ds,ontext(e,t){Wi(At(e,t),e,t)},ontextentity(e,t,s){Wi(e,t,s)},oninterpolation(e,t){if(pn)return Wi(At(e,t),e,t);let s=e+ot.delimiterOpen.length,n=t-ot.delimiterClose.length;for(;ts(Zs.charCodeAt(s));)s++;for(;ts(Zs.charCodeAt(n-1));)n--;let a=At(s,n);a.includes("&")&&(a=Ue.decodeEntities(a,!1)),uo({type:5,content:sl(a,!1,ut(s,n)),loc:ut(e,t)})},onopentagname(e,t){const s=At(e,t);Mt={type:1,tag:s,ns:Ue.getNamespace(s,et[0],Ue.ns),tagType:0,props:[],children:[],loc:ut(e-1,t),codegenNode:void 0}},onopentagend(e){zu(e)},onclosetag(e,t){const s=At(e,t);if(!Ue.isVoidTag(s)){let n=!1;for(let a=0;a<et.length;a++)if(et[a].tag.toLowerCase()===s.toLowerCase()){n=!0,a>0&&Ds(24,et[0].loc.start.offset);for(let l=0;l<=a;l++){const r=et.shift();tl(r,t,l<a)}break}n||Ds(23,ph(e,60))}},onselfclosingtag(e){const t=Mt.tag;Mt.isSelfClosing=!0,zu(e),et[0]&&et[0].tag===t&&tl(et.shift(),e)},onattribname(e,t){Pe={type:6,name:At(e,t),nameLoc:ut(e,t),value:void 0,loc:ut(e)}},ondirname(e,t){const s=At(e,t),n=s==="."||s===":"?"bind":s==="@"?"on":s==="#"?"slot":s.slice(2);if(!pn&&n===""&&Ds(26,e),pn||n==="")Pe={type:6,name:s,nameLoc:ut(e,t),value:void 0,loc:ut(e)};else if(Pe={type:7,name:n,rawName:s,exp:void 0,arg:void 0,modifiers:s==="."?[Ae("prop")]:[],loc:ut(e)},n==="pre"){pn=ot.inVPre=!0,co=Mt;const a=Mt.props;for(let i=0;i<a.length;i++)a[i].type===7&&(a[i]=sy(a[i]))}},ondirarg(e,t){if(e===t)return;const s=At(e,t);if(pn&&!Hu(Pe))Pe.name+=s,An(Pe.nameLoc,t);else{const n=s[0]!=="[";Pe.arg=sl(n?s:s.slice(1,-1),n,ut(e,t),n?3:0)}},ondirmodifier(e,t){const s=At(e,t);if(pn&&!Hu(Pe))Pe.name+="."+s,An(Pe.nameLoc,t);else if(Pe.name==="slot"){const n=Pe.arg;n&&(n.content+="."+s,An(n.loc,t))}else{const n=Ae(s,!0,ut(e,t));Pe.modifiers.push(n)}},onattribdata(e,t){Wt+=At(e,t),Fs<0&&(Fs=e),Tn=t},onattribentity(e,t,s){Wt+=e,Fs<0&&(Fs=t),Tn=s},onattribnameend(e){const t=Pe.loc.start.offset,s=At(t,e);Pe.type===7&&(Pe.rawName=s),Mt.props.some(n=>(n.type===7?n.rawName:n.name)===s)&&Ds(2,t)},onattribend(e,t){if(Mt&&Pe){if(An(Pe.loc,t),e!==0)if(Wt.includes("&")&&(Wt=Ue.decodeEntities(Wt,!0)),Pe.type===6)Pe.name==="class"&&(Wt=gh(Wt).trim()),e===1&&!Wt&&Ds(13,t),Pe.value={type:2,content:Wt,loc:e===1?ut(Fs,Tn):ut(Fs-1,Tn+1)},ot.inSFCRoot&&Mt.tag==="template"&&Pe.name==="lang"&&Wt&&Wt!=="html"&&ot.enterRCDATA(El("</template"),0);else{let s=0;Pe.exp=sl(Wt,!1,ut(Fs,Tn),0,s),Pe.name==="for"&&(Pe.forParseResult=W0(Pe.exp));let n=-1;Pe.name==="bind"&&(n=Pe.modifiers.findIndex(a=>a.content==="sync"))>-1&&bi("COMPILER_V_BIND_SYNC",Ue,Pe.loc,Pe.arg.loc.source)&&(Pe.name="model",Pe.modifiers.splice(n,1))}(Pe.type!==7||Pe.name!=="pre")&&Mt.props.push(Pe)}Wt="",Fs=Tn=-1},oncomment(e,t){Ue.comments&&uo({type:3,content:At(e,t),loc:ut(e-4,t+3)})},onend(){const e=Zs.length;for(let t=0;t<et.length;t++)tl(et[t],e-1),Ds(24,et[t].loc.start.offset)},oncdata(e,t){(et[0]?et[0].ns:Ue.ns)!==0?Wi(At(e,t),e,t):Ds(1,e-9)},onprocessinginstruction(e){(et[0]?et[0].ns:Ue.ns)===0&&Ds(21,e-1)}}),ju=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,G0=/^\(|\)$/g;function W0(e){const t=e.loc,s=e.content,n=s.match(K0);if(!n)return;const[,a,i]=n,l=(d,f,p=!1)=>{const m=t.start.offset+f,g=m+d.length;return sl(d,!1,ut(m,g),0,p?1:0)},r={source:l(i.trim(),s.indexOf(i,a.length)),value:void 0,key:void 0,index:void 0,finalized:!1};let o=a.trim().replace(G0,"").trim();const c=a.indexOf(o),u=o.match(ju);if(u){o=o.replace(ju,"").trim();const d=u[1].trim();let f;if(d&&(f=s.indexOf(d,c+o.length),r.key=l(d,f,!0)),u[2]){const p=u[2].trim();p&&(r.index=l(p,s.indexOf(p,r.key?f+d.length:c+o.length),!0))}}return o&&(r.value=l(o,c,!0)),r}function At(e,t){return Zs.slice(e,t)}function zu(e){ot.inSFCRoot&&(Mt.innerLoc=ut(e+1,e+1)),uo(Mt);const{tag:t,ns:s}=Mt;s===0&&Ue.isPreTag(t)&&xc++,Ue.isVoidTag(t)?tl(Mt,e):(et.unshift(Mt),(s===1||s===2)&&(ot.inXML=!0)),Mt=null}function Wi(e,t,s){{const i=et[0]&&et[0].tag;i!=="script"&&i!=="style"&&e.includes("&")&&(e=Ue.decodeEntities(e,!1))}const n=et[0]||xi,a=n.children[n.children.length-1];a&&a.type===2?(a.content+=e,An(a.loc,s)):n.children.push({type:2,content:e,loc:ut(t,s)})}function tl(e,t,s=!1){s?An(e.loc,ph(t,60)):An(e.loc,Z0(t,62)+1),ot.inSFCRoot&&(e.children.length?e.innerLoc.end=Oe({},e.children[e.children.length-1].loc.end):e.innerLoc.end=Oe({},e.innerLoc.start),e.innerLoc.source=At(e.innerLoc.start.offset,e.innerLoc.end.offset));const{tag:n,ns:a,children:i}=e;if(pn||(n==="slot"?e.tagType=2:qu(e)?e.tagType=3:Y0(e)&&(e.tagType=1)),ot.inRCDATA||(e.children=hh(i)),a===0&&Ue.isIgnoreNewlineTag(n)){const l=i[0];l&&l.type===2&&(l.content=l.content.replace(/^\r?\n/,""))}a===0&&Ue.isPreTag(n)&&xc--,co===e&&(pn=ot.inVPre=!1,co=null),ot.inXML&&(et[0]?et[0].ns:Ue.ns)===0&&(ot.inXML=!1);{const l=e.props;if(!ot.inSFCRoot&&Dn("COMPILER_NATIVE_TEMPLATE",Ue)&&e.tag==="template"&&!qu(e)){const o=et[0]||xi,c=o.children.indexOf(e);o.children.splice(c,1,...e.children)}const r=l.find(o=>o.type===6&&o.name==="inline-template");r&&bi("COMPILER_INLINE_TEMPLATE",Ue,r.loc)&&e.children.length&&(r.value={type:2,content:At(e.children[0].loc.start.offset,e.children[e.children.length-1].loc.end.offset),loc:r.loc})}}function Z0(e,t){let s=e;for(;Zs.charCodeAt(s)!==t&&s<Zs.length-1;)s++;return s}function ph(e,t){let s=e;for(;Zs.charCodeAt(s)!==t&&s>=0;)s--;return s}const J0=new Set(["if","else","else-if","for","slot"]);function qu({tag:e,props:t}){if(e==="template"){for(let s=0;s<t.length;s++)if(t[s].type===7&&J0.has(t[s].name))return!0}return!1}function Y0({tag:e,props:t}){if(Ue.isCustomElement(e))return!1;if(e==="component"||Q0(e.charCodeAt(0))||ih(e)||Ue.isBuiltInComponent&&Ue.isBuiltInComponent(e)||Ue.isNativeTag&&!Ue.isNativeTag(e))return!0;for(let s=0;s<t.length;s++){const n=t[s];if(n.type===6){if(n.name==="is"&&n.value){if(n.value.content.startsWith("vue:"))return!0;if(bi("COMPILER_IS_ON_ELEMENT",Ue,n.loc))return!0}}else if(n.name==="bind"&&En(n.arg,"is")&&bi("COMPILER_IS_ON_ELEMENT",Ue,n.loc))return!0}return!1}function Q0(e){return e>64&&e<91}const X0=/\r\n/g;function hh(e){const t=Ue.whitespace!=="preserve";let s=!1;for(let n=0;n<e.length;n++){const a=e[n];if(a.type===2)if(xc)a.content=a.content.replace(X0,`
`);else if(uh(a.content)){const i=e[n-1]&&e[n-1].type,l=e[n+1]&&e[n+1].type;!i||!l||t&&(i===3&&(l===3||l===1)||i===1&&(l===3||l===1&&ey(a.content)))?(s=!0,e[n]=null):a.content=" "}else t&&(a.content=gh(a.content))}return s?e.filter(Boolean):e}function ey(e){for(let t=0;t<e.length;t++){const s=e.charCodeAt(t);if(s===10||s===13)return!0}return!1}function gh(e){let t="",s=!1;for(let n=0;n<e.length;n++)ts(e.charCodeAt(n))?s||(t+=" ",s=!0):(t+=e[n],s=!1);return t}function uo(e){(et[0]||xi).children.push(e)}function ut(e,t){return{start:ot.getPos(e),end:t==null?t:ot.getPos(t),source:t==null?t:At(e,t)}}function ty(e){return ut(e.start.offset,e.end.offset)}function An(e,t){e.end=ot.getPos(t),e.source=At(e.start.offset,t)}function sy(e){const t={type:6,name:e.rawName,nameLoc:ut(e.loc.start.offset,e.loc.start.offset+e.rawName.length),value:void 0,loc:e.loc};if(e.exp){const s=e.exp.loc;s.end.offset<e.loc.end.offset&&(s.start.offset--,s.start.column--,s.end.offset++,s.end.column++),t.value={type:2,content:e.exp.content,loc:s}}return t}function sl(e,t=!1,s,n=0,a=0){return Ae(e,t,s,n)}function Ds(e,t,s){Ue.onError(tt(e,ut(t,t)))}function ny(){ot.reset(),Mt=null,Pe=null,Wt="",Fs=-1,Tn=-1,et.length=0}function ay(e,t){if(ny(),Zs=e,Ue=Oe({},fh),t){let a;for(a in t)t[a]!=null&&(Ue[a]=t[a])}ot.mode=Ue.parseMode==="html"?1:Ue.parseMode==="sfc"?2:0,ot.inXML=Ue.ns===1||Ue.ns===2;const s=t&&t.delimiters;s&&(ot.delimiterOpen=El(s[0]),ot.delimiterClose=El(s[1]));const n=xi=N0([],e);return ot.parse(Zs),n.loc=ut(0,e.length),n.children=hh(n.children),xi=null,n}function iy(e,t){nl(e,void 0,t,!!mh(e))}function mh(e){const t=e.children.filter(s=>s.type!==3);return t.length===1&&t[0].type===1&&!Rl(t[0])?t[0]:null}function nl(e,t,s,n=!1,a=!1){const{children:i}=e,l=[];for(let u=0;u<i.length;u++){const d=i[u];if(d.type===1&&d.tagType===0){const f=n?0:ss(d,s);if(f>0){if(f>=2){d.codegenNode.patchFlag=-1,l.push(d);continue}}else{const p=d.codegenNode;if(p.type===13){const m=p.patchFlag;if((m===void 0||m===512||m===1)&&bh(d,s)>=2){const g=yh(d);g&&(p.props=s.hoist(g))}p.dynamicProps&&(p.dynamicProps=s.hoist(p.dynamicProps))}}}else if(d.type===12&&(n?0:ss(d,s))>=2){d.codegenNode.type===14&&d.codegenNode.arguments.length>0&&d.codegenNode.arguments.push("-1"),l.push(d);continue}if(d.type===1){const f=d.tagType===1;f&&s.scopes.vSlot++,nl(d,e,s,!1,a),f&&s.scopes.vSlot--}else if(d.type===11)nl(d,e,s,d.children.length===1,!0);else if(d.type===9)for(let f=0;f<d.branches.length;f++)nl(d.branches[f],e,s,d.branches[f].children.length===1,a)}let r=!1;if(l.length===i.length&&e.type===1){if(e.tagType===0&&e.codegenNode&&e.codegenNode.type===13&&fe(e.codegenNode.children))e.codegenNode.children=o(On(e.codegenNode.children)),r=!0;else if(e.tagType===1&&e.codegenNode&&e.codegenNode.type===13&&e.codegenNode.children&&!fe(e.codegenNode.children)&&e.codegenNode.children.type===15){const u=c(e.codegenNode,"default");u&&(u.returns=o(On(u.returns)),r=!0)}else if(e.tagType===3&&t&&t.type===1&&t.tagType===1&&t.codegenNode&&t.codegenNode.type===13&&t.codegenNode.children&&!fe(t.codegenNode.children)&&t.codegenNode.children.type===15){const u=us(e,"slot",!0),d=u&&u.arg&&c(t.codegenNode,u.arg);d&&(d.returns=o(On(d.returns)),r=!0)}}if(!r)for(const u of l)u.codegenNode=s.cache(u.codegenNode);function o(u){const d=s.cache(u);return d.needArraySpread=!0,d}function c(u,d){if(u.children&&!fe(u.children)&&u.children.type===15){const f=u.children.properties.find(p=>p.key===d||p.key.content===d);return f&&f.value}}l.length&&s.transformHoist&&s.transformHoist(i,s,e)}function ss(e,t){const{constantCache:s}=t;switch(e.type){case 1:if(e.tagType!==0)return 0;const n=s.get(e);if(n!==void 0)return n;const a=e.codegenNode;if(a.type!==13||a.isBlock&&e.tag!=="svg"&&e.tag!=="foreignObject"&&e.tag!=="math")return 0;if(a.patchFlag===void 0){let l=3;const r=bh(e,t);if(r===0)return s.set(e,0),0;r<l&&(l=r);for(let o=0;o<e.children.length;o++){const c=ss(e.children[o],t);if(c===0)return s.set(e,0),0;c<l&&(l=c)}if(l>1)for(let o=0;o<e.props.length;o++){const c=e.props[o];if(c.type===7&&c.name==="bind"&&c.exp){const u=ss(c.exp,t);if(u===0)return s.set(e,0),0;u<l&&(l=u)}}if(a.isBlock){for(let o=0;o<e.props.length;o++)if(e.props[o].type===7)return s.set(e,0),0;t.removeHelper($n),t.removeHelper(wa(t.inSSR,a.isComponent)),a.isBlock=!1,t.helper(ka(t.inSSR,a.isComponent))}return s.set(e,l),l}else return s.set(e,0),0;case 2:case 3:return 3;case 9:case 11:case 10:return 0;case 5:case 12:return ss(e.content,t);case 4:return e.constType;case 8:let i=3;for(let l=0;l<e.children.length;l++){const r=e.children[l];if(Te(r)||Ut(r))continue;const o=ss(r,t);if(o===0)return 0;o<i&&(i=o)}return i;case 20:return 2;default:return 0}}const ly=new Set([dc,fc,mi,Ii]);function vh(e,t){if(e.type===14&&!Te(e.callee)&&ly.has(e.callee)){const s=e.arguments[0];if(s.type===4)return ss(s,t);if(s.type===14)return vh(s,t)}return 0}function bh(e,t){let s=3;const n=yh(e);if(n&&n.type===15){const{properties:a}=n;for(let i=0;i<a.length;i++){const{key:l,value:r}=a[i],o=ss(l,t);if(o===0)return o;o<s&&(s=o);let c;if(r.type===4?c=ss(r,t):r.type===14?c=vh(r,t):c=0,c===0)return c;c<s&&(s=c)}}return s}function yh(e){const t=e.codegenNode;if(t.type===13)return t.props}function ry(e,{filename:t="",prefixIdentifiers:s=!1,hoistStatic:n=!1,hmr:a=!1,cacheHandlers:i=!1,nodeTransforms:l=[],directiveTransforms:r={},transformHoist:o=null,isBuiltInComponent:c=Nt,isCustomElement:u=Nt,expressionPlugins:d=[],scopeId:f=null,slotted:p=!0,ssr:m=!1,inSSR:g=!1,ssrCssVars:w="",bindingMetadata:A=Me,inline:b=!1,isTS:v=!1,onError:x=vc,onWarn:R=ah,compatConfig:L}){const O=t.replace(/\?.*$/,"").match(/([^/\\]+)\.\w+$/),S={filename:t,selfName:O&&Vn(Ge(O[1])),prefixIdentifiers:s,hoistStatic:n,hmr:a,cacheHandlers:i,nodeTransforms:l,directiveTransforms:r,transformHoist:o,isBuiltInComponent:c,isCustomElement:u,expressionPlugins:d,scopeId:f,slotted:p,ssr:m,inSSR:g,ssrCssVars:w,bindingMetadata:A,inline:b,isTS:v,onError:x,onWarn:R,compatConfig:L,root:e,helpers:new Map,components:new Set,directives:new Set,hoists:[],imports:[],cached:[],constantCache:new WeakMap,vForMemoKeyedNodes:new WeakSet,temps:0,identifiers:Object.create(null),scopes:{vFor:0,vSlot:0,vPre:0,vOnce:0},parent:null,grandParent:null,currentNode:e,childIndex:0,inVOnce:!1,helper(I){const D=S.helpers.get(I)||0;return S.helpers.set(I,D+1),I},removeHelper(I){const D=S.helpers.get(I);if(D){const B=D-1;B?S.helpers.set(I,B):S.helpers.delete(I)}},helperString(I){return`_${xa[S.helper(I)]}`},replaceNode(I){S.parent.children[S.childIndex]=S.currentNode=I},removeNode(I){const D=S.parent.children,B=I?D.indexOf(I):S.currentNode?S.childIndex:-1;!I||I===S.currentNode?(S.currentNode=null,S.onNodeRemoved()):S.childIndex>B&&(S.childIndex--,S.onNodeRemoved()),S.parent.children.splice(B,1)},onNodeRemoved:Nt,addIdentifiers(I){},removeIdentifiers(I){},hoist(I){Te(I)&&(I=Ae(I)),S.hoists.push(I);const D=Ae(`_hoisted_${S.hoists.length}`,!1,I.loc,2);return D.hoisted=I,D},cache(I,D=!1,B=!1){const F=L0(S.cached.length,I,D,B);return S.cached.push(F),F}};return S.filters=new Set,S}function oy(e,t){const s=ry(e,t);nr(e,s),t.hoistStatic&&iy(e,s),t.ssr||cy(e,s),e.helpers=new Set([...s.helpers.keys()]),e.components=[...s.components],e.directives=[...s.directives],e.imports=s.imports,e.hoists=s.hoists,e.temps=s.temps,e.cached=s.cached,e.transformed=!0,e.filters=[...s.filters]}function cy(e,t){const{helper:s}=t,{children:n}=e;if(n.length===1){const a=mh(e);if(a&&a.codegenNode){const i=a.codegenNode;i.type===13&&mc(i,t),e.codegenNode=i}else e.codegenNode=n[0]}else if(n.length>1){let a=64;e.codegenNode=vi(t,s(gi),void 0,e.children,a,void 0,void 0,!0,void 0,!1)}}function uy(e,t){let s=0;const n=()=>{s--};for(;s<e.children.length;s++){const a=e.children[s];Te(a)||(t.grandParent=t.parent,t.parent=e,t.childIndex=s,t.onNodeRemoved=n,nr(a,t))}}function nr(e,t){t.currentNode=e;const{nodeTransforms:s}=t,n=[];for(let i=0;i<s.length;i++){const l=s[i](e,t);if(l&&(fe(l)?n.push(...l):n.push(l)),t.currentNode)e=t.currentNode;else return}switch(e.type){case 3:t.ssr||t.helper(Ri);break;case 5:t.ssr||t.helper(tr);break;case 9:for(let i=0;i<e.branches.length;i++)nr(e.branches[i],t);break;case 10:case 11:case 1:case 0:uy(e,t);break}t.currentNode=e;let a=n.length;for(;a--;)n[a]()}function xh(e,t){const s=Te(e)?n=>n===e:n=>e.test(n);return(n,a)=>{if(n.type===1){const{props:i}=n;if(n.tagType===3&&i.some(j0))return;const l=[];for(let r=0;r<i.length;r++){const o=i[r];if(o.type===7&&s(o.name)){i.splice(r,1),r--;const c=t(n,o,a);c&&l.push(c)}}return l}}}const ar="/*@__PURE__*/",_h=e=>`${xa[e]}: _${xa[e]}`;function dy(e,{mode:t="function",prefixIdentifiers:s=t==="module",sourceMap:n=!1,filename:a="template.vue.html",scopeId:i=null,optimizeImports:l=!1,runtimeGlobalName:r="Vue",runtimeModuleName:o="vue",ssrRuntimeModuleName:c="vue/server-renderer",ssr:u=!1,isTS:d=!1,inSSR:f=!1}){const p={mode:t,prefixIdentifiers:s,sourceMap:n,filename:a,scopeId:i,optimizeImports:l,runtimeGlobalName:r,runtimeModuleName:o,ssrRuntimeModuleName:c,ssr:u,isTS:d,inSSR:f,source:e.source,code:"",column:1,line:1,offset:0,indentLevel:0,pure:!1,map:void 0,helper(g){return`_${xa[g]}`},push(g,w=-2,A){p.code+=g},indent(){m(++p.indentLevel)},deindent(g=!1){g?--p.indentLevel:m(--p.indentLevel)},newline(){m(p.indentLevel)}};function m(g){p.push(`
`+"  ".repeat(g),0)}return p}function fy(e,t={}){const s=dy(e,t);t.onContextCreated&&t.onContextCreated(s);const{mode:n,push:a,prefixIdentifiers:i,indent:l,deindent:r,newline:o,scopeId:c,ssr:u}=s,d=Array.from(e.helpers),f=d.length>0,p=!i&&n!=="module";py(e,s);const g=u?"ssrRender":"render",A=(u?["_ctx","_push","_parent","_attrs"]:["_ctx","_cache"]).join(", ");if(a(`function ${g}(${A}) {`),l(),p&&(a("with (_ctx) {"),l(),f&&(a(`const { ${d.map(_h).join(", ")} } = _Vue
...
`,0),o()),u||a("return "),e.codegenNode?$t(e.codegenNode,s):a("null"),p&&(r(),a("}")),r(),a("}"),{ast:e,code:s.code,preamble:"",map:s.map?s.map.toJSON():void 0}}function py(e,t){const{ssr:s,prefixIdentifiers:n,push:a,newline:i,runtimeModuleName:l,runtimeGlobalName:r,ssrRuntimeModuleName:o}=t,c=r,u=Array.from(e.helpers);if(u.length>0&&(a(`const _Vue = ${c}
`,-1),e.hoists.length)){const d=[sc,nc,Ri,ac,eh].filter(f=>u.includes(f)).map(_h).join(", ");a(`const { ${d} } = _Vue
`,-1)}hy(e.hoists,t),i(),a("return ")}function Er(e,t,{helper:s,push:n,newline:a,isTS:i}){const l=s(t==="filter"?oc:t==="component"?ic:rc);for(let r=0;r<e.length;r++){let o=e[r];const c=o.endsWith("__self");c&&(o=o.slice(0,-6)),n(`const ${yi(o,t)} = ${l}(${JSON.stringify(o)}${c?", true":""})${i?"!":""}`),r<e.length-1&&a()}}function hy(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:n}=t;n();for(let a=0;a<e.length;a++){const i=e[a];i&&(s(`const _hoisted_${a+1} = `),$t(i,t),n())}t.pure=!1}function _c(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),Ni(e,t,s),s&&t.deindent(),t.push("]")}function Ni(e,t,s=!1,n=!0){const{push:a,newline:i}=t;for(let l=0;l<e.length;l++){const r=e[l];Te(r)?a(r,-3):fe(r)?_c(r,t):$t(r,t),l<e.length-1&&(s?(n&&a(","),i()):n&&a(", "))}}function $t(e,t){if(Te(e)){t.push(e,-3);return}if(Ut(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:$t(e.codegenNode,t);break;case 2:gy(e,t);break;case 4:kh(e,t);break;case 5:my(e,t);break;case 12:$t(e.codegenNode,t);break;case 8:wh(e,t);break;case 3:by(e,t);break;case 13:yy(e,t);break;case 14:_y(e,t);break;case 15:ky(e,t);break;case 17:wy(e,t);break;case 18:Sy(e,t);break;case 19:Ty(e,t);break;case 20:Cy(e,t);break;case 21:Ni(e.body,t,!0,!1);break}}function gy(e,t){t.push(JSON.stringify(e.content),-3,e)}function kh(e,t){const{content:s,isStatic:n}=e;t.push(n?JSON.stringify(s):s,-3,e)}function my(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ar),s(`${n(tr)}(`),$t(e.content,t),s(")")}function wh(e,t){for(let s=0;s<e.children.length;s++){const n=e.children[s];Te(n)?t.push(n,-3):$t(n,t)}}function vy(e,t){const{push:s}=t;if(e.type===8)s("["),wh(e,t),s("]");else if(e.isStatic){const n=bc(e.content)?e.content:JSON.stringify(e.content);s(n,-2,e)}else s(`[${e.content}]`,-3,e)}function by(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ar),s(`${n(Ri)}(${JSON.stringify(e.content)})`,-3,e)}function yy(e,t){const{push:s,helper:n,pure:a}=t,{tag:i,props:l,children:r,patchFlag:o,dynamicProps:c,directives:u,isBlock:d,disableTracking:f,isComponent:p}=e;let m;o&&(m=String(o)),u&&s(n(cc)+"("),d&&s(`(${n($n)}(${f?"true":""}), `),a&&s(ar);const g=d?wa(t.inSSR,p):ka(t.inSSR,p);s(n(g)+"(",-2,e),Ni(xy([i,l,r,m,c]),t),s(")"),d&&s(")"),u&&(s(", "),$t(u,t),s(")"))}function xy(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function _y(e,t){const{push:s,helper:n,pure:a}=t,i=Te(e.callee)?e.callee:n(e.callee);a&&s(ar),s(i+"(",-2,e),Ni(e.arguments,t),s(")")}function ky(e,t){const{push:s,indent:n,deindent:a,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const r=l.length>1||!1;s(r?"{":"{ "),r&&n();for(let o=0;o<l.length;o++){const{key:c,value:u}=l[o];vy(c,t),s(": "),$t(u,t),o<l.length-1&&(s(","),i())}r&&a(),s(r?"}":" }")}function wy(e,t){_c(e.elements,t)}function Sy(e,t){const{push:s,indent:n,deindent:a}=t,{params:i,returns:l,body:r,newline:o,isSlot:c}=e;c&&s(`_${xa[hc]}(`),s("(",-2,e),fe(i)?Ni(i,t):i&&$t(i,t),s(") => "),(o||r)&&(s("{"),n()),l?(o&&s("return "),fe(l)?_c(l,t):$t(l,t)):r&&$t(r,t),(o||r)&&(a(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function Ty(e,t){const{test:s,consequent:n,alternate:a,newline:i}=e,{push:l,indent:r,deindent:o,newline:c}=t;if(s.type===4){const d=!bc(s.content);d&&l("("),kh(s,t),d&&l(")")}else l("("),$t(s,t),l(")");i&&r(),t.indentLevel++,i||l(" "),l("? "),$t(n,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const u=a.type===19;u||t.indentLevel++,$t(a,t),u||t.indentLevel--,i&&o(!0)}function Cy(e,t){const{push:s,helper:n,indent:a,deindent:i,newline:l}=t,{needPauseTracking:r,needArraySpread:o}=e;o&&s("[...("),s(`_cache[${e.index}] || (`),r&&(a(),s(`${n(Cl)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),$t(e.value,t),r&&(s(`).cacheIndex = ${e.index},`),l(),s(`${n(Cl)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),o&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const Ey=xh(/^(?:if|else|else-if)$/,(e,t,s)=>Ay(e,t,s,(n,a,i)=>{const l=s.parent.children;let r=l.indexOf(n),o=0;for(;r-->=0;){const c=l[r];c&&c.type===9&&(o+=c.branches.length)}return()=>{if(i)n.codegenNode=Gu(a,o,s);else{const c=Ry(n.codegenNode);c.alternate=Gu(a,o+n.branches.length-1,s)}}}));function Ay(e,t,s,n){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const a=t.exp?t.exp.loc:e.loc;s.onError(tt(28,t.loc)),t.exp=Ae("true",!1,a)}if(t.name==="if"){const a=Ku(e,t),i={type:9,loc:ty(e.loc),branches:[a]};if(s.replaceNode(i),n)return n(i,a,!0)}else{const a=s.parent.children;let i=a.indexOf(e);for(;i-->=-1;){const l=a[i];if(l&&dh(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(tt(30,e.loc)),s.removeNode();const r=Ku(e,t);l.branches.push(r);const o=n&&n(l,r,!1);nr(r,s),o&&o(),s.currentNode=null}else s.onError(tt(30,e.loc));break}}}function Ku(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!us(e,"for")?e.children:[e],userKey:sr(e,"key"),isTemplateIf:s}}function Gu(e,t,s){return e.condition?oo(e.condition,Wu(e,t,s),_t(s.helper(Ri),['""',"true"])):Wu(e,t,s)}function Wu(e,t,s){const{helper:n}=s,a=gt("key",Ae(`${t}`,!1,rs,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const o=l.codegenNode;return Il(o,a,s),o}else return vi(s,n(gi),ds([a]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const o=l.codegenNode,c=q0(o);return c.type===13&&mc(c,s),Il(c,a,s),o}}function Ry(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const Iy=xh("for",(e,t,s)=>{const{helper:n,removeHelper:a}=s;return Ny(e,t,s,i=>{const l=_t(n(uc),[i.source]),r=Al(e),o=us(e,"memo"),c=sr(e,"key",!1,!0);c&&c.type;let u=c&&(c.type===6?c.value?Ae(c.value.content,!0):void 0:c.exp);const d=u?gt("key",u):null,f=i.source.type===4&&i.source.constType>0,p=f?64:c?128:256;return i.codegenNode=vi(s,n(gi),void 0,l,p,void 0,void 0,!0,!f,!1,e.loc),()=>{let m;const{children:g}=i,w=g.length!==1||g[0].type!==1,A=Rl(e)?e:r&&e.children.length===1&&Rl(e.children[0])?e.children[0]:null;if(A?(m=A.codegenNode,r&&d&&Il(m,d,s)):w?m=vi(s,n(gi),d?ds([d]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(m=g[0].codegenNode,r&&d&&Il(m,d,s),m.isBlock!==!f&&(m.isBlock?(a($n),a(wa(s.inSSR,m.isComponent))):a(ka(s.inSSR,m.isComponent))),m.isBlock=!f,m.isBlock?(n($n),n(wa(s.inSSR,m.isComponent))):n(ka(s.inSSR,m.isComponent))),o){const b=_a(fo(i.parseResult,[Ae("_cached")]));b.body=O0([ys(["const _memo = (",o.exp,")"]),ys(["if (_cached && _cached.el",...u?[" && _cached.key === ",u]:[],` && ${s.helperString(nh)}(_cached, _memo)) return _cached`]),ys(["const _item = ",m]),Ae("_item.memo = _memo"),Ae("return _item")]),l.arguments.push(b,Ae("_cache"),Ae(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(_a(fo(i.parseResult),m,!0))}})});function Ny(e,t,s,n){if(!t.exp){s.onError(tt(31,t.loc));return}const a=t.forParseResult;if(!a){s.onError(tt(32,t.loc));return}Sh(a);const{addIdentifiers:i,removeIdentifiers:l,scopes:r}=s,{source:o,value:c,key:u,index:d}=a,f={type:11,loc:t.loc,source:o,valueAlias:c,keyAlias:u,objectIndexAlias:d,parseResult:a,children:Al(e)?e.children:[e]};s.replaceNode(f),r.vFor++;const p=n&&n(f);return()=>{r.vFor--,p&&p()}}function Sh(e,t){e.finalized||(e.finalized=!0)}function fo({value:e,key:t,index:s},n=[]){return Ly([e,t,s,...n])}function Ly(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,n)=>s||Ae("_".repeat(n+1),!1))}const Zu=Ae("undefined",!1),Oy=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=us(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},Dy=(e,t,s,n)=>_a(e,s,!1,!0,s.length?s[0].loc:n);function My(e,t,s=Dy){t.helper(hc);const{children:n,loc:a}=e,i=[],l=[];let r=t.scopes.vSlot>0||t.scopes.vFor>0;const o=us(e,"slot",!0);if(o){const{arg:w,exp:A}=o;w&&!Xt(w)&&(r=!0),i.push(gt(w||Ae("default",!0),s(A,void 0,n,a)))}let c=!1,u=!1;const d=[],f=new Set;let p=0;for(let w=0;w<n.length;w++){const A=n[w];let b;if(!Al(A)||!(b=us(A,"slot",!0))){A.type!==3&&d.push(A);continue}if(o){t.onError(tt(37,b.loc));break}c=!0;const{children:v,loc:x}=A,{arg:R=Ae("default",!0),exp:L,loc:O}=b;let S;Xt(R)?S=R?R.content:"default":r=!0;const I=us(A,"for"),D=s(L,I,v,x);let B,F;if(B=us(A,"if"))r=!0,l.push(oo(B.exp,Zi(R,D,p++),Zu));else if(F=us(A,/^else(?:-if)?$/,!0)){let M=w,W;for(;M--&&(W=n[M],!!dh(W)););if(W&&Al(W)&&us(W,/^(?:else-)?if$/)){let U=l[l.length-1];for(;U.alternate.type===19;)U=U.alternate;U.alternate=F.exp?oo(F.exp,Zi(R,D,p++),Zu):Zi(R,D,p++)}else t.onError(tt(30,F.loc))}else if(I){r=!0;const M=I.forParseResult;M?(Sh(M),l.push(_t(t.helper(uc),[M.source,_a(fo(M),Zi(R,D),!0)]))):t.onError(tt(32,I.loc))}else{if(S){if(f.has(S)){t.onError(tt(38,O));continue}f.add(S),S==="default"&&(u=!0)}i.push(gt(R,D))}}if(!o){const w=(A,b)=>{const v=s(A,void 0,b,a);return t.compatConfig&&(v.isNonScopedSlot=!0),gt("default",v)};c?d.length&&!d.every(yc)&&(u?t.onError(tt(39,d[0].loc)):i.push(w(void 0,d))):i.push(w(void 0,n))}const m=r?2:al(e.children)?3:1;let g=ds(i.concat(gt("_",Ae(m+"",!1))),a);return l.length&&(g=_t(t.helper(sh),[g,On(l)])),{slots:g,hasDynamicSlots:r}}function Zi(e,t,s){const n=[gt("name",e),gt("fn",t)];return s!=null&&n.push(gt("key",Ae(String(s),!0))),ds(n)}function al(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||al(s.children))return!0;break;case 9:if(al(s.branches))return!0;break;case 10:case 11:if(al(s.children))return!0;break}}return!1}const Th=new WeakMap,Py=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:n,props:a}=e,i=e.tagType===1;let l=i?Fy(e,t):`"${n}"`;const r=Be(l)&&l.callee===lc;let o,c,u=0,d,f,p,m=r||l===ei||l===tc||!i&&(n==="svg"||n==="foreignObject"||n==="math");if(a.length>0){const g=Ch(e,t,void 0,i,r);o=g.props,u=g.patchFlag,f=g.dynamicPropNames;const w=g.directives;p=w&&w.length?On(w.map(A=>Uy(A,t))):void 0,g.shouldUseBlock&&(m=!0)}if(e.children.length>0)if(l===Sl&&(m=!0,u|=1024),i&&l!==ei&&l!==Sl){const{slots:w,hasDynamicSlots:A}=My(e,t);c=w,A&&(u|=1024)}else if(e.children.length===1&&l!==ei){const w=e.children[0],A=w.type,b=A===5||A===8;b&&ss(w,t)===0&&(u|=1),b||A===2?c=w:c=e.children}else c=e.children;f&&f.length&&(d=By(f)),e.codegenNode=vi(t,l,o,c,u===0?void 0:u,d,p,!!m,!1,i,e.loc)};function Fy(e,t,s=!1){let{tag:n}=e;const a=po(n),i=sr(e,"is",!1,!0);if(i)if(a||Dn("COMPILER_IS_ON_ELEMENT",t)){let r;if(i.type===6?r=i.value&&Ae(i.value.content,!0):(r=i.exp,r||(r=Ae("is",!1,i.arg.loc))),r)return _t(t.helper(lc),[r])}else i.type===6&&i.value.content.startsWith("vue:")&&(n=i.value.content.slice(4));const l=ih(n)||t.isBuiltInComponent(n);return l?(s||t.helper(l),l):(t.helper(ic),t.components.add(n),yi(n,"component"))}function Ch(e,t,s=e.props,n,a,i=!1){const{tag:l,loc:r,children:o}=e;let c=[];const u=[],d=[],f=o.length>0;let p=!1,m=0,g=!1,w=!1,A=!1,b=!1,v=!1,x=!1;const R=[],L=D=>{c.length&&(u.push(ds(Ju(c),r)),c=[]),D&&u.push(D)},O=()=>{t.scopes.vFor>0&&c.push(gt(Ae("ref_for",!0),Ae("true")))},S=({key:D,value:B})=>{if(Xt(D)){const F=D.content,M=Bn(F);if(M&&(!n||a)&&F.toLowerCase()!=="onclick"&&F!=="onUpdate:modelValue"&&!Ks(F)&&(b=!0),M&&Ks(F)&&(x=!0),M&&B.type===14&&(B=B.arguments[0]),B.type===20||(B.type===4||B.type===8)&&ss(B,t)>0)return;F==="ref"?g=!0:F==="class"?w=!0:F==="style"?A=!0:F!=="key"&&!R.includes(F)&&R.push(F),n&&(F==="class"||F==="style")&&!R.includes(F)&&R.push(F)}else v=!0};for(let D=0;D<s.length;D++){const B=s[D];if(B.type===6){const{loc:F,name:M,nameLoc:W,value:U}=B;let j=!0;if(M==="ref"&&(g=!0,O()),M==="is"&&(po(l)||U&&U.content.startsWith("vue:")||Dn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(gt(Ae(M,!0,W),Ae(U?U.content:"",j,U?U.loc:F)))}else{const{name:F,arg:M,exp:W,loc:U,modifiers:j}=B,_=F==="bind",N=F==="on";if(F==="slot"){n||t.onError(tt(40,U));continue}if(F==="once"||F==="memo"||F==="is"||_&&En(M,"is")&&(po(l)||Dn("COMPILER_IS_ON_ELEMENT",t))||N&&i)continue;if((_&&En(M,"key")||N&&f&&En(M,"vue:before-update"))&&(p=!0),_&&En(M,"ref")&&O(),!M&&(_||N)){if(v=!0,W)if(_){if(L(),Dn("COMPILER_V_BIND_OBJECT_ORDER",t)){u.unshift(W);continue}O(),L(),u.push(W)}else L({type:14,loc:U,callee:t.helper(pc),arguments:n?[W]:[W,"true"]});else t.onError(tt(_?34:35,U));continue}_&&j.some(re=>re.content==="prop")&&(m|=32);const V=t.directiveTransforms[F];if(V){const{props:re,needRuntime:ve}=V(B,e,t);!i&&re.forEach(S),N&&M&&!Xt(M)?L(ds(re,r)):c.push(...re),ve&&(d.push(B),Ut(ve)&&Th.set(B,ve))}else Ig(F)||(d.push(B),f&&(p=!0))}}let I;if(u.length?(L(),u.length>1?I=_t(t.helper(Tl),u,r):I=u[0]):c.length&&(I=ds(Ju(c),r)),v?m|=16:(w&&!n&&(m|=2),A&&!n&&(m|=4),R.length&&(m|=8),b&&(m|=32)),!p&&(m===0||m===32)&&(g||x||d.length>0)&&(m|=512),!t.inSSR&&I)switch(I.type){case 15:let D=-1,B=-1,F=!1;for(let U=0;U<I.properties.length;U++){const j=I.properties[U].key;Xt(j)?j.content==="class"?D=U:j.content==="style"&&(B=U):j.isHandlerKey||(F=!0)}const M=I.properties[D],W=I.properties[B];F?I=_t(t.helper(mi),[I]):(M&&!Xt(M.value)&&(M.value=_t(t.helper(dc),[M.value])),W&&(A||W.value.type===4&&W.value.content.trim()[0]==="["||W.value.type===17)&&(W.value=_t(t.helper(fc),[W.value])));break;case 14:break;default:I=_t(t.helper(mi),[_t(t.helper(Ii),[I])]);break}return{props:I,directives:d,patchFlag:m,dynamicPropNames:R,shouldUseBlock:p}}function Ju(e){const t=new Map,s=[];for(let n=0;n<e.length;n++){const a=e[n];if(a.key.type===8||!a.key.isStatic){s.push(a);continue}const i=a.key.content,l=t.get(i);l?(i==="style"||i==="class"||Bn(i))&&$y(l,a):(t.set(i,a),s.push(a))}return s}function $y(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=On([e.value,t.value],e.loc)}function Uy(e,t){const s=[],n=Th.get(e);n?s.push(t.helperString(n)):(t.helper(rc),t.directives.add(e.name),s.push(yi(e.name,"directive")));const{loc:a}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=Ae("true",!1,a);s.push(ds(e.modifiers.map(l=>gt(l,i)),a))}return On(s,e.loc)}function By(e){let t="[";for(let s=0,n=e.length;s<n;s++)t+=JSON.stringify(e[s]),s<n-1&&(t+=", ");return t+"]"}function po(e){return e==="component"||e==="Component"}const Hy=(e,t)=>{if(Rl(e)){const{children:s,loc:n}=e,{slotName:a,slotProps:i}=Vy(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",a,"{}","undefined","true"];let r=2;i&&(l[2]=i,r=3),s.length&&(l[3]=_a([],s,!1,!1,n),r=4),t.scopeId&&!t.slotted&&(r=5),l.splice(r),e.codegenNode=_t(t.helper(th),l,n)}};function Vy(e,t){let s='"default"',n;const a=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=Ge(l.name),a.push(l)));else if(l.name==="bind"&&En(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const r=Ge(l.arg.content);s=l.exp=Ae(r,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&Xt(l.arg)&&(l.arg.content=Ge(l.arg.content)),a.push(l)}if(a.length>0){const{props:i,directives:l}=Ch(e,t,a,!1,!1);n=i,l.length&&t.onError(tt(36,l[0].loc))}return{slotName:s,slotProps:n}}const Eh=(e,t,s,n)=>{const{loc:a,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(tt(35,a));let r;if(l.type===4)if(l.isStatic){let d=l.content;d.startsWith("vue:")&&(d=`vnode-${d.slice(4)}`);const f=t.tagType!==0||d.startsWith("vnode")||!/[A-Z]/.test(d)?oa(Ge(d)):`on:${d}`;r=Ae(f,!0,l.loc)}else r=ys([`${s.helperString(ro)}(`,l,")"]);else r=l,r.children.unshift(`${s.helperString(ro)}(`),r.children.push(")");let o=e.exp;o&&!o.content.trim()&&(o=void 0);let c=s.cacheHandlers&&!o&&!s.inVOnce;if(o){const d=oh(o),f=!(d||H0(o)),p=o.content.includes(";");(f||c&&d)&&(o=ys([`${f?"$event":"(...args)"} => ${p?"{":"("}`,o,p?"}":")"]))}let u={props:[gt(r,o||Ae("() => {}",!1,a))]};return n&&(u=n(u)),c&&(u.props[0].value=s.cache(u.props[0].value)),u.props.forEach(d=>d.key.isHandlerKey=!0),u},jy=(e,t,s)=>{const{modifiers:n,loc:a}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),n.some(r=>r.content==="camel")&&(i.type===4?i.isStatic?i.content=Ge(i.content):i.content=`${s.helperString(lo)}(${i.content})`:(i.children.unshift(`${s.helperString(lo)}(`),i.children.push(")"))),s.inSSR||(n.some(r=>r.content==="prop")&&Yu(i,"."),n.some(r=>r.content==="attr")&&Yu(i,"^")),{props:[gt(i,l)]}},Yu=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},zy=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let n,a=!1;for(let i=0;i<s.length;i++){const l=s[i];if(Cr(l)){a=!0;for(let r=i+1;r<s.length;r++){const o=s[r];if(Cr(o))n||(n=s[i]=ys([l],l.loc)),n.children.push(" + ",o),s.splice(r,1),r--;else{n=void 0;break}}}}if(!(!a||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(Cr(l)||l.type===8){const r=[];(l.type!==2||l.content!==" ")&&r.push(l),!t.ssr&&ss(l,t)===0&&r.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:_t(t.helper(ac),r)}}}}},Qu=new WeakSet,qy=(e,t)=>{if(e.type===1&&us(e,"once",!0))return Qu.has(e)||t.inVOnce||t.inSSR?void 0:(Qu.add(e),t.inVOnce=!0,t.helper(Cl),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Ah=(e,t,s)=>{const{exp:n,arg:a}=e;if(!n)return s.onError(tt(41,e.loc)),$a();const i=n.loc.source.trim(),l=n.type===4?n.content:i,r=s.bindingMetadata[i];if(r==="props"||r==="props-aliased")return s.onError(tt(44,n.loc)),$a();if(r==="literal-const"||r==="setup-const")return s.onError(tt(45,n.loc)),$a();if(!l.trim()||!oh(n))return s.onError(tt(42,n.loc)),$a();const o=a||Ae("modelValue",!0),c=a?Xt(a)?`onUpdate:${Ge(a.content)}`:ys(['"onUpdate:" + ',a]):"onUpdate:modelValue";let u;const d=s.isTS?"($event: any)":"$event";u=ys([`${d} => ((`,n,") = $event)"]);const f=[gt(o,e.exp),gt(c,u)];if(e.modifiers.length&&t.tagType===1){const p=e.modifiers.map(g=>g.content).map(g=>(bc(g)?g:JSON.stringify(g))+": true").join(", "),m=a?Xt(a)?`${a.content}Modifiers`:ys([a,' + "Modifiers"']):"modelModifiers";f.push(gt(m,Ae(`{ ${p} }`,!1,e.loc,2)))}return $a(f)};function $a(e=[]){return{props:e}}const Ky=/[\w).+\-_$\]]/,Gy=(e,t)=>{Dn("COMPILER_FILTERS",t)&&(e.type===5?Nl(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&Nl(s.exp,t)}))};function Nl(e,t){if(e.type===4)Xu(e,t);else for(let s=0;s<e.children.length;s++){const n=e.children[s];typeof n=="object"&&(n.type===4?Xu(n,t):n.type===8?Nl(e,t):n.type===5&&Nl(n.content,t))}}function Xu(e,t){const s=e.content;let n=!1,a=!1,i=!1,l=!1,r=0,o=0,c=0,u=0,d,f,p,m,g=[];for(p=0;p<s.length;p++)if(f=d,d=s.charCodeAt(p),n)d===39&&f!==92&&(n=!1);else if(a)d===34&&f!==92&&(a=!1);else if(i)d===96&&f!==92&&(i=!1);else if(l)d===47&&f!==92&&(l=!1);else if(d===124&&s.charCodeAt(p+1)!==124&&s.charCodeAt(p-1)!==124&&!r&&!o&&!c)m===void 0?(u=p+1,m=s.slice(0,p).trim()):w();else{switch(d){case 34:a=!0;break;case 39:n=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:o++;break;case 93:o--;break;case 123:r++;break;case 125:r--;break}if(d===47){let A=p-1,b;for(;A>=0&&(b=s.charAt(A),b===" ");A--);(!b||!Ky.test(b))&&(l=!0)}}m===void 0?m=s.slice(0,p).trim():u!==0&&w();function w(){g.push(s.slice(u,p).trim()),u=p+1}if(g.length){for(p=0;p<g.length;p++)m=Wy(m,g[p],t);e.content=m,e.ast=void 0}}function Wy(e,t,s){s.helper(oc);const n=t.indexOf("(");if(n<0)return s.filters.add(t),`${yi(t,"filter")}(${e})`;{const a=t.slice(0,n),i=t.slice(n+1);return s.filters.add(a),`${yi(a,"filter")}(${e}${i!==")"?","+i:i}`}}const ed=new WeakSet,Zy=(e,t)=>{if(e.type===1){const s=us(e,"memo");return!s||ed.has(e)||t.inSSR?void 0:(ed.add(e),()=>{const n=e.codegenNode||t.currentNode.codegenNode;n&&n.type===13&&(e.tagType!==1&&mc(n,t),e.codegenNode=_t(t.helper(gc),[s.exp,_a(void 0,n),"_cache",String(t.cached.length)]),t.cached.push(null))})}},Jy=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const n=s.arg;if(n.type!==4||!n.isStatic)t.onError(tt(53,n.loc)),s.exp=Ae("",!0,n.loc);else{const a=Ge(n.content);(lh.test(a[0])||a[0]==="-")&&(s.exp=Ae(a,!1,n.loc))}}}};function Yy(e){return[[Jy,qy,Ey,Zy,Iy,Gy,Hy,Py,Oy,zy],{on:Eh,bind:jy,model:Ah}]}function Qy(e,t={}){const s=t.onError||vc,n=t.mode==="module";t.prefixIdentifiers===!0?s(tt(48)):n&&s(tt(49));const a=!1;t.cacheHandlers&&s(tt(50)),t.scopeId&&!n&&s(tt(51));const i=Oe({},t,{prefixIdentifiers:a}),l=Te(e)?ay(e,i):e,[r,o]=Yy();return oy(l,Oe({},i,{nodeTransforms:[...r,...t.nodeTransforms||[]],directiveTransforms:Oe({},o,t.directiveTransforms||{})})),fy(l,i)}const Xy=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Rh=Symbol(""),Ih=Symbol(""),Nh=Symbol(""),Lh=Symbol(""),ho=Symbol(""),Oh=Symbol(""),Dh=Symbol(""),Mh=Symbol(""),Ph=Symbol(""),Fh=Symbol("");I0({[Rh]:"vModelRadio",[Ih]:"vModelCheckbox",[Nh]:"vModelText",[Lh]:"vModelSelect",[ho]:"vModelDynamic",[Oh]:"withModifiers",[Dh]:"withKeys",[Mh]:"vShow",[Ph]:"Transition",[Fh]:"TransitionGroup"});let Yn;function ex(e,t=!1){return Yn||(Yn=document.createElement("div")),t?(Yn.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,Yn.children[0].getAttribute("foo")):(Yn.innerHTML=e,Yn.textContent)}const tx={parseMode:"html",isVoidTag:Gg,isNativeTag:e=>zg(e)||qg(e)||Kg(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:ex,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return Ph;if(e==="TransitionGroup"||e==="transition-group")return Fh},getNamespace(e,t,s){let n=t?t.ns:s;if(t&&n===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(a=>a.type===6&&a.name==="encoding"&&a.value!=null&&(a.value.content==="text/html"||a.value.content==="application/xhtml+xml"))&&(n=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(n=0);else t&&n===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(n=0);if(n===0){if(e==="svg")return 1;if(e==="math")return 2}return n}},sx=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:Ae("style",!0,t.loc),exp:nx(t.value.content,t.loc),modifiers:[],loc:t.loc})})},nx=(e,t)=>{const s=Zd(e);return Ae(JSON.stringify(s),!1,t,3)};function mn(e,t){return tt(e,t)}const ax=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(mn(54,a)),t.children.length&&(s.onError(mn(55,a)),t.children.length=0),{props:[gt(Ae("innerHTML",!0,a),n||Ae("",!0))]}},ix=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(mn(56,a)),t.children.length&&(s.onError(mn(57,a)),t.children.length=0),{props:[gt(Ae("textContent",!0),n?ss(n,s)>0?n:_t(s.helperString(tr),[n],a):Ae("",!0))]}},lx=(e,t,s)=>{const n=Ah(e,t,s);if(!n.props.length||t.tagType===1)return n;e.arg&&s.onError(mn(59,e.arg.loc));const{tag:a}=t,i=s.isCustomElement(a);if(a==="input"||a==="textarea"||a==="select"||i){let l=Nh,r=!1;if(a==="input"||i){const o=sr(t,"type");if(o){if(o.type===7)l=ho;else if(o.value)switch(o.value.content){case"radio":l=Rh;break;case"checkbox":l=Ih;break;case"file":r=!0,s.onError(mn(60,e.loc));break}}else V0(t)&&(l=ho)}else a==="select"&&(l=Lh);r||(n.needRuntime=s.helper(l))}else s.onError(mn(58,e.loc));return n.props=n.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),n},rx=ls("passive,once,capture"),ox=ls("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),cx=ls("left,right"),$h=ls("onkeyup,onkeydown,onkeypress"),ux=(e,t,s,n)=>{const a=[],i=[],l=[];for(let r=0;r<t.length;r++){const o=t[r].content;o==="native"&&bi("COMPILER_V_ON_NATIVE",s)||rx(o)?l.push(o):cx(o)?Xt(e)?$h(e.content.toLowerCase())?a.push(o):i.push(o):(a.push(o),i.push(o)):ox(o)?i.push(o):a.push(o)}return{keyModifiers:a,nonKeyModifiers:i,eventOptionModifiers:l}},td=(e,t)=>Xt(e)&&e.content.toLowerCase()==="onclick"?Ae(t,!0):e.type!==4?ys(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,dx=(e,t,s)=>Eh(e,t,s,n=>{const{modifiers:a}=e;if(!a.length)return n;let{key:i,value:l}=n.props[0];const{keyModifiers:r,nonKeyModifiers:o,eventOptionModifiers:c}=ux(i,a,s,e.loc);if(o.includes("right")&&(i=td(i,"onContextmenu")),o.includes("middle")&&(i=td(i,"onMouseup")),o.length&&(l=_t(s.helper(Oh),[l,JSON.stringify(o)])),r.length&&(!Xt(i)||$h(i.content.toLowerCase()))&&(l=_t(s.helper(Dh),[l,JSON.stringify(r)])),c.length){const u=c.map(Vn).join("");i=Xt(i)?Ae(`${i.content}${u}`,!0):ys(["(",i,`) + "${u}"`])}return{props:[gt(i,l)]}}),fx=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(mn(62,a)),{props:[],needRuntime:s.helper(Mh)}},px=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},hx=[sx],gx={cloak:Xy,html:ax,text:ix,model:lx,on:dx,show:fx};function mx(e,t={}){return Qy(e,Oe({},tx,t,{nodeTransforms:[px,...hx,...t.nodeTransforms||[]],directiveTransforms:Oe({},gx,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const sd=Object.create(null);function vx(e,t){if(!Te(e))if(e.nodeType)e=e.innerHTML;else return Nt;const s=Og(e,t),n=sd[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=Oe({hoistStatic:!0,onError:void 0,onWarn:Nt},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=mx(e,a),l=new Function("Vue",i)(S0);return l._rc=!0,sd[s]=l}_p(vx);const Ll=bn({items:[]});let bx=1;function ir(e,t="info",s=3e3){const n=bx++;return Ll.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>kc(n),s),n}function kc(e){const t=Ll.items.findIndex(s=>s.id===e);t>=0&&Ll.items.splice(t,1)}function xe(e,t="info",s=3e3){return ir(e,t,s)}xe.success=(e,t=3e3)=>ir(e,"success",t);xe.error=(e,t=5e3)=>ir(e,"error",t);xe.info=(e,t=3e3)=>ir(e,"info",t);xe.dismiss=kc;const yx={setup(){return{state:Ll,dismiss:kc}},template:`
...
... (truncated)`:s}function kd(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function eg(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function M_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const P_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=ee(()=>{const M=e.value.uptime_seconds||0,W=Math.floor(M/86400),U=Math.floor(M%86400/3600),j=Math.floor(M%3600/60),_=[];return W>0&&_.push(`${W}d`),U>0&&_.push(`${U}h`),(_.length===0||W===0&&U===0)&&_.push(`${j}m`),_.join(" ")}),p=ee(()=>{const M=e.value.uptime_seconds||0;return 125.66*(1-Math.min(M/86400,1))}),m=ee(()=>{const M=e.value;return[{label:"Guilds",value:M.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:M.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:M.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${M.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:M.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:M.loop_count>0?"text-green-400":"",highlight:M.loop_count>0},{label:"Agents",value:M.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:M.agent_count>0?`${M.agent_count} total`:"",subColor:"text-gray-500",highlight:(M.agent_running??0)>0},{label:"Processes",value:M.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:M.process_count>0?`${M.process_count} total`:"",subColor:"text-gray-500",highlight:(M.process_running??0)>0},{label:"Schedules",value:M.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(M.schedule_failing>0?`${M.schedule_failing} failing`:"")+(M.schedule_failing>0&&M.schedule_paused>0?", ":"")+(M.schedule_paused>0?`${M.schedule_paused} paused`:"")||void 0,subColor:M.schedule_failing>0?"text-red-400":"text-yellow-400",color:M.schedule_failing>0?"text-red-400":"",highlight:M.schedule_failing>0},{label:"Users",value:M.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=ee(()=>{const M=e.value,W=[];return W.push({label:"Bot",status:M.status==="online"?"ok":"warn",detail:M.status==="online"?"Online":"Starting"}),(M.schedule_failing||0)>0?W.push({label:"Schedules",status:"error",detail:`${M.schedule_failing} failing`}):(M.schedule_count||0)>0&&W.push({label:"Schedules",status:"ok",detail:`${M.schedule_count} configured`}),(M.loop_count||0)>0&&W.push({label:"Loops",status:"ok",detail:`${M.loop_count} active`}),(M.agent_running||0)>0&&W.push({label:"Agents",status:"ok",detail:`${M.agent_running} running`}),(M.process_running||0)>0&&W.push({label:"Processes",status:"ok",detail:`${M.process_running} running`}),W});async function w(){try{e.value=await K.get("/api/status"),s.value=null}catch(M){s.value=M.message}finally{t.value=!1}}async function A(){a.value=!0;try{n.value=await K.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function b(){l.value=!0;try{i.value=await K.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function v(){try{const M=await K.get("/api/knowledge");c.value=(Array.isArray(M)?M:[]).reduce((W,U)=>W+(U.chunks||0),0)}catch{c.value=null}}async function x(){try{const M=await K.get("/api/agents");r.value=M.filter(W=>W.status==="running")}catch{}}async function R(){u.value={...u.value,reload:!0};try{await K.post("/api/reload"),xe.success("Config reloaded")}catch(M){xe.error(M.message)}u.value={...u.value,reload:!1}}async function L(){if(!await is({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const W=e.value.session_count;e.value={...e.value,session_count:0};try{const U=await K.post("/api/sessions/clear-all");xe.success(`Cleared ${U.count} session${U.count!==1?"s":""}`),await w()}catch(U){e.value={...e.value,session_count:W},xe.error(U.message)}u.value={...u.value,clearSessions:!1}}async function O(){if(!await is({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const W=e.value.loop_count;e.value={...e.value,loop_count:0};try{const U=await K.post("/api/loops/stop-all");xe.success(U.result),await w()}catch(U){e.value={...e.value,loop_count:W},xe.error(U.message)}u.value={...u.value,stopLoops:!1}}function S(){t.value=!0,s.value=null,w(),A(),b(),x()}let I=null,D=null,B=null;function F(M){if(M.payload&&M.payload.tool_name){const W={...M.payload,_isNew:!0,_key:++d};n.value.unshift(W),n.value.length>10&&n.value.pop(),o.value++,W.error&&(i.value.unshift(W),i.value.length>5&&i.value.pop()),setTimeout(()=>{W._isNew=!1},1500),clearTimeout(B),B=setTimeout(()=>{o.value=0},1e4)}}return $e(async()=>{await Promise.all([w(),A(),b(),x(),v()]),I=setInterval(w,15e3),D=setInterval(x,1e4),qe.subscribe("events",F)}),ft(()=>{I&&clearInterval(I),D&&clearInterval(D),clearTimeout(B),qe.unsubscribe("events",F)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:m,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:A,fetchStatus:w,formatTime:Cc,formatDuration:Ca,retry:S,reloadConfig:R,clearSessions:L,stopAllLoops:O}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function wd(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function F_(e){if(Array.isArray(e))return e}function $_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function U_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function B_(e,t){return F_(e)||$_(e,t)||H_(e,t)||U_()}function H_(e,t){if(e){if(typeof e=="string")return wd(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?wd(e,t):void 0}}const tg=Object.entries,Sd=Object.setPrototypeOf,V_=Object.isFrozen,j_=Object.getPrototypeOf,z_=Object.getOwnPropertyDescriptor;let Kt=Object.freeze,hs=Object.seal,na=Object.create,sg=typeof Reflect<"u"&&Reflect,xo=sg.apply,_o=sg.construct;Kt||(Kt=function(t){return t});hs||(hs=function(t){return t});xo||(xo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});_o||(_o=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Ps=vt(Array.prototype.forEach),q_=vt(Array.prototype.lastIndexOf),Td=vt(Array.prototype.pop),Qn=vt(Array.prototype.push),K_=vt(Array.prototype.splice),Ht=Array.isArray,Ga=vt(String.prototype.toLowerCase),Or=vt(String.prototype.toString),Cd=vt(String.prototype.match),Xn=vt(String.prototype.replace),Ed=vt(String.prototype.indexOf),G_=vt(String.prototype.trim),W_=vt(Number.prototype.toString),Z_=vt(Boolean.prototype.toString),Ad=typeof BigInt>"u"?null:vt(BigInt.prototype.toString),Rd=typeof Symbol>"u"?null:vt(Symbol.prototype.toString),lt=vt(Object.prototype.hasOwnProperty),Ba=vt(Object.prototype.toString),Et=vt(RegExp.prototype.test),Sn=J_(TypeError);function vt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return xo(e,t,n)}}function J_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return _o(e,s)}}function Re(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Ga;if(Sd&&Sd(e,null),!Ht(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(V_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function Y_(e){for(let t=0;t<e.length;t++)lt(e,t)||(e[t]=null);return e}function Dt(e){const t=na(null);for(const n of tg(e)){var s=B_(n,2);const a=s[0],i=s[1];lt(e,a)&&(Ht(i)?t[a]=Y_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Dt(i):t[a]=i)}return t}function Q_(e){switch(typeof e){case"string":return e;case"number":return W_(e);case"boolean":return Z_(e);case"bigint":return Ad?Ad(e):"0";case"symbol":return Rd?Rd(e):"Symbol()";case"undefined":return Ba(e);case"function":case"object":{if(e===null)return Ba(e);const t=e,s=Ss(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Ba(n)}return Ba(e)}default:return Ba(e)}}function Ss(e,t){for(;e!==null;){const n=z_(e,t);if(n){if(n.get)return vt(n.get);if(typeof n.value=="function")return vt(n.value)}e=j_(e)}function s(){return null}return s}function X_(e){try{return Et(e,""),!0}catch{return!1}}const Id=Kt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Dr=Kt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Mr=Kt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ek=Kt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Pr=Kt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),tk=Kt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Nd=Kt(["#text"]),Ld=Kt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Fr=Kt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Od=Kt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ji=Kt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),sk=hs(/{{[\w\W]*|^[\w\W]*}}/g),nk=hs(/<%[\w\W]*|^[\w\W]*%>/g),ak=hs(/\${[\w\W]*/g),ik=hs(/^data-[\-\w.\u00B7-\uFFFF]+$/),lk=hs(/^aria-[\-\w]+$/),Dd=hs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),rk=hs(/^(?:\w+script|data):/i),ok=hs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ck=hs(/^html$/i),uk=hs(/^[a-z][.\w]*(-[.\w]+)+$/i),ks={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},dk=function(){return typeof window>"u"?null:window},fk=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Md=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function ng(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:dk();const t=he=>ng(he);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==ks.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=Ss(f,"cloneNode"),m=Ss(f,"remove"),g=Ss(f,"nextSibling"),w=Ss(f,"childNodes"),A=Ss(f,"parentNode"),b=Ss(f,"shadowRoot"),v=Ss(f,"attributes"),x=l&&l.prototype?Ss(l.prototype,"nodeType"):null,R=l&&l.prototype?Ss(l.prototype,"nodeName"):null;if(typeof i=="function"){const he=s.createElement("template");he.content&&he.content.ownerDocument&&(s=he.content.ownerDocument)}let L,O="",S,I=!1,D=0;const B=function(){if(D>0)throw Sn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},F=function(k){B(),D++;try{return L.createHTML(k)}finally{D--}},M=function(k){B(),D++;try{return L.createScriptURL(k)}finally{D--}},W=function(){return I||(S=fk(d,a),I=!0),S},U=s,j=U.implementation,_=U.createNodeIterator,N=U.createDocumentFragment,V=U.getElementsByTagName,re=n.importNode;let ve=Md();t.isSupported=typeof tg=="function"&&typeof A=="function"&&j&&j.createHTMLDocument!==void 0;const se=sk,de=nk,J=ak,ce=ik,Ie=lk,z=rk,oe=ok,le=uk;let ge=Dd,me=null;const Le=Re({},[...Id,...Dr,...Mr,...Pr,...Nd]);let y=null;const T=Re({},[...Ld,...Fr,...Od,...Ji]);let P=Object.seal(na(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),G=null,E=null;const $=Object.seal(na(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Z=!0,X=!0,te=!1,Y=!0,pe=!1,ie=!0,ue=!1,ye=!1,we=!1,Ee=!1,C=!1,Q=!1,be=!0,De=!1;const Je="user-content-";let We=!0,Ct=!1,st={},Ye=null;const sn=Re({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let xn=null;const Oi=Re({},["audio","video","img","source","image","track"]);let Na=null;const Di=Re({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),qn="http://www.w3.org/1998/Math/MathML",Kn="http://www.w3.org/2000/svg",Lt="http://www.w3.org/1999/xhtml";let gs=Lt,nn=!1,La=null;const Mi=Re({},[qn,Kn,Lt],Or);let H=Re({},["mi","mo","mn","ms","mtext"]),ne=Re({},["annotation-xml"]);const Se=Re({},["title","style","font","a","script"]);let je=null;const it=["application/xhtml+xml","text/html"],Gt="text/html";let nt=null,Gn=null;const vg=s.createElement("form"),Fc=function(k){return k instanceof RegExp||k instanceof Function},dr=function(){let k=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Gn&&Gn===k)return;(!k||typeof k!="object")&&(k={}),k=Dt(k),je=it.indexOf(k.PARSER_MEDIA_TYPE)===-1?Gt:k.PARSER_MEDIA_TYPE,nt=je==="application/xhtml+xml"?Or:Ga,me=lt(k,"ALLOWED_TAGS")&&Ht(k.ALLOWED_TAGS)?Re({},k.ALLOWED_TAGS,nt):Le,y=lt(k,"ALLOWED_ATTR")&&Ht(k.ALLOWED_ATTR)?Re({},k.ALLOWED_ATTR,nt):T,La=lt(k,"ALLOWED_NAMESPACES")&&Ht(k.ALLOWED_NAMESPACES)?Re({},k.ALLOWED_NAMESPACES,Or):Mi,Na=lt(k,"ADD_URI_SAFE_ATTR")&&Ht(k.ADD_URI_SAFE_ATTR)?Re(Dt(Di),k.ADD_URI_SAFE_ATTR,nt):Di,xn=lt(k,"ADD_DATA_URI_TAGS")&&Ht(k.ADD_DATA_URI_TAGS)?Re(Dt(Oi),k.ADD_DATA_URI_TAGS,nt):Oi,Ye=lt(k,"FORBID_CONTENTS")&&Ht(k.FORBID_CONTENTS)?Re({},k.FORBID_CONTENTS,nt):sn,G=lt(k,"FORBID_TAGS")&&Ht(k.FORBID_TAGS)?Re({},k.FORBID_TAGS,nt):Dt({}),E=lt(k,"FORBID_ATTR")&&Ht(k.FORBID_ATTR)?Re({},k.FORBID_ATTR,nt):Dt({}),st=lt(k,"USE_PROFILES")?k.USE_PROFILES&&typeof k.USE_PROFILES=="object"?Dt(k.USE_PROFILES):k.USE_PROFILES:!1,Z=k.ALLOW_ARIA_ATTR!==!1,X=k.ALLOW_DATA_ATTR!==!1,te=k.ALLOW_UNKNOWN_PROTOCOLS||!1,Y=k.ALLOW_SELF_CLOSE_IN_ATTR!==!1,pe=k.SAFE_FOR_TEMPLATES||!1,ie=k.SAFE_FOR_XML!==!1,ue=k.WHOLE_DOCUMENT||!1,Ee=k.RETURN_DOM||!1,C=k.RETURN_DOM_FRAGMENT||!1,Q=k.RETURN_TRUSTED_TYPE||!1,we=k.FORCE_BODY||!1,be=k.SANITIZE_DOM!==!1,De=k.SANITIZE_NAMED_PROPS||!1,We=k.KEEP_CONTENT!==!1,Ct=k.IN_PLACE||!1,ge=X_(k.ALLOWED_URI_REGEXP)?k.ALLOWED_URI_REGEXP:Dd,gs=typeof k.NAMESPACE=="string"?k.NAMESPACE:Lt,H=lt(k,"MATHML_TEXT_INTEGRATION_POINTS")&&k.MATHML_TEXT_INTEGRATION_POINTS&&typeof k.MATHML_TEXT_INTEGRATION_POINTS=="object"?Dt(k.MATHML_TEXT_INTEGRATION_POINTS):Re({},["mi","mo","mn","ms","mtext"]),ne=lt(k,"HTML_INTEGRATION_POINTS")&&k.HTML_INTEGRATION_POINTS&&typeof k.HTML_INTEGRATION_POINTS=="object"?Dt(k.HTML_INTEGRATION_POINTS):Re({},["annotation-xml"]);const q=lt(k,"CUSTOM_ELEMENT_HANDLING")&&k.CUSTOM_ELEMENT_HANDLING&&typeof k.CUSTOM_ELEMENT_HANDLING=="object"?Dt(k.CUSTOM_ELEMENT_HANDLING):na(null);if(P=na(null),lt(q,"tagNameCheck")&&Fc(q.tagNameCheck)&&(P.tagNameCheck=q.tagNameCheck),lt(q,"attributeNameCheck")&&Fc(q.attributeNameCheck)&&(P.attributeNameCheck=q.attributeNameCheck),lt(q,"allowCustomizedBuiltInElements")&&typeof q.allowCustomizedBuiltInElements=="boolean"&&(P.allowCustomizedBuiltInElements=q.allowCustomizedBuiltInElements),pe&&(X=!1),C&&(Ee=!0),st&&(me=Re({},Nd),y=na(null),st.html===!0&&(Re(me,Id),Re(y,Ld)),st.svg===!0&&(Re(me,Dr),Re(y,Fr),Re(y,Ji)),st.svgFilters===!0&&(Re(me,Mr),Re(y,Fr),Re(y,Ji)),st.mathMl===!0&&(Re(me,Pr),Re(y,Od),Re(y,Ji))),$.tagCheck=null,$.attributeCheck=null,lt(k,"ADD_TAGS")&&(typeof k.ADD_TAGS=="function"?$.tagCheck=k.ADD_TAGS:Ht(k.ADD_TAGS)&&(me===Le&&(me=Dt(me)),Re(me,k.ADD_TAGS,nt))),lt(k,"ADD_ATTR")&&(typeof k.ADD_ATTR=="function"?$.attributeCheck=k.ADD_ATTR:Ht(k.ADD_ATTR)&&(y===T&&(y=Dt(y)),Re(y,k.ADD_ATTR,nt))),lt(k,"ADD_URI_SAFE_ATTR")&&Ht(k.ADD_URI_SAFE_ATTR)&&Re(Na,k.ADD_URI_SAFE_ATTR,nt),lt(k,"FORBID_CONTENTS")&&Ht(k.FORBID_CONTENTS)&&(Ye===sn&&(Ye=Dt(Ye)),Re(Ye,k.FORBID_CONTENTS,nt)),lt(k,"ADD_FORBID_CONTENTS")&&Ht(k.ADD_FORBID_CONTENTS)&&(Ye===sn&&(Ye=Dt(Ye)),Re(Ye,k.ADD_FORBID_CONTENTS,nt)),We&&(me["#text"]=!0),ue&&Re(me,["html","head","body"]),me.table&&(Re(me,["tbody"]),delete G.tbody),k.TRUSTED_TYPES_POLICY){if(typeof k.TRUSTED_TYPES_POLICY.createHTML!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof k.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ae=L;L=k.TRUSTED_TYPES_POLICY;try{O=F("")}catch(ke){throw L=ae,ke}}else k.TRUSTED_TYPES_POLICY===null?(L=void 0,O=""):(L===void 0&&(L=W()),L&&typeof O=="string"&&(O=F("")));(ve.uponSanitizeElement.length>0||ve.uponSanitizeAttribute.length>0)&&me===Le&&(me=Dt(me)),ve.uponSanitizeAttribute.length>0&&y===T&&(y=Dt(y)),Kt&&Kt(k),Gn=k},$c=Re({},[...Dr,...Mr,...ek]),Uc=Re({},[...Pr,...tk]),bg=function(k){let q=A(k);(!q||!q.tagName)&&(q={namespaceURI:gs,tagName:"template"});const ae=Ga(k.tagName),ke=Ga(q.tagName);return La[k.namespaceURI]?k.namespaceURI===Kn?q.namespaceURI===Lt?ae==="svg":q.namespaceURI===qn?ae==="svg"&&(ke==="annotation-xml"||H[ke]):!!$c[ae]:k.namespaceURI===qn?q.namespaceURI===Lt?ae==="math":q.namespaceURI===Kn?ae==="math"&&ne[ke]:!!Uc[ae]:k.namespaceURI===Lt?q.namespaceURI===Kn&&!ne[ke]||q.namespaceURI===qn&&!H[ke]?!1:!Uc[ae]&&(Se[ae]||!$c[ae]):!!(je==="application/xhtml+xml"&&La[k.namespaceURI]):!1},ms=function(k){Qn(t.removed,{element:k});try{A(k).removeChild(k)}catch{if(m(k),!A(k))throw Sn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Bc=function(k){const q=w?w(k):k.childNodes;if(q){const ke=[];Ps(q,Ce=>{Qn(ke,Ce)}),Ps(ke,Ce=>{try{m(Ce)}catch{}})}const ae=v?v(k):null;if(ae)for(let ke=ae.length-1;ke>=0;--ke){const Ce=ae[ke],Ne=Ce&&Ce.name;if(typeof Ne=="string")try{k.removeAttribute(Ne)}catch{}}},_n=function(k,q){try{Qn(t.removed,{attribute:q.getAttributeNode(k),from:q})}catch{Qn(t.removed,{attribute:null,from:q})}if(q.removeAttribute(k),k==="is")if(Ee||C)try{ms(q)}catch{}else try{q.setAttribute(k,"")}catch{}},yg=function(k){const q=v?v(k):k.attributes;if(q)for(let ae=q.length-1;ae>=0;--ae){const ke=q[ae],Ce=ke&&ke.name;if(!(typeof Ce!="string"||y[nt(Ce)]))try{k.removeAttribute(Ce)}catch{}}},xg=function(k){const q=[k];for(;q.length>0;){const ae=q.pop();(x?x(ae):ae.nodeType)===ks.element&&yg(ae);const Ce=w?w(ae):ae.childNodes;if(Ce)for(let Ne=Ce.length-1;Ne>=0;--Ne)q.push(Ce[Ne])}},Hc=function(k){let q=null,ae=null;if(we)k="<remove></remove>"+k;else{const Ne=Cd(k,/^[\r\n\t ]+/);ae=Ne&&Ne[0]}je==="application/xhtml+xml"&&gs===Lt&&(k='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+k+"</body></html>");const ke=L?F(k):k;if(gs===Lt)try{q=new u().parseFromString(ke,je)}catch{}if(!q||!q.documentElement){q=j.createDocument(gs,"template",null);try{q.documentElement.innerHTML=nn?O:ke}catch{}}const Ce=q.body||q.documentElement;return k&&ae&&Ce.insertBefore(s.createTextNode(ae),Ce.childNodes[0]||null),gs===Lt?V.call(q,ue?"html":"body")[0]:ue?q.documentElement:Ce},Vc=function(k){return _.call(k.ownerDocument||k,k,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},fr=function(k){var q,ae;k.normalize();const ke=_.call(k.ownerDocument||k,k,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Ce=ke.nextNode();for(;Ce;){let bt=Ce.data;Ps([se,de,J],Qe=>{bt=Xn(bt,Qe," ")}),Ce.data=bt,Ce=ke.nextNode()}const Ne=(q=(ae=k.querySelectorAll)===null||ae===void 0?void 0:ae.call(k,"template"))!==null&&q!==void 0?q:[];Ps(Array.from(Ne),bt=>{Wn(bt.content)&&fr(bt.content)})},Pi=function(k){const q=R?R(k):null;return typeof q!="string"||nt(q)!=="form"?!1:typeof k.nodeName!="string"||typeof k.textContent!="string"||typeof k.removeChild!="function"||k.attributes!==v(k)||typeof k.removeAttribute!="function"||typeof k.setAttribute!="function"||typeof k.namespaceURI!="string"||typeof k.insertBefore!="function"||typeof k.hasChildNodes!="function"||k.nodeType!==x(k)||k.childNodes!==w(k)},Wn=function(k){if(!x||typeof k!="object"||k===null)return!1;try{return x(k)===ks.documentFragment}catch{return!1}},Oa=function(k){if(!x||typeof k!="object"||k===null)return!1;try{return typeof x(k)=="number"}catch{return!1}};function Ls(he,k,q){Ps(he,ae=>{ae.call(t,k,q,Gn)})}const jc=function(k){let q=null;if(Ls(ve.beforeSanitizeElements,k,null),Pi(k))return ms(k),!0;const ae=nt(R?R(k):k.nodeName);if(Ls(ve.uponSanitizeElement,k,{tagName:ae,allowedTags:me}),ie&&k.hasChildNodes()&&!Oa(k.firstElementChild)&&Et(/<[/\w!]/g,k.innerHTML)&&Et(/<[/\w!]/g,k.textContent)||ie&&k.namespaceURI===Lt&&ae==="style"&&Oa(k.firstElementChild)||k.nodeType===ks.progressingInstruction||ie&&k.nodeType===ks.comment&&Et(/<[/\w]/g,k.data))return ms(k),!0;if(G[ae]||!($.tagCheck instanceof Function&&$.tagCheck(ae))&&!me[ae]){if(!G[ae]&&qc(ae)&&(P.tagNameCheck instanceof RegExp&&Et(P.tagNameCheck,ae)||P.tagNameCheck instanceof Function&&P.tagNameCheck(ae)))return!1;if(We&&!Ye[ae]){const Ce=A(k),Ne=w(k);if(Ne&&Ce){const bt=Ne.length;for(let Qe=bt-1;Qe>=0;--Qe){const ct=Ct?Ne[Qe]:p(Ne[Qe],!0);Ce.insertBefore(ct,g(k))}}}return ms(k),!0}return(x?x(k):k.nodeType)===ks.element&&!bg(k)||(ae==="noscript"||ae==="noembed"||ae==="noframes")&&Et(/<\/no(script|embed|frames)/i,k.innerHTML)?(ms(k),!0):(pe&&k.nodeType===ks.text&&(q=k.textContent,Ps([se,de,J],Ce=>{q=Xn(q,Ce," ")}),k.textContent!==q&&(Qn(t.removed,{element:k.cloneNode()}),k.textContent=q)),Ls(ve.afterSanitizeElements,k,null),!1)},zc=function(k,q,ae){if(E[q]||be&&(q==="id"||q==="name")&&(ae in s||ae in vg))return!1;const ke=y[q]||$.attributeCheck instanceof Function&&$.attributeCheck(q,k);if(!(X&&!E[q]&&Et(ce,q))){if(!(Z&&Et(Ie,q))){if(!ke||E[q]){if(!(qc(k)&&(P.tagNameCheck instanceof RegExp&&Et(P.tagNameCheck,k)||P.tagNameCheck instanceof Function&&P.tagNameCheck(k))&&(P.attributeNameCheck instanceof RegExp&&Et(P.attributeNameCheck,q)||P.attributeNameCheck instanceof Function&&P.attributeNameCheck(q,k))||q==="is"&&P.allowCustomizedBuiltInElements&&(P.tagNameCheck instanceof RegExp&&Et(P.tagNameCheck,ae)||P.tagNameCheck instanceof Function&&P.tagNameCheck(ae))))return!1}else if(!Na[q]){if(!Et(ge,Xn(ae,oe,""))){if(!((q==="src"||q==="xlink:href"||q==="href")&&k!=="script"&&Ed(ae,"data:")===0&&xn[k])){if(!(te&&!Et(z,Xn(ae,oe,"")))){if(ae)return!1}}}}}}return!0},_g=Re({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),qc=function(k){return!_g[Ga(k)]&&Et(le,k)},Kc=function(k){Ls(ve.beforeSanitizeAttributes,k,null);const q=k.attributes;if(!q||Pi(k))return;const ae={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let ke=q.length;for(;ke--;){const Ce=q[ke],Ne=Ce.name,bt=Ce.namespaceURI,Qe=Ce.value,ct=nt(Ne),an=Qe;let kt=Ne==="value"?an:G_(an);if(ae.attrName=ct,ae.attrValue=kt,ae.keepAttr=!0,ae.forceKeepAttr=void 0,Ls(ve.uponSanitizeAttribute,k,ae),kt=ae.attrValue,De&&(ct==="id"||ct==="name")&&Ed(kt,Je)!==0&&(_n(Ne,k),kt=Je+kt),ie&&Et(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,kt)){_n(Ne,k);continue}if(ct==="attributename"&&Cd(kt,"href")){_n(Ne,k);continue}if(ae.forceKeepAttr)continue;if(!ae.keepAttr){_n(Ne,k);continue}if(!Y&&Et(/\/>/i,kt)){_n(Ne,k);continue}pe&&Ps([se,de,J],Wc=>{kt=Xn(kt,Wc," ")});const Gc=nt(k.nodeName);if(!zc(Gc,ct,kt)){_n(Ne,k);continue}if(L&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!bt)switch(d.getAttributeType(Gc,ct)){case"TrustedHTML":{kt=F(kt);break}case"TrustedScriptURL":{kt=M(kt);break}}if(kt!==an)try{bt?k.setAttributeNS(bt,Ne,kt):k.setAttribute(Ne,kt),Pi(k)?ms(k):Td(t.removed)}catch{_n(Ne,k)}}Ls(ve.afterSanitizeAttributes,k,null)},Fi=function(k){let q=null;const ae=Vc(k);for(Ls(ve.beforeSanitizeShadowDOM,k,null);q=ae.nextNode();)if(Ls(ve.uponSanitizeShadowNode,q,null),jc(q),Kc(q),Wn(q.content)&&Fi(q.content),(x?x(q):q.nodeType)===ks.element){const Ce=b?b(q):q.shadowRoot;Wn(Ce)&&(pr(Ce),Fi(Ce))}Ls(ve.afterSanitizeShadowDOM,k,null)},pr=function(k){const q=[{node:k,shadow:null}];for(;q.length>0;){const ae=q.pop();if(ae.shadow){Fi(ae.shadow);continue}const ke=ae.node,Ne=(x?x(ke):ke.nodeType)===ks.element,bt=w?w(ke):ke.childNodes;if(bt)for(let Qe=bt.length-1;Qe>=0;--Qe)q.push({node:bt[Qe],shadow:null});if(Ne){const Qe=R?R(ke):null;if(typeof Qe=="string"&&nt(Qe)==="template"){const ct=ke.content;Wn(ct)&&q.push({node:ct,shadow:null})}}if(Ne){const Qe=b?b(ke):ke.shadowRoot;Wn(Qe)&&q.push({node:null,shadow:Qe},{node:Qe,shadow:null})}}};return t.sanitize=function(he){let k=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},q=null,ae=null,ke=null,Ce=null;if(nn=!he,nn&&(he="<!-->"),typeof he!="string"&&!Oa(he)&&(he=Q_(he),typeof he!="string"))throw Sn("dirty is not a string, aborting");if(!t.isSupported)return he;ye||dr(k),t.removed=[];const Ne=Ct&&typeof he!="string"&&Oa(he);if(Ne){const ct=R?R(he):he.nodeName;if(typeof ct=="string"){const an=nt(ct);if(!me[an]||G[an])throw Sn("root node is forbidden and cannot be sanitized in-place")}if(Pi(he))throw Sn("root node is clobbered and cannot be sanitized in-place");try{pr(he)}catch(an){throw Bc(he),an}}else if(Oa(he))q=Hc("<!---->"),ae=q.ownerDocument.importNode(he,!0),ae.nodeType===ks.element&&ae.nodeName==="BODY"||ae.nodeName==="HTML"?q=ae:q.appendChild(ae),pr(ae);else{if(!Ee&&!pe&&!ue&&he.indexOf("<")===-1)return L&&Q?F(he):he;if(q=Hc(he),!q)return Ee?null:Q?O:""}q&&we&&ms(q.firstChild);const bt=Vc(Ne?he:q);try{for(;ke=bt.nextNode();)jc(ke),Kc(ke),Wn(ke.content)&&Fi(ke.content)}catch(ct){throw Ne&&Bc(he),ct}if(Ne)return Ps(t.removed,ct=>{ct.element&&xg(ct.element)}),pe&&fr(he),he;if(Ee){if(pe&&fr(q),C)for(Ce=N.call(q.ownerDocument);q.firstChild;)Ce.appendChild(q.firstChild);else Ce=q;return(y.shadowroot||y.shadowrootmode)&&(Ce=re.call(n,Ce,!0)),Ce}let Qe=ue?q.outerHTML:q.innerHTML;return ue&&me["!doctype"]&&q.ownerDocument&&q.ownerDocument.doctype&&q.ownerDocument.doctype.name&&Et(ck,q.ownerDocument.doctype.name)&&(Qe="<!DOCTYPE "+q.ownerDocument.doctype.name+`>
`+Qe),pe&&Ps([se,de,J],ct=>{Qe=Xn(Qe,ct," ")}),L&&Q?F(Qe):Qe},t.setConfig=function(){let he=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};dr(he),ye=!0},t.clearConfig=function(){Gn=null,ye=!1,L=S,O=""},t.isValidAttribute=function(he,k,q){Gn||dr({});const ae=nt(he),ke=nt(k);return zc(ae,ke,q)},t.addHook=function(he,k){typeof k=="function"&&Qn(ve[he],k)},t.removeHook=function(he,k){if(k!==void 0){const q=q_(ve[he],k);return q===-1?void 0:K_(ve[he],q,1)[0]}return Td(ve[he])},t.removeHooks=function(he){ve[he]=[]},t.removeAllHooks=function(){ve=Md()},t}var Pd=ng();function Ac(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var zn=Ac();function ag(e){zn=e}var si={exec:()=>null};function Ke(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(zt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var zt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},pk=/^(?:[ \t]*(?:\n|$))+/,hk=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,gk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Li=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,mk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Rc=/(?:[*+-]|\d{1,9}[.)])/,ig=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,lg=Ke(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),vk=Ke(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ic=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,bk=/^[^\n]+/,Nc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,yk=Ke(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Nc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),xk=Ke(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Rc).getRegex(),or="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Lc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_k=Ke("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Lc).replace("tag",or).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),rg=Ke(Ic).replace("hr",Li).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex(),kk=Ke(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",rg).getRegex(),Oc={blockquote:kk,code:hk,def:yk,fences:gk,heading:mk,hr:Li,html:_k,lheading:lg,list:xk,newline:pk,paragraph:rg,table:si,text:bk},Fd=Ke("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Li).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex(),wk={...Oc,lheading:vk,table:Fd,paragraph:Ke(Ic).replace("hr",Li).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Fd).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex()},Sk={...Oc,html:Ke(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Lc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:si,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Ke(Ic).replace("hr",Li).replace("heading",` *#{1,6} *[^
]`).replace("lheading",lg).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Tk=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ck=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,og=/^( {2,}|\\)\n(?!\s*$)/,Ek=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,cr=/[\p{P}\p{S}]/u,Dc=/[\s\p{P}\p{S}]/u,cg=/[^\s\p{P}\p{S}]/u,Ak=Ke(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Dc).getRegex(),ug=/(?!~)[\p{P}\p{S}]/u,Rk=/(?!~)[\s\p{P}\p{S}]/u,Ik=/(?:[^\s\p{P}\p{S}]|~)/u,Nk=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,dg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Lk=Ke(dg,"u").replace(/punct/g,cr).getRegex(),Ok=Ke(dg,"u").replace(/punct/g,ug).getRegex(),fg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Dk=Ke(fg,"gu").replace(/notPunctSpace/g,cg).replace(/punctSpace/g,Dc).replace(/punct/g,cr).getRegex(),Mk=Ke(fg,"gu").replace(/notPunctSpace/g,Ik).replace(/punctSpace/g,Rk).replace(/punct/g,ug).getRegex(),Pk=Ke("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,cg).replace(/punctSpace/g,Dc).replace(/punct/g,cr).getRegex(),Fk=Ke(/\\(punct)/,"gu").replace(/punct/g,cr).getRegex(),$k=Ke(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Uk=Ke(Lc).replace("(?:-->|$)","-->").getRegex(),Bk=Ke("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Uk).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ol=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Hk=Ke(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Ol).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),pg=Ke(/^!?\[(label)\]\[(ref)\]/).replace("label",Ol).replace("ref",Nc).getRegex(),hg=Ke(/^!?\[(ref)\](?:\[\])?/).replace("ref",Nc).getRegex(),Vk=Ke("reflink|nolink(?!\\()","g").replace("reflink",pg).replace("nolink",hg).getRegex(),Mc={_backpedal:si,anyPunctuation:Fk,autolink:$k,blockSkip:Nk,br:og,code:Ck,del:si,emStrongLDelim:Lk,emStrongRDelimAst:Dk,emStrongRDelimUnd:Pk,escape:Tk,link:Hk,nolink:hg,punctuation:Ak,reflink:pg,reflinkSearch:Vk,tag:Bk,text:Ek,url:si},jk={...Mc,link:Ke(/^!?\[(label)\]\((.*?)\)/).replace("label",Ol).getRegex(),reflink:Ke(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ol).getRegex()},ko={...Mc,emStrongRDelimAst:Mk,emStrongLDelim:Ok,url:Ke(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},zk={...ko,br:Ke(og).replace("{2,}","*").getRegex(),text:Ke(ko.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Yi={normal:Oc,gfm:wk,pedantic:Sk},Ha={normal:Mc,gfm:ko,breaks:zk,pedantic:jk},qk={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},$d=e=>qk[e];function Ts(e,t){if(t){if(zt.escapeTest.test(e))return e.replace(zt.escapeReplace,$d)}else if(zt.escapeTestNoEncode.test(e))return e.replace(zt.escapeReplaceNoEncode,$d);return e}function Ud(e){try{e=encodeURI(e).replace(zt.percentDecode,"%")}catch{return null}return e}function Bd(e,t){var i;const s=e.replace(zt.findPipe,(l,r,o)=>{let c=!1,u=r;for(;--u>=0&&o[u]==="\\";)c=!c;return c?"|":" |"}),n=s.split(zt.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(zt.slashPipe,"|");return n}function Va(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function Kk(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function Hd(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function Gk(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Ts(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Un=new Wk;function Ve(e,t){return Un.parse(e,t)}Ve.options=Ve.setOptions=function(e){return Un.setOptions(e),Ve.defaults=Un.defaults,ag(Ve.defaults),Ve};Ve.getDefaults=Ac;Ve.defaults=zn;Ve.use=function(...e){return Un.use(...e),Ve.defaults=Un.defaults,ag(Ve.defaults),Ve};Ve.walkTokens=function(e,t){return Un.walkTokens(e,t)};Ve.parseInline=Un.parseInline;Ve.Parser=qs;Ve.parser=qs.parse;Ve.Renderer=Ml;Ve.TextRenderer=Pc;Ve.Lexer=zs;Ve.lexer=zs.lex;Ve.Tokenizer=Dl;Ve.Hooks=il;Ve.parse=Ve;Ve.options;Ve.setOptions;Ve.use;Ve.walkTokens;Ve.parseInline;qs.parse;zs.lex;const Zk={breaks:!0,gfm:!0};function Vd(e){if(!e)return"";try{if(typeof Ve<"u"&&Ve.parse){const t=Ve.parse(e,Zk);return typeof Pd<"u"?Pd.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Jk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Yk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Qk(e){return Yk[e]||"wrench"}const Xk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function jd(e){if(!e)return[];const t=e.match(Xk);return t?[...new Set(t)]:[]}const ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=ee(()=>t.value.trim().length>0&&!s.value),d=ee(()=>{const U=qe.state;return U==="connected"?"Connected":U==="reconnecting"?"Reconnecting…":U==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=ee(()=>{const U=Math.floor(i.value/4)%f.length,j=i.value;return j>3?`${f[U]} (${j}s)`:f[0]});function m(){St(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const U=a.value;U.style.height="auto",U.style.height=Math.min(U.scrollHeight,120)+"px"}function w(U,j,_={}){const N={id:++o,role:U,content:j,timestamp:Date.now(),html:U==="bot"?Vd(j):"",tools_used:_.tools_used||[],is_error:_.is_error||!1,images:U==="bot"?jd(j):[],files:_.files||[],_showTools:!1};return e.value.push(N),m(),U==="bot"&&St(()=>A()),N}function A(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(j=>{j.setAttribute("data-copy","true"),j.style.position="relative";const _=document.createElement("button");_.className="chat-code-copy",_.textContent="Copy",_.addEventListener("click",()=>{const N=j.querySelector("code"),V=N?N.textContent:j.textContent;navigator.clipboard.writeText(V).then(()=>{_.textContent="Copied!",setTimeout(()=>{_.textContent="Copy"},1500)}).catch(()=>{})}),j.appendChild(_)})}function b(U){if(U===0)return!0;const j=e.value[U-1],_=e.value[U],N=new Date(j.timestamp).toDateString(),V=new Date(_.timestamp).toDateString();return N!==V}function v(U){const j=new Date(U),_=new Date;if(j.toDateString()===_.toDateString())return"Today";const N=new Date(_);return N.setDate(N.getDate()-1),j.toDateString()===N.toDateString()?"Yesterday":j.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(U){t.value=U,St(()=>B())}function R(U){window.open(U,"_blank","noopener")}function L(U){U.target.style.display="none"}function O(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function S(){r&&(clearInterval(r),r=null),i.value=0}function I(U){s.value&&(s.value=!1,S(),U.type==="chat_response"?w("bot",U.content,{tools_used:U.tools_used||[],is_error:U.is_error||!1,files:U.files||[]}):U.type==="chat_error"&&w("bot",U.error||"Unknown error",{is_error:!0}),St(()=>{var j;return(j=a.value)==null?void 0:j.focus()}))}async function D(U){try{const j=await K.post("/api/chat",{content:U,channel_id:l.value});w("bot",j.response,{tools_used:j.tools_used||[],is_error:j.is_error||!1,files:j.files||[]})}catch(j){w("bot",j.message||"Failed to send message",{is_error:!0})}}async function B(){const U=t.value.trim();!U||s.value||(w("user",U),t.value="",s.value=!0,O(),a.value&&(a.value.style.height="auto"),qe.connected?qe.sendChat(U,{channelId:l.value})?M():(await D(U),s.value=!1,S()):(await D(U),s.value=!1,S()),St(()=>{var j;return(j=a.value)==null?void 0:j.focus()}))}let F=null;ns(s,U=>{U||F&&(clearTimeout(F),F=null)});function M(){F=setTimeout(()=>{s.value&&(s.value=!1,S(),w("bot","Response timed out. Try again.",{is_error:!0}))},12e4)}async function W(){try{if(!l.value){const j=await K.get("/api/auth/session");l.value=j.channel_id||j.user_id||"web-user"}const U=await K.get("/api/sessions/"+encodeURIComponent(l.value));if(U&&U.messages&&U.messages.length>0){for(const j of U.messages){const _=j.role==="user"?"user":"bot";let N=j.content||"";if(_==="user"){const re=N.match(/^\[.*?\]:\s*/);re&&(N=N.slice(re[0].length))}if(!N.trim())continue;const V={id:++o,role:_,content:N,timestamp:j.timestamp?j.timestamp*1e3:Date.now(),html:_==="bot"?Vd(N):"",tools_used:[],is_error:!1,images:_==="bot"?jd(N):[],files:[],_showTools:!1};e.value.push(V)}St(()=>{m(),A()})}}catch{}}return $e(()=>{qe.subscribe("chat",I),W(),St(()=>{var U;return(U=a.value)==null?void 0:U.focus()})}),ft(()=>{qe.unsubscribe("chat",I),F&&clearTimeout(F),S()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:B,autoResize:g,formatTime:Jk,formatDate:v,showDateSeparator:b,useSuggestion:x,openImage:R,onImageError:L,getToolIcon:Qk}}},ur={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=A_(),s=Yh(),n=ee({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});ns(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var u;return(u=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:u.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},tw={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(c){var f,p,m;const u=c.payload||c,d=u.type||c.type;if(d==="tool_start"){const g={id:`${u.action}-${Date.now()}`,tool:u.action,actor:u.actor||"",channel:u.channel_id||"",iteration:((f=u.metadata)==null?void 0:f.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(g);return}if(d==="tool_end"){const g=e.value.findIndex(w=>w.tool===u.action&&w.status==="running");if(g>=0){const w=e.value[g];w.status=(p=u.metadata)!=null&&p.error?"error":"success",w.elapsed=((m=u.metadata)==null?void 0:m.elapsed_ms)||Date.now()-w.startTime,w.result=u.detail||"",w.fadingOut=!0,setTimeout(()=>{const A=e.value.indexOf(w);A>=0&&e.value.splice(A,1),t.value.unshift(w),t.value.length>n&&t.value.pop()},5e3)}return}if(d==="tool_stream"){const g=u.tool_name||"unknown";if(u.finished)delete s.value[g];else{const A=((s.value[g]||"")+(u.chunk||"")).split(`
`);s.value[g]=A.slice(-30).join(`
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}$e(()=>{qe.on("events",a),i=setInterval(l,500)}),ft(()=>{qe.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
    <div class="space-y-6">
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=ee(()=>e.value.reduce((L,O)=>L+(O.iteration_count||0),0)),d=ee(()=>e.value.filter(L=>L.status==="running").length);function f(L){return L==="running"?"loop-status-running":L==="error"?"loop-status-error":"loop-status-stopped"}function p(L){return L==="running"?"badge-success":L==="error"?"badge-danger":L==="completed"?"badge-info":"badge-warning"}function m(L){return L==="act"?"badge-warning":L==="silent"?"badge-info":"badge-success"}function g(L){c.value={...c.value,[L]:!c.value[L]}}async function w(L=!1){L=L===!0,L||(t.value=!0);try{e.value=await K.get("/api/loops"),s.value=null}catch(O){L||(s.value=O.message)}L||(t.value=!1)}async function A(){l.value=null;const L=a.value;if(!L.goal.trim()){l.value="Goal is required";return}if(!L.channel_id.trim()){l.value="Channel ID is required";return}const O={goal:L.goal.trim(),channel_id:L.channel_id.trim(),interval_seconds:L.interval_seconds||60,mode:L.mode,max_iterations:L.max_iterations||50};L.stop_condition.trim()&&(O.stop_condition=L.stop_condition.trim()),i.value=!0;try{const S=await K.post("/api/loops",O);xe.success(`Loop started: ${S.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await w()}catch(S){l.value=S.message}i.value=!1}async function b(L){if(await is({title:"Stop loop",message:`Stop loop ${L}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=L;try{await K.del(`/api/loops/${encodeURIComponent(L)}`),xe.success("Loop stopped"),await w()}catch(S){xe.error(S.message||"Failed to stop loop")}r.value=null}}async function v(L){o.value=L;try{await K.post(`/api/loops/${encodeURIComponent(L)}/restart`),xe.success("Loop restarted"),await w()}catch(O){xe.error(O.message||"Failed to restart loop")}o.value=null}function x(L){L.payload&&(L.payload.loop_id||L.payload.type==="loop")&&w(!0)}let R=null;return $e(()=>{w(),qe.subscribe("events",x),R=setInterval(()=>{w(!0)},5e3)}),ft(()=>{qe.unsubscribe("events",x),R&&clearInterval(R)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:Ca,formatAge:Qh,toggleHistory:g,fetchLoops:w,doCreate:A,doStop:b,doRestart:v}}},aw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=ee(()=>e.value.filter(g=>g.status==="running").length),r=ee(()=>e.value.filter(g=>g.status!=="running").length);function o(g){return g==="running"?"loop-status-running":g==="failed"||g==="error"?"loop-status-error":"loop-status-stopped"}function c(g){return g==="running"?"badge-success":g==="completed"||g==="exited"?"badge-info":g==="killed"||g==="error"||g==="failed"?"badge-danger":"badge-warning"}async function u(g=!1){g=g===!0,g||(t.value=!0);try{e.value=await K.get("/api/processes"),s.value=null}catch(w){g||(s.value=w.message)}g||(t.value=!1)}function d(){f(),n.value&&(a=setInterval(()=>{t.value||u(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}ns(n,g=>{g?d():f()});async function p(g){if(await is({title:"Kill process",message:`Kill process ${g}?`,confirmLabel:"Kill",danger:!0})){i.value=g;try{await K.del(`/api/processes/${g}`),xe.success(`Process ${g} killed`),await u()}catch(A){xe.error(A.message||"Failed to kill process")}i.value=null}}function m(g){g.payload&&(g.payload.pid||g.payload.type==="process")&&u(!0)}return $e(()=>{u(),qe.subscribe("events",m),d()}),ft(()=>{qe.unsubscribe("events",m),f()}),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:Ca,fetchProcesses:u,doKill:p}}},iw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),m=h(null),g=h([]),w=h(!1),A=ee(()=>e.value.filter(_=>_.cron&&!_.one_time).length),b=ee(()=>e.value.filter(_=>_.one_time).length),v=ee(()=>e.value.filter(_=>_.trigger).length),x=ee(()=>e.value.filter(_=>_.paused).length),R=ee(()=>e.value.filter(_=>_.consecutive_failures>0).length);function L(_){if(!_)return"-";const N=Date.now(),re=(new Date(_).getTime()-N)/1e3;if(re<0)return"overdue";if(re<60)return"in < 1 min";if(re<3600)return`in ${Math.floor(re/60)} min`;if(re<86400){const se=Math.floor(re/3600),de=Math.floor(re%3600/60);return de>0?`in ${se}h ${de}m`:`in ${se}h`}const ve=Math.floor(re/86400);return`in ${ve} day${ve!==1?"s":""}`}function O(_){return _==null?"-":_<1e3?`${_}ms`:_<6e4?`${(_/1e3).toFixed(1)}s`:Ca(_/1e3)}function S(){r.value=null}async function I(){const _=a.value.cron.trim();if(_){o.value=!0;try{r.value=await K.post("/api/schedules/validate-cron",{expression:_})}catch(N){r.value={valid:!1,error:N.message}}o.value=!1}}async function D(){t.value=!0,s.value=null;try{e.value=await K.get("/api/schedules")}catch(_){s.value=_.message}t.value=!1}async function B(_){if(m.value===_){m.value=null,g.value=[];return}m.value=_,w.value=!0,g.value=[];try{g.value=await K.get(`/api/schedules/${encodeURIComponent(_)}/history?limit=10`)}catch{g.value=[]}w.value=!1}async function F(){l.value=null;const _=a.value;if(!_.description.trim()){l.value="Description is required";return}if(!_.channel_id.trim()){l.value="Channel ID is required";return}if(!_.cron.trim()&&!_.run_at.trim()){l.value="Cron expression or run_at time is required";return}const N={description:_.description.trim(),action:_.action,channel_id:_.channel_id.trim()};if(_.cron.trim()&&(N.cron=_.cron.trim()),_.run_at.trim()&&(N.run_at=_.run_at.trim()),_.action==="reminder"&&_.message.trim()&&(N.message=_.message.trim()),_.action==="check"&&(_.tool_name.trim()&&(N.tool_name=_.tool_name.trim()),_.tool_input_str.trim()))try{N.tool_input=JSON.parse(_.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await K.post("/api/schedules",N),xe.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await D()}catch(V){l.value=V.message}i.value=!1}async function M(_){u.value=_;try{const N=await K.post(`/api/schedules/${encodeURIComponent(_)}/run`);if(N.status==="failure")xe.error(`Execution failed: ${N.error||"unknown error"}`);else{const V=N.warning?`Executed (${N.warning})`:"Executed successfully";xe.success(V)}await D()}catch(N){xe.error(N.message||"Failed to trigger")}u.value=null}async function W(_){f.value=_.id;const N=!_.paused;try{await K.put(`/api/schedules/${encodeURIComponent(_.id)}`,{paused:N}),xe.success(N?"Schedule paused":"Schedule resumed"),await D()}catch(V){xe.error(V.message||"Failed to update schedule")}f.value=null}async function U(_){p.value=_;try{await K.post(`/api/schedules/${encodeURIComponent(_)}/reset-failures`),xe.success("Failure counters reset"),await D()}catch(N){xe.error(N.message||"Failed to reset")}p.value=null}async function j(_){const N=e.value.find(re=>re.id===_);if(await is({title:"Delete schedule",message:`Delete "${(N==null?void 0:N.description)||_}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=_;try{await K.del(`/api/schedules/${encodeURIComponent(_)}`),xe.success("Schedule deleted"),await D()}catch(re){xe.error(re.message||"Failed to delete schedule")}d.value=null}}return $e(()=>{D()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:m,history:g,historyLoading:w,cronCount:A,oneTimeCount:b,webhookCount:v,pausedCount:x,failingCount:R,formatTs:Ia,formatAge:Qh,formatFuture:L,formatMs:O,formatDuration:Ca,onCronInput:S,validateCron:I,toggleExpand:B,fetchSchedules:D,doCreate:F,doRunNow:M,doTogglePause:W,doResetFailures:U,doDelete:j}}},lw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=zd,g=ow,w=h([]),A=h(!1),b=h(""),v=h("flat"),x=h(new Set),R=h(""),L=h(""),O=h(""),S=h(null),I=h(!1);function D(){try{const C=localStorage.getItem("odin-session-presets");C&&(w.value=JSON.parse(C))}catch{}}function B(){try{localStorage.setItem("odin-session-presets",JSON.stringify(w.value))}catch{}}const F=ee(()=>d.value.trim()!==""||u.value!=="all"),M=ee(()=>{let C=[...e.value];const Q=zd.find(We=>We.id===u.value),be=Q?Q.filters:{};if(be.source&&(C=C.filter(We=>We.source===be.source)),be.minMessages&&(C=C.filter(We=>We.message_count>=be.minMessages)),be.hasCompaction&&(C=C.filter(We=>We.has_summary)),be.maxAge!=null){const We=Date.now()/1e3;C=C.filter(Ct=>Ct.last_active&&We-Ct.last_active<=be.maxAge)}if(d.value.trim()){const We=d.value.toLowerCase().trim();C=C.filter(Ct=>(Ct.channel_id||"").toLowerCase().includes(We)||(Ct.last_user_id||"").toLowerCase().includes(We)||(Ct.source||"").toLowerCase().includes(We))}const De=f.value,Je=p.value?1:-1;return C.sort((We,Ct)=>{const st=We[De]||0,Ye=Ct[De]||0;return(st-Ye)*Je}),C}),W=ee(()=>{if(!a.value||!a.value.messages)return[];const C=a.value.messages;if(C.length===0)return[];const Q=[];let be=[];for(const De of C)De.role==="user"&&be.length>0&&(Q.push(be),be=[]),be.push(De);return be.length>0&&Q.push(be),Q}),U=ee(()=>M.value.length>0&&o.value.size===M.value.length);function j(C){const Q=C.find(be=>be.role==="user");if(Q&&Q.content){const be=Q.content.slice(0,120);return be.length<Q.content.length?be+"...":be}return"(no user message)"}function _(C){const Q=new Set(x.value);Q.has(C)?Q.delete(C):Q.add(C),x.value=Q}function N(C){u.value=C}function V(C){u.value=C.id,C.filters.searchQuery!=null&&(d.value=C.filters.searchQuery),C.filters.sortBy&&(f.value=C.filters.sortBy)}function re(){if(!b.value.trim())return;const C={id:"custom-"+Date.now(),name:b.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};w.value=[...w.value,C],B(),A.value=!1,b.value=""}function ve(C){w.value=w.value.filter(Q=>Q.id!==C),B(),u.value===C&&(u.value="all")}function se(){u.value="all",d.value="",f.value="last_active",p.value=!1}function de(C){if(!C)return"—";const Q=Date.now()/1e3-C;if(Q<60)return"just now";if(Q<3600){const De=Math.floor(Q/60);return`${De} minute${De!==1?"s":""} ago`}if(Q<86400){const De=Math.floor(Q/3600);return`${De} hour${De!==1?"s":""} ago`}const be=Math.floor(Q/86400);return`${be} day${be!==1?"s":""} ago`}function J(C){if(!C)return"";try{return new Date(C*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ce(C){if(!C)return"";try{return new Date(C*1e3).toLocaleString()}catch{return""}}function Ie(C){return C==="user"?"bg-gray-900/50 border border-gray-800":C==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function z(C){return C==="user"?"sess-msg-user":C==="assistant"?"sess-msg-assistant":"sess-msg-system"}function oe(C){return C==="user"?"badge-info":C==="assistant"?"badge-success":"badge-warning"}function le(C){return C==="user"?"sess-dot-user":C==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ge(C){return C==="user"?"text-cyan-400":C==="assistant"?"text-indigo-400":"text-gray-500"}function me(C){return C?C.length>2e3?C.slice(0,2e3)+`
... (truncated)`:C:""}async function Le(){const C=R.value.trim();if(C){I.value=!0;try{let Q=`/api/sessions/search?q=${encodeURIComponent(C)}&limit=50`;L.value.trim()&&(Q+=`&channel_id=${encodeURIComponent(L.value.trim())}`),O.value.trim()&&(Q+=`&user_id=${encodeURIComponent(O.value.trim())}`);const be=await K.get(Q);S.value=be.results||[]}catch{S.value=[]}I.value=!1}}function y(){R.value="",L.value="",O.value="",S.value=null}function T(C){return C?C.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function P(C){return C==="user"?"bg-gray-900/50 border-gray-800":C==="assistant"?"bg-indigo-950/30 border-indigo-900/30":C==="summary"?"bg-amber-950/20 border-amber-900/30":C==="fts"?"bg-emerald-950/20 border-emerald-900/30":C==="channel"?"bg-purple-950/20 border-purple-900/30":"bg-gray-900/30 border-gray-800/50"}function G(C){return C==="user"?"badge-info":C==="assistant"?"badge-success":C==="summary"?"badge-warning":C==="fts"?"badge-success":"badge-info"}async function E(){t.value=!0,s.value=null;try{e.value=await K.get("/api/sessions")}catch(C){s.value=C.message}t.value=!1}function $(){s.value=null,E()}async function Z(C){if(n.value===C){n.value=null,a.value=null,x.value=new Set;return}n.value=C,a.value=null,i.value=!0,x.value=new Set;try{a.value=await K.get(`/api/sessions/${encodeURIComponent(C)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function X(C){const Q=new Set(o.value);Q.has(C)?Q.delete(C):Q.add(C),o.value=Q}function te(){U.value?o.value=new Set:o.value=new Set(M.value.map(C=>C.channel_id))}function Y(C){l.value=C}async function pe(){if(l.value){r.value=!0;try{await K.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await E()}catch(C){s.value=C.message||"Failed to clear session"}r.value=!1,l.value=null}}function ie(){c.value=!0}async function ue(){if(o.value.size!==0){r.value=!0;try{await K.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await E()}catch(C){s.value=C.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function ye(C,Q){const be=K._token;let De=`/api/sessions/${encodeURIComponent(C)}/export?format=${Q}`;be&&(De+=`&token=${encodeURIComponent(be)}`);const Je=document.createElement("a");Je.href=De,Je.download=`session-${C}.${Q==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let we=null;function Ee(C){C.payload&&C.payload.channel_id&&(clearTimeout(we),we=setTimeout(()=>{E(),n.value&&C.payload.channel_id===n.value&&K.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(Q=>{a.value=Q}).catch(()=>{})},2e3))}return $e(()=>{D(),E(),qe.subscribe("events",Ee)}),ft(()=>{qe.unsubscribe("events",Ee),clearTimeout(we)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:U,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:M,hasActiveFilters:F,customPresets:w,showSavePreset:A,newPresetName:b,threadView:v,threads:W,collapsedThreads:x,ftsQuery:R,ftsChannelId:L,ftsUserId:O,ftsResults:S,ftsSearching:I,formatAge:de,formatTimestamp:J,formatFullTimestamp:ce,messageClass:Ie,threadMsgClass:z,roleBadge:oe,roleDotClass:le,roleLabelClass:ge,truncateContent:me,threadSummary:j,fetchSessions:E,retry:$,toggleSession:Z,toggleSelect:X,toggleSelectAll:te,confirmClear:Y,clearSession:pe,confirmBulkClear:ie,doBulkClear:ue,exportSession:ye,applyPreset:N,applyCustomPreset:V,saveCustomPreset:re,removeCustomPreset:ve,resetFilters:se,toggleThread:_,runFtsSearch:Le,clearFtsSearch:y,highlightSnippet:T,ftsResultClass:P,ftsTypeBadge:G}}},uw={props:["trace"],template:`
...
`)}const vw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),w=h(null),A=h(!1),b=ee(()=>e.value.length),v=ee(()=>e.value.reduce((J,ce)=>J+(ce.execution_count||0),0)),x=ee(()=>e.value.reduce((J,ce)=>J+D(ce.code),0)),R=ee(()=>{if(!l.value)return e.value;const J=l.value.toLowerCase();return e.value.filter(ce=>ce.name.toLowerCase().includes(J)||(ce.description||"").toLowerCase().includes(J))}),L=ee(()=>d.value?d.value.split(`
`).length:0),O=ee(()=>{const J=Math.max(L.value,1);return Array.from({length:J},(ce,Ie)=>Ie+1).join(`
...
`).length:0}function B(J){return mw(J)}function F(J){n.value={...n.value,[J]:!n.value[J]}}async function M(J){try{await navigator.clipboard.writeText(J);const ce=e.value.find(Ie=>Ie.code===J);ce&&(r.value=ce.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function W(J){if(J.key==="Tab"){J.preventDefault();const ce=J.target,Ie=ce.selectionStart,z=ce.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(z),St(()=>{ce.selectionStart=ce.selectionEnd=Ie+4})}}function U(J){const ce=J.target.previousElementSibling;ce&&(ce.scrollTop=J.target.scrollTop)}async function j(){t.value=!0,s.value=null;try{e.value=await K.get("/api/skills")}catch(J){s.value=J.message}t.value=!1}async function _(J){i.value=J,delete a.value[J],a.value={...a.value};try{const ce=await K.post(`/api/skills/${encodeURIComponent(J)}/test`);a.value={...a.value,[J]:ce}}catch(ce){a.value={...a.value,[J]:{result:ce.message,is_error:!0}}}i.value=null}function N(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function V(J){o.value=!0,c.value="edit",u.value=J.name,d.value=J.code||"",f.value=null,p.value=null}function re(){o.value=!1,f.value=null,p.value=null}async function ve(){f.value=null,p.value=null;const J=u.value.trim(),ce=d.value.trim();if(!J){f.value="Name is required";return}if(!ce){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await K.post("/api/skills",{name:J,code:ce}),p.value="Skill created successfully"):(await K.put(`/api/skills/${encodeURIComponent(J)}`,{code:ce}),p.value="Skill updated successfully"),await j(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}m.value=!1}function se(J){w.value=J}async function de(){if(w.value){A.value=!0;try{await K.del(`/api/skills/${encodeURIComponent(w.value)}`),await j()}catch{}A.value=!1,w.value=null}}return $e(()=>{j()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:w,deleting:A,enabledCount:b,totalExecutions:v,totalLines:x,displayedSkills:R,editLineCount:L,editorLineNums:O,editValidation:S,highlight:I,truncate:Ec,formatTs:Ia,countLines:D,getLineNumbers:B,toggleCode:F,copyCode:M,handleEditorKey:W,syncScroll:U,fetchSkills:j,testSkill:_,showCreate:N,editSkill:V,cancelEdit:re,saveSkill:ve,confirmDelete:se,doDelete:de}}};function bw(e,t){if(!e||!t)return kd(e);const s=kd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let w=null;const A=h(null),b=h(!1),v=h({}),x=h({}),R=h(null),L=h(null),O=ee(()=>e.value.reduce((N,V)=>N+(V.chunks||0),0)),S=ee(()=>new Set(e.value.map(V=>V.uploader).filter(Boolean)).size);function I(N,V){const re=x.value[V];if(!re||re.length===0)return 0;const ve=Math.max(...re.map(se=>se.char_count||0));return ve===0?0:Math.round(N.char_count/ve*100)}async function D(){t.value=!0,s.value=null;try{const N=await K.get("/api/knowledge");e.value=Array.isArray(N)?N:[]}catch(N){s.value=N.message}t.value=!1}async function B(N){if(v.value[N]){v.value[N]=!1,L.value=null;return}if(v.value[N]=!0,!(x.value[N]||R.value===N)){R.value=N;try{const V=await K.get(`/api/knowledge/${encodeURIComponent(N)}/chunks`);x.value[N]=Array.isArray(V)?V:[]}catch(V){x.value[N]=[],xe.error(`Failed to load chunks: ${V.message}`)}R.value=null}}async function F(){const N=n.value.trim();if(N){i.value=!0,r.value=null,l.value=N;try{const V=await K.get(`/api/knowledge/search?q=${encodeURIComponent(N)}`);a.value=Array.isArray(V)?V:[]}catch(V){a.value=[],r.value=V.message||"Search failed"}i.value=!1}}function M(){a.value=null,n.value="",r.value=null}async function W(){d.value=null,f.value=null;const N=c.value.trim(),V=u.value.trim();if(!N){d.value="Source name is required";return}if(!V){d.value="Content is required";return}p.value=!0;try{const re=await K.post("/api/knowledge",{source:N,content:V});f.value=`Ingested ${re.chunks||0} chunks from "${N}"`,c.value="",u.value="",x.value={},await D(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(re){d.value=re.message}p.value=!1}async function U(N){m.value=N,g.value=null,w&&(clearTimeout(w),w=null);try{const V=await K.post(`/api/knowledge/${encodeURIComponent(N)}/reingest`);g.value={source:N,error:!1,message:`Re-ingested ${V.chunks||0} chunks`},delete x.value[N],await D(),w=setTimeout(()=>{g.value=null,w=null},3e3)}catch(V){g.value={source:N,error:!0,message:V.message}}m.value=null}function j(N){A.value=N}async function _(){if(A.value){b.value=!0;try{await K.del(`/api/knowledge/${encodeURIComponent(A.value)}`),delete x.value[A.value],await D()}catch{}b.value=!1,A.value=null}}return $e(()=>{D()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:A,deleting:b,expanded:v,sourceChunks:x,loadingChunks:R,selectedChunk:L,totalChunks:O,uploaderCount:S,truncate:Ec,formatTs:Ia,highlightTerms:bw,chunkBarWidth:I,fetchSources:D,toggleSource:B,doSearch:F,clearSearch:M,doIngest:W,doReingest:U,confirmDelete:j,doDelete:_}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),w=h(null),A=h(new Set),b=h(null),v=h(!1),x=h(!1),R=ee(()=>e.value.reduce((se,de)=>se+de.count,0)),L=ee(()=>A.value.size);function O(se){const de=t.value[se];if(!de)return[];if(!l.value.trim())return de;const J=l.value.trim().toLowerCase();return de.filter(ce=>ce.key.toLowerCase().includes(J)||ce.value&&ce.value.toLowerCase().includes(J))}function S(se,de){return A.value.has(se+"/"+de)}function I(se,de){const J=se+"/"+de,ce=new Set(A.value);ce.has(J)?ce.delete(J):ce.add(J),A.value=ce}function D(se){const de=t.value[se];return!de||de.length===0?!1:de.every(J=>A.value.has(se+"/"+J.key))}function B(se,de){const J=t.value[se];if(!J)return;const ce=new Set(A.value);for(const Ie of J){const z=se+"/"+Ie.key;de?ce.add(z):ce.delete(z)}A.value=ce}async function F(){s.value=!0,n.value=null;try{const se=await K.get("/api/memory");e.value=Object.entries(se).map(([de,J])=>({name:de,keys:J.keys||[],count:J.count||0}))}catch(se){n.value=se.message}s.value=!1}async function M(se){if(a.value[se]){a.value[se]=!1;return}a.value[se]=!0;const de=e.value.find(ce=>ce.name===se);if(!de||t.value[se]||i.value===se)return;i.value=se;const J=await Promise.all(de.keys.map(async ce=>{try{const Ie=await K.get(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(ce)}`);return{key:ce,value:Ie.value||""}}catch{return{key:ce,value:"(error loading)"}}}));t.value[se]=J,i.value=null}function W(se,de,J){f.value=se+"/"+de,p.value=J}async function U(se,de){m.value=!0,g.value=null;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(de)}`,{value:p.value});const J=t.value[se];if(J){const ce=J.find(Ie=>Ie.key===de);ce&&(ce.value=p.value)}f.value=null}catch(J){g.value=`Failed to save: ${J.message||"unknown error"}`}m.value=!1}async function j(se,de){try{await navigator.clipboard.writeText(de.value),w.value=se+"/"+de.key,setTimeout(()=>{w.value=null},1500)}catch{}}async function _(){u.value=null,d.value=null;const se=o.value.scope.trim(),de=o.value.key.trim(),J=o.value.value.trim();if(!se){u.value="Scope is required";return}if(!de){u.value="Key is required";return}if(!J){u.value="Value is required";return}c.value=!0;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(de)}`,{value:J}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await F(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(ce){u.value=ce.message}c.value=!1}function N(se,de){b.value={scope:se,key:de}}async function V(){if(!b.value)return;v.value=!0,g.value=null;const{scope:se,key:de}=b.value;try{await K.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(de)}`);const J=t.value[se];J&&(t.value[se]=J.filter(z=>z.key!==de));const ce=e.value.find(z=>z.name===se);ce&&(ce.count--,ce.keys=ce.keys.filter(z=>z!==de));const Ie=new Set(A.value);Ie.delete(se+"/"+de),A.value=Ie}catch(J){g.value=`Failed to delete: ${J.message||"unknown error"}`}v.value=!1,b.value=null}function re(){x.value=!0}async function ve(){v.value=!0,g.value=null;const se=[];for(const de of A.value){const J=de.indexOf("/");se.push({scope:de.slice(0,J),key:de.slice(J+1)})}try{await K.post("/api/memory/bulk-delete",{entries:se}),A.value=new Set,t.value={},await F()}catch(de){g.value=`Bulk delete failed: ${de.message||"unknown error"}`}v.value=!1,x.value=!1}return $e(()=>{F()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:w,selected:A,selectedCount:L,totalEntries:R,deleteTarget:b,deleting:v,showBulkDelete:x,fetchMemory:F,toggleScope:M,startEdit:W,doEdit:U,copyValue:j,doAdd:_,confirmDelete:N,doDelete:V,confirmBulkDelete:re,doBulkDelete:ve,isSelected:S,toggleSelect:I,isScopeAllSelected:D,toggleSelectAll:B,filteredEntries:O}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=ee(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=ee(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await K.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return $e(()=>{c(),i=setInterval(c,3e4)}),ft(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:eg,refresh:u,retry:d}}},Rw=["INFO","WARNING","ERROR"],Iw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Ur=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Nw=[50,100,200,500],Lw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(qe.state||"disconnected"),c=ee(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,m=Rw,g=Iw,w=Ur,A=h("all"),b=h(""),v=h([]),x=h(!1),R=h(""),L=h([]);function O(){try{const H=localStorage.getItem("odin-log-presets");H&&(v.value=JSON.parse(H))}catch{}}function S(){try{localStorage.setItem("odin-log-presets",JSON.stringify(v.value))}catch{}}const I=ee(()=>a.value!==""||i.value.trim()!==""||b.value!==""),D=ee(()=>{const H=Ur.find(ne=>ne.value===b.value);return H?H.label:""}),B=ee(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(H){return H.message}}),F=24,M=ee(()=>{if(t.value.length===0)return[];const H=[],ne=new Date,Se=3600*1e3;for(let je=F-1;je>=0;je--){const it=new Date(ne.getTime()-(je+1)*Se),Gt=new Date(ne.getTime()-je*Se);H.push({start:it,end:Gt,label:_(it,Gt),shortLabel:Gt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const je of t.value){if(!je._time)continue;const it=je._time.getTime();for(const Gt of H)if(it>=Gt.start.getTime()&&it<Gt.end.getTime()){Gt.total++,je.level==="ERROR"?Gt.errors++:je.level==="WARNING"?Gt.warnings++:Gt.info++;break}}return H}),W=ee(()=>{let H=1;for(const ne of M.value)ne.total>H&&(H=ne.total);return H}),U=ee(()=>M.value.length===0?"":"Last 24 hours"),j=ee(()=>Math.ceil(F/8));function _(H,ne){const Se={hour:"2-digit",minute:"2-digit"};return H.toLocaleTimeString([],Se)+" - "+ne.toLocaleTimeString([],Se)}function N(H,ne){return!ne||!H?"0px":Math.max(2,H/ne*100)+"%"}function V(H){const ne=re.value.findIndex(Se=>Se._time&&Se._time.getTime()>=H.start.getTime()&&Se._time.getTime()<H.end.getTime());if(ne>=0&&u.value){const Se=u.value.querySelectorAll(".log-line");Se[ne]&&(Se[ne].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const re=ee(()=>{let H=t.value;if(a.value&&(H=H.filter(ne=>(ne.level||"INFO")===a.value)),b.value){const ne=Ur.find(Se=>Se.value===b.value);if(ne&&ne.seconds){const Se=new Date(Date.now()-ne.seconds*1e3);H=H.filter(je=>je._time&&je._time>=Se)}}if(i.value&&!B.value)if(l.value)try{const ne=new RegExp(i.value,"i");H=H.filter(Se=>{const je=Se.text||Se.raw||"",it=Se.tool||"";return ne.test(je)||ne.test(it)})}catch{}else{const ne=i.value.toLowerCase();H=H.filter(Se=>{const je=(Se.text||Se.raw||"").toLowerCase(),it=(Se.tool||"").toLowerCase();return je.includes(ne)||it.includes(ne)})}return H});function ve(H){if(H.type==="log"&&H.line)try{const ne=typeof H.line=="string"?JSON.parse(H.line):H.line,Se=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Se.toLocaleTimeString(),_time:Se,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(H.line),tool:"",raw:String(H.line)}}if(H.payload){const ne=H.payload,Se=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Se.toLocaleTimeString(),_time:Se,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}return typeof H=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:H,tool:"",raw:H}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(H),tool:"",raw:null}}function se(H){const ne=ve(H);if(s.value){L.value.push(ne);return}de(ne)}function de(H){t.value.push(H),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&St(()=>J())}function J(){const H=u.value;if(H){const ne=H.scrollHeight-H.scrollTop-H.clientHeight;H.scrollTo({top:H.scrollHeight,behavior:ne<500?"smooth":"instant"})}}function ce(){n.value=!0,d.value=!1,St(()=>J())}function Ie(){const H=u.value;if(!H)return;const ne=H.scrollHeight-H.scrollTop-H.clientHeight<40;d.value=!ne&&t.value.length>0,!ne&&n.value&&(n.value=!1)}function z(){if(s.value=!s.value,!s.value&&L.value.length>0){for(const H of L.value)de(H);L.value=[]}}function oe(){t.value=[],L.value=[],d.value=!1}function le(){let H;e.value==="search"?H=Q.value.map(it=>{const Gt=it.error?"ERROR":"INFO",nt=it.tool_name?`[${it.tool_name}] `:"";return`${it.timestamp||""} ${Gt} ${nt}${it.result_summary||it.message||""}`}).join(`
`):H=re.value.map(it=>`${it.ts} ${it.level} ${it.text}`).join(`
`);const ne=new Blob([H],{type:"text/plain"}),Se=URL.createObjectURL(ne),je=document.createElement("a");je.href=Se,je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,je.click(),URL.revokeObjectURL(Se)}function ge(H,ne){const Se=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(Se).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function me(H){a.value=a.value===H?"":H,A.value="all"}function Le(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function T(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function P(H){A.value=H.id;const ne=H.filters;a.value=ne.level||"",b.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function G(H){A.value=H.id,a.value=H.filters.level||"",b.value=H.filters.timeRange||"",i.value=H.filters.text||""}function E(){if(!R.value.trim())return;const H={id:"custom-"+Date.now(),name:R.value.trim(),filters:{level:a.value,timeRange:b.value,text:i.value}};v.value=[...v.value,H],S(),x.value=!1,R.value=""}function $(H){v.value=v.value.filter(ne=>ne.id!==H),S(),A.value===H&&(A.value="all")}const Z=h("all"),X=h(""),te=h(""),Y=h(""),pe=h(""),ie=h(""),ue=h(100),ye=Nw,we=h(!1),Ee=h(!1),C=h(""),Q=h([]),be=h(null),De=h(null);function Je(){e.value="search",be.value||We()}async function We(){try{be.value=await K.get("/api/logs/stats")}catch{}}function Ct(){const H=ie.value;if(!H){Y.value="",pe.value="";return}const Se={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(Se){const je=new Date(Date.now()-Se*1e3);Y.value=st(je),pe.value=""}}function st(H){const ne=Se=>String(Se).padStart(2,"0");return`${H.getFullYear()}-${ne(H.getMonth()+1)}-${ne(H.getDate())}T${ne(H.getHours())}:${ne(H.getMinutes())}`}function Ye(H){if(!H)return"";const ne=new Date(H);return isNaN(ne.getTime())?"":ne.toISOString()}async function sn(){we.value=!0,C.value="",Ee.value=!0,De.value=null;try{const H=new URLSearchParams;Z.value&&Z.value!=="all"&&H.set("level",Z.value),X.value&&H.set("tool",X.value),te.value&&H.set("q",te.value);const ne=Ye(Y.value),Se=Ye(pe.value);ne&&H.set("start",ne),Se&&H.set("end",Se),H.set("limit",String(ue.value));const je=await K.get(`/api/logs/search?${H.toString()}`);Q.value=je.entries||[]}catch(H){C.value=H.message||"Search failed",Q.value=[]}finally{we.value=!1}}function xn(){Z.value="all",X.value="",te.value="",Y.value="",pe.value="",ie.value="",ue.value=100,Q.value=[],Ee.value=!1,C.value="",De.value=null}function Oi(H){De.value=De.value===H?null:H}function Na(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function Di(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function qn(H){return H.error?"log-line-error":"text-gray-300"}function Kn(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let Lt=null,gs=null,nn=!1;function La(){nn||(nn=!0,qe.subscribe("logs",se),r.value=qe.connected,o.value=qe.state||"disconnected",Lt=qe.onStateChange,gs=(H,ne)=>{o.value=H,r.value=H==="connected",Lt&&Lt(H,ne)},qe.onStateChange=gs)}function Mi(){nn&&(nn=!1,qe.unsubscribe("logs",se),qe.onStateChange===gs&&(qe.onStateChange=Lt),gs=null,Lt=null)}return $e(O),Uo(La),Bo(Mi),ft(Mi),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:re,pauseBuffer:L,showJumpBottom:d,copiedIndex:f,regexError:B,levels:m,logPresets:g,timeRanges:w,timeRange:b,activeLogPreset:A,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:R,hasActiveLogFilters:I,timeRangeLabel:D,timelineBuckets:M,timelineMax:W,timelineSpanLabel:U,timelineLabelSkip:j,togglePause:z,clearLogs:oe,exportLogs:le,logLineClass:Le,levelClass:y,levelChipClass:T,toggleLevel:me,copyLine:ge,jumpToBottom:ce,onScroll:Ie,applyLogPreset:P,applyCustomLogPreset:G,saveLogCustomPreset:E,removeLogCustomPreset:$,segmentHeight:N,jumpToTimelineBucket:V,searchLevel:Z,searchTool:X,searchKeyword:te,searchStart:Y,searchEnd:pe,searchTimePreset:ie,searchLimit:ue,searchLimits:ye,searching:we,searchRan:Ee,searchError:C,searchResults:Q,searchStats:be,expandedSearch:De,switchToSearch:Je,runSearch:sn,clearSearchFilters:xn,toggleSearchExpand:Oi,formatSearchTs:Na,searchEntryText:Di,searchLogLineClass:qn,formatJson:Kn,applySearchTimePreset:Ct}}},Ow=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Br=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],gg="••••••••",Pw=50;function Fw(e){return Ow.has(e)}function $w(e){return e===gg}function Qi(e){return JSON.parse(JSON.stringify(e))}function Mn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Mn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Mn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function qd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Mn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Mn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=ee(()=>d.value.length>0),m=ee(()=>f.value.length>0),g=ee(()=>r.value&&t.value?t.value:e.value),w=ee(()=>!e.value||!t.value?!1:!Mn(e.value,t.value)),A=ee(()=>!e.value||!t.value?0:qd(e.value,t.value).length),b=ee(()=>{if(!r.value||!t.value)return{};const E={};for(const $ of Object.keys(t.value)){const Z=t.value[$];if(typeof Z=="object"&&Z!==null&&!Array.isArray(Z))for(const X of Object.keys(Z)){const te=Bw($,X,Z[X]);te&&(E[$+"."+X]=te)}}return E}),v=ee(()=>Object.keys(b.value).length>0),x=ee(()=>e.value?Object.keys(e.value).length:0),R=ee(()=>O.value.length),L=ee(()=>!e.value||!t.value?[]:qd(e.value,t.value)),O=ee(()=>e.value?Br.map(E=>({...E,sections:E.sections.filter($=>$ in e.value)})).filter(E=>E.sections.length>0):[]),S=ee(()=>{if(!e.value)return[];const E=new Set(Br.flatMap($=>$.sections));return Object.keys(e.value).filter($=>!E.has($))});function I(E){return g.value?g.value[E]:null}function D(E){return!e.value||!t.value?!1:!Mn(e.value[E],t.value[E])}function B(E){return E.sections.some($=>D($))}function F(E,$){if(!e.value||!t.value)return!1;const Z=e.value[E],X=t.value[E];return!Z||!X?!1:!Mn(Z[$],X[$])}function M(E){return t.value?t.value[E]:e.value[E]}function W(E,$){const Z=t.value||e.value;return Z[E]?Z[E][$]:void 0}function U(E,$){const Z=r.value&&t.value?t.value:e.value;return Z[E]?Z[E][$]:!1}function j(E,$){return b.value[E+"."+$]||null}function _(E,$){return Dw[E+"."+$]||null}function N(E,$,Z){t.value&&($===null?t.value[E]=Z:(t.value[E]||(t.value[E]={}),t.value[E][$]=Z),t.value={...t.value})}function V(E,$,Z){if(!t.value)return;const X=Qi(t.value);N(E,$,Z),d.value.push(X),d.value.length>Pw&&d.value.shift(),f.value=[]}function re(E,$,Z){try{const X=JSON.parse(Z);V(E,$,X)}catch{}}function ve(){d.value.length!==0&&(f.value.push(Qi(t.value)),t.value=d.value.pop())}function se(){f.value.length!==0&&(d.value.push(Qi(t.value)),t.value=f.value.pop())}function de(E,$,Z){if(!t.value||!t.value[E])return;const X=[...t.value[E][$]];X.splice(Z,1),V(E,$,X)}function J(E,$){if(!t.value||!t.value[E])return;const Z=[...t.value[E][$]||[]],X=prompt("Enter new value:");X!==null&&(Z.push(X),V(E,$,Z))}function ce(E){a.value={...a.value,[E]:!a.value[E]}}function Ie(E){l.value={...l.value,[E]:!l.value[E]}}function z(E){i.value={...i.value,[E]:!i.value[E]}}function oe(E){try{return JSON.stringify(E,null,2)}catch{return String(E)}}function le(E){return E==null?"null":typeof E=="object"?JSON.stringify(E,null,2):String(E)}function ge(E,$){c.value={type:E,message:$},setTimeout(()=>{c.value=null},3e3)}function me(){t.value=Qi(e.value),r.value=!0,d.value=[],f.value=[]}function Le(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function T(){if(!(!w.value||v.value)){o.value=!0;try{const E=Uw(e.value,t.value);if(Object.keys(E).length===0){ge("success","No changes to save."),o.value=!1;return}const $=await K.put("/api/config",E);e.value=$,r.value=!1,t.value=null,d.value=[],f.value=[],ge("success","Config saved successfully.")}catch(E){ge("error",E.message||"Failed to save config")}o.value=!1}}async function P(){s.value=!0,n.value=null;try{e.value=await K.get("/api/config");for(const E of Object.keys(e.value))a.value[E]===void 0&&(a.value[E]=!0);for(const E of Br)l.value[E.key]===void 0&&(l.value[E.key]=!0)}catch(E){n.value=E.message}s.value=!1}function G(E){if(!r.value)return;const $=E.target;$ instanceof HTMLElement&&($.matches("input, textarea, select")||$.isContentEditable)||((E.ctrlKey||E.metaKey)&&!E.shiftKey&&E.key.toLowerCase()==="z"?(E.preventDefault(),ve()):(E.ctrlKey||E.metaKey)&&(E.key==="y"||E.shiftKey&&E.key==="z"||E.shiftKey&&E.key==="Z")&&(E.preventDefault(),se()))}return $e(()=>{P(),document.addEventListener("keydown",G)}),ft(()=>{document.removeEventListener("keydown",G)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:w,hasErrors:v,changeCount:A,REDACTED:gg,showDiffModal:u,diffEntries:L,canUndo:p,canRedo:m,sectionCount:x,groupCount:R,visibleGroups:O,ungroupedSections:S,validationErrors:b,isSensitiveKey:Fw,isRedacted:$w,sectionChanged:D,groupChanged:B,fieldChanged:F,getDisplay:I,getEdited:M,getEditedField:W,getDisplayBool:U,pushEdit:V,pushEditJson:re,getValidationError:j,getEnumOptions:_,removeArrayItem:de,addArrayItem:J,toggleSection:ce,toggleGroup:Ie,toggleNested:z,formatJson:oe,formatDiffVal:le,showToast:ge,showDiff:y,fetchConfig:P,startEdit:me,cancelEdit:Le,saveConfig:T,undo:ve,redo:se}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=ee(()=>{const _={};for(const N of u.value)_[N.id]=N;return _});function p(_){return f.value[_]||null}const m=ee(()=>/^\d{15,25}$/.test(r.value.trim())),g=ee(()=>{const _=r.value.toLowerCase().trim();return _?u.value.filter(N=>!i.value[N.id]&&(N.display_name.toLowerCase().includes(_)||N.username.toLowerCase().includes(_)||N.id.includes(_))):u.value.filter(N=>!i.value[N.id])});function w(_,N){return _?_.allowed_hosts===null||_.allowed_hosts===void 0?{allowed_hosts:[...N],default_host:_.default_host||"",allow_all:!0}:{allowed_hosts:_.allowed_hosts,default_host:_.default_host||"",allow_all:!1}:{allowed_hosts:[...N],default_host:N[0]||"",allow_all:!0}}async function A(){e.value=!0,t.value="";try{const _=await K.get("/api/host-access");s.value=_,n.value=_.available_hosts||[],a.value=w(_.default_policy,n.value);const N=_.users||{},V={};for(const[re,ve]of Object.entries(N))V[re]=w(ve,n.value);i.value=V}catch(_){t.value=_.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await K.get("/api/discord/members")||[]}catch{u.value=[]}}async function b(){try{const _=a.value.allow_all?null:a.value.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:_,default_host:a.value.default_host}),xe.success("Default policy updated")}catch(_){xe.error(_.message||"Failed to save")}}function v(_,N){a.value.allow_all=!1,N?a.value.allowed_hosts.includes(_)||a.value.allowed_hosts.push(_):(a.value.allowed_hosts=a.value.allowed_hosts.filter(V=>V!==_),a.value.default_host===_&&(a.value.default_host=a.value.allowed_hosts[0]||"")),b()}async function x(_){const N=i.value[_];if(N)try{const V=N.allow_all?null:N.allowed_hosts;await K.put(`/api/host-access/user/${_}`,{allowed_hosts:V,default_host:N.default_host});const re=p(_);xe.success(`Updated access for ${re?re.display_name:_}`)}catch(V){xe.error(V.message||"Failed to save")}}function R(_,N,V){const re=i.value[_];re&&(re.allow_all=!1,V?re.allowed_hosts.includes(N)||re.allowed_hosts.push(N):(re.allowed_hosts=re.allowed_hosts.filter(ve=>ve!==N),re.default_host===N&&(re.default_host=re.allowed_hosts[0]||"")),x(_))}function L(_,N){const V=i.value[_];V&&(V.default_host=N,x(_))}function O(){l.value=!0,r.value="",c.value=0,St(()=>{d.value&&d.value.focus()})}function S(){o.value=!0,c.value=0}function I(){c.value<g.value.length-1&&c.value++}function D(){c.value>0&&c.value--}function B(){const _=g.value[c.value];if(_){M(_);return}m.value&&F()}function F(){const _=r.value.trim();/^\d{15,25}$/.test(_)&&(i.value[_]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(_),r.value="",o.value=!1,l.value=!1)}function M(_){i.value[_.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(_.id),r.value="",o.value=!1,l.value=!1}function W(){o.value=!1}function U(){setTimeout(()=>{o.value=!1},150)}async function j(_){const N=p(_);if(await is({title:"Remove user override",message:`Remove the host access override for ${N?N.display_name:_}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await K.del(`/api/host-access/user/${_}`),delete i.value[_],xe.success(`Removed override for ${N?N.display_name:_}`)}catch(re){xe.error(re.message||"Failed to delete")}}return $e(A),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:g,isRawId:m,searchInput:d,fetchData:A,saveDefaultPolicy:b,toggleDefaultHost:v,getMember:p,toggleUserHost:R,setUserDefault:L,openAddUser:O,deleteUser:j,onSearchInput:S,highlightNext:I,highlightPrev:D,selectHighlighted:B,selectMember:M,closeDropdown:W,onBlur:U,addRawId:F}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=ee(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=ee(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(S){return S==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":S==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const S=await K.get("/api/tokens");s.value=S.tokens||[],n.value=S.available_hosts||[]}catch(S){t.value=S.message||"Failed to load tokens"}finally{e.value=!1}}function g(S){return!S||!S.trim()?[]:S.split(",").map(I=>I.trim()).filter(Boolean)}function w(S,I){const D=c.value.allowed_hosts;if(I&&!D.includes(S)&&D.push(S),!I){const B=D.indexOf(S);B>=0&&D.splice(B,1)}}function A(S,I){const D=u.value.allowed_hosts;if(I&&!D.includes(S)&&D.push(S),!I){const B=D.indexOf(S);B>=0&&D.splice(B,1)}}async function b(){var S;i.value=!0;try{const I=g(c.value.allowed_tools_str),D=c.value.host_mode,B=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,F={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:I.length?I:[]};B!==null&&(F.allowed_hosts=B),F.default_host=c.value.default_host||"";const M=await K.post("/api/tokens",F);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,xe.success("Token created"),await m()}catch(I){xe.error(((S=I.data)==null?void 0:S.error)||I.message||"Failed to create token")}finally{i.value=!1}}function v(S){r.value=S;const I=S.allowed_hosts;let D="default";I==null?D="default":Array.isArray(I)&&I.length===0?D="none":Array.isArray(I)&&(D="select"),u.value={username:S.username||"",tier:S.tier||"admin",label:S.label||"",host_mode:D,allowed_hosts:Array.isArray(I)?[...I]:[],default_host:S.default_host||"",allowed_tools_str:(S.allowed_tools||[]).join(", ")}}async function x(){var S;if(r.value){o.value=!0;try{const I=g(u.value.allowed_tools_str),D=u.value.host_mode,B={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:I};D==="none"?B.allowed_hosts=[]:D==="select"?B.allowed_hosts=u.value.allowed_hosts:B.allowed_hosts=null,B.default_host=u.value.default_host||"",await K.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,xe.success("Token updated"),await m()}catch(I){xe.error(((S=I.data)==null?void 0:S.error)||I.message||"Failed to update")}finally{o.value=!1}}}async function R(S){var D;if(await is({title:"Regenerate token",message:`Regenerate token for ${S.username||S.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await K.post("/api/tokens/"+encodeURIComponent(S.user_id)+"/regenerate");l.value=B.token,xe.success("Token regenerated")}catch(B){xe.error(((D=B.data)==null?void 0:D.error)||B.message||"Failed to regenerate")}}async function L(S){var D;if(await is({title:"Delete token",message:`Delete token for ${S.username||S.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/tokens/"+encodeURIComponent(S.user_id)),xe.success("Token deleted"),await m()}catch(B){xe.error(((D=B.data)==null?void 0:D.error)||B.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),xe.success("Copied to clipboard")}catch{xe.error("Copy failed — select and copy manually")}}return $e(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:w,toggleEditHost:A,createToken:b,startEdit:v,saveEdit:x,confirmRegenerate:R,confirmDelete:L,copyToken:O}}};function Hr(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const qw={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:""}),a=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),i=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),l=h(!1),r=h(!1),o=h(!1),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h({configured:!1}),m=h([]),g=h(""),w=h(!1),A=h(!1),b=h({configured:!1}),v=h([]),x=h(""),R=h(!1),L=h(!1),O=h(!0),S=h(""),I=h({configured:!1,accounts:[]}),D=h(null),B=h(null),F=h(""),M=h(null),W=h(!1),U=h(null),j=h(null),_=h("");let N=null;function V(C,Q="success"){xe(C,Q==="error"?"error":"success")}function re(C){if(!C)return"?";const Q=C/(1024*1024*1024);return Q>=1?Q.toFixed(1)+" GB":(C/(1024*1024)).toFixed(0)+" MB"}async function ve(){e.value=!0,await Promise.all([se(),de(),le(),J()]),e.value=!1}async function se(){try{const C=await K.get("/api/llm/status");t.value=C,s.value=C.active_provider||"codex",C.codex&&!P.pending()&&(n.value.enabled=C.codex.enabled,n.value.model=C.codex.model||"gpt-5.5",n.value.reasoning_effort=C.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=C.codex.agent_reasoning_effort||"",n.value.max_tokens=C.codex.max_tokens||4096),C.ollama&&!G.pending()&&(a.value.enabled=C.ollama.enabled,a.value.base_url=C.ollama.base_url||"",a.value.model=C.ollama.model||"",a.value.max_tokens=C.ollama.max_tokens||4096),C.kimi&&!E.pending()&&(i.value.enabled=C.kimi.enabled,i.value.model=C.kimi.model||"",i.value.max_tokens=C.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function de(){try{if(p.value=await K.get("/api/ollama/status"),p.value.model&&(g.value=p.value.model),p.value.configured)try{const C=await K.get("/api/ollama/models");m.value=C.models||[]}catch{m.value=[]}else if(a.value.base_url)try{const C=await K.post("/api/ollama/probe-models",{base_url:a.value.base_url});m.value=C.models||[]}catch{m.value=[]}}catch{p.value={configured:!1}}}async function J(){O.value=!0,S.value="";try{I.value=await K.get("/api/codex/status")}catch(C){S.value=C.message||"Failed to fetch Codex status"}finally{O.value=!1}}async function ce(){const C=t.value?t.value.active_provider:"codex";f.value=!0;try{const Q=await K.post("/api/llm/switch",{provider:s.value});Q.error?(s.value=C,V(Q.error,"error")):(V("Switched to "+s.value+" ("+Q.model+")"),await ve())}catch(Q){s.value=C,V(Q.message||"Switch failed","error")}finally{f.value=!1}}async function Ie(){w.value=!0;try{const C=await K.post("/api/ollama/reload");V(C.configured?"Ollama reloaded":C.reason||"Ollama not configured",C.configured?"success":"error"),await ve()}catch(C){V(C.message||"Reload failed","error")}finally{w.value=!1}}async function z(){A.value=!0;try{await K.post("/api/ollama/model",{model:g.value}),V("Model set to "+g.value),await ve()}catch(C){V(C.message||"Failed","error")}finally{A.value=!1}}async function oe(){const C=a.value.base_url;if(!C){V("Enter a base URL first","error");return}d.value=!0;try{const Q=await K.post("/api/ollama/probe-models",{base_url:C});m.value=Q.models||[],m.value.length?(V(m.value.length+" model(s) found"),!a.value.model&&m.value.length&&(a.value.model=m.value[0].name)):V("No models found at "+C,"error")}catch(Q){V(Q.message||"Could not reach Ollama","error")}finally{d.value=!1}}async function le(){try{if(b.value=await K.get("/api/kimi/status"),b.value.model&&(x.value=b.value.model),b.value.configured)try{const C=await K.get("/api/kimi/models");v.value=C.models||[]}catch{v.value=[]}}catch{b.value={configured:!1}}}async function ge(){R.value=!0;try{const C=await K.post("/api/kimi/reload");V(C.configured?"Kimi reloaded":C.reason||"Kimi not configured",C.configured?"success":"error"),await ve()}catch(C){V(C.message||"Reload failed","error")}finally{R.value=!1}}async function me(){L.value=!0;try{await K.post("/api/kimi/model",{model:x.value}),V("Model set to "+x.value),await ve()}catch(C){V(C.message||"Failed","error")}finally{L.value=!1}}async function Le(){if(o.value){P();return}o.value=!0;try{await K.put("/api/llm/codex/config",n.value),V("Codex config saved"),await Promise.all([se(),J()])}catch(C){V(C.message||"Failed","error"),await Promise.all([se(),J()])}finally{o.value=!1}}async function y(){if(c.value){G();return}c.value=!0;try{const C={...a.value},Q=l.value?a.value.api_key:null;Q===null&&delete C.api_key,await K.put("/api/llm/ollama/config",C),V("Ollama config saved"),Q!==null&&a.value.api_key===Q&&(a.value.api_key="",l.value=!1),await Promise.all([se(),de()])}catch(C){V(C.message||"Failed","error")}finally{c.value=!1}}async function T(){if(u.value){E();return}u.value=!0;try{const C={...i.value},Q=r.value?i.value.api_key:null;Q===null&&delete C.api_key,await K.put("/api/llm/kimi/config",C),V("Kimi config saved"),Q!==null&&i.value.api_key===Q&&(i.value.api_key="",r.value=!1),await Promise.all([se(),le()])}catch(C){V(C.message||"Failed","error")}finally{u.value=!1}}const P=Hr(Le),G=Hr(y),E=Hr(T),$=()=>(P.cancel(),Le()),Z=()=>(G.cancel(),y()),X=()=>(E.cancel(),T());async function te(C){try{await K.post("/api/codex/account/"+C+"/activate"),V("Active account switched"),await J()}catch(Q){V(Q.message||"Failed","error")}}async function Y(C){D.value=C;try{await K.post("/api/codex/account/"+C+"/refresh"),V("Token refreshed"),await J()}catch(Q){V(Q.message||"Refresh failed","error")}finally{D.value=null}}function pe(C,Q){B.value=C,F.value=Q||""}async function ie(C){try{await K.put("/api/codex/account/"+C+"/label",{label:F.value}),V("Label updated"),B.value=null,await J()}catch(Q){V(Q.message||"Failed","error")}}async function ue(C,Q){if(await is({title:"Delete Codex account",message:`Delete ${Q||"account #"+(C+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+C),V("Deleted. Pool reloaded."),await J()}catch(De){V(De.message||"Failed","error")}}async function ye(){W.value=!0;try{const C=await K.post("/api/codex/device-code");U.value=C,M.value="pending",we(C)}catch(C){V(C.message||"Failed","error")}finally{W.value=!1}}async function we(C){N={cancelled:!1};const Q=N;try{const be=await K.post("/api/codex/device-poll",{device_auth_id:C.device_auth_id,user_code:C.user_code,interval:C.interval});if(Q.cancelled)return;j.value=be,M.value="success",await ve()}catch(be){if(Q.cancelled)return;_.value=be.message||"Device login failed",M.value="error"}}function Ee(){N&&(N.cancelled=!0),M.value=null,U.value=null}return $e(ve),ft(()=>{N&&(N.cancelled=!0),P.cancel(),G.cancel(),E.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:f,codexForm:n,ollamaForm:a,kimiForm:i,savingCodex:o,savingOllama:c,savingKimi:u,probingOllama:d,ollamaKeyDirty:l,kimiKeyDirty:r,ollamaStatus:p,ollamaModels:m,ollamaSelectedModel:g,reloading:w,settingModel:A,kimiStatus:b,kimiModels:v,kimiSelectedModel:x,reloadingKimi:R,settingKimiModel:L,codexLoading:O,codexError:S,codexData:I,refreshing:D,editingLabel:B,labelValue:F,deviceState:M,deviceLoading:W,deviceInfo:U,deviceResult:j,deviceError:_,fetchAll:ve,switchProvider:ce,reloadOllama:Ie,setOllamaModel:z,reloadKimi:ge,setKimiModel:me,probeOllamaModels:oe,saveCodexConfig:Le,saveOllamaConfig:y,saveKimiConfig:T,saveCodexConfigDebounced:P,saveOllamaConfigDebounced:G,saveKimiConfigDebounced:E,saveCodexConfigNow:$,saveOllamaConfigNow:Z,saveKimiConfigNow:X,activateAccount:te,refreshAccount:Y,startEditLabel:pe,saveLabel:ie,deleteAccount:ue,startDeviceLogin:ye,cancelDeviceLogin:Ee,formatSize:re}}},Kd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Kw(e){return Kd[e]||Kd[(e||"").toLowerCase()]||"text-gray-400"}const Gw={template:`
  ...
  `},Zw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Lw},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:qw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},pt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),mg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:pt("/operations","live")},{path:"/agents",redirect:pt("/operations","agents")},{path:"/loops",redirect:pt("/operations","loops")},{path:"/processes",redirect:pt("/operations","processes")},{path:"/schedules",redirect:pt("/operations","schedules")},{path:"/audit",redirect:pt("/history","audit")},{path:"/sessions",redirect:pt("/history","sessions")},{path:"/traces",redirect:pt("/history","traces")},{path:"/usage",redirect:pt("/history","usage")},{path:"/tools",redirect:pt("/capabilities","tools")},{path:"/skills",redirect:pt("/capabilities","skills")},{path:"/knowledge",redirect:pt("/capabilities","knowledge")},{path:"/memory",redirect:pt("/capabilities","memory")},{path:"/learned",redirect:pt("/capabilities","learned")},{path:"/health",redirect:pt("/system","health")},{path:"/resources",redirect:pt("/system","resources")},{path:"/logs",redirect:pt("/system","logs")},{path:"/config",redirect:pt("/system","config")},{path:"/host-access",redirect:pt("/system","host-access")},{path:"/internals",redirect:pt("/system","internals")}],ni=E_({history:i_(),routes:mg});ni.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const m=h("starting"),g=h(""),w=mg.filter(_=>_.meta),A=ee(()=>["Workspace","Operate","Observe","Manage"].map(_=>({name:_,routes:w.filter(N=>N.meta.section===_)})).filter(_=>_.routes.length)),b=ee(()=>{var _;return((_=ni.currentRoute.value.meta)==null?void 0:_.label)||"Odin"}),v=ee(()=>{var _;return((_=ni.currentRoute.value.meta)==null?void 0:_.section)||"Management"}),x=ee(()=>{var _;return((_=ni.currentRoute.value.meta)==null?void 0:_.description)||"Management console"});K.onSessionExpired=()=>{t.value=!0,qe.disconnect(),K.setToken(""),e.value="login"};function R(_){var N;if((_.ctrlKey||_.metaKey)&&_.key.toLowerCase()==="k"){e.value==="ready"&&(_.preventDefault(),xd());return}if(n.value&&_.key==="Tab"){const V=[...((N=a.value)==null?void 0:N.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(V.length){const re=V[0],ve=V[V.length-1];if(_.shiftKey&&(document.activeElement===re||!a.value.contains(document.activeElement))){_.preventDefault(),ve.focus();return}if(!_.shiftKey&&(document.activeElement===ve||!a.value.contains(document.activeElement))){_.preventDefault(),re.focus();return}}}if(_.key==="Escape"&&n.value){n.value=!1,_.preventDefault();return}if(_.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(_.target.tagName)){_.preventDefault();const V=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');V&&V.focus()}}function L(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}$e(async()=>{document.addEventListener("keydown",R),r=window.matchMedia("(max-width: 900px)"),L(),r.addEventListener("change",L);const _=await K.check();_.ok?(e.value="ready",U()):_.needsAuth?e.value="login":(e.value="ready",U())});function O(){t.value=!1,e.value="ready",U()}async function S(){await K.logout(),qe.disconnect(),e.value="login"}function I(){s.value=!s.value}function D(){n.value=!n.value}ns(n,async _=>{var N,V;if(_)o=document.activeElement,await St(),(V=(N=a.value)==null?void 0:N.querySelector(".nav-item"))==null||V.focus();else if(o!=null&&o.isConnected){const re=o;o=null,requestAnimationFrame(()=>re.focus())}});const B=ee(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function F(_,N="info",V=3e3){f.value={text:_,level:N},clearTimeout(p),p=setTimeout(()=>{f.value=null},V)}let M=null,W=!1;function U(){qe.onStatusChange=_=>{c.value=_},qe.onStateChange=(_,N)=>{u.value=_,d.value=N.latency??-1,_==="connected"?(W&&F("Connection restored","success"),W=!0):_==="reconnecting"&&N.attempt===1&&F("Connection lost — reconnecting…","warn")},qe.connect(),j(),M&&clearInterval(M),M=setInterval(j,15e3)}async function j(){try{const _=await K.get("/api/status");m.value=_.status==="online"?"online":"starting";const N=_.uptime_seconds||0,V=Math.floor(N/3600),re=Math.floor(N%3600/60);g.value=`${V}h ${re}m uptime`}catch{m.value="offline",g.value=""}}return ft(()=>{M&&clearInterval(M),qe.disconnect(),document.removeEventListener("keydown",R),r==null||r.removeEventListener("change",L)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:B,wsToast:f,botStatus:m,botUptime:g,navRoutes:w,navGroups:A,currentPage:b,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:O,logout:S,toggleSidebar:I,toggleMobileNavigation:D,openPalette:xd}}},yn=wl(Yw);yn.component("odin-icon",L_);yn.component("login-screen",Jw);yn.component("toast-container",yx);yn.component("confirm-host",xx);yn.component("command-palette",N_);yn.directive("modal-focus",D_);yn.use(ni);yn.mount("#app");
