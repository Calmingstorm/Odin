...
... (truncated)`:s}function np(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function bd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Wm=Symbol("agent-detail-cancelled"),Bw=15e3;function Uw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((f,m)=>{r=f,c=m});function u(f,m){o||(o=!0,l!==null&&a(l),l=null,(f?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return o||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Wm),i==null||i.abort()}}}function Zm({state:e,requestDetail:t,timeoutMs:s=Bw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const w=Uw(I=>t(p,{signal:I}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=w.cancel,v.promise=(async()=>{let I=null,x=null;try{I=await w.promise}catch(g){x=g}I!==Wm&&(l!==v||e.detailId!==p||(l=null,!x&&(I===null||typeof I!="object")&&(x=new Error(`${n} response was empty or invalid`)),x?e.detail===null&&(e.detailError=(x==null?void 0:x.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=I,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function Hw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const zw={components:{ToolOutput:Yo},template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const o=K(()=>e.value.filter(L=>L.status==="running").length),r=K(()=>e.value.filter(L=>L.status==="completed").length),c=K(()=>e.value.filter(L=>["failed","timeout","killed"].includes(L.status)).length),d=K(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=K(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(L=>["failed","timeout","killed"].includes(L.status)):e.value.filter(L=>L.status===i.value));function p(L){const H=Number(L.max_iterations)||0;return H<=0?0:Math.min(100,Math.round(L.iteration_count/H*100))}function f(L){return(Number(L.max_iterations)||0)>0}function m(L,H){return L?L==="N/A"?"N/A":H==="current_inheritance"?`inherit (currently ${L})`:L:"unknown"}function v(L){return m(L.display_model,L.display_model_source||L.display_source)}function w(L){return m(L.display_reasoning_effort,L.display_reasoning_effort_source||L.display_source)}function I(L){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[L]||""}const x=h(null),g=h(null),b=h(!1),C=h(null),S=h(""),T=Zm({state:{get detail(){return x.value},set detail(L){x.value=L},get detailId(){return g.value},set detailId(L){g.value=L},get detailLoading(){return b.value},set detailLoading(L){b.value=L},get detailError(){return C.value},set detailError(L){C.value=L}},requestDetail:(L,{signal:H})=>G.get(`/api/agents/${encodeURIComponent(L)}`,{signal:H})});async function y(L){S.value="",await T.open(L.id)}function R(){T.close(),S.value=""}async function $(){await T.refresh()}async function k(L,H){try{await navigator.clipboard.writeText(H||""),S.value=L,setTimeout(()=>{S.value===L&&(S.value="")},1500)}catch{ye.error("Copy failed")}}async function M(L=!1){L=L===!0,L||(t.value=!0);try{const H=await G.get("/api/agents");e.value=Array.isArray(H)?H:[],s.value=null}catch(H){L||(s.value=H.message)}L||(t.value=!1)}async function j(L){const H=e.value.find(W=>W.id===L);if(await qt({title:"Kill agent",message:`Kill agent "${(H==null?void 0:H.label)||L}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=L;try{await G.del(`/api/agents/${encodeURIComponent(L)}`),ye.success("Agent killed"),await M()}catch(W){ye.error(W.message||"Failed to kill agent")}n.value=null}}const q=Hw({isEnabled:()=>a.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!g.value,refreshDetail:$});function D(){q.start()}function O(){q.stop()}return Mt(a,()=>q.sync()),Ve(()=>{l=!0,M(),D()}),ms(()=>{l=!0,M(!0),D()}),ls(()=>{l=!1,O()}),mt(()=>{l=!1,O(),T.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:Aa,formatDuration:ui,progressPercent:p,hasProgress:f,displayModelText:v,displayEffortText:w,displaySourceLabel:I,detail:x,detailId:g,detailLoading:b,detailError:C,copied:S,openDetail:y,closeDetail:R,copyText:k,fetchAgents:M,killAgent:j,startAutoRefresh:D,stopAutoRefresh:O}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),o=h(null),r=h(null),c=h(null),d=h(null),u=h(!1),p=h(null),f=h("");let m=!1;const w=Zm({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return p.value},set detailError(O){p.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:L})=>G.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:L})});async function I(O){f.value="",await w.open(O.id)}function x(){w.close(),f.value=""}async function g(O,L){try{await navigator.clipboard.writeText(L||""),f.value=O,setTimeout(()=>{f.value===O&&(f.value="")},1500)}catch{ye.error("Copy failed")}}const b=K(()=>e.value.reduce((O,L)=>O+(L.iteration_count||0),0)),C=K(()=>e.value.filter(O=>O.status==="running").length);function S(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function A(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function T(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function y(O=!1){O=O===!0,O||(t.value=!0);try{const L=await G.get("/api/loops");e.value=Array.isArray(L)?L:[],s.value=null}catch(L){O||(s.value=L.message)}O||(t.value=!1)}async function R(){l.value=null;const O=a.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const L={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&(L.stop_condition=O.stop_condition.trim()),i.value=!0;try{const H=await G.post("/api/loops",L);ye.success(`Loop started: ${H.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await y()}catch(H){l.value=H.message}i.value=!1}async function $(O){if(await qt({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=O;try{await G.del(`/api/loops/${encodeURIComponent(O)}`),ye.success("Loop stopped"),await y()}catch(H){ye.error(H.message||"Failed to stop loop")}o.value=null}}async function k(O){r.value=O;try{await G.post(`/api/loops/${encodeURIComponent(O)}/restart`),ye.success("Loop restarted"),await y()}catch(L){ye.error(L.message||"Failed to restart loop")}r.value=null}function M(O){m&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(y(!0),d.value&&w.refresh())}let j=null;function q(){j!==null&&clearInterval(j),j=null}function D(){q(),m&&(j=setInterval(()=>{y(!0),d.value&&w.refresh()},5e3))}return Ve(()=>{m=!0,y(),Ye.subscribe("events",M),D()}),ms(()=>{m=!0,y(!0),D()}),ls(()=>{m=!1,q()}),mt(()=>{m=!1,Ye.unsubscribe("events",M),q(),w.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:f,totalIterations:b,runningCount:C,statusDotClass:S,statusBadge:A,modeBadge:T,formatAge:qm,formatDuration:ui,formatTs:Aa,formatTokens:Km,openDetail:I,closeDetail:x,copyText:g,fetchLoops:y,doCreate:R,doStop:$,doRestart:k}}},Vw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),o=h(null),r=K(()=>Ww(a.value.run_at));Mt(()=>a.value.run_at,()=>{o.value=null});const c=K(()=>{var re;const z=r.value;return z.state==="ok"?z.instant:z.state==="ambiguous"&&o.value!==null&&((re=z.options[o.value])==null?void 0:re.instant)||null}),d=K(()=>{const z=c.value;return z?`${z.toLocaleString()} local — ${z.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=h(null),v=h(null),w=h(null),I=h(null),x=h(null),g=h(null),b=h([]),C=h(!1),S=h("");let A=0;const T=K(()=>e.value.filter(z=>z.cron&&!z.one_time).length),y=K(()=>e.value.filter(z=>z.one_time).length),R=K(()=>e.value.filter(z=>z.trigger).length),$=K(()=>e.value.filter(z=>z.paused).length),k=K(()=>e.value.filter(z=>z.consecutive_failures>0).length);function M(z){if(!z)return"-";const re=Date.now(),Ie=(new Date(z).getTime()-re)/1e3;if(Ie<0)return"overdue";if(Ie<60)return"in < 1 min";if(Ie<3600)return`in ${Math.floor(Ie/60)} min`;if(Ie<86400){const P=Math.floor(Ie/3600),U=Math.floor(Ie%3600/60);return U>0?`in ${P}h ${U}m`:`in ${P}h`}const _=Math.floor(Ie/86400);return`in ${_} day${_!==1?"s":""}`}function j(z){return z==null?"-":z<1e3?`${z}ms`:z<6e4?`${(z/1e3).toFixed(1)}s`:ui(z/1e3)}function q(z=a.value.cron){a.value.cron=z,ap(a.value,"cron"),u.value=null}function D(z=a.value.run_at){a.value.run_at=z,ap(a.value,"run_at"),u.value=null}async function O(){const z=a.value.cron.trim();if(z){p.value=!0;try{u.value=await G.post("/api/schedules/validate-cron",{expression:z})}catch(re){u.value={valid:!1,error:re.message}}p.value=!1}}async function L(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(z){s.value=z.message}t.value=!1}async function H(z){if(g.value===z){g.value=null,b.value=[];return}g.value=z,C.value=!0,b.value=[];const re=++A;try{const pe=await G.get(`/api/schedules/${encodeURIComponent(z)}/history?limit=10`);if(re!==A||g.value!==z)return;b.value=pe,S.value=""}catch(pe){if(re!==A||g.value!==z)return;b.value=[],S.value=pe.message||"Failed to load execution history"}re===A&&(C.value=!1)}async function Z(){l.value=null;const z=a.value;if(!z.description.trim()){l.value="Description is required";return}if(!z.channel_id.trim()){l.value="Channel ID is required";return}if(!z.cron.trim()&&!z.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(z.cron.trim()&&z.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const re={description:z.description.trim(),action:z.action,channel_id:z.channel_id.trim()};if(z.cron.trim()&&(re.cron=z.cron.trim()),z.run_at.trim()){const pe=r.value;if(pe.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(pe.state==="invalid"){l.value="One-time run time is not a valid date";return}const Ie=c.value;if(pe.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Ie){l.value="One-time run time could not be resolved";return}re.run_at=Ie.toISOString()}if(z.action==="reminder"&&z.message.trim()&&(re.message=z.message.trim()),z.action==="check"&&(z.tool_name.trim()&&(re.tool_name=z.tool_name.trim()),z.report_format&&(re.report_format=z.report_format),z.tool_input_str.trim()))try{re.tool_input=JSON.parse(z.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",re),ye.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await L()}catch(pe){l.value=pe.message}i.value=!1}async function W(z){m.value=z;try{const re=await G.post(`/api/schedules/${encodeURIComponent(z)}/run`);if(re.status==="failure")ye.error(`Execution failed: ${re.error||"unknown error"}`);else{const pe=re.warning?`Executed (${re.warning})`:"Executed successfully";ye.success(pe)}await L()}catch(re){ye.error(re.message||"Failed to trigger")}m.value=null}async function J(z){w.value=z.id;const re=!z.paused;try{await G.put(`/api/schedules/${encodeURIComponent(z.id)}`,{paused:re}),ye.success(re?"Schedule paused":"Schedule resumed"),await L()}catch(pe){ye.error(pe.message||"Failed to update schedule")}w.value=null}const oe=new Map;function ee(z,re){const pe=oe.get(z.id);pe&&clearTimeout(pe.timer);const Ie={run:()=>ce(z,re),timer:null};Ie.timer=setTimeout(()=>{oe.delete(z.id),Ie.run()},500),oe.set(z.id,Ie)}async function ce(z,re){x.value=z.id;try{await G.put(`/api/schedules/${encodeURIComponent(z.id)}`,{report_format:re}),ye.success(re?"Structured report enabled":"Plain-text report enabled")}catch(pe){ye.error(`Update failed: ${pe.message}`)}finally{await L(),x.value=null}}function Ne(){for(const[z,re]of[...oe])clearTimeout(re.timer),oe.delete(z),re.run()}async function Q(z){I.value=z;try{await G.post(`/api/schedules/${encodeURIComponent(z)}/reset-failures`),ye.success("Failure counters reset"),await L()}catch(re){ye.error(re.message||"Failed to reset")}I.value=null}async function ge(z){const re=e.value.find(Ie=>Ie.id===z);if(await qt({title:"Delete schedule",message:`Delete "${(re==null?void 0:re.description)||z}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=z;try{await G.del(`/api/schedules/${encodeURIComponent(z)}`),ye.success("Schedule deleted"),await L()}catch(Ie){ye.error(Ie.message||"Failed to delete schedule")}v.value=null}}return Ve(()=>{L()}),mt(Ne),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:f,runningId:m,deletingId:v,togglingId:w,resettingId:I,reportUpdatingId:x,flushReportFormatTimers:Ne,expandedId:g,history:b,historyLoading:C,historyError:S,cronCount:T,oneTimeCount:y,webhookCount:R,pausedCount:$,failingCount:k,formatTs:Aa,formatAge:qm,formatFuture:M,formatMs:j,formatDuration:ui,onCronInput:q,onRunAtInput:D,validateCron:O,toggleExpand:H,fetchSchedules:L,doCreate:Z,doRunNow:W,doTogglePause:J,doUpdateReportFormat:ee,doResetFailures:Q,doDelete:ge}}},Jm=[{id:"live",label:"Live",component:Pw},{id:"agents",label:"Agents",component:zw},{id:"loops",label:"Loops",component:jw},{id:"processes",label:"Processes",component:Vw},{id:"schedules",label:"Schedules",component:Zw}],Jw={components:{TabbedPage:Jo},setup(){return{tabs:Jm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
... (truncated)`:ne:""}async function ie(){const ne=S.value.trim();if(!ne)return;const Se=++M;R.value=!0,$.value="",k.value=y.value!==null;try{let Le=`/api/sessions/search?q=${encodeURIComponent(ne)}&limit=50`;A.value.trim()&&(Le+=`&channel_id=${encodeURIComponent(A.value.trim())}`),T.value.trim()&&(Le+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Ke=await G.get(Le);if(Se!==M)return;y.value=Ke.results||[],k.value=!1}catch(Le){if(Se!==M)return;$.value=Le.message||"Search failed. Please retry."}finally{Se===M&&(R.value=!1)}}function se(){M++,S.value="",A.value="",T.value="",y.value=null,$.value="",k.value=!1,R.value=!1}function ae(ne){return ne?ne.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function fe(ne){return ne==="user"?"fts-result-user":ne==="assistant"?"fts-result-assistant":ne==="summary"?"fts-result-summary":ne==="fts"?"fts-result-fts":ne==="channel"?"fts-result-channel":"fts-result-default"}function ue(ne){return ne==="user"?"badge-info":ne==="assistant"?"badge-success":ne==="summary"?"badge-warning":ne==="fts"?"badge-success":"badge-info"}let de=0;async function le(){const ne=++de;t.value=!0,s.value=null;try{const Se=await G.get("/api/sessions");if(ne!==de)return;e.value=Se}catch(Se){if(ne!==de)return;s.value=Se.message}ne===de&&(t.value=!1)}function xe(){s.value=null,le()}async function me(ne){if(n.value===ne){n.value=null,a.value=null,C.value=new Set;return}n.value=ne,a.value=null,i.value=!0,C.value=new Set;const Se=++l;try{const Le=await G.get(`/api/sessions/${encodeURIComponent(ne)}`);Se===l&&n.value===ne&&(a.value=Le)}catch(Le){Se===l&&n.value===ne&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{Se===l&&(i.value=!1)}}function _e(ne){const Se=new Set(c.value);Se.has(ne)?Se.delete(ne):Se.add(ne),c.value=Se}function Re(){H.value?c.value=new Set:c.value=new Set(O.value.map(ne=>ne.channel_id))}function F(ne){o.value=ne}async function ve(){if(o.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await le()}catch(ne){s.value=ne.message||"Failed to clear session"}r.value=!1,o.value=null}}function ke(){d.value=!0}async function Oe(){if(c.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await le()}catch(ne){s.value=ne.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Pe(ne,Se){const Le=`/api/sessions/${encodeURIComponent(ne)}/export?format=${Se}`;try{const Ke=await G.getBlob(Le),Et=URL.createObjectURL(Ke),je=document.createElement("a");je.href=Et,je.download=`session-${ne}.${Se==="text"?"txt":"json"}`,je.click(),URL.revokeObjectURL(Et)}catch(Ke){s.value=Ke.message||"Failed to export session"}}let dt=null;function st(ne){ne.payload&&ne.payload.channel_id&&(clearTimeout(dt),dt=setTimeout(()=>{if(le(),n.value&&ne.payload.channel_id===n.value){const Se=n.value,Le=l;G.get(`/api/sessions/${encodeURIComponent(Se)}`).then(Ke=>{Le!==l||n.value!==Se||(a.value=Ke)}).catch(()=>{})}},2e3))}let _t=!1,Ot=null;function rt(){_t||(_t=!0,le(),Ye.subscribe("events",st),Ot=Ye.onReconnected(()=>le()))}Ve(()=>{j(),rt()}),ms(()=>{rt()});function Qe(){_t&&(_t=!1,Ye.unsubscribe("events",st),Ot&&(Ot(),Ot=null),clearTimeout(dt))}return ls(Qe),mt(Qe),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:H,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:m,filterPresets:v,sortOptions:w,filteredSessions:O,hasActiveFilters:D,customPresets:I,showSavePreset:x,newPresetName:g,threadView:b,threads:L,collapsedThreads:C,ftsQuery:S,ftsChannelId:A,ftsUserId:T,ftsResults:y,ftsSearching:R,ftsError:$,ftsStale:k,formatAge:Q,formatTimestamp:ge,formatFullTimestamp:z,messageClass:re,threadMsgClass:pe,roleBadge:Ie,roleDotClass:_,roleLabelClass:P,truncateContent:U,threadSummary:Z,fetchSessions:le,retry:xe,toggleSession:me,toggleSelect:_e,toggleSelectAll:Re,confirmClear:F,clearSession:ve,confirmBulkClear:ke,doBulkClear:Oe,exportSession:Pe,applyPreset:J,applyCustomPreset:oe,saveCustomPreset:ee,removeCustomPreset:ce,resetFilters:Ne,toggleThread:W,runFtsSearch:ie,clearFtsSearch:se,highlightSnippet:ae,ftsResultClass:fe,ftsTypeBadge:ue}}},ek={props:["trace"],template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=h("7d"),i=h(0),l=h(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=K(()=>n.value.work||{}),f=K(()=>Math.max(1,...(n.value.activity_over_time||[]).map(S=>Number(S.count||0)))),m=K(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),v=S=>({height:`${Math.max(4,Math.round(Number(S||0)/f.value*100))}%`}),w=K(()=>s.value&&l.value-i.value>3e4);async function I(){const S=++d,A=a.value;try{const T=await G.get(`/api/usage?range=${encodeURIComponent(A)}`);if(S!==d||A!==a.value)return;n.value=T,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(T){S===d&&(t.value=T.message)}finally{S===d&&(e.value=!1)}}function x(S){a.value=S,e.value=!s.value,I()}function g(){e.value=!0,I()}function b(){c||(c=!0,I(),o=setInterval(I,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function C(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return Ve(b),ms(b),ls(C),mt(C),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:w,fmtNum:bd,fmtDuration:sk,tokenLabel:nk,activityTrackStyle:m,activityBar:v,selectRange:x,retry:g}}},Ym=[{id:"audit",label:"Audit",component:Yw},{id:"sessions",label:"Sessions",component:Xw},{id:"traces",label:"Traces",component:tk},{id:"usage",label:"Usage & Activity",component:ak}],ik={components:{TabbedPage:Jo},setup(){return{tabs:Ym}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},yr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],lk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),o=h(null),r=h(null),c=h(!1),d=h(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(y){return y.source!=="builtin"?"":u[y.state]||""}function f(y,R){const $=y&&Array.isArray(y.tools)?y.tools:null;if(c.value=!!$,r.value=$?!!y.global_enabled:null,!$){e.value=R.map(j=>({...j,source:"unknown",enabled:void 0,state:null}));return}const k=new Set($.map(j=>j.name)),M=R.filter(j=>!k.has(j.name)).map(j=>({...j,source:j.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...$.map(j=>({...j,source:"builtin"})),...M]}async function m(y,R){if(d.value.has(y.name))return;const $=!!R.target.checked,k=new Set(d.value);k.add(y.name),d.value=k;try{const M=await G.post(`/api/tools/builtins/${encodeURIComponent(y.name)}/enabled`,{enabled:$});f(M,e.value),s.value=null;try{const j=await G.get("/api/tools");f(M,j)}catch(j){console.warn("Built-in toggle committed; visible catalog refresh failed",j)}}catch(M){R.target.checked=!!y.enabled,s.value=M.message||`Failed to toggle ${y.name}`}finally{const M=new Set(d.value);M.delete(y.name),d.value=M}}const v=K(()=>e.value.filter(y=>y.source==="builtin"&&y.is_core).length),w=K(()=>e.value.filter(y=>y.source==="skill").length),I=K(()=>Object.values(a.value).reduce((y,R)=>y+R,0));function x(y){for(const R of yr)if(R.id!=="other"&&R.match(y))return R.id;return"other"}const g=K(()=>{let y=e.value;if(n.value){const R=n.value.toLowerCase();y=y.filter($=>$.name.toLowerCase().includes(R)||($.description||"").toLowerCase().includes(R))}return o.value&&(y=y.filter(R=>x(R.name)===o.value)),y}),b=K(()=>{const y=new Set;for(const R of e.value)y.add(x(R.name));return yr.filter(R=>y.has(R.id))}),C=K(()=>{const y=g.value,R={};for(const k of y){const M=x(k.name);R[M]||(R[M]=[]),R[M].push(k)}const $=[];for(const k of yr)R[k.id]&&R[k.id].length>0&&$.push({label:k.label,icon:k.icon,tools:R[k.id].sort((M,j)=>M.name.localeCompare(j.name))});return $});function S(y){i.value={...i.value,[y]:!i.value[y]}}async function A(){t.value=!0,s.value=null;try{const[y,R,$]=await Promise.all([G.get("/api/tools"),G.get("/api/tools/stats").catch(()=>({})),G.get("/api/tools/builtins").catch(()=>null)]);f($,y),a.value=R||{}}catch(y){s.value=y.message}t.value=!1}function T(){A()}return Ve(()=>{A()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:w,totalUsage:I,filteredTools:g,groupedTools:C,usedCategories:b,stateBadge:p,applyInventory:f,toggleBuiltinTool:m,truncate:gd,toggleExpand:S,refresh:T}}};function ok(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function rk(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function $(ee){return rk(ee)}function k(ee){n.value={...n.value,[ee]:!n.value[ee]}}async function M(ee){try{await navigator.clipboard.writeText(ee);const ce=e.value.find(Ne=>Ne.code===ee);ce&&(o.value=ce.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function j(ee){if(ee.key==="Tab"){ee.preventDefault();const ce=ee.target,Ne=ce.selectionStart,Q=ce.selectionEnd;u.value=u.value.substring(0,Ne)+"    "+u.value.substring(Q),Rt(()=>{ce.selectionStart=ce.selectionEnd=Ne+4})}}function q(ee){const ce=ee.target.previousElementSibling;ce&&(ce.scrollTop=ee.target.scrollTop)}async function D(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(ee){s.value=ee.message}t.value=!1}async function O(ee){i.value=ee,delete a.value[ee],a.value={...a.value};try{const ce=await G.post(`/api/skills/${encodeURIComponent(ee)}/test`);a.value={...a.value,[ee]:ce}}catch(ce){a.value={...a.value,[ee]:{result:ce.message,is_error:!0}}}i.value=null}function L(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function H(ee){r.value=!0,c.value="edit",d.value=ee.name,u.value=ee.code||"",p.value=null,f.value=null}function Z(){r.value=!1,p.value=null,f.value=null}async function W(){p.value=null,f.value=null;const ee=d.value.trim(),ce=u.value.trim();if(!ee){p.value="Name is required";return}if(!ce){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:ee,code:ce}),f.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(ee)}`,{code:ce}),f.value="Skill updated successfully"),await D(),setTimeout(()=>{r.value=!1},800)}catch(Ne){p.value=Ne.message}m.value=!1}function J(ee){w.value=ee}async function oe(){if(w.value){I.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(w.value)}`),await D()}catch(ee){ye.error(`Failed to delete skill: ${ee.message||"unknown error"}`)}I.value=!1,w.value=null}}return Ve(()=>{D()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:v,deleteTarget:w,deleting:I,enabledCount:x,totalExecutions:g,totalLines:b,displayedSkills:C,editLineCount:S,editorLineNums:A,editValidation:T,highlight:y,truncate:gd,formatTs:Aa,countLines:R,getLineNumbers:$,toggleCode:k,copyCode:M,handleEditorKey:j,syncScroll:q,fetchSkills:D,testSkill:O,showCreate:L,editSkill:H,cancelEdit:Z,saveSkill:W,confirmDelete:J,doDelete:oe}}};class Fs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const dk=/^[A-Za-z_][A-Za-z0-9_]*$/;function lp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function op(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Fs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Fs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Fs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Fs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function uk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function pk(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Fs("Server name is required.","name");if(a.length>128||!dk.test(a))throw new Fs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Fs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=lp(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Fs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Fs("An HTTP endpoint is required for this connection.","url");if(d&&!uk(d))throw new Fs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Fs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=lp(e.allowlistText));const r=op(e.headerRows,e.headersRemove,"Header"),c=op(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function fk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function hk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function mk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const vk=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function gk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const bk=1e4,yk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function xr(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function xk(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const _k={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),o=h({}),r=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),m=h(xr()),v=h(""),w=h(!1);let I=null,x=0,g=!1,b=!1;const C=vk,S=K(()=>{var F;return((F=e.value)==null?void 0:F.servers)||[]}),A=K(()=>{var F;return!!((F=e.value)!=null&&F.enabled)}),T=K(()=>{var F,ve,ke,Oe;return{serverCount:((F=e.value)==null?void 0:F.server_count)||0,enabledCount:((ve=e.value)==null?void 0:ve.enabled_server_count)||0,connectedCount:((ke=e.value)==null?void 0:ke.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),y=K(()=>{var F;return((F=f.value)==null?void 0:F.header_keys)||[]}),R=K(()=>{var F;return((F=f.value)==null?void 0:F.env_keys)||[]}),$=K(()=>{var F;return u.value==="edit"&&((F=f.value)==null?void 0:F.transport)==="http"}),k=K(()=>u.value==="add"||!$.value),M=K(()=>$.value?"Replace endpoint URL":"Endpoint URL"),j=K(()=>$.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function q(){D(),I=window.setInterval(()=>O({quiet:!0}),bk)}function D(){I&&window.clearInterval(I),I=null}async function O({quiet:F=!1}={}){const ve=++x;F||(t.value=!0);try{const ke=await G.get("/api/mcp/status");if(ve!==x||!g)return;e.value=ke,n.value="";const Oe=new Set((ke.servers||[]).map(Pe=>Pe.name));i.value=new Set([...i.value].filter(Pe=>Oe.has(Pe)))}catch(ke){ve===x&&g&&(n.value=ke.message||"Failed to load MCP status")}finally{ve===x&&(t.value=!1)}}function L(F){return s.value||a.value.has(F)}function H(F,ve){const ke=new Set(a.value);ve?ke.add(F):ke.delete(F),a.value=ke}function Z(F){return hk(F.state)}function W(F){if(Z(F)==="disabled"){if(!F.enabled)return"Disabled — server switch off";if(!A.value)return"Disabled — global MCP is off"}return yk[Z(F)]}function J(F){return F.transport==="http"?"Streamable HTTP":"stdio"}function oe(F){return F.negotiated_version?`${F.era?`${String(F.era).charAt(0).toUpperCase()}${String(F.era).slice(1)}`:"Protocol"} · ${F.negotiated_version}`:"Not negotiated"}function ee(F){return F.discovered_count?`${F.published_count||0} published · ${F.excluded_count||0} excluded`:"No tools discovered"}const ce=h(new Set);async function Ne(F,ve){if(ce.value.has(F.name))return;const ke=!!ve.target.checked,Oe=new Set(ce.value);Oe.add(F.name),ce.value=Oe;try{const Pe=await G.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/enabled`,{enabled:ke});Pe&&Array.isArray(Pe.servers)?e.value=Pe:await O({quiet:!0})}catch(Pe){ve.target.checked=!!F.enabled,ye.error(Pe.message||`Failed to toggle ${F.name}`)}finally{const Pe=new Set(ce.value);Pe.delete(F.name),ce.value=Pe}}async function Q(F){if(F!==A.value&&!(!F&&!await qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await G.post("/api/mcp/enabled",{enabled:F}),ye.success(F?"MCP enabled":"MCP disabled"),await O({quiet:!0})}catch(ve){ye.error(ve.message||"Failed to update MCP state"),await O({quiet:!0})}finally{s.value=!1}}}async function ge(F){H(F.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/reconnect`,{}),ye.success(`Reconnected ${F.name}`)}catch(ve){ye.error(ve.message||`Failed to reconnect ${F.name}`)}finally{H(F.name,!1),await O({quiet:!0})}}async function z(F){H(F.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/refresh-tools`,{}),ye.success(`Refreshed tools from ${F.name}`),await Ie(F.name,!0)}catch(ve){ye.error(ve.message||`Failed to refresh ${F.name}`)}finally{H(F.name,!1),await O({quiet:!0})}}async function re(F){if(await qt({title:`Remove ${F.name}`,message:`Remove this saved MCP server? Its ${F.published_count||0} published tool${F.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){H(F.name,!0);try{await G.del(`/api/mcp/servers/${encodeURIComponent(F.name)}`),ye.success(`Removed ${F.name}`),delete o.value[F.name]}catch(ke){ye.error(ke.message||`Failed to remove ${F.name}`)}finally{H(F.name,!1),await O({quiet:!0})}}}async function pe(F){const ve=new Set(i.value);if(ve.has(F.name)){ve.delete(F.name),i.value=ve;return}ve.add(F.name),i.value=ve,Object.hasOwn(o.value,F.name)||await Ie(F.name)}async function Ie(F,ve=!1){if(!ve&&Object.hasOwn(o.value,F))return;const ke=new Set(c.value);ke.add(F),c.value=ke,r.value={...r.value,[F]:""};try{const Oe=await G.get(`/api/mcp/servers/${encodeURIComponent(F)}/tools`);o.value={...o.value,[F]:Oe.tools||[]}}catch(Oe){r.value={...r.value,[F]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(c.value);Oe.delete(F),c.value=Oe}}function _(F){return(o.value[F]||[]).filter(ve=>mk(ve,l.value[F]))}function P(F,ve){l.value={...l.value,[F]:ve}}function U(){u.value="add",p.value="",f.value=null,m.value=xr(),v.value="",d.value=!0}function ie(F){u.value="edit",p.value=F.name,f.value=F,m.value={...xr(),name:F.name,enabled:!!F.enabled,transport:F.transport||"stdio"},v.value="",d.value=!0}function se(){w.value||(d.value=!1)}function ae(F){d.value&&gk(F)}function fe(F){const ve=F==="headers"?"headerRows":"envRows";m.value[ve].push({key:"",value:""})}function ue(F,ve){const ke=F==="headers"?"headerRows":"envRows";m.value[ke].splice(ve,1)}function de(F,ve){const ke=F==="headers"?"headersRemove":"envRemove",Oe=m.value[ke];m.value[ke]=Oe.includes(ve)?Oe.filter(Pe=>Pe!==ve):[...Oe,ve]}async function le(){var ve,ke;v.value="";let F;try{F=pk(m.value,{mode:u.value,originalTransport:((ve=f.value)==null?void 0:ve.transport)||""})}catch(Oe){v.value=Oe instanceof Fs?Oe.message:"Invalid MCP server configuration",await Rt(),(ke=document.querySelector(".mcp-editor"))==null||ke.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&fk(F,f.value)&&!await qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){w.value=!0;try{u.value==="add"?await G.post("/api/mcp/servers",F):await G.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,F),ye.success(u.value==="add"?`Saved ${F.name}`:`Updated ${p.value}`),d.value=!1,await O({quiet:!0})}catch(Oe){v.value=Oe.message||"Failed to save MCP server"}finally{w.value=!1}}}let xe=null;function me(F){`${(F==null?void 0:F.event)||""} ${(F==null?void 0:F.type)||""} ${(F==null?void 0:F.tool)||""} ${(F==null?void 0:F.message)||""}`.toLowerCase().includes("mcp")&&(xe&&window.clearTimeout(xe),xe=window.setTimeout(()=>O({quiet:!0}),200))}function _e(){g||(g=!0,b||(Ye.subscribe("events",me),b=!0),O(),q())}function Re(){g=!1,D(),xe&&window.clearTimeout(xe),xe=null,b&&(Ye.unsubscribe("events",me),b=!1)}return Ve(_e),ms(_e),ls(Re),mt(Re),{status:e,loading:t,mutating:s,pageError:n,servers:S,masterEnabled:A,aggregate:T,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:m,formError:v,saving:w,editorGroups:C,configuredHeaderKeys:y,configuredEnvKeys:R,savedHttpEndpoint:$,endpointRequired:k,endpointFieldLabel:M,endpointPlaceholder:j,refreshAll:O,busy:L,serverState:Z,stateLabel:W,transportLabel:J,protocolLabel:oe,toolSummary:ee,formatAge:xk,setMasterEnabled:Q,togglePending:ce,toggleServerEnabled:Ne,reconnect:ge,refreshTools:z,removeServer:re,toggleTools:pe,filteredTools:_,setToolQuery:P,openAdd:U,openEdit:ie,closeEditor:se,jumpToEditorGroup:ae,addSecretRow:fe,removeSecretRow:ue,toggleSecretRemoval:de,saveServer:le}}};function wk(e,t){if(!e||!t)return np(e);const s=np(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const kk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),o=h(null),r=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),v=h(null);let w=null;const I=h(null),x=h(!1),g=h({}),b=h({}),C=h({}),S=h({}),A=new Map,T=h(null),y=K(()=>e.value.reduce((W,J)=>W+(J.chunks||0),0)),R=K(()=>new Set(e.value.map(J=>J.uploader).filter(Boolean)).size);function $(W,J){const oe=b.value[J];if(!oe||oe.length===0)return 0;const ee=Math.max(...oe.map(ce=>ce.char_count||0));return ee===0?0:Math.round(W.char_count/ee*100)}async function k(){t.value=!0,s.value=null;try{const W=await G.get("/api/knowledge");e.value=Array.isArray(W)?W:[]}catch(W){s.value=W.message}t.value=!1}async function M(W){if(g.value[W]){g.value[W]=!1,T.value=null;return}if(g.value[W]=!0,Object.prototype.hasOwnProperty.call(b.value,W))return;if(A.has(W))return A.get(W);const J={...S.value,[W]:!0};S.value=J;const oe={...C.value};delete oe[W],C.value=oe;const ee=G.get(`/api/knowledge/${encodeURIComponent(W)}/chunks`).then(ce=>{b.value={...b.value,[W]:Array.isArray(ce)?ce:[]}}).catch(ce=>{C.value={...C.value,[W]:ce.message||"load failed"}}).finally(()=>{if(A.get(W)!==ee)return;A.delete(W);const ce={...S.value};delete ce[W],S.value=ce});return A.set(W,ee),ee}let j=0;async function q(){const W=n.value.trim();if(!W)return;const J=++j;i.value=!0,o.value=null,l.value=W;try{const oe=await G.get(`/api/knowledge/search?q=${encodeURIComponent(W)}`);if(J!==j)return;a.value=Array.isArray(oe)?oe:[]}catch(oe){if(J!==j)return;a.value=[],o.value=oe.message||"Search failed"}J===j&&(i.value=!1)}function D(){j+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function O(){u.value=null,p.value=null;const W=c.value.trim(),J=d.value.trim();if(!W){u.value="Source name is required";return}if(!J){u.value="Content is required";return}f.value=!0;try{const oe=await G.post("/api/knowledge",{source:W,content:J});p.value=`Ingested ${oe.chunks||0} chunks from "${W}"`,c.value="",d.value="",b.value={},await k(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(oe){u.value=oe.message}f.value=!1}async function L(W){m.value=W,v.value=null,w&&(clearTimeout(w),w=null);try{const J=await G.post(`/api/knowledge/${encodeURIComponent(W)}/reingest`);v.value={source:W,error:!1,message:`Re-ingested ${J.chunks||0} chunks`},delete b.value[W],await k(),w=setTimeout(()=>{v.value=null,w=null},3e3)}catch(J){v.value={source:W,error:!0,message:J.message}}m.value=null}function H(W){I.value=W}async function Z(){if(I.value){x.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(I.value)}`),delete b.value[I.value],await k()}catch(W){ye.error(`Failed to delete source: ${W.message||"unknown error"}`)}x.value=!1,I.value=null}}return Ve(()=>{k()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:v,deleteTarget:I,deleting:x,expanded:g,sourceChunks:b,chunkErrors:C,loadingChunks:S,selectedChunk:T,totalChunks:y,uploaderCount:R,truncate:gd,formatTs:Aa,highlightTerms:wk,chunkBarWidth:$,fetchSources:k,toggleSource:M,doSearch:q,clearSearch:D,doIngest:O,doReingest:L,confirmDelete:H,doDelete:Z}}},Sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),o=h(!1),r=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),m=h(!1),v=h(null),w=h(null),I=h(new Set),x=h(null),g=h(!1),b=h(!1),C=K(()=>e.value.reduce((J,oe)=>J+oe.count,0)),S=K(()=>I.value.size);function A(J){const oe=t.value[J];if(!oe)return[];if(!l.value.trim())return oe;const ee=l.value.trim().toLowerCase();return oe.filter(ce=>ce.key.toLowerCase().includes(ee)||ce.value&&ce.value.toLowerCase().includes(ee))}function T(J,oe){return I.value.has(J+"/"+oe)}function y(J,oe){const ee=J+"/"+oe,ce=new Set(I.value);ce.has(ee)?ce.delete(ee):ce.add(ee),I.value=ce}function R(J){const oe=t.value[J];return!oe||oe.length===0?!1:oe.every(ee=>I.value.has(J+"/"+ee.key))}function $(J,oe){const ee=t.value[J];if(!ee)return;const ce=new Set(I.value);for(const Ne of ee){const Q=J+"/"+Ne.key;oe?ce.add(Q):ce.delete(Q)}I.value=ce}async function k(){s.value=!0,n.value=null;try{const J=await G.get("/api/memory");e.value=Object.entries(J).map(([oe,ee])=>({name:oe,keys:ee.keys||[],count:ee.count||0}))}catch(J){n.value=J.message}s.value=!1}async function M(J){if(a.value[J]){a.value[J]=!1;return}a.value[J]=!0;const oe=e.value.find(ce=>ce.name===J);if(!oe||t.value[J]||i.value===J)return;i.value=J;let ee;try{const Ne=(await G.get(`/api/memory/${encodeURIComponent(J)}`)).entries||{};ee=oe.keys.map(Q=>Object.prototype.hasOwnProperty.call(Ne,Q)?{key:Q,value:Ne[Q]||"",failed:!1}:{key:Q,value:"",failed:!0,error:"Not found in scope"})}catch(ce){ee=oe.keys.map(Ne=>({key:Ne,value:"",failed:!0,error:ce.message||"Failed to load"}))}t.value[J]=ee,i.value=null}function j(J,oe,ee){p.value=J+"/"+oe,f.value=ee}async function q(J,oe){m.value=!0,v.value=null;try{await G.put(`/api/memory/${encodeURIComponent(J)}/${encodeURIComponent(oe)}`,{value:f.value});const ee=t.value[J];if(ee){const ce=ee.find(Ne=>Ne.key===oe);ce&&(ce.value=f.value)}p.value=null}catch(ee){v.value=`Failed to save: ${ee.message||"unknown error"}`}m.value=!1}async function D(J,oe){try{await navigator.clipboard.writeText(oe.value),w.value=J+"/"+oe.key,setTimeout(()=>{w.value=null},1500)}catch{}}async function O(){d.value=null,u.value=null;const J=r.value.scope.trim(),oe=r.value.key.trim(),ee=r.value.value.trim();if(!J){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!ee){d.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(J)}/${encodeURIComponent(oe)}`,{value:ee}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await k(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ce){d.value=ce.message}c.value=!1}function L(J,oe){x.value={scope:J,key:oe}}async function H(){if(!x.value)return;g.value=!0,v.value=null;const{scope:J,key:oe}=x.value;try{await G.del(`/api/memory/${encodeURIComponent(J)}/${encodeURIComponent(oe)}`);const ee=t.value[J];ee&&(t.value[J]=ee.filter(Q=>Q.key!==oe));const ce=e.value.find(Q=>Q.name===J);ce&&(ce.count--,ce.keys=ce.keys.filter(Q=>Q!==oe));const Ne=new Set(I.value);Ne.delete(J+"/"+oe),I.value=Ne}catch(ee){v.value=`Failed to delete: ${ee.message||"unknown error"}`}g.value=!1,x.value=null}function Z(){b.value=!0}async function W(){g.value=!0,v.value=null;const J=[];for(const oe of I.value){const ee=oe.indexOf("/");J.push({scope:oe.slice(0,ee),key:oe.slice(ee+1)})}try{await G.post("/api/memory/bulk-delete",{entries:J}),I.value=new Set,t.value={},await k()}catch(oe){v.value=`Bulk delete failed: ${oe.message||"unknown error"}`}g.value=!1,b.value=!1}return Ve(()=>{k()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:m,actionError:v,copied:w,selected:I,selectedCount:S,totalEntries:C,deleteTarget:x,deleting:g,showBulkDelete:b,fetchMemory:k,toggleScope:M,startEdit:j,doEdit:q,copyValue:D,doAdd:O,confirmDelete:L,doDelete:H,confirmBulkDelete:Z,doBulkDelete:W,isSelected:T,toggleSelect:y,isScopeAllSelected:R,toggleSelectAll:$,filteredEntries:A}}},Tk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const we=new Blob([X],{type:"text/plain"}),$e=URL.createObjectURL(we),Ze=document.createElement("a");Ze.href=$e,Ze.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ze.click(),URL.revokeObjectURL($e)}function ue(X){const we=rp(X);navigator.clipboard.writeText(we).then(()=>{m.value=X.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function de(X){l.value=l.value===X?"":X,g.value="all"}function le(X){return X.level==="ERROR"?"log-line-error":X.level==="WARNING"?"log-line-warning":"text-gray-300"}function xe(X){return X==="ERROR"?"text-red-500 font-semibold":X==="WARNING"?"text-yellow-500":"text-blue-500"}function me(X){return X==="ERROR"?"log-chip-error":X==="WARNING"?"log-chip-warning":"log-chip-info"}function _e(X){g.value=X.id;const we=X.filters;l.value=we.level||"",b.value=we.timeRange||"",o.value=we.text||"",we.levels&&(l.value=we.levels[0]||""),we.hasToolName&&(o.value="")}function Re(X){g.value=X.id,l.value=X.filters.level||"",b.value=X.filters.timeRange||"",o.value=X.filters.text||""}function F(){if(!A.value.trim())return;const X={id:"custom-"+Date.now(),name:A.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};C.value=[...C.value,X],R(),S.value=!1,A.value=""}function ve(X){C.value=C.value.filter(we=>we.id!==X),R(),g.value===X&&(g.value="all")}const ke=h("all"),Oe=h(""),Pe=h(""),dt=h(""),st=h(""),_t=h(""),Ot=h(100),rt=zk,Qe=h(!1),ne=h(!1),Se=h(""),Le=h([]),Ke=h(null),Et=h(null);function je(){e.value="search",Ke.value||Ft()}async function Ft(){try{Ke.value=await G.get("/api/logs/stats")}catch{}}function Ht(){const X=_t.value;if(!X){dt.value="",st.value="";return}const $e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[X];if($e){const Ze=new Date(Date.now()-$e*1e3);dt.value=os(Ze),st.value=""}}function os(X){const we=$e=>String($e).padStart(2,"0");return`${X.getFullYear()}-${we(X.getMonth()+1)}-${we(X.getDate())}T${we(X.getHours())}:${we(X.getMinutes())}`}function Zs(X){if(!X)return"";const we=new Date(X);return isNaN(we.getTime())?"":we.toISOString()}async function ks(){Qe.value=!0,Se.value="",ne.value=!0,Et.value=null;try{const X=new URLSearchParams;ke.value&&ke.value!=="all"&&X.set("level",ke.value),Oe.value&&X.set("tool",Oe.value),Pe.value&&X.set("q",Pe.value);const we=Zs(dt.value),$e=Zs(st.value);we&&X.set("start",we),$e&&X.set("end",$e),X.set("limit",String(Ot.value));const Ze=await G.get(`/api/logs/search?${X.toString()}`);Le.value=Ze.entries||[]}catch(X){Se.value=X.message||"Search failed",Le.value=[]}finally{Qe.value=!1}}function sa(){ke.value="all",Oe.value="",Pe.value="",dt.value="",st.value="",_t.value="",Ot.value=100,Le.value=[],ne.value=!1,Se.value="",Et.value=null}function Js(X){Et.value=Et.value===X?null:X}function Ls(X){if(!X.timestamp)return"";try{return new Date(X.timestamp).toLocaleString()}catch{return X.timestamp}}function Pn(X){return X.type==="web_action"?`${X.status||""} (${X.execution_time_ms||0}ms)`:(X.result_summary||"").slice(0,200)}function Ss(X){return X.error?"log-line-error":"text-gray-300"}function Fn(X){try{return JSON.stringify(X,null,2)}catch{return String(X)}}let zt=null,Xe=!1;function Ns(){Xe||(Xe=!0,Ye.subscribe("logs",ee),c.value=Ye.connected,d.value=Ye.state||"disconnected",zt=Ye.onState(X=>{d.value=X,c.value=X==="connected"}))}function Ds(){Xe&&(Xe=!1,Ye.unsubscribe("logs",ee),zt&&(zt(),zt=null))}return Ve(()=>{y(),window.addEventListener("pointerup",U),window.addEventListener("pointercancel",U)}),ms(Ns),ls(Ds),mt(()=>{Ds(),window.removeEventListener("pointerup",U),window.removeEventListener("pointercancel",U)}),{mode:e,logs:t,paused:a,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:n,groupedLogs:oe,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:J,pauseBuffer:T,showJumpBottom:f,copiedIndex:m,regexError:M,levels:w,logPresets:I,timeRanges:x,timeRange:b,activeLogPreset:g,customLogPresets:C,showSaveLogPreset:S,newLogPresetName:A,hasActiveLogFilters:$,timeRangeLabel:k,timelineBuckets:q,timelineMax:D,timelineSpanLabel:O,timelineLabelSkip:L,togglePause:se,clearLogs:ae,exportLogs:fe,logLineClass:le,levelClass:xe,levelChipClass:me,toggleLevel:de,copyLine:ue,jumpToBottom:Q,onScroll:z,onUserScrollIntent:pe,onUserScrollKey:Ie,onAutoScrollToggle:ie,onPointerDown:P,applyLogPreset:_e,applyCustomLogPreset:Re,saveLogCustomPreset:F,removeLogCustomPreset:ve,segmentHeight:Z,jumpToTimelineBucket:W,searchLevel:ke,searchTool:Oe,searchKeyword:Pe,searchStart:dt,searchEnd:st,searchTimePreset:_t,searchLimit:Ot,searchLimits:rt,searching:Qe,searchRan:ne,searchError:Se,searchResults:Le,searchStats:Ke,expandedSearch:Et,switchToSearch:je,runSearch:ks,clearSearchFilters:sa,toggleSearchExpand:Js,formatSearchTs:Ls,searchEntryText:Pn,searchLogLineClass:Ss,formatJson:Fn,applySearchTimePreset:Ht}}};function Dl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const Vk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function qk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Xa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Gk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},wr=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),Kk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function cp(e){return Kk.some(t=>e===t||e.startsWith(`${t}.`))}const Xm="odin_config_center_expanded_v1",ev="odin_config_center_category_v1",Wk=50,Zk=650,kr=()=>G.get("/api/config/meta");function ca(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ui(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ma(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Jk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function Yk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function tv(e,t){if(Ui(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ca(t);const n={};for(const[a,i]of Object.entries(t)){const l=tv(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function Qk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=tv(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function sv(e,t,s,n){if(Ui(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)sv(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function Xk(){try{const e=JSON.parse(localStorage.getItem(Xm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function eS(){try{const e=localStorage.getItem(ev);return Xa.some(t=>t.key===e)?e:Xa[0].key}catch{return Xa[0].key}}const tS={template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=K(()=>new Set((e.excludedIds||[]).map(String))),o=K(()=>{const C=s.value.toLowerCase().trim();return(e.members||[]).filter(S=>l.value.has(String(S.id))?!1:C?u(S).toLowerCase().includes(C)||String(S.username||"").toLowerCase().includes(C)||String(S.id).includes(C):!0)}),r=K(()=>{const C=s.value.trim();return o.value.length===0&&sS.test(C)&&!l.value.has(C)?C:""}),c=K(()=>o.value.length+(r.value?1:0)),d=K(()=>{if(n.value){if(o.value[a.value])return`${e.optionsId}-${a.value}`;if(r.value&&a.value===o.value.length)return`${e.optionsId}-raw`}});function u(C){return nv(C)}function p(){n.value=!0,a.value=0}function f(){p()}function m(){const C=Math.max(c.value-1,0);a.value=Math.min(a.value+1,C)}function v(){a.value=Math.max(a.value-1,0)}function w(){const C=o.value[a.value];C?I(C):r.value&&a.value===o.value.length&&x(r.value)}function I(C){x(String(C.id))}function x(C){t("select",C),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function b(){setTimeout(g,150)}return Ve(()=>{e.autofocus&&Rt(()=>{var C;return(C=i.value)==null?void 0:C.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:m,highlightPrevious:v,selectHighlighted:w,selectMember:I,selectId:x,closeOptions:g,onBlur:b}}};function dp(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const nS={components:{DiscordUserCombobox:av},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h(null),i=h(null),l=h(!1),o=h(null),r=h({}),c=h([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=K(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),f=K(()=>new Map(c.value.map(D=>[String(D.id),D])));function m(D){return D.config&&D.config.enabled!==void 0?D.config.enabled:!0}function v(D){return dp(D,"require_mention",a.value)}function w(D){return dp(D,"respond_to_bots",a.value)}function I(D){return D.config&&Object.keys(D.config).length>0}function x(D){n.value[D]=!n.value[D]}function g(D){const O=D.discord||{};return{allowed_users:[...O.allowed_users||[]],channels:[...O.channels||[]],respond_to_bots:!!O.respond_to_bots,require_mention:!!O.require_mention,ignore_bot_ids:[...O.ignore_bot_ids||[]]}}async function b({showLoading:D=!0}={}){const O=++d;D&&(t.value=!0),s.value=null;try{const L=await G.get("/api/discord/guilds");O===d&&(e.value=L)}catch(L){O===d&&(s.value=L.message)}finally{D&&O===d&&(t.value=!1)}}async function C(){t.value=!0,s.value=null;try{const[D,O,L]=await Promise.all([G.get("/api/discord/guilds"),G.get("/api/discord/members").catch(()=>[]),G.get("/api/config")]),H=g(L),Z=p.value;a.value=H,Z||(i.value=JSON.parse(JSON.stringify(H))),c.value=O,e.value=D,o.value=null}catch(D){s.value=D.message}finally{t.value=!1}}let S=Promise.resolve();const A=h(new Set);function T(D,O){const L=new Set(A.value);L.add(D),A.value=L;const H=S.then(O);return S=H.catch(()=>{}),H.finally(()=>{const Z=new Set(A.value);Z.delete(D),A.value=Z})}function y(D,O,L,H){const Z=(H==null?void 0:H.target)??null;return T(`guild:${D}:${O}`,async()=>{try{await G.put("/api/discord/guild/"+D+"/config",{[O]:L}),await b({showLoading:!1})}catch(W){s.value=W.message,Z&&typeof L=="boolean"&&(Z.checked=!L)}})}function R(D,O,L,H,Z){const W=(Z==null?void 0:Z.target)??null;return T(`channel:${D}:${L}`,async()=>{try{await G.put("/api/discord/channel/"+D+"/config",{[L]:H}),await b({showLoading:!1})}catch(J){s.value=J.message,W&&typeof H=="boolean"&&(W.checked=!H)}})}function $(D,O){return T(`channel:${D}:clear`,async()=>{try{await G.put("/api/discord/channel/"+D+"/config",{clear:!0}),await b({showLoading:!1})}catch(L){s.value=L.message}})}function k(D,O){const L=String(O);if(!D.userAutocomplete)return L;const H=f.value.get(L);return H?nv(H):L}function M(D,O=null){const L=String(O??r.value[D]??"").trim();!L||i.value[D].includes(L)||(i.value[D]=[...i.value[D],L],r.value={...r.value,[D]:""})}function j(D,O){i.value[D]=i.value[D].filter(L=>L!==O)}async function q(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const O=(await G.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...O.allowed_users||[]],channels:[...O.channels||[]],respond_to_bots:!!O.respond_to_bots,require_mention:!!O.require_mention,ignore_bot_ids:[...O.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(D){o.value=D.message||"Global defaults could not be saved."}finally{l.value=!1}}}return Ve(C),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:w,hasOverride:I,toggleGuild:x,fetchAll:C,fetchGuilds:b,setGuildConfig:y,setChannelConfig:R,clearOverride:$,mutationPending:A,globalItemLabel:k,addGlobalItem:M,removeGlobalItem:j,saveGlobalDefaults:q}}},Cs=e=>e==null?e:JSON.parse(JSON.stringify(e));function aS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let f=null;const m=new Map;function v(S){d+=1;const A=c.then(S,S);return c=A.catch(()=>{}),A}function w(S,A){f=Cs(S),m.clear();for(const[T,y]of Object.entries(A||{}))m.set(T,Cs(y))}function I(S){const A=Cs(S),T=++u;return v(async()=>{try{await e(Cs(A)),f=Cs(A),T===u&&n(Cs(A))}catch(y){T===u&&(a(Cs(f)),r(y,{kind:"default"}))}})}function x(S,A){const T=Cs(A),y=(p.get(S)||0)+1;return p.set(S,y),v(async()=>{try{await t(S,Cs(T)),m.set(S,Cs(T)),y===p.get(S)&&i(S,Cs(T))}catch(R){y===p.get(S)&&(l(S,Cs(m.get(S)??null)),r(R,{kind:"user",uid:S}))}})}function g(S){const A=(p.get(S)||0)+1;return p.set(S,A),v(async()=>{try{await s(S),m.delete(S),A===p.get(S)&&o(S)}catch(T){A===p.get(S)&&(l(S,Cs(m.get(S)??null)),r(T,{kind:"delete",uid:S}))}})}async function b(){for(;;){const S=c;if(await S,S===c)return d}}async function C(S){for(;;){const A=await b(),T=await S();if(A===d)return T}}return{seed:w,saveDefault:I,saveUser:x,deleteUser:g,whenIdle:b,readSnapshot:C,get revision(){return d}}}const iS={components:{DiscordUserCombobox:av},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
...
`),l.value=4,ye.info("Imported existing known_hosts trust. Test before activation.")}catch(D){ye.error(D.message)}}async function y(){try{const q=m.value.split(/\s+/).filter(Boolean),D={...w.value,expected_fingerprints:q,candidate_fingerprints:u.value},O=await G.post("/api/hosts/candidates",D);if(d.value=O.candidate_token,u.value=O.fingerprints||[],w.value.trust_mode==="tofu"&&D.candidate_fingerprints.length===0){w.value.confirm_tofu=!1,ye.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(q){ye.error(q.message)}}async function R(){try{const q=await G.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!q.tested,f.value=q.last_test,p.value&&(l.value=5)}catch(q){ye.error(q.message)}}async function $(){try{await G.post("/api/hosts/candidates/"+d.value+"/commit",{}),ye.success("Host saved and published live"),a.value=!1,await x()}catch(q){ye.error(q.message)}}async function k(q){try{await G.post("/api/hosts/"+encodeURIComponent(q.alias)+"/enabled",{enabled:!q.enabled}),await x()}catch(D){ye.error(D.message)}}async function M(q){var D;if(await qt("Delete host "+q.alias+"? Dependencies will block deletion.")){n.value=[];try{await G.del("/api/hosts/"+encodeURIComponent(q.alias)),await x()}catch(O){n.value=Array.isArray((D=O.data)==null?void 0:D.pending_references)?O.data.pending_references:[],ye.error(O.message)}}}async function j(q){if(await qt("Force revoke "+q.alias+"? Remote outcomes may be unknown."))try{await G.post("/api/hosts/"+encodeURIComponent(q.alias)+"/force-revoke",{}),await x()}catch(D){ye.error(D.message)}}return Ve(x),{hosts:e,loading:t,error:s,pendingReferences:n,wizard:a,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:w,isLocal:I,keyInfo:c,candidate:d,observed:u,tested:p,testResult:f,fingerprintsText:m,load:x,saveSettings:g,beginAdd:C,beginEdit:S,loadKey:A,importLegacy:T,prepare:y,testConnection:R,commit:$,toggle:k,remove:M,forceRevoke:j}}},oS={template:`
  ...
  `,setup(){const e=h(null),t=h(""),s=h(null),n=h(!1),a=h(0),i=h(null),l=h(""),o=h(null),r=h(!1),c=h(0),d=h(Date.now());let u=null,p=0,f=0;async function m(){const O=++p;n.value=!0;try{const L=await G.get("/api/turn-state/turns?limit=100");if(O!==p)return;t.value=L.availability,e.value=L.availability==="available"?L.data:null,s.value=null,a.value=Date.now()}catch(L){if(O!==p)return;s.value=L.message||"Turn-state read failed",L.status===503&&(t.value="unavailable")}O===p&&(n.value=!1)}async function v(){const O=++f;r.value=!0;try{const L=await G.get("/api/turn-state/capacity-breakers");if(O!==f)return;l.value=L.availability,i.value=L.availability==="available"?L.data:null,o.value=null,c.value=Date.now()}catch(L){if(O!==f)return;o.value=L.message||"Breaker read failed",L.status===503&&(l.value="unavailable")}O===f&&(r.value=!1)}function w(){m(),v()}const I=K(()=>e.value!==null&&ki(d.value,a.value)>hp),x=K(()=>i.value!==null&&ki(d.value,c.value)>hp),g=K(()=>I.value||x.value),b=K(()=>Math.round(ki(d.value,a.value)/1e3)),C=K(()=>Math.round(ki(d.value,c.value)/1e3));function S(O){return Sr(O,d.value/1e3)}function A(O){return xS[S(O)]}const T=K(()=>{var H;const O=[...((H=e.value)==null?void 0:H.turns)||[]],L=d.value/1e3;return O.sort((Z,W)=>Sr(Z,L)-Sr(W,L)||(W.last_progress_at||0)-(Z.last_progress_at||0))});function y(O){return O.state==="closed"?"badge-success":O.state==="probing"?"badge-warning":"badge-danger"}function R(O){if(O.state==="closed")return"—";const L=ki(d.value,c.value)/1e3,H=Math.max(0,(O.cooldown_remaining_seconds||0)-L);return H>0?`${Math.ceil(H)}s`:O.state==="probing"?"probe in flight":"probe eligible"}function $(O){if(!O)return"";const L=Math.max(0,Math.round(d.value/1e3-O));if(L<90)return`${L}s ago`;const H=Math.round(L/60);return H<90?`${H}m ago`:`${Math.round(H/60)}h ago`}let k=null,M=null,j=!1;function q(){j||(j=!0,w(),k=setInterval(w,yS),u=setInterval(()=>{d.value=Date.now()},1e3),M=Ye.onReconnected(w))}function D(){j&&(j=!1,k&&(clearInterval(k),k=null),u&&(clearInterval(u),u=null),M&&(M(),M=null))}return Ve(q),ms(q),ls(D),mt(D),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:I,breakersStale:x,anyStale:g,turnsAgeSeconds:b,breakersAgeSeconds:C,sortedTurns:T,priorityOf:S,priorityBadge:A,breakerBadge:y,cooldownLabel:R,ageLabel:$,fetchTurns:m,fetchBreakers:v,refreshAll:w,arm:q,disarm:D}}},wS={setup(){const e=h(""),t=h(""),s=h(!1),n=h(""),a=h(!1),i=h(!1),l=h(!1),o=h(null),r=h(!1);async function c(){a.value=!0,o.value=null,r.value=!1;try{const u=await G.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{a.value=!1}}async function d(){if(await qt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await G.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return Ve(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
...
`,e=e.substring(p.length+1),r=!0),!r){const I=this.rules.other.nextBulletRegex(m),x=this.rules.other.hrRegex(m),g=this.rules.other.fencesBeginRegex(m),b=this.rules.other.headingBeginRegex(m),C=this.rules.other.htmlBeginRegex(m);for(;e;){const S=e.split(`
`,1)[0];let A;if(p=S,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),A=p):A=p.replace(this.rules.other.tabCharGlobal,"    "),g.test(p)||b.test(p)||C.test(p)||I.test(p)||x.test(p))break;if(A.search(this.rules.other.nonSpaceChar)>=m||!p.trim())d+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+tn(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ka=new z1;function at(e,t){return ka.parse(e,t)}at.options=at.setOptions=function(e){return ka.setOptions(e),at.defaults=ka.defaults,cv(at.defaults),at};at.getDefaults=yd;at.defaults=Ra;at.use=function(...e){return ka.use(...e),at.defaults=ka.defaults,cv(at.defaults),at};at.walkTokens=function(e,t){return ka.walkTokens(e,t)};at.parseInline=ka.parseInline;at.Parser=Tn;at.parser=Tn.parse;at.Renderer=ko;at.TextRenderer=Ed;at.Lexer=Sn;at.lexer=Sn.lex;at.Tokenizer=wo;at.Hooks=ql;at.parse=at;at.options;at.setOptions;at.use;at.walkTokens;at.parseInline;Tn.parse;Sn.lex;const j1={breaks:!0,gfm:!0};function Pp(e){if(!e)return"";try{if(typeof at<"u"&&at.parse){const t=at.parse(e,j1);return typeof Ip<"u"?Ip.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function V1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const q1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function G1(e){return q1[e]||"wrench"}const K1=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Fp(e){if(!e)return[];const t=e.match(K1);return t?[...new Set(t)]:[]}const W1={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(""),a=h(null),i=h(null),l=h(0),o=h("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=K(()=>t.value.trim().length>0&&!s.value),p=h(Ye.state||"disconnected");let f=null;const m=K(()=>{const D=p.value;return D==="connected"?"Connected":D==="reconnecting"?"Reconnecting…":D==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],w=K(()=>{const D=Math.floor(l.value/4)%v.length,O=l.value;return O>3?`${v[D]} (${O}s)`:v[0]});function I(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function x(){if(!i.value)return;const D=i.value;D.style.height="auto",D.style.height=Math.min(D.scrollHeight,120)+"px"}function g(D,O,L={}){const H={id:++c,role:D,content:O,timestamp:Date.now(),html:D==="bot"?Pp(O):"",tools_used:L.tools_used||[],is_error:L.is_error||!1,images:D==="bot"?Fp(O):[],files:L.files||[],_showTools:!1};return e.value.push(H),I(),D==="bot"&&Rt(()=>b()),H}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(O=>{O.setAttribute("data-copy","true"),O.style.position="relative";const L=document.createElement("button");L.className="chat-code-copy",L.textContent="Copy",L.addEventListener("click",()=>{const H=O.querySelector("code"),Z=H?H.textContent:O.textContent;navigator.clipboard.writeText(Z).then(()=>{L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},1500)}).catch(()=>{})}),O.appendChild(L)})}function C(D){if(D===0)return!0;const O=e.value[D-1],L=e.value[D],H=new Date(O.timestamp).toDateString(),Z=new Date(L.timestamp).toDateString();return H!==Z}function S(D){const O=new Date(D),L=new Date;if(O.toDateString()===L.toDateString())return"Today";const H=new Date(L);return H.setDate(H.getDate()-1),O.toDateString()===H.toDateString()?"Yesterday":O.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function A(D){t.value=D,Rt(()=>j())}function T(D){window.open(D,"_blank","noopener")}function y(D){D.target.style.display="none"}function R(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function $(){r&&(clearInterval(r),r=null),l.value=0}function k(D){s.value&&(s.value=!1,$(),D.type==="chat_response"?g("bot",D.content,{tools_used:D.tools_used||[],is_error:D.is_error||!1,files:D.files||[]}):D.type==="chat_error"&&g("bot",D.error||"Unknown error",{is_error:!0}),Rt(()=>{var O;return(O=i.value)==null?void 0:O.focus()}))}async function M(D){try{const O=await G.post("/api/chat",{content:D,channel_id:o.value});g("bot",O.response,{tools_used:O.tools_used||[],is_error:O.is_error||!1,files:O.files||[]})}catch(O){g("bot",O.message||"Failed to send message",{is_error:!0})}}async function j(){const D=t.value.trim();if(!D||s.value)return;g("user",D),t.value="",s.value=!0,R(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(D,{channelId:o.value})||(await M(D),s.value=!1,$()),Rt(()=>{var L;return(L=i.value)==null?void 0:L.focus()})}async function q(){n.value="";try{if(!o.value){const O=await G.get("/api/auth/session");o.value=O.channel_id||O.user_id||"web-user"}const D=await G.get("/api/sessions/"+encodeURIComponent(o.value));if(D&&D.messages&&D.messages.length>0){for(const O of D.messages){const L=O.role==="user"?"user":"bot";let H=O.content||"";if(L==="user"){const W=H.match(/^\[.*?\]:\s*/);W&&(H=H.slice(W[0].length))}if(!H.trim())continue;const Z={id:++c,role:L,content:H,timestamp:O.timestamp?O.timestamp*1e3:Date.now(),html:L==="bot"?Pp(H):"",tools_used:[],is_error:!1,images:L==="bot"?Fp(H):[],files:[],_showTools:!1};e.value.push(Z)}Rt(()=>{I(),b()})}}catch(D){D&&D.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",ye.error(n.value))}}return Ve(()=>{Ye.subscribe("chat",k),p.value=Ye.state||"disconnected",f=Ye.onState(D=>{p.value=D}),q(),Rt(()=>{var D;return(D=i.value)==null?void 0:D.focus()})}),mt(()=>{Ye.unsubscribe("chat",k),f&&(f(),f=null),$()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:w,suggestions:d,send:j,autoResize:x,formatTime:V1,formatDate:S,showDateSeparator:C,useSuggestion:A,openImage:T,onImageError:y,getToolIcon:G1,loadHistory:q}}},Z1={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),o=h(!1),r=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),m=K(()=>e.value==="custom"),v=K(()=>[...i.value,...l.value]),w=K(()=>l.value.includes(e.value)),I=K(()=>{var T;return m.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),x=K(()=>{var T;return m.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),g=K(()=>{var T;return m.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function b(){d.value=!0;try{const T=await G.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{d.value=!1}}async function C(){o.value=!0,c.value=null,r.value=!1;try{await G.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(T){c.value=T.message}finally{o.value=!1}}async function S(){const T=u.value.trim();if(T){f.value=!0,c.value=null;try{await G.post("/api/personality/presets",{name:T,display_name:I.value,identity:x.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(y){c.value=y.message}finally{f.value=!1}}}async function A(){if(await qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await G.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(y){c.value=y.message}}}return Ve(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:w,previewName:I,previewIdentity:x,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:C,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:S,deletePreset:A,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),xv=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:IS,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:W1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:Jw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:ik,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Ck,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:Z1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:kS,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/hosts",redirect:kt("/system","hosts")},{path:"/internals",redirect:kt("/system","internals")}],zi=Tw({history:nw(),routes:xv});zi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const J1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let o=null,r=null;const c=h(!1),d=h("disconnected"),u=h(-1),p=h(null);let f=null;const m=h("starting"),v=h(""),w=xv.filter(H=>H.meta),I=K(()=>["Workspace","Operate","Observe","Manage"].map(H=>({name:H,routes:w.filter(Z=>Z.meta.section===H)})).filter(H=>H.routes.length)),x=K(()=>{var H;return((H=zi.currentRoute.value.meta)==null?void 0:H.label)||"Odin"}),g=K(()=>{var H;return((H=zi.currentRoute.value.meta)==null?void 0:H.section)||"Management"}),b=K(()=>{var H;return((H=zi.currentRoute.value.meta)==null?void 0:H.description)||"Management console"});function C(){Ye.disconnect(),j&&(clearInterval(j),j=null)}G.onSessionExpired=()=>{t.value=!0,C(),G.setToken(""),e.value="login"};function S(H){var Z;if((H.ctrlKey||H.metaKey)&&H.key.toLowerCase()==="k"){e.value==="ready"&&(H.preventDefault(),mp());return}if(n.value&&H.key==="Tab"){const W=[...((Z=a.value)==null?void 0:Z.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(W.length){const J=W[0],oe=W[W.length-1];if(H.shiftKey&&(document.activeElement===J||!a.value.contains(document.activeElement))){H.preventDefault(),oe.focus();return}if(!H.shiftKey&&(document.activeElement===oe||!a.value.contains(document.activeElement))){H.preventDefault(),J.focus();return}}}if(H.key==="Escape"&&n.value){n.value=!1,H.preventDefault();return}if(H.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(H.target.tagName)){H.preventDefault();const W=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');W&&W.focus()}}function A(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}Ve(async()=>{document.addEventListener("keydown",S),o=window.matchMedia("(max-width: 900px)"),A(),o.addEventListener("change",A);const H=await G.check();H.ok?(e.value="ready",O()):H.needsAuth?e.value="login":(e.value="ready",O())});function T(){t.value=!1,e.value="ready",O()}async function y(){C(),e.value="login",await G.logout()}function R(){s.value=!s.value}function $(){n.value=!n.value}Mt(n,async H=>{var Z,W;if(H)r=document.activeElement,await Rt(),(W=(Z=a.value)==null?void 0:Z.querySelector(".nav-item"))==null||W.focus();else if(r!=null&&r.isConnected){const J=r;r=null,requestAnimationFrame(()=>J.focus())}});const k=K(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(H,Z="info",W=3e3){p.value={text:H,level:Z},clearTimeout(f),f=setTimeout(()=>{p.value=null},W)}let j=null,q=!1,D=[];function O(){for(const H of D)H();D=[Ye.onStatus(H=>{c.value=H}),Ye.onLatencyChange(H=>{u.value=H}),Ye.onState((H,Z)=>{d.value=H,H==="connected"?(q&&M("Connection restored","success"),q=!0):H==="reconnecting"&&Z.attempt===1&&M("Connection lost — reconnecting…","warn")})],Ye.connect(),L(),j&&clearInterval(j),j=setInterval(L,15e3)}async function L(){try{const H=await G.get("/api/status");m.value=H.status==="online"?"online":"starting";const Z=H.uptime_seconds||0,W=Math.floor(Z/3600),J=Math.floor(Z%3600/60);v.value=`${W}h ${J}m uptime`}catch{m.value="offline",v.value=""}}return mt(()=>{j&&clearInterval(j);for(const H of D)H();D=[],Ye.disconnect(),document.removeEventListener("keydown",S),o==null||o.removeEventListener("change",A)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:k,wsToast:p,botStatus:m,botUptime:v,navRoutes:w,navGroups:I,currentPage:x,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:T,logout:y,toggleSidebar:R,toggleMobileNavigation:$,openPalette:mp}}},ta=co(Y1);ta.component("odin-icon",ES);ta.component("login-screen",J1);ta.component("toast-container",g_);ta.component("confirm-host",b_);ta.component("command-palette",CS);ta.directive("modal-focus",RS);ta.use(zi);ta.mount("#app");
