...
`,-1),r())),e.components.length&&(hr(e.components,"component",s),(e.directives.length||e.temps>0)&&r()),e.directives.length&&(hr(e.directives,"directive",s),e.temps>0&&r()),e.filters&&e.filters.length&&(r(),hr(e.filters,"filter",s),r()),e.temps>0){a("let ");for(let x=0;x<e.temps;x++)a(`${x>0?", ":""}_temp${x}`)}return(e.components.length||e.directives.length||e.temps)&&(a(`
 ...
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let ew=()=>location.protocol+"//"+location.host;function Um(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,o=a.slice(l);return o[0]!=="/"&&(o="/"+o),Hu(o,"")}return Hu(s,e)+n+a}function tw(e,t,s,n){let a=[],i=[],l=null;const o=({state:p})=>{const h=Um(e,location),m=s.value,v=t.value;let w=0;if(p){if(s.value=h,t.value=p,l&&l===m){l=null;return}w=v?p.position-v.position:0}else n(h);a.forEach(L=>{L(s.value,m,{delta:w,type:ac.pop,direction:w?w>0?gr.forward:gr.back:gr.unknown})})};function r(){l=s.value}function c(p){a.push(p);const h=()=>{const m=a.indexOf(p);m>-1&&a.splice(m,1)};return i.push(h),h}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(lt({},p.state,{scroll:Jo()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",o),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",o),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:r,listen:c,destroy:u}}function Gu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?Jo():null}}function sw(e){const{history:t,location:s}=window,n={value:Um(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(r,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+r:ew()+e+r;try{t[d?"replaceState":"pushState"](c,"",p),a.value=c}catch(h){console.error(h),s[d?"replace":"assign"](p)}}function l(r,c){i(r,lt({},t.state,Gu(a.value.back,r,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=r}function o(r,c){const d=lt({},a.value,t.state,{forward:r,scroll:Jo()});i(d.current,d,!0),i(r,lt({},Gu(n.value,r,null),{position:d.position+1},c),!1),n.value=r}return{location:n,state:a,push:o,replace:l}}function nw(e){e=U_(e);const t=sw(e),s=tw(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=lt({location:"",base:e,go:n,createHref:z_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function aw(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),nw(e)}let fa=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Bt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Bt||{});const iw={type:fa.Static,value:""},lw=/[a-zA-Z0-9_]/;function ow(e){if(!e)return[[]];if(e==="/")return[[iw]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(h){throw new Error(`ERR (${s})/"${c}": ${h}`)}let s=Bt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let o=0,r,c="",d="";function u(){c&&(s===Bt.Static?i.push({type:fa.Static,value:c}):s===Bt.Param||s===Bt.ParamRegExp||s===Bt.ParamRegExpEnd?(i.length>1&&(r==="*"||r==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:fa.Param,value:c,regexp:d,repeatable:r==="*"||r==="+",optional:r==="*"||r==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=r}for(;o<e.length;){if(r=e[o++],r==="\\"&&s!==Bt.ParamRegExp){n=s,s=Bt.EscapeNext;continue}switch(s){case Bt.Static:r==="/"?(c&&u(),l()):r===":"?(u(),s=Bt.Param):p();break;case Bt.EscapeNext:p(),s=n;break;case Bt.Param:r==="("?s=Bt.ParamRegExp:lw.test(r)?p():(u(),s=Bt.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--);break;case Bt.ParamRegExp:r===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+r:s=Bt.ParamRegExpEnd:d+=r;break;case Bt.ParamRegExpEnd:u(),s=Bt.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--,d="";break;default:t("Unknown state");break}}return s===Bt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const Ku="[^/]+?",rw={sensitive:!1,strict:!1,start:!0,end:!0};var us=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(us||{});const cw=/[.+*?^${}()[\]/\\]/g;function dw(e,t){const s=lt({},rw,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[us.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const p=c[u];let h=us.Segment+(s.sensitive?us.BonusCaseSensitive:0);if(p.type===fa.Static)u||(a+="/"),a+=p.value.replace(cw,"\\$&"),h+=us.Static;else if(p.type===fa.Param){const{value:m,repeatable:v,optional:w,regexp:L}=p;i.push({name:m,repeatable:v,optional:w});const x=L||Ku;if(x!==Ku){h+=us.BonusCustomRegExp;try{`${x}`}catch(b){throw new Error(`Invalid custom RegExp for param "${m}" (${x}): `+b.message)}}let g=v?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;u||(g=w&&c.length<2?`(?:/${g})`:"/"+g),w&&(g+="?"),a+=g,h+=us.Dynamic,w&&(h+=us.BonusOptional),v&&(h+=us.BonusRepeatable),x===".*"&&(h+=us.BonusWildcard)}d.push(h)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=us.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function o(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const h=d[p]||"",m=i[p-1];u[m.name]=h&&m.repeatable?h.split("/"):h}return u}function r(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const h of p)if(h.type===fa.Static)d+=h.value;else if(h.type===fa.Param){const{value:m,repeatable:v,optional:w}=h,L=m in c?c[m]:"";if(Ws(L)&&!v)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const x=Ws(L)?L.join("/"):L;if(!x)if(w)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${m}"`);d+=x}}return d||"/"}return{re:l,score:n,keys:i,parse:o,stringify:r}}function uw(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===us.Static+us.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===us.Static+us.Segment?1:-1:0}function Hm(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=uw(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Wu(n))return 1;if(Wu(a))return-1}return a.length-n.length}function Wu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const pw={strict:!1,end:!0,sensitive:!1};function fw(e,t,s){const n=dw(ow(e.path),s),a=lt(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function hw(e,t){const s=[],n=new Map;t=Uu(pw,t);function a(u){return n.get(u)}function i(u,p,h){const m=!h,v=Zu(u);v.aliasOf=h&&h.record;const w=Uu(t,u),L=[v];if("alias"in u){const b=typeof u.alias=="string"?[u.alias]:u.alias;for(const E of b)L.push(Zu(lt({},v,{components:h?h.record.components:v.components,path:E,aliasOf:h?h.record:v})))}let x,g;for(const b of L){const{path:E}=b;if(p&&E[0]!=="/"){const C=p.record.path,O=C[C.length-1]==="/"?"":"/";b.path=p.record.path+(E&&O+E)}if(x=fw(b,p,w),h?h.alias.push(x):(g=g||x,g!==x&&g.alias.push(x),m&&u.name&&!Yu(x)&&l(u.name)),zm(x)&&r(x),v.children){const C=v.children;for(let O=0;O<C.length;O++)i(C[O],x,h&&h.children[O])}h=h||x}return g?()=>{l(g)}:Bi}function l(u){if($m(u)){const p=n.get(u);p&&(n.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function o(){return s}function r(u){const p=gw(u,s);s.splice(p,0,u),u.record.name&&!Yu(u)&&n.set(u.record.name,u)}function c(u,p){let h,m={},v,w;if("name"in u&&u.name){if(h=n.get(u.name),!h)throw di(Tt.MATCHER_NOT_FOUND,{location:u});w=h.record.name,m=lt(Ju(p.params,h.keys.filter(g=>!g.optional).concat(h.parent?h.parent.keys.filter(g=>g.optional):[]).map(g=>g.name)),u.params&&Ju(u.params,h.keys.map(g=>g.name))),v=h.stringify(m)}else if(u.path!=null)v=u.path,h=s.find(g=>g.re.test(v)),h&&(m=h.parse(v),w=h.record.name);else{if(h=p.name?n.get(p.name):s.find(g=>g.re.test(p.path)),!h)throw di(Tt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});w=h.record.name,m=lt({},p.params,u.params),v=h.stringify(m)}const L=[];let x=h;for(;x;)L.unshift(x.record),x=x.parent;return{name:w,path:v,params:m,matched:L,meta:vw(L)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:o,getRecordMatcher:a}}function Ju(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Zu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:mw(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function mw(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function Yu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function vw(e){return e.reduce((t,s)=>lt(t,s.meta),{})}function gw(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;Hm(e,t[i])<0?n=i:s=i+1}const a=bw(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function bw(e){let t=e;for(;t=t.parent;)if(zm(t)&&Hm(e,t)===0)return t}function zm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Qu(e){const t=Us(Zo),s=Us(hd),n=W(()=>{const r=ln(e.to);return t.resolve(r)}),a=W(()=>{const{matched:r}=n.value,{length:c}=r,d=r[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(ci.bind(null,d));if(p>-1)return p;const h=Xu(r[c-2]);return c>1&&Xu(d)===h&&u[u.length-1].path!==h?u.findIndex(ci.bind(null,r[c-2])):p}),i=W(()=>a.value>-1&&kw(s.params,n.value.params)),l=W(()=>a.value>-1&&a.value===s.matched.length-1&&Fm(s.params,n.value.params));function o(r={}){if(ww(r)){const c=t[ln(e.replace)?"replace":"push"](ln(e.to)).catch(Bi);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:W(()=>n.value.href),isActive:i,isExactActive:l,navigate:o}}function yw(e){return e.length===1?e[0]:e}const xw=fl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Qu,setup(e,{slots:t}){const s=ea(Qu(e)),{options:n}=Us(Zo),a=W(()=>({[ep(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[ep(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&yw(t.default(s));return e.custom?i:si("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),_w=xw;function ww(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function kw(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Ws(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function Xu(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const ep=(e,t,s)=>e??t??s,Sw=fl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Us(lc),a=W(()=>e.route||n.value),i=Us(qu,0),l=W(()=>{let c=ln(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),o=W(()=>a.value.matched[l.value]);Di(qu,W(()=>l.value+1)),Di(Q_,o),Di(lc,a);const r=f();return Mt(()=>[r.value,o.value,e.name],([c,d,u],[p,h,m])=>{d&&(d.instances[u]=c,h&&h!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=h.leaveGuards),d.updateGuards.size||(d.updateGuards=h.updateGuards))),c&&d&&(!h||!ci(d,h)||!p)&&(d.enterCallbacks[u]||[]).forEach(v=>v(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=o.value,p=u&&u.components[d];if(!p)return tp(s.default,{Component:p,route:c});const h=u.props[d],m=h?h===!0?c.params:typeof h=="function"?h(c):h:null,w=si(p,lt({},m,t,{onVnodeUnmounted:L=>{L.component.isUnmounted&&(u.instances[d]=null)},ref:r}));return tp(s.default,{Component:w,route:c})||w}}});function tp(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Tw=Sw;function Cw(e){const t=hw(e.routes,e),s=e.parseQuery||Z_,n=e.stringifyQuery||Vu,a=e.history,i=wi(),l=wi(),o=wi(),r=Sc(Vn);let c=Vn;Ua&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=mr.bind(null,B=>""+B),u=mr.bind(null,N_),p=mr.bind(null,ll);function h(B,ie){let U,ee;return $m(B)?(U=t.getRecordMatcher(B),ee=ie):ee=B,t.addRoute(ee,U)}function m(B){const ie=t.getRecordMatcher(B);ie&&t.removeRoute(ie)}function v(){return t.getRoutes().map(B=>B.record)}function w(B){return!!t.getRecordMatcher(B)}function L(B,ie){if(ie=lt({},ie||r.value),typeof B=="string"){const M=vr(s,B,ie.path),j=t.resolve({path:M.path},ie),oe=a.createHref(M.fullPath);return lt(M,j,{params:p(j.params),hash:ll(M.hash),redirectedFrom:void 0,href:oe})}let U;if(B.path!=null)U=lt({},B,{path:vr(s,B.path,ie.path).path});else{const M=lt({},B.params);for(const j in M)M[j]==null&&delete M[j];U=lt({},B,{params:u(M)}),ie.params=u(ie.params)}const ee=t.resolve(U,ie),ue=B.hash||"";ee.params=d(p(ee.params));const Ae=M_(n,lt({},B,{hash:I_(ue),path:ee.path})),_=a.createHref(Ae);return lt({fullPath:Ae,hash:ue,query:n===Vu?Y_(B.query):B.query||{}},ee,{redirectedFrom:void 0,href:_})}function x(B){return typeof B=="string"?vr(s,B,r.value.path):lt({},B)}function g(B,ie){if(c!==B)return di(Tt.NAVIGATION_CANCELLED,{from:ie,to:B})}function b(B){return O(B)}function E(B){return b(lt(x(B),{replace:!0}))}function C(B,ie){const U=B.matched[B.matched.length-1];if(U&&U.redirect){const{redirect:ee}=U;let ue=typeof ee=="function"?ee(B,ie):ee;return typeof ue=="string"&&(ue=ue.includes("?")||ue.includes("#")?ue=x(ue):{path:ue},ue.params={}),lt({query:B.query,hash:B.hash,params:ue.path!=null?{}:B.params},ue)}}function O(B,ie){const U=c=L(B),ee=r.value,ue=B.state,Ae=B.force,_=B.replace===!0,M=C(U,ee);if(M)return O(lt(x(M),{state:typeof M=="object"?lt({},ue,M.state):ue,force:Ae,replace:_}),ie||U);const j=U;j.redirectedFrom=ie;let oe;return!Ae&&F_(n,ee,U)&&(oe=di(Tt.NAVIGATION_DUPLICATED,{to:j,from:ee}),J(ee,ee,!0,!1)),(oe?Promise.resolve(oe):N(j,ee)).catch(ne=>mn(ne)?mn(ne,Tt.NAVIGATION_GUARD_REDIRECT)?ne:Z(ne):R(ne,j,ee)).then(ne=>{if(ne){if(mn(ne,Tt.NAVIGATION_GUARD_REDIRECT))return O(lt({replace:_},x(ne.to),{state:typeof ne.to=="object"?lt({},ue,ne.to.state):ue,force:Ae}),ie||j)}else ne=T(j,ee,!0,_,ue);return F(j,ee,ne),ne})}function A(B,ie){const U=g(B,ie);return U?Promise.reject(U):Promise.resolve()}function y(B){const ie=te.values().next().value;return ie&&typeof ie.runWithContext=="function"?ie.runWithContext(B):B()}function N(B,ie){let U;const[ee,ue,Ae]=X_(B,ie);U=br(ee.reverse(),"beforeRouteLeave",B,ie);for(const M of ee)M.leaveGuards.forEach(j=>{U.push(Zn(j,B,ie))});const _=A.bind(null,B,ie);return U.push(_),Ne(U).then(()=>{U=[];for(const M of i.list())U.push(Zn(M,B,ie));return U.push(_),Ne(U)}).then(()=>{U=br(ue,"beforeRouteUpdate",B,ie);for(const M of ue)M.updateGuards.forEach(j=>{U.push(Zn(j,B,ie))});return U.push(_),Ne(U)}).then(()=>{U=[];for(const M of Ae)if(M.beforeEnter)if(Ws(M.beforeEnter))for(const j of M.beforeEnter)U.push(Zn(j,B,ie));else U.push(Zn(M.beforeEnter,B,ie));return U.push(_),Ne(U)}).then(()=>(B.matched.forEach(M=>M.enterCallbacks={}),U=br(Ae,"beforeRouteEnter",B,ie,y),U.push(_),Ne(U))).then(()=>{U=[];for(const M of l.list())U.push(Zn(M,B,ie));return U.push(_),Ne(U)}).catch(M=>mn(M,Tt.NAVIGATION_CANCELLED)?M:Promise.reject(M))}function F(B,ie,U){o.list().forEach(ee=>y(()=>ee(B,ie,U)))}function T(B,ie,U,ee,ue){const Ae=g(B,ie);if(Ae)return Ae;const _=ie===Vn,M=Ua?history.state:{};U&&(ee||_?a.replace(B.fullPath,lt({scroll:_&&M&&M.scroll},ue)):a.push(B.fullPath,ue)),r.value=B,J(B,ie,U,_),Z()}let P;function q(){P||(P=a.listen((B,ie,U)=>{if(!de.listening)return;const ee=L(B),ue=C(ee,de.currentRoute.value);if(ue){O(lt(ue,{replace:!0,force:!0}),ee).catch(Bi);return}c=ee;const Ae=r.value;Ua&&q_(ju(Ae.fullPath,U.delta),Jo()),N(ee,Ae).catch(_=>mn(_,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_CANCELLED)?_:mn(_,Tt.NAVIGATION_GUARD_REDIRECT)?(O(lt(x(_.to),{force:!0}),ee).then(M=>{mn(M,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_DUPLICATED)&&!U.delta&&U.type===ac.pop&&a.go(-1,!1)}).catch(Bi),Promise.reject()):(U.delta&&a.go(-U.delta,!1),R(_,ee,Ae))).then(_=>{_=_||T(ee,Ae,!1),_&&(U.delta&&!mn(_,Tt.NAVIGATION_CANCELLED)?a.go(-U.delta,!1):U.type===ac.pop&&mn(_,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),F(ee,Ae,_)}).catch(Bi)}))}let G=wi(),S=wi(),k;function R(B,ie,U){Z(B);const ee=S.list();return ee.length?ee.forEach(ue=>ue(B,ie,U)):console.error(B),Promise.reject(B)}function H(){return k&&r.value!==Vn?Promise.resolve():new Promise((B,ie)=>{G.add([B,ie])})}function Z(B){return k||(k=!B,q(),G.list().forEach(([ie,U])=>B?U(B):ie()),G.reset()),B}function J(B,ie,U,ee){const{scrollBehavior:ue}=e;if(!Ua||!ue)return Promise.resolve();const Ae=!U&&G_(ju(B.fullPath,0))||(ee||!U)&&history.state&&history.state.scroll||null;return Rt().then(()=>ue(B,ie,Ae)).then(_=>_&&V_(_)).catch(_=>R(_,B,ie))}const Y=B=>a.go(B);let ce;const te=new Set,de={currentRoute:r,listening:!0,addRoute:h,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:w,getRoutes:v,resolve:L,options:e,push:b,replace:E,go:Y,back:()=>Y(-1),forward:()=>Y(1),beforeEach:i.add,beforeResolve:l.add,afterEach:o.add,onError:S.add,isReady:H,install(B){B.component("RouterLink",_w),B.component("RouterView",Tw),B.config.globalProperties.$router=de,Object.defineProperty(B.config.globalProperties,"$route",{enumerable:!0,get:()=>ln(r)}),Ua&&!ce&&r.value===Vn&&(ce=!0,b(a.location).catch(ee=>{}));const ie={};for(const ee in Vn)Object.defineProperty(ie,ee,{get:()=>r.value[ee],enumerable:!0});B.provide(Zo,de),B.provide(hd,kc(ie)),B.provide(lc,r);const U=B.unmount;te.add(B),B.unmount=function(){te.delete(B),te.size<1&&(c=Vn,P&&P(),P=null,r.value=Vn,ce=!1,k=!1),U()}}};function Ne(B){return B.reduce((ie,U)=>ie.then(()=>y(U)),Promise.resolve())}return de}function jm(){return Us(Zo)}function Ew(e){return Us(hd)}const Yo={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=Ew(),s=jm(),n=W({get(){var r;const o=t.query.tab;return o&&e.tabs.some(c=>c.id===o)?o:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(o){s.replace({query:{...t.query,tab:o}})}}),a=W(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.component)||null}),i=W(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.label)||""});Mt(i,o=>{e.groupLabel&&o&&(document.title=`Odin — ${e.groupLabel} › ${o}`)},{immediate:!0});function l(o,r){if(!["ArrowLeft","ArrowRight","Home","End"].includes(o.key))return;o.preventDefault();let c=r;o.key==="ArrowRight"&&(c=(r+1)%e.tabs.length),o.key==="ArrowLeft"&&(c=(r-1+e.tabs.length)%e.tabs.length),o.key==="Home"&&(c=0),o.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`).replace(/\n$/,""),d=qm(c,yr.previewLines,yr.previewChars),u=t.kind==="audit_preview"?(h=t.metadata)==null?void 0:h.source:t.metadata,p=u&&(t.kind==="process_output"||u.kind==="process_output")?`PID ${u.pid??"?"} ${u.status??""}${Number.isInteger(u.exit_code)?` exit ${u.exit_code}`:""}`.trim():t.kind==="agent_result"&&(u!=null&&u.status)?`agent ${u.status}`:"";return{promoted:r,chars:i,lines:l,envelope:o,kind:t.kind,formatted:c,preview:d,outcome:p,header:t.header,summary:a.replace(/\n/g," "),warnings:Dw(t)}}const Mw={name:"CompactOutput",props:{value:{default:""},rawValue:{default:void 0},label:{type:String,default:"Output"},hasContext:{type:Boolean,default:!1}},setup(e){const t=f(!1),s=f(!0),n=f(!1),a=f(""),i=f(null),l=f(null),o=f(!1),r=W(()=>Pw(e.value)),c=W(()=>{const b=e.rawValue===void 0?e.value:e.rawValue;return typeof b=="string"?b:JSON.stringify(b,null,2)??""}),d=W(()=>n.value?c.value:r.value.formatted),u=W(()=>r.value.promoted&&r.value.preview.folded||o.value),p=W(()=>t.value?!!d.value:r.value.promoted),h=W(()=>p.value?"":r.value.summary);let m;function v(){if(t.value)return;const b=r.value.promoted?i.value:l.value;o.value=!!(b&&(b.scrollHeight>b.clientHeight+1||b.scrollWidth>b.clientWidth+1))}function w(){m==null||m.disconnect();for(const b of[i.value,l.value])b&&(m==null||m.observe(b));v()}function L(){t.value=!t.value,t.value||(n.value=!1)}function x(){n.value=!n.value,t.value=!0,a.value=""}async function g(){const b=e.value;try{await navigator.clipboard.writeText(d.value),b===e.value&&(a.value="Copied")}catch{b===e.value&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,n.value=!1,a.value=""}),Mt([i,l,t,s,r],()=>Rt(w),{flush:"post"}),je(()=>{m=new ResizeObserver(v),w()}),ft(()=>m==null?void 0:m.disconnect()),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,previewElement:i,summaryElement:l,model:r,body:d,canExpand:u,showBody:p,headerSummary:h,toggleExpanded:L,toggleRaw:x,copyOutput:g}},template:`
    ...
    </section>`},Qo={name:"ToolOutput",components:{CompactOutput:Mw},props:{value:{default:""},label:{type:String,default:"Output"},presentation:{type:String,default:"inspector"},rawValue:{default:void 0},hasContext:{type:Boolean,default:!1}},setup(e){const t=f(!1),s=f(!0),n=f(!1),a=f(""),i=W(()=>Vm(e.value)),l=W(()=>n.value?[{label:"Raw received value",text:i.value.raw}]:i.value.sections),o=W(()=>{let u=30,p=6e3;return l.value.map(h=>{const m=qm(h.text,u,p);return u=Math.max(0,u-m.lines),p=Math.max(0,p-m.chars),{...h,display:t.value?h.text:m.text,folded:m.folded}})}),r=W(()=>o.value.some(u=>u.folded)),c=W(()=>n.value?i.value.raw:l.value.map(u=>u.label?`${u.label}
${u.text}`:u.text).join(`
...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(a.value="Copied")}catch{e.value===u&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,a.value=""}),Mt(n,()=>{t.value=!1,a.value=""}),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},Fw={components:{ToolOutput:Qo},setup(){const e=f([]),t=f([]),s=f({}),n=50;function a(p){var v,w,L,x,g,b,E,C,O,A,y;const h=p.payload||p,m=h.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(m)&&!(h.agent_id||(v=h.metadata)!=null&&v.agent_id))&&!(["loop_tool_start","loop_tool"].includes(m)&&!(h.call_id||(w=h.metadata)!=null&&w.call_id))){if(m==="tool_start"||m==="loop_tool_start"){const N=h.call_id||((L=h.metadata)==null?void 0:L.call_id)||null,F=h.agent_id||((x=h.metadata)==null?void 0:x.agent_id)||"",T={callId:N,agentId:F,agentLabel:h.agent_label||((g=h.metadata)==null?void 0:g.agent_label)||"",toolInput:h.tool_input,id:N?`${F}:${N}`:`${h.action}-${Date.now()}`,tool:h.action,actor:h.actor||"",channel:h.channel_id||"",iteration:h.iteration??((b=h.metadata)==null?void 0:b.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(T);return}if(m==="tool_end"||m==="loop_tool"){const N=h.call_id||((E=h.metadata)==null?void 0:E.call_id)||null,F=h.agent_id||((C=h.metadata)==null?void 0:C.agent_id)||"";let T=-1;if(N&&(T=e.value.findIndex(P=>P.callId===N&&P.agentId===F&&P.status==="running")),T<0&&!N)for(let P=e.value.length-1;P>=0;P--){const q=e.value[P];if(q.tool===h.action&&q.agentId===F&&q.status==="running"){T=P;break}}if(T>=0){const P=e.value[T];P.status=h.error||(O=h.metadata)!=null&&O.error||["error","failed","cancelled","denied","outcome_unknown"].includes(h.status||((A=h.metadata)==null?void 0:A.status))?"error":"success",P.elapsed=h.execution_time_ms??h.duration_ms??((y=h.metadata)==null?void 0:y.elapsed_ms)??Date.now()-P.startTime,P.result=h.result_summary??h.detail??"",P.fadingOut=!0,setTimeout(()=>{const q=e.value.indexOf(P);q>=0&&e.value.splice(q,1),t.value.unshift(P),t.value.length>n&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const N=h.call_id||h.tool_name||"unknown";if(h.finished){const F={...s.value};delete F[N],s.value=F}else{const T=((s.value[N]||"")+(h.chunk||"")).split(`
...
... (truncated)`:s}function np(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function bd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Wm(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Jm=Symbol("agent-detail-cancelled"),Uw=15e3;function Hw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((h,m)=>{r=h,c=m});function u(h,m){o||(o=!0,l!==null&&a(l),l=null,(h?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(h){u(!1,h)}return o||Promise.resolve(p).then(h=>u(!0,h),h=>u(!1,h)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const h=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${h}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Jm),i==null||i.abort()}}}function Zm({state:e,requestDetail:t,timeoutMs:s=Uw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:h,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,h?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const w=Hw(L=>t(p,{signal:L}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=w.cancel,v.promise=(async()=>{let L=null,x=null;try{L=await w.promise}catch(g){x=g}L!==Jm&&(l!==v||e.detailId!==p||(l=null,!x&&(L===null||typeof L!="object")&&(x=new Error(`${n} response was empty or invalid`)),x?e.detail===null&&(e.detailError=(x==null?void 0:x.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=L,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function zw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const jw={components:{ToolOutput:Qo},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(null),a=f(!0),i=f("all");let l=!1;const o=W(()=>e.value.filter(R=>R.status==="running").length),r=W(()=>e.value.filter(R=>R.status==="completed").length),c=W(()=>e.value.filter(R=>["failed","timeout","killed"].includes(R.status)).length),d=W(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=W(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(R=>["failed","timeout","killed"].includes(R.status)):e.value.filter(R=>R.status===i.value));function p(R){const H=Number(R.max_iterations)||0;return H<=0?0:Math.min(100,Math.round(R.iteration_count/H*100))}function h(R){return(Number(R.max_iterations)||0)>0}function m(R,H){return R?R==="N/A"?"N/A":H==="current_inheritance"?`inherit (currently ${R})`:R:"unknown"}function v(R){return m(R.display_model,R.display_model_source||R.display_source)}function w(R){return m(R.display_reasoning_effort,R.display_reasoning_effort_source||R.display_source)}function L(R){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[R]||""}const x=f(null),g=f(null),b=f(!1),E=f(null),C=f(""),A=Zm({state:{get detail(){return x.value},set detail(R){x.value=R},get detailId(){return g.value},set detailId(R){g.value=R},get detailLoading(){return b.value},set detailLoading(R){b.value=R},get detailError(){return E.value},set detailError(R){E.value=R}},requestDetail:(R,{signal:H})=>V.get(`/api/agents/${encodeURIComponent(R)}`,{signal:H})});async function y(R){C.value="",await A.open(R.id)}function N(){A.close(),C.value=""}async function F(){await A.refresh()}async function T(R,H){try{await navigator.clipboard.writeText(H||""),C.value=R,setTimeout(()=>{C.value===R&&(C.value="")},1500)}catch{ye.error("Copy failed")}}async function P(R=!1){R=R===!0,R||(t.value=!0);try{const H=await V.get("/api/agents");e.value=Array.isArray(H)?H:[],s.value=null}catch(H){R||(s.value=H.message)}R||(t.value=!1)}async function q(R){const H=e.value.find(J=>J.id===R);if(await qt({title:"Kill agent",message:`Kill agent "${(H==null?void 0:H.label)||R}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=R;try{await V.del(`/api/agents/${encodeURIComponent(R)}`),ye.success("Agent killed"),await P()}catch(J){ye.error(J.message||"Failed to kill agent")}n.value=null}}const G=zw({isEnabled:()=>a.value&&l,refreshList:()=>P(!0),hasOpenDetail:()=>!!g.value,refreshDetail:F});function S(){G.start()}function k(){G.stop()}return Mt(a,()=>G.sync()),je(()=>{l=!0,P(),S()}),Qt(()=>{l=!0,P(!0),S()}),Gt(()=>{l=!1,k()}),ft(()=>{l=!1,k(),A.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:Aa,formatDuration:ui,progressPercent:p,hasProgress:h,displayModelText:v,displayEffortText:w,displaySourceLabel:L,detail:x,detailId:g,detailLoading:b,detailError:E,copied:C,openDetail:y,closeDetail:N,copyText:T,fetchAgents:P,killAgent:q,startAutoRefresh:S,stopAutoRefresh:k}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),h=f("");let m=!1;const w=Zm({state:{get detail(){return c.value},set detail(k){c.value=k},get detailId(){return d.value},set detailId(k){d.value=k},get detailLoading(){return u.value},set detailLoading(k){u.value=k},get detailError(){return p.value},set detailError(k){p.value=k}},detailLabel:"Loop detail",requestDetail:(k,{signal:R})=>V.get(`/api/loops/${encodeURIComponent(k)}?limit=100`,{signal:R})});async function L(k){h.value="",await w.open(k.id)}function x(){w.close(),h.value=""}async function g(k,R){try{await navigator.clipboard.writeText(R||""),h.value=k,setTimeout(()=>{h.value===k&&(h.value="")},1500)}catch{ye.error("Copy failed")}}const b=W(()=>e.value.reduce((k,R)=>k+(R.iteration_count||0),0)),E=W(()=>e.value.filter(k=>k.status==="running").length);function C(k){return k==="running"?"loop-status-running":k==="error"?"loop-status-error":"loop-status-stopped"}function O(k){return k==="running"?"badge-success":k==="error"?"badge-danger":k==="completed"?"badge-info":"badge-warning"}function A(k){return k==="act"?"badge-warning":k==="silent"?"badge-info":"badge-success"}async function y(k=!1){k=k===!0,k||(t.value=!0);try{const R=await V.get("/api/loops");e.value=Array.isArray(R)?R:[],s.value=null}catch(R){k||(s.value=R.message)}k||(t.value=!1)}async function N(){l.value=null;const k=a.value;if(!k.goal.trim()){l.value="Goal is required";return}if(!k.channel_id.trim()){l.value="Channel ID is required";return}const R={goal:k.goal.trim(),channel_id:k.channel_id.trim(),interval_seconds:k.interval_seconds||60,mode:k.mode,max_iterations:k.max_iterations||50};k.stop_condition.trim()&&(R.stop_condition=k.stop_condition.trim()),i.value=!0;try{const H=await V.post("/api/loops",R);ye.success(`Loop started: ${H.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await y()}catch(H){l.value=H.message}i.value=!1}async function F(k){if(await qt({title:"Stop loop",message:`Stop loop ${k}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=k;try{await V.del(`/api/loops/${encodeURIComponent(k)}`),ye.success("Loop stopped"),await y()}catch(H){ye.error(H.message||"Failed to stop loop")}o.value=null}}async function T(k){r.value=k;try{await V.post(`/api/loops/${encodeURIComponent(k)}/restart`),ye.success("Loop restarted"),await y()}catch(R){ye.error(R.message||"Failed to restart loop")}r.value=null}function P(k){m&&k.payload&&(k.payload.loop_id||k.payload.type==="loop")&&(y(!0),d.value&&w.refresh())}let q=null;function G(){q!==null&&clearInterval(q),q=null}function S(){G(),m&&(q=setInterval(()=>{y(!0),d.value&&w.refresh()},5e3))}return je(()=>{m=!0,y(),Ye.subscribe("events",P),S()}),Qt(()=>{m=!0,y(!0),S()}),Gt(()=>{m=!1,G()}),ft(()=>{m=!1,Ye.unsubscribe("events",P),G(),w.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:h,totalIterations:b,runningCount:E,statusDotClass:C,statusBadge:O,modeBadge:A,formatAge:Gm,formatDuration:ui,formatTs:Aa,formatTokens:Wm,openDetail:L,closeDetail:x,copyText:g,fetchLoops:y,doCreate:N,doStop:F,doRestart:T}}},qw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=f(!1),l=f(null),o=f(null),r=W(()=>Jw(a.value.run_at));Mt(()=>a.value.run_at,()=>{o.value=null});const c=W(()=>{var ee;const U=r.value;return U.state==="ok"?U.instant:U.state==="ambiguous"&&o.value!==null&&((ee=U.options[o.value])==null?void 0:ee.instant)||null}),d=W(()=>{const U=c.value;return U?`${U.toLocaleString()} local — ${U.toISOString()} UTC`:""}),u=f(null),p=f(!1),h=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=f(null),v=f(null),w=f(null),L=f(null),x=f(null),g=f(null),b=f([]),E=f(!1),C=f("");let O=0;const A=W(()=>e.value.filter(U=>U.cron&&!U.one_time).length),y=W(()=>e.value.filter(U=>U.one_time).length),N=W(()=>e.value.filter(U=>U.trigger).length),F=W(()=>e.value.filter(U=>U.paused).length),T=W(()=>e.value.filter(U=>U.consecutive_failures>0).length);function P(U){if(!U)return"-";const ee=Date.now(),Ae=(new Date(U).getTime()-ee)/1e3;if(Ae<0)return"overdue";if(Ae<60)return"in < 1 min";if(Ae<3600)return`in ${Math.floor(Ae/60)} min`;if(Ae<86400){const M=Math.floor(Ae/3600),j=Math.floor(Ae%3600/60);return j>0?`in ${M}h ${j}m`:`in ${M}h`}const _=Math.floor(Ae/86400);return`in ${_} day${_!==1?"s":""}`}function q(U){return U==null?"-":U<1e3?`${U}ms`:U<6e4?`${(U/1e3).toFixed(1)}s`:ui(U/1e3)}function G(U=a.value.cron){a.value.cron=U,ap(a.value,"cron"),u.value=null}function S(U=a.value.run_at){a.value.run_at=U,ap(a.value,"run_at"),u.value=null}async function k(){const U=a.value.cron.trim();if(U){p.value=!0;try{u.value=await V.post("/api/schedules/validate-cron",{expression:U})}catch(ee){u.value={valid:!1,error:ee.message}}p.value=!1}}async function R(){t.value=!0,s.value=null;try{e.value=await V.get("/api/schedules")}catch(U){s.value=U.message}t.value=!1}async function H(U){if(g.value===U){g.value=null,b.value=[];return}g.value=U,E.value=!0,b.value=[];const ee=++O;try{const ue=await V.get(`/api/schedules/${encodeURIComponent(U)}/history?limit=10`);if(ee!==O||g.value!==U)return;b.value=ue,C.value=""}catch(ue){if(ee!==O||g.value!==U)return;b.value=[],C.value=ue.message||"Failed to load execution history"}ee===O&&(E.value=!1)}async function Z(){l.value=null;const U=a.value;if(!U.description.trim()){l.value="Description is required";return}if(!U.channel_id.trim()){l.value="Channel ID is required";return}if(!U.cron.trim()&&!U.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(U.cron.trim()&&U.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const ee={description:U.description.trim(),action:U.action,channel_id:U.channel_id.trim()};if(U.cron.trim()&&(ee.cron=U.cron.trim()),U.run_at.trim()){const ue=r.value;if(ue.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(ue.state==="invalid"){l.value="One-time run time is not a valid date";return}const Ae=c.value;if(ue.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Ae){l.value="One-time run time could not be resolved";return}ee.run_at=Ae.toISOString()}if(U.action==="reminder"&&U.message.trim()&&(ee.message=U.message.trim()),U.action==="check"&&(U.tool_name.trim()&&(ee.tool_name=U.tool_name.trim()),U.report_format&&(ee.report_format=U.report_format),U.tool_input_str.trim()))try{ee.tool_input=JSON.parse(U.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await V.post("/api/schedules",ee),ye.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await R()}catch(ue){l.value=ue.message}i.value=!1}async function J(U){m.value=U;try{const ee=await V.post(`/api/schedules/${encodeURIComponent(U)}/run`);if(ee.status==="failure")ye.error(`Execution failed: ${ee.error||"unknown error"}`);else{const ue=ee.warning?`Executed (${ee.warning})`:"Executed successfully";ye.success(ue)}await R()}catch(ee){ye.error(ee.message||"Failed to trigger")}m.value=null}async function Y(U){w.value=U.id;const ee=!U.paused;try{await V.put(`/api/schedules/${encodeURIComponent(U.id)}`,{paused:ee}),ye.success(ee?"Schedule paused":"Schedule resumed"),await R()}catch(ue){ye.error(ue.message||"Failed to update schedule")}w.value=null}const ce=new Map;function te(U,ee){const ue=ce.get(U.id);ue&&clearTimeout(ue.timer);const Ae={run:()=>de(U,ee),timer:null};Ae.timer=setTimeout(()=>{ce.delete(U.id),Ae.run()},500),ce.set(U.id,Ae)}async function de(U,ee){x.value=U.id;try{await V.put(`/api/schedules/${encodeURIComponent(U.id)}`,{report_format:ee}),ye.success(ee?"Structured report enabled":"Plain-text report enabled")}catch(ue){ye.error(`Update failed: ${ue.message}`)}finally{await R(),x.value=null}}function Ne(){for(const[U,ee]of[...ce])clearTimeout(ee.timer),ce.delete(U),ee.run()}async function B(U){L.value=U;try{await V.post(`/api/schedules/${encodeURIComponent(U)}/reset-failures`),ye.success("Failure counters reset"),await R()}catch(ee){ye.error(ee.message||"Failed to reset")}L.value=null}async function ie(U){const ee=e.value.find(Ae=>Ae.id===U);if(await qt({title:"Delete schedule",message:`Delete "${(ee==null?void 0:ee.description)||U}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=U;try{await V.del(`/api/schedules/${encodeURIComponent(U)}`),ye.success("Schedule deleted"),await R()}catch(Ae){ye.error(Ae.message||"Failed to delete schedule")}v.value=null}}return je(()=>{R()}),ft(Ne),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:h,runningId:m,deletingId:v,togglingId:w,resettingId:L,reportUpdatingId:x,flushReportFormatTimers:Ne,expandedId:g,history:b,historyLoading:E,historyError:C,cronCount:A,oneTimeCount:y,webhookCount:N,pausedCount:F,failingCount:T,formatTs:Aa,formatAge:Gm,formatFuture:P,formatMs:q,formatDuration:ui,onCronInput:G,onRunAtInput:S,validateCron:k,toggleExpand:H,fetchSchedules:R,doCreate:Z,doRunNow:J,doTogglePause:Y,doUpdateReportFormat:te,doResetFailures:B,doDelete:ie}}},Ym=[{id:"live",label:"Live",component:Fw},{id:"agents",label:"Agents",component:jw},{id:"loops",label:"Loops",component:Vw},{id:"processes",label:"Processes",component:qw},{id:"schedules",label:"Schedules",component:Zw}],Yw={components:{TabbedPage:Yo},setup(){return{tabs:Ym}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Qw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(null),a=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),h=f("last_active"),m=f(!1),v=ip,w=Xw,L=f([]),x=f(!1),g=f(""),b=f("flat"),E=f(new Set),C=f(""),O=f(""),A=f(""),y=f(null),N=f(!1),F=f(""),T=f(!1);let P=0;Mt([C,O,A],()=>{P++,N.value=!1,F.value="",T.value=y.value!==null},{flush:"sync"});function q(){try{const ae=localStorage.getItem("odin-session-presets");ae&&(L.value=JSON.parse(ae))}catch{}}function G(){try{localStorage.setItem("odin-session-presets",JSON.stringify(L.value))}catch{}}const S=W(()=>p.value.trim()!==""||u.value!=="all"),k=W(()=>{let ae=[...e.value];const Se=ip.find(Ve=>Ve.id===u.value),Le=Se?Se.filters:{};if(Le.source&&(ae=ae.filter(Ve=>Ve.source===Le.source)),Le.minMessages&&(ae=ae.filter(Ve=>Ve.message_count>=Le.minMessages)),Le.hasCompaction&&(ae=ae.filter(Ve=>Ve.has_summary)),Le.maxAge!=null){const Ve=Date.now()/1e3;ae=ae.filter($t=>$t.last_active&&Ve-$t.last_active<=Le.maxAge)}if(p.value.trim()){const Ve=p.value.toLowerCase().trim();ae=ae.filter($t=>($t.channel_id||"").toLowerCase().includes(Ve)||($t.last_user_id||"").toLowerCase().includes(Ve)||($t.source||"").toLowerCase().includes(Ve))}const Ke=h.value,Et=m.value?1:-1;return ae.sort((Ve,$t)=>{const zt=Ve[Ke]||0,rs=$t[Ke]||0;return(zt-rs)*Et}),ae}),R=W(()=>{if(!a.value||!a.value.messages)return[];const ae=a.value.messages;if(ae.length===0)return[];const Se=[];let Le=[];for(const Ke of ae)Ke.role==="user"&&Le.length>0&&(Se.push(Le),Le=[]),Le.push(Ke);return Le.length>0&&Se.push(Le),Se}),H=W(()=>k.value.length>0&&c.value.size===k.value.length);function Z(ae){const Se=ae.find(Le=>Le.role==="user");if(Se&&Se.content){const Le=Se.content.slice(0,120);return Le.length<Se.content.length?Le+"...":Le}return"(no user message)"}function J(ae){const Se=new Set(E.value);Se.has(ae)?Se.delete(ae):Se.add(ae),E.value=Se}function Y(ae){u.value=ae}function ce(ae){u.value=ae.id,ae.filters.searchQuery!=null&&(p.value=ae.filters.searchQuery),ae.filters.sortBy&&(h.value=ae.filters.sortBy)}function te(){if(!g.value.trim())return;const ae={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:h.value}};L.value=[...L.value,ae],G(),x.value=!1,g.value=""}function de(ae){L.value=L.value.filter(Se=>Se.id!==ae),G(),u.value===ae&&(u.value="all")}function Ne(){u.value="all",p.value="",h.value="last_active",m.value=!1}function B(ae){if(!ae)return"—";const Se=Date.now()/1e3-ae;if(Se<60)return"just now";if(Se<3600){const Ke=Math.floor(Se/60);return`${Ke} minute${Ke!==1?"s":""} ago`}if(Se<86400){const Ke=Math.floor(Se/3600);return`${Ke} hour${Ke!==1?"s":""} ago`}const Le=Math.floor(Se/86400);return`${Le} day${Le!==1?"s":""} ago`}function ie(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function U(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString()}catch{return""}}function ee(ae){return ae==="user"?"bg-gray-900/50 border border-gray-800":ae==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ue(ae){return ae==="user"?"sess-msg-user":ae==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Ae(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":"badge-warning"}function _(ae){return ae==="user"?"sess-dot-user":ae==="assistant"?"sess-dot-assistant":"sess-dot-system"}function M(ae){return ae==="user"?"text-cyan-400":ae==="assistant"?"text-indigo-400":"text-gray-500"}function j(ae){return ae?ae.length>2e3?ae.slice(0,2e3)+`
... (truncated)`:ae:""}async function oe(){const ae=C.value.trim();if(!ae)return;const Se=++P;N.value=!0,F.value="",T.value=y.value!==null;try{let Le=`/api/sessions/search?q=${encodeURIComponent(ae)}&limit=50`;O.value.trim()&&(Le+=`&channel_id=${encodeURIComponent(O.value.trim())}`),A.value.trim()&&(Le+=`&user_id=${encodeURIComponent(A.value.trim())}`);const Ke=await V.get(Le);if(Se!==P)return;y.value=Ke.results||[],T.value=!1}catch(Le){if(Se!==P)return;F.value=Le.message||"Search failed. Please retry."}finally{Se===P&&(N.value=!1)}}function ne(){P++,C.value="",O.value="",A.value="",y.value=null,F.value="",T.value=!1,N.value=!1}function le(ae){return ae?ae.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function he(ae){return ae==="user"?"fts-result-user":ae==="assistant"?"fts-result-assistant":ae==="summary"?"fts-result-summary":ae==="fts"?"fts-result-fts":ae==="channel"?"fts-result-channel":"fts-result-default"}function fe(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":ae==="summary"?"badge-warning":ae==="fts"?"badge-success":"badge-info"}let pe=0;async function re(){const ae=++pe;t.value=!0,s.value=null;try{const Se=await V.get("/api/sessions");if(ae!==pe)return;e.value=Se}catch(Se){if(ae!==pe)return;s.value=Se.message}ae===pe&&(t.value=!1)}function xe(){s.value=null,re()}async function ve(ae){if(n.value===ae){n.value=null,a.value=null,E.value=new Set;return}n.value=ae,a.value=null,i.value=!0,E.value=new Set;const Se=++l;try{const Le=await V.get(`/api/sessions/${encodeURIComponent(ae)}`);Se===l&&n.value===ae&&(a.value=Le)}catch(Le){Se===l&&n.value===ae&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{Se===l&&(i.value=!1)}}function _e(ae){const Se=new Set(c.value);Se.has(ae)?Se.delete(ae):Se.add(ae),c.value=Se}function Ie(){H.value?c.value=new Set:c.value=new Set(k.value.map(ae=>ae.channel_id))}function $(ae){o.value=ae}async function ge(){if(o.value){r.value=!0;try{await V.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await re()}catch(ae){s.value=ae.message||"Failed to clear session"}r.value=!1,o.value=null}}function ke(){d.value=!0}async function Oe(){if(c.value.size!==0){r.value=!0;try{await V.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await re()}catch(ae){s.value=ae.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Me(ae,Se){const Le=`/api/sessions/${encodeURIComponent(ae)}/export?format=${Se}`;try{const Ke=await V.getBlob(Le),Et=URL.createObjectURL(Ke),Ve=document.createElement("a");Ve.href=Et,Ve.download=`session-${ae}.${Se==="text"?"txt":"json"}`,Ve.click(),URL.revokeObjectURL(Et)}catch(Ke){s.value=Ke.message||"Failed to export session"}}let dt=null;function st(ae){ae.payload&&ae.payload.channel_id&&(clearTimeout(dt),dt=setTimeout(()=>{if(re(),n.value&&ae.payload.channel_id===n.value){const Se=n.value,Le=l;V.get(`/api/sessions/${encodeURIComponent(Se)}`).then(Ke=>{Le!==l||n.value!==Se||(a.value=Ke)}).catch(()=>{})}},2e3))}let _t=!1,Ot=null;function rt(){_t||(_t=!0,re(),Ye.subscribe("events",st),Ot=Ye.onReconnected(()=>re()))}je(()=>{q(),rt()}),Qt(()=>{rt()});function Qe(){_t&&(_t=!1,Ye.unsubscribe("events",st),Ot&&(Ot(),Ot=null),clearTimeout(dt))}return Gt(Qe),ft(Qe),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:H,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:h,sortAsc:m,filterPresets:v,sortOptions:w,filteredSessions:k,hasActiveFilters:S,customPresets:L,showSavePreset:x,newPresetName:g,threadView:b,threads:R,collapsedThreads:E,ftsQuery:C,ftsChannelId:O,ftsUserId:A,ftsResults:y,ftsSearching:N,ftsError:F,ftsStale:T,formatAge:B,formatTimestamp:ie,formatFullTimestamp:U,messageClass:ee,threadMsgClass:ue,roleBadge:Ae,roleDotClass:_,roleLabelClass:M,truncateContent:j,threadSummary:Z,fetchSessions:re,retry:xe,toggleSession:ve,toggleSelect:_e,toggleSelectAll:Ie,confirmClear:$,clearSession:ge,confirmBulkClear:ke,doBulkClear:Oe,exportSession:Me,applyPreset:Y,applyCustomPreset:ce,saveCustomPreset:te,removeCustomPreset:de,resetFilters:Ne,toggleThread:J,runFtsSearch:oe,clearFtsSearch:ne,highlightSnippet:le,ftsResultClass:he,ftsTypeBadge:fe}}},tk={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:Wm}}},sk={components:{ContextAssemblyPanel:tk},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),n=f(null),a=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(O){if(!O)return"—";try{const A=new Date(O);return isNaN(A.getTime())?O:A.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return O}}function p(O){return!O&&O!==0?"—":O<1e3?O+"ms":(O/1e3).toFixed(1)+"s"}function h(O){return!O&&O!==0?"—":O>=1e3?(O/1e3).toFixed(1)+"k":String(O)}function m(O){if(!O)return"";if(typeof O=="string")return O;try{return JSON.stringify(O,null,2)}catch{return String(O)}}function v(O){a.value===O?a.value=null:(a.value=O,c.value={})}function w(O,A){const y=O+"-"+A;c.value={...c.value,[y]:!c.value[y]}}function L(O,A){return!!c.value[O+"-"+A]}function x(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,E()}async function g(){try{const O=await V.get("/api/trajectories");e.value=O.files||[],r.value=O.count||0}catch{}}let b=0;async function E(){const O=++b;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(o.value){const A=await V.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(O!==b)return;let y=A.entries||[];d.value.tool_name&&(y=y.filter(N=>(N.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(y=y.filter(N=>N.is_error)),d.value.channel_id&&(y=y.filter(N=>N.channel_id===d.value.channel_id)),d.value.user_id&&(y=y.filter(N=>N.user_id===d.value.user_id)),t.value=y}else{const A=new URLSearchParams;d.value.channel_id&&A.set("channel_id",d.value.channel_id),d.value.user_id&&A.set("user_id",d.value.user_id),d.value.tool_name&&A.set("tool_name",d.value.tool_name),d.value.errors_only&&A.set("errors_only","true"),A.set("limit",String(d.value.limit));const y=A.toString(),N=await V.get(`/api/trajectories/search/query?${y}`);if(O!==b)return;t.value=N.results||[]}}catch(A){if(O!==b)return;n.value=A.message}O===b&&(s.value=!1)}async function C(){if(!l.value.trim())return;const O=++b;s.value=!0,n.value=null,c.value={};try{const A=await V.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(O!==b)return;i.value=A.entry||null,i.value||(n.value="No trace found for this message ID")}catch(A){if(O!==b)return;A.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=A.message}O===b&&(s.value=!1)}return je(async()=>{await g(),await E()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:h,formatJSON:m,truncateBlock:Km,toggleExpand:v,toggleIteration:w,isIterationExpanded:L,clearFilters:x,fetchFiles:g,fetchTraces:E,lookupMessage:C}}};function nk(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function ak(e){return e?`${e.approximate?"~":""}${bd(e.total||0)}`:"0"}const ik={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=W(()=>n.value.work||{}),h=W(()=>Math.max(1,...(n.value.activity_over_time||[]).map(C=>Number(C.count||0)))),m=W(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),v=C=>({height:`${Math.max(4,Math.round(Number(C||0)/h.value*100))}%`}),w=W(()=>s.value&&l.value-i.value>3e4);async function L(){const C=++d,O=a.value;try{const A=await V.get(`/api/usage?range=${encodeURIComponent(O)}`);if(C!==d||O!==a.value)return;n.value=A,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(A){C===d&&(t.value=A.message)}finally{C===d&&(e.value=!1)}}function x(C){a.value=C,e.value=!s.value,L()}function g(){e.value=!0,L()}function b(){c||(c=!0,L(),o=setInterval(L,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function E(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return je(b),Qt(b),Gt(E),ft(E),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:w,fmtNum:bd,fmtDuration:nk,tokenLabel:ak,activityTrackStyle:m,activityBar:v,selectRange:x,retry:g}}},Qm=[{id:"audit",label:"Audit",component:Qw},{id:"sessions",label:"Sessions",component:ek},{id:"traces",label:"Traces",component:sk},{id:"usage",label:"Usage & Activity",component:ik}],lk={components:{TabbedPage:Yo},setup(){return{tabs:Qm}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},xr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],ok={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(y){return y.source!=="builtin"?"":u[y.state]||""}function h(y,N){const F=y&&Array.isArray(y.tools)?y.tools:null;if(c.value=!!F,r.value=F?!!y.global_enabled:null,!F){e.value=N.map(q=>({...q,source:"unknown",enabled:void 0,state:null}));return}const T=new Set(F.map(q=>q.name)),P=N.filter(q=>!T.has(q.name)).map(q=>({...q,source:q.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...F.map(q=>({...q,source:"builtin"})),...P]}async function m(y,N){if(d.value.has(y.name))return;const F=!!N.target.checked,T=new Set(d.value);T.add(y.name),d.value=T;try{const P=await V.post(`/api/tools/builtins/${encodeURIComponent(y.name)}/enabled`,{enabled:F});h(P,e.value),s.value=null;try{const q=await V.get("/api/tools");h(P,q)}catch(q){console.warn("Built-in toggle committed; visible catalog refresh failed",q)}}catch(P){N.target.checked=!!y.enabled,s.value=P.message||`Failed to toggle ${y.name}`}finally{const P=new Set(d.value);P.delete(y.name),d.value=P}}const v=W(()=>e.value.filter(y=>y.source==="builtin"&&y.is_core).length),w=W(()=>e.value.filter(y=>y.source==="skill").length),L=W(()=>Object.values(a.value).reduce((y,N)=>y+N,0));function x(y){for(const N of xr)if(N.id!=="other"&&N.match(y))return N.id;return"other"}const g=W(()=>{let y=e.value;if(n.value){const N=n.value.toLowerCase();y=y.filter(F=>F.name.toLowerCase().includes(N)||(F.description||"").toLowerCase().includes(N))}return o.value&&(y=y.filter(N=>x(N.name)===o.value)),y}),b=W(()=>{const y=new Set;for(const N of e.value)y.add(x(N.name));return xr.filter(N=>y.has(N.id))}),E=W(()=>{const y=g.value,N={};for(const T of y){const P=x(T.name);N[P]||(N[P]=[]),N[P].push(T)}const F=[];for(const T of xr)N[T.id]&&N[T.id].length>0&&F.push({label:T.label,icon:T.icon,tools:N[T.id].sort((P,q)=>P.name.localeCompare(q.name))});return F});function C(y){i.value={...i.value,[y]:!i.value[y]}}async function O(){t.value=!0,s.value=null;try{const[y,N,F]=await Promise.all([V.get("/api/tools"),V.get("/api/tools/stats").catch(()=>({})),V.get("/api/tools/builtins").catch(()=>null)]);h(F,y),a.value=N||{}}catch(y){s.value=y.message}t.value=!1}function A(){O()}return je(()=>{O()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:w,totalUsage:L,filteredTools:g,groupedTools:E,usedCategories:b,stateBadge:p,applyInventory:h,toggleBuiltinTool:m,truncate:gd,toggleExpand:C,refresh:A}}};function rk(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function ck(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function F(te){return ck(te)}function T(te){n.value={...n.value,[te]:!n.value[te]}}async function P(te){try{await navigator.clipboard.writeText(te);const de=e.value.find(Ne=>Ne.code===te);de&&(o.value=de.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function q(te){if(te.key==="Tab"){te.preventDefault();const de=te.target,Ne=de.selectionStart,B=de.selectionEnd;u.value=u.value.substring(0,Ne)+"    "+u.value.substring(B),Rt(()=>{de.selectionStart=de.selectionEnd=Ne+4})}}function G(te){const de=te.target.previousElementSibling;de&&(de.scrollTop=te.target.scrollTop)}async function S(){t.value=!0,s.value=null;try{e.value=await V.get("/api/skills")}catch(te){s.value=te.message}t.value=!1}async function k(te){i.value=te,delete a.value[te],a.value={...a.value};try{const de=await V.post(`/api/skills/${encodeURIComponent(te)}/test`);a.value={...a.value,[te]:de}}catch(de){a.value={...a.value,[te]:{result:de.message,is_error:!0}}}i.value=null}function R(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,h.value=null}function H(te){r.value=!0,c.value="edit",d.value=te.name,u.value=te.code||"",p.value=null,h.value=null}function Z(){r.value=!1,p.value=null,h.value=null}async function J(){p.value=null,h.value=null;const te=d.value.trim(),de=u.value.trim();if(!te){p.value="Name is required";return}if(!de){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await V.post("/api/skills",{name:te,code:de}),h.value="Skill created successfully"):(await V.put(`/api/skills/${encodeURIComponent(te)}`,{code:de}),h.value="Skill updated successfully"),await S(),setTimeout(()=>{r.value=!1},800)}catch(Ne){p.value=Ne.message}m.value=!1}function Y(te){w.value=te}async function ce(){if(w.value){L.value=!0;try{await V.del(`/api/skills/${encodeURIComponent(w.value)}`),await S()}catch(te){ye.error(`Failed to delete skill: ${te.message||"unknown error"}`)}L.value=!1,w.value=null}}return je(()=>{S()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:h,saving:m,editorRef:v,deleteTarget:w,deleting:L,enabledCount:x,totalExecutions:g,totalLines:b,displayedSkills:E,editLineCount:C,editorLineNums:O,editValidation:A,highlight:y,truncate:gd,formatTs:Aa,countLines:N,getLineNumbers:F,toggleCode:T,copyCode:P,handleEditorKey:q,syncScroll:G,fetchSkills:S,testSkill:k,showCreate:R,editSkill:H,cancelEdit:Z,saveSkill:J,confirmDelete:Y,doDelete:ce}}};class Fs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const uk=/^[A-Za-z_][A-Za-z0-9_]*$/;function lp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function op(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Fs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Fs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Fs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Fs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function pk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function fk(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Fs("Server name is required.","name");if(a.length>128||!uk.test(a))throw new Fs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Fs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=lp(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Fs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Fs("An HTTP endpoint is required for this connection.","url");if(d&&!pk(d))throw new Fs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Fs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=lp(e.allowlistText));const r=op(e.headerRows,e.headersRemove,"Header"),c=op(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function hk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function mk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function vk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const gk=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function bk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const yk=1e4,xk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function _r(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function _k(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const wk={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),n=f(""),a=f(new Set),i=f(new Set),l=f({}),o=f({}),r=f({}),c=f(new Set),d=f(!1),u=f("add"),p=f(""),h=f(null),m=f(_r()),v=f(""),w=f(!1);let L=null,x=0,g=!1,b=!1;const E=gk,C=W(()=>{var $;return(($=e.value)==null?void 0:$.servers)||[]}),O=W(()=>{var $;return!!(($=e.value)!=null&&$.enabled)}),A=W(()=>{var $,ge,ke,Oe;return{serverCount:(($=e.value)==null?void 0:$.server_count)||0,enabledCount:((ge=e.value)==null?void 0:ge.enabled_server_count)||0,connectedCount:((ke=e.value)==null?void 0:ke.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),y=W(()=>{var $;return(($=h.value)==null?void 0:$.header_keys)||[]}),N=W(()=>{var $;return(($=h.value)==null?void 0:$.env_keys)||[]}),F=W(()=>{var $;return u.value==="edit"&&(($=h.value)==null?void 0:$.transport)==="http"}),T=W(()=>u.value==="add"||!F.value),P=W(()=>F.value?"Replace endpoint URL":"Endpoint URL"),q=W(()=>F.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function G(){S(),L=window.setInterval(()=>k({quiet:!0}),yk)}function S(){L&&window.clearInterval(L),L=null}async function k({quiet:$=!1}={}){const ge=++x;$||(t.value=!0);try{const ke=await V.get("/api/mcp/status");if(ge!==x||!g)return;e.value=ke,n.value="";const Oe=new Set((ke.servers||[]).map(Me=>Me.name));i.value=new Set([...i.value].filter(Me=>Oe.has(Me)))}catch(ke){ge===x&&g&&(n.value=ke.message||"Failed to load MCP status")}finally{ge===x&&(t.value=!1)}}function R($){return s.value||a.value.has($)}function H($,ge){const ke=new Set(a.value);ge?ke.add($):ke.delete($),a.value=ke}function Z($){return mk($.state)}function J($){if(Z($)==="disabled"){if(!$.enabled)return"Disabled — server switch off";if(!O.value)return"Disabled — global MCP is off"}return xk[Z($)]}function Y($){return $.transport==="http"?"Streamable HTTP":"stdio"}function ce($){return $.negotiated_version?`${$.era?`${String($.era).charAt(0).toUpperCase()}${String($.era).slice(1)}`:"Protocol"} · ${$.negotiated_version}`:"Not negotiated"}function te($){return $.discovered_count?`${$.published_count||0} published · ${$.excluded_count||0} excluded`:"No tools discovered"}const de=f(new Set);async function Ne($,ge){if(de.value.has($.name))return;const ke=!!ge.target.checked,Oe=new Set(de.value);Oe.add($.name),de.value=Oe;try{const Me=await V.post(`/api/mcp/servers/${encodeURIComponent($.name)}/enabled`,{enabled:ke});Me&&Array.isArray(Me.servers)?e.value=Me:await k({quiet:!0})}catch(Me){ge.target.checked=!!$.enabled,ye.error(Me.message||`Failed to toggle ${$.name}`)}finally{const Me=new Set(de.value);Me.delete($.name),de.value=Me}}async function B($){if($!==O.value&&!(!$&&!await qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await V.post("/api/mcp/enabled",{enabled:$}),ye.success($?"MCP enabled":"MCP disabled"),await k({quiet:!0})}catch(ge){ye.error(ge.message||"Failed to update MCP state"),await k({quiet:!0})}finally{s.value=!1}}}async function ie($){H($.name,!0);try{await V.post(`/api/mcp/servers/${encodeURIComponent($.name)}/reconnect`,{}),ye.success(`Reconnected ${$.name}`)}catch(ge){ye.error(ge.message||`Failed to reconnect ${$.name}`)}finally{H($.name,!1),await k({quiet:!0})}}async function U($){H($.name,!0);try{await V.post(`/api/mcp/servers/${encodeURIComponent($.name)}/refresh-tools`,{}),ye.success(`Refreshed tools from ${$.name}`),await Ae($.name,!0)}catch(ge){ye.error(ge.message||`Failed to refresh ${$.name}`)}finally{H($.name,!1),await k({quiet:!0})}}async function ee($){if(await qt({title:`Remove ${$.name}`,message:`Remove this saved MCP server? Its ${$.published_count||0} published tool${$.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){H($.name,!0);try{await V.del(`/api/mcp/servers/${encodeURIComponent($.name)}`),ye.success(`Removed ${$.name}`),delete o.value[$.name]}catch(ke){ye.error(ke.message||`Failed to remove ${$.name}`)}finally{H($.name,!1),await k({quiet:!0})}}}async function ue($){const ge=new Set(i.value);if(ge.has($.name)){ge.delete($.name),i.value=ge;return}ge.add($.name),i.value=ge,Object.hasOwn(o.value,$.name)||await Ae($.name)}async function Ae($,ge=!1){if(!ge&&Object.hasOwn(o.value,$))return;const ke=new Set(c.value);ke.add($),c.value=ke,r.value={...r.value,[$]:""};try{const Oe=await V.get(`/api/mcp/servers/${encodeURIComponent($)}/tools`);o.value={...o.value,[$]:Oe.tools||[]}}catch(Oe){r.value={...r.value,[$]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(c.value);Oe.delete($),c.value=Oe}}function _($){return(o.value[$]||[]).filter(ge=>vk(ge,l.value[$]))}function M($,ge){l.value={...l.value,[$]:ge}}function j(){u.value="add",p.value="",h.value=null,m.value=_r(),v.value="",d.value=!0}function oe($){u.value="edit",p.value=$.name,h.value=$,m.value={..._r(),name:$.name,enabled:!!$.enabled,transport:$.transport||"stdio"},v.value="",d.value=!0}function ne(){w.value||(d.value=!1)}function le($){d.value&&bk($)}function he($){const ge=$==="headers"?"headerRows":"envRows";m.value[ge].push({key:"",value:""})}function fe($,ge){const ke=$==="headers"?"headerRows":"envRows";m.value[ke].splice(ge,1)}function pe($,ge){const ke=$==="headers"?"headersRemove":"envRemove",Oe=m.value[ke];m.value[ke]=Oe.includes(ge)?Oe.filter(Me=>Me!==ge):[...Oe,ge]}async function re(){var ge,ke;v.value="";let $;try{$=fk(m.value,{mode:u.value,originalTransport:((ge=h.value)==null?void 0:ge.transport)||""})}catch(Oe){v.value=Oe instanceof Fs?Oe.message:"Invalid MCP server configuration",await Rt(),(ke=document.querySelector(".mcp-editor"))==null||ke.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&hk($,h.value)&&!await qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){w.value=!0;try{u.value==="add"?await V.post("/api/mcp/servers",$):await V.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,$),ye.success(u.value==="add"?`Saved ${$.name}`:`Updated ${p.value}`),d.value=!1,await k({quiet:!0})}catch(Oe){v.value=Oe.message||"Failed to save MCP server"}finally{w.value=!1}}}let xe=null;function ve($){`${($==null?void 0:$.event)||""} ${($==null?void 0:$.type)||""} ${($==null?void 0:$.tool)||""} ${($==null?void 0:$.message)||""}`.toLowerCase().includes("mcp")&&(xe&&window.clearTimeout(xe),xe=window.setTimeout(()=>k({quiet:!0}),200))}function _e(){g||(g=!0,b||(Ye.subscribe("events",ve),b=!0),k(),G())}function Ie(){g=!1,S(),xe&&window.clearTimeout(xe),xe=null,b&&(Ye.unsubscribe("events",ve),b=!1)}return je(_e),Qt(_e),Gt(Ie),ft(Ie),{status:e,loading:t,mutating:s,pageError:n,servers:C,masterEnabled:O,aggregate:A,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:h,form:m,formError:v,saving:w,editorGroups:E,configuredHeaderKeys:y,configuredEnvKeys:N,savedHttpEndpoint:F,endpointRequired:T,endpointFieldLabel:P,endpointPlaceholder:q,refreshAll:k,busy:R,serverState:Z,stateLabel:J,transportLabel:Y,protocolLabel:ce,toolSummary:te,formatAge:_k,setMasterEnabled:B,togglePending:de,toggleServerEnabled:Ne,reconnect:ie,refreshTools:U,removeServer:ee,toggleTools:ue,filteredTools:_,setToolQuery:M,openAdd:j,openEdit:oe,closeEditor:ne,jumpToEditorGroup:le,addSecretRow:he,removeSecretRow:fe,toggleSecretRemoval:pe,saveServer:re}}};function kk(e,t){if(!e||!t)return np(e);const s=np(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),h=f(!1),m=f(null),v=f(null);let w=null;const L=f(null),x=f(!1),g=f({}),b=f({}),E=f({}),C=f({}),O=new Map,A=f(null),y=W(()=>e.value.reduce((J,Y)=>J+(Y.chunks||0),0)),N=W(()=>new Set(e.value.map(Y=>Y.uploader).filter(Boolean)).size);function F(J,Y){const ce=b.value[Y];if(!ce||ce.length===0)return 0;const te=Math.max(...ce.map(de=>de.char_count||0));return te===0?0:Math.round(J.char_count/te*100)}async function T(){t.value=!0,s.value=null;try{const J=await V.get("/api/knowledge");e.value=Array.isArray(J)?J:[]}catch(J){s.value=J.message}t.value=!1}async function P(J){if(g.value[J]){g.value[J]=!1,A.value=null;return}if(g.value[J]=!0,Object.prototype.hasOwnProperty.call(b.value,J))return;if(O.has(J))return O.get(J);const Y={...C.value,[J]:!0};C.value=Y;const ce={...E.value};delete ce[J],E.value=ce;const te=V.get(`/api/knowledge/${encodeURIComponent(J)}/chunks`).then(de=>{b.value={...b.value,[J]:Array.isArray(de)?de:[]}}).catch(de=>{E.value={...E.value,[J]:de.message||"load failed"}}).finally(()=>{if(O.get(J)!==te)return;O.delete(J);const de={...C.value};delete de[J],C.value=de});return O.set(J,te),te}let q=0;async function G(){const J=n.value.trim();if(!J)return;const Y=++q;i.value=!0,o.value=null,l.value=J;try{const ce=await V.get(`/api/knowledge/search?q=${encodeURIComponent(J)}`);if(Y!==q)return;a.value=Array.isArray(ce)?ce:[]}catch(ce){if(Y!==q)return;a.value=[],o.value=ce.message||"Search failed"}Y===q&&(i.value=!1)}function S(){q+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function k(){u.value=null,p.value=null;const J=c.value.trim(),Y=d.value.trim();if(!J){u.value="Source name is required";return}if(!Y){u.value="Content is required";return}h.value=!0;try{const ce=await V.post("/api/knowledge",{source:J,content:Y});p.value=`Ingested ${ce.chunks||0} chunks from "${J}"`,c.value="",d.value="",b.value={},await T(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(ce){u.value=ce.message}h.value=!1}async function R(J){m.value=J,v.value=null,w&&(clearTimeout(w),w=null);try{const Y=await V.post(`/api/knowledge/${encodeURIComponent(J)}/reingest`);v.value={source:J,error:!1,message:`Re-ingested ${Y.chunks||0} chunks`},delete b.value[J],await T(),w=setTimeout(()=>{v.value=null,w=null},3e3)}catch(Y){v.value={source:J,error:!0,message:Y.message}}m.value=null}function H(J){L.value=J}async function Z(){if(L.value){x.value=!0;try{await V.del(`/api/knowledge/${encodeURIComponent(L.value)}`),delete b.value[L.value],await T()}catch(J){ye.error(`Failed to delete source: ${J.message||"unknown error"}`)}x.value=!1,L.value=null}}return je(()=>{T()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:h,reingesting:m,reingestResult:v,deleteTarget:L,deleting:x,expanded:g,sourceChunks:b,chunkErrors:E,loadingChunks:C,selectedChunk:A,totalChunks:y,uploaderCount:N,truncate:gd,formatTs:Aa,highlightTerms:kk,chunkBarWidth:F,fetchSources:T,toggleSource:P,doSearch:G,clearSearch:S,doIngest:k,doReingest:R,confirmDelete:H,doDelete:Z}}},Tk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),n=f(null),a=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),h=f(""),m=f(!1),v=f(null),w=f(null),L=f(new Set),x=f(null),g=f(!1),b=f(!1),E=W(()=>e.value.reduce((Y,ce)=>Y+ce.count,0)),C=W(()=>L.value.size);function O(Y){const ce=t.value[Y];if(!ce)return[];if(!l.value.trim())return ce;const te=l.value.trim().toLowerCase();return ce.filter(de=>de.key.toLowerCase().includes(te)||de.value&&de.value.toLowerCase().includes(te))}function A(Y,ce){return L.value.has(Y+"/"+ce)}function y(Y,ce){const te=Y+"/"+ce,de=new Set(L.value);de.has(te)?de.delete(te):de.add(te),L.value=de}function N(Y){const ce=t.value[Y];return!ce||ce.length===0?!1:ce.every(te=>L.value.has(Y+"/"+te.key))}function F(Y,ce){const te=t.value[Y];if(!te)return;const de=new Set(L.value);for(const Ne of te){const B=Y+"/"+Ne.key;ce?de.add(B):de.delete(B)}L.value=de}async function T(){s.value=!0,n.value=null;try{const Y=await V.get("/api/memory");e.value=Object.entries(Y).map(([ce,te])=>({name:ce,keys:te.keys||[],count:te.count||0}))}catch(Y){n.value=Y.message}s.value=!1}async function P(Y){if(a.value[Y]){a.value[Y]=!1;return}a.value[Y]=!0;const ce=e.value.find(de=>de.name===Y);if(!ce||t.value[Y]||i.value===Y)return;i.value=Y;let te;try{const Ne=(await V.get(`/api/memory/${encodeURIComponent(Y)}`)).entries||{};te=ce.keys.map(B=>Object.prototype.hasOwnProperty.call(Ne,B)?{key:B,value:Ne[B]||"",failed:!1}:{key:B,value:"",failed:!0,error:"Not found in scope"})}catch(de){te=ce.keys.map(Ne=>({key:Ne,value:"",failed:!0,error:de.message||"Failed to load"}))}t.value[Y]=te,i.value=null}function q(Y,ce,te){p.value=Y+"/"+ce,h.value=te}async function G(Y,ce){m.value=!0,v.value=null;try{await V.put(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(ce)}`,{value:h.value});const te=t.value[Y];if(te){const de=te.find(Ne=>Ne.key===ce);de&&(de.value=h.value)}p.value=null}catch(te){v.value=`Failed to save: ${te.message||"unknown error"}`}m.value=!1}async function S(Y,ce){try{await navigator.clipboard.writeText(ce.value),w.value=Y+"/"+ce.key,setTimeout(()=>{w.value=null},1500)}catch{}}async function k(){d.value=null,u.value=null;const Y=r.value.scope.trim(),ce=r.value.key.trim(),te=r.value.value.trim();if(!Y){d.value="Scope is required";return}if(!ce){d.value="Key is required";return}if(!te){d.value="Value is required";return}c.value=!0;try{await V.put(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(ce)}`,{value:te}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await T(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(de){d.value=de.message}c.value=!1}function R(Y,ce){x.value={scope:Y,key:ce}}async function H(){if(!x.value)return;g.value=!0,v.value=null;const{scope:Y,key:ce}=x.value;try{await V.del(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(ce)}`);const te=t.value[Y];te&&(t.value[Y]=te.filter(B=>B.key!==ce));const de=e.value.find(B=>B.name===Y);de&&(de.count--,de.keys=de.keys.filter(B=>B!==ce));const Ne=new Set(L.value);Ne.delete(Y+"/"+ce),L.value=Ne}catch(te){v.value=`Failed to delete: ${te.message||"unknown error"}`}g.value=!1,x.value=null}function Z(){b.value=!0}async function J(){g.value=!0,v.value=null;const Y=[];for(const ce of L.value){const te=ce.indexOf("/");Y.push({scope:ce.slice(0,te),key:ce.slice(te+1)})}try{await V.post("/api/memory/bulk-delete",{entries:Y}),L.value=new Set,t.value={},await T()}catch(ce){v.value=`Bulk delete failed: ${ce.message||"unknown error"}`}g.value=!1,b.value=!1}return je(()=>{T()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:h,saving:m,actionError:v,copied:w,selected:L,selectedCount:C,totalEntries:E,deleteTarget:x,deleting:g,showBulkDelete:b,fetchMemory:T,toggleScope:P,startEdit:q,doEdit:G,copyValue:S,doAdd:k,confirmDelete:R,doDelete:H,confirmBulkDelete:Z,doBulkDelete:J,isSelected:A,toggleSelect:y,isScopeAllSelected:N,toggleSelectAll:F,filteredEntries:O}}},Ck={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const we=new Blob([X],{type:"text/plain"}),$e=URL.createObjectURL(we),Je=document.createElement("a");Je.href=$e,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL($e)}function fe(X){const we=rp(X);navigator.clipboard.writeText(we).then(()=>{m.value=X.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function pe(X){l.value=l.value===X?"":X,g.value="all"}function re(X){return X.level==="ERROR"?"log-line-error":X.level==="WARNING"?"log-line-warning":"text-gray-300"}function xe(X){return X==="ERROR"?"text-red-500 font-semibold":X==="WARNING"?"text-yellow-500":"text-blue-500"}function ve(X){return X==="ERROR"?"log-chip-error":X==="WARNING"?"log-chip-warning":"log-chip-info"}function _e(X){g.value=X.id;const we=X.filters;l.value=we.level||"",b.value=we.timeRange||"",o.value=we.text||"",we.levels&&(l.value=we.levels[0]||""),we.hasToolName&&(o.value="")}function Ie(X){g.value=X.id,l.value=X.filters.level||"",b.value=X.filters.timeRange||"",o.value=X.filters.text||""}function $(){if(!O.value.trim())return;const X={id:"custom-"+Date.now(),name:O.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};E.value=[...E.value,X],N(),C.value=!1,O.value=""}function ge(X){E.value=E.value.filter(we=>we.id!==X),N(),g.value===X&&(g.value="all")}const ke=f("all"),Oe=f(""),Me=f(""),dt=f(""),st=f(""),_t=f(""),Ot=f(100),rt=jk,Qe=f(!1),ae=f(!1),Se=f(""),Le=f([]),Ke=f(null),Et=f(null);function Ve(){e.value="search",Ke.value||$t()}async function $t(){try{Ke.value=await V.get("/api/logs/stats")}catch{}}function zt(){const X=_t.value;if(!X){dt.value="",st.value="";return}const $e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[X];if($e){const Je=new Date(Date.now()-$e*1e3);dt.value=rs(Je),st.value=""}}function rs(X){const we=$e=>String($e).padStart(2,"0");return`${X.getFullYear()}-${we(X.getMonth()+1)}-${we(X.getDate())}T${we(X.getHours())}:${we(X.getMinutes())}`}function Js(X){if(!X)return"";const we=new Date(X);return isNaN(we.getTime())?"":we.toISOString()}async function ks(){Qe.value=!0,Se.value="",ae.value=!0,Et.value=null;try{const X=new URLSearchParams;ke.value&&ke.value!=="all"&&X.set("level",ke.value),Oe.value&&X.set("tool",Oe.value),Me.value&&X.set("q",Me.value);const we=Js(dt.value),$e=Js(st.value);we&&X.set("start",we),$e&&X.set("end",$e),X.set("limit",String(Ot.value));const Je=await V.get(`/api/logs/search?${X.toString()}`);Le.value=Je.entries||[]}catch(X){Se.value=X.message||"Search failed",Le.value=[]}finally{Qe.value=!1}}function sa(){ke.value="all",Oe.value="",Me.value="",dt.value="",st.value="",_t.value="",Ot.value=100,Le.value=[],ae.value=!1,Se.value="",Et.value=null}function Zs(X){Et.value=Et.value===X?null:X}function Ns(X){if(!X.timestamp)return"";try{return new Date(X.timestamp).toLocaleString()}catch{return X.timestamp}}function Mn(X){return X.type==="web_action"?`${X.status||""} (${X.execution_time_ms||0}ms)`:(X.result_summary||"").slice(0,200)}function Ss(X){return X.error?"log-line-error":"text-gray-300"}function Fn(X){try{return JSON.stringify(X,null,2)}catch{return String(X)}}let Lt=null,Xe=!1;function Ts(){Xe||(Xe=!0,Ye.subscribe("logs",te),c.value=Ye.connected,d.value=Ye.state||"disconnected",Lt=Ye.onState(X=>{d.value=X,c.value=X==="connected"}))}function Ds(){Xe&&(Xe=!1,Ye.unsubscribe("logs",te),Lt&&(Lt(),Lt=null))}return je(()=>{y(),window.addEventListener("pointerup",j),window.addEventListener("pointercancel",j)}),Qt(Ts),Gt(Ds),ft(()=>{Ds(),window.removeEventListener("pointerup",j),window.removeEventListener("pointercancel",j)}),{mode:e,logs:t,paused:a,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:n,groupedLogs:ce,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:Y,pauseBuffer:A,showJumpBottom:h,copiedIndex:m,regexError:P,levels:w,logPresets:L,timeRanges:x,timeRange:b,activeLogPreset:g,customLogPresets:E,showSaveLogPreset:C,newLogPresetName:O,hasActiveLogFilters:F,timeRangeLabel:T,timelineBuckets:G,timelineMax:S,timelineSpanLabel:k,timelineLabelSkip:R,togglePause:ne,clearLogs:le,exportLogs:he,logLineClass:re,levelClass:xe,levelChipClass:ve,toggleLevel:pe,copyLine:fe,jumpToBottom:B,onScroll:U,onUserScrollIntent:ue,onUserScrollKey:Ae,onAutoScrollToggle:oe,onPointerDown:M,applyLogPreset:_e,applyCustomLogPreset:Ie,saveLogCustomPreset:$,removeLogCustomPreset:ge,segmentHeight:Z,jumpToTimelineBucket:J,searchLevel:ke,searchTool:Oe,searchKeyword:Me,searchStart:dt,searchEnd:st,searchTimePreset:_t,searchLimit:Ot,searchLimits:rt,searching:Qe,searchRan:ae,searchError:Se,searchResults:Le,searchStats:Ke,expandedSearch:Et,switchToSearch:Ve,runSearch:ks,clearSearchFilters:sa,toggleSearchExpand:Zs,formatSearchTs:Ns,searchEntryText:Mn,searchLogLineClass:Ss,formatJson:Fn,applySearchTimePreset:zt}}};function Dl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const qk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function Gk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Xa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Kk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},Pl=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord","computer"]),Wk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function cp(e){return Wk.some(t=>e===t||e.startsWith(`${t}.`))}const ev="odin_config_center_expanded_v1",tv="odin_config_center_category_v1",Jk=50,Zk=650,kr=()=>V.get("/api/config/meta");function ca(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ui(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Pa(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Yk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function Qk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function sv(e,t){if(Ui(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ca(t);const n={};for(const[a,i]of Object.entries(t)){const l=sv(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function Xk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=sv(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function nv(e,t,s,n){if(Ui(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)nv(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function eS(){try{const e=JSON.parse(localStorage.getItem(ev)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function tS(){try{const e=localStorage.getItem(tv);return Xa.some(t=>t.key===e)?e:Xa[0].key}catch{return Xa[0].key}}const sS={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),n=f(null),a=f(!1),i=f(null),l=f(null),o=f(null),r=f(!1),c=f(!1),d=f(null),u=f(""),p=f("all"),h=f(tS()),m=f(eS()),v=f({}),w=f({}),L=f(""),x=f({}),g=f({}),b=f([]),E=f([]),C=f(!1),O=f(!1),A=f(!1);let y=null,N=null,F={path:null,at:0},T=0;const P=W(()=>{var I;return(((I=t.value)==null?void 0:I.fields)||[]).filter(z=>!Pl.has(z.path.split(".")[0])&&!cp(z.path))}),q=W(()=>new Map(P.value.map(I=>[I.path,I]))),G=W(()=>Z.value.reduce((I,z)=>I+z.sections.length,0)),S=W(()=>P.value.length),k=W(()=>qk),R=W(()=>b.value.length>0),H=W(()=>E.value.length>0),Z=W(()=>{if(!e.value)return[];const I=new Set(Xa.flatMap(Ee=>Ee.sections)),z=Xa.map(Ee=>({...Ee,sections:Ee.sections.filter(ct=>Object.hasOwn(e.value,ct)&&!Pl.has(ct))})).filter(Ee=>Ee.sections.length),Q=Object.keys(e.value).filter(Ee=>!I.has(Ee)&&!Pl.has(Ee));return Q.length&&z.push({key:"other",label:"Other",icon:"folder",sections:Q}),z}),J=W(()=>e.value?{...e.value,...v.value}:null),Y=W(()=>{if(!e.value)return[];const I=[];for(const[z,Q]of Object.entries(v.value))nv(e.value[z],Q,z,I);return I.filter(z=>!Ui(z.oldVal,z.newVal)).map(z=>{const Q=M(z.path);return{...z,label:(Q==null?void 0:Q.label)||Pa(z.path.split(".").at(-1)),apply_mode:(Q==null?void 0:Q.apply_mode)||pe(z.path.split(".")[0])}})}),ce=W(()=>Y.value.length>0),te=W(()=>Y.value.length),de=W(()=>new Set(Y.value.map(I=>I.path.split(".")[0])).size),Ne=W(()=>!!u.value||p.value!=="all"),B=W(()=>{const I={...g.value};for(const z of Y.value){const Q=M(z.path),Ee=mi(Q,z.newVal);Ee&&(I[z.path]=Ee)}return I}),ie=W(()=>Object.keys(B.value).length>0),U=W(()=>e.value?(Ne.value?Z.value:Z.value.filter(z=>z.key===h.value)).map(z=>({...z,sections:z.sections.filter(Q=>Qe(Q))})).filter(z=>z.sections.length):[]),ee=W(()=>{const I=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],z=new Map(I.map(Q=>[Q,[]]));for(const Q of Y.value){const Ee=z.has(Q.apply_mode)?Q.apply_mode:"restart";z.get(Ee).push(Q)}return I.filter(Q=>z.get(Q).length).map(Q=>({key:Q,label:Xt(Q),entries:z.get(Q)}))}),ue=W(()=>Y.value.filter(I=>I.apply_mode==="restart").length),Ae=W(()=>P.value.filter(I=>I.pending_restart)),_=W(()=>Ae.value.length);function M(I){const z=q.value.get(I);return z?{...z,apply_details:Dl([z])}:null}function j(I){const z=`${I}.`;return P.value.filter(Q=>Q.path===I||Q.path.startsWith(z))}function oe(){return P.value.some(I=>I.path==="tools.hosts"||I.path.startsWith("tools.hosts."))}function ne(){var Q,Ee;const I=((Ee=(Q=e.value)==null?void 0:Q.tools)==null?void 0:Ee.hosts)||{},z=Object.keys(I).length;return`${z} host${z===1?"":"s"} configured.`}function le(I){return j(I).length}function he(I){return Pa(I)}function fe(I){const z=j(I);if(!z.length)return`${Pa(I)} configuration.`;const Q=z.find(Cs=>Cs.sensitivity==="public"&&Cs.description)||z.find(Cs=>Cs.description),Ee=(Q==null?void 0:Q.description)||"";return Ee.match(/setting for (.+)\.$/i)?`${Pa(I)} settings and runtime behaviour.`:Ee}function pe(I){const z=[...new Set(j(I).map(Q=>Q.apply_mode))];return z.length===1?z[0]:z.includes("restart")?"restart":z.includes("activation_required")?"activation_required":z[0]||"restart"}function re(I){const z=[...new Set(j(I).map(Q=>Xt(Q.apply_mode)))];return z.length?z.length===1?z[0]:`Mixed apply behaviour: ${z.join(" · ")}`:""}function xe(I){return Dl(j(I))}function ve(I){var z;return Object.hasOwn(v.value,I)?v.value[I]:(z=e.value)==null?void 0:z[I]}function _e(){const I=ve("mcp")||{},z=Object.keys(I.servers||{}).length;return`${I.enabled?"Globally enabled":"Globally disabled"} · ${z} configured server${z===1?"":"s"}.`}function Ie(I,z){return z.split(".").reduce((Q,Ee)=>Q==null?void 0:Q[Ee],I)}function $(I){const z=J.value;return j(I).filter(Q=>cp(Q.path)?!1:Q.path.split(".").length<=2?!0:!Q.path.includes(".*")).map(Q=>({...Q,key:Q.path.split(".").at(-1),value:Ie(z,Q.path),apply_details:Dl([Q]),editor:Q.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ge(I){const z=I.path.split(".");return z.length>2?z.slice(0,2).join("."):null}function ke(I){const z=new Map;for(const Q of $(I)){const Ee=ge(Q),ct=Ee||`${I}.__root`;z.has(ct)||z.set(ct,{key:ct,path:Ee,entries:[]}),z.get(ct).entries.push(Q)}return[...z.values()].map(Q=>{const Ee=Q.entries.find(ct=>ct.group_description);return{...Q,label:Q.path?Pa(Q.path.split(".").at(-1)):null,description:(Ee==null?void 0:Ee.group_description)||null,apply_details:Dl(Q.entries),runtime_summaries:Me(Q.entries)}})}function Oe(I){return{save:I.save_effect||(I.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:I.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[I.apply_mode]||"Effective runtime state is not currently observable."}}function Me(I){const z=new Map;for(const Q of I){const Ee=Oe(Q),ct=`${Q.apply_mode}|${Ee.save}|${Ee.runtime}`;z.has(ct)||z.set(ct,{key:ct,label:Xt(Q.apply_mode),save:Ee.save,runtime:Ee.runtime})}return[...z.values()]}function dt(I){if(st(I))return I.runtime_effect||I.activation_policy||"";if(I.apply_mode==="activation_required"){const z=I.activation_policy||I.runtime_effect;return z?`Not active after saving. No activation control exists in this release. ${z}`:"Not active after saving; no activation control exists in this release."}return""}function st(I){return I.action_available===!0&&!!(I.action_label&&I.action_endpoint)}async function _t(I){if(st(I))try{if(Et(I.path))throw new Error("Save this setting before applying its action.");const z=String(I.action_method||"POST").toLowerCase(),Q={post:V.post.bind(V),put:V.put.bind(V),delete:V.del.bind(V)}[z];if(!Q)throw new Error("Unsupported configuration action");await Q(I.action_endpoint,I.action_body||void 0),await De(),es("success",`${I.action_label} completed.`)}catch(z){es("error",z.message||`${I.action_label} failed`)}}function Ot(I,z){return[I.label,I.path,I.description,...I.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(z)}function rt(I){const z=u.value.trim().toLowerCase();return z?j(I).filter(Q=>Ot(Q,z)):[]}function Qe(I){const z=j(I);if(p.value!=="all"&&!z.some(Ee=>Ee.apply_state===p.value))return!1;const Q=u.value.trim().toLowerCase();return!Q||`${he(I)} ${I}`.toLowerCase().includes(Q)?!0:z.some(Ee=>Ot(Ee,Q))}function ae(I,z){return j(I).filter(Q=>Q.apply_state===z).length}function Se(I){return I==="all"?S.value:P.value.filter(z=>z.apply_state===I).length}function Le(I){const z=I.sections.flatMap(Q=>j(Q));return{fields:z.length,modified:Y.value.filter(Q=>I.sections.includes(Q.path.split(".")[0])).length,pending_restart:z.filter(Q=>Q.apply_state==="pending_restart").length,invalid:z.filter(Q=>Q.apply_state==="invalid").length,dormant:z.filter(Q=>Q.apply_state==="dormant").length}}function Ke(I){var z;return Object.hasOwn(v.value,I)&&!Ui((z=e.value)==null?void 0:z[I],v.value[I])}function Et(I){return Y.value.some(z=>z.path===I||z.path.startsWith(`${I}.`))}function Ve(I){h.value=I,u.value="",p.value="all";try{localStorage.setItem(tv,I)}catch{}}function $t(I){p.value=I}function zt(){u.value="",p.value="all"}function rs(I){var z;return((z=Z.value.find(Q=>Q.sections.includes(I)))==null?void 0:z.sections)||[]}function Js(I){const z=rs(I),Q=z.find(Ee=>m.value[Ee]===!0);return Q||z.find(Ee=>m.value[Ee]!==!1)||null}function ks(I){return u.value&&!A.value&&Qe(I)?!0:A.value?Js(I)===I:Object.hasOwn(m.value,I)?m.value[I]===!0:!0}function sa(I){const z=!ks(I);if(A.value){const Q={...m.value};for(const Ee of rs(I))Q[Ee]===!0&&(Q[Ee]=!1);Q[I]=z,m.value=Q;return}m.value={...m.value,[I]:z}}function Zs(){b.value.push(ca(v.value)),b.value.length>Jk&&b.value.shift(),E.value=[]}function Ns(){ce.value&&(Zs(),v.value={},g.value={},C.value=!1)}function Mn(I,z=!1){const Q=Date.now();if(z&&F.path===I&&Q-F.at<Zk){F.at=Q;return}Zs(),F={path:I,at:Q}}function Ss(I,z,Q){if(!z.length)return Q;const Ee=ca(I??{});let ct=Ee;for(let Cs=0;Cs<z.length-1;Cs+=1){const pn=z[Cs];ct[pn]=ca(ct[pn]??{}),ct=ct[pn]}return ct[z.at(-1)]=Q,Ee}function Fn(I){var z;return Object.hasOwn(v.value,I)?v.value[I]:ca((z=e.value)==null?void 0:z[I])}function Lt(I,z,Q={}){var Ad;if(Pl.has(I.path.split(".")[0]))return;const[Ee,...ct]=I.path.split(".");Mn(I.path,!!Q.coalesce);const Cs=Fn(Ee),pn=ct.length?Ss(Cs,ct,z):z,aa={...v.value};if(Ui(pn,(Ad=e.value)==null?void 0:Ad[Ee])?delete aa[Ee]:aa[Ee]=pn,v.value=aa,g.value[I.path]){const Rd={...g.value};delete Rd[I.path],g.value=Rd}}function Xe(I){F={path:null,at:0},w.value={...w.value,[I]:String(Ie(J.value,I)??"")}}function Ts(I){if(F={path:null,at:0},!Object.hasOwn(w.value,I))return;const z={...w.value};delete z[I],w.value=z}function Ds(I){const z=w.value[I.path];if(F={path:null,at:0},z===""){if(I.nullable){Ts(I.path),Lt(I,null,{coalesce:!0});return}g.value={...g.value,[I.path]:"Enter a number."};return}const Q=Number(z);if(Number.isNaN(Q)||I.type==="integer"&&!Number.isInteger(Q)){g.value={...g.value,[I.path]:I.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ee={...w.value};delete Ee[I.path],w.value=Ee,Lt(I,Q,{coalesce:!0})}function X(I){return Object.hasOwn(w.value,I.path)?w.value[I.path]:I.value??""}function we(I,z){if(w.value={...w.value,[I.path]:z},z===""){if(I.nullable){Lt(I,null,{coalesce:!0});return}g.value={...g.value,[I.path]:"Enter a number."};return}const Q=Number(z);if(!Number.isFinite(Q)||I.type==="integer"&&!Number.isInteger(Q)){g.value={...g.value,[I.path]:I.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[I.path]){const Ee={...g.value};delete Ee[I.path],g.value=Ee}Lt(I,Q,{coalesce:!0})}function $e(I){const z=Number.parseInt(L.value,10);if(!Number.isInteger(z)||z<1){g.value={...g.value,[I.path]:"Warning thresholds must be positive whole numbers."};return}const Q=[...new Set([...I.value||[],z])].sort((Ee,ct)=>ct-Ee);L.value="",Lt(I,Q)}function Je(I,z){Lt(I,(I.value||[]).filter(Q=>Q!==z))}function wt(I){return I.apply_mode==="live_read"?"Odin reads the saved file value on next use.":I.apply_mode==="live_for_new_work"?"New work uses the saved file value.":I.apply_mode==="live_apply"?I.apply_handler?`Apply the saved value through ${I.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":I.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":I.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":I.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ut(I){return I.type==="array"&&Array.isArray(I.value)&&!I.structured_container&&!I.structured_container_child&&I.sensitivity==="public"&&I.value.every(z=>["string","number","boolean"].includes(typeof z))}function $n(I){const z=String(x.value[I.path]??"").trim();if(!z)return;const Q=[...new Set([...I.value||[],z])];x.value={...x.value,[I.path]:""},Lt(I,Q)}function js(I,z){Lt(I,(I.value||[]).filter(Q=>Q!==z))}function mi(I,z){var Ee;if(!I)return null;if((Ee=I.enum)!=null&&Ee.length&&!I.enum.includes(z))return`Choose one of: ${I.enum.join(", ")}`;if(I.path==="agents.final_warning_iterations"&&(!Array.isArray(z)||!z.length))return"Add at least one warning threshold.";const Q=I.constraints||{};if((I.type==="integer"||I.type==="number")&&typeof z=="number"){if(Q.minimum!==void 0&&z<Q.minimum)return`Must be at least ${Q.minimum}${I.unit?` ${I.unit}`:""}`;if(Q.maximum!==void 0&&z>Q.maximum)return`Must be at most ${Q.maximum}${I.unit?` ${I.unit}`:""}`}return null}function vi(I){return B.value[I.path]||null}function Ia(I){const z=`${I}.`;return Object.keys(B.value).some(Q=>Q===I||Q.startsWith(z))}function na(){b.value.length&&(E.value.push(ca(v.value)),v.value=b.value.pop(),g.value={},w.value={},F={path:null,at:0})}function Bn(){E.value.length&&(b.value.push(ca(v.value)),v.value=E.value.pop(),g.value={},w.value={},F={path:null,at:0})}function Un(){!ce.value||ie.value||(C.value=!0,O.value=!1)}function Ys(){C.value=!1}function dn(){Ns()}function Xt(I){return Kk[I]||Pa(I||"unknown")}function Oa(I){return`apply-${String(I||"unknown").replaceAll("_","-")}`}function K(I){return`cfgc-field-${I.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function be(I){return`${K(I)}-input`}function Re(I){const z=document.getElementById(K(I))||document.getElementById(K(I.split(".").slice(0,2).join(".")));z==null||z.scrollIntoView({behavior:"smooth",block:"center"})}function es(I,z){l.value={type:I,message:z},window.setTimeout(()=>{var Q;((Q=l.value)==null?void 0:Q.message)===z&&(l.value=null)},3500)}function un(){r.value=!1,p.value="pending_restart",u.value="";const I=Gk(n.value);I&&(I.scrollTop=0)}function Hn(){r.value=!1}function Te(I=1800){N&&window.clearTimeout(N),N=window.setTimeout(D,I)}async function D(){if(c.value){if(T+=1,T>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await kr(),_.value===0){c.value=!1,d.value=null,es("success","Odin restarted and the saved startup settings are active.");return}}catch{}Te(2e3)}}async function se(){if(!c.value){d.value=null;try{await V.post("/api/restart",{}),c.value=!0,T=0,r.value=!1,Te()}catch(I){d.value=I.message||"Odin could not schedule a restart."}}}async function me(){if(!(!ce.value||ie.value||a.value)){a.value=!0;try{const I=Xk(e.value,v.value),z=await V.put("/api/config",I);e.value=z,v.value={},b.value=[],E.value=[],g.value={},C.value=!1;try{t.value=await kr(),o.value=null,r.value=_.value>0,es("success",_.value?`Configuration saved. ${_.value} setting${_.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(Q){o.value=Q.message||"Unknown metadata error.",es("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(I){es("error",I.message||"Configuration could not be saved")}finally{a.value=!1}}}async function De(){var I,z;if(!ce.value){s.value=!0,i.value=null;try{const Q=await V.get("/api/config"),Ee=await kr();e.value=Q,t.value=Ee,o.value=null;const ct=Z.value;if(ct.some(Cs=>Cs.key===h.value)||(h.value=((I=ct[0])==null?void 0:I.key)||Xa[0].key),A.value){const pn=(((z=ct.find(aa=>aa.key===h.value))==null?void 0:z.sections)||[]).find(aa=>m.value[aa]===!0);m.value=pn?{...m.value,[pn]:!0}:{}}}catch(Q){i.value=Q.message||"Unknown configuration error"}finally{s.value=!1}}}function Fe(I){if(C.value||!(I.ctrlKey||I.metaKey))return;const z=I.target;z instanceof HTMLElement&&(z.matches("input, textarea, select")||z.isContentEditable)||(!I.shiftKey&&I.key.toLowerCase()==="z"?(I.preventDefault(),na()):(I.key.toLowerCase()==="y"||I.shiftKey&&I.key.toLowerCase()==="z")&&(I.preventDefault(),Bn()))}function Ue(I){A.value=I.matches}Mt(m,I=>{try{localStorage.setItem(ev,JSON.stringify(I))}catch{}},{deep:!0});let yt=!1;function it(){yt||(yt=!0,document.addEventListener("keydown",Fe))}function vt(){yt&&(yt=!1,document.removeEventListener("keydown",Fe))}return je(()=>{var I;De(),it(),y=window.matchMedia("(max-width: 760px)"),Ue(y),(I=y.addEventListener)==null||I.call(y,"change",Ue)}),Qt(it),Gt(vt),ft(()=>{var I;vt(),(I=y==null?void 0:y.removeEventListener)==null||I.call(y,"change",Ue),N&&window.clearTimeout(N)}),{armKeydown:it,disarmKeydown:vt,handleKeydown:Fe,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:h,reviewOpen:C,mobileOverflowOpen:O,warningThresholdInput:L,arrayInputs:x,healthFilters:k,visibleCategories:Z,displayGroups:U,reviewGroups:ee,sectionCount:G,fieldCount:S,hasChanges:ce,changeCount:te,changedSectionCount:de,hasDraftErrors:ie,canUndo:R,canRedo:H,globalFilterActive:Ne,reviewRestartCount:ue,pendingRestartCount:_,pendingRestartFields:Ae,healthCount:Se,categoryStats:Le,selectCategory:Ve,selectHealthFilter:$t,clearFilters:zt,sectionLabel:he,sectionDescription:fe,sectionFieldCount:le,sectionHealthCount:ae,sectionApplySummary:re,sectionApplyDetails:xe,sectionEntries:$,fieldGroups:ke,sectionSearchHits:rt,mcpConfigSummary:_e,fieldRuntimeCopy:Oe,fieldSpecificRuntimeNote:dt,hasHonestAction:st,runFieldAction:_t,hasHostsCollection:oe,hostsConfigSummary:ne,sectionChanged:Ke,fieldChanged:Et,isSectionExpanded:ks,toggleSection:sa,discardAllDrafts:Ns,setFieldValue:Lt,setNumberFieldValue:we,numberInputValue:X,beginInputEdit:Xe,endTextInputEdit:Ts,endInputEdit:Ds,addWarningThreshold:$e,removeWarningThreshold:Je,isScalarArray:ut,addScalarArrayItem:$n,removeScalarArrayItem:js,fieldError:vi,sectionHasErrors:Ia,undo:na,redo:Bn,openReview:Un,closeReview:Ys,mobileCancel:dn,applyModeLabel:Xt,applyClass:Oa,compactValue:Yk,formatValue:Qk,structuredApplyCopy:wt,fieldId:K,fieldInputId:be,focusField:Re,fetchConfig:De,saveConfig:me,restartOdin:se,restartLater:Hn,reviewPendingRestart:un}}},nS=/^\d{15,25}$/;function av(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const iv={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),n=f(!1),a=f(0),i=f(null),l=W(()=>new Set((e.excludedIds||[]).map(String))),o=W(()=>{const E=s.value.toLowerCase().trim();return(e.members||[]).filter(C=>l.value.has(String(C.id))?!1:E?u(C).toLowerCase().includes(E)||String(C.username||"").toLowerCase().includes(E)||String(C.id).includes(E):!0)}),r=W(()=>{const E=s.value.trim();return o.value.length===0&&nS.test(E)&&!l.value.has(E)?E:""}),c=W(()=>o.value.length+(r.value?1:0)),d=W(()=>{if(n.value){if(o.value[a.value])return`${e.optionsId}-${a.value}`;if(r.value&&a.value===o.value.length)return`${e.optionsId}-raw`}});function u(E){return av(E)}function p(){n.value=!0,a.value=0}function h(){p()}function m(){const E=Math.max(c.value-1,0);a.value=Math.min(a.value+1,E)}function v(){a.value=Math.max(a.value-1,0)}function w(){const E=o.value[a.value];E?L(E):r.value&&a.value===o.value.length&&x(r.value)}function L(E){x(String(E.id))}function x(E){t("select",E),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function b(){setTimeout(g,150)}return je(()=>{e.autofocus&&Rt(()=>{var E;return(E=i.value)==null?void 0:E.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:h,highlightNext:m,highlightPrevious:v,selectHighlighted:w,selectMember:L,selectId:x,closeOptions:g,onBlur:b}}};function dp(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const aS={components:{DiscordUserCombobox:iv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f(!0),s=f(null),n=f({}),a=f(null),i=f(null),l=f(!1),o=f(null),r=f({}),c=f([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=W(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),h=W(()=>new Map(c.value.map(S=>[String(S.id),S])));function m(S){return S.config&&S.config.enabled!==void 0?S.config.enabled:!0}function v(S){return dp(S,"require_mention",a.value)}function w(S){return dp(S,"respond_to_bots",a.value)}function L(S){return S.config&&Object.keys(S.config).length>0}function x(S){n.value[S]=!n.value[S]}function g(S){const k=S.discord||{};return{allowed_users:[...k.allowed_users||[]],channels:[...k.channels||[]],respond_to_bots:!!k.respond_to_bots,require_mention:!!k.require_mention,ignore_bot_ids:[...k.ignore_bot_ids||[]]}}async function b({showLoading:S=!0}={}){const k=++d;S&&(t.value=!0),s.value=null;try{const R=await V.get("/api/discord/guilds");k===d&&(e.value=R)}catch(R){k===d&&(s.value=R.message)}finally{S&&k===d&&(t.value=!1)}}async function E(){t.value=!0,s.value=null;try{const[S,k,R]=await Promise.all([V.get("/api/discord/guilds"),V.get("/api/discord/members").catch(()=>[]),V.get("/api/config")]),H=g(R),Z=p.value;a.value=H,Z||(i.value=JSON.parse(JSON.stringify(H))),c.value=k,e.value=S,o.value=null}catch(S){s.value=S.message}finally{t.value=!1}}let C=Promise.resolve();const O=f(new Set);function A(S,k){const R=new Set(O.value);R.add(S),O.value=R;const H=C.then(k);return C=H.catch(()=>{}),H.finally(()=>{const Z=new Set(O.value);Z.delete(S),O.value=Z})}function y(S,k,R,H){const Z=(H==null?void 0:H.target)??null;return A(`guild:${S}:${k}`,async()=>{try{await V.put("/api/discord/guild/"+S+"/config",{[k]:R}),await b({showLoading:!1})}catch(J){s.value=J.message,Z&&typeof R=="boolean"&&(Z.checked=!R)}})}function N(S,k,R,H,Z){const J=(Z==null?void 0:Z.target)??null;return A(`channel:${S}:${R}`,async()=>{try{await V.put("/api/discord/channel/"+S+"/config",{[R]:H}),await b({showLoading:!1})}catch(Y){s.value=Y.message,J&&typeof H=="boolean"&&(J.checked=!H)}})}function F(S,k){return A(`channel:${S}:clear`,async()=>{try{await V.put("/api/discord/channel/"+S+"/config",{clear:!0}),await b({showLoading:!1})}catch(R){s.value=R.message}})}function T(S,k){const R=String(k);if(!S.userAutocomplete)return R;const H=h.value.get(R);return H?av(H):R}function P(S,k=null){const R=String(k??r.value[S]??"").trim();!R||i.value[S].includes(R)||(i.value[S]=[...i.value[S],R],r.value={...r.value,[S]:""})}function q(S,k){i.value[S]=i.value[S].filter(R=>R!==k)}async function G(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const k=(await V.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...k.allowed_users||[]],channels:[...k.channels||[]],respond_to_bots:!!k.respond_to_bots,require_mention:!!k.require_mention,ignore_bot_ids:[...k.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(S){o.value=S.message||"Global defaults could not be saved."}finally{l.value=!1}}}return je(E),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:w,hasOverride:L,toggleGuild:x,fetchAll:E,fetchGuilds:b,setGuildConfig:y,setChannelConfig:N,clearOverride:F,mutationPending:O,globalItemLabel:T,addGlobalItem:P,removeGlobalItem:q,saveGlobalDefaults:G}}},Es=e=>e==null?e:JSON.parse(JSON.stringify(e));function iS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let h=null;const m=new Map;function v(C){d+=1;const O=c.then(C,C);return c=O.catch(()=>{}),O}function w(C,O){h=Es(C),m.clear();for(const[A,y]of Object.entries(O||{}))m.set(A,Es(y))}function L(C){const O=Es(C),A=++u;return v(async()=>{try{await e(Es(O)),h=Es(O),A===u&&n(Es(O))}catch(y){A===u&&(a(Es(h)),r(y,{kind:"default"}))}})}function x(C,O){const A=Es(O),y=(p.get(C)||0)+1;return p.set(C,y),v(async()=>{try{await t(C,Es(A)),m.set(C,Es(A)),y===p.get(C)&&i(C,Es(A))}catch(N){y===p.get(C)&&(l(C,Es(m.get(C)??null)),r(N,{kind:"user",uid:C}))}})}function g(C){const O=(p.get(C)||0)+1;return p.set(C,O),v(async()=>{try{await s(C),m.delete(C),O===p.get(C)&&o(C)}catch(A){O===p.get(C)&&(l(C,Es(m.get(C)??null)),r(A,{kind:"delete",uid:C}))}})}async function b(){for(;;){const C=c;if(await C,C===c)return d}}async function E(C){for(;;){const O=await b(),A=await C();if(O===d)return A}}return{seed:w,saveDefault:L,saveUser:x,deleteUser:g,whenIdle:b,readSnapshot:E,get revision(){return d}}}const lS={components:{DiscordUserCombobox:iv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=W(()=>{const T={};for(const P of r.value)T[P.id]=P;return T});function d(T){return c.value[T]||null}function u(T,P){return T?T.allowed_hosts===null||T.allowed_hosts===void 0?{allowed_hosts:[...P],default_host:T.default_host||"",allow_all:!0}:{allowed_hosts:T.allowed_hosts,default_host:T.default_host||"",allow_all:!1}:{allowed_hosts:[...P],default_host:P[0]||"",allow_all:!0}}const p=iS({applyDefault:async T=>{const P=T.allow_all?null:T.allowed_hosts;await V.put("/api/host-access/default-policy",{allowed_hosts:P,default_host:T.default_host})},applyUser:async(T,P)=>{const q=P.allow_all?null:P.allowed_hosts;await V.put(`/api/host-access/user/${T}`,{allowed_hosts:q,default_host:P.default_host})},applyDelete:T=>V.del(`/api/host-access/user/${T}`),onDefaultConfirmed:()=>ye.success("Default policy updated"),onDefaultRollback:T=>{T&&(i.value=T)},onUserConfirmed:T=>{const P=d(T);ye.success(`Updated access for ${P?P.display_name:T}`)},onUserRollback:(T,P)=>{const q={...l.value};P?q[T]=P:delete q[T],l.value=q},onUserDeleted:T=>{const P={...l.value};delete P[T],l.value=P},onError:(T,P)=>{var G;const q=P.uid?` ${((G=d(P.uid))==null?void 0:G.display_name)||P.uid}`:"";ye.error(`${T.message||"Failed to save"} — reverted${q}`)}});let h=0;async function m(){const T=++h;e.value=!0,t.value="";try{const P=await p.readSnapshot(()=>V.get("/api/host-access"));if(T!==h)return;s.value=P,n.value=P.available_hosts||[],a.value=P.host_descriptions||{},i.value=u(P.default_policy,n.value);const q=P.users||{},G={};for(const[S,k]of Object.entries(q))G[S]=u(k,n.value);l.value=G,p.seed(i.value,G)}catch(P){T===h&&(t.value=P.message||"Failed to fetch host access data")}finally{T===h&&(e.value=!1)}try{const P=await V.get("/api/discord/members")||[];T===h&&(r.value=P)}catch{T===h&&(r.value=[])}}const v=500,w=new Map;function L(T,P){const q=w.get(T);q&&clearTimeout(q.timer);const G={run:P,timer:null};G.timer=setTimeout(()=>{w.delete(T),P()},v),w.set(T,G)}function x(T){const P=w.get(T);P&&(clearTimeout(P.timer),w.delete(T))}function g(){for(const[T,P]of[...w])clearTimeout(P.timer),w.delete(T),P.run()}function b(){L("default",()=>p.saveDefault(i.value))}function E(T,P){i.value.allow_all=!1,P?i.value.allowed_hosts.includes(T)||i.value.allowed_hosts.push(T):(i.value.allowed_hosts=i.value.allowed_hosts.filter(q=>q!==T),i.value.default_host===T&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function C(T){L(`user:${T}`,()=>{const P=l.value[T];P&&p.saveUser(T,P)})}function O(T,P,q){const G=l.value[T];G&&(G.allow_all=!1,q?G.allowed_hosts.includes(P)||G.allowed_hosts.push(P):(G.allowed_hosts=G.allowed_hosts.filter(S=>S!==P),G.default_host===P&&(G.default_host=G.allowed_hosts[0]||"")),C(T))}function A(T,P){const q=l.value[T];q&&(q.default_host=P,C(T))}function y(){o.value=!0}function N(T){!/^\d{15,25}$/.test(T)||l.value[T]||(l.value[T]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},p.saveUser(T,l.value[T]),o.value=!1)}async function F(T){const P=d(T);await qt({title:"Remove user override",message:`Remove the host access override for ${P?P.display_name:T}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(x(`user:${T}`),await p.deleteUser(T),l.value[T]||ye.success(`Removed override for ${P?P.display_name:T}`))}return je(m),Gt(g),ft(g),{loading:e,error:t,data:s,availableHosts:n,hostDescriptions:a,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:b,toggleDefaultHost:E,getMember:d,toggleUserHost:O,setUserDefault:A,openAddUser:y,addUserById:N,deleteUser:F,flushPendingSaves:g}}},oS={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=f([]),t=f(!1),s=f(""),n=f([]),a=f(!1),i=f(!1),l=f(1),o=f(""),r=f(!1),c=f(null),d=f(""),u=f([]),p=f(!1),h=f(null),m=f(""),v=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),w=f(v()),L=W(()=>["127.0.0.1","localhost","::1"].includes(w.value.address));async function x(){t.value=!0,s.value="";try{const G=await V.get("/api/hosts");e.value=G.hosts||[],o.value=G.default_host||"",r.value=!!G.tofu_enabled}catch(G){s.value=G.message}finally{t.value=!1}}async function g(){try{await V.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),ye.success("Host settings saved and published live"),await x()}catch(G){ye.error(G.message)}}function b(){d.value="",u.value=[],p.value=!1,h.value=null,c.value=null,m.value="",l.value=1,a.value=!0}function E(){i.value=!1,w.value=v(),b()}function C(G){i.value=!0,w.value={...v(),...G},b()}async function O(){try{c.value=await V.get("/api/hosts/public-key")}catch(G){ye.error(G.message)}}async function A(G){try{const S=await V.post("/api/hosts/"+encodeURIComponent(G.alias)+"/import-legacy",{});i.value=!0,w.value={...v(),...G,trust_mode:"pinned"},b(),d.value=S.candidate_token,u.value=S.fingerprints||[],m.value=u.value.join(`
`),l.value=4,ye.info("Imported existing known_hosts trust. Test before activation.")}catch(S){ye.error(S.message)}}async function y(){try{const G=m.value.split(/\s+/).filter(Boolean),S={...w.value,expected_fingerprints:G,candidate_fingerprints:u.value},k=await V.post("/api/hosts/candidates",S);if(d.value=k.candidate_token,u.value=k.fingerprints||[],w.value.trust_mode==="tofu"&&S.candidate_fingerprints.length===0){w.value.confirm_tofu=!1,ye.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(G){ye.error(G.message)}}async function N(){var G,S;p.value=!1,h.value=null;try{const k=await V.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!k.tested,h.value=k.last_test,p.value&&(l.value=5)}catch(k){const R=(G=k.data)==null?void 0:G.last_test;R&&typeof R=="object"&&!Array.isArray(R)&&(h.value=R);const H=(S=h.value)==null?void 0:S.detail;ye.error(typeof H=="string"&&H.trim()?H:k.message)}}async function F(){try{await V.post("/api/hosts/candidates/"+d.value+"/commit",{}),ye.success("Host saved and published live"),a.value=!1,await x()}catch(G){ye.error(G.message)}}async function T(G){try{await V.post("/api/hosts/"+encodeURIComponent(G.alias)+"/enabled",{enabled:!G.enabled}),await x()}catch(S){ye.error(S.message)}}async function P(G){var S;if(await qt("Delete host "+G.alias+"? Dependencies will block deletion.")){n.value=[];try{await V.del("/api/hosts/"+encodeURIComponent(G.alias)),await x()}catch(k){n.value=Array.isArray((S=k.data)==null?void 0:S.pending_references)?k.data.pending_references:[],ye.error(k.message)}}}async function q(G){if(await qt("Force revoke "+G.alias+"? Remote outcomes may be unknown."))try{await V.post("/api/hosts/"+encodeURIComponent(G.alias)+"/force-revoke",{}),await x()}catch(S){ye.error(S.message)}}return je(x),{hosts:e,loading:t,error:s,pendingReferences:n,wizard:a,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:w,isLocal:L,keyInfo:c,candidate:d,observed:u,tested:p,testResult:h,fingerprintsText:m,load:x,saveSettings:g,beginAdd:E,beginEdit:C,loadKey:O,importLegacy:A,prepare:y,testConnection:N,commit:F,toggle:T,remove:P,forceRevoke:q}}},rS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=W(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=W(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function h(A){return A==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":A==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const A=await V.get("/api/tokens");s.value=A.tokens||[],n.value=A.available_hosts||[]}catch(A){t.value=A.message||"Failed to load tokens"}finally{e.value=!1}}function v(A){return!A||!A.trim()?[]:A.split(",").map(y=>y.trim()).filter(Boolean)}function w(A,y){const N=c.value.allowed_hosts;if(y&&!N.includes(A)&&N.push(A),!y){const F=N.indexOf(A);F>=0&&N.splice(F,1)}}function L(A,y){const N=d.value.allowed_hosts;if(y&&!N.includes(A)&&N.push(A),!y){const F=N.indexOf(A);F>=0&&N.splice(F,1)}}async function x(){var A;i.value=!0;try{const y=v(c.value.allowed_tools_str),N=c.value.host_mode,F=N==="none"?[]:N==="select"?c.value.allowed_hosts:null,T={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:y.length?y:[]};F!==null&&(T.allowed_hosts=F),T.default_host=c.value.default_host||"";const P=await V.post("/api/tokens",T);l.value=P.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ye.success("Token created"),await m()}catch(y){ye.error(((A=y.data)==null?void 0:A.error)||y.message||"Failed to create token")}finally{i.value=!1}}function g(A){o.value=A;const y=A.allowed_hosts;let N="default";y==null?N="default":Array.isArray(y)&&y.length===0?N="none":Array.isArray(y)&&(N="select"),d.value={username:A.username||"",tier:A.tier||"admin",label:A.label||"",host_mode:N,allowed_hosts:Array.isArray(y)?[...y]:[],default_host:A.default_host||"",allowed_tools_str:(A.allowed_tools||[]).join(", ")}}async function b(){var A;if(o.value){r.value=!0;try{const y=v(d.value.allowed_tools_str),N=d.value.host_mode,F={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:y};N==="none"?F.allowed_hosts=[]:N==="select"?F.allowed_hosts=d.value.allowed_hosts:F.allowed_hosts=null,F.default_host=d.value.default_host||"",await V.put("/api/tokens/"+encodeURIComponent(o.value.user_id),F),o.value=null,ye.success("Token updated"),await m()}catch(y){ye.error(((A=y.data)==null?void 0:A.error)||y.message||"Failed to update")}finally{r.value=!1}}}async function E(A){var N;if(await qt({title:"Regenerate token",message:`Regenerate token for ${A.username||A.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const F=await V.post("/api/tokens/"+encodeURIComponent(A.user_id)+"/regenerate");l.value=F.token,ye.success("Token regenerated")}catch(F){ye.error(((N=F.data)==null?void 0:N.error)||F.message||"Failed to regenerate")}}async function C(A){var N;if(await qt({title:"Delete token",message:`Delete token for ${A.username||A.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await V.del("/api/tokens/"+encodeURIComponent(A.user_id)),ye.success("Token deleted"),await m()}catch(F){ye.error(((N=F.data)==null?void 0:N.error)||F.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),ye.success("Copied to clipboard")}catch{ye.error("Copy failed — select and copy manually")}}return je(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:h,toggleCreateHost:w,toggleEditHost:L,createToken:x,startEdit:g,saveEdit:b,confirmRegenerate:E,confirmDelete:C,copyToken:O}}},cS=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),dS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),uS=Object.freeze(["enabled","base_url","model","max_tokens"]),pS=Object.freeze(["enabled","model","max_tokens"]);function Xo(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function up(e){return Xo(e,cS)}function pp(e){return Xo(e,dS)}function fS(e,{includeApiKey:t=!1}={}){const s=Xo(e,uS);return t&&(s.api_key=e.api_key),s}function hS(e){return{timeout:e.timeout}}function mS(e,{includeApiKey:t=!1}={}){const s=Xo(e,pS);return t&&(s.api_key=e.api_key),s}function vS(e){return{timeout:e.timeout}}function Ml(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const gS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f("codex"),a=f({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],l=W(()=>{const K=a.value.model;return K&&!i.includes(K)?[K,...i]:i}),o=W(()=>{const K=a.value.agent_model;return K&&K!=="auto"&&!i.includes(K)?[K,...i]:i}),r={"gpt-5.5":["max"],"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},c=(K,be)=>!!K&&!!be&&(r[K]||[]).includes(be),d=K=>!c(a.value.model,K)&&!(a.value.agent_reasoning_effort===""&&c(a.value.agent_model,K)),u=K=>{const be=a.value.agent_model;return be==="auto"?!0:!c(be||a.value.model,K)},p=W(()=>{const K=a.value.agent_reasoning_effort;return K==="auto"?null:K||a.value.reasoning_effort}),h=K=>c(K,a.value.reasoning_effort)||a.value.agent_model===""&&c(K,p.value),m=K=>c(K,p.value),v=f({enabled:!1,model:"gpt-5.6-luna"}),w=f({unavailable_reason:null}),L=W(()=>{const K=v.value.model;return K&&!i.includes(K)?[K,...i]:i});function x(K){const be=K.target.value;v.value.enabled=be!=="",be!==""&&(v.value.model=be),X()}const g=f(!1),b=f({codex:!1,ollama:!1,kimi:!1}),E=f(null),C=f(!1),O=f(""),A=f(null),y=f(!1);let N=0;const F=W(()=>{var K;return Object.entries(((K=E.value)==null?void 0:K.models)||{}).map(([be,Re])=>{var es,un,Hn;return{model:be,floor:Re.floor,override:Re.override,effectiveBudget:(es=Re.effective)==null?void 0:es.effective_budget,configuredPrimaryChars:(un=Re.configured)==null?void 0:un.primary_chars,primaryChars:(Hn=Re.effective)==null?void 0:Hn.primary_chars,provenance:Re.provenance,clampExpiresAt:Re.clamp_expires_at,densityPriorMilli:Re.density_prior_milli,densityScope:Re.density_scope,workloadCalibration:Re.workload_calibration}})}),T=W(()=>{var K;return((K=E.value)==null?void 0:K.clamps)||[]}),P=W(()=>{var K,be;return((be=(K=E.value)==null?void 0:K.models)==null?void 0:be[a.value.model])||null}),q=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),G=f({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),S=f(!1),k=f(!1),R=f(!1),H=f(!1),Z=f(!1),J=f(!1),Y=f(!1),ce=f({configured:null}),te=f(!1),de=f([]),Ne=f(""),B=f(!1),ie=f(!1),U=f({configured:null}),ee=f(!1),ue=f([]),Ae=f(""),_=f(!1),M=f(!1),j=f(!0),oe=f(""),ne=f({configured:null,accounts:[]}),le=f(null),he=f(null),fe=f(""),pe=f(null),re=f(!1),xe=f(null),ve=f(null),_e=f("");let Ie=null;function $(K,be="success"){ye(K,be==="error"?"error":"success")}function ge(K){if(!K)return"?";const be=K/(1024*1024*1024);return be>=1?be.toFixed(1)+" GB":(K/(1024*1024)).toFixed(0)+" MB"}function ke(K){return Number.isFinite(Number(K))?Number(K).toLocaleString():"—"}function Oe(K){return K==null?"automatic (model-derived)":Number(K).toLocaleString()+" characters"}function Me(K){const be=new Date(K);return Number.isNaN(be.getTime())?"unknown":be.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function dt(K){return typeof K=="string"&&K.length>12?K.slice(0,8)+"…"+K.slice(-4):K}function st(K){return typeof K!="number"||!Number.isFinite(K)?"—":(K/1e3).toFixed(2)}function _t(K){return K==="temporary learned clamp"?"is-clamp":K==="override"?"is-override":"is-built-in"}function Ot(K){const be=a.value.context_budget_overrides[K.model];return K.floor!=null&&Number.isFinite(Number(be))&&Number(be)>K.floor}function rt(K,be){const Re={...a.value.context_budget_overrides};be.target.value===""?delete Re[K]:Re[K]=Number(be.target.value),a.value.context_budget_overrides=Re,y.value=!0}function Qe(K){a.value.context_utilization=K.target.value===""?"":Number(K.target.value),y.value=!0}function ae(K){const be={...a.value.context_budget_overrides};delete be[K],a.value.context_budget_overrides=be,y.value=!0}async function Se(){e.value=!0,await Promise.all([Le(),Et(),ks(),Ve(),Ke()]),e.value=!1}async function Le({preserveBasic:K=!1,preserveAdvanced:be=!1}={}){try{const Re=await V.get("/api/llm/status");t.value=Re,s.value=!1,n.value=Re.active_provider||"codex",Re.codex&&!Ds.pending()&&(K||(a.value.enabled=Re.codex.enabled,a.value.model=Re.codex.model||"gpt-5.6-sol",a.value.reasoning_effort=Re.codex.reasoning_effort||"medium",a.value.agent_reasoning_effort=Re.codex.agent_reasoning_effort||"",a.value.agent_model=Re.codex.agent_model||""),be||(a.value.request_timeout_seconds=Re.codex.request_timeout_seconds??a.value.request_timeout_seconds,a.value.stream_stall_timeout_seconds=Re.codex.stream_stall_timeout_seconds??a.value.stream_stall_timeout_seconds,a.value.retry={...a.value.retry,...Re.codex.retry||{}},a.value.connection_pool={...a.value.connection_pool,...Re.codex.connection_pool||{}},a.value.context_compression={...a.value.context_compression,...Re.codex.context_compression||{}},!y.value&&!R.value&&(a.value.context_budget_overrides={...Re.codex.context_budget_overrides||{}},a.value.context_utilization=Re.codex.context_utilization??a.value.context_utilization))),Re.ollama&&!we.pending()&&(K||(q.value.enabled=Re.ollama.enabled,q.value.base_url=Re.ollama.base_url||"",q.value.model=Re.ollama.model||"",q.value.max_tokens=Re.ollama.max_tokens||4096),be||(q.value.timeout=Re.ollama.timeout??q.value.timeout)),Re.kimi&&!$e.pending()&&(K||(G.value.enabled=Re.kimi.enabled,G.value.model=Re.kimi.model||"",G.value.max_tokens=Re.kimi.max_tokens||4096),be||(G.value.timeout=Re.kimi.timeout??G.value.timeout)),Re.auxiliary&&(w.value=Re.auxiliary,X.pending()||(v.value.enabled=Re.auxiliary.enabled,v.value.model=Re.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function Ke(){const K=++N;C.value=!0,O.value="";try{const be=await V.get("/api/context/windows");if(K!==N)return;E.value=be,!R.value&&!y.value&&(a.value.context_budget_overrides=Object.fromEntries(Object.entries(be.models||{}).filter(([,Re])=>Re.override!=null).map(([Re,es])=>[Re,es.override])),a.value.context_utilization=be.utilization??a.value.context_utilization)}catch(be){K===N&&(O.value=be.message||"Failed to load context budgets")}finally{K===N&&(C.value=!1)}}async function Et(){try{if(ce.value=await V.get("/api/ollama/status"),te.value=!1,ce.value.model&&(Ne.value=ce.value.model),ce.value.configured)try{const K=await V.get("/api/ollama/models");de.value=K.models||[]}catch{de.value=[]}else if(q.value.base_url)try{const K=await V.post("/api/ollama/probe-models",{base_url:q.value.base_url});de.value=K.models||[]}catch{de.value=[]}}catch{te.value=!0}}async function Ve(){j.value=!0,oe.value="";try{ne.value=await V.get("/api/codex/status")}catch(K){oe.value=K.message||"Failed to fetch Codex status"}finally{j.value=!1}}async function $t(){const K=t.value?t.value.active_provider:"codex";Y.value=!0;try{const be=await V.post("/api/llm/switch",{provider:n.value});be.error?(n.value=K,$(be.error,"error")):($("Switched to "+n.value+" ("+be.model+")"),await Se())}catch(be){n.value=K,$(be.message||"Switch failed","error")}finally{Y.value=!1}}async function zt(){B.value=!0;try{const K=await V.post("/api/ollama/reload");$(K.configured?"Ollama reloaded":K.reason||"Ollama not configured",K.configured?"success":"error"),await Se()}catch(K){$(K.message||"Reload failed","error")}finally{B.value=!1}}async function rs(){ie.value=!0;try{await V.post("/api/ollama/model",{model:Ne.value}),$("Model set to "+Ne.value),await Se()}catch(K){$(K.message||"Failed","error")}finally{ie.value=!1}}async function Js(){const K=q.value.base_url;if(!K){$("Enter a base URL first","error");return}J.value=!0;try{const be=await V.post("/api/ollama/probe-models",{base_url:K});de.value=be.models||[],de.value.length?($(de.value.length+" model(s) found"),!q.value.model&&de.value.length&&(q.value.model=de.value[0].name)):$("No models found at "+K,"error")}catch(be){$(be.message||"Could not reach Ollama","error")}finally{J.value=!1}}async function ks(){try{if(U.value=await V.get("/api/kimi/status"),ee.value=!1,U.value.model&&(Ae.value=U.value.model),U.value.configured)try{const K=await V.get("/api/kimi/models");ue.value=K.models||[]}catch{ue.value=[]}}catch{ee.value=!0}}async function sa(){_.value=!0;try{const K=await V.post("/api/kimi/reload");$(K.configured?"Kimi reloaded":K.reason||"Kimi not configured",K.configured?"success":"error"),await Se()}catch(K){$(K.message||"Reload failed","error")}finally{_.value=!1}}async function Zs(){M.value=!0;try{await V.post("/api/kimi/model",{model:Ae.value}),$("Model set to "+Ae.value),await Se()}catch(K){$(K.message||"Failed","error")}finally{M.value=!1}}async function Ns(){if(R.value){Ds();return}R.value=!0;const K=up(a.value);try{await V.put("/api/llm/codex/config",K),$("Codex config saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ve()])}catch(be){$(be.message||"Failed","error");const Re=JSON.stringify(up(a.value))!==JSON.stringify(K);await Promise.all([Le({preserveBasic:Re,preserveAdvanced:!0}),Ve()])}finally{R.value=!1}}async function Mn(){if(R.value)return;R.value=!0;const K=pp(a.value);try{await V.put("/api/llm/codex/config",K),JSON.stringify({context_budget_overrides:a.value.context_budget_overrides,context_utilization:a.value.context_utilization})===JSON.stringify({context_budget_overrides:K.context_budget_overrides,context_utilization:K.context_utilization})&&(y.value=!1),$("Codex advanced settings saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ve(),Ke()])}catch(be){$(be.message||"Failed","error");const Re=JSON.stringify(pp(a.value))!==JSON.stringify(K);await Promise.all([Le({preserveBasic:!0,preserveAdvanced:Re}),Ve(),Ke()])}finally{R.value=!1}}async function Ss(){if(H.value){we();return}H.value=!0;try{const K=S.value?q.value.api_key:null,be=fS(q.value,{includeApiKey:K!==null});await V.put("/api/llm/ollama/config",be),$("Ollama config saved"),K!==null&&q.value.api_key===K&&(q.value.api_key="",S.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(K){$(K.message||"Failed","error")}finally{H.value=!1}}async function Fn(){if(!H.value){H.value=!0;try{await V.put("/api/llm/ollama/config",hS(q.value)),$("Ollama timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(K){$(K.message||"Failed","error")}finally{H.value=!1}}}async function Lt(){if(Z.value){$e();return}Z.value=!0;try{const K=k.value?G.value.api_key:null,be=mS(G.value,{includeApiKey:K!==null});await V.put("/api/llm/kimi/config",be),$("Kimi config saved"),K!==null&&G.value.api_key===K&&(G.value.api_key="",k.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(K){$(K.message||"Failed","error")}finally{Z.value=!1}}async function Xe(){if(!Z.value){Z.value=!0;try{await V.put("/api/llm/kimi/config",vS(G.value)),$("Kimi timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(K){$(K.message||"Failed","error")}finally{Z.value=!1}}}async function Ts(){if(g.value){X();return}g.value=!0;try{await V.put("/api/llm/auxiliary/config",v.value),$("Auxiliary config saved"),await Le()}catch(K){$(K.message||"Failed","error"),await Le()}finally{g.value=!1}}const Ds=Ml(Ns),X=Ml(Ts),we=Ml(Ss),$e=Ml(Lt),Je=()=>(Ds.cancel(),Ns()),wt=()=>(we.cancel(),Ss()),ut=()=>($e.cancel(),Lt()),$n=()=>Mn(),js=()=>Fn(),mi=()=>Xe();async function vi(K){const be=K.account_key+":"+K.model;A.value=be;try{const Re=await V.post("/api/context/windows/clear",{account_key:K.account_key,model:K.model});$(Re.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Ke()}catch(Re){$(Re.message||"Failed to clear clamp","error"),await Ke()}finally{A.value=null}}async function Ia(K){try{await V.post("/api/codex/account/"+K+"/activate"),$("Active account switched"),await Ve()}catch(be){$(be.message||"Failed","error")}}async function na(K){le.value=K;try{await V.post("/api/codex/account/"+K+"/refresh"),$("Token refreshed"),await Ve()}catch(be){$(be.message||"Refresh failed","error")}finally{le.value=null}}function Bn(K,be){he.value=K,fe.value=be||""}async function Un(K){try{await V.put("/api/codex/account/"+K+"/label",{label:fe.value}),$("Label updated"),he.value=null,await Ve()}catch(be){$(be.message||"Failed","error")}}async function Ys(K,be){if(await qt({title:"Delete Codex account",message:`Delete ${be||"account #"+(K+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await V.del("/api/codex/account/"+K),$("Deleted. Pool reloaded."),await Ve()}catch(es){$(es.message||"Failed","error")}}async function dn(){re.value=!0;try{const K=await V.post("/api/codex/device-code");xe.value=K,pe.value="pending",Xt(K)}catch(K){$(K.message||"Failed","error")}finally{re.value=!1}}async function Xt(K){Ie={cancelled:!1};const be=Ie;try{const Re=await V.post("/api/codex/device-poll",{device_auth_id:K.device_auth_id,user_code:K.user_code,interval:K.interval});if(be.cancelled)return;ve.value=Re,pe.value="success",await Se()}catch(Re){if(be.cancelled)return;_e.value=Re.message||"Device login failed",pe.value="error"}}function Oa(){Ie&&(Ie.cancelled=!0),pe.value=null,xe.value=null}return je(Se),ft(()=>{Ie&&(Ie.cancelled=!0),Ds.cancel(),X.cancel(),we.cancel(),$e.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:n,switching:Y,advancedOpen:b,codexForm:a,codexModelOptions:l,codexAgentModelOptions:o,mainEffortAllowed:d,agentEffortAllowed:u,mainModelOptionDisabled:h,agentModelOptionDisabled:m,auxForm:v,auxData:w,auxModelOptions:L,onAuxModelChange:x,savingAux:g,saveAuxConfigDebounced:X,ollamaForm:q,kimiForm:G,savingCodex:R,savingOllama:H,savingKimi:Z,probingOllama:J,ollamaKeyDirty:S,kimiKeyDirty:k,fetchCodexStatus:Ve,ollamaStatus:ce,ollamaStatusLoadFailed:te,ollamaModels:de,ollamaSelectedModel:Ne,reloading:B,settingModel:ie,kimiStatus:U,kimiStatusLoadFailed:ee,kimiModels:ue,kimiSelectedModel:Ae,reloadingKimi:_,settingKimiModel:M,codexLoading:j,codexError:oe,codexData:ne,refreshing:le,editingLabel:he,labelValue:fe,contextWindows:E,contextWindowsLoading:C,contextWindowsError:O,contextBudgetRows:F,activeClampRows:T,activeContextBudget:P,clearingClamp:A,contextPolicyDirty:y,deviceState:pe,deviceLoading:re,deviceInfo:xe,deviceResult:ve,deviceError:_e,fetchAll:Se,fetchLLMStatus:Le,fetchOllamaStatus:Et,fetchKimiStatus:ks,switchProvider:$t,reloadOllama:zt,setOllamaModel:rs,reloadKimi:sa,setKimiModel:Zs,probeOllamaModels:Js,saveCodexConfig:Ns,saveOllamaConfig:Ss,saveKimiConfig:Lt,saveCodexAdvancedConfig:Mn,saveOllamaAdvancedConfig:Fn,saveKimiAdvancedConfig:Xe,saveCodexConfigDebounced:Ds,saveOllamaConfigDebounced:we,saveKimiConfigDebounced:$e,saveCodexConfigNow:Je,saveOllamaConfigNow:wt,saveKimiConfigNow:ut,saveCodexAdvancedConfigNow:$n,saveOllamaAdvancedConfigNow:js,saveKimiAdvancedConfigNow:mi,activateAccount:Ia,refreshAccount:na,startEditLabel:Bn,saveLabel:Un,deleteAccount:Ys,startDeviceLogin:dn,cancelDeviceLogin:Oa,formatSize:ge,fetchContextWindows:Ke,clearContextClamp:vi,setContextOverride:rt,setContextUtilization:Qe,resetContextOverride:ae,overrideAboveFloor:Ot,formatCount:ke,formatContextCeiling:Oe,formatExpiry:Me,shortAccountKey:dt,provenanceClass:_t,formatDensity:st}}},fp={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function bS(e){return fp[e]||fp[(e||"").toLowerCase()]||"text-gray-400"}const yS={template:`
  ...
  `,setup(){const e=f(!0),t=f({}),s=f([]),n=f({}),a=f({}),i=f(null),l=f(null),o=f(null),r=f(null),c=f(null),d=W(()=>{var C;return Object.values(((C=i.value)==null?void 0:C.totals)||{}).reduce((O,A)=>O+Number(A||0),0)}),u=f(""),p=f(0),h=f([]),m=W(()=>h.value.map(C=>`${C.label} (${C.path}${C.reason?`: ${C.reason}`:""})`).join("; ")),v=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let w=null;async function L(){var N;const C=await Promise.allSettled(v.map(F=>V.get(F.path))),O=F=>C[F].status==="fulfilled"?C[F].value:null;t.value=O(0)||{};const A=O(1);s.value=Array.isArray(A)?A:A&&A.subsystems||[],n.value=O(2)||{},a.value=O(3)||{},i.value=O(4),l.value=O(5),o.value=O(6),r.value=O(7),c.value=O(8);const y=C.filter(F=>F.status==="rejected");if(h.value=C.flatMap((F,T)=>{var P;return F.status==="rejected"?[{...v[T],reason:((P=F.reason)==null?void 0:P.message)||"request failed"}]:[]}),p.value=h.value.length,y.length===C.length){const F=(N=y[0])==null?void 0:N.reason;u.value=(F==null?void 0:F.message)||"Failed to load internals"}else u.value="";e.value=!1}function x(){e.value=!0,u.value="",L()}let g=!1;function b(){g||(g=!0,L(),w||(w=setInterval(L,3e4)))}function E(){g&&(g=!1,w&&(clearInterval(w),w=null))}return je(b),Qt(b),Gt(E),ft(E),{loading:e,error:u,failedCount:p,failedEndpoints:h,failedEndpointSummary:m,endpoints:v,retry:x,startup:t,subsystems:s,sshPool:n,httpPool:a,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:o,freshnessStats:r,governorStats:c,statusColor:bS,formatAgeSeconds:Bw}}},xS=1e4,hp=3e4;function ki(e,t){return Math.max(0,e-t)}function Sr(e,t){return new Set((e.operations||[]).map(n=>n.state)).has("MANUAL_RESOLUTION_REQUIRED")?0:e.expired_lease||e.status==="ACTIVE"&&(!e.lease_expires_at||e.lease_expires_at<t)?1:e.status==="SUSPENDED"?2:e.status==="ACTIVE"?3:4}const _S=[{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],wS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(null),t=f(""),s=f(null),n=f(!1),a=f(0),i=f(null),l=f(""),o=f(null),r=f(!1),c=f(0),d=f(Date.now());let u=null,p=0,h=0;async function m(){const k=++p;n.value=!0;try{const R=await V.get("/api/turn-state/turns?limit=100");if(k!==p)return;t.value=R.availability,e.value=R.availability==="available"?R.data:null,s.value=null,a.value=Date.now()}catch(R){if(k!==p)return;s.value=R.message||"Turn-state read failed",R.status===503&&(t.value="unavailable")}k===p&&(n.value=!1)}async function v(){const k=++h;r.value=!0;try{const R=await V.get("/api/turn-state/capacity-breakers");if(k!==h)return;l.value=R.availability,i.value=R.availability==="available"?R.data:null,o.value=null,c.value=Date.now()}catch(R){if(k!==h)return;o.value=R.message||"Breaker read failed",R.status===503&&(l.value="unavailable")}k===h&&(r.value=!1)}function w(){m(),v()}const L=W(()=>e.value!==null&&ki(d.value,a.value)>hp),x=W(()=>i.value!==null&&ki(d.value,c.value)>hp),g=W(()=>L.value||x.value),b=W(()=>Math.round(ki(d.value,a.value)/1e3)),E=W(()=>Math.round(ki(d.value,c.value)/1e3));function C(k){return Sr(k,d.value/1e3)}function O(k){return _S[C(k)]}const A=W(()=>{var H;const k=[...((H=e.value)==null?void 0:H.turns)||[]],R=d.value/1e3;return k.sort((Z,J)=>Sr(Z,R)-Sr(J,R)||(J.last_progress_at||0)-(Z.last_progress_at||0))});function y(k){return k.state==="closed"?"badge-success":k.state==="probing"?"badge-warning":"badge-danger"}function N(k){if(k.state==="closed")return"—";const R=ki(d.value,c.value)/1e3,H=Math.max(0,(k.cooldown_remaining_seconds||0)-R);return H>0?`${Math.ceil(H)}s`:k.state==="probing"?"probe in flight":"probe eligible"}function F(k){if(!k)return"";const R=Math.max(0,Math.round(d.value/1e3-k));if(R<90)return`${R}s ago`;const H=Math.round(R/60);return H<90?`${H}m ago`:`${Math.round(H/60)}h ago`}let T=null,P=null,q=!1;function G(){q||(q=!0,w(),T=setInterval(w,xS),u=setInterval(()=>{d.value=Date.now()},1e3),P=Ye.onReconnected(w))}function S(){q&&(q=!1,T&&(clearInterval(T),T=null),u&&(clearInterval(u),u=null),P&&(P(),P=null))}return je(G),Qt(G),Gt(S),ft(S),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:L,breakersStale:x,anyStale:g,turnsAgeSeconds:b,breakersAgeSeconds:E,sortedTurns:A,priorityOf:C,priorityBadge:O,breakerBadge:y,cooldownLabel:N,ageLabel:F,fetchTurns:m,fetchBreakers:v,refreshAll:w,arm:G,disarm:S}}},kS={setup(){const e=f(""),t=f(""),s=f(!1),n=f(""),a=f(!1),i=f(!1),l=f(!1),o=f(null),r=f(!1);async function c(){a.value=!0,o.value=null,r.value=!1;try{const u=await V.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{a.value=!1}}async function d(){if(await qt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await V.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return je(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},mp=e=>JSON.parse(JSON.stringify(e)),SS=(e,t)=>JSON.stringify(e)===JSON.stringify(t),TS={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=f([]),n=f({}),a=f({}),i=f(!1),l=f(!1),o=f(!1),r=f(!1),c=f(!1),d=f(""),u=f("");let p=!1,h=0,m=null;const v=(S,k)=>p&&h===S&&V.token===k,w=S=>"computer-provisioning-"+S.key,L=S=>S===null?"Unset":S===""?"Empty":JSON.stringify(S),x=S=>{const k=a.value[S.key];return S.type==="array"?String(k||"").split(/\r?\n/).map(R=>R.trim()).filter(Boolean):["integer","number"].includes(S.type)?k===""||k==null?null:Number(k):k},g=W(()=>s.value.map(S=>({...S,value:x(S)})).filter(S=>!SS(S.value,n.value[S.key]))),b=W(()=>s.value.filter(S=>S.pending_restart).map(S=>S.label)),E=W(()=>s.value.some(S=>S.apply_state==="unknown")),C=W(()=>{const S={};for(const k of s.value){const R=x(k),H=k.constraints||{};["integer","number"].includes(k.type)&&(R===null&&!k.nullable?S[k.key]="A number is required.":R!==null&&(!Number.isFinite(R)||k.type==="integer"&&!Number.isInteger(R)||H.minimum!=null&&R<H.minimum||H.maximum!=null&&R>H.maximum)&&(S[k.key]="Enter a number within the allowed range.")),k.key==="monitor_names"&&(R.length>16||new Set(R).size!==R.length||R.some(Z=>!/^[A-Za-z0-9_.-]{1,64}$/.test(Z)))&&(S[k.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return S}),O=W(()=>Object.keys(C.value).length>0);function A(S,k){a.value[S.key]=k,u.value=""}function y(){a.value=Object.fromEntries(s.value.map(S=>[S.key,S.type==="array"?n.value[S.key].join(`
`):n.value[S.key]])),r.value=!1}async function N(S,k){const[R,H]=await Promise.all([V.get("/api/config"),V.get("/api/config/meta")]);if(!v(S,k))return!1;const Z=(H.fields||[]).filter(J=>/^computer\.[^.]+$/.test(J.path)&&J.path!=="computer.enabled"&&J.sensitivity==="public"&&J.apply_mode==="restart");if(!R.computer||!Z.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=Z.map(J=>({...J,key:J.path.split(".")[1]})),n.value=Object.fromEntries(s.value.map(J=>[J.key,mp(R.computer[J.key])])),y(),m=k,i.value=!0,c.value=!1,!0}async function F(){if(!p||l.value||o.value)return;const S=++h,k=V.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await N(S,k)}catch(R){v(S,k)&&(c.value=!0,d.value=R.message||"Could not load provisioning. No changes were sent.")}finally{v(S,k)&&(l.value=!1)}}function T(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!O.value&&(r.value=!0)}async function P(){if(!p||!i.value||!r.value||o.value||l.value||c.value||O.value||!g.value.length)return;if(m!==V.token){G(),q();return}const S={computer:Object.fromEntries(g.value.map(Z=>[Z.key,mp(Z.value)]))},k=h,R=V.token;o.value=!0,d.value="",u.value="";let H=!1;try{if(await V.put("/api/config",S),H=!0,!v(k,R))return;await N(k,R)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(Z){v(k,R)&&(c.value=!0,r.value=!1,d.value=H?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${Z.status===400?": "+Z.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{v(k,R)&&(o.value=!1)}}function q(){p||(p=!0,F())}function G(){p=!1,h++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,m=null,s.value=[],n.value={},a.value={},d.value="",u.value=""}return je(q),Qt(q),Gt(G),ft(G),{fields:s,original:n,draft:a,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:b,effectiveUnknown:E,changes:g,validation:C,invalid:O,fieldId:w,format:L,edit:A,discard:y,load:F,openReview:T,save:P}}},CS={components:{ComputerProvisioning:TS},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),n=f(!1),a=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(null),p=f(""),h=f(!1),m=f(Date.now()),v=f(""),w=f(null);let L=0,x=null,g=!1,b=V.token,E=0;const C=B=>B===!0?"Enabled":B===!1?"Disabled":"Unknown",O=W(()=>{var B;return((B=e.value.backend)==null?void 0:B.environment)==="existing_session"}),A=W(()=>Object.entries(e.value.input_limits||{}).filter(([,B])=>typeof B=="number"&&Number.isFinite(B)).map(([B,ie])=>`${B}: ${ie}`).join(", ")),y=W(()=>{var ie;const B=(ie=e.value.application_provenance)==null?void 0:ie.script_identity;return typeof B=="string"?B:!B||typeof B!="object"?"Not observed":`${B.interpreter_basename||"Unknown interpreter"}; argv digest ${B.argv_digest||"not recorded"}; ${B.verified===!0?"verified":"not verified"}`}),N=W(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(B=>B&&typeof B.id=="string"&&typeof B.label=="string"&&["supported","capture_only"].includes(B.input)).slice(0,16):[]),F=W(()=>{const B=e.value.restart_required;return Array.isArray(B)?B.length?B.join(", "):"None reported":B===!0?"Pending; restart required":B===!1?"None reported":"Unknown"}),T=W(()=>{var ie,U;const B=Date.parse(((ie=u.value)==null?void 0:ie.captured_at)||"");return Number.isFinite(B)&&m.value<B+Math.min(1e4,((U=u.value)==null?void 0:U.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function P(){p.value&&URL.revokeObjectURL(p.value),p.value="",u.value=null}function q(){L++,P(),w.value=null,s.value=!1,i.value=!1,l.value=!1}function G(B,ie){return g&&B===L&&ie===V.token}function S(B){q(),c.value=!1;const ie=B.status||(B.name==="AuthError"?401:0);e.value={available:!1,state:ie===503?"unavailable":"unknown"},o.value=ie===401||ie===403||ie===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":ie===410?"Evidence or artifact expired. Observe or prepare the export again.":ie===503?"Computer use is disabled or unavailable.":"Request failed; outcome unknown. Refresh status. No action was replayed."}async function k(){if(t.value||r.value||n.value||a.value||d.value||!g)return;const B=L,ie=V.token;t.value=!0,E=Date.now();try{const U=await V.get("/api/computer");if(!G(B,ie))return;R(U)}catch(U){G(B,ie)&&S(U)}finally{t.value=!1}}function R(B){(e.value.session_id&&e.value.session_id!==B.session_id||e.value.generation!=null&&e.value.generation!==B.generation||e.value.session_generation!=null&&e.value.session_generation!==B.session_generation)&&q(),e.value=B,c.value=!0,o.value=""}async function H(B){if(!g||!c.value||r.value||n.value||a.value)return;q();const ie=L,U=V.token;r.value=!0;try{if(await V.post("/api/computer/enabled",{enabled:B}),!G(ie,U))return;const ee=await V.get("/api/computer");G(ie,U)&&R(ee)}catch(ee){G(ie,U)&&S(ee)}finally{r.value=!1}}async function Z(B){q();const ie=L,U=V.token,ee=B==="stop"?n:a;ee.value=!0;try{const ue=await V.post("/api/computer/"+B,{});if(G(ie,U)){e.value={...e.value,...ue};const Ae=await V.get("/api/computer");G(ie,U)&&R(Ae)}}catch(ue){G(ie,U)&&S(ue)}finally{ee.value=!1}}async function J(){if(!g||!c.value||d.value||e.value.state!=="quarantined")return;const B={session_id:e.value.session_id,generation:e.value.session_generation};if(!B.session_id||!Number.isInteger(B.generation))return;q();const ie=L,U=V.token;d.value=!0;try{const ee=await V.post("/api/computer/recover",B);G(ie,U)&&R(ee)}catch(ee){G(ie,U)&&S(ee)}finally{d.value=!1}}async function Y(){var U;P(),h.value=!1;const B=L,ie=V.token;s.value=!0;try{const ee=await V.post("/api/computer/observe",{});if(!G(B,ie))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((U=ee.frame)==null?void 0:U.evidence_id)||""))throw new Error("Invalid evidence");const ue=await V.getBlob("/api/computer/evidence/"+ee.frame.evidence_id);if(!G(B,ie))return;if(!["image/png","image/jpeg"].includes(ue.type)||ue.size>2097152||!Number.isFinite(Date.parse(ee.frame.expires_at))||Date.parse(ee.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");u.value=ee.frame,p.value=URL.createObjectURL(ue),o.value=""}catch(ee){G(B,ie)&&S(ee)}finally{B===L&&(s.value=!1)}}async function ce(){w.value=null;const B=L,ie=V.token;i.value=!0;try{const U=await V.post("/api/computer/export",{name:v.value});G(B,ie)&&(w.value=U,o.value="")}catch(U){G(B,ie)&&S(U)}finally{B===L&&(i.value=!1)}}async function te(){const B=L,ie=V.token,U=w.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((U==null?void 0:U.artifact_id)||""))throw new Error("Invalid export");const ee=await V.getBlob("/api/computer/download/"+U.artifact_id);if(!G(B,ie))return;const ue=URL.createObjectURL(ee),Ae=document.createElement("a");Ae.href=ue,Ae.download=U.name,Ae.click(),setTimeout(()=>URL.revokeObjectURL(ue),1e3)}catch(ee){G(B,ie)&&S(ee)}finally{B===L&&(l.value=!1)}}function de(){g||(g=!0,k(),x=setInterval(()=>{m.value=Date.now(),b!==V.token&&(b=V.token,q(),c.value=!1,e.value={state:"unknown",available:!1}),u.value&&Date.parse(u.value.expires_at)<=m.value&&(P(),h.value=!0),w.value&&Date.parse(w.value.expires_at)<=m.value&&(w.value=null),m.value-E>=5e3&&k()},500))}function Ne(){g=!1,clearInterval(x),x=null,q(),c.value=!1}return je(de),Qt(de),Gt(Ne),ft(Ne),{status:e,loading:t,observing:s,stopping:n,pausing:a,exporting:i,downloading:l,error:o,frame:u,frameUrl:p,frameExpired:h,freshness:T,name:v,artifact:w,refresh:k,control:Z,observe:Y,clearFrame:P,exportFile:ce,download:te,toggling:r,adminReady:c,enabledLabel:C,restartSettings:F,setEnabled:H,recovering:d,recover:J,applicationProfiles:N,attached:O,scriptIdentity:y,inputLimits:A}}},lv=[{id:"health",label:"Health",component:Ok},{id:"resources",label:"Resources",component:Lk},{id:"logs",label:"Logs",component:Vk},{id:"config",label:"Config",component:sS},{id:"discord",label:"Discord",component:aS},{id:"hosts",label:"Hosts",component:oS},{id:"host-access",label:"Host Access",component:lS},{id:"api-tokens",label:"API Tokens",component:rS},{id:"llm",label:"LLM Config",component:gS},{id:"internals",label:"Internals",component:yS},{id:"turn-state",label:"Turn State",component:wS},{id:"computer",label:"Computer",component:CS},{id:"update",label:"Update",component:kS}],ES={components:{TabbedPage:Yo},setup(){return{tabs:lv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Fl=(e,t,s,n)=>n.map(({id:a,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:a}}})),AS=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Fl("Operations","operations","/operations",Ym),...Fl("History","history","/history",Qm),...Fl("Capabilities","capabilities","/capabilities",Xm),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Fl("System","system","/system",lv)],bs=ea({open:!1,query:"",selected:0});function vp(){bs.query="",bs.selected=0,bs.open=!0}function Tr(){bs.open=!1}function RS(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const IS={setup(){const e=jm(),t=f(null),s=W(()=>{const i=bs.query.trim().toLowerCase();return AS.map(l=>({...l,_score:RS(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Mt(()=>bs.open,async i=>{var l;i&&(await Rt(),(l=t.value)==null||l.focus())}),Mt(()=>bs.query,()=>{bs.selected=0});function n(i){Tr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Tr();return}if(i.key==="ArrowDown")i.preventDefault(),bs.selected=Math.min(bs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),bs.selected=Math.max(bs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[bs.selected];l&&n(l)}}return{state:bs,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Tr}},template:`
    <transition name="modal">
  ...
  `},uc={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(uc));const OS={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>si("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[si("path",{d:uc[e.name]||uc.info})])}},LS=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function gp(e){return[...e.querySelectorAll(LS)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const NS={mounted(e){const t=document.activeElement,s=n=>{if(n.key!=="Tab")return;const a=gp(e);if(!a.length){n.preventDefault(),e.focus();return}const i=a[0],l=a[a.length-1];n.shiftKey&&document.activeElement===i?(n.preventDefault(),l.focus()):!n.shiftKey&&document.activeElement===l&&(n.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||gp(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},DS={template:`
    ...
    </div>`,setup(){const e=f({}),t=f(!0),s=f(null),n=f([]),a=f(!1),i=f([]),l=f(!1),o=f(!1),r=f([]),c=f(0),d=f(null),u=f({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const h=W(()=>{const Z=e.value.uptime_seconds||0,J=Math.floor(Z/86400),Y=Math.floor(Z%86400/3600),ce=Math.floor(Z%3600/60),te=[];return J>0&&te.push(`${J}d`),Y>0&&te.push(`${Y}h`),(te.length===0||J===0&&Y===0)&&te.push(`${ce}m`),te.join(" ")}),m=W(()=>{const Z=e.value.uptime_seconds||0;return 125.66*(1-Math.min(Z/86400,1))}),v=W(()=>{const Z=e.value;return[{label:"Guilds",value:Z.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:Z.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:Z.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${Z.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:Z.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:Z.loop_count>0?"text-green-400":"",highlight:Z.loop_count>0},{label:"Agents",value:Z.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:Z.agent_count>0?`${Z.agent_count} total`:"",subColor:"text-gray-500",highlight:(Z.agent_running??0)>0},{label:"Processes",value:Z.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:Z.process_count>0?`${Z.process_count} total`:"",subColor:"text-gray-500",highlight:(Z.process_running??0)>0},{label:"Schedules",value:Z.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(Z.schedule_failing>0?`${Z.schedule_failing} failing`:"")+(Z.schedule_failing>0&&Z.schedule_paused>0?", ":"")+(Z.schedule_paused>0?`${Z.schedule_paused} paused`:"")||void 0,subColor:Z.schedule_failing>0?"text-red-400":"text-yellow-400",color:Z.schedule_failing>0?"text-red-400":"",highlight:Z.schedule_failing>0},{label:"Users",value:Z.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),w=W(()=>{const Z=e.value,J=[];return J.push({label:"Bot",status:Z.status==="online"?"ok":"warn",detail:Z.status==="online"?"Online":"Starting"}),(Z.schedule_failing||0)>0?J.push({label:"Schedules",status:"error",detail:`${Z.schedule_failing} failing`}):(Z.schedule_count||0)>0&&J.push({label:"Schedules",status:"ok",detail:`${Z.schedule_count} configured`}),(Z.loop_count||0)>0&&J.push({label:"Loops",status:"ok",detail:`${Z.loop_count} active`}),(Z.agent_running||0)>0&&J.push({label:"Agents",status:"ok",detail:`${Z.agent_running} running`}),(Z.process_running||0)>0&&J.push({label:"Processes",status:"ok",detail:`${Z.process_running} running`}),J});async function L(){try{e.value=await V.get("/api/status"),s.value=null}catch(Z){s.value=Z.message}finally{t.value=!1}}let x=0,g=0,b=0,E=0;function C(Z,J){const Y=new Set;return[...J,...Z].filter(ce=>{const te=ce._hmac||JSON.stringify([ce.timestamp,ce.tool_name,ce.user_id,ce.result_summary,ce.error]);return Y.has(te)?!1:(Y.add(te),!0)})}async function O(){const Z=++x,J=b;a.value=!0;try{const Y=await V.get("/api/audit?limit=10");if(Z!==x)return;const ce=J===b?[]:n.value.filter(te=>(te._liveEpoch||0)>J);n.value=C(Y,ce).slice(0,10),c.value=ce.length}catch{}Z===x&&(a.value=!1)}async function A(){const Z=++g,J=E;l.value=!0;try{const Y=await V.get("/api/audit?error_only=1&limit=5");if(Z!==g)return;const ce=J===E?[]:i.value.filter(te=>(te._liveErrorEpoch||0)>J);i.value=C(Y,ce).slice(0,5),o.value=!1}catch{if(Z!==g)return;o.value=J===E||i.value.length===0}Z===g&&(l.value=!1)}async function y(){try{const Z=await V.get("/api/knowledge");d.value=(Array.isArray(Z)?Z:[]).reduce((J,Y)=>J+(Y.chunks||0),0)}catch{d.value=null}}async function N(){try{const Z=await V.get("/api/agents");r.value=Z.filter(J=>J.status==="running")}catch{}}async function F(){u.value={...u.value,reload:!0};try{await V.post("/api/reload"),ye.success("Config reloaded")}catch(Z){ye.error(Z.message)}u.value={...u.value,reload:!1}}async function T(){if(!await qt({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const J=e.value.session_count;e.value={...e.value,session_count:0};try{const Y=await V.post("/api/sessions/clear-all");ye.success(`Cleared ${Y.count} session${Y.count!==1?"s":""}`),await L()}catch(Y){e.value={...e.value,session_count:J},ye.error(Y.message)}u.value={...u.value,clearSessions:!1}}async function P(){if(!await qt({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const J=e.value.loop_count;e.value={...e.value,loop_count:0};try{const Y=await V.post("/api/loops/stop-all");ye.success(Y.result),await L()}catch(Y){e.value={...e.value,loop_count:J},ye.error(Y.message)}u.value={...u.value,stopLoops:!1}}function q(){t.value=!0,s.value=null,L(),O(),A(),N()}let G=null,S=null,k=null;function R(Z){if(Z.payload&&Z.payload.tool_name){b+=1;const J={...Z.payload,_isNew:!0,_key:++p,_liveEpoch:b};n.value.unshift(J),n.value.length>10&&n.value.pop(),c.value++,J.error&&(E+=1,J._liveErrorEpoch=E,o.value=!1,i.value.unshift(J),i.value.length>5&&i.value.pop()),setTimeout(()=>{J._isNew=!1},1500),clearTimeout(k),k=setTimeout(()=>{c.value=0},1e4)}}let H=null;return je(async()=>{await Promise.all([L(),O(),A(),N(),y()]),G=setInterval(L,15e3),S=setInterval(N,1e4),Ye.subscribe("events",R),H=Ye.onReconnected(()=>{O(),A()})}),ft(()=>{G&&clearInterval(G),S&&clearInterval(S),clearTimeout(k),Ye.unsubscribe("events",R),H&&(H(),H=null)}),{status:e,loading:t,error:s,uptime:h,uptimeRingOffset:m,stats:v,healthIndicators:w,activity:n,activityLoading:a,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:O,fetchErrors:A,fetchStatus:L,onEvent:R,formatTime:$w,formatDuration:ui,retry:q,reloadConfig:F,clearSessions:T,stopAllLoops:P}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function bp(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function PS(e){if(Array.isArray(e))return e}function MS(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(n=i.call(s)).done)&&(o.push(n.value),o.length!==t);r=!0);}catch(d){c=!0,a=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return o}}function FS(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function $S(e,t){return PS(e)||MS(e,t)||BS(e,t)||FS()}function BS(e,t){if(e){if(typeof e=="string")return bp(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?bp(e,t):void 0}}const ov=Object.entries,yp=Object.setPrototypeOf,US=Object.isFrozen,HS=Object.getPrototypeOf,zS=Object.getOwnPropertyDescriptor;let ms=Object.freeze,zs=Object.seal,Ha=Object.create,rv=typeof Reflect<"u"&&Reflect,pc=rv.apply,fc=rv.construct;ms||(ms=function(t){return t});zs||(zs=function(t){return t});pc||(pc=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});fc||(fc=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const vn=Ft(Array.prototype.forEach),jS=Ft(Array.prototype.lastIndexOf),xp=Ft(Array.prototype.pop),Ma=Ft(Array.prototype.push),VS=Ft(Array.prototype.splice),ds=Array.isArray,Oi=Ft(String.prototype.toLowerCase),Cr=Ft(String.prototype.toString),_p=Ft(String.prototype.match),Fa=Ft(String.prototype.replace),wp=Ft(String.prototype.indexOf),qS=Ft(String.prototype.trim),GS=Ft(Number.prototype.toString),KS=Ft(Boolean.prototype.toString),kp=typeof BigInt>"u"?null:Ft(BigInt.prototype.toString),Sp=typeof Symbol>"u"?null:Ft(Symbol.prototype.toString),St=Ft(Object.prototype.hasOwnProperty),Si=Ft(Object.prototype.toString),Kt=Ft(RegExp.prototype.test),oa=WS(TypeError);function Ft(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return pc(e,t,n)}}function WS(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return fc(e,s)}}function ze(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Oi;if(yp&&yp(e,null),!ds(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(US(t)||(t[n]=i),a=i)}e[a]=!0}return e}function JS(e){for(let t=0;t<e.length;t++)St(e,t)||(e[t]=null);return e}function ss(e){const t=Ha(null);for(const n of ov(e)){var s=$S(n,2);const a=s[0],i=s[1];St(e,a)&&(ds(i)?t[a]=JS(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=ss(i):t[a]=i)}return t}function ZS(e){switch(typeof e){case"string":return e;case"number":return GS(e);case"boolean":return KS(e);case"bigint":return kp?kp(e):"0";case"symbol":return Sp?Sp(e):"Symbol()";case"undefined":return Si(e);case"function":case"object":{if(e===null)return Si(e);const t=e,s=en(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Si(n)}return Si(e)}default:return Si(e)}}function en(e,t){for(;e!==null;){const n=zS(e,t);if(n){if(n.get)return Ft(n.get);if(typeof n.value=="function")return Ft(n.value)}e=HS(e)}function s(){return null}return s}function YS(e){try{return Kt(e,""),!0}catch{return!1}}const Tp=ms(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Er=ms(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ar=ms(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),QS=ms(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Rr=ms(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),XS=ms(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Cp=ms(["#text"]),Ep=ms(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Ir=ms(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Ap=ms(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),$l=ms(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),e1=zs(/{{[\w\W]*|^[\w\W]*}}/g),t1=zs(/<%[\w\W]*|^[\w\W]*%>/g),s1=zs(/\${[\w\W]*/g),n1=zs(/^data-[\-\w.\u00B7-\uFFFF]+$/),a1=zs(/^aria-[\-\w]+$/),Rp=zs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),i1=zs(/^(?:\w+script|data):/i),l1=zs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),o1=zs(/^html$/i),r1=zs(/^[a-z][.\w]*(-[.\w]+)+$/i),Qs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},c1=function(){return typeof window>"u"?null:window},d1=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Ip=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function cv(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:c1();const t=Te=>cv(Te);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Qs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,h=en(p,"cloneNode"),m=en(p,"remove"),v=en(p,"nextSibling"),w=en(p,"childNodes"),L=en(p,"parentNode"),x=en(p,"shadowRoot"),g=en(p,"attributes"),b=l&&l.prototype?en(l.prototype,"nodeType"):null,E=l&&l.prototype?en(l.prototype,"nodeName"):null;if(typeof i=="function"){const Te=s.createElement("template");Te.content&&Te.content.ownerDocument&&(s=Te.content.ownerDocument)}let C,O="",A,y=!1,N=0;const F=function(){if(N>0)throw oa('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},T=function(D){F(),N++;try{return C.createHTML(D)}finally{N--}},P=function(D){F(),N++;try{return C.createScriptURL(D)}finally{N--}},q=function(){return y||(A=d1(u,a),y=!0),A},G=s,S=G.implementation,k=G.createNodeIterator,R=G.createDocumentFragment,H=G.getElementsByTagName,Z=n.importNode;let J=Ip();t.isSupported=typeof ov=="function"&&typeof L=="function"&&S&&S.createHTMLDocument!==void 0;const Y=e1,ce=t1,te=s1,de=n1,Ne=a1,B=i1,ie=l1,U=r1;let ee=Rp,ue=null;const Ae=ze({},[...Tp,...Er,...Ar,...Rr,...Cp]);let _=null;const M=ze({},[...Ep,...Ir,...Ap,...$l]);let j=Object.seal(Ha(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),oe=null,ne=null;const le=Object.seal(Ha(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let he=!0,fe=!0,pe=!1,re=!0,xe=!1,ve=!0,_e=!1,Ie=!1,$=!1,ge=!1,ke=!1,Oe=!1,Me=!0,dt=!1;const st="user-content-";let _t=!0,Ot=!1,rt={},Qe=null;const ae=ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Se=null;const Le=ze({},["audio","video","img","source","image","track"]);let Ke=null;const Et=ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ve="http://www.w3.org/1998/Math/MathML",$t="http://www.w3.org/2000/svg",zt="http://www.w3.org/1999/xhtml";let rs=zt,Js=!1,ks=null;const sa=ze({},[Ve,$t,zt],Cr);let Zs=ze({},["mi","mo","mn","ms","mtext"]),Ns=ze({},["annotation-xml"]);const Mn=ze({},["title","style","font","a","script"]);let Ss=null;const Fn=["application/xhtml+xml","text/html"],Lt="text/html";let Xe=null,Ts=null;const Ds=s.createElement("form"),X=function(D){return D instanceof RegExp||D instanceof Function},we=function(){let D=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ts&&Ts===D)return;(!D||typeof D!="object")&&(D={}),D=ss(D),Ss=Fn.indexOf(D.PARSER_MEDIA_TYPE)===-1?Lt:D.PARSER_MEDIA_TYPE,Xe=Ss==="application/xhtml+xml"?Cr:Oi,ue=St(D,"ALLOWED_TAGS")&&ds(D.ALLOWED_TAGS)?ze({},D.ALLOWED_TAGS,Xe):Ae,_=St(D,"ALLOWED_ATTR")&&ds(D.ALLOWED_ATTR)?ze({},D.ALLOWED_ATTR,Xe):M,ks=St(D,"ALLOWED_NAMESPACES")&&ds(D.ALLOWED_NAMESPACES)?ze({},D.ALLOWED_NAMESPACES,Cr):sa,Ke=St(D,"ADD_URI_SAFE_ATTR")&&ds(D.ADD_URI_SAFE_ATTR)?ze(ss(Et),D.ADD_URI_SAFE_ATTR,Xe):Et,Se=St(D,"ADD_DATA_URI_TAGS")&&ds(D.ADD_DATA_URI_TAGS)?ze(ss(Le),D.ADD_DATA_URI_TAGS,Xe):Le,Qe=St(D,"FORBID_CONTENTS")&&ds(D.FORBID_CONTENTS)?ze({},D.FORBID_CONTENTS,Xe):ae,oe=St(D,"FORBID_TAGS")&&ds(D.FORBID_TAGS)?ze({},D.FORBID_TAGS,Xe):ss({}),ne=St(D,"FORBID_ATTR")&&ds(D.FORBID_ATTR)?ze({},D.FORBID_ATTR,Xe):ss({}),rt=St(D,"USE_PROFILES")?D.USE_PROFILES&&typeof D.USE_PROFILES=="object"?ss(D.USE_PROFILES):D.USE_PROFILES:!1,he=D.ALLOW_ARIA_ATTR!==!1,fe=D.ALLOW_DATA_ATTR!==!1,pe=D.ALLOW_UNKNOWN_PROTOCOLS||!1,re=D.ALLOW_SELF_CLOSE_IN_ATTR!==!1,xe=D.SAFE_FOR_TEMPLATES||!1,ve=D.SAFE_FOR_XML!==!1,_e=D.WHOLE_DOCUMENT||!1,ge=D.RETURN_DOM||!1,ke=D.RETURN_DOM_FRAGMENT||!1,Oe=D.RETURN_TRUSTED_TYPE||!1,$=D.FORCE_BODY||!1,Me=D.SANITIZE_DOM!==!1,dt=D.SANITIZE_NAMED_PROPS||!1,_t=D.KEEP_CONTENT!==!1,Ot=D.IN_PLACE||!1,ee=YS(D.ALLOWED_URI_REGEXP)?D.ALLOWED_URI_REGEXP:Rp,rs=typeof D.NAMESPACE=="string"?D.NAMESPACE:zt,Zs=St(D,"MATHML_TEXT_INTEGRATION_POINTS")&&D.MATHML_TEXT_INTEGRATION_POINTS&&typeof D.MATHML_TEXT_INTEGRATION_POINTS=="object"?ss(D.MATHML_TEXT_INTEGRATION_POINTS):ze({},["mi","mo","mn","ms","mtext"]),Ns=St(D,"HTML_INTEGRATION_POINTS")&&D.HTML_INTEGRATION_POINTS&&typeof D.HTML_INTEGRATION_POINTS=="object"?ss(D.HTML_INTEGRATION_POINTS):ze({},["annotation-xml"]);const se=St(D,"CUSTOM_ELEMENT_HANDLING")&&D.CUSTOM_ELEMENT_HANDLING&&typeof D.CUSTOM_ELEMENT_HANDLING=="object"?ss(D.CUSTOM_ELEMENT_HANDLING):Ha(null);if(j=Ha(null),St(se,"tagNameCheck")&&X(se.tagNameCheck)&&(j.tagNameCheck=se.tagNameCheck),St(se,"attributeNameCheck")&&X(se.attributeNameCheck)&&(j.attributeNameCheck=se.attributeNameCheck),St(se,"allowCustomizedBuiltInElements")&&typeof se.allowCustomizedBuiltInElements=="boolean"&&(j.allowCustomizedBuiltInElements=se.allowCustomizedBuiltInElements),xe&&(fe=!1),ke&&(ge=!0),rt&&(ue=ze({},Cp),_=Ha(null),rt.html===!0&&(ze(ue,Tp),ze(_,Ep)),rt.svg===!0&&(ze(ue,Er),ze(_,Ir),ze(_,$l)),rt.svgFilters===!0&&(ze(ue,Ar),ze(_,Ir),ze(_,$l)),rt.mathMl===!0&&(ze(ue,Rr),ze(_,Ap),ze(_,$l))),le.tagCheck=null,le.attributeCheck=null,St(D,"ADD_TAGS")&&(typeof D.ADD_TAGS=="function"?le.tagCheck=D.ADD_TAGS:ds(D.ADD_TAGS)&&(ue===Ae&&(ue=ss(ue)),ze(ue,D.ADD_TAGS,Xe))),St(D,"ADD_ATTR")&&(typeof D.ADD_ATTR=="function"?le.attributeCheck=D.ADD_ATTR:ds(D.ADD_ATTR)&&(_===M&&(_=ss(_)),ze(_,D.ADD_ATTR,Xe))),St(D,"ADD_URI_SAFE_ATTR")&&ds(D.ADD_URI_SAFE_ATTR)&&ze(Ke,D.ADD_URI_SAFE_ATTR,Xe),St(D,"FORBID_CONTENTS")&&ds(D.FORBID_CONTENTS)&&(Qe===ae&&(Qe=ss(Qe)),ze(Qe,D.FORBID_CONTENTS,Xe)),St(D,"ADD_FORBID_CONTENTS")&&ds(D.ADD_FORBID_CONTENTS)&&(Qe===ae&&(Qe=ss(Qe)),ze(Qe,D.ADD_FORBID_CONTENTS,Xe)),_t&&(ue["#text"]=!0),_e&&ze(ue,["html","head","body"]),ue.table&&(ze(ue,["tbody"]),delete oe.tbody),D.TRUSTED_TYPES_POLICY){if(typeof D.TRUSTED_TYPES_POLICY.createHTML!="function")throw oa('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof D.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw oa('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const me=C;C=D.TRUSTED_TYPES_POLICY;try{O=T("")}catch(De){throw C=me,De}}else D.TRUSTED_TYPES_POLICY===null?(C=void 0,O=""):(C===void 0&&(C=q()),C&&typeof O=="string"&&(O=T("")));(J.uponSanitizeElement.length>0||J.uponSanitizeAttribute.length>0)&&ue===Ae&&(ue=ss(ue)),J.uponSanitizeAttribute.length>0&&_===M&&(_=ss(_)),ms&&ms(D),Ts=D},$e=ze({},[...Er,...Ar,...QS]),Je=ze({},[...Rr,...XS]),wt=function(D){let se=L(D);(!se||!se.tagName)&&(se={namespaceURI:rs,tagName:"template"});const me=Oi(D.tagName),De=Oi(se.tagName);return ks[D.namespaceURI]?D.namespaceURI===$t?se.namespaceURI===zt?me==="svg":se.namespaceURI===Ve?me==="svg"&&(De==="annotation-xml"||Zs[De]):!!$e[me]:D.namespaceURI===Ve?se.namespaceURI===zt?me==="math":se.namespaceURI===$t?me==="math"&&Ns[De]:!!Je[me]:D.namespaceURI===zt?se.namespaceURI===$t&&!Ns[De]||se.namespaceURI===Ve&&!Zs[De]?!1:!Je[me]&&(Mn[me]||!$e[me]):!!(Ss==="application/xhtml+xml"&&ks[D.namespaceURI]):!1},ut=function(D){Ma(t.removed,{element:D});try{L(D).removeChild(D)}catch{if(m(D),!L(D))throw oa("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},$n=function(D){const se=w?w(D):D.childNodes;if(se){const De=[];vn(se,Fe=>{Ma(De,Fe)}),vn(De,Fe=>{try{m(Fe)}catch{}})}const me=g?g(D):null;if(me)for(let De=me.length-1;De>=0;--De){const Fe=me[De],Ue=Fe&&Fe.name;if(typeof Ue=="string")try{D.removeAttribute(Ue)}catch{}}},js=function(D,se){try{Ma(t.removed,{attribute:se.getAttributeNode(D),from:se})}catch{Ma(t.removed,{attribute:null,from:se})}if(se.removeAttribute(D),D==="is")if(ge||ke)try{ut(se)}catch{}else try{se.setAttribute(D,"")}catch{}},mi=function(D){const se=g?g(D):D.attributes;if(se)for(let me=se.length-1;me>=0;--me){const De=se[me],Fe=De&&De.name;if(!(typeof Fe!="string"||_[Xe(Fe)]))try{D.removeAttribute(Fe)}catch{}}},vi=function(D){const se=[D];for(;se.length>0;){const me=se.pop();(b?b(me):me.nodeType)===Qs.element&&mi(me);const Fe=w?w(me):me.childNodes;if(Fe)for(let Ue=Fe.length-1;Ue>=0;--Ue)se.push(Fe[Ue])}},Ia=function(D){let se=null,me=null;if($)D="<remove></remove>"+D;else{const Ue=_p(D,/^[\r\n\t ]+/);me=Ue&&Ue[0]}Ss==="application/xhtml+xml"&&rs===zt&&(D='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+D+"</body></html>");const De=C?T(D):D;if(rs===zt)try{se=new d().parseFromString(De,Ss)}catch{}if(!se||!se.documentElement){se=S.createDocument(rs,"template",null);try{se.documentElement.innerHTML=Js?O:De}catch{}}const Fe=se.body||se.documentElement;return D&&me&&Fe.insertBefore(s.createTextNode(me),Fe.childNodes[0]||null),rs===zt?H.call(se,_e?"html":"body")[0]:_e?se.documentElement:Fe},na=function(D){return k.call(D.ownerDocument||D,D,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},Bn=function(D){var se,me;D.normalize();const De=k.call(D.ownerDocument||D,D,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let Fe=De.nextNode();for(;Fe;){let yt=Fe.data;vn([Y,ce,te],it=>{yt=Fa(yt,it," ")}),Fe.data=yt,Fe=De.nextNode()}const Ue=(se=(me=D.querySelectorAll)===null||me===void 0?void 0:me.call(D,"template"))!==null&&se!==void 0?se:[];vn(Array.from(Ue),yt=>{Ys(yt.content)&&Bn(yt.content)})},Un=function(D){const se=E?E(D):null;return typeof se!="string"||Xe(se)!=="form"?!1:typeof D.nodeName!="string"||typeof D.textContent!="string"||typeof D.removeChild!="function"||D.attributes!==g(D)||typeof D.removeAttribute!="function"||typeof D.setAttribute!="function"||typeof D.namespaceURI!="string"||typeof D.insertBefore!="function"||typeof D.hasChildNodes!="function"||D.nodeType!==b(D)||D.childNodes!==w(D)},Ys=function(D){if(!b||typeof D!="object"||D===null)return!1;try{return b(D)===Qs.documentFragment}catch{return!1}},dn=function(D){if(!b||typeof D!="object"||D===null)return!1;try{return typeof b(D)=="number"}catch{return!1}};function Xt(Te,D,se){vn(Te,me=>{me.call(t,D,se,Ts)})}const Oa=function(D){let se=null;if(Xt(J.beforeSanitizeElements,D,null),Un(D))return ut(D),!0;const me=Xe(E?E(D):D.nodeName);if(Xt(J.uponSanitizeElement,D,{tagName:me,allowedTags:ue}),ve&&D.hasChildNodes()&&!dn(D.firstElementChild)&&Kt(/<[/\w!]/g,D.innerHTML)&&Kt(/<[/\w!]/g,D.textContent)||ve&&D.namespaceURI===zt&&me==="style"&&dn(D.firstElementChild)||D.nodeType===Qs.progressingInstruction||ve&&D.nodeType===Qs.comment&&Kt(/<[/\w]/g,D.data))return ut(D),!0;if(oe[me]||!(le.tagCheck instanceof Function&&le.tagCheck(me))&&!ue[me]){if(!oe[me]&&Re(me)&&(j.tagNameCheck instanceof RegExp&&Kt(j.tagNameCheck,me)||j.tagNameCheck instanceof Function&&j.tagNameCheck(me)))return!1;if(_t&&!Qe[me]){const Fe=L(D),Ue=w(D);if(Ue&&Fe){const yt=Ue.length;for(let it=yt-1;it>=0;--it){const vt=Ot?Ue[it]:h(Ue[it],!0);Fe.insertBefore(vt,v(D))}}}return ut(D),!0}return(b?b(D):D.nodeType)===Qs.element&&!wt(D)||(me==="noscript"||me==="noembed"||me==="noframes")&&Kt(/<\/no(script|embed|frames)/i,D.innerHTML)?(ut(D),!0):(xe&&D.nodeType===Qs.text&&(se=D.textContent,vn([Y,ce,te],Fe=>{se=Fa(se,Fe," ")}),D.textContent!==se&&(Ma(t.removed,{element:D.cloneNode()}),D.textContent=se)),Xt(J.afterSanitizeElements,D,null),!1)},K=function(D,se,me){if(ne[se]||Me&&(se==="id"||se==="name")&&(me in s||me in Ds))return!1;const De=_[se]||le.attributeCheck instanceof Function&&le.attributeCheck(se,D);if(!(fe&&!ne[se]&&Kt(de,se))){if(!(he&&Kt(Ne,se))){if(!De||ne[se]){if(!(Re(D)&&(j.tagNameCheck instanceof RegExp&&Kt(j.tagNameCheck,D)||j.tagNameCheck instanceof Function&&j.tagNameCheck(D))&&(j.attributeNameCheck instanceof RegExp&&Kt(j.attributeNameCheck,se)||j.attributeNameCheck instanceof Function&&j.attributeNameCheck(se,D))||se==="is"&&j.allowCustomizedBuiltInElements&&(j.tagNameCheck instanceof RegExp&&Kt(j.tagNameCheck,me)||j.tagNameCheck instanceof Function&&j.tagNameCheck(me))))return!1}else if(!Ke[se]){if(!Kt(ee,Fa(me,ie,""))){if(!((se==="src"||se==="xlink:href"||se==="href")&&D!=="script"&&wp(me,"data:")===0&&Se[D])){if(!(pe&&!Kt(B,Fa(me,ie,"")))){if(me)return!1}}}}}}return!0},be=ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Re=function(D){return!be[Oi(D)]&&Kt(U,D)},es=function(D){Xt(J.beforeSanitizeAttributes,D,null);const se=D.attributes;if(!se||Un(D))return;const me={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:_,forceKeepAttr:void 0};let De=se.length;for(;De--;){const Fe=se[De],Ue=Fe.name,yt=Fe.namespaceURI,it=Fe.value,vt=Xe(Ue),I=it;let z=Ue==="value"?I:qS(I);if(me.attrName=vt,me.attrValue=z,me.keepAttr=!0,me.forceKeepAttr=void 0,Xt(J.uponSanitizeAttribute,D,me),z=me.attrValue,dt&&(vt==="id"||vt==="name")&&wp(z,st)!==0&&(js(Ue,D),z=st+z),ve&&Kt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,z)){js(Ue,D);continue}if(vt==="attributename"&&_p(z,"href")){js(Ue,D);continue}if(me.forceKeepAttr)continue;if(!me.keepAttr){js(Ue,D);continue}if(!re&&Kt(/\/>/i,z)){js(Ue,D);continue}xe&&vn([Y,ce,te],Ee=>{z=Fa(z,Ee," ")});const Q=Xe(D.nodeName);if(!K(Q,vt,z)){js(Ue,D);continue}if(C&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!yt)switch(u.getAttributeType(Q,vt)){case"TrustedHTML":{z=T(z);break}case"TrustedScriptURL":{z=P(z);break}}if(z!==I)try{yt?D.setAttributeNS(yt,Ue,z):D.setAttribute(Ue,z),Un(D)?ut(D):xp(t.removed)}catch{js(Ue,D)}}Xt(J.afterSanitizeAttributes,D,null)},un=function(D){let se=null;const me=na(D);for(Xt(J.beforeSanitizeShadowDOM,D,null);se=me.nextNode();)if(Xt(J.uponSanitizeShadowNode,se,null),Oa(se),es(se),Ys(se.content)&&un(se.content),(b?b(se):se.nodeType)===Qs.element){const Fe=x?x(se):se.shadowRoot;Ys(Fe)&&(Hn(Fe),un(Fe))}Xt(J.afterSanitizeShadowDOM,D,null)},Hn=function(D){const se=[{node:D,shadow:null}];for(;se.length>0;){const me=se.pop();if(me.shadow){un(me.shadow);continue}const De=me.node,Ue=(b?b(De):De.nodeType)===Qs.element,yt=w?w(De):De.childNodes;if(yt)for(let it=yt.length-1;it>=0;--it)se.push({node:yt[it],shadow:null});if(Ue){const it=E?E(De):null;if(typeof it=="string"&&Xe(it)==="template"){const vt=De.content;Ys(vt)&&se.push({node:vt,shadow:null})}}if(Ue){const it=x?x(De):De.shadowRoot;Ys(it)&&se.push({node:null,shadow:it},{node:it,shadow:null})}}};return t.sanitize=function(Te){let D=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},se=null,me=null,De=null,Fe=null;if(Js=!Te,Js&&(Te="<!-->"),typeof Te!="string"&&!dn(Te)&&(Te=ZS(Te),typeof Te!="string"))throw oa("dirty is not a string, aborting");if(!t.isSupported)return Te;Ie||we(D),t.removed=[];const Ue=Ot&&typeof Te!="string"&&dn(Te);if(Ue){const vt=E?E(Te):Te.nodeName;if(typeof vt=="string"){const I=Xe(vt);if(!ue[I]||oe[I])throw oa("root node is forbidden and cannot be sanitized in-place")}if(Un(Te))throw oa("root node is clobbered and cannot be sanitized in-place");try{Hn(Te)}catch(I){throw $n(Te),I}}else if(dn(Te))se=Ia("<!---->"),me=se.ownerDocument.importNode(Te,!0),me.nodeType===Qs.element&&me.nodeName==="BODY"||me.nodeName==="HTML"?se=me:se.appendChild(me),Hn(me);else{if(!ge&&!xe&&!_e&&Te.indexOf("<")===-1)return C&&Oe?T(Te):Te;if(se=Ia(Te),!se)return ge?null:Oe?O:""}se&&$&&ut(se.firstChild);const yt=na(Ue?Te:se);try{for(;De=yt.nextNode();)Oa(De),es(De),Ys(De.content)&&un(De.content)}catch(vt){throw Ue&&$n(Te),vt}if(Ue)return vn(t.removed,vt=>{vt.element&&vi(vt.element)}),xe&&Bn(Te),Te;if(ge){if(xe&&Bn(se),ke)for(Fe=R.call(se.ownerDocument);se.firstChild;)Fe.appendChild(se.firstChild);else Fe=se;return(_.shadowroot||_.shadowrootmode)&&(Fe=Z.call(n,Fe,!0)),Fe}let it=_e?se.outerHTML:se.innerHTML;return _e&&ue["!doctype"]&&se.ownerDocument&&se.ownerDocument.doctype&&se.ownerDocument.doctype.name&&Kt(o1,se.ownerDocument.doctype.name)&&(it="<!DOCTYPE "+se.ownerDocument.doctype.name+`>
`+it),xe&&vn([Y,ce,te],vt=>{it=Fa(it,vt," ")}),C&&Oe?T(it):it},t.setConfig=function(){let Te=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};we(Te),Ie=!0},t.clearConfig=function(){Ts=null,Ie=!1,C=A,O=""},t.isValidAttribute=function(Te,D,se){Ts||we({});const me=Xe(Te),De=Xe(D);return K(me,De,se)},t.addHook=function(Te,D){typeof D=="function"&&Ma(J[Te],D)},t.removeHook=function(Te,D){if(D!==void 0){const se=jS(J[Te],D);return se===-1?void 0:VS(J[Te],se,1)[0]}return xp(J[Te])},t.removeHooks=function(Te){J[Te]=[]},t.removeAllHooks=function(){J=Ip()},t}var Op=cv();function yd(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ra=yd();function dv(e){Ra=e}var Hi={exec:()=>null};function ot(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(fs.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var fs={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},u1=/^(?:[ \t]*(?:\n|$))+/,p1=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,f1=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,yl=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,h1=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,xd=/(?:[*+-]|\d{1,9}[.)])/,uv=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,pv=ot(uv).replace(/bull/g,xd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),m1=ot(uv).replace(/bull/g,xd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),_d=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,v1=/^[^\n]+/,wd=/(?!\s*\])(?:\\.|[^\[\]\\])+/,g1=ot(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",wd).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),b1=ot(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,xd).getRegex(),er="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",kd=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,y1=ot("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",kd).replace("tag",er).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),fv=ot(_d).replace("hr",yl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",er).getRegex(),x1=ot(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",fv).getRegex(),Sd={blockquote:x1,code:p1,def:g1,fences:f1,heading:h1,hr:yl,html:y1,lheading:pv,list:b1,newline:u1,paragraph:fv,table:Hi,text:v1},Lp=ot("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",yl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",er).getRegex(),_1={...Sd,lheading:m1,table:Lp,paragraph:ot(_d).replace("hr",yl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Lp).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",er).getRegex()},w1={...Sd,html:ot(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",kd).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Hi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ot(_d).replace("hr",yl).replace("heading",` *#{1,6} *[^
...
`,e=e.substring(p.length+1),r=!0),!r){const L=this.rules.other.nextBulletRegex(m),x=this.rules.other.hrRegex(m),g=this.rules.other.fencesBeginRegex(m),b=this.rules.other.headingBeginRegex(m),E=this.rules.other.htmlBeginRegex(m);for(;e;){const C=e.split(`
`,1)[0];let O;if(p=C,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),O=p):O=p.replace(this.rules.other.tabCharGlobal,"    "),g.test(p)||b.test(p)||E.test(p)||L.test(p)||x.test(p))break;if(O.search(this.rules.other.nonSpaceChar)>=m||!p.trim())d+=`
`+O.slice(m);else{if(h||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||g.test(u)||b.test(u)||x.test(u))break;d+=`
`+p}!h&&!p.trim()&&(h=!0),c+=C+`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+tn(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ka=new G1;function at(e,t){return ka.parse(e,t)}at.options=at.setOptions=function(e){return ka.setOptions(e),at.defaults=ka.defaults,dv(at.defaults),at};at.getDefaults=yd;at.defaults=Ra;at.use=function(...e){return ka.use(...e),at.defaults=ka.defaults,dv(at.defaults),at};at.walkTokens=function(e,t){return ka.walkTokens(e,t)};at.parseInline=ka.parseInline;at.Parser=Tn;at.parser=Tn.parse;at.Renderer=So;at.TextRenderer=Ed;at.Lexer=Sn;at.lexer=Sn.lex;at.Tokenizer=ko;at.Hooks=Gl;at.parse=at;at.options;at.setOptions;at.use;at.walkTokens;at.parseInline;Tn.parse;Sn.lex;const K1={breaks:!0,gfm:!0};function Fp(e){if(!e)return"";try{if(typeof at<"u"&&at.parse){const t=at.parse(e,K1);return typeof Op<"u"?Op.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function W1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const J1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Z1(e){return J1[e]||"wrench"}const Y1=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function $p(e){if(!e)return[];const t=e.match(Y1);return t?[...new Set(t)]:[]}const Q1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),n=f(""),a=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=W(()=>t.value.trim().length>0&&!s.value),p=f(Ye.state||"disconnected");let h=null;const m=W(()=>{const S=p.value;return S==="connected"?"Connected":S==="reconnecting"?"Reconnecting…":S==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],w=W(()=>{const S=Math.floor(l.value/4)%v.length,k=l.value;return k>3?`${v[S]} (${k}s)`:v[0]});function L(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function x(){if(!i.value)return;const S=i.value;S.style.height="auto",S.style.height=Math.min(S.scrollHeight,120)+"px"}function g(S,k,R={}){const H={id:++c,role:S,content:k,timestamp:Date.now(),html:S==="bot"?Fp(k):"",tools_used:R.tools_used||[],is_error:R.is_error||!1,images:S==="bot"?$p(k):[],files:R.files||[],_showTools:!1};return e.value.push(H),L(),S==="bot"&&Rt(()=>b()),H}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(k=>{k.setAttribute("data-copy","true"),k.style.position="relative";const R=document.createElement("button");R.className="chat-code-copy",R.textContent="Copy",R.addEventListener("click",()=>{const H=k.querySelector("code"),Z=H?H.textContent:k.textContent;navigator.clipboard.writeText(Z).then(()=>{R.textContent="Copied!",setTimeout(()=>{R.textContent="Copy"},1500)}).catch(()=>{})}),k.appendChild(R)})}function E(S){if(S===0)return!0;const k=e.value[S-1],R=e.value[S],H=new Date(k.timestamp).toDateString(),Z=new Date(R.timestamp).toDateString();return H!==Z}function C(S){const k=new Date(S),R=new Date;if(k.toDateString()===R.toDateString())return"Today";const H=new Date(R);return H.setDate(H.getDate()-1),k.toDateString()===H.toDateString()?"Yesterday":k.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function O(S){t.value=S,Rt(()=>q())}function A(S){window.open(S,"_blank","noopener")}function y(S){S.target.style.display="none"}function N(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function F(){r&&(clearInterval(r),r=null),l.value=0}function T(S){s.value&&(s.value=!1,F(),S.type==="chat_response"?g("bot",S.content,{tools_used:S.tools_used||[],is_error:S.is_error||!1,files:S.files||[]}):S.type==="chat_error"&&g("bot",S.error||"Unknown error",{is_error:!0}),Rt(()=>{var k;return(k=i.value)==null?void 0:k.focus()}))}async function P(S){try{const k=await V.post("/api/chat",{content:S,channel_id:o.value});g("bot",k.response,{tools_used:k.tools_used||[],is_error:k.is_error||!1,files:k.files||[]})}catch(k){g("bot",k.message||"Failed to send message",{is_error:!0})}}async function q(){const S=t.value.trim();if(!S||s.value)return;g("user",S),t.value="",s.value=!0,N(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(S,{channelId:o.value})||(await P(S),s.value=!1,F()),Rt(()=>{var R;return(R=i.value)==null?void 0:R.focus()})}async function G(){n.value="";try{if(!o.value){const k=await V.get("/api/auth/session");o.value=k.channel_id||k.user_id||"web-user"}const S=await V.get("/api/sessions/"+encodeURIComponent(o.value));if(S&&S.messages&&S.messages.length>0){for(const k of S.messages){const R=k.role==="user"?"user":"bot";let H=k.content||"";if(R==="user"){const J=H.match(/^\[.*?\]:\s*/);J&&(H=H.slice(J[0].length))}if(!H.trim())continue;const Z={id:++c,role:R,content:H,timestamp:k.timestamp?k.timestamp*1e3:Date.now(),html:R==="bot"?Fp(H):"",tools_used:[],is_error:!1,images:R==="bot"?$p(H):[],files:[],_showTools:!1};e.value.push(Z)}Rt(()=>{L(),b()})}}catch(S){S&&S.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",ye.error(n.value))}}return je(()=>{Ye.subscribe("chat",T),p.value=Ye.state||"disconnected",h=Ye.onState(S=>{p.value=S}),G(),Rt(()=>{var S;return(S=i.value)==null?void 0:S.focus()})}),ft(()=>{Ye.unsubscribe("chat",T),h&&(h(),h=null),F()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:w,suggestions:d,send:q,autoResize:x,formatTime:W1,formatDate:C,showDateSeparator:E,useSuggestion:O,openImage:A,onImageError:y,getToolIcon:Z1,loadHistory:G}}},X1={setup(){const e=f("odin"),t=f(""),s=f(""),n=f(""),a=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),h=f(!1),m=W(()=>e.value==="custom"),v=W(()=>[...i.value,...l.value]),w=W(()=>l.value.includes(e.value)),L=W(()=>{var A;return m.value?t.value||"Odin":((A=a.value[e.value])==null?void 0:A.name)||e.value}),x=W(()=>{var A;return m.value?s.value||"(empty — will use Odin default)":((A=a.value[e.value])==null?void 0:A.identity)||""}),g=W(()=>{var A;return m.value?n.value||"(empty — will use Odin default)":((A=a.value[e.value])==null?void 0:A.voice)||""});async function b(){d.value=!0;try{const A=await V.get("/api/personality");e.value=A.preset||"odin",t.value=A.custom_name||"",s.value=A.custom_identity||"",n.value=A.custom_voice||"",a.value=A.presets||{},i.value=A.builtin_presets||[],l.value=A.user_presets||[]}catch(A){c.value=A.message}finally{d.value=!1}}async function E(){o.value=!0,c.value=null,r.value=!1;try{await V.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(A){c.value=A.message}finally{o.value=!1}}async function C(){const A=u.value.trim();if(A){h.value=!0,c.value=null;try{await V.post("/api/personality/presets",{name:A,display_name:L.value,identity:x.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=A.toLowerCase().replace(/ /g,"_")}catch(y){c.value=y.message}finally{h.value=!1}}}async function O(){if(await qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await V.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(y){c.value=y.message}}}return je(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:w,previewName:L,previewIdentity:x,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:E,showSavePreset:p,newPresetName:u,savingPreset:h,saveAsPreset:C,deletePreset:O,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),_v=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:DS,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:Q1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:Yw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:lk,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Ek,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:X1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:ES,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/hosts",redirect:kt("/system","hosts")},{path:"/internals",redirect:kt("/system","internals")}],zi=Cw({history:aw(),routes:_v});zi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const eT={template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=f(""),s=f(null),n=f(!1),a=f(!1);async function i(){n.value=!0,s.value=null;try{V.setPersist(a.value),await V.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{n.value=!1}}return{token:t,error:s,busy:n,persist:a,login:i}}},tT={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),n=f(!1),a=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let h=null;const m=f("starting"),v=f(""),w=_v.filter(H=>H.meta),L=W(()=>["Workspace","Operate","Observe","Manage"].map(H=>({name:H,routes:w.filter(Z=>Z.meta.section===H)})).filter(H=>H.routes.length)),x=W(()=>{var H;return((H=zi.currentRoute.value.meta)==null?void 0:H.label)||"Odin"}),g=W(()=>{var H;return((H=zi.currentRoute.value.meta)==null?void 0:H.section)||"Management"}),b=W(()=>{var H;return((H=zi.currentRoute.value.meta)==null?void 0:H.description)||"Management console"});function E(){Ye.disconnect(),q&&(clearInterval(q),q=null)}V.onSessionExpired=()=>{t.value=!0,E(),V.setToken(""),e.value="login"};function C(H){var Z;if((H.ctrlKey||H.metaKey)&&H.key.toLowerCase()==="k"){e.value==="ready"&&(H.preventDefault(),vp());return}if(n.value&&H.key==="Tab"){const J=[...((Z=a.value)==null?void 0:Z.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(J.length){const Y=J[0],ce=J[J.length-1];if(H.shiftKey&&(document.activeElement===Y||!a.value.contains(document.activeElement))){H.preventDefault(),ce.focus();return}if(!H.shiftKey&&(document.activeElement===ce||!a.value.contains(document.activeElement))){H.preventDefault(),Y.focus();return}}}if(H.key==="Escape"&&n.value){n.value=!1,H.preventDefault();return}if(H.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(H.target.tagName)){H.preventDefault();const J=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');J&&J.focus()}}function O(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}je(async()=>{document.addEventListener("keydown",C),o=window.matchMedia("(max-width: 900px)"),O(),o.addEventListener("change",O);const H=await V.check();H.ok?(e.value="ready",k()):H.needsAuth?e.value="login":(e.value="ready",k())});function A(){t.value=!1,e.value="ready",k()}async function y(){E(),e.value="login",await V.logout()}function N(){s.value=!s.value}function F(){n.value=!n.value}Mt(n,async H=>{var Z,J;if(H)r=document.activeElement,await Rt(),(J=(Z=a.value)==null?void 0:Z.querySelector(".nav-item"))==null||J.focus();else if(r!=null&&r.isConnected){const Y=r;r=null,requestAnimationFrame(()=>Y.focus())}});const T=W(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(H,Z="info",J=3e3){p.value={text:H,level:Z},clearTimeout(h),h=setTimeout(()=>{p.value=null},J)}let q=null,G=!1,S=[];function k(){for(const H of S)H();S=[Ye.onStatus(H=>{c.value=H}),Ye.onLatencyChange(H=>{u.value=H}),Ye.onState((H,Z)=>{d.value=H,H==="connected"?(G&&P("Connection restored","success"),G=!0):H==="reconnecting"&&Z.attempt===1&&P("Connection lost — reconnecting…","warn")})],Ye.connect(),R(),q&&clearInterval(q),q=setInterval(R,15e3)}async function R(){try{const H=await V.get("/api/status");m.value=H.status==="online"?"online":"starting";const Z=H.uptime_seconds||0,J=Math.floor(Z/3600),Y=Math.floor(Z%3600/60);v.value=`${J}h ${Y}m uptime`}catch{m.value="offline",v.value=""}}return ft(()=>{q&&clearInterval(q);for(const H of S)H();S=[],Ye.disconnect(),document.removeEventListener("keydown",C),o==null||o.removeEventListener("change",O)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:T,wsToast:p,botStatus:m,botUptime:v,navRoutes:w,navGroups:L,currentPage:x,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:A,logout:y,toggleSidebar:N,toggleMobileNavigation:F,openPalette:vp}}},ta=uo(tT);ta.component("odin-icon",OS);ta.component("login-screen",eT);ta.component("toast-container",b_);ta.component("confirm-host",y_);ta.component("command-palette",IS);ta.directive("modal-focus",NS);ta.use(zi);ta.mount("#app");
