...
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const vu=Object.create(null);function q0(e,t){if(!Pe(e))if(e.nodeType)e=e.innerHTML;else return zt;const s=rg(e,t),n=vu[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=Ve({hoistStatic:!0,onError:void 0,onWarn:zt},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=V0(e,a),l=new Function("Vue",i)(Qy);return l._rc=!0,vu[s]=l}zf(q0);const or=zn({items:[]});let G0=1;function Dr(e,t="info",s=3e3){const n=G0++;return or.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>Wc(n),s),n}function Wc(e){const t=or.items.findIndex(s=>s.id===e);t>=0&&or.items.splice(t,1)}function Ce(e,t="info",s=3e3){return Dr(e,t,s)}Ce.success=(e,t=3e3)=>Dr(e,"success",t);Ce.error=(e,t=5e3)=>Dr(e,"error",t);Ce.info=(e,t=3e3)=>Dr(e,"info",t);Ce.dismiss=Wc;const K0={setup(){return{state:or,dismiss:Wc}},template:`
...
... (truncated)`:s}function Du(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function wm(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Sm=Symbol("agent-detail-cancelled"),iw=15e3;function lw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((f,g)=>{o=f,c=g});function u(f,g){r||(r=!0,l!==null&&a(l),l=null,(f?o:c)(g))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return r||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sm),i==null||i.abort()}}}function Tm({state:e,requestDetail:t,timeoutMs:s=iw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const p=l;l=null,p==null||p.cancel()}function o(p,{initial:f,coalesce:g}){if(!p)return Promise.resolve();if(g&&l&&l.agentId===p&&e.detailId===p)return l.promise;r();const b={agentId:p,cancel:null,promise:null};l=b,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const E=lw(O=>t(p,{signal:O}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return b.cancel=E.cancel,b.promise=(async()=>{let O=null,y=null;try{O=await E.promise}catch(m){y=m}O!==Sm&&(l!==b||e.detailId!==p||(l=null,!y&&(O===null||typeof O!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=O,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,o(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?o(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function rw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const ow={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const r=Z(()=>e.value.filter(I=>I.status==="running").length),o=Z(()=>e.value.filter(I=>I.status==="completed").length),c=Z(()=>e.value.filter(I=>["failed","timeout","killed"].includes(I.status)).length),d=Z(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),u=Z(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(I=>["failed","timeout","killed"].includes(I.status)):e.value.filter(I=>I.status===i.value));function p(I){const te=Number(I.max_iterations)||0;return te<=0?0:Math.min(100,Math.round(I.iteration_count/te*100))}function f(I){return(Number(I.max_iterations)||0)>0}function g(I,te){return I?I==="N/A"?"N/A":te==="current_inheritance"?`inherit (currently ${I})`:I:"unknown"}function b(I){return g(I.display_model,I.display_model_source||I.display_source)}function E(I){return g(I.display_reasoning_effort,I.display_reasoning_effort_source||I.display_source)}function O(I){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[I]||""}const y=h(null),m=h(null),x=h(!1),S=h(null),v=h(""),T=Tm({state:{get detail(){return y.value},set detail(I){y.value=I},get detailId(){return m.value},set detailId(I){m.value=I},get detailLoading(){return x.value},set detailLoading(I){x.value=I},get detailError(){return S.value},set detailError(I){S.value=I}},requestDetail:(I,{signal:te})=>G.get(`/api/agents/${encodeURIComponent(I)}`,{signal:te})});async function C(I){v.value="",await T.open(I.id)}function D(){T.close(),v.value=""}async function H(){await T.refresh()}async function F(I,te){try{await navigator.clipboard.writeText(te||""),v.value=I,setTimeout(()=>{v.value===I&&(v.value="")},1500)}catch{Ce.error("Copy failed")}}async function A(I=!1){I=I===!0,I||(t.value=!0);try{const te=await G.get("/api/agents");e.value=Array.isArray(te)?te:[],s.value=null}catch(te){I||(s.value=te.message)}I||(t.value=!1)}async function V(I){const te=e.value.find(ke=>ke.id===I);if(await Zt({title:"Kill agent",message:`Kill agent "${(te==null?void 0:te.label)||I}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=I;try{await G.del(`/api/agents/${encodeURIComponent(I)}`),Ce.success("Agent killed"),await A()}catch(ke){Ce.error(ke.message||"Failed to kill agent")}n.value=null}}const ee=rw({isEnabled:()=>a.value&&l,refreshList:()=>A(!0),hasOpenDetail:()=>!!m.value,refreshDetail:H});function U(){ee.start()}function N(){ee.stop()}return as(a,()=>ee.sync()),Ze(()=>{l=!0,A(),U()}),ws(()=>{l=!0,A(!0),U()}),ks(()=>{l=!1,N()}),xt(()=>{l=!1,N(),T.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ba,formatDuration:si,progressPercent:p,hasProgress:f,displayModelText:b,displayEffortText:E,displaySourceLabel:O,detail:y,detailId:m,detailLoading:x,detailError:S,copied:v,openDetail:C,closeDetail:D,copyText:F,fetchAgents:A,killAgent:V,startAutoRefresh:U,stopAutoRefresh:N}}},cw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),r=h(null),o=Z(()=>hw(a.value.run_at));as(()=>a.value.run_at,()=>{r.value=null});const c=Z(()=>{var B;const W=o.value;return W.state==="ok"?W.instant:W.state==="ambiguous"&&r.value!==null&&((B=W.options[r.value])==null?void 0:B.instant)||null}),d=Z(()=>{const W=c.value;return W?`${W.toLocaleString()} local — ${W.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],g=h(null),b=h(null),E=h(null),O=h(null),y=h(null),m=h(null),x=h([]),S=h(!1),v=h("");let k=0;const T=Z(()=>e.value.filter(W=>W.cron&&!W.one_time).length),C=Z(()=>e.value.filter(W=>W.one_time).length),D=Z(()=>e.value.filter(W=>W.trigger).length),H=Z(()=>e.value.filter(W=>W.paused).length),F=Z(()=>e.value.filter(W=>W.consecutive_failures>0).length);function A(W){if(!W)return"-";const B=Date.now(),re=(new Date(W).getTime()-B)/1e3;if(re<0)return"overdue";if(re<60)return"in < 1 min";if(re<3600)return`in ${Math.floor(re/60)} min`;if(re<86400){const ve=Math.floor(re/3600),$e=Math.floor(re%3600/60);return $e>0?`in ${ve}h ${$e}m`:`in ${ve}h`}const ye=Math.floor(re/86400);return`in ${ye} day${ye!==1?"s":""}`}function V(W){return W==null?"-":W<1e3?`${W}ms`:W<6e4?`${(W/1e3).toFixed(1)}s`:si(W/1e3)}function ee(W=a.value.cron){a.value.cron=W,Pu(a.value,"cron"),u.value=null}function U(W=a.value.run_at){a.value.run_at=W,Pu(a.value,"run_at"),u.value=null}async function N(){const W=a.value.cron.trim();if(W){p.value=!0;try{u.value=await G.post("/api/schedules/validate-cron",{expression:W})}catch(B){u.value={valid:!1,error:B.message}}p.value=!1}}async function I(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(W){s.value=W.message}t.value=!1}async function te(W){if(m.value===W){m.value=null,x.value=[];return}m.value=W,S.value=!0,x.value=[];const B=++k;try{const le=await G.get(`/api/schedules/${encodeURIComponent(W)}/history?limit=10`);if(B!==k||m.value!==W)return;x.value=le,v.value=""}catch(le){if(B!==k||m.value!==W)return;x.value=[],v.value=le.message||"Failed to load execution history"}B===k&&(S.value=!1)}async function Te(){l.value=null;const W=a.value;if(!W.description.trim()){l.value="Description is required";return}if(!W.channel_id.trim()){l.value="Channel ID is required";return}if(!W.cron.trim()&&!W.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(W.cron.trim()&&W.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const B={description:W.description.trim(),action:W.action,channel_id:W.channel_id.trim()};if(W.cron.trim()&&(B.cron=W.cron.trim()),W.run_at.trim()){const le=o.value;if(le.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(le.state==="invalid"){l.value="One-time run time is not a valid date";return}const re=c.value;if(le.state==="ambiguous"&&r.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!re){l.value="One-time run time could not be resolved";return}B.run_at=re.toISOString()}if(W.action==="reminder"&&W.message.trim()&&(B.message=W.message.trim()),W.action==="check"&&(W.tool_name.trim()&&(B.tool_name=W.tool_name.trim()),W.report_format&&(B.report_format=W.report_format),W.tool_input_str.trim()))try{B.tool_input=JSON.parse(W.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",B),Ce.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await I()}catch(le){l.value=le.message}i.value=!1}async function ke(W){g.value=W;try{const B=await G.post(`/api/schedules/${encodeURIComponent(W)}/run`);if(B.status==="failure")Ce.error(`Execution failed: ${B.error||"unknown error"}`);else{const le=B.warning?`Executed (${B.warning})`:"Executed successfully";Ce.success(le)}await I()}catch(B){Ce.error(B.message||"Failed to trigger")}g.value=null}async function oe(W){E.value=W.id;const B=!W.paused;try{await G.put(`/api/schedules/${encodeURIComponent(W.id)}`,{paused:B}),Ce.success(B?"Schedule paused":"Schedule resumed"),await I()}catch(le){Ce.error(le.message||"Failed to update schedule")}E.value=null}async function me(W,B){y.value=W.id;try{await G.put(`/api/schedules/${encodeURIComponent(W.id)}`,{report_format:B}),Ce.success(B?"Structured report enabled":"Plain-text report enabled")}catch(le){Ce.error(`Update failed: ${le.message}`)}finally{await I(),y.value=null}}async function ie(W){O.value=W;try{await G.post(`/api/schedules/${encodeURIComponent(W)}/reset-failures`),Ce.success("Failure counters reset"),await I()}catch(B){Ce.error(B.message||"Failed to reset")}O.value=null}async function ge(W){const B=e.value.find(re=>re.id===W);if(await Zt({title:"Delete schedule",message:`Delete "${(B==null?void 0:B.description)||W}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){b.value=W;try{await G.del(`/api/schedules/${encodeURIComponent(W)}`),Ce.success("Schedule deleted"),await I()}catch(re){Ce.error(re.message||"Failed to delete schedule")}b.value=null}}return Ze(()=>{I()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:o,runAtOccurrence:r,cronResult:u,validatingCron:p,cronPresets:f,runningId:g,deletingId:b,togglingId:E,resettingId:O,reportUpdatingId:y,expandedId:m,history:x,historyLoading:S,historyError:v,cronCount:T,oneTimeCount:C,webhookCount:D,pausedCount:H,failingCount:F,formatTs:ba,formatAge:xm,formatFuture:A,formatMs:V,formatDuration:si,onCronInput:ee,onRunAtInput:U,validateCron:N,toggleExpand:te,fetchSchedules:I,doCreate:Te,doRunNow:ke,doTogglePause:oe,doUpdateReportFormat:me,doResetFailures:ie,doDelete:ge}}},Cm=[{id:"live",label:"Live",component:nw},{id:"agents",label:"Agents",component:ow},{id:"loops",label:"Loops",component:cw},{id:"processes",label:"Processes",component:dw},{id:"schedules",label:"Schedules",component:mw}],gw={components:{TabbedPage:$r},setup(){return{tabs:Cm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const r=h(null),o=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),g=h(!1),b=Fu,E=bw,O=h([]),y=h(!1),m=h(""),x=h("flat"),S=h(new Set),v=h(""),k=h(""),T=h(""),C=h(null),D=h(!1);function H(){try{const Y=localStorage.getItem("odin-session-presets");Y&&(O.value=JSON.parse(Y))}catch{}}function F(){try{localStorage.setItem("odin-session-presets",JSON.stringify(O.value))}catch{}}const A=Z(()=>p.value.trim()!==""||u.value!=="all"),V=Z(()=>{let Y=[...e.value];const we=Fu.find(Ue=>Ue.id===u.value),Ee=we?we.filters:{};if(Ee.source&&(Y=Y.filter(Ue=>Ue.source===Ee.source)),Ee.minMessages&&(Y=Y.filter(Ue=>Ue.message_count>=Ee.minMessages)),Ee.hasCompaction&&(Y=Y.filter(Ue=>Ue.has_summary)),Ee.maxAge!=null){const Ue=Date.now()/1e3;Y=Y.filter(mt=>mt.last_active&&Ue-mt.last_active<=Ee.maxAge)}if(p.value.trim()){const Ue=p.value.toLowerCase().trim();Y=Y.filter(mt=>(mt.channel_id||"").toLowerCase().includes(Ue)||(mt.last_user_id||"").toLowerCase().includes(Ue)||(mt.source||"").toLowerCase().includes(Ue))}const Oe=f.value,Ge=g.value?1:-1;return Y.sort((Ue,mt)=>{const Yt=Ue[Oe]||0,Ds=mt[Oe]||0;return(Yt-Ds)*Ge}),Y}),ee=Z(()=>{if(!a.value||!a.value.messages)return[];const Y=a.value.messages;if(Y.length===0)return[];const we=[];let Ee=[];for(const Oe of Y)Oe.role==="user"&&Ee.length>0&&(we.push(Ee),Ee=[]),Ee.push(Oe);return Ee.length>0&&we.push(Ee),we}),U=Z(()=>V.value.length>0&&c.value.size===V.value.length);function N(Y){const we=Y.find(Ee=>Ee.role==="user");if(we&&we.content){const Ee=we.content.slice(0,120);return Ee.length<we.content.length?Ee+"...":Ee}return"(no user message)"}function I(Y){const we=new Set(S.value);we.has(Y)?we.delete(Y):we.add(Y),S.value=we}function te(Y){u.value=Y}function Te(Y){u.value=Y.id,Y.filters.searchQuery!=null&&(p.value=Y.filters.searchQuery),Y.filters.sortBy&&(f.value=Y.filters.sortBy)}function ke(){if(!m.value.trim())return;const Y={id:"custom-"+Date.now(),name:m.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};O.value=[...O.value,Y],F(),y.value=!1,m.value=""}function oe(Y){O.value=O.value.filter(we=>we.id!==Y),F(),u.value===Y&&(u.value="all")}function me(){u.value="all",p.value="",f.value="last_active",g.value=!1}function ie(Y){if(!Y)return"—";const we=Date.now()/1e3-Y;if(we<60)return"just now";if(we<3600){const Oe=Math.floor(we/60);return`${Oe} minute${Oe!==1?"s":""} ago`}if(we<86400){const Oe=Math.floor(we/3600);return`${Oe} hour${Oe!==1?"s":""} ago`}const Ee=Math.floor(we/86400);return`${Ee} day${Ee!==1?"s":""} ago`}function ge(Y){if(!Y)return"";try{return new Date(Y*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function W(Y){if(!Y)return"";try{return new Date(Y*1e3).toLocaleString()}catch{return""}}function B(Y){return Y==="user"?"bg-gray-900/50 border border-gray-800":Y==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function le(Y){return Y==="user"?"sess-msg-user":Y==="assistant"?"sess-msg-assistant":"sess-msg-system"}function re(Y){return Y==="user"?"badge-info":Y==="assistant"?"badge-success":"badge-warning"}function ye(Y){return Y==="user"?"sess-dot-user":Y==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ve(Y){return Y==="user"?"text-cyan-400":Y==="assistant"?"text-indigo-400":"text-gray-500"}function $e(Y){return Y?Y.length>2e3?Y.slice(0,2e3)+`
... (truncated)`:Y:""}async function w(){const Y=v.value.trim();if(Y){D.value=!0;try{let we=`/api/sessions/search?q=${encodeURIComponent(Y)}&limit=50`;k.value.trim()&&(we+=`&channel_id=${encodeURIComponent(k.value.trim())}`),T.value.trim()&&(we+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Ee=await G.get(we);C.value=Ee.results||[]}catch{C.value=[]}D.value=!1}}function L(){v.value="",k.value="",T.value="",C.value=null}function $(Y){return Y?Y.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function ae(Y){return Y==="user"?"fts-result-user":Y==="assistant"?"fts-result-assistant":Y==="summary"?"fts-result-summary":Y==="fts"?"fts-result-fts":Y==="channel"?"fts-result-channel":"fts-result-default"}function J(Y){return Y==="user"?"badge-info":Y==="assistant"?"badge-success":Y==="summary"?"badge-warning":Y==="fts"?"badge-success":"badge-info"}async function se(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(Y){s.value=Y.message}t.value=!1}function fe(){s.value=null,se()}async function P(Y){if(n.value===Y){n.value=null,a.value=null,S.value=new Set;return}n.value=Y,a.value=null,i.value=!0,S.value=new Set;const we=++l;try{const Ee=await G.get(`/api/sessions/${encodeURIComponent(Y)}`);we===l&&n.value===Y&&(a.value=Ee)}catch(Ee){we===l&&n.value===Y&&(a.value={messages:[],summary:"",error:Ee.message||"Failed to load session"})}finally{we===l&&(i.value=!1)}}function X(Y){const we=new Set(c.value);we.has(Y)?we.delete(Y):we.add(Y),c.value=we}function K(){U.value?c.value=new Set:c.value=new Set(V.value.map(Y=>Y.channel_id))}function ne(Y){r.value=Y}async function ce(){if(r.value){o.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await se()}catch(Y){s.value=Y.message||"Failed to clear session"}o.value=!1,r.value=null}}function be(){d.value=!0}async function Ae(){if(c.value.size!==0){o.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await se()}catch(Y){s.value=Y.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}async function Me(Y,we){const Ee=`/api/sessions/${encodeURIComponent(Y)}/export?format=${we}`;try{const Oe=await G.getBlob(Ee),Ge=URL.createObjectURL(Oe),Ue=document.createElement("a");Ue.href=Ge,Ue.download=`session-${Y}.${we==="text"?"txt":"json"}`,Ue.click(),URL.revokeObjectURL(Ge)}catch(Oe){s.value=Oe.message||"Failed to export session"}}let De=null;function Fe(Y){Y.payload&&Y.payload.channel_id&&(clearTimeout(De),De=setTimeout(()=>{if(se(),n.value&&Y.payload.channel_id===n.value){const we=n.value,Ee=l;G.get(`/api/sessions/${encodeURIComponent(we)}`).then(Oe=>{Ee!==l||n.value!==we||(a.value=Oe)}).catch(()=>{})}},2e3))}let ze=!1;function qe(){ze||(ze=!0,se(),je.subscribe("events",Fe))}Ze(()=>{H(),qe()}),ws(()=>{qe()});function dt(){ze&&(ze=!1,je.unsubscribe("events",Fe),clearTimeout(De))}return ks(dt),xt(dt),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:U,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:g,filterPresets:b,sortOptions:E,filteredSessions:V,hasActiveFilters:A,customPresets:O,showSavePreset:y,newPresetName:m,threadView:x,threads:ee,collapsedThreads:S,ftsQuery:v,ftsChannelId:k,ftsUserId:T,ftsResults:C,ftsSearching:D,formatAge:ie,formatTimestamp:ge,formatFullTimestamp:W,messageClass:B,threadMsgClass:le,roleBadge:re,roleDotClass:ye,roleLabelClass:ve,truncateContent:$e,threadSummary:N,fetchSessions:se,retry:fe,toggleSession:P,toggleSelect:X,toggleSelectAll:K,confirmClear:ne,clearSession:ce,confirmBulkClear:be,doBulkClear:Ae,exportSession:Me,applyPreset:te,applyCustomPreset:Te,saveCustomPreset:ke,removeCustomPreset:oe,resetFilters:me,toggleThread:I,runFtsSearch:w,clearFtsSearch:L,highlightSnippet:$,ftsResultClass:ae,ftsTypeBadge:J}}},xw={props:["trace"],template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),a=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),i=h("user");let l=null;const r=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],o=Z(()=>[...n.value.recent||[]].reverse()),c=async()=>{try{const g=await G.get("/api/usage");n.value=g,a.value=g.totals||a.value,t.value=null,s.value=!0}catch(g){t.value=g.message}finally{e.value=!1}},d=()=>{e.value=!0,c()};let u=!1;function p(){u||(u=!0,c(),l||(l=setInterval(c,15e3)))}function f(){u&&(u=!1,l&&(clearInterval(l),l=null))}return Ze(p),ws(p),ks(f),xt(f),{hasData:s,loading:e,error:t,data:n,totals:a,activeTab:i,tabs:r,recentReversed:o,fmtNum:wm,formatTime:ym,retry:d}}},Em=[{id:"audit",label:"Audit",component:vw},{id:"sessions",label:"Sessions",component:yw},{id:"traces",label:"Traces",component:_w},{id:"usage",label:"Usage",component:ww}],kw={components:{TabbedPage:$r},setup(){return{tabs:Em}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},io=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),r=h(null),o=Z(()=>e.value.filter(y=>y.is_core).length),c=Z(()=>e.value.filter(y=>!y.is_core).length),d=Z(()=>Object.values(a.value).reduce((y,m)=>y+m,0));function u(y){for(const m of io)if(m.id!=="other"&&m.match(y))return m.id;return"other"}const p=Z(()=>{let y=e.value;if(n.value){const m=n.value.toLowerCase();y=y.filter(x=>x.name.toLowerCase().includes(m)||(x.description||"").toLowerCase().includes(m))}return r.value&&(y=y.filter(m=>u(m.name)===r.value)),y}),f=Z(()=>{const y=new Set;for(const m of e.value)y.add(u(m.name));return io.filter(m=>y.has(m.id))}),g=Z(()=>{const y=p.value,m={};for(const S of y){const v=u(S.name);m[v]||(m[v]=[]),m[v].push(S)}const x=[];for(const S of io)m[S.id]&&m[S.id].length>0&&x.push({label:S.label,icon:S.icon,tools:m[S.id].sort((v,k)=>v.name.localeCompare(k.name))});return x});function b(y){i.value={...i.value,[y]:!i.value[y]}}async function E(){t.value=!0,s.value=null;try{const[y,m]=await Promise.all([G.get("/api/tools"),G.get("/api/tools/stats").catch(()=>({}))]);e.value=y,a.value=m||{};const x=Object.values(m||{}).filter(S=>S>0).sort((S,v)=>S-v)}catch(y){s.value=y.message}t.value=!1}function O(){E()}return Ze(()=>{E()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,coreCount:o,skillCount:c,totalUsage:d,filteredTools:p,groupedTools:g,usedCategories:f,truncate:Qc,toggleExpand:b,refresh:O}}};function Tw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Cw(e){if(!e)return"1";const t=e.split(`
...
`)}const Ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),d=h(""),u=h(""),p=h(null),f=h(null),g=h(!1),b=h(null),E=h(null),O=h(!1),y=Z(()=>e.value.length),m=Z(()=>e.value.reduce((ie,ge)=>ie+(ge.execution_count||0),0)),x=Z(()=>e.value.reduce((ie,ge)=>ie+D(ge.code),0)),S=Z(()=>{if(!l.value)return e.value;const ie=l.value.toLowerCase();return e.value.filter(ge=>ge.name.toLowerCase().includes(ie)||(ge.description||"").toLowerCase().includes(ie))}),v=Z(()=>u.value?u.value.split(`
`).length:0),k=Z(()=>{const ie=Math.max(v.value,1);return Array.from({length:ie},(ge,W)=>W+1).join(`
`)}),T=Z(()=>{const ie=u.value.trim();return ie?ie.includes("SKILL_DEFINITION")?ie.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function C(ie){return Tw(ie)}function D(ie){return ie?ie.split(`
`).length:0}function H(ie){return Cw(ie)}function F(ie){n.value={...n.value,[ie]:!n.value[ie]}}async function A(ie){try{await navigator.clipboard.writeText(ie);const ge=e.value.find(W=>W.code===ie);ge&&(r.value=ge.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function V(ie){if(ie.key==="Tab"){ie.preventDefault();const ge=ie.target,W=ge.selectionStart,B=ge.selectionEnd;u.value=u.value.substring(0,W)+"    "+u.value.substring(B),Ct(()=>{ge.selectionStart=ge.selectionEnd=W+4})}}function ee(ie){const ge=ie.target.previousElementSibling;ge&&(ge.scrollTop=ie.target.scrollTop)}async function U(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(ie){s.value=ie.message}t.value=!1}async function N(ie){i.value=ie,delete a.value[ie],a.value={...a.value};try{const ge=await G.post(`/api/skills/${encodeURIComponent(ie)}/test`);a.value={...a.value,[ie]:ge}}catch(ge){a.value={...a.value,[ie]:{result:ge.message,is_error:!0}}}i.value=null}function I(){o.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function te(ie){o.value=!0,c.value="edit",d.value=ie.name,u.value=ie.code||"",p.value=null,f.value=null}function Te(){o.value=!1,p.value=null,f.value=null}async function ke(){p.value=null,f.value=null;const ie=d.value.trim(),ge=u.value.trim();if(!ie){p.value="Name is required";return}if(!ge){p.value="Code is required";return}g.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:ie,code:ge}),f.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(ie)}`,{code:ge}),f.value="Skill updated successfully"),await U(),setTimeout(()=>{o.value=!1},800)}catch(W){p.value=W.message}g.value=!1}function oe(ie){E.value=ie}async function me(){if(E.value){O.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(E.value)}`),await U()}catch(ie){Ce.error(`Failed to delete skill: ${ie.message||"unknown error"}`)}O.value=!1,E.value=null}}return Ze(()=>{U()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:g,editorRef:b,deleteTarget:E,deleting:O,enabledCount:y,totalExecutions:m,totalLines:x,displayedSkills:S,editLineCount:v,editorLineNums:k,editValidation:T,highlight:C,truncate:Qc,formatTs:ba,countLines:D,getLineNumbers:H,toggleCode:F,copyCode:A,handleEditorKey:V,syncScroll:ee,fetchSkills:U,testSkill:N,showCreate:I,editSkill:te,cancelEdit:Te,saveSkill:ke,confirmDelete:oe,doDelete:me}}};class Rs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Aw=/^[A-Za-z_][A-Za-z0-9_]*$/;function $u(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Uu(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const r=String((l==null?void 0:l.key)||"").trim(),o=String((l==null?void 0:l.value)??"");if(!(!r&&!o)){if(!r)throw new Rs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(r))throw new Rs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,r))throw new Rs(`${s} key “${r}” appears more than once.`,"authentication");if(i.has(r))throw new Rs(`${s} key “${r}” cannot be replaced and removed in the same save.`,"authentication");n[r]=o}}return{set:n,remove:a}}function Rw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Iw(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Rs("Server name is required.","name");if(a.length>128||!Aw.test(a))throw new Rs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,r={enabled:!!e.enabled,transport:i};if(n&&(r.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Rs("An executable path is required for a new stdio connection.","command");if(d&&(r.command=d),(n||e.replaceArgs)&&(r.args=$u(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Rs("Working directory must be an absolute path.","cwd");r.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Rs("An HTTP endpoint is required for this connection.","url");if(d&&!Rw(d))throw new Rs("Endpoint must be a valid http:// or https:// URL.","url");d&&(r.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Rs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");r.timeout_seconds=d}(n||e.replaceAllowlist)&&(r.tool_allowlist=$u(e.allowlistText));const o=Uu(e.headerRows,e.headersRemove,"Header"),c=Uu(e.envRows,e.envRemove,"Environment variable");return Object.keys(o.set).length&&(r.headers_set=o.set),o.remove.length&&(r.headers_remove=o.remove),Object.keys(c.set).length&&(r.env_set=c.set),c.remove.length&&(r.env_remove=c.remove),r}function Ow(e,t){return t?e.transport!==t||!!String(e.command||"").trim()||!!String(e.url||"").trim()||!!e.replaceArgs||!!e.replaceCwd:!1}function Nw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Lw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const Mw=1e4,Dw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function lo(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function Pw(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Fw={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),r=h({}),o=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),g=h(lo()),b=h(""),E=h(!1);let O=null,y=0,m=!1,x=!1;const S=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]),v=Z(()=>{var P;return((P=e.value)==null?void 0:P.servers)||[]}),k=Z(()=>{var P;return!!((P=e.value)!=null&&P.enabled)}),T=Z(()=>{var P,X,K,ne;return{serverCount:((P=e.value)==null?void 0:P.server_count)||0,enabledCount:((X=e.value)==null?void 0:X.enabled_server_count)||0,connectedCount:((K=e.value)==null?void 0:K.connected_count)||0,toolCount:((ne=e.value)==null?void 0:ne.published_tool_count)||0}}),C=Z(()=>{var P;return((P=f.value)==null?void 0:P.header_keys)||[]}),D=Z(()=>{var P;return((P=f.value)==null?void 0:P.env_keys)||[]});function H(){F(),O=window.setInterval(()=>A({quiet:!0}),Mw)}function F(){O&&window.clearInterval(O),O=null}async function A({quiet:P=!1}={}){const X=++y;P||(t.value=!0);try{const K=await G.get("/api/mcp/status");if(X!==y||!m)return;e.value=K,n.value="";const ne=new Set((K.servers||[]).map(ce=>ce.name));i.value=new Set([...i.value].filter(ce=>ne.has(ce)))}catch(K){X===y&&m&&(n.value=K.message||"Failed to load MCP status")}finally{X===y&&(t.value=!1)}}function V(P){return s.value||a.value.has(P)}function ee(P,X){const K=new Set(a.value);X?K.add(P):K.delete(P),a.value=K}function U(P){return Nw(P.state)}function N(P){return Dw[U(P)]}function I(P){return P.transport==="http"?"Streamable HTTP":"stdio"}function te(P){return P.negotiated_version?`${P.era?`${String(P.era).charAt(0).toUpperCase()}${String(P.era).slice(1)}`:"Protocol"} · ${P.negotiated_version}`:"Not negotiated"}function Te(P){return P.discovered_count?`${P.published_count||0} published · ${P.excluded_count||0} excluded`:"No tools discovered"}async function ke(P){if(P!==k.value&&!(!P&&!await Zt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await G.post("/api/mcp/enabled",{enabled:P}),Ce.success(P?"MCP enabled":"MCP disabled"),await A({quiet:!0})}catch(X){Ce.error(X.message||"Failed to update MCP state"),await A({quiet:!0})}finally{s.value=!1}}}async function oe(P){ee(P.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(P.name)}/reconnect`,{}),Ce.success(`Reconnected ${P.name}`)}catch(X){Ce.error(X.message||`Failed to reconnect ${P.name}`)}finally{ee(P.name,!1),await A({quiet:!0})}}async function me(P){ee(P.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(P.name)}/refresh-tools`,{}),Ce.success(`Refreshed tools from ${P.name}`),await W(P.name,!0)}catch(X){Ce.error(X.message||`Failed to refresh ${P.name}`)}finally{ee(P.name,!1),await A({quiet:!0})}}async function ie(P){if(await Zt({title:`Remove ${P.name}`,message:`Remove this saved MCP server? Its ${P.published_count||0} published tool${P.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){ee(P.name,!0);try{await G.del(`/api/mcp/servers/${encodeURIComponent(P.name)}`),Ce.success(`Removed ${P.name}`),delete r.value[P.name]}catch(K){Ce.error(K.message||`Failed to remove ${P.name}`)}finally{ee(P.name,!1),await A({quiet:!0})}}}async function ge(P){const X=new Set(i.value);if(X.has(P.name)){X.delete(P.name),i.value=X;return}X.add(P.name),i.value=X,Object.hasOwn(r.value,P.name)||await W(P.name)}async function W(P,X=!1){if(!X&&Object.hasOwn(r.value,P))return;const K=new Set(c.value);K.add(P),c.value=K,o.value={...o.value,[P]:""};try{const ne=await G.get(`/api/mcp/servers/${encodeURIComponent(P)}/tools`);r.value={...r.value,[P]:ne.tools||[]}}catch(ne){o.value={...o.value,[P]:ne.message||"Failed to load tools"}}finally{const ne=new Set(c.value);ne.delete(P),c.value=ne}}function B(P){return(r.value[P]||[]).filter(X=>Lw(X,l.value[P]))}function le(P,X){l.value={...l.value,[P]:X}}function re(){u.value="add",p.value="",f.value=null,g.value=lo(),b.value="",d.value=!0}function ye(P){u.value="edit",p.value=P.name,f.value=P,g.value={...lo(),name:P.name,enabled:!!P.enabled,transport:P.transport||"stdio"},b.value="",d.value=!0}function ve(){E.value||(d.value=!1)}function $e(P){const X=P==="headers"?"headerRows":"envRows";g.value[X].push({key:"",value:""})}function w(P,X){const K=P==="headers"?"headerRows":"envRows";g.value[K].splice(X,1)}function L(P,X){const K=P==="headers"?"headersRemove":"envRemove",ne=g.value[K];g.value[K]=ne.includes(X)?ne.filter(ce=>ce!==X):[...ne,X]}async function $(){var X,K,ne;b.value="";let P;try{P=Iw(g.value,{mode:u.value,originalTransport:((X=f.value)==null?void 0:X.transport)||""})}catch(ce){b.value=ce instanceof Rs?ce.message:"Invalid MCP server configuration",await Ct(),(K=document.querySelector(".mcp-editor"))==null||K.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Ow(g.value,(ne=f.value)==null?void 0:ne.transport)&&!await Zt({title:`Change ${p.value} connection`,message:"This edit changes the command, endpoint, transport, arguments, or working directory. The current MCP connection will be retired and rebuilt, and its tools will be unpublished during the transition.",confirmLabel:"Save and reconnect",danger:!0}))){E.value=!0;try{u.value==="add"?await G.post("/api/mcp/servers",P):await G.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,P),Ce.success(u.value==="add"?`Saved ${P.name}`:`Updated ${p.value}`),d.value=!1,await A({quiet:!0})}catch(ce){b.value=ce.message||"Failed to save MCP server"}finally{E.value=!1}}}let ae=null;function J(P){`${(P==null?void 0:P.event)||""} ${(P==null?void 0:P.type)||""} ${(P==null?void 0:P.tool)||""} ${(P==null?void 0:P.message)||""}`.toLowerCase().includes("mcp")&&(ae&&window.clearTimeout(ae),ae=window.setTimeout(()=>A({quiet:!0}),200))}function se(){m||(m=!0,x||(je.subscribe("events",J),x=!0),A(),H())}function fe(){m=!1,F(),ae&&window.clearTimeout(ae),ae=null,x&&(je.unsubscribe("events",J),x=!1)}return Ze(se),ws(se),ks(fe),xt(fe),{status:e,loading:t,mutating:s,pageError:n,servers:v,masterEnabled:k,aggregate:T,expandedServers:i,toolQueries:l,toolErrors:o,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,form:g,formError:b,saving:E,editorGroups:S,configuredHeaderKeys:C,configuredEnvKeys:D,refreshAll:A,busy:V,serverState:U,stateLabel:N,transportLabel:I,protocolLabel:te,toolSummary:Te,formatAge:Pw,setMasterEnabled:ke,reconnect:oe,refreshTools:me,removeServer:ie,toggleTools:ge,filteredTools:B,setToolQuery:le,openAdd:re,openEdit:ye,closeEditor:ve,addSecretRow:$e,removeSecretRow:w,toggleSecretRemoval:L,saveServer:$}}};function $w(e,t){if(!e||!t)return Du(e);const s=Du(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Uw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),g=h(null),b=h(null);let E=null;const O=h(null),y=h(!1),m=h({}),x=h({}),S=h(null),v=h(null),k=Z(()=>e.value.reduce((I,te)=>I+(te.chunks||0),0)),T=Z(()=>new Set(e.value.map(te=>te.uploader).filter(Boolean)).size);function C(I,te){const Te=x.value[te];if(!Te||Te.length===0)return 0;const ke=Math.max(...Te.map(oe=>oe.char_count||0));return ke===0?0:Math.round(I.char_count/ke*100)}async function D(){t.value=!0,s.value=null;try{const I=await G.get("/api/knowledge");e.value=Array.isArray(I)?I:[]}catch(I){s.value=I.message}t.value=!1}async function H(I){if(m.value[I]){m.value[I]=!1,v.value=null;return}if(m.value[I]=!0,!(x.value[I]||S.value===I)){S.value=I;try{const te=await G.get(`/api/knowledge/${encodeURIComponent(I)}/chunks`);x.value[I]=Array.isArray(te)?te:[]}catch(te){x.value[I]=[],Ce.error(`Failed to load chunks: ${te.message}`)}S.value=null}}async function F(){const I=n.value.trim();if(I){i.value=!0,r.value=null,l.value=I;try{const te=await G.get(`/api/knowledge/search?q=${encodeURIComponent(I)}`);a.value=Array.isArray(te)?te:[]}catch(te){a.value=[],r.value=te.message||"Search failed"}i.value=!1}}function A(){a.value=null,n.value="",r.value=null}async function V(){u.value=null,p.value=null;const I=c.value.trim(),te=d.value.trim();if(!I){u.value="Source name is required";return}if(!te){u.value="Content is required";return}f.value=!0;try{const Te=await G.post("/api/knowledge",{source:I,content:te});p.value=`Ingested ${Te.chunks||0} chunks from "${I}"`,c.value="",d.value="",x.value={},await D(),setTimeout(()=>{o.value=!1,p.value=null},1500)}catch(Te){u.value=Te.message}f.value=!1}async function ee(I){g.value=I,b.value=null,E&&(clearTimeout(E),E=null);try{const te=await G.post(`/api/knowledge/${encodeURIComponent(I)}/reingest`);b.value={source:I,error:!1,message:`Re-ingested ${te.chunks||0} chunks`},delete x.value[I],await D(),E=setTimeout(()=>{b.value=null,E=null},3e3)}catch(te){b.value={source:I,error:!0,message:te.message}}g.value=null}function U(I){O.value=I}async function N(){if(O.value){y.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(O.value)}`),delete x.value[O.value],await D()}catch(I){Ce.error(`Failed to delete source: ${I.message||"unknown error"}`)}y.value=!1,O.value=null}}return Ze(()=>{D()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:g,reingestResult:b,deleteTarget:O,deleting:y,expanded:m,sourceChunks:x,loadingChunks:S,selectedChunk:v,totalChunks:k,uploaderCount:T,truncate:Qc,formatTs:ba,highlightTerms:$w,chunkBarWidth:C,fetchSources:D,toggleSource:H,doSearch:F,clearSearch:A,doIngest:V,doReingest:ee,confirmDelete:U,doDelete:N}}},Bw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),g=h(!1),b=h(null),E=h(null),O=h(new Set),y=h(null),m=h(!1),x=h(!1),S=Z(()=>e.value.reduce((oe,me)=>oe+me.count,0)),v=Z(()=>O.value.size);function k(oe){const me=t.value[oe];if(!me)return[];if(!l.value.trim())return me;const ie=l.value.trim().toLowerCase();return me.filter(ge=>ge.key.toLowerCase().includes(ie)||ge.value&&ge.value.toLowerCase().includes(ie))}function T(oe,me){return O.value.has(oe+"/"+me)}function C(oe,me){const ie=oe+"/"+me,ge=new Set(O.value);ge.has(ie)?ge.delete(ie):ge.add(ie),O.value=ge}function D(oe){const me=t.value[oe];return!me||me.length===0?!1:me.every(ie=>O.value.has(oe+"/"+ie.key))}function H(oe,me){const ie=t.value[oe];if(!ie)return;const ge=new Set(O.value);for(const W of ie){const B=oe+"/"+W.key;me?ge.add(B):ge.delete(B)}O.value=ge}async function F(){s.value=!0,n.value=null;try{const oe=await G.get("/api/memory");e.value=Object.entries(oe).map(([me,ie])=>({name:me,keys:ie.keys||[],count:ie.count||0}))}catch(oe){n.value=oe.message}s.value=!1}async function A(oe){if(a.value[oe]){a.value[oe]=!1;return}a.value[oe]=!0;const me=e.value.find(ge=>ge.name===oe);if(!me||t.value[oe]||i.value===oe)return;i.value=oe;let ie;try{const W=(await G.get(`/api/memory/${encodeURIComponent(oe)}`)).entries||{};ie=me.keys.map(B=>Object.prototype.hasOwnProperty.call(W,B)?{key:B,value:W[B]||"",failed:!1}:{key:B,value:"",failed:!0,error:"Not found in scope"})}catch(ge){ie=me.keys.map(W=>({key:W,value:"",failed:!0,error:ge.message||"Failed to load"}))}t.value[oe]=ie,i.value=null}function V(oe,me,ie){p.value=oe+"/"+me,f.value=ie}async function ee(oe,me){g.value=!0,b.value=null;try{await G.put(`/api/memory/${encodeURIComponent(oe)}/${encodeURIComponent(me)}`,{value:f.value});const ie=t.value[oe];if(ie){const ge=ie.find(W=>W.key===me);ge&&(ge.value=f.value)}p.value=null}catch(ie){b.value=`Failed to save: ${ie.message||"unknown error"}`}g.value=!1}async function U(oe,me){try{await navigator.clipboard.writeText(me.value),E.value=oe+"/"+me.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function N(){d.value=null,u.value=null;const oe=o.value.scope.trim(),me=o.value.key.trim(),ie=o.value.value.trim();if(!oe){d.value="Scope is required";return}if(!me){d.value="Key is required";return}if(!ie){d.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(oe)}/${encodeURIComponent(me)}`,{value:ie}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await F(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(ge){d.value=ge.message}c.value=!1}function I(oe,me){y.value={scope:oe,key:me}}async function te(){if(!y.value)return;m.value=!0,b.value=null;const{scope:oe,key:me}=y.value;try{await G.del(`/api/memory/${encodeURIComponent(oe)}/${encodeURIComponent(me)}`);const ie=t.value[oe];ie&&(t.value[oe]=ie.filter(B=>B.key!==me));const ge=e.value.find(B=>B.name===oe);ge&&(ge.count--,ge.keys=ge.keys.filter(B=>B!==me));const W=new Set(O.value);W.delete(oe+"/"+me),O.value=W}catch(ie){b.value=`Failed to delete: ${ie.message||"unknown error"}`}m.value=!1,y.value=null}function Te(){x.value=!0}async function ke(){m.value=!0,b.value=null;const oe=[];for(const me of O.value){const ie=me.indexOf("/");oe.push({scope:me.slice(0,ie),key:me.slice(ie+1)})}try{await G.post("/api/memory/bulk-delete",{entries:oe}),O.value=new Set,t.value={},await F()}catch(me){b.value=`Bulk delete failed: ${me.message||"unknown error"}`}m.value=!1,x.value=!1}return Ze(()=>{F()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:g,actionError:b,copied:E,selected:O,selectedCount:v,totalEntries:S,deleteTarget:y,deleting:m,showBulkDelete:x,fetchMemory:F,toggleScope:A,startEdit:V,doEdit:ee,copyValue:U,doAdd:N,confirmDelete:I,doDelete:te,confirmBulkDelete:Te,doBulkDelete:ke,isSelected:T,toggleSelect:C,isScopeAllSelected:D,toggleSelectAll:H,filteredEntries:k}}},Hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=Z(()=>[...new Set(e.value.map(E=>E.category))].sort()),o=Z(()=>{const b={};return e.value.forEach(E=>{b[E.category]=(b[E.category]||0)+1}),b}),c=Z(()=>a.value?e.value.filter(b=>b.category===a.value):e.value);function d(b){return b==="correction"?"badge-warning":b==="operational"?"badge-info":b==="preference"?"badge-success":"badge-info"}function u(b){i.value=b.key,l.value=b.content}async function p(b){try{await G.put("/api/learned/"+encodeURIComponent(b),{content:l.value}),i.value=null,Ce.success("Entry updated"),await g()}catch(E){Ce.error(E.message||"Failed to save entry")}}async function f(b){if(await Zt({title:"Delete learned entry",message:`Delete "${b}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/learned/"+encodeURIComponent(b)),Ce.success("Entry deleted"),await g()}catch(O){Ce.error(O.message||"Failed to delete entry")}}async function g(){s.value=!0,n.value=null;try{const b=await G.get("/api/learned");e.value=b.entries||[],t.value={last_reflection:b.last_reflection,count:b.count}}catch(b){n.value=b.message}s.value=!1}return Ze(g),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:d,formatTs:ba,startEdit:u,saveEdit:p,deleteEntry:f,fetchEntries:g}}},Am=[{id:"tools",label:"Tools",component:Sw},{id:"skills",label:"Skills",component:Ew},{id:"mcp-servers",label:"MCP Servers",component:Fw},{id:"knowledge",label:"Knowledge",component:Uw},{id:"memory",label:"Memory",component:Bw},{id:"learned",label:"Learned",component:Hw}],zw={components:{TabbedPage:$r},setup(){return{tabs:Am}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},jw={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Vw={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},qw={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},Gw={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h(!1),a=h("sessions"),i=h(null);let l=null;const r=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],o=Z(()=>{if(!i.value||!i.value.collected_at)return"";try{return new Date(i.value.collected_at).toLocaleTimeString()}catch{return""}}),c=Z(()=>{if(!i.value)return[];const E=i.value,O=E.storage_total_bytes||1;return[{label:"Session Persistence",mb:E.sessions.persist_dir.total_mb,bytes:E.sessions.persist_dir.total_bytes,files:E.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(E.sessions.persist_dir.total_bytes/O*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:E.knowledge.db_file.total_mb,bytes:E.knowledge.db_file.total_bytes,files:E.knowledge.db_file.file_count,pct:Math.min(100,Math.round(E.knowledge.db_file.total_bytes/O*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:E.trajectories.message_dir.total_mb,bytes:E.trajectories.message_dir.total_bytes,files:E.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(E.trajectories.message_dir.total_bytes/O*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:E.trajectories.agent_dir.total_mb,bytes:E.trajectories.agent_dir.total_bytes,files:E.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(E.trajectories.agent_dir.total_bytes/O*100)),color:"res-bar-amber"}]});async function d(){try{const E=await G.get("/api/resource-usage");i.value=E,t.value=null,s.value=!0}catch(E){t.value=E.message||"Failed to load resource usage"}finally{e.value=!1,n.value=!1}}async function u(){n.value=!0,await d()}function p(){e.value=!0,t.value=null,d()}let f=!1;function g(){f||(f=!0,d(),l||(l=setInterval(d,3e4)))}function b(){f&&(f=!1,l&&(clearInterval(l),l=null))}return Ze(g),ws(g),ks(b),xt(b),{hasData:s,loading:e,error:t,refreshing:n,data:i,activeTab:a,tabs:r,collectedAt:o,storageItems:c,fmtNum:wm,refresh:u,retry:p}}},Ww=["INFO","WARNING","ERROR"],Zw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],ro=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Jw=[50,100,200,500],Yw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(je.state||"disconnected"),c=Z(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),d=h(null),u=h(!1),p=h(null),f=2e3,g=Ww,b=Zw,E=ro,O=h("all"),y=h(""),m=h([]),x=h(!1),S=h(""),v=h([]);function k(){try{const q=localStorage.getItem("odin-log-presets");q&&(m.value=JSON.parse(q))}catch{}}function T(){try{localStorage.setItem("odin-log-presets",JSON.stringify(m.value))}catch{}}const C=Z(()=>a.value!==""||i.value.trim()!==""||y.value!==""),D=Z(()=>{const q=ro.find(de=>de.value===y.value);return q?q.label:""}),H=Z(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(q){return q.message}}),F=24,A=Z(()=>{if(Te.value.length===0)return[];const q=[],de=new Date,Re=3600*1e3;for(let Je=F-1;Je>=0;Je--){const rt=new Date(de.getTime()-(Je+1)*Re),Lt=new Date(de.getTime()-Je*Re);q.push({start:rt,end:Lt,label:N(rt,Lt),shortLabel:Lt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Je of Te.value){if(!Je._time)continue;const rt=Je._time.getTime();for(const Lt of q)if(rt>=Lt.start.getTime()&&rt<Lt.end.getTime()){Lt.total++,Je.level==="ERROR"?Lt.errors++:Je.level==="WARNING"?Lt.warnings++:Lt.info++;break}}return q}),V=Z(()=>{let q=1;for(const de of A.value)de.total>q&&(q=de.total);return q}),ee=Z(()=>{if(A.value.length===0)return"";const q=Te.value.map(Je=>Je._time&&Je._time.getTime()).filter(Boolean);if(q.length===0)return"";const de=new Date(Math.min(...q));return`${Te.value.length} shown, oldest ${de.toLocaleTimeString()}`}),U=Z(()=>Math.ceil(F/8));function N(q,de){const Re={hour:"2-digit",minute:"2-digit"};return q.toLocaleTimeString([],Re)+" - "+de.toLocaleTimeString([],Re)}function I(q,de){return!de||!q?"0px":Math.max(2,q/de*100)+"%"}function te(q){const de=Te.value.findIndex(Re=>Re._time&&Re._time.getTime()>=q.start.getTime()&&Re._time.getTime()<q.end.getTime());if(de>=0&&d.value){const Re=d.value.querySelectorAll(".log-line");Re[de]&&(Re[de].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const Te=Z(()=>{let q=t.value;if(a.value&&(q=q.filter(de=>(de.level||"INFO")===a.value)),y.value){const de=ro.find(Re=>Re.value===y.value);if(de&&de.seconds){const Re=new Date(Date.now()-de.seconds*1e3);q=q.filter(Je=>Je._time&&Je._time>=Re)}}if(i.value&&!H.value)if(l.value)try{const de=new RegExp(i.value,"i");q=q.filter(Re=>{const Je=Re.text||Re.raw||"",rt=Re.tool||"";return de.test(Je)||de.test(rt)})}catch{}else{const de=i.value.toLowerCase();q=q.filter(Re=>{const Je=(Re.text||Re.raw||"").toLowerCase(),rt=(Re.tool||"").toLowerCase();return Je.includes(de)||rt.includes(de)})}return q});function ke(q){if(q.type==="log"&&q.line)try{const de=typeof q.line=="string"?JSON.parse(q.line):q.line,Re=de.timestamp?new Date(de.timestamp):new Date;return{ts:Re.toLocaleTimeString(),_time:Re,level:de.error?"ERROR":"INFO",text:de.tool_name?`[${de.tool_name}] ${de.result_summary||""}`.trim():de.message||JSON.stringify(de),tool:de.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(q.line),tool:"",raw:String(q.line)}}if(q.payload){const de=q.payload,Re=de.timestamp?new Date(de.timestamp):new Date;return{ts:Re.toLocaleTimeString(),_time:Re,level:de.error?"ERROR":"INFO",text:de.tool_name?`[${de.tool_name}] ${de.result_summary||""}`.trim():de.message||JSON.stringify(de),tool:de.tool_name||"",raw:null}}return typeof q=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:q,tool:"",raw:q}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(q),tool:"",raw:null}}function oe(q){const de=ke(q);if(s.value){v.value.push(de);return}me(de)}function me(q){t.value.push(q),t.value.length>f&&(t.value=t.value.slice(-f)),n.value&&Ct(()=>ie())}function ie(q=!1){const de=d.value;de&&de.scrollTo({top:de.scrollHeight,behavior:q?"smooth":"instant"})}function ge(){n.value=!0,u.value=!1,Ct(()=>ie(!0))}const W=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function B(){const q=d.value;if(!q)return;const de=q.scrollHeight-q.scrollTop-q.clientHeight<40;u.value=!n.value&&!de&&t.value.length>0,ve.value&&le()}function le(){const q=d.value;!q||!n.value||q.scrollHeight-q.scrollTop-q.clientHeight>=40&&(n.value=!1,u.value=t.value.length>0)}function re(){n.value&&requestAnimationFrame(le)}function ye(q){W.has(q.key)&&re()}const ve=h(!1);function $e(){n.value&&(ve.value=!0,requestAnimationFrame(le))}function w(){ve.value&&(ve.value=!1,le())}function L(){n.value&&(u.value=!1,Ct(()=>ie()))}function $(){if(s.value=!s.value,!s.value&&v.value.length>0){for(const q of v.value)me(q);v.value=[]}}function ae(){t.value=[],v.value=[],u.value=!1}function J(){let q;e.value==="search"?q=Ue.value.map(rt=>{const Lt=rt.error?"ERROR":"INFO",Ft=rt.tool_name?`[${rt.tool_name}] `:"";return`${rt.timestamp||""} ${Lt} ${Ft}${rt.result_summary||rt.message||""}`}).join(`
`):q=Te.value.map(rt=>`${rt.ts} ${rt.level} ${rt.text}`).join(`
`);const de=new Blob([q],{type:"text/plain"}),Re=URL.createObjectURL(de),Je=document.createElement("a");Je.href=Re,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL(Re)}function se(q,de){const Re=`${q.ts} ${q.level} ${q.text||q.raw||""}`;navigator.clipboard.writeText(Re).then(()=>{p.value=de,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function fe(q){a.value=a.value===q?"":q,O.value="all"}function P(q){return q.level==="ERROR"?"log-line-error":q.level==="WARNING"?"log-line-warning":"text-gray-300"}function X(q){return q==="ERROR"?"text-red-500 font-semibold":q==="WARNING"?"text-yellow-500":"text-blue-500"}function K(q){return q==="ERROR"?"log-chip-error":q==="WARNING"?"log-chip-warning":"log-chip-info"}function ne(q){O.value=q.id;const de=q.filters;a.value=de.level||"",y.value=de.timeRange||"",i.value=de.text||"",de.levels&&(a.value=de.levels[0]||""),de.hasToolName&&(i.value="")}function ce(q){O.value=q.id,a.value=q.filters.level||"",y.value=q.filters.timeRange||"",i.value=q.filters.text||""}function be(){if(!S.value.trim())return;const q={id:"custom-"+Date.now(),name:S.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};m.value=[...m.value,q],T(),x.value=!1,S.value=""}function Ae(q){m.value=m.value.filter(de=>de.id!==q),T(),O.value===q&&(O.value="all")}const Me=h("all"),De=h(""),Fe=h(""),ze=h(""),qe=h(""),dt=h(""),Y=h(100),we=Jw,Ee=h(!1),Oe=h(!1),Ge=h(""),Ue=h([]),mt=h(null),Yt=h(null);function Ds(){e.value="search",mt.value||An()}async function An(){try{mt.value=await G.get("/api/logs/stats")}catch{}}function Ts(){const q=dt.value;if(!q){ze.value="",qe.value="";return}const Re={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[q];if(Re){const Je=new Date(Date.now()-Re*1e3);ze.value=Ps(Je),qe.value=""}}function Ps(q){const de=Re=>String(Re).padStart(2,"0");return`${q.getFullYear()}-${de(q.getMonth()+1)}-${de(q.getDate())}T${de(q.getHours())}:${de(q.getMinutes())}`}function Pt(q){if(!q)return"";const de=new Date(q);return isNaN(de.getTime())?"":de.toISOString()}async function Qt(){Ee.value=!0,Ge.value="",Oe.value=!0,Yt.value=null;try{const q=new URLSearchParams;Me.value&&Me.value!=="all"&&q.set("level",Me.value),De.value&&q.set("tool",De.value),Fe.value&&q.set("q",Fe.value);const de=Pt(ze.value),Re=Pt(qe.value);de&&q.set("start",de),Re&&q.set("end",Re),q.set("limit",String(Y.value));const Je=await G.get(`/api/logs/search?${q.toString()}`);Ue.value=Je.entries||[]}catch(q){Ge.value=q.message||"Search failed",Ue.value=[]}finally{Ee.value=!1}}function Vs(){Me.value="all",De.value="",Fe.value="",ze.value="",qe.value="",dt.value="",Y.value=100,Ue.value=[],Oe.value=!1,Ge.value="",Yt.value=null}function Cs(q){Yt.value=Yt.value===q?null:q}function nn(q){if(!q.timestamp)return"";try{return new Date(q.timestamp).toLocaleString()}catch{return q.timestamp}}function Fs(q){return q.type==="web_action"?`${q.status||""} (${q.execution_time_ms||0}ms)`:(q.result_summary||"").slice(0,200)}function qs(q){return q.error?"log-line-error":"text-gray-300"}function Vn(q){try{return JSON.stringify(q,null,2)}catch{return String(q)}}let ut=null,rs=null,os=!1;function Qe(){os||(os=!0,je.subscribe("logs",oe),r.value=je.connected,o.value=je.state||"disconnected",ut=je.onStateChange,rs=(q,de)=>{o.value=q,r.value=q==="connected",ut&&ut(q,de)},je.onStateChange=rs)}function gs(){os&&(os=!1,je.unsubscribe("logs",oe),je.onStateChange===rs&&(je.onStateChange=ut),rs=null,ut=null)}return Ze(()=>{k(),window.addEventListener("pointerup",w),window.addEventListener("pointercancel",w)}),ws(Qe),ks(gs),xt(()=>{gs(),window.removeEventListener("pointerup",w),window.removeEventListener("pointercancel",w)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:Te,pauseBuffer:v,showJumpBottom:u,copiedIndex:p,regexError:H,levels:g,logPresets:b,timeRanges:E,timeRange:y,activeLogPreset:O,customLogPresets:m,showSaveLogPreset:x,newLogPresetName:S,hasActiveLogFilters:C,timeRangeLabel:D,timelineBuckets:A,timelineMax:V,timelineSpanLabel:ee,timelineLabelSkip:U,togglePause:$,clearLogs:ae,exportLogs:J,logLineClass:P,levelClass:X,levelChipClass:K,toggleLevel:fe,copyLine:se,jumpToBottom:ge,onScroll:B,onUserScrollIntent:re,onUserScrollKey:ye,onAutoScrollToggle:L,onPointerDown:$e,applyLogPreset:ne,applyCustomLogPreset:ce,saveLogCustomPreset:be,removeLogCustomPreset:Ae,segmentHeight:I,jumpToTimelineBucket:te,searchLevel:Me,searchTool:De,searchKeyword:Fe,searchStart:ze,searchEnd:qe,searchTimePreset:dt,searchLimit:Y,searchLimits:we,searching:Ee,searchRan:Oe,searchError:Ge,searchResults:Ue,searchStats:mt,expandedSearch:Yt,switchToSearch:Ds,runSearch:Qt,clearSearchFilters:Vs,toggleSearchExpand:Cs,formatSearchTs:nn,searchEntryText:Fs,searchLogLineClass:qs,formatJson:Vn,applySearchTimePreset:Ts}}};function Sl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const Qw=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function Xw(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const r=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(r)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Va=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],ek={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},oo=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),tk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Bu(e){return tk.some(t=>e===t||e.startsWith(`${t}.`))}const Rm="odin_config_center_expanded_v1",Im="odin_config_center_category_v1",sk=50,nk=650,co=()=>G.get("/api/config/meta");function ea(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Oi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ca(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function ak(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function ik(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Om(e,t){if(Oi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ea(t);const n={};for(const[a,i]of Object.entries(t)){const l=Om(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function lk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Om(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Nm(e,t,s,n){if(Oi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Nm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function rk(){try{const e=JSON.parse(localStorage.getItem(Rm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function ok(){try{const e=localStorage.getItem(Im);return Va.some(t=>t.key===e)?e:Va[0].key}catch{return Va[0].key}}const ck={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),r=h(null),o=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(ok()),g=h(rk()),b=h({}),E=h({}),O=h(""),y=h({}),m=h({}),x=h([]),S=h([]),v=h(!1),k=h(!1),T=h(!1);let C=null,D=null,H={path:null,at:0},F=0;const A=Z(()=>{var _;return(((_=t.value)==null?void 0:_.fields)||[]).filter(M=>!oo.has(M.path.split(".")[0])&&!Bu(M.path))}),V=Z(()=>new Map(A.value.map(_=>[_.path,_]))),ee=Z(()=>Te.value.reduce((_,M)=>_+M.sections.length,0)),U=Z(()=>A.value.length),N=Z(()=>Qw),I=Z(()=>x.value.length>0),te=Z(()=>S.value.length>0),Te=Z(()=>{if(!e.value)return[];const _=new Set(Va.flatMap(ue=>ue.sections)),M=Va.map(ue=>({...ue,sections:ue.sections.filter(Ne=>Object.hasOwn(e.value,Ne)&&!oo.has(Ne))})).filter(ue=>ue.sections.length),j=Object.keys(e.value).filter(ue=>!_.has(ue)&&!oo.has(ue));return j.length&&M.push({key:"other",label:"Other",icon:"folder",sections:j}),M}),ke=Z(()=>e.value?{...e.value,...b.value}:null),oe=Z(()=>{if(!e.value)return[];const _=[];for(const[M,j]of Object.entries(b.value))Nm(e.value[M],j,M,_);return _.filter(M=>!Oi(M.oldVal,M.newVal)).map(M=>{const j=L(M.path);return{...M,label:(j==null?void 0:j.label)||Ca(M.path.split(".").at(-1)),apply_mode:(j==null?void 0:j.apply_mode)||fe(M.path.split(".")[0])}})}),me=Z(()=>oe.value.length>0),ie=Z(()=>oe.value.length),ge=Z(()=>new Set(oe.value.map(_=>_.path.split(".")[0])).size),W=Z(()=>!!u.value||p.value!=="all"),B=Z(()=>{const _={...m.value};for(const M of oe.value){const j=L(M.path),ue=xa(j,M.newVal);ue&&(_[M.path]=ue)}return _}),le=Z(()=>Object.keys(B.value).length>0),re=Z(()=>e.value?(W.value?Te.value:Te.value.filter(M=>M.key===f.value)).map(M=>({...M,sections:M.sections.filter(j=>Ee(j))})).filter(M=>M.sections.length):[]),ye=Z(()=>{const _=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],M=new Map(_.map(j=>[j,[]]));for(const j of oe.value){const ue=M.has(j.apply_mode)?j.apply_mode:"restart";M.get(ue).push(j)}return _.filter(j=>M.get(j).length).map(j=>({key:j,label:he(j),entries:M.get(j)}))}),ve=Z(()=>oe.value.filter(_=>_.apply_mode==="restart").length),$e=Z(()=>A.value.filter(_=>_.pending_restart)),w=Z(()=>$e.value.length);function L(_){const M=V.value.get(_);return M?{...M,apply_details:Sl([M])}:null}function $(_){const M=`${_}.`;return A.value.filter(j=>j.path===_||j.path.startsWith(M))}function ae(_){return $(_).length}function J(_){return Ca(_)}function se(_){const M=$(_);if(!M.length)return`${Ca(_)} configuration.`;const j=M.find(gt=>gt.sensitivity==="public"&&gt.description)||M.find(gt=>gt.description),ue=(j==null?void 0:j.description)||"";return ue.match(/setting for (.+)\.$/i)?`${Ca(_)} settings and runtime behaviour.`:ue}function fe(_){const M=[...new Set($(_).map(j=>j.apply_mode))];return M.length===1?M[0]:M.includes("restart")?"restart":M.includes("activation_required")?"activation_required":M[0]||"restart"}function P(_){const M=[...new Set($(_).map(j=>he(j.apply_mode)))];return M.length?M.length===1?M[0]:`Mixed apply behaviour: ${M.join(" · ")}`:""}function X(_){return Sl($(_))}function K(_){var M;return Object.hasOwn(b.value,_)?b.value[_]:(M=e.value)==null?void 0:M[_]}function ne(){const _=K("mcp")||{},M=Object.keys(_.servers||{}).length;return`${_.enabled?"Globally enabled":"Globally disabled"} · ${M} configured server${M===1?"":"s"}.`}function ce(_,M){return M.split(".").reduce((j,ue)=>j==null?void 0:j[ue],_)}function be(_){const M=ke.value;return $(_).filter(j=>Bu(j.path)?!1:j.path.split(".").length<=2?!0:!j.path.includes(".*")).map(j=>({...j,key:j.path.split(".").at(-1),value:ce(M,j.path),apply_details:Sl([j]),editor:j.path==="agents.final_warning_iterations"?"warning-chips":null}))}function Ae(_){const M=_.path.split(".");return M.length>2?M.slice(0,2).join("."):null}function Me(_){const M=new Map;for(const j of be(_)){const ue=Ae(j),Ne=ue||`${_}.__root`;M.has(Ne)||M.set(Ne,{key:Ne,path:ue,entries:[]}),M.get(Ne).entries.push(j)}return[...M.values()].map(j=>{const ue=j.entries.find(Ne=>Ne.group_description);return{...j,label:j.path?Ca(j.path.split(".").at(-1)):null,description:(ue==null?void 0:ue.group_description)||null,apply_details:Sl(j.entries),runtime_summaries:Fe(j.entries)}})}function De(_){return{save:_.save_effect||(_.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:_.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[_.apply_mode]||"Effective runtime state is not currently observable."}}function Fe(_){const M=new Map;for(const j of _){const ue=De(j),Ne=`${j.apply_mode}|${ue.save}|${ue.runtime}`;M.has(Ne)||M.set(Ne,{key:Ne,label:he(j.apply_mode),save:ue.save,runtime:ue.runtime})}return[...M.values()]}function ze(_){if(qe(_))return _.runtime_effect||_.activation_policy||"";if(_.apply_mode==="activation_required"){const M=_.activation_policy||_.runtime_effect;return M?`Not active after saving. No activation control exists in this release. ${M}`:"Not active after saving; no activation control exists in this release."}return""}function qe(_){return _.action_available===!0&&!!(_.action_label&&_.action_endpoint)}async function dt(_){if(qe(_))try{if(Yt(_.path))throw new Error("Save this setting before applying its action.");const M=String(_.action_method||"POST").toLowerCase(),j={post:G.post.bind(G),put:G.put.bind(G),delete:G.del.bind(G)}[M];if(!j)throw new Error("Unsupported configuration action");await j(_.action_endpoint,_.action_body||void 0),await Q(),Rn("success",`${_.action_label} completed.`)}catch(M){Rn("error",M.message||`${_.action_label} failed`)}}function Y(_,M){return[_.label,_.path,_.description,..._.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(M)}function we(_){const M=u.value.trim().toLowerCase();return M?$(_).filter(j=>Y(j,M)):[]}function Ee(_){const M=$(_);if(p.value!=="all"&&!M.some(ue=>ue.apply_state===p.value))return!1;const j=u.value.trim().toLowerCase();return!j||`${J(_)} ${_}`.toLowerCase().includes(j)?!0:M.some(ue=>Y(ue,j))}function Oe(_,M){return $(_).filter(j=>j.apply_state===M).length}function Ge(_){return _==="all"?U.value:A.value.filter(M=>M.apply_state===_).length}function Ue(_){const M=_.sections.flatMap(j=>$(j));return{fields:M.length,modified:oe.value.filter(j=>_.sections.includes(j.path.split(".")[0])).length,pending_restart:M.filter(j=>j.apply_state==="pending_restart").length,invalid:M.filter(j=>j.apply_state==="invalid").length,dormant:M.filter(j=>j.apply_state==="dormant").length}}function mt(_){var M;return Object.hasOwn(b.value,_)&&!Oi((M=e.value)==null?void 0:M[_],b.value[_])}function Yt(_){return oe.value.some(M=>M.path===_||M.path.startsWith(`${_}.`))}function Ds(_){f.value=_,u.value="",p.value="all";try{localStorage.setItem(Im,_)}catch{}}function An(_){p.value=_}function Ts(){u.value="",p.value="all"}function Ps(_){var M;return((M=Te.value.find(j=>j.sections.includes(_)))==null?void 0:M.sections)||[]}function Pt(_){const M=Ps(_),j=M.find(ue=>g.value[ue]===!0);return j||M.find(ue=>g.value[ue]!==!1)||null}function Qt(_){return u.value&&!T.value&&Ee(_)?!0:T.value?Pt(_)===_:Object.hasOwn(g.value,_)?g.value[_]===!0:!0}function Vs(_){const M=!Qt(_);if(T.value){const j={...g.value};for(const ue of Ps(_))j[ue]===!0&&(j[ue]=!1);j[_]=M,g.value=j;return}g.value={...g.value,[_]:M}}function Cs(){x.value.push(ea(b.value)),x.value.length>sk&&x.value.shift(),S.value=[]}function nn(){me.value&&(Cs(),b.value={},m.value={},v.value=!1)}function Fs(_,M=!1){const j=Date.now();if(M&&H.path===_&&j-H.at<nk){H.at=j;return}Cs(),H={path:_,at:j}}function qs(_,M,j){if(!M.length)return j;const ue=ea(_??{});let Ne=ue;for(let gt=0;gt<M.length-1;gt+=1){const it=M[gt];Ne[it]=ea(Ne[it]??{}),Ne=Ne[it]}return Ne[M.at(-1)]=j,ue}function Vn(_){var M;return Object.hasOwn(b.value,_)?b.value[_]:ea((M=e.value)==null?void 0:M[_])}function ut(_,M,j={}){var oi;const[ue,...Ne]=_.path.split(".");Fs(_.path,!!j.coalesce);const gt=Vn(ue),it=Ne.length?qs(gt,Ne,M):M,Gs={...b.value};if(Oi(it,(oi=e.value)==null?void 0:oi[ue])?delete Gs[ue]:Gs[ue]=it,b.value=Gs,m.value[_.path]){const od={...m.value};delete od[_.path],m.value=od}}function rs(_){H={path:null,at:0},E.value={...E.value,[_]:String(ce(ke.value,_)??"")}}function os(_){if(H={path:null,at:0},!Object.hasOwn(E.value,_))return;const M={...E.value};delete M[_],E.value=M}function Qe(_){const M=E.value[_.path];if(H={path:null,at:0},M===""){m.value={...m.value,[_.path]:"Enter a number."};return}const j=Number(M);if(Number.isNaN(j)||_.type==="integer"&&!Number.isInteger(j)){m.value={...m.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a number."};return}const ue={...E.value};delete ue[_.path],E.value=ue,ut(_,j,{coalesce:!0})}function gs(_){return Object.hasOwn(E.value,_.path)?E.value[_.path]:_.value??""}function q(_,M){if(E.value={...E.value,[_.path]:M},M===""){m.value={...m.value,[_.path]:"Enter a number."};return}const j=Number(M);if(!Number.isFinite(j)||_.type==="integer"&&!Number.isInteger(j)){m.value={...m.value,[_.path]:_.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(m.value[_.path]){const ue={...m.value};delete ue[_.path],m.value=ue}ut(_,j,{coalesce:!0})}function de(_){const M=Number.parseInt(O.value,10);if(!Number.isInteger(M)||M<1){m.value={...m.value,[_.path]:"Warning thresholds must be positive whole numbers."};return}const j=[...new Set([..._.value||[],M])].sort((ue,Ne)=>Ne-ue);O.value="",ut(_,j)}function Re(_,M){ut(_,(_.value||[]).filter(j=>j!==M))}function Je(_){return _.apply_mode==="live_read"?"Odin reads the saved file value on next use.":_.apply_mode==="live_for_new_work"?"New work uses the saved file value.":_.apply_mode==="live_apply"?_.apply_handler?`Apply the saved value through ${_.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":_.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":_.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":_.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function rt(_){return _.type==="array"&&Array.isArray(_.value)&&!_.structured_container&&!_.structured_container_child&&_.sensitivity==="public"&&_.value.every(M=>["string","number","boolean"].includes(typeof M))}function Lt(_){const M=String(y.value[_.path]??"").trim();if(!M)return;const j=[...new Set([..._.value||[],M])];y.value={...y.value,[_.path]:""},ut(_,j)}function Ft(_,M){ut(_,(_.value||[]).filter(j=>j!==M))}function xa(_,M){var ue;if(!_)return null;if((ue=_.enum)!=null&&ue.length&&!_.enum.includes(M))return`Choose one of: ${_.enum.join(", ")}`;if(_.path==="agents.final_warning_iterations"&&(!Array.isArray(M)||!M.length))return"Add at least one warning threshold.";const j=_.constraints||{};if((_.type==="integer"||_.type==="number")&&typeof M=="number"){if(j.minimum!==void 0&&M<j.minimum)return`Must be at least ${j.minimum}${_.unit?` ${_.unit}`:""}`;if(j.maximum!==void 0&&M>j.maximum)return`Must be at most ${j.maximum}${_.unit?` ${_.unit}`:""}`}return null}function $s(_){return B.value[_.path]||null}function li(_){const M=`${_}.`;return Object.keys(B.value).some(j=>j===_||j.startsWith(M))}function _a(){x.value.length&&(S.value.push(ea(b.value)),b.value=x.value.pop(),m.value={},E.value={},H={path:null,at:0})}function qn(){S.value.length&&(x.value.push(ea(b.value)),b.value=S.value.pop(),m.value={},E.value={},H={path:null,at:0})}function wa(){!me.value||le.value||(v.value=!0,k.value=!1)}function Gn(){v.value=!1}function z(){nn()}function he(_){return ek[_]||Ca(_||"unknown")}function Se(_){return`apply-${String(_||"unknown").replaceAll("_","-")}`}function _t(_){return`cfgc-field-${_.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function Kn(_){return`${_t(_)}-input`}function Wn(_){const M=document.getElementById(_t(_))||document.getElementById(_t(_.split(".").slice(0,2).join(".")));M==null||M.scrollIntoView({behavior:"smooth",block:"center"})}function Rn(_,M){l.value={type:_,message:M},window.setTimeout(()=>{var j;((j=l.value)==null?void 0:j.message)===M&&(l.value=null)},3500)}function cl(){o.value=!1,p.value="pending_restart",u.value="";const _=Xw(n.value);_&&(_.scrollTop=0)}function dl(){o.value=!1}function Zn(_=1800){D&&window.clearTimeout(D),D=window.setTimeout(ri,_)}async function ri(){if(c.value){if(F+=1,F>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await co(),w.value===0){c.value=!1,d.value=null,Rn("success","Odin restarted and the saved startup settings are active.");return}}catch{}Zn(2e3)}}async function xe(){if(!c.value){d.value=null;try{await G.post("/api/restart",{}),c.value=!0,F=0,o.value=!1,Zn()}catch(_){d.value=_.message||"Odin could not schedule a restart."}}}async function R(){if(!(!me.value||le.value||a.value)){a.value=!0;try{const _=lk(e.value,b.value),M=await G.put("/api/config",_);e.value=M,b.value={},x.value=[],S.value=[],m.value={},v.value=!1;try{t.value=await co(),r.value=null,o.value=w.value>0,Rn("success",w.value?`Configuration saved. ${w.value} setting${w.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(j){r.value=j.message||"Unknown metadata error.",Rn("error",`Configuration saved, but apply status could not be refreshed: ${r.value}`)}}catch(_){Rn("error",_.message||"Configuration could not be saved")}finally{a.value=!1}}}async function Q(){var _,M;if(!me.value){s.value=!0,i.value=null;try{const j=await G.get("/api/config"),ue=await co();e.value=j,t.value=ue,r.value=null;const Ne=Te.value;if(Ne.some(gt=>gt.key===f.value)||(f.value=((_=Ne[0])==null?void 0:_.key)||Va[0].key),T.value){const it=(((M=Ne.find(Gs=>Gs.key===f.value))==null?void 0:M.sections)||[]).find(Gs=>g.value[Gs]===!0);g.value=it?{...g.value,[it]:!0}:{}}}catch(j){i.value=j.message||"Unknown configuration error"}finally{s.value=!1}}}function pe(_){if(v.value||!(_.ctrlKey||_.metaKey))return;const M=_.target;M instanceof HTMLElement&&(M.matches("input, textarea, select")||M.isContentEditable)||(!_.shiftKey&&_.key.toLowerCase()==="z"?(_.preventDefault(),_a()):(_.key.toLowerCase()==="y"||_.shiftKey&&_.key.toLowerCase()==="z")&&(_.preventDefault(),qn()))}function Ie(_){T.value=_.matches}return as(g,_=>{try{localStorage.setItem(Rm,JSON.stringify(_))}catch{}},{deep:!0}),Ze(()=>{var _;Q(),document.addEventListener("keydown",pe),C=window.matchMedia("(max-width: 760px)"),Ie(C),(_=C.addEventListener)==null||_.call(C,"change",Ie)}),xt(()=>{var _;document.removeEventListener("keydown",pe),(_=C==null?void 0:C.removeEventListener)==null||_.call(C,"change",Ie),D&&window.clearTimeout(D)}),{config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:r,restartPromptOpen:o,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:v,mobileOverflowOpen:k,warningThresholdInput:O,arrayInputs:y,healthFilters:N,visibleCategories:Te,displayGroups:re,reviewGroups:ye,sectionCount:ee,fieldCount:U,hasChanges:me,changeCount:ie,changedSectionCount:ge,hasDraftErrors:le,canUndo:I,canRedo:te,globalFilterActive:W,reviewRestartCount:ve,pendingRestartCount:w,pendingRestartFields:$e,healthCount:Ge,categoryStats:Ue,selectCategory:Ds,selectHealthFilter:An,clearFilters:Ts,sectionLabel:J,sectionDescription:se,sectionFieldCount:ae,sectionHealthCount:Oe,sectionApplySummary:P,sectionApplyDetails:X,sectionEntries:be,fieldGroups:Me,sectionSearchHits:we,mcpConfigSummary:ne,fieldRuntimeCopy:De,fieldSpecificRuntimeNote:ze,hasHonestAction:qe,runFieldAction:dt,sectionChanged:mt,fieldChanged:Yt,isSectionExpanded:Qt,toggleSection:Vs,discardAllDrafts:nn,setFieldValue:ut,setNumberFieldValue:q,numberInputValue:gs,beginInputEdit:rs,endTextInputEdit:os,endInputEdit:Qe,addWarningThreshold:de,removeWarningThreshold:Re,isScalarArray:rt,addScalarArrayItem:Lt,removeScalarArrayItem:Ft,fieldError:$s,sectionHasErrors:li,undo:_a,redo:qn,openReview:wa,closeReview:Gn,mobileCancel:z,applyModeLabel:he,applyClass:Se,compactValue:ak,formatValue:ik,structuredApplyCopy:Je,fieldId:_t,fieldInputId:Kn,focusField:Wn,fetchConfig:Q,saveConfig:R,restartOdin:xe,restartLater:dl,reviewPendingRestart:cl}}},dk=/^\d{15,25}$/;function Lm(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Mm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=Z(()=>new Set((e.excludedIds||[]).map(String))),r=Z(()=>{const S=s.value.toLowerCase().trim();return(e.members||[]).filter(v=>l.value.has(String(v.id))?!1:S?u(v).toLowerCase().includes(S)||String(v.username||"").toLowerCase().includes(S)||String(v.id).includes(S):!0)}),o=Z(()=>{const S=s.value.trim();return r.value.length===0&&dk.test(S)&&!l.value.has(S)?S:""}),c=Z(()=>r.value.length+(o.value?1:0)),d=Z(()=>{if(n.value){if(r.value[a.value])return`${e.optionsId}-${a.value}`;if(o.value&&a.value===r.value.length)return`${e.optionsId}-raw`}});function u(S){return Lm(S)}function p(){n.value=!0,a.value=0}function f(){p()}function g(){const S=Math.max(c.value-1,0);a.value=Math.min(a.value+1,S)}function b(){a.value=Math.max(a.value-1,0)}function E(){const S=r.value[a.value];S?O(S):o.value&&a.value===r.value.length&&y(o.value)}function O(S){y(String(S.id))}function y(S){t("select",S),s.value="",n.value=!1,a.value=0}function m(){n.value=!1}function x(){setTimeout(m,150)}return Ze(()=>{e.autofocus&&Ct(()=>{var S;return(S=i.value)==null?void 0:S.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:r,rawId:o,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:g,highlightPrevious:b,selectHighlighted:E,selectMember:O,selectId:y,closeOptions:m,onBlur:x}}};function Hu(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const uk={components:{DiscordUserCombobox:Mm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h(null),i=h(null),l=h(!1),r=h(null),o=h({}),c=h([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=Z(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),f=Z(()=>new Map(c.value.map(A=>[String(A.id),A])));function g(A){return A.config&&A.config.enabled!==void 0?A.config.enabled:!0}function b(A){return Hu(A,"require_mention",a.value)}function E(A){return Hu(A,"respond_to_bots",a.value)}function O(A){return A.config&&Object.keys(A.config).length>0}function y(A){n.value[A]=!n.value[A]}function m(A){const V=A.discord||{};return{allowed_users:[...V.allowed_users||[]],channels:[...V.channels||[]],respond_to_bots:!!V.respond_to_bots,require_mention:!!V.require_mention,ignore_bot_ids:[...V.ignore_bot_ids||[]]}}async function x({showLoading:A=!0}={}){const V=++d;A&&(t.value=!0),s.value=null;try{const ee=await G.get("/api/discord/guilds");V===d&&(e.value=ee)}catch(ee){V===d&&(s.value=ee.message)}finally{A&&V===d&&(t.value=!1)}}async function S(){t.value=!0,s.value=null;try{const[A,V,ee]=await Promise.all([G.get("/api/discord/guilds"),G.get("/api/discord/members").catch(()=>[]),G.get("/api/config")]),U=m(ee),N=p.value;a.value=U,N||(i.value=JSON.parse(JSON.stringify(U))),c.value=V,e.value=A,r.value=null}catch(A){s.value=A.message}finally{t.value=!1}}async function v(A,V,ee){try{await G.put("/api/discord/guild/"+A+"/config",{[V]:ee}),await x({showLoading:!1})}catch(U){s.value=U.message}}async function k(A,V,ee,U){try{await G.put("/api/discord/channel/"+A+"/config",{[ee]:U}),await x({showLoading:!1})}catch(N){s.value=N.message}}async function T(A,V){try{await G.put("/api/discord/channel/"+A+"/config",{clear:!0}),await x({showLoading:!1})}catch(ee){s.value=ee.message}}function C(A,V){const ee=String(V);if(!A.userAutocomplete)return ee;const U=f.value.get(ee);return U?Lm(U):ee}function D(A,V=null){const ee=String(V??o.value[A]??"").trim();!ee||i.value[A].includes(ee)||(i.value[A]=[...i.value[A],ee],o.value={...o.value,[A]:""})}function H(A,V){i.value[A]=i.value[A].filter(ee=>ee!==V)}async function F(){if(!(!p.value||l.value)){l.value=!0,r.value=null;try{const V=(await G.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...V.allowed_users||[]],channels:[...V.channels||[]],respond_to_bots:!!V.respond_to_bots,require_mention:!!V.require_mention,ignore_bot_ids:[...V.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(A){r.value=A.message||"Global defaults could not be saved."}finally{l.value=!1}}}return Ze(S),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:r,globalArrayInputs:o,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:g,guildMention:b,guildBots:E,hasOverride:O,toggleGuild:y,fetchAll:S,fetchGuilds:x,setGuildConfig:v,setChannelConfig:k,clearOverride:T,globalItemLabel:C,addGlobalItem:D,removeGlobalItem:H,saveGlobalDefaults:F}}},vs=e=>e==null?e:JSON.parse(JSON.stringify(e));function pk({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:r=()=>{},onError:o=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let f=null;const g=new Map;function b(v){d+=1;const k=c.then(v,v);return c=k.catch(()=>{}),k}function E(v,k){f=vs(v),g.clear();for(const[T,C]of Object.entries(k||{}))g.set(T,vs(C))}function O(v){const k=vs(v),T=++u;return b(async()=>{try{await e(vs(k)),f=vs(k),T===u&&n(vs(k))}catch(C){T===u&&(a(vs(f)),o(C,{kind:"default"}))}})}function y(v,k){const T=vs(k),C=(p.get(v)||0)+1;return p.set(v,C),b(async()=>{try{await t(v,vs(T)),g.set(v,vs(T)),C===p.get(v)&&i(v,vs(T))}catch(D){C===p.get(v)&&(l(v,vs(g.get(v)??null)),o(D,{kind:"user",uid:v}))}})}function m(v){const k=(p.get(v)||0)+1;return p.set(v,k),b(async()=>{try{await s(v),g.delete(v),k===p.get(v)&&r(v)}catch(T){k===p.get(v)&&(l(v,vs(g.get(v)??null)),o(T,{kind:"delete",uid:v}))}})}async function x(){for(;;){const v=c;if(await v,v===c)return d}}async function S(v){for(;;){const k=await x(),T=await v();if(k===d)return T}}return{seed:E,saveDefault:O,saveUser:y,deleteUser:m,whenIdle:x,readSnapshot:S,get revision(){return d}}}const fk={components:{DiscordUserCombobox:Mm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h([]),o=Z(()=>{const v={};for(const k of r.value)v[k.id]=k;return v});function c(v){return o.value[v]||null}function d(v,k){return v?v.allowed_hosts===null||v.allowed_hosts===void 0?{allowed_hosts:[...k],default_host:v.default_host||"",allow_all:!0}:{allowed_hosts:v.allowed_hosts,default_host:v.default_host||"",allow_all:!1}:{allowed_hosts:[...k],default_host:k[0]||"",allow_all:!0}}const u=pk({applyDefault:async v=>{const k=v.allow_all?null:v.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:k,default_host:v.default_host})},applyUser:async(v,k)=>{const T=k.allow_all?null:k.allowed_hosts;await G.put(`/api/host-access/user/${v}`,{allowed_hosts:T,default_host:k.default_host})},applyDelete:v=>G.del(`/api/host-access/user/${v}`),onDefaultConfirmed:()=>Ce.success("Default policy updated"),onDefaultRollback:v=>{v&&(a.value=v)},onUserConfirmed:v=>{const k=c(v);Ce.success(`Updated access for ${k?k.display_name:v}`)},onUserRollback:(v,k)=>{const T={...i.value};k?T[v]=k:delete T[v],i.value=T},onUserDeleted:v=>{const k={...i.value};delete k[v],i.value=k},onError:(v,k)=>{var C;const T=k.uid?` ${((C=c(k.uid))==null?void 0:C.display_name)||k.uid}`:"";Ce.error(`${v.message||"Failed to save"} — reverted${T}`)}});let p=0;async function f(){const v=++p;e.value=!0,t.value="";try{const k=await u.readSnapshot(()=>G.get("/api/host-access"));if(v!==p)return;s.value=k,n.value=k.available_hosts||[],a.value=d(k.default_policy,n.value);const T=k.users||{},C={};for(const[D,H]of Object.entries(T))C[D]=d(H,n.value);i.value=C,u.seed(a.value,C)}catch(k){v===p&&(t.value=k.message||"Failed to fetch host access data")}finally{v===p&&(e.value=!1)}try{const k=await G.get("/api/discord/members")||[];v===p&&(r.value=k)}catch{v===p&&(r.value=[])}}function g(){u.saveDefault(a.value)}function b(v,k){a.value.allow_all=!1,k?a.value.allowed_hosts.includes(v)||a.value.allowed_hosts.push(v):(a.value.allowed_hosts=a.value.allowed_hosts.filter(T=>T!==v),a.value.default_host===v&&(a.value.default_host=a.value.allowed_hosts[0]||"")),g()}function E(v){const k=i.value[v];k&&u.saveUser(v,k)}function O(v,k,T){const C=i.value[v];C&&(C.allow_all=!1,T?C.allowed_hosts.includes(k)||C.allowed_hosts.push(k):(C.allowed_hosts=C.allowed_hosts.filter(D=>D!==k),C.default_host===k&&(C.default_host=C.allowed_hosts[0]||"")),E(v))}function y(v,k){const T=i.value[v];T&&(T.default_host=k,E(v))}function m(){l.value=!0}function x(v){!/^\d{15,25}$/.test(v)||i.value[v]||(i.value[v]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},E(v),l.value=!1)}async function S(v){const k=c(v);await Zt({title:"Remove user override",message:`Remove the host access override for ${k?k.display_name:v}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await u.deleteUser(v),i.value[v]||Ce.success(`Removed override for ${k?k.display_name:v}`))}return Ze(f),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,members:r,fetchData:f,saveDefaultPolicy:g,toggleDefaultHost:b,getMember:c,toggleUserHost:O,setUserDefault:y,openAddUser:m,addUserById:x,deleteUser:S}}},hk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=Z(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=Z(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function g(){e.value=!0,t.value="";try{const T=await G.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function b(T){return!T||!T.trim()?[]:T.split(",").map(C=>C.trim()).filter(Boolean)}function E(T,C){const D=c.value.allowed_hosts;if(C&&!D.includes(T)&&D.push(T),!C){const H=D.indexOf(T);H>=0&&D.splice(H,1)}}function O(T,C){const D=d.value.allowed_hosts;if(C&&!D.includes(T)&&D.push(T),!C){const H=D.indexOf(T);H>=0&&D.splice(H,1)}}async function y(){var T;i.value=!0;try{const C=b(c.value.allowed_tools_str),D=c.value.host_mode,H=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,F={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:C.length?C:[]};H!==null&&(F.allowed_hosts=H),F.default_host=c.value.default_host||"";const A=await G.post("/api/tokens",F);l.value=A.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Ce.success("Token created"),await g()}catch(C){Ce.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to create token")}finally{i.value=!1}}function m(T){r.value=T;const C=T.allowed_hosts;let D="default";C==null?D="default":Array.isArray(C)&&C.length===0?D="none":Array.isArray(C)&&(D="select"),d.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:D,allowed_hosts:Array.isArray(C)?[...C]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const C=b(d.value.allowed_tools_str),D=d.value.host_mode,H={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:C};D==="none"?H.allowed_hosts=[]:D==="select"?H.allowed_hosts=d.value.allowed_hosts:H.allowed_hosts=null,H.default_host=d.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,Ce.success("Token updated"),await g()}catch(C){Ce.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to update")}finally{o.value=!1}}}async function S(T){var D;if(await Zt({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await G.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=H.token,Ce.success("Token regenerated")}catch(H){Ce.error(((D=H.data)==null?void 0:D.error)||H.message||"Failed to regenerate")}}async function v(T){var D;if(await Zt({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(T.user_id)),Ce.success("Token deleted"),await g()}catch(H){Ce.error(((D=H.data)==null?void 0:D.error)||H.message||"Failed to delete")}}async function k(){if(l.value)try{await navigator.clipboard.writeText(l.value),Ce.success("Copied to clipboard")}catch{Ce.error("Copy failed — select and copy manually")}}return Ze(g),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:g,tierBadge:f,toggleCreateHost:E,toggleEditHost:O,createToken:y,startEdit:m,saveEdit:x,confirmRegenerate:S,confirmDelete:v,copyToken:k}}},mk=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),gk=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),vk=Object.freeze(["enabled","base_url","model","max_tokens"]),bk=Object.freeze(["enabled","model","max_tokens"]);function Ur(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function zu(e){return Ur(e,mk)}function ju(e){return Ur(e,gk)}function yk(e,{includeApiKey:t=!1}={}){const s=Ur(e,vk);return t&&(s.api_key=e.api_key),s}function xk(e){return{timeout:e.timeout}}function _k(e,{includeApiKey:t=!1}={}){const s=Ur(e,bk);return t&&(s.api_key=e.api_key),s}function wk(e){return{timeout:e.timeout}}function Tl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const kk={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=Z(()=>{const z=n.value.model;return z&&!a.includes(z)?[z,...a]:a}),l=Z(()=>{const z=n.value.agent_model;return z&&z!=="auto"&&!a.includes(z)?[z,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=Z(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=Z(()=>{const z=n.value.agent_model;return z==="auto"?!0:!r.includes(z||n.value.model)}),d=Z(()=>{const z=n.value.agent_reasoning_effort;return z==="auto"?!1:(z||n.value.reasoning_effort)==="max"}),u=z=>r.includes(z)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),p=z=>r.includes(z)&&d.value,f=h({enabled:!1,model:"gpt-5.6-luna"}),g=h({unavailable_reason:null}),b=Z(()=>{const z=f.value.model;return z&&!a.includes(z)?[z,...a]:a});function E(z){const he=z.target.value;f.value.enabled=he!=="",he!==""&&(f.value.model=he),rs()}const O=h(!1),y=h({codex:!1,ollama:!1,kimi:!1}),m=h(null),x=h(!1),S=h(""),v=h(null),k=h(!1);let T=0;const C=Z(()=>{var z;return Object.entries(((z=m.value)==null?void 0:z.models)||{}).map(([he,Se])=>{var _t,Kn,Wn;return{model:he,floor:Se.floor,override:Se.override,effectiveBudget:(_t=Se.effective)==null?void 0:_t.effective_budget,configuredPrimaryChars:(Kn=Se.configured)==null?void 0:Kn.primary_chars,primaryChars:(Wn=Se.effective)==null?void 0:Wn.primary_chars,provenance:Se.provenance,clampExpiresAt:Se.clamp_expires_at}})}),D=Z(()=>{var z;return((z=m.value)==null?void 0:z.clamps)||[]}),H=Z(()=>{var z,he;return((he=(z=m.value)==null?void 0:z.models)==null?void 0:he[n.value.model])||null}),F=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),A=h({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),V=h(!1),ee=h(!1),U=h(!1),N=h(!1),I=h(!1),te=h(!1),Te=h(!1),ke=h({configured:!1}),oe=h([]),me=h(""),ie=h(!1),ge=h(!1),W=h({configured:!1}),B=h([]),le=h(""),re=h(!1),ye=h(!1),ve=h(!0),$e=h(""),w=h({configured:!1,accounts:[]}),L=h(null),$=h(null),ae=h(""),J=h(null),se=h(!1),fe=h(null),P=h(null),X=h("");let K=null;function ne(z,he="success"){Ce(z,he==="error"?"error":"success")}function ce(z){if(!z)return"?";const he=z/(1024*1024*1024);return he>=1?he.toFixed(1)+" GB":(z/(1024*1024)).toFixed(0)+" MB"}function be(z){return Number.isFinite(Number(z))?Number(z).toLocaleString():"—"}function Ae(z){return z==null?"automatic (model-derived)":Number(z).toLocaleString()+" characters"}function Me(z){const he=new Date(z);return Number.isNaN(he.getTime())?"unknown":he.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function De(z){return typeof z=="string"&&z.length>12?z.slice(0,8)+"…"+z.slice(-4):z}function Fe(z){return z==="temporary learned clamp"?"is-clamp":z==="override"?"is-override":"is-built-in"}function ze(z){const he=n.value.context_budget_overrides[z.model];return z.floor!=null&&Number.isFinite(Number(he))&&Number(he)>z.floor}function qe(z,he){const Se={...n.value.context_budget_overrides};he.target.value===""?delete Se[z]:Se[z]=Number(he.target.value),n.value.context_budget_overrides=Se,k.value=!0}function dt(z){n.value.context_utilization=z.target.value===""?"":Number(z.target.value),k.value=!0}function Y(z){const he={...n.value.context_budget_overrides};delete he[z],n.value.context_budget_overrides=he,k.value=!0}async function we(){e.value=!0,await Promise.all([Ee(),Ge(),Ts(),Ue(),Oe()]),e.value=!1}async function Ee({preserveBasic:z=!1,preserveAdvanced:he=!1}={}){try{const Se=await G.get("/api/llm/status");t.value=Se,s.value=Se.active_provider||"codex",Se.codex&&!ut.pending()&&(z||(n.value.enabled=Se.codex.enabled,n.value.model=Se.codex.model||"gpt-5.6-sol",n.value.reasoning_effort=Se.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=Se.codex.agent_reasoning_effort||"",n.value.agent_model=Se.codex.agent_model||""),he||(n.value.request_timeout_seconds=Se.codex.request_timeout_seconds??n.value.request_timeout_seconds,n.value.stream_stall_timeout_seconds=Se.codex.stream_stall_timeout_seconds??n.value.stream_stall_timeout_seconds,n.value.retry={...n.value.retry,...Se.codex.retry||{}},n.value.connection_pool={...n.value.connection_pool,...Se.codex.connection_pool||{}},n.value.context_compression={...n.value.context_compression,...Se.codex.context_compression||{}},!k.value&&!U.value&&(n.value.context_budget_overrides={...Se.codex.context_budget_overrides||{}},n.value.context_utilization=Se.codex.context_utilization??n.value.context_utilization))),Se.ollama&&!os.pending()&&(z||(F.value.enabled=Se.ollama.enabled,F.value.base_url=Se.ollama.base_url||"",F.value.model=Se.ollama.model||"",F.value.max_tokens=Se.ollama.max_tokens||4096),he||(F.value.timeout=Se.ollama.timeout??F.value.timeout)),Se.kimi&&!Qe.pending()&&(z||(A.value.enabled=Se.kimi.enabled,A.value.model=Se.kimi.model||"",A.value.max_tokens=Se.kimi.max_tokens||4096),he||(A.value.timeout=Se.kimi.timeout??A.value.timeout)),Se.auxiliary&&(g.value=Se.auxiliary,rs.pending()||(f.value.enabled=Se.auxiliary.enabled,f.value.model=Se.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Oe(){const z=++T;x.value=!0,S.value="";try{const he=await G.get("/api/context/windows");if(z!==T)return;m.value=he,!U.value&&!k.value&&(n.value.context_budget_overrides=Object.fromEntries(Object.entries(he.models||{}).filter(([,Se])=>Se.override!=null).map(([Se,_t])=>[Se,_t.override])),n.value.context_utilization=he.utilization??n.value.context_utilization)}catch(he){z===T&&(S.value=he.message||"Failed to load context budgets")}finally{z===T&&(x.value=!1)}}async function Ge(){try{if(ke.value=await G.get("/api/ollama/status"),ke.value.model&&(me.value=ke.value.model),ke.value.configured)try{const z=await G.get("/api/ollama/models");oe.value=z.models||[]}catch{oe.value=[]}else if(F.value.base_url)try{const z=await G.post("/api/ollama/probe-models",{base_url:F.value.base_url});oe.value=z.models||[]}catch{oe.value=[]}}catch{ke.value={configured:!1}}}async function Ue(){ve.value=!0,$e.value="";try{w.value=await G.get("/api/codex/status")}catch(z){$e.value=z.message||"Failed to fetch Codex status"}finally{ve.value=!1}}async function mt(){const z=t.value?t.value.active_provider:"codex";Te.value=!0;try{const he=await G.post("/api/llm/switch",{provider:s.value});he.error?(s.value=z,ne(he.error,"error")):(ne("Switched to "+s.value+" ("+he.model+")"),await we())}catch(he){s.value=z,ne(he.message||"Switch failed","error")}finally{Te.value=!1}}async function Yt(){ie.value=!0;try{const z=await G.post("/api/ollama/reload");ne(z.configured?"Ollama reloaded":z.reason||"Ollama not configured",z.configured?"success":"error"),await we()}catch(z){ne(z.message||"Reload failed","error")}finally{ie.value=!1}}async function Ds(){ge.value=!0;try{await G.post("/api/ollama/model",{model:me.value}),ne("Model set to "+me.value),await we()}catch(z){ne(z.message||"Failed","error")}finally{ge.value=!1}}async function An(){const z=F.value.base_url;if(!z){ne("Enter a base URL first","error");return}te.value=!0;try{const he=await G.post("/api/ollama/probe-models",{base_url:z});oe.value=he.models||[],oe.value.length?(ne(oe.value.length+" model(s) found"),!F.value.model&&oe.value.length&&(F.value.model=oe.value[0].name)):ne("No models found at "+z,"error")}catch(he){ne(he.message||"Could not reach Ollama","error")}finally{te.value=!1}}async function Ts(){try{if(W.value=await G.get("/api/kimi/status"),W.value.model&&(le.value=W.value.model),W.value.configured)try{const z=await G.get("/api/kimi/models");B.value=z.models||[]}catch{B.value=[]}}catch{W.value={configured:!1}}}async function Ps(){re.value=!0;try{const z=await G.post("/api/kimi/reload");ne(z.configured?"Kimi reloaded":z.reason||"Kimi not configured",z.configured?"success":"error"),await we()}catch(z){ne(z.message||"Reload failed","error")}finally{re.value=!1}}async function Pt(){ye.value=!0;try{await G.post("/api/kimi/model",{model:le.value}),ne("Model set to "+le.value),await we()}catch(z){ne(z.message||"Failed","error")}finally{ye.value=!1}}async function Qt(){if(U.value){ut();return}U.value=!0;const z=zu(n.value);try{await G.put("/api/llm/codex/config",z),ne("Codex config saved"),await Promise.all([Ee({preserveBasic:!0,preserveAdvanced:!0}),Ue()])}catch(he){ne(he.message||"Failed","error");const Se=JSON.stringify(zu(n.value))!==JSON.stringify(z);await Promise.all([Ee({preserveBasic:Se,preserveAdvanced:!0}),Ue()])}finally{U.value=!1}}async function Vs(){if(U.value)return;U.value=!0;const z=ju(n.value);try{await G.put("/api/llm/codex/config",z),JSON.stringify({context_budget_overrides:n.value.context_budget_overrides,context_utilization:n.value.context_utilization})===JSON.stringify({context_budget_overrides:z.context_budget_overrides,context_utilization:z.context_utilization})&&(k.value=!1),ne("Codex advanced settings saved"),await Promise.all([Ee({preserveBasic:!0,preserveAdvanced:!0}),Ue(),Oe()])}catch(he){ne(he.message||"Failed","error");const Se=JSON.stringify(ju(n.value))!==JSON.stringify(z);await Promise.all([Ee({preserveBasic:!0,preserveAdvanced:Se}),Ue(),Oe()])}finally{U.value=!1}}async function Cs(){if(N.value){os();return}N.value=!0;try{const z=V.value?F.value.api_key:null,he=yk(F.value,{includeApiKey:z!==null});await G.put("/api/llm/ollama/config",he),ne("Ollama config saved"),z!==null&&F.value.api_key===z&&(F.value.api_key="",V.value=!1),await Promise.all([Ee({preserveBasic:!0,preserveAdvanced:!0}),Ge()])}catch(z){ne(z.message||"Failed","error")}finally{N.value=!1}}async function nn(){if(!N.value){N.value=!0;try{await G.put("/api/llm/ollama/config",xk(F.value)),ne("Ollama timeout saved"),await Promise.all([Ee({preserveBasic:!0,preserveAdvanced:!0}),Ge()])}catch(z){ne(z.message||"Failed","error")}finally{N.value=!1}}}async function Fs(){if(I.value){Qe();return}I.value=!0;try{const z=ee.value?A.value.api_key:null,he=_k(A.value,{includeApiKey:z!==null});await G.put("/api/llm/kimi/config",he),ne("Kimi config saved"),z!==null&&A.value.api_key===z&&(A.value.api_key="",ee.value=!1),await Promise.all([Ee({preserveBasic:!0,preserveAdvanced:!0}),Ts()])}catch(z){ne(z.message||"Failed","error")}finally{I.value=!1}}async function qs(){if(!I.value){I.value=!0;try{await G.put("/api/llm/kimi/config",wk(A.value)),ne("Kimi timeout saved"),await Promise.all([Ee({preserveBasic:!0,preserveAdvanced:!0}),Ts()])}catch(z){ne(z.message||"Failed","error")}finally{I.value=!1}}}async function Vn(){if(O.value){rs();return}O.value=!0;try{await G.put("/api/llm/auxiliary/config",f.value),ne("Auxiliary config saved"),await Ee()}catch(z){ne(z.message||"Failed","error"),await Ee()}finally{O.value=!1}}const ut=Tl(Qt),rs=Tl(Vn),os=Tl(Cs),Qe=Tl(Fs),gs=()=>(ut.cancel(),Qt()),q=()=>(os.cancel(),Cs()),de=()=>(Qe.cancel(),Fs()),Re=()=>Vs(),Je=()=>nn(),rt=()=>qs();async function Lt(z){const he=z.account_key+":"+z.model;v.value=he;try{const Se=await G.post("/api/context/windows/clear",{account_key:z.account_key,model:z.model});ne(Se.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Oe()}catch(Se){ne(Se.message||"Failed to clear clamp","error"),await Oe()}finally{v.value=null}}async function Ft(z){try{await G.post("/api/codex/account/"+z+"/activate"),ne("Active account switched"),await Ue()}catch(he){ne(he.message||"Failed","error")}}async function xa(z){L.value=z;try{await G.post("/api/codex/account/"+z+"/refresh"),ne("Token refreshed"),await Ue()}catch(he){ne(he.message||"Refresh failed","error")}finally{L.value=null}}function $s(z,he){$.value=z,ae.value=he||""}async function li(z){try{await G.put("/api/codex/account/"+z+"/label",{label:ae.value}),ne("Label updated"),$.value=null,await Ue()}catch(he){ne(he.message||"Failed","error")}}async function _a(z,he){if(await Zt({title:"Delete Codex account",message:`Delete ${he||"account #"+(z+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/codex/account/"+z),ne("Deleted. Pool reloaded."),await Ue()}catch(_t){ne(_t.message||"Failed","error")}}async function qn(){se.value=!0;try{const z=await G.post("/api/codex/device-code");fe.value=z,J.value="pending",wa(z)}catch(z){ne(z.message||"Failed","error")}finally{se.value=!1}}async function wa(z){K={cancelled:!1};const he=K;try{const Se=await G.post("/api/codex/device-poll",{device_auth_id:z.device_auth_id,user_code:z.user_code,interval:z.interval});if(he.cancelled)return;P.value=Se,J.value="success",await we()}catch(Se){if(he.cancelled)return;X.value=Se.message||"Device login failed",J.value="error"}}function Gn(){K&&(K.cancelled=!0),J.value=null,fe.value=null}return Ze(we),xt(()=>{K&&(K.cancelled=!0),ut.cancel(),rs.cancel(),os.cancel(),Qe.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:Te,advancedOpen:y,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:p,auxForm:f,auxData:g,auxModelOptions:b,onAuxModelChange:E,savingAux:O,saveAuxConfigDebounced:rs,ollamaForm:F,kimiForm:A,savingCodex:U,savingOllama:N,savingKimi:I,probingOllama:te,ollamaKeyDirty:V,kimiKeyDirty:ee,ollamaStatus:ke,ollamaModels:oe,ollamaSelectedModel:me,reloading:ie,settingModel:ge,kimiStatus:W,kimiModels:B,kimiSelectedModel:le,reloadingKimi:re,settingKimiModel:ye,codexLoading:ve,codexError:$e,codexData:w,refreshing:L,editingLabel:$,labelValue:ae,contextWindows:m,contextWindowsLoading:x,contextWindowsError:S,contextBudgetRows:C,activeClampRows:D,activeContextBudget:H,clearingClamp:v,contextPolicyDirty:k,deviceState:J,deviceLoading:se,deviceInfo:fe,deviceResult:P,deviceError:X,fetchAll:we,switchProvider:mt,reloadOllama:Yt,setOllamaModel:Ds,reloadKimi:Ps,setKimiModel:Pt,probeOllamaModels:An,saveCodexConfig:Qt,saveOllamaConfig:Cs,saveKimiConfig:Fs,saveCodexAdvancedConfig:Vs,saveOllamaAdvancedConfig:nn,saveKimiAdvancedConfig:qs,saveCodexConfigDebounced:ut,saveOllamaConfigDebounced:os,saveKimiConfigDebounced:Qe,saveCodexConfigNow:gs,saveOllamaConfigNow:q,saveKimiConfigNow:de,saveCodexAdvancedConfigNow:Re,saveOllamaAdvancedConfigNow:Je,saveKimiAdvancedConfigNow:rt,activateAccount:Ft,refreshAccount:xa,startEditLabel:$s,saveLabel:li,deleteAccount:_a,startDeviceLogin:qn,cancelDeviceLogin:Gn,formatSize:ce,fetchContextWindows:Oe,clearContextClamp:Lt,setContextOverride:qe,setContextUtilization:dt,resetContextOverride:Y,overrideAboveFloor:ze,formatCount:be,formatContextCeiling:Ae,formatExpiry:Me,shortAccountKey:De,provenanceClass:Fe}}},Vu={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Sk(e){return Vu[e]||Vu[(e||"").toLowerCase()]||"text-gray-400"}const Tk={template:`
  ...
  `},Dm=[{id:"health",label:"Health",component:Gw},{id:"resources",label:"Resources",component:Kw},{id:"logs",label:"Logs",component:Yw},{id:"config",label:"Config",component:ck},{id:"discord",label:"Discord",component:uk},{id:"host-access",label:"Host Access",component:fk},{id:"api-tokens",label:"API Tokens",component:hk},{id:"llm",label:"LLM Config",component:kk},{id:"internals",label:"Internals",component:Tk},{id:"update",label:"Update",component:Ck}],Ek={components:{TabbedPage:$r},setup(){return{tabs:Dm}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Cl=(e,t,s,n)=>n.map(({id:a,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:a}}})),Ak=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Cl("Operations","operations","/operations",Cm),...Cl("History","history","/history",Em),...Cl("Capabilities","capabilities","/capabilities",Am),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Cl("System","system","/system",Dm)],us=zn({open:!1,query:"",selected:0});function qu(){us.query="",us.selected=0,us.open=!0}function uo(){us.open=!1}function Rk(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const Ik={setup(){const e=bm(),t=h(null),s=Z(()=>{const i=us.query.trim().toLowerCase();return Ak.map(l=>({...l,_score:Rk(l,i)})).filter(l=>l._score>0).sort((l,r)=>r._score-l._score)});as(()=>us.open,async i=>{var l;i&&(await Ct(),(l=t.value)==null||l.focus())}),as(()=>us.query,()=>{us.selected=0});function n(i){uo(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),uo();return}if(i.key==="ArrowDown")i.preventDefault(),us.selected=Math.min(us.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),us.selected=Math.max(us.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[us.selected];l&&n(l)}}return{state:us,results:s,inputEl:t,go:n,onKeydown:a,closePalette:uo}},template:`
    <transition name="modal">
  ...
  `},Ko={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(Ko));const Ok={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>Ka("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[Ka("path",{d:Ko[e.name]||Ko.info})])}},Nk=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function Gu(e){return[...e.querySelectorAll(Nk)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const Lk={mounted(e){const t=document.activeElement,s=n=>{if(n.key!=="Tab")return;const a=Gu(e);if(!a.length){n.preventDefault(),e.focus();return}const i=a[0],l=a[a.length-1];n.shiftKey&&document.activeElement===i?(n.preventDefault(),l.focus()):!n.shiftKey&&document.activeElement===l&&(n.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||Gu(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},Mk={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),d=h({reload:!1,clearSessions:!1,stopLoops:!1});let u=0;const p=Z(()=>{const A=e.value.uptime_seconds||0,V=Math.floor(A/86400),ee=Math.floor(A%86400/3600),U=Math.floor(A%3600/60),N=[];return V>0&&N.push(`${V}d`),ee>0&&N.push(`${ee}h`),(N.length===0||V===0&&ee===0)&&N.push(`${U}m`),N.join(" ")}),f=Z(()=>{const A=e.value.uptime_seconds||0;return 125.66*(1-Math.min(A/86400,1))}),g=Z(()=>{const A=e.value;return[{label:"Guilds",value:A.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:A.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:A.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${A.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:A.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:A.loop_count>0?"text-green-400":"",highlight:A.loop_count>0},{label:"Agents",value:A.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:A.agent_count>0?`${A.agent_count} total`:"",subColor:"text-gray-500",highlight:(A.agent_running??0)>0},{label:"Processes",value:A.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:A.process_count>0?`${A.process_count} total`:"",subColor:"text-gray-500",highlight:(A.process_running??0)>0},{label:"Schedules",value:A.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(A.schedule_failing>0?`${A.schedule_failing} failing`:"")+(A.schedule_failing>0&&A.schedule_paused>0?", ":"")+(A.schedule_paused>0?`${A.schedule_paused} paused`:"")||void 0,subColor:A.schedule_failing>0?"text-red-400":"text-yellow-400",color:A.schedule_failing>0?"text-red-400":"",highlight:A.schedule_failing>0},{label:"Users",value:A.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),b=Z(()=>{const A=e.value,V=[];return V.push({label:"Bot",status:A.status==="online"?"ok":"warn",detail:A.status==="online"?"Online":"Starting"}),(A.schedule_failing||0)>0?V.push({label:"Schedules",status:"error",detail:`${A.schedule_failing} failing`}):(A.schedule_count||0)>0&&V.push({label:"Schedules",status:"ok",detail:`${A.schedule_count} configured`}),(A.loop_count||0)>0&&V.push({label:"Loops",status:"ok",detail:`${A.loop_count} active`}),(A.agent_running||0)>0&&V.push({label:"Agents",status:"ok",detail:`${A.agent_running} running`}),(A.process_running||0)>0&&V.push({label:"Processes",status:"ok",detail:`${A.process_running} running`}),V});async function E(){try{e.value=await G.get("/api/status"),s.value=null}catch(A){s.value=A.message}finally{t.value=!1}}async function O(){a.value=!0;try{n.value=await G.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function y(){l.value=!0;try{i.value=await G.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function m(){try{const A=await G.get("/api/knowledge");c.value=(Array.isArray(A)?A:[]).reduce((V,ee)=>V+(ee.chunks||0),0)}catch{c.value=null}}async function x(){try{const A=await G.get("/api/agents");r.value=A.filter(V=>V.status==="running")}catch{}}async function S(){d.value={...d.value,reload:!0};try{await G.post("/api/reload"),Ce.success("Config reloaded")}catch(A){Ce.error(A.message)}d.value={...d.value,reload:!1}}async function v(){if(!await Zt({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;d.value={...d.value,clearSessions:!0};const V=e.value.session_count;e.value={...e.value,session_count:0};try{const ee=await G.post("/api/sessions/clear-all");Ce.success(`Cleared ${ee.count} session${ee.count!==1?"s":""}`),await E()}catch(ee){e.value={...e.value,session_count:V},Ce.error(ee.message)}d.value={...d.value,clearSessions:!1}}async function k(){if(!await Zt({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;d.value={...d.value,stopLoops:!0};const V=e.value.loop_count;e.value={...e.value,loop_count:0};try{const ee=await G.post("/api/loops/stop-all");Ce.success(ee.result),await E()}catch(ee){e.value={...e.value,loop_count:V},Ce.error(ee.message)}d.value={...d.value,stopLoops:!1}}function T(){t.value=!0,s.value=null,E(),O(),y(),x()}let C=null,D=null,H=null;function F(A){if(A.payload&&A.payload.tool_name){const V={...A.payload,_isNew:!0,_key:++u};n.value.unshift(V),n.value.length>10&&n.value.pop(),o.value++,V.error&&(i.value.unshift(V),i.value.length>5&&i.value.pop()),setTimeout(()=>{V._isNew=!1},1500),clearTimeout(H),H=setTimeout(()=>{o.value=0},1e4)}}return Ze(async()=>{await Promise.all([E(),O(),y(),x(),m()]),C=setInterval(E,15e3),D=setInterval(x,1e4),je.subscribe("events",F)}),xt(()=>{C&&clearInterval(C),D&&clearInterval(D),clearTimeout(H),je.unsubscribe("events",F)}),{status:e,loading:t,error:s,uptime:p,uptimeRingOffset:f,stats:g,healthIndicators:b,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:d,fetchActivity:O,fetchStatus:E,formatTime:ym,formatDuration:si,retry:T,reloadConfig:S,clearSessions:v,stopAllLoops:k}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Ku(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function Dk(e){if(Array.isArray(e))return e}function Pk(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(d){c=!0,a=d}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function Fk(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function $k(e,t){return Dk(e)||Pk(e,t)||Uk(e,t)||Fk()}function Uk(e,t){if(e){if(typeof e=="string")return Ku(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Ku(e,t):void 0}}const Pm=Object.entries,Wu=Object.setPrototypeOf,Bk=Object.isFrozen,Hk=Object.getPrototypeOf,zk=Object.getOwnPropertyDescriptor;let ls=Object.freeze,Ms=Object.seal,Na=Object.create,Fm=typeof Reflect<"u"&&Reflect,Wo=Fm.apply,Zo=Fm.construct;ls||(ls=function(t){return t});Ms||(Ms=function(t){return t});Wo||(Wo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});Zo||(Zo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const on=Rt(Array.prototype.forEach),jk=Rt(Array.prototype.lastIndexOf),Zu=Rt(Array.prototype.pop),Ea=Rt(Array.prototype.push),Vk=Rt(Array.prototype.splice),es=Array.isArray,wi=Rt(String.prototype.toLowerCase),po=Rt(String.prototype.toString),Ju=Rt(String.prototype.match),Aa=Rt(String.prototype.replace),Yu=Rt(String.prototype.indexOf),qk=Rt(String.prototype.trim),Gk=Rt(Number.prototype.toString),Kk=Rt(Boolean.prototype.toString),Qu=typeof BigInt>"u"?null:Rt(BigInt.prototype.toString),Xu=typeof Symbol>"u"?null:Rt(Symbol.prototype.toString),vt=Rt(Object.prototype.hasOwnProperty),mi=Rt(Object.prototype.toString),$t=Rt(RegExp.prototype.test),Qn=Wk(TypeError);function Rt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return Wo(e,t,n)}}function Wk(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return Zo(e,s)}}function He(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:wi;if(Wu&&Wu(e,null),!es(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(Bk(t)||(t[n]=i),a=i)}e[a]=!0}return e}function Zk(e){for(let t=0;t<e.length;t++)vt(e,t)||(e[t]=null);return e}function Vt(e){const t=Na(null);for(const n of Pm(e)){var s=$k(n,2);const a=s[0],i=s[1];vt(e,a)&&(es(i)?t[a]=Zk(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Vt(i):t[a]=i)}return t}function Jk(e){switch(typeof e){case"string":return e;case"number":return Gk(e);case"boolean":return Kk(e);case"bigint":return Qu?Qu(e):"0";case"symbol":return Xu?Xu(e):"Symbol()";case"undefined":return mi(e);case"function":case"object":{if(e===null)return mi(e);const t=e,s=Zs(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:mi(n)}return mi(e)}default:return mi(e)}}function Zs(e,t){for(;e!==null;){const n=zk(e,t);if(n){if(n.get)return Rt(n.get);if(typeof n.value=="function")return Rt(n.value)}e=Hk(e)}function s(){return null}return s}function Yk(e){try{return $t(e,""),!0}catch{return!1}}const ep=ls(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),fo=ls(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ho=ls(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Qk=ls(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),mo=ls(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Xk=ls(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),tp=ls(["#text"]),sp=ls(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),go=ls(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),np=ls(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),El=ls(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),eS=Ms(/{{[\w\W]*|^[\w\W]*}}/g),tS=Ms(/<%[\w\W]*|^[\w\W]*%>/g),sS=Ms(/\${[\w\W]*/g),nS=Ms(/^data-[\-\w.\u00B7-\uFFFF]+$/),aS=Ms(/^aria-[\-\w]+$/),ap=Ms(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),iS=Ms(/^(?:\w+script|data):/i),lS=Ms(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),rS=Ms(/^html$/i),oS=Ms(/^[a-z][.\w]*(-[.\w]+)+$/i),Ks={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},cS=function(){return typeof window>"u"?null:window},dS=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},ip=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function $m(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:cS();const t=xe=>$m(xe);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Ks.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=r.prototype,f=Zs(p,"cloneNode"),g=Zs(p,"remove"),b=Zs(p,"nextSibling"),E=Zs(p,"childNodes"),O=Zs(p,"parentNode"),y=Zs(p,"shadowRoot"),m=Zs(p,"attributes"),x=l&&l.prototype?Zs(l.prototype,"nodeType"):null,S=l&&l.prototype?Zs(l.prototype,"nodeName"):null;if(typeof i=="function"){const xe=s.createElement("template");xe.content&&xe.content.ownerDocument&&(s=xe.content.ownerDocument)}let v,k="",T,C=!1,D=0;const H=function(){if(D>0)throw Qn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},F=function(R){H(),D++;try{return v.createHTML(R)}finally{D--}},A=function(R){H(),D++;try{return v.createScriptURL(R)}finally{D--}},V=function(){return C||(T=dS(u,a),C=!0),T},ee=s,U=ee.implementation,N=ee.createNodeIterator,I=ee.createDocumentFragment,te=ee.getElementsByTagName,Te=n.importNode;let ke=ip();t.isSupported=typeof Pm=="function"&&typeof O=="function"&&U&&U.createHTMLDocument!==void 0;const oe=eS,me=tS,ie=sS,ge=nS,W=aS,B=iS,le=lS,re=oS;let ye=ap,ve=null;const $e=He({},[...ep,...fo,...ho,...mo,...tp]);let w=null;const L=He({},[...sp,...go,...np,...El]);let $=Object.seal(Na(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ae=null,J=null;const se=Object.seal(Na(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let fe=!0,P=!0,X=!1,K=!0,ne=!1,ce=!0,be=!1,Ae=!1,Me=!1,De=!1,Fe=!1,ze=!1,qe=!0,dt=!1;const Y="user-content-";let we=!0,Ee=!1,Oe={},Ge=null;const Ue=He({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let mt=null;const Yt=He({},["audio","video","img","source","image","track"]);let Ds=null;const An=He({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ts="http://www.w3.org/1998/Math/MathML",Ps="http://www.w3.org/2000/svg",Pt="http://www.w3.org/1999/xhtml";let Qt=Pt,Vs=!1,Cs=null;const nn=He({},[Ts,Ps,Pt],po);let Fs=He({},["mi","mo","mn","ms","mtext"]),qs=He({},["annotation-xml"]);const Vn=He({},["title","style","font","a","script"]);let ut=null;const rs=["application/xhtml+xml","text/html"],os="text/html";let Qe=null,gs=null;const q=s.createElement("form"),de=function(R){return R instanceof RegExp||R instanceof Function},Re=function(){let R=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(gs&&gs===R)return;(!R||typeof R!="object")&&(R={}),R=Vt(R),ut=rs.indexOf(R.PARSER_MEDIA_TYPE)===-1?os:R.PARSER_MEDIA_TYPE,Qe=ut==="application/xhtml+xml"?po:wi,ve=vt(R,"ALLOWED_TAGS")&&es(R.ALLOWED_TAGS)?He({},R.ALLOWED_TAGS,Qe):$e,w=vt(R,"ALLOWED_ATTR")&&es(R.ALLOWED_ATTR)?He({},R.ALLOWED_ATTR,Qe):L,Cs=vt(R,"ALLOWED_NAMESPACES")&&es(R.ALLOWED_NAMESPACES)?He({},R.ALLOWED_NAMESPACES,po):nn,Ds=vt(R,"ADD_URI_SAFE_ATTR")&&es(R.ADD_URI_SAFE_ATTR)?He(Vt(An),R.ADD_URI_SAFE_ATTR,Qe):An,mt=vt(R,"ADD_DATA_URI_TAGS")&&es(R.ADD_DATA_URI_TAGS)?He(Vt(Yt),R.ADD_DATA_URI_TAGS,Qe):Yt,Ge=vt(R,"FORBID_CONTENTS")&&es(R.FORBID_CONTENTS)?He({},R.FORBID_CONTENTS,Qe):Ue,ae=vt(R,"FORBID_TAGS")&&es(R.FORBID_TAGS)?He({},R.FORBID_TAGS,Qe):Vt({}),J=vt(R,"FORBID_ATTR")&&es(R.FORBID_ATTR)?He({},R.FORBID_ATTR,Qe):Vt({}),Oe=vt(R,"USE_PROFILES")?R.USE_PROFILES&&typeof R.USE_PROFILES=="object"?Vt(R.USE_PROFILES):R.USE_PROFILES:!1,fe=R.ALLOW_ARIA_ATTR!==!1,P=R.ALLOW_DATA_ATTR!==!1,X=R.ALLOW_UNKNOWN_PROTOCOLS||!1,K=R.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ne=R.SAFE_FOR_TEMPLATES||!1,ce=R.SAFE_FOR_XML!==!1,be=R.WHOLE_DOCUMENT||!1,De=R.RETURN_DOM||!1,Fe=R.RETURN_DOM_FRAGMENT||!1,ze=R.RETURN_TRUSTED_TYPE||!1,Me=R.FORCE_BODY||!1,qe=R.SANITIZE_DOM!==!1,dt=R.SANITIZE_NAMED_PROPS||!1,we=R.KEEP_CONTENT!==!1,Ee=R.IN_PLACE||!1,ye=Yk(R.ALLOWED_URI_REGEXP)?R.ALLOWED_URI_REGEXP:ap,Qt=typeof R.NAMESPACE=="string"?R.NAMESPACE:Pt,Fs=vt(R,"MATHML_TEXT_INTEGRATION_POINTS")&&R.MATHML_TEXT_INTEGRATION_POINTS&&typeof R.MATHML_TEXT_INTEGRATION_POINTS=="object"?Vt(R.MATHML_TEXT_INTEGRATION_POINTS):He({},["mi","mo","mn","ms","mtext"]),qs=vt(R,"HTML_INTEGRATION_POINTS")&&R.HTML_INTEGRATION_POINTS&&typeof R.HTML_INTEGRATION_POINTS=="object"?Vt(R.HTML_INTEGRATION_POINTS):He({},["annotation-xml"]);const Q=vt(R,"CUSTOM_ELEMENT_HANDLING")&&R.CUSTOM_ELEMENT_HANDLING&&typeof R.CUSTOM_ELEMENT_HANDLING=="object"?Vt(R.CUSTOM_ELEMENT_HANDLING):Na(null);if($=Na(null),vt(Q,"tagNameCheck")&&de(Q.tagNameCheck)&&($.tagNameCheck=Q.tagNameCheck),vt(Q,"attributeNameCheck")&&de(Q.attributeNameCheck)&&($.attributeNameCheck=Q.attributeNameCheck),vt(Q,"allowCustomizedBuiltInElements")&&typeof Q.allowCustomizedBuiltInElements=="boolean"&&($.allowCustomizedBuiltInElements=Q.allowCustomizedBuiltInElements),ne&&(P=!1),Fe&&(De=!0),Oe&&(ve=He({},tp),w=Na(null),Oe.html===!0&&(He(ve,ep),He(w,sp)),Oe.svg===!0&&(He(ve,fo),He(w,go),He(w,El)),Oe.svgFilters===!0&&(He(ve,ho),He(w,go),He(w,El)),Oe.mathMl===!0&&(He(ve,mo),He(w,np),He(w,El))),se.tagCheck=null,se.attributeCheck=null,vt(R,"ADD_TAGS")&&(typeof R.ADD_TAGS=="function"?se.tagCheck=R.ADD_TAGS:es(R.ADD_TAGS)&&(ve===$e&&(ve=Vt(ve)),He(ve,R.ADD_TAGS,Qe))),vt(R,"ADD_ATTR")&&(typeof R.ADD_ATTR=="function"?se.attributeCheck=R.ADD_ATTR:es(R.ADD_ATTR)&&(w===L&&(w=Vt(w)),He(w,R.ADD_ATTR,Qe))),vt(R,"ADD_URI_SAFE_ATTR")&&es(R.ADD_URI_SAFE_ATTR)&&He(Ds,R.ADD_URI_SAFE_ATTR,Qe),vt(R,"FORBID_CONTENTS")&&es(R.FORBID_CONTENTS)&&(Ge===Ue&&(Ge=Vt(Ge)),He(Ge,R.FORBID_CONTENTS,Qe)),vt(R,"ADD_FORBID_CONTENTS")&&es(R.ADD_FORBID_CONTENTS)&&(Ge===Ue&&(Ge=Vt(Ge)),He(Ge,R.ADD_FORBID_CONTENTS,Qe)),we&&(ve["#text"]=!0),be&&He(ve,["html","head","body"]),ve.table&&(He(ve,["tbody"]),delete ae.tbody),R.TRUSTED_TYPES_POLICY){if(typeof R.TRUSTED_TYPES_POLICY.createHTML!="function")throw Qn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof R.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Qn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const pe=v;v=R.TRUSTED_TYPES_POLICY;try{k=F("")}catch(Ie){throw v=pe,Ie}}else R.TRUSTED_TYPES_POLICY===null?(v=void 0,k=""):(v===void 0&&(v=V()),v&&typeof k=="string"&&(k=F("")));(ke.uponSanitizeElement.length>0||ke.uponSanitizeAttribute.length>0)&&ve===$e&&(ve=Vt(ve)),ke.uponSanitizeAttribute.length>0&&w===L&&(w=Vt(w)),ls&&ls(R),gs=R},Je=He({},[...fo,...ho,...Qk]),rt=He({},[...mo,...Xk]),Lt=function(R){let Q=O(R);(!Q||!Q.tagName)&&(Q={namespaceURI:Qt,tagName:"template"});const pe=wi(R.tagName),Ie=wi(Q.tagName);return Cs[R.namespaceURI]?R.namespaceURI===Ps?Q.namespaceURI===Pt?pe==="svg":Q.namespaceURI===Ts?pe==="svg"&&(Ie==="annotation-xml"||Fs[Ie]):!!Je[pe]:R.namespaceURI===Ts?Q.namespaceURI===Pt?pe==="math":Q.namespaceURI===Ps?pe==="math"&&qs[Ie]:!!rt[pe]:R.namespaceURI===Pt?Q.namespaceURI===Ps&&!qs[Ie]||Q.namespaceURI===Ts&&!Fs[Ie]?!1:!rt[pe]&&(Vn[pe]||!Je[pe]):!!(ut==="application/xhtml+xml"&&Cs[R.namespaceURI]):!1},Ft=function(R){Ea(t.removed,{element:R});try{O(R).removeChild(R)}catch{if(g(R),!O(R))throw Qn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},xa=function(R){const Q=E?E(R):R.childNodes;if(Q){const Ie=[];on(Q,_=>{Ea(Ie,_)}),on(Ie,_=>{try{g(_)}catch{}})}const pe=m?m(R):null;if(pe)for(let Ie=pe.length-1;Ie>=0;--Ie){const _=pe[Ie],M=_&&_.name;if(typeof M=="string")try{R.removeAttribute(M)}catch{}}},$s=function(R,Q){try{Ea(t.removed,{attribute:Q.getAttributeNode(R),from:Q})}catch{Ea(t.removed,{attribute:null,from:Q})}if(Q.removeAttribute(R),R==="is")if(De||Fe)try{Ft(Q)}catch{}else try{Q.setAttribute(R,"")}catch{}},li=function(R){const Q=m?m(R):R.attributes;if(Q)for(let pe=Q.length-1;pe>=0;--pe){const Ie=Q[pe],_=Ie&&Ie.name;if(!(typeof _!="string"||w[Qe(_)]))try{R.removeAttribute(_)}catch{}}},_a=function(R){const Q=[R];for(;Q.length>0;){const pe=Q.pop();(x?x(pe):pe.nodeType)===Ks.element&&li(pe);const _=E?E(pe):pe.childNodes;if(_)for(let M=_.length-1;M>=0;--M)Q.push(_[M])}},qn=function(R){let Q=null,pe=null;if(Me)R="<remove></remove>"+R;else{const M=Ju(R,/^[\r\n\t ]+/);pe=M&&M[0]}ut==="application/xhtml+xml"&&Qt===Pt&&(R='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+R+"</body></html>");const Ie=v?F(R):R;if(Qt===Pt)try{Q=new d().parseFromString(Ie,ut)}catch{}if(!Q||!Q.documentElement){Q=U.createDocument(Qt,"template",null);try{Q.documentElement.innerHTML=Vs?k:Ie}catch{}}const _=Q.body||Q.documentElement;return R&&pe&&_.insertBefore(s.createTextNode(pe),_.childNodes[0]||null),Qt===Pt?te.call(Q,be?"html":"body")[0]:be?Q.documentElement:_},wa=function(R){return N.call(R.ownerDocument||R,R,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},Gn=function(R){var Q,pe;R.normalize();const Ie=N.call(R.ownerDocument||R,R,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let _=Ie.nextNode();for(;_;){let j=_.data;on([oe,me,ie],ue=>{j=Aa(j,ue," ")}),_.data=j,_=Ie.nextNode()}const M=(Q=(pe=R.querySelectorAll)===null||pe===void 0?void 0:pe.call(R,"template"))!==null&&Q!==void 0?Q:[];on(Array.from(M),j=>{he(j.content)&&Gn(j.content)})},z=function(R){const Q=S?S(R):null;return typeof Q!="string"||Qe(Q)!=="form"?!1:typeof R.nodeName!="string"||typeof R.textContent!="string"||typeof R.removeChild!="function"||R.attributes!==m(R)||typeof R.removeAttribute!="function"||typeof R.setAttribute!="function"||typeof R.namespaceURI!="string"||typeof R.insertBefore!="function"||typeof R.hasChildNodes!="function"||R.nodeType!==x(R)||R.childNodes!==E(R)},he=function(R){if(!x||typeof R!="object"||R===null)return!1;try{return x(R)===Ks.documentFragment}catch{return!1}},Se=function(R){if(!x||typeof R!="object"||R===null)return!1;try{return typeof x(R)=="number"}catch{return!1}};function _t(xe,R,Q){on(xe,pe=>{pe.call(t,R,Q,gs)})}const Kn=function(R){let Q=null;if(_t(ke.beforeSanitizeElements,R,null),z(R))return Ft(R),!0;const pe=Qe(S?S(R):R.nodeName);if(_t(ke.uponSanitizeElement,R,{tagName:pe,allowedTags:ve}),ce&&R.hasChildNodes()&&!Se(R.firstElementChild)&&$t(/<[/\w!]/g,R.innerHTML)&&$t(/<[/\w!]/g,R.textContent)||ce&&R.namespaceURI===Pt&&pe==="style"&&Se(R.firstElementChild)||R.nodeType===Ks.progressingInstruction||ce&&R.nodeType===Ks.comment&&$t(/<[/\w]/g,R.data))return Ft(R),!0;if(ae[pe]||!(se.tagCheck instanceof Function&&se.tagCheck(pe))&&!ve[pe]){if(!ae[pe]&&cl(pe)&&($.tagNameCheck instanceof RegExp&&$t($.tagNameCheck,pe)||$.tagNameCheck instanceof Function&&$.tagNameCheck(pe)))return!1;if(we&&!Ge[pe]){const _=O(R),M=E(R);if(M&&_){const j=M.length;for(let ue=j-1;ue>=0;--ue){const Ne=Ee?M[ue]:f(M[ue],!0);_.insertBefore(Ne,b(R))}}}return Ft(R),!0}return(x?x(R):R.nodeType)===Ks.element&&!Lt(R)||(pe==="noscript"||pe==="noembed"||pe==="noframes")&&$t(/<\/no(script|embed|frames)/i,R.innerHTML)?(Ft(R),!0):(ne&&R.nodeType===Ks.text&&(Q=R.textContent,on([oe,me,ie],_=>{Q=Aa(Q,_," ")}),R.textContent!==Q&&(Ea(t.removed,{element:R.cloneNode()}),R.textContent=Q)),_t(ke.afterSanitizeElements,R,null),!1)},Wn=function(R,Q,pe){if(J[Q]||qe&&(Q==="id"||Q==="name")&&(pe in s||pe in q))return!1;const Ie=w[Q]||se.attributeCheck instanceof Function&&se.attributeCheck(Q,R);if(!(P&&!J[Q]&&$t(ge,Q))){if(!(fe&&$t(W,Q))){if(!Ie||J[Q]){if(!(cl(R)&&($.tagNameCheck instanceof RegExp&&$t($.tagNameCheck,R)||$.tagNameCheck instanceof Function&&$.tagNameCheck(R))&&($.attributeNameCheck instanceof RegExp&&$t($.attributeNameCheck,Q)||$.attributeNameCheck instanceof Function&&$.attributeNameCheck(Q,R))||Q==="is"&&$.allowCustomizedBuiltInElements&&($.tagNameCheck instanceof RegExp&&$t($.tagNameCheck,pe)||$.tagNameCheck instanceof Function&&$.tagNameCheck(pe))))return!1}else if(!Ds[Q]){if(!$t(ye,Aa(pe,le,""))){if(!((Q==="src"||Q==="xlink:href"||Q==="href")&&R!=="script"&&Yu(pe,"data:")===0&&mt[R])){if(!(X&&!$t(B,Aa(pe,le,"")))){if(pe)return!1}}}}}}return!0},Rn=He({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),cl=function(R){return!Rn[wi(R)]&&$t(re,R)},dl=function(R){_t(ke.beforeSanitizeAttributes,R,null);const Q=R.attributes;if(!Q||z(R))return;const pe={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:w,forceKeepAttr:void 0};let Ie=Q.length;for(;Ie--;){const _=Q[Ie],M=_.name,j=_.namespaceURI,ue=_.value,Ne=Qe(M),gt=ue;let it=M==="value"?gt:qk(gt);if(pe.attrName=Ne,pe.attrValue=it,pe.keepAttr=!0,pe.forceKeepAttr=void 0,_t(ke.uponSanitizeAttribute,R,pe),it=pe.attrValue,dt&&(Ne==="id"||Ne==="name")&&Yu(it,Y)!==0&&($s(M,R),it=Y+it),ce&&$t(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,it)){$s(M,R);continue}if(Ne==="attributename"&&Ju(it,"href")){$s(M,R);continue}if(pe.forceKeepAttr)continue;if(!pe.keepAttr){$s(M,R);continue}if(!K&&$t(/\/>/i,it)){$s(M,R);continue}ne&&on([oe,me,ie],oi=>{it=Aa(it,oi," ")});const Gs=Qe(R.nodeName);if(!Wn(Gs,Ne,it)){$s(M,R);continue}if(v&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!j)switch(u.getAttributeType(Gs,Ne)){case"TrustedHTML":{it=F(it);break}case"TrustedScriptURL":{it=A(it);break}}if(it!==gt)try{j?R.setAttributeNS(j,M,it):R.setAttribute(M,it),z(R)?Ft(R):Zu(t.removed)}catch{$s(M,R)}}_t(ke.afterSanitizeAttributes,R,null)},Zn=function(R){let Q=null;const pe=wa(R);for(_t(ke.beforeSanitizeShadowDOM,R,null);Q=pe.nextNode();)if(_t(ke.uponSanitizeShadowNode,Q,null),Kn(Q),dl(Q),he(Q.content)&&Zn(Q.content),(x?x(Q):Q.nodeType)===Ks.element){const _=y?y(Q):Q.shadowRoot;he(_)&&(ri(_),Zn(_))}_t(ke.afterSanitizeShadowDOM,R,null)},ri=function(R){const Q=[{node:R,shadow:null}];for(;Q.length>0;){const pe=Q.pop();if(pe.shadow){Zn(pe.shadow);continue}const Ie=pe.node,M=(x?x(Ie):Ie.nodeType)===Ks.element,j=E?E(Ie):Ie.childNodes;if(j)for(let ue=j.length-1;ue>=0;--ue)Q.push({node:j[ue],shadow:null});if(M){const ue=S?S(Ie):null;if(typeof ue=="string"&&Qe(ue)==="template"){const Ne=Ie.content;he(Ne)&&Q.push({node:Ne,shadow:null})}}if(M){const ue=y?y(Ie):Ie.shadowRoot;he(ue)&&Q.push({node:null,shadow:ue},{node:ue,shadow:null})}}};return t.sanitize=function(xe){let R=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},Q=null,pe=null,Ie=null,_=null;if(Vs=!xe,Vs&&(xe="<!-->"),typeof xe!="string"&&!Se(xe)&&(xe=Jk(xe),typeof xe!="string"))throw Qn("dirty is not a string, aborting");if(!t.isSupported)return xe;Ae||Re(R),t.removed=[];const M=Ee&&typeof xe!="string"&&Se(xe);if(M){const Ne=S?S(xe):xe.nodeName;if(typeof Ne=="string"){const gt=Qe(Ne);if(!ve[gt]||ae[gt])throw Qn("root node is forbidden and cannot be sanitized in-place")}if(z(xe))throw Qn("root node is clobbered and cannot be sanitized in-place");try{ri(xe)}catch(gt){throw xa(xe),gt}}else if(Se(xe))Q=qn("<!---->"),pe=Q.ownerDocument.importNode(xe,!0),pe.nodeType===Ks.element&&pe.nodeName==="BODY"||pe.nodeName==="HTML"?Q=pe:Q.appendChild(pe),ri(pe);else{if(!De&&!ne&&!be&&xe.indexOf("<")===-1)return v&&ze?F(xe):xe;if(Q=qn(xe),!Q)return De?null:ze?k:""}Q&&Me&&Ft(Q.firstChild);const j=wa(M?xe:Q);try{for(;Ie=j.nextNode();)Kn(Ie),dl(Ie),he(Ie.content)&&Zn(Ie.content)}catch(Ne){throw M&&xa(xe),Ne}if(M)return on(t.removed,Ne=>{Ne.element&&_a(Ne.element)}),ne&&Gn(xe),xe;if(De){if(ne&&Gn(Q),Fe)for(_=I.call(Q.ownerDocument);Q.firstChild;)_.appendChild(Q.firstChild);else _=Q;return(w.shadowroot||w.shadowrootmode)&&(_=Te.call(n,_,!0)),_}let ue=be?Q.outerHTML:Q.innerHTML;return be&&ve["!doctype"]&&Q.ownerDocument&&Q.ownerDocument.doctype&&Q.ownerDocument.doctype.name&&$t(rS,Q.ownerDocument.doctype.name)&&(ue="<!DOCTYPE "+Q.ownerDocument.doctype.name+`>
`+ue),ne&&on([oe,me,ie],Ne=>{ue=Aa(ue,Ne," ")}),v&&ze?F(ue):ue},t.setConfig=function(){let xe=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Re(xe),Ae=!0},t.clearConfig=function(){gs=null,Ae=!1,v=T,k=""},t.isValidAttribute=function(xe,R,Q){gs||Re({});const pe=Qe(xe),Ie=Qe(R);return Wn(pe,Ie,Q)},t.addHook=function(xe,R){typeof R=="function"&&Ea(ke[xe],R)},t.removeHook=function(xe,R){if(R!==void 0){const Q=jk(ke[xe],R);return Q===-1?void 0:Vk(ke[xe],Q,1)[0]}return Zu(ke[xe])},t.removeHooks=function(xe){ke[xe]=[]},t.removeAllHooks=function(){ke=ip()},t}var lp=$m();function Xc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ya=Xc();function Um(e){ya=e}var Ni={exec:()=>null};function at(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(ns.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var ns={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},uS=/^(?:[ \t]*(?:\n|$))+/,pS=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,fS=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ol=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,hS=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ed=/(?:[*+-]|\d{1,9}[.)])/,Bm=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Hm=at(Bm).replace(/bull/g,ed).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),mS=at(Bm).replace(/bull/g,ed).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),td=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,gS=/^[^\n]+/,sd=/(?!\s*\])(?:\\.|[^\[\]\\])+/,vS=at(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",sd).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),bS=at(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ed).getRegex(),Br="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",nd=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,yS=at("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",nd).replace("tag",Br).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),zm=at(td).replace("hr",ol).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Br).getRegex(),xS=at(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",zm).getRegex(),ad={blockquote:xS,code:pS,def:vS,fences:fS,heading:hS,hr:ol,html:yS,lheading:Hm,list:bS,newline:uS,paragraph:zm,table:Ni,text:gS},rp=at("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ol).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Br).getRegex(),_S={...ad,lheading:mS,table:rp,paragraph:at(td).replace("hr",ol).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",rp).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Br).getRegex()},wS={...ad,html:at(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",nd).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ni,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:at(td).replace("hr",ol).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Hm).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},kS=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,SS=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,jm=/^( {2,}|\\)\n(?!\s*$)/,TS=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Hr=/[\p{P}\p{S}]/u,id=/[\s\p{P}\p{S}]/u,Vm=/[^\s\p{P}\p{S}]/u,CS=at(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,id).getRegex(),qm=/(?!~)[\p{P}\p{S}]/u,ES=/(?!~)[\s\p{P}\p{S}]/u,AS=/(?:[^\s\p{P}\p{S}]|~)/u,RS=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,Gm=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,IS=at(Gm,"u").replace(/punct/g,Hr).getRegex(),OS=at(Gm,"u").replace(/punct/g,qm).getRegex(),Km="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",NS=at(Km,"gu").replace(/notPunctSpace/g,Vm).replace(/punctSpace/g,id).replace(/punct/g,Hr).getRegex(),LS=at(Km,"gu").replace(/notPunctSpace/g,AS).replace(/punctSpace/g,ES).replace(/punct/g,qm).getRegex(),MS=at("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Vm).replace(/punctSpace/g,id).replace(/punct/g,Hr).getRegex(),DS=at(/\\(punct)/,"gu").replace(/punct/g,Hr).getRegex(),PS=at(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),FS=at(nd).replace("(?:-->|$)","-->").getRegex(),$S=at("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",FS).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),cr=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,US=at(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",cr).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Wm=at(/^!?\[(label)\]\[(ref)\]/).replace("label",cr).replace("ref",sd).getRegex(),Zm=at(/^!?\[(ref)\](?:\[\])?/).replace("ref",sd).getRegex(),BS=at("reflink|nolink(?!\\()","g").replace("reflink",Wm).replace("nolink",Zm).getRegex(),ld={_backpedal:Ni,anyPunctuation:DS,autolink:PS,blockSkip:RS,br:jm,code:SS,del:Ni,emStrongLDelim:IS,emStrongRDelimAst:NS,emStrongRDelimUnd:MS,escape:kS,link:US,nolink:Zm,punctuation:CS,reflink:Wm,reflinkSearch:BS,tag:$S,text:TS,url:Ni},HS={...ld,link:at(/^!?\[(label)\]\((.*?)\)/).replace("label",cr).getRegex(),reflink:at(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",cr).getRegex()},Jo={...ld,emStrongRDelimAst:LS,emStrongLDelim:OS,url:at(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},zS={...Jo,br:at(jm).replace("{2,}","*").getRegex(),text:at(Jo.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Al={normal:ad,gfm:_S,pedantic:wS},gi={normal:ld,gfm:Jo,breaks:zS,pedantic:HS},jS={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},op=e=>jS[e];function Js(e,t){if(t){if(ns.escapeTest.test(e))return e.replace(ns.escapeReplace,op)}else if(ns.escapeTestNoEncode.test(e))return e.replace(ns.escapeReplaceNoEncode,op);return e}function cp(e){try{e=encodeURI(e).replace(ns.percentDecode,"%")}catch{return null}return e}function dp(e,t){var i;const s=e.replace(ns.findPipe,(l,r,o)=>{let c=!1,d=r;for(;--d>=0&&o[d]==="\\";)c=!c;return c?"|":" |"}),n=s.split(ns.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(ns.slashPipe,"|");return n}function vi(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function VS(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function up(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function qS(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const s=t[0],n=qS(s,t[3]||"",this.rules);return{type:"code",raw:s,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:n}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let s=t[2].trim();if(this.rules.other.endingHash.test(s)){const n=vi(s,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(s=n.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:vi(t[0],`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Js(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},fa=new GS;function st(e,t){return fa.parse(e,t)}st.options=st.setOptions=function(e){return fa.setOptions(e),st.defaults=fa.defaults,Um(st.defaults),st};st.getDefaults=Xc;st.defaults=ya;st.use=function(...e){return fa.use(...e),st.defaults=fa.defaults,Um(st.defaults),st};st.walkTokens=function(e,t){return fa.walkTokens(e,t)};st.parseInline=fa.parseInline;st.Parser=vn;st.parser=vn.parse;st.Renderer=ur;st.TextRenderer=rd;st.Lexer=gn;st.lexer=gn.lex;st.Tokenizer=dr;st.Hooks=Dl;st.parse=st;st.options;st.setOptions;st.use;st.walkTokens;st.parseInline;vn.parse;gn.lex;const KS={breaks:!0,gfm:!0};function pp(e){if(!e)return"";try{if(typeof st<"u"&&st.parse){const t=st.parse(e,KS);return typeof lp<"u"?lp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function WS(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const ZS={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function JS(e){return ZS[e]||"wrench"}const YS=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function fp(e){if(!e)return[];const t=e.match(YS);return t?[...new Set(t)]:[]}const QS={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],d=Z(()=>t.value.trim().length>0&&!s.value),u=h(je.state||"disconnected");let p=null,f=null;const g=Z(()=>{const U=u.value;return U==="connected"?"Connected":U==="reconnecting"?"Reconnecting…":U==="connecting"?"Connecting…":"REST fallback"}),b=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],E=Z(()=>{const U=Math.floor(i.value/4)%b.length,N=i.value;return N>3?`${b[U]} (${N}s)`:b[0]});function O(){Ct(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!a.value)return;const U=a.value;U.style.height="auto",U.style.height=Math.min(U.scrollHeight,120)+"px"}function m(U,N,I={}){const te={id:++o,role:U,content:N,timestamp:Date.now(),html:U==="bot"?pp(N):"",tools_used:I.tools_used||[],is_error:I.is_error||!1,images:U==="bot"?fp(N):[],files:I.files||[],_showTools:!1};return e.value.push(te),O(),U==="bot"&&Ct(()=>x()),te}function x(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(N=>{N.setAttribute("data-copy","true"),N.style.position="relative";const I=document.createElement("button");I.className="chat-code-copy",I.textContent="Copy",I.addEventListener("click",()=>{const te=N.querySelector("code"),Te=te?te.textContent:N.textContent;navigator.clipboard.writeText(Te).then(()=>{I.textContent="Copied!",setTimeout(()=>{I.textContent="Copy"},1500)}).catch(()=>{})}),N.appendChild(I)})}function S(U){if(U===0)return!0;const N=e.value[U-1],I=e.value[U],te=new Date(N.timestamp).toDateString(),Te=new Date(I.timestamp).toDateString();return te!==Te}function v(U){const N=new Date(U),I=new Date;if(N.toDateString()===I.toDateString())return"Today";const te=new Date(I);return te.setDate(te.getDate()-1),N.toDateString()===te.toDateString()?"Yesterday":N.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function k(U){t.value=U,Ct(()=>V())}function T(U){window.open(U,"_blank","noopener")}function C(U){U.target.style.display="none"}function D(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function H(){r&&(clearInterval(r),r=null),i.value=0}function F(U){s.value&&(s.value=!1,H(),U.type==="chat_response"?m("bot",U.content,{tools_used:U.tools_used||[],is_error:U.is_error||!1,files:U.files||[]}):U.type==="chat_error"&&m("bot",U.error||"Unknown error",{is_error:!0}),Ct(()=>{var N;return(N=a.value)==null?void 0:N.focus()}))}async function A(U){try{const N=await G.post("/api/chat",{content:U,channel_id:l.value});m("bot",N.response,{tools_used:N.tools_used||[],is_error:N.is_error||!1,files:N.files||[]})}catch(N){m("bot",N.message||"Failed to send message",{is_error:!0})}}async function V(){const U=t.value.trim();if(!U||s.value)return;m("user",U),t.value="",s.value=!0,D(),a.value&&(a.value.style.height="auto"),je.connected&&je.sendChat(U,{channelId:l.value})||(await A(U),s.value=!1,H()),Ct(()=>{var I;return(I=a.value)==null?void 0:I.focus()})}async function ee(){try{if(!l.value){const N=await G.get("/api/auth/session");l.value=N.channel_id||N.user_id||"web-user"}const U=await G.get("/api/sessions/"+encodeURIComponent(l.value));if(U&&U.messages&&U.messages.length>0){for(const N of U.messages){const I=N.role==="user"?"user":"bot";let te=N.content||"";if(I==="user"){const ke=te.match(/^\[.*?\]:\s*/);ke&&(te=te.slice(ke[0].length))}if(!te.trim())continue;const Te={id:++o,role:I,content:te,timestamp:N.timestamp?N.timestamp*1e3:Date.now(),html:I==="bot"?pp(te):"",tools_used:[],is_error:!1,images:I==="bot"?fp(te):[],files:[],_showTools:!1};e.value.push(Te)}Ct(()=>{O(),x()})}}catch{}}return Ze(()=>{je.subscribe("chat",F),u.value=je.state||"disconnected",p=je.onStateChange,f=(U,N)=>{u.value=U,p&&p(U,N)},je.onStateChange=f,ee(),Ct(()=>{var U;return(U=a.value)==null?void 0:U.focus()})}),xt(()=>{je.unsubscribe("chat",F),je.onStateChange===f&&(je.onStateChange=p),H()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:d,wsStatus:g,typingText:E,suggestions:c,send:V,autoResize:y,formatTime:WS,formatDate:v,showDateSeparator:S,useSuggestion:k,openImage:T,onImageError:C,getToolIcon:JS}}},XS={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),g=Z(()=>e.value==="custom"),b=Z(()=>[...i.value,...l.value]),E=Z(()=>l.value.includes(e.value)),O=Z(()=>{var T;return g.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),y=Z(()=>{var T;return g.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),m=Z(()=>{var T;return g.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function x(){d.value=!0;try{const T=await G.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{d.value=!1}}async function S(){r.value=!0,c.value=null,o.value=!1;try{await G.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(T){c.value=T.message}finally{r.value=!1}}async function v(){const T=u.value.trim();if(T){f.value=!0,c.value=null;try{await G.post("/api/personality/presets",{name:T,display_name:O.value,identity:y.value,voice:m.value}),p.value=!1,u.value="",await x(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(C){c.value=C.message}finally{f.value=!1}}}async function k(){if(await Zt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await G.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(C){c.value=C.message}}}return Ze(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:b,isCustom:g,isUserPreset:E,previewName:O,previewIdentity:y,previewVoice:m,saving:r,saved:o,error:c,loading:d,save:S,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:v,deletePreset:k,builtinPresets:i,userPresets:l}},template:`
  ...
  `},wt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Jm=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:Mk,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:QS,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:gw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:kw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:zw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:XS,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Ek,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:wt("/operations","live")},{path:"/agents",redirect:wt("/operations","agents")},{path:"/loops",redirect:wt("/operations","loops")},{path:"/processes",redirect:wt("/operations","processes")},{path:"/schedules",redirect:wt("/operations","schedules")},{path:"/audit",redirect:wt("/history","audit")},{path:"/sessions",redirect:wt("/history","sessions")},{path:"/traces",redirect:wt("/history","traces")},{path:"/usage",redirect:wt("/history","usage")},{path:"/tools",redirect:wt("/capabilities","tools")},{path:"/skills",redirect:wt("/capabilities","skills")},{path:"/mcp",redirect:wt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:wt("/capabilities","knowledge")},{path:"/memory",redirect:wt("/capabilities","memory")},{path:"/learned",redirect:wt("/capabilities","learned")},{path:"/health",redirect:wt("/system","health")},{path:"/resources",redirect:wt("/system","resources")},{path:"/logs",redirect:wt("/system","logs")},{path:"/config",redirect:wt("/system","config")},{path:"/host-access",redirect:wt("/system","host-access")},{path:"/internals",redirect:wt("/system","internals")}],Li=tw({history:L_(),routes:Jm});Li.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const e1={template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=h(""),s=h(null),n=h(!1),a=h(!1);async function i(){n.value=!0,s.value=null;try{G.setPersist(a.value),await G.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{n.value=!1}}return{token:t,error:s,busy:n,persist:a,login:i}}},t1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),d=h("disconnected"),u=h(-1),p=h(null);let f=null;const g=h("starting"),b=h(""),E=Jm.filter(N=>N.meta),O=Z(()=>["Workspace","Operate","Observe","Manage"].map(N=>({name:N,routes:E.filter(I=>I.meta.section===N)})).filter(N=>N.routes.length)),y=Z(()=>{var N;return((N=Li.currentRoute.value.meta)==null?void 0:N.label)||"Odin"}),m=Z(()=>{var N;return((N=Li.currentRoute.value.meta)==null?void 0:N.section)||"Management"}),x=Z(()=>{var N;return((N=Li.currentRoute.value.meta)==null?void 0:N.description)||"Management console"});G.onSessionExpired=()=>{t.value=!0,je.disconnect(),G.setToken(""),e.value="login"};function S(N){var I;if((N.ctrlKey||N.metaKey)&&N.key.toLowerCase()==="k"){e.value==="ready"&&(N.preventDefault(),qu());return}if(n.value&&N.key==="Tab"){const te=[...((I=a.value)==null?void 0:I.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(te.length){const Te=te[0],ke=te[te.length-1];if(N.shiftKey&&(document.activeElement===Te||!a.value.contains(document.activeElement))){N.preventDefault(),ke.focus();return}if(!N.shiftKey&&(document.activeElement===ke||!a.value.contains(document.activeElement))){N.preventDefault(),Te.focus();return}}}if(N.key==="Escape"&&n.value){n.value=!1,N.preventDefault();return}if(N.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(N.target.tagName)){N.preventDefault();const te=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');te&&te.focus()}}function v(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Ze(async()=>{document.addEventListener("keydown",S),r=window.matchMedia("(max-width: 900px)"),v(),r.addEventListener("change",v);const N=await G.check();N.ok?(e.value="ready",ee()):N.needsAuth?e.value="login":(e.value="ready",ee())});function k(){t.value=!1,e.value="ready",ee()}async function T(){await G.logout(),je.disconnect(),e.value="login"}function C(){s.value=!s.value}function D(){n.value=!n.value}as(n,async N=>{var I,te;if(N)o=document.activeElement,await Ct(),(te=(I=a.value)==null?void 0:I.querySelector(".nav-item"))==null||te.focus();else if(o!=null&&o.isConnected){const Te=o;o=null,requestAnimationFrame(()=>Te.focus())}});const H=Z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function F(N,I="info",te=3e3){p.value={text:N,level:I},clearTimeout(f),f=setTimeout(()=>{p.value=null},te)}let A=null,V=!1;function ee(){je.onStatusChange=N=>{c.value=N},je.onLatency=N=>{u.value=N},je.onStateChange=(N,I)=>{d.value=N,N==="connected"?(V&&F("Connection restored","success"),V=!0):N==="reconnecting"&&I.attempt===1&&F("Connection lost — reconnecting…","warn")},je.connect(),U(),A&&clearInterval(A),A=setInterval(U,15e3)}async function U(){try{const N=await G.get("/api/status");g.value=N.status==="online"?"online":"starting";const I=N.uptime_seconds||0,te=Math.floor(I/3600),Te=Math.floor(I%3600/60);b.value=`${te}h ${Te}m uptime`}catch{g.value="offline",b.value=""}}return xt(()=>{A&&clearInterval(A),je.disconnect(),document.removeEventListener("keydown",S),r==null||r.removeEventListener("change",v)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:H,wsToast:p,botStatus:g,botUptime:b,navRoutes:E,navGroups:O,currentPage:y,currentSection:m,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:k,logout:T,toggleSidebar:C,toggleMobileNavigation:D,openPalette:qu}}},jn=Xl(t1);jn.component("odin-icon",Ok);jn.component("login-screen",e1);jn.component("toast-container",K0);jn.component("confirm-host",W0);jn.component("command-palette",Ik);jn.directive("modal-focus",Lk);jn.use(Li);jn.mount("#app");
