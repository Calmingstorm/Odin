 ...
 */let D_=()=>location.protocol+"//"+location.host;function wm(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),Cu(r,"")}return Cu(s,e)+n+a}function M_(e,t,s,n){let a=[],i=[],l=null;const r=({state:p})=>{const h=wm(e,location),m=s.value,v=t.value;let T=0;if(p){if(s.value=h,t.value=p,l&&l===m){l=null;return}T=v?p.position-v.position:0}else n(h);a.forEach(O=>{O(s.value,m,{delta:T,type:Wo.pop,direction:T?T>0?lo.forward:lo.back:lo.unknown})})};function o(){l=s.value}function c(p){a.push(p);const h=()=>{const m=a.indexOf(p);m>-1&&a.splice(m,1)};return i.push(h),h}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(nt({},p.state,{scroll:Ur()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:o,listen:c,destroy:u}}function Ou(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?Ur():null}}function P_(e){const{history:t,location:s}=window,n={value:wm(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+o:D_()+e+o;try{t[d?"replaceState":"pushState"](c,"",p),a.value=c}catch(h){console.error(h),s[d?"replace":"assign"](p)}}function l(o,c){i(o,nt({},t.state,Ou(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const d=nt({},a.value,t.state,{forward:o,scroll:Ur()});i(d.current,d,!0),i(o,nt({},Ou(n.value,o,null),{position:d.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function F_(e){e=x_(e);const t=P_(e),s=M_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=nt({location:"",base:e,go:n,createHref:w_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function $_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),F_(e)}let ca=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Nt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Nt||{});const U_={type:ca.Static,value:""},B_=/[a-zA-Z0-9_]/;function H_(e){if(!e)return[[]];if(e==="/")return[[U_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(h){throw new Error(`ERR (${s})/"${c}": ${h}`)}let s=Nt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",d="";function u(){c&&(s===Nt.Static?i.push({type:ca.Static,value:c}):s===Nt.Param||s===Nt.ParamRegExp||s===Nt.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:ca.Param,value:c,regexp:d,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==Nt.ParamRegExp){n=s,s=Nt.EscapeNext;continue}switch(s){case Nt.Static:o==="/"?(c&&u(),l()):o===":"?(u(),s=Nt.Param):p();break;case Nt.EscapeNext:p(),s=n;break;case Nt.Param:o==="("?s=Nt.ParamRegExp:B_.test(o)?p():(u(),s=Nt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case Nt.ParamRegExp:o===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+o:s=Nt.ParamRegExpEnd:d+=o;break;case Nt.ParamRegExpEnd:u(),s=Nt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,d="";break;default:t("Unknown state");break}}return s===Nt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const Lu="[^/]+?",z_={sensitive:!1,strict:!1,start:!0,end:!0};var is=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(is||{});const j_=/[.+*?^${}()[\]/\\]/g;function V_(e,t){const s=nt({},z_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[is.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const p=c[u];let h=is.Segment+(s.sensitive?is.BonusCaseSensitive:0);if(p.type===ca.Static)u||(a+="/"),a+=p.value.replace(j_,"\\$&"),h+=is.Static;else if(p.type===ca.Param){const{value:m,repeatable:v,optional:T,regexp:O}=p;i.push({name:m,repeatable:v,optional:T});const y=O||Lu;if(y!==Lu){h+=is.BonusCustomRegExp;try{`${y}`}catch(b){throw new Error(`Invalid custom RegExp for param "${m}" (${y}): `+b.message)}}let g=v?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(g=T&&c.length<2?`(?:/${g})`:"/"+g),T&&(g+="?"),a+=g,h+=is.Dynamic,T&&(h+=is.BonusOptional),v&&(h+=is.BonusRepeatable),y===".*"&&(h+=is.BonusWildcard)}d.push(h)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=is.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const h=d[p]||"",m=i[p-1];u[m.name]=h&&m.repeatable?h.split("/"):h}return u}function o(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const h of p)if(h.type===ca.Static)d+=h.value;else if(h.type===ca.Param){const{value:m,repeatable:v,optional:T}=h,O=m in c?c[m]:"";if(Gs(O)&&!v)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const y=Gs(O)?O.join("/"):O;if(!y)if(T)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${m}"`);d+=y}}return d||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function q_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===is.Static+is.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===is.Static+is.Segment?1:-1:0}function km(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=q_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Nu(n))return 1;if(Nu(a))return-1}return a.length-n.length}function Nu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const G_={strict:!1,end:!0,sensitive:!1};function K_(e,t,s){const n=V_(H_(e.path),s),a=nt(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function W_(e,t){const s=[],n=new Map;t=Tu(G_,t);function a(u){return n.get(u)}function i(u,p,h){const m=!h,v=Mu(u);v.aliasOf=h&&h.record;const T=Tu(t,u),O=[v];if("alias"in u){const b=typeof u.alias=="string"?[u.alias]:u.alias;for(const k of b)O.push(Mu(nt({},v,{components:h?h.record.components:v.components,path:k,aliasOf:h?h.record:v})))}let y,g;for(const b of O){const{path:k}=b;if(p&&k[0]!=="/"){const w=p.record.path,E=w[w.length-1]==="/"?"":"/";b.path=p.record.path+(k&&E+k)}if(y=K_(b,p,T),h?h.alias.push(y):(g=g||y,g!==y&&g.alias.push(y),m&&u.name&&!Pu(y)&&l(u.name)),Sm(y)&&o(y),v.children){const w=v.children;for(let E=0;E<w.length;E++)i(w[E],y,h&&h.children[E])}h=h||y}return g?()=>{l(g)}:Mi}function l(u){if(xm(u)){const p=n.get(u);p&&(n.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function r(){return s}function o(u){const p=Y_(u,s);s.splice(p,0,u),u.record.name&&!Pu(u)&&n.set(u.record.name,u)}function c(u,p){let h,m={},v,T;if("name"in u&&u.name){if(h=n.get(u.name),!h)throw li(yt.MATCHER_NOT_FOUND,{location:u});T=h.record.name,m=nt(Du(p.params,h.keys.filter(g=>!g.optional).concat(h.parent?h.parent.keys.filter(g=>g.optional):[]).map(g=>g.name)),u.params&&Du(u.params,h.keys.map(g=>g.name))),v=h.stringify(m)}else if(u.path!=null)v=u.path,h=s.find(g=>g.re.test(v)),h&&(m=h.parse(v),T=h.record.name);else{if(h=p.name?n.get(p.name):s.find(g=>g.re.test(p.path)),!h)throw li(yt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});T=h.record.name,m=nt({},p.params,u.params),v=h.stringify(m)}const O=[];let y=h;for(;y;)O.unshift(y.record),y=y.parent;return{name:T,path:v,params:m,matched:O,meta:J_(O)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:r,getRecordMatcher:a}}function Du(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Mu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:Z_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function Z_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function Pu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function J_(e){return e.reduce((t,s)=>nt(t,s.meta),{})}function Y_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;km(e,t[i])<0?n=i:s=i+1}const a=Q_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function Q_(e){let t=e;for(;t=t.parent;)if(Sm(t)&&km(e,t)===0)return t}function Sm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Fu(e){const t=Ms(Br),s=Ms(ed),n=J(()=>{const o=nn(e.to);return t.resolve(o)}),a=J(()=>{const{matched:o}=n.value,{length:c}=o,d=o[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(ii.bind(null,d));if(p>-1)return p;const h=$u(o[c-2]);return c>1&&$u(d)===h&&u[u.length-1].path!==h?u.findIndex(ii.bind(null,o[c-2])):p}),i=J(()=>a.value>-1&&nw(s.params,n.value.params)),l=J(()=>a.value>-1&&a.value===s.matched.length-1&&ym(s.params,n.value.params));function r(o={}){if(sw(o)){const c=t[nn(e.replace)?"replace":"push"](nn(e.to)).catch(Mi);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:J(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function X_(e){return e.length===1?e[0]:e}const ew=rl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Fu,setup(e,{slots:t}){const s=Wn(Fu(e)),{options:n}=Ms(Br),a=J(()=>({[Uu(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[Uu(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&X_(t.default(s));return e.custom?i:Qa("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),tw=ew;function sw(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function nw(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Gs(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function $u(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Uu=(e,t,s)=>e??t??s,aw=rl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Ms(Jo),a=J(()=>e.route||n.value),i=Ms(Iu,0),l=J(()=>{let c=nn(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),r=J(()=>a.value.matched[l.value]);Ii(Iu,J(()=>l.value+1)),Ii(L_,r),Ii(Jo,a);const o=f();return os(()=>[o.value,r.value,e.name],([c,d,u],[p,h,m])=>{d&&(d.instances[u]=c,h&&h!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=h.leaveGuards),d.updateGuards.size||(d.updateGuards=h.updateGuards))),c&&d&&(!h||!ii(d,h)||!p)&&(d.enterCallbacks[u]||[]).forEach(v=>v(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=r.value,p=u&&u.components[d];if(!p)return Bu(s.default,{Component:p,route:c});const h=u.props[d],m=h?h===!0?c.params:typeof h=="function"?h(c):h:null,T=Qa(p,nt({},m,t,{onVnodeUnmounted:O=>{O.component.isUnmounted&&(u.instances[d]=null)},ref:o}));return Bu(s.default,{Component:T,route:c})||T}}});function Bu(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const iw=aw;function lw(e){const t=W_(e.routes,e),s=e.parseQuery||I_,n=e.stringifyQuery||Ru,a=e.history,i=bi(),l=bi(),r=bi(),o=dc($n);let c=$n;Pa&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=ao.bind(null,Y=>""+Y),u=ao.bind(null,f_),p=ao.bind(null,sl);function h(Y,be){let H,re;return xm(Y)?(H=t.getRecordMatcher(Y),re=be):re=Y,t.addRoute(re,H)}function m(Y){const be=t.getRecordMatcher(Y);be&&t.removeRoute(be)}function v(){return t.getRoutes().map(Y=>Y.record)}function T(Y){return!!t.getRecordMatcher(Y)}function O(Y,be){if(be=nt({},be||o.value),typeof Y=="string"){const M=io(s,Y,be.path),B=t.resolve({path:M.path},be),ae=a.createHref(M.fullPath);return nt(M,B,{params:p(B.params),hash:sl(M.hash),redirectedFrom:void 0,href:ae})}let H;if(Y.path!=null)H=nt({},Y,{path:io(s,Y.path,be.path).path});else{const M=nt({},Y.params);for(const B in M)M[B]==null&&delete M[B];H=nt({},Y,{params:u(M)}),be.params=u(be.params)}const re=t.resolve(H,be),ue=Y.hash||"";re.params=d(p(re.params));const Le=v_(n,nt({},Y,{hash:d_(ue),path:re.path})),x=a.createHref(Le);return nt({fullPath:Le,hash:ue,query:n===Ru?O_(Y.query):Y.query||{}},re,{redirectedFrom:void 0,href:x})}function y(Y){return typeof Y=="string"?io(s,Y,o.value.path):nt({},Y)}function g(Y,be){if(c!==Y)return li(yt.NAVIGATION_CANCELLED,{from:be,to:Y})}function b(Y){return E(Y)}function k(Y){return b(nt(y(Y),{replace:!0}))}function w(Y,be){const H=Y.matched[Y.matched.length-1];if(H&&H.redirect){const{redirect:re}=H;let ue=typeof re=="function"?re(Y,be):re;return typeof ue=="string"&&(ue=ue.includes("?")||ue.includes("#")?ue=y(ue):{path:ue},ue.params={}),nt({query:Y.query,hash:Y.hash,params:ue.path!=null?{}:Y.params},ue)}}function E(Y,be){const H=c=O(Y),re=o.value,ue=Y.state,Le=Y.force,x=Y.replace===!0,M=w(H,re);if(M)return E(nt(y(M),{state:typeof M=="object"?nt({},ue,M.state):ue,force:Le,replace:x}),be||H);const B=H;B.redirectedFrom=be;let ae;return!Le&&g_(n,re,H)&&(ae=li(yt.NAVIGATION_DUPLICATED,{to:B,from:re}),q(re,re,!0,!1)),(ae?Promise.resolve(ae):D(B,re)).catch(te=>pn(te)?pn(te,yt.NAVIGATION_GUARD_REDIRECT)?te:K(te):L(te,B,re)).then(te=>{if(te){if(pn(te,yt.NAVIGATION_GUARD_REDIRECT))return E(nt({replace:x},y(te.to),{state:typeof te.to=="object"?nt({},ue,te.to.state):ue,force:Le}),be||B)}else te=R(B,re,!0,x,ue);return A(B,re,te),te})}function C(Y,be){const H=g(Y,be);return H?Promise.reject(H):Promise.resolve()}function _(Y){const be=X.values().next().value;return be&&typeof be.runWithContext=="function"?be.runWithContext(Y):Y()}function D(Y,be){let H;const[re,ue,Le]=N_(Y,be);H=ro(re.reverse(),"beforeRouteLeave",Y,be);for(const M of re)M.leaveGuards.forEach(B=>{H.push(Vn(B,Y,be))});const x=C.bind(null,Y,be);return H.push(x),Pe(H).then(()=>{H=[];for(const M of i.list())H.push(Vn(M,Y,be));return H.push(x),Pe(H)}).then(()=>{H=ro(ue,"beforeRouteUpdate",Y,be);for(const M of ue)M.updateGuards.forEach(B=>{H.push(Vn(B,Y,be))});return H.push(x),Pe(H)}).then(()=>{H=[];for(const M of Le)if(M.beforeEnter)if(Gs(M.beforeEnter))for(const B of M.beforeEnter)H.push(Vn(B,Y,be));else H.push(Vn(M.beforeEnter,Y,be));return H.push(x),Pe(H)}).then(()=>(Y.matched.forEach(M=>M.enterCallbacks={}),H=ro(Le,"beforeRouteEnter",Y,be,_),H.push(x),Pe(H))).then(()=>{H=[];for(const M of l.list())H.push(Vn(M,Y,be));return H.push(x),Pe(H)}).catch(M=>pn(M,yt.NAVIGATION_CANCELLED)?M:Promise.reject(M))}function A(Y,be,H){r.list().forEach(re=>_(()=>re(Y,be,H)))}function R(Y,be,H,re,ue){const Le=g(Y,be);if(Le)return Le;const x=be===$n,M=Pa?history.state:{};H&&(re||x?a.replace(Y.fullPath,nt({scroll:x&&M&&M.scroll},ue)):a.push(Y.fullPath,ue)),o.value=Y,q(Y,be,H,x),K()}let $;function V(){$||($=a.listen((Y,be,H)=>{if(!fe.listening)return;const re=O(Y),ue=w(re,fe.currentRoute.value);if(ue){E(nt(ue,{replace:!0,force:!0}),re).catch(Mi);return}c=re;const Le=o.value;Pa&&T_(Au(Le.fullPath,H.delta),Ur()),D(re,Le).catch(x=>pn(x,yt.NAVIGATION_ABORTED|yt.NAVIGATION_CANCELLED)?x:pn(x,yt.NAVIGATION_GUARD_REDIRECT)?(E(nt(y(x.to),{force:!0}),re).then(M=>{pn(M,yt.NAVIGATION_ABORTED|yt.NAVIGATION_DUPLICATED)&&!H.delta&&H.type===Wo.pop&&a.go(-1,!1)}).catch(Mi),Promise.reject()):(H.delta&&a.go(-H.delta,!1),L(x,re,Le))).then(x=>{x=x||R(re,Le,!1),x&&(H.delta&&!pn(x,yt.NAVIGATION_CANCELLED)?a.go(-H.delta,!1):H.type===Wo.pop&&pn(x,yt.NAVIGATION_ABORTED|yt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),A(re,Le,x)}).catch(Mi)}))}let oe=bi(),P=bi(),N;function L(Y,be,H){K(Y);const re=P.list();return re.length?re.forEach(ue=>ue(Y,be,H)):console.error(Y),Promise.reject(Y)}function U(){return N&&o.value!==$n?Promise.resolve():new Promise((Y,be)=>{oe.add([Y,be])})}function K(Y){return N||(N=!Y,V(),oe.list().forEach(([be,H])=>Y?H(Y):be()),oe.reset()),Y}function q(Y,be,H,re){const{scrollBehavior:ue}=e;if(!Pa||!ue)return Promise.resolve();const Le=!H&&C_(Au(Y.fullPath,0))||(re||!H)&&history.state&&history.state.scroll||null;return Et().then(()=>ue(Y,be,Le)).then(x=>x&&S_(x)).catch(x=>L(x,Y,be))}const Q=Y=>a.go(Y);let ie;const X=new Set,fe={currentRoute:o,listening:!0,addRoute:h,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:T,getRoutes:v,resolve:O,options:e,push:b,replace:k,go:Q,back:()=>Q(-1),forward:()=>Q(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:P.add,isReady:U,install(Y){Y.component("RouterLink",tw),Y.component("RouterView",iw),Y.config.globalProperties.$router=fe,Object.defineProperty(Y.config.globalProperties,"$route",{enumerable:!0,get:()=>nn(o)}),Pa&&!ie&&o.value===$n&&(ie=!0,b(a.location).catch(re=>{}));const be={};for(const re in $n)Object.defineProperty(be,re,{get:()=>o.value[re],enumerable:!0});Y.provide(Br,fe),Y.provide(ed,cc(be)),Y.provide(Jo,o);const H=Y.unmount;X.add(Y),Y.unmount=function(){X.delete(Y),X.size<1&&(c=$n,$&&$(),$=null,o.value=$n,ie=!1,N=!1),H()}}};function Pe(Y){return Y.reduce((be,H)=>be.then(()=>_(H)),Promise.resolve())}return fe}function Tm(){return Ms(Br)}function rw(e){return Ms(ed)}const Hr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=rw(),s=Tm(),n=J({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=J(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=J(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});os(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},ow={setup(){const e=f([]),t=f([]),s=f({}),n=50;function a(p){var v,T,O,y,g;const h=p.payload||p,m=h.type||p.type;if(m==="tool_start"){const b=((v=h.metadata)==null?void 0:v.call_id)||null,k={callId:b,id:b||`${h.action}-${Date.now()}`,tool:h.action,actor:h.actor||"",channel:h.channel_id||"",iteration:((T=h.metadata)==null?void 0:T.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(k);return}if(m==="tool_end"){const b=((O=h.metadata)==null?void 0:O.call_id)||null;let k=-1;if(b&&(k=e.value.findIndex(w=>w.callId===b&&w.status==="running")),k<0&&!b)for(let w=e.value.length-1;w>=0;w--){const E=e.value[w];if(E.tool===h.action&&E.status==="running"){k=w;break}}if(k>=0){const w=e.value[k];w.status=(y=h.metadata)!=null&&y.error?"error":"success",w.elapsed=((g=h.metadata)==null?void 0:g.elapsed_ms)||Date.now()-w.startTime,w.result=h.detail||"",w.fadingOut=!0,setTimeout(()=>{const E=e.value.indexOf(w);E>=0&&e.value.splice(E,1),t.value.unshift(w),t.value.length>n&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const b=h.call_id||h.tool_name||"unknown";if(h.finished){const k={...s.value};delete k[b],s.value=k}else{const w=((s.value[b]||"")+(h.chunk||"")).split(`
...
... (truncated)`:s}function Hu(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function nd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Am(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Rm=Symbol("agent-detail-cancelled"),uw=15e3;function pw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((h,m)=>{o=h,c=m});function u(h,m){r||(r=!0,l!==null&&a(l),l=null,(h?o:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(h){u(!1,h)}return r||Promise.resolve(p).then(h=>u(!0,h),h=>u(!1,h)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const h=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${h}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Rm),i==null||i.abort()}}}function Im({state:e,requestDetail:t,timeoutMs:s=uw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const p=l;l=null,p==null||p.cancel()}function o(p,{initial:h,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;r();const v={agentId:p,cancel:null,promise:null};l=v,h?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const T=pw(O=>t(p,{signal:O}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=T.cancel,v.promise=(async()=>{let O=null,y=null;try{O=await T.promise}catch(g){y=g}O!==Rm&&(l!==v||e.detailId!==p||(l=null,!y&&(O===null||typeof O!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=O,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,o(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?o(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function fw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const hw={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(null),a=f(!0),i=f("all");let l=!1;const r=J(()=>e.value.filter(L=>L.status==="running").length),o=J(()=>e.value.filter(L=>L.status==="completed").length),c=J(()=>e.value.filter(L=>["failed","timeout","killed"].includes(L.status)).length),d=J(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),u=J(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(L=>["failed","timeout","killed"].includes(L.status)):e.value.filter(L=>L.status===i.value));function p(L){const U=Number(L.max_iterations)||0;return U<=0?0:Math.min(100,Math.round(L.iteration_count/U*100))}function h(L){return(Number(L.max_iterations)||0)>0}function m(L,U){return L?L==="N/A"?"N/A":U==="current_inheritance"?`inherit (currently ${L})`:L:"unknown"}function v(L){return m(L.display_model,L.display_model_source||L.display_source)}function T(L){return m(L.display_reasoning_effort,L.display_reasoning_effort_source||L.display_source)}function O(L){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[L]||""}const y=f(null),g=f(null),b=f(!1),k=f(null),w=f(""),C=Im({state:{get detail(){return y.value},set detail(L){y.value=L},get detailId(){return g.value},set detailId(L){g.value=L},get detailLoading(){return b.value},set detailLoading(L){b.value=L},get detailError(){return k.value},set detailError(L){k.value=L}},requestDetail:(L,{signal:U})=>W.get(`/api/agents/${encodeURIComponent(L)}`,{signal:U})});async function _(L){w.value="",await C.open(L.id)}function D(){C.close(),w.value=""}async function A(){await C.refresh()}async function R(L,U){try{await navigator.clipboard.writeText(U||""),w.value=L,setTimeout(()=>{w.value===L&&(w.value="")},1500)}catch{Re.error("Copy failed")}}async function $(L=!1){L=L===!0,L||(t.value=!0);try{const U=await W.get("/api/agents");e.value=Array.isArray(U)?U:[],s.value=null}catch(U){L||(s.value=U.message)}L||(t.value=!1)}async function V(L){const U=e.value.find(q=>q.id===L);if(await Xt({title:"Kill agent",message:`Kill agent "${(U==null?void 0:U.label)||L}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=L;try{await W.del(`/api/agents/${encodeURIComponent(L)}`),Re.success("Agent killed"),await $()}catch(q){Re.error(q.message||"Failed to kill agent")}n.value=null}}const oe=fw({isEnabled:()=>a.value&&l,refreshList:()=>$(!0),hasOpenDetail:()=>!!g.value,refreshDetail:A});function P(){oe.start()}function N(){oe.stop()}return os(a,()=>oe.sync()),We(()=>{l=!0,$(),P()}),us(()=>{l=!0,$(!0),P()}),ts(()=>{l=!1,N()}),mt(()=>{l=!1,N(),C.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ka,formatDuration:ri,progressPercent:p,hasProgress:h,displayModelText:v,displayEffortText:T,displaySourceLabel:O,detail:y,detailId:g,detailLoading:b,detailError:k,copied:w,openDetail:_,closeDetail:D,copyText:R,fetchAgents:$,killAgent:V,startAutoRefresh:P,stopAutoRefresh:N}}},mw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),r=f(null),o=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),h=f("");let m=!1;const T=Im({state:{get detail(){return c.value},set detail(N){c.value=N},get detailId(){return d.value},set detailId(N){d.value=N},get detailLoading(){return u.value},set detailLoading(N){u.value=N},get detailError(){return p.value},set detailError(N){p.value=N}},detailLabel:"Loop detail",requestDetail:(N,{signal:L})=>W.get(`/api/loops/${encodeURIComponent(N)}?limit=100`,{signal:L})});async function O(N){h.value="",await T.open(N.id)}function y(){T.close(),h.value=""}async function g(N,L){try{await navigator.clipboard.writeText(L||""),h.value=N,setTimeout(()=>{h.value===N&&(h.value="")},1500)}catch{Re.error("Copy failed")}}const b=J(()=>e.value.reduce((N,L)=>N+(L.iteration_count||0),0)),k=J(()=>e.value.filter(N=>N.status==="running").length);function w(N){return N==="running"?"loop-status-running":N==="error"?"loop-status-error":"loop-status-stopped"}function E(N){return N==="running"?"badge-success":N==="error"?"badge-danger":N==="completed"?"badge-info":"badge-warning"}function C(N){return N==="act"?"badge-warning":N==="silent"?"badge-info":"badge-success"}async function _(N=!1){N=N===!0,N||(t.value=!0);try{const L=await W.get("/api/loops");e.value=Array.isArray(L)?L:[],s.value=null}catch(L){N||(s.value=L.message)}N||(t.value=!1)}async function D(){l.value=null;const N=a.value;if(!N.goal.trim()){l.value="Goal is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}const L={goal:N.goal.trim(),channel_id:N.channel_id.trim(),interval_seconds:N.interval_seconds||60,mode:N.mode,max_iterations:N.max_iterations||50};N.stop_condition.trim()&&(L.stop_condition=N.stop_condition.trim()),i.value=!0;try{const U=await W.post("/api/loops",L);Re.success(`Loop started: ${U.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await _()}catch(U){l.value=U.message}i.value=!1}async function A(N){if(await Xt({title:"Stop loop",message:`Stop loop ${N}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=N;try{await W.del(`/api/loops/${encodeURIComponent(N)}`),Re.success("Loop stopped"),await _()}catch(U){Re.error(U.message||"Failed to stop loop")}r.value=null}}async function R(N){o.value=N;try{await W.post(`/api/loops/${encodeURIComponent(N)}/restart`),Re.success("Loop restarted"),await _()}catch(L){Re.error(L.message||"Failed to restart loop")}o.value=null}function $(N){m&&N.payload&&(N.payload.loop_id||N.payload.type==="loop")&&(_(!0),d.value&&T.refresh())}let V=null;function oe(){V!==null&&clearInterval(V),V=null}function P(){oe(),m&&(V=setInterval(()=>{_(!0),d.value&&T.refresh()},5e3))}return We(()=>{m=!0,_(),Ye.subscribe("events",$),P()}),us(()=>{m=!0,_(!0),P()}),ts(()=>{m=!1,oe()}),mt(()=>{m=!1,Ye.unsubscribe("events",$),oe(),T.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:p,copied:h,totalIterations:b,runningCount:k,statusDotClass:w,statusBadge:E,modeBadge:C,formatAge:Cm,formatDuration:ri,formatTs:ka,formatTokens:Am,openDetail:O,closeDetail:y,copyText:g,fetchLoops:_,doCreate:D,doStop:A,doRestart:R}}},vw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=f(!1),l=f(null),r=f(null),o=J(()=>xw(a.value.run_at));os(()=>a.value.run_at,()=>{r.value=null});const c=J(()=>{var re;const H=o.value;return H.state==="ok"?H.instant:H.state==="ambiguous"&&r.value!==null&&((re=H.options[r.value])==null?void 0:re.instant)||null}),d=J(()=>{const H=c.value;return H?`${H.toLocaleString()} local — ${H.toISOString()} UTC`:""}),u=f(null),p=f(!1),h=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=f(null),v=f(null),T=f(null),O=f(null),y=f(null),g=f(null),b=f([]),k=f(!1),w=f("");let E=0;const C=J(()=>e.value.filter(H=>H.cron&&!H.one_time).length),_=J(()=>e.value.filter(H=>H.one_time).length),D=J(()=>e.value.filter(H=>H.trigger).length),A=J(()=>e.value.filter(H=>H.paused).length),R=J(()=>e.value.filter(H=>H.consecutive_failures>0).length);function $(H){if(!H)return"-";const re=Date.now(),Le=(new Date(H).getTime()-re)/1e3;if(Le<0)return"overdue";if(Le<60)return"in < 1 min";if(Le<3600)return`in ${Math.floor(Le/60)} min`;if(Le<86400){const M=Math.floor(Le/3600),B=Math.floor(Le%3600/60);return B>0?`in ${M}h ${B}m`:`in ${M}h`}const x=Math.floor(Le/86400);return`in ${x} day${x!==1?"s":""}`}function V(H){return H==null?"-":H<1e3?`${H}ms`:H<6e4?`${(H/1e3).toFixed(1)}s`:ri(H/1e3)}function oe(H=a.value.cron){a.value.cron=H,zu(a.value,"cron"),u.value=null}function P(H=a.value.run_at){a.value.run_at=H,zu(a.value,"run_at"),u.value=null}async function N(){const H=a.value.cron.trim();if(H){p.value=!0;try{u.value=await W.post("/api/schedules/validate-cron",{expression:H})}catch(re){u.value={valid:!1,error:re.message}}p.value=!1}}async function L(){t.value=!0,s.value=null;try{e.value=await W.get("/api/schedules")}catch(H){s.value=H.message}t.value=!1}async function U(H){if(g.value===H){g.value=null,b.value=[];return}g.value=H,k.value=!0,b.value=[];const re=++E;try{const ue=await W.get(`/api/schedules/${encodeURIComponent(H)}/history?limit=10`);if(re!==E||g.value!==H)return;b.value=ue,w.value=""}catch(ue){if(re!==E||g.value!==H)return;b.value=[],w.value=ue.message||"Failed to load execution history"}re===E&&(k.value=!1)}async function K(){l.value=null;const H=a.value;if(!H.description.trim()){l.value="Description is required";return}if(!H.channel_id.trim()){l.value="Channel ID is required";return}if(!H.cron.trim()&&!H.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(H.cron.trim()&&H.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const re={description:H.description.trim(),action:H.action,channel_id:H.channel_id.trim()};if(H.cron.trim()&&(re.cron=H.cron.trim()),H.run_at.trim()){const ue=o.value;if(ue.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(ue.state==="invalid"){l.value="One-time run time is not a valid date";return}const Le=c.value;if(ue.state==="ambiguous"&&r.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Le){l.value="One-time run time could not be resolved";return}re.run_at=Le.toISOString()}if(H.action==="reminder"&&H.message.trim()&&(re.message=H.message.trim()),H.action==="check"&&(H.tool_name.trim()&&(re.tool_name=H.tool_name.trim()),H.report_format&&(re.report_format=H.report_format),H.tool_input_str.trim()))try{re.tool_input=JSON.parse(H.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await W.post("/api/schedules",re),Re.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await L()}catch(ue){l.value=ue.message}i.value=!1}async function q(H){m.value=H;try{const re=await W.post(`/api/schedules/${encodeURIComponent(H)}/run`);if(re.status==="failure")Re.error(`Execution failed: ${re.error||"unknown error"}`);else{const ue=re.warning?`Executed (${re.warning})`:"Executed successfully";Re.success(ue)}await L()}catch(re){Re.error(re.message||"Failed to trigger")}m.value=null}async function Q(H){T.value=H.id;const re=!H.paused;try{await W.put(`/api/schedules/${encodeURIComponent(H.id)}`,{paused:re}),Re.success(re?"Schedule paused":"Schedule resumed"),await L()}catch(ue){Re.error(ue.message||"Failed to update schedule")}T.value=null}const ie=new Map;function X(H,re){const ue=ie.get(H.id);ue&&clearTimeout(ue.timer);const Le={run:()=>fe(H,re),timer:null};Le.timer=setTimeout(()=>{ie.delete(H.id),Le.run()},500),ie.set(H.id,Le)}async function fe(H,re){y.value=H.id;try{await W.put(`/api/schedules/${encodeURIComponent(H.id)}`,{report_format:re}),Re.success(re?"Structured report enabled":"Plain-text report enabled")}catch(ue){Re.error(`Update failed: ${ue.message}`)}finally{await L(),y.value=null}}function Pe(){for(const[H,re]of[...ie])clearTimeout(re.timer),ie.delete(H),re.run()}async function Y(H){O.value=H;try{await W.post(`/api/schedules/${encodeURIComponent(H)}/reset-failures`),Re.success("Failure counters reset"),await L()}catch(re){Re.error(re.message||"Failed to reset")}O.value=null}async function be(H){const re=e.value.find(Le=>Le.id===H);if(await Xt({title:"Delete schedule",message:`Delete "${(re==null?void 0:re.description)||H}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=H;try{await W.del(`/api/schedules/${encodeURIComponent(H)}`),Re.success("Schedule deleted"),await L()}catch(Le){Re.error(Le.message||"Failed to delete schedule")}v.value=null}}return We(()=>{L()}),mt(Pe),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:o,runAtOccurrence:r,cronResult:u,validatingCron:p,cronPresets:h,runningId:m,deletingId:v,togglingId:T,resettingId:O,reportUpdatingId:y,flushReportFormatTimers:Pe,expandedId:g,history:b,historyLoading:k,historyError:w,cronCount:C,oneTimeCount:_,webhookCount:D,pausedCount:A,failingCount:R,formatTs:ka,formatAge:Cm,formatFuture:$,formatMs:V,formatDuration:ri,onCronInput:oe,onRunAtInput:P,validateCron:N,toggleExpand:U,fetchSchedules:L,doCreate:K,doRunNow:q,doTogglePause:Q,doUpdateReportFormat:X,doResetFailures:Y,doDelete:be}}},Om=[{id:"live",label:"Live",component:ow},{id:"agents",label:"Agents",component:hw},{id:"loops",label:"Loops",component:mw},{id:"processes",label:"Processes",component:vw},{id:"schedules",label:"Schedules",component:_w}],ww={components:{TabbedPage:Hr},setup(){return{tabs:Om}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},kw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
... (truncated)`:se:""}async function x(){const se=w.value.trim();if(se){D.value=!0;try{let we=`/api/sessions/search?q=${encodeURIComponent(se)}&limit=50`;E.value.trim()&&(we+=`&channel_id=${encodeURIComponent(E.value.trim())}`),C.value.trim()&&(we+=`&user_id=${encodeURIComponent(C.value.trim())}`);const Ie=await W.get(we);_.value=Ie.results||[]}catch{_.value=[]}D.value=!1}}function M(){w.value="",E.value="",C.value="",_.value=null}function B(se){return se?se.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function ae(se){return se==="user"?"fts-result-user":se==="assistant"?"fts-result-assistant":se==="summary"?"fts-result-summary":se==="fts"?"fts-result-fts":se==="channel"?"fts-result-channel":"fts-result-default"}function te(se){return se==="user"?"badge-info":se==="assistant"?"badge-success":se==="summary"?"badge-warning":se==="fts"?"badge-success":"badge-info"}let ne=0;async function he(){const se=++ne;t.value=!0,s.value=null;try{const we=await W.get("/api/sessions");if(se!==ne)return;e.value=we}catch(we){if(se!==ne)return;s.value=we.message}se===ne&&(t.value=!1)}function de(){s.value=null,he()}async function pe(se){if(n.value===se){n.value=null,a.value=null,k.value=new Set;return}n.value=se,a.value=null,i.value=!0,k.value=new Set;const we=++l;try{const Ie=await W.get(`/api/sessions/${encodeURIComponent(se)}`);we===l&&n.value===se&&(a.value=Ie)}catch(Ie){we===l&&n.value===se&&(a.value={messages:[],summary:"",error:Ie.message||"Failed to load session"})}finally{we===l&&(i.value=!1)}}function le(se){const we=new Set(c.value);we.has(se)?we.delete(se):we.add(se),c.value=we}function ke(){P.value?c.value=new Set:c.value=new Set(V.value.map(se=>se.channel_id))}function ye(se){r.value=se}async function _e(){if(r.value){o.value=!0;try{await W.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await he()}catch(se){s.value=se.message||"Failed to clear session"}o.value=!1,r.value=null}}function ce(){d.value=!0}async function z(){if(c.value.size!==0){o.value=!0;try{await W.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await he()}catch(se){s.value=se.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}async function ve(se,we){const Ie=`/api/sessions/${encodeURIComponent(se)}/export?format=${we}`;try{const ze=await W.getBlob(Ie),it=URL.createObjectURL(ze),qe=document.createElement("a");qe.href=it,qe.download=`session-${se}.${we==="text"?"txt":"json"}`,qe.click(),URL.revokeObjectURL(it)}catch(ze){s.value=ze.message||"Failed to export session"}}let Te=null;function Oe(se){se.payload&&se.payload.channel_id&&(clearTimeout(Te),Te=setTimeout(()=>{if(he(),n.value&&se.payload.channel_id===n.value){const we=n.value,Ie=l;W.get(`/api/sessions/${encodeURIComponent(we)}`).then(ze=>{Ie!==l||n.value!==we||(a.value=ze)}).catch(()=>{})}},2e3))}let De=!1,ct=null;function rt(){De||(De=!0,he(),Ye.subscribe("events",Oe),ct=Ye.onReconnected(()=>he()))}We(()=>{A(),rt()}),us(()=>{rt()});function Pt(){De&&(De=!1,Ye.unsubscribe("events",Oe),ct&&(ct(),ct=null),clearTimeout(Te))}return ts(Pt),mt(Pt),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:P,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:h,sortAsc:m,filterPresets:v,sortOptions:T,filteredSessions:V,hasActiveFilters:$,customPresets:O,showSavePreset:y,newPresetName:g,threadView:b,threads:oe,collapsedThreads:k,ftsQuery:w,ftsChannelId:E,ftsUserId:C,ftsResults:_,ftsSearching:D,formatAge:X,formatTimestamp:fe,formatFullTimestamp:Pe,messageClass:Y,threadMsgClass:be,roleBadge:H,roleDotClass:re,roleLabelClass:ue,truncateContent:Le,threadSummary:N,fetchSessions:he,retry:de,toggleSession:pe,toggleSelect:le,toggleSelectAll:ke,confirmClear:ye,clearSession:_e,confirmBulkClear:ce,doBulkClear:z,exportSession:ve,applyPreset:U,applyCustomPreset:K,saveCustomPreset:q,removeCustomPreset:Q,resetFilters:ie,toggleThread:L,runFtsSearch:x,clearFtsSearch:M,highlightSnippet:B,ftsResultClass:ae,ftsTypeBadge:te}}},Cw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:Am}}},Ew={components:{ContextAssemblyPanel:Cw},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),n=f(null),a=f(null),i=f(null),l=f(""),r=f(""),o=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(E){if(!E)return"—";try{const C=new Date(E);return isNaN(C.getTime())?E:C.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return E}}function p(E){return!E&&E!==0?"—":E<1e3?E+"ms":(E/1e3).toFixed(1)+"s"}function h(E){return!E&&E!==0?"—":E>=1e3?(E/1e3).toFixed(1)+"k":String(E)}function m(E){if(!E)return"";if(typeof E=="string")return E;try{return JSON.stringify(E,null,2)}catch{return String(E)}}function v(E){a.value===E?a.value=null:(a.value=E,c.value={})}function T(E,C){const _=E+"-"+C;c.value={...c.value,[_]:!c.value[_]}}function O(E,C){return!!c.value[E+"-"+C]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,k()}async function g(){try{const E=await W.get("/api/trajectories");e.value=E.files||[],o.value=E.count||0}catch{}}let b=0;async function k(){const E=++b;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const C=await W.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${d.value.limit}`);if(E!==b)return;let _=C.entries||[];d.value.tool_name&&(_=_.filter(D=>(D.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(_=_.filter(D=>D.is_error)),d.value.channel_id&&(_=_.filter(D=>D.channel_id===d.value.channel_id)),d.value.user_id&&(_=_.filter(D=>D.user_id===d.value.user_id)),t.value=_}else{const C=new URLSearchParams;d.value.channel_id&&C.set("channel_id",d.value.channel_id),d.value.user_id&&C.set("user_id",d.value.user_id),d.value.tool_name&&C.set("tool_name",d.value.tool_name),d.value.errors_only&&C.set("errors_only","true"),C.set("limit",String(d.value.limit));const _=C.toString(),D=await W.get(`/api/trajectories/search/query?${_}`);if(E!==b)return;t.value=D.results||[]}}catch(C){if(E!==b)return;n.value=C.message}E===b&&(s.value=!1)}async function w(){if(!l.value.trim())return;const E=++b;s.value=!0,n.value=null,c.value={};try{const C=await W.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(E!==b)return;i.value=C.entry||null,i.value||(n.value="No trace found for this message ID")}catch(C){if(E!==b)return;C.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=C.message}E===b&&(s.value=!1)}return We(async()=>{await g(),await k()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:h,formatJSON:m,truncateBlock:Em,toggleExpand:v,toggleIteration:T,isIterationExpanded:O,clearFilters:y,fetchFiles:g,fetchTraces:k,lookupMessage:w}}};function Aw(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function Rw(e){return e?`${e.approximate?"~":""}${nd(e.total||0)}`:"0"}const Iw={template:`
...
`).length:0}function A(X){return Dw(X)}function R(X){n.value={...n.value,[X]:!n.value[X]}}async function $(X){try{await navigator.clipboard.writeText(X);const fe=e.value.find(Pe=>Pe.code===X);fe&&(r.value=fe.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function V(X){if(X.key==="Tab"){X.preventDefault();const fe=X.target,Pe=fe.selectionStart,Y=fe.selectionEnd;u.value=u.value.substring(0,Pe)+"    "+u.value.substring(Y),Et(()=>{fe.selectionStart=fe.selectionEnd=Pe+4})}}function oe(X){const fe=X.target.previousElementSibling;fe&&(fe.scrollTop=X.target.scrollTop)}async function P(){t.value=!0,s.value=null;try{e.value=await W.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function N(X){i.value=X,delete a.value[X],a.value={...a.value};try{const fe=await W.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:fe}}catch(fe){a.value={...a.value,[X]:{result:fe.message,is_error:!0}}}i.value=null}function L(){o.value=!0,c.value="create",d.value="",u.value="",p.value=null,h.value=null}function U(X){o.value=!0,c.value="edit",d.value=X.name,u.value=X.code||"",p.value=null,h.value=null}function K(){o.value=!1,p.value=null,h.value=null}async function q(){p.value=null,h.value=null;const X=d.value.trim(),fe=u.value.trim();if(!X){p.value="Name is required";return}if(!fe){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await W.post("/api/skills",{name:X,code:fe}),h.value="Skill created successfully"):(await W.put(`/api/skills/${encodeURIComponent(X)}`,{code:fe}),h.value="Skill updated successfully"),await P(),setTimeout(()=>{o.value=!1},800)}catch(Pe){p.value=Pe.message}m.value=!1}function Q(X){T.value=X}async function ie(){if(T.value){O.value=!0;try{await W.del(`/api/skills/${encodeURIComponent(T.value)}`),await P()}catch(X){Re.error(`Failed to delete skill: ${X.message||"unknown error"}`)}O.value=!1,T.value=null}}return We(()=>{P()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:p,editSuccess:h,saving:m,editorRef:v,deleteTarget:T,deleting:O,enabledCount:y,totalExecutions:g,totalLines:b,displayedSkills:k,editLineCount:w,editorLineNums:E,editValidation:C,highlight:_,truncate:sd,formatTs:ka,countLines:D,getLineNumbers:A,toggleCode:R,copyCode:$,handleEditorKey:V,syncScroll:oe,fetchSkills:P,testSkill:N,showCreate:L,editSkill:U,cancelEdit:K,saveSkill:q,confirmDelete:Q,doDelete:ie}}};class Ls extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Pw=/^[A-Za-z_][A-Za-z0-9_]*$/;function Vu(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function qu(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const r=String((l==null?void 0:l.key)||"").trim(),o=String((l==null?void 0:l.value)??"");if(!(!r&&!o)){if(!r)throw new Ls(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(r))throw new Ls(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,r))throw new Ls(`${s} key “${r}” appears more than once.`,"authentication");if(i.has(r))throw new Ls(`${s} key “${r}” cannot be replaced and removed in the same save.`,"authentication");n[r]=o}}return{set:n,remove:a}}function Fw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function $w(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Ls("Server name is required.","name");if(a.length>128||!Pw.test(a))throw new Ls("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,r={enabled:!!e.enabled,transport:i};if(n&&(r.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Ls("An executable path is required for a new stdio connection.","command");if(d&&(r.command=d),(n||e.replaceArgs)&&(r.args=Vu(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Ls("Working directory must be an absolute path.","cwd");r.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Ls("An HTTP endpoint is required for this connection.","url");if(d&&!Fw(d))throw new Ls("Endpoint must be a valid http:// or https:// URL.","url");d&&(r.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Ls("Timeout must be a whole number from 1 to 3600 seconds.","timeout");r.timeout_seconds=d}(n||e.replaceAllowlist)&&(r.tool_allowlist=Vu(e.allowlistText));const o=qu(e.headerRows,e.headersRemove,"Header"),c=qu(e.envRows,e.envRemove,"Environment variable");return Object.keys(o.set).length&&(r.headers_set=o.set),o.remove.length&&(r.headers_remove=o.remove),Object.keys(c.set).length&&(r.env_set=c.set),c.remove.length&&(r.env_remove=c.remove),r}function Uw(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function Bw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Hw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const zw=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function jw(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Vw=1e4,qw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function co(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function Gw(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Kw={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),n=f(""),a=f(new Set),i=f(new Set),l=f({}),r=f({}),o=f({}),c=f(new Set),d=f(!1),u=f("add"),p=f(""),h=f(null),m=f(co()),v=f(""),T=f(!1);let O=null,y=0,g=!1,b=!1;const k=zw,w=J(()=>{var z;return((z=e.value)==null?void 0:z.servers)||[]}),E=J(()=>{var z;return!!((z=e.value)!=null&&z.enabled)}),C=J(()=>{var z,ve,Te,Oe;return{serverCount:((z=e.value)==null?void 0:z.server_count)||0,enabledCount:((ve=e.value)==null?void 0:ve.enabled_server_count)||0,connectedCount:((Te=e.value)==null?void 0:Te.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),_=J(()=>{var z;return((z=h.value)==null?void 0:z.header_keys)||[]}),D=J(()=>{var z;return((z=h.value)==null?void 0:z.env_keys)||[]}),A=J(()=>{var z;return u.value==="edit"&&((z=h.value)==null?void 0:z.transport)==="http"}),R=J(()=>u.value==="add"||!A.value),$=J(()=>A.value?"Replace endpoint URL":"Endpoint URL"),V=J(()=>A.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function oe(){P(),O=window.setInterval(()=>N({quiet:!0}),Vw)}function P(){O&&window.clearInterval(O),O=null}async function N({quiet:z=!1}={}){const ve=++y;z||(t.value=!0);try{const Te=await W.get("/api/mcp/status");if(ve!==y||!g)return;e.value=Te,n.value="";const Oe=new Set((Te.servers||[]).map(De=>De.name));i.value=new Set([...i.value].filter(De=>Oe.has(De)))}catch(Te){ve===y&&g&&(n.value=Te.message||"Failed to load MCP status")}finally{ve===y&&(t.value=!1)}}function L(z){return s.value||a.value.has(z)}function U(z,ve){const Te=new Set(a.value);ve?Te.add(z):Te.delete(z),a.value=Te}function K(z){return Bw(z.state)}function q(z){if(K(z)==="disabled"){if(!z.enabled)return"Disabled — server switch off";if(!E.value)return"Disabled — global MCP is off"}return qw[K(z)]}function Q(z){return z.transport==="http"?"Streamable HTTP":"stdio"}function ie(z){return z.negotiated_version?`${z.era?`${String(z.era).charAt(0).toUpperCase()}${String(z.era).slice(1)}`:"Protocol"} · ${z.negotiated_version}`:"Not negotiated"}function X(z){return z.discovered_count?`${z.published_count||0} published · ${z.excluded_count||0} excluded`:"No tools discovered"}const fe=f(new Set);async function Pe(z,ve){if(fe.value.has(z.name))return;const Te=!!ve.target.checked,Oe=new Set(fe.value);Oe.add(z.name),fe.value=Oe;try{const De=await W.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/enabled`,{enabled:Te});De&&Array.isArray(De.servers)?e.value=De:await N({quiet:!0})}catch(De){ve.target.checked=!!z.enabled,Re.error(De.message||`Failed to toggle ${z.name}`)}finally{const De=new Set(fe.value);De.delete(z.name),fe.value=De}}async function Y(z){if(z!==E.value&&!(!z&&!await Xt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await W.post("/api/mcp/enabled",{enabled:z}),Re.success(z?"MCP enabled":"MCP disabled"),await N({quiet:!0})}catch(ve){Re.error(ve.message||"Failed to update MCP state"),await N({quiet:!0})}finally{s.value=!1}}}async function be(z){U(z.name,!0);try{await W.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/reconnect`,{}),Re.success(`Reconnected ${z.name}`)}catch(ve){Re.error(ve.message||`Failed to reconnect ${z.name}`)}finally{U(z.name,!1),await N({quiet:!0})}}async function H(z){U(z.name,!0);try{await W.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/refresh-tools`,{}),Re.success(`Refreshed tools from ${z.name}`),await Le(z.name,!0)}catch(ve){Re.error(ve.message||`Failed to refresh ${z.name}`)}finally{U(z.name,!1),await N({quiet:!0})}}async function re(z){if(await Xt({title:`Remove ${z.name}`,message:`Remove this saved MCP server? Its ${z.published_count||0} published tool${z.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){U(z.name,!0);try{await W.del(`/api/mcp/servers/${encodeURIComponent(z.name)}`),Re.success(`Removed ${z.name}`),delete r.value[z.name]}catch(Te){Re.error(Te.message||`Failed to remove ${z.name}`)}finally{U(z.name,!1),await N({quiet:!0})}}}async function ue(z){const ve=new Set(i.value);if(ve.has(z.name)){ve.delete(z.name),i.value=ve;return}ve.add(z.name),i.value=ve,Object.hasOwn(r.value,z.name)||await Le(z.name)}async function Le(z,ve=!1){if(!ve&&Object.hasOwn(r.value,z))return;const Te=new Set(c.value);Te.add(z),c.value=Te,o.value={...o.value,[z]:""};try{const Oe=await W.get(`/api/mcp/servers/${encodeURIComponent(z)}/tools`);r.value={...r.value,[z]:Oe.tools||[]}}catch(Oe){o.value={...o.value,[z]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(c.value);Oe.delete(z),c.value=Oe}}function x(z){return(r.value[z]||[]).filter(ve=>Hw(ve,l.value[z]))}function M(z,ve){l.value={...l.value,[z]:ve}}function B(){u.value="add",p.value="",h.value=null,m.value=co(),v.value="",d.value=!0}function ae(z){u.value="edit",p.value=z.name,h.value=z,m.value={...co(),name:z.name,enabled:!!z.enabled,transport:z.transport||"stdio"},v.value="",d.value=!0}function te(){T.value||(d.value=!1)}function ne(z){d.value&&jw(z)}function he(z){const ve=z==="headers"?"headerRows":"envRows";m.value[ve].push({key:"",value:""})}function de(z,ve){const Te=z==="headers"?"headerRows":"envRows";m.value[Te].splice(ve,1)}function pe(z,ve){const Te=z==="headers"?"headersRemove":"envRemove",Oe=m.value[Te];m.value[Te]=Oe.includes(ve)?Oe.filter(De=>De!==ve):[...Oe,ve]}async function le(){var ve,Te;v.value="";let z;try{z=$w(m.value,{mode:u.value,originalTransport:((ve=h.value)==null?void 0:ve.transport)||""})}catch(Oe){v.value=Oe instanceof Ls?Oe.message:"Invalid MCP server configuration",await Et(),(Te=document.querySelector(".mcp-editor"))==null||Te.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Uw(z,h.value)&&!await Xt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){T.value=!0;try{u.value==="add"?await W.post("/api/mcp/servers",z):await W.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,z),Re.success(u.value==="add"?`Saved ${z.name}`:`Updated ${p.value}`),d.value=!1,await N({quiet:!0})}catch(Oe){v.value=Oe.message||"Failed to save MCP server"}finally{T.value=!1}}}let ke=null;function ye(z){`${(z==null?void 0:z.event)||""} ${(z==null?void 0:z.type)||""} ${(z==null?void 0:z.tool)||""} ${(z==null?void 0:z.message)||""}`.toLowerCase().includes("mcp")&&(ke&&window.clearTimeout(ke),ke=window.setTimeout(()=>N({quiet:!0}),200))}function _e(){g||(g=!0,b||(Ye.subscribe("events",ye),b=!0),N(),oe())}function ce(){g=!1,P(),ke&&window.clearTimeout(ke),ke=null,b&&(Ye.unsubscribe("events",ye),b=!1)}return We(_e),us(_e),ts(ce),mt(ce),{status:e,loading:t,mutating:s,pageError:n,servers:w,masterEnabled:E,aggregate:C,expandedServers:i,toolQueries:l,toolErrors:o,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:h,form:m,formError:v,saving:T,editorGroups:k,configuredHeaderKeys:_,configuredEnvKeys:D,savedHttpEndpoint:A,endpointRequired:R,endpointFieldLabel:$,endpointPlaceholder:V,refreshAll:N,busy:L,serverState:K,stateLabel:q,transportLabel:Q,protocolLabel:ie,toolSummary:X,formatAge:Gw,setMasterEnabled:Y,togglePending:fe,toggleServerEnabled:Pe,reconnect:be,refreshTools:H,removeServer:re,toggleTools:ue,filteredTools:x,setToolQuery:M,openAdd:B,openEdit:ae,closeEditor:te,jumpToEditorGroup:ne,addSecretRow:he,removeSecretRow:de,toggleSecretRemoval:pe,saveServer:le}}};function Ww(e,t){if(!e||!t)return Hu(e);const s=Hu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Zw={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f(null),i=f(!1),l=f(""),r=f(null),o=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),h=f(!1),m=f(null),v=f(null);let T=null;const O=f(null),y=f(!1),g=f({}),b=f({}),k=f({}),w=f({}),E=new Map,C=f(null),_=J(()=>e.value.reduce((q,Q)=>q+(Q.chunks||0),0)),D=J(()=>new Set(e.value.map(Q=>Q.uploader).filter(Boolean)).size);function A(q,Q){const ie=b.value[Q];if(!ie||ie.length===0)return 0;const X=Math.max(...ie.map(fe=>fe.char_count||0));return X===0?0:Math.round(q.char_count/X*100)}async function R(){t.value=!0,s.value=null;try{const q=await W.get("/api/knowledge");e.value=Array.isArray(q)?q:[]}catch(q){s.value=q.message}t.value=!1}async function $(q){if(g.value[q]){g.value[q]=!1,C.value=null;return}if(g.value[q]=!0,Object.prototype.hasOwnProperty.call(b.value,q))return;if(E.has(q))return E.get(q);const Q={...w.value,[q]:!0};w.value=Q;const ie={...k.value};delete ie[q],k.value=ie;const X=W.get(`/api/knowledge/${encodeURIComponent(q)}/chunks`).then(fe=>{b.value={...b.value,[q]:Array.isArray(fe)?fe:[]}}).catch(fe=>{k.value={...k.value,[q]:fe.message||"load failed"}}).finally(()=>{if(E.get(q)!==X)return;E.delete(q);const fe={...w.value};delete fe[q],w.value=fe});return E.set(q,X),X}let V=0;async function oe(){const q=n.value.trim();if(!q)return;const Q=++V;i.value=!0,r.value=null,l.value=q;try{const ie=await W.get(`/api/knowledge/search?q=${encodeURIComponent(q)}`);if(Q!==V)return;a.value=Array.isArray(ie)?ie:[]}catch(ie){if(Q!==V)return;a.value=[],r.value=ie.message||"Search failed"}Q===V&&(i.value=!1)}function P(){V+=1,i.value=!1,a.value=null,n.value="",r.value=null}async function N(){u.value=null,p.value=null;const q=c.value.trim(),Q=d.value.trim();if(!q){u.value="Source name is required";return}if(!Q){u.value="Content is required";return}h.value=!0;try{const ie=await W.post("/api/knowledge",{source:q,content:Q});p.value=`Ingested ${ie.chunks||0} chunks from "${q}"`,c.value="",d.value="",b.value={},await R(),setTimeout(()=>{o.value=!1,p.value=null},1500)}catch(ie){u.value=ie.message}h.value=!1}async function L(q){m.value=q,v.value=null,T&&(clearTimeout(T),T=null);try{const Q=await W.post(`/api/knowledge/${encodeURIComponent(q)}/reingest`);v.value={source:q,error:!1,message:`Re-ingested ${Q.chunks||0} chunks`},delete b.value[q],await R(),T=setTimeout(()=>{v.value=null,T=null},3e3)}catch(Q){v.value={source:q,error:!0,message:Q.message}}m.value=null}function U(q){O.value=q}async function K(){if(O.value){y.value=!0;try{await W.del(`/api/knowledge/${encodeURIComponent(O.value)}`),delete b.value[O.value],await R()}catch(q){Re.error(`Failed to delete source: ${q.message||"unknown error"}`)}y.value=!1,O.value=null}}return We(()=>{R()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:h,reingesting:m,reingestResult:v,deleteTarget:O,deleting:y,expanded:g,sourceChunks:b,chunkErrors:k,loadingChunks:w,selectedChunk:C,totalChunks:_,uploaderCount:D,truncate:sd,formatTs:ka,highlightTerms:Ww,chunkBarWidth:A,fetchSources:R,toggleSource:$,doSearch:oe,clearSearch:P,doIngest:N,doReingest:L,confirmDelete:U,doDelete:K}}},Jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),n=f(null),a=f({}),i=f(null),l=f(""),r=f(!1),o=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),h=f(""),m=f(!1),v=f(null),T=f(null),O=f(new Set),y=f(null),g=f(!1),b=f(!1),k=J(()=>e.value.reduce((Q,ie)=>Q+ie.count,0)),w=J(()=>O.value.size);function E(Q){const ie=t.value[Q];if(!ie)return[];if(!l.value.trim())return ie;const X=l.value.trim().toLowerCase();return ie.filter(fe=>fe.key.toLowerCase().includes(X)||fe.value&&fe.value.toLowerCase().includes(X))}function C(Q,ie){return O.value.has(Q+"/"+ie)}function _(Q,ie){const X=Q+"/"+ie,fe=new Set(O.value);fe.has(X)?fe.delete(X):fe.add(X),O.value=fe}function D(Q){const ie=t.value[Q];return!ie||ie.length===0?!1:ie.every(X=>O.value.has(Q+"/"+X.key))}function A(Q,ie){const X=t.value[Q];if(!X)return;const fe=new Set(O.value);for(const Pe of X){const Y=Q+"/"+Pe.key;ie?fe.add(Y):fe.delete(Y)}O.value=fe}async function R(){s.value=!0,n.value=null;try{const Q=await W.get("/api/memory");e.value=Object.entries(Q).map(([ie,X])=>({name:ie,keys:X.keys||[],count:X.count||0}))}catch(Q){n.value=Q.message}s.value=!1}async function $(Q){if(a.value[Q]){a.value[Q]=!1;return}a.value[Q]=!0;const ie=e.value.find(fe=>fe.name===Q);if(!ie||t.value[Q]||i.value===Q)return;i.value=Q;let X;try{const Pe=(await W.get(`/api/memory/${encodeURIComponent(Q)}`)).entries||{};X=ie.keys.map(Y=>Object.prototype.hasOwnProperty.call(Pe,Y)?{key:Y,value:Pe[Y]||"",failed:!1}:{key:Y,value:"",failed:!0,error:"Not found in scope"})}catch(fe){X=ie.keys.map(Pe=>({key:Pe,value:"",failed:!0,error:fe.message||"Failed to load"}))}t.value[Q]=X,i.value=null}function V(Q,ie,X){p.value=Q+"/"+ie,h.value=X}async function oe(Q,ie){m.value=!0,v.value=null;try{await W.put(`/api/memory/${encodeURIComponent(Q)}/${encodeURIComponent(ie)}`,{value:h.value});const X=t.value[Q];if(X){const fe=X.find(Pe=>Pe.key===ie);fe&&(fe.value=h.value)}p.value=null}catch(X){v.value=`Failed to save: ${X.message||"unknown error"}`}m.value=!1}async function P(Q,ie){try{await navigator.clipboard.writeText(ie.value),T.value=Q+"/"+ie.key,setTimeout(()=>{T.value=null},1500)}catch{}}async function N(){d.value=null,u.value=null;const Q=o.value.scope.trim(),ie=o.value.key.trim(),X=o.value.value.trim();if(!Q){d.value="Scope is required";return}if(!ie){d.value="Key is required";return}if(!X){d.value="Value is required";return}c.value=!0;try{await W.put(`/api/memory/${encodeURIComponent(Q)}/${encodeURIComponent(ie)}`,{value:X}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await R(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(fe){d.value=fe.message}c.value=!1}function L(Q,ie){y.value={scope:Q,key:ie}}async function U(){if(!y.value)return;g.value=!0,v.value=null;const{scope:Q,key:ie}=y.value;try{await W.del(`/api/memory/${encodeURIComponent(Q)}/${encodeURIComponent(ie)}`);const X=t.value[Q];X&&(t.value[Q]=X.filter(Y=>Y.key!==ie));const fe=e.value.find(Y=>Y.name===Q);fe&&(fe.count--,fe.keys=fe.keys.filter(Y=>Y!==ie));const Pe=new Set(O.value);Pe.delete(Q+"/"+ie),O.value=Pe}catch(X){v.value=`Failed to delete: ${X.message||"unknown error"}`}g.value=!1,y.value=null}function K(){b.value=!0}async function q(){g.value=!0,v.value=null;const Q=[];for(const ie of O.value){const X=ie.indexOf("/");Q.push({scope:ie.slice(0,X),key:ie.slice(X+1)})}try{await W.post("/api/memory/bulk-delete",{entries:Q}),O.value=new Set,t.value={},await R()}catch(ie){v.value=`Bulk delete failed: ${ie.message||"unknown error"}`}g.value=!1,b.value=!1}return We(()=>{R()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:h,saving:m,actionError:v,copied:T,selected:O,selectedCount:w,totalEntries:k,deleteTarget:y,deleting:g,showBulkDelete:b,fetchMemory:R,toggleScope:$,startEdit:V,doEdit:oe,copyValue:P,doAdd:N,confirmDelete:L,doDelete:U,confirmBulkDelete:K,doBulkDelete:q,isSelected:C,toggleSelect:_,isScopeAllSelected:D,toggleSelectAll:A,filteredEntries:E}}},Yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const me=new Blob([G],{type:"text/plain"}),Ne=URL.createObjectURL(me),Ve=document.createElement("a");Ve.href=Ne,Ve.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ve.click(),URL.revokeObjectURL(Ne)}function ne(G,me){const Ne=`${G.ts} ${G.level} ${G.text||G.raw||""}`;navigator.clipboard.writeText(Ne).then(()=>{p.value=me,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function he(G){a.value=a.value===G?"":G,O.value="all"}function de(G){return G.level==="ERROR"?"log-line-error":G.level==="WARNING"?"log-line-warning":"text-gray-300"}function pe(G){return G==="ERROR"?"text-red-500 font-semibold":G==="WARNING"?"text-yellow-500":"text-blue-500"}function le(G){return G==="ERROR"?"log-chip-error":G==="WARNING"?"log-chip-warning":"log-chip-info"}function ke(G){O.value=G.id;const me=G.filters;a.value=me.level||"",y.value=me.timeRange||"",i.value=me.text||"",me.levels&&(a.value=me.levels[0]||""),me.hasToolName&&(i.value="")}function ye(G){O.value=G.id,a.value=G.filters.level||"",y.value=G.filters.timeRange||"",i.value=G.filters.text||""}function _e(){if(!k.value.trim())return;const G={id:"custom-"+Date.now(),name:k.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};g.value=[...g.value,G],C(),b.value=!1,k.value=""}function ce(G){g.value=g.value.filter(me=>me.id!==G),C(),O.value===G&&(O.value="all")}const z=f("all"),ve=f(""),Te=f(""),Oe=f(""),De=f(""),ct=f(""),rt=f(100),Pt=lk,se=f(!1),we=f(!1),Ie=f(""),ze=f([]),it=f(null),qe=f(null);function _t(){e.value="search",it.value||Ot()}async function Ot(){try{it.value=await W.get("/api/logs/stats")}catch{}}function Es(){const G=ct.value;if(!G){Oe.value="",De.value="";return}const Ne={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[G];if(Ne){const Ve=new Date(Date.now()-Ne*1e3);Oe.value=$s(Ve),De.value=""}}function $s(G){const me=Ne=>String(Ne).padStart(2,"0");return`${G.getFullYear()}-${me(G.getMonth()+1)}-${me(G.getDate())}T${me(G.getHours())}:${me(G.getMinutes())}`}function Ut(G){if(!G)return"";const me=new Date(G);return isNaN(me.getTime())?"":me.toISOString()}async function ys(){se.value=!0,Ie.value="",we.value=!0,qe.value=null;try{const G=new URLSearchParams;z.value&&z.value!=="all"&&G.set("level",z.value),ve.value&&G.set("tool",ve.value),Te.value&&G.set("q",Te.value);const me=Ut(Oe.value),Ne=Ut(De.value);me&&G.set("start",me),Ne&&G.set("end",Ne),G.set("limit",String(rt.value));const Ve=await W.get(`/api/logs/search?${G.toString()}`);ze.value=Ve.entries||[]}catch(G){Ie.value=G.message||"Search failed",ze.value=[]}finally{se.value=!1}}function As(){z.value="all",ve.value="",Te.value="",Oe.value="",De.value="",ct.value="",rt.value=100,ze.value=[],we.value=!1,Ie.value="",qe.value=null}function Ks(G){qe.value=qe.value===G?null:G}function Nn(G){if(!G.timestamp)return"";try{return new Date(G.timestamp).toLocaleString()}catch{return G.timestamp}}function Us(G){return G.type==="web_action"?`${G.status||""} (${G.execution_time_ms||0}ms)`:(G.result_summary||"").slice(0,200)}function Ws(G){return G.error?"log-line-error":"text-gray-300"}function rn(G){try{return JSON.stringify(G,null,2)}catch{return String(G)}}let wt=null,Rs=!1;function Dn(){Rs||(Rs=!0,Ye.subscribe("logs",Q),r.value=Ye.connected,o.value=Ye.state||"disconnected",wt=Ye.onState(G=>{o.value=G,r.value=G==="connected"}))}function lt(){Rs&&(Rs=!1,Ye.unsubscribe("logs",Q),wt&&(wt(),wt=null))}return We(()=>{E(),window.addEventListener("pointerup",x),window.addEventListener("pointercancel",x)}),us(Dn),ts(lt),mt(()=>{lt(),window.removeEventListener("pointerup",x),window.removeEventListener("pointercancel",x)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:K,pauseBuffer:w,showJumpBottom:u,copiedIndex:p,regexError:A,levels:m,logPresets:v,timeRanges:T,timeRange:y,activeLogPreset:O,customLogPresets:g,showSaveLogPreset:b,newLogPresetName:k,hasActiveLogFilters:_,timeRangeLabel:D,timelineBuckets:$,timelineMax:V,timelineSpanLabel:oe,timelineLabelSkip:P,togglePause:B,clearLogs:ae,exportLogs:te,logLineClass:de,levelClass:pe,levelChipClass:le,toggleLevel:he,copyLine:ne,jumpToBottom:fe,onScroll:Y,onUserScrollIntent:H,onUserScrollKey:re,onAutoScrollToggle:M,onPointerDown:Le,applyLogPreset:ke,applyCustomLogPreset:ye,saveLogCustomPreset:_e,removeLogCustomPreset:ce,segmentHeight:L,jumpToTimelineBucket:U,searchLevel:z,searchTool:ve,searchKeyword:Te,searchStart:Oe,searchEnd:De,searchTimePreset:ct,searchLimit:rt,searchLimits:Pt,searching:se,searchRan:we,searchError:Ie,searchResults:ze,searchStats:it,expandedSearch:qe,switchToSearch:_t,runSearch:ys,clearSearchFilters:As,toggleSearchExpand:Ks,formatSearchTs:Nn,searchEntryText:Us,searchLogLineClass:Ws,formatJson:rn,applySearchTimePreset:Es}}};function El(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const ok=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function ck(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const r=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(r)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Za=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],dk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},po=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),uk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Gu(e){return uk.some(t=>e===t||e.startsWith(`${t}.`))}const Dm="odin_config_center_expanded_v1",Mm="odin_config_center_category_v1",pk=50,fk=650,fo=()=>W.get("/api/config/meta");function ia(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Pi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Oa(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function hk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function mk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Pm(e,t){if(Pi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ia(t);const n={};for(const[a,i]of Object.entries(t)){const l=Pm(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function vk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Pm(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Fm(e,t,s,n){if(Pi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Fm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function gk(){try{const e=JSON.parse(localStorage.getItem(Dm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function bk(){try{const e=localStorage.getItem(Mm);return Za.some(t=>t.key===e)?e:Za[0].key}catch{return Za[0].key}}const yk={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),n=f(null),a=f(!1),i=f(null),l=f(null),r=f(null),o=f(!1),c=f(!1),d=f(null),u=f(""),p=f("all"),h=f(bk()),m=f(gk()),v=f({}),T=f({}),O=f(""),y=f({}),g=f({}),b=f([]),k=f([]),w=f(!1),E=f(!1),C=f(!1);let _=null,D=null,A={path:null,at:0},R=0;const $=J(()=>{var S;return(((S=t.value)==null?void 0:S.fields)||[]).filter(F=>!po.has(F.path.split(".")[0])&&!Gu(F.path))}),V=J(()=>new Map($.value.map(S=>[S.path,S]))),oe=J(()=>K.value.reduce((S,F)=>S+F.sections.length,0)),P=J(()=>$.value.length),N=J(()=>ok),L=J(()=>b.value.length>0),U=J(()=>k.value.length>0),K=J(()=>{if(!e.value)return[];const S=new Set(Za.flatMap(xe=>xe.sections)),F=Za.map(xe=>({...xe,sections:xe.sections.filter(Qe=>Object.hasOwn(e.value,Qe)&&!po.has(Qe))})).filter(xe=>xe.sections.length),Z=Object.keys(e.value).filter(xe=>!S.has(xe)&&!po.has(xe));return Z.length&&F.push({key:"other",label:"Other",icon:"folder",sections:Z}),F}),q=J(()=>e.value?{...e.value,...v.value}:null),Q=J(()=>{if(!e.value)return[];const S=[];for(const[F,Z]of Object.entries(v.value))Fm(e.value[F],Z,F,S);return S.filter(F=>!Pi(F.oldVal,F.newVal)).map(F=>{const Z=M(F.path);return{...F,label:(Z==null?void 0:Z.label)||Oa(F.path.split(".").at(-1)),apply_mode:(Z==null?void 0:Z.apply_mode)||he(F.path.split(".")[0])}})}),ie=J(()=>Q.value.length>0),X=J(()=>Q.value.length),fe=J(()=>new Set(Q.value.map(S=>S.path.split(".")[0])).size),Pe=J(()=>!!u.value||p.value!=="all"),Y=J(()=>{const S={...g.value};for(const F of Q.value){const Z=M(F.path),xe=Ta(Z,F.newVal);xe&&(S[F.path]=xe)}return S}),be=J(()=>Object.keys(Y.value).length>0),H=J(()=>e.value?(Pe.value?K.value:K.value.filter(F=>F.key===h.value)).map(F=>({...F,sections:F.sections.filter(Z=>se(Z))})).filter(F=>F.sections.length):[]),re=J(()=>{const S=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],F=new Map(S.map(Z=>[Z,[]]));for(const Z of Q.value){const xe=F.has(Z.apply_mode)?Z.apply_mode:"restart";F.get(xe).push(Z)}return S.filter(Z=>F.get(Z).length).map(Z=>({key:Z,label:xs(Z),entries:F.get(Z)}))}),ue=J(()=>Q.value.filter(S=>S.apply_mode==="restart").length),Le=J(()=>$.value.filter(S=>S.pending_restart)),x=J(()=>Le.value.length);function M(S){const F=V.value.get(S);return F?{...F,apply_details:El([F])}:null}function B(S){const F=`${S}.`;return $.value.filter(Z=>Z.path===S||Z.path.startsWith(F))}function ae(S){return B(S).length}function te(S){return Oa(S)}function ne(S){const F=B(S);if(!F.length)return`${Oa(S)} configuration.`;const Z=F.find(Gt=>Gt.sensitivity==="public"&&Gt.description)||F.find(Gt=>Gt.description),xe=(Z==null?void 0:Z.description)||"";return xe.match(/setting for (.+)\.$/i)?`${Oa(S)} settings and runtime behaviour.`:xe}function he(S){const F=[...new Set(B(S).map(Z=>Z.apply_mode))];return F.length===1?F[0]:F.includes("restart")?"restart":F.includes("activation_required")?"activation_required":F[0]||"restart"}function de(S){const F=[...new Set(B(S).map(Z=>xs(Z.apply_mode)))];return F.length?F.length===1?F[0]:`Mixed apply behaviour: ${F.join(" · ")}`:""}function pe(S){return El(B(S))}function le(S){var F;return Object.hasOwn(v.value,S)?v.value[S]:(F=e.value)==null?void 0:F[S]}function ke(){const S=le("mcp")||{},F=Object.keys(S.servers||{}).length;return`${S.enabled?"Globally enabled":"Globally disabled"} · ${F} configured server${F===1?"":"s"}.`}function ye(S,F){return F.split(".").reduce((Z,xe)=>Z==null?void 0:Z[xe],S)}function _e(S){const F=q.value;return B(S).filter(Z=>Gu(Z.path)?!1:Z.path.split(".").length<=2?!0:!Z.path.includes(".*")).map(Z=>({...Z,key:Z.path.split(".").at(-1),value:ye(F,Z.path),apply_details:El([Z]),editor:Z.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ce(S){const F=S.path.split(".");return F.length>2?F.slice(0,2).join("."):null}function z(S){const F=new Map;for(const Z of _e(S)){const xe=ce(Z),Qe=xe||`${S}.__root`;F.has(Qe)||F.set(Qe,{key:Qe,path:xe,entries:[]}),F.get(Qe).entries.push(Z)}return[...F.values()].map(Z=>{const xe=Z.entries.find(Qe=>Qe.group_description);return{...Z,label:Z.path?Oa(Z.path.split(".").at(-1)):null,description:(xe==null?void 0:xe.group_description)||null,apply_details:El(Z.entries),runtime_summaries:Te(Z.entries)}})}function ve(S){return{save:S.save_effect||(S.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:S.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[S.apply_mode]||"Effective runtime state is not currently observable."}}function Te(S){const F=new Map;for(const Z of S){const xe=ve(Z),Qe=`${Z.apply_mode}|${xe.save}|${xe.runtime}`;F.has(Qe)||F.set(Qe,{key:Qe,label:xs(Z.apply_mode),save:xe.save,runtime:xe.runtime})}return[...F.values()]}function Oe(S){if(De(S))return S.runtime_effect||S.activation_policy||"";if(S.apply_mode==="activation_required"){const F=S.activation_policy||S.runtime_effect;return F?`Not active after saving. No activation control exists in this release. ${F}`:"Not active after saving; no activation control exists in this release."}return""}function De(S){return S.action_available===!0&&!!(S.action_label&&S.action_endpoint)}async function ct(S){if(De(S))try{if(qe(S.path))throw new Error("Save this setting before applying its action.");const F=String(S.action_method||"POST").toLowerCase(),Z={post:W.post.bind(W),put:W.put.bind(W),delete:W.del.bind(W)}[F];if(!Z)throw new Error("Unsupported configuration action");await Z(S.action_endpoint,S.action_body||void 0),await ee(),Ce("success",`${S.action_label} completed.`)}catch(F){Ce("error",F.message||`${S.action_label} failed`)}}function rt(S,F){return[S.label,S.path,S.description,...S.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(F)}function Pt(S){const F=u.value.trim().toLowerCase();return F?B(S).filter(Z=>rt(Z,F)):[]}function se(S){const F=B(S);if(p.value!=="all"&&!F.some(xe=>xe.apply_state===p.value))return!1;const Z=u.value.trim().toLowerCase();return!Z||`${te(S)} ${S}`.toLowerCase().includes(Z)?!0:F.some(xe=>rt(xe,Z))}function we(S,F){return B(S).filter(Z=>Z.apply_state===F).length}function Ie(S){return S==="all"?P.value:$.value.filter(F=>F.apply_state===S).length}function ze(S){const F=S.sections.flatMap(Z=>B(Z));return{fields:F.length,modified:Q.value.filter(Z=>S.sections.includes(Z.path.split(".")[0])).length,pending_restart:F.filter(Z=>Z.apply_state==="pending_restart").length,invalid:F.filter(Z=>Z.apply_state==="invalid").length,dormant:F.filter(Z=>Z.apply_state==="dormant").length}}function it(S){var F;return Object.hasOwn(v.value,S)&&!Pi((F=e.value)==null?void 0:F[S],v.value[S])}function qe(S){return Q.value.some(F=>F.path===S||F.path.startsWith(`${S}.`))}function _t(S){h.value=S,u.value="",p.value="all";try{localStorage.setItem(Mm,S)}catch{}}function Ot(S){p.value=S}function Es(){u.value="",p.value="all"}function $s(S){var F;return((F=K.value.find(Z=>Z.sections.includes(S)))==null?void 0:F.sections)||[]}function Ut(S){const F=$s(S),Z=F.find(xe=>m.value[xe]===!0);return Z||F.find(xe=>m.value[xe]!==!1)||null}function ys(S){return u.value&&!C.value&&se(S)?!0:C.value?Ut(S)===S:Object.hasOwn(m.value,S)?m.value[S]===!0:!0}function As(S){const F=!ys(S);if(C.value){const Z={...m.value};for(const xe of $s(S))Z[xe]===!0&&(Z[xe]=!1);Z[S]=F,m.value=Z;return}m.value={...m.value,[S]:F}}function Ks(){b.value.push(ia(v.value)),b.value.length>pk&&b.value.shift(),k.value=[]}function Nn(){ie.value&&(Ks(),v.value={},g.value={},w.value=!1)}function Us(S,F=!1){const Z=Date.now();if(F&&A.path===S&&Z-A.at<fk){A.at=Z;return}Ks(),A={path:S,at:Z}}function Ws(S,F,Z){if(!F.length)return Z;const xe=ia(S??{});let Qe=xe;for(let Gt=0;Gt<F.length-1;Gt+=1){const cn=F[Gt];Qe[cn]=ia(Qe[cn]??{}),Qe=Qe[cn]}return Qe[F.at(-1)]=Z,xe}function rn(S){var F;return Object.hasOwn(v.value,S)?v.value[S]:ia((F=e.value)==null?void 0:F[S])}function wt(S,F,Z={}){var fd;const[xe,...Qe]=S.path.split(".");Us(S.path,!!Z.coalesce);const Gt=rn(xe),cn=Qe.length?Ws(Gt,Qe,F):F,ea={...v.value};if(Pi(cn,(fd=e.value)==null?void 0:fd[xe])?delete ea[xe]:ea[xe]=cn,v.value=ea,g.value[S.path]){const hd={...g.value};delete hd[S.path],g.value=hd}}function Rs(S){A={path:null,at:0},T.value={...T.value,[S]:String(ye(q.value,S)??"")}}function Dn(S){if(A={path:null,at:0},!Object.hasOwn(T.value,S))return;const F={...T.value};delete F[S],T.value=F}function lt(S){const F=T.value[S.path];if(A={path:null,at:0},F===""){g.value={...g.value,[S.path]:"Enter a number."};return}const Z=Number(F);if(Number.isNaN(Z)||S.type==="integer"&&!Number.isInteger(Z)){g.value={...g.value,[S.path]:S.type==="integer"?"Enter a whole number.":"Enter a number."};return}const xe={...T.value};delete xe[S.path],T.value=xe,wt(S,Z,{coalesce:!0})}function G(S){return Object.hasOwn(T.value,S.path)?T.value[S.path]:S.value??""}function me(S,F){if(T.value={...T.value,[S.path]:F},F===""){g.value={...g.value,[S.path]:"Enter a number."};return}const Z=Number(F);if(!Number.isFinite(Z)||S.type==="integer"&&!Number.isInteger(Z)){g.value={...g.value,[S.path]:S.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[S.path]){const xe={...g.value};delete xe[S.path],g.value=xe}wt(S,Z,{coalesce:!0})}function Ne(S){const F=Number.parseInt(O.value,10);if(!Number.isInteger(F)||F<1){g.value={...g.value,[S.path]:"Warning thresholds must be positive whole numbers."};return}const Z=[...new Set([...S.value||[],F])].sort((xe,Qe)=>Qe-xe);O.value="",wt(S,Z)}function Ve(S,F){wt(S,(S.value||[]).filter(Z=>Z!==F))}function dt(S){return S.apply_mode==="live_read"?"Odin reads the saved file value on next use.":S.apply_mode==="live_for_new_work"?"New work uses the saved file value.":S.apply_mode==="live_apply"?S.apply_handler?`Apply the saved value through ${S.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":S.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":S.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":S.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function Lt(S){return S.type==="array"&&Array.isArray(S.value)&&!S.structured_container&&!S.structured_container_child&&S.sensitivity==="public"&&S.value.every(F=>["string","number","boolean"].includes(typeof F))}function Jn(S){const F=String(y.value[S.path]??"").trim();if(!F)return;const Z=[...new Set([...S.value||[],F])];y.value={...y.value,[S.path]:""},wt(S,Z)}function ss(S,F){wt(S,(S.value||[]).filter(Z=>Z!==F))}function Ta(S,F){var xe;if(!S)return null;if((xe=S.enum)!=null&&xe.length&&!S.enum.includes(F))return`Choose one of: ${S.enum.join(", ")}`;if(S.path==="agents.final_warning_iterations"&&(!Array.isArray(F)||!F.length))return"Add at least one warning threshold.";const Z=S.constraints||{};if((S.type==="integer"||S.type==="number")&&typeof F=="number"){if(Z.minimum!==void 0&&F<Z.minimum)return`Must be at least ${Z.minimum}${S.unit?` ${S.unit}`:""}`;if(Z.maximum!==void 0&&F>Z.maximum)return`Must be at most ${Z.maximum}${S.unit?` ${S.unit}`:""}`}return null}function Bs(S){return Y.value[S.path]||null}function ui(S){const F=`${S}.`;return Object.keys(Y.value).some(Z=>Z===S||Z.startsWith(F))}function Ca(){b.value.length&&(k.value.push(ia(v.value)),v.value=b.value.pop(),g.value={},T.value={},A={path:null,at:0})}function Yn(){k.value.length&&(b.value.push(ia(v.value)),v.value=k.value.pop(),g.value={},T.value={},A={path:null,at:0})}function Ea(){!ie.value||be.value||(w.value=!0,E.value=!1)}function Qn(){w.value=!1}function Mn(){Nn()}function xs(S){return dk[S]||Oa(S||"unknown")}function on(S){return`apply-${String(S||"unknown").replaceAll("_","-")}`}function qt(S){return`cfgc-field-${S.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function j(S){return`${qt(S)}-input`}function Se(S){const F=document.getElementById(qt(S))||document.getElementById(qt(S.split(".").slice(0,2).join(".")));F==null||F.scrollIntoView({behavior:"smooth",block:"center"})}function Ce(S,F){l.value={type:S,message:F},window.setTimeout(()=>{var Z;((Z=l.value)==null?void 0:Z.message)===F&&(l.value=null)},3500)}function Hs(){o.value=!1,p.value="pending_restart",u.value="";const S=ck(n.value);S&&(S.scrollTop=0)}function Xn(){o.value=!1}function Zs(S=1800){D&&window.clearTimeout(D),D=window.setTimeout(pi,S)}async function pi(){if(c.value){if(R+=1,R>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await fo(),x.value===0){c.value=!1,d.value=null,Ce("success","Odin restarted and the saved startup settings are active.");return}}catch{}Zs(2e3)}}async function Ee(){if(!c.value){d.value=null;try{await W.post("/api/restart",{}),c.value=!0,R=0,o.value=!1,Zs()}catch(S){d.value=S.message||"Odin could not schedule a restart."}}}async function I(){if(!(!ie.value||be.value||a.value)){a.value=!0;try{const S=vk(e.value,v.value),F=await W.put("/api/config",S);e.value=F,v.value={},b.value=[],k.value=[],g.value={},w.value=!1;try{t.value=await fo(),r.value=null,o.value=x.value>0,Ce("success",x.value?`Configuration saved. ${x.value} setting${x.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(Z){r.value=Z.message||"Unknown metadata error.",Ce("error",`Configuration saved, but apply status could not be refreshed: ${r.value}`)}}catch(S){Ce("error",S.message||"Configuration could not be saved")}finally{a.value=!1}}}async function ee(){var S,F;if(!ie.value){s.value=!0,i.value=null;try{const Z=await W.get("/api/config"),xe=await fo();e.value=Z,t.value=xe,r.value=null;const Qe=K.value;if(Qe.some(Gt=>Gt.key===h.value)||(h.value=((S=Qe[0])==null?void 0:S.key)||Za[0].key),C.value){const cn=(((F=Qe.find(ea=>ea.key===h.value))==null?void 0:F.sections)||[]).find(ea=>m.value[ea]===!0);m.value=cn?{...m.value,[cn]:!0}:{}}}catch(Z){i.value=Z.message||"Unknown configuration error"}finally{s.value=!1}}}function ge(S){if(w.value||!(S.ctrlKey||S.metaKey))return;const F=S.target;F instanceof HTMLElement&&(F.matches("input, textarea, select")||F.isContentEditable)||(!S.shiftKey&&S.key.toLowerCase()==="z"?(S.preventDefault(),Ca()):(S.key.toLowerCase()==="y"||S.shiftKey&&S.key.toLowerCase()==="z")&&(S.preventDefault(),Yn()))}function Me(S){C.value=S.matches}os(m,S=>{try{localStorage.setItem(Dm,JSON.stringify(S))}catch{}},{deep:!0});let $e=!1;function Be(){$e||($e=!0,document.addEventListener("keydown",ge))}function gt(){$e&&($e=!1,document.removeEventListener("keydown",ge))}return We(()=>{var S;ee(),Be(),_=window.matchMedia("(max-width: 760px)"),Me(_),(S=_.addEventListener)==null||S.call(_,"change",Me)}),us(Be),ts(gt),mt(()=>{var S;gt(),(S=_==null?void 0:_.removeEventListener)==null||S.call(_,"change",Me),D&&window.clearTimeout(D)}),{armKeydown:Be,disarmKeydown:gt,handleKeydown:ge,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:r,restartPromptOpen:o,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:h,reviewOpen:w,mobileOverflowOpen:E,warningThresholdInput:O,arrayInputs:y,healthFilters:N,visibleCategories:K,displayGroups:H,reviewGroups:re,sectionCount:oe,fieldCount:P,hasChanges:ie,changeCount:X,changedSectionCount:fe,hasDraftErrors:be,canUndo:L,canRedo:U,globalFilterActive:Pe,reviewRestartCount:ue,pendingRestartCount:x,pendingRestartFields:Le,healthCount:Ie,categoryStats:ze,selectCategory:_t,selectHealthFilter:Ot,clearFilters:Es,sectionLabel:te,sectionDescription:ne,sectionFieldCount:ae,sectionHealthCount:we,sectionApplySummary:de,sectionApplyDetails:pe,sectionEntries:_e,fieldGroups:z,sectionSearchHits:Pt,mcpConfigSummary:ke,fieldRuntimeCopy:ve,fieldSpecificRuntimeNote:Oe,hasHonestAction:De,runFieldAction:ct,sectionChanged:it,fieldChanged:qe,isSectionExpanded:ys,toggleSection:As,discardAllDrafts:Nn,setFieldValue:wt,setNumberFieldValue:me,numberInputValue:G,beginInputEdit:Rs,endTextInputEdit:Dn,endInputEdit:lt,addWarningThreshold:Ne,removeWarningThreshold:Ve,isScalarArray:Lt,addScalarArrayItem:Jn,removeScalarArrayItem:ss,fieldError:Bs,sectionHasErrors:ui,undo:Ca,redo:Yn,openReview:Ea,closeReview:Qn,mobileCancel:Mn,applyModeLabel:xs,applyClass:on,compactValue:hk,formatValue:mk,structuredApplyCopy:dt,fieldId:qt,fieldInputId:j,focusField:Se,fetchConfig:ee,saveConfig:I,restartOdin:Ee,restartLater:Xn,reviewPendingRestart:Hs}}},xk=/^\d{15,25}$/;function $m(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Um={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),n=f(!1),a=f(0),i=f(null),l=J(()=>new Set((e.excludedIds||[]).map(String))),r=J(()=>{const k=s.value.toLowerCase().trim();return(e.members||[]).filter(w=>l.value.has(String(w.id))?!1:k?u(w).toLowerCase().includes(k)||String(w.username||"").toLowerCase().includes(k)||String(w.id).includes(k):!0)}),o=J(()=>{const k=s.value.trim();return r.value.length===0&&xk.test(k)&&!l.value.has(k)?k:""}),c=J(()=>r.value.length+(o.value?1:0)),d=J(()=>{if(n.value){if(r.value[a.value])return`${e.optionsId}-${a.value}`;if(o.value&&a.value===r.value.length)return`${e.optionsId}-raw`}});function u(k){return $m(k)}function p(){n.value=!0,a.value=0}function h(){p()}function m(){const k=Math.max(c.value-1,0);a.value=Math.min(a.value+1,k)}function v(){a.value=Math.max(a.value-1,0)}function T(){const k=r.value[a.value];k?O(k):o.value&&a.value===r.value.length&&y(o.value)}function O(k){y(String(k.id))}function y(k){t("select",k),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function b(){setTimeout(g,150)}return We(()=>{e.autofocus&&Et(()=>{var k;return(k=i.value)==null?void 0:k.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:r,rawId:o,activeOptionId:d,memberName:u,openOptions:p,onInput:h,highlightNext:m,highlightPrevious:v,selectHighlighted:T,selectMember:O,selectId:y,closeOptions:g,onBlur:b}}};function Ku(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const _k={components:{DiscordUserCombobox:Um},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f(!0),s=f(null),n=f({}),a=f(null),i=f(null),l=f(!1),r=f(null),o=f({}),c=f([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=J(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),h=J(()=>new Map(c.value.map(P=>[String(P.id),P])));function m(P){return P.config&&P.config.enabled!==void 0?P.config.enabled:!0}function v(P){return Ku(P,"require_mention",a.value)}function T(P){return Ku(P,"respond_to_bots",a.value)}function O(P){return P.config&&Object.keys(P.config).length>0}function y(P){n.value[P]=!n.value[P]}function g(P){const N=P.discord||{};return{allowed_users:[...N.allowed_users||[]],channels:[...N.channels||[]],respond_to_bots:!!N.respond_to_bots,require_mention:!!N.require_mention,ignore_bot_ids:[...N.ignore_bot_ids||[]]}}async function b({showLoading:P=!0}={}){const N=++d;P&&(t.value=!0),s.value=null;try{const L=await W.get("/api/discord/guilds");N===d&&(e.value=L)}catch(L){N===d&&(s.value=L.message)}finally{P&&N===d&&(t.value=!1)}}async function k(){t.value=!0,s.value=null;try{const[P,N,L]=await Promise.all([W.get("/api/discord/guilds"),W.get("/api/discord/members").catch(()=>[]),W.get("/api/config")]),U=g(L),K=p.value;a.value=U,K||(i.value=JSON.parse(JSON.stringify(U))),c.value=N,e.value=P,r.value=null}catch(P){s.value=P.message}finally{t.value=!1}}let w=Promise.resolve();const E=f(new Set);function C(P,N){const L=new Set(E.value);L.add(P),E.value=L;const U=w.then(N);return w=U.catch(()=>{}),U.finally(()=>{const K=new Set(E.value);K.delete(P),E.value=K})}function _(P,N,L,U){const K=(U==null?void 0:U.target)??null;return C(`guild:${P}:${N}`,async()=>{try{await W.put("/api/discord/guild/"+P+"/config",{[N]:L}),await b({showLoading:!1})}catch(q){s.value=q.message,K&&typeof L=="boolean"&&(K.checked=!L)}})}function D(P,N,L,U,K){const q=(K==null?void 0:K.target)??null;return C(`channel:${P}:${L}`,async()=>{try{await W.put("/api/discord/channel/"+P+"/config",{[L]:U}),await b({showLoading:!1})}catch(Q){s.value=Q.message,q&&typeof U=="boolean"&&(q.checked=!U)}})}function A(P,N){return C(`channel:${P}:clear`,async()=>{try{await W.put("/api/discord/channel/"+P+"/config",{clear:!0}),await b({showLoading:!1})}catch(L){s.value=L.message}})}function R(P,N){const L=String(N);if(!P.userAutocomplete)return L;const U=h.value.get(L);return U?$m(U):L}function $(P,N=null){const L=String(N??o.value[P]??"").trim();!L||i.value[P].includes(L)||(i.value[P]=[...i.value[P],L],o.value={...o.value,[P]:""})}function V(P,N){i.value[P]=i.value[P].filter(L=>L!==N)}async function oe(){if(!(!p.value||l.value)){l.value=!0,r.value=null;try{const N=(await W.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...N.allowed_users||[]],channels:[...N.channels||[]],respond_to_bots:!!N.respond_to_bots,require_mention:!!N.require_mention,ignore_bot_ids:[...N.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(P){r.value=P.message||"Global defaults could not be saved."}finally{l.value=!1}}}return We(k),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:r,globalArrayInputs:o,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:T,hasOverride:O,toggleGuild:y,fetchAll:k,fetchGuilds:b,setGuildConfig:_,setChannelConfig:D,clearOverride:A,mutationPending:E,globalItemLabel:R,addGlobalItem:$,removeGlobalItem:V,saveGlobalDefaults:oe}}},_s=e=>e==null?e:JSON.parse(JSON.stringify(e));function wk({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:r=()=>{},onError:o=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let h=null;const m=new Map;function v(w){d+=1;const E=c.then(w,w);return c=E.catch(()=>{}),E}function T(w,E){h=_s(w),m.clear();for(const[C,_]of Object.entries(E||{}))m.set(C,_s(_))}function O(w){const E=_s(w),C=++u;return v(async()=>{try{await e(_s(E)),h=_s(E),C===u&&n(_s(E))}catch(_){C===u&&(a(_s(h)),o(_,{kind:"default"}))}})}function y(w,E){const C=_s(E),_=(p.get(w)||0)+1;return p.set(w,_),v(async()=>{try{await t(w,_s(C)),m.set(w,_s(C)),_===p.get(w)&&i(w,_s(C))}catch(D){_===p.get(w)&&(l(w,_s(m.get(w)??null)),o(D,{kind:"user",uid:w}))}})}function g(w){const E=(p.get(w)||0)+1;return p.set(w,E),v(async()=>{try{await s(w),m.delete(w),E===p.get(w)&&r(w)}catch(C){E===p.get(w)&&(l(w,_s(m.get(w)??null)),o(C,{kind:"delete",uid:w}))}})}async function b(){for(;;){const w=c;if(await w,w===c)return d}}async function k(w){for(;;){const E=await b(),C=await w();if(E===d)return C}}return{seed:T,saveDefault:O,saveUser:y,deleteUser:g,whenIdle:b,readSnapshot:k,get revision(){return d}}}const kk={components:{DiscordUserCombobox:Um},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f({}),s=f([]),n=f({}),a=f({}),i=f(null),l=f(null),r=f(null),o=f(null),c=f(null),d=J(()=>{var w;return Object.values(((w=i.value)==null?void 0:w.totals)||{}).reduce((E,C)=>E+Number(C||0),0)}),u=f(""),p=f(0),h=f([]),m=J(()=>h.value.map(w=>`${w.label} (${w.path}${w.reason?`: ${w.reason}`:""})`).join("; ")),v=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let T=null;async function O(){var D;const w=await Promise.allSettled(v.map(A=>W.get(A.path))),E=A=>w[A].status==="fulfilled"?w[A].value:null;t.value=E(0)||{};const C=E(1);s.value=Array.isArray(C)?C:C&&C.subsystems||[],n.value=E(2)||{},a.value=E(3)||{},i.value=E(4),l.value=E(5),r.value=E(6),o.value=E(7),c.value=E(8);const _=w.filter(A=>A.status==="rejected");if(h.value=w.flatMap((A,R)=>{var $;return A.status==="rejected"?[{...v[R],reason:(($=A.reason)==null?void 0:$.message)||"request failed"}]:[]}),p.value=h.value.length,_.length===w.length){const A=(D=_[0])==null?void 0:D.reason;u.value=(A==null?void 0:A.message)||"Failed to load internals"}else u.value="";e.value=!1}function y(){e.value=!0,u.value="",O()}let g=!1;function b(){g||(g=!0,O(),T||(T=setInterval(O,3e4)))}function k(){g&&(g=!1,T&&(clearInterval(T),T=null))}return We(b),us(b),ts(k),mt(k),{loading:e,error:u,failedCount:p,failedEndpoints:h,failedEndpointSummary:m,endpoints:v,retry:y,startup:t,subsystems:s,sshPool:n,httpPool:a,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:r,freshnessStats:o,governorStats:c,statusColor:Dk,formatAgeSeconds:dw}}},Pk=1e4,Yu=3e4;function yi(e,t){return Math.max(0,e-t)}function ho(e,t){const s=new Set((e.operations||[]).map(n=>n.state));return s.has("OUTCOME_UNKNOWN")?0:s.has("MANUAL_RESOLUTION_REQUIRED")?1:e.status==="ACTIVE"&&e.lease_expires_at&&e.lease_expires_at<t?2:e.status==="SUSPENDED"?3:e.status==="ACTIVE"?4:5}const Fk=[{label:"Outcome unknown",cls:"badge-danger"},{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],$k={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(null),t=f(""),s=f(null),n=f(!1),a=f(0),i=f(null),l=f(""),r=f(null),o=f(!1),c=f(0),d=f(Date.now());let u=null,p=0,h=0;async function m(){const N=++p;n.value=!0;try{const L=await W.get("/api/turn-state/turns?limit=100");if(N!==p)return;t.value=L.availability,e.value=L.availability==="available"?L.data:null,s.value=null,a.value=Date.now()}catch(L){if(N!==p)return;s.value=L.message||"Turn-state read failed",L.status===503&&(t.value="unavailable")}N===p&&(n.value=!1)}async function v(){const N=++h;o.value=!0;try{const L=await W.get("/api/turn-state/capacity-breakers");if(N!==h)return;l.value=L.availability,i.value=L.availability==="available"?L.data:null,r.value=null,c.value=Date.now()}catch(L){if(N!==h)return;r.value=L.message||"Breaker read failed",L.status===503&&(l.value="unavailable")}N===h&&(o.value=!1)}function T(){m(),v()}const O=J(()=>e.value!==null&&yi(d.value,a.value)>Yu),y=J(()=>i.value!==null&&yi(d.value,c.value)>Yu),g=J(()=>O.value||y.value),b=J(()=>Math.round(yi(d.value,a.value)/1e3)),k=J(()=>Math.round(yi(d.value,c.value)/1e3));function w(N){return ho(N,d.value/1e3)}function E(N){return Fk[w(N)]}const C=J(()=>{var U;const N=[...((U=e.value)==null?void 0:U.turns)||[]],L=d.value/1e3;return N.sort((K,q)=>ho(K,L)-ho(q,L)||(q.last_progress_at||0)-(K.last_progress_at||0))});function _(N){return N.state==="closed"?"badge-success":N.state==="probing"?"badge-warning":"badge-danger"}function D(N){if(N.state==="closed")return"—";const L=yi(d.value,c.value)/1e3,U=Math.max(0,(N.cooldown_remaining_seconds||0)-L);return U>0?`${Math.ceil(U)}s`:N.state==="probing"?"probe in flight":"probe eligible"}function A(N){if(!N)return"";const L=Math.max(0,Math.round(d.value/1e3-N));if(L<90)return`${L}s ago`;const U=Math.round(L/60);return U<90?`${U}m ago`:`${Math.round(U/60)}h ago`}let R=null,$=null,V=!1;function oe(){V||(V=!0,T(),R=setInterval(T,Pk),u=setInterval(()=>{d.value=Date.now()},1e3),$=Ye.onReconnected(T))}function P(){V&&(V=!1,R&&(clearInterval(R),R=null),u&&(clearInterval(u),u=null),$&&($(),$=null))}return We(oe),us(oe),ts(P),mt(P),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:r,breakersLoading:o,turnsStale:O,breakersStale:y,anyStale:g,turnsAgeSeconds:b,breakersAgeSeconds:k,sortedTurns:C,priorityOf:w,priorityBadge:E,breakerBadge:_,cooldownLabel:D,ageLabel:A,fetchTurns:m,fetchBreakers:v,refreshAll:T,arm:oe,disarm:P}}},Uk={setup(){const e=f(""),t=f(""),s=f(!1),n=f(""),a=f(!1),i=f(!1),l=f(!1),r=f(null),o=f(!1);async function c(){a.value=!0,r.value=null,o.value=!1;try{const u=await W.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(r.value=u.error),o.value=!0}catch(u){r.value=u.message}finally{a.value=!1}}async function d(){if(await Xt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,r.value=null;try{await W.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){r.value=p.message}finally{i.value=!1}}}return We(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:r,checkDone:o,checkUpdate:c,applyUpdate:d}},template:`
...
`,e=e.substring(p.length+1),o=!0),!o){const O=this.rules.other.nextBulletRegex(m),y=this.rules.other.hrRegex(m),g=this.rules.other.fencesBeginRegex(m),b=this.rules.other.headingBeginRegex(m),k=this.rules.other.htmlBeginRegex(m);for(;e;){const w=e.split(`
`,1)[0];let E;if(p=w,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),E=p):E=p.replace(this.rules.other.tabCharGlobal,"    "),g.test(p)||b.test(p)||k.test(p)||O.test(p)||y.test(p))break;if(E.search(this.rules.other.nonSpaceChar)>=m||!p.trim())d+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Xs(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ba=new i1;function st(e,t){return ba.parse(e,t)}st.options=st.setOptions=function(e){return ba.setOptions(e),st.defaults=ba.defaults,Vm(st.defaults),st};st.getDefaults=ad;st.defaults=Sa;st.use=function(...e){return ba.use(...e),st.defaults=ba.defaults,Vm(st.defaults),st};st.walkTokens=function(e,t){return ba.walkTokens(e,t)};st.parseInline=ba.parseInline;st.Parser=wn;st.parser=wn.parse;st.Renderer=hr;st.TextRenderer=pd;st.Lexer=_n;st.lexer=_n.lex;st.Tokenizer=fr;st.Hooks=$l;st.parse=st;st.options;st.setOptions;st.use;st.walkTokens;st.parseInline;wn.parse;_n.lex;const l1={breaks:!0,gfm:!0};function yp(e){if(!e)return"";try{if(typeof st<"u"&&st.parse){const t=st.parse(e,l1);return typeof fp<"u"?fp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function r1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const o1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function c1(e){return o1[e]||"wrench"}const d1=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function xp(e){if(!e)return[];const t=e.match(d1);return t?[...new Set(t)]:[]}const u1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),n=f(""),a=f(null),i=f(null),l=f(0),r=f("");let o=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=J(()=>t.value.trim().length>0&&!s.value),p=f(Ye.state||"disconnected");let h=null;const m=J(()=>{const P=p.value;return P==="connected"?"Connected":P==="reconnecting"?"Reconnecting…":P==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],T=J(()=>{const P=Math.floor(l.value/4)%v.length,N=l.value;return N>3?`${v[P]} (${N}s)`:v[0]});function O(){Et(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function y(){if(!i.value)return;const P=i.value;P.style.height="auto",P.style.height=Math.min(P.scrollHeight,120)+"px"}function g(P,N,L={}){const U={id:++c,role:P,content:N,timestamp:Date.now(),html:P==="bot"?yp(N):"",tools_used:L.tools_used||[],is_error:L.is_error||!1,images:P==="bot"?xp(N):[],files:L.files||[],_showTools:!1};return e.value.push(U),O(),P==="bot"&&Et(()=>b()),U}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(N=>{N.setAttribute("data-copy","true"),N.style.position="relative";const L=document.createElement("button");L.className="chat-code-copy",L.textContent="Copy",L.addEventListener("click",()=>{const U=N.querySelector("code"),K=U?U.textContent:N.textContent;navigator.clipboard.writeText(K).then(()=>{L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},1500)}).catch(()=>{})}),N.appendChild(L)})}function k(P){if(P===0)return!0;const N=e.value[P-1],L=e.value[P],U=new Date(N.timestamp).toDateString(),K=new Date(L.timestamp).toDateString();return U!==K}function w(P){const N=new Date(P),L=new Date;if(N.toDateString()===L.toDateString())return"Today";const U=new Date(L);return U.setDate(U.getDate()-1),N.toDateString()===U.toDateString()?"Yesterday":N.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function E(P){t.value=P,Et(()=>V())}function C(P){window.open(P,"_blank","noopener")}function _(P){P.target.style.display="none"}function D(){l.value=0,o=setInterval(()=>{l.value++},1e3)}function A(){o&&(clearInterval(o),o=null),l.value=0}function R(P){s.value&&(s.value=!1,A(),P.type==="chat_response"?g("bot",P.content,{tools_used:P.tools_used||[],is_error:P.is_error||!1,files:P.files||[]}):P.type==="chat_error"&&g("bot",P.error||"Unknown error",{is_error:!0}),Et(()=>{var N;return(N=i.value)==null?void 0:N.focus()}))}async function $(P){try{const N=await W.post("/api/chat",{content:P,channel_id:r.value});g("bot",N.response,{tools_used:N.tools_used||[],is_error:N.is_error||!1,files:N.files||[]})}catch(N){g("bot",N.message||"Failed to send message",{is_error:!0})}}async function V(){const P=t.value.trim();if(!P||s.value)return;g("user",P),t.value="",s.value=!0,D(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(P,{channelId:r.value})||(await $(P),s.value=!1,A()),Et(()=>{var L;return(L=i.value)==null?void 0:L.focus()})}async function oe(){n.value="";try{if(!r.value){const N=await W.get("/api/auth/session");r.value=N.channel_id||N.user_id||"web-user"}const P=await W.get("/api/sessions/"+encodeURIComponent(r.value));if(P&&P.messages&&P.messages.length>0){for(const N of P.messages){const L=N.role==="user"?"user":"bot";let U=N.content||"";if(L==="user"){const q=U.match(/^\[.*?\]:\s*/);q&&(U=U.slice(q[0].length))}if(!U.trim())continue;const K={id:++c,role:L,content:U,timestamp:N.timestamp?N.timestamp*1e3:Date.now(),html:L==="bot"?yp(U):"",tools_used:[],is_error:!1,images:L==="bot"?xp(U):[],files:[],_showTools:!1};e.value.push(K)}Et(()=>{O(),b()})}}catch(P){P&&P.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",Re.error(n.value))}}return We(()=>{Ye.subscribe("chat",R),p.value=Ye.state||"disconnected",h=Ye.onState(P=>{p.value=P}),oe(),Et(()=>{var P;return(P=i.value)==null?void 0:P.focus()})}),mt(()=>{Ye.unsubscribe("chat",R),h&&(h(),h=null),A()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:T,suggestions:d,send:V,autoResize:y,formatTime:r1,formatDate:w,showDateSeparator:k,useSuggestion:E,openImage:C,onImageError:_,getToolIcon:c1,loadHistory:oe}}},p1={setup(){const e=f("odin"),t=f(""),s=f(""),n=f(""),a=f({}),i=f([]),l=f([]),r=f(!1),o=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),h=f(!1),m=J(()=>e.value==="custom"),v=J(()=>[...i.value,...l.value]),T=J(()=>l.value.includes(e.value)),O=J(()=>{var C;return m.value?t.value||"Odin":((C=a.value[e.value])==null?void 0:C.name)||e.value}),y=J(()=>{var C;return m.value?s.value||"(empty — will use Odin default)":((C=a.value[e.value])==null?void 0:C.identity)||""}),g=J(()=>{var C;return m.value?n.value||"(empty — will use Odin default)":((C=a.value[e.value])==null?void 0:C.voice)||""});async function b(){d.value=!0;try{const C=await W.get("/api/personality");e.value=C.preset||"odin",t.value=C.custom_name||"",s.value=C.custom_identity||"",n.value=C.custom_voice||"",a.value=C.presets||{},i.value=C.builtin_presets||[],l.value=C.user_presets||[]}catch(C){c.value=C.message}finally{d.value=!1}}async function k(){r.value=!0,c.value=null,o.value=!1;try{await W.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(C){c.value=C.message}finally{r.value=!1}}async function w(){const C=u.value.trim();if(C){h.value=!0,c.value=null;try{await W.post("/api/personality/presets",{name:C,display_name:O.value,identity:y.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=C.toLowerCase().replace(/ /g,"_")}catch(_){c.value=_.message}finally{h.value=!1}}}async function E(){if(await Xt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await W.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(_){c.value=_.message}}}return We(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:T,previewName:O,previewIdentity:y,previewVoice:g,saving:r,saved:o,error:c,loading:d,save:k,showSavePreset:p,newPresetName:u,savingPreset:h,saveAsPreset:w,deletePreset:E,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),tv=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:Kk,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:u1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:ww,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:Ow,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Qw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:p1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Bk,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/internals",redirect:kt("/system","internals")}],$i=lw({history:$_(),routes:tv});$i.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const f1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),n=f(!1),a=f(null),i=f(null),l=f(!1);let r=null,o=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let h=null;const m=f("starting"),v=f(""),T=tv.filter(U=>U.meta),O=J(()=>["Workspace","Operate","Observe","Manage"].map(U=>({name:U,routes:T.filter(K=>K.meta.section===U)})).filter(U=>U.routes.length)),y=J(()=>{var U;return((U=$i.currentRoute.value.meta)==null?void 0:U.label)||"Odin"}),g=J(()=>{var U;return((U=$i.currentRoute.value.meta)==null?void 0:U.section)||"Management"}),b=J(()=>{var U;return((U=$i.currentRoute.value.meta)==null?void 0:U.description)||"Management console"});function k(){Ye.disconnect(),V&&(clearInterval(V),V=null)}W.onSessionExpired=()=>{t.value=!0,k(),W.setToken(""),e.value="login"};function w(U){var K;if((U.ctrlKey||U.metaKey)&&U.key.toLowerCase()==="k"){e.value==="ready"&&(U.preventDefault(),Qu());return}if(n.value&&U.key==="Tab"){const q=[...((K=a.value)==null?void 0:K.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(q.length){const Q=q[0],ie=q[q.length-1];if(U.shiftKey&&(document.activeElement===Q||!a.value.contains(document.activeElement))){U.preventDefault(),ie.focus();return}if(!U.shiftKey&&(document.activeElement===ie||!a.value.contains(document.activeElement))){U.preventDefault(),Q.focus();return}}}if(U.key==="Escape"&&n.value){n.value=!1,U.preventDefault();return}if(U.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(U.target.tagName)){U.preventDefault();const q=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');q&&q.focus()}}function E(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}We(async()=>{document.addEventListener("keydown",w),r=window.matchMedia("(max-width: 900px)"),E(),r.addEventListener("change",E);const U=await W.check();U.ok?(e.value="ready",N()):U.needsAuth?e.value="login":(e.value="ready",N())});function C(){t.value=!1,e.value="ready",N()}async function _(){k(),e.value="login",await W.logout()}function D(){s.value=!s.value}function A(){n.value=!n.value}os(n,async U=>{var K,q;if(U)o=document.activeElement,await Et(),(q=(K=a.value)==null?void 0:K.querySelector(".nav-item"))==null||q.focus();else if(o!=null&&o.isConnected){const Q=o;o=null,requestAnimationFrame(()=>Q.focus())}});const R=J(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function $(U,K="info",q=3e3){p.value={text:U,level:K},clearTimeout(h),h=setTimeout(()=>{p.value=null},q)}let V=null,oe=!1,P=[];function N(){for(const U of P)U();P=[Ye.onStatus(U=>{c.value=U}),Ye.onLatencyChange(U=>{u.value=U}),Ye.onState((U,K)=>{d.value=U,U==="connected"?(oe&&$("Connection restored","success"),oe=!0):U==="reconnecting"&&K.attempt===1&&$("Connection lost — reconnecting…","warn")})],Ye.connect(),L(),V&&clearInterval(V),V=setInterval(L,15e3)}async function L(){try{const U=await W.get("/api/status");m.value=U.status==="online"?"online":"starting";const K=U.uptime_seconds||0,q=Math.floor(K/3600),Q=Math.floor(K%3600/60);v.value=`${q}h ${Q}m uptime`}catch{m.value="offline",v.value=""}}return mt(()=>{V&&clearInterval(V);for(const U of P)U();P=[],Ye.disconnect(),document.removeEventListener("keydown",w),r==null||r.removeEventListener("change",E)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:R,wsToast:p,botStatus:m,botUptime:v,navRoutes:T,navGroups:O,currentPage:y,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:C,logout:_,toggleSidebar:D,toggleMobileNavigation:A,openPalette:Qu}}},Zn=sr(h1);Zn.component("odin-icon",Vk);Zn.component("login-screen",f1);Zn.component("toast-container",Q0);Zn.component("confirm-host",X0);Zn.component("command-palette",jk);Zn.directive("modal-focus",Gk);Zn.use($i);Zn.mount("#app");
