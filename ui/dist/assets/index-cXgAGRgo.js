var Zv=Object.defineProperty;var Yv=(e,t,s)=>t in e?Zv(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var xt=(e,t,s)=>Yv(e,typeof t!="symbol"?t+"":t,s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();class Qv{constructor(){this._persist=localStorage.getItem("odin_persist")==="1",this._token=this._persist?localStorage.getItem("odin_token")||"":sessionStorage.getItem("odin_token")||"";const t=this._persist?localStorage:sessionStorage;this._sessionTimeout=parseInt(t.getItem("odin_session_timeout")||"0",10),this._lastActivity=Date.now(),this._activityTimer=null,this.onSessionExpired=null,this._token&&this._sessionTimeout>0&&this._startActivityMonitor()}get token(){return this._token}get sessionTimeout(){return this._sessionTimeout}setToken(t,s=0){if(this._token=t,this._sessionTimeout=s,this._lastActivity=Date.now(),t){const a=this._persist?localStorage:sessionStorage;a.setItem("odin_token",t),this._persist&&localStorage.setItem("odin_persist","1"),s>0?a.setItem("odin_session_timeout",String(s)):a.removeItem("odin_session_timeout"),this._startActivityMonitor()}else sessionStorage.removeItem("odin_token"),sessionStorage.removeItem("odin_session_timeout"),localStorage.removeItem("odin_token"),localStorage.removeItem("odin_persist"),localStorage.removeItem("odin_session_timeout"),this._stopActivityMonitor()}setPersist(t){this._persist=t}_startActivityMonitor(){this._stopActivityMonitor(),!(this._sessionTimeout<=0)&&(this._activityTimer=setInterval(()=>{(Date.now()-this._lastActivity)/1e3>=this._sessionTimeout&&(this._stopActivityMonitor(),this.onSessionExpired&&this.onSessionExpired())},1e4))}_stopActivityMonitor(){this._activityTimer&&(clearInterval(this._activityTimer),this._activityTimer=null)}_headers(t={}){const s={"Content-Type":"application/json",...t};return this._token&&(s.Authorization=`Bearer ${this._token}`),s}async _request(t,s,a=null,{signal:n}={}){this._lastActivity=Date.now();const i={method:t,headers:this._headers(),signal:n};a!==null&&(i.body=JSON.stringify(a));const l=await fetch(s,i);if(l.status===401)throw new zl("Unauthorized");const o=await l.json().catch(()=>null);if(!l.ok){const r=(o==null?void 0:o.error)||`HTTP ${l.status}`;throw new Ar(r,l.status,o)}return o}get(t,s={}){return this._request("GET",t,null,s)}async getBlob(t){this._lastActivity=Date.now();const s=await fetch(t,{method:"GET",headers:this._headers()});if(s.status===401)throw new zl("Unauthorized");if(!s.ok){const a=await s.json().catch(()=>null);throw new Ar((a==null?void 0:a.error)||`HTTP ${s.status}`,s.status,a)}return s.blob()}post(t,s){return this._request("POST",t,s)}async setListenerExposure(t,s){const a=await fetch("/api/setup/listener",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({expose_beyond_loopback:s})}),n=await a.json().catch(()=>null);if(!a.ok)throw new Ar((n==null?void 0:n.error)||"Listener reauthentication failed",a.status,n);return n}put(t,s){return this._request("PUT",t,s)}del(t){return this._request("DELETE",t)}async login(t){const s=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})}),a=await s.json().catch(()=>null);if(!s.ok)throw new zl((a==null?void 0:a.error)||"Login failed");return this.setToken(a.session_id,a.timeout_seconds||0),a}async logout(){const t=this.post("/api/auth/logout",{});this.setToken("");try{await t}catch{}}async check(){try{return await this.get("/api/status"),{ok:!0,needsAuth:!1}}catch(t){return t instanceof zl?{ok:!1,needsAuth:!0}:{ok:!1,needsAuth:!1,error:t.message}}}}class zl extends Error{constructor(t){super(t),this.name="AuthError"}}class Ar extends Error{constructor(t,s,a){super(t),this.name="ApiError",this.status=s,this.data=a}}class Xv{constructor(t){this._api=t,this._ws=null,this._handlers={logs:[],events:[],chat:[]},this._reconnectDelay=1e3,this._maxReconnectDelay=3e4,this._shouldConnect=!1,this._subscriptions=new Set,this._reconnectAttempt=0,this._reconnectTimer=null,this._lastPongTime=0,this._pingInterval=null,this._forcedRetireTimer=null,this._subscriptionAckTimer=null,this._pendingReconnect=null,this._latency=-1,this._chatPending=!1,this._state="disconnected",this._lifecycle={status:new Set,state:new Set,latency:new Set,reconnected:new Set},this._everConnected=!1,this._reconnectEpoch=0}onStatus(t){return this._addLifecycle("status",t)}onState(t){return this._addLifecycle("state",t)}onLatencyChange(t){return this._addLifecycle("latency",t)}onReconnected(t){return this._addLifecycle("reconnected",t)}_addLifecycle(t,s){return this._lifecycle[t].add(s),()=>{this._lifecycle[t].delete(s)}}_emitLifecycle(t,...s){for(const a of[...this._lifecycle[t]])try{a(...s)}catch{}}get connected(){var t;return((t=this._ws)==null?void 0:t.readyState)===WebSocket.OPEN}get state(){return this._state}get reconnectAttempt(){return this._reconnectAttempt}get latency(){return this._latency}get reconnectEpoch(){return this._reconnectEpoch}_resetLatency(){this._latency=-1,this._emitLifecycle("latency",-1)}connect(){this._shouldConnect=!0,this._setState("connecting"),this._open()}disconnect(){this._shouldConnect=!1,this._everConnected=!1,this._reconnectTimer&&(clearTimeout(this._reconnectTimer),this._reconnectTimer=null),this._forcedRetireTimer&&(clearTimeout(this._forcedRetireTimer),this._forcedRetireTimer=null),this._subscriptionAckTimer&&(clearTimeout(this._subscriptionAckTimer),this._subscriptionAckTimer=null),this._pendingReconnect=null,this._reconnectAttempt=0,this._resetLatency(),this._stopPing(),this._ws&&(this._ws.close(),this._ws=null),this._setState("disconnected")}_setState(t){this._state!==t&&(this._state=t,this._emitLifecycle("state",t,{attempt:this._reconnectAttempt,latency:this._latency}))}_startPing(t){this._stopPing(),this._lastPongTime=Date.now(),this._pingInterval=setInterval(()=>{if(!(this._ws!==t||t.readyState!==WebSocket.OPEN)){if(this._lastPongTime&&Date.now()-this._lastPongTime>47e3){this._beginForcedRetirement(t,"pong timeout");return}try{t.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}}},15e3)}_beginForcedRetirement(t,s){if(!(this._ws!==t||this._forcedRetireTimer)){this._stopPing(),this._reconnectAttempt++,this._setState("reconnecting"),this._emitLifecycle("status",!1),this._forcedRetireTimer=setTimeout(()=>{this._forcedRetireTimer=null,this._retireSocket(t,!0,!0)},1e3);try{t.close(4e3,s)}catch{}}}_scheduleReconnect(t=!0){!this._shouldConnect||this._reconnectTimer||(t&&this._reconnectAttempt++,this._setState("reconnecting"),this._reconnectTimer=setTimeout(()=>{this._reconnectTimer=null,this._open()},this._reconnectDelay),this._reconnectDelay=Math.min(this._reconnectDelay*2,this._maxReconnectDelay))}_retireSocket(t,s=!1,a=!1){if(this._ws===t){if(this._forcedRetireTimer&&(clearTimeout(this._forcedRetireTimer),this._forcedRetireTimer=null),this._subscriptionAckTimer&&(clearTimeout(this._subscriptionAckTimer),this._subscriptionAckTimer=null),this._pendingReconnect=null,this._ws=null,this._stopPing(),this._resetLatency(),this._chatPending){this._chatPending=!1;const n={type:"chat_error",error:"Connection lost — the response may still complete; check session history."};for(const i of this._handlers.chat||[])i(n)}s||this._emitLifecycle("status",!1),this._shouldConnect?this._scheduleReconnect(!a):this._setState("disconnected")}}_beginReconnectBarrier(t,s){if(!s)return;const a=new Set(this._subscriptions);if(a.size===0){this._reconnectEpoch+=1,this._emitLifecycle("reconnected",this._reconnectEpoch);return}this._pendingReconnect={socket:t,channels:a},this._subscriptionAckTimer=setTimeout(()=>{var n;((n=this._pendingReconnect)==null?void 0:n.socket)===t&&this._beginForcedRetirement(t,"subscription acknowledgement timeout")},5e3)}_ackSubscription(t,s){const a=this._pendingReconnect;!a||a.socket!==t||!a.channels.has(s)||(a.channels.delete(s),!(a.channels.size>0)&&(this._pendingReconnect=null,this._subscriptionAckTimer&&(clearTimeout(this._subscriptionAckTimer),this._subscriptionAckTimer=null),this._reconnectEpoch+=1,this._emitLifecycle("reconnected",this._reconnectEpoch)))}_stopPing(){this._pingInterval&&(clearInterval(this._pingInterval),this._pingInterval=null)}subscribe(t,s){var a;if(this._handlers[t]||(this._handlers[t]=[]),this._handlers[t].push(s),t!=="chat"&&(this._subscriptions.add(t),this.connected)){const n=this._ws;((a=this._pendingReconnect)==null?void 0:a.socket)===n&&this._pendingReconnect.channels.add(t),n.send(JSON.stringify({subscribe:t}))}}unsubscribe(t,s){const a=this._handlers[t];if(a){const n=a.indexOf(s);if(n>=0&&a.splice(n,1),a.length===0&&t!=="chat"&&(this._subscriptions.delete(t),this.connected)){const i=this._ws;i.send(JSON.stringify({unsubscribe:t})),this._ackSubscription(i,t)}}}on(t,s){return this.subscribe(t,s)}off(t,s){return this.unsubscribe(t,s)}sendChat(t,{channelId:s,userId:a,username:n}={}){return this.connected?(this._ws.send(JSON.stringify({type:"chat",content:t,channel_id:s||"web-default",user_id:a||void 0,username:n||void 0})),this._chatPending=!0,!0):!1}_open(){if(this._ws||!this._shouldConnect)return;const s=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/api/ws`,a=this._api.token?["odin.bearer."+btoa(this._api.token).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")]:void 0,n=a?new WebSocket(s,a):new WebSocket(s);this._ws=n;const i=()=>this._ws===n;n.onopen=()=>{if(!i())return;const l=this._everConnected;this._everConnected=!0,this._reconnectDelay=1e3,this._reconnectAttempt=0;for(const o of this._subscriptions)n.send(JSON.stringify({subscribe:o}));this._startPing(n),this._setState("connected"),this._emitLifecycle("status",!0),this._beginReconnectBarrier(n,l)},n.onmessage=l=>{if(!i())return;let o;try{o=JSON.parse(l.data)}catch{return}const r=o.type;if(r==="pong"){o.ts&&(this._latency=Date.now()-o.ts,this._lastPongTime=Date.now(),this._emitLifecycle("latency",this._latency));return}if(r==="subscribed"){this._ackSubscription(n,o.channel);return}if(r==="log")for(const c of this._handlers.logs||[])c(o);else if(r==="event")for(const c of this._handlers.events||[])c(o);else if(r==="chat_response"||r==="chat_error"){this._chatPending=!1;for(const c of this._handlers.chat||[])c(o)}},n.onclose=()=>{const l=!!this._forcedRetireTimer;this._retireSocket(n,l,l)},n.onerror=()=>{}}}const H=new Qv,nt=new Xv(H);/**
* @vue/shared v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ms(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const et={},di=[],ns=()=>{},oi=()=>!1,$n=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Jo=e=>e.startsWith("onUpdate:"),Qe=Object.assign,Vc=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},eg=Object.prototype.hasOwnProperty,pt=(e,t)=>eg.call(e,t),Ee=Array.isArray,ui=e=>Li(e)==="[object Map]",Un=e=>Li(e)==="[object Set]",tu=e=>Li(e)==="[object Date]",tg=e=>Li(e)==="[object RegExp]",$e=e=>typeof e=="function",ze=e=>typeof e=="string",ms=e=>typeof e=="symbol",rt=e=>e!==null&&typeof e=="object",qc=e=>(rt(e)||$e(e))&&$e(e.then)&&$e(e.catch),ff=Object.prototype.toString,Li=e=>ff.call(e),sg=e=>Li(e).slice(8,-1),Zo=e=>Li(e)==="[object Object]",Yo=e=>ze(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,$a=Ms(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ag=Ms("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),Qo=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},ng=/-\w/g,yt=Qo(e=>e.replace(ng,t=>t.slice(1).toUpperCase())),ig=/\B([A-Z])/g,Es=Qo(e=>e.replace(ig,"-$1").toLowerCase()),Bn=Qo(e=>e.charAt(0).toUpperCase()+e.slice(1)),pi=Qo(e=>e?`on${Bn(e)}`:""),Zt=(e,t)=>!Object.is(e,t),fi=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},mf=(e,t,s,a=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:a,value:s})},Xo=e=>{const t=parseFloat(e);return isNaN(t)?e:t},bo=e=>{const t=ze(e)?Number(e):NaN;return isNaN(t)?e:t};let su;const er=()=>su||(su=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function lg(e,t){return e+JSON.stringify(t,(s,a)=>typeof a=="function"?a.toString():a)}const og="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol",rg=Ms(og);function Rl(e){if(Ee(e)){const t={};for(let s=0;s<e.length;s++){const a=e[s],n=ze(a)?hf(a):Rl(a);if(n)for(const i in n)t[i]=n[i]}return t}else if(ze(e)||rt(e))return e}const cg=/;(?![^(]*\))/g,dg=/:([^]+)/,ug=/\/\*[^]*?\*\//g;function hf(e){const t={};return e.replace(ug,"").split(cg).forEach(s=>{if(s){const a=s.split(dg);a.length>1&&(t[a[0].trim()]=a[1].trim())}}),t}function Il(e){let t="";if(ze(e))t=e;else if(Ee(e))for(let s=0;s<e.length;s++){const a=Il(e[s]);a&&(t+=a+" ")}else if(rt(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function pg(e){if(!e)return null;let{class:t,style:s}=e;return t&&!ze(t)&&(e.class=Il(t)),s&&(e.style=Rl(s)),e}const fg="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",mg="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",hg="annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics",vg="area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr",gg=Ms(fg),bg=Ms(mg),yg=Ms(hg),xg=Ms(vg),_g="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",wg=Ms(_g);function vf(e){return!!e||e===""}function kg(e,t){if(e.length!==t.length)return!1;let s=!0;for(let a=0;s&&a<e.length;a++)s=za(e[a],t[a]);return s}function za(e,t){if(e===t)return!0;let s=tu(e),a=tu(t);if(s||a)return s&&a?e.getTime()===t.getTime():!1;if(s=ms(e),a=ms(t),s||a)return e===t;if(s=Ee(e),a=Ee(t),s||a)return s&&a?kg(e,t):!1;if(s=rt(e),a=rt(t),s||a){if(!s||!a)return!1;const n=Object.keys(e).length,i=Object.keys(t).length;if(n!==i)return!1;for(const l in e){const o=e.hasOwnProperty(l),r=t.hasOwnProperty(l);if(o&&!r||!o&&r||!za(e[l],t[l]))return!1}}return String(e)===String(t)}function tr(e,t){return e.findIndex(s=>za(s,t))}const gf=e=>!!(e&&e.__v_isRef===!0),bf=e=>ze(e)?e:e==null?"":Ee(e)||rt(e)&&(e.toString===ff||!$e(e.toString))?gf(e)?bf(e.value):JSON.stringify(e,yf,2):String(e),yf=(e,t)=>gf(t)?yf(e,t.value):ui(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[a,n],i)=>(s[Rr(a,i)+" =>"]=n,s),{})}:Un(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>Rr(s))}:ms(t)?Rr(t):rt(t)&&!Ee(t)&&!Zo(t)?String(t):t,Rr=(e,t="")=>{var s;return ms(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};function Sg(e){return e==null?"initial":typeof e=="string"?e===""?" ":e:String(e)}/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Wt;class Gc{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&Wt&&(Wt.active?(this.parent=Wt,this.index=(Wt.scopes||(Wt.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=Wt;try{return Wt=this,t()}finally{Wt=s}}}on(){++this._on===1&&(this.prevScope=Wt,Wt=this)}off(){if(this._on>0&&--this._on===0){if(Wt===this)Wt=this.prevScope;else{let t=Wt;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,a;for(s=0,a=this.effects.length;s<a;s++)this.effects[s].stop();for(this.effects.length=0,s=0,a=this.cleanups.length;s<a;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,a=this.scopes.length;s<a;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const n=this.parent.scopes.pop();n&&n!==this&&(this.parent.scopes[this.index]=n,n.index=this.index)}this.parent=void 0}}}function Tg(e){return new Gc(e)}function xf(){return Wt}function Cg(e,t=!1){Wt&&Wt.cleanups.push(e)}let _t;const Ir=new WeakSet;class rl{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Wt&&(Wt.active?Wt.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Ir.has(this)&&(Ir.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||wf(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,au(this),kf(this);const t=_t,s=ta;_t=this,ta=!0;try{return this.fn()}finally{Sf(this),_t=t,ta=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Jc(t);this.deps=this.depsTail=void 0,au(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Ir.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){nc(this)&&this.run()}get dirty(){return nc(this)}}let _f=0,Qi,Xi;function wf(e,t=!1){if(e.flags|=8,t){e.next=Xi,Xi=e;return}e.next=Qi,Qi=e}function Wc(){_f++}function Kc(){if(--_f>0)return;if(Xi){let t=Xi;for(Xi=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;Qi;){let t=Qi;for(Qi=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(a){e||(e=a)}t=s}}if(e)throw e}function kf(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function Sf(e){let t,s=e.depsTail,a=s;for(;a;){const n=a.prevDep;a.version===-1?(a===s&&(s=n),Jc(a),Eg(a)):t=a,a.dep.activeLink=a.prevActiveLink,a.prevActiveLink=void 0,a=n}e.deps=t,e.depsTail=s}function nc(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(Tf(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function Tf(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===cl)||(e.globalVersion=cl,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!nc(e))))return;e.flags|=2;const t=e.dep,s=_t,a=ta;_t=e,ta=!0;try{kf(e);const n=e.fn(e._value);(t.version===0||Zt(n,e._value))&&(e.flags|=128,e._value=n,t.version++)}catch(n){throw t.version++,n}finally{_t=s,ta=a,Sf(e),e.flags&=-3}}function Jc(e,t=!1){const{dep:s,prevSub:a,nextSub:n}=e;if(a&&(a.nextSub=n,e.prevSub=void 0),n&&(n.prevSub=a,e.nextSub=void 0),s.subs===e&&(s.subs=a,!a&&s.computed)){s.computed.flags&=-5;for(let i=s.computed.deps;i;i=i.nextDep)Jc(i,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function Eg(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}function Ag(e,t){e.effect instanceof rl&&(e=e.effect.fn);const s=new rl(e);t&&Qe(s,t);try{s.run()}catch(n){throw s.stop(),n}const a=s.run.bind(s);return a.effect=s,a}function Rg(e){e.effect.stop()}let ta=!0;const Cf=[];function ja(){Cf.push(ta),ta=!1}function Va(){const e=Cf.pop();ta=e===void 0?!0:e}function au(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=_t;_t=void 0;try{t()}finally{_t=s}}}let cl=0;class Ig{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class sr{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!_t||!ta||_t===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==_t)s=this.activeLink=new Ig(_t,this),_t.deps?(s.prevDep=_t.depsTail,_t.depsTail.nextDep=s,_t.depsTail=s):_t.deps=_t.depsTail=s,Ef(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const a=s.nextDep;a.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=a),s.prevDep=_t.depsTail,s.nextDep=void 0,_t.depsTail.nextDep=s,_t.depsTail=s,_t.deps===s&&(_t.deps=a)}return s}trigger(t){this.version++,cl++,this.notify(t)}notify(t){Wc();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Kc()}}}function Ef(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let a=t.deps;a;a=a.nextDep)Ef(a)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const yo=new WeakMap,Rn=Symbol(""),ic=Symbol(""),dl=Symbol("");function us(e,t,s){if(ta&&_t){let a=yo.get(e);a||yo.set(e,a=new Map);let n=a.get(s);n||(a.set(s,n=new sr),n.map=a,n.key=s),n.track()}}function Na(e,t,s,a,n,i){const l=yo.get(e);if(!l){cl++;return}const o=r=>{r&&r.trigger()};if(Wc(),t==="clear")l.forEach(o);else{const r=Ee(e),c=r&&Yo(s);if(r&&s==="length"){const d=Number(a);l.forEach((u,p)=>{(p==="length"||p===dl||!ms(p)&&p>=d)&&o(u)})}else switch((s!==void 0||l.has(void 0))&&o(l.get(s)),c&&o(l.get(dl)),t){case"add":r?c&&o(l.get("length")):(o(l.get(Rn)),ui(e)&&o(l.get(ic)));break;case"delete":r||(o(l.get(Rn)),ui(e)&&o(l.get(ic)));break;case"set":ui(e)&&o(l.get(Rn));break}}Kc()}function Og(e,t){const s=yo.get(e);return s&&s.get(t)}function Yn(e){const t=at(e);return t===e?t:(us(t,"iterate",dl),Rs(e)?t:t.map(aa))}function ar(e){return us(e=at(e),"iterate",dl),e}function ha(e,t){return ga(e)?xi(Ua(e)?aa(t):t):aa(t)}const Lg={__proto__:null,[Symbol.iterator](){return Or(this,Symbol.iterator,e=>ha(this,e))},concat(...e){return Yn(this).concat(...e.map(t=>Ee(t)?Yn(t):t))},entries(){return Or(this,"entries",e=>(e[1]=ha(this,e[1]),e))},every(e,t){return Ta(this,"every",e,t,void 0,arguments)},filter(e,t){return Ta(this,"filter",e,t,s=>s.map(a=>ha(this,a)),arguments)},find(e,t){return Ta(this,"find",e,t,s=>ha(this,s),arguments)},findIndex(e,t){return Ta(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return Ta(this,"findLast",e,t,s=>ha(this,s),arguments)},findLastIndex(e,t){return Ta(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return Ta(this,"forEach",e,t,void 0,arguments)},includes(...e){return Lr(this,"includes",e)},indexOf(...e){return Lr(this,"indexOf",e)},join(e){return Yn(this).join(e)},lastIndexOf(...e){return Lr(this,"lastIndexOf",e)},map(e,t){return Ta(this,"map",e,t,void 0,arguments)},pop(){return Pi(this,"pop")},push(...e){return Pi(this,"push",e)},reduce(e,...t){return nu(this,"reduce",e,t)},reduceRight(e,...t){return nu(this,"reduceRight",e,t)},shift(){return Pi(this,"shift")},some(e,t){return Ta(this,"some",e,t,void 0,arguments)},splice(...e){return Pi(this,"splice",e)},toReversed(){return Yn(this).toReversed()},toSorted(e){return Yn(this).toSorted(e)},toSpliced(...e){return Yn(this).toSpliced(...e)},unshift(...e){return Pi(this,"unshift",e)},values(){return Or(this,"values",e=>ha(this,e))}};function Or(e,t,s){const a=ar(e),n=a[t]();return a!==e&&!Rs(e)&&(n._next=n.next,n.next=()=>{const i=n._next();return i.done||(i.value=s(i.value)),i}),n}const Ng=Array.prototype;function Ta(e,t,s,a,n,i){const l=ar(e),o=l!==e&&!Rs(e),r=l[t];if(r!==Ng[t]){const u=r.apply(e,i);return o?aa(u):u}let c=s;l!==e&&(o?c=function(u,p){return s.call(this,ha(e,u),p,e)}:s.length>2&&(c=function(u,p){return s.call(this,u,p,e)}));const d=r.call(l,c,a);return o&&n?n(d):d}function nu(e,t,s,a){const n=ar(e),i=n!==e&&!Rs(e);let l=s,o=!1;n!==e&&(i?(o=a.length===0,l=function(c,d,u){return o&&(o=!1,c=ha(e,c)),s.call(this,c,ha(e,d),u,e)}):s.length>3&&(l=function(c,d,u){return s.call(this,c,d,u,e)}));const r=n[t](l,...a);return o?ha(e,r):r}function Lr(e,t,s){const a=at(e);us(a,"iterate",dl);const n=a[t](...s);return(n===-1||n===!1)&&Ol(s[0])?(s[0]=at(s[0]),a[t](...s)):n}function Pi(e,t,s=[]){ja(),Wc();const a=at(e)[t].apply(e,s);return Kc(),Va(),a}const Dg=Ms("__proto__,__v_isRef,__isVue"),Af=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(ms));function Mg(e){ms(e)||(e=String(e));const t=at(this);return us(t,"has",e),t.hasOwnProperty(e)}class Rf{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,a){if(s==="__v_skip")return t.__v_skip;const n=this._isReadonly,i=this._isShallow;if(s==="__v_isReactive")return!n;if(s==="__v_isReadonly")return n;if(s==="__v_isShallow")return i;if(s==="__v_raw")return a===(n?i?Mf:Df:i?Nf:Lf).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(a)?t:void 0;const l=Ee(t);if(!n){let r;if(l&&(r=Lg[s]))return r;if(s==="hasOwnProperty")return Mg}const o=Reflect.get(t,s,Ht(t)?t:a);if((ms(s)?Af.has(s):Dg(s))||(n||us(t,"get",s),i))return o;if(Ht(o)){const r=l&&Yo(s)?o:o.value;return n&&rt(r)?xo(r):r}return rt(o)?n?xo(o):fn(o):o}}class If extends Rf{constructor(t=!1){super(!1,t)}set(t,s,a,n){let i=t[s];const l=Ee(t)&&Yo(s);if(!this._isShallow){const c=ga(i);if(!Rs(a)&&!ga(a)&&(i=at(i),a=at(a)),!l&&Ht(i)&&!Ht(a))return c||(i.value=a),!0}const o=l?Number(s)<t.length:pt(t,s),r=Reflect.set(t,s,a,Ht(t)?t:n);return t===at(n)&&(o?Zt(a,i)&&Na(t,"set",s,a):Na(t,"add",s,a)),r}deleteProperty(t,s){const a=pt(t,s);t[s];const n=Reflect.deleteProperty(t,s);return n&&a&&Na(t,"delete",s,void 0),n}has(t,s){const a=Reflect.has(t,s);return(!ms(s)||!Af.has(s))&&us(t,"has",s),a}ownKeys(t){return us(t,"iterate",Ee(t)?"length":Rn),Reflect.ownKeys(t)}}class Of extends Rf{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const Pg=new If,Fg=new Of,$g=new If(!0),Ug=new Of(!0),lc=e=>e,jl=e=>Reflect.getPrototypeOf(e);function Bg(e,t,s){return function(...a){const n=this.__v_raw,i=at(n),l=ui(i),o=e==="entries"||e===Symbol.iterator&&l,r=e==="keys"&&l,c=n[e](...a),d=s?lc:t?xi:aa;return!t&&us(i,"iterate",r?ic:Rn),Qe(Object.create(c),{next(){const{value:u,done:p}=c.next();return p?{value:u,done:p}:{value:o?[d(u[0]),d(u[1])]:d(u),done:p}}})}}function Vl(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function Hg(e,t){const s={get(n){const i=this.__v_raw,l=at(i),o=at(n);e||(Zt(n,o)&&us(l,"get",n),us(l,"get",o));const{has:r}=jl(l),c=t?lc:e?xi:aa;if(r.call(l,n))return c(i.get(n));if(r.call(l,o))return c(i.get(o));i!==l&&i.get(n)},get size(){const n=this.__v_raw;return!e&&us(at(n),"iterate",Rn),n.size},has(n){const i=this.__v_raw,l=at(i),o=at(n);return e||(Zt(n,o)&&us(l,"has",n),us(l,"has",o)),n===o?i.has(n):i.has(n)||i.has(o)},forEach(n,i){const l=this,o=l.__v_raw,r=at(o),c=t?lc:e?xi:aa;return!e&&us(r,"iterate",Rn),o.forEach((d,u)=>n.call(i,c(d),c(u),l))}};return Qe(s,e?{add:Vl("add"),set:Vl("set"),delete:Vl("delete"),clear:Vl("clear")}:{add(n){const i=at(this),l=jl(i),o=at(n),r=!t&&!Rs(n)&&!ga(n)?o:n;return l.has.call(i,r)||Zt(n,r)&&l.has.call(i,n)||Zt(o,r)&&l.has.call(i,o)||(i.add(r),Na(i,"add",r,r)),this},set(n,i){!t&&!Rs(i)&&!ga(i)&&(i=at(i));const l=at(this),{has:o,get:r}=jl(l);let c=o.call(l,n);c||(n=at(n),c=o.call(l,n));const d=r.call(l,n);return l.set(n,i),c?Zt(i,d)&&Na(l,"set",n,i):Na(l,"add",n,i),this},delete(n){const i=at(this),{has:l,get:o}=jl(i);let r=l.call(i,n);r||(n=at(n),r=l.call(i,n)),o&&o.call(i,n);const c=i.delete(n);return r&&Na(i,"delete",n,void 0),c},clear(){const n=at(this),i=n.size!==0,l=n.clear();return i&&Na(n,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(n=>{s[n]=Bg(n,e,t)}),s}function nr(e,t){const s=Hg(e,t);return(a,n,i)=>n==="__v_isReactive"?!e:n==="__v_isReadonly"?e:n==="__v_raw"?a:Reflect.get(pt(s,n)&&n in a?s:a,n,i)}const zg={get:nr(!1,!1)},jg={get:nr(!1,!0)},Vg={get:nr(!0,!1)},qg={get:nr(!0,!0)},Lf=new WeakMap,Nf=new WeakMap,Df=new WeakMap,Mf=new WeakMap;function Gg(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function fn(e){return ga(e)?e:ir(e,!1,Pg,zg,Lf)}function Zc(e){return ir(e,!1,$g,jg,Nf)}function xo(e){return ir(e,!0,Fg,Vg,Df)}function Wg(e){return ir(e,!0,Ug,qg,Mf)}function ir(e,t,s,a,n){if(!rt(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const i=n.get(e);if(i)return i;const l=Gg(sg(e));if(l===0)return e;const o=new Proxy(e,l===2?a:s);return n.set(e,o),o}function Ua(e){return ga(e)?Ua(e.__v_raw):!!(e&&e.__v_isReactive)}function ga(e){return!!(e&&e.__v_isReadonly)}function Rs(e){return!!(e&&e.__v_isShallow)}function Ol(e){return e?!!e.__v_raw:!1}function at(e){const t=e&&e.__v_raw;return t?at(t):e}function Pf(e){return!pt(e,"__v_skip")&&Object.isExtensible(e)&&mf(e,"__v_skip",!0),e}const aa=e=>rt(e)?fn(e):e,xi=e=>rt(e)?xo(e):e;function Ht(e){return e?e.__v_isRef===!0:!1}function f(e){return Ff(e,!1)}function Yc(e){return Ff(e,!0)}function Ff(e,t){return Ht(e)?e:new Kg(e,t)}class Kg{constructor(t,s){this.dep=new sr,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:at(t),this._value=s?t:aa(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,a=this.__v_isShallow||Rs(t)||ga(t);t=a?t:at(t),Zt(t,s)&&(this._rawValue=t,this._value=a?t:aa(t),this.dep.trigger())}}function Jg(e){e.dep&&e.dep.trigger()}function va(e){return Ht(e)?e.value:e}function Zg(e){return $e(e)?e():va(e)}const Yg={get:(e,t,s)=>t==="__v_raw"?e:va(Reflect.get(e,t,s)),set:(e,t,s,a)=>{const n=e[t];return Ht(n)&&!Ht(s)?(n.value=s,!0):Reflect.set(e,t,s,a)}};function Qc(e){return Ua(e)?e:new Proxy(e,Yg)}class Qg{constructor(t){this.__v_isRef=!0,this._value=void 0;const s=this.dep=new sr,{get:a,set:n}=t(s.track.bind(s),s.trigger.bind(s));this._get=a,this._set=n}get value(){return this._value=this._get()}set value(t){this._set(t)}}function $f(e){return new Qg(e)}function Xg(e){const t=Ee(e)?new Array(e.length):{};for(const s in e)t[s]=Uf(e,s);return t}class eb{constructor(t,s,a){this._object=t,this._defaultValue=a,this.__v_isRef=!0,this._value=void 0,this._key=ms(s)?s:String(s),this._raw=at(t);let n=!0,i=t;if(!Ee(t)||ms(this._key)||!Yo(this._key))do n=!Ol(i)||Rs(i);while(n&&(i=i.__v_raw));this._shallow=n}get value(){let t=this._object[this._key];return this._shallow&&(t=va(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&Ht(this._raw[this._key])){const s=this._object[this._key];if(Ht(s)){s.value=t;return}}this._object[this._key]=t}get dep(){return Og(this._raw,this._key)}}class tb{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function sb(e,t,s){return Ht(e)?e:$e(e)?new tb(e):rt(e)&&arguments.length>1?Uf(e,t,s):f(e)}function Uf(e,t,s){return new eb(e,t,s)}class ab{constructor(t,s,a){this.fn=t,this.setter=s,this._value=void 0,this.dep=new sr(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=cl-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=a}notify(){if(this.flags|=16,!(this.flags&8)&&_t!==this)return wf(this,!0),!0}get value(){const t=this.dep.track();return Tf(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function nb(e,t,s=!1){let a,n;return $e(e)?a=e:(a=e.get,n=e.set),new ab(a,n,s)}const ib={GET:"get",HAS:"has",ITERATE:"iterate"},lb={SET:"set",ADD:"add",DELETE:"delete",CLEAR:"clear"},ql={},_o=new WeakMap;let nn;function ob(){return nn}function Bf(e,t=!1,s=nn){if(s){let a=_o.get(s);a||_o.set(s,a=[]),a.push(e)}}function rb(e,t,s=et){const{immediate:a,deep:n,once:i,scheduler:l,augmentJob:o,call:r}=s,c=b=>n?b:Rs(b)||n===!1||n===0?Da(b,1):Da(b);let d,u,p,m,h=!1,g=!1;if(Ht(e)?(u=()=>e.value,h=Rs(e)):Ua(e)?(u=()=>c(e),h=!0):Ee(e)?(g=!0,h=e.some(b=>Ua(b)||Rs(b)),u=()=>e.map(b=>{if(Ht(b))return b.value;if(Ua(b))return c(b);if($e(b))return r?r(b,2):b()})):$e(e)?t?u=r?()=>r(e,2):e:u=()=>{if(p){ja();try{p()}finally{Va()}}const b=nn;nn=d;try{return r?r(e,3,[m]):e(m)}finally{nn=b}}:u=ns,t&&n){const b=u,x=n===!0?1/0:n;u=()=>Da(b(),x)}const A=xf(),I=()=>{d.stop(),A&&A.active&&Vc(A.effects,d)};if(i&&t){const b=t;t=(...x)=>{const w=b(...x);return I(),w}}let y=g?new Array(e.length).fill(ql):ql;const v=b=>{if(!(!(d.flags&1)||!d.dirty&&!b))if(t){const x=d.run();if(b||n||h||(g?x.some((w,C)=>Zt(w,y[C])):Zt(x,y))){p&&p();const w=nn;nn=d;try{const C=[x,y===ql?void 0:g&&y[0]===ql?[]:y,m];y=x,r?r(t,3,C):t(...C)}finally{nn=w}}}else d.run()};return o&&o(v),d=new rl(u),d.scheduler=l?()=>l(v,!1):v,m=b=>Bf(b,!1,d),p=d.onStop=()=>{const b=_o.get(d);if(b){if(r)r(b,4);else for(const x of b)x();_o.delete(d)}},t?a?v(!0):y=d.run():l?l(v.bind(null,!0),!0):d.run(),I.pause=d.pause.bind(d),I.resume=d.resume.bind(d),I.stop=I,I}function Da(e,t=1/0,s){if(t<=0||!rt(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,Ht(e))Da(e.value,t,s);else if(Ee(e))for(let a=0;a<e.length;a++)Da(e[a],t,s);else if(Un(e)||ui(e))e.forEach(a=>{Da(a,t,s)});else if(Zo(e)){for(const a in e)Da(e[a],t,s);for(const a of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,a)&&Da(e[a],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Hf=[];function cb(e){Hf.push(e)}function db(){Hf.pop()}function ub(e,t){}const pb={SETUP_FUNCTION:0,0:"SETUP_FUNCTION",RENDER_FUNCTION:1,1:"RENDER_FUNCTION",NATIVE_EVENT_HANDLER:5,5:"NATIVE_EVENT_HANDLER",COMPONENT_EVENT_HANDLER:6,6:"COMPONENT_EVENT_HANDLER",VNODE_HOOK:7,7:"VNODE_HOOK",DIRECTIVE_HOOK:8,8:"DIRECTIVE_HOOK",TRANSITION_HOOK:9,9:"TRANSITION_HOOK",APP_ERROR_HANDLER:10,10:"APP_ERROR_HANDLER",APP_WARN_HANDLER:11,11:"APP_WARN_HANDLER",FUNCTION_REF:12,12:"FUNCTION_REF",ASYNC_COMPONENT_LOADER:13,13:"ASYNC_COMPONENT_LOADER",SCHEDULER:14,14:"SCHEDULER",COMPONENT_UPDATE:15,15:"COMPONENT_UPDATE",APP_UNMOUNT_CLEANUP:16,16:"APP_UNMOUNT_CLEANUP"},fb={sp:"serverPrefetch hook",bc:"beforeCreate hook",c:"created hook",bm:"beforeMount hook",m:"mounted hook",bu:"beforeUpdate hook",u:"updated",bum:"beforeUnmount hook",um:"unmounted hook",a:"activated hook",da:"deactivated hook",ec:"errorCaptured hook",rtc:"renderTracked hook",rtg:"renderTriggered hook",0:"setup function",1:"render function",2:"watcher getter",3:"watcher callback",4:"watcher cleanup function",5:"native event handler",6:"component event handler",7:"vnode hook",8:"directive hook",9:"transition hook",10:"app errorHandler",11:"app warnHandler",12:"ref function",13:"async component loader",14:"scheduler flush",15:"component update",16:"app unmount cleanup function"};function Ni(e,t,s,a){try{return a?e(...a):e()}catch(n){Hn(n,t,s)}}function Ds(e,t,s,a){if($e(e)){const n=Ni(e,t,s,a);return n&&qc(n)&&n.catch(i=>{Hn(i,t,s)}),n}if(Ee(e)){const n=[];for(let i=0;i<e.length;i++)n.push(Ds(e[i],t,s,a));return n}}function Hn(e,t,s,a=!0){const n=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=t&&t.appContext.config||et;if(t){let o=t.parent;const r=t.proxy,c=`https://vuejs.org/error-reference/#runtime-${s}`;for(;o;){const d=o.ec;if(d){for(let u=0;u<d.length;u++)if(d[u](e,r,c)===!1)return}o=o.parent}if(i){ja(),Ni(i,null,10,[e,r,c]),Va();return}}mb(e,s,n,a,l)}function mb(e,t,s,a=!0,n=!1){if(n)throw e;console.error(e)}const ys=[];let fa=-1;const mi=[];let ln=null,ai=0;const zf=Promise.resolve();let wo=null;function Pt(e){const t=wo||zf;return e?t.then(this?e.bind(this):e):t}function hb(e){let t=fa+1,s=ys.length;for(;t<s;){const a=t+s>>>1,n=ys[a],i=pl(n);i<e||i===e&&n.flags&2?t=a+1:s=a}return t}function Xc(e){if(!(e.flags&1)){const t=pl(e),s=ys[ys.length-1];!s||!(e.flags&2)&&t>=pl(s)?ys.push(e):ys.splice(hb(t),0,e),e.flags|=1,jf()}}function jf(){wo||(wo=zf.then(Vf))}function ul(e){Ee(e)?mi.push(...e):ln&&e.id===-1?ln.splice(ai+1,0,e):e.flags&1||(mi.push(e),e.flags|=1),jf()}function iu(e,t,s=fa+1){for(;s<ys.length;s++){const a=ys[s];if(a&&a.flags&2){if(e&&a.id!==e.uid)continue;ys.splice(s,1),s--,a.flags&4&&(a.flags&=-2),a(),a.flags&4||(a.flags&=-2)}}}function ko(e){if(mi.length){const t=[...new Set(mi)].sort((s,a)=>pl(s)-pl(a));if(mi.length=0,ln){ln.push(...t);return}for(ln=t,ai=0;ai<ln.length;ai++){const s=ln[ai];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}ln=null,ai=0}}const pl=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Vf(e){try{for(fa=0;fa<ys.length;fa++){const t=ys[fa];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Ni(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;fa<ys.length;fa++){const t=ys[fa];t&&(t.flags&=-2)}fa=-1,ys.length=0,ko(),wo=null,(ys.length||mi.length)&&Vf()}}let ni,Gl=[];function qf(e,t){var s,a;ni=e,ni?(ni.enabled=!0,Gl.forEach(({event:n,args:i})=>ni.emit(n,...i)),Gl=[]):typeof window<"u"&&window.HTMLElement&&!((a=(s=window.navigator)==null?void 0:s.userAgent)!=null&&a.includes("jsdom"))?((t.__VUE_DEVTOOLS_HOOK_REPLAY__=t.__VUE_DEVTOOLS_HOOK_REPLAY__||[]).push(i=>{qf(i,t)}),setTimeout(()=>{ni||(t.__VUE_DEVTOOLS_HOOK_REPLAY__=null,Gl=[])},3e3)):Gl=[]}let as=null,lr=null;function fl(e){const t=as;return as=e,lr=e&&e.type.__scopeId||null,t}function vb(e){lr=e}function gb(){lr=null}const bb=e=>ed;function ed(e,t=as,s){if(!t||e._n)return e;const a=(...n)=>{a._d&&gl(-1);const i=fl(t);let l;try{l=e(...n)}finally{fl(i),a._d&&gl(1)}return l};return a._n=!0,a._c=!0,a._d=!0,a}function yb(e,t){if(as===null)return e;const s=Ml(as),a=e.dirs||(e.dirs=[]);for(let n=0;n<t.length;n++){let[i,l,o,r=et]=t[n];i&&($e(i)&&(i={mounted:i,updated:i}),i.deep&&Da(l),a.push({dir:i,instance:s,value:l,oldValue:void 0,arg:o,modifiers:r}))}return e}function ma(e,t,s,a){const n=e.dirs,i=t&&t.dirs;for(let l=0;l<n.length;l++){const o=n[l];i&&(o.oldValue=i[l].value);let r=o.dir[a];r&&(ja(),Ds(r,s,8,[e.el,o,e,t]),Va())}}function el(e,t){if(ss){let s=ss.provides;const a=ss.parent&&ss.parent.provides;a===s&&(s=ss.provides=Object.create(a)),s[e]=t}}function Gs(e,t,s=!1){const a=_s();if(a||In){let n=In?In._context.provides:a?a.parent==null||a.ce?a.vnode.appContext&&a.vnode.appContext.provides:a.parent.provides:void 0;if(n&&e in n)return n[e];if(arguments.length>1)return s&&$e(t)?t.call(a&&a.proxy):t}}function xb(){return!!(_s()||In)}const Gf=Symbol.for("v-scx"),Wf=()=>Gs(Gf);function _b(e,t){return Ll(e,null,t)}function wb(e,t){return Ll(e,null,{flush:"post"})}function Kf(e,t){return Ll(e,null,{flush:"sync"})}function zt(e,t,s){return Ll(e,t,s)}function Ll(e,t,s=et){const{immediate:a,deep:n,flush:i,once:l}=s,o=Qe({},s),r=t&&a||!t&&i!=="post";let c;if(Mn){if(i==="sync"){const m=Wf();c=m.__watcherHandles||(m.__watcherHandles=[])}else if(!r){const m=()=>{};return m.stop=ns,m.resume=ns,m.pause=ns,m}}const d=ss;o.call=(m,h,g)=>Ds(m,d,h,g);let u=!1;i==="post"?o.scheduler=m=>{Ut(m,d&&d.suspense)}:i!=="sync"&&(u=!0,o.scheduler=(m,h)=>{h?m():Xc(m)}),o.augmentJob=m=>{t&&(m.flags|=4),u&&(m.flags|=2,d&&(m.id=d.uid,m.i=d))};const p=rb(e,t,o);return Mn&&(c?c.push(p):r&&p()),p}function kb(e,t,s){const a=this.proxy,n=ze(e)?e.includes(".")?Jf(a,e):()=>a[e]:e.bind(a,a);let i;$e(t)?i=t:(i=t.handler,s=t);const l=Di(this),o=Ll(n,i.bind(a),s);return l(),o}function Jf(e,t){const s=t.split(".");return()=>{let a=e;for(let n=0;n<s.length&&a;n++)a=a[s[n]];return a}}const sn=new WeakMap,Zf=Symbol("_vte"),Yf=e=>e.__isTeleport,Tn=e=>e&&(e.disabled||e.disabled===""),Sb=e=>e&&(e.defer||e.defer===""),lu=e=>typeof SVGElement<"u"&&e instanceof SVGElement,ou=e=>typeof MathMLElement=="function"&&e instanceof MathMLElement,oc=(e,t)=>{const s=e&&e.to;return ze(s)?t?t(s):null:s},Tb={name:"Teleport",__isTeleport:!0,process(e,t,s,a,n,i,l,o,r,c){const{mc:d,pc:u,pbc:p,o:{insert:m,querySelector:h,createText:g,createComment:A,parentNode:I}}=c,y=Tn(t.props);let{dynamicChildren:v}=t;const b=(C,E,_)=>{C.shapeFlag&16&&d(C.children,E,_,n,i,l,o,r)},x=(C=t)=>{const E=Tn(C.props),_=C.target=oc(C.props,h),R=rc(_,C,g,m);_&&(l!=="svg"&&lu(_)?l="svg":l!=="mathml"&&ou(_)&&(l="mathml"),n&&n.isCE&&(n.ce._teleportTargets||(n.ce._teleportTargets=new Set)).add(_),E||(b(C,_,R),Wi(C,!1)))},w=C=>{const E=()=>{if(sn.get(C)===E){if(sn.delete(C),Tn(C.props)){const _=I(C.el)||s;b(C,_,C.anchor),Wi(C,!0)}x(C)}};sn.set(C,E),Ut(E,i)};if(e==null){const C=t.el=g(""),E=t.anchor=g("");if(m(C,s,a),m(E,s,a),Sb(t.props)||i&&i.pendingBranch){w(t);return}y&&(b(t,s,E),Wi(t,!0)),x()}else{t.el=e.el;const C=t.anchor=e.anchor,E=sn.get(e);if(E){E.flags|=8,sn.delete(e),w(t);return}t.targetStart=e.targetStart;const _=t.target=e.target,R=t.targetAnchor=e.targetAnchor,$=Tn(e.props),S=$?s:_,M=$?C:R;if(l==="svg"||lu(_)?l="svg":(l==="mathml"||ou(_))&&(l="mathml"),v?(p(e.dynamicChildren,v,S,n,i,l,o),ud(e,t,!0)):r||u(e,t,S,M,n,i,l,o,!1),y)$?t.props&&e.props&&t.props.to!==e.props.to&&(t.props.to=e.props.to):Wl(t,s,C,c,1);else if((t.props&&t.props.to)!==(e.props&&e.props.to)){const Q=t.target=oc(t.props,h);Q&&Wl(t,Q,null,c,0)}else $&&Wl(t,_,R,c,1);Wi(t,y)}},remove(e,t,s,{um:a,o:{remove:n}},i){const{shapeFlag:l,children:o,anchor:r,targetStart:c,targetAnchor:d,target:u,props:p}=e,m=i||!Tn(p),h=sn.get(e);if(h&&(h.flags|=8,sn.delete(e)),u&&(n(c),n(d)),i&&n(r),!h&&l&16)for(let g=0;g<o.length;g++){const A=o[g];a(A,t,s,m,!!A.dynamicChildren)}},move:Wl,hydrate:Cb};function Wl(e,t,s,{o:{insert:a},m:n},i=2){i===0&&a(e.targetAnchor,t,s);const{el:l,anchor:o,shapeFlag:r,children:c,props:d}=e,u=i===2;if(u&&a(l,t,s),!sn.has(e)&&(!u||Tn(d))&&r&16)for(let p=0;p<c.length;p++)n(c[p],t,s,2);u&&a(o,t,s)}function Cb(e,t,s,a,n,i,{o:{nextSibling:l,parentNode:o,querySelector:r,insert:c,createText:d}},u){function p(A,I){let y=I;for(;y;){if(y&&y.nodeType===8){if(y.data==="teleport start anchor")t.targetStart=y;else if(y.data==="teleport anchor"){t.targetAnchor=y,A._lpa=t.targetAnchor&&l(t.targetAnchor);break}}y=l(y)}}function m(A,I){I.anchor=u(l(A),I,o(A),s,a,n,i)}const h=t.target=oc(t.props,r),g=Tn(t.props);if(h){const A=h._lpa||h.firstChild;t.shapeFlag&16&&(g?(m(e,t),p(h,A),t.targetAnchor||rc(h,t,d,c,o(e)===h?e:null)):(t.anchor=l(e),p(h,A),t.targetAnchor||rc(h,t,d,c),u(A&&l(A),t,h,s,a,n,i))),Wi(t,g)}else g&&t.shapeFlag&16&&(m(e,t),t.targetStart=e,t.targetAnchor=l(e));return t.anchor&&l(t.anchor)}const Eb=Tb;function Wi(e,t){const s=e.ctx;if(s&&s.ut){let a,n;for(t?(a=e.el,n=e.anchor):(a=e.targetStart,n=e.targetAnchor);a&&a!==n;)a.nodeType===1&&a.setAttribute("data-v-owner",s.uid),a=a.nextSibling;s.ut()}}function rc(e,t,s,a,n=null){const i=t.targetStart=s(""),l=t.targetAnchor=s("");return i[Zf]=l,e&&(a(i,e,n),a(l,e,n)),l}const zs=Symbol("_leaveCb"),Fi=Symbol("_enterCb");function td(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ye(()=>{e.isMounted=!0}),dr(()=>{e.isUnmounting=!0}),e}const Hs=[Function,Array],sd={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Hs,onEnter:Hs,onAfterEnter:Hs,onEnterCancelled:Hs,onBeforeLeave:Hs,onLeave:Hs,onAfterLeave:Hs,onLeaveCancelled:Hs,onBeforeAppear:Hs,onAppear:Hs,onAfterAppear:Hs,onAppearCancelled:Hs},Qf=e=>{const t=e.subTree;return t.component?Qf(t.component):t},Ab={name:"BaseTransition",props:sd,setup(e,{slots:t}){const s=_s(),a=td();return()=>{const n=t.default&&or(t.default(),!0),i=n&&n.length?Xf(n):s.subTree?Mm():void 0;if(!i)return;const l=at(e),{mode:o}=l;if(a.isLeaving)return Nr(i);const r=ru(i);if(!r)return Nr(i);let c=_i(r,l,a,s,u=>c=u);r.type!==Ft&&qa(r,c);let d=s.subTree&&ru(s.subTree);if(d&&d.type!==Ft&&!ea(d,r)&&Qf(s).type!==Ft){let u=_i(d,l,a,s);if(qa(d,u),o==="out-in"&&r.type!==Ft)return a.isLeaving=!0,u.afterLeave=()=>{a.isLeaving=!1,s.job.flags&8||s.update(),delete u.afterLeave,d=void 0},Nr(i);o==="in-out"&&r.type!==Ft?u.delayLeave=(p,m,h)=>{const g=tm(a,d);g[String(d.key)]=d,p[zs]=()=>{m(),p[zs]=void 0,delete c.delayedLeave,d=void 0},c.delayedLeave=()=>{h(),delete c.delayedLeave,d=void 0}}:d=void 0}else d&&(d=void 0);return i}}};function Xf(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==Ft){t=s;break}}return t}const em=Ab;function tm(e,t){const{leavingVNodes:s}=e;let a=s.get(t.type);return a||(a=Object.create(null),s.set(t.type,a)),a}function _i(e,t,s,a,n){const{appear:i,mode:l,persisted:o=!1,onBeforeEnter:r,onEnter:c,onAfterEnter:d,onEnterCancelled:u,onBeforeLeave:p,onLeave:m,onAfterLeave:h,onLeaveCancelled:g,onBeforeAppear:A,onAppear:I,onAfterAppear:y,onAppearCancelled:v}=t,b=String(e.key),x=tm(s,e),w=(_,R)=>{_&&Ds(_,a,9,R)},C=(_,R)=>{const $=R[1];w(_,R),Ee(_)?_.every(S=>S.length<=1)&&$():_.length<=1&&$()},E={mode:l,persisted:o,beforeEnter(_){let R=r;if(!s.isMounted)if(i)R=A||r;else return;_[zs]&&_[zs](!0);const $=x[b];$&&ea(e,$)&&$.el[zs]&&$.el[zs](),w(R,[_])},enter(_){if(x[b]===e)return;let R=c,$=d,S=u;if(!s.isMounted)if(i)R=I||c,$=y||d,S=v||u;else return;let M=!1;_[Fi]=W=>{M||(M=!0,W?w(S,[_]):w($,[_]),E.delayedLeave&&E.delayedLeave(),_[Fi]=void 0)};const Q=_[Fi].bind(null,!1);R?C(R,[_,Q]):Q()},leave(_,R){const $=String(e.key);if(_[Fi]&&_[Fi](!0),s.isUnmounting)return R();w(p,[_]);let S=!1;_[zs]=Q=>{S||(S=!0,R(),Q?w(g,[_]):w(h,[_]),_[zs]=void 0,x[$]===e&&delete x[$])};const M=_[zs].bind(null,!1);x[$]=e,m?C(m,[_,M]):M()},clone(_){const R=_i(_,t,s,a,n);return n&&n(R),R}};return E}function Nr(e){if(Dl(e))return e=ba(e),e.children=null,e}function ru(e){if(!Dl(e))return Yf(e.type)&&e.children?Xf(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&$e(s.default))return s.default()}}function qa(e,t){e.shapeFlag&6&&e.component?(e.transition=t,qa(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function or(e,t=!1,s){let a=[],n=0;for(let i=0;i<e.length;i++){let l=e[i];const o=s==null?l.key:String(s)+String(l.key!=null?l.key:i);l.type===Yt?(l.patchFlag&128&&n++,a=a.concat(or(l.children,t,o))):(t||l.type!==Ft)&&a.push(o!=null?ba(l,{key:o}):l)}if(n>1)for(let i=0;i<a.length;i++)a[i].patchFlag=-2;return a}function Nl(e,t){return $e(e)?Qe({name:e.name},t,{setup:e}):e}function Rb(){const e=_s();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function ad(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function Ib(e){const t=_s(),s=Yc(null);if(t){const n=t.refs===et?t.refs={}:t.refs;Object.defineProperty(n,e,{enumerable:!0,get:()=>s.value,set:i=>s.value=i})}return s}function cu(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const So=new WeakMap;function hi(e,t,s,a,n=!1){if(Ee(e)){e.forEach((g,A)=>hi(g,t&&(Ee(t)?t[A]:t),s,a,n));return}if(Ba(a)&&!n){a.shapeFlag&512&&a.type.__asyncResolved&&a.component.subTree.component&&hi(e,t,s,a.component.subTree);return}const i=a.shapeFlag&4?Ml(a.component):a.el,l=n?null:i,{i:o,r}=e,c=t&&t.r,d=o.refs===et?o.refs={}:o.refs,u=o.setupState,p=at(u),m=u===et?oi:g=>cu(d,g)?!1:pt(p,g),h=(g,A)=>!(A&&cu(d,A));if(c!=null&&c!==r){if(du(t),ze(c))d[c]=null,m(c)&&(u[c]=null);else if(Ht(c)){const g=t;h(c,g.k)&&(c.value=null),g.k&&(d[g.k]=null)}}if($e(r))Ni(r,o,12,[l,d]);else{const g=ze(r),A=Ht(r);if(g||A){const I=()=>{if(e.f){const y=g?m(r)?u[r]:d[r]:h()||!e.k?r.value:d[e.k];if(n)Ee(y)&&Vc(y,i);else if(Ee(y))y.includes(i)||y.push(i);else if(g)d[r]=[i],m(r)&&(u[r]=d[r]);else{const v=[i];h(r,e.k)&&(r.value=v),e.k&&(d[e.k]=v)}}else g?(d[r]=l,m(r)&&(u[r]=l)):A&&(h(r,e.k)&&(r.value=l),e.k&&(d[e.k]=l))};if(l){const y=()=>{I(),So.delete(e)};y.id=-1,So.set(e,y),Ut(y,s)}else du(e),I()}}}function du(e){const t=So.get(e);t&&(t.flags|=8,So.delete(e))}let uu=!1;const Qn=()=>{uu||(console.error("Hydration completed but contains mismatches."),uu=!0)},Ob=e=>e.namespaceURI.includes("svg")&&e.tagName!=="foreignObject",Lb=e=>e.namespaceURI.includes("MathML"),Kl=e=>{if(e.nodeType===1){if(Ob(e))return"svg";if(Lb(e))return"mathml"}},ri=e=>e.nodeType===8;function Nb(e){const{mt:t,p:s,o:{patchProp:a,createText:n,nextSibling:i,parentNode:l,remove:o,insert:r,createComment:c}}=e,d=(v,b)=>{if(!b.hasChildNodes()){s(null,v,b),ko(),b._vnode=v;return}u(b.firstChild,v,null,null,null),ko(),b._vnode=v},u=(v,b,x,w,C,E=!1)=>{E=E||!!b.dynamicChildren;const _=ri(v)&&v.data==="[",R=()=>g(v,b,x,w,C,_),{type:$,ref:S,shapeFlag:M,patchFlag:Q}=b;let W=v.nodeType;b.el=v,Q===-2&&(E=!1,b.dynamicChildren=null);let D=null;switch($){case dn:W!==3?b.children===""?(r(b.el=n(""),l(v),v),D=v):D=R():(v.data!==b.children&&(Qn(),v.data=b.children),D=i(v));break;case Ft:y(v)?(D=i(v),I(b.el=v.content.firstChild,v,x)):W!==8||_?D=R():D=i(v);break;case On:if(_&&(v=i(v),W=v.nodeType),W===1||W===3){D=v;const O=!b.children.length;for(let N=0;N<b.staticCount;N++)O&&(b.children+=D.nodeType===1?D.outerHTML:D.data),N===b.staticCount-1&&(b.anchor=D),D=i(D);return _?i(D):D}else R();break;case Yt:_?D=h(v,b,x,w,C,E):D=R();break;default:if(M&1)(W!==1||b.type.toLowerCase()!==v.tagName.toLowerCase())&&!y(v)?D=R():D=p(v,b,x,w,C,E);else if(M&6){b.slotScopeIds=C;const O=l(v);if(_?D=A(v):ri(v)&&v.data==="teleport start"?D=A(v,v.data,"teleport end"):D=i(v),t(b,O,null,x,w,Kl(O),E),Ba(b)&&!b.type.__asyncResolved){let N;_?(N=Et(Yt),N.anchor=D?D.previousSibling:O.lastChild):N=v.nodeType===3?fd(""):Et("div"),N.el=v,b.component.subTree=N}}else M&64?W!==8?D=R():D=b.type.hydrate(v,b,x,w,C,E,e,m):M&128&&(D=b.type.hydrate(v,b,x,w,Kl(l(v)),C,E,e,u))}return S!=null&&hi(S,null,w,b),D},p=(v,b,x,w,C,E)=>{E=E||!!b.dynamicChildren;const{type:_,props:R,patchFlag:$,shapeFlag:S,dirs:M,transition:Q}=b,W=_==="input"||_==="option";if(W||$!==-1){M&&ma(b,null,x,"created");let D=!1;if(y(v)){D=Cm(null,Q)&&x&&x.vnode.props&&x.vnode.props.appear;const N=v.content.firstChild;if(D){const ie=N.getAttribute("class");ie&&(N.$cls=ie),Q.beforeEnter(N)}I(N,v,x),b.el=v=N}if(S&16&&!(R&&(R.innerHTML||R.textContent))){let N=m(v.firstChild,b,v,x,w,C,E);for(N&&!Jl(v,1)&&Qn();N;){const ie=N;N=N.nextSibling,o(ie)}}else if(S&8){let N=b.children;N[0]===`
`&&(v.tagName==="PRE"||v.tagName==="TEXTAREA")&&(N=N.slice(1));const{textContent:ie}=v;ie!==N&&ie!==N.replace(/\r\n|\r/g,`
`)&&(Jl(v,0)||Qn(),v.textContent=b.children)}if(R){if(W||!E||$&48){const N=v.tagName.includes("-");for(const ie in R)(W&&(ie.endsWith("value")||ie==="indeterminate")||$n(ie)&&!$a(ie)||ie[0]==="."||N&&!$a(ie))&&a(v,ie,null,R[ie],void 0,x)}else if(R.onClick)a(v,"onClick",null,R.onClick,void 0,x);else if($&4&&Ua(R.style))for(const N in R.style)R.style[N]}let O;(O=R&&R.onVnodeBeforeMount)&&Ss(O,x,b),M&&ma(b,null,x,"beforeMount"),((O=R&&R.onVnodeMounted)||M||D)&&Im(()=>{O&&Ss(O,x,b),D&&Q.enter(v),M&&ma(b,null,x,"mounted")},w)}return v.nextSibling},m=(v,b,x,w,C,E,_)=>{_=_||!!b.dynamicChildren;const R=b.children,$=R.length;let S=!1;for(let M=0;M<$;M++){const Q=_?R[M]:R[M]=Cs(R[M]),W=Q.type===dn;v?(W&&!_&&M+1<$&&Cs(R[M+1]).type===dn&&(r(n(v.data.slice(Q.children.length)),x,i(v)),v.data=Q.children),v=u(v,Q,w,C,E,_)):W&&!Q.children?r(Q.el=n(""),x):(S||(S=!0,Jl(x,1)||Qn()),s(null,Q,x,null,w,C,Kl(x),E))}return v},h=(v,b,x,w,C,E)=>{const{slotScopeIds:_}=b;_&&(C=C?C.concat(_):_);const R=l(v),$=m(i(v),b,R,x,w,C,E);return $&&ri($)&&$.data==="]"?i(b.anchor=$):(Qn(),r(b.anchor=c("]"),R,$),$)},g=(v,b,x,w,C,E)=>{if(Jl(v.parentElement,1)||Qn(),b.el=null,E){const $=A(v);for(;;){const S=i(v);if(S&&S!==$)o(S);else break}}const _=i(v),R=l(v);return o(v),s(null,b,R,_,x,w,Kl(R),C),x&&(x.vnode.el=b.el,pr(x,b.el)),_},A=(v,b="[",x="]")=>{let w=0;for(;v;)if(v=i(v),v&&ri(v)&&(v.data===b&&w++,v.data===x)){if(w===0)return i(v);w--}return v},I=(v,b,x)=>{const w=b.parentNode;w&&w.replaceChild(v,b);let C=x;for(;C;)C.vnode.el===b&&(C.vnode.el=C.subTree.el=v),C=C.parent},y=v=>v.nodeType===1&&v.tagName==="TEMPLATE";return[d,u]}const pu="data-allow-mismatch",Db={0:"text",1:"children",2:"class",3:"style",4:"attribute"};function Jl(e,t){if(t===0||t===1)for(;e&&!e.hasAttribute(pu);)e=e.parentElement;const s=e&&e.getAttribute(pu);if(s==null)return!1;if(s==="")return!0;{const a=s.split(",");return t===0&&a.includes("children")?!0:a.includes(Db[t])}}const Mb=er().requestIdleCallback||(e=>setTimeout(e,1)),Pb=er().cancelIdleCallback||(e=>clearTimeout(e)),Fb=(e=1e4)=>t=>{const s=Mb(t,{timeout:e});return()=>Pb(s)};function $b(e){const{top:t,left:s,bottom:a,right:n}=e.getBoundingClientRect(),{innerHeight:i,innerWidth:l}=window;return(t>0&&t<i||a>0&&a<i)&&(s>0&&s<l||n>0&&n<l)}const Ub=e=>(t,s)=>{const a=new IntersectionObserver(n=>{for(const i of n)if(i.isIntersecting){a.disconnect(),t();break}},e);return s(n=>{if(n instanceof Element){if($b(n))return t(),a.disconnect(),!1;a.observe(n)}}),()=>a.disconnect()},Bb=e=>t=>{if(e){const s=matchMedia(e);if(s.matches)t();else return s.addEventListener("change",t,{once:!0}),()=>s.removeEventListener("change",t)}},Hb=(e=[])=>(t,s)=>{ze(e)&&(e=[e]);let a=!1;const n=l=>{a||(a=!0,i(),t(),l.target.dispatchEvent(new l.constructor(l.type,l)))},i=()=>{s(l=>{for(const o of e)l.removeEventListener(o,n)})};return s(l=>{for(const o of e)l.addEventListener(o,n,{once:!0})}),i};function zb(e,t){if(ri(e)&&e.data==="["){let s=1,a=e.nextSibling;for(;a;){if(a.nodeType===1){if(t(a)===!1)break}else if(ri(a))if(a.data==="]"){if(--s===0)break}else a.data==="["&&s++;a=a.nextSibling}}else t(e)}const Ba=e=>!!e.type.__asyncLoader;function jb(e){$e(e)&&(e={loader:e});const{loader:t,loadingComponent:s,errorComponent:a,delay:n=200,hydrate:i,timeout:l,suspensible:o=!0,onError:r}=e;let c=null,d,u=0;const p=()=>(u++,c=null,m()),m=()=>{let h;return c||(h=c=t().catch(g=>{if(g=g instanceof Error?g:new Error(String(g)),r)return new Promise((A,I)=>{r(g,()=>A(p()),()=>I(g),u+1)});throw g}).then(g=>h!==c&&c?c:(g&&(g.__esModule||g[Symbol.toStringTag]==="Module")&&(g=g.default),d=g,g)))};return Nl({name:"AsyncComponentWrapper",__asyncLoader:m,__asyncHydrate(h,g,A){let I=!1;(g.bu||(g.bu=[])).push(()=>I=!0);const y=()=>{I||A()},v=i?()=>{const b=i(y,x=>zb(h,x));b&&(g.bum||(g.bum=[])).push(b)}:y;d?v():m().then(()=>!g.isUnmounted&&v())},get __asyncResolved(){return d},setup(){const h=ss;if(ad(h),d)return()=>Zl(d,h);const g=x=>{c=null,Hn(x,h,13,!a)};if(o&&h.suspense||Mn)return m().then(x=>()=>Zl(x,h)).catch(x=>(g(x),()=>a?Et(a,{error:x}):null));const A=f(!1),I=f(),y=f(!!n);let v,b;return gt(()=>{v!=null&&clearTimeout(v),b!=null&&clearTimeout(b)}),n&&(b=setTimeout(()=>{h.isUnmounted||(y.value=!1)},n)),l!=null&&(v=setTimeout(()=>{if(!h.isUnmounted&&!A.value&&!I.value){const x=new Error(`Async component timed out after ${l}ms.`);g(x),I.value=x}},l)),m().then(()=>{h.isUnmounted||(A.value=!0,h.parent&&Dl(h.parent.vnode)&&h.parent.update())}).catch(x=>{if(h.isUnmounted){c=null;return}g(x),I.value=x}),()=>{if(A.value&&d)return Zl(d,h);if(I.value&&a)return Et(a,{error:I.value});if(s&&!y.value)return Zl(s,h)}}})}function Zl(e,t){const{ref:s,props:a,children:n,ce:i}=t.vnode,l=Et(e,a,n);return l.ref=s,l.ce=i,delete t.vnode.ce,l}const Dl=e=>e.type.__isKeepAlive,Vb={name:"KeepAlive",__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){const s=_s(),a=s.ctx;if(!a.renderer)return()=>{const y=t.default&&t.default();return y&&y.length===1?y[0]:y};const n=new Map,i=new Set;let l=null;const o=s.suspense,{renderer:{p:r,m:c,um:d,o:{createElement:u}}}=a,p=u("div");a.activate=(y,v,b,x,w)=>{const C=y.component;c(y,v,b,0,o),r(C.vnode,y,v,b,C,o,x,y.slotScopeIds,w),Ut(()=>{C.isDeactivated=!1,C.a&&fi(C.a);const E=y.props&&y.props.onVnodeMounted;E&&Ss(E,C.parent,y)},o)},a.deactivate=y=>{const v=y.component;Co(v.m),Co(v.a),c(y,p,null,1,o),Ut(()=>{v.da&&fi(v.da);const b=y.props&&y.props.onVnodeUnmounted;b&&Ss(b,v.parent,y),v.isDeactivated=!0},o)};function m(y){Dr(y),d(y,s,o,!0)}function h(y){n.forEach((v,b)=>{const x=gc(Ba(v)?v.type.__asyncResolved||{}:v.type);x&&!y(x)&&g(b)})}function g(y){const v=n.get(y);v&&(!l||!ea(v,l))?m(v):l&&Dr(l),n.delete(y),i.delete(y)}zt(()=>[e.include,e.exclude],([y,v])=>{y&&h(b=>Ki(y,b)),v&&h(b=>!Ki(v,b))},{flush:"post",deep:!0});let A=null;const I=()=>{A!=null&&(Eo(s.subTree.type)?Ut(()=>{n.set(A,Yl(s.subTree))},s.subTree.suspense):n.set(A,Yl(s.subTree)))};return Ye(I),cr(I),dr(()=>{n.forEach(y=>{const{subTree:v,suspense:b}=s,x=Yl(v);if(y.type===x.type&&y.key===x.key){Dr(x);const w=x.component.da;w&&Ut(w,b);return}m(y)})}),()=>{if(A=null,!t.default)return l=null;const y=t.default(),v=y[0];if(y.length>1)return l=null,y;if(!Ga(v)||!(v.shapeFlag&4)&&!(v.shapeFlag&128))return l=null,v;let b=Yl(v);if(b.type===Ft)return l=null,b;const x=b.type,w=gc(Ba(b)?b.type.__asyncResolved||{}:x),{include:C,exclude:E,max:_}=e;if(C&&(!w||!Ki(C,w))||E&&w&&Ki(E,w))return b.shapeFlag&=-257,l=b,v;const R=b.key==null?x:b.key,$=n.get(R);return b.el&&(b=ba(b),v.shapeFlag&128&&(v.ssContent=b)),A=R,$?(b.el=$.el,b.component=$.component,b.transition&&qa(b,b.transition),b.shapeFlag|=512,i.delete(R),i.add(R)):(i.add(R),_&&i.size>parseInt(_,10)&&g(i.values().next().value)),b.shapeFlag|=256,l=b,Eo(v.type)?v:b}}},qb=Vb;function Ki(e,t){return Ee(e)?e.some(s=>Ki(s,t)):ze(e)?e.split(",").includes(t):tg(e)?(e.lastIndex=0,e.test(t)):!1}function is(e,t){sm(e,"a",t)}function Jt(e,t){sm(e,"da",t)}function sm(e,t,s=ss){const a=e.__wdc||(e.__wdc=()=>{let n=s;for(;n;){if(n.isDeactivated)return;n=n.parent}return e()});if(rr(t,a,s),s){let n=s.parent;for(;n&&n.parent;)Dl(n.parent.vnode)&&Gb(a,t,s,n),n=n.parent}}function Gb(e,t,s,a){const n=rr(t,e,a,!0);gt(()=>{Vc(a[t],n)},s)}function Dr(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function Yl(e){return e.shapeFlag&128?e.ssContent:e}function rr(e,t,s=ss,a=!1){if(s){const n=s[e]||(s[e]=[]),i=t.__weh||(t.__weh=(...l)=>{ja();const o=Di(s),r=Ds(t,s,e,l);return o(),Va(),r});return a?n.unshift(i):n.push(i),i}}const Wa=e=>(t,s=ss)=>{(!Mn||e==="sp")&&rr(e,(...a)=>t(...a),s)},am=Wa("bm"),Ye=Wa("m"),nd=Wa("bu"),cr=Wa("u"),dr=Wa("bum"),gt=Wa("um"),nm=Wa("sp"),im=Wa("rtg"),lm=Wa("rtc");function om(e,t=ss){rr("ec",e,t)}const id="components",Wb="directives";function Kb(e,t){return ld(id,e,!0,t)||e}const rm=Symbol.for("v-ndc");function Jb(e){return ze(e)?ld(id,e,!1)||e:e||rm}function Zb(e){return ld(Wb,e)}function ld(e,t,s=!0,a=!1){const n=as||ss;if(n){const i=n.type;if(e===id){const o=gc(i,!1);if(o&&(o===t||o===yt(t)||o===Bn(yt(t))))return i}const l=fu(n[e]||i[e],t)||fu(n.appContext[e],t);return!l&&a?i:l}}function fu(e,t){return e&&(e[t]||e[yt(t)]||e[Bn(yt(t))])}function Yb(e,t,s,a){let n;const i=s&&s[a],l=Ee(e);if(l||ze(e)){const o=l&&Ua(e);let r=!1,c=!1;o&&(r=!Rs(e),c=ga(e),e=ar(e)),n=new Array(e.length);for(let d=0,u=e.length;d<u;d++)n[d]=t(r?c?xi(aa(e[d])):aa(e[d]):e[d],d,void 0,i&&i[d])}else if(typeof e=="number"){n=new Array(e);for(let o=0;o<e;o++)n[o]=t(o+1,o,void 0,i&&i[o])}else if(rt(e))if(e[Symbol.iterator])n=Array.from(e,(o,r)=>t(o,r,void 0,i&&i[r]));else{const o=Object.keys(e);n=new Array(o.length);for(let r=0,c=o.length;r<c;r++){const d=o[r];n[r]=t(e[d],d,r,i&&i[r])}}else n=[];return s&&(s[a]=n),n}function Qb(e,t){for(let s=0;s<t.length;s++){const a=t[s];if(Ee(a))for(let n=0;n<a.length;n++)e[a[n].name]=a[n].fn;else a&&(e[a.name]=a.key?(...n)=>{const i=a.fn(...n);return i&&(i.key=a.key),i}:a.fn)}return e}function Xb(e,t,s={},a,n){if(as.ce||as.parent&&Ba(as.parent)&&as.parent.ce){const c=Object.keys(s).length>0;return t!=="default"&&(s.name=t),vl(),Ao(Yt,null,[Et("slot",s,a&&a())],c?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),vl();const l=i&&od(i(s)),o=s.key||l&&l.key,r=Ao(Yt,{key:(o&&!ms(o)?o:`_${t}`)+(!l&&a?"_fb":"")},l||(a?a():[]),l&&e._===1?64:-2);return!n&&r.scopeId&&(r.slotScopeIds=[r.scopeId+"-s"]),i&&i._c&&(i._d=!0),r}function od(e){return e.some(t=>Ga(t)?!(t.type===Ft||t.type===Yt&&!od(t.children)):!0)?e:null}function ey(e,t){const s={};for(const a in e)s[t&&/[A-Z]/.test(a)?`on:${a}`:pi(a)]=e[a];return s}const cc=e=>e?$m(e)?Ml(e):cc(e.parent):null,tl=Qe(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>cc(e.parent),$root:e=>cc(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>rd(e),$forceUpdate:e=>e.f||(e.f=()=>{Xc(e.update)}),$nextTick:e=>e.n||(e.n=Pt.bind(e.proxy)),$watch:e=>kb.bind(e)}),Mr=(e,t)=>e!==et&&!e.__isScriptSetup&&pt(e,t),dc={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:a,data:n,props:i,accessCache:l,type:o,appContext:r}=e;if(t[0]!=="$"){const p=l[t];if(p!==void 0)switch(p){case 1:return a[t];case 2:return n[t];case 4:return s[t];case 3:return i[t]}else{if(Mr(a,t))return l[t]=1,a[t];if(n!==et&&pt(n,t))return l[t]=2,n[t];if(pt(i,t))return l[t]=3,i[t];if(s!==et&&pt(s,t))return l[t]=4,s[t];uc&&(l[t]=0)}}const c=tl[t];let d,u;if(c)return t==="$attrs"&&us(e.attrs,"get",""),c(e);if((d=o.__cssModules)&&(d=d[t]))return d;if(s!==et&&pt(s,t))return l[t]=4,s[t];if(u=r.config.globalProperties,pt(u,t))return u[t]},set({_:e},t,s){const{data:a,setupState:n,ctx:i}=e;return Mr(n,t)?(n[t]=s,!0):a!==et&&pt(a,t)?(a[t]=s,!0):pt(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:a,appContext:n,props:i,type:l}},o){let r;return!!(s[o]||e!==et&&o[0]!=="$"&&pt(e,o)||Mr(t,o)||pt(i,o)||pt(a,o)||pt(tl,o)||pt(n.config.globalProperties,o)||(r=l.__cssModules)&&r[o])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:pt(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}},ty=Qe({},dc,{get(e,t){if(t!==Symbol.unscopables)return dc.get(e,t,e)},has(e,t){return t[0]!=="_"&&!rg(t)}});function sy(){return null}function ay(){return null}function ny(e){}function iy(e){}function ly(){return null}function oy(){}function ry(e,t){return null}function cy(){return cm().slots}function dy(){return cm().attrs}function cm(e){const t=_s();return t.setupContext||(t.setupContext=zm(t))}function ml(e){return Ee(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}function uy(e,t){const s=ml(e);for(const a in t){if(a.startsWith("__skip"))continue;let n=s[a];n?Ee(n)||$e(n)?n=s[a]={type:n,default:t[a]}:n.default=t[a]:n===null&&(n=s[a]={default:t[a]}),n&&t[`__skip_${a}`]&&(n.skipFactory=!0)}return s}function py(e,t){return!e||!t?e||t:Ee(e)&&Ee(t)?e.concat(t):Qe({},ml(e),ml(t))}function fy(e,t){const s={};for(const a in e)t.includes(a)||Object.defineProperty(s,a,{enumerable:!0,get:()=>e[a]});return s}function my(e){const t=_s(),s=Mn;let a=e();bl(),s&&gi(!1);const n=()=>{Di(t),s&&gi(!0)},i=()=>{_s()!==t&&t.scope.off(),bl(),s&&gi(!1)};return qc(a)&&(a=a.catch(l=>{throw n(),Promise.resolve().then(()=>Promise.resolve().then(i)),l})),[a,()=>{n(),Promise.resolve().then(i)}]}let uc=!0;function hy(e){const t=rd(e),s=e.proxy,a=e.ctx;uc=!1,t.beforeCreate&&mu(t.beforeCreate,e,"bc");const{data:n,computed:i,methods:l,watch:o,provide:r,inject:c,created:d,beforeMount:u,mounted:p,beforeUpdate:m,updated:h,activated:g,deactivated:A,beforeDestroy:I,beforeUnmount:y,destroyed:v,unmounted:b,render:x,renderTracked:w,renderTriggered:C,errorCaptured:E,serverPrefetch:_,expose:R,inheritAttrs:$,components:S,directives:M,filters:Q}=t;if(c&&vy(c,a,null),l)for(const O in l){const N=l[O];$e(N)&&(a[O]=N.bind(s))}if(n){const O=n.call(s,s);rt(O)&&(e.data=fn(O))}if(uc=!0,i)for(const O in i){const N=i[O],ie=$e(N)?N.bind(s,s):$e(N.get)?N.get.bind(s,s):ns,le=!$e(N)&&$e(N.set)?N.set.bind(s):ns,B=j({get:ie,set:le});Object.defineProperty(a,O,{enumerable:!0,configurable:!0,get:()=>B.value,set:J=>B.value=J})}if(o)for(const O in o)dm(o[O],a,s,O);if(r){const O=$e(r)?r.call(s):r;Reflect.ownKeys(O).forEach(N=>{el(N,O[N])})}d&&mu(d,e,"c");function D(O,N){Ee(N)?N.forEach(ie=>O(ie.bind(s))):N&&O(N.bind(s))}if(D(am,u),D(Ye,p),D(nd,m),D(cr,h),D(is,g),D(Jt,A),D(om,E),D(lm,w),D(im,C),D(dr,y),D(gt,b),D(nm,_),Ee(R))if(R.length){const O=e.exposed||(e.exposed={});R.forEach(N=>{Object.defineProperty(O,N,{get:()=>s[N],set:ie=>s[N]=ie,enumerable:!0})})}else e.exposed||(e.exposed={});x&&e.render===ns&&(e.render=x),$!=null&&(e.inheritAttrs=$),S&&(e.components=S),M&&(e.directives=M),_&&ad(e)}function vy(e,t,s=ns){Ee(e)&&(e=pc(e));for(const a in e){const n=e[a];let i;rt(n)?"default"in n?i=Gs(n.from||a,n.default,!0):i=Gs(n.from||a):i=Gs(n),Ht(i)?Object.defineProperty(t,a,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):t[a]=i}}function mu(e,t,s){Ds(Ee(e)?e.map(a=>a.bind(t.proxy)):e.bind(t.proxy),t,s)}function dm(e,t,s,a){let n=a.includes(".")?Jf(s,a):()=>s[a];if(ze(e)){const i=t[e];$e(i)&&zt(n,i)}else if($e(e))zt(n,e.bind(s));else if(rt(e))if(Ee(e))e.forEach(i=>dm(i,t,s,a));else{const i=$e(e.handler)?e.handler.bind(s):t[e.handler];$e(i)&&zt(n,i,e)}}function rd(e){const t=e.type,{mixins:s,extends:a}=t,{mixins:n,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,o=i.get(t);let r;return o?r=o:!n.length&&!s&&!a?r=t:(r={},n.length&&n.forEach(c=>To(r,c,l,!0)),To(r,t,l)),rt(t)&&i.set(t,r),r}function To(e,t,s,a=!1){const{mixins:n,extends:i}=t;i&&To(e,i,s,!0),n&&n.forEach(l=>To(e,l,s,!0));for(const l in t)if(!(a&&l==="expose")){const o=gy[l]||s&&s[l];e[l]=o?o(e[l],t[l]):t[l]}return e}const gy={data:hu,props:vu,emits:vu,methods:Ji,computed:Ji,beforeCreate:vs,created:vs,beforeMount:vs,mounted:vs,beforeUpdate:vs,updated:vs,beforeDestroy:vs,beforeUnmount:vs,destroyed:vs,unmounted:vs,activated:vs,deactivated:vs,errorCaptured:vs,serverPrefetch:vs,components:Ji,directives:Ji,watch:yy,provide:hu,inject:by};function hu(e,t){return t?e?function(){return Qe($e(e)?e.call(this,this):e,$e(t)?t.call(this,this):t)}:t:e}function by(e,t){return Ji(pc(e),pc(t))}function pc(e){if(Ee(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function vs(e,t){return e?[...new Set([].concat(e,t))]:t}function Ji(e,t){return e?Qe(Object.create(null),e,t):t}function vu(e,t){return e?Ee(e)&&Ee(t)?[...new Set([...e,...t])]:Qe(Object.create(null),ml(e),ml(t??{})):t}function yy(e,t){if(!e)return t;if(!t)return e;const s=Qe(Object.create(null),e);for(const a in t)s[a]=vs(e[a],t[a]);return s}function um(){return{app:null,config:{isNativeTag:oi,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let xy=0;function _y(e,t){return function(a,n=null){$e(a)||(a=Qe({},a)),n!=null&&!rt(n)&&(n=null);const i=um(),l=new WeakSet,o=[];let r=!1;const c=i.app={_uid:xy++,_component:a,_props:n,_container:null,_context:i,_instance:null,version:Vm,get config(){return i.config},set config(d){},use(d,...u){return l.has(d)||(d&&$e(d.install)?(l.add(d),d.install(c,...u)):$e(d)&&(l.add(d),d(c,...u))),c},mixin(d){return i.mixins.includes(d)||i.mixins.push(d),c},component(d,u){return u?(i.components[d]=u,c):i.components[d]},directive(d,u){return u?(i.directives[d]=u,c):i.directives[d]},mount(d,u,p){if(!r){const m=c._ceVNode||Et(a,n);return m.appContext=i,p===!0?p="svg":p===!1&&(p=void 0),u&&t?t(m,d):e(m,d,p),r=!0,c._container=d,d.__vue_app__=c,Ml(m.component)}},onUnmount(d){o.push(d)},unmount(){r&&(Ds(o,c._instance,16),e(null,c._container),delete c._container.__vue_app__)},provide(d,u){return i.provides[d]=u,c},runWithContext(d){const u=In;In=c;try{return d()}finally{In=u}}};return c}}let In=null;function wy(e,t,s=et){const a=_s(),n=yt(t),i=Es(t),l=pm(e,n),o=$f((r,c)=>{let d,u=et,p;return Kf(()=>{const m=e[n];Zt(d,m)&&(d=m,c())}),{get(){return r(),s.get?s.get(d):d},set(m){const h=s.set?s.set(m):m;if(!Zt(h,d)&&!(u!==et&&Zt(m,u)))return;const g=a.vnode.props,A=!!(g&&(t in g||n in g||i in g)&&(`onUpdate:${t}`in g||`onUpdate:${n}`in g||`onUpdate:${i}`in g));A||(d=m,c()),a.emit(`update:${t}`,h),Zt(m,u)&&(Zt(m,h)&&!Zt(h,p)||A&&u!==et&&!Zt(h,d))&&c(),u=m,p=h}}});return o[Symbol.iterator]=()=>{let r=0;return{next(){return r<2?{value:r++?l||et:o,done:!1}:{done:!0}}}},o}const pm=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${yt(t)}Modifiers`]||e[`${Es(t)}Modifiers`];function ky(e,t,...s){if(e.isUnmounted)return;const a=e.vnode.props||et;let n=s;const i=t.startsWith("update:"),l=i&&pm(a,t.slice(7));l&&(l.trim&&(n=s.map(d=>ze(d)?d.trim():d)),l.number&&(n=s.map(Xo)));let o,r=a[o=pi(t)]||a[o=pi(yt(t))];!r&&i&&(r=a[o=pi(Es(t))]),r&&Ds(r,e,6,n);const c=a[o+"Once"];if(c){if(!e.emitted)e.emitted={};else if(e.emitted[o])return;e.emitted[o]=!0,Ds(c,e,6,n)}}const Sy=new WeakMap;function fm(e,t,s=!1){const a=s?Sy:t.emitsCache,n=a.get(e);if(n!==void 0)return n;const i=e.emits;let l={},o=!1;if(!$e(e)){const r=c=>{const d=fm(c,t,!0);d&&(o=!0,Qe(l,d))};!s&&t.mixins.length&&t.mixins.forEach(r),e.extends&&r(e.extends),e.mixins&&e.mixins.forEach(r)}return!i&&!o?(rt(e)&&a.set(e,null),null):(Ee(i)?i.forEach(r=>l[r]=null):Qe(l,i),rt(e)&&a.set(e,l),l)}function ur(e,t){return!e||!$n(t)?!1:(t=t.slice(2).replace(/Once$/,""),pt(e,t[0].toLowerCase()+t.slice(1))||pt(e,Es(t))||pt(e,t))}function co(e){const{type:t,vnode:s,proxy:a,withProxy:n,propsOptions:[i],slots:l,attrs:o,emit:r,render:c,renderCache:d,props:u,data:p,setupState:m,ctx:h,inheritAttrs:g}=e,A=fl(e);let I,y;try{if(s.shapeFlag&4){const b=n||a,x=b;I=Cs(c.call(x,b,d,u,m,p,h)),y=o}else{const b=t;I=Cs(b.length>1?b(u,{attrs:o,slots:l,emit:r}):b(u,null)),y=t.props?o:Cy(o)}}catch(b){sl.length=0,Hn(b,e,1),I=Et(Ft)}let v=I;if(y&&g!==!1){const b=Object.keys(y),{shapeFlag:x}=v;b.length&&x&7&&(i&&b.some(Jo)&&(y=Ey(y,i)),v=ba(v,y,!1,!0))}return s.dirs&&(v=ba(v,null,!1,!0),v.dirs=v.dirs?v.dirs.concat(s.dirs):s.dirs),s.transition&&qa(v,s.transition),I=v,fl(A),I}function Ty(e,t=!0){let s;for(let a=0;a<e.length;a++){const n=e[a];if(Ga(n)){if(n.type!==Ft||n.children==="v-if"){if(s)return;s=n}}else return}return s}const Cy=e=>{let t;for(const s in e)(s==="class"||s==="style"||$n(s))&&((t||(t={}))[s]=e[s]);return t},Ey=(e,t)=>{const s={};for(const a in e)(!Jo(a)||!(a.slice(9)in t))&&(s[a]=e[a]);return s};function Ay(e,t,s){const{props:a,children:n,component:i}=e,{props:l,children:o,patchFlag:r}=t,c=i.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&r>=0){if(r&1024)return!0;if(r&16)return a?gu(a,l,c):!!l;if(r&8){const d=t.dynamicProps;for(let u=0;u<d.length;u++){const p=d[u];if(mm(l,a,p)&&!ur(c,p))return!0}}}else return(n||o)&&(!o||!o.$stable)?!0:a===l?!1:a?l?gu(a,l,c):!0:!!l;return!1}function gu(e,t,s){const a=Object.keys(t);if(a.length!==Object.keys(e).length)return!0;for(let n=0;n<a.length;n++){const i=a[n];if(mm(t,e,i)&&!ur(s,i))return!0}return!1}function mm(e,t,s){const a=e[s],n=t[s];return s==="style"&&rt(a)&&rt(n)?!za(a,n):a!==n}function pr({vnode:e,parent:t,suspense:s},a){for(;t;){const n=t.subTree;if(n.suspense&&n.suspense.activeBranch===e&&(n.suspense.vnode.el=n.el=a,e=n),n===e)(e=t.vnode).el=a,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=a)}const hm={},vm=()=>Object.create(hm),gm=e=>Object.getPrototypeOf(e)===hm;function Ry(e,t,s,a=!1){const n={},i=vm();e.propsDefaults=Object.create(null),bm(e,t,n,i);for(const l in e.propsOptions[0])l in n||(n[l]=void 0);s?e.props=a?n:Zc(n):e.type.props?e.props=n:e.props=i,e.attrs=i}function Iy(e,t,s,a){const{props:n,attrs:i,vnode:{patchFlag:l}}=e,o=at(n),[r]=e.propsOptions;let c=!1;if((a||l>0)&&!(l&16)){if(l&8){const d=e.vnode.dynamicProps;for(let u=0;u<d.length;u++){let p=d[u];if(ur(e.emitsOptions,p))continue;const m=t[p];if(r)if(pt(i,p))m!==i[p]&&(i[p]=m,c=!0);else{const h=yt(p);n[h]=fc(r,o,h,m,e,!1)}else m!==i[p]&&(i[p]=m,c=!0)}}}else{bm(e,t,n,i)&&(c=!0);let d;for(const u in o)(!t||!pt(t,u)&&((d=Es(u))===u||!pt(t,d)))&&(r?s&&(s[u]!==void 0||s[d]!==void 0)&&(n[u]=fc(r,o,u,void 0,e,!0)):delete n[u]);if(i!==o)for(const u in i)(!t||!pt(t,u))&&(delete i[u],c=!0)}c&&Na(e.attrs,"set","")}function bm(e,t,s,a){const[n,i]=e.propsOptions;let l=!1,o;if(t)for(let r in t){if($a(r))continue;const c=t[r];let d;n&&pt(n,d=yt(r))?!i||!i.includes(d)?s[d]=c:(o||(o={}))[d]=c:ur(e.emitsOptions,r)||(!(r in a)||c!==a[r])&&(a[r]=c,l=!0)}if(i){const r=at(s),c=o||et;for(let d=0;d<i.length;d++){const u=i[d];s[u]=fc(n,r,u,c[u],e,!pt(c,u))}}return l}function fc(e,t,s,a,n,i){const l=e[s];if(l!=null){const o=pt(l,"default");if(o&&a===void 0){const r=l.default;if(l.type!==Function&&!l.skipFactory&&$e(r)){const{propsDefaults:c}=n;if(s in c)a=c[s];else{const d=Di(n);a=c[s]=r.call(null,t),d()}}else a=r;n.ce&&n.ce._setProp(s,a)}l[0]&&(i&&!o?a=!1:l[1]&&(a===""||a===Es(s))&&(a=!0))}return a}const Oy=new WeakMap;function ym(e,t,s=!1){const a=s?Oy:t.propsCache,n=a.get(e);if(n)return n;const i=e.props,l={},o=[];let r=!1;if(!$e(e)){const d=u=>{r=!0;const[p,m]=ym(u,t,!0);Qe(l,p),m&&o.push(...m)};!s&&t.mixins.length&&t.mixins.forEach(d),e.extends&&d(e.extends),e.mixins&&e.mixins.forEach(d)}if(!i&&!r)return rt(e)&&a.set(e,di),di;if(Ee(i))for(let d=0;d<i.length;d++){const u=yt(i[d]);bu(u)&&(l[u]=et)}else if(i)for(const d in i){const u=yt(d);if(bu(u)){const p=i[d],m=l[u]=Ee(p)||$e(p)?{type:p}:Qe({},p),h=m.type;let g=!1,A=!0;if(Ee(h))for(let I=0;I<h.length;++I){const y=h[I],v=$e(y)&&y.name;if(v==="Boolean"){g=!0;break}else v==="String"&&(A=!1)}else g=$e(h)&&h.name==="Boolean";m[0]=g,m[1]=A,(g||pt(m,"default"))&&o.push(u)}}const c=[l,o];return rt(e)&&a.set(e,c),c}function bu(e){return e[0]!=="$"&&!$a(e)}const cd=e=>e==="_"||e==="_ctx"||e==="$stable",dd=e=>Ee(e)?e.map(Cs):[Cs(e)],Ly=(e,t,s)=>{if(t._n)return t;const a=ed((...n)=>dd(t(...n)),s);return a._c=!1,a},xm=(e,t,s)=>{const a=e._ctx;for(const n in e){if(cd(n))continue;const i=e[n];if($e(i))t[n]=Ly(n,i,a);else if(i!=null){const l=dd(i);t[n]=()=>l}}},_m=(e,t)=>{const s=dd(t);e.slots.default=()=>s},wm=(e,t,s)=>{for(const a in t)(s||!cd(a))&&(e[a]=t[a])},Ny=(e,t,s)=>{const a=e.slots=vm();if(e.vnode.shapeFlag&32){const n=t._;n?(wm(a,t,s),s&&mf(a,"_",n,!0)):xm(t,a)}else t&&_m(e,t)},Dy=(e,t,s)=>{const{vnode:a,slots:n}=e;let i=!0,l=et;if(a.shapeFlag&32){const o=t._;o?s&&o===1?i=!1:wm(n,t,s):(i=!t.$stable,xm(t,n)),l=t}else t&&(_m(e,t),l={default:1});if(i)for(const o in n)!cd(o)&&l[o]==null&&delete n[o]},Ut=Im;function km(e){return Tm(e)}function Sm(e){return Tm(e,Nb)}function Tm(e,t){const s=er();s.__VUE__=!0;const{insert:a,remove:n,patchProp:i,createElement:l,createText:o,createComment:r,setText:c,setElementText:d,parentNode:u,nextSibling:p,setScopeId:m=ns,insertStaticContent:h}=e,g=(T,P,V,ce=null,F=null,Y=null,re=void 0,z=null,ee=!!P.dynamicChildren)=>{if(T===P)return;T&&!ea(T,P)&&(ce=K(T),J(T,F,Y,!0),T=null),P.patchFlag===-2&&(ee=!1,P.dynamicChildren=null);const{type:G,ref:ve,shapeFlag:me}=P;switch(G){case dn:A(T,P,V,ce);break;case Ft:I(T,P,V,ce);break;case On:T==null&&y(P,V,ce,re);break;case Yt:S(T,P,V,ce,F,Y,re,z,ee);break;default:me&1?x(T,P,V,ce,F,Y,re,z,ee):me&6?M(T,P,V,ce,F,Y,re,z,ee):(me&64||me&128)&&G.process(T,P,V,ce,F,Y,re,z,ee,ge)}ve!=null&&F?hi(ve,T&&T.ref,Y,P||T,!P):ve==null&&T&&T.ref!=null&&hi(T.ref,null,Y,T,!0)},A=(T,P,V,ce)=>{if(T==null)a(P.el=o(P.children),V,ce);else{const F=P.el=T.el;P.children!==T.children&&c(F,P.children)}},I=(T,P,V,ce)=>{T==null?a(P.el=r(P.children||""),V,ce):P.el=T.el},y=(T,P,V,ce)=>{[T.el,T.anchor]=h(T.children,P,V,ce,T.el,T.anchor)},v=({el:T,anchor:P},V,ce)=>{let F;for(;T&&T!==P;)F=p(T),a(T,V,ce),T=F;a(P,V,ce)},b=({el:T,anchor:P})=>{let V;for(;T&&T!==P;)V=p(T),n(T),T=V;n(P)},x=(T,P,V,ce,F,Y,re,z,ee)=>{if(P.type==="svg"?re="svg":P.type==="math"&&(re="mathml"),T==null)w(P,V,ce,F,Y,re,z,ee);else{const G=T.el&&T.el._isVueCE?T.el:null;try{G&&G._beginPatch(),_(T,P,F,Y,re,z,ee)}finally{G&&G._endPatch()}}},w=(T,P,V,ce,F,Y,re,z)=>{let ee,G;const{props:ve,shapeFlag:me,transition:ye,dirs:Ie}=T;if(ee=T.el=l(T.type,Y,ve&&ve.is,ve),me&8?d(ee,T.children):me&16&&E(T.children,ee,null,ce,F,Pr(T,Y),re,z),Ie&&ma(T,null,ce,"created"),C(ee,T,T.scopeId,re,ce),ve){for(const Ve in ve)Ve!=="value"&&!$a(Ve)&&i(ee,Ve,null,ve[Ve],Y,ce);"value"in ve&&i(ee,"value",null,ve.value,Y),(G=ve.onVnodeBeforeMount)&&Ss(G,ce,T)}Ie&&ma(T,null,ce,"beforeMount");const Fe=Cm(F,ye);Fe&&ye.beforeEnter(ee),a(ee,P,V),((G=ve&&ve.onVnodeMounted)||Fe||Ie)&&Ut(()=>{try{G&&Ss(G,ce,T),Fe&&ye.enter(ee),Ie&&ma(T,null,ce,"mounted")}finally{}},F)},C=(T,P,V,ce,F)=>{if(V&&m(T,V),ce)for(let Y=0;Y<ce.length;Y++)m(T,ce[Y]);if(F){let Y=F.subTree;if(P===Y||Eo(Y.type)&&(Y.ssContent===P||Y.ssFallback===P)){const re=F.vnode;C(T,re,re.scopeId,re.slotScopeIds,F.parent)}}},E=(T,P,V,ce,F,Y,re,z,ee=0)=>{for(let G=ee;G<T.length;G++){const ve=T[G]=z?Oa(T[G]):Cs(T[G]);g(null,ve,P,V,ce,F,Y,re,z)}},_=(T,P,V,ce,F,Y,re)=>{const z=P.el=T.el;let{patchFlag:ee,dynamicChildren:G,dirs:ve}=P;ee|=T.patchFlag&16;const me=T.props||et,ye=P.props||et;let Ie;if(V&&xn(V,!1),(Ie=ye.onVnodeBeforeUpdate)&&Ss(Ie,V,P,T),ve&&ma(P,T,V,"beforeUpdate"),V&&xn(V,!0),(me.innerHTML&&ye.innerHTML==null||me.textContent&&ye.textContent==null)&&d(z,""),G?R(T.dynamicChildren,G,z,V,ce,Pr(P,F),Y):re||N(T,P,z,null,V,ce,Pr(P,F),Y,!1),ee>0){if(ee&16)$(z,me,ye,V,F);else if(ee&2&&me.class!==ye.class&&i(z,"class",null,ye.class,F),ee&4&&i(z,"style",me.style,ye.style,F),ee&8){const Fe=P.dynamicProps;for(let Ve=0;Ve<Fe.length;Ve++){const Be=Fe[Ve],qe=me[Be],Je=ye[Be];(Je!==qe||Be==="value")&&i(z,Be,qe,Je,F,V)}}ee&1&&T.children!==P.children&&d(z,P.children)}else!re&&G==null&&$(z,me,ye,V,F);((Ie=ye.onVnodeUpdated)||ve)&&Ut(()=>{Ie&&Ss(Ie,V,P,T),ve&&ma(P,T,V,"updated")},ce)},R=(T,P,V,ce,F,Y,re)=>{for(let z=0;z<P.length;z++){const ee=T[z],G=P[z],ve=ee.el&&(ee.type===Yt||!ea(ee,G)||ee.shapeFlag&198)?u(ee.el):V;g(ee,G,ve,null,ce,F,Y,re,!0)}},$=(T,P,V,ce,F)=>{if(P!==V){if(P!==et)for(const Y in P)!$a(Y)&&!(Y in V)&&i(T,Y,P[Y],null,F,ce);for(const Y in V){if($a(Y))continue;const re=V[Y],z=P[Y];re!==z&&Y!=="value"&&i(T,Y,z,re,F,ce)}"value"in V&&i(T,"value",P.value,V.value,F)}},S=(T,P,V,ce,F,Y,re,z,ee)=>{const G=P.el=T?T.el:o(""),ve=P.anchor=T?T.anchor:o("");let{patchFlag:me,dynamicChildren:ye,slotScopeIds:Ie}=P;Ie&&(z=z?z.concat(Ie):Ie),T==null?(a(G,V,ce),a(ve,V,ce),E(P.children||[],V,ve,F,Y,re,z,ee)):me>0&&me&64&&ye&&T.dynamicChildren&&T.dynamicChildren.length===ye.length?(R(T.dynamicChildren,ye,V,F,Y,re,z),(P.key!=null||F&&P===F.subTree)&&ud(T,P,!0)):N(T,P,V,ve,F,Y,re,z,ee)},M=(T,P,V,ce,F,Y,re,z,ee)=>{P.slotScopeIds=z,T==null?P.shapeFlag&512?F.ctx.activate(P,V,ce,re,ee):Q(P,V,ce,F,Y,re,ee):W(T,P,ee)},Q=(T,P,V,ce,F,Y,re)=>{const z=T.component=Fm(T,ce,F);if(Dl(T)&&(z.ctx.renderer=ge),Um(z,!1,re),z.asyncDep){if(F&&F.registerDep(z,D,re),!T.el){const ee=z.subTree=Et(Ft);I(null,ee,P,V),T.placeholder=ee.el}}else D(z,T,P,V,F,Y,re)},W=(T,P,V)=>{const ce=P.component=T.component;if(Ay(T,P,V))if(ce.asyncDep&&!ce.asyncResolved){O(ce,P,V);return}else ce.next=P,ce.update();else P.el=T.el,ce.vnode=P},D=(T,P,V,ce,F,Y,re)=>{const z=()=>{if(T.isMounted){let{next:me,bu:ye,u:Ie,parent:Fe,vnode:Ve}=T;{const We=Em(T);if(We){me&&(me.el=Ve.el,O(T,me,re)),We.asyncDep.then(()=>{Ut(()=>{T.isUnmounted||G()},F)});return}}let Be=me,qe;xn(T,!1),me?(me.el=Ve.el,O(T,me,re)):me=Ve,ye&&fi(ye),(qe=me.props&&me.props.onVnodeBeforeUpdate)&&Ss(qe,Fe,me,Ve),xn(T,!0);const Je=co(T),it=T.subTree;T.subTree=Je,g(it,Je,u(it.el),K(it),T,F,Y),me.el=Je.el,Be===null&&pr(T,Je.el),Ie&&Ut(Ie,F),(qe=me.props&&me.props.onVnodeUpdated)&&Ut(()=>Ss(qe,Fe,me,Ve),F)}else{let me;const{el:ye,props:Ie}=P,{bm:Fe,m:Ve,parent:Be,root:qe,type:Je}=T,it=Ba(P);if(xn(T,!1),Fe&&fi(Fe),!it&&(me=Ie&&Ie.onVnodeBeforeMount)&&Ss(me,Be,P),xn(T,!0),ye&&Ne){const We=()=>{T.subTree=co(T),Ne(ye,T.subTree,T,F,null)};it&&Je.__asyncHydrate?Je.__asyncHydrate(ye,T,We):We()}else{qe.ce&&qe.ce._hasShadowRoot()&&qe.ce._injectChildStyle(Je,T.parent?T.parent.type:void 0);const We=T.subTree=co(T);g(null,We,V,ce,T,F,Y),P.el=We.el}if(Ve&&Ut(Ve,F),!it&&(me=Ie&&Ie.onVnodeMounted)){const We=P;Ut(()=>Ss(me,Be,We),F)}(P.shapeFlag&256||Be&&Ba(Be.vnode)&&Be.vnode.shapeFlag&256)&&T.a&&Ut(T.a,F),T.isMounted=!0,P=V=ce=null}};T.scope.on();const ee=T.effect=new rl(z);T.scope.off();const G=T.update=ee.run.bind(ee),ve=T.job=ee.runIfDirty.bind(ee);ve.i=T,ve.id=T.uid,ee.scheduler=()=>Xc(ve),xn(T,!0),G()},O=(T,P,V)=>{P.component=T;const ce=T.vnode.props;T.vnode=P,T.next=null,Iy(T,P.props,ce,V),Dy(T,P.children,V),ja(),iu(T),Va()},N=(T,P,V,ce,F,Y,re,z,ee=!1)=>{const G=T&&T.children,ve=T?T.shapeFlag:0,me=P.children,{patchFlag:ye,shapeFlag:Ie}=P;if(ye>0){if(ye&128){le(G,me,V,ce,F,Y,re,z,ee);return}else if(ye&256){ie(G,me,V,ce,F,Y,re,z,ee);return}}Ie&8?(ve&16&&de(G,F,Y),me!==G&&d(V,me)):ve&16?Ie&16?le(G,me,V,ce,F,Y,re,z,ee):de(G,F,Y,!0):(ve&8&&d(V,""),Ie&16&&E(me,V,ce,F,Y,re,z,ee))},ie=(T,P,V,ce,F,Y,re,z,ee)=>{T=T||di,P=P||di;const G=T.length,ve=P.length,me=Math.min(G,ve);let ye;for(ye=0;ye<me;ye++){const Ie=P[ye]=ee?Oa(P[ye]):Cs(P[ye]);g(T[ye],Ie,V,null,F,Y,re,z,ee)}G>ve?de(T,F,Y,!0,!1,me):E(P,V,ce,F,Y,re,z,ee,me)},le=(T,P,V,ce,F,Y,re,z,ee)=>{let G=0;const ve=P.length;let me=T.length-1,ye=ve-1;for(;G<=me&&G<=ye;){const Ie=T[G],Fe=P[G]=ee?Oa(P[G]):Cs(P[G]);if(ea(Ie,Fe))g(Ie,Fe,V,null,F,Y,re,z,ee);else break;G++}for(;G<=me&&G<=ye;){const Ie=T[me],Fe=P[ye]=ee?Oa(P[ye]):Cs(P[ye]);if(ea(Ie,Fe))g(Ie,Fe,V,null,F,Y,re,z,ee);else break;me--,ye--}if(G>me){if(G<=ye){const Ie=ye+1,Fe=Ie<ve?P[Ie].el:ce;for(;G<=ye;)g(null,P[G]=ee?Oa(P[G]):Cs(P[G]),V,Fe,F,Y,re,z,ee),G++}}else if(G>ye)for(;G<=me;)J(T[G],F,Y,!0),G++;else{const Ie=G,Fe=G,Ve=new Map;for(G=Fe;G<=ye;G++){const Ce=P[G]=ee?Oa(P[G]):Cs(P[G]);Ce.key!=null&&Ve.set(Ce.key,G)}let Be,qe=0;const Je=ye-Fe+1;let it=!1,We=0;const X=new Array(Je);for(G=0;G<Je;G++)X[G]=0;for(G=Ie;G<=me;G++){const Ce=T[G];if(qe>=Je){J(Ce,F,Y,!0);continue}let Oe;if(Ce.key!=null)Oe=Ve.get(Ce.key);else for(Be=Fe;Be<=ye;Be++)if(X[Be-Fe]===0&&ea(Ce,P[Be])){Oe=Be;break}Oe===void 0?J(Ce,F,Y,!0):(X[Oe-Fe]=G+1,Oe>=We?We=Oe:it=!0,g(Ce,P[Oe],V,null,F,Y,re,z,ee),qe++)}const we=it?My(X):di;for(Be=we.length-1,G=Je-1;G>=0;G--){const Ce=Fe+G,Oe=P[Ce],ae=P[Ce+1],Re=Ce+1<ve?ae.el||Am(ae):ce;X[G]===0?g(null,Oe,V,Re,F,Y,re,z,ee):it&&(Be<0||G!==we[Be]?B(Oe,V,Re,2):Be--)}}},B=(T,P,V,ce,F=null)=>{const{el:Y,type:re,transition:z,children:ee,shapeFlag:G}=T;if(G&6){B(T.component.subTree,P,V,ce);return}if(G&128){T.suspense.move(P,V,ce);return}if(G&64){re.move(T,P,V,ge);return}if(re===Yt){a(Y,P,V);for(let me=0;me<ee.length;me++)B(ee[me],P,V,ce);a(T.anchor,P,V);return}if(re===On){v(T,P,V);return}if(ce!==2&&G&1&&z)if(ce===0)z.persisted&&!Y[zs]?a(Y,P,V):(z.beforeEnter(Y),a(Y,P,V),Ut(()=>z.enter(Y),F));else{const{leave:me,delayLeave:ye,afterLeave:Ie}=z,Fe=()=>{T.ctx.isUnmounted?n(Y):a(Y,P,V)},Ve=()=>{const Be=Y._isLeaving||!!Y[zs];Y._isLeaving&&Y[zs](!0),z.persisted&&!Be?Fe():me(Y,()=>{Fe(),Ie&&Ie()})};ye?ye(Y,Fe,Ve):Ve()}else a(Y,P,V)},J=(T,P,V,ce=!1,F=!1)=>{const{type:Y,props:re,ref:z,children:ee,dynamicChildren:G,shapeFlag:ve,patchFlag:me,dirs:ye,cacheIndex:Ie,memo:Fe}=T;if(me===-2&&(F=!1),z!=null&&(ja(),hi(z,null,V,T,!0),Va()),Ie!=null&&(P.renderCache[Ie]=void 0),ve&256){P.ctx.deactivate(T);return}const Ve=ve&1&&ye,Be=!Ba(T);let qe;if(Be&&(qe=re&&re.onVnodeBeforeUnmount)&&Ss(qe,P,T),ve&6)fe(T.component,V,ce);else{if(ve&128){T.suspense.unmount(V,ce);return}Ve&&ma(T,null,P,"beforeUnmount"),ve&64?T.type.remove(T,P,V,ge,ce):G&&!G.hasOnce&&(Y!==Yt||me>0&&me&64)?de(G,P,V,!1,!0):(Y===Yt&&me&384||!F&&ve&16)&&de(ee,P,V),ce&&te(T)}const Je=Fe!=null&&Ie==null;(Be&&(qe=re&&re.onVnodeUnmounted)||Ve||Je)&&Ut(()=>{qe&&Ss(qe,P,T),Ve&&ma(T,null,P,"unmounted"),Je&&(T.el=null)},V)},te=T=>{const{type:P,el:V,anchor:ce,transition:F}=T;if(P===Yt){Z(V,ce);return}if(P===On){b(T);return}const Y=()=>{n(V),F&&!F.persisted&&F.afterLeave&&F.afterLeave()};if(T.shapeFlag&1&&F&&!F.persisted){const{leave:re,delayLeave:z}=F,ee=()=>re(V,Y);z?z(T.el,Y,ee):ee()}else Y()},Z=(T,P)=>{let V;for(;T!==P;)V=p(T),n(T),T=V;n(P)},fe=(T,P,V)=>{const{bum:ce,scope:F,job:Y,subTree:re,um:z,m:ee,a:G}=T;Co(ee),Co(G),ce&&fi(ce),F.stop(),Y&&(Y.flags|=8,J(re,T,P,V)),z&&Ut(z,P),Ut(()=>{T.isUnmounted=!0},P)},de=(T,P,V,ce=!1,F=!1,Y=0)=>{for(let re=Y;re<T.length;re++)J(T[re],P,V,ce,F)},K=T=>{if(T.shapeFlag&6)return K(T.component.subTree);if(T.shapeFlag&128)return T.suspense.next();const P=p(T.anchor||T.el),V=P&&P[Zf];return V?p(V):P};let ue=!1;const he=(T,P,V)=>{let ce;T==null?P._vnode&&(J(P._vnode,null,null,!0),ce=P._vnode.component):g(P._vnode||null,T,P,null,null,null,V),P._vnode=T,ue||(ue=!0,iu(ce),ko(),ue=!1)},ge={p:g,um:J,m:B,r:te,mt:Q,mc:E,pc:N,pbc:R,n:K,o:e};let xe,Ne;return t&&([xe,Ne]=t(ge)),{render:he,hydrate:xe,createApp:_y(he,xe)}}function Pr({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function xn({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Cm(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function ud(e,t,s=!1){const a=e.children,n=t.children;if(Ee(a)&&Ee(n))for(let i=0;i<a.length;i++){const l=a[i];let o=n[i];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=n[i]=Oa(n[i]),o.el=l.el),!s&&o.patchFlag!==-2&&ud(l,o)),o.type===dn&&(o.patchFlag===-1&&(o=n[i]=Oa(o)),o.el=l.el),o.type===Ft&&!o.el&&(o.el=l.el)}}function My(e){const t=e.slice(),s=[0];let a,n,i,l,o;const r=e.length;for(a=0;a<r;a++){const c=e[a];if(c!==0){if(n=s[s.length-1],e[n]<c){t[a]=n,s.push(a);continue}for(i=0,l=s.length-1;i<l;)o=i+l>>1,e[s[o]]<c?i=o+1:l=o;c<e[s[i]]&&(i>0&&(t[a]=s[i-1]),s[i]=a)}}for(i=s.length,l=s[i-1];i-- >0;)s[i]=l,l=t[l];return s}function Em(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:Em(t)}function Co(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Am(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Am(t.subTree):null}const Eo=e=>e.__isSuspense;let mc=0;const Py={name:"Suspense",__isSuspense:!0,process(e,t,s,a,n,i,l,o,r,c){if(e==null)$y(t,s,a,n,i,l,o,r,c);else{if(i&&i.deps>0&&!e.suspense.isInFallback){t.suspense=e.suspense,t.suspense.vnode=t,t.el=e.el;return}Uy(e,t,s,a,n,l,o,r,c)}},hydrate:By,normalize:Hy},Fy=Py;function hl(e,t){const s=e.props&&e.props[t];$e(s)&&s()}function $y(e,t,s,a,n,i,l,o,r){const{p:c,o:{createElement:d}}=r,u=d("div"),p=e.suspense=Rm(e,n,a,t,u,s,i,l,o,r);c(null,p.pendingBranch=e.ssContent,u,null,a,p,i,l),p.deps>0?(hl(e,"onPending"),hl(e,"onFallback"),c(null,e.ssFallback,t,s,a,null,i,l),vi(p,e.ssFallback)):p.resolve(!1,!0)}function Uy(e,t,s,a,n,i,l,o,{p:r,um:c,o:{createElement:d}}){const u=t.suspense=e.suspense;u.vnode=t,t.el=e.el;const p=t.ssContent,m=t.ssFallback,{activeBranch:h,pendingBranch:g,isInFallback:A,isHydrating:I}=u;if(g)u.pendingBranch=p,ea(g,p)?(r(g,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0?u.resolve():A&&(I||(r(h,m,s,a,n,null,i,l,o),vi(u,m)))):(u.pendingId=mc++,I?(u.isHydrating=!1,u.activeBranch=g):c(g,n,u),u.deps=0,u.effects.length=0,u.hiddenContainer=d("div"),A?(r(null,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0?u.resolve():(r(h,m,s,a,n,null,i,l,o),vi(u,m))):h&&ea(h,p)?(r(h,p,s,a,n,u,i,l,o),u.resolve(!0)):(r(null,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0&&u.resolve()));else if(h&&ea(h,p))r(h,p,s,a,n,u,i,l,o),vi(u,p);else if(hl(t,"onPending"),u.pendingBranch=p,p.shapeFlag&512?u.pendingId=p.component.suspenseId:u.pendingId=mc++,r(null,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0)u.resolve();else{const{timeout:y,pendingId:v}=u;y>0?setTimeout(()=>{u.pendingId===v&&u.fallback(m)},y):y===0&&u.fallback(m)}}function Rm(e,t,s,a,n,i,l,o,r,c,d=!1){const{p:u,m:p,um:m,n:h,o:{parentNode:g,remove:A}}=c;let I;const y=zy(e);y&&t&&t.pendingBranch&&(I=t.pendingId,t.deps++);const v=e.props?bo(e.props.timeout):void 0,b=i,x={vnode:e,parent:t,parentComponent:s,namespace:l,container:a,hiddenContainer:n,deps:0,pendingId:mc++,timeout:typeof v=="number"?v:-1,activeBranch:null,isFallbackMountPending:!1,pendingBranch:null,isInFallback:!d,isHydrating:d,isUnmounted:!1,effects:[],resolve(w=!1,C=!1){const{vnode:E,activeBranch:_,pendingBranch:R,pendingId:$,effects:S,parentComponent:M,container:Q,isInFallback:W}=x;let D=!1;if(x.isHydrating)x.isHydrating=!1;else if(!w){D=_&&R.transition&&R.transition.mode==="out-in";let ie=!1;D&&(_.transition.afterLeave=()=>{$===x.pendingId&&(p(R,Q,i===b&&!ie?h(_):i,0),ul(S),W&&E.ssFallback&&(E.ssFallback.el=null))}),_&&!x.isFallbackMountPending&&(g(_.el)===Q&&(i=h(_),ie=!0),m(_,M,x,!0),!D&&W&&E.ssFallback&&Ut(()=>E.ssFallback.el=null,x)),D||p(R,Q,i,0)}x.isFallbackMountPending=!1,vi(x,R),x.pendingBranch=null,x.isInFallback=!1;let O=x.parent,N=!1;for(;O;){if(O.pendingBranch){O.effects.push(...S),N=!0;break}O=O.parent}!N&&!D&&ul(S),x.effects=[],y&&t&&t.pendingBranch&&I===t.pendingId&&(t.deps--,t.deps===0&&!C&&t.resolve()),hl(E,"onResolve")},fallback(w){if(!x.pendingBranch)return;const{vnode:C,activeBranch:E,parentComponent:_,container:R,namespace:$}=x;hl(C,"onFallback");const S=h(E),M=()=>{x.isFallbackMountPending=!1,x.isInFallback&&(u(null,w,R,S,_,null,$,o,r),vi(x,w))},Q=w.transition&&w.transition.mode==="out-in";Q&&(x.isFallbackMountPending=!0,E.transition.afterLeave=M),x.isInFallback=!0,m(E,_,null,!0),Q||M()},move(w,C,E){x.activeBranch&&p(x.activeBranch,w,C,E),x.container=w},next(){return x.activeBranch&&h(x.activeBranch)},registerDep(w,C,E){const _=!!x.pendingBranch;_&&x.deps++;const R=w.vnode.el;w.asyncDep.catch($=>{Hn($,w,0)}).then($=>{if(w.isUnmounted||x.isUnmounted||x.pendingId!==w.suspenseId)return;bl(),w.asyncResolved=!0;const{vnode:S}=w;hc(w,$,!1),R&&(S.el=R);const M=!R&&w.subTree.el;C(w,S,g(R||w.subTree.el),R?null:h(w.subTree),x,l,E),M&&(S.placeholder=null,A(M)),pr(w,S.el),_&&--x.deps===0&&x.resolve()})},unmount(w,C){x.isUnmounted=!0,x.activeBranch&&m(x.activeBranch,s,w,C),x.pendingBranch&&m(x.pendingBranch,s,w,C)}};return x}function By(e,t,s,a,n,i,l,o,r){const c=t.suspense=Rm(t,a,s,e.parentNode,document.createElement("div"),null,n,i,l,o,!0),d=r(e,c.pendingBranch=t.ssContent,s,c,i,l);return c.deps===0&&c.resolve(!1,!0),d}function Hy(e){const{shapeFlag:t,children:s}=e,a=t&32;e.ssContent=yu(a?s.default:s),e.ssFallback=a?yu(s.fallback):Et(Ft)}function yu(e){let t;if($e(e)){const s=Dn&&e._c;s&&(e._d=!1,vl()),e=e(),s&&(e._d=!0,t=ps,Om())}return Ee(e)&&(e=Ty(e)),e=Cs(e),t&&!e.dynamicChildren&&(e.dynamicChildren=t.filter(s=>s!==e)),e}function Im(e,t){t&&t.pendingBranch?Ee(e)?t.effects.push(...e):t.effects.push(e):ul(e)}function vi(e,t){e.activeBranch=t;const{vnode:s,parentComponent:a}=e;let n=t.el;for(;!n&&t.component;)t=t.component.subTree,n=t.el;s.el=n,a&&a.subTree===s&&(a.vnode.el=n,pr(a,n))}function zy(e){const t=e.props&&e.props.suspensible;return t!=null&&t!==!1}const Yt=Symbol.for("v-fgt"),dn=Symbol.for("v-txt"),Ft=Symbol.for("v-cmt"),On=Symbol.for("v-stc"),sl=[];let ps=null;function vl(e=!1){sl.push(ps=e?null:[])}function Om(){sl.pop(),ps=sl[sl.length-1]||null}let Dn=1;function gl(e,t=!1){Dn+=e,e<0&&ps&&t&&(ps.hasOnce=!0)}function Lm(e){return e.dynamicChildren=Dn>0?ps||di:null,Om(),Dn>0&&ps&&ps.push(e),e}function jy(e,t,s,a,n,i){return Lm(pd(e,t,s,a,n,i,!0))}function Ao(e,t,s,a,n){return Lm(Et(e,t,s,a,n,!0))}function Ga(e){return e?e.__v_isVNode===!0:!1}function ea(e,t){return e.type===t.type&&e.key===t.key}function Vy(e){}const Nm=({key:e})=>e??null,uo=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?ze(e)||Ht(e)||$e(e)?{i:as,r:e,k:t,f:!!s}:e:null);function pd(e,t=null,s=null,a=0,n=null,i=e===Yt?0:1,l=!1,o=!1){const r={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Nm(t),ref:t&&uo(t),scopeId:lr,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:a,dynamicProps:n,dynamicChildren:null,appContext:null,ctx:as};return o?(md(r,s),i&128&&e.normalize(r)):s&&(r.shapeFlag|=ze(s)?8:16),Dn>0&&!l&&ps&&(r.patchFlag>0||i&6)&&r.patchFlag!==32&&ps.push(r),r}const Et=qy;function qy(e,t=null,s=null,a=0,n=null,i=!1){if((!e||e===rm)&&(e=Ft),Ga(e)){const o=ba(e,t,!0);return s&&md(o,s),Dn>0&&!i&&ps&&(o.shapeFlag&6?ps[ps.indexOf(e)]=o:ps.push(o)),o.patchFlag=-2,o}if(Qy(e)&&(e=e.__vccOpts),t){t=Dm(t);let{class:o,style:r}=t;o&&!ze(o)&&(t.class=Il(o)),rt(r)&&(Ol(r)&&!Ee(r)&&(r=Qe({},r)),t.style=Rl(r))}const l=ze(e)?1:Eo(e)?128:Yf(e)?64:rt(e)?4:$e(e)?2:0;return pd(e,t,s,a,n,l,i,!0)}function Dm(e){return e?Ol(e)||gm(e)?Qe({},e):e:null}function ba(e,t,s=!1,a=!1){const{props:n,ref:i,patchFlag:l,children:o,transition:r}=e,c=t?Pm(n||{},t):n,d={__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&Nm(c),ref:t&&t.ref?s&&i?Ee(i)?i.concat(uo(t)):[i,uo(t)]:uo(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:o,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==Yt?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:r,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&ba(e.ssContent),ssFallback:e.ssFallback&&ba(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return r&&a&&qa(d,r.clone(d)),d}function fd(e=" ",t=0){return Et(dn,null,e,t)}function Gy(e,t){const s=Et(On,null,e);return s.staticCount=t,s}function Mm(e="",t=!1){return t?(vl(),Ao(Ft,null,e)):Et(Ft,null,e)}function Cs(e){return e==null||typeof e=="boolean"?Et(Ft):Ee(e)?Et(Yt,null,e.slice()):Ga(e)?Oa(e):Et(dn,null,String(e))}function Oa(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:ba(e)}function md(e,t){let s=0;const{shapeFlag:a}=e;if(t==null)t=null;else if(Ee(t))s=16;else if(typeof t=="object")if(a&65){const n=t.default;n&&(n._c&&(n._d=!1),md(e,n()),n._c&&(n._d=!0));return}else{s=32;const n=t._;!n&&!gm(t)?t._ctx=as:n===3&&as&&(as.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else $e(t)?(t={default:t,_ctx:as},s=32):(t=String(t),a&64?(s=16,t=[fd(t)]):s=8);e.children=t,e.shapeFlag|=s}function Pm(...e){const t={};for(let s=0;s<e.length;s++){const a=e[s];for(const n in a)if(n==="class")t.class!==a.class&&(t.class=Il([t.class,a.class]));else if(n==="style")t.style=Rl([t.style,a.style]);else if($n(n)){const i=t[n],l=a[n];l&&i!==l&&!(Ee(i)&&i.includes(l))?t[n]=i?[].concat(i,l):l:l==null&&i==null&&!Jo(n)&&(t[n]=l)}else n!==""&&(t[n]=a[n])}return t}function Ss(e,t,s,a=null){Ds(e,t,7,[s,a])}const Wy=um();let Ky=0;function Fm(e,t,s){const a=e.type,n=(t?t.appContext:e.appContext)||Wy,i={uid:Ky++,vnode:e,type:a,parent:t,appContext:n,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Gc(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(n.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:ym(a,n),emitsOptions:fm(a,n),emit:null,emitted:null,propsDefaults:et,inheritAttrs:a.inheritAttrs,ctx:et,data:et,props:et,attrs:et,slots:et,refs:et,setupState:et,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=ky.bind(null,i),e.ce&&e.ce(i),i}let ss=null;const _s=()=>ss||as;let Ro,gi;{const e=er(),t=(s,a)=>{let n;return(n=e[s])||(n=e[s]=[]),n.push(a),i=>{n.length>1?n.forEach(l=>l(i)):n[0](i)}};Ro=t("__VUE_INSTANCE_SETTERS__",s=>ss=s),gi=t("__VUE_SSR_SETTERS__",s=>Mn=s)}const Di=e=>{const t=ss;return Ro(e),e.scope.on(),()=>{e.scope.off(),Ro(t)}},bl=()=>{ss&&ss.scope.off(),Ro(null)};function $m(e){return e.vnode.shapeFlag&4}let Mn=!1;function Um(e,t=!1,s=!1){t&&gi(t);const{props:a,children:n}=e.vnode,i=$m(e);Ry(e,a,i,t),Ny(e,n,s||t);const l=i?Jy(e,t):void 0;return t&&gi(!1),l}function Jy(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,dc);const{setup:a}=s;if(a){ja();const n=e.setupContext=a.length>1?zm(e):null,i=Di(e),l=Ni(a,e,0,[e.props,n]),o=qc(l);if(Va(),i(),(o||e.sp)&&!Ba(e)&&ad(e),o){if(l.then(bl,bl),t)return l.then(r=>{hc(e,r,t)}).catch(r=>{Hn(r,e,0)});e.asyncDep=l}else hc(e,l,t)}else Hm(e,t)}function hc(e,t,s){$e(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:rt(t)&&(e.setupState=Qc(t)),Hm(e,s)}let Io,vc;function Bm(e){Io=e,vc=t=>{t.render._rc&&(t.withProxy=new Proxy(t.ctx,ty))}}const Zy=()=>!Io;function Hm(e,t,s){const a=e.type;if(!e.render){if(!t&&Io&&!a.render){const n=a.template||rd(e).template;if(n){const{isCustomElement:i,compilerOptions:l}=e.appContext.config,{delimiters:o,compilerOptions:r}=a,c=Qe(Qe({isCustomElement:i,delimiters:o},l),r);a.render=Io(n,c)}}e.render=a.render||ns,vc&&vc(e)}{const n=Di(e);ja();try{hy(e)}finally{Va(),n()}}}const Yy={get(e,t){return us(e,"get",""),e[t]}};function zm(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Yy),slots:e.slots,emit:e.emit,expose:t}}function Ml(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Qc(Pf(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in tl)return tl[s](e)},has(t,s){return s in t||s in tl}})):e.proxy}function gc(e,t=!0){return $e(e)?e.displayName||e.name:e.name||t&&e.__name}function Qy(e){return $e(e)&&"__vccOpts"in e}const j=(e,t)=>nb(e,t,Mn);function wi(e,t,s){try{gl(-1);const a=arguments.length;return a===2?rt(t)&&!Ee(t)?Ga(t)?Et(e,null,[t]):Et(e,t):Et(e,null,t):(a>3?s=Array.prototype.slice.call(arguments,2):a===3&&Ga(s)&&(s=[s]),Et(e,t,s))}finally{gl(1)}}function Xy(){}function ex(e,t,s,a){const n=s[a];if(n&&jm(n,e))return n;const i=t();return i.memo=e.slice(),i.cacheIndex=a,s[a]=i}function jm(e,t){const s=e.memo;if(s.length!=t.length)return!1;for(let a=0;a<s.length;a++)if(Zt(s[a],t[a]))return!1;return Dn>0&&ps&&ps.push(e),!0}const Vm="3.5.38",tx=ns,sx=fb,ax=ni,nx=qf,ix={createComponentInstance:Fm,setupComponent:Um,renderComponentRoot:co,setCurrentRenderingInstance:fl,isVNode:Ga,normalizeVNode:Cs,getComponentPublicInstance:Ml,ensureValidVNode:od,pushWarningContext:cb,popWarningContext:db},lx=ix,ox=null,rx=null,cx=null;/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let bc;const xu=typeof window<"u"&&window.trustedTypes;if(xu)try{bc=xu.createPolicy("vue",{createHTML:e=>e})}catch{}const qm=bc?e=>bc.createHTML(e):e=>e,dx="http://www.w3.org/2000/svg",ux="http://www.w3.org/1998/Math/MathML",Ia=typeof document<"u"?document:null,_u=Ia&&Ia.createElement("template"),Gm={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,a)=>{const n=t==="svg"?Ia.createElementNS(dx,e):t==="mathml"?Ia.createElementNS(ux,e):s?Ia.createElement(e,{is:s}):Ia.createElement(e);return e==="select"&&a&&a.multiple!=null&&n.setAttribute("multiple",a.multiple),n},createText:e=>Ia.createTextNode(e),createComment:e=>Ia.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Ia.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,a,n,i){const l=s?s.previousSibling:t.lastChild;if(n&&(n===i||n.nextSibling))for(;t.insertBefore(n.cloneNode(!0),s),!(n===i||!(n=n.nextSibling)););else{_u.innerHTML=qm(a==="svg"?`<svg>${e}</svg>`:a==="mathml"?`<math>${e}</math>`:e);const o=_u.content;if(a==="svg"||a==="mathml"){const r=o.firstChild;for(;r.firstChild;)o.appendChild(r.firstChild);o.removeChild(r)}t.insertBefore(o,s)}return[l?l.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},Xa="transition",$i="animation",ki=Symbol("_vtc"),Wm={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Km=Qe({},sd,Wm),px=e=>(e.displayName="Transition",e.props=Km,e),fx=px((e,{slots:t})=>wi(em,Jm(e),t)),_n=(e,t=[])=>{Ee(e)?e.forEach(s=>s(...t)):e&&e(...t)},wu=e=>e?Ee(e)?e.some(t=>t.length>1):e.length>1:!1;function Jm(e){const t={};for(const S in e)S in Wm||(t[S]=e[S]);if(e.css===!1)return t;const{name:s="v",type:a,duration:n,enterFromClass:i=`${s}-enter-from`,enterActiveClass:l=`${s}-enter-active`,enterToClass:o=`${s}-enter-to`,appearFromClass:r=i,appearActiveClass:c=l,appearToClass:d=o,leaveFromClass:u=`${s}-leave-from`,leaveActiveClass:p=`${s}-leave-active`,leaveToClass:m=`${s}-leave-to`}=e,h=mx(n),g=h&&h[0],A=h&&h[1],{onBeforeEnter:I,onEnter:y,onEnterCancelled:v,onLeave:b,onLeaveCancelled:x,onBeforeAppear:w=I,onAppear:C=y,onAppearCancelled:E=v}=t,_=(S,M,Q,W)=>{S._enterCancelled=W,an(S,M?d:o),an(S,M?c:l),Q&&Q()},R=(S,M)=>{S._isLeaving=!1,an(S,u),an(S,m),an(S,p),M&&M()},$=S=>(M,Q)=>{const W=S?C:y,D=()=>_(M,S,Q);_n(W,[M,D]),ku(()=>{an(M,S?r:i),da(M,S?d:o),wu(W)||Su(M,a,g,D)})};return Qe(t,{onBeforeEnter(S){_n(I,[S]),da(S,i),da(S,l)},onBeforeAppear(S){_n(w,[S]),da(S,r),da(S,c)},onEnter:$(!1),onAppear:$(!0),onLeave(S,M){S._isLeaving=!0;const Q=()=>R(S,M);da(S,u),S._enterCancelled?(da(S,p),yc(S)):(yc(S),da(S,p)),ku(()=>{S._isLeaving&&(an(S,u),da(S,m),wu(b)||Su(S,a,A,Q))}),_n(b,[S,Q])},onEnterCancelled(S){_(S,!1,void 0,!0),_n(v,[S])},onAppearCancelled(S){_(S,!0,void 0,!0),_n(E,[S])},onLeaveCancelled(S){R(S),_n(x,[S])}})}function mx(e){if(e==null)return null;if(rt(e))return[Fr(e.enter),Fr(e.leave)];{const t=Fr(e);return[t,t]}}function Fr(e){return bo(e)}function da(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ki]||(e[ki]=new Set)).add(t)}function an(e,t){t.split(/\s+/).forEach(a=>a&&e.classList.remove(a));const s=e[ki];s&&(s.delete(t),s.size||(e[ki]=void 0))}function ku(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let hx=0;function Su(e,t,s,a){const n=e._endId=++hx,i=()=>{n===e._endId&&a()};if(s!=null)return setTimeout(i,s);const{type:l,timeout:o,propCount:r}=Zm(e,t);if(!l)return a();const c=l+"end";let d=0;const u=()=>{e.removeEventListener(c,p),i()},p=m=>{m.target===e&&++d>=r&&u()};setTimeout(()=>{d<r&&u()},o+1),e.addEventListener(c,p)}function Zm(e,t){const s=window.getComputedStyle(e),a=h=>(s[h]||"").split(", "),n=a(`${Xa}Delay`),i=a(`${Xa}Duration`),l=Tu(n,i),o=a(`${$i}Delay`),r=a(`${$i}Duration`),c=Tu(o,r);let d=null,u=0,p=0;t===Xa?l>0&&(d=Xa,u=l,p=i.length):t===$i?c>0&&(d=$i,u=c,p=r.length):(u=Math.max(l,c),d=u>0?l>c?Xa:$i:null,p=d?d===Xa?i.length:r.length:0);const m=d===Xa&&/\b(?:transform|all)(?:,|$)/.test(a(`${Xa}Property`).toString());return{type:d,timeout:u,propCount:p,hasTransform:m}}function Tu(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,a)=>Cu(s)+Cu(e[a])))}function Cu(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function yc(e){return(e?e.ownerDocument:document).body.offsetHeight}function vx(e,t,s){const a=e[ki];a&&(t=(t?[t,...a]:[...a]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const Oo=Symbol("_vod"),hd=Symbol("_vsh"),Ym={name:"show",beforeMount(e,{value:t},{transition:s}){e[Oo]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):Ui(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:a}){!t!=!s&&(a?t?(a.beforeEnter(e),Ui(e,!0),a.enter(e)):a.leave(e,()=>{Ui(e,!1)}):Ui(e,t))},beforeUnmount(e,{value:t}){Ui(e,t)}};function Ui(e,t){e.style.display=t?e[Oo]:"none",e[hd]=!t}function gx(){Ym.getSSRProps=({value:e})=>{if(!e)return{style:{display:"none"}}}}const Qm=Symbol("");function bx(e){const t=_s();if(!t)return;const s=t.ut=(n=e(t.proxy))=>{Array.from(document.querySelectorAll(`[data-v-owner="${t.uid}"]`)).forEach(i=>Lo(i,n))},a=()=>{const n=e(t.proxy);t.ce?Lo(t.ce,n):xc(t.subTree,n),s(n)};nd(()=>{ul(a)}),Ye(()=>{zt(a,ns,{flush:"post"});const n=new MutationObserver(a);n.observe(t.subTree.el.parentNode,{childList:!0}),gt(()=>n.disconnect())})}function xc(e,t){if(e.shapeFlag&128){const s=e.suspense;e=s.activeBranch,s.pendingBranch&&!s.isHydrating&&s.effects.push(()=>{xc(s.activeBranch,t)})}for(;e.component;)e=e.component.subTree;if(e.shapeFlag&1&&e.el)Lo(e.el,t);else if(e.type===Yt)e.children.forEach(s=>xc(s,t));else if(e.type===On){let{el:s,anchor:a}=e;for(;s&&(Lo(s,t),s!==a);)s=s.nextSibling}}function Lo(e,t){if(e.nodeType===1){const s=e.style;let a="";for(const n in t){const i=Sg(t[n]);s.setProperty(`--${n}`,i),a+=`--${n}: ${i};`}s[Qm]=a}}const yx=/(?:^|;)\s*display\s*:/;function xx(e,t,s){const a=e.style,n=ze(s);let i=!1;if(s&&!n){if(t)if(ze(t))for(const l of t.split(";")){const o=l.slice(0,l.indexOf(":")).trim();s[o]==null&&Zi(a,o,"")}else for(const l in t)s[l]==null&&Zi(a,l,"");for(const l in s){l==="display"&&(i=!0);const o=s[l];o!=null?wx(e,l,!ze(t)&&t?t[l]:void 0,o)||Zi(a,l,o):Zi(a,l,"")}}else if(n){if(t!==s){const l=a[Qm];l&&(s+=";"+l),a.cssText=s,i=yx.test(s)}}else t&&e.removeAttribute("style");Oo in e&&(e[Oo]=i?a.display:"",e[hd]&&(a.display="none"))}const Eu=/\s*!important$/;function Zi(e,t,s){if(Ee(s))s.forEach(a=>Zi(e,t,a));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const a=_x(e,t);Eu.test(s)?e.setProperty(Es(a),s.replace(Eu,""),"important"):e[a]=s}}const Au=["Webkit","Moz","ms"],$r={};function _x(e,t){const s=$r[t];if(s)return s;let a=yt(t);if(a!=="filter"&&a in e)return $r[t]=a;a=Bn(a);for(let n=0;n<Au.length;n++){const i=Au[n]+a;if(i in e)return $r[t]=i}return t}function wx(e,t,s,a){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&ze(a)&&s===a}const Ru="http://www.w3.org/1999/xlink";function Iu(e,t,s,a,n,i=wg(t)){a&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Ru,t.slice(6,t.length)):e.setAttributeNS(Ru,t,s):s==null||i&&!vf(s)?e.removeAttribute(t):e.setAttribute(t,i?"":ms(s)?String(s):s)}function Ou(e,t,s,a,n){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?qm(s):s);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const o=i==="OPTION"?e.getAttribute("value")||"":e.value,r=s==null?e.type==="checkbox"?"on":"":String(s);(o!==r||!("_value"in e))&&(e.value=r),s==null&&e.removeAttribute(t),e._value=s;return}let l=!1;if(s===""||s==null){const o=typeof e[t];o==="boolean"?s=vf(s):s==null&&o==="string"?(s="",l=!0):o==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(n||t)}function Ma(e,t,s,a){e.addEventListener(t,s,a)}function kx(e,t,s,a){e.removeEventListener(t,s,a)}const Lu=Symbol("_vei");function Sx(e,t,s,a,n=null){const i=e[Lu]||(e[Lu]={}),l=i[t];if(a&&l)l.value=a;else{const[o,r]=Tx(t);if(a){const c=i[t]=Ax(a,n);Ma(e,o,c,r)}else l&&(kx(e,o,l,r),i[t]=void 0)}}const Nu=/(?:Once|Passive|Capture)$/;function Tx(e){let t;if(Nu.test(e)){t={};let a;for(;a=e.match(Nu);)e=e.slice(0,e.length-a[0].length),t[a[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Es(e.slice(2)),t]}let Ur=0;const Cx=Promise.resolve(),Ex=()=>Ur||(Cx.then(()=>Ur=0),Ur=Date.now());function Ax(e,t){const s=a=>{if(!a._vts)a._vts=Date.now();else if(a._vts<=s.attached)return;const n=s.value;if(Ee(n)){const i=a.stopImmediatePropagation;a.stopImmediatePropagation=()=>{i.call(a),a._stopped=!0};const l=n.slice(),o=[a];for(let r=0;r<l.length&&!a._stopped;r++){const c=l[r];c&&Ds(c,t,5,o)}}else Ds(n,t,5,[a])};return s.value=e,s.attached=Ex(),s}const Du=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Xm=(e,t,s,a,n,i)=>{const l=n==="svg";t==="class"?vx(e,a,l):t==="style"?xx(e,s,a):$n(t)?Jo(t)||Sx(e,t,s,a,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):Rx(e,t,a,l))?(Ou(e,t,a),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Iu(e,t,a,l,i,t!=="value")):e._isVueCE&&(Ix(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!ze(a)))?Ou(e,yt(t),a,i,t):(t==="true-value"?e._trueValue=a:t==="false-value"&&(e._falseValue=a),Iu(e,t,a,l))};function Rx(e,t,s,a){if(a)return!!(t==="innerHTML"||t==="textContent"||t in e&&Du(t)&&$e(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const n=e.tagName;if(n==="IMG"||n==="VIDEO"||n==="CANVAS"||n==="SOURCE")return!1}return Du(t)&&ze(s)?!1:t in e}function Ix(e,t){const s=e._def.props;if(!s)return!1;const a=yt(t);return Array.isArray(s)?s.some(n=>yt(n)===a):Object.keys(s).some(n=>yt(n)===a)}const Mu={};function eh(e,t,s){let a=Nl(e,t);Zo(a)&&(a=Qe({},a,t));class n extends fr{constructor(l){super(a,l,s)}}return n.def=a,n}const Ox=((e,t)=>eh(e,t,fh)),Lx=typeof HTMLElement<"u"?HTMLElement:class{};class fr extends Lx{constructor(t,s={},a=Mo){super(),this._def=t,this._props=s,this._createApp=a,this._isVueCE=!0,this._instance=null,this._app=null,this._nonce=this._def.nonce,this._connected=!1,this._resolved=!1,this._patching=!1,this._dirty=!1,this._numberProps=null,this._styleChildren=new WeakSet,this._styleAnchors=new WeakMap,this._ob=null,this.shadowRoot&&a!==Mo?this._root=this.shadowRoot:t.shadowRoot!==!1?(this.attachShadow(Qe({},t.shadowRootOptions,{mode:"open"})),this._root=this.shadowRoot):this._root=this}connectedCallback(){if(!this.isConnected)return;!this.shadowRoot&&!this._resolved&&this._parseSlots(),this._connected=!0;let t=this;for(;t=t&&(t.assignedSlot||t.parentNode||t.host);)if(t instanceof fr){this._parent=t;break}this._instance||(this._resolved?this._mount(this._def):t&&t._pendingResolve?this._pendingResolve=t._pendingResolve.then(()=>{this._pendingResolve=void 0,this._resolveDef()}):this._resolveDef())}_setParent(t=this._parent){t&&(this._instance.parent=t._instance,this._inheritParentContext(t))}_inheritParentContext(t=this._parent){t&&this._app&&Object.setPrototypeOf(this._app._context.provides,t._instance.provides)}disconnectedCallback(){this._connected=!1,Pt(()=>{this._connected||(this._ob&&(this._ob.disconnect(),this._ob=null),this._app&&this._app.unmount(),this._instance&&(this._instance.ce=void 0),this._app=this._instance=null,this._teleportTargets&&(this._teleportTargets.clear(),this._teleportTargets=void 0))})}_processMutations(t){for(const s of t)this._setAttr(s.attributeName)}_resolveDef(){if(this._pendingResolve)return;for(let a=0;a<this.attributes.length;a++)this._setAttr(this.attributes[a].name);this._ob=new MutationObserver(this._processMutations.bind(this)),this._ob.observe(this,{attributes:!0});const t=(a,n=!1)=>{this._resolved=!0,this._pendingResolve=void 0;const{props:i,styles:l}=a;let o;if(i&&!Ee(i))for(const r in i){const c=i[r];(c===Number||c&&c.type===Number)&&(r in this._props&&(this._props[r]=bo(this._props[r])),(o||(o=Object.create(null)))[yt(r)]=!0)}this._numberProps=o,this._resolveProps(a),this.shadowRoot&&this._applyStyles(l),this._mount(a)},s=this._def.__asyncLoader;s?this._pendingResolve=s().then(a=>{a.configureApp=this._def.configureApp,t(this._def=a,!0)}):t(this._def)}_mount(t){this._app=this._createApp(t),this._inheritParentContext(),t.configureApp&&t.configureApp(this._app),this._app._ceVNode=this._createVNode(),this._app.mount(this._root);const s=this._instance&&this._instance.exposed;if(s)for(const a in s)pt(this,a)||Object.defineProperty(this,a,{get:()=>va(s[a])})}_resolveProps(t){const{props:s}=t,a=Ee(s)?s:Object.keys(s||{});for(const n of Object.keys(this))n[0]!=="_"&&a.includes(n)&&this._setProp(n,this[n]);for(const n of a.map(yt))Object.defineProperty(this,n,{get(){return this._getProp(n)},set(i){this._setProp(n,i,!0,!this._patching)}})}_setAttr(t){if(t.startsWith("data-v-"))return;const s=this.hasAttribute(t);let a=s?this.getAttribute(t):Mu;const n=yt(t);s&&this._numberProps&&this._numberProps[n]&&(a=bo(a)),this._setProp(n,a,!1,!0)}_getProp(t){return this._props[t]}_setProp(t,s,a=!0,n=!1){if(s!==this._props[t]&&(this._dirty=!0,s===Mu?delete this._props[t]:(this._props[t]=s,t==="key"&&this._app&&(this._app._ceVNode.key=s)),n&&this._instance&&this._update(),a)){const i=this._ob;i&&(this._processMutations(i.takeRecords()),i.disconnect()),s===!0?this.setAttribute(Es(t),""):typeof s=="string"||typeof s=="number"?this.setAttribute(Es(t),s+""):s||this.removeAttribute(Es(t)),i&&i.observe(this,{attributes:!0})}}_update(){const t=this._createVNode();this._app&&(t.appContext=this._app._context),ph(t,this._root)}_createVNode(){const t={};this.shadowRoot||(t.onVnodeMounted=t.onVnodeUpdated=this._renderSlots.bind(this));const s=Et(this._def,Qe(t,this._props));return this._instance||(s.ce=a=>{this._instance=a,a.ce=this,a.isCE=!0;const n=(i,l)=>{this.dispatchEvent(new CustomEvent(i,Zo(l[0])?Qe({detail:l},l[0]):{detail:l}))};a.emit=(i,...l)=>{n(i,l),Es(i)!==i&&n(Es(i),l)},this._setParent()}),s}_applyStyles(t,s,a){if(!t)return;if(s){if(s===this._def||this._styleChildren.has(s))return;this._styleChildren.add(s)}const n=this._nonce,i=this.shadowRoot,l=a?this._getStyleAnchor(a)||this._getStyleAnchor(this._def):this._getRootStyleInsertionAnchor(i);let o=null;for(let r=t.length-1;r>=0;r--){const c=document.createElement("style");n&&c.setAttribute("nonce",n),c.textContent=t[r],i.insertBefore(c,o||l),o=c,r===0&&(a||this._styleAnchors.set(this._def,c),s&&this._styleAnchors.set(s,c))}}_getStyleAnchor(t){if(!t)return null;const s=this._styleAnchors.get(t);return s&&s.parentNode===this.shadowRoot?s:(s&&this._styleAnchors.delete(t),null)}_getRootStyleInsertionAnchor(t){for(let s=0;s<t.childNodes.length;s++){const a=t.childNodes[s];if(!(a instanceof HTMLStyleElement))return a}return null}_parseSlots(){const t=this._slots={};let s;for(;s=this.firstChild;){const a=s.nodeType===1&&s.getAttribute("slot")||"default";(t[a]||(t[a]=[])).push(s),this.removeChild(s)}}_renderSlots(){const t=this._getSlots(),s=this._instance.type.__scopeId;for(let a=0;a<t.length;a++){const n=t[a],i=n.getAttribute("name")||"default",l=this._slots[i],o=n.parentNode;if(l)for(const r of l){if(s&&r.nodeType===1){const c=s+"-s",d=document.createTreeWalker(r,1);r.setAttribute(c,"");let u;for(;u=d.nextNode();)u.setAttribute(c,"")}o.insertBefore(r,n)}else for(;n.firstChild;)o.insertBefore(n.firstChild,n);o.removeChild(n)}}_getSlots(){const t=[this];this._teleportTargets&&t.push(...this._teleportTargets);const s=new Set;for(const a of t){const n=a.querySelectorAll("slot");for(let i=0;i<n.length;i++)s.add(n[i])}return Array.from(s)}_injectChildStyle(t,s){this._applyStyles(t.styles,t,s)}_beginPatch(){this._patching=!0,this._dirty=!1}_endPatch(){this._patching=!1,this._dirty&&this._instance&&this._update()}_hasShadowRoot(){return this._def.shadowRoot!==!1}_removeChildStyle(t){}}function th(e){const t=_s(),s=t&&t.ce;return s||null}function Nx(){const e=th();return e&&e.shadowRoot}function Dx(e="$style"){{const t=_s();if(!t)return et;const s=t.type.__cssModules;if(!s)return et;const a=s[e];return a||et}}const sh=new WeakMap,ah=new WeakMap,No=Symbol("_moveCb"),Pu=Symbol("_enterCb"),Mx=e=>(delete e.props.mode,e),Px=Mx({name:"TransitionGroup",props:Qe({},Km,{tag:String,moveClass:String}),setup(e,{slots:t}){const s=_s(),a=td();let n,i;return cr(()=>{if(!n.length)return;const l=e.moveClass||`${e.name||"v"}-move`;if(!Hx(n[0].el,s.vnode.el,l)){n=[];return}n.forEach($x),n.forEach(Ux);const o=n.filter(Bx);yc(s.vnode.el),o.forEach(r=>{const c=r.el,d=c.style;da(c,l),d.transform=d.webkitTransform=d.transitionDuration="";const u=c[No]=p=>{p&&p.target!==c||(!p||p.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",u),c[No]=null,an(c,l))};c.addEventListener("transitionend",u)}),n=[]}),()=>{const l=at(e),o=Jm(l);let r=l.tag||Yt;if(n=[],i)for(let c=0;c<i.length;c++){const d=i[c];d.el&&d.el instanceof Element&&!d.el[hd]&&(n.push(d),qa(d,_i(d,o,a,s)),sh.set(d,nh(d.el)))}i=t.default?or(t.default()):[];for(let c=0;c<i.length;c++){const d=i[c];d.key!=null&&qa(d,_i(d,o,a,s))}return Et(r,null,i)}}}),Fx=Px;function $x(e){const t=e.el;t[No]&&t[No](),t[Pu]&&t[Pu]()}function Ux(e){ah.set(e,nh(e.el))}function Bx(e){const t=sh.get(e),s=ah.get(e),a=t.left-s.left,n=t.top-s.top;if(a||n){const i=e.el,l=i.style,o=i.getBoundingClientRect();let r=1,c=1;return i.offsetWidth&&(r=o.width/i.offsetWidth),i.offsetHeight&&(c=o.height/i.offsetHeight),(!Number.isFinite(r)||r===0)&&(r=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(r-1)<.01&&(r=1),Math.abs(c-1)<.01&&(c=1),l.transform=l.webkitTransform=`translate(${a/r}px,${n/c}px)`,l.transitionDuration="0s",e}}function nh(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function Hx(e,t,s){const a=e.cloneNode(),n=e[ki];n&&n.forEach(o=>{o.split(/\s+/).forEach(r=>r&&a.classList.remove(r))}),s.split(/\s+/).forEach(o=>o&&a.classList.add(o)),a.style.display="none";const i=t.nodeType===1?t:t.parentNode;i.appendChild(a);const{hasTransform:l}=Zm(a);return i.removeChild(a),l}const pn=e=>{const t=e.props["onUpdate:modelValue"]||!1;return Ee(t)?s=>fi(t,s):t};function zx(e){e.target.composing=!0}function Fu(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const Ws=Symbol("_assign");function $u(e,t,s){return t&&(e=e.trim()),s&&(e=Xo(e)),e}const Do={created(e,{modifiers:{lazy:t,trim:s,number:a}},n){e[Ws]=pn(n);const i=a||n.props&&n.props.type==="number";Ma(e,t?"change":"input",l=>{l.target.composing||e[Ws]($u(e.value,s,i))}),(s||i)&&Ma(e,"change",()=>{e.value=$u(e.value,s,i)}),t||(Ma(e,"compositionstart",zx),Ma(e,"compositionend",Fu),Ma(e,"change",Fu))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:a,trim:n,number:i}},l){if(e[Ws]=pn(l),e.composing)return;const o=(i||e.type==="number")&&!/^0\d/.test(e.value)?Xo(e.value):e.value,r=t??"";if(o===r)return;const c=e.getRootNode();(c instanceof Document||c instanceof ShadowRoot)&&c.activeElement===e&&e.type!=="range"&&(a&&t===s||n&&e.value.trim()===r)||(e.value=r)}},vd={deep:!0,created(e,t,s){e[Ws]=pn(s),Ma(e,"change",()=>{const a=e._modelValue,n=Si(e),i=e.checked,l=e[Ws];if(Ee(a)){const o=tr(a,n),r=o!==-1;if(i&&!r)l(a.concat(n));else if(!i&&r){const c=[...a];c.splice(o,1),l(c)}}else if(Un(a)){const o=new Set(a);i?o.add(n):o.delete(n),l(o)}else l(lh(e,i))})},mounted:Uu,beforeUpdate(e,t,s){e[Ws]=pn(s),Uu(e,t,s)}};function Uu(e,{value:t,oldValue:s},a){e._modelValue=t;let n;if(Ee(t))n=tr(t,a.props.value)>-1;else if(Un(t))n=t.has(a.props.value);else{if(t===s)return;n=za(t,lh(e,!0))}e.checked!==n&&(e.checked=n)}const gd={created(e,{value:t},s){e.checked=za(t,s.props.value),e[Ws]=pn(s),Ma(e,"change",()=>{e[Ws](Si(e))})},beforeUpdate(e,{value:t,oldValue:s},a){e[Ws]=pn(a),t!==s&&(e.checked=za(t,a.props.value))}},ih={deep:!0,created(e,{value:t,modifiers:{number:s}},a){const n=Un(t);Ma(e,"change",()=>{const i=Array.prototype.filter.call(e.options,l=>l.selected).map(l=>s?Xo(Si(l)):Si(l));e[Ws](e.multiple?n?new Set(i):i:i[0]),e._assigning=!0,Pt(()=>{e._assigning=!1})}),e[Ws]=pn(a)},mounted(e,{value:t}){Bu(e,t)},beforeUpdate(e,t,s){e[Ws]=pn(s)},updated(e,{value:t}){e._assigning||Bu(e,t)}};function Bu(e,t){const s=e.multiple,a=Ee(t);if(!(s&&!a&&!Un(t))){for(let n=0,i=e.options.length;n<i;n++){const l=e.options[n],o=Si(l);if(s)if(a){const r=typeof o;r==="string"||r==="number"?l.selected=t.some(c=>String(c)===String(o)):l.selected=tr(t,o)>-1}else l.selected=t.has(o);else if(za(Si(l),t)){e.selectedIndex!==n&&(e.selectedIndex=n);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function Si(e){return"_value"in e?e._value:e.value}function lh(e,t){const s=t?"_trueValue":"_falseValue";return s in e?e[s]:t}const oh={created(e,t,s){Ql(e,t,s,null,"created")},mounted(e,t,s){Ql(e,t,s,null,"mounted")},beforeUpdate(e,t,s,a){Ql(e,t,s,a,"beforeUpdate")},updated(e,t,s,a){Ql(e,t,s,a,"updated")}};function rh(e,t){switch(e){case"SELECT":return ih;case"TEXTAREA":return Do;default:switch(t){case"checkbox":return vd;case"radio":return gd;default:return Do}}}function Ql(e,t,s,a,n){const l=rh(e.tagName,s.props&&s.props.type)[n];l&&l(e,t,s,a)}function jx(){Do.getSSRProps=({value:e})=>({value:e}),gd.getSSRProps=({value:e},t)=>{if(t.props&&za(t.props.value,e))return{checked:!0}},vd.getSSRProps=({value:e},t)=>{if(Ee(e)){if(t.props&&tr(e,t.props.value)>-1)return{checked:!0}}else if(Un(e)){if(t.props&&e.has(t.props.value))return{checked:!0}}else if(e)return{checked:!0}},oh.getSSRProps=(e,t)=>{if(typeof t.type!="string")return;const s=rh(t.type.toUpperCase(),t.props&&t.props.type);if(s.getSSRProps)return s.getSSRProps(e,t)}}const Vx=["ctrl","shift","alt","meta"],qx={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>Vx.some(s=>e[`${s}Key`]&&!t.includes(s))},Gx=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),a=t.join(".");return s[a]||(s[a]=((n,...i)=>{for(let l=0;l<t.length;l++){const o=qx[t[l]];if(o&&o(n,t))return}return e(n,...i)}))},Wx={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},Kx=(e,t)=>{const s=e._withKeys||(e._withKeys={}),a=t.join(".");return s[a]||(s[a]=(n=>{if(!("key"in n))return;const i=Es(n.key);if(t.some(l=>l===i||Wx[l]===i))return e(n)}))},ch=Qe({patchProp:Xm},Gm);let al,Hu=!1;function dh(){return al||(al=km(ch))}function uh(){return al=Hu?al:Sm(ch),Hu=!0,al}const ph=((...e)=>{dh().render(...e)}),Jx=((...e)=>{uh().hydrate(...e)}),Mo=((...e)=>{const t=dh().createApp(...e),{mount:s}=t;return t.mount=a=>{const n=hh(a);if(!n)return;const i=t._component;!$e(i)&&!i.render&&!i.template&&(i.template=n.innerHTML),n.nodeType===1&&(n.textContent="");const l=s(n,!1,mh(n));return n instanceof Element&&(n.removeAttribute("v-cloak"),n.setAttribute("data-v-app","")),l},t}),fh=((...e)=>{const t=uh().createApp(...e),{mount:s}=t;return t.mount=a=>{const n=hh(a);if(n)return s(n,!0,mh(n))},t});function mh(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function hh(e){return ze(e)?document.querySelector(e):e}let zu=!1;const Zx=()=>{zu||(zu=!0,jx(),gx())},Yx=Object.freeze(Object.defineProperty({__proto__:null,BaseTransition:em,BaseTransitionPropsValidators:sd,Comment:Ft,DeprecationTypes:cx,EffectScope:Gc,ErrorCodes:pb,ErrorTypeStrings:sx,Fragment:Yt,KeepAlive:qb,ReactiveEffect:rl,Static:On,Suspense:Fy,Teleport:Eb,Text:dn,TrackOpTypes:ib,Transition:fx,TransitionGroup:Fx,TriggerOpTypes:lb,VueElement:fr,assertNumber:ub,callWithAsyncErrorHandling:Ds,callWithErrorHandling:Ni,camelize:yt,capitalize:Bn,cloneVNode:ba,compatUtils:rx,computed:j,createApp:Mo,createBlock:Ao,createCommentVNode:Mm,createElementBlock:jy,createElementVNode:pd,createHydrationRenderer:Sm,createPropsRestProxy:fy,createRenderer:km,createSSRApp:fh,createSlots:Qb,createStaticVNode:Gy,createTextVNode:fd,createVNode:Et,customRef:$f,defineAsyncComponent:jb,defineComponent:Nl,defineCustomElement:eh,defineEmits:ay,defineExpose:ny,defineModel:oy,defineOptions:iy,defineProps:sy,defineSSRCustomElement:Ox,defineSlots:ly,devtools:ax,effect:Ag,effectScope:Tg,getCurrentInstance:_s,getCurrentScope:xf,getCurrentWatcher:ob,getTransitionRawChildren:or,guardReactiveProps:Dm,h:wi,handleError:Hn,hasInjectionContext:xb,hydrate:Jx,hydrateOnIdle:Fb,hydrateOnInteraction:Hb,hydrateOnMediaQuery:Bb,hydrateOnVisible:Ub,initCustomFormatter:Xy,initDirectivesForSSR:Zx,inject:Gs,isMemoSame:jm,isProxy:Ol,isReactive:Ua,isReadonly:ga,isRef:Ht,isRuntimeOnly:Zy,isShallow:Rs,isVNode:Ga,markRaw:Pf,mergeDefaults:uy,mergeModels:py,mergeProps:Pm,nextTick:Pt,nodeOps:Gm,normalizeClass:Il,normalizeProps:pg,normalizeStyle:Rl,onActivated:is,onBeforeMount:am,onBeforeUnmount:dr,onBeforeUpdate:nd,onDeactivated:Jt,onErrorCaptured:om,onMounted:Ye,onRenderTracked:lm,onRenderTriggered:im,onScopeDispose:Cg,onServerPrefetch:nm,onUnmounted:gt,onUpdated:cr,onWatcherCleanup:Bf,openBlock:vl,patchProp:Xm,popScopeId:gb,provide:el,proxyRefs:Qc,pushScopeId:vb,queuePostFlushCb:ul,reactive:fn,readonly:xo,ref:f,registerRuntimeCompiler:Bm,render:ph,renderList:Yb,renderSlot:Xb,resolveComponent:Kb,resolveDirective:Zb,resolveDynamicComponent:Jb,resolveFilter:ox,resolveTransitionHooks:_i,setBlockTracking:gl,setDevtoolsHook:nx,setTransitionHooks:qa,shallowReactive:Zc,shallowReadonly:Wg,shallowRef:Yc,ssrContextKey:Gf,ssrUtils:lx,stop:Rg,toDisplayString:bf,toHandlerKey:pi,toHandlers:ey,toRaw:at,toRef:sb,toRefs:Xg,toValue:Zg,transformVNodeArgs:Vy,triggerRef:Jg,unref:va,useAttrs:dy,useCssModule:Dx,useCssVars:bx,useHost:th,useId:Rb,useModel:wy,useSSRContext:Wf,useShadowRoot:Nx,useSlots:cy,useTemplateRef:Ib,useTransitionState:td,vModelCheckbox:vd,vModelDynamic:oh,vModelRadio:gd,vModelSelect:ih,vModelText:Do,vShow:Ym,version:Vm,warn:tx,watch:zt,watchEffect:_b,watchPostEffect:wb,watchSyncEffect:Kf,withAsyncContext:my,withCtx:ed,withDefaults:ry,withDirectives:yb,withKeys:Kx,withMemo:ex,withModifiers:Gx,withScopeId:bb},Symbol.toStringTag,{value:"Module"}));/**
* @vue/compiler-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const yl=Symbol(""),nl=Symbol(""),bd=Symbol(""),Po=Symbol(""),vh=Symbol(""),Pn=Symbol(""),gh=Symbol(""),bh=Symbol(""),yd=Symbol(""),xd=Symbol(""),Pl=Symbol(""),_d=Symbol(""),yh=Symbol(""),wd=Symbol(""),kd=Symbol(""),Sd=Symbol(""),Td=Symbol(""),Cd=Symbol(""),Ed=Symbol(""),xh=Symbol(""),_h=Symbol(""),mr=Symbol(""),Fo=Symbol(""),Ad=Symbol(""),Rd=Symbol(""),xl=Symbol(""),Fl=Symbol(""),Id=Symbol(""),_c=Symbol(""),Qx=Symbol(""),wc=Symbol(""),$o=Symbol(""),Xx=Symbol(""),e0=Symbol(""),Od=Symbol(""),t0=Symbol(""),s0=Symbol(""),Ld=Symbol(""),wh=Symbol(""),Ti={[yl]:"Fragment",[nl]:"Teleport",[bd]:"Suspense",[Po]:"KeepAlive",[vh]:"BaseTransition",[Pn]:"openBlock",[gh]:"createBlock",[bh]:"createElementBlock",[yd]:"createVNode",[xd]:"createElementVNode",[Pl]:"createCommentVNode",[_d]:"createTextVNode",[yh]:"createStaticVNode",[wd]:"resolveComponent",[kd]:"resolveDynamicComponent",[Sd]:"resolveDirective",[Td]:"resolveFilter",[Cd]:"withDirectives",[Ed]:"renderList",[xh]:"renderSlot",[_h]:"createSlots",[mr]:"toDisplayString",[Fo]:"mergeProps",[Ad]:"normalizeClass",[Rd]:"normalizeStyle",[xl]:"normalizeProps",[Fl]:"guardReactiveProps",[Id]:"toHandlers",[_c]:"camelize",[Qx]:"capitalize",[wc]:"toHandlerKey",[$o]:"setBlockTracking",[Xx]:"pushScopeId",[e0]:"popScopeId",[Od]:"withCtx",[t0]:"unref",[s0]:"isRef",[Ld]:"withMemo",[wh]:"isMemoSame"};function a0(e){Object.getOwnPropertySymbols(e).forEach(t=>{Ti[t]=e[t]})}const Ps={start:{line:1,column:1,offset:0},end:{line:1,column:1,offset:0},source:""};function n0(e,t=""){return{type:0,source:t,children:e,helpers:new Set,components:[],directives:[],hoists:[],imports:[],cached:[],temps:0,codegenNode:void 0,loc:Ps}}function _l(e,t,s,a,n,i,l,o=!1,r=!1,c=!1,d=Ps){return e&&(o?(e.helper(Pn),e.helper(Ai(e.inSSR,c))):e.helper(Ei(e.inSSR,c)),l&&e.helper(Cd)),{type:13,tag:t,props:s,children:a,patchFlag:n,dynamicProps:i,directives:l,isBlock:o,disableTracking:r,isComponent:c,loc:d}}function Ln(e,t=Ps){return{type:17,loc:t,elements:e}}function qs(e,t=Ps){return{type:15,loc:t,properties:e}}function Bt(e,t){return{type:16,loc:Ps,key:ze(e)?Ke(e,!0):e,value:t}}function Ke(e,t=!1,s=Ps,a=0){return{type:4,loc:s,content:e,isStatic:t,constType:t?3:a}}function sa(e,t=Ps){return{type:8,loc:t,children:e}}function Kt(e,t=[],s=Ps){return{type:14,loc:s,callee:e,arguments:t}}function Ci(e,t=void 0,s=!1,a=!1,n=Ps){return{type:18,params:e,returns:t,newline:s,isSlot:a,loc:n}}function kc(e,t,s,a=!0){return{type:19,test:e,consequent:t,alternate:s,newline:a,loc:Ps}}function i0(e,t,s=!1,a=!1){return{type:20,index:e,value:t,needPauseTracking:s,inVOnce:a,needArraySpread:!1,loc:Ps}}function l0(e){return{type:21,body:e,loc:Ps}}function Ei(e,t){return e||t?yd:xd}function Ai(e,t){return e||t?gh:bh}function Nd(e,{helper:t,removeHelper:s,inSSR:a}){e.isBlock||(e.isBlock=!0,s(Ei(a,e.isComponent)),t(Pn),t(Ai(a,e.isComponent)))}const ju=new Uint8Array([123,123]),Vu=new Uint8Array([125,125]);function qu(e){return e>=97&&e<=122||e>=65&&e<=90}function Ls(e){return e===32||e===10||e===9||e===12||e===13}function en(e){return e===47||e===62||Ls(e)}function Uo(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t}const rs={Cdata:new Uint8Array([67,68,65,84,65,91]),CdataEnd:new Uint8Array([93,93,62]),CommentEnd:new Uint8Array([45,45,62]),ScriptEnd:new Uint8Array([60,47,115,99,114,105,112,116]),StyleEnd:new Uint8Array([60,47,115,116,121,108,101]),TitleEnd:new Uint8Array([60,47,116,105,116,108,101]),TextareaEnd:new Uint8Array([60,47,116,101,120,116,97,114,101,97])};class o0{constructor(t,s){this.stack=t,this.cbs=s,this.state=1,this.buffer="",this.sectionStart=0,this.index=0,this.entityStart=0,this.baseState=1,this.inRCDATA=!1,this.inXML=!1,this.inVPre=!1,this.newlines=[],this.mode=0,this.delimiterOpen=ju,this.delimiterClose=Vu,this.delimiterIndex=-1,this.currentSequence=void 0,this.sequenceIndex=0}get inSFCRoot(){return this.mode===2&&this.stack.length===0}reset(){this.state=1,this.mode=0,this.buffer="",this.sectionStart=0,this.index=0,this.baseState=1,this.inRCDATA=!1,this.currentSequence=void 0,this.newlines.length=0,this.delimiterOpen=ju,this.delimiterClose=Vu}getPos(t){let s=1,a=t+1;const n=this.newlines.length;let i=-1;if(n>100){let l=-1,o=n;for(;l+1<o;){const r=l+o>>>1;this.newlines[r]<t?l=r:o=r}i=l}else for(let l=n-1;l>=0;l--)if(t>this.newlines[l]){i=l;break}return i>=0&&(s=i+2,a=t-this.newlines[i]),{column:a,line:s,offset:t}}peek(){return this.buffer.charCodeAt(this.index+1)}stateText(t){t===60?(this.index>this.sectionStart&&this.cbs.ontext(this.sectionStart,this.index),this.state=5,this.sectionStart=this.index):!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t))}stateInterpolationOpen(t){if(t===this.delimiterOpen[this.delimiterIndex])if(this.delimiterIndex===this.delimiterOpen.length-1){const s=this.index+1-this.delimiterOpen.length;s>this.sectionStart&&this.cbs.ontext(this.sectionStart,s),this.state=3,this.sectionStart=s}else this.delimiterIndex++;else this.inRCDATA?(this.state=32,this.stateInRCDATA(t)):(this.state=1,this.stateText(t))}stateInterpolation(t){t===this.delimiterClose[0]&&(this.state=4,this.delimiterIndex=0,this.stateInterpolationClose(t))}stateInterpolationClose(t){t===this.delimiterClose[this.delimiterIndex]?this.delimiterIndex===this.delimiterClose.length-1?(this.cbs.oninterpolation(this.sectionStart,this.index+1),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):this.delimiterIndex++:(this.state=3,this.stateInterpolation(t))}stateSpecialStartSequence(t){const s=this.sequenceIndex===this.currentSequence.length;if(!(s?en(t):(t|32)===this.currentSequence[this.sequenceIndex]))this.inRCDATA=!1;else if(!s){this.sequenceIndex++;return}this.sequenceIndex=0,this.state=6,this.stateInTagName(t)}stateInRCDATA(t){if(this.sequenceIndex===this.currentSequence.length){if(t===62||Ls(t)){const s=this.index-this.currentSequence.length;if(this.sectionStart<s){const a=this.index;this.index=s,this.cbs.ontext(this.sectionStart,s),this.index=a}this.sectionStart=s+2,this.stateInClosingTagName(t),this.inRCDATA=!1;return}this.sequenceIndex=0}(t|32)===this.currentSequence[this.sequenceIndex]?this.sequenceIndex+=1:this.sequenceIndex===0?this.currentSequence===rs.TitleEnd||this.currentSequence===rs.TextareaEnd&&!this.inSFCRoot?!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t)):this.fastForwardTo(60)&&(this.sequenceIndex=1):this.sequenceIndex=+(t===60)}stateCDATASequence(t){t===rs.Cdata[this.sequenceIndex]?++this.sequenceIndex===rs.Cdata.length&&(this.state=28,this.currentSequence=rs.CdataEnd,this.sequenceIndex=0,this.sectionStart=this.index+1):(this.sequenceIndex=0,this.state=23,this.stateInDeclaration(t))}fastForwardTo(t){for(;++this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);if(s===10&&this.newlines.push(this.index),s===t)return!0}return this.index=this.buffer.length-1,!1}stateInCommentLike(t){t===this.currentSequence[this.sequenceIndex]?++this.sequenceIndex===this.currentSequence.length&&(this.currentSequence===rs.CdataEnd?this.cbs.oncdata(this.sectionStart,this.index-2):this.cbs.oncomment(this.sectionStart,this.index-2),this.sequenceIndex=0,this.sectionStart=this.index+1,this.state=1):this.sequenceIndex===0?this.fastForwardTo(this.currentSequence[0])&&(this.sequenceIndex=1):t!==this.currentSequence[this.sequenceIndex-1]&&(this.sequenceIndex=0)}startSpecial(t,s){this.enterRCDATA(t,s),this.state=31}enterRCDATA(t,s){this.inRCDATA=!0,this.currentSequence=t,this.sequenceIndex=s}stateBeforeTagName(t){t===33?(this.state=22,this.sectionStart=this.index+1):t===63?(this.state=24,this.sectionStart=this.index+1):qu(t)?(this.sectionStart=this.index,this.mode===0?this.state=6:this.inSFCRoot?this.state=34:this.inXML?this.state=6:t===116?this.state=30:this.state=t===115?29:6):t===47?this.state=8:(this.state=1,this.stateText(t))}stateInTagName(t){en(t)&&this.handleTagName(t)}stateInSFCRootTagName(t){if(en(t)){const s=this.buffer.slice(this.sectionStart,this.index);s!=="template"&&this.enterRCDATA(Uo("</"+s),0),this.handleTagName(t)}}handleTagName(t){this.cbs.onopentagname(this.sectionStart,this.index),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)}stateBeforeClosingTagName(t){Ls(t)||(t===62?(this.state=1,this.sectionStart=this.index+1):(this.state=qu(t)?9:27,this.sectionStart=this.index))}stateInClosingTagName(t){(t===62||Ls(t))&&(this.cbs.onclosetag(this.sectionStart,this.index),this.sectionStart=-1,this.state=10,this.stateAfterClosingTagName(t))}stateAfterClosingTagName(t){t===62&&(this.state=1,this.sectionStart=this.index+1)}stateBeforeAttrName(t){t===62?(this.cbs.onopentagend(this.index),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):t===47?this.state=7:t===60&&this.peek()===47?(this.cbs.onopentagend(this.index),this.state=5,this.sectionStart=this.index):Ls(t)||this.handleAttrStart(t)}handleAttrStart(t){t===118&&this.peek()===45?(this.state=13,this.sectionStart=this.index):t===46||t===58||t===64||t===35?(this.cbs.ondirname(this.index,this.index+1),this.state=14,this.sectionStart=this.index+1):(this.state=12,this.sectionStart=this.index)}stateInSelfClosingTag(t){t===62?(this.cbs.onselfclosingtag(this.index),this.state=1,this.sectionStart=this.index+1,this.inRCDATA=!1):Ls(t)||(this.state=11,this.stateBeforeAttrName(t))}stateInAttrName(t){(t===61||en(t))&&(this.cbs.onattribname(this.sectionStart,this.index),this.handleAttrNameEnd(t))}stateInDirName(t){t===61||en(t)?(this.cbs.ondirname(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===58?(this.cbs.ondirname(this.sectionStart,this.index),this.state=14,this.sectionStart=this.index+1):t===46&&(this.cbs.ondirname(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDirArg(t){t===61||en(t)?(this.cbs.ondirarg(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===91?this.state=15:t===46&&(this.cbs.ondirarg(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDynamicDirArg(t){t===93?this.state=14:(t===61||en(t))&&(this.cbs.ondirarg(this.sectionStart,this.index+1),this.handleAttrNameEnd(t))}stateInDirModifier(t){t===61||en(t)?(this.cbs.ondirmodifier(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===46&&(this.cbs.ondirmodifier(this.sectionStart,this.index),this.sectionStart=this.index+1)}handleAttrNameEnd(t){this.sectionStart=this.index,this.state=17,this.cbs.onattribnameend(this.index),this.stateAfterAttrName(t)}stateAfterAttrName(t){t===61?this.state=18:t===47||t===62?(this.cbs.onattribend(0,this.sectionStart),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)):Ls(t)||(this.cbs.onattribend(0,this.sectionStart),this.handleAttrStart(t))}stateBeforeAttrValue(t){t===34?(this.state=19,this.sectionStart=this.index+1):t===39?(this.state=20,this.sectionStart=this.index+1):Ls(t)||(this.sectionStart=this.index,this.state=21,this.stateInAttrValueNoQuotes(t))}handleInAttrValue(t,s){(t===s||this.fastForwardTo(s))&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(s===34?3:2,this.index+1),this.state=11)}stateInAttrValueDoubleQuotes(t){this.handleInAttrValue(t,34)}stateInAttrValueSingleQuotes(t){this.handleInAttrValue(t,39)}stateInAttrValueNoQuotes(t){Ls(t)||t===62?(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(1,this.index),this.state=11,this.stateBeforeAttrName(t)):(t===39||t===60||t===61||t===96)&&this.cbs.onerr(18,this.index)}stateBeforeDeclaration(t){t===91?(this.state=26,this.sequenceIndex=0):this.state=t===45?25:23}stateInDeclaration(t){(t===62||this.fastForwardTo(62))&&(this.state=1,this.sectionStart=this.index+1)}stateInProcessingInstruction(t){(t===62||this.fastForwardTo(62))&&(this.cbs.onprocessinginstruction(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeComment(t){t===45?(this.state=28,this.currentSequence=rs.CommentEnd,this.sequenceIndex=2,this.sectionStart=this.index+1):this.state=23}stateInSpecialComment(t){(t===62||this.fastForwardTo(62))&&(this.cbs.oncomment(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeSpecialS(t){t===rs.ScriptEnd[3]?this.startSpecial(rs.ScriptEnd,4):t===rs.StyleEnd[3]?this.startSpecial(rs.StyleEnd,4):(this.state=6,this.stateInTagName(t))}stateBeforeSpecialT(t){t===rs.TitleEnd[3]?this.startSpecial(rs.TitleEnd,4):t===rs.TextareaEnd[3]?this.startSpecial(rs.TextareaEnd,4):(this.state=6,this.stateInTagName(t))}startEntity(){}stateInEntity(){}parse(t){for(this.buffer=t;this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);switch(s===10&&this.state!==33&&this.newlines.push(this.index),this.state){case 1:{this.stateText(s);break}case 2:{this.stateInterpolationOpen(s);break}case 3:{this.stateInterpolation(s);break}case 4:{this.stateInterpolationClose(s);break}case 31:{this.stateSpecialStartSequence(s);break}case 32:{this.stateInRCDATA(s);break}case 26:{this.stateCDATASequence(s);break}case 19:{this.stateInAttrValueDoubleQuotes(s);break}case 12:{this.stateInAttrName(s);break}case 13:{this.stateInDirName(s);break}case 14:{this.stateInDirArg(s);break}case 15:{this.stateInDynamicDirArg(s);break}case 16:{this.stateInDirModifier(s);break}case 28:{this.stateInCommentLike(s);break}case 27:{this.stateInSpecialComment(s);break}case 11:{this.stateBeforeAttrName(s);break}case 6:{this.stateInTagName(s);break}case 34:{this.stateInSFCRootTagName(s);break}case 9:{this.stateInClosingTagName(s);break}case 5:{this.stateBeforeTagName(s);break}case 17:{this.stateAfterAttrName(s);break}case 20:{this.stateInAttrValueSingleQuotes(s);break}case 18:{this.stateBeforeAttrValue(s);break}case 8:{this.stateBeforeClosingTagName(s);break}case 10:{this.stateAfterClosingTagName(s);break}case 29:{this.stateBeforeSpecialS(s);break}case 30:{this.stateBeforeSpecialT(s);break}case 21:{this.stateInAttrValueNoQuotes(s);break}case 7:{this.stateInSelfClosingTag(s);break}case 23:{this.stateInDeclaration(s);break}case 22:{this.stateBeforeDeclaration(s);break}case 25:{this.stateBeforeComment(s);break}case 24:{this.stateInProcessingInstruction(s);break}case 33:{this.stateInEntity();break}}this.index++}this.cleanup(),this.finish()}cleanup(){this.sectionStart!==this.index&&(this.state===1||this.state===32&&this.sequenceIndex===0?(this.cbs.ontext(this.sectionStart,this.index),this.sectionStart=this.index):(this.state===19||this.state===20||this.state===21)&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=this.index))}finish(){this.handleTrailingData(),this.cbs.onend()}handleTrailingData(){const t=this.buffer.length;this.sectionStart>=t||(this.state===28?this.currentSequence===rs.CdataEnd?this.cbs.oncdata(this.sectionStart,t):this.cbs.oncomment(this.sectionStart,t):this.state===6||this.state===11||this.state===18||this.state===17||this.state===12||this.state===13||this.state===14||this.state===15||this.state===16||this.state===20||this.state===19||this.state===21||this.state===9||this.cbs.ontext(this.sectionStart,t))}emitCodePoint(t,s){}}function Gu(e,{compatConfig:t}){const s=t&&t[e];return e==="MODE"?s||3:s}function Nn(e,t){const s=Gu("MODE",t),a=Gu(e,t);return s===3?a===!0:a!==!1}function wl(e,t,s,...a){return Nn(e,t)}function Dd(e){throw e}function kh(e){}function Tt(e,t,s,a){const n=`https://vuejs.org/error-reference/#compiler-${e}`,i=new SyntaxError(String(n));return i.code=e,i.loc=t,i}const As=e=>e.type===4&&e.isStatic;function Sh(e){switch(e){case"Teleport":case"teleport":return nl;case"Suspense":case"suspense":return bd;case"KeepAlive":case"keep-alive":return Po;case"BaseTransition":case"base-transition":return vh}}const r0=/^$|^\d|[^\$\w\xA0-\uFFFF]/,Md=e=>!r0.test(e),Th=/[A-Za-z_$\xA0-\uFFFF]/,c0=/[\.\?\w$\xA0-\uFFFF]/,d0=/\s+[.[]\s*|\s*[.[]\s+/g,Ch=e=>e.type===4?e.content:e.loc.source,u0=e=>{const t=Ch(e).trim().replace(d0,o=>o.trim());let s=0,a=[],n=0,i=0,l=null;for(let o=0;o<t.length;o++){const r=t.charAt(o);switch(s){case 0:if(r==="[")a.push(s),s=1,n++;else if(r==="(")a.push(s),s=2,i++;else if(!(o===0?Th:c0).test(r))return!1;break;case 1:r==="'"||r==='"'||r==="`"?(a.push(s),s=3,l=r):r==="["?n++:r==="]"&&(--n||(s=a.pop()));break;case 2:if(r==="'"||r==='"'||r==="`")a.push(s),s=3,l=r;else if(r==="(")i++;else if(r===")"){if(o===t.length-1)return!1;--i||(s=a.pop())}break;case 3:r===l&&(s=a.pop(),l=null);break}}return!n&&!i},Eh=u0,p0=/^\s*(?:async\s*)?(?:\([^)]*?\)|[\w$_]+)\s*(?::[^=]+)?=>|^\s*(?:async\s+)?function(?:\s+[\w$]+)?\s*\(/,f0=e=>p0.test(Ch(e)),m0=f0;function Vs(e,t,s=!1){for(let a=0;a<e.props.length;a++){const n=e.props[a];if(n.type===7&&(s||n.exp)&&(ze(t)?n.name===t:t.test(n.name)))return n}}function hr(e,t,s=!1,a=!1){for(let n=0;n<e.props.length;n++){const i=e.props[n];if(i.type===6){if(s)continue;if(i.name===t&&(i.value||a))return i}else if(i.name==="bind"&&(i.exp||a)&&Cn(i.arg,t))return i}}function Cn(e,t){return!!(e&&As(e)&&e.content===t)}function h0(e){return e.props.some(t=>t.type===7&&t.name==="bind"&&(!t.arg||t.arg.type!==4||!t.arg.isStatic))}function Br(e){return e.type===5||e.type===2}function Wu(e){return e.type===7&&e.name==="pre"}function v0(e){return e.type===7&&e.name==="slot"}function Bo(e){return e.type===1&&e.tagType===3}function Ho(e){return e.type===1&&e.tagType===2}const g0=new Set([xl,Fl]);function Ah(e,t=[]){if(e&&!ze(e)&&e.type===14){const s=e.callee;if(!ze(s)&&g0.has(s))return Ah(e.arguments[0],t.concat(e))}return[e,t]}function zo(e,t,s){let a,n=e.type===13?e.props:e.arguments[2],i=[],l;if(n&&!ze(n)&&n.type===14){const o=Ah(n);n=o[0],i=o[1],l=i[i.length-1]}if(n==null||ze(n))a=qs([t]);else if(n.type===14){const o=n.arguments[0];!ze(o)&&o.type===15?Ku(t,o)||o.properties.unshift(t):n.callee===Id?a=Kt(s.helper(Fo),[qs([t]),n]):n.arguments.unshift(qs([t])),!a&&(a=n)}else n.type===15?(Ku(t,n)||n.properties.unshift(t),a=n):(a=Kt(s.helper(Fo),[qs([t]),n]),l&&l.callee===Fl&&(l=i[i.length-2]));e.type===13?l?l.arguments[0]=a:e.props=a:l?l.arguments[0]=a:e.arguments[2]=a}function Ku(e,t){let s=!1;if(e.key.type===4){const a=e.key.content;s=t.properties.some(n=>n.key.type===4&&n.key.content===a)}return s}function kl(e,t){return`_${t}_${e.replace(/[^\w]/g,(s,a)=>s==="-"?"_":e.charCodeAt(a).toString())}`}function b0(e){return e.type===14&&e.callee===Ld?e.arguments[1].returns:e}const y0=/([\s\S]*?)\s+(?:in|of)\s+(\S[\s\S]*)/;function Rh(e){for(let t=0;t<e.length;t++)if(!Ls(e.charCodeAt(t)))return!1;return!0}function Pd(e){return e.type===2&&Rh(e.content)||e.type===12&&Pd(e.content)}function Ih(e){return e.type===3||Pd(e)}const Oh={parseMode:"base",ns:0,delimiters:["{{","}}"],getNamespace:()=>0,isVoidTag:oi,isPreTag:oi,isIgnoreNewlineTag:oi,isCustomElement:oi,onError:Dd,onWarn:kh,comments:!1,prefixIdentifiers:!1};let ot=Oh,Sl=null,Ha="",ds=null,tt=null,ks="",Ra=-1,kn=-1,Fd=0,on=!1,Sc=null;const St=[],Dt=new o0(St,{onerr:Ca,ontext(e,t){Xl(ts(e,t),e,t)},ontextentity(e,t,s){Xl(e,t,s)},oninterpolation(e,t){if(on)return Xl(ts(e,t),e,t);let s=e+Dt.delimiterOpen.length,a=t-Dt.delimiterClose.length;for(;Ls(Ha.charCodeAt(s));)s++;for(;Ls(Ha.charCodeAt(a-1));)a--;let n=ts(s,a);n.includes("&")&&(n=ot.decodeEntities(n,!1)),Tc({type:5,content:fo(n,!1,Mt(s,a)),loc:Mt(e,t)})},onopentagname(e,t){const s=ts(e,t);ds={type:1,tag:s,ns:ot.getNamespace(s,St[0],ot.ns),tagType:0,props:[],children:[],loc:Mt(e-1,t),codegenNode:void 0}},onopentagend(e){Zu(e)},onclosetag(e,t){const s=ts(e,t);if(!ot.isVoidTag(s)){let a=!1;for(let n=0;n<St.length;n++)if(St[n].tag.toLowerCase()===s.toLowerCase()){a=!0,n>0&&Ca(24,St[0].loc.start.offset);for(let l=0;l<=n;l++){const o=St.shift();po(o,t,l<n)}break}a||Ca(23,Lh(e,60))}},onselfclosingtag(e){const t=ds.tag;ds.isSelfClosing=!0,Zu(e),St[0]&&St[0].tag===t&&po(St.shift(),e)},onattribname(e,t){tt={type:6,name:ts(e,t),nameLoc:Mt(e,t),value:void 0,loc:Mt(e)}},ondirname(e,t){const s=ts(e,t),a=s==="."||s===":"?"bind":s==="@"?"on":s==="#"?"slot":s.slice(2);if(!on&&a===""&&Ca(26,e),on||a==="")tt={type:6,name:s,nameLoc:Mt(e,t),value:void 0,loc:Mt(e)};else if(tt={type:7,name:a,rawName:s,exp:void 0,arg:void 0,modifiers:s==="."?[Ke("prop")]:[],loc:Mt(e)},a==="pre"){on=Dt.inVPre=!0,Sc=ds;const n=ds.props;for(let i=0;i<n.length;i++)n[i].type===7&&(n[i]=R0(n[i]))}},ondirarg(e,t){if(e===t)return;const s=ts(e,t);if(on&&!Wu(tt))tt.name+=s,En(tt.nameLoc,t);else{const a=s[0]!=="[";tt.arg=fo(a?s:s.slice(1,-1),a,Mt(e,t),a?3:0)}},ondirmodifier(e,t){const s=ts(e,t);if(on&&!Wu(tt))tt.name+="."+s,En(tt.nameLoc,t);else if(tt.name==="slot"){const a=tt.arg;a&&(a.content+="."+s,En(a.loc,t))}else{const a=Ke(s,!0,Mt(e,t));tt.modifiers.push(a)}},onattribdata(e,t){ks+=ts(e,t),Ra<0&&(Ra=e),kn=t},onattribentity(e,t,s){ks+=e,Ra<0&&(Ra=t),kn=s},onattribnameend(e){const t=tt.loc.start.offset,s=ts(t,e);tt.type===7&&(tt.rawName=s),ds.props.some(a=>(a.type===7?a.rawName:a.name)===s)&&Ca(2,t)},onattribend(e,t){if(ds&&tt){if(En(tt.loc,t),e!==0)if(ks.includes("&")&&(ks=ot.decodeEntities(ks,!0)),tt.type===6)tt.name==="class"&&(ks=Dh(ks).trim()),e===1&&!ks&&Ca(13,t),tt.value={type:2,content:ks,loc:e===1?Mt(Ra,kn):Mt(Ra-1,kn+1)},Dt.inSFCRoot&&ds.tag==="template"&&tt.name==="lang"&&ks&&ks!=="html"&&Dt.enterRCDATA(Uo("</template"),0);else{let s=0;tt.exp=fo(ks,!1,Mt(Ra,kn),0,s),tt.name==="for"&&(tt.forParseResult=_0(tt.exp));let a=-1;tt.name==="bind"&&(a=tt.modifiers.findIndex(n=>n.content==="sync"))>-1&&wl("COMPILER_V_BIND_SYNC",ot,tt.loc,tt.arg.loc.source)&&(tt.name="model",tt.modifiers.splice(a,1))}(tt.type!==7||tt.name!=="pre")&&ds.props.push(tt)}ks="",Ra=kn=-1},oncomment(e,t){ot.comments&&Tc({type:3,content:ts(e,t),loc:Mt(e-4,t+3)})},onend(){const e=Ha.length;for(let t=0;t<St.length;t++)po(St[t],e-1),Ca(24,St[t].loc.start.offset)},oncdata(e,t){(St[0]?St[0].ns:ot.ns)!==0?Xl(ts(e,t),e,t):Ca(1,e-9)},onprocessinginstruction(e){(St[0]?St[0].ns:ot.ns)===0&&Ca(21,e-1)}}),Ju=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,x0=/^\(|\)$/g;function _0(e){const t=e.loc,s=e.content,a=s.match(y0);if(!a)return;const[,n,i]=a,l=(u,p,m=!1)=>{const h=t.start.offset+p,g=h+u.length;return fo(u,!1,Mt(h,g),0,m?1:0)},o={source:l(i.trim(),s.indexOf(i,n.length)),value:void 0,key:void 0,index:void 0,finalized:!1};let r=n.trim().replace(x0,"").trim();const c=n.indexOf(r),d=r.match(Ju);if(d){r=r.replace(Ju,"").trim();const u=d[1].trim();let p;if(u&&(p=s.indexOf(u,c+r.length),o.key=l(u,p,!0)),d[2]){const m=d[2].trim();m&&(o.index=l(m,s.indexOf(m,o.key?p+u.length:c+r.length),!0))}}return r&&(o.value=l(r,c,!0)),o}function ts(e,t){return Ha.slice(e,t)}function Zu(e){Dt.inSFCRoot&&(ds.innerLoc=Mt(e+1,e+1)),Tc(ds);const{tag:t,ns:s}=ds;s===0&&ot.isPreTag(t)&&Fd++,ot.isVoidTag(t)?po(ds,e):(St.unshift(ds),(s===1||s===2)&&(Dt.inXML=!0)),ds=null}function Xl(e,t,s){{const i=St[0]&&St[0].tag;i!=="script"&&i!=="style"&&e.includes("&")&&(e=ot.decodeEntities(e,!1))}const a=St[0]||Sl,n=a.children[a.children.length-1];n&&n.type===2?(n.content+=e,En(n.loc,s)):a.children.push({type:2,content:e,loc:Mt(t,s)})}function po(e,t,s=!1){s?En(e.loc,Lh(t,60)):En(e.loc,w0(t,62)+1),Dt.inSFCRoot&&(e.children.length?e.innerLoc.end=Qe({},e.children[e.children.length-1].loc.end):e.innerLoc.end=Qe({},e.innerLoc.start),e.innerLoc.source=ts(e.innerLoc.start.offset,e.innerLoc.end.offset));const{tag:a,ns:n,children:i}=e;if(on||(a==="slot"?e.tagType=2:Yu(e)?e.tagType=3:S0(e)&&(e.tagType=1)),Dt.inRCDATA||(e.children=Nh(i)),n===0&&ot.isIgnoreNewlineTag(a)){const l=i[0];l&&l.type===2&&(l.content=l.content.replace(/^\r?\n/,""))}n===0&&ot.isPreTag(a)&&Fd--,Sc===e&&(on=Dt.inVPre=!1,Sc=null),Dt.inXML&&(St[0]?St[0].ns:ot.ns)===0&&(Dt.inXML=!1);{const l=e.props;if(!Dt.inSFCRoot&&Nn("COMPILER_NATIVE_TEMPLATE",ot)&&e.tag==="template"&&!Yu(e)){const r=St[0]||Sl,c=r.children.indexOf(e);r.children.splice(c,1,...e.children)}const o=l.find(r=>r.type===6&&r.name==="inline-template");o&&wl("COMPILER_INLINE_TEMPLATE",ot,o.loc)&&e.children.length&&(o.value={type:2,content:ts(e.children[0].loc.start.offset,e.children[e.children.length-1].loc.end.offset),loc:o.loc})}}function w0(e,t){let s=e;for(;Ha.charCodeAt(s)!==t&&s<Ha.length-1;)s++;return s}function Lh(e,t){let s=e;for(;Ha.charCodeAt(s)!==t&&s>=0;)s--;return s}const k0=new Set(["if","else","else-if","for","slot"]);function Yu({tag:e,props:t}){if(e==="template"){for(let s=0;s<t.length;s++)if(t[s].type===7&&k0.has(t[s].name))return!0}return!1}function S0({tag:e,props:t}){if(ot.isCustomElement(e))return!1;if(e==="component"||T0(e.charCodeAt(0))||Sh(e)||ot.isBuiltInComponent&&ot.isBuiltInComponent(e)||ot.isNativeTag&&!ot.isNativeTag(e))return!0;for(let s=0;s<t.length;s++){const a=t[s];if(a.type===6){if(a.name==="is"&&a.value){if(a.value.content.startsWith("vue:"))return!0;if(wl("COMPILER_IS_ON_ELEMENT",ot,a.loc))return!0}}else if(a.name==="bind"&&Cn(a.arg,"is")&&wl("COMPILER_IS_ON_ELEMENT",ot,a.loc))return!0}return!1}function T0(e){return e>64&&e<91}const C0=/\r\n/g;function Nh(e){const t=ot.whitespace!=="preserve";let s=!1;for(let a=0;a<e.length;a++){const n=e[a];if(n.type===2)if(Fd)n.content=n.content.replace(C0,`
`);else if(Rh(n.content)){const i=e[a-1]&&e[a-1].type,l=e[a+1]&&e[a+1].type;!i||!l||t&&(i===3&&(l===3||l===1)||i===1&&(l===3||l===1&&E0(n.content)))?(s=!0,e[a]=null):n.content=" "}else t&&(n.content=Dh(n.content))}return s?e.filter(Boolean):e}function E0(e){for(let t=0;t<e.length;t++){const s=e.charCodeAt(t);if(s===10||s===13)return!0}return!1}function Dh(e){let t="",s=!1;for(let a=0;a<e.length;a++)Ls(e.charCodeAt(a))?s||(t+=" ",s=!0):(t+=e[a],s=!1);return t}function Tc(e){(St[0]||Sl).children.push(e)}function Mt(e,t){return{start:Dt.getPos(e),end:t==null?t:Dt.getPos(t),source:t==null?t:ts(e,t)}}function A0(e){return Mt(e.start.offset,e.end.offset)}function En(e,t){e.end=Dt.getPos(t),e.source=ts(e.start.offset,t)}function R0(e){const t={type:6,name:e.rawName,nameLoc:Mt(e.loc.start.offset,e.loc.start.offset+e.rawName.length),value:void 0,loc:e.loc};if(e.exp){const s=e.exp.loc;s.end.offset<e.loc.end.offset&&(s.start.offset--,s.start.column--,s.end.offset++,s.end.column++),t.value={type:2,content:e.exp.content,loc:s}}return t}function fo(e,t=!1,s,a=0,n=0){return Ke(e,t,s,a)}function Ca(e,t,s){ot.onError(Tt(e,Mt(t,t)))}function I0(){Dt.reset(),ds=null,tt=null,ks="",Ra=-1,kn=-1,St.length=0}function O0(e,t){if(I0(),Ha=e,ot=Qe({},Oh),t){let n;for(n in t)t[n]!=null&&(ot[n]=t[n])}Dt.mode=ot.parseMode==="html"?1:ot.parseMode==="sfc"?2:0,Dt.inXML=ot.ns===1||ot.ns===2;const s=t&&t.delimiters;s&&(Dt.delimiterOpen=Uo(s[0]),Dt.delimiterClose=Uo(s[1]));const a=Sl=n0([],e);return Dt.parse(Ha),a.loc=Mt(0,e.length),a.children=Nh(a.children),Sl=null,a}function L0(e,t){mo(e,void 0,t,!!Mh(e))}function Mh(e){const t=e.children.filter(s=>s.type!==3);return t.length===1&&t[0].type===1&&!Ho(t[0])?t[0]:null}function mo(e,t,s,a=!1,n=!1){const{children:i}=e,l=[];for(let d=0;d<i.length;d++){const u=i[d];if(u.type===1&&u.tagType===0){const p=a?0:Ns(u,s);if(p>0){if(p>=2){u.codegenNode.patchFlag=-1,l.push(u);continue}}else{const m=u.codegenNode;if(m.type===13){const h=m.patchFlag;if((h===void 0||h===512||h===1)&&Fh(u,s)>=2){const g=$h(u);g&&(m.props=s.hoist(g))}m.dynamicProps&&(m.dynamicProps=s.hoist(m.dynamicProps))}}}else if(u.type===12&&(a?0:Ns(u,s))>=2){u.codegenNode.type===14&&u.codegenNode.arguments.length>0&&u.codegenNode.arguments.push("-1"),l.push(u);continue}if(u.type===1){const p=u.tagType===1;p&&s.scopes.vSlot++,mo(u,e,s,!1,n),p&&s.scopes.vSlot--}else if(u.type===11)mo(u,e,s,u.children.length===1,!0);else if(u.type===9)for(let p=0;p<u.branches.length;p++)mo(u.branches[p],e,s,u.branches[p].children.length===1,n)}let o=!1;if(l.length===i.length&&e.type===1){if(e.tagType===0&&e.codegenNode&&e.codegenNode.type===13&&Ee(e.codegenNode.children))e.codegenNode.children=r(Ln(e.codegenNode.children)),o=!0;else if(e.tagType===1&&e.codegenNode&&e.codegenNode.type===13&&e.codegenNode.children&&!Ee(e.codegenNode.children)&&e.codegenNode.children.type===15){const d=c(e.codegenNode,"default");d&&(d.returns=r(Ln(d.returns)),o=!0)}else if(e.tagType===3&&t&&t.type===1&&t.tagType===1&&t.codegenNode&&t.codegenNode.type===13&&t.codegenNode.children&&!Ee(t.codegenNode.children)&&t.codegenNode.children.type===15){const d=Vs(e,"slot",!0),u=d&&d.arg&&c(t.codegenNode,d.arg);u&&(u.returns=r(Ln(u.returns)),o=!0)}}if(!o)for(const d of l)d.codegenNode=s.cache(d.codegenNode);function r(d){const u=s.cache(d);return u.needArraySpread=!0,u}function c(d,u){if(d.children&&!Ee(d.children)&&d.children.type===15){const p=d.children.properties.find(m=>m.key===u||m.key.content===u);return p&&p.value}}l.length&&s.transformHoist&&s.transformHoist(i,s,e)}function Ns(e,t){const{constantCache:s}=t;switch(e.type){case 1:if(e.tagType!==0)return 0;const a=s.get(e);if(a!==void 0)return a;const n=e.codegenNode;if(n.type!==13||n.isBlock&&e.tag!=="svg"&&e.tag!=="foreignObject"&&e.tag!=="math")return 0;if(n.patchFlag===void 0){let l=3;const o=Fh(e,t);if(o===0)return s.set(e,0),0;o<l&&(l=o);for(let r=0;r<e.children.length;r++){const c=Ns(e.children[r],t);if(c===0)return s.set(e,0),0;c<l&&(l=c)}if(l>1)for(let r=0;r<e.props.length;r++){const c=e.props[r];if(c.type===7&&c.name==="bind"&&c.exp){const d=Ns(c.exp,t);if(d===0)return s.set(e,0),0;d<l&&(l=d)}}if(n.isBlock){for(let r=0;r<e.props.length;r++)if(e.props[r].type===7)return s.set(e,0),0;t.removeHelper(Pn),t.removeHelper(Ai(t.inSSR,n.isComponent)),n.isBlock=!1,t.helper(Ei(t.inSSR,n.isComponent))}return s.set(e,l),l}else return s.set(e,0),0;case 2:case 3:return 3;case 9:case 11:case 10:return 0;case 5:case 12:return Ns(e.content,t);case 4:return e.constType;case 8:let i=3;for(let l=0;l<e.children.length;l++){const o=e.children[l];if(ze(o)||ms(o))continue;const r=Ns(o,t);if(r===0)return 0;r<i&&(i=r)}return i;case 20:return 2;default:return 0}}const N0=new Set([Ad,Rd,xl,Fl]);function Ph(e,t){if(e.type===14&&!ze(e.callee)&&N0.has(e.callee)){const s=e.arguments[0];if(s.type===4)return Ns(s,t);if(s.type===14)return Ph(s,t)}return 0}function Fh(e,t){let s=3;const a=$h(e);if(a&&a.type===15){const{properties:n}=a;for(let i=0;i<n.length;i++){const{key:l,value:o}=n[i],r=Ns(l,t);if(r===0)return r;r<s&&(s=r);let c;if(o.type===4?c=Ns(o,t):o.type===14?c=Ph(o,t):c=0,c===0)return c;c<s&&(s=c)}}return s}function $h(e){const t=e.codegenNode;if(t.type===13)return t.props}function D0(e,{filename:t="",prefixIdentifiers:s=!1,hoistStatic:a=!1,hmr:n=!1,cacheHandlers:i=!1,nodeTransforms:l=[],directiveTransforms:o={},transformHoist:r=null,isBuiltInComponent:c=ns,isCustomElement:d=ns,expressionPlugins:u=[],scopeId:p=null,slotted:m=!0,ssr:h=!1,inSSR:g=!1,ssrCssVars:A="",bindingMetadata:I=et,inline:y=!1,isTS:v=!1,onError:b=Dd,onWarn:x=kh,compatConfig:w}){const C=t.replace(/\?.*$/,"").match(/([^/\\]+)\.\w+$/),E={filename:t,selfName:C&&Bn(yt(C[1])),prefixIdentifiers:s,hoistStatic:a,hmr:n,cacheHandlers:i,nodeTransforms:l,directiveTransforms:o,transformHoist:r,isBuiltInComponent:c,isCustomElement:d,expressionPlugins:u,scopeId:p,slotted:m,ssr:h,inSSR:g,ssrCssVars:A,bindingMetadata:I,inline:y,isTS:v,onError:b,onWarn:x,compatConfig:w,root:e,helpers:new Map,components:new Set,directives:new Set,hoists:[],imports:[],cached:[],constantCache:new WeakMap,vForMemoKeyedNodes:new WeakSet,temps:0,identifiers:Object.create(null),scopes:{vFor:0,vSlot:0,vPre:0,vOnce:0},parent:null,grandParent:null,currentNode:e,childIndex:0,inVOnce:!1,helper(_){const R=E.helpers.get(_)||0;return E.helpers.set(_,R+1),_},removeHelper(_){const R=E.helpers.get(_);if(R){const $=R-1;$?E.helpers.set(_,$):E.helpers.delete(_)}},helperString(_){return`_${Ti[E.helper(_)]}`},replaceNode(_){E.parent.children[E.childIndex]=E.currentNode=_},removeNode(_){const R=E.parent.children,$=_?R.indexOf(_):E.currentNode?E.childIndex:-1;!_||_===E.currentNode?(E.currentNode=null,E.onNodeRemoved()):E.childIndex>$&&(E.childIndex--,E.onNodeRemoved()),E.parent.children.splice($,1)},onNodeRemoved:ns,addIdentifiers(_){},removeIdentifiers(_){},hoist(_){ze(_)&&(_=Ke(_)),E.hoists.push(_);const R=Ke(`_hoisted_${E.hoists.length}`,!1,_.loc,2);return R.hoisted=_,R},cache(_,R=!1,$=!1){const S=i0(E.cached.length,_,R,$);return E.cached.push(S),S}};return E.filters=new Set,E}function M0(e,t){const s=D0(e,t);vr(e,s),t.hoistStatic&&L0(e,s),t.ssr||P0(e,s),e.helpers=new Set([...s.helpers.keys()]),e.components=[...s.components],e.directives=[...s.directives],e.imports=s.imports,e.hoists=s.hoists,e.temps=s.temps,e.cached=s.cached,e.transformed=!0,e.filters=[...s.filters]}function P0(e,t){const{helper:s}=t,{children:a}=e;if(a.length===1){const n=Mh(e);if(n&&n.codegenNode){const i=n.codegenNode;i.type===13&&Nd(i,t),e.codegenNode=i}else e.codegenNode=a[0]}else if(a.length>1){let n=64;e.codegenNode=_l(t,s(yl),void 0,e.children,n,void 0,void 0,!0,void 0,!1)}}function F0(e,t){let s=0;const a=()=>{s--};for(;s<e.children.length;s++){const n=e.children[s];ze(n)||(t.grandParent=t.parent,t.parent=e,t.childIndex=s,t.onNodeRemoved=a,vr(n,t))}}function vr(e,t){t.currentNode=e;const{nodeTransforms:s}=t,a=[];for(let i=0;i<s.length;i++){const l=s[i](e,t);if(l&&(Ee(l)?a.push(...l):a.push(l)),t.currentNode)e=t.currentNode;else return}switch(e.type){case 3:t.ssr||t.helper(Pl);break;case 5:t.ssr||t.helper(mr);break;case 9:for(let i=0;i<e.branches.length;i++)vr(e.branches[i],t);break;case 10:case 11:case 1:case 0:F0(e,t);break}t.currentNode=e;let n=a.length;for(;n--;)a[n]()}function Uh(e,t){const s=ze(e)?a=>a===e:a=>e.test(a);return(a,n)=>{if(a.type===1){const{props:i}=a;if(a.tagType===3&&i.some(v0))return;const l=[];for(let o=0;o<i.length;o++){const r=i[o];if(r.type===7&&s(r.name)){i.splice(o,1),o--;const c=t(a,r,n);c&&l.push(c)}}return l}}}const gr="/*@__PURE__*/",Bh=e=>`${Ti[e]}: _${Ti[e]}`;function $0(e,{mode:t="function",prefixIdentifiers:s=t==="module",sourceMap:a=!1,filename:n="template.vue.html",scopeId:i=null,optimizeImports:l=!1,runtimeGlobalName:o="Vue",runtimeModuleName:r="vue",ssrRuntimeModuleName:c="vue/server-renderer",ssr:d=!1,isTS:u=!1,inSSR:p=!1}){const m={mode:t,prefixIdentifiers:s,sourceMap:a,filename:n,scopeId:i,optimizeImports:l,runtimeGlobalName:o,runtimeModuleName:r,ssrRuntimeModuleName:c,ssr:d,isTS:u,inSSR:p,source:e.source,code:"",column:1,line:1,offset:0,indentLevel:0,pure:!1,map:void 0,helper(g){return`_${Ti[g]}`},push(g,A=-2,I){m.code+=g},indent(){h(++m.indentLevel)},deindent(g=!1){g?--m.indentLevel:h(--m.indentLevel)},newline(){h(m.indentLevel)}};function h(g){m.push(`
...
`,-1)}H0(e.hoists,t),i(),n("return ")}function Hr(e,t,{helper:s,push:a,newline:n,isTS:i}){const l=s(t==="filter"?Td:t==="component"?wd:Sd);for(let o=0;o<e.length;o++){let r=e[o];const c=r.endsWith("__self");c&&(r=r.slice(0,-6)),a(`const ${kl(r,t)} = ${l}(${JSON.stringify(r)}${c?", true":""})${i?"!":""}`),o<e.length-1&&n()}}function H0(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:a}=t;a();for(let n=0;n<e.length;n++){const i=e[n];i&&(s(`const _hoisted_${n+1} = `),fs(i,t),a())}t.pure=!1}function $d(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),$l(e,t,s),s&&t.deindent(),t.push("]")}function $l(e,t,s=!1,a=!0){const{push:n,newline:i}=t;for(let l=0;l<e.length;l++){const o=e[l];ze(o)?n(o,-3):Ee(o)?$d(o,t):fs(o,t),l<e.length-1&&(s?(a&&n(","),i()):a&&n(", "))}}function fs(e,t){if(ze(e)){t.push(e,-3);return}if(ms(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:fs(e.codegenNode,t);break;case 2:z0(e,t);break;case 4:Hh(e,t);break;case 5:j0(e,t);break;case 12:fs(e.codegenNode,t);break;case 8:zh(e,t);break;case 3:q0(e,t);break;case 13:G0(e,t);break;case 14:K0(e,t);break;case 15:J0(e,t);break;case 17:Z0(e,t);break;case 18:Y0(e,t);break;case 19:Q0(e,t);break;case 20:X0(e,t);break;case 21:$l(e.body,t,!0,!1);break}}function z0(e,t){t.push(JSON.stringify(e.content),-3,e)}function Hh(e,t){const{content:s,isStatic:a}=e;t.push(a?JSON.stringify(s):s,-3,e)}function j0(e,t){const{push:s,helper:a,pure:n}=t;n&&s(gr),s(`${a(mr)}(`),fs(e.content,t),s(")")}function zh(e,t){for(let s=0;s<e.children.length;s++){const a=e.children[s];ze(a)?t.push(a,-3):fs(a,t)}}function V0(e,t){const{push:s}=t;if(e.type===8)s("["),zh(e,t),s("]");else if(e.isStatic){const a=Md(e.content)?e.content:JSON.stringify(e.content);s(a,-2,e)}else s(`[${e.content}]`,-3,e)}function q0(e,t){const{push:s,helper:a,pure:n}=t;n&&s(gr),s(`${a(Pl)}(${JSON.stringify(e.content)})`,-3,e)}function G0(e,t){const{push:s,helper:a,pure:n}=t,{tag:i,props:l,children:o,patchFlag:r,dynamicProps:c,directives:d,isBlock:u,disableTracking:p,isComponent:m}=e;let h;r&&(h=String(r)),d&&s(a(Cd)+"("),u&&s(`(${a(Pn)}(${p?"true":""}), `),n&&s(gr);const g=u?Ai(t.inSSR,m):Ei(t.inSSR,m);s(a(g)+"(",-2,e),$l(W0([i,l,o,h,c]),t),s(")"),u&&s(")"),d&&(s(", "),fs(d,t),s(")"))}function W0(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function K0(e,t){const{push:s,helper:a,pure:n}=t,i=ze(e.callee)?e.callee:a(e.callee);n&&s(gr),s(i+"(",-2,e),$l(e.arguments,t),s(")")}function J0(e,t){const{push:s,indent:a,deindent:n,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const o=l.length>1||!1;s(o?"{":"{ "),o&&a();for(let r=0;r<l.length;r++){const{key:c,value:d}=l[r];V0(c,t),s(": "),fs(d,t),r<l.length-1&&(s(","),i())}o&&n(),s(o?"}":" }")}function Z0(e,t){$d(e.elements,t)}function Y0(e,t){const{push:s,indent:a,deindent:n}=t,{params:i,returns:l,body:o,newline:r,isSlot:c}=e;c&&s(`_${Ti[Od]}(`),s("(",-2,e),Ee(i)?$l(i,t):i&&fs(i,t),s(") => "),(r||o)&&(s("{"),a()),l?(r&&s("return "),Ee(l)?$d(l,t):fs(l,t)):o&&fs(o,t),(r||o)&&(n(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function Q0(e,t){const{test:s,consequent:a,alternate:n,newline:i}=e,{push:l,indent:o,deindent:r,newline:c}=t;if(s.type===4){const u=!Md(s.content);u&&l("("),Hh(s,t),u&&l(")")}else l("("),fs(s,t),l(")");i&&o(),t.indentLevel++,i||l(" "),l("? "),fs(a,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const d=n.type===19;d||t.indentLevel++,fs(n,t),d||t.indentLevel--,i&&r(!0)}function X0(e,t){const{push:s,helper:a,indent:n,deindent:i,newline:l}=t,{needPauseTracking:o,needArraySpread:r}=e;r&&s("[...("),s(`_cache[${e.index}] || (`),o&&(n(),s(`${a($o)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),fs(e.value,t),o&&(s(`).cacheIndex = ${e.index},`),l(),s(`${a($o)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),r&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const e_=Uh(/^(?:if|else|else-if)$/,(e,t,s)=>t_(e,t,s,(a,n,i)=>{const l=s.parent.children;let o=l.indexOf(a),r=0;for(;o-->=0;){const c=l[o];c&&c.type===9&&(r+=c.branches.length)}return()=>{if(i)a.codegenNode=Xu(n,r,s);else{const c=s_(a.codegenNode);c.alternate=Xu(n,r+a.branches.length-1,s)}}}));function t_(e,t,s,a){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const n=t.exp?t.exp.loc:e.loc;s.onError(Tt(28,t.loc)),t.exp=Ke("true",!1,n)}if(t.name==="if"){const n=Qu(e,t),i={type:9,loc:A0(e.loc),branches:[n]};if(s.replaceNode(i),a)return a(i,n,!0)}else{const n=s.parent.children;let i=n.indexOf(e);for(;i-->=-1;){const l=n[i];if(l&&Ih(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(Tt(30,e.loc)),s.removeNode();const o=Qu(e,t);l.branches.push(o);const r=a&&a(l,o,!1);vr(o,s),r&&r(),s.currentNode=null}else s.onError(Tt(30,e.loc));break}}}function Qu(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!Vs(e,"for")?e.children:[e],userKey:hr(e,"key"),isTemplateIf:s}}function Xu(e,t,s){return e.condition?kc(e.condition,ep(e,t,s),Kt(s.helper(Pl),['""',"true"])):ep(e,t,s)}function ep(e,t,s){const{helper:a}=s,n=Bt("key",Ke(`${t}`,!1,Ps,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const r=l.codegenNode;return zo(r,n,s),r}else return _l(s,a(yl),qs([n]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const r=l.codegenNode,c=b0(r);return c.type===13&&Nd(c,s),zo(c,n,s),r}}function s_(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const a_=Uh("for",(e,t,s)=>{const{helper:a,removeHelper:n}=s;return n_(e,t,s,i=>{const l=Kt(a(Ed),[i.source]),o=Bo(e),r=Vs(e,"memo"),c=hr(e,"key",!1,!0);c&&c.type;let d=c&&(c.type===6?c.value?Ke(c.value.content,!0):void 0:c.exp);const u=d?Bt("key",d):null,p=i.source.type===4&&i.source.constType>0,m=p?64:c?128:256;return i.codegenNode=_l(s,a(yl),void 0,l,m,void 0,void 0,!0,!p,!1,e.loc),()=>{let h;const{children:g}=i,A=g.length!==1||g[0].type!==1,I=Ho(e)?e:o&&e.children.length===1&&Ho(e.children[0])?e.children[0]:null;if(I?(h=I.codegenNode,o&&u&&zo(h,u,s)):A?h=_l(s,a(yl),u?qs([u]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(h=g[0].codegenNode,o&&u&&zo(h,u,s),h.isBlock!==!p&&(h.isBlock?(n(Pn),n(Ai(s.inSSR,h.isComponent))):n(Ei(s.inSSR,h.isComponent))),h.isBlock=!p,h.isBlock?(a(Pn),a(Ai(s.inSSR,h.isComponent))):a(Ei(s.inSSR,h.isComponent))),r){const y=Ci(Cc(i.parseResult,[Ke("_cached")]));y.body=l0([sa(["const _memo = (",r.exp,")"]),sa(["if (_cached && _cached.el",...d?[" && _cached.key === ",d]:[],` && ${s.helperString(wh)}(_cached, _memo)) return _cached`]),sa(["const _item = ",h]),Ke("_item.memo = _memo"),Ke("return _item")]),l.arguments.push(y,Ke("_cache"),Ke(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(Ci(Cc(i.parseResult),h,!0))}})});function n_(e,t,s,a){if(!t.exp){s.onError(Tt(31,t.loc));return}const n=t.forParseResult;if(!n){s.onError(Tt(32,t.loc));return}jh(n);const{addIdentifiers:i,removeIdentifiers:l,scopes:o}=s,{source:r,value:c,key:d,index:u}=n,p={type:11,loc:t.loc,source:r,valueAlias:c,keyAlias:d,objectIndexAlias:u,parseResult:n,children:Bo(e)?e.children:[e]};s.replaceNode(p),o.vFor++;const m=a&&a(p);return()=>{o.vFor--,m&&m()}}function jh(e,t){e.finalized||(e.finalized=!0)}function Cc({value:e,key:t,index:s},a=[]){return i_([e,t,s,...a])}function i_(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,a)=>s||Ke("_".repeat(a+1),!1))}const tp=Ke("undefined",!1),l_=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=Vs(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},o_=(e,t,s,a)=>Ci(e,s,!1,!0,s.length?s[0].loc:a);function r_(e,t,s=o_){t.helper(Od);const{children:a,loc:n}=e,i=[],l=[];let o=t.scopes.vSlot>0||t.scopes.vFor>0;const r=Vs(e,"slot",!0);if(r){const{arg:A,exp:I}=r;A&&!As(A)&&(o=!0),i.push(Bt(A||Ke("default",!0),s(I,void 0,a,n)))}let c=!1,d=!1;const u=[],p=new Set;let m=0;for(let A=0;A<a.length;A++){const I=a[A];let y;if(!Bo(I)||!(y=Vs(I,"slot",!0))){I.type!==3&&u.push(I);continue}if(r){t.onError(Tt(37,y.loc));break}c=!0;const{children:v,loc:b}=I,{arg:x=Ke("default",!0),exp:w,loc:C}=y;let E;As(x)?E=x?x.content:"default":o=!0;const _=Vs(I,"for"),R=s(w,_,v,b);let $,S;if($=Vs(I,"if"))o=!0,l.push(kc($.exp,eo(x,R,m++),tp));else if(S=Vs(I,/^else(?:-if)?$/,!0)){let M=A,Q;for(;M--&&(Q=a[M],!!Ih(Q)););if(Q&&Bo(Q)&&Vs(Q,/^(?:else-)?if$/)){let W=l[l.length-1];for(;W.alternate.type===19;)W=W.alternate;W.alternate=S.exp?kc(S.exp,eo(x,R,m++),tp):eo(x,R,m++)}else t.onError(Tt(30,S.loc))}else if(_){o=!0;const M=_.forParseResult;M?(jh(M),l.push(Kt(t.helper(Ed),[M.source,Ci(Cc(M),eo(x,R),!0)]))):t.onError(Tt(32,_.loc))}else{if(E){if(p.has(E)){t.onError(Tt(38,C));continue}p.add(E),E==="default"&&(d=!0)}i.push(Bt(x,R))}}if(!r){const A=(I,y)=>{const v=s(I,void 0,y,n);return t.compatConfig&&(v.isNonScopedSlot=!0),Bt("default",v)};c?u.length&&!u.every(Pd)&&(d?t.onError(Tt(39,u[0].loc)):i.push(A(void 0,u))):i.push(A(void 0,a))}const h=o?2:ho(e.children)?3:1;let g=qs(i.concat(Bt("_",Ke(h+"",!1))),n);return l.length&&(g=Kt(t.helper(_h),[g,Ln(l)])),{slots:g,hasDynamicSlots:o}}function eo(e,t,s){const a=[Bt("name",e),Bt("fn",t)];return s!=null&&a.push(Bt("key",Ke(String(s),!0))),qs(a)}function ho(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||ho(s.children))return!0;break;case 9:if(ho(s.branches))return!0;break;case 10:case 11:if(ho(s.children))return!0;break}}return!1}const Vh=new WeakMap,c_=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:a,props:n}=e,i=e.tagType===1;let l=i?d_(e,t):`"${a}"`;const o=rt(l)&&l.callee===kd;let r,c,d=0,u,p,m,h=o||l===nl||l===bd||!i&&(a==="svg"||a==="foreignObject"||a==="math");if(n.length>0){const g=qh(e,t,void 0,i,o);r=g.props,d=g.patchFlag,p=g.dynamicPropNames;const A=g.directives;m=A&&A.length?Ln(A.map(I=>p_(I,t))):void 0,g.shouldUseBlock&&(h=!0)}if(e.children.length>0)if(l===Po&&(h=!0,d|=1024),i&&l!==nl&&l!==Po){const{slots:A,hasDynamicSlots:I}=r_(e,t);c=A,I&&(d|=1024)}else if(e.children.length===1&&l!==nl){const A=e.children[0],I=A.type,y=I===5||I===8;y&&Ns(A,t)===0&&(d|=1),y||I===2?c=A:c=e.children}else c=e.children;p&&p.length&&(u=f_(p)),e.codegenNode=_l(t,l,r,c,d===0?void 0:d,u,m,!!h,!1,i,e.loc)};function d_(e,t,s=!1){let{tag:a}=e;const n=Ec(a),i=hr(e,"is",!1,!0);if(i)if(n||Nn("COMPILER_IS_ON_ELEMENT",t)){let o;if(i.type===6?o=i.value&&Ke(i.value.content,!0):(o=i.exp,o||(o=Ke("is",!1,i.arg.loc))),o)return Kt(t.helper(kd),[o])}else i.type===6&&i.value.content.startsWith("vue:")&&(a=i.value.content.slice(4));const l=Sh(a)||t.isBuiltInComponent(a);return l?(s||t.helper(l),l):(t.helper(wd),t.components.add(a),kl(a,"component"))}function qh(e,t,s=e.props,a,n,i=!1){const{tag:l,loc:o,children:r}=e;let c=[];const d=[],u=[],p=r.length>0;let m=!1,h=0,g=!1,A=!1,I=!1,y=!1,v=!1,b=!1;const x=[],w=R=>{c.length&&(d.push(qs(sp(c),o)),c=[]),R&&d.push(R)},C=()=>{t.scopes.vFor>0&&c.push(Bt(Ke("ref_for",!0),Ke("true")))},E=({key:R,value:$})=>{if(As(R)){const S=R.content,M=$n(S);if(M&&(!a||n)&&S.toLowerCase()!=="onclick"&&S!=="onUpdate:modelValue"&&!$a(S)&&(y=!0),M&&$a(S)&&(b=!0),M&&$.type===14&&($=$.arguments[0]),$.type===20||($.type===4||$.type===8)&&Ns($,t)>0)return;S==="ref"?g=!0:S==="class"?A=!0:S==="style"?I=!0:S!=="key"&&!x.includes(S)&&x.push(S),a&&(S==="class"||S==="style")&&!x.includes(S)&&x.push(S)}else v=!0};for(let R=0;R<s.length;R++){const $=s[R];if($.type===6){const{loc:S,name:M,nameLoc:Q,value:W}=$;let D=!0;if(M==="ref"&&(g=!0,C()),M==="is"&&(Ec(l)||W&&W.content.startsWith("vue:")||Nn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(Bt(Ke(M,!0,Q),Ke(W?W.content:"",D,W?W.loc:S)))}else{const{name:S,arg:M,exp:Q,loc:W,modifiers:D}=$,O=S==="bind",N=S==="on";if(S==="slot"){a||t.onError(Tt(40,W));continue}if(S==="once"||S==="memo"||S==="is"||O&&Cn(M,"is")&&(Ec(l)||Nn("COMPILER_IS_ON_ELEMENT",t))||N&&i)continue;if((O&&Cn(M,"key")||N&&p&&Cn(M,"vue:before-update"))&&(m=!0),O&&Cn(M,"ref")&&C(),!M&&(O||N)){if(v=!0,Q)if(O){if(w(),Nn("COMPILER_V_BIND_OBJECT_ORDER",t)){d.unshift(Q);continue}C(),w(),d.push(Q)}else w({type:14,loc:W,callee:t.helper(Id),arguments:a?[Q]:[Q,"true"]});else t.onError(Tt(O?34:35,W));continue}O&&D.some(le=>le.content==="prop")&&(h|=32);const ie=t.directiveTransforms[S];if(ie){const{props:le,needRuntime:B}=ie($,e,t);!i&&le.forEach(E),N&&M&&!As(M)?w(qs(le,o)):c.push(...le),B&&(u.push($),ms(B)&&Vh.set($,B))}else ag(S)||(u.push($),p&&(m=!0))}}let _;if(d.length?(w(),d.length>1?_=Kt(t.helper(Fo),d,o):_=d[0]):c.length&&(_=qs(sp(c),o)),v?h|=16:(A&&!a&&(h|=2),I&&!a&&(h|=4),x.length&&(h|=8),y&&(h|=32)),!m&&(h===0||h===32)&&(g||b||u.length>0)&&(h|=512),!t.inSSR&&_)switch(_.type){case 15:let R=-1,$=-1,S=!1;for(let W=0;W<_.properties.length;W++){const D=_.properties[W].key;As(D)?D.content==="class"?R=W:D.content==="style"&&($=W):D.isHandlerKey||(S=!0)}const M=_.properties[R],Q=_.properties[$];S?_=Kt(t.helper(xl),[_]):(M&&!As(M.value)&&(M.value=Kt(t.helper(Ad),[M.value])),Q&&(I||Q.value.type===4&&Q.value.content.trim()[0]==="["||Q.value.type===17)&&(Q.value=Kt(t.helper(Rd),[Q.value])));break;case 14:break;default:_=Kt(t.helper(xl),[Kt(t.helper(Fl),[_])]);break}return{props:_,directives:u,patchFlag:h,dynamicPropNames:x,shouldUseBlock:m}}function sp(e){const t=new Map,s=[];for(let a=0;a<e.length;a++){const n=e[a];if(n.key.type===8||!n.key.isStatic){s.push(n);continue}const i=n.key.content,l=t.get(i);l?(i==="style"||i==="class"||$n(i))&&u_(l,n):(t.set(i,n),s.push(n))}return s}function u_(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Ln([e.value,t.value],e.loc)}function p_(e,t){const s=[],a=Vh.get(e);a?s.push(t.helperString(a)):(t.helper(Sd),t.directives.add(e.name),s.push(kl(e.name,"directive")));const{loc:n}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=Ke("true",!1,n);s.push(qs(e.modifiers.map(l=>Bt(l,i)),n))}return Ln(s,e.loc)}function f_(e){let t="[";for(let s=0,a=e.length;s<a;s++)t+=JSON.stringify(e[s]),s<a-1&&(t+=", ");return t+"]"}function Ec(e){return e==="component"||e==="Component"}const m_=(e,t)=>{if(Ho(e)){const{children:s,loc:a}=e,{slotName:n,slotProps:i}=h_(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",n,"{}","undefined","true"];let o=2;i&&(l[2]=i,o=3),s.length&&(l[3]=Ci([],s,!1,!1,a),o=4),t.scopeId&&!t.slotted&&(o=5),l.splice(o),e.codegenNode=Kt(t.helper(xh),l,a)}};function h_(e,t){let s='"default"',a;const n=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=yt(l.name),n.push(l)));else if(l.name==="bind"&&Cn(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const o=yt(l.arg.content);s=l.exp=Ke(o,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&As(l.arg)&&(l.arg.content=yt(l.arg.content)),n.push(l)}if(n.length>0){const{props:i,directives:l}=qh(e,t,n,!1,!1);a=i,l.length&&t.onError(Tt(36,l[0].loc))}return{slotName:s,slotProps:a}}const Gh=(e,t,s,a)=>{const{loc:n,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(Tt(35,n));let o;if(l.type===4)if(l.isStatic){let u=l.content;u.startsWith("vue:")&&(u=`vnode-${u.slice(4)}`);const p=t.tagType!==0||u.startsWith("vnode")||!/[A-Z]/.test(u)?pi(yt(u)):`on:${u}`;o=Ke(p,!0,l.loc)}else o=sa([`${s.helperString(wc)}(`,l,")"]);else o=l,o.children.unshift(`${s.helperString(wc)}(`),o.children.push(")");let r=e.exp;r&&!r.content.trim()&&(r=void 0);let c=s.cacheHandlers&&!r&&!s.inVOnce;if(r){const u=Eh(r),p=!(u||m0(r)),m=r.content.includes(";");(p||c&&u)&&(r=sa([`${p?"$event":"(...args)"} => ${m?"{":"("}`,r,m?"}":")"]))}let d={props:[Bt(o,r||Ke("() => {}",!1,n))]};return a&&(d=a(d)),c&&(d.props[0].value=s.cache(d.props[0].value)),d.props.forEach(u=>u.key.isHandlerKey=!0),d},v_=(e,t,s)=>{const{modifiers:a,loc:n}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),a.some(o=>o.content==="camel")&&(i.type===4?i.isStatic?i.content=yt(i.content):i.content=`${s.helperString(_c)}(${i.content})`:(i.children.unshift(`${s.helperString(_c)}(`),i.children.push(")"))),s.inSSR||(a.some(o=>o.content==="prop")&&ap(i,"."),a.some(o=>o.content==="attr")&&ap(i,"^")),{props:[Bt(i,l)]}},ap=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},g_=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let a,n=!1;for(let i=0;i<s.length;i++){const l=s[i];if(Br(l)){n=!0;for(let o=i+1;o<s.length;o++){const r=s[o];if(Br(r))a||(a=s[i]=sa([l],l.loc)),a.children.push(" + ",r),s.splice(o,1),o--;else{a=void 0;break}}}}if(!(!n||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(Br(l)||l.type===8){const o=[];(l.type!==2||l.content!==" ")&&o.push(l),!t.ssr&&Ns(l,t)===0&&o.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:Kt(t.helper(_d),o)}}}}},np=new WeakSet,b_=(e,t)=>{if(e.type===1&&Vs(e,"once",!0))return np.has(e)||t.inVOnce||t.inSSR?void 0:(np.add(e),t.inVOnce=!0,t.helper($o),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Wh=(e,t,s)=>{const{exp:a,arg:n}=e;if(!a)return s.onError(Tt(41,e.loc)),Bi();const i=a.loc.source.trim(),l=a.type===4?a.content:i,o=s.bindingMetadata[i];if(o==="props"||o==="props-aliased")return s.onError(Tt(44,a.loc)),Bi();if(o==="literal-const"||o==="setup-const")return s.onError(Tt(45,a.loc)),Bi();if(!l.trim()||!Eh(a))return s.onError(Tt(42,a.loc)),Bi();const r=n||Ke("modelValue",!0),c=n?As(n)?`onUpdate:${yt(n.content)}`:sa(['"onUpdate:" + ',n]):"onUpdate:modelValue";let d;const u=s.isTS?"($event: any)":"$event";d=sa([`${u} => ((`,a,") = $event)"]);const p=[Bt(r,e.exp),Bt(c,d)];if(e.modifiers.length&&t.tagType===1){const m=e.modifiers.map(g=>g.content).map(g=>(Md(g)?g:JSON.stringify(g))+": true").join(", "),h=n?As(n)?`${n.content}Modifiers`:sa([n,' + "Modifiers"']):"modelModifiers";p.push(Bt(h,Ke(`{ ${m} }`,!1,e.loc,2)))}return Bi(p)};function Bi(e=[]){return{props:e}}const y_=/[\w).+\-_$\]]/,x_=(e,t)=>{Nn("COMPILER_FILTERS",t)&&(e.type===5?jo(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&jo(s.exp,t)}))};function jo(e,t){if(e.type===4)ip(e,t);else for(let s=0;s<e.children.length;s++){const a=e.children[s];typeof a=="object"&&(a.type===4?ip(a,t):a.type===8?jo(e,t):a.type===5&&jo(a.content,t))}}function ip(e,t){const s=e.content;let a=!1,n=!1,i=!1,l=!1,o=0,r=0,c=0,d=0,u,p,m,h,g=[];for(m=0;m<s.length;m++)if(p=u,u=s.charCodeAt(m),a)u===39&&p!==92&&(a=!1);else if(n)u===34&&p!==92&&(n=!1);else if(i)u===96&&p!==92&&(i=!1);else if(l)u===47&&p!==92&&(l=!1);else if(u===124&&s.charCodeAt(m+1)!==124&&s.charCodeAt(m-1)!==124&&!o&&!r&&!c)h===void 0?(d=m+1,h=s.slice(0,m).trim()):A();else{switch(u){case 34:n=!0;break;case 39:a=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:r++;break;case 93:r--;break;case 123:o++;break;case 125:o--;break}if(u===47){let I=m-1,y;for(;I>=0&&(y=s.charAt(I),y===" ");I--);(!y||!y_.test(y))&&(l=!0)}}h===void 0?h=s.slice(0,m).trim():d!==0&&A();function A(){g.push(s.slice(d,m).trim()),d=m+1}if(g.length){for(m=0;m<g.length;m++)h=__(h,g[m],t);e.content=h,e.ast=void 0}}function __(e,t,s){s.helper(Td);const a=t.indexOf("(");if(a<0)return s.filters.add(t),`${kl(t,"filter")}(${e})`;{const n=t.slice(0,a),i=t.slice(a+1);return s.filters.add(n),`${kl(n,"filter")}(${e}${i!==")"?","+i:i}`}}const lp=new WeakSet,w_=(e,t)=>{if(e.type===1){const s=Vs(e,"memo");return!s||lp.has(e)||t.inSSR?void 0:(lp.add(e),()=>{const a=e.codegenNode||t.currentNode.codegenNode;a&&a.type===13&&(e.tagType!==1&&Nd(a,t),e.codegenNode=Kt(t.helper(Ld),[s.exp,Ci(void 0,a),"_cache",String(t.cached.length)]),t.cached.push(null))})}},k_=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const a=s.arg;if(a.type!==4||!a.isStatic)t.onError(Tt(53,a.loc)),s.exp=Ke("",!0,a.loc);else{const n=yt(a.content);(Th.test(n[0])||n[0]==="-")&&(s.exp=Ke(n,!1,a.loc))}}}};function S_(e){return[[k_,b_,e_,w_,a_,x_,m_,c_,l_,g_],{on:Gh,bind:v_,model:Wh}]}function T_(e,t={}){const s=t.onError||Dd,a=t.mode==="module";t.prefixIdentifiers===!0?s(Tt(48)):a&&s(Tt(49));const n=!1;t.cacheHandlers&&s(Tt(50)),t.scopeId&&!a&&s(Tt(51));const i=Qe({},t,{prefixIdentifiers:n}),l=ze(e)?O0(e,i):e,[o,r]=S_();return M0(l,Qe({},i,{nodeTransforms:[...o,...t.nodeTransforms||[]],directiveTransforms:Qe({},r,t.directiveTransforms||{})})),U0(l,i)}const C_=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Kh=Symbol(""),Jh=Symbol(""),Zh=Symbol(""),Yh=Symbol(""),Ac=Symbol(""),Qh=Symbol(""),Xh=Symbol(""),ev=Symbol(""),tv=Symbol(""),sv=Symbol("");a0({[Kh]:"vModelRadio",[Jh]:"vModelCheckbox",[Zh]:"vModelText",[Yh]:"vModelSelect",[Ac]:"vModelDynamic",[Qh]:"withModifiers",[Xh]:"withKeys",[ev]:"vShow",[tv]:"Transition",[sv]:"TransitionGroup"});let Xn;function E_(e,t=!1){return Xn||(Xn=document.createElement("div")),t?(Xn.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,Xn.children[0].getAttribute("foo")):(Xn.innerHTML=e,Xn.textContent)}const A_={parseMode:"html",isVoidTag:xg,isNativeTag:e=>gg(e)||bg(e)||yg(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:E_,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return tv;if(e==="TransitionGroup"||e==="transition-group")return sv},getNamespace(e,t,s){let a=t?t.ns:s;if(t&&a===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(n=>n.type===6&&n.name==="encoding"&&n.value!=null&&(n.value.content==="text/html"||n.value.content==="application/xhtml+xml"))&&(a=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(a=0);else t&&a===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(a=0);if(a===0){if(e==="svg")return 1;if(e==="math")return 2}return a}},R_=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:Ke("style",!0,t.loc),exp:I_(t.value.content,t.loc),modifiers:[],loc:t.loc})})},I_=(e,t)=>{const s=hf(e);return Ke(JSON.stringify(s),!1,t,3)};function un(e,t){return Tt(e,t)}const O_=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(un(54,n)),t.children.length&&(s.onError(un(55,n)),t.children.length=0),{props:[Bt(Ke("innerHTML",!0,n),a||Ke("",!0))]}},L_=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(un(56,n)),t.children.length&&(s.onError(un(57,n)),t.children.length=0),{props:[Bt(Ke("textContent",!0),a?Ns(a,s)>0?a:Kt(s.helperString(mr),[a],n):Ke("",!0))]}},N_=(e,t,s)=>{const a=Wh(e,t,s);if(!a.props.length||t.tagType===1)return a;e.arg&&s.onError(un(59,e.arg.loc));const{tag:n}=t,i=s.isCustomElement(n);if(n==="input"||n==="textarea"||n==="select"||i){let l=Zh,o=!1;if(n==="input"||i){const r=hr(t,"type");if(r){if(r.type===7)l=Ac;else if(r.value)switch(r.value.content){case"radio":l=Kh;break;case"checkbox":l=Jh;break;case"file":o=!0,s.onError(un(60,e.loc));break}}else h0(t)&&(l=Ac)}else n==="select"&&(l=Yh);o||(a.needRuntime=s.helper(l))}else s.onError(un(58,e.loc));return a.props=a.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),a},D_=Ms("passive,once,capture"),M_=Ms("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),P_=Ms("left,right"),av=Ms("onkeyup,onkeydown,onkeypress"),F_=(e,t,s,a)=>{const n=[],i=[],l=[];for(let o=0;o<t.length;o++){const r=t[o].content;r==="native"&&wl("COMPILER_V_ON_NATIVE",s)||D_(r)?l.push(r):P_(r)?As(e)?av(e.content.toLowerCase())?n.push(r):i.push(r):(n.push(r),i.push(r)):M_(r)?i.push(r):n.push(r)}return{keyModifiers:n,nonKeyModifiers:i,eventOptionModifiers:l}},op=(e,t)=>As(e)&&e.content.toLowerCase()==="onclick"?Ke(t,!0):e.type!==4?sa(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,$_=(e,t,s)=>Gh(e,t,s,a=>{const{modifiers:n}=e;if(!n.length)return a;let{key:i,value:l}=a.props[0];const{keyModifiers:o,nonKeyModifiers:r,eventOptionModifiers:c}=F_(i,n,s,e.loc);if(r.includes("right")&&(i=op(i,"onContextmenu")),r.includes("middle")&&(i=op(i,"onMouseup")),r.length&&(l=Kt(s.helper(Qh),[l,JSON.stringify(r)])),o.length&&(!As(i)||av(i.content.toLowerCase()))&&(l=Kt(s.helper(Xh),[l,JSON.stringify(o)])),c.length){const d=c.map(Bn).join("");i=As(i)?Ke(`${i.content}${d}`,!0):sa(["(",i,`) + "${d}"`])}return{props:[Bt(i,l)]}}),U_=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(un(62,n)),{props:[],needRuntime:s.helper(ev)}},B_=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},H_=[R_],z_={cloak:C_,html:O_,text:L_,model:N_,on:$_,show:U_};function j_(e,t={}){return T_(e,Qe({},A_,t,{nodeTransforms:[B_,...H_,...t.nodeTransforms||[]],directiveTransforms:Qe({},z_,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const rp=Object.create(null);function V_(e,t){if(!ze(e))if(e.nodeType)e=e.innerHTML;else return ns;const s=lg(e,t),a=rp[s];if(a)return a;if(e[0]==="#"){const o=document.querySelector(e);e=o?o.innerHTML:""}const n=Qe({hoistStatic:!0,onError:void 0,onWarn:ns},t);!n.isCustomElement&&typeof customElements<"u"&&(n.isCustomElement=o=>!!customElements.get(o));const{code:i}=j_(e,n),l=new Function("Vue",i)(Yx);return l._rc=!0,rp[s]=l}Bm(V_);const Vo=fn({items:[]});let q_=1;function br(e,t="info",s=3e3){const a=q_++;return Vo.items.push({id:a,message:String(e),type:t}),s>0&&setTimeout(()=>Ud(a),s),a}function Ud(e){const t=Vo.items.findIndex(s=>s.id===e);t>=0&&Vo.items.splice(t,1)}function ke(e,t="info",s=3e3){return br(e,t,s)}ke.success=(e,t=3e3)=>br(e,"success",t);ke.error=(e,t=5e3)=>br(e,"error",t);ke.info=(e,t=3e3)=>br(e,"info",t);ke.dismiss=Ud;const G_={setup(){return{state:Vo,dismiss:Ud}},template:`
  ...
  `},La=fn({open:!1,title:"Confirm",message:"",confirmLabel:"Confirm",cancelLabel:"Cancel",danger:!1});let bi=null;function Qt({title:e="Confirm",message:t="",confirmLabel:s="Confirm",cancelLabel:a="Cancel",danger:n=!1}={}){return bi&&bi(!1),La.title=e,La.message=t,La.confirmLabel=s,La.cancelLabel=a,La.danger=n,La.open=!0,new Promise(i=>{bi=i})}function cp(e){La.open=!1,bi&&(bi(e),bi=null)}const W_={setup(){function e(t){La.open&&t.key==="Escape"&&(t.stopPropagation(),cp(!1))}return Ye(()=>document.addEventListener("keydown",e,!0)),gt(()=>document.removeEventListener("keydown",e,!0)),{state:La,settle:cp}},template:`
 ...
 * @license MIT
 */const ii=typeof document<"u";function nv(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function K_(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&nv(e.default)}const ht=Object.assign;function zr(e,t){const s={};for(const a in t){const n=t[a];s[a]=na(n)?n.map(e):e(n)}return s}const il=()=>{},na=Array.isArray;function dp(e,t){const s={};for(const a in e)s[a]=a in t?t[a]:e[a];return s}const iv=/#/g,J_=/&/g,Z_=/\//g,Y_=/=/g,Q_=/\?/g,lv=/\+/g,X_=/%5B/g,ew=/%5D/g,ov=/%5E/g,tw=/%60/g,rv=/%7B/g,sw=/%7C/g,cv=/%7D/g,aw=/%20/g;function Bd(e){return e==null?"":encodeURI(""+e).replace(sw,"|").replace(X_,"[").replace(ew,"]")}function nw(e){return Bd(e).replace(rv,"{").replace(cv,"}").replace(ov,"^")}function Rc(e){return Bd(e).replace(lv,"%2B").replace(aw,"+").replace(iv,"%23").replace(J_,"%26").replace(tw,"`").replace(rv,"{").replace(cv,"}").replace(ov,"^")}function iw(e){return Rc(e).replace(Y_,"%3D")}function lw(e){return Bd(e).replace(iv,"%23").replace(Q_,"%3F")}function ow(e){return lw(e).replace(Z_,"%2F")}function Tl(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const rw=/\/$/,cw=e=>e.replace(rw,"");function jr(e,t,s="/"){let a,n={},i="",l="";const o=t.indexOf("#");let r=t.indexOf("?");return r=o>=0&&r>o?-1:r,r>=0&&(a=t.slice(0,r),i=t.slice(r,o>0?o:t.length),n=e(i.slice(1))),o>=0&&(a=a||t.slice(0,o),l=t.slice(o,t.length)),a=fw(a??t,s),{fullPath:a+i+l,path:a,query:n,hash:Tl(l)}}function dw(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function up(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function uw(e,t,s){const a=t.matched.length-1,n=s.matched.length-1;return a>-1&&a===n&&Ri(t.matched[a],s.matched[n])&&dv(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function Ri(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function dv(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!pw(e[s],t[s]))return!1;return!0}function pw(e,t){return na(e)?pp(e,t):na(t)?pp(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function pp(e,t){return na(t)?e.length===t.length&&e.every((s,a)=>s===t[a]):e.length===1&&e[0]===t}function fw(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),a=e.split("/"),n=a[a.length-1];(n===".."||n===".")&&a.push("");let i=s.length-1,l,o;for(l=0;l<a.length;l++)if(o=a[l],o!==".")if(o==="..")i>1&&i--;else break;return s.slice(0,i).join("/")+"/"+a.slice(l).join("/")}const tn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Ic=(function(e){return e.pop="pop",e.push="push",e})({}),Vr=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function mw(e){if(!e)if(ii){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),cw(e)}const hw=/^[^#]+#/;function vw(e,t){return e.replace(hw,"#")+t}function gw(e,t){const s=document.documentElement.getBoundingClientRect(),a=e.getBoundingClientRect();return{behavior:t.behavior,left:a.left-s.left-(t.left||0),top:a.top-s.top-(t.top||0)}}const yr=()=>({left:window.scrollX,top:window.scrollY});function bw(e){let t;if("el"in e){const s=e.el,a=typeof s=="string"&&s.startsWith("#"),n=typeof s=="string"?a?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!n)return;t=gw(n,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function fp(e,t){return(history.state?history.state.position-t:-1)+e}const Oc=new Map;function yw(e,t){Oc.set(e,t)}function xw(e){const t=Oc.get(e);return Oc.delete(e),t}function _w(e){return typeof e=="string"||e&&typeof e=="object"}function uv(e){return typeof e=="string"||typeof e=="symbol"}let Nt=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const pv=Symbol("");Nt.MATCHER_NOT_FOUND+"",Nt.NAVIGATION_GUARD_REDIRECT+"",Nt.NAVIGATION_ABORTED+"",Nt.NAVIGATION_CANCELLED+"",Nt.NAVIGATION_DUPLICATED+"";function Ii(e,t){return ht(new Error,{type:e,[pv]:!0},t)}function Ea(e,t){return e instanceof Error&&pv in e&&(t==null||!!(e.type&t))}const ww=["params","query","hash"];function kw(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of ww)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}function Sw(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let a=0;a<s.length;++a){const n=s[a].replace(lv," "),i=n.indexOf("="),l=Tl(i<0?n:n.slice(0,i)),o=i<0?null:Tl(n.slice(i+1));if(l in t){let r=t[l];na(r)||(r=t[l]=[r]),r.push(o)}else t[l]=o}return t}function mp(e){let t="";for(let s in e){const a=e[s];if(s=iw(s),a==null){a!==void 0&&(t+=(t.length?"&":"")+s);continue}(na(a)?a.map(n=>n&&Rc(n)):[a&&Rc(a)]).forEach(n=>{n!==void 0&&(t+=(t.length?"&":"")+s,n!=null&&(t+="="+n))})}return t}function Tw(e){const t={};for(const s in e){const a=e[s];a!==void 0&&(t[s]=na(a)?a.map(n=>n==null?null:""+n):a==null?a:""+a)}return t}const Cw=Symbol(""),hp=Symbol(""),xr=Symbol(""),Hd=Symbol(""),Lc=Symbol("");function Hi(){let e=[];function t(a){return e.push(a),()=>{const n=e.indexOf(a);n>-1&&e.splice(n,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function rn(e,t,s,a,n,i=l=>l()){const l=a&&(a.enterCallbacks[n]=a.enterCallbacks[n]||[]);return()=>new Promise((o,r)=>{const c=p=>{p===!1?r(Ii(Nt.NAVIGATION_ABORTED,{from:s,to:t})):p instanceof Error?r(p):_w(p)?r(Ii(Nt.NAVIGATION_GUARD_REDIRECT,{from:t,to:p})):(l&&a.enterCallbacks[n]===l&&typeof p=="function"&&l.push(p),o())},d=i(()=>e.call(a&&a.instances[n],t,s,c));let u=Promise.resolve(d);e.length<3&&(u=u.then(c)),u.catch(p=>r(p))})}function qr(e,t,s,a,n=i=>i()){const i=[];for(const l of e)for(const o in l.components){let r=l.components[o];if(!(t!=="beforeRouteEnter"&&!l.instances[o]))if(nv(r)){const c=(r.__vccOpts||r)[t];c&&i.push(rn(c,s,a,l,o,n))}else{let c=r();i.push(()=>c.then(d=>{if(!d)throw new Error(`Couldn't resolve component "${o}" at "${l.path}"`);const u=K_(d)?d.default:d;l.mods[o]=d,l.components[o]=u;const p=(u.__vccOpts||u)[t];return p&&rn(p,s,a,l,o,n)()}))}}return i}function Ew(e,t){const s=[],a=[],n=[],i=Math.max(t.matched.length,e.matched.length);for(let l=0;l<i;l++){const o=t.matched[l];o&&(e.matched.find(c=>Ri(c,o))?a.push(o):s.push(o));const r=e.matched[l];r&&(t.matched.find(c=>Ri(c,r))||n.push(r))}return[s,a,n]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let Aw=()=>location.protocol+"//"+location.host;function fv(e,t){const{pathname:s,search:a,hash:n}=t,i=e.indexOf("#");if(i>-1){let l=n.includes(e.slice(i))?e.slice(i).length:1,o=n.slice(l);return o[0]!=="/"&&(o="/"+o),up(o,"")}return up(s,e)+a+n}function Rw(e,t,s,a){let n=[],i=[],l=null;const o=({state:p})=>{const m=fv(e,location),h=s.value,g=t.value;let A=0;if(p){if(s.value=m,t.value=p,l&&l===h){l=null;return}A=g?p.position-g.position:0}else a(m);n.forEach(I=>{I(s.value,h,{delta:A,type:Ic.pop,direction:A?A>0?Vr.forward:Vr.back:Vr.unknown})})};function r(){l=s.value}function c(p){n.push(p);const m=()=>{const h=n.indexOf(p);h>-1&&n.splice(h,1)};return i.push(m),m}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(ht({},p.state,{scroll:yr()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",o),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",o),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:r,listen:c,destroy:u}}function vp(e,t,s,a=!1,n=!1){return{back:e,current:t,forward:s,replaced:a,position:window.history.length,scroll:n?yr():null}}function Iw(e){const{history:t,location:s}=window,a={value:fv(e,s)},n={value:t.state};n.value||i(a.value,{back:null,current:a.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(r,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+r:Aw()+e+r;try{t[d?"replaceState":"pushState"](c,"",p),n.value=c}catch(m){console.error(m),s[d?"replace":"assign"](p)}}function l(r,c){i(r,ht({},t.state,vp(n.value.back,r,n.value.forward,!0),c,{position:n.value.position}),!0),a.value=r}function o(r,c){const d=ht({},n.value,t.state,{forward:r,scroll:yr()});i(d.current,d,!0),i(r,ht({},vp(a.value,r,null),{position:d.position+1},c),!1),a.value=r}return{location:a,state:n,push:o,replace:l}}function Ow(e){e=mw(e);const t=Iw(e),s=Rw(e,t.state,t.location,t.replace);function a(i,l=!0){l||s.pauseListeners(),history.go(i)}const n=ht({location:"",base:e,go:a,createHref:vw.bind(null,e)},t,s);return Object.defineProperty(n,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(n,"state",{enumerable:!0,get:()=>t.state.value}),n}function Lw(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),Ow(e)}let An=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Gt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Gt||{});const Nw={type:An.Static,value:""},Dw=/[a-zA-Z0-9_]/;function Mw(e){if(!e)return[[]];if(e==="/")return[[Nw]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(m){throw new Error(`ERR (${s})/"${c}": ${m}`)}let s=Gt.Static,a=s;const n=[];let i;function l(){i&&n.push(i),i=[]}let o=0,r,c="",d="";function u(){c&&(s===Gt.Static?i.push({type:An.Static,value:c}):s===Gt.Param||s===Gt.ParamRegExp||s===Gt.ParamRegExpEnd?(i.length>1&&(r==="*"||r==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:An.Param,value:c,regexp:d,repeatable:r==="*"||r==="+",optional:r==="*"||r==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=r}for(;o<e.length;){if(r=e[o++],r==="\\"&&s!==Gt.ParamRegExp){a=s,s=Gt.EscapeNext;continue}switch(s){case Gt.Static:r==="/"?(c&&u(),l()):r===":"?(u(),s=Gt.Param):p();break;case Gt.EscapeNext:p(),s=a;break;case Gt.Param:r==="("?s=Gt.ParamRegExp:Dw.test(r)?p():(u(),s=Gt.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--);break;case Gt.ParamRegExp:r===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+r:s=Gt.ParamRegExpEnd:d+=r;break;case Gt.ParamRegExpEnd:u(),s=Gt.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--,d="";break;default:t("Unknown state");break}}return s===Gt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),n}const gp="[^/]+?",Pw={sensitive:!1,strict:!1,start:!0,end:!0};var bs=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(bs||{});const Fw=/[.+*?^${}()[\]/\\]/g;function $w(e,t){const s=ht({},Pw,t),a=[];let n=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[bs.Root];s.strict&&!c.length&&(n+="/");for(let u=0;u<c.length;u++){const p=c[u];let m=bs.Segment+(s.sensitive?bs.BonusCaseSensitive:0);if(p.type===An.Static)u||(n+="/"),n+=p.value.replace(Fw,"\\$&"),m+=bs.Static;else if(p.type===An.Param){const{value:h,repeatable:g,optional:A,regexp:I}=p;i.push({name:h,repeatable:g,optional:A});const y=I||gp;if(y!==gp){m+=bs.BonusCustomRegExp;try{`${y}`}catch(b){throw new Error(`Invalid custom RegExp for param "${h}" (${y}): `+b.message)}}let v=g?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(v=A&&c.length<2?`(?:/${v})`:"/"+v),A&&(v+="?"),n+=v,m+=bs.Dynamic,A&&(m+=bs.BonusOptional),g&&(m+=bs.BonusRepeatable),y===".*"&&(m+=bs.BonusWildcard)}d.push(m)}a.push(d)}if(s.strict&&s.end){const c=a.length-1;a[c][a[c].length-1]+=bs.BonusStrict}s.strict||(n+="/?"),s.end?n+="$":s.strict&&!n.endsWith("/")&&(n+="(?:/|$)");const l=new RegExp(n,s.sensitive?"":"i");function o(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const m=d[p]||"",h=i[p-1];u[h.name]=m&&h.repeatable?m.split("/"):m}return u}function r(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const m of p)if(m.type===An.Static)d+=m.value;else if(m.type===An.Param){const{value:h,repeatable:g,optional:A}=m,I=h in c?c[h]:"";if(na(I)&&!g)throw new Error(`Provided param "${h}" is an array but it is not repeatable (* or + modifiers)`);const y=na(I)?I.join("/"):I;if(!y)if(A)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${h}"`);d+=y}}return d||"/"}return{re:l,score:a,keys:i,parse:o,stringify:r}}function Uw(e,t){let s=0;for(;s<e.length&&s<t.length;){const a=t[s]-e[s];if(a)return a;s++}return e.length<t.length?e.length===1&&e[0]===bs.Static+bs.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===bs.Static+bs.Segment?1:-1:0}function mv(e,t){let s=0;const a=e.score,n=t.score;for(;s<a.length&&s<n.length;){const i=Uw(a[s],n[s]);if(i)return i;s++}if(Math.abs(n.length-a.length)===1){if(bp(a))return 1;if(bp(n))return-1}return n.length-a.length}function bp(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const Bw={strict:!1,end:!0,sensitive:!1};function Hw(e,t,s){const a=$w(Mw(e.path),s),n=ht(a,{record:e,parent:t,children:[],alias:[]});return t&&!n.record.aliasOf==!t.record.aliasOf&&t.children.push(n),n}function zw(e,t){const s=[],a=new Map;t=dp(Bw,t);function n(u){return a.get(u)}function i(u,p,m){const h=!m,g=xp(u);g.aliasOf=m&&m.record;const A=dp(t,u),I=[g];if("alias"in u){const b=typeof u.alias=="string"?[u.alias]:u.alias;for(const x of b)I.push(xp(ht({},g,{components:m?m.record.components:g.components,path:x,aliasOf:m?m.record:g})))}let y,v;for(const b of I){const{path:x}=b;if(p&&x[0]!=="/"){const w=p.record.path,C=w[w.length-1]==="/"?"":"/";b.path=p.record.path+(x&&C+x)}if(y=Hw(b,p,A),m?m.alias.push(y):(v=v||y,v!==y&&v.alias.push(y),h&&u.name&&!_p(y)&&l(u.name)),hv(y)&&r(y),g.children){const w=g.children;for(let C=0;C<w.length;C++)i(w[C],y,m&&m.children[C])}m=m||y}return v?()=>{l(v)}:il}function l(u){if(uv(u)){const p=a.get(u);p&&(a.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&a.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function o(){return s}function r(u){const p=qw(u,s);s.splice(p,0,u),u.record.name&&!_p(u)&&a.set(u.record.name,u)}function c(u,p){let m,h={},g,A;if("name"in u&&u.name){if(m=a.get(u.name),!m)throw Ii(Nt.MATCHER_NOT_FOUND,{location:u});A=m.record.name,h=ht(yp(p.params,m.keys.filter(v=>!v.optional).concat(m.parent?m.parent.keys.filter(v=>v.optional):[]).map(v=>v.name)),u.params&&yp(u.params,m.keys.map(v=>v.name))),g=m.stringify(h)}else if(u.path!=null)g=u.path,m=s.find(v=>v.re.test(g)),m&&(h=m.parse(g),A=m.record.name);else{if(m=p.name?a.get(p.name):s.find(v=>v.re.test(p.path)),!m)throw Ii(Nt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});A=m.record.name,h=ht({},p.params,u.params),g=m.stringify(h)}const I=[];let y=m;for(;y;)I.unshift(y.record),y=y.parent;return{name:A,path:g,params:h,matched:I,meta:Vw(I)}}e.forEach(u=>i(u));function d(){s.length=0,a.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:o,getRecordMatcher:n}}function yp(e,t){const s={};for(const a of t)a in e&&(s[a]=e[a]);return s}function xp(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:jw(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function jw(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const a in e.components)t[a]=typeof s=="object"?s[a]:s;return t}function _p(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function Vw(e){return e.reduce((t,s)=>ht(t,s.meta),{})}function qw(e,t){let s=0,a=t.length;for(;s!==a;){const i=s+a>>1;mv(e,t[i])<0?a=i:s=i+1}const n=Gw(e);return n&&(a=t.lastIndexOf(n,a-1)),a}function Gw(e){let t=e;for(;t=t.parent;)if(hv(t)&&mv(e,t)===0)return t}function hv({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function wp(e){const t=Gs(xr),s=Gs(Hd),a=j(()=>{const r=va(e.to);return t.resolve(r)}),n=j(()=>{const{matched:r}=a.value,{length:c}=r,d=r[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(Ri.bind(null,d));if(p>-1)return p;const m=kp(r[c-2]);return c>1&&kp(d)===m&&u[u.length-1].path!==m?u.findIndex(Ri.bind(null,r[c-2])):p}),i=j(()=>n.value>-1&&Yw(s.params,a.value.params)),l=j(()=>n.value>-1&&n.value===s.matched.length-1&&dv(s.params,a.value.params));function o(r={}){if(Zw(r)){const c=t[va(e.replace)?"replace":"push"](va(e.to)).catch(il);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:a,href:j(()=>a.value.href),isActive:i,isExactActive:l,navigate:o}}function Ww(e){return e.length===1?e[0]:e}const Kw=Nl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:wp,setup(e,{slots:t}){const s=fn(wp(e)),{options:a}=Gs(xr),n=j(()=>({[Sp(e.activeClass,a.linkActiveClass,"router-link-active")]:s.isActive,[Sp(e.exactActiveClass,a.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&Ww(t.default(s));return e.custom?i:wi("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:n.value},i)}}}),Jw=Kw;function Zw(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function Yw(e,t){for(const s in t){const a=t[s],n=e[s];if(typeof a=="string"){if(a!==n)return!1}else if(!na(n)||n.length!==a.length||a.some((i,l)=>i.valueOf()!==n[l].valueOf()))return!1}return!0}function kp(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Sp=(e,t,s)=>e??t??s,Qw=Nl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const a=Gs(Lc),n=j(()=>e.route||a.value),i=Gs(hp,0),l=j(()=>{let c=va(i);const{matched:d}=n.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),o=j(()=>n.value.matched[l.value]);el(hp,j(()=>l.value+1)),el(Cw,o),el(Lc,n);const r=f();return zt(()=>[r.value,o.value,e.name],([c,d,u],[p,m,h])=>{d&&(d.instances[u]=c,m&&m!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=m.leaveGuards),d.updateGuards.size||(d.updateGuards=m.updateGuards))),c&&d&&(!m||!Ri(d,m)||!p)&&(d.enterCallbacks[u]||[]).forEach(g=>g(c))},{flush:"post"}),()=>{const c=n.value,d=e.name,u=o.value,p=u&&u.components[d];if(!p)return Tp(s.default,{Component:p,route:c});const m=u.props[d],h=m?m===!0?c.params:typeof m=="function"?m(c):m:null,A=wi(p,ht({},h,t,{onVnodeUnmounted:I=>{I.component.isUnmounted&&(u.instances[d]=null)},ref:r}));return Tp(s.default,{Component:A,route:c})||A}}});function Tp(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Xw=Qw;function ek(e){const t=zw(e.routes,e),s=e.parseQuery||Sw,a=e.stringifyQuery||mp,n=e.history,i=Hi(),l=Hi(),o=Hi(),r=Yc(tn);let c=tn;ii&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=zr.bind(null,K=>""+K),u=zr.bind(null,ow),p=zr.bind(null,Tl);function m(K,ue){let he,ge;return uv(K)?(he=t.getRecordMatcher(K),ge=ue):ge=K,t.addRoute(ge,he)}function h(K){const ue=t.getRecordMatcher(K);ue&&t.removeRoute(ue)}function g(){return t.getRoutes().map(K=>K.record)}function A(K){return!!t.getRecordMatcher(K)}function I(K,ue){if(ue=ht({},ue||r.value),typeof K=="string"){const P=jr(s,K,ue.path),V=t.resolve({path:P.path},ue),ce=n.createHref(P.fullPath);return ht(P,V,{params:p(V.params),hash:Tl(P.hash),redirectedFrom:void 0,href:ce})}let he;if(K.path!=null)he=ht({},K,{path:jr(s,K.path,ue.path).path});else{const P=ht({},K.params);for(const V in P)P[V]==null&&delete P[V];he=ht({},K,{params:u(P)}),ue.params=u(ue.params)}const ge=t.resolve(he,ue),xe=K.hash||"";ge.params=d(p(ge.params));const Ne=dw(a,ht({},K,{hash:nw(xe),path:ge.path})),T=n.createHref(Ne);return ht({fullPath:Ne,hash:xe,query:a===mp?Tw(K.query):K.query||{}},ge,{redirectedFrom:void 0,href:T})}function y(K){return typeof K=="string"?jr(s,K,r.value.path):ht({},K)}function v(K,ue){if(c!==K)return Ii(Nt.NAVIGATION_CANCELLED,{from:ue,to:K})}function b(K){return C(K)}function x(K){return b(ht(y(K),{replace:!0}))}function w(K,ue){const he=K.matched[K.matched.length-1];if(he&&he.redirect){const{redirect:ge}=he;let xe=typeof ge=="function"?ge(K,ue):ge;return typeof xe=="string"&&(xe=xe.includes("?")||xe.includes("#")?xe=y(xe):{path:xe},xe.params={}),ht({query:K.query,hash:K.hash,params:xe.path!=null?{}:K.params},xe)}}function C(K,ue){const he=c=I(K),ge=r.value,xe=K.state,Ne=K.force,T=K.replace===!0,P=w(he,ge);if(P)return C(ht(y(P),{state:typeof P=="object"?ht({},xe,P.state):xe,force:Ne,replace:T}),ue||he);const V=he;V.redirectedFrom=ue;let ce;return!Ne&&uw(a,ge,he)&&(ce=Ii(Nt.NAVIGATION_DUPLICATED,{to:V,from:ge}),B(ge,ge,!0,!1)),(ce?Promise.resolve(ce):R(V,ge)).catch(F=>Ea(F)?Ea(F,Nt.NAVIGATION_GUARD_REDIRECT)?F:le(F):N(F,V,ge)).then(F=>{if(F){if(Ea(F,Nt.NAVIGATION_GUARD_REDIRECT))return C(ht({replace:T},y(F.to),{state:typeof F.to=="object"?ht({},xe,F.to.state):xe,force:Ne}),ue||V)}else F=S(V,ge,!0,T,xe);return $(V,ge,F),F})}function E(K,ue){const he=v(K,ue);return he?Promise.reject(he):Promise.resolve()}function _(K){const ue=Z.values().next().value;return ue&&typeof ue.runWithContext=="function"?ue.runWithContext(K):K()}function R(K,ue){let he;const[ge,xe,Ne]=Ew(K,ue);he=qr(ge.reverse(),"beforeRouteLeave",K,ue);for(const P of ge)P.leaveGuards.forEach(V=>{he.push(rn(V,K,ue))});const T=E.bind(null,K,ue);return he.push(T),de(he).then(()=>{he=[];for(const P of i.list())he.push(rn(P,K,ue));return he.push(T),de(he)}).then(()=>{he=qr(xe,"beforeRouteUpdate",K,ue);for(const P of xe)P.updateGuards.forEach(V=>{he.push(rn(V,K,ue))});return he.push(T),de(he)}).then(()=>{he=[];for(const P of Ne)if(P.beforeEnter)if(na(P.beforeEnter))for(const V of P.beforeEnter)he.push(rn(V,K,ue));else he.push(rn(P.beforeEnter,K,ue));return he.push(T),de(he)}).then(()=>(K.matched.forEach(P=>P.enterCallbacks={}),he=qr(Ne,"beforeRouteEnter",K,ue,_),he.push(T),de(he))).then(()=>{he=[];for(const P of l.list())he.push(rn(P,K,ue));return he.push(T),de(he)}).catch(P=>Ea(P,Nt.NAVIGATION_CANCELLED)?P:Promise.reject(P))}function $(K,ue,he){o.list().forEach(ge=>_(()=>ge(K,ue,he)))}function S(K,ue,he,ge,xe){const Ne=v(K,ue);if(Ne)return Ne;const T=ue===tn,P=ii?history.state:{};he&&(ge||T?n.replace(K.fullPath,ht({scroll:T&&P&&P.scroll},xe)):n.push(K.fullPath,xe)),r.value=K,B(K,ue,he,T),le()}let M;function Q(){M||(M=n.listen((K,ue,he)=>{if(!fe.listening)return;const ge=I(K),xe=w(ge,fe.currentRoute.value);if(xe){C(ht(xe,{replace:!0,force:!0}),ge).catch(il);return}c=ge;const Ne=r.value;ii&&yw(fp(Ne.fullPath,he.delta),yr()),R(ge,Ne).catch(T=>Ea(T,Nt.NAVIGATION_ABORTED|Nt.NAVIGATION_CANCELLED)?T:Ea(T,Nt.NAVIGATION_GUARD_REDIRECT)?(C(ht(y(T.to),{force:!0}),ge).then(P=>{Ea(P,Nt.NAVIGATION_ABORTED|Nt.NAVIGATION_DUPLICATED)&&!he.delta&&he.type===Ic.pop&&n.go(-1,!1)}).catch(il),Promise.reject()):(he.delta&&n.go(-he.delta,!1),N(T,ge,Ne))).then(T=>{T=T||S(ge,Ne,!1),T&&(he.delta&&!Ea(T,Nt.NAVIGATION_CANCELLED)?n.go(-he.delta,!1):he.type===Ic.pop&&Ea(T,Nt.NAVIGATION_ABORTED|Nt.NAVIGATION_DUPLICATED)&&n.go(-1,!1)),$(ge,Ne,T)}).catch(il)}))}let W=Hi(),D=Hi(),O;function N(K,ue,he){le(K);const ge=D.list();return ge.length?ge.forEach(xe=>xe(K,ue,he)):console.error(K),Promise.reject(K)}function ie(){return O&&r.value!==tn?Promise.resolve():new Promise((K,ue)=>{W.add([K,ue])})}function le(K){return O||(O=!K,Q(),W.list().forEach(([ue,he])=>K?he(K):ue()),W.reset()),K}function B(K,ue,he,ge){const{scrollBehavior:xe}=e;if(!ii||!xe)return Promise.resolve();const Ne=!he&&xw(fp(K.fullPath,0))||(ge||!he)&&history.state&&history.state.scroll||null;return Pt().then(()=>xe(K,ue,Ne)).then(T=>T&&bw(T)).catch(T=>N(T,K,ue))}const J=K=>n.go(K);let te;const Z=new Set,fe={currentRoute:r,listening:!0,addRoute:m,removeRoute:h,clearRoutes:t.clearRoutes,hasRoute:A,getRoutes:g,resolve:I,options:e,push:b,replace:x,go:J,back:()=>J(-1),forward:()=>J(1),beforeEach:i.add,beforeResolve:l.add,afterEach:o.add,onError:D.add,isReady:ie,install(K){K.component("RouterLink",Jw),K.component("RouterView",Xw),K.config.globalProperties.$router=fe,Object.defineProperty(K.config.globalProperties,"$route",{enumerable:!0,get:()=>va(r)}),ii&&!te&&r.value===tn&&(te=!0,b(n.location).catch(ge=>{}));const ue={};for(const ge in tn)Object.defineProperty(ue,ge,{get:()=>r.value[ge],enumerable:!0});K.provide(xr,fe),K.provide(Hd,Zc(ue)),K.provide(Lc,r);const he=K.unmount;Z.add(K),K.unmount=function(){Z.delete(K),Z.size<1&&(c=tn,M&&M(),M=null,r.value=tn,te=!1,O=!1),he()}}};function de(K){return K.reduce((ue,he)=>ue.then(()=>_(he)),Promise.resolve())}return fe}function vv(){return Gs(xr)}function tk(e){return Gs(Hd)}const _r={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=tk(),s=vv(),a=j({get(){var r;const o=t.query.tab;return o&&e.tabs.some(c=>c.id===o)?o:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(o){s.replace({query:{...t.query,tab:o}})}}),n=j(()=>{var o;return((o=e.tabs.find(r=>r.id===a.value))==null?void 0:o.component)||null}),i=j(()=>{var o;return((o=e.tabs.find(r=>r.id===a.value))==null?void 0:o.label)||""});zt(i,o=>{e.groupLabel&&o&&(document.title=`Odin — ${e.groupLabel} › ${o}`)},{immediate:!0});function l(o,r){if(!["ArrowLeft","ArrowRight","Home","End"].includes(o.key))return;o.preventDefault();let c=r;o.key==="ArrowRight"&&(c=(r+1)%e.tabs.length),o.key==="ArrowLeft"&&(c=(r-1+e.tabs.length)%e.tabs.length),o.key==="Home"&&(c=0),o.key==="End"&&(c=e.tabs.length-1),a.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:a,activeComponent:n,activeLabel:i,onTabKeydown:l}},template:`
...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(n.value="Copied")}catch{e.value===u&&(n.value="Copy unavailable — select text manually")}}return zt(()=>e.value,()=>{t.value=!1,n.value=""}),zt(a,()=>{t.value=!1,n.value=""}),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},uk={components:{ToolOutput:wr},setup(){const e=f([]),t=f([]),s=f({}),a=50;function n(p){var g,A,I,y,v,b,x,w,C,E,_;const m=p.payload||p,h=m.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(h)&&!(m.agent_id||(g=m.metadata)!=null&&g.agent_id))&&!(["loop_tool_start","loop_tool"].includes(h)&&!(m.call_id||(A=m.metadata)!=null&&A.call_id))){if(h==="tool_start"||h==="loop_tool_start"){const R=m.call_id||((I=m.metadata)==null?void 0:I.call_id)||null,$=m.agent_id||((y=m.metadata)==null?void 0:y.agent_id)||"",S={callId:R,agentId:$,agentLabel:m.agent_label||((v=m.metadata)==null?void 0:v.agent_label)||"",toolInput:m.tool_input,id:R?`${$}:${R}`:`${m.action}-${Date.now()}`,tool:m.action,actor:m.actor||"",channel:m.channel_id||"",iteration:m.iteration??((b=m.metadata)==null?void 0:b.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(S);return}if(h==="tool_end"||h==="loop_tool"){const R=m.call_id||((x=m.metadata)==null?void 0:x.call_id)||null,$=m.agent_id||((w=m.metadata)==null?void 0:w.agent_id)||"";let S=-1;if(R&&(S=e.value.findIndex(M=>M.callId===R&&M.agentId===$&&M.status==="running")),S<0&&!R)for(let M=e.value.length-1;M>=0;M--){const Q=e.value[M];if(Q.tool===m.action&&Q.agentId===$&&Q.status==="running"){S=M;break}}if(S>=0){const M=e.value[S];M.status=m.error||(C=m.metadata)!=null&&C.error||["error","failed","cancelled","denied","outcome_unknown"].includes(m.status||((E=m.metadata)==null?void 0:E.status))?"error":"success",M.elapsed=m.execution_time_ms??m.duration_ms??((_=m.metadata)==null?void 0:_.elapsed_ms)??Date.now()-M.startTime,M.result=m.result_summary??m.detail??"",M.fadingOut=!0,setTimeout(()=>{const Q=e.value.indexOf(M);Q>=0&&e.value.splice(Q,1),t.value.unshift(M),t.value.length>a&&t.value.pop()},5e3)}return}if(h==="tool_stream"){const R=m.call_id||m.tool_name||"unknown";if(m.finished){const $={...s.value};delete $[R],s.value=$}else{const S=((s.value[R]||"")+(m.chunk||"")).split(`
`);s.value={...s.value,[R]:S.slice(-30).join(`
`)}}return}}}let i=null;function l(){const p=Date.now();e.value.forEach(m=>{m.status==="running"&&(m.elapsed=p-m.startTime)})}let o=!1;function r(){o||(o=!0,nt.on("events",n),i||(i=setInterval(l,500)))}function c(){o&&(o=!1,nt.off("events",n),i&&(clearInterval(i),i=null))}Ye(r),is(r),Jt(c),gt(c);function d(p){return p<1e3?`${p}ms`:`${(p/1e3).toFixed(1)}s`}function u(p){return p==="running"?"clock":p==="success"?"success":p==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
...
... (truncated)`:s}function Ep(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function qd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function _v(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const wv=Symbol("agent-detail-cancelled"),mk=15e3;function hk(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:a,cancelTimeout:n}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((m,h)=>{r=m,c=h});function u(m,h){o||(o=!0,l!==null&&n(l),l=null,(m?r:c)(h))}let p;try{p=e(i==null?void 0:i.signal)}catch(m){u(!1,m)}return o||Promise.resolve(p).then(m=>u(!0,m),m=>u(!1,m)),!o&&Number.isFinite(t)&&t>0&&(l=a(()=>{const m=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${m}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,wv),i==null||i.abort()}}}function kv({state:e,requestDetail:t,timeoutMs:s=mk,detailLabel:a="Agent detail",scheduleTimeout:n=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:m,coalesce:h}){if(!p)return Promise.resolve();if(h&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const g={agentId:p,cancel:null,promise:null};l=g,m?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const A=hk(I=>t(p,{signal:I}),{timeoutMs:s,timeoutLabel:a,scheduleTimeout:n,cancelTimeout:i});return g.cancel=A.cancel,g.promise=(async()=>{let I=null,y=null;try{I=await A.promise}catch(v){y=v}I!==wv&&(l!==g||e.detailId!==p||(l=null,!y&&(I===null||typeof I!="object")&&(y=new Error(`${a} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${a.toLowerCase()}`):(e.detail=I,e.detailError=null),e.detailLoading=!1))})(),g.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function vk({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:a,intervalMs:n=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&a())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,n))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const gk={components:{ToolOutput:wr},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(!0),i=f("all");let l=!1;const o=j(()=>e.value.filter(N=>N.status==="running").length),r=j(()=>e.value.filter(N=>N.status==="completed").length),c=j(()=>e.value.filter(N=>["failed","timeout","killed"].includes(N.status)).length),d=j(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=j(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(N=>["failed","timeout","killed"].includes(N.status)):e.value.filter(N=>N.status===i.value));function p(N){const ie=Number(N.max_iterations)||0;return ie<=0?0:Math.min(100,Math.round(N.iteration_count/ie*100))}function m(N){return(Number(N.max_iterations)||0)>0}function h(N,ie){return N?N==="N/A"?"N/A":ie==="current_inheritance"?`inherit (currently ${N})`:N:"unknown"}function g(N){return h(N.display_model,N.display_model_source||N.display_source)}function A(N){return h(N.display_reasoning_effort,N.display_reasoning_effort_source||N.display_source)}function I(N){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[N]||""}const y=f(null),v=f(null),b=f(!1),x=f(null),w=f(""),E=kv({state:{get detail(){return y.value},set detail(N){y.value=N},get detailId(){return v.value},set detailId(N){v.value=N},get detailLoading(){return b.value},set detailLoading(N){b.value=N},get detailError(){return x.value},set detailError(N){x.value=N}},requestDetail:(N,{signal:ie})=>H.get(`/api/agents/${encodeURIComponent(N)}`,{signal:ie})});async function _(N){w.value="",await E.open(N.id)}function R(){E.close(),w.value=""}async function $(){await E.refresh()}async function S(N,ie){try{await navigator.clipboard.writeText(ie||""),w.value=N,setTimeout(()=>{w.value===N&&(w.value="")},1500)}catch{ke.error("Copy failed")}}async function M(N=!1){N=N===!0,N||(t.value=!0);try{const ie=await H.get("/api/agents");e.value=Array.isArray(ie)?ie:[],s.value=null}catch(ie){N||(s.value=ie.message)}N||(t.value=!1)}async function Q(N){const ie=e.value.find(B=>B.id===N);if(await Qt({title:"Kill agent",message:`Kill agent "${(ie==null?void 0:ie.label)||N}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){a.value=N;try{await H.del(`/api/agents/${encodeURIComponent(N)}`),ke.success("Agent killed"),await M()}catch(B){ke.error(B.message||"Failed to kill agent")}a.value=null}}const W=vk({isEnabled:()=>n.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!v.value,refreshDetail:$});function D(){W.start()}function O(){W.stop()}return zt(n,()=>W.sync()),Ye(()=>{l=!0,M(),D()}),is(()=>{l=!0,M(!0),D()}),Jt(()=>{l=!1,O()}),gt(()=>{l=!1,O(),E.close()}),{agents:e,loading:t,error:s,killing:a,autoRefresh:n,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:zn,formatDuration:Oi,progressPercent:p,hasProgress:m,displayModelText:g,displayEffortText:A,displaySourceLabel:I,detail:y,detailId:v,detailLoading:b,detailError:x,copied:w,openDetail:_,closeDetail:R,copyText:S,fetchAgents:M,killAgent:Q,startAutoRefresh:D,stopAutoRefresh:O}}},bk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(!1),n=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),m=f("");let h=!1;const A=kv({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return p.value},set detailError(O){p.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:N})=>H.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:N})});async function I(O){m.value="",await A.open(O.id)}function y(){A.close(),m.value=""}async function v(O,N){try{await navigator.clipboard.writeText(N||""),m.value=O,setTimeout(()=>{m.value===O&&(m.value="")},1500)}catch{ke.error("Copy failed")}}const b=j(()=>e.value.reduce((O,N)=>O+(N.iteration_count||0),0)),x=j(()=>e.value.filter(O=>O.status==="running").length);function w(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function C(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function E(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function _(O=!1){O=O===!0,O||(t.value=!0);try{const N=await H.get("/api/loops");e.value=Array.isArray(N)?N:[],s.value=null}catch(N){O||(s.value=N.message)}O||(t.value=!1)}async function R(){l.value=null;const O=n.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const N={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&(N.stop_condition=O.stop_condition.trim()),i.value=!0;try{const ie=await H.post("/api/loops",N);ke.success(`Loop started: ${ie.loop_id}`),n.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},a.value=!1,await _()}catch(ie){l.value=ie.message}i.value=!1}async function $(O){if(await Qt({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=O;try{await H.del(`/api/loops/${encodeURIComponent(O)}`),ke.success("Loop stopped"),await _()}catch(ie){ke.error(ie.message||"Failed to stop loop")}o.value=null}}async function S(O){r.value=O;try{await H.post(`/api/loops/${encodeURIComponent(O)}/restart`),ke.success("Loop restarted"),await _()}catch(N){ke.error(N.message||"Failed to restart loop")}r.value=null}function M(O){h&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(_(!0),d.value&&A.refresh())}let Q=null;function W(){Q!==null&&clearInterval(Q),Q=null}function D(){W(),h&&(Q=setInterval(()=>{_(!0),d.value&&A.refresh()},5e3))}return Ye(()=>{h=!0,_(),nt.subscribe("events",M),D()}),is(()=>{h=!0,_(!0),D()}),Jt(()=>{h=!1,W()}),gt(()=>{h=!1,nt.unsubscribe("events",M),W(),A.close()}),{loops:e,loading:t,error:s,showCreate:a,form:n,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:m,totalIterations:b,runningCount:x,statusDotClass:w,statusBadge:C,modeBadge:E,formatAge:yv,formatDuration:Oi,formatTs:zn,formatTokens:_v,openDetail:I,closeDetail:y,copyText:v,fetchLoops:_,doCreate:R,doStop:$,doRestart:S}}},yk={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(vo(null)),n=j(()=>a.value.available),i=j(()=>so(a.value));let l=null;const o=f(!1),r=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""}),c=f(!1),d=f(null),u=j(()=>Ip(a.value,r.value.action));function p(F){return Ip(a.value,F)}const m=f(null),h=j(()=>kk(r.value.run_at));zt(()=>r.value.run_at,()=>{m.value=null});const g=j(()=>{var Y;const F=h.value;return F.state==="ok"?F.instant:F.state==="ambiguous"&&m.value!==null&&((Y=F.options[m.value])==null?void 0:Y.instant)||null}),A=j(()=>{const F=g.value;return F?`${F.toLocaleString()} local — ${F.toISOString()} UTC`:""}),I=f(null),y=f(!1),v=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],b=f(null),x=f(null),w=f(null),C=f(null),E=f(null),_=f(null),R=f([]),$=f(!1),S=f("");let M=0;const Q=j(()=>e.value.filter(F=>F.cron&&!F.one_time).length),W=j(()=>e.value.filter(F=>F.one_time).length),D=j(()=>e.value.filter(F=>F.trigger).length),O=j(()=>e.value.filter(F=>F.paused).length),N=j(()=>e.value.filter(F=>F.consecutive_failures>0).length);function ie(F){if(!F)return"-";const Y=Date.now(),z=(new Date(F).getTime()-Y)/1e3;if(z<0)return"overdue";if(z<60)return"in < 1 min";if(z<3600)return`in ${Math.floor(z/60)} min`;if(z<86400){const G=Math.floor(z/3600),ve=Math.floor(z%3600/60);return ve>0?`in ${G}h ${ve}m`:`in ${G}h`}const ee=Math.floor(z/86400);return`in ${ee} day${ee!==1?"s":""}`}function le(F){return F==null?"-":F<1e3?`${F}ms`:F<6e4?`${(F/1e3).toFixed(1)}s`:Oi(F/1e3)}function B(F=r.value.cron){r.value.cron=F,Ap(r.value,"cron"),I.value=null}function J(F=r.value.run_at){r.value.run_at=F,Ap(r.value,"run_at"),I.value=null}async function te(){const F=r.value.cron.trim();if(F){y.value=!0;try{I.value=await H.post("/api/schedules/validate-cron",{expression:F})}catch(Y){I.value={valid:!1,error:Y.message}}y.value=!1}}async function Z(){t.value=!0,s.value=null;try{e.value=await H.get("/api/schedules")}catch(F){s.value=F.message}t.value=!1}async function fe(){try{a.value=vo(await H.get("/api/schedules/status"))}catch(F){a.value=Rp(F)||vo(null)}}function de(F){const Y=Rp(F);Y&&(a.value=Y)}async function K(F){if(_.value===F){_.value=null,R.value=[];return}_.value=F,$.value=!0,R.value=[];const Y=++M;try{const re=await H.get(`/api/schedules/${encodeURIComponent(F)}/history?limit=10`);if(Y!==M||_.value!==F)return;R.value=re,S.value=""}catch(re){if(Y!==M||_.value!==F)return;R.value=[],S.value=re.message||"Failed to load execution history"}Y===M&&($.value=!1)}async function ue(){if(d.value=null,!p(r.value.action)){d.value=so(a.value);return}const F=r.value;if(!F.description.trim()){d.value="Description is required";return}if(F.action!=="webhook"&&!F.channel_id.trim()){d.value="Channel ID is required";return}if(!F.cron.trim()&&!F.run_at.trim()){d.value="Cron expression or run_at time is required";return}if(F.cron.trim()&&F.run_at.trim()){d.value="Choose either Cron or One-Time, not both";return}const Y={description:F.description.trim(),action:F.action,channel_id:F.channel_id.trim()};if(F.cron.trim()&&(Y.cron=F.cron.trim()),F.run_at.trim()){const re=h.value;if(re.state==="nonexistent"){d.value="That local time does not exist (daylight saving gap)";return}if(re.state==="invalid"){d.value="One-time run time is not a valid date";return}const z=g.value;if(re.state==="ambiguous"&&m.value===null){d.value="That local time happens twice — choose which occurrence to use";return}if(!z){d.value="One-time run time could not be resolved";return}Y.run_at=z.toISOString()}if(F.action==="reminder"&&F.message.trim()&&(Y.message=F.message.trim()),F.action==="check"&&(F.tool_name.trim()&&(Y.tool_name=F.tool_name.trim()),F.report_format&&(Y.report_format=F.report_format),F.tool_input_str.trim()))try{Y.tool_input=JSON.parse(F.tool_input_str.trim())}catch{d.value="Tool input must be valid JSON";return}if(F.action==="webhook"){if(!F.webhook_url.trim()){d.value="Webhook URL is required";return}const re={url:F.webhook_url.trim(),method:F.webhook_method};if(F.webhook_headers_str.trim())try{const z=JSON.parse(F.webhook_headers_str.trim());if(!z||Array.isArray(z)||typeof z!="object")throw new Error("not an object");re.headers=z}catch{d.value="Webhook headers must be a valid JSON object";return}if(F.webhook_body&&(re.body=F.webhook_body),F.webhook_expected_status_str.trim()){const z=F.webhook_expected_status_str.split(",").map(ee=>Number(ee.trim()));if(z.some(ee=>!Number.isInteger(ee)||ee<100||ee>599)){d.value="Expected status codes must be comma-separated HTTP codes";return}re.expected_status_codes=z}Y.webhook_config=re}c.value=!0;try{await H.post("/api/schedules",Y),ke.success("Schedule created"),r.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""},I.value=null,o.value=!1,await Z()}catch(re){de(re),d.value=re.message}c.value=!1}async function he(F){if(!p(F.action)){ke.error(so(a.value));return}const Y=F.id;b.value=Y;try{const re=await H.post(`/api/schedules/${encodeURIComponent(Y)}/run`);if(re.status==="failure")ke.error(`Execution failed: ${re.error||"unknown error"}`);else{const z=re.warning?`Executed (${re.warning})`:"Executed successfully";ke.success(z)}await Z()}catch(re){de(re),ke.error(re.message||"Failed to trigger")}b.value=null}async function ge(F){if(F.paused&&!p(F.action)){ke.error(so(a.value));return}w.value=F.id;const Y=!F.paused;try{await H.put(`/api/schedules/${encodeURIComponent(F.id)}`,{paused:Y}),ke.success(Y?"Schedule paused":"Schedule resumed"),await Z()}catch(re){de(re),ke.error(re.message||"Failed to update schedule")}w.value=null}const xe=new Map;function Ne(F,Y){const re=xe.get(F.id);re&&clearTimeout(re.timer);const z={run:()=>T(F,Y),timer:null};z.timer=setTimeout(()=>{xe.delete(F.id),z.run()},500),xe.set(F.id,z)}async function T(F,Y){E.value=F.id;try{await H.put(`/api/schedules/${encodeURIComponent(F.id)}`,{report_format:Y}),ke.success(Y?"Structured report enabled":"Plain-text report enabled")}catch(re){ke.error(`Update failed: ${re.message}`)}finally{await Z(),E.value=null}}function P(){for(const[F,Y]of[...xe])clearTimeout(Y.timer),xe.delete(F),Y.run()}async function V(F){C.value=F;try{await H.post(`/api/schedules/${encodeURIComponent(F)}/reset-failures`),ke.success("Failure counters reset"),await Z()}catch(Y){ke.error(Y.message||"Failed to reset")}C.value=null}async function ce(F){const Y=e.value.find(z=>z.id===F);if(await Qt({title:"Delete schedule",message:`Delete "${(Y==null?void 0:Y.description)||F}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){x.value=F;try{await H.del(`/api/schedules/${encodeURIComponent(F)}`),ke.success("Schedule deleted"),await Z()}catch(z){ke.error(z.message||"Failed to delete schedule")}x.value=null}}return Ye(()=>{Z(),fe(),l=setInterval(fe,Sk)}),gt(()=>{P(),l&&clearInterval(l)}),{schedules:e,loading:t,error:s,schedulingAvailable:n,schedulingAvailabilityMessage:i,selectedActionAvailable:u,actionAvailable:p,showCreate:o,form:r,creating:c,createError:d,runAtUtcPreview:A,runAtAnalysis:h,runAtOccurrence:m,cronResult:I,validatingCron:y,cronPresets:v,runningId:b,deletingId:x,togglingId:w,resettingId:C,reportUpdatingId:E,flushReportFormatTimers:P,expandedId:_,history:R,historyLoading:$,historyError:S,cronCount:Q,oneTimeCount:W,webhookCount:D,pausedCount:O,failingCount:N,formatTs:zn,formatAge:yv,formatFuture:ie,formatMs:le,formatDuration:Oi,onCronInput:B,onRunAtInput:J,validateCron:te,toggleExpand:K,fetchSchedules:Z,fetchSchedulingAvailability:fe,doCreate:ue,doRunNow:he,doTogglePause:ge,doUpdateReportFormat:Ne,doResetFailures:V,doDelete:ce}}},Sv=[{id:"live",label:"Live",component:uk},{id:"agents",label:"Agents",component:gk},{id:"loops",label:"Loops",component:bk},{id:"processes",label:"Processes",component:yk},{id:"schedules",label:"Schedules",component:Ck}],Ek={components:{TabbedPage:_r},setup(){return{tabs:Sv}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Ak={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),m=f("last_active"),h=f(!1),g=Op,A=Rk,I=f([]),y=f(!1),v=f(""),b=f("flat"),x=f(new Set),w=f(""),C=f(""),E=f(""),_=f(null),R=f(!1),$=f(""),S=f(!1);let M=0;zt([w,C,E],()=>{M++,R.value=!1,$.value="",S.value=_.value!==null},{flush:"sync"});function Q(){try{const ae=localStorage.getItem("odin-session-presets");ae&&(I.value=JSON.parse(ae))}catch{}}function W(){try{localStorage.setItem("odin-session-presets",JSON.stringify(I.value))}catch{}}const D=j(()=>p.value.trim()!==""||u.value!=="all"),O=j(()=>{let ae=[...e.value];const Re=Op.find(lt=>lt.id===u.value),Me=Re?Re.filters:{};if(Me.source&&(ae=ae.filter(lt=>lt.source===Me.source)),Me.minMessages&&(ae=ae.filter(lt=>lt.message_count>=Me.minMessages)),Me.hasCompaction&&(ae=ae.filter(lt=>lt.has_summary)),Me.maxAge!=null){const lt=Date.now()/1e3;ae=ae.filter(Ct=>Ct.last_active&&lt-Ct.last_active<=Me.maxAge)}if(p.value.trim()){const lt=p.value.toLowerCase().trim();ae=ae.filter(Ct=>(Ct.channel_id||"").toLowerCase().includes(lt)||(Ct.last_user_id||"").toLowerCase().includes(lt)||(Ct.source||"").toLowerCase().includes(lt))}const st=m.value,Vt=h.value?1:-1;return ae.sort((lt,Ct)=>{const $t=lt[st]||0,qt=Ct[st]||0;return($t-qt)*Vt}),ae}),N=j(()=>{if(!n.value||!n.value.messages)return[];const ae=n.value.messages;if(ae.length===0)return[];const Re=[];let Me=[];for(const st of ae)st.role==="user"&&Me.length>0&&(Re.push(Me),Me=[]),Me.push(st);return Me.length>0&&Re.push(Me),Re}),ie=j(()=>O.value.length>0&&c.value.size===O.value.length);function le(ae){const Re=ae.find(Me=>Me.role==="user");if(Re&&Re.content){const Me=Re.content.slice(0,120);return Me.length<Re.content.length?Me+"...":Me}return"(no user message)"}function B(ae){const Re=new Set(x.value);Re.has(ae)?Re.delete(ae):Re.add(ae),x.value=Re}function J(ae){u.value=ae}function te(ae){u.value=ae.id,ae.filters.searchQuery!=null&&(p.value=ae.filters.searchQuery),ae.filters.sortBy&&(m.value=ae.filters.sortBy)}function Z(){if(!v.value.trim())return;const ae={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:p.value,sortBy:m.value}};I.value=[...I.value,ae],W(),y.value=!1,v.value=""}function fe(ae){I.value=I.value.filter(Re=>Re.id!==ae),W(),u.value===ae&&(u.value="all")}function de(){u.value="all",p.value="",m.value="last_active",h.value=!1}function K(ae){if(!ae)return"—";const Re=Date.now()/1e3-ae;if(Re<60)return"just now";if(Re<3600){const st=Math.floor(Re/60);return`${st} minute${st!==1?"s":""} ago`}if(Re<86400){const st=Math.floor(Re/3600);return`${st} hour${st!==1?"s":""} ago`}const Me=Math.floor(Re/86400);return`${Me} day${Me!==1?"s":""} ago`}function ue(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function he(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString()}catch{return""}}function ge(ae){return ae==="user"?"bg-gray-900/50 border border-gray-800":ae==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function xe(ae){return ae==="user"?"sess-msg-user":ae==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Ne(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":"badge-warning"}function T(ae){return ae==="user"?"sess-dot-user":ae==="assistant"?"sess-dot-assistant":"sess-dot-system"}function P(ae){return ae==="user"?"text-cyan-400":ae==="assistant"?"text-indigo-400":"text-gray-500"}function V(ae){return ae?ae.length>2e3?ae.slice(0,2e3)+`
... (truncated)`:ae:""}async function ce(){const ae=w.value.trim();if(!ae)return;const Re=++M;R.value=!0,$.value="",S.value=_.value!==null;try{let Me=`/api/sessions/search?q=${encodeURIComponent(ae)}&limit=50`;C.value.trim()&&(Me+=`&channel_id=${encodeURIComponent(C.value.trim())}`),E.value.trim()&&(Me+=`&user_id=${encodeURIComponent(E.value.trim())}`);const st=await H.get(Me);if(Re!==M)return;_.value=st.results||[],S.value=!1}catch(Me){if(Re!==M)return;$.value=Me.message||"Search failed. Please retry."}finally{Re===M&&(R.value=!1)}}function F(){M++,w.value="",C.value="",E.value="",_.value=null,$.value="",S.value=!1,R.value=!1}function Y(ae){return ae?ae.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function re(ae){return ae==="user"?"fts-result-user":ae==="assistant"?"fts-result-assistant":ae==="summary"?"fts-result-summary":ae==="fts"?"fts-result-fts":ae==="channel"?"fts-result-channel":"fts-result-default"}function z(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":ae==="summary"?"badge-warning":ae==="fts"?"badge-success":"badge-info"}let ee=0;async function G(){const ae=++ee;t.value=!0,s.value=null;try{const Re=await H.get("/api/sessions");if(ae!==ee)return;e.value=Re}catch(Re){if(ae!==ee)return;s.value=Re.message}ae===ee&&(t.value=!1)}function ve(){s.value=null,G()}async function me(ae){if(a.value===ae){a.value=null,n.value=null,x.value=new Set;return}a.value=ae,n.value=null,i.value=!0,x.value=new Set;const Re=++l;try{const Me=await H.get(`/api/sessions/${encodeURIComponent(ae)}`);Re===l&&a.value===ae&&(n.value=Me)}catch(Me){Re===l&&a.value===ae&&(n.value={messages:[],summary:"",error:Me.message||"Failed to load session"})}finally{Re===l&&(i.value=!1)}}function ye(ae){const Re=new Set(c.value);Re.has(ae)?Re.delete(ae):Re.add(ae),c.value=Re}function Ie(){ie.value?c.value=new Set:c.value=new Set(O.value.map(ae=>ae.channel_id))}function Fe(ae){o.value=ae}async function Ve(){if(o.value){r.value=!0;try{await H.del(`/api/sessions/${encodeURIComponent(o.value)}`),a.value===o.value&&(a.value=null,n.value=null),c.value.delete(o.value),await G()}catch(ae){s.value=ae.message||"Failed to clear session"}r.value=!1,o.value=null}}function Be(){d.value=!0}async function qe(){if(c.value.size!==0){r.value=!0;try{await H.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(a.value)&&(a.value=null,n.value=null),c.value=new Set,await G()}catch(ae){s.value=ae.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Je(ae,Re){const Me=`/api/sessions/${encodeURIComponent(ae)}/export?format=${Re}`;try{const st=await H.getBlob(Me),Vt=URL.createObjectURL(st),lt=document.createElement("a");lt.href=Vt,lt.download=`session-${ae}.${Re==="text"?"txt":"json"}`,lt.click(),URL.revokeObjectURL(Vt)}catch(st){s.value=st.message||"Failed to export session"}}let it=null;function We(ae){ae.payload&&ae.payload.channel_id&&(clearTimeout(it),it=setTimeout(()=>{if(G(),a.value&&ae.payload.channel_id===a.value){const Re=a.value,Me=l;H.get(`/api/sessions/${encodeURIComponent(Re)}`).then(st=>{Me!==l||a.value!==Re||(n.value=st)}).catch(()=>{})}},2e3))}let X=!1,we=null;function Ce(){X||(X=!0,G(),nt.subscribe("events",We),we=nt.onReconnected(()=>G()))}Ye(()=>{Q(),Ce()}),is(()=>{Ce()});function Oe(){X&&(X=!1,nt.unsubscribe("events",We),we&&(we(),we=null),clearTimeout(it))}return Jt(Oe),gt(Oe),{sessions:e,loading:t,error:s,expandedId:a,detail:n,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:ie,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:m,sortAsc:h,filterPresets:g,sortOptions:A,filteredSessions:O,hasActiveFilters:D,customPresets:I,showSavePreset:y,newPresetName:v,threadView:b,threads:N,collapsedThreads:x,ftsQuery:w,ftsChannelId:C,ftsUserId:E,ftsResults:_,ftsSearching:R,ftsError:$,ftsStale:S,formatAge:K,formatTimestamp:ue,formatFullTimestamp:he,messageClass:ge,threadMsgClass:xe,roleBadge:Ne,roleDotClass:T,roleLabelClass:P,truncateContent:V,threadSummary:le,fetchSessions:G,retry:ve,toggleSession:me,toggleSelect:ye,toggleSelectAll:Ie,confirmClear:Fe,clearSession:Ve,confirmBulkClear:Be,doBulkClear:qe,exportSession:Je,applyPreset:J,applyCustomPreset:te,saveCustomPreset:Z,removeCustomPreset:fe,resetFilters:de,toggleThread:B,runFtsSearch:ce,clearFtsSearch:F,highlightSnippet:Y,ftsResultClass:re,ftsTypeBadge:z}}},Ok={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:_v}}},Lk={components:{ContextAssemblyPanel:Ok},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(C){if(!C)return"—";try{const E=new Date(C);return isNaN(E.getTime())?C:E.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return C}}function p(C){return!C&&C!==0?"—":C<1e3?C+"ms":(C/1e3).toFixed(1)+"s"}function m(C){return!C&&C!==0?"—":C>=1e3?(C/1e3).toFixed(1)+"k":String(C)}function h(C){if(!C)return"";if(typeof C=="string")return C;try{return JSON.stringify(C,null,2)}catch{return String(C)}}function g(C){n.value===C?n.value=null:(n.value=C,c.value={})}function A(C,E){const _=C+"-"+E;c.value={...c.value,[_]:!c.value[_]}}function I(C,E){return!!c.value[C+"-"+E]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,x()}async function v(){try{const C=await H.get("/api/trajectories");e.value=C.files||[],r.value=C.count||0}catch{}}let b=0;async function x(){const C=++b;s.value=!0,a.value=null,n.value=null,i.value=null,c.value={};try{if(o.value){const E=await H.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(C!==b)return;let _=E.entries||[];d.value.tool_name&&(_=_.filter(R=>(R.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(_=_.filter(R=>R.is_error)),d.value.channel_id&&(_=_.filter(R=>R.channel_id===d.value.channel_id)),d.value.user_id&&(_=_.filter(R=>R.user_id===d.value.user_id)),t.value=_}else{const E=new URLSearchParams;d.value.channel_id&&E.set("channel_id",d.value.channel_id),d.value.user_id&&E.set("user_id",d.value.user_id),d.value.tool_name&&E.set("tool_name",d.value.tool_name),d.value.errors_only&&E.set("errors_only","true"),E.set("limit",String(d.value.limit));const _=E.toString(),R=await H.get(`/api/trajectories/search/query?${_}`);if(C!==b)return;t.value=R.results||[]}}catch(E){if(C!==b)return;a.value=E.message}C===b&&(s.value=!1)}async function w(){if(!l.value.trim())return;const C=++b;s.value=!0,a.value=null,c.value={};try{const E=await H.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(C!==b)return;i.value=E.entry||null,i.value||(a.value="No trace found for this message ID")}catch(E){if(C!==b)return;E.status===404?(i.value=null,a.value="No trace found for message ID: "+l.value):a.value=E.message}C===b&&(s.value=!1)}return Ye(async()=>{await v(),await x()}),{files:e,entries:t,loading:s,error:a,expandedIdx:n,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:m,formatJSON:h,truncateBlock:xv,toggleExpand:g,toggleIteration:A,isIterationExpanded:I,clearFilters:y,fetchFiles:v,fetchTraces:x,lookupMessage:w}}};function Nk(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function Dk(e){return e?`${e.approximate?"~":""}${qd(e.total||0)}`:"0"}const Mk={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),a=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),n=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=j(()=>a.value.work||{}),m=j(()=>Math.max(1,...(a.value.activity_over_time||[]).map(w=>Number(w.count||0)))),h=j(()=>({minWidth:`max(100%, ${(a.value.activity_over_time||[]).length*5}px)`})),g=w=>({height:`${Math.max(4,Math.round(Number(w||0)/m.value*100))}%`}),A=j(()=>s.value&&l.value-i.value>3e4);async function I(){const w=++d,C=n.value;try{const E=await H.get(`/api/usage?range=${encodeURIComponent(C)}`);if(w!==d||C!==n.value)return;a.value=E,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(E){w===d&&(t.value=E.message)}finally{w===d&&(e.value=!1)}}function y(w){n.value=w,e.value=!s.value,I()}function v(){e.value=!0,I()}function b(){c||(c=!0,I(),o=setInterval(I,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function x(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return Ye(b),is(b),Jt(x),gt(x),{data:a,work:p,loading:e,error:t,hasData:s,range:n,ranges:u,isStale:A,fmtNum:qd,fmtDuration:Nk,tokenLabel:Dk,activityTrackStyle:h,activityBar:g,selectRange:y,retry:v}}},Tv=[{id:"audit",label:"Audit",component:Ak},{id:"sessions",label:"Sessions",component:Ik},{id:"traces",label:"Traces",component:Lk},{id:"usage",label:"Usage & Activity",component:Mk}],Pk={components:{TabbedPage:_r},setup(){return{tabs:Tv}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Wr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Fk={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(_){return _.source!=="builtin"?"":u[_.state]||""}function m(_,R){const $=_&&Array.isArray(_.tools)?_.tools:null;if(c.value=!!$,r.value=$?!!_.global_enabled:null,!$){e.value=R.map(Q=>({...Q,source:"unknown",enabled:void 0,state:null}));return}const S=new Set($.map(Q=>Q.name)),M=R.filter(Q=>!S.has(Q.name)).map(Q=>({...Q,source:Q.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...$.map(Q=>({...Q,source:"builtin"})),...M]}async function h(_,R){if(d.value.has(_.name))return;const $=!!R.target.checked,S=new Set(d.value);S.add(_.name),d.value=S;try{const M=await H.post(`/api/tools/builtins/${encodeURIComponent(_.name)}/enabled`,{enabled:$});m(M,e.value),s.value=null;try{const Q=await H.get("/api/tools");m(M,Q)}catch(Q){console.warn("Built-in toggle committed; visible catalog refresh failed",Q)}}catch(M){R.target.checked=!!_.enabled,s.value=M.message||`Failed to toggle ${_.name}`}finally{const M=new Set(d.value);M.delete(_.name),d.value=M}}const g=j(()=>e.value.filter(_=>_.source==="builtin"&&_.is_core).length),A=j(()=>e.value.filter(_=>_.source==="skill").length),I=j(()=>Object.values(n.value).reduce((_,R)=>_+R,0));function y(_){for(const R of Wr)if(R.id!=="other"&&R.match(_))return R.id;return"other"}const v=j(()=>{let _=e.value;if(a.value){const R=a.value.toLowerCase();_=_.filter($=>$.name.toLowerCase().includes(R)||($.description||"").toLowerCase().includes(R))}return o.value&&(_=_.filter(R=>y(R.name)===o.value)),_}),b=j(()=>{const _=new Set;for(const R of e.value)_.add(y(R.name));return Wr.filter(R=>_.has(R.id))}),x=j(()=>{const _=v.value,R={};for(const S of _){const M=y(S.name);R[M]||(R[M]=[]),R[M].push(S)}const $=[];for(const S of Wr)R[S.id]&&R[S.id].length>0&&$.push({label:S.label,icon:S.icon,tools:R[S.id].sort((M,Q)=>M.name.localeCompare(Q.name))});return $});function w(_){i.value={...i.value,[_]:!i.value[_]}}async function C(){t.value=!0,s.value=null;try{const[_,R,$]=await Promise.all([H.get("/api/tools"),H.get("/api/tools/stats").catch(()=>({})),H.get("/api/tools/builtins").catch(()=>null)]);m($,_),n.value=R||{}}catch(_){s.value=_.message}t.value=!1}function E(){C()}return Ye(()=>{C()}),{tools:e,loading:t,error:s,search:a,stats:n,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:g,skillCount:A,totalUsage:I,filteredTools:v,groupedTools:x,usedCategories:b,stateBadge:p,applyInventory:m,toggleBuiltinTool:h,truncate:Vd,toggleExpand:w,refresh:E}}};function $k(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const a="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(a,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Uk(e){if(!e)return"1";const t=e.split(`
...
`)}const Bk={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f({}),n=f({}),i=f(null),l=f(""),o=f(null),r=f(!1),c=f("create"),d=f(""),u=f(""),p=f(null),m=f(null),h=f(!1),g=f(null),A=f(null),I=f(!1),y=j(()=>e.value.length),v=j(()=>e.value.reduce((Z,fe)=>Z+(fe.execution_count||0),0)),b=j(()=>e.value.reduce((Z,fe)=>Z+R(fe.code),0)),x=j(()=>{if(!l.value)return e.value;const Z=l.value.toLowerCase();return e.value.filter(fe=>fe.name.toLowerCase().includes(Z)||(fe.description||"").toLowerCase().includes(Z))}),w=j(()=>u.value?u.value.split(`
`).length:0),C=j(()=>{const Z=Math.max(w.value,1);return Array.from({length:Z},(fe,de)=>de+1).join(`
`)}),E=j(()=>{const Z=u.value.trim();return Z?Z.includes("SKILL_DEFINITION")?Z.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function _(Z){return $k(Z)}function R(Z){return Z?Z.split(`
`).length:0}function $(Z){return Uk(Z)}function S(Z){a.value={...a.value,[Z]:!a.value[Z]}}async function M(Z){try{await navigator.clipboard.writeText(Z);const fe=e.value.find(de=>de.code===Z);fe&&(o.value=fe.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function Q(Z){if(Z.key==="Tab"){Z.preventDefault();const fe=Z.target,de=fe.selectionStart,K=fe.selectionEnd;u.value=u.value.substring(0,de)+"    "+u.value.substring(K),Pt(()=>{fe.selectionStart=fe.selectionEnd=de+4})}}function W(Z){const fe=Z.target.previousElementSibling;fe&&(fe.scrollTop=Z.target.scrollTop)}async function D(){t.value=!0,s.value=null;try{e.value=await H.get("/api/skills")}catch(Z){s.value=Z.message}t.value=!1}async function O(Z){i.value=Z,delete n.value[Z],n.value={...n.value};try{const fe=await H.post(`/api/skills/${encodeURIComponent(Z)}/test`);n.value={...n.value,[Z]:fe}}catch(fe){n.value={...n.value,[Z]:{result:fe.message,is_error:!0}}}i.value=null}function N(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,m.value=null}function ie(Z){r.value=!0,c.value="edit",d.value=Z.name,u.value=Z.code||"",p.value=null,m.value=null}function le(){r.value=!1,p.value=null,m.value=null}async function B(){p.value=null,m.value=null;const Z=d.value.trim(),fe=u.value.trim();if(!Z){p.value="Name is required";return}if(!fe){p.value="Code is required";return}h.value=!0;try{c.value==="create"?(await H.post("/api/skills",{name:Z,code:fe}),m.value="Skill created successfully"):(await H.put(`/api/skills/${encodeURIComponent(Z)}`,{code:fe}),m.value="Skill updated successfully"),await D(),setTimeout(()=>{r.value=!1},800)}catch(de){p.value=de.message}h.value=!1}function J(Z){A.value=Z}async function te(){if(A.value){I.value=!0;try{await H.del(`/api/skills/${encodeURIComponent(A.value)}`),await D()}catch(Z){ke.error(`Failed to delete skill: ${Z.message||"unknown error"}`)}I.value=!1,A.value=null}}return Ye(()=>{D()}),{skills:e,loading:t,error:s,showCode:a,testResults:n,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:m,saving:h,editorRef:g,deleteTarget:A,deleting:I,enabledCount:y,totalExecutions:v,totalLines:b,displayedSkills:x,editLineCount:w,editorLineNums:C,editValidation:E,highlight:_,truncate:Vd,formatTs:zn,countLines:R,getLineNumbers:$,toggleCode:S,copyCode:M,handleEditorKey:Q,syncScroll:W,fetchSkills:D,testSkill:O,showCreate:N,editSkill:ie,cancelEdit:le,saveSkill:B,confirmDelete:J,doDelete:te}}};class js extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Hk=/^[A-Za-z_][A-Za-z0-9_]*$/;function Lp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Np(e,t,s){const a={},n=[...new Set((t||[]).map(l=>String(l)))],i=new Set(n);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new js(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new js(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(a,o))throw new js(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new js(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");a[o]=r}}return{set:a,remove:n}}function zk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function jk(e,{mode:t="add",originalTransport:s=""}={}){const a=t==="add",n=String(e.name||"").trim();if(!n)throw new js("Server name is required.","name");if(n.length>128||!Hk.test(n))throw new js("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!a&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(a&&(o.name=n),i==="stdio"){const d=String(e.command||"").trim();if((a||l)&&!d)throw new js("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(a||e.replaceArgs)&&(o.args=Lp(e.argsText)),a||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new js("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((a||l)&&!d)throw new js("An HTTP endpoint is required for this connection.","url");if(d&&!zk(d))throw new js("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(a||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new js("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(a||e.replaceAllowlist)&&(o.tool_allowlist=Lp(e.allowlistText));const r=Np(e.headerRows,e.headersRemove,"Header"),c=Np(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function Vk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function qk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Gk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(a=>String(a).toLowerCase().includes(s)):!0}const Wk=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function Kk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(a=>(a=window.matchMedia)==null?void 0:a.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const n=t.querySelector(".mcp-editor-groups"),i=n==null?void 0:n.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Jk=1e4,Zk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function Kr(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function Yk(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Qk={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),a=f(!1),n=f(""),i=f({max_published_tools_per_server:"",max_published_tools_global:""}),l=f(new Set),o=j(()=>Object.keys(i.value).every(X=>{var we;return Number.isInteger((we=e.value)==null?void 0:we[X])})),r=f(""),c=f(new Set),d=f(new Set),u=f({}),p=f({}),m=f({}),h=f(new Set),g=f(!1),A=f("add"),I=f(""),y=f(null),v=f(Kr()),b=f(""),x=f(!1);let w=null,C=0,E=!1,_=!1;const R=Wk,$=j(()=>{var X;return((X=e.value)==null?void 0:X.servers)||[]}),S=j(()=>{var X;return!!((X=e.value)!=null&&X.enabled)}),M=j(()=>{var X,we,Ce,Oe;return{serverCount:((X=e.value)==null?void 0:X.server_count)||0,enabledCount:((we=e.value)==null?void 0:we.enabled_server_count)||0,connectedCount:((Ce=e.value)==null?void 0:Ce.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),Q=j(()=>{var X;return((X=y.value)==null?void 0:X.header_keys)||[]}),W=j(()=>{var X;return((X=y.value)==null?void 0:X.env_keys)||[]}),D=j(()=>{var X;return A.value==="edit"&&((X=y.value)==null?void 0:X.transport)==="http"}),O=j(()=>A.value==="add"||!D.value),N=j(()=>D.value?"Replace endpoint URL":"Endpoint URL"),ie=j(()=>D.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function le(){B(),w=window.setInterval(()=>J({quiet:!0}),Jk)}function B(){w&&window.clearInterval(w),w=null}async function J({quiet:X=!1}={}){if(a.value)return;const we=++C;X||(t.value=!0);try{const Ce=await H.get("/api/mcp/status");if(we!==C||!E)return;e.value=Ce;for(const ae of Object.keys(i.value))!l.value.has(ae)&&Number.isInteger(Ce[ae])&&(i.value[ae]=String(Ce[ae]));r.value="";const Oe=new Set((Ce.servers||[]).map(ae=>ae.name));d.value=new Set([...d.value].filter(ae=>Oe.has(ae)))}catch(Ce){we===C&&E&&(r.value=Ce.message||"Failed to load MCP status")}finally{we===C&&(t.value=!1)}}function te(X){return s.value||c.value.has(X)}function Z(X,we){const Ce=new Set(c.value);we?Ce.add(X):Ce.delete(X),c.value=Ce}function fe(X){return qk(X.state)}function de(X){if(fe(X)==="disabled"){if(!X.enabled)return"Disabled — server switch off";if(!S.value)return"Disabled — global MCP is off"}return Zk[fe(X)]}function K(X){return X.transport==="http"?"Streamable HTTP":"stdio"}function ue(X){return X.negotiated_version?`${X.era?`${String(X.era).charAt(0).toUpperCase()}${String(X.era).slice(1)}`:"Protocol"} · ${X.negotiated_version}`:"Not negotiated"}function he(X){return X.discovered_count?`${X.published_count||0} published · ${X.excluded_count||0} excluded`:"No tools discovered"}const ge=f(new Set);async function xe(X,we){if(ge.value.has(X.name))return;const Ce=!!we.target.checked,Oe=new Set(ge.value);Oe.add(X.name),ge.value=Oe;try{const ae=await H.post(`/api/mcp/servers/${encodeURIComponent(X.name)}/enabled`,{enabled:Ce});ae&&Array.isArray(ae.servers)?e.value=ae:await J({quiet:!0})}catch(ae){we.target.checked=!!X.enabled,ke.error(ae.message||`Failed to toggle ${X.name}`)}finally{const ae=new Set(ge.value);ae.delete(X.name),ge.value=ae}}function Ne(X,we){var Oe;i.value[X]=we;const Ce=new Set(l.value);we===String((Oe=e.value)==null?void 0:Oe[X])?Ce.delete(X):Ce.add(X),l.value=Ce,n.value=""}async function T(){if(s.value||!o.value||!l.value.size)return;const X={};for(const we of l.value){const Ce=Number(i.value[we]),Oe=we==="max_published_tools_per_server"?128:256;if(!Number.isInteger(Ce)||Ce<1||Ce>Oe){n.value=`Enter a whole number between 1 and ${Oe}.`;return}X[we]=Ce}a.value=!0,s.value=!0,n.value="",++C,t.value=!1;try{const we=await H.post("/api/mcp/limits",X);e.value=we;for(const Ce of Object.keys(i.value))Number.isInteger(we[Ce])&&(i.value[Ce]=String(we[Ce]));l.value=new Set,ke.success("MCP limits saved. Applied at the next publication or tools refresh.")}catch(we){n.value=we.message||"Failed to save MCP publication limits"}finally{a.value=!1,s.value=!1,await J({quiet:!0})}}async function P(X){if(X!==S.value&&!(!X&&!await Qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await H.post("/api/mcp/enabled",{enabled:X}),ke.success(X?"MCP enabled":"MCP disabled"),await J({quiet:!0})}catch(we){ke.error(we.message||"Failed to update MCP state"),await J({quiet:!0})}finally{s.value=!1}}}async function V(X){Z(X.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(X.name)}/reconnect`,{}),ke.success(`Reconnected ${X.name}`)}catch(we){ke.error(we.message||`Failed to reconnect ${X.name}`)}finally{Z(X.name,!1),await J({quiet:!0})}}async function ce(X){Z(X.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(X.name)}/refresh-tools`,{}),ke.success(`Refreshed tools from ${X.name}`),await re(X.name,!0)}catch(we){ke.error(we.message||`Failed to refresh ${X.name}`)}finally{Z(X.name,!1),await J({quiet:!0})}}async function F(X){if(await Qt({title:`Remove ${X.name}`,message:`Remove this saved MCP server? Its ${X.published_count||0} published tool${X.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){Z(X.name,!0);try{await H.del(`/api/mcp/servers/${encodeURIComponent(X.name)}`),ke.success(`Removed ${X.name}`),delete p.value[X.name]}catch(Ce){ke.error(Ce.message||`Failed to remove ${X.name}`)}finally{Z(X.name,!1),await J({quiet:!0})}}}async function Y(X){const we=new Set(d.value);if(we.has(X.name)){we.delete(X.name),d.value=we;return}we.add(X.name),d.value=we,Object.hasOwn(p.value,X.name)||await re(X.name)}async function re(X,we=!1){if(!we&&Object.hasOwn(p.value,X))return;const Ce=new Set(h.value);Ce.add(X),h.value=Ce,m.value={...m.value,[X]:""};try{const Oe=await H.get(`/api/mcp/servers/${encodeURIComponent(X)}/tools`);p.value={...p.value,[X]:Oe.tools||[]}}catch(Oe){m.value={...m.value,[X]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(h.value);Oe.delete(X),h.value=Oe}}function z(X){return(p.value[X]||[]).filter(we=>Gk(we,u.value[X]))}function ee(X,we){u.value={...u.value,[X]:we}}function G(){A.value="add",I.value="",y.value=null,v.value=Kr(),b.value="",g.value=!0}function ve(X){A.value="edit",I.value=X.name,y.value=X,v.value={...Kr(),name:X.name,enabled:!!X.enabled,transport:X.transport||"stdio"},b.value="",g.value=!0}function me(){x.value||(g.value=!1)}function ye(X){g.value&&Kk(X)}function Ie(X){const we=X==="headers"?"headerRows":"envRows";v.value[we].push({key:"",value:""})}function Fe(X,we){const Ce=X==="headers"?"headerRows":"envRows";v.value[Ce].splice(we,1)}function Ve(X,we){const Ce=X==="headers"?"headersRemove":"envRemove",Oe=v.value[Ce];v.value[Ce]=Oe.includes(we)?Oe.filter(ae=>ae!==we):[...Oe,we]}async function Be(){var we,Ce;b.value="";let X;try{X=jk(v.value,{mode:A.value,originalTransport:((we=y.value)==null?void 0:we.transport)||""})}catch(Oe){b.value=Oe instanceof js?Oe.message:"Invalid MCP server configuration",await Pt(),(Ce=document.querySelector(".mcp-editor"))==null||Ce.scrollTo({top:0,behavior:"smooth"});return}if(!(A.value==="edit"&&Vk(X,y.value)&&!await Qt({title:`Change ${I.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){x.value=!0;try{A.value==="add"?await H.post("/api/mcp/servers",X):await H.put(`/api/mcp/servers/${encodeURIComponent(I.value)}`,X),ke.success(A.value==="add"?`Saved ${X.name}`:`Updated ${I.value}`),g.value=!1,await J({quiet:!0})}catch(Oe){b.value=Oe.message||"Failed to save MCP server"}finally{x.value=!1}}}let qe=null;function Je(X){`${(X==null?void 0:X.event)||""} ${(X==null?void 0:X.type)||""} ${(X==null?void 0:X.tool)||""} ${(X==null?void 0:X.message)||""}`.toLowerCase().includes("mcp")&&(qe&&window.clearTimeout(qe),qe=window.setTimeout(()=>J({quiet:!0}),200))}function it(){E||(E=!0,_||(nt.subscribe("events",Je),_=!0),J(),le())}function We(){E=!1,B(),qe&&window.clearTimeout(qe),qe=null,_&&(nt.unsubscribe("events",Je),_=!1)}return Ye(it),is(it),Jt(We),gt(We),{status:e,loading:t,mutating:s,pageError:r,servers:$,masterEnabled:S,aggregate:M,limitsSaving:a,limitsError:n,limitsAvailable:o,limitDraft:i,limitDirty:l,editLimit:Ne,saveLimits:T,expandedServers:d,toolQueries:u,toolErrors:m,toolsLoading:h,editorOpen:g,editorMode:A,editingName:I,editingServer:y,form:v,formError:b,saving:x,editorGroups:R,configuredHeaderKeys:Q,configuredEnvKeys:W,savedHttpEndpoint:D,endpointRequired:O,endpointFieldLabel:N,endpointPlaceholder:ie,refreshAll:J,busy:te,serverState:fe,stateLabel:de,transportLabel:K,protocolLabel:ue,toolSummary:he,formatAge:Yk,setMasterEnabled:P,togglePending:ge,toggleServerEnabled:xe,reconnect:V,refreshTools:ce,removeServer:F,toggleTools:Y,filteredTools:z,setToolQuery:ee,openAdd:G,openEdit:ve,closeEditor:me,jumpToEditorGroup:ye,addSecretRow:Ie,removeSecretRow:Fe,toggleSecretRemoval:Ve,saveServer:Be}}};function Xk(e,t){if(!e||!t)return Ep(e);const s=Ep(e),a=t.trim().split(/\s+/).filter(Boolean);if(!a.length)return s;const n=a.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${n})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const eS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),m=f(!1),h=f(null),g=f(null);let A=null;const I=f(null),y=f(!1),v=f({}),b=f({}),x=f({}),w=f({}),C=new Map,E=f(null),_=j(()=>e.value.reduce((B,J)=>B+(J.chunks||0),0)),R=j(()=>new Set(e.value.map(J=>J.uploader).filter(Boolean)).size);function $(B,J){const te=b.value[J];if(!te||te.length===0)return 0;const Z=Math.max(...te.map(fe=>fe.char_count||0));return Z===0?0:Math.round(B.char_count/Z*100)}async function S(){t.value=!0,s.value=null;try{const B=await H.get("/api/knowledge");e.value=Array.isArray(B)?B:[]}catch(B){s.value=B.message}t.value=!1}async function M(B){if(v.value[B]){v.value[B]=!1,E.value=null;return}if(v.value[B]=!0,Object.prototype.hasOwnProperty.call(b.value,B))return;if(C.has(B))return C.get(B);const J={...w.value,[B]:!0};w.value=J;const te={...x.value};delete te[B],x.value=te;const Z=H.get(`/api/knowledge/${encodeURIComponent(B)}/chunks`).then(fe=>{b.value={...b.value,[B]:Array.isArray(fe)?fe:[]}}).catch(fe=>{x.value={...x.value,[B]:fe.message||"load failed"}}).finally(()=>{if(C.get(B)!==Z)return;C.delete(B);const fe={...w.value};delete fe[B],w.value=fe});return C.set(B,Z),Z}let Q=0;async function W(){const B=a.value.trim();if(!B)return;const J=++Q;i.value=!0,o.value=null,l.value=B;try{const te=await H.get(`/api/knowledge/search?q=${encodeURIComponent(B)}`);if(J!==Q)return;n.value=Array.isArray(te)?te:[]}catch(te){if(J!==Q)return;n.value=[],o.value=te.message||"Search failed"}J===Q&&(i.value=!1)}function D(){Q+=1,i.value=!1,n.value=null,a.value="",o.value=null}async function O(){u.value=null,p.value=null;const B=c.value.trim(),J=d.value.trim();if(!B){u.value="Source name is required";return}if(!J){u.value="Content is required";return}m.value=!0;try{const te=await H.post("/api/knowledge",{source:B,content:J});p.value=`Ingested ${te.chunks||0} chunks from "${B}"`,c.value="",d.value="",b.value={},await S(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(te){u.value=te.message}m.value=!1}async function N(B){h.value=B,g.value=null,A&&(clearTimeout(A),A=null);try{const J=await H.post(`/api/knowledge/${encodeURIComponent(B)}/reingest`);g.value={source:B,error:!1,message:`Re-ingested ${J.chunks||0} chunks`},delete b.value[B],await S(),A=setTimeout(()=>{g.value=null,A=null},3e3)}catch(J){g.value={source:B,error:!0,message:J.message}}h.value=null}function ie(B){I.value=B}async function le(){if(I.value){y.value=!0;try{await H.del(`/api/knowledge/${encodeURIComponent(I.value)}`),delete b.value[I.value],await S()}catch(B){ke.error(`Failed to delete source: ${B.message||"unknown error"}`)}y.value=!1,I.value=null}}return Ye(()=>{S()}),{sources:e,loading:t,error:s,searchQuery:a,searchResults:n,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:m,reingesting:h,reingestResult:g,deleteTarget:I,deleting:y,expanded:v,sourceChunks:b,chunkErrors:x,loadingChunks:w,selectedChunk:E,totalChunks:_,uploaderCount:R,truncate:Vd,formatTs:zn,highlightTerms:Xk,chunkBarWidth:$,fetchSources:S,toggleSource:M,doSearch:W,clearSearch:D,doIngest:O,doReingest:N,confirmDelete:ie,doDelete:le}}},tS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),a=f(null),n=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),m=f(""),h=f(!1),g=f(null),A=f(null),I=f(new Set),y=f(null),v=f(!1),b=f(!1),x=j(()=>e.value.reduce((J,te)=>J+te.count,0)),w=j(()=>I.value.size);function C(J){const te=t.value[J];if(!te)return[];if(!l.value.trim())return te;const Z=l.value.trim().toLowerCase();return te.filter(fe=>fe.key.toLowerCase().includes(Z)||fe.value&&fe.value.toLowerCase().includes(Z))}function E(J,te){return I.value.has(J+"/"+te)}function _(J,te){const Z=J+"/"+te,fe=new Set(I.value);fe.has(Z)?fe.delete(Z):fe.add(Z),I.value=fe}function R(J){const te=t.value[J];return!te||te.length===0?!1:te.every(Z=>I.value.has(J+"/"+Z.key))}function $(J,te){const Z=t.value[J];if(!Z)return;const fe=new Set(I.value);for(const de of Z){const K=J+"/"+de.key;te?fe.add(K):fe.delete(K)}I.value=fe}async function S(){s.value=!0,a.value=null;try{const J=await H.get("/api/memory");e.value=Object.entries(J).map(([te,Z])=>({name:te,keys:Z.keys||[],count:Z.count||0}))}catch(J){a.value=J.message}s.value=!1}async function M(J){if(n.value[J]){n.value[J]=!1;return}n.value[J]=!0;const te=e.value.find(fe=>fe.name===J);if(!te||t.value[J]||i.value===J)return;i.value=J;let Z;try{const de=(await H.get(`/api/memory/${encodeURIComponent(J)}`)).entries||{};Z=te.keys.map(K=>Object.prototype.hasOwnProperty.call(de,K)?{key:K,value:de[K]||"",failed:!1}:{key:K,value:"",failed:!0,error:"Not found in scope"})}catch(fe){Z=te.keys.map(de=>({key:de,value:"",failed:!0,error:fe.message||"Failed to load"}))}t.value[J]=Z,i.value=null}function Q(J,te,Z){p.value=J+"/"+te,m.value=Z}async function W(J,te){h.value=!0,g.value=null;try{await H.put(`/api/memory/${encodeURIComponent(J)}/${encodeURIComponent(te)}`,{value:m.value});const Z=t.value[J];if(Z){const fe=Z.find(de=>de.key===te);fe&&(fe.value=m.value)}p.value=null}catch(Z){g.value=`Failed to save: ${Z.message||"unknown error"}`}h.value=!1}async function D(J,te){try{await navigator.clipboard.writeText(te.value),A.value=J+"/"+te.key,setTimeout(()=>{A.value=null},1500)}catch{}}async function O(){d.value=null,u.value=null;const J=r.value.scope.trim(),te=r.value.key.trim(),Z=r.value.value.trim();if(!J){d.value="Scope is required";return}if(!te){d.value="Key is required";return}if(!Z){d.value="Value is required";return}c.value=!0;try{await H.put(`/api/memory/${encodeURIComponent(J)}/${encodeURIComponent(te)}`,{value:Z}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await S(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(fe){d.value=fe.message}c.value=!1}function N(J,te){y.value={scope:J,key:te}}async function ie(){if(!y.value)return;v.value=!0,g.value=null;const{scope:J,key:te}=y.value;try{await H.del(`/api/memory/${encodeURIComponent(J)}/${encodeURIComponent(te)}`);const Z=t.value[J];Z&&(t.value[J]=Z.filter(K=>K.key!==te));const fe=e.value.find(K=>K.name===J);fe&&(fe.count--,fe.keys=fe.keys.filter(K=>K!==te));const de=new Set(I.value);de.delete(J+"/"+te),I.value=de}catch(Z){g.value=`Failed to delete: ${Z.message||"unknown error"}`}v.value=!1,y.value=null}function le(){b.value=!0}async function B(){v.value=!0,g.value=null;const J=[];for(const te of I.value){const Z=te.indexOf("/");J.push({scope:te.slice(0,Z),key:te.slice(Z+1)})}try{await H.post("/api/memory/bulk-delete",{entries:J}),I.value=new Set,t.value={},await S()}catch(te){g.value=`Bulk delete failed: ${te.message||"unknown error"}`}v.value=!1,b.value=!1}return Ye(()=>{S()}),{scopes:e,scopeEntries:t,loading:s,error:a,expanded:n,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:m,saving:h,actionError:g,copied:A,selected:I,selectedCount:w,totalEntries:x,deleteTarget:y,deleting:v,showBulkDelete:b,fetchMemory:S,toggleScope:M,startEdit:Q,doEdit:W,copyValue:D,doAdd:O,confirmDelete:N,doDelete:ie,confirmBulkDelete:le,doBulkDelete:B,isSelected:E,toggleSelect:_,isScopeAllSelected:R,toggleSelectAll:$,filteredEntries:C}}},sS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=f([]),t=f(null),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(!1),r=f(!1),c=f(null),d=f(!1),u=j(()=>[...new Set(e.value.map(w=>w.category))].sort()),p=j(()=>{const x={};return e.value.forEach(w=>{x[w.category]=(x[w.category]||0)+1}),x}),m=j(()=>n.value?e.value.filter(x=>x.category===n.value):e.value);function h(x){return x==="correction"?"badge-warning":x==="operational"?"badge-info":x==="preference"?"badge-success":"badge-info"}function g(x){i.value=x.key,l.value=x.content}async function A(x){try{await H.put("/api/learned/"+encodeURIComponent(x),{content:l.value}),i.value=null,ke.success("Entry updated"),await y()}catch(w){ke.error(w.message||"Failed to save entry")}}async function I(x){if(await Qt({title:"Delete learned entry",message:`Delete "${x}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/learned/"+encodeURIComponent(x)),ke.success("Entry deleted"),await y()}catch(C){ke.error(C.message||"Failed to delete entry")}}async function y(){s.value=!0,a.value=null;try{const x=await H.get("/api/learned");e.value=x.entries||[],t.value={last_reflection:x.last_reflection,count:x.count}}catch(x){a.value=x.message}s.value=!1}async function v(){var x;r.value=!1,c.value=null;try{const w=await H.get("/api/config");o.value=((x=w.learning)==null?void 0:x.enabled)===!0,r.value=!0}catch(w){c.value=w.status===403?"Administrator access is required to change automatic learning.":w.message||"Automatic learning state is unavailable."}}async function b(x){if(!(!r.value||d.value)){d.value=!0,c.value=null;try{if(await H.put("/api/config",{learning:{enabled:x}}),await v(),!r.value)return;ke.success(`Automatic learning ${o.value?"enabled":"disabled"}`)}catch(w){r.value=!1,c.value=w.status===403?"Administrator access is required to change automatic learning.":w.message||"Failed to change automatic learning."}finally{d.value=!1}}}return Ye(()=>{y(),v()}),{entries:e,meta:t,loading:s,error:a,filterCat:n,editing:i,editContent:l,categories:u,catCounts:p,filtered:m,learningEnabled:o,configReady:r,configError:c,savingConfig:d,catBadge:h,formatTs:zn,startEdit:g,saveEdit:A,deleteEntry:I,fetchEntries:y,fetchLearningConfig:v,setLearningEnabled:b}}},Cv=[{id:"tools",label:"Tools",component:Fk},{id:"skills",label:"Skills",component:Bk},{id:"mcp-servers",label:"MCP Servers",component:Qk},{id:"knowledge",label:"Knowledge",component:eS},{id:"memory",label:"Memory",component:tS},{id:"learned",label:"Learned",component:sS}],aS={components:{TabbedPage:_r},setup(){return{tabs:Cv}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},nS={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},iS={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},lS={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},oS={template:`
...
`)}),e.splice(n,1,I)}e.length>s&&e.splice(0,e.length-s)}function Fc(e,t,s=new Date){var u,p;let a=e;if(cn(e)&&e.type==="log"&&"line"in e?a=e.line:cn(e)&&"payload"in e&&(a=e.payload),typeof a=="string")try{a=JSON.parse(a)}catch{}const n=cn(a)?a:null,i=n!=null&&n.timestamp?new Date(n.timestamp):s,l=Number.isNaN(i.getTime())?s:i,o=n?n.result_summary??n.detail??n.message??JSON.stringify(n):typeof a=="string"?a:JSON.stringify(a)??"",c=(n==null?void 0:n.error)||((u=n==null?void 0:n.metadata)==null?void 0:u.error)||(n==null?void 0:n.success)===!1||[n==null?void 0:n.status,(p=n==null?void 0:n.metadata)==null?void 0:p.status].some(m=>["failed","error","cancelled","denied","outcome_unknown"].includes(m))?"ERROR":Al(n==null?void 0:n.level).toUpperCase()||"INFO",d={id:t,record:n,ts:l.toLocaleTimeString(),_time:l,level:c,text:typeof o=="string"?o:JSON.stringify(o),tool:Al(n==null?void 0:n.tool_name),raw:n?null:o,attribution:fS(n)};return d.searchText=n?JSON.stringify(n):d.text,d}function hS(e){const t=new Map;for(const s of e){const{turnId:a,agentId:n,rootId:i,label:l,parentId:o}=s.attribution,r=a?`turn:${a}`:n?`root:${i||n}`:"unattributed";t.has(r)||t.set(r,{key:r,title:a?`Turn ${a}`:n?`Agent root ${i||n} (turn unavailable)`:"Unattributed / legacy records",count:0,sections:[],_sections:new Map});const c=t.get(r),d=n?`agent:${n}`:"main";if(!c._sections.has(d)){const u={key:d,agentId:n,label:l,parentId:o,rootId:i,title:n?`${l||"Agent"} (${n})`:"Main thread / turn events",entries:[]};c._sections.set(d,u),c.sections.push(u)}c._sections.get(d).entries.push(s),c.count++}return[...t.values()].map(({_sections:s,...a})=>a)}const vS={components:{ToolOutput:wr},props:{entry:{type:Object,required:!0}},emits:["copy"],setup(e){const t=j(()=>pS(e.entry)),s=j(()=>{var o;return El(((o=e.entry.record)==null?void 0:o.tool_input)??"")}),a=j(()=>{var o,r,c;return El(((o=e.entry.record)==null?void 0:o.error)||((c=(r=e.entry.record)==null?void 0:r.metadata)==null?void 0:c.error)||"")}),n=j(()=>uS(e.entry.record)),i=j(()=>Ev(e.entry)),l=j(()=>(e.entry.events||[e.entry.record]).filter(Boolean).map(o=>{var r;return{type:o.type||"execution",timestamp:o.timestamp||"Time not recorded",status:o.status||((r=o.metadata)==null?void 0:r.status)||""}}));return{display:t,argumentsText:s,errorText:a,metadataText:n,rawRecord:i,lifecycle:l}},template:`
    ...
    </div>`,setup(){const e=f("live"),t=f([]);let s=0;const a=f(!1),n=f(!1),i=f(!0),l=f(""),o=f(""),r=f(!1),c=f(!1),d=f(nt.state||"disconnected"),u=j(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),p=f(null),m=f(!1),h=f(null),g=2e3,A=gS,I=bS,y=Jr,v=f("all"),b=f(""),x=f([]),w=f(!1),C=f(""),E=f([]);function _(){try{const ne=localStorage.getItem("odin-log-presets");ne&&(x.value=JSON.parse(ne))}catch{}}function R(){try{localStorage.setItem("odin-log-presets",JSON.stringify(x.value))}catch{}}const $=j(()=>l.value!==""||o.value.trim()!==""||b.value!==""),S=j(()=>{const ne=Jr.find(_e=>_e.value===b.value);return ne?ne.label:""}),M=j(()=>{if(!r.value||!o.value)return null;try{return new RegExp(o.value,"i"),null}catch(ne){return ne.message}}),Q=24,W=j(()=>{if(J.value.length===0)return[];const ne=[],_e=new Date,He=3600*1e3;for(let Xe=Q-1;Xe>=0;Xe--){const dt=new Date(_e.getTime()-(Xe+1)*He),bt=new Date(_e.getTime()-Xe*He);ne.push({start:dt,end:bt,label:ie(dt,bt),shortLabel:bt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Xe of J.value){if(!Xe._time)continue;const dt=Xe._time.getTime();for(const bt of ne)if(dt>=bt.start.getTime()&&dt<bt.end.getTime()){bt.total++,Xe.level==="ERROR"?bt.errors++:Xe.level==="WARNING"?bt.warnings++:bt.info++;break}}return ne}),D=j(()=>{let ne=1;for(const _e of W.value)_e.total>ne&&(ne=_e.total);return ne}),O=j(()=>{if(W.value.length===0)return"";const ne=J.value.map(Xe=>Xe._time&&Xe._time.getTime()).filter(Boolean);if(ne.length===0)return"";const _e=new Date(Math.min(...ne));return`${J.value.length} shown, oldest ${_e.toLocaleTimeString()}`}),N=j(()=>Math.ceil(Q/8));function ie(ne,_e){const He={hour:"2-digit",minute:"2-digit"};return ne.toLocaleTimeString([],He)+" - "+_e.toLocaleTimeString([],He)}function le(ne,_e){return!_e||!ne?"0px":Math.max(2,ne/_e*100)+"%"}function B(ne){const _e=J.value.findIndex(He=>He._time&&He._time.getTime()>=ne.start.getTime()&&He._time.getTime()<ne.end.getTime());if(_e>=0&&p.value){const He=p.value.querySelector('[data-log-id="'+J.value[_e].id+'"]');He&&(He.scrollIntoView({behavior:"smooth",block:"center"}),i.value=!1)}}const J=j(()=>{let ne=t.value;if(l.value&&(ne=ne.filter(_e=>(_e.level||"INFO")===l.value)),b.value){const _e=Jr.find(He=>He.value===b.value);if(_e&&_e.seconds){const He=new Date(Date.now()-_e.seconds*1e3);ne=ne.filter(Xe=>Xe._time&&Xe._time>=He)}}if(o.value&&!M.value)if(r.value)try{const _e=new RegExp(o.value,"i");ne=ne.filter(He=>{const Xe=He.searchText,dt=He.tool||"";return _e.test(Xe)||_e.test(dt)})}catch{}else{const _e=o.value.toLowerCase();ne=ne.filter(He=>{const Xe=He.searchText.toLowerCase(),dt=(He.tool||"").toLowerCase();return Xe.includes(_e)||dt.includes(_e)})}return ne}),te=j(()=>hS(J.value));function Z(ne){const _e=Fc(ne,++s);if(n.value){E.value.push(_e);return}fe(_e)}function fe(ne){mS(t.value,ne,g),i.value&&Pt(()=>de())}function de(ne=!1){const _e=p.value;_e&&_e.scrollTo({top:_e.scrollHeight,behavior:ne?"smooth":"instant"})}function K(){i.value=!0,m.value=!1,Pt(()=>de(!0))}const ue=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function he(){const ne=p.value;if(!ne)return;const _e=ne.scrollHeight-ne.scrollTop-ne.clientHeight<40;m.value=!i.value&&!_e&&t.value.length>0,T.value&&ge()}function ge(){const ne=p.value;!ne||!i.value||ne.scrollHeight-ne.scrollTop-ne.clientHeight>=40&&(i.value=!1,m.value=t.value.length>0)}function xe(){i.value&&requestAnimationFrame(ge)}function Ne(ne){ue.has(ne.key)&&xe()}const T=f(!1);function P(){i.value&&(T.value=!0,requestAnimationFrame(ge))}function V(){T.value&&(T.value=!1,ge())}function ce(){i.value&&(m.value=!1,Pt(()=>de()))}function F(){if(n.value=!n.value,!n.value&&E.value.length>0){for(const ne of E.value)fe(ne);E.value=[]}}function Y(){t.value=[],E.value=[],m.value=!1}function re(){let ne;e.value==="search"?ne=Me.value.map(dt=>{const bt=dt.error?"ERROR":"INFO",Za=dt.tool_name?`[${dt.tool_name}] `:"";return`${dt.timestamp||""} ${bt} ${Za}${dt.result_summary||dt.message||""}`}).join(`
`):ne=J.value.map(Dp).join(`

`);const _e=new Blob([ne],{type:"text/plain"}),He=URL.createObjectURL(_e),Xe=document.createElement("a");Xe.href=He,Xe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Xe.click(),URL.revokeObjectURL(He)}function z(ne){const _e=Dp(ne);navigator.clipboard.writeText(_e).then(()=>{h.value=ne.id,setTimeout(()=>{h.value=null},1500)}).catch(()=>{})}function ee(ne){l.value=l.value===ne?"":ne,v.value="all"}function G(ne){return ne.level==="ERROR"?"log-line-error":ne.level==="WARNING"?"log-line-warning":"text-gray-300"}function ve(ne){return ne==="ERROR"?"text-red-500 font-semibold":ne==="WARNING"?"text-yellow-500":"text-blue-500"}function me(ne){return ne==="ERROR"?"log-chip-error":ne==="WARNING"?"log-chip-warning":"log-chip-info"}function ye(ne){v.value=ne.id;const _e=ne.filters;l.value=_e.level||"",b.value=_e.timeRange||"",o.value=_e.text||"",_e.levels&&(l.value=_e.levels[0]||""),_e.hasToolName&&(o.value="")}function Ie(ne){v.value=ne.id,l.value=ne.filters.level||"",b.value=ne.filters.timeRange||"",o.value=ne.filters.text||""}function Fe(){if(!C.value.trim())return;const ne={id:"custom-"+Date.now(),name:C.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};x.value=[...x.value,ne],R(),w.value=!1,C.value=""}function Ve(ne){x.value=x.value.filter(_e=>_e.id!==ne),R(),v.value===ne&&(v.value="all")}const Be=f("all"),qe=f(""),Je=f(""),it=f(""),We=f(""),X=f(""),we=f(100),Ce=yS,Oe=f(!1),ae=f(!1),Re=f(""),Me=f([]),st=f(null),Vt=f(null);function lt(){e.value="search",st.value||Ct()}async function Ct(){try{st.value=await H.get("/api/logs/stats")}catch{}}function $t(){const ne=X.value;if(!ne){it.value="",We.value="";return}const He={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[ne];if(He){const Xe=new Date(Date.now()-He*1e3);it.value=qt(Xe),We.value=""}}function qt(ne){const _e=He=>String(He).padStart(2,"0");return`${ne.getFullYear()}-${_e(ne.getMonth()+1)}-${_e(ne.getDate())}T${_e(ne.getHours())}:${_e(ne.getMinutes())}`}function De(ne){if(!ne)return"";const _e=new Date(ne);return isNaN(_e.getTime())?"":_e.toISOString()}async function ia(){Oe.value=!0,Re.value="",ae.value=!0,Vt.value=null;try{const ne=new URLSearchParams;Be.value&&Be.value!=="all"&&ne.set("level",Be.value),qe.value&&ne.set("tool",qe.value),Je.value&&ne.set("q",Je.value);const _e=De(it.value),He=De(We.value);_e&&ne.set("start",_e),He&&ne.set("end",He),ne.set("limit",String(we.value));const Xe=await H.get(`/api/logs/search?${ne.toString()}`);Me.value=Xe.entries||[]}catch(ne){Re.value=ne.message||"Search failed",Me.value=[]}finally{Oe.value=!1}}function mn(){Be.value="all",qe.value="",Je.value="",it.value="",We.value="",X.value="",we.value=100,Me.value=[],ae.value=!1,Re.value="",Vt.value=null}function xa(ne){Vt.value=Vt.value===ne?null:ne}function Js(ne){if(!ne.timestamp)return"";try{return new Date(ne.timestamp).toLocaleString()}catch{return ne.timestamp}}function hn(ne){return ne.type==="web_action"?`${ne.status||""} (${ne.execution_time_ms||0}ms)`:(ne.result_summary||"").slice(0,200)}function Fs(ne){return ne.error?"log-line-error":"text-gray-300"}function vn(ne){try{return JSON.stringify(ne,null,2)}catch{return String(ne)}}let Zs=null,ct=!1;function $s(){ct||(ct=!0,nt.subscribe("logs",Z),c.value=nt.connected,d.value=nt.state||"disconnected",Zs=nt.onState(ne=>{d.value=ne,c.value=ne==="connected"}))}function Ja(){ct&&(ct=!1,nt.unsubscribe("logs",Z),Zs&&(Zs(),Zs=null))}return Ye(()=>{_(),window.addEventListener("pointerup",V),window.addEventListener("pointercancel",V)}),is($s),Jt(Ja),gt(()=>{Ja(),window.removeEventListener("pointerup",V),window.removeEventListener("pointercancel",V)}),{mode:e,logs:t,paused:n,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:a,groupedLogs:te,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:J,pauseBuffer:E,showJumpBottom:m,copiedIndex:h,regexError:M,levels:A,logPresets:I,timeRanges:y,timeRange:b,activeLogPreset:v,customLogPresets:x,showSaveLogPreset:w,newLogPresetName:C,hasActiveLogFilters:$,timeRangeLabel:S,timelineBuckets:W,timelineMax:D,timelineSpanLabel:O,timelineLabelSkip:N,togglePause:F,clearLogs:Y,exportLogs:re,logLineClass:G,levelClass:ve,levelChipClass:me,toggleLevel:ee,copyLine:z,jumpToBottom:K,onScroll:he,onUserScrollIntent:xe,onUserScrollKey:Ne,onAutoScrollToggle:ce,onPointerDown:P,applyLogPreset:ye,applyCustomLogPreset:Ie,saveLogCustomPreset:Fe,removeLogCustomPreset:Ve,segmentHeight:le,jumpToTimelineBucket:B,searchLevel:Be,searchTool:qe,searchKeyword:Je,searchStart:it,searchEnd:We,searchTimePreset:X,searchLimit:we,searchLimits:Ce,searching:Oe,searchRan:ae,searchError:Re,searchResults:Me,searchStats:st,expandedSearch:Vt,switchToSearch:lt,runSearch:ia,clearSearchFilters:mn,toggleSearchExpand:xa,formatSearchTs:Js,searchEntryText:hn,searchLogLineClass:Fs,formatJson:vn,applySearchTimePreset:$t}}};function ao(e=[]){const t=[],s=new Set;function a(n){const i=[n.kind,n.label,n.apply_mode||"",n.code||"",n.text||""].join("\0");s.has(i)||(s.add(i),t.push({...n,key:i}))}for(const n of e)for(const i of(n==null?void 0:n.consumers)||[])a({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const n of e)n!=null&&n.apply_handler&&a({kind:"handler",label:"Apply handler",code:n.apply_handler});for(const n of e)n!=null&&n.restart_reason&&a({kind:"restart",label:"Why a restart is required",text:n.restart_reason});for(const n of e)n!=null&&n.activation_policy&&a({kind:"activation",label:"Activation policy",text:n.activation_policy});return t}const _S=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function wS(e,t={}){var n,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),a=Object.hasOwn(t,"fallback")?t.fallback:(n=globalThis.document)==null?void 0:n.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return a&&a.scrollHeight>a.clientHeight?a:e||a||null}const yi=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["grafana_alerts","outbound_webhooks"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],kS={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},no=new Set(["llm_provider","openai_codex","ollama","openai_compatible","kimi","personality","discord","computer"]),SS=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Pp(e){return SS.some(t=>e===t||e.startsWith(`${t}.`))}const Av="odin_config_center_expanded_v1",Rv="odin_config_center_category_v1",TS=50,CS=650,zi=()=>H.get("/api/config/meta");function Sn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function ci(e,t){return JSON.stringify(e)===JSON.stringify(t)}function ei(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function ES(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function AS(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Iv(e,t){if(ci(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Sn(t);const a={};for(const[n,i]of Object.entries(t)){const l=Iv(e[n],i);l!==void 0&&(a[n]=l)}return Object.keys(a).length?a:void 0}function RS(e,t){const s={};for(const[a,n]of Object.entries(t||{})){const i=Iv(e==null?void 0:e[a],n);i!==void 0&&(s[a]=i)}return s}function Ov(e,t,s,a){if(ci(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Ov(e[l],t[l],s?`${s}.${l}`:l,a);return}a.push({path:s,oldVal:e,newVal:t})}function IS(){try{const e=JSON.parse(localStorage.getItem(Av)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function OS(){try{const e=localStorage.getItem(Rv);return yi.some(t=>t.key===e)?e:yi[0].key}catch{return yi[0].key}}const LS={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),a=f(null),n=f(!1),i=f(null),l=f(!1),o=f(""),r=f(!1),c=f(""),d=f(""),u=f("");function p(k){i.value=k||null,k&&typeof k.authorized=="boolean"&&(l.value=k.authorized)}async function m(){try{const k=await H.get("/api/setup/status");p(k.listener),u.value=""}catch(k){p(null),u.value=`Listener status could not be loaded: ${k.message||"Unknown error"}`}}async function h(){if(!(!ce.value||!o.value.trim()||r.value||V.value)){r.value=!0,c.value="",d.value="";try{const k=H.setListenerExposure(o.value.trim(),l.value);o.value="";const q=await k;c.value=q.message,p(q.listener)}catch(k){d.value=k.message||"Listener consent could not be saved."}finally{o.value="",r.value=!1}}}const g=f(null),A=["image_model","outer_model"],I=f(null),y=f(null),v=f(null),b=f(!1),x=f(!1),w=f(null),C=f(""),E=f("all"),_=f(OS()),R=f(IS()),$=f({}),S=f({}),M=f(""),Q=f({}),W=f({}),D=f([]),O=f([]),N=f(!1),ie=f(!1),le=f(!1);let B=null,J=null,te={path:null,at:0},Z=0;const fe=j(()=>{var k;return(((k=t.value)==null?void 0:k.fields)||[]).filter(q=>!no.has(q.path.split(".")[0])&&!Pp(q.path))}),de=j(()=>new Map(fe.value.map(k=>[k.path,k]))),K=j(()=>Ne.value.reduce((k,q)=>k+q.sections.length,0)),ue=j(()=>fe.value.length),he=j(()=>_S),ge=j(()=>D.value.length>0),xe=j(()=>O.value.length>0),Ne=j(()=>{if(!e.value)return[];const k=new Set(yi.flatMap(Se=>Se.sections)),q=yi.map(Se=>({...Se,sections:Se.sections.filter(Ge=>Object.hasOwn(e.value,Ge)&&!no.has(Ge))})).filter(Se=>Se.sections.length),se=Object.keys(e.value).filter(Se=>!k.has(Se)&&!no.has(Se));return se.length&&q.push({key:"other",label:"Other",icon:"folder",sections:se}),q}),T=j(()=>e.value?{...e.value,...$.value}:null),P=j(()=>{if(!e.value)return[];const k=[];for(const[q,se]of Object.entries($.value))Ov(e.value[q],se,q,k);return k.filter(q=>!ci(q.oldVal,q.newVal)).map(q=>{const se=it(q.path);return{...q,label:(se==null?void 0:se.label)||ei(q.path.split(".").at(-1)),apply_mode:(se==null?void 0:se.apply_mode)||Re(q.path.split(".")[0])}})}),V=j(()=>P.value.length>0),ce=j(()=>!!i.value&&l.value!==i.value.authorized),F=j(()=>{var q;const k=(q=i.value)==null?void 0:q.state;return k==="active"||k==="authorized_loopback"?"active":["pending_widening","pending_narrowing","active_rebind_pending"].includes(k)?"pending":k==="restricted"?"restricted":"unknown"}),Y=j(()=>{var k;return{active:"Exposure active",authorized_loopback:"Authorized · loopback host",pending_widening:"Authorized · restart pending",pending_narrowing:"Restriction saved · restart pending",active_rebind_pending:"Exposed · restart pending",restricted:"Loopback only",unknown:"Runtime state unavailable"}[(k=i.value)==null?void 0:k.state]||"Loading listener state"}),re=j(()=>i.value?i.value.authorized?i.value.authorization_source==="explicit"?"Beyond-loopback access is explicitly authorized":"Beyond-loopback access is retained from this installation":"Beyond-loopback access is not authorized":"Unavailable"),z=j(()=>{var k;return{explicit:"saved explicitly in config.yml",default:"schema default; no web.host key is saved",unknown:"source could not be verified"}[(k=i.value)==null?void 0:k.configured_host_source]||"source unavailable"}),ee=j(()=>{const k=i.value;return!k||k.running_scope==="unavailable"?"Actual bound address unavailable":`${(k.listening_hosts||[]).map((se,Se)=>{var kt;const Ge=(kt=k.listening_ports)==null?void 0:kt[Se];return Ge?`${se}:${Ge}`:se}).join(", ")} · ${k.running_scope==="loopback"?"loopback only":"accepting beyond loopback"}`}),G=j(()=>P.value.length),ve=j(()=>new Set(P.value.map(k=>k.path.split(".")[0])).size),me=j(()=>!!C.value||E.value!=="all"),ye=j(()=>{const k={...W.value};for(const q of P.value){const se=it(q.path),Se=oe(se,q.newVal);Se&&(k[q.path]=Se)}return k}),Ie=j(()=>Object.keys(ye.value).length>0),Fe=j(()=>e.value?(me.value?Ne.value:Ne.value.filter(q=>q.key===_.value)).map(q=>({...q,sections:q.sections.filter(se=>Zs(se))})).filter(q=>q.sections.length):[]),Ve=j(()=>{const k=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],q=new Map(k.map(se=>[se,[]]));for(const se of P.value){const Se=q.has(se.apply_mode)?se.apply_mode:"restart";q.get(Se).push(se)}return k.filter(se=>q.get(se).length).map(se=>({key:se,label:hs(se),entries:q.get(se)}))}),Be=j(()=>P.value.filter(k=>k.apply_mode==="restart").length),qe=j(()=>fe.value.filter(k=>k.pending_restart)),Je=j(()=>qe.value.length);function it(k){const q=de.value.get(k);return q?{...q,apply_details:ao([q])}:null}function We(k){const q=`${k}.`;return fe.value.filter(se=>se.path===k||se.path.startsWith(q))}function X(){return fe.value.some(k=>k.path==="tools.hosts"||k.path.startsWith("tools.hosts."))}function we(){var se,Se;const k=((Se=(se=e.value)==null?void 0:se.tools)==null?void 0:Se.hosts)||{},q=Object.keys(k).length;return`${q} host${q===1?"":"s"} configured.`}function Ce(k){return We(k).length}function Oe(k){return ei(k)}function ae(k){const q=We(k);if(!q.length)return`${ei(k)} configuration.`;const se=q.find(kt=>kt.sensitivity==="public"&&kt.description)||q.find(kt=>kt.description),Se=(se==null?void 0:se.description)||"";return Se.match(/setting for (.+)\.$/i)?`${ei(k)} settings and runtime behaviour.`:Se}function Re(k){const q=[...new Set(We(k).map(se=>se.apply_mode))];return q.length===1?q[0]:q.includes("restart")?"restart":q.includes("activation_required")?"activation_required":q[0]||"restart"}function Me(k){const q=[...new Set(We(k).map(se=>hs(se.apply_mode)))];return q.length?q.length===1?q[0]:`Mixed apply behaviour: ${q.join(" · ")}`:""}function st(k){return ao(We(k))}function Vt(k){var q;return Object.hasOwn($.value,k)?$.value[k]:(q=e.value)==null?void 0:q[k]}function lt(){const k=Vt("mcp")||{},q=Object.keys(k.servers||{}).length;return`${k.enabled?"Globally enabled":"Globally disabled"} · ${q} configured server${q===1?"":"s"}.`}function Ct(k,q){return q.split(".").reduce((se,Se)=>se==null?void 0:se[Se],k)}function $t(k){const q=T.value;return We(k).filter(se=>Pp(se.path)?!1:se.path.split(".").length<=2?!0:!se.path.includes(".*")).map(se=>({...se,key:se.path.split(".").at(-1),value:Ct(q,se.path),apply_details:ao([se]),editor:se.path==="agents.final_warning_iterations"?"warning-chips":null}))}function qt(k){const q=k.path.split(".");return q.length>2?q.slice(0,2).join("."):null}function De(k){const q=new Map;for(const se of $t(k)){const Se=qt(se),Ge=Se||`${k}.__root`;q.has(Ge)||q.set(Ge,{key:Ge,path:Se,entries:[]}),q.get(Ge).entries.push(se)}return[...q.values()].map(se=>{const Se=se.entries.find(Ge=>Ge.group_description);return{...se,label:se.path?ei(se.path.split(".").at(-1)):null,description:(Se==null?void 0:Se.group_description)||null,apply_details:ao(se.entries),runtime_summaries:mn(se.entries)}})}function ia(k){return{save:k.save_effect||(k.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:k.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[k.apply_mode]||"Effective runtime state is not currently observable."}}function mn(k){const q=new Map;for(const se of k){const Se=ia(se),Ge=`${se.apply_mode}|${Se.save}|${Se.runtime}`;q.has(Ge)||q.set(Ge,{key:Ge,label:hs(se.apply_mode),save:Se.save,runtime:Se.runtime})}return[...q.values()]}function xa(k){if(Js(k))return k.runtime_effect||k.activation_policy||"";if(k.apply_mode==="activation_required"){const q=k.activation_policy||k.runtime_effect;return q?`Not active after saving. No activation control exists in this release. ${q}`:"Not active after saving; no activation control exists in this release."}return""}function Js(k){return k.action_available===!0&&!!(k.action_label&&k.action_endpoint)}async function hn(k){if(Js(k))try{if(_e(k.path))throw new Error("Save this setting before applying its action.");const q=String(k.action_method||"POST").toLowerCase(),se={post:H.post.bind(H),put:H.put.bind(H),delete:H.del.bind(H)}[q];if(!se)throw new Error("Unsupported configuration action");await se(k.action_endpoint,k.action_body||void 0),await Qs(),Sa("success",`${k.action_label} completed.`)}catch(q){Sa("error",q.message||`${k.action_label} failed`)}}function Fs(k,q){return[k.label,k.path,k.description,...k.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(q)}function vn(k){const q=C.value.trim().toLowerCase();return q?We(k).filter(se=>Fs(se,q)):[]}function Zs(k){const q=We(k);if(E.value!=="all"&&!q.some(Se=>Se.apply_state===E.value))return!1;const se=C.value.trim().toLowerCase();return!se||`${Oe(k)} ${k}`.toLowerCase().includes(se)?!0:q.some(Se=>Fs(Se,se))}function ct(k,q){return We(k).filter(se=>se.apply_state===q).length}function $s(k){return k==="all"?ue.value:fe.value.filter(q=>q.apply_state===k).length}function Ja(k){const q=k.sections.flatMap(se=>We(se));return{fields:q.length,modified:P.value.filter(se=>k.sections.includes(se.path.split(".")[0])).length,pending_restart:q.filter(se=>se.apply_state==="pending_restart").length,invalid:q.filter(se=>se.apply_state==="invalid").length,dormant:q.filter(se=>se.apply_state==="dormant").length}}function ne(k){var q;return Object.hasOwn($.value,k)&&!ci((q=e.value)==null?void 0:q[k],$.value[k])}function _e(k){return P.value.some(q=>q.path===k||q.path.startsWith(`${k}.`))}function He(k){_.value=k,C.value="",E.value="all";try{localStorage.setItem(Rv,k)}catch{}}function Xe(k){E.value=k}function dt(){C.value="",E.value="all"}function bt(k){var q;return((q=Ne.value.find(se=>se.sections.includes(k)))==null?void 0:q.sections)||[]}function Za(k){const q=bt(k),se=q.find(Se=>R.value[Se]===!0);return se||q.find(Se=>R.value[Se]!==!1)||null}function Us(k){return C.value&&!le.value&&Zs(k)?!0:le.value?Za(k)===k:Object.hasOwn(R.value,k)?R.value[k]===!0:!0}function Mi(k){const q=!Us(k);if(le.value){const se={...R.value};for(const Se of bt(k))se[Se]===!0&&(se[Se]=!1);se[k]=q,R.value=se;return}R.value={...R.value,[k]:q}}function Vn(){D.value.push(Sn($.value)),D.value.length>TS&&D.value.shift(),O.value=[]}function gn(){n.value||V.value&&(Vn(),$.value={},W.value={},N.value=!1)}function _a(k,q=!1){const se=Date.now();if(q&&te.path===k&&se-te.at<CS){te.at=se;return}Vn(),te={path:k,at:se}}function wa(k,q,se){if(!q.length)return se;const Se=Sn(k??{});let Ge=Se;for(let kt=0;kt<q.length-1;kt+=1){const Xs=q[kt];Ge[Xs]=Sn(Ge[Xs]??{}),Ge=Ge[Xs]}return Ge[q.at(-1)]=se,Se}function Ya(k){var q;return Object.hasOwn($.value,k)?$.value[k]:Sn((q=e.value)==null?void 0:q[k])}function Rt(k,q,se={}){var Zn;if(n.value||no.has(k.path.split(".")[0]))return;const[Se,...Ge]=k.path.split(".");_a(k.path,!!se.coalesce);const kt=Ya(Se),Xs=Ge.length?wa(kt,Ge,q):q,ra={...$.value};if(ci(Xs,(Zn=e.value)==null?void 0:Zn[Se])?delete ra[Se]:ra[Se]=Xs,$.value=ra,W.value[k.path]){const yn={...W.value};delete yn[k.path],W.value=yn}}function la(k){te={path:null,at:0},S.value={...S.value,[k]:String(Ct(T.value,k)??"")}}function ls(k){if(te={path:null,at:0},!Object.hasOwn(S.value,k))return;const q={...S.value};delete q[k],S.value=q}function bn(k){const q=S.value[k.path];if(te={path:null,at:0},q===""){if(k.nullable){ls(k.path),Rt(k,null,{coalesce:!0});return}W.value={...W.value,[k.path]:"Enter a number."};return}const se=Number(q);if(Number.isNaN(se)||k.type==="integer"&&!Number.isInteger(se)){W.value={...W.value,[k.path]:k.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Se={...S.value};delete Se[k.path],S.value=Se,Rt(k,se,{coalesce:!0})}function Qa(k){return Object.hasOwn(S.value,k.path)?S.value[k.path]:k.value??""}function qn(k,q){if(S.value={...S.value,[k.path]:q},q===""){if(k.nullable){Rt(k,null,{coalesce:!0});return}W.value={...W.value,[k.path]:"Enter a number."};return}const se=Number(q);if(!Number.isFinite(se)||k.type==="integer"&&!Number.isInteger(se)){W.value={...W.value,[k.path]:k.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(W.value[k.path]){const Se={...W.value};delete Se[k.path],W.value=Se}Rt(k,se,{coalesce:!0})}function Gn(k){const q=Number.parseInt(M.value,10);if(!Number.isInteger(q)||q<1){W.value={...W.value,[k.path]:"Warning thresholds must be positive whole numbers."};return}const se=[...new Set([...k.value||[],q])].sort((Se,Ge)=>Ge-Se);M.value="",Rt(k,se)}function oa(k,q){Rt(k,(k.value||[]).filter(se=>se!==q))}function Bs(k){return k.apply_mode==="live_read"?"Odin reads the saved file value on next use.":k.apply_mode==="live_for_new_work"?"New work uses the saved file value.":k.apply_mode==="live_apply"?k.apply_handler?`Apply the saved value through ${k.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":k.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":k.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":k.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function Ys(k){return k.type==="array"&&Array.isArray(k.value)&&!k.structured_container&&!k.structured_container_child&&k.sensitivity==="public"&&k.value.every(q=>["string","number","boolean"].includes(typeof q))}function Te(k){const q=String(Q.value[k.path]??"").trim();if(!q)return;const se=[...new Set([...k.value||[],q])];Q.value={...Q.value,[k.path]:""},Rt(k,se)}function L(k,q){Rt(k,(k.value||[]).filter(se=>se!==q))}function oe(k,q){var Se;if(!k)return null;if((Se=k.enum)!=null&&Se.length&&!k.enum.includes(q))return`Choose one of: ${k.enum.join(", ")}`;if(k.path==="agents.final_warning_iterations"&&(!Array.isArray(q)||!q.length))return"Add at least one warning threshold.";const se=k.constraints||{};if((k.type==="integer"||k.type==="number")&&typeof q=="number"){if(se.minimum!==void 0&&q<se.minimum)return`Must be at least ${se.minimum}${k.unit?` ${k.unit}`:""}`;if(se.maximum!==void 0&&q>se.maximum)return`Must be at most ${se.maximum}${k.unit?` ${k.unit}`:""}`}return null}function be(k){return ye.value[k.path]||null}function Pe(k){const q=`${k}.`;return Object.keys(ye.value).some(se=>se===k||se.startsWith(q))}function Ue(){n.value||D.value.length&&(O.value.push(Sn($.value)),$.value=D.value.pop(),W.value={},S.value={},te={path:null,at:0})}function je(){n.value||O.value.length&&(D.value.push(Sn($.value)),$.value=O.value.pop(),W.value={},S.value={},te={path:null,at:0})}function At(){!V.value||Ie.value||(N.value=!0,ie.value=!1)}function mt(){N.value=!1}function wt(){gn()}function hs(k){return kS[k]||ei(k||"unknown")}function It(k){return`apply-${String(k||"unknown").replaceAll("_","-")}`}function ka(k){return`cfgc-field-${k.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function Wn(k){return`${ka(k)}-input`}function Tr(k){const q=document.getElementById(ka(k))||document.getElementById(ka(k.split(".").slice(0,2).join(".")));q==null||q.scrollIntoView({behavior:"smooth",block:"center"})}function Sa(k,q){y.value={type:k,message:q},window.setTimeout(()=>{var se;((se=y.value)==null?void 0:se.message)===q&&(y.value=null)},3500)}function U(){b.value=!1,E.value="pending_restart",C.value="";const k=wS(a.value);k&&(k.scrollTop=0)}function pe(){b.value=!1}function Ae(k=1800){J&&window.clearTimeout(J),J=window.setTimeout(ut,k)}async function ut(){if(x.value){if(Z+=1,Z>45){x.value=!1,w.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await zi(),Je.value===0){x.value=!1,w.value=null,Sa("success","Odin restarted and the saved startup settings are active.");return}}catch{}Ae(2e3)}}async function Xt(){if(!x.value){w.value=null;try{await H.post("/api/restart",{}),x.value=!0,Z=0,b.value=!1,Ae()}catch(k){w.value=k.message||"Odin could not schedule a restart."}}}async function Le(){if(!(!V.value||Ie.value||n.value)){n.value=!0;try{const k=RS(e.value,$.value),q=await H.put("/api/config",k);e.value=q,$.value={},D.value=[],O.value=[],W.value={},N.value=!1;try{t.value=await zi(),v.value=null,b.value=Je.value>0,Sa("success",Je.value?`Configuration saved. ${Je.value} setting${Je.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(se){v.value=se.message||"Unknown metadata error.",Sa("error",`Configuration saved, but apply status could not be refreshed: ${v.value}`)}}catch(k){Sa("error",k.message||"Configuration could not be saved")}finally{n.value=!1}}}async function Is(){if(!n.value){n.value=!0,g.value=null;try{t.value=await zi(),v.value=null}catch(k){g.value=`Image model status could not be refreshed: ${k.message||"Unknown error"}`}finally{n.value=!1}}}async function os(k,q){if(n.value||!["follow","pin"].includes(q)||!k.length||k.some(Se=>{var Ge,kt;return!A.includes(Se)||!((kt=(Ge=t.value)==null?void 0:Ge.image_model_defaults)!=null&&kt[Se])}))return;n.value=!0,g.value=null;let se=!1;try{const Se=await H.post("/api/config/image-models",{operations:Object.fromEntries(k.map(Ge=>[Ge,q])),expected_revision:t.value.image_model_revision});se=!0;for(const Ge of k){const kt=`image.openai.${Ge}`,Xs=Ct(e.value,kt),ra=Ct(Se.config,kt),Zn=yn=>!Object.hasOwn(yn,"image")||!ci(Ct(yn,kt),Xs)?yn:wa(yn,kt.split("."),ra);$.value=Zn($.value),D.value=D.value.map(Zn),O.value=O.value.map(Zn),e.value=wa(e.value,kt.split("."),ra)}t.value={...t.value,image_model_defaults:Se.image_model_defaults,image_model_revision:Se.image_model_revision},Sa("success","Image model defaults saved. Unrelated drafts were not saved.")}catch(Se){g.value=`Image model operation failed: ${Se.message||"Unknown error"}. Refresh status before retrying if the outcome is uncertain.`}try{t.value=await zi(),v.value=null}catch(Se){const Ge=`Image model status could not be refreshed: ${Se.message||"Unknown error"}`;v.value=Ge,g.value=se?`Image model defaults were saved, but ${Ge}`:`${g.value} ${Ge}`}finally{n.value=!1}}async function Qs(){var k,q;if(!(V.value||n.value)){s.value=!0,I.value=null;try{const se=await H.get("/api/config"),Se=await zi();await m(),e.value=se,t.value=Se,v.value=null;const Ge=Ne.value;if(Ge.some(kt=>kt.key===_.value)||(_.value=((k=Ge[0])==null?void 0:k.key)||yi[0].key),le.value){const Xs=(((q=Ge.find(ra=>ra.key===_.value))==null?void 0:q.sections)||[]).find(ra=>R.value[ra]===!0);R.value=Xs?{...R.value,[Xs]:!0}:{}}}catch(se){I.value=se.message||"Unknown configuration error"}finally{s.value=!1}}}function Kn(k){if(N.value||!(k.ctrlKey||k.metaKey))return;const q=k.target;q instanceof HTMLElement&&(q.matches("input, textarea, select")||q.isContentEditable)||(!k.shiftKey&&k.key.toLowerCase()==="z"?(k.preventDefault(),Ue()):(k.key.toLowerCase()==="y"||k.shiftKey&&k.key.toLowerCase()==="z")&&(k.preventDefault(),je()))}function Jn(k){le.value=k.matches}zt(R,k=>{try{localStorage.setItem(Av,JSON.stringify(k))}catch{}},{deep:!0});let Hl=!1;function Cr(){Hl||(Hl=!0,document.addEventListener("keydown",Kn))}function Er(){Hl&&(Hl=!1,document.removeEventListener("keydown",Kn))}return Ye(()=>{var k;Qs(),Cr(),B=window.matchMedia("(max-width: 760px)"),Jn(B),(k=B.addEventListener)==null||k.call(B,"change",Jn)}),is(Cr),Jt(Er),Jt(()=>{o.value=""}),gt(()=>{var k;o.value="",Er(),(k=B==null?void 0:B.removeEventListener)==null||k.call(B,"change",Jn),J&&window.clearTimeout(J)}),{listenerState:i,listenerConsent:l,listenerCredential:o,listenerSaving:r,listenerMessage:c,listenerError:d,listenerStatusError:u,listenerChoiceChanged:ce,listenerStatusTone:F,listenerStatusLabel:Y,listenerAuthorizationCopy:re,listenerConfiguredSourceCopy:z,listenerRunningCopy:ee,saveListenerConsent:h,armKeydown:Cr,disarmKeydown:Er,handleKeydown:Kn,config:e,meta:t,loading:s,saving:n,error:I,toast:y,metaRefreshError:v,restartPromptOpen:b,restartScheduled:x,restartError:w,configMain:a,imageModelError:g,imageModelLeaves:A,setImageModelDefaults:os,refreshImageModelMetadata:Is,searchQuery:C,healthFilter:E,activeCategory:_,reviewOpen:N,mobileOverflowOpen:ie,warningThresholdInput:M,arrayInputs:Q,healthFilters:he,visibleCategories:Ne,displayGroups:Fe,reviewGroups:Ve,sectionCount:K,fieldCount:ue,hasChanges:V,changeCount:G,changedSectionCount:ve,hasDraftErrors:Ie,canUndo:ge,canRedo:xe,globalFilterActive:me,reviewRestartCount:Be,pendingRestartCount:Je,pendingRestartFields:qe,healthCount:$s,categoryStats:Ja,selectCategory:He,selectHealthFilter:Xe,clearFilters:dt,sectionLabel:Oe,sectionDescription:ae,sectionFieldCount:Ce,sectionHealthCount:ct,sectionApplySummary:Me,sectionApplyDetails:st,sectionEntries:$t,fieldGroups:De,sectionSearchHits:vn,mcpConfigSummary:lt,fieldRuntimeCopy:ia,fieldSpecificRuntimeNote:xa,hasHonestAction:Js,runFieldAction:hn,hasHostsCollection:X,hostsConfigSummary:we,sectionChanged:ne,fieldChanged:_e,isSectionExpanded:Us,toggleSection:Mi,discardAllDrafts:gn,setFieldValue:Rt,setNumberFieldValue:qn,numberInputValue:Qa,beginInputEdit:la,endTextInputEdit:ls,endInputEdit:bn,addWarningThreshold:Gn,removeWarningThreshold:oa,isScalarArray:Ys,addScalarArrayItem:Te,removeScalarArrayItem:L,fieldError:be,sectionHasErrors:Pe,undo:Ue,redo:je,openReview:At,closeReview:mt,mobileCancel:wt,applyModeLabel:hs,applyClass:It,compactValue:ES,formatValue:AS,structuredApplyCopy:Bs,fieldId:ka,fieldInputId:Wn,focusField:Tr,fetchConfig:Qs,saveConfig:Le,restartOdin:Xt,restartLater:pe,reviewPendingRestart:U}}},NS=/^\d{15,25}$/;function Lv(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Nv={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),a=f(!1),n=f(0),i=f(null),l=j(()=>new Set((e.excludedIds||[]).map(String))),o=j(()=>{const x=s.value.toLowerCase().trim();return(e.members||[]).filter(w=>l.value.has(String(w.id))?!1:x?u(w).toLowerCase().includes(x)||String(w.username||"").toLowerCase().includes(x)||String(w.id).includes(x):!0)}),r=j(()=>{const x=s.value.trim();return o.value.length===0&&NS.test(x)&&!l.value.has(x)?x:""}),c=j(()=>o.value.length+(r.value?1:0)),d=j(()=>{if(a.value){if(o.value[n.value])return`${e.optionsId}-${n.value}`;if(r.value&&n.value===o.value.length)return`${e.optionsId}-raw`}});function u(x){return Lv(x)}function p(){a.value=!0,n.value=0}function m(){p()}function h(){const x=Math.max(c.value-1,0);n.value=Math.min(n.value+1,x)}function g(){n.value=Math.max(n.value-1,0)}function A(){const x=o.value[n.value];x?I(x):r.value&&n.value===o.value.length&&y(r.value)}function I(x){y(String(x.id))}function y(x){t("select",x),s.value="",a.value=!1,n.value=0}function v(){a.value=!1}function b(){setTimeout(v,150)}return Ye(()=>{e.autofocus&&Pt(()=>{var x;return(x=i.value)==null?void 0:x.focus()})}),{query:s,open:a,highlightedIndex:n,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:m,highlightNext:h,highlightPrevious:g,selectHighlighted:A,selectMember:I,selectId:y,closeOptions:v,onBlur:b}}};function Fp(e,t,s){var a;return((a=e==null?void 0:e.config)==null?void 0:a[t])!=null?e.config[t]:s==null?void 0:s[t]}const DS={components:{DiscordUserCombobox:Nv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f({persisted:!1,active:{state:"unknown"}}),s=f(""),a=f(!1),n=f(null);let i=null;const l=f(!0),o=f(null),r=f({}),c=f(null),d=f(null),u=f(!1),p=f(null),m=f({}),h=f([]);let g=0;const A=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),I=j(()=>JSON.stringify(c.value)!==JSON.stringify(d.value)),y=j(()=>new Map(h.value.map(de=>[String(de.id),de])));function v(de){return de.config&&de.config.enabled!==void 0?de.config.enabled:!0}function b(de){return Fp(de,"require_mention",c.value)}function x(de){return Fp(de,"respond_to_bots",c.value)}function w(de){return de.config&&Object.keys(de.config).length>0}function C(de){r.value[de]=!r.value[de]}function E(de){const K=de.discord||{};return{allowed_users:[...K.allowed_users||[]],channels:[...K.channels||[]],respond_to_bots:!!K.respond_to_bots,require_mention:!!K.require_mention,ignore_bot_ids:[...K.ignore_bot_ids||[]]}}async function _({showLoading:de=!0}={}){const K=++g;de&&(l.value=!0),o.value=null;try{const ue=await H.get("/api/discord/guilds");K===g&&(e.value=ue)}catch(ue){K===g&&(o.value=ue.message)}finally{de&&K===g&&(l.value=!1)}}async function R(){try{t.value=await H.get("/api/discord/connection"),n.value=null}catch(de){n.value=de.message}}async function $(de,K=null){if(!a.value){a.value=!0,n.value=null;try{const ue={operation:de};K!==null&&(ue.token=K),t.value=await H.post("/api/discord/connection",ue),de==="credentials"&&(s.value="")}catch(ue){n.value=ue.message||"Connection update failed."}finally{a.value=!1}}}function S(){return $("credentials",s.value)}function M(){return $("connect")}function Q(){return $("detach")}async function W(){l.value=!0,o.value=null;try{const[de,K,ue]=await Promise.all([H.get("/api/discord/guilds"),H.get("/api/discord/members").catch(()=>[]),H.get("/api/config")]),he=E(ue),ge=I.value;c.value=he,ge||(d.value=JSON.parse(JSON.stringify(he))),h.value=K,e.value=de,p.value=null}catch(de){o.value=de.message}finally{l.value=!1}}let D=Promise.resolve();const O=f(new Set);function N(de,K){const ue=new Set(O.value);ue.add(de),O.value=ue;const he=D.then(K);return D=he.catch(()=>{}),he.finally(()=>{const ge=new Set(O.value);ge.delete(de),O.value=ge})}function ie(de,K,ue,he){const ge=(he==null?void 0:he.target)??null;return N(`guild:${de}:${K}`,async()=>{try{await H.put("/api/discord/guild/"+de+"/config",{[K]:ue}),await _({showLoading:!1})}catch(xe){o.value=xe.message,ge&&typeof ue=="boolean"&&(ge.checked=!ue)}})}function le(de,K,ue,he,ge){const xe=(ge==null?void 0:ge.target)??null;return N(`channel:${de}:${ue}`,async()=>{try{await H.put("/api/discord/channel/"+de+"/config",{[ue]:he}),await _({showLoading:!1})}catch(Ne){o.value=Ne.message,xe&&typeof he=="boolean"&&(xe.checked=!he)}})}function B(de,K){return N(`channel:${de}:clear`,async()=>{try{await H.put("/api/discord/channel/"+de+"/config",{clear:!0}),await _({showLoading:!1})}catch(ue){o.value=ue.message}})}function J(de,K){const ue=String(K);if(!de.userAutocomplete)return ue;const he=y.value.get(ue);return he?Lv(he):ue}function te(de,K=null){const ue=String(K??m.value[de]??"").trim();!ue||d.value[de].includes(ue)||(d.value[de]=[...d.value[de],ue],m.value={...m.value,[de]:""})}function Z(de,K){d.value[de]=d.value[de].filter(ue=>ue!==K)}async function fe(){if(!(!I.value||u.value)){u.value=!0,p.value=null;try{const K=(await H.put("/api/config",{discord:d.value})).discord||d.value;c.value={allowed_users:[...K.allowed_users||[]],channels:[...K.channels||[]],respond_to_bots:!!K.respond_to_bots,require_mention:!!K.require_mention,ignore_bot_ids:[...K.ignore_bot_ids||[]]},d.value=JSON.parse(JSON.stringify(c.value))}catch(de){p.value=de.message||"Global defaults could not be saved."}finally{u.value=!1}}}return Ye(()=>{W(),R(),i=window.setInterval(R,5e3)}),gt(()=>{i!==null&&window.clearInterval(i),i=null}),{guilds:e,loading:l,error:o,expanded:r,globalDraft:d,globalSaving:u,globalError:p,globalArrayInputs:m,globalMembers:h,globalListEditors:A,globalChanged:I,guildEnabled:v,guildMention:b,guildBots:x,hasOverride:w,toggleGuild:C,fetchAll:W,fetchGuilds:_,setGuildConfig:ie,setChannelConfig:le,clearOverride:B,mutationPending:O,globalItemLabel:J,addGlobalItem:te,removeGlobalItem:Z,saveGlobalDefaults:fe,connection:t,connectionToken:s,connectionBusy:a,connectionError:n,saveDiscordCredentials:S,connectDiscord:M,detachDiscord:Q}}},Os=e=>e==null?e:JSON.parse(JSON.stringify(e));function MS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:a=()=>{},onDefaultRollback:n=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let m=null;const h=new Map;function g(w){d+=1;const C=c.then(w,w);return c=C.catch(()=>{}),C}function A(w,C){m=Os(w),h.clear();for(const[E,_]of Object.entries(C||{}))h.set(E,Os(_))}function I(w){const C=Os(w),E=++u;return g(async()=>{try{await e(Os(C)),m=Os(C),E===u&&a(Os(C))}catch(_){E===u&&(n(Os(m)),r(_,{kind:"default"}))}})}function y(w,C){const E=Os(C),_=(p.get(w)||0)+1;return p.set(w,_),g(async()=>{try{await t(w,Os(E)),h.set(w,Os(E)),_===p.get(w)&&i(w,Os(E))}catch(R){_===p.get(w)&&(l(w,Os(h.get(w)??null)),r(R,{kind:"user",uid:w}))}})}function v(w){const C=(p.get(w)||0)+1;return p.set(w,C),g(async()=>{try{await s(w),h.delete(w),C===p.get(w)&&o(w)}catch(E){C===p.get(w)&&(l(w,Os(h.get(w)??null)),r(E,{kind:"delete",uid:w}))}})}async function b(){for(;;){const w=c;if(await w,w===c)return d}}async function x(w){for(;;){const C=await b(),E=await w();if(C===d)return E}}return{seed:A,saveDefault:I,saveUser:y,deleteUser:v,whenIdle:b,readSnapshot:x,get revision(){return d}}}const PS={components:{DiscordUserCombobox:Nv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=j(()=>{const S={};for(const M of r.value)S[M.id]=M;return S});function d(S){return c.value[S]||null}function u(S,M){return S?S.allowed_hosts===null||S.allowed_hosts===void 0?{allowed_hosts:[...M],default_host:S.default_host||"",allow_all:!0}:{allowed_hosts:S.allowed_hosts,default_host:S.default_host||"",allow_all:!1}:{allowed_hosts:[...M],default_host:M[0]||"",allow_all:!0}}const p=MS({applyDefault:async S=>{const M=S.allow_all?null:S.allowed_hosts;await H.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:S.default_host})},applyUser:async(S,M)=>{const Q=M.allow_all?null:M.allowed_hosts;await H.put(`/api/host-access/user/${S}`,{allowed_hosts:Q,default_host:M.default_host})},applyDelete:S=>H.del(`/api/host-access/user/${S}`),onDefaultConfirmed:()=>ke.success("Default policy updated"),onDefaultRollback:S=>{S&&(i.value=S)},onUserConfirmed:S=>{const M=d(S);ke.success(`Updated access for ${M?M.display_name:S}`)},onUserRollback:(S,M)=>{const Q={...l.value};M?Q[S]=M:delete Q[S],l.value=Q},onUserDeleted:S=>{const M={...l.value};delete M[S],l.value=M},onError:(S,M)=>{var W;const Q=M.uid?` ${((W=d(M.uid))==null?void 0:W.display_name)||M.uid}`:"";ke.error(`${S.message||"Failed to save"} — reverted${Q}`)}});let m=0;async function h(){const S=++m;e.value=!0,t.value="";try{const M=await p.readSnapshot(()=>H.get("/api/host-access"));if(S!==m)return;s.value=M,a.value=M.available_hosts||[],n.value=M.host_descriptions||{},i.value=u(M.default_policy,a.value);const Q=M.users||{},W={};for(const[D,O]of Object.entries(Q))W[D]=u(O,a.value);l.value=W,p.seed(i.value,W)}catch(M){S===m&&(t.value=M.message||"Failed to fetch host access data")}finally{S===m&&(e.value=!1)}try{const M=await H.get("/api/discord/members")||[];S===m&&(r.value=M)}catch{S===m&&(r.value=[])}}const g=500,A=new Map;function I(S,M){const Q=A.get(S);Q&&clearTimeout(Q.timer);const W={run:M,timer:null};W.timer=setTimeout(()=>{A.delete(S),M()},g),A.set(S,W)}function y(S){const M=A.get(S);M&&(clearTimeout(M.timer),A.delete(S))}function v(){for(const[S,M]of[...A])clearTimeout(M.timer),A.delete(S),M.run()}function b(){I("default",()=>p.saveDefault(i.value))}function x(S,M){i.value.allow_all=!1,M?i.value.allowed_hosts.includes(S)||i.value.allowed_hosts.push(S):(i.value.allowed_hosts=i.value.allowed_hosts.filter(Q=>Q!==S),i.value.default_host===S&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function w(S){I(`user:${S}`,()=>{const M=l.value[S];M&&p.saveUser(S,M)})}function C(S,M,Q){const W=l.value[S];W&&(W.allow_all=!1,Q?W.allowed_hosts.includes(M)||W.allowed_hosts.push(M):(W.allowed_hosts=W.allowed_hosts.filter(D=>D!==M),W.default_host===M&&(W.default_host=W.allowed_hosts[0]||"")),w(S))}function E(S,M){const Q=l.value[S];Q&&(Q.default_host=M,w(S))}function _(){o.value=!0}function R(S){!/^\d{15,25}$/.test(S)||l.value[S]||(l.value[S]={allowed_hosts:[...a.value],default_host:a.value[0]||"",allow_all:!1},p.saveUser(S,l.value[S]),o.value=!1)}async function $(S){const M=d(S);await Qt({title:"Remove user override",message:`Remove the host access override for ${M?M.display_name:S}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(y(`user:${S}`),await p.deleteUser(S),l.value[S]||ke.success(`Removed override for ${M?M.display_name:S}`))}return Ye(h),Jt(v),gt(v),{loading:e,error:t,data:s,availableHosts:a,hostDescriptions:n,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:h,saveDefaultPolicy:b,toggleDefaultHost:x,getMember:d,toggleUserHost:C,setUserDefault:E,openAddUser:_,addUserById:R,deleteUser:$,flushPendingSaves:v}}},FS={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=f([]),t=f(!1),s=f(""),a=f([]),n=f(!1),i=f(!1),l=f(1),o=f(""),r=f(!1),c=f(null),d=f(""),u=f([]),p=f(!1),m=f(null),h=f(""),g=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),A=f(g()),I=j(()=>["127.0.0.1","localhost","::1"].includes(A.value.address));async function y(){t.value=!0,s.value="";try{const W=await H.get("/api/hosts");e.value=W.hosts||[],o.value=W.default_host||"",r.value=!!W.tofu_enabled}catch(W){s.value=W.message}finally{t.value=!1}}async function v(){try{await H.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),ke.success("Host settings saved and published live"),await y()}catch(W){ke.error(W.message)}}function b(){d.value="",u.value=[],p.value=!1,m.value=null,c.value=null,h.value="",l.value=1,n.value=!0}function x(){i.value=!1,A.value=g(),b()}function w(W){i.value=!0,A.value={...g(),...W},b()}async function C(){try{c.value=await H.get("/api/hosts/public-key")}catch(W){ke.error(W.message)}}async function E(W){try{const D=await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/import-legacy",{});i.value=!0,A.value={...g(),...W,trust_mode:"pinned"},b(),d.value=D.candidate_token,u.value=D.fingerprints||[],h.value=u.value.join(`
`),l.value=4,ke.info("Imported existing known_hosts trust. Test before activation.")}catch(D){ke.error(D.message)}}async function _(){try{const W=h.value.split(/\s+/).filter(Boolean),D={...A.value,expected_fingerprints:W,candidate_fingerprints:u.value},O=await H.post("/api/hosts/candidates",D);if(d.value=O.candidate_token,u.value=O.fingerprints||[],A.value.trust_mode==="tofu"&&D.candidate_fingerprints.length===0){A.value.confirm_tofu=!1,ke.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(W){ke.error(W.message)}}async function R(){var W,D;p.value=!1,m.value=null;try{const O=await H.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!O.tested,m.value=O.last_test,p.value&&(l.value=5)}catch(O){const N=(W=O.data)==null?void 0:W.last_test;N&&typeof N=="object"&&!Array.isArray(N)&&(m.value=N);const ie=(D=m.value)==null?void 0:D.detail;ke.error(typeof ie=="string"&&ie.trim()?ie:O.message)}}async function $(){try{await H.post("/api/hosts/candidates/"+d.value+"/commit",{}),ke.success("Host saved and published live"),n.value=!1,await y()}catch(W){ke.error(W.message)}}async function S(W){try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/enabled",{enabled:!W.enabled}),await y()}catch(D){ke.error(D.message)}}async function M(W){var D;if(await Qt("Delete host "+W.alias+"? Dependencies will block deletion.")){a.value=[];try{await H.del("/api/hosts/"+encodeURIComponent(W.alias)),await y()}catch(O){a.value=Array.isArray((D=O.data)==null?void 0:D.pending_references)?O.data.pending_references:[],ke.error(O.message)}}}async function Q(W){if(await Qt("Force revoke "+W.alias+"? Remote outcomes may be unknown."))try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/force-revoke",{}),await y()}catch(D){ke.error(D.message)}}return Ye(y),{hosts:e,loading:t,error:s,pendingReferences:a,wizard:n,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:A,isLocal:I,keyInfo:c,candidate:d,observed:u,tested:p,testResult:m,fingerprintsText:h,load:y,saveSettings:v,beginAdd:x,beginEdit:w,loadKey:C,importLegacy:E,prepare:_,testConnection:R,commit:$,toggle:S,remove:M,forceRevoke:Q}}},$S={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=j(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:a.value),p=j(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:a.value);function m(E){return E==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":E==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function h(){e.value=!0,t.value="";try{const E=await H.get("/api/tokens");s.value=E.tokens||[],a.value=E.available_hosts||[]}catch(E){t.value=E.message||"Failed to load tokens"}finally{e.value=!1}}function g(E){return!E||!E.trim()?[]:E.split(",").map(_=>_.trim()).filter(Boolean)}function A(E,_){const R=c.value.allowed_hosts;if(_&&!R.includes(E)&&R.push(E),!_){const $=R.indexOf(E);$>=0&&R.splice($,1)}}function I(E,_){const R=d.value.allowed_hosts;if(_&&!R.includes(E)&&R.push(E),!_){const $=R.indexOf(E);$>=0&&R.splice($,1)}}async function y(){var E;i.value=!0;try{const _=g(c.value.allowed_tools_str),R=c.value.host_mode,$=R==="none"?[]:R==="select"?c.value.allowed_hosts:null,S={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:_.length?_:[]};$!==null&&(S.allowed_hosts=$),S.default_host=c.value.default_host||"";const M=await H.post("/api/tokens",S);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},n.value=!1,ke.success("Token created"),await h()}catch(_){ke.error(((E=_.data)==null?void 0:E.error)||_.message||"Failed to create token")}finally{i.value=!1}}function v(E){o.value=E;const _=E.allowed_hosts;let R="default";_==null?R="default":Array.isArray(_)&&_.length===0?R="none":Array.isArray(_)&&(R="select"),d.value={username:E.username||"",tier:E.tier||"admin",label:E.label||"",host_mode:R,allowed_hosts:Array.isArray(_)?[..._]:[],default_host:E.default_host||"",allowed_tools_str:(E.allowed_tools||[]).join(", ")}}async function b(){var E;if(o.value){r.value=!0;try{const _=g(d.value.allowed_tools_str),R=d.value.host_mode,$={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:_};R==="none"?$.allowed_hosts=[]:R==="select"?$.allowed_hosts=d.value.allowed_hosts:$.allowed_hosts=null,$.default_host=d.value.default_host||"",await H.put("/api/tokens/"+encodeURIComponent(o.value.user_id),$),o.value=null,ke.success("Token updated"),await h()}catch(_){ke.error(((E=_.data)==null?void 0:E.error)||_.message||"Failed to update")}finally{r.value=!1}}}async function x(E){var R;if(await Qt({title:"Regenerate token",message:`Regenerate token for ${E.username||E.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const $=await H.post("/api/tokens/"+encodeURIComponent(E.user_id)+"/regenerate");l.value=$.token,ke.success("Token regenerated")}catch($){ke.error(((R=$.data)==null?void 0:R.error)||$.message||"Failed to regenerate")}}async function w(E){var R;if(await Qt({title:"Delete token",message:`Delete token for ${E.username||E.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/tokens/"+encodeURIComponent(E.user_id)),ke.success("Token deleted"),await h()}catch($){ke.error(((R=$.data)==null?void 0:R.error)||$.message||"Failed to delete")}}async function C(){if(l.value)try{await navigator.clipboard.writeText(l.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return Ye(h),{loading:e,error:t,tokens:s,availableHosts:a,showCreate:n,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:h,tierBadge:m,toggleCreateHost:A,toggleEditHost:I,createToken:y,startEdit:v,saveEdit:b,confirmRegenerate:x,confirmDelete:w,copyToken:C}}},US=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort"]),BS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),HS=Object.freeze(["enabled","base_url","model","max_tokens"]),zS=Object.freeze(["enabled","base_url","model","max_tokens"]);function Ul(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function jS(e,t={}){const s=Ul(e,zS);return t.includeApiKey&&(s.api_key=e.api_key),s}function VS(e){return Ul(e,["timeout","preset","model_profiles","context_utilization"])}function $p(e){return Ul(e,US)}function Up(e){return Ul(e,BS)}function qS(e,{includeApiKey:t=!1}={}){const s=Ul(e,HS);return t&&(s.api_key=e.api_key),s}function GS(e){return{timeout:e.timeout}}function io(e,t=500){let s=null;const a=(...n)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...n)},t)};return a.pending=()=>s!==null,a.cancel=()=>{s&&(clearTimeout(s),s=null)},a}const WS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),a=f({main:"",main_capability:"medium",agent_capability:"adaptive"}),n=["none","low","medium","high","xhigh","max"],i=f({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),l=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna"],o=j(()=>{const U=t.value||{},pe=U.model_catalogue||U.model_catalog||{},Ae=(Le,Is,os)=>Is.map(Qs=>{var Kn,Jn;return{ref:Le==="codex"?Qs:`${Le}:${typeof Qs=="string"?Qs:Qs.name}`,name:typeof Qs=="string"?Qs:Qs.name,provider:Le,available:!!(os!=null&&os.enabled&&(Le==="codex"?os.configured:(Kn=os.health)!=null&&Kn.healthy)),unavailable_reason:os!=null&&os.enabled?os!=null&&os.configured?!((Jn=os==null?void 0:os.health)!=null&&Jn.healthy)&&Le!=="codex"?"unreachable":"":"not configured":"disabled",capability:Le==="codex"?"reasoning":Le==="compat"?"thinking":"none"}}),ut=[...pe.codex||Ae("codex",l,U.codex),...pe.compat||pe.openai_compatible||Ae("compat",Y.value,U.openai_compatible),...pe.ollama||Ae("ollama",Ne.value,U.ollama)].map(Le=>typeof Le=="string"?{ref:Le,name:Le,provider:"codex",available:!0,capability:"reasoning"}:Le),Xt=new Set(ut.map(Le=>Le.ref));for(const Le of[a.value.main,G.value.model,...G.value.auto_model_allowlist||[]])Le&&Le!=="auto"&&!Xt.has(Le)&&ut.unshift({ref:Le,name:Le.replace(/^(compat|ollama):/,""),provider:Le.split(":")[0]||"codex",available:!1,unavailable_reason:"unavailable",capability:Le.startsWith("compat:")?"thinking":Le.startsWith("ollama:")?"none":"reasoning"});return ut}),r=j(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([U,pe])=>({id:U,label:pe,models:o.value.filter(Ae=>Ae.provider===U)})).filter(U=>U.models.length)),c=j(()=>r.value.map(U=>({...U,models:U.models.filter(pe=>G.value.auto_model_allowlist.includes(pe.ref)||pe.available)})).filter(U=>U.models.length)),d=j(()=>o.value.find(U=>U.ref===a.value.main)),u=j(()=>o.value.find(U=>U.ref===G.value.model)),p=U=>`${U.name}${U.available?"":` (${U.unavailable_reason||"unavailable"})`}`,m=j(()=>{const U=i.value.model;return U&&!l.includes(U)?[U,...l]:l}),h=j(()=>{const U=G.value.model;return U&&U!=="auto"&&!l.includes(U)?[U,...l]:l}),g={"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},A=(U,pe)=>!!U&&!!pe&&(g[U]||[]).includes(pe),I=j(()=>{const U=G.value.model;return U&&!U.includes(":")?U:null}),y=U=>!A(i.value.model,U)&&!(i.value.agent_reasoning_effort===""&&A(I.value,U)),v=U=>{const pe=G.value.model;return pe==="auto"?!0:!A(pe||i.value.model,U)},b=j(()=>{const U=i.value.agent_reasoning_effort;return U==="auto"?null:U||i.value.reasoning_effort}),x=U=>A(U,i.value.reasoning_effort)||G.value.model===""&&A(U,b.value),w=U=>A(U,b.value),C=f({enabled:!1,model:"gpt-5.6-luna"}),E=f({unavailable_reason:null}),_=j(()=>{const U=C.value.model;return U&&!l.includes(U)?[U,...l]:l});function R(U){const pe=U.target.value;C.value.enabled=pe!=="",pe!==""&&(C.value.model=pe),Bs()}const $=f(!1),S=f({codex:!1,ollama:!1,compatible:!1}),M=f(null),Q=f(!1),W=f(""),D=f(null),O=f(!1);let N=0;const ie=j(()=>{var U;return Object.entries(((U=M.value)==null?void 0:U.models)||{}).map(([pe,Ae])=>{var ut,Xt,Le;return{model:pe,floor:Ae.floor,override:Ae.override,effectiveBudget:(ut=Ae.effective)==null?void 0:ut.effective_budget,configuredPrimaryChars:(Xt=Ae.configured)==null?void 0:Xt.primary_chars,primaryChars:(Le=Ae.effective)==null?void 0:Le.primary_chars,provenance:Ae.provenance,clampExpiresAt:Ae.clamp_expires_at,densityPriorMilli:Ae.density_prior_milli,densityScope:Ae.density_scope,workloadCalibration:Ae.workload_calibration}})}),le=j(()=>{var U;return((U=M.value)==null?void 0:U.clamps)||[]}),B=j(()=>{var U,pe;return((pe=(U=M.value)==null?void 0:U.models)==null?void 0:pe[i.value.model])||null}),J=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),te=f({enabled:!1,base_url:"https://api.deepseek.com/v1",api_key:"",model:"deepseek-v4-flash",max_tokens:4096,timeout:300,preset:"deepseek",model_profiles:{},context_utilization:75}),Z=f(!1),fe=f(!1),de=f(!1),K=f(!1),ue=f(!1),he=f(!1),ge=f({configured:null}),xe=f(!1),Ne=f([]),T=f(""),P=f(!1),V=f(!1),ce=f({configured:null}),F=f(!1),Y=f([]),re=f(""),z=f(!1),ee=f(!1),G=f({model:"auto",auto_model_allowlist:[]}),ve=j(()=>Y.value.map(U=>typeof U=="string"?U:U.name).filter(Boolean)),me=()=>{var pe,Ae,ut;const U=(ut=(Ae=(pe=t.value)==null?void 0:pe.openai_compatible)==null?void 0:Ae.preset_catalogue)==null?void 0:ut[te.value.preset];U&&(te.value.base_url=U.base_url),Te()},ye=j(()=>Ne.value||[]),Ie=j(()=>{const U=[...l,...ve.value.map(pe=>`compat:${pe}`),...ye.value.map(pe=>`ollama:${pe.name}`)];for(const pe of[G.value.model,...G.value.auto_model_allowlist||[]])pe&&pe!=="auto"&&!U.includes(pe)&&U.unshift(pe);return U}),Fe=U=>U==="codex-auto-review"?"codex-auto-review (Codex alias → gpt-5.6-luna)":U;async function Ve(){try{G.value={...G.value,...await H.get("/api/agents/model")}}catch{}}async function Be(){try{const U=await H.put("/api/agents/model",{model:G.value.model||null});G.value={...G.value,...U},De("Agent model policy saved")}catch(U){De(U.message||"Failed to save agent model policy","error")}}async function qe(U,pe){const Ae=new Set(G.value.auto_model_allowlist||[]);pe.target.checked?Ae.add(U):Ae.delete(U);try{const ut=await H.put("/api/agents/model",{auto_model_allowlist:[...Ae]});G.value={...G.value,...ut},De("Agent Auto allowlist saved")}catch(ut){De(ut.message||"Failed to save agent allowlist","error")}}function Je(U){const pe=U.hint_metadata||{},Ae=[];return pe.context_tokens&&Ae.push(`context ${Number(pe.context_tokens).toLocaleString()}`),pe.max_output_tokens&&Ae.push(`max output ${Number(pe.max_output_tokens).toLocaleString()}`),pe.structural_source&&Ae.push(`source ${pe.structural_source}`),Ae.join("; ")}async function it(U,pe){const Ae={...G.value.model_selection_hints||{}},ut=pe.trim();ut?Ae[U]=ut:delete Ae[U];try{const Xt=await H.put("/api/agents/model",{model_selection_hints:Ae});G.value={...G.value,...Xt},De("Model hint saved")}catch(Xt){De(Xt.message||"Failed to save model hint","error")}}function We(U,pe){const Ae=(G.value.auto_model_allowlist||[]).indexOf(U);return Ae>=0&&Ae+pe>=0&&Ae+pe<G.value.auto_model_allowlist.length}async function X(U,pe){const Ae=[...G.value.auto_model_allowlist||[]],ut=Ae.indexOf(U);if(!(ut<0||!We(U,pe))){[Ae[ut],Ae[ut+pe]]=[Ae[ut+pe],Ae[ut]];try{const Xt=await H.put("/api/agents/model",{auto_model_allowlist:Ae});G.value={...G.value,...Xt},De("Agent Auto allowlist order saved")}catch(Xt){De(Xt.message||"Failed to reorder agent allowlist","error")}}}const we=f(!0),Ce=f(""),Oe=f({configured:null,accounts:[]}),ae=f(null),Re=f(null),Me=f(""),st=f(null),Vt=f(!1),lt=f(null),Ct=f(null),$t=f("");let qt=null;function De(U,pe="success"){ke(U,pe==="error"?"error":"success")}function ia(U){if(!U)return"?";const pe=U/(1024*1024*1024);return pe>=1?pe.toFixed(1)+" GB":(U/(1024*1024)).toFixed(0)+" MB"}function mn(U){return Number.isFinite(Number(U))?Number(U).toLocaleString():"—"}function xa(U){return U==null?"automatic (model-derived)":Number(U).toLocaleString()+" characters"}function Js(U){const pe=new Date(U);return Number.isNaN(pe.getTime())?"unknown":pe.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function hn(U){return typeof U=="string"&&U.length>12?U.slice(0,8)+"…"+U.slice(-4):U}function Fs(U){return typeof U!="number"||!Number.isFinite(U)?"—":(U/1e3).toFixed(2)}function vn(U){return U==="temporary learned clamp"?"is-clamp":U==="override"?"is-override":"is-built-in"}function Zs(U){const pe=i.value.context_budget_overrides[U.model];return U.floor!=null&&Number.isFinite(Number(pe))&&Number(pe)>U.floor}function ct(U,pe){const Ae={...i.value.context_budget_overrides};pe.target.value===""?delete Ae[U]:Ae[U]=Number(pe.target.value),i.value.context_budget_overrides=Ae,O.value=!0}function $s(U){i.value.context_utilization=U.target.value===""?"":Number(U.target.value),O.value=!0}function Ja(U){const pe={...i.value.context_budget_overrides};delete pe[U],i.value.context_budget_overrides=pe,O.value=!0}async function ne(){e.value=!0,await Promise.all([_e(),Xe(),_a(),Ve(),dt(),He()]),e.value=!1}async function _e({preserveBasic:U=!1,preserveAdvanced:pe=!1}={}){var Ae,ut,Xt;try{const Le=await H.get("/api/llm/status");t.value=Le,s.value=!1,a.value.main=Le.main_model||Le.active_model||(Le.active_provider==="compat"?`compat:${((Ae=Le.openai_compatible)==null?void 0:Ae.model)||""}`:Le.active_provider==="ollama"?`ollama:${((ut=Le.ollama)==null?void 0:ut.model)||""}`:((Xt=Le.codex)==null?void 0:Xt.model)||"gpt-5.6-sol"),Le.codex&&!oa.pending()&&(U||(i.value.enabled=Le.codex.enabled,i.value.model=Le.codex.model||"gpt-5.6-sol",i.value.reasoning_effort=Le.codex.reasoning_effort||"medium",i.value.agent_reasoning_effort=Le.codex.agent_reasoning_effort||""),pe||(i.value.request_timeout_seconds=Le.codex.request_timeout_seconds??i.value.request_timeout_seconds,i.value.stream_stall_timeout_seconds=Le.codex.stream_stall_timeout_seconds??i.value.stream_stall_timeout_seconds,i.value.retry={...i.value.retry,...Le.codex.retry||{}},i.value.connection_pool={...i.value.connection_pool,...Le.codex.connection_pool||{}},i.value.context_compression={...i.value.context_compression,...Le.codex.context_compression||{}},!O.value&&!de.value&&(i.value.context_budget_overrides={...Le.codex.context_budget_overrides||{}},i.value.context_utilization=Le.codex.context_utilization??i.value.context_utilization))),Le.ollama&&!Ys.pending()&&(U||(J.value.enabled=Le.ollama.enabled,J.value.base_url=Le.ollama.base_url||"",J.value.model=Le.ollama.model||"",J.value.max_tokens=Le.ollama.max_tokens||4096),pe||(J.value.timeout=Le.ollama.timeout??J.value.timeout));const Is=Le.openai_compatible;Is&&!Te.pending()&&(U||(te.value.enabled=Is.enabled,te.value.base_url=Is.base_url||te.value.base_url,te.value.model=Is.model||te.value.model,te.value.max_tokens=Is.max_tokens||4096,te.value.preset=Is.preset||te.value.preset),pe||(te.value.timeout=Is.timeout??te.value.timeout,te.value.model_profiles=Is.model_profiles||te.value.model_profiles,te.value.context_utilization=Is.context_utilization??te.value.context_utilization)),Le.auxiliary&&(E.value=Le.auxiliary,Bs.pending()||(C.value.enabled=Le.auxiliary.enabled,C.value.model=Le.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},openai_compatible:{configured:null}}),s.value=!0}}async function He(){const U=++N;Q.value=!0,W.value="";try{const pe=await H.get("/api/context/windows");if(U!==N)return;M.value=pe,!de.value&&!O.value&&(i.value.context_budget_overrides=Object.fromEntries(Object.entries(pe.models||{}).filter(([,Ae])=>Ae.override!=null).map(([Ae,ut])=>[Ae,ut.override])),i.value.context_utilization=pe.utilization??i.value.context_utilization)}catch(pe){U===N&&(W.value=pe.message||"Failed to load context budgets")}finally{U===N&&(Q.value=!1)}}async function Xe(){try{if(ge.value=await H.get("/api/ollama/status"),xe.value=!1,ge.value.model&&(T.value=ge.value.model),ge.value.configured)try{const U=await H.get("/api/ollama/models");Ne.value=U.models||[]}catch{Ne.value=[]}else if(J.value.base_url)try{const U=await H.post("/api/ollama/probe-models",{base_url:J.value.base_url});Ne.value=U.models||[]}catch{Ne.value=[]}}catch{xe.value=!0}}async function dt(){we.value=!0,Ce.value="";try{Oe.value=await H.get("/api/codex/status")}catch(U){Ce.value=U.message||"Failed to fetch Codex status"}finally{we.value=!1}}async function bt(){try{try{await H.put("/api/llm/main-model",{model:a.value.main})}catch(U){if(!/404|not found/i.test(U.message||""))throw U;await H.post("/api/llm/switch",{model:a.value.main})}De("Main model saved"),await ne()}catch(U){De(U.message||"Failed to save main model","error"),await _e()}}async function Za(U){a.value.main_capability=U;const pe=d.value;pe&&(pe.capability==="reasoning"?(i.value.reasoning_effort=U,await Rt()):pe.capability==="thinking"&&(await H.put("/api/openai-compatible/config",{thinking_mode:U}),De("Thinking mode saved")))}async function Us(U){a.value.agent_capability=U;const pe=u.value;(pe==null?void 0:pe.capability)==="reasoning"?(i.value.agent_reasoning_effort=U,await Rt()):(pe==null?void 0:pe.capability)==="thinking"&&(await H.put("/api/agents/model",{...G.value,thinking_mode:U}),De("Agent thinking mode saved"))}async function Mi(){P.value=!0;try{const U=await H.post("/api/ollama/reload");De(U.configured?"Ollama reloaded":U.reason||"Ollama not configured",U.configured?"success":"error"),await ne()}catch(U){De(U.message||"Reload failed","error")}finally{P.value=!1}}async function Vn(){V.value=!0;try{await H.post("/api/ollama/model",{model:T.value}),De("Model set to "+T.value),await ne()}catch(U){De(U.message||"Failed","error")}finally{V.value=!1}}async function gn(){const U=J.value.base_url;if(!U){De("Enter a base URL first","error");return}he.value=!0;try{const pe=await H.post("/api/ollama/probe-models",{base_url:U});Ne.value=pe.models||[],Ne.value.length?(De(Ne.value.length+" model(s) found"),!J.value.model&&Ne.value.length&&(J.value.model=Ne.value[0].name)):De("No models found at "+U,"error")}catch(pe){De(pe.message||"Could not reach Ollama","error")}finally{he.value=!1}}async function _a(){try{if(ce.value=await H.get("/api/openai-compatible/status"),F.value=!1,ce.value.model&&(re.value=ce.value.model),ce.value.configured)try{const U=await H.get("/api/openai-compatible/models");Y.value=U.models||[]}catch{Y.value=[]}}catch{F.value=!0}}async function wa(){z.value=!0;try{const U=await H.post("/api/openai-compatible/reload");De(U.configured?"OpenAI-compatible reloaded":U.reason||"OpenAI-compatible not configured",U.configured?"success":"error"),await ne()}catch(U){De(U.message||"Reload failed","error")}finally{z.value=!1}}async function Ya(){ee.value=!0;try{await H.post("/api/openai-compatible/model",{model:re.value}),De("Model set to "+re.value),await ne()}catch(U){De(U.message||"Failed","error")}finally{ee.value=!1}}async function Rt(){if(de.value){oa();return}de.value=!0;const U=$p(i.value);try{await H.put("/api/llm/codex/config",U),De("Codex config saved"),await Promise.all([_e({preserveBasic:!0,preserveAdvanced:!0}),dt()])}catch(pe){De(pe.message||"Failed","error");const Ae=JSON.stringify($p(i.value))!==JSON.stringify(U);await Promise.all([_e({preserveBasic:Ae,preserveAdvanced:!0}),dt()])}finally{de.value=!1}}async function la(){if(de.value)return;de.value=!0;const U=Up(i.value);try{await H.put("/api/llm/codex/config",U),JSON.stringify({context_budget_overrides:i.value.context_budget_overrides,context_utilization:i.value.context_utilization})===JSON.stringify({context_budget_overrides:U.context_budget_overrides,context_utilization:U.context_utilization})&&(O.value=!1),De("Codex advanced settings saved"),await Promise.all([_e({preserveBasic:!0,preserveAdvanced:!0}),dt(),He()])}catch(pe){De(pe.message||"Failed","error");const Ae=JSON.stringify(Up(i.value))!==JSON.stringify(U);await Promise.all([_e({preserveBasic:!0,preserveAdvanced:Ae}),dt(),He()])}finally{de.value=!1}}async function ls(){if(K.value){Ys();return}K.value=!0;try{const U=Z.value?J.value.api_key:null,pe=qS(J.value,{includeApiKey:U!==null});await H.put("/api/llm/ollama/config",pe),De("Ollama config saved"),U!==null&&J.value.api_key===U&&(J.value.api_key="",Z.value=!1),await Promise.all([_e({preserveBasic:!0,preserveAdvanced:!0}),Xe()])}catch(U){De(U.message||"Failed","error")}finally{K.value=!1}}async function bn(){if(!K.value){K.value=!0;try{await H.put("/api/llm/ollama/config",GS(J.value)),De("Ollama timeout saved"),await Promise.all([_e({preserveBasic:!0,preserveAdvanced:!0}),Xe()])}catch(U){De(U.message||"Failed","error")}finally{K.value=!1}}}async function Qa(){if(ue.value){Te();return}ue.value=!0;try{const U=fe.value?te.value.api_key:null,pe=jS(te.value,{includeApiKey:U!==null});await H.put("/api/openai-compatible/config",pe),De("OpenAI-compatible config saved"),U!==null&&te.value.api_key===U&&(te.value.api_key="",fe.value=!1),await Promise.all([_e({preserveBasic:!0,preserveAdvanced:!0}),_a()])}catch(U){De(U.message||"Failed","error")}finally{ue.value=!1}}async function qn(){if(!ue.value){ue.value=!0;try{await H.put("/api/openai-compatible/config",VS(te.value)),De("OpenAI-compatible endpoint settings saved"),await Promise.all([_e({preserveBasic:!0,preserveAdvanced:!0}),_a()])}catch(U){De(U.message||"Failed","error")}finally{ue.value=!1}}}async function Gn(){if($.value){Bs();return}$.value=!0;try{await H.put("/api/llm/auxiliary/config",C.value),De("Auxiliary config saved"),await _e()}catch(U){De(U.message||"Failed","error"),await _e()}finally{$.value=!1}}const oa=io(Rt),Bs=io(Gn),Ys=io(ls),Te=io(Qa),L=()=>(oa.cancel(),Rt()),oe=()=>(Ys.cancel(),ls()),be=()=>(Te.cancel(),Qa()),Pe=()=>la(),Ue=()=>bn(),je=()=>qn();async function At(U){const pe=U.account_key+":"+U.model;D.value=pe;try{const Ae=await H.post("/api/context/windows/clear",{account_key:U.account_key,model:U.model});De(Ae.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await He()}catch(Ae){De(Ae.message||"Failed to clear clamp","error"),await He()}finally{D.value=null}}async function mt(U){try{await H.post("/api/codex/account/"+U+"/activate"),De("Active account switched"),await dt()}catch(pe){De(pe.message||"Failed","error")}}async function wt(U){ae.value=U;try{await H.post("/api/codex/account/"+U+"/refresh"),De("Token refreshed"),await dt()}catch(pe){De(pe.message||"Refresh failed","error")}finally{ae.value=null}}function hs(U,pe){Re.value=U,Me.value=pe||""}async function It(U){try{await H.put("/api/codex/account/"+U+"/label",{label:Me.value}),De("Label updated"),Re.value=null,await dt()}catch(pe){De(pe.message||"Failed","error")}}async function ka(U,pe){if(await Qt({title:"Delete Codex account",message:`Delete ${pe||"account #"+(U+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/codex/account/"+U),De("Deleted. Pool reloaded."),await dt()}catch(ut){De(ut.message||"Failed","error")}}async function Wn(){Vt.value=!0;try{const U=await H.post("/api/codex/device-code");lt.value=U,st.value="pending",Tr(U)}catch(U){De(U.message||"Failed","error")}finally{Vt.value=!1}}async function Tr(U){qt={cancelled:!1};const pe=qt;try{const Ae=await H.post("/api/codex/device-poll",{device_auth_id:U.device_auth_id,user_code:U.user_code,interval:U.interval});if(pe.cancelled)return;Ct.value=Ae,st.value="success",await ne()}catch(Ae){if(pe.cancelled)return;$t.value=Ae.message||"Device login failed",st.value="error"}}function Sa(){qt&&(qt.cancelled=!0),st.value=null,lt.value=null}return Ye(ne),gt(()=>{qt&&(qt.cancelled=!0),oa.cancel(),Bs.cancel(),Ys.cancel(),Te.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,modelSelection:a,reasoningEfforts:n,modelCatalog:o,modelGroups:r,selectedMainModel:d,selectedAgentModel:u,modelOptionLabel:p,advancedOpen:S,codexForm:i,codexModelOptions:m,codexAgentModelOptions:h,mainEffortAllowed:y,agentEffortAllowed:v,mainModelOptionDisabled:x,agentModelOptionDisabled:w,auxForm:C,auxData:E,auxModelOptions:_,onAuxModelChange:R,savingAux:$,saveAuxConfigDebounced:Bs,ollamaForm:J,compatibleForm:te,savingCodex:de,savingOllama:K,savingCompatible:ue,probingOllama:he,ollamaKeyDirty:Z,compatibleKeyDirty:fe,fetchCodexStatus:dt,ollamaStatus:ge,ollamaStatusLoadFailed:xe,ollamaModels:Ne,ollamaSelectedModel:T,reloading:P,settingModel:V,compatibleStatus:ce,compatibleStatusLoadFailed:F,compatibleModels:Y,compatibleSelectedModel:re,reloadingCompatible:z,settingCompatibleModel:ee,applyCompatiblePreset:me,agentsConfig:G,compatibleAgentModels:ve,ollamaAgentModels:ye,knownAgentModelRefs:Ie,agentModelLabel:Fe,saveAgentsModel:Be,toggleAgentAutoAllowlist:qe,autoAllowlistGroups:c,structuralFacts:Je,saveModelHint:it,canMoveAllowlist:We,moveAgentAutoAllowlist:X,codexLoading:we,codexError:Ce,codexData:Oe,refreshing:ae,editingLabel:Re,labelValue:Me,contextWindows:M,contextWindowsLoading:Q,contextWindowsError:W,contextBudgetRows:ie,activeClampRows:le,activeContextBudget:B,clearingClamp:D,contextPolicyDirty:O,deviceState:st,deviceLoading:Vt,deviceInfo:lt,deviceResult:Ct,deviceError:$t,fetchAll:ne,fetchLLMStatus:_e,fetchOllamaStatus:Xe,fetchCompatibleStatus:_a,saveMainModel:bt,saveMainCapability:Za,saveAgentCapability:Us,reloadOllama:Mi,setOllamaModel:Vn,reloadCompatible:wa,setCompatibleModel:Ya,probeOllamaModels:gn,saveCodexConfig:Rt,saveOllamaConfig:ls,saveCompatibleConfig:Qa,saveCodexAdvancedConfig:la,saveOllamaAdvancedConfig:bn,saveCompatibleAdvancedConfig:qn,saveCodexConfigDebounced:oa,saveOllamaConfigDebounced:Ys,saveCompatibleConfigDebounced:Te,saveCodexConfigNow:L,saveOllamaConfigNow:oe,saveCompatibleConfigNow:be,saveCodexAdvancedConfigNow:Pe,saveOllamaAdvancedConfigNow:Ue,saveCompatibleAdvancedConfigNow:je,activateAccount:mt,refreshAccount:wt,startEditLabel:hs,saveLabel:It,deleteAccount:ka,startDeviceLogin:Wn,cancelDeviceLogin:Sa,formatSize:ia,fetchContextWindows:He,clearContextClamp:At,setContextOverride:ct,setContextUtilization:$s,resetContextOverride:Ja,overrideAboveFloor:Zs,formatCount:mn,formatContextCeiling:xa,formatExpiry:Js,shortAccountKey:hn,provenanceClass:vn,formatDensity:Fs}}},Bp={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function KS(e){return Bp[e]||Bp[(e||"").toLowerCase()]||"text-gray-400"}const JS={template:`
  ...
  `,setup(){const e=f(!0),t=f({}),s=f([]),a=f({}),n=f({}),i=f(null),l=f(null),o=f(null),r=f(null),c=f(null),d=j(()=>{var w;return Object.values(((w=i.value)==null?void 0:w.totals)||{}).reduce((C,E)=>C+Number(E||0),0)}),u=f(""),p=f(0),m=f([]),h=j(()=>m.value.map(w=>`${w.label} (${w.path}${w.reason?`: ${w.reason}`:""})`).join("; ")),g=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let A=null;async function I(){var R;const w=await Promise.allSettled(g.map($=>H.get($.path))),C=$=>w[$].status==="fulfilled"?w[$].value:null;t.value=C(0)||{};const E=C(1);s.value=Array.isArray(E)?E:E&&E.subsystems||[],a.value=C(2)||{},n.value=C(3)||{},i.value=C(4),l.value=C(5),o.value=C(6),r.value=C(7),c.value=C(8);const _=w.filter($=>$.status==="rejected");if(m.value=w.flatMap(($,S)=>{var M;return $.status==="rejected"?[{...g[S],reason:((M=$.reason)==null?void 0:M.message)||"request failed"}]:[]}),p.value=m.value.length,_.length===w.length){const $=(R=_[0])==null?void 0:R.reason;u.value=($==null?void 0:$.message)||"Failed to load internals"}else u.value="";e.value=!1}function y(){e.value=!0,u.value="",I()}let v=!1;function b(){v||(v=!0,I(),A||(A=setInterval(I,3e4)))}function x(){v&&(v=!1,A&&(clearInterval(A),A=null))}return Ye(b),is(b),Jt(x),gt(x),{loading:e,error:u,failedCount:p,failedEndpoints:m,failedEndpointSummary:h,endpoints:g,retry:y,startup:t,subsystems:s,sshPool:a,httpPool:n,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:o,freshnessStats:r,governorStats:c,statusColor:KS,formatAgeSeconds:fk}}},ZS=1e4,Hp=3e4;function ji(e,t){return Math.max(0,e-t)}function Zr(e,t){return new Set((e.operations||[]).map(a=>a.state)).has("MANUAL_RESOLUTION_REQUIRED")?0:e.expired_lease||e.status==="ACTIVE"&&(!e.lease_expires_at||e.lease_expires_at<t)?1:e.status==="SUSPENDED"?2:e.status==="ACTIVE"?3:4}const YS=[{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],QS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(null),t=f(""),s=f(null),a=f(!1),n=f(0),i=f(null),l=f(""),o=f(null),r=f(!1),c=f(0),d=f(Date.now());let u=null,p=0,m=0;async function h(){const O=++p;a.value=!0;try{const N=await H.get("/api/turn-state/turns?limit=100");if(O!==p)return;t.value=N.availability,e.value=N.availability==="available"?N.data:null,s.value=null,n.value=Date.now()}catch(N){if(O!==p)return;s.value=N.message||"Turn-state read failed",N.status===503&&(t.value="unavailable")}O===p&&(a.value=!1)}async function g(){const O=++m;r.value=!0;try{const N=await H.get("/api/turn-state/capacity-breakers");if(O!==m)return;l.value=N.availability,i.value=N.availability==="available"?N.data:null,o.value=null,c.value=Date.now()}catch(N){if(O!==m)return;o.value=N.message||"Breaker read failed",N.status===503&&(l.value="unavailable")}O===m&&(r.value=!1)}function A(){h(),g()}const I=j(()=>e.value!==null&&ji(d.value,n.value)>Hp),y=j(()=>i.value!==null&&ji(d.value,c.value)>Hp),v=j(()=>I.value||y.value),b=j(()=>Math.round(ji(d.value,n.value)/1e3)),x=j(()=>Math.round(ji(d.value,c.value)/1e3));function w(O){return Zr(O,d.value/1e3)}function C(O){return YS[w(O)]}const E=j(()=>{var ie;const O=[...((ie=e.value)==null?void 0:ie.turns)||[]],N=d.value/1e3;return O.sort((le,B)=>Zr(le,N)-Zr(B,N)||(B.last_progress_at||0)-(le.last_progress_at||0))});function _(O){return O.state==="closed"?"badge-success":O.state==="probing"?"badge-warning":"badge-danger"}function R(O){if(O.state==="closed")return"—";const N=ji(d.value,c.value)/1e3,ie=Math.max(0,(O.cooldown_remaining_seconds||0)-N);return ie>0?`${Math.ceil(ie)}s`:O.state==="probing"?"probe in flight":"probe eligible"}function $(O){if(!O)return"";const N=Math.max(0,Math.round(d.value/1e3-O));if(N<90)return`${N}s ago`;const ie=Math.round(N/60);return ie<90?`${ie}m ago`:`${Math.round(ie/60)}h ago`}let S=null,M=null,Q=!1;function W(){Q||(Q=!0,A(),S=setInterval(A,ZS),u=setInterval(()=>{d.value=Date.now()},1e3),M=nt.onReconnected(A))}function D(){Q&&(Q=!1,S&&(clearInterval(S),S=null),u&&(clearInterval(u),u=null),M&&(M(),M=null))}return Ye(W),is(W),Jt(D),gt(D),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:a,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:I,breakersStale:y,anyStale:v,turnsAgeSeconds:b,breakersAgeSeconds:x,sortedTurns:E,priorityOf:w,priorityBadge:C,breakerBadge:_,cooldownLabel:R,ageLabel:$,fetchTurns:h,fetchBreakers:g,refreshAll:A,arm:W,disarm:D}}},XS={setup(){const e=f(""),t=f(""),s=f(!1),a=f(""),n=f(!1),i=f(!1),l=f(!1),o=f(null),r=f(!1);async function c(){n.value=!0,o.value=null,r.value=!1;try{const u=await H.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,a.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{n.value=!1}}async function d(){if(await Qt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await H.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return Ye(c),{current:e,latest:t,updateAvailable:s,changelog:a,checking:n,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},zp=e=>JSON.parse(JSON.stringify(e)),e1=(e,t)=>JSON.stringify(e)===JSON.stringify(t),t1={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=f([]),a=f({}),n=f({}),i=f(!1),l=f(!1),o=f(!1),r=f(!1),c=f(!1),d=f(""),u=f("");let p=!1,m=0,h=null;const g=(D,O)=>p&&m===D&&H.token===O,A=D=>"computer-provisioning-"+D.key,I=D=>D===null?"Unset":D===""?"Empty":JSON.stringify(D),y=D=>{const O=n.value[D.key];return D.type==="array"?String(O||"").split(/\r?\n/).map(N=>N.trim()).filter(Boolean):["integer","number"].includes(D.type)?O===""||O==null?null:Number(O):O},v=j(()=>s.value.map(D=>({...D,value:y(D)})).filter(D=>!e1(D.value,a.value[D.key]))),b=j(()=>s.value.filter(D=>D.pending_restart).map(D=>D.label)),x=j(()=>s.value.some(D=>D.apply_state==="unknown")),w=j(()=>{const D={};for(const O of s.value){const N=y(O),ie=O.constraints||{};["integer","number"].includes(O.type)&&(N===null&&!O.nullable?D[O.key]="A number is required.":N!==null&&(!Number.isFinite(N)||O.type==="integer"&&!Number.isInteger(N)||ie.minimum!=null&&N<ie.minimum||ie.maximum!=null&&N>ie.maximum)&&(D[O.key]="Enter a number within the allowed range.")),O.key==="monitor_names"&&(N.length>16||new Set(N).size!==N.length||N.some(le=>!/^[A-Za-z0-9_.-]{1,64}$/.test(le)))&&(D[O.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return D}),C=j(()=>Object.keys(w.value).length>0);function E(D,O){n.value[D.key]=O,u.value=""}function _(){n.value=Object.fromEntries(s.value.map(D=>[D.key,D.type==="array"?a.value[D.key].join(`
`):a.value[D.key]])),r.value=!1}async function R(D,O){const[N,ie]=await Promise.all([H.get("/api/config"),H.get("/api/config/meta")]);if(!g(D,O))return!1;const le=(ie.fields||[]).filter(B=>/^computer\.[^.]+$/.test(B.path)&&B.path!=="computer.enabled"&&B.sensitivity==="public"&&B.apply_mode==="restart");if(!N.computer||!le.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=le.map(B=>({...B,key:B.path.split(".")[1]})),a.value=Object.fromEntries(s.value.map(B=>[B.key,zp(N.computer[B.key])])),_(),h=O,i.value=!0,c.value=!1,!0}async function $(){if(!p||l.value||o.value)return;const D=++m,O=H.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await R(D,O)}catch(N){g(D,O)&&(c.value=!0,d.value=N.message||"Could not load provisioning. No changes were sent.")}finally{g(D,O)&&(l.value=!1)}}function S(){i.value&&!l.value&&!o.value&&!c.value&&v.value.length&&!C.value&&(r.value=!0)}async function M(){if(!p||!i.value||!r.value||o.value||l.value||c.value||C.value||!v.value.length)return;if(h!==H.token){W(),Q();return}const D={computer:Object.fromEntries(v.value.map(le=>[le.key,zp(le.value)]))},O=m,N=H.token;o.value=!0,d.value="",u.value="";let ie=!1;try{if(await H.put("/api/config",D),ie=!0,!g(O,N))return;await R(O,N)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(le){g(O,N)&&(c.value=!0,r.value=!1,d.value=ie?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${le.status===400?": "+le.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{g(O,N)&&(o.value=!1)}}function Q(){p||(p=!0,$())}function W(){p=!1,m++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,h=null,s.value=[],a.value={},n.value={},d.value="",u.value=""}return Ye(Q),is(Q),Jt(W),gt(W),{fields:s,original:a,draft:n,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:b,effectiveUnknown:x,changes:v,validation:w,invalid:C,fieldId:A,format:I,edit:E,discard:_,load:$,openReview:S,save:M}}},s1={components:{ComputerProvisioning:t1},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),a=f(!1),n=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(0),p=f(""),m=f(""),h=f(null),g=f(""),A=f(!1),I=f(Date.now()),y=f(""),v=f(null);let b=0,x=null,w=!1,C=H.token,E=0,_=null,R=null,$=!1;const S=z=>z===!0?"Enabled":z===!1?"Disabled":"Unknown",M=j(()=>{var z;return((z=e.value.backend)==null?void 0:z.environment)==="existing_session"}),Q=j(()=>{var ee;const z=Date.parse(((ee=e.value.accessibility)==null?void 0:ee.checked_at)||"");return c.value&&Number.isFinite(z)&&I.value-z<15e3&&I.value>=z-5e3}),W=j(()=>{var z;return Q.value?S((z=e.value.accessibility)==null?void 0:z.enabled):"Unknown / not current"}),D=j(()=>{var z;return Q.value?((z=e.value.accessibility)==null?void 0:z.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),O=j(()=>Object.entries(e.value.input_limits||{}).filter(([,z])=>typeof z=="number"&&Number.isFinite(z)).map(([z,ee])=>`${z}: ${ee}`).join(", ")),N=j(()=>{var ee;const z=(ee=e.value.application_provenance)==null?void 0:ee.script_identity;return typeof z=="string"?z:!z||typeof z!="object"?"Not observed":`${z.interpreter_basename||"Unknown interpreter"}; argv digest ${z.argv_digest||"not recorded"}; ${z.verified===!0?"verified":"not verified"}`}),ie=j(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(z=>z&&typeof z.id=="string"&&typeof z.label=="string"&&["supported","capture_only"].includes(z.input)).slice(0,16):[]),le=j(()=>{const z=e.value.restart_required;return Array.isArray(z)?z.length?z.join(", "):"None reported":z===!0?"Pending; restart required":z===!1?"None reported":"Unknown"}),B=j(()=>{var ee,G;const z=Date.parse(((ee=h.value)==null?void 0:ee.captured_at)||"");return Number.isFinite(z)&&I.value<z+Math.min(1e4,((G=h.value)==null?void 0:G.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function J(){g.value&&URL.revokeObjectURL(g.value),g.value="",h.value=null}function te(){b++,J(),v.value=null,c.value=!1,_==null||_.abort(),_=null,t.value=!1,m.value="",s.value=!1,i.value=!1,l.value=!1}function Z(z,ee){return w&&z===b&&ee===H.token}function fe(){return w&&c.value&&R===H.token&&Date.now()-u.value<15e3}function de(z,ee="mutation"){var ve,me;te(),$=!0,p.value="";const G=z.status||(z.name==="AuthError"?401:0);[401,403,404].includes(G)?(u.value=0,R=null,e.value={available:!1,state:"unknown"}):u.value||(e.value={available:!1,state:G===503?"unavailable":"unknown"}),o.value=G===401||G===403||G===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":G===410?"Evidence or artifact expired. Observe or prepare the export again.":ee==="read"?"Status refresh failed. Last-known details are not current. No mutation was requested by this read.":ee==="acknowledged"?"The mutation was acknowledged, but status refresh failed. Refresh status independently; do not replay the change.":"Request failed; outcome unknown. Refresh status. No action was replayed.",ee==="mutation"&&![401,403,404].includes(G)&&typeof((ve=z.data)==null?void 0:ve.code)=="string"&&/^[a-z_]{1,64}$/.test(z.data.code)&&typeof((me=z.data)==null?void 0:me.error)=="string"&&(o.value=z.data.error.slice(0,512),z.data.outcome==="not_applied"&&z.data.next_action==="repair_provisioning"&&typeof z.data.remedy=="string"&&(o.value="Not applied (preflight rejection). "+o.value,p.value=z.data.remedy.slice(0,1024)))}async function K(){if(t.value||r.value||a.value||n.value||d.value||!w)return;const z=b,ee=H.token;t.value=!0,E=Date.now();const G=new AbortController;_=G;try{const ve=await H.get("/api/computer",{signal:G.signal});if(!Z(z,ee))return;ue(ve)}catch(ve){Z(z,ee)&&de(ve,"read")}finally{_===G&&(_=null,t.value=!1)}}function ue(z,ee=""){if(!z||typeof z!="object"||typeof z.state!="string"||typeof z.available!="boolean")throw new Error("Invalid status");(e.value.session_id&&e.value.session_id!==z.session_id||e.value.generation!=null&&e.value.generation!==z.generation||e.value.session_generation!=null&&e.value.session_generation!==z.session_generation)&&te(),e.value=z,u.value=Date.now(),R=H.token,c.value=!(r.value&&ee!=="toggle")&&!(a.value&&ee!=="stop")&&!(n.value&&ee!=="pause")&&!(d.value&&ee!=="recovery"),o.value="",p.value="",$=!c.value}async function he(z){if(!fe()||r.value||a.value||n.value||d.value)return;te();const ee=b,G=H.token;r.value=!0;let ve=!1;try{if(await H.post("/api/computer/enabled",{enabled:z}),ve=!0,!Z(ee,G))return;const me=await H.get("/api/computer");Z(ee,G)&&ue(me,"toggle")}catch(me){Z(ee,G)&&de(me,ve?"acknowledged":"mutation")}finally{r.value=!1}}async function ge(z){if(!w||!["pause","stop"].includes(z)||(z==="stop"?a.value:n.value))return;te();const ee=b,G=H.token,ve=z==="stop"?a:n;ve.value=!0;let me=!1;try{if(await H.post("/api/computer/"+z,{}),me=!0,Z(ee,G)){const ye=await H.get("/api/computer");Z(ee,G)&&ue(ye,z)}}catch(ye){Z(ee,G)&&de(ye,me?"acknowledged":"mutation")}finally{ve.value=!1}}async function xe(){var ve;if(!fe()||d.value||((ve=e.value.backend)==null?void 0:ve.native_backend)!=="hyprland")return;const z={session_id:e.value.session_id,generation:e.value.session_generation};if(!z.session_id||!Number.isInteger(z.generation))return;te();const ee=b,G=H.token;d.value=!0;try{const me=await H.post("/api/computer/release_owned_input",z);Z(ee,G)&&ue(me,"recovery")}catch(me){Z(ee,G)&&de(me,"mutation")}finally{d.value=!1}}async function Ne(){return P(!1)}async function T(){return P(!0)}async function P(z){var Ie;if(!fe()||d.value||r.value||a.value||n.value||e.value.state!=="quarantined")return;const ee={session_id:e.value.session_id,generation:e.value.session_generation};if(!ee.session_id||!Number.isInteger(ee.generation))return;if(z){if(m.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+ee.session_id)return;ee.acknowledgment=m.value}const G=z?((Ie=e.value.recovery)==null?void 0:Ie.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";te();const ve=b,me=H.token;d.value=!0;let ye=!1;try{const Fe=await H.post("/api/computer/"+G,ee);ye=!0,Z(ve,me)&&ue(Fe,"recovery")}catch(Fe){Z(ve,me)&&de(Fe,ye?"acknowledged":"mutation")}finally{d.value=!1}}async function V(){var G;if(!fe()||s.value||!e.value.available)return;J(),A.value=!1;const z=b,ee=H.token;s.value=!0;try{const ve=await H.post("/api/computer/observe",{});if(!Z(z,ee))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((G=ve.frame)==null?void 0:G.evidence_id)||""))throw new Error("Invalid evidence");const me=await H.getBlob("/api/computer/evidence/"+ve.frame.evidence_id);if(!Z(z,ee))return;if(!["image/png","image/jpeg"].includes(me.type)||me.size>2097152||!Number.isFinite(Date.parse(ve.frame.expires_at))||Date.parse(ve.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");h.value=ve.frame,g.value=URL.createObjectURL(me),o.value=""}catch(ve){Z(z,ee)&&de(ve)}finally{z===b&&(s.value=!1)}}async function ce(){if(!fe()||i.value||!e.value.available)return;v.value=null;const z=b,ee=H.token;i.value=!0;try{const G=await H.post("/api/computer/export",{name:y.value});Z(z,ee)&&(v.value=G,o.value="")}catch(G){Z(z,ee)&&de(G)}finally{z===b&&(i.value=!1)}}async function F(){if(!fe()||l.value||!v.value)return;const z=b,ee=H.token,G=v.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((G==null?void 0:G.artifact_id)||""))throw new Error("Invalid export");const ve=await H.getBlob("/api/computer/download/"+G.artifact_id);if(!Z(z,ee))return;const me=URL.createObjectURL(ve),ye=document.createElement("a");ye.href=me,ye.download=G.name,ye.click(),setTimeout(()=>URL.revokeObjectURL(me),1e3)}catch(ve){Z(z,ee)&&de(ve)}finally{z===b&&(l.value=!1)}}function Y(){w||(C!==H.token&&(C=H.token,te(),u.value=0,R=null,e.value={state:"unknown",available:!1},o.value="",p.value=""),w=!0,K(),x=setInterval(()=>{I.value=Date.now(),C!==H.token&&(C=H.token,te(),u.value=0,R=null,o.value="",p.value="",e.value={state:"unknown",available:!1}),c.value&&I.value-u.value>=15e3&&te(),h.value&&Date.parse(h.value.expires_at)<=I.value&&(J(),A.value=!0),v.value&&Date.parse(v.value.expires_at)<=I.value&&(v.value=null),!$&&I.value-E>=5e3&&K()},500))}function re(){w=!1,clearInterval(x),x=null,te(),c.value=!1}return Ye(Y),is(Y),Jt(re),gt(re),{status:e,checkedAt:u,remedy:p,loading:t,observing:s,stopping:a,pausing:n,exporting:i,downloading:l,error:o,frame:h,frameUrl:g,frameExpired:A,freshness:B,name:y,artifact:v,refresh:K,control:ge,observe:V,clearFrame:J,exportFile:ce,download:F,toggling:r,adminReady:c,enabledLabel:S,restartSettings:le,setEnabled:he,recovering:d,recover:Ne,reconcile:T,releaseOwnedInput:xe,reconciliationAck:m,applicationProfiles:ie,attached:M,scriptIdentity:N,inputLimits:O,accessibilityLabel:W,accessibilityDetail:D}}},Dv=[{id:"health",label:"Health",component:oS},{id:"resources",label:"Resources",component:rS},{id:"logs",label:"Logs",component:xS},{id:"config",label:"Config",component:LS},{id:"discord",label:"Discord",component:DS},{id:"hosts",label:"Hosts",component:FS},{id:"host-access",label:"Host Access",component:PS},{id:"api-tokens",label:"API Tokens",component:$S},{id:"llm",label:"LLM Config",component:WS},{id:"internals",label:"Internals",component:JS},{id:"turn-state",label:"Turn State",component:QS},{id:"computer",label:"Computer",component:s1},{id:"update",label:"Update",component:XS}],a1={components:{TabbedPage:_r},setup(){return{tabs:Dv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},lo=(e,t,s,a)=>a.map(({id:n,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:n}}})),n1=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...lo("Operations","operations","/operations",Sv),...lo("History","history","/history",Tv),...lo("Capabilities","capabilities","/capabilities",Cv),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...lo("System","system","/system",Dv)],Ts=fn({open:!1,query:"",selected:0});function jp(){Ts.query="",Ts.selected=0,Ts.open=!0}function Yr(){Ts.open=!1}function i1(e,t){const s=e.label.toLowerCase(),a=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:a.startsWith(t)?80:s.includes(t)?60:a.includes(t)?40:0:1}const l1={setup(){const e=vv(),t=f(null),s=j(()=>{const i=Ts.query.trim().toLowerCase();return n1.map(l=>({...l,_score:i1(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});zt(()=>Ts.open,async i=>{var l;i&&(await Pt(),(l=t.value)==null||l.focus())}),zt(()=>Ts.query,()=>{Ts.selected=0});function a(i){Yr(),e.push(i.to)}function n(i){if(i.key==="Escape"){i.preventDefault(),Yr();return}if(i.key==="ArrowDown")i.preventDefault(),Ts.selected=Math.min(Ts.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Ts.selected=Math.max(Ts.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Ts.selected];l&&a(l)}}return{state:Ts,results:s,inputEl:t,go:a,onKeydown:n,closePalette:Yr}},template:`
    <transition name="modal">
  ...
  `},$c={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys($c));const o1={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>wi("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[wi("path",{d:$c[e.name]||$c.info})])}},r1=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function Vp(e){return[...e.querySelectorAll(r1)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const c1={mounted(e){const t=document.activeElement,s=a=>{if(a.key!=="Tab")return;const n=Vp(e);if(!n.length){a.preventDefault(),e.focus();return}const i=n[0],l=n[n.length-1];a.shiftKey&&document.activeElement===i?(a.preventDefault(),l.focus()):!a.shiftKey&&document.activeElement===l&&(a.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||Vp(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},d1={template:`
    ...
    </div>`,setup(){const e=f({}),t=f(!0),s=f(null),a=f([]),n=f(!1),i=f([]),l=f(!1),o=f(!1),r=f([]),c=f(0),d=f(null),u=f({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const m=j(()=>{const le=e.value.uptime_seconds||0,B=Math.floor(le/86400),J=Math.floor(le%86400/3600),te=Math.floor(le%3600/60),Z=[];return B>0&&Z.push(`${B}d`),J>0&&Z.push(`${J}h`),(Z.length===0||B===0&&J===0)&&Z.push(`${te}m`),Z.join(" ")}),h=j(()=>{const le=e.value.uptime_seconds||0;return 125.66*(1-Math.min(le/86400,1))}),g=j(()=>{const le=e.value;return[{label:"Guilds",value:le.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:le.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:le.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${le.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:le.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:le.loop_count>0?"text-green-400":"",highlight:le.loop_count>0},{label:"Agents",value:le.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:le.agent_count>0?`${le.agent_count} total`:"",subColor:"text-gray-500",highlight:(le.agent_running??0)>0},{label:"Processes",value:le.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:le.process_count>0?`${le.process_count} total`:"",subColor:"text-gray-500",highlight:(le.process_running??0)>0},{label:"Schedules",value:le.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(le.schedule_failing>0?`${le.schedule_failing} failing`:"")+(le.schedule_failing>0&&le.schedule_paused>0?", ":"")+(le.schedule_paused>0?`${le.schedule_paused} paused`:"")||void 0,subColor:le.schedule_failing>0?"text-red-400":"text-yellow-400",color:le.schedule_failing>0?"text-red-400":"",highlight:le.schedule_failing>0},{label:"Users",value:le.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),A=j(()=>{const le=e.value,B=[];return B.push({label:"Bot",status:le.status==="online"?"ok":"warn",detail:le.status==="online"?"Online":"Starting"}),(le.schedule_failing||0)>0?B.push({label:"Schedules",status:"error",detail:`${le.schedule_failing} failing`}):(le.schedule_count||0)>0&&B.push({label:"Schedules",status:"ok",detail:`${le.schedule_count} configured`}),(le.loop_count||0)>0&&B.push({label:"Loops",status:"ok",detail:`${le.loop_count} active`}),(le.agent_running||0)>0&&B.push({label:"Agents",status:"ok",detail:`${le.agent_running} running`}),(le.process_running||0)>0&&B.push({label:"Processes",status:"ok",detail:`${le.process_running} running`}),B});async function I(){try{e.value=await H.get("/api/status"),s.value=null}catch(le){s.value=le.message}finally{t.value=!1}}let y=0,v=0,b=0,x=0;function w(le,B){const J=new Set;return[...B,...le].filter(te=>{const Z=te._hmac||JSON.stringify([te.timestamp,te.tool_name,te.user_id,te.result_summary,te.error]);return J.has(Z)?!1:(J.add(Z),!0)})}async function C(){const le=++y,B=b;n.value=!0;try{const J=await H.get("/api/audit?limit=10");if(le!==y)return;const te=B===b?[]:a.value.filter(Z=>(Z._liveEpoch||0)>B);a.value=w(J,te).slice(0,10),c.value=te.length}catch{}le===y&&(n.value=!1)}async function E(){const le=++v,B=x;l.value=!0;try{const J=await H.get("/api/audit?error_only=1&limit=5");if(le!==v)return;const te=B===x?[]:i.value.filter(Z=>(Z._liveErrorEpoch||0)>B);i.value=w(J,te).slice(0,5),o.value=!1}catch{if(le!==v)return;o.value=B===x||i.value.length===0}le===v&&(l.value=!1)}async function _(){try{const le=await H.get("/api/knowledge");d.value=(Array.isArray(le)?le:[]).reduce((B,J)=>B+(J.chunks||0),0)}catch{d.value=null}}async function R(){try{const le=await H.get("/api/agents");r.value=le.filter(B=>B.status==="running")}catch{}}async function $(){u.value={...u.value,reload:!0};try{await H.post("/api/reload"),ke.success("Config reloaded")}catch(le){ke.error(le.message)}u.value={...u.value,reload:!1}}async function S(){if(!await Qt({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const B=e.value.session_count;e.value={...e.value,session_count:0};try{const J=await H.post("/api/sessions/clear-all");ke.success(`Cleared ${J.count} session${J.count!==1?"s":""}`),await I()}catch(J){e.value={...e.value,session_count:B},ke.error(J.message)}u.value={...u.value,clearSessions:!1}}async function M(){if(!await Qt({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const B=e.value.loop_count;e.value={...e.value,loop_count:0};try{const J=await H.post("/api/loops/stop-all");ke.success(J.result),await I()}catch(J){e.value={...e.value,loop_count:B},ke.error(J.message)}u.value={...u.value,stopLoops:!1}}function Q(){t.value=!0,s.value=null,I(),C(),E(),R()}let W=null,D=null,O=null;function N(le){if(le.payload&&le.payload.tool_name){b+=1;const B={...le.payload,_isNew:!0,_key:++p,_liveEpoch:b};a.value.unshift(B),a.value.length>10&&a.value.pop(),c.value++,B.error&&(x+=1,B._liveErrorEpoch=x,o.value=!1,i.value.unshift(B),i.value.length>5&&i.value.pop()),setTimeout(()=>{B._isNew=!1},1500),clearTimeout(O),O=setTimeout(()=>{c.value=0},1e4)}}let ie=null;return Ye(async()=>{await Promise.all([I(),C(),E(),R(),_()]),W=setInterval(I,15e3),D=setInterval(R,1e4),nt.subscribe("events",N),ie=nt.onReconnected(()=>{C(),E()})}),gt(()=>{W&&clearInterval(W),D&&clearInterval(D),clearTimeout(O),nt.unsubscribe("events",N),ie&&(ie(),ie=null)}),{status:e,loading:t,error:s,uptime:m,uptimeRingOffset:h,stats:g,healthIndicators:A,activity:a,activityLoading:n,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:C,fetchErrors:E,fetchStatus:I,onEvent:N,formatTime:pk,formatDuration:Oi,retry:Q,reloadConfig:$,clearSessions:S,stopAllLoops:M}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function qp(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,a=Array(t);s<t;s++)a[s]=e[s];return a}function u1(e){if(Array.isArray(e))return e}function p1(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var a,n,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(a=i.call(s)).done)&&(o.push(a.value),o.length!==t);r=!0);}catch(d){c=!0,n=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw n}}return o}}function f1(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function m1(e,t){return u1(e)||p1(e,t)||h1(e,t)||f1()}function h1(e,t){if(e){if(typeof e=="string")return qp(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?qp(e,t):void 0}}const Mv=Object.entries,Gp=Object.setPrototypeOf,v1=Object.isFrozen,g1=Object.getPrototypeOf,b1=Object.getOwnPropertyDescriptor;let ws=Object.freeze,Ks=Object.seal,li=Object.create,Pv=typeof Reflect<"u"&&Reflect,Uc=Pv.apply,Bc=Pv.construct;ws||(ws=function(t){return t});Ks||(Ks=function(t){return t});Uc||(Uc=function(t,s){for(var a=arguments.length,n=new Array(a>2?a-2:0),i=2;i<a;i++)n[i-2]=arguments[i];return t.apply(s,n)});Bc||(Bc=function(t){for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return new t(...a)});const Aa=jt(Array.prototype.forEach),y1=jt(Array.prototype.lastIndexOf),Wp=jt(Array.prototype.pop),ti=jt(Array.prototype.push),x1=jt(Array.prototype.splice),gs=Array.isArray,Yi=jt(String.prototype.toLowerCase),Qr=jt(String.prototype.toString),Kp=jt(String.prototype.match),si=jt(String.prototype.replace),Jp=jt(String.prototype.indexOf),_1=jt(String.prototype.trim),w1=jt(Number.prototype.toString),k1=jt(Boolean.prototype.toString),Zp=typeof BigInt>"u"?null:jt(BigInt.prototype.toString),Yp=typeof Symbol>"u"?null:jt(Symbol.prototype.toString),Lt=jt(Object.prototype.hasOwnProperty),Vi=jt(Object.prototype.toString),es=jt(RegExp.prototype.test),wn=S1(TypeError);function jt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return Uc(e,t,a)}}function S1(e){return function(){for(var t=arguments.length,s=new Array(t),a=0;a<t;a++)s[a]=arguments[a];return Bc(e,s)}}function Ze(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Yi;if(Gp&&Gp(e,null),!gs(t))return e;let a=t.length;for(;a--;){let n=t[a];if(typeof n=="string"){const i=s(n);i!==n&&(v1(t)||(t[a]=i),n=i)}e[n]=!0}return e}function T1(e){for(let t=0;t<e.length;t++)Lt(e,t)||(e[t]=null);return e}function cs(e){const t=li(null);for(const a of Mv(e)){var s=m1(a,2);const n=s[0],i=s[1];Lt(e,n)&&(gs(i)?t[n]=T1(i):i&&typeof i=="object"&&i.constructor===Object?t[n]=cs(i):t[n]=i)}return t}function C1(e){switch(typeof e){case"string":return e;case"number":return w1(e);case"boolean":return k1(e);case"bigint":return Zp?Zp(e):"0";case"symbol":return Yp?Yp(e):"Symbol()";case"undefined":return Vi(e);case"function":case"object":{if(e===null)return Vi(e);const t=e,s=ua(t,"toString");if(typeof s=="function"){const a=s(t);return typeof a=="string"?a:Vi(a)}return Vi(e)}default:return Vi(e)}}function ua(e,t){for(;e!==null;){const a=b1(e,t);if(a){if(a.get)return jt(a.get);if(typeof a.value=="function")return jt(a.value)}e=g1(e)}function s(){return null}return s}function E1(e){try{return es(e,""),!0}catch{return!1}}const Qp=ws(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Xr=ws(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),ec=ws(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),A1=ws(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),tc=ws(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),R1=ws(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Xp=ws(["#text"]),ef=ws(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),sc=ws(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),tf=ws(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),oo=ws(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),I1=Ks(/{{[\w\W]*|^[\w\W]*}}/g),O1=Ks(/<%[\w\W]*|^[\w\W]*%>/g),L1=Ks(/\${[\w\W]*/g),N1=Ks(/^data-[\-\w.\u00B7-\uFFFF]+$/),D1=Ks(/^aria-[\-\w]+$/),sf=Ks(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),M1=Ks(/^(?:\w+script|data):/i),P1=Ks(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),F1=Ks(/^html$/i),$1=Ks(/^[a-z][.\w]*(-[.\w]+)+$/i),ca={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},U1=function(){return typeof window>"u"?null:window},B1=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let a=null;const n="data-tt-policy-suffix";s&&s.hasAttribute(n)&&(a=s.getAttribute(n));const i="dompurify"+(a?"#"+a:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},af=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Fv(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:U1();const t=Te=>Fv(Te);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==ca.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const a=s,n=a.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,m=ua(p,"cloneNode"),h=ua(p,"remove"),g=ua(p,"nextSibling"),A=ua(p,"childNodes"),I=ua(p,"parentNode"),y=ua(p,"shadowRoot"),v=ua(p,"attributes"),b=l&&l.prototype?ua(l.prototype,"nodeType"):null,x=l&&l.prototype?ua(l.prototype,"nodeName"):null;if(typeof i=="function"){const Te=s.createElement("template");Te.content&&Te.content.ownerDocument&&(s=Te.content.ownerDocument)}let w,C="",E,_=!1,R=0;const $=function(){if(R>0)throw wn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},S=function(L){$(),R++;try{return w.createHTML(L)}finally{R--}},M=function(L){$(),R++;try{return w.createScriptURL(L)}finally{R--}},Q=function(){return _||(E=B1(u,n),_=!0),E},W=s,D=W.implementation,O=W.createNodeIterator,N=W.createDocumentFragment,ie=W.getElementsByTagName,le=a.importNode;let B=af();t.isSupported=typeof Mv=="function"&&typeof I=="function"&&D&&D.createHTMLDocument!==void 0;const J=I1,te=O1,Z=L1,fe=N1,de=D1,K=M1,ue=P1,he=$1;let ge=sf,xe=null;const Ne=Ze({},[...Qp,...Xr,...ec,...tc,...Xp]);let T=null;const P=Ze({},[...ef,...sc,...tf,...oo]);let V=Object.seal(li(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ce=null,F=null;const Y=Object.seal(li(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let re=!0,z=!0,ee=!1,G=!0,ve=!1,me=!0,ye=!1,Ie=!1,Fe=!1,Ve=!1,Be=!1,qe=!1,Je=!0,it=!1;const We="user-content-";let X=!0,we=!1,Ce={},Oe=null;const ae=Ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Re=null;const Me=Ze({},["audio","video","img","source","image","track"]);let st=null;const Vt=Ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),lt="http://www.w3.org/1998/Math/MathML",Ct="http://www.w3.org/2000/svg",$t="http://www.w3.org/1999/xhtml";let qt=$t,De=!1,ia=null;const mn=Ze({},[lt,Ct,$t],Qr);let xa=Ze({},["mi","mo","mn","ms","mtext"]),Js=Ze({},["annotation-xml"]);const hn=Ze({},["title","style","font","a","script"]);let Fs=null;const vn=["application/xhtml+xml","text/html"],Zs="text/html";let ct=null,$s=null;const Ja=s.createElement("form"),ne=function(L){return L instanceof RegExp||L instanceof Function},_e=function(){let L=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if($s&&$s===L)return;(!L||typeof L!="object")&&(L={}),L=cs(L),Fs=vn.indexOf(L.PARSER_MEDIA_TYPE)===-1?Zs:L.PARSER_MEDIA_TYPE,ct=Fs==="application/xhtml+xml"?Qr:Yi,xe=Lt(L,"ALLOWED_TAGS")&&gs(L.ALLOWED_TAGS)?Ze({},L.ALLOWED_TAGS,ct):Ne,T=Lt(L,"ALLOWED_ATTR")&&gs(L.ALLOWED_ATTR)?Ze({},L.ALLOWED_ATTR,ct):P,ia=Lt(L,"ALLOWED_NAMESPACES")&&gs(L.ALLOWED_NAMESPACES)?Ze({},L.ALLOWED_NAMESPACES,Qr):mn,st=Lt(L,"ADD_URI_SAFE_ATTR")&&gs(L.ADD_URI_SAFE_ATTR)?Ze(cs(Vt),L.ADD_URI_SAFE_ATTR,ct):Vt,Re=Lt(L,"ADD_DATA_URI_TAGS")&&gs(L.ADD_DATA_URI_TAGS)?Ze(cs(Me),L.ADD_DATA_URI_TAGS,ct):Me,Oe=Lt(L,"FORBID_CONTENTS")&&gs(L.FORBID_CONTENTS)?Ze({},L.FORBID_CONTENTS,ct):ae,ce=Lt(L,"FORBID_TAGS")&&gs(L.FORBID_TAGS)?Ze({},L.FORBID_TAGS,ct):cs({}),F=Lt(L,"FORBID_ATTR")&&gs(L.FORBID_ATTR)?Ze({},L.FORBID_ATTR,ct):cs({}),Ce=Lt(L,"USE_PROFILES")?L.USE_PROFILES&&typeof L.USE_PROFILES=="object"?cs(L.USE_PROFILES):L.USE_PROFILES:!1,re=L.ALLOW_ARIA_ATTR!==!1,z=L.ALLOW_DATA_ATTR!==!1,ee=L.ALLOW_UNKNOWN_PROTOCOLS||!1,G=L.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ve=L.SAFE_FOR_TEMPLATES||!1,me=L.SAFE_FOR_XML!==!1,ye=L.WHOLE_DOCUMENT||!1,Ve=L.RETURN_DOM||!1,Be=L.RETURN_DOM_FRAGMENT||!1,qe=L.RETURN_TRUSTED_TYPE||!1,Fe=L.FORCE_BODY||!1,Je=L.SANITIZE_DOM!==!1,it=L.SANITIZE_NAMED_PROPS||!1,X=L.KEEP_CONTENT!==!1,we=L.IN_PLACE||!1,ge=E1(L.ALLOWED_URI_REGEXP)?L.ALLOWED_URI_REGEXP:sf,qt=typeof L.NAMESPACE=="string"?L.NAMESPACE:$t,xa=Lt(L,"MATHML_TEXT_INTEGRATION_POINTS")&&L.MATHML_TEXT_INTEGRATION_POINTS&&typeof L.MATHML_TEXT_INTEGRATION_POINTS=="object"?cs(L.MATHML_TEXT_INTEGRATION_POINTS):Ze({},["mi","mo","mn","ms","mtext"]),Js=Lt(L,"HTML_INTEGRATION_POINTS")&&L.HTML_INTEGRATION_POINTS&&typeof L.HTML_INTEGRATION_POINTS=="object"?cs(L.HTML_INTEGRATION_POINTS):Ze({},["annotation-xml"]);const oe=Lt(L,"CUSTOM_ELEMENT_HANDLING")&&L.CUSTOM_ELEMENT_HANDLING&&typeof L.CUSTOM_ELEMENT_HANDLING=="object"?cs(L.CUSTOM_ELEMENT_HANDLING):li(null);if(V=li(null),Lt(oe,"tagNameCheck")&&ne(oe.tagNameCheck)&&(V.tagNameCheck=oe.tagNameCheck),Lt(oe,"attributeNameCheck")&&ne(oe.attributeNameCheck)&&(V.attributeNameCheck=oe.attributeNameCheck),Lt(oe,"allowCustomizedBuiltInElements")&&typeof oe.allowCustomizedBuiltInElements=="boolean"&&(V.allowCustomizedBuiltInElements=oe.allowCustomizedBuiltInElements),ve&&(z=!1),Be&&(Ve=!0),Ce&&(xe=Ze({},Xp),T=li(null),Ce.html===!0&&(Ze(xe,Qp),Ze(T,ef)),Ce.svg===!0&&(Ze(xe,Xr),Ze(T,sc),Ze(T,oo)),Ce.svgFilters===!0&&(Ze(xe,ec),Ze(T,sc),Ze(T,oo)),Ce.mathMl===!0&&(Ze(xe,tc),Ze(T,tf),Ze(T,oo))),Y.tagCheck=null,Y.attributeCheck=null,Lt(L,"ADD_TAGS")&&(typeof L.ADD_TAGS=="function"?Y.tagCheck=L.ADD_TAGS:gs(L.ADD_TAGS)&&(xe===Ne&&(xe=cs(xe)),Ze(xe,L.ADD_TAGS,ct))),Lt(L,"ADD_ATTR")&&(typeof L.ADD_ATTR=="function"?Y.attributeCheck=L.ADD_ATTR:gs(L.ADD_ATTR)&&(T===P&&(T=cs(T)),Ze(T,L.ADD_ATTR,ct))),Lt(L,"ADD_URI_SAFE_ATTR")&&gs(L.ADD_URI_SAFE_ATTR)&&Ze(st,L.ADD_URI_SAFE_ATTR,ct),Lt(L,"FORBID_CONTENTS")&&gs(L.FORBID_CONTENTS)&&(Oe===ae&&(Oe=cs(Oe)),Ze(Oe,L.FORBID_CONTENTS,ct)),Lt(L,"ADD_FORBID_CONTENTS")&&gs(L.ADD_FORBID_CONTENTS)&&(Oe===ae&&(Oe=cs(Oe)),Ze(Oe,L.ADD_FORBID_CONTENTS,ct)),X&&(xe["#text"]=!0),ye&&Ze(xe,["html","head","body"]),xe.table&&(Ze(xe,["tbody"]),delete ce.tbody),L.TRUSTED_TYPES_POLICY){if(typeof L.TRUSTED_TYPES_POLICY.createHTML!="function")throw wn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof L.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw wn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const be=w;w=L.TRUSTED_TYPES_POLICY;try{C=S("")}catch(Pe){throw w=be,Pe}}else L.TRUSTED_TYPES_POLICY===null?(w=void 0,C=""):(w===void 0&&(w=Q()),w&&typeof C=="string"&&(C=S("")));(B.uponSanitizeElement.length>0||B.uponSanitizeAttribute.length>0)&&xe===Ne&&(xe=cs(xe)),B.uponSanitizeAttribute.length>0&&T===P&&(T=cs(T)),ws&&ws(L),$s=L},He=Ze({},[...Xr,...ec,...A1]),Xe=Ze({},[...tc,...R1]),dt=function(L){let oe=I(L);(!oe||!oe.tagName)&&(oe={namespaceURI:qt,tagName:"template"});const be=Yi(L.tagName),Pe=Yi(oe.tagName);return ia[L.namespaceURI]?L.namespaceURI===Ct?oe.namespaceURI===$t?be==="svg":oe.namespaceURI===lt?be==="svg"&&(Pe==="annotation-xml"||xa[Pe]):!!He[be]:L.namespaceURI===lt?oe.namespaceURI===$t?be==="math":oe.namespaceURI===Ct?be==="math"&&Js[Pe]:!!Xe[be]:L.namespaceURI===$t?oe.namespaceURI===Ct&&!Js[Pe]||oe.namespaceURI===lt&&!xa[Pe]?!1:!Xe[be]&&(hn[be]||!He[be]):!!(Fs==="application/xhtml+xml"&&ia[L.namespaceURI]):!1},bt=function(L){ti(t.removed,{element:L});try{I(L).removeChild(L)}catch{if(h(L),!I(L))throw wn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Za=function(L){const oe=A?A(L):L.childNodes;if(oe){const Pe=[];Aa(oe,Ue=>{ti(Pe,Ue)}),Aa(Pe,Ue=>{try{h(Ue)}catch{}})}const be=v?v(L):null;if(be)for(let Pe=be.length-1;Pe>=0;--Pe){const Ue=be[Pe],je=Ue&&Ue.name;if(typeof je=="string")try{L.removeAttribute(je)}catch{}}},Us=function(L,oe){try{ti(t.removed,{attribute:oe.getAttributeNode(L),from:oe})}catch{ti(t.removed,{attribute:null,from:oe})}if(oe.removeAttribute(L),L==="is")if(Ve||Be)try{bt(oe)}catch{}else try{oe.setAttribute(L,"")}catch{}},Mi=function(L){const oe=v?v(L):L.attributes;if(oe)for(let be=oe.length-1;be>=0;--be){const Pe=oe[be],Ue=Pe&&Pe.name;if(!(typeof Ue!="string"||T[ct(Ue)]))try{L.removeAttribute(Ue)}catch{}}},Vn=function(L){const oe=[L];for(;oe.length>0;){const be=oe.pop();(b?b(be):be.nodeType)===ca.element&&Mi(be);const Ue=A?A(be):be.childNodes;if(Ue)for(let je=Ue.length-1;je>=0;--je)oe.push(Ue[je])}},gn=function(L){let oe=null,be=null;if(Fe)L="<remove></remove>"+L;else{const je=Kp(L,/^[\r\n\t ]+/);be=je&&je[0]}Fs==="application/xhtml+xml"&&qt===$t&&(L='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+L+"</body></html>");const Pe=w?S(L):L;if(qt===$t)try{oe=new d().parseFromString(Pe,Fs)}catch{}if(!oe||!oe.documentElement){oe=D.createDocument(qt,"template",null);try{oe.documentElement.innerHTML=De?C:Pe}catch{}}const Ue=oe.body||oe.documentElement;return L&&be&&Ue.insertBefore(s.createTextNode(be),Ue.childNodes[0]||null),qt===$t?ie.call(oe,ye?"html":"body")[0]:ye?oe.documentElement:Ue},_a=function(L){return O.call(L.ownerDocument||L,L,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},wa=function(L){var oe,be;L.normalize();const Pe=O.call(L.ownerDocument||L,L,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let Ue=Pe.nextNode();for(;Ue;){let At=Ue.data;Aa([J,te,Z],mt=>{At=si(At,mt," ")}),Ue.data=At,Ue=Pe.nextNode()}const je=(oe=(be=L.querySelectorAll)===null||be===void 0?void 0:be.call(L,"template"))!==null&&oe!==void 0?oe:[];Aa(Array.from(je),At=>{Rt(At.content)&&wa(At.content)})},Ya=function(L){const oe=x?x(L):null;return typeof oe!="string"||ct(oe)!=="form"?!1:typeof L.nodeName!="string"||typeof L.textContent!="string"||typeof L.removeChild!="function"||L.attributes!==v(L)||typeof L.removeAttribute!="function"||typeof L.setAttribute!="function"||typeof L.namespaceURI!="string"||typeof L.insertBefore!="function"||typeof L.hasChildNodes!="function"||L.nodeType!==b(L)||L.childNodes!==A(L)},Rt=function(L){if(!b||typeof L!="object"||L===null)return!1;try{return b(L)===ca.documentFragment}catch{return!1}},la=function(L){if(!b||typeof L!="object"||L===null)return!1;try{return typeof b(L)=="number"}catch{return!1}};function ls(Te,L,oe){Aa(Te,be=>{be.call(t,L,oe,$s)})}const bn=function(L){let oe=null;if(ls(B.beforeSanitizeElements,L,null),Ya(L))return bt(L),!0;const be=ct(x?x(L):L.nodeName);if(ls(B.uponSanitizeElement,L,{tagName:be,allowedTags:xe}),me&&L.hasChildNodes()&&!la(L.firstElementChild)&&es(/<[/\w!]/g,L.innerHTML)&&es(/<[/\w!]/g,L.textContent)||me&&L.namespaceURI===$t&&be==="style"&&la(L.firstElementChild)||L.nodeType===ca.progressingInstruction||me&&L.nodeType===ca.comment&&es(/<[/\w]/g,L.data))return bt(L),!0;if(ce[be]||!(Y.tagCheck instanceof Function&&Y.tagCheck(be))&&!xe[be]){if(!ce[be]&&Gn(be)&&(V.tagNameCheck instanceof RegExp&&es(V.tagNameCheck,be)||V.tagNameCheck instanceof Function&&V.tagNameCheck(be)))return!1;if(X&&!Oe[be]){const Ue=I(L),je=A(L);if(je&&Ue){const At=je.length;for(let mt=At-1;mt>=0;--mt){const wt=we?je[mt]:m(je[mt],!0);Ue.insertBefore(wt,g(L))}}}return bt(L),!0}return(b?b(L):L.nodeType)===ca.element&&!dt(L)||(be==="noscript"||be==="noembed"||be==="noframes")&&es(/<\/no(script|embed|frames)/i,L.innerHTML)?(bt(L),!0):(ve&&L.nodeType===ca.text&&(oe=L.textContent,Aa([J,te,Z],Ue=>{oe=si(oe,Ue," ")}),L.textContent!==oe&&(ti(t.removed,{element:L.cloneNode()}),L.textContent=oe)),ls(B.afterSanitizeElements,L,null),!1)},Qa=function(L,oe,be){if(F[oe]||Je&&(oe==="id"||oe==="name")&&(be in s||be in Ja))return!1;const Pe=T[oe]||Y.attributeCheck instanceof Function&&Y.attributeCheck(oe,L);if(!(z&&!F[oe]&&es(fe,oe))){if(!(re&&es(de,oe))){if(!Pe||F[oe]){if(!(Gn(L)&&(V.tagNameCheck instanceof RegExp&&es(V.tagNameCheck,L)||V.tagNameCheck instanceof Function&&V.tagNameCheck(L))&&(V.attributeNameCheck instanceof RegExp&&es(V.attributeNameCheck,oe)||V.attributeNameCheck instanceof Function&&V.attributeNameCheck(oe,L))||oe==="is"&&V.allowCustomizedBuiltInElements&&(V.tagNameCheck instanceof RegExp&&es(V.tagNameCheck,be)||V.tagNameCheck instanceof Function&&V.tagNameCheck(be))))return!1}else if(!st[oe]){if(!es(ge,si(be,ue,""))){if(!((oe==="src"||oe==="xlink:href"||oe==="href")&&L!=="script"&&Jp(be,"data:")===0&&Re[L])){if(!(ee&&!es(K,si(be,ue,"")))){if(be)return!1}}}}}}return!0},qn=Ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Gn=function(L){return!qn[Yi(L)]&&es(he,L)},oa=function(L){ls(B.beforeSanitizeAttributes,L,null);const oe=L.attributes;if(!oe||Ya(L))return;const be={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:T,forceKeepAttr:void 0};let Pe=oe.length;for(;Pe--;){const Ue=oe[Pe],je=Ue.name,At=Ue.namespaceURI,mt=Ue.value,wt=ct(je),hs=mt;let It=je==="value"?hs:_1(hs);if(be.attrName=wt,be.attrValue=It,be.keepAttr=!0,be.forceKeepAttr=void 0,ls(B.uponSanitizeAttribute,L,be),It=be.attrValue,it&&(wt==="id"||wt==="name")&&Jp(It,We)!==0&&(Us(je,L),It=We+It),me&&es(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,It)){Us(je,L);continue}if(wt==="attributename"&&Kp(It,"href")){Us(je,L);continue}if(be.forceKeepAttr)continue;if(!be.keepAttr){Us(je,L);continue}if(!G&&es(/\/>/i,It)){Us(je,L);continue}ve&&Aa([J,te,Z],Wn=>{It=si(It,Wn," ")});const ka=ct(L.nodeName);if(!Qa(ka,wt,It)){Us(je,L);continue}if(w&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!At)switch(u.getAttributeType(ka,wt)){case"TrustedHTML":{It=S(It);break}case"TrustedScriptURL":{It=M(It);break}}if(It!==hs)try{At?L.setAttributeNS(At,je,It):L.setAttribute(je,It),Ya(L)?bt(L):Wp(t.removed)}catch{Us(je,L)}}ls(B.afterSanitizeAttributes,L,null)},Bs=function(L){let oe=null;const be=_a(L);for(ls(B.beforeSanitizeShadowDOM,L,null);oe=be.nextNode();)if(ls(B.uponSanitizeShadowNode,oe,null),bn(oe),oa(oe),Rt(oe.content)&&Bs(oe.content),(b?b(oe):oe.nodeType)===ca.element){const Ue=y?y(oe):oe.shadowRoot;Rt(Ue)&&(Ys(Ue),Bs(Ue))}ls(B.afterSanitizeShadowDOM,L,null)},Ys=function(L){const oe=[{node:L,shadow:null}];for(;oe.length>0;){const be=oe.pop();if(be.shadow){Bs(be.shadow);continue}const Pe=be.node,je=(b?b(Pe):Pe.nodeType)===ca.element,At=A?A(Pe):Pe.childNodes;if(At)for(let mt=At.length-1;mt>=0;--mt)oe.push({node:At[mt],shadow:null});if(je){const mt=x?x(Pe):null;if(typeof mt=="string"&&ct(mt)==="template"){const wt=Pe.content;Rt(wt)&&oe.push({node:wt,shadow:null})}}if(je){const mt=y?y(Pe):Pe.shadowRoot;Rt(mt)&&oe.push({node:null,shadow:mt},{node:mt,shadow:null})}}};return t.sanitize=function(Te){let L=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},oe=null,be=null,Pe=null,Ue=null;if(De=!Te,De&&(Te="<!-->"),typeof Te!="string"&&!la(Te)&&(Te=C1(Te),typeof Te!="string"))throw wn("dirty is not a string, aborting");if(!t.isSupported)return Te;Ie||_e(L),t.removed=[];const je=we&&typeof Te!="string"&&la(Te);if(je){const wt=x?x(Te):Te.nodeName;if(typeof wt=="string"){const hs=ct(wt);if(!xe[hs]||ce[hs])throw wn("root node is forbidden and cannot be sanitized in-place")}if(Ya(Te))throw wn("root node is clobbered and cannot be sanitized in-place");try{Ys(Te)}catch(hs){throw Za(Te),hs}}else if(la(Te))oe=gn("<!---->"),be=oe.ownerDocument.importNode(Te,!0),be.nodeType===ca.element&&be.nodeName==="BODY"||be.nodeName==="HTML"?oe=be:oe.appendChild(be),Ys(be);else{if(!Ve&&!ve&&!ye&&Te.indexOf("<")===-1)return w&&qe?S(Te):Te;if(oe=gn(Te),!oe)return Ve?null:qe?C:""}oe&&Fe&&bt(oe.firstChild);const At=_a(je?Te:oe);try{for(;Pe=At.nextNode();)bn(Pe),oa(Pe),Rt(Pe.content)&&Bs(Pe.content)}catch(wt){throw je&&Za(Te),wt}if(je)return Aa(t.removed,wt=>{wt.element&&Vn(wt.element)}),ve&&wa(Te),Te;if(Ve){if(ve&&wa(oe),Be)for(Ue=N.call(oe.ownerDocument);oe.firstChild;)Ue.appendChild(oe.firstChild);else Ue=oe;return(T.shadowroot||T.shadowrootmode)&&(Ue=le.call(a,Ue,!0)),Ue}let mt=ye?oe.outerHTML:oe.innerHTML;return ye&&xe["!doctype"]&&oe.ownerDocument&&oe.ownerDocument.doctype&&oe.ownerDocument.doctype.name&&es(F1,oe.ownerDocument.doctype.name)&&(mt="<!DOCTYPE "+oe.ownerDocument.doctype.name+`>
`+mt),ve&&Aa([J,te,Z],wt=>{mt=si(mt,wt," ")}),w&&qe?S(mt):mt},t.setConfig=function(){let Te=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};_e(Te),Ie=!0},t.clearConfig=function(){$s=null,Ie=!1,w=E,C=""},t.isValidAttribute=function(Te,L,oe){$s||_e({});const be=ct(Te),Pe=ct(L);return Qa(be,Pe,oe)},t.addHook=function(Te,L){typeof L=="function"&&ti(B[Te],L)},t.removeHook=function(Te,L){if(L!==void 0){const oe=y1(B[Te],L);return oe===-1?void 0:x1(B[Te],oe,1)[0]}return Wp(B[Te])},t.removeHooks=function(Te){B[Te]=[]},t.removeAllHooks=function(){B=af()},t}var nf=Fv();function Gd(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var jn=Gd();function $v(e){jn=e}var ll={exec:()=>null};function vt(e,t=""){let s=typeof e=="string"?e:e.source;const a={replace:(n,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(xs.caret,"$1"),s=s.replace(n,l),a},getRegex:()=>new RegExp(s,t)};return a}var xs={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},H1=/^(?:[ \t]*(?:\n|$))+/,z1=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,j1=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Bl=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,V1=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Wd=/(?:[*+-]|\d{1,9}[.)])/,Uv=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Bv=vt(Uv).replace(/bull/g,Wd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),q1=vt(Uv).replace(/bull/g,Wd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Kd=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,G1=/^[^\n]+/,Jd=/(?!\s*\])(?:\\.|[^\[\]\\])+/,W1=vt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Jd).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),K1=vt(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Wd).getRegex(),kr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Zd=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,J1=vt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Zd).replace("tag",kr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Hv=vt(Kd).replace("hr",Bl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",kr).getRegex(),Z1=vt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Hv).getRegex(),Yd={blockquote:Z1,code:z1,def:W1,fences:j1,heading:V1,hr:Bl,html:J1,lheading:Bv,list:K1,newline:H1,paragraph:Hv,table:ll,text:G1},lf=vt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Bl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",kr).getRegex(),Y1={...Yd,lheading:q1,table:lf,paragraph:vt(Kd).replace("hr",Bl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",lf).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",kr).getRegex()},Q1={...Yd,html:vt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Zd).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ll,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:vt(Kd).replace("hr",Bl).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Bv).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},X1=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,eT=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,zv=/^( {2,}|\\)\n(?!\s*$)/,tT=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Sr=/[\p{P}\p{S}]/u,Qd=/[\s\p{P}\p{S}]/u,jv=/[^\s\p{P}\p{S}]/u,sT=vt(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Qd).getRegex(),Vv=/(?!~)[\p{P}\p{S}]/u,aT=/(?!~)[\s\p{P}\p{S}]/u,nT=/(?:[^\s\p{P}\p{S}]|~)/u,iT=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,qv=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,lT=vt(qv,"u").replace(/punct/g,Sr).getRegex(),oT=vt(qv,"u").replace(/punct/g,Vv).getRegex(),Gv="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",rT=vt(Gv,"gu").replace(/notPunctSpace/g,jv).replace(/punctSpace/g,Qd).replace(/punct/g,Sr).getRegex(),cT=vt(Gv,"gu").replace(/notPunctSpace/g,nT).replace(/punctSpace/g,aT).replace(/punct/g,Vv).getRegex(),dT=vt("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,jv).replace(/punctSpace/g,Qd).replace(/punct/g,Sr).getRegex(),uT=vt(/\\(punct)/,"gu").replace(/punct/g,Sr).getRegex(),pT=vt(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),fT=vt(Zd).replace("(?:-->|$)","-->").getRegex(),mT=vt("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",fT).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Go=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,hT=vt(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Go).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Wv=vt(/^!?\[(label)\]\[(ref)\]/).replace("label",Go).replace("ref",Jd).getRegex(),Kv=vt(/^!?\[(ref)\](?:\[\])?/).replace("ref",Jd).getRegex(),vT=vt("reflink|nolink(?!\\()","g").replace("reflink",Wv).replace("nolink",Kv).getRegex(),Xd={_backpedal:ll,anyPunctuation:uT,autolink:pT,blockSkip:iT,br:zv,code:eT,del:ll,emStrongLDelim:lT,emStrongRDelimAst:rT,emStrongRDelimUnd:dT,escape:X1,link:hT,nolink:Kv,punctuation:sT,reflink:Wv,reflinkSearch:vT,tag:mT,text:tT,url:ll},gT={...Xd,link:vt(/^!?\[(label)\]\((.*?)\)/).replace("label",Go).getRegex(),reflink:vt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Go).getRegex()},Hc={...Xd,emStrongRDelimAst:cT,emStrongLDelim:oT,url:vt(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},bT={...Hc,br:vt(zv).replace("{2,}","*").getRegex(),text:vt(Hc.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ro={normal:Yd,gfm:Y1,pedantic:Q1},qi={normal:Xd,gfm:Hc,breaks:bT,pedantic:gT},yT={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},of=e=>yT[e];function pa(e,t){if(t){if(xs.escapeTest.test(e))return e.replace(xs.escapeReplace,of)}else if(xs.escapeTestNoEncode.test(e))return e.replace(xs.escapeReplaceNoEncode,of);return e}function rf(e){try{e=encodeURI(e).replace(xs.percentDecode,"%")}catch{return null}return e}function cf(e,t){var i;const s=e.replace(xs.findPipe,(l,o,r)=>{let c=!1,d=o;for(;--d>=0&&r[d]==="\\";)c=!c;return c?"|":" |"}),a=s.split(xs.splitPipe);let n=0;if(a[0].trim()||a.shift(),a.length>0&&!((i=a.at(-1))!=null&&i.trim())&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;n<a.length;n++)a[n]=a[n].trim().replace(xs.slashPipe,"|");return a}function Gi(e,t,s){const a=e.length;if(a===0)return"";let n=0;for(;n<a&&e.charAt(a-n-1)===t;)n++;return e.slice(0,a-n)}function xT(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let a=0;a<e.length;a++)if(e[a]==="\\")a++;else if(e[a]===t[0])s++;else if(e[a]===t[1]&&(s--,s<0))return a;return s>0?-2:-1}function df(e,t,s,a,n){const i=t.href,l=t.title||null,o=e[1].replace(n.other.outputLinkReplace,"$1");a.state.inLink=!0;const r={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:o,tokens:a.inlineTokens(o)};return a.state.inLink=!1,r}function _T(e,t,s){const a=e.match(s.other.indentCodeCompensation);if(a===null)return t;const n=a[1];return t.split(`
...
`)}var Wo=class{constructor(e){xt(this,"options");xt(this,"rules");xt(this,"lexer");this.options=e||jn}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const s=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?s:Gi(s,`
...
`,1)[0];let C;if(p=w,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),C=p):C=p.replace(this.rules.other.tabCharGlobal,"    "),v.test(p)||b.test(p)||x.test(p)||I.test(p)||y.test(p))break;if(C.search(this.rules.other.nonSpaceChar)>=h||!p.trim())d+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+pa(s.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(s);throw s}}},Fn=new wT;function ft(e,t){return Fn.parse(e,t)}ft.options=ft.setOptions=function(e){return Fn.setOptions(e),ft.defaults=Fn.defaults,$v(ft.defaults),ft};ft.getDefaults=Gd;ft.defaults=jn;ft.use=function(...e){return Fn.use(...e),ft.defaults=Fn.defaults,$v(ft.defaults),ft};ft.walkTokens=function(e,t){return Fn.walkTokens(e,t)};ft.parseInline=Fn.parseInline;ft.Parser=Fa;ft.parser=Fa.parse;ft.Renderer=Ko;ft.TextRenderer=eu;ft.Lexer=Pa;ft.lexer=Pa.lex;ft.Tokenizer=Wo;ft.Hooks=go;ft.parse=ft;ft.options;ft.setOptions;ft.use;ft.walkTokens;ft.parseInline;Fa.parse;Pa.lex;const kT={breaks:!0,gfm:!0};function uf(e){if(!e)return"";try{if(typeof ft<"u"&&ft.parse){const t=ft.parse(e,kT);return typeof nf<"u"?nf.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function ST(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),a=t.getMinutes().toString().padStart(2,"0");return`${s}:${a}`}const TT={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function CT(e){return TT[e]||"wrench"}const ET=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function pf(e){if(!e)return[];const t=e.match(ET);return t?[...new Set(t)]:[]}const AT={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),a=f(""),n=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=j(()=>t.value.trim().length>0&&!s.value),p=f(nt.state||"disconnected");let m=null;const h=j(()=>{const D=p.value;return D==="connected"?"Connected":D==="reconnecting"?"Reconnecting…":D==="connecting"?"Connecting…":"REST fallback"}),g=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],A=j(()=>{const D=Math.floor(l.value/4)%g.length,O=l.value;return O>3?`${g[D]} (${O}s)`:g[0]});function I(){Pt(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!i.value)return;const D=i.value;D.style.height="auto",D.style.height=Math.min(D.scrollHeight,120)+"px"}function v(D,O,N={}){const ie={id:++c,role:D,content:O,timestamp:Date.now(),html:D==="bot"?uf(O):"",tools_used:N.tools_used||[],is_error:N.is_error||!1,images:D==="bot"?pf(O):[],files:N.files||[],_showTools:!1};return e.value.push(ie),I(),D==="bot"&&Pt(()=>b()),ie}function b(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(O=>{O.setAttribute("data-copy","true"),O.style.position="relative";const N=document.createElement("button");N.className="chat-code-copy",N.textContent="Copy",N.addEventListener("click",()=>{const ie=O.querySelector("code"),le=ie?ie.textContent:O.textContent;navigator.clipboard.writeText(le).then(()=>{N.textContent="Copied!",setTimeout(()=>{N.textContent="Copy"},1500)}).catch(()=>{})}),O.appendChild(N)})}function x(D){if(D===0)return!0;const O=e.value[D-1],N=e.value[D],ie=new Date(O.timestamp).toDateString(),le=new Date(N.timestamp).toDateString();return ie!==le}function w(D){const O=new Date(D),N=new Date;if(O.toDateString()===N.toDateString())return"Today";const ie=new Date(N);return ie.setDate(ie.getDate()-1),O.toDateString()===ie.toDateString()?"Yesterday":O.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function C(D){t.value=D,Pt(()=>Q())}function E(D){window.open(D,"_blank","noopener")}function _(D){D.target.style.display="none"}function R(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function $(){r&&(clearInterval(r),r=null),l.value=0}function S(D){s.value&&(s.value=!1,$(),D.type==="chat_response"?v("bot",D.content,{tools_used:D.tools_used||[],is_error:D.is_error||!1,files:D.files||[]}):D.type==="chat_error"&&v("bot",D.error||"Unknown error",{is_error:!0}),Pt(()=>{var O;return(O=i.value)==null?void 0:O.focus()}))}async function M(D){try{const O=await H.post("/api/chat",{content:D,channel_id:o.value});v("bot",O.response,{tools_used:O.tools_used||[],is_error:O.is_error||!1,files:O.files||[]})}catch(O){v("bot",O.message||"Failed to send message",{is_error:!0})}}async function Q(){const D=t.value.trim();if(!D||s.value)return;v("user",D),t.value="",s.value=!0,R(),i.value&&(i.value.style.height="auto"),nt.connected&&nt.sendChat(D,{channelId:o.value})||(await M(D),s.value=!1,$()),Pt(()=>{var N;return(N=i.value)==null?void 0:N.focus()})}async function W(){a.value="";try{if(!o.value){const O=await H.get("/api/auth/session");o.value=O.channel_id||O.user_id||"web-user"}const D=await H.get("/api/sessions/"+encodeURIComponent(o.value));if(D&&D.messages&&D.messages.length>0){for(const O of D.messages){const N=O.role==="user"?"user":"bot";let ie=O.content||"";if(N==="user"){const B=ie.match(/^\[.*?\]:\s*/);B&&(ie=ie.slice(B[0].length))}if(!ie.trim())continue;const le={id:++c,role:N,content:ie,timestamp:O.timestamp?O.timestamp*1e3:Date.now(),html:N==="bot"?uf(ie):"",tools_used:[],is_error:!1,images:N==="bot"?pf(ie):[],files:[],_showTools:!1};e.value.push(le)}Pt(()=>{I(),b()})}}catch(D){D&&D.status!==404&&(a.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",ke.error(a.value))}}return Ye(()=>{nt.subscribe("chat",S),p.value=nt.state||"disconnected",m=nt.onState(D=>{p.value=D}),W(),Pt(()=>{var D;return(D=i.value)==null?void 0:D.focus()})}),gt(()=>{nt.unsubscribe("chat",S),m&&(m(),m=null),$()}),{messages:e,input:t,sending:s,historyError:a,messagesEl:n,inputEl:i,canSend:u,wsStatus:h,typingText:A,suggestions:d,send:Q,autoResize:y,formatTime:ST,formatDate:w,showDateSeparator:x,useSuggestion:C,openImage:E,onImageError:_,getToolIcon:CT,loadHistory:W}}},RT={setup(){const e=f("odin"),t=f(""),s=f(""),a=f(""),n=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),m=f(!1),h=j(()=>e.value==="custom"),g=j(()=>[...i.value,...l.value]),A=j(()=>l.value.includes(e.value)),I=j(()=>{var E;return h.value?t.value||"Odin":((E=n.value[e.value])==null?void 0:E.name)||e.value}),y=j(()=>{var E;return h.value?s.value||"(empty — will use Odin default)":((E=n.value[e.value])==null?void 0:E.identity)||""}),v=j(()=>{var E;return h.value?a.value||"(empty — will use Odin default)":((E=n.value[e.value])==null?void 0:E.voice)||""});async function b(){d.value=!0;try{const E=await H.get("/api/personality");e.value=E.preset||"odin",t.value=E.custom_name||"",s.value=E.custom_identity||"",a.value=E.custom_voice||"",n.value=E.presets||{},i.value=E.builtin_presets||[],l.value=E.user_presets||[]}catch(E){c.value=E.message}finally{d.value=!1}}async function x(){o.value=!0,c.value=null,r.value=!1;try{await H.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:a.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(E){c.value=E.message}finally{o.value=!1}}async function w(){const E=u.value.trim();if(E){m.value=!0,c.value=null;try{await H.post("/api/personality/presets",{name:E,display_name:I.value,identity:y.value,voice:v.value}),p.value=!1,u.value="",await b(),e.value=E.toLowerCase().replace(/ /g,"_")}catch(_){c.value=_.message}finally{m.value=!1}}}async function C(){if(await Qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await H.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(_){c.value=_.message}}}return Ye(b),{preset:e,customName:t,customIdentity:s,customVoice:a,presets:n,presetNames:g,isCustom:h,isUserPreset:A,previewName:I,previewIdentity:y,previewVoice:v,saving:o,saved:r,error:c,loading:d,save:x,showSavePreset:p,newPresetName:u,savingPreset:m,saveAsPreset:w,deletePreset:C,builtinPresets:i,userPresets:l}},template:`
  ...
  `},IT={props:["onComplete"],template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),a=f(!1),n=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let m=null;const h=f("starting"),g=f(""),A=Jv.filter(B=>B.meta),I=j(()=>["Workspace","Operate","Observe","Manage"].map(B=>({name:B,routes:A.filter(J=>J.meta.section===B)})).filter(B=>B.routes.length)),y=j(()=>{var B;return((B=ol.currentRoute.value.meta)==null?void 0:B.label)||"Odin"}),v=j(()=>{var B;return((B=ol.currentRoute.value.meta)==null?void 0:B.section)||"Management"}),b=j(()=>{var B;return((B=ol.currentRoute.value.meta)==null?void 0:B.description)||"Management console"});function x(){nt.disconnect(),D&&(clearInterval(D),D=null)}H.onSessionExpired=()=>{t.value=!0,x(),H.setToken(""),e.value="login"};function w(B){var J;if((B.ctrlKey||B.metaKey)&&B.key.toLowerCase()==="k"){e.value==="ready"&&(B.preventDefault(),jp());return}if(a.value&&B.key==="Tab"){const te=[...((J=n.value)==null?void 0:J.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(te.length){const Z=te[0],fe=te[te.length-1];if(B.shiftKey&&(document.activeElement===Z||!n.value.contains(document.activeElement))){B.preventDefault(),fe.focus();return}if(!B.shiftKey&&(document.activeElement===fe||!n.value.contains(document.activeElement))){B.preventDefault(),Z.focus();return}}}if(B.key==="Escape"&&a.value){a.value=!1,B.preventDefault();return}if(B.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(B.target.tagName)){B.preventDefault();const te=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');te&&te.focus()}}function C(){l.value=!!(o!=null&&o.matches),l.value||(a.value=!1)}async function E(){try{const B=await H.get("/api/setup/status");if(B.mode==="pending"||B.needed===!0)return x(),e.value="setup",!0}catch(B){B==null||B.name}return!1}Ye(async()=>{if(document.addEventListener("keydown",w),o=window.matchMedia("(max-width: 900px)"),C(),o.addEventListener("change",C),await E())return;const B=await H.check();B.ok?(e.value="ready",ie()):B.needsAuth?e.value="login":(e.value="ready",ie())});function _(){t.value=!1,e.value="ready",ie()}async function R(){if(await E())return;const B=await H.check();B.ok?(e.value="ready",ie()):B.needsAuth?e.value="login":(e.value="ready",ie())}async function $(){x(),e.value="login",await H.logout()}function S(){s.value=!s.value}function M(){a.value=!a.value}zt(a,async B=>{var J,te;if(B)r=document.activeElement,await Pt(),(te=(J=n.value)==null?void 0:J.querySelector(".nav-item"))==null||te.focus();else if(r!=null&&r.isConnected){const Z=r;r=null,requestAnimationFrame(()=>Z.focus())}});const Q=j(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function W(B,J="info",te=3e3){p.value={text:B,level:J},clearTimeout(m),m=setTimeout(()=>{p.value=null},te)}let D=null,O=!1,N=[];function ie(){for(const B of N)B();N=[nt.onStatus(B=>{c.value=B}),nt.onLatencyChange(B=>{u.value=B}),nt.onState((B,J)=>{d.value=B,B==="connected"?(O&&W("Connection restored","success"),O=!0):B==="reconnecting"&&J.attempt===1&&W("Connection lost — reconnecting…","warn")})],nt.connect(),le(),D&&clearInterval(D),D=setInterval(le,15e3)}async function le(){try{const B=await H.get("/api/status");h.value=B.status==="online"?"online":"starting";const J=B.uptime_seconds||0,te=Math.floor(J/3600),Z=Math.floor(J%3600/60);g.value=`${te}h ${Z}m uptime`}catch{h.value="offline",g.value=""}}return gt(()=>{D&&clearInterval(D);for(const B of N)B();N=[],nt.disconnect(),document.removeEventListener("keydown",w),o==null||o.removeEventListener("change",C)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:a,wsConnected:c,wsState:d,wsLatency:u,wsLabel:Q,wsToast:p,botStatus:h,botUptime:g,navRoutes:A,navGroups:I,currentPage:y,currentSection:v,currentDescription:b,sidebarEl:n,mobileMenuButton:i,isMobileViewport:l,onLogin:_,onSetupComplete:R,logout:$,toggleSidebar:S,toggleMobileNavigation:M,openPalette:jp}}},Ka=Mo(LT);Ka.component("odin-icon",o1);Ka.component("login-screen",OT);Ka.component("setup-page",IT);Ka.component("toast-container",G_);Ka.component("confirm-host",W_);Ka.component("command-palette",l1);Ka.directive("modal-focus",c1);Ka.use(ol);Ka.mount("#app");
