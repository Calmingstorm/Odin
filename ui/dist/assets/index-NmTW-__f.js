 ...
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let aw=()=>location.protocol+"//"+location.host;function jm(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,o=a.slice(l);return o[0]!=="/"&&(o="/"+o),ju(o,"")}return ju(s,e)+n+a}function iw(e,t,s,n){let a=[],i=[],l=null;const o=({state:p})=>{const f=jm(e,location),m=s.value,v=t.value;let k=0;if(p){if(s.value=f,t.value=p,l&&l===m){l=null;return}k=v?p.position-v.position:0}else n(f);a.forEach(N=>{N(s.value,m,{delta:k,type:ic.pop,direction:k?k>0?br.forward:br.back:br.unknown})})};function r(){l=s.value}function c(p){a.push(p);const f=()=>{const m=a.indexOf(p);m>-1&&a.splice(m,1)};return i.push(f),f}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(lt({},p.state,{scroll:Zo()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",o),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",o),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:r,listen:c,destroy:u}}function Wu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?Zo():null}}function lw(e){const{history:t,location:s}=window,n={value:jm(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(r,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+r:aw()+e+r;try{t[d?"replaceState":"pushState"](c,"",p),a.value=c}catch(f){console.error(f),s[d?"replace":"assign"](p)}}function l(r,c){i(r,lt({},t.state,Wu(a.value.back,r,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=r}function o(r,c){const d=lt({},a.value,t.state,{forward:r,scroll:Zo()});i(d.current,d,!0),i(r,lt({},Wu(n.value,r,null),{position:d.position+1},c),!1),n.value=r}return{location:n,state:a,push:o,replace:l}}function ow(e){e=V_(e);const t=lw(e),s=iw(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=lt({location:"",base:e,go:n,createHref:G_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function rw(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),ow(e)}let ha=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Ut=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Ut||{});const cw={type:ha.Static,value:""},dw=/[a-zA-Z0-9_]/;function uw(e){if(!e)return[[]];if(e==="/")return[[cw]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(f){throw new Error(`ERR (${s})/"${c}": ${f}`)}let s=Ut.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let o=0,r,c="",d="";function u(){c&&(s===Ut.Static?i.push({type:ha.Static,value:c}):s===Ut.Param||s===Ut.ParamRegExp||s===Ut.ParamRegExpEnd?(i.length>1&&(r==="*"||r==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:ha.Param,value:c,regexp:d,repeatable:r==="*"||r==="+",optional:r==="*"||r==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=r}for(;o<e.length;){if(r=e[o++],r==="\\"&&s!==Ut.ParamRegExp){n=s,s=Ut.EscapeNext;continue}switch(s){case Ut.Static:r==="/"?(c&&u(),l()):r===":"?(u(),s=Ut.Param):p();break;case Ut.EscapeNext:p(),s=n;break;case Ut.Param:r==="("?s=Ut.ParamRegExp:dw.test(r)?p():(u(),s=Ut.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--);break;case Ut.ParamRegExp:r===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+r:s=Ut.ParamRegExpEnd:d+=r;break;case Ut.ParamRegExpEnd:u(),s=Ut.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--,d="";break;default:t("Unknown state");break}}return s===Ut.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const Ju="[^/]+?",pw={sensitive:!1,strict:!1,start:!0,end:!0};var us=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(us||{});const fw=/[.+*?^${}()[\]/\\]/g;function hw(e,t){const s=lt({},pw,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[us.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const p=c[u];let f=us.Segment+(s.sensitive?us.BonusCaseSensitive:0);if(p.type===ha.Static)u||(a+="/"),a+=p.value.replace(fw,"\\$&"),f+=us.Static;else if(p.type===ha.Param){const{value:m,repeatable:v,optional:k,regexp:N}=p;i.push({name:m,repeatable:v,optional:k});const y=N||Ju;if(y!==Ju){f+=us.BonusCustomRegExp;try{`${y}`}catch(b){throw new Error(`Invalid custom RegExp for param "${m}" (${y}): `+b.message)}}let g=v?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(g=k&&c.length<2?`(?:/${g})`:"/"+g),k&&(g+="?"),a+=g,f+=us.Dynamic,k&&(f+=us.BonusOptional),v&&(f+=us.BonusRepeatable),y===".*"&&(f+=us.BonusWildcard)}d.push(f)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=us.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function o(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const f=d[p]||"",m=i[p-1];u[m.name]=f&&m.repeatable?f.split("/"):f}return u}function r(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const f of p)if(f.type===ha.Static)d+=f.value;else if(f.type===ha.Param){const{value:m,repeatable:v,optional:k}=f,N=m in c?c[m]:"";if(Ws(N)&&!v)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const y=Ws(N)?N.join("/"):N;if(!y)if(k)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${m}"`);d+=y}}return d||"/"}return{re:l,score:n,keys:i,parse:o,stringify:r}}function mw(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===us.Static+us.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===us.Static+us.Segment?1:-1:0}function Vm(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=mw(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Zu(n))return 1;if(Zu(a))return-1}return a.length-n.length}function Zu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const vw={strict:!1,end:!0,sensitive:!1};function gw(e,t,s){const n=hw(uw(e.path),s),a=lt(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function bw(e,t){const s=[],n=new Map;t=zu(vw,t);function a(u){return n.get(u)}function i(u,p,f){const m=!f,v=Qu(u);v.aliasOf=f&&f.record;const k=zu(t,u),N=[v];if("alias"in u){const b=typeof u.alias=="string"?[u.alias]:u.alias;for(const E of b)N.push(Qu(lt({},v,{components:f?f.record.components:v.components,path:E,aliasOf:f?f.record:v})))}let y,g;for(const b of N){const{path:E}=b;if(p&&E[0]!=="/"){const T=p.record.path,L=T[T.length-1]==="/"?"":"/";b.path=p.record.path+(E&&L+E)}if(y=gw(b,p,k),f?f.alias.push(y):(g=g||y,g!==y&&g.alias.push(y),m&&u.name&&!Xu(y)&&l(u.name)),qm(y)&&r(y),v.children){const T=v.children;for(let L=0;L<T.length;L++)i(T[L],y,f&&f.children[L])}f=f||y}return g?()=>{l(g)}:Ui}function l(u){if(Hm(u)){const p=n.get(u);p&&(n.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function o(){return s}function r(u){const p=_w(u,s);s.splice(p,0,u),u.record.name&&!Xu(u)&&n.set(u.record.name,u)}function c(u,p){let f,m={},v,k;if("name"in u&&u.name){if(f=n.get(u.name),!f)throw di(Tt.MATCHER_NOT_FOUND,{location:u});k=f.record.name,m=lt(Yu(p.params,f.keys.filter(g=>!g.optional).concat(f.parent?f.parent.keys.filter(g=>g.optional):[]).map(g=>g.name)),u.params&&Yu(u.params,f.keys.map(g=>g.name))),v=f.stringify(m)}else if(u.path!=null)v=u.path,f=s.find(g=>g.re.test(v)),f&&(m=f.parse(v),k=f.record.name);else{if(f=p.name?n.get(p.name):s.find(g=>g.re.test(p.path)),!f)throw di(Tt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});k=f.record.name,m=lt({},p.params,u.params),v=f.stringify(m)}const N=[];let y=f;for(;y;)N.unshift(y.record),y=y.parent;return{name:k,path:v,params:m,matched:N,meta:xw(N)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:o,getRecordMatcher:a}}function Yu(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Qu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:yw(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function yw(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function Xu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function xw(e){return e.reduce((t,s)=>lt(t,s.meta),{})}function _w(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;Vm(e,t[i])<0?n=i:s=i+1}const a=ww(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function ww(e){let t=e;for(;t=t.parent;)if(qm(t)&&Vm(e,t)===0)return t}function qm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function ep(e){const t=Bs(Yo),s=Bs(vd),n=G(()=>{const r=ln(e.to);return t.resolve(r)}),a=G(()=>{const{matched:r}=n.value,{length:c}=r,d=r[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(ci.bind(null,d));if(p>-1)return p;const f=tp(r[c-2]);return c>1&&tp(d)===f&&u[u.length-1].path!==f?u.findIndex(ci.bind(null,r[c-2])):p}),i=G(()=>a.value>-1&&Ew(s.params,n.value.params)),l=G(()=>a.value>-1&&a.value===s.matched.length-1&&Bm(s.params,n.value.params));function o(r={}){if(Cw(r)){const c=t[ln(e.replace)?"replace":"push"](ln(e.to)).catch(Ui);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:G(()=>n.value.href),isActive:i,isExactActive:l,navigate:o}}function kw(e){return e.length===1?e[0]:e}const Sw=hl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:ep,setup(e,{slots:t}){const s=ta(ep(e)),{options:n}=Bs(Yo),a=G(()=>({[sp(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[sp(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&kw(t.default(s));return e.custom?i:si("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),Tw=Sw;function Cw(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function Ew(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Ws(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function tp(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const sp=(e,t,s)=>e??t??s,Aw=hl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Bs(oc),a=G(()=>e.route||n.value),i=Bs(Ku,0),l=G(()=>{let c=ln(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),o=G(()=>a.value.matched[l.value]);Di(Ku,G(()=>l.value+1)),Di(sw,o),Di(oc,a);const r=h();return Mt(()=>[r.value,o.value,e.name],([c,d,u],[p,f,m])=>{d&&(d.instances[u]=c,f&&f!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=f.leaveGuards),d.updateGuards.size||(d.updateGuards=f.updateGuards))),c&&d&&(!f||!ci(d,f)||!p)&&(d.enterCallbacks[u]||[]).forEach(v=>v(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=o.value,p=u&&u.components[d];if(!p)return np(s.default,{Component:p,route:c});const f=u.props[d],m=f?f===!0?c.params:typeof f=="function"?f(c):f:null,k=si(p,lt({},m,t,{onVnodeUnmounted:N=>{N.component.isUnmounted&&(u.instances[d]=null)},ref:r}));return np(s.default,{Component:k,route:c})||k}}});function np(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Rw=Aw;function Iw(e){const t=bw(e.routes,e),s=e.parseQuery||ew,n=e.stringifyQuery||Gu,a=e.history,i=wi(),l=wi(),o=wi(),r=Cc(Vn);let c=Vn;Ba&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=vr.bind(null,ee=>""+ee),u=vr.bind(null,F_),p=vr.bind(null,ll);function f(ee,ge){let q,re;return Hm(ee)?(q=t.getRecordMatcher(ee),re=ge):re=ee,t.addRoute(re,q)}function m(ee){const ge=t.getRecordMatcher(ee);ge&&t.removeRoute(ge)}function v(){return t.getRoutes().map(ee=>ee.record)}function k(ee){return!!t.getRecordMatcher(ee)}function N(ee,ge){if(ge=lt({},ge||r.value),typeof ee=="string"){const x=gr(s,ee,ge.path),F=t.resolve({path:x.path},ge),Q=a.createHref(x.fullPath);return lt(x,F,{params:p(F.params),hash:ll(x.hash),redirectedFrom:void 0,href:Q})}let q;if(ee.path!=null)q=lt({},ee,{path:gr(s,ee.path,ge.path).path});else{const x=lt({},ee.params);for(const F in x)x[F]==null&&delete x[F];q=lt({},ee,{params:u(x)}),ge.params=u(ge.params)}const re=t.resolve(q,ge),fe=ee.hash||"";re.params=d(p(re.params));const Ie=B_(n,lt({},ee,{hash:D_(fe),path:re.path})),w=a.createHref(Ie);return lt({fullPath:Ie,hash:fe,query:n===Gu?tw(ee.query):ee.query||{}},re,{redirectedFrom:void 0,href:w})}function y(ee){return typeof ee=="string"?gr(s,ee,r.value.path):lt({},ee)}function g(ee,ge){if(c!==ee)return di(Tt.NAVIGATION_CANCELLED,{from:ge,to:ee})}function b(ee){return L(ee)}function E(ee){return b(lt(y(ee),{replace:!0}))}function T(ee,ge){const q=ee.matched[ee.matched.length-1];if(q&&q.redirect){const{redirect:re}=q;let fe=typeof re=="function"?re(ee,ge):re;return typeof fe=="string"&&(fe=fe.includes("?")||fe.includes("#")?fe=y(fe):{path:fe},fe.params={}),lt({query:ee.query,hash:ee.hash,params:fe.path!=null?{}:ee.params},fe)}}function L(ee,ge){const q=c=N(ee),re=r.value,fe=ee.state,Ie=ee.force,w=ee.replace===!0,x=T(q,re);if(x)return L(lt(y(x),{state:typeof x=="object"?lt({},fe,x.state):fe,force:Ie,replace:w}),ge||q);const F=q;F.redirectedFrom=ge;let Q;return!Ie&&H_(n,re,q)&&(Q=di(Tt.NAVIGATION_DUPLICATED,{to:F,from:re}),K(re,re,!0,!1)),(Q?Promise.resolve(Q):D(F,re)).catch(Z=>mn(Z)?mn(Z,Tt.NAVIGATION_GUARD_REDIRECT)?Z:V(Z):I(Z,F,re)).then(Z=>{if(Z){if(mn(Z,Tt.NAVIGATION_GUARD_REDIRECT))return L(lt({replace:w},y(Z.to),{state:typeof Z.to=="object"?lt({},fe,Z.to.state):fe,force:Ie}),ge||F)}else Z=C(F,re,!0,w,fe);return $(F,re,Z),Z})}function R(ee,ge){const q=g(ee,ge);return q?Promise.reject(q):Promise.resolve()}function _(ee){const ge=se.values().next().value;return ge&&typeof ge.runWithContext=="function"?ge.runWithContext(ee):ee()}function D(ee,ge){let q;const[re,fe,Ie]=nw(ee,ge);q=yr(re.reverse(),"beforeRouteLeave",ee,ge);for(const x of re)x.leaveGuards.forEach(F=>{q.push(Zn(F,ee,ge))});const w=R.bind(null,ee,ge);return q.push(w),Ne(q).then(()=>{q=[];for(const x of i.list())q.push(Zn(x,ee,ge));return q.push(w),Ne(q)}).then(()=>{q=yr(fe,"beforeRouteUpdate",ee,ge);for(const x of fe)x.updateGuards.forEach(F=>{q.push(Zn(F,ee,ge))});return q.push(w),Ne(q)}).then(()=>{q=[];for(const x of Ie)if(x.beforeEnter)if(Ws(x.beforeEnter))for(const F of x.beforeEnter)q.push(Zn(F,ee,ge));else q.push(Zn(x.beforeEnter,ee,ge));return q.push(w),Ne(q)}).then(()=>(ee.matched.forEach(x=>x.enterCallbacks={}),q=yr(Ie,"beforeRouteEnter",ee,ge,_),q.push(w),Ne(q))).then(()=>{q=[];for(const x of l.list())q.push(Zn(x,ee,ge));return q.push(w),Ne(q)}).catch(x=>mn(x,Tt.NAVIGATION_CANCELLED)?x:Promise.reject(x))}function $(ee,ge,q){o.list().forEach(re=>_(()=>re(ee,ge,q)))}function C(ee,ge,q,re,fe){const Ie=g(ee,ge);if(Ie)return Ie;const w=ge===Vn,x=Ba?history.state:{};q&&(re||w?a.replace(ee.fullPath,lt({scroll:w&&x&&x.scroll},fe)):a.push(ee.fullPath,fe)),r.value=ee,K(ee,ge,q,w),V()}let M;function j(){M||(M=a.listen((ee,ge,q)=>{if(!ce.listening)return;const re=N(ee),fe=T(re,ce.currentRoute.value);if(fe){L(lt(fe,{replace:!0,force:!0}),re).catch(Ui);return}c=re;const Ie=r.value;Ba&&J_(qu(Ie.fullPath,q.delta),Zo()),D(re,Ie).catch(w=>mn(w,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_CANCELLED)?w:mn(w,Tt.NAVIGATION_GUARD_REDIRECT)?(L(lt(y(w.to),{force:!0}),re).then(x=>{mn(x,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_DUPLICATED)&&!q.delta&&q.type===ic.pop&&a.go(-1,!1)}).catch(Ui),Promise.reject()):(q.delta&&a.go(-q.delta,!1),I(w,re,Ie))).then(w=>{w=w||C(re,Ie,!1),w&&(q.delta&&!mn(w,Tt.NAVIGATION_CANCELLED)?a.go(-q.delta,!1):q.type===ic.pop&&mn(w,Tt.NAVIGATION_ABORTED|Tt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),$(re,Ie,w)}).catch(Ui)}))}let J=wi(),A=wi(),S;function I(ee,ge,q){V(ee);const re=A.list();return re.length?re.forEach(fe=>fe(ee,ge,q)):console.error(ee),Promise.reject(ee)}function U(){return S&&r.value!==Vn?Promise.resolve():new Promise((ee,ge)=>{J.add([ee,ge])})}function V(ee){return S||(S=!ee,j(),J.list().forEach(([ge,q])=>ee?q(ee):ge()),J.reset()),ee}function K(ee,ge,q,re){const{scrollBehavior:fe}=e;if(!Ba||!fe)return Promise.resolve();const Ie=!q&&Z_(qu(ee.fullPath,0))||(re||!q)&&history.state&&history.state.scroll||null;return Rt().then(()=>fe(ee,ge,Ie)).then(w=>w&&W_(w)).catch(w=>I(w,ee,ge))}const Y=ee=>a.go(ee);let le;const se=new Set,ce={currentRoute:r,listening:!0,addRoute:f,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:k,getRoutes:v,resolve:N,options:e,push:b,replace:E,go:Y,back:()=>Y(-1),forward:()=>Y(1),beforeEach:i.add,beforeResolve:l.add,afterEach:o.add,onError:A.add,isReady:U,install(ee){ee.component("RouterLink",Tw),ee.component("RouterView",Rw),ee.config.globalProperties.$router=ce,Object.defineProperty(ee.config.globalProperties,"$route",{enumerable:!0,get:()=>ln(r)}),Ba&&!le&&r.value===Vn&&(le=!0,b(a.location).catch(re=>{}));const ge={};for(const re in Vn)Object.defineProperty(ge,re,{get:()=>r.value[re],enumerable:!0});ee.provide(Yo,ce),ee.provide(vd,Tc(ge)),ee.provide(oc,r);const q=ee.unmount;se.add(ee),ee.unmount=function(){se.delete(ee),se.size<1&&(c=Vn,M&&M(),M=null,r.value=Vn,le=!1,S=!1),q()}}};function Ne(ee){return ee.reduce((ge,q)=>ge.then(()=>_(q)),Promise.resolve())}return ce}function Gm(){return Bs(Yo)}function Ow(e){return Bs(vd)}const Qo={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=Ow(),s=Gm(),n=G({get(){var r;const o=t.query.tab;return o&&e.tabs.some(c=>c.id===o)?o:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(o){s.replace({query:{...t.query,tab:o}})}}),a=G(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.component)||null}),i=G(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.label)||""});Mt(i,o=>{e.groupLabel&&o&&(document.title=`Odin — ${e.groupLabel} › ${o}`)},{immediate:!0});function l(o,r){if(!["ArrowLeft","ArrowRight","Home","End"].includes(o.key))return;o.preventDefault();let c=r;o.key==="ArrowRight"&&(c=(r+1)%e.tabs.length),o.key==="ArrowLeft"&&(c=(r-1+e.tabs.length)%e.tabs.length),o.key==="Home"&&(c=0),o.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(a.value="Copied")}catch{e.value===u&&(a.value="Copy unavailable — select text manually")}}return Mt(()=>e.value,()=>{t.value=!1,a.value=""}),Mt(n,()=>{t.value=!1,a.value=""}),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},Hw={components:{ToolOutput:Xo},setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(p){var v,k,N,y,g,b,E,T,L,R,_;const f=p.payload||p,m=f.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(m)&&!(f.agent_id||(v=f.metadata)!=null&&v.agent_id))&&!(["loop_tool_start","loop_tool"].includes(m)&&!(f.call_id||(k=f.metadata)!=null&&k.call_id))){if(m==="tool_start"||m==="loop_tool_start"){const D=f.call_id||((N=f.metadata)==null?void 0:N.call_id)||null,$=f.agent_id||((y=f.metadata)==null?void 0:y.agent_id)||"",C={callId:D,agentId:$,agentLabel:f.agent_label||((g=f.metadata)==null?void 0:g.agent_label)||"",toolInput:f.tool_input,id:D?`${$}:${D}`:`${f.action}-${Date.now()}`,tool:f.action,actor:f.actor||"",channel:f.channel_id||"",iteration:f.iteration??((b=f.metadata)==null?void 0:b.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(C);return}if(m==="tool_end"||m==="loop_tool"){const D=f.call_id||((E=f.metadata)==null?void 0:E.call_id)||null,$=f.agent_id||((T=f.metadata)==null?void 0:T.agent_id)||"";let C=-1;if(D&&(C=e.value.findIndex(M=>M.callId===D&&M.agentId===$&&M.status==="running")),C<0&&!D)for(let M=e.value.length-1;M>=0;M--){const j=e.value[M];if(j.tool===f.action&&j.agentId===$&&j.status==="running"){C=M;break}}if(C>=0){const M=e.value[C];M.status=f.error||(L=f.metadata)!=null&&L.error||["error","failed","cancelled","denied","outcome_unknown"].includes(f.status||((R=f.metadata)==null?void 0:R.status))?"error":"success",M.elapsed=f.execution_time_ms??f.duration_ms??((_=f.metadata)==null?void 0:_.elapsed_ms)??Date.now()-M.startTime,M.result=f.result_summary??f.detail??"",M.fadingOut=!0,setTimeout(()=>{const j=e.value.indexOf(M);j>=0&&e.value.splice(j,1),t.value.unshift(M),t.value.length>n&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const D=f.call_id||f.tool_name||"unknown";if(f.finished){const $={...s.value};delete $[D],s.value=$}else{const C=((s.value[D]||"")+(f.chunk||"")).split(`
`);s.value={...s.value,[D]:C.slice(-30).join(`
...
... (truncated)`:s}function ip(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function xd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Ym(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Qm=Symbol("agent-detail-cancelled"),Vw=15e3;function qw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((f,m)=>{r=f,c=m});function u(f,m){o||(o=!0,l!==null&&a(l),l=null,(f?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return o||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Qm),i==null||i.abort()}}}function Xm({state:e,requestDetail:t,timeoutMs:s=Vw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const k=qw(N=>t(p,{signal:N}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=k.cancel,v.promise=(async()=>{let N=null,y=null;try{N=await k.promise}catch(g){y=g}N!==Qm&&(l!==v||e.detailId!==p||(l=null,!y&&(N===null||typeof N!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=N,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function Gw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const Kw={components:{ToolOutput:Xo},template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const o=G(()=>e.value.filter(I=>I.status==="running").length),r=G(()=>e.value.filter(I=>I.status==="completed").length),c=G(()=>e.value.filter(I=>["failed","timeout","killed"].includes(I.status)).length),d=G(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=G(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(I=>["failed","timeout","killed"].includes(I.status)):e.value.filter(I=>I.status===i.value));function p(I){const U=Number(I.max_iterations)||0;return U<=0?0:Math.min(100,Math.round(I.iteration_count/U*100))}function f(I){return(Number(I.max_iterations)||0)>0}function m(I,U){return I?I==="N/A"?"N/A":U==="current_inheritance"?`inherit (currently ${I})`:I:"unknown"}function v(I){return m(I.display_model,I.display_model_source||I.display_source)}function k(I){return m(I.display_reasoning_effort,I.display_reasoning_effort_source||I.display_source)}function N(I){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[I]||""}const y=h(null),g=h(null),b=h(!1),E=h(null),T=h(""),R=Xm({state:{get detail(){return y.value},set detail(I){y.value=I},get detailId(){return g.value},set detailId(I){g.value=I},get detailLoading(){return b.value},set detailLoading(I){b.value=I},get detailError(){return E.value},set detailError(I){E.value=I}},requestDetail:(I,{signal:U})=>z.get(`/api/agents/${encodeURIComponent(I)}`,{signal:U})});async function _(I){T.value="",await R.open(I.id)}function D(){R.close(),T.value=""}async function $(){await R.refresh()}async function C(I,U){try{await navigator.clipboard.writeText(U||""),T.value=I,setTimeout(()=>{T.value===I&&(T.value="")},1500)}catch{ye.error("Copy failed")}}async function M(I=!1){I=I===!0,I||(t.value=!0);try{const U=await z.get("/api/agents");e.value=Array.isArray(U)?U:[],s.value=null}catch(U){I||(s.value=U.message)}I||(t.value=!1)}async function j(I){const U=e.value.find(K=>K.id===I);if(await qt({title:"Kill agent",message:`Kill agent "${(U==null?void 0:U.label)||I}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=I;try{await z.del(`/api/agents/${encodeURIComponent(I)}`),ye.success("Agent killed"),await M()}catch(K){ye.error(K.message||"Failed to kill agent")}n.value=null}}const J=Gw({isEnabled:()=>a.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!g.value,refreshDetail:$});function A(){J.start()}function S(){J.stop()}return Mt(a,()=>J.sync()),je(()=>{l=!0,M(),A()}),Qt(()=>{l=!0,M(!0),A()}),Gt(()=>{l=!1,S()}),ft(()=>{l=!1,S(),R.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:Aa,formatDuration:ui,progressPercent:p,hasProgress:f,displayModelText:v,displayEffortText:k,displaySourceLabel:N,detail:y,detailId:g,detailLoading:b,detailError:E,copied:T,openDetail:_,closeDetail:D,copyText:C,fetchAgents:M,killAgent:j,startAutoRefresh:A,stopAutoRefresh:S}}},Ww={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),o=h(null),r=h(null),c=h(null),d=h(null),u=h(!1),p=h(null),f=h("");let m=!1;const k=Xm({state:{get detail(){return c.value},set detail(S){c.value=S},get detailId(){return d.value},set detailId(S){d.value=S},get detailLoading(){return u.value},set detailLoading(S){u.value=S},get detailError(){return p.value},set detailError(S){p.value=S}},detailLabel:"Loop detail",requestDetail:(S,{signal:I})=>z.get(`/api/loops/${encodeURIComponent(S)}?limit=100`,{signal:I})});async function N(S){f.value="",await k.open(S.id)}function y(){k.close(),f.value=""}async function g(S,I){try{await navigator.clipboard.writeText(I||""),f.value=S,setTimeout(()=>{f.value===S&&(f.value="")},1500)}catch{ye.error("Copy failed")}}const b=G(()=>e.value.reduce((S,I)=>S+(I.iteration_count||0),0)),E=G(()=>e.value.filter(S=>S.status==="running").length);function T(S){return S==="running"?"loop-status-running":S==="error"?"loop-status-error":"loop-status-stopped"}function L(S){return S==="running"?"badge-success":S==="error"?"badge-danger":S==="completed"?"badge-info":"badge-warning"}function R(S){return S==="act"?"badge-warning":S==="silent"?"badge-info":"badge-success"}async function _(S=!1){S=S===!0,S||(t.value=!0);try{const I=await z.get("/api/loops");e.value=Array.isArray(I)?I:[],s.value=null}catch(I){S||(s.value=I.message)}S||(t.value=!1)}async function D(){l.value=null;const S=a.value;if(!S.goal.trim()){l.value="Goal is required";return}if(!S.channel_id.trim()){l.value="Channel ID is required";return}const I={goal:S.goal.trim(),channel_id:S.channel_id.trim(),interval_seconds:S.interval_seconds||60,mode:S.mode,max_iterations:S.max_iterations||50};S.stop_condition.trim()&&(I.stop_condition=S.stop_condition.trim()),i.value=!0;try{const U=await z.post("/api/loops",I);ye.success(`Loop started: ${U.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await _()}catch(U){l.value=U.message}i.value=!1}async function $(S){if(await qt({title:"Stop loop",message:`Stop loop ${S}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=S;try{await z.del(`/api/loops/${encodeURIComponent(S)}`),ye.success("Loop stopped"),await _()}catch(U){ye.error(U.message||"Failed to stop loop")}o.value=null}}async function C(S){r.value=S;try{await z.post(`/api/loops/${encodeURIComponent(S)}/restart`),ye.success("Loop restarted"),await _()}catch(I){ye.error(I.message||"Failed to restart loop")}r.value=null}function M(S){m&&S.payload&&(S.payload.loop_id||S.payload.type==="loop")&&(_(!0),d.value&&k.refresh())}let j=null;function J(){j!==null&&clearInterval(j),j=null}function A(){J(),m&&(j=setInterval(()=>{_(!0),d.value&&k.refresh()},5e3))}return je(()=>{m=!0,_(),Ye.subscribe("events",M),A()}),Qt(()=>{m=!0,_(!0),A()}),Gt(()=>{m=!1,J()}),ft(()=>{m=!1,Ye.unsubscribe("events",M),J(),k.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:f,totalIterations:b,runningCount:E,statusDotClass:T,statusBadge:L,modeBadge:R,formatAge:Jm,formatDuration:ui,formatTs:Aa,formatTokens:Ym,openDetail:N,closeDetail:y,copyText:g,fetchLoops:_,doCreate:D,doStop:$,doRestart:C}}},Jw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),o=h(null),r=G(()=>Xw(a.value.run_at));Mt(()=>a.value.run_at,()=>{o.value=null});const c=G(()=>{var re;const q=r.value;return q.state==="ok"?q.instant:q.state==="ambiguous"&&o.value!==null&&((re=q.options[o.value])==null?void 0:re.instant)||null}),d=G(()=>{const q=c.value;return q?`${q.toLocaleString()} local — ${q.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=h(null),v=h(null),k=h(null),N=h(null),y=h(null),g=h(null),b=h([]),E=h(!1),T=h("");let L=0;const R=G(()=>e.value.filter(q=>q.cron&&!q.one_time).length),_=G(()=>e.value.filter(q=>q.one_time).length),D=G(()=>e.value.filter(q=>q.trigger).length),$=G(()=>e.value.filter(q=>q.paused).length),C=G(()=>e.value.filter(q=>q.consecutive_failures>0).length);function M(q){if(!q)return"-";const re=Date.now(),Ie=(new Date(q).getTime()-re)/1e3;if(Ie<0)return"overdue";if(Ie<60)return"in < 1 min";if(Ie<3600)return`in ${Math.floor(Ie/60)} min`;if(Ie<86400){const x=Math.floor(Ie/3600),F=Math.floor(Ie%3600/60);return F>0?`in ${x}h ${F}m`:`in ${x}h`}const w=Math.floor(Ie/86400);return`in ${w} day${w!==1?"s":""}`}function j(q){return q==null?"-":q<1e3?`${q}ms`:q<6e4?`${(q/1e3).toFixed(1)}s`:ui(q/1e3)}function J(q=a.value.cron){a.value.cron=q,lp(a.value,"cron"),u.value=null}function A(q=a.value.run_at){a.value.run_at=q,lp(a.value,"run_at"),u.value=null}async function S(){const q=a.value.cron.trim();if(q){p.value=!0;try{u.value=await z.post("/api/schedules/validate-cron",{expression:q})}catch(re){u.value={valid:!1,error:re.message}}p.value=!1}}async function I(){t.value=!0,s.value=null;try{e.value=await z.get("/api/schedules")}catch(q){s.value=q.message}t.value=!1}async function U(q){if(g.value===q){g.value=null,b.value=[];return}g.value=q,E.value=!0,b.value=[];const re=++L;try{const fe=await z.get(`/api/schedules/${encodeURIComponent(q)}/history?limit=10`);if(re!==L||g.value!==q)return;b.value=fe,T.value=""}catch(fe){if(re!==L||g.value!==q)return;b.value=[],T.value=fe.message||"Failed to load execution history"}re===L&&(E.value=!1)}async function V(){l.value=null;const q=a.value;if(!q.description.trim()){l.value="Description is required";return}if(!q.channel_id.trim()){l.value="Channel ID is required";return}if(!q.cron.trim()&&!q.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(q.cron.trim()&&q.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const re={description:q.description.trim(),action:q.action,channel_id:q.channel_id.trim()};if(q.cron.trim()&&(re.cron=q.cron.trim()),q.run_at.trim()){const fe=r.value;if(fe.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(fe.state==="invalid"){l.value="One-time run time is not a valid date";return}const Ie=c.value;if(fe.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Ie){l.value="One-time run time could not be resolved";return}re.run_at=Ie.toISOString()}if(q.action==="reminder"&&q.message.trim()&&(re.message=q.message.trim()),q.action==="check"&&(q.tool_name.trim()&&(re.tool_name=q.tool_name.trim()),q.report_format&&(re.report_format=q.report_format),q.tool_input_str.trim()))try{re.tool_input=JSON.parse(q.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await z.post("/api/schedules",re),ye.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await I()}catch(fe){l.value=fe.message}i.value=!1}async function K(q){m.value=q;try{const re=await z.post(`/api/schedules/${encodeURIComponent(q)}/run`);if(re.status==="failure")ye.error(`Execution failed: ${re.error||"unknown error"}`);else{const fe=re.warning?`Executed (${re.warning})`:"Executed successfully";ye.success(fe)}await I()}catch(re){ye.error(re.message||"Failed to trigger")}m.value=null}async function Y(q){k.value=q.id;const re=!q.paused;try{await z.put(`/api/schedules/${encodeURIComponent(q.id)}`,{paused:re}),ye.success(re?"Schedule paused":"Schedule resumed"),await I()}catch(fe){ye.error(fe.message||"Failed to update schedule")}k.value=null}const le=new Map;function se(q,re){const fe=le.get(q.id);fe&&clearTimeout(fe.timer);const Ie={run:()=>ce(q,re),timer:null};Ie.timer=setTimeout(()=>{le.delete(q.id),Ie.run()},500),le.set(q.id,Ie)}async function ce(q,re){y.value=q.id;try{await z.put(`/api/schedules/${encodeURIComponent(q.id)}`,{report_format:re}),ye.success(re?"Structured report enabled":"Plain-text report enabled")}catch(fe){ye.error(`Update failed: ${fe.message}`)}finally{await I(),y.value=null}}function Ne(){for(const[q,re]of[...le])clearTimeout(re.timer),le.delete(q),re.run()}async function ee(q){N.value=q;try{await z.post(`/api/schedules/${encodeURIComponent(q)}/reset-failures`),ye.success("Failure counters reset"),await I()}catch(re){ye.error(re.message||"Failed to reset")}N.value=null}async function ge(q){const re=e.value.find(Ie=>Ie.id===q);if(await qt({title:"Delete schedule",message:`Delete "${(re==null?void 0:re.description)||q}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=q;try{await z.del(`/api/schedules/${encodeURIComponent(q)}`),ye.success("Schedule deleted"),await I()}catch(Ie){ye.error(Ie.message||"Failed to delete schedule")}v.value=null}}return je(()=>{I()}),ft(Ne),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:f,runningId:m,deletingId:v,togglingId:k,resettingId:N,reportUpdatingId:y,flushReportFormatTimers:Ne,expandedId:g,history:b,historyLoading:E,historyError:T,cronCount:R,oneTimeCount:_,webhookCount:D,pausedCount:$,failingCount:C,formatTs:Aa,formatAge:Jm,formatFuture:M,formatMs:j,formatDuration:ui,onCronInput:J,onRunAtInput:A,validateCron:S,toggleExpand:U,fetchSchedules:I,doCreate:V,doRunNow:K,doTogglePause:Y,doUpdateReportFormat:se,doResetFailures:ee,doDelete:ge}}},ev=[{id:"live",label:"Live",component:Hw},{id:"agents",label:"Agents",component:Kw},{id:"loops",label:"Loops",component:Ww},{id:"processes",label:"Processes",component:Jw},{id:"schedules",label:"Schedules",component:ek}],tk={components:{TabbedPage:Qo},setup(){return{tabs:ev}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const o=h(null),r=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),m=h(!1),v=op,k=nk,N=h([]),y=h(!1),g=h(""),b=h("flat"),E=h(new Set),T=h(""),L=h(""),R=h(""),_=h(null),D=h(!1),$=h(""),C=h(!1);let M=0;Mt([T,L,R],()=>{M++,D.value=!1,$.value="",C.value=_.value!==null},{flush:"sync"});function j(){try{const ie=localStorage.getItem("odin-session-presets");ie&&(N.value=JSON.parse(ie))}catch{}}function J(){try{localStorage.setItem("odin-session-presets",JSON.stringify(N.value))}catch{}}const A=G(()=>p.value.trim()!==""||u.value!=="all"),S=G(()=>{let ie=[...e.value];const Se=op.find(Ve=>Ve.id===u.value),Le=Se?Se.filters:{};if(Le.source&&(ie=ie.filter(Ve=>Ve.source===Le.source)),Le.minMessages&&(ie=ie.filter(Ve=>Ve.message_count>=Le.minMessages)),Le.hasCompaction&&(ie=ie.filter(Ve=>Ve.has_summary)),Le.maxAge!=null){const Ve=Date.now()/1e3;ie=ie.filter($t=>$t.last_active&&Ve-$t.last_active<=Le.maxAge)}if(p.value.trim()){const Ve=p.value.toLowerCase().trim();ie=ie.filter($t=>($t.channel_id||"").toLowerCase().includes(Ve)||($t.last_user_id||"").toLowerCase().includes(Ve)||($t.source||"").toLowerCase().includes(Ve))}const Ke=f.value,Et=m.value?1:-1;return ie.sort((Ve,$t)=>{const zt=Ve[Ke]||0,rs=$t[Ke]||0;return(zt-rs)*Et}),ie}),I=G(()=>{if(!a.value||!a.value.messages)return[];const ie=a.value.messages;if(ie.length===0)return[];const Se=[];let Le=[];for(const Ke of ie)Ke.role==="user"&&Le.length>0&&(Se.push(Le),Le=[]),Le.push(Ke);return Le.length>0&&Se.push(Le),Se}),U=G(()=>S.value.length>0&&c.value.size===S.value.length);function V(ie){const Se=ie.find(Le=>Le.role==="user");if(Se&&Se.content){const Le=Se.content.slice(0,120);return Le.length<Se.content.length?Le+"...":Le}return"(no user message)"}function K(ie){const Se=new Set(E.value);Se.has(ie)?Se.delete(ie):Se.add(ie),E.value=Se}function Y(ie){u.value=ie}function le(ie){u.value=ie.id,ie.filters.searchQuery!=null&&(p.value=ie.filters.searchQuery),ie.filters.sortBy&&(f.value=ie.filters.sortBy)}function se(){if(!g.value.trim())return;const ie={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};N.value=[...N.value,ie],J(),y.value=!1,g.value=""}function ce(ie){N.value=N.value.filter(Se=>Se.id!==ie),J(),u.value===ie&&(u.value="all")}function Ne(){u.value="all",p.value="",f.value="last_active",m.value=!1}function ee(ie){if(!ie)return"—";const Se=Date.now()/1e3-ie;if(Se<60)return"just now";if(Se<3600){const Ke=Math.floor(Se/60);return`${Ke} minute${Ke!==1?"s":""} ago`}if(Se<86400){const Ke=Math.floor(Se/3600);return`${Ke} hour${Ke!==1?"s":""} ago`}const Le=Math.floor(Se/86400);return`${Le} day${Le!==1?"s":""} ago`}function ge(ie){if(!ie)return"";try{return new Date(ie*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function q(ie){if(!ie)return"";try{return new Date(ie*1e3).toLocaleString()}catch{return""}}function re(ie){return ie==="user"?"bg-gray-900/50 border border-gray-800":ie==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function fe(ie){return ie==="user"?"sess-msg-user":ie==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Ie(ie){return ie==="user"?"badge-info":ie==="assistant"?"badge-success":"badge-warning"}function w(ie){return ie==="user"?"sess-dot-user":ie==="assistant"?"sess-dot-assistant":"sess-dot-system"}function x(ie){return ie==="user"?"text-cyan-400":ie==="assistant"?"text-indigo-400":"text-gray-500"}function F(ie){return ie?ie.length>2e3?ie.slice(0,2e3)+`
... (truncated)`:ie:""}async function Q(){const ie=T.value.trim();if(!ie)return;const Se=++M;D.value=!0,$.value="",C.value=_.value!==null;try{let Le=`/api/sessions/search?q=${encodeURIComponent(ie)}&limit=50`;L.value.trim()&&(Le+=`&channel_id=${encodeURIComponent(L.value.trim())}`),R.value.trim()&&(Le+=`&user_id=${encodeURIComponent(R.value.trim())}`);const Ke=await z.get(Le);if(Se!==M)return;_.value=Ke.results||[],C.value=!1}catch(Le){if(Se!==M)return;$.value=Le.message||"Search failed. Please retry."}finally{Se===M&&(D.value=!1)}}function Z(){M++,T.value="",L.value="",R.value="",_.value=null,$.value="",C.value=!1,D.value=!1}function ne(ie){return ie?ie.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function pe(ie){return ie==="user"?"fts-result-user":ie==="assistant"?"fts-result-assistant":ie==="summary"?"fts-result-summary":ie==="fts"?"fts-result-fts":ie==="channel"?"fts-result-channel":"fts-result-default"}function ue(ie){return ie==="user"?"badge-info":ie==="assistant"?"badge-success":ie==="summary"?"badge-warning":ie==="fts"?"badge-success":"badge-info"}let de=0;async function oe(){const ie=++de;t.value=!0,s.value=null;try{const Se=await z.get("/api/sessions");if(ie!==de)return;e.value=Se}catch(Se){if(ie!==de)return;s.value=Se.message}ie===de&&(t.value=!1)}function xe(){s.value=null,oe()}async function me(ie){if(n.value===ie){n.value=null,a.value=null,E.value=new Set;return}n.value=ie,a.value=null,i.value=!0,E.value=new Set;const Se=++l;try{const Le=await z.get(`/api/sessions/${encodeURIComponent(ie)}`);Se===l&&n.value===ie&&(a.value=Le)}catch(Le){Se===l&&n.value===ie&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{Se===l&&(i.value=!1)}}function _e(ie){const Se=new Set(c.value);Se.has(ie)?Se.delete(ie):Se.add(ie),c.value=Se}function Re(){U.value?c.value=new Set:c.value=new Set(S.value.map(ie=>ie.channel_id))}function B(ie){o.value=ie}async function ve(){if(o.value){r.value=!0;try{await z.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await oe()}catch(ie){s.value=ie.message||"Failed to clear session"}r.value=!1,o.value=null}}function ke(){d.value=!0}async function Oe(){if(c.value.size!==0){r.value=!0;try{await z.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await oe()}catch(ie){s.value=ie.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Me(ie,Se){const Le=`/api/sessions/${encodeURIComponent(ie)}/export?format=${Se}`;try{const Ke=await z.getBlob(Le),Et=URL.createObjectURL(Ke),Ve=document.createElement("a");Ve.href=Et,Ve.download=`session-${ie}.${Se==="text"?"txt":"json"}`,Ve.click(),URL.revokeObjectURL(Et)}catch(Ke){s.value=Ke.message||"Failed to export session"}}let dt=null;function st(ie){ie.payload&&ie.payload.channel_id&&(clearTimeout(dt),dt=setTimeout(()=>{if(oe(),n.value&&ie.payload.channel_id===n.value){const Se=n.value,Le=l;z.get(`/api/sessions/${encodeURIComponent(Se)}`).then(Ke=>{Le!==l||n.value!==Se||(a.value=Ke)}).catch(()=>{})}},2e3))}let _t=!1,Ot=null;function rt(){_t||(_t=!0,oe(),Ye.subscribe("events",st),Ot=Ye.onReconnected(()=>oe()))}je(()=>{j(),rt()}),Qt(()=>{rt()});function Qe(){_t&&(_t=!1,Ye.unsubscribe("events",st),Ot&&(Ot(),Ot=null),clearTimeout(dt))}return Gt(Qe),ft(Qe),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:U,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:m,filterPresets:v,sortOptions:k,filteredSessions:S,hasActiveFilters:A,customPresets:N,showSavePreset:y,newPresetName:g,threadView:b,threads:I,collapsedThreads:E,ftsQuery:T,ftsChannelId:L,ftsUserId:R,ftsResults:_,ftsSearching:D,ftsError:$,ftsStale:C,formatAge:ee,formatTimestamp:ge,formatFullTimestamp:q,messageClass:re,threadMsgClass:fe,roleBadge:Ie,roleDotClass:w,roleLabelClass:x,truncateContent:F,threadSummary:V,fetchSessions:oe,retry:xe,toggleSession:me,toggleSelect:_e,toggleSelectAll:Re,confirmClear:B,clearSession:ve,confirmBulkClear:ke,doBulkClear:Oe,exportSession:Me,applyPreset:Y,applyCustomPreset:le,saveCustomPreset:se,removeCustomPreset:ce,resetFilters:Ne,toggleThread:K,runFtsSearch:Q,clearFtsSearch:Z,highlightSnippet:ne,ftsResultClass:pe,ftsTypeBadge:ue}}},ik={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:Ym}}},lk={components:{ContextAssemblyPanel:ik},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),o=h(""),r=h(0),c=h({}),d=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(L){if(!L)return"—";try{const R=new Date(L);return isNaN(R.getTime())?L:R.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return L}}function p(L){return!L&&L!==0?"—":L<1e3?L+"ms":(L/1e3).toFixed(1)+"s"}function f(L){return!L&&L!==0?"—":L>=1e3?(L/1e3).toFixed(1)+"k":String(L)}function m(L){if(!L)return"";if(typeof L=="string")return L;try{return JSON.stringify(L,null,2)}catch{return String(L)}}function v(L){a.value===L?a.value=null:(a.value=L,c.value={})}function k(L,R){const _=L+"-"+R;c.value={...c.value,[_]:!c.value[_]}}function N(L,R){return!!c.value[L+"-"+R]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,E()}async function g(){try{const L=await z.get("/api/trajectories");e.value=L.files||[],r.value=L.count||0}catch{}}let b=0;async function E(){const L=++b;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(o.value){const R=await z.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(L!==b)return;let _=R.entries||[];d.value.tool_name&&(_=_.filter(D=>(D.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(_=_.filter(D=>D.is_error)),d.value.channel_id&&(_=_.filter(D=>D.channel_id===d.value.channel_id)),d.value.user_id&&(_=_.filter(D=>D.user_id===d.value.user_id)),t.value=_}else{const R=new URLSearchParams;d.value.channel_id&&R.set("channel_id",d.value.channel_id),d.value.user_id&&R.set("user_id",d.value.user_id),d.value.tool_name&&R.set("tool_name",d.value.tool_name),d.value.errors_only&&R.set("errors_only","true"),R.set("limit",String(d.value.limit));const _=R.toString(),D=await z.get(`/api/trajectories/search/query?${_}`);if(L!==b)return;t.value=D.results||[]}}catch(R){if(L!==b)return;n.value=R.message}L===b&&(s.value=!1)}async function T(){if(!l.value.trim())return;const L=++b;s.value=!0,n.value=null,c.value={};try{const R=await z.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(L!==b)return;i.value=R.entry||null,i.value||(n.value="No trace found for this message ID")}catch(R){if(L!==b)return;R.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=R.message}L===b&&(s.value=!1)}return je(async()=>{await g(),await E()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:f,formatJSON:m,truncateBlock:Zm,toggleExpand:v,toggleIteration:k,isIterationExpanded:N,clearFilters:y,fetchFiles:g,fetchTraces:E,lookupMessage:T}}};function ok(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function rk(e){return e?`${e.approximate?"~":""}${xd(e.total||0)}`:"0"}const ck={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=h("7d"),i=h(0),l=h(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=G(()=>n.value.work||{}),f=G(()=>Math.max(1,...(n.value.activity_over_time||[]).map(T=>Number(T.count||0)))),m=G(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),v=T=>({height:`${Math.max(4,Math.round(Number(T||0)/f.value*100))}%`}),k=G(()=>s.value&&l.value-i.value>3e4);async function N(){const T=++d,L=a.value;try{const R=await z.get(`/api/usage?range=${encodeURIComponent(L)}`);if(T!==d||L!==a.value)return;n.value=R,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(R){T===d&&(t.value=R.message)}finally{T===d&&(e.value=!1)}}function y(T){a.value=T,e.value=!s.value,N()}function g(){e.value=!0,N()}function b(){c||(c=!0,N(),o=setInterval(N,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function E(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return je(b),Qt(b),Gt(E),ft(E),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:k,fmtNum:xd,fmtDuration:ok,tokenLabel:rk,activityTrackStyle:m,activityBar:v,selectRange:y,retry:g}}},tv=[{id:"audit",label:"Audit",component:sk},{id:"sessions",label:"Sessions",component:ak},{id:"traces",label:"Traces",component:lk},{id:"usage",label:"Usage & Activity",component:ck}],dk={components:{TabbedPage:Qo},setup(){return{tabs:tv}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},_r=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],uk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),o=h(null),r=h(null),c=h(!1),d=h(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(_){return _.source!=="builtin"?"":u[_.state]||""}function f(_,D){const $=_&&Array.isArray(_.tools)?_.tools:null;if(c.value=!!$,r.value=$?!!_.global_enabled:null,!$){e.value=D.map(j=>({...j,source:"unknown",enabled:void 0,state:null}));return}const C=new Set($.map(j=>j.name)),M=D.filter(j=>!C.has(j.name)).map(j=>({...j,source:j.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...$.map(j=>({...j,source:"builtin"})),...M]}async function m(_,D){if(d.value.has(_.name))return;const $=!!D.target.checked,C=new Set(d.value);C.add(_.name),d.value=C;try{const M=await z.post(`/api/tools/builtins/${encodeURIComponent(_.name)}/enabled`,{enabled:$});f(M,e.value),s.value=null;try{const j=await z.get("/api/tools");f(M,j)}catch(j){console.warn("Built-in toggle committed; visible catalog refresh failed",j)}}catch(M){D.target.checked=!!_.enabled,s.value=M.message||`Failed to toggle ${_.name}`}finally{const M=new Set(d.value);M.delete(_.name),d.value=M}}const v=G(()=>e.value.filter(_=>_.source==="builtin"&&_.is_core).length),k=G(()=>e.value.filter(_=>_.source==="skill").length),N=G(()=>Object.values(a.value).reduce((_,D)=>_+D,0));function y(_){for(const D of _r)if(D.id!=="other"&&D.match(_))return D.id;return"other"}const g=G(()=>{let _=e.value;if(n.value){const D=n.value.toLowerCase();_=_.filter($=>$.name.toLowerCase().includes(D)||($.description||"").toLowerCase().includes(D))}return o.value&&(_=_.filter(D=>y(D.name)===o.value)),_}),b=G(()=>{const _=new Set;for(const D of e.value)_.add(y(D.name));return _r.filter(D=>_.has(D.id))}),E=G(()=>{const _=g.value,D={};for(const C of _){const M=y(C.name);D[M]||(D[M]=[]),D[M].push(C)}const $=[];for(const C of _r)D[C.id]&&D[C.id].length>0&&$.push({label:C.label,icon:C.icon,tools:D[C.id].sort((M,j)=>M.name.localeCompare(j.name))});return $});function T(_){i.value={...i.value,[_]:!i.value[_]}}async function L(){t.value=!0,s.value=null;try{const[_,D,$]=await Promise.all([z.get("/api/tools"),z.get("/api/tools/stats").catch(()=>({})),z.get("/api/tools/builtins").catch(()=>null)]);f($,_),a.value=D||{}}catch(_){s.value=_.message}t.value=!1}function R(){L()}return je(()=>{L()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:k,totalUsage:N,filteredTools:g,groupedTools:E,usedCategories:b,stateBadge:p,applyInventory:f,toggleBuiltinTool:m,truncate:yd,toggleExpand:T,refresh:R}}};function pk(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function fk(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function $(se){return fk(se)}function C(se){n.value={...n.value,[se]:!n.value[se]}}async function M(se){try{await navigator.clipboard.writeText(se);const ce=e.value.find(Ne=>Ne.code===se);ce&&(o.value=ce.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function j(se){if(se.key==="Tab"){se.preventDefault();const ce=se.target,Ne=ce.selectionStart,ee=ce.selectionEnd;u.value=u.value.substring(0,Ne)+"    "+u.value.substring(ee),Rt(()=>{ce.selectionStart=ce.selectionEnd=Ne+4})}}function J(se){const ce=se.target.previousElementSibling;ce&&(ce.scrollTop=se.target.scrollTop)}async function A(){t.value=!0,s.value=null;try{e.value=await z.get("/api/skills")}catch(se){s.value=se.message}t.value=!1}async function S(se){i.value=se,delete a.value[se],a.value={...a.value};try{const ce=await z.post(`/api/skills/${encodeURIComponent(se)}/test`);a.value={...a.value,[se]:ce}}catch(ce){a.value={...a.value,[se]:{result:ce.message,is_error:!0}}}i.value=null}function I(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function U(se){r.value=!0,c.value="edit",d.value=se.name,u.value=se.code||"",p.value=null,f.value=null}function V(){r.value=!1,p.value=null,f.value=null}async function K(){p.value=null,f.value=null;const se=d.value.trim(),ce=u.value.trim();if(!se){p.value="Name is required";return}if(!ce){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await z.post("/api/skills",{name:se,code:ce}),f.value="Skill created successfully"):(await z.put(`/api/skills/${encodeURIComponent(se)}`,{code:ce}),f.value="Skill updated successfully"),await A(),setTimeout(()=>{r.value=!1},800)}catch(Ne){p.value=Ne.message}m.value=!1}function Y(se){k.value=se}async function le(){if(k.value){N.value=!0;try{await z.del(`/api/skills/${encodeURIComponent(k.value)}`),await A()}catch(se){ye.error(`Failed to delete skill: ${se.message||"unknown error"}`)}N.value=!1,k.value=null}}return je(()=>{A()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:v,deleteTarget:k,deleting:N,enabledCount:y,totalExecutions:g,totalLines:b,displayedSkills:E,editLineCount:T,editorLineNums:L,editValidation:R,highlight:_,truncate:yd,formatTs:Aa,countLines:D,getLineNumbers:$,toggleCode:C,copyCode:M,handleEditorKey:j,syncScroll:J,fetchSkills:A,testSkill:S,showCreate:I,editSkill:U,cancelEdit:V,saveSkill:K,confirmDelete:Y,doDelete:le}}};class Fs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const mk=/^[A-Za-z_][A-Za-z0-9_]*$/;function rp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function cp(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Fs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Fs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Fs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Fs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function vk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function gk(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Fs("Server name is required.","name");if(a.length>128||!mk.test(a))throw new Fs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Fs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=rp(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Fs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Fs("An HTTP endpoint is required for this connection.","url");if(d&&!vk(d))throw new Fs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Fs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=rp(e.allowlistText));const r=cp(e.headerRows,e.headersRemove,"Header"),c=cp(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function bk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function yk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function xk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const _k=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function wk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const kk=1e4,Sk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function wr(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function Tk(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Ck={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),o=h({}),r=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),m=h(wr()),v=h(""),k=h(!1);let N=null,y=0,g=!1,b=!1;const E=_k,T=G(()=>{var B;return((B=e.value)==null?void 0:B.servers)||[]}),L=G(()=>{var B;return!!((B=e.value)!=null&&B.enabled)}),R=G(()=>{var B,ve,ke,Oe;return{serverCount:((B=e.value)==null?void 0:B.server_count)||0,enabledCount:((ve=e.value)==null?void 0:ve.enabled_server_count)||0,connectedCount:((ke=e.value)==null?void 0:ke.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),_=G(()=>{var B;return((B=f.value)==null?void 0:B.header_keys)||[]}),D=G(()=>{var B;return((B=f.value)==null?void 0:B.env_keys)||[]}),$=G(()=>{var B;return u.value==="edit"&&((B=f.value)==null?void 0:B.transport)==="http"}),C=G(()=>u.value==="add"||!$.value),M=G(()=>$.value?"Replace endpoint URL":"Endpoint URL"),j=G(()=>$.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function J(){A(),N=window.setInterval(()=>S({quiet:!0}),kk)}function A(){N&&window.clearInterval(N),N=null}async function S({quiet:B=!1}={}){const ve=++y;B||(t.value=!0);try{const ke=await z.get("/api/mcp/status");if(ve!==y||!g)return;e.value=ke,n.value="";const Oe=new Set((ke.servers||[]).map(Me=>Me.name));i.value=new Set([...i.value].filter(Me=>Oe.has(Me)))}catch(ke){ve===y&&g&&(n.value=ke.message||"Failed to load MCP status")}finally{ve===y&&(t.value=!1)}}function I(B){return s.value||a.value.has(B)}function U(B,ve){const ke=new Set(a.value);ve?ke.add(B):ke.delete(B),a.value=ke}function V(B){return yk(B.state)}function K(B){if(V(B)==="disabled"){if(!B.enabled)return"Disabled — server switch off";if(!L.value)return"Disabled — global MCP is off"}return Sk[V(B)]}function Y(B){return B.transport==="http"?"Streamable HTTP":"stdio"}function le(B){return B.negotiated_version?`${B.era?`${String(B.era).charAt(0).toUpperCase()}${String(B.era).slice(1)}`:"Protocol"} · ${B.negotiated_version}`:"Not negotiated"}function se(B){return B.discovered_count?`${B.published_count||0} published · ${B.excluded_count||0} excluded`:"No tools discovered"}const ce=h(new Set);async function Ne(B,ve){if(ce.value.has(B.name))return;const ke=!!ve.target.checked,Oe=new Set(ce.value);Oe.add(B.name),ce.value=Oe;try{const Me=await z.post(`/api/mcp/servers/${encodeURIComponent(B.name)}/enabled`,{enabled:ke});Me&&Array.isArray(Me.servers)?e.value=Me:await S({quiet:!0})}catch(Me){ve.target.checked=!!B.enabled,ye.error(Me.message||`Failed to toggle ${B.name}`)}finally{const Me=new Set(ce.value);Me.delete(B.name),ce.value=Me}}async function ee(B){if(B!==L.value&&!(!B&&!await qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await z.post("/api/mcp/enabled",{enabled:B}),ye.success(B?"MCP enabled":"MCP disabled"),await S({quiet:!0})}catch(ve){ye.error(ve.message||"Failed to update MCP state"),await S({quiet:!0})}finally{s.value=!1}}}async function ge(B){U(B.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent(B.name)}/reconnect`,{}),ye.success(`Reconnected ${B.name}`)}catch(ve){ye.error(ve.message||`Failed to reconnect ${B.name}`)}finally{U(B.name,!1),await S({quiet:!0})}}async function q(B){U(B.name,!0);try{await z.post(`/api/mcp/servers/${encodeURIComponent(B.name)}/refresh-tools`,{}),ye.success(`Refreshed tools from ${B.name}`),await Ie(B.name,!0)}catch(ve){ye.error(ve.message||`Failed to refresh ${B.name}`)}finally{U(B.name,!1),await S({quiet:!0})}}async function re(B){if(await qt({title:`Remove ${B.name}`,message:`Remove this saved MCP server? Its ${B.published_count||0} published tool${B.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){U(B.name,!0);try{await z.del(`/api/mcp/servers/${encodeURIComponent(B.name)}`),ye.success(`Removed ${B.name}`),delete o.value[B.name]}catch(ke){ye.error(ke.message||`Failed to remove ${B.name}`)}finally{U(B.name,!1),await S({quiet:!0})}}}async function fe(B){const ve=new Set(i.value);if(ve.has(B.name)){ve.delete(B.name),i.value=ve;return}ve.add(B.name),i.value=ve,Object.hasOwn(o.value,B.name)||await Ie(B.name)}async function Ie(B,ve=!1){if(!ve&&Object.hasOwn(o.value,B))return;const ke=new Set(c.value);ke.add(B),c.value=ke,r.value={...r.value,[B]:""};try{const Oe=await z.get(`/api/mcp/servers/${encodeURIComponent(B)}/tools`);o.value={...o.value,[B]:Oe.tools||[]}}catch(Oe){r.value={...r.value,[B]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(c.value);Oe.delete(B),c.value=Oe}}function w(B){return(o.value[B]||[]).filter(ve=>xk(ve,l.value[B]))}function x(B,ve){l.value={...l.value,[B]:ve}}function F(){u.value="add",p.value="",f.value=null,m.value=wr(),v.value="",d.value=!0}function Q(B){u.value="edit",p.value=B.name,f.value=B,m.value={...wr(),name:B.name,enabled:!!B.enabled,transport:B.transport||"stdio"},v.value="",d.value=!0}function Z(){k.value||(d.value=!1)}function ne(B){d.value&&wk(B)}function pe(B){const ve=B==="headers"?"headerRows":"envRows";m.value[ve].push({key:"",value:""})}function ue(B,ve){const ke=B==="headers"?"headerRows":"envRows";m.value[ke].splice(ve,1)}function de(B,ve){const ke=B==="headers"?"headersRemove":"envRemove",Oe=m.value[ke];m.value[ke]=Oe.includes(ve)?Oe.filter(Me=>Me!==ve):[...Oe,ve]}async function oe(){var ve,ke;v.value="";let B;try{B=gk(m.value,{mode:u.value,originalTransport:((ve=f.value)==null?void 0:ve.transport)||""})}catch(Oe){v.value=Oe instanceof Fs?Oe.message:"Invalid MCP server configuration",await Rt(),(ke=document.querySelector(".mcp-editor"))==null||ke.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&bk(B,f.value)&&!await qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){k.value=!0;try{u.value==="add"?await z.post("/api/mcp/servers",B):await z.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,B),ye.success(u.value==="add"?`Saved ${B.name}`:`Updated ${p.value}`),d.value=!1,await S({quiet:!0})}catch(Oe){v.value=Oe.message||"Failed to save MCP server"}finally{k.value=!1}}}let xe=null;function me(B){`${(B==null?void 0:B.event)||""} ${(B==null?void 0:B.type)||""} ${(B==null?void 0:B.tool)||""} ${(B==null?void 0:B.message)||""}`.toLowerCase().includes("mcp")&&(xe&&window.clearTimeout(xe),xe=window.setTimeout(()=>S({quiet:!0}),200))}function _e(){g||(g=!0,b||(Ye.subscribe("events",me),b=!0),S(),J())}function Re(){g=!1,A(),xe&&window.clearTimeout(xe),xe=null,b&&(Ye.unsubscribe("events",me),b=!1)}return je(_e),Qt(_e),Gt(Re),ft(Re),{status:e,loading:t,mutating:s,pageError:n,servers:T,masterEnabled:L,aggregate:R,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:m,formError:v,saving:k,editorGroups:E,configuredHeaderKeys:_,configuredEnvKeys:D,savedHttpEndpoint:$,endpointRequired:C,endpointFieldLabel:M,endpointPlaceholder:j,refreshAll:S,busy:I,serverState:V,stateLabel:K,transportLabel:Y,protocolLabel:le,toolSummary:se,formatAge:Tk,setMasterEnabled:ee,togglePending:ce,toggleServerEnabled:Ne,reconnect:ge,refreshTools:q,removeServer:re,toggleTools:fe,filteredTools:w,setToolQuery:x,openAdd:F,openEdit:Q,closeEditor:Z,jumpToEditorGroup:ne,addSecretRow:pe,removeSecretRow:ue,toggleSecretRemoval:de,saveServer:oe}}};function Ek(e,t){if(!e||!t)return ip(e);const s=ip(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Ak={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),o=h(null),r=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),v=h(null);let k=null;const N=h(null),y=h(!1),g=h({}),b=h({}),E=h({}),T=h({}),L=new Map,R=h(null),_=G(()=>e.value.reduce((K,Y)=>K+(Y.chunks||0),0)),D=G(()=>new Set(e.value.map(Y=>Y.uploader).filter(Boolean)).size);function $(K,Y){const le=b.value[Y];if(!le||le.length===0)return 0;const se=Math.max(...le.map(ce=>ce.char_count||0));return se===0?0:Math.round(K.char_count/se*100)}async function C(){t.value=!0,s.value=null;try{const K=await z.get("/api/knowledge");e.value=Array.isArray(K)?K:[]}catch(K){s.value=K.message}t.value=!1}async function M(K){if(g.value[K]){g.value[K]=!1,R.value=null;return}if(g.value[K]=!0,Object.prototype.hasOwnProperty.call(b.value,K))return;if(L.has(K))return L.get(K);const Y={...T.value,[K]:!0};T.value=Y;const le={...E.value};delete le[K],E.value=le;const se=z.get(`/api/knowledge/${encodeURIComponent(K)}/chunks`).then(ce=>{b.value={...b.value,[K]:Array.isArray(ce)?ce:[]}}).catch(ce=>{E.value={...E.value,[K]:ce.message||"load failed"}}).finally(()=>{if(L.get(K)!==se)return;L.delete(K);const ce={...T.value};delete ce[K],T.value=ce});return L.set(K,se),se}let j=0;async function J(){const K=n.value.trim();if(!K)return;const Y=++j;i.value=!0,o.value=null,l.value=K;try{const le=await z.get(`/api/knowledge/search?q=${encodeURIComponent(K)}`);if(Y!==j)return;a.value=Array.isArray(le)?le:[]}catch(le){if(Y!==j)return;a.value=[],o.value=le.message||"Search failed"}Y===j&&(i.value=!1)}function A(){j+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function S(){u.value=null,p.value=null;const K=c.value.trim(),Y=d.value.trim();if(!K){u.value="Source name is required";return}if(!Y){u.value="Content is required";return}f.value=!0;try{const le=await z.post("/api/knowledge",{source:K,content:Y});p.value=`Ingested ${le.chunks||0} chunks from "${K}"`,c.value="",d.value="",b.value={},await C(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(le){u.value=le.message}f.value=!1}async function I(K){m.value=K,v.value=null,k&&(clearTimeout(k),k=null);try{const Y=await z.post(`/api/knowledge/${encodeURIComponent(K)}/reingest`);v.value={source:K,error:!1,message:`Re-ingested ${Y.chunks||0} chunks`},delete b.value[K],await C(),k=setTimeout(()=>{v.value=null,k=null},3e3)}catch(Y){v.value={source:K,error:!0,message:Y.message}}m.value=null}function U(K){N.value=K}async function V(){if(N.value){y.value=!0;try{await z.del(`/api/knowledge/${encodeURIComponent(N.value)}`),delete b.value[N.value],await C()}catch(K){ye.error(`Failed to delete source: ${K.message||"unknown error"}`)}y.value=!1,N.value=null}}return je(()=>{C()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:v,deleteTarget:N,deleting:y,expanded:g,sourceChunks:b,chunkErrors:E,loadingChunks:T,selectedChunk:R,totalChunks:_,uploaderCount:D,truncate:yd,formatTs:Aa,highlightTerms:Ek,chunkBarWidth:$,fetchSources:C,toggleSource:M,doSearch:J,clearSearch:A,doIngest:S,doReingest:I,confirmDelete:U,doDelete:V}}},Rk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),o=h(!1),r=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),m=h(!1),v=h(null),k=h(null),N=h(new Set),y=h(null),g=h(!1),b=h(!1),E=G(()=>e.value.reduce((Y,le)=>Y+le.count,0)),T=G(()=>N.value.size);function L(Y){const le=t.value[Y];if(!le)return[];if(!l.value.trim())return le;const se=l.value.trim().toLowerCase();return le.filter(ce=>ce.key.toLowerCase().includes(se)||ce.value&&ce.value.toLowerCase().includes(se))}function R(Y,le){return N.value.has(Y+"/"+le)}function _(Y,le){const se=Y+"/"+le,ce=new Set(N.value);ce.has(se)?ce.delete(se):ce.add(se),N.value=ce}function D(Y){const le=t.value[Y];return!le||le.length===0?!1:le.every(se=>N.value.has(Y+"/"+se.key))}function $(Y,le){const se=t.value[Y];if(!se)return;const ce=new Set(N.value);for(const Ne of se){const ee=Y+"/"+Ne.key;le?ce.add(ee):ce.delete(ee)}N.value=ce}async function C(){s.value=!0,n.value=null;try{const Y=await z.get("/api/memory");e.value=Object.entries(Y).map(([le,se])=>({name:le,keys:se.keys||[],count:se.count||0}))}catch(Y){n.value=Y.message}s.value=!1}async function M(Y){if(a.value[Y]){a.value[Y]=!1;return}a.value[Y]=!0;const le=e.value.find(ce=>ce.name===Y);if(!le||t.value[Y]||i.value===Y)return;i.value=Y;let se;try{const Ne=(await z.get(`/api/memory/${encodeURIComponent(Y)}`)).entries||{};se=le.keys.map(ee=>Object.prototype.hasOwnProperty.call(Ne,ee)?{key:ee,value:Ne[ee]||"",failed:!1}:{key:ee,value:"",failed:!0,error:"Not found in scope"})}catch(ce){se=le.keys.map(Ne=>({key:Ne,value:"",failed:!0,error:ce.message||"Failed to load"}))}t.value[Y]=se,i.value=null}function j(Y,le,se){p.value=Y+"/"+le,f.value=se}async function J(Y,le){m.value=!0,v.value=null;try{await z.put(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(le)}`,{value:f.value});const se=t.value[Y];if(se){const ce=se.find(Ne=>Ne.key===le);ce&&(ce.value=f.value)}p.value=null}catch(se){v.value=`Failed to save: ${se.message||"unknown error"}`}m.value=!1}async function A(Y,le){try{await navigator.clipboard.writeText(le.value),k.value=Y+"/"+le.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function S(){d.value=null,u.value=null;const Y=r.value.scope.trim(),le=r.value.key.trim(),se=r.value.value.trim();if(!Y){d.value="Scope is required";return}if(!le){d.value="Key is required";return}if(!se){d.value="Value is required";return}c.value=!0;try{await z.put(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(le)}`,{value:se}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await C(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ce){d.value=ce.message}c.value=!1}function I(Y,le){y.value={scope:Y,key:le}}async function U(){if(!y.value)return;g.value=!0,v.value=null;const{scope:Y,key:le}=y.value;try{await z.del(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(le)}`);const se=t.value[Y];se&&(t.value[Y]=se.filter(ee=>ee.key!==le));const ce=e.value.find(ee=>ee.name===Y);ce&&(ce.count--,ce.keys=ce.keys.filter(ee=>ee!==le));const Ne=new Set(N.value);Ne.delete(Y+"/"+le),N.value=Ne}catch(se){v.value=`Failed to delete: ${se.message||"unknown error"}`}g.value=!1,y.value=null}function V(){b.value=!0}async function K(){g.value=!0,v.value=null;const Y=[];for(const le of N.value){const se=le.indexOf("/");Y.push({scope:le.slice(0,se),key:le.slice(se+1)})}try{await z.post("/api/memory/bulk-delete",{entries:Y}),N.value=new Set,t.value={},await C()}catch(le){v.value=`Bulk delete failed: ${le.message||"unknown error"}`}g.value=!1,b.value=!1}return je(()=>{C()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:m,actionError:v,copied:k,selected:N,selectedCount:T,totalEntries:E,deleteTarget:y,deleting:g,showBulkDelete:b,fetchMemory:C,toggleScope:M,startEdit:j,doEdit:J,copyValue:A,doAdd:S,confirmDelete:I,doDelete:U,confirmBulkDelete:V,doBulkDelete:K,isSelected:R,toggleSelect:_,isScopeAllSelected:D,toggleSelectAll:$,filteredEntries:L}}},Ik={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),o=G(()=>[...new Set(e.value.map(k=>k.category))].sort()),r=G(()=>{const v={};return e.value.forEach(k=>{v[k.category]=(v[k.category]||0)+1}),v}),c=G(()=>a.value?e.value.filter(v=>v.category===a.value):e.value);function d(v){return v==="correction"?"badge-warning":v==="operational"?"badge-info":v==="preference"?"badge-success":"badge-info"}function u(v){i.value=v.key,l.value=v.content}async function p(v){try{await z.put("/api/learned/"+encodeURIComponent(v),{content:l.value}),i.value=null,ye.success("Entry updated"),await m()}catch(k){ye.error(k.message||"Failed to save entry")}}async function f(v){if(await qt({title:"Delete learned entry",message:`Delete "${v}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/learned/"+encodeURIComponent(v)),ye.success("Entry deleted"),await m()}catch(N){ye.error(N.message||"Failed to delete entry")}}async function m(){s.value=!0,n.value=null;try{const v=await z.get("/api/learned");e.value=v.entries||[],t.value={last_reflection:v.last_reflection,count:v.count}}catch(v){n.value=v.message}s.value=!1}return je(m),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:o,catCounts:r,filtered:c,catBadge:d,formatTs:Aa,startEdit:u,saveEdit:p,deleteEntry:f,fetchEntries:m}}},sv=[{id:"tools",label:"Tools",component:uk},{id:"skills",label:"Skills",component:hk},{id:"mcp-servers",label:"MCP Servers",component:Ck},{id:"knowledge",label:"Knowledge",component:Ak},{id:"memory",label:"Memory",component:Rk},{id:"learned",label:"Learned",component:Ik}],Ok={components:{TabbedPage:Qo},setup(){return{tabs:sv}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Lk={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Nk={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},Dk={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},Pk={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h(!1),a=h(!1),i=G(()=>e.value.components||[]),l=G(()=>Dk[e.value.overall]||"text-gray-400"),o=G(()=>e.value.overall==="healthy"?"success":e.value.overall==="degraded"?"warning":e.value.overall==="unhealthy"?"error":"minus"),r=G(()=>{const T=e.value.overall;return T==="healthy"?"All Systems Healthy":T==="degraded"?"Some Systems Degraded":T==="unhealthy"?"System Issues Detected":"Unknown"});function c(T){return Lk[T]||"text-gray-400"}function d(T){return Nk[T]||"info"}function u(T){return T==="ok"?"badge-success":T==="degraded"?"badge-warning":T==="down"?"badge-danger":"badge-info"}function p(T){return T==="closed"?"text-green-400":T==="half_open"?"text-yellow-400":T==="open"?"text-red-400":"text-gray-400"}function f(T){return T.replace(/_/g," ").replace(/\b\w/g,L=>L.toUpperCase())}function m(T){if(!T)return"—";try{return new Date(T).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return T}}function v(T){return T>=1e6?(T/1e6).toFixed(1)+"M":T>=1e3?(T/1e3).toFixed(1)+"K":String(T)}async function k(){a.value=!0;try{e.value=await z.get("/api/health/components"),s.value=null,n.value=!0}catch(T){s.value=T.message}finally{t.value=!1,a.value=!1}}function N(){t.value=!0,s.value=null,k()}let y=null,g=!1;function b(){g||(g=!0,k(),y||(y=setInterval(k,3e4)))}function E(){g&&(g=!1,y&&(clearInterval(y),y=null))}return je(b),Qt(b),Gt(E),ft(E),{data:e,hasData:n,loading:t,error:s,refreshing:a,components:i,overallColor:l,overallIcon:o,overallLabel:r,statusColor:c,statusIcon:d,badgeClass:u,circuitColor:p,formatName:f,formatTime:m,formatNumber:v,fetchHealth:k,retry:N}}},Mk={template:`
...
`);const we=new Blob([te],{type:"text/plain"}),$e=URL.createObjectURL(we),Je=document.createElement("a");Je.href=$e,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL($e)}function ue(te){const we=dp(te);navigator.clipboard.writeText(we).then(()=>{m.value=te.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function de(te){l.value=l.value===te?"":te,g.value="all"}function oe(te){return te.level==="ERROR"?"log-line-error":te.level==="WARNING"?"log-line-warning":"text-gray-300"}function xe(te){return te==="ERROR"?"text-red-500 font-semibold":te==="WARNING"?"text-yellow-500":"text-blue-500"}function me(te){return te==="ERROR"?"log-chip-error":te==="WARNING"?"log-chip-warning":"log-chip-info"}function _e(te){g.value=te.id;const we=te.filters;l.value=we.level||"",b.value=we.timeRange||"",o.value=we.text||"",we.levels&&(l.value=we.levels[0]||""),we.hasToolName&&(o.value="")}function Re(te){g.value=te.id,l.value=te.filters.level||"",b.value=te.filters.timeRange||"",o.value=te.filters.text||""}function B(){if(!L.value.trim())return;const te={id:"custom-"+Date.now(),name:L.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};E.value=[...E.value,te],D(),T.value=!1,L.value=""}function ve(te){E.value=E.value.filter(we=>we.id!==te),D(),g.value===te&&(g.value="all")}const ke=h("all"),Oe=h(""),Me=h(""),dt=h(""),st=h(""),_t=h(""),Ot=h(100),rt=Kk,Qe=h(!1),ie=h(!1),Se=h(""),Le=h([]),Ke=h(null),Et=h(null);function Ve(){e.value="search",Ke.value||$t()}async function $t(){try{Ke.value=await z.get("/api/logs/stats")}catch{}}function zt(){const te=_t.value;if(!te){dt.value="",st.value="";return}const $e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[te];if($e){const Je=new Date(Date.now()-$e*1e3);dt.value=rs(Je),st.value=""}}function rs(te){const we=$e=>String($e).padStart(2,"0");return`${te.getFullYear()}-${we(te.getMonth()+1)}-${we(te.getDate())}T${we(te.getHours())}:${we(te.getMinutes())}`}function Js(te){if(!te)return"";const we=new Date(te);return isNaN(we.getTime())?"":we.toISOString()}async function ks(){Qe.value=!0,Se.value="",ie.value=!0,Et.value=null;try{const te=new URLSearchParams;ke.value&&ke.value!=="all"&&te.set("level",ke.value),Oe.value&&te.set("tool",Oe.value),Me.value&&te.set("q",Me.value);const we=Js(dt.value),$e=Js(st.value);we&&te.set("start",we),$e&&te.set("end",$e),te.set("limit",String(Ot.value));const Je=await z.get(`/api/logs/search?${te.toString()}`);Le.value=Je.entries||[]}catch(te){Se.value=te.message||"Search failed",Le.value=[]}finally{Qe.value=!1}}function na(){ke.value="all",Oe.value="",Me.value="",dt.value="",st.value="",_t.value="",Ot.value=100,Le.value=[],ie.value=!1,Se.value="",Et.value=null}function Zs(te){Et.value=Et.value===te?null:te}function Ns(te){if(!te.timestamp)return"";try{return new Date(te.timestamp).toLocaleString()}catch{return te.timestamp}}function Mn(te){return te.type==="web_action"?`${te.status||""} (${te.execution_time_ms||0}ms)`:(te.result_summary||"").slice(0,200)}function Ss(te){return te.error?"log-line-error":"text-gray-300"}function Fn(te){try{return JSON.stringify(te,null,2)}catch{return String(te)}}let Lt=null,Xe=!1;function Ts(){Xe||(Xe=!0,Ye.subscribe("logs",se),c.value=Ye.connected,d.value=Ye.state||"disconnected",Lt=Ye.onState(te=>{d.value=te,c.value=te==="connected"}))}function Ds(){Xe&&(Xe=!1,Ye.unsubscribe("logs",se),Lt&&(Lt(),Lt=null))}return je(()=>{_(),window.addEventListener("pointerup",F),window.addEventListener("pointercancel",F)}),Qt(Ts),Gt(Ds),ft(()=>{Ds(),window.removeEventListener("pointerup",F),window.removeEventListener("pointercancel",F)}),{mode:e,logs:t,paused:a,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:n,groupedLogs:le,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:Y,pauseBuffer:R,showJumpBottom:f,copiedIndex:m,regexError:M,levels:k,logPresets:N,timeRanges:y,timeRange:b,activeLogPreset:g,customLogPresets:E,showSaveLogPreset:T,newLogPresetName:L,hasActiveLogFilters:$,timeRangeLabel:C,timelineBuckets:J,timelineMax:A,timelineSpanLabel:S,timelineLabelSkip:I,togglePause:Z,clearLogs:ne,exportLogs:pe,logLineClass:oe,levelClass:xe,levelChipClass:me,toggleLevel:de,copyLine:ue,jumpToBottom:ee,onScroll:q,onUserScrollIntent:fe,onUserScrollKey:Ie,onAutoScrollToggle:Q,onPointerDown:x,applyLogPreset:_e,applyCustomLogPreset:Re,saveLogCustomPreset:B,removeLogCustomPreset:ve,segmentHeight:V,jumpToTimelineBucket:K,searchLevel:ke,searchTool:Oe,searchKeyword:Me,searchStart:dt,searchEnd:st,searchTimePreset:_t,searchLimit:Ot,searchLimits:rt,searching:Qe,searchRan:ie,searchError:Se,searchResults:Le,searchStats:Ke,expandedSearch:Et,switchToSearch:Ve,runSearch:ks,clearSearchFilters:na,toggleSearchExpand:Zs,formatSearchTs:Ns,searchEntryText:Mn,searchLogLineClass:Ss,formatJson:Fn,applySearchTimePreset:zt}}};function Pl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const Jk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function Zk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Xa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Yk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},Ml=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord","computer"]),Qk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function pp(e){return Qk.some(t=>e===t||e.startsWith(`${t}.`))}const av="odin_config_center_expanded_v1",iv="odin_config_center_category_v1",Xk=50,eS=650,Sr=()=>z.get("/api/config/meta");function da(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Bi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Pa(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function tS(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function sS(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function lv(e,t){if(Bi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return da(t);const n={};for(const[a,i]of Object.entries(t)){const l=lv(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function nS(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=lv(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function ov(e,t,s,n){if(Bi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)ov(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function aS(){try{const e=JSON.parse(localStorage.getItem(av)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function iS(){try{const e=localStorage.getItem(iv);return Xa.some(t=>t.key===e)?e:Xa[0].key}catch{return Xa[0].key}}const lS={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),o=h(null),r=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(iS()),m=h(aS()),v=h({}),k=h({}),N=h(""),y=h({}),g=h({}),b=h([]),E=h([]),T=h(!1),L=h(!1),R=h(!1);let _=null,D=null,$={path:null,at:0},C=0;const M=G(()=>{var O;return(((O=t.value)==null?void 0:O.fields)||[]).filter(H=>!Ml.has(H.path.split(".")[0])&&!pp(H.path))}),j=G(()=>new Map(M.value.map(O=>[O.path,O]))),J=G(()=>V.value.reduce((O,H)=>O+H.sections.length,0)),A=G(()=>M.value.length),S=G(()=>Jk),I=G(()=>b.value.length>0),U=G(()=>E.value.length>0),V=G(()=>{if(!e.value)return[];const O=new Set(Xa.flatMap(Ee=>Ee.sections)),H=Xa.map(Ee=>({...Ee,sections:Ee.sections.filter(ct=>Object.hasOwn(e.value,ct)&&!Ml.has(ct))})).filter(Ee=>Ee.sections.length),X=Object.keys(e.value).filter(Ee=>!O.has(Ee)&&!Ml.has(Ee));return X.length&&H.push({key:"other",label:"Other",icon:"folder",sections:X}),H}),K=G(()=>e.value?{...e.value,...v.value}:null),Y=G(()=>{if(!e.value)return[];const O=[];for(const[H,X]of Object.entries(v.value))ov(e.value[H],X,H,O);return O.filter(H=>!Bi(H.oldVal,H.newVal)).map(H=>{const X=x(H.path);return{...H,label:(X==null?void 0:X.label)||Pa(H.path.split(".").at(-1)),apply_mode:(X==null?void 0:X.apply_mode)||de(H.path.split(".")[0])}})}),le=G(()=>Y.value.length>0),se=G(()=>Y.value.length),ce=G(()=>new Set(Y.value.map(O=>O.path.split(".")[0])).size),Ne=G(()=>!!u.value||p.value!=="all"),ee=G(()=>{const O={...g.value};for(const H of Y.value){const X=x(H.path),Ee=mi(X,H.newVal);Ee&&(O[H.path]=Ee)}return O}),ge=G(()=>Object.keys(ee.value).length>0),q=G(()=>e.value?(Ne.value?V.value:V.value.filter(H=>H.key===f.value)).map(H=>({...H,sections:H.sections.filter(X=>Qe(X))})).filter(H=>H.sections.length):[]),re=G(()=>{const O=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],H=new Map(O.map(X=>[X,[]]));for(const X of Y.value){const Ee=H.has(X.apply_mode)?X.apply_mode:"restart";H.get(Ee).push(X)}return O.filter(X=>H.get(X).length).map(X=>({key:X,label:Xt(X),entries:H.get(X)}))}),fe=G(()=>Y.value.filter(O=>O.apply_mode==="restart").length),Ie=G(()=>M.value.filter(O=>O.pending_restart)),w=G(()=>Ie.value.length);function x(O){const H=j.value.get(O);return H?{...H,apply_details:Pl([H])}:null}function F(O){const H=`${O}.`;return M.value.filter(X=>X.path===O||X.path.startsWith(H))}function Q(){return M.value.some(O=>O.path==="tools.hosts"||O.path.startsWith("tools.hosts."))}function Z(){var X,Ee;const O=((Ee=(X=e.value)==null?void 0:X.tools)==null?void 0:Ee.hosts)||{},H=Object.keys(O).length;return`${H} host${H===1?"":"s"} configured.`}function ne(O){return F(O).length}function pe(O){return Pa(O)}function ue(O){const H=F(O);if(!H.length)return`${Pa(O)} configuration.`;const X=H.find(Cs=>Cs.sensitivity==="public"&&Cs.description)||H.find(Cs=>Cs.description),Ee=(X==null?void 0:X.description)||"";return Ee.match(/setting for (.+)\.$/i)?`${Pa(O)} settings and runtime behaviour.`:Ee}function de(O){const H=[...new Set(F(O).map(X=>X.apply_mode))];return H.length===1?H[0]:H.includes("restart")?"restart":H.includes("activation_required")?"activation_required":H[0]||"restart"}function oe(O){const H=[...new Set(F(O).map(X=>Xt(X.apply_mode)))];return H.length?H.length===1?H[0]:`Mixed apply behaviour: ${H.join(" · ")}`:""}function xe(O){return Pl(F(O))}function me(O){var H;return Object.hasOwn(v.value,O)?v.value[O]:(H=e.value)==null?void 0:H[O]}function _e(){const O=me("mcp")||{},H=Object.keys(O.servers||{}).length;return`${O.enabled?"Globally enabled":"Globally disabled"} · ${H} configured server${H===1?"":"s"}.`}function Re(O,H){return H.split(".").reduce((X,Ee)=>X==null?void 0:X[Ee],O)}function B(O){const H=K.value;return F(O).filter(X=>pp(X.path)?!1:X.path.split(".").length<=2?!0:!X.path.includes(".*")).map(X=>({...X,key:X.path.split(".").at(-1),value:Re(H,X.path),apply_details:Pl([X]),editor:X.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ve(O){const H=O.path.split(".");return H.length>2?H.slice(0,2).join("."):null}function ke(O){const H=new Map;for(const X of B(O)){const Ee=ve(X),ct=Ee||`${O}.__root`;H.has(ct)||H.set(ct,{key:ct,path:Ee,entries:[]}),H.get(ct).entries.push(X)}return[...H.values()].map(X=>{const Ee=X.entries.find(ct=>ct.group_description);return{...X,label:X.path?Pa(X.path.split(".").at(-1)):null,description:(Ee==null?void 0:Ee.group_description)||null,apply_details:Pl(X.entries),runtime_summaries:Me(X.entries)}})}function Oe(O){return{save:O.save_effect||(O.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:O.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[O.apply_mode]||"Effective runtime state is not currently observable."}}function Me(O){const H=new Map;for(const X of O){const Ee=Oe(X),ct=`${X.apply_mode}|${Ee.save}|${Ee.runtime}`;H.has(ct)||H.set(ct,{key:ct,label:Xt(X.apply_mode),save:Ee.save,runtime:Ee.runtime})}return[...H.values()]}function dt(O){if(st(O))return O.runtime_effect||O.activation_policy||"";if(O.apply_mode==="activation_required"){const H=O.activation_policy||O.runtime_effect;return H?`Not active after saving. No activation control exists in this release. ${H}`:"Not active after saving; no activation control exists in this release."}return""}function st(O){return O.action_available===!0&&!!(O.action_label&&O.action_endpoint)}async function _t(O){if(st(O))try{if(Et(O.path))throw new Error("Save this setting before applying its action.");const H=String(O.action_method||"POST").toLowerCase(),X={post:z.post.bind(z),put:z.put.bind(z),delete:z.del.bind(z)}[H];if(!X)throw new Error("Unsupported configuration action");await X(O.action_endpoint,O.action_body||void 0),await De(),es("success",`${O.action_label} completed.`)}catch(H){es("error",H.message||`${O.action_label} failed`)}}function Ot(O,H){return[O.label,O.path,O.description,...O.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(H)}function rt(O){const H=u.value.trim().toLowerCase();return H?F(O).filter(X=>Ot(X,H)):[]}function Qe(O){const H=F(O);if(p.value!=="all"&&!H.some(Ee=>Ee.apply_state===p.value))return!1;const X=u.value.trim().toLowerCase();return!X||`${pe(O)} ${O}`.toLowerCase().includes(X)?!0:H.some(Ee=>Ot(Ee,X))}function ie(O,H){return F(O).filter(X=>X.apply_state===H).length}function Se(O){return O==="all"?A.value:M.value.filter(H=>H.apply_state===O).length}function Le(O){const H=O.sections.flatMap(X=>F(X));return{fields:H.length,modified:Y.value.filter(X=>O.sections.includes(X.path.split(".")[0])).length,pending_restart:H.filter(X=>X.apply_state==="pending_restart").length,invalid:H.filter(X=>X.apply_state==="invalid").length,dormant:H.filter(X=>X.apply_state==="dormant").length}}function Ke(O){var H;return Object.hasOwn(v.value,O)&&!Bi((H=e.value)==null?void 0:H[O],v.value[O])}function Et(O){return Y.value.some(H=>H.path===O||H.path.startsWith(`${O}.`))}function Ve(O){f.value=O,u.value="",p.value="all";try{localStorage.setItem(iv,O)}catch{}}function $t(O){p.value=O}function zt(){u.value="",p.value="all"}function rs(O){var H;return((H=V.value.find(X=>X.sections.includes(O)))==null?void 0:H.sections)||[]}function Js(O){const H=rs(O),X=H.find(Ee=>m.value[Ee]===!0);return X||H.find(Ee=>m.value[Ee]!==!1)||null}function ks(O){return u.value&&!R.value&&Qe(O)?!0:R.value?Js(O)===O:Object.hasOwn(m.value,O)?m.value[O]===!0:!0}function na(O){const H=!ks(O);if(R.value){const X={...m.value};for(const Ee of rs(O))X[Ee]===!0&&(X[Ee]=!1);X[O]=H,m.value=X;return}m.value={...m.value,[O]:H}}function Zs(){b.value.push(da(v.value)),b.value.length>Xk&&b.value.shift(),E.value=[]}function Ns(){le.value&&(Zs(),v.value={},g.value={},T.value=!1)}function Mn(O,H=!1){const X=Date.now();if(H&&$.path===O&&X-$.at<eS){$.at=X;return}Zs(),$={path:O,at:X}}function Ss(O,H,X){if(!H.length)return X;const Ee=da(O??{});let ct=Ee;for(let Cs=0;Cs<H.length-1;Cs+=1){const pn=H[Cs];ct[pn]=da(ct[pn]??{}),ct=ct[pn]}return ct[H.at(-1)]=X,Ee}function Fn(O){var H;return Object.hasOwn(v.value,O)?v.value[O]:da((H=e.value)==null?void 0:H[O])}function Lt(O,H,X={}){var Id;if(Ml.has(O.path.split(".")[0]))return;const[Ee,...ct]=O.path.split(".");Mn(O.path,!!X.coalesce);const Cs=Fn(Ee),pn=ct.length?Ss(Cs,ct,H):H,ia={...v.value};if(Bi(pn,(Id=e.value)==null?void 0:Id[Ee])?delete ia[Ee]:ia[Ee]=pn,v.value=ia,g.value[O.path]){const Od={...g.value};delete Od[O.path],g.value=Od}}function Xe(O){$={path:null,at:0},k.value={...k.value,[O]:String(Re(K.value,O)??"")}}function Ts(O){if($={path:null,at:0},!Object.hasOwn(k.value,O))return;const H={...k.value};delete H[O],k.value=H}function Ds(O){const H=k.value[O.path];if($={path:null,at:0},H===""){if(O.nullable){Ts(O.path),Lt(O,null,{coalesce:!0});return}g.value={...g.value,[O.path]:"Enter a number."};return}const X=Number(H);if(Number.isNaN(X)||O.type==="integer"&&!Number.isInteger(X)){g.value={...g.value,[O.path]:O.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ee={...k.value};delete Ee[O.path],k.value=Ee,Lt(O,X,{coalesce:!0})}function te(O){return Object.hasOwn(k.value,O.path)?k.value[O.path]:O.value??""}function we(O,H){if(k.value={...k.value,[O.path]:H},H===""){if(O.nullable){Lt(O,null,{coalesce:!0});return}g.value={...g.value,[O.path]:"Enter a number."};return}const X=Number(H);if(!Number.isFinite(X)||O.type==="integer"&&!Number.isInteger(X)){g.value={...g.value,[O.path]:O.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[O.path]){const Ee={...g.value};delete Ee[O.path],g.value=Ee}Lt(O,X,{coalesce:!0})}function $e(O){const H=Number.parseInt(N.value,10);if(!Number.isInteger(H)||H<1){g.value={...g.value,[O.path]:"Warning thresholds must be positive whole numbers."};return}const X=[...new Set([...O.value||[],H])].sort((Ee,ct)=>ct-Ee);N.value="",Lt(O,X)}function Je(O,H){Lt(O,(O.value||[]).filter(X=>X!==H))}function wt(O){return O.apply_mode==="live_read"?"Odin reads the saved file value on next use.":O.apply_mode==="live_for_new_work"?"New work uses the saved file value.":O.apply_mode==="live_apply"?O.apply_handler?`Apply the saved value through ${O.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":O.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":O.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":O.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ut(O){return O.type==="array"&&Array.isArray(O.value)&&!O.structured_container&&!O.structured_container_child&&O.sensitivity==="public"&&O.value.every(H=>["string","number","boolean"].includes(typeof H))}function $n(O){const H=String(y.value[O.path]??"").trim();if(!H)return;const X=[...new Set([...O.value||[],H])];y.value={...y.value,[O.path]:""},Lt(O,X)}function js(O,H){Lt(O,(O.value||[]).filter(X=>X!==H))}function mi(O,H){var Ee;if(!O)return null;if((Ee=O.enum)!=null&&Ee.length&&!O.enum.includes(H))return`Choose one of: ${O.enum.join(", ")}`;if(O.path==="agents.final_warning_iterations"&&(!Array.isArray(H)||!H.length))return"Add at least one warning threshold.";const X=O.constraints||{};if((O.type==="integer"||O.type==="number")&&typeof H=="number"){if(X.minimum!==void 0&&H<X.minimum)return`Must be at least ${X.minimum}${O.unit?` ${O.unit}`:""}`;if(X.maximum!==void 0&&H>X.maximum)return`Must be at most ${X.maximum}${O.unit?` ${O.unit}`:""}`}return null}function vi(O){return ee.value[O.path]||null}function Ia(O){const H=`${O}.`;return Object.keys(ee.value).some(X=>X===O||X.startsWith(H))}function aa(){b.value.length&&(E.value.push(da(v.value)),v.value=b.value.pop(),g.value={},k.value={},$={path:null,at:0})}function Un(){E.value.length&&(b.value.push(da(v.value)),v.value=E.value.pop(),g.value={},k.value={},$={path:null,at:0})}function Bn(){!le.value||ge.value||(T.value=!0,L.value=!1)}function Ys(){T.value=!1}function dn(){Ns()}function Xt(O){return Yk[O]||Pa(O||"unknown")}function Oa(O){return`apply-${String(O||"unknown").replaceAll("_","-")}`}function W(O){return`cfgc-field-${O.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function be(O){return`${W(O)}-input`}function Ae(O){const H=document.getElementById(W(O))||document.getElementById(W(O.split(".").slice(0,2).join(".")));H==null||H.scrollIntoView({behavior:"smooth",block:"center"})}function es(O,H){l.value={type:O,message:H},window.setTimeout(()=>{var X;((X=l.value)==null?void 0:X.message)===H&&(l.value=null)},3500)}function un(){r.value=!1,p.value="pending_restart",u.value="";const O=Zk(n.value);O&&(O.scrollTop=0)}function Hn(){r.value=!1}function Te(O=1800){D&&window.clearTimeout(D),D=window.setTimeout(P,O)}async function P(){if(c.value){if(C+=1,C>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await Sr(),w.value===0){c.value=!1,d.value=null,es("success","Odin restarted and the saved startup settings are active.");return}}catch{}Te(2e3)}}async function ae(){if(!c.value){d.value=null;try{await z.post("/api/restart",{}),c.value=!0,C=0,r.value=!1,Te()}catch(O){d.value=O.message||"Odin could not schedule a restart."}}}async function he(){if(!(!le.value||ge.value||a.value)){a.value=!0;try{const O=nS(e.value,v.value),H=await z.put("/api/config",O);e.value=H,v.value={},b.value=[],E.value=[],g.value={},T.value=!1;try{t.value=await Sr(),o.value=null,r.value=w.value>0,es("success",w.value?`Configuration saved. ${w.value} setting${w.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(X){o.value=X.message||"Unknown metadata error.",es("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(O){es("error",O.message||"Configuration could not be saved")}finally{a.value=!1}}}async function De(){var O,H;if(!le.value){s.value=!0,i.value=null;try{const X=await z.get("/api/config"),Ee=await Sr();e.value=X,t.value=Ee,o.value=null;const ct=V.value;if(ct.some(Cs=>Cs.key===f.value)||(f.value=((O=ct[0])==null?void 0:O.key)||Xa[0].key),R.value){const pn=(((H=ct.find(ia=>ia.key===f.value))==null?void 0:H.sections)||[]).find(ia=>m.value[ia]===!0);m.value=pn?{...m.value,[pn]:!0}:{}}}catch(X){i.value=X.message||"Unknown configuration error"}finally{s.value=!1}}}function Fe(O){if(T.value||!(O.ctrlKey||O.metaKey))return;const H=O.target;H instanceof HTMLElement&&(H.matches("input, textarea, select")||H.isContentEditable)||(!O.shiftKey&&O.key.toLowerCase()==="z"?(O.preventDefault(),aa()):(O.key.toLowerCase()==="y"||O.shiftKey&&O.key.toLowerCase()==="z")&&(O.preventDefault(),Un()))}function Be(O){R.value=O.matches}Mt(m,O=>{try{localStorage.setItem(av,JSON.stringify(O))}catch{}},{deep:!0});let yt=!1;function it(){yt||(yt=!0,document.addEventListener("keydown",Fe))}function vt(){yt&&(yt=!1,document.removeEventListener("keydown",Fe))}return je(()=>{var O;De(),it(),_=window.matchMedia("(max-width: 760px)"),Be(_),(O=_.addEventListener)==null||O.call(_,"change",Be)}),Qt(it),Gt(vt),ft(()=>{var O;vt(),(O=_==null?void 0:_.removeEventListener)==null||O.call(_,"change",Be),D&&window.clearTimeout(D)}),{armKeydown:it,disarmKeydown:vt,handleKeydown:Fe,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:T,mobileOverflowOpen:L,warningThresholdInput:N,arrayInputs:y,healthFilters:S,visibleCategories:V,displayGroups:q,reviewGroups:re,sectionCount:J,fieldCount:A,hasChanges:le,changeCount:se,changedSectionCount:ce,hasDraftErrors:ge,canUndo:I,canRedo:U,globalFilterActive:Ne,reviewRestartCount:fe,pendingRestartCount:w,pendingRestartFields:Ie,healthCount:Se,categoryStats:Le,selectCategory:Ve,selectHealthFilter:$t,clearFilters:zt,sectionLabel:pe,sectionDescription:ue,sectionFieldCount:ne,sectionHealthCount:ie,sectionApplySummary:oe,sectionApplyDetails:xe,sectionEntries:B,fieldGroups:ke,sectionSearchHits:rt,mcpConfigSummary:_e,fieldRuntimeCopy:Oe,fieldSpecificRuntimeNote:dt,hasHonestAction:st,runFieldAction:_t,hasHostsCollection:Q,hostsConfigSummary:Z,sectionChanged:Ke,fieldChanged:Et,isSectionExpanded:ks,toggleSection:na,discardAllDrafts:Ns,setFieldValue:Lt,setNumberFieldValue:we,numberInputValue:te,beginInputEdit:Xe,endTextInputEdit:Ts,endInputEdit:Ds,addWarningThreshold:$e,removeWarningThreshold:Je,isScalarArray:ut,addScalarArrayItem:$n,removeScalarArrayItem:js,fieldError:vi,sectionHasErrors:Ia,undo:aa,redo:Un,openReview:Bn,closeReview:Ys,mobileCancel:dn,applyModeLabel:Xt,applyClass:Oa,compactValue:tS,formatValue:sS,structuredApplyCopy:wt,fieldId:W,fieldInputId:be,focusField:Ae,fetchConfig:De,saveConfig:he,restartOdin:ae,restartLater:Hn,reviewPendingRestart:un}}},oS=/^\d{15,25}$/;function rv(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const cv={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=G(()=>new Set((e.excludedIds||[]).map(String))),o=G(()=>{const E=s.value.toLowerCase().trim();return(e.members||[]).filter(T=>l.value.has(String(T.id))?!1:E?u(T).toLowerCase().includes(E)||String(T.username||"").toLowerCase().includes(E)||String(T.id).includes(E):!0)}),r=G(()=>{const E=s.value.trim();return o.value.length===0&&oS.test(E)&&!l.value.has(E)?E:""}),c=G(()=>o.value.length+(r.value?1:0)),d=G(()=>{if(n.value){if(o.value[a.value])return`${e.optionsId}-${a.value}`;if(r.value&&a.value===o.value.length)return`${e.optionsId}-raw`}});function u(E){return rv(E)}function p(){n.value=!0,a.value=0}function f(){p()}function m(){const E=Math.max(c.value-1,0);a.value=Math.min(a.value+1,E)}function v(){a.value=Math.max(a.value-1,0)}function k(){const E=o.value[a.value];E?N(E):r.value&&a.value===o.value.length&&y(r.value)}function N(E){y(String(E.id))}function y(E){t("select",E),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function b(){setTimeout(g,150)}return je(()=>{e.autofocus&&Rt(()=>{var E;return(E=i.value)==null?void 0:E.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:m,highlightPrevious:v,selectHighlighted:k,selectMember:N,selectId:y,closeOptions:g,onBlur:b}}};function fp(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const rS={components:{DiscordUserCombobox:cv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h(null),i=h(null),l=h(!1),o=h(null),r=h({}),c=h([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=G(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),f=G(()=>new Map(c.value.map(A=>[String(A.id),A])));function m(A){return A.config&&A.config.enabled!==void 0?A.config.enabled:!0}function v(A){return fp(A,"require_mention",a.value)}function k(A){return fp(A,"respond_to_bots",a.value)}function N(A){return A.config&&Object.keys(A.config).length>0}function y(A){n.value[A]=!n.value[A]}function g(A){const S=A.discord||{};return{allowed_users:[...S.allowed_users||[]],channels:[...S.channels||[]],respond_to_bots:!!S.respond_to_bots,require_mention:!!S.require_mention,ignore_bot_ids:[...S.ignore_bot_ids||[]]}}async function b({showLoading:A=!0}={}){const S=++d;A&&(t.value=!0),s.value=null;try{const I=await z.get("/api/discord/guilds");S===d&&(e.value=I)}catch(I){S===d&&(s.value=I.message)}finally{A&&S===d&&(t.value=!1)}}async function E(){t.value=!0,s.value=null;try{const[A,S,I]=await Promise.all([z.get("/api/discord/guilds"),z.get("/api/discord/members").catch(()=>[]),z.get("/api/config")]),U=g(I),V=p.value;a.value=U,V||(i.value=JSON.parse(JSON.stringify(U))),c.value=S,e.value=A,o.value=null}catch(A){s.value=A.message}finally{t.value=!1}}let T=Promise.resolve();const L=h(new Set);function R(A,S){const I=new Set(L.value);I.add(A),L.value=I;const U=T.then(S);return T=U.catch(()=>{}),U.finally(()=>{const V=new Set(L.value);V.delete(A),L.value=V})}function _(A,S,I,U){const V=(U==null?void 0:U.target)??null;return R(`guild:${A}:${S}`,async()=>{try{await z.put("/api/discord/guild/"+A+"/config",{[S]:I}),await b({showLoading:!1})}catch(K){s.value=K.message,V&&typeof I=="boolean"&&(V.checked=!I)}})}function D(A,S,I,U,V){const K=(V==null?void 0:V.target)??null;return R(`channel:${A}:${I}`,async()=>{try{await z.put("/api/discord/channel/"+A+"/config",{[I]:U}),await b({showLoading:!1})}catch(Y){s.value=Y.message,K&&typeof U=="boolean"&&(K.checked=!U)}})}function $(A,S){return R(`channel:${A}:clear`,async()=>{try{await z.put("/api/discord/channel/"+A+"/config",{clear:!0}),await b({showLoading:!1})}catch(I){s.value=I.message}})}function C(A,S){const I=String(S);if(!A.userAutocomplete)return I;const U=f.value.get(I);return U?rv(U):I}function M(A,S=null){const I=String(S??r.value[A]??"").trim();!I||i.value[A].includes(I)||(i.value[A]=[...i.value[A],I],r.value={...r.value,[A]:""})}function j(A,S){i.value[A]=i.value[A].filter(I=>I!==S)}async function J(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const S=(await z.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...S.allowed_users||[]],channels:[...S.channels||[]],respond_to_bots:!!S.respond_to_bots,require_mention:!!S.require_mention,ignore_bot_ids:[...S.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(A){o.value=A.message||"Global defaults could not be saved."}finally{l.value=!1}}}return je(E),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:k,hasOverride:N,toggleGuild:y,fetchAll:E,fetchGuilds:b,setGuildConfig:_,setChannelConfig:D,clearOverride:$,mutationPending:L,globalItemLabel:C,addGlobalItem:M,removeGlobalItem:j,saveGlobalDefaults:J}}},Es=e=>e==null?e:JSON.parse(JSON.stringify(e));function cS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let f=null;const m=new Map;function v(T){d+=1;const L=c.then(T,T);return c=L.catch(()=>{}),L}function k(T,L){f=Es(T),m.clear();for(const[R,_]of Object.entries(L||{}))m.set(R,Es(_))}function N(T){const L=Es(T),R=++u;return v(async()=>{try{await e(Es(L)),f=Es(L),R===u&&n(Es(L))}catch(_){R===u&&(a(Es(f)),r(_,{kind:"default"}))}})}function y(T,L){const R=Es(L),_=(p.get(T)||0)+1;return p.set(T,_),v(async()=>{try{await t(T,Es(R)),m.set(T,Es(R)),_===p.get(T)&&i(T,Es(R))}catch(D){_===p.get(T)&&(l(T,Es(m.get(T)??null)),r(D,{kind:"user",uid:T}))}})}function g(T){const L=(p.get(T)||0)+1;return p.set(T,L),v(async()=>{try{await s(T),m.delete(T),L===p.get(T)&&o(T)}catch(R){L===p.get(T)&&(l(T,Es(m.get(T)??null)),r(R,{kind:"delete",uid:T}))}})}async function b(){for(;;){const T=c;if(await T,T===c)return d}}async function E(T){for(;;){const L=await b(),R=await T();if(L===d)return R}}return{seed:k,saveDefault:N,saveUser:y,deleteUser:g,whenIdle:b,readSnapshot:E,get revision(){return d}}}const dS={components:{DiscordUserCombobox:cv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({}),i=h({allowed_hosts:[],default_host:""}),l=h({}),o=h(!1),r=h([]),c=G(()=>{const C={};for(const M of r.value)C[M.id]=M;return C});function d(C){return c.value[C]||null}function u(C,M){return C?C.allowed_hosts===null||C.allowed_hosts===void 0?{allowed_hosts:[...M],default_host:C.default_host||"",allow_all:!0}:{allowed_hosts:C.allowed_hosts,default_host:C.default_host||"",allow_all:!1}:{allowed_hosts:[...M],default_host:M[0]||"",allow_all:!0}}const p=cS({applyDefault:async C=>{const M=C.allow_all?null:C.allowed_hosts;await z.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:C.default_host})},applyUser:async(C,M)=>{const j=M.allow_all?null:M.allowed_hosts;await z.put(`/api/host-access/user/${C}`,{allowed_hosts:j,default_host:M.default_host})},applyDelete:C=>z.del(`/api/host-access/user/${C}`),onDefaultConfirmed:()=>ye.success("Default policy updated"),onDefaultRollback:C=>{C&&(i.value=C)},onUserConfirmed:C=>{const M=d(C);ye.success(`Updated access for ${M?M.display_name:C}`)},onUserRollback:(C,M)=>{const j={...l.value};M?j[C]=M:delete j[C],l.value=j},onUserDeleted:C=>{const M={...l.value};delete M[C],l.value=M},onError:(C,M)=>{var J;const j=M.uid?` ${((J=d(M.uid))==null?void 0:J.display_name)||M.uid}`:"";ye.error(`${C.message||"Failed to save"} — reverted${j}`)}});let f=0;async function m(){const C=++f;e.value=!0,t.value="";try{const M=await p.readSnapshot(()=>z.get("/api/host-access"));if(C!==f)return;s.value=M,n.value=M.available_hosts||[],a.value=M.host_descriptions||{},i.value=u(M.default_policy,n.value);const j=M.users||{},J={};for(const[A,S]of Object.entries(j))J[A]=u(S,n.value);l.value=J,p.seed(i.value,J)}catch(M){C===f&&(t.value=M.message||"Failed to fetch host access data")}finally{C===f&&(e.value=!1)}try{const M=await z.get("/api/discord/members")||[];C===f&&(r.value=M)}catch{C===f&&(r.value=[])}}const v=500,k=new Map;function N(C,M){const j=k.get(C);j&&clearTimeout(j.timer);const J={run:M,timer:null};J.timer=setTimeout(()=>{k.delete(C),M()},v),k.set(C,J)}function y(C){const M=k.get(C);M&&(clearTimeout(M.timer),k.delete(C))}function g(){for(const[C,M]of[...k])clearTimeout(M.timer),k.delete(C),M.run()}function b(){N("default",()=>p.saveDefault(i.value))}function E(C,M){i.value.allow_all=!1,M?i.value.allowed_hosts.includes(C)||i.value.allowed_hosts.push(C):(i.value.allowed_hosts=i.value.allowed_hosts.filter(j=>j!==C),i.value.default_host===C&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function T(C){N(`user:${C}`,()=>{const M=l.value[C];M&&p.saveUser(C,M)})}function L(C,M,j){const J=l.value[C];J&&(J.allow_all=!1,j?J.allowed_hosts.includes(M)||J.allowed_hosts.push(M):(J.allowed_hosts=J.allowed_hosts.filter(A=>A!==M),J.default_host===M&&(J.default_host=J.allowed_hosts[0]||"")),T(C))}function R(C,M){const j=l.value[C];j&&(j.default_host=M,T(C))}function _(){o.value=!0}function D(C){!/^\d{15,25}$/.test(C)||l.value[C]||(l.value[C]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},p.saveUser(C,l.value[C]),o.value=!1)}async function $(C){const M=d(C);await qt({title:"Remove user override",message:`Remove the host access override for ${M?M.display_name:C}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(y(`user:${C}`),await p.deleteUser(C),l.value[C]||ye.success(`Removed override for ${M?M.display_name:C}`))}return je(m),Gt(g),ft(g),{loading:e,error:t,data:s,availableHosts:n,hostDescriptions:a,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:b,toggleDefaultHost:E,getMember:d,toggleUserHost:L,setUserDefault:R,openAddUser:_,addUserById:D,deleteUser:$,flushPendingSaves:g}}},uS={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=h([]),t=h(!1),s=h(""),n=h([]),a=h(!1),i=h(!1),l=h(1),o=h(""),r=h(!1),c=h(null),d=h(""),u=h([]),p=h(!1),f=h(null),m=h(""),v=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),k=h(v()),N=G(()=>["127.0.0.1","localhost","::1"].includes(k.value.address));async function y(){t.value=!0,s.value="";try{const J=await z.get("/api/hosts");e.value=J.hosts||[],o.value=J.default_host||"",r.value=!!J.tofu_enabled}catch(J){s.value=J.message}finally{t.value=!1}}async function g(){try{await z.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),ye.success("Host settings saved and published live"),await y()}catch(J){ye.error(J.message)}}function b(){d.value="",u.value=[],p.value=!1,f.value=null,c.value=null,m.value="",l.value=1,a.value=!0}function E(){i.value=!1,k.value=v(),b()}function T(J){i.value=!0,k.value={...v(),...J},b()}async function L(){try{c.value=await z.get("/api/hosts/public-key")}catch(J){ye.error(J.message)}}async function R(J){try{const A=await z.post("/api/hosts/"+encodeURIComponent(J.alias)+"/import-legacy",{});i.value=!0,k.value={...v(),...J,trust_mode:"pinned"},b(),d.value=A.candidate_token,u.value=A.fingerprints||[],m.value=u.value.join(`
`),l.value=4,ye.info("Imported existing known_hosts trust. Test before activation.")}catch(A){ye.error(A.message)}}async function _(){try{const J=m.value.split(/\s+/).filter(Boolean),A={...k.value,expected_fingerprints:J,candidate_fingerprints:u.value},S=await z.post("/api/hosts/candidates",A);if(d.value=S.candidate_token,u.value=S.fingerprints||[],k.value.trust_mode==="tofu"&&A.candidate_fingerprints.length===0){k.value.confirm_tofu=!1,ye.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(J){ye.error(J.message)}}async function D(){var J,A;p.value=!1,f.value=null;try{const S=await z.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!S.tested,f.value=S.last_test,p.value&&(l.value=5)}catch(S){const I=(J=S.data)==null?void 0:J.last_test;I&&typeof I=="object"&&!Array.isArray(I)&&(f.value=I);const U=(A=f.value)==null?void 0:A.detail;ye.error(typeof U=="string"&&U.trim()?U:S.message)}}async function $(){try{await z.post("/api/hosts/candidates/"+d.value+"/commit",{}),ye.success("Host saved and published live"),a.value=!1,await y()}catch(J){ye.error(J.message)}}async function C(J){try{await z.post("/api/hosts/"+encodeURIComponent(J.alias)+"/enabled",{enabled:!J.enabled}),await y()}catch(A){ye.error(A.message)}}async function M(J){var A;if(await qt("Delete host "+J.alias+"? Dependencies will block deletion.")){n.value=[];try{await z.del("/api/hosts/"+encodeURIComponent(J.alias)),await y()}catch(S){n.value=Array.isArray((A=S.data)==null?void 0:A.pending_references)?S.data.pending_references:[],ye.error(S.message)}}}async function j(J){if(await qt("Force revoke "+J.alias+"? Remote outcomes may be unknown."))try{await z.post("/api/hosts/"+encodeURIComponent(J.alias)+"/force-revoke",{}),await y()}catch(A){ye.error(A.message)}}return je(y),{hosts:e,loading:t,error:s,pendingReferences:n,wizard:a,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:k,isLocal:N,keyInfo:c,candidate:d,observed:u,tested:p,testResult:f,fingerprintsText:m,load:y,saveSettings:g,beginAdd:E,beginEdit:T,loadKey:L,importLegacy:R,prepare:_,testConnection:D,commit:$,toggle:C,remove:M,forceRevoke:j}}},pS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),o=h(null),r=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=G(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=G(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(R){return R==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":R==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const R=await z.get("/api/tokens");s.value=R.tokens||[],n.value=R.available_hosts||[]}catch(R){t.value=R.message||"Failed to load tokens"}finally{e.value=!1}}function v(R){return!R||!R.trim()?[]:R.split(",").map(_=>_.trim()).filter(Boolean)}function k(R,_){const D=c.value.allowed_hosts;if(_&&!D.includes(R)&&D.push(R),!_){const $=D.indexOf(R);$>=0&&D.splice($,1)}}function N(R,_){const D=d.value.allowed_hosts;if(_&&!D.includes(R)&&D.push(R),!_){const $=D.indexOf(R);$>=0&&D.splice($,1)}}async function y(){var R;i.value=!0;try{const _=v(c.value.allowed_tools_str),D=c.value.host_mode,$=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,C={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:_.length?_:[]};$!==null&&(C.allowed_hosts=$),C.default_host=c.value.default_host||"";const M=await z.post("/api/tokens",C);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ye.success("Token created"),await m()}catch(_){ye.error(((R=_.data)==null?void 0:R.error)||_.message||"Failed to create token")}finally{i.value=!1}}function g(R){o.value=R;const _=R.allowed_hosts;let D="default";_==null?D="default":Array.isArray(_)&&_.length===0?D="none":Array.isArray(_)&&(D="select"),d.value={username:R.username||"",tier:R.tier||"admin",label:R.label||"",host_mode:D,allowed_hosts:Array.isArray(_)?[..._]:[],default_host:R.default_host||"",allowed_tools_str:(R.allowed_tools||[]).join(", ")}}async function b(){var R;if(o.value){r.value=!0;try{const _=v(d.value.allowed_tools_str),D=d.value.host_mode,$={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:_};D==="none"?$.allowed_hosts=[]:D==="select"?$.allowed_hosts=d.value.allowed_hosts:$.allowed_hosts=null,$.default_host=d.value.default_host||"",await z.put("/api/tokens/"+encodeURIComponent(o.value.user_id),$),o.value=null,ye.success("Token updated"),await m()}catch(_){ye.error(((R=_.data)==null?void 0:R.error)||_.message||"Failed to update")}finally{r.value=!1}}}async function E(R){var D;if(await qt({title:"Regenerate token",message:`Regenerate token for ${R.username||R.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const $=await z.post("/api/tokens/"+encodeURIComponent(R.user_id)+"/regenerate");l.value=$.token,ye.success("Token regenerated")}catch($){ye.error(((D=$.data)==null?void 0:D.error)||$.message||"Failed to regenerate")}}async function T(R){var D;if(await qt({title:"Delete token",message:`Delete token for ${R.username||R.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/tokens/"+encodeURIComponent(R.user_id)),ye.success("Token deleted"),await m()}catch($){ye.error(((D=$.data)==null?void 0:D.error)||$.message||"Failed to delete")}}async function L(){if(l.value)try{await navigator.clipboard.writeText(l.value),ye.success("Copied to clipboard")}catch{ye.error("Copy failed — select and copy manually")}}return je(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:f,toggleCreateHost:k,toggleEditHost:N,createToken:y,startEdit:g,saveEdit:b,confirmRegenerate:E,confirmDelete:T,copyToken:L}}},fS=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),hS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),mS=Object.freeze(["enabled","base_url","model","max_tokens"]),vS=Object.freeze(["enabled","model","max_tokens"]);function er(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function hp(e){return er(e,fS)}function mp(e){return er(e,hS)}function gS(e,{includeApiKey:t=!1}={}){const s=er(e,mS);return t&&(s.api_key=e.api_key),s}function bS(e){return{timeout:e.timeout}}function yS(e,{includeApiKey:t=!1}={}){const s=er(e,vS);return t&&(s.api_key=e.api_key),s}function xS(e){return{timeout:e.timeout}}function Fl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const _S={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("codex"),a=h({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],l=G(()=>{const W=a.value.model;return W&&!i.includes(W)?[W,...i]:i}),o=G(()=>{const W=a.value.agent_model;return W&&W!=="auto"&&!i.includes(W)?[W,...i]:i}),r={"gpt-5.5":["max"],"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},c=(W,be)=>!!W&&!!be&&(r[W]||[]).includes(be),d=W=>!c(a.value.model,W)&&!(a.value.agent_reasoning_effort===""&&c(a.value.agent_model,W)),u=W=>{const be=a.value.agent_model;return be==="auto"?!0:!c(be||a.value.model,W)},p=G(()=>{const W=a.value.agent_reasoning_effort;return W==="auto"?null:W||a.value.reasoning_effort}),f=W=>c(W,a.value.reasoning_effort)||a.value.agent_model===""&&c(W,p.value),m=W=>c(W,p.value),v=h({enabled:!1,model:"gpt-5.6-luna"}),k=h({unavailable_reason:null}),N=G(()=>{const W=v.value.model;return W&&!i.includes(W)?[W,...i]:i});function y(W){const be=W.target.value;v.value.enabled=be!=="",be!==""&&(v.value.model=be),te()}const g=h(!1),b=h({codex:!1,ollama:!1,kimi:!1}),E=h(null),T=h(!1),L=h(""),R=h(null),_=h(!1);let D=0;const $=G(()=>{var W;return Object.entries(((W=E.value)==null?void 0:W.models)||{}).map(([be,Ae])=>{var es,un,Hn;return{model:be,floor:Ae.floor,override:Ae.override,effectiveBudget:(es=Ae.effective)==null?void 0:es.effective_budget,configuredPrimaryChars:(un=Ae.configured)==null?void 0:un.primary_chars,primaryChars:(Hn=Ae.effective)==null?void 0:Hn.primary_chars,provenance:Ae.provenance,clampExpiresAt:Ae.clamp_expires_at,densityPriorMilli:Ae.density_prior_milli,densityScope:Ae.density_scope,workloadCalibration:Ae.workload_calibration}})}),C=G(()=>{var W;return((W=E.value)==null?void 0:W.clamps)||[]}),M=G(()=>{var W,be;return((be=(W=E.value)==null?void 0:W.models)==null?void 0:be[a.value.model])||null}),j=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),J=h({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),A=h(!1),S=h(!1),I=h(!1),U=h(!1),V=h(!1),K=h(!1),Y=h(!1),le=h({configured:null}),se=h(!1),ce=h([]),Ne=h(""),ee=h(!1),ge=h(!1),q=h({configured:null}),re=h(!1),fe=h([]),Ie=h(""),w=h(!1),x=h(!1),F=h(!0),Q=h(""),Z=h({configured:null,accounts:[]}),ne=h(null),pe=h(null),ue=h(""),de=h(null),oe=h(!1),xe=h(null),me=h(null),_e=h("");let Re=null;function B(W,be="success"){ye(W,be==="error"?"error":"success")}function ve(W){if(!W)return"?";const be=W/(1024*1024*1024);return be>=1?be.toFixed(1)+" GB":(W/(1024*1024)).toFixed(0)+" MB"}function ke(W){return Number.isFinite(Number(W))?Number(W).toLocaleString():"—"}function Oe(W){return W==null?"automatic (model-derived)":Number(W).toLocaleString()+" characters"}function Me(W){const be=new Date(W);return Number.isNaN(be.getTime())?"unknown":be.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function dt(W){return typeof W=="string"&&W.length>12?W.slice(0,8)+"…"+W.slice(-4):W}function st(W){return typeof W!="number"||!Number.isFinite(W)?"—":(W/1e3).toFixed(2)}function _t(W){return W==="temporary learned clamp"?"is-clamp":W==="override"?"is-override":"is-built-in"}function Ot(W){const be=a.value.context_budget_overrides[W.model];return W.floor!=null&&Number.isFinite(Number(be))&&Number(be)>W.floor}function rt(W,be){const Ae={...a.value.context_budget_overrides};be.target.value===""?delete Ae[W]:Ae[W]=Number(be.target.value),a.value.context_budget_overrides=Ae,_.value=!0}function Qe(W){a.value.context_utilization=W.target.value===""?"":Number(W.target.value),_.value=!0}function ie(W){const be={...a.value.context_budget_overrides};delete be[W],a.value.context_budget_overrides=be,_.value=!0}async function Se(){e.value=!0,await Promise.all([Le(),Et(),ks(),Ve(),Ke()]),e.value=!1}async function Le({preserveBasic:W=!1,preserveAdvanced:be=!1}={}){try{const Ae=await z.get("/api/llm/status");t.value=Ae,s.value=!1,n.value=Ae.active_provider||"codex",Ae.codex&&!Ds.pending()&&(W||(a.value.enabled=Ae.codex.enabled,a.value.model=Ae.codex.model||"gpt-5.6-sol",a.value.reasoning_effort=Ae.codex.reasoning_effort||"medium",a.value.agent_reasoning_effort=Ae.codex.agent_reasoning_effort||"",a.value.agent_model=Ae.codex.agent_model||""),be||(a.value.request_timeout_seconds=Ae.codex.request_timeout_seconds??a.value.request_timeout_seconds,a.value.stream_stall_timeout_seconds=Ae.codex.stream_stall_timeout_seconds??a.value.stream_stall_timeout_seconds,a.value.retry={...a.value.retry,...Ae.codex.retry||{}},a.value.connection_pool={...a.value.connection_pool,...Ae.codex.connection_pool||{}},a.value.context_compression={...a.value.context_compression,...Ae.codex.context_compression||{}},!_.value&&!I.value&&(a.value.context_budget_overrides={...Ae.codex.context_budget_overrides||{}},a.value.context_utilization=Ae.codex.context_utilization??a.value.context_utilization))),Ae.ollama&&!we.pending()&&(W||(j.value.enabled=Ae.ollama.enabled,j.value.base_url=Ae.ollama.base_url||"",j.value.model=Ae.ollama.model||"",j.value.max_tokens=Ae.ollama.max_tokens||4096),be||(j.value.timeout=Ae.ollama.timeout??j.value.timeout)),Ae.kimi&&!$e.pending()&&(W||(J.value.enabled=Ae.kimi.enabled,J.value.model=Ae.kimi.model||"",J.value.max_tokens=Ae.kimi.max_tokens||4096),be||(J.value.timeout=Ae.kimi.timeout??J.value.timeout)),Ae.auxiliary&&(k.value=Ae.auxiliary,te.pending()||(v.value.enabled=Ae.auxiliary.enabled,v.value.model=Ae.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function Ke(){const W=++D;T.value=!0,L.value="";try{const be=await z.get("/api/context/windows");if(W!==D)return;E.value=be,!I.value&&!_.value&&(a.value.context_budget_overrides=Object.fromEntries(Object.entries(be.models||{}).filter(([,Ae])=>Ae.override!=null).map(([Ae,es])=>[Ae,es.override])),a.value.context_utilization=be.utilization??a.value.context_utilization)}catch(be){W===D&&(L.value=be.message||"Failed to load context budgets")}finally{W===D&&(T.value=!1)}}async function Et(){try{if(le.value=await z.get("/api/ollama/status"),se.value=!1,le.value.model&&(Ne.value=le.value.model),le.value.configured)try{const W=await z.get("/api/ollama/models");ce.value=W.models||[]}catch{ce.value=[]}else if(j.value.base_url)try{const W=await z.post("/api/ollama/probe-models",{base_url:j.value.base_url});ce.value=W.models||[]}catch{ce.value=[]}}catch{se.value=!0}}async function Ve(){F.value=!0,Q.value="";try{Z.value=await z.get("/api/codex/status")}catch(W){Q.value=W.message||"Failed to fetch Codex status"}finally{F.value=!1}}async function $t(){const W=t.value?t.value.active_provider:"codex";Y.value=!0;try{const be=await z.post("/api/llm/switch",{provider:n.value});be.error?(n.value=W,B(be.error,"error")):(B("Switched to "+n.value+" ("+be.model+")"),await Se())}catch(be){n.value=W,B(be.message||"Switch failed","error")}finally{Y.value=!1}}async function zt(){ee.value=!0;try{const W=await z.post("/api/ollama/reload");B(W.configured?"Ollama reloaded":W.reason||"Ollama not configured",W.configured?"success":"error"),await Se()}catch(W){B(W.message||"Reload failed","error")}finally{ee.value=!1}}async function rs(){ge.value=!0;try{await z.post("/api/ollama/model",{model:Ne.value}),B("Model set to "+Ne.value),await Se()}catch(W){B(W.message||"Failed","error")}finally{ge.value=!1}}async function Js(){const W=j.value.base_url;if(!W){B("Enter a base URL first","error");return}K.value=!0;try{const be=await z.post("/api/ollama/probe-models",{base_url:W});ce.value=be.models||[],ce.value.length?(B(ce.value.length+" model(s) found"),!j.value.model&&ce.value.length&&(j.value.model=ce.value[0].name)):B("No models found at "+W,"error")}catch(be){B(be.message||"Could not reach Ollama","error")}finally{K.value=!1}}async function ks(){try{if(q.value=await z.get("/api/kimi/status"),re.value=!1,q.value.model&&(Ie.value=q.value.model),q.value.configured)try{const W=await z.get("/api/kimi/models");fe.value=W.models||[]}catch{fe.value=[]}}catch{re.value=!0}}async function na(){w.value=!0;try{const W=await z.post("/api/kimi/reload");B(W.configured?"Kimi reloaded":W.reason||"Kimi not configured",W.configured?"success":"error"),await Se()}catch(W){B(W.message||"Reload failed","error")}finally{w.value=!1}}async function Zs(){x.value=!0;try{await z.post("/api/kimi/model",{model:Ie.value}),B("Model set to "+Ie.value),await Se()}catch(W){B(W.message||"Failed","error")}finally{x.value=!1}}async function Ns(){if(I.value){Ds();return}I.value=!0;const W=hp(a.value);try{await z.put("/api/llm/codex/config",W),B("Codex config saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ve()])}catch(be){B(be.message||"Failed","error");const Ae=JSON.stringify(hp(a.value))!==JSON.stringify(W);await Promise.all([Le({preserveBasic:Ae,preserveAdvanced:!0}),Ve()])}finally{I.value=!1}}async function Mn(){if(I.value)return;I.value=!0;const W=mp(a.value);try{await z.put("/api/llm/codex/config",W),JSON.stringify({context_budget_overrides:a.value.context_budget_overrides,context_utilization:a.value.context_utilization})===JSON.stringify({context_budget_overrides:W.context_budget_overrides,context_utilization:W.context_utilization})&&(_.value=!1),B("Codex advanced settings saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Ve(),Ke()])}catch(be){B(be.message||"Failed","error");const Ae=JSON.stringify(mp(a.value))!==JSON.stringify(W);await Promise.all([Le({preserveBasic:!0,preserveAdvanced:Ae}),Ve(),Ke()])}finally{I.value=!1}}async function Ss(){if(U.value){we();return}U.value=!0;try{const W=A.value?j.value.api_key:null,be=gS(j.value,{includeApiKey:W!==null});await z.put("/api/llm/ollama/config",be),B("Ollama config saved"),W!==null&&j.value.api_key===W&&(j.value.api_key="",A.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(W){B(W.message||"Failed","error")}finally{U.value=!1}}async function Fn(){if(!U.value){U.value=!0;try{await z.put("/api/llm/ollama/config",bS(j.value)),B("Ollama timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(W){B(W.message||"Failed","error")}finally{U.value=!1}}}async function Lt(){if(V.value){$e();return}V.value=!0;try{const W=S.value?J.value.api_key:null,be=yS(J.value,{includeApiKey:W!==null});await z.put("/api/llm/kimi/config",be),B("Kimi config saved"),W!==null&&J.value.api_key===W&&(J.value.api_key="",S.value=!1),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(W){B(W.message||"Failed","error")}finally{V.value=!1}}async function Xe(){if(!V.value){V.value=!0;try{await z.put("/api/llm/kimi/config",xS(J.value)),B("Kimi timeout saved"),await Promise.all([Le({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(W){B(W.message||"Failed","error")}finally{V.value=!1}}}async function Ts(){if(g.value){te();return}g.value=!0;try{await z.put("/api/llm/auxiliary/config",v.value),B("Auxiliary config saved"),await Le()}catch(W){B(W.message||"Failed","error"),await Le()}finally{g.value=!1}}const Ds=Fl(Ns),te=Fl(Ts),we=Fl(Ss),$e=Fl(Lt),Je=()=>(Ds.cancel(),Ns()),wt=()=>(we.cancel(),Ss()),ut=()=>($e.cancel(),Lt()),$n=()=>Mn(),js=()=>Fn(),mi=()=>Xe();async function vi(W){const be=W.account_key+":"+W.model;R.value=be;try{const Ae=await z.post("/api/context/windows/clear",{account_key:W.account_key,model:W.model});B(Ae.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Ke()}catch(Ae){B(Ae.message||"Failed to clear clamp","error"),await Ke()}finally{R.value=null}}async function Ia(W){try{await z.post("/api/codex/account/"+W+"/activate"),B("Active account switched"),await Ve()}catch(be){B(be.message||"Failed","error")}}async function aa(W){ne.value=W;try{await z.post("/api/codex/account/"+W+"/refresh"),B("Token refreshed"),await Ve()}catch(be){B(be.message||"Refresh failed","error")}finally{ne.value=null}}function Un(W,be){pe.value=W,ue.value=be||""}async function Bn(W){try{await z.put("/api/codex/account/"+W+"/label",{label:ue.value}),B("Label updated"),pe.value=null,await Ve()}catch(be){B(be.message||"Failed","error")}}async function Ys(W,be){if(await qt({title:"Delete Codex account",message:`Delete ${be||"account #"+(W+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/codex/account/"+W),B("Deleted. Pool reloaded."),await Ve()}catch(es){B(es.message||"Failed","error")}}async function dn(){oe.value=!0;try{const W=await z.post("/api/codex/device-code");xe.value=W,de.value="pending",Xt(W)}catch(W){B(W.message||"Failed","error")}finally{oe.value=!1}}async function Xt(W){Re={cancelled:!1};const be=Re;try{const Ae=await z.post("/api/codex/device-poll",{device_auth_id:W.device_auth_id,user_code:W.user_code,interval:W.interval});if(be.cancelled)return;me.value=Ae,de.value="success",await Se()}catch(Ae){if(be.cancelled)return;_e.value=Ae.message||"Device login failed",de.value="error"}}function Oa(){Re&&(Re.cancelled=!0),de.value=null,xe.value=null}return je(Se),ft(()=>{Re&&(Re.cancelled=!0),Ds.cancel(),te.cancel(),we.cancel(),$e.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:n,switching:Y,advancedOpen:b,codexForm:a,codexModelOptions:l,codexAgentModelOptions:o,mainEffortAllowed:d,agentEffortAllowed:u,mainModelOptionDisabled:f,agentModelOptionDisabled:m,auxForm:v,auxData:k,auxModelOptions:N,onAuxModelChange:y,savingAux:g,saveAuxConfigDebounced:te,ollamaForm:j,kimiForm:J,savingCodex:I,savingOllama:U,savingKimi:V,probingOllama:K,ollamaKeyDirty:A,kimiKeyDirty:S,fetchCodexStatus:Ve,ollamaStatus:le,ollamaStatusLoadFailed:se,ollamaModels:ce,ollamaSelectedModel:Ne,reloading:ee,settingModel:ge,kimiStatus:q,kimiStatusLoadFailed:re,kimiModels:fe,kimiSelectedModel:Ie,reloadingKimi:w,settingKimiModel:x,codexLoading:F,codexError:Q,codexData:Z,refreshing:ne,editingLabel:pe,labelValue:ue,contextWindows:E,contextWindowsLoading:T,contextWindowsError:L,contextBudgetRows:$,activeClampRows:C,activeContextBudget:M,clearingClamp:R,contextPolicyDirty:_,deviceState:de,deviceLoading:oe,deviceInfo:xe,deviceResult:me,deviceError:_e,fetchAll:Se,fetchLLMStatus:Le,fetchOllamaStatus:Et,fetchKimiStatus:ks,switchProvider:$t,reloadOllama:zt,setOllamaModel:rs,reloadKimi:na,setKimiModel:Zs,probeOllamaModels:Js,saveCodexConfig:Ns,saveOllamaConfig:Ss,saveKimiConfig:Lt,saveCodexAdvancedConfig:Mn,saveOllamaAdvancedConfig:Fn,saveKimiAdvancedConfig:Xe,saveCodexConfigDebounced:Ds,saveOllamaConfigDebounced:we,saveKimiConfigDebounced:$e,saveCodexConfigNow:Je,saveOllamaConfigNow:wt,saveKimiConfigNow:ut,saveCodexAdvancedConfigNow:$n,saveOllamaAdvancedConfigNow:js,saveKimiAdvancedConfigNow:mi,activateAccount:Ia,refreshAccount:aa,startEditLabel:Un,saveLabel:Bn,deleteAccount:Ys,startDeviceLogin:dn,cancelDeviceLogin:Oa,formatSize:ve,fetchContextWindows:Ke,clearContextClamp:vi,setContextOverride:rt,setContextUtilization:Qe,resetContextOverride:ie,overrideAboveFloor:Ot,formatCount:ke,formatContextCeiling:Oe,formatExpiry:Me,shortAccountKey:dt,provenanceClass:_t,formatDensity:st}}},vp={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function wS(e){return vp[e]||vp[(e||"").toLowerCase()]||"text-gray-400"}const kS={template:`
  ...
  `,setup(){const e=h(null),t=h(""),s=h(null),n=h(!1),a=h(0),i=h(null),l=h(""),o=h(null),r=h(!1),c=h(0),d=h(Date.now());let u=null,p=0,f=0;async function m(){const S=++p;n.value=!0;try{const I=await z.get("/api/turn-state/turns?limit=100");if(S!==p)return;t.value=I.availability,e.value=I.availability==="available"?I.data:null,s.value=null,a.value=Date.now()}catch(I){if(S!==p)return;s.value=I.message||"Turn-state read failed",I.status===503&&(t.value="unavailable")}S===p&&(n.value=!1)}async function v(){const S=++f;r.value=!0;try{const I=await z.get("/api/turn-state/capacity-breakers");if(S!==f)return;l.value=I.availability,i.value=I.availability==="available"?I.data:null,o.value=null,c.value=Date.now()}catch(I){if(S!==f)return;o.value=I.message||"Breaker read failed",I.status===503&&(l.value="unavailable")}S===f&&(r.value=!1)}function k(){m(),v()}const N=G(()=>e.value!==null&&ki(d.value,a.value)>gp),y=G(()=>i.value!==null&&ki(d.value,c.value)>gp),g=G(()=>N.value||y.value),b=G(()=>Math.round(ki(d.value,a.value)/1e3)),E=G(()=>Math.round(ki(d.value,c.value)/1e3));function T(S){return Tr(S,d.value/1e3)}function L(S){return TS[T(S)]}const R=G(()=>{var U;const S=[...((U=e.value)==null?void 0:U.turns)||[]],I=d.value/1e3;return S.sort((V,K)=>Tr(V,I)-Tr(K,I)||(K.last_progress_at||0)-(V.last_progress_at||0))});function _(S){return S.state==="closed"?"badge-success":S.state==="probing"?"badge-warning":"badge-danger"}function D(S){if(S.state==="closed")return"—";const I=ki(d.value,c.value)/1e3,U=Math.max(0,(S.cooldown_remaining_seconds||0)-I);return U>0?`${Math.ceil(U)}s`:S.state==="probing"?"probe in flight":"probe eligible"}function $(S){if(!S)return"";const I=Math.max(0,Math.round(d.value/1e3-S));if(I<90)return`${I}s ago`;const U=Math.round(I/60);return U<90?`${U}m ago`:`${Math.round(U/60)}h ago`}let C=null,M=null,j=!1;function J(){j||(j=!0,k(),C=setInterval(k,SS),u=setInterval(()=>{d.value=Date.now()},1e3),M=Ye.onReconnected(k))}function A(){j&&(j=!1,C&&(clearInterval(C),C=null),u&&(clearInterval(u),u=null),M&&(M(),M=null))}return je(J),Qt(J),Gt(A),ft(A),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:N,breakersStale:y,anyStale:g,turnsAgeSeconds:b,breakersAgeSeconds:E,sortedTurns:R,priorityOf:T,priorityBadge:L,breakerBadge:_,cooldownLabel:D,ageLabel:$,fetchTurns:m,fetchBreakers:v,refreshAll:k,arm:J,disarm:A}}},ES={setup(){const e=h(""),t=h(""),s=h(!1),n=h(""),a=h(!1),i=h(!1),l=h(!1),o=h(null),r=h(!1);async function c(){a.value=!0,o.value=null,r.value=!1;try{const u=await z.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{a.value=!1}}async function d(){if(await qt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await z.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return je(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},bp=e=>JSON.parse(JSON.stringify(e)),AS=(e,t)=>JSON.stringify(e)===JSON.stringify(t),RS={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=h([]),n=h({}),a=h({}),i=h(!1),l=h(!1),o=h(!1),r=h(!1),c=h(!1),d=h(""),u=h("");let p=!1,f=0,m=null;const v=(A,S)=>p&&f===A&&z.token===S,k=A=>"computer-provisioning-"+A.key,N=A=>A===null?"Unset":A===""?"Empty":JSON.stringify(A),y=A=>{const S=a.value[A.key];return A.type==="array"?String(S||"").split(/\r?\n/).map(I=>I.trim()).filter(Boolean):["integer","number"].includes(A.type)?S===""||S==null?null:Number(S):S},g=G(()=>s.value.map(A=>({...A,value:y(A)})).filter(A=>!AS(A.value,n.value[A.key]))),b=G(()=>s.value.filter(A=>A.pending_restart).map(A=>A.label)),E=G(()=>s.value.some(A=>A.apply_state==="unknown")),T=G(()=>{const A={};for(const S of s.value){const I=y(S),U=S.constraints||{};["integer","number"].includes(S.type)&&(I===null&&!S.nullable?A[S.key]="A number is required.":I!==null&&(!Number.isFinite(I)||S.type==="integer"&&!Number.isInteger(I)||U.minimum!=null&&I<U.minimum||U.maximum!=null&&I>U.maximum)&&(A[S.key]="Enter a number within the allowed range.")),S.key==="monitor_names"&&(I.length>16||new Set(I).size!==I.length||I.some(V=>!/^[A-Za-z0-9_.-]{1,64}$/.test(V)))&&(A[S.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return A}),L=G(()=>Object.keys(T.value).length>0);function R(A,S){a.value[A.key]=S,u.value=""}function _(){a.value=Object.fromEntries(s.value.map(A=>[A.key,A.type==="array"?n.value[A.key].join(`
`):n.value[A.key]])),r.value=!1}async function D(A,S){const[I,U]=await Promise.all([z.get("/api/config"),z.get("/api/config/meta")]);if(!v(A,S))return!1;const V=(U.fields||[]).filter(K=>/^computer\.[^.]+$/.test(K.path)&&K.path!=="computer.enabled"&&K.sensitivity==="public"&&K.apply_mode==="restart");if(!I.computer||!V.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=V.map(K=>({...K,key:K.path.split(".")[1]})),n.value=Object.fromEntries(s.value.map(K=>[K.key,bp(I.computer[K.key])])),_(),m=S,i.value=!0,c.value=!1,!0}async function $(){if(!p||l.value||o.value)return;const A=++f,S=z.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await D(A,S)}catch(I){v(A,S)&&(c.value=!0,d.value=I.message||"Could not load provisioning. No changes were sent.")}finally{v(A,S)&&(l.value=!1)}}function C(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!L.value&&(r.value=!0)}async function M(){if(!p||!i.value||!r.value||o.value||l.value||c.value||L.value||!g.value.length)return;if(m!==z.token){J(),j();return}const A={computer:Object.fromEntries(g.value.map(V=>[V.key,bp(V.value)]))},S=f,I=z.token;o.value=!0,d.value="",u.value="";let U=!1;try{if(await z.put("/api/config",A),U=!0,!v(S,I))return;await D(S,I)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(V){v(S,I)&&(c.value=!0,r.value=!1,d.value=U?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${V.status===400?": "+V.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{v(S,I)&&(o.value=!1)}}function j(){p||(p=!0,$())}function J(){p=!1,f++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,m=null,s.value=[],n.value={},a.value={},d.value="",u.value=""}return je(j),Qt(j),Gt(J),ft(J),{fields:s,original:n,draft:a,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:b,effectiveUnknown:E,changes:g,validation:T,invalid:L,fieldId:k,format:N,edit:R,discard:_,load:$,openReview:C,save:M}}},IS={components:{ComputerProvisioning:RS},template:`
    ...
    </div>`,setup(){const e=h({state:"unknown",available:!1}),t=h(!1),s=h(!1),n=h(!1),a=h(!1),i=h(!1),l=h(!1),o=h(""),r=h(!1),c=h(!1),d=h(!1),u=h(""),p=h(null),f=h(""),m=h(!1),v=h(Date.now()),k=h(""),N=h(null);let y=0,g=null,b=!1,E=z.token,T=0,L=null;const R=x=>x===!0?"Enabled":x===!1?"Disabled":"Unknown",_=G(()=>{var x;return((x=e.value.backend)==null?void 0:x.environment)==="existing_session"}),D=G(()=>{var F;const x=Date.parse(((F=e.value.accessibility)==null?void 0:F.checked_at)||"");return Number.isFinite(x)&&v.value-x<15e3&&v.value>=x-5e3}),$=G(()=>{var x;return D.value?R((x=e.value.accessibility)==null?void 0:x.enabled):"Unknown / not current"}),C=G(()=>{var x;return D.value?((x=e.value.accessibility)==null?void 0:x.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),M=G(()=>Object.entries(e.value.input_limits||{}).filter(([,x])=>typeof x=="number"&&Number.isFinite(x)).map(([x,F])=>`${x}: ${F}`).join(", ")),j=G(()=>{var F;const x=(F=e.value.application_provenance)==null?void 0:F.script_identity;return typeof x=="string"?x:!x||typeof x!="object"?"Not observed":`${x.interpreter_basename||"Unknown interpreter"}; argv digest ${x.argv_digest||"not recorded"}; ${x.verified===!0?"verified":"not verified"}`}),J=G(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(x=>x&&typeof x.id=="string"&&typeof x.label=="string"&&["supported","capture_only"].includes(x.input)).slice(0,16):[]),A=G(()=>{const x=e.value.restart_required;return Array.isArray(x)?x.length?x.join(", "):"None reported":x===!0?"Pending; restart required":x===!1?"None reported":"Unknown"}),S=G(()=>{var F,Q;const x=Date.parse(((F=p.value)==null?void 0:F.captured_at)||"");return Number.isFinite(x)&&v.value<x+Math.min(1e4,((Q=p.value)==null?void 0:Q.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function I(){f.value&&URL.revokeObjectURL(f.value),f.value="",p.value=null}function U(){y++,I(),N.value=null,L==null||L.abort(),L=null,t.value=!1,u.value="",s.value=!1,i.value=!1,l.value=!1}function V(x,F){return b&&x===y&&F===z.token}function K(x){var Q,Z;U(),c.value=!1;const F=x.status||(x.name==="AuthError"?401:0);e.value={available:!1,state:F===503?"unavailable":"unknown"},o.value=F===401||F===403||F===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":F===410?"Evidence or artifact expired. Observe or prepare the export again.":F===503?"Computer use is disabled or unavailable.":"Request failed; outcome unknown. Refresh status. No action was replayed.",![401,403,404].includes(F)&&typeof((Q=x.data)==null?void 0:Q.code)=="string"&&/^[a-z_]{1,64}$/.test(x.data.code)&&typeof((Z=x.data)==null?void 0:Z.error)=="string"&&(o.value=x.data.error.slice(0,512))}async function Y(){if(t.value||r.value||n.value||a.value||d.value||!b)return;const x=y,F=z.token;t.value=!0,T=Date.now();const Q=new AbortController;L=Q;try{const Z=await z.get("/api/computer",{signal:Q.signal});if(!V(x,F))return;le(Z)}catch(Z){V(x,F)&&K(Z)}finally{L===Q&&(L=null,t.value=!1)}}function le(x){(e.value.session_id&&e.value.session_id!==x.session_id||e.value.generation!=null&&e.value.generation!==x.generation||e.value.session_generation!=null&&e.value.session_generation!==x.session_generation)&&U(),e.value=x,c.value=!0,o.value=""}async function se(x){if(!b||!c.value||r.value||n.value||a.value)return;U();const F=y,Q=z.token;r.value=!0;try{if(await z.post("/api/computer/enabled",{enabled:x}),!V(F,Q))return;const Z=await z.get("/api/computer");V(F,Q)&&le(Z)}catch(Z){V(F,Q)&&K(Z)}finally{r.value=!1}}async function ce(x){U();const F=y,Q=z.token,Z=x==="stop"?n:a;Z.value=!0;try{const ne=await z.post("/api/computer/"+x,{});if(V(F,Q)){e.value={...e.value,...ne};const pe=await z.get("/api/computer");V(F,Q)&&le(pe)}}catch(ne){V(F,Q)&&K(ne)}finally{Z.value=!1}}async function Ne(){return ge(!1)}async function ee(){return ge(!0)}async function ge(x){var pe;if(!b||!c.value||d.value||e.value.state!=="quarantined")return;const F={session_id:e.value.session_id,generation:e.value.session_generation};if(!F.session_id||!Number.isInteger(F.generation))return;if(x){if(u.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+F.session_id)return;F.acknowledgment=u.value}const Q=x?((pe=e.value.recovery)==null?void 0:pe.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";U();const Z=y,ne=z.token;d.value=!0;try{const ue=await z.post("/api/computer/"+Q,F);V(Z,ne)&&le(ue)}catch(ue){V(Z,ne)&&K(ue)}finally{d.value=!1}}async function q(){var Q;I(),m.value=!1;const x=y,F=z.token;s.value=!0;try{const Z=await z.post("/api/computer/observe",{});if(!V(x,F))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((Q=Z.frame)==null?void 0:Q.evidence_id)||""))throw new Error("Invalid evidence");const ne=await z.getBlob("/api/computer/evidence/"+Z.frame.evidence_id);if(!V(x,F))return;if(!["image/png","image/jpeg"].includes(ne.type)||ne.size>2097152||!Number.isFinite(Date.parse(Z.frame.expires_at))||Date.parse(Z.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");p.value=Z.frame,f.value=URL.createObjectURL(ne),o.value=""}catch(Z){V(x,F)&&K(Z)}finally{x===y&&(s.value=!1)}}async function re(){N.value=null;const x=y,F=z.token;i.value=!0;try{const Q=await z.post("/api/computer/export",{name:k.value});V(x,F)&&(N.value=Q,o.value="")}catch(Q){V(x,F)&&K(Q)}finally{x===y&&(i.value=!1)}}async function fe(){const x=y,F=z.token,Q=N.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((Q==null?void 0:Q.artifact_id)||""))throw new Error("Invalid export");const Z=await z.getBlob("/api/computer/download/"+Q.artifact_id);if(!V(x,F))return;const ne=URL.createObjectURL(Z),pe=document.createElement("a");pe.href=ne,pe.download=Q.name,pe.click(),setTimeout(()=>URL.revokeObjectURL(ne),1e3)}catch(Z){V(x,F)&&K(Z)}finally{x===y&&(l.value=!1)}}function Ie(){b||(b=!0,Y(),g=setInterval(()=>{v.value=Date.now(),E!==z.token&&(E=z.token,U(),c.value=!1,e.value={state:"unknown",available:!1}),p.value&&Date.parse(p.value.expires_at)<=v.value&&(I(),m.value=!0),N.value&&Date.parse(N.value.expires_at)<=v.value&&(N.value=null),v.value-T>=5e3&&Y()},500))}function w(){b=!1,clearInterval(g),g=null,U(),c.value=!1}return je(Ie),Qt(Ie),Gt(w),ft(w),{status:e,loading:t,observing:s,stopping:n,pausing:a,exporting:i,downloading:l,error:o,frame:p,frameUrl:f,frameExpired:m,freshness:S,name:k,artifact:N,refresh:Y,control:ce,observe:q,clearFrame:I,exportFile:re,download:fe,toggling:r,adminReady:c,enabledLabel:R,restartSettings:A,setEnabled:se,recovering:d,recover:Ne,reconcile:ee,reconciliationAck:u,applicationProfiles:J,attached:_,scriptIdentity:j,inputLimits:M,accessibilityLabel:$,accessibilityDetail:C}}},dv=[{id:"health",label:"Health",component:Pk},{id:"resources",label:"Resources",component:Mk},{id:"logs",label:"Logs",component:Wk},{id:"config",label:"Config",component:lS},{id:"discord",label:"Discord",component:rS},{id:"hosts",label:"Hosts",component:uS},{id:"host-access",label:"Host Access",component:dS},{id:"api-tokens",label:"API Tokens",component:pS},{id:"llm",label:"LLM Config",component:_S},{id:"internals",label:"Internals",component:kS},{id:"turn-state",label:"Turn State",component:CS},{id:"computer",label:"Computer",component:IS},{id:"update",label:"Update",component:ES}],OS={components:{TabbedPage:Qo},setup(){return{tabs:dv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},$l=(e,t,s,n)=>n.map(({id:a,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:a}}})),LS=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...$l("Operations","operations","/operations",ev),...$l("History","history","/history",tv),...$l("Capabilities","capabilities","/capabilities",sv),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...$l("System","system","/system",dv)],bs=ta({open:!1,query:"",selected:0});function yp(){bs.query="",bs.selected=0,bs.open=!0}function Cr(){bs.open=!1}function NS(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const DS={setup(){const e=Gm(),t=h(null),s=G(()=>{const i=bs.query.trim().toLowerCase();return LS.map(l=>({...l,_score:NS(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Mt(()=>bs.open,async i=>{var l;i&&(await Rt(),(l=t.value)==null||l.focus())}),Mt(()=>bs.query,()=>{bs.selected=0});function n(i){Cr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Cr();return}if(i.key==="ArrowDown")i.preventDefault(),bs.selected=Math.min(bs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),bs.selected=Math.max(bs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[bs.selected];l&&n(l)}}return{state:bs,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Cr}},template:`
    <transition name="modal">
  ...
  `},fc={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(fc));const PS={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>si("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[si("path",{d:fc[e.name]||fc.info})])}},MS=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function xp(e){return[...e.querySelectorAll(MS)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const FS={mounted(e){const t=document.activeElement,s=n=>{if(n.key!=="Tab")return;const a=xp(e);if(!a.length){n.preventDefault(),e.focus();return}const i=a[0],l=a[a.length-1];n.shiftKey&&document.activeElement===i?(n.preventDefault(),l.focus()):!n.shiftKey&&document.activeElement===l&&(n.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||xp(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},$S={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),o=h(!1),r=h([]),c=h(0),d=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const f=G(()=>{const V=e.value.uptime_seconds||0,K=Math.floor(V/86400),Y=Math.floor(V%86400/3600),le=Math.floor(V%3600/60),se=[];return K>0&&se.push(`${K}d`),Y>0&&se.push(`${Y}h`),(se.length===0||K===0&&Y===0)&&se.push(`${le}m`),se.join(" ")}),m=G(()=>{const V=e.value.uptime_seconds||0;return 125.66*(1-Math.min(V/86400,1))}),v=G(()=>{const V=e.value;return[{label:"Guilds",value:V.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:V.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:V.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${V.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:V.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:V.loop_count>0?"text-green-400":"",highlight:V.loop_count>0},{label:"Agents",value:V.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:V.agent_count>0?`${V.agent_count} total`:"",subColor:"text-gray-500",highlight:(V.agent_running??0)>0},{label:"Processes",value:V.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:V.process_count>0?`${V.process_count} total`:"",subColor:"text-gray-500",highlight:(V.process_running??0)>0},{label:"Schedules",value:V.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(V.schedule_failing>0?`${V.schedule_failing} failing`:"")+(V.schedule_failing>0&&V.schedule_paused>0?", ":"")+(V.schedule_paused>0?`${V.schedule_paused} paused`:"")||void 0,subColor:V.schedule_failing>0?"text-red-400":"text-yellow-400",color:V.schedule_failing>0?"text-red-400":"",highlight:V.schedule_failing>0},{label:"Users",value:V.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),k=G(()=>{const V=e.value,K=[];return K.push({label:"Bot",status:V.status==="online"?"ok":"warn",detail:V.status==="online"?"Online":"Starting"}),(V.schedule_failing||0)>0?K.push({label:"Schedules",status:"error",detail:`${V.schedule_failing} failing`}):(V.schedule_count||0)>0&&K.push({label:"Schedules",status:"ok",detail:`${V.schedule_count} configured`}),(V.loop_count||0)>0&&K.push({label:"Loops",status:"ok",detail:`${V.loop_count} active`}),(V.agent_running||0)>0&&K.push({label:"Agents",status:"ok",detail:`${V.agent_running} running`}),(V.process_running||0)>0&&K.push({label:"Processes",status:"ok",detail:`${V.process_running} running`}),K});async function N(){try{e.value=await z.get("/api/status"),s.value=null}catch(V){s.value=V.message}finally{t.value=!1}}let y=0,g=0,b=0,E=0;function T(V,K){const Y=new Set;return[...K,...V].filter(le=>{const se=le._hmac||JSON.stringify([le.timestamp,le.tool_name,le.user_id,le.result_summary,le.error]);return Y.has(se)?!1:(Y.add(se),!0)})}async function L(){const V=++y,K=b;a.value=!0;try{const Y=await z.get("/api/audit?limit=10");if(V!==y)return;const le=K===b?[]:n.value.filter(se=>(se._liveEpoch||0)>K);n.value=T(Y,le).slice(0,10),c.value=le.length}catch{}V===y&&(a.value=!1)}async function R(){const V=++g,K=E;l.value=!0;try{const Y=await z.get("/api/audit?error_only=1&limit=5");if(V!==g)return;const le=K===E?[]:i.value.filter(se=>(se._liveErrorEpoch||0)>K);i.value=T(Y,le).slice(0,5),o.value=!1}catch{if(V!==g)return;o.value=K===E||i.value.length===0}V===g&&(l.value=!1)}async function _(){try{const V=await z.get("/api/knowledge");d.value=(Array.isArray(V)?V:[]).reduce((K,Y)=>K+(Y.chunks||0),0)}catch{d.value=null}}async function D(){try{const V=await z.get("/api/agents");r.value=V.filter(K=>K.status==="running")}catch{}}async function $(){u.value={...u.value,reload:!0};try{await z.post("/api/reload"),ye.success("Config reloaded")}catch(V){ye.error(V.message)}u.value={...u.value,reload:!1}}async function C(){if(!await qt({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const K=e.value.session_count;e.value={...e.value,session_count:0};try{const Y=await z.post("/api/sessions/clear-all");ye.success(`Cleared ${Y.count} session${Y.count!==1?"s":""}`),await N()}catch(Y){e.value={...e.value,session_count:K},ye.error(Y.message)}u.value={...u.value,clearSessions:!1}}async function M(){if(!await qt({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const K=e.value.loop_count;e.value={...e.value,loop_count:0};try{const Y=await z.post("/api/loops/stop-all");ye.success(Y.result),await N()}catch(Y){e.value={...e.value,loop_count:K},ye.error(Y.message)}u.value={...u.value,stopLoops:!1}}function j(){t.value=!0,s.value=null,N(),L(),R(),D()}let J=null,A=null,S=null;function I(V){if(V.payload&&V.payload.tool_name){b+=1;const K={...V.payload,_isNew:!0,_key:++p,_liveEpoch:b};n.value.unshift(K),n.value.length>10&&n.value.pop(),c.value++,K.error&&(E+=1,K._liveErrorEpoch=E,o.value=!1,i.value.unshift(K),i.value.length>5&&i.value.pop()),setTimeout(()=>{K._isNew=!1},1500),clearTimeout(S),S=setTimeout(()=>{c.value=0},1e4)}}let U=null;return je(async()=>{await Promise.all([N(),L(),R(),D(),_()]),J=setInterval(N,15e3),A=setInterval(D,1e4),Ye.subscribe("events",I),U=Ye.onReconnected(()=>{L(),R()})}),ft(()=>{J&&clearInterval(J),A&&clearInterval(A),clearTimeout(S),Ye.unsubscribe("events",I),U&&(U(),U=null)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:m,stats:v,healthIndicators:k,activity:n,activityLoading:a,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:L,fetchErrors:R,fetchStatus:N,onEvent:I,formatTime:zw,formatDuration:ui,retry:j,reloadConfig:$,clearSessions:C,stopAllLoops:M}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function _p(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function US(e){if(Array.isArray(e))return e}function BS(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(n=i.call(s)).done)&&(o.push(n.value),o.length!==t);r=!0);}catch(d){c=!0,a=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return o}}function HS(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function zS(e,t){return US(e)||BS(e,t)||jS(e,t)||HS()}function jS(e,t){if(e){if(typeof e=="string")return _p(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?_p(e,t):void 0}}const uv=Object.entries,wp=Object.setPrototypeOf,VS=Object.isFrozen,qS=Object.getPrototypeOf,GS=Object.getOwnPropertyDescriptor;let ms=Object.freeze,zs=Object.seal,Ha=Object.create,pv=typeof Reflect<"u"&&Reflect,hc=pv.apply,mc=pv.construct;ms||(ms=function(t){return t});zs||(zs=function(t){return t});hc||(hc=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});mc||(mc=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const vn=Ft(Array.prototype.forEach),KS=Ft(Array.prototype.lastIndexOf),kp=Ft(Array.prototype.pop),Ma=Ft(Array.prototype.push),WS=Ft(Array.prototype.splice),ds=Array.isArray,Oi=Ft(String.prototype.toLowerCase),Er=Ft(String.prototype.toString),Sp=Ft(String.prototype.match),Fa=Ft(String.prototype.replace),Tp=Ft(String.prototype.indexOf),JS=Ft(String.prototype.trim),ZS=Ft(Number.prototype.toString),YS=Ft(Boolean.prototype.toString),Cp=typeof BigInt>"u"?null:Ft(BigInt.prototype.toString),Ep=typeof Symbol>"u"?null:Ft(Symbol.prototype.toString),St=Ft(Object.prototype.hasOwnProperty),Si=Ft(Object.prototype.toString),Kt=Ft(RegExp.prototype.test),ra=QS(TypeError);function Ft(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return hc(e,t,n)}}function QS(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return mc(e,s)}}function ze(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Oi;if(wp&&wp(e,null),!ds(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(VS(t)||(t[n]=i),a=i)}e[a]=!0}return e}function XS(e){for(let t=0;t<e.length;t++)St(e,t)||(e[t]=null);return e}function ss(e){const t=Ha(null);for(const n of uv(e)){var s=zS(n,2);const a=s[0],i=s[1];St(e,a)&&(ds(i)?t[a]=XS(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=ss(i):t[a]=i)}return t}function e1(e){switch(typeof e){case"string":return e;case"number":return ZS(e);case"boolean":return YS(e);case"bigint":return Cp?Cp(e):"0";case"symbol":return Ep?Ep(e):"Symbol()";case"undefined":return Si(e);case"function":case"object":{if(e===null)return Si(e);const t=e,s=en(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Si(n)}return Si(e)}default:return Si(e)}}function en(e,t){for(;e!==null;){const n=GS(e,t);if(n){if(n.get)return Ft(n.get);if(typeof n.value=="function")return Ft(n.value)}e=qS(e)}function s(){return null}return s}function t1(e){try{return Kt(e,""),!0}catch{return!1}}const Ap=ms(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Ar=ms(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Rr=ms(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),s1=ms(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ir=ms(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),n1=ms(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Rp=ms(["#text"]),Ip=ms(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Or=ms(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Op=ms(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ul=ms(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),a1=zs(/{{[\w\W]*|^[\w\W]*}}/g),i1=zs(/<%[\w\W]*|^[\w\W]*%>/g),l1=zs(/\${[\w\W]*/g),o1=zs(/^data-[\-\w.\u00B7-\uFFFF]+$/),r1=zs(/^aria-[\-\w]+$/),Lp=zs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),c1=zs(/^(?:\w+script|data):/i),d1=zs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),u1=zs(/^html$/i),p1=zs(/^[a-z][.\w]*(-[.\w]+)+$/i),Qs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},f1=function(){return typeof window>"u"?null:window},h1=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Np=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function fv(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:f1();const t=Te=>fv(Te);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Qs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,f=en(p,"cloneNode"),m=en(p,"remove"),v=en(p,"nextSibling"),k=en(p,"childNodes"),N=en(p,"parentNode"),y=en(p,"shadowRoot"),g=en(p,"attributes"),b=l&&l.prototype?en(l.prototype,"nodeType"):null,E=l&&l.prototype?en(l.prototype,"nodeName"):null;if(typeof i=="function"){const Te=s.createElement("template");Te.content&&Te.content.ownerDocument&&(s=Te.content.ownerDocument)}let T,L="",R,_=!1,D=0;const $=function(){if(D>0)throw ra('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},C=function(P){$(),D++;try{return T.createHTML(P)}finally{D--}},M=function(P){$(),D++;try{return T.createScriptURL(P)}finally{D--}},j=function(){return _||(R=h1(u,a),_=!0),R},J=s,A=J.implementation,S=J.createNodeIterator,I=J.createDocumentFragment,U=J.getElementsByTagName,V=n.importNode;let K=Np();t.isSupported=typeof uv=="function"&&typeof N=="function"&&A&&A.createHTMLDocument!==void 0;const Y=a1,le=i1,se=l1,ce=o1,Ne=r1,ee=c1,ge=d1,q=p1;let re=Lp,fe=null;const Ie=ze({},[...Ap,...Ar,...Rr,...Ir,...Rp]);let w=null;const x=ze({},[...Ip,...Or,...Op,...Ul]);let F=Object.seal(Ha(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Q=null,Z=null;const ne=Object.seal(Ha(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let pe=!0,ue=!0,de=!1,oe=!0,xe=!1,me=!0,_e=!1,Re=!1,B=!1,ve=!1,ke=!1,Oe=!1,Me=!0,dt=!1;const st="user-content-";let _t=!0,Ot=!1,rt={},Qe=null;const ie=ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Se=null;const Le=ze({},["audio","video","img","source","image","track"]);let Ke=null;const Et=ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ve="http://www.w3.org/1998/Math/MathML",$t="http://www.w3.org/2000/svg",zt="http://www.w3.org/1999/xhtml";let rs=zt,Js=!1,ks=null;const na=ze({},[Ve,$t,zt],Er);let Zs=ze({},["mi","mo","mn","ms","mtext"]),Ns=ze({},["annotation-xml"]);const Mn=ze({},["title","style","font","a","script"]);let Ss=null;const Fn=["application/xhtml+xml","text/html"],Lt="text/html";let Xe=null,Ts=null;const Ds=s.createElement("form"),te=function(P){return P instanceof RegExp||P instanceof Function},we=function(){let P=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ts&&Ts===P)return;(!P||typeof P!="object")&&(P={}),P=ss(P),Ss=Fn.indexOf(P.PARSER_MEDIA_TYPE)===-1?Lt:P.PARSER_MEDIA_TYPE,Xe=Ss==="application/xhtml+xml"?Er:Oi,fe=St(P,"ALLOWED_TAGS")&&ds(P.ALLOWED_TAGS)?ze({},P.ALLOWED_TAGS,Xe):Ie,w=St(P,"ALLOWED_ATTR")&&ds(P.ALLOWED_ATTR)?ze({},P.ALLOWED_ATTR,Xe):x,ks=St(P,"ALLOWED_NAMESPACES")&&ds(P.ALLOWED_NAMESPACES)?ze({},P.ALLOWED_NAMESPACES,Er):na,Ke=St(P,"ADD_URI_SAFE_ATTR")&&ds(P.ADD_URI_SAFE_ATTR)?ze(ss(Et),P.ADD_URI_SAFE_ATTR,Xe):Et,Se=St(P,"ADD_DATA_URI_TAGS")&&ds(P.ADD_DATA_URI_TAGS)?ze(ss(Le),P.ADD_DATA_URI_TAGS,Xe):Le,Qe=St(P,"FORBID_CONTENTS")&&ds(P.FORBID_CONTENTS)?ze({},P.FORBID_CONTENTS,Xe):ie,Q=St(P,"FORBID_TAGS")&&ds(P.FORBID_TAGS)?ze({},P.FORBID_TAGS,Xe):ss({}),Z=St(P,"FORBID_ATTR")&&ds(P.FORBID_ATTR)?ze({},P.FORBID_ATTR,Xe):ss({}),rt=St(P,"USE_PROFILES")?P.USE_PROFILES&&typeof P.USE_PROFILES=="object"?ss(P.USE_PROFILES):P.USE_PROFILES:!1,pe=P.ALLOW_ARIA_ATTR!==!1,ue=P.ALLOW_DATA_ATTR!==!1,de=P.ALLOW_UNKNOWN_PROTOCOLS||!1,oe=P.ALLOW_SELF_CLOSE_IN_ATTR!==!1,xe=P.SAFE_FOR_TEMPLATES||!1,me=P.SAFE_FOR_XML!==!1,_e=P.WHOLE_DOCUMENT||!1,ve=P.RETURN_DOM||!1,ke=P.RETURN_DOM_FRAGMENT||!1,Oe=P.RETURN_TRUSTED_TYPE||!1,B=P.FORCE_BODY||!1,Me=P.SANITIZE_DOM!==!1,dt=P.SANITIZE_NAMED_PROPS||!1,_t=P.KEEP_CONTENT!==!1,Ot=P.IN_PLACE||!1,re=t1(P.ALLOWED_URI_REGEXP)?P.ALLOWED_URI_REGEXP:Lp,rs=typeof P.NAMESPACE=="string"?P.NAMESPACE:zt,Zs=St(P,"MATHML_TEXT_INTEGRATION_POINTS")&&P.MATHML_TEXT_INTEGRATION_POINTS&&typeof P.MATHML_TEXT_INTEGRATION_POINTS=="object"?ss(P.MATHML_TEXT_INTEGRATION_POINTS):ze({},["mi","mo","mn","ms","mtext"]),Ns=St(P,"HTML_INTEGRATION_POINTS")&&P.HTML_INTEGRATION_POINTS&&typeof P.HTML_INTEGRATION_POINTS=="object"?ss(P.HTML_INTEGRATION_POINTS):ze({},["annotation-xml"]);const ae=St(P,"CUSTOM_ELEMENT_HANDLING")&&P.CUSTOM_ELEMENT_HANDLING&&typeof P.CUSTOM_ELEMENT_HANDLING=="object"?ss(P.CUSTOM_ELEMENT_HANDLING):Ha(null);if(F=Ha(null),St(ae,"tagNameCheck")&&te(ae.tagNameCheck)&&(F.tagNameCheck=ae.tagNameCheck),St(ae,"attributeNameCheck")&&te(ae.attributeNameCheck)&&(F.attributeNameCheck=ae.attributeNameCheck),St(ae,"allowCustomizedBuiltInElements")&&typeof ae.allowCustomizedBuiltInElements=="boolean"&&(F.allowCustomizedBuiltInElements=ae.allowCustomizedBuiltInElements),xe&&(ue=!1),ke&&(ve=!0),rt&&(fe=ze({},Rp),w=Ha(null),rt.html===!0&&(ze(fe,Ap),ze(w,Ip)),rt.svg===!0&&(ze(fe,Ar),ze(w,Or),ze(w,Ul)),rt.svgFilters===!0&&(ze(fe,Rr),ze(w,Or),ze(w,Ul)),rt.mathMl===!0&&(ze(fe,Ir),ze(w,Op),ze(w,Ul))),ne.tagCheck=null,ne.attributeCheck=null,St(P,"ADD_TAGS")&&(typeof P.ADD_TAGS=="function"?ne.tagCheck=P.ADD_TAGS:ds(P.ADD_TAGS)&&(fe===Ie&&(fe=ss(fe)),ze(fe,P.ADD_TAGS,Xe))),St(P,"ADD_ATTR")&&(typeof P.ADD_ATTR=="function"?ne.attributeCheck=P.ADD_ATTR:ds(P.ADD_ATTR)&&(w===x&&(w=ss(w)),ze(w,P.ADD_ATTR,Xe))),St(P,"ADD_URI_SAFE_ATTR")&&ds(P.ADD_URI_SAFE_ATTR)&&ze(Ke,P.ADD_URI_SAFE_ATTR,Xe),St(P,"FORBID_CONTENTS")&&ds(P.FORBID_CONTENTS)&&(Qe===ie&&(Qe=ss(Qe)),ze(Qe,P.FORBID_CONTENTS,Xe)),St(P,"ADD_FORBID_CONTENTS")&&ds(P.ADD_FORBID_CONTENTS)&&(Qe===ie&&(Qe=ss(Qe)),ze(Qe,P.ADD_FORBID_CONTENTS,Xe)),_t&&(fe["#text"]=!0),_e&&ze(fe,["html","head","body"]),fe.table&&(ze(fe,["tbody"]),delete Q.tbody),P.TRUSTED_TYPES_POLICY){if(typeof P.TRUSTED_TYPES_POLICY.createHTML!="function")throw ra('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof P.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw ra('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const he=T;T=P.TRUSTED_TYPES_POLICY;try{L=C("")}catch(De){throw T=he,De}}else P.TRUSTED_TYPES_POLICY===null?(T=void 0,L=""):(T===void 0&&(T=j()),T&&typeof L=="string"&&(L=C("")));(K.uponSanitizeElement.length>0||K.uponSanitizeAttribute.length>0)&&fe===Ie&&(fe=ss(fe)),K.uponSanitizeAttribute.length>0&&w===x&&(w=ss(w)),ms&&ms(P),Ts=P},$e=ze({},[...Ar,...Rr,...s1]),Je=ze({},[...Ir,...n1]),wt=function(P){let ae=N(P);(!ae||!ae.tagName)&&(ae={namespaceURI:rs,tagName:"template"});const he=Oi(P.tagName),De=Oi(ae.tagName);return ks[P.namespaceURI]?P.namespaceURI===$t?ae.namespaceURI===zt?he==="svg":ae.namespaceURI===Ve?he==="svg"&&(De==="annotation-xml"||Zs[De]):!!$e[he]:P.namespaceURI===Ve?ae.namespaceURI===zt?he==="math":ae.namespaceURI===$t?he==="math"&&Ns[De]:!!Je[he]:P.namespaceURI===zt?ae.namespaceURI===$t&&!Ns[De]||ae.namespaceURI===Ve&&!Zs[De]?!1:!Je[he]&&(Mn[he]||!$e[he]):!!(Ss==="application/xhtml+xml"&&ks[P.namespaceURI]):!1},ut=function(P){Ma(t.removed,{element:P});try{N(P).removeChild(P)}catch{if(m(P),!N(P))throw ra("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},$n=function(P){const ae=k?k(P):P.childNodes;if(ae){const De=[];vn(ae,Fe=>{Ma(De,Fe)}),vn(De,Fe=>{try{m(Fe)}catch{}})}const he=g?g(P):null;if(he)for(let De=he.length-1;De>=0;--De){const Fe=he[De],Be=Fe&&Fe.name;if(typeof Be=="string")try{P.removeAttribute(Be)}catch{}}},js=function(P,ae){try{Ma(t.removed,{attribute:ae.getAttributeNode(P),from:ae})}catch{Ma(t.removed,{attribute:null,from:ae})}if(ae.removeAttribute(P),P==="is")if(ve||ke)try{ut(ae)}catch{}else try{ae.setAttribute(P,"")}catch{}},mi=function(P){const ae=g?g(P):P.attributes;if(ae)for(let he=ae.length-1;he>=0;--he){const De=ae[he],Fe=De&&De.name;if(!(typeof Fe!="string"||w[Xe(Fe)]))try{P.removeAttribute(Fe)}catch{}}},vi=function(P){const ae=[P];for(;ae.length>0;){const he=ae.pop();(b?b(he):he.nodeType)===Qs.element&&mi(he);const Fe=k?k(he):he.childNodes;if(Fe)for(let Be=Fe.length-1;Be>=0;--Be)ae.push(Fe[Be])}},Ia=function(P){let ae=null,he=null;if(B)P="<remove></remove>"+P;else{const Be=Sp(P,/^[\r\n\t ]+/);he=Be&&Be[0]}Ss==="application/xhtml+xml"&&rs===zt&&(P='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+P+"</body></html>");const De=T?C(P):P;if(rs===zt)try{ae=new d().parseFromString(De,Ss)}catch{}if(!ae||!ae.documentElement){ae=A.createDocument(rs,"template",null);try{ae.documentElement.innerHTML=Js?L:De}catch{}}const Fe=ae.body||ae.documentElement;return P&&he&&Fe.insertBefore(s.createTextNode(he),Fe.childNodes[0]||null),rs===zt?U.call(ae,_e?"html":"body")[0]:_e?ae.documentElement:Fe},aa=function(P){return S.call(P.ownerDocument||P,P,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},Un=function(P){var ae,he;P.normalize();const De=S.call(P.ownerDocument||P,P,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let Fe=De.nextNode();for(;Fe;){let yt=Fe.data;vn([Y,le,se],it=>{yt=Fa(yt,it," ")}),Fe.data=yt,Fe=De.nextNode()}const Be=(ae=(he=P.querySelectorAll)===null||he===void 0?void 0:he.call(P,"template"))!==null&&ae!==void 0?ae:[];vn(Array.from(Be),yt=>{Ys(yt.content)&&Un(yt.content)})},Bn=function(P){const ae=E?E(P):null;return typeof ae!="string"||Xe(ae)!=="form"?!1:typeof P.nodeName!="string"||typeof P.textContent!="string"||typeof P.removeChild!="function"||P.attributes!==g(P)||typeof P.removeAttribute!="function"||typeof P.setAttribute!="function"||typeof P.namespaceURI!="string"||typeof P.insertBefore!="function"||typeof P.hasChildNodes!="function"||P.nodeType!==b(P)||P.childNodes!==k(P)},Ys=function(P){if(!b||typeof P!="object"||P===null)return!1;try{return b(P)===Qs.documentFragment}catch{return!1}},dn=function(P){if(!b||typeof P!="object"||P===null)return!1;try{return typeof b(P)=="number"}catch{return!1}};function Xt(Te,P,ae){vn(Te,he=>{he.call(t,P,ae,Ts)})}const Oa=function(P){let ae=null;if(Xt(K.beforeSanitizeElements,P,null),Bn(P))return ut(P),!0;const he=Xe(E?E(P):P.nodeName);if(Xt(K.uponSanitizeElement,P,{tagName:he,allowedTags:fe}),me&&P.hasChildNodes()&&!dn(P.firstElementChild)&&Kt(/<[/\w!]/g,P.innerHTML)&&Kt(/<[/\w!]/g,P.textContent)||me&&P.namespaceURI===zt&&he==="style"&&dn(P.firstElementChild)||P.nodeType===Qs.progressingInstruction||me&&P.nodeType===Qs.comment&&Kt(/<[/\w]/g,P.data))return ut(P),!0;if(Q[he]||!(ne.tagCheck instanceof Function&&ne.tagCheck(he))&&!fe[he]){if(!Q[he]&&Ae(he)&&(F.tagNameCheck instanceof RegExp&&Kt(F.tagNameCheck,he)||F.tagNameCheck instanceof Function&&F.tagNameCheck(he)))return!1;if(_t&&!Qe[he]){const Fe=N(P),Be=k(P);if(Be&&Fe){const yt=Be.length;for(let it=yt-1;it>=0;--it){const vt=Ot?Be[it]:f(Be[it],!0);Fe.insertBefore(vt,v(P))}}}return ut(P),!0}return(b?b(P):P.nodeType)===Qs.element&&!wt(P)||(he==="noscript"||he==="noembed"||he==="noframes")&&Kt(/<\/no(script|embed|frames)/i,P.innerHTML)?(ut(P),!0):(xe&&P.nodeType===Qs.text&&(ae=P.textContent,vn([Y,le,se],Fe=>{ae=Fa(ae,Fe," ")}),P.textContent!==ae&&(Ma(t.removed,{element:P.cloneNode()}),P.textContent=ae)),Xt(K.afterSanitizeElements,P,null),!1)},W=function(P,ae,he){if(Z[ae]||Me&&(ae==="id"||ae==="name")&&(he in s||he in Ds))return!1;const De=w[ae]||ne.attributeCheck instanceof Function&&ne.attributeCheck(ae,P);if(!(ue&&!Z[ae]&&Kt(ce,ae))){if(!(pe&&Kt(Ne,ae))){if(!De||Z[ae]){if(!(Ae(P)&&(F.tagNameCheck instanceof RegExp&&Kt(F.tagNameCheck,P)||F.tagNameCheck instanceof Function&&F.tagNameCheck(P))&&(F.attributeNameCheck instanceof RegExp&&Kt(F.attributeNameCheck,ae)||F.attributeNameCheck instanceof Function&&F.attributeNameCheck(ae,P))||ae==="is"&&F.allowCustomizedBuiltInElements&&(F.tagNameCheck instanceof RegExp&&Kt(F.tagNameCheck,he)||F.tagNameCheck instanceof Function&&F.tagNameCheck(he))))return!1}else if(!Ke[ae]){if(!Kt(re,Fa(he,ge,""))){if(!((ae==="src"||ae==="xlink:href"||ae==="href")&&P!=="script"&&Tp(he,"data:")===0&&Se[P])){if(!(de&&!Kt(ee,Fa(he,ge,"")))){if(he)return!1}}}}}}return!0},be=ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Ae=function(P){return!be[Oi(P)]&&Kt(q,P)},es=function(P){Xt(K.beforeSanitizeAttributes,P,null);const ae=P.attributes;if(!ae||Bn(P))return;const he={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:w,forceKeepAttr:void 0};let De=ae.length;for(;De--;){const Fe=ae[De],Be=Fe.name,yt=Fe.namespaceURI,it=Fe.value,vt=Xe(Be),O=it;let H=Be==="value"?O:JS(O);if(he.attrName=vt,he.attrValue=H,he.keepAttr=!0,he.forceKeepAttr=void 0,Xt(K.uponSanitizeAttribute,P,he),H=he.attrValue,dt&&(vt==="id"||vt==="name")&&Tp(H,st)!==0&&(js(Be,P),H=st+H),me&&Kt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,H)){js(Be,P);continue}if(vt==="attributename"&&Sp(H,"href")){js(Be,P);continue}if(he.forceKeepAttr)continue;if(!he.keepAttr){js(Be,P);continue}if(!oe&&Kt(/\/>/i,H)){js(Be,P);continue}xe&&vn([Y,le,se],Ee=>{H=Fa(H,Ee," ")});const X=Xe(P.nodeName);if(!W(X,vt,H)){js(Be,P);continue}if(T&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!yt)switch(u.getAttributeType(X,vt)){case"TrustedHTML":{H=C(H);break}case"TrustedScriptURL":{H=M(H);break}}if(H!==O)try{yt?P.setAttributeNS(yt,Be,H):P.setAttribute(Be,H),Bn(P)?ut(P):kp(t.removed)}catch{js(Be,P)}}Xt(K.afterSanitizeAttributes,P,null)},un=function(P){let ae=null;const he=aa(P);for(Xt(K.beforeSanitizeShadowDOM,P,null);ae=he.nextNode();)if(Xt(K.uponSanitizeShadowNode,ae,null),Oa(ae),es(ae),Ys(ae.content)&&un(ae.content),(b?b(ae):ae.nodeType)===Qs.element){const Fe=y?y(ae):ae.shadowRoot;Ys(Fe)&&(Hn(Fe),un(Fe))}Xt(K.afterSanitizeShadowDOM,P,null)},Hn=function(P){const ae=[{node:P,shadow:null}];for(;ae.length>0;){const he=ae.pop();if(he.shadow){un(he.shadow);continue}const De=he.node,Be=(b?b(De):De.nodeType)===Qs.element,yt=k?k(De):De.childNodes;if(yt)for(let it=yt.length-1;it>=0;--it)ae.push({node:yt[it],shadow:null});if(Be){const it=E?E(De):null;if(typeof it=="string"&&Xe(it)==="template"){const vt=De.content;Ys(vt)&&ae.push({node:vt,shadow:null})}}if(Be){const it=y?y(De):De.shadowRoot;Ys(it)&&ae.push({node:null,shadow:it},{node:it,shadow:null})}}};return t.sanitize=function(Te){let P=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},ae=null,he=null,De=null,Fe=null;if(Js=!Te,Js&&(Te="<!-->"),typeof Te!="string"&&!dn(Te)&&(Te=e1(Te),typeof Te!="string"))throw ra("dirty is not a string, aborting");if(!t.isSupported)return Te;Re||we(P),t.removed=[];const Be=Ot&&typeof Te!="string"&&dn(Te);if(Be){const vt=E?E(Te):Te.nodeName;if(typeof vt=="string"){const O=Xe(vt);if(!fe[O]||Q[O])throw ra("root node is forbidden and cannot be sanitized in-place")}if(Bn(Te))throw ra("root node is clobbered and cannot be sanitized in-place");try{Hn(Te)}catch(O){throw $n(Te),O}}else if(dn(Te))ae=Ia("<!---->"),he=ae.ownerDocument.importNode(Te,!0),he.nodeType===Qs.element&&he.nodeName==="BODY"||he.nodeName==="HTML"?ae=he:ae.appendChild(he),Hn(he);else{if(!ve&&!xe&&!_e&&Te.indexOf("<")===-1)return T&&Oe?C(Te):Te;if(ae=Ia(Te),!ae)return ve?null:Oe?L:""}ae&&B&&ut(ae.firstChild);const yt=aa(Be?Te:ae);try{for(;De=yt.nextNode();)Oa(De),es(De),Ys(De.content)&&un(De.content)}catch(vt){throw Be&&$n(Te),vt}if(Be)return vn(t.removed,vt=>{vt.element&&vi(vt.element)}),xe&&Un(Te),Te;if(ve){if(xe&&Un(ae),ke)for(Fe=I.call(ae.ownerDocument);ae.firstChild;)Fe.appendChild(ae.firstChild);else Fe=ae;return(w.shadowroot||w.shadowrootmode)&&(Fe=V.call(n,Fe,!0)),Fe}let it=_e?ae.outerHTML:ae.innerHTML;return _e&&fe["!doctype"]&&ae.ownerDocument&&ae.ownerDocument.doctype&&ae.ownerDocument.doctype.name&&Kt(u1,ae.ownerDocument.doctype.name)&&(it="<!DOCTYPE "+ae.ownerDocument.doctype.name+`>
`+it),xe&&vn([Y,le,se],vt=>{it=Fa(it,vt," ")}),T&&Oe?C(it):it},t.setConfig=function(){let Te=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};we(Te),Re=!0},t.clearConfig=function(){Ts=null,Re=!1,T=R,L=""},t.isValidAttribute=function(Te,P,ae){Ts||we({});const he=Xe(Te),De=Xe(P);return W(he,De,ae)},t.addHook=function(Te,P){typeof P=="function"&&Ma(K[Te],P)},t.removeHook=function(Te,P){if(P!==void 0){const ae=KS(K[Te],P);return ae===-1?void 0:WS(K[Te],ae,1)[0]}return kp(K[Te])},t.removeHooks=function(Te){K[Te]=[]},t.removeAllHooks=function(){K=Np()},t}var Dp=fv();function _d(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ra=_d();function hv(e){Ra=e}var Hi={exec:()=>null};function ot(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(fs.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var fs={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},m1=/^(?:[ \t]*(?:\n|$))+/,v1=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,g1=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,xl=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,b1=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,wd=/(?:[*+-]|\d{1,9}[.)])/,mv=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,vv=ot(mv).replace(/bull/g,wd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),y1=ot(mv).replace(/bull/g,wd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),kd=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,x1=/^[^\n]+/,Sd=/(?!\s*\])(?:\\.|[^\[\]\\])+/,_1=ot(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Sd).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),w1=ot(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,wd).getRegex(),tr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Td=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,k1=ot("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Td).replace("tag",tr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),gv=ot(kd).replace("hr",xl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tr).getRegex(),S1=ot(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",gv).getRegex(),Cd={blockquote:S1,code:v1,def:_1,fences:g1,heading:b1,hr:xl,html:k1,lheading:vv,list:w1,newline:m1,paragraph:gv,table:Hi,text:x1},Pp=ot("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",xl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tr).getRegex(),T1={...Cd,lheading:y1,table:Pp,paragraph:ot(kd).replace("hr",xl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Pp).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tr).getRegex()},C1={...Cd,html:ot(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Td).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Hi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ot(kd).replace("hr",xl).replace("heading",` *#{1,6} *[^
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+tn(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ka=new Z1;function at(e,t){return ka.parse(e,t)}at.options=at.setOptions=function(e){return ka.setOptions(e),at.defaults=ka.defaults,hv(at.defaults),at};at.getDefaults=_d;at.defaults=Ra;at.use=function(...e){return ka.use(...e),at.defaults=ka.defaults,hv(at.defaults),at};at.walkTokens=function(e,t){return ka.walkTokens(e,t)};at.parseInline=ka.parseInline;at.Parser=Tn;at.parser=Tn.parse;at.Renderer=To;at.TextRenderer=Rd;at.Lexer=Sn;at.lexer=Sn.lex;at.Tokenizer=So;at.Hooks=Kl;at.parse=at;at.options;at.setOptions;at.use;at.walkTokens;at.parseInline;Tn.parse;Sn.lex;const Y1={breaks:!0,gfm:!0};function Bp(e){if(!e)return"";try{if(typeof at<"u"&&at.parse){const t=at.parse(e,Y1);return typeof Dp<"u"?Dp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Q1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const X1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function eT(e){return X1[e]||"wrench"}const tT=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Hp(e){if(!e)return[];const t=e.match(tT);return t?[...new Set(t)]:[]}const sT={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(""),a=h(null),i=h(null),l=h(0),o=h("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=G(()=>t.value.trim().length>0&&!s.value),p=h(Ye.state||"disconnected");let f=null;const m=G(()=>{const A=p.value;return A==="connected"?"Connected":A==="reconnecting"?"Reconnecting…":A==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],k=G(()=>{const A=Math.floor(l.value/4)%v.length,S=l.value;return S>3?`${v[A]} (${S}s)`:v[0]});function N(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function y(){if(!i.value)return;const A=i.value;A.style.height="auto",A.style.height=Math.min(A.scrollHeight,120)+"px"}function g(A,S,I={}){const U={id:++c,role:A,content:S,timestamp:Date.now(),html:A==="bot"?Bp(S):"",tools_used:I.tools_used||[],is_error:I.is_error||!1,images:A==="bot"?Hp(S):[],files:I.files||[],_showTools:!1};return e.value.push(U),N(),A==="bot"&&Rt(()=>b()),U}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(S=>{S.setAttribute("data-copy","true"),S.style.position="relative";const I=document.createElement("button");I.className="chat-code-copy",I.textContent="Copy",I.addEventListener("click",()=>{const U=S.querySelector("code"),V=U?U.textContent:S.textContent;navigator.clipboard.writeText(V).then(()=>{I.textContent="Copied!",setTimeout(()=>{I.textContent="Copy"},1500)}).catch(()=>{})}),S.appendChild(I)})}function E(A){if(A===0)return!0;const S=e.value[A-1],I=e.value[A],U=new Date(S.timestamp).toDateString(),V=new Date(I.timestamp).toDateString();return U!==V}function T(A){const S=new Date(A),I=new Date;if(S.toDateString()===I.toDateString())return"Today";const U=new Date(I);return U.setDate(U.getDate()-1),S.toDateString()===U.toDateString()?"Yesterday":S.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function L(A){t.value=A,Rt(()=>j())}function R(A){window.open(A,"_blank","noopener")}function _(A){A.target.style.display="none"}function D(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function $(){r&&(clearInterval(r),r=null),l.value=0}function C(A){s.value&&(s.value=!1,$(),A.type==="chat_response"?g("bot",A.content,{tools_used:A.tools_used||[],is_error:A.is_error||!1,files:A.files||[]}):A.type==="chat_error"&&g("bot",A.error||"Unknown error",{is_error:!0}),Rt(()=>{var S;return(S=i.value)==null?void 0:S.focus()}))}async function M(A){try{const S=await z.post("/api/chat",{content:A,channel_id:o.value});g("bot",S.response,{tools_used:S.tools_used||[],is_error:S.is_error||!1,files:S.files||[]})}catch(S){g("bot",S.message||"Failed to send message",{is_error:!0})}}async function j(){const A=t.value.trim();if(!A||s.value)return;g("user",A),t.value="",s.value=!0,D(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(A,{channelId:o.value})||(await M(A),s.value=!1,$()),Rt(()=>{var I;return(I=i.value)==null?void 0:I.focus()})}async function J(){n.value="";try{if(!o.value){const S=await z.get("/api/auth/session");o.value=S.channel_id||S.user_id||"web-user"}const A=await z.get("/api/sessions/"+encodeURIComponent(o.value));if(A&&A.messages&&A.messages.length>0){for(const S of A.messages){const I=S.role==="user"?"user":"bot";let U=S.content||"";if(I==="user"){const K=U.match(/^\[.*?\]:\s*/);K&&(U=U.slice(K[0].length))}if(!U.trim())continue;const V={id:++c,role:I,content:U,timestamp:S.timestamp?S.timestamp*1e3:Date.now(),html:I==="bot"?Bp(U):"",tools_used:[],is_error:!1,images:I==="bot"?Hp(U):[],files:[],_showTools:!1};e.value.push(V)}Rt(()=>{N(),b()})}}catch(A){A&&A.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",ye.error(n.value))}}return je(()=>{Ye.subscribe("chat",C),p.value=Ye.state||"disconnected",f=Ye.onState(A=>{p.value=A}),J(),Rt(()=>{var A;return(A=i.value)==null?void 0:A.focus()})}),ft(()=>{Ye.unsubscribe("chat",C),f&&(f(),f=null),$()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:k,suggestions:d,send:j,autoResize:y,formatTime:Q1,formatDate:T,showDateSeparator:E,useSuggestion:L,openImage:R,onImageError:_,getToolIcon:eT,loadHistory:J}}},nT={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),o=h(!1),r=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),m=G(()=>e.value==="custom"),v=G(()=>[...i.value,...l.value]),k=G(()=>l.value.includes(e.value)),N=G(()=>{var R;return m.value?t.value||"Odin":((R=a.value[e.value])==null?void 0:R.name)||e.value}),y=G(()=>{var R;return m.value?s.value||"(empty — will use Odin default)":((R=a.value[e.value])==null?void 0:R.identity)||""}),g=G(()=>{var R;return m.value?n.value||"(empty — will use Odin default)":((R=a.value[e.value])==null?void 0:R.voice)||""});async function b(){d.value=!0;try{const R=await z.get("/api/personality");e.value=R.preset||"odin",t.value=R.custom_name||"",s.value=R.custom_identity||"",n.value=R.custom_voice||"",a.value=R.presets||{},i.value=R.builtin_presets||[],l.value=R.user_presets||[]}catch(R){c.value=R.message}finally{d.value=!1}}async function E(){o.value=!0,c.value=null,r.value=!1;try{await z.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(R){c.value=R.message}finally{o.value=!1}}async function T(){const R=u.value.trim();if(R){f.value=!0,c.value=null;try{await z.post("/api/personality/presets",{name:R,display_name:N.value,identity:y.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=R.toLowerCase().replace(/ /g,"_")}catch(_){c.value=_.message}finally{f.value=!1}}}async function L(){if(await qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await z.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(_){c.value=_.message}}}return je(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:k,previewName:N,previewIdentity:y,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:E,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:T,deletePreset:L,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Tv=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:$S,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:sT,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:tk,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:dk,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Ok,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:nT,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:OS,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/hosts",redirect:kt("/system","hosts")},{path:"/internals",redirect:kt("/system","internals")}],zi=Iw({history:rw(),routes:Tv});zi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const aT={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let o=null,r=null;const c=h(!1),d=h("disconnected"),u=h(-1),p=h(null);let f=null;const m=h("starting"),v=h(""),k=Tv.filter(U=>U.meta),N=G(()=>["Workspace","Operate","Observe","Manage"].map(U=>({name:U,routes:k.filter(V=>V.meta.section===U)})).filter(U=>U.routes.length)),y=G(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.label)||"Odin"}),g=G(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.section)||"Management"}),b=G(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.description)||"Management console"});function E(){Ye.disconnect(),j&&(clearInterval(j),j=null)}z.onSessionExpired=()=>{t.value=!0,E(),z.setToken(""),e.value="login"};function T(U){var V;if((U.ctrlKey||U.metaKey)&&U.key.toLowerCase()==="k"){e.value==="ready"&&(U.preventDefault(),yp());return}if(n.value&&U.key==="Tab"){const K=[...((V=a.value)==null?void 0:V.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(K.length){const Y=K[0],le=K[K.length-1];if(U.shiftKey&&(document.activeElement===Y||!a.value.contains(document.activeElement))){U.preventDefault(),le.focus();return}if(!U.shiftKey&&(document.activeElement===le||!a.value.contains(document.activeElement))){U.preventDefault(),Y.focus();return}}}if(U.key==="Escape"&&n.value){n.value=!1,U.preventDefault();return}if(U.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(U.target.tagName)){U.preventDefault();const K=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');K&&K.focus()}}function L(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}je(async()=>{document.addEventListener("keydown",T),o=window.matchMedia("(max-width: 900px)"),L(),o.addEventListener("change",L);const U=await z.check();U.ok?(e.value="ready",S()):U.needsAuth?e.value="login":(e.value="ready",S())});function R(){t.value=!1,e.value="ready",S()}async function _(){E(),e.value="login",await z.logout()}function D(){s.value=!s.value}function $(){n.value=!n.value}Mt(n,async U=>{var V,K;if(U)r=document.activeElement,await Rt(),(K=(V=a.value)==null?void 0:V.querySelector(".nav-item"))==null||K.focus();else if(r!=null&&r.isConnected){const Y=r;r=null,requestAnimationFrame(()=>Y.focus())}});const C=G(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(U,V="info",K=3e3){p.value={text:U,level:V},clearTimeout(f),f=setTimeout(()=>{p.value=null},K)}let j=null,J=!1,A=[];function S(){for(const U of A)U();A=[Ye.onStatus(U=>{c.value=U}),Ye.onLatencyChange(U=>{u.value=U}),Ye.onState((U,V)=>{d.value=U,U==="connected"?(J&&M("Connection restored","success"),J=!0):U==="reconnecting"&&V.attempt===1&&M("Connection lost — reconnecting…","warn")})],Ye.connect(),I(),j&&clearInterval(j),j=setInterval(I,15e3)}async function I(){try{const U=await z.get("/api/status");m.value=U.status==="online"?"online":"starting";const V=U.uptime_seconds||0,K=Math.floor(V/3600),Y=Math.floor(V%3600/60);v.value=`${K}h ${Y}m uptime`}catch{m.value="offline",v.value=""}}return ft(()=>{j&&clearInterval(j);for(const U of A)U();A=[],Ye.disconnect(),document.removeEventListener("keydown",T),o==null||o.removeEventListener("change",L)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:C,wsToast:p,botStatus:m,botUptime:v,navRoutes:k,navGroups:N,currentPage:y,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:R,logout:_,toggleSidebar:D,toggleMobileNavigation:$,openPalette:yp}}},sa=po(iT);sa.component("odin-icon",PS);sa.component("login-screen",aT);sa.component("toast-container",w_);sa.component("confirm-host",k_);sa.component("command-palette",DS);sa.directive("modal-focus",FS);sa.use(zi);sa.mount("#app");
