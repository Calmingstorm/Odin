...
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const sd=Object.create(null);function vx(e,t){if(!Ee(e))if(e.nodeType)e=e.innerHTML;else return Lt;const s=Lg(e,t),n=sd[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=De({hoistStatic:!0,onError:void 0,onWarn:Lt},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=mx(e,a),l=new Function("Vue",i)(Sy);return l._rc=!0,sd[s]=l}_p(vx);const Ll=wn({items:[]});let bx=1;function lr(e,t="info",s=3e3){const n=bx++;return Ll.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>kc(n),s),n}function kc(e){const t=Ll.items.findIndex(s=>s.id===e);t>=0&&Ll.items.splice(t,1)}function ke(e,t="info",s=3e3){return lr(e,t,s)}ke.success=(e,t=3e3)=>lr(e,"success",t);ke.error=(e,t=5e3)=>lr(e,"error",t);ke.info=(e,t=3e3)=>lr(e,"info",t);ke.dismiss=kc;const yx={setup(){return{state:Ll,dismiss:kc}},template:`
...
`,e=e.substring(f.length+1),o=!0),!o){const E=this.rules.other.nextBulletRegex(m),y=this.rules.other.hrRegex(m),v=this.rules.other.fencesBeginRegex(m),x=this.rules.other.headingBeginRegex(m),T=this.rules.other.htmlBeginRegex(m);for(;e;){const N=e.split(`
`,1)[0];let O;if(f=N,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),O=f):O=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||T.test(f)||E.test(f)||y.test(f))break;if(O.search(this.rules.other.nonSpaceChar)>=m||!f.trim())u+=`
`+O.slice(m);else{if(p||d.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||v.test(d)||x.test(d)||y.test(d))break;u+=`
`+f}!p&&!f.trim()&&(p=!0),c+=N+`
...
`)}),w=Q(()=>{const ee=d.value.trim();return ee?ee.includes("SKILL_DEFINITION")?ee.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function A(ee){return gw(ee)}function L(ee){return ee?ee.split(`
`).length:0}function B(ee){return mw(ee)}function P(ee){n.value={...n.value,[ee]:!n.value[ee]}}async function S(ee){try{await navigator.clipboard.writeText(ee);const pe=e.value.find(Ie=>Ie.code===ee);pe&&(r.value=pe.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function $(ee){if(ee.key==="Tab"){ee.preventDefault();const pe=ee.target,Ie=pe.selectionStart,V=pe.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(V),Et(()=>{pe.selectionStart=pe.selectionEnd=Ie+4})}}function q(ee){const pe=ee.target.previousElementSibling;pe&&(pe.scrollTop=ee.target.scrollTop)}async function G(){t.value=!0,s.value=null;try{e.value=await K.get("/api/skills")}catch(ee){s.value=ee.message}t.value=!1}async function D(ee){i.value=ee,delete a.value[ee],a.value={...a.value};try{const pe=await K.post(`/api/skills/${encodeURIComponent(ee)}/test`);a.value={...a.value,[ee]:pe}}catch(pe){a.value={...a.value,[ee]:{result:pe.message,is_error:!0}}}i.value=null}function I(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function j(ee){o.value=!0,c.value="edit",u.value=ee.name,d.value=ee.code||"",f.value=null,p.value=null}function ue(){o.value=!1,f.value=null,p.value=null}async function fe(){f.value=null,p.value=null;const ee=u.value.trim(),pe=d.value.trim();if(!ee){f.value="Name is required";return}if(!pe){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await K.post("/api/skills",{name:ee,code:pe}),p.value="Skill created successfully"):(await K.put(`/api/skills/${encodeURIComponent(ee)}`,{code:pe}),p.value="Skill updated successfully"),await G(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}m.value=!1}function ne(ee){k.value=ee}async function ge(){if(k.value){E.value=!0;try{await K.del(`/api/skills/${encodeURIComponent(k.value)}`),await G()}catch{}E.value=!1,k.value=null}}return Ue(()=>{G()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:k,deleting:E,enabledCount:y,totalExecutions:v,totalLines:x,displayedSkills:T,editLineCount:N,editorLineNums:O,editValidation:w,highlight:A,truncate:Ec,formatTs:La,countLines:L,getLineNumbers:B,toggleCode:P,copyCode:S,handleEditorKey:$,syncScroll:q,fetchSkills:G,testSkill:D,showCreate:I,editSkill:j,cancelEdit:ue,saveSkill:fe,confirmDelete:ne,doDelete:ge}}};function bw(e,t){if(!e||!t)return kd(e);const s=kd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),k=h(null),E=h(new Set),y=h(null),v=h(!1),x=h(!1),T=Q(()=>e.value.reduce((ne,ge)=>ne+ge.count,0)),N=Q(()=>E.value.size);function O(ne){const ge=t.value[ne];if(!ge)return[];if(!l.value.trim())return ge;const ee=l.value.trim().toLowerCase();return ge.filter(pe=>pe.key.toLowerCase().includes(ee)||pe.value&&pe.value.toLowerCase().includes(ee))}function w(ne,ge){return E.value.has(ne+"/"+ge)}function A(ne,ge){const ee=ne+"/"+ge,pe=new Set(E.value);pe.has(ee)?pe.delete(ee):pe.add(ee),E.value=pe}function L(ne){const ge=t.value[ne];return!ge||ge.length===0?!1:ge.every(ee=>E.value.has(ne+"/"+ee.key))}function B(ne,ge){const ee=t.value[ne];if(!ee)return;const pe=new Set(E.value);for(const Ie of ee){const V=ne+"/"+Ie.key;ge?pe.add(V):pe.delete(V)}E.value=pe}async function P(){s.value=!0,n.value=null;try{const ne=await K.get("/api/memory");e.value=Object.entries(ne).map(([ge,ee])=>({name:ge,keys:ee.keys||[],count:ee.count||0}))}catch(ne){n.value=ne.message}s.value=!1}async function S(ne){if(a.value[ne]){a.value[ne]=!1;return}a.value[ne]=!0;const ge=e.value.find(pe=>pe.name===ne);if(!ge||t.value[ne]||i.value===ne)return;i.value=ne;const ee=await Promise.all(ge.keys.map(async pe=>{try{const Ie=await K.get(`/api/memory/${encodeURIComponent(ne)}/${encodeURIComponent(pe)}`);return{key:pe,value:Ie.value||""}}catch{return{key:pe,value:"(error loading)"}}}));t.value[ne]=ee,i.value=null}function $(ne,ge,ee){f.value=ne+"/"+ge,p.value=ee}async function q(ne,ge){m.value=!0,g.value=null;try{await K.put(`/api/memory/${encodeURIComponent(ne)}/${encodeURIComponent(ge)}`,{value:p.value});const ee=t.value[ne];if(ee){const pe=ee.find(Ie=>Ie.key===ge);pe&&(pe.value=p.value)}f.value=null}catch(ee){g.value=`Failed to save: ${ee.message||"unknown error"}`}m.value=!1}async function G(ne,ge){try{await navigator.clipboard.writeText(ge.value),k.value=ne+"/"+ge.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function D(){u.value=null,d.value=null;const ne=o.value.scope.trim(),ge=o.value.key.trim(),ee=o.value.value.trim();if(!ne){u.value="Scope is required";return}if(!ge){u.value="Key is required";return}if(!ee){u.value="Value is required";return}c.value=!0;try{await K.put(`/api/memory/${encodeURIComponent(ne)}/${encodeURIComponent(ge)}`,{value:ee}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(pe){u.value=pe.message}c.value=!1}function I(ne,ge){y.value={scope:ne,key:ge}}async function j(){if(!y.value)return;v.value=!0,g.value=null;const{scope:ne,key:ge}=y.value;try{await K.del(`/api/memory/${encodeURIComponent(ne)}/${encodeURIComponent(ge)}`);const ee=t.value[ne];ee&&(t.value[ne]=ee.filter(V=>V.key!==ge));const pe=e.value.find(V=>V.name===ne);pe&&(pe.count--,pe.keys=pe.keys.filter(V=>V!==ge));const Ie=new Set(E.value);Ie.delete(ne+"/"+ge),E.value=Ie}catch(ee){g.value=`Failed to delete: ${ee.message||"unknown error"}`}v.value=!1,y.value=null}function ue(){x.value=!0}async function fe(){v.value=!0,g.value=null;const ne=[];for(const ge of E.value){const ee=ge.indexOf("/");ne.push({scope:ge.slice(0,ee),key:ge.slice(ee+1)})}try{await K.post("/api/memory/bulk-delete",{entries:ne}),E.value=new Set,t.value={},await P()}catch(ge){g.value=`Bulk delete failed: ${ge.message||"unknown error"}`}v.value=!1,x.value=!1}return Ue(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:k,selected:E,selectedCount:N,totalEntries:T,deleteTarget:y,deleting:v,showBulkDelete:x,fetchMemory:P,toggleScope:S,startEdit:$,doEdit:q,copyValue:G,doAdd:D,confirmDelete:I,doDelete:j,confirmBulkDelete:ue,doBulkDelete:fe,isSelected:w,toggleSelect:A,isScopeAllSelected:L,toggleSelectAll:B,filteredEntries:O}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const ae=new Blob([H],{type:"text/plain"}),Ce=URL.createObjectURL(ae),Ke=document.createElement("a");Ke.href=Ce,Ke.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ke.click(),URL.revokeObjectURL(Ce)}function de(H,ae){const Ce=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(Ce).then(()=>{f.value=ae,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function he(H){a.value=a.value===H?"":H,E.value="all"}function Me(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function b(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function C(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function M(H){E.value=H.id;const ae=H.filters;a.value=ae.level||"",y.value=ae.timeRange||"",i.value=ae.text||"",ae.levels&&(a.value=ae.levels[0]||""),ae.hasToolName&&(i.value="")}function W(H){E.value=H.id,a.value=H.filters.level||"",y.value=H.filters.timeRange||"",i.value=H.filters.text||""}function R(){if(!T.value.trim())return;const H={id:"custom-"+Date.now(),name:T.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};v.value=[...v.value,H],w(),x.value=!1,T.value=""}function F(H){v.value=v.value.filter(ae=>ae.id!==H),w(),E.value===H&&(E.value="all")}const Z=h("all"),X=h(""),se=h(""),J=h(""),me=h(""),le=h(""),ce=h(100),ye=Nw,_e=h(!1),Te=h(!1),U=h(""),oe=h([]),xe=h(null),Pe=h(null);function Je(){e.value="search",xe.value||Ze()}async function Ze(){try{xe.value=await K.get("/api/logs/stats")}catch{}}function xt(){const H=le.value;if(!H){J.value="",me.value="";return}const Ce={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(Ce){const Ke=new Date(Date.now()-Ce*1e3);J.value=et(Ke),me.value=""}}function et(H){const ae=Ce=>String(Ce).padStart(2,"0");return`${H.getFullYear()}-${ae(H.getMonth()+1)}-${ae(H.getDate())}T${ae(H.getHours())}:${ae(H.getMinutes())}`}function Ye(H){if(!H)return"";const ae=new Date(H);return isNaN(ae.getTime())?"":ae.toISOString()}async function Ss(){_e.value=!0,U.value="",Te.value=!0,Pe.value=null;try{const H=new URLSearchParams;Z.value&&Z.value!=="all"&&H.set("level",Z.value),X.value&&H.set("tool",X.value),se.value&&H.set("q",se.value);const ae=Ye(J.value),Ce=Ye(me.value);ae&&H.set("start",ae),Ce&&H.set("end",Ce),H.set("limit",String(ce.value));const Ke=await K.get(`/api/logs/search?${H.toString()}`);oe.value=Ke.entries||[]}catch(H){U.value=H.message||"Search failed",oe.value=[]}finally{_e.value=!1}}function Ms(){Z.value="all",X.value="",se.value="",J.value="",me.value="",le.value="",ce.value=100,oe.value=[],Te.value=!1,U.value="",Pe.value=null}function Y(H){Pe.value=Pe.value===H?null:H}function Ne(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function Ps(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function on(H){return H.error?"log-line-error":"text-gray-300"}function Zn(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let Dt=null,vs=null,cn=!1;function Da(){cn||(cn=!0,Ge.subscribe("logs",ne),r.value=Ge.connected,o.value=Ge.state||"disconnected",Dt=Ge.onStateChange,vs=(H,ae)=>{o.value=H,r.value=H==="connected",Dt&&Dt(H,ae)},Ge.onStateChange=vs)}function Mi(){cn&&(cn=!1,Ge.unsubscribe("logs",ne),Ge.onStateChange===vs&&(Ge.onStateChange=Dt),vs=null,Dt=null)}return Ue(O),Bo(Da),Uo(Mi),ht(Mi),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ue,pauseBuffer:N,showJumpBottom:d,copiedIndex:f,regexError:B,levels:m,logPresets:g,timeRanges:k,timeRange:y,activeLogPreset:E,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:T,hasActiveLogFilters:A,timeRangeLabel:L,timelineBuckets:S,timelineMax:$,timelineSpanLabel:q,timelineLabelSkip:G,togglePause:V,clearLogs:te,exportLogs:re,logLineClass:Me,levelClass:b,levelChipClass:C,toggleLevel:he,copyLine:de,jumpToBottom:pe,onScroll:Ie,applyLogPreset:M,applyCustomLogPreset:W,saveLogCustomPreset:R,removeLogCustomPreset:F,segmentHeight:I,jumpToTimelineBucket:j,searchLevel:Z,searchTool:X,searchKeyword:se,searchStart:J,searchEnd:me,searchTimePreset:le,searchLimit:ce,searchLimits:ye,searching:_e,searchRan:Te,searchError:U,searchResults:oe,searchStats:xe,expandedSearch:Pe,switchToSearch:Je,runSearch:Ss,clearSearchFilters:Ms,toggleSearchExpand:Y,formatSearchTs:Ne,searchEntryText:Ps,searchLogLineClass:on,formatJson:Zn,applySearchTimePreset:xt}}},Lw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Hr=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],gg="••••••••",Pw=50;function Fw(e){return Lw.has(e)}function $w(e){return e===gg}function Qi(e){return JSON.parse(JSON.stringify(e))}function Bn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Bw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Bn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Bn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Uw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Kd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Bn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Bn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=Q(()=>{const I={};for(const j of u.value)I[j.id]=j;return I});function p(I){return f.value[I]||null}const m=Q(()=>/^\d{15,25}$/.test(r.value.trim())),g=Q(()=>{if(o.value){if(k.value[c.value])return"host-user-option-"+c.value;if(m.value)return"host-user-option-raw"}}),k=Q(()=>{const I=r.value.toLowerCase().trim();return I?u.value.filter(j=>!i.value[j.id]&&(j.display_name.toLowerCase().includes(I)||j.username.toLowerCase().includes(I)||j.id.includes(I))):u.value.filter(j=>!i.value[j.id])});function E(I,j){return I?I.allowed_hosts===null||I.allowed_hosts===void 0?{allowed_hosts:[...j],default_host:I.default_host||"",allow_all:!0}:{allowed_hosts:I.allowed_hosts,default_host:I.default_host||"",allow_all:!1}:{allowed_hosts:[...j],default_host:j[0]||"",allow_all:!0}}async function y(){e.value=!0,t.value="";try{const I=await K.get("/api/host-access");s.value=I,n.value=I.available_hosts||[],a.value=E(I.default_policy,n.value);const j=I.users||{},ue={};for(const[fe,ne]of Object.entries(j))ue[fe]=E(ne,n.value);i.value=ue}catch(I){t.value=I.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await K.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const I=a.value.allow_all?null:a.value.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:I,default_host:a.value.default_host}),ke.success("Default policy updated")}catch(I){ke.error(I.message||"Failed to save")}}function x(I,j){a.value.allow_all=!1,j?a.value.allowed_hosts.includes(I)||a.value.allowed_hosts.push(I):(a.value.allowed_hosts=a.value.allowed_hosts.filter(ue=>ue!==I),a.value.default_host===I&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function T(I){const j=i.value[I];if(j)try{const ue=j.allow_all?null:j.allowed_hosts;await K.put(`/api/host-access/user/${I}`,{allowed_hosts:ue,default_host:j.default_host});const fe=p(I);ke.success(`Updated access for ${fe?fe.display_name:I}`)}catch(ue){ke.error(ue.message||"Failed to save")}}function N(I,j,ue){const fe=i.value[I];fe&&(fe.allow_all=!1,ue?fe.allowed_hosts.includes(j)||fe.allowed_hosts.push(j):(fe.allowed_hosts=fe.allowed_hosts.filter(ne=>ne!==j),fe.default_host===j&&(fe.default_host=fe.allowed_hosts[0]||"")),T(I))}function O(I,j){const ue=i.value[I];ue&&(ue.default_host=j,T(I))}function w(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function A(){o.value=!0,c.value=0}function L(){c.value<k.value.length-1&&c.value++}function B(){c.value>0&&c.value--}function P(){const I=k.value[c.value];if(I){$(I);return}m.value&&S()}function S(){const I=r.value.trim();/^\d{15,25}$/.test(I)&&(i.value[I]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},T(I),r.value="",o.value=!1,l.value=!1)}function $(I){i.value[I.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},T(I.id),r.value="",o.value=!1,l.value=!1}function q(){o.value=!1}function G(){setTimeout(()=>{o.value=!1},150)}async function D(I){const j=p(I);if(await ls({title:"Remove user override",message:`Remove the host access override for ${j?j.display_name:I}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await K.del(`/api/host-access/user/${I}`),delete i.value[I],ke.success(`Removed override for ${j?j.display_name:I}`)}catch(fe){ke.error(fe.message||"Failed to delete")}}return Ue(y),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:k,isRawId:m,activeOptionId:g,searchInput:d,fetchData:y,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:N,setUserDefault:O,openAddUser:w,deleteUser:D,onSearchInput:A,highlightNext:L,highlightPrev:B,selectHighlighted:P,selectMember:$,closeDropdown:q,onBlur:G,addRawId:S}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=Q(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=Q(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(w){return w==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":w==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const w=await K.get("/api/tokens");s.value=w.tokens||[],n.value=w.available_hosts||[]}catch(w){t.value=w.message||"Failed to load tokens"}finally{e.value=!1}}function g(w){return!w||!w.trim()?[]:w.split(",").map(A=>A.trim()).filter(Boolean)}function k(w,A){const L=c.value.allowed_hosts;if(A&&!L.includes(w)&&L.push(w),!A){const B=L.indexOf(w);B>=0&&L.splice(B,1)}}function E(w,A){const L=u.value.allowed_hosts;if(A&&!L.includes(w)&&L.push(w),!A){const B=L.indexOf(w);B>=0&&L.splice(B,1)}}async function y(){var w;i.value=!0;try{const A=g(c.value.allowed_tools_str),L=c.value.host_mode,B=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:A.length?A:[]};B!==null&&(P.allowed_hosts=B),P.default_host=c.value.default_host||"";const S=await K.post("/api/tokens",P);l.value=S.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ke.success("Token created"),await m()}catch(A){ke.error(((w=A.data)==null?void 0:w.error)||A.message||"Failed to create token")}finally{i.value=!1}}function v(w){r.value=w;const A=w.allowed_hosts;let L="default";A==null?L="default":Array.isArray(A)&&A.length===0?L="none":Array.isArray(A)&&(L="select"),u.value={username:w.username||"",tier:w.tier||"admin",label:w.label||"",host_mode:L,allowed_hosts:Array.isArray(A)?[...A]:[],default_host:w.default_host||"",allowed_tools_str:(w.allowed_tools||[]).join(", ")}}async function x(){var w;if(r.value){o.value=!0;try{const A=g(u.value.allowed_tools_str),L=u.value.host_mode,B={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:A};L==="none"?B.allowed_hosts=[]:L==="select"?B.allowed_hosts=u.value.allowed_hosts:B.allowed_hosts=null,B.default_host=u.value.default_host||"",await K.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,ke.success("Token updated"),await m()}catch(A){ke.error(((w=A.data)==null?void 0:w.error)||A.message||"Failed to update")}finally{o.value=!1}}}async function T(w){var L;if(await ls({title:"Regenerate token",message:`Regenerate token for ${w.username||w.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await K.post("/api/tokens/"+encodeURIComponent(w.user_id)+"/regenerate");l.value=B.token,ke.success("Token regenerated")}catch(B){ke.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to regenerate")}}async function N(w){var L;if(await ls({title:"Delete token",message:`Delete token for ${w.username||w.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/tokens/"+encodeURIComponent(w.user_id)),ke.success("Token deleted"),await m()}catch(B){ke.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return Ue(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:k,toggleEditHost:E,createToken:y,startEdit:v,saveEdit:x,confirmRegenerate:T,confirmDelete:N,copyToken:O}}};function Xi(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Kw={template:`
    <div class="p-6 page-fade-in">
