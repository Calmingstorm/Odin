...
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const of=Object.create(null);function _k(e,t){if(!We(e))if(e.nodeType)e=e.innerHTML;else return us;const s=$b(e,t),a=of[s];if(a)return a;if(e[0]==="#"){const o=document.querySelector(e);e=o?o.innerHTML:""}const n=at({hoistStatic:!0,onError:void 0,onWarn:us},t);!n.isCustomElement&&typeof customElements<"u"&&(n.isCustomElement=o=>!!customElements.get(o));const{code:i}=xk(e,n),l=new Function("Vue",i)(A_);return l._rc=!0,of[s]=l}Ph(_k);const _r=Tn({items:[]});let wk=1;function Jr(e,t="info",s=3e3){const a=wk++;return _r.items.push({id:a,message:String(e),type:t}),s>0&&setTimeout(()=>Eu(a),s),a}function Eu(e){const t=_r.items.findIndex(s=>s.id===e);t>=0&&_r.items.splice(t,1)}function Ee(e,t="info",s=3e3){return Jr(e,t,s)}Ee.success=(e,t=3e3)=>Jr(e,"success",t);Ee.error=(e,t=5e3)=>Jr(e,"error",t);Ee.info=(e,t=3e3)=>Jr(e,"info",t);Ee.dismiss=Eu;const kk={setup(){return{state:_r,dismiss:Eu}},template:`
...
`)}var Sr=class{constructor(e){Ct(this,"options");Ct(this,"rules");Ct(this,"lexer");this.options=e||ni}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const s=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?s:hl(s,`
