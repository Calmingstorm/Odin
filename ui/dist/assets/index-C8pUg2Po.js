...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}$e(()=>{qe.on("events",a),i=setInterval(l,500)}),ft(()=>{qe.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"⏳":c==="success"?"✅":c==="error"?"❌":"⭕"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},Yk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=Md,g=sw,k=h([]),E=h(!1),v=h(""),b=h("flat"),x=h(new Set),R=h(""),S=h(""),D=h(""),w=h(null),I=h(!1);function L(){try{const C=localStorage.getItem("odin-session-presets");C&&(k.value=JSON.parse(C))}catch{}}function H(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const F=ee(()=>d.value.trim()!==""||u.value!=="all"),P=ee(()=>{let C=[...e.value];const Z=Md.find(Ge=>Ge.id===u.value),be=Z?Z.filters:{};if(be.source&&(C=C.filter(Ge=>Ge.source===be.source)),be.minMessages&&(C=C.filter(Ge=>Ge.message_count>=be.minMessages)),be.hasCompaction&&(C=C.filter(Ge=>Ge.has_summary)),be.maxAge!=null){const Ge=Date.now()/1e3;C=C.filter(St=>St.last_active&&Ge-St.last_active<=be.maxAge)}if(d.value.trim()){const Ge=d.value.toLowerCase().trim();C=C.filter(St=>(St.channel_id||"").toLowerCase().includes(Ge)||(St.last_user_id||"").toLowerCase().includes(Ge)||(St.source||"").toLowerCase().includes(Ge))}const Le=f.value,Je=p.value?1:-1;return C.sort((Ge,St)=>{const st=Ge[Le]||0,Ye=St[Le]||0;return(st-Ye)*Je}),C}),W=ee(()=>{if(!a.value||!a.value.messages)return[];const C=a.value.messages;if(C.length===0)return[];const Z=[];let be=[];for(const Le of C)Le.role==="user"&&be.length>0&&(Z.push(be),be=[]),be.push(Le);return be.length>0&&Z.push(be),Z}),B=ee(()=>P.value.length>0&&o.value.size===P.value.length);function j(C){const Z=C.find(be=>be.role==="user");if(Z&&Z.content){const be=Z.content.slice(0,120);return be.length<Z.content.length?be+"...":be}return"(no user message)"}function N(C){const Z=new Set(x.value);Z.has(C)?Z.delete(C):Z.add(C),x.value=Z}function O(C){u.value=C}function z(C){u.value=C.id,C.filters.searchQuery!=null&&(d.value=C.filters.searchQuery),C.filters.sortBy&&(f.value=C.filters.sortBy)}function ue(){if(!v.value.trim())return;const C={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,C],H(),E.value=!1,v.value=""}function ve(C){k.value=k.value.filter(Z=>Z.id!==C),H(),u.value===C&&(u.value="all")}function se(){u.value="all",d.value="",f.value="last_active",p.value=!1}function de(C){if(!C)return"—";const Z=Date.now()/1e3-C;if(Z<60)return"just now";if(Z<3600){const Le=Math.floor(Z/60);return`${Le} minute${Le!==1?"s":""} ago`}if(Z<86400){const Le=Math.floor(Z/3600);return`${Le} hour${Le!==1?"s":""} ago`}const be=Math.floor(Z/86400);return`${be} day${be!==1?"s":""} ago`}function Y(C){if(!C)return"";try{return new Date(C*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function oe(C){if(!C)return"";try{return new Date(C*1e3).toLocaleString()}catch{return""}}function Ie(C){return C==="user"?"bg-gray-900/50 border border-gray-800":C==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function V(C){return C==="user"?"sess-msg-user":C==="assistant"?"sess-msg-assistant":"sess-msg-system"}function re(C){return C==="user"?"badge-info":C==="assistant"?"badge-success":"badge-warning"}function le(C){return C==="user"?"sess-dot-user":C==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ge(C){return C==="user"?"text-cyan-400":C==="assistant"?"text-indigo-400":"text-gray-500"}function me(C){return C?C.length>2e3?C.slice(0,2e3)+`
... (truncated)`:C:""}async function De(){const C=R.value.trim();if(C){I.value=!0;try{let Z=`/api/sessions/search?q=${encodeURIComponent(C)}&limit=50`;S.value.trim()&&(Z+=`&channel_id=${encodeURIComponent(S.value.trim())}`),D.value.trim()&&(Z+=`&user_id=${encodeURIComponent(D.value.trim())}`);const be=await K.get(Z);w.value=be.results||[]}catch{w.value=[]}I.value=!1}}function y(){R.value="",S.value="",D.value="",w.value=null}function T(C){return C?C.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(C){return C==="user"?"bg-gray-900/50 border-gray-800":C==="assistant"?"bg-indigo-950/30 border-indigo-900/30":C==="summary"?"bg-amber-950/20 border-amber-900/30":C==="fts"?"bg-emerald-950/20 border-emerald-900/30":C==="channel"?"bg-purple-950/20 border-purple-900/30":"bg-gray-900/30 border-gray-800/50"}function G(C){return C==="user"?"badge-info":C==="assistant"?"badge-success":C==="summary"?"badge-warning":C==="fts"?"badge-success":"badge-info"}async function A(){t.value=!0,s.value=null;try{e.value=await K.get("/api/sessions")}catch(C){s.value=C.message}t.value=!1}function $(){s.value=null,A()}async function J(C){if(n.value===C){n.value=null,a.value=null,x.value=new Set;return}n.value=C,a.value=null,i.value=!0,x.value=new Set;try{a.value=await K.get(`/api/sessions/${encodeURIComponent(C)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function X(C){const Z=new Set(o.value);Z.has(C)?Z.delete(C):Z.add(C),o.value=Z}function te(){B.value?o.value=new Set:o.value=new Set(P.value.map(C=>C.channel_id))}function Q(C){l.value=C}async function pe(){if(l.value){r.value=!0;try{await K.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await A()}catch(C){s.value=C.message||"Failed to clear session"}r.value=!1,l.value=null}}function ie(){c.value=!0}async function ce(){if(o.value.size!==0){r.value=!0;try{await K.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await A()}catch(C){s.value=C.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function ye(C,Z){const be=K._token;let Le=`/api/sessions/${encodeURIComponent(C)}/export?format=${Z}`;be&&(Le+=`&token=${encodeURIComponent(be)}`);const Je=document.createElement("a");Je.href=Le,Je.download=`session-${C}.${Z==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let Se=null;function Ee(C){C.payload&&C.payload.channel_id&&(clearTimeout(Se),Se=setTimeout(()=>{A(),n.value&&C.payload.channel_id===n.value&&K.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(Z=>{a.value=Z}).catch(()=>{})},2e3))}return $e(()=>{L(),A(),qe.subscribe("events",Ee)}),ft(()=>{qe.unsubscribe("events",Ee),clearTimeout(Se)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:B,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:P,hasActiveFilters:F,customPresets:k,showSavePreset:E,newPresetName:v,threadView:b,threads:W,collapsedThreads:x,ftsQuery:R,ftsChannelId:S,ftsUserId:D,ftsResults:w,ftsSearching:I,formatAge:de,formatTimestamp:Y,formatFullTimestamp:oe,messageClass:Ie,threadMsgClass:V,roleBadge:re,roleDotClass:le,roleLabelClass:ge,truncateContent:me,threadSummary:j,fetchSessions:A,retry:$,toggleSession:J,toggleSelect:X,toggleSelectAll:te,confirmClear:Q,clearSession:pe,confirmBulkClear:ie,doBulkClear:ce,exportSession:ye,applyPreset:O,applyCustomPreset:z,saveCustomPreset:ue,removeCustomPreset:ve,resetFilters:se,toggleThread:N,runFtsSearch:De,clearFtsSearch:y,highlightSnippet:T,ftsResultClass:M,ftsTypeBadge:G}}},aw={props:["trace"],template:`
...
`);const ne=new Blob([U],{type:"text/plain"}),_e=URL.createObjectURL(ne),Qe=document.createElement("a");Qe.href=_e,Qe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Qe.click(),URL.revokeObjectURL(_e)}function ge(U,ne){const _e=`${U.ts} ${U.level} ${U.text||U.raw||""}`;navigator.clipboard.writeText(_e).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function me(U){a.value=a.value===U?"":U,E.value="all"}function De(U){return U.level==="ERROR"?"log-line-error":U.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(U){return U==="ERROR"?"text-red-500 font-semibold":U==="WARNING"?"text-yellow-500":"text-blue-500"}function T(U){return U==="ERROR"?"log-chip-error":U==="WARNING"?"log-chip-warning":"log-chip-info"}function M(U){E.value=U.id;const ne=U.filters;a.value=ne.level||"",v.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function G(U){E.value=U.id,a.value=U.filters.level||"",v.value=U.filters.timeRange||"",i.value=U.filters.text||""}function A(){if(!R.value.trim())return;const U={id:"custom-"+Date.now(),name:R.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};b.value=[...b.value,U],w(),x.value=!1,R.value=""}function $(U){b.value=b.value.filter(ne=>ne.id!==U),w(),E.value===U&&(E.value="all")}const J=h("all"),X=h(""),te=h(""),Q=h(""),pe=h(""),ie=h(""),ce=h(100),ye=Tw,Se=h(!1),Ee=h(!1),C=h(""),Z=h([]),be=h(null),Le=h(null);function Je(){e.value="search",be.value||Ge()}async function Ge(){try{be.value=await K.get("/api/logs/stats")}catch{}}function St(){const U=ie.value;if(!U){Q.value="",pe.value="";return}const _e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[U];if(_e){const Qe=new Date(Date.now()-_e*1e3);Q.value=st(Qe),pe.value=""}}function st(U){const ne=_e=>String(_e).padStart(2,"0");return`${U.getFullYear()}-${ne(U.getMonth()+1)}-${ne(U.getDate())}T${ne(U.getHours())}:${ne(U.getMinutes())}`}function Ye(U){if(!U)return"";const ne=new Date(U);return isNaN(ne.getTime())?"":ne.toISOString()}async function en(){Se.value=!0,C.value="",Ee.value=!0,Le.value=null;try{const U=new URLSearchParams;J.value&&J.value!=="all"&&U.set("level",J.value),X.value&&U.set("tool",X.value),te.value&&U.set("q",te.value);const ne=Ye(Q.value),_e=Ye(pe.value);ne&&U.set("start",ne),_e&&U.set("end",_e),U.set("limit",String(ce.value));const Qe=await K.get(`/api/logs/search?${U.toString()}`);Z.value=Qe.entries||[]}catch(U){C.value=U.message||"Search failed",Z.value=[]}finally{Se.value=!1}}function mn(){J.value="all",X.value="",te.value="",Q.value="",pe.value="",ie.value="",ce.value=100,Z.value=[],Ee.value=!1,C.value="",Le.value=null}function Ai(U){Le.value=Le.value===U?null:U}function Ea(U){if(!U.timestamp)return"";try{return new Date(U.timestamp).toLocaleString()}catch{return U.timestamp}}function Ri(U){return U.type==="web_action"?`${U.status||""} (${U.execution_time_ms||0}ms)`:(U.result_summary||"").slice(0,200)}function Hn(U){return U.error?"log-line-error":"text-gray-300"}function jn(U){try{return JSON.stringify(U,null,2)}catch{return String(U)}}let Kt=null;return $e(()=>{D(),qe.subscribe("logs",se),r.value=qe.connected,o.value=qe.state||"disconnected",Kt=qe.onStateChange;const U=qe.onStateChange;qe.onStateChange=(ne,_e)=>{o.value=ne,r.value=ne==="connected",U&&U(ne,_e)}}),ft(()=>{qe.unsubscribe("logs",se),Kt!==void 0&&(qe.onStateChange=Kt)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ue,pauseBuffer:S,showJumpBottom:d,copiedIndex:f,regexError:H,levels:m,logPresets:g,timeRanges:k,timeRange:v,activeLogPreset:E,customLogPresets:b,showSaveLogPreset:x,newLogPresetName:R,hasActiveLogFilters:I,timeRangeLabel:L,timelineBuckets:P,timelineMax:W,timelineSpanLabel:B,timelineLabelSkip:j,togglePause:V,clearLogs:re,exportLogs:le,logLineClass:De,levelClass:y,levelChipClass:T,toggleLevel:me,copyLine:ge,jumpToBottom:oe,onScroll:Ie,applyLogPreset:M,applyCustomLogPreset:G,saveLogCustomPreset:A,removeLogCustomPreset:$,segmentHeight:O,jumpToTimelineBucket:z,searchLevel:J,searchTool:X,searchKeyword:te,searchStart:Q,searchEnd:pe,searchTimePreset:ie,searchLimit:ce,searchLimits:ye,searching:Se,searchRan:Ee,searchError:C,searchResults:Z,searchStats:be,expandedSearch:Le,switchToSearch:Je,runSearch:en,clearSearchFilters:mn,toggleSearchExpand:Ai,formatSearchTs:Ea,searchEntryText:Ri,searchLogLineClass:Hn,formatJson:jn,applySearchTimePreset:St}}},Ew=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Aw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Rw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1“128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Fr=[{key:"core",label:"Core",icon:"⚙",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"🧠",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"💾",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"🔗",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"🛠",sections:["tools"]},{key:"ui",label:"Web UI",icon:"🌐",sections:["web"]},{key:"automation",label:"Automation",icon:"🔄",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"🔌",sections:["issue_tracker"]}],cg="••••••••",Iw=50;function Nw(e){return Ew.has(e)}function Dw(e){return e===cg}function Ki(e){return JSON.parse(JSON.stringify(e))}function Nn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ow(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Nn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Lw(e,t,s){const n=Rw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Fd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Nn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Pw={template:`
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=ee(()=>d.value.length>0),m=ee(()=>f.value.length>0),g=ee(()=>r.value&&t.value?t.value:e.value),k=ee(()=>!e.value||!t.value?!1:!Nn(e.value,t.value)),E=ee(()=>!e.value||!t.value?0:Fd(e.value,t.value).length),v=ee(()=>{if(!r.value||!t.value)return{};const A={};for(const $ of Object.keys(t.value)){const J=t.value[$];if(typeof J=="object"&&J!==null&&!Array.isArray(J))for(const X of Object.keys(J)){const te=Lw($,X,J[X]);te&&(A[$+"."+X]=te)}}return A}),b=ee(()=>Object.keys(v.value).length>0),x=ee(()=>e.value?Object.keys(e.value).length:0),R=ee(()=>D.value.length),S=ee(()=>!e.value||!t.value?[]:Fd(e.value,t.value)),D=ee(()=>e.value?Fr.map(A=>({...A,sections:A.sections.filter($=>$ in e.value)})).filter(A=>A.sections.length>0):[]),w=ee(()=>{if(!e.value)return[];const A=new Set(Fr.flatMap($=>$.sections));return Object.keys(e.value).filter($=>!A.has($))});function I(A){return g.value?g.value[A]:null}function L(A){return!e.value||!t.value?!1:!Nn(e.value[A],t.value[A])}function H(A){return A.sections.some($=>L($))}function F(A,$){if(!e.value||!t.value)return!1;const J=e.value[A],X=t.value[A];return!J||!X?!1:!Nn(J[$],X[$])}function P(A){return t.value?t.value[A]:e.value[A]}function W(A,$){const J=t.value||e.value;return J[A]?J[A][$]:void 0}function B(A,$){const J=r.value&&t.value?t.value:e.value;return J[A]?J[A][$]:!1}function j(A,$){return v.value[A+"."+$]||null}function N(A,$){return Aw[A+"."+$]||null}function O(A,$,J){t.value&&($===null?t.value[A]=J:(t.value[A]||(t.value[A]={}),t.value[A][$]=J),t.value={...t.value})}function z(A,$,J){if(!t.value)return;const X=Ki(t.value);O(A,$,J),d.value.push(X),d.value.length>Iw&&d.value.shift(),f.value=[]}function ue(A,$,J){try{const X=JSON.parse(J);z(A,$,X)}catch{}}function ve(){d.value.length!==0&&(f.value.push(Ki(t.value)),t.value=d.value.pop())}function se(){f.value.length!==0&&(d.value.push(Ki(t.value)),t.value=f.value.pop())}function de(A,$,J){if(!t.value||!t.value[A])return;const X=[...t.value[A][$]];X.splice(J,1),z(A,$,X)}function Y(A,$){if(!t.value||!t.value[A])return;const J=[...t.value[A][$]||[]],X=prompt("Enter new value:");X!==null&&(J.push(X),z(A,$,J))}function oe(A){a.value={...a.value,[A]:!a.value[A]}}function Ie(A){l.value={...l.value,[A]:!l.value[A]}}function V(A){i.value={...i.value,[A]:!i.value[A]}}function re(A){try{return JSON.stringify(A,null,2)}catch{return String(A)}}function le(A){return A==null?"null":typeof A=="object"?JSON.stringify(A,null,2):String(A)}function ge(A,$){c.value={type:A,message:$},setTimeout(()=>{c.value=null},3e3)}function me(){t.value=Ki(e.value),r.value=!0,d.value=[],f.value=[]}function De(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function T(){if(!(!k.value||b.value)){o.value=!0;try{const A=Ow(e.value,t.value);if(Object.keys(A).length===0){ge("success","No changes to save."),o.value=!1;return}const $=await K.put("/api/config",A);e.value=$,r.value=!1,t.value=null,d.value=[],f.value=[],ge("success","Config saved successfully.")}catch(A){ge("error",A.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await K.get("/api/config");for(const A of Object.keys(e.value))a.value[A]===void 0&&(a.value[A]=!0);for(const A of Fr)l.value[A.key]===void 0&&(l.value[A.key]=!0)}catch(A){n.value=A.message}s.value=!1}function G(A){r.value&&((A.ctrlKey||A.metaKey)&&!A.shiftKey&&A.key==="z"?(A.preventDefault(),ve()):(A.ctrlKey||A.metaKey)&&(A.key==="y"||A.shiftKey&&A.key==="z"||A.shiftKey&&A.key==="Z")&&(A.preventDefault(),se()))}return $e(()=>{M(),document.addEventListener("keydown",G)}),ft(()=>{document.removeEventListener("keydown",G)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:b,changeCount:E,REDACTED:cg,showDiffModal:u,diffEntries:S,canUndo:p,canRedo:m,sectionCount:x,groupCount:R,visibleGroups:D,ungroupedSections:w,validationErrors:v,isSensitiveKey:Nw,isRedacted:Dw,sectionChanged:L,groupChanged:H,fieldChanged:F,getDisplay:I,getEdited:P,getEditedField:W,getDisplayBool:B,pushEdit:z,pushEditJson:ue,getValidationError:j,getEnumOptions:N,removeArrayItem:de,addArrayItem:Y,toggleSection:oe,toggleGroup:Ie,toggleNested:V,formatJson:re,formatDiffVal:le,showToast:ge,showDiff:y,fetchConfig:M,startEdit:me,cancelEdit:De,saveConfig:T,undo:ve,redo:se}}},Mw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium"}),a=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),i=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),l=h(!1),r=h(!1),o=h(!1),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h({configured:!1}),m=h([]),g=h(""),k=h(!1),E=h(!1),v=h({configured:!1}),b=h([]),x=h(""),R=h(!1),S=h(!1),D=h(!0),w=h(""),I=h({configured:!1,accounts:[]}),L=h(null),H=h(null),F=h(""),P=h(null),W=h(!1),B=h(null),j=h(null),N=h("");let O=null;function z(C,Z="success"){xe(C,Z==="error"?"error":"success")}function ue(C){if(!C)return"?";const Z=C/(1024*1024*1024);return Z>=1?Z.toFixed(1)+" GB":(C/(1024*1024)).toFixed(0)+" MB"}async function ve(){e.value=!0,await Promise.all([se(),de(),le(),Y()]),e.value=!1}async function se(){try{const C=await K.get("/api/llm/status");t.value=C,s.value=C.active_provider||"codex",C.codex&&!M.pending()&&(n.value.enabled=C.codex.enabled,n.value.model=C.codex.model||"gpt-5.5",n.value.reasoning_effort=C.codex.reasoning_effort||"medium",n.value.max_tokens=C.codex.max_tokens||4096),C.ollama&&!G.pending()&&(a.value.enabled=C.ollama.enabled,a.value.base_url=C.ollama.base_url||"",a.value.model=C.ollama.model||"",a.value.max_tokens=C.ollama.max_tokens||4096),C.kimi&&!A.pending()&&(i.value.enabled=C.kimi.enabled,i.value.model=C.kimi.model||"",i.value.max_tokens=C.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function de(){try{if(p.value=await K.get("/api/ollama/status"),p.value.model&&(g.value=p.value.model),p.value.configured)try{const C=await K.get("/api/ollama/models");m.value=C.models||[]}catch{m.value=[]}else if(a.value.base_url)try{const C=await K.post("/api/ollama/probe-models",{base_url:a.value.base_url});m.value=C.models||[]}catch{m.value=[]}}catch{p.value={configured:!1}}}async function Y(){D.value=!0,w.value="";try{I.value=await K.get("/api/codex/status")}catch(C){w.value=C.message||"Failed to fetch Codex status"}finally{D.value=!1}}async function oe(){const C=t.value?t.value.active_provider:"codex";f.value=!0;try{const Z=await K.post("/api/llm/switch",{provider:s.value});Z.error?(s.value=C,z(Z.error,"error")):(z("Switched to "+s.value+" ("+Z.model+")"),await ve())}catch(Z){s.value=C,z(Z.message||"Switch failed","error")}finally{f.value=!1}}async function Ie(){k.value=!0;try{const C=await K.post("/api/ollama/reload");z(C.configured?"Ollama reloaded":C.reason||"Ollama not configured",C.configured?"success":"error"),await ve()}catch(C){z(C.message||"Reload failed","error")}finally{k.value=!1}}async function V(){E.value=!0;try{await K.post("/api/ollama/model",{model:g.value}),z("Model set to "+g.value),await ve()}catch(C){z(C.message||"Failed","error")}finally{E.value=!1}}async function re(){const C=a.value.base_url;if(!C){z("Enter a base URL first","error");return}d.value=!0;try{const Z=await K.post("/api/ollama/probe-models",{base_url:C});m.value=Z.models||[],m.value.length?(z(m.value.length+" model(s) found"),!a.value.model&&m.value.length&&(a.value.model=m.value[0].name)):z("No models found at "+C,"error")}catch(Z){z(Z.message||"Could not reach Ollama","error")}finally{d.value=!1}}async function le(){try{if(v.value=await K.get("/api/kimi/status"),v.value.model&&(x.value=v.value.model),v.value.configured)try{const C=await K.get("/api/kimi/models");b.value=C.models||[]}catch{b.value=[]}}catch{v.value={configured:!1}}}async function ge(){R.value=!0;try{const C=await K.post("/api/kimi/reload");z(C.configured?"Kimi reloaded":C.reason||"Kimi not configured",C.configured?"success":"error"),await ve()}catch(C){z(C.message||"Reload failed","error")}finally{R.value=!1}}async function me(){S.value=!0;try{await K.post("/api/kimi/model",{model:x.value}),z("Model set to "+x.value),await ve()}catch(C){z(C.message||"Failed","error")}finally{S.value=!1}}async function De(){if(o.value){M();return}o.value=!0;try{await K.put("/api/llm/codex/config",n.value),z("Codex config saved"),await Promise.all([se(),Y()])}catch(C){z(C.message||"Failed","error"),await Promise.all([se(),Y()])}finally{o.value=!1}}async function y(){if(c.value){G();return}c.value=!0;try{const C={...a.value};l.value||delete C.api_key,await K.put("/api/llm/ollama/config",C),z("Ollama config saved"),a.value.api_key="",l.value=!1,await Promise.all([se(),de()])}catch(C){z(C.message||"Failed","error")}finally{c.value=!1}}async function T(){if(u.value){A();return}u.value=!0;try{const C={...i.value};r.value||delete C.api_key,await K.put("/api/llm/kimi/config",C),z("Kimi config saved"),i.value.api_key="",r.value=!1,await Promise.all([se(),le()])}catch(C){z(C.message||"Failed","error")}finally{u.value=!1}}const M=$r(De),G=$r(y),A=$r(T),$=()=>(M.cancel(),De()),J=()=>(G.cancel(),y()),X=()=>(A.cancel(),T());async function te(C){try{await K.post("/api/codex/account/"+C+"/activate"),z("Active account switched"),await Y()}catch(Z){z(Z.message||"Failed","error")}}async function Q(C){L.value=C;try{await K.post("/api/codex/account/"+C+"/refresh"),z("Token refreshed"),await Y()}catch(Z){z(Z.message||"Refresh failed","error")}finally{L.value=null}}function pe(C,Z){H.value=C,F.value=Z||""}async function ie(C){try{await K.put("/api/codex/account/"+C+"/label",{label:F.value}),z("Label updated"),H.value=null,await Y()}catch(Z){z(Z.message||"Failed","error")}}async function ce(C,Z){if(await ns({title:"Delete Codex account",message:`Delete ${Z||"account #"+(C+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+C),z("Deleted. Pool reloaded."),await Y()}catch(Le){z(Le.message||"Failed","error")}}async function ye(){W.value=!0;try{const C=await K.post("/api/codex/device-code");B.value=C,P.value="pending",Se(C)}catch(C){z(C.message||"Failed","error")}finally{W.value=!1}}async function Se(C){O={cancelled:!1};const Z=O;try{const be=await K.post("/api/codex/device-poll",{device_auth_id:C.device_auth_id,user_code:C.user_code,interval:C.interval});if(Z.cancelled)return;j.value=be,P.value="success",await ve()}catch(be){if(Z.cancelled)return;N.value=be.message||"Device login failed",P.value="error"}}function Ee(){O&&(O.cancelled=!0),P.value=null,B.value=null}return $e(ve),ft(()=>{O&&(O.cancelled=!0),M.cancel(),G.cancel(),A.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:f,codexForm:n,ollamaForm:a,kimiForm:i,savingCodex:o,savingOllama:c,savingKimi:u,probingOllama:d,ollamaKeyDirty:l,kimiKeyDirty:r,ollamaStatus:p,ollamaModels:m,ollamaSelectedModel:g,reloading:k,settingModel:E,kimiStatus:v,kimiModels:b,kimiSelectedModel:x,reloadingKimi:R,settingKimiModel:S,codexLoading:D,codexError:w,codexData:I,refreshing:L,editingLabel:H,labelValue:F,deviceState:P,deviceLoading:W,deviceInfo:B,deviceResult:j,deviceError:N,fetchAll:ve,switchProvider:oe,reloadOllama:Ie,setOllamaModel:V,reloadKimi:ge,setKimiModel:me,probeOllamaModels:re,saveCodexConfig:De,saveOllamaConfig:y,saveKimiConfig:T,saveCodexConfigDebounced:M,saveOllamaConfigDebounced:G,saveKimiConfigDebounced:A,saveCodexConfigNow:$,saveOllamaConfigNow:J,saveKimiConfigNow:X,activateAccount:te,refreshAccount:Q,startEditLabel:pe,saveLabel:ie,deleteAccount:ce,startDeviceLogin:ye,cancelDeviceLogin:Ee,formatSize:ue}}},$d={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Uw(e){return $d[e]||$d[(e||"").toLowerCase()]||"text-gray-400"}const Hw={template:`
