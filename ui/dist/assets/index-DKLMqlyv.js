...
`,1)[0];let I;if(f=T,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),I=f):I=f.replace(this.rules.other.tabCharGlobal,"    "),b.test(f)||x.test(f)||A.test(f)||E.test(f)||v.test(f))break;if(I.search(this.rules.other.nonSpaceChar)>=m||!f.trim())u+=`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}$e(()=>{qe.on("events",a),i=setInterval(l,500)}),ft(()=>{qe.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"⏳":c==="success"?"✅":c==="error"?"❌":"⭕"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},Jk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=te(()=>e.value.reduce((T,I)=>T+(I.iteration_count||0),0)),d=te(()=>e.value.filter(T=>T.status==="running").length);function f(T){return T==="running"?"loop-status-running":T==="error"?"loop-status-error":"loop-status-stopped"}function p(T){return T==="running"?"badge-success":T==="error"?"badge-danger":T==="completed"?"badge-info":"badge-warning"}function m(T){return T==="act"?"badge-warning":T==="silent"?"badge-info":"badge-success"}function g(T){c.value={...c.value,[T]:!c.value[T]}}async function S(T=!1){T=T===!0,T||(t.value=!0);try{e.value=await G.get("/api/loops"),s.value=null}catch(I){T||(s.value=I.message)}T||(t.value=!1)}async function E(){l.value=null;const T=a.value;if(!T.goal.trim()){l.value="Goal is required";return}if(!T.channel_id.trim()){l.value="Channel ID is required";return}const I={goal:T.goal.trim(),channel_id:T.channel_id.trim(),interval_seconds:T.interval_seconds||60,mode:T.mode,max_iterations:T.max_iterations||50};T.stop_condition.trim()&&(I.stop_condition=T.stop_condition.trim()),i.value=!0;try{const w=await G.post("/api/loops",I);we.success(`Loop started: ${w.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await S()}catch(w){l.value=w.message}i.value=!1}async function v(T){if(await ns({title:"Stop loop",message:`Stop loop ${T}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=T;try{await G.del(`/api/loops/${encodeURIComponent(T)}`),we.success("Loop stopped"),await S()}catch(w){we.error(w.message||"Failed to stop loop")}r.value=null}}async function b(T){o.value=T;try{await G.post(`/api/loops/${encodeURIComponent(T)}/restart`),we.success("Loop restarted"),await S()}catch(I){we.error(I.message||"Failed to restart loop")}o.value=null}function x(T){T.payload&&(T.payload.loop_id||T.payload.type==="loop")&&S(!0)}let A=null;return $e(()=>{S(),qe.subscribe("events",x),A=setInterval(()=>{d.value>0&&S(!0)},5e3)}),ft(()=>{qe.unsubscribe("events",x),A&&clearInterval(A)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:sr,formatAge:zh,toggleHistory:g,fetchLoops:S,doCreate:E,doStop:v,doRestart:b}}},Qk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=te(()=>e.value.filter(g=>g.status==="running").length),r=te(()=>e.value.filter(g=>g.status!=="running").length);function o(g){return g==="running"?"loop-status-running":g==="failed"||g==="error"?"loop-status-error":"loop-status-stopped"}function c(g){return g==="running"?"badge-success":g==="completed"||g==="exited"?"badge-info":g==="killed"||g==="error"||g==="failed"?"badge-danger":"badge-warning"}async function u(g=!1){g=g===!0,g||(t.value=!0);try{e.value=await G.get("/api/processes"),s.value=null}catch(S){g||(s.value=S.message)}g||(t.value=!1)}function d(){f(),n.value&&(a=setInterval(()=>{t.value||u(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}ds(n,g=>{g?d():f()});async function p(g){if(await ns({title:"Kill process",message:`Kill process ${g}?`,confirmLabel:"Kill",danger:!0})){i.value=g;try{await G.del(`/api/processes/${g}`),we.success(`Process ${g} killed`),await u()}catch(E){we.error(E.message||"Failed to kill process")}i.value=null}}function m(g){g.payload&&(g.payload.pid||g.payload.type==="process")&&u(!0)}return $e(()=>{u(),qe.subscribe("events",m),d()}),ft(()=>{qe.unsubscribe("events",m),f()}),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:sr,fetchProcesses:u,doKill:p}}},Xk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=te(()=>e.value.filter(_=>_.cron&&!_.one_time).length),m=te(()=>e.value.filter(_=>_.one_time).length),g=te(()=>e.value.filter(_=>_.trigger).length),S=te(()=>e.value.filter(_=>_.paused).length);function E(_){if(!_)return"-";const N=Date.now(),D=(new Date(_).getTime()-N)/1e3;if(D<0)return"overdue";if(D<60)return"in < 1 min";if(D<3600)return`in ${Math.floor(D/60)} min`;if(D<86400){const J=Math.floor(D/3600),$=Math.floor(D%3600/60);return $>0?`in ${J}h ${$}m`:`in ${J}h`}const L=Math.floor(D/86400);return`in ${L} day${L!==1?"s":""}`}function v(){r.value=null}async function b(){const _=a.value.cron.trim();if(_){o.value=!0;try{r.value=await G.post("/api/schedules/validate-cron",{expression:_})}catch(N){r.value={valid:!1,error:N.message}}o.value=!1}}async function x(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(_){s.value=_.message}t.value=!1}async function A(){l.value=null;const _=a.value;if(!_.description.trim()){l.value="Description is required";return}if(!_.channel_id.trim()){l.value="Channel ID is required";return}if(!_.cron.trim()&&!_.run_at.trim()){l.value="Cron expression or run_at time is required";return}const N={description:_.description.trim(),action:_.action,channel_id:_.channel_id.trim()};if(_.cron.trim()&&(N.cron=_.cron.trim()),_.run_at.trim()&&(N.run_at=_.run_at.trim()),_.action==="reminder"&&_.message.trim()&&(N.message=_.message.trim()),_.action==="check"&&(_.tool_name.trim()&&(N.tool_name=_.tool_name.trim()),_.tool_input_str.trim()))try{N.tool_input=JSON.parse(_.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",N),we.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await x()}catch(U){l.value=U.message}i.value=!1}async function T(_){u.value=_;try{await G.post(`/api/schedules/${encodeURIComponent(_)}/run`),we.success("Schedule triggered"),await x()}catch(N){we.error(N.message||"Failed to trigger")}u.value=null}async function I(_){f.value=_.id;const N=!_.paused;try{await G.put(`/api/schedules/${encodeURIComponent(_.id)}`,{paused:N}),we.success(N?"Schedule paused":"Schedule resumed"),await x()}catch(U){we.error(U.message||"Failed to update schedule")}f.value=null}async function w(_){const N=e.value.find(D=>D.id===_);if(await ns({title:"Delete schedule",message:`Delete "${(N==null?void 0:N.description)||_}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=_;try{await G.del(`/api/schedules/${encodeURIComponent(_)}`),we.success("Schedule deleted"),await x()}catch(D){we.error(D.message||"Failed to delete schedule")}d.value=null}}return $e(()=>{x()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,cronCount:p,oneTimeCount:m,webhookCount:g,pausedCount:S,formatTs:Sa,formatAge:zh,formatFuture:E,onCronInput:v,validateCron:b,fetchSchedules:x,doCreate:A,doRunNow:T,doTogglePause:I,doDelete:w}}},Zk={components:{TabbedPage:ir},setup(){return{tabs:[{id:"live",label:"Live",component:Wk},{id:"agents",label:"Agents",component:Jk},{id:"loops",label:"Loops",component:Yk},{id:"processes",label:"Processes",component:Qk},{id:"schedules",label:"Schedules",component:Xk}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},ew={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
... (truncated)`:H:""}async function Le(){const H=A.value.trim();if(H){_.value=!0;try{let ce=`/api/sessions/search?q=${encodeURIComponent(H)}&limit=50`;T.value.trim()&&(ce+=`&channel_id=${encodeURIComponent(T.value.trim())}`),I.value.trim()&&(ce+=`&user_id=${encodeURIComponent(I.value.trim())}`);const ye=await G.get(ce);w.value=ye.results||[]}catch{w.value=[]}_.value=!1}}function y(){A.value="",T.value="",I.value="",w.value=null}function C(H){return H?H.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function P(H){return H==="user"?"bg-gray-900/50 border-gray-800":H==="assistant"?"bg-indigo-950/30 border-indigo-900/30":H==="summary"?"bg-amber-950/20 border-amber-900/30":H==="fts"?"bg-emerald-950/20 border-emerald-900/30":H==="channel"?"bg-purple-950/20 border-purple-900/30":"bg-gray-900/30 border-gray-800/50"}function W(H){return H==="user"?"badge-info":H==="assistant"?"badge-success":H==="summary"?"badge-warning":H==="fts"?"badge-success":"badge-info"}async function R(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(H){s.value=H.message}t.value=!1}function F(){s.value=null,R()}async function Y(H){if(n.value===H){n.value=null,a.value=null,x.value=new Set;return}n.value=H,a.value=null,i.value=!0,x.value=new Set;try{a.value=await G.get(`/api/sessions/${encodeURIComponent(H)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Z(H){const ce=new Set(o.value);ce.has(H)?ce.delete(H):ce.add(H),o.value=ce}function se(){$.value?o.value=new Set:o.value=new Set(L.value.map(H=>H.channel_id))}function Q(H){l.value=H}async function B(){if(l.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await R()}catch(H){s.value=H.message||"Failed to clear session"}r.value=!1,l.value=null}}function ee(){c.value=!0}async function oe(){if(o.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await R()}catch(H){s.value=H.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function be(H,ce){const ye=G._token;let Me=`/api/sessions/${encodeURIComponent(H)}/export?format=${ce}`;ye&&(Me+=`&token=${encodeURIComponent(ye)}`);const Je=document.createElement("a");Je.href=Me,Je.download=`session-${H}.${ce==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let Te=null;function Ae(H){H.payload&&H.payload.channel_id&&(clearTimeout(Te),Te=setTimeout(()=>{R(),n.value&&H.payload.channel_id===n.value&&G.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(ce=>{a.value=ce}).catch(()=>{})},2e3))}return $e(()=>{N(),R(),qe.subscribe("events",Ae)}),ft(()=>{qe.unsubscribe("events",Ae),clearTimeout(Te)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:$,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:L,hasActiveFilters:D,customPresets:S,showSavePreset:E,newPresetName:v,threadView:b,threads:J,collapsedThreads:x,ftsQuery:A,ftsChannelId:T,ftsUserId:I,ftsResults:w,ftsSearching:_,formatAge:he,formatTimestamp:X,formatFullTimestamp:ue,messageClass:Ie,threadMsgClass:q,roleBadge:re,roleDotClass:le,roleLabelClass:pe,truncateContent:ge,threadSummary:V,fetchSessions:R,retry:F,toggleSession:Y,toggleSelect:Z,toggleSelectAll:se,confirmClear:Q,clearSession:B,confirmBulkClear:ee,doBulkClear:oe,exportSession:be,applyPreset:O,applyCustomPreset:K,saveCustomPreset:ve,removeCustomPreset:me,resetFilters:ie,toggleThread:M,runFtsSearch:Le,clearFtsSearch:y,highlightSnippet:C,ftsResultClass:P,ftsTypeBadge:W}}},nw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:R_}}},aw={components:{ContextAssemblyPanel:nw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(I){if(!I)return"—";try{const w=new Date(I);return isNaN(w.getTime())?I:w.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return I}}function f(I){return!I&&I!==0?"—":I<1e3?I+"ms":(I/1e3).toFixed(1)+"s"}function p(I){return!I&&I!==0?"—":I>=1e3?(I/1e3).toFixed(1)+"k":String(I)}function m(I){if(!I)return"";if(typeof I=="string")return I;try{return JSON.stringify(I,null,2)}catch{return String(I)}}function g(I){a.value===I?a.value=null:(a.value=I,c.value={})}function S(I,w){const _=I+"-"+w;c.value={...c.value,[_]:!c.value[_]}}function E(I,w){return!!c.value[I+"-"+w]}function v(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,A()}async function b(){try{const I=await G.get("/api/trajectories");e.value=I.files||[],o.value=I.count||0}catch{}}let x=0;async function A(){const I=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const w=await G.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(I!==x)return;let _=w.entries||[];u.value.tool_name&&(_=_.filter(N=>(N.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(_=_.filter(N=>N.is_error)),u.value.channel_id&&(_=_.filter(N=>N.channel_id===u.value.channel_id)),u.value.user_id&&(_=_.filter(N=>N.user_id===u.value.user_id)),t.value=_}else{const w=new URLSearchParams;u.value.channel_id&&w.set("channel_id",u.value.channel_id),u.value.user_id&&w.set("user_id",u.value.user_id),u.value.tool_name&&w.set("tool_name",u.value.tool_name),u.value.errors_only&&w.set("errors_only","true"),w.set("limit",String(u.value.limit));const _=w.toString(),N=await G.get(`/api/trajectories/search/query?${_}`);if(I!==x)return;t.value=N.results||[]}}catch(w){if(I!==x)return;n.value=w.message}I===x&&(s.value=!1)}async function T(){if(!l.value.trim())return;const I=++x;s.value=!0,n.value=null,c.value={};try{const w=await G.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(I!==x)return;i.value=w.entry||null,i.value||(n.value="No trace found for this message ID")}catch(w){if(I!==x)return;w.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=w.message}I===x&&(s.value=!1)}return $e(async()=>{await b(),await A()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:m,truncateBlock:Gh,toggleExpand:g,toggleIteration:S,isIterationExpanded:E,clearFilters:v,fetchFiles:b,fetchTraces:A,lookupMessage:T}}},iw={template:`
...
`).length:0}function U(X){return cw(X)}function D(X){n.value={...n.value,[X]:!n.value[X]}}async function L(X){try{await navigator.clipboard.writeText(X);const ue=e.value.find(Ie=>Ie.code===X);ue&&(r.value=ue.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function J(X){if(X.key==="Tab"){X.preventDefault();const ue=X.target,Ie=ue.selectionStart,q=ue.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(q),Et(()=>{ue.selectionStart=ue.selectionEnd=Ie+4})}}function $(X){const ue=X.target.previousElementSibling;ue&&(ue.scrollTop=X.target.scrollTop)}async function V(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function M(X){i.value=X,delete a.value[X],a.value={...a.value};try{const ue=await G.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:ue}}catch(ue){a.value={...a.value,[X]:{result:ue.message,is_error:!0}}}i.value=null}function O(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function K(X){o.value=!0,c.value="edit",u.value=X.name,d.value=X.code||"",f.value=null,p.value=null}function ve(){o.value=!1,f.value=null,p.value=null}async function me(){f.value=null,p.value=null;const X=u.value.trim(),ue=d.value.trim();if(!X){f.value="Name is required";return}if(!ue){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:X,code:ue}),p.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(X)}`,{code:ue}),p.value="Skill updated successfully"),await V(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}m.value=!1}function ie(X){S.value=X}async function he(){if(S.value){E.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(S.value)}`),await V()}catch{}E.value=!1,S.value=null}}return $e(()=>{V()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:S,deleting:E,enabledCount:v,totalExecutions:b,totalLines:x,displayedSkills:A,editLineCount:T,editorLineNums:I,editValidation:w,highlight:_,truncate:xc,formatTs:Sa,countLines:N,getLineNumbers:U,toggleCode:D,copyCode:L,handleEditorKey:J,syncScroll:$,fetchSkills:V,testSkill:M,showCreate:O,editSkill:K,cancelEdit:ve,saveSkill:me,confirmDelete:ie,doDelete:he}}};function dw(e,t){if(!e||!t)return fd(e);const s=fd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const fw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let S=null;const E=h(null),v=h(!1),b=h({}),x=h({}),A=h(null),T=h(null),I=te(()=>e.value.reduce((O,K)=>O+(K.chunks||0),0)),w=te(()=>new Set(e.value.map(K=>K.uploader).filter(Boolean)).size);function _(O,K){const ve=x.value[K];if(!ve||ve.length===0)return 0;const me=Math.max(...ve.map(ie=>ie.char_count||0));return me===0?0:Math.round(O.char_count/me*100)}async function N(){t.value=!0,s.value=null;try{const O=await G.get("/api/knowledge");e.value=Array.isArray(O)?O:[]}catch(O){s.value=O.message}t.value=!1}async function U(O){if(b.value[O]){b.value[O]=!1,T.value=null;return}if(b.value[O]=!0,!(x.value[O]||A.value===O)){A.value=O;try{const K=await G.get(`/api/knowledge/${encodeURIComponent(O)}/chunks`);x.value[O]=Array.isArray(K)?K:[]}catch(K){x.value[O]=[],we.error(`Failed to load chunks: ${K.message}`)}A.value=null}}async function D(){const O=n.value.trim();if(O){i.value=!0,r.value=null,l.value=O;try{const K=await G.get(`/api/knowledge/search?q=${encodeURIComponent(O)}`);a.value=Array.isArray(K)?K:[]}catch(K){a.value=[],r.value=K.message||"Search failed"}i.value=!1}}function L(){a.value=null,n.value="",r.value=null}async function J(){d.value=null,f.value=null;const O=c.value.trim(),K=u.value.trim();if(!O){d.value="Source name is required";return}if(!K){d.value="Content is required";return}p.value=!0;try{const ve=await G.post("/api/knowledge",{source:O,content:K});f.value=`Ingested ${ve.chunks||0} chunks from "${O}"`,c.value="",u.value="",x.value={},await N(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(ve){d.value=ve.message}p.value=!1}async function $(O){m.value=O,g.value=null,S&&(clearTimeout(S),S=null);try{const K=await G.post(`/api/knowledge/${encodeURIComponent(O)}/reingest`);g.value={source:O,error:!1,message:`Re-ingested ${K.chunks||0} chunks`},delete x.value[O],await N(),S=setTimeout(()=>{g.value=null,S=null},3e3)}catch(K){g.value={source:O,error:!0,message:K.message}}m.value=null}function V(O){E.value=O}async function M(){if(E.value){v.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(E.value)}`),delete x.value[E.value],await N()}catch{}v.value=!1,E.value=null}}return $e(()=>{N()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:E,deleting:v,expanded:b,sourceChunks:x,loadingChunks:A,selectedChunk:T,totalChunks:I,uploaderCount:w,truncate:xc,formatTs:Sa,highlightTerms:dw,chunkBarWidth:_,fetchSources:N,toggleSource:U,doSearch:D,clearSearch:L,doIngest:J,doReingest:$,confirmDelete:V,doDelete:M}}},pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
`);const ne=new Blob([j],{type:"text/plain"}),xe=URL.createObjectURL(ne),Qe=document.createElement("a");Qe.href=xe,Qe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Qe.click(),URL.revokeObjectURL(xe)}function pe(j,ne){const xe=`${j.ts} ${j.level} ${j.text||j.raw||""}`;navigator.clipboard.writeText(xe).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function ge(j){a.value=a.value===j?"":j,E.value="all"}function Le(j){return j.level==="ERROR"?"log-line-error":j.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(j){return j==="ERROR"?"text-red-500 font-semibold":j==="WARNING"?"text-yellow-500":"text-blue-500"}function C(j){return j==="ERROR"?"log-chip-error":j==="WARNING"?"log-chip-warning":"log-chip-info"}function P(j){E.value=j.id;const ne=j.filters;a.value=ne.level||"",v.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function W(j){E.value=j.id,a.value=j.filters.level||"",v.value=j.filters.timeRange||"",i.value=j.filters.text||""}function R(){if(!A.value.trim())return;const j={id:"custom-"+Date.now(),name:A.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};b.value=[...b.value,j],w(),x.value=!1,A.value=""}function F(j){b.value=b.value.filter(ne=>ne.id!==j),w(),E.value===j&&(E.value="all")}const Y=h("all"),Z=h(""),se=h(""),Q=h(""),B=h(""),ee=h(""),oe=h(100),be=Sw,Te=h(!1),Ae=h(!1),H=h(""),ce=h([]),ye=h(null),Me=h(null);function Je(){e.value="search",ye.value||Ke()}async function Ke(){try{ye.value=await G.get("/api/logs/stats")}catch{}}function St(){const j=ee.value;if(!j){Q.value="",B.value="";return}const xe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[j];if(xe){const Qe=new Date(Date.now()-xe*1e3);Q.value=st(Qe),B.value=""}}function st(j){const ne=xe=>String(xe).padStart(2,"0");return`${j.getFullYear()}-${ne(j.getMonth()+1)}-${ne(j.getDate())}T${ne(j.getHours())}:${ne(j.getMinutes())}`}function Ye(j){if(!j)return"";const ne=new Date(j);return isNaN(ne.getTime())?"":ne.toISOString()}async function en(){Te.value=!0,H.value="",Ae.value=!0,Me.value=null;try{const j=new URLSearchParams;Y.value&&Y.value!=="all"&&j.set("level",Y.value),Z.value&&j.set("tool",Z.value),se.value&&j.set("q",se.value);const ne=Ye(Q.value),xe=Ye(B.value);ne&&j.set("start",ne),xe&&j.set("end",xe),j.set("limit",String(oe.value));const Qe=await G.get(`/api/logs/search?${j.toString()}`);ce.value=Qe.entries||[]}catch(j){H.value=j.message||"Search failed",ce.value=[]}finally{Te.value=!1}}function mn(){Y.value="all",Z.value="",se.value="",Q.value="",B.value="",ee.value="",oe.value=100,ce.value=[],Ae.value=!1,H.value="",Me.value=null}function Ei(j){Me.value=Me.value===j?null:j}function Ca(j){if(!j.timestamp)return"";try{return new Date(j.timestamp).toLocaleString()}catch{return j.timestamp}}function Ai(j){return j.type==="web_action"?`${j.status||""} (${j.execution_time_ms||0}ms)`:(j.result_summary||"").slice(0,200)}function Hn(j){return j.error?"log-line-error":"text-gray-300"}function jn(j){try{return JSON.stringify(j,null,2)}catch{return String(j)}}let Gt=null;return $e(()=>{I(),qe.subscribe("logs",ie),r.value=qe.connected,o.value=qe.state||"disconnected",Gt=qe.onStateChange;const j=qe.onStateChange;qe.onStateChange=(ne,xe)=>{o.value=ne,r.value=ne==="connected",j&&j(ne,xe)}}),ft(()=>{qe.unsubscribe("logs",ie),Gt!==void 0&&(qe.onStateChange=Gt)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ve,pauseBuffer:T,showJumpBottom:d,copiedIndex:f,regexError:U,levels:m,logPresets:g,timeRanges:S,timeRange:v,activeLogPreset:E,customLogPresets:b,showSaveLogPreset:x,newLogPresetName:A,hasActiveLogFilters:_,timeRangeLabel:N,timelineBuckets:L,timelineMax:J,timelineSpanLabel:$,timelineLabelSkip:V,togglePause:q,clearLogs:re,exportLogs:le,logLineClass:Le,levelClass:y,levelChipClass:C,toggleLevel:ge,copyLine:pe,jumpToBottom:ue,onScroll:Ie,applyLogPreset:P,applyCustomLogPreset:W,saveLogCustomPreset:R,removeLogCustomPreset:F,segmentHeight:O,jumpToTimelineBucket:K,searchLevel:Y,searchTool:Z,searchKeyword:se,searchStart:Q,searchEnd:B,searchTimePreset:ee,searchLimit:oe,searchLimits:be,searching:Te,searchRan:Ae,searchError:H,searchResults:ce,searchStats:ye,expandedSearch:Me,switchToSearch:Je,runSearch:en,clearSearchFilters:mn,toggleSearchExpand:Ei,formatSearchTs:Ca,searchEntryText:Ai,searchLogLineClass:Hn,formatJson:jn,applySearchTimePreset:St}}},Cw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Ew={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Aw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1“128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"monitoring.cooldown_minutes":{type:"number",min:0,message:"Must be non-negative"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Fr=[{key:"core",label:"Core",icon:"⚙",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"🧠",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"💾",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"🔗",sections:["webhook","monitoring","observability","email","voice","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"🛠",sections:["tools"]},{key:"ui",label:"Web UI",icon:"🌐",sections:["web"]},{key:"automation",label:"Automation",icon:"🔄",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"🔌",sections:["issue_tracker"]}],og="••••••••",Rw=50;function Iw(e){return Cw.has(e)}function Nw(e){return e===og}function zi(e){return JSON.parse(JSON.stringify(e))}function Nn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Dw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Nn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Ow(e,t,s){const n=Aw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Md(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Nn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Lw={template:`
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=te(()=>{const M={};for(const O of u.value)M[O.id]=O;return M});function p(M){return f.value[M]||null}const m=te(()=>/^\d{15,25}$/.test(r.value.trim())),g=te(()=>{const M=r.value.toLowerCase().trim();return M?u.value.filter(O=>!i.value[O.id]&&(O.display_name.toLowerCase().includes(M)||O.username.toLowerCase().includes(M)||O.id.includes(M))):u.value.filter(O=>!i.value[O.id])});function S(M,O){return M?M.allowed_hosts===null||M.allowed_hosts===void 0?{allowed_hosts:[...O],default_host:M.default_host||"",allow_all:!0}:{allowed_hosts:M.allowed_hosts,default_host:M.default_host||"",allow_all:!1}:{allowed_hosts:[...O],default_host:O[0]||"",allow_all:!0}}async function E(){e.value=!0,t.value="";try{const M=await G.get("/api/host-access");s.value=M,n.value=M.available_hosts||[],a.value=S(M.default_policy,n.value);const O=M.users||{},K={};for(const[ve,me]of Object.entries(O))K[ve]=S(me,n.value);i.value=K}catch(M){t.value=M.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await G.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const M=a.value.allow_all?null:a.value.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:a.value.default_host}),we.success("Default policy updated")}catch(M){we.error(M.message||"Failed to save")}}function b(M,O){a.value.allow_all=!1,O?a.value.allowed_hosts.includes(M)||a.value.allowed_hosts.push(M):(a.value.allowed_hosts=a.value.allowed_hosts.filter(K=>K!==M),a.value.default_host===M&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function x(M){const O=i.value[M];if(O)try{const K=O.allow_all?null:O.allowed_hosts;await G.put(`/api/host-access/user/${M}`,{allowed_hosts:K,default_host:O.default_host});const ve=p(M);we.success(`Updated access for ${ve?ve.display_name:M}`)}catch(K){we.error(K.message||"Failed to save")}}function A(M,O,K){const ve=i.value[M];ve&&(ve.allow_all=!1,K?ve.allowed_hosts.includes(O)||ve.allowed_hosts.push(O):(ve.allowed_hosts=ve.allowed_hosts.filter(me=>me!==O),ve.default_host===O&&(ve.default_host=ve.allowed_hosts[0]||"")),x(M))}function T(M,O){const K=i.value[M];K&&(K.default_host=O,x(M))}function I(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function w(){o.value=!0,c.value=0}function _(){c.value<g.value.length-1&&c.value++}function N(){c.value>0&&c.value--}function U(){const M=g.value[c.value];if(M){L(M);return}m.value&&D()}function D(){const M=r.value.trim();/^\d{15,25}$/.test(M)&&(i.value[M]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(M),r.value="",o.value=!1,l.value=!1)}function L(M){i.value[M.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(M.id),r.value="",o.value=!1,l.value=!1}function J(){o.value=!1}function $(){setTimeout(()=>{o.value=!1},150)}async function V(M){const O=p(M);if(await ns({title:"Remove user override",message:`Remove the host access override for ${O?O.display_name:M}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await G.del(`/api/host-access/user/${M}`),delete i.value[M],we.success(`Removed override for ${O?O.display_name:M}`)}catch(ve){we.error(ve.message||"Failed to delete")}}return $e(E),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:g,isRawId:m,searchInput:d,fetchData:E,saveDefaultPolicy:v,toggleDefaultHost:b,getMember:p,toggleUserHost:A,setUserDefault:T,openAddUser:I,deleteUser:V,onSearchInput:w,highlightNext:_,highlightPrev:N,selectHighlighted:U,selectMember:L,closeDropdown:J,onBlur:$,addRawId:D}}},Fw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=te(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=te(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(w){return w==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":w==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const w=await G.get("/api/tokens");s.value=w.tokens||[],n.value=w.available_hosts||[]}catch(w){t.value=w.message||"Failed to load tokens"}finally{e.value=!1}}function g(w){return!w||!w.trim()?[]:w.split(",").map(_=>_.trim()).filter(Boolean)}function S(w,_){const N=c.value.allowed_hosts;if(_&&!N.includes(w)&&N.push(w),!_){const U=N.indexOf(w);U>=0&&N.splice(U,1)}}function E(w,_){const N=u.value.allowed_hosts;if(_&&!N.includes(w)&&N.push(w),!_){const U=N.indexOf(w);U>=0&&N.splice(U,1)}}async function v(){var w;i.value=!0;try{const _=g(c.value.allowed_tools_str),N=c.value.host_mode,U=N==="none"?[]:N==="select"?c.value.allowed_hosts:null,D={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:_.length?_:[]};U!==null&&(D.allowed_hosts=U),D.default_host=c.value.default_host||"";const L=await G.post("/api/tokens",D);l.value=L.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,we.success("Token created"),await m()}catch(_){we.error(((w=_.data)==null?void 0:w.error)||_.message||"Failed to create token")}finally{i.value=!1}}function b(w){r.value=w;const _=w.allowed_hosts;let N="default";_==null?N="default":Array.isArray(_)&&_.length===0?N="none":Array.isArray(_)&&(N="select"),u.value={username:w.username||"",tier:w.tier||"admin",label:w.label||"",host_mode:N,allowed_hosts:Array.isArray(_)?[..._]:[],default_host:w.default_host||"",allowed_tools_str:(w.allowed_tools||[]).join(", ")}}async function x(){var w;if(r.value){o.value=!0;try{const _=g(u.value.allowed_tools_str),N=u.value.host_mode,U={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:_};N==="none"?U.allowed_hosts=[]:N==="select"?U.allowed_hosts=u.value.allowed_hosts:U.allowed_hosts=null,U.default_host=u.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),U),r.value=null,we.success("Token updated"),await m()}catch(_){we.error(((w=_.data)==null?void 0:w.error)||_.message||"Failed to update")}finally{o.value=!1}}}async function A(w){var N;if(await ns({title:"Regenerate token",message:`Regenerate token for ${w.username||w.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const U=await G.post("/api/tokens/"+encodeURIComponent(w.user_id)+"/regenerate");l.value=U.token,we.success("Token regenerated")}catch(U){we.error(((N=U.data)==null?void 0:N.error)||U.message||"Failed to regenerate")}}async function T(w){var N;if(await ns({title:"Delete token",message:`Delete token for ${w.username||w.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(w.user_id)),we.success("Token deleted"),await m()}catch(U){we.error(((N=U.data)==null?void 0:N.error)||U.message||"Failed to delete")}}async function I(){if(l.value)try{await navigator.clipboard.writeText(l.value),we.success("Copied to clipboard")}catch{we.error("Copy failed — select and copy manually")}}return $e(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:S,toggleEditHost:E,createToken:v,startEdit:b,saveEdit:x,confirmRegenerate:A,confirmDelete:T,copyToken:I}}},$w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
