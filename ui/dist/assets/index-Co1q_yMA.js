...
... (truncated)`:s}function Sd(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function sg(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function M_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const P_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=J(()=>{const S=e.value.uptime_seconds||0,U=Math.floor(S/86400),G=Math.floor(S%86400/3600),W=Math.floor(S%3600/60),D=[];return U>0&&D.push(`${U}d`),G>0&&D.push(`${G}h`),(D.length===0||U===0&&G===0)&&D.push(`${W}m`),D.join(" ")}),p=J(()=>{const S=e.value.uptime_seconds||0;return 125.66*(1-Math.min(S/86400,1))}),b=J(()=>{const S=e.value;return[{label:"Guilds",value:S.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:S.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:S.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${S.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:S.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:S.loop_count>0?"text-green-400":"",highlight:S.loop_count>0},{label:"Agents",value:S.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:S.agent_count>0?`${S.agent_count} total`:"",subColor:"text-gray-500",highlight:(S.agent_running??0)>0},{label:"Processes",value:S.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:S.process_count>0?`${S.process_count} total`:"",subColor:"text-gray-500",highlight:(S.process_running??0)>0},{label:"Schedules",value:S.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(S.schedule_failing>0?`${S.schedule_failing} failing`:"")+(S.schedule_failing>0&&S.schedule_paused>0?", ":"")+(S.schedule_paused>0?`${S.schedule_paused} paused`:"")||void 0,subColor:S.schedule_failing>0?"text-red-400":"text-yellow-400",color:S.schedule_failing>0?"text-red-400":"",highlight:S.schedule_failing>0},{label:"Users",value:S.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=J(()=>{const S=e.value,U=[];return U.push({label:"Bot",status:S.status==="online"?"ok":"warn",detail:S.status==="online"?"Online":"Starting"}),(S.schedule_failing||0)>0?U.push({label:"Schedules",status:"error",detail:`${S.schedule_failing} failing`}):(S.schedule_count||0)>0&&U.push({label:"Schedules",status:"ok",detail:`${S.schedule_count} configured`}),(S.loop_count||0)>0&&U.push({label:"Loops",status:"ok",detail:`${S.loop_count} active`}),(S.agent_running||0)>0&&U.push({label:"Agents",status:"ok",detail:`${S.agent_running} running`}),(S.process_running||0)>0&&U.push({label:"Processes",status:"ok",detail:`${S.process_running} running`}),U});async function T(){try{e.value=await K.get("/api/status"),s.value=null}catch(S){s.value=S.message}finally{t.value=!1}}async function L(){a.value=!0;try{n.value=await K.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function y(){l.value=!0;try{i.value=await K.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function v(){try{const S=await K.get("/api/knowledge");c.value=(Array.isArray(S)?S:[]).reduce((U,G)=>U+(G.chunks||0),0)}catch{c.value=null}}async function x(){try{const S=await K.get("/api/agents");r.value=S.filter(U=>U.status==="running")}catch{}}async function w(){u.value={...u.value,reload:!0};try{await K.post("/api/reload"),_e.success("Config reloaded")}catch(S){_e.error(S.message)}u.value={...u.value,reload:!1}}async function I(){if(!await rs({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const U=e.value.session_count;e.value={...e.value,session_count:0};try{const G=await K.post("/api/sessions/clear-all");_e.success(`Cleared ${G.count} session${G.count!==1?"s":""}`),await T()}catch(G){e.value={...e.value,session_count:U},_e.error(G.message)}u.value={...u.value,clearSessions:!1}}async function N(){if(!await rs({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const U=e.value.loop_count;e.value={...e.value,loop_count:0};try{const G=await K.post("/api/loops/stop-all");_e.success(G.result),await T()}catch(G){e.value={...e.value,loop_count:U},_e.error(G.message)}u.value={...u.value,stopLoops:!1}}function k(){t.value=!0,s.value=null,T(),L(),y(),x()}let C=null,O=null,B=null;function F(S){if(S.payload&&S.payload.tool_name){const U={...S.payload,_isNew:!0,_key:++d};n.value.unshift(U),n.value.length>10&&n.value.pop(),o.value++,U.error&&(i.value.unshift(U),i.value.length>5&&i.value.pop()),setTimeout(()=>{U._isNew=!1},1500),clearTimeout(B),B=setTimeout(()=>{o.value=0},1e4)}}return He(async()=>{await Promise.all([T(),L(),y(),x(),v()]),C=setInterval(T,15e3),O=setInterval(x,1e4),We.subscribe("events",F)}),gt(()=>{C&&clearInterval(C),O&&clearInterval(O),clearTimeout(B),We.unsubscribe("events",F)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:b,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:L,fetchStatus:T,formatTime:Nc,formatDuration:Oa,retry:k,reloadConfig:w,clearSessions:I,stopAllLoops:N}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Td(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function F_(e){if(Array.isArray(e))return e}function $_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function U_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function B_(e,t){return F_(e)||$_(e,t)||H_(e,t)||U_()}function H_(e,t){if(e){if(typeof e=="string")return Td(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Td(e,t):void 0}}const ng=Object.entries,Cd=Object.setPrototypeOf,V_=Object.isFrozen,j_=Object.getPrototypeOf,z_=Object.getOwnPropertyDescriptor;let Gt=Object.freeze,vs=Object.seal,ua=Object.create,ag=typeof Reflect<"u"&&Reflect,Eo=ag.apply,Ao=ag.construct;Gt||(Gt=function(t){return t});vs||(vs=function(t){return t});Eo||(Eo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});Ao||(Ao=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Vs=xt(Array.prototype.forEach),q_=xt(Array.prototype.lastIndexOf),Ed=xt(Array.prototype.pop),ia=xt(Array.prototype.push),K_=xt(Array.prototype.splice),Vt=Array.isArray,ei=xt(String.prototype.toLowerCase),Hr=xt(String.prototype.toString),Ad=xt(String.prototype.match),la=xt(String.prototype.replace),Rd=xt(String.prototype.indexOf),G_=xt(String.prototype.trim),W_=xt(Number.prototype.toString),Z_=xt(Boolean.prototype.toString),Id=typeof BigInt>"u"?null:xt(BigInt.prototype.toString),Nd=typeof Symbol>"u"?null:xt(Symbol.prototype.toString),ot=xt(Object.prototype.hasOwnProperty),Ga=xt(Object.prototype.toString),Rt=xt(RegExp.prototype.test),Nn=J_(TypeError);function xt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return Eo(e,t,n)}}function J_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return Ao(e,s)}}function Oe(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:ei;if(Cd&&Cd(e,null),!Vt(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(V_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function Y_(e){for(let t=0;t<e.length;t++)ot(e,t)||(e[t]=null);return e}function Mt(e){const t=ua(null);for(const n of ng(e)){var s=B_(n,2);const a=s[0],i=s[1];ot(e,a)&&(Vt(i)?t[a]=Y_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Mt(i):t[a]=i)}return t}function Q_(e){switch(typeof e){case"string":return e;case"number":return W_(e);case"boolean":return Z_(e);case"bigint":return Id?Id(e):"0";case"symbol":return Nd?Nd(e):"Symbol()";case"undefined":return Ga(e);case"function":case"object":{if(e===null)return Ga(e);const t=e,s=Rs(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Ga(n)}return Ga(e)}default:return Ga(e)}}function Rs(e,t){for(;e!==null;){const n=z_(e,t);if(n){if(n.get)return xt(n.get);if(typeof n.value=="function")return xt(n.value)}e=j_(e)}function s(){return null}return s}function X_(e){try{return Rt(e,""),!0}catch{return!1}}const Ld=Gt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Vr=Gt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),jr=Gt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ek=Gt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),zr=Gt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),tk=Gt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Od=Gt(["#text"]),Dd=Gt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),qr=Gt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Md=Gt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),el=Gt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),sk=vs(/{{[\w\W]*|^[\w\W]*}}/g),nk=vs(/<%[\w\W]*|^[\w\W]*%>/g),ak=vs(/\${[\w\W]*/g),ik=vs(/^data-[\-\w.\u00B7-\uFFFF]+$/),lk=vs(/^aria-[\-\w]+$/),Pd=vs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),rk=vs(/^(?:\w+script|data):/i),ok=vs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ck=vs(/^html$/i),uk=vs(/^[a-z][.\w]*(-[.\w]+)+$/i),Es={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},dk=function(){return typeof window>"u"?null:window},fk=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Fd=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function ig(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:dk();const t=ve=>ig(ve);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Es.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=Rs(f,"cloneNode"),b=Rs(f,"remove"),g=Rs(f,"nextSibling"),T=Rs(f,"childNodes"),L=Rs(f,"parentNode"),y=Rs(f,"shadowRoot"),v=Rs(f,"attributes"),x=l&&l.prototype?Rs(l.prototype,"nodeType"):null,w=l&&l.prototype?Rs(l.prototype,"nodeName"):null;if(typeof i=="function"){const ve=s.createElement("template");ve.content&&ve.content.ownerDocument&&(s=ve.content.ownerDocument)}let I,N="",k,C=!1,O=0;const B=function(){if(O>0)throw Nn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},F=function(_){B(),O++;try{return I.createHTML(_)}finally{O--}},S=function(_){B(),O++;try{return I.createScriptURL(_)}finally{O--}},U=function(){return C||(k=fk(d,a),C=!0),k},G=s,W=G.implementation,D=G.createNodeIterator,E=G.createDocumentFragment,P=G.getElementsByTagName,te=n.importNode;let re=Fd();t.isSupported=typeof ng=="function"&&typeof L=="function"&&W&&W.createHTMLDocument!==void 0;const se=sk,fe=nk,Q=ak,de=ik,Ie=lk,j=rk,ue=ok,le=uk;let me=Pd,pe=null;const Le=Oe({},[...Ld,...Vr,...jr,...zr,...Od]);let m=null;const A=Oe({},[...Dd,...qr,...Md,...el]);let M=Object.seal(ua(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Z=null,R=null;const $=Object.seal(ua(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Y=!0,ee=!0,ne=!1,X=!0,be=!1,oe=!0,ge=!1,xe=!1,ke=!1,Ee=!1,H=!1,ce=!1,ye=!0,Me=!1;const Ue="user-content-";let Je=!0,dt=!1,Ye={},Ke=null;const Wt=Oe({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let bs=null;const Ts=Oe({},["audio","video","img","source","image","track"]);let Cn=null;const Qn=Oe({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),cn="http://www.w3.org/1998/Math/MathML",un="http://www.w3.org/2000/svg",z="http://www.w3.org/1999/xhtml";let Se=z,Cs=!1,En=null;const br=Oe({},[cn,un,z],Hr);let $a=Oe({},["mi","mo","mn","ms","mtext"]),Ua=Oe({},["annotation-xml"]);const yr=Oe({},["title","style","font","a","script"]);let ys=null;const Xn=["application/xhtml+xml","text/html"],ea="text/html";let it=null,Fs=null;const V=s.createElement("form"),ae=function(_){return _ instanceof RegExp||_ instanceof Function},Te=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Fs&&Fs===_)return;(!_||typeof _!="object")&&(_={}),_=Mt(_),ys=Xn.indexOf(_.PARSER_MEDIA_TYPE)===-1?ea:_.PARSER_MEDIA_TYPE,it=ys==="application/xhtml+xml"?Hr:ei,pe=ot(_,"ALLOWED_TAGS")&&Vt(_.ALLOWED_TAGS)?Oe({},_.ALLOWED_TAGS,it):Le,m=ot(_,"ALLOWED_ATTR")&&Vt(_.ALLOWED_ATTR)?Oe({},_.ALLOWED_ATTR,it):A,En=ot(_,"ALLOWED_NAMESPACES")&&Vt(_.ALLOWED_NAMESPACES)?Oe({},_.ALLOWED_NAMESPACES,Hr):br,Cn=ot(_,"ADD_URI_SAFE_ATTR")&&Vt(_.ADD_URI_SAFE_ATTR)?Oe(Mt(Qn),_.ADD_URI_SAFE_ATTR,it):Qn,bs=ot(_,"ADD_DATA_URI_TAGS")&&Vt(_.ADD_DATA_URI_TAGS)?Oe(Mt(Ts),_.ADD_DATA_URI_TAGS,it):Ts,Ke=ot(_,"FORBID_CONTENTS")&&Vt(_.FORBID_CONTENTS)?Oe({},_.FORBID_CONTENTS,it):Wt,Z=ot(_,"FORBID_TAGS")&&Vt(_.FORBID_TAGS)?Oe({},_.FORBID_TAGS,it):Mt({}),R=ot(_,"FORBID_ATTR")&&Vt(_.FORBID_ATTR)?Oe({},_.FORBID_ATTR,it):Mt({}),Ye=ot(_,"USE_PROFILES")?_.USE_PROFILES&&typeof _.USE_PROFILES=="object"?Mt(_.USE_PROFILES):_.USE_PROFILES:!1,Y=_.ALLOW_ARIA_ATTR!==!1,ee=_.ALLOW_DATA_ATTR!==!1,ne=_.ALLOW_UNKNOWN_PROTOCOLS||!1,X=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,be=_.SAFE_FOR_TEMPLATES||!1,oe=_.SAFE_FOR_XML!==!1,ge=_.WHOLE_DOCUMENT||!1,Ee=_.RETURN_DOM||!1,H=_.RETURN_DOM_FRAGMENT||!1,ce=_.RETURN_TRUSTED_TYPE||!1,ke=_.FORCE_BODY||!1,ye=_.SANITIZE_DOM!==!1,Me=_.SANITIZE_NAMED_PROPS||!1,Je=_.KEEP_CONTENT!==!1,dt=_.IN_PLACE||!1,me=X_(_.ALLOWED_URI_REGEXP)?_.ALLOWED_URI_REGEXP:Pd,Se=typeof _.NAMESPACE=="string"?_.NAMESPACE:z,$a=ot(_,"MATHML_TEXT_INTEGRATION_POINTS")&&_.MATHML_TEXT_INTEGRATION_POINTS&&typeof _.MATHML_TEXT_INTEGRATION_POINTS=="object"?Mt(_.MATHML_TEXT_INTEGRATION_POINTS):Oe({},["mi","mo","mn","ms","mtext"]),Ua=ot(_,"HTML_INTEGRATION_POINTS")&&_.HTML_INTEGRATION_POINTS&&typeof _.HTML_INTEGRATION_POINTS=="object"?Mt(_.HTML_INTEGRATION_POINTS):Oe({},["annotation-xml"]);const q=ot(_,"CUSTOM_ELEMENT_HANDLING")&&_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING=="object"?Mt(_.CUSTOM_ELEMENT_HANDLING):ua(null);if(M=ua(null),ot(q,"tagNameCheck")&&ae(q.tagNameCheck)&&(M.tagNameCheck=q.tagNameCheck),ot(q,"attributeNameCheck")&&ae(q.attributeNameCheck)&&(M.attributeNameCheck=q.attributeNameCheck),ot(q,"allowCustomizedBuiltInElements")&&typeof q.allowCustomizedBuiltInElements=="boolean"&&(M.allowCustomizedBuiltInElements=q.allowCustomizedBuiltInElements),be&&(ee=!1),H&&(Ee=!0),Ye&&(pe=Oe({},Od),m=ua(null),Ye.html===!0&&(Oe(pe,Ld),Oe(m,Dd)),Ye.svg===!0&&(Oe(pe,Vr),Oe(m,qr),Oe(m,el)),Ye.svgFilters===!0&&(Oe(pe,jr),Oe(m,qr),Oe(m,el)),Ye.mathMl===!0&&(Oe(pe,zr),Oe(m,Md),Oe(m,el))),$.tagCheck=null,$.attributeCheck=null,ot(_,"ADD_TAGS")&&(typeof _.ADD_TAGS=="function"?$.tagCheck=_.ADD_TAGS:Vt(_.ADD_TAGS)&&(pe===Le&&(pe=Mt(pe)),Oe(pe,_.ADD_TAGS,it))),ot(_,"ADD_ATTR")&&(typeof _.ADD_ATTR=="function"?$.attributeCheck=_.ADD_ATTR:Vt(_.ADD_ATTR)&&(m===A&&(m=Mt(m)),Oe(m,_.ADD_ATTR,it))),ot(_,"ADD_URI_SAFE_ATTR")&&Vt(_.ADD_URI_SAFE_ATTR)&&Oe(Cn,_.ADD_URI_SAFE_ATTR,it),ot(_,"FORBID_CONTENTS")&&Vt(_.FORBID_CONTENTS)&&(Ke===Wt&&(Ke=Mt(Ke)),Oe(Ke,_.FORBID_CONTENTS,it)),ot(_,"ADD_FORBID_CONTENTS")&&Vt(_.ADD_FORBID_CONTENTS)&&(Ke===Wt&&(Ke=Mt(Ke)),Oe(Ke,_.ADD_FORBID_CONTENTS,it)),Je&&(pe["#text"]=!0),ge&&Oe(pe,["html","head","body"]),pe.table&&(Oe(pe,["tbody"]),delete Z.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw Nn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Nn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ie=I;I=_.TRUSTED_TYPES_POLICY;try{N=F("")}catch(Ce){throw I=ie,Ce}}else _.TRUSTED_TYPES_POLICY===null?(I=void 0,N=""):(I===void 0&&(I=U()),I&&typeof N=="string"&&(N=F("")));(re.uponSanitizeElement.length>0||re.uponSanitizeAttribute.length>0)&&pe===Le&&(pe=Mt(pe)),re.uponSanitizeAttribute.length>0&&m===A&&(m=Mt(m)),Gt&&Gt(_),Fs=_},Xe=Oe({},[...Vr,...jr,...ek]),rt=Oe({},[...zr,...tk]),Zt=function(_){let q=L(_);(!q||!q.tagName)&&(q={namespaceURI:Se,tagName:"template"});const ie=ei(_.tagName),Ce=ei(q.tagName);return En[_.namespaceURI]?_.namespaceURI===un?q.namespaceURI===z?ie==="svg":q.namespaceURI===cn?ie==="svg"&&(Ce==="annotation-xml"||$a[Ce]):!!Xe[ie]:_.namespaceURI===cn?q.namespaceURI===z?ie==="math":q.namespaceURI===un?ie==="math"&&Ua[Ce]:!!rt[ie]:_.namespaceURI===z?q.namespaceURI===un&&!Ua[Ce]||q.namespaceURI===cn&&!$a[Ce]?!1:!rt[ie]&&(yr[ie]||!Xe[ie]):!!(ys==="application/xhtml+xml"&&En[_.namespaceURI]):!1},ns=function(_){ia(t.removed,{element:_});try{L(_).removeChild(_)}catch{if(b(_),!L(_))throw Nn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Vc=function(_){const q=T?T(_):_.childNodes;if(q){const Ce=[];Vs(q,Re=>{ia(Ce,Re)}),Vs(Ce,Re=>{try{b(Re)}catch{}})}const ie=v?v(_):null;if(ie)for(let Ce=ie.length-1;Ce>=0;--Ce){const Re=ie[Ce],De=Re&&Re.name;if(typeof De=="string")try{_.removeAttribute(De)}catch{}}},An=function(_,q){try{ia(t.removed,{attribute:q.getAttributeNode(_),from:q})}catch{ia(t.removed,{attribute:null,from:q})}if(q.removeAttribute(_),_==="is")if(Ee||H)try{ns(q)}catch{}else try{q.setAttribute(_,"")}catch{}},yg=function(_){const q=v?v(_):_.attributes;if(q)for(let ie=q.length-1;ie>=0;--ie){const Ce=q[ie],Re=Ce&&Ce.name;if(!(typeof Re!="string"||m[it(Re)]))try{_.removeAttribute(Re)}catch{}}},xg=function(_){const q=[_];for(;q.length>0;){const ie=q.pop();(x?x(ie):ie.nodeType)===Es.element&&yg(ie);const Re=T?T(ie):ie.childNodes;if(Re)for(let De=Re.length-1;De>=0;--De)q.push(Re[De])}},jc=function(_){let q=null,ie=null;if(ke)_="<remove></remove>"+_;else{const De=Ad(_,/^[\r\n\t ]+/);ie=De&&De[0]}ys==="application/xhtml+xml"&&Se===z&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const Ce=I?F(_):_;if(Se===z)try{q=new u().parseFromString(Ce,ys)}catch{}if(!q||!q.documentElement){q=W.createDocument(Se,"template",null);try{q.documentElement.innerHTML=Cs?N:Ce}catch{}}const Re=q.body||q.documentElement;return _&&ie&&Re.insertBefore(s.createTextNode(ie),Re.childNodes[0]||null),Se===z?P.call(q,ge?"html":"body")[0]:ge?q.documentElement:Re},zc=function(_){return D.call(_.ownerDocument||_,_,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},xr=function(_){var q,ie;_.normalize();const Ce=D.call(_.ownerDocument||_,_,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Re=Ce.nextNode();for(;Re;){let _t=Re.data;Vs([se,fe,Q],tt=>{_t=la(_t,tt," ")}),Re.data=_t,Re=Ce.nextNode()}const De=(q=(ie=_.querySelectorAll)===null||ie===void 0?void 0:ie.call(_,"template"))!==null&&q!==void 0?q:[];Vs(Array.from(De),_t=>{ta(_t.content)&&xr(_t.content)})},Bi=function(_){const q=w?w(_):null;return typeof q!="string"||it(q)!=="form"?!1:typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||_.attributes!==v(_)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function"||_.nodeType!==x(_)||_.childNodes!==T(_)},ta=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return x(_)===Es.documentFragment}catch{return!1}},Ba=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return typeof x(_)=="number"}catch{return!1}};function $s(ve,_,q){Vs(ve,ie=>{ie.call(t,_,q,Fs)})}const qc=function(_){let q=null;if($s(re.beforeSanitizeElements,_,null),Bi(_))return ns(_),!0;const ie=it(w?w(_):_.nodeName);if($s(re.uponSanitizeElement,_,{tagName:ie,allowedTags:pe}),oe&&_.hasChildNodes()&&!Ba(_.firstElementChild)&&Rt(/<[/\w!]/g,_.innerHTML)&&Rt(/<[/\w!]/g,_.textContent)||oe&&_.namespaceURI===z&&ie==="style"&&Ba(_.firstElementChild)||_.nodeType===Es.progressingInstruction||oe&&_.nodeType===Es.comment&&Rt(/<[/\w]/g,_.data))return ns(_),!0;if(Z[ie]||!($.tagCheck instanceof Function&&$.tagCheck(ie))&&!pe[ie]){if(!Z[ie]&&Gc(ie)&&(M.tagNameCheck instanceof RegExp&&Rt(M.tagNameCheck,ie)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ie)))return!1;if(Je&&!Ke[ie]){const Re=L(_),De=T(_);if(De&&Re){const _t=De.length;for(let tt=_t-1;tt>=0;--tt){const ft=dt?De[tt]:p(De[tt],!0);Re.insertBefore(ft,g(_))}}}return ns(_),!0}return(x?x(_):_.nodeType)===Es.element&&!Zt(_)||(ie==="noscript"||ie==="noembed"||ie==="noframes")&&Rt(/<\/no(script|embed|frames)/i,_.innerHTML)?(ns(_),!0):(be&&_.nodeType===Es.text&&(q=_.textContent,Vs([se,fe,Q],Re=>{q=la(q,Re," ")}),_.textContent!==q&&(ia(t.removed,{element:_.cloneNode()}),_.textContent=q)),$s(re.afterSanitizeElements,_,null),!1)},Kc=function(_,q,ie){if(R[q]||ye&&(q==="id"||q==="name")&&(ie in s||ie in V))return!1;const Ce=m[q]||$.attributeCheck instanceof Function&&$.attributeCheck(q,_);if(!(ee&&!R[q]&&Rt(de,q))){if(!(Y&&Rt(Ie,q))){if(!Ce||R[q]){if(!(Gc(_)&&(M.tagNameCheck instanceof RegExp&&Rt(M.tagNameCheck,_)||M.tagNameCheck instanceof Function&&M.tagNameCheck(_))&&(M.attributeNameCheck instanceof RegExp&&Rt(M.attributeNameCheck,q)||M.attributeNameCheck instanceof Function&&M.attributeNameCheck(q,_))||q==="is"&&M.allowCustomizedBuiltInElements&&(M.tagNameCheck instanceof RegExp&&Rt(M.tagNameCheck,ie)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ie))))return!1}else if(!Cn[q]){if(!Rt(me,la(ie,ue,""))){if(!((q==="src"||q==="xlink:href"||q==="href")&&_!=="script"&&Rd(ie,"data:")===0&&bs[_])){if(!(ne&&!Rt(j,la(ie,ue,"")))){if(ie)return!1}}}}}}return!0},_g=Oe({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Gc=function(_){return!_g[ei(_)]&&Rt(le,_)},Wc=function(_){$s(re.beforeSanitizeAttributes,_,null);const q=_.attributes;if(!q||Bi(_))return;const ie={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:m,forceKeepAttr:void 0};let Ce=q.length;for(;Ce--;){const Re=q[Ce],De=Re.name,_t=Re.namespaceURI,tt=Re.value,ft=it(De),dn=tt;let Ct=De==="value"?dn:G_(dn);if(ie.attrName=ft,ie.attrValue=Ct,ie.keepAttr=!0,ie.forceKeepAttr=void 0,$s(re.uponSanitizeAttribute,_,ie),Ct=ie.attrValue,Me&&(ft==="id"||ft==="name")&&Rd(Ct,Ue)!==0&&(An(De,_),Ct=Ue+Ct),oe&&Rt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Ct)){An(De,_);continue}if(ft==="attributename"&&Ad(Ct,"href")){An(De,_);continue}if(ie.forceKeepAttr)continue;if(!ie.keepAttr){An(De,_);continue}if(!X&&Rt(/\/>/i,Ct)){An(De,_);continue}be&&Vs([se,fe,Q],Jc=>{Ct=la(Ct,Jc," ")});const Zc=it(_.nodeName);if(!Kc(Zc,ft,Ct)){An(De,_);continue}if(I&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!_t)switch(d.getAttributeType(Zc,ft)){case"TrustedHTML":{Ct=F(Ct);break}case"TrustedScriptURL":{Ct=S(Ct);break}}if(Ct!==dn)try{_t?_.setAttributeNS(_t,De,Ct):_.setAttribute(De,Ct),Bi(_)?ns(_):Ed(t.removed)}catch{An(De,_)}}$s(re.afterSanitizeAttributes,_,null)},Hi=function(_){let q=null;const ie=zc(_);for($s(re.beforeSanitizeShadowDOM,_,null);q=ie.nextNode();)if($s(re.uponSanitizeShadowNode,q,null),qc(q),Wc(q),ta(q.content)&&Hi(q.content),(x?x(q):q.nodeType)===Es.element){const Re=y?y(q):q.shadowRoot;ta(Re)&&(_r(Re),Hi(Re))}$s(re.afterSanitizeShadowDOM,_,null)},_r=function(_){const q=[{node:_,shadow:null}];for(;q.length>0;){const ie=q.pop();if(ie.shadow){Hi(ie.shadow);continue}const Ce=ie.node,De=(x?x(Ce):Ce.nodeType)===Es.element,_t=T?T(Ce):Ce.childNodes;if(_t)for(let tt=_t.length-1;tt>=0;--tt)q.push({node:_t[tt],shadow:null});if(De){const tt=w?w(Ce):null;if(typeof tt=="string"&&it(tt)==="template"){const ft=Ce.content;ta(ft)&&q.push({node:ft,shadow:null})}}if(De){const tt=y?y(Ce):Ce.shadowRoot;ta(tt)&&q.push({node:null,shadow:tt},{node:tt,shadow:null})}}};return t.sanitize=function(ve){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},q=null,ie=null,Ce=null,Re=null;if(Cs=!ve,Cs&&(ve="<!-->"),typeof ve!="string"&&!Ba(ve)&&(ve=Q_(ve),typeof ve!="string"))throw Nn("dirty is not a string, aborting");if(!t.isSupported)return ve;xe||Te(_),t.removed=[];const De=dt&&typeof ve!="string"&&Ba(ve);if(De){const ft=w?w(ve):ve.nodeName;if(typeof ft=="string"){const dn=it(ft);if(!pe[dn]||Z[dn])throw Nn("root node is forbidden and cannot be sanitized in-place")}if(Bi(ve))throw Nn("root node is clobbered and cannot be sanitized in-place");try{_r(ve)}catch(dn){throw Vc(ve),dn}}else if(Ba(ve))q=jc("<!---->"),ie=q.ownerDocument.importNode(ve,!0),ie.nodeType===Es.element&&ie.nodeName==="BODY"||ie.nodeName==="HTML"?q=ie:q.appendChild(ie),_r(ie);else{if(!Ee&&!be&&!ge&&ve.indexOf("<")===-1)return I&&ce?F(ve):ve;if(q=jc(ve),!q)return Ee?null:ce?N:""}q&&ke&&ns(q.firstChild);const _t=zc(De?ve:q);try{for(;Ce=_t.nextNode();)qc(Ce),Wc(Ce),ta(Ce.content)&&Hi(Ce.content)}catch(ft){throw De&&Vc(ve),ft}if(De)return Vs(t.removed,ft=>{ft.element&&xg(ft.element)}),be&&xr(ve),ve;if(Ee){if(be&&xr(q),H)for(Re=E.call(q.ownerDocument);q.firstChild;)Re.appendChild(q.firstChild);else Re=q;return(m.shadowroot||m.shadowrootmode)&&(Re=te.call(n,Re,!0)),Re}let tt=ge?q.outerHTML:q.innerHTML;return ge&&pe["!doctype"]&&q.ownerDocument&&q.ownerDocument.doctype&&q.ownerDocument.doctype.name&&Rt(ck,q.ownerDocument.doctype.name)&&(tt="<!DOCTYPE "+q.ownerDocument.doctype.name+`>
`+tt),be&&Vs([se,fe,Q],ft=>{tt=la(tt,ft," ")}),I&&ce?F(tt):tt},t.setConfig=function(){let ve=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Te(ve),xe=!0},t.clearConfig=function(){Fs=null,xe=!1,I=k,N=""},t.isValidAttribute=function(ve,_,q){Fs||Te({});const ie=it(ve),Ce=it(_);return Kc(ie,Ce,q)},t.addHook=function(ve,_){typeof _=="function"&&ia(re[ve],_)},t.removeHook=function(ve,_){if(_!==void 0){const q=q_(re[ve],_);return q===-1?void 0:K_(re[ve],q,1)[0]}return Ed(re[ve])},t.removeHooks=function(ve){re[ve]=[]},t.removeAllHooks=function(){re=Fd()},t}var $d=ig();function Oc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Yn=Oc();function lg(e){Yn=e}var ci={exec:()=>null};function Ze(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(qt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var qt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},pk=/^(?:[ \t]*(?:\n|$))+/,hk=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,gk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ui=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,mk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Dc=/(?:[*+-]|\d{1,9}[.)])/,rg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,og=Ze(rg).replace(/bull/g,Dc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),vk=Ze(rg).replace(/bull/g,Dc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Mc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,bk=/^[^\n]+/,Pc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,yk=Ze(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Pc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),xk=Ze(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Dc).getRegex(),gr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Fc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_k=Ze("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Fc).replace("tag",gr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),cg=Ze(Mc).replace("hr",Ui).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gr).getRegex(),kk=Ze(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",cg).getRegex(),$c={blockquote:kk,code:hk,def:yk,fences:gk,heading:mk,hr:Ui,html:_k,lheading:og,list:xk,newline:pk,paragraph:cg,table:ci,text:bk},Ud=Ze("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ui).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gr).getRegex(),wk={...$c,lheading:vk,table:Ud,paragraph:Ze(Mc).replace("hr",Ui).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ud).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gr).getRegex()},Sk={...$c,html:Ze(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Fc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ci,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Ze(Mc).replace("hr",Ui).replace("heading",` *#{1,6} *[^
]`).replace("lheading",og).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Tk=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ck=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ug=/^( {2,}|\\)\n(?!\s*$)/,Ek=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,mr=/[\p{P}\p{S}]/u,Uc=/[\s\p{P}\p{S}]/u,dg=/[^\s\p{P}\p{S}]/u,Ak=Ze(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Uc).getRegex(),fg=/(?!~)[\p{P}\p{S}]/u,Rk=/(?!~)[\s\p{P}\p{S}]/u,Ik=/(?:[^\s\p{P}\p{S}]|~)/u,Nk=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,pg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Lk=Ze(pg,"u").replace(/punct/g,mr).getRegex(),Ok=Ze(pg,"u").replace(/punct/g,fg).getRegex(),hg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Dk=Ze(hg,"gu").replace(/notPunctSpace/g,dg).replace(/punctSpace/g,Uc).replace(/punct/g,mr).getRegex(),Mk=Ze(hg,"gu").replace(/notPunctSpace/g,Ik).replace(/punctSpace/g,Rk).replace(/punct/g,fg).getRegex(),Pk=Ze("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,dg).replace(/punctSpace/g,Uc).replace(/punct/g,mr).getRegex(),Fk=Ze(/\\(punct)/,"gu").replace(/punct/g,mr).getRegex(),$k=Ze(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Uk=Ze(Fc).replace("(?:-->|$)","-->").getRegex(),Bk=Ze("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Uk).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),$l=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Hk=Ze(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",$l).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),gg=Ze(/^!?\[(label)\]\[(ref)\]/).replace("label",$l).replace("ref",Pc).getRegex(),mg=Ze(/^!?\[(ref)\](?:\[\])?/).replace("ref",Pc).getRegex(),Vk=Ze("reflink|nolink(?!\\()","g").replace("reflink",gg).replace("nolink",mg).getRegex(),Bc={_backpedal:ci,anyPunctuation:Fk,autolink:$k,blockSkip:Nk,br:ug,code:Ck,del:ci,emStrongLDelim:Lk,emStrongRDelimAst:Dk,emStrongRDelimUnd:Pk,escape:Tk,link:Hk,nolink:mg,punctuation:Ak,reflink:gg,reflinkSearch:Vk,tag:Bk,text:Ek,url:ci},jk={...Bc,link:Ze(/^!?\[(label)\]\((.*?)\)/).replace("label",$l).getRegex(),reflink:Ze(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",$l).getRegex()},Ro={...Bc,emStrongRDelimAst:Mk,emStrongLDelim:Ok,url:Ze(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},zk={...Ro,br:Ze(ug).replace("{2,}","*").getRegex(),text:Ze(Ro.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},tl={normal:$c,gfm:wk,pedantic:Sk},Wa={normal:Bc,gfm:Ro,breaks:zk,pedantic:jk},qk={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Bd=e=>qk[e];function Is(e,t){if(t){if(qt.escapeTest.test(e))return e.replace(qt.escapeReplace,Bd)}else if(qt.escapeTestNoEncode.test(e))return e.replace(qt.escapeReplaceNoEncode,Bd);return e}function Hd(e){try{e=encodeURI(e).replace(qt.percentDecode,"%")}catch{return null}return e}function Vd(e,t){var i;const s=e.replace(qt.findPipe,(l,r,o)=>{let c=!1,u=r;for(;--u>=0&&o[u]==="\\";)c=!c;return c?"|":" |"}),n=s.split(qt.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(qt.slashPipe,"|");return n}function Za(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function Kk(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function jd(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function Gk(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Is(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Kn=new Wk;function qe(e,t){return Kn.parse(e,t)}qe.options=qe.setOptions=function(e){return Kn.setOptions(e),qe.defaults=Kn.defaults,lg(qe.defaults),qe};qe.getDefaults=Oc;qe.defaults=Yn;qe.use=function(...e){return Kn.use(...e),qe.defaults=Kn.defaults,lg(qe.defaults),qe};qe.walkTokens=function(e,t){return Kn.walkTokens(e,t)};qe.parseInline=Kn.parseInline;qe.Parser=Ys;qe.parser=Ys.parse;qe.Renderer=Bl;qe.TextRenderer=Hc;qe.Lexer=Js;qe.lexer=Js.lex;qe.Tokenizer=Ul;qe.Hooks=ul;qe.parse=qe;qe.options;qe.setOptions;qe.use;qe.walkTokens;qe.parseInline;Ys.parse;Js.lex;const Zk={breaks:!0,gfm:!0};function zd(e){if(!e)return"";try{if(typeof qe<"u"&&qe.parse){const t=qe.parse(e,Zk);return typeof $d<"u"?$d.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Jk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Yk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Qk(e){return Yk[e]||"wrench"}const Xk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function qd(e){if(!e)return[];const t=e.match(Xk);return t?[...new Set(t)]:[]}const ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=J(()=>t.value.trim().length>0&&!s.value),d=J(()=>{const S=We.state;return S==="connected"?"Connected":S==="reconnecting"?"Reconnecting…":S==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=J(()=>{const S=Math.floor(i.value/4)%f.length,U=i.value;return U>3?`${f[S]} (${U}s)`:f[0]});function b(){St(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const S=a.value;S.style.height="auto",S.style.height=Math.min(S.scrollHeight,120)+"px"}function T(S,U,G={}){const W={id:++o,role:S,content:U,timestamp:Date.now(),html:S==="bot"?zd(U):"",tools_used:G.tools_used||[],is_error:G.is_error||!1,images:S==="bot"?qd(U):[],files:G.files||[],_showTools:!1};return e.value.push(W),b(),S==="bot"&&St(()=>L()),W}function L(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(U=>{U.setAttribute("data-copy","true"),U.style.position="relative";const G=document.createElement("button");G.className="chat-code-copy",G.textContent="Copy",G.addEventListener("click",()=>{const W=U.querySelector("code"),D=W?W.textContent:U.textContent;navigator.clipboard.writeText(D).then(()=>{G.textContent="Copied!",setTimeout(()=>{G.textContent="Copy"},1500)}).catch(()=>{})}),U.appendChild(G)})}function y(S){if(S===0)return!0;const U=e.value[S-1],G=e.value[S],W=new Date(U.timestamp).toDateString(),D=new Date(G.timestamp).toDateString();return W!==D}function v(S){const U=new Date(S),G=new Date;if(U.toDateString()===G.toDateString())return"Today";const W=new Date(G);return W.setDate(W.getDate()-1),U.toDateString()===W.toDateString()?"Yesterday":U.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(S){t.value=S,St(()=>B())}function w(S){window.open(S,"_blank","noopener")}function I(S){S.target.style.display="none"}function N(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function k(){r&&(clearInterval(r),r=null),i.value=0}function C(S){s.value&&(s.value=!1,k(),S.type==="chat_response"?T("bot",S.content,{tools_used:S.tools_used||[],is_error:S.is_error||!1,files:S.files||[]}):S.type==="chat_error"&&T("bot",S.error||"Unknown error",{is_error:!0}),St(()=>{var U;return(U=a.value)==null?void 0:U.focus()}))}async function O(S){try{const U=await K.post("/api/chat",{content:S,channel_id:l.value});T("bot",U.response,{tools_used:U.tools_used||[],is_error:U.is_error||!1,files:U.files||[]})}catch(U){T("bot",U.message||"Failed to send message",{is_error:!0})}}async function B(){const S=t.value.trim();if(!S||s.value)return;T("user",S),t.value="",s.value=!0,N(),a.value&&(a.value.style.height="auto"),We.connected&&We.sendChat(S,{channelId:l.value})||(await O(S),s.value=!1,k()),St(()=>{var G;return(G=a.value)==null?void 0:G.focus()})}async function F(){try{if(!l.value){const U=await K.get("/api/auth/session");l.value=U.channel_id||U.user_id||"web-user"}const S=await K.get("/api/sessions/"+encodeURIComponent(l.value));if(S&&S.messages&&S.messages.length>0){for(const U of S.messages){const G=U.role==="user"?"user":"bot";let W=U.content||"";if(G==="user"){const E=W.match(/^\[.*?\]:\s*/);E&&(W=W.slice(E[0].length))}if(!W.trim())continue;const D={id:++o,role:G,content:W,timestamp:U.timestamp?U.timestamp*1e3:Date.now(),html:G==="bot"?zd(W):"",tools_used:[],is_error:!1,images:G==="bot"?qd(W):[],files:[],_showTools:!1};e.value.push(D)}St(()=>{b(),L()})}}catch{}}return He(()=>{We.subscribe("chat",C),F(),St(()=>{var S;return(S=a.value)==null?void 0:S.focus()})}),gt(()=>{We.unsubscribe("chat",C),k()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:B,autoResize:g,formatTime:Jk,formatDate:v,showDateSeparator:y,useSuggestion:x,openImage:w,onImageError:I,getToolIcon:Qk}}},vr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=A_(),s=Xh(),n=J({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=J(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=J(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});gs(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var u;return(u=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:u.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}He(()=>{We.on("events",a),i=setInterval(l,500)}),gt(()=>{We.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=null;const r=J(()=>e.value.filter(P=>P.status==="running").length),o=J(()=>e.value.filter(P=>P.status==="completed").length),c=J(()=>e.value.filter(P=>["failed","timeout","killed"].includes(P.status)).length),u=J(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),d=J(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(P=>["failed","timeout","killed"].includes(P.status)):e.value.filter(P=>P.status===i.value));function f(P){const te=Number(P.max_iterations)||0;return te<=0?0:Math.min(100,Math.round(P.iteration_count/te*100))}function p(P){return(Number(P.max_iterations)||0)>0}function b(P,te){return P?P==="N/A"?"N/A":te==="current_inheritance"?`inherit (currently ${P})`:P:"unknown"}function g(P){return b(P.display_model,P.display_model_source||P.display_source)}function T(P){return b(P.display_reasoning_effort,P.display_reasoning_effort_source||P.display_source)}function L(P){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[P]||""}const y=h(null),v=h(null),x=h(!1),w=h(null),I=h("");let N=0,k=0,C=0;function O(P,te){return P===N&&te>C}async function B(P){const te=++N,re=++k;C=0,v.value=P.id,y.value=null,w.value=null,x.value=!0;try{const se=await K.get(`/api/agents/${encodeURIComponent(P.id)}`);if(!O(te,re))return;C=re,y.value=se}catch(se){if(!O(te,re))return;C=re,w.value=se.message||"Failed to load agent detail"}te===N&&(x.value=!1)}function F(){N++,v.value=null,y.value=null,w.value=null,x.value=!1,I.value=""}async function S(){if(!v.value)return;const P=N,te=++k;try{const re=await K.get(`/api/agents/${encodeURIComponent(v.value)}`);if(!O(P,te))return;C=te,y.value=re}catch{}}async function U(P,te){try{await navigator.clipboard.writeText(te||""),I.value=P,setTimeout(()=>{I.value===P&&(I.value="")},1500)}catch{_e.error("Copy failed")}}async function G(P=!1){P=P===!0,P||(t.value=!0);try{const te=await K.get("/api/agents");e.value=Array.isArray(te)?te:[],s.value=null}catch(te){P||(s.value=te.message)}P||(t.value=!1)}async function W(P){const te=e.value.find(se=>se.id===P);if(await rs({title:"Kill agent",message:`Kill agent "${(te==null?void 0:te.label)||P}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=P;try{await K.del(`/api/agents/${encodeURIComponent(P)}`),_e.success("Agent killed"),await G()}catch(se){_e.error(se.message||"Failed to kill agent")}n.value=null}}function D(){E(),a.value&&(l=setInterval(()=>{a.value&&(G(!0),v.value&&S())},5e3))}function E(){l&&(clearInterval(l),l=null)}return He(()=>{G(),D()}),er(()=>{G(!0),D()}),tr(E),gt(E),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:u,filteredAgents:d,formatTs:Fa,formatDuration:Oa,progressPercent:f,hasProgress:p,displayModelText:g,displayEffortText:T,displaySourceLabel:L,detail:y,detailId:v,detailLoading:x,detailError:w,copied:I,openDetail:B,closeDetail:F,copyText:U,fetchAgents:G,killAgent:W,startAutoRefresh:D,stopAutoRefresh:E}}},nw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=J(()=>e.value.reduce((I,N)=>I+(N.iteration_count||0),0)),d=J(()=>e.value.filter(I=>I.status==="running").length);function f(I){return I==="running"?"loop-status-running":I==="error"?"loop-status-error":"loop-status-stopped"}function p(I){return I==="running"?"badge-success":I==="error"?"badge-danger":I==="completed"?"badge-info":"badge-warning"}function b(I){return I==="act"?"badge-warning":I==="silent"?"badge-info":"badge-success"}function g(I){c.value={...c.value,[I]:!c.value[I]}}async function T(I=!1){I=I===!0,I||(t.value=!0);try{e.value=await K.get("/api/loops"),s.value=null}catch(N){I||(s.value=N.message)}I||(t.value=!1)}async function L(){l.value=null;const I=a.value;if(!I.goal.trim()){l.value="Goal is required";return}if(!I.channel_id.trim()){l.value="Channel ID is required";return}const N={goal:I.goal.trim(),channel_id:I.channel_id.trim(),interval_seconds:I.interval_seconds||60,mode:I.mode,max_iterations:I.max_iterations||50};I.stop_condition.trim()&&(N.stop_condition=I.stop_condition.trim()),i.value=!0;try{const k=await K.post("/api/loops",N);_e.success(`Loop started: ${k.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await T()}catch(k){l.value=k.message}i.value=!1}async function y(I){if(await rs({title:"Stop loop",message:`Stop loop ${I}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=I;try{await K.del(`/api/loops/${encodeURIComponent(I)}`),_e.success("Loop stopped"),await T()}catch(k){_e.error(k.message||"Failed to stop loop")}r.value=null}}async function v(I){o.value=I;try{await K.post(`/api/loops/${encodeURIComponent(I)}/restart`),_e.success("Loop restarted"),await T()}catch(N){_e.error(N.message||"Failed to restart loop")}o.value=null}function x(I){I.payload&&(I.payload.loop_id||I.payload.type==="loop")&&T(!0)}let w=null;return He(()=>{T(),We.subscribe("events",x),w=setInterval(()=>{T(!0)},5e3)}),gt(()=>{We.unsubscribe("events",x),w&&clearInterval(w)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:b,formatDuration:Oa,formatAge:eg,toggleHistory:g,fetchLoops:T,doCreate:L,doStop:y,doRestart:v}}},aw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=J(()=>e.value.filter(g=>g.status==="running").length),r=J(()=>e.value.filter(g=>g.status!=="running").length);function o(g){return g==="running"?"loop-status-running":g==="failed"||g==="error"?"loop-status-error":"loop-status-stopped"}function c(g){return g==="running"?"badge-success":g==="completed"||g==="exited"?"badge-info":g==="killed"||g==="error"||g==="failed"?"badge-danger":"badge-warning"}async function u(g=!1){g=g===!0,g||(t.value=!0);try{e.value=await K.get("/api/processes"),s.value=null}catch(T){g||(s.value=T.message)}g||(t.value=!1)}function d(){f(),n.value&&(a=setInterval(()=>{t.value||u(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}gs(n,g=>{g?d():f()});async function p(g){if(await rs({title:"Kill process",message:`Kill process ${g}?`,confirmLabel:"Kill",danger:!0})){i.value=g;try{await K.del(`/api/processes/${g}`),_e.success(`Process ${g} killed`),await u()}catch(L){_e.error(L.message||"Failed to kill process")}i.value=null}}function b(g){g.payload&&(g.payload.pid||g.payload.type==="process")&&u(!0)}return He(()=>{u(),We.subscribe("events",b),d()}),gt(()=>{We.unsubscribe("events",b),f()}),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:Oa,fetchProcesses:u,doKill:p}}},iw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),b=h(null),g=h([]),T=h(!1),L=J(()=>e.value.filter(D=>D.cron&&!D.one_time).length),y=J(()=>e.value.filter(D=>D.one_time).length),v=J(()=>e.value.filter(D=>D.trigger).length),x=J(()=>e.value.filter(D=>D.paused).length),w=J(()=>e.value.filter(D=>D.consecutive_failures>0).length);function I(D){if(!D)return"-";const E=Date.now(),te=(new Date(D).getTime()-E)/1e3;if(te<0)return"overdue";if(te<60)return"in < 1 min";if(te<3600)return`in ${Math.floor(te/60)} min`;if(te<86400){const se=Math.floor(te/3600),fe=Math.floor(te%3600/60);return fe>0?`in ${se}h ${fe}m`:`in ${se}h`}const re=Math.floor(te/86400);return`in ${re} day${re!==1?"s":""}`}function N(D){return D==null?"-":D<1e3?`${D}ms`:D<6e4?`${(D/1e3).toFixed(1)}s`:Oa(D/1e3)}function k(){r.value=null}async function C(){const D=a.value.cron.trim();if(D){o.value=!0;try{r.value=await K.post("/api/schedules/validate-cron",{expression:D})}catch(E){r.value={valid:!1,error:E.message}}o.value=!1}}async function O(){t.value=!0,s.value=null;try{e.value=await K.get("/api/schedules")}catch(D){s.value=D.message}t.value=!1}async function B(D){if(b.value===D){b.value=null,g.value=[];return}b.value=D,T.value=!0,g.value=[];try{g.value=await K.get(`/api/schedules/${encodeURIComponent(D)}/history?limit=10`)}catch{g.value=[]}T.value=!1}async function F(){l.value=null;const D=a.value;if(!D.description.trim()){l.value="Description is required";return}if(!D.channel_id.trim()){l.value="Channel ID is required";return}if(!D.cron.trim()&&!D.run_at.trim()){l.value="Cron expression or run_at time is required";return}const E={description:D.description.trim(),action:D.action,channel_id:D.channel_id.trim()};if(D.cron.trim()&&(E.cron=D.cron.trim()),D.run_at.trim()&&(E.run_at=D.run_at.trim()),D.action==="reminder"&&D.message.trim()&&(E.message=D.message.trim()),D.action==="check"&&(D.tool_name.trim()&&(E.tool_name=D.tool_name.trim()),D.tool_input_str.trim()))try{E.tool_input=JSON.parse(D.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await K.post("/api/schedules",E),_e.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await O()}catch(P){l.value=P.message}i.value=!1}async function S(D){u.value=D;try{const E=await K.post(`/api/schedules/${encodeURIComponent(D)}/run`);if(E.status==="failure")_e.error(`Execution failed: ${E.error||"unknown error"}`);else{const P=E.warning?`Executed (${E.warning})`:"Executed successfully";_e.success(P)}await O()}catch(E){_e.error(E.message||"Failed to trigger")}u.value=null}async function U(D){f.value=D.id;const E=!D.paused;try{await K.put(`/api/schedules/${encodeURIComponent(D.id)}`,{paused:E}),_e.success(E?"Schedule paused":"Schedule resumed"),await O()}catch(P){_e.error(P.message||"Failed to update schedule")}f.value=null}async function G(D){p.value=D;try{await K.post(`/api/schedules/${encodeURIComponent(D)}/reset-failures`),_e.success("Failure counters reset"),await O()}catch(E){_e.error(E.message||"Failed to reset")}p.value=null}async function W(D){const E=e.value.find(te=>te.id===D);if(await rs({title:"Delete schedule",message:`Delete "${(E==null?void 0:E.description)||D}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=D;try{await K.del(`/api/schedules/${encodeURIComponent(D)}`),_e.success("Schedule deleted"),await O()}catch(te){_e.error(te.message||"Failed to delete schedule")}d.value=null}}return He(()=>{O()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:b,history:g,historyLoading:T,cronCount:L,oneTimeCount:y,webhookCount:v,pausedCount:x,failingCount:w,formatTs:Fa,formatAge:eg,formatFuture:I,formatMs:N,formatDuration:Oa,onCronInput:k,validateCron:C,toggleExpand:B,fetchSchedules:O,doCreate:F,doRunNow:S,doTogglePause:U,doResetFailures:G,doDelete:W}}},lw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),b=Kd,g=ow,T=h([]),L=h(!1),y=h(""),v=h("flat"),x=h(new Set),w=h(""),I=h(""),N=h(""),k=h(null),C=h(!1);function O(){try{const H=localStorage.getItem("odin-session-presets");H&&(T.value=JSON.parse(H))}catch{}}function B(){try{localStorage.setItem("odin-session-presets",JSON.stringify(T.value))}catch{}}const F=J(()=>d.value.trim()!==""||u.value!=="all"),S=J(()=>{let H=[...e.value];const ce=Kd.find(Je=>Je.id===u.value),ye=ce?ce.filters:{};if(ye.source&&(H=H.filter(Je=>Je.source===ye.source)),ye.minMessages&&(H=H.filter(Je=>Je.message_count>=ye.minMessages)),ye.hasCompaction&&(H=H.filter(Je=>Je.has_summary)),ye.maxAge!=null){const Je=Date.now()/1e3;H=H.filter(dt=>dt.last_active&&Je-dt.last_active<=ye.maxAge)}if(d.value.trim()){const Je=d.value.toLowerCase().trim();H=H.filter(dt=>(dt.channel_id||"").toLowerCase().includes(Je)||(dt.last_user_id||"").toLowerCase().includes(Je)||(dt.source||"").toLowerCase().includes(Je))}const Me=f.value,Ue=p.value?1:-1;return H.sort((Je,dt)=>{const Ye=Je[Me]||0,Ke=dt[Me]||0;return(Ye-Ke)*Ue}),H}),U=J(()=>{if(!a.value||!a.value.messages)return[];const H=a.value.messages;if(H.length===0)return[];const ce=[];let ye=[];for(const Me of H)Me.role==="user"&&ye.length>0&&(ce.push(ye),ye=[]),ye.push(Me);return ye.length>0&&ce.push(ye),ce}),G=J(()=>S.value.length>0&&o.value.size===S.value.length);function W(H){const ce=H.find(ye=>ye.role==="user");if(ce&&ce.content){const ye=ce.content.slice(0,120);return ye.length<ce.content.length?ye+"...":ye}return"(no user message)"}function D(H){const ce=new Set(x.value);ce.has(H)?ce.delete(H):ce.add(H),x.value=ce}function E(H){u.value=H}function P(H){u.value=H.id,H.filters.searchQuery!=null&&(d.value=H.filters.searchQuery),H.filters.sortBy&&(f.value=H.filters.sortBy)}function te(){if(!y.value.trim())return;const H={id:"custom-"+Date.now(),name:y.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};T.value=[...T.value,H],B(),L.value=!1,y.value=""}function re(H){T.value=T.value.filter(ce=>ce.id!==H),B(),u.value===H&&(u.value="all")}function se(){u.value="all",d.value="",f.value="last_active",p.value=!1}function fe(H){if(!H)return"—";const ce=Date.now()/1e3-H;if(ce<60)return"just now";if(ce<3600){const Me=Math.floor(ce/60);return`${Me} minute${Me!==1?"s":""} ago`}if(ce<86400){const Me=Math.floor(ce/3600);return`${Me} hour${Me!==1?"s":""} ago`}const ye=Math.floor(ce/86400);return`${ye} day${ye!==1?"s":""} ago`}function Q(H){if(!H)return"";try{return new Date(H*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function de(H){if(!H)return"";try{return new Date(H*1e3).toLocaleString()}catch{return""}}function Ie(H){return H==="user"?"bg-gray-900/50 border border-gray-800":H==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function j(H){return H==="user"?"sess-msg-user":H==="assistant"?"sess-msg-assistant":"sess-msg-system"}function ue(H){return H==="user"?"badge-info":H==="assistant"?"badge-success":"badge-warning"}function le(H){return H==="user"?"sess-dot-user":H==="assistant"?"sess-dot-assistant":"sess-dot-system"}function me(H){return H==="user"?"text-cyan-400":H==="assistant"?"text-indigo-400":"text-gray-500"}function pe(H){return H?H.length>2e3?H.slice(0,2e3)+`
... (truncated)`:H:""}async function Le(){const H=w.value.trim();if(H){C.value=!0;try{let ce=`/api/sessions/search?q=${encodeURIComponent(H)}&limit=50`;I.value.trim()&&(ce+=`&channel_id=${encodeURIComponent(I.value.trim())}`),N.value.trim()&&(ce+=`&user_id=${encodeURIComponent(N.value.trim())}`);const ye=await K.get(ce);k.value=ye.results||[]}catch{k.value=[]}C.value=!1}}function m(){w.value="",I.value="",N.value="",k.value=null}function A(H){return H?H.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(H){return H==="user"?"fts-result-user":H==="assistant"?"fts-result-assistant":H==="summary"?"fts-result-summary":H==="fts"?"fts-result-fts":H==="channel"?"fts-result-channel":"fts-result-default"}function Z(H){return H==="user"?"badge-info":H==="assistant"?"badge-success":H==="summary"?"badge-warning":H==="fts"?"badge-success":"badge-info"}async function R(){t.value=!0,s.value=null;try{e.value=await K.get("/api/sessions")}catch(H){s.value=H.message}t.value=!1}function $(){s.value=null,R()}async function Y(H){if(n.value===H){n.value=null,a.value=null,x.value=new Set;return}n.value=H,a.value=null,i.value=!0,x.value=new Set;try{a.value=await K.get(`/api/sessions/${encodeURIComponent(H)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function ee(H){const ce=new Set(o.value);ce.has(H)?ce.delete(H):ce.add(H),o.value=ce}function ne(){G.value?o.value=new Set:o.value=new Set(S.value.map(H=>H.channel_id))}function X(H){l.value=H}async function be(){if(l.value){r.value=!0;try{await K.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await R()}catch(H){s.value=H.message||"Failed to clear session"}r.value=!1,l.value=null}}function oe(){c.value=!0}async function ge(){if(o.value.size!==0){r.value=!0;try{await K.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await R()}catch(H){s.value=H.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function xe(H,ce){const ye=K._token;let Me=`/api/sessions/${encodeURIComponent(H)}/export?format=${ce}`;ye&&(Me+=`&token=${encodeURIComponent(ye)}`);const Ue=document.createElement("a");Ue.href=Me,Ue.download=`session-${H}.${ce==="text"?"txt":"json"}`,document.body.appendChild(Ue),Ue.click(),document.body.removeChild(Ue)}let ke=null;function Ee(H){H.payload&&H.payload.channel_id&&(clearTimeout(ke),ke=setTimeout(()=>{R(),n.value&&H.payload.channel_id===n.value&&K.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(ce=>{a.value=ce}).catch(()=>{})},2e3))}return He(()=>{O(),R(),We.subscribe("events",Ee)}),gt(()=>{We.unsubscribe("events",Ee),clearTimeout(ke)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:G,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:b,sortOptions:g,filteredSessions:S,hasActiveFilters:F,customPresets:T,showSavePreset:L,newPresetName:y,threadView:v,threads:U,collapsedThreads:x,ftsQuery:w,ftsChannelId:I,ftsUserId:N,ftsResults:k,ftsSearching:C,formatAge:fe,formatTimestamp:Q,formatFullTimestamp:de,messageClass:Ie,threadMsgClass:j,roleBadge:ue,roleDotClass:le,roleLabelClass:me,truncateContent:pe,threadSummary:W,fetchSessions:R,retry:$,toggleSession:Y,toggleSelect:ee,toggleSelectAll:ne,confirmClear:X,clearSession:be,confirmBulkClear:oe,doBulkClear:ge,exportSession:xe,applyPreset:E,applyCustomPreset:P,saveCustomPreset:te,removeCustomPreset:re,resetFilters:se,toggleThread:D,runFtsSearch:Le,clearFtsSearch:m,highlightSnippet:A,ftsResultClass:M,ftsTypeBadge:Z}}},uw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:M_}}},dw={components:{ContextAssemblyPanel:uw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(N){if(!N)return"—";try{const k=new Date(N);return isNaN(k.getTime())?N:k.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return N}}function f(N){return!N&&N!==0?"—":N<1e3?N+"ms":(N/1e3).toFixed(1)+"s"}function p(N){return!N&&N!==0?"—":N>=1e3?(N/1e3).toFixed(1)+"k":String(N)}function b(N){if(!N)return"";if(typeof N=="string")return N;try{return JSON.stringify(N,null,2)}catch{return String(N)}}function g(N){a.value===N?a.value=null:(a.value=N,c.value={})}function T(N,k){const C=N+"-"+k;c.value={...c.value,[C]:!c.value[C]}}function L(N,k){return!!c.value[N+"-"+k]}function y(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,w()}async function v(){try{const N=await K.get("/api/trajectories");e.value=N.files||[],o.value=N.count||0}catch{}}let x=0;async function w(){const N=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const k=await K.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(N!==x)return;let C=k.entries||[];u.value.tool_name&&(C=C.filter(O=>(O.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(C=C.filter(O=>O.is_error)),u.value.channel_id&&(C=C.filter(O=>O.channel_id===u.value.channel_id)),u.value.user_id&&(C=C.filter(O=>O.user_id===u.value.user_id)),t.value=C}else{const k=new URLSearchParams;u.value.channel_id&&k.set("channel_id",u.value.channel_id),u.value.user_id&&k.set("user_id",u.value.user_id),u.value.tool_name&&k.set("tool_name",u.value.tool_name),u.value.errors_only&&k.set("errors_only","true"),k.set("limit",String(u.value.limit));const C=k.toString(),O=await K.get(`/api/trajectories/search/query?${C}`);if(N!==x)return;t.value=O.results||[]}}catch(k){if(N!==x)return;n.value=k.message}N===x&&(s.value=!1)}async function I(){if(!l.value.trim())return;const N=++x;s.value=!0,n.value=null,c.value={};try{const k=await K.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(N!==x)return;i.value=k.entry||null,i.value||(n.value="No trace found for this message ID")}catch(k){if(N!==x)return;k.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=k.message}N===x&&(s.value=!1)}return He(async()=>{await v(),await w()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:b,truncateBlock:tg,toggleExpand:g,toggleIteration:T,isIterationExpanded:L,clearFilters:y,fetchFiles:v,fetchTraces:w,lookupMessage:I}}},fw={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),n=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),a=h("user");let i=null;const l=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],r=J(()=>[...s.value.recent||[]].reverse()),o=async()=>{try{const u=await K.get("/api/usage");s.value=u,n.value=u.totals||n.value,t.value=null}catch(u){t.value=u.message}finally{e.value=!1}},c=()=>{e.value=!0,o()};return He(()=>{o(),i=setInterval(o,15e3)}),gt(()=>{i&&clearInterval(i)}),{loading:e,error:t,data:s,totals:n,activeTab:a,tabs:l,recentReversed:r,fmtNum:sg,formatTime:Nc,retry:c}}},pw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"audit",label:"Audit",component:rw},{id:"sessions",label:"Sessions",component:cw},{id:"traces",label:"Traces",component:dw},{id:"usage",label:"Usage",component:fw}]}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Kr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],hw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),r=h(null),o=J(()=>e.value.filter(y=>y.is_core).length),c=J(()=>e.value.filter(y=>!y.is_core).length),u=J(()=>Object.values(a.value).reduce((y,v)=>y+v,0));function d(y){for(const v of Kr)if(v.id!=="other"&&v.match(y))return v.id;return"other"}const f=J(()=>{let y=e.value;if(n.value){const v=n.value.toLowerCase();y=y.filter(x=>x.name.toLowerCase().includes(v)||(x.description||"").toLowerCase().includes(v))}return r.value&&(y=y.filter(v=>d(v.name)===r.value)),y}),p=J(()=>{const y=new Set;for(const v of e.value)y.add(d(v.name));return Kr.filter(v=>y.has(v.id))}),b=J(()=>{const y=f.value,v={};for(const w of y){const I=d(w.name);v[I]||(v[I]=[]),v[I].push(w)}const x=[];for(const w of Kr)v[w.id]&&v[w.id].length>0&&x.push({label:w.label,icon:w.icon,tools:v[w.id].sort((I,N)=>I.name.localeCompare(N.name))});return x});function g(y){i.value={...i.value,[y]:!i.value[y]}}async function T(){t.value=!0,s.value=null;try{const[y,v]=await Promise.all([K.get("/api/tools"),K.get("/api/tools/stats").catch(()=>({}))]);e.value=y,a.value=v||{};const x=Object.values(v||{}).filter(w=>w>0).sort((w,I)=>w-I)}catch(y){s.value=y.message}t.value=!1}function L(){T()}return He(()=>{T()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,coreCount:o,skillCount:c,totalUsage:u,filteredTools:f,groupedTools:b,usedCategories:p,truncate:Lc,toggleExpand:g,refresh:L}}};function gw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function mw(e){if(!e)return"1";const t=e.split(`
...
`)}const vw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),b=h(!1),g=h(null),T=h(null),L=h(!1),y=J(()=>e.value.length),v=J(()=>e.value.reduce((Q,de)=>Q+(de.execution_count||0),0)),x=J(()=>e.value.reduce((Q,de)=>Q+O(de.code),0)),w=J(()=>{if(!l.value)return e.value;const Q=l.value.toLowerCase();return e.value.filter(de=>de.name.toLowerCase().includes(Q)||(de.description||"").toLowerCase().includes(Q))}),I=J(()=>d.value?d.value.split(`
`).length:0),N=J(()=>{const Q=Math.max(I.value,1);return Array.from({length:Q},(de,Ie)=>Ie+1).join(`
`)}),k=J(()=>{const Q=d.value.trim();return Q?Q.includes("SKILL_DEFINITION")?Q.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function C(Q){return gw(Q)}function O(Q){return Q?Q.split(`
`).length:0}function B(Q){return mw(Q)}function F(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function S(Q){try{await navigator.clipboard.writeText(Q);const de=e.value.find(Ie=>Ie.code===Q);de&&(r.value=de.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function U(Q){if(Q.key==="Tab"){Q.preventDefault();const de=Q.target,Ie=de.selectionStart,j=de.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(j),St(()=>{de.selectionStart=de.selectionEnd=Ie+4})}}function G(Q){const de=Q.target.previousElementSibling;de&&(de.scrollTop=Q.target.scrollTop)}async function W(){t.value=!0,s.value=null;try{e.value=await K.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function D(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const de=await K.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:de}}catch(de){a.value={...a.value,[Q]:{result:de.message,is_error:!0}}}i.value=null}function E(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function P(Q){o.value=!0,c.value="edit",u.value=Q.name,d.value=Q.code||"",f.value=null,p.value=null}function te(){o.value=!1,f.value=null,p.value=null}async function re(){f.value=null,p.value=null;const Q=u.value.trim(),de=d.value.trim();if(!Q){f.value="Name is required";return}if(!de){f.value="Code is required";return}b.value=!0;try{c.value==="create"?(await K.post("/api/skills",{name:Q,code:de}),p.value="Skill created successfully"):(await K.put(`/api/skills/${encodeURIComponent(Q)}`,{code:de}),p.value="Skill updated successfully"),await W(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}b.value=!1}function se(Q){T.value=Q}async function fe(){if(T.value){L.value=!0;try{await K.del(`/api/skills/${encodeURIComponent(T.value)}`),await W()}catch{}L.value=!1,T.value=null}}return He(()=>{W()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:b,editorRef:g,deleteTarget:T,deleting:L,enabledCount:y,totalExecutions:v,totalLines:x,displayedSkills:w,editLineCount:I,editorLineNums:N,editValidation:k,highlight:C,truncate:Lc,formatTs:Fa,countLines:O,getLineNumbers:B,toggleCode:F,copyCode:S,handleEditorKey:U,syncScroll:G,fetchSkills:W,testSkill:D,showCreate:E,editSkill:P,cancelEdit:te,saveSkill:re,confirmDelete:se,doDelete:fe}}};function bw(e,t){if(!e||!t)return Sd(e);const s=Sd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),b=h(null),g=h(null);let T=null;const L=h(null),y=h(!1),v=h({}),x=h({}),w=h(null),I=h(null),N=J(()=>e.value.reduce((E,P)=>E+(P.chunks||0),0)),k=J(()=>new Set(e.value.map(P=>P.uploader).filter(Boolean)).size);function C(E,P){const te=x.value[P];if(!te||te.length===0)return 0;const re=Math.max(...te.map(se=>se.char_count||0));return re===0?0:Math.round(E.char_count/re*100)}async function O(){t.value=!0,s.value=null;try{const E=await K.get("/api/knowledge");e.value=Array.isArray(E)?E:[]}catch(E){s.value=E.message}t.value=!1}async function B(E){if(v.value[E]){v.value[E]=!1,I.value=null;return}if(v.value[E]=!0,!(x.value[E]||w.value===E)){w.value=E;try{const P=await K.get(`/api/knowledge/${encodeURIComponent(E)}/chunks`);x.value[E]=Array.isArray(P)?P:[]}catch(P){x.value[E]=[],_e.error(`Failed to load chunks: ${P.message}`)}w.value=null}}async function F(){const E=n.value.trim();if(E){i.value=!0,r.value=null,l.value=E;try{const P=await K.get(`/api/knowledge/search?q=${encodeURIComponent(E)}`);a.value=Array.isArray(P)?P:[]}catch(P){a.value=[],r.value=P.message||"Search failed"}i.value=!1}}function S(){a.value=null,n.value="",r.value=null}async function U(){d.value=null,f.value=null;const E=c.value.trim(),P=u.value.trim();if(!E){d.value="Source name is required";return}if(!P){d.value="Content is required";return}p.value=!0;try{const te=await K.post("/api/knowledge",{source:E,content:P});f.value=`Ingested ${te.chunks||0} chunks from "${E}"`,c.value="",u.value="",x.value={},await O(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(te){d.value=te.message}p.value=!1}async function G(E){b.value=E,g.value=null,T&&(clearTimeout(T),T=null);try{const P=await K.post(`/api/knowledge/${encodeURIComponent(E)}/reingest`);g.value={source:E,error:!1,message:`Re-ingested ${P.chunks||0} chunks`},delete x.value[E],await O(),T=setTimeout(()=>{g.value=null,T=null},3e3)}catch(P){g.value={source:E,error:!0,message:P.message}}b.value=null}function W(E){L.value=E}async function D(){if(L.value){y.value=!0;try{await K.del(`/api/knowledge/${encodeURIComponent(L.value)}`),delete x.value[L.value],await O()}catch{}y.value=!1,L.value=null}}return He(()=>{O()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:b,reingestResult:g,deleteTarget:L,deleting:y,expanded:v,sourceChunks:x,loadingChunks:w,selectedChunk:I,totalChunks:N,uploaderCount:k,truncate:Lc,formatTs:Fa,highlightTerms:bw,chunkBarWidth:C,fetchSources:O,toggleSource:B,doSearch:F,clearSearch:S,doIngest:U,doReingest:G,confirmDelete:W,doDelete:D}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),b=h(!1),g=h(null),T=h(null),L=h(new Set),y=h(null),v=h(!1),x=h(!1),w=J(()=>e.value.reduce((se,fe)=>se+fe.count,0)),I=J(()=>L.value.size);function N(se){const fe=t.value[se];if(!fe)return[];if(!l.value.trim())return fe;const Q=l.value.trim().toLowerCase();return fe.filter(de=>de.key.toLowerCase().includes(Q)||de.value&&de.value.toLowerCase().includes(Q))}function k(se,fe){return L.value.has(se+"/"+fe)}function C(se,fe){const Q=se+"/"+fe,de=new Set(L.value);de.has(Q)?de.delete(Q):de.add(Q),L.value=de}function O(se){const fe=t.value[se];return!fe||fe.length===0?!1:fe.every(Q=>L.value.has(se+"/"+Q.key))}function B(se,fe){const Q=t.value[se];if(!Q)return;const de=new Set(L.value);for(const Ie of Q){const j=se+"/"+Ie.key;fe?de.add(j):de.delete(j)}L.value=de}async function F(){s.value=!0,n.value=null;try{const se=await K.get("/api/memory");e.value=Object.entries(se).map(([fe,Q])=>({name:fe,keys:Q.keys||[],count:Q.count||0}))}catch(se){n.value=se.message}s.value=!1}async function S(se){if(a.value[se]){a.value[se]=!1;return}a.value[se]=!0;const fe=e.value.find(de=>de.name===se);if(!fe||t.value[se]||i.value===se)return;i.value=se;const Q=await Promise.all(fe.keys.map(async de=>{try{const Ie=await K.get(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(de)}`);return{key:de,value:Ie.value||""}}catch{return{key:de,value:"(error loading)"}}}));t.value[se]=Q,i.value=null}function U(se,fe,Q){f.value=se+"/"+fe,p.value=Q}async function G(se,fe){b.value=!0,g.value=null;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(fe)}`,{value:p.value});const Q=t.value[se];if(Q){const de=Q.find(Ie=>Ie.key===fe);de&&(de.value=p.value)}f.value=null}catch(Q){g.value=`Failed to save: ${Q.message||"unknown error"}`}b.value=!1}async function W(se,fe){try{await navigator.clipboard.writeText(fe.value),T.value=se+"/"+fe.key,setTimeout(()=>{T.value=null},1500)}catch{}}async function D(){u.value=null,d.value=null;const se=o.value.scope.trim(),fe=o.value.key.trim(),Q=o.value.value.trim();if(!se){u.value="Scope is required";return}if(!fe){u.value="Key is required";return}if(!Q){u.value="Value is required";return}c.value=!0;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(fe)}`,{value:Q}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await F(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(de){u.value=de.message}c.value=!1}function E(se,fe){y.value={scope:se,key:fe}}async function P(){if(!y.value)return;v.value=!0,g.value=null;const{scope:se,key:fe}=y.value;try{await K.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(fe)}`);const Q=t.value[se];Q&&(t.value[se]=Q.filter(j=>j.key!==fe));const de=e.value.find(j=>j.name===se);de&&(de.count--,de.keys=de.keys.filter(j=>j!==fe));const Ie=new Set(L.value);Ie.delete(se+"/"+fe),L.value=Ie}catch(Q){g.value=`Failed to delete: ${Q.message||"unknown error"}`}v.value=!1,y.value=null}function te(){x.value=!0}async function re(){v.value=!0,g.value=null;const se=[];for(const fe of L.value){const Q=fe.indexOf("/");se.push({scope:fe.slice(0,Q),key:fe.slice(Q+1)})}try{await K.post("/api/memory/bulk-delete",{entries:se}),L.value=new Set,t.value={},await F()}catch(fe){g.value=`Bulk delete failed: ${fe.message||"unknown error"}`}v.value=!1,x.value=!1}return He(()=>{F()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:b,actionError:g,copied:T,selected:L,selectedCount:I,totalEntries:w,deleteTarget:y,deleting:v,showBulkDelete:x,fetchMemory:F,toggleScope:S,startEdit:U,doEdit:G,copyValue:W,doAdd:D,confirmDelete:E,doDelete:P,confirmBulkDelete:te,doBulkDelete:re,isSelected:k,toggleSelect:C,isScopeAllSelected:O,toggleSelectAll:B,filteredEntries:N}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=J(()=>[...new Set(e.value.map(T=>T.category))].sort()),o=J(()=>{const g={};return e.value.forEach(T=>{g[T.category]=(g[T.category]||0)+1}),g}),c=J(()=>a.value?e.value.filter(g=>g.category===a.value):e.value);function u(g){return g==="correction"?"badge-warning":g==="operational"?"badge-info":g==="preference"?"badge-success":"badge-info"}function d(g){i.value=g.key,l.value=g.content}async function f(g){try{await K.put("/api/learned/"+encodeURIComponent(g),{content:l.value}),i.value=null,_e.success("Entry updated"),await b()}catch(T){_e.error(T.message||"Failed to save entry")}}async function p(g){if(await rs({title:"Delete learned entry",message:`Delete "${g}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/learned/"+encodeURIComponent(g)),_e.success("Entry deleted"),await b()}catch(L){_e.error(L.message||"Failed to delete entry")}}async function b(){s.value=!0,n.value=null;try{const g=await K.get("/api/learned");e.value=g.entries||[],t.value={last_reflection:g.last_reflection,count:g.count}}catch(g){n.value=g.message}s.value=!1}return He(b),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:u,formatTs:Fa,startEdit:d,saveEdit:f,deleteEntry:p,fetchEntries:b}}},kw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"tools",label:"Tools",component:hw},{id:"skills",label:"Skills",component:vw},{id:"knowledge",label:"Knowledge",component:yw},{id:"memory",label:"Memory",component:xw},{id:"learned",label:"Learned",component:_w}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},ww={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),u=h(!0),d=h(""),f=h(!1),p=h(!1),b=J(()=>e.value==="custom"),g=J(()=>[...i.value,...l.value]),T=J(()=>l.value.includes(e.value)),L=J(()=>{var k;return b.value?t.value||"Odin":((k=a.value[e.value])==null?void 0:k.name)||e.value}),y=J(()=>{var k;return b.value?s.value||"(empty — will use Odin default)":((k=a.value[e.value])==null?void 0:k.identity)||""}),v=J(()=>{var k;return b.value?n.value||"(empty — will use Odin default)":((k=a.value[e.value])==null?void 0:k.voice)||""});async function x(){u.value=!0;try{const k=await K.get("/api/personality");e.value=k.preset||"odin",t.value=k.custom_name||"",s.value=k.custom_identity||"",n.value=k.custom_voice||"",a.value=k.presets||{},i.value=k.builtin_presets||[],l.value=k.user_presets||[]}catch(k){c.value=k.message}finally{u.value=!1}}async function w(){r.value=!0,c.value=null,o.value=!1;try{await K.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(k){c.value=k.message}finally{r.value=!1}}async function I(){const k=d.value.trim();if(k){p.value=!0,c.value=null;try{await K.post("/api/personality/presets",{name:k,display_name:L.value,identity:y.value,voice:v.value}),f.value=!1,d.value="",await x(),e.value=k.toLowerCase().replace(/ /g,"_")}catch(C){c.value=C.message}finally{p.value=!1}}}async function N(){if(await rs({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await K.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(C){c.value=C.message}}}return He(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:g,isCustom:b,isUserPreset:T,previewName:L,previewIdentity:y,previewVoice:v,saving:r,saved:o,error:c,loading:u,save:w,showSavePreset:f,newPresetName:d,savingPreset:p,saveAsPreset:I,deletePreset:N,builtinPresets:i,userPresets:l}},template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=J(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=J(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await K.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return He(()=>{c(),i=setInterval(c,3e4)}),gt(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:sg,refresh:u,retry:d}}},Rw=["INFO","WARNING","ERROR"],Iw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Gr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Nw=[50,100,200,500],Lw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(We.state||"disconnected"),c=J(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,b=Rw,g=Iw,T=Gr,L=h("all"),y=h(""),v=h([]),x=h(!1),w=h(""),I=h([]);function N(){try{const V=localStorage.getItem("odin-log-presets");V&&(v.value=JSON.parse(V))}catch{}}function k(){try{localStorage.setItem("odin-log-presets",JSON.stringify(v.value))}catch{}}const C=J(()=>a.value!==""||i.value.trim()!==""||y.value!==""),O=J(()=>{const V=Gr.find(ae=>ae.value===y.value);return V?V.label:""}),B=J(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(V){return V.message}}),F=24,S=J(()=>{if(t.value.length===0)return[];const V=[],ae=new Date,Te=3600*1e3;for(let Xe=F-1;Xe>=0;Xe--){const rt=new Date(ae.getTime()-(Xe+1)*Te),Zt=new Date(ae.getTime()-Xe*Te);V.push({start:rt,end:Zt,label:D(rt,Zt),shortLabel:Zt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Xe of t.value){if(!Xe._time)continue;const rt=Xe._time.getTime();for(const Zt of V)if(rt>=Zt.start.getTime()&&rt<Zt.end.getTime()){Zt.total++,Xe.level==="ERROR"?Zt.errors++:Xe.level==="WARNING"?Zt.warnings++:Zt.info++;break}}return V}),U=J(()=>{let V=1;for(const ae of S.value)ae.total>V&&(V=ae.total);return V}),G=J(()=>S.value.length===0?"":"Last 24 hours"),W=J(()=>Math.ceil(F/8));function D(V,ae){const Te={hour:"2-digit",minute:"2-digit"};return V.toLocaleTimeString([],Te)+" - "+ae.toLocaleTimeString([],Te)}function E(V,ae){return!ae||!V?"0px":Math.max(2,V/ae*100)+"%"}function P(V){const ae=te.value.findIndex(Te=>Te._time&&Te._time.getTime()>=V.start.getTime()&&Te._time.getTime()<V.end.getTime());if(ae>=0&&u.value){const Te=u.value.querySelectorAll(".log-line");Te[ae]&&(Te[ae].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const te=J(()=>{let V=t.value;if(a.value&&(V=V.filter(ae=>(ae.level||"INFO")===a.value)),y.value){const ae=Gr.find(Te=>Te.value===y.value);if(ae&&ae.seconds){const Te=new Date(Date.now()-ae.seconds*1e3);V=V.filter(Xe=>Xe._time&&Xe._time>=Te)}}if(i.value&&!B.value)if(l.value)try{const ae=new RegExp(i.value,"i");V=V.filter(Te=>{const Xe=Te.text||Te.raw||"",rt=Te.tool||"";return ae.test(Xe)||ae.test(rt)})}catch{}else{const ae=i.value.toLowerCase();V=V.filter(Te=>{const Xe=(Te.text||Te.raw||"").toLowerCase(),rt=(Te.tool||"").toLowerCase();return Xe.includes(ae)||rt.includes(ae)})}return V});function re(V){if(V.type==="log"&&V.line)try{const ae=typeof V.line=="string"?JSON.parse(V.line):V.line,Te=ae.timestamp?new Date(ae.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ae.error?"ERROR":"INFO",text:ae.tool_name?`[${ae.tool_name}] ${ae.result_summary||""}`.trim():ae.message||JSON.stringify(ae),tool:ae.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(V.line),tool:"",raw:String(V.line)}}if(V.payload){const ae=V.payload,Te=ae.timestamp?new Date(ae.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ae.error?"ERROR":"INFO",text:ae.tool_name?`[${ae.tool_name}] ${ae.result_summary||""}`.trim():ae.message||JSON.stringify(ae),tool:ae.tool_name||"",raw:null}}return typeof V=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:V,tool:"",raw:V}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(V),tool:"",raw:null}}function se(V){const ae=re(V);if(s.value){I.value.push(ae);return}fe(ae)}function fe(V){t.value.push(V),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&St(()=>Q())}function Q(V=!1){const ae=u.value;ae&&ae.scrollTo({top:ae.scrollHeight,behavior:V?"smooth":"instant"})}function de(){n.value=!0,d.value=!1,St(()=>Q(!0))}const Ie=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function j(){const V=u.value;if(!V)return;const ae=V.scrollHeight-V.scrollTop-V.clientHeight<40;d.value=!n.value&&!ae&&t.value.length>0,pe.value&&ue()}function ue(){const V=u.value;!V||!n.value||V.scrollHeight-V.scrollTop-V.clientHeight>=40&&(n.value=!1,d.value=t.value.length>0)}function le(){n.value&&requestAnimationFrame(ue)}function me(V){Ie.has(V.key)&&le()}const pe=h(!1);function Le(){n.value&&(pe.value=!0,requestAnimationFrame(ue))}function m(){pe.value&&(pe.value=!1,ue())}function A(){n.value&&(d.value=!1,St(()=>Q()))}function M(){if(s.value=!s.value,!s.value&&I.value.length>0){for(const V of I.value)fe(V);I.value=[]}}function Z(){t.value=[],I.value=[],d.value=!1}function R(){let V;e.value==="search"?V=Wt.value.map(rt=>{const Zt=rt.error?"ERROR":"INFO",ns=rt.tool_name?`[${rt.tool_name}] `:"";return`${rt.timestamp||""} ${Zt} ${ns}${rt.result_summary||rt.message||""}`}).join(`
`):V=te.value.map(rt=>`${rt.ts} ${rt.level} ${rt.text}`).join(`
`);const ae=new Blob([V],{type:"text/plain"}),Te=URL.createObjectURL(ae),Xe=document.createElement("a");Xe.href=Te,Xe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Xe.click(),URL.revokeObjectURL(Te)}function $(V,ae){const Te=`${V.ts} ${V.level} ${V.text||V.raw||""}`;navigator.clipboard.writeText(Te).then(()=>{f.value=ae,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function Y(V){a.value=a.value===V?"":V,L.value="all"}function ee(V){return V.level==="ERROR"?"log-line-error":V.level==="WARNING"?"log-line-warning":"text-gray-300"}function ne(V){return V==="ERROR"?"text-red-500 font-semibold":V==="WARNING"?"text-yellow-500":"text-blue-500"}function X(V){return V==="ERROR"?"log-chip-error":V==="WARNING"?"log-chip-warning":"log-chip-info"}function be(V){L.value=V.id;const ae=V.filters;a.value=ae.level||"",y.value=ae.timeRange||"",i.value=ae.text||"",ae.levels&&(a.value=ae.levels[0]||""),ae.hasToolName&&(i.value="")}function oe(V){L.value=V.id,a.value=V.filters.level||"",y.value=V.filters.timeRange||"",i.value=V.filters.text||""}function ge(){if(!w.value.trim())return;const V={id:"custom-"+Date.now(),name:w.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};v.value=[...v.value,V],k(),x.value=!1,w.value=""}function xe(V){v.value=v.value.filter(ae=>ae.id!==V),k(),L.value===V&&(L.value="all")}const ke=h("all"),Ee=h(""),H=h(""),ce=h(""),ye=h(""),Me=h(""),Ue=h(100),Je=Nw,dt=h(!1),Ye=h(!1),Ke=h(""),Wt=h([]),bs=h(null),Ts=h(null);function Cn(){e.value="search",bs.value||Qn()}async function Qn(){try{bs.value=await K.get("/api/logs/stats")}catch{}}function cn(){const V=Me.value;if(!V){ce.value="",ye.value="";return}const Te={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[V];if(Te){const Xe=new Date(Date.now()-Te*1e3);ce.value=un(Xe),ye.value=""}}function un(V){const ae=Te=>String(Te).padStart(2,"0");return`${V.getFullYear()}-${ae(V.getMonth()+1)}-${ae(V.getDate())}T${ae(V.getHours())}:${ae(V.getMinutes())}`}function z(V){if(!V)return"";const ae=new Date(V);return isNaN(ae.getTime())?"":ae.toISOString()}async function Se(){dt.value=!0,Ke.value="",Ye.value=!0,Ts.value=null;try{const V=new URLSearchParams;ke.value&&ke.value!=="all"&&V.set("level",ke.value),Ee.value&&V.set("tool",Ee.value),H.value&&V.set("q",H.value);const ae=z(ce.value),Te=z(ye.value);ae&&V.set("start",ae),Te&&V.set("end",Te),V.set("limit",String(Ue.value));const Xe=await K.get(`/api/logs/search?${V.toString()}`);Wt.value=Xe.entries||[]}catch(V){Ke.value=V.message||"Search failed",Wt.value=[]}finally{dt.value=!1}}function Cs(){ke.value="all",Ee.value="",H.value="",ce.value="",ye.value="",Me.value="",Ue.value=100,Wt.value=[],Ye.value=!1,Ke.value="",Ts.value=null}function En(V){Ts.value=Ts.value===V?null:V}function br(V){if(!V.timestamp)return"";try{return new Date(V.timestamp).toLocaleString()}catch{return V.timestamp}}function $a(V){return V.type==="web_action"?`${V.status||""} (${V.execution_time_ms||0}ms)`:(V.result_summary||"").slice(0,200)}function Ua(V){return V.error?"log-line-error":"text-gray-300"}function yr(V){try{return JSON.stringify(V,null,2)}catch{return String(V)}}let ys=null,Xn=null,ea=!1;function it(){ea||(ea=!0,We.subscribe("logs",se),r.value=We.connected,o.value=We.state||"disconnected",ys=We.onStateChange,Xn=(V,ae)=>{o.value=V,r.value=V==="connected",ys&&ys(V,ae)},We.onStateChange=Xn)}function Fs(){ea&&(ea=!1,We.unsubscribe("logs",se),We.onStateChange===Xn&&(We.onStateChange=ys),Xn=null,ys=null)}return He(()=>{N(),window.addEventListener("pointerup",m),window.addEventListener("pointercancel",m)}),er(it),tr(Fs),gt(()=>{Fs(),window.removeEventListener("pointerup",m),window.removeEventListener("pointercancel",m)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:te,pauseBuffer:I,showJumpBottom:d,copiedIndex:f,regexError:B,levels:b,logPresets:g,timeRanges:T,timeRange:y,activeLogPreset:L,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:w,hasActiveLogFilters:C,timeRangeLabel:O,timelineBuckets:S,timelineMax:U,timelineSpanLabel:G,timelineLabelSkip:W,togglePause:M,clearLogs:Z,exportLogs:R,logLineClass:ee,levelClass:ne,levelChipClass:X,toggleLevel:Y,copyLine:$,jumpToBottom:de,onScroll:j,onUserScrollIntent:le,onUserScrollKey:me,onAutoScrollToggle:A,onPointerDown:Le,applyLogPreset:be,applyCustomLogPreset:oe,saveLogCustomPreset:ge,removeLogCustomPreset:xe,segmentHeight:E,jumpToTimelineBucket:P,searchLevel:ke,searchTool:Ee,searchKeyword:H,searchStart:ce,searchEnd:ye,searchTimePreset:Me,searchLimit:Ue,searchLimits:Je,searching:dt,searchRan:Ye,searchError:Ke,searchResults:Wt,searchStats:bs,expandedSearch:Ts,switchToSearch:Cn,runSearch:Se,clearSearchFilters:Cs,toggleSearchExpand:En,formatSearchTs:br,searchEntryText:$a,searchLogLineClass:Ua,formatJson:yr,applySearchTimePreset:cn}}},Ow=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Wr=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],vg="••••••••",Pw=50;function Fw(e){return Ow.has(e)}function $w(e){return e===vg}function sl(e){return JSON.parse(JSON.stringify(e))}function Vn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Vn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Vn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Gd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Vn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Vn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=J(()=>d.value.length>0),b=J(()=>f.value.length>0),g=J(()=>r.value&&t.value?t.value:e.value),T=J(()=>!e.value||!t.value?!1:!Vn(e.value,t.value)),L=J(()=>!e.value||!t.value?0:Gd(e.value,t.value).length),y=J(()=>{if(!r.value||!t.value)return{};const R={};for(const $ of Object.keys(t.value)){const Y=t.value[$];if(typeof Y=="object"&&Y!==null&&!Array.isArray(Y))for(const ee of Object.keys(Y)){const ne=Bw($,ee,Y[ee]);ne&&(R[$+"."+ee]=ne)}}return R}),v=J(()=>Object.keys(y.value).length>0),x=J(()=>e.value?Object.keys(e.value).length:0),w=J(()=>N.value.length),I=J(()=>!e.value||!t.value?[]:Gd(e.value,t.value)),N=J(()=>e.value?Wr.map(R=>({...R,sections:R.sections.filter($=>$ in e.value)})).filter(R=>R.sections.length>0):[]),k=J(()=>{if(!e.value)return[];const R=new Set(Wr.flatMap($=>$.sections));return Object.keys(e.value).filter($=>!R.has($))});function C(R){return g.value?g.value[R]:null}function O(R){return!e.value||!t.value?!1:!Vn(e.value[R],t.value[R])}function B(R){return R.sections.some($=>O($))}function F(R,$){if(!e.value||!t.value)return!1;const Y=e.value[R],ee=t.value[R];return!Y||!ee?!1:!Vn(Y[$],ee[$])}function S(R){return t.value?t.value[R]:e.value[R]}function U(R,$){const Y=t.value||e.value;return Y[R]?Y[R][$]:void 0}function G(R,$){const Y=r.value&&t.value?t.value:e.value;return Y[R]?Y[R][$]:!1}function W(R,$){return y.value[R+"."+$]||null}function D(R,$){return Dw[R+"."+$]||null}function E(R,$,Y){t.value&&($===null?t.value[R]=Y:(t.value[R]||(t.value[R]={}),t.value[R][$]=Y),t.value={...t.value})}function P(R,$,Y){if(!t.value)return;const ee=sl(t.value);E(R,$,Y),d.value.push(ee),d.value.length>Pw&&d.value.shift(),f.value=[]}function te(R,$,Y){try{const ee=JSON.parse(Y);P(R,$,ee)}catch{}}function re(){d.value.length!==0&&(f.value.push(sl(t.value)),t.value=d.value.pop())}function se(){f.value.length!==0&&(d.value.push(sl(t.value)),t.value=f.value.pop())}function fe(R,$,Y){if(!t.value||!t.value[R])return;const ee=[...t.value[R][$]];ee.splice(Y,1),P(R,$,ee)}function Q(R,$){if(!t.value||!t.value[R])return;const Y=[...t.value[R][$]||[]],ee=prompt("Enter new value:");ee!==null&&(Y.push(ee),P(R,$,Y))}function de(R){a.value={...a.value,[R]:!a.value[R]}}function Ie(R){l.value={...l.value,[R]:!l.value[R]}}function j(R){i.value={...i.value,[R]:!i.value[R]}}function ue(R){try{return JSON.stringify(R,null,2)}catch{return String(R)}}function le(R){return R==null?"null":typeof R=="object"?JSON.stringify(R,null,2):String(R)}function me(R,$){c.value={type:R,message:$},setTimeout(()=>{c.value=null},3e3)}function pe(){t.value=sl(e.value),r.value=!0,d.value=[],f.value=[]}function Le(){r.value=!1,t.value=null,d.value=[],f.value=[]}function m(){u.value=!0}async function A(){if(!(!T.value||v.value)){o.value=!0;try{const R=Uw(e.value,t.value);if(Object.keys(R).length===0){me("success","No changes to save."),o.value=!1;return}const $=await K.put("/api/config",R);e.value=$,r.value=!1,t.value=null,d.value=[],f.value=[],me("success","Config saved successfully.")}catch(R){me("error",R.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await K.get("/api/config");for(const R of Object.keys(e.value))a.value[R]===void 0&&(a.value[R]=!0);for(const R of Wr)l.value[R.key]===void 0&&(l.value[R.key]=!0)}catch(R){n.value=R.message}s.value=!1}function Z(R){if(!r.value)return;const $=R.target;$ instanceof HTMLElement&&($.matches("input, textarea, select")||$.isContentEditable)||((R.ctrlKey||R.metaKey)&&!R.shiftKey&&R.key.toLowerCase()==="z"?(R.preventDefault(),re()):(R.ctrlKey||R.metaKey)&&(R.key==="y"||R.shiftKey&&R.key==="z"||R.shiftKey&&R.key==="Z")&&(R.preventDefault(),se()))}return He(()=>{M(),document.addEventListener("keydown",Z)}),gt(()=>{document.removeEventListener("keydown",Z)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:T,hasErrors:v,changeCount:L,REDACTED:vg,showDiffModal:u,diffEntries:I,canUndo:p,canRedo:b,sectionCount:x,groupCount:w,visibleGroups:N,ungroupedSections:k,validationErrors:y,isSensitiveKey:Fw,isRedacted:$w,sectionChanged:O,groupChanged:B,fieldChanged:F,getDisplay:C,getEdited:S,getEditedField:U,getDisplayBool:G,pushEdit:P,pushEditJson:te,getValidationError:W,getEnumOptions:D,removeArrayItem:fe,addArrayItem:Q,toggleSection:de,toggleGroup:Ie,toggleNested:j,formatJson:ue,formatDiffVal:le,showToast:me,showDiff:m,fetchConfig:M,startEdit:pe,cancelEdit:Le,saveConfig:A,undo:re,redo:se}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({});function a(p){return p.config&&p.config.enabled!==void 0?p.config.enabled:!0}function i(p){return p.config&&p.config.require_mention!==void 0?p.config.require_mention:!1}function l(p){return p.config&&p.config.respond_to_bots!==void 0?p.config.respond_to_bots:!1}function r(p){return p.config&&Object.keys(p.config).length>0}function o(p){n.value[p]=!n.value[p]}async function c(){t.value=!0,s.value=null;try{e.value=await K.get("/api/discord/guilds")}catch(p){s.value=p.message}t.value=!1}async function u(p,b,g){try{await K.put("/api/discord/guild/"+p+"/config",{[b]:g}),await c()}catch(T){s.value=T.message}}async function d(p,b,g,T){try{await K.put("/api/discord/channel/"+p+"/config",{[g]:T}),await c()}catch(L){s.value=L.message}}async function f(p,b){try{await K.put("/api/discord/channel/"+p+"/config",{clear:!0}),await c()}catch(g){s.value=g.message}}return He(c),{guilds:e,loading:t,error:s,expanded:n,guildEnabled:a,guildMention:i,guildBots:l,hasOverride:r,toggleGuild:o,fetchGuilds:c,setGuildConfig:u,setChannelConfig:d,clearOverride:f}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=J(()=>{const E={};for(const P of u.value)E[P.id]=P;return E});function p(E){return f.value[E]||null}const b=J(()=>/^\d{15,25}$/.test(r.value.trim())),g=J(()=>{if(o.value){if(T.value[c.value])return"host-user-option-"+c.value;if(b.value)return"host-user-option-raw"}}),T=J(()=>{const E=r.value.toLowerCase().trim();return E?u.value.filter(P=>!i.value[P.id]&&(P.display_name.toLowerCase().includes(E)||P.username.toLowerCase().includes(E)||P.id.includes(E))):u.value.filter(P=>!i.value[P.id])});function L(E,P){return E?E.allowed_hosts===null||E.allowed_hosts===void 0?{allowed_hosts:[...P],default_host:E.default_host||"",allow_all:!0}:{allowed_hosts:E.allowed_hosts,default_host:E.default_host||"",allow_all:!1}:{allowed_hosts:[...P],default_host:P[0]||"",allow_all:!0}}async function y(){e.value=!0,t.value="";try{const E=await K.get("/api/host-access");s.value=E,n.value=E.available_hosts||[],a.value=L(E.default_policy,n.value);const P=E.users||{},te={};for(const[re,se]of Object.entries(P))te[re]=L(se,n.value);i.value=te}catch(E){t.value=E.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await K.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const E=a.value.allow_all?null:a.value.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:E,default_host:a.value.default_host}),_e.success("Default policy updated")}catch(E){_e.error(E.message||"Failed to save")}}function x(E,P){a.value.allow_all=!1,P?a.value.allowed_hosts.includes(E)||a.value.allowed_hosts.push(E):(a.value.allowed_hosts=a.value.allowed_hosts.filter(te=>te!==E),a.value.default_host===E&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function w(E){const P=i.value[E];if(P)try{const te=P.allow_all?null:P.allowed_hosts;await K.put(`/api/host-access/user/${E}`,{allowed_hosts:te,default_host:P.default_host});const re=p(E);_e.success(`Updated access for ${re?re.display_name:E}`)}catch(te){_e.error(te.message||"Failed to save")}}function I(E,P,te){const re=i.value[E];re&&(re.allow_all=!1,te?re.allowed_hosts.includes(P)||re.allowed_hosts.push(P):(re.allowed_hosts=re.allowed_hosts.filter(se=>se!==P),re.default_host===P&&(re.default_host=re.allowed_hosts[0]||"")),w(E))}function N(E,P){const te=i.value[E];te&&(te.default_host=P,w(E))}function k(){l.value=!0,r.value="",c.value=0,St(()=>{d.value&&d.value.focus()})}function C(){o.value=!0,c.value=0}function O(){c.value<T.value.length-1&&c.value++}function B(){c.value>0&&c.value--}function F(){const E=T.value[c.value];if(E){U(E);return}b.value&&S()}function S(){const E=r.value.trim();/^\d{15,25}$/.test(E)&&(i.value[E]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},w(E),r.value="",o.value=!1,l.value=!1)}function U(E){i.value[E.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},w(E.id),r.value="",o.value=!1,l.value=!1}function G(){o.value=!1}function W(){setTimeout(()=>{o.value=!1},150)}async function D(E){const P=p(E);if(await rs({title:"Remove user override",message:`Remove the host access override for ${P?P.display_name:E}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await K.del(`/api/host-access/user/${E}`),delete i.value[E],_e.success(`Removed override for ${P?P.display_name:E}`)}catch(re){_e.error(re.message||"Failed to delete")}}return He(y),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:T,isRawId:b,activeOptionId:g,searchInput:d,fetchData:y,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:I,setUserDefault:N,openAddUser:k,deleteUser:D,onSearchInput:C,highlightNext:O,highlightPrev:B,selectHighlighted:F,selectMember:U,closeDropdown:G,onBlur:W,addRawId:S}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=J(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=J(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(k){return k==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":k==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function b(){e.value=!0,t.value="";try{const k=await K.get("/api/tokens");s.value=k.tokens||[],n.value=k.available_hosts||[]}catch(k){t.value=k.message||"Failed to load tokens"}finally{e.value=!1}}function g(k){return!k||!k.trim()?[]:k.split(",").map(C=>C.trim()).filter(Boolean)}function T(k,C){const O=c.value.allowed_hosts;if(C&&!O.includes(k)&&O.push(k),!C){const B=O.indexOf(k);B>=0&&O.splice(B,1)}}function L(k,C){const O=u.value.allowed_hosts;if(C&&!O.includes(k)&&O.push(k),!C){const B=O.indexOf(k);B>=0&&O.splice(B,1)}}async function y(){var k;i.value=!0;try{const C=g(c.value.allowed_tools_str),O=c.value.host_mode,B=O==="none"?[]:O==="select"?c.value.allowed_hosts:null,F={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:C.length?C:[]};B!==null&&(F.allowed_hosts=B),F.default_host=c.value.default_host||"";const S=await K.post("/api/tokens",F);l.value=S.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,_e.success("Token created"),await b()}catch(C){_e.error(((k=C.data)==null?void 0:k.error)||C.message||"Failed to create token")}finally{i.value=!1}}function v(k){r.value=k;const C=k.allowed_hosts;let O="default";C==null?O="default":Array.isArray(C)&&C.length===0?O="none":Array.isArray(C)&&(O="select"),u.value={username:k.username||"",tier:k.tier||"admin",label:k.label||"",host_mode:O,allowed_hosts:Array.isArray(C)?[...C]:[],default_host:k.default_host||"",allowed_tools_str:(k.allowed_tools||[]).join(", ")}}async function x(){var k;if(r.value){o.value=!0;try{const C=g(u.value.allowed_tools_str),O=u.value.host_mode,B={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:C};O==="none"?B.allowed_hosts=[]:O==="select"?B.allowed_hosts=u.value.allowed_hosts:B.allowed_hosts=null,B.default_host=u.value.default_host||"",await K.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,_e.success("Token updated"),await b()}catch(C){_e.error(((k=C.data)==null?void 0:k.error)||C.message||"Failed to update")}finally{o.value=!1}}}async function w(k){var O;if(await rs({title:"Regenerate token",message:`Regenerate token for ${k.username||k.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await K.post("/api/tokens/"+encodeURIComponent(k.user_id)+"/regenerate");l.value=B.token,_e.success("Token regenerated")}catch(B){_e.error(((O=B.data)==null?void 0:O.error)||B.message||"Failed to regenerate")}}async function I(k){var O;if(await rs({title:"Delete token",message:`Delete token for ${k.username||k.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/tokens/"+encodeURIComponent(k.user_id)),_e.success("Token deleted"),await b()}catch(B){_e.error(((O=B.data)==null?void 0:O.error)||B.message||"Failed to delete")}}async function N(){if(l.value)try{await navigator.clipboard.writeText(l.value),_e.success("Copied to clipboard")}catch{_e.error("Copy failed — select and copy manually")}}return He(b),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:b,tierBadge:p,toggleCreateHost:T,toggleEditHost:L,createToken:y,startEdit:v,saveEdit:x,confirmRegenerate:w,confirmDelete:I,copyToken:N}}};function nl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const qw={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=J(()=>{const z=n.value.model;return z&&!a.includes(z)?[z,...a]:a}),l=J(()=>{const z=n.value.agent_model;return z&&z!=="auto"&&!a.includes(z)?[z,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=J(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=J(()=>{const z=n.value.agent_model;return z==="auto"?!0:!r.includes(z||n.value.model)}),u=J(()=>{const z=n.value.agent_reasoning_effort;return z==="auto"?!1:(z||n.value.reasoning_effort)==="max"}),d=z=>r.includes(z)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&u.value),f=z=>r.includes(z)&&u.value,p=h({enabled:!1,model:"gpt-5.6-luna"}),b=h({unavailable_reason:null}),g=J(()=>{const z=p.value.model;return z&&!a.includes(z)?[z,...a]:a});function T(z){const Se=z.target.value;p.value.enabled=Se!=="",Se!==""&&(p.value.model=Se),ye()}const L=h(!1),y=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),v=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),x=h(!1),w=h(!1),I=h(!1),N=h(!1),k=h(!1),C=h(!1),O=h(!1),B=h({configured:!1}),F=h([]),S=h(""),U=h(!1),G=h(!1),W=h({configured:!1}),D=h([]),E=h(""),P=h(!1),te=h(!1),re=h(!0),se=h(""),fe=h({configured:!1,accounts:[]}),Q=h(null),de=h(null),Ie=h(""),j=h(null),ue=h(!1),le=h(null),me=h(null),pe=h("");let Le=null;function m(z,Se="success"){_e(z,Se==="error"?"error":"success")}function A(z){if(!z)return"?";const Se=z/(1024*1024*1024);return Se>=1?Se.toFixed(1)+" GB":(z/(1024*1024)).toFixed(0)+" MB"}async function M(){e.value=!0,await Promise.all([Z(),R(),be(),$()]),e.value=!1}async function Z(){try{const z=await K.get("/api/llm/status");t.value=z,s.value=z.active_provider||"codex",z.codex&&!ce.pending()&&(n.value.enabled=z.codex.enabled,n.value.model=z.codex.model||"gpt-5.5",n.value.reasoning_effort=z.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=z.codex.agent_reasoning_effort||"",n.value.agent_model=z.codex.agent_model||"",n.value.max_tokens=z.codex.max_tokens||4096),z.ollama&&!Me.pending()&&(y.value.enabled=z.ollama.enabled,y.value.base_url=z.ollama.base_url||"",y.value.model=z.ollama.model||"",y.value.max_tokens=z.ollama.max_tokens||4096),z.kimi&&!Ue.pending()&&(v.value.enabled=z.kimi.enabled,v.value.model=z.kimi.model||"",v.value.max_tokens=z.kimi.max_tokens||4096),z.auxiliary&&(b.value=z.auxiliary,ye.pending()||(p.value.enabled=z.auxiliary.enabled,p.value.model=z.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function R(){try{if(B.value=await K.get("/api/ollama/status"),B.value.model&&(S.value=B.value.model),B.value.configured)try{const z=await K.get("/api/ollama/models");F.value=z.models||[]}catch{F.value=[]}else if(y.value.base_url)try{const z=await K.post("/api/ollama/probe-models",{base_url:y.value.base_url});F.value=z.models||[]}catch{F.value=[]}}catch{B.value={configured:!1}}}async function $(){re.value=!0,se.value="";try{fe.value=await K.get("/api/codex/status")}catch(z){se.value=z.message||"Failed to fetch Codex status"}finally{re.value=!1}}async function Y(){const z=t.value?t.value.active_provider:"codex";O.value=!0;try{const Se=await K.post("/api/llm/switch",{provider:s.value});Se.error?(s.value=z,m(Se.error,"error")):(m("Switched to "+s.value+" ("+Se.model+")"),await M())}catch(Se){s.value=z,m(Se.message||"Switch failed","error")}finally{O.value=!1}}async function ee(){U.value=!0;try{const z=await K.post("/api/ollama/reload");m(z.configured?"Ollama reloaded":z.reason||"Ollama not configured",z.configured?"success":"error"),await M()}catch(z){m(z.message||"Reload failed","error")}finally{U.value=!1}}async function ne(){G.value=!0;try{await K.post("/api/ollama/model",{model:S.value}),m("Model set to "+S.value),await M()}catch(z){m(z.message||"Failed","error")}finally{G.value=!1}}async function X(){const z=y.value.base_url;if(!z){m("Enter a base URL first","error");return}C.value=!0;try{const Se=await K.post("/api/ollama/probe-models",{base_url:z});F.value=Se.models||[],F.value.length?(m(F.value.length+" model(s) found"),!y.value.model&&F.value.length&&(y.value.model=F.value[0].name)):m("No models found at "+z,"error")}catch(Se){m(Se.message||"Could not reach Ollama","error")}finally{C.value=!1}}async function be(){try{if(W.value=await K.get("/api/kimi/status"),W.value.model&&(E.value=W.value.model),W.value.configured)try{const z=await K.get("/api/kimi/models");D.value=z.models||[]}catch{D.value=[]}}catch{W.value={configured:!1}}}async function oe(){P.value=!0;try{const z=await K.post("/api/kimi/reload");m(z.configured?"Kimi reloaded":z.reason||"Kimi not configured",z.configured?"success":"error"),await M()}catch(z){m(z.message||"Reload failed","error")}finally{P.value=!1}}async function ge(){te.value=!0;try{await K.post("/api/kimi/model",{model:E.value}),m("Model set to "+E.value),await M()}catch(z){m(z.message||"Failed","error")}finally{te.value=!1}}async function xe(){if(I.value){ce();return}I.value=!0;try{await K.put("/api/llm/codex/config",n.value),m("Codex config saved"),await Promise.all([Z(),$()])}catch(z){m(z.message||"Failed","error"),await Promise.all([Z(),$()])}finally{I.value=!1}}async function ke(){if(N.value){Me();return}N.value=!0;try{const z={...y.value},Se=x.value?y.value.api_key:null;Se===null&&delete z.api_key,await K.put("/api/llm/ollama/config",z),m("Ollama config saved"),Se!==null&&y.value.api_key===Se&&(y.value.api_key="",x.value=!1),await Promise.all([Z(),R()])}catch(z){m(z.message||"Failed","error")}finally{N.value=!1}}async function Ee(){if(k.value){Ue();return}k.value=!0;try{const z={...v.value},Se=w.value?v.value.api_key:null;Se===null&&delete z.api_key,await K.put("/api/llm/kimi/config",z),m("Kimi config saved"),Se!==null&&v.value.api_key===Se&&(v.value.api_key="",w.value=!1),await Promise.all([Z(),be()])}catch(z){m(z.message||"Failed","error")}finally{k.value=!1}}async function H(){if(L.value){ye();return}L.value=!0;try{await K.put("/api/llm/auxiliary/config",p.value),m("Auxiliary config saved"),await Z()}catch(z){m(z.message||"Failed","error"),await Z()}finally{L.value=!1}}const ce=nl(xe),ye=nl(H),Me=nl(ke),Ue=nl(Ee),Je=()=>(ce.cancel(),xe()),dt=()=>(Me.cancel(),ke()),Ye=()=>(Ue.cancel(),Ee());async function Ke(z){try{await K.post("/api/codex/account/"+z+"/activate"),m("Active account switched"),await $()}catch(Se){m(Se.message||"Failed","error")}}async function Wt(z){Q.value=z;try{await K.post("/api/codex/account/"+z+"/refresh"),m("Token refreshed"),await $()}catch(Se){m(Se.message||"Refresh failed","error")}finally{Q.value=null}}function bs(z,Se){de.value=z,Ie.value=Se||""}async function Ts(z){try{await K.put("/api/codex/account/"+z+"/label",{label:Ie.value}),m("Label updated"),de.value=null,await $()}catch(Se){m(Se.message||"Failed","error")}}async function Cn(z,Se){if(await rs({title:"Delete Codex account",message:`Delete ${Se||"account #"+(z+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+z),m("Deleted. Pool reloaded."),await $()}catch(En){m(En.message||"Failed","error")}}async function Qn(){ue.value=!0;try{const z=await K.post("/api/codex/device-code");le.value=z,j.value="pending",cn(z)}catch(z){m(z.message||"Failed","error")}finally{ue.value=!1}}async function cn(z){Le={cancelled:!1};const Se=Le;try{const Cs=await K.post("/api/codex/device-poll",{device_auth_id:z.device_auth_id,user_code:z.user_code,interval:z.interval});if(Se.cancelled)return;me.value=Cs,j.value="success",await M()}catch(Cs){if(Se.cancelled)return;pe.value=Cs.message||"Device login failed",j.value="error"}}function un(){Le&&(Le.cancelled=!0),j.value=null,le.value=null}return He(M),gt(()=>{Le&&(Le.cancelled=!0),ce.cancel(),ye.cancel(),Me.cancel(),Ue.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:O,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:d,agentModelOptionDisabled:f,auxForm:p,auxData:b,auxModelOptions:g,onAuxModelChange:T,savingAux:L,saveAuxConfigDebounced:ye,ollamaForm:y,kimiForm:v,savingCodex:I,savingOllama:N,savingKimi:k,probingOllama:C,ollamaKeyDirty:x,kimiKeyDirty:w,ollamaStatus:B,ollamaModels:F,ollamaSelectedModel:S,reloading:U,settingModel:G,kimiStatus:W,kimiModels:D,kimiSelectedModel:E,reloadingKimi:P,settingKimiModel:te,codexLoading:re,codexError:se,codexData:fe,refreshing:Q,editingLabel:de,labelValue:Ie,deviceState:j,deviceLoading:ue,deviceInfo:le,deviceResult:me,deviceError:pe,fetchAll:M,switchProvider:Y,reloadOllama:ee,setOllamaModel:ne,reloadKimi:oe,setKimiModel:ge,probeOllamaModels:X,saveCodexConfig:xe,saveOllamaConfig:ke,saveKimiConfig:Ee,saveCodexConfigDebounced:ce,saveOllamaConfigDebounced:Me,saveKimiConfigDebounced:Ue,saveCodexConfigNow:Je,saveOllamaConfigNow:dt,saveKimiConfigNow:Ye,activateAccount:Ke,refreshAccount:Wt,startEditLabel:bs,saveLabel:Ts,deleteAccount:Cn,startDeviceLogin:Qn,cancelDeviceLogin:un,formatSize:A}}},Wd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Kw(e){return Wd[e]||Wd[(e||"").toLowerCase()]||"text-gray-400"}const Gw={template:`
  ...
  `},Zw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Lw},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:qw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},mt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),bg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:mt("/operations","live")},{path:"/agents",redirect:mt("/operations","agents")},{path:"/loops",redirect:mt("/operations","loops")},{path:"/processes",redirect:mt("/operations","processes")},{path:"/schedules",redirect:mt("/operations","schedules")},{path:"/audit",redirect:mt("/history","audit")},{path:"/sessions",redirect:mt("/history","sessions")},{path:"/traces",redirect:mt("/history","traces")},{path:"/usage",redirect:mt("/history","usage")},{path:"/tools",redirect:mt("/capabilities","tools")},{path:"/skills",redirect:mt("/capabilities","skills")},{path:"/knowledge",redirect:mt("/capabilities","knowledge")},{path:"/memory",redirect:mt("/capabilities","memory")},{path:"/learned",redirect:mt("/capabilities","learned")},{path:"/health",redirect:mt("/system","health")},{path:"/resources",redirect:mt("/system","resources")},{path:"/logs",redirect:mt("/system","logs")},{path:"/config",redirect:mt("/system","config")},{path:"/host-access",redirect:mt("/system","host-access")},{path:"/internals",redirect:mt("/system","internals")}],ui=E_({history:i_(),routes:bg});ui.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const b=h("starting"),g=h(""),T=bg.filter(D=>D.meta),L=J(()=>["Workspace","Operate","Observe","Manage"].map(D=>({name:D,routes:T.filter(E=>E.meta.section===D)})).filter(D=>D.routes.length)),y=J(()=>{var D;return((D=ui.currentRoute.value.meta)==null?void 0:D.label)||"Odin"}),v=J(()=>{var D;return((D=ui.currentRoute.value.meta)==null?void 0:D.section)||"Management"}),x=J(()=>{var D;return((D=ui.currentRoute.value.meta)==null?void 0:D.description)||"Management console"});K.onSessionExpired=()=>{t.value=!0,We.disconnect(),K.setToken(""),e.value="login"};function w(D){var E;if((D.ctrlKey||D.metaKey)&&D.key.toLowerCase()==="k"){e.value==="ready"&&(D.preventDefault(),kd());return}if(n.value&&D.key==="Tab"){const P=[...((E=a.value)==null?void 0:E.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(P.length){const te=P[0],re=P[P.length-1];if(D.shiftKey&&(document.activeElement===te||!a.value.contains(document.activeElement))){D.preventDefault(),re.focus();return}if(!D.shiftKey&&(document.activeElement===re||!a.value.contains(document.activeElement))){D.preventDefault(),te.focus();return}}}if(D.key==="Escape"&&n.value){n.value=!1,D.preventDefault();return}if(D.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(D.target.tagName)){D.preventDefault();const P=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');P&&P.focus()}}function I(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}He(async()=>{document.addEventListener("keydown",w),r=window.matchMedia("(max-width: 900px)"),I(),r.addEventListener("change",I);const D=await K.check();D.ok?(e.value="ready",G()):D.needsAuth?e.value="login":(e.value="ready",G())});function N(){t.value=!1,e.value="ready",G()}async function k(){await K.logout(),We.disconnect(),e.value="login"}function C(){s.value=!s.value}function O(){n.value=!n.value}gs(n,async D=>{var E,P;if(D)o=document.activeElement,await St(),(P=(E=a.value)==null?void 0:E.querySelector(".nav-item"))==null||P.focus();else if(o!=null&&o.isConnected){const te=o;o=null,requestAnimationFrame(()=>te.focus())}});const B=J(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function F(D,E="info",P=3e3){f.value={text:D,level:E},clearTimeout(p),p=setTimeout(()=>{f.value=null},P)}let S=null,U=!1;function G(){We.onStatusChange=D=>{c.value=D},We.onStateChange=(D,E)=>{u.value=D,d.value=E.latency??-1,D==="connected"?(U&&F("Connection restored","success"),U=!0):D==="reconnecting"&&E.attempt===1&&F("Connection lost — reconnecting…","warn")},We.connect(),W(),S&&clearInterval(S),S=setInterval(W,15e3)}async function W(){try{const D=await K.get("/api/status");b.value=D.status==="online"?"online":"starting";const E=D.uptime_seconds||0,P=Math.floor(E/3600),te=Math.floor(E%3600/60);g.value=`${P}h ${te}m uptime`}catch{b.value="offline",g.value=""}}return gt(()=>{S&&clearInterval(S),We.disconnect(),document.removeEventListener("keydown",w),r==null||r.removeEventListener("change",I)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:B,wsToast:f,botStatus:b,botUptime:g,navRoutes:T,navGroups:L,currentPage:y,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:N,logout:k,toggleSidebar:C,toggleMobileNavigation:O,openPalette:kd}}},Tn=Al(Yw);Tn.component("odin-icon",L_);Tn.component("login-screen",Jw);Tn.component("toast-container",yx);Tn.component("confirm-host",xx);Tn.component("command-palette",N_);Tn.directive("modal-focus",D_);Tn.use(ui);Tn.mount("#app");
