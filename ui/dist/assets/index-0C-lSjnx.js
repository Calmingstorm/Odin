...
`).replace(/\n$/,""),d=vg(c,Lc.previewLines,Lc.previewChars),u=t.kind==="audit_preview"?(m=t.metadata)==null?void 0:m.source:t.metadata,f=u&&(t.kind==="process_output"||u.kind==="process_output")?`PID ${u.pid??"?"} ${u.status??""}${Number.isInteger(u.exit_code)?` exit ${u.exit_code}`:""}`.trim():t.kind==="agent_result"&&(u!=null&&u.status)?`agent ${u.status}`:"";return{promoted:r,chars:i,lines:l,envelope:o,kind:t.kind,formatted:c,preview:d,outcome:f,header:t.header,summary:n.replace(/\n/g," "),warnings:jS(t)}}const qS={name:"CompactOutput",props:{value:{default:""},rawValue:{default:void 0},label:{type:String,default:"Output"},hasContext:{type:Boolean,default:!1},recordId:{default:null}},setup(e){const t=p(!1),s=p(!0),a=p(!1),n=p(""),i=p(null),l=p(null),o=p(!1),r=H(()=>VS(e.value)),c=H(()=>{const x=e.rawValue===void 0?e.value:e.rawValue;return typeof x=="string"?x:JSON.stringify(x,null,2)??""}),d=H(()=>a.value?c.value:r.value.formatted),u=H(()=>r.value.promoted&&r.value.preview.folded||o.value),f=H(()=>t.value?!!d.value:r.value.promoted),m=H(()=>f.value?"":r.value.summary);let h;function b(){if(t.value)return;const x=r.value.promoted?i.value:l.value;o.value=!!(x&&(x.scrollHeight>x.clientHeight+1||x.scrollWidth>x.clientWidth+1))}function I(){h==null||h.disconnect();for(const x of[i.value,l.value])x&&(h==null||h.observe(x));b()}function k(){t.value=!t.value,t.value||(a.value=!1)}function y(){a.value=!a.value,t.value=!0,n.value=""}async function g(){const x=e.value;try{await navigator.clipboard.writeText(d.value),x===e.value&&(n.value="Copied")}catch{x===e.value&&(n.value="Copy unavailable — select text manually")}}return Wt([()=>e.value,()=>e.rawValue,()=>e.recordId],(x,S)=>{(e.recordId===null||x[2]!==S[2])&&(t.value=!1,a.value=!1),n.value=""}),Wt([i,l,t,s,r],()=>zt(I),{flush:"post"}),st(()=>{h=new ResizeObserver(b),I()}),xt(()=>h==null?void 0:h.disconnect()),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,previewElement:i,summaryElement:l,model:r,body:d,canExpand:u,showBody:f,headerSummary:m,toggleExpanded:k,toggleRaw:y,copyOutput:g}},template:`
...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(n.value="Copied")}catch{e.value===u&&(n.value="Copy unavailable — select text manually")}}return Wt(()=>e.value,()=>{t.value=!1,n.value=""}),Wt(a,()=>{t.value=!1,n.value=""}),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},GS={components:{ToolOutput:ec},setup(){const e=p([]),t=p([]),s=p({}),a=50;function n(f){var b,I,k,y,g,x,S,_,A,R,w;const m=f.payload||f,h=m.type||f.type;if(!(["loop_tool_start","loop_tool"].includes(h)&&!(m.agent_id||(b=m.metadata)!=null&&b.agent_id))&&!(["loop_tool_start","loop_tool"].includes(h)&&!(m.call_id||(I=m.metadata)!=null&&I.call_id))){if(h==="tool_start"||h==="loop_tool_start"){const O=m.call_id||((k=m.metadata)==null?void 0:k.call_id)||null,B=m.agent_id||((y=m.metadata)==null?void 0:y.agent_id)||"",T={callId:O,agentId:B,agentLabel:m.agent_label||((g=m.metadata)==null?void 0:g.agent_label)||"",toolInput:m.tool_input,id:O?`${B}:${O}`:`${m.action}-${Date.now()}`,tool:m.action,actor:m.actor||"",channel:m.channel_id||"",iteration:m.iteration??((x=m.metadata)==null?void 0:x.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(T);return}if(h==="tool_end"||h==="loop_tool"){const O=m.call_id||((S=m.metadata)==null?void 0:S.call_id)||null,B=m.agent_id||((_=m.metadata)==null?void 0:_.agent_id)||"";let T=-1;if(O&&(T=e.value.findIndex($=>$.callId===O&&$.agentId===B&&$.status==="running")),T<0&&!O)for(let $=e.value.length-1;$>=0;$--){const Q=e.value[$];if(Q.tool===m.action&&Q.agentId===B&&Q.status==="running"){T=$;break}}if(T>=0){const $=e.value[T];$.status=m.error||(A=m.metadata)!=null&&A.error||["error","failed","cancelled","denied","outcome_unknown"].includes(m.status||((R=m.metadata)==null?void 0:R.status))?"error":"success",$.elapsed=m.execution_time_ms??m.duration_ms??((w=m.metadata)==null?void 0:w.elapsed_ms)??Date.now()-$.startTime,$.result=m.result_summary??m.detail??"",$.fadingOut=!0,setTimeout(()=>{const Q=e.value.indexOf($);Q>=0&&e.value.splice(Q,1),t.value.unshift($),t.value.length>a&&t.value.pop()},5e3)}return}if(h==="tool_stream"){const O=m.call_id||m.tool_name||"unknown";if(m.finished){const B={...s.value};delete B[O],s.value=B}else{const T=((s.value[O]||"")+(m.chunk||"")).split(`
`);s.value={...s.value,[O]:T.slice(-30).join(`
`)}}return}}}let i=null;function l(){const f=Date.now();e.value.forEach(m=>{m.status==="running"&&(m.elapsed=f-m.startTime)})}let o=!1;function r(){o||(o=!0,ut.on("events",n),i||(i=setInterval(l,500)))}function c(){o&&(o=!1,ut.off("events",n),i&&(clearInterval(i),i=null))}st(r),rs(r),Kt(c),xt(c);function d(f){return f<1e3?`${f}ms`:`${(f/1e3).toFixed(1)}s`}function u(f){return f==="running"?"clock":f==="success"?"success":f==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
...
`),l.value=4,Se.info("Imported existing known_hosts trust. Test before activation.")}catch(N){Se.error(N.message)}}async function w(){try{const W=h.value.split(/\s+/).filter(Boolean),N={...I.value,expected_fingerprints:W,candidate_fingerprints:u.value},L=await z.post("/api/hosts/candidates",N);if(d.value=L.candidate_token,u.value=L.fingerprints||[],I.value.trust_mode==="tofu"&&N.candidate_fingerprints.length===0){I.value.confirm_tofu=!1,Se.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(W){Se.error(W.message)}}async function O(){var W,N;f.value=!1,m.value=null;try{const L=await z.post("/api/hosts/candidates/"+d.value+"/test",{});f.value=!!L.tested,m.value=L.last_test,f.value&&(l.value=5)}catch(L){const D=(W=L.data)==null?void 0:W.last_test;D&&typeof D=="object"&&!Array.isArray(D)&&(m.value=D);const re=(N=m.value)==null?void 0:N.detail;Se.error(typeof re=="string"&&re.trim()?re:L.message)}}async function B(){try{await z.post("/api/hosts/candidates/"+d.value+"/commit",{}),Se.success("Host saved and published live"),n.value=!1,await y()}catch(W){Se.error(W.message)}}async function T(W){try{await z.post("/api/hosts/"+encodeURIComponent(W.alias)+"/enabled",{enabled:!W.enabled}),await y()}catch(N){Se.error(N.message)}}async function $(W){var N;if(await os("Delete host "+W.alias+"? Dependencies will block deletion.")){a.value=[];try{await z.del("/api/hosts/"+encodeURIComponent(W.alias)),await y()}catch(L){a.value=Array.isArray((N=L.data)==null?void 0:N.pending_references)?L.data.pending_references:[],Se.error(L.message)}}}async function Q(W){if(await os("Force revoke "+W.alias+"? Remote outcomes may be unknown."))try{await z.post("/api/hosts/"+encodeURIComponent(W.alias)+"/force-revoke",{}),await y()}catch(N){Se.error(N.message)}}return st(y),{hosts:e,loading:t,error:s,pendingReferences:a,wizard:n,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:I,isLocal:k,keyInfo:c,candidate:d,observed:u,tested:f,testResult:m,fingerprintsText:h,load:y,saveSettings:g,beginAdd:S,beginEdit:_,loadKey:A,importLegacy:R,prepare:w,testConnection:O,commit:B,toggle:T,remove:$,forceRevoke:Q}}},yC={template:`
  ...
  `,setup(){const e=p(!0),t=p(""),s=p(null),a=p([]),n=p(!1),i=p(!1),l=p(null),o=p(null),r=p(!1),c=p({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=p({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=H(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:a.value),f=H(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:a.value);function m(R){return R==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":R==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function h(){e.value=!0,t.value="";try{const R=await z.get("/api/tokens");s.value=R.tokens||[],a.value=R.available_hosts||[]}catch(R){t.value=R.message||"Failed to load tokens"}finally{e.value=!1}}function b(R){return!R||!R.trim()?[]:R.split(",").map(w=>w.trim()).filter(Boolean)}function I(R,w){const O=c.value.allowed_hosts;if(w&&!O.includes(R)&&O.push(R),!w){const B=O.indexOf(R);B>=0&&O.splice(B,1)}}function k(R,w){const O=d.value.allowed_hosts;if(w&&!O.includes(R)&&O.push(R),!w){const B=O.indexOf(R);B>=0&&O.splice(B,1)}}async function y(){var R;i.value=!0;try{const w=b(c.value.allowed_tools_str),O=c.value.host_mode,B=O==="none"?[]:O==="select"?c.value.allowed_hosts:null,T={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:w.length?w:[]};B!==null&&(T.allowed_hosts=B),T.default_host=c.value.default_host||"";const $=await z.post("/api/tokens",T);l.value=$.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},n.value=!1,Se.success("Token created"),await h()}catch(w){Se.error(((R=w.data)==null?void 0:R.error)||w.message||"Failed to create token")}finally{i.value=!1}}function g(R){o.value=R;const w=R.allowed_hosts;let O="default";w==null?O="default":Array.isArray(w)&&w.length===0?O="none":Array.isArray(w)&&(O="select"),d.value={username:R.username||"",tier:R.tier||"admin",label:R.label||"",host_mode:O,allowed_hosts:Array.isArray(w)?[...w]:[],default_host:R.default_host||"",allowed_tools_str:(R.allowed_tools||[]).join(", ")}}async function x(){var R;if(o.value){r.value=!0;try{const w=b(d.value.allowed_tools_str),O=d.value.host_mode,B={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:w};O==="none"?B.allowed_hosts=[]:O==="select"?B.allowed_hosts=d.value.allowed_hosts:B.allowed_hosts=null,B.default_host=d.value.default_host||"",await z.put("/api/tokens/"+encodeURIComponent(o.value.user_id),B),o.value=null,Se.success("Token updated"),await h()}catch(w){Se.error(((R=w.data)==null?void 0:R.error)||w.message||"Failed to update")}finally{r.value=!1}}}async function S(R){var O;if(await os({title:"Regenerate token",message:`Regenerate token for ${R.username||R.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await z.post("/api/tokens/"+encodeURIComponent(R.user_id)+"/regenerate");l.value=B.token,Se.success("Token regenerated")}catch(B){Se.error(((O=B.data)==null?void 0:O.error)||B.message||"Failed to regenerate")}}async function _(R){var O;if(await os({title:"Delete token",message:`Delete token for ${R.username||R.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/tokens/"+encodeURIComponent(R.user_id)),Se.success("Token deleted"),await h()}catch(B){Se.error(((O=B.data)==null?void 0:O.error)||B.message||"Failed to delete")}}async function A(){if(l.value)try{await navigator.clipboard.writeText(l.value),Se.success("Copied to clipboard")}catch{Se.error("Copy failed — select and copy manually")}}return st(h),{loading:e,error:t,tokens:s,availableHosts:a,showCreate:n,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:f,fetchData:h,tierBadge:m,toggleCreateHost:I,toggleEditHost:k,createToken:y,startEdit:g,saveEdit:x,confirmRegenerate:S,confirmDelete:_,copyToken:A}}},xC=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort"]),_C=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),wC=Object.freeze(["enabled","base_url","model","max_tokens","num_ctx"]),kC=Object.freeze(["enabled","base_url","model","reasoning_effort"]);function po(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function Mo(e,t={}){const s=po(e,kC);return t.includeApiKey&&(s.api_key=e.api_key),s}function Pc(e){return po(e,["request_timeout_seconds","stream_stall_timeout_seconds","preset","model_profiles","context_utilization","openrouter"])}function Do(e){return po(e,xC)}function Po(e){return po(e,_C)}function $o(e,{includeApiKey:t=!1}={}){const s=po(e,wC);return t&&(s.api_key=e.api_key),s}function $c(e){return{timeout:e.timeout}}function Fo(e,t=500){let s=null;const a=(...n)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...n)},t)};return a.pending=()=>s!==null,a.cancel=()=>{s&&(clearTimeout(s),s=null)},a}const SC={template:`
  ...
  `},zf=e=>JSON.parse(JSON.stringify(e)),OC=(e,t)=>JSON.stringify(e)===JSON.stringify(t),LC={emits:["saved"],template:`
...
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const s=t[0],a=QT(s,t[3]||"",this.rules);return{type:"code",raw:s,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:a}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let s=t[2].trim();if(this.rules.other.endingHash.test(s)){const a=bl(s,"#");(this.options.pedantic||!a||this.rules.other.endingSpaceChar.test(a))&&(s=a.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:bl(t[0],`
...
${c}`:c,n=n?`${n}
${d}`:d;const u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(d,i,!0),this.lexer.state.top=u,s.length===0)break;const f=i.at(-1);if((f==null?void 0:f.type)==="code")break;if((f==null?void 0:f.type)==="blockquote"){const m=f,h=m.raw+`
`+s.join(`
`),b=this.blockquote(h);i[i.length-1]=b,a=a.substring(0,a.length-m.raw.length)+b.raw,n=n.substring(0,n.length-m.text.length)+b.text;break}else if((f==null?void 0:f.type)==="list"){const m=f,h=m.raw+`
`+s.join(`
`),b=this.list(h);i[i.length-1]=b,a=a.substring(0,a.length-f.raw.length)+b.raw,n=n.substring(0,n.length-m.raw.length)+b.raw,s=h.substring(i.at(-1).raw.length).split(`
...
`,1)[0],m=!u.trim(),h=0;if(this.options.pedantic?(h=2,d=u.trimStart()):m?h=t[1].length+1:(h=t[2].search(this.rules.other.nonSpaceChar),h=h>4?1:h,d=u.slice(h),h+=t[1].length),m&&this.rules.other.blankLine.test(f)&&(c+=f+`
`,e=e.substring(f.length+1),r=!0),!r){const k=this.rules.other.nextBulletRegex(h),y=this.rules.other.hrRegex(h),g=this.rules.other.fencesBeginRegex(h),x=this.rules.other.headingBeginRegex(h),S=this.rules.other.htmlBeginRegex(h);for(;e;){const _=e.split(`
`,1)[0];let A;if(f=_,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),A=f):A=f.replace(this.rules.other.tabCharGlobal,"    "),g.test(f)||x.test(f)||S.test(f)||k.test(f)||y.test(f))break;if(A.search(this.rules.other.nonSpaceChar)>=h||!f.trim())d+=`
`+A.slice(h);else{if(m||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||g.test(u)||x.test(u)||y.test(u))break;d+=`
`+f}!m&&!f.trim()&&(m=!0),c+=_+`
...
`+o.raw,c.text+=`
`+o.raw,this.inlineQueue.at(-1).src=c.text):this.tokens.links[o.tag]||(this.tokens.links[o.tag]={href:o.href,title:o.title});continue}if(o=this.tokenizer.table(t)){t=t.substring(o.raw.length),s.push(o);continue}if(o=this.tokenizer.lheading(t)){t=t.substring(o.raw.length),s.push(o);continue}let r=t;if((l=this.options.extensions)!=null&&l.startBlock){let c=1/0;const d=t.slice(1);let u;this.options.extensions.startBlock.forEach(f=>{u=f.call({lexer:this},d),typeof u=="number"&&u>=0&&(c=Math.min(c,u))}),c<1/0&&c>=0&&(r=t.substring(0,c+1))}if(this.state.top&&(o=this.tokenizer.paragraph(r))){const c=s.at(-1);a&&(c==null?void 0:c.type)==="paragraph"?(c.raw+=`
`+o.raw,c.text+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+Ca(s.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(s);throw s}}},Xn=new XT;function vt(e,t){return Xn.parse(e,t)}vt.options=vt.setOptions=function(e){return Xn.setOptions(e),vt.defaults=Xn.defaults,Pg(vt.defaults),vt};vt.getDefaults=Mu;vt.defaults=ii;vt.use=function(...e){return Xn.use(...e),vt.defaults=Xn.defaults,Pg(vt.defaults),vt};vt.walkTokens=function(e,t){return Xn.walkTokens(e,t)};vt.parseInline=Xn.parseInline;vt.Parser=Ja;vt.parser=Ja.parse;vt.Renderer=Tr;vt.TextRenderer=Hu;vt.Lexer=Ka;vt.lexer=Ka.lex;vt.Tokenizer=Cr;vt.Hooks=Jo;vt.parse=vt;vt.options;vt.setOptions;vt.use;vt.walkTokens;vt.parseInline;Ja.parse;Ka.lex;const eE={breaks:!0,gfm:!0};function cm(e){if(!e)return"";try{if(typeof vt<"u"&&vt.parse){const t=vt.parse(e,eE);return typeof am<"u"?am.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function tE(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),a=t.getMinutes().toString().padStart(2,"0");return`${s}:${a}`}const sE={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function aE(e){return sE[e]||"wrench"}const nE=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function dm(e){if(!e)return[];const t=e.match(nE);return t?[...new Set(t)]:[]}const iE={template:`
  ...
  `},oE={props:["onComplete"],template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=p(""),s=p(null),a=p(!1),n=p(!1);async function i(){a.value=!0,s.value=null;try{z.setPersist(n.value),await z.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{a.value=!1}}return{token:t,error:s,busy:a,persist:n,login:i}}},cE={template:`
