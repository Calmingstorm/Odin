...
`);const ne=new Blob([H],{type:"text/plain"}),_e=URL.createObjectURL(ne),Qe=document.createElement("a");Qe.href=_e,Qe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Qe.click(),URL.revokeObjectURL(_e)}function ge(H,ne){const _e=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(_e).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function ve(H){a.value=a.value===H?"":H,C.value="all"}function Le(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function T(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function P(H){C.value=H.id;const ne=H.filters;a.value=ne.level||"",v.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function W(H){C.value=H.id,a.value=H.filters.level||"",v.value=H.filters.timeRange||"",i.value=H.filters.text||""}function R(){if(!E.value.trim())return;const H={id:"custom-"+Date.now(),name:E.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};b.value=[...b.value,H],w(),x.value=!1,E.value=""}function F(H){b.value=b.value.filter(ne=>ne.id!==H),w(),C.value===H&&(C.value="all")}const Y=h("all"),Z=h(""),se=h(""),Q=h(""),$=h(""),ee=h(""),oe=h(100),be=Sw,Te=h(!1),Ae=h(!1),U=h(""),ce=h([]),ye=h(null),Me=h(null);function Je(){e.value="search",ye.value||Ke()}async function Ke(){try{ye.value=await K.get("/api/logs/stats")}catch{}}function St(){const H=ee.value;if(!H){Q.value="",$.value="";return}const _e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(_e){const Qe=new Date(Date.now()-_e*1e3);Q.value=st(Qe),$.value=""}}function st(H){const ne=_e=>String(_e).padStart(2,"0");return`${H.getFullYear()}-${ne(H.getMonth()+1)}-${ne(H.getDate())}T${ne(H.getHours())}:${ne(H.getMinutes())}`}function Ye(H){if(!H)return"";const ne=new Date(H);return isNaN(ne.getTime())?"":ne.toISOString()}async function en(){Te.value=!0,U.value="",Ae.value=!0,Me.value=null;try{const H=new URLSearchParams;Y.value&&Y.value!=="all"&&H.set("level",Y.value),Z.value&&H.set("tool",Z.value),se.value&&H.set("q",se.value);const ne=Ye(Q.value),_e=Ye($.value);ne&&H.set("start",ne),_e&&H.set("end",_e),H.set("limit",String(oe.value));const Qe=await K.get(`/api/logs/search?${H.toString()}`);ce.value=Qe.entries||[]}catch(H){U.value=H.message||"Search failed",ce.value=[]}finally{Te.value=!1}}function mn(){Y.value="all",Z.value="",se.value="",Q.value="",$.value="",ee.value="",oe.value=100,ce.value=[],Ae.value=!1,U.value="",Me.value=null}function Ai(H){Me.value=Me.value===H?null:H}function Ea(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function Ri(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function Hn(H){return H.error?"log-line-error":"text-gray-300"}function jn(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let Gt=null;return $e(()=>{N(),qe.subscribe("logs",ie),r.value=qe.connected,o.value=qe.state||"disconnected",Gt=qe.onStateChange;const H=qe.onStateChange;qe.onStateChange=(ne,_e)=>{o.value=ne,r.value=ne==="connected",H&&H(ne,_e)}}),ft(()=>{qe.unsubscribe("logs",ie),Gt!==void 0&&(qe.onStateChange=Gt)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:de,pauseBuffer:S,showJumpBottom:d,copiedIndex:f,regexError:j,levels:m,logPresets:g,timeRanges:k,timeRange:v,activeLogPreset:C,customLogPresets:b,showSaveLogPreset:x,newLogPresetName:E,hasActiveLogFilters:A,timeRangeLabel:O,timelineBuckets:L,timelineMax:J,timelineSpanLabel:B,timelineLabelSkip:V,togglePause:q,clearLogs:re,exportLogs:le,logLineClass:Le,levelClass:y,levelChipClass:T,toggleLevel:ve,copyLine:ge,jumpToBottom:ue,onScroll:Ie,applyLogPreset:P,applyCustomLogPreset:W,saveLogCustomPreset:R,removeLogCustomPreset:F,segmentHeight:D,jumpToTimelineBucket:G,searchLevel:Y,searchTool:Z,searchKeyword:se,searchStart:Q,searchEnd:$,searchTimePreset:ee,searchLimit:oe,searchLimits:be,searching:Te,searchRan:Ae,searchError:U,searchResults:ce,searchStats:ye,expandedSearch:Me,switchToSearch:Je,runSearch:en,clearSearchFilters:mn,toggleSearchExpand:Ai,formatSearchTs:Ea,searchEntryText:Ri,searchLogLineClass:Hn,formatJson:jn,applySearchTimePreset:St}}},Cw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Ew={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Aw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1“128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Fr=[{key:"core",label:"Core",icon:"⚙",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"🧠",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"💾",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"🔗",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"🛠",sections:["tools"]},{key:"ui",label:"Web UI",icon:"🌐",sections:["web"]},{key:"automation",label:"Automation",icon:"🔄",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"🔌",sections:["issue_tracker"]}],og="••••••••",Rw=50;function Iw(e){return Cw.has(e)}function Nw(e){return e===og}function Gi(e){return JSON.parse(JSON.stringify(e))}function Nn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Dw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Nn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Ow(e,t,s){const n=Aw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Md(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Nn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Lw={template:`
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=te(()=>{const I={};for(const D of u.value)I[D.id]=D;return I});function p(I){return f.value[I]||null}const m=te(()=>/^\d{15,25}$/.test(r.value.trim())),g=te(()=>{const I=r.value.toLowerCase().trim();return I?u.value.filter(D=>!i.value[D.id]&&(D.display_name.toLowerCase().includes(I)||D.username.toLowerCase().includes(I)||D.id.includes(I))):u.value.filter(D=>!i.value[D.id])});function k(I,D){return I?I.allowed_hosts===null||I.allowed_hosts===void 0?{allowed_hosts:[...D],default_host:I.default_host||"",allow_all:!0}:{allowed_hosts:I.allowed_hosts,default_host:I.default_host||"",allow_all:!1}:{allowed_hosts:[...D],default_host:D[0]||"",allow_all:!0}}async function C(){e.value=!0,t.value="";try{const I=await K.get("/api/host-access");s.value=I,n.value=I.available_hosts||[],a.value=k(I.default_policy,n.value);const D=I.users||{},G={};for(const[de,me]of Object.entries(D))G[de]=k(me,n.value);i.value=G}catch(I){t.value=I.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await K.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const I=a.value.allow_all?null:a.value.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:I,default_host:a.value.default_host}),xe.success("Default policy updated")}catch(I){xe.error(I.message||"Failed to save")}}function b(I,D){a.value.allow_all=!1,D?a.value.allowed_hosts.includes(I)||a.value.allowed_hosts.push(I):(a.value.allowed_hosts=a.value.allowed_hosts.filter(G=>G!==I),a.value.default_host===I&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function x(I){const D=i.value[I];if(D)try{const G=D.allow_all?null:D.allowed_hosts;await K.put(`/api/host-access/user/${I}`,{allowed_hosts:G,default_host:D.default_host});const de=p(I);xe.success(`Updated access for ${de?de.display_name:I}`)}catch(G){xe.error(G.message||"Failed to save")}}function E(I,D,G){const de=i.value[I];de&&(de.allow_all=!1,G?de.allowed_hosts.includes(D)||de.allowed_hosts.push(D):(de.allowed_hosts=de.allowed_hosts.filter(me=>me!==D),de.default_host===D&&(de.default_host=de.allowed_hosts[0]||"")),x(I))}function S(I,D){const G=i.value[I];G&&(G.default_host=D,x(I))}function N(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function w(){o.value=!0,c.value=0}function A(){c.value<g.value.length-1&&c.value++}function O(){c.value>0&&c.value--}function j(){const I=g.value[c.value];if(I){L(I);return}m.value&&M()}function M(){const I=r.value.trim();/^\d{15,25}$/.test(I)&&(i.value[I]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(I),r.value="",o.value=!1,l.value=!1)}function L(I){i.value[I.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(I.id),r.value="",o.value=!1,l.value=!1}function J(){o.value=!1}function B(){setTimeout(()=>{o.value=!1},150)}async function V(I){const D=p(I);if(await ns({title:"Remove user override",message:`Remove the host access override for ${D?D.display_name:I}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await K.del(`/api/host-access/user/${I}`),delete i.value[I],xe.success(`Removed override for ${D?D.display_name:I}`)}catch(de){xe.error(de.message||"Failed to delete")}}return $e(C),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:g,isRawId:m,searchInput:d,fetchData:C,saveDefaultPolicy:v,toggleDefaultHost:b,getMember:p,toggleUserHost:E,setUserDefault:S,openAddUser:N,deleteUser:V,onSearchInput:w,highlightNext:A,highlightPrev:O,selectHighlighted:j,selectMember:L,closeDropdown:J,onBlur:B,addRawId:M}}},Fw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium"}),a=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),i=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),l=h(!1),r=h(!1),o=h(!1),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h({configured:!1}),m=h([]),g=h(""),k=h(!1),C=h(!1),v=h({configured:!1}),b=h([]),x=h(""),E=h(!1),S=h(!1),N=h(!0),w=h(""),A=h({configured:!1,accounts:[]}),O=h(null),j=h(null),M=h(""),L=h(null),J=h(!1),B=h(null),V=h(null),I=h("");let D=null;function G($,ee="success"){xe($,ee==="error"?"error":"success")}function de($){if(!$)return"?";const ee=$/(1024*1024*1024);return ee>=1?ee.toFixed(1)+" GB":($/(1024*1024)).toFixed(0)+" MB"}async function me(){e.value=!0,await Promise.all([ie(),pe(),le(),X()]),e.value=!1}async function ie(){try{const $=await K.get("/api/llm/status");t.value=$,s.value=$.active_provider||"codex",$.codex&&(n.value.enabled=$.codex.enabled,n.value.model=$.codex.model||"gpt-5.5",n.value.reasoning_effort=$.codex.reasoning_effort||"medium",n.value.max_tokens=$.codex.max_tokens||4096),$.ollama&&(a.value.enabled=$.ollama.enabled,a.value.base_url=$.ollama.base_url||"",a.value.model=$.ollama.model||"",a.value.max_tokens=$.ollama.max_tokens||4096),$.kimi&&(i.value.enabled=$.kimi.enabled,i.value.model=$.kimi.model||"",i.value.max_tokens=$.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function pe(){try{if(p.value=await K.get("/api/ollama/status"),p.value.model&&(g.value=p.value.model),p.value.configured)try{const $=await K.get("/api/ollama/models");m.value=$.models||[]}catch{m.value=[]}else if(a.value.base_url)try{const $=await K.post("/api/ollama/probe-models",{base_url:a.value.base_url});m.value=$.models||[]}catch{m.value=[]}}catch{p.value={configured:!1}}}async function X(){N.value=!0,w.value="";try{A.value=await K.get("/api/codex/status")}catch($){w.value=$.message||"Failed to fetch Codex status"}finally{N.value=!1}}async function ue(){const $=t.value?t.value.active_provider:"codex";f.value=!0;try{const ee=await K.post("/api/llm/switch",{provider:s.value});ee.error?(s.value=$,G(ee.error,"error")):(G("Switched to "+s.value+" ("+ee.model+")"),await me())}catch(ee){s.value=$,G(ee.message||"Switch failed","error")}finally{f.value=!1}}async function Ie(){k.value=!0;try{const $=await K.post("/api/ollama/reload");G($.configured?"Ollama reloaded":$.reason||"Ollama not configured",$.configured?"success":"error"),await me()}catch($){G($.message||"Reload failed","error")}finally{k.value=!1}}async function q(){C.value=!0;try{await K.post("/api/ollama/model",{model:g.value}),G("Model set to "+g.value),await me()}catch($){G($.message||"Failed","error")}finally{C.value=!1}}async function re(){const $=a.value.base_url;if(!$){G("Enter a base URL first","error");return}d.value=!0;try{const ee=await K.post("/api/ollama/probe-models",{base_url:$});m.value=ee.models||[],m.value.length?(G(m.value.length+" model(s) found"),!a.value.model&&m.value.length&&(a.value.model=m.value[0].name)):G("No models found at "+$,"error")}catch(ee){G(ee.message||"Could not reach Ollama","error")}finally{d.value=!1}}async function le(){try{if(v.value=await K.get("/api/kimi/status"),v.value.model&&(x.value=v.value.model),v.value.configured)try{const $=await K.get("/api/kimi/models");b.value=$.models||[]}catch{b.value=[]}}catch{v.value={configured:!1}}}async function ge(){E.value=!0;try{const $=await K.post("/api/kimi/reload");G($.configured?"Kimi reloaded":$.reason||"Kimi not configured",$.configured?"success":"error"),await me()}catch($){G($.message||"Reload failed","error")}finally{E.value=!1}}async function ve(){S.value=!0;try{await K.post("/api/kimi/model",{model:x.value}),G("Model set to "+x.value),await me()}catch($){G($.message||"Failed","error")}finally{S.value=!1}}async function Le(){o.value=!0;try{await K.put("/api/llm/codex/config",n.value),G("Codex config saved"),await me()}catch($){G($.message||"Failed","error"),await me()}finally{o.value=!1}}async function y(){c.value=!0;try{const $={...a.value};l.value||delete $.api_key,await K.put("/api/llm/ollama/config",$),G("Ollama config saved"),a.value.api_key="",l.value=!1,await me()}catch($){G($.message||"Failed","error")}finally{c.value=!1}}async function T(){u.value=!0;try{const $={...i.value};r.value||delete $.api_key,await K.put("/api/llm/kimi/config",$),G("Kimi config saved"),i.value.api_key="",r.value=!1,await me()}catch($){G($.message||"Failed","error")}finally{u.value=!1}}async function P($){try{await K.post("/api/codex/account/"+$+"/activate"),G("Active account switched"),await X()}catch(ee){G(ee.message||"Failed","error")}}async function W($){O.value=$;try{await K.post("/api/codex/account/"+$+"/refresh"),G("Token refreshed"),await X()}catch(ee){G(ee.message||"Refresh failed","error")}finally{O.value=null}}function R($,ee){j.value=$,M.value=ee||""}async function F($){try{await K.put("/api/codex/account/"+$+"/label",{label:M.value}),G("Label updated"),j.value=null,await X()}catch(ee){G(ee.message||"Failed","error")}}async function Y($,ee){if(await ns({title:"Delete Codex account",message:`Delete ${ee||"account #"+($+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+$),G("Deleted. Pool reloaded."),await X()}catch(be){G(be.message||"Failed","error")}}async function Z(){J.value=!0;try{const $=await K.post("/api/codex/device-code");B.value=$,L.value="pending",se($)}catch($){G($.message||"Failed","error")}finally{J.value=!1}}async function se($){D={cancelled:!1};const ee=D;try{const oe=await K.post("/api/codex/device-poll",{device_auth_id:$.device_auth_id,user_code:$.user_code,interval:$.interval});if(ee.cancelled)return;V.value=oe,L.value="success",await me()}catch(oe){if(ee.cancelled)return;I.value=oe.message||"Device login failed",L.value="error"}}function Q(){D&&(D.cancelled=!0),L.value=null,B.value=null}return $e(me),ft(()=>{D&&(D.cancelled=!0)}),{loading:e,llmStatus:t,selectedProvider:s,switching:f,codexForm:n,ollamaForm:a,kimiForm:i,savingCodex:o,savingOllama:c,savingKimi:u,probingOllama:d,ollamaKeyDirty:l,kimiKeyDirty:r,ollamaStatus:p,ollamaModels:m,ollamaSelectedModel:g,reloading:k,settingModel:C,kimiStatus:v,kimiModels:b,kimiSelectedModel:x,reloadingKimi:E,settingKimiModel:S,codexLoading:N,codexError:w,codexData:A,refreshing:O,editingLabel:j,labelValue:M,deviceState:L,deviceLoading:J,deviceInfo:B,deviceResult:V,deviceError:I,fetchAll:me,switchProvider:ue,reloadOllama:Ie,setOllamaModel:q,reloadKimi:ge,setKimiModel:ve,probeOllamaModels:re,saveCodexConfig:Le,saveOllamaConfig:y,saveKimiConfig:T,activateAccount:P,refreshAccount:W,startEditLabel:R,saveLabel:F,deleteAccount:Y,startDeviceLogin:Z,cancelDeviceLogin:Q,formatSize:de}}},Fd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Bw(e){return Fd[e]||Fd[(e||"").toLowerCase()]||"text-gray-400"}const Uw={template:`
