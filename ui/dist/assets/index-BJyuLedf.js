var _g=Object.defineProperty;var kg=(e,t,s)=>t in e?_g(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var We=(e,t,s)=>kg(e,typeof t!="symbol"?t+"":t,s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();class wg{constructor(){this._persist=localStorage.getItem("odin_persist")==="1",this._token=this._persist?localStorage.getItem("odin_token")||"":sessionStorage.getItem("odin_token")||"";const t=this._persist?localStorage:sessionStorage;this._sessionTimeout=parseInt(t.getItem("odin_session_timeout")||"0",10),this._lastActivity=Date.now(),this._activityTimer=null,this.onSessionExpired=null,this._token&&this._sessionTimeout>0&&this._startActivityMonitor()}get token(){return this._token}get sessionTimeout(){return this._sessionTimeout}setToken(t,s=0){if(this._token=t,this._sessionTimeout=s,this._lastActivity=Date.now(),t){const n=this._persist?localStorage:sessionStorage;n.setItem("odin_token",t),this._persist&&localStorage.setItem("odin_persist","1"),s>0?n.setItem("odin_session_timeout",String(s)):n.removeItem("odin_session_timeout"),this._startActivityMonitor()}else sessionStorage.removeItem("odin_token"),sessionStorage.removeItem("odin_session_timeout"),localStorage.removeItem("odin_token"),localStorage.removeItem("odin_persist"),localStorage.removeItem("odin_session_timeout"),this._stopActivityMonitor()}setPersist(t){this._persist=t}_startActivityMonitor(){this._stopActivityMonitor(),!(this._sessionTimeout<=0)&&(this._activityTimer=setInterval(()=>{(Date.now()-this._lastActivity)/1e3>=this._sessionTimeout&&(this._stopActivityMonitor(),this.onSessionExpired&&this.onSessionExpired())},1e4))}_stopActivityMonitor(){this._activityTimer&&(clearInterval(this._activityTimer),this._activityTimer=null)}_headers(t={}){const s={"Content-Type":"application/json",...t};return this._token&&(s.Authorization=`Bearer ${this._token}`),s}async _request(t,s,n=null){this._lastActivity=Date.now();const a={method:t,headers:this._headers()};n!==null&&(a.body=JSON.stringify(n));const i=await fetch(s,a);if(i.status===401)throw new dr("Unauthorized");const l=await i.json().catch(()=>null);if(!i.ok){const r=(l==null?void 0:l.error)||`HTTP ${i.status}`;throw new Sg(r,i.status,l)}return l}get(t){return this._request("GET",t)}post(t,s){return this._request("POST",t,s)}put(t,s){return this._request("PUT",t,s)}del(t){return this._request("DELETE",t)}async login(t){const s=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})}),n=await s.json().catch(()=>null);if(!s.ok)throw new dr((n==null?void 0:n.error)||"Login failed");return this.setToken(n.session_id,n.timeout_seconds||0),n}async logout(){try{await this.post("/api/auth/logout",{})}catch{}this.setToken("")}async check(){try{return await this.get("/api/status"),{ok:!0,needsAuth:!1}}catch(t){return t instanceof dr?{ok:!1,needsAuth:!0}:{ok:!1,needsAuth:!1,error:t.message}}}}class dr extends Error{constructor(t){super(t),this.name="AuthError"}}class Sg extends Error{constructor(t,s,n){super(t),this.name="ApiError",this.status=s,this.data=n}}class Tg{constructor(t){this._api=t,this._ws=null,this._handlers={logs:[],events:[],chat:[]},this._reconnectDelay=1e3,this._maxReconnectDelay=3e4,this._shouldConnect=!1,this._subscriptions=new Set,this._reconnectAttempt=0,this._lastPongTime=0,this._pingInterval=null,this._latency=-1,this._state="disconnected",this.onStatusChange=null,this.onStateChange=null}get connected(){var t;return((t=this._ws)==null?void 0:t.readyState)===WebSocket.OPEN}get state(){return this._state}get reconnectAttempt(){return this._reconnectAttempt}get latency(){return this._latency}connect(){this._shouldConnect=!0,this._setState("connecting"),this._open()}disconnect(){this._shouldConnect=!1,this._reconnectAttempt=0,this._latency=-1,this._stopPing(),this._ws&&(this._ws.close(),this._ws=null),this._setState("disconnected")}_setState(t){this._state!==t&&(this._state=t,this.onStateChange&&this.onStateChange(t,{attempt:this._reconnectAttempt,latency:this._latency}))}_startPing(){this._stopPing(),this._pingInterval=setInterval(()=>{if(this.connected)try{this._ws.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}},15e3)}_stopPing(){this._pingInterval&&(clearInterval(this._pingInterval),this._pingInterval=null)}subscribe(t,s){this._handlers[t]||(this._handlers[t]=[]),this._handlers[t].push(s),t!=="chat"&&(this._subscriptions.add(t),this.connected&&this._ws.send(JSON.stringify({subscribe:t})))}unsubscribe(t,s){const n=this._handlers[t];if(n){const a=n.indexOf(s);a>=0&&n.splice(a,1),n.length===0&&t!=="chat"&&(this._subscriptions.delete(t),this.connected&&this._ws.send(JSON.stringify({unsubscribe:t})))}}on(t,s){return this.subscribe(t,s)}off(t,s){return this.unsubscribe(t,s)}sendChat(t,{channelId:s,userId:n,username:a}={}){return this.connected?(this._ws.send(JSON.stringify({type:"chat",content:t,channel_id:s||"web-default",user_id:n||void 0,username:a||void 0})),!0):!1}_open(){if(this._ws)return;let s=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/api/ws`;this._api.token&&(s+=`?token=${encodeURIComponent(this._api.token)}`),this._ws=new WebSocket(s),this._ws.onopen=()=>{this._reconnectDelay=1e3,this._reconnectAttempt=0;for(const n of this._subscriptions)this._ws.send(JSON.stringify({subscribe:n}));this._startPing(),this._setState("connected"),this.onStatusChange&&this.onStatusChange(!0)},this._ws.onmessage=n=>{let a;try{a=JSON.parse(n.data)}catch{return}const i=a.type;if(i==="pong"){a.ts&&(this._latency=Date.now()-a.ts,this._lastPongTime=Date.now());return}if(i==="log")for(const l of this._handlers.logs||[])l(a);else if(i==="event")for(const l of this._handlers.events||[])l(a);else if(i==="chat_response"||i==="chat_error")for(const l of this._handlers.chat||[])l(a)},this._ws.onclose=()=>{this._ws=null,this._stopPing(),this._latency=-1,this.onStatusChange&&this.onStatusChange(!1),this._shouldConnect?(this._reconnectAttempt++,this._setState("reconnecting"),setTimeout(()=>this._open(),this._reconnectDelay),this._reconnectDelay=Math.min(this._reconnectDelay*2,this._maxReconnectDelay)):this._setState("disconnected")},this._ws.onerror=()=>{}}}const K=new wg,ze=new Tg(K);/**
* @vue/shared v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function as(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const Pe={},na=[],It=()=>{},ta=()=>!1,Mn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Dl=e=>e.startsWith("onUpdate:"),Oe=Object.assign,wo=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Cg=Object.prototype.hasOwnProperty,He=(e,t)=>Cg.call(e,t),fe=Array.isArray,aa=e=>Sa(e)==="[object Map]",Fn=e=>Sa(e)==="[object Set]",qc=e=>Sa(e)==="[object Date]",Eg=e=>Sa(e)==="[object RegExp]",ke=e=>typeof e=="function",Te=e=>typeof e=="string",$t=e=>typeof e=="symbol",Ue=e=>e!==null&&typeof e=="object",So=e=>(Ue(e)||ke(e))&&ke(e.then)&&ke(e.catch),Vd=Object.prototype.toString,Sa=e=>Vd.call(e),Ag=e=>Sa(e).slice(8,-1),Ol=e=>Sa(e)==="[object Object]",Ll=e=>Te(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,zs=as(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Rg=as("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),Pl=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Ig=/-\w/g,Ke=Pl(e=>e.replace(Ig,t=>t.slice(1).toUpperCase())),Ng=/\B([A-Z])/g,Yt=Pl(e=>e.replace(Ng,"-$1").toLowerCase()),$n=Pl(e=>e.charAt(0).toUpperCase()+e.slice(1)),ia=Pl(e=>e?`on${$n(e)}`:""),kt=(e,t)=>!Object.is(e,t),la=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},jd=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Ml=e=>{const t=parseFloat(e);return isNaN(t)?e:t},sl=e=>{const t=Te(e)?Number(e):NaN;return isNaN(t)?e:t};let Kc;const Fl=()=>Kc||(Kc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Dg(e,t){return e+JSON.stringify(t,(s,n)=>typeof n=="function"?n.toString():n)}const Og="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol",Lg=as(Og);function yi(e){if(fe(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],a=Te(n)?zd(n):yi(n);if(a)for(const i in a)t[i]=a[i]}return t}else if(Te(e)||Ue(e))return e}const Pg=/;(?![^(]*\))/g,Mg=/:([^]+)/,Fg=/\/\*[^]*?\*\//g;function zd(e){const t={};return e.replace(Fg,"").split(Pg).forEach(s=>{if(s){const n=s.split(Mg);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function xi(e){let t="";if(Te(e))t=e;else if(fe(e))for(let s=0;s<e.length;s++){const n=xi(e[s]);n&&(t+=n+" ")}else if(Ue(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function $g(e){if(!e)return null;let{class:t,style:s}=e;return t&&!Te(t)&&(e.class=xi(t)),s&&(e.style=yi(s)),e}const Bg="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",Ug="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",Hg="annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics",Vg="area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr",jg=as(Bg),zg=as(Ug),qg=as(Hg),Kg=as(Vg),Gg="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Wg=as(Gg);function qd(e){return!!e||e===""}function Jg(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=Ws(e[n],t[n]);return s}function Ws(e,t){if(e===t)return!0;let s=qc(e),n=qc(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=$t(e),n=$t(t),s||n)return e===t;if(s=fe(e),n=fe(t),s||n)return s&&n?Jg(e,t):!1;if(s=Ue(e),n=Ue(t),s||n){if(!s||!n)return!1;const a=Object.keys(e).length,i=Object.keys(t).length;if(a!==i)return!1;for(const l in e){const r=e.hasOwnProperty(l),o=t.hasOwnProperty(l);if(r&&!o||!r&&o||!Ws(e[l],t[l]))return!1}}return String(e)===String(t)}function $l(e,t){return e.findIndex(s=>Ws(s,t))}const Kd=e=>!!(e&&e.__v_isRef===!0),Gd=e=>Te(e)?e:e==null?"":fe(e)||Ue(e)&&(e.toString===Vd||!ke(e.toString))?Kd(e)?Gd(e.value):JSON.stringify(e,Wd,2):String(e),Wd=(e,t)=>Kd(t)?Wd(e,t.value):aa(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,a],i)=>(s[fr(n,i)+" =>"]=a,s),{})}:Fn(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>fr(s))}:$t(t)?fr(t):Ue(t)&&!fe(t)&&!Ol(t)?String(t):t,fr=(e,t="")=>{var s;return $t(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};function Zg(e){return e==null?"initial":typeof e=="string"?e===""?" ":e:String(e)}/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let yt;class To{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&yt&&(yt.active?(this.parent=yt,this.index=(yt.scopes||(yt.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=yt;try{return yt=this,t()}finally{yt=s}}}on(){++this._on===1&&(this.prevScope=yt,yt=this)}off(){if(this._on>0&&--this._on===0){if(yt===this)yt=this.prevScope;else{let t=yt;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0}}}function Yg(e){return new To(e)}function Jd(){return yt}function Qg(e,t=!1){yt&&yt.cleanups.push(e)}let Xe;const pr=new WeakSet;class ti{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,yt&&(yt.active?yt.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,pr.has(this)&&(pr.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Yd(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Gc(this),Qd(this);const t=Xe,s=ms;Xe=this,ms=!0;try{return this.fn()}finally{Xd(this),Xe=t,ms=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Ao(t);this.deps=this.depsTail=void 0,Gc(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?pr.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Hr(this)&&this.run()}get dirty(){return Hr(this)}}let Zd=0,qa,Ka;function Yd(e,t=!1){if(e.flags|=8,t){e.next=Ka,Ka=e;return}e.next=qa,qa=e}function Co(){Zd++}function Eo(){if(--Zd>0)return;if(Ka){let t=Ka;for(Ka=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;qa;){let t=qa;for(qa=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function Qd(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function Xd(e){let t,s=e.depsTail,n=s;for(;n;){const a=n.prevDep;n.version===-1?(n===s&&(s=a),Ao(n),Xg(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=a}e.deps=t,e.depsTail=s}function Hr(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(ef(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function ef(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===si)||(e.globalVersion=si,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Hr(e))))return;e.flags|=2;const t=e.dep,s=Xe,n=ms;Xe=e,ms=!0;try{Qd(e);const a=e.fn(e._value);(t.version===0||kt(a,e._value))&&(e.flags|=128,e._value=a,t.version++)}catch(a){throw t.version++,a}finally{Xe=s,ms=n,Xd(e),e.flags&=-3}}function Ao(e,t=!1){const{dep:s,prevSub:n,nextSub:a}=e;if(n&&(n.nextSub=a,e.prevSub=void 0),a&&(a.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let i=s.computed.deps;i;i=i.nextDep)Ao(i,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function Xg(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}function em(e,t){e.effect instanceof ti&&(e=e.effect.fn);const s=new ti(e);t&&Oe(s,t);try{s.run()}catch(a){throw s.stop(),a}const n=s.run.bind(s);return n.effect=s,n}function tm(e){e.effect.stop()}let ms=!0;const tf=[];function Js(){tf.push(ms),ms=!1}function Zs(){const e=tf.pop();ms=e===void 0?!0:e}function Gc(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=Xe;Xe=void 0;try{t()}finally{Xe=s}}}let si=0;class sm{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Bl{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!Xe||!ms||Xe===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==Xe)s=this.activeLink=new sm(Xe,this),Xe.deps?(s.prevDep=Xe.depsTail,Xe.depsTail.nextDep=s,Xe.depsTail=s):Xe.deps=Xe.depsTail=s,sf(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=Xe.depsTail,s.nextDep=void 0,Xe.depsTail.nextDep=s,Xe.depsTail=s,Xe.deps===s&&(Xe.deps=n)}return s}trigger(t){this.version++,si++,this.notify(t)}notify(t){Co();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Eo()}}}function sf(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)sf(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const nl=new WeakMap,Cn=Symbol(""),Vr=Symbol(""),ni=Symbol("");function Pt(e,t,s){if(ms&&Xe){let n=nl.get(e);n||nl.set(e,n=new Map);let a=n.get(s);a||(n.set(s,a=new Bl),a.map=n,a.key=s),a.track()}}function Bs(e,t,s,n,a,i){const l=nl.get(e);if(!l){si++;return}const r=o=>{o&&o.trigger()};if(Co(),t==="clear")l.forEach(r);else{const o=fe(e),c=o&&Ll(s);if(o&&s==="length"){const u=Number(n);l.forEach((d,f)=>{(f==="length"||f===ni||!$t(f)&&f>=u)&&r(d)})}else switch((s!==void 0||l.has(void 0))&&r(l.get(s)),c&&r(l.get(ni)),t){case"add":o?c&&r(l.get("length")):(r(l.get(Cn)),aa(e)&&r(l.get(Vr)));break;case"delete":o||(r(l.get(Cn)),aa(e)&&r(l.get(Vr)));break;case"set":aa(e)&&r(l.get(Cn));break}}Eo()}function nm(e,t){const s=nl.get(e);return s&&s.get(t)}function Kn(e){const t=Fe(e);return t===e?t:(Pt(t,"iterate",ni),Xt(e)?t:t.map(bs))}function Ul(e){return Pt(e=Fe(e),"iterate",ni),e}function Cs(e,t){return As(e)?fa(qs(e)?bs(t):t):bs(t)}const am={__proto__:null,[Symbol.iterator](){return hr(this,Symbol.iterator,e=>Cs(this,e))},concat(...e){return Kn(this).concat(...e.map(t=>fe(t)?Kn(t):t))},entries(){return hr(this,"entries",e=>(e[1]=Cs(this,e[1]),e))},every(e,t){return Ns(this,"every",e,t,void 0,arguments)},filter(e,t){return Ns(this,"filter",e,t,s=>s.map(n=>Cs(this,n)),arguments)},find(e,t){return Ns(this,"find",e,t,s=>Cs(this,s),arguments)},findIndex(e,t){return Ns(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return Ns(this,"findLast",e,t,s=>Cs(this,s),arguments)},findLastIndex(e,t){return Ns(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return Ns(this,"forEach",e,t,void 0,arguments)},includes(...e){return gr(this,"includes",e)},indexOf(...e){return gr(this,"indexOf",e)},join(e){return Kn(this).join(e)},lastIndexOf(...e){return gr(this,"lastIndexOf",e)},map(e,t){return Ns(this,"map",e,t,void 0,arguments)},pop(){return Na(this,"pop")},push(...e){return Na(this,"push",e)},reduce(e,...t){return Wc(this,"reduce",e,t)},reduceRight(e,...t){return Wc(this,"reduceRight",e,t)},shift(){return Na(this,"shift")},some(e,t){return Ns(this,"some",e,t,void 0,arguments)},splice(...e){return Na(this,"splice",e)},toReversed(){return Kn(this).toReversed()},toSorted(e){return Kn(this).toSorted(e)},toSpliced(...e){return Kn(this).toSpliced(...e)},unshift(...e){return Na(this,"unshift",e)},values(){return hr(this,"values",e=>Cs(this,e))}};function hr(e,t,s){const n=Ul(e),a=n[t]();return n!==e&&!Xt(e)&&(a._next=a.next,a.next=()=>{const i=a._next();return i.done||(i.value=s(i.value)),i}),a}const im=Array.prototype;function Ns(e,t,s,n,a,i){const l=Ul(e),r=l!==e&&!Xt(e),o=l[t];if(o!==im[t]){const d=o.apply(e,i);return r?bs(d):d}let c=s;l!==e&&(r?c=function(d,f){return s.call(this,Cs(e,d),f,e)}:s.length>2&&(c=function(d,f){return s.call(this,d,f,e)}));const u=o.call(l,c,n);return r&&a?a(u):u}function Wc(e,t,s,n){const a=Ul(e),i=a!==e&&!Xt(e);let l=s,r=!1;a!==e&&(i?(r=n.length===0,l=function(c,u,d){return r&&(r=!1,c=Cs(e,c)),s.call(this,c,Cs(e,u),d,e)}):s.length>3&&(l=function(c,u,d){return s.call(this,c,u,d,e)}));const o=a[t](l,...n);return r?Cs(e,o):o}function gr(e,t,s){const n=Fe(e);Pt(n,"iterate",ni);const a=n[t](...s);return(a===-1||a===!1)&&_i(s[0])?(s[0]=Fe(s[0]),n[t](...s)):a}function Na(e,t,s=[]){Js(),Co();const n=Fe(e)[t].apply(e,s);return Eo(),Zs(),n}const lm=as("__proto__,__v_isRef,__isVue"),nf=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter($t));function rm(e){$t(e)||(e=String(e));const t=Fe(this);return Pt(t,"has",e),t.hasOwnProperty(e)}class af{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const a=this._isReadonly,i=this._isShallow;if(s==="__v_isReactive")return!a;if(s==="__v_isReadonly")return a;if(s==="__v_isShallow")return i;if(s==="__v_raw")return n===(a?i?df:uf:i?cf:of).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const l=fe(t);if(!a){let o;if(l&&(o=am[s]))return o;if(s==="hasOwnProperty")return rm}const r=Reflect.get(t,s,gt(t)?t:n);if(($t(s)?nf.has(s):lm(s))||(a||Pt(t,"get",s),i))return r;if(gt(r)){const o=l&&Ll(s)?r:r.value;return a&&Ue(o)?al(o):o}return Ue(r)?a?al(r):gn(r):r}}class lf extends af{constructor(t=!1){super(!1,t)}set(t,s,n,a){let i=t[s];const l=fe(t)&&Ll(s);if(!this._isShallow){const c=As(i);if(!Xt(n)&&!As(n)&&(i=Fe(i),n=Fe(n)),!l&&gt(i)&&!gt(n))return c||(i.value=n),!0}const r=l?Number(s)<t.length:He(t,s),o=Reflect.set(t,s,n,gt(t)?t:a);return t===Fe(a)&&(r?kt(n,i)&&Bs(t,"set",s,n):Bs(t,"add",s,n)),o}deleteProperty(t,s){const n=He(t,s);t[s];const a=Reflect.deleteProperty(t,s);return a&&n&&Bs(t,"delete",s,void 0),a}has(t,s){const n=Reflect.has(t,s);return(!$t(s)||!nf.has(s))&&Pt(t,"has",s),n}ownKeys(t){return Pt(t,"iterate",fe(t)?"length":Cn),Reflect.ownKeys(t)}}class rf extends af{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const om=new lf,cm=new rf,um=new lf(!0),dm=new rf(!0),jr=e=>e,Li=e=>Reflect.getPrototypeOf(e);function fm(e,t,s){return function(...n){const a=this.__v_raw,i=Fe(a),l=aa(i),r=e==="entries"||e===Symbol.iterator&&l,o=e==="keys"&&l,c=a[e](...n),u=s?jr:t?fa:bs;return!t&&Pt(i,"iterate",o?Vr:Cn),Oe(Object.create(c),{next(){const{value:d,done:f}=c.next();return f?{value:d,done:f}:{value:r?[u(d[0]),u(d[1])]:u(d),done:f}}})}}function Pi(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function pm(e,t){const s={get(a){const i=this.__v_raw,l=Fe(i),r=Fe(a);e||(kt(a,r)&&Pt(l,"get",a),Pt(l,"get",r));const{has:o}=Li(l),c=t?jr:e?fa:bs;if(o.call(l,a))return c(i.get(a));if(o.call(l,r))return c(i.get(r));i!==l&&i.get(a)},get size(){const a=this.__v_raw;return!e&&Pt(Fe(a),"iterate",Cn),a.size},has(a){const i=this.__v_raw,l=Fe(i),r=Fe(a);return e||(kt(a,r)&&Pt(l,"has",a),Pt(l,"has",r)),a===r?i.has(a):i.has(a)||i.has(r)},forEach(a,i){const l=this,r=l.__v_raw,o=Fe(r),c=t?jr:e?fa:bs;return!e&&Pt(o,"iterate",Cn),r.forEach((u,d)=>a.call(i,c(u),c(d),l))}};return Oe(s,e?{add:Pi("add"),set:Pi("set"),delete:Pi("delete"),clear:Pi("clear")}:{add(a){const i=Fe(this),l=Li(i),r=Fe(a),o=!t&&!Xt(a)&&!As(a)?r:a;return l.has.call(i,o)||kt(a,o)&&l.has.call(i,a)||kt(r,o)&&l.has.call(i,r)||(i.add(o),Bs(i,"add",o,o)),this},set(a,i){!t&&!Xt(i)&&!As(i)&&(i=Fe(i));const l=Fe(this),{has:r,get:o}=Li(l);let c=r.call(l,a);c||(a=Fe(a),c=r.call(l,a));const u=o.call(l,a);return l.set(a,i),c?kt(i,u)&&Bs(l,"set",a,i):Bs(l,"add",a,i),this},delete(a){const i=Fe(this),{has:l,get:r}=Li(i);let o=l.call(i,a);o||(a=Fe(a),o=l.call(i,a)),r&&r.call(i,a);const c=i.delete(a);return o&&Bs(i,"delete",a,void 0),c},clear(){const a=Fe(this),i=a.size!==0,l=a.clear();return i&&Bs(a,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(a=>{s[a]=fm(a,e,t)}),s}function Hl(e,t){const s=pm(e,t);return(n,a,i)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?n:Reflect.get(He(s,a)&&a in n?s:n,a,i)}const hm={get:Hl(!1,!1)},gm={get:Hl(!1,!0)},mm={get:Hl(!0,!1)},vm={get:Hl(!0,!0)},of=new WeakMap,cf=new WeakMap,uf=new WeakMap,df=new WeakMap;function bm(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function gn(e){return As(e)?e:Vl(e,!1,om,hm,of)}function Ro(e){return Vl(e,!1,um,gm,cf)}function al(e){return Vl(e,!0,cm,mm,uf)}function ym(e){return Vl(e,!0,dm,vm,df)}function Vl(e,t,s,n,a){if(!Ue(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const i=a.get(e);if(i)return i;const l=bm(Ag(e));if(l===0)return e;const r=new Proxy(e,l===2?n:s);return a.set(e,r),r}function qs(e){return As(e)?qs(e.__v_raw):!!(e&&e.__v_isReactive)}function As(e){return!!(e&&e.__v_isReadonly)}function Xt(e){return!!(e&&e.__v_isShallow)}function _i(e){return e?!!e.__v_raw:!1}function Fe(e){const t=e&&e.__v_raw;return t?Fe(t):e}function ff(e){return!He(e,"__v_skip")&&Object.isExtensible(e)&&jd(e,"__v_skip",!0),e}const bs=e=>Ue(e)?gn(e):e,fa=e=>Ue(e)?al(e):e;function gt(e){return e?e.__v_isRef===!0:!1}function h(e){return pf(e,!1)}function Io(e){return pf(e,!0)}function pf(e,t){return gt(e)?e:new xm(e,t)}class xm{constructor(t,s){this.dep=new Bl,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:Fe(t),this._value=s?t:bs(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||Xt(t)||As(t);t=n?t:Fe(t),kt(t,s)&&(this._rawValue=t,this._value=n?t:bs(t),this.dep.trigger())}}function _m(e){e.dep&&e.dep.trigger()}function Es(e){return gt(e)?e.value:e}function km(e){return ke(e)?e():Es(e)}const wm={get:(e,t,s)=>t==="__v_raw"?e:Es(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const a=e[t];return gt(a)&&!gt(s)?(a.value=s,!0):Reflect.set(e,t,s,n)}};function No(e){return qs(e)?e:new Proxy(e,wm)}class Sm{constructor(t){this.__v_isRef=!0,this._value=void 0;const s=this.dep=new Bl,{get:n,set:a}=t(s.track.bind(s),s.trigger.bind(s));this._get=n,this._set=a}get value(){return this._value=this._get()}set value(t){this._set(t)}}function hf(e){return new Sm(e)}function Tm(e){const t=fe(e)?new Array(e.length):{};for(const s in e)t[s]=gf(e,s);return t}class Cm{constructor(t,s,n){this._object=t,this._defaultValue=n,this.__v_isRef=!0,this._value=void 0,this._key=$t(s)?s:String(s),this._raw=Fe(t);let a=!0,i=t;if(!fe(t)||$t(this._key)||!Ll(this._key))do a=!_i(i)||Xt(i);while(a&&(i=i.__v_raw));this._shallow=a}get value(){let t=this._object[this._key];return this._shallow&&(t=Es(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&gt(this._raw[this._key])){const s=this._object[this._key];if(gt(s)){s.value=t;return}}this._object[this._key]=t}get dep(){return nm(this._raw,this._key)}}class Em{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function Am(e,t,s){return gt(e)?e:ke(e)?new Em(e):Ue(e)&&arguments.length>1?gf(e,t,s):h(e)}function gf(e,t,s){return new Cm(e,t,s)}class Rm{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new Bl(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=si-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&Xe!==this)return Yd(this,!0),!0}get value(){const t=this.dep.track();return ef(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Im(e,t,s=!1){let n,a;return ke(e)?n=e:(n=e.get,a=e.set),new Rm(n,a,s)}const Nm={GET:"get",HAS:"has",ITERATE:"iterate"},Dm={SET:"set",ADD:"add",DELETE:"delete",CLEAR:"clear"},Mi={},il=new WeakMap;let on;function Om(){return on}function mf(e,t=!1,s=on){if(s){let n=il.get(s);n||il.set(s,n=[]),n.push(e)}}function Lm(e,t,s=Pe){const{immediate:n,deep:a,once:i,scheduler:l,augmentJob:r,call:o}=s,c=x=>a?x:Xt(x)||a===!1||a===0?Us(x,1):Us(x);let u,d,f,p,m=!1,g=!1;if(gt(e)?(d=()=>e.value,m=Xt(e)):qs(e)?(d=()=>c(e),m=!0):fe(e)?(g=!0,m=e.some(x=>qs(x)||Xt(x)),d=()=>e.map(x=>{if(gt(x))return x.value;if(qs(x))return c(x);if(ke(x))return o?o(x,2):x()})):ke(e)?t?d=o?()=>o(e,2):e:d=()=>{if(f){Js();try{f()}finally{Zs()}}const x=on;on=u;try{return o?o(e,3,[p]):e(p)}finally{on=x}}:d=It,t&&a){const x=d,R=a===!0?1/0:a;d=()=>Us(x(),R)}const k=Jd(),A=()=>{u.stop(),k&&k.active&&wo(k.effects,u)};if(i&&t){const x=t;t=(...R)=>{const D=x(...R);return A(),D}}let b=g?new Array(e.length).fill(Mi):Mi;const v=x=>{if(!(!(u.flags&1)||!u.dirty&&!x))if(t){const R=u.run();if(x||a||m||(g?R.some((D,O)=>kt(D,b[O])):kt(R,b))){f&&f();const D=on;on=u;try{const O=[R,b===Mi?void 0:g&&b[0]===Mi?[]:b,p];b=R,o?o(t,3,O):t(...O)}finally{on=D}}}else u.run()};return r&&r(v),u=new ti(d),u.scheduler=l?()=>l(v,!1):v,p=x=>mf(x,!1,u),f=u.onStop=()=>{const x=il.get(u);if(x){if(o)o(x,4);else for(const R of x)R();il.delete(u)}},t?n?v(!0):b=u.run():l?l(v.bind(null,!0),!0):u.run(),A.pause=u.pause.bind(u),A.resume=u.resume.bind(u),A.stop=A,A}function Us(e,t=1/0,s){if(t<=0||!Ue(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,gt(e))Us(e.value,t,s);else if(fe(e))for(let n=0;n<e.length;n++)Us(e[n],t,s);else if(Fn(e)||aa(e))e.forEach(n=>{Us(n,t,s)});else if(Ol(e)){for(const n in e)Us(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&Us(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const vf=[];function Pm(e){vf.push(e)}function Mm(){vf.pop()}function Fm(e,t){}const $m={SETUP_FUNCTION:0,0:"SETUP_FUNCTION",RENDER_FUNCTION:1,1:"RENDER_FUNCTION",NATIVE_EVENT_HANDLER:5,5:"NATIVE_EVENT_HANDLER",COMPONENT_EVENT_HANDLER:6,6:"COMPONENT_EVENT_HANDLER",VNODE_HOOK:7,7:"VNODE_HOOK",DIRECTIVE_HOOK:8,8:"DIRECTIVE_HOOK",TRANSITION_HOOK:9,9:"TRANSITION_HOOK",APP_ERROR_HANDLER:10,10:"APP_ERROR_HANDLER",APP_WARN_HANDLER:11,11:"APP_WARN_HANDLER",FUNCTION_REF:12,12:"FUNCTION_REF",ASYNC_COMPONENT_LOADER:13,13:"ASYNC_COMPONENT_LOADER",SCHEDULER:14,14:"SCHEDULER",COMPONENT_UPDATE:15,15:"COMPONENT_UPDATE",APP_UNMOUNT_CLEANUP:16,16:"APP_UNMOUNT_CLEANUP"},Bm={sp:"serverPrefetch hook",bc:"beforeCreate hook",c:"created hook",bm:"beforeMount hook",m:"mounted hook",bu:"beforeUpdate hook",u:"updated",bum:"beforeUnmount hook",um:"unmounted hook",a:"activated hook",da:"deactivated hook",ec:"errorCaptured hook",rtc:"renderTracked hook",rtg:"renderTriggered hook",0:"setup function",1:"render function",2:"watcher getter",3:"watcher callback",4:"watcher cleanup function",5:"native event handler",6:"component event handler",7:"vnode hook",8:"directive hook",9:"transition hook",10:"app errorHandler",11:"app warnHandler",12:"ref function",13:"async component loader",14:"scheduler flush",15:"component update",16:"app unmount cleanup function"};function Ta(e,t,s,n){try{return n?e(...n):e()}catch(a){Bn(a,t,s)}}function ss(e,t,s,n){if(ke(e)){const a=Ta(e,t,s,n);return a&&So(a)&&a.catch(i=>{Bn(i,t,s)}),a}if(fe(e)){const a=[];for(let i=0;i<e.length;i++)a.push(ss(e[i],t,s,n));return a}}function Bn(e,t,s,n=!0){const a=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=t&&t.appContext.config||Pe;if(t){let r=t.parent;const o=t.proxy,c=`https://vuejs.org/error-reference/#runtime-${s}`;for(;r;){const u=r.ec;if(u){for(let d=0;d<u.length;d++)if(u[d](e,o,c)===!1)return}r=r.parent}if(i){Js(),Ta(i,null,10,[e,o,c]),Zs();return}}Um(e,s,a,n,l)}function Um(e,t,s,n=!0,a=!1){if(a)throw e;console.error(e)}const Vt=[];let Ss=-1;const ra=[];let cn=null,Yn=0;const bf=Promise.resolve();let ll=null;function Et(e){const t=ll||bf;return e?t.then(this?e.bind(this):e):t}function Hm(e){let t=Ss+1,s=Vt.length;for(;t<s;){const n=t+s>>>1,a=Vt[n],i=ii(a);i<e||i===e&&a.flags&2?t=n+1:s=n}return t}function Do(e){if(!(e.flags&1)){const t=ii(e),s=Vt[Vt.length-1];!s||!(e.flags&2)&&t>=ii(s)?Vt.push(e):Vt.splice(Hm(t),0,e),e.flags|=1,yf()}}function yf(){ll||(ll=bf.then(xf))}function ai(e){fe(e)?ra.push(...e):cn&&e.id===-1?cn.splice(Yn+1,0,e):e.flags&1||(ra.push(e),e.flags|=1),yf()}function Jc(e,t,s=Ss+1){for(;s<Vt.length;s++){const n=Vt[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;Vt.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function rl(e){if(ra.length){const t=[...new Set(ra)].sort((s,n)=>ii(s)-ii(n));if(ra.length=0,cn){cn.push(...t);return}for(cn=t,Yn=0;Yn<cn.length;Yn++){const s=cn[Yn];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}cn=null,Yn=0}}const ii=e=>e.id==null?e.flags&2?-1:1/0:e.id;function xf(e){try{for(Ss=0;Ss<Vt.length;Ss++){const t=Vt[Ss];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Ta(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Ss<Vt.length;Ss++){const t=Vt[Ss];t&&(t.flags&=-2)}Ss=-1,Vt.length=0,rl(),ll=null,(Vt.length||ra.length)&&xf()}}let Qn,Fi=[];function _f(e,t){var s,n;Qn=e,Qn?(Qn.enabled=!0,Fi.forEach(({event:a,args:i})=>Qn.emit(a,...i)),Fi=[]):typeof window<"u"&&window.HTMLElement&&!((n=(s=window.navigator)==null?void 0:s.userAgent)!=null&&n.includes("jsdom"))?((t.__VUE_DEVTOOLS_HOOK_REPLAY__=t.__VUE_DEVTOOLS_HOOK_REPLAY__||[]).push(i=>{_f(i,t)}),setTimeout(()=>{Qn||(t.__VUE_DEVTOOLS_HOOK_REPLAY__=null,Fi=[])},3e3)):Fi=[]}let Rt=null,jl=null;function li(e){const t=Rt;return Rt=e,jl=e&&e.type.__scopeId||null,t}function Vm(e){jl=e}function jm(){jl=null}const zm=e=>Oo;function Oo(e,t=Rt,s){if(!t||e._n)return e;const n=(...a)=>{n._d&&ui(-1);const i=li(t);let l;try{l=e(...a)}finally{li(i),n._d&&ui(1)}return l};return n._n=!0,n._c=!0,n._d=!0,n}function qm(e,t){if(Rt===null)return e;const s=Ti(Rt),n=e.dirs||(e.dirs=[]);for(let a=0;a<t.length;a++){let[i,l,r,o=Pe]=t[a];i&&(ke(i)&&(i={mounted:i,updated:i}),i.deep&&Us(l),n.push({dir:i,instance:s,value:l,oldValue:void 0,arg:r,modifiers:o}))}return e}function Ts(e,t,s,n){const a=e.dirs,i=t&&t.dirs;for(let l=0;l<a.length;l++){const r=a[l];i&&(r.oldValue=i[l].value);let o=r.dir[n];o&&(Js(),ss(o,s,8,[e.el,r,e,t]),Zs())}}function Ga(e,t){if(At){let s=At.provides;const n=At.parent&&At.parent.provides;n===s&&(s=At.provides=Object.create(n)),s[e]=t}}function us(e,t,s=!1){const n=zt();if(n||En){let a=En?En._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(a&&e in a)return a[e];if(arguments.length>1)return s&&ke(t)?t.call(n&&n.proxy):t}}function Km(){return!!(zt()||En)}const kf=Symbol.for("v-scx"),wf=()=>us(kf);function Gm(e,t){return ki(e,null,t)}function Wm(e,t){return ki(e,null,{flush:"post"})}function Sf(e,t){return ki(e,null,{flush:"sync"})}function ds(e,t,s){return ki(e,t,s)}function ki(e,t,s=Pe){const{immediate:n,deep:a,flush:i,once:l}=s,r=Oe({},s),o=t&&n||!t&&i!=="post";let c;if(On){if(i==="sync"){const p=wf();c=p.__watcherHandles||(p.__watcherHandles=[])}else if(!o){const p=()=>{};return p.stop=It,p.resume=It,p.pause=It,p}}const u=At;r.call=(p,m,g)=>ss(p,u,m,g);let d=!1;i==="post"?r.scheduler=p=>{pt(p,u&&u.suspense)}:i!=="sync"&&(d=!0,r.scheduler=(p,m)=>{m?p():Do(p)}),r.augmentJob=p=>{t&&(p.flags|=4),d&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const f=Lm(e,t,r);return On&&(c?c.push(f):o&&f()),f}function Jm(e,t,s){const n=this.proxy,a=Te(e)?e.includes(".")?Tf(n,e):()=>n[e]:e.bind(n,n);let i;ke(t)?i=t:(i=t.handler,s=t);const l=Ca(this),r=ki(a,i.bind(n),s);return l(),r}function Tf(e,t){const s=t.split(".");return()=>{let n=e;for(let a=0;a<s.length&&n;a++)n=n[s[a]];return n}}const ln=new WeakMap,Cf=Symbol("_vte"),Ef=e=>e.__isTeleport,kn=e=>e&&(e.disabled||e.disabled===""),Zm=e=>e&&(e.defer||e.defer===""),Zc=e=>typeof SVGElement<"u"&&e instanceof SVGElement,Yc=e=>typeof MathMLElement=="function"&&e instanceof MathMLElement,zr=(e,t)=>{const s=e&&e.to;return Te(s)?t?t(s):null:s},Ym={name:"Teleport",__isTeleport:!0,process(e,t,s,n,a,i,l,r,o,c){const{mc:u,pc:d,pbc:f,o:{insert:p,querySelector:m,createText:g,createComment:k,parentNode:A}}=c,b=kn(t.props);let{dynamicChildren:v}=t;const x=(O,S,I)=>{O.shapeFlag&16&&u(O.children,S,I,a,i,l,r,o)},R=(O=t)=>{const S=kn(O.props),I=O.target=zr(O.props,m),w=qr(I,O,g,p);I&&(l!=="svg"&&Zc(I)?l="svg":l!=="mathml"&&Yc(I)&&(l="mathml"),a&&a.isCE&&(a.ce._teleportTargets||(a.ce._teleportTargets=new Set)).add(I),S||(x(O,I,w),Ua(O,!1)))},D=O=>{const S=()=>{if(ln.get(O)===S){if(ln.delete(O),kn(O.props)){const I=A(O.el)||s;x(O,I,O.anchor),Ua(O,!0)}R(O)}};ln.set(O,S),pt(S,i)};if(e==null){const O=t.el=g(""),S=t.anchor=g("");if(p(O,s,n),p(S,s,n),Zm(t.props)||i&&i.pendingBranch){D(t);return}b&&(x(t,s,S),Ua(t,!0)),R()}else{t.el=e.el;const O=t.anchor=e.anchor,S=ln.get(e);if(S){S.flags|=8,ln.delete(e),D(t);return}t.targetStart=e.targetStart;const I=t.target=e.target,w=t.targetAnchor=e.targetAnchor,$=kn(e.props),F=$?s:I,P=$?O:w;if(l==="svg"||Zc(I)?l="svg":(l==="mathml"||Yc(I))&&(l="mathml"),v?(f(e.dynamicChildren,v,F,a,i,l,r),zo(e,t,!0)):o||d(e,t,F,P,a,i,l,r,!1),b)$?t.props&&e.props&&t.props.to!==e.props.to&&(t.props.to=e.props.to):$i(t,s,O,c,1);else if((t.props&&t.props.to)!==(e.props&&e.props.to)){const W=t.target=zr(t.props,m);W&&$i(t,W,null,c,0)}else $&&$i(t,I,w,c,1);Ua(t,b)}},remove(e,t,s,{um:n,o:{remove:a}},i){const{shapeFlag:l,children:r,anchor:o,targetStart:c,targetAnchor:u,target:d,props:f}=e,p=i||!kn(f),m=ln.get(e);if(m&&(m.flags|=8,ln.delete(e)),d&&(a(c),a(u)),i&&a(o),!m&&l&16)for(let g=0;g<r.length;g++){const k=r[g];n(k,t,s,p,!!k.dynamicChildren)}},move:$i,hydrate:Qm};function $i(e,t,s,{o:{insert:n},m:a},i=2){i===0&&n(e.targetAnchor,t,s);const{el:l,anchor:r,shapeFlag:o,children:c,props:u}=e,d=i===2;if(d&&n(l,t,s),!ln.has(e)&&(!d||kn(u))&&o&16)for(let f=0;f<c.length;f++)a(c[f],t,s,2);d&&n(r,t,s)}function Qm(e,t,s,n,a,i,{o:{nextSibling:l,parentNode:r,querySelector:o,insert:c,createText:u}},d){function f(k,A){let b=A;for(;b;){if(b&&b.nodeType===8){if(b.data==="teleport start anchor")t.targetStart=b;else if(b.data==="teleport anchor"){t.targetAnchor=b,k._lpa=t.targetAnchor&&l(t.targetAnchor);break}}b=l(b)}}function p(k,A){A.anchor=d(l(k),A,r(k),s,n,a,i)}const m=t.target=zr(t.props,o),g=kn(t.props);if(m){const k=m._lpa||m.firstChild;t.shapeFlag&16&&(g?(p(e,t),f(m,k),t.targetAnchor||qr(m,t,u,c,r(e)===m?e:null)):(t.anchor=l(e),f(m,k),t.targetAnchor||qr(m,t,u,c),d(k&&l(k),t,m,s,n,a,i))),Ua(t,g)}else g&&t.shapeFlag&16&&(p(e,t),t.targetStart=e,t.targetAnchor=l(e));return t.anchor&&l(t.anchor)}const Xm=Ym;function Ua(e,t){const s=e.ctx;if(s&&s.ut){let n,a;for(t?(n=e.el,a=e.anchor):(n=e.targetStart,a=e.targetAnchor);n&&n!==a;)n.nodeType===1&&n.setAttribute("data-v-owner",s.uid),n=n.nextSibling;s.ut()}}function qr(e,t,s,n,a=null){const i=t.targetStart=s(""),l=t.targetAnchor=s("");return i[Cf]=l,e&&(n(i,e,a),n(l,e,a)),l}const rs=Symbol("_leaveCb"),Da=Symbol("_enterCb");function Lo(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return $e(()=>{e.isMounted=!0}),Gl(()=>{e.isUnmounting=!0}),e}const ls=[Function,Array],Po={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ls,onEnter:ls,onAfterEnter:ls,onEnterCancelled:ls,onBeforeLeave:ls,onLeave:ls,onAfterLeave:ls,onLeaveCancelled:ls,onBeforeAppear:ls,onAppear:ls,onAfterAppear:ls,onAppearCancelled:ls},Af=e=>{const t=e.subTree;return t.component?Af(t.component):t},ev={name:"BaseTransition",props:Po,setup(e,{slots:t}){const s=zt(),n=Lo();return()=>{const a=t.default&&zl(t.default(),!0),i=a&&a.length?Rf(a):s.subTree?pp():void 0;if(!i)return;const l=Fe(e),{mode:r}=l;if(n.isLeaving)return mr(i);const o=Qc(i);if(!o)return mr(i);let c=pa(o,l,n,s,d=>c=d);o.type!==dt&&Ys(o,c);let u=s.subTree&&Qc(s.subTree);if(u&&u.type!==dt&&!gs(u,o)&&Af(s).type!==dt){let d=pa(u,l,n,s);if(Ys(u,d),r==="out-in"&&o.type!==dt)return n.isLeaving=!0,d.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete d.afterLeave,u=void 0},mr(i);r==="in-out"&&o.type!==dt?d.delayLeave=(f,p,m)=>{const g=Nf(n,u);g[String(u.key)]=u,f[rs]=()=>{p(),f[rs]=void 0,delete c.delayedLeave,u=void 0},c.delayedLeave=()=>{m(),delete c.delayedLeave,u=void 0}}:u=void 0}else u&&(u=void 0);return i}}};function Rf(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==dt){t=s;break}}return t}const If=ev;function Nf(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function pa(e,t,s,n,a){const{appear:i,mode:l,persisted:r=!1,onBeforeEnter:o,onEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:f,onLeave:p,onAfterLeave:m,onLeaveCancelled:g,onBeforeAppear:k,onAppear:A,onAfterAppear:b,onAppearCancelled:v}=t,x=String(e.key),R=Nf(s,e),D=(I,w)=>{I&&ss(I,n,9,w)},O=(I,w)=>{const $=w[1];D(I,w),fe(I)?I.every(F=>F.length<=1)&&$():I.length<=1&&$()},S={mode:l,persisted:r,beforeEnter(I){let w=o;if(!s.isMounted)if(i)w=k||o;else return;I[rs]&&I[rs](!0);const $=R[x];$&&gs(e,$)&&$.el[rs]&&$.el[rs](),D(w,[I])},enter(I){if(R[x]===e)return;let w=c,$=u,F=d;if(!s.isMounted)if(i)w=A||c,$=b||u,F=v||d;else return;let P=!1;I[Da]=U=>{P||(P=!0,U?D(F,[I]):D($,[I]),S.delayedLeave&&S.delayedLeave(),I[Da]=void 0)};const W=I[Da].bind(null,!1);w?O(w,[I,W]):W()},leave(I,w){const $=String(e.key);if(I[Da]&&I[Da](!0),s.isUnmounting)return w();D(f,[I]);let F=!1;I[rs]=W=>{F||(F=!0,w(),W?D(g,[I]):D(m,[I]),I[rs]=void 0,R[$]===e&&delete R[$])};const P=I[rs].bind(null,!1);R[$]=e,p?O(p,[I,P]):P()},clone(I){const w=pa(I,t,s,n,a);return a&&a(w),w}};return S}function mr(e){if(Si(e))return e=Rs(e),e.children=null,e}function Qc(e){if(!Si(e))return Ef(e.type)&&e.children?Rf(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&ke(s.default))return s.default()}}function Ys(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Ys(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function zl(e,t=!1,s){let n=[],a=0;for(let i=0;i<e.length;i++){let l=e[i];const r=s==null?l.key:String(s)+String(l.key!=null?l.key:i);l.type===wt?(l.patchFlag&128&&a++,n=n.concat(zl(l.children,t,r))):(t||l.type!==dt)&&n.push(r!=null?Rs(l,{key:r}):l)}if(a>1)for(let i=0;i<n.length;i++)n[i].patchFlag=-2;return n}function wi(e,t){return ke(e)?Oe({name:e.name},t,{setup:e}):e}function tv(){const e=zt();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function Mo(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function sv(e){const t=zt(),s=Io(null);if(t){const a=t.refs===Pe?t.refs={}:t.refs;Object.defineProperty(a,e,{enumerable:!0,get:()=>s.value,set:i=>s.value=i})}return s}function Xc(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const ol=new WeakMap;function oa(e,t,s,n,a=!1){if(fe(e)){e.forEach((g,k)=>oa(g,t&&(fe(t)?t[k]:t),s,n,a));return}if(Ks(n)&&!a){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&oa(e,t,s,n.component.subTree);return}const i=n.shapeFlag&4?Ti(n.component):n.el,l=a?null:i,{i:r,r:o}=e,c=t&&t.r,u=r.refs===Pe?r.refs={}:r.refs,d=r.setupState,f=Fe(d),p=d===Pe?ta:g=>Xc(u,g)?!1:He(f,g),m=(g,k)=>!(k&&Xc(u,k));if(c!=null&&c!==o){if(eu(t),Te(c))u[c]=null,p(c)&&(d[c]=null);else if(gt(c)){const g=t;m(c,g.k)&&(c.value=null),g.k&&(u[g.k]=null)}}if(ke(o))Ta(o,r,12,[l,u]);else{const g=Te(o),k=gt(o);if(g||k){const A=()=>{if(e.f){const b=g?p(o)?d[o]:u[o]:m()||!e.k?o.value:u[e.k];if(a)fe(b)&&wo(b,i);else if(fe(b))b.includes(i)||b.push(i);else if(g)u[o]=[i],p(o)&&(d[o]=u[o]);else{const v=[i];m(o,e.k)&&(o.value=v),e.k&&(u[e.k]=v)}}else g?(u[o]=l,p(o)&&(d[o]=l)):k&&(m(o,e.k)&&(o.value=l),e.k&&(u[e.k]=l))};if(l){const b=()=>{A(),ol.delete(e)};b.id=-1,ol.set(e,b),pt(b,s)}else eu(e),A()}}}function eu(e){const t=ol.get(e);t&&(t.flags|=8,ol.delete(e))}let tu=!1;const Gn=()=>{tu||(console.error("Hydration completed but contains mismatches."),tu=!0)},nv=e=>e.namespaceURI.includes("svg")&&e.tagName!=="foreignObject",av=e=>e.namespaceURI.includes("MathML"),Bi=e=>{if(e.nodeType===1){if(nv(e))return"svg";if(av(e))return"mathml"}},sa=e=>e.nodeType===8;function iv(e){const{mt:t,p:s,o:{patchProp:n,createText:a,nextSibling:i,parentNode:l,remove:r,insert:o,createComment:c}}=e,u=(v,x)=>{if(!x.hasChildNodes()){s(null,v,x),rl(),x._vnode=v;return}d(x.firstChild,v,null,null,null),rl(),x._vnode=v},d=(v,x,R,D,O,S=!1)=>{S=S||!!x.dynamicChildren;const I=sa(v)&&v.data==="[",w=()=>g(v,x,R,D,O,I),{type:$,ref:F,shapeFlag:P,patchFlag:W}=x;let U=v.nodeType;x.el=v,W===-2&&(S=!1,x.dynamicChildren=null);let V=null;switch($){case fn:U!==3?x.children===""?(o(x.el=a(""),l(v),v),V=v):V=w():(v.data!==x.children&&(Gn(),v.data=x.children),V=i(v));break;case dt:b(v)?(V=i(v),A(x.el=v.content.firstChild,v,R)):U!==8||I?V=w():V=i(v);break;case An:if(I&&(v=i(v),U=v.nodeType),U===1||U===3){V=v;const N=!x.children.length;for(let L=0;L<x.staticCount;L++)N&&(x.children+=V.nodeType===1?V.outerHTML:V.data),L===x.staticCount-1&&(x.anchor=V),V=i(V);return I?i(V):V}else w();break;case wt:I?V=m(v,x,R,D,O,S):V=w();break;default:if(P&1)(U!==1||x.type.toLowerCase()!==v.tagName.toLowerCase())&&!b(v)?V=w():V=f(v,x,R,D,O,S);else if(P&6){x.slotScopeIds=O;const N=l(v);if(I?V=k(v):sa(v)&&v.data==="teleport start"?V=k(v,v.data,"teleport end"):V=i(v),t(x,N,null,R,D,Bi(N),S),Ks(x)&&!x.type.__asyncResolved){let L;I?(L=at(wt),L.anchor=V?V.previousSibling:N.lastChild):L=v.nodeType===3?Ko(""):at("div"),L.el=v,x.component.subTree=L}}else P&64?U!==8?V=w():V=x.type.hydrate(v,x,R,D,O,S,e,p):P&128&&(V=x.type.hydrate(v,x,R,D,Bi(l(v)),O,S,e,d))}return F!=null&&oa(F,null,D,x),V},f=(v,x,R,D,O,S)=>{S=S||!!x.dynamicChildren;const{type:I,props:w,patchFlag:$,shapeFlag:F,dirs:P,transition:W}=x,U=I==="input"||I==="option";if(U||$!==-1){P&&Ts(x,null,R,"created");let V=!1;if(b(v)){V=ap(null,W)&&R&&R.vnode.props&&R.vnode.props.appear;const L=v.content.firstChild;if(V){const q=L.getAttribute("class");q&&(L.$cls=q),W.beforeEnter(L)}A(L,v,R),x.el=v=L}if(F&16&&!(w&&(w.innerHTML||w.textContent))){let L=p(v.firstChild,x,v,R,D,O,S);for(L&&!Ui(v,1)&&Gn();L;){const q=L;L=L.nextSibling,r(q)}}else if(F&8){let L=x.children;L[0]===`
`&&(v.tagName==="PRE"||v.tagName==="TEXTAREA")&&(L=L.slice(1));const{textContent:q}=v;q!==L&&q!==L.replace(/\r\n|\r/g,`
`)&&(Ui(v,0)||Gn(),v.textContent=x.children)}if(w){if(U||!S||$&48){const L=v.tagName.includes("-");for(const q in w)(U&&(q.endsWith("value")||q==="indeterminate")||Mn(q)&&!zs(q)||q[0]==="."||L&&!zs(q))&&n(v,q,null,w[q],void 0,R)}else if(w.onClick)n(v,"onClick",null,w.onClick,void 0,R);else if($&4&&qs(w.style))for(const L in w.style)w.style[L]}let N;(N=w&&w.onVnodeBeforeMount)&&Wt(N,R,x),P&&Ts(x,null,R,"beforeMount"),((N=w&&w.onVnodeMounted)||P||V)&&op(()=>{N&&Wt(N,R,x),V&&W.enter(v),P&&Ts(x,null,R,"mounted")},D)}return v.nextSibling},p=(v,x,R,D,O,S,I)=>{I=I||!!x.dynamicChildren;const w=x.children,$=w.length;let F=!1;for(let P=0;P<$;P++){const W=I?w[P]:w[P]=Zt(w[P]),U=W.type===fn;v?(U&&!I&&P+1<$&&Zt(w[P+1]).type===fn&&(o(a(v.data.slice(W.children.length)),R,i(v)),v.data=W.children),v=d(v,W,D,O,S,I)):U&&!W.children?o(W.el=a(""),R):(F||(F=!0,Ui(R,1)||Gn()),s(null,W,R,null,D,O,Bi(R),S))}return v},m=(v,x,R,D,O,S)=>{const{slotScopeIds:I}=x;I&&(O=O?O.concat(I):I);const w=l(v),$=p(i(v),x,w,R,D,O,S);return $&&sa($)&&$.data==="]"?i(x.anchor=$):(Gn(),o(x.anchor=c("]"),w,$),$)},g=(v,x,R,D,O,S)=>{if(Ui(v.parentElement,1)||Gn(),x.el=null,S){const $=k(v);for(;;){const F=i(v);if(F&&F!==$)r(F);else break}}const I=i(v),w=l(v);return r(v),s(null,x,w,I,R,D,Bi(w),O),R&&(R.vnode.el=x.el,Jl(R,x.el)),I},k=(v,x="[",R="]")=>{let D=0;for(;v;)if(v=i(v),v&&sa(v)&&(v.data===x&&D++,v.data===R)){if(D===0)return i(v);D--}return v},A=(v,x,R)=>{const D=x.parentNode;D&&D.replaceChild(v,x);let O=R;for(;O;)O.vnode.el===x&&(O.vnode.el=O.subTree.el=v),O=O.parent},b=v=>v.nodeType===1&&v.tagName==="TEMPLATE";return[u,d]}const su="data-allow-mismatch",lv={0:"text",1:"children",2:"class",3:"style",4:"attribute"};function Ui(e,t){if(t===0||t===1)for(;e&&!e.hasAttribute(su);)e=e.parentElement;const s=e&&e.getAttribute(su);if(s==null)return!1;if(s==="")return!0;{const n=s.split(",");return t===0&&n.includes("children")?!0:n.includes(lv[t])}}const rv=Fl().requestIdleCallback||(e=>setTimeout(e,1)),ov=Fl().cancelIdleCallback||(e=>clearTimeout(e)),cv=(e=1e4)=>t=>{const s=rv(t,{timeout:e});return()=>ov(s)};function uv(e){const{top:t,left:s,bottom:n,right:a}=e.getBoundingClientRect(),{innerHeight:i,innerWidth:l}=window;return(t>0&&t<i||n>0&&n<i)&&(s>0&&s<l||a>0&&a<l)}const dv=e=>(t,s)=>{const n=new IntersectionObserver(a=>{for(const i of a)if(i.isIntersecting){n.disconnect(),t();break}},e);return s(a=>{if(a instanceof Element){if(uv(a))return t(),n.disconnect(),!1;n.observe(a)}}),()=>n.disconnect()},fv=e=>t=>{if(e){const s=matchMedia(e);if(s.matches)t();else return s.addEventListener("change",t,{once:!0}),()=>s.removeEventListener("change",t)}},pv=(e=[])=>(t,s)=>{Te(e)&&(e=[e]);let n=!1;const a=l=>{n||(n=!0,i(),t(),l.target.dispatchEvent(new l.constructor(l.type,l)))},i=()=>{s(l=>{for(const r of e)l.removeEventListener(r,a)})};return s(l=>{for(const r of e)l.addEventListener(r,a,{once:!0})}),i};function hv(e,t){if(sa(e)&&e.data==="["){let s=1,n=e.nextSibling;for(;n;){if(n.nodeType===1){if(t(n)===!1)break}else if(sa(n))if(n.data==="]"){if(--s===0)break}else n.data==="["&&s++;n=n.nextSibling}}else t(e)}const Ks=e=>!!e.type.__asyncLoader;function gv(e){ke(e)&&(e={loader:e});const{loader:t,loadingComponent:s,errorComponent:n,delay:a=200,hydrate:i,timeout:l,suspensible:r=!0,onError:o}=e;let c=null,u,d=0;const f=()=>(d++,c=null,p()),p=()=>{let m;return c||(m=c=t().catch(g=>{if(g=g instanceof Error?g:new Error(String(g)),o)return new Promise((k,A)=>{o(g,()=>k(f()),()=>A(g),d+1)});throw g}).then(g=>m!==c&&c?c:(g&&(g.__esModule||g[Symbol.toStringTag]==="Module")&&(g=g.default),u=g,g)))};return wi({name:"AsyncComponentWrapper",__asyncLoader:p,__asyncHydrate(m,g,k){let A=!1;(g.bu||(g.bu=[])).push(()=>A=!0);const b=()=>{A||k()},v=i?()=>{const x=i(b,R=>hv(m,R));x&&(g.bum||(g.bum=[])).push(x)}:b;u?v():p().then(()=>!g.isUnmounted&&v())},get __asyncResolved(){return u},setup(){const m=At;if(Mo(m),u)return()=>Hi(u,m);const g=R=>{c=null,Bn(R,m,13,!n)};if(r&&m.suspense||On)return p().then(R=>()=>Hi(R,m)).catch(R=>(g(R),()=>n?at(n,{error:R}):null));const k=h(!1),A=h(),b=h(!!a);let v,x;return ft(()=>{v!=null&&clearTimeout(v),x!=null&&clearTimeout(x)}),a&&(x=setTimeout(()=>{m.isUnmounted||(b.value=!1)},a)),l!=null&&(v=setTimeout(()=>{if(!m.isUnmounted&&!k.value&&!A.value){const R=new Error(`Async component timed out after ${l}ms.`);g(R),A.value=R}},l)),p().then(()=>{m.isUnmounted||(k.value=!0,m.parent&&Si(m.parent.vnode)&&m.parent.update())}).catch(R=>{if(m.isUnmounted){c=null;return}g(R),A.value=R}),()=>{if(k.value&&u)return Hi(u,m);if(A.value&&n)return at(n,{error:A.value});if(s&&!b.value)return Hi(s,m)}}})}function Hi(e,t){const{ref:s,props:n,children:a,ce:i}=t.vnode,l=at(e,n,a);return l.ref=s,l.ce=i,delete t.vnode.ce,l}const Si=e=>e.type.__isKeepAlive,mv={name:"KeepAlive",__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){const s=zt(),n=s.ctx;if(!n.renderer)return()=>{const b=t.default&&t.default();return b&&b.length===1?b[0]:b};const a=new Map,i=new Set;let l=null;const r=s.suspense,{renderer:{p:o,m:c,um:u,o:{createElement:d}}}=n,f=d("div");n.activate=(b,v,x,R,D)=>{const O=b.component;c(b,v,x,0,r),o(O.vnode,b,v,x,O,r,R,b.slotScopeIds,D),pt(()=>{O.isDeactivated=!1,O.a&&la(O.a);const S=b.props&&b.props.onVnodeMounted;S&&Wt(S,O.parent,b)},r)},n.deactivate=b=>{const v=b.component;ul(v.m),ul(v.a),c(b,f,null,1,r),pt(()=>{v.da&&la(v.da);const x=b.props&&b.props.onVnodeUnmounted;x&&Wt(x,v.parent,b),v.isDeactivated=!0},r)};function p(b){vr(b),u(b,s,r,!0)}function m(b){a.forEach((v,x)=>{const R=eo(Ks(v)?v.type.__asyncResolved||{}:v.type);R&&!b(R)&&g(x)})}function g(b){const v=a.get(b);v&&(!l||!gs(v,l))?p(v):l&&vr(l),a.delete(b),i.delete(b)}ds(()=>[e.include,e.exclude],([b,v])=>{b&&m(x=>Ha(b,x)),v&&m(x=>!Ha(v,x))},{flush:"post",deep:!0});let k=null;const A=()=>{k!=null&&(dl(s.subTree.type)?pt(()=>{a.set(k,Vi(s.subTree))},s.subTree.suspense):a.set(k,Vi(s.subTree)))};return $e(A),Kl(A),Gl(()=>{a.forEach(b=>{const{subTree:v,suspense:x}=s,R=Vi(v);if(b.type===R.type&&b.key===R.key){vr(R);const D=R.component.da;D&&pt(D,x);return}p(b)})}),()=>{if(k=null,!t.default)return l=null;const b=t.default(),v=b[0];if(b.length>1)return l=null,b;if(!Qs(v)||!(v.shapeFlag&4)&&!(v.shapeFlag&128))return l=null,v;let x=Vi(v);if(x.type===dt)return l=null,x;const R=x.type,D=eo(Ks(x)?x.type.__asyncResolved||{}:R),{include:O,exclude:S,max:I}=e;if(O&&(!D||!Ha(O,D))||S&&D&&Ha(S,D))return x.shapeFlag&=-257,l=x,v;const w=x.key==null?R:x.key,$=a.get(w);return x.el&&(x=Rs(x),v.shapeFlag&128&&(v.ssContent=x)),k=w,$?(x.el=$.el,x.component=$.component,x.transition&&Ys(x,x.transition),x.shapeFlag|=512,i.delete(w),i.add(w)):(i.add(w),I&&i.size>parseInt(I,10)&&g(i.values().next().value)),x.shapeFlag|=256,l=x,dl(v.type)?v:x}}},vv=mv;function Ha(e,t){return fe(e)?e.some(s=>Ha(s,t)):Te(e)?e.split(",").includes(t):Eg(e)?(e.lastIndex=0,e.test(t)):!1}function Df(e,t){Lf(e,"a",t)}function Of(e,t){Lf(e,"da",t)}function Lf(e,t,s=At){const n=e.__wdc||(e.__wdc=()=>{let a=s;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if(ql(t,n,s),s){let a=s.parent;for(;a&&a.parent;)Si(a.parent.vnode)&&bv(n,t,s,a),a=a.parent}}function bv(e,t,s,n){const a=ql(t,e,n,!0);ft(()=>{wo(n[t],a)},s)}function vr(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function Vi(e){return e.shapeFlag&128?e.ssContent:e}function ql(e,t,s=At,n=!1){if(s){const a=s[e]||(s[e]=[]),i=t.__weh||(t.__weh=(...l)=>{Js();const r=Ca(s),o=ss(t,s,e,l);return r(),Zs(),o});return n?a.unshift(i):a.push(i),i}}const Xs=e=>(t,s=At)=>{(!On||e==="sp")&&ql(e,(...n)=>t(...n),s)},Pf=Xs("bm"),$e=Xs("m"),Fo=Xs("bu"),Kl=Xs("u"),Gl=Xs("bum"),ft=Xs("um"),Mf=Xs("sp"),Ff=Xs("rtg"),$f=Xs("rtc");function Bf(e,t=At){ql("ec",e,t)}const $o="components",yv="directives";function xv(e,t){return Bo($o,e,!0,t)||e}const Uf=Symbol.for("v-ndc");function _v(e){return Te(e)?Bo($o,e,!1)||e:e||Uf}function kv(e){return Bo(yv,e)}function Bo(e,t,s=!0,n=!1){const a=Rt||At;if(a){const i=a.type;if(e===$o){const r=eo(i,!1);if(r&&(r===t||r===Ke(t)||r===$n(Ke(t))))return i}const l=nu(a[e]||i[e],t)||nu(a.appContext[e],t);return!l&&n?i:l}}function nu(e,t){return e&&(e[t]||e[Ke(t)]||e[$n(Ke(t))])}function wv(e,t,s,n){let a;const i=s&&s[n],l=fe(e);if(l||Te(e)){const r=l&&qs(e);let o=!1,c=!1;r&&(o=!Xt(e),c=As(e),e=Ul(e)),a=new Array(e.length);for(let u=0,d=e.length;u<d;u++)a[u]=t(o?c?fa(bs(e[u])):bs(e[u]):e[u],u,void 0,i&&i[u])}else if(typeof e=="number"){a=new Array(e);for(let r=0;r<e;r++)a[r]=t(r+1,r,void 0,i&&i[r])}else if(Ue(e))if(e[Symbol.iterator])a=Array.from(e,(r,o)=>t(r,o,void 0,i&&i[o]));else{const r=Object.keys(e);a=new Array(r.length);for(let o=0,c=r.length;o<c;o++){const u=r[o];a[o]=t(e[u],u,o,i&&i[o])}}else a=[];return s&&(s[n]=a),a}function Sv(e,t){for(let s=0;s<t.length;s++){const n=t[s];if(fe(n))for(let a=0;a<n.length;a++)e[n[a].name]=n[a].fn;else n&&(e[n.name]=n.key?(...a)=>{const i=n.fn(...a);return i&&(i.key=n.key),i}:n.fn)}return e}function Tv(e,t,s={},n,a){if(Rt.ce||Rt.parent&&Ks(Rt.parent)&&Rt.parent.ce){const c=Object.keys(s).length>0;return t!=="default"&&(s.name=t),ci(),fl(wt,null,[at("slot",s,n&&n())],c?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),ci();const l=i&&Uo(i(s)),r=s.key||l&&l.key,o=fl(wt,{key:(r&&!$t(r)?r:`_${t}`)+(!l&&n?"_fb":"")},l||(n?n():[]),l&&e._===1?64:-2);return!a&&o.scopeId&&(o.slotScopeIds=[o.scopeId+"-s"]),i&&i._c&&(i._d=!0),o}function Uo(e){return e.some(t=>Qs(t)?!(t.type===dt||t.type===wt&&!Uo(t.children)):!0)?e:null}function Cv(e,t){const s={};for(const n in e)s[t&&/[A-Z]/.test(n)?`on:${n}`:ia(n)]=e[n];return s}const Kr=e=>e?mp(e)?Ti(e):Kr(e.parent):null,Wa=Oe(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Kr(e.parent),$root:e=>Kr(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Ho(e),$forceUpdate:e=>e.f||(e.f=()=>{Do(e.update)}),$nextTick:e=>e.n||(e.n=Et.bind(e.proxy)),$watch:e=>Jm.bind(e)}),br=(e,t)=>e!==Pe&&!e.__isScriptSetup&&He(e,t),Gr={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:a,props:i,accessCache:l,type:r,appContext:o}=e;if(t[0]!=="$"){const f=l[t];if(f!==void 0)switch(f){case 1:return n[t];case 2:return a[t];case 4:return s[t];case 3:return i[t]}else{if(br(n,t))return l[t]=1,n[t];if(a!==Pe&&He(a,t))return l[t]=2,a[t];if(He(i,t))return l[t]=3,i[t];if(s!==Pe&&He(s,t))return l[t]=4,s[t];Wr&&(l[t]=0)}}const c=Wa[t];let u,d;if(c)return t==="$attrs"&&Pt(e.attrs,"get",""),c(e);if((u=r.__cssModules)&&(u=u[t]))return u;if(s!==Pe&&He(s,t))return l[t]=4,s[t];if(d=o.config.globalProperties,He(d,t))return d[t]},set({_:e},t,s){const{data:n,setupState:a,ctx:i}=e;return br(a,t)?(a[t]=s,!0):n!==Pe&&He(n,t)?(n[t]=s,!0):He(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:a,props:i,type:l}},r){let o;return!!(s[r]||e!==Pe&&r[0]!=="$"&&He(e,r)||br(t,r)||He(i,r)||He(n,r)||He(Wa,r)||He(a.config.globalProperties,r)||(o=l.__cssModules)&&o[r])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:He(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}},Ev=Oe({},Gr,{get(e,t){if(t!==Symbol.unscopables)return Gr.get(e,t,e)},has(e,t){return t[0]!=="_"&&!Lg(t)}});function Av(){return null}function Rv(){return null}function Iv(e){}function Nv(e){}function Dv(){return null}function Ov(){}function Lv(e,t){return null}function Pv(){return Hf().slots}function Mv(){return Hf().attrs}function Hf(e){const t=zt();return t.setupContext||(t.setupContext=xp(t))}function ri(e){return fe(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}function Fv(e,t){const s=ri(e);for(const n in t){if(n.startsWith("__skip"))continue;let a=s[n];a?fe(a)||ke(a)?a=s[n]={type:a,default:t[n]}:a.default=t[n]:a===null&&(a=s[n]={default:t[n]}),a&&t[`__skip_${n}`]&&(a.skipFactory=!0)}return s}function $v(e,t){return!e||!t?e||t:fe(e)&&fe(t)?e.concat(t):Oe({},ri(e),ri(t))}function Bv(e,t){const s={};for(const n in e)t.includes(n)||Object.defineProperty(s,n,{enumerable:!0,get:()=>e[n]});return s}function Uv(e){const t=zt(),s=On;let n=e();di(),s&&ua(!1);const a=()=>{Ca(t),s&&ua(!0)},i=()=>{zt()!==t&&t.scope.off(),di(),s&&ua(!1)};return So(n)&&(n=n.catch(l=>{throw a(),Promise.resolve().then(()=>Promise.resolve().then(i)),l})),[n,()=>{a(),Promise.resolve().then(i)}]}let Wr=!0;function Hv(e){const t=Ho(e),s=e.proxy,n=e.ctx;Wr=!1,t.beforeCreate&&au(t.beforeCreate,e,"bc");const{data:a,computed:i,methods:l,watch:r,provide:o,inject:c,created:u,beforeMount:d,mounted:f,beforeUpdate:p,updated:m,activated:g,deactivated:k,beforeDestroy:A,beforeUnmount:b,destroyed:v,unmounted:x,render:R,renderTracked:D,renderTriggered:O,errorCaptured:S,serverPrefetch:I,expose:w,inheritAttrs:$,components:F,directives:P,filters:W}=t;if(c&&Vv(c,n,null),l)for(const N in l){const L=l[N];ke(L)&&(n[N]=L.bind(s))}if(a){const N=a.call(s,s);Ue(N)&&(e.data=gn(N))}if(Wr=!0,i)for(const N in i){const L=i[N],q=ke(L)?L.bind(s,s):ke(L.get)?L.get.bind(s,s):It,ue=!ke(L)&&ke(L.set)?L.set.bind(s):It,ve=ee({get:q,set:ue});Object.defineProperty(n,N,{enumerable:!0,configurable:!0,get:()=>ve.value,set:se=>ve.value=se})}if(r)for(const N in r)Vf(r[N],n,s,N);if(o){const N=ke(o)?o.call(s):o;Reflect.ownKeys(N).forEach(L=>{Ga(L,N[L])})}u&&au(u,e,"c");function V(N,L){fe(L)?L.forEach(q=>N(q.bind(s))):L&&N(L.bind(s))}if(V(Pf,d),V($e,f),V(Fo,p),V(Kl,m),V(Df,g),V(Of,k),V(Bf,S),V($f,D),V(Ff,O),V(Gl,b),V(ft,x),V(Mf,I),fe(w))if(w.length){const N=e.exposed||(e.exposed={});w.forEach(L=>{Object.defineProperty(N,L,{get:()=>s[L],set:q=>s[L]=q,enumerable:!0})})}else e.exposed||(e.exposed={});R&&e.render===It&&(e.render=R),$!=null&&(e.inheritAttrs=$),F&&(e.components=F),P&&(e.directives=P),I&&Mo(e)}function Vv(e,t,s=It){fe(e)&&(e=Jr(e));for(const n in e){const a=e[n];let i;Ue(a)?"default"in a?i=us(a.from||n,a.default,!0):i=us(a.from||n):i=us(a),gt(i)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):t[n]=i}}function au(e,t,s){ss(fe(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function Vf(e,t,s,n){let a=n.includes(".")?Tf(s,n):()=>s[n];if(Te(e)){const i=t[e];ke(i)&&ds(a,i)}else if(ke(e))ds(a,e.bind(s));else if(Ue(e))if(fe(e))e.forEach(i=>Vf(i,t,s,n));else{const i=ke(e.handler)?e.handler.bind(s):t[e.handler];ke(i)&&ds(a,i,e)}}function Ho(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:a,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,r=i.get(t);let o;return r?o=r:!a.length&&!s&&!n?o=t:(o={},a.length&&a.forEach(c=>cl(o,c,l,!0)),cl(o,t,l)),Ue(t)&&i.set(t,o),o}function cl(e,t,s,n=!1){const{mixins:a,extends:i}=t;i&&cl(e,i,s,!0),a&&a.forEach(l=>cl(e,l,s,!0));for(const l in t)if(!(n&&l==="expose")){const r=jv[l]||s&&s[l];e[l]=r?r(e[l],t[l]):t[l]}return e}const jv={data:iu,props:lu,emits:lu,methods:Va,computed:Va,beforeCreate:Bt,created:Bt,beforeMount:Bt,mounted:Bt,beforeUpdate:Bt,updated:Bt,beforeDestroy:Bt,beforeUnmount:Bt,destroyed:Bt,unmounted:Bt,activated:Bt,deactivated:Bt,errorCaptured:Bt,serverPrefetch:Bt,components:Va,directives:Va,watch:qv,provide:iu,inject:zv};function iu(e,t){return t?e?function(){return Oe(ke(e)?e.call(this,this):e,ke(t)?t.call(this,this):t)}:t:e}function zv(e,t){return Va(Jr(e),Jr(t))}function Jr(e){if(fe(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Bt(e,t){return e?[...new Set([].concat(e,t))]:t}function Va(e,t){return e?Oe(Object.create(null),e,t):t}function lu(e,t){return e?fe(e)&&fe(t)?[...new Set([...e,...t])]:Oe(Object.create(null),ri(e),ri(t??{})):t}function qv(e,t){if(!e)return t;if(!t)return e;const s=Oe(Object.create(null),e);for(const n in t)s[n]=Bt(e[n],t[n]);return s}function jf(){return{app:null,config:{isNativeTag:ta,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Kv=0;function Gv(e,t){return function(n,a=null){ke(n)||(n=Oe({},n)),a!=null&&!Ue(a)&&(a=null);const i=jf(),l=new WeakSet,r=[];let o=!1;const c=i.app={_uid:Kv++,_component:n,_props:a,_container:null,_context:i,_instance:null,version:kp,get config(){return i.config},set config(u){},use(u,...d){return l.has(u)||(u&&ke(u.install)?(l.add(u),u.install(c,...d)):ke(u)&&(l.add(u),u(c,...d))),c},mixin(u){return i.mixins.includes(u)||i.mixins.push(u),c},component(u,d){return d?(i.components[u]=d,c):i.components[u]},directive(u,d){return d?(i.directives[u]=d,c):i.directives[u]},mount(u,d,f){if(!o){const p=c._ceVNode||at(n,a);return p.appContext=i,f===!0?f="svg":f===!1&&(f=void 0),d&&t?t(p,u):e(p,u,f),o=!0,c._container=u,u.__vue_app__=c,Ti(p.component)}},onUnmount(u){r.push(u)},unmount(){o&&(ss(r,c._instance,16),e(null,c._container),delete c._container.__vue_app__)},provide(u,d){return i.provides[u]=d,c},runWithContext(u){const d=En;En=c;try{return u()}finally{En=d}}};return c}}let En=null;function Wv(e,t,s=Pe){const n=zt(),a=Ke(t),i=Yt(t),l=zf(e,a),r=hf((o,c)=>{let u,d=Pe,f;return Sf(()=>{const p=e[a];kt(u,p)&&(u=p,c())}),{get(){return o(),s.get?s.get(u):u},set(p){const m=s.set?s.set(p):p;if(!kt(m,u)&&!(d!==Pe&&kt(p,d)))return;const g=n.vnode.props,k=!!(g&&(t in g||a in g||i in g)&&(`onUpdate:${t}`in g||`onUpdate:${a}`in g||`onUpdate:${i}`in g));k||(u=p,c()),n.emit(`update:${t}`,m),kt(p,d)&&(kt(p,m)&&!kt(m,f)||k&&d!==Pe&&!kt(m,u))&&c(),d=p,f=m}}});return r[Symbol.iterator]=()=>{let o=0;return{next(){return o<2?{value:o++?l||Pe:r,done:!1}:{done:!0}}}},r}const zf=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Ke(t)}Modifiers`]||e[`${Yt(t)}Modifiers`];function Jv(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||Pe;let a=s;const i=t.startsWith("update:"),l=i&&zf(n,t.slice(7));l&&(l.trim&&(a=s.map(u=>Te(u)?u.trim():u)),l.number&&(a=s.map(Ml)));let r,o=n[r=ia(t)]||n[r=ia(Ke(t))];!o&&i&&(o=n[r=ia(Yt(t))]),o&&ss(o,e,6,a);const c=n[r+"Once"];if(c){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,ss(c,e,6,a)}}const Zv=new WeakMap;function qf(e,t,s=!1){const n=s?Zv:t.emitsCache,a=n.get(e);if(a!==void 0)return a;const i=e.emits;let l={},r=!1;if(!ke(e)){const o=c=>{const u=qf(c,t,!0);u&&(r=!0,Oe(l,u))};!s&&t.mixins.length&&t.mixins.forEach(o),e.extends&&o(e.extends),e.mixins&&e.mixins.forEach(o)}return!i&&!r?(Ue(e)&&n.set(e,null),null):(fe(i)?i.forEach(o=>l[o]=null):Oe(l,i),Ue(e)&&n.set(e,l),l)}function Wl(e,t){return!e||!Mn(t)?!1:(t=t.slice(2).replace(/Once$/,""),He(e,t[0].toLowerCase()+t.slice(1))||He(e,Yt(t))||He(e,t))}function Ji(e){const{type:t,vnode:s,proxy:n,withProxy:a,propsOptions:[i],slots:l,attrs:r,emit:o,render:c,renderCache:u,props:d,data:f,setupState:p,ctx:m,inheritAttrs:g}=e,k=li(e);let A,b;try{if(s.shapeFlag&4){const x=a||n,R=x;A=Zt(c.call(R,x,u,d,p,f,m)),b=r}else{const x=t;A=Zt(x.length>1?x(d,{attrs:r,slots:l,emit:o}):x(d,null)),b=t.props?r:Qv(r)}}catch(x){Ja.length=0,Bn(x,e,1),A=at(dt)}let v=A;if(b&&g!==!1){const x=Object.keys(b),{shapeFlag:R}=v;x.length&&R&7&&(i&&x.some(Dl)&&(b=Xv(b,i)),v=Rs(v,b,!1,!0))}return s.dirs&&(v=Rs(v,null,!1,!0),v.dirs=v.dirs?v.dirs.concat(s.dirs):s.dirs),s.transition&&Ys(v,s.transition),A=v,li(k),A}function Yv(e,t=!0){let s;for(let n=0;n<e.length;n++){const a=e[n];if(Qs(a)){if(a.type!==dt||a.children==="v-if"){if(s)return;s=a}}else return}return s}const Qv=e=>{let t;for(const s in e)(s==="class"||s==="style"||Mn(s))&&((t||(t={}))[s]=e[s]);return t},Xv=(e,t)=>{const s={};for(const n in e)(!Dl(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function eb(e,t,s){const{props:n,children:a,component:i}=e,{props:l,children:r,patchFlag:o}=t,c=i.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&o>=0){if(o&1024)return!0;if(o&16)return n?ru(n,l,c):!!l;if(o&8){const u=t.dynamicProps;for(let d=0;d<u.length;d++){const f=u[d];if(Kf(l,n,f)&&!Wl(c,f))return!0}}}else return(a||r)&&(!r||!r.$stable)?!0:n===l?!1:n?l?ru(n,l,c):!0:!!l;return!1}function ru(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let a=0;a<n.length;a++){const i=n[a];if(Kf(t,e,i)&&!Wl(s,i))return!0}return!1}function Kf(e,t,s){const n=e[s],a=t[s];return s==="style"&&Ue(n)&&Ue(a)?!Ws(n,a):n!==a}function Jl({vnode:e,parent:t,suspense:s},n){for(;t;){const a=t.subTree;if(a.suspense&&a.suspense.activeBranch===e&&(a.suspense.vnode.el=a.el=n,e=a),a===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const Gf={},Wf=()=>Object.create(Gf),Jf=e=>Object.getPrototypeOf(e)===Gf;function tb(e,t,s,n=!1){const a={},i=Wf();e.propsDefaults=Object.create(null),Zf(e,t,a,i);for(const l in e.propsOptions[0])l in a||(a[l]=void 0);s?e.props=n?a:Ro(a):e.type.props?e.props=a:e.props=i,e.attrs=i}function sb(e,t,s,n){const{props:a,attrs:i,vnode:{patchFlag:l}}=e,r=Fe(a),[o]=e.propsOptions;let c=!1;if((n||l>0)&&!(l&16)){if(l&8){const u=e.vnode.dynamicProps;for(let d=0;d<u.length;d++){let f=u[d];if(Wl(e.emitsOptions,f))continue;const p=t[f];if(o)if(He(i,f))p!==i[f]&&(i[f]=p,c=!0);else{const m=Ke(f);a[m]=Zr(o,r,m,p,e,!1)}else p!==i[f]&&(i[f]=p,c=!0)}}}else{Zf(e,t,a,i)&&(c=!0);let u;for(const d in r)(!t||!He(t,d)&&((u=Yt(d))===d||!He(t,u)))&&(o?s&&(s[d]!==void 0||s[u]!==void 0)&&(a[d]=Zr(o,r,d,void 0,e,!0)):delete a[d]);if(i!==r)for(const d in i)(!t||!He(t,d))&&(delete i[d],c=!0)}c&&Bs(e.attrs,"set","")}function Zf(e,t,s,n){const[a,i]=e.propsOptions;let l=!1,r;if(t)for(let o in t){if(zs(o))continue;const c=t[o];let u;a&&He(a,u=Ke(o))?!i||!i.includes(u)?s[u]=c:(r||(r={}))[u]=c:Wl(e.emitsOptions,o)||(!(o in n)||c!==n[o])&&(n[o]=c,l=!0)}if(i){const o=Fe(s),c=r||Pe;for(let u=0;u<i.length;u++){const d=i[u];s[d]=Zr(a,o,d,c[d],e,!He(c,d))}}return l}function Zr(e,t,s,n,a,i){const l=e[s];if(l!=null){const r=He(l,"default");if(r&&n===void 0){const o=l.default;if(l.type!==Function&&!l.skipFactory&&ke(o)){const{propsDefaults:c}=a;if(s in c)n=c[s];else{const u=Ca(a);n=c[s]=o.call(null,t),u()}}else n=o;a.ce&&a.ce._setProp(s,n)}l[0]&&(i&&!r?n=!1:l[1]&&(n===""||n===Yt(s))&&(n=!0))}return n}const nb=new WeakMap;function Yf(e,t,s=!1){const n=s?nb:t.propsCache,a=n.get(e);if(a)return a;const i=e.props,l={},r=[];let o=!1;if(!ke(e)){const u=d=>{o=!0;const[f,p]=Yf(d,t,!0);Oe(l,f),p&&r.push(...p)};!s&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!i&&!o)return Ue(e)&&n.set(e,na),na;if(fe(i))for(let u=0;u<i.length;u++){const d=Ke(i[u]);ou(d)&&(l[d]=Pe)}else if(i)for(const u in i){const d=Ke(u);if(ou(d)){const f=i[u],p=l[d]=fe(f)||ke(f)?{type:f}:Oe({},f),m=p.type;let g=!1,k=!0;if(fe(m))for(let A=0;A<m.length;++A){const b=m[A],v=ke(b)&&b.name;if(v==="Boolean"){g=!0;break}else v==="String"&&(k=!1)}else g=ke(m)&&m.name==="Boolean";p[0]=g,p[1]=k,(g||He(p,"default"))&&r.push(d)}}const c=[l,r];return Ue(e)&&n.set(e,c),c}function ou(e){return e[0]!=="$"&&!zs(e)}const Vo=e=>e==="_"||e==="_ctx"||e==="$stable",jo=e=>fe(e)?e.map(Zt):[Zt(e)],ab=(e,t,s)=>{if(t._n)return t;const n=Oo((...a)=>jo(t(...a)),s);return n._c=!1,n},Qf=(e,t,s)=>{const n=e._ctx;for(const a in e){if(Vo(a))continue;const i=e[a];if(ke(i))t[a]=ab(a,i,n);else if(i!=null){const l=jo(i);t[a]=()=>l}}},Xf=(e,t)=>{const s=jo(t);e.slots.default=()=>s},ep=(e,t,s)=>{for(const n in t)(s||!Vo(n))&&(e[n]=t[n])},ib=(e,t,s)=>{const n=e.slots=Wf();if(e.vnode.shapeFlag&32){const a=t._;a?(ep(n,t,s),s&&jd(n,"_",a,!0)):Qf(t,n)}else t&&Xf(e,t)},lb=(e,t,s)=>{const{vnode:n,slots:a}=e;let i=!0,l=Pe;if(n.shapeFlag&32){const r=t._;r?s&&r===1?i=!1:ep(a,t,s):(i=!t.$stable,Qf(t,a)),l=t}else t&&(Xf(e,t),l={default:1});if(i)for(const r in a)!Vo(r)&&l[r]==null&&delete a[r]},pt=op;function tp(e){return np(e)}function sp(e){return np(e,iv)}function np(e,t){const s=Fl();s.__VUE__=!0;const{insert:n,remove:a,patchProp:i,createElement:l,createText:r,createComment:o,setText:c,setElementText:u,parentNode:d,nextSibling:f,setScopeId:p=It,insertStaticContent:m}=e,g=(y,T,M,G=null,E=null,B=null,J=void 0,X=null,te=!!T.dynamicChildren)=>{if(y===T)return;y&&!gs(y,T)&&(G=j(y),se(y,E,B,!0),y=null),T.patchFlag===-2&&(te=!1,T.dynamicChildren=null);const{type:Y,ref:pe,shapeFlag:ie}=T;switch(Y){case fn:k(y,T,M,G);break;case dt:A(y,T,M,G);break;case An:y==null&&b(T,M,G,J);break;case wt:F(y,T,M,G,E,B,J,X,te);break;default:ie&1?R(y,T,M,G,E,B,J,X,te):ie&6?P(y,T,M,G,E,B,J,X,te):(ie&64||ie&128)&&Y.process(y,T,M,G,E,B,J,X,te,ge)}pe!=null&&E?oa(pe,y&&y.ref,B,T||y,!T):pe==null&&y&&y.ref!=null&&oa(y.ref,null,B,y,!0)},k=(y,T,M,G)=>{if(y==null)n(T.el=r(T.children),M,G);else{const E=T.el=y.el;T.children!==y.children&&c(E,T.children)}},A=(y,T,M,G)=>{y==null?n(T.el=o(T.children||""),M,G):T.el=y.el},b=(y,T,M,G)=>{[y.el,y.anchor]=m(y.children,T,M,G,y.el,y.anchor)},v=({el:y,anchor:T},M,G)=>{let E;for(;y&&y!==T;)E=f(y),n(y,M,G),y=E;n(T,M,G)},x=({el:y,anchor:T})=>{let M;for(;y&&y!==T;)M=f(y),a(y),y=M;a(T)},R=(y,T,M,G,E,B,J,X,te)=>{if(T.type==="svg"?J="svg":T.type==="math"&&(J="mathml"),y==null)D(T,M,G,E,B,J,X,te);else{const Y=y.el&&y.el._isVueCE?y.el:null;try{Y&&Y._beginPatch(),I(y,T,E,B,J,X,te)}finally{Y&&Y._endPatch()}}},D=(y,T,M,G,E,B,J,X)=>{let te,Y;const{props:pe,shapeFlag:ie,transition:ce,dirs:ye}=y;if(te=y.el=l(y.type,B,pe&&pe.is,pe),ie&8?u(te,y.children):ie&16&&S(y.children,te,null,G,E,yr(y,B),J,X),ye&&Ts(y,null,G,"created"),O(te,y,y.scopeId,J,G),pe){for(const Ee in pe)Ee!=="value"&&!zs(Ee)&&i(te,Ee,null,pe[Ee],B,G);"value"in pe&&i(te,"value",null,pe.value,B),(Y=pe.onVnodeBeforeMount)&&Wt(Y,G,y)}ye&&Ts(y,null,G,"beforeMount");const Se=ap(E,ce);Se&&ce.beforeEnter(te),n(te,T,M),((Y=pe&&pe.onVnodeMounted)||Se||ye)&&pt(()=>{try{Y&&Wt(Y,G,y),Se&&ce.enter(te),ye&&Ts(y,null,G,"mounted")}finally{}},E)},O=(y,T,M,G,E)=>{if(M&&p(y,M),G)for(let B=0;B<G.length;B++)p(y,G[B]);if(E){let B=E.subTree;if(T===B||dl(B.type)&&(B.ssContent===T||B.ssFallback===T)){const J=E.vnode;O(y,J,J.scopeId,J.slotScopeIds,E.parent)}}},S=(y,T,M,G,E,B,J,X,te=0)=>{for(let Y=te;Y<y.length;Y++){const pe=y[Y]=X?Fs(y[Y]):Zt(y[Y]);g(null,pe,T,M,G,E,B,J,X)}},I=(y,T,M,G,E,B,J)=>{const X=T.el=y.el;let{patchFlag:te,dynamicChildren:Y,dirs:pe}=T;te|=y.patchFlag&16;const ie=y.props||Pe,ce=T.props||Pe;let ye;if(M&&bn(M,!1),(ye=ce.onVnodeBeforeUpdate)&&Wt(ye,M,T,y),pe&&Ts(T,y,M,"beforeUpdate"),M&&bn(M,!0),(ie.innerHTML&&ce.innerHTML==null||ie.textContent&&ce.textContent==null)&&u(X,""),Y?w(y.dynamicChildren,Y,X,M,G,yr(T,E),B):J||L(y,T,X,null,M,G,yr(T,E),B,!1),te>0){if(te&16)$(X,ie,ce,M,E);else if(te&2&&ie.class!==ce.class&&i(X,"class",null,ce.class,E),te&4&&i(X,"style",ie.style,ce.style,E),te&8){const Se=T.dynamicProps;for(let Ee=0;Ee<Se.length;Ee++){const C=Se[Ee],Q=ie[C],be=ce[C];(be!==Q||C==="value")&&i(X,C,Q,be,E,M)}}te&1&&y.children!==T.children&&u(X,T.children)}else!J&&Y==null&&$(X,ie,ce,M,E);((ye=ce.onVnodeUpdated)||pe)&&pt(()=>{ye&&Wt(ye,M,T,y),pe&&Ts(T,y,M,"updated")},G)},w=(y,T,M,G,E,B,J)=>{for(let X=0;X<T.length;X++){const te=y[X],Y=T[X],pe=te.el&&(te.type===wt||!gs(te,Y)||te.shapeFlag&198)?d(te.el):M;g(te,Y,pe,null,G,E,B,J,!0)}},$=(y,T,M,G,E)=>{if(T!==M){if(T!==Pe)for(const B in T)!zs(B)&&!(B in M)&&i(y,B,T[B],null,E,G);for(const B in M){if(zs(B))continue;const J=M[B],X=T[B];J!==X&&B!=="value"&&i(y,B,X,J,E,G)}"value"in M&&i(y,"value",T.value,M.value,E)}},F=(y,T,M,G,E,B,J,X,te)=>{const Y=T.el=y?y.el:r(""),pe=T.anchor=y?y.anchor:r("");let{patchFlag:ie,dynamicChildren:ce,slotScopeIds:ye}=T;ye&&(X=X?X.concat(ye):ye),y==null?(n(Y,M,G),n(pe,M,G),S(T.children||[],M,pe,E,B,J,X,te)):ie>0&&ie&64&&ce&&y.dynamicChildren&&y.dynamicChildren.length===ce.length?(w(y.dynamicChildren,ce,M,E,B,J,X),(T.key!=null||E&&T===E.subTree)&&zo(y,T,!0)):L(y,T,M,pe,E,B,J,X,te)},P=(y,T,M,G,E,B,J,X,te)=>{T.slotScopeIds=X,y==null?T.shapeFlag&512?E.ctx.activate(T,M,G,J,te):W(T,M,G,E,B,J,te):U(y,T,te)},W=(y,T,M,G,E,B,J)=>{const X=y.component=gp(y,G,E);if(Si(y)&&(X.ctx.renderer=ge),vp(X,!1,J),X.asyncDep){if(E&&E.registerDep(X,V,J),!y.el){const te=X.subTree=at(dt);A(null,te,T,M),y.placeholder=te.el}}else V(X,y,T,M,E,B,J)},U=(y,T,M)=>{const G=T.component=y.component;if(eb(y,T,M))if(G.asyncDep&&!G.asyncResolved){N(G,T,M);return}else G.next=T,G.update();else T.el=y.el,G.vnode=T},V=(y,T,M,G,E,B,J)=>{const X=()=>{if(y.isMounted){let{next:ie,bu:ce,u:ye,parent:Se,vnode:Ee}=y;{const Je=ip(y);if(Je){ie&&(ie.el=Ee.el,N(y,ie,J)),Je.asyncDep.then(()=>{pt(()=>{y.isUnmounted||Y()},E)});return}}let C=ie,Q;bn(y,!1),ie?(ie.el=Ee.el,N(y,ie,J)):ie=Ee,ce&&la(ce),(Q=ie.props&&ie.props.onVnodeBeforeUpdate)&&Wt(Q,Se,ie,Ee),bn(y,!0);const be=Ji(y),Le=y.subTree;y.subTree=be,g(Le,be,d(Le.el),j(Le),y,E,B),ie.el=be.el,C===null&&Jl(y,be.el),ye&&pt(ye,E),(Q=ie.props&&ie.props.onVnodeUpdated)&&pt(()=>Wt(Q,Se,ie,Ee),E)}else{let ie;const{el:ce,props:ye}=T,{bm:Se,m:Ee,parent:C,root:Q,type:be}=y,Le=Ks(T);if(bn(y,!1),Se&&la(Se),!Le&&(ie=ye&&ye.onVnodeBeforeMount)&&Wt(ie,C,T),bn(y,!0),ce&&De){const Je=()=>{y.subTree=Ji(y),De(ce,y.subTree,y,E,null)};Le&&be.__asyncHydrate?be.__asyncHydrate(ce,y,Je):Je()}else{Q.ce&&Q.ce._hasShadowRoot()&&Q.ce._injectChildStyle(be,y.parent?y.parent.type:void 0);const Je=y.subTree=Ji(y);g(null,Je,M,G,y,E,B),T.el=Je.el}if(Ee&&pt(Ee,E),!Le&&(ie=ye&&ye.onVnodeMounted)){const Je=T;pt(()=>Wt(ie,C,Je),E)}(T.shapeFlag&256||C&&Ks(C.vnode)&&C.vnode.shapeFlag&256)&&y.a&&pt(y.a,E),y.isMounted=!0,T=M=G=null}};y.scope.on();const te=y.effect=new ti(X);y.scope.off();const Y=y.update=te.run.bind(te),pe=y.job=te.runIfDirty.bind(te);pe.i=y,pe.id=y.uid,te.scheduler=()=>Do(pe),bn(y,!0),Y()},N=(y,T,M)=>{T.component=y;const G=y.vnode.props;y.vnode=T,y.next=null,sb(y,T.props,G,M),lb(y,T.children,M),Js(),Jc(y),Zs()},L=(y,T,M,G,E,B,J,X,te=!1)=>{const Y=y&&y.children,pe=y?y.shapeFlag:0,ie=T.children,{patchFlag:ce,shapeFlag:ye}=T;if(ce>0){if(ce&128){ue(Y,ie,M,G,E,B,J,X,te);return}else if(ce&256){q(Y,ie,M,G,E,B,J,X,te);return}}ye&8?(pe&16&&Ie(Y,E,B),ie!==Y&&u(M,ie)):pe&16?ye&16?ue(Y,ie,M,G,E,B,J,X,te):Ie(Y,E,B,!0):(pe&8&&u(M,""),ye&16&&S(ie,M,G,E,B,J,X,te))},q=(y,T,M,G,E,B,J,X,te)=>{y=y||na,T=T||na;const Y=y.length,pe=T.length,ie=Math.min(Y,pe);let ce;for(ce=0;ce<ie;ce++){const ye=T[ce]=te?Fs(T[ce]):Zt(T[ce]);g(y[ce],ye,M,null,E,B,J,X,te)}Y>pe?Ie(y,E,B,!0,!1,ie):S(T,M,G,E,B,J,X,te,ie)},ue=(y,T,M,G,E,B,J,X,te)=>{let Y=0;const pe=T.length;let ie=y.length-1,ce=pe-1;for(;Y<=ie&&Y<=ce;){const ye=y[Y],Se=T[Y]=te?Fs(T[Y]):Zt(T[Y]);if(gs(ye,Se))g(ye,Se,M,null,E,B,J,X,te);else break;Y++}for(;Y<=ie&&Y<=ce;){const ye=y[ie],Se=T[ce]=te?Fs(T[ce]):Zt(T[ce]);if(gs(ye,Se))g(ye,Se,M,null,E,B,J,X,te);else break;ie--,ce--}if(Y>ie){if(Y<=ce){const ye=ce+1,Se=ye<pe?T[ye].el:G;for(;Y<=ce;)g(null,T[Y]=te?Fs(T[Y]):Zt(T[Y]),M,Se,E,B,J,X,te),Y++}}else if(Y>ce)for(;Y<=ie;)se(y[Y],E,B,!0),Y++;else{const ye=Y,Se=Y,Ee=new Map;for(Y=Se;Y<=ce;Y++){const st=T[Y]=te?Fs(T[Y]):Zt(T[Y]);st.key!=null&&Ee.set(st.key,Y)}let C,Q=0;const be=ce-Se+1;let Le=!1,Je=0;const Ge=new Array(be);for(Y=0;Y<be;Y++)Ge[Y]=0;for(Y=ye;Y<=ie;Y++){const st=y[Y];if(Q>=be){se(st,E,B,!0);continue}let Ze;if(st.key!=null)Ze=Ee.get(st.key);else for(C=Se;C<=ce;C++)if(Ge[C-Se]===0&&gs(st,T[C])){Ze=C;break}Ze===void 0?se(st,E,B,!0):(Ge[Ze-Se]=Y+1,Ze>=Je?Je=Ze:Le=!0,g(st,T[Ze],M,null,E,B,J,X,te),Q++)}const St=Le?rb(Ge):na;for(C=St.length-1,Y=be-1;Y>=0;Y--){const st=Se+Y,Ze=T[st],en=T[st+1],mn=st+1<pe?en.el||lp(en):G;Ge[Y]===0?g(null,Ze,M,mn,E,B,J,X,te):Le&&(C<0||Y!==St[C]?ve(Ze,M,mn,2):C--)}}},ve=(y,T,M,G,E=null)=>{const{el:B,type:J,transition:X,children:te,shapeFlag:Y}=y;if(Y&6){ve(y.component.subTree,T,M,G);return}if(Y&128){y.suspense.move(T,M,G);return}if(Y&64){J.move(y,T,M,ge);return}if(J===wt){n(B,T,M);for(let ie=0;ie<te.length;ie++)ve(te[ie],T,M,G);n(y.anchor,T,M);return}if(J===An){v(y,T,M);return}if(G!==2&&Y&1&&X)if(G===0)X.persisted&&!B[rs]?n(B,T,M):(X.beforeEnter(B),n(B,T,M),pt(()=>X.enter(B),E));else{const{leave:ie,delayLeave:ce,afterLeave:ye}=X,Se=()=>{y.ctx.isUnmounted?a(B):n(B,T,M)},Ee=()=>{const C=B._isLeaving||!!B[rs];B._isLeaving&&B[rs](!0),X.persisted&&!C?Se():ie(B,()=>{Se(),ye&&ye()})};ce?ce(B,Se,Ee):Ee()}else n(B,T,M)},se=(y,T,M,G=!1,E=!1)=>{const{type:B,props:J,ref:X,children:te,dynamicChildren:Y,shapeFlag:pe,patchFlag:ie,dirs:ce,cacheIndex:ye,memo:Se}=y;if(ie===-2&&(E=!1),X!=null&&(Js(),oa(X,null,M,y,!0),Zs()),ye!=null&&(T.renderCache[ye]=void 0),pe&256){T.ctx.deactivate(y);return}const Ee=pe&1&&ce,C=!Ks(y);let Q;if(C&&(Q=J&&J.onVnodeBeforeUnmount)&&Wt(Q,T,y),pe&6)oe(y.component,M,G);else{if(pe&128){y.suspense.unmount(M,G);return}Ee&&Ts(y,null,T,"beforeUnmount"),pe&64?y.type.remove(y,T,M,ge,G):Y&&!Y.hasOnce&&(B!==wt||ie>0&&ie&64)?Ie(Y,T,M,!1,!0):(B===wt&&ie&384||!E&&pe&16)&&Ie(te,T,M),G&&de(y)}const be=Se!=null&&ye==null;(C&&(Q=J&&J.onVnodeUnmounted)||Ee||be)&&pt(()=>{Q&&Wt(Q,T,y),Ee&&Ts(y,null,T,"unmounted"),be&&(y.el=null)},M)},de=y=>{const{type:T,el:M,anchor:G,transition:E}=y;if(T===wt){Z(M,G);return}if(T===An){x(y);return}const B=()=>{a(M),E&&!E.persisted&&E.afterLeave&&E.afterLeave()};if(y.shapeFlag&1&&E&&!E.persisted){const{leave:J,delayLeave:X}=E,te=()=>J(M,B);X?X(y.el,B,te):te()}else B()},Z=(y,T)=>{let M;for(;y!==T;)M=f(y),a(y),y=M;a(T)},oe=(y,T,M)=>{const{bum:G,scope:E,job:B,subTree:J,um:X,m:te,a:Y}=y;ul(te),ul(Y),G&&la(G),E.stop(),B&&(B.flags|=8,se(J,y,T,M)),X&&pt(X,T),pt(()=>{y.isUnmounted=!0},T)},Ie=(y,T,M,G=!1,E=!1,B=0)=>{for(let J=B;J<y.length;J++)se(y[J],T,M,G,E)},j=y=>{if(y.shapeFlag&6)return j(y.component.subTree);if(y.shapeFlag&128)return y.suspense.next();const T=f(y.anchor||y.el),M=T&&T[Cf];return M?f(M):T};let re=!1;const le=(y,T,M)=>{let G;y==null?T._vnode&&(se(T._vnode,null,null,!0),G=T._vnode.component):g(T._vnode||null,y,T,null,null,null,M),T._vnode=y,re||(re=!0,Jc(G),rl(),re=!1)},ge={p:g,um:se,m:ve,r:de,mt:W,mc:S,pc:L,pbc:w,n:j,o:e};let me,De;return t&&([me,De]=t(ge)),{render:le,hydrate:me,createApp:Gv(le,me)}}function yr({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function bn({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function ap(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function zo(e,t,s=!1){const n=e.children,a=t.children;if(fe(n)&&fe(a))for(let i=0;i<n.length;i++){const l=n[i];let r=a[i];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=a[i]=Fs(a[i]),r.el=l.el),!s&&r.patchFlag!==-2&&zo(l,r)),r.type===fn&&(r.patchFlag===-1&&(r=a[i]=Fs(r)),r.el=l.el),r.type===dt&&!r.el&&(r.el=l.el)}}function rb(e){const t=e.slice(),s=[0];let n,a,i,l,r;const o=e.length;for(n=0;n<o;n++){const c=e[n];if(c!==0){if(a=s[s.length-1],e[a]<c){t[n]=a,s.push(n);continue}for(i=0,l=s.length-1;i<l;)r=i+l>>1,e[s[r]]<c?i=r+1:l=r;c<e[s[i]]&&(i>0&&(t[n]=s[i-1]),s[i]=n)}}for(i=s.length,l=s[i-1];i-- >0;)s[i]=l,l=t[l];return s}function ip(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:ip(t)}function ul(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function lp(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?lp(t.subTree):null}const dl=e=>e.__isSuspense;let Yr=0;const ob={name:"Suspense",__isSuspense:!0,process(e,t,s,n,a,i,l,r,o,c){if(e==null)ub(t,s,n,a,i,l,r,o,c);else{if(i&&i.deps>0&&!e.suspense.isInFallback){t.suspense=e.suspense,t.suspense.vnode=t,t.el=e.el;return}db(e,t,s,n,a,l,r,o,c)}},hydrate:fb,normalize:pb},cb=ob;function oi(e,t){const s=e.props&&e.props[t];ke(s)&&s()}function ub(e,t,s,n,a,i,l,r,o){const{p:c,o:{createElement:u}}=o,d=u("div"),f=e.suspense=rp(e,a,n,t,d,s,i,l,r,o);c(null,f.pendingBranch=e.ssContent,d,null,n,f,i,l),f.deps>0?(oi(e,"onPending"),oi(e,"onFallback"),c(null,e.ssFallback,t,s,n,null,i,l),ca(f,e.ssFallback)):f.resolve(!1,!0)}function db(e,t,s,n,a,i,l,r,{p:o,um:c,o:{createElement:u}}){const d=t.suspense=e.suspense;d.vnode=t,t.el=e.el;const f=t.ssContent,p=t.ssFallback,{activeBranch:m,pendingBranch:g,isInFallback:k,isHydrating:A}=d;if(g)d.pendingBranch=f,gs(g,f)?(o(g,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():k&&(A||(o(m,p,s,n,a,null,i,l,r),ca(d,p)))):(d.pendingId=Yr++,A?(d.isHydrating=!1,d.activeBranch=g):c(g,a,d),d.deps=0,d.effects.length=0,d.hiddenContainer=u("div"),k?(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():(o(m,p,s,n,a,null,i,l,r),ca(d,p))):m&&gs(m,f)?(o(m,f,s,n,a,d,i,l,r),d.resolve(!0)):(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0&&d.resolve()));else if(m&&gs(m,f))o(m,f,s,n,a,d,i,l,r),ca(d,f);else if(oi(t,"onPending"),d.pendingBranch=f,f.shapeFlag&512?d.pendingId=f.component.suspenseId:d.pendingId=Yr++,o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0)d.resolve();else{const{timeout:b,pendingId:v}=d;b>0?setTimeout(()=>{d.pendingId===v&&d.fallback(p)},b):b===0&&d.fallback(p)}}function rp(e,t,s,n,a,i,l,r,o,c,u=!1){const{p:d,m:f,um:p,n:m,o:{parentNode:g,remove:k}}=c;let A;const b=hb(e);b&&t&&t.pendingBranch&&(A=t.pendingId,t.deps++);const v=e.props?sl(e.props.timeout):void 0,x=i,R={vnode:e,parent:t,parentComponent:s,namespace:l,container:n,hiddenContainer:a,deps:0,pendingId:Yr++,timeout:typeof v=="number"?v:-1,activeBranch:null,isFallbackMountPending:!1,pendingBranch:null,isInFallback:!u,isHydrating:u,isUnmounted:!1,effects:[],resolve(D=!1,O=!1){const{vnode:S,activeBranch:I,pendingBranch:w,pendingId:$,effects:F,parentComponent:P,container:W,isInFallback:U}=R;let V=!1;if(R.isHydrating)R.isHydrating=!1;else if(!D){V=I&&w.transition&&w.transition.mode==="out-in";let q=!1;V&&(I.transition.afterLeave=()=>{$===R.pendingId&&(f(w,W,i===x&&!q?m(I):i,0),ai(F),U&&S.ssFallback&&(S.ssFallback.el=null))}),I&&!R.isFallbackMountPending&&(g(I.el)===W&&(i=m(I),q=!0),p(I,P,R,!0),!V&&U&&S.ssFallback&&pt(()=>S.ssFallback.el=null,R)),V||f(w,W,i,0)}R.isFallbackMountPending=!1,ca(R,w),R.pendingBranch=null,R.isInFallback=!1;let N=R.parent,L=!1;for(;N;){if(N.pendingBranch){N.effects.push(...F),L=!0;break}N=N.parent}!L&&!V&&ai(F),R.effects=[],b&&t&&t.pendingBranch&&A===t.pendingId&&(t.deps--,t.deps===0&&!O&&t.resolve()),oi(S,"onResolve")},fallback(D){if(!R.pendingBranch)return;const{vnode:O,activeBranch:S,parentComponent:I,container:w,namespace:$}=R;oi(O,"onFallback");const F=m(S),P=()=>{R.isFallbackMountPending=!1,R.isInFallback&&(d(null,D,w,F,I,null,$,r,o),ca(R,D))},W=D.transition&&D.transition.mode==="out-in";W&&(R.isFallbackMountPending=!0,S.transition.afterLeave=P),R.isInFallback=!0,p(S,I,null,!0),W||P()},move(D,O,S){R.activeBranch&&f(R.activeBranch,D,O,S),R.container=D},next(){return R.activeBranch&&m(R.activeBranch)},registerDep(D,O,S){const I=!!R.pendingBranch;I&&R.deps++;const w=D.vnode.el;D.asyncDep.catch($=>{Bn($,D,0)}).then($=>{if(D.isUnmounted||R.isUnmounted||R.pendingId!==D.suspenseId)return;di(),D.asyncResolved=!0;const{vnode:F}=D;Qr(D,$,!1),w&&(F.el=w);const P=!w&&D.subTree.el;O(D,F,g(w||D.subTree.el),w?null:m(D.subTree),R,l,S),P&&(F.placeholder=null,k(P)),Jl(D,F.el),I&&--R.deps===0&&R.resolve()})},unmount(D,O){R.isUnmounted=!0,R.activeBranch&&p(R.activeBranch,s,D,O),R.pendingBranch&&p(R.pendingBranch,s,D,O)}};return R}function fb(e,t,s,n,a,i,l,r,o){const c=t.suspense=rp(t,n,s,e.parentNode,document.createElement("div"),null,a,i,l,r,!0),u=o(e,c.pendingBranch=t.ssContent,s,c,i,l);return c.deps===0&&c.resolve(!1,!0),u}function pb(e){const{shapeFlag:t,children:s}=e,n=t&32;e.ssContent=cu(n?s.default:s),e.ssFallback=n?cu(s.fallback):at(dt)}function cu(e){let t;if(ke(e)){const s=Dn&&e._c;s&&(e._d=!1,ci()),e=e(),s&&(e._d=!0,t=Mt,cp())}return fe(e)&&(e=Yv(e)),e=Zt(e),t&&!e.dynamicChildren&&(e.dynamicChildren=t.filter(s=>s!==e)),e}function op(e,t){t&&t.pendingBranch?fe(e)?t.effects.push(...e):t.effects.push(e):ai(e)}function ca(e,t){e.activeBranch=t;const{vnode:s,parentComponent:n}=e;let a=t.el;for(;!a&&t.component;)t=t.component.subTree,a=t.el;s.el=a,n&&n.subTree===s&&(n.vnode.el=a,Jl(n,a))}function hb(e){const t=e.props&&e.props.suspensible;return t!=null&&t!==!1}const wt=Symbol.for("v-fgt"),fn=Symbol.for("v-txt"),dt=Symbol.for("v-cmt"),An=Symbol.for("v-stc"),Ja=[];let Mt=null;function ci(e=!1){Ja.push(Mt=e?null:[])}function cp(){Ja.pop(),Mt=Ja[Ja.length-1]||null}let Dn=1;function ui(e,t=!1){Dn+=e,e<0&&Mt&&t&&(Mt.hasOnce=!0)}function up(e){return e.dynamicChildren=Dn>0?Mt||na:null,cp(),Dn>0&&Mt&&Mt.push(e),e}function gb(e,t,s,n,a,i){return up(qo(e,t,s,n,a,i,!0))}function fl(e,t,s,n,a){return up(at(e,t,s,n,a,!0))}function Qs(e){return e?e.__v_isVNode===!0:!1}function gs(e,t){return e.type===t.type&&e.key===t.key}function mb(e){}const dp=({key:e})=>e??null,Zi=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?Te(e)||gt(e)||ke(e)?{i:Rt,r:e,k:t,f:!!s}:e:null);function qo(e,t=null,s=null,n=0,a=null,i=e===wt?0:1,l=!1,r=!1){const o={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&dp(t),ref:t&&Zi(t),scopeId:jl,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:n,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:Rt};return r?(Go(o,s),i&128&&e.normalize(o)):s&&(o.shapeFlag|=Te(s)?8:16),Dn>0&&!l&&Mt&&(o.patchFlag>0||i&6)&&o.patchFlag!==32&&Mt.push(o),o}const at=vb;function vb(e,t=null,s=null,n=0,a=null,i=!1){if((!e||e===Uf)&&(e=dt),Qs(e)){const r=Rs(e,t,!0);return s&&Go(r,s),Dn>0&&!i&&Mt&&(r.shapeFlag&6?Mt[Mt.indexOf(e)]=r:Mt.push(r)),r.patchFlag=-2,r}if(Sb(e)&&(e=e.__vccOpts),t){t=fp(t);let{class:r,style:o}=t;r&&!Te(r)&&(t.class=xi(r)),Ue(o)&&(_i(o)&&!fe(o)&&(o=Oe({},o)),t.style=yi(o))}const l=Te(e)?1:dl(e)?128:Ef(e)?64:Ue(e)?4:ke(e)?2:0;return qo(e,t,s,n,a,l,i,!0)}function fp(e){return e?_i(e)||Jf(e)?Oe({},e):e:null}function Rs(e,t,s=!1,n=!1){const{props:a,ref:i,patchFlag:l,children:r,transition:o}=e,c=t?hp(a||{},t):a,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&dp(c),ref:t&&t.ref?s&&i?fe(i)?i.concat(Zi(t)):[i,Zi(t)]:Zi(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:r,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==wt?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:o,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Rs(e.ssContent),ssFallback:e.ssFallback&&Rs(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return o&&n&&Ys(u,o.clone(u)),u}function Ko(e=" ",t=0){return at(fn,null,e,t)}function bb(e,t){const s=at(An,null,e);return s.staticCount=t,s}function pp(e="",t=!1){return t?(ci(),fl(dt,null,e)):at(dt,null,e)}function Zt(e){return e==null||typeof e=="boolean"?at(dt):fe(e)?at(wt,null,e.slice()):Qs(e)?Fs(e):at(fn,null,String(e))}function Fs(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Rs(e)}function Go(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(fe(t))s=16;else if(typeof t=="object")if(n&65){const a=t.default;a&&(a._c&&(a._d=!1),Go(e,a()),a._c&&(a._d=!0));return}else{s=32;const a=t._;!a&&!Jf(t)?t._ctx=Rt:a===3&&Rt&&(Rt.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else ke(t)?(t={default:t,_ctx:Rt},s=32):(t=String(t),n&64?(s=16,t=[Ko(t)]):s=8);e.children=t,e.shapeFlag|=s}function hp(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const a in n)if(a==="class")t.class!==n.class&&(t.class=xi([t.class,n.class]));else if(a==="style")t.style=yi([t.style,n.style]);else if(Mn(a)){const i=t[a],l=n[a];l&&i!==l&&!(fe(i)&&i.includes(l))?t[a]=i?[].concat(i,l):l:l==null&&i==null&&!Dl(a)&&(t[a]=l)}else a!==""&&(t[a]=n[a])}return t}function Wt(e,t,s,n=null){ss(e,t,7,[s,n])}const yb=jf();let xb=0;function gp(e,t,s){const n=e.type,a=(t?t.appContext:e.appContext)||yb,i={uid:xb++,vnode:e,type:n,parent:t,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new To(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(a.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Yf(n,a),emitsOptions:qf(n,a),emit:null,emitted:null,propsDefaults:Pe,inheritAttrs:n.inheritAttrs,ctx:Pe,data:Pe,props:Pe,attrs:Pe,slots:Pe,refs:Pe,setupState:Pe,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=Jv.bind(null,i),e.ce&&e.ce(i),i}let At=null;const zt=()=>At||Rt;let pl,ua;{const e=Fl(),t=(s,n)=>{let a;return(a=e[s])||(a=e[s]=[]),a.push(n),i=>{a.length>1?a.forEach(l=>l(i)):a[0](i)}};pl=t("__VUE_INSTANCE_SETTERS__",s=>At=s),ua=t("__VUE_SSR_SETTERS__",s=>On=s)}const Ca=e=>{const t=At;return pl(e),e.scope.on(),()=>{e.scope.off(),pl(t)}},di=()=>{At&&At.scope.off(),pl(null)};function mp(e){return e.vnode.shapeFlag&4}let On=!1;function vp(e,t=!1,s=!1){t&&ua(t);const{props:n,children:a}=e.vnode,i=mp(e);tb(e,n,i,t),ib(e,a,s||t);const l=i?_b(e,t):void 0;return t&&ua(!1),l}function _b(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Gr);const{setup:n}=s;if(n){Js();const a=e.setupContext=n.length>1?xp(e):null,i=Ca(e),l=Ta(n,e,0,[e.props,a]),r=So(l);if(Zs(),i(),(r||e.sp)&&!Ks(e)&&Mo(e),r){if(l.then(di,di),t)return l.then(o=>{Qr(e,o,t)}).catch(o=>{Bn(o,e,0)});e.asyncDep=l}else Qr(e,l,t)}else yp(e,t)}function Qr(e,t,s){ke(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Ue(t)&&(e.setupState=No(t)),yp(e,s)}let hl,Xr;function bp(e){hl=e,Xr=t=>{t.render._rc&&(t.withProxy=new Proxy(t.ctx,Ev))}}const kb=()=>!hl;function yp(e,t,s){const n=e.type;if(!e.render){if(!t&&hl&&!n.render){const a=n.template||Ho(e).template;if(a){const{isCustomElement:i,compilerOptions:l}=e.appContext.config,{delimiters:r,compilerOptions:o}=n,c=Oe(Oe({isCustomElement:i,delimiters:r},l),o);n.render=hl(a,c)}}e.render=n.render||It,Xr&&Xr(e)}{const a=Ca(e);Js();try{Hv(e)}finally{Zs(),a()}}}const wb={get(e,t){return Pt(e,"get",""),e[t]}};function xp(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,wb),slots:e.slots,emit:e.emit,expose:t}}function Ti(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(No(ff(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Wa)return Wa[s](e)},has(t,s){return s in t||s in Wa}})):e.proxy}function eo(e,t=!0){return ke(e)?e.displayName||e.name:e.name||t&&e.__name}function Sb(e){return ke(e)&&"__vccOpts"in e}const ee=(e,t)=>Im(e,t,On);function ha(e,t,s){try{ui(-1);const n=arguments.length;return n===2?Ue(t)&&!fe(t)?Qs(t)?at(e,null,[t]):at(e,t):at(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&Qs(s)&&(s=[s]),at(e,t,s))}finally{ui(1)}}function Tb(){}function Cb(e,t,s,n){const a=s[n];if(a&&_p(a,e))return a;const i=t();return i.memo=e.slice(),i.cacheIndex=n,s[n]=i}function _p(e,t){const s=e.memo;if(s.length!=t.length)return!1;for(let n=0;n<s.length;n++)if(kt(s[n],t[n]))return!1;return Dn>0&&Mt&&Mt.push(e),!0}const kp="3.5.38",Eb=It,Ab=Bm,Rb=Qn,Ib=_f,Nb={createComponentInstance:gp,setupComponent:vp,renderComponentRoot:Ji,setCurrentRenderingInstance:li,isVNode:Qs,normalizeVNode:Zt,getComponentPublicInstance:Ti,ensureValidVNode:Uo,pushWarningContext:Pm,popWarningContext:Mm},Db=Nb,Ob=null,Lb=null,Pb=null;/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let to;const uu=typeof window<"u"&&window.trustedTypes;if(uu)try{to=uu.createPolicy("vue",{createHTML:e=>e})}catch{}const wp=to?e=>to.createHTML(e):e=>e,Mb="http://www.w3.org/2000/svg",Fb="http://www.w3.org/1998/Math/MathML",Ms=typeof document<"u"?document:null,du=Ms&&Ms.createElement("template"),Sp={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const a=t==="svg"?Ms.createElementNS(Mb,e):t==="mathml"?Ms.createElementNS(Fb,e):s?Ms.createElement(e,{is:s}):Ms.createElement(e);return e==="select"&&n&&n.multiple!=null&&a.setAttribute("multiple",n.multiple),a},createText:e=>Ms.createTextNode(e),createComment:e=>Ms.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Ms.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,a,i){const l=s?s.previousSibling:t.lastChild;if(a&&(a===i||a.nextSibling))for(;t.insertBefore(a.cloneNode(!0),s),!(a===i||!(a=a.nextSibling)););else{du.innerHTML=wp(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const r=du.content;if(n==="svg"||n==="mathml"){const o=r.firstChild;for(;o.firstChild;)r.appendChild(o.firstChild);r.removeChild(o)}t.insertBefore(r,s)}return[l?l.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},sn="transition",Oa="animation",ga=Symbol("_vtc"),Tp={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Cp=Oe({},Po,Tp),$b=e=>(e.displayName="Transition",e.props=Cp,e),Bb=$b((e,{slots:t})=>ha(If,Ep(e),t)),yn=(e,t=[])=>{fe(e)?e.forEach(s=>s(...t)):e&&e(...t)},fu=e=>e?fe(e)?e.some(t=>t.length>1):e.length>1:!1;function Ep(e){const t={};for(const F in e)F in Tp||(t[F]=e[F]);if(e.css===!1)return t;const{name:s="v",type:n,duration:a,enterFromClass:i=`${s}-enter-from`,enterActiveClass:l=`${s}-enter-active`,enterToClass:r=`${s}-enter-to`,appearFromClass:o=i,appearActiveClass:c=l,appearToClass:u=r,leaveFromClass:d=`${s}-leave-from`,leaveActiveClass:f=`${s}-leave-active`,leaveToClass:p=`${s}-leave-to`}=e,m=Ub(a),g=m&&m[0],k=m&&m[1],{onBeforeEnter:A,onEnter:b,onEnterCancelled:v,onLeave:x,onLeaveCancelled:R,onBeforeAppear:D=A,onAppear:O=b,onAppearCancelled:S=v}=t,I=(F,P,W,U)=>{F._enterCancelled=U,rn(F,P?u:r),rn(F,P?c:l),W&&W()},w=(F,P)=>{F._isLeaving=!1,rn(F,d),rn(F,p),rn(F,f),P&&P()},$=F=>(P,W)=>{const U=F?O:b,V=()=>I(P,F,W);yn(U,[P,V]),pu(()=>{rn(P,F?o:i),_s(P,F?u:r),fu(U)||hu(P,n,g,V)})};return Oe(t,{onBeforeEnter(F){yn(A,[F]),_s(F,i),_s(F,l)},onBeforeAppear(F){yn(D,[F]),_s(F,o),_s(F,c)},onEnter:$(!1),onAppear:$(!0),onLeave(F,P){F._isLeaving=!0;const W=()=>w(F,P);_s(F,d),F._enterCancelled?(_s(F,f),so(F)):(so(F),_s(F,f)),pu(()=>{F._isLeaving&&(rn(F,d),_s(F,p),fu(x)||hu(F,n,k,W))}),yn(x,[F,W])},onEnterCancelled(F){I(F,!1,void 0,!0),yn(v,[F])},onAppearCancelled(F){I(F,!0,void 0,!0),yn(S,[F])},onLeaveCancelled(F){w(F),yn(R,[F])}})}function Ub(e){if(e==null)return null;if(Ue(e))return[xr(e.enter),xr(e.leave)];{const t=xr(e);return[t,t]}}function xr(e){return sl(e)}function _s(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ga]||(e[ga]=new Set)).add(t)}function rn(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[ga];s&&(s.delete(t),s.size||(e[ga]=void 0))}function pu(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Hb=0;function hu(e,t,s,n){const a=e._endId=++Hb,i=()=>{a===e._endId&&n()};if(s!=null)return setTimeout(i,s);const{type:l,timeout:r,propCount:o}=Ap(e,t);if(!l)return n();const c=l+"end";let u=0;const d=()=>{e.removeEventListener(c,f),i()},f=p=>{p.target===e&&++u>=o&&d()};setTimeout(()=>{u<o&&d()},r+1),e.addEventListener(c,f)}function Ap(e,t){const s=window.getComputedStyle(e),n=m=>(s[m]||"").split(", "),a=n(`${sn}Delay`),i=n(`${sn}Duration`),l=gu(a,i),r=n(`${Oa}Delay`),o=n(`${Oa}Duration`),c=gu(r,o);let u=null,d=0,f=0;t===sn?l>0&&(u=sn,d=l,f=i.length):t===Oa?c>0&&(u=Oa,d=c,f=o.length):(d=Math.max(l,c),u=d>0?l>c?sn:Oa:null,f=u?u===sn?i.length:o.length:0);const p=u===sn&&/\b(?:transform|all)(?:,|$)/.test(n(`${sn}Property`).toString());return{type:u,timeout:d,propCount:f,hasTransform:p}}function gu(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>mu(s)+mu(e[n])))}function mu(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function so(e){return(e?e.ownerDocument:document).body.offsetHeight}function Vb(e,t,s){const n=e[ga];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const gl=Symbol("_vod"),Wo=Symbol("_vsh"),Rp={name:"show",beforeMount(e,{value:t},{transition:s}){e[gl]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):La(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),La(e,!0),n.enter(e)):n.leave(e,()=>{La(e,!1)}):La(e,t))},beforeUnmount(e,{value:t}){La(e,t)}};function La(e,t){e.style.display=t?e[gl]:"none",e[Wo]=!t}function jb(){Rp.getSSRProps=({value:e})=>{if(!e)return{style:{display:"none"}}}}const Ip=Symbol("");function zb(e){const t=zt();if(!t)return;const s=t.ut=(a=e(t.proxy))=>{Array.from(document.querySelectorAll(`[data-v-owner="${t.uid}"]`)).forEach(i=>ml(i,a))},n=()=>{const a=e(t.proxy);t.ce?ml(t.ce,a):no(t.subTree,a),s(a)};Fo(()=>{ai(n)}),$e(()=>{ds(n,It,{flush:"post"});const a=new MutationObserver(n);a.observe(t.subTree.el.parentNode,{childList:!0}),ft(()=>a.disconnect())})}function no(e,t){if(e.shapeFlag&128){const s=e.suspense;e=s.activeBranch,s.pendingBranch&&!s.isHydrating&&s.effects.push(()=>{no(s.activeBranch,t)})}for(;e.component;)e=e.component.subTree;if(e.shapeFlag&1&&e.el)ml(e.el,t);else if(e.type===wt)e.children.forEach(s=>no(s,t));else if(e.type===An){let{el:s,anchor:n}=e;for(;s&&(ml(s,t),s!==n);)s=s.nextSibling}}function ml(e,t){if(e.nodeType===1){const s=e.style;let n="";for(const a in t){const i=Zg(t[a]);s.setProperty(`--${a}`,i),n+=`--${a}: ${i};`}s[Ip]=n}}const qb=/(?:^|;)\s*display\s*:/;function Kb(e,t,s){const n=e.style,a=Te(s);let i=!1;if(s&&!a){if(t)if(Te(t))for(const l of t.split(";")){const r=l.slice(0,l.indexOf(":")).trim();s[r]==null&&ja(n,r,"")}else for(const l in t)s[l]==null&&ja(n,l,"");for(const l in s){l==="display"&&(i=!0);const r=s[l];r!=null?Wb(e,l,!Te(t)&&t?t[l]:void 0,r)||ja(n,l,r):ja(n,l,"")}}else if(a){if(t!==s){const l=n[Ip];l&&(s+=";"+l),n.cssText=s,i=qb.test(s)}}else t&&e.removeAttribute("style");gl in e&&(e[gl]=i?n.display:"",e[Wo]&&(n.display="none"))}const vu=/\s*!important$/;function ja(e,t,s){if(fe(s))s.forEach(n=>ja(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Gb(e,t);vu.test(s)?e.setProperty(Yt(n),s.replace(vu,""),"important"):e[n]=s}}const bu=["Webkit","Moz","ms"],_r={};function Gb(e,t){const s=_r[t];if(s)return s;let n=Ke(t);if(n!=="filter"&&n in e)return _r[t]=n;n=$n(n);for(let a=0;a<bu.length;a++){const i=bu[a]+n;if(i in e)return _r[t]=i}return t}function Wb(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&Te(n)&&s===n}const yu="http://www.w3.org/1999/xlink";function xu(e,t,s,n,a,i=Wg(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(yu,t.slice(6,t.length)):e.setAttributeNS(yu,t,s):s==null||i&&!qd(s)?e.removeAttribute(t):e.setAttribute(t,i?"":$t(s)?String(s):s)}function _u(e,t,s,n,a){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?wp(s):s);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const r=i==="OPTION"?e.getAttribute("value")||"":e.value,o=s==null?e.type==="checkbox"?"on":"":String(s);(r!==o||!("_value"in e))&&(e.value=o),s==null&&e.removeAttribute(t),e._value=s;return}let l=!1;if(s===""||s==null){const r=typeof e[t];r==="boolean"?s=qd(s):s==null&&r==="string"?(s="",l=!0):r==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(a||t)}function Hs(e,t,s,n){e.addEventListener(t,s,n)}function Jb(e,t,s,n){e.removeEventListener(t,s,n)}const ku=Symbol("_vei");function Zb(e,t,s,n,a=null){const i=e[ku]||(e[ku]={}),l=i[t];if(n&&l)l.value=n;else{const[r,o]=Yb(t);if(n){const c=i[t]=ey(n,a);Hs(e,r,c,o)}else l&&(Jb(e,r,l,o),i[t]=void 0)}}const wu=/(?:Once|Passive|Capture)$/;function Yb(e){let t;if(wu.test(e)){t={};let n;for(;n=e.match(wu);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Yt(e.slice(2)),t]}let kr=0;const Qb=Promise.resolve(),Xb=()=>kr||(Qb.then(()=>kr=0),kr=Date.now());function ey(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const a=s.value;if(fe(a)){const i=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{i.call(n),n._stopped=!0};const l=a.slice(),r=[n];for(let o=0;o<l.length&&!n._stopped;o++){const c=l[o];c&&ss(c,t,5,r)}}else ss(a,t,5,[n])};return s.value=e,s.attached=Xb(),s}const Su=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Np=(e,t,s,n,a,i)=>{const l=a==="svg";t==="class"?Vb(e,n,l):t==="style"?Kb(e,s,n):Mn(t)?Dl(t)||Zb(e,t,s,n,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):ty(e,t,n,l))?(_u(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&xu(e,t,n,l,i,t!=="value")):e._isVueCE&&(sy(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!Te(n)))?_u(e,Ke(t),n,i,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),xu(e,t,n,l))};function ty(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Su(t)&&ke(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const a=e.tagName;if(a==="IMG"||a==="VIDEO"||a==="CANVAS"||a==="SOURCE")return!1}return Su(t)&&Te(s)?!1:t in e}function sy(e,t){const s=e._def.props;if(!s)return!1;const n=Ke(t);return Array.isArray(s)?s.some(a=>Ke(a)===n):Object.keys(s).some(a=>Ke(a)===n)}const Tu={};function Dp(e,t,s){let n=wi(e,t);Ol(n)&&(n=Oe({},n,t));class a extends Zl{constructor(l){super(n,l,s)}}return a.def=n,a}const ny=((e,t)=>Dp(e,t,qp)),ay=typeof HTMLElement<"u"?HTMLElement:class{};class Zl extends ay{constructor(t,s={},n=yl){super(),this._def=t,this._props=s,this._createApp=n,this._isVueCE=!0,this._instance=null,this._app=null,this._nonce=this._def.nonce,this._connected=!1,this._resolved=!1,this._patching=!1,this._dirty=!1,this._numberProps=null,this._styleChildren=new WeakSet,this._styleAnchors=new WeakMap,this._ob=null,this.shadowRoot&&n!==yl?this._root=this.shadowRoot:t.shadowRoot!==!1?(this.attachShadow(Oe({},t.shadowRootOptions,{mode:"open"})),this._root=this.shadowRoot):this._root=this}connectedCallback(){if(!this.isConnected)return;!this.shadowRoot&&!this._resolved&&this._parseSlots(),this._connected=!0;let t=this;for(;t=t&&(t.assignedSlot||t.parentNode||t.host);)if(t instanceof Zl){this._parent=t;break}this._instance||(this._resolved?this._mount(this._def):t&&t._pendingResolve?this._pendingResolve=t._pendingResolve.then(()=>{this._pendingResolve=void 0,this._resolveDef()}):this._resolveDef())}_setParent(t=this._parent){t&&(this._instance.parent=t._instance,this._inheritParentContext(t))}_inheritParentContext(t=this._parent){t&&this._app&&Object.setPrototypeOf(this._app._context.provides,t._instance.provides)}disconnectedCallback(){this._connected=!1,Et(()=>{this._connected||(this._ob&&(this._ob.disconnect(),this._ob=null),this._app&&this._app.unmount(),this._instance&&(this._instance.ce=void 0),this._app=this._instance=null,this._teleportTargets&&(this._teleportTargets.clear(),this._teleportTargets=void 0))})}_processMutations(t){for(const s of t)this._setAttr(s.attributeName)}_resolveDef(){if(this._pendingResolve)return;for(let n=0;n<this.attributes.length;n++)this._setAttr(this.attributes[n].name);this._ob=new MutationObserver(this._processMutations.bind(this)),this._ob.observe(this,{attributes:!0});const t=(n,a=!1)=>{this._resolved=!0,this._pendingResolve=void 0;const{props:i,styles:l}=n;let r;if(i&&!fe(i))for(const o in i){const c=i[o];(c===Number||c&&c.type===Number)&&(o in this._props&&(this._props[o]=sl(this._props[o])),(r||(r=Object.create(null)))[Ke(o)]=!0)}this._numberProps=r,this._resolveProps(n),this.shadowRoot&&this._applyStyles(l),this._mount(n)},s=this._def.__asyncLoader;s?this._pendingResolve=s().then(n=>{n.configureApp=this._def.configureApp,t(this._def=n,!0)}):t(this._def)}_mount(t){this._app=this._createApp(t),this._inheritParentContext(),t.configureApp&&t.configureApp(this._app),this._app._ceVNode=this._createVNode(),this._app.mount(this._root);const s=this._instance&&this._instance.exposed;if(s)for(const n in s)He(this,n)||Object.defineProperty(this,n,{get:()=>Es(s[n])})}_resolveProps(t){const{props:s}=t,n=fe(s)?s:Object.keys(s||{});for(const a of Object.keys(this))a[0]!=="_"&&n.includes(a)&&this._setProp(a,this[a]);for(const a of n.map(Ke))Object.defineProperty(this,a,{get(){return this._getProp(a)},set(i){this._setProp(a,i,!0,!this._patching)}})}_setAttr(t){if(t.startsWith("data-v-"))return;const s=this.hasAttribute(t);let n=s?this.getAttribute(t):Tu;const a=Ke(t);s&&this._numberProps&&this._numberProps[a]&&(n=sl(n)),this._setProp(a,n,!1,!0)}_getProp(t){return this._props[t]}_setProp(t,s,n=!0,a=!1){if(s!==this._props[t]&&(this._dirty=!0,s===Tu?delete this._props[t]:(this._props[t]=s,t==="key"&&this._app&&(this._app._ceVNode.key=s)),a&&this._instance&&this._update(),n)){const i=this._ob;i&&(this._processMutations(i.takeRecords()),i.disconnect()),s===!0?this.setAttribute(Yt(t),""):typeof s=="string"||typeof s=="number"?this.setAttribute(Yt(t),s+""):s||this.removeAttribute(Yt(t)),i&&i.observe(this,{attributes:!0})}}_update(){const t=this._createVNode();this._app&&(t.appContext=this._app._context),zp(t,this._root)}_createVNode(){const t={};this.shadowRoot||(t.onVnodeMounted=t.onVnodeUpdated=this._renderSlots.bind(this));const s=at(this._def,Oe(t,this._props));return this._instance||(s.ce=n=>{this._instance=n,n.ce=this,n.isCE=!0;const a=(i,l)=>{this.dispatchEvent(new CustomEvent(i,Ol(l[0])?Oe({detail:l},l[0]):{detail:l}))};n.emit=(i,...l)=>{a(i,l),Yt(i)!==i&&a(Yt(i),l)},this._setParent()}),s}_applyStyles(t,s,n){if(!t)return;if(s){if(s===this._def||this._styleChildren.has(s))return;this._styleChildren.add(s)}const a=this._nonce,i=this.shadowRoot,l=n?this._getStyleAnchor(n)||this._getStyleAnchor(this._def):this._getRootStyleInsertionAnchor(i);let r=null;for(let o=t.length-1;o>=0;o--){const c=document.createElement("style");a&&c.setAttribute("nonce",a),c.textContent=t[o],i.insertBefore(c,r||l),r=c,o===0&&(n||this._styleAnchors.set(this._def,c),s&&this._styleAnchors.set(s,c))}}_getStyleAnchor(t){if(!t)return null;const s=this._styleAnchors.get(t);return s&&s.parentNode===this.shadowRoot?s:(s&&this._styleAnchors.delete(t),null)}_getRootStyleInsertionAnchor(t){for(let s=0;s<t.childNodes.length;s++){const n=t.childNodes[s];if(!(n instanceof HTMLStyleElement))return n}return null}_parseSlots(){const t=this._slots={};let s;for(;s=this.firstChild;){const n=s.nodeType===1&&s.getAttribute("slot")||"default";(t[n]||(t[n]=[])).push(s),this.removeChild(s)}}_renderSlots(){const t=this._getSlots(),s=this._instance.type.__scopeId;for(let n=0;n<t.length;n++){const a=t[n],i=a.getAttribute("name")||"default",l=this._slots[i],r=a.parentNode;if(l)for(const o of l){if(s&&o.nodeType===1){const c=s+"-s",u=document.createTreeWalker(o,1);o.setAttribute(c,"");let d;for(;d=u.nextNode();)d.setAttribute(c,"")}r.insertBefore(o,a)}else for(;a.firstChild;)r.insertBefore(a.firstChild,a);r.removeChild(a)}}_getSlots(){const t=[this];this._teleportTargets&&t.push(...this._teleportTargets);const s=new Set;for(const n of t){const a=n.querySelectorAll("slot");for(let i=0;i<a.length;i++)s.add(a[i])}return Array.from(s)}_injectChildStyle(t,s){this._applyStyles(t.styles,t,s)}_beginPatch(){this._patching=!0,this._dirty=!1}_endPatch(){this._patching=!1,this._dirty&&this._instance&&this._update()}_hasShadowRoot(){return this._def.shadowRoot!==!1}_removeChildStyle(t){}}function Op(e){const t=zt(),s=t&&t.ce;return s||null}function iy(){const e=Op();return e&&e.shadowRoot}function ly(e="$style"){{const t=zt();if(!t)return Pe;const s=t.type.__cssModules;if(!s)return Pe;const n=s[e];return n||Pe}}const Lp=new WeakMap,Pp=new WeakMap,vl=Symbol("_moveCb"),Cu=Symbol("_enterCb"),ry=e=>(delete e.props.mode,e),oy=ry({name:"TransitionGroup",props:Oe({},Cp,{tag:String,moveClass:String}),setup(e,{slots:t}){const s=zt(),n=Lo();let a,i;return Kl(()=>{if(!a.length)return;const l=e.moveClass||`${e.name||"v"}-move`;if(!py(a[0].el,s.vnode.el,l)){a=[];return}a.forEach(uy),a.forEach(dy);const r=a.filter(fy);so(s.vnode.el),r.forEach(o=>{const c=o.el,u=c.style;_s(c,l),u.transform=u.webkitTransform=u.transitionDuration="";const d=c[vl]=f=>{f&&f.target!==c||(!f||f.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",d),c[vl]=null,rn(c,l))};c.addEventListener("transitionend",d)}),a=[]}),()=>{const l=Fe(e),r=Ep(l);let o=l.tag||wt;if(a=[],i)for(let c=0;c<i.length;c++){const u=i[c];u.el&&u.el instanceof Element&&!u.el[Wo]&&(a.push(u),Ys(u,pa(u,r,n,s)),Lp.set(u,Mp(u.el)))}i=t.default?zl(t.default()):[];for(let c=0;c<i.length;c++){const u=i[c];u.key!=null&&Ys(u,pa(u,r,n,s))}return at(o,null,i)}}}),cy=oy;function uy(e){const t=e.el;t[vl]&&t[vl](),t[Cu]&&t[Cu]()}function dy(e){Pp.set(e,Mp(e.el))}function fy(e){const t=Lp.get(e),s=Pp.get(e),n=t.left-s.left,a=t.top-s.top;if(n||a){const i=e.el,l=i.style,r=i.getBoundingClientRect();let o=1,c=1;return i.offsetWidth&&(o=r.width/i.offsetWidth),i.offsetHeight&&(c=r.height/i.offsetHeight),(!Number.isFinite(o)||o===0)&&(o=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(o-1)<.01&&(o=1),Math.abs(c-1)<.01&&(c=1),l.transform=l.webkitTransform=`translate(${n/o}px,${a/c}px)`,l.transitionDuration="0s",e}}function Mp(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function py(e,t,s){const n=e.cloneNode(),a=e[ga];a&&a.forEach(r=>{r.split(/\s+/).forEach(o=>o&&n.classList.remove(o))}),s.split(/\s+/).forEach(r=>r&&n.classList.add(r)),n.style.display="none";const i=t.nodeType===1?t:t.parentNode;i.appendChild(n);const{hasTransform:l}=Ap(n);return i.removeChild(n),l}const hn=e=>{const t=e.props["onUpdate:modelValue"]||!1;return fe(t)?s=>la(t,s):t};function hy(e){e.target.composing=!0}function Eu(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const fs=Symbol("_assign");function Au(e,t,s){return t&&(e=e.trim()),s&&(e=Ml(e)),e}const bl={created(e,{modifiers:{lazy:t,trim:s,number:n}},a){e[fs]=hn(a);const i=n||a.props&&a.props.type==="number";Hs(e,t?"change":"input",l=>{l.target.composing||e[fs](Au(e.value,s,i))}),(s||i)&&Hs(e,"change",()=>{e.value=Au(e.value,s,i)}),t||(Hs(e,"compositionstart",hy),Hs(e,"compositionend",Eu),Hs(e,"change",Eu))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:n,trim:a,number:i}},l){if(e[fs]=hn(l),e.composing)return;const r=(i||e.type==="number")&&!/^0\d/.test(e.value)?Ml(e.value):e.value,o=t??"";if(r===o)return;const c=e.getRootNode();(c instanceof Document||c instanceof ShadowRoot)&&c.activeElement===e&&e.type!=="range"&&(n&&t===s||a&&e.value.trim()===o)||(e.value=o)}},Jo={deep:!0,created(e,t,s){e[fs]=hn(s),Hs(e,"change",()=>{const n=e._modelValue,a=ma(e),i=e.checked,l=e[fs];if(fe(n)){const r=$l(n,a),o=r!==-1;if(i&&!o)l(n.concat(a));else if(!i&&o){const c=[...n];c.splice(r,1),l(c)}}else if(Fn(n)){const r=new Set(n);i?r.add(a):r.delete(a),l(r)}else l($p(e,i))})},mounted:Ru,beforeUpdate(e,t,s){e[fs]=hn(s),Ru(e,t,s)}};function Ru(e,{value:t,oldValue:s},n){e._modelValue=t;let a;if(fe(t))a=$l(t,n.props.value)>-1;else if(Fn(t))a=t.has(n.props.value);else{if(t===s)return;a=Ws(t,$p(e,!0))}e.checked!==a&&(e.checked=a)}const Zo={created(e,{value:t},s){e.checked=Ws(t,s.props.value),e[fs]=hn(s),Hs(e,"change",()=>{e[fs](ma(e))})},beforeUpdate(e,{value:t,oldValue:s},n){e[fs]=hn(n),t!==s&&(e.checked=Ws(t,n.props.value))}},Fp={deep:!0,created(e,{value:t,modifiers:{number:s}},n){const a=Fn(t);Hs(e,"change",()=>{const i=Array.prototype.filter.call(e.options,l=>l.selected).map(l=>s?Ml(ma(l)):ma(l));e[fs](e.multiple?a?new Set(i):i:i[0]),e._assigning=!0,Et(()=>{e._assigning=!1})}),e[fs]=hn(n)},mounted(e,{value:t}){Iu(e,t)},beforeUpdate(e,t,s){e[fs]=hn(s)},updated(e,{value:t}){e._assigning||Iu(e,t)}};function Iu(e,t){const s=e.multiple,n=fe(t);if(!(s&&!n&&!Fn(t))){for(let a=0,i=e.options.length;a<i;a++){const l=e.options[a],r=ma(l);if(s)if(n){const o=typeof r;o==="string"||o==="number"?l.selected=t.some(c=>String(c)===String(r)):l.selected=$l(t,r)>-1}else l.selected=t.has(r);else if(Ws(ma(l),t)){e.selectedIndex!==a&&(e.selectedIndex=a);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function ma(e){return"_value"in e?e._value:e.value}function $p(e,t){const s=t?"_trueValue":"_falseValue";return s in e?e[s]:t}const Bp={created(e,t,s){ji(e,t,s,null,"created")},mounted(e,t,s){ji(e,t,s,null,"mounted")},beforeUpdate(e,t,s,n){ji(e,t,s,n,"beforeUpdate")},updated(e,t,s,n){ji(e,t,s,n,"updated")}};function Up(e,t){switch(e){case"SELECT":return Fp;case"TEXTAREA":return bl;default:switch(t){case"checkbox":return Jo;case"radio":return Zo;default:return bl}}}function ji(e,t,s,n,a){const l=Up(e.tagName,s.props&&s.props.type)[a];l&&l(e,t,s,n)}function gy(){bl.getSSRProps=({value:e})=>({value:e}),Zo.getSSRProps=({value:e},t)=>{if(t.props&&Ws(t.props.value,e))return{checked:!0}},Jo.getSSRProps=({value:e},t)=>{if(fe(e)){if(t.props&&$l(e,t.props.value)>-1)return{checked:!0}}else if(Fn(e)){if(t.props&&e.has(t.props.value))return{checked:!0}}else if(e)return{checked:!0}},Bp.getSSRProps=(e,t)=>{if(typeof t.type!="string")return;const s=Up(t.type.toUpperCase(),t.props&&t.props.type);if(s.getSSRProps)return s.getSSRProps(e,t)}}const my=["ctrl","shift","alt","meta"],vy={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>my.some(s=>e[`${s}Key`]&&!t.includes(s))},by=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((a,...i)=>{for(let l=0;l<t.length;l++){const r=vy[t[l]];if(r&&r(a,t))return}return e(a,...i)}))},yy={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},xy=(e,t)=>{const s=e._withKeys||(e._withKeys={}),n=t.join(".");return s[n]||(s[n]=(a=>{if(!("key"in a))return;const i=Yt(a.key);if(t.some(l=>l===i||yy[l]===i))return e(a)}))},Hp=Oe({patchProp:Np},Sp);let Za,Nu=!1;function Vp(){return Za||(Za=tp(Hp))}function jp(){return Za=Nu?Za:sp(Hp),Nu=!0,Za}const zp=((...e)=>{Vp().render(...e)}),_y=((...e)=>{jp().hydrate(...e)}),yl=((...e)=>{const t=Vp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Gp(n);if(!a)return;const i=t._component;!ke(i)&&!i.render&&!i.template&&(i.template=a.innerHTML),a.nodeType===1&&(a.textContent="");const l=s(a,!1,Kp(a));return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),l},t}),qp=((...e)=>{const t=jp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Gp(n);if(a)return s(a,!0,Kp(a))},t});function Kp(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Gp(e){return Te(e)?document.querySelector(e):e}let Du=!1;const ky=()=>{Du||(Du=!0,gy(),jb())},wy=Object.freeze(Object.defineProperty({__proto__:null,BaseTransition:If,BaseTransitionPropsValidators:Po,Comment:dt,DeprecationTypes:Pb,EffectScope:To,ErrorCodes:$m,ErrorTypeStrings:Ab,Fragment:wt,KeepAlive:vv,ReactiveEffect:ti,Static:An,Suspense:cb,Teleport:Xm,Text:fn,TrackOpTypes:Nm,Transition:Bb,TransitionGroup:cy,TriggerOpTypes:Dm,VueElement:Zl,assertNumber:Fm,callWithAsyncErrorHandling:ss,callWithErrorHandling:Ta,camelize:Ke,capitalize:$n,cloneVNode:Rs,compatUtils:Lb,computed:ee,createApp:yl,createBlock:fl,createCommentVNode:pp,createElementBlock:gb,createElementVNode:qo,createHydrationRenderer:sp,createPropsRestProxy:Bv,createRenderer:tp,createSSRApp:qp,createSlots:Sv,createStaticVNode:bb,createTextVNode:Ko,createVNode:at,customRef:hf,defineAsyncComponent:gv,defineComponent:wi,defineCustomElement:Dp,defineEmits:Rv,defineExpose:Iv,defineModel:Ov,defineOptions:Nv,defineProps:Av,defineSSRCustomElement:ny,defineSlots:Dv,devtools:Rb,effect:em,effectScope:Yg,getCurrentInstance:zt,getCurrentScope:Jd,getCurrentWatcher:Om,getTransitionRawChildren:zl,guardReactiveProps:fp,h:ha,handleError:Bn,hasInjectionContext:Km,hydrate:_y,hydrateOnIdle:cv,hydrateOnInteraction:pv,hydrateOnMediaQuery:fv,hydrateOnVisible:dv,initCustomFormatter:Tb,initDirectivesForSSR:ky,inject:us,isMemoSame:_p,isProxy:_i,isReactive:qs,isReadonly:As,isRef:gt,isRuntimeOnly:kb,isShallow:Xt,isVNode:Qs,markRaw:ff,mergeDefaults:Fv,mergeModels:$v,mergeProps:hp,nextTick:Et,nodeOps:Sp,normalizeClass:xi,normalizeProps:$g,normalizeStyle:yi,onActivated:Df,onBeforeMount:Pf,onBeforeUnmount:Gl,onBeforeUpdate:Fo,onDeactivated:Of,onErrorCaptured:Bf,onMounted:$e,onRenderTracked:$f,onRenderTriggered:Ff,onScopeDispose:Qg,onServerPrefetch:Mf,onUnmounted:ft,onUpdated:Kl,onWatcherCleanup:mf,openBlock:ci,patchProp:Np,popScopeId:jm,provide:Ga,proxyRefs:No,pushScopeId:Vm,queuePostFlushCb:ai,reactive:gn,readonly:al,ref:h,registerRuntimeCompiler:bp,render:zp,renderList:wv,renderSlot:Tv,resolveComponent:xv,resolveDirective:kv,resolveDynamicComponent:_v,resolveFilter:Ob,resolveTransitionHooks:pa,setBlockTracking:ui,setDevtoolsHook:Ib,setTransitionHooks:Ys,shallowReactive:Ro,shallowReadonly:ym,shallowRef:Io,ssrContextKey:kf,ssrUtils:Db,stop:tm,toDisplayString:Gd,toHandlerKey:ia,toHandlers:Cv,toRaw:Fe,toRef:Am,toRefs:Tm,toValue:km,transformVNodeArgs:mb,triggerRef:_m,unref:Es,useAttrs:Mv,useCssModule:ly,useCssVars:zb,useHost:Op,useId:tv,useModel:Wv,useSSRContext:wf,useShadowRoot:iy,useSlots:Pv,useTemplateRef:sv,useTransitionState:Lo,vModelCheckbox:Jo,vModelDynamic:Bp,vModelRadio:Zo,vModelSelect:Fp,vModelText:bl,vShow:Rp,version:kp,warn:Eb,watch:ds,watchEffect:Gm,watchPostEffect:Wm,watchSyncEffect:Sf,withAsyncContext:Uv,withCtx:Oo,withDefaults:Lv,withDirectives:qm,withKeys:xy,withMemo:Cb,withModifiers:by,withScopeId:zm},Symbol.toStringTag,{value:"Module"}));/**
* @vue/compiler-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const fi=Symbol(""),Ya=Symbol(""),Yo=Symbol(""),xl=Symbol(""),Wp=Symbol(""),Ln=Symbol(""),Jp=Symbol(""),Zp=Symbol(""),Qo=Symbol(""),Xo=Symbol(""),Ci=Symbol(""),ec=Symbol(""),Yp=Symbol(""),tc=Symbol(""),sc=Symbol(""),nc=Symbol(""),ac=Symbol(""),ic=Symbol(""),lc=Symbol(""),Qp=Symbol(""),Xp=Symbol(""),Yl=Symbol(""),_l=Symbol(""),rc=Symbol(""),oc=Symbol(""),pi=Symbol(""),Ei=Symbol(""),cc=Symbol(""),ao=Symbol(""),Sy=Symbol(""),io=Symbol(""),kl=Symbol(""),Ty=Symbol(""),Cy=Symbol(""),uc=Symbol(""),Ey=Symbol(""),Ay=Symbol(""),dc=Symbol(""),eh=Symbol(""),va={[fi]:"Fragment",[Ya]:"Teleport",[Yo]:"Suspense",[xl]:"KeepAlive",[Wp]:"BaseTransition",[Ln]:"openBlock",[Jp]:"createBlock",[Zp]:"createElementBlock",[Qo]:"createVNode",[Xo]:"createElementVNode",[Ci]:"createCommentVNode",[ec]:"createTextVNode",[Yp]:"createStaticVNode",[tc]:"resolveComponent",[sc]:"resolveDynamicComponent",[nc]:"resolveDirective",[ac]:"resolveFilter",[ic]:"withDirectives",[lc]:"renderList",[Qp]:"renderSlot",[Xp]:"createSlots",[Yl]:"toDisplayString",[_l]:"mergeProps",[rc]:"normalizeClass",[oc]:"normalizeStyle",[pi]:"normalizeProps",[Ei]:"guardReactiveProps",[cc]:"toHandlers",[ao]:"camelize",[Sy]:"capitalize",[io]:"toHandlerKey",[kl]:"setBlockTracking",[Ty]:"pushScopeId",[Cy]:"popScopeId",[uc]:"withCtx",[Ey]:"unref",[Ay]:"isRef",[dc]:"withMemo",[eh]:"isMemoSame"};function Ry(e){Object.getOwnPropertySymbols(e).forEach(t=>{va[t]=e[t]})}const is={start:{line:1,column:1,offset:0},end:{line:1,column:1,offset:0},source:""};function Iy(e,t=""){return{type:0,source:t,children:e,helpers:new Set,components:[],directives:[],hoists:[],imports:[],cached:[],temps:0,codegenNode:void 0,loc:is}}function hi(e,t,s,n,a,i,l,r=!1,o=!1,c=!1,u=is){return e&&(r?(e.helper(Ln),e.helper(xa(e.inSSR,c))):e.helper(ya(e.inSSR,c)),l&&e.helper(ic)),{type:13,tag:t,props:s,children:n,patchFlag:a,dynamicProps:i,directives:l,isBlock:r,disableTracking:o,isComponent:c,loc:u}}function Rn(e,t=is){return{type:17,loc:t,elements:e}}function cs(e,t=is){return{type:15,loc:t,properties:e}}function ht(e,t){return{type:16,loc:is,key:Te(e)?Ae(e,!0):e,value:t}}function Ae(e,t=!1,s=is,n=0){return{type:4,loc:s,content:e,isStatic:t,constType:t?3:n}}function vs(e,t=is){return{type:8,loc:t,children:e}}function xt(e,t=[],s=is){return{type:14,loc:s,callee:e,arguments:t}}function ba(e,t=void 0,s=!1,n=!1,a=is){return{type:18,params:e,returns:t,newline:s,isSlot:n,loc:a}}function lo(e,t,s,n=!0){return{type:19,test:e,consequent:t,alternate:s,newline:n,loc:is}}function Ny(e,t,s=!1,n=!1){return{type:20,index:e,value:t,needPauseTracking:s,inVOnce:n,needArraySpread:!1,loc:is}}function Dy(e){return{type:21,body:e,loc:is}}function ya(e,t){return e||t?Qo:Xo}function xa(e,t){return e||t?Jp:Zp}function fc(e,{helper:t,removeHelper:s,inSSR:n}){e.isBlock||(e.isBlock=!0,s(ya(n,e.isComponent)),t(Ln),t(xa(n,e.isComponent)))}const Ou=new Uint8Array([123,123]),Lu=new Uint8Array([125,125]);function Pu(e){return e>=97&&e<=122||e>=65&&e<=90}function es(e){return e===32||e===10||e===9||e===12||e===13}function nn(e){return e===47||e===62||es(e)}function wl(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t}const Dt={Cdata:new Uint8Array([67,68,65,84,65,91]),CdataEnd:new Uint8Array([93,93,62]),CommentEnd:new Uint8Array([45,45,62]),ScriptEnd:new Uint8Array([60,47,115,99,114,105,112,116]),StyleEnd:new Uint8Array([60,47,115,116,121,108,101]),TitleEnd:new Uint8Array([60,47,116,105,116,108,101]),TextareaEnd:new Uint8Array([60,47,116,101,120,116,97,114,101,97])};class Oy{constructor(t,s){this.stack=t,this.cbs=s,this.state=1,this.buffer="",this.sectionStart=0,this.index=0,this.entityStart=0,this.baseState=1,this.inRCDATA=!1,this.inXML=!1,this.inVPre=!1,this.newlines=[],this.mode=0,this.delimiterOpen=Ou,this.delimiterClose=Lu,this.delimiterIndex=-1,this.currentSequence=void 0,this.sequenceIndex=0}get inSFCRoot(){return this.mode===2&&this.stack.length===0}reset(){this.state=1,this.mode=0,this.buffer="",this.sectionStart=0,this.index=0,this.baseState=1,this.inRCDATA=!1,this.currentSequence=void 0,this.newlines.length=0,this.delimiterOpen=Ou,this.delimiterClose=Lu}getPos(t){let s=1,n=t+1;const a=this.newlines.length;let i=-1;if(a>100){let l=-1,r=a;for(;l+1<r;){const o=l+r>>>1;this.newlines[o]<t?l=o:r=o}i=l}else for(let l=a-1;l>=0;l--)if(t>this.newlines[l]){i=l;break}return i>=0&&(s=i+2,n=t-this.newlines[i]),{column:n,line:s,offset:t}}peek(){return this.buffer.charCodeAt(this.index+1)}stateText(t){t===60?(this.index>this.sectionStart&&this.cbs.ontext(this.sectionStart,this.index),this.state=5,this.sectionStart=this.index):!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t))}stateInterpolationOpen(t){if(t===this.delimiterOpen[this.delimiterIndex])if(this.delimiterIndex===this.delimiterOpen.length-1){const s=this.index+1-this.delimiterOpen.length;s>this.sectionStart&&this.cbs.ontext(this.sectionStart,s),this.state=3,this.sectionStart=s}else this.delimiterIndex++;else this.inRCDATA?(this.state=32,this.stateInRCDATA(t)):(this.state=1,this.stateText(t))}stateInterpolation(t){t===this.delimiterClose[0]&&(this.state=4,this.delimiterIndex=0,this.stateInterpolationClose(t))}stateInterpolationClose(t){t===this.delimiterClose[this.delimiterIndex]?this.delimiterIndex===this.delimiterClose.length-1?(this.cbs.oninterpolation(this.sectionStart,this.index+1),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):this.delimiterIndex++:(this.state=3,this.stateInterpolation(t))}stateSpecialStartSequence(t){const s=this.sequenceIndex===this.currentSequence.length;if(!(s?nn(t):(t|32)===this.currentSequence[this.sequenceIndex]))this.inRCDATA=!1;else if(!s){this.sequenceIndex++;return}this.sequenceIndex=0,this.state=6,this.stateInTagName(t)}stateInRCDATA(t){if(this.sequenceIndex===this.currentSequence.length){if(t===62||es(t)){const s=this.index-this.currentSequence.length;if(this.sectionStart<s){const n=this.index;this.index=s,this.cbs.ontext(this.sectionStart,s),this.index=n}this.sectionStart=s+2,this.stateInClosingTagName(t),this.inRCDATA=!1;return}this.sequenceIndex=0}(t|32)===this.currentSequence[this.sequenceIndex]?this.sequenceIndex+=1:this.sequenceIndex===0?this.currentSequence===Dt.TitleEnd||this.currentSequence===Dt.TextareaEnd&&!this.inSFCRoot?!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t)):this.fastForwardTo(60)&&(this.sequenceIndex=1):this.sequenceIndex=+(t===60)}stateCDATASequence(t){t===Dt.Cdata[this.sequenceIndex]?++this.sequenceIndex===Dt.Cdata.length&&(this.state=28,this.currentSequence=Dt.CdataEnd,this.sequenceIndex=0,this.sectionStart=this.index+1):(this.sequenceIndex=0,this.state=23,this.stateInDeclaration(t))}fastForwardTo(t){for(;++this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);if(s===10&&this.newlines.push(this.index),s===t)return!0}return this.index=this.buffer.length-1,!1}stateInCommentLike(t){t===this.currentSequence[this.sequenceIndex]?++this.sequenceIndex===this.currentSequence.length&&(this.currentSequence===Dt.CdataEnd?this.cbs.oncdata(this.sectionStart,this.index-2):this.cbs.oncomment(this.sectionStart,this.index-2),this.sequenceIndex=0,this.sectionStart=this.index+1,this.state=1):this.sequenceIndex===0?this.fastForwardTo(this.currentSequence[0])&&(this.sequenceIndex=1):t!==this.currentSequence[this.sequenceIndex-1]&&(this.sequenceIndex=0)}startSpecial(t,s){this.enterRCDATA(t,s),this.state=31}enterRCDATA(t,s){this.inRCDATA=!0,this.currentSequence=t,this.sequenceIndex=s}stateBeforeTagName(t){t===33?(this.state=22,this.sectionStart=this.index+1):t===63?(this.state=24,this.sectionStart=this.index+1):Pu(t)?(this.sectionStart=this.index,this.mode===0?this.state=6:this.inSFCRoot?this.state=34:this.inXML?this.state=6:t===116?this.state=30:this.state=t===115?29:6):t===47?this.state=8:(this.state=1,this.stateText(t))}stateInTagName(t){nn(t)&&this.handleTagName(t)}stateInSFCRootTagName(t){if(nn(t)){const s=this.buffer.slice(this.sectionStart,this.index);s!=="template"&&this.enterRCDATA(wl("</"+s),0),this.handleTagName(t)}}handleTagName(t){this.cbs.onopentagname(this.sectionStart,this.index),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)}stateBeforeClosingTagName(t){es(t)||(t===62?(this.state=1,this.sectionStart=this.index+1):(this.state=Pu(t)?9:27,this.sectionStart=this.index))}stateInClosingTagName(t){(t===62||es(t))&&(this.cbs.onclosetag(this.sectionStart,this.index),this.sectionStart=-1,this.state=10,this.stateAfterClosingTagName(t))}stateAfterClosingTagName(t){t===62&&(this.state=1,this.sectionStart=this.index+1)}stateBeforeAttrName(t){t===62?(this.cbs.onopentagend(this.index),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):t===47?this.state=7:t===60&&this.peek()===47?(this.cbs.onopentagend(this.index),this.state=5,this.sectionStart=this.index):es(t)||this.handleAttrStart(t)}handleAttrStart(t){t===118&&this.peek()===45?(this.state=13,this.sectionStart=this.index):t===46||t===58||t===64||t===35?(this.cbs.ondirname(this.index,this.index+1),this.state=14,this.sectionStart=this.index+1):(this.state=12,this.sectionStart=this.index)}stateInSelfClosingTag(t){t===62?(this.cbs.onselfclosingtag(this.index),this.state=1,this.sectionStart=this.index+1,this.inRCDATA=!1):es(t)||(this.state=11,this.stateBeforeAttrName(t))}stateInAttrName(t){(t===61||nn(t))&&(this.cbs.onattribname(this.sectionStart,this.index),this.handleAttrNameEnd(t))}stateInDirName(t){t===61||nn(t)?(this.cbs.ondirname(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===58?(this.cbs.ondirname(this.sectionStart,this.index),this.state=14,this.sectionStart=this.index+1):t===46&&(this.cbs.ondirname(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDirArg(t){t===61||nn(t)?(this.cbs.ondirarg(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===91?this.state=15:t===46&&(this.cbs.ondirarg(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDynamicDirArg(t){t===93?this.state=14:(t===61||nn(t))&&(this.cbs.ondirarg(this.sectionStart,this.index+1),this.handleAttrNameEnd(t))}stateInDirModifier(t){t===61||nn(t)?(this.cbs.ondirmodifier(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===46&&(this.cbs.ondirmodifier(this.sectionStart,this.index),this.sectionStart=this.index+1)}handleAttrNameEnd(t){this.sectionStart=this.index,this.state=17,this.cbs.onattribnameend(this.index),this.stateAfterAttrName(t)}stateAfterAttrName(t){t===61?this.state=18:t===47||t===62?(this.cbs.onattribend(0,this.sectionStart),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)):es(t)||(this.cbs.onattribend(0,this.sectionStart),this.handleAttrStart(t))}stateBeforeAttrValue(t){t===34?(this.state=19,this.sectionStart=this.index+1):t===39?(this.state=20,this.sectionStart=this.index+1):es(t)||(this.sectionStart=this.index,this.state=21,this.stateInAttrValueNoQuotes(t))}handleInAttrValue(t,s){(t===s||this.fastForwardTo(s))&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(s===34?3:2,this.index+1),this.state=11)}stateInAttrValueDoubleQuotes(t){this.handleInAttrValue(t,34)}stateInAttrValueSingleQuotes(t){this.handleInAttrValue(t,39)}stateInAttrValueNoQuotes(t){es(t)||t===62?(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(1,this.index),this.state=11,this.stateBeforeAttrName(t)):(t===39||t===60||t===61||t===96)&&this.cbs.onerr(18,this.index)}stateBeforeDeclaration(t){t===91?(this.state=26,this.sequenceIndex=0):this.state=t===45?25:23}stateInDeclaration(t){(t===62||this.fastForwardTo(62))&&(this.state=1,this.sectionStart=this.index+1)}stateInProcessingInstruction(t){(t===62||this.fastForwardTo(62))&&(this.cbs.onprocessinginstruction(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeComment(t){t===45?(this.state=28,this.currentSequence=Dt.CommentEnd,this.sequenceIndex=2,this.sectionStart=this.index+1):this.state=23}stateInSpecialComment(t){(t===62||this.fastForwardTo(62))&&(this.cbs.oncomment(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeSpecialS(t){t===Dt.ScriptEnd[3]?this.startSpecial(Dt.ScriptEnd,4):t===Dt.StyleEnd[3]?this.startSpecial(Dt.StyleEnd,4):(this.state=6,this.stateInTagName(t))}stateBeforeSpecialT(t){t===Dt.TitleEnd[3]?this.startSpecial(Dt.TitleEnd,4):t===Dt.TextareaEnd[3]?this.startSpecial(Dt.TextareaEnd,4):(this.state=6,this.stateInTagName(t))}startEntity(){}stateInEntity(){}parse(t){for(this.buffer=t;this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);switch(s===10&&this.state!==33&&this.newlines.push(this.index),this.state){case 1:{this.stateText(s);break}case 2:{this.stateInterpolationOpen(s);break}case 3:{this.stateInterpolation(s);break}case 4:{this.stateInterpolationClose(s);break}case 31:{this.stateSpecialStartSequence(s);break}case 32:{this.stateInRCDATA(s);break}case 26:{this.stateCDATASequence(s);break}case 19:{this.stateInAttrValueDoubleQuotes(s);break}case 12:{this.stateInAttrName(s);break}case 13:{this.stateInDirName(s);break}case 14:{this.stateInDirArg(s);break}case 15:{this.stateInDynamicDirArg(s);break}case 16:{this.stateInDirModifier(s);break}case 28:{this.stateInCommentLike(s);break}case 27:{this.stateInSpecialComment(s);break}case 11:{this.stateBeforeAttrName(s);break}case 6:{this.stateInTagName(s);break}case 34:{this.stateInSFCRootTagName(s);break}case 9:{this.stateInClosingTagName(s);break}case 5:{this.stateBeforeTagName(s);break}case 17:{this.stateAfterAttrName(s);break}case 20:{this.stateInAttrValueSingleQuotes(s);break}case 18:{this.stateBeforeAttrValue(s);break}case 8:{this.stateBeforeClosingTagName(s);break}case 10:{this.stateAfterClosingTagName(s);break}case 29:{this.stateBeforeSpecialS(s);break}case 30:{this.stateBeforeSpecialT(s);break}case 21:{this.stateInAttrValueNoQuotes(s);break}case 7:{this.stateInSelfClosingTag(s);break}case 23:{this.stateInDeclaration(s);break}case 22:{this.stateBeforeDeclaration(s);break}case 25:{this.stateBeforeComment(s);break}case 24:{this.stateInProcessingInstruction(s);break}case 33:{this.stateInEntity();break}}this.index++}this.cleanup(),this.finish()}cleanup(){this.sectionStart!==this.index&&(this.state===1||this.state===32&&this.sequenceIndex===0?(this.cbs.ontext(this.sectionStart,this.index),this.sectionStart=this.index):(this.state===19||this.state===20||this.state===21)&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=this.index))}finish(){this.handleTrailingData(),this.cbs.onend()}handleTrailingData(){const t=this.buffer.length;this.sectionStart>=t||(this.state===28?this.currentSequence===Dt.CdataEnd?this.cbs.oncdata(this.sectionStart,t):this.cbs.oncomment(this.sectionStart,t):this.state===6||this.state===11||this.state===18||this.state===17||this.state===12||this.state===13||this.state===14||this.state===15||this.state===16||this.state===20||this.state===19||this.state===21||this.state===9||this.cbs.ontext(this.sectionStart,t))}emitCodePoint(t,s){}}function Mu(e,{compatConfig:t}){const s=t&&t[e];return e==="MODE"?s||3:s}function In(e,t){const s=Mu("MODE",t),n=Mu(e,t);return s===3?n===!0:n!==!1}function gi(e,t,s,...n){return In(e,t)}function pc(e){throw e}function th(e){}function tt(e,t,s,n){const a=`https://vuejs.org/error-reference/#compiler-${e}`,i=new SyntaxError(String(a));return i.code=e,i.loc=t,i}const Qt=e=>e.type===4&&e.isStatic;function sh(e){switch(e){case"Teleport":case"teleport":return Ya;case"Suspense":case"suspense":return Yo;case"KeepAlive":case"keep-alive":return xl;case"BaseTransition":case"base-transition":return Wp}}const Ly=/^$|^\d|[^\$\w\xA0-\uFFFF]/,hc=e=>!Ly.test(e),nh=/[A-Za-z_$\xA0-\uFFFF]/,Py=/[\.\?\w$\xA0-\uFFFF]/,My=/\s+[.[]\s*|\s*[.[]\s+/g,ah=e=>e.type===4?e.content:e.loc.source,Fy=e=>{const t=ah(e).trim().replace(My,r=>r.trim());let s=0,n=[],a=0,i=0,l=null;for(let r=0;r<t.length;r++){const o=t.charAt(r);switch(s){case 0:if(o==="[")n.push(s),s=1,a++;else if(o==="(")n.push(s),s=2,i++;else if(!(r===0?nh:Py).test(o))return!1;break;case 1:o==="'"||o==='"'||o==="`"?(n.push(s),s=3,l=o):o==="["?a++:o==="]"&&(--a||(s=n.pop()));break;case 2:if(o==="'"||o==='"'||o==="`")n.push(s),s=3,l=o;else if(o==="(")i++;else if(o===")"){if(r===t.length-1)return!1;--i||(s=n.pop())}break;case 3:o===l&&(s=n.pop(),l=null);break}}return!a&&!i},ih=Fy,$y=/^\s*(?:async\s*)?(?:\([^)]*?\)|[\w$_]+)\s*(?::[^=]+)?=>|^\s*(?:async\s+)?function(?:\s+[\w$]+)?\s*\(/,By=e=>$y.test(ah(e)),Uy=By;function os(e,t,s=!1){for(let n=0;n<e.props.length;n++){const a=e.props[n];if(a.type===7&&(s||a.exp)&&(Te(t)?a.name===t:t.test(a.name)))return a}}function Ql(e,t,s=!1,n=!1){for(let a=0;a<e.props.length;a++){const i=e.props[a];if(i.type===6){if(s)continue;if(i.name===t&&(i.value||n))return i}else if(i.name==="bind"&&(i.exp||n)&&wn(i.arg,t))return i}}function wn(e,t){return!!(e&&Qt(e)&&e.content===t)}function Hy(e){return e.props.some(t=>t.type===7&&t.name==="bind"&&(!t.arg||t.arg.type!==4||!t.arg.isStatic))}function wr(e){return e.type===5||e.type===2}function Fu(e){return e.type===7&&e.name==="pre"}function Vy(e){return e.type===7&&e.name==="slot"}function Sl(e){return e.type===1&&e.tagType===3}function Tl(e){return e.type===1&&e.tagType===2}const jy=new Set([pi,Ei]);function lh(e,t=[]){if(e&&!Te(e)&&e.type===14){const s=e.callee;if(!Te(s)&&jy.has(s))return lh(e.arguments[0],t.concat(e))}return[e,t]}function Cl(e,t,s){let n,a=e.type===13?e.props:e.arguments[2],i=[],l;if(a&&!Te(a)&&a.type===14){const r=lh(a);a=r[0],i=r[1],l=i[i.length-1]}if(a==null||Te(a))n=cs([t]);else if(a.type===14){const r=a.arguments[0];!Te(r)&&r.type===15?$u(t,r)||r.properties.unshift(t):a.callee===cc?n=xt(s.helper(_l),[cs([t]),a]):a.arguments.unshift(cs([t])),!n&&(n=a)}else a.type===15?($u(t,a)||a.properties.unshift(t),n=a):(n=xt(s.helper(_l),[cs([t]),a]),l&&l.callee===Ei&&(l=i[i.length-2]));e.type===13?l?l.arguments[0]=n:e.props=n:l?l.arguments[0]=n:e.arguments[2]=n}function $u(e,t){let s=!1;if(e.key.type===4){const n=e.key.content;s=t.properties.some(a=>a.key.type===4&&a.key.content===n)}return s}function mi(e,t){return`_${t}_${e.replace(/[^\w]/g,(s,n)=>s==="-"?"_":e.charCodeAt(n).toString())}`}function zy(e){return e.type===14&&e.callee===dc?e.arguments[1].returns:e}const qy=/([\s\S]*?)\s+(?:in|of)\s+(\S[\s\S]*)/;function rh(e){for(let t=0;t<e.length;t++)if(!es(e.charCodeAt(t)))return!1;return!0}function gc(e){return e.type===2&&rh(e.content)||e.type===12&&gc(e.content)}function oh(e){return e.type===3||gc(e)}const ch={parseMode:"base",ns:0,delimiters:["{{","}}"],getNamespace:()=>0,isVoidTag:ta,isPreTag:ta,isIgnoreNewlineTag:ta,isCustomElement:ta,onError:pc,onWarn:th,comments:!1,prefixIdentifiers:!1};let Be=ch,vi=null,Gs="",Lt=null,Me=null,Gt="",Ps=-1,_n=-1,mc=0,un=!1,ro=null;const et=[],ot=new Oy(et,{onerr:Ds,ontext(e,t){zi(Ct(e,t),e,t)},ontextentity(e,t,s){zi(e,t,s)},oninterpolation(e,t){if(un)return zi(Ct(e,t),e,t);let s=e+ot.delimiterOpen.length,n=t-ot.delimiterClose.length;for(;es(Gs.charCodeAt(s));)s++;for(;es(Gs.charCodeAt(n-1));)n--;let a=Ct(s,n);a.includes("&")&&(a=Be.decodeEntities(a,!1)),oo({type:5,content:Qi(a,!1,ut(s,n)),loc:ut(e,t)})},onopentagname(e,t){const s=Ct(e,t);Lt={type:1,tag:s,ns:Be.getNamespace(s,et[0],Be.ns),tagType:0,props:[],children:[],loc:ut(e-1,t),codegenNode:void 0}},onopentagend(e){Uu(e)},onclosetag(e,t){const s=Ct(e,t);if(!Be.isVoidTag(s)){let n=!1;for(let a=0;a<et.length;a++)if(et[a].tag.toLowerCase()===s.toLowerCase()){n=!0,a>0&&Ds(24,et[0].loc.start.offset);for(let l=0;l<=a;l++){const r=et.shift();Yi(r,t,l<a)}break}n||Ds(23,uh(e,60))}},onselfclosingtag(e){const t=Lt.tag;Lt.isSelfClosing=!0,Uu(e),et[0]&&et[0].tag===t&&Yi(et.shift(),e)},onattribname(e,t){Me={type:6,name:Ct(e,t),nameLoc:ut(e,t),value:void 0,loc:ut(e)}},ondirname(e,t){const s=Ct(e,t),n=s==="."||s===":"?"bind":s==="@"?"on":s==="#"?"slot":s.slice(2);if(!un&&n===""&&Ds(26,e),un||n==="")Me={type:6,name:s,nameLoc:ut(e,t),value:void 0,loc:ut(e)};else if(Me={type:7,name:n,rawName:s,exp:void 0,arg:void 0,modifiers:s==="."?[Ae("prop")]:[],loc:ut(e)},n==="pre"){un=ot.inVPre=!0,ro=Lt;const a=Lt.props;for(let i=0;i<a.length;i++)a[i].type===7&&(a[i]=t0(a[i]))}},ondirarg(e,t){if(e===t)return;const s=Ct(e,t);if(un&&!Fu(Me))Me.name+=s,Sn(Me.nameLoc,t);else{const n=s[0]!=="[";Me.arg=Qi(n?s:s.slice(1,-1),n,ut(e,t),n?3:0)}},ondirmodifier(e,t){const s=Ct(e,t);if(un&&!Fu(Me))Me.name+="."+s,Sn(Me.nameLoc,t);else if(Me.name==="slot"){const n=Me.arg;n&&(n.content+="."+s,Sn(n.loc,t))}else{const n=Ae(s,!0,ut(e,t));Me.modifiers.push(n)}},onattribdata(e,t){Gt+=Ct(e,t),Ps<0&&(Ps=e),_n=t},onattribentity(e,t,s){Gt+=e,Ps<0&&(Ps=t),_n=s},onattribnameend(e){const t=Me.loc.start.offset,s=Ct(t,e);Me.type===7&&(Me.rawName=s),Lt.props.some(n=>(n.type===7?n.rawName:n.name)===s)&&Ds(2,t)},onattribend(e,t){if(Lt&&Me){if(Sn(Me.loc,t),e!==0)if(Gt.includes("&")&&(Gt=Be.decodeEntities(Gt,!0)),Me.type===6)Me.name==="class"&&(Gt=fh(Gt).trim()),e===1&&!Gt&&Ds(13,t),Me.value={type:2,content:Gt,loc:e===1?ut(Ps,_n):ut(Ps-1,_n+1)},ot.inSFCRoot&&Lt.tag==="template"&&Me.name==="lang"&&Gt&&Gt!=="html"&&ot.enterRCDATA(wl("</template"),0);else{let s=0;Me.exp=Qi(Gt,!1,ut(Ps,_n),0,s),Me.name==="for"&&(Me.forParseResult=Gy(Me.exp));let n=-1;Me.name==="bind"&&(n=Me.modifiers.findIndex(a=>a.content==="sync"))>-1&&gi("COMPILER_V_BIND_SYNC",Be,Me.loc,Me.arg.loc.source)&&(Me.name="model",Me.modifiers.splice(n,1))}(Me.type!==7||Me.name!=="pre")&&Lt.props.push(Me)}Gt="",Ps=_n=-1},oncomment(e,t){Be.comments&&oo({type:3,content:Ct(e,t),loc:ut(e-4,t+3)})},onend(){const e=Gs.length;for(let t=0;t<et.length;t++)Yi(et[t],e-1),Ds(24,et[t].loc.start.offset)},oncdata(e,t){(et[0]?et[0].ns:Be.ns)!==0?zi(Ct(e,t),e,t):Ds(1,e-9)},onprocessinginstruction(e){(et[0]?et[0].ns:Be.ns)===0&&Ds(21,e-1)}}),Bu=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,Ky=/^\(|\)$/g;function Gy(e){const t=e.loc,s=e.content,n=s.match(qy);if(!n)return;const[,a,i]=n,l=(d,f,p=!1)=>{const m=t.start.offset+f,g=m+d.length;return Qi(d,!1,ut(m,g),0,p?1:0)},r={source:l(i.trim(),s.indexOf(i,a.length)),value:void 0,key:void 0,index:void 0,finalized:!1};let o=a.trim().replace(Ky,"").trim();const c=a.indexOf(o),u=o.match(Bu);if(u){o=o.replace(Bu,"").trim();const d=u[1].trim();let f;if(d&&(f=s.indexOf(d,c+o.length),r.key=l(d,f,!0)),u[2]){const p=u[2].trim();p&&(r.index=l(p,s.indexOf(p,r.key?f+d.length:c+o.length),!0))}}return o&&(r.value=l(o,c,!0)),r}function Ct(e,t){return Gs.slice(e,t)}function Uu(e){ot.inSFCRoot&&(Lt.innerLoc=ut(e+1,e+1)),oo(Lt);const{tag:t,ns:s}=Lt;s===0&&Be.isPreTag(t)&&mc++,Be.isVoidTag(t)?Yi(Lt,e):(et.unshift(Lt),(s===1||s===2)&&(ot.inXML=!0)),Lt=null}function zi(e,t,s){{const i=et[0]&&et[0].tag;i!=="script"&&i!=="style"&&e.includes("&")&&(e=Be.decodeEntities(e,!1))}const n=et[0]||vi,a=n.children[n.children.length-1];a&&a.type===2?(a.content+=e,Sn(a.loc,s)):n.children.push({type:2,content:e,loc:ut(t,s)})}function Yi(e,t,s=!1){s?Sn(e.loc,uh(t,60)):Sn(e.loc,Wy(t,62)+1),ot.inSFCRoot&&(e.children.length?e.innerLoc.end=Oe({},e.children[e.children.length-1].loc.end):e.innerLoc.end=Oe({},e.innerLoc.start),e.innerLoc.source=Ct(e.innerLoc.start.offset,e.innerLoc.end.offset));const{tag:n,ns:a,children:i}=e;if(un||(n==="slot"?e.tagType=2:Hu(e)?e.tagType=3:Zy(e)&&(e.tagType=1)),ot.inRCDATA||(e.children=dh(i)),a===0&&Be.isIgnoreNewlineTag(n)){const l=i[0];l&&l.type===2&&(l.content=l.content.replace(/^\r?\n/,""))}a===0&&Be.isPreTag(n)&&mc--,ro===e&&(un=ot.inVPre=!1,ro=null),ot.inXML&&(et[0]?et[0].ns:Be.ns)===0&&(ot.inXML=!1);{const l=e.props;if(!ot.inSFCRoot&&In("COMPILER_NATIVE_TEMPLATE",Be)&&e.tag==="template"&&!Hu(e)){const o=et[0]||vi,c=o.children.indexOf(e);o.children.splice(c,1,...e.children)}const r=l.find(o=>o.type===6&&o.name==="inline-template");r&&gi("COMPILER_INLINE_TEMPLATE",Be,r.loc)&&e.children.length&&(r.value={type:2,content:Ct(e.children[0].loc.start.offset,e.children[e.children.length-1].loc.end.offset),loc:r.loc})}}function Wy(e,t){let s=e;for(;Gs.charCodeAt(s)!==t&&s<Gs.length-1;)s++;return s}function uh(e,t){let s=e;for(;Gs.charCodeAt(s)!==t&&s>=0;)s--;return s}const Jy=new Set(["if","else","else-if","for","slot"]);function Hu({tag:e,props:t}){if(e==="template"){for(let s=0;s<t.length;s++)if(t[s].type===7&&Jy.has(t[s].name))return!0}return!1}function Zy({tag:e,props:t}){if(Be.isCustomElement(e))return!1;if(e==="component"||Yy(e.charCodeAt(0))||sh(e)||Be.isBuiltInComponent&&Be.isBuiltInComponent(e)||Be.isNativeTag&&!Be.isNativeTag(e))return!0;for(let s=0;s<t.length;s++){const n=t[s];if(n.type===6){if(n.name==="is"&&n.value){if(n.value.content.startsWith("vue:"))return!0;if(gi("COMPILER_IS_ON_ELEMENT",Be,n.loc))return!0}}else if(n.name==="bind"&&wn(n.arg,"is")&&gi("COMPILER_IS_ON_ELEMENT",Be,n.loc))return!0}return!1}function Yy(e){return e>64&&e<91}const Qy=/\r\n/g;function dh(e){const t=Be.whitespace!=="preserve";let s=!1;for(let n=0;n<e.length;n++){const a=e[n];if(a.type===2)if(mc)a.content=a.content.replace(Qy,`
`);else if(rh(a.content)){const i=e[n-1]&&e[n-1].type,l=e[n+1]&&e[n+1].type;!i||!l||t&&(i===3&&(l===3||l===1)||i===1&&(l===3||l===1&&Xy(a.content)))?(s=!0,e[n]=null):a.content=" "}else t&&(a.content=fh(a.content))}return s?e.filter(Boolean):e}function Xy(e){for(let t=0;t<e.length;t++){const s=e.charCodeAt(t);if(s===10||s===13)return!0}return!1}function fh(e){let t="",s=!1;for(let n=0;n<e.length;n++)es(e.charCodeAt(n))?s||(t+=" ",s=!0):(t+=e[n],s=!1);return t}function oo(e){(et[0]||vi).children.push(e)}function ut(e,t){return{start:ot.getPos(e),end:t==null?t:ot.getPos(t),source:t==null?t:Ct(e,t)}}function e0(e){return ut(e.start.offset,e.end.offset)}function Sn(e,t){e.end=ot.getPos(t),e.source=Ct(e.start.offset,t)}function t0(e){const t={type:6,name:e.rawName,nameLoc:ut(e.loc.start.offset,e.loc.start.offset+e.rawName.length),value:void 0,loc:e.loc};if(e.exp){const s=e.exp.loc;s.end.offset<e.loc.end.offset&&(s.start.offset--,s.start.column--,s.end.offset++,s.end.column++),t.value={type:2,content:e.exp.content,loc:s}}return t}function Qi(e,t=!1,s,n=0,a=0){return Ae(e,t,s,n)}function Ds(e,t,s){Be.onError(tt(e,ut(t,t)))}function s0(){ot.reset(),Lt=null,Me=null,Gt="",Ps=-1,_n=-1,et.length=0}function n0(e,t){if(s0(),Gs=e,Be=Oe({},ch),t){let a;for(a in t)t[a]!=null&&(Be[a]=t[a])}ot.mode=Be.parseMode==="html"?1:Be.parseMode==="sfc"?2:0,ot.inXML=Be.ns===1||Be.ns===2;const s=t&&t.delimiters;s&&(ot.delimiterOpen=wl(s[0]),ot.delimiterClose=wl(s[1]));const n=vi=Iy([],e);return ot.parse(Gs),n.loc=ut(0,e.length),n.children=dh(n.children),vi=null,n}function a0(e,t){Xi(e,void 0,t,!!ph(e))}function ph(e){const t=e.children.filter(s=>s.type!==3);return t.length===1&&t[0].type===1&&!Tl(t[0])?t[0]:null}function Xi(e,t,s,n=!1,a=!1){const{children:i}=e,l=[];for(let u=0;u<i.length;u++){const d=i[u];if(d.type===1&&d.tagType===0){const f=n?0:ts(d,s);if(f>0){if(f>=2){d.codegenNode.patchFlag=-1,l.push(d);continue}}else{const p=d.codegenNode;if(p.type===13){const m=p.patchFlag;if((m===void 0||m===512||m===1)&&gh(d,s)>=2){const g=mh(d);g&&(p.props=s.hoist(g))}p.dynamicProps&&(p.dynamicProps=s.hoist(p.dynamicProps))}}}else if(d.type===12&&(n?0:ts(d,s))>=2){d.codegenNode.type===14&&d.codegenNode.arguments.length>0&&d.codegenNode.arguments.push("-1"),l.push(d);continue}if(d.type===1){const f=d.tagType===1;f&&s.scopes.vSlot++,Xi(d,e,s,!1,a),f&&s.scopes.vSlot--}else if(d.type===11)Xi(d,e,s,d.children.length===1,!0);else if(d.type===9)for(let f=0;f<d.branches.length;f++)Xi(d.branches[f],e,s,d.branches[f].children.length===1,a)}let r=!1;if(l.length===i.length&&e.type===1){if(e.tagType===0&&e.codegenNode&&e.codegenNode.type===13&&fe(e.codegenNode.children))e.codegenNode.children=o(Rn(e.codegenNode.children)),r=!0;else if(e.tagType===1&&e.codegenNode&&e.codegenNode.type===13&&e.codegenNode.children&&!fe(e.codegenNode.children)&&e.codegenNode.children.type===15){const u=c(e.codegenNode,"default");u&&(u.returns=o(Rn(u.returns)),r=!0)}else if(e.tagType===3&&t&&t.type===1&&t.tagType===1&&t.codegenNode&&t.codegenNode.type===13&&t.codegenNode.children&&!fe(t.codegenNode.children)&&t.codegenNode.children.type===15){const u=os(e,"slot",!0),d=u&&u.arg&&c(t.codegenNode,u.arg);d&&(d.returns=o(Rn(d.returns)),r=!0)}}if(!r)for(const u of l)u.codegenNode=s.cache(u.codegenNode);function o(u){const d=s.cache(u);return d.needArraySpread=!0,d}function c(u,d){if(u.children&&!fe(u.children)&&u.children.type===15){const f=u.children.properties.find(p=>p.key===d||p.key.content===d);return f&&f.value}}l.length&&s.transformHoist&&s.transformHoist(i,s,e)}function ts(e,t){const{constantCache:s}=t;switch(e.type){case 1:if(e.tagType!==0)return 0;const n=s.get(e);if(n!==void 0)return n;const a=e.codegenNode;if(a.type!==13||a.isBlock&&e.tag!=="svg"&&e.tag!=="foreignObject"&&e.tag!=="math")return 0;if(a.patchFlag===void 0){let l=3;const r=gh(e,t);if(r===0)return s.set(e,0),0;r<l&&(l=r);for(let o=0;o<e.children.length;o++){const c=ts(e.children[o],t);if(c===0)return s.set(e,0),0;c<l&&(l=c)}if(l>1)for(let o=0;o<e.props.length;o++){const c=e.props[o];if(c.type===7&&c.name==="bind"&&c.exp){const u=ts(c.exp,t);if(u===0)return s.set(e,0),0;u<l&&(l=u)}}if(a.isBlock){for(let o=0;o<e.props.length;o++)if(e.props[o].type===7)return s.set(e,0),0;t.removeHelper(Ln),t.removeHelper(xa(t.inSSR,a.isComponent)),a.isBlock=!1,t.helper(ya(t.inSSR,a.isComponent))}return s.set(e,l),l}else return s.set(e,0),0;case 2:case 3:return 3;case 9:case 11:case 10:return 0;case 5:case 12:return ts(e.content,t);case 4:return e.constType;case 8:let i=3;for(let l=0;l<e.children.length;l++){const r=e.children[l];if(Te(r)||$t(r))continue;const o=ts(r,t);if(o===0)return 0;o<i&&(i=o)}return i;case 20:return 2;default:return 0}}const i0=new Set([rc,oc,pi,Ei]);function hh(e,t){if(e.type===14&&!Te(e.callee)&&i0.has(e.callee)){const s=e.arguments[0];if(s.type===4)return ts(s,t);if(s.type===14)return hh(s,t)}return 0}function gh(e,t){let s=3;const n=mh(e);if(n&&n.type===15){const{properties:a}=n;for(let i=0;i<a.length;i++){const{key:l,value:r}=a[i],o=ts(l,t);if(o===0)return o;o<s&&(s=o);let c;if(r.type===4?c=ts(r,t):r.type===14?c=hh(r,t):c=0,c===0)return c;c<s&&(s=c)}}return s}function mh(e){const t=e.codegenNode;if(t.type===13)return t.props}function l0(e,{filename:t="",prefixIdentifiers:s=!1,hoistStatic:n=!1,hmr:a=!1,cacheHandlers:i=!1,nodeTransforms:l=[],directiveTransforms:r={},transformHoist:o=null,isBuiltInComponent:c=It,isCustomElement:u=It,expressionPlugins:d=[],scopeId:f=null,slotted:p=!0,ssr:m=!1,inSSR:g=!1,ssrCssVars:k="",bindingMetadata:A=Pe,inline:b=!1,isTS:v=!1,onError:x=pc,onWarn:R=th,compatConfig:D}){const O=t.replace(/\?.*$/,"").match(/([^/\\]+)\.\w+$/),S={filename:t,selfName:O&&$n(Ke(O[1])),prefixIdentifiers:s,hoistStatic:n,hmr:a,cacheHandlers:i,nodeTransforms:l,directiveTransforms:r,transformHoist:o,isBuiltInComponent:c,isCustomElement:u,expressionPlugins:d,scopeId:f,slotted:p,ssr:m,inSSR:g,ssrCssVars:k,bindingMetadata:A,inline:b,isTS:v,onError:x,onWarn:R,compatConfig:D,root:e,helpers:new Map,components:new Set,directives:new Set,hoists:[],imports:[],cached:[],constantCache:new WeakMap,vForMemoKeyedNodes:new WeakSet,temps:0,identifiers:Object.create(null),scopes:{vFor:0,vSlot:0,vPre:0,vOnce:0},parent:null,grandParent:null,currentNode:e,childIndex:0,inVOnce:!1,helper(I){const w=S.helpers.get(I)||0;return S.helpers.set(I,w+1),I},removeHelper(I){const w=S.helpers.get(I);if(w){const $=w-1;$?S.helpers.set(I,$):S.helpers.delete(I)}},helperString(I){return`_${va[S.helper(I)]}`},replaceNode(I){S.parent.children[S.childIndex]=S.currentNode=I},removeNode(I){const w=S.parent.children,$=I?w.indexOf(I):S.currentNode?S.childIndex:-1;!I||I===S.currentNode?(S.currentNode=null,S.onNodeRemoved()):S.childIndex>$&&(S.childIndex--,S.onNodeRemoved()),S.parent.children.splice($,1)},onNodeRemoved:It,addIdentifiers(I){},removeIdentifiers(I){},hoist(I){Te(I)&&(I=Ae(I)),S.hoists.push(I);const w=Ae(`_hoisted_${S.hoists.length}`,!1,I.loc,2);return w.hoisted=I,w},cache(I,w=!1,$=!1){const F=Ny(S.cached.length,I,w,$);return S.cached.push(F),F}};return S.filters=new Set,S}function r0(e,t){const s=l0(e,t);Xl(e,s),t.hoistStatic&&a0(e,s),t.ssr||o0(e,s),e.helpers=new Set([...s.helpers.keys()]),e.components=[...s.components],e.directives=[...s.directives],e.imports=s.imports,e.hoists=s.hoists,e.temps=s.temps,e.cached=s.cached,e.transformed=!0,e.filters=[...s.filters]}function o0(e,t){const{helper:s}=t,{children:n}=e;if(n.length===1){const a=ph(e);if(a&&a.codegenNode){const i=a.codegenNode;i.type===13&&fc(i,t),e.codegenNode=i}else e.codegenNode=n[0]}else if(n.length>1){let a=64;e.codegenNode=hi(t,s(fi),void 0,e.children,a,void 0,void 0,!0,void 0,!1)}}function c0(e,t){let s=0;const n=()=>{s--};for(;s<e.children.length;s++){const a=e.children[s];Te(a)||(t.grandParent=t.parent,t.parent=e,t.childIndex=s,t.onNodeRemoved=n,Xl(a,t))}}function Xl(e,t){t.currentNode=e;const{nodeTransforms:s}=t,n=[];for(let i=0;i<s.length;i++){const l=s[i](e,t);if(l&&(fe(l)?n.push(...l):n.push(l)),t.currentNode)e=t.currentNode;else return}switch(e.type){case 3:t.ssr||t.helper(Ci);break;case 5:t.ssr||t.helper(Yl);break;case 9:for(let i=0;i<e.branches.length;i++)Xl(e.branches[i],t);break;case 10:case 11:case 1:case 0:c0(e,t);break}t.currentNode=e;let a=n.length;for(;a--;)n[a]()}function vh(e,t){const s=Te(e)?n=>n===e:n=>e.test(n);return(n,a)=>{if(n.type===1){const{props:i}=n;if(n.tagType===3&&i.some(Vy))return;const l=[];for(let r=0;r<i.length;r++){const o=i[r];if(o.type===7&&s(o.name)){i.splice(r,1),r--;const c=t(n,o,a);c&&l.push(c)}}return l}}}const er="/*@__PURE__*/",bh=e=>`${va[e]}: _${va[e]}`;function u0(e,{mode:t="function",prefixIdentifiers:s=t==="module",sourceMap:n=!1,filename:a="template.vue.html",scopeId:i=null,optimizeImports:l=!1,runtimeGlobalName:r="Vue",runtimeModuleName:o="vue",ssrRuntimeModuleName:c="vue/server-renderer",ssr:u=!1,isTS:d=!1,inSSR:f=!1}){const p={mode:t,prefixIdentifiers:s,sourceMap:n,filename:a,scopeId:i,optimizeImports:l,runtimeGlobalName:r,runtimeModuleName:o,ssrRuntimeModuleName:c,ssr:u,isTS:d,inSSR:f,source:e.source,code:"",column:1,line:1,offset:0,indentLevel:0,pure:!1,map:void 0,helper(g){return`_${va[g]}`},push(g,k=-2,A){p.code+=g},indent(){m(++p.indentLevel)},deindent(g=!1){g?--p.indentLevel:m(--p.indentLevel)},newline(){m(p.indentLevel)}};function m(g){p.push(`
`+"  ".repeat(g),0)}return p}function d0(e,t={}){const s=u0(e,t);t.onContextCreated&&t.onContextCreated(s);const{mode:n,push:a,prefixIdentifiers:i,indent:l,deindent:r,newline:o,scopeId:c,ssr:u}=s,d=Array.from(e.helpers),f=d.length>0,p=!i&&n!=="module";f0(e,s);const g=u?"ssrRender":"render",A=(u?["_ctx","_push","_parent","_attrs"]:["_ctx","_cache"]).join(", ");if(a(`function ${g}(${A}) {`),l(),p&&(a("with (_ctx) {"),l(),f&&(a(`const { ${d.map(bh).join(", ")} } = _Vue
...
`,-1),e.hoists.length)){const d=[Qo,Xo,Ci,ec,Yp].filter(f=>u.includes(f)).map(bh).join(", ");a(`const { ${d} } = _Vue
`,-1)}p0(e.hoists,t),i(),a("return ")}function Sr(e,t,{helper:s,push:n,newline:a,isTS:i}){const l=s(t==="filter"?ac:t==="component"?tc:nc);for(let r=0;r<e.length;r++){let o=e[r];const c=o.endsWith("__self");c&&(o=o.slice(0,-6)),n(`const ${mi(o,t)} = ${l}(${JSON.stringify(o)}${c?", true":""})${i?"!":""}`),r<e.length-1&&a()}}function p0(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:n}=t;n();for(let a=0;a<e.length;a++){const i=e[a];i&&(s(`const _hoisted_${a+1} = `),Ft(i,t),n())}t.pure=!1}function vc(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),Ai(e,t,s),s&&t.deindent(),t.push("]")}function Ai(e,t,s=!1,n=!0){const{push:a,newline:i}=t;for(let l=0;l<e.length;l++){const r=e[l];Te(r)?a(r,-3):fe(r)?vc(r,t):Ft(r,t),l<e.length-1&&(s?(n&&a(","),i()):n&&a(", "))}}function Ft(e,t){if(Te(e)){t.push(e,-3);return}if($t(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:Ft(e.codegenNode,t);break;case 2:h0(e,t);break;case 4:yh(e,t);break;case 5:g0(e,t);break;case 12:Ft(e.codegenNode,t);break;case 8:xh(e,t);break;case 3:v0(e,t);break;case 13:b0(e,t);break;case 14:x0(e,t);break;case 15:_0(e,t);break;case 17:k0(e,t);break;case 18:w0(e,t);break;case 19:S0(e,t);break;case 20:T0(e,t);break;case 21:Ai(e.body,t,!0,!1);break}}function h0(e,t){t.push(JSON.stringify(e.content),-3,e)}function yh(e,t){const{content:s,isStatic:n}=e;t.push(n?JSON.stringify(s):s,-3,e)}function g0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(er),s(`${n(Yl)}(`),Ft(e.content,t),s(")")}function xh(e,t){for(let s=0;s<e.children.length;s++){const n=e.children[s];Te(n)?t.push(n,-3):Ft(n,t)}}function m0(e,t){const{push:s}=t;if(e.type===8)s("["),xh(e,t),s("]");else if(e.isStatic){const n=hc(e.content)?e.content:JSON.stringify(e.content);s(n,-2,e)}else s(`[${e.content}]`,-3,e)}function v0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(er),s(`${n(Ci)}(${JSON.stringify(e.content)})`,-3,e)}function b0(e,t){const{push:s,helper:n,pure:a}=t,{tag:i,props:l,children:r,patchFlag:o,dynamicProps:c,directives:u,isBlock:d,disableTracking:f,isComponent:p}=e;let m;o&&(m=String(o)),u&&s(n(ic)+"("),d&&s(`(${n(Ln)}(${f?"true":""}), `),a&&s(er);const g=d?xa(t.inSSR,p):ya(t.inSSR,p);s(n(g)+"(",-2,e),Ai(y0([i,l,r,m,c]),t),s(")"),d&&s(")"),u&&(s(", "),Ft(u,t),s(")"))}function y0(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function x0(e,t){const{push:s,helper:n,pure:a}=t,i=Te(e.callee)?e.callee:n(e.callee);a&&s(er),s(i+"(",-2,e),Ai(e.arguments,t),s(")")}function _0(e,t){const{push:s,indent:n,deindent:a,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const r=l.length>1||!1;s(r?"{":"{ "),r&&n();for(let o=0;o<l.length;o++){const{key:c,value:u}=l[o];m0(c,t),s(": "),Ft(u,t),o<l.length-1&&(s(","),i())}r&&a(),s(r?"}":" }")}function k0(e,t){vc(e.elements,t)}function w0(e,t){const{push:s,indent:n,deindent:a}=t,{params:i,returns:l,body:r,newline:o,isSlot:c}=e;c&&s(`_${va[uc]}(`),s("(",-2,e),fe(i)?Ai(i,t):i&&Ft(i,t),s(") => "),(o||r)&&(s("{"),n()),l?(o&&s("return "),fe(l)?vc(l,t):Ft(l,t)):r&&Ft(r,t),(o||r)&&(a(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function S0(e,t){const{test:s,consequent:n,alternate:a,newline:i}=e,{push:l,indent:r,deindent:o,newline:c}=t;if(s.type===4){const d=!hc(s.content);d&&l("("),yh(s,t),d&&l(")")}else l("("),Ft(s,t),l(")");i&&r(),t.indentLevel++,i||l(" "),l("? "),Ft(n,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const u=a.type===19;u||t.indentLevel++,Ft(a,t),u||t.indentLevel--,i&&o(!0)}function T0(e,t){const{push:s,helper:n,indent:a,deindent:i,newline:l}=t,{needPauseTracking:r,needArraySpread:o}=e;o&&s("[...("),s(`_cache[${e.index}] || (`),r&&(a(),s(`${n(kl)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),Ft(e.value,t),r&&(s(`).cacheIndex = ${e.index},`),l(),s(`${n(kl)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),o&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const C0=vh(/^(?:if|else|else-if)$/,(e,t,s)=>E0(e,t,s,(n,a,i)=>{const l=s.parent.children;let r=l.indexOf(n),o=0;for(;r-->=0;){const c=l[r];c&&c.type===9&&(o+=c.branches.length)}return()=>{if(i)n.codegenNode=ju(a,o,s);else{const c=A0(n.codegenNode);c.alternate=ju(a,o+n.branches.length-1,s)}}}));function E0(e,t,s,n){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const a=t.exp?t.exp.loc:e.loc;s.onError(tt(28,t.loc)),t.exp=Ae("true",!1,a)}if(t.name==="if"){const a=Vu(e,t),i={type:9,loc:e0(e.loc),branches:[a]};if(s.replaceNode(i),n)return n(i,a,!0)}else{const a=s.parent.children;let i=a.indexOf(e);for(;i-->=-1;){const l=a[i];if(l&&oh(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(tt(30,e.loc)),s.removeNode();const r=Vu(e,t);l.branches.push(r);const o=n&&n(l,r,!1);Xl(r,s),o&&o(),s.currentNode=null}else s.onError(tt(30,e.loc));break}}}function Vu(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!os(e,"for")?e.children:[e],userKey:Ql(e,"key"),isTemplateIf:s}}function ju(e,t,s){return e.condition?lo(e.condition,zu(e,t,s),xt(s.helper(Ci),['""',"true"])):zu(e,t,s)}function zu(e,t,s){const{helper:n}=s,a=ht("key",Ae(`${t}`,!1,is,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const o=l.codegenNode;return Cl(o,a,s),o}else return hi(s,n(fi),cs([a]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const o=l.codegenNode,c=zy(o);return c.type===13&&fc(c,s),Cl(c,a,s),o}}function A0(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const R0=vh("for",(e,t,s)=>{const{helper:n,removeHelper:a}=s;return I0(e,t,s,i=>{const l=xt(n(lc),[i.source]),r=Sl(e),o=os(e,"memo"),c=Ql(e,"key",!1,!0);c&&c.type;let u=c&&(c.type===6?c.value?Ae(c.value.content,!0):void 0:c.exp);const d=u?ht("key",u):null,f=i.source.type===4&&i.source.constType>0,p=f?64:c?128:256;return i.codegenNode=hi(s,n(fi),void 0,l,p,void 0,void 0,!0,!f,!1,e.loc),()=>{let m;const{children:g}=i,k=g.length!==1||g[0].type!==1,A=Tl(e)?e:r&&e.children.length===1&&Tl(e.children[0])?e.children[0]:null;if(A?(m=A.codegenNode,r&&d&&Cl(m,d,s)):k?m=hi(s,n(fi),d?cs([d]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(m=g[0].codegenNode,r&&d&&Cl(m,d,s),m.isBlock!==!f&&(m.isBlock?(a(Ln),a(xa(s.inSSR,m.isComponent))):a(ya(s.inSSR,m.isComponent))),m.isBlock=!f,m.isBlock?(n(Ln),n(xa(s.inSSR,m.isComponent))):n(ya(s.inSSR,m.isComponent))),o){const b=ba(co(i.parseResult,[Ae("_cached")]));b.body=Dy([vs(["const _memo = (",o.exp,")"]),vs(["if (_cached && _cached.el",...u?[" && _cached.key === ",u]:[],` && ${s.helperString(eh)}(_cached, _memo)) return _cached`]),vs(["const _item = ",m]),Ae("_item.memo = _memo"),Ae("return _item")]),l.arguments.push(b,Ae("_cache"),Ae(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(ba(co(i.parseResult),m,!0))}})});function I0(e,t,s,n){if(!t.exp){s.onError(tt(31,t.loc));return}const a=t.forParseResult;if(!a){s.onError(tt(32,t.loc));return}_h(a);const{addIdentifiers:i,removeIdentifiers:l,scopes:r}=s,{source:o,value:c,key:u,index:d}=a,f={type:11,loc:t.loc,source:o,valueAlias:c,keyAlias:u,objectIndexAlias:d,parseResult:a,children:Sl(e)?e.children:[e]};s.replaceNode(f),r.vFor++;const p=n&&n(f);return()=>{r.vFor--,p&&p()}}function _h(e,t){e.finalized||(e.finalized=!0)}function co({value:e,key:t,index:s},n=[]){return N0([e,t,s,...n])}function N0(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,n)=>s||Ae("_".repeat(n+1),!1))}const qu=Ae("undefined",!1),D0=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=os(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},O0=(e,t,s,n)=>ba(e,s,!1,!0,s.length?s[0].loc:n);function L0(e,t,s=O0){t.helper(uc);const{children:n,loc:a}=e,i=[],l=[];let r=t.scopes.vSlot>0||t.scopes.vFor>0;const o=os(e,"slot",!0);if(o){const{arg:k,exp:A}=o;k&&!Qt(k)&&(r=!0),i.push(ht(k||Ae("default",!0),s(A,void 0,n,a)))}let c=!1,u=!1;const d=[],f=new Set;let p=0;for(let k=0;k<n.length;k++){const A=n[k];let b;if(!Sl(A)||!(b=os(A,"slot",!0))){A.type!==3&&d.push(A);continue}if(o){t.onError(tt(37,b.loc));break}c=!0;const{children:v,loc:x}=A,{arg:R=Ae("default",!0),exp:D,loc:O}=b;let S;Qt(R)?S=R?R.content:"default":r=!0;const I=os(A,"for"),w=s(D,I,v,x);let $,F;if($=os(A,"if"))r=!0,l.push(lo($.exp,qi(R,w,p++),qu));else if(F=os(A,/^else(?:-if)?$/,!0)){let P=k,W;for(;P--&&(W=n[P],!!oh(W)););if(W&&Sl(W)&&os(W,/^(?:else-)?if$/)){let U=l[l.length-1];for(;U.alternate.type===19;)U=U.alternate;U.alternate=F.exp?lo(F.exp,qi(R,w,p++),qu):qi(R,w,p++)}else t.onError(tt(30,F.loc))}else if(I){r=!0;const P=I.forParseResult;P?(_h(P),l.push(xt(t.helper(lc),[P.source,ba(co(P),qi(R,w),!0)]))):t.onError(tt(32,I.loc))}else{if(S){if(f.has(S)){t.onError(tt(38,O));continue}f.add(S),S==="default"&&(u=!0)}i.push(ht(R,w))}}if(!o){const k=(A,b)=>{const v=s(A,void 0,b,a);return t.compatConfig&&(v.isNonScopedSlot=!0),ht("default",v)};c?d.length&&!d.every(gc)&&(u?t.onError(tt(39,d[0].loc)):i.push(k(void 0,d))):i.push(k(void 0,n))}const m=r?2:el(e.children)?3:1;let g=cs(i.concat(ht("_",Ae(m+"",!1))),a);return l.length&&(g=xt(t.helper(Xp),[g,Rn(l)])),{slots:g,hasDynamicSlots:r}}function qi(e,t,s){const n=[ht("name",e),ht("fn",t)];return s!=null&&n.push(ht("key",Ae(String(s),!0))),cs(n)}function el(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||el(s.children))return!0;break;case 9:if(el(s.branches))return!0;break;case 10:case 11:if(el(s.children))return!0;break}}return!1}const kh=new WeakMap,P0=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:n,props:a}=e,i=e.tagType===1;let l=i?M0(e,t):`"${n}"`;const r=Ue(l)&&l.callee===sc;let o,c,u=0,d,f,p,m=r||l===Ya||l===Yo||!i&&(n==="svg"||n==="foreignObject"||n==="math");if(a.length>0){const g=wh(e,t,void 0,i,r);o=g.props,u=g.patchFlag,f=g.dynamicPropNames;const k=g.directives;p=k&&k.length?Rn(k.map(A=>$0(A,t))):void 0,g.shouldUseBlock&&(m=!0)}if(e.children.length>0)if(l===xl&&(m=!0,u|=1024),i&&l!==Ya&&l!==xl){const{slots:k,hasDynamicSlots:A}=L0(e,t);c=k,A&&(u|=1024)}else if(e.children.length===1&&l!==Ya){const k=e.children[0],A=k.type,b=A===5||A===8;b&&ts(k,t)===0&&(u|=1),b||A===2?c=k:c=e.children}else c=e.children;f&&f.length&&(d=B0(f)),e.codegenNode=hi(t,l,o,c,u===0?void 0:u,d,p,!!m,!1,i,e.loc)};function M0(e,t,s=!1){let{tag:n}=e;const a=uo(n),i=Ql(e,"is",!1,!0);if(i)if(a||In("COMPILER_IS_ON_ELEMENT",t)){let r;if(i.type===6?r=i.value&&Ae(i.value.content,!0):(r=i.exp,r||(r=Ae("is",!1,i.arg.loc))),r)return xt(t.helper(sc),[r])}else i.type===6&&i.value.content.startsWith("vue:")&&(n=i.value.content.slice(4));const l=sh(n)||t.isBuiltInComponent(n);return l?(s||t.helper(l),l):(t.helper(tc),t.components.add(n),mi(n,"component"))}function wh(e,t,s=e.props,n,a,i=!1){const{tag:l,loc:r,children:o}=e;let c=[];const u=[],d=[],f=o.length>0;let p=!1,m=0,g=!1,k=!1,A=!1,b=!1,v=!1,x=!1;const R=[],D=w=>{c.length&&(u.push(cs(Ku(c),r)),c=[]),w&&u.push(w)},O=()=>{t.scopes.vFor>0&&c.push(ht(Ae("ref_for",!0),Ae("true")))},S=({key:w,value:$})=>{if(Qt(w)){const F=w.content,P=Mn(F);if(P&&(!n||a)&&F.toLowerCase()!=="onclick"&&F!=="onUpdate:modelValue"&&!zs(F)&&(b=!0),P&&zs(F)&&(x=!0),P&&$.type===14&&($=$.arguments[0]),$.type===20||($.type===4||$.type===8)&&ts($,t)>0)return;F==="ref"?g=!0:F==="class"?k=!0:F==="style"?A=!0:F!=="key"&&!R.includes(F)&&R.push(F),n&&(F==="class"||F==="style")&&!R.includes(F)&&R.push(F)}else v=!0};for(let w=0;w<s.length;w++){const $=s[w];if($.type===6){const{loc:F,name:P,nameLoc:W,value:U}=$;let V=!0;if(P==="ref"&&(g=!0,O()),P==="is"&&(uo(l)||U&&U.content.startsWith("vue:")||In("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(ht(Ae(P,!0,W),Ae(U?U.content:"",V,U?U.loc:F)))}else{const{name:F,arg:P,exp:W,loc:U,modifiers:V}=$,N=F==="bind",L=F==="on";if(F==="slot"){n||t.onError(tt(40,U));continue}if(F==="once"||F==="memo"||F==="is"||N&&wn(P,"is")&&(uo(l)||In("COMPILER_IS_ON_ELEMENT",t))||L&&i)continue;if((N&&wn(P,"key")||L&&f&&wn(P,"vue:before-update"))&&(p=!0),N&&wn(P,"ref")&&O(),!P&&(N||L)){if(v=!0,W)if(N){if(D(),In("COMPILER_V_BIND_OBJECT_ORDER",t)){u.unshift(W);continue}O(),D(),u.push(W)}else D({type:14,loc:U,callee:t.helper(cc),arguments:n?[W]:[W,"true"]});else t.onError(tt(N?34:35,U));continue}N&&V.some(ue=>ue.content==="prop")&&(m|=32);const q=t.directiveTransforms[F];if(q){const{props:ue,needRuntime:ve}=q($,e,t);!i&&ue.forEach(S),L&&P&&!Qt(P)?D(cs(ue,r)):c.push(...ue),ve&&(d.push($),$t(ve)&&kh.set($,ve))}else Rg(F)||(d.push($),f&&(p=!0))}}let I;if(u.length?(D(),u.length>1?I=xt(t.helper(_l),u,r):I=u[0]):c.length&&(I=cs(Ku(c),r)),v?m|=16:(k&&!n&&(m|=2),A&&!n&&(m|=4),R.length&&(m|=8),b&&(m|=32)),!p&&(m===0||m===32)&&(g||x||d.length>0)&&(m|=512),!t.inSSR&&I)switch(I.type){case 15:let w=-1,$=-1,F=!1;for(let U=0;U<I.properties.length;U++){const V=I.properties[U].key;Qt(V)?V.content==="class"?w=U:V.content==="style"&&($=U):V.isHandlerKey||(F=!0)}const P=I.properties[w],W=I.properties[$];F?I=xt(t.helper(pi),[I]):(P&&!Qt(P.value)&&(P.value=xt(t.helper(rc),[P.value])),W&&(A||W.value.type===4&&W.value.content.trim()[0]==="["||W.value.type===17)&&(W.value=xt(t.helper(oc),[W.value])));break;case 14:break;default:I=xt(t.helper(pi),[xt(t.helper(Ei),[I])]);break}return{props:I,directives:d,patchFlag:m,dynamicPropNames:R,shouldUseBlock:p}}function Ku(e){const t=new Map,s=[];for(let n=0;n<e.length;n++){const a=e[n];if(a.key.type===8||!a.key.isStatic){s.push(a);continue}const i=a.key.content,l=t.get(i);l?(i==="style"||i==="class"||Mn(i))&&F0(l,a):(t.set(i,a),s.push(a))}return s}function F0(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Rn([e.value,t.value],e.loc)}function $0(e,t){const s=[],n=kh.get(e);n?s.push(t.helperString(n)):(t.helper(nc),t.directives.add(e.name),s.push(mi(e.name,"directive")));const{loc:a}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=Ae("true",!1,a);s.push(cs(e.modifiers.map(l=>ht(l,i)),a))}return Rn(s,e.loc)}function B0(e){let t="[";for(let s=0,n=e.length;s<n;s++)t+=JSON.stringify(e[s]),s<n-1&&(t+=", ");return t+"]"}function uo(e){return e==="component"||e==="Component"}const U0=(e,t)=>{if(Tl(e)){const{children:s,loc:n}=e,{slotName:a,slotProps:i}=H0(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",a,"{}","undefined","true"];let r=2;i&&(l[2]=i,r=3),s.length&&(l[3]=ba([],s,!1,!1,n),r=4),t.scopeId&&!t.slotted&&(r=5),l.splice(r),e.codegenNode=xt(t.helper(Qp),l,n)}};function H0(e,t){let s='"default"',n;const a=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=Ke(l.name),a.push(l)));else if(l.name==="bind"&&wn(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const r=Ke(l.arg.content);s=l.exp=Ae(r,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&Qt(l.arg)&&(l.arg.content=Ke(l.arg.content)),a.push(l)}if(a.length>0){const{props:i,directives:l}=wh(e,t,a,!1,!1);n=i,l.length&&t.onError(tt(36,l[0].loc))}return{slotName:s,slotProps:n}}const Sh=(e,t,s,n)=>{const{loc:a,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(tt(35,a));let r;if(l.type===4)if(l.isStatic){let d=l.content;d.startsWith("vue:")&&(d=`vnode-${d.slice(4)}`);const f=t.tagType!==0||d.startsWith("vnode")||!/[A-Z]/.test(d)?ia(Ke(d)):`on:${d}`;r=Ae(f,!0,l.loc)}else r=vs([`${s.helperString(io)}(`,l,")"]);else r=l,r.children.unshift(`${s.helperString(io)}(`),r.children.push(")");let o=e.exp;o&&!o.content.trim()&&(o=void 0);let c=s.cacheHandlers&&!o&&!s.inVOnce;if(o){const d=ih(o),f=!(d||Uy(o)),p=o.content.includes(";");(f||c&&d)&&(o=vs([`${f?"$event":"(...args)"} => ${p?"{":"("}`,o,p?"}":")"]))}let u={props:[ht(r,o||Ae("() => {}",!1,a))]};return n&&(u=n(u)),c&&(u.props[0].value=s.cache(u.props[0].value)),u.props.forEach(d=>d.key.isHandlerKey=!0),u},V0=(e,t,s)=>{const{modifiers:n,loc:a}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),n.some(r=>r.content==="camel")&&(i.type===4?i.isStatic?i.content=Ke(i.content):i.content=`${s.helperString(ao)}(${i.content})`:(i.children.unshift(`${s.helperString(ao)}(`),i.children.push(")"))),s.inSSR||(n.some(r=>r.content==="prop")&&Gu(i,"."),n.some(r=>r.content==="attr")&&Gu(i,"^")),{props:[ht(i,l)]}},Gu=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},j0=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let n,a=!1;for(let i=0;i<s.length;i++){const l=s[i];if(wr(l)){a=!0;for(let r=i+1;r<s.length;r++){const o=s[r];if(wr(o))n||(n=s[i]=vs([l],l.loc)),n.children.push(" + ",o),s.splice(r,1),r--;else{n=void 0;break}}}}if(!(!a||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(wr(l)||l.type===8){const r=[];(l.type!==2||l.content!==" ")&&r.push(l),!t.ssr&&ts(l,t)===0&&r.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:xt(t.helper(ec),r)}}}}},Wu=new WeakSet,z0=(e,t)=>{if(e.type===1&&os(e,"once",!0))return Wu.has(e)||t.inVOnce||t.inSSR?void 0:(Wu.add(e),t.inVOnce=!0,t.helper(kl),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Th=(e,t,s)=>{const{exp:n,arg:a}=e;if(!n)return s.onError(tt(41,e.loc)),Pa();const i=n.loc.source.trim(),l=n.type===4?n.content:i,r=s.bindingMetadata[i];if(r==="props"||r==="props-aliased")return s.onError(tt(44,n.loc)),Pa();if(r==="literal-const"||r==="setup-const")return s.onError(tt(45,n.loc)),Pa();if(!l.trim()||!ih(n))return s.onError(tt(42,n.loc)),Pa();const o=a||Ae("modelValue",!0),c=a?Qt(a)?`onUpdate:${Ke(a.content)}`:vs(['"onUpdate:" + ',a]):"onUpdate:modelValue";let u;const d=s.isTS?"($event: any)":"$event";u=vs([`${d} => ((`,n,") = $event)"]);const f=[ht(o,e.exp),ht(c,u)];if(e.modifiers.length&&t.tagType===1){const p=e.modifiers.map(g=>g.content).map(g=>(hc(g)?g:JSON.stringify(g))+": true").join(", "),m=a?Qt(a)?`${a.content}Modifiers`:vs([a,' + "Modifiers"']):"modelModifiers";f.push(ht(m,Ae(`{ ${p} }`,!1,e.loc,2)))}return Pa(f)};function Pa(e=[]){return{props:e}}const q0=/[\w).+\-_$\]]/,K0=(e,t)=>{In("COMPILER_FILTERS",t)&&(e.type===5?El(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&El(s.exp,t)}))};function El(e,t){if(e.type===4)Ju(e,t);else for(let s=0;s<e.children.length;s++){const n=e.children[s];typeof n=="object"&&(n.type===4?Ju(n,t):n.type===8?El(e,t):n.type===5&&El(n.content,t))}}function Ju(e,t){const s=e.content;let n=!1,a=!1,i=!1,l=!1,r=0,o=0,c=0,u=0,d,f,p,m,g=[];for(p=0;p<s.length;p++)if(f=d,d=s.charCodeAt(p),n)d===39&&f!==92&&(n=!1);else if(a)d===34&&f!==92&&(a=!1);else if(i)d===96&&f!==92&&(i=!1);else if(l)d===47&&f!==92&&(l=!1);else if(d===124&&s.charCodeAt(p+1)!==124&&s.charCodeAt(p-1)!==124&&!r&&!o&&!c)m===void 0?(u=p+1,m=s.slice(0,p).trim()):k();else{switch(d){case 34:a=!0;break;case 39:n=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:o++;break;case 93:o--;break;case 123:r++;break;case 125:r--;break}if(d===47){let A=p-1,b;for(;A>=0&&(b=s.charAt(A),b===" ");A--);(!b||!q0.test(b))&&(l=!0)}}m===void 0?m=s.slice(0,p).trim():u!==0&&k();function k(){g.push(s.slice(u,p).trim()),u=p+1}if(g.length){for(p=0;p<g.length;p++)m=G0(m,g[p],t);e.content=m,e.ast=void 0}}function G0(e,t,s){s.helper(ac);const n=t.indexOf("(");if(n<0)return s.filters.add(t),`${mi(t,"filter")}(${e})`;{const a=t.slice(0,n),i=t.slice(n+1);return s.filters.add(a),`${mi(a,"filter")}(${e}${i!==")"?","+i:i}`}}const Zu=new WeakSet,W0=(e,t)=>{if(e.type===1){const s=os(e,"memo");return!s||Zu.has(e)||t.inSSR?void 0:(Zu.add(e),()=>{const n=e.codegenNode||t.currentNode.codegenNode;n&&n.type===13&&(e.tagType!==1&&fc(n,t),e.codegenNode=xt(t.helper(dc),[s.exp,ba(void 0,n),"_cache",String(t.cached.length)]),t.cached.push(null))})}},J0=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const n=s.arg;if(n.type!==4||!n.isStatic)t.onError(tt(53,n.loc)),s.exp=Ae("",!0,n.loc);else{const a=Ke(n.content);(nh.test(a[0])||a[0]==="-")&&(s.exp=Ae(a,!1,n.loc))}}}};function Z0(e){return[[J0,z0,C0,W0,R0,K0,U0,P0,D0,j0],{on:Sh,bind:V0,model:Th}]}function Y0(e,t={}){const s=t.onError||pc,n=t.mode==="module";t.prefixIdentifiers===!0?s(tt(48)):n&&s(tt(49));const a=!1;t.cacheHandlers&&s(tt(50)),t.scopeId&&!n&&s(tt(51));const i=Oe({},t,{prefixIdentifiers:a}),l=Te(e)?n0(e,i):e,[r,o]=Z0();return r0(l,Oe({},i,{nodeTransforms:[...r,...t.nodeTransforms||[]],directiveTransforms:Oe({},o,t.directiveTransforms||{})})),d0(l,i)}const Q0=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Ch=Symbol(""),Eh=Symbol(""),Ah=Symbol(""),Rh=Symbol(""),fo=Symbol(""),Ih=Symbol(""),Nh=Symbol(""),Dh=Symbol(""),Oh=Symbol(""),Lh=Symbol("");Ry({[Ch]:"vModelRadio",[Eh]:"vModelCheckbox",[Ah]:"vModelText",[Rh]:"vModelSelect",[fo]:"vModelDynamic",[Ih]:"withModifiers",[Nh]:"withKeys",[Dh]:"vShow",[Oh]:"Transition",[Lh]:"TransitionGroup"});let Wn;function X0(e,t=!1){return Wn||(Wn=document.createElement("div")),t?(Wn.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,Wn.children[0].getAttribute("foo")):(Wn.innerHTML=e,Wn.textContent)}const ex={parseMode:"html",isVoidTag:Kg,isNativeTag:e=>jg(e)||zg(e)||qg(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:X0,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return Oh;if(e==="TransitionGroup"||e==="transition-group")return Lh},getNamespace(e,t,s){let n=t?t.ns:s;if(t&&n===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(a=>a.type===6&&a.name==="encoding"&&a.value!=null&&(a.value.content==="text/html"||a.value.content==="application/xhtml+xml"))&&(n=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(n=0);else t&&n===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(n=0);if(n===0){if(e==="svg")return 1;if(e==="math")return 2}return n}},tx=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:Ae("style",!0,t.loc),exp:sx(t.value.content,t.loc),modifiers:[],loc:t.loc})})},sx=(e,t)=>{const s=zd(e);return Ae(JSON.stringify(s),!1,t,3)};function pn(e,t){return tt(e,t)}const nx=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(pn(54,a)),t.children.length&&(s.onError(pn(55,a)),t.children.length=0),{props:[ht(Ae("innerHTML",!0,a),n||Ae("",!0))]}},ax=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(pn(56,a)),t.children.length&&(s.onError(pn(57,a)),t.children.length=0),{props:[ht(Ae("textContent",!0),n?ts(n,s)>0?n:xt(s.helperString(Yl),[n],a):Ae("",!0))]}},ix=(e,t,s)=>{const n=Th(e,t,s);if(!n.props.length||t.tagType===1)return n;e.arg&&s.onError(pn(59,e.arg.loc));const{tag:a}=t,i=s.isCustomElement(a);if(a==="input"||a==="textarea"||a==="select"||i){let l=Ah,r=!1;if(a==="input"||i){const o=Ql(t,"type");if(o){if(o.type===7)l=fo;else if(o.value)switch(o.value.content){case"radio":l=Ch;break;case"checkbox":l=Eh;break;case"file":r=!0,s.onError(pn(60,e.loc));break}}else Hy(t)&&(l=fo)}else a==="select"&&(l=Rh);r||(n.needRuntime=s.helper(l))}else s.onError(pn(58,e.loc));return n.props=n.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),n},lx=as("passive,once,capture"),rx=as("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),ox=as("left,right"),Ph=as("onkeyup,onkeydown,onkeypress"),cx=(e,t,s,n)=>{const a=[],i=[],l=[];for(let r=0;r<t.length;r++){const o=t[r].content;o==="native"&&gi("COMPILER_V_ON_NATIVE",s)||lx(o)?l.push(o):ox(o)?Qt(e)?Ph(e.content.toLowerCase())?a.push(o):i.push(o):(a.push(o),i.push(o)):rx(o)?i.push(o):a.push(o)}return{keyModifiers:a,nonKeyModifiers:i,eventOptionModifiers:l}},Yu=(e,t)=>Qt(e)&&e.content.toLowerCase()==="onclick"?Ae(t,!0):e.type!==4?vs(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,ux=(e,t,s)=>Sh(e,t,s,n=>{const{modifiers:a}=e;if(!a.length)return n;let{key:i,value:l}=n.props[0];const{keyModifiers:r,nonKeyModifiers:o,eventOptionModifiers:c}=cx(i,a,s,e.loc);if(o.includes("right")&&(i=Yu(i,"onContextmenu")),o.includes("middle")&&(i=Yu(i,"onMouseup")),o.length&&(l=xt(s.helper(Ih),[l,JSON.stringify(o)])),r.length&&(!Qt(i)||Ph(i.content.toLowerCase()))&&(l=xt(s.helper(Nh),[l,JSON.stringify(r)])),c.length){const u=c.map($n).join("");i=Qt(i)?Ae(`${i.content}${u}`,!0):vs(["(",i,`) + "${u}"`])}return{props:[ht(i,l)]}}),dx=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(pn(62,a)),{props:[],needRuntime:s.helper(Dh)}},fx=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},px=[tx],hx={cloak:Q0,html:nx,text:ax,model:ix,on:ux,show:dx};function gx(e,t={}){return Y0(e,Oe({},ex,t,{nodeTransforms:[fx,...px,...t.nodeTransforms||[]],directiveTransforms:Oe({},hx,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Qu=Object.create(null);function mx(e,t){if(!Te(e))if(e.nodeType)e=e.innerHTML;else return It;const s=Dg(e,t),n=Qu[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=Oe({hoistStatic:!0,onError:void 0,onWarn:It},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=gx(e,a),l=new Function("Vue",i)(wy);return l._rc=!0,Qu[s]=l}bp(mx);const Al=gn({items:[]});let vx=1;function tr(e,t="info",s=3e3){const n=vx++;return Al.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>bc(n),s),n}function bc(e){const t=Al.items.findIndex(s=>s.id===e);t>=0&&Al.items.splice(t,1)}function xe(e,t="info",s=3e3){return tr(e,t,s)}xe.success=(e,t=3e3)=>tr(e,"success",t);xe.error=(e,t=5e3)=>tr(e,"error",t);xe.info=(e,t=3e3)=>tr(e,"info",t);xe.dismiss=bc;const bx={setup(){return{state:Al,dismiss:bc}},template:`
  ...
  `},$s=gn({open:!1,title:"Confirm",message:"",confirmLabel:"Confirm",cancelLabel:"Cancel",danger:!1});let da=null;function ns({title:e="Confirm",message:t="",confirmLabel:s="Confirm",cancelLabel:n="Cancel",danger:a=!1}={}){return da&&da(!1),$s.title=e,$s.message=t,$s.confirmLabel=s,$s.cancelLabel=n,$s.danger=a,$s.open=!0,new Promise(i=>{da=i})}function Tr(e){$s.open=!1,da&&(da(e),da=null)}const yx={setup(){function e(t){$s.open&&(t.key==="Escape"&&(t.stopPropagation(),Tr(!1)),t.key==="Enter"&&(t.stopPropagation(),Tr(!0)))}return $e(()=>document.addEventListener("keydown",e,!0)),ft(()=>document.removeEventListener("keydown",e,!0)),{state:$s,settle:Tr}},template:`
 ...
 */let e_=()=>location.protocol+"//"+location.host;function qh(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),ed(r,"")}return ed(s,e)+n+a}function t_(e,t,s,n){let a=[],i=[],l=null;const r=({state:f})=>{const p=qh(e,location),m=s.value,g=t.value;let k=0;if(f){if(s.value=p,t.value=f,l&&l===m){l=null;return}k=g?f.position-g.position:0}else n(p);a.forEach(A=>{A(s.value,m,{delta:k,type:ho.pop,direction:k?k>0?Ar.forward:Ar.back:Ar.unknown})})};function o(){l=s.value}function c(f){a.push(f);const p=()=>{const m=a.indexOf(f);m>-1&&a.splice(m,1)};return i.push(p),p}function u(){if(document.visibilityState==="hidden"){const{history:f}=window;if(!f.state)return;f.replaceState(je({},f.state,{scroll:sr()}),"")}}function d(){for(const f of i)f();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",u),document.removeEventListener("visibilitychange",u)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",u),document.addEventListener("visibilitychange",u),{pauseListeners:o,listen:c,destroy:d}}function id(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?sr():null}}function s_(e){const{history:t,location:s}=window,n={value:qh(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,u){const d=e.indexOf("#"),f=d>-1?(s.host&&document.querySelector("base")?e:e.slice(d))+o:e_()+e+o;try{t[u?"replaceState":"pushState"](c,"",f),a.value=c}catch(p){console.error(p),s[u?"replace":"assign"](f)}}function l(o,c){i(o,je({},t.state,id(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const u=je({},a.value,t.state,{forward:o,scroll:sr()});i(u.current,u,!0),i(o,je({},id(n.value,o,null),{position:u.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function n_(e){e=Ux(e);const t=s_(e),s=t_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=je({location:"",base:e,go:n,createHref:Vx.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function a_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),n_(e)}let Tn=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var bt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(bt||{});const i_={type:Tn.Static,value:""},l_=/[a-zA-Z0-9_]/;function r_(e){if(!e)return[[]];if(e==="/")return[[i_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(p){throw new Error(`ERR (${s})/"${c}": ${p}`)}let s=bt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",u="";function d(){c&&(s===bt.Static?i.push({type:Tn.Static,value:c}):s===bt.Param||s===bt.ParamRegExp||s===bt.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Tn.Param,value:c,regexp:u,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function f(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==bt.ParamRegExp){n=s,s=bt.EscapeNext;continue}switch(s){case bt.Static:o==="/"?(c&&d(),l()):o===":"?(d(),s=bt.Param):f();break;case bt.EscapeNext:f(),s=n;break;case bt.Param:o==="("?s=bt.ParamRegExp:l_.test(o)?f():(d(),s=bt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case bt.ParamRegExp:o===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+o:s=bt.ParamRegExpEnd:u+=o;break;case bt.ParamRegExpEnd:d(),s=bt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,u="";break;default:t("Unknown state");break}}return s===bt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),d(),l(),a}const ld="[^/]+?",o_={sensitive:!1,strict:!1,start:!0,end:!0};var Ht=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Ht||{});const c_=/[.+*?^${}()[\]/\\]/g;function u_(e,t){const s=je({},o_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const u=c.length?[]:[Ht.Root];s.strict&&!c.length&&(a+="/");for(let d=0;d<c.length;d++){const f=c[d];let p=Ht.Segment+(s.sensitive?Ht.BonusCaseSensitive:0);if(f.type===Tn.Static)d||(a+="/"),a+=f.value.replace(c_,"\\$&"),p+=Ht.Static;else if(f.type===Tn.Param){const{value:m,repeatable:g,optional:k,regexp:A}=f;i.push({name:m,repeatable:g,optional:k});const b=A||ld;if(b!==ld){p+=Ht.BonusCustomRegExp;try{`${b}`}catch(x){throw new Error(`Invalid custom RegExp for param "${m}" (${b}): `+x.message)}}let v=g?`((?:${b})(?:/(?:${b}))*)`:`(${b})`;d||(v=k&&c.length<2?`(?:/${v})`:"/"+v),k&&(v+="?"),a+=v,p+=Ht.Dynamic,k&&(p+=Ht.BonusOptional),g&&(p+=Ht.BonusRepeatable),b===".*"&&(p+=Ht.BonusWildcard)}u.push(p)}n.push(u)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=Ht.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const u=c.match(l),d={};if(!u)return null;for(let f=1;f<u.length;f++){const p=u[f]||"",m=i[f-1];d[m.name]=p&&m.repeatable?p.split("/"):p}return d}function o(c){let u="",d=!1;for(const f of e){(!d||!u.endsWith("/"))&&(u+="/"),d=!1;for(const p of f)if(p.type===Tn.Static)u+=p.value;else if(p.type===Tn.Param){const{value:m,repeatable:g,optional:k}=p,A=m in c?c[m]:"";if(ys(A)&&!g)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const b=ys(A)?A.join("/"):A;if(!b)if(k)f.length<2&&(u.endsWith("/")?u=u.slice(0,-1):d=!0);else throw new Error(`Missing required param "${m}"`);u+=b}}return u||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function d_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Ht.Static+Ht.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Ht.Static+Ht.Segment?1:-1:0}function Kh(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=d_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(rd(n))return 1;if(rd(a))return-1}return a.length-n.length}function rd(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const f_={strict:!1,end:!0,sensitive:!1};function p_(e,t,s){const n=u_(r_(e.path),s),a=je(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function h_(e,t){const s=[],n=new Map;t=Xu(f_,t);function a(d){return n.get(d)}function i(d,f,p){const m=!p,g=cd(d);g.aliasOf=p&&p.record;const k=Xu(t,d),A=[g];if("alias"in d){const x=typeof d.alias=="string"?[d.alias]:d.alias;for(const R of x)A.push(cd(je({},g,{components:p?p.record.components:g.components,path:R,aliasOf:p?p.record:g})))}let b,v;for(const x of A){const{path:R}=x;if(f&&R[0]!=="/"){const D=f.record.path,O=D[D.length-1]==="/"?"":"/";x.path=f.record.path+(R&&O+R)}if(b=p_(x,f,k),p?p.alias.push(b):(v=v||b,v!==b&&v.alias.push(b),m&&d.name&&!ud(b)&&l(d.name)),Gh(b)&&o(b),g.children){const D=g.children;for(let O=0;O<D.length;O++)i(D[O],b,p&&p.children[O])}p=p||b}return v?()=>{l(v)}:Qa}function l(d){if(jh(d)){const f=n.get(d);f&&(n.delete(d),s.splice(s.indexOf(f),1),f.children.forEach(l),f.alias.forEach(l))}else{const f=s.indexOf(d);f>-1&&(s.splice(f,1),d.record.name&&n.delete(d.record.name),d.children.forEach(l),d.alias.forEach(l))}}function r(){return s}function o(d){const f=v_(d,s);s.splice(f,0,d),d.record.name&&!ud(d)&&n.set(d.record.name,d)}function c(d,f){let p,m={},g,k;if("name"in d&&d.name){if(p=n.get(d.name),!p)throw ka(rt.MATCHER_NOT_FOUND,{location:d});k=p.record.name,m=je(od(f.params,p.keys.filter(v=>!v.optional).concat(p.parent?p.parent.keys.filter(v=>v.optional):[]).map(v=>v.name)),d.params&&od(d.params,p.keys.map(v=>v.name))),g=p.stringify(m)}else if(d.path!=null)g=d.path,p=s.find(v=>v.re.test(g)),p&&(m=p.parse(g),k=p.record.name);else{if(p=f.name?n.get(f.name):s.find(v=>v.re.test(f.path)),!p)throw ka(rt.MATCHER_NOT_FOUND,{location:d,currentLocation:f});k=p.record.name,m=je({},f.params,d.params),g=p.stringify(m)}const A=[];let b=p;for(;b;)A.unshift(b.record),b=b.parent;return{name:k,path:g,params:m,matched:A,meta:m_(A)}}e.forEach(d=>i(d));function u(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:u,getRoutes:r,getRecordMatcher:a}}function od(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function cd(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:g_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function g_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function ud(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function m_(e){return e.reduce((t,s)=>je(t,s.meta),{})}function v_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;Kh(e,t[i])<0?n=i:s=i+1}const a=b_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function b_(e){let t=e;for(;t=t.parent;)if(Gh(t)&&Kh(e,t)===0)return t}function Gh({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function dd(e){const t=us(nr),s=us(xc),n=ee(()=>{const o=Es(e.to);return t.resolve(o)}),a=ee(()=>{const{matched:o}=n.value,{length:c}=o,u=o[c-1],d=s.matched;if(!u||!d.length)return-1;const f=d.findIndex(_a.bind(null,u));if(f>-1)return f;const p=fd(o[c-2]);return c>1&&fd(u)===p&&d[d.length-1].path!==p?d.findIndex(_a.bind(null,o[c-2])):f}),i=ee(()=>a.value>-1&&w_(s.params,n.value.params)),l=ee(()=>a.value>-1&&a.value===s.matched.length-1&&Vh(s.params,n.value.params));function r(o={}){if(k_(o)){const c=t[Es(e.replace)?"replace":"push"](Es(e.to)).catch(Qa);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:ee(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function y_(e){return e.length===1?e[0]:e}const x_=wi({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:dd,setup(e,{slots:t}){const s=gn(dd(e)),{options:n}=us(nr),a=ee(()=>({[pd(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[pd(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&y_(t.default(s));return e.custom?i:ha("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),__=x_;function k_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function w_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!ys(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function fd(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const pd=(e,t,s)=>e??t??s,S_=wi({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=us(mo),a=ee(()=>e.route||n.value),i=us(ad,0),l=ee(()=>{let c=Es(i);const{matched:u}=a.value;let d;for(;(d=u[c])&&!d.components;)c++;return c}),r=ee(()=>a.value.matched[l.value]);Ga(ad,ee(()=>l.value+1)),Ga(Qx,r),Ga(mo,a);const o=h();return ds(()=>[o.value,r.value,e.name],([c,u,d],[f,p,m])=>{u&&(u.instances[d]=c,p&&p!==u&&c&&c===f&&(u.leaveGuards.size||(u.leaveGuards=p.leaveGuards),u.updateGuards.size||(u.updateGuards=p.updateGuards))),c&&u&&(!p||!_a(u,p)||!f)&&(u.enterCallbacks[d]||[]).forEach(g=>g(c))},{flush:"post"}),()=>{const c=a.value,u=e.name,d=r.value,f=d&&d.components[u];if(!f)return hd(s.default,{Component:f,route:c});const p=d.props[u],m=p?p===!0?c.params:typeof p=="function"?p(c):p:null,k=ha(f,je({},m,t,{onVnodeUnmounted:A=>{A.component.isUnmounted&&(d.instances[u]=null)},ref:o}));return hd(s.default,{Component:k,route:c})||k}}});function hd(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const T_=S_;function C_(e){const t=h_(e.routes,e),s=e.parseQuery||Zx,n=e.stringifyQuery||nd,a=e.history,i=Ma(),l=Ma(),r=Ma(),o=Io(an);let c=an;Xn&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Cr.bind(null,j=>""+j),d=Cr.bind(null,Ox),f=Cr.bind(null,bi);function p(j,re){let le,ge;return jh(j)?(le=t.getRecordMatcher(j),ge=re):ge=j,t.addRoute(ge,le)}function m(j){const re=t.getRecordMatcher(j);re&&t.removeRoute(re)}function g(){return t.getRoutes().map(j=>j.record)}function k(j){return!!t.getRecordMatcher(j)}function A(j,re){if(re=je({},re||o.value),typeof j=="string"){const T=Er(s,j,re.path),M=t.resolve({path:T.path},re),G=a.createHref(T.fullPath);return je(T,M,{params:f(M.params),hash:bi(T.hash),redirectedFrom:void 0,href:G})}let le;if(j.path!=null)le=je({},j,{path:Er(s,j.path,re.path).path});else{const T=je({},j.params);for(const M in T)T[M]==null&&delete T[M];le=je({},j,{params:d(T)}),re.params=d(re.params)}const ge=t.resolve(le,re),me=j.hash||"";ge.params=u(f(ge.params));const De=Mx(n,je({},j,{hash:Ix(me),path:ge.path})),y=a.createHref(De);return je({fullPath:De,hash:me,query:n===nd?Yx(j.query):j.query||{}},ge,{redirectedFrom:void 0,href:y})}function b(j){return typeof j=="string"?Er(s,j,o.value.path):je({},j)}function v(j,re){if(c!==j)return ka(rt.NAVIGATION_CANCELLED,{from:re,to:j})}function x(j){return O(j)}function R(j){return x(je(b(j),{replace:!0}))}function D(j,re){const le=j.matched[j.matched.length-1];if(le&&le.redirect){const{redirect:ge}=le;let me=typeof ge=="function"?ge(j,re):ge;return typeof me=="string"&&(me=me.includes("?")||me.includes("#")?me=b(me):{path:me},me.params={}),je({query:j.query,hash:j.hash,params:me.path!=null?{}:j.params},me)}}function O(j,re){const le=c=A(j),ge=o.value,me=j.state,De=j.force,y=j.replace===!0,T=D(le,ge);if(T)return O(je(b(T),{state:typeof T=="object"?je({},me,T.state):me,force:De,replace:y}),re||le);const M=le;M.redirectedFrom=re;let G;return!De&&Fx(n,ge,le)&&(G=ka(rt.NAVIGATION_DUPLICATED,{to:M,from:ge}),ve(ge,ge,!0,!1)),(G?Promise.resolve(G):w(M,ge)).catch(E=>Os(E)?Os(E,rt.NAVIGATION_GUARD_REDIRECT)?E:ue(E):L(E,M,ge)).then(E=>{if(E){if(Os(E,rt.NAVIGATION_GUARD_REDIRECT))return O(je({replace:y},b(E.to),{state:typeof E.to=="object"?je({},me,E.to.state):me,force:De}),re||M)}else E=F(M,ge,!0,y,me);return $(M,ge,E),E})}function S(j,re){const le=v(j,re);return le?Promise.reject(le):Promise.resolve()}function I(j){const re=Z.values().next().value;return re&&typeof re.runWithContext=="function"?re.runWithContext(j):j()}function w(j,re){let le;const[ge,me,De]=Xx(j,re);le=Rr(ge.reverse(),"beforeRouteLeave",j,re);for(const T of ge)T.leaveGuards.forEach(M=>{le.push(dn(M,j,re))});const y=S.bind(null,j,re);return le.push(y),Ie(le).then(()=>{le=[];for(const T of i.list())le.push(dn(T,j,re));return le.push(y),Ie(le)}).then(()=>{le=Rr(me,"beforeRouteUpdate",j,re);for(const T of me)T.updateGuards.forEach(M=>{le.push(dn(M,j,re))});return le.push(y),Ie(le)}).then(()=>{le=[];for(const T of De)if(T.beforeEnter)if(ys(T.beforeEnter))for(const M of T.beforeEnter)le.push(dn(M,j,re));else le.push(dn(T.beforeEnter,j,re));return le.push(y),Ie(le)}).then(()=>(j.matched.forEach(T=>T.enterCallbacks={}),le=Rr(De,"beforeRouteEnter",j,re,I),le.push(y),Ie(le))).then(()=>{le=[];for(const T of l.list())le.push(dn(T,j,re));return le.push(y),Ie(le)}).catch(T=>Os(T,rt.NAVIGATION_CANCELLED)?T:Promise.reject(T))}function $(j,re,le){r.list().forEach(ge=>I(()=>ge(j,re,le)))}function F(j,re,le,ge,me){const De=v(j,re);if(De)return De;const y=re===an,T=Xn?history.state:{};le&&(ge||y?a.replace(j.fullPath,je({scroll:y&&T&&T.scroll},me)):a.push(j.fullPath,me)),o.value=j,ve(j,re,le,y),ue()}let P;function W(){P||(P=a.listen((j,re,le)=>{if(!oe.listening)return;const ge=A(j),me=D(ge,oe.currentRoute.value);if(me){O(je(me,{replace:!0,force:!0}),ge).catch(Qa);return}c=ge;const De=o.value;Xn&&qx(sd(De.fullPath,le.delta),sr()),w(ge,De).catch(y=>Os(y,rt.NAVIGATION_ABORTED|rt.NAVIGATION_CANCELLED)?y:Os(y,rt.NAVIGATION_GUARD_REDIRECT)?(O(je(b(y.to),{force:!0}),ge).then(T=>{Os(T,rt.NAVIGATION_ABORTED|rt.NAVIGATION_DUPLICATED)&&!le.delta&&le.type===ho.pop&&a.go(-1,!1)}).catch(Qa),Promise.reject()):(le.delta&&a.go(-le.delta,!1),L(y,ge,De))).then(y=>{y=y||F(ge,De,!1),y&&(le.delta&&!Os(y,rt.NAVIGATION_CANCELLED)?a.go(-le.delta,!1):le.type===ho.pop&&Os(y,rt.NAVIGATION_ABORTED|rt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),$(ge,De,y)}).catch(Qa)}))}let U=Ma(),V=Ma(),N;function L(j,re,le){ue(j);const ge=V.list();return ge.length?ge.forEach(me=>me(j,re,le)):console.error(j),Promise.reject(j)}function q(){return N&&o.value!==an?Promise.resolve():new Promise((j,re)=>{U.add([j,re])})}function ue(j){return N||(N=!j,W(),U.list().forEach(([re,le])=>j?le(j):re()),U.reset()),j}function ve(j,re,le,ge){const{scrollBehavior:me}=e;if(!Xn||!me)return Promise.resolve();const De=!le&&Kx(sd(j.fullPath,0))||(ge||!le)&&history.state&&history.state.scroll||null;return Et().then(()=>me(j,re,De)).then(y=>y&&zx(y)).catch(y=>L(y,j,re))}const se=j=>a.go(j);let de;const Z=new Set,oe={currentRoute:o,listening:!0,addRoute:p,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:k,getRoutes:g,resolve:A,options:e,push:x,replace:R,go:se,back:()=>se(-1),forward:()=>se(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:V.add,isReady:q,install(j){j.component("RouterLink",__),j.component("RouterView",T_),j.config.globalProperties.$router=oe,Object.defineProperty(j.config.globalProperties,"$route",{enumerable:!0,get:()=>Es(o)}),Xn&&!de&&o.value===an&&(de=!0,x(a.location).catch(ge=>{}));const re={};for(const ge in an)Object.defineProperty(re,ge,{get:()=>o.value[ge],enumerable:!0});j.provide(nr,oe),j.provide(xc,Ro(re)),j.provide(mo,o);const le=j.unmount;Z.add(j),j.unmount=function(){Z.delete(j),Z.size<1&&(c=an,P&&P(),P=null,o.value=an,de=!1,N=!1),le()}}};function Ie(j){return j.reduce((re,le)=>re.then(()=>I(le)),Promise.resolve())}return oe}function Wh(){return us(nr)}function E_(e){return us(xc)}const A_=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...["Live","Agents","Loops","Processes","Schedules"].map(e=>({group:"Operations",label:e,icon:"operations",to:{path:"/operations",query:{tab:e.toLowerCase()}}})),...["Audit","Sessions","Traces","Usage"].map(e=>({group:"History",label:e,icon:"history",to:{path:"/history",query:{tab:e.toLowerCase()}}})),...["Tools","Skills","Knowledge","Memory","Learned"].map(e=>({group:"Capabilities",label:e,icon:"capabilities",to:{path:"/capabilities",query:{tab:e.toLowerCase()}}})),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...[["Health","health"],["Resources","resources"],["Logs","logs"],["Config","config"],["Discord","discord"],["Host Access","host-access"],["API Tokens","api-tokens"],["LLM Config","llm"],["Internals","internals"],["Update","update"]].map(([e,t])=>({group:"System",label:e,icon:"system",to:{path:"/system",query:{tab:t}}}))],Jt=gn({open:!1,query:"",selected:0});function gd(){Jt.query="",Jt.selected=0,Jt.open=!0}function Ir(){Jt.open=!1}function R_(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const I_={setup(){const e=Wh(),t=h(null),s=ee(()=>{const i=Jt.query.trim().toLowerCase();return A_.map(l=>({...l,_score:R_(l,i)})).filter(l=>l._score>0).sort((l,r)=>r._score-l._score)});ds(()=>Jt.open,async i=>{var l;i&&(await Et(),(l=t.value)==null||l.focus())}),ds(()=>Jt.query,()=>{Jt.selected=0});function n(i){Ir(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Ir();return}if(i.key==="ArrowDown")i.preventDefault(),Jt.selected=Math.min(Jt.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Jt.selected=Math.max(Jt.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Jt.selected];l&&n(l)}}return{state:Jt,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Ir}},template:`
  ...
  `},vo={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01"};Object.freeze(Object.keys(vo));const N_={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>ha("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[ha("path",{d:vo[e.name]||vo.info})])}};function _c(e){if(e instanceof Date)return e;if(typeof e=="string"){const t=new Date(e);return isNaN(t.getTime())?null:t}return typeof e=="number"&&isFinite(e)?new Date(e<1e12?e*1e3:e):null}function Ea(e){const t=_c(e);return t?t.toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"}):"—"}function kc(e){const t=_c(e);return t?t.toLocaleTimeString():"—"}function Jh(e){const t=_c(e);if(!t)return"—";const s=Math.max(0,Math.floor((Date.now()-t.getTime())/1e3));return s<60?`${s}s ago`:s<3600?`${Math.floor(s/60)}m ago`:s<86400?`${Math.floor(s/3600)}h ago`:`${Math.floor(s/86400)}d ago`}function wa(e){if(e==null||!isFinite(e))return"—";const t=Math.max(0,Math.round(e));if(t<60)return`${t}s`;if(t<3600){const a=Math.floor(t/60),i=t%60;return i?`${a}m ${i}s`:`${a}m`}const s=Math.floor(t/3600),n=Math.floor(t%3600/60);return n?`${s}h ${n}m`:`${s}h`}function wc(e,t=200){const s=String(e??"");return s.length>t?s.slice(0,t)+"…":s}function Zh(e,t=5e3){const s=String(e??"");return s.length>t?s.slice(0,t)+`
... (truncated)`:s}function md(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Yh(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function D_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const O_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=ee(()=>{const P=e.value.uptime_seconds||0,W=Math.floor(P/86400),U=Math.floor(P%86400/3600),V=Math.floor(P%3600/60),N=[];return W>0&&N.push(`${W}d`),U>0&&N.push(`${U}h`),(N.length===0||W===0&&U===0)&&N.push(`${V}m`),N.join(" ")}),p=ee(()=>{const P=e.value.uptime_seconds||0;return 125.66*(1-Math.min(P/86400,1))}),m=ee(()=>{const P=e.value;return[{label:"Guilds",value:P.guild_count??0,icon:"⌂",iconColor:"text-blue-400"},{label:"Sessions",value:P.session_count??0,icon:"☰",iconColor:"text-yellow-400"},{label:"Tools",value:P.tool_count??0,icon:"⚒",iconColor:"text-purple-400",sub:`${P.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:P.loop_count??0,icon:"⟳",iconColor:"text-green-400",color:P.loop_count>0?"text-green-400":"",highlight:P.loop_count>0},{label:"Agents",value:P.agent_running??0,icon:"⚓",iconColor:"text-cyan-400",sub:P.agent_count>0?`${P.agent_count} total`:"",subColor:"text-gray-500",highlight:(P.agent_running??0)>0},{label:"Processes",value:P.process_running??0,icon:"⚙",iconColor:"text-orange-400",sub:P.process_count>0?`${P.process_count} total`:"",subColor:"text-gray-500",highlight:(P.process_running??0)>0},{label:"Schedules",value:P.schedule_count??0,icon:"⏰",iconColor:"text-amber-400",sub:(P.schedule_failing>0?`${P.schedule_failing} failing`:"")+(P.schedule_failing>0&&P.schedule_paused>0?", ":"")+(P.schedule_paused>0?`${P.schedule_paused} paused`:"")||void 0,subColor:P.schedule_failing>0?"text-red-400":"text-yellow-400",color:P.schedule_failing>0?"text-red-400":"",highlight:P.schedule_failing>0},{label:"Users",value:P.user_count??0,icon:"☺",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"≡",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=ee(()=>{const P=e.value,W=[];return W.push({label:"Bot",status:P.status==="online"?"ok":"warn",detail:P.status==="online"?"Online":"Starting"}),(P.schedule_failing||0)>0?W.push({label:"Schedules",status:"error",detail:`${P.schedule_failing} failing`}):(P.schedule_count||0)>0&&W.push({label:"Schedules",status:"ok",detail:`${P.schedule_count} configured`}),(P.loop_count||0)>0&&W.push({label:"Loops",status:"ok",detail:`${P.loop_count} active`}),(P.agent_running||0)>0&&W.push({label:"Agents",status:"ok",detail:`${P.agent_running} running`}),(P.process_running||0)>0&&W.push({label:"Processes",status:"ok",detail:`${P.process_running} running`}),W});async function k(){try{e.value=await K.get("/api/status"),s.value=null}catch(P){s.value=P.message}finally{t.value=!1}}async function A(){a.value=!0;try{n.value=await K.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function b(){l.value=!0;try{i.value=await K.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function v(){try{const P=await K.get("/api/knowledge");c.value=(Array.isArray(P)?P:[]).reduce((W,U)=>W+(U.chunks||0),0)}catch{c.value=null}}async function x(){try{const P=await K.get("/api/agents");r.value=P.filter(W=>W.status==="running")}catch{}}async function R(){u.value={...u.value,reload:!0};try{await K.post("/api/reload"),xe.success("Config reloaded")}catch(P){xe.error(P.message)}u.value={...u.value,reload:!1}}async function D(){if(!await ns({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const W=e.value.session_count;e.value={...e.value,session_count:0};try{const U=await K.post("/api/sessions/clear-all");xe.success(`Cleared ${U.count} session${U.count!==1?"s":""}`),await k()}catch(U){e.value={...e.value,session_count:W},xe.error(U.message)}u.value={...u.value,clearSessions:!1}}async function O(){if(!await ns({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const W=e.value.loop_count;e.value={...e.value,loop_count:0};try{const U=await K.post("/api/loops/stop-all");xe.success(U.result),await k()}catch(U){e.value={...e.value,loop_count:W},xe.error(U.message)}u.value={...u.value,stopLoops:!1}}function S(){t.value=!0,s.value=null,k(),A(),b(),x()}let I=null,w=null,$=null;function F(P){if(P.payload&&P.payload.tool_name){const W={...P.payload,_isNew:!0,_key:++d};n.value.unshift(W),n.value.length>10&&n.value.pop(),o.value++,W.error&&(i.value.unshift(W),i.value.length>5&&i.value.pop()),setTimeout(()=>{W._isNew=!1},1500),clearTimeout($),$=setTimeout(()=>{o.value=0},1e4)}}return $e(async()=>{await Promise.all([k(),A(),b(),x(),v()]),I=setInterval(k,15e3),w=setInterval(x,1e4),ze.subscribe("events",F)}),ft(()=>{I&&clearInterval(I),w&&clearInterval(w),clearTimeout($),ze.unsubscribe("events",F)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:m,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:A,fetchStatus:k,formatTime:kc,formatDuration:wa,retry:S,reloadConfig:R,clearSessions:D,stopAllLoops:O}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function vd(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function L_(e){if(Array.isArray(e))return e}function P_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function M_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function F_(e,t){return L_(e)||P_(e,t)||$_(e,t)||M_()}function $_(e,t){if(e){if(typeof e=="string")return vd(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?vd(e,t):void 0}}const Qh=Object.entries,bd=Object.setPrototypeOf,B_=Object.isFrozen,U_=Object.getPrototypeOf,H_=Object.getOwnPropertyDescriptor;let qt=Object.freeze,ps=Object.seal,ea=Object.create,Xh=typeof Reflect<"u"&&Reflect,bo=Xh.apply,yo=Xh.construct;qt||(qt=function(t){return t});ps||(ps=function(t){return t});bo||(bo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});yo||(yo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Ls=mt(Array.prototype.forEach),V_=mt(Array.prototype.lastIndexOf),yd=mt(Array.prototype.pop),Jn=mt(Array.prototype.push),j_=mt(Array.prototype.splice),Ut=Array.isArray,za=mt(String.prototype.toLowerCase),Nr=mt(String.prototype.toString),xd=mt(String.prototype.match),Zn=mt(String.prototype.replace),_d=mt(String.prototype.indexOf),z_=mt(String.prototype.trim),q_=mt(Number.prototype.toString),K_=mt(Boolean.prototype.toString),kd=typeof BigInt>"u"?null:mt(BigInt.prototype.toString),wd=typeof Symbol>"u"?null:mt(Symbol.prototype.toString),lt=mt(Object.prototype.hasOwnProperty),Fa=mt(Object.prototype.toString),Tt=mt(RegExp.prototype.test),xn=G_(TypeError);function mt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return bo(e,t,n)}}function G_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return yo(e,s)}}function Re(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:za;if(bd&&bd(e,null),!Ut(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(B_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function W_(e){for(let t=0;t<e.length;t++)lt(e,t)||(e[t]=null);return e}function Ot(e){const t=ea(null);for(const n of Qh(e)){var s=F_(n,2);const a=s[0],i=s[1];lt(e,a)&&(Ut(i)?t[a]=W_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Ot(i):t[a]=i)}return t}function J_(e){switch(typeof e){case"string":return e;case"number":return q_(e);case"boolean":return K_(e);case"bigint":return kd?kd(e):"0";case"symbol":return wd?wd(e):"Symbol()";case"undefined":return Fa(e);case"function":case"object":{if(e===null)return Fa(e);const t=e,s=ks(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Fa(n)}return Fa(e)}default:return Fa(e)}}function ks(e,t){for(;e!==null;){const n=H_(e,t);if(n){if(n.get)return mt(n.get);if(typeof n.value=="function")return mt(n.value)}e=U_(e)}function s(){return null}return s}function Z_(e){try{return Tt(e,""),!0}catch{return!1}}const Sd=qt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Dr=qt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Or=qt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Y_=qt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Lr=qt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Q_=qt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Td=qt(["#text"]),Cd=qt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Pr=qt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Ed=qt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ki=qt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),X_=ps(/{{[\w\W]*|^[\w\W]*}}/g),ek=ps(/<%[\w\W]*|^[\w\W]*%>/g),tk=ps(/\${[\w\W]*/g),sk=ps(/^data-[\-\w.\u00B7-\uFFFF]+$/),nk=ps(/^aria-[\-\w]+$/),Ad=ps(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),ak=ps(/^(?:\w+script|data):/i),ik=ps(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),lk=ps(/^html$/i),rk=ps(/^[a-z][.\w]*(-[.\w]+)+$/i),xs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},ok=function(){return typeof window>"u"?null:window},ck=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Rd=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function eg(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:ok();const t=he=>eg(he);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==xs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=ks(f,"cloneNode"),m=ks(f,"remove"),g=ks(f,"nextSibling"),k=ks(f,"childNodes"),A=ks(f,"parentNode"),b=ks(f,"shadowRoot"),v=ks(f,"attributes"),x=l&&l.prototype?ks(l.prototype,"nodeType"):null,R=l&&l.prototype?ks(l.prototype,"nodeName"):null;if(typeof i=="function"){const he=s.createElement("template");he.content&&he.content.ownerDocument&&(s=he.content.ownerDocument)}let D,O="",S,I=!1,w=0;const $=function(){if(w>0)throw xn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},F=function(_){$(),w++;try{return D.createHTML(_)}finally{w--}},P=function(_){$(),w++;try{return D.createScriptURL(_)}finally{w--}},W=function(){return I||(S=ck(d,a),I=!0),S},U=s,V=U.implementation,N=U.createNodeIterator,L=U.createDocumentFragment,q=U.getElementsByTagName,ue=n.importNode;let ve=Rd();t.isSupported=typeof Qh=="function"&&typeof A=="function"&&V&&V.createHTMLDocument!==void 0;const se=X_,de=ek,Z=tk,oe=sk,Ie=nk,j=ak,re=ik,le=rk;let ge=Ad,me=null;const De=Re({},[...Sd,...Dr,...Or,...Lr,...Td]);let y=null;const T=Re({},[...Cd,...Pr,...Ed,...Ki]);let M=Object.seal(ea(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),G=null,E=null;const B=Object.seal(ea(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let J=!0,X=!0,te=!1,Y=!0,pe=!1,ie=!0,ce=!1,ye=!1,Se=!1,Ee=!1,C=!1,Q=!1,be=!0,Le=!1;const Je="user-content-";let Ge=!0,St=!1,st={},Ze=null;const en=Re({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let mn=null;const Ii=Re({},["audio","video","img","source","image","track"]);let Aa=null;const Ni=Re({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Vn="http://www.w3.org/1998/Math/MathML",jn="http://www.w3.org/2000/svg",Kt="http://www.w3.org/1999/xhtml";let H=Kt,ne=!1,_e=null;const Ye=Re({},[Vn,jn,Kt],Nr);let nt=Re({},["mi","mo","mn","ms","mtext"]),Nt=Re({},["annotation-xml"]);const rr=Re({},["title","style","font","a","script"]);let Ra=null;const hg=["application/xhtml+xml","text/html"],gg="text/html";let it=null,zn=null;const mg=s.createElement("form"),Oc=function(_){return _ instanceof RegExp||_ instanceof Function},or=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(zn&&zn===_)return;(!_||typeof _!="object")&&(_={}),_=Ot(_),Ra=hg.indexOf(_.PARSER_MEDIA_TYPE)===-1?gg:_.PARSER_MEDIA_TYPE,it=Ra==="application/xhtml+xml"?Nr:za,me=lt(_,"ALLOWED_TAGS")&&Ut(_.ALLOWED_TAGS)?Re({},_.ALLOWED_TAGS,it):De,y=lt(_,"ALLOWED_ATTR")&&Ut(_.ALLOWED_ATTR)?Re({},_.ALLOWED_ATTR,it):T,_e=lt(_,"ALLOWED_NAMESPACES")&&Ut(_.ALLOWED_NAMESPACES)?Re({},_.ALLOWED_NAMESPACES,Nr):Ye,Aa=lt(_,"ADD_URI_SAFE_ATTR")&&Ut(_.ADD_URI_SAFE_ATTR)?Re(Ot(Ni),_.ADD_URI_SAFE_ATTR,it):Ni,mn=lt(_,"ADD_DATA_URI_TAGS")&&Ut(_.ADD_DATA_URI_TAGS)?Re(Ot(Ii),_.ADD_DATA_URI_TAGS,it):Ii,Ze=lt(_,"FORBID_CONTENTS")&&Ut(_.FORBID_CONTENTS)?Re({},_.FORBID_CONTENTS,it):en,G=lt(_,"FORBID_TAGS")&&Ut(_.FORBID_TAGS)?Re({},_.FORBID_TAGS,it):Ot({}),E=lt(_,"FORBID_ATTR")&&Ut(_.FORBID_ATTR)?Re({},_.FORBID_ATTR,it):Ot({}),st=lt(_,"USE_PROFILES")?_.USE_PROFILES&&typeof _.USE_PROFILES=="object"?Ot(_.USE_PROFILES):_.USE_PROFILES:!1,J=_.ALLOW_ARIA_ATTR!==!1,X=_.ALLOW_DATA_ATTR!==!1,te=_.ALLOW_UNKNOWN_PROTOCOLS||!1,Y=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,pe=_.SAFE_FOR_TEMPLATES||!1,ie=_.SAFE_FOR_XML!==!1,ce=_.WHOLE_DOCUMENT||!1,Ee=_.RETURN_DOM||!1,C=_.RETURN_DOM_FRAGMENT||!1,Q=_.RETURN_TRUSTED_TYPE||!1,Se=_.FORCE_BODY||!1,be=_.SANITIZE_DOM!==!1,Le=_.SANITIZE_NAMED_PROPS||!1,Ge=_.KEEP_CONTENT!==!1,St=_.IN_PLACE||!1,ge=Z_(_.ALLOWED_URI_REGEXP)?_.ALLOWED_URI_REGEXP:Ad,H=typeof _.NAMESPACE=="string"?_.NAMESPACE:Kt,nt=lt(_,"MATHML_TEXT_INTEGRATION_POINTS")&&_.MATHML_TEXT_INTEGRATION_POINTS&&typeof _.MATHML_TEXT_INTEGRATION_POINTS=="object"?Ot(_.MATHML_TEXT_INTEGRATION_POINTS):Re({},["mi","mo","mn","ms","mtext"]),Nt=lt(_,"HTML_INTEGRATION_POINTS")&&_.HTML_INTEGRATION_POINTS&&typeof _.HTML_INTEGRATION_POINTS=="object"?Ot(_.HTML_INTEGRATION_POINTS):Re({},["annotation-xml"]);const z=lt(_,"CUSTOM_ELEMENT_HANDLING")&&_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING=="object"?Ot(_.CUSTOM_ELEMENT_HANDLING):ea(null);if(M=ea(null),lt(z,"tagNameCheck")&&Oc(z.tagNameCheck)&&(M.tagNameCheck=z.tagNameCheck),lt(z,"attributeNameCheck")&&Oc(z.attributeNameCheck)&&(M.attributeNameCheck=z.attributeNameCheck),lt(z,"allowCustomizedBuiltInElements")&&typeof z.allowCustomizedBuiltInElements=="boolean"&&(M.allowCustomizedBuiltInElements=z.allowCustomizedBuiltInElements),pe&&(X=!1),C&&(Ee=!0),st&&(me=Re({},Td),y=ea(null),st.html===!0&&(Re(me,Sd),Re(y,Cd)),st.svg===!0&&(Re(me,Dr),Re(y,Pr),Re(y,Ki)),st.svgFilters===!0&&(Re(me,Or),Re(y,Pr),Re(y,Ki)),st.mathMl===!0&&(Re(me,Lr),Re(y,Ed),Re(y,Ki))),B.tagCheck=null,B.attributeCheck=null,lt(_,"ADD_TAGS")&&(typeof _.ADD_TAGS=="function"?B.tagCheck=_.ADD_TAGS:Ut(_.ADD_TAGS)&&(me===De&&(me=Ot(me)),Re(me,_.ADD_TAGS,it))),lt(_,"ADD_ATTR")&&(typeof _.ADD_ATTR=="function"?B.attributeCheck=_.ADD_ATTR:Ut(_.ADD_ATTR)&&(y===T&&(y=Ot(y)),Re(y,_.ADD_ATTR,it))),lt(_,"ADD_URI_SAFE_ATTR")&&Ut(_.ADD_URI_SAFE_ATTR)&&Re(Aa,_.ADD_URI_SAFE_ATTR,it),lt(_,"FORBID_CONTENTS")&&Ut(_.FORBID_CONTENTS)&&(Ze===en&&(Ze=Ot(Ze)),Re(Ze,_.FORBID_CONTENTS,it)),lt(_,"ADD_FORBID_CONTENTS")&&Ut(_.ADD_FORBID_CONTENTS)&&(Ze===en&&(Ze=Ot(Ze)),Re(Ze,_.ADD_FORBID_CONTENTS,it)),Ge&&(me["#text"]=!0),ce&&Re(me,["html","head","body"]),me.table&&(Re(me,["tbody"]),delete G.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw xn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw xn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ae=D;D=_.TRUSTED_TYPES_POLICY;try{O=F("")}catch(we){throw D=ae,we}}else _.TRUSTED_TYPES_POLICY===null?(D=void 0,O=""):(D===void 0&&(D=W()),D&&typeof O=="string"&&(O=F("")));(ve.uponSanitizeElement.length>0||ve.uponSanitizeAttribute.length>0)&&me===De&&(me=Ot(me)),ve.uponSanitizeAttribute.length>0&&y===T&&(y=Ot(y)),qt&&qt(_),zn=_},Lc=Re({},[...Dr,...Or,...Y_]),Pc=Re({},[...Lr,...Q_]),vg=function(_){let z=A(_);(!z||!z.tagName)&&(z={namespaceURI:H,tagName:"template"});const ae=za(_.tagName),we=za(z.tagName);return _e[_.namespaceURI]?_.namespaceURI===jn?z.namespaceURI===Kt?ae==="svg":z.namespaceURI===Vn?ae==="svg"&&(we==="annotation-xml"||nt[we]):!!Lc[ae]:_.namespaceURI===Vn?z.namespaceURI===Kt?ae==="math":z.namespaceURI===jn?ae==="math"&&Nt[we]:!!Pc[ae]:_.namespaceURI===Kt?z.namespaceURI===jn&&!Nt[we]||z.namespaceURI===Vn&&!nt[we]?!1:!Pc[ae]&&(rr[ae]||!Lc[ae]):!!(Ra==="application/xhtml+xml"&&_e[_.namespaceURI]):!1},hs=function(_){Jn(t.removed,{element:_});try{A(_).removeChild(_)}catch{if(m(_),!A(_))throw xn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Mc=function(_){const z=k?k(_):_.childNodes;if(z){const we=[];Ls(z,Ce=>{Jn(we,Ce)}),Ls(we,Ce=>{try{m(Ce)}catch{}})}const ae=v?v(_):null;if(ae)for(let we=ae.length-1;we>=0;--we){const Ce=ae[we],Ne=Ce&&Ce.name;if(typeof Ne=="string")try{_.removeAttribute(Ne)}catch{}}},vn=function(_,z){try{Jn(t.removed,{attribute:z.getAttributeNode(_),from:z})}catch{Jn(t.removed,{attribute:null,from:z})}if(z.removeAttribute(_),_==="is")if(Ee||C)try{hs(z)}catch{}else try{z.setAttribute(_,"")}catch{}},bg=function(_){const z=v?v(_):_.attributes;if(z)for(let ae=z.length-1;ae>=0;--ae){const we=z[ae],Ce=we&&we.name;if(!(typeof Ce!="string"||y[it(Ce)]))try{_.removeAttribute(Ce)}catch{}}},yg=function(_){const z=[_];for(;z.length>0;){const ae=z.pop();(x?x(ae):ae.nodeType)===xs.element&&bg(ae);const Ce=k?k(ae):ae.childNodes;if(Ce)for(let Ne=Ce.length-1;Ne>=0;--Ne)z.push(Ce[Ne])}},Fc=function(_){let z=null,ae=null;if(Se)_="<remove></remove>"+_;else{const Ne=xd(_,/^[\r\n\t ]+/);ae=Ne&&Ne[0]}Ra==="application/xhtml+xml"&&H===Kt&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const we=D?F(_):_;if(H===Kt)try{z=new u().parseFromString(we,Ra)}catch{}if(!z||!z.documentElement){z=V.createDocument(H,"template",null);try{z.documentElement.innerHTML=ne?O:we}catch{}}const Ce=z.body||z.documentElement;return _&&ae&&Ce.insertBefore(s.createTextNode(ae),Ce.childNodes[0]||null),H===Kt?q.call(z,ce?"html":"body")[0]:ce?z.documentElement:Ce},$c=function(_){return N.call(_.ownerDocument||_,_,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},cr=function(_){var z,ae;_.normalize();const we=N.call(_.ownerDocument||_,_,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Ce=we.nextNode();for(;Ce;){let vt=Ce.data;Ls([se,de,Z],Qe=>{vt=Zn(vt,Qe," ")}),Ce.data=vt,Ce=we.nextNode()}const Ne=(z=(ae=_.querySelectorAll)===null||ae===void 0?void 0:ae.call(_,"template"))!==null&&z!==void 0?z:[];Ls(Array.from(Ne),vt=>{qn(vt.content)&&cr(vt.content)})},Di=function(_){const z=R?R(_):null;return typeof z!="string"||it(z)!=="form"?!1:typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||_.attributes!==v(_)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function"||_.nodeType!==x(_)||_.childNodes!==k(_)},qn=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return x(_)===xs.documentFragment}catch{return!1}},Ia=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return typeof x(_)=="number"}catch{return!1}};function Is(he,_,z){Ls(he,ae=>{ae.call(t,_,z,zn)})}const Bc=function(_){let z=null;if(Is(ve.beforeSanitizeElements,_,null),Di(_))return hs(_),!0;const ae=it(R?R(_):_.nodeName);if(Is(ve.uponSanitizeElement,_,{tagName:ae,allowedTags:me}),ie&&_.hasChildNodes()&&!Ia(_.firstElementChild)&&Tt(/<[/\w!]/g,_.innerHTML)&&Tt(/<[/\w!]/g,_.textContent)||ie&&_.namespaceURI===Kt&&ae==="style"&&Ia(_.firstElementChild)||_.nodeType===xs.progressingInstruction||ie&&_.nodeType===xs.comment&&Tt(/<[/\w]/g,_.data))return hs(_),!0;if(G[ae]||!(B.tagCheck instanceof Function&&B.tagCheck(ae))&&!me[ae]){if(!G[ae]&&Hc(ae)&&(M.tagNameCheck instanceof RegExp&&Tt(M.tagNameCheck,ae)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ae)))return!1;if(Ge&&!Ze[ae]){const Ce=A(_),Ne=k(_);if(Ne&&Ce){const vt=Ne.length;for(let Qe=vt-1;Qe>=0;--Qe){const ct=St?Ne[Qe]:p(Ne[Qe],!0);Ce.insertBefore(ct,g(_))}}}return hs(_),!0}return(x?x(_):_.nodeType)===xs.element&&!vg(_)||(ae==="noscript"||ae==="noembed"||ae==="noframes")&&Tt(/<\/no(script|embed|frames)/i,_.innerHTML)?(hs(_),!0):(pe&&_.nodeType===xs.text&&(z=_.textContent,Ls([se,de,Z],Ce=>{z=Zn(z,Ce," ")}),_.textContent!==z&&(Jn(t.removed,{element:_.cloneNode()}),_.textContent=z)),Is(ve.afterSanitizeElements,_,null),!1)},Uc=function(_,z,ae){if(E[z]||be&&(z==="id"||z==="name")&&(ae in s||ae in mg))return!1;const we=y[z]||B.attributeCheck instanceof Function&&B.attributeCheck(z,_);if(!(X&&!E[z]&&Tt(oe,z))){if(!(J&&Tt(Ie,z))){if(!we||E[z]){if(!(Hc(_)&&(M.tagNameCheck instanceof RegExp&&Tt(M.tagNameCheck,_)||M.tagNameCheck instanceof Function&&M.tagNameCheck(_))&&(M.attributeNameCheck instanceof RegExp&&Tt(M.attributeNameCheck,z)||M.attributeNameCheck instanceof Function&&M.attributeNameCheck(z,_))||z==="is"&&M.allowCustomizedBuiltInElements&&(M.tagNameCheck instanceof RegExp&&Tt(M.tagNameCheck,ae)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ae))))return!1}else if(!Aa[z]){if(!Tt(ge,Zn(ae,re,""))){if(!((z==="src"||z==="xlink:href"||z==="href")&&_!=="script"&&_d(ae,"data:")===0&&mn[_])){if(!(te&&!Tt(j,Zn(ae,re,"")))){if(ae)return!1}}}}}}return!0},xg=Re({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Hc=function(_){return!xg[za(_)]&&Tt(le,_)},Vc=function(_){Is(ve.beforeSanitizeAttributes,_,null);const z=_.attributes;if(!z||Di(_))return;const ae={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let we=z.length;for(;we--;){const Ce=z[we],Ne=Ce.name,vt=Ce.namespaceURI,Qe=Ce.value,ct=it(Ne),tn=Qe;let _t=Ne==="value"?tn:z_(tn);if(ae.attrName=ct,ae.attrValue=_t,ae.keepAttr=!0,ae.forceKeepAttr=void 0,Is(ve.uponSanitizeAttribute,_,ae),_t=ae.attrValue,Le&&(ct==="id"||ct==="name")&&_d(_t,Je)!==0&&(vn(Ne,_),_t=Je+_t),ie&&Tt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,_t)){vn(Ne,_);continue}if(ct==="attributename"&&xd(_t,"href")){vn(Ne,_);continue}if(ae.forceKeepAttr)continue;if(!ae.keepAttr){vn(Ne,_);continue}if(!Y&&Tt(/\/>/i,_t)){vn(Ne,_);continue}pe&&Ls([se,de,Z],zc=>{_t=Zn(_t,zc," ")});const jc=it(_.nodeName);if(!Uc(jc,ct,_t)){vn(Ne,_);continue}if(D&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!vt)switch(d.getAttributeType(jc,ct)){case"TrustedHTML":{_t=F(_t);break}case"TrustedScriptURL":{_t=P(_t);break}}if(_t!==tn)try{vt?_.setAttributeNS(vt,Ne,_t):_.setAttribute(Ne,_t),Di(_)?hs(_):yd(t.removed)}catch{vn(Ne,_)}}Is(ve.afterSanitizeAttributes,_,null)},Oi=function(_){let z=null;const ae=$c(_);for(Is(ve.beforeSanitizeShadowDOM,_,null);z=ae.nextNode();)if(Is(ve.uponSanitizeShadowNode,z,null),Bc(z),Vc(z),qn(z.content)&&Oi(z.content),(x?x(z):z.nodeType)===xs.element){const Ce=b?b(z):z.shadowRoot;qn(Ce)&&(ur(Ce),Oi(Ce))}Is(ve.afterSanitizeShadowDOM,_,null)},ur=function(_){const z=[{node:_,shadow:null}];for(;z.length>0;){const ae=z.pop();if(ae.shadow){Oi(ae.shadow);continue}const we=ae.node,Ne=(x?x(we):we.nodeType)===xs.element,vt=k?k(we):we.childNodes;if(vt)for(let Qe=vt.length-1;Qe>=0;--Qe)z.push({node:vt[Qe],shadow:null});if(Ne){const Qe=R?R(we):null;if(typeof Qe=="string"&&it(Qe)==="template"){const ct=we.content;qn(ct)&&z.push({node:ct,shadow:null})}}if(Ne){const Qe=b?b(we):we.shadowRoot;qn(Qe)&&z.push({node:null,shadow:Qe},{node:Qe,shadow:null})}}};return t.sanitize=function(he){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},z=null,ae=null,we=null,Ce=null;if(ne=!he,ne&&(he="<!-->"),typeof he!="string"&&!Ia(he)&&(he=J_(he),typeof he!="string"))throw xn("dirty is not a string, aborting");if(!t.isSupported)return he;ye||or(_),t.removed=[];const Ne=St&&typeof he!="string"&&Ia(he);if(Ne){const ct=R?R(he):he.nodeName;if(typeof ct=="string"){const tn=it(ct);if(!me[tn]||G[tn])throw xn("root node is forbidden and cannot be sanitized in-place")}if(Di(he))throw xn("root node is clobbered and cannot be sanitized in-place");try{ur(he)}catch(tn){throw Mc(he),tn}}else if(Ia(he))z=Fc("<!---->"),ae=z.ownerDocument.importNode(he,!0),ae.nodeType===xs.element&&ae.nodeName==="BODY"||ae.nodeName==="HTML"?z=ae:z.appendChild(ae),ur(ae);else{if(!Ee&&!pe&&!ce&&he.indexOf("<")===-1)return D&&Q?F(he):he;if(z=Fc(he),!z)return Ee?null:Q?O:""}z&&Se&&hs(z.firstChild);const vt=$c(Ne?he:z);try{for(;we=vt.nextNode();)Bc(we),Vc(we),qn(we.content)&&Oi(we.content)}catch(ct){throw Ne&&Mc(he),ct}if(Ne)return Ls(t.removed,ct=>{ct.element&&yg(ct.element)}),pe&&cr(he),he;if(Ee){if(pe&&cr(z),C)for(Ce=L.call(z.ownerDocument);z.firstChild;)Ce.appendChild(z.firstChild);else Ce=z;return(y.shadowroot||y.shadowrootmode)&&(Ce=ue.call(n,Ce,!0)),Ce}let Qe=ce?z.outerHTML:z.innerHTML;return ce&&me["!doctype"]&&z.ownerDocument&&z.ownerDocument.doctype&&z.ownerDocument.doctype.name&&Tt(lk,z.ownerDocument.doctype.name)&&(Qe="<!DOCTYPE "+z.ownerDocument.doctype.name+`>
`+Qe),pe&&Ls([se,de,Z],ct=>{Qe=Zn(Qe,ct," ")}),D&&Q?F(Qe):Qe},t.setConfig=function(){let he=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};or(he),ye=!0},t.clearConfig=function(){zn=null,ye=!1,D=S,O=""},t.isValidAttribute=function(he,_,z){zn||or({});const ae=it(he),we=it(_);return Uc(ae,we,z)},t.addHook=function(he,_){typeof _=="function"&&Jn(ve[he],_)},t.removeHook=function(he,_){if(_!==void 0){const z=V_(ve[he],_);return z===-1?void 0:j_(ve[he],z,1)[0]}return yd(ve[he])},t.removeHooks=function(he){ve[he]=[]},t.removeAllHooks=function(){ve=Rd()},t}var Id=eg();function Sc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Un=Sc();function tg(e){Un=e}var Xa={exec:()=>null};function qe(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(jt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var jt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},uk=/^(?:[ \t]*(?:\n|$))+/,dk=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,fk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ri=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,pk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Tc=/(?:[*+-]|\d{1,9}[.)])/,sg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,ng=qe(sg).replace(/bull/g,Tc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),hk=qe(sg).replace(/bull/g,Tc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Cc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,gk=/^[^\n]+/,Ec=/(?!\s*\])(?:\\.|[^\[\]\\])+/,mk=qe(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ec).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),vk=qe(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Tc).getRegex(),ar="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ac=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,bk=qe("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Ac).replace("tag",ar).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ag=qe(Cc).replace("hr",Ri).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ar).getRegex(),yk=qe(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ag).getRegex(),Rc={blockquote:yk,code:dk,def:mk,fences:fk,heading:pk,hr:Ri,html:bk,lheading:ng,list:vk,newline:uk,paragraph:ag,table:Xa,text:gk},Nd=qe("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ri).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ar).getRegex(),xk={...Rc,lheading:hk,table:Nd,paragraph:qe(Cc).replace("hr",Ri).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Nd).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ar).getRegex()},_k={...Rc,html:qe(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ac).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Xa,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:qe(Cc).replace("hr",Ri).replace("heading",` *#{1,6} *[^
]`).replace("lheading",ng).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},kk=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,wk=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ig=/^( {2,}|\\)\n(?!\s*$)/,Sk=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ir=/[\p{P}\p{S}]/u,Ic=/[\s\p{P}\p{S}]/u,lg=/[^\s\p{P}\p{S}]/u,Tk=qe(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Ic).getRegex(),rg=/(?!~)[\p{P}\p{S}]/u,Ck=/(?!~)[\s\p{P}\p{S}]/u,Ek=/(?:[^\s\p{P}\p{S}]|~)/u,Ak=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,og=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Rk=qe(og,"u").replace(/punct/g,ir).getRegex(),Ik=qe(og,"u").replace(/punct/g,rg).getRegex(),cg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Nk=qe(cg,"gu").replace(/notPunctSpace/g,lg).replace(/punctSpace/g,Ic).replace(/punct/g,ir).getRegex(),Dk=qe(cg,"gu").replace(/notPunctSpace/g,Ek).replace(/punctSpace/g,Ck).replace(/punct/g,rg).getRegex(),Ok=qe("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,lg).replace(/punctSpace/g,Ic).replace(/punct/g,ir).getRegex(),Lk=qe(/\\(punct)/,"gu").replace(/punct/g,ir).getRegex(),Pk=qe(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Mk=qe(Ac).replace("(?:-->|$)","-->").getRegex(),Fk=qe("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Mk).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Rl=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,$k=qe(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Rl).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ug=qe(/^!?\[(label)\]\[(ref)\]/).replace("label",Rl).replace("ref",Ec).getRegex(),dg=qe(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ec).getRegex(),Bk=qe("reflink|nolink(?!\\()","g").replace("reflink",ug).replace("nolink",dg).getRegex(),Nc={_backpedal:Xa,anyPunctuation:Lk,autolink:Pk,blockSkip:Ak,br:ig,code:wk,del:Xa,emStrongLDelim:Rk,emStrongRDelimAst:Nk,emStrongRDelimUnd:Ok,escape:kk,link:$k,nolink:dg,punctuation:Tk,reflink:ug,reflinkSearch:Bk,tag:Fk,text:Sk,url:Xa},Uk={...Nc,link:qe(/^!?\[(label)\]\((.*?)\)/).replace("label",Rl).getRegex(),reflink:qe(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Rl).getRegex()},xo={...Nc,emStrongRDelimAst:Dk,emStrongLDelim:Ik,url:qe(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Hk={...xo,br:qe(ig).replace("{2,}","*").getRegex(),text:qe(xo.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Gi={normal:Rc,gfm:xk,pedantic:_k},$a={normal:Nc,gfm:xo,breaks:Hk,pedantic:Uk},Vk={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Dd=e=>Vk[e];function ws(e,t){if(t){if(jt.escapeTest.test(e))return e.replace(jt.escapeReplace,Dd)}else if(jt.escapeTestNoEncode.test(e))return e.replace(jt.escapeReplaceNoEncode,Dd);return e}function Od(e){try{e=encodeURI(e).replace(jt.percentDecode,"%")}catch{return null}return e}function Ld(e,t){var i;const s=e.replace(jt.findPipe,(l,r,o)=>{let c=!1,u=r;for(;--u>=0&&o[u]==="\\";)c=!c;return c?"|":" |"}),n=s.split(jt.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(jt.slashPipe,"|");return n}function Ba(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function jk(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function Pd(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function zk(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
`)}var Il=class{constructor(e){We(this,"options");We(this,"rules");We(this,"lexer");this.options=e||Un}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const s=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?s:Ba(s,`
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const s=t[0],n=zk(s,t[3]||"",this.rules);return{type:"code",raw:s,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:n}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let s=t[2].trim();if(this.rules.other.endingHash.test(s)){const n=Ba(s,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(s=n.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:Ba(t[0],`
...
`,e=e.substring(f.length+1),o=!0),!o){const A=this.rules.other.nextBulletRegex(m),b=this.rules.other.hrRegex(m),v=this.rules.other.fencesBeginRegex(m),x=this.rules.other.headingBeginRegex(m),R=this.rules.other.htmlBeginRegex(m);for(;e;){const D=e.split(`
`,1)[0];let O;if(f=D,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),O=f):O=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||R.test(f)||A.test(f)||b.test(f))break;if(O.search(this.rules.other.nonSpaceChar)>=m||!f.trim())u+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+ws(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Pn=new qk;function Ve(e,t){return Pn.parse(e,t)}Ve.options=Ve.setOptions=function(e){return Pn.setOptions(e),Ve.defaults=Pn.defaults,tg(Ve.defaults),Ve};Ve.getDefaults=Sc;Ve.defaults=Un;Ve.use=function(...e){return Pn.use(...e),Ve.defaults=Pn.defaults,tg(Ve.defaults),Ve};Ve.walkTokens=function(e,t){return Pn.walkTokens(e,t)};Ve.parseInline=Pn.parseInline;Ve.Parser=js;Ve.parser=js.parse;Ve.Renderer=Nl;Ve.TextRenderer=Dc;Ve.Lexer=Vs;Ve.lexer=Vs.lex;Ve.Tokenizer=Il;Ve.Hooks=tl;Ve.parse=Ve;Ve.options;Ve.setOptions;Ve.use;Ve.walkTokens;Ve.parseInline;js.parse;Vs.lex;const Kk={breaks:!0,gfm:!0};function Md(e){if(!e)return"";try{if(typeof Ve<"u"&&Ve.parse){const t=Ve.parse(e,Kk);return typeof Id<"u"?Id.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Gk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Fd={run_command:"⌘",ssh_command:"⌘",run_script:"⌘",read_file:"📄",write_file:"✏️",list_directory:"📂",search_knowledge:"🔍",ingest_document:"📚",generate_image:"🎨",analyze_image:"🖼️",analyze_pdf:"📃",browser_screenshot:"🌐",manage_process:"⚙️"};function Wk(e){return Fd[e]?Fd[e]:"🔧"}const Jk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function $d(e){if(!e)return[];const t=e.match(Jk);return t?[...new Set(t)]:[]}const Zk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=ee(()=>t.value.trim().length>0&&!s.value),d=ee(()=>{const U=ze.state;return U==="connected"?"Connected":U==="reconnecting"?"Reconnecting…":U==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=ee(()=>{const U=Math.floor(i.value/4)%f.length,V=i.value;return V>3?`${f[U]} (${V}s)`:f[0]});function m(){Et(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const U=a.value;U.style.height="auto",U.style.height=Math.min(U.scrollHeight,120)+"px"}function k(U,V,N={}){const L={id:++o,role:U,content:V,timestamp:Date.now(),html:U==="bot"?Md(V):"",tools_used:N.tools_used||[],is_error:N.is_error||!1,images:U==="bot"?$d(V):[],files:N.files||[],_showTools:!1};return e.value.push(L),m(),U==="bot"&&Et(()=>A()),L}function A(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(V=>{V.setAttribute("data-copy","true"),V.style.position="relative";const N=document.createElement("button");N.className="chat-code-copy",N.textContent="Copy",N.addEventListener("click",()=>{const L=V.querySelector("code"),q=L?L.textContent:V.textContent;navigator.clipboard.writeText(q).then(()=>{N.textContent="Copied!",setTimeout(()=>{N.textContent="Copy"},1500)}).catch(()=>{})}),V.appendChild(N)})}function b(U){if(U===0)return!0;const V=e.value[U-1],N=e.value[U],L=new Date(V.timestamp).toDateString(),q=new Date(N.timestamp).toDateString();return L!==q}function v(U){const V=new Date(U),N=new Date;if(V.toDateString()===N.toDateString())return"Today";const L=new Date(N);return L.setDate(L.getDate()-1),V.toDateString()===L.toDateString()?"Yesterday":V.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(U){t.value=U,Et(()=>$())}function R(U){window.open(U,"_blank","noopener")}function D(U){U.target.style.display="none"}function O(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function S(){r&&(clearInterval(r),r=null),i.value=0}function I(U){s.value&&(s.value=!1,S(),U.type==="chat_response"?k("bot",U.content,{tools_used:U.tools_used||[],is_error:U.is_error||!1,files:U.files||[]}):U.type==="chat_error"&&k("bot",U.error||"Unknown error",{is_error:!0}),Et(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}async function w(U){try{const V=await K.post("/api/chat",{content:U,channel_id:l.value});k("bot",V.response,{tools_used:V.tools_used||[],is_error:V.is_error||!1,files:V.files||[]})}catch(V){k("bot",V.message||"Failed to send message",{is_error:!0})}}async function $(){const U=t.value.trim();!U||s.value||(k("user",U),t.value="",s.value=!0,O(),a.value&&(a.value.style.height="auto"),ze.connected?ze.sendChat(U,{channelId:l.value})?P():(await w(U),s.value=!1,S()):(await w(U),s.value=!1,S()),Et(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}let F=null;ds(s,U=>{U||F&&(clearTimeout(F),F=null)});function P(){F=setTimeout(()=>{s.value&&(s.value=!1,S(),k("bot","Response timed out. Try again.",{is_error:!0}))},12e4)}async function W(){try{if(!l.value){const V=await K.get("/api/auth/session");l.value=V.channel_id||V.user_id||"web-user"}const U=await K.get("/api/sessions/"+encodeURIComponent(l.value));if(U&&U.messages&&U.messages.length>0){for(const V of U.messages){const N=V.role==="user"?"user":"bot";let L=V.content||"";if(N==="user"){const ue=L.match(/^\[.*?\]:\s*/);ue&&(L=L.slice(ue[0].length))}if(!L.trim())continue;const q={id:++o,role:N,content:L,timestamp:V.timestamp?V.timestamp*1e3:Date.now(),html:N==="bot"?Md(L):"",tools_used:[],is_error:!1,images:N==="bot"?$d(L):[],files:[],_showTools:!1};e.value.push(q)}Et(()=>{m(),A()})}}catch{}}return $e(()=>{ze.subscribe("chat",I),W(),Et(()=>{var U;return(U=a.value)==null?void 0:U.focus()})}),ft(()=>{ze.unsubscribe("chat",I),F&&clearTimeout(F),S()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:$,autoResize:g,formatTime:Gk,formatDate:v,showDateSeparator:b,useSuggestion:x,openImage:R,onImageError:D,getToolIcon:Wk}}},lr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=E_(),s=Wh(),n=ee({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});ds(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var u;return(u=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:u.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}$e(()=>{ze.on("events",a),i=setInterval(l,500)}),ft(()=>{ze.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"⏳":c==="success"?"✅":c==="error"?"❌":"⭕"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
    <div class="space-y-6">
  ...
  `},Qk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=ee(()=>e.value.reduce((D,O)=>D+(O.iteration_count||0),0)),d=ee(()=>e.value.filter(D=>D.status==="running").length);function f(D){return D==="running"?"loop-status-running":D==="error"?"loop-status-error":"loop-status-stopped"}function p(D){return D==="running"?"badge-success":D==="error"?"badge-danger":D==="completed"?"badge-info":"badge-warning"}function m(D){return D==="act"?"badge-warning":D==="silent"?"badge-info":"badge-success"}function g(D){c.value={...c.value,[D]:!c.value[D]}}async function k(D=!1){D=D===!0,D||(t.value=!0);try{e.value=await K.get("/api/loops"),s.value=null}catch(O){D||(s.value=O.message)}D||(t.value=!1)}async function A(){l.value=null;const D=a.value;if(!D.goal.trim()){l.value="Goal is required";return}if(!D.channel_id.trim()){l.value="Channel ID is required";return}const O={goal:D.goal.trim(),channel_id:D.channel_id.trim(),interval_seconds:D.interval_seconds||60,mode:D.mode,max_iterations:D.max_iterations||50};D.stop_condition.trim()&&(O.stop_condition=D.stop_condition.trim()),i.value=!0;try{const S=await K.post("/api/loops",O);xe.success(`Loop started: ${S.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await k()}catch(S){l.value=S.message}i.value=!1}async function b(D){if(await ns({title:"Stop loop",message:`Stop loop ${D}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=D;try{await K.del(`/api/loops/${encodeURIComponent(D)}`),xe.success("Loop stopped"),await k()}catch(S){xe.error(S.message||"Failed to stop loop")}r.value=null}}async function v(D){o.value=D;try{await K.post(`/api/loops/${encodeURIComponent(D)}/restart`),xe.success("Loop restarted"),await k()}catch(O){xe.error(O.message||"Failed to restart loop")}o.value=null}function x(D){D.payload&&(D.payload.loop_id||D.payload.type==="loop")&&k(!0)}let R=null;return $e(()=>{k(),ze.subscribe("events",x),R=setInterval(()=>{k(!0)},5e3)}),ft(()=>{ze.unsubscribe("events",x),R&&clearInterval(R)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:wa,formatAge:Jh,toggleHistory:g,fetchLoops:k,doCreate:A,doStop:b,doRestart:v}}},ew={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),m=h(null),g=h([]),k=h(!1),A=ee(()=>e.value.filter(N=>N.cron&&!N.one_time).length),b=ee(()=>e.value.filter(N=>N.one_time).length),v=ee(()=>e.value.filter(N=>N.trigger).length),x=ee(()=>e.value.filter(N=>N.paused).length),R=ee(()=>e.value.filter(N=>N.consecutive_failures>0).length);function D(N){if(!N)return"-";const L=Date.now(),ue=(new Date(N).getTime()-L)/1e3;if(ue<0)return"overdue";if(ue<60)return"in < 1 min";if(ue<3600)return`in ${Math.floor(ue/60)} min`;if(ue<86400){const se=Math.floor(ue/3600),de=Math.floor(ue%3600/60);return de>0?`in ${se}h ${de}m`:`in ${se}h`}const ve=Math.floor(ue/86400);return`in ${ve} day${ve!==1?"s":""}`}function O(N){return N==null?"-":N<1e3?`${N}ms`:N<6e4?`${(N/1e3).toFixed(1)}s`:wa(N/1e3)}function S(){r.value=null}async function I(){const N=a.value.cron.trim();if(N){o.value=!0;try{r.value=await K.post("/api/schedules/validate-cron",{expression:N})}catch(L){r.value={valid:!1,error:L.message}}o.value=!1}}async function w(){t.value=!0,s.value=null;try{e.value=await K.get("/api/schedules")}catch(N){s.value=N.message}t.value=!1}async function $(N){if(m.value===N){m.value=null,g.value=[];return}m.value=N,k.value=!0,g.value=[];try{g.value=await K.get(`/api/schedules/${encodeURIComponent(N)}/history?limit=10`)}catch{g.value=[]}k.value=!1}async function F(){l.value=null;const N=a.value;if(!N.description.trim()){l.value="Description is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}if(!N.cron.trim()&&!N.run_at.trim()){l.value="Cron expression or run_at time is required";return}const L={description:N.description.trim(),action:N.action,channel_id:N.channel_id.trim()};if(N.cron.trim()&&(L.cron=N.cron.trim()),N.run_at.trim()&&(L.run_at=N.run_at.trim()),N.action==="reminder"&&N.message.trim()&&(L.message=N.message.trim()),N.action==="check"&&(N.tool_name.trim()&&(L.tool_name=N.tool_name.trim()),N.tool_input_str.trim()))try{L.tool_input=JSON.parse(N.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await K.post("/api/schedules",L),xe.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await w()}catch(q){l.value=q.message}i.value=!1}async function P(N){u.value=N;try{const L=await K.post(`/api/schedules/${encodeURIComponent(N)}/run`);if(L.status==="failure")xe.error(`Execution failed: ${L.error||"unknown error"}`);else{const q=L.warning?`Executed (${L.warning})`:"Executed successfully";xe.success(q)}await w()}catch(L){xe.error(L.message||"Failed to trigger")}u.value=null}async function W(N){f.value=N.id;const L=!N.paused;try{await K.put(`/api/schedules/${encodeURIComponent(N.id)}`,{paused:L}),xe.success(L?"Schedule paused":"Schedule resumed"),await w()}catch(q){xe.error(q.message||"Failed to update schedule")}f.value=null}async function U(N){p.value=N;try{await K.post(`/api/schedules/${encodeURIComponent(N)}/reset-failures`),xe.success("Failure counters reset"),await w()}catch(L){xe.error(L.message||"Failed to reset")}p.value=null}async function V(N){const L=e.value.find(ue=>ue.id===N);if(await ns({title:"Delete schedule",message:`Delete "${(L==null?void 0:L.description)||N}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=N;try{await K.del(`/api/schedules/${encodeURIComponent(N)}`),xe.success("Schedule deleted"),await w()}catch(ue){xe.error(ue.message||"Failed to delete schedule")}d.value=null}}return $e(()=>{w()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:m,history:g,historyLoading:k,cronCount:A,oneTimeCount:b,webhookCount:v,pausedCount:x,failingCount:R,formatTs:Ea,formatAge:Jh,formatFuture:D,formatMs:O,formatDuration:wa,onCronInput:S,validateCron:I,toggleExpand:$,fetchSchedules:w,doCreate:F,doRunNow:P,doTogglePause:W,doResetFailures:U,doDelete:V}}},sw={components:{TabbedPage:lr},setup(){return{tabs:[{id:"live",label:"Live",component:Yk},{id:"agents",label:"Agents",component:Qk},{id:"loops",label:"Loops",component:Xk},{id:"processes",label:"Processes",component:ew},{id:"schedules",label:"Schedules",component:tw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},nw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=Bd,g=aw,k=h([]),A=h(!1),b=h(""),v=h("flat"),x=h(new Set),R=h(""),D=h(""),O=h(""),S=h(null),I=h(!1);function w(){try{const C=localStorage.getItem("odin-session-presets");C&&(k.value=JSON.parse(C))}catch{}}function $(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const F=ee(()=>d.value.trim()!==""||u.value!=="all"),P=ee(()=>{let C=[...e.value];const Q=Bd.find(Ge=>Ge.id===u.value),be=Q?Q.filters:{};if(be.source&&(C=C.filter(Ge=>Ge.source===be.source)),be.minMessages&&(C=C.filter(Ge=>Ge.message_count>=be.minMessages)),be.hasCompaction&&(C=C.filter(Ge=>Ge.has_summary)),be.maxAge!=null){const Ge=Date.now()/1e3;C=C.filter(St=>St.last_active&&Ge-St.last_active<=be.maxAge)}if(d.value.trim()){const Ge=d.value.toLowerCase().trim();C=C.filter(St=>(St.channel_id||"").toLowerCase().includes(Ge)||(St.last_user_id||"").toLowerCase().includes(Ge)||(St.source||"").toLowerCase().includes(Ge))}const Le=f.value,Je=p.value?1:-1;return C.sort((Ge,St)=>{const st=Ge[Le]||0,Ze=St[Le]||0;return(st-Ze)*Je}),C}),W=ee(()=>{if(!a.value||!a.value.messages)return[];const C=a.value.messages;if(C.length===0)return[];const Q=[];let be=[];for(const Le of C)Le.role==="user"&&be.length>0&&(Q.push(be),be=[]),be.push(Le);return be.length>0&&Q.push(be),Q}),U=ee(()=>P.value.length>0&&o.value.size===P.value.length);function V(C){const Q=C.find(be=>be.role==="user");if(Q&&Q.content){const be=Q.content.slice(0,120);return be.length<Q.content.length?be+"...":be}return"(no user message)"}function N(C){const Q=new Set(x.value);Q.has(C)?Q.delete(C):Q.add(C),x.value=Q}function L(C){u.value=C}function q(C){u.value=C.id,C.filters.searchQuery!=null&&(d.value=C.filters.searchQuery),C.filters.sortBy&&(f.value=C.filters.sortBy)}function ue(){if(!b.value.trim())return;const C={id:"custom-"+Date.now(),name:b.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,C],$(),A.value=!1,b.value=""}function ve(C){k.value=k.value.filter(Q=>Q.id!==C),$(),u.value===C&&(u.value="all")}function se(){u.value="all",d.value="",f.value="last_active",p.value=!1}function de(C){if(!C)return"—";const Q=Date.now()/1e3-C;if(Q<60)return"just now";if(Q<3600){const Le=Math.floor(Q/60);return`${Le} minute${Le!==1?"s":""} ago`}if(Q<86400){const Le=Math.floor(Q/3600);return`${Le} hour${Le!==1?"s":""} ago`}const be=Math.floor(Q/86400);return`${be} day${be!==1?"s":""} ago`}function Z(C){if(!C)return"";try{return new Date(C*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function oe(C){if(!C)return"";try{return new Date(C*1e3).toLocaleString()}catch{return""}}function Ie(C){return C==="user"?"bg-gray-900/50 border border-gray-800":C==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function j(C){return C==="user"?"sess-msg-user":C==="assistant"?"sess-msg-assistant":"sess-msg-system"}function re(C){return C==="user"?"badge-info":C==="assistant"?"badge-success":"badge-warning"}function le(C){return C==="user"?"sess-dot-user":C==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ge(C){return C==="user"?"text-cyan-400":C==="assistant"?"text-indigo-400":"text-gray-500"}function me(C){return C?C.length>2e3?C.slice(0,2e3)+`
... (truncated)`:C:""}async function De(){const C=R.value.trim();if(C){I.value=!0;try{let Q=`/api/sessions/search?q=${encodeURIComponent(C)}&limit=50`;D.value.trim()&&(Q+=`&channel_id=${encodeURIComponent(D.value.trim())}`),O.value.trim()&&(Q+=`&user_id=${encodeURIComponent(O.value.trim())}`);const be=await K.get(Q);S.value=be.results||[]}catch{S.value=[]}I.value=!1}}function y(){R.value="",D.value="",O.value="",S.value=null}function T(C){return C?C.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(C){return C==="user"?"bg-gray-900/50 border-gray-800":C==="assistant"?"bg-indigo-950/30 border-indigo-900/30":C==="summary"?"bg-amber-950/20 border-amber-900/30":C==="fts"?"bg-emerald-950/20 border-emerald-900/30":C==="channel"?"bg-purple-950/20 border-purple-900/30":"bg-gray-900/30 border-gray-800/50"}function G(C){return C==="user"?"badge-info":C==="assistant"?"badge-success":C==="summary"?"badge-warning":C==="fts"?"badge-success":"badge-info"}async function E(){t.value=!0,s.value=null;try{e.value=await K.get("/api/sessions")}catch(C){s.value=C.message}t.value=!1}function B(){s.value=null,E()}async function J(C){if(n.value===C){n.value=null,a.value=null,x.value=new Set;return}n.value=C,a.value=null,i.value=!0,x.value=new Set;try{a.value=await K.get(`/api/sessions/${encodeURIComponent(C)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function X(C){const Q=new Set(o.value);Q.has(C)?Q.delete(C):Q.add(C),o.value=Q}function te(){U.value?o.value=new Set:o.value=new Set(P.value.map(C=>C.channel_id))}function Y(C){l.value=C}async function pe(){if(l.value){r.value=!0;try{await K.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await E()}catch(C){s.value=C.message||"Failed to clear session"}r.value=!1,l.value=null}}function ie(){c.value=!0}async function ce(){if(o.value.size!==0){r.value=!0;try{await K.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await E()}catch(C){s.value=C.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function ye(C,Q){const be=K._token;let Le=`/api/sessions/${encodeURIComponent(C)}/export?format=${Q}`;be&&(Le+=`&token=${encodeURIComponent(be)}`);const Je=document.createElement("a");Je.href=Le,Je.download=`session-${C}.${Q==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let Se=null;function Ee(C){C.payload&&C.payload.channel_id&&(clearTimeout(Se),Se=setTimeout(()=>{E(),n.value&&C.payload.channel_id===n.value&&K.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(Q=>{a.value=Q}).catch(()=>{})},2e3))}return $e(()=>{w(),E(),ze.subscribe("events",Ee)}),ft(()=>{ze.unsubscribe("events",Ee),clearTimeout(Se)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:U,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:P,hasActiveFilters:F,customPresets:k,showSavePreset:A,newPresetName:b,threadView:v,threads:W,collapsedThreads:x,ftsQuery:R,ftsChannelId:D,ftsUserId:O,ftsResults:S,ftsSearching:I,formatAge:de,formatTimestamp:Z,formatFullTimestamp:oe,messageClass:Ie,threadMsgClass:j,roleBadge:re,roleDotClass:le,roleLabelClass:ge,truncateContent:me,threadSummary:V,fetchSessions:E,retry:B,toggleSession:J,toggleSelect:X,toggleSelectAll:te,confirmClear:Y,clearSession:pe,confirmBulkClear:ie,doBulkClear:ce,exportSession:ye,applyPreset:L,applyCustomPreset:q,saveCustomPreset:ue,removeCustomPreset:ve,resetFilters:se,toggleThread:N,runFtsSearch:De,clearFtsSearch:y,highlightSnippet:T,ftsResultClass:M,ftsTypeBadge:G}}},lw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:D_}}},rw={components:{ContextAssemblyPanel:lw},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
`)}const pw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),k=h(null),A=h(!1),b=ee(()=>e.value.length),v=ee(()=>e.value.reduce((Z,oe)=>Z+(oe.execution_count||0),0)),x=ee(()=>e.value.reduce((Z,oe)=>Z+w(oe.code),0)),R=ee(()=>{if(!l.value)return e.value;const Z=l.value.toLowerCase();return e.value.filter(oe=>oe.name.toLowerCase().includes(Z)||(oe.description||"").toLowerCase().includes(Z))}),D=ee(()=>d.value?d.value.split(`
`).length:0),O=ee(()=>{const Z=Math.max(D.value,1);return Array.from({length:Z},(oe,Ie)=>Ie+1).join(`
`)}),S=ee(()=>{const Z=d.value.trim();return Z?Z.includes("SKILL_DEFINITION")?Z.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function I(Z){return dw(Z)}function w(Z){return Z?Z.split(`
`).length:0}function $(Z){return fw(Z)}function F(Z){n.value={...n.value,[Z]:!n.value[Z]}}async function P(Z){try{await navigator.clipboard.writeText(Z);const oe=e.value.find(Ie=>Ie.code===Z);oe&&(r.value=oe.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function W(Z){if(Z.key==="Tab"){Z.preventDefault();const oe=Z.target,Ie=oe.selectionStart,j=oe.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(j),Et(()=>{oe.selectionStart=oe.selectionEnd=Ie+4})}}function U(Z){const oe=Z.target.previousElementSibling;oe&&(oe.scrollTop=Z.target.scrollTop)}async function V(){t.value=!0,s.value=null;try{e.value=await K.get("/api/skills")}catch(Z){s.value=Z.message}t.value=!1}async function N(Z){i.value=Z,delete a.value[Z],a.value={...a.value};try{const oe=await K.post(`/api/skills/${encodeURIComponent(Z)}/test`);a.value={...a.value,[Z]:oe}}catch(oe){a.value={...a.value,[Z]:{result:oe.message,is_error:!0}}}i.value=null}function L(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function q(Z){o.value=!0,c.value="edit",u.value=Z.name,d.value=Z.code||"",f.value=null,p.value=null}function ue(){o.value=!1,f.value=null,p.value=null}async function ve(){f.value=null,p.value=null;const Z=u.value.trim(),oe=d.value.trim();if(!Z){f.value="Name is required";return}if(!oe){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await K.post("/api/skills",{name:Z,code:oe}),p.value="Skill created successfully"):(await K.put(`/api/skills/${encodeURIComponent(Z)}`,{code:oe}),p.value="Skill updated successfully"),await V(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}m.value=!1}function se(Z){k.value=Z}async function de(){if(k.value){A.value=!0;try{await K.del(`/api/skills/${encodeURIComponent(k.value)}`),await V()}catch{}A.value=!1,k.value=null}}return $e(()=>{V()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:k,deleting:A,enabledCount:b,totalExecutions:v,totalLines:x,displayedSkills:R,editLineCount:D,editorLineNums:O,editValidation:S,highlight:I,truncate:wc,formatTs:Ea,countLines:w,getLineNumbers:$,toggleCode:F,copyCode:P,handleEditorKey:W,syncScroll:U,fetchSkills:V,testSkill:N,showCreate:L,editSkill:q,cancelEdit:ue,saveSkill:ve,confirmDelete:se,doDelete:de}}};function hw(e,t){if(!e||!t)return md(e);const s=md(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const gw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let k=null;const A=h(null),b=h(!1),v=h({}),x=h({}),R=h(null),D=h(null),O=ee(()=>e.value.reduce((L,q)=>L+(q.chunks||0),0)),S=ee(()=>new Set(e.value.map(q=>q.uploader).filter(Boolean)).size);function I(L,q){const ue=x.value[q];if(!ue||ue.length===0)return 0;const ve=Math.max(...ue.map(se=>se.char_count||0));return ve===0?0:Math.round(L.char_count/ve*100)}async function w(){t.value=!0,s.value=null;try{const L=await K.get("/api/knowledge");e.value=Array.isArray(L)?L:[]}catch(L){s.value=L.message}t.value=!1}async function $(L){if(v.value[L]){v.value[L]=!1,D.value=null;return}if(v.value[L]=!0,!(x.value[L]||R.value===L)){R.value=L;try{const q=await K.get(`/api/knowledge/${encodeURIComponent(L)}/chunks`);x.value[L]=Array.isArray(q)?q:[]}catch(q){x.value[L]=[],xe.error(`Failed to load chunks: ${q.message}`)}R.value=null}}async function F(){const L=n.value.trim();if(L){i.value=!0,r.value=null,l.value=L;try{const q=await K.get(`/api/knowledge/search?q=${encodeURIComponent(L)}`);a.value=Array.isArray(q)?q:[]}catch(q){a.value=[],r.value=q.message||"Search failed"}i.value=!1}}function P(){a.value=null,n.value="",r.value=null}async function W(){d.value=null,f.value=null;const L=c.value.trim(),q=u.value.trim();if(!L){d.value="Source name is required";return}if(!q){d.value="Content is required";return}p.value=!0;try{const ue=await K.post("/api/knowledge",{source:L,content:q});f.value=`Ingested ${ue.chunks||0} chunks from "${L}"`,c.value="",u.value="",x.value={},await w(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(ue){d.value=ue.message}p.value=!1}async function U(L){m.value=L,g.value=null,k&&(clearTimeout(k),k=null);try{const q=await K.post(`/api/knowledge/${encodeURIComponent(L)}/reingest`);g.value={source:L,error:!1,message:`Re-ingested ${q.chunks||0} chunks`},delete x.value[L],await w(),k=setTimeout(()=>{g.value=null,k=null},3e3)}catch(q){g.value={source:L,error:!0,message:q.message}}m.value=null}function V(L){A.value=L}async function N(){if(A.value){b.value=!0;try{await K.del(`/api/knowledge/${encodeURIComponent(A.value)}`),delete x.value[A.value],await w()}catch{}b.value=!1,A.value=null}}return $e(()=>{w()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:A,deleting:b,expanded:v,sourceChunks:x,loadingChunks:R,selectedChunk:D,totalChunks:O,uploaderCount:S,truncate:wc,formatTs:Ea,highlightTerms:hw,chunkBarWidth:I,fetchSources:w,toggleSource:$,doSearch:F,clearSearch:P,doIngest:W,doReingest:U,confirmDelete:V,doDelete:N}}},mw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),k=h(null),A=h(new Set),b=h(null),v=h(!1),x=h(!1),R=ee(()=>e.value.reduce((se,de)=>se+de.count,0)),D=ee(()=>A.value.size);function O(se){const de=t.value[se];if(!de)return[];if(!l.value.trim())return de;const Z=l.value.trim().toLowerCase();return de.filter(oe=>oe.key.toLowerCase().includes(Z)||oe.value&&oe.value.toLowerCase().includes(Z))}function S(se,de){return A.value.has(se+"/"+de)}function I(se,de){const Z=se+"/"+de,oe=new Set(A.value);oe.has(Z)?oe.delete(Z):oe.add(Z),A.value=oe}function w(se){const de=t.value[se];return!de||de.length===0?!1:de.every(Z=>A.value.has(se+"/"+Z.key))}function $(se,de){const Z=t.value[se];if(!Z)return;const oe=new Set(A.value);for(const Ie of Z){const j=se+"/"+Ie.key;de?oe.add(j):oe.delete(j)}A.value=oe}async function F(){s.value=!0,n.value=null;try{const se=await K.get("/api/memory");e.value=Object.entries(se).map(([de,Z])=>({name:de,keys:Z.keys||[],count:Z.count||0}))}catch(se){n.value=se.message}s.value=!1}async function P(se){if(a.value[se]){a.value[se]=!1;return}a.value[se]=!0;const de=e.value.find(oe=>oe.name===se);if(!de||t.value[se]||i.value===se)return;i.value=se;const Z=await Promise.all(de.keys.map(async oe=>{try{const Ie=await K.get(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(oe)}`);return{key:oe,value:Ie.value||""}}catch{return{key:oe,value:"(error loading)"}}}));t.value[se]=Z,i.value=null}function W(se,de,Z){f.value=se+"/"+de,p.value=Z}async function U(se,de){m.value=!0,g.value=null;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(de)}`,{value:p.value});const Z=t.value[se];if(Z){const oe=Z.find(Ie=>Ie.key===de);oe&&(oe.value=p.value)}f.value=null}catch(Z){g.value=`Failed to save: ${Z.message||"unknown error"}`}m.value=!1}async function V(se,de){try{await navigator.clipboard.writeText(de.value),k.value=se+"/"+de.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function N(){u.value=null,d.value=null;const se=o.value.scope.trim(),de=o.value.key.trim(),Z=o.value.value.trim();if(!se){u.value="Scope is required";return}if(!de){u.value="Key is required";return}if(!Z){u.value="Value is required";return}c.value=!0;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(de)}`,{value:Z}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await F(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(oe){u.value=oe.message}c.value=!1}function L(se,de){b.value={scope:se,key:de}}async function q(){if(!b.value)return;v.value=!0,g.value=null;const{scope:se,key:de}=b.value;try{await K.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(de)}`);const Z=t.value[se];Z&&(t.value[se]=Z.filter(j=>j.key!==de));const oe=e.value.find(j=>j.name===se);oe&&(oe.count--,oe.keys=oe.keys.filter(j=>j!==de));const Ie=new Set(A.value);Ie.delete(se+"/"+de),A.value=Ie}catch(Z){g.value=`Failed to delete: ${Z.message||"unknown error"}`}v.value=!1,b.value=null}function ue(){x.value=!0}async function ve(){v.value=!0,g.value=null;const se=[];for(const de of A.value){const Z=de.indexOf("/");se.push({scope:de.slice(0,Z),key:de.slice(Z+1)})}try{await K.post("/api/memory/bulk-delete",{entries:se}),A.value=new Set,t.value={},await F()}catch(de){g.value=`Bulk delete failed: ${de.message||"unknown error"}`}v.value=!1,x.value=!1}return $e(()=>{F()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:k,selected:A,selectedCount:D,totalEntries:R,deleteTarget:b,deleting:v,showBulkDelete:x,fetchMemory:F,toggleScope:P,startEdit:W,doEdit:U,copyValue:V,doAdd:N,confirmDelete:L,doDelete:q,confirmBulkDelete:ue,doBulkDelete:ve,isSelected:S,toggleSelect:I,isScopeAllSelected:w,toggleSelectAll:$,filteredEntries:O}}},vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `},xw={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},_w={ok:"✔",degraded:"⚠",down:"✖",unconfigured:"—"},kw={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},ww={template:`
...
`);const ne=new Blob([H],{type:"text/plain"}),_e=URL.createObjectURL(ne),Ye=document.createElement("a");Ye.href=_e,Ye.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ye.click(),URL.revokeObjectURL(_e)}function ge(H,ne){const _e=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(_e).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function me(H){a.value=a.value===H?"":H,A.value="all"}function De(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function T(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function M(H){A.value=H.id;const ne=H.filters;a.value=ne.level||"",b.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function G(H){A.value=H.id,a.value=H.filters.level||"",b.value=H.filters.timeRange||"",i.value=H.filters.text||""}function E(){if(!R.value.trim())return;const H={id:"custom-"+Date.now(),name:R.value.trim(),filters:{level:a.value,timeRange:b.value,text:i.value}};v.value=[...v.value,H],S(),x.value=!1,R.value=""}function B(H){v.value=v.value.filter(ne=>ne.id!==H),S(),A.value===H&&(A.value="all")}const J=h("all"),X=h(""),te=h(""),Y=h(""),pe=h(""),ie=h(""),ce=h(100),ye=Ew,Se=h(!1),Ee=h(!1),C=h(""),Q=h([]),be=h(null),Le=h(null);function Je(){e.value="search",be.value||Ge()}async function Ge(){try{be.value=await K.get("/api/logs/stats")}catch{}}function St(){const H=ie.value;if(!H){Y.value="",pe.value="";return}const _e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(_e){const Ye=new Date(Date.now()-_e*1e3);Y.value=st(Ye),pe.value=""}}function st(H){const ne=_e=>String(_e).padStart(2,"0");return`${H.getFullYear()}-${ne(H.getMonth()+1)}-${ne(H.getDate())}T${ne(H.getHours())}:${ne(H.getMinutes())}`}function Ze(H){if(!H)return"";const ne=new Date(H);return isNaN(ne.getTime())?"":ne.toISOString()}async function en(){Se.value=!0,C.value="",Ee.value=!0,Le.value=null;try{const H=new URLSearchParams;J.value&&J.value!=="all"&&H.set("level",J.value),X.value&&H.set("tool",X.value),te.value&&H.set("q",te.value);const ne=Ze(Y.value),_e=Ze(pe.value);ne&&H.set("start",ne),_e&&H.set("end",_e),H.set("limit",String(ce.value));const Ye=await K.get(`/api/logs/search?${H.toString()}`);Q.value=Ye.entries||[]}catch(H){C.value=H.message||"Search failed",Q.value=[]}finally{Se.value=!1}}function mn(){J.value="all",X.value="",te.value="",Y.value="",pe.value="",ie.value="",ce.value=100,Q.value=[],Ee.value=!1,C.value="",Le.value=null}function Ii(H){Le.value=Le.value===H?null:H}function Aa(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function Ni(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function Vn(H){return H.error?"log-line-error":"text-gray-300"}function jn(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let Kt=null;return $e(()=>{O(),ze.subscribe("logs",se),r.value=ze.connected,o.value=ze.state||"disconnected",Kt=ze.onStateChange;const H=ze.onStateChange;ze.onStateChange=(ne,_e)=>{o.value=ne,r.value=ne==="connected",H&&H(ne,_e)}}),ft(()=>{ze.unsubscribe("logs",se),Kt!==void 0&&(ze.onStateChange=Kt)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ue,pauseBuffer:D,showJumpBottom:d,copiedIndex:f,regexError:$,levels:m,logPresets:g,timeRanges:k,timeRange:b,activeLogPreset:A,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:R,hasActiveLogFilters:I,timeRangeLabel:w,timelineBuckets:P,timelineMax:W,timelineSpanLabel:U,timelineLabelSkip:V,togglePause:j,clearLogs:re,exportLogs:le,logLineClass:De,levelClass:y,levelChipClass:T,toggleLevel:me,copyLine:ge,jumpToBottom:oe,onScroll:Ie,applyLogPreset:M,applyCustomLogPreset:G,saveLogCustomPreset:E,removeLogCustomPreset:B,segmentHeight:L,jumpToTimelineBucket:q,searchLevel:J,searchTool:X,searchKeyword:te,searchStart:Y,searchEnd:pe,searchTimePreset:ie,searchLimit:ce,searchLimits:ye,searching:Se,searchRan:Ee,searchError:C,searchResults:Q,searchStats:be,expandedSearch:Le,switchToSearch:Je,runSearch:en,clearSearchFilters:mn,toggleSearchExpand:Ii,formatSearchTs:Aa,searchEntryText:Ni,searchLogLineClass:Vn,formatJson:jn,applySearchTimePreset:St}}},Rw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Iw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Nw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1“128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},$r=[{key:"core",label:"Core",icon:"⚙",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"🧠",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"💾",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"🔗",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"🛠",sections:["tools"]},{key:"ui",label:"Web UI",icon:"🌐",sections:["web"]},{key:"automation",label:"Automation",icon:"🔄",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"🔌",sections:["issue_tracker"]}],fg="••••••••",Dw=50;function Ow(e){return Rw.has(e)}function Lw(e){return e===fg}function Wi(e){return JSON.parse(JSON.stringify(e))}function Nn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Pw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Nn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Mw(e,t,s){const n=Nw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Ud(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Nn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Fw={template:`
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=ee(()=>d.value.length>0),m=ee(()=>f.value.length>0),g=ee(()=>r.value&&t.value?t.value:e.value),k=ee(()=>!e.value||!t.value?!1:!Nn(e.value,t.value)),A=ee(()=>!e.value||!t.value?0:Ud(e.value,t.value).length),b=ee(()=>{if(!r.value||!t.value)return{};const E={};for(const B of Object.keys(t.value)){const J=t.value[B];if(typeof J=="object"&&J!==null&&!Array.isArray(J))for(const X of Object.keys(J)){const te=Mw(B,X,J[X]);te&&(E[B+"."+X]=te)}}return E}),v=ee(()=>Object.keys(b.value).length>0),x=ee(()=>e.value?Object.keys(e.value).length:0),R=ee(()=>O.value.length),D=ee(()=>!e.value||!t.value?[]:Ud(e.value,t.value)),O=ee(()=>e.value?$r.map(E=>({...E,sections:E.sections.filter(B=>B in e.value)})).filter(E=>E.sections.length>0):[]),S=ee(()=>{if(!e.value)return[];const E=new Set($r.flatMap(B=>B.sections));return Object.keys(e.value).filter(B=>!E.has(B))});function I(E){return g.value?g.value[E]:null}function w(E){return!e.value||!t.value?!1:!Nn(e.value[E],t.value[E])}function $(E){return E.sections.some(B=>w(B))}function F(E,B){if(!e.value||!t.value)return!1;const J=e.value[E],X=t.value[E];return!J||!X?!1:!Nn(J[B],X[B])}function P(E){return t.value?t.value[E]:e.value[E]}function W(E,B){const J=t.value||e.value;return J[E]?J[E][B]:void 0}function U(E,B){const J=r.value&&t.value?t.value:e.value;return J[E]?J[E][B]:!1}function V(E,B){return b.value[E+"."+B]||null}function N(E,B){return Iw[E+"."+B]||null}function L(E,B,J){t.value&&(B===null?t.value[E]=J:(t.value[E]||(t.value[E]={}),t.value[E][B]=J),t.value={...t.value})}function q(E,B,J){if(!t.value)return;const X=Wi(t.value);L(E,B,J),d.value.push(X),d.value.length>Dw&&d.value.shift(),f.value=[]}function ue(E,B,J){try{const X=JSON.parse(J);q(E,B,X)}catch{}}function ve(){d.value.length!==0&&(f.value.push(Wi(t.value)),t.value=d.value.pop())}function se(){f.value.length!==0&&(d.value.push(Wi(t.value)),t.value=f.value.pop())}function de(E,B,J){if(!t.value||!t.value[E])return;const X=[...t.value[E][B]];X.splice(J,1),q(E,B,X)}function Z(E,B){if(!t.value||!t.value[E])return;const J=[...t.value[E][B]||[]],X=prompt("Enter new value:");X!==null&&(J.push(X),q(E,B,J))}function oe(E){a.value={...a.value,[E]:!a.value[E]}}function Ie(E){l.value={...l.value,[E]:!l.value[E]}}function j(E){i.value={...i.value,[E]:!i.value[E]}}function re(E){try{return JSON.stringify(E,null,2)}catch{return String(E)}}function le(E){return E==null?"null":typeof E=="object"?JSON.stringify(E,null,2):String(E)}function ge(E,B){c.value={type:E,message:B},setTimeout(()=>{c.value=null},3e3)}function me(){t.value=Wi(e.value),r.value=!0,d.value=[],f.value=[]}function De(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function T(){if(!(!k.value||v.value)){o.value=!0;try{const E=Pw(e.value,t.value);if(Object.keys(E).length===0){ge("success","No changes to save."),o.value=!1;return}const B=await K.put("/api/config",E);e.value=B,r.value=!1,t.value=null,d.value=[],f.value=[],ge("success","Config saved successfully.")}catch(E){ge("error",E.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await K.get("/api/config");for(const E of Object.keys(e.value))a.value[E]===void 0&&(a.value[E]=!0);for(const E of $r)l.value[E.key]===void 0&&(l.value[E.key]=!0)}catch(E){n.value=E.message}s.value=!1}function G(E){r.value&&((E.ctrlKey||E.metaKey)&&!E.shiftKey&&E.key==="z"?(E.preventDefault(),ve()):(E.ctrlKey||E.metaKey)&&(E.key==="y"||E.shiftKey&&E.key==="z"||E.shiftKey&&E.key==="Z")&&(E.preventDefault(),se()))}return $e(()=>{M(),document.addEventListener("keydown",G)}),ft(()=>{document.removeEventListener("keydown",G)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:v,changeCount:A,REDACTED:fg,showDiffModal:u,diffEntries:D,canUndo:p,canRedo:m,sectionCount:x,groupCount:R,visibleGroups:O,ungroupedSections:S,validationErrors:b,isSensitiveKey:Ow,isRedacted:Lw,sectionChanged:w,groupChanged:$,fieldChanged:F,getDisplay:I,getEdited:P,getEditedField:W,getDisplayBool:U,pushEdit:q,pushEditJson:ue,getValidationError:V,getEnumOptions:N,removeArrayItem:de,addArrayItem:Z,toggleSection:oe,toggleGroup:Ie,toggleNested:j,formatJson:re,formatDiffVal:le,showToast:ge,showDiff:y,fetchConfig:M,startEdit:me,cancelEdit:De,saveConfig:T,undo:ve,redo:se}}},$w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=ee(()=>{const N={};for(const L of u.value)N[L.id]=L;return N});function p(N){return f.value[N]||null}const m=ee(()=>/^\d{15,25}$/.test(r.value.trim())),g=ee(()=>{const N=r.value.toLowerCase().trim();return N?u.value.filter(L=>!i.value[L.id]&&(L.display_name.toLowerCase().includes(N)||L.username.toLowerCase().includes(N)||L.id.includes(N))):u.value.filter(L=>!i.value[L.id])});function k(N,L){return N?N.allowed_hosts===null||N.allowed_hosts===void 0?{allowed_hosts:[...L],default_host:N.default_host||"",allow_all:!0}:{allowed_hosts:N.allowed_hosts,default_host:N.default_host||"",allow_all:!1}:{allowed_hosts:[...L],default_host:L[0]||"",allow_all:!0}}async function A(){e.value=!0,t.value="";try{const N=await K.get("/api/host-access");s.value=N,n.value=N.available_hosts||[],a.value=k(N.default_policy,n.value);const L=N.users||{},q={};for(const[ue,ve]of Object.entries(L))q[ue]=k(ve,n.value);i.value=q}catch(N){t.value=N.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await K.get("/api/discord/members")||[]}catch{u.value=[]}}async function b(){try{const N=a.value.allow_all?null:a.value.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:N,default_host:a.value.default_host}),xe.success("Default policy updated")}catch(N){xe.error(N.message||"Failed to save")}}function v(N,L){a.value.allow_all=!1,L?a.value.allowed_hosts.includes(N)||a.value.allowed_hosts.push(N):(a.value.allowed_hosts=a.value.allowed_hosts.filter(q=>q!==N),a.value.default_host===N&&(a.value.default_host=a.value.allowed_hosts[0]||"")),b()}async function x(N){const L=i.value[N];if(L)try{const q=L.allow_all?null:L.allowed_hosts;await K.put(`/api/host-access/user/${N}`,{allowed_hosts:q,default_host:L.default_host});const ue=p(N);xe.success(`Updated access for ${ue?ue.display_name:N}`)}catch(q){xe.error(q.message||"Failed to save")}}function R(N,L,q){const ue=i.value[N];ue&&(ue.allow_all=!1,q?ue.allowed_hosts.includes(L)||ue.allowed_hosts.push(L):(ue.allowed_hosts=ue.allowed_hosts.filter(ve=>ve!==L),ue.default_host===L&&(ue.default_host=ue.allowed_hosts[0]||"")),x(N))}function D(N,L){const q=i.value[N];q&&(q.default_host=L,x(N))}function O(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function S(){o.value=!0,c.value=0}function I(){c.value<g.value.length-1&&c.value++}function w(){c.value>0&&c.value--}function $(){const N=g.value[c.value];if(N){P(N);return}m.value&&F()}function F(){const N=r.value.trim();/^\d{15,25}$/.test(N)&&(i.value[N]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(N),r.value="",o.value=!1,l.value=!1)}function P(N){i.value[N.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(N.id),r.value="",o.value=!1,l.value=!1}function W(){o.value=!1}function U(){setTimeout(()=>{o.value=!1},150)}async function V(N){const L=p(N);if(await ns({title:"Remove user override",message:`Remove the host access override for ${L?L.display_name:N}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await K.del(`/api/host-access/user/${N}`),delete i.value[N],xe.success(`Removed override for ${L?L.display_name:N}`)}catch(ue){xe.error(ue.message||"Failed to delete")}}return $e(A),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:g,isRawId:m,searchInput:d,fetchData:A,saveDefaultPolicy:b,toggleDefaultHost:v,getMember:p,toggleUserHost:R,setUserDefault:D,openAddUser:O,deleteUser:V,onSearchInput:S,highlightNext:I,highlightPrev:w,selectHighlighted:$,selectMember:P,closeDropdown:W,onBlur:U,addRawId:F}}},Uw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:""}),a=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),i=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),l=h(!1),r=h(!1),o=h(!1),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h({configured:!1}),m=h([]),g=h(""),k=h(!1),A=h(!1),b=h({configured:!1}),v=h([]),x=h(""),R=h(!1),D=h(!1),O=h(!0),S=h(""),I=h({configured:!1,accounts:[]}),w=h(null),$=h(null),F=h(""),P=h(null),W=h(!1),U=h(null),V=h(null),N=h("");let L=null;function q(C,Q="success"){xe(C,Q==="error"?"error":"success")}function ue(C){if(!C)return"?";const Q=C/(1024*1024*1024);return Q>=1?Q.toFixed(1)+" GB":(C/(1024*1024)).toFixed(0)+" MB"}async function ve(){e.value=!0,await Promise.all([se(),de(),le(),Z()]),e.value=!1}async function se(){try{const C=await K.get("/api/llm/status");t.value=C,s.value=C.active_provider||"codex",C.codex&&!M.pending()&&(n.value.enabled=C.codex.enabled,n.value.model=C.codex.model||"gpt-5.5",n.value.reasoning_effort=C.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=C.codex.agent_reasoning_effort||"",n.value.max_tokens=C.codex.max_tokens||4096),C.ollama&&!G.pending()&&(a.value.enabled=C.ollama.enabled,a.value.base_url=C.ollama.base_url||"",a.value.model=C.ollama.model||"",a.value.max_tokens=C.ollama.max_tokens||4096),C.kimi&&!E.pending()&&(i.value.enabled=C.kimi.enabled,i.value.model=C.kimi.model||"",i.value.max_tokens=C.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function de(){try{if(p.value=await K.get("/api/ollama/status"),p.value.model&&(g.value=p.value.model),p.value.configured)try{const C=await K.get("/api/ollama/models");m.value=C.models||[]}catch{m.value=[]}else if(a.value.base_url)try{const C=await K.post("/api/ollama/probe-models",{base_url:a.value.base_url});m.value=C.models||[]}catch{m.value=[]}}catch{p.value={configured:!1}}}async function Z(){O.value=!0,S.value="";try{I.value=await K.get("/api/codex/status")}catch(C){S.value=C.message||"Failed to fetch Codex status"}finally{O.value=!1}}async function oe(){const C=t.value?t.value.active_provider:"codex";f.value=!0;try{const Q=await K.post("/api/llm/switch",{provider:s.value});Q.error?(s.value=C,q(Q.error,"error")):(q("Switched to "+s.value+" ("+Q.model+")"),await ve())}catch(Q){s.value=C,q(Q.message||"Switch failed","error")}finally{f.value=!1}}async function Ie(){k.value=!0;try{const C=await K.post("/api/ollama/reload");q(C.configured?"Ollama reloaded":C.reason||"Ollama not configured",C.configured?"success":"error"),await ve()}catch(C){q(C.message||"Reload failed","error")}finally{k.value=!1}}async function j(){A.value=!0;try{await K.post("/api/ollama/model",{model:g.value}),q("Model set to "+g.value),await ve()}catch(C){q(C.message||"Failed","error")}finally{A.value=!1}}async function re(){const C=a.value.base_url;if(!C){q("Enter a base URL first","error");return}d.value=!0;try{const Q=await K.post("/api/ollama/probe-models",{base_url:C});m.value=Q.models||[],m.value.length?(q(m.value.length+" model(s) found"),!a.value.model&&m.value.length&&(a.value.model=m.value[0].name)):q("No models found at "+C,"error")}catch(Q){q(Q.message||"Could not reach Ollama","error")}finally{d.value=!1}}async function le(){try{if(b.value=await K.get("/api/kimi/status"),b.value.model&&(x.value=b.value.model),b.value.configured)try{const C=await K.get("/api/kimi/models");v.value=C.models||[]}catch{v.value=[]}}catch{b.value={configured:!1}}}async function ge(){R.value=!0;try{const C=await K.post("/api/kimi/reload");q(C.configured?"Kimi reloaded":C.reason||"Kimi not configured",C.configured?"success":"error"),await ve()}catch(C){q(C.message||"Reload failed","error")}finally{R.value=!1}}async function me(){D.value=!0;try{await K.post("/api/kimi/model",{model:x.value}),q("Model set to "+x.value),await ve()}catch(C){q(C.message||"Failed","error")}finally{D.value=!1}}async function De(){if(o.value){M();return}o.value=!0;try{await K.put("/api/llm/codex/config",n.value),q("Codex config saved"),await Promise.all([se(),Z()])}catch(C){q(C.message||"Failed","error"),await Promise.all([se(),Z()])}finally{o.value=!1}}async function y(){if(c.value){G();return}c.value=!0;try{const C={...a.value},Q=l.value?a.value.api_key:null;Q===null&&delete C.api_key,await K.put("/api/llm/ollama/config",C),q("Ollama config saved"),Q!==null&&a.value.api_key===Q&&(a.value.api_key="",l.value=!1),await Promise.all([se(),de()])}catch(C){q(C.message||"Failed","error")}finally{c.value=!1}}async function T(){if(u.value){E();return}u.value=!0;try{const C={...i.value},Q=r.value?i.value.api_key:null;Q===null&&delete C.api_key,await K.put("/api/llm/kimi/config",C),q("Kimi config saved"),Q!==null&&i.value.api_key===Q&&(i.value.api_key="",r.value=!1),await Promise.all([se(),le()])}catch(C){q(C.message||"Failed","error")}finally{u.value=!1}}const M=Br(De),G=Br(y),E=Br(T),B=()=>(M.cancel(),De()),J=()=>(G.cancel(),y()),X=()=>(E.cancel(),T());async function te(C){try{await K.post("/api/codex/account/"+C+"/activate"),q("Active account switched"),await Z()}catch(Q){q(Q.message||"Failed","error")}}async function Y(C){w.value=C;try{await K.post("/api/codex/account/"+C+"/refresh"),q("Token refreshed"),await Z()}catch(Q){q(Q.message||"Refresh failed","error")}finally{w.value=null}}function pe(C,Q){$.value=C,F.value=Q||""}async function ie(C){try{await K.put("/api/codex/account/"+C+"/label",{label:F.value}),q("Label updated"),$.value=null,await Z()}catch(Q){q(Q.message||"Failed","error")}}async function ce(C,Q){if(await ns({title:"Delete Codex account",message:`Delete ${Q||"account #"+(C+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+C),q("Deleted. Pool reloaded."),await Z()}catch(Le){q(Le.message||"Failed","error")}}async function ye(){W.value=!0;try{const C=await K.post("/api/codex/device-code");U.value=C,P.value="pending",Se(C)}catch(C){q(C.message||"Failed","error")}finally{W.value=!1}}async function Se(C){L={cancelled:!1};const Q=L;try{const be=await K.post("/api/codex/device-poll",{device_auth_id:C.device_auth_id,user_code:C.user_code,interval:C.interval});if(Q.cancelled)return;V.value=be,P.value="success",await ve()}catch(be){if(Q.cancelled)return;N.value=be.message||"Device login failed",P.value="error"}}function Ee(){L&&(L.cancelled=!0),P.value=null,U.value=null}return $e(ve),ft(()=>{L&&(L.cancelled=!0),M.cancel(),G.cancel(),E.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:f,codexForm:n,ollamaForm:a,kimiForm:i,savingCodex:o,savingOllama:c,savingKimi:u,probingOllama:d,ollamaKeyDirty:l,kimiKeyDirty:r,ollamaStatus:p,ollamaModels:m,ollamaSelectedModel:g,reloading:k,settingModel:A,kimiStatus:b,kimiModels:v,kimiSelectedModel:x,reloadingKimi:R,settingKimiModel:D,codexLoading:O,codexError:S,codexData:I,refreshing:w,editingLabel:$,labelValue:F,deviceState:P,deviceLoading:W,deviceInfo:U,deviceResult:V,deviceError:N,fetchAll:ve,switchProvider:oe,reloadOllama:Ie,setOllamaModel:j,reloadKimi:ge,setKimiModel:me,probeOllamaModels:re,saveCodexConfig:De,saveOllamaConfig:y,saveKimiConfig:T,saveCodexConfigDebounced:M,saveOllamaConfigDebounced:G,saveKimiConfigDebounced:E,saveCodexConfigNow:B,saveOllamaConfigNow:J,saveKimiConfigNow:X,activateAccount:te,refreshAccount:Y,startEditLabel:pe,saveLabel:ie,deleteAccount:ce,startDeviceLogin:ye,cancelDeviceLogin:Ee,formatSize:ue}}},Hd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Vw(e){return Hd[e]||Hd[(e||"").toLowerCase()]||"text-gray-400"}const jw={template:`
