...
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const of=Object.create(null);function kk(e,t){if(!Je(e))if(e.nodeType)e=e.innerHTML;else return ms;const s=Ub(e,t),a=of[s];if(a)return a;if(e[0]==="#"){const o=document.querySelector(e);e=o?o.innerHTML:""}const n=at({hoistStatic:!0,onError:void 0,onWarn:ms},t);!n.isCustomElement&&typeof customElements<"u"&&(n.isCustomElement=o=>!!customElements.get(o));const{code:i}=wk(e,n),l=new Function("Vue",i)(I_);return l._rc=!0,of[s]=l}Ph(kk);const wr=Cn({items:[]});let Sk=1;function Zr(e,t="info",s=3e3){const a=Sk++;return wr.items.push({id:a,message:String(e),type:t}),s>0&&setTimeout(()=>Eu(a),s),a}function Eu(e){const t=wr.items.findIndex(s=>s.id===e);t>=0&&wr.items.splice(t,1)}function Te(e,t="info",s=3e3){return Zr(e,t,s)}Te.success=(e,t=3e3)=>Zr(e,"success",t);Te.error=(e,t=5e3)=>Zr(e,"error",t);Te.info=(e,t=3e3)=>Zr(e,"info",t);Te.dismiss=Eu;const Ck={setup(){return{state:wr,dismiss:Eu}},template:`
...
`).replace(/\n$/,""),d=mg(c,Lc.previewLines,Lc.previewChars),u=t.kind==="audit_preview"?(m=t.metadata)==null?void 0:m.source:t.metadata,p=u&&(t.kind==="process_output"||u.kind==="process_output")?`PID ${u.pid??"?"} ${u.status??""}${Number.isInteger(u.exit_code)?` exit ${u.exit_code}`:""}`.trim():t.kind==="agent_result"&&(u!=null&&u.status)?`agent ${u.status}`:"";return{promoted:r,chars:i,lines:l,envelope:o,kind:t.kind,formatted:c,preview:d,outcome:p,header:t.header,summary:n.replace(/\n/g," "),warnings:zS(t)}}const jS={name:"CompactOutput",props:{value:{default:""},rawValue:{default:void 0},label:{type:String,default:"Output"},hasContext:{type:Boolean,default:!1},recordId:{default:null}},setup(e){const t=f(!1),s=f(!0),a=f(!1),n=f(""),i=f(null),l=f(null),o=f(!1),r=j(()=>HS(e.value)),c=j(()=>{const x=e.rawValue===void 0?e.value:e.rawValue;return typeof x=="string"?x:JSON.stringify(x,null,2)??""}),d=j(()=>a.value?c.value:r.value.formatted),u=j(()=>r.value.promoted&&r.value.preview.folded||o.value),p=j(()=>t.value?!!d.value:r.value.promoted),m=j(()=>p.value?"":r.value.summary);let h;function b(){if(t.value)return;const x=r.value.promoted?i.value:l.value;o.value=!!(x&&(x.scrollHeight>x.clientHeight+1||x.scrollWidth>x.clientWidth+1))}function I(){h==null||h.disconnect();for(const x of[i.value,l.value])x&&(h==null||h.observe(x));b()}function k(){t.value=!t.value,t.value||(a.value=!1)}function y(){a.value=!a.value,t.value=!0,n.value=""}async function g(){const x=e.value;try{await navigator.clipboard.writeText(d.value),x===e.value&&(n.value="Copied")}catch{x===e.value&&(n.value="Copy unavailable — select text manually")}}return Jt([()=>e.value,()=>e.rawValue,()=>e.recordId],(x,_)=>{(e.recordId===null||x[2]!==_[2])&&(t.value=!1,a.value=!1),n.value=""}),Jt([i,l,t,s,r],()=>Ht(I),{flush:"post"}),tt(()=>{h=new ResizeObserver(b),I()}),wt(()=>h==null?void 0:h.disconnect()),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,previewElement:i,summaryElement:l,model:r,body:d,canExpand:u,showBody:p,headerSummary:m,toggleExpanded:k,toggleRaw:y,copyOutput:g}},template:`
...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(n.value="Copied")}catch{e.value===u&&(n.value="Copy unavailable — select text manually")}}return Jt(()=>e.value,()=>{t.value=!1,n.value=""}),Jt(a,()=>{t.value=!1,n.value=""}),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},VS={components:{ToolOutput:ec},setup(){const e=f([]),t=f([]),s=f({}),a=50;function n(p){var b,I,k,y,g,x,_,S,E,R,w;const m=p.payload||p,h=m.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(h)&&!(m.agent_id||(b=m.metadata)!=null&&b.agent_id))&&!(["loop_tool_start","loop_tool"].includes(h)&&!(m.call_id||(I=m.metadata)!=null&&I.call_id))){if(h==="tool_start"||h==="loop_tool_start"){const O=m.call_id||((k=m.metadata)==null?void 0:k.call_id)||null,B=m.agent_id||((y=m.metadata)==null?void 0:y.agent_id)||"",T={callId:O,agentId:B,agentLabel:m.agent_label||((g=m.metadata)==null?void 0:g.agent_label)||"",toolInput:m.tool_input,id:O?`${B}:${O}`:`${m.action}-${Date.now()}`,tool:m.action,actor:m.actor||"",channel:m.channel_id||"",iteration:m.iteration??((x=m.metadata)==null?void 0:x.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(T);return}if(h==="tool_end"||h==="loop_tool"){const O=m.call_id||((_=m.metadata)==null?void 0:_.call_id)||null,B=m.agent_id||((S=m.metadata)==null?void 0:S.agent_id)||"";let T=-1;if(O&&(T=e.value.findIndex(F=>F.callId===O&&F.agentId===B&&F.status==="running")),T<0&&!O)for(let F=e.value.length-1;F>=0;F--){const X=e.value[F];if(X.tool===m.action&&X.agentId===B&&X.status==="running"){T=F;break}}if(T>=0){const F=e.value[T];F.status=m.error||(E=m.metadata)!=null&&E.error||["error","failed","cancelled","denied","outcome_unknown"].includes(m.status||((R=m.metadata)==null?void 0:R.status))?"error":"success",F.elapsed=m.execution_time_ms??m.duration_ms??((w=m.metadata)==null?void 0:w.elapsed_ms)??Date.now()-F.startTime,F.result=m.result_summary??m.detail??"",F.fadingOut=!0,setTimeout(()=>{const X=e.value.indexOf(F);X>=0&&e.value.splice(X,1),t.value.unshift(F),t.value.length>a&&t.value.pop()},5e3)}return}if(h==="tool_stream"){const O=m.call_id||m.tool_name||"unknown";if(m.finished){const B={...s.value};delete B[O],s.value=B}else{const T=((s.value[O]||"")+(m.chunk||"")).split(`
...
... (truncated)`:s}function Tf(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Nu(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function gg(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const bg=Symbol("agent-detail-cancelled"),WS=15e3;function KS(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:a,cancelTimeout:n}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((m,h)=>{r=m,c=h});function u(m,h){o||(o=!0,l!==null&&n(l),l=null,(m?r:c)(h))}let p;try{p=e(i==null?void 0:i.signal)}catch(m){u(!1,m)}return o||Promise.resolve(p).then(m=>u(!0,m),m=>u(!1,m)),!o&&Number.isFinite(t)&&t>0&&(l=a(()=>{const m=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${m}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,bg),i==null||i.abort()}}}function yg({state:e,requestDetail:t,timeoutMs:s=WS,detailLabel:a="Agent detail",scheduleTimeout:n=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:m,coalesce:h}){if(!p)return Promise.resolve();if(h&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const b={agentId:p,cancel:null,promise:null};l=b,m?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const I=KS(k=>t(p,{signal:k}),{timeoutMs:s,timeoutLabel:a,scheduleTimeout:n,cancelTimeout:i});return b.cancel=I.cancel,b.promise=(async()=>{let k=null,y=null;try{k=await I.promise}catch(g){y=g}k!==bg&&(l!==b||e.detailId!==p||(l=null,!y&&(k===null||typeof k!="object")&&(y=new Error(`${a} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${a.toLowerCase()}`):(e.detail=k,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function JS({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:a,intervalMs:n=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&a())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,n))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const ZS={components:{ToolOutput:ec},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(!0),i=f("all");let l=!1;const o=j(()=>e.value.filter(D=>D.status==="running").length),r=j(()=>e.value.filter(D=>D.status==="completed").length),c=j(()=>e.value.filter(D=>["failed","timeout","killed"].includes(D.status)).length),d=j(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=j(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(D=>["failed","timeout","killed"].includes(D.status)):e.value.filter(D=>D.status===i.value));function p(D){const ie=Number(D.max_iterations)||0;return ie<=0?0:Math.min(100,Math.round(D.iteration_count/ie*100))}function m(D){return(Number(D.max_iterations)||0)>0}function h(D,ie){return D?D==="N/A"?"N/A":ie==="current_inheritance"?`inherit (currently ${D})`:D:"unknown"}function b(D){return h(D.display_model,D.display_model_source||D.display_source)}function I(D){return h(D.display_reasoning_effort,D.display_reasoning_effort_source||D.display_source)}function k(D){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[D]||""}const y=f(null),g=f(null),x=f(!1),_=f(null),S=f(""),R=yg({state:{get detail(){return y.value},set detail(D){y.value=D},get detailId(){return g.value},set detailId(D){g.value=D},get detailLoading(){return x.value},set detailLoading(D){x.value=D},get detailError(){return _.value},set detailError(D){_.value=D}},requestDetail:(D,{signal:ie})=>H.get(`/api/agents/${encodeURIComponent(D)}`,{signal:ie})});async function w(D){S.value="",await R.open(D.id)}function O(){R.close(),S.value=""}async function B(){await R.refresh()}async function T(D,ie){try{await navigator.clipboard.writeText(ie||""),S.value=D,setTimeout(()=>{S.value===D&&(S.value="")},1500)}catch{Te.error("Copy failed")}}async function F(D=!1){D=D===!0,D||(t.value=!0);try{const ie=await H.get("/api/agents");e.value=Array.isArray(ie)?ie:[],s.value=null}catch(ie){D||(s.value=ie.message)}D||(t.value=!1)}async function X(D){const ie=e.value.find(z=>z.id===D);if(await os({title:"Kill agent",message:`Kill agent "${(ie==null?void 0:ie.label)||D}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){a.value=D;try{await H.del(`/api/agents/${encodeURIComponent(D)}`),Te.success("Agent killed"),await F()}catch(z){Te.error(z.message||"Failed to kill agent")}a.value=null}}const W=JS({isEnabled:()=>n.value&&l,refreshList:()=>F(!0),hasOpenDetail:()=>!!g.value,refreshDetail:B});function M(){W.start()}function L(){W.stop()}return Jt(n,()=>W.sync()),tt(()=>{l=!0,F(),M()}),rs(()=>{l=!0,F(!0),M()}),Zt(()=>{l=!1,L()}),wt(()=>{l=!1,L(),R.close()}),{agents:e,loading:t,error:s,killing:a,autoRefresh:n,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ai,formatDuration:Ji,progressPercent:p,hasProgress:m,displayModelText:b,displayEffortText:I,displaySourceLabel:k,detail:y,detailId:g,detailLoading:x,detailError:_,copied:S,openDetail:w,closeDetail:O,copyText:T,fetchAgents:F,killAgent:X,startAutoRefresh:M,stopAutoRefresh:L}}},YS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(!1),n=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),m=f("");let h=!1;const I=yg({state:{get detail(){return c.value},set detail(L){c.value=L},get detailId(){return d.value},set detailId(L){d.value=L},get detailLoading(){return u.value},set detailLoading(L){u.value=L},get detailError(){return p.value},set detailError(L){p.value=L}},detailLabel:"Loop detail",requestDetail:(L,{signal:D})=>H.get(`/api/loops/${encodeURIComponent(L)}?limit=100`,{signal:D})});async function k(L){m.value="",await I.open(L.id)}function y(){I.close(),m.value=""}async function g(L,D){try{await navigator.clipboard.writeText(D||""),m.value=L,setTimeout(()=>{m.value===L&&(m.value="")},1500)}catch{Te.error("Copy failed")}}const x=j(()=>e.value.reduce((L,D)=>L+(D.iteration_count||0),0)),_=j(()=>e.value.filter(L=>L.status==="running").length);function S(L){return L==="running"?"loop-status-running":L==="error"?"loop-status-error":"loop-status-stopped"}function E(L){return L==="running"?"badge-success":L==="error"?"badge-danger":L==="completed"?"badge-info":"badge-warning"}function R(L){return L==="act"?"badge-warning":L==="silent"?"badge-info":"badge-success"}async function w(L=!1){L=L===!0,L||(t.value=!0);try{const D=await H.get("/api/loops");e.value=Array.isArray(D)?D:[],s.value=null}catch(D){L||(s.value=D.message)}L||(t.value=!1)}async function O(){l.value=null;const L=n.value;if(!L.goal.trim()){l.value="Goal is required";return}if(!L.channel_id.trim()){l.value="Channel ID is required";return}const D={goal:L.goal.trim(),channel_id:L.channel_id.trim(),interval_seconds:L.interval_seconds||60,mode:L.mode,max_iterations:L.max_iterations||50};L.stop_condition.trim()&&(D.stop_condition=L.stop_condition.trim()),i.value=!0;try{const ie=await H.post("/api/loops",D);Te.success(`Loop started: ${ie.loop_id}`),n.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},a.value=!1,await w()}catch(ie){l.value=ie.message}i.value=!1}async function B(L){if(await os({title:"Stop loop",message:`Stop loop ${L}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=L;try{await H.del(`/api/loops/${encodeURIComponent(L)}`),Te.success("Loop stopped"),await w()}catch(ie){Te.error(ie.message||"Failed to stop loop")}o.value=null}}async function T(L){r.value=L;try{await H.post(`/api/loops/${encodeURIComponent(L)}/restart`),Te.success("Loop restarted"),await w()}catch(D){Te.error(D.message||"Failed to restart loop")}r.value=null}function F(L){h&&L.payload&&(L.payload.loop_id||L.payload.type==="loop")&&(w(!0),d.value&&I.refresh())}let X=null;function W(){X!==null&&clearInterval(X),X=null}function M(){W(),h&&(X=setInterval(()=>{w(!0),d.value&&I.refresh()},5e3))}return tt(()=>{h=!0,w(),ct.subscribe("events",F),M()}),rs(()=>{h=!0,w(!0),M()}),Zt(()=>{h=!1,W()}),wt(()=>{h=!1,ct.unsubscribe("events",F),W(),I.close()}),{loops:e,loading:t,error:s,showCreate:a,form:n,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:m,totalIterations:x,runningCount:_,statusDotClass:S,statusBadge:E,modeBadge:R,formatAge:hg,formatDuration:Ji,formatTs:ai,formatTokens:gg,openDetail:k,closeDetail:y,copyText:g,fetchLoops:w,doCreate:O,doStop:B,doRestart:T}}},QS={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(Ko(null)),n=j(()=>a.value.available),i=j(()=>Oo(a.value));let l=null;const o=f(!1),r=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""}),c=f(!1),d=f(null),u=j(()=>Rf(a.value,r.value.action));function p(U){return Rf(a.value,U)}const m=f(null),h=j(()=>s1(r.value.run_at));Jt(()=>r.value.run_at,()=>{m.value=null});const b=j(()=>{var Z;const U=h.value;return U.state==="ok"?U.instant:U.state==="ambiguous"&&m.value!==null&&((Z=U.options[m.value])==null?void 0:Z.instant)||null}),I=j(()=>{const U=b.value;return U?`${U.toLocaleString()} local — ${U.toISOString()} UTC`:""}),k=f(null),y=f(!1),g=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],x=f(null),_=f(null),S=f(null),E=f(null),R=f(null),w=f(null),O=f([]),B=f(!1),T=f("");let F=0;const X=j(()=>e.value.filter(U=>U.cron&&!U.one_time).length),W=j(()=>e.value.filter(U=>U.one_time).length),M=j(()=>e.value.filter(U=>U.trigger).length),L=j(()=>e.value.filter(U=>U.paused).length),D=j(()=>e.value.filter(U=>U.consecutive_failures>0).length);function ie(U){if(!U)return"-";const Z=Date.now(),V=(new Date(U).getTime()-Z)/1e3;if(V<0)return"overdue";if(V<60)return"in < 1 min";if(V<3600)return`in ${Math.floor(V/60)} min`;if(V<86400){const se=Math.floor(V/3600),ge=Math.floor(V%3600/60);return ge>0?`in ${se}h ${ge}m`:`in ${se}h`}const te=Math.floor(V/86400);return`in ${te} day${te!==1?"s":""}`}function le(U){return U==null?"-":U<1e3?`${U}ms`:U<6e4?`${(U/1e3).toFixed(1)}s`:Ji(U/1e3)}function z(U=r.value.cron){r.value.cron=U,Ef(r.value,"cron"),k.value=null}function Y(U=r.value.run_at){r.value.run_at=U,Ef(r.value,"run_at"),k.value=null}async function oe(){const U=r.value.cron.trim();if(U){y.value=!0;try{k.value=await H.post("/api/schedules/validate-cron",{expression:U})}catch(Z){k.value={valid:!1,error:Z.message}}y.value=!1}}async function K(){t.value=!0,s.value=null;try{e.value=await H.get("/api/schedules")}catch(U){s.value=U.message}t.value=!1}async function he(){try{a.value=Ko(await H.get("/api/schedules/status"))}catch(U){a.value=Af(U)||Ko(null)}}function fe(U){const Z=Af(U);Z&&(a.value=Z)}async function J(U){if(w.value===U){w.value=null,O.value=[];return}w.value=U,B.value=!0,O.value=[];const Z=++F;try{const de=await H.get(`/api/schedules/${encodeURIComponent(U)}/history?limit=10`);if(Z!==F||w.value!==U)return;O.value=de,T.value=""}catch(de){if(Z!==F||w.value!==U)return;O.value=[],T.value=de.message||"Failed to load execution history"}Z===F&&(B.value=!1)}async function pe(){if(d.value=null,!p(r.value.action)){d.value=Oo(a.value);return}const U=r.value;if(!U.description.trim()){d.value="Description is required";return}if(U.action!=="webhook"&&!U.channel_id.trim()){d.value="Channel ID is required";return}if(!U.cron.trim()&&!U.run_at.trim()){d.value="Cron expression or run_at time is required";return}if(U.cron.trim()&&U.run_at.trim()){d.value="Choose either Cron or One-Time, not both";return}const Z={description:U.description.trim(),action:U.action,channel_id:U.channel_id.trim()};if(U.cron.trim()&&(Z.cron=U.cron.trim()),U.run_at.trim()){const de=h.value;if(de.state==="nonexistent"){d.value="That local time does not exist (daylight saving gap)";return}if(de.state==="invalid"){d.value="One-time run time is not a valid date";return}const V=b.value;if(de.state==="ambiguous"&&m.value===null){d.value="That local time happens twice — choose which occurrence to use";return}if(!V){d.value="One-time run time could not be resolved";return}Z.run_at=V.toISOString()}if(U.action==="reminder"&&U.message.trim()&&(Z.message=U.message.trim()),U.action==="check"&&(U.tool_name.trim()&&(Z.tool_name=U.tool_name.trim()),U.report_format&&(Z.report_format=U.report_format),U.tool_input_str.trim()))try{Z.tool_input=JSON.parse(U.tool_input_str.trim())}catch{d.value="Tool input must be valid JSON";return}if(U.action==="webhook"){if(!U.webhook_url.trim()){d.value="Webhook URL is required";return}const de={url:U.webhook_url.trim(),method:U.webhook_method};if(U.webhook_headers_str.trim())try{const V=JSON.parse(U.webhook_headers_str.trim());if(!V||Array.isArray(V)||typeof V!="object")throw new Error("not an object");de.headers=V}catch{d.value="Webhook headers must be a valid JSON object";return}if(U.webhook_body&&(de.body=U.webhook_body),U.webhook_expected_status_str.trim()){const V=U.webhook_expected_status_str.split(",").map(te=>Number(te.trim()));if(V.some(te=>!Number.isInteger(te)||te<100||te>599)){d.value="Expected status codes must be comma-separated HTTP codes";return}de.expected_status_codes=V}Z.webhook_config=de}c.value=!0;try{await H.post("/api/schedules",Z),Te.success("Schedule created"),r.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""},k.value=null,o.value=!1,await K()}catch(de){fe(de),d.value=de.message}c.value=!1}async function ve(U){if(!p(U.action)){Te.error(Oo(a.value));return}const Z=U.id;x.value=Z;try{const de=await H.post(`/api/schedules/${encodeURIComponent(Z)}/run`);if(de.status==="failure")Te.error(`Execution failed: ${de.error||"unknown error"}`);else{const V=de.warning?`Executed (${de.warning})`:"Executed successfully";Te.success(V)}await K()}catch(de){fe(de),Te.error(de.message||"Failed to trigger")}x.value=null}async function ye(U){if(U.paused&&!p(U.action)){Te.error(Oo(a.value));return}S.value=U.id;const Z=!U.paused;try{await H.put(`/api/schedules/${encodeURIComponent(U.id)}`,{paused:Z}),Te.success(Z?"Schedule paused":"Schedule resumed"),await K()}catch(de){fe(de),Te.error(de.message||"Failed to update schedule")}S.value=null}const xe=new Map;function He(U,Z){const de=xe.get(U.id);de&&clearTimeout(de.timer);const V={run:()=>A(U,Z),timer:null};V.timer=setTimeout(()=>{xe.delete(U.id),V.run()},500),xe.set(U.id,V)}async function A(U,Z){R.value=U.id;try{await H.put(`/api/schedules/${encodeURIComponent(U.id)}`,{report_format:Z}),Te.success(Z?"Structured report enabled":"Plain-text report enabled")}catch(de){Te.error(`Update failed: ${de.message}`)}finally{await K(),R.value=null}}function P(){for(const[U,Z]of[...xe])clearTimeout(Z.timer),xe.delete(U),Z.run()}async function q(U){E.value=U;try{await H.post(`/api/schedules/${encodeURIComponent(U)}/reset-failures`),Te.success("Failure counters reset"),await K()}catch(Z){Te.error(Z.message||"Failed to reset")}E.value=null}async function ue(U){const Z=e.value.find(V=>V.id===U);if(await os({title:"Delete schedule",message:`Delete "${(Z==null?void 0:Z.description)||U}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){_.value=U;try{await H.del(`/api/schedules/${encodeURIComponent(U)}`),Te.success("Schedule deleted"),await K()}catch(V){Te.error(V.message||"Failed to delete schedule")}_.value=null}}return tt(()=>{K(),he(),l=setInterval(he,a1)}),wt(()=>{P(),l&&clearInterval(l)}),{schedules:e,loading:t,error:s,schedulingAvailable:n,schedulingAvailabilityMessage:i,selectedActionAvailable:u,actionAvailable:p,showCreate:o,form:r,creating:c,createError:d,runAtUtcPreview:I,runAtAnalysis:h,runAtOccurrence:m,cronResult:k,validatingCron:y,cronPresets:g,runningId:x,deletingId:_,togglingId:S,resettingId:E,reportUpdatingId:R,flushReportFormatTimers:P,expandedId:w,history:O,historyLoading:B,historyError:T,cronCount:X,oneTimeCount:W,webhookCount:M,pausedCount:L,failingCount:D,formatTs:ai,formatAge:hg,formatFuture:ie,formatMs:le,formatDuration:Ji,onCronInput:z,onRunAtInput:Y,validateCron:oe,toggleExpand:J,fetchSchedules:K,fetchSchedulingAvailability:he,doCreate:pe,doRunNow:ve,doTogglePause:ye,doUpdateReportFormat:He,doResetFailures:q,doDelete:ue}}},xg=[{id:"live",label:"Live",component:VS},{id:"agents",label:"Agents",component:ZS},{id:"loops",label:"Loops",component:YS},{id:"processes",label:"Processes",component:QS},{id:"schedules",label:"Schedules",component:i1}],l1={components:{TabbedPage:Xr},setup(){return{tabs:xg}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},o1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),m=f("last_active"),h=f(!1),b=If,I=r1,k=f([]),y=f(!1),g=f(""),x=f("flat"),_=f(new Set),S=f(""),E=f(""),R=f(""),w=f(null),O=f(!1),B=f(""),T=f(!1);let F=0;Jt([S,E,R],()=>{F++,O.value=!1,B.value="",T.value=w.value!==null},{flush:"sync"});function X(){try{const ae=localStorage.getItem("odin-session-presets");ae&&(k.value=JSON.parse(ae))}catch{}}function W(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const M=j(()=>p.value.trim()!==""||u.value!=="all"),L=j(()=>{let ae=[...e.value];const Le=If.find(ft=>ft.id===u.value),Ue=Le?Le.filters:{};if(Ue.source&&(ae=ae.filter(ft=>ft.source===Ue.source)),Ue.minMessages&&(ae=ae.filter(ft=>ft.message_count>=Ue.minMessages)),Ue.hasCompaction&&(ae=ae.filter(ft=>ft.has_summary)),Ue.maxAge!=null){const ft=Date.now()/1e3;ae=ae.filter(yt=>yt.last_active&&ft-yt.last_active<=Ue.maxAge)}if(p.value.trim()){const ft=p.value.toLowerCase().trim();ae=ae.filter(yt=>(yt.channel_id||"").toLowerCase().includes(ft)||(yt.last_user_id||"").toLowerCase().includes(ft)||(yt.source||"").toLowerCase().includes(ft))}const dt=m.value,Ut=h.value?1:-1;return ae.sort((ft,yt)=>{const Qt=ft[dt]||0,cs=yt[dt]||0;return(Qt-cs)*Ut}),ae}),D=j(()=>{if(!n.value||!n.value.messages)return[];const ae=n.value.messages;if(ae.length===0)return[];const Le=[];let Ue=[];for(const dt of ae)dt.role==="user"&&Ue.length>0&&(Le.push(Ue),Ue=[]),Ue.push(dt);return Ue.length>0&&Le.push(Ue),Le}),ie=j(()=>L.value.length>0&&c.value.size===L.value.length);function le(ae){const Le=ae.find(Ue=>Ue.role==="user");if(Le&&Le.content){const Ue=Le.content.slice(0,120);return Ue.length<Le.content.length?Ue+"...":Ue}return"(no user message)"}function z(ae){const Le=new Set(_.value);Le.has(ae)?Le.delete(ae):Le.add(ae),_.value=Le}function Y(ae){u.value=ae}function oe(ae){u.value=ae.id,ae.filters.searchQuery!=null&&(p.value=ae.filters.searchQuery),ae.filters.sortBy&&(m.value=ae.filters.sortBy)}function K(){if(!g.value.trim())return;const ae={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:m.value}};k.value=[...k.value,ae],W(),y.value=!1,g.value=""}function he(ae){k.value=k.value.filter(Le=>Le.id!==ae),W(),u.value===ae&&(u.value="all")}function fe(){u.value="all",p.value="",m.value="last_active",h.value=!1}function J(ae){if(!ae)return"—";const Le=Date.now()/1e3-ae;if(Le<60)return"just now";if(Le<3600){const dt=Math.floor(Le/60);return`${dt} minute${dt!==1?"s":""} ago`}if(Le<86400){const dt=Math.floor(Le/3600);return`${dt} hour${dt!==1?"s":""} ago`}const Ue=Math.floor(Le/86400);return`${Ue} day${Ue!==1?"s":""} ago`}function pe(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ve(ae){if(!ae)return"";try{return new Date(ae*1e3).toLocaleString()}catch{return""}}function ye(ae){return ae==="user"?"bg-gray-900/50 border border-gray-800":ae==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function xe(ae){return ae==="user"?"sess-msg-user":ae==="assistant"?"sess-msg-assistant":"sess-msg-system"}function He(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":"badge-warning"}function A(ae){return ae==="user"?"sess-dot-user":ae==="assistant"?"sess-dot-assistant":"sess-dot-system"}function P(ae){return ae==="user"?"text-cyan-400":ae==="assistant"?"text-indigo-400":"text-gray-500"}function q(ae){return ae?ae.length>2e3?ae.slice(0,2e3)+`
... (truncated)`:ae:""}async function ue(){const ae=S.value.trim();if(!ae)return;const Le=++F;O.value=!0,B.value="",T.value=w.value!==null;try{let Ue=`/api/sessions/search?q=${encodeURIComponent(ae)}&limit=50`;E.value.trim()&&(Ue+=`&channel_id=${encodeURIComponent(E.value.trim())}`),R.value.trim()&&(Ue+=`&user_id=${encodeURIComponent(R.value.trim())}`);const dt=await H.get(Ue);if(Le!==F)return;w.value=dt.results||[],T.value=!1}catch(Ue){if(Le!==F)return;B.value=Ue.message||"Search failed. Please retry."}finally{Le===F&&(O.value=!1)}}function U(){F++,S.value="",E.value="",R.value="",w.value=null,B.value="",T.value=!1,O.value=!1}function Z(ae){return ae?ae.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function de(ae){return ae==="user"?"fts-result-user":ae==="assistant"?"fts-result-assistant":ae==="summary"?"fts-result-summary":ae==="fts"?"fts-result-fts":ae==="channel"?"fts-result-channel":"fts-result-default"}function V(ae){return ae==="user"?"badge-info":ae==="assistant"?"badge-success":ae==="summary"?"badge-warning":ae==="fts"?"badge-success":"badge-info"}let te=0;async function se(){const ae=++te;t.value=!0,s.value=null;try{const Le=await H.get("/api/sessions");if(ae!==te)return;e.value=Le}catch(Le){if(ae!==te)return;s.value=Le.message}ae===te&&(t.value=!1)}function ge(){s.value=null,se()}async function me(ae){if(a.value===ae){a.value=null,n.value=null,_.value=new Set;return}a.value=ae,n.value=null,i.value=!0,_.value=new Set;const Le=++l;try{const Ue=await H.get(`/api/sessions/${encodeURIComponent(ae)}`);Le===l&&a.value===ae&&(n.value=Ue)}catch(Ue){Le===l&&a.value===ae&&(n.value={messages:[],summary:"",error:Ue.message||"Failed to load session"})}finally{Le===l&&(i.value=!1)}}function ke(ae){const Le=new Set(c.value);Le.has(ae)?Le.delete(ae):Le.add(ae),c.value=Le}function we(){ie.value?c.value=new Set:c.value=new Set(L.value.map(ae=>ae.channel_id))}function be(ae){o.value=ae}async function Ke(){if(o.value){r.value=!0;try{await H.del(`/api/sessions/${encodeURIComponent(o.value)}`),a.value===o.value&&(a.value=null,n.value=null),c.value.delete(o.value),await se()}catch(ae){s.value=ae.message||"Failed to clear session"}r.value=!1,o.value=null}}function je(){d.value=!0}async function $e(){if(c.value.size!==0){r.value=!0;try{await H.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(a.value)&&(a.value=null,n.value=null),c.value=new Set,await se()}catch(ae){s.value=ae.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Ge(ae,Le){const Ue=`/api/sessions/${encodeURIComponent(ae)}/export?format=${Le}`;try{const dt=await H.getBlob(Ue),Ut=URL.createObjectURL(dt),ft=document.createElement("a");ft.href=Ut,ft.download=`session-${ae}.${Le==="text"?"txt":"json"}`,ft.click(),URL.revokeObjectURL(Ut)}catch(dt){s.value=dt.message||"Failed to export session"}}let st=null;function Ye(ae){ae.payload&&ae.payload.channel_id&&(clearTimeout(st),st=setTimeout(()=>{if(se(),a.value&&ae.payload.channel_id===a.value){const Le=a.value,Ue=l;H.get(`/api/sessions/${encodeURIComponent(Le)}`).then(dt=>{Ue!==l||a.value!==Le||(n.value=dt)}).catch(()=>{})}},2e3))}let Q=!1,Ee=null;function Ae(){Q||(Q=!0,se(),ct.subscribe("events",Ye),Ee=ct.onReconnected(()=>se()))}tt(()=>{X(),Ae()}),rs(()=>{Ae()});function Ne(){Q&&(Q=!1,ct.unsubscribe("events",Ye),Ee&&(Ee(),Ee=null),clearTimeout(st))}return Zt(Ne),wt(Ne),{sessions:e,loading:t,error:s,expandedId:a,detail:n,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:ie,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:m,sortAsc:h,filterPresets:b,sortOptions:I,filteredSessions:L,hasActiveFilters:M,customPresets:k,showSavePreset:y,newPresetName:g,threadView:x,threads:D,collapsedThreads:_,ftsQuery:S,ftsChannelId:E,ftsUserId:R,ftsResults:w,ftsSearching:O,ftsError:B,ftsStale:T,formatAge:J,formatTimestamp:pe,formatFullTimestamp:ve,messageClass:ye,threadMsgClass:xe,roleBadge:He,roleDotClass:A,roleLabelClass:P,truncateContent:q,threadSummary:le,fetchSessions:se,retry:ge,toggleSession:me,toggleSelect:ke,toggleSelectAll:we,confirmClear:be,clearSession:Ke,confirmBulkClear:je,doBulkClear:$e,exportSession:Ge,applyPreset:Y,applyCustomPreset:oe,saveCustomPreset:K,removeCustomPreset:he,resetFilters:fe,toggleThread:z,runFtsSearch:ue,clearFtsSearch:U,highlightSnippet:Z,ftsResultClass:de,ftsTypeBadge:V}}},d1={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:gg}}},u1={components:{ContextAssemblyPanel:d1},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(E){if(!E)return"—";try{const R=new Date(E);return isNaN(R.getTime())?E:R.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return E}}function p(E){return!E&&E!==0?"—":E<1e3?E+"ms":(E/1e3).toFixed(1)+"s"}function m(E){return!E&&E!==0?"—":E>=1e3?(E/1e3).toFixed(1)+"k":String(E)}function h(E){if(!E)return"";if(typeof E=="string")return E;try{return JSON.stringify(E,null,2)}catch{return String(E)}}function b(E){n.value===E?n.value=null:(n.value=E,c.value={})}function I(E,R){const w=E+"-"+R;c.value={...c.value,[w]:!c.value[w]}}function k(E,R){return!!c.value[E+"-"+R]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,_()}async function g(){try{const E=await H.get("/api/trajectories");e.value=E.files||[],r.value=E.count||0}catch{}}let x=0;async function _(){const E=++x;s.value=!0,a.value=null,n.value=null,i.value=null,c.value={};try{if(o.value){const R=await H.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(E!==x)return;let w=R.entries||[];d.value.tool_name&&(w=w.filter(O=>(O.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(w=w.filter(O=>O.is_error)),d.value.channel_id&&(w=w.filter(O=>O.channel_id===d.value.channel_id)),d.value.user_id&&(w=w.filter(O=>O.user_id===d.value.user_id)),t.value=w}else{const R=new URLSearchParams;d.value.channel_id&&R.set("channel_id",d.value.channel_id),d.value.user_id&&R.set("user_id",d.value.user_id),d.value.tool_name&&R.set("tool_name",d.value.tool_name),d.value.errors_only&&R.set("errors_only","true"),R.set("limit",String(d.value.limit));const w=R.toString(),O=await H.get(`/api/trajectories/search/query?${w}`);if(E!==x)return;t.value=O.results||[]}}catch(R){if(E!==x)return;a.value=R.message}E===x&&(s.value=!1)}async function S(){if(!l.value.trim())return;const E=++x;s.value=!0,a.value=null,c.value={};try{const R=await H.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(E!==x)return;i.value=R.entry||null,i.value||(a.value="No trace found for this message ID")}catch(R){if(E!==x)return;R.status===404?(i.value=null,a.value="No trace found for message ID: "+l.value):a.value=R.message}E===x&&(s.value=!1)}return tt(async()=>{await g(),await _()}),{files:e,entries:t,loading:s,error:a,expandedIdx:n,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:m,formatJSON:h,truncateBlock:vg,toggleExpand:b,toggleIteration:I,isIterationExpanded:k,clearFilters:y,fetchFiles:g,fetchTraces:_,lookupMessage:S}}};function p1(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function f1(e){return e?`${e.approximate?"~":""}${Nu(e.total||0)}`:"0"}const m1={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),a=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),n=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=j(()=>a.value.work||{}),m=E=>E==null?"Not reported":`$${Number(E).toFixed(6)}`,h=j(()=>Math.max(1,...(a.value.activity_over_time||[]).map(E=>Number(E.count||0)))),b=j(()=>({minWidth:`max(100%, ${(a.value.activity_over_time||[]).length*5}px)`})),I=E=>({height:`${Math.max(4,Math.round(Number(E||0)/h.value*100))}%`}),k=j(()=>s.value&&l.value-i.value>3e4);async function y(){const E=++d,R=n.value;try{const w=await H.get(`/api/usage?range=${encodeURIComponent(R)}`);if(E!==d||R!==n.value)return;a.value=w,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(w){E===d&&(t.value=w.message)}finally{E===d&&(e.value=!1)}}function g(E){n.value=E,e.value=!s.value,y()}function x(){e.value=!0,y()}function _(){c||(c=!0,y(),o=setInterval(y,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function S(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return tt(_),rs(_),Zt(S),wt(S),{data:a,work:p,loading:e,error:t,hasData:s,range:n,ranges:u,isStale:k,fmtNum:Nu,fmtDuration:p1,tokenLabel:f1,formatActualCost:m,activityTrackStyle:b,activityBar:I,selectRange:g,retry:x}}},_g=[{id:"audit",label:"Audit",component:o1},{id:"sessions",label:"Sessions",component:c1},{id:"traces",label:"Traces",component:u1},{id:"usage",label:"Usage & Activity",component:m1}],h1={components:{TabbedPage:Xr},setup(){return{tabs:_g}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Nc=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],v1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(w){return w.source!=="builtin"?"":u[w.state]||""}function m(w,O){const B=w&&Array.isArray(w.tools)?w.tools:null;if(c.value=!!B,r.value=B?!!w.global_enabled:null,!B){e.value=O.map(X=>({...X,source:"unknown",enabled:void 0,state:null}));return}const T=new Set(B.map(X=>X.name)),F=O.filter(X=>!T.has(X.name)).map(X=>({...X,source:X.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...B.map(X=>({...X,source:"builtin"})),...F]}async function h(w,O){if(d.value.has(w.name))return;const B=!!O.target.checked,T=new Set(d.value);T.add(w.name),d.value=T;try{const F=await H.post(`/api/tools/builtins/${encodeURIComponent(w.name)}/enabled`,{enabled:B});m(F,e.value),s.value=null;try{const X=await H.get("/api/tools");m(F,X)}catch(X){console.warn("Built-in toggle committed; visible catalog refresh failed",X)}}catch(F){O.target.checked=!!w.enabled,s.value=F.message||`Failed to toggle ${w.name}`}finally{const F=new Set(d.value);F.delete(w.name),d.value=F}}const b=j(()=>e.value.filter(w=>w.source==="builtin"&&w.is_core).length),I=j(()=>e.value.filter(w=>w.source==="skill").length),k=j(()=>Object.values(n.value).reduce((w,O)=>w+O,0));function y(w){for(const O of Nc)if(O.id!=="other"&&O.match(w))return O.id;return"other"}const g=j(()=>{let w=e.value;if(a.value){const O=a.value.toLowerCase();w=w.filter(B=>B.name.toLowerCase().includes(O)||(B.description||"").toLowerCase().includes(O))}return o.value&&(w=w.filter(O=>y(O.name)===o.value)),w}),x=j(()=>{const w=new Set;for(const O of e.value)w.add(y(O.name));return Nc.filter(O=>w.has(O.id))}),_=j(()=>{const w=g.value,O={};for(const T of w){const F=y(T.name);O[F]||(O[F]=[]),O[F].push(T)}const B=[];for(const T of Nc)O[T.id]&&O[T.id].length>0&&B.push({label:T.label,icon:T.icon,tools:O[T.id].sort((F,X)=>F.name.localeCompare(X.name))});return B});function S(w){i.value={...i.value,[w]:!i.value[w]}}async function E(){t.value=!0,s.value=null;try{const[w,O,B]=await Promise.all([H.get("/api/tools"),H.get("/api/tools/stats").catch(()=>({})),H.get("/api/tools/builtins").catch(()=>null)]);m(B,w),n.value=O||{}}catch(w){s.value=w.message}t.value=!1}function R(){E()}return tt(()=>{E()}),{tools:e,loading:t,error:s,search:a,stats:n,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:b,skillCount:I,totalUsage:k,filteredTools:g,groupedTools:_,usedCategories:x,stateBadge:p,applyInventory:m,toggleBuiltinTool:h,truncate:Lu,toggleExpand:S,refresh:R}}};function g1(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const a="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(a,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function b1(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function B(K){return b1(K)}function T(K){a.value={...a.value,[K]:!a.value[K]}}async function F(K){try{await navigator.clipboard.writeText(K);const he=e.value.find(fe=>fe.code===K);he&&(o.value=he.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function X(K){if(K.key==="Tab"){K.preventDefault();const he=K.target,fe=he.selectionStart,J=he.selectionEnd;u.value=u.value.substring(0,fe)+"    "+u.value.substring(J),Ht(()=>{he.selectionStart=he.selectionEnd=fe+4})}}function W(K){const he=K.target.previousElementSibling;he&&(he.scrollTop=K.target.scrollTop)}async function M(){t.value=!0,s.value=null;try{e.value=await H.get("/api/skills")}catch(K){s.value=K.message}t.value=!1}async function L(K){i.value=K,delete n.value[K],n.value={...n.value};try{const he=await H.post(`/api/skills/${encodeURIComponent(K)}/test`);n.value={...n.value,[K]:he}}catch(he){n.value={...n.value,[K]:{result:he.message,is_error:!0}}}i.value=null}function D(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,m.value=null}function ie(K){r.value=!0,c.value="edit",d.value=K.name,u.value=K.code||"",p.value=null,m.value=null}function le(){r.value=!1,p.value=null,m.value=null}async function z(){p.value=null,m.value=null;const K=d.value.trim(),he=u.value.trim();if(!K){p.value="Name is required";return}if(!he){p.value="Code is required";return}h.value=!0;try{c.value==="create"?(await H.post("/api/skills",{name:K,code:he}),m.value="Skill created successfully"):(await H.put(`/api/skills/${encodeURIComponent(K)}`,{code:he}),m.value="Skill updated successfully"),await M(),setTimeout(()=>{r.value=!1},800)}catch(fe){p.value=fe.message}h.value=!1}function Y(K){I.value=K}async function oe(){if(I.value){k.value=!0;try{await H.del(`/api/skills/${encodeURIComponent(I.value)}`),await M()}catch(K){Te.error(`Failed to delete skill: ${K.message||"unknown error"}`)}k.value=!1,I.value=null}}return tt(()=>{M()}),{skills:e,loading:t,error:s,showCode:a,testResults:n,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:m,saving:h,editorRef:b,deleteTarget:I,deleting:k,enabledCount:y,totalExecutions:g,totalLines:x,displayedSkills:_,editLineCount:S,editorLineNums:E,editValidation:R,highlight:w,truncate:Lu,formatTs:ai,countLines:O,getLineNumbers:B,toggleCode:T,copyCode:F,handleEditorKey:X,syncScroll:W,fetchSkills:M,testSkill:L,showCreate:D,editSkill:ie,cancelEdit:le,saveSkill:z,confirmDelete:Y,doDelete:oe}}};class aa extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const x1=/^[A-Za-z_][A-Za-z0-9_]*$/;function Of(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Lf(e,t,s){const a={},n=[...new Set((t||[]).map(l=>String(l)))],i=new Set(n);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new aa(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new aa(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(a,o))throw new aa(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new aa(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");a[o]=r}}return{set:a,remove:n}}function _1(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function w1(e,{mode:t="add",originalTransport:s=""}={}){const a=t==="add",n=String(e.name||"").trim();if(!n)throw new aa("Server name is required.","name");if(n.length>128||!x1.test(n))throw new aa("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!a&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(a&&(o.name=n),i==="stdio"){const d=String(e.command||"").trim();if((a||l)&&!d)throw new aa("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(a||e.replaceArgs)&&(o.args=Of(e.argsText)),a||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new aa("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((a||l)&&!d)throw new aa("An HTTP endpoint is required for this connection.","url");if(d&&!_1(d))throw new aa("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(a||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new aa("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(a||e.replaceAllowlist)&&(o.tool_allowlist=Of(e.allowlistText));const r=Lf(e.headerRows,e.headersRemove,"Header"),c=Lf(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function k1(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function S1(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function C1(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(a=>String(a).toLowerCase().includes(s)):!0}const T1=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function E1(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(a=>(a=window.matchMedia)==null?void 0:a.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const n=t.querySelector(".mcp-editor-groups"),i=n==null?void 0:n.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const A1=1e4,R1=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function Mc(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function I1(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const O1={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),a=f(!1),n=f(""),i=f({max_published_tools_per_server:"",max_published_tools_global:""}),l=f(new Set),o=j(()=>Object.keys(i.value).every(Q=>{var Ee;return Number.isInteger((Ee=e.value)==null?void 0:Ee[Q])})),r=f(""),c=f(new Set),d=f(new Set),u=f({}),p=f({}),m=f({}),h=f(new Set),b=f(!1),I=f("add"),k=f(""),y=f(null),g=f(Mc()),x=f(""),_=f(!1);let S=null,E=0,R=!1,w=!1;const O=T1,B=j(()=>{var Q;return((Q=e.value)==null?void 0:Q.servers)||[]}),T=j(()=>{var Q;return!!((Q=e.value)!=null&&Q.enabled)}),F=j(()=>{var Q,Ee,Ae,Ne;return{serverCount:((Q=e.value)==null?void 0:Q.server_count)||0,enabledCount:((Ee=e.value)==null?void 0:Ee.enabled_server_count)||0,connectedCount:((Ae=e.value)==null?void 0:Ae.connected_count)||0,toolCount:((Ne=e.value)==null?void 0:Ne.published_tool_count)||0}}),X=j(()=>{var Q;return((Q=y.value)==null?void 0:Q.header_keys)||[]}),W=j(()=>{var Q;return((Q=y.value)==null?void 0:Q.env_keys)||[]}),M=j(()=>{var Q;return I.value==="edit"&&((Q=y.value)==null?void 0:Q.transport)==="http"}),L=j(()=>I.value==="add"||!M.value),D=j(()=>M.value?"Replace endpoint URL":"Endpoint URL"),ie=j(()=>M.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function le(){z(),S=window.setInterval(()=>Y({quiet:!0}),A1)}function z(){S&&window.clearInterval(S),S=null}async function Y({quiet:Q=!1}={}){if(a.value)return;const Ee=++E;Q||(t.value=!0);try{const Ae=await H.get("/api/mcp/status");if(Ee!==E||!R)return;e.value=Ae;for(const ae of Object.keys(i.value))!l.value.has(ae)&&Number.isInteger(Ae[ae])&&(i.value[ae]=String(Ae[ae]));r.value="";const Ne=new Set((Ae.servers||[]).map(ae=>ae.name));d.value=new Set([...d.value].filter(ae=>Ne.has(ae)))}catch(Ae){Ee===E&&R&&(r.value=Ae.message||"Failed to load MCP status")}finally{Ee===E&&(t.value=!1)}}function oe(Q){return s.value||c.value.has(Q)}function K(Q,Ee){const Ae=new Set(c.value);Ee?Ae.add(Q):Ae.delete(Q),c.value=Ae}function he(Q){return S1(Q.state)}function fe(Q){if(he(Q)==="disabled"){if(!Q.enabled)return"Disabled — server switch off";if(!T.value)return"Disabled — global MCP is off"}return R1[he(Q)]}function J(Q){return Q.transport==="http"?"Streamable HTTP":"stdio"}function pe(Q){return Q.negotiated_version?`${Q.era?`${String(Q.era).charAt(0).toUpperCase()}${String(Q.era).slice(1)}`:"Protocol"} · ${Q.negotiated_version}`:"Not negotiated"}function ve(Q){return Q.discovered_count?`${Q.published_count||0} published · ${Q.excluded_count||0} excluded`:"No tools discovered"}const ye=f(new Set);async function xe(Q,Ee){if(ye.value.has(Q.name))return;const Ae=!!Ee.target.checked,Ne=new Set(ye.value);Ne.add(Q.name),ye.value=Ne;try{const ae=await H.post(`/api/mcp/servers/${encodeURIComponent(Q.name)}/enabled`,{enabled:Ae});ae&&Array.isArray(ae.servers)?e.value=ae:await Y({quiet:!0})}catch(ae){Ee.target.checked=!!Q.enabled,Te.error(ae.message||`Failed to toggle ${Q.name}`)}finally{const ae=new Set(ye.value);ae.delete(Q.name),ye.value=ae}}function He(Q,Ee){var Ne;i.value[Q]=Ee;const Ae=new Set(l.value);Ee===String((Ne=e.value)==null?void 0:Ne[Q])?Ae.delete(Q):Ae.add(Q),l.value=Ae,n.value=""}async function A(){if(s.value||!o.value||!l.value.size)return;const Q={};for(const Ee of l.value){const Ae=Number(i.value[Ee]),Ne=Ee==="max_published_tools_per_server"?128:256;if(!Number.isInteger(Ae)||Ae<1||Ae>Ne){n.value=`Enter a whole number between 1 and ${Ne}.`;return}Q[Ee]=Ae}a.value=!0,s.value=!0,n.value="",++E,t.value=!1;try{const Ee=await H.post("/api/mcp/limits",Q);e.value=Ee;for(const Ae of Object.keys(i.value))Number.isInteger(Ee[Ae])&&(i.value[Ae]=String(Ee[Ae]));l.value=new Set,Te.success("MCP limits saved. Applied at the next publication or tools refresh.")}catch(Ee){n.value=Ee.message||"Failed to save MCP publication limits"}finally{a.value=!1,s.value=!1,await Y({quiet:!0})}}async function P(Q){if(Q!==T.value&&!(!Q&&!await os({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await H.post("/api/mcp/enabled",{enabled:Q}),Te.success(Q?"MCP enabled":"MCP disabled"),await Y({quiet:!0})}catch(Ee){Te.error(Ee.message||"Failed to update MCP state"),await Y({quiet:!0})}finally{s.value=!1}}}async function q(Q){K(Q.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(Q.name)}/reconnect`,{}),Te.success(`Reconnected ${Q.name}`)}catch(Ee){Te.error(Ee.message||`Failed to reconnect ${Q.name}`)}finally{K(Q.name,!1),await Y({quiet:!0})}}async function ue(Q){K(Q.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(Q.name)}/refresh-tools`,{}),Te.success(`Refreshed tools from ${Q.name}`),await de(Q.name,!0)}catch(Ee){Te.error(Ee.message||`Failed to refresh ${Q.name}`)}finally{K(Q.name,!1),await Y({quiet:!0})}}async function U(Q){if(await os({title:`Remove ${Q.name}`,message:`Remove this saved MCP server? Its ${Q.published_count||0} published tool${Q.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){K(Q.name,!0);try{await H.del(`/api/mcp/servers/${encodeURIComponent(Q.name)}`),Te.success(`Removed ${Q.name}`),delete p.value[Q.name]}catch(Ae){Te.error(Ae.message||`Failed to remove ${Q.name}`)}finally{K(Q.name,!1),await Y({quiet:!0})}}}async function Z(Q){const Ee=new Set(d.value);if(Ee.has(Q.name)){Ee.delete(Q.name),d.value=Ee;return}Ee.add(Q.name),d.value=Ee,Object.hasOwn(p.value,Q.name)||await de(Q.name)}async function de(Q,Ee=!1){if(!Ee&&Object.hasOwn(p.value,Q))return;const Ae=new Set(h.value);Ae.add(Q),h.value=Ae,m.value={...m.value,[Q]:""};try{const Ne=await H.get(`/api/mcp/servers/${encodeURIComponent(Q)}/tools`);p.value={...p.value,[Q]:Ne.tools||[]}}catch(Ne){m.value={...m.value,[Q]:Ne.message||"Failed to load tools"}}finally{const Ne=new Set(h.value);Ne.delete(Q),h.value=Ne}}function V(Q){return(p.value[Q]||[]).filter(Ee=>C1(Ee,u.value[Q]))}function te(Q,Ee){u.value={...u.value,[Q]:Ee}}function se(){I.value="add",k.value="",y.value=null,g.value=Mc(),x.value="",b.value=!0}function ge(Q){I.value="edit",k.value=Q.name,y.value=Q,g.value={...Mc(),name:Q.name,enabled:!!Q.enabled,transport:Q.transport||"stdio"},x.value="",b.value=!0}function me(){_.value||(b.value=!1)}function ke(Q){b.value&&E1(Q)}function we(Q){const Ee=Q==="headers"?"headerRows":"envRows";g.value[Ee].push({key:"",value:""})}function be(Q,Ee){const Ae=Q==="headers"?"headerRows":"envRows";g.value[Ae].splice(Ee,1)}function Ke(Q,Ee){const Ae=Q==="headers"?"headersRemove":"envRemove",Ne=g.value[Ae];g.value[Ae]=Ne.includes(Ee)?Ne.filter(ae=>ae!==Ee):[...Ne,Ee]}async function je(){var Ee,Ae;x.value="";let Q;try{Q=w1(g.value,{mode:I.value,originalTransport:((Ee=y.value)==null?void 0:Ee.transport)||""})}catch(Ne){x.value=Ne instanceof aa?Ne.message:"Invalid MCP server configuration",await Ht(),(Ae=document.querySelector(".mcp-editor"))==null||Ae.scrollTo({top:0,behavior:"smooth"});return}if(!(I.value==="edit"&&k1(Q,y.value)&&!await os({title:`Change ${k.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){_.value=!0;try{I.value==="add"?await H.post("/api/mcp/servers",Q):await H.put(`/api/mcp/servers/${encodeURIComponent(k.value)}`,Q),Te.success(I.value==="add"?`Saved ${Q.name}`:`Updated ${k.value}`),b.value=!1,await Y({quiet:!0})}catch(Ne){x.value=Ne.message||"Failed to save MCP server"}finally{_.value=!1}}}let $e=null;function Ge(Q){`${(Q==null?void 0:Q.event)||""} ${(Q==null?void 0:Q.type)||""} ${(Q==null?void 0:Q.tool)||""} ${(Q==null?void 0:Q.message)||""}`.toLowerCase().includes("mcp")&&($e&&window.clearTimeout($e),$e=window.setTimeout(()=>Y({quiet:!0}),200))}function st(){R||(R=!0,w||(ct.subscribe("events",Ge),w=!0),Y(),le())}function Ye(){R=!1,z(),$e&&window.clearTimeout($e),$e=null,w&&(ct.unsubscribe("events",Ge),w=!1)}return tt(st),rs(st),Zt(Ye),wt(Ye),{status:e,loading:t,mutating:s,pageError:r,servers:B,masterEnabled:T,aggregate:F,limitsSaving:a,limitsError:n,limitsAvailable:o,limitDraft:i,limitDirty:l,editLimit:He,saveLimits:A,expandedServers:d,toolQueries:u,toolErrors:m,toolsLoading:h,editorOpen:b,editorMode:I,editingName:k,editingServer:y,form:g,formError:x,saving:_,editorGroups:O,configuredHeaderKeys:X,configuredEnvKeys:W,savedHttpEndpoint:M,endpointRequired:L,endpointFieldLabel:D,endpointPlaceholder:ie,refreshAll:Y,busy:oe,serverState:he,stateLabel:fe,transportLabel:J,protocolLabel:pe,toolSummary:ve,formatAge:I1,setMasterEnabled:P,togglePending:ye,toggleServerEnabled:xe,reconnect:q,refreshTools:ue,removeServer:U,toggleTools:Z,filteredTools:V,setToolQuery:te,openAdd:se,openEdit:ge,closeEditor:me,jumpToEditorGroup:ke,addSecretRow:we,removeSecretRow:be,toggleSecretRemoval:Ke,saveServer:je}}};function L1(e,t){if(!e||!t)return Tf(e);const s=Tf(e),a=t.trim().split(/\s+/).filter(Boolean);if(!a.length)return s;const n=a.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${n})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const N1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),m=f(!1),h=f(null),b=f(null);let I=null;const k=f(null),y=f(!1),g=f({}),x=f({}),_=f({}),S=f({}),E=new Map,R=f(null),w=j(()=>e.value.reduce((z,Y)=>z+(Y.chunks||0),0)),O=j(()=>new Set(e.value.map(Y=>Y.uploader).filter(Boolean)).size);function B(z,Y){const oe=x.value[Y];if(!oe||oe.length===0)return 0;const K=Math.max(...oe.map(he=>he.char_count||0));return K===0?0:Math.round(z.char_count/K*100)}async function T(){t.value=!0,s.value=null;try{const z=await H.get("/api/knowledge");e.value=Array.isArray(z)?z:[]}catch(z){s.value=z.message}t.value=!1}async function F(z){if(g.value[z]){g.value[z]=!1,R.value=null;return}if(g.value[z]=!0,Object.prototype.hasOwnProperty.call(x.value,z))return;if(E.has(z))return E.get(z);const Y={...S.value,[z]:!0};S.value=Y;const oe={..._.value};delete oe[z],_.value=oe;const K=H.get(`/api/knowledge/${encodeURIComponent(z)}/chunks`).then(he=>{x.value={...x.value,[z]:Array.isArray(he)?he:[]}}).catch(he=>{_.value={..._.value,[z]:he.message||"load failed"}}).finally(()=>{if(E.get(z)!==K)return;E.delete(z);const he={...S.value};delete he[z],S.value=he});return E.set(z,K),K}let X=0;async function W(){const z=a.value.trim();if(!z)return;const Y=++X;i.value=!0,o.value=null,l.value=z;try{const oe=await H.get(`/api/knowledge/search?q=${encodeURIComponent(z)}`);if(Y!==X)return;n.value=Array.isArray(oe)?oe:[]}catch(oe){if(Y!==X)return;n.value=[],o.value=oe.message||"Search failed"}Y===X&&(i.value=!1)}function M(){X+=1,i.value=!1,n.value=null,a.value="",o.value=null}async function L(){u.value=null,p.value=null;const z=c.value.trim(),Y=d.value.trim();if(!z){u.value="Source name is required";return}if(!Y){u.value="Content is required";return}m.value=!0;try{const oe=await H.post("/api/knowledge",{source:z,content:Y});p.value=`Ingested ${oe.chunks||0} chunks from "${z}"`,c.value="",d.value="",x.value={},await T(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(oe){u.value=oe.message}m.value=!1}async function D(z){h.value=z,b.value=null,I&&(clearTimeout(I),I=null);try{const Y=await H.post(`/api/knowledge/${encodeURIComponent(z)}/reingest`);b.value={source:z,error:!1,message:`Re-ingested ${Y.chunks||0} chunks`},delete x.value[z],await T(),I=setTimeout(()=>{b.value=null,I=null},3e3)}catch(Y){b.value={source:z,error:!0,message:Y.message}}h.value=null}function ie(z){k.value=z}async function le(){if(k.value){y.value=!0;try{await H.del(`/api/knowledge/${encodeURIComponent(k.value)}`),delete x.value[k.value],await T()}catch(z){Te.error(`Failed to delete source: ${z.message||"unknown error"}`)}y.value=!1,k.value=null}}return tt(()=>{T()}),{sources:e,loading:t,error:s,searchQuery:a,searchResults:n,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:m,reingesting:h,reingestResult:b,deleteTarget:k,deleting:y,expanded:g,sourceChunks:x,chunkErrors:_,loadingChunks:S,selectedChunk:R,totalChunks:w,uploaderCount:O,truncate:Lu,formatTs:ai,highlightTerms:L1,chunkBarWidth:B,fetchSources:T,toggleSource:F,doSearch:W,clearSearch:M,doIngest:L,doReingest:D,confirmDelete:ie,doDelete:le}}},M1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),a=f(null),n=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),m=f(""),h=f(!1),b=f(null),I=f(null),k=f(new Set),y=f(null),g=f(!1),x=f(!1),_=j(()=>e.value.reduce((Y,oe)=>Y+oe.count,0)),S=j(()=>k.value.size);function E(Y){const oe=t.value[Y];if(!oe)return[];if(!l.value.trim())return oe;const K=l.value.trim().toLowerCase();return oe.filter(he=>he.key.toLowerCase().includes(K)||he.value&&he.value.toLowerCase().includes(K))}function R(Y,oe){return k.value.has(Y+"/"+oe)}function w(Y,oe){const K=Y+"/"+oe,he=new Set(k.value);he.has(K)?he.delete(K):he.add(K),k.value=he}function O(Y){const oe=t.value[Y];return!oe||oe.length===0?!1:oe.every(K=>k.value.has(Y+"/"+K.key))}function B(Y,oe){const K=t.value[Y];if(!K)return;const he=new Set(k.value);for(const fe of K){const J=Y+"/"+fe.key;oe?he.add(J):he.delete(J)}k.value=he}async function T(){s.value=!0,a.value=null;try{const Y=await H.get("/api/memory");e.value=Object.entries(Y).map(([oe,K])=>({name:oe,keys:K.keys||[],count:K.count||0}))}catch(Y){a.value=Y.message}s.value=!1}async function F(Y){if(n.value[Y]){n.value[Y]=!1;return}n.value[Y]=!0;const oe=e.value.find(he=>he.name===Y);if(!oe||t.value[Y]||i.value===Y)return;i.value=Y;let K;try{const fe=(await H.get(`/api/memory/${encodeURIComponent(Y)}`)).entries||{};K=oe.keys.map(J=>Object.prototype.hasOwnProperty.call(fe,J)?{key:J,value:fe[J]||"",failed:!1}:{key:J,value:"",failed:!0,error:"Not found in scope"})}catch(he){K=oe.keys.map(fe=>({key:fe,value:"",failed:!0,error:he.message||"Failed to load"}))}t.value[Y]=K,i.value=null}function X(Y,oe,K){p.value=Y+"/"+oe,m.value=K}async function W(Y,oe){h.value=!0,b.value=null;try{await H.put(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(oe)}`,{value:m.value});const K=t.value[Y];if(K){const he=K.find(fe=>fe.key===oe);he&&(he.value=m.value)}p.value=null}catch(K){b.value=`Failed to save: ${K.message||"unknown error"}`}h.value=!1}async function M(Y,oe){try{await navigator.clipboard.writeText(oe.value),I.value=Y+"/"+oe.key,setTimeout(()=>{I.value=null},1500)}catch{}}async function L(){d.value=null,u.value=null;const Y=r.value.scope.trim(),oe=r.value.key.trim(),K=r.value.value.trim();if(!Y){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!K){d.value="Value is required";return}c.value=!0;try{await H.put(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(oe)}`,{value:K}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await T(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(he){d.value=he.message}c.value=!1}function D(Y,oe){y.value={scope:Y,key:oe}}async function ie(){if(!y.value)return;g.value=!0,b.value=null;const{scope:Y,key:oe}=y.value;try{await H.del(`/api/memory/${encodeURIComponent(Y)}/${encodeURIComponent(oe)}`);const K=t.value[Y];K&&(t.value[Y]=K.filter(J=>J.key!==oe));const he=e.value.find(J=>J.name===Y);he&&(he.count--,he.keys=he.keys.filter(J=>J!==oe));const fe=new Set(k.value);fe.delete(Y+"/"+oe),k.value=fe}catch(K){b.value=`Failed to delete: ${K.message||"unknown error"}`}g.value=!1,y.value=null}function le(){x.value=!0}async function z(){g.value=!0,b.value=null;const Y=[];for(const oe of k.value){const K=oe.indexOf("/");Y.push({scope:oe.slice(0,K),key:oe.slice(K+1)})}try{await H.post("/api/memory/bulk-delete",{entries:Y}),k.value=new Set,t.value={},await T()}catch(oe){b.value=`Bulk delete failed: ${oe.message||"unknown error"}`}g.value=!1,x.value=!1}return tt(()=>{T()}),{scopes:e,scopeEntries:t,loading:s,error:a,expanded:n,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:m,saving:h,actionError:b,copied:I,selected:k,selectedCount:S,totalEntries:_,deleteTarget:y,deleting:g,showBulkDelete:x,fetchMemory:T,toggleScope:F,startEdit:X,doEdit:W,copyValue:M,doAdd:L,confirmDelete:D,doDelete:ie,confirmBulkDelete:le,doBulkDelete:z,isSelected:R,toggleSelect:w,isScopeAllSelected:O,toggleSelectAll:B,filteredEntries:E}}},D1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=f([]),t=f(null),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(!1),r=f(!1),c=f(null),d=f(!1),u=j(()=>[...new Set(e.value.map(S=>S.category))].sort()),p=j(()=>{const _={};return e.value.forEach(S=>{_[S.category]=(_[S.category]||0)+1}),_}),m=j(()=>n.value?e.value.filter(_=>_.category===n.value):e.value);function h(_){return _==="correction"?"badge-warning":_==="operational"?"badge-info":_==="preference"?"badge-success":"badge-info"}function b(_){i.value=_.key,l.value=_.content}async function I(_){try{await H.put("/api/learned/"+encodeURIComponent(_),{content:l.value}),i.value=null,Te.success("Entry updated"),await y()}catch(S){Te.error(S.message||"Failed to save entry")}}async function k(_){if(await os({title:"Delete learned entry",message:`Delete "${_}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/learned/"+encodeURIComponent(_)),Te.success("Entry deleted"),await y()}catch(E){Te.error(E.message||"Failed to delete entry")}}async function y(){s.value=!0,a.value=null;try{const _=await H.get("/api/learned");e.value=_.entries||[],t.value={last_reflection:_.last_reflection,count:_.count}}catch(_){a.value=_.message}s.value=!1}async function g(){var _;r.value=!1,c.value=null;try{const S=await H.get("/api/config");o.value=((_=S.learning)==null?void 0:_.enabled)===!0,r.value=!0}catch(S){c.value=S.status===403?"Administrator access is required to change automatic learning.":S.message||"Automatic learning state is unavailable."}}async function x(_){if(!(!r.value||d.value)){d.value=!0,c.value=null;try{if(await H.put("/api/config",{learning:{enabled:_}}),await g(),!r.value)return;Te.success(`Automatic learning ${o.value?"enabled":"disabled"}`)}catch(S){r.value=!1,c.value=S.status===403?"Administrator access is required to change automatic learning.":S.message||"Failed to change automatic learning."}finally{d.value=!1}}}return tt(()=>{y(),g()}),{entries:e,meta:t,loading:s,error:a,filterCat:n,editing:i,editContent:l,categories:u,catCounts:p,filtered:m,learningEnabled:o,configReady:r,configError:c,savingConfig:d,catBadge:h,formatTs:ai,startEdit:b,saveEdit:I,deleteEntry:k,fetchEntries:y,fetchLearningConfig:g,setLearningEnabled:x}}},wg=[{id:"tools",label:"Tools",component:v1},{id:"skills",label:"Skills",component:y1},{id:"mcp-servers",label:"MCP Servers",component:O1},{id:"knowledge",label:"Knowledge",component:N1},{id:"memory",label:"Memory",component:M1},{id:"learned",label:"Learned",component:D1}],P1={components:{TabbedPage:Xr},setup(){return{tabs:wg}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},$1={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},F1={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},U1={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},B1={template:`
    ...
    </div>`,setup(){const e=f({}),t=f(!0),s=f(null),a=f(!1),n=f(!1),i=j(()=>e.value.components||[]),l=j(()=>U1[e.value.overall]||"text-gray-400"),o=j(()=>e.value.overall==="healthy"?"success":e.value.overall==="degraded"?"warning":e.value.overall==="unhealthy"?"error":"minus"),r=j(()=>{const S=e.value.overall;return S==="healthy"?"All Systems Healthy":S==="degraded"?"Some Systems Degraded":S==="unhealthy"?"System Issues Detected":"Unknown"});function c(S){return $1[S]||"text-gray-400"}function d(S){return F1[S]||"info"}function u(S){return S==="ok"?"badge-success":S==="degraded"?"badge-warning":S==="down"?"badge-danger":"badge-info"}function p(S){return S==="closed"?"text-green-400":S==="half_open"?"text-yellow-400":S==="open"?"text-red-400":"text-gray-400"}function m(S){return S.replace(/_/g," ").replace(/\b\w/g,E=>E.toUpperCase())}function h(S){if(!S)return"—";try{return new Date(S).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return S}}function b(S){return S>=1e6?(S/1e6).toFixed(1)+"M":S>=1e3?(S/1e3).toFixed(1)+"K":String(S)}async function I(){n.value=!0;try{e.value=await H.get("/api/health/components"),s.value=null,a.value=!0}catch(S){s.value=S.message}finally{t.value=!1,n.value=!1}}function k(){t.value=!0,s.value=null,I()}let y=null,g=!1;function x(){g||(g=!0,I(),y||(y=setInterval(I,3e4)))}function _(){g&&(g=!1,y&&(clearInterval(y),y=null))}return tt(x),rs(x),Zt(_),wt(_),{data:e,hasData:a,loading:t,error:s,refreshing:n,components:i,overallColor:l,overallIcon:o,overallLabel:r,statusColor:c,statusIcon:d,badgeClass:u,circuitColor:p,formatName:m,formatTime:h,formatNumber:b,fetchHealth:I,retry:k}}},z1={template:`
...
`)}),e.splice(n,1,k)}e.length>s&&e.splice(0,e.length-s)}function Cd(e,t,s=new Date){var u,p;let a=e;if(_n(e)&&e.type==="log"&&"line"in e?a=e.line:_n(e)&&"payload"in e&&(a=e.payload),typeof a=="string")try{a=JSON.parse(a)}catch{}const n=_n(a)?a:null,i=n!=null&&n.timestamp?new Date(n.timestamp):s,l=Number.isNaN(i.getTime())?s:i,o=n?n.result_summary??n.detail??n.message??JSON.stringify(n):typeof a=="string"?a:JSON.stringify(a)??"",c=(n==null?void 0:n.error)||((u=n==null?void 0:n.metadata)==null?void 0:u.error)||(n==null?void 0:n.success)===!1||[n==null?void 0:n.status,(p=n==null?void 0:n.metadata)==null?void 0:p.status].some(m=>["failed","error","cancelled","denied","outcome_unknown"].includes(m))?"ERROR":eo(n==null?void 0:n.level).toUpperCase()||"INFO",d={id:t,record:n,ts:l.toLocaleTimeString(),_time:l,level:c,text:typeof o=="string"?o:JSON.stringify(o),tool:eo(n==null?void 0:n.tool_name),raw:n?null:o,attribution:G1(n)};return d.searchText=n?JSON.stringify(n):d.text,d}function K1(e){const t=new Map;for(const s of e){const{turnId:a,agentId:n,rootId:i,label:l,parentId:o}=s.attribution,r=a?`turn:${a}`:n?`root:${i||n}`:"unattributed";t.has(r)||t.set(r,{key:r,title:a?`Turn ${a}`:n?`Agent root ${i||n} (turn unavailable)`:"Unattributed / legacy records",count:0,sections:[],_sections:new Map});const c=t.get(r),d=n?`agent:${n}`:"main";if(!c._sections.has(d)){const u={key:d,agentId:n,label:l,parentId:o,rootId:i,title:n?`${l||"Agent"} (${n})`:"Main thread / turn events",entries:[]};c._sections.set(d,u),c.sections.push(u)}c._sections.get(d).entries.push(s),c.count++}return[...t.values()].map(({_sections:s,...a})=>a)}const J1={components:{ToolOutput:ec},props:{entry:{type:Object,required:!0}},emits:["copy"],setup(e){const t=j(()=>q1(e.entry)),s=j(()=>{var o;return Xl(((o=e.entry.record)==null?void 0:o.tool_input)??"")}),a=j(()=>{var o,r,c;return Xl(((o=e.entry.record)==null?void 0:o.error)||((c=(r=e.entry.record)==null?void 0:r.metadata)==null?void 0:c.error)||"")}),n=j(()=>V1(e.entry.record)),i=j(()=>kg(e.entry)),l=j(()=>(e.entry.events||[e.entry.record]).filter(Boolean).map(o=>{var r;return{type:o.type||"execution",timestamp:o.timestamp||"Time not recorded",status:o.status||((r=o.metadata)==null?void 0:r.status)||""}}));return{display:t,argumentsText:s,errorText:a,metadataText:n,rawRecord:i,lifecycle:l}},template:`
    ...
    </div>`,setup(){const e=f("live"),t=f([]);let s=0;const a=f(!1),n=f(!1),i=f(!0),l=f(""),o=f(""),r=f(!1),c=f(!1),d=f(ct.state||"disconnected"),u=j(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),p=f(null),m=f(!1),h=f(null),b=2e3,I=Z1,k=Y1,y=Dc,g=f("all"),x=f(""),_=f([]),S=f(!1),E=f(""),R=f([]);function w(){try{const re=localStorage.getItem("odin-log-presets");re&&(_.value=JSON.parse(re))}catch{}}function O(){try{localStorage.setItem("odin-log-presets",JSON.stringify(_.value))}catch{}}const B=j(()=>l.value!==""||o.value.trim()!==""||x.value!==""),T=j(()=>{const re=Dc.find(Ie=>Ie.value===x.value);return re?re.label:""}),F=j(()=>{if(!r.value||!o.value)return null;try{return new RegExp(o.value,"i"),null}catch(re){return re.message}}),X=24,W=j(()=>{if(Y.value.length===0)return[];const re=[],Ie=new Date,Be=3600*1e3;for(let nt=X-1;nt>=0;nt--){const kt=new Date(Ie.getTime()-(nt+1)*Be),ut=new Date(Ie.getTime()-nt*Be);re.push({start:kt,end:ut,label:ie(kt,ut),shortLabel:ut.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const nt of Y.value){if(!nt._time)continue;const kt=nt._time.getTime();for(const ut of re)if(kt>=ut.start.getTime()&&kt<ut.end.getTime()){ut.total++,nt.level==="ERROR"?ut.errors++:nt.level==="WARNING"?ut.warnings++:ut.info++;break}}return re}),M=j(()=>{let re=1;for(const Ie of W.value)Ie.total>re&&(re=Ie.total);return re}),L=j(()=>{if(W.value.length===0)return"";const re=Y.value.map(nt=>nt._time&&nt._time.getTime()).filter(Boolean);if(re.length===0)return"";const Ie=new Date(Math.min(...re));return`${Y.value.length} shown, oldest ${Ie.toLocaleTimeString()}`}),D=j(()=>Math.ceil(X/8));function ie(re,Ie){const Be={hour:"2-digit",minute:"2-digit"};return re.toLocaleTimeString([],Be)+" - "+Ie.toLocaleTimeString([],Be)}function le(re,Ie){return!Ie||!re?"0px":Math.max(2,re/Ie*100)+"%"}function z(re){const Ie=Y.value.findIndex(Be=>Be._time&&Be._time.getTime()>=re.start.getTime()&&Be._time.getTime()<re.end.getTime());if(Ie>=0&&p.value){const Be=p.value.querySelector('[data-log-id="'+Y.value[Ie].id+'"]');Be&&(Be.scrollIntoView({behavior:"smooth",block:"center"}),i.value=!1)}}const Y=j(()=>{let re=t.value;if(l.value&&(re=re.filter(Ie=>(Ie.level||"INFO")===l.value)),x.value){const Ie=Dc.find(Be=>Be.value===x.value);if(Ie&&Ie.seconds){const Be=new Date(Date.now()-Ie.seconds*1e3);re=re.filter(nt=>nt._time&&nt._time>=Be)}}if(o.value&&!F.value)if(r.value)try{const Ie=new RegExp(o.value,"i");re=re.filter(Be=>{const nt=Be.searchText,kt=Be.tool||"";return Ie.test(nt)||Ie.test(kt)})}catch{}else{const Ie=o.value.toLowerCase();re=re.filter(Be=>{const nt=Be.searchText.toLowerCase(),kt=(Be.tool||"").toLowerCase();return nt.includes(Ie)||kt.includes(Ie)})}return re}),oe=j(()=>K1(Y.value));function K(re){const Ie=Cd(re,++s);if(n.value){R.value.push(Ie);return}he(Ie)}function he(re){W1(t.value,re,b),i.value&&Ht(()=>fe())}function fe(re=!1){const Ie=p.value;Ie&&Ie.scrollTo({top:Ie.scrollHeight,behavior:re?"smooth":"instant"})}function J(){i.value=!0,m.value=!1,Ht(()=>fe(!0))}const pe=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function ve(){const re=p.value;if(!re)return;const Ie=re.scrollHeight-re.scrollTop-re.clientHeight<40;m.value=!i.value&&!Ie&&t.value.length>0,A.value&&ye()}function ye(){const re=p.value;!re||!i.value||re.scrollHeight-re.scrollTop-re.clientHeight>=40&&(i.value=!1,m.value=t.value.length>0)}function xe(){i.value&&requestAnimationFrame(ye)}function He(re){pe.has(re.key)&&xe()}const A=f(!1);function P(){i.value&&(A.value=!0,requestAnimationFrame(ye))}function q(){A.value&&(A.value=!1,ye())}function ue(){i.value&&(m.value=!1,Ht(()=>fe()))}function U(){if(n.value=!n.value,!n.value&&R.value.length>0){for(const re of R.value)he(re);R.value=[]}}function Z(){t.value=[],R.value=[],m.value=!1}function de(){let re;e.value==="search"?re=Ue.value.map(kt=>{const ut=kt.error?"ERROR":"INFO",ba=kt.tool_name?`[${kt.tool_name}] `:"";return`${kt.timestamp||""} ${ut} ${ba}${kt.result_summary||kt.message||""}`}).join(`
`):re=Y.value.map(Nf).join(`

`);const Ie=new Blob([re],{type:"text/plain"}),Be=URL.createObjectURL(Ie),nt=document.createElement("a");nt.href=Be,nt.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,nt.click(),URL.revokeObjectURL(Be)}function V(re){const Ie=Nf(re);navigator.clipboard.writeText(Ie).then(()=>{h.value=re.id,setTimeout(()=>{h.value=null},1500)}).catch(()=>{})}function te(re){l.value=l.value===re?"":re,g.value="all"}function se(re){return re.level==="ERROR"?"log-line-error":re.level==="WARNING"?"log-line-warning":"text-gray-300"}function ge(re){return re==="ERROR"?"text-red-500 font-semibold":re==="WARNING"?"text-yellow-500":"text-blue-500"}function me(re){return re==="ERROR"?"log-chip-error":re==="WARNING"?"log-chip-warning":"log-chip-info"}function ke(re){g.value=re.id;const Ie=re.filters;l.value=Ie.level||"",x.value=Ie.timeRange||"",o.value=Ie.text||"",Ie.levels&&(l.value=Ie.levels[0]||""),Ie.hasToolName&&(o.value="")}function we(re){g.value=re.id,l.value=re.filters.level||"",x.value=re.filters.timeRange||"",o.value=re.filters.text||""}function be(){if(!E.value.trim())return;const re={id:"custom-"+Date.now(),name:E.value.trim(),filters:{level:l.value,timeRange:x.value,text:o.value}};_.value=[..._.value,re],O(),S.value=!1,E.value=""}function Ke(re){_.value=_.value.filter(Ie=>Ie.id!==re),O(),g.value===re&&(g.value="all")}const je=f("all"),$e=f(""),Ge=f(""),st=f(""),Ye=f(""),Q=f(""),Ee=f(100),Ae=Q1,Ne=f(!1),ae=f(!1),Le=f(""),Ue=f([]),dt=f(null),Ut=f(null);function ft(){e.value="search",dt.value||yt()}async function yt(){try{dt.value=await H.get("/api/logs/stats")}catch{}}function Qt(){const re=Q.value;if(!re){st.value="",Ye.value="";return}const Be={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[re];if(Be){const nt=new Date(Date.now()-Be*1e3);st.value=cs(nt),Ye.value=""}}function cs(re){const Ie=Be=>String(Be).padStart(2,"0");return`${re.getFullYear()}-${Ie(re.getMonth()+1)}-${Ie(re.getDate())}T${Ie(re.getHours())}:${Ie(re.getMinutes())}`}function Xs(re){if(!re)return"";const Ie=new Date(re);return isNaN(Ie.getTime())?"":Ie.toISOString()}async function ea(){Ne.value=!0,Le.value="",ae.value=!0,Ut.value=null;try{const re=new URLSearchParams;je.value&&je.value!=="all"&&re.set("level",je.value),$e.value&&re.set("tool",$e.value),Ge.value&&re.set("q",Ge.value);const Ie=Xs(st.value),Be=Xs(Ye.value);Ie&&re.set("start",Ie),Be&&re.set("end",Be),re.set("limit",String(Ee.value));const nt=await H.get(`/api/logs/search?${re.toString()}`);Ue.value=nt.entries||[]}catch(re){Le.value=re.message||"Search failed",Ue.value=[]}finally{Ne.value=!1}}function Qe(){je.value="all",$e.value="",Ge.value="",st.value="",Ye.value="",Q.value="",Ee.value=100,Ue.value=[],ae.value=!1,Le.value="",Ut.value=null}function ca(re){Ut.value=Ut.value===re?null:re}function hs(re){if(!re.timestamp)return"";try{return new Date(re.timestamp).toLocaleString()}catch{return re.timestamp}}function Ns(re){return re.type==="web_action"?`${re.status||""} (${re.execution_time_ms||0}ms)`:(re.result_summary||"").slice(0,200)}function vs(re){return re.error?"log-line-error":"text-gray-300"}function Tn(re){try{return JSON.stringify(re,null,2)}catch{return String(re)}}let Mt=null,vt=!1;function Ms(){vt||(vt=!0,ct.subscribe("logs",K),c.value=ct.connected,d.value=ct.state||"disconnected",Mt=ct.onState(re=>{d.value=re,c.value=re==="connected"}))}function rn(){vt&&(vt=!1,ct.unsubscribe("logs",K),Mt&&(Mt(),Mt=null))}return tt(()=>{w(),window.addEventListener("pointerup",q),window.addEventListener("pointercancel",q)}),rs(Ms),Zt(rn),wt(()=>{rn(),window.removeEventListener("pointerup",q),window.removeEventListener("pointercancel",q)}),{mode:e,logs:t,paused:n,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:a,groupedLogs:oe,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:Y,pauseBuffer:R,showJumpBottom:m,copiedIndex:h,regexError:F,levels:I,logPresets:k,timeRanges:y,timeRange:x,activeLogPreset:g,customLogPresets:_,showSaveLogPreset:S,newLogPresetName:E,hasActiveLogFilters:B,timeRangeLabel:T,timelineBuckets:W,timelineMax:M,timelineSpanLabel:L,timelineLabelSkip:D,togglePause:U,clearLogs:Z,exportLogs:de,logLineClass:se,levelClass:ge,levelChipClass:me,toggleLevel:te,copyLine:V,jumpToBottom:J,onScroll:ve,onUserScrollIntent:xe,onUserScrollKey:He,onAutoScrollToggle:ue,onPointerDown:P,applyLogPreset:ke,applyCustomLogPreset:we,saveLogCustomPreset:be,removeLogCustomPreset:Ke,segmentHeight:le,jumpToTimelineBucket:z,searchLevel:je,searchTool:$e,searchKeyword:Ge,searchStart:st,searchEnd:Ye,searchTimePreset:Q,searchLimit:Ee,searchLimits:Ae,searching:Ne,searchRan:ae,searchError:Le,searchResults:Ue,searchStats:dt,expandedSearch:Ut,switchToSearch:ft,runSearch:ea,clearSearchFilters:Qe,toggleSearchExpand:ca,formatSearchTs:hs,searchEntryText:Ns,searchLogLineClass:vs,formatJson:Tn,applySearchTimePreset:Qt}}};function Lo(e=[]){const t=[],s=new Set;function a(n){const i=[n.kind,n.label,n.apply_mode||"",n.code||"",n.text||""].join("\0");s.has(i)||(s.add(i),t.push({...n,key:i}))}for(const n of e)for(const i of(n==null?void 0:n.consumers)||[])a({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const n of e)n!=null&&n.apply_handler&&a({kind:"handler",label:"Apply handler",code:n.apply_handler});for(const n of e)n!=null&&n.restart_reason&&a({kind:"restart",label:"Why a restart is required",text:n.restart_reason});for(const n of e)n!=null&&n.activation_policy&&a({kind:"activation",label:"Activation policy",text:n.activation_policy});return t}const eC=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function tC(e,t={}){var n,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),a=Object.hasOwn(t,"fallback")?t.fallback:(n=globalThis.document)==null?void 0:n.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return a&&a.scrollHeight>a.clientHeight?a:e||a||null}const $i=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["grafana_alerts","outbound_webhooks"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],sC={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},No=new Set(["llm_provider","openai_codex","ollama","openai_compatible","kimi","personality","discord","computer"]),aC=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Df(e){return aC.some(t=>e===t||e.startsWith(`${t}.`))}const Sg="odin_config_center_expanded_v1",Cg="odin_config_center_category_v1",nC=50,iC=650,ml=()=>H.get("/api/config/meta");function Un(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ei(e,t){return JSON.stringify(e)===JSON.stringify(t)}function bi(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function lC(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function oC(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Tg(e,t){if(Ei(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Un(t);const a={};for(const[n,i]of Object.entries(t)){const l=Tg(e[n],i);l!==void 0&&(a[n]=l)}return Object.keys(a).length?a:void 0}function rC(e,t){const s={};for(const[a,n]of Object.entries(t||{})){const i=Tg(e==null?void 0:e[a],n);i!==void 0&&(s[a]=i)}return s}function Eg(e,t,s,a){if(Ei(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Eg(e[l],t[l],s?`${s}.${l}`:l,a);return}a.push({path:s,oldVal:e,newVal:t})}function cC(){try{const e=JSON.parse(localStorage.getItem(Sg)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function dC(){try{const e=localStorage.getItem(Cg);return $i.some(t=>t.key===e)?e:$i[0].key}catch{return $i[0].key}}const uC={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),a=f(null),n=f(!1),i=f(null),l=f(!1),o=f(""),r=f(!1),c=f(""),d=f(""),u=f("");function p(C){i.value=C||null,C&&typeof C.authorized=="boolean"&&(l.value=C.authorized)}async function m(){try{const C=await H.get("/api/setup/status");p(C.listener),u.value=""}catch(C){p(null),u.value=`Listener status could not be loaded: ${C.message||"Unknown error"}`}}async function h(){if(!(!ue.value||!o.value.trim()||r.value||q.value)){r.value=!0,c.value="",d.value="";try{const C=H.setListenerExposure(o.value.trim(),l.value);o.value="";const G=await C;c.value=G.message,p(G.listener)}catch(C){d.value=C.message||"Listener consent could not be saved."}finally{o.value="",r.value=!1}}}const b=f(null),I=["image_model","outer_model"],k=f(null),y=f(null),g=f(null),x=f(!1),_=f(!1),S=f(null),E=f(""),R=f("all"),w=f(dC()),O=f(cC()),B=f({}),T=f({}),F=f(""),X=f({}),W=f({}),M=f([]),L=f([]),D=f(!1),ie=f(!1),le=f(!1);let z=null,Y=null,oe={path:null,at:0},K=0;const he=j(()=>{var C;return(((C=t.value)==null?void 0:C.fields)||[]).filter(G=>!No.has(G.path.split(".")[0])&&!Df(G.path))}),fe=j(()=>new Map(he.value.map(C=>[C.path,C]))),J=j(()=>He.value.reduce((C,G)=>C+G.sections.length,0)),pe=j(()=>he.value.length),ve=j(()=>eC),ye=j(()=>M.value.length>0),xe=j(()=>L.value.length>0),He=j(()=>{if(!e.value)return[];const C=new Set($i.flatMap(Se=>Se.sections)),G=$i.map(Se=>({...Se,sections:Se.sections.filter(We=>Object.hasOwn(e.value,We)&&!No.has(We))})).filter(Se=>Se.sections.length),ne=Object.keys(e.value).filter(Se=>!C.has(Se)&&!No.has(Se));return ne.length&&G.push({key:"other",label:"Other",icon:"folder",sections:ne}),G}),A=j(()=>e.value?{...e.value,...B.value}:null),P=j(()=>{if(!e.value)return[];const C=[];for(const[G,ne]of Object.entries(B.value))Eg(e.value[G],ne,G,C);return C.filter(G=>!Ei(G.oldVal,G.newVal)).map(G=>{const ne=st(G.path);return{...G,label:(ne==null?void 0:ne.label)||bi(G.path.split(".").at(-1)),apply_mode:(ne==null?void 0:ne.apply_mode)||Le(G.path.split(".")[0])}})}),q=j(()=>P.value.length>0),ue=j(()=>!!i.value&&l.value!==i.value.authorized),U=j(()=>{var G;const C=(G=i.value)==null?void 0:G.state;return C==="active"||C==="authorized_loopback"?"active":["pending_widening","pending_narrowing","active_rebind_pending"].includes(C)?"pending":C==="restricted"?"restricted":"unknown"}),Z=j(()=>{var C;return{active:"Exposure active",authorized_loopback:"Authorized · loopback host",pending_widening:"Authorized · restart pending",pending_narrowing:"Restriction saved · restart pending",active_rebind_pending:"Exposed · restart pending",restricted:"Loopback only",unknown:"Runtime state unavailable"}[(C=i.value)==null?void 0:C.state]||"Loading listener state"}),de=j(()=>i.value?i.value.authorized?i.value.authorization_source==="explicit"?"Beyond-loopback access is explicitly authorized":"Beyond-loopback access is retained from this installation":"Beyond-loopback access is not authorized":"Unavailable"),V=j(()=>{var C;return{explicit:"saved explicitly in config.yml",default:"schema default; no web.host key is saved",unknown:"source could not be verified"}[(C=i.value)==null?void 0:C.configured_host_source]||"source unavailable"}),te=j(()=>{const C=i.value;return!C||C.running_scope==="unavailable"?"Actual bound address unavailable":`${(C.listening_hosts||[]).map((ne,Se)=>{var Ct;const We=(Ct=C.listening_ports)==null?void 0:Ct[Se];return We?`${ne}:${We}`:ne}).join(", ")} · ${C.running_scope==="loopback"?"loopback only":"accepting beyond loopback"}`}),se=j(()=>P.value.length),ge=j(()=>new Set(P.value.map(C=>C.path.split(".")[0])).size),me=j(()=>!!E.value||R.value!=="all"),ke=j(()=>{const C={...W.value};for(const G of P.value){const ne=st(G.path),Se=ce(ne,G.newVal);Se&&(C[G.path]=Se)}return C}),we=j(()=>Object.keys(ke.value).length>0),be=j(()=>e.value?(me.value?He.value:He.value.filter(G=>G.key===w.value)).map(G=>({...G,sections:G.sections.filter(ne=>Mt(ne))})).filter(G=>G.sections.length):[]),Ke=j(()=>{const C=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],G=new Map(C.map(ne=>[ne,[]]));for(const ne of P.value){const Se=G.has(ne.apply_mode)?ne.apply_mode:"restart";G.get(Se).push(ne)}return C.filter(ne=>G.get(ne).length).map(ne=>({key:ne,label:gs(ne),entries:G.get(ne)}))}),je=j(()=>P.value.filter(C=>C.apply_mode==="restart").length),$e=j(()=>he.value.filter(C=>C.pending_restart)),Ge=j(()=>$e.value.length);function st(C){const G=fe.value.get(C);return G?{...G,apply_details:Lo([G])}:null}function Ye(C){const G=`${C}.`;return he.value.filter(ne=>ne.path===C||ne.path.startsWith(G))}function Q(){return he.value.some(C=>C.path==="tools.hosts"||C.path.startsWith("tools.hosts."))}function Ee(){var ne,Se;const C=((Se=(ne=e.value)==null?void 0:ne.tools)==null?void 0:Se.hosts)||{},G=Object.keys(C).length;return`${G} host${G===1?"":"s"} configured.`}function Ae(C){return Ye(C).length}function Ne(C){return bi(C)}function ae(C){const G=Ye(C);if(!G.length)return`${bi(C)} configuration.`;const ne=G.find(Ct=>Ct.sensitivity==="public"&&Ct.description)||G.find(Ct=>Ct.description),Se=(ne==null?void 0:ne.description)||"";return Se.match(/setting for (.+)\.$/i)?`${bi(C)} settings and runtime behaviour.`:Se}function Le(C){const G=[...new Set(Ye(C).map(ne=>ne.apply_mode))];return G.length===1?G[0]:G.includes("restart")?"restart":G.includes("activation_required")?"activation_required":G[0]||"restart"}function Ue(C){const G=[...new Set(Ye(C).map(ne=>gs(ne.apply_mode)))];return G.length?G.length===1?G[0]:`Mixed apply behaviour: ${G.join(" · ")}`:""}function dt(C){return Lo(Ye(C))}function Ut(C){var G;return Object.hasOwn(B.value,C)?B.value[C]:(G=e.value)==null?void 0:G[C]}function ft(){const C=Ut("mcp")||{},G=Object.keys(C.servers||{}).length;return`${C.enabled?"Globally enabled":"Globally disabled"} · ${G} configured server${G===1?"":"s"}.`}function yt(C,G){return G.split(".").reduce((ne,Se)=>ne==null?void 0:ne[Se],C)}function Qt(C){const G=A.value;return Ye(C).filter(ne=>Df(ne.path)?!1:ne.path.split(".").length<=2?!0:!ne.path.includes(".*")).map(ne=>({...ne,key:ne.path.split(".").at(-1),value:yt(G,ne.path),apply_details:Lo([ne]),editor:ne.path==="agents.final_warning_iterations"?"warning-chips":null}))}function cs(C){const G=C.path.split(".");return G.length>2?G.slice(0,2).join("."):null}function Xs(C){const G=new Map;for(const ne of Qt(C)){const Se=cs(ne),We=Se||`${C}.__root`;G.has(We)||G.set(We,{key:We,path:Se,entries:[]}),G.get(We).entries.push(ne)}return[...G.values()].map(ne=>{const Se=ne.entries.find(We=>We.group_description);return{...ne,label:ne.path?bi(ne.path.split(".").at(-1)):null,description:(Se==null?void 0:Se.group_description)||null,apply_details:Lo(ne.entries),runtime_summaries:Qe(ne.entries)}})}function ea(C){return{save:C.save_effect||(C.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:C.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[C.apply_mode]||"Effective runtime state is not currently observable."}}function Qe(C){const G=new Map;for(const ne of C){const Se=ea(ne),We=`${ne.apply_mode}|${Se.save}|${Se.runtime}`;G.has(We)||G.set(We,{key:We,label:gs(ne.apply_mode),save:Se.save,runtime:Se.runtime})}return[...G.values()]}function ca(C){if(hs(C))return C.runtime_effect||C.activation_policy||"";if(C.apply_mode==="activation_required"){const G=C.activation_policy||C.runtime_effect;return G?`Not active after saving. No activation control exists in this release. ${G}`:"Not active after saving; no activation control exists in this release."}return""}function hs(C){return C.action_available===!0&&!!(C.action_label&&C.action_endpoint)}async function Ns(C){if(hs(C))try{if(Ie(C.path))throw new Error("Save this setting before applying its action.");const G=String(C.action_method||"POST").toLowerCase(),ne={post:H.post.bind(H),put:H.put.bind(H),delete:H.del.bind(H)}[G];if(!ne)throw new Error("Unsupported configuration action");await ne(C.action_endpoint,C.action_body||void 0),await Xi(),Ma("success",`${C.action_label} completed.`)}catch(G){Ma("error",G.message||`${C.action_label} failed`)}}function vs(C,G){return[C.label,C.path,C.description,...C.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(G)}function Tn(C){const G=E.value.trim().toLowerCase();return G?Ye(C).filter(ne=>vs(ne,G)):[]}function Mt(C){const G=Ye(C);if(R.value!=="all"&&!G.some(Se=>Se.apply_state===R.value))return!1;const ne=E.value.trim().toLowerCase();return!ne||`${Ne(C)} ${C}`.toLowerCase().includes(ne)?!0:G.some(Se=>vs(Se,ne))}function vt(C,G){return Ye(C).filter(ne=>ne.apply_state===G).length}function Ms(C){return C==="all"?pe.value:he.value.filter(G=>G.apply_state===C).length}function rn(C){const G=C.sections.flatMap(ne=>Ye(ne));return{fields:G.length,modified:P.value.filter(ne=>C.sections.includes(ne.path.split(".")[0])).length,pending_restart:G.filter(ne=>ne.apply_state==="pending_restart").length,invalid:G.filter(ne=>ne.apply_state==="invalid").length,dormant:G.filter(ne=>ne.apply_state==="dormant").length}}function re(C){var G;return Object.hasOwn(B.value,C)&&!Ei((G=e.value)==null?void 0:G[C],B.value[C])}function Ie(C){return P.value.some(G=>G.path===C||G.path.startsWith(`${C}.`))}function Be(C){w.value=C,E.value="",R.value="all";try{localStorage.setItem(Cg,C)}catch{}}function nt(C){R.value=C}function kt(){E.value="",R.value="all"}function ut(C){var G;return((G=He.value.find(ne=>ne.sections.includes(C)))==null?void 0:G.sections)||[]}function ba(C){const G=ut(C),ne=G.find(Se=>O.value[Se]===!0);return ne||G.find(Se=>O.value[Se]!==!1)||null}function Ds(C){return E.value&&!le.value&&Mt(C)?!0:le.value?ba(C)===C:Object.hasOwn(O.value,C)?O.value[C]===!0:!0}function ii(C){const G=!Ds(C);if(le.value){const ne={...O.value};for(const Se of ut(C))ne[Se]===!0&&(ne[Se]=!1);ne[C]=G,O.value=ne;return}O.value={...O.value,[C]:G}}function En(){M.value.push(Un(B.value)),M.value.length>nC&&M.value.shift(),L.value=[]}function cn(){n.value||q.value&&(En(),B.value={},W.value={},D.value=!1)}function An(C,G=!1){const ne=Date.now();if(G&&oe.path===C&&ne-oe.at<iC){oe.at=ne;return}En(),oe={path:C,at:ne}}function da(C,G,ne){if(!G.length)return ne;const Se=Un(C??{});let We=Se;for(let Ct=0;Ct<G.length-1;Ct+=1){const Vs=G[Ct];We[Vs]=Un(We[Vs]??{}),We=We[Vs]}return We[G.at(-1)]=ne,Se}function ya(C){var G;return Object.hasOwn(B.value,C)?B.value[C]:Un((G=e.value)==null?void 0:G[C])}function Vt(C,G,ne={}){var un;if(n.value||No.has(C.path.split(".")[0]))return;const[Se,...We]=C.path.split(".");An(C.path,!!ne.coalesce);const Ct=ya(Se),Vs=We.length?da(Ct,We,G):G,qs={...B.value};if(Ei(Vs,(un=e.value)==null?void 0:un[Se])?delete qs[Se]:qs[Se]=Vs,B.value=qs,W.value[C.path]){const xa={...W.value};delete xa[C.path],W.value=xa}}function ua(C){oe={path:null,at:0},T.value={...T.value,[C]:String(yt(A.value,C)??"")}}function as(C){if(oe={path:null,at:0},!Object.hasOwn(T.value,C))return;const G={...T.value};delete G[C],T.value=G}function dn(C){const G=T.value[C.path];if(oe={path:null,at:0},G===""){if(C.nullable){as(C.path),Vt(C,null,{coalesce:!0});return}W.value={...W.value,[C.path]:"Enter a number."};return}const ne=Number(G);if(Number.isNaN(ne)||C.type==="integer"&&!Number.isInteger(ne)){W.value={...W.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Se={...T.value};delete Se[C.path],T.value=Se,Vt(C,ne,{coalesce:!0})}function Rn(C){return Object.hasOwn(T.value,C.path)?T.value[C.path]:C.value??""}function li(C,G){if(T.value={...T.value,[C.path]:G},G===""){if(C.nullable){Vt(C,null,{coalesce:!0});return}W.value={...W.value,[C.path]:"Enter a number."};return}const ne=Number(G);if(!Number.isFinite(ne)||C.type==="integer"&&!Number.isInteger(ne)){W.value={...W.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(W.value[C.path]){const Se={...W.value};delete Se[C.path],W.value=Se}Vt(C,ne,{coalesce:!0})}function oi(C){const G=Number.parseInt(F.value,10);if(!Number.isInteger(G)||G<1){W.value={...W.value,[C.path]:"Warning thresholds must be positive whole numbers."};return}const ne=[...new Set([...C.value||[],G])].sort((Se,We)=>We-Se);F.value="",Vt(C,ne)}function ri(C,G){Vt(C,(C.value||[]).filter(ne=>ne!==G))}function ns(C){return C.apply_mode==="live_read"?"Odin reads the saved file value on next use.":C.apply_mode==="live_for_new_work"?"New work uses the saved file value.":C.apply_mode==="live_apply"?C.apply_handler?`Apply the saved value through ${C.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":C.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":C.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":C.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function In(C){return C.type==="array"&&Array.isArray(C.value)&&!C.structured_container&&!C.structured_container_child&&C.sensitivity==="public"&&C.value.every(G=>["string","number","boolean"].includes(typeof G))}function Re(C){const G=String(X.value[C.path]??"").trim();if(!G)return;const ne=[...new Set([...C.value||[],G])];X.value={...X.value,[C.path]:""},Vt(C,ne)}function N(C,G){Vt(C,(C.value||[]).filter(ne=>ne!==G))}function ce(C,G){var Se;if(!C)return null;if((Se=C.enum)!=null&&Se.length&&!C.enum.includes(G))return`Choose one of: ${C.enum.join(", ")}`;if(C.path==="agents.final_warning_iterations"&&(!Array.isArray(G)||!G.length))return"Add at least one warning threshold.";const ne=C.constraints||{};if((C.type==="integer"||C.type==="number")&&typeof G=="number"){if(ne.minimum!==void 0&&G<ne.minimum)return`Must be at least ${ne.minimum}${C.unit?` ${C.unit}`:""}`;if(ne.maximum!==void 0&&G>ne.maximum)return`Must be at most ${ne.maximum}${C.unit?` ${C.unit}`:""}`}return null}function _e(C){return ke.value[C.path]||null}function Fe(C){const G=`${C}.`;return Object.keys(ke.value).some(ne=>ne===C||ne.startsWith(G))}function qe(){n.value||M.value.length&&(L.value.push(Un(B.value)),B.value=M.value.pop(),W.value={},T.value={},oe={path:null,at:0})}function Ze(){n.value||L.value.length&&(M.value.push(Un(B.value)),B.value=L.value.pop(),W.value={},T.value={},oe={path:null,at:0})}function Et(){!q.value||we.value||(D.value=!0,ie.value=!1)}function pt(){D.value=!1}function At(){cn()}function gs(C){return sC[C]||bi(C||"unknown")}function Nt(C){return`apply-${String(C||"unknown").replaceAll("_","-")}`}function Na(C){return`cfgc-field-${C.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function ci(C){return`${Na(C)}-input`}function mo(C){const G=document.getElementById(Na(C))||document.getElementById(Na(C.split(".").slice(0,2).join(".")));G==null||G.scrollIntoView({behavior:"smooth",block:"center"})}function Ma(C,G){y.value={type:C,message:G},window.setTimeout(()=>{var ne;((ne=y.value)==null?void 0:ne.message)===G&&(y.value=null)},3500)}function ac(){x.value=!1,R.value="pending_restart",E.value="";const C=tC(a.value);C&&(C.scrollTop=0)}function ho(){x.value=!1}function di(C=1800){Y&&window.clearTimeout(Y),Y=window.setTimeout(nc,C)}async function nc(){if(_.value){if(K+=1,K>45){_.value=!1,S.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await ml(),Ge.value===0){_.value=!1,S.value=null,Ma("success","Odin restarted and the saved startup settings are active.");return}}catch{}di(2e3)}}async function On(){if(!_.value){S.value=null;try{await H.post("/api/restart",{}),_.value=!0,K=0,x.value=!1,di()}catch(C){S.value=C.message||"Odin could not schedule a restart."}}}async function ic(){if(!(!q.value||we.value||n.value)){n.value=!0;try{const C=rC(e.value,B.value),G=await H.put("/api/config",C);e.value=G,B.value={},M.value=[],L.value=[],W.value={},D.value=!1;try{t.value=await ml(),g.value=null,x.value=Ge.value>0,Ma("success",Ge.value?`Configuration saved. ${Ge.value} setting${Ge.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(ne){g.value=ne.message||"Unknown metadata error.",Ma("error",`Configuration saved, but apply status could not be refreshed: ${g.value}`)}}catch(C){Ma("error",C.message||"Configuration could not be saved")}finally{n.value=!1}}}async function Da(){if(!n.value){n.value=!0,b.value=null;try{t.value=await ml(),g.value=null}catch(C){b.value=`Image model status could not be refreshed: ${C.message||"Unknown error"}`}finally{n.value=!1}}}async function lc(C,G){if(n.value||!["follow","pin"].includes(G)||!C.length||C.some(Se=>{var We,Ct;return!I.includes(Se)||!((Ct=(We=t.value)==null?void 0:We.image_model_defaults)!=null&&Ct[Se])}))return;n.value=!0,b.value=null;let ne=!1;try{const Se=await H.post("/api/config/image-models",{operations:Object.fromEntries(C.map(We=>[We,G])),expected_revision:t.value.image_model_revision});ne=!0;for(const We of C){const Ct=`image.openai.${We}`,Vs=yt(e.value,Ct),qs=yt(Se.config,Ct),un=xa=>!Object.hasOwn(xa,"image")||!Ei(yt(xa,Ct),Vs)?xa:da(xa,Ct.split("."),qs);B.value=un(B.value),M.value=M.value.map(un),L.value=L.value.map(un),e.value=da(e.value,Ct.split("."),qs)}t.value={...t.value,image_model_defaults:Se.image_model_defaults,image_model_revision:Se.image_model_revision},Ma("success","Image model defaults saved. Unrelated drafts were not saved.")}catch(Se){b.value=`Image model operation failed: ${Se.message||"Unknown error"}. Refresh status before retrying if the outcome is uncertain.`}try{t.value=await ml(),g.value=null}catch(Se){const We=`Image model status could not be refreshed: ${Se.message||"Unknown error"}`;g.value=We,b.value=ne?`Image model defaults were saved, but ${We}`:`${b.value} ${We}`}finally{n.value=!1}}async function Xi(){var C,G;if(!(q.value||n.value)){s.value=!0,k.value=null;try{const ne=await H.get("/api/config"),Se=await ml();await m(),e.value=ne,t.value=Se,g.value=null;const We=He.value;if(We.some(Ct=>Ct.key===w.value)||(w.value=((C=We[0])==null?void 0:C.key)||$i[0].key),le.value){const Vs=(((G=We.find(qs=>qs.key===w.value))==null?void 0:G.sections)||[]).find(qs=>O.value[qs]===!0);O.value=Vs?{...O.value,[Vs]:!0}:{}}}catch(ne){k.value=ne.message||"Unknown configuration error"}finally{s.value=!1}}}function Pa(C){if(D.value||!(C.ctrlKey||C.metaKey))return;const G=C.target;G instanceof HTMLElement&&(G.matches("input, textarea, select")||G.isContentEditable)||(!C.shiftKey&&C.key.toLowerCase()==="z"?(C.preventDefault(),qe()):(C.key.toLowerCase()==="y"||C.shiftKey&&C.key.toLowerCase()==="z")&&(C.preventDefault(),Ze()))}function el(C){le.value=C.matches}Jt(O,C=>{try{localStorage.setItem(Sg,JSON.stringify(C))}catch{}},{deep:!0});let ui=!1;function tl(){ui||(ui=!0,document.addEventListener("keydown",Pa))}function sl(){ui&&(ui=!1,document.removeEventListener("keydown",Pa))}return tt(()=>{var C;Xi(),tl(),z=window.matchMedia("(max-width: 760px)"),el(z),(C=z.addEventListener)==null||C.call(z,"change",el)}),rs(tl),Zt(sl),Zt(()=>{o.value=""}),wt(()=>{var C;o.value="",sl(),(C=z==null?void 0:z.removeEventListener)==null||C.call(z,"change",el),Y&&window.clearTimeout(Y)}),{listenerState:i,listenerConsent:l,listenerCredential:o,listenerSaving:r,listenerMessage:c,listenerError:d,listenerStatusError:u,listenerChoiceChanged:ue,listenerStatusTone:U,listenerStatusLabel:Z,listenerAuthorizationCopy:de,listenerConfiguredSourceCopy:V,listenerRunningCopy:te,saveListenerConsent:h,armKeydown:tl,disarmKeydown:sl,handleKeydown:Pa,config:e,meta:t,loading:s,saving:n,error:k,toast:y,metaRefreshError:g,restartPromptOpen:x,restartScheduled:_,restartError:S,configMain:a,imageModelError:b,imageModelLeaves:I,setImageModelDefaults:lc,refreshImageModelMetadata:Da,searchQuery:E,healthFilter:R,activeCategory:w,reviewOpen:D,mobileOverflowOpen:ie,warningThresholdInput:F,arrayInputs:X,healthFilters:ve,visibleCategories:He,displayGroups:be,reviewGroups:Ke,sectionCount:J,fieldCount:pe,hasChanges:q,changeCount:se,changedSectionCount:ge,hasDraftErrors:we,canUndo:ye,canRedo:xe,globalFilterActive:me,reviewRestartCount:je,pendingRestartCount:Ge,pendingRestartFields:$e,healthCount:Ms,categoryStats:rn,selectCategory:Be,selectHealthFilter:nt,clearFilters:kt,sectionLabel:Ne,sectionDescription:ae,sectionFieldCount:Ae,sectionHealthCount:vt,sectionApplySummary:Ue,sectionApplyDetails:dt,sectionEntries:Qt,fieldGroups:Xs,sectionSearchHits:Tn,mcpConfigSummary:ft,fieldRuntimeCopy:ea,fieldSpecificRuntimeNote:ca,hasHonestAction:hs,runFieldAction:Ns,hasHostsCollection:Q,hostsConfigSummary:Ee,sectionChanged:re,fieldChanged:Ie,isSectionExpanded:Ds,toggleSection:ii,discardAllDrafts:cn,setFieldValue:Vt,setNumberFieldValue:li,numberInputValue:Rn,beginInputEdit:ua,endTextInputEdit:as,endInputEdit:dn,addWarningThreshold:oi,removeWarningThreshold:ri,isScalarArray:In,addScalarArrayItem:Re,removeScalarArrayItem:N,fieldError:_e,sectionHasErrors:Fe,undo:qe,redo:Ze,openReview:Et,closeReview:pt,mobileCancel:At,applyModeLabel:gs,applyClass:Nt,compactValue:lC,formatValue:oC,structuredApplyCopy:ns,fieldId:Na,fieldInputId:ci,focusField:mo,fetchConfig:Xi,saveConfig:ic,restartOdin:On,restartLater:ho,reviewPendingRestart:ac}}},pC=/^\d{15,25}$/;function Ag(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Rg={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),a=f(!1),n=f(0),i=f(null),l=j(()=>new Set((e.excludedIds||[]).map(String))),o=j(()=>{const _=s.value.toLowerCase().trim();return(e.members||[]).filter(S=>l.value.has(String(S.id))?!1:_?u(S).toLowerCase().includes(_)||String(S.username||"").toLowerCase().includes(_)||String(S.id).includes(_):!0)}),r=j(()=>{const _=s.value.trim();return o.value.length===0&&pC.test(_)&&!l.value.has(_)?_:""}),c=j(()=>o.value.length+(r.value?1:0)),d=j(()=>{if(a.value){if(o.value[n.value])return`${e.optionsId}-${n.value}`;if(r.value&&n.value===o.value.length)return`${e.optionsId}-raw`}});function u(_){return Ag(_)}function p(){a.value=!0,n.value=0}function m(){p()}function h(){const _=Math.max(c.value-1,0);n.value=Math.min(n.value+1,_)}function b(){n.value=Math.max(n.value-1,0)}function I(){const _=o.value[n.value];_?k(_):r.value&&n.value===o.value.length&&y(r.value)}function k(_){y(String(_.id))}function y(_){t("select",_),s.value="",a.value=!1,n.value=0}function g(){a.value=!1}function x(){setTimeout(g,150)}return tt(()=>{e.autofocus&&Ht(()=>{var _;return(_=i.value)==null?void 0:_.focus()})}),{query:s,open:a,highlightedIndex:n,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:m,highlightNext:h,highlightPrevious:b,selectHighlighted:I,selectMember:k,selectId:y,closeOptions:g,onBlur:x}}};function Pf(e,t,s){var a;return((a=e==null?void 0:e.config)==null?void 0:a[t])!=null?e.config[t]:s==null?void 0:s[t]}const fC={components:{DiscordUserCombobox:Rg},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f({persisted:!1,active:{state:"unknown"}}),s=f(""),a=f(!1),n=f(null);let i=null;const l=f(!0),o=f(null),r=f({}),c=f(null),d=f(null),u=f(!1),p=f(null),m=f({}),h=f([]);let b=0;const I=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),k=j(()=>JSON.stringify(c.value)!==JSON.stringify(d.value)),y=j(()=>new Map(h.value.map(fe=>[String(fe.id),fe])));function g(fe){return fe.config&&fe.config.enabled!==void 0?fe.config.enabled:!0}function x(fe){return Pf(fe,"require_mention",c.value)}function _(fe){return Pf(fe,"respond_to_bots",c.value)}function S(fe){return fe.config&&Object.keys(fe.config).length>0}function E(fe){r.value[fe]=!r.value[fe]}function R(fe){const J=fe.discord||{};return{allowed_users:[...J.allowed_users||[]],channels:[...J.channels||[]],respond_to_bots:!!J.respond_to_bots,require_mention:!!J.require_mention,ignore_bot_ids:[...J.ignore_bot_ids||[]]}}async function w({showLoading:fe=!0}={}){const J=++b;fe&&(l.value=!0),o.value=null;try{const pe=await H.get("/api/discord/guilds");J===b&&(e.value=pe)}catch(pe){J===b&&(o.value=pe.message)}finally{fe&&J===b&&(l.value=!1)}}async function O(){try{t.value=await H.get("/api/discord/connection"),n.value=null}catch(fe){n.value=fe.message}}async function B(fe,J=null){if(!a.value){a.value=!0,n.value=null;try{const pe={operation:fe};J!==null&&(pe.token=J),t.value=await H.post("/api/discord/connection",pe),fe==="credentials"&&(s.value="")}catch(pe){n.value=pe.message||"Connection update failed."}finally{a.value=!1}}}function T(){return B("credentials",s.value)}function F(){return B("connect")}function X(){return B("detach")}async function W(){l.value=!0,o.value=null;try{const[fe,J,pe]=await Promise.all([H.get("/api/discord/guilds"),H.get("/api/discord/members").catch(()=>[]),H.get("/api/config")]),ve=R(pe),ye=k.value;c.value=ve,ye||(d.value=JSON.parse(JSON.stringify(ve))),h.value=J,e.value=fe,p.value=null}catch(fe){o.value=fe.message}finally{l.value=!1}}let M=Promise.resolve();const L=f(new Set);function D(fe,J){const pe=new Set(L.value);pe.add(fe),L.value=pe;const ve=M.then(J);return M=ve.catch(()=>{}),ve.finally(()=>{const ye=new Set(L.value);ye.delete(fe),L.value=ye})}function ie(fe,J,pe,ve){const ye=(ve==null?void 0:ve.target)??null;return D(`guild:${fe}:${J}`,async()=>{try{await H.put("/api/discord/guild/"+fe+"/config",{[J]:pe}),await w({showLoading:!1})}catch(xe){o.value=xe.message,ye&&typeof pe=="boolean"&&(ye.checked=!pe)}})}function le(fe,J,pe,ve,ye){const xe=(ye==null?void 0:ye.target)??null;return D(`channel:${fe}:${pe}`,async()=>{try{await H.put("/api/discord/channel/"+fe+"/config",{[pe]:ve}),await w({showLoading:!1})}catch(He){o.value=He.message,xe&&typeof ve=="boolean"&&(xe.checked=!ve)}})}function z(fe,J){return D(`channel:${fe}:clear`,async()=>{try{await H.put("/api/discord/channel/"+fe+"/config",{clear:!0}),await w({showLoading:!1})}catch(pe){o.value=pe.message}})}function Y(fe,J){const pe=String(J);if(!fe.userAutocomplete)return pe;const ve=y.value.get(pe);return ve?Ag(ve):pe}function oe(fe,J=null){const pe=String(J??m.value[fe]??"").trim();!pe||d.value[fe].includes(pe)||(d.value[fe]=[...d.value[fe],pe],m.value={...m.value,[fe]:""})}function K(fe,J){d.value[fe]=d.value[fe].filter(pe=>pe!==J)}async function he(){if(!(!k.value||u.value)){u.value=!0,p.value=null;try{const J=(await H.put("/api/config",{discord:d.value})).discord||d.value;c.value={allowed_users:[...J.allowed_users||[]],channels:[...J.channels||[]],respond_to_bots:!!J.respond_to_bots,require_mention:!!J.require_mention,ignore_bot_ids:[...J.ignore_bot_ids||[]]},d.value=JSON.parse(JSON.stringify(c.value))}catch(fe){p.value=fe.message||"Global defaults could not be saved."}finally{u.value=!1}}}return tt(()=>{W(),O(),i=window.setInterval(O,5e3)}),wt(()=>{i!==null&&window.clearInterval(i),i=null}),{guilds:e,loading:l,error:o,expanded:r,globalDraft:d,globalSaving:u,globalError:p,globalArrayInputs:m,globalMembers:h,globalListEditors:I,globalChanged:k,guildEnabled:g,guildMention:x,guildBots:_,hasOverride:S,toggleGuild:E,fetchAll:W,fetchGuilds:w,setGuildConfig:ie,setChannelConfig:le,clearOverride:z,mutationPending:L,globalItemLabel:Y,addGlobalItem:oe,removeGlobalItem:K,saveGlobalDefaults:he,connection:t,connectionToken:s,connectionBusy:a,connectionError:n,saveDiscordCredentials:T,connectDiscord:F,detachDiscord:X}}},Ws=e=>e==null?e:JSON.parse(JSON.stringify(e));function mC({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:a=()=>{},onDefaultRollback:n=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let m=null;const h=new Map;function b(S){d+=1;const E=c.then(S,S);return c=E.catch(()=>{}),E}function I(S,E){m=Ws(S),h.clear();for(const[R,w]of Object.entries(E||{}))h.set(R,Ws(w))}function k(S){const E=Ws(S),R=++u;return b(async()=>{try{await e(Ws(E)),m=Ws(E),R===u&&a(Ws(E))}catch(w){R===u&&(n(Ws(m)),r(w,{kind:"default"}))}})}function y(S,E){const R=Ws(E),w=(p.get(S)||0)+1;return p.set(S,w),b(async()=>{try{await t(S,Ws(R)),h.set(S,Ws(R)),w===p.get(S)&&i(S,Ws(R))}catch(O){w===p.get(S)&&(l(S,Ws(h.get(S)??null)),r(O,{kind:"user",uid:S}))}})}function g(S){const E=(p.get(S)||0)+1;return p.set(S,E),b(async()=>{try{await s(S),h.delete(S),E===p.get(S)&&o(S)}catch(R){E===p.get(S)&&(l(S,Ws(h.get(S)??null)),r(R,{kind:"delete",uid:S}))}})}async function x(){for(;;){const S=c;if(await S,S===c)return d}}async function _(S){for(;;){const E=await x(),R=await S();if(E===d)return R}}return{seed:I,saveDefault:k,saveUser:y,deleteUser:g,whenIdle:x,readSnapshot:_,get revision(){return d}}}const hC={components:{DiscordUserCombobox:Rg},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=j(()=>{const T={};for(const F of r.value)T[F.id]=F;return T});function d(T){return c.value[T]||null}function u(T,F){return T?T.allowed_hosts===null||T.allowed_hosts===void 0?{allowed_hosts:[...F],default_host:T.default_host||"",allow_all:!0}:{allowed_hosts:T.allowed_hosts,default_host:T.default_host||"",allow_all:!1}:{allowed_hosts:[...F],default_host:F[0]||"",allow_all:!0}}const p=mC({applyDefault:async T=>{const F=T.allow_all?null:T.allowed_hosts;await H.put("/api/host-access/default-policy",{allowed_hosts:F,default_host:T.default_host})},applyUser:async(T,F)=>{const X=F.allow_all?null:F.allowed_hosts;await H.put(`/api/host-access/user/${T}`,{allowed_hosts:X,default_host:F.default_host})},applyDelete:T=>H.del(`/api/host-access/user/${T}`),onDefaultConfirmed:()=>Te.success("Default policy updated"),onDefaultRollback:T=>{T&&(i.value=T)},onUserConfirmed:T=>{const F=d(T);Te.success(`Updated access for ${F?F.display_name:T}`)},onUserRollback:(T,F)=>{const X={...l.value};F?X[T]=F:delete X[T],l.value=X},onUserDeleted:T=>{const F={...l.value};delete F[T],l.value=F},onError:(T,F)=>{var W;const X=F.uid?` ${((W=d(F.uid))==null?void 0:W.display_name)||F.uid}`:"";Te.error(`${T.message||"Failed to save"} — reverted${X}`)}});let m=0;async function h(){const T=++m;e.value=!0,t.value="";try{const F=await p.readSnapshot(()=>H.get("/api/host-access"));if(T!==m)return;s.value=F,a.value=F.available_hosts||[],n.value=F.host_descriptions||{},i.value=u(F.default_policy,a.value);const X=F.users||{},W={};for(const[M,L]of Object.entries(X))W[M]=u(L,a.value);l.value=W,p.seed(i.value,W)}catch(F){T===m&&(t.value=F.message||"Failed to fetch host access data")}finally{T===m&&(e.value=!1)}try{const F=await H.get("/api/discord/members")||[];T===m&&(r.value=F)}catch{T===m&&(r.value=[])}}const b=500,I=new Map;function k(T,F){const X=I.get(T);X&&clearTimeout(X.timer);const W={run:F,timer:null};W.timer=setTimeout(()=>{I.delete(T),F()},b),I.set(T,W)}function y(T){const F=I.get(T);F&&(clearTimeout(F.timer),I.delete(T))}function g(){for(const[T,F]of[...I])clearTimeout(F.timer),I.delete(T),F.run()}function x(){k("default",()=>p.saveDefault(i.value))}function _(T,F){i.value.allow_all=!1,F?i.value.allowed_hosts.includes(T)||i.value.allowed_hosts.push(T):(i.value.allowed_hosts=i.value.allowed_hosts.filter(X=>X!==T),i.value.default_host===T&&(i.value.default_host=i.value.allowed_hosts[0]||"")),x()}function S(T){k(`user:${T}`,()=>{const F=l.value[T];F&&p.saveUser(T,F)})}function E(T,F,X){const W=l.value[T];W&&(W.allow_all=!1,X?W.allowed_hosts.includes(F)||W.allowed_hosts.push(F):(W.allowed_hosts=W.allowed_hosts.filter(M=>M!==F),W.default_host===F&&(W.default_host=W.allowed_hosts[0]||"")),S(T))}function R(T,F){const X=l.value[T];X&&(X.default_host=F,S(T))}function w(){o.value=!0}function O(T){!/^\d{15,25}$/.test(T)||l.value[T]||(l.value[T]={allowed_hosts:[...a.value],default_host:a.value[0]||"",allow_all:!1},p.saveUser(T,l.value[T]),o.value=!1)}async function B(T){const F=d(T);await os({title:"Remove user override",message:`Remove the host access override for ${F?F.display_name:T}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(y(`user:${T}`),await p.deleteUser(T),l.value[T]||Te.success(`Removed override for ${F?F.display_name:T}`))}return tt(h),Zt(g),wt(g),{loading:e,error:t,data:s,availableHosts:a,hostDescriptions:n,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:h,saveDefaultPolicy:x,toggleDefaultHost:_,getMember:d,toggleUserHost:E,setUserDefault:R,openAddUser:w,addUserById:O,deleteUser:B,flushPendingSaves:g}}},vC={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
...
`),l.value=4,Te.info("Imported existing known_hosts trust. Test before activation.")}catch(M){Te.error(M.message)}}async function w(){try{const W=h.value.split(/\s+/).filter(Boolean),M={...I.value,expected_fingerprints:W,candidate_fingerprints:u.value},L=await H.post("/api/hosts/candidates",M);if(d.value=L.candidate_token,u.value=L.fingerprints||[],I.value.trust_mode==="tofu"&&M.candidate_fingerprints.length===0){I.value.confirm_tofu=!1,Te.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(W){Te.error(W.message)}}async function O(){var W,M;p.value=!1,m.value=null;try{const L=await H.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!L.tested,m.value=L.last_test,p.value&&(l.value=5)}catch(L){const D=(W=L.data)==null?void 0:W.last_test;D&&typeof D=="object"&&!Array.isArray(D)&&(m.value=D);const ie=(M=m.value)==null?void 0:M.detail;Te.error(typeof ie=="string"&&ie.trim()?ie:L.message)}}async function B(){try{await H.post("/api/hosts/candidates/"+d.value+"/commit",{}),Te.success("Host saved and published live"),n.value=!1,await y()}catch(W){Te.error(W.message)}}async function T(W){try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/enabled",{enabled:!W.enabled}),await y()}catch(M){Te.error(M.message)}}async function F(W){var M;if(await os("Delete host "+W.alias+"? Dependencies will block deletion.")){a.value=[];try{await H.del("/api/hosts/"+encodeURIComponent(W.alias)),await y()}catch(L){a.value=Array.isArray((M=L.data)==null?void 0:M.pending_references)?L.data.pending_references:[],Te.error(L.message)}}}async function X(W){if(await os("Force revoke "+W.alias+"? Remote outcomes may be unknown."))try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/force-revoke",{}),await y()}catch(M){Te.error(M.message)}}return tt(y),{hosts:e,loading:t,error:s,pendingReferences:a,wizard:n,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:I,isLocal:k,keyInfo:c,candidate:d,observed:u,tested:p,testResult:m,fingerprintsText:h,load:y,saveSettings:g,beginAdd:_,beginEdit:S,loadKey:E,importLegacy:R,prepare:w,testConnection:O,commit:B,toggle:T,remove:F,forceRevoke:X}}},gC={template:`
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=j(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:a.value),p=j(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:a.value);function m(R){return R==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":R==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function h(){e.value=!0,t.value="";try{const R=await H.get("/api/tokens");s.value=R.tokens||[],a.value=R.available_hosts||[]}catch(R){t.value=R.message||"Failed to load tokens"}finally{e.value=!1}}function b(R){return!R||!R.trim()?[]:R.split(",").map(w=>w.trim()).filter(Boolean)}function I(R,w){const O=c.value.allowed_hosts;if(w&&!O.includes(R)&&O.push(R),!w){const B=O.indexOf(R);B>=0&&O.splice(B,1)}}function k(R,w){const O=d.value.allowed_hosts;if(w&&!O.includes(R)&&O.push(R),!w){const B=O.indexOf(R);B>=0&&O.splice(B,1)}}async function y(){var R;i.value=!0;try{const w=b(c.value.allowed_tools_str),O=c.value.host_mode,B=O==="none"?[]:O==="select"?c.value.allowed_hosts:null,T={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:w.length?w:[]};B!==null&&(T.allowed_hosts=B),T.default_host=c.value.default_host||"";const F=await H.post("/api/tokens",T);l.value=F.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},n.value=!1,Te.success("Token created"),await h()}catch(w){Te.error(((R=w.data)==null?void 0:R.error)||w.message||"Failed to create token")}finally{i.value=!1}}function g(R){o.value=R;const w=R.allowed_hosts;let O="default";w==null?O="default":Array.isArray(w)&&w.length===0?O="none":Array.isArray(w)&&(O="select"),d.value={username:R.username||"",tier:R.tier||"admin",label:R.label||"",host_mode:O,allowed_hosts:Array.isArray(w)?[...w]:[],default_host:R.default_host||"",allowed_tools_str:(R.allowed_tools||[]).join(", ")}}async function x(){var R;if(o.value){r.value=!0;try{const w=b(d.value.allowed_tools_str),O=d.value.host_mode,B={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:w};O==="none"?B.allowed_hosts=[]:O==="select"?B.allowed_hosts=d.value.allowed_hosts:B.allowed_hosts=null,B.default_host=d.value.default_host||"",await H.put("/api/tokens/"+encodeURIComponent(o.value.user_id),B),o.value=null,Te.success("Token updated"),await h()}catch(w){Te.error(((R=w.data)==null?void 0:R.error)||w.message||"Failed to update")}finally{r.value=!1}}}async function _(R){var O;if(await os({title:"Regenerate token",message:`Regenerate token for ${R.username||R.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await H.post("/api/tokens/"+encodeURIComponent(R.user_id)+"/regenerate");l.value=B.token,Te.success("Token regenerated")}catch(B){Te.error(((O=B.data)==null?void 0:O.error)||B.message||"Failed to regenerate")}}async function S(R){var O;if(await os({title:"Delete token",message:`Delete token for ${R.username||R.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/tokens/"+encodeURIComponent(R.user_id)),Te.success("Token deleted"),await h()}catch(B){Te.error(((O=B.data)==null?void 0:O.error)||B.message||"Failed to delete")}}async function E(){if(l.value)try{await navigator.clipboard.writeText(l.value),Te.success("Copied to clipboard")}catch{Te.error("Copy failed — select and copy manually")}}return tt(h),{loading:e,error:t,tokens:s,availableHosts:a,showCreate:n,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:h,tierBadge:m,toggleCreateHost:I,toggleEditHost:k,createToken:y,startEdit:g,saveEdit:x,confirmRegenerate:_,confirmDelete:S,copyToken:E}}},bC=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort"]),yC=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),xC=Object.freeze(["enabled","base_url","model","max_tokens","num_ctx"]),_C=Object.freeze(["enabled","base_url","model","reasoning_effort"]);function po(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function Mo(e,t={}){const s=po(e,_C);return t.includeApiKey&&(s.api_key=e.api_key),s}function Pc(e){return po(e,["timeout","preset","model_profiles","context_utilization","openrouter"])}function Do(e){return po(e,bC)}function Po(e){return po(e,yC)}function $o(e,{includeApiKey:t=!1}={}){const s=po(e,xC);return t&&(s.api_key=e.api_key),s}function $c(e){return{timeout:e.timeout}}function Fo(e,t=500){let s=null;const a=(...n)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...n)},t)};return a.pending=()=>s!==null,a.cancel=()=>{s&&(clearTimeout(s),s=null)},a}const wC={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=15e3;let a=null,n=!1,i=null,l=null;const o={codexBasic:null,codexAdvanced:null,ollamaBasic:null,ollamaAdvanced:null,compatibleBasic:null,compatibleAdvanced:null,auxiliary:null,mainModel:null,agents:null},r=v=>JSON.stringify(v),c=(v,$)=>{o[v]=r($)},d=(v,$)=>o[v]!==null&&o[v]!==r($),u=f(null),p=f(!1),m=f({main:"",main_capability:"medium",agent_capability:"adaptive"}),h=f(""),b=["none","low","medium","high","xhigh","max"],I=["none","low","medium","high","xhigh","max"],k=f({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),y=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna"],g=j(()=>{const v=u.value||{},$=v.model_catalogue||v.model_catalog||{},ee=Pe=>{var Xt,Me,Bt;return((Xt=be.value.model_profiles)==null?void 0:Xt[Pe])||((Bt=(Me=be.value.openrouter)==null?void 0:Me.catalogue_profiles)==null?void 0:Bt[Pe])||null},Ce=(Pe,Xt,Me)=>Xt.map(Bt=>{var Yu,Qu;const qt=typeof Bt=="string"?Bt:Bt.name,Gs=Pe==="compat"?ee(qt):null;return{ref:Pe==="codex"?Bt:`${Pe}:${qt}`,name:qt,provider:Pe,available:!!(Me!=null&&Me.enabled&&(Pe==="codex"?Me.configured:(Yu=Me.health)!=null&&Yu.healthy)),unavailable_reason:Me!=null&&Me.enabled?Me!=null&&Me.configured?!((Qu=Me==null?void 0:Me.health)!=null&&Qu.healthy)&&Pe!=="codex"?"unreachable":"":"not configured":"disabled",capability:Pe==="codex"||Gs!=null&&Gs.supports_reasoning?"reasoning":Gs!=null&&Gs.supports_thinking_mode?"thinking":"none",efforts:Gs==null?void 0:Gs.supported_efforts,profile:Gs}}),De=[...$.codex||Ce("codex",y,v.codex),...$.compat||$.openai_compatible||[],...$.ollama||Ce("ollama",ae.value,v.ollama)].map(Pe=>typeof Pe=="string"?{ref:Pe,name:Pe,provider:"codex",available:!0,capability:"reasoning"}:Pe),ot=Pe=>{const Xt=De.findIndex(Me=>Me.ref===Pe.ref);Xt===-1?De.push(Pe):De[Xt]={...De[Xt],...Pe}};for(const Pe of Ce("compat",yt.value,v.openai_compatible))ot(Pe);if(ns.value&&ut.value.length)for(const Pe of ut.value){const Xt=`compat:${Pe.id}`;ot({ref:Xt,name:Pe.name||Pe.id,provider:"compat",available:!0,unavailable_reason:"",capability:Pe.supports_reasoning?"reasoning":"none",efforts:b.filter(Me=>{var Bt;return(Bt=Pe.supported_efforts)==null?void 0:Bt.includes(Me)}),agent_available:Pe.agent_eligible&&!!Pe.profile,agent_unavailable_reason:Pe.agent_unavailable_reason||""})}const Cs=new Set(De.map(Pe=>Pe.ref));for(const Pe of[m.value.main,Qe.value.model,...Mt.value])Pe&&Pe!=="auto"&&!Cs.has(Pe)&&De.unshift({ref:Pe,name:Pe.replace(/^(compat|ollama):/,""),provider:Pe.split(":")[0]||"codex",available:!1,unavailable_reason:"unavailable",capability:Pe.startsWith("ollama:")||Pe.includes(":")?"none":"reasoning"});return De.filter(Pe=>!ns.value||Pe.provider!=="compat"||Pe.ref.slice(7).includes("/")).map(Pe=>Pe.efforts?{...Pe,efforts:b.filter(Xt=>Pe.efforts.includes(Xt)&&!K(Pe.ref,Xt))}:Pe)}),x=j(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,$])=>({id:v,label:$,models:g.value.filter(ee=>{if(ee.provider!==v)return!1;const Ce=h.value.trim().toLowerCase();return!Ce||`${ee.name} ${ee.ref}`.toLowerCase().includes(Ce)})})).filter(v=>v.models.length)),_=v=>v.available&&v.agent_available!==!1,S=v=>v.available?`${v.name}${v.agent_available===!1?` (${v.agent_unavailable_reason||"not agent-eligible"})`:""}`:le(v),E=j(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,$])=>({id:v,label:$,models:g.value.filter(ee=>ee.provider===v&&!(v==="compat"&&ns.value)&&`${ee.ref} ${ee.name}`.toLowerCase().includes(ba.value.trim().toLowerCase()))})).filter(v=>v.models.length)),R=j(()=>g.value.find(v=>v.ref===m.value.main)),w=j(()=>g.value.find(v=>v.ref===Qe.value.model)),O=v=>g.value.find($=>$.ref===v),B=v=>{const $=O(v);return($==null?void 0:$.provider)==="codex"?b.filter(ee=>!K(v,ee)):($==null?void 0:$.efforts)||[]},T=v=>vs.value.find($=>Ns($)===v),F=(v,$)=>{const ee=T(v);return typeof ee=="string"?"":(ee==null?void 0:ee[$])||""},X=j(()=>Mt.value.map(v=>O(v)).filter(v=>v&&_(v))),W=j(()=>[...new Set(X.value.map(v=>v.capability!=="reasoning"?v.capability||"none":v.provider==="codex"?"codex_reasoning":"compatible_reasoning"))]),M=j(()=>W.value.length>1),L=j(()=>{var $;if(Qe.value.model!=="auto")return(($=w.value)==null?void 0:$.capability)||"none";if(M.value)return"mixed";const v=W.value[0]||"none";return v.endsWith("_reasoning")?"reasoning":v}),D=j(()=>{var v;return Qe.value.model==="auto"?b:((v=w.value)==null?void 0:v.efforts)||b}),ie=j(()=>L.value==="thinking"?Qe.value.thinking_mode??k.value.agent_reasoning_effort??"":k.value.agent_reasoning_effort??""),le=v=>`${v.name}${v.available?"":` (${v.unavailable_reason||"unavailable"})`}`,z=j(()=>{const v=k.value.model;return v&&!y.includes(v)?[v,...y]:y}),Y=j(()=>{const v=Qe.value.model;return v&&v!=="auto"&&!y.includes(v)?[v,...y]:y}),oe={"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},K=(v,$)=>!!v&&!!$&&(oe[v]||[]).includes($),he=j(()=>{const v=Qe.value.model;return v&&!v.includes(":")?v:null}),fe=v=>!K(k.value.model,v)&&!(k.value.agent_reasoning_effort===""&&K(he.value,v)),J=v=>{const $=Qe.value.model;return $==="auto"?!0:!K($||k.value.model,v)},pe=j(()=>{const v=k.value.agent_reasoning_effort;return v==="auto"?null:v||k.value.reasoning_effort}),ve=v=>K(v,k.value.reasoning_effort)||Qe.value.model===""&&K(v,pe.value),ye=v=>K(v,pe.value),xe=f({enabled:!1,model:"gpt-5.6-luna"}),He=f({unavailable_reason:null}),A=j(()=>{const v=xe.value.model;return v&&!y.includes(v)?[v,...y]:y});function P(v){const $=v.target.value;xe.value.enabled=$!=="",$!==""&&(xe.value.model=$),$.startsWith("compat:")&&ns.value?Pa(Se($),We($)).then(()=>Nn()).catch(ee=>ze(ee.message||"Failed to prepare OpenRouter model","error")):Nn()}const q=f(!1),ue=f({codex:!1,ollama:!1,compatible:!1}),U=f(null),Z=f(!1),de=f(""),V=f(null),te=f(!1);let se=0;const ge=j(()=>{var v;return Object.entries(((v=U.value)==null?void 0:v.models)||{}).map(([$,ee])=>{var Ce,De,ot;return{model:$,floor:ee.floor,override:ee.override,effectiveBudget:(Ce=ee.effective)==null?void 0:Ce.effective_budget,configuredPrimaryChars:(De=ee.configured)==null?void 0:De.primary_chars,primaryChars:(ot=ee.effective)==null?void 0:ot.primary_chars,provenance:ee.provenance,clampExpiresAt:ee.clamp_expires_at,densityPriorMilli:ee.density_prior_milli,densityScope:ee.density_scope,workloadCalibration:ee.workload_calibration}})}),me=j(()=>{var v;return((v=U.value)==null?void 0:v.clamps)||[]}),ke=j(()=>{var v,$;return(($=(v=U.value)==null?void 0:v.models)==null?void 0:$[k.value.model])||null}),we=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,num_ctx:32768,timeout:300}),be=f({enabled:!1,base_url:"https://api.deepseek.com/v1",api_key:"",model:"deepseek-v4-flash",timeout:300,preset:"deepseek",reasoning_effort:"medium",model_profiles:{},context_utilization:75,openrouter:{order:[],allow_fallbacks:!0,quantizations:[],sort:null,data_collection:null,reasoning_effort:"medium",model_pins:{},catalogue_profiles:{}}}),Ke=f(!1),je=f(!1),$e=f(!1),Ge=f(!1),st=f(!1),Ye=f(!1);function Q(){var $,ee,Ce;return!!((($=t.value)==null?void 0:$.contains(document.activeElement))&&((Ce=(ee=document.activeElement)==null?void 0:ee.matches)==null?void 0:Ce.call(ee,'input, textarea, select, [contenteditable="true"]'))||ca.value||vo.value!==null||te.value||Ke.value||je.value||hs.value||$e.value||Ge.value||st.value||q.value||fi.pending()||mi.pending()||Mn.pending()||Nn.pending()||d("codexBasic",Do(k.value))||d("codexAdvanced",Po(k.value))||d("ollamaBasic",$o(we.value))||d("ollamaAdvanced",$c(we.value))||d("compatibleBasic",Mo(be.value))||d("compatibleAdvanced",Pc(be.value))||d("auxiliary",xe.value)||d("mainModel",m.value.main)||d("agents",Qe.value))}function Ee(){o.codexBasic=r(Do(k.value)),o.codexAdvanced=r(Po(k.value)),o.ollamaBasic=r($o(we.value)),o.ollamaAdvanced=r($c(we.value)),o.compatibleBasic=r(Mo(be.value)),o.compatibleAdvanced=r(Pc(be.value)),o.auxiliary=r(xe.value),o.mainModel=r(m.value.main)}const Ae=f({configured:null}),Ne=f(!1),ae=f([]),Le=f(""),Ue=f(!1),dt=f(!1),Ut=f({configured:null}),ft=f(!1),yt=f([]),Qt=j(()=>ns.value?ut.value.map(v=>v.id):yt.value),cs=f(""),Xs=f(!1),ea=f(!1),Qe=f({model:"auto",thinking_mode:null,auto_model_allowlist:[]}),ca=f(!1),hs=f(!1),Ns=v=>typeof v=="string"?v:v==null?void 0:v.model,vs=j(()=>(Qe.value.auto_model_allowlist||[]).map(v=>typeof v=="string"?v:{...v}).filter(v=>Ns(v))),Tn=j(()=>!k.value.enabled&&be.value.enabled?be.value.model?[`compat:${be.value.model}`]:[]:!k.value.enabled&&!be.value.enabled&&we.value.enabled?we.value.model?[`ollama:${we.value.model}`]:[]:y),Mt=j(()=>vs.value.length?vs.value.map(Ns):Tn.value),vt=j(()=>{var v;return(v=Qe.value.auto_model_allowlist)!=null&&v.length?`Allowlist: ${Mt.value.length} models`:`Default: ${Mt.value.join(", ")||"no available agent models"}`}),Ms=new Map;function rn(){ca.value=!1,G()}const re=v=>{if(ns.value&&v.startsWith("compat:")&&!v.slice(7).includes("/"))return"OpenRouter requires a namespaced vendor/model ID; this is a direct-endpoint profile.";const $=g.value.find(ee=>ee.ref===v);return $?_($)?"":$.agent_unavailable_reason||$.unavailable_reason||"Not agent-eligible":"Model is absent from the current endpoint catalogue."},Ie=v=>{if(Et.value.has(v))return gs(v);const $=g.value.find(Ce=>Ce.ref===v),ee=($==null?void 0:$.hint_metadata)||{};return[ee.hint||ee.hint_derived,ee.as_of&&`as of ${ee.as_of}`,ee.scope_note,ee.evidence&&`Evidence: ${ee.evidence}`,$&&qs($)].filter(Boolean).join(" · ")||"No catalogue hint. Add an operator hint below."},Be=f(null),nt=f(!1),kt=f(""),ut=j(()=>{var v;return(((v=Be.value)==null?void 0:v.models)||[]).map($=>{var Ce,De,ot;const ee=((Ce=be.value.model_profiles)==null?void 0:Ce[$.id])||$.profile||((ot=(De=be.value.openrouter)==null?void 0:De.catalogue_profiles)==null?void 0:ot[$.id])||($.context_length>0&&$.max_completion_tokens>0?{total_window_tokens:$.context_length,max_output_tokens:$.max_completion_tokens}:null);return{...$,profile:ee}})}),ba=f(""),Ds=f(""),ii=f(!0),En=f(!0),cn=f(!0),An=f(!1),da=f(null),ya=f(""),Vt=f(null),ua=f(""),as=f([]),dn=f(!1),Rn=f("throughput"),li=(v,$,ee=null)=>{const Ce=v[$],De=ee&&Ce&&typeof Ce=="object"?Ce[ee]:Ce,ot=Number(De);return Number.isFinite(ot)?ot:null},oi=j(()=>{const v=[...as.value],$=Rn.value;return v.sort((ee,Ce)=>{var qt,Gs;if($==="quantization")return String(ee.quantization).localeCompare(String(Ce.quantization));const[De,ot,Cs]=$==="throughput"?["throughput_last_30m","p50",!0]:$==="latency_p99"?["latency_last_30m","p99",!1]:$==="cache_price"?["cache_read_per_token",null,!1]:["prompt_per_token",null,!1],Pe=(qt=ee.pricing)==null?void 0:qt[De],Xt=(Gs=Ce.pricing)==null?void 0:Gs[De],Me=ot?li(ee,De,ot):Pe==null?null:Number(Pe),Bt=ot?li(Ce,De,ot):Xt==null?null:Number(Xt);return Number.isFinite(Me)?Number.isFinite(Bt)?Cs?Bt-Me:Me-Bt:-1:1})}),ri=j(()=>{try{return new URL(be.value.base_url).hostname}catch{return""}}),ns=j(()=>/(^|\.)openrouter\.ai$/i.test(ri.value)),In=j(()=>{var v,$;return ns.value?nt.value?"OpenRouter recognized · fetching catalogue…":kt.value?`OpenRouter recognized · catalogue failed: ${kt.value}`:`OpenRouter recognized · ${(($=(v=Be.value)==null?void 0:v.models)==null?void 0:$.length)||0} catalogue models loaded`:yt.value.length?`${yt.value.length} endpoint models loaded`:"Catalogue not loaded"}),Re=j(()=>kt.value?"text-red-400":"text-gray-500"),N=j(()=>{var v;return[...new Set((((v=Be.value)==null?void 0:v.models)||[]).map($=>$.vendor))].sort()}),ce=j(()=>{var v;return[...new Set((((v=Be.value)==null?void 0:v.models)||[]).flatMap($=>($.endpoints||[]).map(ee=>ee.quantization)).filter(Boolean))].sort()}),_e=v=>{var $;return((($=Be.value)==null?void 0:$.measured_cache)||[]).some(ee=>ee.model===v.id&&ee.samples>0&&ee.cached_percent>0)},Fe=j(()=>{const v=ba.value.trim().toLowerCase();return ut.value.filter($=>{var ee;return!(v&&!`${$.id} ${$.name} ${$.vendor}`.toLowerCase().includes(v)||Ds.value&&$.vendor!==Ds.value||ii.value&&!$.supports_tools||En.value&&!$.agent_eligible||cn.value&&$.variant!=="standard"||An.value&&!_e($)||da.value!=null&&Number((ee=$.pricing)==null?void 0:ee.prompt_per_token)*1e6>Number(da.value)||ya.value&&!($.endpoints||[]).some(Ce=>Ce.quantization===ya.value))})}),qe=j(()=>Fe.value.slice(0,100)),Ze=j(()=>Fe.value.length),Et=j(()=>new Map(ut.value.map(v=>[`compat:${v.id}`,v]))),pt=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(3)}/M`,At=v=>{var $,ee,Ce,De;return[v.vendor,v.context_length?`${Number(v.context_length).toLocaleString()} ctx`:"context unknown",`${pt(($=v.pricing)==null?void 0:$.prompt_per_token)} in`,`${pt((ee=v.pricing)==null?void 0:ee.completion_per_token)} out`,`${pt((Ce=v.pricing)==null?void 0:Ce.cache_read_per_token)} cache read`,`${pt((De=v.pricing)==null?void 0:De.cache_write_per_token)} cache write`,v.supports_tools?"tools":"no tools",v.supports_reasoning?"reasoning":"no reasoning",v.variant!=="standard"?v.variant:null].filter(Boolean).join(" · ")},gs=v=>{var De;const $=Et.value.get(v);if(!$)return"Catalogue facts unavailable";const ee=(((De=Be.value)==null?void 0:De.measured_cache)||[]).filter(ot=>ot.model===$.id),Ce=ee.length?ee.map(ot=>`${ot.upstream_provider}: ${ot.cached_percent}% cached`).join(" · "):"No measured cache evidence yet";return`${At($)} · ${Ce}${$.profile_conflict?" · operator profile conflicts with catalogue":""}`},Nt=j(()=>yt.value.map(v=>typeof v=="string"?v:v.name).filter(Boolean)),Na=async()=>{var $,ee,Ce;const v=(Ce=(ee=($=u.value)==null?void 0:$.openai_compatible)==null?void 0:ee.preset_catalogue)==null?void 0:Ce[be.value.preset];v&&(be.value.base_url=v.base_url),Mn.cancel(),await ol()},ci=(v,$)=>{be.value.openrouter[v]=$.split(",").map(ee=>ee.trim()).filter(Boolean)},mo=j(()=>ae.value||[]),Ma=j(()=>{const v=[...y,...Nt.value.map($=>`compat:${$}`),...mo.value.map($=>`ollama:${$.name}`)];for(const $ of[Qe.value.model,...Mt.value])$&&$!=="auto"&&!v.includes($)&&v.unshift($);return v}),ac=v=>v==="codex-auto-review"?"codex-auto-review (Codex alias → gpt-5.6-luna)":v;async function ho({poll:v=!1}={}){try{const $=await H.get("/api/agents/model");if(v&&Q())return;Qe.value={...Qe.value,...$},o.agents=r(Qe.value)}catch{}}async function di(){if(!ns.value){Be.value=null,kt.value="";return}nt.value=!0;try{Be.value=await H.get("/api/openrouter/catalogue"),kt.value=""}catch(v){kt.value=v.message||"Failed to load OpenRouter catalogue"}finally{nt.value=!1}}async function nc(){var v;try{(v=Qe.value.model)!=null&&v.startsWith("compat:")&&ns.value&&await Pa(Se(Qe.value.model),We(Qe.value.model));const $=await H.put("/api/agents/model",{model:Qe.value.model||null});Qe.value={...Qe.value,...$},o.agents=r(Qe.value),ze("Agent model policy saved")}catch($){ze($.message||"Failed to save agent model policy","error")}}const On=()=>[...vs.value.length?vs.value:Mt.value];async function ic(v,$){const ee=On(),Ce=ee.findIndex(Cs=>Ns(Cs)===v);let De=null;if($.target.checked&&Ce<0&&ee.push(Ms.get(v)||v),!$.target.checked&&Ce>=0&&([De]=ee.splice(Ce,1)),!ee.length){$.target.checked=!0,ze("Keep one model selected. An empty list restores the provider default.","error");return}const ot=await Da(ee,"Agent Auto allowlist saved");ot&&$.target.checked&&Ms.delete(v),ot&&!$.target.checked&&typeof De=="object"&&Ms.set(v,De),ot||($.target.checked=Mt.value.includes(v))}async function Da(v,$){if(hs.value)return!1;hs.value=!0;try{const ee=await H.put("/api/agents/model",{auto_model_allowlist:v});return Qe.value={...Qe.value,...ee},o.agents=r(Qe.value),ze($),!0}catch(ee){return ze(ee.message||"Failed to save agent allowlist","error"),!1}finally{hs.value=!1}}const lc=()=>Da([],"Provider default restored");async function Xi(v,$,ee){const Ce=Mt.value.map(De=>{const ot=T(De);if(De!==v)return ot||De;const Cs=typeof ot=="string"?{model:De}:{...ot||{model:De}};return delete Cs.reasoning_effort,delete Cs.thinking_mode,ee&&(Cs[$]=ee),Object.keys(Cs).length===1?Cs.model:Cs});await Da(Ce,"Model default saved")}async function Pa(v,$=""){const[ee,...Ce]=v.split("/");if(!ee||!Ce.length)throw new Error("OpenRouter model id is not namespaced");return H.post(`/api/openrouter/models/${encodeURIComponent(ee)}/${encodeURIComponent(Ce.join("/"))}/select`,{provider_tag:$})}const el=(v,$)=>{var Ce;const ee=(((Ce=Be.value)==null?void 0:Ce.measured_cache)||[]).find(De=>De.model===v&&De.upstream_provider===$);return ee?`${ee.cached_percent}% cached over ${ee.samples} calls`:"no measured cache evidence"},ui=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(4)}/M`,tl=(v,$)=>{if(v==null)return"n/a";if(typeof v=="number")return Number(v).toLocaleString();const ee=v[$];return ee==null?"n/a":Number(ee).toLocaleString()},sl=v=>{var De;const $=[];v.quantization==="fp4"&&$.push("fp4 quantization may change quality");const ee=typeof v.latency_last_30m=="object"?Number((De=v.latency_last_30m)==null?void 0:De.p99):null,Ce=Number(Qe.value.iteration_timeout_seconds||0)*1e3;return ee&&Ce&&ee>Ce&&$.push("p99 exceeds the agent iteration budget"),$.join("; ")};async function C(v){var $;Vt.value=v,ua.value=(($=be.value.openrouter.model_pins)==null?void 0:$[v.id])||"",dn.value=!0;try{const[ee,...Ce]=v.id.split("/"),De=await H.get(`/api/openrouter/models/${encodeURIComponent(ee)}/${encodeURIComponent(Ce.join("/"))}/endpoints`);as.value=De.endpoints||[]}catch(ee){as.value=[],ze(ee.message||"Failed to load OpenRouter provider routes","error")}finally{dn.value=!1}}function G(){Vt.value=null,ua.value="",as.value=[]}async function ne(v,$=""){try{await Pa(v.id,$);const ee=On(),Ce=`compat:${v.id}`;if(ee.some(ot=>Ns(ot)===Ce)||ee.push(Ce),!await Da(ee,$?"OpenRouter model added and provider pinned.":"OpenRouter model added unpinned."))return;G(),await _a()}catch(ee){ze(ee.message||"Failed to add OpenRouter model","error")}}const Se=v=>v.startsWith("compat:")?v.slice(7):v,We=v=>{var $;return(($=be.value.openrouter.model_pins)==null?void 0:$[Se(v)])||""},Ct=v=>Mt.value.length>1&&Da(On().filter($=>Ns($)!==v),"Model removed from allowlist");async function Vs(){var v,$;try{const ee=On();for(const Ce of((v=Be.value)==null?void 0:v.quick_add)||[])($=Et.value.get(Ce))!=null&&$.agent_eligible&&(await Pa(Se(Ce),""),ee.some(De=>Ns(De)===Ce)||ee.push(Ce));await Da(ee,"Curated OpenRouter models added"),await _a()}catch(ee){ze(ee.message||"Failed to add curated OpenRouter models","error")}}function qs(v){const $=v.hint_metadata||{},ee=[];return $.context_tokens&&ee.push(`context ${Number($.context_tokens).toLocaleString()}`),$.max_output_tokens&&ee.push(`max output ${Number($.max_output_tokens).toLocaleString()}`),$.structural_source&&ee.push(`source ${$.structural_source}`),ee.join("; ")}async function un(v,$){const ee={...Qe.value.model_selection_hints||{}},Ce=$.trim();Ce?ee[v]=Ce:delete ee[v];try{const De=await H.put("/api/agents/model",{model_selection_hints:ee});Qe.value={...Qe.value,...De},o.agents=r(Qe.value),ze("Model hint saved")}catch(De){ze(De.message||"Failed to save model hint","error")}}function xa(v,$){const ee=Mt.value.indexOf(v);return!hs.value&&ee>=0&&ee+$>=0&&ee+$<Mt.value.length}async function Gg(v,$){const ee=On(),Ce=ee.findIndex(De=>Ns(De)===v);Ce<0||!xa(v,$)||([ee[Ce],ee[Ce+$]]=[ee[Ce+$],ee[Ce]],await Da(ee,"Agent Auto allowlist order saved"))}const oc=f(!0),rc=f(""),ju=f({configured:null,accounts:[]}),cc=f(null),vo=f(null),dc=f(""),al=f(null),uc=f(!1),pc=f(null),Vu=f(null),qu=f("");let pi=null;function ze(v,$="success"){Te(v,$==="error"?"error":"success")}function Wg(v){if(!v)return"?";const $=v/(1024*1024*1024);return $>=1?$.toFixed(1)+" GB":(v/(1024*1024)).toFixed(0)+" MB"}function Kg(v){return Number.isFinite(Number(v))?Number(v).toLocaleString():"—"}function Jg(v){return v==null?"automatic (model-derived)":Number(v).toLocaleString()+" characters"}function Zg(v){const $=new Date(v);return Number.isNaN($.getTime())?"unknown":$.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function Yg(v){return typeof v=="string"&&v.length>12?v.slice(0,8)+"…"+v.slice(-4):v}function Qg(v){return typeof v!="number"||!Number.isFinite(v)?"—":(v/1e3).toFixed(2)}function Xg(v){return v==="temporary learned clamp"?"is-clamp":v==="override"?"is-override":"is-built-in"}function eb(v){const $=k.value.context_budget_overrides[v.model];return v.floor!=null&&Number.isFinite(Number($))&&Number($)>v.floor}function tb(v,$){const ee={...k.value.context_budget_overrides};$.target.value===""?delete ee[v]:ee[v]=Number($.target.value),k.value.context_budget_overrides=ee,te.value=!0}function sb(v){k.value.context_utilization=v.target.value===""?"":Number(v.target.value),te.value=!0}function ab(v){const $={...k.value.context_budget_overrides};delete $[v],k.value.context_budget_overrides=$,te.value=!0}async function _a({quiet:v=!1,poll:$=!1}={}){if(!($&&Q())){if(l&&await l,i)return i;v||(e.value=!0),i=(async()=>{await Promise.all([Ps({poll:$}),nl(),il(),ho({poll:$}),pa(),Ln({poll:$})]),await di(),Q()||Ee()})();try{await i}finally{i=null,v||(e.value=!1)}}}async function nb(){if(!(Q()||i)){if(l)return l;l=Promise.all([Ps({poll:!0}),nl({refreshModels:!1}),il({refreshModels:!1}),ho({poll:!0}),pa(),Ln({poll:!0})]).then(()=>{Q()||Ee()});try{await l}finally{l=null}}}async function Ps({preserveBasic:v=!1,preserveAdvanced:$=!1,poll:ee=!1}={}){var Ce,De,ot,Cs,Pe,Xt;try{const Me=await H.get("/api/llm/status"),Bt=ee&&Q();u.value=Me,p.value=!1,Bt||(m.value.main=Me.main_model||Me.active_model||(Me.active_provider==="compat"?`compat:${((Ce=Me.openai_compatible)==null?void 0:Ce.model)||""}`:Me.active_provider==="ollama"?`ollama:${((De=Me.ollama)==null?void 0:De.model)||""}`:((ot=Me.codex)==null?void 0:ot.model)||"gpt-5.6-sol")),!Bt&&Me.codex&&!fi.pending()&&(v||(k.value.enabled=Me.codex.enabled,k.value.model=Me.codex.model||"gpt-5.6-sol",k.value.reasoning_effort=Me.codex.reasoning_effort||"medium",k.value.agent_reasoning_effort=Me.codex.agent_reasoning_effort||""),$||(k.value.request_timeout_seconds=Me.codex.request_timeout_seconds??k.value.request_timeout_seconds,k.value.stream_stall_timeout_seconds=Me.codex.stream_stall_timeout_seconds??k.value.stream_stall_timeout_seconds,k.value.retry={...k.value.retry,...Me.codex.retry||{}},k.value.connection_pool={...k.value.connection_pool,...Me.codex.connection_pool||{}},k.value.context_compression={...k.value.context_compression,...Me.codex.context_compression||{}},!te.value&&!$e.value&&(k.value.context_budget_overrides={...Me.codex.context_budget_overrides||{}},k.value.context_utilization=Me.codex.context_utilization??k.value.context_utilization))),!Bt&&Me.ollama&&!mi.pending()&&(v||(we.value.enabled=Me.ollama.enabled,we.value.base_url=Me.ollama.base_url||"",we.value.model=Me.ollama.model||"",we.value.max_tokens=Me.ollama.max_tokens||4096,we.value.num_ctx=Me.ollama.num_ctx||32768),$||(we.value.timeout=Me.ollama.timeout??we.value.timeout));const qt=Me.openai_compatible;!Bt&&qt&&!Mn.pending()&&(v||(be.value.enabled=qt.enabled,be.value.base_url=qt.base_url||be.value.base_url,be.value.model=qt.model||be.value.model,be.value.preset=qt.preset||be.value.preset,be.value.reasoning_effort=qt.reasoning_effort||"medium"),$||(be.value.timeout=qt.timeout??be.value.timeout,be.value.model_profiles=qt.model_profiles||be.value.model_profiles,be.value.context_utilization=qt.context_utilization??be.value.context_utilization,be.value.openrouter={...be.value.openrouter,...qt.openrouter||{}})),Bt||((Cs=m.value.main)!=null&&Cs.startsWith("compat:")?m.value.main_capability=(qt==null?void 0:qt.reasoning_effort)||"medium":(Pe=m.value.main)!=null&&Pe.startsWith("ollama:")||(m.value.main_capability=((Xt=Me.codex)==null?void 0:Xt.reasoning_effort)||"medium")),!Bt&&Me.auxiliary&&(He.value=Me.auxiliary,Nn.pending()||(xe.value.enabled=Me.auxiliary.enabled,xe.value.model=Me.auxiliary.model||"gpt-5.6-luna"))}catch{u.value||(u.value={active_provider:"",codex:{configured:null},ollama:{configured:null},openai_compatible:{configured:null}}),p.value=!0}}async function Ln({poll:v=!1}={}){const $=++se;Z.value=!0,de.value="";try{const ee=await H.get("/api/context/windows");if($!==se)return;U.value=ee,!(v&&Q())&&!$e.value&&!te.value&&(k.value.context_budget_overrides=Object.fromEntries(Object.entries(ee.models||{}).filter(([,Ce])=>Ce.override!=null).map(([Ce,De])=>[Ce,De.override])),k.value.context_utilization=ee.utilization??k.value.context_utilization)}catch(ee){$===se&&(de.value=ee.message||"Failed to load context budgets")}finally{$===se&&(Z.value=!1)}}async function nl({refreshModels:v=!0}={}){try{if(Ae.value=await H.get("/api/ollama/status"),Ne.value=!1,Ae.value.model&&(Le.value=Ae.value.model),v&&Ae.value.configured)try{const $=await H.get("/api/ollama/models");ae.value=$.models||[]}catch{ae.value=[]}else if(v&&we.value.base_url)try{const $=await H.post("/api/ollama/probe-models",{base_url:we.value.base_url});ae.value=$.models||[]}catch{ae.value=[]}}catch{Ne.value=!0}}async function pa(){oc.value=!0,rc.value="";try{ju.value=await H.get("/api/codex/status")}catch(v){rc.value=v.message||"Failed to fetch Codex status"}finally{oc.value=!1}}async function ib(){try{m.value.main.startsWith("compat:")&&ns.value&&await Pa(Se(m.value.main),We(m.value.main));try{await H.put("/api/llm/main-model",{model:m.value.main})}catch(v){if(!/404|not found/i.test(v.message||""))throw v;await H.post("/api/llm/switch",{model:m.value.main})}c("mainModel",m.value.main),ze("Main model saved"),await _a()}catch(v){ze(v.message||"Failed to save main model","error"),await Ps()}}async function lb(v){m.value.main_capability=v;const $=R.value;$&&($.provider==="compat"&&$.capability!=="none"?(be.value.reasoning_effort=v,await ol()):$.capability==="reasoning"?(k.value.reasoning_effort=v,await ll()):$.capability==="thinking"&&(await H.put("/api/openai-compatible/config",{thinking_mode:v}),ze("Thinking mode saved")))}async function ob(v){m.value.agent_capability=v;const $=w.value,ee=($==null?void 0:$.capability)||L.value;if(ee!=="none"){if(v===""||v==="auto"||ee==="reasoning"||ee==="mixed"){if(k.value.agent_reasoning_effort=v,ee==="thinking"){const Ce=await H.put("/api/agents/model",{thinking_mode:null});Qe.value={...Qe.value,...Ce}}await ll()}else if(ee==="thinking"){const Ce=await H.put("/api/agents/model",{thinking_mode:v});Qe.value={...Qe.value,...Ce},ze("Agent thinking mode saved")}}}async function rb(){Ue.value=!0;try{const v=await H.post("/api/ollama/reload");ze(v.configured?"Ollama reloaded":v.reason||"Ollama not configured",v.configured?"success":"error"),await _a()}catch(v){ze(v.message||"Reload failed","error")}finally{Ue.value=!1}}async function cb(){dt.value=!0;try{await H.post("/api/ollama/model",{model:Le.value}),ze("Model set to "+Le.value),await _a()}catch(v){ze(v.message||"Failed","error")}finally{dt.value=!1}}async function db(){const v=we.value.base_url;if(!v){ze("Enter a base URL first","error");return}Ye.value=!0;try{const $=await H.post("/api/ollama/probe-models",{base_url:v});ae.value=$.models||[],ae.value.length?(ze(ae.value.length+" model(s) found"),!we.value.model&&ae.value.length&&(we.value.model=ae.value[0].name)):ze("No models found at "+v,"error")}catch($){ze($.message||"Could not reach Ollama","error")}finally{Ye.value=!1}}async function il({refreshModels:v=!0}={}){try{if(Ut.value=await H.get("/api/openai-compatible/status"),ft.value=!1,Ut.value.model&&(cs.value=Ut.value.model),v&&Ut.value.configured)try{const $=await H.get("/api/openai-compatible/models");yt.value=$.models||[]}catch{yt.value=[]}}catch{ft.value=!0}}async function ub(){Xs.value=!0;try{const v=await H.post("/api/openai-compatible/reload");ze(v.configured?"OpenAI-compatible reloaded":v.reason||"OpenAI-compatible not configured",v.configured?"success":"error"),await _a()}catch(v){ze(v.message||"Reload failed","error")}finally{Xs.value=!1}}async function pb(){ea.value=!0;try{await H.post("/api/openai-compatible/model",{model:cs.value}),ze("Model set to "+cs.value),await _a()}catch(v){ze(v.message||"Failed","error")}finally{ea.value=!1}}async function ll(){if($e.value){fi();return}$e.value=!0;const v=Do(k.value);try{await H.put("/api/llm/codex/config",v),c("codexBasic",v),ze("Codex config saved"),await Promise.all([Ps({preserveBasic:!0,preserveAdvanced:!0}),pa()])}catch($){ze($.message||"Failed","error");const ee=JSON.stringify(Do(k.value))!==JSON.stringify(v);await Promise.all([Ps({preserveBasic:ee,preserveAdvanced:!0}),pa()])}finally{$e.value=!1}}async function Gu(){if($e.value)return;$e.value=!0;const v=Po(k.value);try{await H.put("/api/llm/codex/config",v),c("codexAdvanced",v),JSON.stringify({context_budget_overrides:k.value.context_budget_overrides,context_utilization:k.value.context_utilization})===JSON.stringify({context_budget_overrides:v.context_budget_overrides,context_utilization:v.context_utilization})&&(te.value=!1),ze("Codex advanced settings saved"),await Promise.all([Ps({preserveBasic:!0,preserveAdvanced:!0}),pa(),Ln()])}catch($){ze($.message||"Failed","error");const ee=JSON.stringify(Po(k.value))!==JSON.stringify(v);await Promise.all([Ps({preserveBasic:!0,preserveAdvanced:ee}),pa(),Ln()])}finally{$e.value=!1}}async function fc(){if(Ge.value){mi();return}Ge.value=!0;try{const v=Ke.value?we.value.api_key:null,$=$o(we.value,{includeApiKey:v!==null});await H.put("/api/llm/ollama/config",$),ze("Ollama config saved"),v!==null&&we.value.api_key===v&&(we.value.api_key="",Ke.value=!1),c("ollamaBasic",$o(we.value)),await Promise.all([Ps({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){ze(v.message||"Failed","error")}finally{Ge.value=!1}}async function Wu(){if(!Ge.value){Ge.value=!0;try{const v=$c(we.value);await H.put("/api/llm/ollama/config",v),c("ollamaAdvanced",v),ze("Ollama timeout saved"),await Promise.all([Ps({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){ze(v.message||"Failed","error")}finally{Ge.value=!1}}}async function ol(){if(st.value){Mn();return}st.value=!0;try{const v=je.value?be.value.api_key:null,$=Mo(be.value,{includeApiKey:v!==null});await H.put("/api/openai-compatible/config",$),ze("OpenAI-compatible config saved"),v!==null&&be.value.api_key===v&&(be.value.api_key="",je.value=!1),c("compatibleBasic",Mo(be.value)),await Promise.all([Ps({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){ze(v.message||"Failed","error")}finally{st.value=!1}}async function Ku(){if(!st.value){st.value=!0;try{const v=Pc(be.value);await H.put("/api/openai-compatible/config",v),c("compatibleAdvanced",v),ze("OpenAI-compatible endpoint settings saved"),await Promise.all([Ps({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){ze(v.message||"Failed","error")}finally{st.value=!1}}}async function fb(){if(q.value){Nn();return}q.value=!0;try{const v={...xe.value};await H.put("/api/llm/auxiliary/config",v),c("auxiliary",v),ze("Auxiliary config saved"),await Ps()}catch(v){ze(v.message||"Failed","error"),await Ps()}finally{q.value=!1}}const fi=Fo(ll),Nn=Fo(fb),mi=Fo(fc),Mn=Fo(ol),mb=()=>(fi.cancel(),ll()),hb=()=>(mi.cancel(),fc()),vb=()=>(Mn.cancel(),ol()),gb=()=>Gu(),bb=()=>Wu(),yb=()=>Ku();async function xb(v){const $=v.account_key+":"+v.model;V.value=$;try{const ee=await H.post("/api/context/windows/clear",{account_key:v.account_key,model:v.model});ze(ee.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Ln()}catch(ee){ze(ee.message||"Failed to clear clamp","error"),await Ln()}finally{V.value=null}}async function _b(v){try{await H.post("/api/codex/account/"+v+"/activate"),ze("Active account switched"),await pa()}catch($){ze($.message||"Failed","error")}}async function wb(v){cc.value=v;try{await H.post("/api/codex/account/"+v+"/refresh"),ze("Token refreshed"),await pa()}catch($){ze($.message||"Refresh failed","error")}finally{cc.value=null}}function kb(v,$){vo.value=v,dc.value=$||""}async function Sb(v){try{await H.put("/api/codex/account/"+v+"/label",{label:dc.value}),ze("Label updated"),vo.value=null,await pa()}catch($){ze($.message||"Failed","error")}}async function Cb(v,$){if(await os({title:"Delete Codex account",message:`Delete ${$||"account #"+(v+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/codex/account/"+v),ze("Deleted. Pool reloaded."),await pa()}catch(Ce){ze(Ce.message||"Failed","error")}}async function Tb(){uc.value=!0;try{const v=await H.post("/api/codex/device-code");pc.value=v,al.value="pending",Eb(v)}catch(v){ze(v.message||"Failed","error")}finally{uc.value=!1}}async function Eb(v){pi={cancelled:!1};const $=pi;try{const ee=await H.post("/api/codex/device-poll",{device_auth_id:v.device_auth_id,user_code:v.user_code,interval:v.interval});if($.cancelled)return;Vu.value=ee,al.value="success",await _a()}catch(ee){if($.cancelled)return;qu.value=ee.message||"Device login failed",al.value="error"}}function Ab(){pi&&(pi.cancelled=!0),al.value=null,pc.value=null}function Ju(){n||(n=!0,_a(),a=window.setInterval(nb,s))}function Zu(){n&&(n=!1,a!==null&&window.clearInterval(a),a=null)}return tt(Ju),rs(Ju),Zt(Zu),wt(()=>{Zu(),pi&&(pi.cancelled=!0),fi.cancel(),Nn.cancel(),mi.cancel(),Mn.cancel()}),{pageRoot:t,allowlistModalOpen:ca,closeAllowlistModal:rn,allowlistSaving:hs,effectiveAllowlist:Mt,allowlistSummary:vt,resetAgentAllowlist:lc,selectedUnavailableReason:re,selectedModelFacts:Ie,loading:e,llmStatus:u,llmStatusLoadFailed:p,modelSelection:m,modelSelectorSearch:h,reasoningEfforts:b,neutralReasoningLevels:I,modelCatalog:g,modelGroups:x,selectedMainModel:R,selectedAgentModel:w,selectedAgentCapabilityValue:ie,agentCapabilityKind:L,agentCapabilityEfforts:D,autoAllowlistModels:X,allowlistModel:O,allowlistModelEfforts:B,allowlistEntryCapabilityValue:F,modelOptionLabel:le,agentModelAvailable:_,agentModelOptionLabel:S,advancedOpen:ue,codexForm:k,codexModelOptions:z,codexAgentModelOptions:Y,mainEffortAllowed:fe,agentEffortAllowed:J,mainModelOptionDisabled:ve,agentModelOptionDisabled:ye,auxForm:xe,auxData:He,auxModelOptions:A,onAuxModelChange:P,savingAux:q,saveAuxConfigDebounced:Nn,ollamaForm:we,compatibleForm:be,savingCodex:$e,savingOllama:Ge,savingCompatible:st,probingOllama:Ye,ollamaKeyDirty:Ke,compatibleKeyDirty:je,fetchCodexStatus:pa,ollamaStatus:Ae,ollamaStatusLoadFailed:Ne,ollamaModels:ae,ollamaSelectedModel:Le,reloading:Ue,settingModel:dt,compatibleStatus:Ut,compatibleStatusLoadFailed:ft,compatibleModels:yt,visibleCompatibleModels:Qt,compatibleSelectedModel:cs,reloadingCompatible:Xs,settingCompatibleModel:ea,applyCompatiblePreset:Na,setOpenRouterList:ci,agentsConfig:Qe,compatibleAgentModels:Nt,ollamaAgentModels:mo,knownAgentModelRefs:Ma,agentModelLabel:ac,saveAgentsModel:nc,toggleAgentAutoAllowlist:ic,saveAllowlistEntryCapability:Xi,autoAllowlistGroups:E,structuralFacts:qs,saveModelHint:un,canMoveAllowlist:xa,moveAgentAutoAllowlist:Gg,openRouterCatalogue:Be,openRouterCatalogueLoading:nt,openRouterCatalogueError:kt,openRouterRecognized:ns,compatibleCatalogueStatus:In,compatibleCatalogueStatusClass:Re,openRouterSearch:ba,openRouterVendor:Ds,openRouterVendors:N,openRouterToolsOnly:ii,openRouterEligibleOnly:En,openRouterStandardOnly:cn,openRouterMeasuredCacheOnly:An,openRouterMaxPromptPrice:da,openRouterQuantization:ya,openRouterQuantizations:ce,openRouterResults:qe,openRouterMatchCount:Ze,openRouterInlineFacts:At,openRouterSelectedFacts:gs,prepareOpenRouterModel:C,addOpenRouterModel:ne,removeOpenRouterModel:Ct,quickAddOpenRouter:Vs,openRouterModelMap:Et,openRouterPin:We,openRouterPendingModel:Vt,openRouterPendingTag:ua,openRouterPendingEndpoints:as,openRouterPendingLoading:dn,openRouterEndpointSort:Rn,openRouterSortedPendingEndpoints:oi,openRouterEndpointCacheFact:el,openRouterRate:ui,openRouterMetric:tl,openRouterRouteWarning:sl,cancelOpenRouterPending:G,codexLoading:oc,codexError:rc,codexData:ju,refreshing:cc,editingLabel:vo,labelValue:dc,contextWindows:U,contextWindowsLoading:Z,contextWindowsError:de,contextBudgetRows:ge,activeClampRows:me,activeContextBudget:ke,clearingClamp:V,contextPolicyDirty:te,deviceState:al,deviceLoading:uc,deviceInfo:pc,deviceResult:Vu,deviceError:qu,fetchAll:_a,fetchLLMStatus:Ps,fetchOllamaStatus:nl,fetchCompatibleStatus:il,saveMainModel:ib,saveMainCapability:lb,saveAgentCapability:ob,reloadOllama:rb,setOllamaModel:cb,reloadCompatible:ub,setCompatibleModel:pb,probeOllamaModels:db,saveCodexConfig:ll,saveOllamaConfig:fc,saveCompatibleConfig:ol,saveCodexAdvancedConfig:Gu,saveOllamaAdvancedConfig:Wu,saveCompatibleAdvancedConfig:Ku,saveCodexConfigDebounced:fi,saveOllamaConfigDebounced:mi,saveCompatibleConfigDebounced:Mn,saveCodexConfigNow:mb,saveOllamaConfigNow:hb,saveCompatibleConfigNow:vb,saveCodexAdvancedConfigNow:gb,saveOllamaAdvancedConfigNow:bb,saveCompatibleAdvancedConfigNow:yb,activateAccount:_b,refreshAccount:wb,startEditLabel:kb,saveLabel:Sb,deleteAccount:Cb,startDeviceLogin:Tb,cancelDeviceLogin:Ab,formatSize:Wg,fetchContextWindows:Ln,clearContextClamp:xb,setContextOverride:tb,setContextUtilization:sb,resetContextOverride:ab,overrideAboveFloor:eb,formatCount:Kg,formatContextCeiling:Jg,formatExpiry:Zg,shortAccountKey:Yg,provenanceClass:Xg,formatDensity:Qg}}},$f={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function kC(e){return $f[e]||$f[(e||"").toLowerCase()]||"text-gray-400"}const SC={template:`
  ...
  `,setup(){const e=f(null),t=f(""),s=f(null),a=f(!1),n=f(0),i=f(null),l=f(""),o=f(null),r=f(!1),c=f(0),d=f(Date.now());let u=null,p=0,m=0;async function h(){const L=++p;a.value=!0;try{const D=await H.get("/api/turn-state/turns?limit=100");if(L!==p)return;t.value=D.availability,e.value=D.availability==="available"?D.data:null,s.value=null,n.value=Date.now()}catch(D){if(L!==p)return;s.value=D.message||"Turn-state read failed",D.status===503&&(t.value="unavailable")}L===p&&(a.value=!1)}async function b(){const L=++m;r.value=!0;try{const D=await H.get("/api/turn-state/capacity-breakers");if(L!==m)return;l.value=D.availability,i.value=D.availability==="available"?D.data:null,o.value=null,c.value=Date.now()}catch(D){if(L!==m)return;o.value=D.message||"Breaker read failed",D.status===503&&(l.value="unavailable")}L===m&&(r.value=!1)}function I(){h(),b()}const k=j(()=>e.value!==null&&hl(d.value,n.value)>Ff),y=j(()=>i.value!==null&&hl(d.value,c.value)>Ff),g=j(()=>k.value||y.value),x=j(()=>Math.round(hl(d.value,n.value)/1e3)),_=j(()=>Math.round(hl(d.value,c.value)/1e3));function S(L){return Fc(L,d.value/1e3)}function E(L){return TC[S(L)]}const R=j(()=>{var ie;const L=[...((ie=e.value)==null?void 0:ie.turns)||[]],D=d.value/1e3;return L.sort((le,z)=>Fc(le,D)-Fc(z,D)||(z.last_progress_at||0)-(le.last_progress_at||0))});function w(L){return L.state==="closed"?"badge-success":L.state==="probing"?"badge-warning":"badge-danger"}function O(L){if(L.state==="closed")return"—";const D=hl(d.value,c.value)/1e3,ie=Math.max(0,(L.cooldown_remaining_seconds||0)-D);return ie>0?`${Math.ceil(ie)}s`:L.state==="probing"?"probe in flight":"probe eligible"}function B(L){if(!L)return"";const D=Math.max(0,Math.round(d.value/1e3-L));if(D<90)return`${D}s ago`;const ie=Math.round(D/60);return ie<90?`${ie}m ago`:`${Math.round(ie/60)}h ago`}let T=null,F=null,X=!1;function W(){X||(X=!0,I(),T=setInterval(I,CC),u=setInterval(()=>{d.value=Date.now()},1e3),F=ct.onReconnected(I))}function M(){X&&(X=!1,T&&(clearInterval(T),T=null),u&&(clearInterval(u),u=null),F&&(F(),F=null))}return tt(W),rs(W),Zt(M),wt(M),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:a,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:k,breakersStale:y,anyStale:g,turnsAgeSeconds:x,breakersAgeSeconds:_,sortedTurns:R,priorityOf:S,priorityBadge:E,breakerBadge:w,cooldownLabel:O,ageLabel:B,fetchTurns:h,fetchBreakers:b,refreshAll:I,arm:W,disarm:M}}},AC={setup(){const e=f(""),t=f(""),s=f(!1),a=f(""),n=f(!1),i=f(!1),l=f(!1),o=f(null),r=f(!1);async function c(){n.value=!0,o.value=null,r.value=!1;try{const u=await H.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,a.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{n.value=!1}}async function d(){if(await os({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await H.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return tt(c),{current:e,latest:t,updateAvailable:s,changelog:a,checking:n,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},Uf=e=>JSON.parse(JSON.stringify(e)),RC=(e,t)=>JSON.stringify(e)===JSON.stringify(t),IC={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=f([]),a=f({}),n=f({}),i=f(!1),l=f(!1),o=f(!1),r=f(!1),c=f(!1),d=f(""),u=f("");let p=!1,m=0,h=null;const b=(M,L)=>p&&m===M&&H.token===L,I=M=>"computer-provisioning-"+M.key,k=M=>M===null?"Unset":M===""?"Empty":JSON.stringify(M),y=M=>{const L=n.value[M.key];return M.type==="array"?String(L||"").split(/\r?\n/).map(D=>D.trim()).filter(Boolean):["integer","number"].includes(M.type)?L===""||L==null?null:Number(L):L},g=j(()=>s.value.map(M=>({...M,value:y(M)})).filter(M=>!RC(M.value,a.value[M.key]))),x=j(()=>s.value.filter(M=>M.pending_restart).map(M=>M.label)),_=j(()=>s.value.some(M=>M.apply_state==="unknown")),S=j(()=>{const M={};for(const L of s.value){const D=y(L),ie=L.constraints||{};["integer","number"].includes(L.type)&&(D===null&&!L.nullable?M[L.key]="A number is required.":D!==null&&(!Number.isFinite(D)||L.type==="integer"&&!Number.isInteger(D)||ie.minimum!=null&&D<ie.minimum||ie.maximum!=null&&D>ie.maximum)&&(M[L.key]="Enter a number within the allowed range.")),L.key==="monitor_names"&&(D.length>16||new Set(D).size!==D.length||D.some(le=>!/^[A-Za-z0-9_.-]{1,64}$/.test(le)))&&(M[L.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return M}),E=j(()=>Object.keys(S.value).length>0);function R(M,L){n.value[M.key]=L,u.value=""}function w(){n.value=Object.fromEntries(s.value.map(M=>[M.key,M.type==="array"?a.value[M.key].join(`
`):a.value[M.key]])),r.value=!1}async function O(M,L){const[D,ie]=await Promise.all([H.get("/api/config"),H.get("/api/config/meta")]);if(!b(M,L))return!1;const le=(ie.fields||[]).filter(z=>/^computer\.[^.]+$/.test(z.path)&&z.path!=="computer.enabled"&&z.sensitivity==="public"&&z.apply_mode==="restart");if(!D.computer||!le.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=le.map(z=>({...z,key:z.path.split(".")[1]})),a.value=Object.fromEntries(s.value.map(z=>[z.key,Uf(D.computer[z.key])])),w(),h=L,i.value=!0,c.value=!1,!0}async function B(){if(!p||l.value||o.value)return;const M=++m,L=H.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await O(M,L)}catch(D){b(M,L)&&(c.value=!0,d.value=D.message||"Could not load provisioning. No changes were sent.")}finally{b(M,L)&&(l.value=!1)}}function T(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!E.value&&(r.value=!0)}async function F(){if(!p||!i.value||!r.value||o.value||l.value||c.value||E.value||!g.value.length)return;if(h!==H.token){W(),X();return}const M={computer:Object.fromEntries(g.value.map(le=>[le.key,Uf(le.value)]))},L=m,D=H.token;o.value=!0,d.value="",u.value="";let ie=!1;try{if(await H.put("/api/config",M),ie=!0,!b(L,D))return;await O(L,D)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(le){b(L,D)&&(c.value=!0,r.value=!1,d.value=ie?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${le.status===400?": "+le.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{b(L,D)&&(o.value=!1)}}function X(){p||(p=!0,B())}function W(){p=!1,m++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,h=null,s.value=[],a.value={},n.value={},d.value="",u.value=""}return tt(X),rs(X),Zt(W),wt(W),{fields:s,original:a,draft:n,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:x,effectiveUnknown:_,changes:g,validation:S,invalid:E,fieldId:I,format:k,edit:R,discard:w,load:B,openReview:T,save:F}}},OC={components:{ComputerProvisioning:IC},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),a=f(!1),n=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(0),p=f(""),m=f(""),h=f(null),b=f(""),I=f(!1),k=f(Date.now()),y=f(""),g=f(null);let x=0,_=null,S=!1,E=H.token,R=0,w=null,O=null,B=!1;const T=V=>V===!0?"Enabled":V===!1?"Disabled":"Unknown",F=j(()=>{var V;return((V=e.value.backend)==null?void 0:V.environment)==="existing_session"}),X=j(()=>{var te;const V=Date.parse(((te=e.value.accessibility)==null?void 0:te.checked_at)||"");return c.value&&Number.isFinite(V)&&k.value-V<15e3&&k.value>=V-5e3}),W=j(()=>{var V;return X.value?T((V=e.value.accessibility)==null?void 0:V.enabled):"Unknown / not current"}),M=j(()=>{var V;return X.value?((V=e.value.accessibility)==null?void 0:V.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),L=j(()=>Object.entries(e.value.input_limits||{}).filter(([,V])=>typeof V=="number"&&Number.isFinite(V)).map(([V,te])=>`${V}: ${te}`).join(", ")),D=j(()=>{var te;const V=(te=e.value.application_provenance)==null?void 0:te.script_identity;return typeof V=="string"?V:!V||typeof V!="object"?"Not observed":`${V.interpreter_basename||"Unknown interpreter"}; argv digest ${V.argv_digest||"not recorded"}; ${V.verified===!0?"verified":"not verified"}`}),ie=j(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(V=>V&&typeof V.id=="string"&&typeof V.label=="string"&&["supported","capture_only"].includes(V.input)).slice(0,16):[]),le=j(()=>{const V=e.value.restart_required;return Array.isArray(V)?V.length?V.join(", "):"None reported":V===!0?"Pending; restart required":V===!1?"None reported":"Unknown"}),z=j(()=>{var te,se;const V=Date.parse(((te=h.value)==null?void 0:te.captured_at)||"");return Number.isFinite(V)&&k.value<V+Math.min(1e4,((se=h.value)==null?void 0:se.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function Y(){b.value&&URL.revokeObjectURL(b.value),b.value="",h.value=null}function oe(){x++,Y(),g.value=null,c.value=!1,w==null||w.abort(),w=null,t.value=!1,m.value="",s.value=!1,i.value=!1,l.value=!1}function K(V,te){return S&&V===x&&te===H.token}function he(){return S&&c.value&&O===H.token&&Date.now()-u.value<15e3}function fe(V,te="mutation"){var ge,me;oe(),B=!0,p.value="";const se=V.status||(V.name==="AuthError"?401:0);[401,403,404].includes(se)?(u.value=0,O=null,e.value={available:!1,state:"unknown"}):u.value||(e.value={available:!1,state:se===503?"unavailable":"unknown"}),o.value=se===401||se===403||se===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":se===410?"Evidence or artifact expired. Observe or prepare the export again.":te==="read"?"Status refresh failed. Last-known details are not current. No mutation was requested by this read.":te==="acknowledged"?"The mutation was acknowledged, but status refresh failed. Refresh status independently; do not replay the change.":"Request failed; outcome unknown. Refresh status. No action was replayed.",te==="mutation"&&![401,403,404].includes(se)&&typeof((ge=V.data)==null?void 0:ge.code)=="string"&&/^[a-z_]{1,64}$/.test(V.data.code)&&typeof((me=V.data)==null?void 0:me.error)=="string"&&(o.value=V.data.error.slice(0,512),V.data.outcome==="not_applied"&&V.data.next_action==="repair_provisioning"&&typeof V.data.remedy=="string"&&(o.value="Not applied (preflight rejection). "+o.value,p.value=V.data.remedy.slice(0,1024)))}async function J(){if(t.value||r.value||a.value||n.value||d.value||!S)return;const V=x,te=H.token;t.value=!0,R=Date.now();const se=new AbortController;w=se;try{const ge=await H.get("/api/computer",{signal:se.signal});if(!K(V,te))return;pe(ge)}catch(ge){K(V,te)&&fe(ge,"read")}finally{w===se&&(w=null,t.value=!1)}}function pe(V,te=""){if(!V||typeof V!="object"||typeof V.state!="string"||typeof V.available!="boolean")throw new Error("Invalid status");(e.value.session_id&&e.value.session_id!==V.session_id||e.value.generation!=null&&e.value.generation!==V.generation||e.value.session_generation!=null&&e.value.session_generation!==V.session_generation)&&oe(),e.value=V,u.value=Date.now(),O=H.token,c.value=!(r.value&&te!=="toggle")&&!(a.value&&te!=="stop")&&!(n.value&&te!=="pause")&&!(d.value&&te!=="recovery"),o.value="",p.value="",B=!c.value}async function ve(V){if(!he()||r.value||a.value||n.value||d.value)return;oe();const te=x,se=H.token;r.value=!0;let ge=!1;try{if(await H.post("/api/computer/enabled",{enabled:V}),ge=!0,!K(te,se))return;const me=await H.get("/api/computer");K(te,se)&&pe(me,"toggle")}catch(me){K(te,se)&&fe(me,ge?"acknowledged":"mutation")}finally{r.value=!1}}async function ye(V){if(!S||!["pause","stop"].includes(V)||(V==="stop"?a.value:n.value))return;oe();const te=x,se=H.token,ge=V==="stop"?a:n;ge.value=!0;let me=!1;try{if(await H.post("/api/computer/"+V,{}),me=!0,K(te,se)){const ke=await H.get("/api/computer");K(te,se)&&pe(ke,V)}}catch(ke){K(te,se)&&fe(ke,me?"acknowledged":"mutation")}finally{ge.value=!1}}async function xe(){var ge;if(!he()||d.value||((ge=e.value.backend)==null?void 0:ge.native_backend)!=="hyprland")return;const V={session_id:e.value.session_id,generation:e.value.session_generation};if(!V.session_id||!Number.isInteger(V.generation))return;oe();const te=x,se=H.token;d.value=!0;try{const me=await H.post("/api/computer/release_owned_input",V);K(te,se)&&pe(me,"recovery")}catch(me){K(te,se)&&fe(me,"mutation")}finally{d.value=!1}}async function He(){return P(!1)}async function A(){return P(!0)}async function P(V){var we;if(!he()||d.value||r.value||a.value||n.value||e.value.state!=="quarantined")return;const te={session_id:e.value.session_id,generation:e.value.session_generation};if(!te.session_id||!Number.isInteger(te.generation))return;if(V){if(m.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+te.session_id)return;te.acknowledgment=m.value}const se=V?((we=e.value.recovery)==null?void 0:we.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";oe();const ge=x,me=H.token;d.value=!0;let ke=!1;try{const be=await H.post("/api/computer/"+se,te);ke=!0,K(ge,me)&&pe(be,"recovery")}catch(be){K(ge,me)&&fe(be,ke?"acknowledged":"mutation")}finally{d.value=!1}}async function q(){var se;if(!he()||s.value||!e.value.available)return;Y(),I.value=!1;const V=x,te=H.token;s.value=!0;try{const ge=await H.post("/api/computer/observe",{});if(!K(V,te))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((se=ge.frame)==null?void 0:se.evidence_id)||""))throw new Error("Invalid evidence");const me=await H.getBlob("/api/computer/evidence/"+ge.frame.evidence_id);if(!K(V,te))return;if(!["image/png","image/jpeg"].includes(me.type)||me.size>2097152||!Number.isFinite(Date.parse(ge.frame.expires_at))||Date.parse(ge.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");h.value=ge.frame,b.value=URL.createObjectURL(me),o.value=""}catch(ge){K(V,te)&&fe(ge)}finally{V===x&&(s.value=!1)}}async function ue(){if(!he()||i.value||!e.value.available)return;g.value=null;const V=x,te=H.token;i.value=!0;try{const se=await H.post("/api/computer/export",{name:y.value});K(V,te)&&(g.value=se,o.value="")}catch(se){K(V,te)&&fe(se)}finally{V===x&&(i.value=!1)}}async function U(){if(!he()||l.value||!g.value)return;const V=x,te=H.token,se=g.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((se==null?void 0:se.artifact_id)||""))throw new Error("Invalid export");const ge=await H.getBlob("/api/computer/download/"+se.artifact_id);if(!K(V,te))return;const me=URL.createObjectURL(ge),ke=document.createElement("a");ke.href=me,ke.download=se.name,ke.click(),setTimeout(()=>URL.revokeObjectURL(me),1e3)}catch(ge){K(V,te)&&fe(ge)}finally{V===x&&(l.value=!1)}}function Z(){S||(E!==H.token&&(E=H.token,oe(),u.value=0,O=null,e.value={state:"unknown",available:!1},o.value="",p.value=""),S=!0,J(),_=setInterval(()=>{k.value=Date.now(),E!==H.token&&(E=H.token,oe(),u.value=0,O=null,o.value="",p.value="",e.value={state:"unknown",available:!1}),c.value&&k.value-u.value>=15e3&&oe(),h.value&&Date.parse(h.value.expires_at)<=k.value&&(Y(),I.value=!0),g.value&&Date.parse(g.value.expires_at)<=k.value&&(g.value=null),!B&&k.value-R>=5e3&&J()},500))}function de(){S=!1,clearInterval(_),_=null,oe(),c.value=!1}return tt(Z),rs(Z),Zt(de),wt(de),{status:e,checkedAt:u,remedy:p,loading:t,observing:s,stopping:a,pausing:n,exporting:i,downloading:l,error:o,frame:h,frameUrl:b,frameExpired:I,freshness:z,name:y,artifact:g,refresh:J,control:ye,observe:q,clearFrame:Y,exportFile:ue,download:U,toggling:r,adminReady:c,enabledLabel:T,restartSettings:le,setEnabled:ve,recovering:d,recover:He,reconcile:A,releaseOwnedInput:xe,reconciliationAck:m,applicationProfiles:ie,attached:F,scriptIdentity:D,inputLimits:L,accessibilityLabel:W,accessibilityDetail:M}}},Ig=[{id:"health",label:"Health",component:B1},{id:"resources",label:"Resources",component:z1},{id:"logs",label:"Logs",component:X1},{id:"config",label:"Config",component:uC},{id:"discord",label:"Discord",component:fC},{id:"hosts",label:"Hosts",component:vC},{id:"host-access",label:"Host Access",component:hC},{id:"api-tokens",label:"API Tokens",component:gC},{id:"llm",label:"LLM Config",component:wC},{id:"internals",label:"Internals",component:SC},{id:"turn-state",label:"Turn State",component:EC},{id:"computer",label:"Computer",component:OC},{id:"update",label:"Update",component:AC}],LC={components:{TabbedPage:Xr},setup(){return{tabs:Ig}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Uo=(e,t,s,a)=>a.map(({id:n,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:n}}})),NC=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Uo("Operations","operations","/operations",xg),...Uo("History","history","/history",_g),...Uo("Capabilities","capabilities","/capabilities",wg),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Uo("System","system","/system",Ig)],Us=Cn({open:!1,query:"",selected:0});function Bf(){Us.query="",Us.selected=0,Us.open=!0}function Uc(){Us.open=!1}function MC(e,t){const s=e.label.toLowerCase(),a=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:a.startsWith(t)?80:s.includes(t)?60:a.includes(t)?40:0:1}const DC={setup(){const e=pg(),t=f(null),s=j(()=>{const i=Us.query.trim().toLowerCase();return NC.map(l=>({...l,_score:MC(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Jt(()=>Us.open,async i=>{var l;i&&(await Ht(),(l=t.value)==null||l.focus())}),Jt(()=>Us.query,()=>{Us.selected=0});function a(i){Uc(),e.push(i.to)}function n(i){if(i.key==="Escape"){i.preventDefault(),Uc();return}if(i.key==="ArrowDown")i.preventDefault(),Us.selected=Math.min(Us.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Us.selected=Math.max(Us.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Us.selected];l&&a(l)}}return{state:Us,results:s,inputEl:t,go:a,onKeydown:n,closePalette:Uc}},template:`
    <transition name="modal">
  ...
  `},Td={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(Td));const PC={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>Bi("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[Bi("path",{d:Td[e.name]||Td.info})])}},$C=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function zf(e){return[...e.querySelectorAll($C)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const FC={mounted(e){const t=document.activeElement,s=a=>{if(a.key!=="Tab")return;const n=zf(e);if(!n.length){a.preventDefault(),e.focus();return}const i=n[0],l=n[n.length-1];a.shiftKey&&document.activeElement===i?(a.preventDefault(),l.focus()):!a.shiftKey&&document.activeElement===l&&(a.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||zf(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},UC={template:`
    ...
    </div>`,setup(){const e=f({}),t=f(!0),s=f(null),a=f([]),n=f(!1),i=f([]),l=f(!1),o=f(!1),r=f([]),c=f(0),d=f(null),u=f({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const m=j(()=>{const le=e.value.uptime_seconds||0,z=Math.floor(le/86400),Y=Math.floor(le%86400/3600),oe=Math.floor(le%3600/60),K=[];return z>0&&K.push(`${z}d`),Y>0&&K.push(`${Y}h`),(K.length===0||z===0&&Y===0)&&K.push(`${oe}m`),K.join(" ")}),h=j(()=>{const le=e.value.uptime_seconds||0;return 125.66*(1-Math.min(le/86400,1))}),b=j(()=>{const le=e.value;return[{label:"Guilds",value:le.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:le.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:le.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${le.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:le.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:le.loop_count>0?"text-green-400":"",highlight:le.loop_count>0},{label:"Agents",value:le.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:le.agent_count>0?`${le.agent_count} total`:"",subColor:"text-gray-500",highlight:(le.agent_running??0)>0},{label:"Processes",value:le.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:le.process_count>0?`${le.process_count} total`:"",subColor:"text-gray-500",highlight:(le.process_running??0)>0},{label:"Schedules",value:le.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(le.schedule_failing>0?`${le.schedule_failing} failing`:"")+(le.schedule_failing>0&&le.schedule_paused>0?", ":"")+(le.schedule_paused>0?`${le.schedule_paused} paused`:"")||void 0,subColor:le.schedule_failing>0?"text-red-400":"text-yellow-400",color:le.schedule_failing>0?"text-red-400":"",highlight:le.schedule_failing>0},{label:"Users",value:le.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),I=j(()=>{const le=e.value,z=[];return z.push({label:"Bot",status:le.status==="online"?"ok":"warn",detail:le.status==="online"?"Online":"Starting"}),(le.schedule_failing||0)>0?z.push({label:"Schedules",status:"error",detail:`${le.schedule_failing} failing`}):(le.schedule_count||0)>0&&z.push({label:"Schedules",status:"ok",detail:`${le.schedule_count} configured`}),(le.loop_count||0)>0&&z.push({label:"Loops",status:"ok",detail:`${le.loop_count} active`}),(le.agent_running||0)>0&&z.push({label:"Agents",status:"ok",detail:`${le.agent_running} running`}),(le.process_running||0)>0&&z.push({label:"Processes",status:"ok",detail:`${le.process_running} running`}),z});async function k(){try{e.value=await H.get("/api/status"),s.value=null}catch(le){s.value=le.message}finally{t.value=!1}}let y=0,g=0,x=0,_=0;function S(le,z){const Y=new Set;return[...z,...le].filter(oe=>{const K=oe._hmac||JSON.stringify([oe.timestamp,oe.tool_name,oe.user_id,oe.result_summary,oe.error]);return Y.has(K)?!1:(Y.add(K),!0)})}async function E(){const le=++y,z=x;n.value=!0;try{const Y=await H.get("/api/audit?limit=10");if(le!==y)return;const oe=z===x?[]:a.value.filter(K=>(K._liveEpoch||0)>z);a.value=S(Y,oe).slice(0,10),c.value=oe.length}catch{}le===y&&(n.value=!1)}async function R(){const le=++g,z=_;l.value=!0;try{const Y=await H.get("/api/audit?error_only=1&limit=5");if(le!==g)return;const oe=z===_?[]:i.value.filter(K=>(K._liveErrorEpoch||0)>z);i.value=S(Y,oe).slice(0,5),o.value=!1}catch{if(le!==g)return;o.value=z===_||i.value.length===0}le===g&&(l.value=!1)}async function w(){try{const le=await H.get("/api/knowledge");d.value=(Array.isArray(le)?le:[]).reduce((z,Y)=>z+(Y.chunks||0),0)}catch{d.value=null}}async function O(){try{const le=await H.get("/api/agents");r.value=le.filter(z=>z.status==="running")}catch{}}async function B(){u.value={...u.value,reload:!0};try{await H.post("/api/reload"),Te.success("Config reloaded")}catch(le){Te.error(le.message)}u.value={...u.value,reload:!1}}async function T(){if(!await os({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const z=e.value.session_count;e.value={...e.value,session_count:0};try{const Y=await H.post("/api/sessions/clear-all");Te.success(`Cleared ${Y.count} session${Y.count!==1?"s":""}`),await k()}catch(Y){e.value={...e.value,session_count:z},Te.error(Y.message)}u.value={...u.value,clearSessions:!1}}async function F(){if(!await os({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const z=e.value.loop_count;e.value={...e.value,loop_count:0};try{const Y=await H.post("/api/loops/stop-all");Te.success(Y.result),await k()}catch(Y){e.value={...e.value,loop_count:z},Te.error(Y.message)}u.value={...u.value,stopLoops:!1}}function X(){t.value=!0,s.value=null,k(),E(),R(),O()}let W=null,M=null,L=null;function D(le){if(le.payload&&le.payload.tool_name){x+=1;const z={...le.payload,_isNew:!0,_key:++p,_liveEpoch:x};a.value.unshift(z),a.value.length>10&&a.value.pop(),c.value++,z.error&&(_+=1,z._liveErrorEpoch=_,o.value=!1,i.value.unshift(z),i.value.length>5&&i.value.pop()),setTimeout(()=>{z._isNew=!1},1500),clearTimeout(L),L=setTimeout(()=>{c.value=0},1e4)}}let ie=null;return tt(async()=>{await Promise.all([k(),E(),R(),O(),w()]),W=setInterval(k,15e3),M=setInterval(O,1e4),ct.subscribe("events",D),ie=ct.onReconnected(()=>{E(),R()})}),wt(()=>{W&&clearInterval(W),M&&clearInterval(M),clearTimeout(L),ct.unsubscribe("events",D),ie&&(ie(),ie=null)}),{status:e,loading:t,error:s,uptime:m,uptimeRingOffset:h,stats:b,healthIndicators:I,activity:a,activityLoading:n,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:E,fetchErrors:R,fetchStatus:k,onEvent:D,formatTime:qS,formatDuration:Ji,retry:X,reloadConfig:B,clearSessions:T,stopAllLoops:F}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Hf(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,a=Array(t);s<t;s++)a[s]=e[s];return a}function BC(e){if(Array.isArray(e))return e}function zC(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var a,n,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(a=i.call(s)).done)&&(o.push(a.value),o.length!==t);r=!0);}catch(d){c=!0,n=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw n}}return o}}function HC(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function jC(e,t){return BC(e)||zC(e,t)||VC(e,t)||HC()}function VC(e,t){if(e){if(typeof e=="string")return Hf(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Hf(e,t):void 0}}const Og=Object.entries,jf=Object.setPrototypeOf,qC=Object.isFrozen,GC=Object.getPrototypeOf,WC=Object.getOwnPropertyDescriptor;let Ls=Object.freeze,ra=Object.seal,Si=Object.create,Lg=typeof Reflect<"u"&&Reflect,Ed=Lg.apply,Ad=Lg.construct;Ls||(Ls=function(t){return t});ra||(ra=function(t){return t});Ed||(Ed=function(t,s){for(var a=arguments.length,n=new Array(a>2?a-2:0),i=2;i<a;i++)n[i-2]=arguments[i];return t.apply(s,n)});Ad||(Ad=function(t){for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return new t(...a)});const Ba=Yt(Array.prototype.forEach),KC=Yt(Array.prototype.lastIndexOf),Vf=Yt(Array.prototype.pop),yi=Yt(Array.prototype.push),JC=Yt(Array.prototype.splice),Es=Array.isArray,kl=Yt(String.prototype.toLowerCase),Bc=Yt(String.prototype.toString),qf=Yt(String.prototype.match),xi=Yt(String.prototype.replace),Gf=Yt(String.prototype.indexOf),ZC=Yt(String.prototype.trim),YC=Yt(Number.prototype.toString),QC=Yt(Boolean.prototype.toString),Wf=typeof BigInt>"u"?null:Yt(BigInt.prototype.toString),Kf=typeof Symbol>"u"?null:Yt(Symbol.prototype.toString),Pt=Yt(Object.prototype.hasOwnProperty),vl=Yt(Object.prototype.toString),ds=Yt(RegExp.prototype.test),$n=XC(TypeError);function Yt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return Ed(e,t,a)}}function XC(e){return function(){for(var t=arguments.length,s=new Array(t),a=0;a<t;a++)s[a]=arguments[a];return Ad(e,s)}}function et(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:kl;if(jf&&jf(e,null),!Es(t))return e;let a=t.length;for(;a--;){let n=t[a];if(typeof n=="string"){const i=s(n);i!==n&&(qC(t)||(t[a]=i),n=i)}e[n]=!0}return e}function eT(e){for(let t=0;t<e.length;t++)Pt(e,t)||(e[t]=null);return e}function ys(e){const t=Si(null);for(const a of Og(e)){var s=jC(a,2);const n=s[0],i=s[1];Pt(e,n)&&(Es(i)?t[n]=eT(i):i&&typeof i=="object"&&i.constructor===Object?t[n]=ys(i):t[n]=i)}return t}function tT(e){switch(typeof e){case"string":return e;case"number":return YC(e);case"boolean":return QC(e);case"bigint":return Wf?Wf(e):"0";case"symbol":return Kf?Kf(e):"Symbol()";case"undefined":return vl(e);case"function":case"object":{if(e===null)return vl(e);const t=e,s=Sa(t,"toString");if(typeof s=="function"){const a=s(t);return typeof a=="string"?a:vl(a)}return vl(e)}default:return vl(e)}}function Sa(e,t){for(;e!==null;){const a=WC(e,t);if(a){if(a.get)return Yt(a.get);if(typeof a.value=="function")return Yt(a.value)}e=GC(e)}function s(){return null}return s}function sT(e){try{return ds(e,""),!0}catch{return!1}}const Jf=Ls(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),zc=Ls(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Hc=Ls(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),aT=Ls(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),jc=Ls(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),nT=Ls(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Zf=Ls(["#text"]),Yf=Ls(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Vc=Ls(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Qf=Ls(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Bo=Ls(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),iT=ra(/{{[\w\W]*|^[\w\W]*}}/g),lT=ra(/<%[\w\W]*|^[\w\W]*%>/g),oT=ra(/\${[\w\W]*/g),rT=ra(/^data-[\-\w.\u00B7-\uFFFF]+$/),cT=ra(/^aria-[\-\w]+$/),Xf=ra(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),dT=ra(/^(?:\w+script|data):/i),uT=ra(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),pT=ra(/^html$/i),fT=ra(/^[a-z][.\w]*(-[.\w]+)+$/i),wa={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},mT=function(){return typeof window>"u"?null:window},hT=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let a=null;const n="data-tt-policy-suffix";s&&s.hasAttribute(n)&&(a=s.getAttribute(n));const i="dompurify"+(a?"#"+a:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},em=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Ng(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:mT();const t=Re=>Ng(Re);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==wa.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const a=s,n=a.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,m=Sa(p,"cloneNode"),h=Sa(p,"remove"),b=Sa(p,"nextSibling"),I=Sa(p,"childNodes"),k=Sa(p,"parentNode"),y=Sa(p,"shadowRoot"),g=Sa(p,"attributes"),x=l&&l.prototype?Sa(l.prototype,"nodeType"):null,_=l&&l.prototype?Sa(l.prototype,"nodeName"):null;if(typeof i=="function"){const Re=s.createElement("template");Re.content&&Re.content.ownerDocument&&(s=Re.content.ownerDocument)}let S,E="",R,w=!1,O=0;const B=function(){if(O>0)throw $n('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},T=function(N){B(),O++;try{return S.createHTML(N)}finally{O--}},F=function(N){B(),O++;try{return S.createScriptURL(N)}finally{O--}},X=function(){return w||(R=hT(u,n),w=!0),R},W=s,M=W.implementation,L=W.createNodeIterator,D=W.createDocumentFragment,ie=W.getElementsByTagName,le=a.importNode;let z=em();t.isSupported=typeof Og=="function"&&typeof k=="function"&&M&&M.createHTMLDocument!==void 0;const Y=iT,oe=lT,K=oT,he=rT,fe=cT,J=dT,pe=uT,ve=fT;let ye=Xf,xe=null;const He=et({},[...Jf,...zc,...Hc,...jc,...Zf]);let A=null;const P=et({},[...Yf,...Vc,...Qf,...Bo]);let q=Object.seal(Si(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ue=null,U=null;const Z=Object.seal(Si(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let de=!0,V=!0,te=!1,se=!0,ge=!1,me=!0,ke=!1,we=!1,be=!1,Ke=!1,je=!1,$e=!1,Ge=!0,st=!1;const Ye="user-content-";let Q=!0,Ee=!1,Ae={},Ne=null;const ae=et({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Le=null;const Ue=et({},["audio","video","img","source","image","track"]);let dt=null;const Ut=et({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ft="http://www.w3.org/1998/Math/MathML",yt="http://www.w3.org/2000/svg",Qt="http://www.w3.org/1999/xhtml";let cs=Qt,Xs=!1,ea=null;const Qe=et({},[ft,yt,Qt],Bc);let ca=et({},["mi","mo","mn","ms","mtext"]),hs=et({},["annotation-xml"]);const Ns=et({},["title","style","font","a","script"]);let vs=null;const Tn=["application/xhtml+xml","text/html"],Mt="text/html";let vt=null,Ms=null;const rn=s.createElement("form"),re=function(N){return N instanceof RegExp||N instanceof Function},Ie=function(){let N=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ms&&Ms===N)return;(!N||typeof N!="object")&&(N={}),N=ys(N),vs=Tn.indexOf(N.PARSER_MEDIA_TYPE)===-1?Mt:N.PARSER_MEDIA_TYPE,vt=vs==="application/xhtml+xml"?Bc:kl,xe=Pt(N,"ALLOWED_TAGS")&&Es(N.ALLOWED_TAGS)?et({},N.ALLOWED_TAGS,vt):He,A=Pt(N,"ALLOWED_ATTR")&&Es(N.ALLOWED_ATTR)?et({},N.ALLOWED_ATTR,vt):P,ea=Pt(N,"ALLOWED_NAMESPACES")&&Es(N.ALLOWED_NAMESPACES)?et({},N.ALLOWED_NAMESPACES,Bc):Qe,dt=Pt(N,"ADD_URI_SAFE_ATTR")&&Es(N.ADD_URI_SAFE_ATTR)?et(ys(Ut),N.ADD_URI_SAFE_ATTR,vt):Ut,Le=Pt(N,"ADD_DATA_URI_TAGS")&&Es(N.ADD_DATA_URI_TAGS)?et(ys(Ue),N.ADD_DATA_URI_TAGS,vt):Ue,Ne=Pt(N,"FORBID_CONTENTS")&&Es(N.FORBID_CONTENTS)?et({},N.FORBID_CONTENTS,vt):ae,ue=Pt(N,"FORBID_TAGS")&&Es(N.FORBID_TAGS)?et({},N.FORBID_TAGS,vt):ys({}),U=Pt(N,"FORBID_ATTR")&&Es(N.FORBID_ATTR)?et({},N.FORBID_ATTR,vt):ys({}),Ae=Pt(N,"USE_PROFILES")?N.USE_PROFILES&&typeof N.USE_PROFILES=="object"?ys(N.USE_PROFILES):N.USE_PROFILES:!1,de=N.ALLOW_ARIA_ATTR!==!1,V=N.ALLOW_DATA_ATTR!==!1,te=N.ALLOW_UNKNOWN_PROTOCOLS||!1,se=N.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ge=N.SAFE_FOR_TEMPLATES||!1,me=N.SAFE_FOR_XML!==!1,ke=N.WHOLE_DOCUMENT||!1,Ke=N.RETURN_DOM||!1,je=N.RETURN_DOM_FRAGMENT||!1,$e=N.RETURN_TRUSTED_TYPE||!1,be=N.FORCE_BODY||!1,Ge=N.SANITIZE_DOM!==!1,st=N.SANITIZE_NAMED_PROPS||!1,Q=N.KEEP_CONTENT!==!1,Ee=N.IN_PLACE||!1,ye=sT(N.ALLOWED_URI_REGEXP)?N.ALLOWED_URI_REGEXP:Xf,cs=typeof N.NAMESPACE=="string"?N.NAMESPACE:Qt,ca=Pt(N,"MATHML_TEXT_INTEGRATION_POINTS")&&N.MATHML_TEXT_INTEGRATION_POINTS&&typeof N.MATHML_TEXT_INTEGRATION_POINTS=="object"?ys(N.MATHML_TEXT_INTEGRATION_POINTS):et({},["mi","mo","mn","ms","mtext"]),hs=Pt(N,"HTML_INTEGRATION_POINTS")&&N.HTML_INTEGRATION_POINTS&&typeof N.HTML_INTEGRATION_POINTS=="object"?ys(N.HTML_INTEGRATION_POINTS):et({},["annotation-xml"]);const ce=Pt(N,"CUSTOM_ELEMENT_HANDLING")&&N.CUSTOM_ELEMENT_HANDLING&&typeof N.CUSTOM_ELEMENT_HANDLING=="object"?ys(N.CUSTOM_ELEMENT_HANDLING):Si(null);if(q=Si(null),Pt(ce,"tagNameCheck")&&re(ce.tagNameCheck)&&(q.tagNameCheck=ce.tagNameCheck),Pt(ce,"attributeNameCheck")&&re(ce.attributeNameCheck)&&(q.attributeNameCheck=ce.attributeNameCheck),Pt(ce,"allowCustomizedBuiltInElements")&&typeof ce.allowCustomizedBuiltInElements=="boolean"&&(q.allowCustomizedBuiltInElements=ce.allowCustomizedBuiltInElements),ge&&(V=!1),je&&(Ke=!0),Ae&&(xe=et({},Zf),A=Si(null),Ae.html===!0&&(et(xe,Jf),et(A,Yf)),Ae.svg===!0&&(et(xe,zc),et(A,Vc),et(A,Bo)),Ae.svgFilters===!0&&(et(xe,Hc),et(A,Vc),et(A,Bo)),Ae.mathMl===!0&&(et(xe,jc),et(A,Qf),et(A,Bo))),Z.tagCheck=null,Z.attributeCheck=null,Pt(N,"ADD_TAGS")&&(typeof N.ADD_TAGS=="function"?Z.tagCheck=N.ADD_TAGS:Es(N.ADD_TAGS)&&(xe===He&&(xe=ys(xe)),et(xe,N.ADD_TAGS,vt))),Pt(N,"ADD_ATTR")&&(typeof N.ADD_ATTR=="function"?Z.attributeCheck=N.ADD_ATTR:Es(N.ADD_ATTR)&&(A===P&&(A=ys(A)),et(A,N.ADD_ATTR,vt))),Pt(N,"ADD_URI_SAFE_ATTR")&&Es(N.ADD_URI_SAFE_ATTR)&&et(dt,N.ADD_URI_SAFE_ATTR,vt),Pt(N,"FORBID_CONTENTS")&&Es(N.FORBID_CONTENTS)&&(Ne===ae&&(Ne=ys(Ne)),et(Ne,N.FORBID_CONTENTS,vt)),Pt(N,"ADD_FORBID_CONTENTS")&&Es(N.ADD_FORBID_CONTENTS)&&(Ne===ae&&(Ne=ys(Ne)),et(Ne,N.ADD_FORBID_CONTENTS,vt)),Q&&(xe["#text"]=!0),ke&&et(xe,["html","head","body"]),xe.table&&(et(xe,["tbody"]),delete ue.tbody),N.TRUSTED_TYPES_POLICY){if(typeof N.TRUSTED_TYPES_POLICY.createHTML!="function")throw $n('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof N.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw $n('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const _e=S;S=N.TRUSTED_TYPES_POLICY;try{E=T("")}catch(Fe){throw S=_e,Fe}}else N.TRUSTED_TYPES_POLICY===null?(S=void 0,E=""):(S===void 0&&(S=X()),S&&typeof E=="string"&&(E=T("")));(z.uponSanitizeElement.length>0||z.uponSanitizeAttribute.length>0)&&xe===He&&(xe=ys(xe)),z.uponSanitizeAttribute.length>0&&A===P&&(A=ys(A)),Ls&&Ls(N),Ms=N},Be=et({},[...zc,...Hc,...aT]),nt=et({},[...jc,...nT]),kt=function(N){let ce=k(N);(!ce||!ce.tagName)&&(ce={namespaceURI:cs,tagName:"template"});const _e=kl(N.tagName),Fe=kl(ce.tagName);return ea[N.namespaceURI]?N.namespaceURI===yt?ce.namespaceURI===Qt?_e==="svg":ce.namespaceURI===ft?_e==="svg"&&(Fe==="annotation-xml"||ca[Fe]):!!Be[_e]:N.namespaceURI===ft?ce.namespaceURI===Qt?_e==="math":ce.namespaceURI===yt?_e==="math"&&hs[Fe]:!!nt[_e]:N.namespaceURI===Qt?ce.namespaceURI===yt&&!hs[Fe]||ce.namespaceURI===ft&&!ca[Fe]?!1:!nt[_e]&&(Ns[_e]||!Be[_e]):!!(vs==="application/xhtml+xml"&&ea[N.namespaceURI]):!1},ut=function(N){yi(t.removed,{element:N});try{k(N).removeChild(N)}catch{if(h(N),!k(N))throw $n("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},ba=function(N){const ce=I?I(N):N.childNodes;if(ce){const Fe=[];Ba(ce,qe=>{yi(Fe,qe)}),Ba(Fe,qe=>{try{h(qe)}catch{}})}const _e=g?g(N):null;if(_e)for(let Fe=_e.length-1;Fe>=0;--Fe){const qe=_e[Fe],Ze=qe&&qe.name;if(typeof Ze=="string")try{N.removeAttribute(Ze)}catch{}}},Ds=function(N,ce){try{yi(t.removed,{attribute:ce.getAttributeNode(N),from:ce})}catch{yi(t.removed,{attribute:null,from:ce})}if(ce.removeAttribute(N),N==="is")if(Ke||je)try{ut(ce)}catch{}else try{ce.setAttribute(N,"")}catch{}},ii=function(N){const ce=g?g(N):N.attributes;if(ce)for(let _e=ce.length-1;_e>=0;--_e){const Fe=ce[_e],qe=Fe&&Fe.name;if(!(typeof qe!="string"||A[vt(qe)]))try{N.removeAttribute(qe)}catch{}}},En=function(N){const ce=[N];for(;ce.length>0;){const _e=ce.pop();(x?x(_e):_e.nodeType)===wa.element&&ii(_e);const qe=I?I(_e):_e.childNodes;if(qe)for(let Ze=qe.length-1;Ze>=0;--Ze)ce.push(qe[Ze])}},cn=function(N){let ce=null,_e=null;if(be)N="<remove></remove>"+N;else{const Ze=qf(N,/^[\r\n\t ]+/);_e=Ze&&Ze[0]}vs==="application/xhtml+xml"&&cs===Qt&&(N='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+N+"</body></html>");const Fe=S?T(N):N;if(cs===Qt)try{ce=new d().parseFromString(Fe,vs)}catch{}if(!ce||!ce.documentElement){ce=M.createDocument(cs,"template",null);try{ce.documentElement.innerHTML=Xs?E:Fe}catch{}}const qe=ce.body||ce.documentElement;return N&&_e&&qe.insertBefore(s.createTextNode(_e),qe.childNodes[0]||null),cs===Qt?ie.call(ce,ke?"html":"body")[0]:ke?ce.documentElement:qe},An=function(N){return L.call(N.ownerDocument||N,N,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},da=function(N){var ce,_e;N.normalize();const Fe=L.call(N.ownerDocument||N,N,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let qe=Fe.nextNode();for(;qe;){let Et=qe.data;Ba([Y,oe,K],pt=>{Et=xi(Et,pt," ")}),qe.data=Et,qe=Fe.nextNode()}const Ze=(ce=(_e=N.querySelectorAll)===null||_e===void 0?void 0:_e.call(N,"template"))!==null&&ce!==void 0?ce:[];Ba(Array.from(Ze),Et=>{Vt(Et.content)&&da(Et.content)})},ya=function(N){const ce=_?_(N):null;return typeof ce!="string"||vt(ce)!=="form"?!1:typeof N.nodeName!="string"||typeof N.textContent!="string"||typeof N.removeChild!="function"||N.attributes!==g(N)||typeof N.removeAttribute!="function"||typeof N.setAttribute!="function"||typeof N.namespaceURI!="string"||typeof N.insertBefore!="function"||typeof N.hasChildNodes!="function"||N.nodeType!==x(N)||N.childNodes!==I(N)},Vt=function(N){if(!x||typeof N!="object"||N===null)return!1;try{return x(N)===wa.documentFragment}catch{return!1}},ua=function(N){if(!x||typeof N!="object"||N===null)return!1;try{return typeof x(N)=="number"}catch{return!1}};function as(Re,N,ce){Ba(Re,_e=>{_e.call(t,N,ce,Ms)})}const dn=function(N){let ce=null;if(as(z.beforeSanitizeElements,N,null),ya(N))return ut(N),!0;const _e=vt(_?_(N):N.nodeName);if(as(z.uponSanitizeElement,N,{tagName:_e,allowedTags:xe}),me&&N.hasChildNodes()&&!ua(N.firstElementChild)&&ds(/<[/\w!]/g,N.innerHTML)&&ds(/<[/\w!]/g,N.textContent)||me&&N.namespaceURI===Qt&&_e==="style"&&ua(N.firstElementChild)||N.nodeType===wa.progressingInstruction||me&&N.nodeType===wa.comment&&ds(/<[/\w]/g,N.data))return ut(N),!0;if(ue[_e]||!(Z.tagCheck instanceof Function&&Z.tagCheck(_e))&&!xe[_e]){if(!ue[_e]&&oi(_e)&&(q.tagNameCheck instanceof RegExp&&ds(q.tagNameCheck,_e)||q.tagNameCheck instanceof Function&&q.tagNameCheck(_e)))return!1;if(Q&&!Ne[_e]){const qe=k(N),Ze=I(N);if(Ze&&qe){const Et=Ze.length;for(let pt=Et-1;pt>=0;--pt){const At=Ee?Ze[pt]:m(Ze[pt],!0);qe.insertBefore(At,b(N))}}}return ut(N),!0}return(x?x(N):N.nodeType)===wa.element&&!kt(N)||(_e==="noscript"||_e==="noembed"||_e==="noframes")&&ds(/<\/no(script|embed|frames)/i,N.innerHTML)?(ut(N),!0):(ge&&N.nodeType===wa.text&&(ce=N.textContent,Ba([Y,oe,K],qe=>{ce=xi(ce,qe," ")}),N.textContent!==ce&&(yi(t.removed,{element:N.cloneNode()}),N.textContent=ce)),as(z.afterSanitizeElements,N,null),!1)},Rn=function(N,ce,_e){if(U[ce]||Ge&&(ce==="id"||ce==="name")&&(_e in s||_e in rn))return!1;const Fe=A[ce]||Z.attributeCheck instanceof Function&&Z.attributeCheck(ce,N);if(!(V&&!U[ce]&&ds(he,ce))){if(!(de&&ds(fe,ce))){if(!Fe||U[ce]){if(!(oi(N)&&(q.tagNameCheck instanceof RegExp&&ds(q.tagNameCheck,N)||q.tagNameCheck instanceof Function&&q.tagNameCheck(N))&&(q.attributeNameCheck instanceof RegExp&&ds(q.attributeNameCheck,ce)||q.attributeNameCheck instanceof Function&&q.attributeNameCheck(ce,N))||ce==="is"&&q.allowCustomizedBuiltInElements&&(q.tagNameCheck instanceof RegExp&&ds(q.tagNameCheck,_e)||q.tagNameCheck instanceof Function&&q.tagNameCheck(_e))))return!1}else if(!dt[ce]){if(!ds(ye,xi(_e,pe,""))){if(!((ce==="src"||ce==="xlink:href"||ce==="href")&&N!=="script"&&Gf(_e,"data:")===0&&Le[N])){if(!(te&&!ds(J,xi(_e,pe,"")))){if(_e)return!1}}}}}}return!0},li=et({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),oi=function(N){return!li[kl(N)]&&ds(ve,N)},ri=function(N){as(z.beforeSanitizeAttributes,N,null);const ce=N.attributes;if(!ce||ya(N))return;const _e={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:A,forceKeepAttr:void 0};let Fe=ce.length;for(;Fe--;){const qe=ce[Fe],Ze=qe.name,Et=qe.namespaceURI,pt=qe.value,At=vt(Ze),gs=pt;let Nt=Ze==="value"?gs:ZC(gs);if(_e.attrName=At,_e.attrValue=Nt,_e.keepAttr=!0,_e.forceKeepAttr=void 0,as(z.uponSanitizeAttribute,N,_e),Nt=_e.attrValue,st&&(At==="id"||At==="name")&&Gf(Nt,Ye)!==0&&(Ds(Ze,N),Nt=Ye+Nt),me&&ds(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Nt)){Ds(Ze,N);continue}if(At==="attributename"&&qf(Nt,"href")){Ds(Ze,N);continue}if(_e.forceKeepAttr)continue;if(!_e.keepAttr){Ds(Ze,N);continue}if(!se&&ds(/\/>/i,Nt)){Ds(Ze,N);continue}ge&&Ba([Y,oe,K],ci=>{Nt=xi(Nt,ci," ")});const Na=vt(N.nodeName);if(!Rn(Na,At,Nt)){Ds(Ze,N);continue}if(S&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!Et)switch(u.getAttributeType(Na,At)){case"TrustedHTML":{Nt=T(Nt);break}case"TrustedScriptURL":{Nt=F(Nt);break}}if(Nt!==gs)try{Et?N.setAttributeNS(Et,Ze,Nt):N.setAttribute(Ze,Nt),ya(N)?ut(N):Vf(t.removed)}catch{Ds(Ze,N)}}as(z.afterSanitizeAttributes,N,null)},ns=function(N){let ce=null;const _e=An(N);for(as(z.beforeSanitizeShadowDOM,N,null);ce=_e.nextNode();)if(as(z.uponSanitizeShadowNode,ce,null),dn(ce),ri(ce),Vt(ce.content)&&ns(ce.content),(x?x(ce):ce.nodeType)===wa.element){const qe=y?y(ce):ce.shadowRoot;Vt(qe)&&(In(qe),ns(qe))}as(z.afterSanitizeShadowDOM,N,null)},In=function(N){const ce=[{node:N,shadow:null}];for(;ce.length>0;){const _e=ce.pop();if(_e.shadow){ns(_e.shadow);continue}const Fe=_e.node,Ze=(x?x(Fe):Fe.nodeType)===wa.element,Et=I?I(Fe):Fe.childNodes;if(Et)for(let pt=Et.length-1;pt>=0;--pt)ce.push({node:Et[pt],shadow:null});if(Ze){const pt=_?_(Fe):null;if(typeof pt=="string"&&vt(pt)==="template"){const At=Fe.content;Vt(At)&&ce.push({node:At,shadow:null})}}if(Ze){const pt=y?y(Fe):Fe.shadowRoot;Vt(pt)&&ce.push({node:null,shadow:pt},{node:pt,shadow:null})}}};return t.sanitize=function(Re){let N=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},ce=null,_e=null,Fe=null,qe=null;if(Xs=!Re,Xs&&(Re="<!-->"),typeof Re!="string"&&!ua(Re)&&(Re=tT(Re),typeof Re!="string"))throw $n("dirty is not a string, aborting");if(!t.isSupported)return Re;we||Ie(N),t.removed=[];const Ze=Ee&&typeof Re!="string"&&ua(Re);if(Ze){const At=_?_(Re):Re.nodeName;if(typeof At=="string"){const gs=vt(At);if(!xe[gs]||ue[gs])throw $n("root node is forbidden and cannot be sanitized in-place")}if(ya(Re))throw $n("root node is clobbered and cannot be sanitized in-place");try{In(Re)}catch(gs){throw ba(Re),gs}}else if(ua(Re))ce=cn("<!---->"),_e=ce.ownerDocument.importNode(Re,!0),_e.nodeType===wa.element&&_e.nodeName==="BODY"||_e.nodeName==="HTML"?ce=_e:ce.appendChild(_e),In(_e);else{if(!Ke&&!ge&&!ke&&Re.indexOf("<")===-1)return S&&$e?T(Re):Re;if(ce=cn(Re),!ce)return Ke?null:$e?E:""}ce&&be&&ut(ce.firstChild);const Et=An(Ze?Re:ce);try{for(;Fe=Et.nextNode();)dn(Fe),ri(Fe),Vt(Fe.content)&&ns(Fe.content)}catch(At){throw Ze&&ba(Re),At}if(Ze)return Ba(t.removed,At=>{At.element&&En(At.element)}),ge&&da(Re),Re;if(Ke){if(ge&&da(ce),je)for(qe=D.call(ce.ownerDocument);ce.firstChild;)qe.appendChild(ce.firstChild);else qe=ce;return(A.shadowroot||A.shadowrootmode)&&(qe=le.call(a,qe,!0)),qe}let pt=ke?ce.outerHTML:ce.innerHTML;return ke&&xe["!doctype"]&&ce.ownerDocument&&ce.ownerDocument.doctype&&ce.ownerDocument.doctype.name&&ds(pT,ce.ownerDocument.doctype.name)&&(pt="<!DOCTYPE "+ce.ownerDocument.doctype.name+`>
`+pt),ge&&Ba([Y,oe,K],At=>{pt=xi(pt,At," ")}),S&&$e?T(pt):pt},t.setConfig=function(){let Re=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Ie(Re),we=!0},t.clearConfig=function(){Ms=null,we=!1,S=R,E=""},t.isValidAttribute=function(Re,N,ce){Ms||Ie({});const _e=vt(Re),Fe=vt(N);return Rn(_e,Fe,ce)},t.addHook=function(Re,N){typeof N=="function"&&yi(z[Re],N)},t.removeHook=function(Re,N){if(N!==void 0){const ce=KC(z[Re],N);return ce===-1?void 0:JC(z[Re],ce,1)[0]}return Vf(z[Re])},t.removeHooks=function(Re){z[Re]=[]},t.removeAllHooks=function(){z=em()},t}var tm=Ng();function Mu(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ni=Mu();function Mg(e){ni=e}var Ll={exec:()=>null};function _t(e,t=""){let s=typeof e=="string"?e:e.source;const a={replace:(n,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Is.caret,"$1"),s=s.replace(n,l),a},getRegex:()=>new RegExp(s,t)};return a}var Is={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},vT=/^(?:[ \t]*(?:\n|$))+/,gT=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,bT=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,fo=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,yT=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Du=/(?:[*+-]|\d{1,9}[.)])/,Dg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Pg=_t(Dg).replace(/bull/g,Du).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),xT=_t(Dg).replace(/bull/g,Du).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Pu=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,_T=/^[^\n]+/,$u=/(?!\s*\])(?:\\.|[^\[\]\\])+/,wT=_t(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",$u).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),kT=_t(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Du).getRegex(),tc="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Fu=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ST=_t("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Fu).replace("tag",tc).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),$g=_t(Pu).replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex(),CT=_t(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",$g).getRegex(),Uu={blockquote:CT,code:gT,def:wT,fences:bT,heading:yT,hr:fo,html:ST,lheading:Pg,list:kT,newline:vT,paragraph:$g,table:Ll,text:_T},sm=_t("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex(),TT={...Uu,lheading:xT,table:sm,paragraph:_t(Pu).replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",sm).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex()},ET={...Uu,html:_t(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Fu).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ll,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:_t(Pu).replace("hr",fo).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Pg).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},AT=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,RT=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Fg=/^( {2,}|\\)\n(?!\s*$)/,IT=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,sc=/[\p{P}\p{S}]/u,Bu=/[\s\p{P}\p{S}]/u,Ug=/[^\s\p{P}\p{S}]/u,OT=_t(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Bu).getRegex(),Bg=/(?!~)[\p{P}\p{S}]/u,LT=/(?!~)[\s\p{P}\p{S}]/u,NT=/(?:[^\s\p{P}\p{S}]|~)/u,MT=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,zg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,DT=_t(zg,"u").replace(/punct/g,sc).getRegex(),PT=_t(zg,"u").replace(/punct/g,Bg).getRegex(),Hg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",$T=_t(Hg,"gu").replace(/notPunctSpace/g,Ug).replace(/punctSpace/g,Bu).replace(/punct/g,sc).getRegex(),FT=_t(Hg,"gu").replace(/notPunctSpace/g,NT).replace(/punctSpace/g,LT).replace(/punct/g,Bg).getRegex(),UT=_t("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Ug).replace(/punctSpace/g,Bu).replace(/punct/g,sc).getRegex(),BT=_t(/\\(punct)/,"gu").replace(/punct/g,sc).getRegex(),zT=_t(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),HT=_t(Fu).replace("(?:-->|$)","-->").getRegex(),jT=_t("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",HT).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Sr=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,VT=_t(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Sr).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),jg=_t(/^!?\[(label)\]\[(ref)\]/).replace("label",Sr).replace("ref",$u).getRegex(),Vg=_t(/^!?\[(ref)\](?:\[\])?/).replace("ref",$u).getRegex(),qT=_t("reflink|nolink(?!\\()","g").replace("reflink",jg).replace("nolink",Vg).getRegex(),zu={_backpedal:Ll,anyPunctuation:BT,autolink:zT,blockSkip:MT,br:Fg,code:RT,del:Ll,emStrongLDelim:DT,emStrongRDelimAst:$T,emStrongRDelimUnd:UT,escape:AT,link:VT,nolink:Vg,punctuation:OT,reflink:jg,reflinkSearch:qT,tag:jT,text:IT,url:Ll},GT={...zu,link:_t(/^!?\[(label)\]\((.*?)\)/).replace("label",Sr).getRegex(),reflink:_t(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Sr).getRegex()},Rd={...zu,emStrongRDelimAst:FT,emStrongLDelim:PT,url:_t(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},WT={...Rd,br:_t(Fg).replace("{2,}","*").getRegex(),text:_t(Rd.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},zo={normal:Uu,gfm:TT,pedantic:ET},gl={normal:zu,gfm:Rd,breaks:WT,pedantic:GT},KT={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},am=e=>KT[e];function Ca(e,t){if(t){if(Is.escapeTest.test(e))return e.replace(Is.escapeReplace,am)}else if(Is.escapeTestNoEncode.test(e))return e.replace(Is.escapeReplaceNoEncode,am);return e}function nm(e){try{e=encodeURI(e).replace(Is.percentDecode,"%")}catch{return null}return e}function im(e,t){var i;const s=e.replace(Is.findPipe,(l,o,r)=>{let c=!1,d=o;for(;--d>=0&&r[d]==="\\";)c=!c;return c?"|":" |"}),a=s.split(Is.splitPipe);let n=0;if(a[0].trim()||a.shift(),a.length>0&&!((i=a.at(-1))!=null&&i.trim())&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;n<a.length;n++)a[n]=a[n].trim().replace(Is.slashPipe,"|");return a}function bl(e,t,s){const a=e.length;if(a===0)return"";let n=0;for(;n<a&&e.charAt(a-n-1)===t;)n++;return e.slice(0,a-n)}function JT(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let a=0;a<e.length;a++)if(e[a]==="\\")a++;else if(e[a]===t[0])s++;else if(e[a]===t[1]&&(s--,s<0))return a;return s>0?-2:-1}function lm(e,t,s,a,n){const i=t.href,l=t.title||null,o=e[1].replace(n.other.outputLinkReplace,"$1");a.state.inLink=!0;const r={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:o,tokens:a.inlineTokens(o)};return a.state.inLink=!1,r}function ZT(e,t,s){const a=e.match(s.other.indentCodeCompensation);if(a===null)return t;const n=a[1];return t.split(`
...
`,e=e.substring(p.length+1),r=!0),!r){const k=this.rules.other.nextBulletRegex(h),y=this.rules.other.hrRegex(h),g=this.rules.other.fencesBeginRegex(h),x=this.rules.other.headingBeginRegex(h),_=this.rules.other.htmlBeginRegex(h);for(;e;){const S=e.split(`
`,1)[0];let E;if(p=S,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),E=p):E=p.replace(this.rules.other.tabCharGlobal,"    "),g.test(p)||x.test(p)||_.test(p)||k.test(p)||y.test(p))break;if(E.search(this.rules.other.nonSpaceChar)>=h||!p.trim())d+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+Ca(s.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(s);throw s}}},Qn=new YT;function bt(e,t){return Qn.parse(e,t)}bt.options=bt.setOptions=function(e){return Qn.setOptions(e),bt.defaults=Qn.defaults,Mg(bt.defaults),bt};bt.getDefaults=Mu;bt.defaults=ni;bt.use=function(...e){return Qn.use(...e),bt.defaults=Qn.defaults,Mg(bt.defaults),bt};bt.walkTokens=function(e,t){return Qn.walkTokens(e,t)};bt.parseInline=Qn.parseInline;bt.Parser=Ja;bt.parser=Ja.parse;bt.Renderer=Tr;bt.TextRenderer=Hu;bt.Lexer=Ka;bt.lexer=Ka.lex;bt.Tokenizer=Cr;bt.Hooks=Jo;bt.parse=bt;bt.options;bt.setOptions;bt.use;bt.walkTokens;bt.parseInline;Ja.parse;Ka.lex;const QT={breaks:!0,gfm:!0};function om(e){if(!e)return"";try{if(typeof bt<"u"&&bt.parse){const t=bt.parse(e,QT);return typeof tm<"u"?tm.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function XT(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),a=t.getMinutes().toString().padStart(2,"0");return`${s}:${a}`}const eE={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function tE(e){return eE[e]||"wrench"}const sE=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function rm(e){if(!e)return[];const t=e.match(sE);return t?[...new Set(t)]:[]}const aE={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),a=f(""),n=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=j(()=>t.value.trim().length>0&&!s.value),p=f(ct.state||"disconnected");let m=null;const h=j(()=>{const M=p.value;return M==="connected"?"Connected":M==="reconnecting"?"Reconnecting…":M==="connecting"?"Connecting…":"REST fallback"}),b=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],I=j(()=>{const M=Math.floor(l.value/4)%b.length,L=l.value;return L>3?`${b[M]} (${L}s)`:b[0]});function k(){Ht(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!i.value)return;const M=i.value;M.style.height="auto",M.style.height=Math.min(M.scrollHeight,120)+"px"}function g(M,L,D={}){const ie={id:++c,role:M,content:L,timestamp:Date.now(),html:M==="bot"?om(L):"",tools_used:D.tools_used||[],is_error:D.is_error||!1,images:M==="bot"?rm(L):[],files:D.files||[],_showTools:!1};return e.value.push(ie),k(),M==="bot"&&Ht(()=>x()),ie}function x(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(L=>{L.setAttribute("data-copy","true"),L.style.position="relative";const D=document.createElement("button");D.className="chat-code-copy",D.textContent="Copy",D.addEventListener("click",()=>{const ie=L.querySelector("code"),le=ie?ie.textContent:L.textContent;navigator.clipboard.writeText(le).then(()=>{D.textContent="Copied!",setTimeout(()=>{D.textContent="Copy"},1500)}).catch(()=>{})}),L.appendChild(D)})}function _(M){if(M===0)return!0;const L=e.value[M-1],D=e.value[M],ie=new Date(L.timestamp).toDateString(),le=new Date(D.timestamp).toDateString();return ie!==le}function S(M){const L=new Date(M),D=new Date;if(L.toDateString()===D.toDateString())return"Today";const ie=new Date(D);return ie.setDate(ie.getDate()-1),L.toDateString()===ie.toDateString()?"Yesterday":L.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function E(M){t.value=M,Ht(()=>X())}function R(M){window.open(M,"_blank","noopener")}function w(M){M.target.style.display="none"}function O(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function B(){r&&(clearInterval(r),r=null),l.value=0}function T(M){s.value&&(s.value=!1,B(),M.type==="chat_response"?g("bot",M.content,{tools_used:M.tools_used||[],is_error:M.is_error||!1,files:M.files||[]}):M.type==="chat_error"&&g("bot",M.error||"Unknown error",{is_error:!0}),Ht(()=>{var L;return(L=i.value)==null?void 0:L.focus()}))}async function F(M){try{const L=await H.post("/api/chat",{content:M,channel_id:o.value});g("bot",L.response,{tools_used:L.tools_used||[],is_error:L.is_error||!1,files:L.files||[]})}catch(L){g("bot",L.message||"Failed to send message",{is_error:!0})}}async function X(){const M=t.value.trim();if(!M||s.value)return;g("user",M),t.value="",s.value=!0,O(),i.value&&(i.value.style.height="auto"),ct.connected&&ct.sendChat(M,{channelId:o.value})||(await F(M),s.value=!1,B()),Ht(()=>{var D;return(D=i.value)==null?void 0:D.focus()})}async function W(){a.value="";try{if(!o.value){const L=await H.get("/api/auth/session");o.value=L.channel_id||L.user_id||"web-user"}const M=await H.get("/api/sessions/"+encodeURIComponent(o.value));if(M&&M.messages&&M.messages.length>0){for(const L of M.messages){const D=L.role==="user"?"user":"bot";let ie=L.content||"";if(D==="user"){const z=ie.match(/^\[.*?\]:\s*/);z&&(ie=ie.slice(z[0].length))}if(!ie.trim())continue;const le={id:++c,role:D,content:ie,timestamp:L.timestamp?L.timestamp*1e3:Date.now(),html:D==="bot"?om(ie):"",tools_used:[],is_error:!1,images:D==="bot"?rm(ie):[],files:[],_showTools:!1};e.value.push(le)}Ht(()=>{k(),x()})}}catch(M){M&&M.status!==404&&(a.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",Te.error(a.value))}}return tt(()=>{ct.subscribe("chat",T),p.value=ct.state||"disconnected",m=ct.onState(M=>{p.value=M}),W(),Ht(()=>{var M;return(M=i.value)==null?void 0:M.focus()})}),wt(()=>{ct.unsubscribe("chat",T),m&&(m(),m=null),B()}),{messages:e,input:t,sending:s,historyError:a,messagesEl:n,inputEl:i,canSend:u,wsStatus:h,typingText:I,suggestions:d,send:X,autoResize:y,formatTime:XT,formatDate:S,showDateSeparator:_,useSuggestion:E,openImage:R,onImageError:w,getToolIcon:tE,loadHistory:W}}},nE={setup(){const e=f("odin"),t=f(""),s=f(""),a=f(""),n=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),m=f(!1),h=j(()=>e.value==="custom"),b=j(()=>[...i.value,...l.value]),I=j(()=>l.value.includes(e.value)),k=j(()=>{var R;return h.value?t.value||"Odin":((R=n.value[e.value])==null?void 0:R.name)||e.value}),y=j(()=>{var R;return h.value?s.value||"(empty — will use Odin default)":((R=n.value[e.value])==null?void 0:R.identity)||""}),g=j(()=>{var R;return h.value?a.value||"(empty — will use Odin default)":((R=n.value[e.value])==null?void 0:R.voice)||""});async function x(){d.value=!0;try{const R=await H.get("/api/personality");e.value=R.preset||"odin",t.value=R.custom_name||"",s.value=R.custom_identity||"",a.value=R.custom_voice||"",n.value=R.presets||{},i.value=R.builtin_presets||[],l.value=R.user_presets||[]}catch(R){c.value=R.message}finally{d.value=!1}}async function _(){o.value=!0,c.value=null,r.value=!1;try{await H.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:a.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(R){c.value=R.message}finally{o.value=!1}}async function S(){const R=u.value.trim();if(R){m.value=!0,c.value=null;try{await H.post("/api/personality/presets",{name:R,display_name:k.value,identity:y.value,voice:g.value}),p.value=!1,u.value="",await x(),e.value=R.toLowerCase().replace(/ /g,"_")}catch(w){c.value=w.message}finally{m.value=!1}}}async function E(){if(await os({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await H.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(w){c.value=w.message}}}return tt(x),{preset:e,customName:t,customIdentity:s,customVoice:a,presets:n,presetNames:b,isCustom:h,isUserPreset:I,previewName:k,previewIdentity:y,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:_,showSavePreset:p,newPresetName:u,savingPreset:m,saveAsPreset:S,deletePreset:E,builtinPresets:i,userPresets:l}},template:`
  ...
  `},iE={props:["onComplete"],template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=f(""),s=f(null),a=f(!1),n=f(!1);async function i(){a.value=!0,s.value=null;try{H.setPersist(n.value),await H.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{a.value=!1}}return{token:t,error:s,busy:a,persist:n,login:i}}},oE={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),a=f(!1),n=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let m=null;const h=f("starting"),b=f(""),I=qg.filter(z=>z.meta),k=j(()=>["Workspace","Operate","Observe","Manage"].map(z=>({name:z,routes:I.filter(Y=>Y.meta.section===z)})).filter(z=>z.routes.length)),y=j(()=>{var z;return((z=Nl.currentRoute.value.meta)==null?void 0:z.label)||"Odin"}),g=j(()=>{var z;return((z=Nl.currentRoute.value.meta)==null?void 0:z.section)||"Management"}),x=j(()=>{var z;return((z=Nl.currentRoute.value.meta)==null?void 0:z.description)||"Management console"});function _(){ct.disconnect(),M&&(clearInterval(M),M=null)}H.onSessionExpired=()=>{t.value=!0,_(),H.setToken(""),e.value="login"};function S(z){var Y;if((z.ctrlKey||z.metaKey)&&z.key.toLowerCase()==="k"){e.value==="ready"&&(z.preventDefault(),Bf());return}if(a.value&&z.key==="Tab"){const oe=[...((Y=n.value)==null?void 0:Y.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(oe.length){const K=oe[0],he=oe[oe.length-1];if(z.shiftKey&&(document.activeElement===K||!n.value.contains(document.activeElement))){z.preventDefault(),he.focus();return}if(!z.shiftKey&&(document.activeElement===he||!n.value.contains(document.activeElement))){z.preventDefault(),K.focus();return}}}if(z.key==="Escape"&&a.value){a.value=!1,z.preventDefault();return}if(z.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(z.target.tagName)){z.preventDefault();const oe=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');oe&&oe.focus()}}function E(){l.value=!!(o!=null&&o.matches),l.value||(a.value=!1)}async function R(){try{const z=await H.get("/api/setup/status");if(z.mode==="pending"||z.needed===!0)return _(),e.value="setup",!0}catch(z){z==null||z.name}return!1}tt(async()=>{if(document.addEventListener("keydown",S),o=window.matchMedia("(max-width: 900px)"),E(),o.addEventListener("change",E),await R())return;const z=await H.check();z.ok?(e.value="ready",ie()):z.needsAuth?e.value="login":(e.value="ready",ie())});function w(){t.value=!1,e.value="ready",ie()}async function O(){if(await R())return;const z=await H.check();z.ok?(e.value="ready",ie()):z.needsAuth?e.value="login":(e.value="ready",ie())}async function B(){_(),e.value="login",await H.logout()}function T(){s.value=!s.value}function F(){a.value=!a.value}Jt(a,async z=>{var Y,oe;if(z)r=document.activeElement,await Ht(),(oe=(Y=n.value)==null?void 0:Y.querySelector(".nav-item"))==null||oe.focus();else if(r!=null&&r.isConnected){const K=r;r=null,requestAnimationFrame(()=>K.focus())}});const X=j(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function W(z,Y="info",oe=3e3){p.value={text:z,level:Y},clearTimeout(m),m=setTimeout(()=>{p.value=null},oe)}let M=null,L=!1,D=[];function ie(){for(const z of D)z();D=[ct.onStatus(z=>{c.value=z}),ct.onLatencyChange(z=>{u.value=z}),ct.onState((z,Y)=>{d.value=z,z==="connected"?(L&&W("Connection restored","success"),L=!0):z==="reconnecting"&&Y.attempt===1&&W("Connection lost — reconnecting…","warn")})],ct.connect(),le(),M&&clearInterval(M),M=setInterval(le,15e3)}async function le(){try{const z=await H.get("/api/status");h.value=z.status==="online"?"online":"starting";const Y=z.uptime_seconds||0,oe=Math.floor(Y/3600),K=Math.floor(Y%3600/60);b.value=`${oe}h ${K}m uptime`}catch{h.value="offline",b.value=""}}return wt(()=>{M&&clearInterval(M);for(const z of D)z();D=[],ct.disconnect(),document.removeEventListener("keydown",S),o==null||o.removeEventListener("change",E)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:a,wsConnected:c,wsState:d,wsLatency:u,wsLabel:X,wsToast:p,botStatus:h,botUptime:b,navRoutes:I,navGroups:k,currentPage:y,currentSection:g,currentDescription:x,sidebarEl:n,mobileMenuButton:i,isMobileViewport:l,onLogin:w,onSetupComplete:O,logout:B,toggleSidebar:T,toggleMobileNavigation:F,openPalette:Bf}}},on=fr(oE);on.component("odin-icon",PC);on.component("login-screen",lE);on.component("setup-page",iE);on.component("toast-container",Ck);on.component("confirm-host",Tk);on.component("command-palette",DC);on.directive("modal-focus",FC);on.use(Nl);on.mount("#app");
