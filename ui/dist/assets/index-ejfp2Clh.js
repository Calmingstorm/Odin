...
`,-1)}h0(e.hoists,t),i(),a("return ")}function Ar(e,t,{helper:s,push:n,newline:a,isTS:i}){const l=s(t==="filter"?oc:t==="component"?ic:rc);for(let r=0;r<e.length;r++){let o=e[r];const c=o.endsWith("__self");c&&(o=o.slice(0,-6)),n(`const ${_i(o,t)} = ${l}(${JSON.stringify(o)}${c?", true":""})${i?"!":""}`),r<e.length-1&&a()}}function h0(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:n}=t;n();for(let a=0;a<e.length;a++){const i=e[a];i&&(s(`const _hoisted_${a+1} = `),Bt(i,t),n())}t.pure=!1}function _c(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),Li(e,t,s),s&&t.deindent(),t.push("]")}function Li(e,t,s=!1,n=!0){const{push:a,newline:i}=t;for(let l=0;l<e.length;l++){const r=e[l];Ce(r)?a(r,-3):me(r)?_c(r,t):Bt(r,t),l<e.length-1&&(s?(n&&a(","),i()):n&&a(", "))}}function Bt(e,t){if(Ce(e)){t.push(e,-3);return}if(Ht(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:Bt(e.codegenNode,t);break;case 2:m0(e,t);break;case 4:kh(e,t);break;case 5:g0(e,t);break;case 12:Bt(e.codegenNode,t);break;case 8:wh(e,t);break;case 3:b0(e,t);break;case 13:y0(e,t);break;case 14:_0(e,t);break;case 15:k0(e,t);break;case 17:w0(e,t);break;case 18:S0(e,t);break;case 19:T0(e,t);break;case 20:C0(e,t);break;case 21:Li(e.body,t,!0,!1);break}}function m0(e,t){t.push(JSON.stringify(e.content),-3,e)}function kh(e,t){const{content:s,isStatic:n}=e;t.push(n?JSON.stringify(s):s,-3,e)}function g0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ir),s(`${n(sr)}(`),Bt(e.content,t),s(")")}function wh(e,t){for(let s=0;s<e.children.length;s++){const n=e.children[s];Ce(n)?t.push(n,-3):Bt(n,t)}}function v0(e,t){const{push:s}=t;if(e.type===8)s("["),wh(e,t),s("]");else if(e.isStatic){const n=bc(e.content)?e.content:JSON.stringify(e.content);s(n,-2,e)}else s(`[${e.content}]`,-3,e)}function b0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ir),s(`${n(Ni)}(${JSON.stringify(e.content)})`,-3,e)}function y0(e,t){const{push:s,helper:n,pure:a}=t,{tag:i,props:l,children:r,patchFlag:o,dynamicProps:c,directives:u,isBlock:d,disableTracking:f,isComponent:p}=e;let g;o&&(g=String(o)),u&&s(n(cc)+"("),d&&s(`(${n(Bn)}(${f?"true":""}), `),a&&s(ir);const m=d?Ca(t.inSSR,p):Ta(t.inSSR,p);s(n(m)+"(",-2,e),Li(x0([i,l,r,g,c]),t),s(")"),d&&s(")"),u&&(s(", "),Bt(u,t),s(")"))}function x0(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function _0(e,t){const{push:s,helper:n,pure:a}=t,i=Ce(e.callee)?e.callee:n(e.callee);a&&s(ir),s(i+"(",-2,e),Li(e.arguments,t),s(")")}function k0(e,t){const{push:s,indent:n,deindent:a,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const r=l.length>1||!1;s(r?"{":"{ "),r&&n();for(let o=0;o<l.length;o++){const{key:c,value:u}=l[o];v0(c,t),s(": "),Bt(u,t),o<l.length-1&&(s(","),i())}r&&a(),s(r?"}":" }")}function w0(e,t){_c(e.elements,t)}function S0(e,t){const{push:s,indent:n,deindent:a}=t,{params:i,returns:l,body:r,newline:o,isSlot:c}=e;c&&s(`_${wa[hc]}(`),s("(",-2,e),me(i)?Li(i,t):i&&Bt(i,t),s(") => "),(o||r)&&(s("{"),n()),l?(o&&s("return "),me(l)?_c(l,t):Bt(l,t)):r&&Bt(r,t),(o||r)&&(a(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function T0(e,t){const{test:s,consequent:n,alternate:a,newline:i}=e,{push:l,indent:r,deindent:o,newline:c}=t;if(s.type===4){const d=!bc(s.content);d&&l("("),kh(s,t),d&&l(")")}else l("("),Bt(s,t),l(")");i&&r(),t.indentLevel++,i||l(" "),l("? "),Bt(n,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const u=a.type===19;u||t.indentLevel++,Bt(a,t),u||t.indentLevel--,i&&o(!0)}function C0(e,t){const{push:s,helper:n,indent:a,deindent:i,newline:l}=t,{needPauseTracking:r,needArraySpread:o}=e;o&&s("[...("),s(`_cache[${e.index}] || (`),r&&(a(),s(`${n(El)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),Bt(e.value,t),r&&(s(`).cacheIndex = ${e.index},`),l(),s(`${n(El)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),o&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const E0=xh(/^(?:if|else|else-if)$/,(e,t,s)=>A0(e,t,s,(n,a,i)=>{const l=s.parent.children;let r=l.indexOf(n),o=0;for(;r-->=0;){const c=l[r];c&&c.type===9&&(o+=c.branches.length)}return()=>{if(i)n.codegenNode=Gu(a,o,s);else{const c=R0(n.codegenNode);c.alternate=Gu(a,o+n.branches.length-1,s)}}}));function A0(e,t,s,n){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const a=t.exp?t.exp.loc:e.loc;s.onError(at(28,t.loc)),t.exp=Oe("true",!1,a)}if(t.name==="if"){const a=qu(e,t),i={type:9,loc:t0(e.loc),branches:[a]};if(s.replaceNode(i),n)return n(i,a,!0)}else{const a=s.parent.children;let i=a.indexOf(e);for(;i-->=-1;){const l=a[i];if(l&&dh(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(at(30,e.loc)),s.removeNode();const r=qu(e,t);l.branches.push(r);const o=n&&n(l,r,!1);ar(r,s),o&&o(),s.currentNode=null}else s.onError(at(30,e.loc));break}}}function qu(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!ds(e,"for")?e.children:[e],userKey:nr(e,"key"),isTemplateIf:s}}function Gu(e,t,s){return e.condition?oo(e.condition,Wu(e,t,s),St(s.helper(Ni),['""',"true"])):Wu(e,t,s)}function Wu(e,t,s){const{helper:n}=s,a=vt("key",Oe(`${t}`,!1,os,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const o=l.codegenNode;return Nl(o,a,s),o}else return yi(s,n(vi),fs([a]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const o=l.codegenNode,c=Ky(o);return c.type===13&&gc(c,s),Nl(c,a,s),o}}function R0(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const I0=xh("for",(e,t,s)=>{const{helper:n,removeHelper:a}=s;return N0(e,t,s,i=>{const l=St(n(uc),[i.source]),r=Rl(e),o=ds(e,"memo"),c=nr(e,"key",!1,!0);c&&c.type;let u=c&&(c.type===6?c.value?Oe(c.value.content,!0):void 0:c.exp);const d=u?vt("key",u):null,f=i.source.type===4&&i.source.constType>0,p=f?64:c?128:256;return i.codegenNode=yi(s,n(vi),void 0,l,p,void 0,void 0,!0,!f,!1,e.loc),()=>{let g;const{children:m}=i,k=m.length!==1||m[0].type!==1,E=Il(e)?e:r&&e.children.length===1&&Il(e.children[0])?e.children[0]:null;if(E?(g=E.codegenNode,r&&d&&Nl(g,d,s)):k?g=yi(s,n(vi),d?fs([d]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(g=m[0].codegenNode,r&&d&&Nl(g,d,s),g.isBlock!==!f&&(g.isBlock?(a(Bn),a(Ca(s.inSSR,g.isComponent))):a(Ta(s.inSSR,g.isComponent))),g.isBlock=!f,g.isBlock?(n(Bn),n(Ca(s.inSSR,g.isComponent))):n(Ta(s.inSSR,g.isComponent))),o){const b=Sa(fo(i.parseResult,[Oe("_cached")]));b.body=Ly([_s(["const _memo = (",o.exp,")"]),_s(["if (_cached && _cached.el",...u?[" && _cached.key === ",u]:[],` && ${s.helperString(nh)}(_cached, _memo)) return _cached`]),_s(["const _item = ",g]),Oe("_item.memo = _memo"),Oe("return _item")]),l.arguments.push(b,Oe("_cache"),Oe(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(Sa(fo(i.parseResult),g,!0))}})});function N0(e,t,s,n){if(!t.exp){s.onError(at(31,t.loc));return}const a=t.forParseResult;if(!a){s.onError(at(32,t.loc));return}Sh(a);const{addIdentifiers:i,removeIdentifiers:l,scopes:r}=s,{source:o,value:c,key:u,index:d}=a,f={type:11,loc:t.loc,source:o,valueAlias:c,keyAlias:u,objectIndexAlias:d,parseResult:a,children:Rl(e)?e.children:[e]};s.replaceNode(f),r.vFor++;const p=n&&n(f);return()=>{r.vFor--,p&&p()}}function Sh(e,t){e.finalized||(e.finalized=!0)}function fo({value:e,key:t,index:s},n=[]){return O0([e,t,s,...n])}function O0(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,n)=>s||Oe("_".repeat(n+1),!1))}const Zu=Oe("undefined",!1),L0=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=ds(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},D0=(e,t,s,n)=>Sa(e,s,!1,!0,s.length?s[0].loc:n);function M0(e,t,s=D0){t.helper(hc);const{children:n,loc:a}=e,i=[],l=[];let r=t.scopes.vSlot>0||t.scopes.vFor>0;const o=ds(e,"slot",!0);if(o){const{arg:k,exp:E}=o;k&&!ts(k)&&(r=!0),i.push(vt(k||Oe("default",!0),s(E,void 0,n,a)))}let c=!1,u=!1;const d=[],f=new Set;let p=0;for(let k=0;k<n.length;k++){const E=n[k];let b;if(!Rl(E)||!(b=ds(E,"slot",!0))){E.type!==3&&d.push(E);continue}if(o){t.onError(at(37,b.loc));break}c=!0;const{children:v,loc:x}=E,{arg:w=Oe("default",!0),exp:N,loc:O}=b;let S;ts(w)?S=w?w.content:"default":r=!0;const R=ds(E,"for"),L=s(N,R,v,x);let H,P;if(H=ds(E,"if"))r=!0,l.push(oo(H.exp,Zi(w,L,p++),Zu));else if(P=ds(E,/^else(?:-if)?$/,!0)){let T=k,U;for(;T--&&(U=n[T],!!dh(U)););if(U&&Rl(U)&&ds(U,/^(?:else-)?if$/)){let q=l[l.length-1];for(;q.alternate.type===19;)q=q.alternate;q.alternate=P.exp?oo(P.exp,Zi(w,L,p++),Zu):Zi(w,L,p++)}else t.onError(at(30,P.loc))}else if(R){r=!0;const T=R.forParseResult;T?(Sh(T),l.push(St(t.helper(uc),[T.source,Sa(fo(T),Zi(w,L),!0)]))):t.onError(at(32,R.loc))}else{if(S){if(f.has(S)){t.onError(at(38,O));continue}f.add(S),S==="default"&&(u=!0)}i.push(vt(w,L))}}if(!o){const k=(E,b)=>{const v=s(E,void 0,b,a);return t.compatConfig&&(v.isNonScopedSlot=!0),vt("default",v)};c?d.length&&!d.every(yc)&&(u?t.onError(at(39,d[0].loc)):i.push(k(void 0,d))):i.push(k(void 0,n))}const g=r?2:il(e.children)?3:1;let m=fs(i.concat(vt("_",Oe(g+"",!1))),a);return l.length&&(m=St(t.helper(sh),[m,Mn(l)])),{slots:m,hasDynamicSlots:r}}function Zi(e,t,s){const n=[vt("name",e),vt("fn",t)];return s!=null&&n.push(vt("key",Oe(String(s),!0))),fs(n)}function il(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||il(s.children))return!0;break;case 9:if(il(s.branches))return!0;break;case 10:case 11:if(il(s.children))return!0;break}}return!1}const Th=new WeakMap,P0=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:n,props:a}=e,i=e.tagType===1;let l=i?F0(e,t):`"${n}"`;const r=Ve(l)&&l.callee===lc;let o,c,u=0,d,f,p,g=r||l===si||l===tc||!i&&(n==="svg"||n==="foreignObject"||n==="math");if(a.length>0){const m=Ch(e,t,void 0,i,r);o=m.props,u=m.patchFlag,f=m.dynamicPropNames;const k=m.directives;p=k&&k.length?Mn(k.map(E=>U0(E,t))):void 0,m.shouldUseBlock&&(g=!0)}if(e.children.length>0)if(l===Tl&&(g=!0,u|=1024),i&&l!==si&&l!==Tl){const{slots:k,hasDynamicSlots:E}=M0(e,t);c=k,E&&(u|=1024)}else if(e.children.length===1&&l!==si){const k=e.children[0],E=k.type,b=E===5||E===8;b&&as(k,t)===0&&(u|=1),b||E===2?c=k:c=e.children}else c=e.children;f&&f.length&&(d=B0(f)),e.codegenNode=yi(t,l,o,c,u===0?void 0:u,d,p,!!g,!1,i,e.loc)};function F0(e,t,s=!1){let{tag:n}=e;const a=po(n),i=nr(e,"is",!1,!0);if(i)if(a||Pn("COMPILER_IS_ON_ELEMENT",t)){let r;if(i.type===6?r=i.value&&Oe(i.value.content,!0):(r=i.exp,r||(r=Oe("is",!1,i.arg.loc))),r)return St(t.helper(lc),[r])}else i.type===6&&i.value.content.startsWith("vue:")&&(n=i.value.content.slice(4));const l=ih(n)||t.isBuiltInComponent(n);return l?(s||t.helper(l),l):(t.helper(ic),t.components.add(n),_i(n,"component"))}function Ch(e,t,s=e.props,n,a,i=!1){const{tag:l,loc:r,children:o}=e;let c=[];const u=[],d=[],f=o.length>0;let p=!1,g=0,m=!1,k=!1,E=!1,b=!1,v=!1,x=!1;const w=[],N=L=>{c.length&&(u.push(fs(Ju(c),r)),c=[]),L&&u.push(L)},O=()=>{t.scopes.vFor>0&&c.push(vt(Oe("ref_for",!0),Oe("true")))},S=({key:L,value:H})=>{if(ts(L)){const P=L.content,T=Vn(P);if(T&&(!n||a)&&P.toLowerCase()!=="onclick"&&P!=="onUpdate:modelValue"&&!Js(P)&&(b=!0),T&&Js(P)&&(x=!0),T&&H.type===14&&(H=H.arguments[0]),H.type===20||(H.type===4||H.type===8)&&as(H,t)>0)return;P==="ref"?m=!0:P==="class"?k=!0:P==="style"?E=!0:P!=="key"&&!w.includes(P)&&w.push(P),n&&(P==="class"||P==="style")&&!w.includes(P)&&w.push(P)}else v=!0};for(let L=0;L<s.length;L++){const H=s[L];if(H.type===6){const{loc:P,name:T,nameLoc:U,value:q}=H;let G=!0;if(T==="ref"&&(m=!0,O()),T==="is"&&(po(l)||q&&q.content.startsWith("vue:")||Pn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(vt(Oe(T,!0,U),Oe(q?q.content:"",G,q?q.loc:P)))}else{const{name:P,arg:T,exp:U,loc:q,modifiers:G}=H,D=P==="bind",I=P==="on";if(P==="slot"){n||t.onError(at(40,q));continue}if(P==="once"||P==="memo"||P==="is"||D&&Rn(T,"is")&&(po(l)||Pn("COMPILER_IS_ON_ELEMENT",t))||I&&i)continue;if((D&&Rn(T,"key")||I&&f&&Rn(T,"vue:before-update"))&&(p=!0),D&&Rn(T,"ref")&&O(),!T&&(D||I)){if(v=!0,U)if(D){if(N(),Pn("COMPILER_V_BIND_OBJECT_ORDER",t)){u.unshift(U);continue}O(),N(),u.push(U)}else N({type:14,loc:q,callee:t.helper(pc),arguments:n?[U]:[U,"true"]});else t.onError(at(D?34:35,q));continue}D&&G.some(ue=>ue.content==="prop")&&(g|=32);const j=t.directiveTransforms[P];if(j){const{props:ue,needRuntime:oe}=j(H,e,t);!i&&ue.forEach(S),I&&T&&!ts(T)?N(fs(ue,r)):c.push(...ue),oe&&(d.push(H),Ht(oe)&&Th.set(H,oe))}else Im(P)||(d.push(H),f&&(p=!0))}}let R;if(u.length?(N(),u.length>1?R=St(t.helper(Cl),u,r):R=u[0]):c.length&&(R=fs(Ju(c),r)),v?g|=16:(k&&!n&&(g|=2),E&&!n&&(g|=4),w.length&&(g|=8),b&&(g|=32)),!p&&(g===0||g===32)&&(m||x||d.length>0)&&(g|=512),!t.inSSR&&R)switch(R.type){case 15:let L=-1,H=-1,P=!1;for(let q=0;q<R.properties.length;q++){const G=R.properties[q].key;ts(G)?G.content==="class"?L=q:G.content==="style"&&(H=q):G.isHandlerKey||(P=!0)}const T=R.properties[L],U=R.properties[H];P?R=St(t.helper(bi),[R]):(T&&!ts(T.value)&&(T.value=St(t.helper(dc),[T.value])),U&&(E||U.value.type===4&&U.value.content.trim()[0]==="["||U.value.type===17)&&(U.value=St(t.helper(fc),[U.value])));break;case 14:break;default:R=St(t.helper(bi),[St(t.helper(Oi),[R])]);break}return{props:R,directives:d,patchFlag:g,dynamicPropNames:w,shouldUseBlock:p}}function Ju(e){const t=new Map,s=[];for(let n=0;n<e.length;n++){const a=e[n];if(a.key.type===8||!a.key.isStatic){s.push(a);continue}const i=a.key.content,l=t.get(i);l?(i==="style"||i==="class"||Vn(i))&&$0(l,a):(t.set(i,a),s.push(a))}return s}function $0(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Mn([e.value,t.value],e.loc)}function U0(e,t){const s=[],n=Th.get(e);n?s.push(t.helperString(n)):(t.helper(rc),t.directives.add(e.name),s.push(_i(e.name,"directive")));const{loc:a}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=Oe("true",!1,a);s.push(fs(e.modifiers.map(l=>vt(l,i)),a))}return Mn(s,e.loc)}function B0(e){let t="[";for(let s=0,n=e.length;s<n;s++)t+=JSON.stringify(e[s]),s<n-1&&(t+=", ");return t+"]"}function po(e){return e==="component"||e==="Component"}const H0=(e,t)=>{if(Il(e)){const{children:s,loc:n}=e,{slotName:a,slotProps:i}=V0(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",a,"{}","undefined","true"];let r=2;i&&(l[2]=i,r=3),s.length&&(l[3]=Sa([],s,!1,!1,n),r=4),t.scopeId&&!t.slotted&&(r=5),l.splice(r),e.codegenNode=St(t.helper(th),l,n)}};function V0(e,t){let s='"default"',n;const a=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=Qe(l.name),a.push(l)));else if(l.name==="bind"&&Rn(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const r=Qe(l.arg.content);s=l.exp=Oe(r,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&ts(l.arg)&&(l.arg.content=Qe(l.arg.content)),a.push(l)}if(a.length>0){const{props:i,directives:l}=Ch(e,t,a,!1,!1);n=i,l.length&&t.onError(at(36,l[0].loc))}return{slotName:s,slotProps:n}}const Eh=(e,t,s,n)=>{const{loc:a,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(at(35,a));let r;if(l.type===4)if(l.isStatic){let d=l.content;d.startsWith("vue:")&&(d=`vnode-${d.slice(4)}`);const f=t.tagType!==0||d.startsWith("vnode")||!/[A-Z]/.test(d)?da(Qe(d)):`on:${d}`;r=Oe(f,!0,l.loc)}else r=_s([`${s.helperString(ro)}(`,l,")"]);else r=l,r.children.unshift(`${s.helperString(ro)}(`),r.children.push(")");let o=e.exp;o&&!o.content.trim()&&(o=void 0);let c=s.cacheHandlers&&!o&&!s.inVOnce;if(o){const d=oh(o),f=!(d||Hy(o)),p=o.content.includes(";");(f||c&&d)&&(o=_s([`${f?"$event":"(...args)"} => ${p?"{":"("}`,o,p?"}":")"]))}let u={props:[vt(r,o||Oe("() => {}",!1,a))]};return n&&(u=n(u)),c&&(u.props[0].value=s.cache(u.props[0].value)),u.props.forEach(d=>d.key.isHandlerKey=!0),u},j0=(e,t,s)=>{const{modifiers:n,loc:a}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),n.some(r=>r.content==="camel")&&(i.type===4?i.isStatic?i.content=Qe(i.content):i.content=`${s.helperString(lo)}(${i.content})`:(i.children.unshift(`${s.helperString(lo)}(`),i.children.push(")"))),s.inSSR||(n.some(r=>r.content==="prop")&&Yu(i,"."),n.some(r=>r.content==="attr")&&Yu(i,"^")),{props:[vt(i,l)]}},Yu=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},z0=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let n,a=!1;for(let i=0;i<s.length;i++){const l=s[i];if(Er(l)){a=!0;for(let r=i+1;r<s.length;r++){const o=s[r];if(Er(o))n||(n=s[i]=_s([l],l.loc)),n.children.push(" + ",o),s.splice(r,1),r--;else{n=void 0;break}}}}if(!(!a||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(Er(l)||l.type===8){const r=[];(l.type!==2||l.content!==" ")&&r.push(l),!t.ssr&&as(l,t)===0&&r.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:St(t.helper(ac),r)}}}}},Qu=new WeakSet,K0=(e,t)=>{if(e.type===1&&ds(e,"once",!0))return Qu.has(e)||t.inVOnce||t.inSSR?void 0:(Qu.add(e),t.inVOnce=!0,t.helper(El),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Ah=(e,t,s)=>{const{exp:n,arg:a}=e;if(!n)return s.onError(at(41,e.loc)),Ba();const i=n.loc.source.trim(),l=n.type===4?n.content:i,r=s.bindingMetadata[i];if(r==="props"||r==="props-aliased")return s.onError(at(44,n.loc)),Ba();if(r==="literal-const"||r==="setup-const")return s.onError(at(45,n.loc)),Ba();if(!l.trim()||!oh(n))return s.onError(at(42,n.loc)),Ba();const o=a||Oe("modelValue",!0),c=a?ts(a)?`onUpdate:${Qe(a.content)}`:_s(['"onUpdate:" + ',a]):"onUpdate:modelValue";let u;const d=s.isTS?"($event: any)":"$event";u=_s([`${d} => ((`,n,") = $event)"]);const f=[vt(o,e.exp),vt(c,u)];if(e.modifiers.length&&t.tagType===1){const p=e.modifiers.map(m=>m.content).map(m=>(bc(m)?m:JSON.stringify(m))+": true").join(", "),g=a?ts(a)?`${a.content}Modifiers`:_s([a,' + "Modifiers"']):"modelModifiers";f.push(vt(g,Oe(`{ ${p} }`,!1,e.loc,2)))}return Ba(f)};function Ba(e=[]){return{props:e}}const q0=/[\w).+\-_$\]]/,G0=(e,t)=>{Pn("COMPILER_FILTERS",t)&&(e.type===5?Ol(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&Ol(s.exp,t)}))};function Ol(e,t){if(e.type===4)Xu(e,t);else for(let s=0;s<e.children.length;s++){const n=e.children[s];typeof n=="object"&&(n.type===4?Xu(n,t):n.type===8?Ol(e,t):n.type===5&&Ol(n.content,t))}}function Xu(e,t){const s=e.content;let n=!1,a=!1,i=!1,l=!1,r=0,o=0,c=0,u=0,d,f,p,g,m=[];for(p=0;p<s.length;p++)if(f=d,d=s.charCodeAt(p),n)d===39&&f!==92&&(n=!1);else if(a)d===34&&f!==92&&(a=!1);else if(i)d===96&&f!==92&&(i=!1);else if(l)d===47&&f!==92&&(l=!1);else if(d===124&&s.charCodeAt(p+1)!==124&&s.charCodeAt(p-1)!==124&&!r&&!o&&!c)g===void 0?(u=p+1,g=s.slice(0,p).trim()):k();else{switch(d){case 34:a=!0;break;case 39:n=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:o++;break;case 93:o--;break;case 123:r++;break;case 125:r--;break}if(d===47){let E=p-1,b;for(;E>=0&&(b=s.charAt(E),b===" ");E--);(!b||!q0.test(b))&&(l=!0)}}g===void 0?g=s.slice(0,p).trim():u!==0&&k();function k(){m.push(s.slice(u,p).trim()),u=p+1}if(m.length){for(p=0;p<m.length;p++)g=W0(g,m[p],t);e.content=g,e.ast=void 0}}function W0(e,t,s){s.helper(oc);const n=t.indexOf("(");if(n<0)return s.filters.add(t),`${_i(t,"filter")}(${e})`;{const a=t.slice(0,n),i=t.slice(n+1);return s.filters.add(a),`${_i(a,"filter")}(${e}${i!==")"?","+i:i}`}}const ed=new WeakSet,Z0=(e,t)=>{if(e.type===1){const s=ds(e,"memo");return!s||ed.has(e)||t.inSSR?void 0:(ed.add(e),()=>{const n=e.codegenNode||t.currentNode.codegenNode;n&&n.type===13&&(e.tagType!==1&&gc(n,t),e.codegenNode=St(t.helper(mc),[s.exp,Sa(void 0,n),"_cache",String(t.cached.length)]),t.cached.push(null))})}},J0=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const n=s.arg;if(n.type!==4||!n.isStatic)t.onError(at(53,n.loc)),s.exp=Oe("",!0,n.loc);else{const a=Qe(n.content);(lh.test(a[0])||a[0]==="-")&&(s.exp=Oe(a,!1,n.loc))}}}};function Y0(e){return[[J0,K0,E0,Z0,I0,G0,H0,P0,L0,z0],{on:Eh,bind:j0,model:Ah}]}function Q0(e,t={}){const s=t.onError||vc,n=t.mode==="module";t.prefixIdentifiers===!0?s(at(48)):n&&s(at(49));const a=!1;t.cacheHandlers&&s(at(50)),t.scopeId&&!n&&s(at(51));const i=Me({},t,{prefixIdentifiers:a}),l=Ce(e)?a0(e,i):e,[r,o]=Y0();return o0(l,Me({},i,{nodeTransforms:[...r,...t.nodeTransforms||[]],directiveTransforms:Me({},o,t.directiveTransforms||{})})),f0(l,i)}const X0=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Rh=Symbol(""),Ih=Symbol(""),Nh=Symbol(""),Oh=Symbol(""),ho=Symbol(""),Lh=Symbol(""),Dh=Symbol(""),Mh=Symbol(""),Ph=Symbol(""),Fh=Symbol("");Iy({[Rh]:"vModelRadio",[Ih]:"vModelCheckbox",[Nh]:"vModelText",[Oh]:"vModelSelect",[ho]:"vModelDynamic",[Lh]:"withModifiers",[Dh]:"withKeys",[Mh]:"vShow",[Ph]:"Transition",[Fh]:"TransitionGroup"});let ea;function ex(e,t=!1){return ea||(ea=document.createElement("div")),t?(ea.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,ea.children[0].getAttribute("foo")):(ea.innerHTML=e,ea.textContent)}const tx={parseMode:"html",isVoidTag:Gm,isNativeTag:e=>zm(e)||Km(e)||qm(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:ex,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return Ph;if(e==="TransitionGroup"||e==="transition-group")return Fh},getNamespace(e,t,s){let n=t?t.ns:s;if(t&&n===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(a=>a.type===6&&a.name==="encoding"&&a.value!=null&&(a.value.content==="text/html"||a.value.content==="application/xhtml+xml"))&&(n=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(n=0);else t&&n===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(n=0);if(n===0){if(e==="svg")return 1;if(e==="math")return 2}return n}},sx=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:Oe("style",!0,t.loc),exp:nx(t.value.content,t.loc),modifiers:[],loc:t.loc})})},nx=(e,t)=>{const s=Zd(e);return Oe(JSON.stringify(s),!1,t,3)};function yn(e,t){return at(e,t)}const ax=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(yn(54,a)),t.children.length&&(s.onError(yn(55,a)),t.children.length=0),{props:[vt(Oe("innerHTML",!0,a),n||Oe("",!0))]}},ix=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(yn(56,a)),t.children.length&&(s.onError(yn(57,a)),t.children.length=0),{props:[vt(Oe("textContent",!0),n?as(n,s)>0?n:St(s.helperString(sr),[n],a):Oe("",!0))]}},lx=(e,t,s)=>{const n=Ah(e,t,s);if(!n.props.length||t.tagType===1)return n;e.arg&&s.onError(yn(59,e.arg.loc));const{tag:a}=t,i=s.isCustomElement(a);if(a==="input"||a==="textarea"||a==="select"||i){let l=Nh,r=!1;if(a==="input"||i){const o=nr(t,"type");if(o){if(o.type===7)l=ho;else if(o.value)switch(o.value.content){case"radio":l=Rh;break;case"checkbox":l=Ih;break;case"file":r=!0,s.onError(yn(60,e.loc));break}}else Vy(t)&&(l=ho)}else a==="select"&&(l=Oh);r||(n.needRuntime=s.helper(l))}else s.onError(yn(58,e.loc));return n.props=n.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),n},rx=rs("passive,once,capture"),ox=rs("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),cx=rs("left,right"),$h=rs("onkeyup,onkeydown,onkeypress"),ux=(e,t,s,n)=>{const a=[],i=[],l=[];for(let r=0;r<t.length;r++){const o=t[r].content;o==="native"&&xi("COMPILER_V_ON_NATIVE",s)||rx(o)?l.push(o):cx(o)?ts(e)?$h(e.content.toLowerCase())?a.push(o):i.push(o):(a.push(o),i.push(o)):ox(o)?i.push(o):a.push(o)}return{keyModifiers:a,nonKeyModifiers:i,eventOptionModifiers:l}},td=(e,t)=>ts(e)&&e.content.toLowerCase()==="onclick"?Oe(t,!0):e.type!==4?_s(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,dx=(e,t,s)=>Eh(e,t,s,n=>{const{modifiers:a}=e;if(!a.length)return n;let{key:i,value:l}=n.props[0];const{keyModifiers:r,nonKeyModifiers:o,eventOptionModifiers:c}=ux(i,a,s,e.loc);if(o.includes("right")&&(i=td(i,"onContextmenu")),o.includes("middle")&&(i=td(i,"onMouseup")),o.length&&(l=St(s.helper(Lh),[l,JSON.stringify(o)])),r.length&&(!ts(i)||$h(i.content.toLowerCase()))&&(l=St(s.helper(Dh),[l,JSON.stringify(r)])),c.length){const u=c.map(zn).join("");i=ts(i)?Oe(`${i.content}${u}`,!0):_s(["(",i,`) + "${u}"`])}return{props:[vt(i,l)]}}),fx=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(yn(62,a)),{props:[],needRuntime:s.helper(Mh)}},px=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},hx=[sx],mx={cloak:X0,html:ax,text:ix,model:lx,on:dx,show:fx};function gx(e,t={}){return Q0(e,Me({},tx,t,{nodeTransforms:[px,...hx,...t.nodeTransforms||[]],directiveTransforms:Me({},mx,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const sd=Object.create(null);function vx(e,t){if(!Ce(e))if(e.nodeType)e=e.innerHTML;else return Lt;const s=Lm(e,t),n=sd[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=Me({hoistStatic:!0,onError:void 0,onWarn:Lt},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=gx(e,a),l=new Function("Vue",i)(Sy);return l._rc=!0,sd[s]=l}_p(vx);const Ll=_n({items:[]});let bx=1;function lr(e,t="info",s=3e3){const n=bx++;return Ll.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>kc(n),s),n}function kc(e){const t=Ll.items.findIndex(s=>s.id===e);t>=0&&Ll.items.splice(t,1)}function ke(e,t="info",s=3e3){return lr(e,t,s)}ke.success=(e,t=3e3)=>lr(e,"success",t);ke.error=(e,t=5e3)=>lr(e,"error",t);ke.info=(e,t=3e3)=>lr(e,"info",t);ke.dismiss=kc;const yx={setup(){return{state:Ll,dismiss:kc}},template:`
...
`)}var Ml=class{constructor(e){Xe(this,"options");Xe(this,"rules");Xe(this,"lexer");this.options=e||qn}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const s=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?s:za(s,`
...
`,e=e.substring(f.length+1),o=!0),!o){const E=this.rules.other.nextBulletRegex(g),b=this.rules.other.hrRegex(g),v=this.rules.other.fencesBeginRegex(g),x=this.rules.other.headingBeginRegex(g),w=this.rules.other.htmlBeginRegex(g);for(;e;){const N=e.split(`
`,1)[0];let O;if(f=N,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),O=f):O=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||w.test(f)||E.test(f)||b.test(f))break;if(O.search(this.rules.other.nonSpaceChar)>=g||!f.trim())u+=`
`+O.slice(g);else{if(p||d.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||v.test(d)||x.test(d)||b.test(d))break;u+=`
`+f}!p&&!f.trim()&&(p=!0),c+=N+`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}Be(()=>{Ge.on("events",a),i=setInterval(l,500)}),ht(()=>{Ge.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=X(()=>e.value.reduce((N,O)=>N+(O.iteration_count||0),0)),d=X(()=>e.value.filter(N=>N.status==="running").length);function f(N){return N==="running"?"loop-status-running":N==="error"?"loop-status-error":"loop-status-stopped"}function p(N){return N==="running"?"badge-success":N==="error"?"badge-danger":N==="completed"?"badge-info":"badge-warning"}function g(N){return N==="act"?"badge-warning":N==="silent"?"badge-info":"badge-success"}function m(N){c.value={...c.value,[N]:!c.value[N]}}async function k(N=!1){N=N===!0,N||(t.value=!0);try{e.value=await K.get("/api/loops"),s.value=null}catch(O){N||(s.value=O.message)}N||(t.value=!1)}async function E(){l.value=null;const N=a.value;if(!N.goal.trim()){l.value="Goal is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}const O={goal:N.goal.trim(),channel_id:N.channel_id.trim(),interval_seconds:N.interval_seconds||60,mode:N.mode,max_iterations:N.max_iterations||50};N.stop_condition.trim()&&(O.stop_condition=N.stop_condition.trim()),i.value=!0;try{const S=await K.post("/api/loops",O);ke.success(`Loop started: ${S.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await k()}catch(S){l.value=S.message}i.value=!1}async function b(N){if(await ls({title:"Stop loop",message:`Stop loop ${N}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=N;try{await K.del(`/api/loops/${encodeURIComponent(N)}`),ke.success("Loop stopped"),await k()}catch(S){ke.error(S.message||"Failed to stop loop")}r.value=null}}async function v(N){o.value=N;try{await K.post(`/api/loops/${encodeURIComponent(N)}/restart`),ke.success("Loop restarted"),await k()}catch(O){ke.error(O.message||"Failed to restart loop")}o.value=null}function x(N){N.payload&&(N.payload.loop_id||N.payload.type==="loop")&&k(!0)}let w=null;return Be(()=>{k(),Ge.subscribe("events",x),w=setInterval(()=>{k(!0)},5e3)}),ht(()=>{Ge.unsubscribe("events",x),w&&clearInterval(w)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:g,formatDuration:Ra,formatAge:Qh,toggleHistory:m,fetchLoops:k,doCreate:E,doStop:b,doRestart:v}}},aw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),g=h(null),m=h([]),k=h(!1),E=X(()=>e.value.filter(D=>D.cron&&!D.one_time).length),b=X(()=>e.value.filter(D=>D.one_time).length),v=X(()=>e.value.filter(D=>D.trigger).length),x=X(()=>e.value.filter(D=>D.paused).length),w=X(()=>e.value.filter(D=>D.consecutive_failures>0).length);function N(D){if(!D)return"-";const I=Date.now(),ue=(new Date(D).getTime()-I)/1e3;if(ue<0)return"overdue";if(ue<60)return"in < 1 min";if(ue<3600)return`in ${Math.floor(ue/60)} min`;if(ue<86400){const se=Math.floor(ue/3600),he=Math.floor(ue%3600/60);return he>0?`in ${se}h ${he}m`:`in ${se}h`}const oe=Math.floor(ue/86400);return`in ${oe} day${oe!==1?"s":""}`}function O(D){return D==null?"-":D<1e3?`${D}ms`:D<6e4?`${(D/1e3).toFixed(1)}s`:Ra(D/1e3)}function S(){r.value=null}async function R(){const D=a.value.cron.trim();if(D){o.value=!0;try{r.value=await K.post("/api/schedules/validate-cron",{expression:D})}catch(I){r.value={valid:!1,error:I.message}}o.value=!1}}async function L(){t.value=!0,s.value=null;try{e.value=await K.get("/api/schedules")}catch(D){s.value=D.message}t.value=!1}async function H(D){if(g.value===D){g.value=null,m.value=[];return}g.value=D,k.value=!0,m.value=[];try{m.value=await K.get(`/api/schedules/${encodeURIComponent(D)}/history?limit=10`)}catch{m.value=[]}k.value=!1}async function P(){l.value=null;const D=a.value;if(!D.description.trim()){l.value="Description is required";return}if(!D.channel_id.trim()){l.value="Channel ID is required";return}if(!D.cron.trim()&&!D.run_at.trim()){l.value="Cron expression or run_at time is required";return}const I={description:D.description.trim(),action:D.action,channel_id:D.channel_id.trim()};if(D.cron.trim()&&(I.cron=D.cron.trim()),D.run_at.trim()&&(I.run_at=D.run_at.trim()),D.action==="reminder"&&D.message.trim()&&(I.message=D.message.trim()),D.action==="check"&&(D.tool_name.trim()&&(I.tool_name=D.tool_name.trim()),D.tool_input_str.trim()))try{I.tool_input=JSON.parse(D.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await K.post("/api/schedules",I),ke.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await L()}catch(j){l.value=j.message}i.value=!1}async function T(D){u.value=D;try{const I=await K.post(`/api/schedules/${encodeURIComponent(D)}/run`);if(I.status==="failure")ke.error(`Execution failed: ${I.error||"unknown error"}`);else{const j=I.warning?`Executed (${I.warning})`:"Executed successfully";ke.success(j)}await L()}catch(I){ke.error(I.message||"Failed to trigger")}u.value=null}async function U(D){f.value=D.id;const I=!D.paused;try{await K.put(`/api/schedules/${encodeURIComponent(D.id)}`,{paused:I}),ke.success(I?"Schedule paused":"Schedule resumed"),await L()}catch(j){ke.error(j.message||"Failed to update schedule")}f.value=null}async function q(D){p.value=D;try{await K.post(`/api/schedules/${encodeURIComponent(D)}/reset-failures`),ke.success("Failure counters reset"),await L()}catch(I){ke.error(I.message||"Failed to reset")}p.value=null}async function G(D){const I=e.value.find(ue=>ue.id===D);if(await ls({title:"Delete schedule",message:`Delete "${(I==null?void 0:I.description)||D}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=D;try{await K.del(`/api/schedules/${encodeURIComponent(D)}`),ke.success("Schedule deleted"),await L()}catch(ue){ke.error(ue.message||"Failed to delete schedule")}d.value=null}}return Be(()=>{L()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:g,history:m,historyLoading:k,cronCount:E,oneTimeCount:b,webhookCount:v,pausedCount:x,failingCount:w,formatTs:La,formatAge:Qh,formatFuture:N,formatMs:O,formatDuration:Ra,onCronInput:S,validateCron:R,toggleExpand:H,fetchSchedules:L,doCreate:P,doRunNow:T,doTogglePause:U,doResetFailures:q,doDelete:G}}},lw={components:{TabbedPage:dr},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),g=zd,m=ow,k=h([]),E=h(!1),b=h(""),v=h("flat"),x=h(new Set),w=h(""),N=h(""),O=h(""),S=h(null),R=h(!1);function L(){try{const B=localStorage.getItem("odin-session-presets");B&&(k.value=JSON.parse(B))}catch{}}function H(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const P=X(()=>d.value.trim()!==""||u.value!=="all"),T=X(()=>{let B=[...e.value];const re=zd.find(Ze=>Ze.id===u.value),xe=re?re.filters:{};if(xe.source&&(B=B.filter(Ze=>Ze.source===xe.source)),xe.minMessages&&(B=B.filter(Ze=>Ze.message_count>=xe.minMessages)),xe.hasCompaction&&(B=B.filter(Ze=>Ze.has_summary)),xe.maxAge!=null){const Ze=Date.now()/1e3;B=B.filter(xt=>xt.last_active&&Ze-xt.last_active<=xe.maxAge)}if(d.value.trim()){const Ze=d.value.toLowerCase().trim();B=B.filter(xt=>(xt.channel_id||"").toLowerCase().includes(Ze)||(xt.last_user_id||"").toLowerCase().includes(Ze)||(xt.source||"").toLowerCase().includes(Ze))}const Pe=f.value,Je=p.value?1:-1;return B.sort((Ze,xt)=>{const et=Ze[Pe]||0,Ye=xt[Pe]||0;return(et-Ye)*Je}),B}),U=X(()=>{if(!a.value||!a.value.messages)return[];const B=a.value.messages;if(B.length===0)return[];const re=[];let xe=[];for(const Pe of B)Pe.role==="user"&&xe.length>0&&(re.push(xe),xe=[]),xe.push(Pe);return xe.length>0&&re.push(xe),re}),q=X(()=>T.value.length>0&&o.value.size===T.value.length);function G(B){const re=B.find(xe=>xe.role==="user");if(re&&re.content){const xe=re.content.slice(0,120);return xe.length<re.content.length?xe+"...":xe}return"(no user message)"}function D(B){const re=new Set(x.value);re.has(B)?re.delete(B):re.add(B),x.value=re}function I(B){u.value=B}function j(B){u.value=B.id,B.filters.searchQuery!=null&&(d.value=B.filters.searchQuery),B.filters.sortBy&&(f.value=B.filters.sortBy)}function ue(){if(!b.value.trim())return;const B={id:"custom-"+Date.now(),name:b.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,B],H(),E.value=!1,b.value=""}function oe(B){k.value=k.value.filter(re=>re.id!==B),H(),u.value===B&&(u.value="all")}function se(){u.value="all",d.value="",f.value="last_active",p.value=!1}function he(B){if(!B)return"—";const re=Date.now()/1e3-B;if(re<60)return"just now";if(re<3600){const Pe=Math.floor(re/60);return`${Pe} minute${Pe!==1?"s":""} ago`}if(re<86400){const Pe=Math.floor(re/3600);return`${Pe} hour${Pe!==1?"s":""} ago`}const xe=Math.floor(re/86400);return`${xe} day${xe!==1?"s":""} ago`}function ee(B){if(!B)return"";try{return new Date(B*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function fe(B){if(!B)return"";try{return new Date(B*1e3).toLocaleString()}catch{return""}}function Ee(B){return B==="user"?"bg-gray-900/50 border border-gray-800":B==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function F(B){return B==="user"?"sess-msg-user":B==="assistant"?"sess-msg-assistant":"sess-msg-system"}function de(B){return B==="user"?"badge-info":B==="assistant"?"badge-success":"badge-warning"}function ne(B){return B==="user"?"sess-dot-user":B==="assistant"?"sess-dot-assistant":"sess-dot-system"}function pe(B){return B==="user"?"text-cyan-400":B==="assistant"?"text-indigo-400":"text-gray-500"}function be(B){return B?B.length>2e3?B.slice(0,2e3)+`
... (truncated)`:B:""}async function Ne(){const B=w.value.trim();if(B){R.value=!0;try{let re=`/api/sessions/search?q=${encodeURIComponent(B)}&limit=50`;N.value.trim()&&(re+=`&channel_id=${encodeURIComponent(N.value.trim())}`),O.value.trim()&&(re+=`&user_id=${encodeURIComponent(O.value.trim())}`);const xe=await K.get(re);S.value=xe.results||[]}catch{S.value=[]}R.value=!1}}function y(){w.value="",N.value="",O.value="",S.value=null}function C(B){return B?B.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(B){return B==="user"?"fts-result-user":B==="assistant"?"fts-result-assistant":B==="summary"?"fts-result-summary":B==="fts"?"fts-result-fts":B==="channel"?"fts-result-channel":"fts-result-default"}function Z(B){return B==="user"?"badge-info":B==="assistant"?"badge-success":B==="summary"?"badge-warning":B==="fts"?"badge-success":"badge-info"}async function A(){t.value=!0,s.value=null;try{e.value=await K.get("/api/sessions")}catch(B){s.value=B.message}t.value=!1}function $(){s.value=null,A()}async function J(B){if(n.value===B){n.value=null,a.value=null,x.value=new Set;return}n.value=B,a.value=null,i.value=!0,x.value=new Set;try{a.value=await K.get(`/api/sessions/${encodeURIComponent(B)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Q(B){const re=new Set(o.value);re.has(B)?re.delete(B):re.add(B),o.value=re}function te(){q.value?o.value=new Set:o.value=new Set(T.value.map(B=>B.channel_id))}function Y(B){l.value=B}async function ge(){if(l.value){r.value=!0;try{await K.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await A()}catch(B){s.value=B.message||"Failed to clear session"}r.value=!1,l.value=null}}function ae(){c.value=!0}async function ce(){if(o.value.size!==0){r.value=!0;try{await K.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await A()}catch(B){s.value=B.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function ye(B,re){const xe=K._token;let Pe=`/api/sessions/${encodeURIComponent(B)}/export?format=${re}`;xe&&(Pe+=`&token=${encodeURIComponent(xe)}`);const Je=document.createElement("a");Je.href=Pe,Je.download=`session-${B}.${re==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let _e=null;function Ie(B){B.payload&&B.payload.channel_id&&(clearTimeout(_e),_e=setTimeout(()=>{A(),n.value&&B.payload.channel_id===n.value&&K.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(re=>{a.value=re}).catch(()=>{})},2e3))}return Be(()=>{L(),A(),Ge.subscribe("events",Ie)}),ht(()=>{Ge.unsubscribe("events",Ie),clearTimeout(_e)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:q,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:g,sortOptions:m,filteredSessions:T,hasActiveFilters:P,customPresets:k,showSavePreset:E,newPresetName:b,threadView:v,threads:U,collapsedThreads:x,ftsQuery:w,ftsChannelId:N,ftsUserId:O,ftsResults:S,ftsSearching:R,formatAge:he,formatTimestamp:ee,formatFullTimestamp:fe,messageClass:Ee,threadMsgClass:F,roleBadge:de,roleDotClass:ne,roleLabelClass:pe,truncateContent:be,threadSummary:G,fetchSessions:A,retry:$,toggleSession:J,toggleSelect:Q,toggleSelectAll:te,confirmClear:Y,clearSession:ge,confirmBulkClear:ae,doBulkClear:ce,exportSession:ye,applyPreset:I,applyCustomPreset:j,saveCustomPreset:ue,removeCustomPreset:oe,resetFilters:se,toggleThread:D,runFtsSearch:Ne,clearFtsSearch:y,highlightSnippet:C,ftsResultClass:M,ftsTypeBadge:Z}}},uw={props:["trace"],template:`
...
`)}),S=X(()=>{const ee=d.value.trim();return ee?ee.includes("SKILL_DEFINITION")?ee.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function R(ee){return mw(ee)}function L(ee){return ee?ee.split(`
`).length:0}function H(ee){return gw(ee)}function P(ee){n.value={...n.value,[ee]:!n.value[ee]}}async function T(ee){try{await navigator.clipboard.writeText(ee);const fe=e.value.find(Ee=>Ee.code===ee);fe&&(r.value=fe.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function U(ee){if(ee.key==="Tab"){ee.preventDefault();const fe=ee.target,Ee=fe.selectionStart,F=fe.selectionEnd;d.value=d.value.substring(0,Ee)+"    "+d.value.substring(F),Et(()=>{fe.selectionStart=fe.selectionEnd=Ee+4})}}function q(ee){const fe=ee.target.previousElementSibling;fe&&(fe.scrollTop=ee.target.scrollTop)}async function G(){t.value=!0,s.value=null;try{e.value=await K.get("/api/skills")}catch(ee){s.value=ee.message}t.value=!1}async function D(ee){i.value=ee,delete a.value[ee],a.value={...a.value};try{const fe=await K.post(`/api/skills/${encodeURIComponent(ee)}/test`);a.value={...a.value,[ee]:fe}}catch(fe){a.value={...a.value,[ee]:{result:fe.message,is_error:!0}}}i.value=null}function I(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function j(ee){o.value=!0,c.value="edit",u.value=ee.name,d.value=ee.code||"",f.value=null,p.value=null}function ue(){o.value=!1,f.value=null,p.value=null}async function oe(){f.value=null,p.value=null;const ee=u.value.trim(),fe=d.value.trim();if(!ee){f.value="Name is required";return}if(!fe){f.value="Code is required";return}g.value=!0;try{c.value==="create"?(await K.post("/api/skills",{name:ee,code:fe}),p.value="Skill created successfully"):(await K.put(`/api/skills/${encodeURIComponent(ee)}`,{code:fe}),p.value="Skill updated successfully"),await G(),setTimeout(()=>{o.value=!1},800)}catch(Ee){f.value=Ee.message}g.value=!1}function se(ee){k.value=ee}async function he(){if(k.value){E.value=!0;try{await K.del(`/api/skills/${encodeURIComponent(k.value)}`),await G()}catch{}E.value=!1,k.value=null}}return Be(()=>{G()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:g,editorRef:m,deleteTarget:k,deleting:E,enabledCount:b,totalExecutions:v,totalLines:x,displayedSkills:w,editLineCount:N,editorLineNums:O,editValidation:S,highlight:R,truncate:Ec,formatTs:La,countLines:L,getLineNumbers:H,toggleCode:P,copyCode:T,handleEditorKey:U,syncScroll:q,fetchSkills:G,testSkill:D,showCreate:I,editSkill:j,cancelEdit:ue,saveSkill:oe,confirmDelete:se,doDelete:he}}};function bw(e,t){if(!e||!t)return kd(e);const s=kd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),g=h(null),m=h(null);let k=null;const E=h(null),b=h(!1),v=h({}),x=h({}),w=h(null),N=h(null),O=X(()=>e.value.reduce((I,j)=>I+(j.chunks||0),0)),S=X(()=>new Set(e.value.map(j=>j.uploader).filter(Boolean)).size);function R(I,j){const ue=x.value[j];if(!ue||ue.length===0)return 0;const oe=Math.max(...ue.map(se=>se.char_count||0));return oe===0?0:Math.round(I.char_count/oe*100)}async function L(){t.value=!0,s.value=null;try{const I=await K.get("/api/knowledge");e.value=Array.isArray(I)?I:[]}catch(I){s.value=I.message}t.value=!1}async function H(I){if(v.value[I]){v.value[I]=!1,N.value=null;return}if(v.value[I]=!0,!(x.value[I]||w.value===I)){w.value=I;try{const j=await K.get(`/api/knowledge/${encodeURIComponent(I)}/chunks`);x.value[I]=Array.isArray(j)?j:[]}catch(j){x.value[I]=[],ke.error(`Failed to load chunks: ${j.message}`)}w.value=null}}async function P(){const I=n.value.trim();if(I){i.value=!0,r.value=null,l.value=I;try{const j=await K.get(`/api/knowledge/search?q=${encodeURIComponent(I)}`);a.value=Array.isArray(j)?j:[]}catch(j){a.value=[],r.value=j.message||"Search failed"}i.value=!1}}function T(){a.value=null,n.value="",r.value=null}async function U(){d.value=null,f.value=null;const I=c.value.trim(),j=u.value.trim();if(!I){d.value="Source name is required";return}if(!j){d.value="Content is required";return}p.value=!0;try{const ue=await K.post("/api/knowledge",{source:I,content:j});f.value=`Ingested ${ue.chunks||0} chunks from "${I}"`,c.value="",u.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(ue){d.value=ue.message}p.value=!1}async function q(I){g.value=I,m.value=null,k&&(clearTimeout(k),k=null);try{const j=await K.post(`/api/knowledge/${encodeURIComponent(I)}/reingest`);m.value={source:I,error:!1,message:`Re-ingested ${j.chunks||0} chunks`},delete x.value[I],await L(),k=setTimeout(()=>{m.value=null,k=null},3e3)}catch(j){m.value={source:I,error:!0,message:j.message}}g.value=null}function G(I){E.value=I}async function D(){if(E.value){b.value=!0;try{await K.del(`/api/knowledge/${encodeURIComponent(E.value)}`),delete x.value[E.value],await L()}catch{}b.value=!1,E.value=null}}return Be(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:g,reingestResult:m,deleteTarget:E,deleting:b,expanded:v,sourceChunks:x,loadingChunks:w,selectedChunk:N,totalChunks:O,uploaderCount:S,truncate:Ec,formatTs:La,highlightTerms:bw,chunkBarWidth:R,fetchSources:L,toggleSource:H,doSearch:P,clearSearch:T,doIngest:U,doReingest:q,confirmDelete:G,doDelete:D}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),g=h(!1),m=h(null),k=h(null),E=h(new Set),b=h(null),v=h(!1),x=h(!1),w=X(()=>e.value.reduce((se,he)=>se+he.count,0)),N=X(()=>E.value.size);function O(se){const he=t.value[se];if(!he)return[];if(!l.value.trim())return he;const ee=l.value.trim().toLowerCase();return he.filter(fe=>fe.key.toLowerCase().includes(ee)||fe.value&&fe.value.toLowerCase().includes(ee))}function S(se,he){return E.value.has(se+"/"+he)}function R(se,he){const ee=se+"/"+he,fe=new Set(E.value);fe.has(ee)?fe.delete(ee):fe.add(ee),E.value=fe}function L(se){const he=t.value[se];return!he||he.length===0?!1:he.every(ee=>E.value.has(se+"/"+ee.key))}function H(se,he){const ee=t.value[se];if(!ee)return;const fe=new Set(E.value);for(const Ee of ee){const F=se+"/"+Ee.key;he?fe.add(F):fe.delete(F)}E.value=fe}async function P(){s.value=!0,n.value=null;try{const se=await K.get("/api/memory");e.value=Object.entries(se).map(([he,ee])=>({name:he,keys:ee.keys||[],count:ee.count||0}))}catch(se){n.value=se.message}s.value=!1}async function T(se){if(a.value[se]){a.value[se]=!1;return}a.value[se]=!0;const he=e.value.find(fe=>fe.name===se);if(!he||t.value[se]||i.value===se)return;i.value=se;const ee=await Promise.all(he.keys.map(async fe=>{try{const Ee=await K.get(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(fe)}`);return{key:fe,value:Ee.value||""}}catch{return{key:fe,value:"(error loading)"}}}));t.value[se]=ee,i.value=null}function U(se,he,ee){f.value=se+"/"+he,p.value=ee}async function q(se,he){g.value=!0,m.value=null;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(he)}`,{value:p.value});const ee=t.value[se];if(ee){const fe=ee.find(Ee=>Ee.key===he);fe&&(fe.value=p.value)}f.value=null}catch(ee){m.value=`Failed to save: ${ee.message||"unknown error"}`}g.value=!1}async function G(se,he){try{await navigator.clipboard.writeText(he.value),k.value=se+"/"+he.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function D(){u.value=null,d.value=null;const se=o.value.scope.trim(),he=o.value.key.trim(),ee=o.value.value.trim();if(!se){u.value="Scope is required";return}if(!he){u.value="Key is required";return}if(!ee){u.value="Value is required";return}c.value=!0;try{await K.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(he)}`,{value:ee}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(fe){u.value=fe.message}c.value=!1}function I(se,he){b.value={scope:se,key:he}}async function j(){if(!b.value)return;v.value=!0,m.value=null;const{scope:se,key:he}=b.value;try{await K.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(he)}`);const ee=t.value[se];ee&&(t.value[se]=ee.filter(F=>F.key!==he));const fe=e.value.find(F=>F.name===se);fe&&(fe.count--,fe.keys=fe.keys.filter(F=>F!==he));const Ee=new Set(E.value);Ee.delete(se+"/"+he),E.value=Ee}catch(ee){m.value=`Failed to delete: ${ee.message||"unknown error"}`}v.value=!1,b.value=null}function ue(){x.value=!0}async function oe(){v.value=!0,m.value=null;const se=[];for(const he of E.value){const ee=he.indexOf("/");se.push({scope:he.slice(0,ee),key:he.slice(ee+1)})}try{await K.post("/api/memory/bulk-delete",{entries:se}),E.value=new Set,t.value={},await P()}catch(he){m.value=`Bulk delete failed: ${he.message||"unknown error"}`}v.value=!1,x.value=!1}return Be(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:g,actionError:m,copied:k,selected:E,selectedCount:N,totalEntries:w,deleteTarget:b,deleting:v,showBulkDelete:x,fetchMemory:P,toggleScope:T,startEdit:U,doEdit:q,copyValue:G,doAdd:D,confirmDelete:I,doDelete:j,confirmBulkDelete:ue,doBulkDelete:oe,isSelected:S,toggleSelect:R,isScopeAllSelected:L,toggleSelectAll:H,filteredEntries:O}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=X(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=X(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await K.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return Be(()=>{c(),i=setInterval(c,3e4)}),ht(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:em,refresh:u,retry:d}}},Rw=["INFO","WARNING","ERROR"],Iw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Br=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Nw=[50,100,200,500],Ow={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(Ge.state||"disconnected"),c=X(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,g=Rw,m=Iw,k=Br,E=h("all"),b=h(""),v=h([]),x=h(!1),w=h(""),N=h([]);function O(){try{const V=localStorage.getItem("odin-log-presets");V&&(v.value=JSON.parse(V))}catch{}}function S(){try{localStorage.setItem("odin-log-presets",JSON.stringify(v.value))}catch{}}const R=X(()=>a.value!==""||i.value.trim()!==""||b.value!==""),L=X(()=>{const V=Br.find(ie=>ie.value===b.value);return V?V.label:""}),H=X(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(V){return V.message}}),P=24,T=X(()=>{if(t.value.length===0)return[];const V=[],ie=new Date,Te=3600*1e3;for(let Ke=P-1;Ke>=0;Ke--){const rt=new Date(ie.getTime()-(Ke+1)*Te),Zt=new Date(ie.getTime()-Ke*Te);V.push({start:rt,end:Zt,label:D(rt,Zt),shortLabel:Zt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Ke of t.value){if(!Ke._time)continue;const rt=Ke._time.getTime();for(const Zt of V)if(rt>=Zt.start.getTime()&&rt<Zt.end.getTime()){Zt.total++,Ke.level==="ERROR"?Zt.errors++:Ke.level==="WARNING"?Zt.warnings++:Zt.info++;break}}return V}),U=X(()=>{let V=1;for(const ie of T.value)ie.total>V&&(V=ie.total);return V}),q=X(()=>T.value.length===0?"":"Last 24 hours"),G=X(()=>Math.ceil(P/8));function D(V,ie){const Te={hour:"2-digit",minute:"2-digit"};return V.toLocaleTimeString([],Te)+" - "+ie.toLocaleTimeString([],Te)}function I(V,ie){return!ie||!V?"0px":Math.max(2,V/ie*100)+"%"}function j(V){const ie=ue.value.findIndex(Te=>Te._time&&Te._time.getTime()>=V.start.getTime()&&Te._time.getTime()<V.end.getTime());if(ie>=0&&u.value){const Te=u.value.querySelectorAll(".log-line");Te[ie]&&(Te[ie].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const ue=X(()=>{let V=t.value;if(a.value&&(V=V.filter(ie=>(ie.level||"INFO")===a.value)),b.value){const ie=Br.find(Te=>Te.value===b.value);if(ie&&ie.seconds){const Te=new Date(Date.now()-ie.seconds*1e3);V=V.filter(Ke=>Ke._time&&Ke._time>=Te)}}if(i.value&&!H.value)if(l.value)try{const ie=new RegExp(i.value,"i");V=V.filter(Te=>{const Ke=Te.text||Te.raw||"",rt=Te.tool||"";return ie.test(Ke)||ie.test(rt)})}catch{}else{const ie=i.value.toLowerCase();V=V.filter(Te=>{const Ke=(Te.text||Te.raw||"").toLowerCase(),rt=(Te.tool||"").toLowerCase();return Ke.includes(ie)||rt.includes(ie)})}return V});function oe(V){if(V.type==="log"&&V.line)try{const ie=typeof V.line=="string"?JSON.parse(V.line):V.line,Te=ie.timestamp?new Date(ie.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ie.error?"ERROR":"INFO",text:ie.tool_name?`[${ie.tool_name}] ${ie.result_summary||""}`.trim():ie.message||JSON.stringify(ie),tool:ie.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(V.line),tool:"",raw:String(V.line)}}if(V.payload){const ie=V.payload,Te=ie.timestamp?new Date(ie.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ie.error?"ERROR":"INFO",text:ie.tool_name?`[${ie.tool_name}] ${ie.result_summary||""}`.trim():ie.message||JSON.stringify(ie),tool:ie.tool_name||"",raw:null}}return typeof V=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:V,tool:"",raw:V}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(V),tool:"",raw:null}}function se(V){const ie=oe(V);if(s.value){N.value.push(ie);return}he(ie)}function he(V){t.value.push(V),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&Et(()=>ee())}function ee(){const V=u.value;if(V){const ie=V.scrollHeight-V.scrollTop-V.clientHeight;V.scrollTo({top:V.scrollHeight,behavior:ie<500?"smooth":"instant"})}}function fe(){n.value=!0,d.value=!1,Et(()=>ee())}function Ee(){const V=u.value;if(!V)return;const ie=V.scrollHeight-V.scrollTop-V.clientHeight<40;d.value=!ie&&t.value.length>0,!ie&&n.value&&(n.value=!1)}function F(){if(s.value=!s.value,!s.value&&N.value.length>0){for(const V of N.value)he(V);N.value=[]}}function de(){t.value=[],N.value=[],d.value=!1}function ne(){let V;e.value==="search"?V=re.value.map(rt=>{const Zt=rt.error?"ERROR":"INFO",it=rt.tool_name?`[${rt.tool_name}] `:"";return`${rt.timestamp||""} ${Zt} ${it}${rt.result_summary||rt.message||""}`}).join(`
`):V=ue.value.map(rt=>`${rt.ts} ${rt.level} ${rt.text}`).join(`
`);const ie=new Blob([V],{type:"text/plain"}),Te=URL.createObjectURL(ie),Ke=document.createElement("a");Ke.href=Te,Ke.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ke.click(),URL.revokeObjectURL(Te)}function pe(V,ie){const Te=`${V.ts} ${V.level} ${V.text||V.raw||""}`;navigator.clipboard.writeText(Te).then(()=>{f.value=ie,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function be(V){a.value=a.value===V?"":V,E.value="all"}function Ne(V){return V.level==="ERROR"?"log-line-error":V.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(V){return V==="ERROR"?"text-red-500 font-semibold":V==="WARNING"?"text-yellow-500":"text-blue-500"}function C(V){return V==="ERROR"?"log-chip-error":V==="WARNING"?"log-chip-warning":"log-chip-info"}function M(V){E.value=V.id;const ie=V.filters;a.value=ie.level||"",b.value=ie.timeRange||"",i.value=ie.text||"",ie.levels&&(a.value=ie.levels[0]||""),ie.hasToolName&&(i.value="")}function Z(V){E.value=V.id,a.value=V.filters.level||"",b.value=V.filters.timeRange||"",i.value=V.filters.text||""}function A(){if(!w.value.trim())return;const V={id:"custom-"+Date.now(),name:w.value.trim(),filters:{level:a.value,timeRange:b.value,text:i.value}};v.value=[...v.value,V],S(),x.value=!1,w.value=""}function $(V){v.value=v.value.filter(ie=>ie.id!==V),S(),E.value===V&&(E.value="all")}const J=h("all"),Q=h(""),te=h(""),Y=h(""),ge=h(""),ae=h(""),ce=h(100),ye=Nw,_e=h(!1),Ie=h(!1),B=h(""),re=h([]),xe=h(null),Pe=h(null);function Je(){e.value="search",xe.value||Ze()}async function Ze(){try{xe.value=await K.get("/api/logs/stats")}catch{}}function xt(){const V=ae.value;if(!V){Y.value="",ge.value="";return}const Te={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[V];if(Te){const Ke=new Date(Date.now()-Te*1e3);Y.value=et(Ke),ge.value=""}}function et(V){const ie=Te=>String(Te).padStart(2,"0");return`${V.getFullYear()}-${ie(V.getMonth()+1)}-${ie(V.getDate())}T${ie(V.getHours())}:${ie(V.getMinutes())}`}function Ye(V){if(!V)return"";const ie=new Date(V);return isNaN(ie.getTime())?"":ie.toISOString()}async function Ss(){_e.value=!0,B.value="",Ie.value=!0,Pe.value=null;try{const V=new URLSearchParams;J.value&&J.value!=="all"&&V.set("level",J.value),Q.value&&V.set("tool",Q.value),te.value&&V.set("q",te.value);const ie=Ye(Y.value),Te=Ye(ge.value);ie&&V.set("start",ie),Te&&V.set("end",Te),V.set("limit",String(ce.value));const Ke=await K.get(`/api/logs/search?${V.toString()}`);re.value=Ke.entries||[]}catch(V){B.value=V.message||"Search failed",re.value=[]}finally{_e.value=!1}}function W(){J.value="all",Q.value="",te.value="",Y.value="",ge.value="",ae.value="",ce.value=100,re.value=[],Ie.value=!1,B.value="",Pe.value=null}function Ae(V){Pe.value=Pe.value===V?null:V}function Ts(V){if(!V.timestamp)return"";try{return new Date(V.timestamp).toLocaleString()}catch{return V.timestamp}}function Gn(V){return V.type==="web_action"?`${V.status||""} (${V.execution_time_ms||0}ms)`:(V.result_summary||"").slice(0,200)}function Wn(V){return V.error?"log-line-error":"text-gray-300"}function Zn(V){try{return JSON.stringify(V,null,2)}catch{return String(V)}}let Dt=null,vs=null,rn=!1;function Da(){rn||(rn=!0,Ge.subscribe("logs",se),r.value=Ge.connected,o.value=Ge.state||"disconnected",Dt=Ge.onStateChange,vs=(V,ie)=>{o.value=V,r.value=V==="connected",Dt&&Dt(V,ie)},Ge.onStateChange=vs)}function Mi(){rn&&(rn=!1,Ge.unsubscribe("logs",se),Ge.onStateChange===vs&&(Ge.onStateChange=Dt),vs=null,Dt=null)}return Be(O),Uo(Da),Bo(Mi),ht(Mi),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ue,pauseBuffer:N,showJumpBottom:d,copiedIndex:f,regexError:H,levels:g,logPresets:m,timeRanges:k,timeRange:b,activeLogPreset:E,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:w,hasActiveLogFilters:R,timeRangeLabel:L,timelineBuckets:T,timelineMax:U,timelineSpanLabel:q,timelineLabelSkip:G,togglePause:F,clearLogs:de,exportLogs:ne,logLineClass:Ne,levelClass:y,levelChipClass:C,toggleLevel:be,copyLine:pe,jumpToBottom:fe,onScroll:Ee,applyLogPreset:M,applyCustomLogPreset:Z,saveLogCustomPreset:A,removeLogCustomPreset:$,segmentHeight:I,jumpToTimelineBucket:j,searchLevel:J,searchTool:Q,searchKeyword:te,searchStart:Y,searchEnd:ge,searchTimePreset:ae,searchLimit:ce,searchLimits:ye,searching:_e,searchRan:Ie,searchError:B,searchResults:re,searchStats:xe,expandedSearch:Pe,switchToSearch:Je,runSearch:Ss,clearSearchFilters:W,toggleSearchExpand:Ae,formatSearchTs:Ts,searchEntryText:Gn,searchLogLineClass:Wn,formatJson:Zn,applySearchTimePreset:xt}}},Lw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Hr=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],mm="••••••••",Pw=50;function Fw(e){return Lw.has(e)}function $w(e){return e===mm}function Qi(e){return JSON.parse(JSON.stringify(e))}function Fn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Fn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Fn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Kd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Fn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Fn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=X(()=>d.value.length>0),g=X(()=>f.value.length>0),m=X(()=>r.value&&t.value?t.value:e.value),k=X(()=>!e.value||!t.value?!1:!Fn(e.value,t.value)),E=X(()=>!e.value||!t.value?0:Kd(e.value,t.value).length),b=X(()=>{if(!r.value||!t.value)return{};const A={};for(const $ of Object.keys(t.value)){const J=t.value[$];if(typeof J=="object"&&J!==null&&!Array.isArray(J))for(const Q of Object.keys(J)){const te=Bw($,Q,J[Q]);te&&(A[$+"."+Q]=te)}}return A}),v=X(()=>Object.keys(b.value).length>0),x=X(()=>e.value?Object.keys(e.value).length:0),w=X(()=>O.value.length),N=X(()=>!e.value||!t.value?[]:Kd(e.value,t.value)),O=X(()=>e.value?Hr.map(A=>({...A,sections:A.sections.filter($=>$ in e.value)})).filter(A=>A.sections.length>0):[]),S=X(()=>{if(!e.value)return[];const A=new Set(Hr.flatMap($=>$.sections));return Object.keys(e.value).filter($=>!A.has($))});function R(A){return m.value?m.value[A]:null}function L(A){return!e.value||!t.value?!1:!Fn(e.value[A],t.value[A])}function H(A){return A.sections.some($=>L($))}function P(A,$){if(!e.value||!t.value)return!1;const J=e.value[A],Q=t.value[A];return!J||!Q?!1:!Fn(J[$],Q[$])}function T(A){return t.value?t.value[A]:e.value[A]}function U(A,$){const J=t.value||e.value;return J[A]?J[A][$]:void 0}function q(A,$){const J=r.value&&t.value?t.value:e.value;return J[A]?J[A][$]:!1}function G(A,$){return b.value[A+"."+$]||null}function D(A,$){return Dw[A+"."+$]||null}function I(A,$,J){t.value&&($===null?t.value[A]=J:(t.value[A]||(t.value[A]={}),t.value[A][$]=J),t.value={...t.value})}function j(A,$,J){if(!t.value)return;const Q=Qi(t.value);I(A,$,J),d.value.push(Q),d.value.length>Pw&&d.value.shift(),f.value=[]}function ue(A,$,J){try{const Q=JSON.parse(J);j(A,$,Q)}catch{}}function oe(){d.value.length!==0&&(f.value.push(Qi(t.value)),t.value=d.value.pop())}function se(){f.value.length!==0&&(d.value.push(Qi(t.value)),t.value=f.value.pop())}function he(A,$,J){if(!t.value||!t.value[A])return;const Q=[...t.value[A][$]];Q.splice(J,1),j(A,$,Q)}function ee(A,$){if(!t.value||!t.value[A])return;const J=[...t.value[A][$]||[]],Q=prompt("Enter new value:");Q!==null&&(J.push(Q),j(A,$,J))}function fe(A){a.value={...a.value,[A]:!a.value[A]}}function Ee(A){l.value={...l.value,[A]:!l.value[A]}}function F(A){i.value={...i.value,[A]:!i.value[A]}}function de(A){try{return JSON.stringify(A,null,2)}catch{return String(A)}}function ne(A){return A==null?"null":typeof A=="object"?JSON.stringify(A,null,2):String(A)}function pe(A,$){c.value={type:A,message:$},setTimeout(()=>{c.value=null},3e3)}function be(){t.value=Qi(e.value),r.value=!0,d.value=[],f.value=[]}function Ne(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function C(){if(!(!k.value||v.value)){o.value=!0;try{const A=Uw(e.value,t.value);if(Object.keys(A).length===0){pe("success","No changes to save."),o.value=!1;return}const $=await K.put("/api/config",A);e.value=$,r.value=!1,t.value=null,d.value=[],f.value=[],pe("success","Config saved successfully.")}catch(A){pe("error",A.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await K.get("/api/config");for(const A of Object.keys(e.value))a.value[A]===void 0&&(a.value[A]=!0);for(const A of Hr)l.value[A.key]===void 0&&(l.value[A.key]=!0)}catch(A){n.value=A.message}s.value=!1}function Z(A){if(!r.value)return;const $=A.target;$ instanceof HTMLElement&&($.matches("input, textarea, select")||$.isContentEditable)||((A.ctrlKey||A.metaKey)&&!A.shiftKey&&A.key.toLowerCase()==="z"?(A.preventDefault(),oe()):(A.ctrlKey||A.metaKey)&&(A.key==="y"||A.shiftKey&&A.key==="z"||A.shiftKey&&A.key==="Z")&&(A.preventDefault(),se()))}return Be(()=>{M(),document.addEventListener("keydown",Z)}),ht(()=>{document.removeEventListener("keydown",Z)}),{config:e,displayConfig:m,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:v,changeCount:E,REDACTED:mm,showDiffModal:u,diffEntries:N,canUndo:p,canRedo:g,sectionCount:x,groupCount:w,visibleGroups:O,ungroupedSections:S,validationErrors:b,isSensitiveKey:Fw,isRedacted:$w,sectionChanged:L,groupChanged:H,fieldChanged:P,getDisplay:R,getEdited:T,getEditedField:U,getDisplayBool:q,pushEdit:j,pushEditJson:ue,getValidationError:G,getEnumOptions:D,removeArrayItem:he,addArrayItem:ee,toggleSection:fe,toggleGroup:Ee,toggleNested:F,formatJson:de,formatDiffVal:ne,showToast:pe,showDiff:y,fetchConfig:M,startEdit:be,cancelEdit:Ne,saveConfig:C,undo:oe,redo:se}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=X(()=>{const I={};for(const j of u.value)I[j.id]=j;return I});function p(I){return f.value[I]||null}const g=X(()=>/^\d{15,25}$/.test(r.value.trim())),m=X(()=>{if(o.value){if(k.value[c.value])return"host-user-option-"+c.value;if(g.value)return"host-user-option-raw"}}),k=X(()=>{const I=r.value.toLowerCase().trim();return I?u.value.filter(j=>!i.value[j.id]&&(j.display_name.toLowerCase().includes(I)||j.username.toLowerCase().includes(I)||j.id.includes(I))):u.value.filter(j=>!i.value[j.id])});function E(I,j){return I?I.allowed_hosts===null||I.allowed_hosts===void 0?{allowed_hosts:[...j],default_host:I.default_host||"",allow_all:!0}:{allowed_hosts:I.allowed_hosts,default_host:I.default_host||"",allow_all:!1}:{allowed_hosts:[...j],default_host:j[0]||"",allow_all:!0}}async function b(){e.value=!0,t.value="";try{const I=await K.get("/api/host-access");s.value=I,n.value=I.available_hosts||[],a.value=E(I.default_policy,n.value);const j=I.users||{},ue={};for(const[oe,se]of Object.entries(j))ue[oe]=E(se,n.value);i.value=ue}catch(I){t.value=I.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await K.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const I=a.value.allow_all?null:a.value.allowed_hosts;await K.put("/api/host-access/default-policy",{allowed_hosts:I,default_host:a.value.default_host}),ke.success("Default policy updated")}catch(I){ke.error(I.message||"Failed to save")}}function x(I,j){a.value.allow_all=!1,j?a.value.allowed_hosts.includes(I)||a.value.allowed_hosts.push(I):(a.value.allowed_hosts=a.value.allowed_hosts.filter(ue=>ue!==I),a.value.default_host===I&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function w(I){const j=i.value[I];if(j)try{const ue=j.allow_all?null:j.allowed_hosts;await K.put(`/api/host-access/user/${I}`,{allowed_hosts:ue,default_host:j.default_host});const oe=p(I);ke.success(`Updated access for ${oe?oe.display_name:I}`)}catch(ue){ke.error(ue.message||"Failed to save")}}function N(I,j,ue){const oe=i.value[I];oe&&(oe.allow_all=!1,ue?oe.allowed_hosts.includes(j)||oe.allowed_hosts.push(j):(oe.allowed_hosts=oe.allowed_hosts.filter(se=>se!==j),oe.default_host===j&&(oe.default_host=oe.allowed_hosts[0]||"")),w(I))}function O(I,j){const ue=i.value[I];ue&&(ue.default_host=j,w(I))}function S(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function R(){o.value=!0,c.value=0}function L(){c.value<k.value.length-1&&c.value++}function H(){c.value>0&&c.value--}function P(){const I=k.value[c.value];if(I){U(I);return}g.value&&T()}function T(){const I=r.value.trim();/^\d{15,25}$/.test(I)&&(i.value[I]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},w(I),r.value="",o.value=!1,l.value=!1)}function U(I){i.value[I.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},w(I.id),r.value="",o.value=!1,l.value=!1}function q(){o.value=!1}function G(){setTimeout(()=>{o.value=!1},150)}async function D(I){const j=p(I);if(await ls({title:"Remove user override",message:`Remove the host access override for ${j?j.display_name:I}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await K.del(`/api/host-access/user/${I}`),delete i.value[I],ke.success(`Removed override for ${j?j.display_name:I}`)}catch(oe){ke.error(oe.message||"Failed to delete")}}return Be(b),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:k,isRawId:g,activeOptionId:m,searchInput:d,fetchData:b,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:N,setUserDefault:O,openAddUser:S,deleteUser:D,onSearchInput:R,highlightNext:L,highlightPrev:H,selectHighlighted:P,selectMember:U,closeDropdown:q,onBlur:G,addRawId:T}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=X(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=X(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(S){return S==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":S==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function g(){e.value=!0,t.value="";try{const S=await K.get("/api/tokens");s.value=S.tokens||[],n.value=S.available_hosts||[]}catch(S){t.value=S.message||"Failed to load tokens"}finally{e.value=!1}}function m(S){return!S||!S.trim()?[]:S.split(",").map(R=>R.trim()).filter(Boolean)}function k(S,R){const L=c.value.allowed_hosts;if(R&&!L.includes(S)&&L.push(S),!R){const H=L.indexOf(S);H>=0&&L.splice(H,1)}}function E(S,R){const L=u.value.allowed_hosts;if(R&&!L.includes(S)&&L.push(S),!R){const H=L.indexOf(S);H>=0&&L.splice(H,1)}}async function b(){var S;i.value=!0;try{const R=m(c.value.allowed_tools_str),L=c.value.host_mode,H=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:R.length?R:[]};H!==null&&(P.allowed_hosts=H),P.default_host=c.value.default_host||"";const T=await K.post("/api/tokens",P);l.value=T.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ke.success("Token created"),await g()}catch(R){ke.error(((S=R.data)==null?void 0:S.error)||R.message||"Failed to create token")}finally{i.value=!1}}function v(S){r.value=S;const R=S.allowed_hosts;let L="default";R==null?L="default":Array.isArray(R)&&R.length===0?L="none":Array.isArray(R)&&(L="select"),u.value={username:S.username||"",tier:S.tier||"admin",label:S.label||"",host_mode:L,allowed_hosts:Array.isArray(R)?[...R]:[],default_host:S.default_host||"",allowed_tools_str:(S.allowed_tools||[]).join(", ")}}async function x(){var S;if(r.value){o.value=!0;try{const R=m(u.value.allowed_tools_str),L=u.value.host_mode,H={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:R};L==="none"?H.allowed_hosts=[]:L==="select"?H.allowed_hosts=u.value.allowed_hosts:H.allowed_hosts=null,H.default_host=u.value.default_host||"",await K.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,ke.success("Token updated"),await g()}catch(R){ke.error(((S=R.data)==null?void 0:S.error)||R.message||"Failed to update")}finally{o.value=!1}}}async function w(S){var L;if(await ls({title:"Regenerate token",message:`Regenerate token for ${S.username||S.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await K.post("/api/tokens/"+encodeURIComponent(S.user_id)+"/regenerate");l.value=H.token,ke.success("Token regenerated")}catch(H){ke.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to regenerate")}}async function N(S){var L;if(await ls({title:"Delete token",message:`Delete token for ${S.username||S.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/tokens/"+encodeURIComponent(S.user_id)),ke.success("Token deleted"),await g()}catch(H){ke.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return Be(g),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:g,tierBadge:p,toggleCreateHost:k,toggleEditHost:E,createToken:b,startEdit:v,saveEdit:x,confirmRegenerate:w,confirmDelete:N,copyToken:O}}};function Xi(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Kw={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=X(()=>{const W=n.value.model;return W&&!a.includes(W)?[W,...a]:a}),l=X(()=>{const W=n.value.agent_model;return W&&W!=="auto"&&!a.includes(W)?[W,...a]:a}),r=h({enabled:!1,model:"gpt-5.6-luna"}),o=h({unavailable_reason:null}),c=X(()=>{const W=r.value.model;return W&&!a.includes(W)?[W,...a]:a});function u(W){const Ae=W.target.value;r.value.enabled=Ae!=="",Ae!==""&&(r.value.model=Ae),ce()}const d=h(!1),f=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),p=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),g=h(!1),m=h(!1),k=h(!1),E=h(!1),b=h(!1),v=h(!1),x=h(!1),w=h({configured:!1}),N=h([]),O=h(""),S=h(!1),R=h(!1),L=h({configured:!1}),H=h([]),P=h(""),T=h(!1),U=h(!1),q=h(!0),G=h(""),D=h({configured:!1,accounts:[]}),I=h(null),j=h(null),ue=h(""),oe=h(null),se=h(!1),he=h(null),ee=h(null),fe=h("");let Ee=null;function F(W,Ae="success"){ke(W,Ae==="error"?"error":"success")}function de(W){if(!W)return"?";const Ae=W/(1024*1024*1024);return Ae>=1?Ae.toFixed(1)+" GB":(W/(1024*1024)).toFixed(0)+" MB"}async function ne(){e.value=!0,await Promise.all([pe(),be(),A(),Ne()]),e.value=!1}async function pe(){try{const W=await K.get("/api/llm/status");t.value=W,s.value=W.active_provider||"codex",W.codex&&!ae.pending()&&(n.value.enabled=W.codex.enabled,n.value.model=W.codex.model||"gpt-5.5",n.value.reasoning_effort=W.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=W.codex.agent_reasoning_effort||"",n.value.agent_model=W.codex.agent_model||"",n.value.max_tokens=W.codex.max_tokens||4096),W.ollama&&!ye.pending()&&(f.value.enabled=W.ollama.enabled,f.value.base_url=W.ollama.base_url||"",f.value.model=W.ollama.model||"",f.value.max_tokens=W.ollama.max_tokens||4096),W.kimi&&!_e.pending()&&(p.value.enabled=W.kimi.enabled,p.value.model=W.kimi.model||"",p.value.max_tokens=W.kimi.max_tokens||4096),W.auxiliary&&(o.value=W.auxiliary,ce.pending()||(r.value.enabled=W.auxiliary.enabled,r.value.model=W.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function be(){try{if(w.value=await K.get("/api/ollama/status"),w.value.model&&(O.value=w.value.model),w.value.configured)try{const W=await K.get("/api/ollama/models");N.value=W.models||[]}catch{N.value=[]}else if(f.value.base_url)try{const W=await K.post("/api/ollama/probe-models",{base_url:f.value.base_url});N.value=W.models||[]}catch{N.value=[]}}catch{w.value={configured:!1}}}async function Ne(){q.value=!0,G.value="";try{D.value=await K.get("/api/codex/status")}catch(W){G.value=W.message||"Failed to fetch Codex status"}finally{q.value=!1}}async function y(){const W=t.value?t.value.active_provider:"codex";x.value=!0;try{const Ae=await K.post("/api/llm/switch",{provider:s.value});Ae.error?(s.value=W,F(Ae.error,"error")):(F("Switched to "+s.value+" ("+Ae.model+")"),await ne())}catch(Ae){s.value=W,F(Ae.message||"Switch failed","error")}finally{x.value=!1}}async function C(){S.value=!0;try{const W=await K.post("/api/ollama/reload");F(W.configured?"Ollama reloaded":W.reason||"Ollama not configured",W.configured?"success":"error"),await ne()}catch(W){F(W.message||"Reload failed","error")}finally{S.value=!1}}async function M(){R.value=!0;try{await K.post("/api/ollama/model",{model:O.value}),F("Model set to "+O.value),await ne()}catch(W){F(W.message||"Failed","error")}finally{R.value=!1}}async function Z(){const W=f.value.base_url;if(!W){F("Enter a base URL first","error");return}v.value=!0;try{const Ae=await K.post("/api/ollama/probe-models",{base_url:W});N.value=Ae.models||[],N.value.length?(F(N.value.length+" model(s) found"),!f.value.model&&N.value.length&&(f.value.model=N.value[0].name)):F("No models found at "+W,"error")}catch(Ae){F(Ae.message||"Could not reach Ollama","error")}finally{v.value=!1}}async function A(){try{if(L.value=await K.get("/api/kimi/status"),L.value.model&&(P.value=L.value.model),L.value.configured)try{const W=await K.get("/api/kimi/models");H.value=W.models||[]}catch{H.value=[]}}catch{L.value={configured:!1}}}async function $(){T.value=!0;try{const W=await K.post("/api/kimi/reload");F(W.configured?"Kimi reloaded":W.reason||"Kimi not configured",W.configured?"success":"error"),await ne()}catch(W){F(W.message||"Reload failed","error")}finally{T.value=!1}}async function J(){U.value=!0;try{await K.post("/api/kimi/model",{model:P.value}),F("Model set to "+P.value),await ne()}catch(W){F(W.message||"Failed","error")}finally{U.value=!1}}async function Q(){if(k.value){ae();return}k.value=!0;try{await K.put("/api/llm/codex/config",n.value),F("Codex config saved"),await Promise.all([pe(),Ne()])}catch(W){F(W.message||"Failed","error"),await Promise.all([pe(),Ne()])}finally{k.value=!1}}async function te(){if(E.value){ye();return}E.value=!0;try{const W={...f.value},Ae=g.value?f.value.api_key:null;Ae===null&&delete W.api_key,await K.put("/api/llm/ollama/config",W),F("Ollama config saved"),Ae!==null&&f.value.api_key===Ae&&(f.value.api_key="",g.value=!1),await Promise.all([pe(),be()])}catch(W){F(W.message||"Failed","error")}finally{E.value=!1}}async function Y(){if(b.value){_e();return}b.value=!0;try{const W={...p.value},Ae=m.value?p.value.api_key:null;Ae===null&&delete W.api_key,await K.put("/api/llm/kimi/config",W),F("Kimi config saved"),Ae!==null&&p.value.api_key===Ae&&(p.value.api_key="",m.value=!1),await Promise.all([pe(),A()])}catch(W){F(W.message||"Failed","error")}finally{b.value=!1}}async function ge(){if(d.value){ce();return}d.value=!0;try{await K.put("/api/llm/auxiliary/config",r.value),F("Auxiliary config saved"),await pe()}catch(W){F(W.message||"Failed","error"),await pe()}finally{d.value=!1}}const ae=Xi(Q),ce=Xi(ge),ye=Xi(te),_e=Xi(Y),Ie=()=>(ae.cancel(),Q()),B=()=>(ye.cancel(),te()),re=()=>(_e.cancel(),Y());async function xe(W){try{await K.post("/api/codex/account/"+W+"/activate"),F("Active account switched"),await Ne()}catch(Ae){F(Ae.message||"Failed","error")}}async function Pe(W){I.value=W;try{await K.post("/api/codex/account/"+W+"/refresh"),F("Token refreshed"),await Ne()}catch(Ae){F(Ae.message||"Refresh failed","error")}finally{I.value=null}}function Je(W,Ae){j.value=W,ue.value=Ae||""}async function Ze(W){try{await K.put("/api/codex/account/"+W+"/label",{label:ue.value}),F("Label updated"),j.value=null,await Ne()}catch(Ae){F(Ae.message||"Failed","error")}}async function xt(W,Ae){if(await ls({title:"Delete Codex account",message:`Delete ${Ae||"account #"+(W+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await K.del("/api/codex/account/"+W),F("Deleted. Pool reloaded."),await Ne()}catch(Gn){F(Gn.message||"Failed","error")}}async function et(){se.value=!0;try{const W=await K.post("/api/codex/device-code");he.value=W,oe.value="pending",Ye(W)}catch(W){F(W.message||"Failed","error")}finally{se.value=!1}}async function Ye(W){Ee={cancelled:!1};const Ae=Ee;try{const Ts=await K.post("/api/codex/device-poll",{device_auth_id:W.device_auth_id,user_code:W.user_code,interval:W.interval});if(Ae.cancelled)return;ee.value=Ts,oe.value="success",await ne()}catch(Ts){if(Ae.cancelled)return;fe.value=Ts.message||"Device login failed",oe.value="error"}}function Ss(){Ee&&(Ee.cancelled=!0),oe.value=null,he.value=null}return Be(ne),ht(()=>{Ee&&(Ee.cancelled=!0),ae.cancel(),ce.cancel(),ye.cancel(),_e.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:x,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,auxForm:r,auxData:o,auxModelOptions:c,onAuxModelChange:u,savingAux:d,saveAuxConfigDebounced:ce,ollamaForm:f,kimiForm:p,savingCodex:k,savingOllama:E,savingKimi:b,probingOllama:v,ollamaKeyDirty:g,kimiKeyDirty:m,ollamaStatus:w,ollamaModels:N,ollamaSelectedModel:O,reloading:S,settingModel:R,kimiStatus:L,kimiModels:H,kimiSelectedModel:P,reloadingKimi:T,settingKimiModel:U,codexLoading:q,codexError:G,codexData:D,refreshing:I,editingLabel:j,labelValue:ue,deviceState:oe,deviceLoading:se,deviceInfo:he,deviceResult:ee,deviceError:fe,fetchAll:ne,switchProvider:y,reloadOllama:C,setOllamaModel:M,reloadKimi:$,setKimiModel:J,probeOllamaModels:Z,saveCodexConfig:Q,saveOllamaConfig:te,saveKimiConfig:Y,saveCodexConfigDebounced:ae,saveOllamaConfigDebounced:ye,saveKimiConfigDebounced:_e,saveCodexConfigNow:Ie,saveOllamaConfigNow:B,saveKimiConfigNow:re,activateAccount:xe,refreshAccount:Pe,startEditLabel:Je,saveLabel:Ze,deleteAccount:xt,startDeviceLogin:et,cancelDeviceLogin:Ss,formatSize:de}}},qd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function qw(e){return qd[e]||qd[(e||"").toLowerCase()]||"text-gray-400"}const Gw={template:`
  ...
  `},Zw={components:{TabbedPage:dr},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Ow},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:Kw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},mt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),gm=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:mt("/operations","live")},{path:"/agents",redirect:mt("/operations","agents")},{path:"/loops",redirect:mt("/operations","loops")},{path:"/processes",redirect:mt("/operations","processes")},{path:"/schedules",redirect:mt("/operations","schedules")},{path:"/audit",redirect:mt("/history","audit")},{path:"/sessions",redirect:mt("/history","sessions")},{path:"/traces",redirect:mt("/history","traces")},{path:"/usage",redirect:mt("/history","usage")},{path:"/tools",redirect:mt("/capabilities","tools")},{path:"/skills",redirect:mt("/capabilities","skills")},{path:"/knowledge",redirect:mt("/capabilities","knowledge")},{path:"/memory",redirect:mt("/capabilities","memory")},{path:"/learned",redirect:mt("/capabilities","learned")},{path:"/health",redirect:mt("/system","health")},{path:"/resources",redirect:mt("/system","resources")},{path:"/logs",redirect:mt("/system","logs")},{path:"/config",redirect:mt("/system","config")},{path:"/host-access",redirect:mt("/system","host-access")},{path:"/internals",redirect:mt("/system","internals")}],ii=E_({history:i_(),routes:gm});ii.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const g=h("starting"),m=h(""),k=gm.filter(D=>D.meta),E=X(()=>["Workspace","Operate","Observe","Manage"].map(D=>({name:D,routes:k.filter(I=>I.meta.section===D)})).filter(D=>D.routes.length)),b=X(()=>{var D;return((D=ii.currentRoute.value.meta)==null?void 0:D.label)||"Odin"}),v=X(()=>{var D;return((D=ii.currentRoute.value.meta)==null?void 0:D.section)||"Management"}),x=X(()=>{var D;return((D=ii.currentRoute.value.meta)==null?void 0:D.description)||"Management console"});K.onSessionExpired=()=>{t.value=!0,Ge.disconnect(),K.setToken(""),e.value="login"};function w(D){var I;if((D.ctrlKey||D.metaKey)&&D.key.toLowerCase()==="k"){e.value==="ready"&&(D.preventDefault(),xd());return}if(n.value&&D.key==="Tab"){const j=[...((I=a.value)==null?void 0:I.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(j.length){const ue=j[0],oe=j[j.length-1];if(D.shiftKey&&(document.activeElement===ue||!a.value.contains(document.activeElement))){D.preventDefault(),oe.focus();return}if(!D.shiftKey&&(document.activeElement===oe||!a.value.contains(document.activeElement))){D.preventDefault(),ue.focus();return}}}if(D.key==="Escape"&&n.value){n.value=!1,D.preventDefault();return}if(D.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(D.target.tagName)){D.preventDefault();const j=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');j&&j.focus()}}function N(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Be(async()=>{document.addEventListener("keydown",w),r=window.matchMedia("(max-width: 900px)"),N(),r.addEventListener("change",N);const D=await K.check();D.ok?(e.value="ready",q()):D.needsAuth?e.value="login":(e.value="ready",q())});function O(){t.value=!1,e.value="ready",q()}async function S(){await K.logout(),Ge.disconnect(),e.value="login"}function R(){s.value=!s.value}function L(){n.value=!n.value}hs(n,async D=>{var I,j;if(D)o=document.activeElement,await Et(),(j=(I=a.value)==null?void 0:I.querySelector(".nav-item"))==null||j.focus();else if(o!=null&&o.isConnected){const ue=o;o=null,requestAnimationFrame(()=>ue.focus())}});const H=X(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(D,I="info",j=3e3){f.value={text:D,level:I},clearTimeout(p),p=setTimeout(()=>{f.value=null},j)}let T=null,U=!1;function q(){Ge.onStatusChange=D=>{c.value=D},Ge.onStateChange=(D,I)=>{u.value=D,d.value=I.latency??-1,D==="connected"?(U&&P("Connection restored","success"),U=!0):D==="reconnecting"&&I.attempt===1&&P("Connection lost — reconnecting…","warn")},Ge.connect(),G(),T&&clearInterval(T),T=setInterval(G,15e3)}async function G(){try{const D=await K.get("/api/status");g.value=D.status==="online"?"online":"starting";const I=D.uptime_seconds||0,j=Math.floor(I/3600),ue=Math.floor(I%3600/60);m.value=`${j}h ${ue}m uptime`}catch{g.value="offline",m.value=""}}return ht(()=>{T&&clearInterval(T),Ge.disconnect(),document.removeEventListener("keydown",w),r==null||r.removeEventListener("change",N)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:H,wsToast:f,botStatus:g,botUptime:m,navRoutes:k,navGroups:E,currentPage:b,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:O,logout:S,toggleSidebar:R,toggleMobileNavigation:L,openPalette:xd}}},kn=Sl(Yw);kn.component("odin-icon",O_);kn.component("login-screen",Jw);kn.component("toast-container",yx);kn.component("confirm-host",xx);kn.component("command-palette",N_);kn.directive("modal-focus",D_);kn.use(ii);kn.mount("#app");
