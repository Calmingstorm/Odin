...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(n.value="Copied")}catch{e.value===u&&(n.value="Copy unavailable — select text manually")}}return Wt(()=>e.value,()=>{t.value=!1,n.value=""}),Wt(a,()=>{t.value=!1,n.value=""}),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},GS={components:{ToolOutput:ec},setup(){const e=f([]),t=f([]),s=f({}),a=50;function n(p){var y,R,k,b,g,x,S,_,E,L,A;const m=p.payload||p,h=m.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(h)&&!(m.agent_id||(y=m.metadata)!=null&&y.agent_id))&&!(["loop_tool_start","loop_tool"].includes(h)&&!(m.call_id||(R=m.metadata)!=null&&R.call_id))){if(h==="tool_start"||h==="loop_tool_start"){const P=m.call_id||((k=m.metadata)==null?void 0:k.call_id)||null,N=m.agent_id||((b=m.metadata)==null?void 0:b.agent_id)||"",w={callId:P,agentId:N,agentLabel:m.agent_label||((g=m.metadata)==null?void 0:g.agent_label)||"",toolInput:m.tool_input,id:P?`${N}:${P}`:`${m.action}-${Date.now()}`,tool:m.action,actor:m.actor||"",channel:m.channel_id||"",iteration:m.iteration??((x=m.metadata)==null?void 0:x.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(w);return}if(h==="tool_end"||h==="loop_tool"){const P=m.call_id||((S=m.metadata)==null?void 0:S.call_id)||null,N=m.agent_id||((_=m.metadata)==null?void 0:_.agent_id)||"";let w=-1;if(P&&(w=e.value.findIndex(I=>I.callId===P&&I.agentId===N&&I.status==="running")),w<0&&!P)for(let I=e.value.length-1;I>=0;I--){const K=e.value[I];if(K.tool===m.action&&K.agentId===N&&K.status==="running"){w=I;break}}if(w>=0){const I=e.value[w];I.status=m.error||(E=m.metadata)!=null&&E.error||["error","failed","cancelled","denied","outcome_unknown"].includes(m.status||((L=m.metadata)==null?void 0:L.status))?"error":"success",I.elapsed=m.execution_time_ms??m.duration_ms??((A=m.metadata)==null?void 0:A.elapsed_ms)??Date.now()-I.startTime,I.result=m.result_summary??m.detail??"",I.fadingOut=!0,setTimeout(()=>{const K=e.value.indexOf(I);K>=0&&e.value.splice(K,1),t.value.unshift(I),t.value.length>a&&t.value.pop()},5e3)}return}if(h==="tool_stream"){const P=m.call_id||m.tool_name||"unknown";if(m.finished){const N={...s.value};delete N[P],s.value=N}else{const w=((s.value[P]||"")+(m.chunk||"")).split(`
...
... (truncated)`:s}function Tf(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Nu(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function yg(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const xg=Symbol("agent-detail-cancelled"),JS=15e3;function ZS(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:a,cancelTimeout:n}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((m,h)=>{r=m,c=h});function u(m,h){o||(o=!0,l!==null&&n(l),l=null,(m?r:c)(h))}let p;try{p=e(i==null?void 0:i.signal)}catch(m){u(!1,m)}return o||Promise.resolve(p).then(m=>u(!0,m),m=>u(!1,m)),!o&&Number.isFinite(t)&&t>0&&(l=a(()=>{const m=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${m}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,xg),i==null||i.abort()}}}function _g({state:e,requestDetail:t,timeoutMs:s=JS,detailLabel:a="Agent detail",scheduleTimeout:n=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:m,coalesce:h}){if(!p)return Promise.resolve();if(h&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const y={agentId:p,cancel:null,promise:null};l=y,m?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const R=ZS(k=>t(p,{signal:k}),{timeoutMs:s,timeoutLabel:a,scheduleTimeout:n,cancelTimeout:i});return y.cancel=R.cancel,y.promise=(async()=>{let k=null,b=null;try{k=await R.promise}catch(g){b=g}k!==xg&&(l!==y||e.detailId!==p||(l=null,!b&&(k===null||typeof k!="object")&&(b=new Error(`${a} response was empty or invalid`)),b?e.detail===null&&(e.detailError=(b==null?void 0:b.message)||`Failed to load ${a.toLowerCase()}`):(e.detail=k,e.detailError=null),e.detailLoading=!1))})(),y.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function YS({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:a,intervalMs:n=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&a())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,n))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const QS={components:{ToolOutput:ec},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(!1),n=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),m=f("");let h=!1;const R=_g({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return p.value},set detailError(O){p.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:$})=>z.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:$})});async function k(O){m.value="",await R.open(O.id)}function b(){R.close(),m.value=""}async function g(O,$){try{await navigator.clipboard.writeText($||""),m.value=O,setTimeout(()=>{m.value===O&&(m.value="")},1500)}catch{ke.error("Copy failed")}}const x=H(()=>e.value.reduce((O,$)=>O+($.iteration_count||0),0)),S=H(()=>e.value.filter(O=>O.status==="running").length);function _(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function E(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function L(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function A(O=!1){O=O===!0,O||(t.value=!0);try{const $=await z.get("/api/loops");e.value=Array.isArray($)?$:[],s.value=null}catch($){O||(s.value=$.message)}O||(t.value=!1)}async function P(){l.value=null;const O=n.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const $={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&($.stop_condition=O.stop_condition.trim()),i.value=!0;try{const re=await z.post("/api/loops",$);ke.success(`Loop started: ${re.loop_id}`),n.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},a.value=!1,await A()}catch(re){l.value=re.message}i.value=!1}async function N(O){if(await os({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=O;try{await z.del(`/api/loops/${encodeURIComponent(O)}`),ke.success("Loop stopped"),await A()}catch(re){ke.error(re.message||"Failed to stop loop")}o.value=null}}async function w(O){r.value=O;try{await z.post(`/api/loops/${encodeURIComponent(O)}/restart`),ke.success("Loop restarted"),await A()}catch($){ke.error($.message||"Failed to restart loop")}r.value=null}function I(O){h&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(A(!0),d.value&&R.refresh())}let K=null;function G(){K!==null&&clearInterval(K),K=null}function M(){G(),h&&(K=setInterval(()=>{A(!0),d.value&&R.refresh()},5e3))}return tt(()=>{h=!0,A(),ut.subscribe("events",I),M()}),rs(()=>{h=!0,A(!0),M()}),Kt(()=>{h=!1,G()}),xt(()=>{h=!1,ut.unsubscribe("events",I),G(),R.close()}),{loops:e,loading:t,error:s,showCreate:a,form:n,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:m,totalIterations:x,runningCount:S,statusDotClass:_,statusBadge:E,modeBadge:L,formatAge:gg,formatDuration:Ji,formatTs:ni,formatTokens:yg,openDetail:k,closeDetail:b,copyText:g,fetchLoops:A,doCreate:P,doStop:N,doRestart:w}}},e1={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(Ko(null)),n=H(()=>a.value.available),i=H(()=>Oo(a.value));let l=null;const o=f(!1),r=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""}),c=f(!1),d=f(null),u=H(()=>If(a.value,r.value.action));function p(B){return If(a.value,B)}const m=f(null),h=H(()=>Af(r.value.run_at));Wt(()=>r.value.run_at,()=>{m.value=null});const y=H(()=>{var ue;const B=h.value;return B.state==="ok"?B.instant:B.state==="ambiguous"&&m.value!==null&&((ue=B.options[m.value])==null?void 0:ue.instant)||null}),R=H(()=>{const B=y.value;return B?`${B.toLocaleString()} local — ${B.toISOString()} UTC`:""}),k=f(null),b=f(!1),g=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],x=f(null),S=f(null),_=f(null),E=f(null),L=f(null),A=f(null),P=f({}),N=f({}),w=f(null),I=f([]),K=f(!1),G=f("");let M=0;const O=H(()=>e.value.filter(B=>B.cron&&!B.one_time).length),$=H(()=>e.value.filter(B=>B.one_time).length),re=H(()=>e.value.filter(B=>B.trigger).length),ce=H(()=>e.value.filter(B=>B.paused).length),Z=H(()=>e.value.filter(B=>B.consecutive_failures>0).length);function J(B){if(!B)return"-";const ue=Date.now(),he=(new Date(B).getTime()-ue)/1e3;if(he<0)return"overdue";if(he<60)return"in < 1 min";if(he<3600)return`in ${Math.floor(he/60)} min`;if(he<86400){const Ve=Math.floor(he/3600),$e=Math.floor(he%3600/60);return $e>0?`in ${Ve}h ${$e}m`:`in ${Ve}h`}const Fe=Math.floor(he/86400);return`in ${Fe} day${Fe!==1?"s":""}`}function se(B){return B==null?"-":B<1e3?`${B}ms`:B<6e4?`${(B/1e3).toFixed(1)}s`:Ji(B/1e3)}function j(B=r.value.cron){r.value.cron=B,Ef(r.value,"cron"),k.value=null}function ye(B=r.value.run_at){r.value.run_at=B,Ef(r.value,"run_at"),k.value=null}function Oe(B){return Af(P.value[B.id]||"")}function ne(B,ue){P.value[B]=ue,delete N.value[B]}function ie(B,ue){N.value[B]=ue===""?null:Number(ue)}async function ve(B){let ue;try{ue=l1(Oe(B),N.value[B.id])}catch(oe){ke.error(oe.message);return}A.value=B.id;try{const oe=await z.put(`/api/schedules/${encodeURIComponent(B.id)}`,{run_at:ue});oe!=null&&oe.inert_reason||oe!=null&&oe.paused?ke.error(`Schedule remains paused and inert: ${oe.inert_reason||"the server kept it paused"}`):(ke.success("Schedule re-armed for the new run time"),delete P.value[B.id],delete N.value[B.id]),await ge()}catch(oe){T(oe),ke.error(oe.message||"Failed to re-arm schedule")}finally{A.value=null}}async function be(){const B=r.value.cron.trim();if(B){b.value=!0;try{k.value=await z.post("/api/schedules/validate-cron",{expression:B})}catch(ue){k.value={valid:!1,error:ue.message}}b.value=!1}}async function ge(){t.value=!0,s.value=null;try{e.value=await z.get("/api/schedules")}catch(B){s.value=B.message}t.value=!1}async function Ne(){try{a.value=Ko(await z.get("/api/schedules/status"))}catch(B){a.value=Rf(B)||Ko(null)}}function T(B){const ue=Rf(B);ue&&(a.value=ue)}async function F(B){if(w.value===B){w.value=null,I.value=[];return}w.value=B,K.value=!0,I.value=[];const ue=++M;try{const oe=await z.get(`/api/schedules/${encodeURIComponent(B)}/history?limit=10`);if(ue!==M||w.value!==B)return;I.value=oe,G.value=""}catch(oe){if(ue!==M||w.value!==B)return;I.value=[],G.value=oe.message||"Failed to load execution history"}ue===M&&(K.value=!1)}async function W(){if(d.value=null,!p(r.value.action)){d.value=Oo(a.value);return}const B=r.value;if(!B.description.trim()){d.value="Description is required";return}if(B.action!=="webhook"&&!B.channel_id.trim()){d.value="Channel ID is required";return}if(!B.cron.trim()&&!B.run_at.trim()){d.value="Cron expression or run_at time is required";return}if(B.cron.trim()&&B.run_at.trim()){d.value="Choose either Cron or One-Time, not both";return}const ue={description:B.description.trim(),action:B.action,channel_id:B.channel_id.trim()};if(B.cron.trim()&&(ue.cron=B.cron.trim()),B.run_at.trim()){const oe=h.value;if(oe.state==="nonexistent"){d.value="That local time does not exist (daylight saving gap)";return}if(oe.state==="invalid"){d.value="One-time run time is not a valid date";return}const he=y.value;if(oe.state==="ambiguous"&&m.value===null){d.value="That local time happens twice — choose which occurrence to use";return}if(!he){d.value="One-time run time could not be resolved";return}ue.run_at=he.toISOString()}if(B.action==="reminder"&&B.message.trim()&&(ue.message=B.message.trim()),B.action==="check"&&(B.tool_name.trim()&&(ue.tool_name=B.tool_name.trim()),B.report_format&&(ue.report_format=B.report_format),B.tool_input_str.trim()))try{ue.tool_input=JSON.parse(B.tool_input_str.trim())}catch{d.value="Tool input must be valid JSON";return}if(B.action==="webhook"){if(!B.webhook_url.trim()){d.value="Webhook URL is required";return}const oe={url:B.webhook_url.trim(),method:B.webhook_method};if(B.webhook_headers_str.trim())try{const he=JSON.parse(B.webhook_headers_str.trim());if(!he||Array.isArray(he)||typeof he!="object")throw new Error("not an object");oe.headers=he}catch{d.value="Webhook headers must be a valid JSON object";return}if(B.webhook_body&&(oe.body=B.webhook_body),B.webhook_expected_status_str.trim()){const he=B.webhook_expected_status_str.split(",").map(Fe=>Number(Fe.trim()));if(he.some(Fe=>!Number.isInteger(Fe)||Fe<100||Fe>599)){d.value="Expected status codes must be comma-separated HTTP codes";return}oe.expected_status_codes=he}ue.webhook_config=oe}c.value=!0;try{await z.post("/api/schedules",ue),ke.success("Schedule created"),r.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""},k.value=null,o.value=!1,await ge()}catch(oe){T(oe),d.value=oe.message}c.value=!1}async function me(B){if(!p(B.action)){ke.error(Oo(a.value));return}const ue=B.id;x.value=ue;try{const oe=await z.post(`/api/schedules/${encodeURIComponent(ue)}/run`);if(oe.status==="failure")ke.error(`Execution failed: ${oe.error||"unknown error"}`);else{const he=oe.warning?`Executed (${oe.warning})`:"Executed successfully";ke.success(he)}await ge()}catch(oe){T(oe),ke.error(oe.message||"Failed to trigger")}x.value=null}async function de(B){if(B.paused&&!p(B.action)){ke.error(Oo(a.value));return}_.value=B.id;const ue=!B.paused;try{const oe=await z.put(`/api/schedules/${encodeURIComponent(B.id)}`,{paused:ue});!ue&&(oe!=null&&oe.inert_reason)?ke.error(`Schedule remains paused and inert: ${oe.inert_reason}`):ke.success(ue?"Schedule paused":"Schedule resumed"),await ge()}catch(oe){T(oe),ke.error(oe.message||"Failed to update schedule")}_.value=null}const fe=new Map;function _e(B,ue){const oe=fe.get(B.id);oe&&clearTimeout(oe.timer);const he={run:()=>q(B,ue),timer:null};he.timer=setTimeout(()=>{fe.delete(B.id),he.run()},500),fe.set(B.id,he)}async function q(B,ue){L.value=B.id;try{await z.put(`/api/schedules/${encodeURIComponent(B.id)}`,{report_format:ue}),ke.success(ue?"Structured report enabled":"Plain-text report enabled")}catch(oe){ke.error(`Update failed: ${oe.message}`)}finally{await ge(),L.value=null}}function te(){for(const[B,ue]of[...fe])clearTimeout(ue.timer),fe.delete(B),ue.run()}async function X(B){E.value=B;try{await z.post(`/api/schedules/${encodeURIComponent(B)}/reset-failures`),ke.success("Failure counters reset"),await ge()}catch(ue){ke.error(ue.message||"Failed to reset")}E.value=null}async function xe(B){const ue=e.value.find(he=>he.id===B);if(await os({title:"Delete schedule",message:`Delete "${(ue==null?void 0:ue.description)||B}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){S.value=B;try{await z.del(`/api/schedules/${encodeURIComponent(B)}`),ke.success("Schedule deleted"),await ge()}catch(he){ke.error(he.message||"Failed to delete schedule")}S.value=null}}return tt(()=>{ge(),Ne(),l=setInterval(Ne,n1)}),xt(()=>{te(),l&&clearInterval(l)}),{schedules:e,loading:t,error:s,schedulingAvailable:n,schedulingAvailabilityMessage:i,selectedActionAvailable:u,actionAvailable:p,showCreate:o,form:r,creating:c,createError:d,runAtUtcPreview:R,runAtAnalysis:h,runAtOccurrence:m,cronResult:k,validatingCron:b,cronPresets:g,runningId:x,deletingId:S,togglingId:_,resettingId:E,reportUpdatingId:L,flushReportFormatTimers:te,rearmingId:A,rearmRunAt:P,rearmOccurrences:N,rearmAnalysis:Oe,expandedId:w,history:I,historyLoading:K,historyError:G,cronCount:O,oneTimeCount:$,webhookCount:re,pausedCount:ce,failingCount:Z,formatTs:ni,formatAge:gg,formatFuture:J,formatMs:se,formatDuration:Ji,onCronInput:j,onRunAtInput:ye,validateCron:be,toggleExpand:F,fetchSchedules:ge,fetchSchedulingAvailability:Ne,doCreate:W,doRunNow:me,doTogglePause:de,doUpdateReportFormat:_e,doResetFailures:X,doDelete:xe,setRearmRunAt:ne,setRearmOccurrence:ie,doRearmSchedule:ve}}},wg=[{id:"live",label:"Live",component:GS},{id:"agents",label:"Agents",component:QS},{id:"loops",label:"Loops",component:XS},{id:"processes",label:"Processes",component:e1},{id:"schedules",label:"Schedules",component:o1}],r1={components:{TabbedPage:Xr},setup(){return{tabs:wg}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},c1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
... (truncated)`:ee:""}async function me(){const ee=_.value.trim();if(!ee)return;const Le=++I;P.value=!0,N.value="",w.value=A.value!==null;try{let He=`/api/sessions/search?q=${encodeURIComponent(ee)}&limit=50`;E.value.trim()&&(He+=`&channel_id=${encodeURIComponent(E.value.trim())}`),L.value.trim()&&(He+=`&user_id=${encodeURIComponent(L.value.trim())}`);const rt=await z.get(He);if(Le!==I)return;A.value=rt.results||[],w.value=!1}catch(He){if(Le!==I)return;N.value=He.message||"Search failed. Please retry."}finally{Le===I&&(P.value=!1)}}function de(){I++,_.value="",E.value="",L.value="",A.value=null,N.value="",w.value=!1,P.value=!1}function fe(ee){return ee?ee.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function _e(ee){return ee==="user"?"fts-result-user":ee==="assistant"?"fts-result-assistant":ee==="summary"?"fts-result-summary":ee==="fts"?"fts-result-fts":ee==="channel"?"fts-result-channel":"fts-result-default"}function q(ee){return ee==="user"?"badge-info":ee==="assistant"?"badge-success":ee==="summary"?"badge-warning":ee==="fts"?"badge-success":"badge-info"}let te=0;async function X(){const ee=++te;t.value=!0,s.value=null;try{const Le=await z.get("/api/sessions");if(ee!==te)return;e.value=Le}catch(Le){if(ee!==te)return;s.value=Le.message}ee===te&&(t.value=!1)}function xe(){s.value=null,X()}async function B(ee){if(a.value===ee){a.value=null,n.value=null,S.value=new Set;return}a.value=ee,n.value=null,i.value=!0,S.value=new Set;const Le=++l;try{const He=await z.get(`/api/sessions/${encodeURIComponent(ee)}`);Le===l&&a.value===ee&&(n.value=He)}catch(He){Le===l&&a.value===ee&&(n.value={messages:[],summary:"",error:He.message||"Failed to load session"})}finally{Le===l&&(i.value=!1)}}function ue(ee){const Le=new Set(c.value);Le.has(ee)?Le.delete(ee):Le.add(ee),c.value=Le}function oe(){re.value?c.value=new Set:c.value=new Set(O.value.map(ee=>ee.channel_id))}function he(ee){o.value=ee}async function Fe(){if(o.value){r.value=!0;try{await z.del(`/api/sessions/${encodeURIComponent(o.value)}`),a.value===o.value&&(a.value=null,n.value=null),c.value.delete(o.value),await X()}catch(ee){s.value=ee.message||"Failed to clear session"}r.value=!1,o.value=null}}function Ve(){d.value=!0}async function $e(){if(c.value.size!==0){r.value=!0;try{await z.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(a.value)&&(a.value=null,n.value=null),c.value=new Set,await X()}catch(ee){s.value=ee.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Ke(ee,Le){const He=`/api/sessions/${encodeURIComponent(ee)}/export?format=${Le}`;try{const rt=await z.getBlob(He),Zt=URL.createObjectURL(rt),lt=document.createElement("a");lt.href=Zt,lt.download=`session-${ee}.${Le==="text"?"txt":"json"}`,lt.click(),URL.revokeObjectURL(Zt)}catch(rt){s.value=rt.message||"Failed to export session"}}let at=null;function Xe(ee){ee.payload&&ee.payload.channel_id&&(clearTimeout(at),at=setTimeout(()=>{if(X(),a.value&&ee.payload.channel_id===a.value){const Le=a.value,He=l;z.get(`/api/sessions/${encodeURIComponent(Le)}`).then(rt=>{He!==l||a.value!==Le||(n.value=rt)}).catch(()=>{})}},2e3))}let Y=!1,Ee=null;function Ae(){Y||(Y=!0,X(),ut.subscribe("events",Xe),Ee=ut.onReconnected(()=>X()))}tt(()=>{K(),Ae()}),rs(()=>{Ae()});function Me(){Y&&(Y=!1,ut.unsubscribe("events",Xe),Ee&&(Ee(),Ee=null),clearTimeout(at))}return Kt(Me),xt(Me),{sessions:e,loading:t,error:s,expandedId:a,detail:n,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:re,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:m,sortAsc:h,filterPresets:y,sortOptions:R,filteredSessions:O,hasActiveFilters:M,customPresets:k,showSavePreset:b,newPresetName:g,threadView:x,threads:$,collapsedThreads:S,ftsQuery:_,ftsChannelId:E,ftsUserId:L,ftsResults:A,ftsSearching:P,ftsError:N,ftsStale:w,formatAge:ne,formatTimestamp:ie,formatFullTimestamp:ve,messageClass:be,threadMsgClass:ge,roleBadge:Ne,roleDotClass:T,roleLabelClass:F,truncateContent:W,threadSummary:ce,fetchSessions:X,retry:xe,toggleSession:B,toggleSelect:ue,toggleSelectAll:oe,confirmClear:he,clearSession:Fe,confirmBulkClear:Ve,doBulkClear:$e,exportSession:Ke,applyPreset:J,applyCustomPreset:se,saveCustomPreset:j,removeCustomPreset:ye,resetFilters:Oe,toggleThread:Z,runFtsSearch:me,clearFtsSearch:de,highlightSnippet:fe,ftsResultClass:_e,ftsTypeBadge:q}}},p1={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:yg}}},f1={components:{ContextAssemblyPanel:p1},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(E){if(!E)return"—";try{const L=new Date(E);return isNaN(L.getTime())?E:L.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return E}}function p(E){return!E&&E!==0?"—":E<1e3?E+"ms":(E/1e3).toFixed(1)+"s"}function m(E){return!E&&E!==0?"—":E>=1e3?(E/1e3).toFixed(1)+"k":String(E)}function h(E){if(!E)return"";if(typeof E=="string")return E;try{return JSON.stringify(E,null,2)}catch{return String(E)}}function y(E){n.value===E?n.value=null:(n.value=E,c.value={})}function R(E,L){const A=E+"-"+L;c.value={...c.value,[A]:!c.value[A]}}function k(E,L){return!!c.value[E+"-"+L]}function b(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,S()}async function g(){try{const E=await z.get("/api/trajectories");e.value=E.files||[],r.value=E.count||0}catch{}}let x=0;async function S(){const E=++x;s.value=!0,a.value=null,n.value=null,i.value=null,c.value={};try{if(o.value){const L=await z.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(E!==x)return;let A=L.entries||[];d.value.tool_name&&(A=A.filter(P=>(P.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(A=A.filter(P=>P.is_error)),d.value.channel_id&&(A=A.filter(P=>P.channel_id===d.value.channel_id)),d.value.user_id&&(A=A.filter(P=>P.user_id===d.value.user_id)),t.value=A}else{const L=new URLSearchParams;d.value.channel_id&&L.set("channel_id",d.value.channel_id),d.value.user_id&&L.set("user_id",d.value.user_id),d.value.tool_name&&L.set("tool_name",d.value.tool_name),d.value.errors_only&&L.set("errors_only","true"),L.set("limit",String(d.value.limit));const A=L.toString(),P=await z.get(`/api/trajectories/search/query?${A}`);if(E!==x)return;t.value=P.results||[]}}catch(L){if(E!==x)return;a.value=L.message}E===x&&(s.value=!1)}async function _(){if(!l.value.trim())return;const E=++x;s.value=!0,a.value=null,c.value={};try{const L=await z.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(E!==x)return;i.value=L.entry||null,i.value||(a.value="No trace found for this message ID")}catch(L){if(E!==x)return;L.status===404?(i.value=null,a.value="No trace found for message ID: "+l.value):a.value=L.message}E===x&&(s.value=!1)}return tt(async()=>{await g(),await S()}),{files:e,entries:t,loading:s,error:a,expandedIdx:n,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:m,formatJSON:h,truncateBlock:bg,toggleExpand:y,toggleIteration:R,isIterationExpanded:k,clearFilters:b,fetchFiles:g,fetchTraces:S,lookupMessage:_}}};function m1(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function h1(e){return e?`${e.approximate?"~":""}${Nu(e.total||0)}`:"0"}const v1={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),a=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),n=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=H(()=>a.value.work||{}),m=E=>E==null?"Not reported":`$${Number(E).toFixed(6)}`,h=H(()=>Math.max(1,...(a.value.activity_over_time||[]).map(E=>Number(E.count||0)))),y=H(()=>({minWidth:`max(100%, ${(a.value.activity_over_time||[]).length*5}px)`})),R=E=>({height:`${Math.max(4,Math.round(Number(E||0)/h.value*100))}%`}),k=H(()=>s.value&&l.value-i.value>3e4);async function b(){const E=++d,L=n.value;try{const A=await z.get(`/api/usage?range=${encodeURIComponent(L)}`);if(E!==d||L!==n.value)return;a.value=A,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(A){E===d&&(t.value=A.message)}finally{E===d&&(e.value=!1)}}function g(E){n.value=E,e.value=!s.value,b()}function x(){e.value=!0,b()}function S(){c||(c=!0,b(),o=setInterval(b,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function _(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return tt(S),rs(S),Kt(_),xt(_),{data:a,work:p,loading:e,error:t,hasData:s,range:n,ranges:u,isStale:k,fmtNum:Nu,fmtDuration:m1,tokenLabel:h1,formatActualCost:m,activityTrackStyle:y,activityBar:R,selectRange:g,retry:x}}},kg=[{id:"audit",label:"Audit",component:c1},{id:"sessions",label:"Sessions",component:u1},{id:"traces",label:"Traces",component:f1},{id:"usage",label:"Usage & Activity",component:v1}],g1={components:{TabbedPage:Xr},setup(){return{tabs:kg}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Nc=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],b1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(A){return A.source!=="builtin"?"":u[A.state]||""}function m(A,P){const N=A&&Array.isArray(A.tools)?A.tools:null;if(c.value=!!N,r.value=N?!!A.global_enabled:null,!N){e.value=P.map(K=>({...K,source:"unknown",enabled:void 0,state:null}));return}const w=new Set(N.map(K=>K.name)),I=P.filter(K=>!w.has(K.name)).map(K=>({...K,source:K.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...N.map(K=>({...K,source:"builtin"})),...I]}async function h(A,P){if(d.value.has(A.name))return;const N=!!P.target.checked,w=new Set(d.value);w.add(A.name),d.value=w;try{const I=await z.post(`/api/tools/builtins/${encodeURIComponent(A.name)}/enabled`,{enabled:N});m(I,e.value),s.value=null;try{const K=await z.get("/api/tools");m(I,K)}catch(K){console.warn("Built-in toggle committed; visible catalog refresh failed",K)}}catch(I){P.target.checked=!!A.enabled,s.value=I.message||`Failed to toggle ${A.name}`}finally{const I=new Set(d.value);I.delete(A.name),d.value=I}}const y=H(()=>e.value.filter(A=>A.source==="builtin"&&A.is_core).length),R=H(()=>e.value.filter(A=>A.source==="skill").length),k=H(()=>Object.values(n.value).reduce((A,P)=>A+P,0));function b(A){for(const P of Nc)if(P.id!=="other"&&P.match(A))return P.id;return"other"}const g=H(()=>{let A=e.value;if(a.value){const P=a.value.toLowerCase();A=A.filter(N=>N.name.toLowerCase().includes(P)||(N.description||"").toLowerCase().includes(P))}return o.value&&(A=A.filter(P=>b(P.name)===o.value)),A}),x=H(()=>{const A=new Set;for(const P of e.value)A.add(b(P.name));return Nc.filter(P=>A.has(P.id))}),S=H(()=>{const A=g.value,P={};for(const w of A){const I=b(w.name);P[I]||(P[I]=[]),P[I].push(w)}const N=[];for(const w of Nc)P[w.id]&&P[w.id].length>0&&N.push({label:w.label,icon:w.icon,tools:P[w.id].sort((I,K)=>I.name.localeCompare(K.name))});return N});function _(A){i.value={...i.value,[A]:!i.value[A]}}async function E(){t.value=!0,s.value=null;try{const[A,P,N]=await Promise.all([z.get("/api/tools"),z.get("/api/tools/stats").catch(()=>({})),z.get("/api/tools/builtins").catch(()=>null)]);m(N,A),n.value=P||{}}catch(A){s.value=A.message}t.value=!1}function L(){E()}return tt(()=>{E()}),{tools:e,loading:t,error:s,search:a,stats:n,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:y,skillCount:R,totalUsage:k,filteredTools:g,groupedTools:S,usedCategories:x,stateBadge:p,applyInventory:m,toggleBuiltinTool:h,truncate:Lu,toggleExpand:_,refresh:L}}};function y1(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const a="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(a,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function x1(e){if(!e)return"1";const t=e.split(`
...
`);const Se=new Blob([le],{type:"text/plain"}),qe=URL.createObjectURL(Se),Ge=document.createElement("a");Ge.href=qe,Ge.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ge.click(),URL.revokeObjectURL(qe)}function te(le){const Se=Mf(le);navigator.clipboard.writeText(Se).then(()=>{h.value=le.id,setTimeout(()=>{h.value=null},1500)}).catch(()=>{})}function X(le){l.value=l.value===le?"":le,g.value="all",S.value=!1}function xe(le){return le.level==="ERROR"?"log-line-error":le.level==="WARNING"?"log-line-warning":"text-gray-300"}function B(le){return le==="ERROR"?"text-red-500 font-semibold":le==="WARNING"?"text-yellow-500":"text-blue-500"}function ue(le){return le==="ERROR"?"log-chip-error":le==="WARNING"?"log-chip-warning":"log-chip-info"}function oe(le){g.value=le.id;const Se=le.filters;l.value=Se.level||"",x.value=Se.timeRange||"",o.value=Se.text||"",S.value=!!Se.hasToolName,Se.levels&&(l.value=Se.levels.includes("WARNING")&&Se.levels.includes("ERROR")?Pf:Se.levels[0]||"")}function he(le){g.value=le.id,l.value=le.filters.level||"",x.value=le.filters.timeRange||"",o.value=le.filters.text||"",S.value=!!le.filters.hasToolName}function Fe(){if(!L.value.trim())return;const le={id:"custom-"+Date.now(),name:L.value.trim(),filters:{level:l.value,timeRange:x.value,text:o.value,hasToolName:S.value||void 0}};_.value=[..._.value,le],N(),E.value=!1,L.value=""}function Ve(le){_.value=_.value.filter(Se=>Se.id!==le),N(),g.value===le&&(g.value="all",x.value="",S.value=!1,l.value="",o.value="")}const $e=f("all"),Ke=f(""),at=f(""),Xe=f(""),Y=f(""),Ee=f(""),Ae=f(100),Me=eC,ee=f(!1),Le=f(!1),He=f(""),rt=f([]),Zt=f(null),lt=f(null);function gt(){e.value="search",Zt.value||Yt()}async function Yt(){try{Zt.value=await z.get("/api/logs/stats")}catch{}}function cs(){const le=Ee.value;if(!le){Xe.value="",Y.value="";return}const qe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[le];if(qe){const Ge=new Date(Date.now()-qe*1e3);Xe.value=oa(Ge),Y.value=""}}function oa(le){const Se=qe=>String(qe).padStart(2,"0");return`${le.getFullYear()}-${Se(le.getMonth()+1)}-${Se(le.getDate())}T${Se(le.getHours())}:${Se(le.getMinutes())}`}function js(le){if(!le)return"";const Se=new Date(le);return isNaN(Se.getTime())?"":Se.toISOString()}let Ze=0;async function ra(){if(ee.value)return;const le=++Ze;ee.value=!0,He.value="",Le.value=!0,lt.value=null;try{const Se=new URLSearchParams;$e.value&&$e.value!=="all"&&Se.set("level",$e.value),Ke.value&&Se.set("tool",Ke.value),at.value&&Se.set("q",at.value);const qe=js(Xe.value),Ge=js(Y.value);qe&&Se.set("start",qe),Ge&&Se.set("end",Ge),Se.set("limit",String(Ae.value));const kt=await z.get(`/api/logs/search?${Se.toString()}`);if(le!==Ze)return;rt.value=kt.entries||[]}catch(Se){if(le!==Ze)return;He.value=Se.message||"Search failed",rt.value=[]}finally{le===Ze&&(ee.value=!1)}}function vs(){Ze++,$e.value="all",Ke.value="",at.value="",Xe.value="",Y.value="",Ee.value="",Ae.value=100,rt.value=[],Le.value=!1,He.value="",lt.value=null,ee.value=!1}function Ms(le){lt.value=lt.value===le?null:le}function gs(le){if(!le.timestamp)return"";try{return new Date(le.timestamp).toLocaleString()}catch{return le.timestamp}}function En(le){return le.type==="web_action"?`${le.status||""} (${le.execution_time_ms||0}ms)`:(le.result_summary||"").slice(0,200)}function Qt(le){return le.error?"log-line-error":"text-gray-300"}function _t(le){try{return JSON.stringify(le,null,2)}catch{return String(le)}}let ds=null,ba=!1;function rn(){ba||(ba=!0,ut.subscribe("logs",ye),c.value=ut.connected,d.value=ut.state||"disconnected",ds=ut.onState(le=>{d.value=le,c.value=le==="connected"}))}function ca(){ba&&(ba=!1,ut.unsubscribe("logs",ye),ds&&(ds(),ds=null))}return tt(()=>{P(),window.addEventListener("pointerup",me),window.addEventListener("pointercancel",me)}),rs(rn),Kt(ca),xt(()=>{ca(),window.removeEventListener("pointerup",me),window.removeEventListener("pointercancel",me)}),{mode:e,logs:t,paused:n,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:a,groupedLogs:j,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:se,pauseBuffer:A,showJumpBottom:m,copiedIndex:h,regexError:K,levels:R,logPresets:k,timeRanges:b,timeRange:x,toolOnly:S,activeLogPreset:g,customLogPresets:_,showSaveLogPreset:E,newLogPresetName:L,hasActiveLogFilters:w,timeRangeLabel:I,timelineBuckets:M,timelineMax:O,timelineSpanLabel:$,timelineLabelSkip:re,togglePause:fe,clearLogs:_e,exportLogs:q,logLineClass:xe,levelClass:B,levelChipClass:ue,toggleLevel:X,copyLine:te,jumpToBottom:ie,onScroll:be,onUserScrollIntent:Ne,onUserScrollKey:T,onAutoScrollToggle:de,onPointerDown:W,applyLogPreset:oe,applyCustomLogPreset:he,saveLogCustomPreset:Fe,removeLogCustomPreset:Ve,segmentHeight:Z,jumpToTimelineBucket:J,searchLevel:$e,searchTool:Ke,searchKeyword:at,searchStart:Xe,searchEnd:Y,searchTimePreset:Ee,searchLimit:Ae,searchLimits:Me,searching:ee,searchRan:Le,searchError:He,searchResults:rt,searchStats:Zt,expandedSearch:lt,switchToSearch:gt,runSearch:ra,clearSearchFilters:vs,toggleSearchExpand:Ms,formatSearchTs:gs,searchEntryText:En,searchLogLineClass:Qt,formatJson:_t,applySearchTimePreset:cs}}};function Lo(e=[]){const t=[],s=new Set;function a(n){const i=[n.kind,n.label,n.apply_mode||"",n.code||"",n.text||""].join("\0");s.has(i)||(s.add(i),t.push({...n,key:i}))}for(const n of e)for(const i of(n==null?void 0:n.consumers)||[])a({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const n of e)n!=null&&n.apply_handler&&a({kind:"handler",label:"Apply handler",code:n.apply_handler});for(const n of e)n!=null&&n.restart_reason&&a({kind:"restart",label:"Why a restart is required",text:n.restart_reason});for(const n of e)n!=null&&n.activation_policy&&a({kind:"activation",label:"Activation policy",text:n.activation_policy});return t}const sC=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function aC(e,t={}){var n,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),a=Object.hasOwn(t,"fallback")?t.fallback:(n=globalThis.document)==null?void 0:n.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return a&&a.scrollHeight>a.clientHeight?a:e||a||null}const $i=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["grafana_alerts","outbound_webhooks"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],nC={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},No=new Set(["llm_provider","openai_codex","ollama","openai_compatible","kimi","personality","discord","computer"]),iC=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function $f(e){return iC.some(t=>e===t||e.startsWith(`${t}.`))}const Tg="odin_config_center_expanded_v1",Eg="odin_config_center_category_v1",lC=50,oC=650,ml=()=>z.get("/api/config/meta");function Bn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ei(e,t){return JSON.stringify(e)===JSON.stringify(t)}function bi(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function rC(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function cC(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Ag(e,t){if(Ei(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Bn(t);const a={};for(const[n,i]of Object.entries(t)){const l=Ag(e[n],i);l!==void 0&&(a[n]=l)}return Object.keys(a).length?a:void 0}function dC(e,t){const s={};for(const[a,n]of Object.entries(t||{})){const i=Ag(e==null?void 0:e[a],n);i!==void 0&&(s[a]=i)}return s}function Rg(e,t,s,a){if(Ei(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Rg(e[l],t[l],s?`${s}.${l}`:l,a);return}a.push({path:s,oldVal:e,newVal:t})}function uC(){try{const e=JSON.parse(localStorage.getItem(Tg)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function pC(){try{const e=localStorage.getItem(Eg);return $i.some(t=>t.key===e)?e:$i[0].key}catch{return $i[0].key}}const fC={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),a=f(null),n=f(!1),i=f(null),l=f(!1),o=f(""),r=f(!1),c=f(""),d=f(""),u=f("");function p(C){i.value=C||null,C&&typeof C.authorized=="boolean"&&(l.value=C.authorized)}async function m(){try{const C=await z.get("/api/setup/status");p(C.listener),u.value=""}catch(C){p(null),u.value=`Listener status could not be loaded: ${C.message||"Unknown error"}`}}async function h(){if(!(!me.value||!o.value.trim()||r.value||W.value)){r.value=!0,c.value="",d.value="";try{const C=z.setListenerExposure(o.value.trim(),l.value);o.value="";const V=await C;c.value=V.message,p(V.listener)}catch(C){d.value=C.message||"Listener consent could not be saved."}finally{o.value="",r.value=!1}}}const y=f(null),R=["image_model","outer_model"],k=f(null),b=f(null),g=f(null),x=f(!1),S=f(!1),_=f(null),E=f(""),L=f("all"),A=f(pC()),P=f(uC()),N=f({}),w=f({}),I=f(""),K=f({}),G=f({}),M=f([]),O=f([]),$=f(!1),re=f(!1),ce=f(!1);let Z=null,J=null,se={path:null,at:0},j=0;const ye=H(()=>{var C;return(((C=t.value)==null?void 0:C.fields)||[]).filter(V=>!No.has(V.path.split(".")[0])&&!$f(V.path))}),Oe=H(()=>new Map(ye.value.map(C=>[C.path,C]))),ne=H(()=>Ne.value.reduce((C,V)=>C+V.sections.length,0)),ie=H(()=>ye.value.length),ve=H(()=>sC),be=H(()=>M.value.length>0),ge=H(()=>O.value.length>0),Ne=H(()=>{if(!e.value)return[];const C=new Set($i.flatMap(Ce=>Ce.sections)),V=$i.map(Ce=>({...Ce,sections:Ce.sections.filter(Je=>Object.hasOwn(e.value,Je)&&!No.has(Je))})).filter(Ce=>Ce.sections.length),ae=Object.keys(e.value).filter(Ce=>!C.has(Ce)&&!No.has(Ce));return ae.length&&V.push({key:"other",label:"Other",icon:"folder",sections:ae}),V}),T=H(()=>e.value?{...e.value,...N.value}:null),F=H(()=>{if(!e.value)return[];const C=[];for(const[V,ae]of Object.entries(N.value))Rg(e.value[V],ae,V,C);return C.filter(V=>!Ei(V.oldVal,V.newVal)).map(V=>{const ae=at(V.path);return{...V,label:(ae==null?void 0:ae.label)||bi(V.path.split(".").at(-1)),apply_mode:(ae==null?void 0:ae.apply_mode)||Le(V.path.split(".")[0])}})}),W=H(()=>F.value.length>0),me=H(()=>!!i.value&&l.value!==i.value.authorized),de=H(()=>{var V;const C=(V=i.value)==null?void 0:V.state;return C==="active"||C==="authorized_loopback"?"active":["pending_widening","pending_narrowing","active_rebind_pending"].includes(C)?"pending":C==="restricted"?"restricted":"unknown"}),fe=H(()=>{var C;return{active:"Exposure active",authorized_loopback:"Authorized · loopback host",pending_widening:"Authorized · restart pending",pending_narrowing:"Restriction saved · restart pending",active_rebind_pending:"Exposed · restart pending",restricted:"Loopback only",unknown:"Runtime state unavailable"}[(C=i.value)==null?void 0:C.state]||"Loading listener state"}),_e=H(()=>i.value?i.value.authorized?i.value.authorization_source==="explicit"?"Beyond-loopback access is explicitly authorized":"Beyond-loopback access is retained from this installation":"Beyond-loopback access is not authorized":"Unavailable"),q=H(()=>{var C;return{explicit:"saved explicitly in config.yml",default:"schema default; no web.host key is saved",unknown:"source could not be verified"}[(C=i.value)==null?void 0:C.configured_host_source]||"source unavailable"}),te=H(()=>{const C=i.value;return!C||C.running_scope==="unavailable"?"Actual bound address unavailable":`${(C.listening_hosts||[]).map((ae,Ce)=>{var Ct;const Je=(Ct=C.listening_ports)==null?void 0:Ct[Ce];return Je?`${ae}:${Je}`:ae}).join(", ")} · ${C.running_scope==="loopback"?"loopback only":"accepting beyond loopback"}`}),X=H(()=>F.value.length),xe=H(()=>new Set(F.value.map(C=>C.path.split(".")[0])).size),B=H(()=>!!E.value||L.value!=="all"),ue=H(()=>{const C={...G.value};for(const V of F.value){const ae=at(V.path),Ce=pe(ae,V.newVal);Ce&&(C[V.path]=Ce)}return C}),oe=H(()=>Object.keys(ue.value).length>0),he=H(()=>e.value?(B.value?Ne.value:Ne.value.filter(V=>V.key===A.value)).map(V=>({...V,sections:V.sections.filter(ae=>Qt(ae))})).filter(V=>V.sections.length):[]),Fe=H(()=>{const C=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],V=new Map(C.map(ae=>[ae,[]]));for(const ae of F.value){const Ce=V.has(ae.apply_mode)?ae.apply_mode:"restart";V.get(Ce).push(ae)}return C.filter(ae=>V.get(ae).length).map(ae=>({key:ae,label:bs(ae),entries:V.get(ae)}))}),Ve=H(()=>F.value.filter(C=>C.apply_mode==="restart").length),$e=H(()=>ye.value.filter(C=>C.pending_restart)),Ke=H(()=>$e.value.length);function at(C){const V=Oe.value.get(C);return V?{...V,apply_details:Lo([V])}:null}function Xe(C){const V=`${C}.`;return ye.value.filter(ae=>ae.path===C||ae.path.startsWith(V))}function Y(){return ye.value.some(C=>C.path==="tools.hosts"||C.path.startsWith("tools.hosts."))}function Ee(){var ae,Ce;const C=((Ce=(ae=e.value)==null?void 0:ae.tools)==null?void 0:Ce.hosts)||{},V=Object.keys(C).length;return`${V} host${V===1?"":"s"} configured.`}function Ae(C){return Xe(C).length}function Me(C){return bi(C)}function ee(C){const V=Xe(C);if(!V.length)return`${bi(C)} configuration.`;const ae=V.find(Ct=>Ct.sensitivity==="public"&&Ct.description)||V.find(Ct=>Ct.description),Ce=(ae==null?void 0:ae.description)||"";return Ce.match(/setting for (.+)\.$/i)?`${bi(C)} settings and runtime behaviour.`:Ce}function Le(C){const V=[...new Set(Xe(C).map(ae=>ae.apply_mode))];return V.length===1?V[0]:V.includes("restart")?"restart":V.includes("activation_required")?"activation_required":V[0]||"restart"}function He(C){const V=[...new Set(Xe(C).map(ae=>bs(ae.apply_mode)))];return V.length?V.length===1?V[0]:`Mixed apply behaviour: ${V.join(" · ")}`:""}function rt(C){return Lo(Xe(C))}function Zt(C){var V;return Object.hasOwn(N.value,C)?N.value[C]:(V=e.value)==null?void 0:V[C]}function lt(){const C=Zt("mcp")||{},V=Object.keys(C.servers||{}).length;return`${C.enabled?"Globally enabled":"Globally disabled"} · ${V} configured server${V===1?"":"s"}.`}function gt(C,V){return V.split(".").reduce((ae,Ce)=>ae==null?void 0:ae[Ce],C)}function Yt(C){const V=T.value;return Xe(C).filter(ae=>$f(ae.path)?!1:ae.path.split(".").length<=2?!0:!ae.path.includes(".*")).map(ae=>({...ae,key:ae.path.split(".").at(-1),value:gt(V,ae.path),apply_details:Lo([ae]),editor:ae.path==="agents.final_warning_iterations"?"warning-chips":null}))}function cs(C){const V=C.path.split(".");return V.length>2?V.slice(0,2).join("."):null}function oa(C){const V=new Map;for(const ae of Yt(C)){const Ce=cs(ae),Je=Ce||`${C}.__root`;V.has(Je)||V.set(Je,{key:Je,path:Ce,entries:[]}),V.get(Je).entries.push(ae)}return[...V.values()].map(ae=>{const Ce=ae.entries.find(Je=>Je.group_description);return{...ae,label:ae.path?bi(ae.path.split(".").at(-1)):null,description:(Ce==null?void 0:Ce.group_description)||null,apply_details:Lo(ae.entries),runtime_summaries:Ze(ae.entries)}})}function js(C){return{save:C.save_effect||(C.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:C.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[C.apply_mode]||"Effective runtime state is not currently observable."}}function Ze(C){const V=new Map;for(const ae of C){const Ce=js(ae),Je=`${ae.apply_mode}|${Ce.save}|${Ce.runtime}`;V.has(Je)||V.set(Je,{key:Je,label:bs(ae.apply_mode),save:Ce.save,runtime:Ce.runtime})}return[...V.values()]}function ra(C){if(vs(C))return C.runtime_effect||C.activation_policy||"";if(C.apply_mode==="activation_required"){const V=C.activation_policy||C.runtime_effect;return V?`Not active after saving. No activation control exists in this release. ${V}`:"Not active after saving; no activation control exists in this release."}return""}function vs(C){return C.action_available===!0&&!!(C.action_label&&C.action_endpoint)}async function Ms(C){if(vs(C))try{if(ca(C.path))throw new Error("Save this setting before applying its action.");const V=String(C.action_method||"POST").toLowerCase(),ae={post:z.post.bind(z),put:z.put.bind(z),delete:z.del.bind(z)}[V];if(!ae)throw new Error("Unsupported configuration action");await ae(C.action_endpoint,C.action_body||void 0),await Xi(),Ma("success",`${C.action_label} completed.`)}catch(V){Ma("error",V.message||`${C.action_label} failed`)}}function gs(C,V){return[C.label,C.path,C.description,...C.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(V)}function En(C){const V=E.value.trim().toLowerCase();return V?Xe(C).filter(ae=>gs(ae,V)):[]}function Qt(C){const V=Xe(C);if(L.value!=="all"&&!V.some(Ce=>Ce.apply_state===L.value))return!1;const ae=E.value.trim().toLowerCase();return!ae||`${Me(C)} ${C}`.toLowerCase().includes(ae)?!0:V.some(Ce=>gs(Ce,ae))}function _t(C,V){return Xe(C).filter(ae=>ae.apply_state===V).length}function ds(C){return C==="all"?ie.value:ye.value.filter(V=>V.apply_state===C).length}function ba(C){const V=C.sections.flatMap(ae=>Xe(ae));return{fields:V.length,modified:F.value.filter(ae=>C.sections.includes(ae.path.split(".")[0])).length,pending_restart:V.filter(ae=>ae.apply_state==="pending_restart").length,invalid:V.filter(ae=>ae.apply_state==="invalid").length,dormant:V.filter(ae=>ae.apply_state==="dormant").length}}function rn(C){var V;return Object.hasOwn(N.value,C)&&!Ei((V=e.value)==null?void 0:V[C],N.value[C])}function ca(C){return F.value.some(V=>V.path===C||V.path.startsWith(`${C}.`))}function le(C){A.value=C,E.value="",L.value="all";try{localStorage.setItem(Eg,C)}catch{}}function Se(C){L.value=C}function qe(){E.value="",L.value="all"}function Ge(C){var V;return((V=Ne.value.find(ae=>ae.sections.includes(C)))==null?void 0:V.sections)||[]}function kt(C){const V=Ge(C),ae=V.find(Ce=>P.value[Ce]===!0);return ae||V.find(Ce=>P.value[Ce]!==!1)||null}function St(C){return E.value&&!ce.value&&Qt(C)?!0:ce.value?kt(C)===C:Object.hasOwn(P.value,C)?P.value[C]===!0:!0}function cn(C){const V=!St(C);if(ce.value){const ae={...P.value};for(const Ce of Ge(C))ae[Ce]===!0&&(ae[Ce]=!1);ae[C]=V,P.value=ae;return}P.value={...P.value,[C]:V}}function An(){M.value.push(Bn(N.value)),M.value.length>lC&&M.value.shift(),O.value=[]}function dn(){n.value||W.value&&(An(),N.value={},G.value={},$.value=!1)}function Rn(C,V=!1){const ae=Date.now();if(V&&se.path===C&&ae-se.at<oC){se.at=ae;return}An(),se={path:C,at:ae}}function da(C,V,ae){if(!V.length)return ae;const Ce=Bn(C??{});let Je=Ce;for(let Ct=0;Ct<V.length-1;Ct+=1){const Vs=V[Ct];Je[Vs]=Bn(Je[Vs]??{}),Je=Je[Vs]}return Je[V.at(-1)]=ae,Ce}function ya(C){var V;return Object.hasOwn(N.value,C)?N.value[C]:Bn((V=e.value)==null?void 0:V[C])}function jt(C,V,ae={}){var pn;if(n.value||No.has(C.path.split(".")[0]))return;const[Ce,...Je]=C.path.split(".");Rn(C.path,!!ae.coalesce);const Ct=ya(Ce),Vs=Je.length?da(Ct,Je,V):V,qs={...N.value};if(Ei(Vs,(pn=e.value)==null?void 0:pn[Ce])?delete qs[Ce]:qs[Ce]=Vs,N.value=qs,G.value[C.path]){const xa={...G.value};delete xa[C.path],G.value=xa}}function ua(C){se={path:null,at:0},w.value={...w.value,[C]:String(gt(T.value,C)??"")}}function as(C){if(se={path:null,at:0},!Object.hasOwn(w.value,C))return;const V={...w.value};delete V[C],w.value=V}function un(C){const V=w.value[C.path];if(se={path:null,at:0},V===""){if(C.nullable){as(C.path),jt(C,null,{coalesce:!0});return}G.value={...G.value,[C.path]:"Enter a number."};return}const ae=Number(V);if(Number.isNaN(ae)||C.type==="integer"&&!Number.isInteger(ae)){G.value={...G.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ce={...w.value};delete Ce[C.path],w.value=Ce,jt(C,ae,{coalesce:!0})}function In(C){return Object.hasOwn(w.value,C.path)?w.value[C.path]:C.value??""}function li(C,V){if(w.value={...w.value,[C.path]:V},V===""){if(C.nullable){jt(C,null,{coalesce:!0});return}G.value={...G.value,[C.path]:"Enter a number."};return}const ae=Number(V);if(!Number.isFinite(ae)||C.type==="integer"&&!Number.isInteger(ae)){G.value={...G.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(G.value[C.path]){const Ce={...G.value};delete Ce[C.path],G.value=Ce}jt(C,ae,{coalesce:!0})}function oi(C){const V=Number.parseInt(I.value,10);if(!Number.isInteger(V)||V<1){G.value={...G.value,[C.path]:"Warning thresholds must be positive whole numbers."};return}const ae=[...new Set([...C.value||[],V])].sort((Ce,Je)=>Je-Ce);I.value="",jt(C,ae)}function ri(C,V){jt(C,(C.value||[]).filter(ae=>ae!==V))}function ns(C){return C.apply_mode==="live_read"?"Odin reads the saved file value on next use.":C.apply_mode==="live_for_new_work"?"New work uses the saved file value.":C.apply_mode==="live_apply"?C.apply_handler?`Apply the saved value through ${C.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":C.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":C.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":C.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function On(C){return C.type==="array"&&Array.isArray(C.value)&&!C.structured_container&&!C.structured_container_child&&C.sensitivity==="public"&&C.value.every(V=>["string","number","boolean"].includes(typeof V))}function Re(C){const V=String(K.value[C.path]??"").trim();if(!V)return;const ae=[...new Set([...C.value||[],V])];K.value={...K.value,[C.path]:""},jt(C,ae)}function D(C,V){jt(C,(C.value||[]).filter(ae=>ae!==V))}function pe(C,V){var Ce;if(!C)return null;if((Ce=C.enum)!=null&&Ce.length&&!C.enum.includes(V))return`Choose one of: ${C.enum.join(", ")}`;if(C.path==="agents.final_warning_iterations"&&(!Array.isArray(V)||!V.length))return"Add at least one warning threshold.";const ae=C.constraints||{};if((C.type==="integer"||C.type==="number")&&typeof V=="number"){if(ae.minimum!==void 0&&V<ae.minimum)return`Must be at least ${ae.minimum}${C.unit?` ${C.unit}`:""}`;if(ae.maximum!==void 0&&V>ae.maximum)return`Must be at most ${ae.maximum}${C.unit?` ${C.unit}`:""}`}return null}function we(C){return ue.value[C.path]||null}function Be(C){const V=`${C}.`;return Object.keys(ue.value).some(ae=>ae===C||ae.startsWith(V))}function We(){n.value||M.value.length&&(O.value.push(Bn(N.value)),N.value=M.value.pop(),G.value={},w.value={},se={path:null,at:0})}function Qe(){n.value||O.value.length&&(M.value.push(Bn(N.value)),N.value=O.value.pop(),G.value={},w.value={},se={path:null,at:0})}function Et(){!W.value||oe.value||($.value=!0,re.value=!1)}function pt(){$.value=!1}function At(){dn()}function bs(C){return nC[C]||bi(C||"unknown")}function Nt(C){return`apply-${String(C||"unknown").replaceAll("_","-")}`}function Na(C){return`cfgc-field-${C.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function ci(C){return`${Na(C)}-input`}function mo(C){const V=document.getElementById(Na(C))||document.getElementById(Na(C.split(".").slice(0,2).join(".")));V==null||V.scrollIntoView({behavior:"smooth",block:"center"})}function Ma(C,V){b.value={type:C,message:V},window.setTimeout(()=>{var ae;((ae=b.value)==null?void 0:ae.message)===V&&(b.value=null)},3500)}function ac(){x.value=!1,L.value="pending_restart",E.value="";const C=aC(a.value);C&&(C.scrollTop=0)}function ho(){x.value=!1}function di(C=1800){J&&window.clearTimeout(J),J=window.setTimeout(nc,C)}async function nc(){if(S.value){if(j+=1,j>45){S.value=!1,_.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await ml(),Ke.value===0){S.value=!1,_.value=null,Ma("success","Odin restarted and the saved startup settings are active.");return}}catch{}di(2e3)}}async function Ln(){if(!S.value){_.value=null;try{await z.post("/api/restart",{}),S.value=!0,j=0,x.value=!1,di()}catch(C){_.value=C.message||"Odin could not schedule a restart."}}}async function ic(){if(!(!W.value||oe.value||n.value)){n.value=!0;try{const C=dC(e.value,N.value),V=await z.put("/api/config",C);e.value=V,N.value={},M.value=[],O.value=[],G.value={},$.value=!1;try{t.value=await ml(),g.value=null,x.value=Ke.value>0,Ma("success",Ke.value?`Configuration saved. ${Ke.value} setting${Ke.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(ae){g.value=ae.message||"Unknown metadata error.",Ma("error",`Configuration saved, but apply status could not be refreshed: ${g.value}`)}}catch(C){Ma("error",C.message||"Configuration could not be saved")}finally{n.value=!1}}}async function Da(){if(!n.value){n.value=!0,y.value=null;try{t.value=await ml(),g.value=null}catch(C){y.value=`Image model status could not be refreshed: ${C.message||"Unknown error"}`}finally{n.value=!1}}}async function lc(C,V){if(n.value||!["follow","pin"].includes(V)||!C.length||C.some(Ce=>{var Je,Ct;return!R.includes(Ce)||!((Ct=(Je=t.value)==null?void 0:Je.image_model_defaults)!=null&&Ct[Ce])}))return;n.value=!0,y.value=null;let ae=!1;try{const Ce=await z.post("/api/config/image-models",{operations:Object.fromEntries(C.map(Je=>[Je,V])),expected_revision:t.value.image_model_revision});ae=!0;for(const Je of C){const Ct=`image.openai.${Je}`,Vs=gt(e.value,Ct),qs=gt(Ce.config,Ct),pn=xa=>!Object.hasOwn(xa,"image")||!Ei(gt(xa,Ct),Vs)?xa:da(xa,Ct.split("."),qs);N.value=pn(N.value),M.value=M.value.map(pn),O.value=O.value.map(pn),e.value=da(e.value,Ct.split("."),qs)}t.value={...t.value,image_model_defaults:Ce.image_model_defaults,image_model_revision:Ce.image_model_revision},Ma("success","Image model defaults saved. Unrelated drafts were not saved.")}catch(Ce){y.value=`Image model operation failed: ${Ce.message||"Unknown error"}. Refresh status before retrying if the outcome is uncertain.`}try{t.value=await ml(),g.value=null}catch(Ce){const Je=`Image model status could not be refreshed: ${Ce.message||"Unknown error"}`;g.value=Je,y.value=ae?`Image model defaults were saved, but ${Je}`:`${y.value} ${Je}`}finally{n.value=!1}}async function Xi(){var C,V;if(!(W.value||n.value)){s.value=!0,k.value=null;try{const ae=await z.get("/api/config"),Ce=await ml();await m(),e.value=ae,t.value=Ce,g.value=null;const Je=Ne.value;if(Je.some(Ct=>Ct.key===A.value)||(A.value=((C=Je[0])==null?void 0:C.key)||$i[0].key),ce.value){const Vs=(((V=Je.find(qs=>qs.key===A.value))==null?void 0:V.sections)||[]).find(qs=>P.value[qs]===!0);P.value=Vs?{...P.value,[Vs]:!0}:{}}}catch(ae){k.value=ae.message||"Unknown configuration error"}finally{s.value=!1}}}function Pa(C){if($.value||!(C.ctrlKey||C.metaKey))return;const V=C.target;V instanceof HTMLElement&&(V.matches("input, textarea, select")||V.isContentEditable)||(!C.shiftKey&&C.key.toLowerCase()==="z"?(C.preventDefault(),We()):(C.key.toLowerCase()==="y"||C.shiftKey&&C.key.toLowerCase()==="z")&&(C.preventDefault(),Qe()))}function el(C){ce.value=C.matches}Wt(P,C=>{try{localStorage.setItem(Tg,JSON.stringify(C))}catch{}},{deep:!0});let ui=!1;function tl(){ui||(ui=!0,document.addEventListener("keydown",Pa))}function sl(){ui&&(ui=!1,document.removeEventListener("keydown",Pa))}return tt(()=>{var C;Xi(),tl(),Z=window.matchMedia("(max-width: 760px)"),el(Z),(C=Z.addEventListener)==null||C.call(Z,"change",el)}),rs(tl),Kt(sl),Kt(()=>{o.value=""}),xt(()=>{var C;o.value="",sl(),(C=Z==null?void 0:Z.removeEventListener)==null||C.call(Z,"change",el),J&&window.clearTimeout(J)}),{listenerState:i,listenerConsent:l,listenerCredential:o,listenerSaving:r,listenerMessage:c,listenerError:d,listenerStatusError:u,listenerChoiceChanged:me,listenerStatusTone:de,listenerStatusLabel:fe,listenerAuthorizationCopy:_e,listenerConfiguredSourceCopy:q,listenerRunningCopy:te,saveListenerConsent:h,armKeydown:tl,disarmKeydown:sl,handleKeydown:Pa,config:e,meta:t,loading:s,saving:n,error:k,toast:b,metaRefreshError:g,restartPromptOpen:x,restartScheduled:S,restartError:_,configMain:a,imageModelError:y,imageModelLeaves:R,setImageModelDefaults:lc,refreshImageModelMetadata:Da,searchQuery:E,healthFilter:L,activeCategory:A,reviewOpen:$,mobileOverflowOpen:re,warningThresholdInput:I,arrayInputs:K,healthFilters:ve,visibleCategories:Ne,displayGroups:he,reviewGroups:Fe,sectionCount:ne,fieldCount:ie,hasChanges:W,changeCount:X,changedSectionCount:xe,hasDraftErrors:oe,canUndo:be,canRedo:ge,globalFilterActive:B,reviewRestartCount:Ve,pendingRestartCount:Ke,pendingRestartFields:$e,healthCount:ds,categoryStats:ba,selectCategory:le,selectHealthFilter:Se,clearFilters:qe,sectionLabel:Me,sectionDescription:ee,sectionFieldCount:Ae,sectionHealthCount:_t,sectionApplySummary:He,sectionApplyDetails:rt,sectionEntries:Yt,fieldGroups:oa,sectionSearchHits:En,mcpConfigSummary:lt,fieldRuntimeCopy:js,fieldSpecificRuntimeNote:ra,hasHonestAction:vs,runFieldAction:Ms,hasHostsCollection:Y,hostsConfigSummary:Ee,sectionChanged:rn,fieldChanged:ca,isSectionExpanded:St,toggleSection:cn,discardAllDrafts:dn,setFieldValue:jt,setNumberFieldValue:li,numberInputValue:In,beginInputEdit:ua,endTextInputEdit:as,endInputEdit:un,addWarningThreshold:oi,removeWarningThreshold:ri,isScalarArray:On,addScalarArrayItem:Re,removeScalarArrayItem:D,fieldError:we,sectionHasErrors:Be,undo:We,redo:Qe,openReview:Et,closeReview:pt,mobileCancel:At,applyModeLabel:bs,applyClass:Nt,compactValue:rC,formatValue:cC,structuredApplyCopy:ns,fieldId:Na,fieldInputId:ci,focusField:mo,fetchConfig:Xi,saveConfig:ic,restartOdin:Ln,restartLater:ho,reviewPendingRestart:ac}}},mC=/^\d{15,25}$/;function Ig(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Og={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1},showAddButton:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),a=f(!1),n=f(0),i=f(null),l=H(()=>new Set((e.excludedIds||[]).map(String))),o=H(()=>{const _=s.value.toLowerCase().trim();return(e.members||[]).filter(E=>l.value.has(String(E.id))?!1:_?p(E).toLowerCase().includes(_)||String(E.username||"").toLowerCase().includes(_)||String(E.id).includes(_):!0)}),r=H(()=>{const _=s.value.trim();return o.value.length===0&&mC.test(_)&&!l.value.has(_)?_:""}),c=H(()=>o.value.length+(r.value?1:0)),d=H(()=>!!s.value.trim()&&!!(o.value[n.value]||r.value&&n.value===o.value.length)),u=H(()=>{if(a.value){if(o.value[n.value])return`${e.optionsId}-${n.value}`;if(r.value&&n.value===o.value.length)return`${e.optionsId}-raw`}});function p(_){return Ig(_)}function m(){a.value=!0,n.value=0}function h(){m()}function y(){const _=Math.max(c.value-1,0);n.value=Math.min(n.value+1,_)}function R(){n.value=Math.max(n.value-1,0)}function k(){const _=o.value[n.value];_?b(_):r.value&&n.value===o.value.length&&g(r.value)}function b(_){g(String(_.id))}function g(_){t("select",_),s.value="",a.value=!1,n.value=0}function x(){a.value=!1}function S(){setTimeout(x,150)}return tt(()=>{e.autofocus&&zt(()=>{var _;return(_=i.value)==null?void 0:_.focus()})}),{query:s,open:a,highlightedIndex:n,input:i,filteredMembers:o,rawId:r,activeOptionId:u,selectableValue:d,memberName:p,openOptions:m,onInput:h,highlightNext:y,highlightPrevious:R,selectHighlighted:k,selectMember:b,selectId:g,closeOptions:x,onBlur:S}}};function Ff(e,t,s){var a;return((a=e==null?void 0:e.config)==null?void 0:a[t])!=null?e.config[t]:s==null?void 0:s[t]}const hC={components:{DiscordUserCombobox:Og},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
...
`),l.value=4,ke.info("Imported existing known_hosts trust. Test before activation.")}catch(M){ke.error(M.message)}}async function A(){try{const G=h.value.split(/\s+/).filter(Boolean),M={...R.value,expected_fingerprints:G,candidate_fingerprints:u.value},O=await z.post("/api/hosts/candidates",M);if(d.value=O.candidate_token,u.value=O.fingerprints||[],R.value.trust_mode==="tofu"&&M.candidate_fingerprints.length===0){R.value.confirm_tofu=!1,ke.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(G){ke.error(G.message)}}async function P(){var G,M;p.value=!1,m.value=null;try{const O=await z.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!O.tested,m.value=O.last_test,p.value&&(l.value=5)}catch(O){const $=(G=O.data)==null?void 0:G.last_test;$&&typeof $=="object"&&!Array.isArray($)&&(m.value=$);const re=(M=m.value)==null?void 0:M.detail;ke.error(typeof re=="string"&&re.trim()?re:O.message)}}async function N(){try{await z.post("/api/hosts/candidates/"+d.value+"/commit",{}),ke.success("Host saved and published live"),n.value=!1,await b()}catch(G){ke.error(G.message)}}async function w(G){try{await z.post("/api/hosts/"+encodeURIComponent(G.alias)+"/enabled",{enabled:!G.enabled}),await b()}catch(M){ke.error(M.message)}}async function I(G){var M;if(await os("Delete host "+G.alias+"? Dependencies will block deletion.")){a.value=[];try{await z.del("/api/hosts/"+encodeURIComponent(G.alias)),await b()}catch(O){a.value=Array.isArray((M=O.data)==null?void 0:M.pending_references)?O.data.pending_references:[],ke.error(O.message)}}}async function K(G){if(await os("Force revoke "+G.alias+"? Remote outcomes may be unknown."))try{await z.post("/api/hosts/"+encodeURIComponent(G.alias)+"/force-revoke",{}),await b()}catch(M){ke.error(M.message)}}return tt(b),{hosts:e,loading:t,error:s,pendingReferences:a,wizard:n,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:R,isLocal:k,keyInfo:c,candidate:d,observed:u,tested:p,testResult:m,fingerprintsText:h,load:b,saveSettings:g,beginAdd:S,beginEdit:_,loadKey:E,importLegacy:L,prepare:A,testConnection:P,commit:N,toggle:w,remove:I,forceRevoke:K}}},yC={template:`
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f([]),i=f("missing"),l=f(!1),o=f(!1),r=f(null),c=f(null),d=f(!1);async function u(N){var w;try{await z.del("/api/tokens/unusable/"+N),ke.success("Unusable token entry removed"),await k()}catch(I){ke.error(((w=I.data)==null?void 0:w.error)||I.message||"Failed to remove unusable token")}}const p=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),m=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),h=H(()=>p.value.host_mode==="select"?p.value.allowed_hosts:p.value.host_mode==="none"?[]:a.value),y=H(()=>m.value.host_mode==="select"?m.value.allowed_hosts:m.value.host_mode==="none"?[]:a.value);function R(N){return N==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":N==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function k(){e.value=!0,t.value="";try{const N=await z.get("/api/tokens");s.value=N.tokens||[],a.value=N.available_hosts||[],n.value=N.invalid_entries||[],i.value=N.store_status||"missing"}catch(N){t.value=N.message||"Failed to load tokens"}finally{e.value=!1}}function b(N){return!N||!N.trim()?[]:N.split(",").map(w=>w.trim()).filter(Boolean)}function g(N,w){const I=p.value.allowed_hosts;if(w&&!I.includes(N)&&I.push(N),!w){const K=I.indexOf(N);K>=0&&I.splice(K,1)}}function x(N,w){const I=m.value.allowed_hosts;if(w&&!I.includes(N)&&I.push(N),!w){const K=I.indexOf(N);K>=0&&I.splice(K,1)}}async function S(){var N;o.value=!0;try{const w=b(p.value.allowed_tools_str),I=p.value.host_mode,K=I==="none"?[]:I==="select"?p.value.allowed_hosts:null,G={user_id:p.value.user_id.trim(),username:p.value.username.trim()||"API",tier:p.value.tier,label:p.value.label.trim(),allowed_tools:w.length?w:[]};K!==null&&(G.allowed_hosts=K),G.default_host=p.value.default_host||"";const M=await z.post("/api/tokens",G);r.value=M.token,p.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},l.value=!1,ke.success("Token created"),await k()}catch(w){ke.error(((N=w.data)==null?void 0:N.error)||w.message||"Failed to create token")}finally{o.value=!1}}function _(N){c.value=N;const w=N.allowed_hosts;let I="default";w==null?I="default":Array.isArray(w)&&w.length===0?I="none":Array.isArray(w)&&(I="select"),m.value={username:N.username||"",tier:N.tier||"admin",label:N.label||"",host_mode:I,allowed_hosts:Array.isArray(w)?[...w]:[],default_host:N.default_host||"",allowed_tools_str:(N.allowed_tools||[]).join(", ")}}async function E(){var N;if(c.value){d.value=!0;try{const w=b(m.value.allowed_tools_str),I=m.value.host_mode,K={username:m.value.username,tier:m.value.tier,label:m.value.label,allowed_tools:w};I==="none"?K.allowed_hosts=[]:I==="select"?K.allowed_hosts=m.value.allowed_hosts:K.allowed_hosts=null,K.default_host=m.value.default_host||"",await z.put("/api/tokens/"+encodeURIComponent(c.value.user_id),K),c.value=null,ke.success("Token updated"),await k()}catch(w){ke.error(((N=w.data)==null?void 0:N.error)||w.message||"Failed to update")}finally{d.value=!1}}}async function L(N){var I;if(await os({title:"Regenerate token",message:`Regenerate token for ${N.username||N.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const K=await z.post("/api/tokens/"+encodeURIComponent(N.user_id)+"/regenerate");r.value=K.token,ke.success("Token regenerated")}catch(K){ke.error(((I=K.data)==null?void 0:I.error)||K.message||"Failed to regenerate")}}async function A(N){var I;if(await os({title:"Delete token",message:`Delete token for ${N.username||N.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/tokens/"+encodeURIComponent(N.user_id)),ke.success("Token deleted"),await k()}catch(K){ke.error(((I=K.data)==null?void 0:I.error)||K.message||"Failed to delete")}}async function P(){if(r.value)try{await navigator.clipboard.writeText(r.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return tt(k),{loading:e,error:t,tokens:s,availableHosts:a,invalidEntries:n,storeStatus:i,showCreate:l,creating:o,newToken:r,editing:c,saving:d,createForm:p,editForm:m,removeUnusable:u,createDefaultHostOptions:h,editDefaultHostOptions:y,fetchData:k,tierBadge:R,toggleCreateHost:g,toggleEditHost:x,createToken:S,startEdit:_,saveEdit:E,confirmRegenerate:L,confirmDelete:A,copyToken:P}}},xC={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(null),s=15e3;let a=null,n=!1,i=null,l=null;const o={codexBasic:null,codexAdvanced:null,ollamaBasic:null,ollamaAdvanced:null,compatibleBasic:null,compatibleAdvanced:null,auxiliary:null,mainModel:null,agents:null},r=v=>JSON.stringify(v),c=(v,U)=>{o[v]=r(U)},d=(v,U)=>o[v]!==null&&o[v]!==r(U),u=f(null),p=f(!1),m=f({main:"",main_capability:"medium",agent_capability:"adaptive"}),h=f(""),y=["none","low","medium","high","xhigh","max"],R=["none","low","medium","high","xhigh","max"],k=f({enabled:!1,model:"gpt-6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),b=["gpt-6-astra","gpt-6-sol","gpt-6-luna","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna"],g=H(()=>{const v=u.value||{},U=v.model_catalogue||v.model_catalog||{},Q=Ue=>{var Xt,De,Ft;return((Xt=he.value.model_profiles)==null?void 0:Xt[Ue])||((Ft=(De=he.value.openrouter)==null?void 0:De.catalogue_profiles)==null?void 0:Ft[Ue])||null},Te=(Ue,Xt,De)=>Xt.map(Ft=>{var Yu,Qu;const Ut=typeof Ft=="string"?Ft:Ft.name,Gs=Ue==="compat"?Q(Ut):null;return{ref:Ue==="codex"?Ft:`${Ue}:${Ut}`,name:Ut,provider:Ue,available:!!(De!=null&&De.enabled&&(Ue==="codex"?De.configured:(Yu=De.health)!=null&&Yu.healthy)),unavailable_reason:De!=null&&De.enabled?De!=null&&De.configured?!((Qu=De==null?void 0:De.health)!=null&&Qu.healthy)&&Ue!=="codex"?"unreachable":"":"not configured":"disabled",capability:Ue==="codex"||Gs!=null&&Gs.supports_reasoning?"reasoning":Gs!=null&&Gs.supports_thinking_mode?"thinking":"none",efforts:Gs==null?void 0:Gs.supported_efforts,profile:Gs}}),Pe=[...U.codex||Te("codex",b,v.codex),...U.compat||U.openai_compatible||[],...U.ollama||Te("ollama",ee.value,v.ollama)].map(Ue=>typeof Ue=="string"?{ref:Ue,name:Ue,provider:"codex",available:!0,capability:"reasoning"}:Ue),ct=Ue=>{const Xt=Pe.findIndex(De=>De.ref===Ue.ref);Xt===-1?Pe.push(Ue):Pe[Xt]={...Pe[Xt],...Ue}};for(const Ue of Te("compat",gt.value,v.openai_compatible))ct(Ue);if(ns.value&&Ge.value.length)for(const Ue of Ge.value){const Xt=`compat:${Ue.id}`;ct({ref:Xt,name:Ue.name||Ue.id,provider:"compat",available:!0,unavailable_reason:"",capability:Ue.supports_reasoning?"reasoning":"none",efforts:y.filter(De=>{var Ft;return(Ft=Ue.supported_efforts)==null?void 0:Ft.includes(De)}),agent_available:Ue.agent_eligible&&!!Ue.profile,agent_unavailable_reason:Ue.agent_unavailable_reason||""})}const Ts=new Set(Pe.map(Ue=>Ue.ref));for(const Ue of[m.value.main,Ze.value.model,...Qt.value])Ue&&Ue!=="auto"&&!Ts.has(Ue)&&Pe.unshift({ref:Ue,name:Ue.replace(/^(compat|ollama):/,""),provider:Ue.split(":")[0]||"codex",available:!1,unavailable_reason:"unavailable",capability:Ue.startsWith("ollama:")||Ue.includes(":")?"none":"reasoning"});return Pe.filter(Ue=>!ns.value||Ue.provider!=="compat"||Ue.ref.slice(7).includes("/")).map(Ue=>Ue.efforts?{...Ue,efforts:y.filter(Xt=>Ue.efforts.includes(Xt)&&!j(Ue.ref,Xt))}:Ue)}),x=H(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,U])=>({id:v,label:U,models:g.value.filter(Q=>{if(Q.provider!==v)return!1;const Te=h.value.trim().toLowerCase();return!Te||`${Q.name} ${Q.ref}`.toLowerCase().includes(Te)})})).filter(v=>v.models.length)),S=v=>v.available&&v.agent_available!==!1,_=v=>v.available?`${v.name}${v.agent_available===!1?` (${v.agent_unavailable_reason||"not agent-eligible"})`:""}`:ce(v),E=H(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,U])=>({id:v,label:U,models:g.value.filter(Q=>Q.provider===v&&!(v==="compat"&&ns.value)&&`${Q.ref} ${Q.name}`.toLowerCase().includes(kt.value.trim().toLowerCase()))})).filter(v=>v.models.length)),L=H(()=>g.value.find(v=>v.ref===m.value.main)),A=H(()=>g.value.find(v=>v.ref===Ze.value.model)),P=v=>g.value.find(U=>U.ref===v),N=v=>{const U=P(v);return(U==null?void 0:U.provider)==="codex"?y.filter(Q=>!j(v,Q)):(U==null?void 0:U.efforts)||[]},w=v=>gs.value.find(U=>Ms(U)===v),I=(v,U)=>{const Q=w(v);return typeof Q=="string"?"":(Q==null?void 0:Q[U])||""},K=H(()=>Qt.value.map(v=>P(v)).filter(v=>v&&S(v))),G=H(()=>[...new Set(K.value.map(v=>v.capability!=="reasoning"?v.capability||"none":v.provider==="codex"?"codex_reasoning":"compatible_reasoning"))]),M=H(()=>G.value.length>1),O=H(()=>{var U;if(Ze.value.model!=="auto")return((U=A.value)==null?void 0:U.capability)||"none";if(M.value)return"mixed";const v=G.value[0]||"none";return v.endsWith("_reasoning")?"reasoning":v}),$=H(()=>{var v;return Ze.value.model==="auto"?y:((v=A.value)==null?void 0:v.efforts)||y}),re=H(()=>O.value==="thinking"?Ze.value.thinking_mode??k.value.agent_reasoning_effort??"":k.value.agent_reasoning_effort??""),ce=v=>`${v.name}${v.available?"":` (${v.unavailable_reason||"unavailable"})`}`,Z=H(()=>{const v=k.value.model;return v&&!b.includes(v)?[v,...b]:b}),J=H(()=>{const v=Ze.value.model;return v&&v!=="auto"&&!b.includes(v)?[v,...b]:b}),se={"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},j=(v,U)=>!!v&&!!U&&(se[v]||[]).includes(U),ye=H(()=>{const v=Ze.value.model;return v&&!v.includes(":")?v:null}),Oe=v=>!j(k.value.model,v)&&!(k.value.agent_reasoning_effort===""&&j(ye.value,v)),ne=v=>{const U=Ze.value.model;return U==="auto"?!0:!j(U||k.value.model,v)},ie=H(()=>{const v=k.value.agent_reasoning_effort;return v==="auto"?null:v||k.value.reasoning_effort}),ve=v=>j(v,k.value.reasoning_effort)||Ze.value.model===""&&j(v,ie.value),be=v=>j(v,ie.value),ge=f({enabled:!1,model:"gpt-6-luna"}),Ne=f({unavailable_reason:null}),T=H(()=>{const v=ge.value.model;return v&&!b.includes(v)?[v,...b]:b});function F(v){const U=v.target.value;ge.value.enabled=U!=="",U!==""&&(ge.value.model=U),U.startsWith("compat:")&&ns.value?Pa(Ce(U),Je(U)).then(()=>Mn()).catch(Q=>ze(Q.message||"Failed to prepare OpenRouter model","error")):Mn()}const W=f(!1),me=f({codex:!1,ollama:!1,compatible:!1}),de=f(null),fe=f(!1),_e=f(""),q=f(null),te=f(!1);let X=0;const xe=H(()=>{var v;return Object.entries(((v=de.value)==null?void 0:v.models)||{}).map(([U,Q])=>{var Te,Pe,ct;return{model:U,floor:Q.floor,override:Q.override,effectiveBudget:(Te=Q.effective)==null?void 0:Te.effective_budget,configuredPrimaryChars:(Pe=Q.configured)==null?void 0:Pe.primary_chars,primaryChars:(ct=Q.effective)==null?void 0:ct.primary_chars,provenance:Q.provenance,clampExpiresAt:Q.clamp_expires_at,densityPriorMilli:Q.density_prior_milli,densityScope:Q.density_scope,workloadCalibration:Q.workload_calibration}})}),B=H(()=>{var v;return((v=de.value)==null?void 0:v.clamps)||[]}),ue=H(()=>{var v,U;return((U=(v=de.value)==null?void 0:v.models)==null?void 0:U[k.value.model])||null}),oe=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,num_ctx:32768,timeout:300}),he=f({enabled:!1,base_url:"https://api.deepseek.com/v1",api_key:"",model:"deepseek-v4-flash",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,preset:"deepseek",reasoning_effort:"medium",model_profiles:{},context_utilization:75,openrouter:{order:[],allow_fallbacks:!0,quantizations:[],sort:null,data_collection:null,reasoning_effort:"medium",model_pins:{},catalogue_profiles:{}}}),Fe=f(!1),Ve=f(!1),$e=f(!1),Ke=f(!1),at=f(!1),Xe=f(!1);function Y(){var U,Q,Te;return!!(((U=t.value)==null?void 0:U.contains(document.activeElement))&&((Te=(Q=document.activeElement)==null?void 0:Q.matches)==null?void 0:Te.call(Q,'input, textarea, select, [contenteditable="true"]'))||ra.value||vo.value!==null||te.value||Fe.value||Ve.value||vs.value||$e.value||Ke.value||at.value||W.value||fi.pending()||mi.pending()||Dn.pending()||Mn.pending()||d("codexBasic",Do(k.value))||d("codexAdvanced",Po(k.value))||d("ollamaBasic",$o(oe.value))||d("ollamaAdvanced",$c(oe.value))||d("compatibleBasic",Mo(he.value))||d("compatibleAdvanced",Pc(he.value))||d("auxiliary",ge.value)||d("mainModel",m.value.main)||d("agents",Ze.value))}function Ee(){o.codexBasic=r(Do(k.value)),o.codexAdvanced=r(Po(k.value)),o.ollamaBasic=r($o(oe.value)),o.ollamaAdvanced=r($c(oe.value)),o.compatibleBasic=r(Mo(he.value)),o.compatibleAdvanced=r(Pc(he.value)),o.auxiliary=r(ge.value),o.mainModel=r(m.value.main)}const Ae=f({configured:null}),Me=f(!1),ee=f([]),Le=f(""),He=f(!1),rt=f(!1),Zt=f({configured:null}),lt=f(!1),gt=f([]),Yt=H(()=>ns.value?Ge.value.map(v=>v.id):gt.value),cs=f(""),oa=f(!1),js=f(!1),Ze=f({model:"auto",thinking_mode:null,auto_model_allowlist:[]}),ra=f(!1),vs=f(!1),Ms=v=>typeof v=="string"?v:v==null?void 0:v.model,gs=H(()=>(Ze.value.auto_model_allowlist||[]).map(v=>typeof v=="string"?v:{...v}).filter(v=>Ms(v))),En=H(()=>!k.value.enabled&&he.value.enabled?he.value.model?[`compat:${he.value.model}`]:[]:!k.value.enabled&&!he.value.enabled&&oe.value.enabled?oe.value.model?[`ollama:${oe.value.model}`]:[]:b),Qt=H(()=>gs.value.length?gs.value.map(Ms):En.value),_t=H(()=>{var v;return(v=Ze.value.auto_model_allowlist)!=null&&v.length?`Allowlist: ${Qt.value.length} models`:`Default: ${Qt.value.join(", ")||"no available agent models"}`}),ds=new Map;function ba(){ra.value=!1,V()}const rn=v=>{if(ns.value&&v.startsWith("compat:")&&!v.slice(7).includes("/"))return"OpenRouter requires a namespaced vendor/model ID; this is a direct-endpoint profile.";const U=g.value.find(Q=>Q.ref===v);return U?S(U)?"":U.agent_unavailable_reason||U.unavailable_reason||"Not agent-eligible":"Model is absent from the current endpoint catalogue."},ca=v=>{if(Et.value.has(v))return bs(v);const U=g.value.find(Te=>Te.ref===v),Q=(U==null?void 0:U.hint_metadata)||{};return[Q.hint||Q.hint_derived,Q.as_of&&`as of ${Q.as_of}`,Q.scope_note,Q.evidence&&`Evidence: ${Q.evidence}`,U&&qs(U)].filter(Boolean).join(" · ")||"No catalogue hint. Add an operator hint below."},le=f(null),Se=f(!1),qe=f(""),Ge=H(()=>{var v;return(((v=le.value)==null?void 0:v.models)||[]).map(U=>{var Te,Pe,ct;const Q=((Te=he.value.model_profiles)==null?void 0:Te[U.id])||U.profile||((ct=(Pe=he.value.openrouter)==null?void 0:Pe.catalogue_profiles)==null?void 0:ct[U.id])||(U.context_length>0&&U.max_completion_tokens>0?{total_window_tokens:U.context_length,max_output_tokens:U.max_completion_tokens}:null);return{...U,profile:Q}})}),kt=f(""),St=f(""),cn=f(!0),An=f(!0),dn=f(!0),Rn=f(!1),da=f(null),ya=f(""),jt=f(null),ua=f(""),as=f([]),un=f(!1),In=f("throughput"),li=(v,U,Q=null)=>{const Te=v[U],Pe=Q&&Te&&typeof Te=="object"?Te[Q]:Te,ct=Number(Pe);return Number.isFinite(ct)?ct:null},oi=H(()=>{const v=[...as.value],U=In.value;return v.sort((Q,Te)=>{var Ut,Gs;if(U==="quantization")return String(Q.quantization).localeCompare(String(Te.quantization));const[Pe,ct,Ts]=U==="throughput"?["throughput_last_30m","p50",!0]:U==="latency_p99"?["latency_last_30m","p99",!1]:U==="cache_price"?["cache_read_per_token",null,!1]:["prompt_per_token",null,!1],Ue=(Ut=Q.pricing)==null?void 0:Ut[Pe],Xt=(Gs=Te.pricing)==null?void 0:Gs[Pe],De=ct?li(Q,Pe,ct):Ue==null?null:Number(Ue),Ft=ct?li(Te,Pe,ct):Xt==null?null:Number(Xt);return Number.isFinite(De)?Number.isFinite(Ft)?Ts?Ft-De:De-Ft:-1:1})}),ri=H(()=>{try{return new URL(he.value.base_url).hostname}catch{return""}}),ns=H(()=>/(^|\.)openrouter\.ai$/i.test(ri.value)),On=H(()=>{var v,U;return ns.value?Se.value?"OpenRouter recognized · fetching catalogue…":qe.value?`OpenRouter recognized · catalogue failed: ${qe.value}`:`OpenRouter recognized · ${((U=(v=le.value)==null?void 0:v.models)==null?void 0:U.length)||0} catalogue models loaded`:gt.value.length?`${gt.value.length} endpoint models loaded`:"Catalogue not loaded"}),Re=H(()=>qe.value?"text-red-400":"text-gray-500"),D=H(()=>{var v;return[...new Set((((v=le.value)==null?void 0:v.models)||[]).map(U=>U.vendor))].sort()}),pe=H(()=>{var v;return[...new Set((((v=le.value)==null?void 0:v.models)||[]).flatMap(U=>(U.endpoints||[]).map(Q=>Q.quantization)).filter(Boolean))].sort()}),we=v=>{var U;return(((U=le.value)==null?void 0:U.measured_cache)||[]).some(Q=>Q.model===v.id&&Q.samples>0&&Q.cached_percent>0)},Be=H(()=>{const v=kt.value.trim().toLowerCase();return Ge.value.filter(U=>{var Q;return!(v&&!`${U.id} ${U.name} ${U.vendor}`.toLowerCase().includes(v)||St.value&&U.vendor!==St.value||cn.value&&!U.supports_tools||An.value&&!U.agent_eligible||dn.value&&U.variant!=="standard"||Rn.value&&!we(U)||da.value!=null&&Number((Q=U.pricing)==null?void 0:Q.prompt_per_token)*1e6>Number(da.value)||ya.value&&!(U.endpoints||[]).some(Te=>Te.quantization===ya.value))})}),We=H(()=>Be.value.slice(0,100)),Qe=H(()=>Be.value.length),Et=H(()=>new Map(Ge.value.map(v=>[`compat:${v.id}`,v]))),pt=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(3)}/M`,At=v=>{var U,Q,Te,Pe;return[v.vendor,v.context_length?`${Number(v.context_length).toLocaleString()} ctx`:"context unknown",`${pt((U=v.pricing)==null?void 0:U.prompt_per_token)} in`,`${pt((Q=v.pricing)==null?void 0:Q.completion_per_token)} out`,`${pt((Te=v.pricing)==null?void 0:Te.cache_read_per_token)} cache read`,`${pt((Pe=v.pricing)==null?void 0:Pe.cache_write_per_token)} cache write`,v.supports_tools?"tools":"no tools",v.supports_reasoning?"reasoning":"no reasoning",v.variant!=="standard"?v.variant:null].filter(Boolean).join(" · ")},bs=v=>{var Pe;const U=Et.value.get(v);if(!U)return"Catalogue facts unavailable";const Q=(((Pe=le.value)==null?void 0:Pe.measured_cache)||[]).filter(ct=>ct.model===U.id),Te=Q.length?Q.map(ct=>`${ct.upstream_provider}: ${ct.cached_percent}% cached`).join(" · "):"No measured cache evidence yet";return`${At(U)} · ${Te}${U.profile_conflict?" · operator profile conflicts with catalogue":""}`},Nt=H(()=>gt.value.map(v=>typeof v=="string"?v:v.name).filter(Boolean)),Na=async()=>{var U,Q,Te;const v=(Te=(Q=(U=u.value)==null?void 0:U.openai_compatible)==null?void 0:Q.preset_catalogue)==null?void 0:Te[he.value.preset];v&&(he.value.base_url=v.base_url),Dn.cancel(),await ol()},ci=(v,U)=>{he.value.openrouter[v]=U.split(",").map(Q=>Q.trim()).filter(Boolean)},mo=H(()=>ee.value||[]),Ma=H(()=>{const v=[...b,...Nt.value.map(U=>`compat:${U}`),...mo.value.map(U=>`ollama:${U.name}`)];for(const U of[Ze.value.model,...Qt.value])U&&U!=="auto"&&!v.includes(U)&&v.unshift(U);return v}),ac=v=>v==="codex-auto-review"?"codex-auto-review (Codex alias → gpt-5.6-luna)":v;async function ho({poll:v=!1}={}){try{const U=await z.get("/api/agents/model");if(v&&Y())return;Ze.value={...Ze.value,...U},o.agents=r(Ze.value)}catch{}}async function di(){if(!ns.value){le.value=null,qe.value="";return}Se.value=!0;try{le.value=await z.get("/api/openrouter/catalogue"),qe.value=""}catch(v){qe.value=v.message||"Failed to load OpenRouter catalogue"}finally{Se.value=!1}}async function nc(){var v;try{(v=Ze.value.model)!=null&&v.startsWith("compat:")&&ns.value&&await Pa(Ce(Ze.value.model),Je(Ze.value.model));const U=await z.put("/api/agents/model",{model:Ze.value.model||null});Ze.value={...Ze.value,...U},o.agents=r(Ze.value),ze("Agent model policy saved")}catch(U){ze(U.message||"Failed to save agent model policy","error")}}const Ln=()=>[...gs.value.length?gs.value:Qt.value];async function ic(v,U){const Q=Ln(),Te=Q.findIndex(Ts=>Ms(Ts)===v);let Pe=null;if(U.target.checked&&Te<0&&Q.push(ds.get(v)||v),!U.target.checked&&Te>=0&&([Pe]=Q.splice(Te,1)),!Q.length){U.target.checked=!0,ze("Keep one model selected. An empty list restores the provider default.","error");return}const ct=await Da(Q,"Agent Auto allowlist saved");ct&&U.target.checked&&ds.delete(v),ct&&!U.target.checked&&typeof Pe=="object"&&ds.set(v,Pe),ct||(U.target.checked=Qt.value.includes(v))}async function Da(v,U){if(vs.value)return!1;vs.value=!0;try{const Q=await z.put("/api/agents/model",{auto_model_allowlist:v});return Ze.value={...Ze.value,...Q},o.agents=r(Ze.value),ze(U),!0}catch(Q){return ze(Q.message||"Failed to save agent allowlist","error"),!1}finally{vs.value=!1}}const lc=()=>Da([],"Provider default restored");async function Xi(v,U,Q){const Te=Qt.value.map(Pe=>{const ct=w(Pe);if(Pe!==v)return ct||Pe;const Ts=typeof ct=="string"?{model:Pe}:{...ct||{model:Pe}};return delete Ts.reasoning_effort,delete Ts.thinking_mode,Q&&(Ts[U]=Q),Object.keys(Ts).length===1?Ts.model:Ts});await Da(Te,"Model default saved")}async function Pa(v,U=""){const[Q,...Te]=v.split("/");if(!Q||!Te.length)throw new Error("OpenRouter model id is not namespaced");return z.post(`/api/openrouter/models/${encodeURIComponent(Q)}/${encodeURIComponent(Te.join("/"))}/select`,{provider_tag:U})}const el=(v,U)=>{var Te;const Q=(((Te=le.value)==null?void 0:Te.measured_cache)||[]).find(Pe=>Pe.model===v&&Pe.upstream_provider===U);return Q?`${Q.cached_percent}% cached over ${Q.samples} calls`:"no measured cache evidence"},ui=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(4)}/M`,tl=(v,U)=>{if(v==null)return"n/a";if(typeof v=="number")return Number(v).toLocaleString();const Q=v[U];return Q==null?"n/a":Number(Q).toLocaleString()},sl=v=>{var Pe;const U=[];v.quantization==="fp4"&&U.push("fp4 quantization may change quality");const Q=typeof v.latency_last_30m=="object"?Number((Pe=v.latency_last_30m)==null?void 0:Pe.p99):null,Te=Number(Ze.value.iteration_timeout_seconds||0)*1e3;return Q&&Te&&Q>Te&&U.push("p99 exceeds the agent iteration budget"),U.join("; ")};async function C(v){var U;jt.value=v,ua.value=((U=he.value.openrouter.model_pins)==null?void 0:U[v.id])||"",un.value=!0;try{const[Q,...Te]=v.id.split("/"),Pe=await z.get(`/api/openrouter/models/${encodeURIComponent(Q)}/${encodeURIComponent(Te.join("/"))}/endpoints`);as.value=Pe.endpoints||[]}catch(Q){as.value=[],ze(Q.message||"Failed to load OpenRouter provider routes","error")}finally{un.value=!1}}function V(){jt.value=null,ua.value="",as.value=[]}async function ae(v,U=""){try{await Pa(v.id,U);const Q=Ln(),Te=`compat:${v.id}`;if(Q.some(ct=>Ms(ct)===Te)||Q.push(Te),!await Da(Q,U?"OpenRouter model added and provider pinned.":"OpenRouter model added unpinned."))return;V(),await _a()}catch(Q){ze(Q.message||"Failed to add OpenRouter model","error")}}const Ce=v=>v.startsWith("compat:")?v.slice(7):v,Je=v=>{var U;return((U=he.value.openrouter.model_pins)==null?void 0:U[Ce(v)])||""},Ct=v=>Qt.value.length>1&&Da(Ln().filter(U=>Ms(U)!==v),"Model removed from allowlist");async function Vs(){var v,U;try{const Q=Ln();for(const Te of((v=le.value)==null?void 0:v.quick_add)||[])(U=Et.value.get(Te))!=null&&U.agent_eligible&&(await Pa(Ce(Te),""),Q.some(Pe=>Ms(Pe)===Te)||Q.push(Te));await Da(Q,"Curated OpenRouter models added"),await _a()}catch(Q){ze(Q.message||"Failed to add curated OpenRouter models","error")}}function qs(v){const U=v.hint_metadata||{},Q=[];return U.context_tokens&&Q.push(`context ${Number(U.context_tokens).toLocaleString()}`),U.max_output_tokens&&Q.push(`max output ${Number(U.max_output_tokens).toLocaleString()}`),U.structural_source&&Q.push(`source ${U.structural_source}`),Q.join("; ")}async function pn(v,U){const Q={...Ze.value.model_selection_hints||{}},Te=U.trim();Te?Q[v]=Te:delete Q[v];try{const Pe=await z.put("/api/agents/model",{model_selection_hints:Q});Ze.value={...Ze.value,...Pe},o.agents=r(Ze.value),ze("Model hint saved")}catch(Pe){ze(Pe.message||"Failed to save model hint","error")}}function xa(v,U){const Q=Qt.value.indexOf(v);return!vs.value&&Q>=0&&Q+U>=0&&Q+U<Qt.value.length}async function Kg(v,U){const Q=Ln(),Te=Q.findIndex(Pe=>Ms(Pe)===v);Te<0||!xa(v,U)||([Q[Te],Q[Te+U]]=[Q[Te+U],Q[Te]],await Da(Q,"Agent Auto allowlist order saved"))}const oc=f(!0),rc=f(""),ju=f({configured:null,accounts:[]}),cc=f(null),vo=f(null),dc=f(""),al=f(null),uc=f(!1),pc=f(null),Vu=f(null),qu=f("");let pi=null;function ze(v,U="success"){ke(v,U==="error"?"error":"success")}function Jg(v){if(!v)return"?";const U=v/(1024*1024*1024);return U>=1?U.toFixed(1)+" GB":(v/(1024*1024)).toFixed(0)+" MB"}function Zg(v){return Number.isFinite(Number(v))?Number(v).toLocaleString():"—"}function Yg(v){return v==null?"automatic (model-derived)":Number(v).toLocaleString()+" characters"}function Qg(v){const U=new Date(v);return Number.isNaN(U.getTime())?"unknown":U.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function Xg(v){return typeof v=="string"&&v.length>12?v.slice(0,8)+"…"+v.slice(-4):v}function eb(v){return typeof v!="number"||!Number.isFinite(v)?"—":(v/1e3).toFixed(2)}function tb(v){return v==="temporary learned clamp"?"is-clamp":v==="override"?"is-override":"is-built-in"}function sb(v){const U=k.value.context_budget_overrides[v.model];return v.floor!=null&&Number.isFinite(Number(U))&&Number(U)>v.floor}function ab(v,U){const Q={...k.value.context_budget_overrides};U.target.value===""?delete Q[v]:Q[v]=Number(U.target.value),k.value.context_budget_overrides=Q,te.value=!0}function nb(v){k.value.context_utilization=v.target.value===""?"":Number(v.target.value),te.value=!0}function ib(v){const U={...k.value.context_budget_overrides};delete U[v],k.value.context_budget_overrides=U,te.value=!0}async function _a({quiet:v=!1,poll:U=!1}={}){if(!(U&&Y())){if(l&&await l,i)return i;v||(e.value=!0),i=(async()=>{await Promise.all([Ds({poll:U}),nl(),il(),ho({poll:U}),pa(),Nn({poll:U})]),await di(),Y()||Ee()})();try{await i}finally{i=null,v||(e.value=!1)}}}async function lb(){if(!(Y()||i)){if(l)return l;l=Promise.all([Ds({poll:!0}),nl({refreshModels:!1}),il({refreshModels:!1}),ho({poll:!0}),pa(),Nn({poll:!0})]).then(()=>{Y()||Ee()});try{await l}finally{l=null}}}async function Ds({preserveBasic:v=!1,preserveAdvanced:U=!1,poll:Q=!1}={}){var Te,Pe,ct,Ts,Ue,Xt;try{const De=await z.get("/api/llm/status"),Ft=Q&&Y();u.value=De,p.value=!1,Ft||(m.value.main=De.main_model||De.active_model||(De.active_provider==="compat"?`compat:${((Te=De.openai_compatible)==null?void 0:Te.model)||""}`:De.active_provider==="ollama"?`ollama:${((Pe=De.ollama)==null?void 0:Pe.model)||""}`:((ct=De.codex)==null?void 0:ct.model)||"gpt-6-sol")),!Ft&&De.codex&&!fi.pending()&&(v||(k.value.enabled=De.codex.enabled,k.value.model=De.codex.model||"gpt-6-sol",k.value.reasoning_effort=De.codex.reasoning_effort||"medium",k.value.agent_reasoning_effort=De.codex.agent_reasoning_effort||""),U||(k.value.request_timeout_seconds=De.codex.request_timeout_seconds??k.value.request_timeout_seconds,k.value.stream_stall_timeout_seconds=De.codex.stream_stall_timeout_seconds??k.value.stream_stall_timeout_seconds,k.value.retry={...k.value.retry,...De.codex.retry||{}},k.value.connection_pool={...k.value.connection_pool,...De.codex.connection_pool||{}},k.value.context_compression={...k.value.context_compression,...De.codex.context_compression||{}},!te.value&&!$e.value&&(k.value.context_budget_overrides={...De.codex.context_budget_overrides||{}},k.value.context_utilization=De.codex.context_utilization??k.value.context_utilization))),!Ft&&De.ollama&&!mi.pending()&&(v||(oe.value.enabled=De.ollama.enabled,oe.value.base_url=De.ollama.base_url||"",oe.value.model=De.ollama.model||"",oe.value.max_tokens=De.ollama.max_tokens||4096,oe.value.num_ctx=De.ollama.num_ctx||32768),U||(oe.value.timeout=De.ollama.timeout??oe.value.timeout));const Ut=De.openai_compatible;!Ft&&Ut&&!Dn.pending()&&(v||(he.value.enabled=Ut.enabled,he.value.base_url=Ut.base_url||he.value.base_url,he.value.model=Ut.model||he.value.model,he.value.preset=Ut.preset||he.value.preset,he.value.reasoning_effort=Ut.reasoning_effort||"medium"),U||(he.value.request_timeout_seconds=Ut.request_timeout_seconds??he.value.request_timeout_seconds,he.value.stream_stall_timeout_seconds=Ut.stream_stall_timeout_seconds??he.value.stream_stall_timeout_seconds,he.value.model_profiles=Ut.model_profiles||he.value.model_profiles,he.value.context_utilization=Ut.context_utilization??he.value.context_utilization,he.value.openrouter={...he.value.openrouter,...Ut.openrouter||{}})),Ft||((Ts=m.value.main)!=null&&Ts.startsWith("compat:")?m.value.main_capability=(Ut==null?void 0:Ut.reasoning_effort)||"medium":(Ue=m.value.main)!=null&&Ue.startsWith("ollama:")||(m.value.main_capability=((Xt=De.codex)==null?void 0:Xt.reasoning_effort)||"medium")),!Ft&&De.auxiliary&&(Ne.value=De.auxiliary,Mn.pending()||(ge.value.enabled=De.auxiliary.enabled,ge.value.model=De.auxiliary.model||"gpt-6-luna"))}catch{u.value||(u.value={active_provider:"",codex:{configured:null},ollama:{configured:null},openai_compatible:{configured:null}}),p.value=!0}}async function Nn({poll:v=!1}={}){const U=++X;fe.value=!0,_e.value="";try{const Q=await z.get("/api/context/windows");if(U!==X)return;de.value=Q,!(v&&Y())&&!$e.value&&!te.value&&(k.value.context_budget_overrides=Object.fromEntries(Object.entries(Q.models||{}).filter(([,Te])=>Te.override!=null).map(([Te,Pe])=>[Te,Pe.override])),k.value.context_utilization=Q.utilization??k.value.context_utilization)}catch(Q){U===X&&(_e.value=Q.message||"Failed to load context budgets")}finally{U===X&&(fe.value=!1)}}async function nl({refreshModels:v=!0}={}){try{if(Ae.value=await z.get("/api/ollama/status"),Me.value=!1,Ae.value.model&&(Le.value=Ae.value.model),v&&Ae.value.configured)try{const U=await z.get("/api/ollama/models");ee.value=U.models||[]}catch{ee.value=[]}else if(v&&oe.value.base_url)try{const U=await z.post("/api/ollama/probe-models",{base_url:oe.value.base_url});ee.value=U.models||[]}catch{ee.value=[]}}catch{Me.value=!0}}async function pa(){oc.value=!0,rc.value="";try{ju.value=await z.get("/api/codex/status")}catch(v){rc.value=v.message||"Failed to fetch Codex status"}finally{oc.value=!1}}async function ob(){try{m.value.main.startsWith("compat:")&&ns.value&&await Pa(Ce(m.value.main),Je(m.value.main));try{await z.put("/api/llm/main-model",{model:m.value.main})}catch(v){if(!/404|not found/i.test(v.message||""))throw v;await z.post("/api/llm/switch",{model:m.value.main})}c("mainModel",m.value.main),ze("Main model saved"),await _a()}catch(v){ze(v.message||"Failed to save main model","error"),await Ds()}}async function rb(v){m.value.main_capability=v;const U=L.value;U&&(U.provider==="compat"&&U.capability!=="none"?(he.value.reasoning_effort=v,await ol()):U.capability==="reasoning"?(k.value.reasoning_effort=v,await ll()):U.capability==="thinking"&&(await z.put("/api/openai-compatible/config",{thinking_mode:v}),ze("Thinking mode saved")))}async function cb(v){m.value.agent_capability=v;const U=A.value,Q=(U==null?void 0:U.capability)||O.value;if(Q!=="none"){if(v===""||v==="auto"||Q==="reasoning"||Q==="mixed"){if(k.value.agent_reasoning_effort=v,Q==="thinking"){const Te=await z.put("/api/agents/model",{thinking_mode:null});Ze.value={...Ze.value,...Te}}await ll()}else if(Q==="thinking"){const Te=await z.put("/api/agents/model",{thinking_mode:v});Ze.value={...Ze.value,...Te},ze("Agent thinking mode saved")}}}async function db(){He.value=!0;try{const v=await z.post("/api/ollama/reload");ze(v.configured?"Ollama reloaded":v.reason||"Ollama not configured",v.configured?"success":"error"),await _a()}catch(v){ze(v.message||"Reload failed","error")}finally{He.value=!1}}async function ub(){rt.value=!0;try{await z.post("/api/ollama/model",{model:Le.value}),ze("Model set to "+Le.value),await _a()}catch(v){ze(v.message||"Failed","error")}finally{rt.value=!1}}async function pb(){const v=oe.value.base_url;if(!v){ze("Enter a base URL first","error");return}Xe.value=!0;try{const U=await z.post("/api/ollama/probe-models",{base_url:v});ee.value=U.models||[],ee.value.length?(ze(ee.value.length+" model(s) found"),!oe.value.model&&ee.value.length&&(oe.value.model=ee.value[0].name)):ze("No models found at "+v,"error")}catch(U){ze(U.message||"Could not reach Ollama","error")}finally{Xe.value=!1}}async function il({refreshModels:v=!0}={}){try{if(Zt.value=await z.get("/api/openai-compatible/status"),lt.value=!1,Zt.value.model&&(cs.value=Zt.value.model),v&&Zt.value.configured)try{const U=await z.get("/api/openai-compatible/models");gt.value=U.models||[]}catch{gt.value=[]}}catch{lt.value=!0}}async function fb(){oa.value=!0;try{const v=await z.post("/api/openai-compatible/reload");ze(v.configured?"OpenAI-compatible reloaded":v.reason||"OpenAI-compatible not configured",v.configured?"success":"error"),await _a()}catch(v){ze(v.message||"Reload failed","error")}finally{oa.value=!1}}async function mb(){js.value=!0;try{await z.post("/api/openai-compatible/model",{model:cs.value}),ze("Model set to "+cs.value),await _a()}catch(v){ze(v.message||"Failed","error")}finally{js.value=!1}}async function ll(){if($e.value){fi();return}$e.value=!0;const v=Do(k.value);try{await z.put("/api/llm/codex/config",v),c("codexBasic",v),ze("Codex config saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),pa()])}catch(U){ze(U.message||"Failed","error");const Q=JSON.stringify(Do(k.value))!==JSON.stringify(v);await Promise.all([Ds({preserveBasic:Q,preserveAdvanced:!0}),pa()])}finally{$e.value=!1}}async function Gu(){if($e.value)return;$e.value=!0;const v=Po(k.value);try{await z.put("/api/llm/codex/config",v),c("codexAdvanced",v),JSON.stringify({context_budget_overrides:k.value.context_budget_overrides,context_utilization:k.value.context_utilization})===JSON.stringify({context_budget_overrides:v.context_budget_overrides,context_utilization:v.context_utilization})&&(te.value=!1),ze("Codex advanced settings saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),pa(),Nn()])}catch(U){ze(U.message||"Failed","error");const Q=JSON.stringify(Po(k.value))!==JSON.stringify(v);await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:Q}),pa(),Nn()])}finally{$e.value=!1}}async function fc(){if(Ke.value){mi();return}Ke.value=!0;try{const v=Fe.value?oe.value.api_key:null,U=$o(oe.value,{includeApiKey:v!==null});await z.put("/api/llm/ollama/config",U),ze("Ollama config saved"),v!==null&&oe.value.api_key===v&&(oe.value.api_key="",Fe.value=!1),c("ollamaBasic",$o(oe.value)),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){ze(v.message||"Failed","error")}finally{Ke.value=!1}}async function Wu(){if(!Ke.value){Ke.value=!0;try{const v=$c(oe.value);await z.put("/api/llm/ollama/config",v),c("ollamaAdvanced",v),ze("Ollama timeout saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){ze(v.message||"Failed","error")}finally{Ke.value=!1}}}async function ol(){if(at.value){Dn();return}at.value=!0;try{const v=Ve.value?he.value.api_key:null,U=Mo(he.value,{includeApiKey:v!==null});await z.put("/api/openai-compatible/config",U),ze("OpenAI-compatible config saved"),v!==null&&he.value.api_key===v&&(he.value.api_key="",Ve.value=!1),c("compatibleBasic",Mo(he.value)),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){ze(v.message||"Failed","error")}finally{at.value=!1}}async function Ku(){if(!at.value){at.value=!0;try{const v=Pc(he.value);await z.put("/api/openai-compatible/config",v),c("compatibleAdvanced",v),ze("OpenAI-compatible endpoint settings saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){ze(v.message||"Failed","error")}finally{at.value=!1}}}async function hb(){if(W.value){Mn();return}W.value=!0;try{const v={...ge.value};await z.put("/api/llm/auxiliary/config",v),c("auxiliary",v),ze("Auxiliary config saved"),await Ds()}catch(v){ze(v.message||"Failed","error"),await Ds()}finally{W.value=!1}}const fi=Fo(ll),Mn=Fo(hb),mi=Fo(fc),Dn=Fo(ol),vb=()=>(fi.cancel(),ll()),gb=()=>(mi.cancel(),fc()),bb=()=>(Dn.cancel(),ol()),yb=()=>Gu(),xb=()=>Wu(),_b=()=>Ku();async function wb(v){const U=v.account_key+":"+v.model;q.value=U;try{const Q=await z.post("/api/context/windows/clear",{account_key:v.account_key,model:v.model});ze(Q.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Nn()}catch(Q){ze(Q.message||"Failed to clear clamp","error"),await Nn()}finally{q.value=null}}async function kb(v){try{await z.post("/api/codex/account/"+v+"/activate"),ze("Active account switched"),await pa()}catch(U){ze(U.message||"Failed","error")}}async function Sb(v){cc.value=v;try{await z.post("/api/codex/account/"+v+"/refresh"),ze("Token refreshed"),await pa()}catch(U){ze(U.message||"Refresh failed","error")}finally{cc.value=null}}function Cb(v,U){vo.value=v,dc.value=U||""}async function Tb(v){try{await z.put("/api/codex/account/"+v+"/label",{label:dc.value}),ze("Label updated"),vo.value=null,await pa()}catch(U){ze(U.message||"Failed","error")}}async function Eb(v,U){if(await os({title:"Delete Codex account",message:`Delete ${U||"account #"+(v+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await z.del("/api/codex/account/"+v),ze("Deleted. Pool reloaded."),await pa()}catch(Te){ze(Te.message||"Failed","error")}}async function Ab(){uc.value=!0;try{const v=await z.post("/api/codex/device-code");pc.value=v,al.value="pending",Rb(v)}catch(v){ze(v.message||"Failed","error")}finally{uc.value=!1}}async function Rb(v){pi={cancelled:!1};const U=pi;try{const Q=await z.post("/api/codex/device-poll",{device_auth_id:v.device_auth_id,user_code:v.user_code,interval:v.interval});if(U.cancelled)return;Vu.value=Q,al.value="success",await _a()}catch(Q){if(U.cancelled)return;qu.value=Q.message||"Device login failed",al.value="error"}}function Ib(){pi&&(pi.cancelled=!0),al.value=null,pc.value=null}function Ju(){n||(n=!0,_a(),a=window.setInterval(lb,s))}function Zu(){n&&(n=!1,a!==null&&window.clearInterval(a),a=null)}return tt(Ju),rs(Ju),Kt(Zu),xt(()=>{Zu(),pi&&(pi.cancelled=!0),fi.cancel(),Mn.cancel(),mi.cancel(),Dn.cancel()}),{pageRoot:t,allowlistModalOpen:ra,closeAllowlistModal:ba,allowlistSaving:vs,effectiveAllowlist:Qt,allowlistSummary:_t,resetAgentAllowlist:lc,selectedUnavailableReason:rn,selectedModelFacts:ca,loading:e,llmStatus:u,llmStatusLoadFailed:p,modelSelection:m,modelSelectorSearch:h,reasoningEfforts:y,neutralReasoningLevels:R,modelCatalog:g,modelGroups:x,selectedMainModel:L,selectedAgentModel:A,selectedAgentCapabilityValue:re,agentCapabilityKind:O,agentCapabilityEfforts:$,autoAllowlistModels:K,allowlistModel:P,allowlistModelEfforts:N,allowlistEntryCapabilityValue:I,modelOptionLabel:ce,agentModelAvailable:S,agentModelOptionLabel:_,advancedOpen:me,codexForm:k,codexModelOptions:Z,codexAgentModelOptions:J,mainEffortAllowed:Oe,agentEffortAllowed:ne,mainModelOptionDisabled:ve,agentModelOptionDisabled:be,auxForm:ge,auxData:Ne,auxModelOptions:T,onAuxModelChange:F,savingAux:W,saveAuxConfigDebounced:Mn,ollamaForm:oe,compatibleForm:he,savingCodex:$e,savingOllama:Ke,savingCompatible:at,probingOllama:Xe,ollamaKeyDirty:Fe,compatibleKeyDirty:Ve,fetchCodexStatus:pa,ollamaStatus:Ae,ollamaStatusLoadFailed:Me,ollamaModels:ee,ollamaSelectedModel:Le,reloading:He,settingModel:rt,compatibleStatus:Zt,compatibleStatusLoadFailed:lt,compatibleModels:gt,visibleCompatibleModels:Yt,compatibleSelectedModel:cs,reloadingCompatible:oa,settingCompatibleModel:js,applyCompatiblePreset:Na,setOpenRouterList:ci,agentsConfig:Ze,compatibleAgentModels:Nt,ollamaAgentModels:mo,knownAgentModelRefs:Ma,agentModelLabel:ac,saveAgentsModel:nc,toggleAgentAutoAllowlist:ic,saveAllowlistEntryCapability:Xi,autoAllowlistGroups:E,structuralFacts:qs,saveModelHint:pn,canMoveAllowlist:xa,moveAgentAutoAllowlist:Kg,openRouterCatalogue:le,openRouterCatalogueLoading:Se,openRouterCatalogueError:qe,openRouterRecognized:ns,compatibleCatalogueStatus:On,compatibleCatalogueStatusClass:Re,openRouterSearch:kt,openRouterVendor:St,openRouterVendors:D,openRouterToolsOnly:cn,openRouterEligibleOnly:An,openRouterStandardOnly:dn,openRouterMeasuredCacheOnly:Rn,openRouterMaxPromptPrice:da,openRouterQuantization:ya,openRouterQuantizations:pe,openRouterResults:We,openRouterMatchCount:Qe,openRouterInlineFacts:At,openRouterSelectedFacts:bs,prepareOpenRouterModel:C,addOpenRouterModel:ae,removeOpenRouterModel:Ct,quickAddOpenRouter:Vs,openRouterModelMap:Et,openRouterPin:Je,openRouterPendingModel:jt,openRouterPendingTag:ua,openRouterPendingEndpoints:as,openRouterPendingLoading:un,openRouterEndpointSort:In,openRouterSortedPendingEndpoints:oi,openRouterEndpointCacheFact:el,openRouterRate:ui,openRouterMetric:tl,openRouterRouteWarning:sl,cancelOpenRouterPending:V,codexLoading:oc,codexError:rc,codexData:ju,refreshing:cc,editingLabel:vo,labelValue:dc,contextWindows:de,contextWindowsLoading:fe,contextWindowsError:_e,contextBudgetRows:xe,activeClampRows:B,activeContextBudget:ue,clearingClamp:q,contextPolicyDirty:te,deviceState:al,deviceLoading:uc,deviceInfo:pc,deviceResult:Vu,deviceError:qu,fetchAll:_a,fetchLLMStatus:Ds,fetchOllamaStatus:nl,fetchCompatibleStatus:il,saveMainModel:ob,saveMainCapability:rb,saveAgentCapability:cb,reloadOllama:db,setOllamaModel:ub,reloadCompatible:fb,setCompatibleModel:mb,probeOllamaModels:pb,saveCodexConfig:ll,saveOllamaConfig:fc,saveCompatibleConfig:ol,saveCodexAdvancedConfig:Gu,saveOllamaAdvancedConfig:Wu,saveCompatibleAdvancedConfig:Ku,saveCodexConfigDebounced:fi,saveOllamaConfigDebounced:mi,saveCompatibleConfigDebounced:Dn,saveCodexConfigNow:vb,saveOllamaConfigNow:gb,saveCompatibleConfigNow:bb,saveCodexAdvancedConfigNow:yb,saveOllamaAdvancedConfigNow:xb,saveCompatibleAdvancedConfigNow:_b,activateAccount:kb,refreshAccount:Sb,startEditLabel:Cb,saveLabel:Tb,deleteAccount:Eb,startDeviceLogin:Ab,cancelDeviceLogin:Ib,formatSize:Jg,fetchContextWindows:Nn,clearContextClamp:wb,setContextOverride:ab,setContextUtilization:nb,resetContextOverride:ib,overrideAboveFloor:sb,formatCount:Zg,formatContextCeiling:Yg,formatExpiry:Qg,shortAccountKey:Xg,provenanceClass:tb,formatDensity:eb}}},Uf={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function TC(e){return Uf[e]||Uf[(e||"").toLowerCase()]||"text-gray-400"}const EC={template:`
  ...
  `,setup(){const e=f(!0),t=f({}),s=f([]),a=f({}),n=f({}),i=f(null),l=f(null),o=f(null),r=f(null),c=f(null),d=H(()=>{var _;return Object.values(((_=i.value)==null?void 0:_.totals)||{}).reduce((E,L)=>E+Number(L||0),0)}),u=f(""),p=f(0),m=f([]),h=H(()=>m.value.map(_=>`${_.label} (${_.path}${_.reason?`: ${_.reason}`:""})`).join("; ")),y=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let R=null;async function k(){var P;const _=await Promise.allSettled(y.map(N=>z.get(N.path))),E=N=>_[N].status==="fulfilled"?_[N].value:null;t.value=E(0)||{};const L=E(1);s.value=Array.isArray(L)?L:L&&L.subsystems||[],a.value=E(2)||{},n.value=E(3)||{},i.value=E(4),l.value=E(5),o.value=E(6),r.value=E(7),c.value=E(8);const A=_.filter(N=>N.status==="rejected");if(m.value=_.flatMap((N,w)=>{var I;return N.status==="rejected"?[{...y[w],reason:((I=N.reason)==null?void 0:I.message)||"request failed"}]:[]}),p.value=m.value.length,A.length===_.length){const N=(P=A[0])==null?void 0:P.reason;u.value=(N==null?void 0:N.message)||"Failed to load internals"}else u.value="";e.value=!1}function b(){e.value=!0,u.value="",k()}let g=!1;function x(){g||(g=!0,k(),R||(R=setInterval(k,3e4)))}function S(){g&&(g=!1,R&&(clearInterval(R),R=null))}return tt(x),rs(x),Kt(S),xt(S),{loading:e,error:u,failedCount:p,failedEndpoints:m,failedEndpointSummary:h,endpoints:y,retry:b,startup:t,subsystems:s,sshPool:a,httpPool:n,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:o,freshnessStats:r,governorStats:c,statusColor:TC,formatAgeSeconds:KS}}},AC=1e4,Bf=3e4;function hl(e,t){return Math.max(0,e-t)}function Fc(e,t){return new Set((e.operations||[]).map(a=>a.state)).has("MANUAL_RESOLUTION_REQUIRED")?0:e.expired_lease||e.status==="ACTIVE"&&(!e.lease_expires_at||e.lease_expires_at<t)?1:e.status==="SUSPENDED"?2:e.status==="ACTIVE"?3:4}const RC=[{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],IC={template:`
    <div class="p-6 page-fade-in">
...
`):a.value[M.key]])),r.value=!1}async function P(M,O){const[$,re]=await Promise.all([z.get("/api/config"),z.get("/api/config/meta")]);if(!y(M,O))return!1;const ce=(re.fields||[]).filter(Z=>/^computer\.[^.]+$/.test(Z.path)&&Z.path!=="computer.enabled"&&Z.sensitivity==="public"&&Z.apply_mode==="restart");if(!$.computer||!ce.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=ce.map(Z=>({...Z,key:Z.path.split(".")[1]})),a.value=Object.fromEntries(s.value.map(Z=>[Z.key,zf($.computer[Z.key])])),A(),h=O,i.value=!0,c.value=!1,!0}async function N(){if(!p||l.value||o.value)return;const M=++m,O=z.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await P(M,O)}catch($){y(M,O)&&(c.value=!0,d.value=$.message||"Could not load provisioning. No changes were sent.")}finally{y(M,O)&&(l.value=!1)}}function w(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!E.value&&(r.value=!0)}async function I(){if(!p||!i.value||!r.value||o.value||l.value||c.value||E.value||!g.value.length)return;if(h!==z.token){G(),K();return}const M={computer:Object.fromEntries(g.value.map(ce=>[ce.key,zf(ce.value)]))},O=m,$=z.token;o.value=!0,d.value="",u.value="";let re=!1;try{if(await z.put("/api/config",M),re=!0,!y(O,$))return;await P(O,$)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(ce){y(O,$)&&(c.value=!0,r.value=!1,d.value=re?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${ce.status===400?": "+ce.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{y(O,$)&&(o.value=!1)}}function K(){p||(p=!0,N())}function G(){p=!1,m++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,h=null,s.value=[],a.value={},n.value={},d.value="",u.value=""}return tt(K),rs(K),Kt(G),xt(G),{fields:s,original:a,draft:n,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:x,effectiveUnknown:S,changes:g,validation:_,invalid:E,fieldId:R,format:k,edit:L,discard:A,load:N,openReview:w,save:I}}},MC={components:{ComputerProvisioning:NC},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),a=f(!1),n=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(0),p=f(""),m=f(""),h=f(null),y=f(""),R=f(!1),k=f(Date.now()),b=f(""),g=f(null);let x=0,S=null,_=!1,E=z.token,L=0,A=null,P=null,N=!1;const w=q=>q===!0?"Enabled":q===!1?"Disabled":"Unknown",I=H(()=>{var q;return((q=e.value.backend)==null?void 0:q.environment)==="existing_session"}),K=H(()=>{var te;const q=Date.parse(((te=e.value.accessibility)==null?void 0:te.checked_at)||"");return c.value&&Number.isFinite(q)&&k.value-q<15e3&&k.value>=q-5e3}),G=H(()=>{var q;return K.value?w((q=e.value.accessibility)==null?void 0:q.enabled):"Unknown / not current"}),M=H(()=>{var q;return K.value?((q=e.value.accessibility)==null?void 0:q.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),O=H(()=>Object.entries(e.value.input_limits||{}).filter(([,q])=>typeof q=="number"&&Number.isFinite(q)).map(([q,te])=>`${q}: ${te}`).join(", ")),$=H(()=>{var te;const q=(te=e.value.application_provenance)==null?void 0:te.script_identity;return typeof q=="string"?q:!q||typeof q!="object"?"Not observed":`${q.interpreter_basename||"Unknown interpreter"}; argv digest ${q.argv_digest||"not recorded"}; ${q.verified===!0?"verified":"not verified"}`}),re=H(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(q=>q&&typeof q.id=="string"&&typeof q.label=="string"&&["supported","capture_only"].includes(q.input)).slice(0,16):[]),ce=H(()=>{const q=e.value.restart_required;return Array.isArray(q)?q.length?q.join(", "):"None reported":q===!0?"Pending; restart required":q===!1?"None reported":"Unknown"}),Z=H(()=>{var te,X;const q=Date.parse(((te=h.value)==null?void 0:te.captured_at)||"");return Number.isFinite(q)&&k.value<q+Math.min(1e4,((X=h.value)==null?void 0:X.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function J(){y.value&&URL.revokeObjectURL(y.value),y.value="",h.value=null}function se(){x++,J(),g.value=null,c.value=!1,A==null||A.abort(),A=null,t.value=!1,m.value="",s.value=!1,i.value=!1,l.value=!1}function j(q,te){return _&&q===x&&te===z.token}function ye(){return _&&c.value&&P===z.token&&Date.now()-u.value<15e3}function Oe(q,te="mutation"){var xe,B;se(),N=!0,p.value="";const X=q.status||(q.name==="AuthError"?401:0);[401,403,404].includes(X)?(u.value=0,P=null,e.value={available:!1,state:"unknown"}):u.value||(e.value={available:!1,state:X===503?"unavailable":"unknown"}),o.value=X===401||X===403||X===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":X===410?"Evidence or artifact expired. Observe or prepare the export again.":te==="read"?"Status refresh failed. Last-known details are not current. No mutation was requested by this read.":te==="acknowledged"?"The mutation was acknowledged, but status refresh failed. Refresh status independently; do not replay the change.":"Request failed; outcome unknown. Refresh status. No action was replayed.",te==="mutation"&&![401,403,404].includes(X)&&typeof((xe=q.data)==null?void 0:xe.code)=="string"&&/^[a-z_]{1,64}$/.test(q.data.code)&&typeof((B=q.data)==null?void 0:B.error)=="string"&&(o.value=q.data.error.slice(0,512),q.data.outcome==="not_applied"&&q.data.next_action==="repair_provisioning"&&typeof q.data.remedy=="string"&&(o.value="Not applied (preflight rejection). "+o.value,p.value=q.data.remedy.slice(0,1024)))}async function ne(){if(t.value||r.value||a.value||n.value||d.value||!_)return;const q=x,te=z.token;t.value=!0,L=Date.now();const X=new AbortController;A=X;try{const xe=await z.get("/api/computer",{signal:X.signal});if(!j(q,te))return;ie(xe)}catch(xe){j(q,te)&&Oe(xe,"read")}finally{A===X&&(A=null,t.value=!1)}}function ie(q,te=""){if(!q||typeof q!="object"||typeof q.state!="string"||typeof q.available!="boolean")throw new Error("Invalid status");(e.value.session_id&&e.value.session_id!==q.session_id||e.value.generation!=null&&e.value.generation!==q.generation||e.value.session_generation!=null&&e.value.session_generation!==q.session_generation)&&se(),e.value=q,u.value=Date.now(),P=z.token,c.value=!(r.value&&te!=="toggle")&&!(a.value&&te!=="stop")&&!(n.value&&te!=="pause")&&!(d.value&&te!=="recovery"),o.value="",p.value="",N=!c.value}async function ve(q){if(!ye()||r.value||a.value||n.value||d.value)return;se();const te=x,X=z.token;r.value=!0;let xe=!1;try{if(await z.post("/api/computer/enabled",{enabled:q}),xe=!0,!j(te,X))return;const B=await z.get("/api/computer");j(te,X)&&ie(B,"toggle")}catch(B){j(te,X)&&Oe(B,xe?"acknowledged":"mutation")}finally{r.value=!1}}async function be(q){if(!_||!["pause","stop"].includes(q)||(q==="stop"?a.value:n.value))return;se();const te=x,X=z.token,xe=q==="stop"?a:n;xe.value=!0;let B=!1;try{if(await z.post("/api/computer/"+q,{}),B=!0,j(te,X)){const ue=await z.get("/api/computer");j(te,X)&&ie(ue,q)}}catch(ue){j(te,X)&&Oe(ue,B?"acknowledged":"mutation")}finally{xe.value=!1}}async function ge(){var xe;if(!ye()||d.value||((xe=e.value.backend)==null?void 0:xe.native_backend)!=="hyprland")return;const q={session_id:e.value.session_id,generation:e.value.session_generation};if(!q.session_id||!Number.isInteger(q.generation))return;se();const te=x,X=z.token;d.value=!0;try{const B=await z.post("/api/computer/release_owned_input",q);j(te,X)&&ie(B,"recovery")}catch(B){j(te,X)&&Oe(B,"mutation")}finally{d.value=!1}}async function Ne(){return F(!1)}async function T(){return F(!0)}async function F(q){var oe;if(!ye()||d.value||r.value||a.value||n.value||e.value.state!=="quarantined")return;const te={session_id:e.value.session_id,generation:e.value.session_generation};if(!te.session_id||!Number.isInteger(te.generation))return;if(q){if(m.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+te.session_id)return;te.acknowledgment=m.value}const X=q?((oe=e.value.recovery)==null?void 0:oe.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";se();const xe=x,B=z.token;d.value=!0;let ue=!1;try{const he=await z.post("/api/computer/"+X,te);ue=!0,j(xe,B)&&ie(he,"recovery")}catch(he){j(xe,B)&&Oe(he,ue?"acknowledged":"mutation")}finally{d.value=!1}}async function W(){var X;if(!ye()||s.value||!e.value.available)return;J(),R.value=!1;const q=x,te=z.token;s.value=!0;try{const xe=await z.post("/api/computer/observe",{});if(!j(q,te))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((X=xe.frame)==null?void 0:X.evidence_id)||""))throw new Error("Invalid evidence");const B=await z.getBlob("/api/computer/evidence/"+xe.frame.evidence_id);if(!j(q,te))return;if(!["image/png","image/jpeg"].includes(B.type)||B.size>2097152||!Number.isFinite(Date.parse(xe.frame.expires_at))||Date.parse(xe.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");h.value=xe.frame,y.value=URL.createObjectURL(B),o.value=""}catch(xe){j(q,te)&&Oe(xe)}finally{q===x&&(s.value=!1)}}async function me(){if(!ye()||i.value||!e.value.available)return;g.value=null;const q=x,te=z.token;i.value=!0;try{const X=await z.post("/api/computer/export",{name:b.value});j(q,te)&&(g.value=X,o.value="")}catch(X){j(q,te)&&Oe(X)}finally{q===x&&(i.value=!1)}}async function de(){if(!ye()||l.value||!g.value)return;const q=x,te=z.token,X=g.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((X==null?void 0:X.artifact_id)||""))throw new Error("Invalid export");const xe=await z.getBlob("/api/computer/download/"+X.artifact_id);if(!j(q,te))return;const B=URL.createObjectURL(xe),ue=document.createElement("a");ue.href=B,ue.download=X.name,ue.click(),setTimeout(()=>URL.revokeObjectURL(B),1e3)}catch(xe){j(q,te)&&Oe(xe)}finally{q===x&&(l.value=!1)}}function fe(){_||(E!==z.token&&(E=z.token,se(),u.value=0,P=null,e.value={state:"unknown",available:!1},o.value="",p.value=""),_=!0,ne(),S=setInterval(()=>{k.value=Date.now(),E!==z.token&&(E=z.token,se(),u.value=0,P=null,o.value="",p.value="",e.value={state:"unknown",available:!1}),c.value&&k.value-u.value>=15e3&&se(),h.value&&Date.parse(h.value.expires_at)<=k.value&&(J(),R.value=!0),g.value&&Date.parse(g.value.expires_at)<=k.value&&(g.value=null),!N&&k.value-L>=5e3&&ne()},500))}function _e(){_=!1,clearInterval(S),S=null,se(),c.value=!1}return tt(fe),rs(fe),Kt(_e),xt(_e),{status:e,checkedAt:u,remedy:p,loading:t,observing:s,stopping:a,pausing:n,exporting:i,downloading:l,error:o,frame:h,frameUrl:y,frameExpired:R,freshness:Z,name:b,artifact:g,refresh:ne,control:be,observe:W,clearFrame:J,exportFile:me,download:de,toggling:r,adminReady:c,enabledLabel:w,restartSettings:ce,setEnabled:ve,recovering:d,recover:Ne,reconcile:T,releaseOwnedInput:ge,reconciliationAck:m,applicationProfiles:re,attached:I,scriptIdentity:$,inputLimits:O,accessibilityLabel:G,accessibilityDetail:M}}},Lg=[{id:"health",label:"Health",component:H1},{id:"resources",label:"Resources",component:j1},{id:"logs",label:"Logs",component:tC},{id:"config",label:"Config",component:fC},{id:"discord",label:"Discord",component:hC},{id:"hosts",label:"Hosts",component:bC},{id:"host-access",label:"Host Access",component:gC},{id:"permissions",label:"Permissions",component:xC},{id:"api-tokens",label:"API Tokens",component:yC},{id:"llm",label:"LLM Config",component:CC},{id:"internals",label:"Internals",component:EC},{id:"turn-state",label:"Turn State",component:IC},{id:"computer",label:"Computer",component:MC},{id:"update",label:"Update",component:OC}],DC={components:{TabbedPage:Xr},setup(){return{tabs:Lg}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Uo=(e,t,s,a)=>a.map(({id:n,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:n}}})),PC=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Uo("Operations","operations","/operations",wg),...Uo("History","history","/history",kg),...Uo("Capabilities","capabilities","/capabilities",Sg),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Uo("System","system","/system",Lg)],Fs=Tn({open:!1,query:"",selected:0});function Hf(){Fs.query="",Fs.selected=0,Fs.open=!0}function Uc(){Fs.open=!1}function $C(e,t){const s=e.label.toLowerCase(),a=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:a.startsWith(t)?80:s.includes(t)?60:a.includes(t)?40:0:1}const FC={setup(){const e=mg(),t=f(null),s=H(()=>{const i=Fs.query.trim().toLowerCase();return PC.map(l=>({...l,_score:$C(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Wt(()=>Fs.open,async i=>{var l;i&&(await zt(),(l=t.value)==null||l.focus())}),Wt(()=>Fs.query,()=>{Fs.selected=0});function a(i){Uc(),e.push(i.to)}function n(i){if(i.key==="Escape"){i.preventDefault(),Uc();return}if(i.key==="ArrowDown")i.preventDefault(),Fs.selected=Math.min(Fs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Fs.selected=Math.max(Fs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Fs.selected];l&&a(l)}}return{state:Fs,results:s,inputEl:t,go:a,onKeydown:n,closePalette:Uc}},template:`
    <transition name="modal">
