var kg=Object.defineProperty;var wg=(e,t,s)=>t in e?kg(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var Je=(e,t,s)=>wg(e,typeof t!="symbol"?t+"":t,s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();class Sg{constructor(){this._persist=localStorage.getItem("odin_persist")==="1",this._token=this._persist?localStorage.getItem("odin_token")||"":sessionStorage.getItem("odin_token")||"";const t=this._persist?localStorage:sessionStorage;this._sessionTimeout=parseInt(t.getItem("odin_session_timeout")||"0",10),this._lastActivity=Date.now(),this._activityTimer=null,this.onSessionExpired=null,this._token&&this._sessionTimeout>0&&this._startActivityMonitor()}get token(){return this._token}get sessionTimeout(){return this._sessionTimeout}setToken(t,s=0){if(this._token=t,this._sessionTimeout=s,this._lastActivity=Date.now(),t){const n=this._persist?localStorage:sessionStorage;n.setItem("odin_token",t),this._persist&&localStorage.setItem("odin_persist","1"),s>0?n.setItem("odin_session_timeout",String(s)):n.removeItem("odin_session_timeout"),this._startActivityMonitor()}else sessionStorage.removeItem("odin_token"),sessionStorage.removeItem("odin_session_timeout"),localStorage.removeItem("odin_token"),localStorage.removeItem("odin_persist"),localStorage.removeItem("odin_session_timeout"),this._stopActivityMonitor()}setPersist(t){this._persist=t}_startActivityMonitor(){this._stopActivityMonitor(),!(this._sessionTimeout<=0)&&(this._activityTimer=setInterval(()=>{(Date.now()-this._lastActivity)/1e3>=this._sessionTimeout&&(this._stopActivityMonitor(),this.onSessionExpired&&this.onSessionExpired())},1e4))}_stopActivityMonitor(){this._activityTimer&&(clearInterval(this._activityTimer),this._activityTimer=null)}_headers(t={}){const s={"Content-Type":"application/json",...t};return this._token&&(s.Authorization=`Bearer ${this._token}`),s}async _request(t,s,n=null){this._lastActivity=Date.now();const a={method:t,headers:this._headers()};n!==null&&(a.body=JSON.stringify(n));const i=await fetch(s,a);if(i.status===401)throw new hr("Unauthorized");const l=await i.json().catch(()=>null);if(!i.ok){const r=(l==null?void 0:l.error)||`HTTP ${i.status}`;throw new Tg(r,i.status,l)}return l}get(t){return this._request("GET",t)}post(t,s){return this._request("POST",t,s)}put(t,s){return this._request("PUT",t,s)}del(t){return this._request("DELETE",t)}async login(t){const s=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})}),n=await s.json().catch(()=>null);if(!s.ok)throw new hr((n==null?void 0:n.error)||"Login failed");return this.setToken(n.session_id,n.timeout_seconds||0),n}async logout(){try{await this.post("/api/auth/logout",{})}catch{}this.setToken("")}async check(){try{return await this.get("/api/status"),{ok:!0,needsAuth:!1}}catch(t){return t instanceof hr?{ok:!1,needsAuth:!0}:{ok:!1,needsAuth:!1,error:t.message}}}}class hr extends Error{constructor(t){super(t),this.name="AuthError"}}class Tg extends Error{constructor(t,s,n){super(t),this.name="ApiError",this.status=s,this.data=n}}class Cg{constructor(t){this._api=t,this._ws=null,this._handlers={logs:[],events:[],chat:[]},this._reconnectDelay=1e3,this._maxReconnectDelay=3e4,this._shouldConnect=!1,this._subscriptions=new Set,this._reconnectAttempt=0,this._lastPongTime=0,this._pingInterval=null,this._latency=-1,this._chatPending=!1,this._state="disconnected",this.onStatusChange=null,this.onStateChange=null}get connected(){var t;return((t=this._ws)==null?void 0:t.readyState)===WebSocket.OPEN}get state(){return this._state}get reconnectAttempt(){return this._reconnectAttempt}get latency(){return this._latency}connect(){this._shouldConnect=!0,this._setState("connecting"),this._open()}disconnect(){this._shouldConnect=!1,this._reconnectAttempt=0,this._latency=-1,this._stopPing(),this._ws&&(this._ws.close(),this._ws=null),this._setState("disconnected")}_setState(t){this._state!==t&&(this._state=t,this.onStateChange&&this.onStateChange(t,{attempt:this._reconnectAttempt,latency:this._latency}))}_startPing(){this._stopPing(),this._pingInterval=setInterval(()=>{if(this.connected)try{this._ws.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}},15e3)}_stopPing(){this._pingInterval&&(clearInterval(this._pingInterval),this._pingInterval=null)}subscribe(t,s){this._handlers[t]||(this._handlers[t]=[]),this._handlers[t].push(s),t!=="chat"&&(this._subscriptions.add(t),this.connected&&this._ws.send(JSON.stringify({subscribe:t})))}unsubscribe(t,s){const n=this._handlers[t];if(n){const a=n.indexOf(s);a>=0&&n.splice(a,1),n.length===0&&t!=="chat"&&(this._subscriptions.delete(t),this.connected&&this._ws.send(JSON.stringify({unsubscribe:t})))}}on(t,s){return this.subscribe(t,s)}off(t,s){return this.unsubscribe(t,s)}sendChat(t,{channelId:s,userId:n,username:a}={}){return this.connected?(this._ws.send(JSON.stringify({type:"chat",content:t,channel_id:s||"web-default",user_id:n||void 0,username:a||void 0})),this._chatPending=!0,!0):!1}_open(){if(this._ws)return;let s=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/api/ws`;this._api.token&&(s+=`?token=${encodeURIComponent(this._api.token)}`),this._ws=new WebSocket(s),this._ws.onopen=()=>{this._reconnectDelay=1e3,this._reconnectAttempt=0;for(const n of this._subscriptions)this._ws.send(JSON.stringify({subscribe:n}));this._startPing(),this._setState("connected"),this.onStatusChange&&this.onStatusChange(!0)},this._ws.onmessage=n=>{let a;try{a=JSON.parse(n.data)}catch{return}const i=a.type;if(i==="pong"){a.ts&&(this._latency=Date.now()-a.ts,this._lastPongTime=Date.now());return}if(i==="log")for(const l of this._handlers.logs||[])l(a);else if(i==="event")for(const l of this._handlers.events||[])l(a);else if(i==="chat_response"||i==="chat_error"){this._chatPending=!1;for(const l of this._handlers.chat||[])l(a)}},this._ws.onclose=()=>{if(this._ws=null,this._stopPing(),this._latency=-1,this._chatPending){this._chatPending=!1;const n={type:"chat_error",error:"Connection lost — the response may still complete; check session history."};for(const a of this._handlers.chat||[])a(n)}this.onStatusChange&&this.onStatusChange(!1),this._shouldConnect?(this._reconnectAttempt++,this._setState("reconnecting"),setTimeout(()=>this._open(),this._reconnectDelay),this._reconnectDelay=Math.min(this._reconnectDelay*2,this._maxReconnectDelay)):this._setState("disconnected")},this._ws.onerror=()=>{}}}const q=new Sg,Ge=new Cg(q);/**
* @vue/shared v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function is(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const Pe={},la=[],Nt=()=>{},aa=()=>!1,Bn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Pl=e=>e.startsWith("onUpdate:"),De=Object.assign,To=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Eg=Object.prototype.hasOwnProperty,je=(e,t)=>Eg.call(e,t),pe=Array.isArray,ra=e=>Ea(e)==="[object Map]",Hn=e=>Ea(e)==="[object Set]",Zc=e=>Ea(e)==="[object Date]",Ag=e=>Ea(e)==="[object RegExp]",we=e=>typeof e=="function",Ee=e=>typeof e=="string",Ut=e=>typeof e=="symbol",Ve=e=>e!==null&&typeof e=="object",Co=e=>(Ve(e)||we(e))&&we(e.then)&&we(e.catch),Gd=Object.prototype.toString,Ea=e=>Gd.call(e),Rg=e=>Ea(e).slice(8,-1),Fl=e=>Ea(e)==="[object Object]",$l=e=>Ee(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,qs=is(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ig=is("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),Ul=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Ng=/-\w/g,Ze=Ul(e=>e.replace(Ng,t=>t.slice(1).toUpperCase())),Og=/\B([A-Z])/g,Qt=Ul(e=>e.replace(Og,"-$1").toLowerCase()),Vn=Ul(e=>e.charAt(0).toUpperCase()+e.slice(1)),oa=Ul(e=>e?`on${Vn(e)}`:""),St=(e,t)=>!Object.is(e,t),ca=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},Wd=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Bl=e=>{const t=parseFloat(e);return isNaN(t)?e:t},ll=e=>{const t=Ee(e)?Number(e):NaN;return isNaN(t)?e:t};let Jc;const Hl=()=>Jc||(Jc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Lg(e,t){return e+JSON.stringify(t,(s,n)=>typeof n=="function"?n.toString():n)}const Dg="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol",Mg=is(Dg);function ki(e){if(pe(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],a=Ee(n)?Zd(n):ki(n);if(a)for(const i in a)t[i]=a[i]}return t}else if(Ee(e)||Ve(e))return e}const Pg=/;(?![^(]*\))/g,Fg=/:([^]+)/,$g=/\/\*[^]*?\*\//g;function Zd(e){const t={};return e.replace($g,"").split(Pg).forEach(s=>{if(s){const n=s.split(Fg);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function wi(e){let t="";if(Ee(e))t=e;else if(pe(e))for(let s=0;s<e.length;s++){const n=wi(e[s]);n&&(t+=n+" ")}else if(Ve(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function Ug(e){if(!e)return null;let{class:t,style:s}=e;return t&&!Ee(t)&&(e.class=wi(t)),s&&(e.style=ki(s)),e}const Bg="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",Hg="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",Vg="annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics",jg="area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr",zg=is(Bg),Kg=is(Hg),qg=is(Vg),Gg=is(jg),Wg="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Zg=is(Wg);function Jd(e){return!!e||e===""}function Jg(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=Js(e[n],t[n]);return s}function Js(e,t){if(e===t)return!0;let s=Zc(e),n=Zc(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=Ut(e),n=Ut(t),s||n)return e===t;if(s=pe(e),n=pe(t),s||n)return s&&n?Jg(e,t):!1;if(s=Ve(e),n=Ve(t),s||n){if(!s||!n)return!1;const a=Object.keys(e).length,i=Object.keys(t).length;if(a!==i)return!1;for(const l in e){const r=e.hasOwnProperty(l),o=t.hasOwnProperty(l);if(r&&!o||!r&&o||!Js(e[l],t[l]))return!1}}return String(e)===String(t)}function Vl(e,t){return e.findIndex(s=>Js(s,t))}const Yd=e=>!!(e&&e.__v_isRef===!0),Qd=e=>Ee(e)?e:e==null?"":pe(e)||Ve(e)&&(e.toString===Gd||!we(e.toString))?Yd(e)?Qd(e.value):JSON.stringify(e,Xd,2):String(e),Xd=(e,t)=>Yd(t)?Xd(e,t.value):ra(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,a],i)=>(s[gr(n,i)+" =>"]=a,s),{})}:Hn(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>gr(s))}:Ut(t)?gr(t):Ve(t)&&!pe(t)&&!Fl(t)?String(t):t,gr=(e,t="")=>{var s;return Ut(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};function Yg(e){return e==null?"initial":typeof e=="string"?e===""?" ":e:String(e)}/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let _t;class Eo{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&_t&&(_t.active?(this.parent=_t,this.index=(_t.scopes||(_t.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=_t;try{return _t=this,t()}finally{_t=s}}}on(){++this._on===1&&(this.prevScope=_t,_t=this)}off(){if(this._on>0&&--this._on===0){if(_t===this)_t=this.prevScope;else{let t=_t;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0}}}function Qg(e){return new Eo(e)}function ef(){return _t}function Xg(e,t=!1){_t&&_t.cleanups.push(e)}let Xe;const mr=new WeakSet;class ai{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,_t&&(_t.active?_t.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,mr.has(this)&&(mr.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||sf(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Yc(this),nf(this);const t=Xe,s=bs;Xe=this,bs=!0;try{return this.fn()}finally{af(this),Xe=t,bs=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Io(t);this.deps=this.depsTail=void 0,Yc(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?mr.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){jr(this)&&this.run()}get dirty(){return jr(this)}}let tf=0,Wa,Za;function sf(e,t=!1){if(e.flags|=8,t){e.next=Za,Za=e;return}e.next=Wa,Wa=e}function Ao(){tf++}function Ro(){if(--tf>0)return;if(Za){let t=Za;for(Za=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;Wa;){let t=Wa;for(Wa=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function nf(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function af(e){let t,s=e.depsTail,n=s;for(;n;){const a=n.prevDep;n.version===-1?(n===s&&(s=a),Io(n),em(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=a}e.deps=t,e.depsTail=s}function jr(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(lf(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function lf(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===ii)||(e.globalVersion=ii,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!jr(e))))return;e.flags|=2;const t=e.dep,s=Xe,n=bs;Xe=e,bs=!0;try{nf(e);const a=e.fn(e._value);(t.version===0||St(a,e._value))&&(e.flags|=128,e._value=a,t.version++)}catch(a){throw t.version++,a}finally{Xe=s,bs=n,af(e),e.flags&=-3}}function Io(e,t=!1){const{dep:s,prevSub:n,nextSub:a}=e;if(n&&(n.nextSub=a,e.prevSub=void 0),a&&(a.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let i=s.computed.deps;i;i=i.nextDep)Io(i,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function em(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}function tm(e,t){e.effect instanceof ai&&(e=e.effect.fn);const s=new ai(e);t&&De(s,t);try{s.run()}catch(a){throw s.stop(),a}const n=s.run.bind(s);return n.effect=s,n}function sm(e){e.effect.stop()}let bs=!0;const rf=[];function Ys(){rf.push(bs),bs=!1}function Qs(){const e=rf.pop();bs=e===void 0?!0:e}function Yc(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=Xe;Xe=void 0;try{t()}finally{Xe=s}}}let ii=0;class nm{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class jl{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!Xe||!bs||Xe===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==Xe)s=this.activeLink=new nm(Xe,this),Xe.deps?(s.prevDep=Xe.depsTail,Xe.depsTail.nextDep=s,Xe.depsTail=s):Xe.deps=Xe.depsTail=s,of(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=Xe.depsTail,s.nextDep=void 0,Xe.depsTail.nextDep=s,Xe.depsTail=s,Xe.deps===s&&(Xe.deps=n)}return s}trigger(t){this.version++,ii++,this.notify(t)}notify(t){Ao();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Ro()}}}function of(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)of(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const rl=new WeakMap,In=Symbol(""),zr=Symbol(""),li=Symbol("");function Pt(e,t,s){if(bs&&Xe){let n=rl.get(e);n||rl.set(e,n=new Map);let a=n.get(s);a||(n.set(s,a=new jl),a.map=n,a.key=s),a.track()}}function Hs(e,t,s,n,a,i){const l=rl.get(e);if(!l){ii++;return}const r=o=>{o&&o.trigger()};if(Ao(),t==="clear")l.forEach(r);else{const o=pe(e),c=o&&$l(s);if(o&&s==="length"){const u=Number(n);l.forEach((d,f)=>{(f==="length"||f===li||!Ut(f)&&f>=u)&&r(d)})}else switch((s!==void 0||l.has(void 0))&&r(l.get(s)),c&&r(l.get(li)),t){case"add":o?c&&r(l.get("length")):(r(l.get(In)),ra(e)&&r(l.get(zr)));break;case"delete":o||(r(l.get(In)),ra(e)&&r(l.get(zr)));break;case"set":ra(e)&&r(l.get(In));break}}Ro()}function am(e,t){const s=rl.get(e);return s&&s.get(t)}function Zn(e){const t=$e(e);return t===e?t:(Pt(t,"iterate",li),es(e)?t:t.map(xs))}function zl(e){return Pt(e=$e(e),"iterate",li),e}function As(e,t){return Is(e)?ga(Gs(e)?xs(t):t):xs(t)}const im={__proto__:null,[Symbol.iterator](){return vr(this,Symbol.iterator,e=>As(this,e))},concat(...e){return Zn(this).concat(...e.map(t=>pe(t)?Zn(t):t))},entries(){return vr(this,"entries",e=>(e[1]=As(this,e[1]),e))},every(e,t){return Ls(this,"every",e,t,void 0,arguments)},filter(e,t){return Ls(this,"filter",e,t,s=>s.map(n=>As(this,n)),arguments)},find(e,t){return Ls(this,"find",e,t,s=>As(this,s),arguments)},findIndex(e,t){return Ls(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return Ls(this,"findLast",e,t,s=>As(this,s),arguments)},findLastIndex(e,t){return Ls(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return Ls(this,"forEach",e,t,void 0,arguments)},includes(...e){return br(this,"includes",e)},indexOf(...e){return br(this,"indexOf",e)},join(e){return Zn(this).join(e)},lastIndexOf(...e){return br(this,"lastIndexOf",e)},map(e,t){return Ls(this,"map",e,t,void 0,arguments)},pop(){return Da(this,"pop")},push(...e){return Da(this,"push",e)},reduce(e,...t){return Qc(this,"reduce",e,t)},reduceRight(e,...t){return Qc(this,"reduceRight",e,t)},shift(){return Da(this,"shift")},some(e,t){return Ls(this,"some",e,t,void 0,arguments)},splice(...e){return Da(this,"splice",e)},toReversed(){return Zn(this).toReversed()},toSorted(e){return Zn(this).toSorted(e)},toSpliced(...e){return Zn(this).toSpliced(...e)},unshift(...e){return Da(this,"unshift",e)},values(){return vr(this,"values",e=>As(this,e))}};function vr(e,t,s){const n=zl(e),a=n[t]();return n!==e&&!es(e)&&(a._next=a.next,a.next=()=>{const i=a._next();return i.done||(i.value=s(i.value)),i}),a}const lm=Array.prototype;function Ls(e,t,s,n,a,i){const l=zl(e),r=l!==e&&!es(e),o=l[t];if(o!==lm[t]){const d=o.apply(e,i);return r?xs(d):d}let c=s;l!==e&&(r?c=function(d,f){return s.call(this,As(e,d),f,e)}:s.length>2&&(c=function(d,f){return s.call(this,d,f,e)}));const u=o.call(l,c,n);return r&&a?a(u):u}function Qc(e,t,s,n){const a=zl(e),i=a!==e&&!es(e);let l=s,r=!1;a!==e&&(i?(r=n.length===0,l=function(c,u,d){return r&&(r=!1,c=As(e,c)),s.call(this,c,As(e,u),d,e)}):s.length>3&&(l=function(c,u,d){return s.call(this,c,u,d,e)}));const o=a[t](l,...n);return r?As(e,o):o}function br(e,t,s){const n=$e(e);Pt(n,"iterate",li);const a=n[t](...s);return(a===-1||a===!1)&&Si(s[0])?(s[0]=$e(s[0]),n[t](...s)):a}function Da(e,t,s=[]){Ys(),Ao();const n=$e(e)[t].apply(e,s);return Ro(),Qs(),n}const rm=is("__proto__,__v_isRef,__isVue"),cf=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Ut));function om(e){Ut(e)||(e=String(e));const t=$e(this);return Pt(t,"has",e),t.hasOwnProperty(e)}class uf{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const a=this._isReadonly,i=this._isShallow;if(s==="__v_isReactive")return!a;if(s==="__v_isReadonly")return a;if(s==="__v_isShallow")return i;if(s==="__v_raw")return n===(a?i?mf:gf:i?hf:pf).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const l=pe(t);if(!a){let o;if(l&&(o=im[s]))return o;if(s==="hasOwnProperty")return om}const r=Reflect.get(t,s,mt(t)?t:n);if((Ut(s)?cf.has(s):rm(s))||(a||Pt(t,"get",s),i))return r;if(mt(r)){const o=l&&$l(s)?r:r.value;return a&&Ve(o)?ol(o):o}return Ve(r)?a?ol(r):bn(r):r}}class df extends uf{constructor(t=!1){super(!1,t)}set(t,s,n,a){let i=t[s];const l=pe(t)&&$l(s);if(!this._isShallow){const c=Is(i);if(!es(n)&&!Is(n)&&(i=$e(i),n=$e(n)),!l&&mt(i)&&!mt(n))return c||(i.value=n),!0}const r=l?Number(s)<t.length:je(t,s),o=Reflect.set(t,s,n,mt(t)?t:a);return t===$e(a)&&(r?St(n,i)&&Hs(t,"set",s,n):Hs(t,"add",s,n)),o}deleteProperty(t,s){const n=je(t,s);t[s];const a=Reflect.deleteProperty(t,s);return a&&n&&Hs(t,"delete",s,void 0),a}has(t,s){const n=Reflect.has(t,s);return(!Ut(s)||!cf.has(s))&&Pt(t,"has",s),n}ownKeys(t){return Pt(t,"iterate",pe(t)?"length":In),Reflect.ownKeys(t)}}class ff extends uf{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const cm=new df,um=new ff,dm=new df(!0),fm=new ff(!0),Kr=e=>e,$i=e=>Reflect.getPrototypeOf(e);function pm(e,t,s){return function(...n){const a=this.__v_raw,i=$e(a),l=ra(i),r=e==="entries"||e===Symbol.iterator&&l,o=e==="keys"&&l,c=a[e](...n),u=s?Kr:t?ga:xs;return!t&&Pt(i,"iterate",o?zr:In),De(Object.create(c),{next(){const{value:d,done:f}=c.next();return f?{value:d,done:f}:{value:r?[u(d[0]),u(d[1])]:u(d),done:f}}})}}function Ui(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function hm(e,t){const s={get(a){const i=this.__v_raw,l=$e(i),r=$e(a);e||(St(a,r)&&Pt(l,"get",a),Pt(l,"get",r));const{has:o}=$i(l),c=t?Kr:e?ga:xs;if(o.call(l,a))return c(i.get(a));if(o.call(l,r))return c(i.get(r));i!==l&&i.get(a)},get size(){const a=this.__v_raw;return!e&&Pt($e(a),"iterate",In),a.size},has(a){const i=this.__v_raw,l=$e(i),r=$e(a);return e||(St(a,r)&&Pt(l,"has",a),Pt(l,"has",r)),a===r?i.has(a):i.has(a)||i.has(r)},forEach(a,i){const l=this,r=l.__v_raw,o=$e(r),c=t?Kr:e?ga:xs;return!e&&Pt(o,"iterate",In),r.forEach((u,d)=>a.call(i,c(u),c(d),l))}};return De(s,e?{add:Ui("add"),set:Ui("set"),delete:Ui("delete"),clear:Ui("clear")}:{add(a){const i=$e(this),l=$i(i),r=$e(a),o=!t&&!es(a)&&!Is(a)?r:a;return l.has.call(i,o)||St(a,o)&&l.has.call(i,a)||St(r,o)&&l.has.call(i,r)||(i.add(o),Hs(i,"add",o,o)),this},set(a,i){!t&&!es(i)&&!Is(i)&&(i=$e(i));const l=$e(this),{has:r,get:o}=$i(l);let c=r.call(l,a);c||(a=$e(a),c=r.call(l,a));const u=o.call(l,a);return l.set(a,i),c?St(i,u)&&Hs(l,"set",a,i):Hs(l,"add",a,i),this},delete(a){const i=$e(this),{has:l,get:r}=$i(i);let o=l.call(i,a);o||(a=$e(a),o=l.call(i,a)),r&&r.call(i,a);const c=i.delete(a);return o&&Hs(i,"delete",a,void 0),c},clear(){const a=$e(this),i=a.size!==0,l=a.clear();return i&&Hs(a,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(a=>{s[a]=pm(a,e,t)}),s}function Kl(e,t){const s=hm(e,t);return(n,a,i)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?n:Reflect.get(je(s,a)&&a in n?s:n,a,i)}const gm={get:Kl(!1,!1)},mm={get:Kl(!1,!0)},vm={get:Kl(!0,!1)},bm={get:Kl(!0,!0)},pf=new WeakMap,hf=new WeakMap,gf=new WeakMap,mf=new WeakMap;function ym(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function bn(e){return Is(e)?e:ql(e,!1,cm,gm,pf)}function No(e){return ql(e,!1,dm,mm,hf)}function ol(e){return ql(e,!0,um,vm,gf)}function xm(e){return ql(e,!0,fm,bm,mf)}function ql(e,t,s,n,a){if(!Ve(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const i=a.get(e);if(i)return i;const l=ym(Rg(e));if(l===0)return e;const r=new Proxy(e,l===2?n:s);return a.set(e,r),r}function Gs(e){return Is(e)?Gs(e.__v_raw):!!(e&&e.__v_isReactive)}function Is(e){return!!(e&&e.__v_isReadonly)}function es(e){return!!(e&&e.__v_isShallow)}function Si(e){return e?!!e.__v_raw:!1}function $e(e){const t=e&&e.__v_raw;return t?$e(t):e}function vf(e){return!je(e,"__v_skip")&&Object.isExtensible(e)&&Wd(e,"__v_skip",!0),e}const xs=e=>Ve(e)?bn(e):e,ga=e=>Ve(e)?ol(e):e;function mt(e){return e?e.__v_isRef===!0:!1}function h(e){return bf(e,!1)}function Oo(e){return bf(e,!0)}function bf(e,t){return mt(e)?e:new _m(e,t)}class _m{constructor(t,s){this.dep=new jl,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:$e(t),this._value=s?t:xs(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||es(t)||Is(t);t=n?t:$e(t),St(t,s)&&(this._rawValue=t,this._value=n?t:xs(t),this.dep.trigger())}}function km(e){e.dep&&e.dep.trigger()}function Rs(e){return mt(e)?e.value:e}function wm(e){return we(e)?e():Rs(e)}const Sm={get:(e,t,s)=>t==="__v_raw"?e:Rs(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const a=e[t];return mt(a)&&!mt(s)?(a.value=s,!0):Reflect.set(e,t,s,n)}};function Lo(e){return Gs(e)?e:new Proxy(e,Sm)}class Tm{constructor(t){this.__v_isRef=!0,this._value=void 0;const s=this.dep=new jl,{get:n,set:a}=t(s.track.bind(s),s.trigger.bind(s));this._get=n,this._set=a}get value(){return this._value=this._get()}set value(t){this._set(t)}}function yf(e){return new Tm(e)}function Cm(e){const t=pe(e)?new Array(e.length):{};for(const s in e)t[s]=xf(e,s);return t}class Em{constructor(t,s,n){this._object=t,this._defaultValue=n,this.__v_isRef=!0,this._value=void 0,this._key=Ut(s)?s:String(s),this._raw=$e(t);let a=!0,i=t;if(!pe(t)||Ut(this._key)||!$l(this._key))do a=!Si(i)||es(i);while(a&&(i=i.__v_raw));this._shallow=a}get value(){let t=this._object[this._key];return this._shallow&&(t=Rs(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&mt(this._raw[this._key])){const s=this._object[this._key];if(mt(s)){s.value=t;return}}this._object[this._key]=t}get dep(){return am(this._raw,this._key)}}class Am{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function Rm(e,t,s){return mt(e)?e:we(e)?new Am(e):Ve(e)&&arguments.length>1?xf(e,t,s):h(e)}function xf(e,t,s){return new Em(e,t,s)}class Im{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new jl(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=ii-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&Xe!==this)return sf(this,!0),!0}get value(){const t=this.dep.track();return lf(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Nm(e,t,s=!1){let n,a;return we(e)?n=e:(n=e.get,a=e.set),new Im(n,a,s)}const Om={GET:"get",HAS:"has",ITERATE:"iterate"},Lm={SET:"set",ADD:"add",DELETE:"delete",CLEAR:"clear"},Bi={},cl=new WeakMap;let dn;function Dm(){return dn}function _f(e,t=!1,s=dn){if(s){let n=cl.get(s);n||cl.set(s,n=[]),n.push(e)}}function Mm(e,t,s=Pe){const{immediate:n,deep:a,once:i,scheduler:l,augmentJob:r,call:o}=s,c=x=>a?x:es(x)||a===!1||a===0?Vs(x,1):Vs(x);let u,d,f,p,m=!1,g=!1;if(mt(e)?(d=()=>e.value,m=es(e)):Gs(e)?(d=()=>c(e),m=!0):pe(e)?(g=!0,m=e.some(x=>Gs(x)||es(x)),d=()=>e.map(x=>{if(mt(x))return x.value;if(Gs(x))return c(x);if(we(x))return o?o(x,2):x()})):we(e)?t?d=o?()=>o(e,2):e:d=()=>{if(f){Ys();try{f()}finally{Qs()}}const x=dn;dn=u;try{return o?o(e,3,[p]):e(p)}finally{dn=x}}:d=Nt,t&&a){const x=d,S=a===!0?1/0:a;d=()=>Vs(x(),S)}const k=ef(),w=()=>{u.stop(),k&&k.active&&To(k.effects,u)};if(i&&t){const x=t;t=(...S)=>{const N=x(...S);return w(),N}}let b=g?new Array(e.length).fill(Bi):Bi;const v=x=>{if(!(!(u.flags&1)||!u.dirty&&!x))if(t){const S=u.run();if(x||a||m||(g?S.some((N,O)=>St(N,b[O])):St(S,b))){f&&f();const N=dn;dn=u;try{const O=[S,b===Bi?void 0:g&&b[0]===Bi?[]:b,p];b=S,o?o(t,3,O):t(...O)}finally{dn=N}}}else u.run()};return r&&r(v),u=new ai(d),u.scheduler=l?()=>l(v,!1):v,p=x=>_f(x,!1,u),f=u.onStop=()=>{const x=cl.get(u);if(x){if(o)o(x,4);else for(const S of x)S();cl.delete(u)}},t?n?v(!0):b=u.run():l?l(v.bind(null,!0),!0):u.run(),w.pause=u.pause.bind(u),w.resume=u.resume.bind(u),w.stop=w,w}function Vs(e,t=1/0,s){if(t<=0||!Ve(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,mt(e))Vs(e.value,t,s);else if(pe(e))for(let n=0;n<e.length;n++)Vs(e[n],t,s);else if(Hn(e)||ra(e))e.forEach(n=>{Vs(n,t,s)});else if(Fl(e)){for(const n in e)Vs(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&Vs(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const kf=[];function Pm(e){kf.push(e)}function Fm(){kf.pop()}function $m(e,t){}const Um={SETUP_FUNCTION:0,0:"SETUP_FUNCTION",RENDER_FUNCTION:1,1:"RENDER_FUNCTION",NATIVE_EVENT_HANDLER:5,5:"NATIVE_EVENT_HANDLER",COMPONENT_EVENT_HANDLER:6,6:"COMPONENT_EVENT_HANDLER",VNODE_HOOK:7,7:"VNODE_HOOK",DIRECTIVE_HOOK:8,8:"DIRECTIVE_HOOK",TRANSITION_HOOK:9,9:"TRANSITION_HOOK",APP_ERROR_HANDLER:10,10:"APP_ERROR_HANDLER",APP_WARN_HANDLER:11,11:"APP_WARN_HANDLER",FUNCTION_REF:12,12:"FUNCTION_REF",ASYNC_COMPONENT_LOADER:13,13:"ASYNC_COMPONENT_LOADER",SCHEDULER:14,14:"SCHEDULER",COMPONENT_UPDATE:15,15:"COMPONENT_UPDATE",APP_UNMOUNT_CLEANUP:16,16:"APP_UNMOUNT_CLEANUP"},Bm={sp:"serverPrefetch hook",bc:"beforeCreate hook",c:"created hook",bm:"beforeMount hook",m:"mounted hook",bu:"beforeUpdate hook",u:"updated",bum:"beforeUnmount hook",um:"unmounted hook",a:"activated hook",da:"deactivated hook",ec:"errorCaptured hook",rtc:"renderTracked hook",rtg:"renderTriggered hook",0:"setup function",1:"render function",2:"watcher getter",3:"watcher callback",4:"watcher cleanup function",5:"native event handler",6:"component event handler",7:"vnode hook",8:"directive hook",9:"transition hook",10:"app errorHandler",11:"app warnHandler",12:"ref function",13:"async component loader",14:"scheduler flush",15:"component update",16:"app unmount cleanup function"};function Aa(e,t,s,n){try{return n?e(...n):e()}catch(a){jn(a,t,s)}}function ns(e,t,s,n){if(we(e)){const a=Aa(e,t,s,n);return a&&Co(a)&&a.catch(i=>{jn(i,t,s)}),a}if(pe(e)){const a=[];for(let i=0;i<e.length;i++)a.push(ns(e[i],t,s,n));return a}}function jn(e,t,s,n=!0){const a=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=t&&t.appContext.config||Pe;if(t){let r=t.parent;const o=t.proxy,c=`https://vuejs.org/error-reference/#runtime-${s}`;for(;r;){const u=r.ec;if(u){for(let d=0;d<u.length;d++)if(u[d](e,o,c)===!1)return}r=r.parent}if(i){Ys(),Aa(i,null,10,[e,o,c]),Qs();return}}Hm(e,s,a,n,l)}function Hm(e,t,s,n=!0,a=!1){if(a)throw e;console.error(e)}const jt=[];let Cs=-1;const ua=[];let fn=null,ea=0;const wf=Promise.resolve();let ul=null;function Tt(e){const t=ul||wf;return e?t.then(this?e.bind(this):e):t}function Vm(e){let t=Cs+1,s=jt.length;for(;t<s;){const n=t+s>>>1,a=jt[n],i=oi(a);i<e||i===e&&a.flags&2?t=n+1:s=n}return t}function Do(e){if(!(e.flags&1)){const t=oi(e),s=jt[jt.length-1];!s||!(e.flags&2)&&t>=oi(s)?jt.push(e):jt.splice(Vm(t),0,e),e.flags|=1,Sf()}}function Sf(){ul||(ul=wf.then(Tf))}function ri(e){pe(e)?ua.push(...e):fn&&e.id===-1?fn.splice(ea+1,0,e):e.flags&1||(ua.push(e),e.flags|=1),Sf()}function Xc(e,t,s=Cs+1){for(;s<jt.length;s++){const n=jt[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;jt.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function dl(e){if(ua.length){const t=[...new Set(ua)].sort((s,n)=>oi(s)-oi(n));if(ua.length=0,fn){fn.push(...t);return}for(fn=t,ea=0;ea<fn.length;ea++){const s=fn[ea];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}fn=null,ea=0}}const oi=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Tf(e){try{for(Cs=0;Cs<jt.length;Cs++){const t=jt[Cs];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Aa(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Cs<jt.length;Cs++){const t=jt[Cs];t&&(t.flags&=-2)}Cs=-1,jt.length=0,dl(),ul=null,(jt.length||ua.length)&&Tf()}}let ta,Hi=[];function Cf(e,t){var s,n;ta=e,ta?(ta.enabled=!0,Hi.forEach(({event:a,args:i})=>ta.emit(a,...i)),Hi=[]):typeof window<"u"&&window.HTMLElement&&!((n=(s=window.navigator)==null?void 0:s.userAgent)!=null&&n.includes("jsdom"))?((t.__VUE_DEVTOOLS_HOOK_REPLAY__=t.__VUE_DEVTOOLS_HOOK_REPLAY__||[]).push(i=>{Cf(i,t)}),setTimeout(()=>{ta||(t.__VUE_DEVTOOLS_HOOK_REPLAY__=null,Hi=[])},3e3)):Hi=[]}let It=null,Gl=null;function ci(e){const t=It;return It=e,Gl=e&&e.type.__scopeId||null,t}function jm(e){Gl=e}function zm(){Gl=null}const Km=e=>Mo;function Mo(e,t=It,s){if(!t||e._n)return e;const n=(...a)=>{n._d&&pi(-1);const i=ci(t);let l;try{l=e(...a)}finally{ci(i),n._d&&pi(1)}return l};return n._n=!0,n._c=!0,n._d=!0,n}function qm(e,t){if(It===null)return e;const s=Ai(It),n=e.dirs||(e.dirs=[]);for(let a=0;a<t.length;a++){let[i,l,r,o=Pe]=t[a];i&&(we(i)&&(i={mounted:i,updated:i}),i.deep&&Vs(l),n.push({dir:i,instance:s,value:l,oldValue:void 0,arg:r,modifiers:o}))}return e}function Es(e,t,s,n){const a=e.dirs,i=t&&t.dirs;for(let l=0;l<a.length;l++){const r=a[l];i&&(r.oldValue=i[l].value);let o=r.dir[n];o&&(Ys(),ns(o,s,8,[e.el,r,e,t]),Qs())}}function Ja(e,t){if(Rt){let s=Rt.provides;const n=Rt.parent&&Rt.parent.provides;n===s&&(s=Rt.provides=Object.create(n)),s[e]=t}}function ds(e,t,s=!1){const n=Kt();if(n||Nn){let a=Nn?Nn._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(a&&e in a)return a[e];if(arguments.length>1)return s&&we(t)?t.call(n&&n.proxy):t}}function Gm(){return!!(Kt()||Nn)}const Ef=Symbol.for("v-scx"),Af=()=>ds(Ef);function Wm(e,t){return Ti(e,null,t)}function Zm(e,t){return Ti(e,null,{flush:"post"})}function Rf(e,t){return Ti(e,null,{flush:"sync"})}function fs(e,t,s){return Ti(e,t,s)}function Ti(e,t,s=Pe){const{immediate:n,deep:a,flush:i,once:l}=s,r=De({},s),o=t&&n||!t&&i!=="post";let c;if(Fn){if(i==="sync"){const p=Af();c=p.__watcherHandles||(p.__watcherHandles=[])}else if(!o){const p=()=>{};return p.stop=Nt,p.resume=Nt,p.pause=Nt,p}}const u=Rt;r.call=(p,m,g)=>ns(p,u,m,g);let d=!1;i==="post"?r.scheduler=p=>{ht(p,u&&u.suspense)}:i!=="sync"&&(d=!0,r.scheduler=(p,m)=>{m?p():Do(p)}),r.augmentJob=p=>{t&&(p.flags|=4),d&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const f=Mm(e,t,r);return Fn&&(c?c.push(f):o&&f()),f}function Jm(e,t,s){const n=this.proxy,a=Ee(e)?e.includes(".")?If(n,e):()=>n[e]:e.bind(n,n);let i;we(t)?i=t:(i=t.handler,s=t);const l=Ra(this),r=Ti(a,i.bind(n),s);return l(),r}function If(e,t){const s=t.split(".");return()=>{let n=e;for(let a=0;a<s.length&&n;a++)n=n[s[a]];return n}}const cn=new WeakMap,Nf=Symbol("_vte"),Of=e=>e.__isTeleport,Cn=e=>e&&(e.disabled||e.disabled===""),Ym=e=>e&&(e.defer||e.defer===""),eu=e=>typeof SVGElement<"u"&&e instanceof SVGElement,tu=e=>typeof MathMLElement=="function"&&e instanceof MathMLElement,qr=(e,t)=>{const s=e&&e.to;return Ee(s)?t?t(s):null:s},Qm={name:"Teleport",__isTeleport:!0,process(e,t,s,n,a,i,l,r,o,c){const{mc:u,pc:d,pbc:f,o:{insert:p,querySelector:m,createText:g,createComment:k,parentNode:w}}=c,b=Cn(t.props);let{dynamicChildren:v}=t;const x=(O,T,R)=>{O.shapeFlag&16&&u(O.children,T,R,a,i,l,r,o)},S=(O=t)=>{const T=Cn(O.props),R=O.target=qr(O.props,m),L=Gr(R,O,g,p);R&&(l!=="svg"&&eu(R)?l="svg":l!=="mathml"&&tu(R)&&(l="mathml"),a&&a.isCE&&(a.ce._teleportTargets||(a.ce._teleportTargets=new Set)).add(R),T||(x(O,R,L),ja(O,!1)))},N=O=>{const T=()=>{if(cn.get(O)===T){if(cn.delete(O),Cn(O.props)){const R=w(O.el)||s;x(O,R,O.anchor),ja(O,!0)}S(O)}};cn.set(O,T),ht(T,i)};if(e==null){const O=t.el=g(""),T=t.anchor=g("");if(p(O,s,n),p(T,s,n),Ym(t.props)||i&&i.pendingBranch){N(t);return}b&&(x(t,s,T),ja(t,!0)),S()}else{t.el=e.el;const O=t.anchor=e.anchor,T=cn.get(e);if(T){T.flags|=8,cn.delete(e),N(t);return}t.targetStart=e.targetStart;const R=t.target=e.target,L=t.targetAnchor=e.targetAnchor,B=Cn(e.props),P=B?s:R,C=B?O:L;if(l==="svg"||eu(R)?l="svg":(l==="mathml"||tu(R))&&(l="mathml"),v?(f(e.dynamicChildren,v,P,a,i,l,r),Wo(e,t,!0)):o||d(e,t,P,C,a,i,l,r,!1),b)B?t.props&&e.props&&t.props.to!==e.props.to&&(t.props.to=e.props.to):Vi(t,s,O,c,1);else if((t.props&&t.props.to)!==(e.props&&e.props.to)){const $=t.target=qr(t.props,m);$&&Vi(t,$,null,c,0)}else B&&Vi(t,R,L,c,1);ja(t,b)}},remove(e,t,s,{um:n,o:{remove:a}},i){const{shapeFlag:l,children:r,anchor:o,targetStart:c,targetAnchor:u,target:d,props:f}=e,p=i||!Cn(f),m=cn.get(e);if(m&&(m.flags|=8,cn.delete(e)),d&&(a(c),a(u)),i&&a(o),!m&&l&16)for(let g=0;g<r.length;g++){const k=r[g];n(k,t,s,p,!!k.dynamicChildren)}},move:Vi,hydrate:Xm};function Vi(e,t,s,{o:{insert:n},m:a},i=2){i===0&&n(e.targetAnchor,t,s);const{el:l,anchor:r,shapeFlag:o,children:c,props:u}=e,d=i===2;if(d&&n(l,t,s),!cn.has(e)&&(!d||Cn(u))&&o&16)for(let f=0;f<c.length;f++)a(c[f],t,s,2);d&&n(r,t,s)}function Xm(e,t,s,n,a,i,{o:{nextSibling:l,parentNode:r,querySelector:o,insert:c,createText:u}},d){function f(k,w){let b=w;for(;b;){if(b&&b.nodeType===8){if(b.data==="teleport start anchor")t.targetStart=b;else if(b.data==="teleport anchor"){t.targetAnchor=b,k._lpa=t.targetAnchor&&l(t.targetAnchor);break}}b=l(b)}}function p(k,w){w.anchor=d(l(k),w,r(k),s,n,a,i)}const m=t.target=qr(t.props,o),g=Cn(t.props);if(m){const k=m._lpa||m.firstChild;t.shapeFlag&16&&(g?(p(e,t),f(m,k),t.targetAnchor||Gr(m,t,u,c,r(e)===m?e:null)):(t.anchor=l(e),f(m,k),t.targetAnchor||Gr(m,t,u,c),d(k&&l(k),t,m,s,n,a,i))),ja(t,g)}else g&&t.shapeFlag&16&&(p(e,t),t.targetStart=e,t.targetAnchor=l(e));return t.anchor&&l(t.anchor)}const ev=Qm;function ja(e,t){const s=e.ctx;if(s&&s.ut){let n,a;for(t?(n=e.el,a=e.anchor):(n=e.targetStart,a=e.targetAnchor);n&&n!==a;)n.nodeType===1&&n.setAttribute("data-v-owner",s.uid),n=n.nextSibling;s.ut()}}function Gr(e,t,s,n,a=null){const i=t.targetStart=s(""),l=t.targetAnchor=s("");return i[Nf]=l,e&&(n(i,e,a),n(l,e,a)),l}const os=Symbol("_leaveCb"),Ma=Symbol("_enterCb");function Po(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ue(()=>{e.isMounted=!0}),Yl(()=>{e.isUnmounting=!0}),e}const rs=[Function,Array],Fo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:rs,onEnter:rs,onAfterEnter:rs,onEnterCancelled:rs,onBeforeLeave:rs,onLeave:rs,onAfterLeave:rs,onLeaveCancelled:rs,onBeforeAppear:rs,onAppear:rs,onAfterAppear:rs,onAppearCancelled:rs},Lf=e=>{const t=e.subTree;return t.component?Lf(t.component):t},tv={name:"BaseTransition",props:Fo,setup(e,{slots:t}){const s=Kt(),n=Po();return()=>{const a=t.default&&Wl(t.default(),!0),i=a&&a.length?Df(a):s.subTree?mp():void 0;if(!i)return;const l=$e(e),{mode:r}=l;if(n.isLeaving)return yr(i);const o=su(i);if(!o)return yr(i);let c=ma(o,l,n,s,d=>c=d);o.type!==dt&&Xs(o,c);let u=s.subTree&&su(s.subTree);if(u&&u.type!==dt&&!vs(u,o)&&Lf(s).type!==dt){let d=ma(u,l,n,s);if(Xs(u,d),r==="out-in"&&o.type!==dt)return n.isLeaving=!0,d.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete d.afterLeave,u=void 0},yr(i);r==="in-out"&&o.type!==dt?d.delayLeave=(f,p,m)=>{const g=Pf(n,u);g[String(u.key)]=u,f[os]=()=>{p(),f[os]=void 0,delete c.delayedLeave,u=void 0},c.delayedLeave=()=>{m(),delete c.delayedLeave,u=void 0}}:u=void 0}else u&&(u=void 0);return i}}};function Df(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==dt){t=s;break}}return t}const Mf=tv;function Pf(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function ma(e,t,s,n,a){const{appear:i,mode:l,persisted:r=!1,onBeforeEnter:o,onEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:f,onLeave:p,onAfterLeave:m,onLeaveCancelled:g,onBeforeAppear:k,onAppear:w,onAfterAppear:b,onAppearCancelled:v}=t,x=String(e.key),S=Pf(s,e),N=(R,L)=>{R&&ns(R,n,9,L)},O=(R,L)=>{const B=L[1];N(R,L),pe(R)?R.every(P=>P.length<=1)&&B():R.length<=1&&B()},T={mode:l,persisted:r,beforeEnter(R){let L=o;if(!s.isMounted)if(i)L=k||o;else return;R[os]&&R[os](!0);const B=S[x];B&&vs(e,B)&&B.el[os]&&B.el[os](),N(L,[R])},enter(R){if(S[x]===e)return;let L=c,B=u,P=d;if(!s.isMounted)if(i)L=w||c,B=b||u,P=v||d;else return;let C=!1;R[Ma]=W=>{C||(C=!0,W?N(P,[R]):N(B,[R]),T.delayedLeave&&T.delayedLeave(),R[Ma]=void 0)};const $=R[Ma].bind(null,!1);L?O(L,[R,$]):$()},leave(R,L){const B=String(e.key);if(R[Ma]&&R[Ma](!0),s.isUnmounting)return L();N(f,[R]);let P=!1;R[os]=$=>{P||(P=!0,L(),$?N(g,[R]):N(m,[R]),R[os]=void 0,S[B]===e&&delete S[B])};const C=R[os].bind(null,!1);S[B]=e,p?O(p,[R,C]):C()},clone(R){const L=ma(R,t,s,n,a);return a&&a(L),L}};return T}function yr(e){if(Ei(e))return e=Ns(e),e.children=null,e}function su(e){if(!Ei(e))return Of(e.type)&&e.children?Df(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&we(s.default))return s.default()}}function Xs(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Xs(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Wl(e,t=!1,s){let n=[],a=0;for(let i=0;i<e.length;i++){let l=e[i];const r=s==null?l.key:String(s)+String(l.key!=null?l.key:i);l.type===Ct?(l.patchFlag&128&&a++,n=n.concat(Wl(l.children,t,r))):(t||l.type!==dt)&&n.push(r!=null?Ns(l,{key:r}):l)}if(a>1)for(let i=0;i<n.length;i++)n[i].patchFlag=-2;return n}function Ci(e,t){return we(e)?De({name:e.name},t,{setup:e}):e}function sv(){const e=Kt();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function $o(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function nv(e){const t=Kt(),s=Oo(null);if(t){const a=t.refs===Pe?t.refs={}:t.refs;Object.defineProperty(a,e,{enumerable:!0,get:()=>s.value,set:i=>s.value=i})}return s}function nu(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const fl=new WeakMap;function da(e,t,s,n,a=!1){if(pe(e)){e.forEach((g,k)=>da(g,t&&(pe(t)?t[k]:t),s,n,a));return}if(Ws(n)&&!a){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&da(e,t,s,n.component.subTree);return}const i=n.shapeFlag&4?Ai(n.component):n.el,l=a?null:i,{i:r,r:o}=e,c=t&&t.r,u=r.refs===Pe?r.refs={}:r.refs,d=r.setupState,f=$e(d),p=d===Pe?aa:g=>nu(u,g)?!1:je(f,g),m=(g,k)=>!(k&&nu(u,k));if(c!=null&&c!==o){if(au(t),Ee(c))u[c]=null,p(c)&&(d[c]=null);else if(mt(c)){const g=t;m(c,g.k)&&(c.value=null),g.k&&(u[g.k]=null)}}if(we(o))Aa(o,r,12,[l,u]);else{const g=Ee(o),k=mt(o);if(g||k){const w=()=>{if(e.f){const b=g?p(o)?d[o]:u[o]:m()||!e.k?o.value:u[e.k];if(a)pe(b)&&To(b,i);else if(pe(b))b.includes(i)||b.push(i);else if(g)u[o]=[i],p(o)&&(d[o]=u[o]);else{const v=[i];m(o,e.k)&&(o.value=v),e.k&&(u[e.k]=v)}}else g?(u[o]=l,p(o)&&(d[o]=l)):k&&(m(o,e.k)&&(o.value=l),e.k&&(u[e.k]=l))};if(l){const b=()=>{w(),fl.delete(e)};b.id=-1,fl.set(e,b),ht(b,s)}else au(e),w()}}}function au(e){const t=fl.get(e);t&&(t.flags|=8,fl.delete(e))}let iu=!1;const Jn=()=>{iu||(console.error("Hydration completed but contains mismatches."),iu=!0)},av=e=>e.namespaceURI.includes("svg")&&e.tagName!=="foreignObject",iv=e=>e.namespaceURI.includes("MathML"),ji=e=>{if(e.nodeType===1){if(av(e))return"svg";if(iv(e))return"mathml"}},ia=e=>e.nodeType===8;function lv(e){const{mt:t,p:s,o:{patchProp:n,createText:a,nextSibling:i,parentNode:l,remove:r,insert:o,createComment:c}}=e,u=(v,x)=>{if(!x.hasChildNodes()){s(null,v,x),dl(),x._vnode=v;return}d(x.firstChild,v,null,null,null),dl(),x._vnode=v},d=(v,x,S,N,O,T=!1)=>{T=T||!!x.dynamicChildren;const R=ia(v)&&v.data==="[",L=()=>g(v,x,S,N,O,R),{type:B,ref:P,shapeFlag:C,patchFlag:$}=x;let W=v.nodeType;x.el=v,$===-2&&(T=!1,x.dynamicChildren=null);let G=null;switch(B){case gn:W!==3?x.children===""?(o(x.el=a(""),l(v),v),G=v):G=L():(v.data!==x.children&&(Jn(),v.data=x.children),G=i(v));break;case dt:b(v)?(G=i(v),w(x.el=v.content.firstChild,v,S)):W!==8||R?G=L():G=i(v);break;case On:if(R&&(v=i(v),W=v.nodeType),W===1||W===3){G=v;const D=!x.children.length;for(let I=0;I<x.staticCount;I++)D&&(x.children+=G.nodeType===1?G.outerHTML:G.data),I===x.staticCount-1&&(x.anchor=G),G=i(G);return R?i(G):G}else L();break;case Ct:R?G=m(v,x,S,N,O,T):G=L();break;default:if(C&1)(W!==1||x.type.toLowerCase()!==v.tagName.toLowerCase())&&!b(v)?G=L():G=f(v,x,S,N,O,T);else if(C&6){x.slotScopeIds=O;const D=l(v);if(R?G=k(v):ia(v)&&v.data==="teleport start"?G=k(v,v.data,"teleport end"):G=i(v),t(x,D,null,S,N,ji(D),T),Ws(x)&&!x.type.__asyncResolved){let I;R?(I=at(Ct),I.anchor=G?G.previousSibling:D.lastChild):I=v.nodeType===3?Jo(""):at("div"),I.el=v,x.component.subTree=I}}else C&64?W!==8?G=L():G=x.type.hydrate(v,x,S,N,O,T,e,p):C&128&&(G=x.type.hydrate(v,x,S,N,ji(l(v)),O,T,e,d))}return P!=null&&da(P,null,N,x),G},f=(v,x,S,N,O,T)=>{T=T||!!x.dynamicChildren;const{type:R,props:L,patchFlag:B,shapeFlag:P,dirs:C,transition:$}=x,W=R==="input"||R==="option";if(W||B!==-1){C&&Es(x,null,S,"created");let G=!1;if(b(v)){G=rp(null,$)&&S&&S.vnode.props&&S.vnode.props.appear;const I=v.content.firstChild;if(G){const K=I.getAttribute("class");K&&(I.$cls=K),$.beforeEnter(I)}w(I,v,S),x.el=v=I}if(P&16&&!(L&&(L.innerHTML||L.textContent))){let I=p(v.firstChild,x,v,S,N,O,T);for(I&&!zi(v,1)&&Jn();I;){const K=I;I=I.nextSibling,r(K)}}else if(P&8){let I=x.children;I[0]===`
`&&(v.tagName==="PRE"||v.tagName==="TEXTAREA")&&(I=I.slice(1));const{textContent:K}=v;K!==I&&K!==I.replace(/\r\n|\r/g,`
`)&&(zi(v,0)||Jn(),v.textContent=x.children)}if(L){if(W||!T||B&48){const I=v.tagName.includes("-");for(const K in L)(W&&(K.endsWith("value")||K==="indeterminate")||Bn(K)&&!qs(K)||K[0]==="."||I&&!qs(K))&&n(v,K,null,L[K],void 0,S)}else if(L.onClick)n(v,"onClick",null,L.onClick,void 0,S);else if(B&4&&Gs(L.style))for(const I in L.style)L.style[I]}let D;(D=L&&L.onVnodeBeforeMount)&&Zt(D,S,x),C&&Es(x,null,S,"beforeMount"),((D=L&&L.onVnodeMounted)||C||G)&&dp(()=>{D&&Zt(D,S,x),G&&$.enter(v),C&&Es(x,null,S,"mounted")},N)}return v.nextSibling},p=(v,x,S,N,O,T,R)=>{R=R||!!x.dynamicChildren;const L=x.children,B=L.length;let P=!1;for(let C=0;C<B;C++){const $=R?L[C]:L[C]=Yt(L[C]),W=$.type===gn;v?(W&&!R&&C+1<B&&Yt(L[C+1]).type===gn&&(o(a(v.data.slice($.children.length)),S,i(v)),v.data=$.children),v=d(v,$,N,O,T,R)):W&&!$.children?o($.el=a(""),S):(P||(P=!0,zi(S,1)||Jn()),s(null,$,S,null,N,O,ji(S),T))}return v},m=(v,x,S,N,O,T)=>{const{slotScopeIds:R}=x;R&&(O=O?O.concat(R):R);const L=l(v),B=p(i(v),x,L,S,N,O,T);return B&&ia(B)&&B.data==="]"?i(x.anchor=B):(Jn(),o(x.anchor=c("]"),L,B),B)},g=(v,x,S,N,O,T)=>{if(zi(v.parentElement,1)||Jn(),x.el=null,T){const B=k(v);for(;;){const P=i(v);if(P&&P!==B)r(P);else break}}const R=i(v),L=l(v);return r(v),s(null,x,L,R,S,N,ji(L),O),S&&(S.vnode.el=x.el,Xl(S,x.el)),R},k=(v,x="[",S="]")=>{let N=0;for(;v;)if(v=i(v),v&&ia(v)&&(v.data===x&&N++,v.data===S)){if(N===0)return i(v);N--}return v},w=(v,x,S)=>{const N=x.parentNode;N&&N.replaceChild(v,x);let O=S;for(;O;)O.vnode.el===x&&(O.vnode.el=O.subTree.el=v),O=O.parent},b=v=>v.nodeType===1&&v.tagName==="TEMPLATE";return[u,d]}const lu="data-allow-mismatch",rv={0:"text",1:"children",2:"class",3:"style",4:"attribute"};function zi(e,t){if(t===0||t===1)for(;e&&!e.hasAttribute(lu);)e=e.parentElement;const s=e&&e.getAttribute(lu);if(s==null)return!1;if(s==="")return!0;{const n=s.split(",");return t===0&&n.includes("children")?!0:n.includes(rv[t])}}const ov=Hl().requestIdleCallback||(e=>setTimeout(e,1)),cv=Hl().cancelIdleCallback||(e=>clearTimeout(e)),uv=(e=1e4)=>t=>{const s=ov(t,{timeout:e});return()=>cv(s)};function dv(e){const{top:t,left:s,bottom:n,right:a}=e.getBoundingClientRect(),{innerHeight:i,innerWidth:l}=window;return(t>0&&t<i||n>0&&n<i)&&(s>0&&s<l||a>0&&a<l)}const fv=e=>(t,s)=>{const n=new IntersectionObserver(a=>{for(const i of a)if(i.isIntersecting){n.disconnect(),t();break}},e);return s(a=>{if(a instanceof Element){if(dv(a))return t(),n.disconnect(),!1;n.observe(a)}}),()=>n.disconnect()},pv=e=>t=>{if(e){const s=matchMedia(e);if(s.matches)t();else return s.addEventListener("change",t,{once:!0}),()=>s.removeEventListener("change",t)}},hv=(e=[])=>(t,s)=>{Ee(e)&&(e=[e]);let n=!1;const a=l=>{n||(n=!0,i(),t(),l.target.dispatchEvent(new l.constructor(l.type,l)))},i=()=>{s(l=>{for(const r of e)l.removeEventListener(r,a)})};return s(l=>{for(const r of e)l.addEventListener(r,a,{once:!0})}),i};function gv(e,t){if(ia(e)&&e.data==="["){let s=1,n=e.nextSibling;for(;n;){if(n.nodeType===1){if(t(n)===!1)break}else if(ia(n))if(n.data==="]"){if(--s===0)break}else n.data==="["&&s++;n=n.nextSibling}}else t(e)}const Ws=e=>!!e.type.__asyncLoader;function mv(e){we(e)&&(e={loader:e});const{loader:t,loadingComponent:s,errorComponent:n,delay:a=200,hydrate:i,timeout:l,suspensible:r=!0,onError:o}=e;let c=null,u,d=0;const f=()=>(d++,c=null,p()),p=()=>{let m;return c||(m=c=t().catch(g=>{if(g=g instanceof Error?g:new Error(String(g)),o)return new Promise((k,w)=>{o(g,()=>k(f()),()=>w(g),d+1)});throw g}).then(g=>m!==c&&c?c:(g&&(g.__esModule||g[Symbol.toStringTag]==="Module")&&(g=g.default),u=g,g)))};return Ci({name:"AsyncComponentWrapper",__asyncLoader:p,__asyncHydrate(m,g,k){let w=!1;(g.bu||(g.bu=[])).push(()=>w=!0);const b=()=>{w||k()},v=i?()=>{const x=i(b,S=>gv(m,S));x&&(g.bum||(g.bum=[])).push(x)}:b;u?v():p().then(()=>!g.isUnmounted&&v())},get __asyncResolved(){return u},setup(){const m=Rt;if($o(m),u)return()=>Ki(u,m);const g=S=>{c=null,jn(S,m,13,!n)};if(r&&m.suspense||Fn)return p().then(S=>()=>Ki(S,m)).catch(S=>(g(S),()=>n?at(n,{error:S}):null));const k=h(!1),w=h(),b=h(!!a);let v,x;return ft(()=>{v!=null&&clearTimeout(v),x!=null&&clearTimeout(x)}),a&&(x=setTimeout(()=>{m.isUnmounted||(b.value=!1)},a)),l!=null&&(v=setTimeout(()=>{if(!m.isUnmounted&&!k.value&&!w.value){const S=new Error(`Async component timed out after ${l}ms.`);g(S),w.value=S}},l)),p().then(()=>{m.isUnmounted||(k.value=!0,m.parent&&Ei(m.parent.vnode)&&m.parent.update())}).catch(S=>{if(m.isUnmounted){c=null;return}g(S),w.value=S}),()=>{if(k.value&&u)return Ki(u,m);if(w.value&&n)return at(n,{error:w.value});if(s&&!b.value)return Ki(s,m)}}})}function Ki(e,t){const{ref:s,props:n,children:a,ce:i}=t.vnode,l=at(e,n,a);return l.ref=s,l.ce=i,delete t.vnode.ce,l}const Ei=e=>e.type.__isKeepAlive,vv={name:"KeepAlive",__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){const s=Kt(),n=s.ctx;if(!n.renderer)return()=>{const b=t.default&&t.default();return b&&b.length===1?b[0]:b};const a=new Map,i=new Set;let l=null;const r=s.suspense,{renderer:{p:o,m:c,um:u,o:{createElement:d}}}=n,f=d("div");n.activate=(b,v,x,S,N)=>{const O=b.component;c(b,v,x,0,r),o(O.vnode,b,v,x,O,r,S,b.slotScopeIds,N),ht(()=>{O.isDeactivated=!1,O.a&&ca(O.a);const T=b.props&&b.props.onVnodeMounted;T&&Zt(T,O.parent,b)},r)},n.deactivate=b=>{const v=b.component;hl(v.m),hl(v.a),c(b,f,null,1,r),ht(()=>{v.da&&ca(v.da);const x=b.props&&b.props.onVnodeUnmounted;x&&Zt(x,v.parent,b),v.isDeactivated=!0},r)};function p(b){xr(b),u(b,s,r,!0)}function m(b){a.forEach((v,x)=>{const S=so(Ws(v)?v.type.__asyncResolved||{}:v.type);S&&!b(S)&&g(x)})}function g(b){const v=a.get(b);v&&(!l||!vs(v,l))?p(v):l&&xr(l),a.delete(b),i.delete(b)}fs(()=>[e.include,e.exclude],([b,v])=>{b&&m(x=>za(b,x)),v&&m(x=>!za(v,x))},{flush:"post",deep:!0});let k=null;const w=()=>{k!=null&&(gl(s.subTree.type)?ht(()=>{a.set(k,qi(s.subTree))},s.subTree.suspense):a.set(k,qi(s.subTree)))};return Ue(w),Jl(w),Yl(()=>{a.forEach(b=>{const{subTree:v,suspense:x}=s,S=qi(v);if(b.type===S.type&&b.key===S.key){xr(S);const N=S.component.da;N&&ht(N,x);return}p(b)})}),()=>{if(k=null,!t.default)return l=null;const b=t.default(),v=b[0];if(b.length>1)return l=null,b;if(!en(v)||!(v.shapeFlag&4)&&!(v.shapeFlag&128))return l=null,v;let x=qi(v);if(x.type===dt)return l=null,x;const S=x.type,N=so(Ws(x)?x.type.__asyncResolved||{}:S),{include:O,exclude:T,max:R}=e;if(O&&(!N||!za(O,N))||T&&N&&za(T,N))return x.shapeFlag&=-257,l=x,v;const L=x.key==null?S:x.key,B=a.get(L);return x.el&&(x=Ns(x),v.shapeFlag&128&&(v.ssContent=x)),k=L,B?(x.el=B.el,x.component=B.component,x.transition&&Xs(x,x.transition),x.shapeFlag|=512,i.delete(L),i.add(L)):(i.add(L),R&&i.size>parseInt(R,10)&&g(i.values().next().value)),x.shapeFlag|=256,l=x,gl(v.type)?v:x}}},bv=vv;function za(e,t){return pe(e)?e.some(s=>za(s,t)):Ee(e)?e.split(",").includes(t):Ag(e)?(e.lastIndex=0,e.test(t)):!1}function Uo(e,t){Ff(e,"a",t)}function Bo(e,t){Ff(e,"da",t)}function Ff(e,t,s=Rt){const n=e.__wdc||(e.__wdc=()=>{let a=s;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if(Zl(t,n,s),s){let a=s.parent;for(;a&&a.parent;)Ei(a.parent.vnode)&&yv(n,t,s,a),a=a.parent}}function yv(e,t,s,n){const a=Zl(t,e,n,!0);ft(()=>{To(n[t],a)},s)}function xr(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function qi(e){return e.shapeFlag&128?e.ssContent:e}function Zl(e,t,s=Rt,n=!1){if(s){const a=s[e]||(s[e]=[]),i=t.__weh||(t.__weh=(...l)=>{Ys();const r=Ra(s),o=ns(t,s,e,l);return r(),Qs(),o});return n?a.unshift(i):a.push(i),i}}const tn=e=>(t,s=Rt)=>{(!Fn||e==="sp")&&Zl(e,(...n)=>t(...n),s)},$f=tn("bm"),Ue=tn("m"),Ho=tn("bu"),Jl=tn("u"),Yl=tn("bum"),ft=tn("um"),Uf=tn("sp"),Bf=tn("rtg"),Hf=tn("rtc");function Vf(e,t=Rt){Zl("ec",e,t)}const Vo="components",xv="directives";function _v(e,t){return jo(Vo,e,!0,t)||e}const jf=Symbol.for("v-ndc");function kv(e){return Ee(e)?jo(Vo,e,!1)||e:e||jf}function wv(e){return jo(xv,e)}function jo(e,t,s=!0,n=!1){const a=It||Rt;if(a){const i=a.type;if(e===Vo){const r=so(i,!1);if(r&&(r===t||r===Ze(t)||r===Vn(Ze(t))))return i}const l=ru(a[e]||i[e],t)||ru(a.appContext[e],t);return!l&&n?i:l}}function ru(e,t){return e&&(e[t]||e[Ze(t)]||e[Vn(Ze(t))])}function Sv(e,t,s,n){let a;const i=s&&s[n],l=pe(e);if(l||Ee(e)){const r=l&&Gs(e);let o=!1,c=!1;r&&(o=!es(e),c=Is(e),e=zl(e)),a=new Array(e.length);for(let u=0,d=e.length;u<d;u++)a[u]=t(o?c?ga(xs(e[u])):xs(e[u]):e[u],u,void 0,i&&i[u])}else if(typeof e=="number"){a=new Array(e);for(let r=0;r<e;r++)a[r]=t(r+1,r,void 0,i&&i[r])}else if(Ve(e))if(e[Symbol.iterator])a=Array.from(e,(r,o)=>t(r,o,void 0,i&&i[o]));else{const r=Object.keys(e);a=new Array(r.length);for(let o=0,c=r.length;o<c;o++){const u=r[o];a[o]=t(e[u],u,o,i&&i[o])}}else a=[];return s&&(s[n]=a),a}function Tv(e,t){for(let s=0;s<t.length;s++){const n=t[s];if(pe(n))for(let a=0;a<n.length;a++)e[n[a].name]=n[a].fn;else n&&(e[n.name]=n.key?(...a)=>{const i=n.fn(...a);return i&&(i.key=n.key),i}:n.fn)}return e}function Cv(e,t,s={},n,a){if(It.ce||It.parent&&Ws(It.parent)&&It.parent.ce){const c=Object.keys(s).length>0;return t!=="default"&&(s.name=t),fi(),ml(Ct,null,[at("slot",s,n&&n())],c?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),fi();const l=i&&zo(i(s)),r=s.key||l&&l.key,o=ml(Ct,{key:(r&&!Ut(r)?r:`_${t}`)+(!l&&n?"_fb":"")},l||(n?n():[]),l&&e._===1?64:-2);return!a&&o.scopeId&&(o.slotScopeIds=[o.scopeId+"-s"]),i&&i._c&&(i._d=!0),o}function zo(e){return e.some(t=>en(t)?!(t.type===dt||t.type===Ct&&!zo(t.children)):!0)?e:null}function Ev(e,t){const s={};for(const n in e)s[t&&/[A-Z]/.test(n)?`on:${n}`:oa(n)]=e[n];return s}const Wr=e=>e?yp(e)?Ai(e):Wr(e.parent):null,Ya=De(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Wr(e.parent),$root:e=>Wr(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Ko(e),$forceUpdate:e=>e.f||(e.f=()=>{Do(e.update)}),$nextTick:e=>e.n||(e.n=Tt.bind(e.proxy)),$watch:e=>Jm.bind(e)}),_r=(e,t)=>e!==Pe&&!e.__isScriptSetup&&je(e,t),Zr={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:a,props:i,accessCache:l,type:r,appContext:o}=e;if(t[0]!=="$"){const f=l[t];if(f!==void 0)switch(f){case 1:return n[t];case 2:return a[t];case 4:return s[t];case 3:return i[t]}else{if(_r(n,t))return l[t]=1,n[t];if(a!==Pe&&je(a,t))return l[t]=2,a[t];if(je(i,t))return l[t]=3,i[t];if(s!==Pe&&je(s,t))return l[t]=4,s[t];Jr&&(l[t]=0)}}const c=Ya[t];let u,d;if(c)return t==="$attrs"&&Pt(e.attrs,"get",""),c(e);if((u=r.__cssModules)&&(u=u[t]))return u;if(s!==Pe&&je(s,t))return l[t]=4,s[t];if(d=o.config.globalProperties,je(d,t))return d[t]},set({_:e},t,s){const{data:n,setupState:a,ctx:i}=e;return _r(a,t)?(a[t]=s,!0):n!==Pe&&je(n,t)?(n[t]=s,!0):je(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:a,props:i,type:l}},r){let o;return!!(s[r]||e!==Pe&&r[0]!=="$"&&je(e,r)||_r(t,r)||je(i,r)||je(n,r)||je(Ya,r)||je(a.config.globalProperties,r)||(o=l.__cssModules)&&o[r])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:je(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}},Av=De({},Zr,{get(e,t){if(t!==Symbol.unscopables)return Zr.get(e,t,e)},has(e,t){return t[0]!=="_"&&!Mg(t)}});function Rv(){return null}function Iv(){return null}function Nv(e){}function Ov(e){}function Lv(){return null}function Dv(){}function Mv(e,t){return null}function Pv(){return zf().slots}function Fv(){return zf().attrs}function zf(e){const t=Kt();return t.setupContext||(t.setupContext=wp(t))}function ui(e){return pe(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}function $v(e,t){const s=ui(e);for(const n in t){if(n.startsWith("__skip"))continue;let a=s[n];a?pe(a)||we(a)?a=s[n]={type:a,default:t[n]}:a.default=t[n]:a===null&&(a=s[n]={default:t[n]}),a&&t[`__skip_${n}`]&&(a.skipFactory=!0)}return s}function Uv(e,t){return!e||!t?e||t:pe(e)&&pe(t)?e.concat(t):De({},ui(e),ui(t))}function Bv(e,t){const s={};for(const n in e)t.includes(n)||Object.defineProperty(s,n,{enumerable:!0,get:()=>e[n]});return s}function Hv(e){const t=Kt(),s=Fn;let n=e();hi(),s&&pa(!1);const a=()=>{Ra(t),s&&pa(!0)},i=()=>{Kt()!==t&&t.scope.off(),hi(),s&&pa(!1)};return Co(n)&&(n=n.catch(l=>{throw a(),Promise.resolve().then(()=>Promise.resolve().then(i)),l})),[n,()=>{a(),Promise.resolve().then(i)}]}let Jr=!0;function Vv(e){const t=Ko(e),s=e.proxy,n=e.ctx;Jr=!1,t.beforeCreate&&ou(t.beforeCreate,e,"bc");const{data:a,computed:i,methods:l,watch:r,provide:o,inject:c,created:u,beforeMount:d,mounted:f,beforeUpdate:p,updated:m,activated:g,deactivated:k,beforeDestroy:w,beforeUnmount:b,destroyed:v,unmounted:x,render:S,renderTracked:N,renderTriggered:O,errorCaptured:T,serverPrefetch:R,expose:L,inheritAttrs:B,components:P,directives:C,filters:$}=t;if(c&&jv(c,n,null),l)for(const D in l){const I=l[D];we(I)&&(n[D]=I.bind(s))}if(a){const D=a.call(s,s);Ve(D)&&(e.data=bn(D))}if(Jr=!0,i)for(const D in i){const I=i[D],K=we(I)?I.bind(s,s):we(I.get)?I.get.bind(s,s):Nt,de=!we(I)&&we(I.set)?I.set.bind(s):Nt,re=te({get:K,set:de});Object.defineProperty(n,D,{enumerable:!0,configurable:!0,get:()=>re.value,set:Z=>re.value=Z})}if(r)for(const D in r)Kf(r[D],n,s,D);if(o){const D=we(o)?o.call(s):o;Reflect.ownKeys(D).forEach(I=>{Ja(I,D[I])})}u&&ou(u,e,"c");function G(D,I){pe(I)?I.forEach(K=>D(K.bind(s))):I&&D(I.bind(s))}if(G($f,d),G(Ue,f),G(Ho,p),G(Jl,m),G(Uo,g),G(Bo,k),G(Vf,T),G(Hf,N),G(Bf,O),G(Yl,b),G(ft,x),G(Uf,R),pe(L))if(L.length){const D=e.exposed||(e.exposed={});L.forEach(I=>{Object.defineProperty(D,I,{get:()=>s[I],set:K=>s[I]=K,enumerable:!0})})}else e.exposed||(e.exposed={});S&&e.render===Nt&&(e.render=S),B!=null&&(e.inheritAttrs=B),P&&(e.components=P),C&&(e.directives=C),R&&$o(e)}function jv(e,t,s=Nt){pe(e)&&(e=Yr(e));for(const n in e){const a=e[n];let i;Ve(a)?"default"in a?i=ds(a.from||n,a.default,!0):i=ds(a.from||n):i=ds(a),mt(i)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):t[n]=i}}function ou(e,t,s){ns(pe(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function Kf(e,t,s,n){let a=n.includes(".")?If(s,n):()=>s[n];if(Ee(e)){const i=t[e];we(i)&&fs(a,i)}else if(we(e))fs(a,e.bind(s));else if(Ve(e))if(pe(e))e.forEach(i=>Kf(i,t,s,n));else{const i=we(e.handler)?e.handler.bind(s):t[e.handler];we(i)&&fs(a,i,e)}}function Ko(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:a,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,r=i.get(t);let o;return r?o=r:!a.length&&!s&&!n?o=t:(o={},a.length&&a.forEach(c=>pl(o,c,l,!0)),pl(o,t,l)),Ve(t)&&i.set(t,o),o}function pl(e,t,s,n=!1){const{mixins:a,extends:i}=t;i&&pl(e,i,s,!0),a&&a.forEach(l=>pl(e,l,s,!0));for(const l in t)if(!(n&&l==="expose")){const r=zv[l]||s&&s[l];e[l]=r?r(e[l],t[l]):t[l]}return e}const zv={data:cu,props:uu,emits:uu,methods:Ka,computed:Ka,beforeCreate:Bt,created:Bt,beforeMount:Bt,mounted:Bt,beforeUpdate:Bt,updated:Bt,beforeDestroy:Bt,beforeUnmount:Bt,destroyed:Bt,unmounted:Bt,activated:Bt,deactivated:Bt,errorCaptured:Bt,serverPrefetch:Bt,components:Ka,directives:Ka,watch:qv,provide:cu,inject:Kv};function cu(e,t){return t?e?function(){return De(we(e)?e.call(this,this):e,we(t)?t.call(this,this):t)}:t:e}function Kv(e,t){return Ka(Yr(e),Yr(t))}function Yr(e){if(pe(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Bt(e,t){return e?[...new Set([].concat(e,t))]:t}function Ka(e,t){return e?De(Object.create(null),e,t):t}function uu(e,t){return e?pe(e)&&pe(t)?[...new Set([...e,...t])]:De(Object.create(null),ui(e),ui(t??{})):t}function qv(e,t){if(!e)return t;if(!t)return e;const s=De(Object.create(null),e);for(const n in t)s[n]=Bt(e[n],t[n]);return s}function qf(){return{app:null,config:{isNativeTag:aa,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Gv=0;function Wv(e,t){return function(n,a=null){we(n)||(n=De({},n)),a!=null&&!Ve(a)&&(a=null);const i=qf(),l=new WeakSet,r=[];let o=!1;const c=i.app={_uid:Gv++,_component:n,_props:a,_container:null,_context:i,_instance:null,version:Tp,get config(){return i.config},set config(u){},use(u,...d){return l.has(u)||(u&&we(u.install)?(l.add(u),u.install(c,...d)):we(u)&&(l.add(u),u(c,...d))),c},mixin(u){return i.mixins.includes(u)||i.mixins.push(u),c},component(u,d){return d?(i.components[u]=d,c):i.components[u]},directive(u,d){return d?(i.directives[u]=d,c):i.directives[u]},mount(u,d,f){if(!o){const p=c._ceVNode||at(n,a);return p.appContext=i,f===!0?f="svg":f===!1&&(f=void 0),d&&t?t(p,u):e(p,u,f),o=!0,c._container=u,u.__vue_app__=c,Ai(p.component)}},onUnmount(u){r.push(u)},unmount(){o&&(ns(r,c._instance,16),e(null,c._container),delete c._container.__vue_app__)},provide(u,d){return i.provides[u]=d,c},runWithContext(u){const d=Nn;Nn=c;try{return u()}finally{Nn=d}}};return c}}let Nn=null;function Zv(e,t,s=Pe){const n=Kt(),a=Ze(t),i=Qt(t),l=Gf(e,a),r=yf((o,c)=>{let u,d=Pe,f;return Rf(()=>{const p=e[a];St(u,p)&&(u=p,c())}),{get(){return o(),s.get?s.get(u):u},set(p){const m=s.set?s.set(p):p;if(!St(m,u)&&!(d!==Pe&&St(p,d)))return;const g=n.vnode.props,k=!!(g&&(t in g||a in g||i in g)&&(`onUpdate:${t}`in g||`onUpdate:${a}`in g||`onUpdate:${i}`in g));k||(u=p,c()),n.emit(`update:${t}`,m),St(p,d)&&(St(p,m)&&!St(m,f)||k&&d!==Pe&&!St(m,u))&&c(),d=p,f=m}}});return r[Symbol.iterator]=()=>{let o=0;return{next(){return o<2?{value:o++?l||Pe:r,done:!1}:{done:!0}}}},r}const Gf=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Ze(t)}Modifiers`]||e[`${Qt(t)}Modifiers`];function Jv(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||Pe;let a=s;const i=t.startsWith("update:"),l=i&&Gf(n,t.slice(7));l&&(l.trim&&(a=s.map(u=>Ee(u)?u.trim():u)),l.number&&(a=s.map(Bl)));let r,o=n[r=oa(t)]||n[r=oa(Ze(t))];!o&&i&&(o=n[r=oa(Qt(t))]),o&&ns(o,e,6,a);const c=n[r+"Once"];if(c){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,ns(c,e,6,a)}}const Yv=new WeakMap;function Wf(e,t,s=!1){const n=s?Yv:t.emitsCache,a=n.get(e);if(a!==void 0)return a;const i=e.emits;let l={},r=!1;if(!we(e)){const o=c=>{const u=Wf(c,t,!0);u&&(r=!0,De(l,u))};!s&&t.mixins.length&&t.mixins.forEach(o),e.extends&&o(e.extends),e.mixins&&e.mixins.forEach(o)}return!i&&!r?(Ve(e)&&n.set(e,null),null):(pe(i)?i.forEach(o=>l[o]=null):De(l,i),Ve(e)&&n.set(e,l),l)}function Ql(e,t){return!e||!Bn(t)?!1:(t=t.slice(2).replace(/Once$/,""),je(e,t[0].toLowerCase()+t.slice(1))||je(e,Qt(t))||je(e,t))}function Xi(e){const{type:t,vnode:s,proxy:n,withProxy:a,propsOptions:[i],slots:l,attrs:r,emit:o,render:c,renderCache:u,props:d,data:f,setupState:p,ctx:m,inheritAttrs:g}=e,k=ci(e);let w,b;try{if(s.shapeFlag&4){const x=a||n,S=x;w=Yt(c.call(S,x,u,d,p,f,m)),b=r}else{const x=t;w=Yt(x.length>1?x(d,{attrs:r,slots:l,emit:o}):x(d,null)),b=t.props?r:Xv(r)}}catch(x){Qa.length=0,jn(x,e,1),w=at(dt)}let v=w;if(b&&g!==!1){const x=Object.keys(b),{shapeFlag:S}=v;x.length&&S&7&&(i&&x.some(Pl)&&(b=eb(b,i)),v=Ns(v,b,!1,!0))}return s.dirs&&(v=Ns(v,null,!1,!0),v.dirs=v.dirs?v.dirs.concat(s.dirs):s.dirs),s.transition&&Xs(v,s.transition),w=v,ci(k),w}function Qv(e,t=!0){let s;for(let n=0;n<e.length;n++){const a=e[n];if(en(a)){if(a.type!==dt||a.children==="v-if"){if(s)return;s=a}}else return}return s}const Xv=e=>{let t;for(const s in e)(s==="class"||s==="style"||Bn(s))&&((t||(t={}))[s]=e[s]);return t},eb=(e,t)=>{const s={};for(const n in e)(!Pl(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function tb(e,t,s){const{props:n,children:a,component:i}=e,{props:l,children:r,patchFlag:o}=t,c=i.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&o>=0){if(o&1024)return!0;if(o&16)return n?du(n,l,c):!!l;if(o&8){const u=t.dynamicProps;for(let d=0;d<u.length;d++){const f=u[d];if(Zf(l,n,f)&&!Ql(c,f))return!0}}}else return(a||r)&&(!r||!r.$stable)?!0:n===l?!1:n?l?du(n,l,c):!0:!!l;return!1}function du(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let a=0;a<n.length;a++){const i=n[a];if(Zf(t,e,i)&&!Ql(s,i))return!0}return!1}function Zf(e,t,s){const n=e[s],a=t[s];return s==="style"&&Ve(n)&&Ve(a)?!Js(n,a):n!==a}function Xl({vnode:e,parent:t,suspense:s},n){for(;t;){const a=t.subTree;if(a.suspense&&a.suspense.activeBranch===e&&(a.suspense.vnode.el=a.el=n,e=a),a===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const Jf={},Yf=()=>Object.create(Jf),Qf=e=>Object.getPrototypeOf(e)===Jf;function sb(e,t,s,n=!1){const a={},i=Yf();e.propsDefaults=Object.create(null),Xf(e,t,a,i);for(const l in e.propsOptions[0])l in a||(a[l]=void 0);s?e.props=n?a:No(a):e.type.props?e.props=a:e.props=i,e.attrs=i}function nb(e,t,s,n){const{props:a,attrs:i,vnode:{patchFlag:l}}=e,r=$e(a),[o]=e.propsOptions;let c=!1;if((n||l>0)&&!(l&16)){if(l&8){const u=e.vnode.dynamicProps;for(let d=0;d<u.length;d++){let f=u[d];if(Ql(e.emitsOptions,f))continue;const p=t[f];if(o)if(je(i,f))p!==i[f]&&(i[f]=p,c=!0);else{const m=Ze(f);a[m]=Qr(o,r,m,p,e,!1)}else p!==i[f]&&(i[f]=p,c=!0)}}}else{Xf(e,t,a,i)&&(c=!0);let u;for(const d in r)(!t||!je(t,d)&&((u=Qt(d))===d||!je(t,u)))&&(o?s&&(s[d]!==void 0||s[u]!==void 0)&&(a[d]=Qr(o,r,d,void 0,e,!0)):delete a[d]);if(i!==r)for(const d in i)(!t||!je(t,d))&&(delete i[d],c=!0)}c&&Hs(e.attrs,"set","")}function Xf(e,t,s,n){const[a,i]=e.propsOptions;let l=!1,r;if(t)for(let o in t){if(qs(o))continue;const c=t[o];let u;a&&je(a,u=Ze(o))?!i||!i.includes(u)?s[u]=c:(r||(r={}))[u]=c:Ql(e.emitsOptions,o)||(!(o in n)||c!==n[o])&&(n[o]=c,l=!0)}if(i){const o=$e(s),c=r||Pe;for(let u=0;u<i.length;u++){const d=i[u];s[d]=Qr(a,o,d,c[d],e,!je(c,d))}}return l}function Qr(e,t,s,n,a,i){const l=e[s];if(l!=null){const r=je(l,"default");if(r&&n===void 0){const o=l.default;if(l.type!==Function&&!l.skipFactory&&we(o)){const{propsDefaults:c}=a;if(s in c)n=c[s];else{const u=Ra(a);n=c[s]=o.call(null,t),u()}}else n=o;a.ce&&a.ce._setProp(s,n)}l[0]&&(i&&!r?n=!1:l[1]&&(n===""||n===Qt(s))&&(n=!0))}return n}const ab=new WeakMap;function ep(e,t,s=!1){const n=s?ab:t.propsCache,a=n.get(e);if(a)return a;const i=e.props,l={},r=[];let o=!1;if(!we(e)){const u=d=>{o=!0;const[f,p]=ep(d,t,!0);De(l,f),p&&r.push(...p)};!s&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!i&&!o)return Ve(e)&&n.set(e,la),la;if(pe(i))for(let u=0;u<i.length;u++){const d=Ze(i[u]);fu(d)&&(l[d]=Pe)}else if(i)for(const u in i){const d=Ze(u);if(fu(d)){const f=i[u],p=l[d]=pe(f)||we(f)?{type:f}:De({},f),m=p.type;let g=!1,k=!0;if(pe(m))for(let w=0;w<m.length;++w){const b=m[w],v=we(b)&&b.name;if(v==="Boolean"){g=!0;break}else v==="String"&&(k=!1)}else g=we(m)&&m.name==="Boolean";p[0]=g,p[1]=k,(g||je(p,"default"))&&r.push(d)}}const c=[l,r];return Ve(e)&&n.set(e,c),c}function fu(e){return e[0]!=="$"&&!qs(e)}const qo=e=>e==="_"||e==="_ctx"||e==="$stable",Go=e=>pe(e)?e.map(Yt):[Yt(e)],ib=(e,t,s)=>{if(t._n)return t;const n=Mo((...a)=>Go(t(...a)),s);return n._c=!1,n},tp=(e,t,s)=>{const n=e._ctx;for(const a in e){if(qo(a))continue;const i=e[a];if(we(i))t[a]=ib(a,i,n);else if(i!=null){const l=Go(i);t[a]=()=>l}}},sp=(e,t)=>{const s=Go(t);e.slots.default=()=>s},np=(e,t,s)=>{for(const n in t)(s||!qo(n))&&(e[n]=t[n])},lb=(e,t,s)=>{const n=e.slots=Yf();if(e.vnode.shapeFlag&32){const a=t._;a?(np(n,t,s),s&&Wd(n,"_",a,!0)):tp(t,n)}else t&&sp(e,t)},rb=(e,t,s)=>{const{vnode:n,slots:a}=e;let i=!0,l=Pe;if(n.shapeFlag&32){const r=t._;r?s&&r===1?i=!1:np(a,t,s):(i=!t.$stable,tp(t,a)),l=t}else t&&(sp(e,t),l={default:1});if(i)for(const r in a)!qo(r)&&l[r]==null&&delete a[r]},ht=dp;function ap(e){return lp(e)}function ip(e){return lp(e,lv)}function lp(e,t){const s=Hl();s.__VUE__=!0;const{insert:n,remove:a,patchProp:i,createElement:l,createText:r,createComment:o,setText:c,setElementText:u,parentNode:d,nextSibling:f,setScopeId:p=Nt,insertStaticContent:m}=e,g=(y,E,M,J=null,A=null,F=null,Y=void 0,Q=null,se=!!E.dynamicChildren)=>{if(y===E)return;y&&!vs(y,E)&&(J=V(y),Z(y,A,F,!0),y=null),E.patchFlag===-2&&(se=!1,E.dynamicChildren=null);const{type:ee,ref:ge,shapeFlag:ie}=E;switch(ee){case gn:k(y,E,M,J);break;case dt:w(y,E,M,J);break;case On:y==null&&b(E,M,J,Y);break;case Ct:P(y,E,M,J,A,F,Y,Q,se);break;default:ie&1?S(y,E,M,J,A,F,Y,Q,se):ie&6?C(y,E,M,J,A,F,Y,Q,se):(ie&64||ie&128)&&ee.process(y,E,M,J,A,F,Y,Q,se,ve)}ge!=null&&A?da(ge,y&&y.ref,F,E||y,!E):ge==null&&y&&y.ref!=null&&da(y.ref,null,F,y,!0)},k=(y,E,M,J)=>{if(y==null)n(E.el=r(E.children),M,J);else{const A=E.el=y.el;E.children!==y.children&&c(A,E.children)}},w=(y,E,M,J)=>{y==null?n(E.el=o(E.children||""),M,J):E.el=y.el},b=(y,E,M,J)=>{[y.el,y.anchor]=m(y.children,E,M,J,y.el,y.anchor)},v=({el:y,anchor:E},M,J)=>{let A;for(;y&&y!==E;)A=f(y),n(y,M,J),y=A;n(E,M,J)},x=({el:y,anchor:E})=>{let M;for(;y&&y!==E;)M=f(y),a(y),y=M;a(E)},S=(y,E,M,J,A,F,Y,Q,se)=>{if(E.type==="svg"?Y="svg":E.type==="math"&&(Y="mathml"),y==null)N(E,M,J,A,F,Y,Q,se);else{const ee=y.el&&y.el._isVueCE?y.el:null;try{ee&&ee._beginPatch(),R(y,E,A,F,Y,Q,se)}finally{ee&&ee._endPatch()}}},N=(y,E,M,J,A,F,Y,Q)=>{let se,ee;const{props:ge,shapeFlag:ie,transition:fe,dirs:_e}=y;if(se=y.el=l(y.type,F,ge&&ge.is,ge),ie&8?u(se,y.children):ie&16&&T(y.children,se,null,J,A,kr(y,F),Y,Q),_e&&Es(y,null,J,"created"),O(se,y,y.scopeId,Y,J),ge){for(const Re in ge)Re!=="value"&&!qs(Re)&&i(se,Re,null,ge[Re],F,J);"value"in ge&&i(se,"value",null,ge.value,F),(ee=ge.onVnodeBeforeMount)&&Zt(ee,J,y)}_e&&Es(y,null,J,"beforeMount");const Te=rp(A,fe);Te&&fe.beforeEnter(se),n(se,E,M),((ee=ge&&ge.onVnodeMounted)||Te||_e)&&ht(()=>{try{ee&&Zt(ee,J,y),Te&&fe.enter(se),_e&&Es(y,null,J,"mounted")}finally{}},A)},O=(y,E,M,J,A)=>{if(M&&p(y,M),J)for(let F=0;F<J.length;F++)p(y,J[F]);if(A){let F=A.subTree;if(E===F||gl(F.type)&&(F.ssContent===E||F.ssFallback===E)){const Y=A.vnode;O(y,Y,Y.scopeId,Y.slotScopeIds,A.parent)}}},T=(y,E,M,J,A,F,Y,Q,se=0)=>{for(let ee=se;ee<y.length;ee++){const ge=y[ee]=Q?Us(y[ee]):Yt(y[ee]);g(null,ge,E,M,J,A,F,Y,Q)}},R=(y,E,M,J,A,F,Y)=>{const Q=E.el=y.el;let{patchFlag:se,dynamicChildren:ee,dirs:ge}=E;se|=y.patchFlag&16;const ie=y.props||Pe,fe=E.props||Pe;let _e;if(M&&kn(M,!1),(_e=fe.onVnodeBeforeUpdate)&&Zt(_e,M,E,y),ge&&Es(E,y,M,"beforeUpdate"),M&&kn(M,!0),(ie.innerHTML&&fe.innerHTML==null||ie.textContent&&fe.textContent==null)&&u(Q,""),ee?L(y.dynamicChildren,ee,Q,M,J,kr(E,A),F):Y||I(y,E,Q,null,M,J,kr(E,A),F,!1),se>0){if(se&16)B(Q,ie,fe,M,A);else if(se&2&&ie.class!==fe.class&&i(Q,"class",null,fe.class,A),se&4&&i(Q,"style",ie.style,fe.style,A),se&8){const Te=E.dynamicProps;for(let Re=0;Re<Te.length;Re++){const U=Te[Re],ce=ie[U],xe=fe[U];(xe!==ce||U==="value")&&i(Q,U,ce,xe,A,M)}}se&1&&y.children!==E.children&&u(Q,E.children)}else!Y&&ee==null&&B(Q,ie,fe,M,A);((_e=fe.onVnodeUpdated)||ge)&&ht(()=>{_e&&Zt(_e,M,E,y),ge&&Es(E,y,M,"updated")},J)},L=(y,E,M,J,A,F,Y)=>{for(let Q=0;Q<E.length;Q++){const se=y[Q],ee=E[Q],ge=se.el&&(se.type===Ct||!vs(se,ee)||se.shapeFlag&198)?d(se.el):M;g(se,ee,ge,null,J,A,F,Y,!0)}},B=(y,E,M,J,A)=>{if(E!==M){if(E!==Pe)for(const F in E)!qs(F)&&!(F in M)&&i(y,F,E[F],null,A,J);for(const F in M){if(qs(F))continue;const Y=M[F],Q=E[F];Y!==Q&&F!=="value"&&i(y,F,Q,Y,A,J)}"value"in M&&i(y,"value",E.value,M.value,A)}},P=(y,E,M,J,A,F,Y,Q,se)=>{const ee=E.el=y?y.el:r(""),ge=E.anchor=y?y.anchor:r("");let{patchFlag:ie,dynamicChildren:fe,slotScopeIds:_e}=E;_e&&(Q=Q?Q.concat(_e):_e),y==null?(n(ee,M,J),n(ge,M,J),T(E.children||[],M,ge,A,F,Y,Q,se)):ie>0&&ie&64&&fe&&y.dynamicChildren&&y.dynamicChildren.length===fe.length?(L(y.dynamicChildren,fe,M,A,F,Y,Q),(E.key!=null||A&&E===A.subTree)&&Wo(y,E,!0)):I(y,E,M,ge,A,F,Y,Q,se)},C=(y,E,M,J,A,F,Y,Q,se)=>{E.slotScopeIds=Q,y==null?E.shapeFlag&512?A.ctx.activate(E,M,J,Y,se):$(E,M,J,A,F,Y,se):W(y,E,se)},$=(y,E,M,J,A,F,Y)=>{const Q=y.component=bp(y,J,A);if(Ei(y)&&(Q.ctx.renderer=ve),xp(Q,!1,Y),Q.asyncDep){if(A&&A.registerDep(Q,G,Y),!y.el){const se=Q.subTree=at(dt);w(null,se,E,M),y.placeholder=se.el}}else G(Q,y,E,M,A,F,Y)},W=(y,E,M)=>{const J=E.component=y.component;if(tb(y,E,M))if(J.asyncDep&&!J.asyncResolved){D(J,E,M);return}else J.next=E,J.update();else E.el=y.el,J.vnode=E},G=(y,E,M,J,A,F,Y)=>{const Q=()=>{if(y.isMounted){let{next:ie,bu:fe,u:_e,parent:Te,vnode:Re}=y;{const ye=op(y);if(ye){ie&&(ie.el=Re.el,D(y,ie,Y)),ye.asyncDep.then(()=>{ht(()=>{y.isUnmounted||ee()},A)});return}}let U=ie,ce;kn(y,!1),ie?(ie.el=Re.el,D(y,ie,Y)):ie=Re,fe&&ca(fe),(ce=ie.props&&ie.props.onVnodeBeforeUpdate)&&Zt(ce,Te,ie,Re),kn(y,!0);const xe=Xi(y),j=y.subTree;y.subTree=xe,g(j,xe,d(j.el),V(j),y,A,F),ie.el=xe.el,U===null&&Xl(y,xe.el),_e&&ht(_e,A),(ce=ie.props&&ie.props.onVnodeUpdated)&&ht(()=>Zt(ce,Te,ie,Re),A)}else{let ie;const{el:fe,props:_e}=E,{bm:Te,m:Re,parent:U,root:ce,type:xe}=y,j=Ws(E);if(kn(y,!1),Te&&ca(Te),!j&&(ie=_e&&_e.onVnodeBeforeMount)&&Zt(ie,U,E),kn(y,!0),fe&&Me){const ye=()=>{y.subTree=Xi(y),Me(fe,y.subTree,y,A,null)};j&&xe.__asyncHydrate?xe.__asyncHydrate(fe,y,ye):ye()}else{ce.ce&&ce.ce._hasShadowRoot()&&ce.ce._injectChildStyle(xe,y.parent?y.parent.type:void 0);const ye=y.subTree=Xi(y);g(null,ye,M,J,y,A,F),E.el=ye.el}if(Re&&ht(Re,A),!j&&(ie=_e&&_e.onVnodeMounted)){const ye=E;ht(()=>Zt(ie,U,ye),A)}(E.shapeFlag&256||U&&Ws(U.vnode)&&U.vnode.shapeFlag&256)&&y.a&&ht(y.a,A),y.isMounted=!0,E=M=J=null}};y.scope.on();const se=y.effect=new ai(Q);y.scope.off();const ee=y.update=se.run.bind(se),ge=y.job=se.runIfDirty.bind(se);ge.i=y,ge.id=y.uid,se.scheduler=()=>Do(ge),kn(y,!0),ee()},D=(y,E,M)=>{E.component=y;const J=y.vnode.props;y.vnode=E,y.next=null,nb(y,E.props,J,M),rb(y,E.children,M),Ys(),Xc(y),Qs()},I=(y,E,M,J,A,F,Y,Q,se=!1)=>{const ee=y&&y.children,ge=y?y.shapeFlag:0,ie=E.children,{patchFlag:fe,shapeFlag:_e}=E;if(fe>0){if(fe&128){de(ee,ie,M,J,A,F,Y,Q,se);return}else if(fe&256){K(ee,ie,M,J,A,F,Y,Q,se);return}}_e&8?(ge&16&&Ne(ee,A,F),ie!==ee&&u(M,ie)):ge&16?_e&16?de(ee,ie,M,J,A,F,Y,Q,se):Ne(ee,A,F,!0):(ge&8&&u(M,""),_e&16&&T(ie,M,J,A,F,Y,Q,se))},K=(y,E,M,J,A,F,Y,Q,se)=>{y=y||la,E=E||la;const ee=y.length,ge=E.length,ie=Math.min(ee,ge);let fe;for(fe=0;fe<ie;fe++){const _e=E[fe]=se?Us(E[fe]):Yt(E[fe]);g(y[fe],_e,M,null,A,F,Y,Q,se)}ee>ge?Ne(y,A,F,!0,!1,ie):T(E,M,J,A,F,Y,Q,se,ie)},de=(y,E,M,J,A,F,Y,Q,se)=>{let ee=0;const ge=E.length;let ie=y.length-1,fe=ge-1;for(;ee<=ie&&ee<=fe;){const _e=y[ee],Te=E[ee]=se?Us(E[ee]):Yt(E[ee]);if(vs(_e,Te))g(_e,Te,M,null,A,F,Y,Q,se);else break;ee++}for(;ee<=ie&&ee<=fe;){const _e=y[ie],Te=E[fe]=se?Us(E[fe]):Yt(E[fe]);if(vs(_e,Te))g(_e,Te,M,null,A,F,Y,Q,se);else break;ie--,fe--}if(ee>ie){if(ee<=fe){const _e=fe+1,Te=_e<ge?E[_e].el:J;for(;ee<=fe;)g(null,E[ee]=se?Us(E[ee]):Yt(E[ee]),M,Te,A,F,Y,Q,se),ee++}}else if(ee>fe)for(;ee<=ie;)Z(y[ee],A,F,!0),ee++;else{const _e=ee,Te=ee,Re=new Map;for(ee=Te;ee<=fe;ee++){const st=E[ee]=se?Us(E[ee]):Yt(E[ee]);st.key!=null&&Re.set(st.key,ee)}let U,ce=0;const xe=fe-Te+1;let j=!1,ye=0;const Be=new Array(xe);for(ee=0;ee<xe;ee++)Be[ee]=0;for(ee=_e;ee<=ie;ee++){const st=y[ee];if(ce>=xe){Z(st,A,F,!0);continue}let Ye;if(st.key!=null)Ye=Re.get(st.key);else for(U=Te;U<=fe;U++)if(Be[U-Te]===0&&vs(st,E[U])){Ye=U;break}Ye===void 0?Z(st,A,F,!0):(Be[Ye-Te]=ee+1,Ye>=ye?ye=Ye:j=!0,g(st,E[Ye],M,null,A,F,Y,Q,se),ce++)}const bt=j?ob(Be):la;for(U=bt.length-1,ee=xe-1;ee>=0;ee--){const st=Te+ee,Ye=E[st],sn=E[st+1],xn=st+1<ge?sn.el||cp(sn):J;Be[ee]===0?g(null,Ye,M,xn,A,F,Y,Q,se):j&&(U<0||ee!==bt[U]?re(Ye,M,xn,2):U--)}}},re=(y,E,M,J,A=null)=>{const{el:F,type:Y,transition:Q,children:se,shapeFlag:ee}=y;if(ee&6){re(y.component.subTree,E,M,J);return}if(ee&128){y.suspense.move(E,M,J);return}if(ee&64){Y.move(y,E,M,ve);return}if(Y===Ct){n(F,E,M);for(let ie=0;ie<se.length;ie++)re(se[ie],E,M,J);n(y.anchor,E,M);return}if(Y===On){v(y,E,M);return}if(J!==2&&ee&1&&Q)if(J===0)Q.persisted&&!F[os]?n(F,E,M):(Q.beforeEnter(F),n(F,E,M),ht(()=>Q.enter(F),A));else{const{leave:ie,delayLeave:fe,afterLeave:_e}=Q,Te=()=>{y.ctx.isUnmounted?a(F):n(F,E,M)},Re=()=>{const U=F._isLeaving||!!F[os];F._isLeaving&&F[os](!0),Q.persisted&&!U?Te():ie(F,()=>{Te(),_e&&_e()})};fe?fe(F,Te,Re):Re()}else n(F,E,M)},Z=(y,E,M,J=!1,A=!1)=>{const{type:F,props:Y,ref:Q,children:se,dynamicChildren:ee,shapeFlag:ge,patchFlag:ie,dirs:fe,cacheIndex:_e,memo:Te}=y;if(ie===-2&&(A=!1),Q!=null&&(Ys(),da(Q,null,M,y,!0),Qs()),_e!=null&&(E.renderCache[_e]=void 0),ge&256){E.ctx.deactivate(y);return}const Re=ge&1&&fe,U=!Ws(y);let ce;if(U&&(ce=Y&&Y.onVnodeBeforeUnmount)&&Zt(ce,E,y),ge&6)oe(y.component,M,J);else{if(ge&128){y.suspense.unmount(M,J);return}Re&&Es(y,null,E,"beforeUnmount"),ge&64?y.type.remove(y,E,M,ve,J):ee&&!ee.hasOnce&&(F!==Ct||ie>0&&ie&64)?Ne(ee,E,M,!1,!0):(F===Ct&&ie&384||!A&&ge&16)&&Ne(se,E,M),J&&he(y)}const xe=Te!=null&&_e==null;(U&&(ce=Y&&Y.onVnodeUnmounted)||Re||xe)&&ht(()=>{ce&&Zt(ce,E,y),Re&&Es(y,null,E,"unmounted"),xe&&(y.el=null)},M)},he=y=>{const{type:E,el:M,anchor:J,transition:A}=y;if(E===Ct){X(M,J);return}if(E===On){x(y);return}const F=()=>{a(M),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(y.shapeFlag&1&&A&&!A.persisted){const{leave:Y,delayLeave:Q}=A,se=()=>Y(M,F);Q?Q(y.el,F,se):se()}else F()},X=(y,E)=>{let M;for(;y!==E;)M=f(y),a(y),y=M;a(E)},oe=(y,E,M)=>{const{bum:J,scope:A,job:F,subTree:Y,um:Q,m:se,a:ee}=y;hl(se),hl(ee),J&&ca(J),A.stop(),F&&(F.flags|=8,Z(Y,y,E,M)),Q&&ht(Q,E),ht(()=>{y.isUnmounted=!0},E)},Ne=(y,E,M,J=!1,A=!1,F=0)=>{for(let Y=F;Y<y.length;Y++)Z(y[Y],E,M,J,A)},V=y=>{if(y.shapeFlag&6)return V(y.component.subTree);if(y.shapeFlag&128)return y.suspense.next();const E=f(y.anchor||y.el),M=E&&E[Nf];return M?f(M):E};let ue=!1;const le=(y,E,M)=>{let J;y==null?E._vnode&&(Z(E._vnode,null,null,!0),J=E._vnode.component):g(E._vnode||null,y,E,null,null,null,M),E._vnode=y,ue||(ue=!0,Xc(J),dl(),ue=!1)},ve={p:g,um:Z,m:re,r:he,mt:$,mc:T,pc:I,pbc:L,n:V,o:e};let be,Me;return t&&([be,Me]=t(ve)),{render:le,hydrate:be,createApp:Wv(le,be)}}function kr({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function kn({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function rp(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function Wo(e,t,s=!1){const n=e.children,a=t.children;if(pe(n)&&pe(a))for(let i=0;i<n.length;i++){const l=n[i];let r=a[i];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=a[i]=Us(a[i]),r.el=l.el),!s&&r.patchFlag!==-2&&Wo(l,r)),r.type===gn&&(r.patchFlag===-1&&(r=a[i]=Us(r)),r.el=l.el),r.type===dt&&!r.el&&(r.el=l.el)}}function ob(e){const t=e.slice(),s=[0];let n,a,i,l,r;const o=e.length;for(n=0;n<o;n++){const c=e[n];if(c!==0){if(a=s[s.length-1],e[a]<c){t[n]=a,s.push(n);continue}for(i=0,l=s.length-1;i<l;)r=i+l>>1,e[s[r]]<c?i=r+1:l=r;c<e[s[i]]&&(i>0&&(t[n]=s[i-1]),s[i]=n)}}for(i=s.length,l=s[i-1];i-- >0;)s[i]=l,l=t[l];return s}function op(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:op(t)}function hl(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function cp(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?cp(t.subTree):null}const gl=e=>e.__isSuspense;let Xr=0;const cb={name:"Suspense",__isSuspense:!0,process(e,t,s,n,a,i,l,r,o,c){if(e==null)db(t,s,n,a,i,l,r,o,c);else{if(i&&i.deps>0&&!e.suspense.isInFallback){t.suspense=e.suspense,t.suspense.vnode=t,t.el=e.el;return}fb(e,t,s,n,a,l,r,o,c)}},hydrate:pb,normalize:hb},ub=cb;function di(e,t){const s=e.props&&e.props[t];we(s)&&s()}function db(e,t,s,n,a,i,l,r,o){const{p:c,o:{createElement:u}}=o,d=u("div"),f=e.suspense=up(e,a,n,t,d,s,i,l,r,o);c(null,f.pendingBranch=e.ssContent,d,null,n,f,i,l),f.deps>0?(di(e,"onPending"),di(e,"onFallback"),c(null,e.ssFallback,t,s,n,null,i,l),fa(f,e.ssFallback)):f.resolve(!1,!0)}function fb(e,t,s,n,a,i,l,r,{p:o,um:c,o:{createElement:u}}){const d=t.suspense=e.suspense;d.vnode=t,t.el=e.el;const f=t.ssContent,p=t.ssFallback,{activeBranch:m,pendingBranch:g,isInFallback:k,isHydrating:w}=d;if(g)d.pendingBranch=f,vs(g,f)?(o(g,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():k&&(w||(o(m,p,s,n,a,null,i,l,r),fa(d,p)))):(d.pendingId=Xr++,w?(d.isHydrating=!1,d.activeBranch=g):c(g,a,d),d.deps=0,d.effects.length=0,d.hiddenContainer=u("div"),k?(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():(o(m,p,s,n,a,null,i,l,r),fa(d,p))):m&&vs(m,f)?(o(m,f,s,n,a,d,i,l,r),d.resolve(!0)):(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0&&d.resolve()));else if(m&&vs(m,f))o(m,f,s,n,a,d,i,l,r),fa(d,f);else if(di(t,"onPending"),d.pendingBranch=f,f.shapeFlag&512?d.pendingId=f.component.suspenseId:d.pendingId=Xr++,o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0)d.resolve();else{const{timeout:b,pendingId:v}=d;b>0?setTimeout(()=>{d.pendingId===v&&d.fallback(p)},b):b===0&&d.fallback(p)}}function up(e,t,s,n,a,i,l,r,o,c,u=!1){const{p:d,m:f,um:p,n:m,o:{parentNode:g,remove:k}}=c;let w;const b=gb(e);b&&t&&t.pendingBranch&&(w=t.pendingId,t.deps++);const v=e.props?ll(e.props.timeout):void 0,x=i,S={vnode:e,parent:t,parentComponent:s,namespace:l,container:n,hiddenContainer:a,deps:0,pendingId:Xr++,timeout:typeof v=="number"?v:-1,activeBranch:null,isFallbackMountPending:!1,pendingBranch:null,isInFallback:!u,isHydrating:u,isUnmounted:!1,effects:[],resolve(N=!1,O=!1){const{vnode:T,activeBranch:R,pendingBranch:L,pendingId:B,effects:P,parentComponent:C,container:$,isInFallback:W}=S;let G=!1;if(S.isHydrating)S.isHydrating=!1;else if(!N){G=R&&L.transition&&L.transition.mode==="out-in";let K=!1;G&&(R.transition.afterLeave=()=>{B===S.pendingId&&(f(L,$,i===x&&!K?m(R):i,0),ri(P),W&&T.ssFallback&&(T.ssFallback.el=null))}),R&&!S.isFallbackMountPending&&(g(R.el)===$&&(i=m(R),K=!0),p(R,C,S,!0),!G&&W&&T.ssFallback&&ht(()=>T.ssFallback.el=null,S)),G||f(L,$,i,0)}S.isFallbackMountPending=!1,fa(S,L),S.pendingBranch=null,S.isInFallback=!1;let D=S.parent,I=!1;for(;D;){if(D.pendingBranch){D.effects.push(...P),I=!0;break}D=D.parent}!I&&!G&&ri(P),S.effects=[],b&&t&&t.pendingBranch&&w===t.pendingId&&(t.deps--,t.deps===0&&!O&&t.resolve()),di(T,"onResolve")},fallback(N){if(!S.pendingBranch)return;const{vnode:O,activeBranch:T,parentComponent:R,container:L,namespace:B}=S;di(O,"onFallback");const P=m(T),C=()=>{S.isFallbackMountPending=!1,S.isInFallback&&(d(null,N,L,P,R,null,B,r,o),fa(S,N))},$=N.transition&&N.transition.mode==="out-in";$&&(S.isFallbackMountPending=!0,T.transition.afterLeave=C),S.isInFallback=!0,p(T,R,null,!0),$||C()},move(N,O,T){S.activeBranch&&f(S.activeBranch,N,O,T),S.container=N},next(){return S.activeBranch&&m(S.activeBranch)},registerDep(N,O,T){const R=!!S.pendingBranch;R&&S.deps++;const L=N.vnode.el;N.asyncDep.catch(B=>{jn(B,N,0)}).then(B=>{if(N.isUnmounted||S.isUnmounted||S.pendingId!==N.suspenseId)return;hi(),N.asyncResolved=!0;const{vnode:P}=N;eo(N,B,!1),L&&(P.el=L);const C=!L&&N.subTree.el;O(N,P,g(L||N.subTree.el),L?null:m(N.subTree),S,l,T),C&&(P.placeholder=null,k(C)),Xl(N,P.el),R&&--S.deps===0&&S.resolve()})},unmount(N,O){S.isUnmounted=!0,S.activeBranch&&p(S.activeBranch,s,N,O),S.pendingBranch&&p(S.pendingBranch,s,N,O)}};return S}function pb(e,t,s,n,a,i,l,r,o){const c=t.suspense=up(t,n,s,e.parentNode,document.createElement("div"),null,a,i,l,r,!0),u=o(e,c.pendingBranch=t.ssContent,s,c,i,l);return c.deps===0&&c.resolve(!1,!0),u}function hb(e){const{shapeFlag:t,children:s}=e,n=t&32;e.ssContent=pu(n?s.default:s),e.ssFallback=n?pu(s.fallback):at(dt)}function pu(e){let t;if(we(e)){const s=Pn&&e._c;s&&(e._d=!1,fi()),e=e(),s&&(e._d=!0,t=Ft,fp())}return pe(e)&&(e=Qv(e)),e=Yt(e),t&&!e.dynamicChildren&&(e.dynamicChildren=t.filter(s=>s!==e)),e}function dp(e,t){t&&t.pendingBranch?pe(e)?t.effects.push(...e):t.effects.push(e):ri(e)}function fa(e,t){e.activeBranch=t;const{vnode:s,parentComponent:n}=e;let a=t.el;for(;!a&&t.component;)t=t.component.subTree,a=t.el;s.el=a,n&&n.subTree===s&&(n.vnode.el=a,Xl(n,a))}function gb(e){const t=e.props&&e.props.suspensible;return t!=null&&t!==!1}const Ct=Symbol.for("v-fgt"),gn=Symbol.for("v-txt"),dt=Symbol.for("v-cmt"),On=Symbol.for("v-stc"),Qa=[];let Ft=null;function fi(e=!1){Qa.push(Ft=e?null:[])}function fp(){Qa.pop(),Ft=Qa[Qa.length-1]||null}let Pn=1;function pi(e,t=!1){Pn+=e,e<0&&Ft&&t&&(Ft.hasOnce=!0)}function pp(e){return e.dynamicChildren=Pn>0?Ft||la:null,fp(),Pn>0&&Ft&&Ft.push(e),e}function mb(e,t,s,n,a,i){return pp(Zo(e,t,s,n,a,i,!0))}function ml(e,t,s,n,a){return pp(at(e,t,s,n,a,!0))}function en(e){return e?e.__v_isVNode===!0:!1}function vs(e,t){return e.type===t.type&&e.key===t.key}function vb(e){}const hp=({key:e})=>e??null,el=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?Ee(e)||mt(e)||we(e)?{i:It,r:e,k:t,f:!!s}:e:null);function Zo(e,t=null,s=null,n=0,a=null,i=e===Ct?0:1,l=!1,r=!1){const o={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&hp(t),ref:t&&el(t),scopeId:Gl,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:n,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:It};return r?(Yo(o,s),i&128&&e.normalize(o)):s&&(o.shapeFlag|=Ee(s)?8:16),Pn>0&&!l&&Ft&&(o.patchFlag>0||i&6)&&o.patchFlag!==32&&Ft.push(o),o}const at=bb;function bb(e,t=null,s=null,n=0,a=null,i=!1){if((!e||e===jf)&&(e=dt),en(e)){const r=Ns(e,t,!0);return s&&Yo(r,s),Pn>0&&!i&&Ft&&(r.shapeFlag&6?Ft[Ft.indexOf(e)]=r:Ft.push(r)),r.patchFlag=-2,r}if(Tb(e)&&(e=e.__vccOpts),t){t=gp(t);let{class:r,style:o}=t;r&&!Ee(r)&&(t.class=wi(r)),Ve(o)&&(Si(o)&&!pe(o)&&(o=De({},o)),t.style=ki(o))}const l=Ee(e)?1:gl(e)?128:Of(e)?64:Ve(e)?4:we(e)?2:0;return Zo(e,t,s,n,a,l,i,!0)}function gp(e){return e?Si(e)||Qf(e)?De({},e):e:null}function Ns(e,t,s=!1,n=!1){const{props:a,ref:i,patchFlag:l,children:r,transition:o}=e,c=t?vp(a||{},t):a,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&hp(c),ref:t&&t.ref?s&&i?pe(i)?i.concat(el(t)):[i,el(t)]:el(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:r,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==Ct?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:o,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Ns(e.ssContent),ssFallback:e.ssFallback&&Ns(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return o&&n&&Xs(u,o.clone(u)),u}function Jo(e=" ",t=0){return at(gn,null,e,t)}function yb(e,t){const s=at(On,null,e);return s.staticCount=t,s}function mp(e="",t=!1){return t?(fi(),ml(dt,null,e)):at(dt,null,e)}function Yt(e){return e==null||typeof e=="boolean"?at(dt):pe(e)?at(Ct,null,e.slice()):en(e)?Us(e):at(gn,null,String(e))}function Us(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Ns(e)}function Yo(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(pe(t))s=16;else if(typeof t=="object")if(n&65){const a=t.default;a&&(a._c&&(a._d=!1),Yo(e,a()),a._c&&(a._d=!0));return}else{s=32;const a=t._;!a&&!Qf(t)?t._ctx=It:a===3&&It&&(It.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else we(t)?(t={default:t,_ctx:It},s=32):(t=String(t),n&64?(s=16,t=[Jo(t)]):s=8);e.children=t,e.shapeFlag|=s}function vp(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const a in n)if(a==="class")t.class!==n.class&&(t.class=wi([t.class,n.class]));else if(a==="style")t.style=ki([t.style,n.style]);else if(Bn(a)){const i=t[a],l=n[a];l&&i!==l&&!(pe(i)&&i.includes(l))?t[a]=i?[].concat(i,l):l:l==null&&i==null&&!Pl(a)&&(t[a]=l)}else a!==""&&(t[a]=n[a])}return t}function Zt(e,t,s,n=null){ns(e,t,7,[s,n])}const xb=qf();let _b=0;function bp(e,t,s){const n=e.type,a=(t?t.appContext:e.appContext)||xb,i={uid:_b++,vnode:e,type:n,parent:t,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Eo(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(a.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:ep(n,a),emitsOptions:Wf(n,a),emit:null,emitted:null,propsDefaults:Pe,inheritAttrs:n.inheritAttrs,ctx:Pe,data:Pe,props:Pe,attrs:Pe,slots:Pe,refs:Pe,setupState:Pe,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=Jv.bind(null,i),e.ce&&e.ce(i),i}let Rt=null;const Kt=()=>Rt||It;let vl,pa;{const e=Hl(),t=(s,n)=>{let a;return(a=e[s])||(a=e[s]=[]),a.push(n),i=>{a.length>1?a.forEach(l=>l(i)):a[0](i)}};vl=t("__VUE_INSTANCE_SETTERS__",s=>Rt=s),pa=t("__VUE_SSR_SETTERS__",s=>Fn=s)}const Ra=e=>{const t=Rt;return vl(e),e.scope.on(),()=>{e.scope.off(),vl(t)}},hi=()=>{Rt&&Rt.scope.off(),vl(null)};function yp(e){return e.vnode.shapeFlag&4}let Fn=!1;function xp(e,t=!1,s=!1){t&&pa(t);const{props:n,children:a}=e.vnode,i=yp(e);sb(e,n,i,t),lb(e,a,s||t);const l=i?kb(e,t):void 0;return t&&pa(!1),l}function kb(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Zr);const{setup:n}=s;if(n){Ys();const a=e.setupContext=n.length>1?wp(e):null,i=Ra(e),l=Aa(n,e,0,[e.props,a]),r=Co(l);if(Qs(),i(),(r||e.sp)&&!Ws(e)&&$o(e),r){if(l.then(hi,hi),t)return l.then(o=>{eo(e,o,t)}).catch(o=>{jn(o,e,0)});e.asyncDep=l}else eo(e,l,t)}else kp(e,t)}function eo(e,t,s){we(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Ve(t)&&(e.setupState=Lo(t)),kp(e,s)}let bl,to;function _p(e){bl=e,to=t=>{t.render._rc&&(t.withProxy=new Proxy(t.ctx,Av))}}const wb=()=>!bl;function kp(e,t,s){const n=e.type;if(!e.render){if(!t&&bl&&!n.render){const a=n.template||Ko(e).template;if(a){const{isCustomElement:i,compilerOptions:l}=e.appContext.config,{delimiters:r,compilerOptions:o}=n,c=De(De({isCustomElement:i,delimiters:r},l),o);n.render=bl(a,c)}}e.render=n.render||Nt,to&&to(e)}{const a=Ra(e);Ys();try{Vv(e)}finally{Qs(),a()}}}const Sb={get(e,t){return Pt(e,"get",""),e[t]}};function wp(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Sb),slots:e.slots,emit:e.emit,expose:t}}function Ai(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Lo(vf(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Ya)return Ya[s](e)},has(t,s){return s in t||s in Ya}})):e.proxy}function so(e,t=!0){return we(e)?e.displayName||e.name:e.name||t&&e.__name}function Tb(e){return we(e)&&"__vccOpts"in e}const te=(e,t)=>Nm(e,t,Fn);function va(e,t,s){try{pi(-1);const n=arguments.length;return n===2?Ve(t)&&!pe(t)?en(t)?at(e,null,[t]):at(e,t):at(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&en(s)&&(s=[s]),at(e,t,s))}finally{pi(1)}}function Cb(){}function Eb(e,t,s,n){const a=s[n];if(a&&Sp(a,e))return a;const i=t();return i.memo=e.slice(),i.cacheIndex=n,s[n]=i}function Sp(e,t){const s=e.memo;if(s.length!=t.length)return!1;for(let n=0;n<s.length;n++)if(St(s[n],t[n]))return!1;return Pn>0&&Ft&&Ft.push(e),!0}const Tp="3.5.38",Ab=Nt,Rb=Bm,Ib=ta,Nb=Cf,Ob={createComponentInstance:bp,setupComponent:xp,renderComponentRoot:Xi,setCurrentRenderingInstance:ci,isVNode:en,normalizeVNode:Yt,getComponentPublicInstance:Ai,ensureValidVNode:zo,pushWarningContext:Pm,popWarningContext:Fm},Lb=Ob,Db=null,Mb=null,Pb=null;/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let no;const hu=typeof window<"u"&&window.trustedTypes;if(hu)try{no=hu.createPolicy("vue",{createHTML:e=>e})}catch{}const Cp=no?e=>no.createHTML(e):e=>e,Fb="http://www.w3.org/2000/svg",$b="http://www.w3.org/1998/Math/MathML",$s=typeof document<"u"?document:null,gu=$s&&$s.createElement("template"),Ep={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const a=t==="svg"?$s.createElementNS(Fb,e):t==="mathml"?$s.createElementNS($b,e):s?$s.createElement(e,{is:s}):$s.createElement(e);return e==="select"&&n&&n.multiple!=null&&a.setAttribute("multiple",n.multiple),a},createText:e=>$s.createTextNode(e),createComment:e=>$s.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>$s.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,a,i){const l=s?s.previousSibling:t.lastChild;if(a&&(a===i||a.nextSibling))for(;t.insertBefore(a.cloneNode(!0),s),!(a===i||!(a=a.nextSibling)););else{gu.innerHTML=Cp(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const r=gu.content;if(n==="svg"||n==="mathml"){const o=r.firstChild;for(;o.firstChild;)r.appendChild(o.firstChild);r.removeChild(o)}t.insertBefore(r,s)}return[l?l.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},ln="transition",Pa="animation",ba=Symbol("_vtc"),Ap={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Rp=De({},Fo,Ap),Ub=e=>(e.displayName="Transition",e.props=Rp,e),Bb=Ub((e,{slots:t})=>va(Mf,Ip(e),t)),wn=(e,t=[])=>{pe(e)?e.forEach(s=>s(...t)):e&&e(...t)},mu=e=>e?pe(e)?e.some(t=>t.length>1):e.length>1:!1;function Ip(e){const t={};for(const P in e)P in Ap||(t[P]=e[P]);if(e.css===!1)return t;const{name:s="v",type:n,duration:a,enterFromClass:i=`${s}-enter-from`,enterActiveClass:l=`${s}-enter-active`,enterToClass:r=`${s}-enter-to`,appearFromClass:o=i,appearActiveClass:c=l,appearToClass:u=r,leaveFromClass:d=`${s}-leave-from`,leaveActiveClass:f=`${s}-leave-active`,leaveToClass:p=`${s}-leave-to`}=e,m=Hb(a),g=m&&m[0],k=m&&m[1],{onBeforeEnter:w,onEnter:b,onEnterCancelled:v,onLeave:x,onLeaveCancelled:S,onBeforeAppear:N=w,onAppear:O=b,onAppearCancelled:T=v}=t,R=(P,C,$,W)=>{P._enterCancelled=W,un(P,C?u:r),un(P,C?c:l),$&&$()},L=(P,C)=>{P._isLeaving=!1,un(P,d),un(P,p),un(P,f),C&&C()},B=P=>(C,$)=>{const W=P?O:b,G=()=>R(C,P,$);wn(W,[C,G]),vu(()=>{un(C,P?o:i),ws(C,P?u:r),mu(W)||bu(C,n,g,G)})};return De(t,{onBeforeEnter(P){wn(w,[P]),ws(P,i),ws(P,l)},onBeforeAppear(P){wn(N,[P]),ws(P,o),ws(P,c)},onEnter:B(!1),onAppear:B(!0),onLeave(P,C){P._isLeaving=!0;const $=()=>L(P,C);ws(P,d),P._enterCancelled?(ws(P,f),ao(P)):(ao(P),ws(P,f)),vu(()=>{P._isLeaving&&(un(P,d),ws(P,p),mu(x)||bu(P,n,k,$))}),wn(x,[P,$])},onEnterCancelled(P){R(P,!1,void 0,!0),wn(v,[P])},onAppearCancelled(P){R(P,!0,void 0,!0),wn(T,[P])},onLeaveCancelled(P){L(P),wn(S,[P])}})}function Hb(e){if(e==null)return null;if(Ve(e))return[wr(e.enter),wr(e.leave)];{const t=wr(e);return[t,t]}}function wr(e){return ll(e)}function ws(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ba]||(e[ba]=new Set)).add(t)}function un(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[ba];s&&(s.delete(t),s.size||(e[ba]=void 0))}function vu(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Vb=0;function bu(e,t,s,n){const a=e._endId=++Vb,i=()=>{a===e._endId&&n()};if(s!=null)return setTimeout(i,s);const{type:l,timeout:r,propCount:o}=Np(e,t);if(!l)return n();const c=l+"end";let u=0;const d=()=>{e.removeEventListener(c,f),i()},f=p=>{p.target===e&&++u>=o&&d()};setTimeout(()=>{u<o&&d()},r+1),e.addEventListener(c,f)}function Np(e,t){const s=window.getComputedStyle(e),n=m=>(s[m]||"").split(", "),a=n(`${ln}Delay`),i=n(`${ln}Duration`),l=yu(a,i),r=n(`${Pa}Delay`),o=n(`${Pa}Duration`),c=yu(r,o);let u=null,d=0,f=0;t===ln?l>0&&(u=ln,d=l,f=i.length):t===Pa?c>0&&(u=Pa,d=c,f=o.length):(d=Math.max(l,c),u=d>0?l>c?ln:Pa:null,f=u?u===ln?i.length:o.length:0);const p=u===ln&&/\b(?:transform|all)(?:,|$)/.test(n(`${ln}Property`).toString());return{type:u,timeout:d,propCount:f,hasTransform:p}}function yu(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>xu(s)+xu(e[n])))}function xu(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function ao(e){return(e?e.ownerDocument:document).body.offsetHeight}function jb(e,t,s){const n=e[ba];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const yl=Symbol("_vod"),Qo=Symbol("_vsh"),Op={name:"show",beforeMount(e,{value:t},{transition:s}){e[yl]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):Fa(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),Fa(e,!0),n.enter(e)):n.leave(e,()=>{Fa(e,!1)}):Fa(e,t))},beforeUnmount(e,{value:t}){Fa(e,t)}};function Fa(e,t){e.style.display=t?e[yl]:"none",e[Qo]=!t}function zb(){Op.getSSRProps=({value:e})=>{if(!e)return{style:{display:"none"}}}}const Lp=Symbol("");function Kb(e){const t=Kt();if(!t)return;const s=t.ut=(a=e(t.proxy))=>{Array.from(document.querySelectorAll(`[data-v-owner="${t.uid}"]`)).forEach(i=>xl(i,a))},n=()=>{const a=e(t.proxy);t.ce?xl(t.ce,a):io(t.subTree,a),s(a)};Ho(()=>{ri(n)}),Ue(()=>{fs(n,Nt,{flush:"post"});const a=new MutationObserver(n);a.observe(t.subTree.el.parentNode,{childList:!0}),ft(()=>a.disconnect())})}function io(e,t){if(e.shapeFlag&128){const s=e.suspense;e=s.activeBranch,s.pendingBranch&&!s.isHydrating&&s.effects.push(()=>{io(s.activeBranch,t)})}for(;e.component;)e=e.component.subTree;if(e.shapeFlag&1&&e.el)xl(e.el,t);else if(e.type===Ct)e.children.forEach(s=>io(s,t));else if(e.type===On){let{el:s,anchor:n}=e;for(;s&&(xl(s,t),s!==n);)s=s.nextSibling}}function xl(e,t){if(e.nodeType===1){const s=e.style;let n="";for(const a in t){const i=Yg(t[a]);s.setProperty(`--${a}`,i),n+=`--${a}: ${i};`}s[Lp]=n}}const qb=/(?:^|;)\s*display\s*:/;function Gb(e,t,s){const n=e.style,a=Ee(s);let i=!1;if(s&&!a){if(t)if(Ee(t))for(const l of t.split(";")){const r=l.slice(0,l.indexOf(":")).trim();s[r]==null&&qa(n,r,"")}else for(const l in t)s[l]==null&&qa(n,l,"");for(const l in s){l==="display"&&(i=!0);const r=s[l];r!=null?Zb(e,l,!Ee(t)&&t?t[l]:void 0,r)||qa(n,l,r):qa(n,l,"")}}else if(a){if(t!==s){const l=n[Lp];l&&(s+=";"+l),n.cssText=s,i=qb.test(s)}}else t&&e.removeAttribute("style");yl in e&&(e[yl]=i?n.display:"",e[Qo]&&(n.display="none"))}const _u=/\s*!important$/;function qa(e,t,s){if(pe(s))s.forEach(n=>qa(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Wb(e,t);_u.test(s)?e.setProperty(Qt(n),s.replace(_u,""),"important"):e[n]=s}}const ku=["Webkit","Moz","ms"],Sr={};function Wb(e,t){const s=Sr[t];if(s)return s;let n=Ze(t);if(n!=="filter"&&n in e)return Sr[t]=n;n=Vn(n);for(let a=0;a<ku.length;a++){const i=ku[a]+n;if(i in e)return Sr[t]=i}return t}function Zb(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&Ee(n)&&s===n}const wu="http://www.w3.org/1999/xlink";function Su(e,t,s,n,a,i=Zg(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(wu,t.slice(6,t.length)):e.setAttributeNS(wu,t,s):s==null||i&&!Jd(s)?e.removeAttribute(t):e.setAttribute(t,i?"":Ut(s)?String(s):s)}function Tu(e,t,s,n,a){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?Cp(s):s);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const r=i==="OPTION"?e.getAttribute("value")||"":e.value,o=s==null?e.type==="checkbox"?"on":"":String(s);(r!==o||!("_value"in e))&&(e.value=o),s==null&&e.removeAttribute(t),e._value=s;return}let l=!1;if(s===""||s==null){const r=typeof e[t];r==="boolean"?s=Jd(s):s==null&&r==="string"?(s="",l=!0):r==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(a||t)}function js(e,t,s,n){e.addEventListener(t,s,n)}function Jb(e,t,s,n){e.removeEventListener(t,s,n)}const Cu=Symbol("_vei");function Yb(e,t,s,n,a=null){const i=e[Cu]||(e[Cu]={}),l=i[t];if(n&&l)l.value=n;else{const[r,o]=Qb(t);if(n){const c=i[t]=ty(n,a);js(e,r,c,o)}else l&&(Jb(e,r,l,o),i[t]=void 0)}}const Eu=/(?:Once|Passive|Capture)$/;function Qb(e){let t;if(Eu.test(e)){t={};let n;for(;n=e.match(Eu);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Qt(e.slice(2)),t]}let Tr=0;const Xb=Promise.resolve(),ey=()=>Tr||(Xb.then(()=>Tr=0),Tr=Date.now());function ty(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const a=s.value;if(pe(a)){const i=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{i.call(n),n._stopped=!0};const l=a.slice(),r=[n];for(let o=0;o<l.length&&!n._stopped;o++){const c=l[o];c&&ns(c,t,5,r)}}else ns(a,t,5,[n])};return s.value=e,s.attached=ey(),s}const Au=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Dp=(e,t,s,n,a,i)=>{const l=a==="svg";t==="class"?jb(e,n,l):t==="style"?Gb(e,s,n):Bn(t)?Pl(t)||Yb(e,t,s,n,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):sy(e,t,n,l))?(Tu(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Su(e,t,n,l,i,t!=="value")):e._isVueCE&&(ny(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!Ee(n)))?Tu(e,Ze(t),n,i,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Su(e,t,n,l))};function sy(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Au(t)&&we(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const a=e.tagName;if(a==="IMG"||a==="VIDEO"||a==="CANVAS"||a==="SOURCE")return!1}return Au(t)&&Ee(s)?!1:t in e}function ny(e,t){const s=e._def.props;if(!s)return!1;const n=Ze(t);return Array.isArray(s)?s.some(a=>Ze(a)===n):Object.keys(s).some(a=>Ze(a)===n)}const Ru={};function Mp(e,t,s){let n=Ci(e,t);Fl(n)&&(n=De({},n,t));class a extends er{constructor(l){super(n,l,s)}}return a.def=n,a}const ay=((e,t)=>Mp(e,t,Wp)),iy=typeof HTMLElement<"u"?HTMLElement:class{};class er extends iy{constructor(t,s={},n=wl){super(),this._def=t,this._props=s,this._createApp=n,this._isVueCE=!0,this._instance=null,this._app=null,this._nonce=this._def.nonce,this._connected=!1,this._resolved=!1,this._patching=!1,this._dirty=!1,this._numberProps=null,this._styleChildren=new WeakSet,this._styleAnchors=new WeakMap,this._ob=null,this.shadowRoot&&n!==wl?this._root=this.shadowRoot:t.shadowRoot!==!1?(this.attachShadow(De({},t.shadowRootOptions,{mode:"open"})),this._root=this.shadowRoot):this._root=this}connectedCallback(){if(!this.isConnected)return;!this.shadowRoot&&!this._resolved&&this._parseSlots(),this._connected=!0;let t=this;for(;t=t&&(t.assignedSlot||t.parentNode||t.host);)if(t instanceof er){this._parent=t;break}this._instance||(this._resolved?this._mount(this._def):t&&t._pendingResolve?this._pendingResolve=t._pendingResolve.then(()=>{this._pendingResolve=void 0,this._resolveDef()}):this._resolveDef())}_setParent(t=this._parent){t&&(this._instance.parent=t._instance,this._inheritParentContext(t))}_inheritParentContext(t=this._parent){t&&this._app&&Object.setPrototypeOf(this._app._context.provides,t._instance.provides)}disconnectedCallback(){this._connected=!1,Tt(()=>{this._connected||(this._ob&&(this._ob.disconnect(),this._ob=null),this._app&&this._app.unmount(),this._instance&&(this._instance.ce=void 0),this._app=this._instance=null,this._teleportTargets&&(this._teleportTargets.clear(),this._teleportTargets=void 0))})}_processMutations(t){for(const s of t)this._setAttr(s.attributeName)}_resolveDef(){if(this._pendingResolve)return;for(let n=0;n<this.attributes.length;n++)this._setAttr(this.attributes[n].name);this._ob=new MutationObserver(this._processMutations.bind(this)),this._ob.observe(this,{attributes:!0});const t=(n,a=!1)=>{this._resolved=!0,this._pendingResolve=void 0;const{props:i,styles:l}=n;let r;if(i&&!pe(i))for(const o in i){const c=i[o];(c===Number||c&&c.type===Number)&&(o in this._props&&(this._props[o]=ll(this._props[o])),(r||(r=Object.create(null)))[Ze(o)]=!0)}this._numberProps=r,this._resolveProps(n),this.shadowRoot&&this._applyStyles(l),this._mount(n)},s=this._def.__asyncLoader;s?this._pendingResolve=s().then(n=>{n.configureApp=this._def.configureApp,t(this._def=n,!0)}):t(this._def)}_mount(t){this._app=this._createApp(t),this._inheritParentContext(),t.configureApp&&t.configureApp(this._app),this._app._ceVNode=this._createVNode(),this._app.mount(this._root);const s=this._instance&&this._instance.exposed;if(s)for(const n in s)je(this,n)||Object.defineProperty(this,n,{get:()=>Rs(s[n])})}_resolveProps(t){const{props:s}=t,n=pe(s)?s:Object.keys(s||{});for(const a of Object.keys(this))a[0]!=="_"&&n.includes(a)&&this._setProp(a,this[a]);for(const a of n.map(Ze))Object.defineProperty(this,a,{get(){return this._getProp(a)},set(i){this._setProp(a,i,!0,!this._patching)}})}_setAttr(t){if(t.startsWith("data-v-"))return;const s=this.hasAttribute(t);let n=s?this.getAttribute(t):Ru;const a=Ze(t);s&&this._numberProps&&this._numberProps[a]&&(n=ll(n)),this._setProp(a,n,!1,!0)}_getProp(t){return this._props[t]}_setProp(t,s,n=!0,a=!1){if(s!==this._props[t]&&(this._dirty=!0,s===Ru?delete this._props[t]:(this._props[t]=s,t==="key"&&this._app&&(this._app._ceVNode.key=s)),a&&this._instance&&this._update(),n)){const i=this._ob;i&&(this._processMutations(i.takeRecords()),i.disconnect()),s===!0?this.setAttribute(Qt(t),""):typeof s=="string"||typeof s=="number"?this.setAttribute(Qt(t),s+""):s||this.removeAttribute(Qt(t)),i&&i.observe(this,{attributes:!0})}}_update(){const t=this._createVNode();this._app&&(t.appContext=this._app._context),Gp(t,this._root)}_createVNode(){const t={};this.shadowRoot||(t.onVnodeMounted=t.onVnodeUpdated=this._renderSlots.bind(this));const s=at(this._def,De(t,this._props));return this._instance||(s.ce=n=>{this._instance=n,n.ce=this,n.isCE=!0;const a=(i,l)=>{this.dispatchEvent(new CustomEvent(i,Fl(l[0])?De({detail:l},l[0]):{detail:l}))};n.emit=(i,...l)=>{a(i,l),Qt(i)!==i&&a(Qt(i),l)},this._setParent()}),s}_applyStyles(t,s,n){if(!t)return;if(s){if(s===this._def||this._styleChildren.has(s))return;this._styleChildren.add(s)}const a=this._nonce,i=this.shadowRoot,l=n?this._getStyleAnchor(n)||this._getStyleAnchor(this._def):this._getRootStyleInsertionAnchor(i);let r=null;for(let o=t.length-1;o>=0;o--){const c=document.createElement("style");a&&c.setAttribute("nonce",a),c.textContent=t[o],i.insertBefore(c,r||l),r=c,o===0&&(n||this._styleAnchors.set(this._def,c),s&&this._styleAnchors.set(s,c))}}_getStyleAnchor(t){if(!t)return null;const s=this._styleAnchors.get(t);return s&&s.parentNode===this.shadowRoot?s:(s&&this._styleAnchors.delete(t),null)}_getRootStyleInsertionAnchor(t){for(let s=0;s<t.childNodes.length;s++){const n=t.childNodes[s];if(!(n instanceof HTMLStyleElement))return n}return null}_parseSlots(){const t=this._slots={};let s;for(;s=this.firstChild;){const n=s.nodeType===1&&s.getAttribute("slot")||"default";(t[n]||(t[n]=[])).push(s),this.removeChild(s)}}_renderSlots(){const t=this._getSlots(),s=this._instance.type.__scopeId;for(let n=0;n<t.length;n++){const a=t[n],i=a.getAttribute("name")||"default",l=this._slots[i],r=a.parentNode;if(l)for(const o of l){if(s&&o.nodeType===1){const c=s+"-s",u=document.createTreeWalker(o,1);o.setAttribute(c,"");let d;for(;d=u.nextNode();)d.setAttribute(c,"")}r.insertBefore(o,a)}else for(;a.firstChild;)r.insertBefore(a.firstChild,a);r.removeChild(a)}}_getSlots(){const t=[this];this._teleportTargets&&t.push(...this._teleportTargets);const s=new Set;for(const n of t){const a=n.querySelectorAll("slot");for(let i=0;i<a.length;i++)s.add(a[i])}return Array.from(s)}_injectChildStyle(t,s){this._applyStyles(t.styles,t,s)}_beginPatch(){this._patching=!0,this._dirty=!1}_endPatch(){this._patching=!1,this._dirty&&this._instance&&this._update()}_hasShadowRoot(){return this._def.shadowRoot!==!1}_removeChildStyle(t){}}function Pp(e){const t=Kt(),s=t&&t.ce;return s||null}function ly(){const e=Pp();return e&&e.shadowRoot}function ry(e="$style"){{const t=Kt();if(!t)return Pe;const s=t.type.__cssModules;if(!s)return Pe;const n=s[e];return n||Pe}}const Fp=new WeakMap,$p=new WeakMap,_l=Symbol("_moveCb"),Iu=Symbol("_enterCb"),oy=e=>(delete e.props.mode,e),cy=oy({name:"TransitionGroup",props:De({},Rp,{tag:String,moveClass:String}),setup(e,{slots:t}){const s=Kt(),n=Po();let a,i;return Jl(()=>{if(!a.length)return;const l=e.moveClass||`${e.name||"v"}-move`;if(!hy(a[0].el,s.vnode.el,l)){a=[];return}a.forEach(dy),a.forEach(fy);const r=a.filter(py);ao(s.vnode.el),r.forEach(o=>{const c=o.el,u=c.style;ws(c,l),u.transform=u.webkitTransform=u.transitionDuration="";const d=c[_l]=f=>{f&&f.target!==c||(!f||f.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",d),c[_l]=null,un(c,l))};c.addEventListener("transitionend",d)}),a=[]}),()=>{const l=$e(e),r=Ip(l);let o=l.tag||Ct;if(a=[],i)for(let c=0;c<i.length;c++){const u=i[c];u.el&&u.el instanceof Element&&!u.el[Qo]&&(a.push(u),Xs(u,ma(u,r,n,s)),Fp.set(u,Up(u.el)))}i=t.default?Wl(t.default()):[];for(let c=0;c<i.length;c++){const u=i[c];u.key!=null&&Xs(u,ma(u,r,n,s))}return at(o,null,i)}}}),uy=cy;function dy(e){const t=e.el;t[_l]&&t[_l](),t[Iu]&&t[Iu]()}function fy(e){$p.set(e,Up(e.el))}function py(e){const t=Fp.get(e),s=$p.get(e),n=t.left-s.left,a=t.top-s.top;if(n||a){const i=e.el,l=i.style,r=i.getBoundingClientRect();let o=1,c=1;return i.offsetWidth&&(o=r.width/i.offsetWidth),i.offsetHeight&&(c=r.height/i.offsetHeight),(!Number.isFinite(o)||o===0)&&(o=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(o-1)<.01&&(o=1),Math.abs(c-1)<.01&&(c=1),l.transform=l.webkitTransform=`translate(${n/o}px,${a/c}px)`,l.transitionDuration="0s",e}}function Up(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function hy(e,t,s){const n=e.cloneNode(),a=e[ba];a&&a.forEach(r=>{r.split(/\s+/).forEach(o=>o&&n.classList.remove(o))}),s.split(/\s+/).forEach(r=>r&&n.classList.add(r)),n.style.display="none";const i=t.nodeType===1?t:t.parentNode;i.appendChild(n);const{hasTransform:l}=Np(n);return i.removeChild(n),l}const vn=e=>{const t=e.props["onUpdate:modelValue"]||!1;return pe(t)?s=>ca(t,s):t};function gy(e){e.target.composing=!0}function Nu(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const ps=Symbol("_assign");function Ou(e,t,s){return t&&(e=e.trim()),s&&(e=Bl(e)),e}const kl={created(e,{modifiers:{lazy:t,trim:s,number:n}},a){e[ps]=vn(a);const i=n||a.props&&a.props.type==="number";js(e,t?"change":"input",l=>{l.target.composing||e[ps](Ou(e.value,s,i))}),(s||i)&&js(e,"change",()=>{e.value=Ou(e.value,s,i)}),t||(js(e,"compositionstart",gy),js(e,"compositionend",Nu),js(e,"change",Nu))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:n,trim:a,number:i}},l){if(e[ps]=vn(l),e.composing)return;const r=(i||e.type==="number")&&!/^0\d/.test(e.value)?Bl(e.value):e.value,o=t??"";if(r===o)return;const c=e.getRootNode();(c instanceof Document||c instanceof ShadowRoot)&&c.activeElement===e&&e.type!=="range"&&(n&&t===s||a&&e.value.trim()===o)||(e.value=o)}},Xo={deep:!0,created(e,t,s){e[ps]=vn(s),js(e,"change",()=>{const n=e._modelValue,a=ya(e),i=e.checked,l=e[ps];if(pe(n)){const r=Vl(n,a),o=r!==-1;if(i&&!o)l(n.concat(a));else if(!i&&o){const c=[...n];c.splice(r,1),l(c)}}else if(Hn(n)){const r=new Set(n);i?r.add(a):r.delete(a),l(r)}else l(Hp(e,i))})},mounted:Lu,beforeUpdate(e,t,s){e[ps]=vn(s),Lu(e,t,s)}};function Lu(e,{value:t,oldValue:s},n){e._modelValue=t;let a;if(pe(t))a=Vl(t,n.props.value)>-1;else if(Hn(t))a=t.has(n.props.value);else{if(t===s)return;a=Js(t,Hp(e,!0))}e.checked!==a&&(e.checked=a)}const ec={created(e,{value:t},s){e.checked=Js(t,s.props.value),e[ps]=vn(s),js(e,"change",()=>{e[ps](ya(e))})},beforeUpdate(e,{value:t,oldValue:s},n){e[ps]=vn(n),t!==s&&(e.checked=Js(t,n.props.value))}},Bp={deep:!0,created(e,{value:t,modifiers:{number:s}},n){const a=Hn(t);js(e,"change",()=>{const i=Array.prototype.filter.call(e.options,l=>l.selected).map(l=>s?Bl(ya(l)):ya(l));e[ps](e.multiple?a?new Set(i):i:i[0]),e._assigning=!0,Tt(()=>{e._assigning=!1})}),e[ps]=vn(n)},mounted(e,{value:t}){Du(e,t)},beforeUpdate(e,t,s){e[ps]=vn(s)},updated(e,{value:t}){e._assigning||Du(e,t)}};function Du(e,t){const s=e.multiple,n=pe(t);if(!(s&&!n&&!Hn(t))){for(let a=0,i=e.options.length;a<i;a++){const l=e.options[a],r=ya(l);if(s)if(n){const o=typeof r;o==="string"||o==="number"?l.selected=t.some(c=>String(c)===String(r)):l.selected=Vl(t,r)>-1}else l.selected=t.has(r);else if(Js(ya(l),t)){e.selectedIndex!==a&&(e.selectedIndex=a);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function ya(e){return"_value"in e?e._value:e.value}function Hp(e,t){const s=t?"_trueValue":"_falseValue";return s in e?e[s]:t}const Vp={created(e,t,s){Gi(e,t,s,null,"created")},mounted(e,t,s){Gi(e,t,s,null,"mounted")},beforeUpdate(e,t,s,n){Gi(e,t,s,n,"beforeUpdate")},updated(e,t,s,n){Gi(e,t,s,n,"updated")}};function jp(e,t){switch(e){case"SELECT":return Bp;case"TEXTAREA":return kl;default:switch(t){case"checkbox":return Xo;case"radio":return ec;default:return kl}}}function Gi(e,t,s,n,a){const l=jp(e.tagName,s.props&&s.props.type)[a];l&&l(e,t,s,n)}function my(){kl.getSSRProps=({value:e})=>({value:e}),ec.getSSRProps=({value:e},t)=>{if(t.props&&Js(t.props.value,e))return{checked:!0}},Xo.getSSRProps=({value:e},t)=>{if(pe(e)){if(t.props&&Vl(e,t.props.value)>-1)return{checked:!0}}else if(Hn(e)){if(t.props&&e.has(t.props.value))return{checked:!0}}else if(e)return{checked:!0}},Vp.getSSRProps=(e,t)=>{if(typeof t.type!="string")return;const s=jp(t.type.toUpperCase(),t.props&&t.props.type);if(s.getSSRProps)return s.getSSRProps(e,t)}}const vy=["ctrl","shift","alt","meta"],by={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>vy.some(s=>e[`${s}Key`]&&!t.includes(s))},yy=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((a,...i)=>{for(let l=0;l<t.length;l++){const r=by[t[l]];if(r&&r(a,t))return}return e(a,...i)}))},xy={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},_y=(e,t)=>{const s=e._withKeys||(e._withKeys={}),n=t.join(".");return s[n]||(s[n]=(a=>{if(!("key"in a))return;const i=Qt(a.key);if(t.some(l=>l===i||xy[l]===i))return e(a)}))},zp=De({patchProp:Dp},Ep);let Xa,Mu=!1;function Kp(){return Xa||(Xa=ap(zp))}function qp(){return Xa=Mu?Xa:ip(zp),Mu=!0,Xa}const Gp=((...e)=>{Kp().render(...e)}),ky=((...e)=>{qp().hydrate(...e)}),wl=((...e)=>{const t=Kp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Jp(n);if(!a)return;const i=t._component;!we(i)&&!i.render&&!i.template&&(i.template=a.innerHTML),a.nodeType===1&&(a.textContent="");const l=s(a,!1,Zp(a));return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),l},t}),Wp=((...e)=>{const t=qp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Jp(n);if(a)return s(a,!0,Zp(a))},t});function Zp(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Jp(e){return Ee(e)?document.querySelector(e):e}let Pu=!1;const wy=()=>{Pu||(Pu=!0,my(),zb())},Sy=Object.freeze(Object.defineProperty({__proto__:null,BaseTransition:Mf,BaseTransitionPropsValidators:Fo,Comment:dt,DeprecationTypes:Pb,EffectScope:Eo,ErrorCodes:Um,ErrorTypeStrings:Rb,Fragment:Ct,KeepAlive:bv,ReactiveEffect:ai,Static:On,Suspense:ub,Teleport:ev,Text:gn,TrackOpTypes:Om,Transition:Bb,TransitionGroup:uy,TriggerOpTypes:Lm,VueElement:er,assertNumber:$m,callWithAsyncErrorHandling:ns,callWithErrorHandling:Aa,camelize:Ze,capitalize:Vn,cloneVNode:Ns,compatUtils:Mb,computed:te,createApp:wl,createBlock:ml,createCommentVNode:mp,createElementBlock:mb,createElementVNode:Zo,createHydrationRenderer:ip,createPropsRestProxy:Bv,createRenderer:ap,createSSRApp:Wp,createSlots:Tv,createStaticVNode:yb,createTextVNode:Jo,createVNode:at,customRef:yf,defineAsyncComponent:mv,defineComponent:Ci,defineCustomElement:Mp,defineEmits:Iv,defineExpose:Nv,defineModel:Dv,defineOptions:Ov,defineProps:Rv,defineSSRCustomElement:ay,defineSlots:Lv,devtools:Ib,effect:tm,effectScope:Qg,getCurrentInstance:Kt,getCurrentScope:ef,getCurrentWatcher:Dm,getTransitionRawChildren:Wl,guardReactiveProps:gp,h:va,handleError:jn,hasInjectionContext:Gm,hydrate:ky,hydrateOnIdle:uv,hydrateOnInteraction:hv,hydrateOnMediaQuery:pv,hydrateOnVisible:fv,initCustomFormatter:Cb,initDirectivesForSSR:wy,inject:ds,isMemoSame:Sp,isProxy:Si,isReactive:Gs,isReadonly:Is,isRef:mt,isRuntimeOnly:wb,isShallow:es,isVNode:en,markRaw:vf,mergeDefaults:$v,mergeModels:Uv,mergeProps:vp,nextTick:Tt,nodeOps:Ep,normalizeClass:wi,normalizeProps:Ug,normalizeStyle:ki,onActivated:Uo,onBeforeMount:$f,onBeforeUnmount:Yl,onBeforeUpdate:Ho,onDeactivated:Bo,onErrorCaptured:Vf,onMounted:Ue,onRenderTracked:Hf,onRenderTriggered:Bf,onScopeDispose:Xg,onServerPrefetch:Uf,onUnmounted:ft,onUpdated:Jl,onWatcherCleanup:_f,openBlock:fi,patchProp:Dp,popScopeId:zm,provide:Ja,proxyRefs:Lo,pushScopeId:jm,queuePostFlushCb:ri,reactive:bn,readonly:ol,ref:h,registerRuntimeCompiler:_p,render:Gp,renderList:Sv,renderSlot:Cv,resolveComponent:_v,resolveDirective:wv,resolveDynamicComponent:kv,resolveFilter:Db,resolveTransitionHooks:ma,setBlockTracking:pi,setDevtoolsHook:Nb,setTransitionHooks:Xs,shallowReactive:No,shallowReadonly:xm,shallowRef:Oo,ssrContextKey:Ef,ssrUtils:Lb,stop:sm,toDisplayString:Qd,toHandlerKey:oa,toHandlers:Ev,toRaw:$e,toRef:Rm,toRefs:Cm,toValue:wm,transformVNodeArgs:vb,triggerRef:km,unref:Rs,useAttrs:Fv,useCssModule:ry,useCssVars:Kb,useHost:Pp,useId:sv,useModel:Zv,useSSRContext:Af,useShadowRoot:ly,useSlots:Pv,useTemplateRef:nv,useTransitionState:Po,vModelCheckbox:Xo,vModelDynamic:Vp,vModelRadio:ec,vModelSelect:Bp,vModelText:kl,vShow:Op,version:Tp,warn:Ab,watch:fs,watchEffect:Wm,watchPostEffect:Zm,watchSyncEffect:Rf,withAsyncContext:Hv,withCtx:Mo,withDefaults:Mv,withDirectives:qm,withKeys:_y,withMemo:Eb,withModifiers:yy,withScopeId:Km},Symbol.toStringTag,{value:"Module"}));/**
* @vue/compiler-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const gi=Symbol(""),ei=Symbol(""),tc=Symbol(""),Sl=Symbol(""),Yp=Symbol(""),$n=Symbol(""),Qp=Symbol(""),Xp=Symbol(""),sc=Symbol(""),nc=Symbol(""),Ri=Symbol(""),ac=Symbol(""),eh=Symbol(""),ic=Symbol(""),lc=Symbol(""),rc=Symbol(""),oc=Symbol(""),cc=Symbol(""),uc=Symbol(""),th=Symbol(""),sh=Symbol(""),tr=Symbol(""),Tl=Symbol(""),dc=Symbol(""),fc=Symbol(""),mi=Symbol(""),Ii=Symbol(""),pc=Symbol(""),lo=Symbol(""),Ty=Symbol(""),ro=Symbol(""),Cl=Symbol(""),Cy=Symbol(""),Ey=Symbol(""),hc=Symbol(""),Ay=Symbol(""),Ry=Symbol(""),gc=Symbol(""),nh=Symbol(""),xa={[gi]:"Fragment",[ei]:"Teleport",[tc]:"Suspense",[Sl]:"KeepAlive",[Yp]:"BaseTransition",[$n]:"openBlock",[Qp]:"createBlock",[Xp]:"createElementBlock",[sc]:"createVNode",[nc]:"createElementVNode",[Ri]:"createCommentVNode",[ac]:"createTextVNode",[eh]:"createStaticVNode",[ic]:"resolveComponent",[lc]:"resolveDynamicComponent",[rc]:"resolveDirective",[oc]:"resolveFilter",[cc]:"withDirectives",[uc]:"renderList",[th]:"renderSlot",[sh]:"createSlots",[tr]:"toDisplayString",[Tl]:"mergeProps",[dc]:"normalizeClass",[fc]:"normalizeStyle",[mi]:"normalizeProps",[Ii]:"guardReactiveProps",[pc]:"toHandlers",[lo]:"camelize",[Ty]:"capitalize",[ro]:"toHandlerKey",[Cl]:"setBlockTracking",[Cy]:"pushScopeId",[Ey]:"popScopeId",[hc]:"withCtx",[Ay]:"unref",[Ry]:"isRef",[gc]:"withMemo",[nh]:"isMemoSame"};function Iy(e){Object.getOwnPropertySymbols(e).forEach(t=>{xa[t]=e[t]})}const ls={start:{line:1,column:1,offset:0},end:{line:1,column:1,offset:0},source:""};function Ny(e,t=""){return{type:0,source:t,children:e,helpers:new Set,components:[],directives:[],hoists:[],imports:[],cached:[],temps:0,codegenNode:void 0,loc:ls}}function vi(e,t,s,n,a,i,l,r=!1,o=!1,c=!1,u=ls){return e&&(r?(e.helper($n),e.helper(wa(e.inSSR,c))):e.helper(ka(e.inSSR,c)),l&&e.helper(cc)),{type:13,tag:t,props:s,children:n,patchFlag:a,dynamicProps:i,directives:l,isBlock:r,disableTracking:o,isComponent:c,loc:u}}function Ln(e,t=ls){return{type:17,loc:t,elements:e}}function us(e,t=ls){return{type:15,loc:t,properties:e}}function gt(e,t){return{type:16,loc:ls,key:Ee(e)?Ie(e,!0):e,value:t}}function Ie(e,t=!1,s=ls,n=0){return{type:4,loc:s,content:e,isStatic:t,constType:t?3:n}}function ys(e,t=ls){return{type:8,loc:t,children:e}}function kt(e,t=[],s=ls){return{type:14,loc:s,callee:e,arguments:t}}function _a(e,t=void 0,s=!1,n=!1,a=ls){return{type:18,params:e,returns:t,newline:s,isSlot:n,loc:a}}function oo(e,t,s,n=!0){return{type:19,test:e,consequent:t,alternate:s,newline:n,loc:ls}}function Oy(e,t,s=!1,n=!1){return{type:20,index:e,value:t,needPauseTracking:s,inVOnce:n,needArraySpread:!1,loc:ls}}function Ly(e){return{type:21,body:e,loc:ls}}function ka(e,t){return e||t?sc:nc}function wa(e,t){return e||t?Qp:Xp}function mc(e,{helper:t,removeHelper:s,inSSR:n}){e.isBlock||(e.isBlock=!0,s(ka(n,e.isComponent)),t($n),t(wa(n,e.isComponent)))}const Fu=new Uint8Array([123,123]),$u=new Uint8Array([125,125]);function Uu(e){return e>=97&&e<=122||e>=65&&e<=90}function ts(e){return e===32||e===10||e===9||e===12||e===13}function rn(e){return e===47||e===62||ts(e)}function El(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t}const Lt={Cdata:new Uint8Array([67,68,65,84,65,91]),CdataEnd:new Uint8Array([93,93,62]),CommentEnd:new Uint8Array([45,45,62]),ScriptEnd:new Uint8Array([60,47,115,99,114,105,112,116]),StyleEnd:new Uint8Array([60,47,115,116,121,108,101]),TitleEnd:new Uint8Array([60,47,116,105,116,108,101]),TextareaEnd:new Uint8Array([60,47,116,101,120,116,97,114,101,97])};class Dy{constructor(t,s){this.stack=t,this.cbs=s,this.state=1,this.buffer="",this.sectionStart=0,this.index=0,this.entityStart=0,this.baseState=1,this.inRCDATA=!1,this.inXML=!1,this.inVPre=!1,this.newlines=[],this.mode=0,this.delimiterOpen=Fu,this.delimiterClose=$u,this.delimiterIndex=-1,this.currentSequence=void 0,this.sequenceIndex=0}get inSFCRoot(){return this.mode===2&&this.stack.length===0}reset(){this.state=1,this.mode=0,this.buffer="",this.sectionStart=0,this.index=0,this.baseState=1,this.inRCDATA=!1,this.currentSequence=void 0,this.newlines.length=0,this.delimiterOpen=Fu,this.delimiterClose=$u}getPos(t){let s=1,n=t+1;const a=this.newlines.length;let i=-1;if(a>100){let l=-1,r=a;for(;l+1<r;){const o=l+r>>>1;this.newlines[o]<t?l=o:r=o}i=l}else for(let l=a-1;l>=0;l--)if(t>this.newlines[l]){i=l;break}return i>=0&&(s=i+2,n=t-this.newlines[i]),{column:n,line:s,offset:t}}peek(){return this.buffer.charCodeAt(this.index+1)}stateText(t){t===60?(this.index>this.sectionStart&&this.cbs.ontext(this.sectionStart,this.index),this.state=5,this.sectionStart=this.index):!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t))}stateInterpolationOpen(t){if(t===this.delimiterOpen[this.delimiterIndex])if(this.delimiterIndex===this.delimiterOpen.length-1){const s=this.index+1-this.delimiterOpen.length;s>this.sectionStart&&this.cbs.ontext(this.sectionStart,s),this.state=3,this.sectionStart=s}else this.delimiterIndex++;else this.inRCDATA?(this.state=32,this.stateInRCDATA(t)):(this.state=1,this.stateText(t))}stateInterpolation(t){t===this.delimiterClose[0]&&(this.state=4,this.delimiterIndex=0,this.stateInterpolationClose(t))}stateInterpolationClose(t){t===this.delimiterClose[this.delimiterIndex]?this.delimiterIndex===this.delimiterClose.length-1?(this.cbs.oninterpolation(this.sectionStart,this.index+1),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):this.delimiterIndex++:(this.state=3,this.stateInterpolation(t))}stateSpecialStartSequence(t){const s=this.sequenceIndex===this.currentSequence.length;if(!(s?rn(t):(t|32)===this.currentSequence[this.sequenceIndex]))this.inRCDATA=!1;else if(!s){this.sequenceIndex++;return}this.sequenceIndex=0,this.state=6,this.stateInTagName(t)}stateInRCDATA(t){if(this.sequenceIndex===this.currentSequence.length){if(t===62||ts(t)){const s=this.index-this.currentSequence.length;if(this.sectionStart<s){const n=this.index;this.index=s,this.cbs.ontext(this.sectionStart,s),this.index=n}this.sectionStart=s+2,this.stateInClosingTagName(t),this.inRCDATA=!1;return}this.sequenceIndex=0}(t|32)===this.currentSequence[this.sequenceIndex]?this.sequenceIndex+=1:this.sequenceIndex===0?this.currentSequence===Lt.TitleEnd||this.currentSequence===Lt.TextareaEnd&&!this.inSFCRoot?!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t)):this.fastForwardTo(60)&&(this.sequenceIndex=1):this.sequenceIndex=+(t===60)}stateCDATASequence(t){t===Lt.Cdata[this.sequenceIndex]?++this.sequenceIndex===Lt.Cdata.length&&(this.state=28,this.currentSequence=Lt.CdataEnd,this.sequenceIndex=0,this.sectionStart=this.index+1):(this.sequenceIndex=0,this.state=23,this.stateInDeclaration(t))}fastForwardTo(t){for(;++this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);if(s===10&&this.newlines.push(this.index),s===t)return!0}return this.index=this.buffer.length-1,!1}stateInCommentLike(t){t===this.currentSequence[this.sequenceIndex]?++this.sequenceIndex===this.currentSequence.length&&(this.currentSequence===Lt.CdataEnd?this.cbs.oncdata(this.sectionStart,this.index-2):this.cbs.oncomment(this.sectionStart,this.index-2),this.sequenceIndex=0,this.sectionStart=this.index+1,this.state=1):this.sequenceIndex===0?this.fastForwardTo(this.currentSequence[0])&&(this.sequenceIndex=1):t!==this.currentSequence[this.sequenceIndex-1]&&(this.sequenceIndex=0)}startSpecial(t,s){this.enterRCDATA(t,s),this.state=31}enterRCDATA(t,s){this.inRCDATA=!0,this.currentSequence=t,this.sequenceIndex=s}stateBeforeTagName(t){t===33?(this.state=22,this.sectionStart=this.index+1):t===63?(this.state=24,this.sectionStart=this.index+1):Uu(t)?(this.sectionStart=this.index,this.mode===0?this.state=6:this.inSFCRoot?this.state=34:this.inXML?this.state=6:t===116?this.state=30:this.state=t===115?29:6):t===47?this.state=8:(this.state=1,this.stateText(t))}stateInTagName(t){rn(t)&&this.handleTagName(t)}stateInSFCRootTagName(t){if(rn(t)){const s=this.buffer.slice(this.sectionStart,this.index);s!=="template"&&this.enterRCDATA(El("</"+s),0),this.handleTagName(t)}}handleTagName(t){this.cbs.onopentagname(this.sectionStart,this.index),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)}stateBeforeClosingTagName(t){ts(t)||(t===62?(this.state=1,this.sectionStart=this.index+1):(this.state=Uu(t)?9:27,this.sectionStart=this.index))}stateInClosingTagName(t){(t===62||ts(t))&&(this.cbs.onclosetag(this.sectionStart,this.index),this.sectionStart=-1,this.state=10,this.stateAfterClosingTagName(t))}stateAfterClosingTagName(t){t===62&&(this.state=1,this.sectionStart=this.index+1)}stateBeforeAttrName(t){t===62?(this.cbs.onopentagend(this.index),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):t===47?this.state=7:t===60&&this.peek()===47?(this.cbs.onopentagend(this.index),this.state=5,this.sectionStart=this.index):ts(t)||this.handleAttrStart(t)}handleAttrStart(t){t===118&&this.peek()===45?(this.state=13,this.sectionStart=this.index):t===46||t===58||t===64||t===35?(this.cbs.ondirname(this.index,this.index+1),this.state=14,this.sectionStart=this.index+1):(this.state=12,this.sectionStart=this.index)}stateInSelfClosingTag(t){t===62?(this.cbs.onselfclosingtag(this.index),this.state=1,this.sectionStart=this.index+1,this.inRCDATA=!1):ts(t)||(this.state=11,this.stateBeforeAttrName(t))}stateInAttrName(t){(t===61||rn(t))&&(this.cbs.onattribname(this.sectionStart,this.index),this.handleAttrNameEnd(t))}stateInDirName(t){t===61||rn(t)?(this.cbs.ondirname(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===58?(this.cbs.ondirname(this.sectionStart,this.index),this.state=14,this.sectionStart=this.index+1):t===46&&(this.cbs.ondirname(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDirArg(t){t===61||rn(t)?(this.cbs.ondirarg(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===91?this.state=15:t===46&&(this.cbs.ondirarg(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDynamicDirArg(t){t===93?this.state=14:(t===61||rn(t))&&(this.cbs.ondirarg(this.sectionStart,this.index+1),this.handleAttrNameEnd(t))}stateInDirModifier(t){t===61||rn(t)?(this.cbs.ondirmodifier(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===46&&(this.cbs.ondirmodifier(this.sectionStart,this.index),this.sectionStart=this.index+1)}handleAttrNameEnd(t){this.sectionStart=this.index,this.state=17,this.cbs.onattribnameend(this.index),this.stateAfterAttrName(t)}stateAfterAttrName(t){t===61?this.state=18:t===47||t===62?(this.cbs.onattribend(0,this.sectionStart),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)):ts(t)||(this.cbs.onattribend(0,this.sectionStart),this.handleAttrStart(t))}stateBeforeAttrValue(t){t===34?(this.state=19,this.sectionStart=this.index+1):t===39?(this.state=20,this.sectionStart=this.index+1):ts(t)||(this.sectionStart=this.index,this.state=21,this.stateInAttrValueNoQuotes(t))}handleInAttrValue(t,s){(t===s||this.fastForwardTo(s))&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(s===34?3:2,this.index+1),this.state=11)}stateInAttrValueDoubleQuotes(t){this.handleInAttrValue(t,34)}stateInAttrValueSingleQuotes(t){this.handleInAttrValue(t,39)}stateInAttrValueNoQuotes(t){ts(t)||t===62?(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(1,this.index),this.state=11,this.stateBeforeAttrName(t)):(t===39||t===60||t===61||t===96)&&this.cbs.onerr(18,this.index)}stateBeforeDeclaration(t){t===91?(this.state=26,this.sequenceIndex=0):this.state=t===45?25:23}stateInDeclaration(t){(t===62||this.fastForwardTo(62))&&(this.state=1,this.sectionStart=this.index+1)}stateInProcessingInstruction(t){(t===62||this.fastForwardTo(62))&&(this.cbs.onprocessinginstruction(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeComment(t){t===45?(this.state=28,this.currentSequence=Lt.CommentEnd,this.sequenceIndex=2,this.sectionStart=this.index+1):this.state=23}stateInSpecialComment(t){(t===62||this.fastForwardTo(62))&&(this.cbs.oncomment(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeSpecialS(t){t===Lt.ScriptEnd[3]?this.startSpecial(Lt.ScriptEnd,4):t===Lt.StyleEnd[3]?this.startSpecial(Lt.StyleEnd,4):(this.state=6,this.stateInTagName(t))}stateBeforeSpecialT(t){t===Lt.TitleEnd[3]?this.startSpecial(Lt.TitleEnd,4):t===Lt.TextareaEnd[3]?this.startSpecial(Lt.TextareaEnd,4):(this.state=6,this.stateInTagName(t))}startEntity(){}stateInEntity(){}parse(t){for(this.buffer=t;this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);switch(s===10&&this.state!==33&&this.newlines.push(this.index),this.state){case 1:{this.stateText(s);break}case 2:{this.stateInterpolationOpen(s);break}case 3:{this.stateInterpolation(s);break}case 4:{this.stateInterpolationClose(s);break}case 31:{this.stateSpecialStartSequence(s);break}case 32:{this.stateInRCDATA(s);break}case 26:{this.stateCDATASequence(s);break}case 19:{this.stateInAttrValueDoubleQuotes(s);break}case 12:{this.stateInAttrName(s);break}case 13:{this.stateInDirName(s);break}case 14:{this.stateInDirArg(s);break}case 15:{this.stateInDynamicDirArg(s);break}case 16:{this.stateInDirModifier(s);break}case 28:{this.stateInCommentLike(s);break}case 27:{this.stateInSpecialComment(s);break}case 11:{this.stateBeforeAttrName(s);break}case 6:{this.stateInTagName(s);break}case 34:{this.stateInSFCRootTagName(s);break}case 9:{this.stateInClosingTagName(s);break}case 5:{this.stateBeforeTagName(s);break}case 17:{this.stateAfterAttrName(s);break}case 20:{this.stateInAttrValueSingleQuotes(s);break}case 18:{this.stateBeforeAttrValue(s);break}case 8:{this.stateBeforeClosingTagName(s);break}case 10:{this.stateAfterClosingTagName(s);break}case 29:{this.stateBeforeSpecialS(s);break}case 30:{this.stateBeforeSpecialT(s);break}case 21:{this.stateInAttrValueNoQuotes(s);break}case 7:{this.stateInSelfClosingTag(s);break}case 23:{this.stateInDeclaration(s);break}case 22:{this.stateBeforeDeclaration(s);break}case 25:{this.stateBeforeComment(s);break}case 24:{this.stateInProcessingInstruction(s);break}case 33:{this.stateInEntity();break}}this.index++}this.cleanup(),this.finish()}cleanup(){this.sectionStart!==this.index&&(this.state===1||this.state===32&&this.sequenceIndex===0?(this.cbs.ontext(this.sectionStart,this.index),this.sectionStart=this.index):(this.state===19||this.state===20||this.state===21)&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=this.index))}finish(){this.handleTrailingData(),this.cbs.onend()}handleTrailingData(){const t=this.buffer.length;this.sectionStart>=t||(this.state===28?this.currentSequence===Lt.CdataEnd?this.cbs.oncdata(this.sectionStart,t):this.cbs.oncomment(this.sectionStart,t):this.state===6||this.state===11||this.state===18||this.state===17||this.state===12||this.state===13||this.state===14||this.state===15||this.state===16||this.state===20||this.state===19||this.state===21||this.state===9||this.cbs.ontext(this.sectionStart,t))}emitCodePoint(t,s){}}function Bu(e,{compatConfig:t}){const s=t&&t[e];return e==="MODE"?s||3:s}function Dn(e,t){const s=Bu("MODE",t),n=Bu(e,t);return s===3?n===!0:n!==!1}function bi(e,t,s,...n){return Dn(e,t)}function vc(e){throw e}function ah(e){}function tt(e,t,s,n){const a=`https://vuejs.org/error-reference/#compiler-${e}`,i=new SyntaxError(String(a));return i.code=e,i.loc=t,i}const Xt=e=>e.type===4&&e.isStatic;function ih(e){switch(e){case"Teleport":case"teleport":return ei;case"Suspense":case"suspense":return tc;case"KeepAlive":case"keep-alive":return Sl;case"BaseTransition":case"base-transition":return Yp}}const My=/^$|^\d|[^\$\w\xA0-\uFFFF]/,bc=e=>!My.test(e),lh=/[A-Za-z_$\xA0-\uFFFF]/,Py=/[\.\?\w$\xA0-\uFFFF]/,Fy=/\s+[.[]\s*|\s*[.[]\s+/g,rh=e=>e.type===4?e.content:e.loc.source,$y=e=>{const t=rh(e).trim().replace(Fy,r=>r.trim());let s=0,n=[],a=0,i=0,l=null;for(let r=0;r<t.length;r++){const o=t.charAt(r);switch(s){case 0:if(o==="[")n.push(s),s=1,a++;else if(o==="(")n.push(s),s=2,i++;else if(!(r===0?lh:Py).test(o))return!1;break;case 1:o==="'"||o==='"'||o==="`"?(n.push(s),s=3,l=o):o==="["?a++:o==="]"&&(--a||(s=n.pop()));break;case 2:if(o==="'"||o==='"'||o==="`")n.push(s),s=3,l=o;else if(o==="(")i++;else if(o===")"){if(r===t.length-1)return!1;--i||(s=n.pop())}break;case 3:o===l&&(s=n.pop(),l=null);break}}return!a&&!i},oh=$y,Uy=/^\s*(?:async\s*)?(?:\([^)]*?\)|[\w$_]+)\s*(?::[^=]+)?=>|^\s*(?:async\s+)?function(?:\s+[\w$]+)?\s*\(/,By=e=>Uy.test(rh(e)),Hy=By;function cs(e,t,s=!1){for(let n=0;n<e.props.length;n++){const a=e.props[n];if(a.type===7&&(s||a.exp)&&(Ee(t)?a.name===t:t.test(a.name)))return a}}function sr(e,t,s=!1,n=!1){for(let a=0;a<e.props.length;a++){const i=e.props[a];if(i.type===6){if(s)continue;if(i.name===t&&(i.value||n))return i}else if(i.name==="bind"&&(i.exp||n)&&En(i.arg,t))return i}}function En(e,t){return!!(e&&Xt(e)&&e.content===t)}function Vy(e){return e.props.some(t=>t.type===7&&t.name==="bind"&&(!t.arg||t.arg.type!==4||!t.arg.isStatic))}function Cr(e){return e.type===5||e.type===2}function Hu(e){return e.type===7&&e.name==="pre"}function jy(e){return e.type===7&&e.name==="slot"}function Al(e){return e.type===1&&e.tagType===3}function Rl(e){return e.type===1&&e.tagType===2}const zy=new Set([mi,Ii]);function ch(e,t=[]){if(e&&!Ee(e)&&e.type===14){const s=e.callee;if(!Ee(s)&&zy.has(s))return ch(e.arguments[0],t.concat(e))}return[e,t]}function Il(e,t,s){let n,a=e.type===13?e.props:e.arguments[2],i=[],l;if(a&&!Ee(a)&&a.type===14){const r=ch(a);a=r[0],i=r[1],l=i[i.length-1]}if(a==null||Ee(a))n=us([t]);else if(a.type===14){const r=a.arguments[0];!Ee(r)&&r.type===15?Vu(t,r)||r.properties.unshift(t):a.callee===pc?n=kt(s.helper(Tl),[us([t]),a]):a.arguments.unshift(us([t])),!n&&(n=a)}else a.type===15?(Vu(t,a)||a.properties.unshift(t),n=a):(n=kt(s.helper(Tl),[us([t]),a]),l&&l.callee===Ii&&(l=i[i.length-2]));e.type===13?l?l.arguments[0]=n:e.props=n:l?l.arguments[0]=n:e.arguments[2]=n}function Vu(e,t){let s=!1;if(e.key.type===4){const n=e.key.content;s=t.properties.some(a=>a.key.type===4&&a.key.content===n)}return s}function yi(e,t){return`_${t}_${e.replace(/[^\w]/g,(s,n)=>s==="-"?"_":e.charCodeAt(n).toString())}`}function Ky(e){return e.type===14&&e.callee===gc?e.arguments[1].returns:e}const qy=/([\s\S]*?)\s+(?:in|of)\s+(\S[\s\S]*)/;function uh(e){for(let t=0;t<e.length;t++)if(!ts(e.charCodeAt(t)))return!1;return!0}function yc(e){return e.type===2&&uh(e.content)||e.type===12&&yc(e.content)}function dh(e){return e.type===3||yc(e)}const fh={parseMode:"base",ns:0,delimiters:["{{","}}"],getNamespace:()=>0,isVoidTag:aa,isPreTag:aa,isIgnoreNewlineTag:aa,isCustomElement:aa,onError:vc,onWarn:ah,comments:!1,prefixIdentifiers:!1};let He=fh,xi=null,Zs="",Mt=null,Fe=null,Wt="",Fs=-1,Tn=-1,xc=0,pn=!1,co=null;const et=[],ot=new Dy(et,{onerr:Ds,ontext(e,t){Wi(At(e,t),e,t)},ontextentity(e,t,s){Wi(e,t,s)},oninterpolation(e,t){if(pn)return Wi(At(e,t),e,t);let s=e+ot.delimiterOpen.length,n=t-ot.delimiterClose.length;for(;ts(Zs.charCodeAt(s));)s++;for(;ts(Zs.charCodeAt(n-1));)n--;let a=At(s,n);a.includes("&")&&(a=He.decodeEntities(a,!1)),uo({type:5,content:sl(a,!1,ut(s,n)),loc:ut(e,t)})},onopentagname(e,t){const s=At(e,t);Mt={type:1,tag:s,ns:He.getNamespace(s,et[0],He.ns),tagType:0,props:[],children:[],loc:ut(e-1,t),codegenNode:void 0}},onopentagend(e){zu(e)},onclosetag(e,t){const s=At(e,t);if(!He.isVoidTag(s)){let n=!1;for(let a=0;a<et.length;a++)if(et[a].tag.toLowerCase()===s.toLowerCase()){n=!0,a>0&&Ds(24,et[0].loc.start.offset);for(let l=0;l<=a;l++){const r=et.shift();tl(r,t,l<a)}break}n||Ds(23,ph(e,60))}},onselfclosingtag(e){const t=Mt.tag;Mt.isSelfClosing=!0,zu(e),et[0]&&et[0].tag===t&&tl(et.shift(),e)},onattribname(e,t){Fe={type:6,name:At(e,t),nameLoc:ut(e,t),value:void 0,loc:ut(e)}},ondirname(e,t){const s=At(e,t),n=s==="."||s===":"?"bind":s==="@"?"on":s==="#"?"slot":s.slice(2);if(!pn&&n===""&&Ds(26,e),pn||n==="")Fe={type:6,name:s,nameLoc:ut(e,t),value:void 0,loc:ut(e)};else if(Fe={type:7,name:n,rawName:s,exp:void 0,arg:void 0,modifiers:s==="."?[Ie("prop")]:[],loc:ut(e)},n==="pre"){pn=ot.inVPre=!0,co=Mt;const a=Mt.props;for(let i=0;i<a.length;i++)a[i].type===7&&(a[i]=s0(a[i]))}},ondirarg(e,t){if(e===t)return;const s=At(e,t);if(pn&&!Hu(Fe))Fe.name+=s,An(Fe.nameLoc,t);else{const n=s[0]!=="[";Fe.arg=sl(n?s:s.slice(1,-1),n,ut(e,t),n?3:0)}},ondirmodifier(e,t){const s=At(e,t);if(pn&&!Hu(Fe))Fe.name+="."+s,An(Fe.nameLoc,t);else if(Fe.name==="slot"){const n=Fe.arg;n&&(n.content+="."+s,An(n.loc,t))}else{const n=Ie(s,!0,ut(e,t));Fe.modifiers.push(n)}},onattribdata(e,t){Wt+=At(e,t),Fs<0&&(Fs=e),Tn=t},onattribentity(e,t,s){Wt+=e,Fs<0&&(Fs=t),Tn=s},onattribnameend(e){const t=Fe.loc.start.offset,s=At(t,e);Fe.type===7&&(Fe.rawName=s),Mt.props.some(n=>(n.type===7?n.rawName:n.name)===s)&&Ds(2,t)},onattribend(e,t){if(Mt&&Fe){if(An(Fe.loc,t),e!==0)if(Wt.includes("&")&&(Wt=He.decodeEntities(Wt,!0)),Fe.type===6)Fe.name==="class"&&(Wt=gh(Wt).trim()),e===1&&!Wt&&Ds(13,t),Fe.value={type:2,content:Wt,loc:e===1?ut(Fs,Tn):ut(Fs-1,Tn+1)},ot.inSFCRoot&&Mt.tag==="template"&&Fe.name==="lang"&&Wt&&Wt!=="html"&&ot.enterRCDATA(El("</template"),0);else{let s=0;Fe.exp=sl(Wt,!1,ut(Fs,Tn),0,s),Fe.name==="for"&&(Fe.forParseResult=Wy(Fe.exp));let n=-1;Fe.name==="bind"&&(n=Fe.modifiers.findIndex(a=>a.content==="sync"))>-1&&bi("COMPILER_V_BIND_SYNC",He,Fe.loc,Fe.arg.loc.source)&&(Fe.name="model",Fe.modifiers.splice(n,1))}(Fe.type!==7||Fe.name!=="pre")&&Mt.props.push(Fe)}Wt="",Fs=Tn=-1},oncomment(e,t){He.comments&&uo({type:3,content:At(e,t),loc:ut(e-4,t+3)})},onend(){const e=Zs.length;for(let t=0;t<et.length;t++)tl(et[t],e-1),Ds(24,et[t].loc.start.offset)},oncdata(e,t){(et[0]?et[0].ns:He.ns)!==0?Wi(At(e,t),e,t):Ds(1,e-9)},onprocessinginstruction(e){(et[0]?et[0].ns:He.ns)===0&&Ds(21,e-1)}}),ju=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,Gy=/^\(|\)$/g;function Wy(e){const t=e.loc,s=e.content,n=s.match(qy);if(!n)return;const[,a,i]=n,l=(d,f,p=!1)=>{const m=t.start.offset+f,g=m+d.length;return sl(d,!1,ut(m,g),0,p?1:0)},r={source:l(i.trim(),s.indexOf(i,a.length)),value:void 0,key:void 0,index:void 0,finalized:!1};let o=a.trim().replace(Gy,"").trim();const c=a.indexOf(o),u=o.match(ju);if(u){o=o.replace(ju,"").trim();const d=u[1].trim();let f;if(d&&(f=s.indexOf(d,c+o.length),r.key=l(d,f,!0)),u[2]){const p=u[2].trim();p&&(r.index=l(p,s.indexOf(p,r.key?f+d.length:c+o.length),!0))}}return o&&(r.value=l(o,c,!0)),r}function At(e,t){return Zs.slice(e,t)}function zu(e){ot.inSFCRoot&&(Mt.innerLoc=ut(e+1,e+1)),uo(Mt);const{tag:t,ns:s}=Mt;s===0&&He.isPreTag(t)&&xc++,He.isVoidTag(t)?tl(Mt,e):(et.unshift(Mt),(s===1||s===2)&&(ot.inXML=!0)),Mt=null}function Wi(e,t,s){{const i=et[0]&&et[0].tag;i!=="script"&&i!=="style"&&e.includes("&")&&(e=He.decodeEntities(e,!1))}const n=et[0]||xi,a=n.children[n.children.length-1];a&&a.type===2?(a.content+=e,An(a.loc,s)):n.children.push({type:2,content:e,loc:ut(t,s)})}function tl(e,t,s=!1){s?An(e.loc,ph(t,60)):An(e.loc,Zy(t,62)+1),ot.inSFCRoot&&(e.children.length?e.innerLoc.end=De({},e.children[e.children.length-1].loc.end):e.innerLoc.end=De({},e.innerLoc.start),e.innerLoc.source=At(e.innerLoc.start.offset,e.innerLoc.end.offset));const{tag:n,ns:a,children:i}=e;if(pn||(n==="slot"?e.tagType=2:Ku(e)?e.tagType=3:Yy(e)&&(e.tagType=1)),ot.inRCDATA||(e.children=hh(i)),a===0&&He.isIgnoreNewlineTag(n)){const l=i[0];l&&l.type===2&&(l.content=l.content.replace(/^\r?\n/,""))}a===0&&He.isPreTag(n)&&xc--,co===e&&(pn=ot.inVPre=!1,co=null),ot.inXML&&(et[0]?et[0].ns:He.ns)===0&&(ot.inXML=!1);{const l=e.props;if(!ot.inSFCRoot&&Dn("COMPILER_NATIVE_TEMPLATE",He)&&e.tag==="template"&&!Ku(e)){const o=et[0]||xi,c=o.children.indexOf(e);o.children.splice(c,1,...e.children)}const r=l.find(o=>o.type===6&&o.name==="inline-template");r&&bi("COMPILER_INLINE_TEMPLATE",He,r.loc)&&e.children.length&&(r.value={type:2,content:At(e.children[0].loc.start.offset,e.children[e.children.length-1].loc.end.offset),loc:r.loc})}}function Zy(e,t){let s=e;for(;Zs.charCodeAt(s)!==t&&s<Zs.length-1;)s++;return s}function ph(e,t){let s=e;for(;Zs.charCodeAt(s)!==t&&s>=0;)s--;return s}const Jy=new Set(["if","else","else-if","for","slot"]);function Ku({tag:e,props:t}){if(e==="template"){for(let s=0;s<t.length;s++)if(t[s].type===7&&Jy.has(t[s].name))return!0}return!1}function Yy({tag:e,props:t}){if(He.isCustomElement(e))return!1;if(e==="component"||Qy(e.charCodeAt(0))||ih(e)||He.isBuiltInComponent&&He.isBuiltInComponent(e)||He.isNativeTag&&!He.isNativeTag(e))return!0;for(let s=0;s<t.length;s++){const n=t[s];if(n.type===6){if(n.name==="is"&&n.value){if(n.value.content.startsWith("vue:"))return!0;if(bi("COMPILER_IS_ON_ELEMENT",He,n.loc))return!0}}else if(n.name==="bind"&&En(n.arg,"is")&&bi("COMPILER_IS_ON_ELEMENT",He,n.loc))return!0}return!1}function Qy(e){return e>64&&e<91}const Xy=/\r\n/g;function hh(e){const t=He.whitespace!=="preserve";let s=!1;for(let n=0;n<e.length;n++){const a=e[n];if(a.type===2)if(xc)a.content=a.content.replace(Xy,`
`);else if(uh(a.content)){const i=e[n-1]&&e[n-1].type,l=e[n+1]&&e[n+1].type;!i||!l||t&&(i===3&&(l===3||l===1)||i===1&&(l===3||l===1&&e0(a.content)))?(s=!0,e[n]=null):a.content=" "}else t&&(a.content=gh(a.content))}return s?e.filter(Boolean):e}function e0(e){for(let t=0;t<e.length;t++){const s=e.charCodeAt(t);if(s===10||s===13)return!0}return!1}function gh(e){let t="",s=!1;for(let n=0;n<e.length;n++)ts(e.charCodeAt(n))?s||(t+=" ",s=!0):(t+=e[n],s=!1);return t}function uo(e){(et[0]||xi).children.push(e)}function ut(e,t){return{start:ot.getPos(e),end:t==null?t:ot.getPos(t),source:t==null?t:At(e,t)}}function t0(e){return ut(e.start.offset,e.end.offset)}function An(e,t){e.end=ot.getPos(t),e.source=At(e.start.offset,t)}function s0(e){const t={type:6,name:e.rawName,nameLoc:ut(e.loc.start.offset,e.loc.start.offset+e.rawName.length),value:void 0,loc:e.loc};if(e.exp){const s=e.exp.loc;s.end.offset<e.loc.end.offset&&(s.start.offset--,s.start.column--,s.end.offset++,s.end.column++),t.value={type:2,content:e.exp.content,loc:s}}return t}function sl(e,t=!1,s,n=0,a=0){return Ie(e,t,s,n)}function Ds(e,t,s){He.onError(tt(e,ut(t,t)))}function n0(){ot.reset(),Mt=null,Fe=null,Wt="",Fs=-1,Tn=-1,et.length=0}function a0(e,t){if(n0(),Zs=e,He=De({},fh),t){let a;for(a in t)t[a]!=null&&(He[a]=t[a])}ot.mode=He.parseMode==="html"?1:He.parseMode==="sfc"?2:0,ot.inXML=He.ns===1||He.ns===2;const s=t&&t.delimiters;s&&(ot.delimiterOpen=El(s[0]),ot.delimiterClose=El(s[1]));const n=xi=Ny([],e);return ot.parse(Zs),n.loc=ut(0,e.length),n.children=hh(n.children),xi=null,n}function i0(e,t){nl(e,void 0,t,!!mh(e))}function mh(e){const t=e.children.filter(s=>s.type!==3);return t.length===1&&t[0].type===1&&!Rl(t[0])?t[0]:null}function nl(e,t,s,n=!1,a=!1){const{children:i}=e,l=[];for(let u=0;u<i.length;u++){const d=i[u];if(d.type===1&&d.tagType===0){const f=n?0:ss(d,s);if(f>0){if(f>=2){d.codegenNode.patchFlag=-1,l.push(d);continue}}else{const p=d.codegenNode;if(p.type===13){const m=p.patchFlag;if((m===void 0||m===512||m===1)&&bh(d,s)>=2){const g=yh(d);g&&(p.props=s.hoist(g))}p.dynamicProps&&(p.dynamicProps=s.hoist(p.dynamicProps))}}}else if(d.type===12&&(n?0:ss(d,s))>=2){d.codegenNode.type===14&&d.codegenNode.arguments.length>0&&d.codegenNode.arguments.push("-1"),l.push(d);continue}if(d.type===1){const f=d.tagType===1;f&&s.scopes.vSlot++,nl(d,e,s,!1,a),f&&s.scopes.vSlot--}else if(d.type===11)nl(d,e,s,d.children.length===1,!0);else if(d.type===9)for(let f=0;f<d.branches.length;f++)nl(d.branches[f],e,s,d.branches[f].children.length===1,a)}let r=!1;if(l.length===i.length&&e.type===1){if(e.tagType===0&&e.codegenNode&&e.codegenNode.type===13&&pe(e.codegenNode.children))e.codegenNode.children=o(Ln(e.codegenNode.children)),r=!0;else if(e.tagType===1&&e.codegenNode&&e.codegenNode.type===13&&e.codegenNode.children&&!pe(e.codegenNode.children)&&e.codegenNode.children.type===15){const u=c(e.codegenNode,"default");u&&(u.returns=o(Ln(u.returns)),r=!0)}else if(e.tagType===3&&t&&t.type===1&&t.tagType===1&&t.codegenNode&&t.codegenNode.type===13&&t.codegenNode.children&&!pe(t.codegenNode.children)&&t.codegenNode.children.type===15){const u=cs(e,"slot",!0),d=u&&u.arg&&c(t.codegenNode,u.arg);d&&(d.returns=o(Ln(d.returns)),r=!0)}}if(!r)for(const u of l)u.codegenNode=s.cache(u.codegenNode);function o(u){const d=s.cache(u);return d.needArraySpread=!0,d}function c(u,d){if(u.children&&!pe(u.children)&&u.children.type===15){const f=u.children.properties.find(p=>p.key===d||p.key.content===d);return f&&f.value}}l.length&&s.transformHoist&&s.transformHoist(i,s,e)}function ss(e,t){const{constantCache:s}=t;switch(e.type){case 1:if(e.tagType!==0)return 0;const n=s.get(e);if(n!==void 0)return n;const a=e.codegenNode;if(a.type!==13||a.isBlock&&e.tag!=="svg"&&e.tag!=="foreignObject"&&e.tag!=="math")return 0;if(a.patchFlag===void 0){let l=3;const r=bh(e,t);if(r===0)return s.set(e,0),0;r<l&&(l=r);for(let o=0;o<e.children.length;o++){const c=ss(e.children[o],t);if(c===0)return s.set(e,0),0;c<l&&(l=c)}if(l>1)for(let o=0;o<e.props.length;o++){const c=e.props[o];if(c.type===7&&c.name==="bind"&&c.exp){const u=ss(c.exp,t);if(u===0)return s.set(e,0),0;u<l&&(l=u)}}if(a.isBlock){for(let o=0;o<e.props.length;o++)if(e.props[o].type===7)return s.set(e,0),0;t.removeHelper($n),t.removeHelper(wa(t.inSSR,a.isComponent)),a.isBlock=!1,t.helper(ka(t.inSSR,a.isComponent))}return s.set(e,l),l}else return s.set(e,0),0;case 2:case 3:return 3;case 9:case 11:case 10:return 0;case 5:case 12:return ss(e.content,t);case 4:return e.constType;case 8:let i=3;for(let l=0;l<e.children.length;l++){const r=e.children[l];if(Ee(r)||Ut(r))continue;const o=ss(r,t);if(o===0)return 0;o<i&&(i=o)}return i;case 20:return 2;default:return 0}}const l0=new Set([dc,fc,mi,Ii]);function vh(e,t){if(e.type===14&&!Ee(e.callee)&&l0.has(e.callee)){const s=e.arguments[0];if(s.type===4)return ss(s,t);if(s.type===14)return vh(s,t)}return 0}function bh(e,t){let s=3;const n=yh(e);if(n&&n.type===15){const{properties:a}=n;for(let i=0;i<a.length;i++){const{key:l,value:r}=a[i],o=ss(l,t);if(o===0)return o;o<s&&(s=o);let c;if(r.type===4?c=ss(r,t):r.type===14?c=vh(r,t):c=0,c===0)return c;c<s&&(s=c)}}return s}function yh(e){const t=e.codegenNode;if(t.type===13)return t.props}function r0(e,{filename:t="",prefixIdentifiers:s=!1,hoistStatic:n=!1,hmr:a=!1,cacheHandlers:i=!1,nodeTransforms:l=[],directiveTransforms:r={},transformHoist:o=null,isBuiltInComponent:c=Nt,isCustomElement:u=Nt,expressionPlugins:d=[],scopeId:f=null,slotted:p=!0,ssr:m=!1,inSSR:g=!1,ssrCssVars:k="",bindingMetadata:w=Pe,inline:b=!1,isTS:v=!1,onError:x=vc,onWarn:S=ah,compatConfig:N}){const O=t.replace(/\?.*$/,"").match(/([^/\\]+)\.\w+$/),T={filename:t,selfName:O&&Vn(Ze(O[1])),prefixIdentifiers:s,hoistStatic:n,hmr:a,cacheHandlers:i,nodeTransforms:l,directiveTransforms:r,transformHoist:o,isBuiltInComponent:c,isCustomElement:u,expressionPlugins:d,scopeId:f,slotted:p,ssr:m,inSSR:g,ssrCssVars:k,bindingMetadata:w,inline:b,isTS:v,onError:x,onWarn:S,compatConfig:N,root:e,helpers:new Map,components:new Set,directives:new Set,hoists:[],imports:[],cached:[],constantCache:new WeakMap,vForMemoKeyedNodes:new WeakSet,temps:0,identifiers:Object.create(null),scopes:{vFor:0,vSlot:0,vPre:0,vOnce:0},parent:null,grandParent:null,currentNode:e,childIndex:0,inVOnce:!1,helper(R){const L=T.helpers.get(R)||0;return T.helpers.set(R,L+1),R},removeHelper(R){const L=T.helpers.get(R);if(L){const B=L-1;B?T.helpers.set(R,B):T.helpers.delete(R)}},helperString(R){return`_${xa[T.helper(R)]}`},replaceNode(R){T.parent.children[T.childIndex]=T.currentNode=R},removeNode(R){const L=T.parent.children,B=R?L.indexOf(R):T.currentNode?T.childIndex:-1;!R||R===T.currentNode?(T.currentNode=null,T.onNodeRemoved()):T.childIndex>B&&(T.childIndex--,T.onNodeRemoved()),T.parent.children.splice(B,1)},onNodeRemoved:Nt,addIdentifiers(R){},removeIdentifiers(R){},hoist(R){Ee(R)&&(R=Ie(R)),T.hoists.push(R);const L=Ie(`_hoisted_${T.hoists.length}`,!1,R.loc,2);return L.hoisted=R,L},cache(R,L=!1,B=!1){const P=Oy(T.cached.length,R,L,B);return T.cached.push(P),P}};return T.filters=new Set,T}function o0(e,t){const s=r0(e,t);nr(e,s),t.hoistStatic&&i0(e,s),t.ssr||c0(e,s),e.helpers=new Set([...s.helpers.keys()]),e.components=[...s.components],e.directives=[...s.directives],e.imports=s.imports,e.hoists=s.hoists,e.temps=s.temps,e.cached=s.cached,e.transformed=!0,e.filters=[...s.filters]}function c0(e,t){const{helper:s}=t,{children:n}=e;if(n.length===1){const a=mh(e);if(a&&a.codegenNode){const i=a.codegenNode;i.type===13&&mc(i,t),e.codegenNode=i}else e.codegenNode=n[0]}else if(n.length>1){let a=64;e.codegenNode=vi(t,s(gi),void 0,e.children,a,void 0,void 0,!0,void 0,!1)}}function u0(e,t){let s=0;const n=()=>{s--};for(;s<e.children.length;s++){const a=e.children[s];Ee(a)||(t.grandParent=t.parent,t.parent=e,t.childIndex=s,t.onNodeRemoved=n,nr(a,t))}}function nr(e,t){t.currentNode=e;const{nodeTransforms:s}=t,n=[];for(let i=0;i<s.length;i++){const l=s[i](e,t);if(l&&(pe(l)?n.push(...l):n.push(l)),t.currentNode)e=t.currentNode;else return}switch(e.type){case 3:t.ssr||t.helper(Ri);break;case 5:t.ssr||t.helper(tr);break;case 9:for(let i=0;i<e.branches.length;i++)nr(e.branches[i],t);break;case 10:case 11:case 1:case 0:u0(e,t);break}t.currentNode=e;let a=n.length;for(;a--;)n[a]()}function xh(e,t){const s=Ee(e)?n=>n===e:n=>e.test(n);return(n,a)=>{if(n.type===1){const{props:i}=n;if(n.tagType===3&&i.some(jy))return;const l=[];for(let r=0;r<i.length;r++){const o=i[r];if(o.type===7&&s(o.name)){i.splice(r,1),r--;const c=t(n,o,a);c&&l.push(c)}}return l}}}const ar="/*@__PURE__*/",_h=e=>`${xa[e]}: _${xa[e]}`;function d0(e,{mode:t="function",prefixIdentifiers:s=t==="module",sourceMap:n=!1,filename:a="template.vue.html",scopeId:i=null,optimizeImports:l=!1,runtimeGlobalName:r="Vue",runtimeModuleName:o="vue",ssrRuntimeModuleName:c="vue/server-renderer",ssr:u=!1,isTS:d=!1,inSSR:f=!1}){const p={mode:t,prefixIdentifiers:s,sourceMap:n,filename:a,scopeId:i,optimizeImports:l,runtimeGlobalName:r,runtimeModuleName:o,ssrRuntimeModuleName:c,ssr:u,isTS:d,inSSR:f,source:e.source,code:"",column:1,line:1,offset:0,indentLevel:0,pure:!1,map:void 0,helper(g){return`_${xa[g]}`},push(g,k=-2,w){p.code+=g},indent(){m(++p.indentLevel)},deindent(g=!1){g?--p.indentLevel:m(--p.indentLevel)},newline(){m(p.indentLevel)}};function m(g){p.push(`
`+"  ".repeat(g),0)}return p}function f0(e,t={}){const s=d0(e,t);t.onContextCreated&&t.onContextCreated(s);const{mode:n,push:a,prefixIdentifiers:i,indent:l,deindent:r,newline:o,scopeId:c,ssr:u}=s,d=Array.from(e.helpers),f=d.length>0,p=!i&&n!=="module";p0(e,s);const g=u?"ssrRender":"render",w=(u?["_ctx","_push","_parent","_attrs"]:["_ctx","_cache"]).join(", ");if(a(`function ${g}(${w}) {`),l(),p&&(a("with (_ctx) {"),l(),f&&(a(`const { ${d.map(_h).join(", ")} } = _Vue
...
`,-1)}h0(e.hoists,t),i(),a("return ")}function Er(e,t,{helper:s,push:n,newline:a,isTS:i}){const l=s(t==="filter"?oc:t==="component"?ic:rc);for(let r=0;r<e.length;r++){let o=e[r];const c=o.endsWith("__self");c&&(o=o.slice(0,-6)),n(`const ${yi(o,t)} = ${l}(${JSON.stringify(o)}${c?", true":""})${i?"!":""}`),r<e.length-1&&a()}}function h0(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:n}=t;n();for(let a=0;a<e.length;a++){const i=e[a];i&&(s(`const _hoisted_${a+1} = `),$t(i,t),n())}t.pure=!1}function _c(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),Ni(e,t,s),s&&t.deindent(),t.push("]")}function Ni(e,t,s=!1,n=!0){const{push:a,newline:i}=t;for(let l=0;l<e.length;l++){const r=e[l];Ee(r)?a(r,-3):pe(r)?_c(r,t):$t(r,t),l<e.length-1&&(s?(n&&a(","),i()):n&&a(", "))}}function $t(e,t){if(Ee(e)){t.push(e,-3);return}if(Ut(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:$t(e.codegenNode,t);break;case 2:g0(e,t);break;case 4:kh(e,t);break;case 5:m0(e,t);break;case 12:$t(e.codegenNode,t);break;case 8:wh(e,t);break;case 3:b0(e,t);break;case 13:y0(e,t);break;case 14:_0(e,t);break;case 15:k0(e,t);break;case 17:w0(e,t);break;case 18:S0(e,t);break;case 19:T0(e,t);break;case 20:C0(e,t);break;case 21:Ni(e.body,t,!0,!1);break}}function g0(e,t){t.push(JSON.stringify(e.content),-3,e)}function kh(e,t){const{content:s,isStatic:n}=e;t.push(n?JSON.stringify(s):s,-3,e)}function m0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ar),s(`${n(tr)}(`),$t(e.content,t),s(")")}function wh(e,t){for(let s=0;s<e.children.length;s++){const n=e.children[s];Ee(n)?t.push(n,-3):$t(n,t)}}function v0(e,t){const{push:s}=t;if(e.type===8)s("["),wh(e,t),s("]");else if(e.isStatic){const n=bc(e.content)?e.content:JSON.stringify(e.content);s(n,-2,e)}else s(`[${e.content}]`,-3,e)}function b0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ar),s(`${n(Ri)}(${JSON.stringify(e.content)})`,-3,e)}function y0(e,t){const{push:s,helper:n,pure:a}=t,{tag:i,props:l,children:r,patchFlag:o,dynamicProps:c,directives:u,isBlock:d,disableTracking:f,isComponent:p}=e;let m;o&&(m=String(o)),u&&s(n(cc)+"("),d&&s(`(${n($n)}(${f?"true":""}), `),a&&s(ar);const g=d?wa(t.inSSR,p):ka(t.inSSR,p);s(n(g)+"(",-2,e),Ni(x0([i,l,r,m,c]),t),s(")"),d&&s(")"),u&&(s(", "),$t(u,t),s(")"))}function x0(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function _0(e,t){const{push:s,helper:n,pure:a}=t,i=Ee(e.callee)?e.callee:n(e.callee);a&&s(ar),s(i+"(",-2,e),Ni(e.arguments,t),s(")")}function k0(e,t){const{push:s,indent:n,deindent:a,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const r=l.length>1||!1;s(r?"{":"{ "),r&&n();for(let o=0;o<l.length;o++){const{key:c,value:u}=l[o];v0(c,t),s(": "),$t(u,t),o<l.length-1&&(s(","),i())}r&&a(),s(r?"}":" }")}function w0(e,t){_c(e.elements,t)}function S0(e,t){const{push:s,indent:n,deindent:a}=t,{params:i,returns:l,body:r,newline:o,isSlot:c}=e;c&&s(`_${xa[hc]}(`),s("(",-2,e),pe(i)?Ni(i,t):i&&$t(i,t),s(") => "),(o||r)&&(s("{"),n()),l?(o&&s("return "),pe(l)?_c(l,t):$t(l,t)):r&&$t(r,t),(o||r)&&(a(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function T0(e,t){const{test:s,consequent:n,alternate:a,newline:i}=e,{push:l,indent:r,deindent:o,newline:c}=t;if(s.type===4){const d=!bc(s.content);d&&l("("),kh(s,t),d&&l(")")}else l("("),$t(s,t),l(")");i&&r(),t.indentLevel++,i||l(" "),l("? "),$t(n,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const u=a.type===19;u||t.indentLevel++,$t(a,t),u||t.indentLevel--,i&&o(!0)}function C0(e,t){const{push:s,helper:n,indent:a,deindent:i,newline:l}=t,{needPauseTracking:r,needArraySpread:o}=e;o&&s("[...("),s(`_cache[${e.index}] || (`),r&&(a(),s(`${n(Cl)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),$t(e.value,t),r&&(s(`).cacheIndex = ${e.index},`),l(),s(`${n(Cl)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),o&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const E0=xh(/^(?:if|else|else-if)$/,(e,t,s)=>A0(e,t,s,(n,a,i)=>{const l=s.parent.children;let r=l.indexOf(n),o=0;for(;r-->=0;){const c=l[r];c&&c.type===9&&(o+=c.branches.length)}return()=>{if(i)n.codegenNode=Gu(a,o,s);else{const c=R0(n.codegenNode);c.alternate=Gu(a,o+n.branches.length-1,s)}}}));function A0(e,t,s,n){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const a=t.exp?t.exp.loc:e.loc;s.onError(tt(28,t.loc)),t.exp=Ie("true",!1,a)}if(t.name==="if"){const a=qu(e,t),i={type:9,loc:t0(e.loc),branches:[a]};if(s.replaceNode(i),n)return n(i,a,!0)}else{const a=s.parent.children;let i=a.indexOf(e);for(;i-->=-1;){const l=a[i];if(l&&dh(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(tt(30,e.loc)),s.removeNode();const r=qu(e,t);l.branches.push(r);const o=n&&n(l,r,!1);nr(r,s),o&&o(),s.currentNode=null}else s.onError(tt(30,e.loc));break}}}function qu(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!cs(e,"for")?e.children:[e],userKey:sr(e,"key"),isTemplateIf:s}}function Gu(e,t,s){return e.condition?oo(e.condition,Wu(e,t,s),kt(s.helper(Ri),['""',"true"])):Wu(e,t,s)}function Wu(e,t,s){const{helper:n}=s,a=gt("key",Ie(`${t}`,!1,ls,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const o=l.codegenNode;return Il(o,a,s),o}else return vi(s,n(gi),us([a]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const o=l.codegenNode,c=Ky(o);return c.type===13&&mc(c,s),Il(c,a,s),o}}function R0(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const I0=xh("for",(e,t,s)=>{const{helper:n,removeHelper:a}=s;return N0(e,t,s,i=>{const l=kt(n(uc),[i.source]),r=Al(e),o=cs(e,"memo"),c=sr(e,"key",!1,!0);c&&c.type;let u=c&&(c.type===6?c.value?Ie(c.value.content,!0):void 0:c.exp);const d=u?gt("key",u):null,f=i.source.type===4&&i.source.constType>0,p=f?64:c?128:256;return i.codegenNode=vi(s,n(gi),void 0,l,p,void 0,void 0,!0,!f,!1,e.loc),()=>{let m;const{children:g}=i,k=g.length!==1||g[0].type!==1,w=Rl(e)?e:r&&e.children.length===1&&Rl(e.children[0])?e.children[0]:null;if(w?(m=w.codegenNode,r&&d&&Il(m,d,s)):k?m=vi(s,n(gi),d?us([d]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(m=g[0].codegenNode,r&&d&&Il(m,d,s),m.isBlock!==!f&&(m.isBlock?(a($n),a(wa(s.inSSR,m.isComponent))):a(ka(s.inSSR,m.isComponent))),m.isBlock=!f,m.isBlock?(n($n),n(wa(s.inSSR,m.isComponent))):n(ka(s.inSSR,m.isComponent))),o){const b=_a(fo(i.parseResult,[Ie("_cached")]));b.body=Ly([ys(["const _memo = (",o.exp,")"]),ys(["if (_cached && _cached.el",...u?[" && _cached.key === ",u]:[],` && ${s.helperString(nh)}(_cached, _memo)) return _cached`]),ys(["const _item = ",m]),Ie("_item.memo = _memo"),Ie("return _item")]),l.arguments.push(b,Ie("_cache"),Ie(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(_a(fo(i.parseResult),m,!0))}})});function N0(e,t,s,n){if(!t.exp){s.onError(tt(31,t.loc));return}const a=t.forParseResult;if(!a){s.onError(tt(32,t.loc));return}Sh(a);const{addIdentifiers:i,removeIdentifiers:l,scopes:r}=s,{source:o,value:c,key:u,index:d}=a,f={type:11,loc:t.loc,source:o,valueAlias:c,keyAlias:u,objectIndexAlias:d,parseResult:a,children:Al(e)?e.children:[e]};s.replaceNode(f),r.vFor++;const p=n&&n(f);return()=>{r.vFor--,p&&p()}}function Sh(e,t){e.finalized||(e.finalized=!0)}function fo({value:e,key:t,index:s},n=[]){return O0([e,t,s,...n])}function O0(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,n)=>s||Ie("_".repeat(n+1),!1))}const Zu=Ie("undefined",!1),L0=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=cs(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},D0=(e,t,s,n)=>_a(e,s,!1,!0,s.length?s[0].loc:n);function M0(e,t,s=D0){t.helper(hc);const{children:n,loc:a}=e,i=[],l=[];let r=t.scopes.vSlot>0||t.scopes.vFor>0;const o=cs(e,"slot",!0);if(o){const{arg:k,exp:w}=o;k&&!Xt(k)&&(r=!0),i.push(gt(k||Ie("default",!0),s(w,void 0,n,a)))}let c=!1,u=!1;const d=[],f=new Set;let p=0;for(let k=0;k<n.length;k++){const w=n[k];let b;if(!Al(w)||!(b=cs(w,"slot",!0))){w.type!==3&&d.push(w);continue}if(o){t.onError(tt(37,b.loc));break}c=!0;const{children:v,loc:x}=w,{arg:S=Ie("default",!0),exp:N,loc:O}=b;let T;Xt(S)?T=S?S.content:"default":r=!0;const R=cs(w,"for"),L=s(N,R,v,x);let B,P;if(B=cs(w,"if"))r=!0,l.push(oo(B.exp,Zi(S,L,p++),Zu));else if(P=cs(w,/^else(?:-if)?$/,!0)){let C=k,$;for(;C--&&($=n[C],!!dh($)););if($&&Al($)&&cs($,/^(?:else-)?if$/)){let W=l[l.length-1];for(;W.alternate.type===19;)W=W.alternate;W.alternate=P.exp?oo(P.exp,Zi(S,L,p++),Zu):Zi(S,L,p++)}else t.onError(tt(30,P.loc))}else if(R){r=!0;const C=R.forParseResult;C?(Sh(C),l.push(kt(t.helper(uc),[C.source,_a(fo(C),Zi(S,L),!0)]))):t.onError(tt(32,R.loc))}else{if(T){if(f.has(T)){t.onError(tt(38,O));continue}f.add(T),T==="default"&&(u=!0)}i.push(gt(S,L))}}if(!o){const k=(w,b)=>{const v=s(w,void 0,b,a);return t.compatConfig&&(v.isNonScopedSlot=!0),gt("default",v)};c?d.length&&!d.every(yc)&&(u?t.onError(tt(39,d[0].loc)):i.push(k(void 0,d))):i.push(k(void 0,n))}const m=r?2:al(e.children)?3:1;let g=us(i.concat(gt("_",Ie(m+"",!1))),a);return l.length&&(g=kt(t.helper(sh),[g,Ln(l)])),{slots:g,hasDynamicSlots:r}}function Zi(e,t,s){const n=[gt("name",e),gt("fn",t)];return s!=null&&n.push(gt("key",Ie(String(s),!0))),us(n)}function al(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||al(s.children))return!0;break;case 9:if(al(s.branches))return!0;break;case 10:case 11:if(al(s.children))return!0;break}}return!1}const Th=new WeakMap,P0=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:n,props:a}=e,i=e.tagType===1;let l=i?F0(e,t):`"${n}"`;const r=Ve(l)&&l.callee===lc;let o,c,u=0,d,f,p,m=r||l===ei||l===tc||!i&&(n==="svg"||n==="foreignObject"||n==="math");if(a.length>0){const g=Ch(e,t,void 0,i,r);o=g.props,u=g.patchFlag,f=g.dynamicPropNames;const k=g.directives;p=k&&k.length?Ln(k.map(w=>U0(w,t))):void 0,g.shouldUseBlock&&(m=!0)}if(e.children.length>0)if(l===Sl&&(m=!0,u|=1024),i&&l!==ei&&l!==Sl){const{slots:k,hasDynamicSlots:w}=M0(e,t);c=k,w&&(u|=1024)}else if(e.children.length===1&&l!==ei){const k=e.children[0],w=k.type,b=w===5||w===8;b&&ss(k,t)===0&&(u|=1),b||w===2?c=k:c=e.children}else c=e.children;f&&f.length&&(d=B0(f)),e.codegenNode=vi(t,l,o,c,u===0?void 0:u,d,p,!!m,!1,i,e.loc)};function F0(e,t,s=!1){let{tag:n}=e;const a=po(n),i=sr(e,"is",!1,!0);if(i)if(a||Dn("COMPILER_IS_ON_ELEMENT",t)){let r;if(i.type===6?r=i.value&&Ie(i.value.content,!0):(r=i.exp,r||(r=Ie("is",!1,i.arg.loc))),r)return kt(t.helper(lc),[r])}else i.type===6&&i.value.content.startsWith("vue:")&&(n=i.value.content.slice(4));const l=ih(n)||t.isBuiltInComponent(n);return l?(s||t.helper(l),l):(t.helper(ic),t.components.add(n),yi(n,"component"))}function Ch(e,t,s=e.props,n,a,i=!1){const{tag:l,loc:r,children:o}=e;let c=[];const u=[],d=[],f=o.length>0;let p=!1,m=0,g=!1,k=!1,w=!1,b=!1,v=!1,x=!1;const S=[],N=L=>{c.length&&(u.push(us(Ju(c),r)),c=[]),L&&u.push(L)},O=()=>{t.scopes.vFor>0&&c.push(gt(Ie("ref_for",!0),Ie("true")))},T=({key:L,value:B})=>{if(Xt(L)){const P=L.content,C=Bn(P);if(C&&(!n||a)&&P.toLowerCase()!=="onclick"&&P!=="onUpdate:modelValue"&&!qs(P)&&(b=!0),C&&qs(P)&&(x=!0),C&&B.type===14&&(B=B.arguments[0]),B.type===20||(B.type===4||B.type===8)&&ss(B,t)>0)return;P==="ref"?g=!0:P==="class"?k=!0:P==="style"?w=!0:P!=="key"&&!S.includes(P)&&S.push(P),n&&(P==="class"||P==="style")&&!S.includes(P)&&S.push(P)}else v=!0};for(let L=0;L<s.length;L++){const B=s[L];if(B.type===6){const{loc:P,name:C,nameLoc:$,value:W}=B;let G=!0;if(C==="ref"&&(g=!0,O()),C==="is"&&(po(l)||W&&W.content.startsWith("vue:")||Dn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(gt(Ie(C,!0,$),Ie(W?W.content:"",G,W?W.loc:P)))}else{const{name:P,arg:C,exp:$,loc:W,modifiers:G}=B,D=P==="bind",I=P==="on";if(P==="slot"){n||t.onError(tt(40,W));continue}if(P==="once"||P==="memo"||P==="is"||D&&En(C,"is")&&(po(l)||Dn("COMPILER_IS_ON_ELEMENT",t))||I&&i)continue;if((D&&En(C,"key")||I&&f&&En(C,"vue:before-update"))&&(p=!0),D&&En(C,"ref")&&O(),!C&&(D||I)){if(v=!0,$)if(D){if(N(),Dn("COMPILER_V_BIND_OBJECT_ORDER",t)){u.unshift($);continue}O(),N(),u.push($)}else N({type:14,loc:W,callee:t.helper(pc),arguments:n?[$]:[$,"true"]});else t.onError(tt(D?34:35,W));continue}D&&G.some(de=>de.content==="prop")&&(m|=32);const K=t.directiveTransforms[P];if(K){const{props:de,needRuntime:re}=K(B,e,t);!i&&de.forEach(T),I&&C&&!Xt(C)?N(us(de,r)):c.push(...de),re&&(d.push(B),Ut(re)&&Th.set(B,re))}else Ig(P)||(d.push(B),f&&(p=!0))}}let R;if(u.length?(N(),u.length>1?R=kt(t.helper(Tl),u,r):R=u[0]):c.length&&(R=us(Ju(c),r)),v?m|=16:(k&&!n&&(m|=2),w&&!n&&(m|=4),S.length&&(m|=8),b&&(m|=32)),!p&&(m===0||m===32)&&(g||x||d.length>0)&&(m|=512),!t.inSSR&&R)switch(R.type){case 15:let L=-1,B=-1,P=!1;for(let W=0;W<R.properties.length;W++){const G=R.properties[W].key;Xt(G)?G.content==="class"?L=W:G.content==="style"&&(B=W):G.isHandlerKey||(P=!0)}const C=R.properties[L],$=R.properties[B];P?R=kt(t.helper(mi),[R]):(C&&!Xt(C.value)&&(C.value=kt(t.helper(dc),[C.value])),$&&(w||$.value.type===4&&$.value.content.trim()[0]==="["||$.value.type===17)&&($.value=kt(t.helper(fc),[$.value])));break;case 14:break;default:R=kt(t.helper(mi),[kt(t.helper(Ii),[R])]);break}return{props:R,directives:d,patchFlag:m,dynamicPropNames:S,shouldUseBlock:p}}function Ju(e){const t=new Map,s=[];for(let n=0;n<e.length;n++){const a=e[n];if(a.key.type===8||!a.key.isStatic){s.push(a);continue}const i=a.key.content,l=t.get(i);l?(i==="style"||i==="class"||Bn(i))&&$0(l,a):(t.set(i,a),s.push(a))}return s}function $0(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Ln([e.value,t.value],e.loc)}function U0(e,t){const s=[],n=Th.get(e);n?s.push(t.helperString(n)):(t.helper(rc),t.directives.add(e.name),s.push(yi(e.name,"directive")));const{loc:a}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=Ie("true",!1,a);s.push(us(e.modifiers.map(l=>gt(l,i)),a))}return Ln(s,e.loc)}function B0(e){let t="[";for(let s=0,n=e.length;s<n;s++)t+=JSON.stringify(e[s]),s<n-1&&(t+=", ");return t+"]"}function po(e){return e==="component"||e==="Component"}const H0=(e,t)=>{if(Rl(e)){const{children:s,loc:n}=e,{slotName:a,slotProps:i}=V0(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",a,"{}","undefined","true"];let r=2;i&&(l[2]=i,r=3),s.length&&(l[3]=_a([],s,!1,!1,n),r=4),t.scopeId&&!t.slotted&&(r=5),l.splice(r),e.codegenNode=kt(t.helper(th),l,n)}};function V0(e,t){let s='"default"',n;const a=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=Ze(l.name),a.push(l)));else if(l.name==="bind"&&En(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const r=Ze(l.arg.content);s=l.exp=Ie(r,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&Xt(l.arg)&&(l.arg.content=Ze(l.arg.content)),a.push(l)}if(a.length>0){const{props:i,directives:l}=Ch(e,t,a,!1,!1);n=i,l.length&&t.onError(tt(36,l[0].loc))}return{slotName:s,slotProps:n}}const Eh=(e,t,s,n)=>{const{loc:a,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(tt(35,a));let r;if(l.type===4)if(l.isStatic){let d=l.content;d.startsWith("vue:")&&(d=`vnode-${d.slice(4)}`);const f=t.tagType!==0||d.startsWith("vnode")||!/[A-Z]/.test(d)?oa(Ze(d)):`on:${d}`;r=Ie(f,!0,l.loc)}else r=ys([`${s.helperString(ro)}(`,l,")"]);else r=l,r.children.unshift(`${s.helperString(ro)}(`),r.children.push(")");let o=e.exp;o&&!o.content.trim()&&(o=void 0);let c=s.cacheHandlers&&!o&&!s.inVOnce;if(o){const d=oh(o),f=!(d||Hy(o)),p=o.content.includes(";");(f||c&&d)&&(o=ys([`${f?"$event":"(...args)"} => ${p?"{":"("}`,o,p?"}":")"]))}let u={props:[gt(r,o||Ie("() => {}",!1,a))]};return n&&(u=n(u)),c&&(u.props[0].value=s.cache(u.props[0].value)),u.props.forEach(d=>d.key.isHandlerKey=!0),u},j0=(e,t,s)=>{const{modifiers:n,loc:a}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),n.some(r=>r.content==="camel")&&(i.type===4?i.isStatic?i.content=Ze(i.content):i.content=`${s.helperString(lo)}(${i.content})`:(i.children.unshift(`${s.helperString(lo)}(`),i.children.push(")"))),s.inSSR||(n.some(r=>r.content==="prop")&&Yu(i,"."),n.some(r=>r.content==="attr")&&Yu(i,"^")),{props:[gt(i,l)]}},Yu=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},z0=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let n,a=!1;for(let i=0;i<s.length;i++){const l=s[i];if(Cr(l)){a=!0;for(let r=i+1;r<s.length;r++){const o=s[r];if(Cr(o))n||(n=s[i]=ys([l],l.loc)),n.children.push(" + ",o),s.splice(r,1),r--;else{n=void 0;break}}}}if(!(!a||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(Cr(l)||l.type===8){const r=[];(l.type!==2||l.content!==" ")&&r.push(l),!t.ssr&&ss(l,t)===0&&r.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:kt(t.helper(ac),r)}}}}},Qu=new WeakSet,K0=(e,t)=>{if(e.type===1&&cs(e,"once",!0))return Qu.has(e)||t.inVOnce||t.inSSR?void 0:(Qu.add(e),t.inVOnce=!0,t.helper(Cl),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Ah=(e,t,s)=>{const{exp:n,arg:a}=e;if(!n)return s.onError(tt(41,e.loc)),$a();const i=n.loc.source.trim(),l=n.type===4?n.content:i,r=s.bindingMetadata[i];if(r==="props"||r==="props-aliased")return s.onError(tt(44,n.loc)),$a();if(r==="literal-const"||r==="setup-const")return s.onError(tt(45,n.loc)),$a();if(!l.trim()||!oh(n))return s.onError(tt(42,n.loc)),$a();const o=a||Ie("modelValue",!0),c=a?Xt(a)?`onUpdate:${Ze(a.content)}`:ys(['"onUpdate:" + ',a]):"onUpdate:modelValue";let u;const d=s.isTS?"($event: any)":"$event";u=ys([`${d} => ((`,n,") = $event)"]);const f=[gt(o,e.exp),gt(c,u)];if(e.modifiers.length&&t.tagType===1){const p=e.modifiers.map(g=>g.content).map(g=>(bc(g)?g:JSON.stringify(g))+": true").join(", "),m=a?Xt(a)?`${a.content}Modifiers`:ys([a,' + "Modifiers"']):"modelModifiers";f.push(gt(m,Ie(`{ ${p} }`,!1,e.loc,2)))}return $a(f)};function $a(e=[]){return{props:e}}const q0=/[\w).+\-_$\]]/,G0=(e,t)=>{Dn("COMPILER_FILTERS",t)&&(e.type===5?Nl(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&Nl(s.exp,t)}))};function Nl(e,t){if(e.type===4)Xu(e,t);else for(let s=0;s<e.children.length;s++){const n=e.children[s];typeof n=="object"&&(n.type===4?Xu(n,t):n.type===8?Nl(e,t):n.type===5&&Nl(n.content,t))}}function Xu(e,t){const s=e.content;let n=!1,a=!1,i=!1,l=!1,r=0,o=0,c=0,u=0,d,f,p,m,g=[];for(p=0;p<s.length;p++)if(f=d,d=s.charCodeAt(p),n)d===39&&f!==92&&(n=!1);else if(a)d===34&&f!==92&&(a=!1);else if(i)d===96&&f!==92&&(i=!1);else if(l)d===47&&f!==92&&(l=!1);else if(d===124&&s.charCodeAt(p+1)!==124&&s.charCodeAt(p-1)!==124&&!r&&!o&&!c)m===void 0?(u=p+1,m=s.slice(0,p).trim()):k();else{switch(d){case 34:a=!0;break;case 39:n=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:o++;break;case 93:o--;break;case 123:r++;break;case 125:r--;break}if(d===47){let w=p-1,b;for(;w>=0&&(b=s.charAt(w),b===" ");w--);(!b||!q0.test(b))&&(l=!0)}}m===void 0?m=s.slice(0,p).trim():u!==0&&k();function k(){g.push(s.slice(u,p).trim()),u=p+1}if(g.length){for(p=0;p<g.length;p++)m=W0(m,g[p],t);e.content=m,e.ast=void 0}}function W0(e,t,s){s.helper(oc);const n=t.indexOf("(");if(n<0)return s.filters.add(t),`${yi(t,"filter")}(${e})`;{const a=t.slice(0,n),i=t.slice(n+1);return s.filters.add(a),`${yi(a,"filter")}(${e}${i!==")"?","+i:i}`}}const ed=new WeakSet,Z0=(e,t)=>{if(e.type===1){const s=cs(e,"memo");return!s||ed.has(e)||t.inSSR?void 0:(ed.add(e),()=>{const n=e.codegenNode||t.currentNode.codegenNode;n&&n.type===13&&(e.tagType!==1&&mc(n,t),e.codegenNode=kt(t.helper(gc),[s.exp,_a(void 0,n),"_cache",String(t.cached.length)]),t.cached.push(null))})}},J0=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const n=s.arg;if(n.type!==4||!n.isStatic)t.onError(tt(53,n.loc)),s.exp=Ie("",!0,n.loc);else{const a=Ze(n.content);(lh.test(a[0])||a[0]==="-")&&(s.exp=Ie(a,!1,n.loc))}}}};function Y0(e){return[[J0,K0,E0,Z0,I0,G0,H0,P0,L0,z0],{on:Eh,bind:j0,model:Ah}]}function Q0(e,t={}){const s=t.onError||vc,n=t.mode==="module";t.prefixIdentifiers===!0?s(tt(48)):n&&s(tt(49));const a=!1;t.cacheHandlers&&s(tt(50)),t.scopeId&&!n&&s(tt(51));const i=De({},t,{prefixIdentifiers:a}),l=Ee(e)?a0(e,i):e,[r,o]=Y0();return o0(l,De({},i,{nodeTransforms:[...r,...t.nodeTransforms||[]],directiveTransforms:De({},o,t.directiveTransforms||{})})),f0(l,i)}const X0=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Rh=Symbol(""),Ih=Symbol(""),Nh=Symbol(""),Oh=Symbol(""),ho=Symbol(""),Lh=Symbol(""),Dh=Symbol(""),Mh=Symbol(""),Ph=Symbol(""),Fh=Symbol("");Iy({[Rh]:"vModelRadio",[Ih]:"vModelCheckbox",[Nh]:"vModelText",[Oh]:"vModelSelect",[ho]:"vModelDynamic",[Lh]:"withModifiers",[Dh]:"withKeys",[Mh]:"vShow",[Ph]:"Transition",[Fh]:"TransitionGroup"});let Yn;function ex(e,t=!1){return Yn||(Yn=document.createElement("div")),t?(Yn.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,Yn.children[0].getAttribute("foo")):(Yn.innerHTML=e,Yn.textContent)}const tx={parseMode:"html",isVoidTag:Gg,isNativeTag:e=>zg(e)||Kg(e)||qg(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:ex,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return Ph;if(e==="TransitionGroup"||e==="transition-group")return Fh},getNamespace(e,t,s){let n=t?t.ns:s;if(t&&n===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(a=>a.type===6&&a.name==="encoding"&&a.value!=null&&(a.value.content==="text/html"||a.value.content==="application/xhtml+xml"))&&(n=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(n=0);else t&&n===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(n=0);if(n===0){if(e==="svg")return 1;if(e==="math")return 2}return n}},sx=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:Ie("style",!0,t.loc),exp:nx(t.value.content,t.loc),modifiers:[],loc:t.loc})})},nx=(e,t)=>{const s=Zd(e);return Ie(JSON.stringify(s),!1,t,3)};function mn(e,t){return tt(e,t)}const ax=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(mn(54,a)),t.children.length&&(s.onError(mn(55,a)),t.children.length=0),{props:[gt(Ie("innerHTML",!0,a),n||Ie("",!0))]}},ix=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(mn(56,a)),t.children.length&&(s.onError(mn(57,a)),t.children.length=0),{props:[gt(Ie("textContent",!0),n?ss(n,s)>0?n:kt(s.helperString(tr),[n],a):Ie("",!0))]}},lx=(e,t,s)=>{const n=Ah(e,t,s);if(!n.props.length||t.tagType===1)return n;e.arg&&s.onError(mn(59,e.arg.loc));const{tag:a}=t,i=s.isCustomElement(a);if(a==="input"||a==="textarea"||a==="select"||i){let l=Nh,r=!1;if(a==="input"||i){const o=sr(t,"type");if(o){if(o.type===7)l=ho;else if(o.value)switch(o.value.content){case"radio":l=Rh;break;case"checkbox":l=Ih;break;case"file":r=!0,s.onError(mn(60,e.loc));break}}else Vy(t)&&(l=ho)}else a==="select"&&(l=Oh);r||(n.needRuntime=s.helper(l))}else s.onError(mn(58,e.loc));return n.props=n.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),n},rx=is("passive,once,capture"),ox=is("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),cx=is("left,right"),$h=is("onkeyup,onkeydown,onkeypress"),ux=(e,t,s,n)=>{const a=[],i=[],l=[];for(let r=0;r<t.length;r++){const o=t[r].content;o==="native"&&bi("COMPILER_V_ON_NATIVE",s)||rx(o)?l.push(o):cx(o)?Xt(e)?$h(e.content.toLowerCase())?a.push(o):i.push(o):(a.push(o),i.push(o)):ox(o)?i.push(o):a.push(o)}return{keyModifiers:a,nonKeyModifiers:i,eventOptionModifiers:l}},td=(e,t)=>Xt(e)&&e.content.toLowerCase()==="onclick"?Ie(t,!0):e.type!==4?ys(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,dx=(e,t,s)=>Eh(e,t,s,n=>{const{modifiers:a}=e;if(!a.length)return n;let{key:i,value:l}=n.props[0];const{keyModifiers:r,nonKeyModifiers:o,eventOptionModifiers:c}=ux(i,a,s,e.loc);if(o.includes("right")&&(i=td(i,"onContextmenu")),o.includes("middle")&&(i=td(i,"onMouseup")),o.length&&(l=kt(s.helper(Lh),[l,JSON.stringify(o)])),r.length&&(!Xt(i)||$h(i.content.toLowerCase()))&&(l=kt(s.helper(Dh),[l,JSON.stringify(r)])),c.length){const u=c.map(Vn).join("");i=Xt(i)?Ie(`${i.content}${u}`,!0):ys(["(",i,`) + "${u}"`])}return{props:[gt(i,l)]}}),fx=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(mn(62,a)),{props:[],needRuntime:s.helper(Mh)}},px=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},hx=[sx],gx={cloak:X0,html:ax,text:ix,model:lx,on:dx,show:fx};function mx(e,t={}){return Q0(e,De({},tx,t,{nodeTransforms:[px,...hx,...t.nodeTransforms||[]],directiveTransforms:De({},gx,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const sd=Object.create(null);function vx(e,t){if(!Ee(e))if(e.nodeType)e=e.innerHTML;else return Nt;const s=Lg(e,t),n=sd[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=De({hoistStatic:!0,onError:void 0,onWarn:Nt},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=mx(e,a),l=new Function("Vue",i)(Sy);return l._rc=!0,sd[s]=l}_p(vx);const Ol=bn({items:[]});let bx=1;function ir(e,t="info",s=3e3){const n=bx++;return Ol.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>kc(n),s),n}function kc(e){const t=Ol.items.findIndex(s=>s.id===e);t>=0&&Ol.items.splice(t,1)}function ke(e,t="info",s=3e3){return ir(e,t,s)}ke.success=(e,t=3e3)=>ir(e,"success",t);ke.error=(e,t=5e3)=>ir(e,"error",t);ke.info=(e,t=3e3)=>ir(e,"info",t);ke.dismiss=kc;const yx={setup(){return{state:Ol,dismiss:kc}},template:`
  ...
  `},Bs=bn({open:!1,title:"Confirm",message:"",confirmLabel:"Confirm",cancelLabel:"Cancel",danger:!1});let ha=null;function as({title:e="Confirm",message:t="",confirmLabel:s="Confirm",cancelLabel:n="Cancel",danger:a=!1}={}){return ha&&ha(!1),Bs.title=e,Bs.message=t,Bs.confirmLabel=s,Bs.cancelLabel=n,Bs.danger=a,Bs.open=!0,new Promise(i=>{ha=i})}function nd(e){Bs.open=!1,ha&&(ha(e),ha=null)}const xx={setup(){function e(t){Bs.open&&t.key==="Escape"&&(t.stopPropagation(),nd(!1))}return Ue(()=>document.addEventListener("keydown",e,!0)),ft(()=>document.removeEventListener("keydown",e,!0)),{state:Bs,settle:nd}},template:`
 ...
 * @license MIT
 */const sa=typeof document<"u";function Uh(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function _x(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&Uh(e.default)}const qe=Object.assign;function Ar(e,t){const s={};for(const n in t){const a=t[n];s[n]=_s(a)?a.map(e):e(a)}return s}const ti=()=>{},_s=Array.isArray;function ad(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}const Bh=/#/g,kx=/&/g,wx=/\//g,Sx=/=/g,Tx=/\?/g,Hh=/\+/g,Cx=/%5B/g,Ex=/%5D/g,Vh=/%5E/g,Ax=/%60/g,jh=/%7B/g,Rx=/%7C/g,zh=/%7D/g,Ix=/%20/g;function wc(e){return e==null?"":encodeURI(""+e).replace(Rx,"|").replace(Cx,"[").replace(Ex,"]")}function Nx(e){return wc(e).replace(jh,"{").replace(zh,"}").replace(Vh,"^")}function go(e){return wc(e).replace(Hh,"%2B").replace(Ix,"+").replace(Bh,"%23").replace(kx,"%26").replace(Ax,"`").replace(jh,"{").replace(zh,"}").replace(Vh,"^")}function Ox(e){return go(e).replace(Sx,"%3D")}function Lx(e){return wc(e).replace(Bh,"%23").replace(Tx,"%3F")}function Dx(e){return Lx(e).replace(wx,"%2F")}function _i(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const Mx=/\/$/,Px=e=>e.replace(Mx,"");function Rr(e,t,s="/"){let n,a={},i="",l="";const r=t.indexOf("#");let o=t.indexOf("?");return o=r>=0&&o>r?-1:o,o>=0&&(n=t.slice(0,o),i=t.slice(o,r>0?r:t.length),a=e(i.slice(1))),r>=0&&(n=n||t.slice(0,r),l=t.slice(r,t.length)),n=Bx(n??t,s),{fullPath:n+i+l,path:n,query:a,hash:_i(l)}}function Fx(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function id(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function $x(e,t,s){const n=t.matched.length-1,a=s.matched.length-1;return n>-1&&n===a&&Sa(t.matched[n],s.matched[a])&&Kh(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function Sa(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function Kh(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!Ux(e[s],t[s]))return!1;return!0}function Ux(e,t){return _s(e)?ld(e,t):_s(t)?ld(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function ld(e,t){return _s(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function Bx(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),a=n[n.length-1];(a===".."||a===".")&&n.push("");let i=s.length-1,l,r;for(l=0;l<n.length;l++)if(r=n[l],r!==".")if(r==="..")i>1&&i--;else break;return s.slice(0,i).join("/")+"/"+n.slice(l).join("/")}const on={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let mo=(function(e){return e.pop="pop",e.push="push",e})({}),Ir=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Hx(e){if(!e)if(sa){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Px(e)}const Vx=/^[^#]+#/;function jx(e,t){return e.replace(Vx,"#")+t}function zx(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const lr=()=>({left:window.scrollX,top:window.scrollY});function Kx(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),a=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!a)return;t=zx(a,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function rd(e,t){return(history.state?history.state.position-t:-1)+e}const vo=new Map;function qx(e,t){vo.set(e,t)}function Gx(e){const t=vo.get(e);return vo.delete(e),t}function Wx(e){return typeof e=="string"||e&&typeof e=="object"}function qh(e){return typeof e=="string"||typeof e=="symbol"}let rt=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const Gh=Symbol("");rt.MATCHER_NOT_FOUND+"",rt.NAVIGATION_GUARD_REDIRECT+"",rt.NAVIGATION_ABORTED+"",rt.NAVIGATION_CANCELLED+"",rt.NAVIGATION_DUPLICATED+"";function Ta(e,t){return qe(new Error,{type:e,[Gh]:!0},t)}function Ms(e,t){return e instanceof Error&&Gh in e&&(t==null||!!(e.type&t))}const Zx=["params","query","hash"];function Jx(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of Zx)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}function Yx(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const a=s[n].replace(Hh," "),i=a.indexOf("="),l=_i(i<0?a:a.slice(0,i)),r=i<0?null:_i(a.slice(i+1));if(l in t){let o=t[l];_s(o)||(o=t[l]=[o]),o.push(r)}else t[l]=r}return t}function od(e){let t="";for(let s in e){const n=e[s];if(s=Ox(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(_s(n)?n.map(a=>a&&go(a)):[n&&go(n)]).forEach(a=>{a!==void 0&&(t+=(t.length?"&":"")+s,a!=null&&(t+="="+a))})}return t}function Qx(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=_s(n)?n.map(a=>a==null?null:""+a):n==null?n:""+n)}return t}const Xx=Symbol(""),cd=Symbol(""),rr=Symbol(""),Sc=Symbol(""),bo=Symbol("");function Ua(){let e=[];function t(n){return e.push(n),()=>{const a=e.indexOf(n);a>-1&&e.splice(a,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function hn(e,t,s,n,a,i=l=>l()){const l=n&&(n.enterCallbacks[a]=n.enterCallbacks[a]||[]);return()=>new Promise((r,o)=>{const c=f=>{f===!1?o(Ta(rt.NAVIGATION_ABORTED,{from:s,to:t})):f instanceof Error?o(f):Wx(f)?o(Ta(rt.NAVIGATION_GUARD_REDIRECT,{from:t,to:f})):(l&&n.enterCallbacks[a]===l&&typeof f=="function"&&l.push(f),r())},u=i(()=>e.call(n&&n.instances[a],t,s,c));let d=Promise.resolve(u);e.length<3&&(d=d.then(c)),d.catch(f=>o(f))})}function Nr(e,t,s,n,a=i=>i()){const i=[];for(const l of e)for(const r in l.components){let o=l.components[r];if(!(t!=="beforeRouteEnter"&&!l.instances[r]))if(Uh(o)){const c=(o.__vccOpts||o)[t];c&&i.push(hn(c,s,n,l,r,a))}else{let c=o();i.push(()=>c.then(u=>{if(!u)throw new Error(`Couldn't resolve component "${r}" at "${l.path}"`);const d=_x(u)?u.default:u;l.mods[r]=u,l.components[r]=d;const f=(d.__vccOpts||d)[t];return f&&hn(f,s,n,l,r,a)()}))}}return i}function e_(e,t){const s=[],n=[],a=[],i=Math.max(t.matched.length,e.matched.length);for(let l=0;l<i;l++){const r=t.matched[l];r&&(e.matched.find(c=>Sa(c,r))?n.push(r):s.push(r));const o=e.matched[l];o&&(t.matched.find(c=>Sa(c,o))||a.push(o))}return[s,n,a]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let t_=()=>location.protocol+"//"+location.host;function Wh(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),id(r,"")}return id(s,e)+n+a}function s_(e,t,s,n){let a=[],i=[],l=null;const r=({state:f})=>{const p=Wh(e,location),m=s.value,g=t.value;let k=0;if(f){if(s.value=p,t.value=f,l&&l===m){l=null;return}k=g?f.position-g.position:0}else n(p);a.forEach(w=>{w(s.value,m,{delta:k,type:mo.pop,direction:k?k>0?Ir.forward:Ir.back:Ir.unknown})})};function o(){l=s.value}function c(f){a.push(f);const p=()=>{const m=a.indexOf(f);m>-1&&a.splice(m,1)};return i.push(p),p}function u(){if(document.visibilityState==="hidden"){const{history:f}=window;if(!f.state)return;f.replaceState(qe({},f.state,{scroll:lr()}),"")}}function d(){for(const f of i)f();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",u),document.removeEventListener("visibilitychange",u)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",u),document.addEventListener("visibilitychange",u),{pauseListeners:o,listen:c,destroy:d}}function ud(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?lr():null}}function n_(e){const{history:t,location:s}=window,n={value:Wh(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,u){const d=e.indexOf("#"),f=d>-1?(s.host&&document.querySelector("base")?e:e.slice(d))+o:t_()+e+o;try{t[u?"replaceState":"pushState"](c,"",f),a.value=c}catch(p){console.error(p),s[u?"replace":"assign"](f)}}function l(o,c){i(o,qe({},t.state,ud(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const u=qe({},a.value,t.state,{forward:o,scroll:lr()});i(u.current,u,!0),i(o,qe({},ud(n.value,o,null),{position:u.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function a_(e){e=Hx(e);const t=n_(e),s=s_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=qe({location:"",base:e,go:n,createHref:jx.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function i_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),a_(e)}let Rn=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var xt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(xt||{});const l_={type:Rn.Static,value:""},r_=/[a-zA-Z0-9_]/;function o_(e){if(!e)return[[]];if(e==="/")return[[l_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(p){throw new Error(`ERR (${s})/"${c}": ${p}`)}let s=xt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",u="";function d(){c&&(s===xt.Static?i.push({type:Rn.Static,value:c}):s===xt.Param||s===xt.ParamRegExp||s===xt.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Rn.Param,value:c,regexp:u,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function f(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==xt.ParamRegExp){n=s,s=xt.EscapeNext;continue}switch(s){case xt.Static:o==="/"?(c&&d(),l()):o===":"?(d(),s=xt.Param):f();break;case xt.EscapeNext:f(),s=n;break;case xt.Param:o==="("?s=xt.ParamRegExp:r_.test(o)?f():(d(),s=xt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case xt.ParamRegExp:o===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+o:s=xt.ParamRegExpEnd:u+=o;break;case xt.ParamRegExpEnd:d(),s=xt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,u="";break;default:t("Unknown state");break}}return s===xt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),d(),l(),a}const dd="[^/]+?",c_={sensitive:!1,strict:!1,start:!0,end:!0};var Vt=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Vt||{});const u_=/[.+*?^${}()[\]/\\]/g;function d_(e,t){const s=qe({},c_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const u=c.length?[]:[Vt.Root];s.strict&&!c.length&&(a+="/");for(let d=0;d<c.length;d++){const f=c[d];let p=Vt.Segment+(s.sensitive?Vt.BonusCaseSensitive:0);if(f.type===Rn.Static)d||(a+="/"),a+=f.value.replace(u_,"\\$&"),p+=Vt.Static;else if(f.type===Rn.Param){const{value:m,repeatable:g,optional:k,regexp:w}=f;i.push({name:m,repeatable:g,optional:k});const b=w||dd;if(b!==dd){p+=Vt.BonusCustomRegExp;try{`${b}`}catch(x){throw new Error(`Invalid custom RegExp for param "${m}" (${b}): `+x.message)}}let v=g?`((?:${b})(?:/(?:${b}))*)`:`(${b})`;d||(v=k&&c.length<2?`(?:/${v})`:"/"+v),k&&(v+="?"),a+=v,p+=Vt.Dynamic,k&&(p+=Vt.BonusOptional),g&&(p+=Vt.BonusRepeatable),b===".*"&&(p+=Vt.BonusWildcard)}u.push(p)}n.push(u)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=Vt.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const u=c.match(l),d={};if(!u)return null;for(let f=1;f<u.length;f++){const p=u[f]||"",m=i[f-1];d[m.name]=p&&m.repeatable?p.split("/"):p}return d}function o(c){let u="",d=!1;for(const f of e){(!d||!u.endsWith("/"))&&(u+="/"),d=!1;for(const p of f)if(p.type===Rn.Static)u+=p.value;else if(p.type===Rn.Param){const{value:m,repeatable:g,optional:k}=p,w=m in c?c[m]:"";if(_s(w)&&!g)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const b=_s(w)?w.join("/"):w;if(!b)if(k)f.length<2&&(u.endsWith("/")?u=u.slice(0,-1):d=!0);else throw new Error(`Missing required param "${m}"`);u+=b}}return u||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function f_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Vt.Static+Vt.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Vt.Static+Vt.Segment?1:-1:0}function Zh(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=f_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(fd(n))return 1;if(fd(a))return-1}return a.length-n.length}function fd(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const p_={strict:!1,end:!0,sensitive:!1};function h_(e,t,s){const n=d_(o_(e.path),s),a=qe(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function g_(e,t){const s=[],n=new Map;t=ad(p_,t);function a(d){return n.get(d)}function i(d,f,p){const m=!p,g=hd(d);g.aliasOf=p&&p.record;const k=ad(t,d),w=[g];if("alias"in d){const x=typeof d.alias=="string"?[d.alias]:d.alias;for(const S of x)w.push(hd(qe({},g,{components:p?p.record.components:g.components,path:S,aliasOf:p?p.record:g})))}let b,v;for(const x of w){const{path:S}=x;if(f&&S[0]!=="/"){const N=f.record.path,O=N[N.length-1]==="/"?"":"/";x.path=f.record.path+(S&&O+S)}if(b=h_(x,f,k),p?p.alias.push(b):(v=v||b,v!==b&&v.alias.push(b),m&&d.name&&!gd(b)&&l(d.name)),Jh(b)&&o(b),g.children){const N=g.children;for(let O=0;O<N.length;O++)i(N[O],b,p&&p.children[O])}p=p||b}return v?()=>{l(v)}:ti}function l(d){if(qh(d)){const f=n.get(d);f&&(n.delete(d),s.splice(s.indexOf(f),1),f.children.forEach(l),f.alias.forEach(l))}else{const f=s.indexOf(d);f>-1&&(s.splice(f,1),d.record.name&&n.delete(d.record.name),d.children.forEach(l),d.alias.forEach(l))}}function r(){return s}function o(d){const f=b_(d,s);s.splice(f,0,d),d.record.name&&!gd(d)&&n.set(d.record.name,d)}function c(d,f){let p,m={},g,k;if("name"in d&&d.name){if(p=n.get(d.name),!p)throw Ta(rt.MATCHER_NOT_FOUND,{location:d});k=p.record.name,m=qe(pd(f.params,p.keys.filter(v=>!v.optional).concat(p.parent?p.parent.keys.filter(v=>v.optional):[]).map(v=>v.name)),d.params&&pd(d.params,p.keys.map(v=>v.name))),g=p.stringify(m)}else if(d.path!=null)g=d.path,p=s.find(v=>v.re.test(g)),p&&(m=p.parse(g),k=p.record.name);else{if(p=f.name?n.get(f.name):s.find(v=>v.re.test(f.path)),!p)throw Ta(rt.MATCHER_NOT_FOUND,{location:d,currentLocation:f});k=p.record.name,m=qe({},f.params,d.params),g=p.stringify(m)}const w=[];let b=p;for(;b;)w.unshift(b.record),b=b.parent;return{name:k,path:g,params:m,matched:w,meta:v_(w)}}e.forEach(d=>i(d));function u(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:u,getRoutes:r,getRecordMatcher:a}}function pd(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function hd(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:m_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function m_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function gd(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function v_(e){return e.reduce((t,s)=>qe(t,s.meta),{})}function b_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;Zh(e,t[i])<0?n=i:s=i+1}const a=y_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function y_(e){let t=e;for(;t=t.parent;)if(Jh(t)&&Zh(e,t)===0)return t}function Jh({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function md(e){const t=ds(rr),s=ds(Sc),n=te(()=>{const o=Rs(e.to);return t.resolve(o)}),a=te(()=>{const{matched:o}=n.value,{length:c}=o,u=o[c-1],d=s.matched;if(!u||!d.length)return-1;const f=d.findIndex(Sa.bind(null,u));if(f>-1)return f;const p=vd(o[c-2]);return c>1&&vd(u)===p&&d[d.length-1].path!==p?d.findIndex(Sa.bind(null,o[c-2])):f}),i=te(()=>a.value>-1&&S_(s.params,n.value.params)),l=te(()=>a.value>-1&&a.value===s.matched.length-1&&Kh(s.params,n.value.params));function r(o={}){if(w_(o)){const c=t[Rs(e.replace)?"replace":"push"](Rs(e.to)).catch(ti);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:te(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function x_(e){return e.length===1?e[0]:e}const __=Ci({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:md,setup(e,{slots:t}){const s=bn(md(e)),{options:n}=ds(rr),a=te(()=>({[bd(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[bd(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&x_(t.default(s));return e.custom?i:va("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),k_=__;function w_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function S_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!_s(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function vd(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const bd=(e,t,s)=>e??t??s,T_=Ci({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=ds(bo),a=te(()=>e.route||n.value),i=ds(cd,0),l=te(()=>{let c=Rs(i);const{matched:u}=a.value;let d;for(;(d=u[c])&&!d.components;)c++;return c}),r=te(()=>a.value.matched[l.value]);Ja(cd,te(()=>l.value+1)),Ja(Xx,r),Ja(bo,a);const o=h();return fs(()=>[o.value,r.value,e.name],([c,u,d],[f,p,m])=>{u&&(u.instances[d]=c,p&&p!==u&&c&&c===f&&(u.leaveGuards.size||(u.leaveGuards=p.leaveGuards),u.updateGuards.size||(u.updateGuards=p.updateGuards))),c&&u&&(!p||!Sa(u,p)||!f)&&(u.enterCallbacks[d]||[]).forEach(g=>g(c))},{flush:"post"}),()=>{const c=a.value,u=e.name,d=r.value,f=d&&d.components[u];if(!f)return yd(s.default,{Component:f,route:c});const p=d.props[u],m=p?p===!0?c.params:typeof p=="function"?p(c):p:null,k=va(f,qe({},m,t,{onVnodeUnmounted:w=>{w.component.isUnmounted&&(d.instances[u]=null)},ref:o}));return yd(s.default,{Component:k,route:c})||k}}});function yd(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const C_=T_;function E_(e){const t=g_(e.routes,e),s=e.parseQuery||Yx,n=e.stringifyQuery||od,a=e.history,i=Ua(),l=Ua(),r=Ua(),o=Oo(on);let c=on;sa&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Ar.bind(null,V=>""+V),d=Ar.bind(null,Dx),f=Ar.bind(null,_i);function p(V,ue){let le,ve;return qh(V)?(le=t.getRecordMatcher(V),ve=ue):ve=V,t.addRoute(ve,le)}function m(V){const ue=t.getRecordMatcher(V);ue&&t.removeRoute(ue)}function g(){return t.getRoutes().map(V=>V.record)}function k(V){return!!t.getRecordMatcher(V)}function w(V,ue){if(ue=qe({},ue||o.value),typeof V=="string"){const E=Rr(s,V,ue.path),M=t.resolve({path:E.path},ue),J=a.createHref(E.fullPath);return qe(E,M,{params:f(M.params),hash:_i(E.hash),redirectedFrom:void 0,href:J})}let le;if(V.path!=null)le=qe({},V,{path:Rr(s,V.path,ue.path).path});else{const E=qe({},V.params);for(const M in E)E[M]==null&&delete E[M];le=qe({},V,{params:d(E)}),ue.params=d(ue.params)}const ve=t.resolve(le,ue),be=V.hash||"";ve.params=u(f(ve.params));const Me=Fx(n,qe({},V,{hash:Nx(be),path:ve.path})),y=a.createHref(Me);return qe({fullPath:Me,hash:be,query:n===od?Qx(V.query):V.query||{}},ve,{redirectedFrom:void 0,href:y})}function b(V){return typeof V=="string"?Rr(s,V,o.value.path):qe({},V)}function v(V,ue){if(c!==V)return Ta(rt.NAVIGATION_CANCELLED,{from:ue,to:V})}function x(V){return O(V)}function S(V){return x(qe(b(V),{replace:!0}))}function N(V,ue){const le=V.matched[V.matched.length-1];if(le&&le.redirect){const{redirect:ve}=le;let be=typeof ve=="function"?ve(V,ue):ve;return typeof be=="string"&&(be=be.includes("?")||be.includes("#")?be=b(be):{path:be},be.params={}),qe({query:V.query,hash:V.hash,params:be.path!=null?{}:V.params},be)}}function O(V,ue){const le=c=w(V),ve=o.value,be=V.state,Me=V.force,y=V.replace===!0,E=N(le,ve);if(E)return O(qe(b(E),{state:typeof E=="object"?qe({},be,E.state):be,force:Me,replace:y}),ue||le);const M=le;M.redirectedFrom=ue;let J;return!Me&&$x(n,ve,le)&&(J=Ta(rt.NAVIGATION_DUPLICATED,{to:M,from:ve}),re(ve,ve,!0,!1)),(J?Promise.resolve(J):L(M,ve)).catch(A=>Ms(A)?Ms(A,rt.NAVIGATION_GUARD_REDIRECT)?A:de(A):I(A,M,ve)).then(A=>{if(A){if(Ms(A,rt.NAVIGATION_GUARD_REDIRECT))return O(qe({replace:y},b(A.to),{state:typeof A.to=="object"?qe({},be,A.to.state):be,force:Me}),ue||M)}else A=P(M,ve,!0,y,be);return B(M,ve,A),A})}function T(V,ue){const le=v(V,ue);return le?Promise.reject(le):Promise.resolve()}function R(V){const ue=X.values().next().value;return ue&&typeof ue.runWithContext=="function"?ue.runWithContext(V):V()}function L(V,ue){let le;const[ve,be,Me]=e_(V,ue);le=Nr(ve.reverse(),"beforeRouteLeave",V,ue);for(const E of ve)E.leaveGuards.forEach(M=>{le.push(hn(M,V,ue))});const y=T.bind(null,V,ue);return le.push(y),Ne(le).then(()=>{le=[];for(const E of i.list())le.push(hn(E,V,ue));return le.push(y),Ne(le)}).then(()=>{le=Nr(be,"beforeRouteUpdate",V,ue);for(const E of be)E.updateGuards.forEach(M=>{le.push(hn(M,V,ue))});return le.push(y),Ne(le)}).then(()=>{le=[];for(const E of Me)if(E.beforeEnter)if(_s(E.beforeEnter))for(const M of E.beforeEnter)le.push(hn(M,V,ue));else le.push(hn(E.beforeEnter,V,ue));return le.push(y),Ne(le)}).then(()=>(V.matched.forEach(E=>E.enterCallbacks={}),le=Nr(Me,"beforeRouteEnter",V,ue,R),le.push(y),Ne(le))).then(()=>{le=[];for(const E of l.list())le.push(hn(E,V,ue));return le.push(y),Ne(le)}).catch(E=>Ms(E,rt.NAVIGATION_CANCELLED)?E:Promise.reject(E))}function B(V,ue,le){r.list().forEach(ve=>R(()=>ve(V,ue,le)))}function P(V,ue,le,ve,be){const Me=v(V,ue);if(Me)return Me;const y=ue===on,E=sa?history.state:{};le&&(ve||y?a.replace(V.fullPath,qe({scroll:y&&E&&E.scroll},be)):a.push(V.fullPath,be)),o.value=V,re(V,ue,le,y),de()}let C;function $(){C||(C=a.listen((V,ue,le)=>{if(!oe.listening)return;const ve=w(V),be=N(ve,oe.currentRoute.value);if(be){O(qe(be,{replace:!0,force:!0}),ve).catch(ti);return}c=ve;const Me=o.value;sa&&qx(rd(Me.fullPath,le.delta),lr()),L(ve,Me).catch(y=>Ms(y,rt.NAVIGATION_ABORTED|rt.NAVIGATION_CANCELLED)?y:Ms(y,rt.NAVIGATION_GUARD_REDIRECT)?(O(qe(b(y.to),{force:!0}),ve).then(E=>{Ms(E,rt.NAVIGATION_ABORTED|rt.NAVIGATION_DUPLICATED)&&!le.delta&&le.type===mo.pop&&a.go(-1,!1)}).catch(ti),Promise.reject()):(le.delta&&a.go(-le.delta,!1),I(y,ve,Me))).then(y=>{y=y||P(ve,Me,!1),y&&(le.delta&&!Ms(y,rt.NAVIGATION_CANCELLED)?a.go(-le.delta,!1):le.type===mo.pop&&Ms(y,rt.NAVIGATION_ABORTED|rt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),B(ve,Me,y)}).catch(ti)}))}let W=Ua(),G=Ua(),D;function I(V,ue,le){de(V);const ve=G.list();return ve.length?ve.forEach(be=>be(V,ue,le)):console.error(V),Promise.reject(V)}function K(){return D&&o.value!==on?Promise.resolve():new Promise((V,ue)=>{W.add([V,ue])})}function de(V){return D||(D=!V,$(),W.list().forEach(([ue,le])=>V?le(V):ue()),W.reset()),V}function re(V,ue,le,ve){const{scrollBehavior:be}=e;if(!sa||!be)return Promise.resolve();const Me=!le&&Gx(rd(V.fullPath,0))||(ve||!le)&&history.state&&history.state.scroll||null;return Tt().then(()=>be(V,ue,Me)).then(y=>y&&Kx(y)).catch(y=>I(y,V,ue))}const Z=V=>a.go(V);let he;const X=new Set,oe={currentRoute:o,listening:!0,addRoute:p,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:k,getRoutes:g,resolve:w,options:e,push:x,replace:S,go:Z,back:()=>Z(-1),forward:()=>Z(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:G.add,isReady:K,install(V){V.component("RouterLink",k_),V.component("RouterView",C_),V.config.globalProperties.$router=oe,Object.defineProperty(V.config.globalProperties,"$route",{enumerable:!0,get:()=>Rs(o)}),sa&&!he&&o.value===on&&(he=!0,x(a.location).catch(ve=>{}));const ue={};for(const ve in on)Object.defineProperty(ue,ve,{get:()=>o.value[ve],enumerable:!0});V.provide(rr,oe),V.provide(Sc,No(ue)),V.provide(bo,o);const le=V.unmount;X.add(V),V.unmount=function(){X.delete(V),X.size<1&&(c=on,C&&C(),C=null,o.value=on,he=!1,D=!1),le()}}};function Ne(V){return V.reduce((ue,le)=>ue.then(()=>R(le)),Promise.resolve())}return oe}function Yh(){return ds(rr)}function A_(e){return ds(Sc)}const R_=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...["Live","Agents","Loops","Processes","Schedules"].map(e=>({group:"Operations",label:e,icon:"operations",to:{path:"/operations",query:{tab:e.toLowerCase()}}})),...["Audit","Sessions","Traces","Usage"].map(e=>({group:"History",label:e,icon:"history",to:{path:"/history",query:{tab:e.toLowerCase()}}})),...["Tools","Skills","Knowledge","Memory","Learned"].map(e=>({group:"Capabilities",label:e,icon:"capabilities",to:{path:"/capabilities",query:{tab:e.toLowerCase()}}})),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...[["Health","health"],["Resources","resources"],["Logs","logs"],["Config","config"],["Discord","discord"],["Host Access","host-access"],["API Tokens","api-tokens"],["LLM Config","llm"],["Internals","internals"],["Update","update"]].map(([e,t])=>({group:"System",label:e,icon:"system",to:{path:"/system",query:{tab:t}}}))],Jt=bn({open:!1,query:"",selected:0});function xd(){Jt.query="",Jt.selected=0,Jt.open=!0}function Or(){Jt.open=!1}function I_(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const N_={setup(){const e=Yh(),t=h(null),s=te(()=>{const i=Jt.query.trim().toLowerCase();return R_.map(l=>({...l,_score:I_(l,i)})).filter(l=>l._score>0).sort((l,r)=>r._score-l._score)});fs(()=>Jt.open,async i=>{var l;i&&(await Tt(),(l=t.value)==null||l.focus())}),fs(()=>Jt.query,()=>{Jt.selected=0});function n(i){Or(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Or();return}if(i.key==="ArrowDown")i.preventDefault(),Jt.selected=Math.min(Jt.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Jt.selected=Math.max(Jt.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Jt.selected];l&&n(l)}}return{state:Jt,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Or}},template:`
    <transition name="modal">
...
... (truncated)`:s}function kd(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function eg(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function M_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const P_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=te(()=>{const C=e.value.uptime_seconds||0,$=Math.floor(C/86400),W=Math.floor(C%86400/3600),G=Math.floor(C%3600/60),D=[];return $>0&&D.push(`${$}d`),W>0&&D.push(`${W}h`),(D.length===0||$===0&&W===0)&&D.push(`${G}m`),D.join(" ")}),p=te(()=>{const C=e.value.uptime_seconds||0;return 125.66*(1-Math.min(C/86400,1))}),m=te(()=>{const C=e.value;return[{label:"Guilds",value:C.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:C.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:C.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${C.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:C.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:C.loop_count>0?"text-green-400":"",highlight:C.loop_count>0},{label:"Agents",value:C.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:C.agent_count>0?`${C.agent_count} total`:"",subColor:"text-gray-500",highlight:(C.agent_running??0)>0},{label:"Processes",value:C.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:C.process_count>0?`${C.process_count} total`:"",subColor:"text-gray-500",highlight:(C.process_running??0)>0},{label:"Schedules",value:C.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(C.schedule_failing>0?`${C.schedule_failing} failing`:"")+(C.schedule_failing>0&&C.schedule_paused>0?", ":"")+(C.schedule_paused>0?`${C.schedule_paused} paused`:"")||void 0,subColor:C.schedule_failing>0?"text-red-400":"text-yellow-400",color:C.schedule_failing>0?"text-red-400":"",highlight:C.schedule_failing>0},{label:"Users",value:C.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=te(()=>{const C=e.value,$=[];return $.push({label:"Bot",status:C.status==="online"?"ok":"warn",detail:C.status==="online"?"Online":"Starting"}),(C.schedule_failing||0)>0?$.push({label:"Schedules",status:"error",detail:`${C.schedule_failing} failing`}):(C.schedule_count||0)>0&&$.push({label:"Schedules",status:"ok",detail:`${C.schedule_count} configured`}),(C.loop_count||0)>0&&$.push({label:"Loops",status:"ok",detail:`${C.loop_count} active`}),(C.agent_running||0)>0&&$.push({label:"Agents",status:"ok",detail:`${C.agent_running} running`}),(C.process_running||0)>0&&$.push({label:"Processes",status:"ok",detail:`${C.process_running} running`}),$});async function k(){try{e.value=await q.get("/api/status"),s.value=null}catch(C){s.value=C.message}finally{t.value=!1}}async function w(){a.value=!0;try{n.value=await q.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function b(){l.value=!0;try{i.value=await q.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function v(){try{const C=await q.get("/api/knowledge");c.value=(Array.isArray(C)?C:[]).reduce(($,W)=>$+(W.chunks||0),0)}catch{c.value=null}}async function x(){try{const C=await q.get("/api/agents");r.value=C.filter($=>$.status==="running")}catch{}}async function S(){u.value={...u.value,reload:!0};try{await q.post("/api/reload"),ke.success("Config reloaded")}catch(C){ke.error(C.message)}u.value={...u.value,reload:!1}}async function N(){if(!await as({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const $=e.value.session_count;e.value={...e.value,session_count:0};try{const W=await q.post("/api/sessions/clear-all");ke.success(`Cleared ${W.count} session${W.count!==1?"s":""}`),await k()}catch(W){e.value={...e.value,session_count:$},ke.error(W.message)}u.value={...u.value,clearSessions:!1}}async function O(){if(!await as({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const $=e.value.loop_count;e.value={...e.value,loop_count:0};try{const W=await q.post("/api/loops/stop-all");ke.success(W.result),await k()}catch(W){e.value={...e.value,loop_count:$},ke.error(W.message)}u.value={...u.value,stopLoops:!1}}function T(){t.value=!0,s.value=null,k(),w(),b(),x()}let R=null,L=null,B=null;function P(C){if(C.payload&&C.payload.tool_name){const $={...C.payload,_isNew:!0,_key:++d};n.value.unshift($),n.value.length>10&&n.value.pop(),o.value++,$.error&&(i.value.unshift($),i.value.length>5&&i.value.pop()),setTimeout(()=>{$._isNew=!1},1500),clearTimeout(B),B=setTimeout(()=>{o.value=0},1e4)}}return Ue(async()=>{await Promise.all([k(),w(),b(),x(),v()]),R=setInterval(k,15e3),L=setInterval(x,1e4),Ge.subscribe("events",P)}),ft(()=>{R&&clearInterval(R),L&&clearInterval(L),clearTimeout(B),Ge.unsubscribe("events",P)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:m,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:w,fetchStatus:k,formatTime:Cc,formatDuration:Ca,retry:T,reloadConfig:S,clearSessions:N,stopAllLoops:O}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function wd(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function F_(e){if(Array.isArray(e))return e}function $_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function U_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function B_(e,t){return F_(e)||$_(e,t)||H_(e,t)||U_()}function H_(e,t){if(e){if(typeof e=="string")return wd(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?wd(e,t):void 0}}const tg=Object.entries,Sd=Object.setPrototypeOf,V_=Object.isFrozen,j_=Object.getPrototypeOf,z_=Object.getOwnPropertyDescriptor;let qt=Object.freeze,hs=Object.seal,na=Object.create,sg=typeof Reflect<"u"&&Reflect,xo=sg.apply,_o=sg.construct;qt||(qt=function(t){return t});hs||(hs=function(t){return t});xo||(xo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});_o||(_o=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Ps=vt(Array.prototype.forEach),K_=vt(Array.prototype.lastIndexOf),Td=vt(Array.prototype.pop),Qn=vt(Array.prototype.push),q_=vt(Array.prototype.splice),Ht=Array.isArray,Ga=vt(String.prototype.toLowerCase),Lr=vt(String.prototype.toString),Cd=vt(String.prototype.match),Xn=vt(String.prototype.replace),Ed=vt(String.prototype.indexOf),G_=vt(String.prototype.trim),W_=vt(Number.prototype.toString),Z_=vt(Boolean.prototype.toString),Ad=typeof BigInt>"u"?null:vt(BigInt.prototype.toString),Rd=typeof Symbol>"u"?null:vt(Symbol.prototype.toString),lt=vt(Object.prototype.hasOwnProperty),Ba=vt(Object.prototype.toString),Et=vt(RegExp.prototype.test),Sn=J_(TypeError);function vt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return xo(e,t,n)}}function J_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return _o(e,s)}}function Oe(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Ga;if(Sd&&Sd(e,null),!Ht(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(V_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function Y_(e){for(let t=0;t<e.length;t++)lt(e,t)||(e[t]=null);return e}function Dt(e){const t=na(null);for(const n of tg(e)){var s=B_(n,2);const a=s[0],i=s[1];lt(e,a)&&(Ht(i)?t[a]=Y_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Dt(i):t[a]=i)}return t}function Q_(e){switch(typeof e){case"string":return e;case"number":return W_(e);case"boolean":return Z_(e);case"bigint":return Ad?Ad(e):"0";case"symbol":return Rd?Rd(e):"Symbol()";case"undefined":return Ba(e);case"function":case"object":{if(e===null)return Ba(e);const t=e,s=Ss(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Ba(n)}return Ba(e)}default:return Ba(e)}}function Ss(e,t){for(;e!==null;){const n=z_(e,t);if(n){if(n.get)return vt(n.get);if(typeof n.value=="function")return vt(n.value)}e=j_(e)}function s(){return null}return s}function X_(e){try{return Et(e,""),!0}catch{return!1}}const Id=qt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Dr=qt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Mr=qt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ek=qt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Pr=qt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),tk=qt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Nd=qt(["#text"]),Od=qt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Fr=qt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Ld=qt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ji=qt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),sk=hs(/{{[\w\W]*|^[\w\W]*}}/g),nk=hs(/<%[\w\W]*|^[\w\W]*%>/g),ak=hs(/\${[\w\W]*/g),ik=hs(/^data-[\-\w.\u00B7-\uFFFF]+$/),lk=hs(/^aria-[\-\w]+$/),Dd=hs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),rk=hs(/^(?:\w+script|data):/i),ok=hs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ck=hs(/^html$/i),uk=hs(/^[a-z][.\w]*(-[.\w]+)+$/i),ks={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},dk=function(){return typeof window>"u"?null:window},fk=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Md=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function ng(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:dk();const t=me=>ng(me);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==ks.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=Ss(f,"cloneNode"),m=Ss(f,"remove"),g=Ss(f,"nextSibling"),k=Ss(f,"childNodes"),w=Ss(f,"parentNode"),b=Ss(f,"shadowRoot"),v=Ss(f,"attributes"),x=l&&l.prototype?Ss(l.prototype,"nodeType"):null,S=l&&l.prototype?Ss(l.prototype,"nodeName"):null;if(typeof i=="function"){const me=s.createElement("template");me.content&&me.content.ownerDocument&&(s=me.content.ownerDocument)}let N,O="",T,R=!1,L=0;const B=function(){if(L>0)throw Sn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},P=function(_){B(),L++;try{return N.createHTML(_)}finally{L--}},C=function(_){B(),L++;try{return N.createScriptURL(_)}finally{L--}},$=function(){return R||(T=fk(d,a),R=!0),T},W=s,G=W.implementation,D=W.createNodeIterator,I=W.createDocumentFragment,K=W.getElementsByTagName,de=n.importNode;let re=Md();t.isSupported=typeof tg=="function"&&typeof w=="function"&&G&&G.createHTMLDocument!==void 0;const Z=sk,he=nk,X=ak,oe=ik,Ne=lk,V=rk,ue=ok,le=uk;let ve=Dd,be=null;const Me=Oe({},[...Id,...Dr,...Mr,...Pr,...Nd]);let y=null;const E=Oe({},[...Od,...Fr,...Ld,...Ji]);let M=Object.seal(na(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),J=null,A=null;const F=Object.seal(na(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Y=!0,Q=!0,se=!1,ee=!0,ge=!1,ie=!0,fe=!1,_e=!1,Te=!1,Re=!1,U=!1,ce=!1,xe=!0,j=!1;const ye="user-content-";let Be=!0,bt=!1,st={},Ye=null;const sn=Oe({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let xn=null;const Li=Oe({},["audio","video","img","source","image","track"]);let Na=null;const Di=Oe({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Kn="http://www.w3.org/1998/Math/MathML",qn="http://www.w3.org/2000/svg",Ot="http://www.w3.org/1999/xhtml";let gs=Ot,nn=!1,Oa=null;const Mi=Oe({},[Kn,qn,Ot],Lr);let H=Oe({},["mi","mo","mn","ms","mtext"]),ne=Oe({},["annotation-xml"]);const Ce=Oe({},["title","style","font","a","script"]);let Ke=null;const it=["application/xhtml+xml","text/html"],Gt="text/html";let nt=null,Gn=null;const vg=s.createElement("form"),Fc=function(_){return _ instanceof RegExp||_ instanceof Function},dr=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Gn&&Gn===_)return;(!_||typeof _!="object")&&(_={}),_=Dt(_),Ke=it.indexOf(_.PARSER_MEDIA_TYPE)===-1?Gt:_.PARSER_MEDIA_TYPE,nt=Ke==="application/xhtml+xml"?Lr:Ga,be=lt(_,"ALLOWED_TAGS")&&Ht(_.ALLOWED_TAGS)?Oe({},_.ALLOWED_TAGS,nt):Me,y=lt(_,"ALLOWED_ATTR")&&Ht(_.ALLOWED_ATTR)?Oe({},_.ALLOWED_ATTR,nt):E,Oa=lt(_,"ALLOWED_NAMESPACES")&&Ht(_.ALLOWED_NAMESPACES)?Oe({},_.ALLOWED_NAMESPACES,Lr):Mi,Na=lt(_,"ADD_URI_SAFE_ATTR")&&Ht(_.ADD_URI_SAFE_ATTR)?Oe(Dt(Di),_.ADD_URI_SAFE_ATTR,nt):Di,xn=lt(_,"ADD_DATA_URI_TAGS")&&Ht(_.ADD_DATA_URI_TAGS)?Oe(Dt(Li),_.ADD_DATA_URI_TAGS,nt):Li,Ye=lt(_,"FORBID_CONTENTS")&&Ht(_.FORBID_CONTENTS)?Oe({},_.FORBID_CONTENTS,nt):sn,J=lt(_,"FORBID_TAGS")&&Ht(_.FORBID_TAGS)?Oe({},_.FORBID_TAGS,nt):Dt({}),A=lt(_,"FORBID_ATTR")&&Ht(_.FORBID_ATTR)?Oe({},_.FORBID_ATTR,nt):Dt({}),st=lt(_,"USE_PROFILES")?_.USE_PROFILES&&typeof _.USE_PROFILES=="object"?Dt(_.USE_PROFILES):_.USE_PROFILES:!1,Y=_.ALLOW_ARIA_ATTR!==!1,Q=_.ALLOW_DATA_ATTR!==!1,se=_.ALLOW_UNKNOWN_PROTOCOLS||!1,ee=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ge=_.SAFE_FOR_TEMPLATES||!1,ie=_.SAFE_FOR_XML!==!1,fe=_.WHOLE_DOCUMENT||!1,Re=_.RETURN_DOM||!1,U=_.RETURN_DOM_FRAGMENT||!1,ce=_.RETURN_TRUSTED_TYPE||!1,Te=_.FORCE_BODY||!1,xe=_.SANITIZE_DOM!==!1,j=_.SANITIZE_NAMED_PROPS||!1,Be=_.KEEP_CONTENT!==!1,bt=_.IN_PLACE||!1,ve=X_(_.ALLOWED_URI_REGEXP)?_.ALLOWED_URI_REGEXP:Dd,gs=typeof _.NAMESPACE=="string"?_.NAMESPACE:Ot,H=lt(_,"MATHML_TEXT_INTEGRATION_POINTS")&&_.MATHML_TEXT_INTEGRATION_POINTS&&typeof _.MATHML_TEXT_INTEGRATION_POINTS=="object"?Dt(_.MATHML_TEXT_INTEGRATION_POINTS):Oe({},["mi","mo","mn","ms","mtext"]),ne=lt(_,"HTML_INTEGRATION_POINTS")&&_.HTML_INTEGRATION_POINTS&&typeof _.HTML_INTEGRATION_POINTS=="object"?Dt(_.HTML_INTEGRATION_POINTS):Oe({},["annotation-xml"]);const z=lt(_,"CUSTOM_ELEMENT_HANDLING")&&_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING=="object"?Dt(_.CUSTOM_ELEMENT_HANDLING):na(null);if(M=na(null),lt(z,"tagNameCheck")&&Fc(z.tagNameCheck)&&(M.tagNameCheck=z.tagNameCheck),lt(z,"attributeNameCheck")&&Fc(z.attributeNameCheck)&&(M.attributeNameCheck=z.attributeNameCheck),lt(z,"allowCustomizedBuiltInElements")&&typeof z.allowCustomizedBuiltInElements=="boolean"&&(M.allowCustomizedBuiltInElements=z.allowCustomizedBuiltInElements),ge&&(Q=!1),U&&(Re=!0),st&&(be=Oe({},Nd),y=na(null),st.html===!0&&(Oe(be,Id),Oe(y,Od)),st.svg===!0&&(Oe(be,Dr),Oe(y,Fr),Oe(y,Ji)),st.svgFilters===!0&&(Oe(be,Mr),Oe(y,Fr),Oe(y,Ji)),st.mathMl===!0&&(Oe(be,Pr),Oe(y,Ld),Oe(y,Ji))),F.tagCheck=null,F.attributeCheck=null,lt(_,"ADD_TAGS")&&(typeof _.ADD_TAGS=="function"?F.tagCheck=_.ADD_TAGS:Ht(_.ADD_TAGS)&&(be===Me&&(be=Dt(be)),Oe(be,_.ADD_TAGS,nt))),lt(_,"ADD_ATTR")&&(typeof _.ADD_ATTR=="function"?F.attributeCheck=_.ADD_ATTR:Ht(_.ADD_ATTR)&&(y===E&&(y=Dt(y)),Oe(y,_.ADD_ATTR,nt))),lt(_,"ADD_URI_SAFE_ATTR")&&Ht(_.ADD_URI_SAFE_ATTR)&&Oe(Na,_.ADD_URI_SAFE_ATTR,nt),lt(_,"FORBID_CONTENTS")&&Ht(_.FORBID_CONTENTS)&&(Ye===sn&&(Ye=Dt(Ye)),Oe(Ye,_.FORBID_CONTENTS,nt)),lt(_,"ADD_FORBID_CONTENTS")&&Ht(_.ADD_FORBID_CONTENTS)&&(Ye===sn&&(Ye=Dt(Ye)),Oe(Ye,_.ADD_FORBID_CONTENTS,nt)),Be&&(be["#text"]=!0),fe&&Oe(be,["html","head","body"]),be.table&&(Oe(be,["tbody"]),delete J.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ae=N;N=_.TRUSTED_TYPES_POLICY;try{O=P("")}catch(Se){throw N=ae,Se}}else _.TRUSTED_TYPES_POLICY===null?(N=void 0,O=""):(N===void 0&&(N=$()),N&&typeof O=="string"&&(O=P("")));(re.uponSanitizeElement.length>0||re.uponSanitizeAttribute.length>0)&&be===Me&&(be=Dt(be)),re.uponSanitizeAttribute.length>0&&y===E&&(y=Dt(y)),qt&&qt(_),Gn=_},$c=Oe({},[...Dr,...Mr,...ek]),Uc=Oe({},[...Pr,...tk]),bg=function(_){let z=w(_);(!z||!z.tagName)&&(z={namespaceURI:gs,tagName:"template"});const ae=Ga(_.tagName),Se=Ga(z.tagName);return Oa[_.namespaceURI]?_.namespaceURI===qn?z.namespaceURI===Ot?ae==="svg":z.namespaceURI===Kn?ae==="svg"&&(Se==="annotation-xml"||H[Se]):!!$c[ae]:_.namespaceURI===Kn?z.namespaceURI===Ot?ae==="math":z.namespaceURI===qn?ae==="math"&&ne[Se]:!!Uc[ae]:_.namespaceURI===Ot?z.namespaceURI===qn&&!ne[Se]||z.namespaceURI===Kn&&!H[Se]?!1:!Uc[ae]&&(Ce[ae]||!$c[ae]):!!(Ke==="application/xhtml+xml"&&Oa[_.namespaceURI]):!1},ms=function(_){Qn(t.removed,{element:_});try{w(_).removeChild(_)}catch{if(m(_),!w(_))throw Sn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Bc=function(_){const z=k?k(_):_.childNodes;if(z){const Se=[];Ps(z,Ae=>{Qn(Se,Ae)}),Ps(Se,Ae=>{try{m(Ae)}catch{}})}const ae=v?v(_):null;if(ae)for(let Se=ae.length-1;Se>=0;--Se){const Ae=ae[Se],Le=Ae&&Ae.name;if(typeof Le=="string")try{_.removeAttribute(Le)}catch{}}},_n=function(_,z){try{Qn(t.removed,{attribute:z.getAttributeNode(_),from:z})}catch{Qn(t.removed,{attribute:null,from:z})}if(z.removeAttribute(_),_==="is")if(Re||U)try{ms(z)}catch{}else try{z.setAttribute(_,"")}catch{}},yg=function(_){const z=v?v(_):_.attributes;if(z)for(let ae=z.length-1;ae>=0;--ae){const Se=z[ae],Ae=Se&&Se.name;if(!(typeof Ae!="string"||y[nt(Ae)]))try{_.removeAttribute(Ae)}catch{}}},xg=function(_){const z=[_];for(;z.length>0;){const ae=z.pop();(x?x(ae):ae.nodeType)===ks.element&&yg(ae);const Ae=k?k(ae):ae.childNodes;if(Ae)for(let Le=Ae.length-1;Le>=0;--Le)z.push(Ae[Le])}},Hc=function(_){let z=null,ae=null;if(Te)_="<remove></remove>"+_;else{const Le=Cd(_,/^[\r\n\t ]+/);ae=Le&&Le[0]}Ke==="application/xhtml+xml"&&gs===Ot&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const Se=N?P(_):_;if(gs===Ot)try{z=new u().parseFromString(Se,Ke)}catch{}if(!z||!z.documentElement){z=G.createDocument(gs,"template",null);try{z.documentElement.innerHTML=nn?O:Se}catch{}}const Ae=z.body||z.documentElement;return _&&ae&&Ae.insertBefore(s.createTextNode(ae),Ae.childNodes[0]||null),gs===Ot?K.call(z,fe?"html":"body")[0]:fe?z.documentElement:Ae},Vc=function(_){return D.call(_.ownerDocument||_,_,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},fr=function(_){var z,ae;_.normalize();const Se=D.call(_.ownerDocument||_,_,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Ae=Se.nextNode();for(;Ae;){let yt=Ae.data;Ps([Z,he,X],Qe=>{yt=Xn(yt,Qe," ")}),Ae.data=yt,Ae=Se.nextNode()}const Le=(z=(ae=_.querySelectorAll)===null||ae===void 0?void 0:ae.call(_,"template"))!==null&&z!==void 0?z:[];Ps(Array.from(Le),yt=>{Wn(yt.content)&&fr(yt.content)})},Pi=function(_){const z=S?S(_):null;return typeof z!="string"||nt(z)!=="form"?!1:typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||_.attributes!==v(_)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function"||_.nodeType!==x(_)||_.childNodes!==k(_)},Wn=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return x(_)===ks.documentFragment}catch{return!1}},La=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return typeof x(_)=="number"}catch{return!1}};function Os(me,_,z){Ps(me,ae=>{ae.call(t,_,z,Gn)})}const jc=function(_){let z=null;if(Os(re.beforeSanitizeElements,_,null),Pi(_))return ms(_),!0;const ae=nt(S?S(_):_.nodeName);if(Os(re.uponSanitizeElement,_,{tagName:ae,allowedTags:be}),ie&&_.hasChildNodes()&&!La(_.firstElementChild)&&Et(/<[/\w!]/g,_.innerHTML)&&Et(/<[/\w!]/g,_.textContent)||ie&&_.namespaceURI===Ot&&ae==="style"&&La(_.firstElementChild)||_.nodeType===ks.progressingInstruction||ie&&_.nodeType===ks.comment&&Et(/<[/\w]/g,_.data))return ms(_),!0;if(J[ae]||!(F.tagCheck instanceof Function&&F.tagCheck(ae))&&!be[ae]){if(!J[ae]&&Kc(ae)&&(M.tagNameCheck instanceof RegExp&&Et(M.tagNameCheck,ae)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ae)))return!1;if(Be&&!Ye[ae]){const Ae=w(_),Le=k(_);if(Le&&Ae){const yt=Le.length;for(let Qe=yt-1;Qe>=0;--Qe){const ct=bt?Le[Qe]:p(Le[Qe],!0);Ae.insertBefore(ct,g(_))}}}return ms(_),!0}return(x?x(_):_.nodeType)===ks.element&&!bg(_)||(ae==="noscript"||ae==="noembed"||ae==="noframes")&&Et(/<\/no(script|embed|frames)/i,_.innerHTML)?(ms(_),!0):(ge&&_.nodeType===ks.text&&(z=_.textContent,Ps([Z,he,X],Ae=>{z=Xn(z,Ae," ")}),_.textContent!==z&&(Qn(t.removed,{element:_.cloneNode()}),_.textContent=z)),Os(re.afterSanitizeElements,_,null),!1)},zc=function(_,z,ae){if(A[z]||xe&&(z==="id"||z==="name")&&(ae in s||ae in vg))return!1;const Se=y[z]||F.attributeCheck instanceof Function&&F.attributeCheck(z,_);if(!(Q&&!A[z]&&Et(oe,z))){if(!(Y&&Et(Ne,z))){if(!Se||A[z]){if(!(Kc(_)&&(M.tagNameCheck instanceof RegExp&&Et(M.tagNameCheck,_)||M.tagNameCheck instanceof Function&&M.tagNameCheck(_))&&(M.attributeNameCheck instanceof RegExp&&Et(M.attributeNameCheck,z)||M.attributeNameCheck instanceof Function&&M.attributeNameCheck(z,_))||z==="is"&&M.allowCustomizedBuiltInElements&&(M.tagNameCheck instanceof RegExp&&Et(M.tagNameCheck,ae)||M.tagNameCheck instanceof Function&&M.tagNameCheck(ae))))return!1}else if(!Na[z]){if(!Et(ve,Xn(ae,ue,""))){if(!((z==="src"||z==="xlink:href"||z==="href")&&_!=="script"&&Ed(ae,"data:")===0&&xn[_])){if(!(se&&!Et(V,Xn(ae,ue,"")))){if(ae)return!1}}}}}}return!0},_g=Oe({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Kc=function(_){return!_g[Ga(_)]&&Et(le,_)},qc=function(_){Os(re.beforeSanitizeAttributes,_,null);const z=_.attributes;if(!z||Pi(_))return;const ae={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let Se=z.length;for(;Se--;){const Ae=z[Se],Le=Ae.name,yt=Ae.namespaceURI,Qe=Ae.value,ct=nt(Le),an=Qe;let wt=Le==="value"?an:G_(an);if(ae.attrName=ct,ae.attrValue=wt,ae.keepAttr=!0,ae.forceKeepAttr=void 0,Os(re.uponSanitizeAttribute,_,ae),wt=ae.attrValue,j&&(ct==="id"||ct==="name")&&Ed(wt,ye)!==0&&(_n(Le,_),wt=ye+wt),ie&&Et(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,wt)){_n(Le,_);continue}if(ct==="attributename"&&Cd(wt,"href")){_n(Le,_);continue}if(ae.forceKeepAttr)continue;if(!ae.keepAttr){_n(Le,_);continue}if(!ee&&Et(/\/>/i,wt)){_n(Le,_);continue}ge&&Ps([Z,he,X],Wc=>{wt=Xn(wt,Wc," ")});const Gc=nt(_.nodeName);if(!zc(Gc,ct,wt)){_n(Le,_);continue}if(N&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!yt)switch(d.getAttributeType(Gc,ct)){case"TrustedHTML":{wt=P(wt);break}case"TrustedScriptURL":{wt=C(wt);break}}if(wt!==an)try{yt?_.setAttributeNS(yt,Le,wt):_.setAttribute(Le,wt),Pi(_)?ms(_):Td(t.removed)}catch{_n(Le,_)}}Os(re.afterSanitizeAttributes,_,null)},Fi=function(_){let z=null;const ae=Vc(_);for(Os(re.beforeSanitizeShadowDOM,_,null);z=ae.nextNode();)if(Os(re.uponSanitizeShadowNode,z,null),jc(z),qc(z),Wn(z.content)&&Fi(z.content),(x?x(z):z.nodeType)===ks.element){const Ae=b?b(z):z.shadowRoot;Wn(Ae)&&(pr(Ae),Fi(Ae))}Os(re.afterSanitizeShadowDOM,_,null)},pr=function(_){const z=[{node:_,shadow:null}];for(;z.length>0;){const ae=z.pop();if(ae.shadow){Fi(ae.shadow);continue}const Se=ae.node,Le=(x?x(Se):Se.nodeType)===ks.element,yt=k?k(Se):Se.childNodes;if(yt)for(let Qe=yt.length-1;Qe>=0;--Qe)z.push({node:yt[Qe],shadow:null});if(Le){const Qe=S?S(Se):null;if(typeof Qe=="string"&&nt(Qe)==="template"){const ct=Se.content;Wn(ct)&&z.push({node:ct,shadow:null})}}if(Le){const Qe=b?b(Se):Se.shadowRoot;Wn(Qe)&&z.push({node:null,shadow:Qe},{node:Qe,shadow:null})}}};return t.sanitize=function(me){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},z=null,ae=null,Se=null,Ae=null;if(nn=!me,nn&&(me="<!-->"),typeof me!="string"&&!La(me)&&(me=Q_(me),typeof me!="string"))throw Sn("dirty is not a string, aborting");if(!t.isSupported)return me;_e||dr(_),t.removed=[];const Le=bt&&typeof me!="string"&&La(me);if(Le){const ct=S?S(me):me.nodeName;if(typeof ct=="string"){const an=nt(ct);if(!be[an]||J[an])throw Sn("root node is forbidden and cannot be sanitized in-place")}if(Pi(me))throw Sn("root node is clobbered and cannot be sanitized in-place");try{pr(me)}catch(an){throw Bc(me),an}}else if(La(me))z=Hc("<!---->"),ae=z.ownerDocument.importNode(me,!0),ae.nodeType===ks.element&&ae.nodeName==="BODY"||ae.nodeName==="HTML"?z=ae:z.appendChild(ae),pr(ae);else{if(!Re&&!ge&&!fe&&me.indexOf("<")===-1)return N&&ce?P(me):me;if(z=Hc(me),!z)return Re?null:ce?O:""}z&&Te&&ms(z.firstChild);const yt=Vc(Le?me:z);try{for(;Se=yt.nextNode();)jc(Se),qc(Se),Wn(Se.content)&&Fi(Se.content)}catch(ct){throw Le&&Bc(me),ct}if(Le)return Ps(t.removed,ct=>{ct.element&&xg(ct.element)}),ge&&fr(me),me;if(Re){if(ge&&fr(z),U)for(Ae=I.call(z.ownerDocument);z.firstChild;)Ae.appendChild(z.firstChild);else Ae=z;return(y.shadowroot||y.shadowrootmode)&&(Ae=de.call(n,Ae,!0)),Ae}let Qe=fe?z.outerHTML:z.innerHTML;return fe&&be["!doctype"]&&z.ownerDocument&&z.ownerDocument.doctype&&z.ownerDocument.doctype.name&&Et(ck,z.ownerDocument.doctype.name)&&(Qe="<!DOCTYPE "+z.ownerDocument.doctype.name+`>
`+Qe),ge&&Ps([Z,he,X],ct=>{Qe=Xn(Qe,ct," ")}),N&&ce?P(Qe):Qe},t.setConfig=function(){let me=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};dr(me),_e=!0},t.clearConfig=function(){Gn=null,_e=!1,N=T,O=""},t.isValidAttribute=function(me,_,z){Gn||dr({});const ae=nt(me),Se=nt(_);return zc(ae,Se,z)},t.addHook=function(me,_){typeof _=="function"&&Qn(re[me],_)},t.removeHook=function(me,_){if(_!==void 0){const z=K_(re[me],_);return z===-1?void 0:q_(re[me],z,1)[0]}return Td(re[me])},t.removeHooks=function(me){re[me]=[]},t.removeAllHooks=function(){re=Md()},t}var Pd=ng();function Ac(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var zn=Ac();function ag(e){zn=e}var si={exec:()=>null};function We(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(zt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var zt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},pk=/^(?:[ \t]*(?:\n|$))+/,hk=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,gk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Oi=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,mk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Rc=/(?:[*+-]|\d{1,9}[.)])/,ig=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,lg=We(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),vk=We(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ic=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,bk=/^[^\n]+/,Nc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,yk=We(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Nc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),xk=We(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Rc).getRegex(),or="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Oc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_k=We("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Oc).replace("tag",or).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),rg=We(Ic).replace("hr",Oi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex(),kk=We(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",rg).getRegex(),Lc={blockquote:kk,code:hk,def:yk,fences:gk,heading:mk,hr:Oi,html:_k,lheading:lg,list:xk,newline:pk,paragraph:rg,table:si,text:bk},Fd=We("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Oi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex(),wk={...Lc,lheading:vk,table:Fd,paragraph:We(Ic).replace("hr",Oi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Fd).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",or).getRegex()},Sk={...Lc,html:We(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Oc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:si,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:We(Ic).replace("hr",Oi).replace("heading",` *#{1,6} *[^
]`).replace("lheading",lg).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Tk=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ck=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,og=/^( {2,}|\\)\n(?!\s*$)/,Ek=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,cr=/[\p{P}\p{S}]/u,Dc=/[\s\p{P}\p{S}]/u,cg=/[^\s\p{P}\p{S}]/u,Ak=We(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Dc).getRegex(),ug=/(?!~)[\p{P}\p{S}]/u,Rk=/(?!~)[\s\p{P}\p{S}]/u,Ik=/(?:[^\s\p{P}\p{S}]|~)/u,Nk=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,dg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ok=We(dg,"u").replace(/punct/g,cr).getRegex(),Lk=We(dg,"u").replace(/punct/g,ug).getRegex(),fg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Dk=We(fg,"gu").replace(/notPunctSpace/g,cg).replace(/punctSpace/g,Dc).replace(/punct/g,cr).getRegex(),Mk=We(fg,"gu").replace(/notPunctSpace/g,Ik).replace(/punctSpace/g,Rk).replace(/punct/g,ug).getRegex(),Pk=We("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,cg).replace(/punctSpace/g,Dc).replace(/punct/g,cr).getRegex(),Fk=We(/\\(punct)/,"gu").replace(/punct/g,cr).getRegex(),$k=We(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Uk=We(Oc).replace("(?:-->|$)","-->").getRegex(),Bk=We("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Uk).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ll=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Hk=We(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Ll).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),pg=We(/^!?\[(label)\]\[(ref)\]/).replace("label",Ll).replace("ref",Nc).getRegex(),hg=We(/^!?\[(ref)\](?:\[\])?/).replace("ref",Nc).getRegex(),Vk=We("reflink|nolink(?!\\()","g").replace("reflink",pg).replace("nolink",hg).getRegex(),Mc={_backpedal:si,anyPunctuation:Fk,autolink:$k,blockSkip:Nk,br:og,code:Ck,del:si,emStrongLDelim:Ok,emStrongRDelimAst:Dk,emStrongRDelimUnd:Pk,escape:Tk,link:Hk,nolink:hg,punctuation:Ak,reflink:pg,reflinkSearch:Vk,tag:Bk,text:Ek,url:si},jk={...Mc,link:We(/^!?\[(label)\]\((.*?)\)/).replace("label",Ll).getRegex(),reflink:We(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ll).getRegex()},ko={...Mc,emStrongRDelimAst:Mk,emStrongLDelim:Lk,url:We(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},zk={...ko,br:We(og).replace("{2,}","*").getRegex(),text:We(ko.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Yi={normal:Lc,gfm:wk,pedantic:Sk},Ha={normal:Mc,gfm:ko,breaks:zk,pedantic:jk},Kk={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},$d=e=>Kk[e];function Ts(e,t){if(t){if(zt.escapeTest.test(e))return e.replace(zt.escapeReplace,$d)}else if(zt.escapeTestNoEncode.test(e))return e.replace(zt.escapeReplaceNoEncode,$d);return e}function Ud(e){try{e=encodeURI(e).replace(zt.percentDecode,"%")}catch{return null}return e}function Bd(e,t){var i;const s=e.replace(zt.findPipe,(l,r,o)=>{let c=!1,u=r;for(;--u>=0&&o[u]==="\\";)c=!c;return c?"|":" |"}),n=s.split(zt.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(zt.slashPipe,"|");return n}function Va(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function qk(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function Hd(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function Gk(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
`)}var Dl=class{constructor(e){Je(this,"options");Je(this,"rules");Je(this,"lexer");this.options=e||zn}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const s=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?s:Va(s,`
...
`,e=e.substring(f.length+1),o=!0),!o){const w=this.rules.other.nextBulletRegex(m),b=this.rules.other.hrRegex(m),v=this.rules.other.fencesBeginRegex(m),x=this.rules.other.headingBeginRegex(m),S=this.rules.other.htmlBeginRegex(m);for(;e;){const N=e.split(`
`,1)[0];let O;if(f=N,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),O=f):O=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||S.test(f)||w.test(f)||b.test(f))break;if(O.search(this.rules.other.nonSpaceChar)>=m||!f.trim())u+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Ts(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Un=new Wk;function ze(e,t){return Un.parse(e,t)}ze.options=ze.setOptions=function(e){return Un.setOptions(e),ze.defaults=Un.defaults,ag(ze.defaults),ze};ze.getDefaults=Ac;ze.defaults=zn;ze.use=function(...e){return Un.use(...e),ze.defaults=Un.defaults,ag(ze.defaults),ze};ze.walkTokens=function(e,t){return Un.walkTokens(e,t)};ze.parseInline=Un.parseInline;ze.Parser=Ks;ze.parser=Ks.parse;ze.Renderer=Ml;ze.TextRenderer=Pc;ze.Lexer=zs;ze.lexer=zs.lex;ze.Tokenizer=Dl;ze.Hooks=il;ze.parse=ze;ze.options;ze.setOptions;ze.use;ze.walkTokens;ze.parseInline;Ks.parse;zs.lex;const Zk={breaks:!0,gfm:!0};function Vd(e){if(!e)return"";try{if(typeof ze<"u"&&ze.parse){const t=ze.parse(e,Zk);return typeof Pd<"u"?Pd.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Jk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Yk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Qk(e){return Yk[e]||"wrench"}const Xk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function jd(e){if(!e)return[];const t=e.match(Xk);return t?[...new Set(t)]:[]}const ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=te(()=>t.value.trim().length>0&&!s.value),d=te(()=>{const C=Ge.state;return C==="connected"?"Connected":C==="reconnecting"?"Reconnecting…":C==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=te(()=>{const C=Math.floor(i.value/4)%f.length,$=i.value;return $>3?`${f[C]} (${$}s)`:f[0]});function m(){Tt(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const C=a.value;C.style.height="auto",C.style.height=Math.min(C.scrollHeight,120)+"px"}function k(C,$,W={}){const G={id:++o,role:C,content:$,timestamp:Date.now(),html:C==="bot"?Vd($):"",tools_used:W.tools_used||[],is_error:W.is_error||!1,images:C==="bot"?jd($):[],files:W.files||[],_showTools:!1};return e.value.push(G),m(),C==="bot"&&Tt(()=>w()),G}function w(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach($=>{$.setAttribute("data-copy","true"),$.style.position="relative";const W=document.createElement("button");W.className="chat-code-copy",W.textContent="Copy",W.addEventListener("click",()=>{const G=$.querySelector("code"),D=G?G.textContent:$.textContent;navigator.clipboard.writeText(D).then(()=>{W.textContent="Copied!",setTimeout(()=>{W.textContent="Copy"},1500)}).catch(()=>{})}),$.appendChild(W)})}function b(C){if(C===0)return!0;const $=e.value[C-1],W=e.value[C],G=new Date($.timestamp).toDateString(),D=new Date(W.timestamp).toDateString();return G!==D}function v(C){const $=new Date(C),W=new Date;if($.toDateString()===W.toDateString())return"Today";const G=new Date(W);return G.setDate(G.getDate()-1),$.toDateString()===G.toDateString()?"Yesterday":$.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(C){t.value=C,Tt(()=>B())}function S(C){window.open(C,"_blank","noopener")}function N(C){C.target.style.display="none"}function O(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function T(){r&&(clearInterval(r),r=null),i.value=0}function R(C){s.value&&(s.value=!1,T(),C.type==="chat_response"?k("bot",C.content,{tools_used:C.tools_used||[],is_error:C.is_error||!1,files:C.files||[]}):C.type==="chat_error"&&k("bot",C.error||"Unknown error",{is_error:!0}),Tt(()=>{var $;return($=a.value)==null?void 0:$.focus()}))}async function L(C){try{const $=await q.post("/api/chat",{content:C,channel_id:l.value});k("bot",$.response,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]})}catch($){k("bot",$.message||"Failed to send message",{is_error:!0})}}async function B(){const C=t.value.trim();if(!C||s.value)return;k("user",C),t.value="",s.value=!0,O(),a.value&&(a.value.style.height="auto"),Ge.connected&&Ge.sendChat(C,{channelId:l.value})||(await L(C),s.value=!1,T()),Tt(()=>{var W;return(W=a.value)==null?void 0:W.focus()})}async function P(){try{if(!l.value){const $=await q.get("/api/auth/session");l.value=$.channel_id||$.user_id||"web-user"}const C=await q.get("/api/sessions/"+encodeURIComponent(l.value));if(C&&C.messages&&C.messages.length>0){for(const $ of C.messages){const W=$.role==="user"?"user":"bot";let G=$.content||"";if(W==="user"){const I=G.match(/^\[.*?\]:\s*/);I&&(G=G.slice(I[0].length))}if(!G.trim())continue;const D={id:++o,role:W,content:G,timestamp:$.timestamp?$.timestamp*1e3:Date.now(),html:W==="bot"?Vd(G):"",tools_used:[],is_error:!1,images:W==="bot"?jd(G):[],files:[],_showTools:!1};e.value.push(D)}Tt(()=>{m(),w()})}}catch{}}return Ue(()=>{Ge.subscribe("chat",R),P(),Tt(()=>{var C;return(C=a.value)==null?void 0:C.focus()})}),ft(()=>{Ge.unsubscribe("chat",R),T()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:B,autoResize:g,formatTime:Jk,formatDate:v,showDateSeparator:b,useSuggestion:x,openImage:S,onImageError:N,getToolIcon:Qk}}},ur={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=A_(),s=Yh(),n=te({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=te(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=te(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});fs(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var u;return(u=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:u.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},tw={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(c){var f,p,m;const u=c.payload||c,d=u.type||c.type;if(d==="tool_start"){const g={id:`${u.action}-${Date.now()}`,tool:u.action,actor:u.actor||"",channel:u.channel_id||"",iteration:((f=u.metadata)==null?void 0:f.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(g);return}if(d==="tool_end"){const g=e.value.findIndex(k=>k.tool===u.action&&k.status==="running");if(g>=0){const k=e.value[g];k.status=(p=u.metadata)!=null&&p.error?"error":"success",k.elapsed=((m=u.metadata)==null?void 0:m.elapsed_ms)||Date.now()-k.startTime,k.result=u.detail||"",k.fadingOut=!0,setTimeout(()=>{const w=e.value.indexOf(k);w>=0&&e.value.splice(w,1),t.value.unshift(k),t.value.length>n&&t.value.pop()},5e3)}return}if(d==="tool_stream"){const g=u.tool_name||"unknown";if(u.finished)delete s.value[g];else{const w=((s.value[g]||"")+(u.chunk||"")).split(`
`);s.value[g]=w.slice(-30).join(`
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}Ue(()=>{Ge.on("events",a),i=setInterval(l,500)}),ft(()=>{Ge.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=null;const r=te(()=>e.value.filter(w=>w.status==="running").length),o=te(()=>e.value.filter(w=>w.status==="completed").length),c=te(()=>e.value.filter(w=>["failed","timeout","killed"].includes(w.status)).length),u=te(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),d=te(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(w=>["failed","timeout","killed"].includes(w.status)):e.value.filter(w=>w.status===i.value));function f(w){return Math.min(100,Math.round(w.iteration_count/30*100))}async function p(w=!1){w=w===!0,w||(t.value=!0);try{const b=await q.get("/api/agents");e.value=Array.isArray(b)?b:[],s.value=null}catch(b){w||(s.value=b.message)}w||(t.value=!1)}async function m(w){const b=e.value.find(x=>x.id===w);if(await as({title:"Kill agent",message:`Kill agent "${(b==null?void 0:b.label)||w}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=w;try{await q.del(`/api/agents/${encodeURIComponent(w)}`),ke.success("Agent killed"),await p()}catch(x){ke.error(x.message||"Failed to kill agent")}n.value=null}}function g(){k(),a.value&&(l=setInterval(()=>{a.value&&p(!0)},5e3))}function k(){l&&(clearInterval(l),l=null)}return Ue(()=>{p(),g()}),ft(()=>{k()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:u,filteredAgents:d,formatTs:Ia,formatDuration:Ca,progressPercent:f,fetchAgents:p,killAgent:m,startAutoRefresh:g,stopAutoRefresh:k}}},nw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=te(()=>e.value.reduce((N,O)=>N+(O.iteration_count||0),0)),d=te(()=>e.value.filter(N=>N.status==="running").length);function f(N){return N==="running"?"loop-status-running":N==="error"?"loop-status-error":"loop-status-stopped"}function p(N){return N==="running"?"badge-success":N==="error"?"badge-danger":N==="completed"?"badge-info":"badge-warning"}function m(N){return N==="act"?"badge-warning":N==="silent"?"badge-info":"badge-success"}function g(N){c.value={...c.value,[N]:!c.value[N]}}async function k(N=!1){N=N===!0,N||(t.value=!0);try{e.value=await q.get("/api/loops"),s.value=null}catch(O){N||(s.value=O.message)}N||(t.value=!1)}async function w(){l.value=null;const N=a.value;if(!N.goal.trim()){l.value="Goal is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}const O={goal:N.goal.trim(),channel_id:N.channel_id.trim(),interval_seconds:N.interval_seconds||60,mode:N.mode,max_iterations:N.max_iterations||50};N.stop_condition.trim()&&(O.stop_condition=N.stop_condition.trim()),i.value=!0;try{const T=await q.post("/api/loops",O);ke.success(`Loop started: ${T.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await k()}catch(T){l.value=T.message}i.value=!1}async function b(N){if(await as({title:"Stop loop",message:`Stop loop ${N}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=N;try{await q.del(`/api/loops/${encodeURIComponent(N)}`),ke.success("Loop stopped"),await k()}catch(T){ke.error(T.message||"Failed to stop loop")}r.value=null}}async function v(N){o.value=N;try{await q.post(`/api/loops/${encodeURIComponent(N)}/restart`),ke.success("Loop restarted"),await k()}catch(O){ke.error(O.message||"Failed to restart loop")}o.value=null}function x(N){N.payload&&(N.payload.loop_id||N.payload.type==="loop")&&k(!0)}let S=null;return Ue(()=>{k(),Ge.subscribe("events",x),S=setInterval(()=>{k(!0)},5e3)}),ft(()=>{Ge.unsubscribe("events",x),S&&clearInterval(S)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:Ca,formatAge:Qh,toggleHistory:g,fetchLoops:k,doCreate:w,doStop:b,doRestart:v}}},aw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),m=h(null),g=h([]),k=h(!1),w=te(()=>e.value.filter(D=>D.cron&&!D.one_time).length),b=te(()=>e.value.filter(D=>D.one_time).length),v=te(()=>e.value.filter(D=>D.trigger).length),x=te(()=>e.value.filter(D=>D.paused).length),S=te(()=>e.value.filter(D=>D.consecutive_failures>0).length);function N(D){if(!D)return"-";const I=Date.now(),de=(new Date(D).getTime()-I)/1e3;if(de<0)return"overdue";if(de<60)return"in < 1 min";if(de<3600)return`in ${Math.floor(de/60)} min`;if(de<86400){const Z=Math.floor(de/3600),he=Math.floor(de%3600/60);return he>0?`in ${Z}h ${he}m`:`in ${Z}h`}const re=Math.floor(de/86400);return`in ${re} day${re!==1?"s":""}`}function O(D){return D==null?"-":D<1e3?`${D}ms`:D<6e4?`${(D/1e3).toFixed(1)}s`:Ca(D/1e3)}function T(){r.value=null}async function R(){const D=a.value.cron.trim();if(D){o.value=!0;try{r.value=await q.post("/api/schedules/validate-cron",{expression:D})}catch(I){r.value={valid:!1,error:I.message}}o.value=!1}}async function L(){t.value=!0,s.value=null;try{e.value=await q.get("/api/schedules")}catch(D){s.value=D.message}t.value=!1}async function B(D){if(m.value===D){m.value=null,g.value=[];return}m.value=D,k.value=!0,g.value=[];try{g.value=await q.get(`/api/schedules/${encodeURIComponent(D)}/history?limit=10`)}catch{g.value=[]}k.value=!1}async function P(){l.value=null;const D=a.value;if(!D.description.trim()){l.value="Description is required";return}if(!D.channel_id.trim()){l.value="Channel ID is required";return}if(!D.cron.trim()&&!D.run_at.trim()){l.value="Cron expression or run_at time is required";return}const I={description:D.description.trim(),action:D.action,channel_id:D.channel_id.trim()};if(D.cron.trim()&&(I.cron=D.cron.trim()),D.run_at.trim()&&(I.run_at=D.run_at.trim()),D.action==="reminder"&&D.message.trim()&&(I.message=D.message.trim()),D.action==="check"&&(D.tool_name.trim()&&(I.tool_name=D.tool_name.trim()),D.tool_input_str.trim()))try{I.tool_input=JSON.parse(D.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await q.post("/api/schedules",I),ke.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await L()}catch(K){l.value=K.message}i.value=!1}async function C(D){u.value=D;try{const I=await q.post(`/api/schedules/${encodeURIComponent(D)}/run`);if(I.status==="failure")ke.error(`Execution failed: ${I.error||"unknown error"}`);else{const K=I.warning?`Executed (${I.warning})`:"Executed successfully";ke.success(K)}await L()}catch(I){ke.error(I.message||"Failed to trigger")}u.value=null}async function $(D){f.value=D.id;const I=!D.paused;try{await q.put(`/api/schedules/${encodeURIComponent(D.id)}`,{paused:I}),ke.success(I?"Schedule paused":"Schedule resumed"),await L()}catch(K){ke.error(K.message||"Failed to update schedule")}f.value=null}async function W(D){p.value=D;try{await q.post(`/api/schedules/${encodeURIComponent(D)}/reset-failures`),ke.success("Failure counters reset"),await L()}catch(I){ke.error(I.message||"Failed to reset")}p.value=null}async function G(D){const I=e.value.find(de=>de.id===D);if(await as({title:"Delete schedule",message:`Delete "${(I==null?void 0:I.description)||D}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=D;try{await q.del(`/api/schedules/${encodeURIComponent(D)}`),ke.success("Schedule deleted"),await L()}catch(de){ke.error(de.message||"Failed to delete schedule")}d.value=null}}return Ue(()=>{L()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:m,history:g,historyLoading:k,cronCount:w,oneTimeCount:b,webhookCount:v,pausedCount:x,failingCount:S,formatTs:Ia,formatAge:Qh,formatFuture:N,formatMs:O,formatDuration:Ca,onCronInput:T,validateCron:R,toggleExpand:B,fetchSchedules:L,doCreate:P,doRunNow:C,doTogglePause:$,doResetFailures:W,doDelete:G}}},lw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=zd,g=ow,k=h([]),w=h(!1),b=h(""),v=h("flat"),x=h(new Set),S=h(""),N=h(""),O=h(""),T=h(null),R=h(!1);function L(){try{const U=localStorage.getItem("odin-session-presets");U&&(k.value=JSON.parse(U))}catch{}}function B(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const P=te(()=>d.value.trim()!==""||u.value!=="all"),C=te(()=>{let U=[...e.value];const ce=zd.find(Be=>Be.id===u.value),xe=ce?ce.filters:{};if(xe.source&&(U=U.filter(Be=>Be.source===xe.source)),xe.minMessages&&(U=U.filter(Be=>Be.message_count>=xe.minMessages)),xe.hasCompaction&&(U=U.filter(Be=>Be.has_summary)),xe.maxAge!=null){const Be=Date.now()/1e3;U=U.filter(bt=>bt.last_active&&Be-bt.last_active<=xe.maxAge)}if(d.value.trim()){const Be=d.value.toLowerCase().trim();U=U.filter(bt=>(bt.channel_id||"").toLowerCase().includes(Be)||(bt.last_user_id||"").toLowerCase().includes(Be)||(bt.source||"").toLowerCase().includes(Be))}const j=f.value,ye=p.value?1:-1;return U.sort((Be,bt)=>{const st=Be[j]||0,Ye=bt[j]||0;return(st-Ye)*ye}),U}),$=te(()=>{if(!a.value||!a.value.messages)return[];const U=a.value.messages;if(U.length===0)return[];const ce=[];let xe=[];for(const j of U)j.role==="user"&&xe.length>0&&(ce.push(xe),xe=[]),xe.push(j);return xe.length>0&&ce.push(xe),ce}),W=te(()=>C.value.length>0&&o.value.size===C.value.length);function G(U){const ce=U.find(xe=>xe.role==="user");if(ce&&ce.content){const xe=ce.content.slice(0,120);return xe.length<ce.content.length?xe+"...":xe}return"(no user message)"}function D(U){const ce=new Set(x.value);ce.has(U)?ce.delete(U):ce.add(U),x.value=ce}function I(U){u.value=U}function K(U){u.value=U.id,U.filters.searchQuery!=null&&(d.value=U.filters.searchQuery),U.filters.sortBy&&(f.value=U.filters.sortBy)}function de(){if(!b.value.trim())return;const U={id:"custom-"+Date.now(),name:b.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,U],B(),w.value=!1,b.value=""}function re(U){k.value=k.value.filter(ce=>ce.id!==U),B(),u.value===U&&(u.value="all")}function Z(){u.value="all",d.value="",f.value="last_active",p.value=!1}function he(U){if(!U)return"—";const ce=Date.now()/1e3-U;if(ce<60)return"just now";if(ce<3600){const j=Math.floor(ce/60);return`${j} minute${j!==1?"s":""} ago`}if(ce<86400){const j=Math.floor(ce/3600);return`${j} hour${j!==1?"s":""} ago`}const xe=Math.floor(ce/86400);return`${xe} day${xe!==1?"s":""} ago`}function X(U){if(!U)return"";try{return new Date(U*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function oe(U){if(!U)return"";try{return new Date(U*1e3).toLocaleString()}catch{return""}}function Ne(U){return U==="user"?"bg-gray-900/50 border border-gray-800":U==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function V(U){return U==="user"?"sess-msg-user":U==="assistant"?"sess-msg-assistant":"sess-msg-system"}function ue(U){return U==="user"?"badge-info":U==="assistant"?"badge-success":"badge-warning"}function le(U){return U==="user"?"sess-dot-user":U==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ve(U){return U==="user"?"text-cyan-400":U==="assistant"?"text-indigo-400":"text-gray-500"}function be(U){return U?U.length>2e3?U.slice(0,2e3)+`
... (truncated)`:U:""}async function Me(){const U=S.value.trim();if(U){R.value=!0;try{let ce=`/api/sessions/search?q=${encodeURIComponent(U)}&limit=50`;N.value.trim()&&(ce+=`&channel_id=${encodeURIComponent(N.value.trim())}`),O.value.trim()&&(ce+=`&user_id=${encodeURIComponent(O.value.trim())}`);const xe=await q.get(ce);T.value=xe.results||[]}catch{T.value=[]}R.value=!1}}function y(){S.value="",N.value="",O.value="",T.value=null}function E(U){return U?U.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(U){return U==="user"?"fts-result-user":U==="assistant"?"fts-result-assistant":U==="summary"?"fts-result-summary":U==="fts"?"fts-result-fts":U==="channel"?"fts-result-channel":"fts-result-default"}function J(U){return U==="user"?"badge-info":U==="assistant"?"badge-success":U==="summary"?"badge-warning":U==="fts"?"badge-success":"badge-info"}async function A(){t.value=!0,s.value=null;try{e.value=await q.get("/api/sessions")}catch(U){s.value=U.message}t.value=!1}function F(){s.value=null,A()}async function Y(U){if(n.value===U){n.value=null,a.value=null,x.value=new Set;return}n.value=U,a.value=null,i.value=!0,x.value=new Set;try{a.value=await q.get(`/api/sessions/${encodeURIComponent(U)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Q(U){const ce=new Set(o.value);ce.has(U)?ce.delete(U):ce.add(U),o.value=ce}function se(){W.value?o.value=new Set:o.value=new Set(C.value.map(U=>U.channel_id))}function ee(U){l.value=U}async function ge(){if(l.value){r.value=!0;try{await q.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await A()}catch(U){s.value=U.message||"Failed to clear session"}r.value=!1,l.value=null}}function ie(){c.value=!0}async function fe(){if(o.value.size!==0){r.value=!0;try{await q.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await A()}catch(U){s.value=U.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function _e(U,ce){const xe=q._token;let j=`/api/sessions/${encodeURIComponent(U)}/export?format=${ce}`;xe&&(j+=`&token=${encodeURIComponent(xe)}`);const ye=document.createElement("a");ye.href=j,ye.download=`session-${U}.${ce==="text"?"txt":"json"}`,document.body.appendChild(ye),ye.click(),document.body.removeChild(ye)}let Te=null;function Re(U){U.payload&&U.payload.channel_id&&(clearTimeout(Te),Te=setTimeout(()=>{A(),n.value&&U.payload.channel_id===n.value&&q.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(ce=>{a.value=ce}).catch(()=>{})},2e3))}return Ue(()=>{L(),A(),Ge.subscribe("events",Re)}),ft(()=>{Ge.unsubscribe("events",Re),clearTimeout(Te)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:W,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:C,hasActiveFilters:P,customPresets:k,showSavePreset:w,newPresetName:b,threadView:v,threads:$,collapsedThreads:x,ftsQuery:S,ftsChannelId:N,ftsUserId:O,ftsResults:T,ftsSearching:R,formatAge:he,formatTimestamp:X,formatFullTimestamp:oe,messageClass:Ne,threadMsgClass:V,roleBadge:ue,roleDotClass:le,roleLabelClass:ve,truncateContent:be,threadSummary:G,fetchSessions:A,retry:F,toggleSession:Y,toggleSelect:Q,toggleSelectAll:se,confirmClear:ee,clearSession:ge,confirmBulkClear:ie,doBulkClear:fe,exportSession:_e,applyPreset:I,applyCustomPreset:K,saveCustomPreset:de,removeCustomPreset:re,resetFilters:Z,toggleThread:D,runFtsSearch:Me,clearFtsSearch:y,highlightSnippet:E,ftsResultClass:M,ftsTypeBadge:J}}},uw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:M_}}},dw={components:{ContextAssemblyPanel:uw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(O){if(!O)return"—";try{const T=new Date(O);return isNaN(T.getTime())?O:T.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return O}}function f(O){return!O&&O!==0?"—":O<1e3?O+"ms":(O/1e3).toFixed(1)+"s"}function p(O){return!O&&O!==0?"—":O>=1e3?(O/1e3).toFixed(1)+"k":String(O)}function m(O){if(!O)return"";if(typeof O=="string")return O;try{return JSON.stringify(O,null,2)}catch{return String(O)}}function g(O){a.value===O?a.value=null:(a.value=O,c.value={})}function k(O,T){const R=O+"-"+T;c.value={...c.value,[R]:!c.value[R]}}function w(O,T){return!!c.value[O+"-"+T]}function b(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,S()}async function v(){try{const O=await q.get("/api/trajectories");e.value=O.files||[],o.value=O.count||0}catch{}}let x=0;async function S(){const O=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const T=await q.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(O!==x)return;let R=T.entries||[];u.value.tool_name&&(R=R.filter(L=>(L.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(R=R.filter(L=>L.is_error)),u.value.channel_id&&(R=R.filter(L=>L.channel_id===u.value.channel_id)),u.value.user_id&&(R=R.filter(L=>L.user_id===u.value.user_id)),t.value=R}else{const T=new URLSearchParams;u.value.channel_id&&T.set("channel_id",u.value.channel_id),u.value.user_id&&T.set("user_id",u.value.user_id),u.value.tool_name&&T.set("tool_name",u.value.tool_name),u.value.errors_only&&T.set("errors_only","true"),T.set("limit",String(u.value.limit));const R=T.toString(),L=await q.get(`/api/trajectories/search/query?${R}`);if(O!==x)return;t.value=L.results||[]}}catch(T){if(O!==x)return;n.value=T.message}O===x&&(s.value=!1)}async function N(){if(!l.value.trim())return;const O=++x;s.value=!0,n.value=null,c.value={};try{const T=await q.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(O!==x)return;i.value=T.entry||null,i.value||(n.value="No trace found for this message ID")}catch(T){if(O!==x)return;T.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=T.message}O===x&&(s.value=!1)}return Ue(async()=>{await v(),await S()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:m,truncateBlock:Xh,toggleExpand:g,toggleIteration:k,isIterationExpanded:w,clearFilters:b,fetchFiles:v,fetchTraces:S,lookupMessage:N}}},fw={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),n=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),a=h("user");let i=null;const l=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],r=te(()=>[...s.value.recent||[]].reverse()),o=async()=>{try{const u=await q.get("/api/usage");s.value=u,n.value=u.totals||n.value,t.value=null}catch(u){t.value=u.message}finally{e.value=!1}},c=()=>{e.value=!0,o()};return Ue(()=>{o(),i=setInterval(o,15e3)}),ft(()=>{i&&clearInterval(i)}),{loading:e,error:t,data:s,totals:n,activeTab:a,tabs:l,recentReversed:r,fmtNum:eg,formatTime:Cc,retry:c}}},pw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"audit",label:"Audit",component:rw},{id:"sessions",label:"Sessions",component:cw},{id:"traces",label:"Traces",component:dw},{id:"usage",label:"Usage",component:fw}]}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},$r=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],hw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),r=h(null),o=te(()=>e.value.filter(b=>b.is_core).length),c=te(()=>e.value.filter(b=>!b.is_core).length),u=te(()=>Object.values(a.value).reduce((b,v)=>b+v,0));function d(b){for(const v of $r)if(v.id!=="other"&&v.match(b))return v.id;return"other"}const f=te(()=>{let b=e.value;if(n.value){const v=n.value.toLowerCase();b=b.filter(x=>x.name.toLowerCase().includes(v)||(x.description||"").toLowerCase().includes(v))}return r.value&&(b=b.filter(v=>d(v.name)===r.value)),b}),p=te(()=>{const b=new Set;for(const v of e.value)b.add(d(v.name));return $r.filter(v=>b.has(v.id))}),m=te(()=>{const b=f.value,v={};for(const S of b){const N=d(S.name);v[N]||(v[N]=[]),v[N].push(S)}const x=[];for(const S of $r)v[S.id]&&v[S.id].length>0&&x.push({label:S.label,icon:S.icon,tools:v[S.id].sort((N,O)=>N.name.localeCompare(O.name))});return x});function g(b){i.value={...i.value,[b]:!i.value[b]}}async function k(){t.value=!0,s.value=null;try{const[b,v]=await Promise.all([q.get("/api/tools"),q.get("/api/tools/stats").catch(()=>({}))]);e.value=b,a.value=v||{};const x=Object.values(v||{}).filter(S=>S>0).sort((S,N)=>S-N)}catch(b){s.value=b.message}t.value=!1}function w(){k()}return Ue(()=>{k()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,coreCount:o,skillCount:c,totalUsage:u,filteredTools:f,groupedTools:m,usedCategories:p,truncate:Ec,toggleExpand:g,refresh:w}}};function gw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function mw(e){if(!e)return"1";const t=e.split(`
...
`)}const vw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),k=h(null),w=h(!1),b=te(()=>e.value.length),v=te(()=>e.value.reduce((X,oe)=>X+(oe.execution_count||0),0)),x=te(()=>e.value.reduce((X,oe)=>X+L(oe.code),0)),S=te(()=>{if(!l.value)return e.value;const X=l.value.toLowerCase();return e.value.filter(oe=>oe.name.toLowerCase().includes(X)||(oe.description||"").toLowerCase().includes(X))}),N=te(()=>d.value?d.value.split(`
`).length:0),O=te(()=>{const X=Math.max(N.value,1);return Array.from({length:X},(oe,Ne)=>Ne+1).join(`
`)}),T=te(()=>{const X=d.value.trim();return X?X.includes("SKILL_DEFINITION")?X.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function R(X){return gw(X)}function L(X){return X?X.split(`
`).length:0}function B(X){return mw(X)}function P(X){n.value={...n.value,[X]:!n.value[X]}}async function C(X){try{await navigator.clipboard.writeText(X);const oe=e.value.find(Ne=>Ne.code===X);oe&&(r.value=oe.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function $(X){if(X.key==="Tab"){X.preventDefault();const oe=X.target,Ne=oe.selectionStart,V=oe.selectionEnd;d.value=d.value.substring(0,Ne)+"    "+d.value.substring(V),Tt(()=>{oe.selectionStart=oe.selectionEnd=Ne+4})}}function W(X){const oe=X.target.previousElementSibling;oe&&(oe.scrollTop=X.target.scrollTop)}async function G(){t.value=!0,s.value=null;try{e.value=await q.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function D(X){i.value=X,delete a.value[X],a.value={...a.value};try{const oe=await q.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:oe}}catch(oe){a.value={...a.value,[X]:{result:oe.message,is_error:!0}}}i.value=null}function I(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function K(X){o.value=!0,c.value="edit",u.value=X.name,d.value=X.code||"",f.value=null,p.value=null}function de(){o.value=!1,f.value=null,p.value=null}async function re(){f.value=null,p.value=null;const X=u.value.trim(),oe=d.value.trim();if(!X){f.value="Name is required";return}if(!oe){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await q.post("/api/skills",{name:X,code:oe}),p.value="Skill created successfully"):(await q.put(`/api/skills/${encodeURIComponent(X)}`,{code:oe}),p.value="Skill updated successfully"),await G(),setTimeout(()=>{o.value=!1},800)}catch(Ne){f.value=Ne.message}m.value=!1}function Z(X){k.value=X}async function he(){if(k.value){w.value=!0;try{await q.del(`/api/skills/${encodeURIComponent(k.value)}`),await G()}catch{}w.value=!1,k.value=null}}return Ue(()=>{G()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:k,deleting:w,enabledCount:b,totalExecutions:v,totalLines:x,displayedSkills:S,editLineCount:N,editorLineNums:O,editValidation:T,highlight:R,truncate:Ec,formatTs:Ia,countLines:L,getLineNumbers:B,toggleCode:P,copyCode:C,handleEditorKey:$,syncScroll:W,fetchSkills:G,testSkill:D,showCreate:I,editSkill:K,cancelEdit:de,saveSkill:re,confirmDelete:Z,doDelete:he}}};function bw(e,t){if(!e||!t)return kd(e);const s=kd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let k=null;const w=h(null),b=h(!1),v=h({}),x=h({}),S=h(null),N=h(null),O=te(()=>e.value.reduce((I,K)=>I+(K.chunks||0),0)),T=te(()=>new Set(e.value.map(K=>K.uploader).filter(Boolean)).size);function R(I,K){const de=x.value[K];if(!de||de.length===0)return 0;const re=Math.max(...de.map(Z=>Z.char_count||0));return re===0?0:Math.round(I.char_count/re*100)}async function L(){t.value=!0,s.value=null;try{const I=await q.get("/api/knowledge");e.value=Array.isArray(I)?I:[]}catch(I){s.value=I.message}t.value=!1}async function B(I){if(v.value[I]){v.value[I]=!1,N.value=null;return}if(v.value[I]=!0,!(x.value[I]||S.value===I)){S.value=I;try{const K=await q.get(`/api/knowledge/${encodeURIComponent(I)}/chunks`);x.value[I]=Array.isArray(K)?K:[]}catch(K){x.value[I]=[],ke.error(`Failed to load chunks: ${K.message}`)}S.value=null}}async function P(){const I=n.value.trim();if(I){i.value=!0,r.value=null,l.value=I;try{const K=await q.get(`/api/knowledge/search?q=${encodeURIComponent(I)}`);a.value=Array.isArray(K)?K:[]}catch(K){a.value=[],r.value=K.message||"Search failed"}i.value=!1}}function C(){a.value=null,n.value="",r.value=null}async function $(){d.value=null,f.value=null;const I=c.value.trim(),K=u.value.trim();if(!I){d.value="Source name is required";return}if(!K){d.value="Content is required";return}p.value=!0;try{const de=await q.post("/api/knowledge",{source:I,content:K});f.value=`Ingested ${de.chunks||0} chunks from "${I}"`,c.value="",u.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(de){d.value=de.message}p.value=!1}async function W(I){m.value=I,g.value=null,k&&(clearTimeout(k),k=null);try{const K=await q.post(`/api/knowledge/${encodeURIComponent(I)}/reingest`);g.value={source:I,error:!1,message:`Re-ingested ${K.chunks||0} chunks`},delete x.value[I],await L(),k=setTimeout(()=>{g.value=null,k=null},3e3)}catch(K){g.value={source:I,error:!0,message:K.message}}m.value=null}function G(I){w.value=I}async function D(){if(w.value){b.value=!0;try{await q.del(`/api/knowledge/${encodeURIComponent(w.value)}`),delete x.value[w.value],await L()}catch{}b.value=!1,w.value=null}}return Ue(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:w,deleting:b,expanded:v,sourceChunks:x,loadingChunks:S,selectedChunk:N,totalChunks:O,uploaderCount:T,truncate:Ec,formatTs:Ia,highlightTerms:bw,chunkBarWidth:R,fetchSources:L,toggleSource:B,doSearch:P,clearSearch:C,doIngest:$,doReingest:W,confirmDelete:G,doDelete:D}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),k=h(null),w=h(new Set),b=h(null),v=h(!1),x=h(!1),S=te(()=>e.value.reduce((Z,he)=>Z+he.count,0)),N=te(()=>w.value.size);function O(Z){const he=t.value[Z];if(!he)return[];if(!l.value.trim())return he;const X=l.value.trim().toLowerCase();return he.filter(oe=>oe.key.toLowerCase().includes(X)||oe.value&&oe.value.toLowerCase().includes(X))}function T(Z,he){return w.value.has(Z+"/"+he)}function R(Z,he){const X=Z+"/"+he,oe=new Set(w.value);oe.has(X)?oe.delete(X):oe.add(X),w.value=oe}function L(Z){const he=t.value[Z];return!he||he.length===0?!1:he.every(X=>w.value.has(Z+"/"+X.key))}function B(Z,he){const X=t.value[Z];if(!X)return;const oe=new Set(w.value);for(const Ne of X){const V=Z+"/"+Ne.key;he?oe.add(V):oe.delete(V)}w.value=oe}async function P(){s.value=!0,n.value=null;try{const Z=await q.get("/api/memory");e.value=Object.entries(Z).map(([he,X])=>({name:he,keys:X.keys||[],count:X.count||0}))}catch(Z){n.value=Z.message}s.value=!1}async function C(Z){if(a.value[Z]){a.value[Z]=!1;return}a.value[Z]=!0;const he=e.value.find(oe=>oe.name===Z);if(!he||t.value[Z]||i.value===Z)return;i.value=Z;const X=await Promise.all(he.keys.map(async oe=>{try{const Ne=await q.get(`/api/memory/${encodeURIComponent(Z)}/${encodeURIComponent(oe)}`);return{key:oe,value:Ne.value||""}}catch{return{key:oe,value:"(error loading)"}}}));t.value[Z]=X,i.value=null}function $(Z,he,X){f.value=Z+"/"+he,p.value=X}async function W(Z,he){m.value=!0,g.value=null;try{await q.put(`/api/memory/${encodeURIComponent(Z)}/${encodeURIComponent(he)}`,{value:p.value});const X=t.value[Z];if(X){const oe=X.find(Ne=>Ne.key===he);oe&&(oe.value=p.value)}f.value=null}catch(X){g.value=`Failed to save: ${X.message||"unknown error"}`}m.value=!1}async function G(Z,he){try{await navigator.clipboard.writeText(he.value),k.value=Z+"/"+he.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function D(){u.value=null,d.value=null;const Z=o.value.scope.trim(),he=o.value.key.trim(),X=o.value.value.trim();if(!Z){u.value="Scope is required";return}if(!he){u.value="Key is required";return}if(!X){u.value="Value is required";return}c.value=!0;try{await q.put(`/api/memory/${encodeURIComponent(Z)}/${encodeURIComponent(he)}`,{value:X}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(oe){u.value=oe.message}c.value=!1}function I(Z,he){b.value={scope:Z,key:he}}async function K(){if(!b.value)return;v.value=!0,g.value=null;const{scope:Z,key:he}=b.value;try{await q.del(`/api/memory/${encodeURIComponent(Z)}/${encodeURIComponent(he)}`);const X=t.value[Z];X&&(t.value[Z]=X.filter(V=>V.key!==he));const oe=e.value.find(V=>V.name===Z);oe&&(oe.count--,oe.keys=oe.keys.filter(V=>V!==he));const Ne=new Set(w.value);Ne.delete(Z+"/"+he),w.value=Ne}catch(X){g.value=`Failed to delete: ${X.message||"unknown error"}`}v.value=!1,b.value=null}function de(){x.value=!0}async function re(){v.value=!0,g.value=null;const Z=[];for(const he of w.value){const X=he.indexOf("/");Z.push({scope:he.slice(0,X),key:he.slice(X+1)})}try{await q.post("/api/memory/bulk-delete",{entries:Z}),w.value=new Set,t.value={},await P()}catch(he){g.value=`Bulk delete failed: ${he.message||"unknown error"}`}v.value=!1,x.value=!1}return Ue(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:k,selected:w,selectedCount:N,totalEntries:S,deleteTarget:b,deleting:v,showBulkDelete:x,fetchMemory:P,toggleScope:C,startEdit:$,doEdit:W,copyValue:G,doAdd:D,confirmDelete:I,doDelete:K,confirmBulkDelete:de,doBulkDelete:re,isSelected:T,toggleSelect:R,isScopeAllSelected:L,toggleSelectAll:B,filteredEntries:O}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=te(()=>[...new Set(e.value.map(k=>k.category))].sort()),o=te(()=>{const g={};return e.value.forEach(k=>{g[k.category]=(g[k.category]||0)+1}),g}),c=te(()=>a.value?e.value.filter(g=>g.category===a.value):e.value);function u(g){return g==="correction"?"badge-warning":g==="operational"?"badge-info":g==="preference"?"badge-success":"badge-info"}function d(g){i.value=g.key,l.value=g.content}async function f(g){try{await q.put("/api/learned/"+encodeURIComponent(g),{content:l.value}),i.value=null,ke.success("Entry updated"),await m()}catch(k){ke.error(k.message||"Failed to save entry")}}async function p(g){if(await as({title:"Delete learned entry",message:`Delete "${g}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/learned/"+encodeURIComponent(g)),ke.success("Entry deleted"),await m()}catch(w){ke.error(w.message||"Failed to delete entry")}}async function m(){s.value=!0,n.value=null;try{const g=await q.get("/api/learned");e.value=g.entries||[],t.value={last_reflection:g.last_reflection,count:g.count}}catch(g){n.value=g.message}s.value=!1}return Ue(m),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:u,formatTs:Ia,startEdit:d,saveEdit:f,deleteEntry:p,fetchEntries:m}}},kw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"tools",label:"Tools",component:hw},{id:"skills",label:"Skills",component:vw},{id:"knowledge",label:"Knowledge",component:yw},{id:"memory",label:"Memory",component:xw},{id:"learned",label:"Learned",component:_w}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},ww={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),u=h(!0),d=h(""),f=h(!1),p=h(!1),m=te(()=>e.value==="custom"),g=te(()=>[...i.value,...l.value]),k=te(()=>l.value.includes(e.value)),w=te(()=>{var T;return m.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),b=te(()=>{var T;return m.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),v=te(()=>{var T;return m.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function x(){u.value=!0;try{const T=await q.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{u.value=!1}}async function S(){r.value=!0,c.value=null,o.value=!1;try{await q.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(T){c.value=T.message}finally{r.value=!1}}async function N(){const T=d.value.trim();if(T){p.value=!0,c.value=null;try{await q.post("/api/personality/presets",{name:T,display_name:w.value,identity:b.value,voice:v.value}),f.value=!1,d.value="",await x(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(R){c.value=R.message}finally{p.value=!1}}}async function O(){if(await as({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await q.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(R){c.value=R.message}}}return Ue(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:g,isCustom:m,isUserPreset:k,previewName:w,previewIdentity:b,previewVoice:v,saving:r,saved:o,error:c,loading:u,save:S,showSavePreset:f,newPresetName:d,savingPreset:p,saveAsPreset:N,deletePreset:O,builtinPresets:i,userPresets:l}},template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=te(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=te(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await q.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return Ue(()=>{c(),i=setInterval(c,3e4)}),ft(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:eg,refresh:u,retry:d}}},Rw=["INFO","WARNING","ERROR"],Iw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Ur=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Nw=[50,100,200,500],Ow={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(Ge.state||"disconnected"),c=te(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,m=Rw,g=Iw,k=Ur,w=h("all"),b=h(""),v=h([]),x=h(!1),S=h(""),N=h([]);function O(){try{const H=localStorage.getItem("odin-log-presets");H&&(v.value=JSON.parse(H))}catch{}}function T(){try{localStorage.setItem("odin-log-presets",JSON.stringify(v.value))}catch{}}const R=te(()=>a.value!==""||i.value.trim()!==""||b.value!==""),L=te(()=>{const H=Ur.find(ne=>ne.value===b.value);return H?H.label:""}),B=te(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(H){return H.message}}),P=24,C=te(()=>{if(t.value.length===0)return[];const H=[],ne=new Date,Ce=3600*1e3;for(let Ke=P-1;Ke>=0;Ke--){const it=new Date(ne.getTime()-(Ke+1)*Ce),Gt=new Date(ne.getTime()-Ke*Ce);H.push({start:it,end:Gt,label:D(it,Gt),shortLabel:Gt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Ke of t.value){if(!Ke._time)continue;const it=Ke._time.getTime();for(const Gt of H)if(it>=Gt.start.getTime()&&it<Gt.end.getTime()){Gt.total++,Ke.level==="ERROR"?Gt.errors++:Ke.level==="WARNING"?Gt.warnings++:Gt.info++;break}}return H}),$=te(()=>{let H=1;for(const ne of C.value)ne.total>H&&(H=ne.total);return H}),W=te(()=>C.value.length===0?"":"Last 24 hours"),G=te(()=>Math.ceil(P/8));function D(H,ne){const Ce={hour:"2-digit",minute:"2-digit"};return H.toLocaleTimeString([],Ce)+" - "+ne.toLocaleTimeString([],Ce)}function I(H,ne){return!ne||!H?"0px":Math.max(2,H/ne*100)+"%"}function K(H){const ne=de.value.findIndex(Ce=>Ce._time&&Ce._time.getTime()>=H.start.getTime()&&Ce._time.getTime()<H.end.getTime());if(ne>=0&&u.value){const Ce=u.value.querySelectorAll(".log-line");Ce[ne]&&(Ce[ne].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const de=te(()=>{let H=t.value;if(a.value&&(H=H.filter(ne=>(ne.level||"INFO")===a.value)),b.value){const ne=Ur.find(Ce=>Ce.value===b.value);if(ne&&ne.seconds){const Ce=new Date(Date.now()-ne.seconds*1e3);H=H.filter(Ke=>Ke._time&&Ke._time>=Ce)}}if(i.value&&!B.value)if(l.value)try{const ne=new RegExp(i.value,"i");H=H.filter(Ce=>{const Ke=Ce.text||Ce.raw||"",it=Ce.tool||"";return ne.test(Ke)||ne.test(it)})}catch{}else{const ne=i.value.toLowerCase();H=H.filter(Ce=>{const Ke=(Ce.text||Ce.raw||"").toLowerCase(),it=(Ce.tool||"").toLowerCase();return Ke.includes(ne)||it.includes(ne)})}return H});function re(H){if(H.type==="log"&&H.line)try{const ne=typeof H.line=="string"?JSON.parse(H.line):H.line,Ce=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Ce.toLocaleTimeString(),_time:Ce,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(H.line),tool:"",raw:String(H.line)}}if(H.payload){const ne=H.payload,Ce=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Ce.toLocaleTimeString(),_time:Ce,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}return typeof H=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:H,tool:"",raw:H}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(H),tool:"",raw:null}}function Z(H){const ne=re(H);if(s.value){N.value.push(ne);return}he(ne)}function he(H){t.value.push(H),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&Tt(()=>X())}function X(){const H=u.value;if(H){const ne=H.scrollHeight-H.scrollTop-H.clientHeight;H.scrollTo({top:H.scrollHeight,behavior:ne<500?"smooth":"instant"})}}function oe(){n.value=!0,d.value=!1,Tt(()=>X())}function Ne(){const H=u.value;if(!H)return;const ne=H.scrollHeight-H.scrollTop-H.clientHeight<40;d.value=!ne&&t.value.length>0,!ne&&n.value&&(n.value=!1)}function V(){if(s.value=!s.value,!s.value&&N.value.length>0){for(const H of N.value)he(H);N.value=[]}}function ue(){t.value=[],N.value=[],d.value=!1}function le(){let H;e.value==="search"?H=ce.value.map(it=>{const Gt=it.error?"ERROR":"INFO",nt=it.tool_name?`[${it.tool_name}] `:"";return`${it.timestamp||""} ${Gt} ${nt}${it.result_summary||it.message||""}`}).join(`
`):H=de.value.map(it=>`${it.ts} ${it.level} ${it.text}`).join(`
`);const ne=new Blob([H],{type:"text/plain"}),Ce=URL.createObjectURL(ne),Ke=document.createElement("a");Ke.href=Ce,Ke.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ke.click(),URL.revokeObjectURL(Ce)}function ve(H,ne){const Ce=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(Ce).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function be(H){a.value=a.value===H?"":H,w.value="all"}function Me(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function E(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function M(H){w.value=H.id;const ne=H.filters;a.value=ne.level||"",b.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function J(H){w.value=H.id,a.value=H.filters.level||"",b.value=H.filters.timeRange||"",i.value=H.filters.text||""}function A(){if(!S.value.trim())return;const H={id:"custom-"+Date.now(),name:S.value.trim(),filters:{level:a.value,timeRange:b.value,text:i.value}};v.value=[...v.value,H],T(),x.value=!1,S.value=""}function F(H){v.value=v.value.filter(ne=>ne.id!==H),T(),w.value===H&&(w.value="all")}const Y=h("all"),Q=h(""),se=h(""),ee=h(""),ge=h(""),ie=h(""),fe=h(100),_e=Nw,Te=h(!1),Re=h(!1),U=h(""),ce=h([]),xe=h(null),j=h(null);function ye(){e.value="search",xe.value||Be()}async function Be(){try{xe.value=await q.get("/api/logs/stats")}catch{}}function bt(){const H=ie.value;if(!H){ee.value="",ge.value="";return}const Ce={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(Ce){const Ke=new Date(Date.now()-Ce*1e3);ee.value=st(Ke),ge.value=""}}function st(H){const ne=Ce=>String(Ce).padStart(2,"0");return`${H.getFullYear()}-${ne(H.getMonth()+1)}-${ne(H.getDate())}T${ne(H.getHours())}:${ne(H.getMinutes())}`}function Ye(H){if(!H)return"";const ne=new Date(H);return isNaN(ne.getTime())?"":ne.toISOString()}async function sn(){Te.value=!0,U.value="",Re.value=!0,j.value=null;try{const H=new URLSearchParams;Y.value&&Y.value!=="all"&&H.set("level",Y.value),Q.value&&H.set("tool",Q.value),se.value&&H.set("q",se.value);const ne=Ye(ee.value),Ce=Ye(ge.value);ne&&H.set("start",ne),Ce&&H.set("end",Ce),H.set("limit",String(fe.value));const Ke=await q.get(`/api/logs/search?${H.toString()}`);ce.value=Ke.entries||[]}catch(H){U.value=H.message||"Search failed",ce.value=[]}finally{Te.value=!1}}function xn(){Y.value="all",Q.value="",se.value="",ee.value="",ge.value="",ie.value="",fe.value=100,ce.value=[],Re.value=!1,U.value="",j.value=null}function Li(H){j.value=j.value===H?null:H}function Na(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function Di(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function Kn(H){return H.error?"log-line-error":"text-gray-300"}function qn(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let Ot=null,gs=null,nn=!1;function Oa(){nn||(nn=!0,Ge.subscribe("logs",Z),r.value=Ge.connected,o.value=Ge.state||"disconnected",Ot=Ge.onStateChange,gs=(H,ne)=>{o.value=H,r.value=H==="connected",Ot&&Ot(H,ne)},Ge.onStateChange=gs)}function Mi(){nn&&(nn=!1,Ge.unsubscribe("logs",Z),Ge.onStateChange===gs&&(Ge.onStateChange=Ot),gs=null,Ot=null)}return Ue(O),Uo(Oa),Bo(Mi),ft(Mi),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:de,pauseBuffer:N,showJumpBottom:d,copiedIndex:f,regexError:B,levels:m,logPresets:g,timeRanges:k,timeRange:b,activeLogPreset:w,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:S,hasActiveLogFilters:R,timeRangeLabel:L,timelineBuckets:C,timelineMax:$,timelineSpanLabel:W,timelineLabelSkip:G,togglePause:V,clearLogs:ue,exportLogs:le,logLineClass:Me,levelClass:y,levelChipClass:E,toggleLevel:be,copyLine:ve,jumpToBottom:oe,onScroll:Ne,applyLogPreset:M,applyCustomLogPreset:J,saveLogCustomPreset:A,removeLogCustomPreset:F,segmentHeight:I,jumpToTimelineBucket:K,searchLevel:Y,searchTool:Q,searchKeyword:se,searchStart:ee,searchEnd:ge,searchTimePreset:ie,searchLimit:fe,searchLimits:_e,searching:Te,searchRan:Re,searchError:U,searchResults:ce,searchStats:xe,expandedSearch:j,switchToSearch:ye,runSearch:sn,clearSearchFilters:xn,toggleSearchExpand:Li,formatSearchTs:Na,searchEntryText:Di,searchLogLineClass:Kn,formatJson:qn,applySearchTimePreset:bt}}},Lw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Br=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],gg="••••••••",Pw=50;function Fw(e){return Lw.has(e)}function $w(e){return e===gg}function Qi(e){return JSON.parse(JSON.stringify(e))}function Mn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Mn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Mn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Kd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Mn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Mn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=te(()=>d.value.length>0),m=te(()=>f.value.length>0),g=te(()=>r.value&&t.value?t.value:e.value),k=te(()=>!e.value||!t.value?!1:!Mn(e.value,t.value)),w=te(()=>!e.value||!t.value?0:Kd(e.value,t.value).length),b=te(()=>{if(!r.value||!t.value)return{};const A={};for(const F of Object.keys(t.value)){const Y=t.value[F];if(typeof Y=="object"&&Y!==null&&!Array.isArray(Y))for(const Q of Object.keys(Y)){const se=Bw(F,Q,Y[Q]);se&&(A[F+"."+Q]=se)}}return A}),v=te(()=>Object.keys(b.value).length>0),x=te(()=>e.value?Object.keys(e.value).length:0),S=te(()=>O.value.length),N=te(()=>!e.value||!t.value?[]:Kd(e.value,t.value)),O=te(()=>e.value?Br.map(A=>({...A,sections:A.sections.filter(F=>F in e.value)})).filter(A=>A.sections.length>0):[]),T=te(()=>{if(!e.value)return[];const A=new Set(Br.flatMap(F=>F.sections));return Object.keys(e.value).filter(F=>!A.has(F))});function R(A){return g.value?g.value[A]:null}function L(A){return!e.value||!t.value?!1:!Mn(e.value[A],t.value[A])}function B(A){return A.sections.some(F=>L(F))}function P(A,F){if(!e.value||!t.value)return!1;const Y=e.value[A],Q=t.value[A];return!Y||!Q?!1:!Mn(Y[F],Q[F])}function C(A){return t.value?t.value[A]:e.value[A]}function $(A,F){const Y=t.value||e.value;return Y[A]?Y[A][F]:void 0}function W(A,F){const Y=r.value&&t.value?t.value:e.value;return Y[A]?Y[A][F]:!1}function G(A,F){return b.value[A+"."+F]||null}function D(A,F){return Dw[A+"."+F]||null}function I(A,F,Y){t.value&&(F===null?t.value[A]=Y:(t.value[A]||(t.value[A]={}),t.value[A][F]=Y),t.value={...t.value})}function K(A,F,Y){if(!t.value)return;const Q=Qi(t.value);I(A,F,Y),d.value.push(Q),d.value.length>Pw&&d.value.shift(),f.value=[]}function de(A,F,Y){try{const Q=JSON.parse(Y);K(A,F,Q)}catch{}}function re(){d.value.length!==0&&(f.value.push(Qi(t.value)),t.value=d.value.pop())}function Z(){f.value.length!==0&&(d.value.push(Qi(t.value)),t.value=f.value.pop())}function he(A,F,Y){if(!t.value||!t.value[A])return;const Q=[...t.value[A][F]];Q.splice(Y,1),K(A,F,Q)}function X(A,F){if(!t.value||!t.value[A])return;const Y=[...t.value[A][F]||[]],Q=prompt("Enter new value:");Q!==null&&(Y.push(Q),K(A,F,Y))}function oe(A){a.value={...a.value,[A]:!a.value[A]}}function Ne(A){l.value={...l.value,[A]:!l.value[A]}}function V(A){i.value={...i.value,[A]:!i.value[A]}}function ue(A){try{return JSON.stringify(A,null,2)}catch{return String(A)}}function le(A){return A==null?"null":typeof A=="object"?JSON.stringify(A,null,2):String(A)}function ve(A,F){c.value={type:A,message:F},setTimeout(()=>{c.value=null},3e3)}function be(){t.value=Qi(e.value),r.value=!0,d.value=[],f.value=[]}function Me(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function E(){if(!(!k.value||v.value)){o.value=!0;try{const A=Uw(e.value,t.value);if(Object.keys(A).length===0){ve("success","No changes to save."),o.value=!1;return}const F=await q.put("/api/config",A);e.value=F,r.value=!1,t.value=null,d.value=[],f.value=[],ve("success","Config saved successfully.")}catch(A){ve("error",A.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await q.get("/api/config");for(const A of Object.keys(e.value))a.value[A]===void 0&&(a.value[A]=!0);for(const A of Br)l.value[A.key]===void 0&&(l.value[A.key]=!0)}catch(A){n.value=A.message}s.value=!1}function J(A){if(!r.value)return;const F=A.target;F instanceof HTMLElement&&(F.matches("input, textarea, select")||F.isContentEditable)||((A.ctrlKey||A.metaKey)&&!A.shiftKey&&A.key.toLowerCase()==="z"?(A.preventDefault(),re()):(A.ctrlKey||A.metaKey)&&(A.key==="y"||A.shiftKey&&A.key==="z"||A.shiftKey&&A.key==="Z")&&(A.preventDefault(),Z()))}return Ue(()=>{M(),document.addEventListener("keydown",J)}),ft(()=>{document.removeEventListener("keydown",J)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:v,changeCount:w,REDACTED:gg,showDiffModal:u,diffEntries:N,canUndo:p,canRedo:m,sectionCount:x,groupCount:S,visibleGroups:O,ungroupedSections:T,validationErrors:b,isSensitiveKey:Fw,isRedacted:$w,sectionChanged:L,groupChanged:B,fieldChanged:P,getDisplay:R,getEdited:C,getEditedField:$,getDisplayBool:W,pushEdit:K,pushEditJson:de,getValidationError:G,getEnumOptions:D,removeArrayItem:he,addArrayItem:X,toggleSection:oe,toggleGroup:Ne,toggleNested:V,formatJson:ue,formatDiffVal:le,showToast:ve,showDiff:y,fetchConfig:M,startEdit:be,cancelEdit:Me,saveConfig:E,undo:re,redo:Z}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=te(()=>{const I={};for(const K of u.value)I[K.id]=K;return I});function p(I){return f.value[I]||null}const m=te(()=>/^\d{15,25}$/.test(r.value.trim())),g=te(()=>{if(o.value){if(k.value[c.value])return"host-user-option-"+c.value;if(m.value)return"host-user-option-raw"}}),k=te(()=>{const I=r.value.toLowerCase().trim();return I?u.value.filter(K=>!i.value[K.id]&&(K.display_name.toLowerCase().includes(I)||K.username.toLowerCase().includes(I)||K.id.includes(I))):u.value.filter(K=>!i.value[K.id])});function w(I,K){return I?I.allowed_hosts===null||I.allowed_hosts===void 0?{allowed_hosts:[...K],default_host:I.default_host||"",allow_all:!0}:{allowed_hosts:I.allowed_hosts,default_host:I.default_host||"",allow_all:!1}:{allowed_hosts:[...K],default_host:K[0]||"",allow_all:!0}}async function b(){e.value=!0,t.value="";try{const I=await q.get("/api/host-access");s.value=I,n.value=I.available_hosts||[],a.value=w(I.default_policy,n.value);const K=I.users||{},de={};for(const[re,Z]of Object.entries(K))de[re]=w(Z,n.value);i.value=de}catch(I){t.value=I.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await q.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const I=a.value.allow_all?null:a.value.allowed_hosts;await q.put("/api/host-access/default-policy",{allowed_hosts:I,default_host:a.value.default_host}),ke.success("Default policy updated")}catch(I){ke.error(I.message||"Failed to save")}}function x(I,K){a.value.allow_all=!1,K?a.value.allowed_hosts.includes(I)||a.value.allowed_hosts.push(I):(a.value.allowed_hosts=a.value.allowed_hosts.filter(de=>de!==I),a.value.default_host===I&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function S(I){const K=i.value[I];if(K)try{const de=K.allow_all?null:K.allowed_hosts;await q.put(`/api/host-access/user/${I}`,{allowed_hosts:de,default_host:K.default_host});const re=p(I);ke.success(`Updated access for ${re?re.display_name:I}`)}catch(de){ke.error(de.message||"Failed to save")}}function N(I,K,de){const re=i.value[I];re&&(re.allow_all=!1,de?re.allowed_hosts.includes(K)||re.allowed_hosts.push(K):(re.allowed_hosts=re.allowed_hosts.filter(Z=>Z!==K),re.default_host===K&&(re.default_host=re.allowed_hosts[0]||"")),S(I))}function O(I,K){const de=i.value[I];de&&(de.default_host=K,S(I))}function T(){l.value=!0,r.value="",c.value=0,Tt(()=>{d.value&&d.value.focus()})}function R(){o.value=!0,c.value=0}function L(){c.value<k.value.length-1&&c.value++}function B(){c.value>0&&c.value--}function P(){const I=k.value[c.value];if(I){$(I);return}m.value&&C()}function C(){const I=r.value.trim();/^\d{15,25}$/.test(I)&&(i.value[I]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},S(I),r.value="",o.value=!1,l.value=!1)}function $(I){i.value[I.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},S(I.id),r.value="",o.value=!1,l.value=!1}function W(){o.value=!1}function G(){setTimeout(()=>{o.value=!1},150)}async function D(I){const K=p(I);if(await as({title:"Remove user override",message:`Remove the host access override for ${K?K.display_name:I}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await q.del(`/api/host-access/user/${I}`),delete i.value[I],ke.success(`Removed override for ${K?K.display_name:I}`)}catch(re){ke.error(re.message||"Failed to delete")}}return Ue(b),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:k,isRawId:m,activeOptionId:g,searchInput:d,fetchData:b,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:N,setUserDefault:O,openAddUser:T,deleteUser:D,onSearchInput:R,highlightNext:L,highlightPrev:B,selectHighlighted:P,selectMember:$,closeDropdown:W,onBlur:G,addRawId:C}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=te(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=te(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const T=await q.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function g(T){return!T||!T.trim()?[]:T.split(",").map(R=>R.trim()).filter(Boolean)}function k(T,R){const L=c.value.allowed_hosts;if(R&&!L.includes(T)&&L.push(T),!R){const B=L.indexOf(T);B>=0&&L.splice(B,1)}}function w(T,R){const L=u.value.allowed_hosts;if(R&&!L.includes(T)&&L.push(T),!R){const B=L.indexOf(T);B>=0&&L.splice(B,1)}}async function b(){var T;i.value=!0;try{const R=g(c.value.allowed_tools_str),L=c.value.host_mode,B=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:R.length?R:[]};B!==null&&(P.allowed_hosts=B),P.default_host=c.value.default_host||"";const C=await q.post("/api/tokens",P);l.value=C.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ke.success("Token created"),await m()}catch(R){ke.error(((T=R.data)==null?void 0:T.error)||R.message||"Failed to create token")}finally{i.value=!1}}function v(T){r.value=T;const R=T.allowed_hosts;let L="default";R==null?L="default":Array.isArray(R)&&R.length===0?L="none":Array.isArray(R)&&(L="select"),u.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:L,allowed_hosts:Array.isArray(R)?[...R]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const R=g(u.value.allowed_tools_str),L=u.value.host_mode,B={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:R};L==="none"?B.allowed_hosts=[]:L==="select"?B.allowed_hosts=u.value.allowed_hosts:B.allowed_hosts=null,B.default_host=u.value.default_host||"",await q.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,ke.success("Token updated"),await m()}catch(R){ke.error(((T=R.data)==null?void 0:T.error)||R.message||"Failed to update")}finally{o.value=!1}}}async function S(T){var L;if(await as({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await q.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=B.token,ke.success("Token regenerated")}catch(B){ke.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to regenerate")}}async function N(T){var L;if(await as({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/tokens/"+encodeURIComponent(T.user_id)),ke.success("Token deleted"),await m()}catch(B){ke.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return Ue(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:k,toggleEditHost:w,createToken:b,startEdit:v,saveEdit:x,confirmRegenerate:S,confirmDelete:N,copyToken:O}}};function Hr(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Kw={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5","gpt-5","gpt-5-mini","gpt-4.1","gpt-4o"],i=te(()=>{const j=n.value.model;return j&&!a.includes(j)?[j,...a]:a}),l=te(()=>{const j=n.value.agent_model;return j&&!a.includes(j)?[j,...a]:a}),r=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),o=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h(!1),m=h(!1),g=h(!1),k=h({configured:!1}),w=h([]),b=h(""),v=h(!1),x=h(!1),S=h({configured:!1}),N=h([]),O=h(""),T=h(!1),R=h(!1),L=h(!0),B=h(""),P=h({configured:!1,accounts:[]}),C=h(null),$=h(null),W=h(""),G=h(null),D=h(!1),I=h(null),K=h(null),de=h("");let re=null;function Z(j,ye="success"){ke(j,ye==="error"?"error":"success")}function he(j){if(!j)return"?";const ye=j/(1024*1024*1024);return ye>=1?ye.toFixed(1)+" GB":(j/(1024*1024)).toFixed(0)+" MB"}async function X(){e.value=!0,await Promise.all([oe(),Ne(),Me(),V()]),e.value=!1}async function oe(){try{const j=await q.get("/api/llm/status");t.value=j,s.value=j.active_provider||"codex",j.codex&&!F.pending()&&(n.value.enabled=j.codex.enabled,n.value.model=j.codex.model||"gpt-5.5",n.value.reasoning_effort=j.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=j.codex.agent_reasoning_effort||"",n.value.agent_model=j.codex.agent_model||"",n.value.max_tokens=j.codex.max_tokens||4096),j.ollama&&!Y.pending()&&(r.value.enabled=j.ollama.enabled,r.value.base_url=j.ollama.base_url||"",r.value.model=j.ollama.model||"",r.value.max_tokens=j.ollama.max_tokens||4096),j.kimi&&!Q.pending()&&(o.value.enabled=j.kimi.enabled,o.value.model=j.kimi.model||"",o.value.max_tokens=j.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Ne(){try{if(k.value=await q.get("/api/ollama/status"),k.value.model&&(b.value=k.value.model),k.value.configured)try{const j=await q.get("/api/ollama/models");w.value=j.models||[]}catch{w.value=[]}else if(r.value.base_url)try{const j=await q.post("/api/ollama/probe-models",{base_url:r.value.base_url});w.value=j.models||[]}catch{w.value=[]}}catch{k.value={configured:!1}}}async function V(){L.value=!0,B.value="";try{P.value=await q.get("/api/codex/status")}catch(j){B.value=j.message||"Failed to fetch Codex status"}finally{L.value=!1}}async function ue(){const j=t.value?t.value.active_provider:"codex";g.value=!0;try{const ye=await q.post("/api/llm/switch",{provider:s.value});ye.error?(s.value=j,Z(ye.error,"error")):(Z("Switched to "+s.value+" ("+ye.model+")"),await X())}catch(ye){s.value=j,Z(ye.message||"Switch failed","error")}finally{g.value=!1}}async function le(){v.value=!0;try{const j=await q.post("/api/ollama/reload");Z(j.configured?"Ollama reloaded":j.reason||"Ollama not configured",j.configured?"success":"error"),await X()}catch(j){Z(j.message||"Reload failed","error")}finally{v.value=!1}}async function ve(){x.value=!0;try{await q.post("/api/ollama/model",{model:b.value}),Z("Model set to "+b.value),await X()}catch(j){Z(j.message||"Failed","error")}finally{x.value=!1}}async function be(){const j=r.value.base_url;if(!j){Z("Enter a base URL first","error");return}m.value=!0;try{const ye=await q.post("/api/ollama/probe-models",{base_url:j});w.value=ye.models||[],w.value.length?(Z(w.value.length+" model(s) found"),!r.value.model&&w.value.length&&(r.value.model=w.value[0].name)):Z("No models found at "+j,"error")}catch(ye){Z(ye.message||"Could not reach Ollama","error")}finally{m.value=!1}}async function Me(){try{if(S.value=await q.get("/api/kimi/status"),S.value.model&&(O.value=S.value.model),S.value.configured)try{const j=await q.get("/api/kimi/models");N.value=j.models||[]}catch{N.value=[]}}catch{S.value={configured:!1}}}async function y(){T.value=!0;try{const j=await q.post("/api/kimi/reload");Z(j.configured?"Kimi reloaded":j.reason||"Kimi not configured",j.configured?"success":"error"),await X()}catch(j){Z(j.message||"Reload failed","error")}finally{T.value=!1}}async function E(){R.value=!0;try{await q.post("/api/kimi/model",{model:O.value}),Z("Model set to "+O.value),await X()}catch(j){Z(j.message||"Failed","error")}finally{R.value=!1}}async function M(){if(d.value){F();return}d.value=!0;try{await q.put("/api/llm/codex/config",n.value),Z("Codex config saved"),await Promise.all([oe(),V()])}catch(j){Z(j.message||"Failed","error"),await Promise.all([oe(),V()])}finally{d.value=!1}}async function J(){if(f.value){Y();return}f.value=!0;try{const j={...r.value},ye=c.value?r.value.api_key:null;ye===null&&delete j.api_key,await q.put("/api/llm/ollama/config",j),Z("Ollama config saved"),ye!==null&&r.value.api_key===ye&&(r.value.api_key="",c.value=!1),await Promise.all([oe(),Ne()])}catch(j){Z(j.message||"Failed","error")}finally{f.value=!1}}async function A(){if(p.value){Q();return}p.value=!0;try{const j={...o.value},ye=u.value?o.value.api_key:null;ye===null&&delete j.api_key,await q.put("/api/llm/kimi/config",j),Z("Kimi config saved"),ye!==null&&o.value.api_key===ye&&(o.value.api_key="",u.value=!1),await Promise.all([oe(),Me()])}catch(j){Z(j.message||"Failed","error")}finally{p.value=!1}}const F=Hr(M),Y=Hr(J),Q=Hr(A),se=()=>(F.cancel(),M()),ee=()=>(Y.cancel(),J()),ge=()=>(Q.cancel(),A());async function ie(j){try{await q.post("/api/codex/account/"+j+"/activate"),Z("Active account switched"),await V()}catch(ye){Z(ye.message||"Failed","error")}}async function fe(j){C.value=j;try{await q.post("/api/codex/account/"+j+"/refresh"),Z("Token refreshed"),await V()}catch(ye){Z(ye.message||"Refresh failed","error")}finally{C.value=null}}function _e(j,ye){$.value=j,W.value=ye||""}async function Te(j){try{await q.put("/api/codex/account/"+j+"/label",{label:W.value}),Z("Label updated"),$.value=null,await V()}catch(ye){Z(ye.message||"Failed","error")}}async function Re(j,ye){if(await as({title:"Delete Codex account",message:`Delete ${ye||"account #"+(j+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/codex/account/"+j),Z("Deleted. Pool reloaded."),await V()}catch(bt){Z(bt.message||"Failed","error")}}async function U(){D.value=!0;try{const j=await q.post("/api/codex/device-code");I.value=j,G.value="pending",ce(j)}catch(j){Z(j.message||"Failed","error")}finally{D.value=!1}}async function ce(j){re={cancelled:!1};const ye=re;try{const Be=await q.post("/api/codex/device-poll",{device_auth_id:j.device_auth_id,user_code:j.user_code,interval:j.interval});if(ye.cancelled)return;K.value=Be,G.value="success",await X()}catch(Be){if(ye.cancelled)return;de.value=Be.message||"Device login failed",G.value="error"}}function xe(){re&&(re.cancelled=!0),G.value=null,I.value=null}return Ue(X),ft(()=>{re&&(re.cancelled=!0),F.cancel(),Y.cancel(),Q.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:g,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,ollamaForm:r,kimiForm:o,savingCodex:d,savingOllama:f,savingKimi:p,probingOllama:m,ollamaKeyDirty:c,kimiKeyDirty:u,ollamaStatus:k,ollamaModels:w,ollamaSelectedModel:b,reloading:v,settingModel:x,kimiStatus:S,kimiModels:N,kimiSelectedModel:O,reloadingKimi:T,settingKimiModel:R,codexLoading:L,codexError:B,codexData:P,refreshing:C,editingLabel:$,labelValue:W,deviceState:G,deviceLoading:D,deviceInfo:I,deviceResult:K,deviceError:de,fetchAll:X,switchProvider:ue,reloadOllama:le,setOllamaModel:ve,reloadKimi:y,setKimiModel:E,probeOllamaModels:be,saveCodexConfig:M,saveOllamaConfig:J,saveKimiConfig:A,saveCodexConfigDebounced:F,saveOllamaConfigDebounced:Y,saveKimiConfigDebounced:Q,saveCodexConfigNow:se,saveOllamaConfigNow:ee,saveKimiConfigNow:ge,activateAccount:ie,refreshAccount:fe,startEditLabel:_e,saveLabel:Te,deleteAccount:Re,startDeviceLogin:U,cancelDeviceLogin:xe,formatSize:he}}},qd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function qw(e){return qd[e]||qd[(e||"").toLowerCase()]||"text-gray-400"}const Gw={template:`
  ...
  `},Zw={components:{TabbedPage:ur},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Ow},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:Kw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},pt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),mg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:pt("/operations","live")},{path:"/agents",redirect:pt("/operations","agents")},{path:"/loops",redirect:pt("/operations","loops")},{path:"/processes",redirect:pt("/operations","processes")},{path:"/schedules",redirect:pt("/operations","schedules")},{path:"/audit",redirect:pt("/history","audit")},{path:"/sessions",redirect:pt("/history","sessions")},{path:"/traces",redirect:pt("/history","traces")},{path:"/usage",redirect:pt("/history","usage")},{path:"/tools",redirect:pt("/capabilities","tools")},{path:"/skills",redirect:pt("/capabilities","skills")},{path:"/knowledge",redirect:pt("/capabilities","knowledge")},{path:"/memory",redirect:pt("/capabilities","memory")},{path:"/learned",redirect:pt("/capabilities","learned")},{path:"/health",redirect:pt("/system","health")},{path:"/resources",redirect:pt("/system","resources")},{path:"/logs",redirect:pt("/system","logs")},{path:"/config",redirect:pt("/system","config")},{path:"/host-access",redirect:pt("/system","host-access")},{path:"/internals",redirect:pt("/system","internals")}],ni=E_({history:i_(),routes:mg});ni.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const m=h("starting"),g=h(""),k=mg.filter(D=>D.meta),w=te(()=>["Workspace","Operate","Observe","Manage"].map(D=>({name:D,routes:k.filter(I=>I.meta.section===D)})).filter(D=>D.routes.length)),b=te(()=>{var D;return((D=ni.currentRoute.value.meta)==null?void 0:D.label)||"Odin"}),v=te(()=>{var D;return((D=ni.currentRoute.value.meta)==null?void 0:D.section)||"Management"}),x=te(()=>{var D;return((D=ni.currentRoute.value.meta)==null?void 0:D.description)||"Management console"});q.onSessionExpired=()=>{t.value=!0,Ge.disconnect(),q.setToken(""),e.value="login"};function S(D){var I;if((D.ctrlKey||D.metaKey)&&D.key.toLowerCase()==="k"){e.value==="ready"&&(D.preventDefault(),xd());return}if(n.value&&D.key==="Tab"){const K=[...((I=a.value)==null?void 0:I.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(K.length){const de=K[0],re=K[K.length-1];if(D.shiftKey&&(document.activeElement===de||!a.value.contains(document.activeElement))){D.preventDefault(),re.focus();return}if(!D.shiftKey&&(document.activeElement===re||!a.value.contains(document.activeElement))){D.preventDefault(),de.focus();return}}}if(D.key==="Escape"&&n.value){n.value=!1,D.preventDefault();return}if(D.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(D.target.tagName)){D.preventDefault();const K=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');K&&K.focus()}}function N(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Ue(async()=>{document.addEventListener("keydown",S),r=window.matchMedia("(max-width: 900px)"),N(),r.addEventListener("change",N);const D=await q.check();D.ok?(e.value="ready",W()):D.needsAuth?e.value="login":(e.value="ready",W())});function O(){t.value=!1,e.value="ready",W()}async function T(){await q.logout(),Ge.disconnect(),e.value="login"}function R(){s.value=!s.value}function L(){n.value=!n.value}fs(n,async D=>{var I,K;if(D)o=document.activeElement,await Tt(),(K=(I=a.value)==null?void 0:I.querySelector(".nav-item"))==null||K.focus();else if(o!=null&&o.isConnected){const de=o;o=null,requestAnimationFrame(()=>de.focus())}});const B=te(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(D,I="info",K=3e3){f.value={text:D,level:I},clearTimeout(p),p=setTimeout(()=>{f.value=null},K)}let C=null,$=!1;function W(){Ge.onStatusChange=D=>{c.value=D},Ge.onStateChange=(D,I)=>{u.value=D,d.value=I.latency??-1,D==="connected"?($&&P("Connection restored","success"),$=!0):D==="reconnecting"&&I.attempt===1&&P("Connection lost — reconnecting…","warn")},Ge.connect(),G(),C&&clearInterval(C),C=setInterval(G,15e3)}async function G(){try{const D=await q.get("/api/status");m.value=D.status==="online"?"online":"starting";const I=D.uptime_seconds||0,K=Math.floor(I/3600),de=Math.floor(I%3600/60);g.value=`${K}h ${de}m uptime`}catch{m.value="offline",g.value=""}}return ft(()=>{C&&clearInterval(C),Ge.disconnect(),document.removeEventListener("keydown",S),r==null||r.removeEventListener("change",N)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:B,wsToast:f,botStatus:m,botUptime:g,navRoutes:k,navGroups:w,currentPage:b,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:O,logout:T,toggleSidebar:R,toggleMobileNavigation:L,openPalette:xd}}},yn=wl(Yw);yn.component("odin-icon",O_);yn.component("login-screen",Jw);yn.component("toast-container",yx);yn.component("confirm-host",xx);yn.component("command-palette",N_);yn.directive("modal-focus",D_);yn.use(ni);yn.mount("#app");
