...
`));async function d(){const u=e.value;try{await navigator.clipboard.writeText(c.value),e.value===u&&(n.value="Copied")}catch{e.value===u&&(n.value="Copy unavailable — select text manually")}}return Ft(()=>e.value,()=>{t.value=!1,n.value=""}),Ft(a,()=>{t.value=!1,n.value=""}),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,model:i,foldedSections:o,canExpand:r,copyOutput:d}},template:`
  ...
  `},tk={components:{ToolOutput:cr},setup(){const e=f([]),t=f([]),s=f({}),a=50;function n(p){var v,E,R,y,g,b,w,_,T,k,x;const h=p.payload||p,m=h.type||p.type;if(!(["loop_tool_start","loop_tool"].includes(m)&&!(h.agent_id||(v=h.metadata)!=null&&v.agent_id))&&!(["loop_tool_start","loop_tool"].includes(m)&&!(h.call_id||(E=h.metadata)!=null&&E.call_id))){if(m==="tool_start"||m==="loop_tool_start"){const I=h.call_id||((R=h.metadata)==null?void 0:R.call_id)||null,$=h.agent_id||((y=h.metadata)==null?void 0:y.agent_id)||"",S={callId:I,agentId:$,agentLabel:h.agent_label||((g=h.metadata)==null?void 0:g.agent_label)||"",toolInput:h.tool_input,id:I?`${$}:${I}`:`${h.action}-${Date.now()}`,tool:h.action,actor:h.actor||"",channel:h.channel_id||"",iteration:h.iteration??((b=h.metadata)==null?void 0:b.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(S);return}if(m==="tool_end"||m==="loop_tool"){const I=h.call_id||((w=h.metadata)==null?void 0:w.call_id)||null,$=h.agent_id||((_=h.metadata)==null?void 0:_.agent_id)||"";let S=-1;if(I&&(S=e.value.findIndex(P=>P.callId===I&&P.agentId===$&&P.status==="running")),S<0&&!I)for(let P=e.value.length-1;P>=0;P--){const q=e.value[P];if(q.tool===h.action&&q.agentId===$&&q.status==="running"){S=P;break}}if(S>=0){const P=e.value[S];P.status=h.error||(T=h.metadata)!=null&&T.error||["error","failed","cancelled","denied","outcome_unknown"].includes(h.status||((k=h.metadata)==null?void 0:k.status))?"error":"success",P.elapsed=h.execution_time_ms??h.duration_ms??((x=h.metadata)==null?void 0:x.elapsed_ms)??Date.now()-P.startTime,P.result=h.result_summary??h.detail??"",P.fadingOut=!0,setTimeout(()=>{const q=e.value.indexOf(P);q>=0&&e.value.splice(q,1),t.value.unshift(P),t.value.length>a&&t.value.pop()},5e3)}return}if(m==="tool_stream"){const I=h.call_id||h.tool_name||"unknown";if(h.finished){const $={...s.value};delete $[I],s.value=$}else{const S=((s.value[I]||"")+(h.chunk||"")).split(`
`);s.value={...s.value,[I]:S.slice(-30).join(`
...
... (truncated)`:s}function gp(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Pd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function uv(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const pv=Symbol("agent-detail-cancelled"),nk=15e3;function ik(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:a,cancelTimeout:n}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((h,m)=>{r=h,c=m});function u(h,m){o||(o=!0,l!==null&&n(l),l=null,(h?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(h){u(!1,h)}return o||Promise.resolve(p).then(h=>u(!0,h),h=>u(!1,h)),!o&&Number.isFinite(t)&&t>0&&(l=a(()=>{const h=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${h}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,pv),i==null||i.abort()}}}function fv({state:e,requestDetail:t,timeoutMs:s=nk,detailLabel:a="Agent detail",scheduleTimeout:n=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:h,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,h?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const E=ik(R=>t(p,{signal:R}),{timeoutMs:s,timeoutLabel:a,scheduleTimeout:n,cancelTimeout:i});return v.cancel=E.cancel,v.promise=(async()=>{let R=null,y=null;try{R=await E.promise}catch(g){y=g}R!==pv&&(l!==v||e.detailId!==p||(l=null,!y&&(R===null||typeof R!="object")&&(y=new Error(`${a} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${a.toLowerCase()}`):(e.detail=R,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function lk({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:a,intervalMs:n=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&a())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,n))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const ok={components:{ToolOutput:cr},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(!0),i=f("all");let l=!1;const o=z(()=>e.value.filter(L=>L.status==="running").length),r=z(()=>e.value.filter(L=>L.status==="completed").length),c=z(()=>e.value.filter(L=>["failed","timeout","killed"].includes(L.status)).length),d=z(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=z(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(L=>["failed","timeout","killed"].includes(L.status)):e.value.filter(L=>L.status===i.value));function p(L){const te=Number(L.max_iterations)||0;return te<=0?0:Math.min(100,Math.round(L.iteration_count/te*100))}function h(L){return(Number(L.max_iterations)||0)>0}function m(L,te){return L?L==="N/A"?"N/A":te==="current_inheritance"?`inherit (currently ${L})`:L:"unknown"}function v(L){return m(L.display_model,L.display_model_source||L.display_source)}function E(L){return m(L.display_reasoning_effort,L.display_reasoning_effort_source||L.display_source)}function R(L){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[L]||""}const y=f(null),g=f(null),b=f(!1),w=f(null),_=f(""),k=fv({state:{get detail(){return y.value},set detail(L){y.value=L},get detailId(){return g.value},set detailId(L){g.value=L},get detailLoading(){return b.value},set detailLoading(L){b.value=L},get detailError(){return w.value},set detailError(L){w.value=L}},requestDetail:(L,{signal:te})=>H.get(`/api/agents/${encodeURIComponent(L)}`,{signal:te})});async function x(L){_.value="",await k.open(L.id)}function I(){k.close(),_.value=""}async function $(){await k.refresh()}async function S(L,te){try{await navigator.clipboard.writeText(te||""),_.value=L,setTimeout(()=>{_.value===L&&(_.value="")},1500)}catch{we.error("Copy failed")}}async function P(L=!1){L=L===!0,L||(t.value=!0);try{const te=await H.get("/api/agents");e.value=Array.isArray(te)?te:[],s.value=null}catch(te){L||(s.value=te.message)}L||(t.value=!1)}async function q(L){const te=e.value.find(U=>U.id===L);if(await Kt({title:"Kill agent",message:`Kill agent "${(te==null?void 0:te.label)||L}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){a.value=L;try{await H.del(`/api/agents/${encodeURIComponent(L)}`),we.success("Agent killed"),await P()}catch(U){we.error(U.message||"Failed to kill agent")}a.value=null}}const W=lk({isEnabled:()=>n.value&&l,refreshList:()=>P(!0),hasOpenDetail:()=>!!g.value,refreshDetail:$});function D(){W.start()}function O(){W.stop()}return Ft(n,()=>W.sync()),Ge(()=>{l=!0,P(),D()}),Xt(()=>{l=!0,P(!0),D()}),Vt(()=>{l=!1,O()}),ft(()=>{l=!1,O(),k.close()}),{agents:e,loading:t,error:s,killing:a,autoRefresh:n,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:In,formatDuration:vi,progressPercent:p,hasProgress:h,displayModelText:v,displayEffortText:E,displaySourceLabel:R,detail:y,detailId:g,detailLoading:b,detailError:w,copied:_,openDetail:x,closeDetail:I,copyText:S,fetchAgents:P,killAgent:q,startAutoRefresh:D,stopAutoRefresh:O}}},rk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(!1),n=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),h=f("");let m=!1;const E=fv({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return p.value},set detailError(O){p.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:L})=>H.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:L})});async function R(O){h.value="",await E.open(O.id)}function y(){E.close(),h.value=""}async function g(O,L){try{await navigator.clipboard.writeText(L||""),h.value=O,setTimeout(()=>{h.value===O&&(h.value="")},1500)}catch{we.error("Copy failed")}}const b=z(()=>e.value.reduce((O,L)=>O+(L.iteration_count||0),0)),w=z(()=>e.value.filter(O=>O.status==="running").length);function _(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function T(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function k(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function x(O=!1){O=O===!0,O||(t.value=!0);try{const L=await H.get("/api/loops");e.value=Array.isArray(L)?L:[],s.value=null}catch(L){O||(s.value=L.message)}O||(t.value=!1)}async function I(){l.value=null;const O=n.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const L={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&(L.stop_condition=O.stop_condition.trim()),i.value=!0;try{const te=await H.post("/api/loops",L);we.success(`Loop started: ${te.loop_id}`),n.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},a.value=!1,await x()}catch(te){l.value=te.message}i.value=!1}async function $(O){if(await Kt({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=O;try{await H.del(`/api/loops/${encodeURIComponent(O)}`),we.success("Loop stopped"),await x()}catch(te){we.error(te.message||"Failed to stop loop")}o.value=null}}async function S(O){r.value=O;try{await H.post(`/api/loops/${encodeURIComponent(O)}/restart`),we.success("Loop restarted"),await x()}catch(L){we.error(L.message||"Failed to restart loop")}r.value=null}function P(O){m&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(x(!0),d.value&&E.refresh())}let q=null;function W(){q!==null&&clearInterval(q),q=null}function D(){W(),m&&(q=setInterval(()=>{x(!0),d.value&&E.refresh()},5e3))}return Ge(()=>{m=!0,x(),st.subscribe("events",P),D()}),Xt(()=>{m=!0,x(!0),D()}),Vt(()=>{m=!1,W()}),ft(()=>{m=!1,st.unsubscribe("events",P),W(),E.close()}),{loops:e,loading:t,error:s,showCreate:a,form:n,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:h,totalIterations:b,runningCount:w,statusDotClass:_,statusBadge:T,modeBadge:k,formatAge:cv,formatDuration:vi,formatTs:In,formatTokens:uv,openDetail:R,closeDetail:y,copyText:g,fetchLoops:x,doCreate:I,doStop:$,doRestart:S}}},ck={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(so(null)),n=z(()=>a.value.available),i=z(()=>zl(a.value));let l=null;const o=f(!1),r=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""}),c=f(!1),d=f(null),u=z(()=>xp(a.value,r.value.action));function p(F){return xp(a.value,F)}const h=f(null),m=z(()=>fk(r.value.run_at));Ft(()=>r.value.run_at,()=>{h.value=null});const v=z(()=>{var Z;const F=m.value;return F.state==="ok"?F.instant:F.state==="ambiguous"&&h.value!==null&&((Z=F.options[h.value])==null?void 0:Z.instant)||null}),E=z(()=>{const F=v.value;return F?`${F.toLocaleString()} local — ${F.toISOString()} UTC`:""}),R=f(null),y=f(!1),g=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],b=f(null),w=f(null),_=f(null),T=f(null),k=f(null),x=f(null),I=f([]),$=f(!1),S=f("");let P=0;const q=z(()=>e.value.filter(F=>F.cron&&!F.one_time).length),W=z(()=>e.value.filter(F=>F.one_time).length),D=z(()=>e.value.filter(F=>F.trigger).length),O=z(()=>e.value.filter(F=>F.paused).length),L=z(()=>e.value.filter(F=>F.consecutive_failures>0).length);function te(F){if(!F)return"-";const Z=Date.now(),B=(new Date(F).getTime()-Z)/1e3;if(B<0)return"overdue";if(B<60)return"in < 1 min";if(B<3600)return`in ${Math.floor(B/60)} min`;if(B<86400){const ee=Math.floor(B/3600),pe=Math.floor(B%3600/60);return pe>0?`in ${ee}h ${pe}m`:`in ${ee}h`}const Y=Math.floor(B/86400);return`in ${Y} day${Y!==1?"s":""}`}function ie(F){return F==null?"-":F<1e3?`${F}ms`:F<6e4?`${(F/1e3).toFixed(1)}s`:vi(F/1e3)}function U(F=r.value.cron){r.value.cron=F,bp(r.value,"cron"),R.value=null}function Q(F=r.value.run_at){r.value.run_at=F,bp(r.value,"run_at"),R.value=null}async function oe(){const F=r.value.cron.trim();if(F){y.value=!0;try{R.value=await H.post("/api/schedules/validate-cron",{expression:F})}catch(Z){R.value={valid:!1,error:Z.message}}y.value=!1}}async function K(){t.value=!0,s.value=null;try{e.value=await H.get("/api/schedules")}catch(F){s.value=F.message}t.value=!1}async function fe(){try{a.value=so(await H.get("/api/schedules/status"))}catch(F){a.value=yp(F)||so(null)}}function ue(F){const Z=yp(F);Z&&(a.value=Z)}async function G(F){if(x.value===F){x.value=null,I.value=[];return}x.value=F,$.value=!0,I.value=[];const Z=++P;try{const re=await H.get(`/api/schedules/${encodeURIComponent(F)}/history?limit=10`);if(Z!==P||x.value!==F)return;I.value=re,S.value=""}catch(re){if(Z!==P||x.value!==F)return;I.value=[],S.value=re.message||"Failed to load execution history"}Z===P&&($.value=!1)}async function ce(){if(d.value=null,!p(r.value.action)){d.value=zl(a.value);return}const F=r.value;if(!F.description.trim()){d.value="Description is required";return}if(F.action!=="webhook"&&!F.channel_id.trim()){d.value="Channel ID is required";return}if(!F.cron.trim()&&!F.run_at.trim()){d.value="Cron expression or run_at time is required";return}if(F.cron.trim()&&F.run_at.trim()){d.value="Choose either Cron or One-Time, not both";return}const Z={description:F.description.trim(),action:F.action,channel_id:F.channel_id.trim()};if(F.cron.trim()&&(Z.cron=F.cron.trim()),F.run_at.trim()){const re=m.value;if(re.state==="nonexistent"){d.value="That local time does not exist (daylight saving gap)";return}if(re.state==="invalid"){d.value="One-time run time is not a valid date";return}const B=v.value;if(re.state==="ambiguous"&&h.value===null){d.value="That local time happens twice — choose which occurrence to use";return}if(!B){d.value="One-time run time could not be resolved";return}Z.run_at=B.toISOString()}if(F.action==="reminder"&&F.message.trim()&&(Z.message=F.message.trim()),F.action==="check"&&(F.tool_name.trim()&&(Z.tool_name=F.tool_name.trim()),F.report_format&&(Z.report_format=F.report_format),F.tool_input_str.trim()))try{Z.tool_input=JSON.parse(F.tool_input_str.trim())}catch{d.value="Tool input must be valid JSON";return}if(F.action==="webhook"){if(!F.webhook_url.trim()){d.value="Webhook URL is required";return}const re={url:F.webhook_url.trim(),method:F.webhook_method};if(F.webhook_headers_str.trim())try{const B=JSON.parse(F.webhook_headers_str.trim());if(!B||Array.isArray(B)||typeof B!="object")throw new Error("not an object");re.headers=B}catch{d.value="Webhook headers must be a valid JSON object";return}if(F.webhook_body&&(re.body=F.webhook_body),F.webhook_expected_status_str.trim()){const B=F.webhook_expected_status_str.split(",").map(Y=>Number(Y.trim()));if(B.some(Y=>!Number.isInteger(Y)||Y<100||Y>599)){d.value="Expected status codes must be comma-separated HTTP codes";return}re.expected_status_codes=B}Z.webhook_config=re}c.value=!0;try{await H.post("/api/schedules",Z),we.success("Schedule created"),r.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""},R.value=null,o.value=!1,await K()}catch(re){ue(re),d.value=re.message}c.value=!1}async function me(F){if(!p(F.action)){we.error(zl(a.value));return}const Z=F.id;b.value=Z;try{const re=await H.post(`/api/schedules/${encodeURIComponent(Z)}/run`);if(re.status==="failure")we.error(`Execution failed: ${re.error||"unknown error"}`);else{const B=re.warning?`Executed (${re.warning})`:"Executed successfully";we.success(B)}await K()}catch(re){ue(re),we.error(re.message||"Failed to trigger")}b.value=null}async function ve(F){if(F.paused&&!p(F.action)){we.error(zl(a.value));return}_.value=F.id;const Z=!F.paused;try{await H.put(`/api/schedules/${encodeURIComponent(F.id)}`,{paused:Z}),we.success(Z?"Schedule paused":"Schedule resumed"),await K()}catch(re){ue(re),we.error(re.message||"Failed to update schedule")}_.value=null}const be=new Map;function $e(F,Z){const re=be.get(F.id);re&&clearTimeout(re.timer);const B={run:()=>C(F,Z),timer:null};B.timer=setTimeout(()=>{be.delete(F.id),B.run()},500),be.set(F.id,B)}async function C(F,Z){k.value=F.id;try{await H.put(`/api/schedules/${encodeURIComponent(F.id)}`,{report_format:Z}),we.success(Z?"Structured report enabled":"Plain-text report enabled")}catch(re){we.error(`Update failed: ${re.message}`)}finally{await K(),k.value=null}}function M(){for(const[F,Z]of[...be])clearTimeout(Z.timer),be.delete(F),Z.run()}async function j(F){T.value=F;try{await H.post(`/api/schedules/${encodeURIComponent(F)}/reset-failures`),we.success("Failure counters reset"),await K()}catch(Z){we.error(Z.message||"Failed to reset")}T.value=null}async function de(F){const Z=e.value.find(B=>B.id===F);if(await Kt({title:"Delete schedule",message:`Delete "${(Z==null?void 0:Z.description)||F}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){w.value=F;try{await H.del(`/api/schedules/${encodeURIComponent(F)}`),we.success("Schedule deleted"),await K()}catch(B){we.error(B.message||"Failed to delete schedule")}w.value=null}}return Ge(()=>{K(),fe(),l=setInterval(fe,hk)}),ft(()=>{M(),l&&clearInterval(l)}),{schedules:e,loading:t,error:s,schedulingAvailable:n,schedulingAvailabilityMessage:i,selectedActionAvailable:u,actionAvailable:p,showCreate:o,form:r,creating:c,createError:d,runAtUtcPreview:E,runAtAnalysis:m,runAtOccurrence:h,cronResult:R,validatingCron:y,cronPresets:g,runningId:b,deletingId:w,togglingId:_,resettingId:T,reportUpdatingId:k,flushReportFormatTimers:M,expandedId:x,history:I,historyLoading:$,historyError:S,cronCount:q,oneTimeCount:W,webhookCount:D,pausedCount:O,failingCount:L,formatTs:In,formatAge:cv,formatFuture:te,formatMs:ie,formatDuration:vi,onCronInput:U,onRunAtInput:Q,validateCron:oe,toggleExpand:G,fetchSchedules:K,fetchSchedulingAvailability:fe,doCreate:ce,doRunNow:me,doTogglePause:ve,doUpdateReportFormat:$e,doResetFailures:j,doDelete:de}}},hv=[{id:"live",label:"Live",component:tk},{id:"agents",label:"Agents",component:ok},{id:"loops",label:"Loops",component:rk},{id:"processes",label:"Processes",component:ck},{id:"schedules",label:"Schedules",component:vk}],gk={components:{TabbedPage:rr},setup(){return{tabs:hv}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},bk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),h=f("last_active"),m=f(!1),v=_p,E=yk,R=f([]),y=f(!1),g=f(""),b=f("flat"),w=f(new Set),_=f(""),T=f(""),k=f(""),x=f(null),I=f(!1),$=f(""),S=f(!1);let P=0;Ft([_,T,k],()=>{P++,I.value=!1,$.value="",S.value=x.value!==null},{flush:"sync"});function q(){try{const se=localStorage.getItem("odin-session-presets");se&&(R.value=JSON.parse(se))}catch{}}function W(){try{localStorage.setItem("odin-session-presets",JSON.stringify(R.value))}catch{}}const D=z(()=>p.value.trim()!==""||u.value!=="all"),O=z(()=>{let se=[...e.value];const Ee=_p.find(Ke=>Ke.id===u.value),Ne=Ee?Ee.filters:{};if(Ne.source&&(se=se.filter(Ke=>Ke.source===Ne.source)),Ne.minMessages&&(se=se.filter(Ke=>Ke.message_count>=Ne.minMessages)),Ne.hasCompaction&&(se=se.filter(Ke=>Ke.has_summary)),Ne.maxAge!=null){const Ke=Date.now()/1e3;se=se.filter(Ut=>Ut.last_active&&Ke-Ut.last_active<=Ne.maxAge)}if(p.value.trim()){const Ke=p.value.toLowerCase().trim();se=se.filter(Ut=>(Ut.channel_id||"").toLowerCase().includes(Ke)||(Ut.last_user_id||"").toLowerCase().includes(Ke)||(Ut.source||"").toLowerCase().includes(Ke))}const Je=h.value,Lt=m.value?1:-1;return se.sort((Ke,Ut)=>{const Bt=Ke[Je]||0,hs=Ut[Je]||0;return(Bt-hs)*Lt}),se}),L=z(()=>{if(!n.value||!n.value.messages)return[];const se=n.value.messages;if(se.length===0)return[];const Ee=[];let Ne=[];for(const Je of se)Je.role==="user"&&Ne.length>0&&(Ee.push(Ne),Ne=[]),Ne.push(Je);return Ne.length>0&&Ee.push(Ne),Ee}),te=z(()=>O.value.length>0&&c.value.size===O.value.length);function ie(se){const Ee=se.find(Ne=>Ne.role==="user");if(Ee&&Ee.content){const Ne=Ee.content.slice(0,120);return Ne.length<Ee.content.length?Ne+"...":Ne}return"(no user message)"}function U(se){const Ee=new Set(w.value);Ee.has(se)?Ee.delete(se):Ee.add(se),w.value=Ee}function Q(se){u.value=se}function oe(se){u.value=se.id,se.filters.searchQuery!=null&&(p.value=se.filters.searchQuery),se.filters.sortBy&&(h.value=se.filters.sortBy)}function K(){if(!g.value.trim())return;const se={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:h.value}};R.value=[...R.value,se],W(),y.value=!1,g.value=""}function fe(se){R.value=R.value.filter(Ee=>Ee.id!==se),W(),u.value===se&&(u.value="all")}function ue(){u.value="all",p.value="",h.value="last_active",m.value=!1}function G(se){if(!se)return"—";const Ee=Date.now()/1e3-se;if(Ee<60)return"just now";if(Ee<3600){const Je=Math.floor(Ee/60);return`${Je} minute${Je!==1?"s":""} ago`}if(Ee<86400){const Je=Math.floor(Ee/3600);return`${Je} hour${Je!==1?"s":""} ago`}const Ne=Math.floor(Ee/86400);return`${Ne} day${Ne!==1?"s":""} ago`}function ce(se){if(!se)return"";try{return new Date(se*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function me(se){if(!se)return"";try{return new Date(se*1e3).toLocaleString()}catch{return""}}function ve(se){return se==="user"?"bg-gray-900/50 border border-gray-800":se==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function be(se){return se==="user"?"sess-msg-user":se==="assistant"?"sess-msg-assistant":"sess-msg-system"}function $e(se){return se==="user"?"badge-info":se==="assistant"?"badge-success":"badge-warning"}function C(se){return se==="user"?"sess-dot-user":se==="assistant"?"sess-dot-assistant":"sess-dot-system"}function M(se){return se==="user"?"text-cyan-400":se==="assistant"?"text-indigo-400":"text-gray-500"}function j(se){return se?se.length>2e3?se.slice(0,2e3)+`
... (truncated)`:se:""}async function de(){const se=_.value.trim();if(!se)return;const Ee=++P;I.value=!0,$.value="",S.value=x.value!==null;try{let Ne=`/api/sessions/search?q=${encodeURIComponent(se)}&limit=50`;T.value.trim()&&(Ne+=`&channel_id=${encodeURIComponent(T.value.trim())}`),k.value.trim()&&(Ne+=`&user_id=${encodeURIComponent(k.value.trim())}`);const Je=await H.get(Ne);if(Ee!==P)return;x.value=Je.results||[],S.value=!1}catch(Ne){if(Ee!==P)return;$.value=Ne.message||"Search failed. Please retry."}finally{Ee===P&&(I.value=!1)}}function F(){P++,_.value="",T.value="",k.value="",x.value=null,$.value="",S.value=!1,I.value=!1}function Z(se){return se?se.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function re(se){return se==="user"?"fts-result-user":se==="assistant"?"fts-result-assistant":se==="summary"?"fts-result-summary":se==="fts"?"fts-result-fts":se==="channel"?"fts-result-channel":"fts-result-default"}function B(se){return se==="user"?"badge-info":se==="assistant"?"badge-success":se==="summary"?"badge-warning":se==="fts"?"badge-success":"badge-info"}let Y=0;async function ee(){const se=++Y;t.value=!0,s.value=null;try{const Ee=await H.get("/api/sessions");if(se!==Y)return;e.value=Ee}catch(Ee){if(se!==Y)return;s.value=Ee.message}se===Y&&(t.value=!1)}function pe(){s.value=null,ee()}async function he(se){if(a.value===se){a.value=null,n.value=null,w.value=new Set;return}a.value=se,n.value=null,i.value=!0,w.value=new Set;const Ee=++l;try{const Ne=await H.get(`/api/sessions/${encodeURIComponent(se)}`);Ee===l&&a.value===se&&(n.value=Ne)}catch(Ne){Ee===l&&a.value===se&&(n.value={messages:[],summary:"",error:Ne.message||"Failed to load session"})}finally{Ee===l&&(i.value=!1)}}function xe(se){const Ee=new Set(c.value);Ee.has(se)?Ee.delete(se):Ee.add(se),c.value=Ee}function Oe(){te.value?c.value=new Set:c.value=new Set(O.value.map(se=>se.channel_id))}function ge(se){o.value=se}async function He(){if(o.value){r.value=!0;try{await H.del(`/api/sessions/${encodeURIComponent(o.value)}`),a.value===o.value&&(a.value=null,n.value=null),c.value.delete(o.value),await ee()}catch(se){s.value=se.message||"Failed to clear session"}r.value=!1,o.value=null}}function Ue(){d.value=!0}async function je(){if(c.value.size!==0){r.value=!0;try{await H.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(a.value)&&(a.value=null,n.value=null),c.value=new Set,await ee()}catch(se){s.value=se.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Qe(se,Ee){const Ne=`/api/sessions/${encodeURIComponent(se)}/export?format=${Ee}`;try{const Je=await H.getBlob(Ne),Lt=URL.createObjectURL(Je),Ke=document.createElement("a");Ke.href=Lt,Ke.download=`session-${se}.${Ee==="text"?"txt":"json"}`,Ke.click(),URL.revokeObjectURL(Lt)}catch(Je){s.value=Je.message||"Failed to export session"}}let ot=null;function nt(se){se.payload&&se.payload.channel_id&&(clearTimeout(ot),ot=setTimeout(()=>{if(ee(),a.value&&se.payload.channel_id===a.value){const Ee=a.value,Ne=l;H.get(`/api/sessions/${encodeURIComponent(Ee)}`).then(Je=>{Ne!==l||a.value!==Ee||(n.value=Je)}).catch(()=>{})}},2e3))}let X=!1,_e=null;function Ae(){X||(X=!0,ee(),st.subscribe("events",nt),_e=st.onReconnected(()=>ee()))}Ge(()=>{q(),Ae()}),Xt(()=>{Ae()});function Le(){X&&(X=!1,st.unsubscribe("events",nt),_e&&(_e(),_e=null),clearTimeout(ot))}return Vt(Le),ft(Le),{sessions:e,loading:t,error:s,expandedId:a,detail:n,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:te,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:h,sortAsc:m,filterPresets:v,sortOptions:E,filteredSessions:O,hasActiveFilters:D,customPresets:R,showSavePreset:y,newPresetName:g,threadView:b,threads:L,collapsedThreads:w,ftsQuery:_,ftsChannelId:T,ftsUserId:k,ftsResults:x,ftsSearching:I,ftsError:$,ftsStale:S,formatAge:G,formatTimestamp:ce,formatFullTimestamp:me,messageClass:ve,threadMsgClass:be,roleBadge:$e,roleDotClass:C,roleLabelClass:M,truncateContent:j,threadSummary:ie,fetchSessions:ee,retry:pe,toggleSession:he,toggleSelect:xe,toggleSelectAll:Oe,confirmClear:ge,clearSession:He,confirmBulkClear:Ue,doBulkClear:je,exportSession:Qe,applyPreset:Q,applyCustomPreset:oe,saveCustomPreset:K,removeCustomPreset:fe,resetFilters:ue,toggleThread:U,runFtsSearch:de,clearFtsSearch:F,highlightSnippet:Z,ftsResultClass:re,ftsTypeBadge:B}}},_k={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:uv}}},wk={components:{ContextAssemblyPanel:_k},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(T){if(!T)return"—";try{const k=new Date(T);return isNaN(k.getTime())?T:k.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return T}}function p(T){return!T&&T!==0?"—":T<1e3?T+"ms":(T/1e3).toFixed(1)+"s"}function h(T){return!T&&T!==0?"—":T>=1e3?(T/1e3).toFixed(1)+"k":String(T)}function m(T){if(!T)return"";if(typeof T=="string")return T;try{return JSON.stringify(T,null,2)}catch{return String(T)}}function v(T){n.value===T?n.value=null:(n.value=T,c.value={})}function E(T,k){const x=T+"-"+k;c.value={...c.value,[x]:!c.value[x]}}function R(T,k){return!!c.value[T+"-"+k]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,w()}async function g(){try{const T=await H.get("/api/trajectories");e.value=T.files||[],r.value=T.count||0}catch{}}let b=0;async function w(){const T=++b;s.value=!0,a.value=null,n.value=null,i.value=null,c.value={};try{if(o.value){const k=await H.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(T!==b)return;let x=k.entries||[];d.value.tool_name&&(x=x.filter(I=>(I.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(x=x.filter(I=>I.is_error)),d.value.channel_id&&(x=x.filter(I=>I.channel_id===d.value.channel_id)),d.value.user_id&&(x=x.filter(I=>I.user_id===d.value.user_id)),t.value=x}else{const k=new URLSearchParams;d.value.channel_id&&k.set("channel_id",d.value.channel_id),d.value.user_id&&k.set("user_id",d.value.user_id),d.value.tool_name&&k.set("tool_name",d.value.tool_name),d.value.errors_only&&k.set("errors_only","true"),k.set("limit",String(d.value.limit));const x=k.toString(),I=await H.get(`/api/trajectories/search/query?${x}`);if(T!==b)return;t.value=I.results||[]}}catch(k){if(T!==b)return;a.value=k.message}T===b&&(s.value=!1)}async function _(){if(!l.value.trim())return;const T=++b;s.value=!0,a.value=null,c.value={};try{const k=await H.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(T!==b)return;i.value=k.entry||null,i.value||(a.value="No trace found for this message ID")}catch(k){if(T!==b)return;k.status===404?(i.value=null,a.value="No trace found for message ID: "+l.value):a.value=k.message}T===b&&(s.value=!1)}return Ge(async()=>{await g(),await w()}),{files:e,entries:t,loading:s,error:a,expandedIdx:n,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:h,formatJSON:m,truncateBlock:dv,toggleExpand:v,toggleIteration:E,isIterationExpanded:R,clearFilters:y,fetchFiles:g,fetchTraces:w,lookupMessage:_}}};function kk(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function Sk(e){return e?`${e.approximate?"~":""}${Pd(e.total||0)}`:"0"}const Tk={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),a=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),n=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=z(()=>a.value.work||{}),h=z(()=>Math.max(1,...(a.value.activity_over_time||[]).map(_=>Number(_.count||0)))),m=z(()=>({minWidth:`max(100%, ${(a.value.activity_over_time||[]).length*5}px)`})),v=_=>({height:`${Math.max(4,Math.round(Number(_||0)/h.value*100))}%`}),E=z(()=>s.value&&l.value-i.value>3e4);async function R(){const _=++d,T=n.value;try{const k=await H.get(`/api/usage?range=${encodeURIComponent(T)}`);if(_!==d||T!==n.value)return;a.value=k,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(k){_===d&&(t.value=k.message)}finally{_===d&&(e.value=!1)}}function y(_){n.value=_,e.value=!s.value,R()}function g(){e.value=!0,R()}function b(){c||(c=!0,R(),o=setInterval(R,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function w(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return Ge(b),Xt(b),Vt(w),ft(w),{data:a,work:p,loading:e,error:t,hasData:s,range:n,ranges:u,isStale:E,fmtNum:Pd,fmtDuration:kk,tokenLabel:Sk,activityTrackStyle:m,activityBar:v,selectRange:y,retry:g}}},mv=[{id:"audit",label:"Audit",component:bk},{id:"sessions",label:"Sessions",component:xk},{id:"traces",label:"Traces",component:wk},{id:"usage",label:"Usage & Activity",component:Tk}],Ck={components:{TabbedPage:rr},setup(){return{tabs:mv}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Fr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Ek={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(x){return x.source!=="builtin"?"":u[x.state]||""}function h(x,I){const $=x&&Array.isArray(x.tools)?x.tools:null;if(c.value=!!$,r.value=$?!!x.global_enabled:null,!$){e.value=I.map(q=>({...q,source:"unknown",enabled:void 0,state:null}));return}const S=new Set($.map(q=>q.name)),P=I.filter(q=>!S.has(q.name)).map(q=>({...q,source:q.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...$.map(q=>({...q,source:"builtin"})),...P]}async function m(x,I){if(d.value.has(x.name))return;const $=!!I.target.checked,S=new Set(d.value);S.add(x.name),d.value=S;try{const P=await H.post(`/api/tools/builtins/${encodeURIComponent(x.name)}/enabled`,{enabled:$});h(P,e.value),s.value=null;try{const q=await H.get("/api/tools");h(P,q)}catch(q){console.warn("Built-in toggle committed; visible catalog refresh failed",q)}}catch(P){I.target.checked=!!x.enabled,s.value=P.message||`Failed to toggle ${x.name}`}finally{const P=new Set(d.value);P.delete(x.name),d.value=P}}const v=z(()=>e.value.filter(x=>x.source==="builtin"&&x.is_core).length),E=z(()=>e.value.filter(x=>x.source==="skill").length),R=z(()=>Object.values(n.value).reduce((x,I)=>x+I,0));function y(x){for(const I of Fr)if(I.id!=="other"&&I.match(x))return I.id;return"other"}const g=z(()=>{let x=e.value;if(a.value){const I=a.value.toLowerCase();x=x.filter($=>$.name.toLowerCase().includes(I)||($.description||"").toLowerCase().includes(I))}return o.value&&(x=x.filter(I=>y(I.name)===o.value)),x}),b=z(()=>{const x=new Set;for(const I of e.value)x.add(y(I.name));return Fr.filter(I=>x.has(I.id))}),w=z(()=>{const x=g.value,I={};for(const S of x){const P=y(S.name);I[P]||(I[P]=[]),I[P].push(S)}const $=[];for(const S of Fr)I[S.id]&&I[S.id].length>0&&$.push({label:S.label,icon:S.icon,tools:I[S.id].sort((P,q)=>P.name.localeCompare(q.name))});return $});function _(x){i.value={...i.value,[x]:!i.value[x]}}async function T(){t.value=!0,s.value=null;try{const[x,I,$]=await Promise.all([H.get("/api/tools"),H.get("/api/tools/stats").catch(()=>({})),H.get("/api/tools/builtins").catch(()=>null)]);h($,x),n.value=I||{}}catch(x){s.value=x.message}t.value=!1}function k(){T()}return Ge(()=>{T()}),{tools:e,loading:t,error:s,search:a,stats:n,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:E,totalUsage:R,filteredTools:g,groupedTools:w,usedCategories:b,stateBadge:p,applyInventory:h,toggleBuiltinTool:m,truncate:Dd,toggleExpand:_,refresh:k}}};function Ak(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const a="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(a,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Rk(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function $(K){return Rk(K)}function S(K){a.value={...a.value,[K]:!a.value[K]}}async function P(K){try{await navigator.clipboard.writeText(K);const fe=e.value.find(ue=>ue.code===K);fe&&(o.value=fe.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function q(K){if(K.key==="Tab"){K.preventDefault();const fe=K.target,ue=fe.selectionStart,G=fe.selectionEnd;u.value=u.value.substring(0,ue)+"    "+u.value.substring(G),It(()=>{fe.selectionStart=fe.selectionEnd=ue+4})}}function W(K){const fe=K.target.previousElementSibling;fe&&(fe.scrollTop=K.target.scrollTop)}async function D(){t.value=!0,s.value=null;try{e.value=await H.get("/api/skills")}catch(K){s.value=K.message}t.value=!1}async function O(K){i.value=K,delete n.value[K],n.value={...n.value};try{const fe=await H.post(`/api/skills/${encodeURIComponent(K)}/test`);n.value={...n.value,[K]:fe}}catch(fe){n.value={...n.value,[K]:{result:fe.message,is_error:!0}}}i.value=null}function L(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,h.value=null}function te(K){r.value=!0,c.value="edit",d.value=K.name,u.value=K.code||"",p.value=null,h.value=null}function ie(){r.value=!1,p.value=null,h.value=null}async function U(){p.value=null,h.value=null;const K=d.value.trim(),fe=u.value.trim();if(!K){p.value="Name is required";return}if(!fe){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await H.post("/api/skills",{name:K,code:fe}),h.value="Skill created successfully"):(await H.put(`/api/skills/${encodeURIComponent(K)}`,{code:fe}),h.value="Skill updated successfully"),await D(),setTimeout(()=>{r.value=!1},800)}catch(ue){p.value=ue.message}m.value=!1}function Q(K){E.value=K}async function oe(){if(E.value){R.value=!0;try{await H.del(`/api/skills/${encodeURIComponent(E.value)}`),await D()}catch(K){we.error(`Failed to delete skill: ${K.message||"unknown error"}`)}R.value=!1,E.value=null}}return Ge(()=>{D()}),{skills:e,loading:t,error:s,showCode:a,testResults:n,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:h,saving:m,editorRef:v,deleteTarget:E,deleting:R,enabledCount:y,totalExecutions:g,totalLines:b,displayedSkills:w,editLineCount:_,editorLineNums:T,editValidation:k,highlight:x,truncate:Dd,formatTs:In,countLines:I,getLineNumbers:$,toggleCode:S,copyCode:P,handleEditorKey:q,syncScroll:W,fetchSkills:D,testSkill:O,showCreate:L,editSkill:te,cancelEdit:ie,saveSkill:U,confirmDelete:Q,doDelete:oe}}};class Ms extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Ok=/^[A-Za-z_][A-Za-z0-9_]*$/;function wp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function kp(e,t,s){const a={},n=[...new Set((t||[]).map(l=>String(l)))],i=new Set(n);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Ms(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Ms(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(a,o))throw new Ms(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Ms(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");a[o]=r}}return{set:a,remove:n}}function Lk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Nk(e,{mode:t="add",originalTransport:s=""}={}){const a=t==="add",n=String(e.name||"").trim();if(!n)throw new Ms("Server name is required.","name");if(n.length>128||!Ok.test(n))throw new Ms("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!a&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(a&&(o.name=n),i==="stdio"){const d=String(e.command||"").trim();if((a||l)&&!d)throw new Ms("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(a||e.replaceArgs)&&(o.args=wp(e.argsText)),a||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Ms("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((a||l)&&!d)throw new Ms("An HTTP endpoint is required for this connection.","url");if(d&&!Lk(d))throw new Ms("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(a||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Ms("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(a||e.replaceAllowlist)&&(o.tool_allowlist=wp(e.allowlistText));const r=kp(e.headerRows,e.headersRemove,"Header"),c=kp(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function Dk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function Pk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Mk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(a=>String(a).toLowerCase().includes(s)):!0}const Fk=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function $k(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(a=>(a=window.matchMedia)==null?void 0:a.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const n=t.querySelector(".mcp-editor-groups"),i=n==null?void 0:n.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Uk=1e4,Bk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function $r(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function Hk(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const jk={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),a=f(!1),n=f(""),i=f({max_published_tools_per_server:"",max_published_tools_global:""}),l=f(new Set),o=z(()=>Object.keys(i.value).every(X=>{var _e;return Number.isInteger((_e=e.value)==null?void 0:_e[X])})),r=f(""),c=f(new Set),d=f(new Set),u=f({}),p=f({}),h=f({}),m=f(new Set),v=f(!1),E=f("add"),R=f(""),y=f(null),g=f($r()),b=f(""),w=f(!1);let _=null,T=0,k=!1,x=!1;const I=Fk,$=z(()=>{var X;return((X=e.value)==null?void 0:X.servers)||[]}),S=z(()=>{var X;return!!((X=e.value)!=null&&X.enabled)}),P=z(()=>{var X,_e,Ae,Le;return{serverCount:((X=e.value)==null?void 0:X.server_count)||0,enabledCount:((_e=e.value)==null?void 0:_e.enabled_server_count)||0,connectedCount:((Ae=e.value)==null?void 0:Ae.connected_count)||0,toolCount:((Le=e.value)==null?void 0:Le.published_tool_count)||0}}),q=z(()=>{var X;return((X=y.value)==null?void 0:X.header_keys)||[]}),W=z(()=>{var X;return((X=y.value)==null?void 0:X.env_keys)||[]}),D=z(()=>{var X;return E.value==="edit"&&((X=y.value)==null?void 0:X.transport)==="http"}),O=z(()=>E.value==="add"||!D.value),L=z(()=>D.value?"Replace endpoint URL":"Endpoint URL"),te=z(()=>D.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function ie(){U(),_=window.setInterval(()=>Q({quiet:!0}),Uk)}function U(){_&&window.clearInterval(_),_=null}async function Q({quiet:X=!1}={}){if(a.value)return;const _e=++T;X||(t.value=!0);try{const Ae=await H.get("/api/mcp/status");if(_e!==T||!k)return;e.value=Ae;for(const se of Object.keys(i.value))!l.value.has(se)&&Number.isInteger(Ae[se])&&(i.value[se]=String(Ae[se]));r.value="";const Le=new Set((Ae.servers||[]).map(se=>se.name));d.value=new Set([...d.value].filter(se=>Le.has(se)))}catch(Ae){_e===T&&k&&(r.value=Ae.message||"Failed to load MCP status")}finally{_e===T&&(t.value=!1)}}function oe(X){return s.value||c.value.has(X)}function K(X,_e){const Ae=new Set(c.value);_e?Ae.add(X):Ae.delete(X),c.value=Ae}function fe(X){return Pk(X.state)}function ue(X){if(fe(X)==="disabled"){if(!X.enabled)return"Disabled — server switch off";if(!S.value)return"Disabled — global MCP is off"}return Bk[fe(X)]}function G(X){return X.transport==="http"?"Streamable HTTP":"stdio"}function ce(X){return X.negotiated_version?`${X.era?`${String(X.era).charAt(0).toUpperCase()}${String(X.era).slice(1)}`:"Protocol"} · ${X.negotiated_version}`:"Not negotiated"}function me(X){return X.discovered_count?`${X.published_count||0} published · ${X.excluded_count||0} excluded`:"No tools discovered"}const ve=f(new Set);async function be(X,_e){if(ve.value.has(X.name))return;const Ae=!!_e.target.checked,Le=new Set(ve.value);Le.add(X.name),ve.value=Le;try{const se=await H.post(`/api/mcp/servers/${encodeURIComponent(X.name)}/enabled`,{enabled:Ae});se&&Array.isArray(se.servers)?e.value=se:await Q({quiet:!0})}catch(se){_e.target.checked=!!X.enabled,we.error(se.message||`Failed to toggle ${X.name}`)}finally{const se=new Set(ve.value);se.delete(X.name),ve.value=se}}function $e(X,_e){var Le;i.value[X]=_e;const Ae=new Set(l.value);_e===String((Le=e.value)==null?void 0:Le[X])?Ae.delete(X):Ae.add(X),l.value=Ae,n.value=""}async function C(){if(s.value||!o.value||!l.value.size)return;const X={};for(const _e of l.value){const Ae=Number(i.value[_e]),Le=_e==="max_published_tools_per_server"?128:256;if(!Number.isInteger(Ae)||Ae<1||Ae>Le){n.value=`Enter a whole number between 1 and ${Le}.`;return}X[_e]=Ae}a.value=!0,s.value=!0,n.value="",++T,t.value=!1;try{const _e=await H.post("/api/mcp/limits",X);e.value=_e;for(const Ae of Object.keys(i.value))Number.isInteger(_e[Ae])&&(i.value[Ae]=String(_e[Ae]));l.value=new Set,we.success("MCP limits saved. Applied at the next publication or tools refresh.")}catch(_e){n.value=_e.message||"Failed to save MCP publication limits"}finally{a.value=!1,s.value=!1,await Q({quiet:!0})}}async function M(X){if(X!==S.value&&!(!X&&!await Kt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await H.post("/api/mcp/enabled",{enabled:X}),we.success(X?"MCP enabled":"MCP disabled"),await Q({quiet:!0})}catch(_e){we.error(_e.message||"Failed to update MCP state"),await Q({quiet:!0})}finally{s.value=!1}}}async function j(X){K(X.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(X.name)}/reconnect`,{}),we.success(`Reconnected ${X.name}`)}catch(_e){we.error(_e.message||`Failed to reconnect ${X.name}`)}finally{K(X.name,!1),await Q({quiet:!0})}}async function de(X){K(X.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(X.name)}/refresh-tools`,{}),we.success(`Refreshed tools from ${X.name}`),await re(X.name,!0)}catch(_e){we.error(_e.message||`Failed to refresh ${X.name}`)}finally{K(X.name,!1),await Q({quiet:!0})}}async function F(X){if(await Kt({title:`Remove ${X.name}`,message:`Remove this saved MCP server? Its ${X.published_count||0} published tool${X.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){K(X.name,!0);try{await H.del(`/api/mcp/servers/${encodeURIComponent(X.name)}`),we.success(`Removed ${X.name}`),delete p.value[X.name]}catch(Ae){we.error(Ae.message||`Failed to remove ${X.name}`)}finally{K(X.name,!1),await Q({quiet:!0})}}}async function Z(X){const _e=new Set(d.value);if(_e.has(X.name)){_e.delete(X.name),d.value=_e;return}_e.add(X.name),d.value=_e,Object.hasOwn(p.value,X.name)||await re(X.name)}async function re(X,_e=!1){if(!_e&&Object.hasOwn(p.value,X))return;const Ae=new Set(m.value);Ae.add(X),m.value=Ae,h.value={...h.value,[X]:""};try{const Le=await H.get(`/api/mcp/servers/${encodeURIComponent(X)}/tools`);p.value={...p.value,[X]:Le.tools||[]}}catch(Le){h.value={...h.value,[X]:Le.message||"Failed to load tools"}}finally{const Le=new Set(m.value);Le.delete(X),m.value=Le}}function B(X){return(p.value[X]||[]).filter(_e=>Mk(_e,u.value[X]))}function Y(X,_e){u.value={...u.value,[X]:_e}}function ee(){E.value="add",R.value="",y.value=null,g.value=$r(),b.value="",v.value=!0}function pe(X){E.value="edit",R.value=X.name,y.value=X,g.value={...$r(),name:X.name,enabled:!!X.enabled,transport:X.transport||"stdio"},b.value="",v.value=!0}function he(){w.value||(v.value=!1)}function xe(X){v.value&&$k(X)}function Oe(X){const _e=X==="headers"?"headerRows":"envRows";g.value[_e].push({key:"",value:""})}function ge(X,_e){const Ae=X==="headers"?"headerRows":"envRows";g.value[Ae].splice(_e,1)}function He(X,_e){const Ae=X==="headers"?"headersRemove":"envRemove",Le=g.value[Ae];g.value[Ae]=Le.includes(_e)?Le.filter(se=>se!==_e):[...Le,_e]}async function Ue(){var _e,Ae;b.value="";let X;try{X=Nk(g.value,{mode:E.value,originalTransport:((_e=y.value)==null?void 0:_e.transport)||""})}catch(Le){b.value=Le instanceof Ms?Le.message:"Invalid MCP server configuration",await It(),(Ae=document.querySelector(".mcp-editor"))==null||Ae.scrollTo({top:0,behavior:"smooth"});return}if(!(E.value==="edit"&&Dk(X,y.value)&&!await Kt({title:`Change ${R.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){w.value=!0;try{E.value==="add"?await H.post("/api/mcp/servers",X):await H.put(`/api/mcp/servers/${encodeURIComponent(R.value)}`,X),we.success(E.value==="add"?`Saved ${X.name}`:`Updated ${R.value}`),v.value=!1,await Q({quiet:!0})}catch(Le){b.value=Le.message||"Failed to save MCP server"}finally{w.value=!1}}}let je=null;function Qe(X){`${(X==null?void 0:X.event)||""} ${(X==null?void 0:X.type)||""} ${(X==null?void 0:X.tool)||""} ${(X==null?void 0:X.message)||""}`.toLowerCase().includes("mcp")&&(je&&window.clearTimeout(je),je=window.setTimeout(()=>Q({quiet:!0}),200))}function ot(){k||(k=!0,x||(st.subscribe("events",Qe),x=!0),Q(),ie())}function nt(){k=!1,U(),je&&window.clearTimeout(je),je=null,x&&(st.unsubscribe("events",Qe),x=!1)}return Ge(ot),Xt(ot),Vt(nt),ft(nt),{status:e,loading:t,mutating:s,pageError:r,servers:$,masterEnabled:S,aggregate:P,limitsSaving:a,limitsError:n,limitsAvailable:o,limitDraft:i,limitDirty:l,editLimit:$e,saveLimits:C,expandedServers:d,toolQueries:u,toolErrors:h,toolsLoading:m,editorOpen:v,editorMode:E,editingName:R,editingServer:y,form:g,formError:b,saving:w,editorGroups:I,configuredHeaderKeys:q,configuredEnvKeys:W,savedHttpEndpoint:D,endpointRequired:O,endpointFieldLabel:L,endpointPlaceholder:te,refreshAll:Q,busy:oe,serverState:fe,stateLabel:ue,transportLabel:G,protocolLabel:ce,toolSummary:me,formatAge:Hk,setMasterEnabled:M,togglePending:ve,toggleServerEnabled:be,reconnect:j,refreshTools:de,removeServer:F,toggleTools:Z,filteredTools:B,setToolQuery:Y,openAdd:ee,openEdit:pe,closeEditor:he,jumpToEditorGroup:xe,addSecretRow:Oe,removeSecretRow:ge,toggleSecretRemoval:He,saveServer:Ue}}};function zk(e,t){if(!e||!t)return gp(e);const s=gp(e),a=t.trim().split(/\s+/).filter(Boolean);if(!a.length)return s;const n=a.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${n})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Vk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),h=f(!1),m=f(null),v=f(null);let E=null;const R=f(null),y=f(!1),g=f({}),b=f({}),w=f({}),_=f({}),T=new Map,k=f(null),x=z(()=>e.value.reduce((U,Q)=>U+(Q.chunks||0),0)),I=z(()=>new Set(e.value.map(Q=>Q.uploader).filter(Boolean)).size);function $(U,Q){const oe=b.value[Q];if(!oe||oe.length===0)return 0;const K=Math.max(...oe.map(fe=>fe.char_count||0));return K===0?0:Math.round(U.char_count/K*100)}async function S(){t.value=!0,s.value=null;try{const U=await H.get("/api/knowledge");e.value=Array.isArray(U)?U:[]}catch(U){s.value=U.message}t.value=!1}async function P(U){if(g.value[U]){g.value[U]=!1,k.value=null;return}if(g.value[U]=!0,Object.prototype.hasOwnProperty.call(b.value,U))return;if(T.has(U))return T.get(U);const Q={..._.value,[U]:!0};_.value=Q;const oe={...w.value};delete oe[U],w.value=oe;const K=H.get(`/api/knowledge/${encodeURIComponent(U)}/chunks`).then(fe=>{b.value={...b.value,[U]:Array.isArray(fe)?fe:[]}}).catch(fe=>{w.value={...w.value,[U]:fe.message||"load failed"}}).finally(()=>{if(T.get(U)!==K)return;T.delete(U);const fe={..._.value};delete fe[U],_.value=fe});return T.set(U,K),K}let q=0;async function W(){const U=a.value.trim();if(!U)return;const Q=++q;i.value=!0,o.value=null,l.value=U;try{const oe=await H.get(`/api/knowledge/search?q=${encodeURIComponent(U)}`);if(Q!==q)return;n.value=Array.isArray(oe)?oe:[]}catch(oe){if(Q!==q)return;n.value=[],o.value=oe.message||"Search failed"}Q===q&&(i.value=!1)}function D(){q+=1,i.value=!1,n.value=null,a.value="",o.value=null}async function O(){u.value=null,p.value=null;const U=c.value.trim(),Q=d.value.trim();if(!U){u.value="Source name is required";return}if(!Q){u.value="Content is required";return}h.value=!0;try{const oe=await H.post("/api/knowledge",{source:U,content:Q});p.value=`Ingested ${oe.chunks||0} chunks from "${U}"`,c.value="",d.value="",b.value={},await S(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(oe){u.value=oe.message}h.value=!1}async function L(U){m.value=U,v.value=null,E&&(clearTimeout(E),E=null);try{const Q=await H.post(`/api/knowledge/${encodeURIComponent(U)}/reingest`);v.value={source:U,error:!1,message:`Re-ingested ${Q.chunks||0} chunks`},delete b.value[U],await S(),E=setTimeout(()=>{v.value=null,E=null},3e3)}catch(Q){v.value={source:U,error:!0,message:Q.message}}m.value=null}function te(U){R.value=U}async function ie(){if(R.value){y.value=!0;try{await H.del(`/api/knowledge/${encodeURIComponent(R.value)}`),delete b.value[R.value],await S()}catch(U){we.error(`Failed to delete source: ${U.message||"unknown error"}`)}y.value=!1,R.value=null}}return Ge(()=>{S()}),{sources:e,loading:t,error:s,searchQuery:a,searchResults:n,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:h,reingesting:m,reingestResult:v,deleteTarget:R,deleting:y,expanded:g,sourceChunks:b,chunkErrors:w,loadingChunks:_,selectedChunk:k,totalChunks:x,uploaderCount:I,truncate:Dd,formatTs:In,highlightTerms:zk,chunkBarWidth:$,fetchSources:S,toggleSource:P,doSearch:W,clearSearch:D,doIngest:O,doReingest:L,confirmDelete:te,doDelete:ie}}},qk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),a=f(null),n=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),h=f(""),m=f(!1),v=f(null),E=f(null),R=f(new Set),y=f(null),g=f(!1),b=f(!1),w=z(()=>e.value.reduce((Q,oe)=>Q+oe.count,0)),_=z(()=>R.value.size);function T(Q){const oe=t.value[Q];if(!oe)return[];if(!l.value.trim())return oe;const K=l.value.trim().toLowerCase();return oe.filter(fe=>fe.key.toLowerCase().includes(K)||fe.value&&fe.value.toLowerCase().includes(K))}function k(Q,oe){return R.value.has(Q+"/"+oe)}function x(Q,oe){const K=Q+"/"+oe,fe=new Set(R.value);fe.has(K)?fe.delete(K):fe.add(K),R.value=fe}function I(Q){const oe=t.value[Q];return!oe||oe.length===0?!1:oe.every(K=>R.value.has(Q+"/"+K.key))}function $(Q,oe){const K=t.value[Q];if(!K)return;const fe=new Set(R.value);for(const ue of K){const G=Q+"/"+ue.key;oe?fe.add(G):fe.delete(G)}R.value=fe}async function S(){s.value=!0,a.value=null;try{const Q=await H.get("/api/memory");e.value=Object.entries(Q).map(([oe,K])=>({name:oe,keys:K.keys||[],count:K.count||0}))}catch(Q){a.value=Q.message}s.value=!1}async function P(Q){if(n.value[Q]){n.value[Q]=!1;return}n.value[Q]=!0;const oe=e.value.find(fe=>fe.name===Q);if(!oe||t.value[Q]||i.value===Q)return;i.value=Q;let K;try{const ue=(await H.get(`/api/memory/${encodeURIComponent(Q)}`)).entries||{};K=oe.keys.map(G=>Object.prototype.hasOwnProperty.call(ue,G)?{key:G,value:ue[G]||"",failed:!1}:{key:G,value:"",failed:!0,error:"Not found in scope"})}catch(fe){K=oe.keys.map(ue=>({key:ue,value:"",failed:!0,error:fe.message||"Failed to load"}))}t.value[Q]=K,i.value=null}function q(Q,oe,K){p.value=Q+"/"+oe,h.value=K}async function W(Q,oe){m.value=!0,v.value=null;try{await H.put(`/api/memory/${encodeURIComponent(Q)}/${encodeURIComponent(oe)}`,{value:h.value});const K=t.value[Q];if(K){const fe=K.find(ue=>ue.key===oe);fe&&(fe.value=h.value)}p.value=null}catch(K){v.value=`Failed to save: ${K.message||"unknown error"}`}m.value=!1}async function D(Q,oe){try{await navigator.clipboard.writeText(oe.value),E.value=Q+"/"+oe.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function O(){d.value=null,u.value=null;const Q=r.value.scope.trim(),oe=r.value.key.trim(),K=r.value.value.trim();if(!Q){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!K){d.value="Value is required";return}c.value=!0;try{await H.put(`/api/memory/${encodeURIComponent(Q)}/${encodeURIComponent(oe)}`,{value:K}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await S(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(fe){d.value=fe.message}c.value=!1}function L(Q,oe){y.value={scope:Q,key:oe}}async function te(){if(!y.value)return;g.value=!0,v.value=null;const{scope:Q,key:oe}=y.value;try{await H.del(`/api/memory/${encodeURIComponent(Q)}/${encodeURIComponent(oe)}`);const K=t.value[Q];K&&(t.value[Q]=K.filter(G=>G.key!==oe));const fe=e.value.find(G=>G.name===Q);fe&&(fe.count--,fe.keys=fe.keys.filter(G=>G!==oe));const ue=new Set(R.value);ue.delete(Q+"/"+oe),R.value=ue}catch(K){v.value=`Failed to delete: ${K.message||"unknown error"}`}g.value=!1,y.value=null}function ie(){b.value=!0}async function U(){g.value=!0,v.value=null;const Q=[];for(const oe of R.value){const K=oe.indexOf("/");Q.push({scope:oe.slice(0,K),key:oe.slice(K+1)})}try{await H.post("/api/memory/bulk-delete",{entries:Q}),R.value=new Set,t.value={},await S()}catch(oe){v.value=`Bulk delete failed: ${oe.message||"unknown error"}`}g.value=!1,b.value=!1}return Ge(()=>{S()}),{scopes:e,scopeEntries:t,loading:s,error:a,expanded:n,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:h,saving:m,actionError:v,copied:E,selected:R,selectedCount:_,totalEntries:w,deleteTarget:y,deleting:g,showBulkDelete:b,fetchMemory:S,toggleScope:P,startEdit:q,doEdit:W,copyValue:D,doAdd:O,confirmDelete:L,doDelete:te,confirmBulkDelete:ie,doBulkDelete:U,isSelected:k,toggleSelect:x,isScopeAllSelected:I,toggleSelectAll:$,filteredEntries:T}}},Gk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=f([]),t=f(null),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=z(()=>[...new Set(e.value.map(E=>E.category))].sort()),r=z(()=>{const v={};return e.value.forEach(E=>{v[E.category]=(v[E.category]||0)+1}),v}),c=z(()=>n.value?e.value.filter(v=>v.category===n.value):e.value);function d(v){return v==="correction"?"badge-warning":v==="operational"?"badge-info":v==="preference"?"badge-success":"badge-info"}function u(v){i.value=v.key,l.value=v.content}async function p(v){try{await H.put("/api/learned/"+encodeURIComponent(v),{content:l.value}),i.value=null,we.success("Entry updated"),await m()}catch(E){we.error(E.message||"Failed to save entry")}}async function h(v){if(await Kt({title:"Delete learned entry",message:`Delete "${v}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/learned/"+encodeURIComponent(v)),we.success("Entry deleted"),await m()}catch(R){we.error(R.message||"Failed to delete entry")}}async function m(){s.value=!0,a.value=null;try{const v=await H.get("/api/learned");e.value=v.entries||[],t.value={last_reflection:v.last_reflection,count:v.count}}catch(v){a.value=v.message}s.value=!1}return Ge(m),{entries:e,meta:t,loading:s,error:a,filterCat:n,editing:i,editContent:l,categories:o,catCounts:r,filtered:c,catBadge:d,formatTs:In,startEdit:u,saveEdit:p,deleteEntry:h,fetchEntries:m}}},vv=[{id:"tools",label:"Tools",component:Ek},{id:"skills",label:"Skills",component:Ik},{id:"mcp-servers",label:"MCP Servers",component:jk},{id:"knowledge",label:"Knowledge",component:Vk},{id:"memory",label:"Memory",component:qk},{id:"learned",label:"Learned",component:Gk}],Kk={components:{TabbedPage:rr},setup(){return{tabs:vv}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Wk={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Jk={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},Zk={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},Yk={template:`
...
`);const Te=new Blob([ne],{type:"text/plain"}),Fe=URL.createObjectURL(Te),et=document.createElement("a");et.href=Fe,et.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,et.click(),URL.revokeObjectURL(Fe)}function B(ne){const Te=Sp(ne);navigator.clipboard.writeText(Te).then(()=>{m.value=ne.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function Y(ne){l.value=l.value===ne?"":ne,g.value="all"}function ee(ne){return ne.level==="ERROR"?"log-line-error":ne.level==="WARNING"?"log-line-warning":"text-gray-300"}function pe(ne){return ne==="ERROR"?"text-red-500 font-semibold":ne==="WARNING"?"text-yellow-500":"text-blue-500"}function he(ne){return ne==="ERROR"?"log-chip-error":ne==="WARNING"?"log-chip-warning":"log-chip-info"}function xe(ne){g.value=ne.id;const Te=ne.filters;l.value=Te.level||"",b.value=Te.timeRange||"",o.value=Te.text||"",Te.levels&&(l.value=Te.levels[0]||""),Te.hasToolName&&(o.value="")}function Oe(ne){g.value=ne.id,l.value=ne.filters.level||"",b.value=ne.filters.timeRange||"",o.value=ne.filters.text||""}function ge(){if(!T.value.trim())return;const ne={id:"custom-"+Date.now(),name:T.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};w.value=[...w.value,ne],I(),_.value=!1,T.value=""}function He(ne){w.value=w.value.filter(Te=>Te.id!==ne),I(),g.value===ne&&(g.value="all")}const Ue=f("all"),je=f(""),Qe=f(""),ot=f(""),nt=f(""),X=f(""),_e=f(100),Ae=cS,Le=f(!1),se=f(!1),Ee=f(""),Ne=f([]),Je=f(null),Lt=f(null);function Ke(){e.value="search",Je.value||Ut()}async function Ut(){try{Je.value=await H.get("/api/logs/stats")}catch{}}function Bt(){const ne=X.value;if(!ne){ot.value="",nt.value="";return}const Fe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[ne];if(Fe){const et=new Date(Date.now()-Fe*1e3);ot.value=hs(et),nt.value=""}}function hs(ne){const Te=Fe=>String(Fe).padStart(2,"0");return`${ne.getFullYear()}-${Te(ne.getMonth()+1)}-${Te(ne.getDate())}T${Te(ne.getHours())}:${Te(ne.getMinutes())}`}function Ys(ne){if(!ne)return"";const Te=new Date(ne);return isNaN(Te.getTime())?"":Te.toISOString()}async function Os(){Le.value=!0,Ee.value="",se.value=!0,Lt.value=null;try{const ne=new URLSearchParams;Ue.value&&Ue.value!=="all"&&ne.set("level",Ue.value),je.value&&ne.set("tool",je.value),Qe.value&&ne.set("q",Qe.value);const Te=Ys(ot.value),Fe=Ys(nt.value);Te&&ne.set("start",Te),Fe&&ne.set("end",Fe),ne.set("limit",String(_e.value));const et=await H.get(`/api/logs/search?${ne.toString()}`);Ne.value=et.entries||[]}catch(ne){Ee.value=ne.message||"Search failed",Ne.value=[]}finally{Le.value=!1}}function nn(){Ue.value="all",je.value="",Qe.value="",ot.value="",nt.value="",X.value="",_e.value=100,Ne.value=[],se.value=!1,Ee.value="",Lt.value=null}function Qs(ne){Lt.value=Lt.value===ne?null:ne}function js(ne){if(!ne.timestamp)return"";try{return new Date(ne.timestamp).toLocaleString()}catch{return ne.timestamp}}function Ha(ne){return ne.type==="web_action"?`${ne.status||""} (${ne.execution_time_ms||0}ms)`:(ne.result_summary||"").slice(0,200)}function ws(ne){return ne.error?"log-line-error":"text-gray-300"}function fa(ne){try{return JSON.stringify(ne,null,2)}catch{return String(ne)}}let Ls=null,at=!1;function Ns(){at||(at=!0,st.subscribe("logs",K),c.value=st.connected,d.value=st.state||"disconnected",Ls=st.onState(ne=>{d.value=ne,c.value=ne==="connected"}))}function ks(){at&&(at=!1,st.unsubscribe("logs",K),Ls&&(Ls(),Ls=null))}return Ge(()=>{x(),window.addEventListener("pointerup",j),window.addEventListener("pointercancel",j)}),Xt(Ns),Vt(ks),ft(()=>{ks(),window.removeEventListener("pointerup",j),window.removeEventListener("pointercancel",j)}),{mode:e,logs:t,paused:n,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:a,groupedLogs:oe,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:Q,pauseBuffer:k,showJumpBottom:h,copiedIndex:m,regexError:P,levels:E,logPresets:R,timeRanges:y,timeRange:b,activeLogPreset:g,customLogPresets:w,showSaveLogPreset:_,newLogPresetName:T,hasActiveLogFilters:$,timeRangeLabel:S,timelineBuckets:W,timelineMax:D,timelineSpanLabel:O,timelineLabelSkip:L,togglePause:F,clearLogs:Z,exportLogs:re,logLineClass:ee,levelClass:pe,levelChipClass:he,toggleLevel:Y,copyLine:B,jumpToBottom:G,onScroll:me,onUserScrollIntent:be,onUserScrollKey:$e,onAutoScrollToggle:de,onPointerDown:M,applyLogPreset:xe,applyCustomLogPreset:Oe,saveLogCustomPreset:ge,removeLogCustomPreset:He,segmentHeight:ie,jumpToTimelineBucket:U,searchLevel:Ue,searchTool:je,searchKeyword:Qe,searchStart:ot,searchEnd:nt,searchTimePreset:X,searchLimit:_e,searchLimits:Ae,searching:Le,searchRan:se,searchError:Ee,searchResults:Ne,searchStats:Je,expandedSearch:Lt,switchToSearch:Ke,runSearch:Os,clearSearchFilters:nn,toggleSearchExpand:Qs,formatSearchTs:js,searchEntryText:Ha,searchLogLineClass:ws,formatJson:fa,applySearchTimePreset:Bt}}};function Vl(e=[]){const t=[],s=new Set;function a(n){const i=[n.kind,n.label,n.apply_mode||"",n.code||"",n.text||""].join("\0");s.has(i)||(s.add(i),t.push({...n,key:i}))}for(const n of e)for(const i of(n==null?void 0:n.consumers)||[])a({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const n of e)n!=null&&n.apply_handler&&a({kind:"handler",label:"Apply handler",code:n.apply_handler});for(const n of e)n!=null&&n.restart_reason&&a({kind:"restart",label:"Why a restart is required",text:n.restart_reason});for(const n of e)n!=null&&n.activation_policy&&a({kind:"activation",label:"Activation policy",text:n.activation_policy});return t}const uS=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function pS(e,t={}){var n,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),a=Object.hasOwn(t,"fallback")?t.fallback:(n=globalThis.document)==null?void 0:n.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return a&&a.scrollHeight>a.clientHeight?a:e||a||null}const ni=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],fS={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},ql=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord","computer"]),hS=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Cp(e){return hS.some(t=>e===t||e.startsWith(`${t}.`))}const bv="odin_config_center_expanded_v1",yv="odin_config_center_category_v1",mS=50,vS=650,Ai=()=>H.get("/api/config/meta");function pn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Wn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Un(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function gS(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function bS(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function xv(e,t){if(Wn(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return pn(t);const a={};for(const[n,i]of Object.entries(t)){const l=xv(e[n],i);l!==void 0&&(a[n]=l)}return Object.keys(a).length?a:void 0}function yS(e,t){const s={};for(const[a,n]of Object.entries(t||{})){const i=xv(e==null?void 0:e[a],n);i!==void 0&&(s[a]=i)}return s}function _v(e,t,s,a){if(Wn(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)_v(e[l],t[l],s?`${s}.${l}`:l,a);return}a.push({path:s,oldVal:e,newVal:t})}function xS(){try{const e=JSON.parse(localStorage.getItem(bv)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function _S(){try{const e=localStorage.getItem(yv);return ni.some(t=>t.key===e)?e:ni[0].key}catch{return ni[0].key}}const wS={template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),a=f(!1),n=f(0),i=f(null),l=z(()=>new Set((e.excludedIds||[]).map(String))),o=z(()=>{const w=s.value.toLowerCase().trim();return(e.members||[]).filter(_=>l.value.has(String(_.id))?!1:w?u(_).toLowerCase().includes(w)||String(_.username||"").toLowerCase().includes(w)||String(_.id).includes(w):!0)}),r=z(()=>{const w=s.value.trim();return o.value.length===0&&kS.test(w)&&!l.value.has(w)?w:""}),c=z(()=>o.value.length+(r.value?1:0)),d=z(()=>{if(a.value){if(o.value[n.value])return`${e.optionsId}-${n.value}`;if(r.value&&n.value===o.value.length)return`${e.optionsId}-raw`}});function u(w){return wv(w)}function p(){a.value=!0,n.value=0}function h(){p()}function m(){const w=Math.max(c.value-1,0);n.value=Math.min(n.value+1,w)}function v(){n.value=Math.max(n.value-1,0)}function E(){const w=o.value[n.value];w?R(w):r.value&&n.value===o.value.length&&y(r.value)}function R(w){y(String(w.id))}function y(w){t("select",w),s.value="",a.value=!1,n.value=0}function g(){a.value=!1}function b(){setTimeout(g,150)}return Ge(()=>{e.autofocus&&It(()=>{var w;return(w=i.value)==null?void 0:w.focus()})}),{query:s,open:a,highlightedIndex:n,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:h,highlightNext:m,highlightPrevious:v,selectHighlighted:E,selectMember:R,selectId:y,closeOptions:g,onBlur:b}}};function Ep(e,t,s){var a;return((a=e==null?void 0:e.config)==null?void 0:a[t])!=null?e.config[t]:s==null?void 0:s[t]}const SS={components:{DiscordUserCombobox:kv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f({persisted:!1,active:{state:"unknown"}}),s=f(""),a=f(!1),n=f(null);let i=null;const l=f(!0),o=f(null),r=f({}),c=f(null),d=f(null),u=f(!1),p=f(null),h=f({}),m=f([]);let v=0;const E=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),R=z(()=>JSON.stringify(c.value)!==JSON.stringify(d.value)),y=z(()=>new Map(m.value.map(ue=>[String(ue.id),ue])));function g(ue){return ue.config&&ue.config.enabled!==void 0?ue.config.enabled:!0}function b(ue){return Ep(ue,"require_mention",c.value)}function w(ue){return Ep(ue,"respond_to_bots",c.value)}function _(ue){return ue.config&&Object.keys(ue.config).length>0}function T(ue){r.value[ue]=!r.value[ue]}function k(ue){const G=ue.discord||{};return{allowed_users:[...G.allowed_users||[]],channels:[...G.channels||[]],respond_to_bots:!!G.respond_to_bots,require_mention:!!G.require_mention,ignore_bot_ids:[...G.ignore_bot_ids||[]]}}async function x({showLoading:ue=!0}={}){const G=++v;ue&&(l.value=!0),o.value=null;try{const ce=await H.get("/api/discord/guilds");G===v&&(e.value=ce)}catch(ce){G===v&&(o.value=ce.message)}finally{ue&&G===v&&(l.value=!1)}}async function I(){try{t.value=await H.get("/api/discord/connection"),n.value=null}catch(ue){n.value=ue.message}}async function $(ue,G=null){if(!a.value){a.value=!0,n.value=null;try{const ce={operation:ue};G!==null&&(ce.token=G),t.value=await H.post("/api/discord/connection",ce),ue==="credentials"&&(s.value="")}catch(ce){n.value=ce.message||"Connection update failed."}finally{a.value=!1}}}function S(){return $("credentials",s.value)}function P(){return $("connect")}function q(){return $("detach")}async function W(){l.value=!0,o.value=null;try{const[ue,G,ce]=await Promise.all([H.get("/api/discord/guilds"),H.get("/api/discord/members").catch(()=>[]),H.get("/api/config")]),me=k(ce),ve=R.value;c.value=me,ve||(d.value=JSON.parse(JSON.stringify(me))),m.value=G,e.value=ue,p.value=null}catch(ue){o.value=ue.message}finally{l.value=!1}}let D=Promise.resolve();const O=f(new Set);function L(ue,G){const ce=new Set(O.value);ce.add(ue),O.value=ce;const me=D.then(G);return D=me.catch(()=>{}),me.finally(()=>{const ve=new Set(O.value);ve.delete(ue),O.value=ve})}function te(ue,G,ce,me){const ve=(me==null?void 0:me.target)??null;return L(`guild:${ue}:${G}`,async()=>{try{await H.put("/api/discord/guild/"+ue+"/config",{[G]:ce}),await x({showLoading:!1})}catch(be){o.value=be.message,ve&&typeof ce=="boolean"&&(ve.checked=!ce)}})}function ie(ue,G,ce,me,ve){const be=(ve==null?void 0:ve.target)??null;return L(`channel:${ue}:${ce}`,async()=>{try{await H.put("/api/discord/channel/"+ue+"/config",{[ce]:me}),await x({showLoading:!1})}catch($e){o.value=$e.message,be&&typeof me=="boolean"&&(be.checked=!me)}})}function U(ue,G){return L(`channel:${ue}:clear`,async()=>{try{await H.put("/api/discord/channel/"+ue+"/config",{clear:!0}),await x({showLoading:!1})}catch(ce){o.value=ce.message}})}function Q(ue,G){const ce=String(G);if(!ue.userAutocomplete)return ce;const me=y.value.get(ce);return me?wv(me):ce}function oe(ue,G=null){const ce=String(G??h.value[ue]??"").trim();!ce||d.value[ue].includes(ce)||(d.value[ue]=[...d.value[ue],ce],h.value={...h.value,[ue]:""})}function K(ue,G){d.value[ue]=d.value[ue].filter(ce=>ce!==G)}async function fe(){if(!(!R.value||u.value)){u.value=!0,p.value=null;try{const G=(await H.put("/api/config",{discord:d.value})).discord||d.value;c.value={allowed_users:[...G.allowed_users||[]],channels:[...G.channels||[]],respond_to_bots:!!G.respond_to_bots,require_mention:!!G.require_mention,ignore_bot_ids:[...G.ignore_bot_ids||[]]},d.value=JSON.parse(JSON.stringify(c.value))}catch(ue){p.value=ue.message||"Global defaults could not be saved."}finally{u.value=!1}}}return Ge(()=>{W(),I(),i=window.setInterval(I,5e3)}),ft(()=>{i!==null&&window.clearInterval(i),i=null}),{guilds:e,loading:l,error:o,expanded:r,globalDraft:d,globalSaving:u,globalError:p,globalArrayInputs:h,globalMembers:m,globalListEditors:E,globalChanged:R,guildEnabled:g,guildMention:b,guildBots:w,hasOverride:_,toggleGuild:T,fetchAll:W,fetchGuilds:x,setGuildConfig:te,setChannelConfig:ie,clearOverride:U,mutationPending:O,globalItemLabel:Q,addGlobalItem:oe,removeGlobalItem:K,saveGlobalDefaults:fe,connection:t,connectionToken:s,connectionBusy:a,connectionError:n,saveDiscordCredentials:S,connectDiscord:P,detachDiscord:q}}},Ts=e=>e==null?e:JSON.parse(JSON.stringify(e));function TS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:a=()=>{},onDefaultRollback:n=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let h=null;const m=new Map;function v(_){d+=1;const T=c.then(_,_);return c=T.catch(()=>{}),T}function E(_,T){h=Ts(_),m.clear();for(const[k,x]of Object.entries(T||{}))m.set(k,Ts(x))}function R(_){const T=Ts(_),k=++u;return v(async()=>{try{await e(Ts(T)),h=Ts(T),k===u&&a(Ts(T))}catch(x){k===u&&(n(Ts(h)),r(x,{kind:"default"}))}})}function y(_,T){const k=Ts(T),x=(p.get(_)||0)+1;return p.set(_,x),v(async()=>{try{await t(_,Ts(k)),m.set(_,Ts(k)),x===p.get(_)&&i(_,Ts(k))}catch(I){x===p.get(_)&&(l(_,Ts(m.get(_)??null)),r(I,{kind:"user",uid:_}))}})}function g(_){const T=(p.get(_)||0)+1;return p.set(_,T),v(async()=>{try{await s(_),m.delete(_),T===p.get(_)&&o(_)}catch(k){T===p.get(_)&&(l(_,Ts(m.get(_)??null)),r(k,{kind:"delete",uid:_}))}})}async function b(){for(;;){const _=c;if(await _,_===c)return d}}async function w(_){for(;;){const T=await b(),k=await _();if(T===d)return k}}return{seed:E,saveDefault:R,saveUser:y,deleteUser:g,whenIdle:b,readSnapshot:w,get revision(){return d}}}const CS={components:{DiscordUserCombobox:kv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=z(()=>{const S={};for(const P of r.value)S[P.id]=P;return S});function d(S){return c.value[S]||null}function u(S,P){return S?S.allowed_hosts===null||S.allowed_hosts===void 0?{allowed_hosts:[...P],default_host:S.default_host||"",allow_all:!0}:{allowed_hosts:S.allowed_hosts,default_host:S.default_host||"",allow_all:!1}:{allowed_hosts:[...P],default_host:P[0]||"",allow_all:!0}}const p=TS({applyDefault:async S=>{const P=S.allow_all?null:S.allowed_hosts;await H.put("/api/host-access/default-policy",{allowed_hosts:P,default_host:S.default_host})},applyUser:async(S,P)=>{const q=P.allow_all?null:P.allowed_hosts;await H.put(`/api/host-access/user/${S}`,{allowed_hosts:q,default_host:P.default_host})},applyDelete:S=>H.del(`/api/host-access/user/${S}`),onDefaultConfirmed:()=>we.success("Default policy updated"),onDefaultRollback:S=>{S&&(i.value=S)},onUserConfirmed:S=>{const P=d(S);we.success(`Updated access for ${P?P.display_name:S}`)},onUserRollback:(S,P)=>{const q={...l.value};P?q[S]=P:delete q[S],l.value=q},onUserDeleted:S=>{const P={...l.value};delete P[S],l.value=P},onError:(S,P)=>{var W;const q=P.uid?` ${((W=d(P.uid))==null?void 0:W.display_name)||P.uid}`:"";we.error(`${S.message||"Failed to save"} — reverted${q}`)}});let h=0;async function m(){const S=++h;e.value=!0,t.value="";try{const P=await p.readSnapshot(()=>H.get("/api/host-access"));if(S!==h)return;s.value=P,a.value=P.available_hosts||[],n.value=P.host_descriptions||{},i.value=u(P.default_policy,a.value);const q=P.users||{},W={};for(const[D,O]of Object.entries(q))W[D]=u(O,a.value);l.value=W,p.seed(i.value,W)}catch(P){S===h&&(t.value=P.message||"Failed to fetch host access data")}finally{S===h&&(e.value=!1)}try{const P=await H.get("/api/discord/members")||[];S===h&&(r.value=P)}catch{S===h&&(r.value=[])}}const v=500,E=new Map;function R(S,P){const q=E.get(S);q&&clearTimeout(q.timer);const W={run:P,timer:null};W.timer=setTimeout(()=>{E.delete(S),P()},v),E.set(S,W)}function y(S){const P=E.get(S);P&&(clearTimeout(P.timer),E.delete(S))}function g(){for(const[S,P]of[...E])clearTimeout(P.timer),E.delete(S),P.run()}function b(){R("default",()=>p.saveDefault(i.value))}function w(S,P){i.value.allow_all=!1,P?i.value.allowed_hosts.includes(S)||i.value.allowed_hosts.push(S):(i.value.allowed_hosts=i.value.allowed_hosts.filter(q=>q!==S),i.value.default_host===S&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function _(S){R(`user:${S}`,()=>{const P=l.value[S];P&&p.saveUser(S,P)})}function T(S,P,q){const W=l.value[S];W&&(W.allow_all=!1,q?W.allowed_hosts.includes(P)||W.allowed_hosts.push(P):(W.allowed_hosts=W.allowed_hosts.filter(D=>D!==P),W.default_host===P&&(W.default_host=W.allowed_hosts[0]||"")),_(S))}function k(S,P){const q=l.value[S];q&&(q.default_host=P,_(S))}function x(){o.value=!0}function I(S){!/^\d{15,25}$/.test(S)||l.value[S]||(l.value[S]={allowed_hosts:[...a.value],default_host:a.value[0]||"",allow_all:!1},p.saveUser(S,l.value[S]),o.value=!1)}async function $(S){const P=d(S);await Kt({title:"Remove user override",message:`Remove the host access override for ${P?P.display_name:S}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(y(`user:${S}`),await p.deleteUser(S),l.value[S]||we.success(`Removed override for ${P?P.display_name:S}`))}return Ge(m),Vt(g),ft(g),{loading:e,error:t,data:s,availableHosts:a,hostDescriptions:n,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:b,toggleDefaultHost:w,getMember:d,toggleUserHost:T,setUserDefault:k,openAddUser:x,addUserById:I,deleteUser:$,flushPendingSaves:g}}},ES={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=f([]),t=f(!1),s=f(""),a=f([]),n=f(!1),i=f(!1),l=f(1),o=f(""),r=f(!1),c=f(null),d=f(""),u=f([]),p=f(!1),h=f(null),m=f(""),v=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),E=f(v()),R=z(()=>["127.0.0.1","localhost","::1"].includes(E.value.address));async function y(){t.value=!0,s.value="";try{const W=await H.get("/api/hosts");e.value=W.hosts||[],o.value=W.default_host||"",r.value=!!W.tofu_enabled}catch(W){s.value=W.message}finally{t.value=!1}}async function g(){try{await H.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),we.success("Host settings saved and published live"),await y()}catch(W){we.error(W.message)}}function b(){d.value="",u.value=[],p.value=!1,h.value=null,c.value=null,m.value="",l.value=1,n.value=!0}function w(){i.value=!1,E.value=v(),b()}function _(W){i.value=!0,E.value={...v(),...W},b()}async function T(){try{c.value=await H.get("/api/hosts/public-key")}catch(W){we.error(W.message)}}async function k(W){try{const D=await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/import-legacy",{});i.value=!0,E.value={...v(),...W,trust_mode:"pinned"},b(),d.value=D.candidate_token,u.value=D.fingerprints||[],m.value=u.value.join(`
`),l.value=4,we.info("Imported existing known_hosts trust. Test before activation.")}catch(D){we.error(D.message)}}async function x(){try{const W=m.value.split(/\s+/).filter(Boolean),D={...E.value,expected_fingerprints:W,candidate_fingerprints:u.value},O=await H.post("/api/hosts/candidates",D);if(d.value=O.candidate_token,u.value=O.fingerprints||[],E.value.trust_mode==="tofu"&&D.candidate_fingerprints.length===0){E.value.confirm_tofu=!1,we.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(W){we.error(W.message)}}async function I(){var W,D;p.value=!1,h.value=null;try{const O=await H.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!O.tested,h.value=O.last_test,p.value&&(l.value=5)}catch(O){const L=(W=O.data)==null?void 0:W.last_test;L&&typeof L=="object"&&!Array.isArray(L)&&(h.value=L);const te=(D=h.value)==null?void 0:D.detail;we.error(typeof te=="string"&&te.trim()?te:O.message)}}async function $(){try{await H.post("/api/hosts/candidates/"+d.value+"/commit",{}),we.success("Host saved and published live"),n.value=!1,await y()}catch(W){we.error(W.message)}}async function S(W){try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/enabled",{enabled:!W.enabled}),await y()}catch(D){we.error(D.message)}}async function P(W){var D;if(await Kt("Delete host "+W.alias+"? Dependencies will block deletion.")){a.value=[];try{await H.del("/api/hosts/"+encodeURIComponent(W.alias)),await y()}catch(O){a.value=Array.isArray((D=O.data)==null?void 0:D.pending_references)?O.data.pending_references:[],we.error(O.message)}}}async function q(W){if(await Kt("Force revoke "+W.alias+"? Remote outcomes may be unknown."))try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/force-revoke",{}),await y()}catch(D){we.error(D.message)}}return Ge(y),{hosts:e,loading:t,error:s,pendingReferences:a,wizard:n,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:E,isLocal:R,keyInfo:c,candidate:d,observed:u,tested:p,testResult:h,fingerprintsText:m,load:y,saveSettings:g,beginAdd:w,beginEdit:_,loadKey:T,importLegacy:k,prepare:x,testConnection:I,commit:$,toggle:S,remove:P,forceRevoke:q}}},AS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=z(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:a.value),p=z(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:a.value);function h(k){return k==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":k==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const k=await H.get("/api/tokens");s.value=k.tokens||[],a.value=k.available_hosts||[]}catch(k){t.value=k.message||"Failed to load tokens"}finally{e.value=!1}}function v(k){return!k||!k.trim()?[]:k.split(",").map(x=>x.trim()).filter(Boolean)}function E(k,x){const I=c.value.allowed_hosts;if(x&&!I.includes(k)&&I.push(k),!x){const $=I.indexOf(k);$>=0&&I.splice($,1)}}function R(k,x){const I=d.value.allowed_hosts;if(x&&!I.includes(k)&&I.push(k),!x){const $=I.indexOf(k);$>=0&&I.splice($,1)}}async function y(){var k;i.value=!0;try{const x=v(c.value.allowed_tools_str),I=c.value.host_mode,$=I==="none"?[]:I==="select"?c.value.allowed_hosts:null,S={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:x.length?x:[]};$!==null&&(S.allowed_hosts=$),S.default_host=c.value.default_host||"";const P=await H.post("/api/tokens",S);l.value=P.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},n.value=!1,we.success("Token created"),await m()}catch(x){we.error(((k=x.data)==null?void 0:k.error)||x.message||"Failed to create token")}finally{i.value=!1}}function g(k){o.value=k;const x=k.allowed_hosts;let I="default";x==null?I="default":Array.isArray(x)&&x.length===0?I="none":Array.isArray(x)&&(I="select"),d.value={username:k.username||"",tier:k.tier||"admin",label:k.label||"",host_mode:I,allowed_hosts:Array.isArray(x)?[...x]:[],default_host:k.default_host||"",allowed_tools_str:(k.allowed_tools||[]).join(", ")}}async function b(){var k;if(o.value){r.value=!0;try{const x=v(d.value.allowed_tools_str),I=d.value.host_mode,$={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:x};I==="none"?$.allowed_hosts=[]:I==="select"?$.allowed_hosts=d.value.allowed_hosts:$.allowed_hosts=null,$.default_host=d.value.default_host||"",await H.put("/api/tokens/"+encodeURIComponent(o.value.user_id),$),o.value=null,we.success("Token updated"),await m()}catch(x){we.error(((k=x.data)==null?void 0:k.error)||x.message||"Failed to update")}finally{r.value=!1}}}async function w(k){var I;if(await Kt({title:"Regenerate token",message:`Regenerate token for ${k.username||k.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const $=await H.post("/api/tokens/"+encodeURIComponent(k.user_id)+"/regenerate");l.value=$.token,we.success("Token regenerated")}catch($){we.error(((I=$.data)==null?void 0:I.error)||$.message||"Failed to regenerate")}}async function _(k){var I;if(await Kt({title:"Delete token",message:`Delete token for ${k.username||k.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/tokens/"+encodeURIComponent(k.user_id)),we.success("Token deleted"),await m()}catch($){we.error(((I=$.data)==null?void 0:I.error)||$.message||"Failed to delete")}}async function T(){if(l.value)try{await navigator.clipboard.writeText(l.value),we.success("Copied to clipboard")}catch{we.error("Copy failed — select and copy manually")}}return Ge(m),{loading:e,error:t,tokens:s,availableHosts:a,showCreate:n,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:h,toggleCreateHost:E,toggleEditHost:R,createToken:y,startEdit:g,saveEdit:b,confirmRegenerate:w,confirmDelete:_,copyToken:T}}},RS=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),IS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),OS=Object.freeze(["enabled","base_url","model","max_tokens"]),LS=Object.freeze(["enabled","model","max_tokens"]);function dr(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function Ap(e){return dr(e,RS)}function Rp(e){return dr(e,IS)}function NS(e,{includeApiKey:t=!1}={}){const s=dr(e,OS);return t&&(s.api_key=e.api_key),s}function DS(e){return{timeout:e.timeout}}function PS(e,{includeApiKey:t=!1}={}){const s=dr(e,LS);return t&&(s.api_key=e.api_key),s}function MS(e){return{timeout:e.timeout}}function Gl(e,t=500){let s=null;const a=(...n)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...n)},t)};return a.pending=()=>s!==null,a.cancel=()=>{s&&(clearTimeout(s),s=null)},a}const FS={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),a=f("codex"),n=f({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna"],l=z(()=>{const J=n.value.model;return J&&!i.includes(J)?[J,...i]:i}),o=z(()=>{const J=n.value.agent_model;return J&&J!=="auto"&&!i.includes(J)?[J,...i]:i}),r={"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},c=(J,ke)=>!!J&&!!ke&&(r[J]||[]).includes(ke),d=J=>!c(n.value.model,J)&&!(n.value.agent_reasoning_effort===""&&c(n.value.agent_model,J)),u=J=>{const ke=n.value.agent_model;return ke==="auto"?!0:!c(ke||n.value.model,J)},p=z(()=>{const J=n.value.agent_reasoning_effort;return J==="auto"?null:J||n.value.reasoning_effort}),h=J=>c(J,n.value.reasoning_effort)||n.value.agent_model===""&&c(J,p.value),m=J=>c(J,p.value),v=f({enabled:!1,model:"gpt-5.6-luna"}),E=f({unavailable_reason:null}),R=z(()=>{const J=v.value.model;return J&&!i.includes(J)?[J,...i]:i});function y(J){const ke=J.target.value;v.value.enabled=ke!=="",ke!==""&&(v.value.model=ke),ne()}const g=f(!1),b=f({codex:!1,ollama:!1,kimi:!1}),w=f(null),_=f(!1),T=f(""),k=f(null),x=f(!1);let I=0;const $=z(()=>{var J;return Object.entries(((J=w.value)==null?void 0:J.models)||{}).map(([ke,Ie])=>{var Vs,va,za;return{model:ke,floor:Ie.floor,override:Ie.override,effectiveBudget:(Vs=Ie.effective)==null?void 0:Vs.effective_budget,configuredPrimaryChars:(va=Ie.configured)==null?void 0:va.primary_chars,primaryChars:(za=Ie.effective)==null?void 0:za.primary_chars,provenance:Ie.provenance,clampExpiresAt:Ie.clamp_expires_at,densityPriorMilli:Ie.density_prior_milli,densityScope:Ie.density_scope,workloadCalibration:Ie.workload_calibration}})}),S=z(()=>{var J;return((J=w.value)==null?void 0:J.clamps)||[]}),P=z(()=>{var J,ke;return((ke=(J=w.value)==null?void 0:J.models)==null?void 0:ke[n.value.model])||null}),q=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),W=f({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),D=f(!1),O=f(!1),L=f(!1),te=f(!1),ie=f(!1),U=f(!1),Q=f(!1),oe=f({configured:null}),K=f(!1),fe=f([]),ue=f(""),G=f(!1),ce=f(!1),me=f({configured:null}),ve=f(!1),be=f([]),$e=f(""),C=f(!1),M=f(!1),j=f(!0),de=f(""),F=f({configured:null,accounts:[]}),Z=f(null),re=f(null),B=f(""),Y=f(null),ee=f(!1),pe=f(null),he=f(null),xe=f("");let Oe=null;function ge(J,ke="success"){we(J,ke==="error"?"error":"success")}function He(J){if(!J)return"?";const ke=J/(1024*1024*1024);return ke>=1?ke.toFixed(1)+" GB":(J/(1024*1024)).toFixed(0)+" MB"}function Ue(J){return Number.isFinite(Number(J))?Number(J).toLocaleString():"—"}function je(J){return J==null?"automatic (model-derived)":Number(J).toLocaleString()+" characters"}function Qe(J){const ke=new Date(J);return Number.isNaN(ke.getTime())?"unknown":ke.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function ot(J){return typeof J=="string"&&J.length>12?J.slice(0,8)+"…"+J.slice(-4):J}function nt(J){return typeof J!="number"||!Number.isFinite(J)?"—":(J/1e3).toFixed(2)}function X(J){return J==="temporary learned clamp"?"is-clamp":J==="override"?"is-override":"is-built-in"}function _e(J){const ke=n.value.context_budget_overrides[J.model];return J.floor!=null&&Number.isFinite(Number(ke))&&Number(ke)>J.floor}function Ae(J,ke){const Ie={...n.value.context_budget_overrides};ke.target.value===""?delete Ie[J]:Ie[J]=Number(ke.target.value),n.value.context_budget_overrides=Ie,x.value=!0}function Le(J){n.value.context_utilization=J.target.value===""?"":Number(J.target.value),x.value=!0}function se(J){const ke={...n.value.context_budget_overrides};delete ke[J],n.value.context_budget_overrides=ke,x.value=!0}async function Ee(){e.value=!0,await Promise.all([Ne(),Lt(),Os(),Ke(),Je()]),e.value=!1}async function Ne({preserveBasic:J=!1,preserveAdvanced:ke=!1}={}){try{const Ie=await H.get("/api/llm/status");t.value=Ie,s.value=!1,a.value=Ie.active_provider||"codex",Ie.codex&&!ks.pending()&&(J||(n.value.enabled=Ie.codex.enabled,n.value.model=Ie.codex.model||"gpt-5.6-sol",n.value.reasoning_effort=Ie.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=Ie.codex.agent_reasoning_effort||"",n.value.agent_model=Ie.codex.agent_model||""),ke||(n.value.request_timeout_seconds=Ie.codex.request_timeout_seconds??n.value.request_timeout_seconds,n.value.stream_stall_timeout_seconds=Ie.codex.stream_stall_timeout_seconds??n.value.stream_stall_timeout_seconds,n.value.retry={...n.value.retry,...Ie.codex.retry||{}},n.value.connection_pool={...n.value.connection_pool,...Ie.codex.connection_pool||{}},n.value.context_compression={...n.value.context_compression,...Ie.codex.context_compression||{}},!x.value&&!L.value&&(n.value.context_budget_overrides={...Ie.codex.context_budget_overrides||{}},n.value.context_utilization=Ie.codex.context_utilization??n.value.context_utilization))),Ie.ollama&&!Te.pending()&&(J||(q.value.enabled=Ie.ollama.enabled,q.value.base_url=Ie.ollama.base_url||"",q.value.model=Ie.ollama.model||"",q.value.max_tokens=Ie.ollama.max_tokens||4096),ke||(q.value.timeout=Ie.ollama.timeout??q.value.timeout)),Ie.kimi&&!Fe.pending()&&(J||(W.value.enabled=Ie.kimi.enabled,W.value.model=Ie.kimi.model||"",W.value.max_tokens=Ie.kimi.max_tokens||4096),ke||(W.value.timeout=Ie.kimi.timeout??W.value.timeout)),Ie.auxiliary&&(E.value=Ie.auxiliary,ne.pending()||(v.value.enabled=Ie.auxiliary.enabled,v.value.model=Ie.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function Je(){const J=++I;_.value=!0,T.value="";try{const ke=await H.get("/api/context/windows");if(J!==I)return;w.value=ke,!L.value&&!x.value&&(n.value.context_budget_overrides=Object.fromEntries(Object.entries(ke.models||{}).filter(([,Ie])=>Ie.override!=null).map(([Ie,Vs])=>[Ie,Vs.override])),n.value.context_utilization=ke.utilization??n.value.context_utilization)}catch(ke){J===I&&(T.value=ke.message||"Failed to load context budgets")}finally{J===I&&(_.value=!1)}}async function Lt(){try{if(oe.value=await H.get("/api/ollama/status"),K.value=!1,oe.value.model&&(ue.value=oe.value.model),oe.value.configured)try{const J=await H.get("/api/ollama/models");fe.value=J.models||[]}catch{fe.value=[]}else if(q.value.base_url)try{const J=await H.post("/api/ollama/probe-models",{base_url:q.value.base_url});fe.value=J.models||[]}catch{fe.value=[]}}catch{K.value=!0}}async function Ke(){j.value=!0,de.value="";try{F.value=await H.get("/api/codex/status")}catch(J){de.value=J.message||"Failed to fetch Codex status"}finally{j.value=!1}}async function Ut(){const J=t.value?t.value.active_provider:"codex";Q.value=!0;try{const ke=await H.post("/api/llm/switch",{provider:a.value});ke.error?(a.value=J,ge(ke.error,"error")):(ge("Switched to "+a.value+" ("+ke.model+")"),await Ee())}catch(ke){a.value=J,ge(ke.message||"Switch failed","error")}finally{Q.value=!1}}async function Bt(){G.value=!0;try{const J=await H.post("/api/ollama/reload");ge(J.configured?"Ollama reloaded":J.reason||"Ollama not configured",J.configured?"success":"error"),await Ee()}catch(J){ge(J.message||"Reload failed","error")}finally{G.value=!1}}async function hs(){ce.value=!0;try{await H.post("/api/ollama/model",{model:ue.value}),ge("Model set to "+ue.value),await Ee()}catch(J){ge(J.message||"Failed","error")}finally{ce.value=!1}}async function Ys(){const J=q.value.base_url;if(!J){ge("Enter a base URL first","error");return}U.value=!0;try{const ke=await H.post("/api/ollama/probe-models",{base_url:J});fe.value=ke.models||[],fe.value.length?(ge(fe.value.length+" model(s) found"),!q.value.model&&fe.value.length&&(q.value.model=fe.value[0].name)):ge("No models found at "+J,"error")}catch(ke){ge(ke.message||"Could not reach Ollama","error")}finally{U.value=!1}}async function Os(){try{if(me.value=await H.get("/api/kimi/status"),ve.value=!1,me.value.model&&($e.value=me.value.model),me.value.configured)try{const J=await H.get("/api/kimi/models");be.value=J.models||[]}catch{be.value=[]}}catch{ve.value=!0}}async function nn(){C.value=!0;try{const J=await H.post("/api/kimi/reload");ge(J.configured?"Kimi reloaded":J.reason||"Kimi not configured",J.configured?"success":"error"),await Ee()}catch(J){ge(J.message||"Reload failed","error")}finally{C.value=!1}}async function Qs(){M.value=!0;try{await H.post("/api/kimi/model",{model:$e.value}),ge("Model set to "+$e.value),await Ee()}catch(J){ge(J.message||"Failed","error")}finally{M.value=!1}}async function js(){if(L.value){ks();return}L.value=!0;const J=Ap(n.value);try{await H.put("/api/llm/codex/config",J),ge("Codex config saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Ke()])}catch(ke){ge(ke.message||"Failed","error");const Ie=JSON.stringify(Ap(n.value))!==JSON.stringify(J);await Promise.all([Ne({preserveBasic:Ie,preserveAdvanced:!0}),Ke()])}finally{L.value=!1}}async function Ha(){if(L.value)return;L.value=!0;const J=Rp(n.value);try{await H.put("/api/llm/codex/config",J),JSON.stringify({context_budget_overrides:n.value.context_budget_overrides,context_utilization:n.value.context_utilization})===JSON.stringify({context_budget_overrides:J.context_budget_overrides,context_utilization:J.context_utilization})&&(x.value=!1),ge("Codex advanced settings saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Ke(),Je()])}catch(ke){ge(ke.message||"Failed","error");const Ie=JSON.stringify(Rp(n.value))!==JSON.stringify(J);await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:Ie}),Ke(),Je()])}finally{L.value=!1}}async function ws(){if(te.value){Te();return}te.value=!0;try{const J=D.value?q.value.api_key:null,ke=NS(q.value,{includeApiKey:J!==null});await H.put("/api/llm/ollama/config",ke),ge("Ollama config saved"),J!==null&&q.value.api_key===J&&(q.value.api_key="",D.value=!1),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Lt()])}catch(J){ge(J.message||"Failed","error")}finally{te.value=!1}}async function fa(){if(!te.value){te.value=!0;try{await H.put("/api/llm/ollama/config",DS(q.value)),ge("Ollama timeout saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Lt()])}catch(J){ge(J.message||"Failed","error")}finally{te.value=!1}}}async function Ls(){if(ie.value){Fe();return}ie.value=!0;try{const J=O.value?W.value.api_key:null,ke=PS(W.value,{includeApiKey:J!==null});await H.put("/api/llm/kimi/config",ke),ge("Kimi config saved"),J!==null&&W.value.api_key===J&&(W.value.api_key="",O.value=!1),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Os()])}catch(J){ge(J.message||"Failed","error")}finally{ie.value=!1}}async function at(){if(!ie.value){ie.value=!0;try{await H.put("/api/llm/kimi/config",MS(W.value)),ge("Kimi timeout saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Os()])}catch(J){ge(J.message||"Failed","error")}finally{ie.value=!1}}}async function Ns(){if(g.value){ne();return}g.value=!0;try{await H.put("/api/llm/auxiliary/config",v.value),ge("Auxiliary config saved"),await Ne()}catch(J){ge(J.message||"Failed","error"),await Ne()}finally{g.value=!1}}const ks=Gl(js),ne=Gl(Ns),Te=Gl(ws),Fe=Gl(Ls),et=()=>(ks.cancel(),js()),dt=()=>(Te.cancel(),ws()),mt=()=>(Fe.cancel(),Ls()),ha=()=>Ha(),zs=()=>fa(),xi=()=>at();async function _i(J){const ke=J.account_key+":"+J.model;k.value=ke;try{const Ie=await H.post("/api/context/windows/clear",{account_key:J.account_key,model:J.model});ge(Ie.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Je()}catch(Ie){ge(Ie.message||"Failed to clear clamp","error"),await Je()}finally{k.value=null}}async function Ln(J){try{await H.post("/api/codex/account/"+J+"/activate"),ge("Active account switched"),await Ke()}catch(ke){ge(ke.message||"Failed","error")}}async function Nn(J){Z.value=J;try{await H.post("/api/codex/account/"+J+"/refresh"),ge("Token refreshed"),await Ke()}catch(ke){ge(ke.message||"Refresh failed","error")}finally{Z.value=null}}function ln(J,ke){re.value=J,B.value=ke||""}async function ja(J){try{await H.put("/api/codex/account/"+J+"/label",{label:B.value}),ge("Label updated"),re.value=null,await Ke()}catch(ke){ge(ke.message||"Failed","error")}}async function Xs(J,ke){if(await Kt({title:"Delete Codex account",message:`Delete ${ke||"account #"+(J+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/codex/account/"+J),ge("Deleted. Pool reloaded."),await Ke()}catch(Vs){ge(Vs.message||"Failed","error")}}async function ma(){ee.value=!0;try{const J=await H.post("/api/codex/device-code");pe.value=J,Y.value="pending",Ss(J)}catch(J){ge(J.message||"Failed","error")}finally{ee.value=!1}}async function Ss(J){Oe={cancelled:!1};const ke=Oe;try{const Ie=await H.post("/api/codex/device-poll",{device_auth_id:J.device_auth_id,user_code:J.user_code,interval:J.interval});if(ke.cancelled)return;he.value=Ie,Y.value="success",await Ee()}catch(Ie){if(ke.cancelled)return;xe.value=Ie.message||"Device login failed",Y.value="error"}}function Dn(){Oe&&(Oe.cancelled=!0),Y.value=null,pe.value=null}return Ge(Ee),ft(()=>{Oe&&(Oe.cancelled=!0),ks.cancel(),ne.cancel(),Te.cancel(),Fe.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:a,switching:Q,advancedOpen:b,codexForm:n,codexModelOptions:l,codexAgentModelOptions:o,mainEffortAllowed:d,agentEffortAllowed:u,mainModelOptionDisabled:h,agentModelOptionDisabled:m,auxForm:v,auxData:E,auxModelOptions:R,onAuxModelChange:y,savingAux:g,saveAuxConfigDebounced:ne,ollamaForm:q,kimiForm:W,savingCodex:L,savingOllama:te,savingKimi:ie,probingOllama:U,ollamaKeyDirty:D,kimiKeyDirty:O,fetchCodexStatus:Ke,ollamaStatus:oe,ollamaStatusLoadFailed:K,ollamaModels:fe,ollamaSelectedModel:ue,reloading:G,settingModel:ce,kimiStatus:me,kimiStatusLoadFailed:ve,kimiModels:be,kimiSelectedModel:$e,reloadingKimi:C,settingKimiModel:M,codexLoading:j,codexError:de,codexData:F,refreshing:Z,editingLabel:re,labelValue:B,contextWindows:w,contextWindowsLoading:_,contextWindowsError:T,contextBudgetRows:$,activeClampRows:S,activeContextBudget:P,clearingClamp:k,contextPolicyDirty:x,deviceState:Y,deviceLoading:ee,deviceInfo:pe,deviceResult:he,deviceError:xe,fetchAll:Ee,fetchLLMStatus:Ne,fetchOllamaStatus:Lt,fetchKimiStatus:Os,switchProvider:Ut,reloadOllama:Bt,setOllamaModel:hs,reloadKimi:nn,setKimiModel:Qs,probeOllamaModels:Ys,saveCodexConfig:js,saveOllamaConfig:ws,saveKimiConfig:Ls,saveCodexAdvancedConfig:Ha,saveOllamaAdvancedConfig:fa,saveKimiAdvancedConfig:at,saveCodexConfigDebounced:ks,saveOllamaConfigDebounced:Te,saveKimiConfigDebounced:Fe,saveCodexConfigNow:et,saveOllamaConfigNow:dt,saveKimiConfigNow:mt,saveCodexAdvancedConfigNow:ha,saveOllamaAdvancedConfigNow:zs,saveKimiAdvancedConfigNow:xi,activateAccount:Ln,refreshAccount:Nn,startEditLabel:ln,saveLabel:ja,deleteAccount:Xs,startDeviceLogin:ma,cancelDeviceLogin:Dn,formatSize:He,fetchContextWindows:Je,clearContextClamp:_i,setContextOverride:Ae,setContextUtilization:Le,resetContextOverride:se,overrideAboveFloor:_e,formatCount:Ue,formatContextCeiling:je,formatExpiry:Qe,shortAccountKey:ot,provenanceClass:X,formatDensity:nt}}},Ip={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function $S(e){return Ip[e]||Ip[(e||"").toLowerCase()]||"text-gray-400"}const US={template:`
  ...
  `},Lp=e=>JSON.parse(JSON.stringify(e)),VS=(e,t)=>JSON.stringify(e)===JSON.stringify(t),qS={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=f([]),a=f({}),n=f({}),i=f(!1),l=f(!1),o=f(!1),r=f(!1),c=f(!1),d=f(""),u=f("");let p=!1,h=0,m=null;const v=(D,O)=>p&&h===D&&H.token===O,E=D=>"computer-provisioning-"+D.key,R=D=>D===null?"Unset":D===""?"Empty":JSON.stringify(D),y=D=>{const O=n.value[D.key];return D.type==="array"?String(O||"").split(/\r?\n/).map(L=>L.trim()).filter(Boolean):["integer","number"].includes(D.type)?O===""||O==null?null:Number(O):O},g=z(()=>s.value.map(D=>({...D,value:y(D)})).filter(D=>!VS(D.value,a.value[D.key]))),b=z(()=>s.value.filter(D=>D.pending_restart).map(D=>D.label)),w=z(()=>s.value.some(D=>D.apply_state==="unknown")),_=z(()=>{const D={};for(const O of s.value){const L=y(O),te=O.constraints||{};["integer","number"].includes(O.type)&&(L===null&&!O.nullable?D[O.key]="A number is required.":L!==null&&(!Number.isFinite(L)||O.type==="integer"&&!Number.isInteger(L)||te.minimum!=null&&L<te.minimum||te.maximum!=null&&L>te.maximum)&&(D[O.key]="Enter a number within the allowed range.")),O.key==="monitor_names"&&(L.length>16||new Set(L).size!==L.length||L.some(ie=>!/^[A-Za-z0-9_.-]{1,64}$/.test(ie)))&&(D[O.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return D}),T=z(()=>Object.keys(_.value).length>0);function k(D,O){n.value[D.key]=O,u.value=""}function x(){n.value=Object.fromEntries(s.value.map(D=>[D.key,D.type==="array"?a.value[D.key].join(`
`):a.value[D.key]])),r.value=!1}async function I(D,O){const[L,te]=await Promise.all([H.get("/api/config"),H.get("/api/config/meta")]);if(!v(D,O))return!1;const ie=(te.fields||[]).filter(U=>/^computer\.[^.]+$/.test(U.path)&&U.path!=="computer.enabled"&&U.sensitivity==="public"&&U.apply_mode==="restart");if(!L.computer||!ie.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=ie.map(U=>({...U,key:U.path.split(".")[1]})),a.value=Object.fromEntries(s.value.map(U=>[U.key,Lp(L.computer[U.key])])),x(),m=O,i.value=!0,c.value=!1,!0}async function $(){if(!p||l.value||o.value)return;const D=++h,O=H.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await I(D,O)}catch(L){v(D,O)&&(c.value=!0,d.value=L.message||"Could not load provisioning. No changes were sent.")}finally{v(D,O)&&(l.value=!1)}}function S(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!T.value&&(r.value=!0)}async function P(){if(!p||!i.value||!r.value||o.value||l.value||c.value||T.value||!g.value.length)return;if(m!==H.token){W(),q();return}const D={computer:Object.fromEntries(g.value.map(ie=>[ie.key,Lp(ie.value)]))},O=h,L=H.token;o.value=!0,d.value="",u.value="";let te=!1;try{if(await H.put("/api/config",D),te=!0,!v(O,L))return;await I(O,L)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(ie){v(O,L)&&(c.value=!0,r.value=!1,d.value=te?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${ie.status===400?": "+ie.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{v(O,L)&&(o.value=!1)}}function q(){p||(p=!0,$())}function W(){p=!1,h++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,m=null,s.value=[],a.value={},n.value={},d.value="",u.value=""}return Ge(q),Xt(q),Vt(W),ft(W),{fields:s,original:a,draft:n,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:b,effectiveUnknown:w,changes:g,validation:_,invalid:T,fieldId:E,format:R,edit:k,discard:x,load:$,openReview:S,save:P}}},GS={components:{ComputerProvisioning:qS},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),a=f(!1),n=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(0),p=f(""),h=f(""),m=f(null),v=f(""),E=f(!1),R=f(Date.now()),y=f(""),g=f(null);let b=0,w=null,_=!1,T=H.token,k=0,x=null,I=null,$=!1;const S=B=>B===!0?"Enabled":B===!1?"Disabled":"Unknown",P=z(()=>{var B;return((B=e.value.backend)==null?void 0:B.environment)==="existing_session"}),q=z(()=>{var Y;const B=Date.parse(((Y=e.value.accessibility)==null?void 0:Y.checked_at)||"");return c.value&&Number.isFinite(B)&&R.value-B<15e3&&R.value>=B-5e3}),W=z(()=>{var B;return q.value?S((B=e.value.accessibility)==null?void 0:B.enabled):"Unknown / not current"}),D=z(()=>{var B;return q.value?((B=e.value.accessibility)==null?void 0:B.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),O=z(()=>Object.entries(e.value.input_limits||{}).filter(([,B])=>typeof B=="number"&&Number.isFinite(B)).map(([B,Y])=>`${B}: ${Y}`).join(", ")),L=z(()=>{var Y;const B=(Y=e.value.application_provenance)==null?void 0:Y.script_identity;return typeof B=="string"?B:!B||typeof B!="object"?"Not observed":`${B.interpreter_basename||"Unknown interpreter"}; argv digest ${B.argv_digest||"not recorded"}; ${B.verified===!0?"verified":"not verified"}`}),te=z(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(B=>B&&typeof B.id=="string"&&typeof B.label=="string"&&["supported","capture_only"].includes(B.input)).slice(0,16):[]),ie=z(()=>{const B=e.value.restart_required;return Array.isArray(B)?B.length?B.join(", "):"None reported":B===!0?"Pending; restart required":B===!1?"None reported":"Unknown"}),U=z(()=>{var Y,ee;const B=Date.parse(((Y=m.value)==null?void 0:Y.captured_at)||"");return Number.isFinite(B)&&R.value<B+Math.min(1e4,((ee=m.value)==null?void 0:ee.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function Q(){v.value&&URL.revokeObjectURL(v.value),v.value="",m.value=null}function oe(){b++,Q(),g.value=null,c.value=!1,x==null||x.abort(),x=null,t.value=!1,h.value="",s.value=!1,i.value=!1,l.value=!1}function K(B,Y){return _&&B===b&&Y===H.token}function fe(){return _&&c.value&&I===H.token&&Date.now()-u.value<15e3}function ue(B,Y="mutation"){var pe,he;oe(),$=!0,p.value="";const ee=B.status||(B.name==="AuthError"?401:0);[401,403,404].includes(ee)?(u.value=0,I=null,e.value={available:!1,state:"unknown"}):u.value||(e.value={available:!1,state:ee===503?"unavailable":"unknown"}),o.value=ee===401||ee===403||ee===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":ee===410?"Evidence or artifact expired. Observe or prepare the export again.":Y==="read"?"Status refresh failed. Last-known details are not current. No mutation was requested by this read.":Y==="acknowledged"?"The mutation was acknowledged, but status refresh failed. Refresh status independently; do not replay the change.":"Request failed; outcome unknown. Refresh status. No action was replayed.",Y==="mutation"&&![401,403,404].includes(ee)&&typeof((pe=B.data)==null?void 0:pe.code)=="string"&&/^[a-z_]{1,64}$/.test(B.data.code)&&typeof((he=B.data)==null?void 0:he.error)=="string"&&(o.value=B.data.error.slice(0,512),B.data.outcome==="not_applied"&&B.data.next_action==="repair_provisioning"&&typeof B.data.remedy=="string"&&(o.value="Not applied (preflight rejection). "+o.value,p.value=B.data.remedy.slice(0,1024)))}async function G(){if(t.value||r.value||a.value||n.value||d.value||!_)return;const B=b,Y=H.token;t.value=!0,k=Date.now();const ee=new AbortController;x=ee;try{const pe=await H.get("/api/computer",{signal:ee.signal});if(!K(B,Y))return;ce(pe)}catch(pe){K(B,Y)&&ue(pe,"read")}finally{x===ee&&(x=null,t.value=!1)}}function ce(B,Y=""){if(!B||typeof B!="object"||typeof B.state!="string"||typeof B.available!="boolean")throw new Error("Invalid status");(e.value.session_id&&e.value.session_id!==B.session_id||e.value.generation!=null&&e.value.generation!==B.generation||e.value.session_generation!=null&&e.value.session_generation!==B.session_generation)&&oe(),e.value=B,u.value=Date.now(),I=H.token,c.value=!(r.value&&Y!=="toggle")&&!(a.value&&Y!=="stop")&&!(n.value&&Y!=="pause")&&!(d.value&&Y!=="recovery"),o.value="",p.value="",$=!c.value}async function me(B){if(!fe()||r.value||a.value||n.value||d.value)return;oe();const Y=b,ee=H.token;r.value=!0;let pe=!1;try{if(await H.post("/api/computer/enabled",{enabled:B}),pe=!0,!K(Y,ee))return;const he=await H.get("/api/computer");K(Y,ee)&&ce(he,"toggle")}catch(he){K(Y,ee)&&ue(he,pe?"acknowledged":"mutation")}finally{r.value=!1}}async function ve(B){if(!_||!["pause","stop"].includes(B)||(B==="stop"?a.value:n.value))return;oe();const Y=b,ee=H.token,pe=B==="stop"?a:n;pe.value=!0;let he=!1;try{if(await H.post("/api/computer/"+B,{}),he=!0,K(Y,ee)){const xe=await H.get("/api/computer");K(Y,ee)&&ce(xe,B)}}catch(xe){K(Y,ee)&&ue(xe,he?"acknowledged":"mutation")}finally{pe.value=!1}}async function be(){var pe;if(!fe()||d.value||((pe=e.value.backend)==null?void 0:pe.native_backend)!=="hyprland")return;const B={session_id:e.value.session_id,generation:e.value.session_generation};if(!B.session_id||!Number.isInteger(B.generation))return;oe();const Y=b,ee=H.token;d.value=!0;try{const he=await H.post("/api/computer/release_owned_input",B);K(Y,ee)&&ce(he,"recovery")}catch(he){K(Y,ee)&&ue(he,"mutation")}finally{d.value=!1}}async function $e(){return M(!1)}async function C(){return M(!0)}async function M(B){var Oe;if(!fe()||d.value||r.value||a.value||n.value||e.value.state!=="quarantined")return;const Y={session_id:e.value.session_id,generation:e.value.session_generation};if(!Y.session_id||!Number.isInteger(Y.generation))return;if(B){if(h.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+Y.session_id)return;Y.acknowledgment=h.value}const ee=B?((Oe=e.value.recovery)==null?void 0:Oe.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";oe();const pe=b,he=H.token;d.value=!0;let xe=!1;try{const ge=await H.post("/api/computer/"+ee,Y);xe=!0,K(pe,he)&&ce(ge,"recovery")}catch(ge){K(pe,he)&&ue(ge,xe?"acknowledged":"mutation")}finally{d.value=!1}}async function j(){var ee;if(!fe()||s.value||!e.value.available)return;Q(),E.value=!1;const B=b,Y=H.token;s.value=!0;try{const pe=await H.post("/api/computer/observe",{});if(!K(B,Y))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((ee=pe.frame)==null?void 0:ee.evidence_id)||""))throw new Error("Invalid evidence");const he=await H.getBlob("/api/computer/evidence/"+pe.frame.evidence_id);if(!K(B,Y))return;if(!["image/png","image/jpeg"].includes(he.type)||he.size>2097152||!Number.isFinite(Date.parse(pe.frame.expires_at))||Date.parse(pe.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");m.value=pe.frame,v.value=URL.createObjectURL(he),o.value=""}catch(pe){K(B,Y)&&ue(pe)}finally{B===b&&(s.value=!1)}}async function de(){if(!fe()||i.value||!e.value.available)return;g.value=null;const B=b,Y=H.token;i.value=!0;try{const ee=await H.post("/api/computer/export",{name:y.value});K(B,Y)&&(g.value=ee,o.value="")}catch(ee){K(B,Y)&&ue(ee)}finally{B===b&&(i.value=!1)}}async function F(){if(!fe()||l.value||!g.value)return;const B=b,Y=H.token,ee=g.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((ee==null?void 0:ee.artifact_id)||""))throw new Error("Invalid export");const pe=await H.getBlob("/api/computer/download/"+ee.artifact_id);if(!K(B,Y))return;const he=URL.createObjectURL(pe),xe=document.createElement("a");xe.href=he,xe.download=ee.name,xe.click(),setTimeout(()=>URL.revokeObjectURL(he),1e3)}catch(pe){K(B,Y)&&ue(pe)}finally{B===b&&(l.value=!1)}}function Z(){_||(T!==H.token&&(T=H.token,oe(),u.value=0,I=null,e.value={state:"unknown",available:!1},o.value="",p.value=""),_=!0,G(),w=setInterval(()=>{R.value=Date.now(),T!==H.token&&(T=H.token,oe(),u.value=0,I=null,o.value="",p.value="",e.value={state:"unknown",available:!1}),c.value&&R.value-u.value>=15e3&&oe(),m.value&&Date.parse(m.value.expires_at)<=R.value&&(Q(),E.value=!0),g.value&&Date.parse(g.value.expires_at)<=R.value&&(g.value=null),!$&&R.value-k>=5e3&&G()},500))}function re(){_=!1,clearInterval(w),w=null,oe(),c.value=!1}return Ge(Z),Xt(Z),Vt(re),ft(re),{status:e,checkedAt:u,remedy:p,loading:t,observing:s,stopping:a,pausing:n,exporting:i,downloading:l,error:o,frame:m,frameUrl:v,frameExpired:E,freshness:U,name:y,artifact:g,refresh:G,control:ve,observe:j,clearFrame:Q,exportFile:de,download:F,toggling:r,adminReady:c,enabledLabel:S,restartSettings:ie,setEnabled:me,recovering:d,recover:$e,reconcile:C,releaseOwnedInput:be,reconciliationAck:h,applicationProfiles:te,attached:P,scriptIdentity:L,inputLimits:O,accessibilityLabel:W,accessibilityDetail:D}}},Sv=[{id:"health",label:"Health",component:Yk},{id:"resources",label:"Resources",component:Qk},{id:"logs",label:"Logs",component:dS},{id:"config",label:"Config",component:wS},{id:"discord",label:"Discord",component:SS},{id:"hosts",label:"Hosts",component:ES},{id:"host-access",label:"Host Access",component:CS},{id:"api-tokens",label:"API Tokens",component:AS},{id:"llm",label:"LLM Config",component:FS},{id:"internals",label:"Internals",component:US},{id:"turn-state",label:"Turn State",component:jS},{id:"computer",label:"Computer",component:GS},{id:"update",label:"Update",component:zS}],KS={components:{TabbedPage:rr},setup(){return{tabs:Sv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Kl=(e,t,s,a)=>a.map(({id:n,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:n}}})),WS=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Kl("Operations","operations","/operations",hv),...Kl("History","history","/history",mv),...Kl("Capabilities","capabilities","/capabilities",vv),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Kl("System","system","/system",Sv)],gs=an({open:!1,query:"",selected:0});function Np(){gs.query="",gs.selected=0,gs.open=!0}function Hr(){gs.open=!1}function JS(e,t){const s=e.label.toLowerCase(),a=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:a.startsWith(t)?80:s.includes(t)?60:a.includes(t)?40:0:1}const ZS={setup(){const e=lv(),t=f(null),s=z(()=>{const i=gs.query.trim().toLowerCase();return WS.map(l=>({...l,_score:JS(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Ft(()=>gs.open,async i=>{var l;i&&(await It(),(l=t.value)==null||l.focus())}),Ft(()=>gs.query,()=>{gs.selected=0});function a(i){Hr(),e.push(i.to)}function n(i){if(i.key==="Escape"){i.preventDefault(),Hr();return}if(i.key==="ArrowDown")i.preventDefault(),gs.selected=Math.min(gs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),gs.selected=Math.max(gs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[gs.selected];l&&a(l)}}return{state:gs,results:s,inputEl:t,go:a,onKeydown:n,closePalette:Hr}},template:`
    <transition name="modal">
...
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+ia(s.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(s);throw s}}},Tn=new pT;function ct(e,t){return Tn.parse(e,t)}ct.options=ct.setOptions=function(e){return Tn.setOptions(e),ct.defaults=Tn.defaults,Av(ct.defaults),ct};ct.getDefaults=Md;ct.defaults=On;ct.use=function(...e){return Tn.use(...e),ct.defaults=Tn.defaults,Av(ct.defaults),ct};ct.walkTokens=function(e,t){return Tn.walkTokens(e,t)};ct.parseInline=Tn.parseInline;ct.Parser=Ra;ct.parser=Ra.parse;ct.Renderer=Po;ct.TextRenderer=Vd;ct.Lexer=Aa;ct.lexer=Aa.lex;ct.Tokenizer=Do;ct.Hooks=ao;ct.parse=ct;ct.options;ct.setOptions;ct.use;ct.walkTokens;ct.parseInline;Ra.parse;Aa.lex;const fT={breaks:!0,gfm:!0};function ef(e){if(!e)return"";try{if(typeof ct<"u"&&ct.parse){const t=ct.parse(e,fT);return typeof Wp<"u"?Wp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function hT(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),a=t.getMinutes().toString().padStart(2,"0");return`${s}:${a}`}const mT={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function vT(e){return mT[e]||"wrench"}const gT=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function tf(e){if(!e)return[];const t=e.match(gT);return t?[...new Set(t)]:[]}const bT={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),a=f(""),n=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=z(()=>t.value.trim().length>0&&!s.value),p=f(st.state||"disconnected");let h=null;const m=z(()=>{const D=p.value;return D==="connected"?"Connected":D==="reconnecting"?"Reconnecting…":D==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],E=z(()=>{const D=Math.floor(l.value/4)%v.length,O=l.value;return O>3?`${v[D]} (${O}s)`:v[0]});function R(){It(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!i.value)return;const D=i.value;D.style.height="auto",D.style.height=Math.min(D.scrollHeight,120)+"px"}function g(D,O,L={}){const te={id:++c,role:D,content:O,timestamp:Date.now(),html:D==="bot"?ef(O):"",tools_used:L.tools_used||[],is_error:L.is_error||!1,images:D==="bot"?tf(O):[],files:L.files||[],_showTools:!1};return e.value.push(te),R(),D==="bot"&&It(()=>b()),te}function b(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(O=>{O.setAttribute("data-copy","true"),O.style.position="relative";const L=document.createElement("button");L.className="chat-code-copy",L.textContent="Copy",L.addEventListener("click",()=>{const te=O.querySelector("code"),ie=te?te.textContent:O.textContent;navigator.clipboard.writeText(ie).then(()=>{L.textContent="Copied!",setTimeout(()=>{L.textContent="Copy"},1500)}).catch(()=>{})}),O.appendChild(L)})}function w(D){if(D===0)return!0;const O=e.value[D-1],L=e.value[D],te=new Date(O.timestamp).toDateString(),ie=new Date(L.timestamp).toDateString();return te!==ie}function _(D){const O=new Date(D),L=new Date;if(O.toDateString()===L.toDateString())return"Today";const te=new Date(L);return te.setDate(te.getDate()-1),O.toDateString()===te.toDateString()?"Yesterday":O.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function T(D){t.value=D,It(()=>q())}function k(D){window.open(D,"_blank","noopener")}function x(D){D.target.style.display="none"}function I(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function $(){r&&(clearInterval(r),r=null),l.value=0}function S(D){s.value&&(s.value=!1,$(),D.type==="chat_response"?g("bot",D.content,{tools_used:D.tools_used||[],is_error:D.is_error||!1,files:D.files||[]}):D.type==="chat_error"&&g("bot",D.error||"Unknown error",{is_error:!0}),It(()=>{var O;return(O=i.value)==null?void 0:O.focus()}))}async function P(D){try{const O=await H.post("/api/chat",{content:D,channel_id:o.value});g("bot",O.response,{tools_used:O.tools_used||[],is_error:O.is_error||!1,files:O.files||[]})}catch(O){g("bot",O.message||"Failed to send message",{is_error:!0})}}async function q(){const D=t.value.trim();if(!D||s.value)return;g("user",D),t.value="",s.value=!0,I(),i.value&&(i.value.style.height="auto"),st.connected&&st.sendChat(D,{channelId:o.value})||(await P(D),s.value=!1,$()),It(()=>{var L;return(L=i.value)==null?void 0:L.focus()})}async function W(){a.value="";try{if(!o.value){const O=await H.get("/api/auth/session");o.value=O.channel_id||O.user_id||"web-user"}const D=await H.get("/api/sessions/"+encodeURIComponent(o.value));if(D&&D.messages&&D.messages.length>0){for(const O of D.messages){const L=O.role==="user"?"user":"bot";let te=O.content||"";if(L==="user"){const U=te.match(/^\[.*?\]:\s*/);U&&(te=te.slice(U[0].length))}if(!te.trim())continue;const ie={id:++c,role:L,content:te,timestamp:O.timestamp?O.timestamp*1e3:Date.now(),html:L==="bot"?ef(te):"",tools_used:[],is_error:!1,images:L==="bot"?tf(te):[],files:[],_showTools:!1};e.value.push(ie)}It(()=>{R(),b()})}}catch(D){D&&D.status!==404&&(a.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",we.error(a.value))}}return Ge(()=>{st.subscribe("chat",S),p.value=st.state||"disconnected",h=st.onState(D=>{p.value=D}),W(),It(()=>{var D;return(D=i.value)==null?void 0:D.focus()})}),ft(()=>{st.unsubscribe("chat",S),h&&(h(),h=null),$()}),{messages:e,input:t,sending:s,historyError:a,messagesEl:n,inputEl:i,canSend:u,wsStatus:m,typingText:E,suggestions:d,send:q,autoResize:y,formatTime:hT,formatDate:_,showDateSeparator:w,useSuggestion:T,openImage:k,onImageError:x,getToolIcon:vT,loadHistory:W}}},yT={setup(){const e=f("odin"),t=f(""),s=f(""),a=f(""),n=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),h=f(!1),m=z(()=>e.value==="custom"),v=z(()=>[...i.value,...l.value]),E=z(()=>l.value.includes(e.value)),R=z(()=>{var k;return m.value?t.value||"Odin":((k=n.value[e.value])==null?void 0:k.name)||e.value}),y=z(()=>{var k;return m.value?s.value||"(empty — will use Odin default)":((k=n.value[e.value])==null?void 0:k.identity)||""}),g=z(()=>{var k;return m.value?a.value||"(empty — will use Odin default)":((k=n.value[e.value])==null?void 0:k.voice)||""});async function b(){d.value=!0;try{const k=await H.get("/api/personality");e.value=k.preset||"odin",t.value=k.custom_name||"",s.value=k.custom_identity||"",a.value=k.custom_voice||"",n.value=k.presets||{},i.value=k.builtin_presets||[],l.value=k.user_presets||[]}catch(k){c.value=k.message}finally{d.value=!1}}async function w(){o.value=!0,c.value=null,r.value=!1;try{await H.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:a.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(k){c.value=k.message}finally{o.value=!1}}async function _(){const k=u.value.trim();if(k){h.value=!0,c.value=null;try{await H.post("/api/personality/presets",{name:k,display_name:R.value,identity:y.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=k.toLowerCase().replace(/ /g,"_")}catch(x){c.value=x.message}finally{h.value=!1}}}async function T(){if(await Kt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await H.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(x){c.value=x.message}}}return Ge(b),{preset:e,customName:t,customIdentity:s,customVoice:a,presets:n,presetNames:v,isCustom:m,isUserPreset:E,previewName:R,previewIdentity:y,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:w,showSavePreset:p,newPresetName:u,savingPreset:h,saveAsPreset:_,deletePreset:T,builtinPresets:i,userPresets:l}},template:`
  ...
  `},xT={props:["onComplete"],template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),a=f(!1),n=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let h=null;const m=f("starting"),v=f(""),E=Uv.filter(U=>U.meta),R=z(()=>["Workspace","Operate","Observe","Manage"].map(U=>({name:U,routes:E.filter(Q=>Q.meta.section===U)})).filter(U=>U.routes.length)),y=z(()=>{var U;return((U=Ki.currentRoute.value.meta)==null?void 0:U.label)||"Odin"}),g=z(()=>{var U;return((U=Ki.currentRoute.value.meta)==null?void 0:U.section)||"Management"}),b=z(()=>{var U;return((U=Ki.currentRoute.value.meta)==null?void 0:U.description)||"Management console"});function w(){st.disconnect(),D&&(clearInterval(D),D=null)}H.onSessionExpired=()=>{t.value=!0,w(),H.setToken(""),e.value="login"};function _(U){var Q;if((U.ctrlKey||U.metaKey)&&U.key.toLowerCase()==="k"){e.value==="ready"&&(U.preventDefault(),Np());return}if(a.value&&U.key==="Tab"){const oe=[...((Q=n.value)==null?void 0:Q.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(oe.length){const K=oe[0],fe=oe[oe.length-1];if(U.shiftKey&&(document.activeElement===K||!n.value.contains(document.activeElement))){U.preventDefault(),fe.focus();return}if(!U.shiftKey&&(document.activeElement===fe||!n.value.contains(document.activeElement))){U.preventDefault(),K.focus();return}}}if(U.key==="Escape"&&a.value){a.value=!1,U.preventDefault();return}if(U.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(U.target.tagName)){U.preventDefault();const oe=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');oe&&oe.focus()}}function T(){l.value=!!(o!=null&&o.matches),l.value||(a.value=!1)}async function k(){try{const U=await H.get("/api/setup/status");if(U.mode==="pending"||U.needed===!0)return w(),e.value="setup",!0}catch(U){U==null||U.name}return!1}Ge(async()=>{if(document.addEventListener("keydown",_),o=window.matchMedia("(max-width: 900px)"),T(),o.addEventListener("change",T),await k())return;const U=await H.check();U.ok?(e.value="ready",te()):U.needsAuth?e.value="login":(e.value="ready",te())});function x(){t.value=!1,e.value="ready",te()}async function I(){if(await k())return;const U=await H.check();U.ok?(e.value="ready",te()):U.needsAuth?e.value="login":(e.value="ready",te())}async function $(){w(),e.value="login",await H.logout()}function S(){s.value=!s.value}function P(){a.value=!a.value}Ft(a,async U=>{var Q,oe;if(U)r=document.activeElement,await It(),(oe=(Q=n.value)==null?void 0:Q.querySelector(".nav-item"))==null||oe.focus();else if(r!=null&&r.isConnected){const K=r;r=null,requestAnimationFrame(()=>K.focus())}});const q=z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function W(U,Q="info",oe=3e3){p.value={text:U,level:Q},clearTimeout(h),h=setTimeout(()=>{p.value=null},oe)}let D=null,O=!1,L=[];function te(){for(const U of L)U();L=[st.onStatus(U=>{c.value=U}),st.onLatencyChange(U=>{u.value=U}),st.onState((U,Q)=>{d.value=U,U==="connected"?(O&&W("Connection restored","success"),O=!0):U==="reconnecting"&&Q.attempt===1&&W("Connection lost — reconnecting…","warn")})],st.connect(),ie(),D&&clearInterval(D),D=setInterval(ie,15e3)}async function ie(){try{const U=await H.get("/api/status");m.value=U.status==="online"?"online":"starting";const Q=U.uptime_seconds||0,oe=Math.floor(Q/3600),K=Math.floor(Q%3600/60);v.value=`${oe}h ${K}m uptime`}catch{m.value="offline",v.value=""}}return ft(()=>{D&&clearInterval(D);for(const U of L)U();L=[],st.disconnect(),document.removeEventListener("keydown",_),o==null||o.removeEventListener("change",T)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:a,wsConnected:c,wsState:d,wsLatency:u,wsLabel:q,wsToast:p,botStatus:m,botUptime:v,navRoutes:E,navGroups:R,currentPage:y,currentSection:g,currentDescription:b,sidebarEl:n,mobileMenuButton:i,isMobileViewport:l,onLogin:x,onSetupComplete:I,logout:$,toggleSidebar:S,toggleMobileNavigation:P,openPalette:Np}}},Ba=wo(wT);Ba.component("odin-icon",YS);Ba.component("login-screen",_T);Ba.component("setup-page",xT);Ba.component("toast-container",M_);Ba.component("confirm-host",F_);Ba.component("command-palette",ZS);Ba.directive("modal-focus",XS);Ba.use(Ki);Ba.mount("#app");
