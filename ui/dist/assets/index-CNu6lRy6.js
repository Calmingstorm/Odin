var Ib=Object.defineProperty;var Ob=(e,t,s)=>t in e?Ib(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var Tt=(e,t,s)=>Ob(e,typeof t!="symbol"?t+"":t,s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();class Lb{constructor(){this._persist=localStorage.getItem("odin_persist")==="1",this._token=this._persist?localStorage.getItem("odin_token")||"":sessionStorage.getItem("odin_token")||"";const t=this._persist?localStorage:sessionStorage;this._sessionTimeout=parseInt(t.getItem("odin_session_timeout")||"0",10),this._lastActivity=Date.now(),this._activityTimer=null,this.onSessionExpired=null,this._token&&this._sessionTimeout>0&&this._startActivityMonitor()}get token(){return this._token}get sessionTimeout(){return this._sessionTimeout}setToken(t,s=0){if(this._token=t,this._sessionTimeout=s,this._lastActivity=Date.now(),t){const a=this._persist?localStorage:sessionStorage;a.setItem("odin_token",t),this._persist&&localStorage.setItem("odin_persist","1"),s>0?a.setItem("odin_session_timeout",String(s)):a.removeItem("odin_session_timeout"),this._startActivityMonitor()}else sessionStorage.removeItem("odin_token"),sessionStorage.removeItem("odin_session_timeout"),localStorage.removeItem("odin_token"),localStorage.removeItem("odin_persist"),localStorage.removeItem("odin_session_timeout"),this._stopActivityMonitor()}setPersist(t){this._persist=t}_startActivityMonitor(){this._stopActivityMonitor(),!(this._sessionTimeout<=0)&&(this._activityTimer=setInterval(()=>{(Date.now()-this._lastActivity)/1e3>=this._sessionTimeout&&(this._stopActivityMonitor(),this.onSessionExpired&&this.onSessionExpired())},1e4))}_stopActivityMonitor(){this._activityTimer&&(clearInterval(this._activityTimer),this._activityTimer=null)}_headers(t={}){const s={"Content-Type":"application/json",...t};return this._token&&(s.Authorization=`Bearer ${this._token}`),s}async _request(t,s,a=null,{signal:n}={}){this._lastActivity=Date.now();const i={method:t,headers:this._headers(),signal:n};a!==null&&(i.body=JSON.stringify(a));const l=await fetch(s,i);if(l.status===401)throw new go("Unauthorized");const o=await l.json().catch(()=>null);if(!l.ok){const r=(o==null?void 0:o.error)||`HTTP ${l.status}`;throw new mc(r,l.status,o)}return o}get(t,s={}){return this._request("GET",t,null,s)}async getBlob(t){this._lastActivity=Date.now();const s=await fetch(t,{method:"GET",headers:this._headers()});if(s.status===401)throw new go("Unauthorized");if(!s.ok){const a=await s.json().catch(()=>null);throw new mc((a==null?void 0:a.error)||`HTTP ${s.status}`,s.status,a)}return s.blob()}post(t,s){return this._request("POST",t,s)}async setListenerExposure(t,s){const a=await fetch("/api/setup/listener",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({expose_beyond_loopback:s})}),n=await a.json().catch(()=>null);if(!a.ok)throw new mc((n==null?void 0:n.error)||"Listener reauthentication failed",a.status,n);return n}put(t,s){return this._request("PUT",t,s)}del(t){return this._request("DELETE",t)}async login(t){const s=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})}),a=await s.json().catch(()=>null);if(!s.ok)throw new go((a==null?void 0:a.error)||"Login failed");return this.setToken(a.session_id,a.timeout_seconds||0),a}async logout(){const t=this.post("/api/auth/logout",{});this.setToken("");try{await t}catch{}}async check(){try{return await this.get("/api/status"),{ok:!0,needsAuth:!1}}catch(t){return t instanceof go?{ok:!1,needsAuth:!0}:{ok:!1,needsAuth:!1,error:t.message}}}}class go extends Error{constructor(t){super(t),this.name="AuthError"}}class mc extends Error{constructor(t,s,a){super(t),this.name="ApiError",this.status=s,this.data=a}}class Nb{constructor(t){this._api=t,this._ws=null,this._handlers={logs:[],events:[],chat:[]},this._reconnectDelay=1e3,this._maxReconnectDelay=3e4,this._shouldConnect=!1,this._subscriptions=new Set,this._reconnectAttempt=0,this._reconnectTimer=null,this._lastPongTime=0,this._pingInterval=null,this._forcedRetireTimer=null,this._subscriptionAckTimer=null,this._pendingReconnect=null,this._latency=-1,this._chatPending=!1,this._state="disconnected",this._lifecycle={status:new Set,state:new Set,latency:new Set,reconnected:new Set},this._everConnected=!1,this._reconnectEpoch=0}onStatus(t){return this._addLifecycle("status",t)}onState(t){return this._addLifecycle("state",t)}onLatencyChange(t){return this._addLifecycle("latency",t)}onReconnected(t){return this._addLifecycle("reconnected",t)}_addLifecycle(t,s){return this._lifecycle[t].add(s),()=>{this._lifecycle[t].delete(s)}}_emitLifecycle(t,...s){for(const a of[...this._lifecycle[t]])try{a(...s)}catch{}}get connected(){var t;return((t=this._ws)==null?void 0:t.readyState)===WebSocket.OPEN}get state(){return this._state}get reconnectAttempt(){return this._reconnectAttempt}get latency(){return this._latency}get reconnectEpoch(){return this._reconnectEpoch}_resetLatency(){this._latency=-1,this._emitLifecycle("latency",-1)}connect(){this._shouldConnect=!0,this._setState("connecting"),this._open()}disconnect(){this._shouldConnect=!1,this._everConnected=!1,this._reconnectTimer&&(clearTimeout(this._reconnectTimer),this._reconnectTimer=null),this._forcedRetireTimer&&(clearTimeout(this._forcedRetireTimer),this._forcedRetireTimer=null),this._subscriptionAckTimer&&(clearTimeout(this._subscriptionAckTimer),this._subscriptionAckTimer=null),this._pendingReconnect=null,this._reconnectAttempt=0,this._resetLatency(),this._stopPing(),this._ws&&(this._ws.close(),this._ws=null),this._setState("disconnected")}_setState(t){this._state!==t&&(this._state=t,this._emitLifecycle("state",t,{attempt:this._reconnectAttempt,latency:this._latency}))}_startPing(t){this._stopPing(),this._lastPongTime=Date.now(),this._pingInterval=setInterval(()=>{if(!(this._ws!==t||t.readyState!==WebSocket.OPEN)){if(this._lastPongTime&&Date.now()-this._lastPongTime>47e3){this._beginForcedRetirement(t,"pong timeout");return}try{t.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}}},15e3)}_beginForcedRetirement(t,s){if(!(this._ws!==t||this._forcedRetireTimer)){this._stopPing(),this._reconnectAttempt++,this._setState("reconnecting"),this._emitLifecycle("status",!1),this._forcedRetireTimer=setTimeout(()=>{this._forcedRetireTimer=null,this._retireSocket(t,!0,!0)},1e3);try{t.close(4e3,s)}catch{}}}_scheduleReconnect(t=!0){!this._shouldConnect||this._reconnectTimer||(t&&this._reconnectAttempt++,this._setState("reconnecting"),this._reconnectTimer=setTimeout(()=>{this._reconnectTimer=null,this._open()},this._reconnectDelay),this._reconnectDelay=Math.min(this._reconnectDelay*2,this._maxReconnectDelay))}_retireSocket(t,s=!1,a=!1){if(this._ws===t){if(this._forcedRetireTimer&&(clearTimeout(this._forcedRetireTimer),this._forcedRetireTimer=null),this._subscriptionAckTimer&&(clearTimeout(this._subscriptionAckTimer),this._subscriptionAckTimer=null),this._pendingReconnect=null,this._ws=null,this._stopPing(),this._resetLatency(),this._chatPending){this._chatPending=!1;const n={type:"chat_error",error:"Connection lost — the response may still complete; check session history."};for(const i of this._handlers.chat||[])i(n)}s||this._emitLifecycle("status",!1),this._shouldConnect?this._scheduleReconnect(!a):this._setState("disconnected")}}_beginReconnectBarrier(t,s){if(!s)return;const a=new Set(this._subscriptions);if(a.size===0){this._reconnectEpoch+=1,this._emitLifecycle("reconnected",this._reconnectEpoch);return}this._pendingReconnect={socket:t,channels:a},this._subscriptionAckTimer=setTimeout(()=>{var n;((n=this._pendingReconnect)==null?void 0:n.socket)===t&&this._beginForcedRetirement(t,"subscription acknowledgement timeout")},5e3)}_ackSubscription(t,s){const a=this._pendingReconnect;!a||a.socket!==t||!a.channels.has(s)||(a.channels.delete(s),!(a.channels.size>0)&&(this._pendingReconnect=null,this._subscriptionAckTimer&&(clearTimeout(this._subscriptionAckTimer),this._subscriptionAckTimer=null),this._reconnectEpoch+=1,this._emitLifecycle("reconnected",this._reconnectEpoch)))}_stopPing(){this._pingInterval&&(clearInterval(this._pingInterval),this._pingInterval=null)}subscribe(t,s){var a;if(this._handlers[t]||(this._handlers[t]=[]),this._handlers[t].push(s),t!=="chat"&&(this._subscriptions.add(t),this.connected)){const n=this._ws;((a=this._pendingReconnect)==null?void 0:a.socket)===n&&this._pendingReconnect.channels.add(t),n.send(JSON.stringify({subscribe:t}))}}unsubscribe(t,s){const a=this._handlers[t];if(a){const n=a.indexOf(s);if(n>=0&&a.splice(n,1),a.length===0&&t!=="chat"&&(this._subscriptions.delete(t),this.connected)){const i=this._ws;i.send(JSON.stringify({unsubscribe:t})),this._ackSubscription(i,t)}}}on(t,s){return this.subscribe(t,s)}off(t,s){return this.unsubscribe(t,s)}sendChat(t,{channelId:s,userId:a,username:n}={}){return this.connected?(this._ws.send(JSON.stringify({type:"chat",content:t,channel_id:s||"web-default",user_id:a||void 0,username:n||void 0})),this._chatPending=!0,!0):!1}_open(){if(this._ws||!this._shouldConnect)return;const s=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/api/ws`,a=this._api.token?["odin.bearer."+btoa(this._api.token).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")]:void 0,n=a?new WebSocket(s,a):new WebSocket(s);this._ws=n;const i=()=>this._ws===n;n.onopen=()=>{if(!i())return;const l=this._everConnected;this._everConnected=!0,this._reconnectDelay=1e3,this._reconnectAttempt=0;for(const o of this._subscriptions)n.send(JSON.stringify({subscribe:o}));this._startPing(n),this._setState("connected"),this._emitLifecycle("status",!0),this._beginReconnectBarrier(n,l)},n.onmessage=l=>{if(!i())return;let o;try{o=JSON.parse(l.data)}catch{return}const r=o.type;if(r==="pong"){o.ts&&(this._latency=Date.now()-o.ts,this._lastPongTime=Date.now(),this._emitLifecycle("latency",this._latency));return}if(r==="subscribed"){this._ackSubscription(n,o.channel);return}if(r==="log")for(const c of this._handlers.logs||[])c(o);else if(r==="event")for(const c of this._handlers.events||[])c(o);else if(r==="chat_response"||r==="chat_error"){this._chatPending=!1;for(const c of this._handlers.chat||[])c(o)}},n.onclose=()=>{const l=!!this._forcedRetireTimer;this._retireSocket(n,l,l)},n.onerror=()=>{}}}const H=new Lb,ut=new Nb(H);/**
* @vue/shared v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ys(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const it={},Ai=[],hs=()=>{},Ci=()=>!1,ei=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Er=e=>e.startsWith("onUpdate:"),nt=Object.assign,Ld=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Mb=Object.prototype.hasOwnProperty,ht=(e,t)=>Mb.call(e,t),Oe=Array.isArray,Ri=e=>Zi(e)==="[object Map]",ti=e=>Zi(e)==="[object Set]",Xu=e=>Zi(e)==="[object Date]",Db=e=>Zi(e)==="[object RegExp]",He=e=>typeof e=="function",Ye=e=>typeof e=="string",Cs=e=>typeof e=="symbol",mt=e=>e!==null&&typeof e=="object",Nd=e=>(mt(e)||He(e))&&He(e.then)&&He(e.catch),dm=Object.prototype.toString,Zi=e=>dm.call(e),Pb=e=>Zi(e).slice(8,-1),Ar=e=>Zi(e)==="[object Object]",Rr=e=>Ye(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Za=Ys(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),$b=Ys("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),Ir=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Fb=/-\w/g,wt=Ir(e=>e.replace(Fb,t=>t.slice(1).toUpperCase())),Bb=/\B([A-Z])/g,Us=Ir(e=>e.replace(Bb,"-$1").toLowerCase()),si=Ir(e=>e.charAt(0).toUpperCase()+e.slice(1)),Ii=Ir(e=>e?`on${si(e)}`:""),is=(e,t)=>!Object.is(e,t),Oi=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},um=(e,t,s,a=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:a,value:s})},Or=e=>{const t=parseFloat(e);return isNaN(t)?e:t},Zo=e=>{const t=Ye(e)?Number(e):NaN;return isNaN(t)?e:t};let ep;const Lr=()=>ep||(ep=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Ub(e,t){return e+JSON.stringify(t,(s,a)=>typeof a=="function"?a.toString():a)}const zb="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol",Hb=Ys(zb);function to(e){if(Oe(e)){const t={};for(let s=0;s<e.length;s++){const a=e[s],n=Ye(a)?pm(a):to(a);if(n)for(const i in n)t[i]=n[i]}return t}else if(Ye(e)||mt(e))return e}const jb=/;(?![^(]*\))/g,Vb=/:([^]+)/,qb=/\/\*[^]*?\*\//g;function pm(e){const t={};return e.replace(qb,"").split(jb).forEach(s=>{if(s){const a=s.split(Vb);a.length>1&&(t[a[0].trim()]=a[1].trim())}}),t}function so(e){let t="";if(Ye(e))t=e;else if(Oe(e))for(let s=0;s<e.length;s++){const a=so(e[s]);a&&(t+=a+" ")}else if(mt(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function Gb(e){if(!e)return null;let{class:t,style:s}=e;return t&&!Ye(t)&&(e.class=so(t)),s&&(e.style=to(s)),e}const Wb="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",Kb="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",Jb="annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics",Zb="area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr",Yb=Ys(Wb),Qb=Ys(Kb),Xb=Ys(Jb),ey=Ys(Zb),ty="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",sy=Ys(ty);function fm(e){return!!e||e===""}function ay(e,t){if(e.length!==t.length)return!1;let s=!0;for(let a=0;s&&a<e.length;a++)s=en(e[a],t[a]);return s}function en(e,t){if(e===t)return!0;let s=Xu(e),a=Xu(t);if(s||a)return s&&a?e.getTime()===t.getTime():!1;if(s=Cs(e),a=Cs(t),s||a)return e===t;if(s=Oe(e),a=Oe(t),s||a)return s&&a?ay(e,t):!1;if(s=mt(e),a=mt(t),s||a){if(!s||!a)return!1;const n=Object.keys(e).length,i=Object.keys(t).length;if(n!==i)return!1;for(const l in e){const o=e.hasOwnProperty(l),r=t.hasOwnProperty(l);if(o&&!r||!o&&r||!en(e[l],t[l]))return!1}}return String(e)===String(t)}function Nr(e,t){return e.findIndex(s=>en(s,t))}const mm=e=>!!(e&&e.__v_isRef===!0),hm=e=>Ye(e)?e:e==null?"":Oe(e)||mt(e)&&(e.toString===dm||!He(e.toString))?mm(e)?hm(e.value):JSON.stringify(e,vm,2):String(e),vm=(e,t)=>mm(t)?vm(e,t.value):Ri(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[a,n],i)=>(s[hc(a,i)+" =>"]=n,s),{})}:ti(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>hc(s))}:Cs(t)?hc(t):mt(t)&&!Oe(t)&&!Ar(t)?String(t):t,hc=(e,t="")=>{var s;return Cs(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};function ny(e){return e==null?"initial":typeof e=="string"?e===""?" ":e:String(e)}/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ts;class Md{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&ts&&(ts.active?(this.parent=ts,this.index=(ts.scopes||(ts.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=ts;try{return ts=this,t()}finally{ts=s}}}on(){++this._on===1&&(this.prevScope=ts,ts=this)}off(){if(this._on>0&&--this._on===0){if(ts===this)ts=this.prevScope;else{let t=ts;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,a;for(s=0,a=this.effects.length;s<a;s++)this.effects[s].stop();for(this.effects.length=0,s=0,a=this.cleanups.length;s<a;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,a=this.scopes.length;s<a;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const n=this.parent.scopes.pop();n&&n!==this&&(this.parent.scopes[this.index]=n,n.index=this.index)}this.parent=void 0}}}function iy(e){return new Md(e)}function gm(){return ts}function ly(e,t=!1){ts&&ts.cleanups.push(e)}let Rt;const vc=new WeakSet;class Ml{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ts&&(ts.active?ts.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,vc.has(this)&&(vc.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||ym(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,tp(this),xm(this);const t=Rt,s=ma;Rt=this,ma=!0;try{return this.fn()}finally{_m(this),Rt=t,ma=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)$d(t);this.deps=this.depsTail=void 0,tp(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?vc.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Gc(this)&&this.run()}get dirty(){return Gc(this)}}let bm=0,Sl,Cl;function ym(e,t=!1){if(e.flags|=8,t){e.next=Cl,Cl=e;return}e.next=Sl,Sl=e}function Dd(){bm++}function Pd(){if(--bm>0)return;if(Cl){let t=Cl;for(Cl=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;Sl;){let t=Sl;for(Sl=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(a){e||(e=a)}t=s}}if(e)throw e}function xm(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function _m(e){let t,s=e.depsTail,a=s;for(;a;){const n=a.prevDep;a.version===-1?(a===s&&(s=n),$d(a),oy(a)):t=a,a.dep.activeLink=a.prevActiveLink,a.prevActiveLink=void 0,a=n}e.deps=t,e.depsTail=s}function Gc(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(wm(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function wm(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Dl)||(e.globalVersion=Dl,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Gc(e))))return;e.flags|=2;const t=e.dep,s=Rt,a=ma;Rt=e,ma=!0;try{xm(e);const n=e.fn(e._value);(t.version===0||is(n,e._value))&&(e.flags|=128,e._value=n,t.version++)}catch(n){throw t.version++,n}finally{Rt=s,ma=a,_m(e),e.flags&=-3}}function $d(e,t=!1){const{dep:s,prevSub:a,nextSub:n}=e;if(a&&(a.nextSub=n,e.prevSub=void 0),n&&(n.prevSub=a,e.nextSub=void 0),s.subs===e&&(s.subs=a,!a&&s.computed)){s.computed.flags&=-5;for(let i=s.computed.deps;i;i=i.nextDep)$d(i,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function oy(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}function ry(e,t){e.effect instanceof Ml&&(e=e.effect.fn);const s=new Ml(e);t&&nt(s,t);try{s.run()}catch(n){throw s.stop(),n}const a=s.run.bind(s);return a.effect=s,a}function cy(e){e.effect.stop()}let ma=!0;const km=[];function tn(){km.push(ma),ma=!1}function sn(){const e=km.pop();ma=e===void 0?!0:e}function tp(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=Rt;Rt=void 0;try{t()}finally{Rt=s}}}let Dl=0;class dy{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Mr{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!Rt||!ma||Rt===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==Rt)s=this.activeLink=new dy(Rt,this),Rt.deps?(s.prevDep=Rt.depsTail,Rt.depsTail.nextDep=s,Rt.depsTail=s):Rt.deps=Rt.depsTail=s,Sm(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const a=s.nextDep;a.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=a),s.prevDep=Rt.depsTail,s.nextDep=void 0,Rt.depsTail.nextDep=s,Rt.depsTail=s,Rt.deps===s&&(Rt.deps=a)}return s}trigger(t){this.version++,Dl++,this.notify(t)}notify(t){Dd();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Pd()}}}function Sm(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let a=t.deps;a;a=a.nextDep)Sm(a)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const Yo=new WeakMap,qn=Symbol(""),Wc=Symbol(""),Pl=Symbol("");function ws(e,t,s){if(ma&&Rt){let a=Yo.get(e);a||Yo.set(e,a=new Map);let n=a.get(s);n||(a.set(s,n=new Mr),n.map=a,n.key=s),n.track()}}function qa(e,t,s,a,n,i){const l=Yo.get(e);if(!l){Dl++;return}const o=r=>{r&&r.trigger()};if(Dd(),t==="clear")l.forEach(o);else{const r=Oe(e),c=r&&Rr(s);if(r&&s==="length"){const d=Number(a);l.forEach((u,p)=>{(p==="length"||p===Pl||!Cs(p)&&p>=d)&&o(u)})}else switch((s!==void 0||l.has(void 0))&&o(l.get(s)),c&&o(l.get(Pl)),t){case"add":r?c&&o(l.get("length")):(o(l.get(qn)),Ri(e)&&o(l.get(Wc)));break;case"delete":r||(o(l.get(qn)),Ri(e)&&o(l.get(Wc)));break;case"set":Ri(e)&&o(l.get(qn));break}}Pd()}function uy(e,t){const s=Yo.get(e);return s&&s.get(t)}function hi(e){const t=dt(e);return t===e?t:(ws(t,"iterate",Pl),Hs(e)?t:t.map(va))}function Dr(e){return ws(e=dt(e),"iterate",Pl),e}function Aa(e,t){return Ia(e)?Fi(Ya(e)?va(t):t):va(t)}const py={__proto__:null,[Symbol.iterator](){return gc(this,Symbol.iterator,e=>Aa(this,e))},concat(...e){return hi(this).concat(...e.map(t=>Oe(t)?hi(t):t))},entries(){return gc(this,"entries",e=>(e[1]=Aa(this,e[1]),e))},every(e,t){return $a(this,"every",e,t,void 0,arguments)},filter(e,t){return $a(this,"filter",e,t,s=>s.map(a=>Aa(this,a)),arguments)},find(e,t){return $a(this,"find",e,t,s=>Aa(this,s),arguments)},findIndex(e,t){return $a(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return $a(this,"findLast",e,t,s=>Aa(this,s),arguments)},findLastIndex(e,t){return $a(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return $a(this,"forEach",e,t,void 0,arguments)},includes(...e){return bc(this,"includes",e)},indexOf(...e){return bc(this,"indexOf",e)},join(e){return hi(this).join(e)},lastIndexOf(...e){return bc(this,"lastIndexOf",e)},map(e,t){return $a(this,"map",e,t,void 0,arguments)},pop(){return rl(this,"pop")},push(...e){return rl(this,"push",e)},reduce(e,...t){return sp(this,"reduce",e,t)},reduceRight(e,...t){return sp(this,"reduceRight",e,t)},shift(){return rl(this,"shift")},some(e,t){return $a(this,"some",e,t,void 0,arguments)},splice(...e){return rl(this,"splice",e)},toReversed(){return hi(this).toReversed()},toSorted(e){return hi(this).toSorted(e)},toSpliced(...e){return hi(this).toSpliced(...e)},unshift(...e){return rl(this,"unshift",e)},values(){return gc(this,"values",e=>Aa(this,e))}};function gc(e,t,s){const a=Dr(e),n=a[t]();return a!==e&&!Hs(e)&&(n._next=n.next,n.next=()=>{const i=n._next();return i.done||(i.value=s(i.value)),i}),n}const fy=Array.prototype;function $a(e,t,s,a,n,i){const l=Dr(e),o=l!==e&&!Hs(e),r=l[t];if(r!==fy[t]){const u=r.apply(e,i);return o?va(u):u}let c=s;l!==e&&(o?c=function(u,p){return s.call(this,Aa(e,u),p,e)}:s.length>2&&(c=function(u,p){return s.call(this,u,p,e)}));const d=r.call(l,c,a);return o&&n?n(d):d}function sp(e,t,s,a){const n=Dr(e),i=n!==e&&!Hs(e);let l=s,o=!1;n!==e&&(i?(o=a.length===0,l=function(c,d,u){return o&&(o=!1,c=Aa(e,c)),s.call(this,c,Aa(e,d),u,e)}):s.length>3&&(l=function(c,d,u){return s.call(this,c,d,u,e)}));const r=n[t](l,...a);return o?Aa(e,r):r}function bc(e,t,s){const a=dt(e);ws(a,"iterate",Pl);const n=a[t](...s);return(n===-1||n===!1)&&ao(s[0])?(s[0]=dt(s[0]),a[t](...s)):n}function rl(e,t,s=[]){tn(),Dd();const a=dt(e)[t].apply(e,s);return Pd(),sn(),a}const my=Ys("__proto__,__v_isRef,__isVue"),Cm=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Cs));function hy(e){Cs(e)||(e=String(e));const t=dt(this);return ws(t,"has",e),t.hasOwnProperty(e)}class Tm{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,a){if(s==="__v_skip")return t.__v_skip;const n=this._isReadonly,i=this._isShallow;if(s==="__v_isReactive")return!n;if(s==="__v_isReadonly")return n;if(s==="__v_isShallow")return i;if(s==="__v_raw")return a===(n?i?Lm:Om:i?Im:Rm).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(a)?t:void 0;const l=Oe(t);if(!n){let r;if(l&&(r=py[s]))return r;if(s==="hasOwnProperty")return hy}const o=Reflect.get(t,s,Gt(t)?t:a);if((Cs(s)?Cm.has(s):my(s))||(n||ws(t,"get",s),i))return o;if(Gt(o)){const r=l&&Rr(s)?o:o.value;return n&&mt(r)?Qo(r):r}return mt(o)?n?Qo(o):Tn(o):o}}class Em extends Tm{constructor(t=!1){super(!1,t)}set(t,s,a,n){let i=t[s];const l=Oe(t)&&Rr(s);if(!this._isShallow){const c=Ia(i);if(!Hs(a)&&!Ia(a)&&(i=dt(i),a=dt(a)),!l&&Gt(i)&&!Gt(a))return c||(i.value=a),!0}const o=l?Number(s)<t.length:ht(t,s),r=Reflect.set(t,s,a,Gt(t)?t:n);return t===dt(n)&&(o?is(a,i)&&qa(t,"set",s,a):qa(t,"add",s,a)),r}deleteProperty(t,s){const a=ht(t,s);t[s];const n=Reflect.deleteProperty(t,s);return n&&a&&qa(t,"delete",s,void 0),n}has(t,s){const a=Reflect.has(t,s);return(!Cs(s)||!Cm.has(s))&&ws(t,"has",s),a}ownKeys(t){return ws(t,"iterate",Oe(t)?"length":qn),Reflect.ownKeys(t)}}class Am extends Tm{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const vy=new Em,gy=new Am,by=new Em(!0),yy=new Am(!0),Kc=e=>e,bo=e=>Reflect.getPrototypeOf(e);function xy(e,t,s){return function(...a){const n=this.__v_raw,i=dt(n),l=Ri(i),o=e==="entries"||e===Symbol.iterator&&l,r=e==="keys"&&l,c=n[e](...a),d=s?Kc:t?Fi:va;return!t&&ws(i,"iterate",r?Wc:qn),nt(Object.create(c),{next(){const{value:u,done:p}=c.next();return p?{value:u,done:p}:{value:o?[d(u[0]),d(u[1])]:d(u),done:p}}})}}function yo(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function _y(e,t){const s={get(n){const i=this.__v_raw,l=dt(i),o=dt(n);e||(is(n,o)&&ws(l,"get",n),ws(l,"get",o));const{has:r}=bo(l),c=t?Kc:e?Fi:va;if(r.call(l,n))return c(i.get(n));if(r.call(l,o))return c(i.get(o));i!==l&&i.get(n)},get size(){const n=this.__v_raw;return!e&&ws(dt(n),"iterate",qn),n.size},has(n){const i=this.__v_raw,l=dt(i),o=dt(n);return e||(is(n,o)&&ws(l,"has",n),ws(l,"has",o)),n===o?i.has(n):i.has(n)||i.has(o)},forEach(n,i){const l=this,o=l.__v_raw,r=dt(o),c=t?Kc:e?Fi:va;return!e&&ws(r,"iterate",qn),o.forEach((d,u)=>n.call(i,c(d),c(u),l))}};return nt(s,e?{add:yo("add"),set:yo("set"),delete:yo("delete"),clear:yo("clear")}:{add(n){const i=dt(this),l=bo(i),o=dt(n),r=!t&&!Hs(n)&&!Ia(n)?o:n;return l.has.call(i,r)||is(n,r)&&l.has.call(i,n)||is(o,r)&&l.has.call(i,o)||(i.add(r),qa(i,"add",r,r)),this},set(n,i){!t&&!Hs(i)&&!Ia(i)&&(i=dt(i));const l=dt(this),{has:o,get:r}=bo(l);let c=o.call(l,n);c||(n=dt(n),c=o.call(l,n));const d=r.call(l,n);return l.set(n,i),c?is(i,d)&&qa(l,"set",n,i):qa(l,"add",n,i),this},delete(n){const i=dt(this),{has:l,get:o}=bo(i);let r=l.call(i,n);r||(n=dt(n),r=l.call(i,n)),o&&o.call(i,n);const c=i.delete(n);return r&&qa(i,"delete",n,void 0),c},clear(){const n=dt(this),i=n.size!==0,l=n.clear();return i&&qa(n,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(n=>{s[n]=xy(n,e,t)}),s}function Pr(e,t){const s=_y(e,t);return(a,n,i)=>n==="__v_isReactive"?!e:n==="__v_isReadonly"?e:n==="__v_raw"?a:Reflect.get(ht(s,n)&&n in a?s:a,n,i)}const wy={get:Pr(!1,!1)},ky={get:Pr(!1,!0)},Sy={get:Pr(!0,!1)},Cy={get:Pr(!0,!0)},Rm=new WeakMap,Im=new WeakMap,Om=new WeakMap,Lm=new WeakMap;function Ty(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Tn(e){return Ia(e)?e:$r(e,!1,vy,wy,Rm)}function Fd(e){return $r(e,!1,by,ky,Im)}function Qo(e){return $r(e,!0,gy,Sy,Om)}function Ey(e){return $r(e,!0,yy,Cy,Lm)}function $r(e,t,s,a,n){if(!mt(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const i=n.get(e);if(i)return i;const l=Ty(Pb(e));if(l===0)return e;const o=new Proxy(e,l===2?a:s);return n.set(e,o),o}function Ya(e){return Ia(e)?Ya(e.__v_raw):!!(e&&e.__v_isReactive)}function Ia(e){return!!(e&&e.__v_isReadonly)}function Hs(e){return!!(e&&e.__v_isShallow)}function ao(e){return e?!!e.__v_raw:!1}function dt(e){const t=e&&e.__v_raw;return t?dt(t):e}function Nm(e){return!ht(e,"__v_skip")&&Object.isExtensible(e)&&um(e,"__v_skip",!0),e}const va=e=>mt(e)?Tn(e):e,Fi=e=>mt(e)?Qo(e):e;function Gt(e){return e?e.__v_isRef===!0:!1}function f(e){return Mm(e,!1)}function Bd(e){return Mm(e,!0)}function Mm(e,t){return Gt(e)?e:new Ay(e,t)}class Ay{constructor(t,s){this.dep=new Mr,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:dt(t),this._value=s?t:va(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,a=this.__v_isShallow||Hs(t)||Ia(t);t=a?t:dt(t),is(t,s)&&(this._rawValue=t,this._value=a?t:va(t),this.dep.trigger())}}function Ry(e){e.dep&&e.dep.trigger()}function Ra(e){return Gt(e)?e.value:e}function Iy(e){return He(e)?e():Ra(e)}const Oy={get:(e,t,s)=>t==="__v_raw"?e:Ra(Reflect.get(e,t,s)),set:(e,t,s,a)=>{const n=e[t];return Gt(n)&&!Gt(s)?(n.value=s,!0):Reflect.set(e,t,s,a)}};function Ud(e){return Ya(e)?e:new Proxy(e,Oy)}class Ly{constructor(t){this.__v_isRef=!0,this._value=void 0;const s=this.dep=new Mr,{get:a,set:n}=t(s.track.bind(s),s.trigger.bind(s));this._get=a,this._set=n}get value(){return this._value=this._get()}set value(t){this._set(t)}}function Dm(e){return new Ly(e)}function Ny(e){const t=Oe(e)?new Array(e.length):{};for(const s in e)t[s]=Pm(e,s);return t}class My{constructor(t,s,a){this._object=t,this._defaultValue=a,this.__v_isRef=!0,this._value=void 0,this._key=Cs(s)?s:String(s),this._raw=dt(t);let n=!0,i=t;if(!Oe(t)||Cs(this._key)||!Rr(this._key))do n=!ao(i)||Hs(i);while(n&&(i=i.__v_raw));this._shallow=n}get value(){let t=this._object[this._key];return this._shallow&&(t=Ra(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&Gt(this._raw[this._key])){const s=this._object[this._key];if(Gt(s)){s.value=t;return}}this._object[this._key]=t}get dep(){return uy(this._raw,this._key)}}class Dy{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function Py(e,t,s){return Gt(e)?e:He(e)?new Dy(e):mt(e)&&arguments.length>1?Pm(e,t,s):f(e)}function Pm(e,t,s){return new My(e,t,s)}class $y{constructor(t,s,a){this.fn=t,this.setter=s,this._value=void 0,this.dep=new Mr(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Dl-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=a}notify(){if(this.flags|=16,!(this.flags&8)&&Rt!==this)return ym(this,!0),!0}get value(){const t=this.dep.track();return wm(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Fy(e,t,s=!1){let a,n;return He(e)?a=e:(a=e.get,n=e.set),new $y(a,n,s)}const By={GET:"get",HAS:"has",ITERATE:"iterate"},Uy={SET:"set",ADD:"add",DELETE:"delete",CLEAR:"clear"},xo={},Xo=new WeakMap;let bn;function zy(){return bn}function $m(e,t=!1,s=bn){if(s){let a=Xo.get(s);a||Xo.set(s,a=[]),a.push(e)}}function Hy(e,t,s=it){const{immediate:a,deep:n,once:i,scheduler:l,augmentJob:o,call:r}=s,c=x=>n?x:Hs(x)||n===!1||n===0?Ga(x,1):Ga(x);let d,u,p,m,h=!1,b=!1;if(Gt(e)?(u=()=>e.value,h=Hs(e)):Ya(e)?(u=()=>c(e),h=!0):Oe(e)?(b=!0,h=e.some(x=>Ya(x)||Hs(x)),u=()=>e.map(x=>{if(Gt(x))return x.value;if(Ya(x))return c(x);if(He(x))return r?r(x,2):x()})):He(e)?t?u=r?()=>r(e,2):e:u=()=>{if(p){tn();try{p()}finally{sn()}}const x=bn;bn=d;try{return r?r(e,3,[m]):e(m)}finally{bn=x}}:u=hs,t&&n){const x=u,S=n===!0?1/0:n;u=()=>Ga(x(),S)}const I=gm(),k=()=>{d.stop(),I&&I.active&&Ld(I.effects,d)};if(i&&t){const x=t;t=(...S)=>{const _=x(...S);return k(),_}}let y=b?new Array(e.length).fill(xo):xo;const g=x=>{if(!(!(d.flags&1)||!d.dirty&&!x))if(t){const S=d.run();if(x||n||h||(b?S.some((_,E)=>is(_,y[E])):is(S,y))){p&&p();const _=bn;bn=d;try{const E=[S,y===xo?void 0:b&&y[0]===xo?[]:y,m];y=S,r?r(t,3,E):t(...E)}finally{bn=_}}}else d.run()};return o&&o(g),d=new Ml(u),d.scheduler=l?()=>l(g,!1):g,m=x=>$m(x,!1,d),p=d.onStop=()=>{const x=Xo.get(d);if(x){if(r)r(x,4);else for(const S of x)S();Xo.delete(d)}},t?a?g(!0):y=d.run():l?l(g.bind(null,!0),!0):d.run(),k.pause=d.pause.bind(d),k.resume=d.resume.bind(d),k.stop=k,k}function Ga(e,t=1/0,s){if(t<=0||!mt(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,Gt(e))Ga(e.value,t,s);else if(Oe(e))for(let a=0;a<e.length;a++)Ga(e[a],t,s);else if(ti(e)||Ri(e))e.forEach(a=>{Ga(a,t,s)});else if(Ar(e)){for(const a in e)Ga(e[a],t,s);for(const a of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,a)&&Ga(e[a],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Fm=[];function jy(e){Fm.push(e)}function Vy(){Fm.pop()}function qy(e,t){}const Gy={SETUP_FUNCTION:0,0:"SETUP_FUNCTION",RENDER_FUNCTION:1,1:"RENDER_FUNCTION",NATIVE_EVENT_HANDLER:5,5:"NATIVE_EVENT_HANDLER",COMPONENT_EVENT_HANDLER:6,6:"COMPONENT_EVENT_HANDLER",VNODE_HOOK:7,7:"VNODE_HOOK",DIRECTIVE_HOOK:8,8:"DIRECTIVE_HOOK",TRANSITION_HOOK:9,9:"TRANSITION_HOOK",APP_ERROR_HANDLER:10,10:"APP_ERROR_HANDLER",APP_WARN_HANDLER:11,11:"APP_WARN_HANDLER",FUNCTION_REF:12,12:"FUNCTION_REF",ASYNC_COMPONENT_LOADER:13,13:"ASYNC_COMPONENT_LOADER",SCHEDULER:14,14:"SCHEDULER",COMPONENT_UPDATE:15,15:"COMPONENT_UPDATE",APP_UNMOUNT_CLEANUP:16,16:"APP_UNMOUNT_CLEANUP"},Wy={sp:"serverPrefetch hook",bc:"beforeCreate hook",c:"created hook",bm:"beforeMount hook",m:"mounted hook",bu:"beforeUpdate hook",u:"updated",bum:"beforeUnmount hook",um:"unmounted hook",a:"activated hook",da:"deactivated hook",ec:"errorCaptured hook",rtc:"renderTracked hook",rtg:"renderTriggered hook",0:"setup function",1:"render function",2:"watcher getter",3:"watcher callback",4:"watcher cleanup function",5:"native event handler",6:"component event handler",7:"vnode hook",8:"directive hook",9:"transition hook",10:"app errorHandler",11:"app warnHandler",12:"ref function",13:"async component loader",14:"scheduler flush",15:"component update",16:"app unmount cleanup function"};function Yi(e,t,s,a){try{return a?e(...a):e()}catch(n){ai(n,t,s)}}function Zs(e,t,s,a){if(He(e)){const n=Yi(e,t,s,a);return n&&Nd(n)&&n.catch(i=>{ai(i,t,s)}),n}if(Oe(e)){const n=[];for(let i=0;i<e.length;i++)n.push(Zs(e[i],t,s,a));return n}}function ai(e,t,s,a=!0){const n=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=t&&t.appContext.config||it;if(t){let o=t.parent;const r=t.proxy,c=`https://vuejs.org/error-reference/#runtime-${s}`;for(;o;){const d=o.ec;if(d){for(let u=0;u<d.length;u++)if(d[u](e,r,c)===!1)return}o=o.parent}if(i){tn(),Yi(i,null,10,[e,r,c]),sn();return}}Ky(e,s,n,a,l)}function Ky(e,t,s,a=!0,n=!1){if(n)throw e;console.error(e)}const Is=[];let Ta=-1;const Li=[];let yn=null,_i=0;const Bm=Promise.resolve();let er=null;function zt(e){const t=er||Bm;return e?t.then(this?e.bind(this):e):t}function Jy(e){let t=Ta+1,s=Is.length;for(;t<s;){const a=t+s>>>1,n=Is[a],i=Fl(n);i<e||i===e&&n.flags&2?t=a+1:s=a}return t}function zd(e){if(!(e.flags&1)){const t=Fl(e),s=Is[Is.length-1];!s||!(e.flags&2)&&t>=Fl(s)?Is.push(e):Is.splice(Jy(t),0,e),e.flags|=1,Um()}}function Um(){er||(er=Bm.then(zm))}function $l(e){Oe(e)?Li.push(...e):yn&&e.id===-1?yn.splice(_i+1,0,e):e.flags&1||(Li.push(e),e.flags|=1),Um()}function ap(e,t,s=Ta+1){for(;s<Is.length;s++){const a=Is[s];if(a&&a.flags&2){if(e&&a.id!==e.uid)continue;Is.splice(s,1),s--,a.flags&4&&(a.flags&=-2),a(),a.flags&4||(a.flags&=-2)}}}function tr(e){if(Li.length){const t=[...new Set(Li)].sort((s,a)=>Fl(s)-Fl(a));if(Li.length=0,yn){yn.push(...t);return}for(yn=t,_i=0;_i<yn.length;_i++){const s=yn[_i];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}yn=null,_i=0}}const Fl=e=>e.id==null?e.flags&2?-1:1/0:e.id;function zm(e){try{for(Ta=0;Ta<Is.length;Ta++){const t=Is[Ta];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Yi(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Ta<Is.length;Ta++){const t=Is[Ta];t&&(t.flags&=-2)}Ta=-1,Is.length=0,tr(),er=null,(Is.length||Li.length)&&zm()}}let wi,_o=[];function Hm(e,t){var s,a;wi=e,wi?(wi.enabled=!0,_o.forEach(({event:n,args:i})=>wi.emit(n,...i)),_o=[]):typeof window<"u"&&window.HTMLElement&&!((a=(s=window.navigator)==null?void 0:s.userAgent)!=null&&a.includes("jsdom"))?((t.__VUE_DEVTOOLS_HOOK_REPLAY__=t.__VUE_DEVTOOLS_HOOK_REPLAY__||[]).push(i=>{Hm(i,t)}),setTimeout(()=>{wi||(t.__VUE_DEVTOOLS_HOOK_REPLAY__=null,_o=[])},3e3)):_o=[]}let ms=null,Fr=null;function Bl(e){const t=ms;return ms=e,Fr=e&&e.type.__scopeId||null,t}function Zy(e){Fr=e}function Yy(){Fr=null}const Qy=e=>Hd;function Hd(e,t=ms,s){if(!t||e._n)return e;const a=(...n)=>{a._d&&jl(-1);const i=Bl(t);let l;try{l=e(...n)}finally{Bl(i),a._d&&jl(1)}return l};return a._n=!0,a._c=!0,a._d=!0,a}function Xy(e,t){if(ms===null)return e;const s=oo(ms),a=e.dirs||(e.dirs=[]);for(let n=0;n<t.length;n++){let[i,l,o,r=it]=t[n];i&&(He(i)&&(i={mounted:i,updated:i}),i.deep&&Ga(l),a.push({dir:i,instance:s,value:l,oldValue:void 0,arg:o,modifiers:r}))}return e}function Ea(e,t,s,a){const n=e.dirs,i=t&&t.dirs;for(let l=0;l<n.length;l++){const o=n[l];i&&(o.oldValue=i[l].value);let r=o.dir[a];r&&(tn(),Zs(r,s,8,[e.el,o,e,t]),sn())}}function Tl(e,t){if(fs){let s=fs.provides;const a=fs.parent&&fs.parent.provides;a===s&&(s=fs.provides=Object.create(a)),s[e]=t}}function na(e,t,s=!1){const a=Ls();if(a||Gn){let n=Gn?Gn._context.provides:a?a.parent==null||a.ce?a.vnode.appContext&&a.vnode.appContext.provides:a.parent.provides:void 0;if(n&&e in n)return n[e];if(arguments.length>1)return s&&He(t)?t.call(a&&a.proxy):t}}function ex(){return!!(Ls()||Gn)}const jm=Symbol.for("v-scx"),Vm=()=>na(jm);function tx(e,t){return no(e,null,t)}function sx(e,t){return no(e,null,{flush:"post"})}function qm(e,t){return no(e,null,{flush:"sync"})}function Wt(e,t,s){return no(e,t,s)}function no(e,t,s=it){const{immediate:a,deep:n,flush:i,once:l}=s,o=nt({},s),r=t&&a||!t&&i!=="post";let c;if(Yn){if(i==="sync"){const m=Vm();c=m.__watcherHandles||(m.__watcherHandles=[])}else if(!r){const m=()=>{};return m.stop=hs,m.resume=hs,m.pause=hs,m}}const d=fs;o.call=(m,h,b)=>Zs(m,d,h,b);let u=!1;i==="post"?o.scheduler=m=>{Vt(m,d&&d.suspense)}:i!=="sync"&&(u=!0,o.scheduler=(m,h)=>{h?m():zd(m)}),o.augmentJob=m=>{t&&(m.flags|=4),u&&(m.flags|=2,d&&(m.id=d.uid,m.i=d))};const p=Hy(e,t,o);return Yn&&(c?c.push(p):r&&p()),p}function ax(e,t,s){const a=this.proxy,n=Ye(e)?e.includes(".")?Gm(a,e):()=>a[e]:e.bind(a,a);let i;He(t)?i=t:(i=t.handler,s=t);const l=Qi(this),o=no(n,i.bind(a),s);return l(),o}function Gm(e,t){const s=t.split(".");return()=>{let a=e;for(let n=0;n<s.length&&a;n++)a=a[s[n]];return a}}const vn=new WeakMap,Wm=Symbol("_vte"),Km=e=>e.__isTeleport,zn=e=>e&&(e.disabled||e.disabled===""),nx=e=>e&&(e.defer||e.defer===""),np=e=>typeof SVGElement<"u"&&e instanceof SVGElement,ip=e=>typeof MathMLElement=="function"&&e instanceof MathMLElement,Jc=(e,t)=>{const s=e&&e.to;return Ye(s)?t?t(s):null:s},ix={name:"Teleport",__isTeleport:!0,process(e,t,s,a,n,i,l,o,r,c){const{mc:d,pc:u,pbc:p,o:{insert:m,querySelector:h,createText:b,createComment:I,parentNode:k}}=c,y=zn(t.props);let{dynamicChildren:g}=t;const x=(E,R,w)=>{E.shapeFlag&16&&d(E.children,R,w,n,i,l,o,r)},S=(E=t)=>{const R=zn(E.props),w=E.target=Jc(E.props,h),O=Zc(w,E,b,m);w&&(l!=="svg"&&np(w)?l="svg":l!=="mathml"&&ip(w)&&(l="mathml"),n&&n.isCE&&(n.ce._teleportTargets||(n.ce._teleportTargets=new Set)).add(w),R||(x(E,w,O),yl(E,!1)))},_=E=>{const R=()=>{if(vn.get(E)===R){if(vn.delete(E),zn(E.props)){const w=k(E.el)||s;x(E,w,E.anchor),yl(E,!0)}S(E)}};vn.set(E,R),Vt(R,i)};if(e==null){const E=t.el=b(""),R=t.anchor=b("");if(m(E,s,a),m(R,s,a),nx(t.props)||i&&i.pendingBranch){_(t);return}y&&(x(t,s,R),yl(t,!0)),S()}else{t.el=e.el;const E=t.anchor=e.anchor,R=vn.get(e);if(R){R.flags|=8,vn.delete(e),_(t);return}t.targetStart=e.targetStart;const w=t.target=e.target,O=t.targetAnchor=e.targetAnchor,U=zn(e.props),T=U?s:w,$=U?E:O;if(l==="svg"||np(w)?l="svg":(l==="mathml"||ip(w))&&(l="mathml"),g?(p(e.dynamicChildren,g,T,n,i,l,o),Xd(e,t,!0)):r||u(e,t,T,$,n,i,l,o,!1),y)U?t.props&&e.props&&t.props.to!==e.props.to&&(t.props.to=e.props.to):wo(t,s,E,c,1);else if((t.props&&t.props.to)!==(e.props&&e.props.to)){const te=t.target=Jc(t.props,h);te&&wo(t,te,null,c,0)}else U&&wo(t,w,O,c,1);yl(t,y)}},remove(e,t,s,{um:a,o:{remove:n}},i){const{shapeFlag:l,children:o,anchor:r,targetStart:c,targetAnchor:d,target:u,props:p}=e,m=i||!zn(p),h=vn.get(e);if(h&&(h.flags|=8,vn.delete(e)),u&&(n(c),n(d)),i&&n(r),!h&&l&16)for(let b=0;b<o.length;b++){const I=o[b];a(I,t,s,m,!!I.dynamicChildren)}},move:wo,hydrate:lx};function wo(e,t,s,{o:{insert:a},m:n},i=2){i===0&&a(e.targetAnchor,t,s);const{el:l,anchor:o,shapeFlag:r,children:c,props:d}=e,u=i===2;if(u&&a(l,t,s),!vn.has(e)&&(!u||zn(d))&&r&16)for(let p=0;p<c.length;p++)n(c[p],t,s,2);u&&a(o,t,s)}function lx(e,t,s,a,n,i,{o:{nextSibling:l,parentNode:o,querySelector:r,insert:c,createText:d}},u){function p(I,k){let y=k;for(;y;){if(y&&y.nodeType===8){if(y.data==="teleport start anchor")t.targetStart=y;else if(y.data==="teleport anchor"){t.targetAnchor=y,I._lpa=t.targetAnchor&&l(t.targetAnchor);break}}y=l(y)}}function m(I,k){k.anchor=u(l(I),k,o(I),s,a,n,i)}const h=t.target=Jc(t.props,r),b=zn(t.props);if(h){const I=h._lpa||h.firstChild;t.shapeFlag&16&&(b?(m(e,t),p(h,I),t.targetAnchor||Zc(h,t,d,c,o(e)===h?e:null)):(t.anchor=l(e),p(h,I),t.targetAnchor||Zc(h,t,d,c),u(I&&l(I),t,h,s,a,n,i))),yl(t,b)}else b&&t.shapeFlag&16&&(m(e,t),t.targetStart=e,t.targetAnchor=l(e));return t.anchor&&l(t.anchor)}const ox=ix;function yl(e,t){const s=e.ctx;if(s&&s.ut){let a,n;for(t?(a=e.el,n=e.anchor):(a=e.targetStart,n=e.targetAnchor);a&&a!==n;)a.nodeType===1&&a.setAttribute("data-v-owner",s.uid),a=a.nextSibling;s.ut()}}function Zc(e,t,s,a,n=null){const i=t.targetStart=s(""),l=t.targetAnchor=s("");return i[Wm]=l,e&&(a(i,e,n),a(l,e,n)),l}const ea=Symbol("_leaveCb"),cl=Symbol("_enterCb");function jd(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return st(()=>{e.isMounted=!0}),Hr(()=>{e.isUnmounting=!0}),e}const Xs=[Function,Array],Vd={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Xs,onEnter:Xs,onAfterEnter:Xs,onEnterCancelled:Xs,onBeforeLeave:Xs,onLeave:Xs,onAfterLeave:Xs,onLeaveCancelled:Xs,onBeforeAppear:Xs,onAppear:Xs,onAfterAppear:Xs,onAppearCancelled:Xs},Jm=e=>{const t=e.subTree;return t.component?Jm(t.component):t},rx={name:"BaseTransition",props:Vd,setup(e,{slots:t}){const s=Ls(),a=jd();return()=>{const n=t.default&&Br(t.default(),!0),i=n&&n.length?Zm(n):s.subTree?Lh():void 0;if(!i)return;const l=dt(e),{mode:o}=l;if(a.isLeaving)return yc(i);const r=lp(i);if(!r)return yc(i);let c=Bi(r,l,a,s,u=>c=u);r.type!==Ht&&an(r,c);let d=s.subTree&&lp(s.subTree);if(d&&d.type!==Ht&&!fa(d,r)&&Jm(s).type!==Ht){let u=Bi(d,l,a,s);if(an(d,u),o==="out-in"&&r.type!==Ht)return a.isLeaving=!0,u.afterLeave=()=>{a.isLeaving=!1,s.job.flags&8||s.update(),delete u.afterLeave,d=void 0},yc(i);o==="in-out"&&r.type!==Ht?u.delayLeave=(p,m,h)=>{const b=Qm(a,d);b[String(d.key)]=d,p[ea]=()=>{m(),p[ea]=void 0,delete c.delayedLeave,d=void 0},c.delayedLeave=()=>{h(),delete c.delayedLeave,d=void 0}}:d=void 0}else d&&(d=void 0);return i}}};function Zm(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==Ht){t=s;break}}return t}const Ym=rx;function Qm(e,t){const{leavingVNodes:s}=e;let a=s.get(t.type);return a||(a=Object.create(null),s.set(t.type,a)),a}function Bi(e,t,s,a,n){const{appear:i,mode:l,persisted:o=!1,onBeforeEnter:r,onEnter:c,onAfterEnter:d,onEnterCancelled:u,onBeforeLeave:p,onLeave:m,onAfterLeave:h,onLeaveCancelled:b,onBeforeAppear:I,onAppear:k,onAfterAppear:y,onAppearCancelled:g}=t,x=String(e.key),S=Qm(s,e),_=(w,O)=>{w&&Zs(w,a,9,O)},E=(w,O)=>{const U=O[1];_(w,O),Oe(w)?w.every(T=>T.length<=1)&&U():w.length<=1&&U()},R={mode:l,persisted:o,beforeEnter(w){let O=r;if(!s.isMounted)if(i)O=I||r;else return;w[ea]&&w[ea](!0);const U=S[x];U&&fa(e,U)&&U.el[ea]&&U.el[ea](),_(O,[w])},enter(w){if(S[x]===e)return;let O=c,U=d,T=u;if(!s.isMounted)if(i)O=k||c,U=y||d,T=g||u;else return;let $=!1;w[cl]=W=>{$||($=!0,W?_(T,[w]):_(U,[w]),R.delayedLeave&&R.delayedLeave(),w[cl]=void 0)};const te=w[cl].bind(null,!1);O?E(O,[w,te]):te()},leave(w,O){const U=String(e.key);if(w[cl]&&w[cl](!0),s.isUnmounting)return O();_(p,[w]);let T=!1;w[ea]=te=>{T||(T=!0,O(),te?_(b,[w]):_(h,[w]),w[ea]=void 0,S[U]===e&&delete S[U])};const $=w[ea].bind(null,!1);S[U]=e,m?E(m,[w,$]):$()},clone(w){const O=Bi(w,t,s,a,n);return n&&n(O),O}};return R}function yc(e){if(lo(e))return e=Oa(e),e.children=null,e}function lp(e){if(!lo(e))return Km(e.type)&&e.children?Zm(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&He(s.default))return s.default()}}function an(e,t){e.shapeFlag&6&&e.component?(e.transition=t,an(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Br(e,t=!1,s){let a=[],n=0;for(let i=0;i<e.length;i++){let l=e[i];const o=s==null?l.key:String(s)+String(l.key!=null?l.key:i);l.type===ls?(l.patchFlag&128&&n++,a=a.concat(Br(l.children,t,o))):(t||l.type!==Ht)&&a.push(o!=null?Oa(l,{key:o}):l)}if(n>1)for(let i=0;i<a.length;i++)a[i].patchFlag=-2;return a}function io(e,t){return He(e)?nt({name:e.name},t,{setup:e}):e}function cx(){const e=Ls();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function qd(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function dx(e){const t=Ls(),s=Bd(null);if(t){const n=t.refs===it?t.refs={}:t.refs;Object.defineProperty(n,e,{enumerable:!0,get:()=>s.value,set:i=>s.value=i})}return s}function op(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const sr=new WeakMap;function Ni(e,t,s,a,n=!1){if(Oe(e)){e.forEach((b,I)=>Ni(b,t&&(Oe(t)?t[I]:t),s,a,n));return}if(Qa(a)&&!n){a.shapeFlag&512&&a.type.__asyncResolved&&a.component.subTree.component&&Ni(e,t,s,a.component.subTree);return}const i=a.shapeFlag&4?oo(a.component):a.el,l=n?null:i,{i:o,r}=e,c=t&&t.r,d=o.refs===it?o.refs={}:o.refs,u=o.setupState,p=dt(u),m=u===it?Ci:b=>op(d,b)?!1:ht(p,b),h=(b,I)=>!(I&&op(d,I));if(c!=null&&c!==r){if(rp(t),Ye(c))d[c]=null,m(c)&&(u[c]=null);else if(Gt(c)){const b=t;h(c,b.k)&&(c.value=null),b.k&&(d[b.k]=null)}}if(He(r))Yi(r,o,12,[l,d]);else{const b=Ye(r),I=Gt(r);if(b||I){const k=()=>{if(e.f){const y=b?m(r)?u[r]:d[r]:h()||!e.k?r.value:d[e.k];if(n)Oe(y)&&Ld(y,i);else if(Oe(y))y.includes(i)||y.push(i);else if(b)d[r]=[i],m(r)&&(u[r]=d[r]);else{const g=[i];h(r,e.k)&&(r.value=g),e.k&&(d[e.k]=g)}}else b?(d[r]=l,m(r)&&(u[r]=l)):I&&(h(r,e.k)&&(r.value=l),e.k&&(d[e.k]=l))};if(l){const y=()=>{k(),sr.delete(e)};y.id=-1,sr.set(e,y),Vt(y,s)}else rp(e),k()}}}function rp(e){const t=sr.get(e);t&&(t.flags|=8,sr.delete(e))}let cp=!1;const vi=()=>{cp||(console.error("Hydration completed but contains mismatches."),cp=!0)},ux=e=>e.namespaceURI.includes("svg")&&e.tagName!=="foreignObject",px=e=>e.namespaceURI.includes("MathML"),ko=e=>{if(e.nodeType===1){if(ux(e))return"svg";if(px(e))return"mathml"}},Ti=e=>e.nodeType===8;function fx(e){const{mt:t,p:s,o:{patchProp:a,createText:n,nextSibling:i,parentNode:l,remove:o,insert:r,createComment:c}}=e,d=(g,x)=>{if(!x.hasChildNodes()){s(null,g,x),tr(),x._vnode=g;return}u(x.firstChild,g,null,null,null),tr(),x._vnode=g},u=(g,x,S,_,E,R=!1)=>{R=R||!!x.dynamicChildren;const w=Ti(g)&&g.data==="[",O=()=>b(g,x,S,_,E,w),{type:U,ref:T,shapeFlag:$,patchFlag:te}=x;let W=g.nodeType;x.el=g,te===-2&&(R=!1,x.dynamicChildren=null);let M=null;switch(U){case kn:W!==3?x.children===""?(r(x.el=n(""),l(g),g),M=g):M=O():(g.data!==x.children&&(vi(),g.data=x.children),M=i(g));break;case Ht:y(g)?(M=i(g),k(x.el=g.content.firstChild,g,S)):W!==8||w?M=O():M=i(g);break;case Wn:if(w&&(g=i(g),W=g.nodeType),W===1||W===3){M=g;const L=!x.children.length;for(let P=0;P<x.staticCount;P++)L&&(x.children+=M.nodeType===1?M.outerHTML:M.data),P===x.staticCount-1&&(x.anchor=M),M=i(M);return w?i(M):M}else O();break;case ls:w?M=h(g,x,S,_,E,R):M=O();break;default:if($&1)(W!==1||x.type.toLowerCase()!==g.tagName.toLowerCase())&&!y(g)?M=O():M=p(g,x,S,_,E,R);else if($&6){x.slotScopeIds=E;const L=l(g);if(w?M=I(g):Ti(g)&&g.data==="teleport start"?M=I(g,g.data,"teleport end"):M=i(g),t(x,L,null,S,_,ko(L),R),Qa(x)&&!x.type.__asyncResolved){let P;w?(P=Lt(ls),P.anchor=M?M.previousSibling:L.lastChild):P=g.nodeType===3?tu(""):Lt("div"),P.el=g,x.component.subTree=P}}else $&64?W!==8?M=O():M=x.type.hydrate(g,x,S,_,E,R,e,m):$&128&&(M=x.type.hydrate(g,x,S,_,ko(l(g)),E,R,e,u))}return T!=null&&Ni(T,null,_,x),M},p=(g,x,S,_,E,R)=>{R=R||!!x.dynamicChildren;const{type:w,props:O,patchFlag:U,shapeFlag:T,dirs:$,transition:te}=x,W=w==="input"||w==="option";if(W||U!==-1){$&&Ea(x,null,S,"created");let M=!1;if(y(g)){M=kh(null,te)&&S&&S.vnode.props&&S.vnode.props.appear;const P=g.content.firstChild;if(M){const re=P.getAttribute("class");re&&(P.$cls=re),te.beforeEnter(P)}k(P,g,S),x.el=g=P}if(T&16&&!(O&&(O.innerHTML||O.textContent))){let P=m(g.firstChild,x,g,S,_,E,R);for(P&&!So(g,1)&&vi();P;){const re=P;P=P.nextSibling,o(re)}}else if(T&8){let P=x.children;P[0]===`
`&&(g.tagName==="PRE"||g.tagName==="TEXTAREA")&&(P=P.slice(1));const{textContent:re}=g;re!==P&&re!==P.replace(/\r\n|\r/g,`
`)&&(So(g,0)||vi(),g.textContent=x.children)}if(O){if(W||!R||U&48){const P=g.tagName.includes("-");for(const re in O)(W&&(re.endsWith("value")||re==="indeterminate")||ei(re)&&!Za(re)||re[0]==="."||P&&!Za(re))&&a(g,re,null,O[re],void 0,S)}else if(O.onClick)a(g,"onClick",null,O.onClick,void 0,S);else if(U&4&&Ya(O.style))for(const P in O.style)O.style[P]}let L;(L=O&&O.onVnodeBeforeMount)&&$s(L,S,x),$&&Ea(x,null,S,"beforeMount"),((L=O&&O.onVnodeMounted)||$||M)&&Eh(()=>{L&&$s(L,S,x),M&&te.enter(g),$&&Ea(x,null,S,"mounted")},_)}return g.nextSibling},m=(g,x,S,_,E,R,w)=>{w=w||!!x.dynamicChildren;const O=x.children,U=O.length;let T=!1;for(let $=0;$<U;$++){const te=w?O[$]:O[$]=Bs(O[$]),W=te.type===kn;g?(W&&!w&&$+1<U&&Bs(O[$+1]).type===kn&&(r(n(g.data.slice(te.children.length)),S,i(g)),g.data=te.children),g=u(g,te,_,E,R,w)):W&&!te.children?r(te.el=n(""),S):(T||(T=!0,So(S,1)||vi()),s(null,te,S,null,_,E,ko(S),R))}return g},h=(g,x,S,_,E,R)=>{const{slotScopeIds:w}=x;w&&(E=E?E.concat(w):w);const O=l(g),U=m(i(g),x,O,S,_,E,R);return U&&Ti(U)&&U.data==="]"?i(x.anchor=U):(vi(),r(x.anchor=c("]"),O,U),U)},b=(g,x,S,_,E,R)=>{if(So(g.parentElement,1)||vi(),x.el=null,R){const U=I(g);for(;;){const T=i(g);if(T&&T!==U)o(T);else break}}const w=i(g),O=l(g);return o(g),s(null,x,O,w,S,_,ko(O),E),S&&(S.vnode.el=x.el,Vr(S,x.el)),w},I=(g,x="[",S="]")=>{let _=0;for(;g;)if(g=i(g),g&&Ti(g)&&(g.data===x&&_++,g.data===S)){if(_===0)return i(g);_--}return g},k=(g,x,S)=>{const _=x.parentNode;_&&_.replaceChild(g,x);let E=S;for(;E;)E.vnode.el===x&&(E.vnode.el=E.subTree.el=g),E=E.parent},y=g=>g.nodeType===1&&g.tagName==="TEMPLATE";return[d,u]}const dp="data-allow-mismatch",mx={0:"text",1:"children",2:"class",3:"style",4:"attribute"};function So(e,t){if(t===0||t===1)for(;e&&!e.hasAttribute(dp);)e=e.parentElement;const s=e&&e.getAttribute(dp);if(s==null)return!1;if(s==="")return!0;{const a=s.split(",");return t===0&&a.includes("children")?!0:a.includes(mx[t])}}const hx=Lr().requestIdleCallback||(e=>setTimeout(e,1)),vx=Lr().cancelIdleCallback||(e=>clearTimeout(e)),gx=(e=1e4)=>t=>{const s=hx(t,{timeout:e});return()=>vx(s)};function bx(e){const{top:t,left:s,bottom:a,right:n}=e.getBoundingClientRect(),{innerHeight:i,innerWidth:l}=window;return(t>0&&t<i||a>0&&a<i)&&(s>0&&s<l||n>0&&n<l)}const yx=e=>(t,s)=>{const a=new IntersectionObserver(n=>{for(const i of n)if(i.isIntersecting){a.disconnect(),t();break}},e);return s(n=>{if(n instanceof Element){if(bx(n))return t(),a.disconnect(),!1;a.observe(n)}}),()=>a.disconnect()},xx=e=>t=>{if(e){const s=matchMedia(e);if(s.matches)t();else return s.addEventListener("change",t,{once:!0}),()=>s.removeEventListener("change",t)}},_x=(e=[])=>(t,s)=>{Ye(e)&&(e=[e]);let a=!1;const n=l=>{a||(a=!0,i(),t(),l.target.dispatchEvent(new l.constructor(l.type,l)))},i=()=>{s(l=>{for(const o of e)l.removeEventListener(o,n)})};return s(l=>{for(const o of e)l.addEventListener(o,n,{once:!0})}),i};function wx(e,t){if(Ti(e)&&e.data==="["){let s=1,a=e.nextSibling;for(;a;){if(a.nodeType===1){if(t(a)===!1)break}else if(Ti(a))if(a.data==="]"){if(--s===0)break}else a.data==="["&&s++;a=a.nextSibling}}else t(e)}const Qa=e=>!!e.type.__asyncLoader;function kx(e){He(e)&&(e={loader:e});const{loader:t,loadingComponent:s,errorComponent:a,delay:n=200,hydrate:i,timeout:l,suspensible:o=!0,onError:r}=e;let c=null,d,u=0;const p=()=>(u++,c=null,m()),m=()=>{let h;return c||(h=c=t().catch(b=>{if(b=b instanceof Error?b:new Error(String(b)),r)return new Promise((I,k)=>{r(b,()=>I(p()),()=>k(b),u+1)});throw b}).then(b=>h!==c&&c?c:(b&&(b.__esModule||b[Symbol.toStringTag]==="Module")&&(b=b.default),d=b,b)))};return io({name:"AsyncComponentWrapper",__asyncLoader:m,__asyncHydrate(h,b,I){let k=!1;(b.bu||(b.bu=[])).push(()=>k=!0);const y=()=>{k||I()},g=i?()=>{const x=i(y,S=>wx(h,S));x&&(b.bum||(b.bum=[])).push(x)}:y;d?g():m().then(()=>!b.isUnmounted&&g())},get __asyncResolved(){return d},setup(){const h=fs;if(qd(h),d)return()=>Co(d,h);const b=S=>{c=null,ai(S,h,13,!a)};if(o&&h.suspense||Yn)return m().then(S=>()=>Co(S,h)).catch(S=>(b(S),()=>a?Lt(a,{error:S}):null));const I=f(!1),k=f(),y=f(!!n);let g,x;return xt(()=>{g!=null&&clearTimeout(g),x!=null&&clearTimeout(x)}),n&&(x=setTimeout(()=>{h.isUnmounted||(y.value=!1)},n)),l!=null&&(g=setTimeout(()=>{if(!h.isUnmounted&&!I.value&&!k.value){const S=new Error(`Async component timed out after ${l}ms.`);b(S),k.value=S}},l)),m().then(()=>{h.isUnmounted||(I.value=!0,h.parent&&lo(h.parent.vnode)&&h.parent.update())}).catch(S=>{if(h.isUnmounted){c=null;return}b(S),k.value=S}),()=>{if(I.value&&d)return Co(d,h);if(k.value&&a)return Lt(a,{error:k.value});if(s&&!y.value)return Co(s,h)}}})}function Co(e,t){const{ref:s,props:a,children:n,ce:i}=t.vnode,l=Lt(e,a,n);return l.ref=s,l.ce=i,delete t.vnode.ce,l}const lo=e=>e.type.__isKeepAlive,Sx={name:"KeepAlive",__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){const s=Ls(),a=s.ctx;if(!a.renderer)return()=>{const y=t.default&&t.default();return y&&y.length===1?y[0]:y};const n=new Map,i=new Set;let l=null;const o=s.suspense,{renderer:{p:r,m:c,um:d,o:{createElement:u}}}=a,p=u("div");a.activate=(y,g,x,S,_)=>{const E=y.component;c(y,g,x,0,o),r(E.vnode,y,g,x,E,o,S,y.slotScopeIds,_),Vt(()=>{E.isDeactivated=!1,E.a&&Oi(E.a);const R=y.props&&y.props.onVnodeMounted;R&&$s(R,E.parent,y)},o)},a.deactivate=y=>{const g=y.component;nr(g.m),nr(g.a),c(y,p,null,1,o),Vt(()=>{g.da&&Oi(g.da);const x=y.props&&y.props.onVnodeUnmounted;x&&$s(x,g.parent,y),g.isDeactivated=!0},o)};function m(y){xc(y),d(y,s,o,!0)}function h(y){n.forEach((g,x)=>{const S=id(Qa(g)?g.type.__asyncResolved||{}:g.type);S&&!y(S)&&b(x)})}function b(y){const g=n.get(y);g&&(!l||!fa(g,l))?m(g):l&&xc(l),n.delete(y),i.delete(y)}Wt(()=>[e.include,e.exclude],([y,g])=>{y&&h(x=>xl(y,x)),g&&h(x=>!xl(g,x))},{flush:"post",deep:!0});let I=null;const k=()=>{I!=null&&(ir(s.subTree.type)?Vt(()=>{n.set(I,To(s.subTree))},s.subTree.suspense):n.set(I,To(s.subTree)))};return st(k),zr(k),Hr(()=>{n.forEach(y=>{const{subTree:g,suspense:x}=s,S=To(g);if(y.type===S.type&&y.key===S.key){xc(S);const _=S.component.da;_&&Vt(_,x);return}m(y)})}),()=>{if(I=null,!t.default)return l=null;const y=t.default(),g=y[0];if(y.length>1)return l=null,y;if(!nn(g)||!(g.shapeFlag&4)&&!(g.shapeFlag&128))return l=null,g;let x=To(g);if(x.type===Ht)return l=null,x;const S=x.type,_=id(Qa(x)?x.type.__asyncResolved||{}:S),{include:E,exclude:R,max:w}=e;if(E&&(!_||!xl(E,_))||R&&_&&xl(R,_))return x.shapeFlag&=-257,l=x,g;const O=x.key==null?S:x.key,U=n.get(O);return x.el&&(x=Oa(x),g.shapeFlag&128&&(g.ssContent=x)),I=O,U?(x.el=U.el,x.component=U.component,x.transition&&an(x,x.transition),x.shapeFlag|=512,i.delete(O),i.add(O)):(i.add(O),w&&i.size>parseInt(w,10)&&b(i.values().next().value)),x.shapeFlag|=256,l=x,ir(g.type)?g:x}}},Cx=Sx;function xl(e,t){return Oe(e)?e.some(s=>xl(s,t)):Ye(e)?e.split(",").includes(t):Db(e)?(e.lastIndex=0,e.test(t)):!1}function rs(e,t){Xm(e,"a",t)}function Kt(e,t){Xm(e,"da",t)}function Xm(e,t,s=fs){const a=e.__wdc||(e.__wdc=()=>{let n=s;for(;n;){if(n.isDeactivated)return;n=n.parent}return e()});if(Ur(t,a,s),s){let n=s.parent;for(;n&&n.parent;)lo(n.parent.vnode)&&Tx(a,t,s,n),n=n.parent}}function Tx(e,t,s,a){const n=Ur(t,e,a,!0);xt(()=>{Ld(a[t],n)},s)}function xc(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function To(e){return e.shapeFlag&128?e.ssContent:e}function Ur(e,t,s=fs,a=!1){if(s){const n=s[e]||(s[e]=[]),i=t.__weh||(t.__weh=(...l)=>{tn();const o=Qi(s),r=Zs(t,s,e,l);return o(),sn(),r});return a?n.unshift(i):n.push(i),i}}const ln=e=>(t,s=fs)=>{(!Yn||e==="sp")&&Ur(e,(...a)=>t(...a),s)},eh=ln("bm"),st=ln("m"),Gd=ln("bu"),zr=ln("u"),Hr=ln("bum"),xt=ln("um"),th=ln("sp"),sh=ln("rtg"),ah=ln("rtc");function nh(e,t=fs){Ur("ec",e,t)}const Wd="components",Ex="directives";function Ax(e,t){return Kd(Wd,e,!0,t)||e}const ih=Symbol.for("v-ndc");function Rx(e){return Ye(e)?Kd(Wd,e,!1)||e:e||ih}function Ix(e){return Kd(Ex,e)}function Kd(e,t,s=!0,a=!1){const n=ms||fs;if(n){const i=n.type;if(e===Wd){const o=id(i,!1);if(o&&(o===t||o===wt(t)||o===si(wt(t))))return i}const l=up(n[e]||i[e],t)||up(n.appContext[e],t);return!l&&a?i:l}}function up(e,t){return e&&(e[t]||e[wt(t)]||e[si(wt(t))])}function Ox(e,t,s,a){let n;const i=s&&s[a],l=Oe(e);if(l||Ye(e)){const o=l&&Ya(e);let r=!1,c=!1;o&&(r=!Hs(e),c=Ia(e),e=Dr(e)),n=new Array(e.length);for(let d=0,u=e.length;d<u;d++)n[d]=t(r?c?Fi(va(e[d])):va(e[d]):e[d],d,void 0,i&&i[d])}else if(typeof e=="number"){n=new Array(e);for(let o=0;o<e;o++)n[o]=t(o+1,o,void 0,i&&i[o])}else if(mt(e))if(e[Symbol.iterator])n=Array.from(e,(o,r)=>t(o,r,void 0,i&&i[r]));else{const o=Object.keys(e);n=new Array(o.length);for(let r=0,c=o.length;r<c;r++){const d=o[r];n[r]=t(e[d],d,r,i&&i[r])}}else n=[];return s&&(s[a]=n),n}function Lx(e,t){for(let s=0;s<t.length;s++){const a=t[s];if(Oe(a))for(let n=0;n<a.length;n++)e[a[n].name]=a[n].fn;else a&&(e[a.name]=a.key?(...n)=>{const i=a.fn(...n);return i&&(i.key=a.key),i}:a.fn)}return e}function Nx(e,t,s={},a,n){if(ms.ce||ms.parent&&Qa(ms.parent)&&ms.parent.ce){const c=Object.keys(s).length>0;return t!=="default"&&(s.name=t),Hl(),lr(ls,null,[Lt("slot",s,a&&a())],c?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),Hl();const l=i&&Jd(i(s)),o=s.key||l&&l.key,r=lr(ls,{key:(o&&!Cs(o)?o:`_${t}`)+(!l&&a?"_fb":"")},l||(a?a():[]),l&&e._===1?64:-2);return!n&&r.scopeId&&(r.slotScopeIds=[r.scopeId+"-s"]),i&&i._c&&(i._d=!0),r}function Jd(e){return e.some(t=>nn(t)?!(t.type===Ht||t.type===ls&&!Jd(t.children)):!0)?e:null}function Mx(e,t){const s={};for(const a in e)s[t&&/[A-Z]/.test(a)?`on:${a}`:Ii(a)]=e[a];return s}const Yc=e=>e?Dh(e)?oo(e):Yc(e.parent):null,El=nt(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Yc(e.parent),$root:e=>Yc(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Zd(e),$forceUpdate:e=>e.f||(e.f=()=>{zd(e.update)}),$nextTick:e=>e.n||(e.n=zt.bind(e.proxy)),$watch:e=>ax.bind(e)}),_c=(e,t)=>e!==it&&!e.__isScriptSetup&&ht(e,t),Qc={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:a,data:n,props:i,accessCache:l,type:o,appContext:r}=e;if(t[0]!=="$"){const p=l[t];if(p!==void 0)switch(p){case 1:return a[t];case 2:return n[t];case 4:return s[t];case 3:return i[t]}else{if(_c(a,t))return l[t]=1,a[t];if(n!==it&&ht(n,t))return l[t]=2,n[t];if(ht(i,t))return l[t]=3,i[t];if(s!==it&&ht(s,t))return l[t]=4,s[t];Xc&&(l[t]=0)}}const c=El[t];let d,u;if(c)return t==="$attrs"&&ws(e.attrs,"get",""),c(e);if((d=o.__cssModules)&&(d=d[t]))return d;if(s!==it&&ht(s,t))return l[t]=4,s[t];if(u=r.config.globalProperties,ht(u,t))return u[t]},set({_:e},t,s){const{data:a,setupState:n,ctx:i}=e;return _c(n,t)?(n[t]=s,!0):a!==it&&ht(a,t)?(a[t]=s,!0):ht(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:a,appContext:n,props:i,type:l}},o){let r;return!!(s[o]||e!==it&&o[0]!=="$"&&ht(e,o)||_c(t,o)||ht(i,o)||ht(a,o)||ht(El,o)||ht(n.config.globalProperties,o)||(r=l.__cssModules)&&r[o])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:ht(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}},Dx=nt({},Qc,{get(e,t){if(t!==Symbol.unscopables)return Qc.get(e,t,e)},has(e,t){return t[0]!=="_"&&!Hb(t)}});function Px(){return null}function $x(){return null}function Fx(e){}function Bx(e){}function Ux(){return null}function zx(){}function Hx(e,t){return null}function jx(){return lh().slots}function Vx(){return lh().attrs}function lh(e){const t=Ls();return t.setupContext||(t.setupContext=Bh(t))}function Ul(e){return Oe(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}function qx(e,t){const s=Ul(e);for(const a in t){if(a.startsWith("__skip"))continue;let n=s[a];n?Oe(n)||He(n)?n=s[a]={type:n,default:t[a]}:n.default=t[a]:n===null&&(n=s[a]={default:t[a]}),n&&t[`__skip_${a}`]&&(n.skipFactory=!0)}return s}function Gx(e,t){return!e||!t?e||t:Oe(e)&&Oe(t)?e.concat(t):nt({},Ul(e),Ul(t))}function Wx(e,t){const s={};for(const a in e)t.includes(a)||Object.defineProperty(s,a,{enumerable:!0,get:()=>e[a]});return s}function Kx(e){const t=Ls(),s=Yn;let a=e();Vl(),s&&Di(!1);const n=()=>{Qi(t),s&&Di(!0)},i=()=>{Ls()!==t&&t.scope.off(),Vl(),s&&Di(!1)};return Nd(a)&&(a=a.catch(l=>{throw n(),Promise.resolve().then(()=>Promise.resolve().then(i)),l})),[a,()=>{n(),Promise.resolve().then(i)}]}let Xc=!0;function Jx(e){const t=Zd(e),s=e.proxy,a=e.ctx;Xc=!1,t.beforeCreate&&pp(t.beforeCreate,e,"bc");const{data:n,computed:i,methods:l,watch:o,provide:r,inject:c,created:d,beforeMount:u,mounted:p,beforeUpdate:m,updated:h,activated:b,deactivated:I,beforeDestroy:k,beforeUnmount:y,destroyed:g,unmounted:x,render:S,renderTracked:_,renderTriggered:E,errorCaptured:R,serverPrefetch:w,expose:O,inheritAttrs:U,components:T,directives:$,filters:te}=t;if(c&&Zx(c,a,null),l)for(const L in l){const P=l[L];He(P)&&(a[L]=P.bind(s))}if(n){const L=n.call(s,s);mt(L)&&(e.data=Tn(L))}if(Xc=!0,i)for(const L in i){const P=i[L],re=He(P)?P.bind(s,s):He(P.get)?P.get.bind(s,s):hs,ce=!He(P)&&He(P.set)?P.set.bind(s):hs,J=z({get:re,set:ce});Object.defineProperty(a,L,{enumerable:!0,configurable:!0,get:()=>J.value,set:K=>J.value=K})}if(o)for(const L in o)oh(o[L],a,s,L);if(r){const L=He(r)?r.call(s):r;Reflect.ownKeys(L).forEach(P=>{Tl(P,L[P])})}d&&pp(d,e,"c");function M(L,P){Oe(P)?P.forEach(re=>L(re.bind(s))):P&&L(P.bind(s))}if(M(eh,u),M(st,p),M(Gd,m),M(zr,h),M(rs,b),M(Kt,I),M(nh,R),M(ah,_),M(sh,E),M(Hr,y),M(xt,x),M(th,w),Oe(O))if(O.length){const L=e.exposed||(e.exposed={});O.forEach(P=>{Object.defineProperty(L,P,{get:()=>s[P],set:re=>s[P]=re,enumerable:!0})})}else e.exposed||(e.exposed={});S&&e.render===hs&&(e.render=S),U!=null&&(e.inheritAttrs=U),T&&(e.components=T),$&&(e.directives=$),w&&qd(e)}function Zx(e,t,s=hs){Oe(e)&&(e=ed(e));for(const a in e){const n=e[a];let i;mt(n)?"default"in n?i=na(n.from||a,n.default,!0):i=na(n.from||a):i=na(n),Gt(i)?Object.defineProperty(t,a,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):t[a]=i}}function pp(e,t,s){Zs(Oe(e)?e.map(a=>a.bind(t.proxy)):e.bind(t.proxy),t,s)}function oh(e,t,s,a){let n=a.includes(".")?Gm(s,a):()=>s[a];if(Ye(e)){const i=t[e];He(i)&&Wt(n,i)}else if(He(e))Wt(n,e.bind(s));else if(mt(e))if(Oe(e))e.forEach(i=>oh(i,t,s,a));else{const i=He(e.handler)?e.handler.bind(s):t[e.handler];He(i)&&Wt(n,i,e)}}function Zd(e){const t=e.type,{mixins:s,extends:a}=t,{mixins:n,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,o=i.get(t);let r;return o?r=o:!n.length&&!s&&!a?r=t:(r={},n.length&&n.forEach(c=>ar(r,c,l,!0)),ar(r,t,l)),mt(t)&&i.set(t,r),r}function ar(e,t,s,a=!1){const{mixins:n,extends:i}=t;i&&ar(e,i,s,!0),n&&n.forEach(l=>ar(e,l,s,!0));for(const l in t)if(!(a&&l==="expose")){const o=Yx[l]||s&&s[l];e[l]=o?o(e[l],t[l]):t[l]}return e}const Yx={data:fp,props:mp,emits:mp,methods:_l,computed:_l,beforeCreate:Es,created:Es,beforeMount:Es,mounted:Es,beforeUpdate:Es,updated:Es,beforeDestroy:Es,beforeUnmount:Es,destroyed:Es,unmounted:Es,activated:Es,deactivated:Es,errorCaptured:Es,serverPrefetch:Es,components:_l,directives:_l,watch:Xx,provide:fp,inject:Qx};function fp(e,t){return t?e?function(){return nt(He(e)?e.call(this,this):e,He(t)?t.call(this,this):t)}:t:e}function Qx(e,t){return _l(ed(e),ed(t))}function ed(e){if(Oe(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Es(e,t){return e?[...new Set([].concat(e,t))]:t}function _l(e,t){return e?nt(Object.create(null),e,t):t}function mp(e,t){return e?Oe(e)&&Oe(t)?[...new Set([...e,...t])]:nt(Object.create(null),Ul(e),Ul(t??{})):t}function Xx(e,t){if(!e)return t;if(!t)return e;const s=nt(Object.create(null),e);for(const a in t)s[a]=Es(e[a],t[a]);return s}function rh(){return{app:null,config:{isNativeTag:Ci,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let e0=0;function t0(e,t){return function(a,n=null){He(a)||(a=nt({},a)),n!=null&&!mt(n)&&(n=null);const i=rh(),l=new WeakSet,o=[];let r=!1;const c=i.app={_uid:e0++,_component:a,_props:n,_container:null,_context:i,_instance:null,version:zh,get config(){return i.config},set config(d){},use(d,...u){return l.has(d)||(d&&He(d.install)?(l.add(d),d.install(c,...u)):He(d)&&(l.add(d),d(c,...u))),c},mixin(d){return i.mixins.includes(d)||i.mixins.push(d),c},component(d,u){return u?(i.components[d]=u,c):i.components[d]},directive(d,u){return u?(i.directives[d]=u,c):i.directives[d]},mount(d,u,p){if(!r){const m=c._ceVNode||Lt(a,n);return m.appContext=i,p===!0?p="svg":p===!1&&(p=void 0),u&&t?t(m,d):e(m,d,p),r=!0,c._container=d,d.__vue_app__=c,oo(m.component)}},onUnmount(d){o.push(d)},unmount(){r&&(Zs(o,c._instance,16),e(null,c._container),delete c._container.__vue_app__)},provide(d,u){return i.provides[d]=u,c},runWithContext(d){const u=Gn;Gn=c;try{return d()}finally{Gn=u}}};return c}}let Gn=null;function s0(e,t,s=it){const a=Ls(),n=wt(t),i=Us(t),l=ch(e,n),o=Dm((r,c)=>{let d,u=it,p;return qm(()=>{const m=e[n];is(d,m)&&(d=m,c())}),{get(){return r(),s.get?s.get(d):d},set(m){const h=s.set?s.set(m):m;if(!is(h,d)&&!(u!==it&&is(m,u)))return;const b=a.vnode.props,I=!!(b&&(t in b||n in b||i in b)&&(`onUpdate:${t}`in b||`onUpdate:${n}`in b||`onUpdate:${i}`in b));I||(d=m,c()),a.emit(`update:${t}`,h),is(m,u)&&(is(m,h)&&!is(h,p)||I&&u!==it&&!is(h,d))&&c(),u=m,p=h}}});return o[Symbol.iterator]=()=>{let r=0;return{next(){return r<2?{value:r++?l||it:o,done:!1}:{done:!0}}}},o}const ch=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${wt(t)}Modifiers`]||e[`${Us(t)}Modifiers`];function a0(e,t,...s){if(e.isUnmounted)return;const a=e.vnode.props||it;let n=s;const i=t.startsWith("update:"),l=i&&ch(a,t.slice(7));l&&(l.trim&&(n=s.map(d=>Ye(d)?d.trim():d)),l.number&&(n=s.map(Or)));let o,r=a[o=Ii(t)]||a[o=Ii(wt(t))];!r&&i&&(r=a[o=Ii(Us(t))]),r&&Zs(r,e,6,n);const c=a[o+"Once"];if(c){if(!e.emitted)e.emitted={};else if(e.emitted[o])return;e.emitted[o]=!0,Zs(c,e,6,n)}}const n0=new WeakMap;function dh(e,t,s=!1){const a=s?n0:t.emitsCache,n=a.get(e);if(n!==void 0)return n;const i=e.emits;let l={},o=!1;if(!He(e)){const r=c=>{const d=dh(c,t,!0);d&&(o=!0,nt(l,d))};!s&&t.mixins.length&&t.mixins.forEach(r),e.extends&&r(e.extends),e.mixins&&e.mixins.forEach(r)}return!i&&!o?(mt(e)&&a.set(e,null),null):(Oe(i)?i.forEach(r=>l[r]=null):nt(l,i),mt(e)&&a.set(e,l),l)}function jr(e,t){return!e||!ei(t)?!1:(t=t.slice(2).replace(/Once$/,""),ht(e,t[0].toLowerCase()+t.slice(1))||ht(e,Us(t))||ht(e,t))}function Ho(e){const{type:t,vnode:s,proxy:a,withProxy:n,propsOptions:[i],slots:l,attrs:o,emit:r,render:c,renderCache:d,props:u,data:p,setupState:m,ctx:h,inheritAttrs:b}=e,I=Bl(e);let k,y;try{if(s.shapeFlag&4){const x=n||a,S=x;k=Bs(c.call(S,x,d,u,m,p,h)),y=o}else{const x=t;k=Bs(x.length>1?x(u,{attrs:o,slots:l,emit:r}):x(u,null)),y=t.props?o:l0(o)}}catch(x){Al.length=0,ai(x,e,1),k=Lt(Ht)}let g=k;if(y&&b!==!1){const x=Object.keys(y),{shapeFlag:S}=g;x.length&&S&7&&(i&&x.some(Er)&&(y=o0(y,i)),g=Oa(g,y,!1,!0))}return s.dirs&&(g=Oa(g,null,!1,!0),g.dirs=g.dirs?g.dirs.concat(s.dirs):s.dirs),s.transition&&an(g,s.transition),k=g,Bl(I),k}function i0(e,t=!0){let s;for(let a=0;a<e.length;a++){const n=e[a];if(nn(n)){if(n.type!==Ht||n.children==="v-if"){if(s)return;s=n}}else return}return s}const l0=e=>{let t;for(const s in e)(s==="class"||s==="style"||ei(s))&&((t||(t={}))[s]=e[s]);return t},o0=(e,t)=>{const s={};for(const a in e)(!Er(a)||!(a.slice(9)in t))&&(s[a]=e[a]);return s};function r0(e,t,s){const{props:a,children:n,component:i}=e,{props:l,children:o,patchFlag:r}=t,c=i.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&r>=0){if(r&1024)return!0;if(r&16)return a?hp(a,l,c):!!l;if(r&8){const d=t.dynamicProps;for(let u=0;u<d.length;u++){const p=d[u];if(uh(l,a,p)&&!jr(c,p))return!0}}}else return(n||o)&&(!o||!o.$stable)?!0:a===l?!1:a?l?hp(a,l,c):!0:!!l;return!1}function hp(e,t,s){const a=Object.keys(t);if(a.length!==Object.keys(e).length)return!0;for(let n=0;n<a.length;n++){const i=a[n];if(uh(t,e,i)&&!jr(s,i))return!0}return!1}function uh(e,t,s){const a=e[s],n=t[s];return s==="style"&&mt(a)&&mt(n)?!en(a,n):a!==n}function Vr({vnode:e,parent:t,suspense:s},a){for(;t;){const n=t.subTree;if(n.suspense&&n.suspense.activeBranch===e&&(n.suspense.vnode.el=n.el=a,e=n),n===e)(e=t.vnode).el=a,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=a)}const ph={},fh=()=>Object.create(ph),mh=e=>Object.getPrototypeOf(e)===ph;function c0(e,t,s,a=!1){const n={},i=fh();e.propsDefaults=Object.create(null),hh(e,t,n,i);for(const l in e.propsOptions[0])l in n||(n[l]=void 0);s?e.props=a?n:Fd(n):e.type.props?e.props=n:e.props=i,e.attrs=i}function d0(e,t,s,a){const{props:n,attrs:i,vnode:{patchFlag:l}}=e,o=dt(n),[r]=e.propsOptions;let c=!1;if((a||l>0)&&!(l&16)){if(l&8){const d=e.vnode.dynamicProps;for(let u=0;u<d.length;u++){let p=d[u];if(jr(e.emitsOptions,p))continue;const m=t[p];if(r)if(ht(i,p))m!==i[p]&&(i[p]=m,c=!0);else{const h=wt(p);n[h]=td(r,o,h,m,e,!1)}else m!==i[p]&&(i[p]=m,c=!0)}}}else{hh(e,t,n,i)&&(c=!0);let d;for(const u in o)(!t||!ht(t,u)&&((d=Us(u))===u||!ht(t,d)))&&(r?s&&(s[u]!==void 0||s[d]!==void 0)&&(n[u]=td(r,o,u,void 0,e,!0)):delete n[u]);if(i!==o)for(const u in i)(!t||!ht(t,u))&&(delete i[u],c=!0)}c&&qa(e.attrs,"set","")}function hh(e,t,s,a){const[n,i]=e.propsOptions;let l=!1,o;if(t)for(let r in t){if(Za(r))continue;const c=t[r];let d;n&&ht(n,d=wt(r))?!i||!i.includes(d)?s[d]=c:(o||(o={}))[d]=c:jr(e.emitsOptions,r)||(!(r in a)||c!==a[r])&&(a[r]=c,l=!0)}if(i){const r=dt(s),c=o||it;for(let d=0;d<i.length;d++){const u=i[d];s[u]=td(n,r,u,c[u],e,!ht(c,u))}}return l}function td(e,t,s,a,n,i){const l=e[s];if(l!=null){const o=ht(l,"default");if(o&&a===void 0){const r=l.default;if(l.type!==Function&&!l.skipFactory&&He(r)){const{propsDefaults:c}=n;if(s in c)a=c[s];else{const d=Qi(n);a=c[s]=r.call(null,t),d()}}else a=r;n.ce&&n.ce._setProp(s,a)}l[0]&&(i&&!o?a=!1:l[1]&&(a===""||a===Us(s))&&(a=!0))}return a}const u0=new WeakMap;function vh(e,t,s=!1){const a=s?u0:t.propsCache,n=a.get(e);if(n)return n;const i=e.props,l={},o=[];let r=!1;if(!He(e)){const d=u=>{r=!0;const[p,m]=vh(u,t,!0);nt(l,p),m&&o.push(...m)};!s&&t.mixins.length&&t.mixins.forEach(d),e.extends&&d(e.extends),e.mixins&&e.mixins.forEach(d)}if(!i&&!r)return mt(e)&&a.set(e,Ai),Ai;if(Oe(i))for(let d=0;d<i.length;d++){const u=wt(i[d]);vp(u)&&(l[u]=it)}else if(i)for(const d in i){const u=wt(d);if(vp(u)){const p=i[d],m=l[u]=Oe(p)||He(p)?{type:p}:nt({},p),h=m.type;let b=!1,I=!0;if(Oe(h))for(let k=0;k<h.length;++k){const y=h[k],g=He(y)&&y.name;if(g==="Boolean"){b=!0;break}else g==="String"&&(I=!1)}else b=He(h)&&h.name==="Boolean";m[0]=b,m[1]=I,(b||ht(m,"default"))&&o.push(u)}}const c=[l,o];return mt(e)&&a.set(e,c),c}function vp(e){return e[0]!=="$"&&!Za(e)}const Yd=e=>e==="_"||e==="_ctx"||e==="$stable",Qd=e=>Oe(e)?e.map(Bs):[Bs(e)],p0=(e,t,s)=>{if(t._n)return t;const a=Hd((...n)=>Qd(t(...n)),s);return a._c=!1,a},gh=(e,t,s)=>{const a=e._ctx;for(const n in e){if(Yd(n))continue;const i=e[n];if(He(i))t[n]=p0(n,i,a);else if(i!=null){const l=Qd(i);t[n]=()=>l}}},bh=(e,t)=>{const s=Qd(t);e.slots.default=()=>s},yh=(e,t,s)=>{for(const a in t)(s||!Yd(a))&&(e[a]=t[a])},f0=(e,t,s)=>{const a=e.slots=fh();if(e.vnode.shapeFlag&32){const n=t._;n?(yh(a,t,s),s&&um(a,"_",n,!0)):gh(t,a)}else t&&bh(e,t)},m0=(e,t,s)=>{const{vnode:a,slots:n}=e;let i=!0,l=it;if(a.shapeFlag&32){const o=t._;o?s&&o===1?i=!1:yh(n,t,s):(i=!t.$stable,gh(t,n)),l=t}else t&&(bh(e,t),l={default:1});if(i)for(const o in n)!Yd(o)&&l[o]==null&&delete n[o]},Vt=Eh;function xh(e){return wh(e)}function _h(e){return wh(e,fx)}function wh(e,t){const s=Lr();s.__VUE__=!0;const{insert:a,remove:n,patchProp:i,createElement:l,createText:o,createComment:r,setText:c,setElementText:d,parentNode:u,nextSibling:p,setScopeId:m=hs,insertStaticContent:h}=e,b=(A,D,G,pe=null,B=null,Y=null,ue=void 0,j=null,X=!!D.dynamicChildren)=>{if(A===D)return;A&&!fa(A,D)&&(pe=ie(A),K(A,B,Y,!0),A=null),D.patchFlag===-2&&(X=!1,D.dynamicChildren=null);const{type:ee,ref:be,shapeFlag:he}=D;switch(ee){case kn:I(A,D,G,pe);break;case Ht:k(A,D,G,pe);break;case Wn:A==null&&y(D,G,pe,ue);break;case ls:T(A,D,G,pe,B,Y,ue,j,X);break;default:he&1?S(A,D,G,pe,B,Y,ue,j,X):he&6?$(A,D,G,pe,B,Y,ue,j,X):(he&64||he&128)&&ee.process(A,D,G,pe,B,Y,ue,j,X,me)}be!=null&&B?Ni(be,A&&A.ref,Y,D||A,!D):be==null&&A&&A.ref!=null&&Ni(A.ref,null,Y,A,!0)},I=(A,D,G,pe)=>{if(A==null)a(D.el=o(D.children),G,pe);else{const B=D.el=A.el;D.children!==A.children&&c(B,D.children)}},k=(A,D,G,pe)=>{A==null?a(D.el=r(D.children||""),G,pe):D.el=A.el},y=(A,D,G,pe)=>{[A.el,A.anchor]=h(A.children,D,G,pe,A.el,A.anchor)},g=({el:A,anchor:D},G,pe)=>{let B;for(;A&&A!==D;)B=p(A),a(A,G,pe),A=B;a(D,G,pe)},x=({el:A,anchor:D})=>{let G;for(;A&&A!==D;)G=p(A),n(A),A=G;n(D)},S=(A,D,G,pe,B,Y,ue,j,X)=>{if(D.type==="svg"?ue="svg":D.type==="math"&&(ue="mathml"),A==null)_(D,G,pe,B,Y,ue,j,X);else{const ee=A.el&&A.el._isVueCE?A.el:null;try{ee&&ee._beginPatch(),w(A,D,B,Y,ue,j,X)}finally{ee&&ee._endPatch()}}},_=(A,D,G,pe,B,Y,ue,j)=>{let X,ee;const{props:be,shapeFlag:he,transition:we,dirs:_e}=A;if(X=A.el=l(A.type,Y,be&&be.is,be),he&8?d(X,A.children):he&16&&R(A.children,X,null,pe,B,wc(A,Y),ue,j),_e&&Ea(A,null,pe,"created"),E(X,A,A.scopeId,ue,pe),be){for(const Ke in be)Ke!=="value"&&!Za(Ke)&&i(X,Ke,null,be[Ke],Y,pe);"value"in be&&i(X,"value",null,be.value,Y),(ee=be.onVnodeBeforeMount)&&$s(ee,pe,A)}_e&&Ea(A,null,pe,"beforeMount");const ye=kh(B,we);ye&&we.beforeEnter(X),a(X,D,G),((ee=be&&be.onVnodeMounted)||ye||_e)&&Vt(()=>{try{ee&&$s(ee,pe,A),ye&&we.enter(X),_e&&Ea(A,null,pe,"mounted")}finally{}},B)},E=(A,D,G,pe,B)=>{if(G&&m(A,G),pe)for(let Y=0;Y<pe.length;Y++)m(A,pe[Y]);if(B){let Y=B.subTree;if(D===Y||ir(Y.type)&&(Y.ssContent===D||Y.ssFallback===D)){const ue=B.vnode;E(A,ue,ue.scopeId,ue.slotScopeIds,B.parent)}}},R=(A,D,G,pe,B,Y,ue,j,X=0)=>{for(let ee=X;ee<A.length;ee++){const be=A[ee]=j?ja(A[ee]):Bs(A[ee]);b(null,be,D,G,pe,B,Y,ue,j)}},w=(A,D,G,pe,B,Y,ue)=>{const j=D.el=A.el;let{patchFlag:X,dynamicChildren:ee,dirs:be}=D;X|=A.patchFlag&16;const he=A.props||it,we=D.props||it;let _e;if(G&&Pn(G,!1),(_e=we.onVnodeBeforeUpdate)&&$s(_e,G,D,A),be&&Ea(D,A,G,"beforeUpdate"),G&&Pn(G,!0),(he.innerHTML&&we.innerHTML==null||he.textContent&&we.textContent==null)&&d(j,""),ee?O(A.dynamicChildren,ee,j,G,pe,wc(D,B),Y):ue||P(A,D,j,null,G,pe,wc(D,B),Y,!1),X>0){if(X&16)U(j,he,we,G,B);else if(X&2&&he.class!==we.class&&i(j,"class",null,we.class,B),X&4&&i(j,"style",he.style,we.style,B),X&8){const ye=D.dynamicProps;for(let Ke=0;Ke<ye.length;Ke++){const Je=ye[Ke],Fe=he[Je],Ge=we[Je];(Ge!==Fe||Je==="value")&&i(j,Je,Fe,Ge,B,G)}}X&1&&A.children!==D.children&&d(j,D.children)}else!ue&&ee==null&&U(j,he,we,G,B);((_e=we.onVnodeUpdated)||be)&&Vt(()=>{_e&&$s(_e,G,D,A),be&&Ea(D,A,G,"updated")},pe)},O=(A,D,G,pe,B,Y,ue)=>{for(let j=0;j<D.length;j++){const X=A[j],ee=D[j],be=X.el&&(X.type===ls||!fa(X,ee)||X.shapeFlag&198)?u(X.el):G;b(X,ee,be,null,pe,B,Y,ue,!0)}},U=(A,D,G,pe,B)=>{if(D!==G){if(D!==it)for(const Y in D)!Za(Y)&&!(Y in G)&&i(A,Y,D[Y],null,B,pe);for(const Y in G){if(Za(Y))continue;const ue=G[Y],j=D[Y];ue!==j&&Y!=="value"&&i(A,Y,j,ue,B,pe)}"value"in G&&i(A,"value",D.value,G.value,B)}},T=(A,D,G,pe,B,Y,ue,j,X)=>{const ee=D.el=A?A.el:o(""),be=D.anchor=A?A.anchor:o("");let{patchFlag:he,dynamicChildren:we,slotScopeIds:_e}=D;_e&&(j=j?j.concat(_e):_e),A==null?(a(ee,G,pe),a(be,G,pe),R(D.children||[],G,be,B,Y,ue,j,X)):he>0&&he&64&&we&&A.dynamicChildren&&A.dynamicChildren.length===we.length?(O(A.dynamicChildren,we,G,B,Y,ue,j),(D.key!=null||B&&D===B.subTree)&&Xd(A,D,!0)):P(A,D,G,be,B,Y,ue,j,X)},$=(A,D,G,pe,B,Y,ue,j,X)=>{D.slotScopeIds=j,A==null?D.shapeFlag&512?B.ctx.activate(D,G,pe,ue,X):te(D,G,pe,B,Y,ue,X):W(A,D,X)},te=(A,D,G,pe,B,Y,ue)=>{const j=A.component=Mh(A,pe,B);if(lo(A)&&(j.ctx.renderer=me),Ph(j,!1,ue),j.asyncDep){if(B&&B.registerDep(j,M,ue),!A.el){const X=j.subTree=Lt(Ht);k(null,X,D,G),A.placeholder=X.el}}else M(j,A,D,G,B,Y,ue)},W=(A,D,G)=>{const pe=D.component=A.component;if(r0(A,D,G))if(pe.asyncDep&&!pe.asyncResolved){L(pe,D,G);return}else pe.next=D,pe.update();else D.el=A.el,pe.vnode=D},M=(A,D,G,pe,B,Y,ue)=>{const j=()=>{if(A.isMounted){let{next:he,bu:we,u:_e,parent:ye,vnode:Ke}=A;{const Xe=Sh(A);if(Xe){he&&(he.el=Ke.el,L(A,he,ue)),Xe.asyncDep.then(()=>{Vt(()=>{A.isUnmounted||ee()},B)});return}}let Je=he,Fe;Pn(A,!1),he?(he.el=Ke.el,L(A,he,ue)):he=Ke,we&&Oi(we),(Fe=he.props&&he.props.onVnodeBeforeUpdate)&&$s(Fe,ye,he,Ke),Pn(A,!0);const Ge=Ho(A),at=A.subTree;A.subTree=Ge,b(at,Ge,u(at.el),ie(at),A,B,Y),he.el=Ge.el,Je===null&&Vr(A,Ge.el),_e&&Vt(_e,B),(Fe=he.props&&he.props.onVnodeUpdated)&&Vt(()=>$s(Fe,ye,he,Ke),B)}else{let he;const{el:we,props:_e}=D,{bm:ye,m:Ke,parent:Je,root:Fe,type:Ge}=A,at=Qa(D);if(Pn(A,!1),ye&&Oi(ye),!at&&(he=_e&&_e.onVnodeBeforeMount)&&$s(he,Je,D),Pn(A,!0),we&&Ne){const Xe=()=>{A.subTree=Ho(A),Ne(we,A.subTree,A,B,null)};at&&Ge.__asyncHydrate?Ge.__asyncHydrate(we,A,Xe):Xe()}else{Fe.ce&&Fe.ce._hasShadowRoot()&&Fe.ce._injectChildStyle(Ge,A.parent?A.parent.type:void 0);const Xe=A.subTree=Ho(A);b(null,Xe,G,pe,A,B,Y),D.el=Xe.el}if(Ke&&Vt(Ke,B),!at&&(he=_e&&_e.onVnodeMounted)){const Xe=D;Vt(()=>$s(he,Je,Xe),B)}(D.shapeFlag&256||Je&&Qa(Je.vnode)&&Je.vnode.shapeFlag&256)&&A.a&&Vt(A.a,B),A.isMounted=!0,D=G=pe=null}};A.scope.on();const X=A.effect=new Ml(j);A.scope.off();const ee=A.update=X.run.bind(X),be=A.job=X.runIfDirty.bind(X);be.i=A,be.id=A.uid,X.scheduler=()=>zd(be),Pn(A,!0),ee()},L=(A,D,G)=>{D.component=A;const pe=A.vnode.props;A.vnode=D,A.next=null,d0(A,D.props,pe,G),m0(A,D.children,G),tn(),ap(A),sn()},P=(A,D,G,pe,B,Y,ue,j,X=!1)=>{const ee=A&&A.children,be=A?A.shapeFlag:0,he=D.children,{patchFlag:we,shapeFlag:_e}=D;if(we>0){if(we&128){ce(ee,he,G,pe,B,Y,ue,j,X);return}else if(we&256){re(ee,he,G,pe,B,Y,ue,j,X);return}}_e&8?(be&16&&Ie(ee,B,Y),he!==ee&&d(G,he)):be&16?_e&16?ce(ee,he,G,pe,B,Y,ue,j,X):Ie(ee,B,Y,!0):(be&8&&d(G,""),_e&16&&R(he,G,pe,B,Y,ue,j,X))},re=(A,D,G,pe,B,Y,ue,j,X)=>{A=A||Ai,D=D||Ai;const ee=A.length,be=D.length,he=Math.min(ee,be);let we;for(we=0;we<he;we++){const _e=D[we]=X?ja(D[we]):Bs(D[we]);b(A[we],_e,G,null,B,Y,ue,j,X)}ee>be?Ie(A,B,Y,!0,!1,he):R(D,G,pe,B,Y,ue,j,X,he)},ce=(A,D,G,pe,B,Y,ue,j,X)=>{let ee=0;const be=D.length;let he=A.length-1,we=be-1;for(;ee<=he&&ee<=we;){const _e=A[ee],ye=D[ee]=X?ja(D[ee]):Bs(D[ee]);if(fa(_e,ye))b(_e,ye,G,null,B,Y,ue,j,X);else break;ee++}for(;ee<=he&&ee<=we;){const _e=A[he],ye=D[we]=X?ja(D[we]):Bs(D[we]);if(fa(_e,ye))b(_e,ye,G,null,B,Y,ue,j,X);else break;he--,we--}if(ee>he){if(ee<=we){const _e=we+1,ye=_e<be?D[_e].el:pe;for(;ee<=we;)b(null,D[ee]=X?ja(D[ee]):Bs(D[ee]),G,ye,B,Y,ue,j,X),ee++}}else if(ee>we)for(;ee<=he;)K(A[ee],B,Y,!0),ee++;else{const _e=ee,ye=ee,Ke=new Map;for(ee=ye;ee<=we;ee++){const Ae=D[ee]=X?ja(D[ee]):Bs(D[ee]);Ae.key!=null&&Ke.set(Ae.key,ee)}let Je,Fe=0;const Ge=we-ye+1;let at=!1,Xe=0;const Z=new Array(Ge);for(ee=0;ee<Ge;ee++)Z[ee]=0;for(ee=_e;ee<=he;ee++){const Ae=A[ee];if(Fe>=Ge){K(Ae,B,Y,!0);continue}let Me;if(Ae.key!=null)Me=Ke.get(Ae.key);else for(Je=ye;Je<=we;Je++)if(Z[Je-ye]===0&&fa(Ae,D[Je])){Me=Je;break}Me===void 0?K(Ae,B,Y,!0):(Z[Me-ye]=ee+1,Me>=Xe?Xe=Me:at=!0,b(Ae,D[Me],G,null,B,Y,ue,j,X),Fe++)}const Ee=at?h0(Z):Ai;for(Je=Ee.length-1,ee=Ge-1;ee>=0;ee--){const Ae=ye+ee,Me=D[Ae],se=D[Ae+1],Le=Ae+1<be?se.el||Ch(se):pe;Z[ee]===0?b(null,Me,G,Le,B,Y,ue,j,X):at&&(Je<0||ee!==Ee[Je]?J(Me,G,Le,2):Je--)}}},J=(A,D,G,pe,B=null)=>{const{el:Y,type:ue,transition:j,children:X,shapeFlag:ee}=A;if(ee&6){J(A.component.subTree,D,G,pe);return}if(ee&128){A.suspense.move(D,G,pe);return}if(ee&64){ue.move(A,D,G,me);return}if(ue===ls){a(Y,D,G);for(let he=0;he<X.length;he++)J(X[he],D,G,pe);a(A.anchor,D,G);return}if(ue===Wn){g(A,D,G);return}if(pe!==2&&ee&1&&j)if(pe===0)j.persisted&&!Y[ea]?a(Y,D,G):(j.beforeEnter(Y),a(Y,D,G),Vt(()=>j.enter(Y),B));else{const{leave:he,delayLeave:we,afterLeave:_e}=j,ye=()=>{A.ctx.isUnmounted?n(Y):a(Y,D,G)},Ke=()=>{const Je=Y._isLeaving||!!Y[ea];Y._isLeaving&&Y[ea](!0),j.persisted&&!Je?ye():he(Y,()=>{ye(),_e&&_e()})};we?we(Y,ye,Ke):Ke()}else a(Y,D,G)},K=(A,D,G,pe=!1,B=!1)=>{const{type:Y,props:ue,ref:j,children:X,dynamicChildren:ee,shapeFlag:be,patchFlag:he,dirs:we,cacheIndex:_e,memo:ye}=A;if(he===-2&&(B=!1),j!=null&&(tn(),Ni(j,null,G,A,!0),sn()),_e!=null&&(D.renderCache[_e]=void 0),be&256){D.ctx.deactivate(A);return}const Ke=be&1&&we,Je=!Qa(A);let Fe;if(Je&&(Fe=ue&&ue.onVnodeBeforeUnmount)&&$s(Fe,D,A),be&6)ve(A.component,G,pe);else{if(be&128){A.suspense.unmount(G,pe);return}Ke&&Ea(A,null,D,"beforeUnmount"),be&64?A.type.remove(A,D,G,me,pe):ee&&!ee.hasOnce&&(Y!==ls||he>0&&he&64)?Ie(ee,D,G,!1,!0):(Y===ls&&he&384||!B&&be&16)&&Ie(X,D,G),pe&&ae(A)}const Ge=ye!=null&&_e==null;(Je&&(Fe=ue&&ue.onVnodeUnmounted)||Ke||Ge)&&Vt(()=>{Fe&&$s(Fe,D,A),Ke&&Ea(A,null,D,"unmounted"),Ge&&(A.el=null)},G)},ae=A=>{const{type:D,el:G,anchor:pe,transition:B}=A;if(D===ls){V(G,pe);return}if(D===Wn){x(A);return}const Y=()=>{n(G),B&&!B.persisted&&B.afterLeave&&B.afterLeave()};if(A.shapeFlag&1&&B&&!B.persisted){const{leave:ue,delayLeave:j}=B,X=()=>ue(G,Y);j?j(A.el,Y,X):X()}else Y()},V=(A,D)=>{let G;for(;A!==D;)G=p(A),n(A),A=G;n(D)},ve=(A,D,G)=>{const{bum:pe,scope:B,job:Y,subTree:ue,um:j,m:X,a:ee}=A;nr(X),nr(ee),pe&&Oi(pe),B.stop(),Y&&(Y.flags|=8,K(ue,A,D,G)),j&&Vt(j,D),Vt(()=>{A.isUnmounted=!0},D)},Ie=(A,D,G,pe=!1,B=!1,Y=0)=>{for(let ue=Y;ue<A.length;ue++)K(A[ue],D,G,pe,B)},ie=A=>{if(A.shapeFlag&6)return ie(A.component.subTree);if(A.shapeFlag&128)return A.suspense.next();const D=p(A.anchor||A.el),G=D&&D[Wm];return G?p(G):D};let le=!1;const fe=(A,D,G)=>{let pe;A==null?D._vnode&&(K(D._vnode,null,null,!0),pe=D._vnode.component):b(D._vnode||null,A,D,null,null,null,G),D._vnode=A,le||(le=!0,ap(pe),tr(),le=!1)},me={p:b,um:K,m:J,r:ae,mt:te,mc:R,pc:P,pbc:O,n:ie,o:e};let ge,Ne;return t&&([ge,Ne]=t(me)),{render:fe,hydrate:ge,createApp:t0(fe,ge)}}function wc({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Pn({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function kh(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function Xd(e,t,s=!1){const a=e.children,n=t.children;if(Oe(a)&&Oe(n))for(let i=0;i<a.length;i++){const l=a[i];let o=n[i];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=n[i]=ja(n[i]),o.el=l.el),!s&&o.patchFlag!==-2&&Xd(l,o)),o.type===kn&&(o.patchFlag===-1&&(o=n[i]=ja(o)),o.el=l.el),o.type===Ht&&!o.el&&(o.el=l.el)}}function h0(e){const t=e.slice(),s=[0];let a,n,i,l,o;const r=e.length;for(a=0;a<r;a++){const c=e[a];if(c!==0){if(n=s[s.length-1],e[n]<c){t[a]=n,s.push(a);continue}for(i=0,l=s.length-1;i<l;)o=i+l>>1,e[s[o]]<c?i=o+1:l=o;c<e[s[i]]&&(i>0&&(t[a]=s[i-1]),s[i]=a)}}for(i=s.length,l=s[i-1];i-- >0;)s[i]=l,l=t[l];return s}function Sh(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:Sh(t)}function nr(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Ch(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Ch(t.subTree):null}const ir=e=>e.__isSuspense;let sd=0;const v0={name:"Suspense",__isSuspense:!0,process(e,t,s,a,n,i,l,o,r,c){if(e==null)b0(t,s,a,n,i,l,o,r,c);else{if(i&&i.deps>0&&!e.suspense.isInFallback){t.suspense=e.suspense,t.suspense.vnode=t,t.el=e.el;return}y0(e,t,s,a,n,l,o,r,c)}},hydrate:x0,normalize:_0},g0=v0;function zl(e,t){const s=e.props&&e.props[t];He(s)&&s()}function b0(e,t,s,a,n,i,l,o,r){const{p:c,o:{createElement:d}}=r,u=d("div"),p=e.suspense=Th(e,n,a,t,u,s,i,l,o,r);c(null,p.pendingBranch=e.ssContent,u,null,a,p,i,l),p.deps>0?(zl(e,"onPending"),zl(e,"onFallback"),c(null,e.ssFallback,t,s,a,null,i,l),Mi(p,e.ssFallback)):p.resolve(!1,!0)}function y0(e,t,s,a,n,i,l,o,{p:r,um:c,o:{createElement:d}}){const u=t.suspense=e.suspense;u.vnode=t,t.el=e.el;const p=t.ssContent,m=t.ssFallback,{activeBranch:h,pendingBranch:b,isInFallback:I,isHydrating:k}=u;if(b)u.pendingBranch=p,fa(b,p)?(r(b,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0?u.resolve():I&&(k||(r(h,m,s,a,n,null,i,l,o),Mi(u,m)))):(u.pendingId=sd++,k?(u.isHydrating=!1,u.activeBranch=b):c(b,n,u),u.deps=0,u.effects.length=0,u.hiddenContainer=d("div"),I?(r(null,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0?u.resolve():(r(h,m,s,a,n,null,i,l,o),Mi(u,m))):h&&fa(h,p)?(r(h,p,s,a,n,u,i,l,o),u.resolve(!0)):(r(null,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0&&u.resolve()));else if(h&&fa(h,p))r(h,p,s,a,n,u,i,l,o),Mi(u,p);else if(zl(t,"onPending"),u.pendingBranch=p,p.shapeFlag&512?u.pendingId=p.component.suspenseId:u.pendingId=sd++,r(null,p,u.hiddenContainer,null,n,u,i,l,o),u.deps<=0)u.resolve();else{const{timeout:y,pendingId:g}=u;y>0?setTimeout(()=>{u.pendingId===g&&u.fallback(m)},y):y===0&&u.fallback(m)}}function Th(e,t,s,a,n,i,l,o,r,c,d=!1){const{p:u,m:p,um:m,n:h,o:{parentNode:b,remove:I}}=c;let k;const y=w0(e);y&&t&&t.pendingBranch&&(k=t.pendingId,t.deps++);const g=e.props?Zo(e.props.timeout):void 0,x=i,S={vnode:e,parent:t,parentComponent:s,namespace:l,container:a,hiddenContainer:n,deps:0,pendingId:sd++,timeout:typeof g=="number"?g:-1,activeBranch:null,isFallbackMountPending:!1,pendingBranch:null,isInFallback:!d,isHydrating:d,isUnmounted:!1,effects:[],resolve(_=!1,E=!1){const{vnode:R,activeBranch:w,pendingBranch:O,pendingId:U,effects:T,parentComponent:$,container:te,isInFallback:W}=S;let M=!1;if(S.isHydrating)S.isHydrating=!1;else if(!_){M=w&&O.transition&&O.transition.mode==="out-in";let re=!1;M&&(w.transition.afterLeave=()=>{U===S.pendingId&&(p(O,te,i===x&&!re?h(w):i,0),$l(T),W&&R.ssFallback&&(R.ssFallback.el=null))}),w&&!S.isFallbackMountPending&&(b(w.el)===te&&(i=h(w),re=!0),m(w,$,S,!0),!M&&W&&R.ssFallback&&Vt(()=>R.ssFallback.el=null,S)),M||p(O,te,i,0)}S.isFallbackMountPending=!1,Mi(S,O),S.pendingBranch=null,S.isInFallback=!1;let L=S.parent,P=!1;for(;L;){if(L.pendingBranch){L.effects.push(...T),P=!0;break}L=L.parent}!P&&!M&&$l(T),S.effects=[],y&&t&&t.pendingBranch&&k===t.pendingId&&(t.deps--,t.deps===0&&!E&&t.resolve()),zl(R,"onResolve")},fallback(_){if(!S.pendingBranch)return;const{vnode:E,activeBranch:R,parentComponent:w,container:O,namespace:U}=S;zl(E,"onFallback");const T=h(R),$=()=>{S.isFallbackMountPending=!1,S.isInFallback&&(u(null,_,O,T,w,null,U,o,r),Mi(S,_))},te=_.transition&&_.transition.mode==="out-in";te&&(S.isFallbackMountPending=!0,R.transition.afterLeave=$),S.isInFallback=!0,m(R,w,null,!0),te||$()},move(_,E,R){S.activeBranch&&p(S.activeBranch,_,E,R),S.container=_},next(){return S.activeBranch&&h(S.activeBranch)},registerDep(_,E,R){const w=!!S.pendingBranch;w&&S.deps++;const O=_.vnode.el;_.asyncDep.catch(U=>{ai(U,_,0)}).then(U=>{if(_.isUnmounted||S.isUnmounted||S.pendingId!==_.suspenseId)return;Vl(),_.asyncResolved=!0;const{vnode:T}=_;ad(_,U,!1),O&&(T.el=O);const $=!O&&_.subTree.el;E(_,T,b(O||_.subTree.el),O?null:h(_.subTree),S,l,R),$&&(T.placeholder=null,I($)),Vr(_,T.el),w&&--S.deps===0&&S.resolve()})},unmount(_,E){S.isUnmounted=!0,S.activeBranch&&m(S.activeBranch,s,_,E),S.pendingBranch&&m(S.pendingBranch,s,_,E)}};return S}function x0(e,t,s,a,n,i,l,o,r){const c=t.suspense=Th(t,a,s,e.parentNode,document.createElement("div"),null,n,i,l,o,!0),d=r(e,c.pendingBranch=t.ssContent,s,c,i,l);return c.deps===0&&c.resolve(!1,!0),d}function _0(e){const{shapeFlag:t,children:s}=e,a=t&32;e.ssContent=gp(a?s.default:s),e.ssFallback=a?gp(s.fallback):Lt(Ht)}function gp(e){let t;if(He(e)){const s=Zn&&e._c;s&&(e._d=!1,Hl()),e=e(),s&&(e._d=!0,t=ks,Ah())}return Oe(e)&&(e=i0(e)),e=Bs(e),t&&!e.dynamicChildren&&(e.dynamicChildren=t.filter(s=>s!==e)),e}function Eh(e,t){t&&t.pendingBranch?Oe(e)?t.effects.push(...e):t.effects.push(e):$l(e)}function Mi(e,t){e.activeBranch=t;const{vnode:s,parentComponent:a}=e;let n=t.el;for(;!n&&t.component;)t=t.component.subTree,n=t.el;s.el=n,a&&a.subTree===s&&(a.vnode.el=n,Vr(a,n))}function w0(e){const t=e.props&&e.props.suspensible;return t!=null&&t!==!1}const ls=Symbol.for("v-fgt"),kn=Symbol.for("v-txt"),Ht=Symbol.for("v-cmt"),Wn=Symbol.for("v-stc"),Al=[];let ks=null;function Hl(e=!1){Al.push(ks=e?null:[])}function Ah(){Al.pop(),ks=Al[Al.length-1]||null}let Zn=1;function jl(e,t=!1){Zn+=e,e<0&&ks&&t&&(ks.hasOnce=!0)}function Rh(e){return e.dynamicChildren=Zn>0?ks||Ai:null,Ah(),Zn>0&&ks&&ks.push(e),e}function k0(e,t,s,a,n,i){return Rh(eu(e,t,s,a,n,i,!0))}function lr(e,t,s,a,n){return Rh(Lt(e,t,s,a,n,!0))}function nn(e){return e?e.__v_isVNode===!0:!1}function fa(e,t){return e.type===t.type&&e.key===t.key}function S0(e){}const Ih=({key:e})=>e??null,jo=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?Ye(e)||Gt(e)||He(e)?{i:ms,r:e,k:t,f:!!s}:e:null);function eu(e,t=null,s=null,a=0,n=null,i=e===ls?0:1,l=!1,o=!1){const r={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Ih(t),ref:t&&jo(t),scopeId:Fr,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:a,dynamicProps:n,dynamicChildren:null,appContext:null,ctx:ms};return o?(su(r,s),i&128&&e.normalize(r)):s&&(r.shapeFlag|=Ye(s)?8:16),Zn>0&&!l&&ks&&(r.patchFlag>0||i&6)&&r.patchFlag!==32&&ks.push(r),r}const Lt=C0;function C0(e,t=null,s=null,a=0,n=null,i=!1){if((!e||e===ih)&&(e=Ht),nn(e)){const o=Oa(e,t,!0);return s&&su(o,s),Zn>0&&!i&&ks&&(o.shapeFlag&6?ks[ks.indexOf(e)]=o:ks.push(o)),o.patchFlag=-2,o}if(L0(e)&&(e=e.__vccOpts),t){t=Oh(t);let{class:o,style:r}=t;o&&!Ye(o)&&(t.class=so(o)),mt(r)&&(ao(r)&&!Oe(r)&&(r=nt({},r)),t.style=to(r))}const l=Ye(e)?1:ir(e)?128:Km(e)?64:mt(e)?4:He(e)?2:0;return eu(e,t,s,a,n,l,i,!0)}function Oh(e){return e?ao(e)||mh(e)?nt({},e):e:null}function Oa(e,t,s=!1,a=!1){const{props:n,ref:i,patchFlag:l,children:o,transition:r}=e,c=t?Nh(n||{},t):n,d={__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&Ih(c),ref:t&&t.ref?s&&i?Oe(i)?i.concat(jo(t)):[i,jo(t)]:jo(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:o,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==ls?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:r,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Oa(e.ssContent),ssFallback:e.ssFallback&&Oa(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return r&&a&&an(d,r.clone(d)),d}function tu(e=" ",t=0){return Lt(kn,null,e,t)}function T0(e,t){const s=Lt(Wn,null,e);return s.staticCount=t,s}function Lh(e="",t=!1){return t?(Hl(),lr(Ht,null,e)):Lt(Ht,null,e)}function Bs(e){return e==null||typeof e=="boolean"?Lt(Ht):Oe(e)?Lt(ls,null,e.slice()):nn(e)?ja(e):Lt(kn,null,String(e))}function ja(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Oa(e)}function su(e,t){let s=0;const{shapeFlag:a}=e;if(t==null)t=null;else if(Oe(t))s=16;else if(typeof t=="object")if(a&65){const n=t.default;n&&(n._c&&(n._d=!1),su(e,n()),n._c&&(n._d=!0));return}else{s=32;const n=t._;!n&&!mh(t)?t._ctx=ms:n===3&&ms&&(ms.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else He(t)?(t={default:t,_ctx:ms},s=32):(t=String(t),a&64?(s=16,t=[tu(t)]):s=8);e.children=t,e.shapeFlag|=s}function Nh(...e){const t={};for(let s=0;s<e.length;s++){const a=e[s];for(const n in a)if(n==="class")t.class!==a.class&&(t.class=so([t.class,a.class]));else if(n==="style")t.style=to([t.style,a.style]);else if(ei(n)){const i=t[n],l=a[n];l&&i!==l&&!(Oe(i)&&i.includes(l))?t[n]=i?[].concat(i,l):l:l==null&&i==null&&!Er(n)&&(t[n]=l)}else n!==""&&(t[n]=a[n])}return t}function $s(e,t,s,a=null){Zs(e,t,7,[s,a])}const E0=rh();let A0=0;function Mh(e,t,s){const a=e.type,n=(t?t.appContext:e.appContext)||E0,i={uid:A0++,vnode:e,type:a,parent:t,appContext:n,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Md(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(n.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:vh(a,n),emitsOptions:dh(a,n),emit:null,emitted:null,propsDefaults:it,inheritAttrs:a.inheritAttrs,ctx:it,data:it,props:it,attrs:it,slots:it,refs:it,setupState:it,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=a0.bind(null,i),e.ce&&e.ce(i),i}let fs=null;const Ls=()=>fs||ms;let or,Di;{const e=Lr(),t=(s,a)=>{let n;return(n=e[s])||(n=e[s]=[]),n.push(a),i=>{n.length>1?n.forEach(l=>l(i)):n[0](i)}};or=t("__VUE_INSTANCE_SETTERS__",s=>fs=s),Di=t("__VUE_SSR_SETTERS__",s=>Yn=s)}const Qi=e=>{const t=fs;return or(e),e.scope.on(),()=>{e.scope.off(),or(t)}},Vl=()=>{fs&&fs.scope.off(),or(null)};function Dh(e){return e.vnode.shapeFlag&4}let Yn=!1;function Ph(e,t=!1,s=!1){t&&Di(t);const{props:a,children:n}=e.vnode,i=Dh(e);c0(e,a,i,t),f0(e,n,s||t);const l=i?R0(e,t):void 0;return t&&Di(!1),l}function R0(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Qc);const{setup:a}=s;if(a){tn();const n=e.setupContext=a.length>1?Bh(e):null,i=Qi(e),l=Yi(a,e,0,[e.props,n]),o=Nd(l);if(sn(),i(),(o||e.sp)&&!Qa(e)&&qd(e),o){if(l.then(Vl,Vl),t)return l.then(r=>{ad(e,r,t)}).catch(r=>{ai(r,e,0)});e.asyncDep=l}else ad(e,l,t)}else Fh(e,t)}function ad(e,t,s){He(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:mt(t)&&(e.setupState=Ud(t)),Fh(e,s)}let rr,nd;function $h(e){rr=e,nd=t=>{t.render._rc&&(t.withProxy=new Proxy(t.ctx,Dx))}}const I0=()=>!rr;function Fh(e,t,s){const a=e.type;if(!e.render){if(!t&&rr&&!a.render){const n=a.template||Zd(e).template;if(n){const{isCustomElement:i,compilerOptions:l}=e.appContext.config,{delimiters:o,compilerOptions:r}=a,c=nt(nt({isCustomElement:i,delimiters:o},l),r);a.render=rr(n,c)}}e.render=a.render||hs,nd&&nd(e)}{const n=Qi(e);tn();try{Jx(e)}finally{sn(),n()}}}const O0={get(e,t){return ws(e,"get",""),e[t]}};function Bh(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,O0),slots:e.slots,emit:e.emit,expose:t}}function oo(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Ud(Nm(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in El)return El[s](e)},has(t,s){return s in t||s in El}})):e.proxy}function id(e,t=!0){return He(e)?e.displayName||e.name:e.name||t&&e.__name}function L0(e){return He(e)&&"__vccOpts"in e}const z=(e,t)=>Fy(e,t,Yn);function Ui(e,t,s){try{jl(-1);const a=arguments.length;return a===2?mt(t)&&!Oe(t)?nn(t)?Lt(e,null,[t]):Lt(e,t):Lt(e,null,t):(a>3?s=Array.prototype.slice.call(arguments,2):a===3&&nn(s)&&(s=[s]),Lt(e,t,s))}finally{jl(1)}}function N0(){}function M0(e,t,s,a){const n=s[a];if(n&&Uh(n,e))return n;const i=t();return i.memo=e.slice(),i.cacheIndex=a,s[a]=i}function Uh(e,t){const s=e.memo;if(s.length!=t.length)return!1;for(let a=0;a<s.length;a++)if(is(s[a],t[a]))return!1;return Zn>0&&ks&&ks.push(e),!0}const zh="3.5.38",D0=hs,P0=Wy,$0=wi,F0=Hm,B0={createComponentInstance:Mh,setupComponent:Ph,renderComponentRoot:Ho,setCurrentRenderingInstance:Bl,isVNode:nn,normalizeVNode:Bs,getComponentPublicInstance:oo,ensureValidVNode:Jd,pushWarningContext:jy,popWarningContext:Vy},U0=B0,z0=null,H0=null,j0=null;/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ld;const bp=typeof window<"u"&&window.trustedTypes;if(bp)try{ld=bp.createPolicy("vue",{createHTML:e=>e})}catch{}const Hh=ld?e=>ld.createHTML(e):e=>e,V0="http://www.w3.org/2000/svg",q0="http://www.w3.org/1998/Math/MathML",Ha=typeof document<"u"?document:null,yp=Ha&&Ha.createElement("template"),jh={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,a)=>{const n=t==="svg"?Ha.createElementNS(V0,e):t==="mathml"?Ha.createElementNS(q0,e):s?Ha.createElement(e,{is:s}):Ha.createElement(e);return e==="select"&&a&&a.multiple!=null&&n.setAttribute("multiple",a.multiple),n},createText:e=>Ha.createTextNode(e),createComment:e=>Ha.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Ha.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,a,n,i){const l=s?s.previousSibling:t.lastChild;if(n&&(n===i||n.nextSibling))for(;t.insertBefore(n.cloneNode(!0),s),!(n===i||!(n=n.nextSibling)););else{yp.innerHTML=Hh(a==="svg"?`<svg>${e}</svg>`:a==="mathml"?`<math>${e}</math>`:e);const o=yp.content;if(a==="svg"||a==="mathml"){const r=o.firstChild;for(;r.firstChild;)o.appendChild(r.firstChild);o.removeChild(r)}t.insertBefore(o,s)}return[l?l.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},fn="transition",dl="animation",zi=Symbol("_vtc"),Vh={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},qh=nt({},Vd,Vh),G0=e=>(e.displayName="Transition",e.props=qh,e),W0=G0((e,{slots:t})=>Ui(Ym,Gh(e),t)),$n=(e,t=[])=>{Oe(e)?e.forEach(s=>s(...t)):e&&e(...t)},xp=e=>e?Oe(e)?e.some(t=>t.length>1):e.length>1:!1;function Gh(e){const t={};for(const T in e)T in Vh||(t[T]=e[T]);if(e.css===!1)return t;const{name:s="v",type:a,duration:n,enterFromClass:i=`${s}-enter-from`,enterActiveClass:l=`${s}-enter-active`,enterToClass:o=`${s}-enter-to`,appearFromClass:r=i,appearActiveClass:c=l,appearToClass:d=o,leaveFromClass:u=`${s}-leave-from`,leaveActiveClass:p=`${s}-leave-active`,leaveToClass:m=`${s}-leave-to`}=e,h=K0(n),b=h&&h[0],I=h&&h[1],{onBeforeEnter:k,onEnter:y,onEnterCancelled:g,onLeave:x,onLeaveCancelled:S,onBeforeAppear:_=k,onAppear:E=y,onAppearCancelled:R=g}=t,w=(T,$,te,W)=>{T._enterCancelled=W,gn(T,$?d:o),gn(T,$?c:l),te&&te()},O=(T,$)=>{T._isLeaving=!1,gn(T,u),gn(T,m),gn(T,p),$&&$()},U=T=>($,te)=>{const W=T?E:y,M=()=>w($,T,te);$n(W,[$,M]),_p(()=>{gn($,T?r:i),ka($,T?d:o),xp(W)||wp($,a,b,M)})};return nt(t,{onBeforeEnter(T){$n(k,[T]),ka(T,i),ka(T,l)},onBeforeAppear(T){$n(_,[T]),ka(T,r),ka(T,c)},onEnter:U(!1),onAppear:U(!0),onLeave(T,$){T._isLeaving=!0;const te=()=>O(T,$);ka(T,u),T._enterCancelled?(ka(T,p),od(T)):(od(T),ka(T,p)),_p(()=>{T._isLeaving&&(gn(T,u),ka(T,m),xp(x)||wp(T,a,I,te))}),$n(x,[T,te])},onEnterCancelled(T){w(T,!1,void 0,!0),$n(g,[T])},onAppearCancelled(T){w(T,!0,void 0,!0),$n(R,[T])},onLeaveCancelled(T){O(T),$n(S,[T])}})}function K0(e){if(e==null)return null;if(mt(e))return[kc(e.enter),kc(e.leave)];{const t=kc(e);return[t,t]}}function kc(e){return Zo(e)}function ka(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[zi]||(e[zi]=new Set)).add(t)}function gn(e,t){t.split(/\s+/).forEach(a=>a&&e.classList.remove(a));const s=e[zi];s&&(s.delete(t),s.size||(e[zi]=void 0))}function _p(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let J0=0;function wp(e,t,s,a){const n=e._endId=++J0,i=()=>{n===e._endId&&a()};if(s!=null)return setTimeout(i,s);const{type:l,timeout:o,propCount:r}=Wh(e,t);if(!l)return a();const c=l+"end";let d=0;const u=()=>{e.removeEventListener(c,p),i()},p=m=>{m.target===e&&++d>=r&&u()};setTimeout(()=>{d<r&&u()},o+1),e.addEventListener(c,p)}function Wh(e,t){const s=window.getComputedStyle(e),a=h=>(s[h]||"").split(", "),n=a(`${fn}Delay`),i=a(`${fn}Duration`),l=kp(n,i),o=a(`${dl}Delay`),r=a(`${dl}Duration`),c=kp(o,r);let d=null,u=0,p=0;t===fn?l>0&&(d=fn,u=l,p=i.length):t===dl?c>0&&(d=dl,u=c,p=r.length):(u=Math.max(l,c),d=u>0?l>c?fn:dl:null,p=d?d===fn?i.length:r.length:0);const m=d===fn&&/\b(?:transform|all)(?:,|$)/.test(a(`${fn}Property`).toString());return{type:d,timeout:u,propCount:p,hasTransform:m}}function kp(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,a)=>Sp(s)+Sp(e[a])))}function Sp(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function od(e){return(e?e.ownerDocument:document).body.offsetHeight}function Z0(e,t,s){const a=e[zi];a&&(t=(t?[t,...a]:[...a]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const cr=Symbol("_vod"),au=Symbol("_vsh"),Kh={name:"show",beforeMount(e,{value:t},{transition:s}){e[cr]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):ul(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:a}){!t!=!s&&(a?t?(a.beforeEnter(e),ul(e,!0),a.enter(e)):a.leave(e,()=>{ul(e,!1)}):ul(e,t))},beforeUnmount(e,{value:t}){ul(e,t)}};function ul(e,t){e.style.display=t?e[cr]:"none",e[au]=!t}function Y0(){Kh.getSSRProps=({value:e})=>{if(!e)return{style:{display:"none"}}}}const Jh=Symbol("");function Q0(e){const t=Ls();if(!t)return;const s=t.ut=(n=e(t.proxy))=>{Array.from(document.querySelectorAll(`[data-v-owner="${t.uid}"]`)).forEach(i=>dr(i,n))},a=()=>{const n=e(t.proxy);t.ce?dr(t.ce,n):rd(t.subTree,n),s(n)};Gd(()=>{$l(a)}),st(()=>{Wt(a,hs,{flush:"post"});const n=new MutationObserver(a);n.observe(t.subTree.el.parentNode,{childList:!0}),xt(()=>n.disconnect())})}function rd(e,t){if(e.shapeFlag&128){const s=e.suspense;e=s.activeBranch,s.pendingBranch&&!s.isHydrating&&s.effects.push(()=>{rd(s.activeBranch,t)})}for(;e.component;)e=e.component.subTree;if(e.shapeFlag&1&&e.el)dr(e.el,t);else if(e.type===ls)e.children.forEach(s=>rd(s,t));else if(e.type===Wn){let{el:s,anchor:a}=e;for(;s&&(dr(s,t),s!==a);)s=s.nextSibling}}function dr(e,t){if(e.nodeType===1){const s=e.style;let a="";for(const n in t){const i=ny(t[n]);s.setProperty(`--${n}`,i),a+=`--${n}: ${i};`}s[Jh]=a}}const X0=/(?:^|;)\s*display\s*:/;function e_(e,t,s){const a=e.style,n=Ye(s);let i=!1;if(s&&!n){if(t)if(Ye(t))for(const l of t.split(";")){const o=l.slice(0,l.indexOf(":")).trim();s[o]==null&&wl(a,o,"")}else for(const l in t)s[l]==null&&wl(a,l,"");for(const l in s){l==="display"&&(i=!0);const o=s[l];o!=null?s_(e,l,!Ye(t)&&t?t[l]:void 0,o)||wl(a,l,o):wl(a,l,"")}}else if(n){if(t!==s){const l=a[Jh];l&&(s+=";"+l),a.cssText=s,i=X0.test(s)}}else t&&e.removeAttribute("style");cr in e&&(e[cr]=i?a.display:"",e[au]&&(a.display="none"))}const Cp=/\s*!important$/;function wl(e,t,s){if(Oe(s))s.forEach(a=>wl(e,t,a));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const a=t_(e,t);Cp.test(s)?e.setProperty(Us(a),s.replace(Cp,""),"important"):e[a]=s}}const Tp=["Webkit","Moz","ms"],Sc={};function t_(e,t){const s=Sc[t];if(s)return s;let a=wt(t);if(a!=="filter"&&a in e)return Sc[t]=a;a=si(a);for(let n=0;n<Tp.length;n++){const i=Tp[n]+a;if(i in e)return Sc[t]=i}return t}function s_(e,t,s,a){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&Ye(a)&&s===a}const Ep="http://www.w3.org/1999/xlink";function Ap(e,t,s,a,n,i=sy(t)){a&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Ep,t.slice(6,t.length)):e.setAttributeNS(Ep,t,s):s==null||i&&!fm(s)?e.removeAttribute(t):e.setAttribute(t,i?"":Cs(s)?String(s):s)}function Rp(e,t,s,a,n){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?Hh(s):s);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const o=i==="OPTION"?e.getAttribute("value")||"":e.value,r=s==null?e.type==="checkbox"?"on":"":String(s);(o!==r||!("_value"in e))&&(e.value=r),s==null&&e.removeAttribute(t),e._value=s;return}let l=!1;if(s===""||s==null){const o=typeof e[t];o==="boolean"?s=fm(s):s==null&&o==="string"?(s="",l=!0):o==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(n||t)}function Wa(e,t,s,a){e.addEventListener(t,s,a)}function a_(e,t,s,a){e.removeEventListener(t,s,a)}const Ip=Symbol("_vei");function n_(e,t,s,a,n=null){const i=e[Ip]||(e[Ip]={}),l=i[t];if(a&&l)l.value=a;else{const[o,r]=i_(t);if(a){const c=i[t]=r_(a,n);Wa(e,o,c,r)}else l&&(a_(e,o,l,r),i[t]=void 0)}}const Op=/(?:Once|Passive|Capture)$/;function i_(e){let t;if(Op.test(e)){t={};let a;for(;a=e.match(Op);)e=e.slice(0,e.length-a[0].length),t[a[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Us(e.slice(2)),t]}let Cc=0;const l_=Promise.resolve(),o_=()=>Cc||(l_.then(()=>Cc=0),Cc=Date.now());function r_(e,t){const s=a=>{if(!a._vts)a._vts=Date.now();else if(a._vts<=s.attached)return;const n=s.value;if(Oe(n)){const i=a.stopImmediatePropagation;a.stopImmediatePropagation=()=>{i.call(a),a._stopped=!0};const l=n.slice(),o=[a];for(let r=0;r<l.length&&!a._stopped;r++){const c=l[r];c&&Zs(c,t,5,o)}}else Zs(n,t,5,[a])};return s.value=e,s.attached=o_(),s}const Lp=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Zh=(e,t,s,a,n,i)=>{const l=n==="svg";t==="class"?Z0(e,a,l):t==="style"?e_(e,s,a):ei(t)?Er(t)||n_(e,t,s,a,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):c_(e,t,a,l))?(Rp(e,t,a),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Ap(e,t,a,l,i,t!=="value")):e._isVueCE&&(d_(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!Ye(a)))?Rp(e,wt(t),a,i,t):(t==="true-value"?e._trueValue=a:t==="false-value"&&(e._falseValue=a),Ap(e,t,a,l))};function c_(e,t,s,a){if(a)return!!(t==="innerHTML"||t==="textContent"||t in e&&Lp(t)&&He(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const n=e.tagName;if(n==="IMG"||n==="VIDEO"||n==="CANVAS"||n==="SOURCE")return!1}return Lp(t)&&Ye(s)?!1:t in e}function d_(e,t){const s=e._def.props;if(!s)return!1;const a=wt(t);return Array.isArray(s)?s.some(n=>wt(n)===a):Object.keys(s).some(n=>wt(n)===a)}const Np={};function Yh(e,t,s){let a=io(e,t);Ar(a)&&(a=nt({},a,t));class n extends qr{constructor(l){super(a,l,s)}}return n.def=a,n}const u_=((e,t)=>Yh(e,t,dv)),p_=typeof HTMLElement<"u"?HTMLElement:class{};class qr extends p_{constructor(t,s={},a=fr){super(),this._def=t,this._props=s,this._createApp=a,this._isVueCE=!0,this._instance=null,this._app=null,this._nonce=this._def.nonce,this._connected=!1,this._resolved=!1,this._patching=!1,this._dirty=!1,this._numberProps=null,this._styleChildren=new WeakSet,this._styleAnchors=new WeakMap,this._ob=null,this.shadowRoot&&a!==fr?this._root=this.shadowRoot:t.shadowRoot!==!1?(this.attachShadow(nt({},t.shadowRootOptions,{mode:"open"})),this._root=this.shadowRoot):this._root=this}connectedCallback(){if(!this.isConnected)return;!this.shadowRoot&&!this._resolved&&this._parseSlots(),this._connected=!0;let t=this;for(;t=t&&(t.assignedSlot||t.parentNode||t.host);)if(t instanceof qr){this._parent=t;break}this._instance||(this._resolved?this._mount(this._def):t&&t._pendingResolve?this._pendingResolve=t._pendingResolve.then(()=>{this._pendingResolve=void 0,this._resolveDef()}):this._resolveDef())}_setParent(t=this._parent){t&&(this._instance.parent=t._instance,this._inheritParentContext(t))}_inheritParentContext(t=this._parent){t&&this._app&&Object.setPrototypeOf(this._app._context.provides,t._instance.provides)}disconnectedCallback(){this._connected=!1,zt(()=>{this._connected||(this._ob&&(this._ob.disconnect(),this._ob=null),this._app&&this._app.unmount(),this._instance&&(this._instance.ce=void 0),this._app=this._instance=null,this._teleportTargets&&(this._teleportTargets.clear(),this._teleportTargets=void 0))})}_processMutations(t){for(const s of t)this._setAttr(s.attributeName)}_resolveDef(){if(this._pendingResolve)return;for(let a=0;a<this.attributes.length;a++)this._setAttr(this.attributes[a].name);this._ob=new MutationObserver(this._processMutations.bind(this)),this._ob.observe(this,{attributes:!0});const t=(a,n=!1)=>{this._resolved=!0,this._pendingResolve=void 0;const{props:i,styles:l}=a;let o;if(i&&!Oe(i))for(const r in i){const c=i[r];(c===Number||c&&c.type===Number)&&(r in this._props&&(this._props[r]=Zo(this._props[r])),(o||(o=Object.create(null)))[wt(r)]=!0)}this._numberProps=o,this._resolveProps(a),this.shadowRoot&&this._applyStyles(l),this._mount(a)},s=this._def.__asyncLoader;s?this._pendingResolve=s().then(a=>{a.configureApp=this._def.configureApp,t(this._def=a,!0)}):t(this._def)}_mount(t){this._app=this._createApp(t),this._inheritParentContext(),t.configureApp&&t.configureApp(this._app),this._app._ceVNode=this._createVNode(),this._app.mount(this._root);const s=this._instance&&this._instance.exposed;if(s)for(const a in s)ht(this,a)||Object.defineProperty(this,a,{get:()=>Ra(s[a])})}_resolveProps(t){const{props:s}=t,a=Oe(s)?s:Object.keys(s||{});for(const n of Object.keys(this))n[0]!=="_"&&a.includes(n)&&this._setProp(n,this[n]);for(const n of a.map(wt))Object.defineProperty(this,n,{get(){return this._getProp(n)},set(i){this._setProp(n,i,!0,!this._patching)}})}_setAttr(t){if(t.startsWith("data-v-"))return;const s=this.hasAttribute(t);let a=s?this.getAttribute(t):Np;const n=wt(t);s&&this._numberProps&&this._numberProps[n]&&(a=Zo(a)),this._setProp(n,a,!1,!0)}_getProp(t){return this._props[t]}_setProp(t,s,a=!0,n=!1){if(s!==this._props[t]&&(this._dirty=!0,s===Np?delete this._props[t]:(this._props[t]=s,t==="key"&&this._app&&(this._app._ceVNode.key=s)),n&&this._instance&&this._update(),a)){const i=this._ob;i&&(this._processMutations(i.takeRecords()),i.disconnect()),s===!0?this.setAttribute(Us(t),""):typeof s=="string"||typeof s=="number"?this.setAttribute(Us(t),s+""):s||this.removeAttribute(Us(t)),i&&i.observe(this,{attributes:!0})}}_update(){const t=this._createVNode();this._app&&(t.appContext=this._app._context),cv(t,this._root)}_createVNode(){const t={};this.shadowRoot||(t.onVnodeMounted=t.onVnodeUpdated=this._renderSlots.bind(this));const s=Lt(this._def,nt(t,this._props));return this._instance||(s.ce=a=>{this._instance=a,a.ce=this,a.isCE=!0;const n=(i,l)=>{this.dispatchEvent(new CustomEvent(i,Ar(l[0])?nt({detail:l},l[0]):{detail:l}))};a.emit=(i,...l)=>{n(i,l),Us(i)!==i&&n(Us(i),l)},this._setParent()}),s}_applyStyles(t,s,a){if(!t)return;if(s){if(s===this._def||this._styleChildren.has(s))return;this._styleChildren.add(s)}const n=this._nonce,i=this.shadowRoot,l=a?this._getStyleAnchor(a)||this._getStyleAnchor(this._def):this._getRootStyleInsertionAnchor(i);let o=null;for(let r=t.length-1;r>=0;r--){const c=document.createElement("style");n&&c.setAttribute("nonce",n),c.textContent=t[r],i.insertBefore(c,o||l),o=c,r===0&&(a||this._styleAnchors.set(this._def,c),s&&this._styleAnchors.set(s,c))}}_getStyleAnchor(t){if(!t)return null;const s=this._styleAnchors.get(t);return s&&s.parentNode===this.shadowRoot?s:(s&&this._styleAnchors.delete(t),null)}_getRootStyleInsertionAnchor(t){for(let s=0;s<t.childNodes.length;s++){const a=t.childNodes[s];if(!(a instanceof HTMLStyleElement))return a}return null}_parseSlots(){const t=this._slots={};let s;for(;s=this.firstChild;){const a=s.nodeType===1&&s.getAttribute("slot")||"default";(t[a]||(t[a]=[])).push(s),this.removeChild(s)}}_renderSlots(){const t=this._getSlots(),s=this._instance.type.__scopeId;for(let a=0;a<t.length;a++){const n=t[a],i=n.getAttribute("name")||"default",l=this._slots[i],o=n.parentNode;if(l)for(const r of l){if(s&&r.nodeType===1){const c=s+"-s",d=document.createTreeWalker(r,1);r.setAttribute(c,"");let u;for(;u=d.nextNode();)u.setAttribute(c,"")}o.insertBefore(r,n)}else for(;n.firstChild;)o.insertBefore(n.firstChild,n);o.removeChild(n)}}_getSlots(){const t=[this];this._teleportTargets&&t.push(...this._teleportTargets);const s=new Set;for(const a of t){const n=a.querySelectorAll("slot");for(let i=0;i<n.length;i++)s.add(n[i])}return Array.from(s)}_injectChildStyle(t,s){this._applyStyles(t.styles,t,s)}_beginPatch(){this._patching=!0,this._dirty=!1}_endPatch(){this._patching=!1,this._dirty&&this._instance&&this._update()}_hasShadowRoot(){return this._def.shadowRoot!==!1}_removeChildStyle(t){}}function Qh(e){const t=Ls(),s=t&&t.ce;return s||null}function f_(){const e=Qh();return e&&e.shadowRoot}function m_(e="$style"){{const t=Ls();if(!t)return it;const s=t.type.__cssModules;if(!s)return it;const a=s[e];return a||it}}const Xh=new WeakMap,ev=new WeakMap,ur=Symbol("_moveCb"),Mp=Symbol("_enterCb"),h_=e=>(delete e.props.mode,e),v_=h_({name:"TransitionGroup",props:nt({},qh,{tag:String,moveClass:String}),setup(e,{slots:t}){const s=Ls(),a=jd();let n,i;return zr(()=>{if(!n.length)return;const l=e.moveClass||`${e.name||"v"}-move`;if(!__(n[0].el,s.vnode.el,l)){n=[];return}n.forEach(b_),n.forEach(y_);const o=n.filter(x_);od(s.vnode.el),o.forEach(r=>{const c=r.el,d=c.style;ka(c,l),d.transform=d.webkitTransform=d.transitionDuration="";const u=c[ur]=p=>{p&&p.target!==c||(!p||p.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",u),c[ur]=null,gn(c,l))};c.addEventListener("transitionend",u)}),n=[]}),()=>{const l=dt(e),o=Gh(l);let r=l.tag||ls;if(n=[],i)for(let c=0;c<i.length;c++){const d=i[c];d.el&&d.el instanceof Element&&!d.el[au]&&(n.push(d),an(d,Bi(d,o,a,s)),Xh.set(d,tv(d.el)))}i=t.default?Br(t.default()):[];for(let c=0;c<i.length;c++){const d=i[c];d.key!=null&&an(d,Bi(d,o,a,s))}return Lt(r,null,i)}}}),g_=v_;function b_(e){const t=e.el;t[ur]&&t[ur](),t[Mp]&&t[Mp]()}function y_(e){ev.set(e,tv(e.el))}function x_(e){const t=Xh.get(e),s=ev.get(e),a=t.left-s.left,n=t.top-s.top;if(a||n){const i=e.el,l=i.style,o=i.getBoundingClientRect();let r=1,c=1;return i.offsetWidth&&(r=o.width/i.offsetWidth),i.offsetHeight&&(c=o.height/i.offsetHeight),(!Number.isFinite(r)||r===0)&&(r=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(r-1)<.01&&(r=1),Math.abs(c-1)<.01&&(c=1),l.transform=l.webkitTransform=`translate(${a/r}px,${n/c}px)`,l.transitionDuration="0s",e}}function tv(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function __(e,t,s){const a=e.cloneNode(),n=e[zi];n&&n.forEach(o=>{o.split(/\s+/).forEach(r=>r&&a.classList.remove(r))}),s.split(/\s+/).forEach(o=>o&&a.classList.add(o)),a.style.display="none";const i=t.nodeType===1?t:t.parentNode;i.appendChild(a);const{hasTransform:l}=Wh(a);return i.removeChild(a),l}const Cn=e=>{const t=e.props["onUpdate:modelValue"]||!1;return Oe(t)?s=>Oi(t,s):t};function w_(e){e.target.composing=!0}function Dp(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const ia=Symbol("_assign");function Pp(e,t,s){return t&&(e=e.trim()),s&&(e=Or(e)),e}const pr={created(e,{modifiers:{lazy:t,trim:s,number:a}},n){e[ia]=Cn(n);const i=a||n.props&&n.props.type==="number";Wa(e,t?"change":"input",l=>{l.target.composing||e[ia](Pp(e.value,s,i))}),(s||i)&&Wa(e,"change",()=>{e.value=Pp(e.value,s,i)}),t||(Wa(e,"compositionstart",w_),Wa(e,"compositionend",Dp),Wa(e,"change",Dp))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:a,trim:n,number:i}},l){if(e[ia]=Cn(l),e.composing)return;const o=(i||e.type==="number")&&!/^0\d/.test(e.value)?Or(e.value):e.value,r=t??"";if(o===r)return;const c=e.getRootNode();(c instanceof Document||c instanceof ShadowRoot)&&c.activeElement===e&&e.type!=="range"&&(a&&t===s||n&&e.value.trim()===r)||(e.value=r)}},nu={deep:!0,created(e,t,s){e[ia]=Cn(s),Wa(e,"change",()=>{const a=e._modelValue,n=Hi(e),i=e.checked,l=e[ia];if(Oe(a)){const o=Nr(a,n),r=o!==-1;if(i&&!r)l(a.concat(n));else if(!i&&r){const c=[...a];c.splice(o,1),l(c)}}else if(ti(a)){const o=new Set(a);i?o.add(n):o.delete(n),l(o)}else l(av(e,i))})},mounted:$p,beforeUpdate(e,t,s){e[ia]=Cn(s),$p(e,t,s)}};function $p(e,{value:t,oldValue:s},a){e._modelValue=t;let n;if(Oe(t))n=Nr(t,a.props.value)>-1;else if(ti(t))n=t.has(a.props.value);else{if(t===s)return;n=en(t,av(e,!0))}e.checked!==n&&(e.checked=n)}const iu={created(e,{value:t},s){e.checked=en(t,s.props.value),e[ia]=Cn(s),Wa(e,"change",()=>{e[ia](Hi(e))})},beforeUpdate(e,{value:t,oldValue:s},a){e[ia]=Cn(a),t!==s&&(e.checked=en(t,a.props.value))}},sv={deep:!0,created(e,{value:t,modifiers:{number:s}},a){const n=ti(t);Wa(e,"change",()=>{const i=Array.prototype.filter.call(e.options,l=>l.selected).map(l=>s?Or(Hi(l)):Hi(l));e[ia](e.multiple?n?new Set(i):i:i[0]),e._assigning=!0,zt(()=>{e._assigning=!1})}),e[ia]=Cn(a)},mounted(e,{value:t}){Fp(e,t)},beforeUpdate(e,t,s){e[ia]=Cn(s)},updated(e,{value:t}){e._assigning||Fp(e,t)}};function Fp(e,t){const s=e.multiple,a=Oe(t);if(!(s&&!a&&!ti(t))){for(let n=0,i=e.options.length;n<i;n++){const l=e.options[n],o=Hi(l);if(s)if(a){const r=typeof o;r==="string"||r==="number"?l.selected=t.some(c=>String(c)===String(o)):l.selected=Nr(t,o)>-1}else l.selected=t.has(o);else if(en(Hi(l),t)){e.selectedIndex!==n&&(e.selectedIndex=n);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function Hi(e){return"_value"in e?e._value:e.value}function av(e,t){const s=t?"_trueValue":"_falseValue";return s in e?e[s]:t}const nv={created(e,t,s){Eo(e,t,s,null,"created")},mounted(e,t,s){Eo(e,t,s,null,"mounted")},beforeUpdate(e,t,s,a){Eo(e,t,s,a,"beforeUpdate")},updated(e,t,s,a){Eo(e,t,s,a,"updated")}};function iv(e,t){switch(e){case"SELECT":return sv;case"TEXTAREA":return pr;default:switch(t){case"checkbox":return nu;case"radio":return iu;default:return pr}}}function Eo(e,t,s,a,n){const l=iv(e.tagName,s.props&&s.props.type)[n];l&&l(e,t,s,a)}function k_(){pr.getSSRProps=({value:e})=>({value:e}),iu.getSSRProps=({value:e},t)=>{if(t.props&&en(t.props.value,e))return{checked:!0}},nu.getSSRProps=({value:e},t)=>{if(Oe(e)){if(t.props&&Nr(e,t.props.value)>-1)return{checked:!0}}else if(ti(e)){if(t.props&&e.has(t.props.value))return{checked:!0}}else if(e)return{checked:!0}},nv.getSSRProps=(e,t)=>{if(typeof t.type!="string")return;const s=iv(t.type.toUpperCase(),t.props&&t.props.type);if(s.getSSRProps)return s.getSSRProps(e,t)}}const S_=["ctrl","shift","alt","meta"],C_={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>S_.some(s=>e[`${s}Key`]&&!t.includes(s))},T_=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),a=t.join(".");return s[a]||(s[a]=((n,...i)=>{for(let l=0;l<t.length;l++){const o=C_[t[l]];if(o&&o(n,t))return}return e(n,...i)}))},E_={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},A_=(e,t)=>{const s=e._withKeys||(e._withKeys={}),a=t.join(".");return s[a]||(s[a]=(n=>{if(!("key"in n))return;const i=Us(n.key);if(t.some(l=>l===i||E_[l]===i))return e(n)}))},lv=nt({patchProp:Zh},jh);let Rl,Bp=!1;function ov(){return Rl||(Rl=xh(lv))}function rv(){return Rl=Bp?Rl:_h(lv),Bp=!0,Rl}const cv=((...e)=>{ov().render(...e)}),R_=((...e)=>{rv().hydrate(...e)}),fr=((...e)=>{const t=ov().createApp(...e),{mount:s}=t;return t.mount=a=>{const n=pv(a);if(!n)return;const i=t._component;!He(i)&&!i.render&&!i.template&&(i.template=n.innerHTML),n.nodeType===1&&(n.textContent="");const l=s(n,!1,uv(n));return n instanceof Element&&(n.removeAttribute("v-cloak"),n.setAttribute("data-v-app","")),l},t}),dv=((...e)=>{const t=rv().createApp(...e),{mount:s}=t;return t.mount=a=>{const n=pv(a);if(n)return s(n,!0,uv(n))},t});function uv(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function pv(e){return Ye(e)?document.querySelector(e):e}let Up=!1;const I_=()=>{Up||(Up=!0,k_(),Y0())},O_=Object.freeze(Object.defineProperty({__proto__:null,BaseTransition:Ym,BaseTransitionPropsValidators:Vd,Comment:Ht,DeprecationTypes:j0,EffectScope:Md,ErrorCodes:Gy,ErrorTypeStrings:P0,Fragment:ls,KeepAlive:Cx,ReactiveEffect:Ml,Static:Wn,Suspense:g0,Teleport:ox,Text:kn,TrackOpTypes:By,Transition:W0,TransitionGroup:g_,TriggerOpTypes:Uy,VueElement:qr,assertNumber:qy,callWithAsyncErrorHandling:Zs,callWithErrorHandling:Yi,camelize:wt,capitalize:si,cloneVNode:Oa,compatUtils:H0,computed:z,createApp:fr,createBlock:lr,createCommentVNode:Lh,createElementBlock:k0,createElementVNode:eu,createHydrationRenderer:_h,createPropsRestProxy:Wx,createRenderer:xh,createSSRApp:dv,createSlots:Lx,createStaticVNode:T0,createTextVNode:tu,createVNode:Lt,customRef:Dm,defineAsyncComponent:kx,defineComponent:io,defineCustomElement:Yh,defineEmits:$x,defineExpose:Fx,defineModel:zx,defineOptions:Bx,defineProps:Px,defineSSRCustomElement:u_,defineSlots:Ux,devtools:$0,effect:ry,effectScope:iy,getCurrentInstance:Ls,getCurrentScope:gm,getCurrentWatcher:zy,getTransitionRawChildren:Br,guardReactiveProps:Oh,h:Ui,handleError:ai,hasInjectionContext:ex,hydrate:R_,hydrateOnIdle:gx,hydrateOnInteraction:_x,hydrateOnMediaQuery:xx,hydrateOnVisible:yx,initCustomFormatter:N0,initDirectivesForSSR:I_,inject:na,isMemoSame:Uh,isProxy:ao,isReactive:Ya,isReadonly:Ia,isRef:Gt,isRuntimeOnly:I0,isShallow:Hs,isVNode:nn,markRaw:Nm,mergeDefaults:qx,mergeModels:Gx,mergeProps:Nh,nextTick:zt,nodeOps:jh,normalizeClass:so,normalizeProps:Gb,normalizeStyle:to,onActivated:rs,onBeforeMount:eh,onBeforeUnmount:Hr,onBeforeUpdate:Gd,onDeactivated:Kt,onErrorCaptured:nh,onMounted:st,onRenderTracked:ah,onRenderTriggered:sh,onScopeDispose:ly,onServerPrefetch:th,onUnmounted:xt,onUpdated:zr,onWatcherCleanup:$m,openBlock:Hl,patchProp:Zh,popScopeId:Yy,provide:Tl,proxyRefs:Ud,pushScopeId:Zy,queuePostFlushCb:$l,reactive:Tn,readonly:Qo,ref:f,registerRuntimeCompiler:$h,render:cv,renderList:Ox,renderSlot:Nx,resolveComponent:Ax,resolveDirective:Ix,resolveDynamicComponent:Rx,resolveFilter:z0,resolveTransitionHooks:Bi,setBlockTracking:jl,setDevtoolsHook:F0,setTransitionHooks:an,shallowReactive:Fd,shallowReadonly:Ey,shallowRef:Bd,ssrContextKey:jm,ssrUtils:U0,stop:cy,toDisplayString:hm,toHandlerKey:Ii,toHandlers:Mx,toRaw:dt,toRef:Py,toRefs:Ny,toValue:Iy,transformVNodeArgs:S0,triggerRef:Ry,unref:Ra,useAttrs:Vx,useCssModule:m_,useCssVars:Q0,useHost:Qh,useId:cx,useModel:s0,useSSRContext:Vm,useShadowRoot:f_,useSlots:jx,useTemplateRef:dx,useTransitionState:jd,vModelCheckbox:nu,vModelDynamic:nv,vModelRadio:iu,vModelSelect:sv,vModelText:pr,vShow:Kh,version:zh,warn:D0,watch:Wt,watchEffect:tx,watchPostEffect:sx,watchSyncEffect:qm,withAsyncContext:Kx,withCtx:Hd,withDefaults:Hx,withDirectives:Xy,withKeys:A_,withMemo:M0,withModifiers:T_,withScopeId:Qy},Symbol.toStringTag,{value:"Module"}));/**
* @vue/compiler-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const ql=Symbol(""),Il=Symbol(""),lu=Symbol(""),mr=Symbol(""),fv=Symbol(""),Qn=Symbol(""),mv=Symbol(""),hv=Symbol(""),ou=Symbol(""),ru=Symbol(""),ro=Symbol(""),cu=Symbol(""),vv=Symbol(""),du=Symbol(""),uu=Symbol(""),pu=Symbol(""),fu=Symbol(""),mu=Symbol(""),hu=Symbol(""),gv=Symbol(""),bv=Symbol(""),Gr=Symbol(""),hr=Symbol(""),vu=Symbol(""),gu=Symbol(""),Gl=Symbol(""),co=Symbol(""),bu=Symbol(""),cd=Symbol(""),L_=Symbol(""),dd=Symbol(""),vr=Symbol(""),N_=Symbol(""),M_=Symbol(""),yu=Symbol(""),D_=Symbol(""),P_=Symbol(""),xu=Symbol(""),yv=Symbol(""),ji={[ql]:"Fragment",[Il]:"Teleport",[lu]:"Suspense",[mr]:"KeepAlive",[fv]:"BaseTransition",[Qn]:"openBlock",[mv]:"createBlock",[hv]:"createElementBlock",[ou]:"createVNode",[ru]:"createElementVNode",[ro]:"createCommentVNode",[cu]:"createTextVNode",[vv]:"createStaticVNode",[du]:"resolveComponent",[uu]:"resolveDynamicComponent",[pu]:"resolveDirective",[fu]:"resolveFilter",[mu]:"withDirectives",[hu]:"renderList",[gv]:"renderSlot",[bv]:"createSlots",[Gr]:"toDisplayString",[hr]:"mergeProps",[vu]:"normalizeClass",[gu]:"normalizeStyle",[Gl]:"normalizeProps",[co]:"guardReactiveProps",[bu]:"toHandlers",[cd]:"camelize",[L_]:"capitalize",[dd]:"toHandlerKey",[vr]:"setBlockTracking",[N_]:"pushScopeId",[M_]:"popScopeId",[yu]:"withCtx",[D_]:"unref",[P_]:"isRef",[xu]:"withMemo",[yv]:"isMemoSame"};function $_(e){Object.getOwnPropertySymbols(e).forEach(t=>{ji[t]=e[t]})}const Qs={start:{line:1,column:1,offset:0},end:{line:1,column:1,offset:0},source:""};function F_(e,t=""){return{type:0,source:t,children:e,helpers:new Set,components:[],directives:[],hoists:[],imports:[],cached:[],temps:0,codegenNode:void 0,loc:Qs}}function Wl(e,t,s,a,n,i,l,o=!1,r=!1,c=!1,d=Qs){return e&&(o?(e.helper(Qn),e.helper(Gi(e.inSSR,c))):e.helper(qi(e.inSSR,c)),l&&e.helper(mu)),{type:13,tag:t,props:s,children:a,patchFlag:n,dynamicProps:i,directives:l,isBlock:o,disableTracking:r,isComponent:c,loc:d}}function Kn(e,t=Qs){return{type:17,loc:t,elements:e}}function aa(e,t=Qs){return{type:15,loc:t,properties:e}}function qt(e,t){return{type:16,loc:Qs,key:Ye(e)?et(e,!0):e,value:t}}function et(e,t=!1,s=Qs,a=0){return{type:4,loc:s,content:e,isStatic:t,constType:t?3:a}}function ha(e,t=Qs){return{type:8,loc:t,children:e}}function ss(e,t=[],s=Qs){return{type:14,loc:s,callee:e,arguments:t}}function Vi(e,t=void 0,s=!1,a=!1,n=Qs){return{type:18,params:e,returns:t,newline:s,isSlot:a,loc:n}}function ud(e,t,s,a=!0){return{type:19,test:e,consequent:t,alternate:s,newline:a,loc:Qs}}function B_(e,t,s=!1,a=!1){return{type:20,index:e,value:t,needPauseTracking:s,inVOnce:a,needArraySpread:!1,loc:Qs}}function U_(e){return{type:21,body:e,loc:Qs}}function qi(e,t){return e||t?ou:ru}function Gi(e,t){return e||t?mv:hv}function _u(e,{helper:t,removeHelper:s,inSSR:a}){e.isBlock||(e.isBlock=!0,s(qi(a,e.isComponent)),t(Qn),t(Gi(a,e.isComponent)))}const zp=new Uint8Array([123,123]),Hp=new Uint8Array([125,125]);function jp(e){return e>=97&&e<=122||e>=65&&e<=90}function Ks(e){return e===32||e===10||e===9||e===12||e===13}function mn(e){return e===47||e===62||Ks(e)}function gr(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t}const ys={Cdata:new Uint8Array([67,68,65,84,65,91]),CdataEnd:new Uint8Array([93,93,62]),CommentEnd:new Uint8Array([45,45,62]),ScriptEnd:new Uint8Array([60,47,115,99,114,105,112,116]),StyleEnd:new Uint8Array([60,47,115,116,121,108,101]),TitleEnd:new Uint8Array([60,47,116,105,116,108,101]),TextareaEnd:new Uint8Array([60,47,116,101,120,116,97,114,101,97])};class z_{constructor(t,s){this.stack=t,this.cbs=s,this.state=1,this.buffer="",this.sectionStart=0,this.index=0,this.entityStart=0,this.baseState=1,this.inRCDATA=!1,this.inXML=!1,this.inVPre=!1,this.newlines=[],this.mode=0,this.delimiterOpen=zp,this.delimiterClose=Hp,this.delimiterIndex=-1,this.currentSequence=void 0,this.sequenceIndex=0}get inSFCRoot(){return this.mode===2&&this.stack.length===0}reset(){this.state=1,this.mode=0,this.buffer="",this.sectionStart=0,this.index=0,this.baseState=1,this.inRCDATA=!1,this.currentSequence=void 0,this.newlines.length=0,this.delimiterOpen=zp,this.delimiterClose=Hp}getPos(t){let s=1,a=t+1;const n=this.newlines.length;let i=-1;if(n>100){let l=-1,o=n;for(;l+1<o;){const r=l+o>>>1;this.newlines[r]<t?l=r:o=r}i=l}else for(let l=n-1;l>=0;l--)if(t>this.newlines[l]){i=l;break}return i>=0&&(s=i+2,a=t-this.newlines[i]),{column:a,line:s,offset:t}}peek(){return this.buffer.charCodeAt(this.index+1)}stateText(t){t===60?(this.index>this.sectionStart&&this.cbs.ontext(this.sectionStart,this.index),this.state=5,this.sectionStart=this.index):!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t))}stateInterpolationOpen(t){if(t===this.delimiterOpen[this.delimiterIndex])if(this.delimiterIndex===this.delimiterOpen.length-1){const s=this.index+1-this.delimiterOpen.length;s>this.sectionStart&&this.cbs.ontext(this.sectionStart,s),this.state=3,this.sectionStart=s}else this.delimiterIndex++;else this.inRCDATA?(this.state=32,this.stateInRCDATA(t)):(this.state=1,this.stateText(t))}stateInterpolation(t){t===this.delimiterClose[0]&&(this.state=4,this.delimiterIndex=0,this.stateInterpolationClose(t))}stateInterpolationClose(t){t===this.delimiterClose[this.delimiterIndex]?this.delimiterIndex===this.delimiterClose.length-1?(this.cbs.oninterpolation(this.sectionStart,this.index+1),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):this.delimiterIndex++:(this.state=3,this.stateInterpolation(t))}stateSpecialStartSequence(t){const s=this.sequenceIndex===this.currentSequence.length;if(!(s?mn(t):(t|32)===this.currentSequence[this.sequenceIndex]))this.inRCDATA=!1;else if(!s){this.sequenceIndex++;return}this.sequenceIndex=0,this.state=6,this.stateInTagName(t)}stateInRCDATA(t){if(this.sequenceIndex===this.currentSequence.length){if(t===62||Ks(t)){const s=this.index-this.currentSequence.length;if(this.sectionStart<s){const a=this.index;this.index=s,this.cbs.ontext(this.sectionStart,s),this.index=a}this.sectionStart=s+2,this.stateInClosingTagName(t),this.inRCDATA=!1;return}this.sequenceIndex=0}(t|32)===this.currentSequence[this.sequenceIndex]?this.sequenceIndex+=1:this.sequenceIndex===0?this.currentSequence===ys.TitleEnd||this.currentSequence===ys.TextareaEnd&&!this.inSFCRoot?!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t)):this.fastForwardTo(60)&&(this.sequenceIndex=1):this.sequenceIndex=+(t===60)}stateCDATASequence(t){t===ys.Cdata[this.sequenceIndex]?++this.sequenceIndex===ys.Cdata.length&&(this.state=28,this.currentSequence=ys.CdataEnd,this.sequenceIndex=0,this.sectionStart=this.index+1):(this.sequenceIndex=0,this.state=23,this.stateInDeclaration(t))}fastForwardTo(t){for(;++this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);if(s===10&&this.newlines.push(this.index),s===t)return!0}return this.index=this.buffer.length-1,!1}stateInCommentLike(t){t===this.currentSequence[this.sequenceIndex]?++this.sequenceIndex===this.currentSequence.length&&(this.currentSequence===ys.CdataEnd?this.cbs.oncdata(this.sectionStart,this.index-2):this.cbs.oncomment(this.sectionStart,this.index-2),this.sequenceIndex=0,this.sectionStart=this.index+1,this.state=1):this.sequenceIndex===0?this.fastForwardTo(this.currentSequence[0])&&(this.sequenceIndex=1):t!==this.currentSequence[this.sequenceIndex-1]&&(this.sequenceIndex=0)}startSpecial(t,s){this.enterRCDATA(t,s),this.state=31}enterRCDATA(t,s){this.inRCDATA=!0,this.currentSequence=t,this.sequenceIndex=s}stateBeforeTagName(t){t===33?(this.state=22,this.sectionStart=this.index+1):t===63?(this.state=24,this.sectionStart=this.index+1):jp(t)?(this.sectionStart=this.index,this.mode===0?this.state=6:this.inSFCRoot?this.state=34:this.inXML?this.state=6:t===116?this.state=30:this.state=t===115?29:6):t===47?this.state=8:(this.state=1,this.stateText(t))}stateInTagName(t){mn(t)&&this.handleTagName(t)}stateInSFCRootTagName(t){if(mn(t)){const s=this.buffer.slice(this.sectionStart,this.index);s!=="template"&&this.enterRCDATA(gr("</"+s),0),this.handleTagName(t)}}handleTagName(t){this.cbs.onopentagname(this.sectionStart,this.index),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)}stateBeforeClosingTagName(t){Ks(t)||(t===62?(this.state=1,this.sectionStart=this.index+1):(this.state=jp(t)?9:27,this.sectionStart=this.index))}stateInClosingTagName(t){(t===62||Ks(t))&&(this.cbs.onclosetag(this.sectionStart,this.index),this.sectionStart=-1,this.state=10,this.stateAfterClosingTagName(t))}stateAfterClosingTagName(t){t===62&&(this.state=1,this.sectionStart=this.index+1)}stateBeforeAttrName(t){t===62?(this.cbs.onopentagend(this.index),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):t===47?this.state=7:t===60&&this.peek()===47?(this.cbs.onopentagend(this.index),this.state=5,this.sectionStart=this.index):Ks(t)||this.handleAttrStart(t)}handleAttrStart(t){t===118&&this.peek()===45?(this.state=13,this.sectionStart=this.index):t===46||t===58||t===64||t===35?(this.cbs.ondirname(this.index,this.index+1),this.state=14,this.sectionStart=this.index+1):(this.state=12,this.sectionStart=this.index)}stateInSelfClosingTag(t){t===62?(this.cbs.onselfclosingtag(this.index),this.state=1,this.sectionStart=this.index+1,this.inRCDATA=!1):Ks(t)||(this.state=11,this.stateBeforeAttrName(t))}stateInAttrName(t){(t===61||mn(t))&&(this.cbs.onattribname(this.sectionStart,this.index),this.handleAttrNameEnd(t))}stateInDirName(t){t===61||mn(t)?(this.cbs.ondirname(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===58?(this.cbs.ondirname(this.sectionStart,this.index),this.state=14,this.sectionStart=this.index+1):t===46&&(this.cbs.ondirname(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDirArg(t){t===61||mn(t)?(this.cbs.ondirarg(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===91?this.state=15:t===46&&(this.cbs.ondirarg(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDynamicDirArg(t){t===93?this.state=14:(t===61||mn(t))&&(this.cbs.ondirarg(this.sectionStart,this.index+1),this.handleAttrNameEnd(t))}stateInDirModifier(t){t===61||mn(t)?(this.cbs.ondirmodifier(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===46&&(this.cbs.ondirmodifier(this.sectionStart,this.index),this.sectionStart=this.index+1)}handleAttrNameEnd(t){this.sectionStart=this.index,this.state=17,this.cbs.onattribnameend(this.index),this.stateAfterAttrName(t)}stateAfterAttrName(t){t===61?this.state=18:t===47||t===62?(this.cbs.onattribend(0,this.sectionStart),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)):Ks(t)||(this.cbs.onattribend(0,this.sectionStart),this.handleAttrStart(t))}stateBeforeAttrValue(t){t===34?(this.state=19,this.sectionStart=this.index+1):t===39?(this.state=20,this.sectionStart=this.index+1):Ks(t)||(this.sectionStart=this.index,this.state=21,this.stateInAttrValueNoQuotes(t))}handleInAttrValue(t,s){(t===s||this.fastForwardTo(s))&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(s===34?3:2,this.index+1),this.state=11)}stateInAttrValueDoubleQuotes(t){this.handleInAttrValue(t,34)}stateInAttrValueSingleQuotes(t){this.handleInAttrValue(t,39)}stateInAttrValueNoQuotes(t){Ks(t)||t===62?(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(1,this.index),this.state=11,this.stateBeforeAttrName(t)):(t===39||t===60||t===61||t===96)&&this.cbs.onerr(18,this.index)}stateBeforeDeclaration(t){t===91?(this.state=26,this.sequenceIndex=0):this.state=t===45?25:23}stateInDeclaration(t){(t===62||this.fastForwardTo(62))&&(this.state=1,this.sectionStart=this.index+1)}stateInProcessingInstruction(t){(t===62||this.fastForwardTo(62))&&(this.cbs.onprocessinginstruction(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeComment(t){t===45?(this.state=28,this.currentSequence=ys.CommentEnd,this.sequenceIndex=2,this.sectionStart=this.index+1):this.state=23}stateInSpecialComment(t){(t===62||this.fastForwardTo(62))&&(this.cbs.oncomment(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeSpecialS(t){t===ys.ScriptEnd[3]?this.startSpecial(ys.ScriptEnd,4):t===ys.StyleEnd[3]?this.startSpecial(ys.StyleEnd,4):(this.state=6,this.stateInTagName(t))}stateBeforeSpecialT(t){t===ys.TitleEnd[3]?this.startSpecial(ys.TitleEnd,4):t===ys.TextareaEnd[3]?this.startSpecial(ys.TextareaEnd,4):(this.state=6,this.stateInTagName(t))}startEntity(){}stateInEntity(){}parse(t){for(this.buffer=t;this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);switch(s===10&&this.state!==33&&this.newlines.push(this.index),this.state){case 1:{this.stateText(s);break}case 2:{this.stateInterpolationOpen(s);break}case 3:{this.stateInterpolation(s);break}case 4:{this.stateInterpolationClose(s);break}case 31:{this.stateSpecialStartSequence(s);break}case 32:{this.stateInRCDATA(s);break}case 26:{this.stateCDATASequence(s);break}case 19:{this.stateInAttrValueDoubleQuotes(s);break}case 12:{this.stateInAttrName(s);break}case 13:{this.stateInDirName(s);break}case 14:{this.stateInDirArg(s);break}case 15:{this.stateInDynamicDirArg(s);break}case 16:{this.stateInDirModifier(s);break}case 28:{this.stateInCommentLike(s);break}case 27:{this.stateInSpecialComment(s);break}case 11:{this.stateBeforeAttrName(s);break}case 6:{this.stateInTagName(s);break}case 34:{this.stateInSFCRootTagName(s);break}case 9:{this.stateInClosingTagName(s);break}case 5:{this.stateBeforeTagName(s);break}case 17:{this.stateAfterAttrName(s);break}case 20:{this.stateInAttrValueSingleQuotes(s);break}case 18:{this.stateBeforeAttrValue(s);break}case 8:{this.stateBeforeClosingTagName(s);break}case 10:{this.stateAfterClosingTagName(s);break}case 29:{this.stateBeforeSpecialS(s);break}case 30:{this.stateBeforeSpecialT(s);break}case 21:{this.stateInAttrValueNoQuotes(s);break}case 7:{this.stateInSelfClosingTag(s);break}case 23:{this.stateInDeclaration(s);break}case 22:{this.stateBeforeDeclaration(s);break}case 25:{this.stateBeforeComment(s);break}case 24:{this.stateInProcessingInstruction(s);break}case 33:{this.stateInEntity();break}}this.index++}this.cleanup(),this.finish()}cleanup(){this.sectionStart!==this.index&&(this.state===1||this.state===32&&this.sequenceIndex===0?(this.cbs.ontext(this.sectionStart,this.index),this.sectionStart=this.index):(this.state===19||this.state===20||this.state===21)&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=this.index))}finish(){this.handleTrailingData(),this.cbs.onend()}handleTrailingData(){const t=this.buffer.length;this.sectionStart>=t||(this.state===28?this.currentSequence===ys.CdataEnd?this.cbs.oncdata(this.sectionStart,t):this.cbs.oncomment(this.sectionStart,t):this.state===6||this.state===11||this.state===18||this.state===17||this.state===12||this.state===13||this.state===14||this.state===15||this.state===16||this.state===20||this.state===19||this.state===21||this.state===9||this.cbs.ontext(this.sectionStart,t))}emitCodePoint(t,s){}}function Vp(e,{compatConfig:t}){const s=t&&t[e];return e==="MODE"?s||3:s}function Jn(e,t){const s=Vp("MODE",t),a=Vp(e,t);return s===3?a===!0:a!==!1}function Kl(e,t,s,...a){return Jn(e,t)}function wu(e){throw e}function xv(e){}function Ot(e,t,s,a){const n=`https://vuejs.org/error-reference/#compiler-${e}`,i=new SyntaxError(String(n));return i.code=e,i.loc=t,i}const zs=e=>e.type===4&&e.isStatic;function _v(e){switch(e){case"Teleport":case"teleport":return Il;case"Suspense":case"suspense":return lu;case"KeepAlive":case"keep-alive":return mr;case"BaseTransition":case"base-transition":return fv}}const H_=/^$|^\d|[^\$\w\xA0-\uFFFF]/,ku=e=>!H_.test(e),wv=/[A-Za-z_$\xA0-\uFFFF]/,j_=/[\.\?\w$\xA0-\uFFFF]/,V_=/\s+[.[]\s*|\s*[.[]\s+/g,kv=e=>e.type===4?e.content:e.loc.source,q_=e=>{const t=kv(e).trim().replace(V_,o=>o.trim());let s=0,a=[],n=0,i=0,l=null;for(let o=0;o<t.length;o++){const r=t.charAt(o);switch(s){case 0:if(r==="[")a.push(s),s=1,n++;else if(r==="(")a.push(s),s=2,i++;else if(!(o===0?wv:j_).test(r))return!1;break;case 1:r==="'"||r==='"'||r==="`"?(a.push(s),s=3,l=r):r==="["?n++:r==="]"&&(--n||(s=a.pop()));break;case 2:if(r==="'"||r==='"'||r==="`")a.push(s),s=3,l=r;else if(r==="(")i++;else if(r===")"){if(o===t.length-1)return!1;--i||(s=a.pop())}break;case 3:r===l&&(s=a.pop(),l=null);break}}return!n&&!i},Sv=q_,G_=/^\s*(?:async\s*)?(?:\([^)]*?\)|[\w$_]+)\s*(?::[^=]+)?=>|^\s*(?:async\s+)?function(?:\s+[\w$]+)?\s*\(/,W_=e=>G_.test(kv(e)),K_=W_;function sa(e,t,s=!1){for(let a=0;a<e.props.length;a++){const n=e.props[a];if(n.type===7&&(s||n.exp)&&(Ye(t)?n.name===t:t.test(n.name)))return n}}function Wr(e,t,s=!1,a=!1){for(let n=0;n<e.props.length;n++){const i=e.props[n];if(i.type===6){if(s)continue;if(i.name===t&&(i.value||a))return i}else if(i.name==="bind"&&(i.exp||a)&&Hn(i.arg,t))return i}}function Hn(e,t){return!!(e&&zs(e)&&e.content===t)}function J_(e){return e.props.some(t=>t.type===7&&t.name==="bind"&&(!t.arg||t.arg.type!==4||!t.arg.isStatic))}function Tc(e){return e.type===5||e.type===2}function qp(e){return e.type===7&&e.name==="pre"}function Z_(e){return e.type===7&&e.name==="slot"}function br(e){return e.type===1&&e.tagType===3}function yr(e){return e.type===1&&e.tagType===2}const Y_=new Set([Gl,co]);function Cv(e,t=[]){if(e&&!Ye(e)&&e.type===14){const s=e.callee;if(!Ye(s)&&Y_.has(s))return Cv(e.arguments[0],t.concat(e))}return[e,t]}function xr(e,t,s){let a,n=e.type===13?e.props:e.arguments[2],i=[],l;if(n&&!Ye(n)&&n.type===14){const o=Cv(n);n=o[0],i=o[1],l=i[i.length-1]}if(n==null||Ye(n))a=aa([t]);else if(n.type===14){const o=n.arguments[0];!Ye(o)&&o.type===15?Gp(t,o)||o.properties.unshift(t):n.callee===bu?a=ss(s.helper(hr),[aa([t]),n]):n.arguments.unshift(aa([t])),!a&&(a=n)}else n.type===15?(Gp(t,n)||n.properties.unshift(t),a=n):(a=ss(s.helper(hr),[aa([t]),n]),l&&l.callee===co&&(l=i[i.length-2]));e.type===13?l?l.arguments[0]=a:e.props=a:l?l.arguments[0]=a:e.arguments[2]=a}function Gp(e,t){let s=!1;if(e.key.type===4){const a=e.key.content;s=t.properties.some(n=>n.key.type===4&&n.key.content===a)}return s}function Jl(e,t){return`_${t}_${e.replace(/[^\w]/g,(s,a)=>s==="-"?"_":e.charCodeAt(a).toString())}`}function Q_(e){return e.type===14&&e.callee===xu?e.arguments[1].returns:e}const X_=/([\s\S]*?)\s+(?:in|of)\s+(\S[\s\S]*)/;function Tv(e){for(let t=0;t<e.length;t++)if(!Ks(e.charCodeAt(t)))return!1;return!0}function Su(e){return e.type===2&&Tv(e.content)||e.type===12&&Su(e.content)}function Ev(e){return e.type===3||Su(e)}const Av={parseMode:"base",ns:0,delimiters:["{{","}}"],getNamespace:()=>0,isVoidTag:Ci,isPreTag:Ci,isIgnoreNewlineTag:Ci,isCustomElement:Ci,onError:wu,onWarn:xv,comments:!1,prefixIdentifiers:!1};let ft=Av,Zl=null,Xa="",_s=null,ot=null,Ps="",za=-1,Bn=-1,Cu=0,xn=!1,pd=null;const It=[],$t=new z_(It,{onerr:Fa,ontext(e,t){Ao(ps(e,t),e,t)},ontextentity(e,t,s){Ao(e,t,s)},oninterpolation(e,t){if(xn)return Ao(ps(e,t),e,t);let s=e+$t.delimiterOpen.length,a=t-$t.delimiterClose.length;for(;Ks(Xa.charCodeAt(s));)s++;for(;Ks(Xa.charCodeAt(a-1));)a--;let n=ps(s,a);n.includes("&")&&(n=ft.decodeEntities(n,!1)),fd({type:5,content:qo(n,!1,Ut(s,a)),loc:Ut(e,t)})},onopentagname(e,t){const s=ps(e,t);_s={type:1,tag:s,ns:ft.getNamespace(s,It[0],ft.ns),tagType:0,props:[],children:[],loc:Ut(e-1,t),codegenNode:void 0}},onopentagend(e){Kp(e)},onclosetag(e,t){const s=ps(e,t);if(!ft.isVoidTag(s)){let a=!1;for(let n=0;n<It.length;n++)if(It[n].tag.toLowerCase()===s.toLowerCase()){a=!0,n>0&&Fa(24,It[0].loc.start.offset);for(let l=0;l<=n;l++){const o=It.shift();Vo(o,t,l<n)}break}a||Fa(23,Rv(e,60))}},onselfclosingtag(e){const t=_s.tag;_s.isSelfClosing=!0,Kp(e),It[0]&&It[0].tag===t&&Vo(It.shift(),e)},onattribname(e,t){ot={type:6,name:ps(e,t),nameLoc:Ut(e,t),value:void 0,loc:Ut(e)}},ondirname(e,t){const s=ps(e,t),a=s==="."||s===":"?"bind":s==="@"?"on":s==="#"?"slot":s.slice(2);if(!xn&&a===""&&Fa(26,e),xn||a==="")ot={type:6,name:s,nameLoc:Ut(e,t),value:void 0,loc:Ut(e)};else if(ot={type:7,name:a,rawName:s,exp:void 0,arg:void 0,modifiers:s==="."?[et("prop")]:[],loc:Ut(e)},a==="pre"){xn=$t.inVPre=!0,pd=_s;const n=_s.props;for(let i=0;i<n.length;i++)n[i].type===7&&(n[i]=cw(n[i]))}},ondirarg(e,t){if(e===t)return;const s=ps(e,t);if(xn&&!qp(ot))ot.name+=s,jn(ot.nameLoc,t);else{const a=s[0]!=="[";ot.arg=qo(a?s:s.slice(1,-1),a,Ut(e,t),a?3:0)}},ondirmodifier(e,t){const s=ps(e,t);if(xn&&!qp(ot))ot.name+="."+s,jn(ot.nameLoc,t);else if(ot.name==="slot"){const a=ot.arg;a&&(a.content+="."+s,jn(a.loc,t))}else{const a=et(s,!0,Ut(e,t));ot.modifiers.push(a)}},onattribdata(e,t){Ps+=ps(e,t),za<0&&(za=e),Bn=t},onattribentity(e,t,s){Ps+=e,za<0&&(za=t),Bn=s},onattribnameend(e){const t=ot.loc.start.offset,s=ps(t,e);ot.type===7&&(ot.rawName=s),_s.props.some(a=>(a.type===7?a.rawName:a.name)===s)&&Fa(2,t)},onattribend(e,t){if(_s&&ot){if(jn(ot.loc,t),e!==0)if(Ps.includes("&")&&(Ps=ft.decodeEntities(Ps,!0)),ot.type===6)ot.name==="class"&&(Ps=Ov(Ps).trim()),e===1&&!Ps&&Fa(13,t),ot.value={type:2,content:Ps,loc:e===1?Ut(za,Bn):Ut(za-1,Bn+1)},$t.inSFCRoot&&_s.tag==="template"&&ot.name==="lang"&&Ps&&Ps!=="html"&&$t.enterRCDATA(gr("</template"),0);else{let s=0;ot.exp=qo(Ps,!1,Ut(za,Bn),0,s),ot.name==="for"&&(ot.forParseResult=tw(ot.exp));let a=-1;ot.name==="bind"&&(a=ot.modifiers.findIndex(n=>n.content==="sync"))>-1&&Kl("COMPILER_V_BIND_SYNC",ft,ot.loc,ot.arg.loc.source)&&(ot.name="model",ot.modifiers.splice(a,1))}(ot.type!==7||ot.name!=="pre")&&_s.props.push(ot)}Ps="",za=Bn=-1},oncomment(e,t){ft.comments&&fd({type:3,content:ps(e,t),loc:Ut(e-4,t+3)})},onend(){const e=Xa.length;for(let t=0;t<It.length;t++)Vo(It[t],e-1),Fa(24,It[t].loc.start.offset)},oncdata(e,t){(It[0]?It[0].ns:ft.ns)!==0?Ao(ps(e,t),e,t):Fa(1,e-9)},onprocessinginstruction(e){(It[0]?It[0].ns:ft.ns)===0&&Fa(21,e-1)}}),Wp=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,ew=/^\(|\)$/g;function tw(e){const t=e.loc,s=e.content,a=s.match(X_);if(!a)return;const[,n,i]=a,l=(u,p,m=!1)=>{const h=t.start.offset+p,b=h+u.length;return qo(u,!1,Ut(h,b),0,m?1:0)},o={source:l(i.trim(),s.indexOf(i,n.length)),value:void 0,key:void 0,index:void 0,finalized:!1};let r=n.trim().replace(ew,"").trim();const c=n.indexOf(r),d=r.match(Wp);if(d){r=r.replace(Wp,"").trim();const u=d[1].trim();let p;if(u&&(p=s.indexOf(u,c+r.length),o.key=l(u,p,!0)),d[2]){const m=d[2].trim();m&&(o.index=l(m,s.indexOf(m,o.key?p+u.length:c+r.length),!0))}}return r&&(o.value=l(r,c,!0)),o}function ps(e,t){return Xa.slice(e,t)}function Kp(e){$t.inSFCRoot&&(_s.innerLoc=Ut(e+1,e+1)),fd(_s);const{tag:t,ns:s}=_s;s===0&&ft.isPreTag(t)&&Cu++,ft.isVoidTag(t)?Vo(_s,e):(It.unshift(_s),(s===1||s===2)&&($t.inXML=!0)),_s=null}function Ao(e,t,s){{const i=It[0]&&It[0].tag;i!=="script"&&i!=="style"&&e.includes("&")&&(e=ft.decodeEntities(e,!1))}const a=It[0]||Zl,n=a.children[a.children.length-1];n&&n.type===2?(n.content+=e,jn(n.loc,s)):a.children.push({type:2,content:e,loc:Ut(t,s)})}function Vo(e,t,s=!1){s?jn(e.loc,Rv(t,60)):jn(e.loc,sw(t,62)+1),$t.inSFCRoot&&(e.children.length?e.innerLoc.end=nt({},e.children[e.children.length-1].loc.end):e.innerLoc.end=nt({},e.innerLoc.start),e.innerLoc.source=ps(e.innerLoc.start.offset,e.innerLoc.end.offset));const{tag:a,ns:n,children:i}=e;if(xn||(a==="slot"?e.tagType=2:Jp(e)?e.tagType=3:nw(e)&&(e.tagType=1)),$t.inRCDATA||(e.children=Iv(i)),n===0&&ft.isIgnoreNewlineTag(a)){const l=i[0];l&&l.type===2&&(l.content=l.content.replace(/^\r?\n/,""))}n===0&&ft.isPreTag(a)&&Cu--,pd===e&&(xn=$t.inVPre=!1,pd=null),$t.inXML&&(It[0]?It[0].ns:ft.ns)===0&&($t.inXML=!1);{const l=e.props;if(!$t.inSFCRoot&&Jn("COMPILER_NATIVE_TEMPLATE",ft)&&e.tag==="template"&&!Jp(e)){const r=It[0]||Zl,c=r.children.indexOf(e);r.children.splice(c,1,...e.children)}const o=l.find(r=>r.type===6&&r.name==="inline-template");o&&Kl("COMPILER_INLINE_TEMPLATE",ft,o.loc)&&e.children.length&&(o.value={type:2,content:ps(e.children[0].loc.start.offset,e.children[e.children.length-1].loc.end.offset),loc:o.loc})}}function sw(e,t){let s=e;for(;Xa.charCodeAt(s)!==t&&s<Xa.length-1;)s++;return s}function Rv(e,t){let s=e;for(;Xa.charCodeAt(s)!==t&&s>=0;)s--;return s}const aw=new Set(["if","else","else-if","for","slot"]);function Jp({tag:e,props:t}){if(e==="template"){for(let s=0;s<t.length;s++)if(t[s].type===7&&aw.has(t[s].name))return!0}return!1}function nw({tag:e,props:t}){if(ft.isCustomElement(e))return!1;if(e==="component"||iw(e.charCodeAt(0))||_v(e)||ft.isBuiltInComponent&&ft.isBuiltInComponent(e)||ft.isNativeTag&&!ft.isNativeTag(e))return!0;for(let s=0;s<t.length;s++){const a=t[s];if(a.type===6){if(a.name==="is"&&a.value){if(a.value.content.startsWith("vue:"))return!0;if(Kl("COMPILER_IS_ON_ELEMENT",ft,a.loc))return!0}}else if(a.name==="bind"&&Hn(a.arg,"is")&&Kl("COMPILER_IS_ON_ELEMENT",ft,a.loc))return!0}return!1}function iw(e){return e>64&&e<91}const lw=/\r\n/g;function Iv(e){const t=ft.whitespace!=="preserve";let s=!1;for(let a=0;a<e.length;a++){const n=e[a];if(n.type===2)if(Cu)n.content=n.content.replace(lw,`
`);else if(Tv(n.content)){const i=e[a-1]&&e[a-1].type,l=e[a+1]&&e[a+1].type;!i||!l||t&&(i===3&&(l===3||l===1)||i===1&&(l===3||l===1&&ow(n.content)))?(s=!0,e[a]=null):n.content=" "}else t&&(n.content=Ov(n.content))}return s?e.filter(Boolean):e}function ow(e){for(let t=0;t<e.length;t++){const s=e.charCodeAt(t);if(s===10||s===13)return!0}return!1}function Ov(e){let t="",s=!1;for(let a=0;a<e.length;a++)Ks(e.charCodeAt(a))?s||(t+=" ",s=!0):(t+=e[a],s=!1);return t}function fd(e){(It[0]||Zl).children.push(e)}function Ut(e,t){return{start:$t.getPos(e),end:t==null?t:$t.getPos(t),source:t==null?t:ps(e,t)}}function rw(e){return Ut(e.start.offset,e.end.offset)}function jn(e,t){e.end=$t.getPos(t),e.source=ps(e.start.offset,t)}function cw(e){const t={type:6,name:e.rawName,nameLoc:Ut(e.loc.start.offset,e.loc.start.offset+e.rawName.length),value:void 0,loc:e.loc};if(e.exp){const s=e.exp.loc;s.end.offset<e.loc.end.offset&&(s.start.offset--,s.start.column--,s.end.offset++,s.end.column++),t.value={type:2,content:e.exp.content,loc:s}}return t}function qo(e,t=!1,s,a=0,n=0){return et(e,t,s,a)}function Fa(e,t,s){ft.onError(Ot(e,Ut(t,t)))}function dw(){$t.reset(),_s=null,ot=null,Ps="",za=-1,Bn=-1,It.length=0}function uw(e,t){if(dw(),Xa=e,ft=nt({},Av),t){let n;for(n in t)t[n]!=null&&(ft[n]=t[n])}$t.mode=ft.parseMode==="html"?1:ft.parseMode==="sfc"?2:0,$t.inXML=ft.ns===1||ft.ns===2;const s=t&&t.delimiters;s&&($t.delimiterOpen=gr(s[0]),$t.delimiterClose=gr(s[1]));const a=Zl=F_([],e);return $t.parse(Xa),a.loc=Ut(0,e.length),a.children=Iv(a.children),Zl=null,a}function pw(e,t){Go(e,void 0,t,!!Lv(e))}function Lv(e){const t=e.children.filter(s=>s.type!==3);return t.length===1&&t[0].type===1&&!yr(t[0])?t[0]:null}function Go(e,t,s,a=!1,n=!1){const{children:i}=e,l=[];for(let d=0;d<i.length;d++){const u=i[d];if(u.type===1&&u.tagType===0){const p=a?0:Js(u,s);if(p>0){if(p>=2){u.codegenNode.patchFlag=-1,l.push(u);continue}}else{const m=u.codegenNode;if(m.type===13){const h=m.patchFlag;if((h===void 0||h===512||h===1)&&Mv(u,s)>=2){const b=Dv(u);b&&(m.props=s.hoist(b))}m.dynamicProps&&(m.dynamicProps=s.hoist(m.dynamicProps))}}}else if(u.type===12&&(a?0:Js(u,s))>=2){u.codegenNode.type===14&&u.codegenNode.arguments.length>0&&u.codegenNode.arguments.push("-1"),l.push(u);continue}if(u.type===1){const p=u.tagType===1;p&&s.scopes.vSlot++,Go(u,e,s,!1,n),p&&s.scopes.vSlot--}else if(u.type===11)Go(u,e,s,u.children.length===1,!0);else if(u.type===9)for(let p=0;p<u.branches.length;p++)Go(u.branches[p],e,s,u.branches[p].children.length===1,n)}let o=!1;if(l.length===i.length&&e.type===1){if(e.tagType===0&&e.codegenNode&&e.codegenNode.type===13&&Oe(e.codegenNode.children))e.codegenNode.children=r(Kn(e.codegenNode.children)),o=!0;else if(e.tagType===1&&e.codegenNode&&e.codegenNode.type===13&&e.codegenNode.children&&!Oe(e.codegenNode.children)&&e.codegenNode.children.type===15){const d=c(e.codegenNode,"default");d&&(d.returns=r(Kn(d.returns)),o=!0)}else if(e.tagType===3&&t&&t.type===1&&t.tagType===1&&t.codegenNode&&t.codegenNode.type===13&&t.codegenNode.children&&!Oe(t.codegenNode.children)&&t.codegenNode.children.type===15){const d=sa(e,"slot",!0),u=d&&d.arg&&c(t.codegenNode,d.arg);u&&(u.returns=r(Kn(u.returns)),o=!0)}}if(!o)for(const d of l)d.codegenNode=s.cache(d.codegenNode);function r(d){const u=s.cache(d);return u.needArraySpread=!0,u}function c(d,u){if(d.children&&!Oe(d.children)&&d.children.type===15){const p=d.children.properties.find(m=>m.key===u||m.key.content===u);return p&&p.value}}l.length&&s.transformHoist&&s.transformHoist(i,s,e)}function Js(e,t){const{constantCache:s}=t;switch(e.type){case 1:if(e.tagType!==0)return 0;const a=s.get(e);if(a!==void 0)return a;const n=e.codegenNode;if(n.type!==13||n.isBlock&&e.tag!=="svg"&&e.tag!=="foreignObject"&&e.tag!=="math")return 0;if(n.patchFlag===void 0){let l=3;const o=Mv(e,t);if(o===0)return s.set(e,0),0;o<l&&(l=o);for(let r=0;r<e.children.length;r++){const c=Js(e.children[r],t);if(c===0)return s.set(e,0),0;c<l&&(l=c)}if(l>1)for(let r=0;r<e.props.length;r++){const c=e.props[r];if(c.type===7&&c.name==="bind"&&c.exp){const d=Js(c.exp,t);if(d===0)return s.set(e,0),0;d<l&&(l=d)}}if(n.isBlock){for(let r=0;r<e.props.length;r++)if(e.props[r].type===7)return s.set(e,0),0;t.removeHelper(Qn),t.removeHelper(Gi(t.inSSR,n.isComponent)),n.isBlock=!1,t.helper(qi(t.inSSR,n.isComponent))}return s.set(e,l),l}else return s.set(e,0),0;case 2:case 3:return 3;case 9:case 11:case 10:return 0;case 5:case 12:return Js(e.content,t);case 4:return e.constType;case 8:let i=3;for(let l=0;l<e.children.length;l++){const o=e.children[l];if(Ye(o)||Cs(o))continue;const r=Js(o,t);if(r===0)return 0;r<i&&(i=r)}return i;case 20:return 2;default:return 0}}const fw=new Set([vu,gu,Gl,co]);function Nv(e,t){if(e.type===14&&!Ye(e.callee)&&fw.has(e.callee)){const s=e.arguments[0];if(s.type===4)return Js(s,t);if(s.type===14)return Nv(s,t)}return 0}function Mv(e,t){let s=3;const a=Dv(e);if(a&&a.type===15){const{properties:n}=a;for(let i=0;i<n.length;i++){const{key:l,value:o}=n[i],r=Js(l,t);if(r===0)return r;r<s&&(s=r);let c;if(o.type===4?c=Js(o,t):o.type===14?c=Nv(o,t):c=0,c===0)return c;c<s&&(s=c)}}return s}function Dv(e){const t=e.codegenNode;if(t.type===13)return t.props}function mw(e,{filename:t="",prefixIdentifiers:s=!1,hoistStatic:a=!1,hmr:n=!1,cacheHandlers:i=!1,nodeTransforms:l=[],directiveTransforms:o={},transformHoist:r=null,isBuiltInComponent:c=hs,isCustomElement:d=hs,expressionPlugins:u=[],scopeId:p=null,slotted:m=!0,ssr:h=!1,inSSR:b=!1,ssrCssVars:I="",bindingMetadata:k=it,inline:y=!1,isTS:g=!1,onError:x=wu,onWarn:S=xv,compatConfig:_}){const E=t.replace(/\?.*$/,"").match(/([^/\\]+)\.\w+$/),R={filename:t,selfName:E&&si(wt(E[1])),prefixIdentifiers:s,hoistStatic:a,hmr:n,cacheHandlers:i,nodeTransforms:l,directiveTransforms:o,transformHoist:r,isBuiltInComponent:c,isCustomElement:d,expressionPlugins:u,scopeId:p,slotted:m,ssr:h,inSSR:b,ssrCssVars:I,bindingMetadata:k,inline:y,isTS:g,onError:x,onWarn:S,compatConfig:_,root:e,helpers:new Map,components:new Set,directives:new Set,hoists:[],imports:[],cached:[],constantCache:new WeakMap,vForMemoKeyedNodes:new WeakSet,temps:0,identifiers:Object.create(null),scopes:{vFor:0,vSlot:0,vPre:0,vOnce:0},parent:null,grandParent:null,currentNode:e,childIndex:0,inVOnce:!1,helper(w){const O=R.helpers.get(w)||0;return R.helpers.set(w,O+1),w},removeHelper(w){const O=R.helpers.get(w);if(O){const U=O-1;U?R.helpers.set(w,U):R.helpers.delete(w)}},helperString(w){return`_${ji[R.helper(w)]}`},replaceNode(w){R.parent.children[R.childIndex]=R.currentNode=w},removeNode(w){const O=R.parent.children,U=w?O.indexOf(w):R.currentNode?R.childIndex:-1;!w||w===R.currentNode?(R.currentNode=null,R.onNodeRemoved()):R.childIndex>U&&(R.childIndex--,R.onNodeRemoved()),R.parent.children.splice(U,1)},onNodeRemoved:hs,addIdentifiers(w){},removeIdentifiers(w){},hoist(w){Ye(w)&&(w=et(w)),R.hoists.push(w);const O=et(`_hoisted_${R.hoists.length}`,!1,w.loc,2);return O.hoisted=w,O},cache(w,O=!1,U=!1){const T=B_(R.cached.length,w,O,U);return R.cached.push(T),T}};return R.filters=new Set,R}function hw(e,t){const s=mw(e,t);Kr(e,s),t.hoistStatic&&pw(e,s),t.ssr||vw(e,s),e.helpers=new Set([...s.helpers.keys()]),e.components=[...s.components],e.directives=[...s.directives],e.imports=s.imports,e.hoists=s.hoists,e.temps=s.temps,e.cached=s.cached,e.transformed=!0,e.filters=[...s.filters]}function vw(e,t){const{helper:s}=t,{children:a}=e;if(a.length===1){const n=Lv(e);if(n&&n.codegenNode){const i=n.codegenNode;i.type===13&&_u(i,t),e.codegenNode=i}else e.codegenNode=a[0]}else if(a.length>1){let n=64;e.codegenNode=Wl(t,s(ql),void 0,e.children,n,void 0,void 0,!0,void 0,!1)}}function gw(e,t){let s=0;const a=()=>{s--};for(;s<e.children.length;s++){const n=e.children[s];Ye(n)||(t.grandParent=t.parent,t.parent=e,t.childIndex=s,t.onNodeRemoved=a,Kr(n,t))}}function Kr(e,t){t.currentNode=e;const{nodeTransforms:s}=t,a=[];for(let i=0;i<s.length;i++){const l=s[i](e,t);if(l&&(Oe(l)?a.push(...l):a.push(l)),t.currentNode)e=t.currentNode;else return}switch(e.type){case 3:t.ssr||t.helper(ro);break;case 5:t.ssr||t.helper(Gr);break;case 9:for(let i=0;i<e.branches.length;i++)Kr(e.branches[i],t);break;case 10:case 11:case 1:case 0:gw(e,t);break}t.currentNode=e;let n=a.length;for(;n--;)a[n]()}function Pv(e,t){const s=Ye(e)?a=>a===e:a=>e.test(a);return(a,n)=>{if(a.type===1){const{props:i}=a;if(a.tagType===3&&i.some(Z_))return;const l=[];for(let o=0;o<i.length;o++){const r=i[o];if(r.type===7&&s(r.name)){i.splice(o,1),o--;const c=t(a,r,n);c&&l.push(c)}}return l}}}const Jr="/*@__PURE__*/",$v=e=>`${ji[e]}: _${ji[e]}`;function bw(e,{mode:t="function",prefixIdentifiers:s=t==="module",sourceMap:a=!1,filename:n="template.vue.html",scopeId:i=null,optimizeImports:l=!1,runtimeGlobalName:o="Vue",runtimeModuleName:r="vue",ssrRuntimeModuleName:c="vue/server-renderer",ssr:d=!1,isTS:u=!1,inSSR:p=!1}){const m={mode:t,prefixIdentifiers:s,sourceMap:a,filename:n,scopeId:i,optimizeImports:l,runtimeGlobalName:o,runtimeModuleName:r,ssrRuntimeModuleName:c,ssr:d,isTS:u,inSSR:p,source:e.source,code:"",column:1,line:1,offset:0,indentLevel:0,pure:!1,map:void 0,helper(b){return`_${ji[b]}`},push(b,I=-2,k){m.code+=b},indent(){h(++m.indentLevel)},deindent(b=!1){b?--m.indentLevel:h(--m.indentLevel)},newline(){h(m.indentLevel)}};function h(b){m.push(`
`+"  ".repeat(b),0)}return m}function yw(e,t={}){const s=bw(e,t);t.onContextCreated&&t.onContextCreated(s);const{mode:a,push:n,prefixIdentifiers:i,indent:l,deindent:o,newline:r,scopeId:c,ssr:d}=s,u=Array.from(e.helpers),p=u.length>0,m=!i&&a!=="module";xw(e,s);const b=d?"ssrRender":"render",k=(d?["_ctx","_push","_parent","_attrs"]:["_ctx","_cache"]).join(", ");if(n(`function ${b}(${k}) {`),l(),m&&(n("with (_ctx) {"),l(),p&&(n(`const { ${u.map($v).join(", ")} } = _Vue
...
`,0),r()),d||n("return "),e.codegenNode?Ss(e.codegenNode,s):n("null"),m&&(o(),n("}")),o(),n("}"),{ast:e,code:s.code,preamble:"",map:s.map?s.map.toJSON():void 0}}function xw(e,t){const{ssr:s,prefixIdentifiers:a,push:n,newline:i,runtimeModuleName:l,runtimeGlobalName:o,ssrRuntimeModuleName:r}=t,c=o,d=Array.from(e.helpers);if(d.length>0&&(n(`const _Vue = ${c}
`,-1),e.hoists.length)){const u=[ou,ru,ro,cu,vv].filter(p=>d.includes(p)).map($v).join(", ");n(`const { ${u} } = _Vue
`,-1)}_w(e.hoists,t),i(),n("return ")}function Ec(e,t,{helper:s,push:a,newline:n,isTS:i}){const l=s(t==="filter"?fu:t==="component"?du:pu);for(let o=0;o<e.length;o++){let r=e[o];const c=r.endsWith("__self");c&&(r=r.slice(0,-6)),a(`const ${Jl(r,t)} = ${l}(${JSON.stringify(r)}${c?", true":""})${i?"!":""}`),o<e.length-1&&n()}}function _w(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:a}=t;a();for(let n=0;n<e.length;n++){const i=e[n];i&&(s(`const _hoisted_${n+1} = `),Ss(i,t),a())}t.pure=!1}function Tu(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),uo(e,t,s),s&&t.deindent(),t.push("]")}function uo(e,t,s=!1,a=!0){const{push:n,newline:i}=t;for(let l=0;l<e.length;l++){const o=e[l];Ye(o)?n(o,-3):Oe(o)?Tu(o,t):Ss(o,t),l<e.length-1&&(s?(a&&n(","),i()):a&&n(", "))}}function Ss(e,t){if(Ye(e)){t.push(e,-3);return}if(Cs(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:Ss(e.codegenNode,t);break;case 2:ww(e,t);break;case 4:Fv(e,t);break;case 5:kw(e,t);break;case 12:Ss(e.codegenNode,t);break;case 8:Bv(e,t);break;case 3:Cw(e,t);break;case 13:Tw(e,t);break;case 14:Aw(e,t);break;case 15:Rw(e,t);break;case 17:Iw(e,t);break;case 18:Ow(e,t);break;case 19:Lw(e,t);break;case 20:Nw(e,t);break;case 21:uo(e.body,t,!0,!1);break}}function ww(e,t){t.push(JSON.stringify(e.content),-3,e)}function Fv(e,t){const{content:s,isStatic:a}=e;t.push(a?JSON.stringify(s):s,-3,e)}function kw(e,t){const{push:s,helper:a,pure:n}=t;n&&s(Jr),s(`${a(Gr)}(`),Ss(e.content,t),s(")")}function Bv(e,t){for(let s=0;s<e.children.length;s++){const a=e.children[s];Ye(a)?t.push(a,-3):Ss(a,t)}}function Sw(e,t){const{push:s}=t;if(e.type===8)s("["),Bv(e,t),s("]");else if(e.isStatic){const a=ku(e.content)?e.content:JSON.stringify(e.content);s(a,-2,e)}else s(`[${e.content}]`,-3,e)}function Cw(e,t){const{push:s,helper:a,pure:n}=t;n&&s(Jr),s(`${a(ro)}(${JSON.stringify(e.content)})`,-3,e)}function Tw(e,t){const{push:s,helper:a,pure:n}=t,{tag:i,props:l,children:o,patchFlag:r,dynamicProps:c,directives:d,isBlock:u,disableTracking:p,isComponent:m}=e;let h;r&&(h=String(r)),d&&s(a(mu)+"("),u&&s(`(${a(Qn)}(${p?"true":""}), `),n&&s(Jr);const b=u?Gi(t.inSSR,m):qi(t.inSSR,m);s(a(b)+"(",-2,e),uo(Ew([i,l,o,h,c]),t),s(")"),u&&s(")"),d&&(s(", "),Ss(d,t),s(")"))}function Ew(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function Aw(e,t){const{push:s,helper:a,pure:n}=t,i=Ye(e.callee)?e.callee:a(e.callee);n&&s(Jr),s(i+"(",-2,e),uo(e.arguments,t),s(")")}function Rw(e,t){const{push:s,indent:a,deindent:n,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const o=l.length>1||!1;s(o?"{":"{ "),o&&a();for(let r=0;r<l.length;r++){const{key:c,value:d}=l[r];Sw(c,t),s(": "),Ss(d,t),r<l.length-1&&(s(","),i())}o&&n(),s(o?"}":" }")}function Iw(e,t){Tu(e.elements,t)}function Ow(e,t){const{push:s,indent:a,deindent:n}=t,{params:i,returns:l,body:o,newline:r,isSlot:c}=e;c&&s(`_${ji[yu]}(`),s("(",-2,e),Oe(i)?uo(i,t):i&&Ss(i,t),s(") => "),(r||o)&&(s("{"),a()),l?(r&&s("return "),Oe(l)?Tu(l,t):Ss(l,t)):o&&Ss(o,t),(r||o)&&(n(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function Lw(e,t){const{test:s,consequent:a,alternate:n,newline:i}=e,{push:l,indent:o,deindent:r,newline:c}=t;if(s.type===4){const u=!ku(s.content);u&&l("("),Fv(s,t),u&&l(")")}else l("("),Ss(s,t),l(")");i&&o(),t.indentLevel++,i||l(" "),l("? "),Ss(a,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const d=n.type===19;d||t.indentLevel++,Ss(n,t),d||t.indentLevel--,i&&r(!0)}function Nw(e,t){const{push:s,helper:a,indent:n,deindent:i,newline:l}=t,{needPauseTracking:o,needArraySpread:r}=e;r&&s("[...("),s(`_cache[${e.index}] || (`),o&&(n(),s(`${a(vr)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),Ss(e.value,t),o&&(s(`).cacheIndex = ${e.index},`),l(),s(`${a(vr)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),r&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const Mw=Pv(/^(?:if|else|else-if)$/,(e,t,s)=>Dw(e,t,s,(a,n,i)=>{const l=s.parent.children;let o=l.indexOf(a),r=0;for(;o-->=0;){const c=l[o];c&&c.type===9&&(r+=c.branches.length)}return()=>{if(i)a.codegenNode=Yp(n,r,s);else{const c=Pw(a.codegenNode);c.alternate=Yp(n,r+a.branches.length-1,s)}}}));function Dw(e,t,s,a){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const n=t.exp?t.exp.loc:e.loc;s.onError(Ot(28,t.loc)),t.exp=et("true",!1,n)}if(t.name==="if"){const n=Zp(e,t),i={type:9,loc:rw(e.loc),branches:[n]};if(s.replaceNode(i),a)return a(i,n,!0)}else{const n=s.parent.children;let i=n.indexOf(e);for(;i-->=-1;){const l=n[i];if(l&&Ev(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(Ot(30,e.loc)),s.removeNode();const o=Zp(e,t);l.branches.push(o);const r=a&&a(l,o,!1);Kr(o,s),r&&r(),s.currentNode=null}else s.onError(Ot(30,e.loc));break}}}function Zp(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!sa(e,"for")?e.children:[e],userKey:Wr(e,"key"),isTemplateIf:s}}function Yp(e,t,s){return e.condition?ud(e.condition,Qp(e,t,s),ss(s.helper(ro),['""',"true"])):Qp(e,t,s)}function Qp(e,t,s){const{helper:a}=s,n=qt("key",et(`${t}`,!1,Qs,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const r=l.codegenNode;return xr(r,n,s),r}else return Wl(s,a(ql),aa([n]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const r=l.codegenNode,c=Q_(r);return c.type===13&&_u(c,s),xr(c,n,s),r}}function Pw(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const $w=Pv("for",(e,t,s)=>{const{helper:a,removeHelper:n}=s;return Fw(e,t,s,i=>{const l=ss(a(hu),[i.source]),o=br(e),r=sa(e,"memo"),c=Wr(e,"key",!1,!0);c&&c.type;let d=c&&(c.type===6?c.value?et(c.value.content,!0):void 0:c.exp);const u=d?qt("key",d):null,p=i.source.type===4&&i.source.constType>0,m=p?64:c?128:256;return i.codegenNode=Wl(s,a(ql),void 0,l,m,void 0,void 0,!0,!p,!1,e.loc),()=>{let h;const{children:b}=i,I=b.length!==1||b[0].type!==1,k=yr(e)?e:o&&e.children.length===1&&yr(e.children[0])?e.children[0]:null;if(k?(h=k.codegenNode,o&&u&&xr(h,u,s)):I?h=Wl(s,a(ql),u?aa([u]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(h=b[0].codegenNode,o&&u&&xr(h,u,s),h.isBlock!==!p&&(h.isBlock?(n(Qn),n(Gi(s.inSSR,h.isComponent))):n(qi(s.inSSR,h.isComponent))),h.isBlock=!p,h.isBlock?(a(Qn),a(Gi(s.inSSR,h.isComponent))):a(qi(s.inSSR,h.isComponent))),r){const y=Vi(md(i.parseResult,[et("_cached")]));y.body=U_([ha(["const _memo = (",r.exp,")"]),ha(["if (_cached && _cached.el",...d?[" && _cached.key === ",d]:[],` && ${s.helperString(yv)}(_cached, _memo)) return _cached`]),ha(["const _item = ",h]),et("_item.memo = _memo"),et("return _item")]),l.arguments.push(y,et("_cache"),et(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(Vi(md(i.parseResult),h,!0))}})});function Fw(e,t,s,a){if(!t.exp){s.onError(Ot(31,t.loc));return}const n=t.forParseResult;if(!n){s.onError(Ot(32,t.loc));return}Uv(n);const{addIdentifiers:i,removeIdentifiers:l,scopes:o}=s,{source:r,value:c,key:d,index:u}=n,p={type:11,loc:t.loc,source:r,valueAlias:c,keyAlias:d,objectIndexAlias:u,parseResult:n,children:br(e)?e.children:[e]};s.replaceNode(p),o.vFor++;const m=a&&a(p);return()=>{o.vFor--,m&&m()}}function Uv(e,t){e.finalized||(e.finalized=!0)}function md({value:e,key:t,index:s},a=[]){return Bw([e,t,s,...a])}function Bw(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,a)=>s||et("_".repeat(a+1),!1))}const Xp=et("undefined",!1),Uw=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=sa(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},zw=(e,t,s,a)=>Vi(e,s,!1,!0,s.length?s[0].loc:a);function Hw(e,t,s=zw){t.helper(yu);const{children:a,loc:n}=e,i=[],l=[];let o=t.scopes.vSlot>0||t.scopes.vFor>0;const r=sa(e,"slot",!0);if(r){const{arg:I,exp:k}=r;I&&!zs(I)&&(o=!0),i.push(qt(I||et("default",!0),s(k,void 0,a,n)))}let c=!1,d=!1;const u=[],p=new Set;let m=0;for(let I=0;I<a.length;I++){const k=a[I];let y;if(!br(k)||!(y=sa(k,"slot",!0))){k.type!==3&&u.push(k);continue}if(r){t.onError(Ot(37,y.loc));break}c=!0;const{children:g,loc:x}=k,{arg:S=et("default",!0),exp:_,loc:E}=y;let R;zs(S)?R=S?S.content:"default":o=!0;const w=sa(k,"for"),O=s(_,w,g,x);let U,T;if(U=sa(k,"if"))o=!0,l.push(ud(U.exp,Ro(S,O,m++),Xp));else if(T=sa(k,/^else(?:-if)?$/,!0)){let $=I,te;for(;$--&&(te=a[$],!!Ev(te)););if(te&&br(te)&&sa(te,/^(?:else-)?if$/)){let W=l[l.length-1];for(;W.alternate.type===19;)W=W.alternate;W.alternate=T.exp?ud(T.exp,Ro(S,O,m++),Xp):Ro(S,O,m++)}else t.onError(Ot(30,T.loc))}else if(w){o=!0;const $=w.forParseResult;$?(Uv($),l.push(ss(t.helper(hu),[$.source,Vi(md($),Ro(S,O),!0)]))):t.onError(Ot(32,w.loc))}else{if(R){if(p.has(R)){t.onError(Ot(38,E));continue}p.add(R),R==="default"&&(d=!0)}i.push(qt(S,O))}}if(!r){const I=(k,y)=>{const g=s(k,void 0,y,n);return t.compatConfig&&(g.isNonScopedSlot=!0),qt("default",g)};c?u.length&&!u.every(Su)&&(d?t.onError(Ot(39,u[0].loc)):i.push(I(void 0,u))):i.push(I(void 0,a))}const h=o?2:Wo(e.children)?3:1;let b=aa(i.concat(qt("_",et(h+"",!1))),n);return l.length&&(b=ss(t.helper(bv),[b,Kn(l)])),{slots:b,hasDynamicSlots:o}}function Ro(e,t,s){const a=[qt("name",e),qt("fn",t)];return s!=null&&a.push(qt("key",et(String(s),!0))),aa(a)}function Wo(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||Wo(s.children))return!0;break;case 9:if(Wo(s.branches))return!0;break;case 10:case 11:if(Wo(s.children))return!0;break}}return!1}const zv=new WeakMap,jw=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:a,props:n}=e,i=e.tagType===1;let l=i?Vw(e,t):`"${a}"`;const o=mt(l)&&l.callee===uu;let r,c,d=0,u,p,m,h=o||l===Il||l===lu||!i&&(a==="svg"||a==="foreignObject"||a==="math");if(n.length>0){const b=Hv(e,t,void 0,i,o);r=b.props,d=b.patchFlag,p=b.dynamicPropNames;const I=b.directives;m=I&&I.length?Kn(I.map(k=>Gw(k,t))):void 0,b.shouldUseBlock&&(h=!0)}if(e.children.length>0)if(l===mr&&(h=!0,d|=1024),i&&l!==Il&&l!==mr){const{slots:I,hasDynamicSlots:k}=Hw(e,t);c=I,k&&(d|=1024)}else if(e.children.length===1&&l!==Il){const I=e.children[0],k=I.type,y=k===5||k===8;y&&Js(I,t)===0&&(d|=1),y||k===2?c=I:c=e.children}else c=e.children;p&&p.length&&(u=Ww(p)),e.codegenNode=Wl(t,l,r,c,d===0?void 0:d,u,m,!!h,!1,i,e.loc)};function Vw(e,t,s=!1){let{tag:a}=e;const n=hd(a),i=Wr(e,"is",!1,!0);if(i)if(n||Jn("COMPILER_IS_ON_ELEMENT",t)){let o;if(i.type===6?o=i.value&&et(i.value.content,!0):(o=i.exp,o||(o=et("is",!1,i.arg.loc))),o)return ss(t.helper(uu),[o])}else i.type===6&&i.value.content.startsWith("vue:")&&(a=i.value.content.slice(4));const l=_v(a)||t.isBuiltInComponent(a);return l?(s||t.helper(l),l):(t.helper(du),t.components.add(a),Jl(a,"component"))}function Hv(e,t,s=e.props,a,n,i=!1){const{tag:l,loc:o,children:r}=e;let c=[];const d=[],u=[],p=r.length>0;let m=!1,h=0,b=!1,I=!1,k=!1,y=!1,g=!1,x=!1;const S=[],_=O=>{c.length&&(d.push(aa(ef(c),o)),c=[]),O&&d.push(O)},E=()=>{t.scopes.vFor>0&&c.push(qt(et("ref_for",!0),et("true")))},R=({key:O,value:U})=>{if(zs(O)){const T=O.content,$=ei(T);if($&&(!a||n)&&T.toLowerCase()!=="onclick"&&T!=="onUpdate:modelValue"&&!Za(T)&&(y=!0),$&&Za(T)&&(x=!0),$&&U.type===14&&(U=U.arguments[0]),U.type===20||(U.type===4||U.type===8)&&Js(U,t)>0)return;T==="ref"?b=!0:T==="class"?I=!0:T==="style"?k=!0:T!=="key"&&!S.includes(T)&&S.push(T),a&&(T==="class"||T==="style")&&!S.includes(T)&&S.push(T)}else g=!0};for(let O=0;O<s.length;O++){const U=s[O];if(U.type===6){const{loc:T,name:$,nameLoc:te,value:W}=U;let M=!0;if($==="ref"&&(b=!0,E()),$==="is"&&(hd(l)||W&&W.content.startsWith("vue:")||Jn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(qt(et($,!0,te),et(W?W.content:"",M,W?W.loc:T)))}else{const{name:T,arg:$,exp:te,loc:W,modifiers:M}=U,L=T==="bind",P=T==="on";if(T==="slot"){a||t.onError(Ot(40,W));continue}if(T==="once"||T==="memo"||T==="is"||L&&Hn($,"is")&&(hd(l)||Jn("COMPILER_IS_ON_ELEMENT",t))||P&&i)continue;if((L&&Hn($,"key")||P&&p&&Hn($,"vue:before-update"))&&(m=!0),L&&Hn($,"ref")&&E(),!$&&(L||P)){if(g=!0,te)if(L){if(_(),Jn("COMPILER_V_BIND_OBJECT_ORDER",t)){d.unshift(te);continue}E(),_(),d.push(te)}else _({type:14,loc:W,callee:t.helper(bu),arguments:a?[te]:[te,"true"]});else t.onError(Ot(L?34:35,W));continue}L&&M.some(ce=>ce.content==="prop")&&(h|=32);const re=t.directiveTransforms[T];if(re){const{props:ce,needRuntime:J}=re(U,e,t);!i&&ce.forEach(R),P&&$&&!zs($)?_(aa(ce,o)):c.push(...ce),J&&(u.push(U),Cs(J)&&zv.set(U,J))}else $b(T)||(u.push(U),p&&(m=!0))}}let w;if(d.length?(_(),d.length>1?w=ss(t.helper(hr),d,o):w=d[0]):c.length&&(w=aa(ef(c),o)),g?h|=16:(I&&!a&&(h|=2),k&&!a&&(h|=4),S.length&&(h|=8),y&&(h|=32)),!m&&(h===0||h===32)&&(b||x||u.length>0)&&(h|=512),!t.inSSR&&w)switch(w.type){case 15:let O=-1,U=-1,T=!1;for(let W=0;W<w.properties.length;W++){const M=w.properties[W].key;zs(M)?M.content==="class"?O=W:M.content==="style"&&(U=W):M.isHandlerKey||(T=!0)}const $=w.properties[O],te=w.properties[U];T?w=ss(t.helper(Gl),[w]):($&&!zs($.value)&&($.value=ss(t.helper(vu),[$.value])),te&&(k||te.value.type===4&&te.value.content.trim()[0]==="["||te.value.type===17)&&(te.value=ss(t.helper(gu),[te.value])));break;case 14:break;default:w=ss(t.helper(Gl),[ss(t.helper(co),[w])]);break}return{props:w,directives:u,patchFlag:h,dynamicPropNames:S,shouldUseBlock:m}}function ef(e){const t=new Map,s=[];for(let a=0;a<e.length;a++){const n=e[a];if(n.key.type===8||!n.key.isStatic){s.push(n);continue}const i=n.key.content,l=t.get(i);l?(i==="style"||i==="class"||ei(i))&&qw(l,n):(t.set(i,n),s.push(n))}return s}function qw(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Kn([e.value,t.value],e.loc)}function Gw(e,t){const s=[],a=zv.get(e);a?s.push(t.helperString(a)):(t.helper(pu),t.directives.add(e.name),s.push(Jl(e.name,"directive")));const{loc:n}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=et("true",!1,n);s.push(aa(e.modifiers.map(l=>qt(l,i)),n))}return Kn(s,e.loc)}function Ww(e){let t="[";for(let s=0,a=e.length;s<a;s++)t+=JSON.stringify(e[s]),s<a-1&&(t+=", ");return t+"]"}function hd(e){return e==="component"||e==="Component"}const Kw=(e,t)=>{if(yr(e)){const{children:s,loc:a}=e,{slotName:n,slotProps:i}=Jw(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",n,"{}","undefined","true"];let o=2;i&&(l[2]=i,o=3),s.length&&(l[3]=Vi([],s,!1,!1,a),o=4),t.scopeId&&!t.slotted&&(o=5),l.splice(o),e.codegenNode=ss(t.helper(gv),l,a)}};function Jw(e,t){let s='"default"',a;const n=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=wt(l.name),n.push(l)));else if(l.name==="bind"&&Hn(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const o=wt(l.arg.content);s=l.exp=et(o,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&zs(l.arg)&&(l.arg.content=wt(l.arg.content)),n.push(l)}if(n.length>0){const{props:i,directives:l}=Hv(e,t,n,!1,!1);a=i,l.length&&t.onError(Ot(36,l[0].loc))}return{slotName:s,slotProps:a}}const jv=(e,t,s,a)=>{const{loc:n,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(Ot(35,n));let o;if(l.type===4)if(l.isStatic){let u=l.content;u.startsWith("vue:")&&(u=`vnode-${u.slice(4)}`);const p=t.tagType!==0||u.startsWith("vnode")||!/[A-Z]/.test(u)?Ii(wt(u)):`on:${u}`;o=et(p,!0,l.loc)}else o=ha([`${s.helperString(dd)}(`,l,")"]);else o=l,o.children.unshift(`${s.helperString(dd)}(`),o.children.push(")");let r=e.exp;r&&!r.content.trim()&&(r=void 0);let c=s.cacheHandlers&&!r&&!s.inVOnce;if(r){const u=Sv(r),p=!(u||K_(r)),m=r.content.includes(";");(p||c&&u)&&(r=ha([`${p?"$event":"(...args)"} => ${m?"{":"("}`,r,m?"}":")"]))}let d={props:[qt(o,r||et("() => {}",!1,n))]};return a&&(d=a(d)),c&&(d.props[0].value=s.cache(d.props[0].value)),d.props.forEach(u=>u.key.isHandlerKey=!0),d},Zw=(e,t,s)=>{const{modifiers:a,loc:n}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),a.some(o=>o.content==="camel")&&(i.type===4?i.isStatic?i.content=wt(i.content):i.content=`${s.helperString(cd)}(${i.content})`:(i.children.unshift(`${s.helperString(cd)}(`),i.children.push(")"))),s.inSSR||(a.some(o=>o.content==="prop")&&tf(i,"."),a.some(o=>o.content==="attr")&&tf(i,"^")),{props:[qt(i,l)]}},tf=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},Yw=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let a,n=!1;for(let i=0;i<s.length;i++){const l=s[i];if(Tc(l)){n=!0;for(let o=i+1;o<s.length;o++){const r=s[o];if(Tc(r))a||(a=s[i]=ha([l],l.loc)),a.children.push(" + ",r),s.splice(o,1),o--;else{a=void 0;break}}}}if(!(!n||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(Tc(l)||l.type===8){const o=[];(l.type!==2||l.content!==" ")&&o.push(l),!t.ssr&&Js(l,t)===0&&o.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:ss(t.helper(cu),o)}}}}},sf=new WeakSet,Qw=(e,t)=>{if(e.type===1&&sa(e,"once",!0))return sf.has(e)||t.inVOnce||t.inSSR?void 0:(sf.add(e),t.inVOnce=!0,t.helper(vr),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Vv=(e,t,s)=>{const{exp:a,arg:n}=e;if(!a)return s.onError(Ot(41,e.loc)),pl();const i=a.loc.source.trim(),l=a.type===4?a.content:i,o=s.bindingMetadata[i];if(o==="props"||o==="props-aliased")return s.onError(Ot(44,a.loc)),pl();if(o==="literal-const"||o==="setup-const")return s.onError(Ot(45,a.loc)),pl();if(!l.trim()||!Sv(a))return s.onError(Ot(42,a.loc)),pl();const r=n||et("modelValue",!0),c=n?zs(n)?`onUpdate:${wt(n.content)}`:ha(['"onUpdate:" + ',n]):"onUpdate:modelValue";let d;const u=s.isTS?"($event: any)":"$event";d=ha([`${u} => ((`,a,") = $event)"]);const p=[qt(r,e.exp),qt(c,d)];if(e.modifiers.length&&t.tagType===1){const m=e.modifiers.map(b=>b.content).map(b=>(ku(b)?b:JSON.stringify(b))+": true").join(", "),h=n?zs(n)?`${n.content}Modifiers`:ha([n,' + "Modifiers"']):"modelModifiers";p.push(qt(h,et(`{ ${m} }`,!1,e.loc,2)))}return pl(p)};function pl(e=[]){return{props:e}}const Xw=/[\w).+\-_$\]]/,ek=(e,t)=>{Jn("COMPILER_FILTERS",t)&&(e.type===5?_r(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&_r(s.exp,t)}))};function _r(e,t){if(e.type===4)af(e,t);else for(let s=0;s<e.children.length;s++){const a=e.children[s];typeof a=="object"&&(a.type===4?af(a,t):a.type===8?_r(e,t):a.type===5&&_r(a.content,t))}}function af(e,t){const s=e.content;let a=!1,n=!1,i=!1,l=!1,o=0,r=0,c=0,d=0,u,p,m,h,b=[];for(m=0;m<s.length;m++)if(p=u,u=s.charCodeAt(m),a)u===39&&p!==92&&(a=!1);else if(n)u===34&&p!==92&&(n=!1);else if(i)u===96&&p!==92&&(i=!1);else if(l)u===47&&p!==92&&(l=!1);else if(u===124&&s.charCodeAt(m+1)!==124&&s.charCodeAt(m-1)!==124&&!o&&!r&&!c)h===void 0?(d=m+1,h=s.slice(0,m).trim()):I();else{switch(u){case 34:n=!0;break;case 39:a=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:r++;break;case 93:r--;break;case 123:o++;break;case 125:o--;break}if(u===47){let k=m-1,y;for(;k>=0&&(y=s.charAt(k),y===" ");k--);(!y||!Xw.test(y))&&(l=!0)}}h===void 0?h=s.slice(0,m).trim():d!==0&&I();function I(){b.push(s.slice(d,m).trim()),d=m+1}if(b.length){for(m=0;m<b.length;m++)h=tk(h,b[m],t);e.content=h,e.ast=void 0}}function tk(e,t,s){s.helper(fu);const a=t.indexOf("(");if(a<0)return s.filters.add(t),`${Jl(t,"filter")}(${e})`;{const n=t.slice(0,a),i=t.slice(a+1);return s.filters.add(n),`${Jl(n,"filter")}(${e}${i!==")"?","+i:i}`}}const nf=new WeakSet,sk=(e,t)=>{if(e.type===1){const s=sa(e,"memo");return!s||nf.has(e)||t.inSSR?void 0:(nf.add(e),()=>{const a=e.codegenNode||t.currentNode.codegenNode;a&&a.type===13&&(e.tagType!==1&&_u(a,t),e.codegenNode=ss(t.helper(xu),[s.exp,Vi(void 0,a),"_cache",String(t.cached.length)]),t.cached.push(null))})}},ak=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const a=s.arg;if(a.type!==4||!a.isStatic)t.onError(Ot(53,a.loc)),s.exp=et("",!0,a.loc);else{const n=wt(a.content);(wv.test(n[0])||n[0]==="-")&&(s.exp=et(n,!1,a.loc))}}}};function nk(e){return[[ak,Qw,Mw,sk,$w,ek,Kw,jw,Uw,Yw],{on:jv,bind:Zw,model:Vv}]}function ik(e,t={}){const s=t.onError||wu,a=t.mode==="module";t.prefixIdentifiers===!0?s(Ot(48)):a&&s(Ot(49));const n=!1;t.cacheHandlers&&s(Ot(50)),t.scopeId&&!a&&s(Ot(51));const i=nt({},t,{prefixIdentifiers:n}),l=Ye(e)?uw(e,i):e,[o,r]=nk();return hw(l,nt({},i,{nodeTransforms:[...o,...t.nodeTransforms||[]],directiveTransforms:nt({},r,t.directiveTransforms||{})})),yw(l,i)}const lk=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const qv=Symbol(""),Gv=Symbol(""),Wv=Symbol(""),Kv=Symbol(""),vd=Symbol(""),Jv=Symbol(""),Zv=Symbol(""),Yv=Symbol(""),Qv=Symbol(""),Xv=Symbol("");$_({[qv]:"vModelRadio",[Gv]:"vModelCheckbox",[Wv]:"vModelText",[Kv]:"vModelSelect",[vd]:"vModelDynamic",[Jv]:"withModifiers",[Zv]:"withKeys",[Yv]:"vShow",[Qv]:"Transition",[Xv]:"TransitionGroup"});let gi;function ok(e,t=!1){return gi||(gi=document.createElement("div")),t?(gi.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,gi.children[0].getAttribute("foo")):(gi.innerHTML=e,gi.textContent)}const rk={parseMode:"html",isVoidTag:ey,isNativeTag:e=>Yb(e)||Qb(e)||Xb(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:ok,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return Qv;if(e==="TransitionGroup"||e==="transition-group")return Xv},getNamespace(e,t,s){let a=t?t.ns:s;if(t&&a===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(n=>n.type===6&&n.name==="encoding"&&n.value!=null&&(n.value.content==="text/html"||n.value.content==="application/xhtml+xml"))&&(a=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(a=0);else t&&a===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(a=0);if(a===0){if(e==="svg")return 1;if(e==="math")return 2}return a}},ck=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:et("style",!0,t.loc),exp:dk(t.value.content,t.loc),modifiers:[],loc:t.loc})})},dk=(e,t)=>{const s=pm(e);return et(JSON.stringify(s),!1,t,3)};function Sn(e,t){return Ot(e,t)}const uk=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(Sn(54,n)),t.children.length&&(s.onError(Sn(55,n)),t.children.length=0),{props:[qt(et("innerHTML",!0,n),a||et("",!0))]}},pk=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(Sn(56,n)),t.children.length&&(s.onError(Sn(57,n)),t.children.length=0),{props:[qt(et("textContent",!0),a?Js(a,s)>0?a:ss(s.helperString(Gr),[a],n):et("",!0))]}},fk=(e,t,s)=>{const a=Vv(e,t,s);if(!a.props.length||t.tagType===1)return a;e.arg&&s.onError(Sn(59,e.arg.loc));const{tag:n}=t,i=s.isCustomElement(n);if(n==="input"||n==="textarea"||n==="select"||i){let l=Wv,o=!1;if(n==="input"||i){const r=Wr(t,"type");if(r){if(r.type===7)l=vd;else if(r.value)switch(r.value.content){case"radio":l=qv;break;case"checkbox":l=Gv;break;case"file":o=!0,s.onError(Sn(60,e.loc));break}}else J_(t)&&(l=vd)}else n==="select"&&(l=Kv);o||(a.needRuntime=s.helper(l))}else s.onError(Sn(58,e.loc));return a.props=a.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),a},mk=Ys("passive,once,capture"),hk=Ys("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),vk=Ys("left,right"),eg=Ys("onkeyup,onkeydown,onkeypress"),gk=(e,t,s,a)=>{const n=[],i=[],l=[];for(let o=0;o<t.length;o++){const r=t[o].content;r==="native"&&Kl("COMPILER_V_ON_NATIVE",s)||mk(r)?l.push(r):vk(r)?zs(e)?eg(e.content.toLowerCase())?n.push(r):i.push(r):(n.push(r),i.push(r)):hk(r)?i.push(r):n.push(r)}return{keyModifiers:n,nonKeyModifiers:i,eventOptionModifiers:l}},lf=(e,t)=>zs(e)&&e.content.toLowerCase()==="onclick"?et(t,!0):e.type!==4?ha(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,bk=(e,t,s)=>jv(e,t,s,a=>{const{modifiers:n}=e;if(!n.length)return a;let{key:i,value:l}=a.props[0];const{keyModifiers:o,nonKeyModifiers:r,eventOptionModifiers:c}=gk(i,n,s,e.loc);if(r.includes("right")&&(i=lf(i,"onContextmenu")),r.includes("middle")&&(i=lf(i,"onMouseup")),r.length&&(l=ss(s.helper(Jv),[l,JSON.stringify(r)])),o.length&&(!zs(i)||eg(i.content.toLowerCase()))&&(l=ss(s.helper(Zv),[l,JSON.stringify(o)])),c.length){const d=c.map(si).join("");i=zs(i)?et(`${i.content}${d}`,!0):ha(["(",i,`) + "${d}"`])}return{props:[qt(i,l)]}}),yk=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(Sn(62,n)),{props:[],needRuntime:s.helper(Yv)}},xk=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},_k=[ck],wk={cloak:lk,html:uk,text:pk,model:fk,on:bk,show:yk};function kk(e,t={}){return ik(e,nt({},rk,t,{nodeTransforms:[xk,..._k,...t.nodeTransforms||[]],directiveTransforms:nt({},wk,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const of=Object.create(null);function Sk(e,t){if(!Ye(e))if(e.nodeType)e=e.innerHTML;else return hs;const s=Ub(e,t),a=of[s];if(a)return a;if(e[0]==="#"){const o=document.querySelector(e);e=o?o.innerHTML:""}const n=nt({hoistStatic:!0,onError:void 0,onWarn:hs},t);!n.isCustomElement&&typeof customElements<"u"&&(n.isCustomElement=o=>!!customElements.get(o));const{code:i}=kk(e,n),l=new Function("Vue",i)(O_);return l._rc=!0,of[s]=l}$h(Sk);const wr=Tn({items:[]});let Ck=1;function Zr(e,t="info",s=3e3){const a=Ck++;return wr.items.push({id:a,message:String(e),type:t}),s>0&&setTimeout(()=>Eu(a),s),a}function Eu(e){const t=wr.items.findIndex(s=>s.id===e);t>=0&&wr.items.splice(t,1)}function Te(e,t="info",s=3e3){return Zr(e,t,s)}Te.success=(e,t=3e3)=>Zr(e,"success",t);Te.error=(e,t=5e3)=>Zr(e,"error",t);Te.info=(e,t=3e3)=>Zr(e,"info",t);Te.dismiss=Eu;const Tk={setup(){return{state:wr,dismiss:Eu}},template:`
 ...
 * @license MIT
 */const ki=typeof document<"u";function tg(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function Ak(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&tg(e.default)}const bt=Object.assign;function Ac(e,t){const s={};for(const a in t){const n=t[a];s[a]=ga(n)?n.map(e):e(n)}return s}const Ol=()=>{},ga=Array.isArray;function cf(e,t){const s={};for(const a in e)s[a]=a in t?t[a]:e[a];return s}const sg=/#/g,Rk=/&/g,Ik=/\//g,Ok=/=/g,Lk=/\?/g,ag=/\+/g,Nk=/%5B/g,Mk=/%5D/g,ng=/%5E/g,Dk=/%60/g,ig=/%7B/g,Pk=/%7C/g,lg=/%7D/g,$k=/%20/g;function Au(e){return e==null?"":encodeURI(""+e).replace(Pk,"|").replace(Nk,"[").replace(Mk,"]")}function Fk(e){return Au(e).replace(ig,"{").replace(lg,"}").replace(ng,"^")}function gd(e){return Au(e).replace(ag,"%2B").replace($k,"+").replace(sg,"%23").replace(Rk,"%26").replace(Dk,"`").replace(ig,"{").replace(lg,"}").replace(ng,"^")}function Bk(e){return gd(e).replace(Ok,"%3D")}function Uk(e){return Au(e).replace(sg,"%23").replace(Lk,"%3F")}function zk(e){return Uk(e).replace(Ik,"%2F")}function Yl(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const Hk=/\/$/,jk=e=>e.replace(Hk,"");function Rc(e,t,s="/"){let a,n={},i="",l="";const o=t.indexOf("#");let r=t.indexOf("?");return r=o>=0&&r>o?-1:r,r>=0&&(a=t.slice(0,r),i=t.slice(r,o>0?o:t.length),n=e(i.slice(1))),o>=0&&(a=a||t.slice(0,o),l=t.slice(o,t.length)),a=Wk(a??t,s),{fullPath:a+i+l,path:a,query:n,hash:Yl(l)}}function Vk(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function df(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function qk(e,t,s){const a=t.matched.length-1,n=s.matched.length-1;return a>-1&&a===n&&Wi(t.matched[a],s.matched[n])&&og(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function Wi(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function og(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!Gk(e[s],t[s]))return!1;return!0}function Gk(e,t){return ga(e)?uf(e,t):ga(t)?uf(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function uf(e,t){return ga(t)?e.length===t.length&&e.every((s,a)=>s===t[a]):e.length===1&&e[0]===t}function Wk(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),a=e.split("/"),n=a[a.length-1];(n===".."||n===".")&&a.push("");let i=s.length-1,l,o;for(l=0;l<a.length;l++)if(o=a[l],o!==".")if(o==="..")i>1&&i--;else break;return s.slice(0,i).join("/")+"/"+a.slice(l).join("/")}const hn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let bd=(function(e){return e.pop="pop",e.push="push",e})({}),Ic=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Kk(e){if(!e)if(ki){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),jk(e)}const Jk=/^[^#]+#/;function Zk(e,t){return e.replace(Jk,"#")+t}function Yk(e,t){const s=document.documentElement.getBoundingClientRect(),a=e.getBoundingClientRect();return{behavior:t.behavior,left:a.left-s.left-(t.left||0),top:a.top-s.top-(t.top||0)}}const Yr=()=>({left:window.scrollX,top:window.scrollY});function Qk(e){let t;if("el"in e){const s=e.el,a=typeof s=="string"&&s.startsWith("#"),n=typeof s=="string"?a?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!n)return;t=Yk(n,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function pf(e,t){return(history.state?history.state.position-t:-1)+e}const yd=new Map;function Xk(e,t){yd.set(e,t)}function eS(e){const t=yd.get(e);return yd.delete(e),t}function tS(e){return typeof e=="string"||e&&typeof e=="object"}function rg(e){return typeof e=="string"||typeof e=="symbol"}let Pt=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const cg=Symbol("");Pt.MATCHER_NOT_FOUND+"",Pt.NAVIGATION_GUARD_REDIRECT+"",Pt.NAVIGATION_ABORTED+"",Pt.NAVIGATION_CANCELLED+"",Pt.NAVIGATION_DUPLICATED+"";function Ki(e,t){return bt(new Error,{type:e,[cg]:!0},t)}function Ba(e,t){return e instanceof Error&&cg in e&&(t==null||!!(e.type&t))}const sS=["params","query","hash"];function aS(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of sS)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}function nS(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let a=0;a<s.length;++a){const n=s[a].replace(ag," "),i=n.indexOf("="),l=Yl(i<0?n:n.slice(0,i)),o=i<0?null:Yl(n.slice(i+1));if(l in t){let r=t[l];ga(r)||(r=t[l]=[r]),r.push(o)}else t[l]=o}return t}function ff(e){let t="";for(let s in e){const a=e[s];if(s=Bk(s),a==null){a!==void 0&&(t+=(t.length?"&":"")+s);continue}(ga(a)?a.map(n=>n&&gd(n)):[a&&gd(a)]).forEach(n=>{n!==void 0&&(t+=(t.length?"&":"")+s,n!=null&&(t+="="+n))})}return t}function iS(e){const t={};for(const s in e){const a=e[s];a!==void 0&&(t[s]=ga(a)?a.map(n=>n==null?null:""+n):a==null?a:""+a)}return t}const lS=Symbol(""),mf=Symbol(""),Qr=Symbol(""),Ru=Symbol(""),xd=Symbol("");function fl(){let e=[];function t(a){return e.push(a),()=>{const n=e.indexOf(a);n>-1&&e.splice(n,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function _n(e,t,s,a,n,i=l=>l()){const l=a&&(a.enterCallbacks[n]=a.enterCallbacks[n]||[]);return()=>new Promise((o,r)=>{const c=p=>{p===!1?r(Ki(Pt.NAVIGATION_ABORTED,{from:s,to:t})):p instanceof Error?r(p):tS(p)?r(Ki(Pt.NAVIGATION_GUARD_REDIRECT,{from:t,to:p})):(l&&a.enterCallbacks[n]===l&&typeof p=="function"&&l.push(p),o())},d=i(()=>e.call(a&&a.instances[n],t,s,c));let u=Promise.resolve(d);e.length<3&&(u=u.then(c)),u.catch(p=>r(p))})}function Oc(e,t,s,a,n=i=>i()){const i=[];for(const l of e)for(const o in l.components){let r=l.components[o];if(!(t!=="beforeRouteEnter"&&!l.instances[o]))if(tg(r)){const c=(r.__vccOpts||r)[t];c&&i.push(_n(c,s,a,l,o,n))}else{let c=r();i.push(()=>c.then(d=>{if(!d)throw new Error(`Couldn't resolve component "${o}" at "${l.path}"`);const u=Ak(d)?d.default:d;l.mods[o]=d,l.components[o]=u;const p=(u.__vccOpts||u)[t];return p&&_n(p,s,a,l,o,n)()}))}}return i}function oS(e,t){const s=[],a=[],n=[],i=Math.max(t.matched.length,e.matched.length);for(let l=0;l<i;l++){const o=t.matched[l];o&&(e.matched.find(c=>Wi(c,o))?a.push(o):s.push(o));const r=e.matched[l];r&&(t.matched.find(c=>Wi(c,r))||n.push(r))}return[s,a,n]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let rS=()=>location.protocol+"//"+location.host;function dg(e,t){const{pathname:s,search:a,hash:n}=t,i=e.indexOf("#");if(i>-1){let l=n.includes(e.slice(i))?e.slice(i).length:1,o=n.slice(l);return o[0]!=="/"&&(o="/"+o),df(o,"")}return df(s,e)+a+n}function cS(e,t,s,a){let n=[],i=[],l=null;const o=({state:p})=>{const m=dg(e,location),h=s.value,b=t.value;let I=0;if(p){if(s.value=m,t.value=p,l&&l===h){l=null;return}I=b?p.position-b.position:0}else a(m);n.forEach(k=>{k(s.value,h,{delta:I,type:bd.pop,direction:I?I>0?Ic.forward:Ic.back:Ic.unknown})})};function r(){l=s.value}function c(p){n.push(p);const m=()=>{const h=n.indexOf(p);h>-1&&n.splice(h,1)};return i.push(m),m}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(bt({},p.state,{scroll:Yr()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",o),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",o),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:r,listen:c,destroy:u}}function hf(e,t,s,a=!1,n=!1){return{back:e,current:t,forward:s,replaced:a,position:window.history.length,scroll:n?Yr():null}}function dS(e){const{history:t,location:s}=window,a={value:dg(e,s)},n={value:t.state};n.value||i(a.value,{back:null,current:a.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(r,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+r:rS()+e+r;try{t[d?"replaceState":"pushState"](c,"",p),n.value=c}catch(m){console.error(m),s[d?"replace":"assign"](p)}}function l(r,c){i(r,bt({},t.state,hf(n.value.back,r,n.value.forward,!0),c,{position:n.value.position}),!0),a.value=r}function o(r,c){const d=bt({},n.value,t.state,{forward:r,scroll:Yr()});i(d.current,d,!0),i(r,bt({},hf(a.value,r,null),{position:d.position+1},c),!1),a.value=r}return{location:a,state:n,push:o,replace:l}}function uS(e){e=Kk(e);const t=dS(e),s=cS(e,t.state,t.location,t.replace);function a(i,l=!0){l||s.pauseListeners(),history.go(i)}const n=bt({location:"",base:e,go:a,createHref:Zk.bind(null,e)},t,s);return Object.defineProperty(n,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(n,"state",{enumerable:!0,get:()=>t.state.value}),n}function pS(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),uS(e)}let Vn=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var es=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(es||{});const fS={type:Vn.Static,value:""},mS=/[a-zA-Z0-9_]/;function hS(e){if(!e)return[[]];if(e==="/")return[[fS]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(m){throw new Error(`ERR (${s})/"${c}": ${m}`)}let s=es.Static,a=s;const n=[];let i;function l(){i&&n.push(i),i=[]}let o=0,r,c="",d="";function u(){c&&(s===es.Static?i.push({type:Vn.Static,value:c}):s===es.Param||s===es.ParamRegExp||s===es.ParamRegExpEnd?(i.length>1&&(r==="*"||r==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Vn.Param,value:c,regexp:d,repeatable:r==="*"||r==="+",optional:r==="*"||r==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=r}for(;o<e.length;){if(r=e[o++],r==="\\"&&s!==es.ParamRegExp){a=s,s=es.EscapeNext;continue}switch(s){case es.Static:r==="/"?(c&&u(),l()):r===":"?(u(),s=es.Param):p();break;case es.EscapeNext:p(),s=a;break;case es.Param:r==="("?s=es.ParamRegExp:mS.test(r)?p():(u(),s=es.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--);break;case es.ParamRegExp:r===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+r:s=es.ParamRegExpEnd:d+=r;break;case es.ParamRegExpEnd:u(),s=es.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--,d="";break;default:t("Unknown state");break}}return s===es.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),n}const vf="[^/]+?",vS={sensitive:!1,strict:!1,start:!0,end:!0};var Rs=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Rs||{});const gS=/[.+*?^${}()[\]/\\]/g;function bS(e,t){const s=bt({},vS,t),a=[];let n=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[Rs.Root];s.strict&&!c.length&&(n+="/");for(let u=0;u<c.length;u++){const p=c[u];let m=Rs.Segment+(s.sensitive?Rs.BonusCaseSensitive:0);if(p.type===Vn.Static)u||(n+="/"),n+=p.value.replace(gS,"\\$&"),m+=Rs.Static;else if(p.type===Vn.Param){const{value:h,repeatable:b,optional:I,regexp:k}=p;i.push({name:h,repeatable:b,optional:I});const y=k||vf;if(y!==vf){m+=Rs.BonusCustomRegExp;try{`${y}`}catch(x){throw new Error(`Invalid custom RegExp for param "${h}" (${y}): `+x.message)}}let g=b?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(g=I&&c.length<2?`(?:/${g})`:"/"+g),I&&(g+="?"),n+=g,m+=Rs.Dynamic,I&&(m+=Rs.BonusOptional),b&&(m+=Rs.BonusRepeatable),y===".*"&&(m+=Rs.BonusWildcard)}d.push(m)}a.push(d)}if(s.strict&&s.end){const c=a.length-1;a[c][a[c].length-1]+=Rs.BonusStrict}s.strict||(n+="/?"),s.end?n+="$":s.strict&&!n.endsWith("/")&&(n+="(?:/|$)");const l=new RegExp(n,s.sensitive?"":"i");function o(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const m=d[p]||"",h=i[p-1];u[h.name]=m&&h.repeatable?m.split("/"):m}return u}function r(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const m of p)if(m.type===Vn.Static)d+=m.value;else if(m.type===Vn.Param){const{value:h,repeatable:b,optional:I}=m,k=h in c?c[h]:"";if(ga(k)&&!b)throw new Error(`Provided param "${h}" is an array but it is not repeatable (* or + modifiers)`);const y=ga(k)?k.join("/"):k;if(!y)if(I)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${h}"`);d+=y}}return d||"/"}return{re:l,score:a,keys:i,parse:o,stringify:r}}function yS(e,t){let s=0;for(;s<e.length&&s<t.length;){const a=t[s]-e[s];if(a)return a;s++}return e.length<t.length?e.length===1&&e[0]===Rs.Static+Rs.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Rs.Static+Rs.Segment?1:-1:0}function ug(e,t){let s=0;const a=e.score,n=t.score;for(;s<a.length&&s<n.length;){const i=yS(a[s],n[s]);if(i)return i;s++}if(Math.abs(n.length-a.length)===1){if(gf(a))return 1;if(gf(n))return-1}return n.length-a.length}function gf(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const xS={strict:!1,end:!0,sensitive:!1};function _S(e,t,s){const a=bS(hS(e.path),s),n=bt(a,{record:e,parent:t,children:[],alias:[]});return t&&!n.record.aliasOf==!t.record.aliasOf&&t.children.push(n),n}function wS(e,t){const s=[],a=new Map;t=cf(xS,t);function n(u){return a.get(u)}function i(u,p,m){const h=!m,b=yf(u);b.aliasOf=m&&m.record;const I=cf(t,u),k=[b];if("alias"in u){const x=typeof u.alias=="string"?[u.alias]:u.alias;for(const S of x)k.push(yf(bt({},b,{components:m?m.record.components:b.components,path:S,aliasOf:m?m.record:b})))}let y,g;for(const x of k){const{path:S}=x;if(p&&S[0]!=="/"){const _=p.record.path,E=_[_.length-1]==="/"?"":"/";x.path=p.record.path+(S&&E+S)}if(y=_S(x,p,I),m?m.alias.push(y):(g=g||y,g!==y&&g.alias.push(y),h&&u.name&&!xf(y)&&l(u.name)),pg(y)&&r(y),b.children){const _=b.children;for(let E=0;E<_.length;E++)i(_[E],y,m&&m.children[E])}m=m||y}return g?()=>{l(g)}:Ol}function l(u){if(rg(u)){const p=a.get(u);p&&(a.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&a.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function o(){return s}function r(u){const p=CS(u,s);s.splice(p,0,u),u.record.name&&!xf(u)&&a.set(u.record.name,u)}function c(u,p){let m,h={},b,I;if("name"in u&&u.name){if(m=a.get(u.name),!m)throw Ki(Pt.MATCHER_NOT_FOUND,{location:u});I=m.record.name,h=bt(bf(p.params,m.keys.filter(g=>!g.optional).concat(m.parent?m.parent.keys.filter(g=>g.optional):[]).map(g=>g.name)),u.params&&bf(u.params,m.keys.map(g=>g.name))),b=m.stringify(h)}else if(u.path!=null)b=u.path,m=s.find(g=>g.re.test(b)),m&&(h=m.parse(b),I=m.record.name);else{if(m=p.name?a.get(p.name):s.find(g=>g.re.test(p.path)),!m)throw Ki(Pt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});I=m.record.name,h=bt({},p.params,u.params),b=m.stringify(h)}const k=[];let y=m;for(;y;)k.unshift(y.record),y=y.parent;return{name:I,path:b,params:h,matched:k,meta:SS(k)}}e.forEach(u=>i(u));function d(){s.length=0,a.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:o,getRecordMatcher:n}}function bf(e,t){const s={};for(const a of t)a in e&&(s[a]=e[a]);return s}function yf(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:kS(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function kS(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const a in e.components)t[a]=typeof s=="object"?s[a]:s;return t}function xf(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function SS(e){return e.reduce((t,s)=>bt(t,s.meta),{})}function CS(e,t){let s=0,a=t.length;for(;s!==a;){const i=s+a>>1;ug(e,t[i])<0?a=i:s=i+1}const n=TS(e);return n&&(a=t.lastIndexOf(n,a-1)),a}function TS(e){let t=e;for(;t=t.parent;)if(pg(t)&&ug(e,t)===0)return t}function pg({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function _f(e){const t=na(Qr),s=na(Ru),a=z(()=>{const r=Ra(e.to);return t.resolve(r)}),n=z(()=>{const{matched:r}=a.value,{length:c}=r,d=r[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(Wi.bind(null,d));if(p>-1)return p;const m=wf(r[c-2]);return c>1&&wf(d)===m&&u[u.length-1].path!==m?u.findIndex(Wi.bind(null,r[c-2])):p}),i=z(()=>n.value>-1&&OS(s.params,a.value.params)),l=z(()=>n.value>-1&&n.value===s.matched.length-1&&og(s.params,a.value.params));function o(r={}){if(IS(r)){const c=t[Ra(e.replace)?"replace":"push"](Ra(e.to)).catch(Ol);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:a,href:z(()=>a.value.href),isActive:i,isExactActive:l,navigate:o}}function ES(e){return e.length===1?e[0]:e}const AS=io({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:_f,setup(e,{slots:t}){const s=Tn(_f(e)),{options:a}=na(Qr),n=z(()=>({[kf(e.activeClass,a.linkActiveClass,"router-link-active")]:s.isActive,[kf(e.exactActiveClass,a.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&ES(t.default(s));return e.custom?i:Ui("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:n.value},i)}}}),RS=AS;function IS(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function OS(e,t){for(const s in t){const a=t[s],n=e[s];if(typeof a=="string"){if(a!==n)return!1}else if(!ga(n)||n.length!==a.length||a.some((i,l)=>i.valueOf()!==n[l].valueOf()))return!1}return!0}function wf(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const kf=(e,t,s)=>e??t??s,LS=io({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const a=na(xd),n=z(()=>e.route||a.value),i=na(mf,0),l=z(()=>{let c=Ra(i);const{matched:d}=n.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),o=z(()=>n.value.matched[l.value]);Tl(mf,z(()=>l.value+1)),Tl(lS,o),Tl(xd,n);const r=f();return Wt(()=>[r.value,o.value,e.name],([c,d,u],[p,m,h])=>{d&&(d.instances[u]=c,m&&m!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=m.leaveGuards),d.updateGuards.size||(d.updateGuards=m.updateGuards))),c&&d&&(!m||!Wi(d,m)||!p)&&(d.enterCallbacks[u]||[]).forEach(b=>b(c))},{flush:"post"}),()=>{const c=n.value,d=e.name,u=o.value,p=u&&u.components[d];if(!p)return Sf(s.default,{Component:p,route:c});const m=u.props[d],h=m?m===!0?c.params:typeof m=="function"?m(c):m:null,I=Ui(p,bt({},h,t,{onVnodeUnmounted:k=>{k.component.isUnmounted&&(u.instances[d]=null)},ref:r}));return Sf(s.default,{Component:I,route:c})||I}}});function Sf(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const NS=LS;function MS(e){const t=wS(e.routes,e),s=e.parseQuery||nS,a=e.stringifyQuery||ff,n=e.history,i=fl(),l=fl(),o=fl(),r=Bd(hn);let c=hn;ki&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Ac.bind(null,ie=>""+ie),u=Ac.bind(null,zk),p=Ac.bind(null,Yl);function m(ie,le){let fe,me;return rg(ie)?(fe=t.getRecordMatcher(ie),me=le):me=ie,t.addRoute(me,fe)}function h(ie){const le=t.getRecordMatcher(ie);le&&t.removeRoute(le)}function b(){return t.getRoutes().map(ie=>ie.record)}function I(ie){return!!t.getRecordMatcher(ie)}function k(ie,le){if(le=bt({},le||r.value),typeof ie=="string"){const D=Rc(s,ie,le.path),G=t.resolve({path:D.path},le),pe=n.createHref(D.fullPath);return bt(D,G,{params:p(G.params),hash:Yl(D.hash),redirectedFrom:void 0,href:pe})}let fe;if(ie.path!=null)fe=bt({},ie,{path:Rc(s,ie.path,le.path).path});else{const D=bt({},ie.params);for(const G in D)D[G]==null&&delete D[G];fe=bt({},ie,{params:u(D)}),le.params=u(le.params)}const me=t.resolve(fe,le),ge=ie.hash||"";me.params=d(p(me.params));const Ne=Vk(a,bt({},ie,{hash:Fk(ge),path:me.path})),A=n.createHref(Ne);return bt({fullPath:Ne,hash:ge,query:a===ff?iS(ie.query):ie.query||{}},me,{redirectedFrom:void 0,href:A})}function y(ie){return typeof ie=="string"?Rc(s,ie,r.value.path):bt({},ie)}function g(ie,le){if(c!==ie)return Ki(Pt.NAVIGATION_CANCELLED,{from:le,to:ie})}function x(ie){return E(ie)}function S(ie){return x(bt(y(ie),{replace:!0}))}function _(ie,le){const fe=ie.matched[ie.matched.length-1];if(fe&&fe.redirect){const{redirect:me}=fe;let ge=typeof me=="function"?me(ie,le):me;return typeof ge=="string"&&(ge=ge.includes("?")||ge.includes("#")?ge=y(ge):{path:ge},ge.params={}),bt({query:ie.query,hash:ie.hash,params:ge.path!=null?{}:ie.params},ge)}}function E(ie,le){const fe=c=k(ie),me=r.value,ge=ie.state,Ne=ie.force,A=ie.replace===!0,D=_(fe,me);if(D)return E(bt(y(D),{state:typeof D=="object"?bt({},ge,D.state):ge,force:Ne,replace:A}),le||fe);const G=fe;G.redirectedFrom=le;let pe;return!Ne&&qk(a,me,fe)&&(pe=Ki(Pt.NAVIGATION_DUPLICATED,{to:G,from:me}),J(me,me,!0,!1)),(pe?Promise.resolve(pe):O(G,me)).catch(B=>Ba(B)?Ba(B,Pt.NAVIGATION_GUARD_REDIRECT)?B:ce(B):P(B,G,me)).then(B=>{if(B){if(Ba(B,Pt.NAVIGATION_GUARD_REDIRECT))return E(bt({replace:A},y(B.to),{state:typeof B.to=="object"?bt({},ge,B.to.state):ge,force:Ne}),le||G)}else B=T(G,me,!0,A,ge);return U(G,me,B),B})}function R(ie,le){const fe=g(ie,le);return fe?Promise.reject(fe):Promise.resolve()}function w(ie){const le=V.values().next().value;return le&&typeof le.runWithContext=="function"?le.runWithContext(ie):ie()}function O(ie,le){let fe;const[me,ge,Ne]=oS(ie,le);fe=Oc(me.reverse(),"beforeRouteLeave",ie,le);for(const D of me)D.leaveGuards.forEach(G=>{fe.push(_n(G,ie,le))});const A=R.bind(null,ie,le);return fe.push(A),Ie(fe).then(()=>{fe=[];for(const D of i.list())fe.push(_n(D,ie,le));return fe.push(A),Ie(fe)}).then(()=>{fe=Oc(ge,"beforeRouteUpdate",ie,le);for(const D of ge)D.updateGuards.forEach(G=>{fe.push(_n(G,ie,le))});return fe.push(A),Ie(fe)}).then(()=>{fe=[];for(const D of Ne)if(D.beforeEnter)if(ga(D.beforeEnter))for(const G of D.beforeEnter)fe.push(_n(G,ie,le));else fe.push(_n(D.beforeEnter,ie,le));return fe.push(A),Ie(fe)}).then(()=>(ie.matched.forEach(D=>D.enterCallbacks={}),fe=Oc(Ne,"beforeRouteEnter",ie,le,w),fe.push(A),Ie(fe))).then(()=>{fe=[];for(const D of l.list())fe.push(_n(D,ie,le));return fe.push(A),Ie(fe)}).catch(D=>Ba(D,Pt.NAVIGATION_CANCELLED)?D:Promise.reject(D))}function U(ie,le,fe){o.list().forEach(me=>w(()=>me(ie,le,fe)))}function T(ie,le,fe,me,ge){const Ne=g(ie,le);if(Ne)return Ne;const A=le===hn,D=ki?history.state:{};fe&&(me||A?n.replace(ie.fullPath,bt({scroll:A&&D&&D.scroll},ge)):n.push(ie.fullPath,ge)),r.value=ie,J(ie,le,fe,A),ce()}let $;function te(){$||($=n.listen((ie,le,fe)=>{if(!ve.listening)return;const me=k(ie),ge=_(me,ve.currentRoute.value);if(ge){E(bt(ge,{replace:!0,force:!0}),me).catch(Ol);return}c=me;const Ne=r.value;ki&&Xk(pf(Ne.fullPath,fe.delta),Yr()),O(me,Ne).catch(A=>Ba(A,Pt.NAVIGATION_ABORTED|Pt.NAVIGATION_CANCELLED)?A:Ba(A,Pt.NAVIGATION_GUARD_REDIRECT)?(E(bt(y(A.to),{force:!0}),me).then(D=>{Ba(D,Pt.NAVIGATION_ABORTED|Pt.NAVIGATION_DUPLICATED)&&!fe.delta&&fe.type===bd.pop&&n.go(-1,!1)}).catch(Ol),Promise.reject()):(fe.delta&&n.go(-fe.delta,!1),P(A,me,Ne))).then(A=>{A=A||T(me,Ne,!1),A&&(fe.delta&&!Ba(A,Pt.NAVIGATION_CANCELLED)?n.go(-fe.delta,!1):fe.type===bd.pop&&Ba(A,Pt.NAVIGATION_ABORTED|Pt.NAVIGATION_DUPLICATED)&&n.go(-1,!1)),U(me,Ne,A)}).catch(Ol)}))}let W=fl(),M=fl(),L;function P(ie,le,fe){ce(ie);const me=M.list();return me.length?me.forEach(ge=>ge(ie,le,fe)):console.error(ie),Promise.reject(ie)}function re(){return L&&r.value!==hn?Promise.resolve():new Promise((ie,le)=>{W.add([ie,le])})}function ce(ie){return L||(L=!ie,te(),W.list().forEach(([le,fe])=>ie?fe(ie):le()),W.reset()),ie}function J(ie,le,fe,me){const{scrollBehavior:ge}=e;if(!ki||!ge)return Promise.resolve();const Ne=!fe&&eS(pf(ie.fullPath,0))||(me||!fe)&&history.state&&history.state.scroll||null;return zt().then(()=>ge(ie,le,Ne)).then(A=>A&&Qk(A)).catch(A=>P(A,ie,le))}const K=ie=>n.go(ie);let ae;const V=new Set,ve={currentRoute:r,listening:!0,addRoute:m,removeRoute:h,clearRoutes:t.clearRoutes,hasRoute:I,getRoutes:b,resolve:k,options:e,push:x,replace:S,go:K,back:()=>K(-1),forward:()=>K(1),beforeEach:i.add,beforeResolve:l.add,afterEach:o.add,onError:M.add,isReady:re,install(ie){ie.component("RouterLink",RS),ie.component("RouterView",NS),ie.config.globalProperties.$router=ve,Object.defineProperty(ie.config.globalProperties,"$route",{enumerable:!0,get:()=>Ra(r)}),ki&&!ae&&r.value===hn&&(ae=!0,x(n.location).catch(me=>{}));const le={};for(const me in hn)Object.defineProperty(le,me,{get:()=>r.value[me],enumerable:!0});ie.provide(Qr,ve),ie.provide(Ru,Fd(le)),ie.provide(xd,r);const fe=ie.unmount;V.add(ie),ie.unmount=function(){V.delete(ie),V.size<1&&(c=hn,$&&$(),$=null,r.value=hn,ae=!1,L=!1),fe()}}};function Ie(ie){return ie.reduce((le,fe)=>le.then(()=>w(fe)),Promise.resolve())}return ve}function fg(){return na(Qr)}function DS(e){return na(Ru)}const Xr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=DS(),s=fg(),a=z({get(){var r;const o=t.query.tab;return o&&e.tabs.some(c=>c.id===o)?o:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(o){s.replace({query:{...t.query,tab:o}})}}),n=z(()=>{var o;return((o=e.tabs.find(r=>r.id===a.value))==null?void 0:o.component)||null}),i=z(()=>{var o;return((o=e.tabs.find(r=>r.id===a.value))==null?void 0:o.label)||""});Wt(i,o=>{e.groupLabel&&o&&(document.title=`Odin — ${e.groupLabel} › ${o}`)},{immediate:!0});function l(o,r){if(!["ArrowLeft","ArrowRight","Home","End"].includes(o.key))return;o.preventDefault();let c=r;o.key==="ArrowRight"&&(c=(r+1)%e.tabs.length),o.key==="ArrowLeft"&&(c=(r-1+e.tabs.length)%e.tabs.length),o.key==="Home"&&(c=0),o.key==="End"&&(c=e.tabs.length-1),a.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:a,activeComponent:n,activeLabel:i,onTabKeydown:l}},template:`
...
`).replace(/\n$/,""),d=hg(c,Lc.previewLines,Lc.previewChars),u=t.kind==="audit_preview"?(m=t.metadata)==null?void 0:m.source:t.metadata,p=u&&(t.kind==="process_output"||u.kind==="process_output")?`PID ${u.pid??"?"} ${u.status??""}${Number.isInteger(u.exit_code)?` exit ${u.exit_code}`:""}`.trim():t.kind==="agent_result"&&(u!=null&&u.status)?`agent ${u.status}`:"";return{promoted:r,chars:i,lines:l,envelope:o,kind:t.kind,formatted:c,preview:d,outcome:p,header:t.header,summary:n.replace(/\n/g," "),warnings:HS(t)}}const VS={name:"CompactOutput",props:{value:{default:""},rawValue:{default:void 0},label:{type:String,default:"Output"},hasContext:{type:Boolean,default:!1},recordId:{default:null}},setup(e){const t=f(!1),s=f(!0),a=f(!1),n=f(""),i=f(null),l=f(null),o=f(!1),r=z(()=>jS(e.value)),c=z(()=>{const x=e.rawValue===void 0?e.value:e.rawValue;return typeof x=="string"?x:JSON.stringify(x,null,2)??""}),d=z(()=>a.value?c.value:r.value.formatted),u=z(()=>r.value.promoted&&r.value.preview.folded||o.value),p=z(()=>t.value?!!d.value:r.value.promoted),m=z(()=>p.value?"":r.value.summary);let h;function b(){if(t.value)return;const x=r.value.promoted?i.value:l.value;o.value=!!(x&&(x.scrollHeight>x.clientHeight+1||x.scrollWidth>x.clientWidth+1))}function I(){h==null||h.disconnect();for(const x of[i.value,l.value])x&&(h==null||h.observe(x));b()}function k(){t.value=!t.value,t.value||(a.value=!1)}function y(){a.value=!a.value,t.value=!0,n.value=""}async function g(){const x=e.value;try{await navigator.clipboard.writeText(d.value),x===e.value&&(n.value="Copied")}catch{x===e.value&&(n.value="Copy unavailable — select text manually")}}return Wt([()=>e.value,()=>e.rawValue,()=>e.recordId],(x,S)=>{(e.recordId===null||x[2]!==S[2])&&(t.value=!1,a.value=!1),n.value=""}),Wt([i,l,t,s,r],()=>zt(I),{flush:"post"}),st(()=>{h=new ResizeObserver(b),I()}),xt(()=>h==null?void 0:h.disconnect()),{expanded:t,wrapped:s,rawMode:a,copyStatus:n,previewElement:i,summaryElement:l,model:r,body:d,canExpand:u,showBody:p,headerSummary:m,toggleExpanded:k,toggleRaw:y,copyOutput:g}},template:`
    ...
    </section>`},ec={name:"ToolOutput",components:{CompactOutput:VS},props:{value:{default:""},label:{type:String,default:"Output"},presentation:{type:String,default:"inspector"},rawValue:{default:void 0},hasContext:{type:Boolean,default:!1},recordId:{default:null}},setup(e){const t=f(!1),s=f(!0),a=f(!1),n=f(""),i=z(()=>mg(e.value)),l=z(()=>a.value?[{label:"Raw received value",text:i.value.raw}]:i.value.sections),o=z(()=>{let u=30,p=6e3;return l.value.map(m=>{const h=hg(m.text,u,p);return u=Math.max(0,u-h.lines),p=Math.max(0,p-h.chars),{...m,display:t.value?m.text:h.text,folded:h.folded}})}),r=z(()=>o.value.some(u=>u.folded)),c=z(()=>a.value?i.value.raw:l.value.map(u=>u.label?`${u.label}
${u.text}`:u.text).join(`
...
`)}}return}}}let i=null;function l(){const p=Date.now();e.value.forEach(m=>{m.status==="running"&&(m.elapsed=p-m.startTime)})}let o=!1;function r(){o||(o=!0,ut.on("events",n),i||(i=setInterval(l,500)))}function c(){o&&(o=!1,ut.off("events",n),i&&(clearInterval(i),i=null))}st(r),rs(r),Kt(c),xt(c);function d(p){return p<1e3?`${p}ms`:`${(p/1e3).toFixed(1)}s`}function u(p){return p==="running"?"clock":p==="success"?"success":p==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
  ...
  `};function Ou(e){if(e instanceof Date)return e;if(typeof e=="string"){const t=new Date(e);return isNaN(t.getTime())?null:t}return typeof e=="number"&&isFinite(e)?new Date(e<1e12?e*1e3:e):null}function ni(e){const t=Ou(e);return t?t.toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"}):"—"}function GS(e){const t=Ou(e);return t?t.toLocaleTimeString():"—"}function vg(e){const t=Ou(e);if(!t)return"—";const s=Math.max(0,Math.floor((Date.now()-t.getTime())/1e3));return s<60?`${s}s ago`:s<3600?`${Math.floor(s/60)}m ago`:s<86400?`${Math.floor(s/3600)}h ago`:`${Math.floor(s/86400)}d ago`}function WS(e){if(e==null||!isFinite(e))return"—";const t=Math.max(0,Math.floor(Number(e)));return t<60?"less than 1 min ago":t<3600?`${Math.floor(t/60)} min ago`:t<86400?`${Math.floor(t/3600)} hr ago`:`${Math.floor(t/86400)} day ago`}function Ji(e){if(e==null||!isFinite(e))return"—";const t=Math.max(0,Math.round(e));if(t<60)return`${t}s`;if(t<3600){const n=Math.floor(t/60),i=t%60;return i?`${n}m ${i}s`:`${n}m`}const s=Math.floor(t/3600),a=Math.floor(t%3600/60);return a?`${s}h ${a}m`:`${s}h`}function Lu(e,t=200){const s=String(e??"");return s.length>t?s.slice(0,t)+"…":s}function gg(e,t=5e3){const s=String(e??"");return s.length>t?s.slice(0,t)+`
... (truncated)`:s}function Tf(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Nu(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function bg(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const yg=Symbol("agent-detail-cancelled"),KS=15e3;function JS(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:a,cancelTimeout:n}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((m,h)=>{r=m,c=h});function u(m,h){o||(o=!0,l!==null&&n(l),l=null,(m?r:c)(h))}let p;try{p=e(i==null?void 0:i.signal)}catch(m){u(!1,m)}return o||Promise.resolve(p).then(m=>u(!0,m),m=>u(!1,m)),!o&&Number.isFinite(t)&&t>0&&(l=a(()=>{const m=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${m}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,yg),i==null||i.abort()}}}function xg({state:e,requestDetail:t,timeoutMs:s=KS,detailLabel:a="Agent detail",scheduleTimeout:n=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:m,coalesce:h}){if(!p)return Promise.resolve();if(h&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const b={agentId:p,cancel:null,promise:null};l=b,m?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const I=JS(k=>t(p,{signal:k}),{timeoutMs:s,timeoutLabel:a,scheduleTimeout:n,cancelTimeout:i});return b.cancel=I.cancel,b.promise=(async()=>{let k=null,y=null;try{k=await I.promise}catch(g){y=g}k!==yg&&(l!==b||e.detailId!==p||(l=null,!y&&(k===null||typeof k!="object")&&(y=new Error(`${a} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${a.toLowerCase()}`):(e.detail=k,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function ZS({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:a,intervalMs:n=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&a())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,n))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const YS={components:{ToolOutput:ec},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(!0),i=f("all");let l=!1;const o=z(()=>e.value.filter(P=>P.status==="running").length),r=z(()=>e.value.filter(P=>P.status==="completed").length),c=z(()=>e.value.filter(P=>["failed","timeout","killed"].includes(P.status)).length),d=z(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=z(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(P=>["failed","timeout","killed"].includes(P.status)):e.value.filter(P=>P.status===i.value));function p(P){const re=Number(P.max_iterations)||0;return re<=0?0:Math.min(100,Math.round(P.iteration_count/re*100))}function m(P){return(Number(P.max_iterations)||0)>0}function h(P,re){return P?P==="N/A"?"N/A":re==="current_inheritance"?`inherit (currently ${P})`:P:"unknown"}function b(P){return h(P.display_model,P.display_model_source||P.display_source)}function I(P){return h(P.display_reasoning_effort,P.display_reasoning_effort_source||P.display_source)}function k(P){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[P]||""}const y=f(null),g=f(null),x=f(!1),S=f(null),_=f(""),R=xg({state:{get detail(){return y.value},set detail(P){y.value=P},get detailId(){return g.value},set detailId(P){g.value=P},get detailLoading(){return x.value},set detailLoading(P){x.value=P},get detailError(){return S.value},set detailError(P){S.value=P}},requestDetail:(P,{signal:re})=>H.get(`/api/agents/${encodeURIComponent(P)}`,{signal:re})});async function w(P){_.value="",await R.open(P.id)}function O(){R.close(),_.value=""}async function U(){await R.refresh()}async function T(P,re){try{await navigator.clipboard.writeText(re||""),_.value=P,setTimeout(()=>{_.value===P&&(_.value="")},1500)}catch{Te.error("Copy failed")}}async function $(P=!1){P=P===!0,P||(t.value=!0);try{const re=await H.get("/api/agents");e.value=Array.isArray(re)?re:[],s.value=null}catch(re){P||(s.value=re.message)}P||(t.value=!1)}async function te(P){const re=e.value.find(J=>J.id===P);if(await os({title:"Kill agent",message:`Kill agent "${(re==null?void 0:re.label)||P}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){a.value=P;try{await H.del(`/api/agents/${encodeURIComponent(P)}`),Te.success("Agent killed"),await $()}catch(J){Te.error(J.message||"Failed to kill agent")}a.value=null}}const W=ZS({isEnabled:()=>n.value&&l,refreshList:()=>$(!0),hasOpenDetail:()=>!!g.value,refreshDetail:U});function M(){W.start()}function L(){W.stop()}return Wt(n,()=>W.sync()),st(()=>{l=!0,$(),M()}),rs(()=>{l=!0,$(!0),M()}),Kt(()=>{l=!1,L()}),xt(()=>{l=!1,L(),R.close()}),{agents:e,loading:t,error:s,killing:a,autoRefresh:n,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ni,formatDuration:Ji,progressPercent:p,hasProgress:m,displayModelText:b,displayEffortText:I,displaySourceLabel:k,detail:y,detailId:g,detailLoading:x,detailError:S,copied:_,openDetail:w,closeDetail:O,copyText:T,fetchAgents:$,killAgent:te,startAutoRefresh:M,stopAutoRefresh:L}}},QS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(!1),n=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),m=f("");let h=!1;const I=xg({state:{get detail(){return c.value},set detail(L){c.value=L},get detailId(){return d.value},set detailId(L){d.value=L},get detailLoading(){return u.value},set detailLoading(L){u.value=L},get detailError(){return p.value},set detailError(L){p.value=L}},detailLabel:"Loop detail",requestDetail:(L,{signal:P})=>H.get(`/api/loops/${encodeURIComponent(L)}?limit=100`,{signal:P})});async function k(L){m.value="",await I.open(L.id)}function y(){I.close(),m.value=""}async function g(L,P){try{await navigator.clipboard.writeText(P||""),m.value=L,setTimeout(()=>{m.value===L&&(m.value="")},1500)}catch{Te.error("Copy failed")}}const x=z(()=>e.value.reduce((L,P)=>L+(P.iteration_count||0),0)),S=z(()=>e.value.filter(L=>L.status==="running").length);function _(L){return L==="running"?"loop-status-running":L==="error"?"loop-status-error":"loop-status-stopped"}function E(L){return L==="running"?"badge-success":L==="error"?"badge-danger":L==="completed"?"badge-info":"badge-warning"}function R(L){return L==="act"?"badge-warning":L==="silent"?"badge-info":"badge-success"}async function w(L=!1){L=L===!0,L||(t.value=!0);try{const P=await H.get("/api/loops");e.value=Array.isArray(P)?P:[],s.value=null}catch(P){L||(s.value=P.message)}L||(t.value=!1)}async function O(){l.value=null;const L=n.value;if(!L.goal.trim()){l.value="Goal is required";return}if(!L.channel_id.trim()){l.value="Channel ID is required";return}const P={goal:L.goal.trim(),channel_id:L.channel_id.trim(),interval_seconds:L.interval_seconds||60,mode:L.mode,max_iterations:L.max_iterations||50};L.stop_condition.trim()&&(P.stop_condition=L.stop_condition.trim()),i.value=!0;try{const re=await H.post("/api/loops",P);Te.success(`Loop started: ${re.loop_id}`),n.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},a.value=!1,await w()}catch(re){l.value=re.message}i.value=!1}async function U(L){if(await os({title:"Stop loop",message:`Stop loop ${L}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=L;try{await H.del(`/api/loops/${encodeURIComponent(L)}`),Te.success("Loop stopped"),await w()}catch(re){Te.error(re.message||"Failed to stop loop")}o.value=null}}async function T(L){r.value=L;try{await H.post(`/api/loops/${encodeURIComponent(L)}/restart`),Te.success("Loop restarted"),await w()}catch(P){Te.error(P.message||"Failed to restart loop")}r.value=null}function $(L){h&&L.payload&&(L.payload.loop_id||L.payload.type==="loop")&&(w(!0),d.value&&I.refresh())}let te=null;function W(){te!==null&&clearInterval(te),te=null}function M(){W(),h&&(te=setInterval(()=>{w(!0),d.value&&I.refresh()},5e3))}return st(()=>{h=!0,w(),ut.subscribe("events",$),M()}),rs(()=>{h=!0,w(!0),M()}),Kt(()=>{h=!1,W()}),xt(()=>{h=!1,ut.unsubscribe("events",$),W(),I.close()}),{loops:e,loading:t,error:s,showCreate:a,form:n,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:m,totalIterations:x,runningCount:S,statusDotClass:_,statusBadge:E,modeBadge:R,formatAge:vg,formatDuration:Ji,formatTs:ni,formatTokens:bg,openDetail:k,closeDetail:y,copyText:g,fetchLoops:w,doCreate:O,doStop:U,doRestart:T}}},XS={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(Ko(null)),n=z(()=>a.value.available),i=z(()=>Oo(a.value));let l=null;const o=f(!1),r=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""}),c=f(!1),d=f(null),u=z(()=>Rf(a.value,r.value.action));function p(B){return Rf(a.value,B)}const m=f(null),h=z(()=>a1(r.value.run_at));Wt(()=>r.value.run_at,()=>{m.value=null});const b=z(()=>{var Y;const B=h.value;return B.state==="ok"?B.instant:B.state==="ambiguous"&&m.value!==null&&((Y=B.options[m.value])==null?void 0:Y.instant)||null}),I=z(()=>{const B=b.value;return B?`${B.toLocaleString()} local — ${B.toISOString()} UTC`:""}),k=f(null),y=f(!1),g=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],x=f(null),S=f(null),_=f(null),E=f(null),R=f(null),w=f(null),O=f([]),U=f(!1),T=f("");let $=0;const te=z(()=>e.value.filter(B=>B.cron&&!B.one_time).length),W=z(()=>e.value.filter(B=>B.one_time).length),M=z(()=>e.value.filter(B=>B.trigger).length),L=z(()=>e.value.filter(B=>B.paused).length),P=z(()=>e.value.filter(B=>B.consecutive_failures>0).length);function re(B){if(!B)return"-";const Y=Date.now(),j=(new Date(B).getTime()-Y)/1e3;if(j<0)return"overdue";if(j<60)return"in < 1 min";if(j<3600)return`in ${Math.floor(j/60)} min`;if(j<86400){const ee=Math.floor(j/3600),be=Math.floor(j%3600/60);return be>0?`in ${ee}h ${be}m`:`in ${ee}h`}const X=Math.floor(j/86400);return`in ${X} day${X!==1?"s":""}`}function ce(B){return B==null?"-":B<1e3?`${B}ms`:B<6e4?`${(B/1e3).toFixed(1)}s`:Ji(B/1e3)}function J(B=r.value.cron){r.value.cron=B,Ef(r.value,"cron"),k.value=null}function K(B=r.value.run_at){r.value.run_at=B,Ef(r.value,"run_at"),k.value=null}async function ae(){const B=r.value.cron.trim();if(B){y.value=!0;try{k.value=await H.post("/api/schedules/validate-cron",{expression:B})}catch(Y){k.value={valid:!1,error:Y.message}}y.value=!1}}async function V(){t.value=!0,s.value=null;try{e.value=await H.get("/api/schedules")}catch(B){s.value=B.message}t.value=!1}async function ve(){try{a.value=Ko(await H.get("/api/schedules/status"))}catch(B){a.value=Af(B)||Ko(null)}}function Ie(B){const Y=Af(B);Y&&(a.value=Y)}async function ie(B){if(w.value===B){w.value=null,O.value=[];return}w.value=B,U.value=!0,O.value=[];const Y=++$;try{const ue=await H.get(`/api/schedules/${encodeURIComponent(B)}/history?limit=10`);if(Y!==$||w.value!==B)return;O.value=ue,T.value=""}catch(ue){if(Y!==$||w.value!==B)return;O.value=[],T.value=ue.message||"Failed to load execution history"}Y===$&&(U.value=!1)}async function le(){if(d.value=null,!p(r.value.action)){d.value=Oo(a.value);return}const B=r.value;if(!B.description.trim()){d.value="Description is required";return}if(B.action!=="webhook"&&!B.channel_id.trim()){d.value="Channel ID is required";return}if(!B.cron.trim()&&!B.run_at.trim()){d.value="Cron expression or run_at time is required";return}if(B.cron.trim()&&B.run_at.trim()){d.value="Choose either Cron or One-Time, not both";return}const Y={description:B.description.trim(),action:B.action,channel_id:B.channel_id.trim()};if(B.cron.trim()&&(Y.cron=B.cron.trim()),B.run_at.trim()){const ue=h.value;if(ue.state==="nonexistent"){d.value="That local time does not exist (daylight saving gap)";return}if(ue.state==="invalid"){d.value="One-time run time is not a valid date";return}const j=b.value;if(ue.state==="ambiguous"&&m.value===null){d.value="That local time happens twice — choose which occurrence to use";return}if(!j){d.value="One-time run time could not be resolved";return}Y.run_at=j.toISOString()}if(B.action==="reminder"&&B.message.trim()&&(Y.message=B.message.trim()),B.action==="check"&&(B.tool_name.trim()&&(Y.tool_name=B.tool_name.trim()),B.report_format&&(Y.report_format=B.report_format),B.tool_input_str.trim()))try{Y.tool_input=JSON.parse(B.tool_input_str.trim())}catch{d.value="Tool input must be valid JSON";return}if(B.action==="webhook"){if(!B.webhook_url.trim()){d.value="Webhook URL is required";return}const ue={url:B.webhook_url.trim(),method:B.webhook_method};if(B.webhook_headers_str.trim())try{const j=JSON.parse(B.webhook_headers_str.trim());if(!j||Array.isArray(j)||typeof j!="object")throw new Error("not an object");ue.headers=j}catch{d.value="Webhook headers must be a valid JSON object";return}if(B.webhook_body&&(ue.body=B.webhook_body),B.webhook_expected_status_str.trim()){const j=B.webhook_expected_status_str.split(",").map(X=>Number(X.trim()));if(j.some(X=>!Number.isInteger(X)||X<100||X>599)){d.value="Expected status codes must be comma-separated HTTP codes";return}ue.expected_status_codes=j}Y.webhook_config=ue}c.value=!0;try{await H.post("/api/schedules",Y),Te.success("Schedule created"),r.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""},k.value=null,o.value=!1,await V()}catch(ue){Ie(ue),d.value=ue.message}c.value=!1}async function fe(B){if(!p(B.action)){Te.error(Oo(a.value));return}const Y=B.id;x.value=Y;try{const ue=await H.post(`/api/schedules/${encodeURIComponent(Y)}/run`);if(ue.status==="failure")Te.error(`Execution failed: ${ue.error||"unknown error"}`);else{const j=ue.warning?`Executed (${ue.warning})`:"Executed successfully";Te.success(j)}await V()}catch(ue){Ie(ue),Te.error(ue.message||"Failed to trigger")}x.value=null}async function me(B){if(B.paused&&!p(B.action)){Te.error(Oo(a.value));return}_.value=B.id;const Y=!B.paused;try{await H.put(`/api/schedules/${encodeURIComponent(B.id)}`,{paused:Y}),Te.success(Y?"Schedule paused":"Schedule resumed"),await V()}catch(ue){Ie(ue),Te.error(ue.message||"Failed to update schedule")}_.value=null}const ge=new Map;function Ne(B,Y){const ue=ge.get(B.id);ue&&clearTimeout(ue.timer);const j={run:()=>A(B,Y),timer:null};j.timer=setTimeout(()=>{ge.delete(B.id),j.run()},500),ge.set(B.id,j)}async function A(B,Y){R.value=B.id;try{await H.put(`/api/schedules/${encodeURIComponent(B.id)}`,{report_format:Y}),Te.success(Y?"Structured report enabled":"Plain-text report enabled")}catch(ue){Te.error(`Update failed: ${ue.message}`)}finally{await V(),R.value=null}}function D(){for(const[B,Y]of[...ge])clearTimeout(Y.timer),ge.delete(B),Y.run()}async function G(B){E.value=B;try{await H.post(`/api/schedules/${encodeURIComponent(B)}/reset-failures`),Te.success("Failure counters reset"),await V()}catch(Y){Te.error(Y.message||"Failed to reset")}E.value=null}async function pe(B){const Y=e.value.find(j=>j.id===B);if(await os({title:"Delete schedule",message:`Delete "${(Y==null?void 0:Y.description)||B}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){S.value=B;try{await H.del(`/api/schedules/${encodeURIComponent(B)}`),Te.success("Schedule deleted"),await V()}catch(j){Te.error(j.message||"Failed to delete schedule")}S.value=null}}return st(()=>{V(),ve(),l=setInterval(ve,n1)}),xt(()=>{D(),l&&clearInterval(l)}),{schedules:e,loading:t,error:s,schedulingAvailable:n,schedulingAvailabilityMessage:i,selectedActionAvailable:u,actionAvailable:p,showCreate:o,form:r,creating:c,createError:d,runAtUtcPreview:I,runAtAnalysis:h,runAtOccurrence:m,cronResult:k,validatingCron:y,cronPresets:g,runningId:x,deletingId:S,togglingId:_,resettingId:E,reportUpdatingId:R,flushReportFormatTimers:D,expandedId:w,history:O,historyLoading:U,historyError:T,cronCount:te,oneTimeCount:W,webhookCount:M,pausedCount:L,failingCount:P,formatTs:ni,formatAge:vg,formatFuture:re,formatMs:ce,formatDuration:Ji,onCronInput:J,onRunAtInput:K,validateCron:ae,toggleExpand:ie,fetchSchedules:V,fetchSchedulingAvailability:ve,doCreate:le,doRunNow:fe,doTogglePause:me,doUpdateReportFormat:Ne,doResetFailures:G,doDelete:pe}}},_g=[{id:"live",label:"Live",component:qS},{id:"agents",label:"Agents",component:YS},{id:"loops",label:"Loops",component:QS},{id:"processes",label:"Processes",component:XS},{id:"schedules",label:"Schedules",component:l1}],o1={components:{TabbedPage:Xr},setup(){return{tabs:_g}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},r1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),m=f("last_active"),h=f(!1),b=If,I=c1,k=f([]),y=f(!1),g=f(""),x=f("flat"),S=f(new Set),_=f(""),E=f(""),R=f(""),w=f(null),O=f(!1),U=f(""),T=f(!1);let $=0;Wt([_,E,R],()=>{$++,O.value=!1,U.value="",T.value=w.value!==null},{flush:"sync"});function te(){try{const se=localStorage.getItem("odin-session-presets");se&&(k.value=JSON.parse(se))}catch{}}function W(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const M=z(()=>p.value.trim()!==""||u.value!=="all"),L=z(()=>{let se=[...e.value];const Le=If.find(lt=>lt.id===u.value),ze=Le?Le.filters:{};if(ze.source&&(se=se.filter(lt=>lt.source===ze.source)),ze.minMessages&&(se=se.filter(lt=>lt.message_count>=ze.minMessages)),ze.hasCompaction&&(se=se.filter(lt=>lt.has_summary)),ze.maxAge!=null){const lt=Date.now()/1e3;se=se.filter(gt=>gt.last_active&&lt-gt.last_active<=ze.maxAge)}if(p.value.trim()){const lt=p.value.toLowerCase().trim();se=se.filter(gt=>(gt.channel_id||"").toLowerCase().includes(lt)||(gt.last_user_id||"").toLowerCase().includes(lt)||(gt.source||"").toLowerCase().includes(lt))}const rt=m.value,Zt=h.value?1:-1;return se.sort((lt,gt)=>{const Yt=lt[rt]||0,cs=gt[rt]||0;return(Yt-cs)*Zt}),se}),P=z(()=>{if(!n.value||!n.value.messages)return[];const se=n.value.messages;if(se.length===0)return[];const Le=[];let ze=[];for(const rt of se)rt.role==="user"&&ze.length>0&&(Le.push(ze),ze=[]),ze.push(rt);return ze.length>0&&Le.push(ze),Le}),re=z(()=>L.value.length>0&&c.value.size===L.value.length);function ce(se){const Le=se.find(ze=>ze.role==="user");if(Le&&Le.content){const ze=Le.content.slice(0,120);return ze.length<Le.content.length?ze+"...":ze}return"(no user message)"}function J(se){const Le=new Set(S.value);Le.has(se)?Le.delete(se):Le.add(se),S.value=Le}function K(se){u.value=se}function ae(se){u.value=se.id,se.filters.searchQuery!=null&&(p.value=se.filters.searchQuery),se.filters.sortBy&&(m.value=se.filters.sortBy)}function V(){if(!g.value.trim())return;const se={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:m.value}};k.value=[...k.value,se],W(),y.value=!1,g.value=""}function ve(se){k.value=k.value.filter(Le=>Le.id!==se),W(),u.value===se&&(u.value="all")}function Ie(){u.value="all",p.value="",m.value="last_active",h.value=!1}function ie(se){if(!se)return"—";const Le=Date.now()/1e3-se;if(Le<60)return"just now";if(Le<3600){const rt=Math.floor(Le/60);return`${rt} minute${rt!==1?"s":""} ago`}if(Le<86400){const rt=Math.floor(Le/3600);return`${rt} hour${rt!==1?"s":""} ago`}const ze=Math.floor(Le/86400);return`${ze} day${ze!==1?"s":""} ago`}function le(se){if(!se)return"";try{return new Date(se*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function fe(se){if(!se)return"";try{return new Date(se*1e3).toLocaleString()}catch{return""}}function me(se){return se==="user"?"bg-gray-900/50 border border-gray-800":se==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ge(se){return se==="user"?"sess-msg-user":se==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Ne(se){return se==="user"?"badge-info":se==="assistant"?"badge-success":"badge-warning"}function A(se){return se==="user"?"sess-dot-user":se==="assistant"?"sess-dot-assistant":"sess-dot-system"}function D(se){return se==="user"?"text-cyan-400":se==="assistant"?"text-indigo-400":"text-gray-500"}function G(se){return se?se.length>2e3?se.slice(0,2e3)+`
... (truncated)`:se:""}async function pe(){const se=_.value.trim();if(!se)return;const Le=++$;O.value=!0,U.value="",T.value=w.value!==null;try{let ze=`/api/sessions/search?q=${encodeURIComponent(se)}&limit=50`;E.value.trim()&&(ze+=`&channel_id=${encodeURIComponent(E.value.trim())}`),R.value.trim()&&(ze+=`&user_id=${encodeURIComponent(R.value.trim())}`);const rt=await H.get(ze);if(Le!==$)return;w.value=rt.results||[],T.value=!1}catch(ze){if(Le!==$)return;U.value=ze.message||"Search failed. Please retry."}finally{Le===$&&(O.value=!1)}}function B(){$++,_.value="",E.value="",R.value="",w.value=null,U.value="",T.value=!1,O.value=!1}function Y(se){return se?se.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function ue(se){return se==="user"?"fts-result-user":se==="assistant"?"fts-result-assistant":se==="summary"?"fts-result-summary":se==="fts"?"fts-result-fts":se==="channel"?"fts-result-channel":"fts-result-default"}function j(se){return se==="user"?"badge-info":se==="assistant"?"badge-success":se==="summary"?"badge-warning":se==="fts"?"badge-success":"badge-info"}let X=0;async function ee(){const se=++X;t.value=!0,s.value=null;try{const Le=await H.get("/api/sessions");if(se!==X)return;e.value=Le}catch(Le){if(se!==X)return;s.value=Le.message}se===X&&(t.value=!1)}function be(){s.value=null,ee()}async function he(se){if(a.value===se){a.value=null,n.value=null,S.value=new Set;return}a.value=se,n.value=null,i.value=!0,S.value=new Set;const Le=++l;try{const ze=await H.get(`/api/sessions/${encodeURIComponent(se)}`);Le===l&&a.value===se&&(n.value=ze)}catch(ze){Le===l&&a.value===se&&(n.value={messages:[],summary:"",error:ze.message||"Failed to load session"})}finally{Le===l&&(i.value=!1)}}function we(se){const Le=new Set(c.value);Le.has(se)?Le.delete(se):Le.add(se),c.value=Le}function _e(){re.value?c.value=new Set:c.value=new Set(L.value.map(se=>se.channel_id))}function ye(se){o.value=se}async function Ke(){if(o.value){r.value=!0;try{await H.del(`/api/sessions/${encodeURIComponent(o.value)}`),a.value===o.value&&(a.value=null,n.value=null),c.value.delete(o.value),await ee()}catch(se){s.value=se.message||"Failed to clear session"}r.value=!1,o.value=null}}function Je(){d.value=!0}async function Fe(){if(c.value.size!==0){r.value=!0;try{await H.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(a.value)&&(a.value=null,n.value=null),c.value=new Set,await ee()}catch(se){s.value=se.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Ge(se,Le){const ze=`/api/sessions/${encodeURIComponent(se)}/export?format=${Le}`;try{const rt=await H.getBlob(ze),Zt=URL.createObjectURL(rt),lt=document.createElement("a");lt.href=Zt,lt.download=`session-${se}.${Le==="text"?"txt":"json"}`,lt.click(),URL.revokeObjectURL(Zt)}catch(rt){s.value=rt.message||"Failed to export session"}}let at=null;function Xe(se){se.payload&&se.payload.channel_id&&(clearTimeout(at),at=setTimeout(()=>{if(ee(),a.value&&se.payload.channel_id===a.value){const Le=a.value,ze=l;H.get(`/api/sessions/${encodeURIComponent(Le)}`).then(rt=>{ze!==l||a.value!==Le||(n.value=rt)}).catch(()=>{})}},2e3))}let Z=!1,Ee=null;function Ae(){Z||(Z=!0,ee(),ut.subscribe("events",Xe),Ee=ut.onReconnected(()=>ee()))}st(()=>{te(),Ae()}),rs(()=>{Ae()});function Me(){Z&&(Z=!1,ut.unsubscribe("events",Xe),Ee&&(Ee(),Ee=null),clearTimeout(at))}return Kt(Me),xt(Me),{sessions:e,loading:t,error:s,expandedId:a,detail:n,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:re,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:m,sortAsc:h,filterPresets:b,sortOptions:I,filteredSessions:L,hasActiveFilters:M,customPresets:k,showSavePreset:y,newPresetName:g,threadView:x,threads:P,collapsedThreads:S,ftsQuery:_,ftsChannelId:E,ftsUserId:R,ftsResults:w,ftsSearching:O,ftsError:U,ftsStale:T,formatAge:ie,formatTimestamp:le,formatFullTimestamp:fe,messageClass:me,threadMsgClass:ge,roleBadge:Ne,roleDotClass:A,roleLabelClass:D,truncateContent:G,threadSummary:ce,fetchSessions:ee,retry:be,toggleSession:he,toggleSelect:we,toggleSelectAll:_e,confirmClear:ye,clearSession:Ke,confirmBulkClear:Je,doBulkClear:Fe,exportSession:Ge,applyPreset:K,applyCustomPreset:ae,saveCustomPreset:V,removeCustomPreset:ve,resetFilters:Ie,toggleThread:J,runFtsSearch:pe,clearFtsSearch:B,highlightSnippet:Y,ftsResultClass:ue,ftsTypeBadge:j}}},u1={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:bg}}},p1={components:{ContextAssemblyPanel:u1},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(E){if(!E)return"—";try{const R=new Date(E);return isNaN(R.getTime())?E:R.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return E}}function p(E){return!E&&E!==0?"—":E<1e3?E+"ms":(E/1e3).toFixed(1)+"s"}function m(E){return!E&&E!==0?"—":E>=1e3?(E/1e3).toFixed(1)+"k":String(E)}function h(E){if(!E)return"";if(typeof E=="string")return E;try{return JSON.stringify(E,null,2)}catch{return String(E)}}function b(E){n.value===E?n.value=null:(n.value=E,c.value={})}function I(E,R){const w=E+"-"+R;c.value={...c.value,[w]:!c.value[w]}}function k(E,R){return!!c.value[E+"-"+R]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,S()}async function g(){try{const E=await H.get("/api/trajectories");e.value=E.files||[],r.value=E.count||0}catch{}}let x=0;async function S(){const E=++x;s.value=!0,a.value=null,n.value=null,i.value=null,c.value={};try{if(o.value){const R=await H.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(E!==x)return;let w=R.entries||[];d.value.tool_name&&(w=w.filter(O=>(O.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(w=w.filter(O=>O.is_error)),d.value.channel_id&&(w=w.filter(O=>O.channel_id===d.value.channel_id)),d.value.user_id&&(w=w.filter(O=>O.user_id===d.value.user_id)),t.value=w}else{const R=new URLSearchParams;d.value.channel_id&&R.set("channel_id",d.value.channel_id),d.value.user_id&&R.set("user_id",d.value.user_id),d.value.tool_name&&R.set("tool_name",d.value.tool_name),d.value.errors_only&&R.set("errors_only","true"),R.set("limit",String(d.value.limit));const w=R.toString(),O=await H.get(`/api/trajectories/search/query?${w}`);if(E!==x)return;t.value=O.results||[]}}catch(R){if(E!==x)return;a.value=R.message}E===x&&(s.value=!1)}async function _(){if(!l.value.trim())return;const E=++x;s.value=!0,a.value=null,c.value={};try{const R=await H.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(E!==x)return;i.value=R.entry||null,i.value||(a.value="No trace found for this message ID")}catch(R){if(E!==x)return;R.status===404?(i.value=null,a.value="No trace found for message ID: "+l.value):a.value=R.message}E===x&&(s.value=!1)}return st(async()=>{await g(),await S()}),{files:e,entries:t,loading:s,error:a,expandedIdx:n,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:m,formatJSON:h,truncateBlock:gg,toggleExpand:b,toggleIteration:I,isIterationExpanded:k,clearFilters:y,fetchFiles:g,fetchTraces:S,lookupMessage:_}}};function f1(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function m1(e){return e?`${e.approximate?"~":""}${Nu(e.total||0)}`:"0"}const h1={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),a=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),n=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=z(()=>a.value.work||{}),m=E=>E==null?"Not reported":`$${Number(E).toFixed(6)}`,h=z(()=>Math.max(1,...(a.value.activity_over_time||[]).map(E=>Number(E.count||0)))),b=z(()=>({minWidth:`max(100%, ${(a.value.activity_over_time||[]).length*5}px)`})),I=E=>({height:`${Math.max(4,Math.round(Number(E||0)/h.value*100))}%`}),k=z(()=>s.value&&l.value-i.value>3e4);async function y(){const E=++d,R=n.value;try{const w=await H.get(`/api/usage?range=${encodeURIComponent(R)}`);if(E!==d||R!==n.value)return;a.value=w,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(w){E===d&&(t.value=w.message)}finally{E===d&&(e.value=!1)}}function g(E){n.value=E,e.value=!s.value,y()}function x(){e.value=!0,y()}function S(){c||(c=!0,y(),o=setInterval(y,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function _(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return st(S),rs(S),Kt(_),xt(_),{data:a,work:p,loading:e,error:t,hasData:s,range:n,ranges:u,isStale:k,fmtNum:Nu,fmtDuration:f1,tokenLabel:m1,formatActualCost:m,activityTrackStyle:b,activityBar:I,selectRange:g,retry:x}}},wg=[{id:"audit",label:"Audit",component:r1},{id:"sessions",label:"Sessions",component:d1},{id:"traces",label:"Traces",component:p1},{id:"usage",label:"Usage & Activity",component:h1}],v1={components:{TabbedPage:Xr},setup(){return{tabs:wg}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Nc=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],g1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(w){return w.source!=="builtin"?"":u[w.state]||""}function m(w,O){const U=w&&Array.isArray(w.tools)?w.tools:null;if(c.value=!!U,r.value=U?!!w.global_enabled:null,!U){e.value=O.map(te=>({...te,source:"unknown",enabled:void 0,state:null}));return}const T=new Set(U.map(te=>te.name)),$=O.filter(te=>!T.has(te.name)).map(te=>({...te,source:te.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...U.map(te=>({...te,source:"builtin"})),...$]}async function h(w,O){if(d.value.has(w.name))return;const U=!!O.target.checked,T=new Set(d.value);T.add(w.name),d.value=T;try{const $=await H.post(`/api/tools/builtins/${encodeURIComponent(w.name)}/enabled`,{enabled:U});m($,e.value),s.value=null;try{const te=await H.get("/api/tools");m($,te)}catch(te){console.warn("Built-in toggle committed; visible catalog refresh failed",te)}}catch($){O.target.checked=!!w.enabled,s.value=$.message||`Failed to toggle ${w.name}`}finally{const $=new Set(d.value);$.delete(w.name),d.value=$}}const b=z(()=>e.value.filter(w=>w.source==="builtin"&&w.is_core).length),I=z(()=>e.value.filter(w=>w.source==="skill").length),k=z(()=>Object.values(n.value).reduce((w,O)=>w+O,0));function y(w){for(const O of Nc)if(O.id!=="other"&&O.match(w))return O.id;return"other"}const g=z(()=>{let w=e.value;if(a.value){const O=a.value.toLowerCase();w=w.filter(U=>U.name.toLowerCase().includes(O)||(U.description||"").toLowerCase().includes(O))}return o.value&&(w=w.filter(O=>y(O.name)===o.value)),w}),x=z(()=>{const w=new Set;for(const O of e.value)w.add(y(O.name));return Nc.filter(O=>w.has(O.id))}),S=z(()=>{const w=g.value,O={};for(const T of w){const $=y(T.name);O[$]||(O[$]=[]),O[$].push(T)}const U=[];for(const T of Nc)O[T.id]&&O[T.id].length>0&&U.push({label:T.label,icon:T.icon,tools:O[T.id].sort(($,te)=>$.name.localeCompare(te.name))});return U});function _(w){i.value={...i.value,[w]:!i.value[w]}}async function E(){t.value=!0,s.value=null;try{const[w,O,U]=await Promise.all([H.get("/api/tools"),H.get("/api/tools/stats").catch(()=>({})),H.get("/api/tools/builtins").catch(()=>null)]);m(U,w),n.value=O||{}}catch(w){s.value=w.message}t.value=!1}function R(){E()}return st(()=>{E()}),{tools:e,loading:t,error:s,search:a,stats:n,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:b,skillCount:I,totalUsage:k,filteredTools:g,groupedTools:S,usedCategories:x,stateBadge:p,applyInventory:m,toggleBuiltinTool:h,truncate:Lu,toggleExpand:_,refresh:R}}};function b1(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const a="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(a,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function y1(e){if(!e)return"1";const t=e.split(`
...
`)}const x1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f({}),n=f({}),i=f(null),l=f(""),o=f(null),r=f(!1),c=f("create"),d=f(""),u=f(""),p=f(null),m=f(null),h=f(!1),b=f(null),I=f(null),k=f(!1),y=z(()=>e.value.length),g=z(()=>e.value.reduce((V,ve)=>V+(ve.execution_count||0),0)),x=z(()=>e.value.reduce((V,ve)=>V+O(ve.code),0)),S=z(()=>{if(!l.value)return e.value;const V=l.value.toLowerCase();return e.value.filter(ve=>ve.name.toLowerCase().includes(V)||(ve.description||"").toLowerCase().includes(V))}),_=z(()=>u.value?u.value.split(`
`).length:0),E=z(()=>{const V=Math.max(_.value,1);return Array.from({length:V},(ve,Ie)=>Ie+1).join(`
`)}),R=z(()=>{const V=u.value.trim();return V?V.includes("SKILL_DEFINITION")?V.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function w(V){return b1(V)}function O(V){return V?V.split(`
`).length:0}function U(V){return y1(V)}function T(V){a.value={...a.value,[V]:!a.value[V]}}async function $(V){try{await navigator.clipboard.writeText(V);const ve=e.value.find(Ie=>Ie.code===V);ve&&(o.value=ve.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function te(V){if(V.key==="Tab"){V.preventDefault();const ve=V.target,Ie=ve.selectionStart,ie=ve.selectionEnd;u.value=u.value.substring(0,Ie)+"    "+u.value.substring(ie),zt(()=>{ve.selectionStart=ve.selectionEnd=Ie+4})}}function W(V){const ve=V.target.previousElementSibling;ve&&(ve.scrollTop=V.target.scrollTop)}async function M(){t.value=!0,s.value=null;try{e.value=await H.get("/api/skills")}catch(V){s.value=V.message}t.value=!1}async function L(V){i.value=V,delete n.value[V],n.value={...n.value};try{const ve=await H.post(`/api/skills/${encodeURIComponent(V)}/test`);n.value={...n.value,[V]:ve}}catch(ve){n.value={...n.value,[V]:{result:ve.message,is_error:!0}}}i.value=null}function P(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,m.value=null}function re(V){r.value=!0,c.value="edit",d.value=V.name,u.value=V.code||"",p.value=null,m.value=null}function ce(){r.value=!1,p.value=null,m.value=null}async function J(){p.value=null,m.value=null;const V=d.value.trim(),ve=u.value.trim();if(!V){p.value="Name is required";return}if(!ve){p.value="Code is required";return}h.value=!0;try{c.value==="create"?(await H.post("/api/skills",{name:V,code:ve}),m.value="Skill created successfully"):(await H.put(`/api/skills/${encodeURIComponent(V)}`,{code:ve}),m.value="Skill updated successfully"),await M(),setTimeout(()=>{r.value=!1},800)}catch(Ie){p.value=Ie.message}h.value=!1}function K(V){I.value=V}async function ae(){if(I.value){k.value=!0;try{await H.del(`/api/skills/${encodeURIComponent(I.value)}`),await M()}catch(V){Te.error(`Failed to delete skill: ${V.message||"unknown error"}`)}k.value=!1,I.value=null}}return st(()=>{M()}),{skills:e,loading:t,error:s,showCode:a,testResults:n,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:m,saving:h,editorRef:b,deleteTarget:I,deleting:k,enabledCount:y,totalExecutions:g,totalLines:x,displayedSkills:S,editLineCount:_,editorLineNums:E,editValidation:R,highlight:w,truncate:Lu,formatTs:ni,countLines:O,getLineNumbers:U,toggleCode:T,copyCode:$,handleEditorKey:te,syncScroll:W,fetchSkills:M,testSkill:L,showCreate:P,editSkill:re,cancelEdit:ce,saveSkill:J,confirmDelete:K,doDelete:ae}}};class ta extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const _1=/^[A-Za-z_][A-Za-z0-9_]*$/;function Of(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Lf(e,t,s){const a={},n=[...new Set((t||[]).map(l=>String(l)))],i=new Set(n);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new ta(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new ta(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(a,o))throw new ta(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new ta(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");a[o]=r}}return{set:a,remove:n}}function w1(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function k1(e,{mode:t="add",originalTransport:s=""}={}){const a=t==="add",n=String(e.name||"").trim();if(!n)throw new ta("Server name is required.","name");if(n.length>128||!_1.test(n))throw new ta("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!a&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(a&&(o.name=n),i==="stdio"){const d=String(e.command||"").trim();if((a||l)&&!d)throw new ta("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(a||e.replaceArgs)&&(o.args=Of(e.argsText)),a||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new ta("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((a||l)&&!d)throw new ta("An HTTP endpoint is required for this connection.","url");if(d&&!w1(d))throw new ta("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(a||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new ta("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(a||e.replaceAllowlist)&&(o.tool_allowlist=Of(e.allowlistText));const r=Lf(e.headerRows,e.headersRemove,"Header"),c=Lf(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function S1(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function C1(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function T1(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(a=>String(a).toLowerCase().includes(s)):!0}const E1=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function A1(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(a=>(a=window.matchMedia)==null?void 0:a.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const n=t.querySelector(".mcp-editor-groups"),i=n==null?void 0:n.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const R1=1e4,I1=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function Mc(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function O1(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const L1={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),a=f(!1),n=f(""),i=f({max_published_tools_per_server:"",max_published_tools_global:""}),l=f(new Set),o=z(()=>Object.keys(i.value).every(Z=>{var Ee;return Number.isInteger((Ee=e.value)==null?void 0:Ee[Z])})),r=f(""),c=f(new Set),d=f(new Set),u=f({}),p=f({}),m=f({}),h=f(new Set),b=f(!1),I=f("add"),k=f(""),y=f(null),g=f(Mc()),x=f(""),S=f(!1);let _=null,E=0,R=!1,w=!1;const O=E1,U=z(()=>{var Z;return((Z=e.value)==null?void 0:Z.servers)||[]}),T=z(()=>{var Z;return!!((Z=e.value)!=null&&Z.enabled)}),$=z(()=>{var Z,Ee,Ae,Me;return{serverCount:((Z=e.value)==null?void 0:Z.server_count)||0,enabledCount:((Ee=e.value)==null?void 0:Ee.enabled_server_count)||0,connectedCount:((Ae=e.value)==null?void 0:Ae.connected_count)||0,toolCount:((Me=e.value)==null?void 0:Me.published_tool_count)||0}}),te=z(()=>{var Z;return((Z=y.value)==null?void 0:Z.header_keys)||[]}),W=z(()=>{var Z;return((Z=y.value)==null?void 0:Z.env_keys)||[]}),M=z(()=>{var Z;return I.value==="edit"&&((Z=y.value)==null?void 0:Z.transport)==="http"}),L=z(()=>I.value==="add"||!M.value),P=z(()=>M.value?"Replace endpoint URL":"Endpoint URL"),re=z(()=>M.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function ce(){J(),_=window.setInterval(()=>K({quiet:!0}),R1)}function J(){_&&window.clearInterval(_),_=null}async function K({quiet:Z=!1}={}){if(a.value)return;const Ee=++E;Z||(t.value=!0);try{const Ae=await H.get("/api/mcp/status");if(Ee!==E||!R)return;e.value=Ae;for(const se of Object.keys(i.value))!l.value.has(se)&&Number.isInteger(Ae[se])&&(i.value[se]=String(Ae[se]));r.value="";const Me=new Set((Ae.servers||[]).map(se=>se.name));d.value=new Set([...d.value].filter(se=>Me.has(se)))}catch(Ae){Ee===E&&R&&(r.value=Ae.message||"Failed to load MCP status")}finally{Ee===E&&(t.value=!1)}}function ae(Z){return s.value||c.value.has(Z)}function V(Z,Ee){const Ae=new Set(c.value);Ee?Ae.add(Z):Ae.delete(Z),c.value=Ae}function ve(Z){return C1(Z.state)}function Ie(Z){if(ve(Z)==="disabled"){if(!Z.enabled)return"Disabled — server switch off";if(!T.value)return"Disabled — global MCP is off"}return I1[ve(Z)]}function ie(Z){return Z.transport==="http"?"Streamable HTTP":"stdio"}function le(Z){return Z.negotiated_version?`${Z.era?`${String(Z.era).charAt(0).toUpperCase()}${String(Z.era).slice(1)}`:"Protocol"} · ${Z.negotiated_version}`:"Not negotiated"}function fe(Z){return Z.discovered_count?`${Z.published_count||0} published · ${Z.excluded_count||0} excluded`:"No tools discovered"}const me=f(new Set);async function ge(Z,Ee){if(me.value.has(Z.name))return;const Ae=!!Ee.target.checked,Me=new Set(me.value);Me.add(Z.name),me.value=Me;try{const se=await H.post(`/api/mcp/servers/${encodeURIComponent(Z.name)}/enabled`,{enabled:Ae});se&&Array.isArray(se.servers)?e.value=se:await K({quiet:!0})}catch(se){Ee.target.checked=!!Z.enabled,Te.error(se.message||`Failed to toggle ${Z.name}`)}finally{const se=new Set(me.value);se.delete(Z.name),me.value=se}}function Ne(Z,Ee){var Me;i.value[Z]=Ee;const Ae=new Set(l.value);Ee===String((Me=e.value)==null?void 0:Me[Z])?Ae.delete(Z):Ae.add(Z),l.value=Ae,n.value=""}async function A(){if(s.value||!o.value||!l.value.size)return;const Z={};for(const Ee of l.value){const Ae=Number(i.value[Ee]),Me=Ee==="max_published_tools_per_server"?128:256;if(!Number.isInteger(Ae)||Ae<1||Ae>Me){n.value=`Enter a whole number between 1 and ${Me}.`;return}Z[Ee]=Ae}a.value=!0,s.value=!0,n.value="",++E,t.value=!1;try{const Ee=await H.post("/api/mcp/limits",Z);e.value=Ee;for(const Ae of Object.keys(i.value))Number.isInteger(Ee[Ae])&&(i.value[Ae]=String(Ee[Ae]));l.value=new Set,Te.success("MCP limits saved. Applied at the next publication or tools refresh.")}catch(Ee){n.value=Ee.message||"Failed to save MCP publication limits"}finally{a.value=!1,s.value=!1,await K({quiet:!0})}}async function D(Z){if(Z!==T.value&&!(!Z&&!await os({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await H.post("/api/mcp/enabled",{enabled:Z}),Te.success(Z?"MCP enabled":"MCP disabled"),await K({quiet:!0})}catch(Ee){Te.error(Ee.message||"Failed to update MCP state"),await K({quiet:!0})}finally{s.value=!1}}}async function G(Z){V(Z.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(Z.name)}/reconnect`,{}),Te.success(`Reconnected ${Z.name}`)}catch(Ee){Te.error(Ee.message||`Failed to reconnect ${Z.name}`)}finally{V(Z.name,!1),await K({quiet:!0})}}async function pe(Z){V(Z.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(Z.name)}/refresh-tools`,{}),Te.success(`Refreshed tools from ${Z.name}`),await ue(Z.name,!0)}catch(Ee){Te.error(Ee.message||`Failed to refresh ${Z.name}`)}finally{V(Z.name,!1),await K({quiet:!0})}}async function B(Z){if(await os({title:`Remove ${Z.name}`,message:`Remove this saved MCP server? Its ${Z.published_count||0} published tool${Z.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){V(Z.name,!0);try{await H.del(`/api/mcp/servers/${encodeURIComponent(Z.name)}`),Te.success(`Removed ${Z.name}`),delete p.value[Z.name]}catch(Ae){Te.error(Ae.message||`Failed to remove ${Z.name}`)}finally{V(Z.name,!1),await K({quiet:!0})}}}async function Y(Z){const Ee=new Set(d.value);if(Ee.has(Z.name)){Ee.delete(Z.name),d.value=Ee;return}Ee.add(Z.name),d.value=Ee,Object.hasOwn(p.value,Z.name)||await ue(Z.name)}async function ue(Z,Ee=!1){if(!Ee&&Object.hasOwn(p.value,Z))return;const Ae=new Set(h.value);Ae.add(Z),h.value=Ae,m.value={...m.value,[Z]:""};try{const Me=await H.get(`/api/mcp/servers/${encodeURIComponent(Z)}/tools`);p.value={...p.value,[Z]:Me.tools||[]}}catch(Me){m.value={...m.value,[Z]:Me.message||"Failed to load tools"}}finally{const Me=new Set(h.value);Me.delete(Z),h.value=Me}}function j(Z){return(p.value[Z]||[]).filter(Ee=>T1(Ee,u.value[Z]))}function X(Z,Ee){u.value={...u.value,[Z]:Ee}}function ee(){I.value="add",k.value="",y.value=null,g.value=Mc(),x.value="",b.value=!0}function be(Z){I.value="edit",k.value=Z.name,y.value=Z,g.value={...Mc(),name:Z.name,enabled:!!Z.enabled,transport:Z.transport||"stdio"},x.value="",b.value=!0}function he(){S.value||(b.value=!1)}function we(Z){b.value&&A1(Z)}function _e(Z){const Ee=Z==="headers"?"headerRows":"envRows";g.value[Ee].push({key:"",value:""})}function ye(Z,Ee){const Ae=Z==="headers"?"headerRows":"envRows";g.value[Ae].splice(Ee,1)}function Ke(Z,Ee){const Ae=Z==="headers"?"headersRemove":"envRemove",Me=g.value[Ae];g.value[Ae]=Me.includes(Ee)?Me.filter(se=>se!==Ee):[...Me,Ee]}async function Je(){var Ee,Ae;x.value="";let Z;try{Z=k1(g.value,{mode:I.value,originalTransport:((Ee=y.value)==null?void 0:Ee.transport)||""})}catch(Me){x.value=Me instanceof ta?Me.message:"Invalid MCP server configuration",await zt(),(Ae=document.querySelector(".mcp-editor"))==null||Ae.scrollTo({top:0,behavior:"smooth"});return}if(!(I.value==="edit"&&S1(Z,y.value)&&!await os({title:`Change ${k.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){S.value=!0;try{I.value==="add"?await H.post("/api/mcp/servers",Z):await H.put(`/api/mcp/servers/${encodeURIComponent(k.value)}`,Z),Te.success(I.value==="add"?`Saved ${Z.name}`:`Updated ${k.value}`),b.value=!1,await K({quiet:!0})}catch(Me){x.value=Me.message||"Failed to save MCP server"}finally{S.value=!1}}}let Fe=null;function Ge(Z){`${(Z==null?void 0:Z.event)||""} ${(Z==null?void 0:Z.type)||""} ${(Z==null?void 0:Z.tool)||""} ${(Z==null?void 0:Z.message)||""}`.toLowerCase().includes("mcp")&&(Fe&&window.clearTimeout(Fe),Fe=window.setTimeout(()=>K({quiet:!0}),200))}function at(){R||(R=!0,w||(ut.subscribe("events",Ge),w=!0),K(),ce())}function Xe(){R=!1,J(),Fe&&window.clearTimeout(Fe),Fe=null,w&&(ut.unsubscribe("events",Ge),w=!1)}return st(at),rs(at),Kt(Xe),xt(Xe),{status:e,loading:t,mutating:s,pageError:r,servers:U,masterEnabled:T,aggregate:$,limitsSaving:a,limitsError:n,limitsAvailable:o,limitDraft:i,limitDirty:l,editLimit:Ne,saveLimits:A,expandedServers:d,toolQueries:u,toolErrors:m,toolsLoading:h,editorOpen:b,editorMode:I,editingName:k,editingServer:y,form:g,formError:x,saving:S,editorGroups:O,configuredHeaderKeys:te,configuredEnvKeys:W,savedHttpEndpoint:M,endpointRequired:L,endpointFieldLabel:P,endpointPlaceholder:re,refreshAll:K,busy:ae,serverState:ve,stateLabel:Ie,transportLabel:ie,protocolLabel:le,toolSummary:fe,formatAge:O1,setMasterEnabled:D,togglePending:me,toggleServerEnabled:ge,reconnect:G,refreshTools:pe,removeServer:B,toggleTools:Y,filteredTools:j,setToolQuery:X,openAdd:ee,openEdit:be,closeEditor:he,jumpToEditorGroup:we,addSecretRow:_e,removeSecretRow:ye,toggleSecretRemoval:Ke,saveServer:Je}}};function N1(e,t){if(!e||!t)return Tf(e);const s=Tf(e),a=t.trim().split(/\s+/).filter(Boolean);if(!a.length)return s;const n=a.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${n})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const M1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),m=f("success"),h=f(!1),b=f(null),I=f(null);let k=null;const y=f(null),g=f(!1),x=f({}),S=f({}),_=f({}),E=f({}),R=new Map,w=f(null),O=z(()=>e.value.reduce((K,ae)=>K+(ae.chunks||0),0)),U=z(()=>new Set(e.value.map(ae=>ae.uploader).filter(Boolean)).size);function T(K,ae){const V=S.value[ae];if(!V||V.length===0)return 0;const ve=Math.max(...V.map(Ie=>Ie.char_count||0));return ve===0?0:Math.round(K.char_count/ve*100)}async function $(){t.value=!0,s.value=null;try{const K=await H.get("/api/knowledge");e.value=Array.isArray(K)?K:[]}catch(K){s.value=K.message}t.value=!1}async function te(K){if(x.value[K]){x.value[K]=!1,w.value=null;return}if(x.value[K]=!0,Object.prototype.hasOwnProperty.call(S.value,K))return;if(R.has(K))return R.get(K);const ae={...E.value,[K]:!0};E.value=ae;const V={..._.value};delete V[K],_.value=V;const ve=H.get(`/api/knowledge/${encodeURIComponent(K)}/chunks`).then(Ie=>{S.value={...S.value,[K]:Array.isArray(Ie)?Ie:[]}}).catch(Ie=>{_.value={..._.value,[K]:Ie.message||"load failed"}}).finally(()=>{if(R.get(K)!==ve)return;R.delete(K);const Ie={...E.value};delete Ie[K],E.value=Ie});return R.set(K,ve),ve}let W=0;async function M(){const K=a.value.trim();if(!K)return;const ae=++W;i.value=!0,o.value=null,l.value=K;try{const V=await H.get(`/api/knowledge/search?q=${encodeURIComponent(K)}`);if(ae!==W)return;n.value=Array.isArray(V)?V:[]}catch(V){if(ae!==W)return;n.value=[],o.value=V.message||"Search failed"}ae===W&&(i.value=!1)}function L(){W+=1,i.value=!1,n.value=null,a.value="",o.value=null}async function P(){u.value=null,p.value=null,m.value="success";const K=c.value.trim(),ae=d.value.trim();if(!K){u.value="Source name is required";return}if(!ae){u.value="Content is required";return}h.value=!0;try{const V=await H.post("/api/knowledge",{source:K,content:ae}),ve=V.outcome==="duplicate"||V.outcome==="conflict";V.outcome==="unchanged"?(p.value=`Already stored unchanged: "${K}" (${V.chunks} chunks)`,c.value="",d.value=""):ve?(m.value="warning",p.value=V.message||V.status):Number.isInteger(V.chunks)&&V.chunks>0?(p.value=`Ingested ${V.chunks} chunks from "${K}"`,c.value="",d.value=""):(m.value="warning",p.value="Ingestion returned no confirmed stored content; check the source before retrying."),S.value={},await $(),!ve&&m.value==="success"&&setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(V){u.value=V.message}h.value=!1}async function re(K){b.value=K,I.value=null,k&&(clearTimeout(k),k=null);try{const ae=await H.post(`/api/knowledge/${encodeURIComponent(K)}/reingest`),V=ae.outcome==="duplicate"||ae.outcome==="conflict";I.value={source:K,error:!1,warning:V,message:V?ae.message||ae.status:ae.outcome==="unchanged"?`Already stored unchanged (${ae.chunks} chunks)`:`Re-ingested ${ae.chunks||0} chunks`},V||(delete S.value[K],await $()),k=setTimeout(()=>{I.value=null,k=null},3e3)}catch(ae){I.value={source:K,error:!0,message:ae.message}}b.value=null}function ce(K){y.value=K}async function J(){if(y.value){g.value=!0;try{await H.del(`/api/knowledge/${encodeURIComponent(y.value)}`),delete S.value[y.value],await $()}catch(K){Te.error(`Failed to delete source: ${K.message||"unknown error"}`)}g.value=!1,y.value=null}}return st(()=>{$()}),{sources:e,loading:t,error:s,searchQuery:a,searchResults:n,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingestNoticeType:m,ingesting:h,reingesting:b,reingestResult:I,deleteTarget:y,deleting:g,expanded:x,sourceChunks:S,chunkErrors:_,loadingChunks:E,selectedChunk:w,totalChunks:O,uploaderCount:U,truncate:Lu,formatTs:ni,highlightTerms:N1,chunkBarWidth:T,fetchSources:$,toggleSource:te,doSearch:M,clearSearch:L,doIngest:P,doReingest:re,confirmDelete:ce,doDelete:J}}},D1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),a=f(null),n=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),m=f(""),h=f(!1),b=f(null),I=f(null),k=f(new Set),y=f(null),g=f(!1),x=f(!1),S=z(()=>e.value.reduce((K,ae)=>K+ae.count,0)),_=z(()=>k.value.size);function E(K){const ae=t.value[K];if(!ae)return[];if(!l.value.trim())return ae;const V=l.value.trim().toLowerCase();return ae.filter(ve=>ve.key.toLowerCase().includes(V)||ve.value&&ve.value.toLowerCase().includes(V))}function R(K,ae){return k.value.has(K+"/"+ae)}function w(K,ae){const V=K+"/"+ae,ve=new Set(k.value);ve.has(V)?ve.delete(V):ve.add(V),k.value=ve}function O(K){const ae=t.value[K];return!ae||ae.length===0?!1:ae.every(V=>k.value.has(K+"/"+V.key))}function U(K,ae){const V=t.value[K];if(!V)return;const ve=new Set(k.value);for(const Ie of V){const ie=K+"/"+Ie.key;ae?ve.add(ie):ve.delete(ie)}k.value=ve}async function T(){s.value=!0,a.value=null;try{const K=await H.get("/api/memory");e.value=Object.entries(K).map(([ae,V])=>({name:ae,keys:V.keys||[],count:V.count||0}))}catch(K){a.value=K.message}s.value=!1}async function $(K){if(n.value[K]){n.value[K]=!1;return}n.value[K]=!0;const ae=e.value.find(ve=>ve.name===K);if(!ae||t.value[K]||i.value===K)return;i.value=K;let V;try{const Ie=(await H.get(`/api/memory/${encodeURIComponent(K)}`)).entries||{};V=ae.keys.map(ie=>Object.prototype.hasOwnProperty.call(Ie,ie)?{key:ie,value:Ie[ie]||"",failed:!1}:{key:ie,value:"",failed:!0,error:"Not found in scope"})}catch(ve){V=ae.keys.map(Ie=>({key:Ie,value:"",failed:!0,error:ve.message||"Failed to load"}))}t.value[K]=V,i.value=null}function te(K,ae,V){p.value=K+"/"+ae,m.value=V}async function W(K,ae){h.value=!0,b.value=null;try{await H.put(`/api/memory/${encodeURIComponent(K)}/${encodeURIComponent(ae)}`,{value:m.value});const V=t.value[K];if(V){const ve=V.find(Ie=>Ie.key===ae);ve&&(ve.value=m.value)}p.value=null}catch(V){b.value=`Failed to save: ${V.message||"unknown error"}`}h.value=!1}async function M(K,ae){try{await navigator.clipboard.writeText(ae.value),I.value=K+"/"+ae.key,setTimeout(()=>{I.value=null},1500)}catch{}}async function L(){d.value=null,u.value=null;const K=r.value.scope.trim(),ae=r.value.key.trim(),V=r.value.value.trim();if(!K){d.value="Scope is required";return}if(!ae){d.value="Key is required";return}if(!V){d.value="Value is required";return}c.value=!0;try{await H.put(`/api/memory/${encodeURIComponent(K)}/${encodeURIComponent(ae)}`,{value:V}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await T(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ve){d.value=ve.message}c.value=!1}function P(K,ae){y.value={scope:K,key:ae}}async function re(){if(!y.value)return;g.value=!0,b.value=null;const{scope:K,key:ae}=y.value;try{await H.del(`/api/memory/${encodeURIComponent(K)}/${encodeURIComponent(ae)}`);const V=t.value[K];V&&(t.value[K]=V.filter(ie=>ie.key!==ae));const ve=e.value.find(ie=>ie.name===K);ve&&(ve.count--,ve.keys=ve.keys.filter(ie=>ie!==ae));const Ie=new Set(k.value);Ie.delete(K+"/"+ae),k.value=Ie}catch(V){b.value=`Failed to delete: ${V.message||"unknown error"}`}g.value=!1,y.value=null}function ce(){x.value=!0}async function J(){g.value=!0,b.value=null;const K=[];for(const ae of k.value){const V=ae.indexOf("/");K.push({scope:ae.slice(0,V),key:ae.slice(V+1)})}try{await H.post("/api/memory/bulk-delete",{entries:K}),k.value=new Set,t.value={},await T()}catch(ae){b.value=`Bulk delete failed: ${ae.message||"unknown error"}`}g.value=!1,x.value=!1}return st(()=>{T()}),{scopes:e,scopeEntries:t,loading:s,error:a,expanded:n,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:m,saving:h,actionError:b,copied:I,selected:k,selectedCount:_,totalEntries:S,deleteTarget:y,deleting:g,showBulkDelete:x,fetchMemory:T,toggleScope:$,startEdit:te,doEdit:W,copyValue:M,doAdd:L,confirmDelete:P,doDelete:re,confirmBulkDelete:ce,doBulkDelete:J,isSelected:R,toggleSelect:w,isScopeAllSelected:O,toggleSelectAll:U,filteredEntries:E}}},P1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=f([]),t=f(null),s=f(!0),a=f(null),n=f(null),i=f(null),l=f(""),o=f(!1),r=f(!1),c=f(null),d=f(!1),u=z(()=>[...new Set(e.value.map(_=>_.category))].sort()),p=z(()=>{const S={};return e.value.forEach(_=>{S[_.category]=(S[_.category]||0)+1}),S}),m=z(()=>n.value?e.value.filter(S=>S.category===n.value):e.value);function h(S){return S==="correction"?"badge-warning":S==="operational"?"badge-info":S==="preference"?"badge-success":"badge-info"}function b(S){i.value=S.key,l.value=S.content}async function I(S){try{await H.put("/api/learned/"+encodeURIComponent(S),{content:l.value}),i.value=null,Te.success("Entry updated"),await y()}catch(_){Te.error(_.message||"Failed to save entry")}}async function k(S){if(await os({title:"Delete learned entry",message:`Delete "${S}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/learned/"+encodeURIComponent(S)),Te.success("Entry deleted"),await y()}catch(E){Te.error(E.message||"Failed to delete entry")}}async function y(){s.value=!0,a.value=null;try{const S=await H.get("/api/learned");e.value=S.entries||[],t.value={last_reflection:S.last_reflection,count:S.count}}catch(S){a.value=S.message}s.value=!1}async function g(){var S;r.value=!1,c.value=null;try{const _=await H.get("/api/config");o.value=((S=_.learning)==null?void 0:S.enabled)===!0,r.value=!0}catch(_){c.value=_.status===403?"Administrator access is required to change automatic learning.":_.message||"Automatic learning state is unavailable."}}async function x(S){if(!(!r.value||d.value)){d.value=!0,c.value=null;try{if(await H.put("/api/config",{learning:{enabled:S}}),await g(),!r.value)return;Te.success(`Automatic learning ${o.value?"enabled":"disabled"}`)}catch(_){r.value=!1,c.value=_.status===403?"Administrator access is required to change automatic learning.":_.message||"Failed to change automatic learning."}finally{d.value=!1}}}return st(()=>{y(),g()}),{entries:e,meta:t,loading:s,error:a,filterCat:n,editing:i,editContent:l,categories:u,catCounts:p,filtered:m,learningEnabled:o,configReady:r,configError:c,savingConfig:d,catBadge:h,formatTs:ni,startEdit:b,saveEdit:I,deleteEntry:k,fetchEntries:y,fetchLearningConfig:g,setLearningEnabled:x}}},kg=[{id:"tools",label:"Tools",component:g1},{id:"skills",label:"Skills",component:x1},{id:"mcp-servers",label:"MCP Servers",component:L1},{id:"knowledge",label:"Knowledge",component:M1},{id:"memory",label:"Memory",component:D1},{id:"learned",label:"Learned",component:P1}],$1={components:{TabbedPage:Xr},setup(){return{tabs:kg}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},F1={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},B1={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},U1={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},z1={template:`
...
`)}),e.splice(n,1,k)}e.length>s&&e.splice(0,e.length-s)}function Cd(e,t,s=new Date){var u,p;let a=e;if(wn(e)&&e.type==="log"&&"line"in e?a=e.line:wn(e)&&"payload"in e&&(a=e.payload),typeof a=="string")try{a=JSON.parse(a)}catch{}const n=wn(a)?a:null,i=n!=null&&n.timestamp?new Date(n.timestamp):s,l=Number.isNaN(i.getTime())?s:i,o=n?n.result_summary??n.detail??n.message??JSON.stringify(n):typeof a=="string"?a:JSON.stringify(a)??"",c=(n==null?void 0:n.error)||((u=n==null?void 0:n.metadata)==null?void 0:u.error)||(n==null?void 0:n.success)===!1||[n==null?void 0:n.status,(p=n==null?void 0:n.metadata)==null?void 0:p.status].some(m=>["failed","error","cancelled","denied","outcome_unknown"].includes(m))?"ERROR":eo(n==null?void 0:n.level).toUpperCase()||"INFO",d={id:t,record:n,ts:l.toLocaleTimeString(),_time:l,level:c,text:typeof o=="string"?o:JSON.stringify(o),tool:eo(n==null?void 0:n.tool_name),raw:n?null:o,attribution:W1(n)};return d.searchText=n?JSON.stringify(n):d.text,d}function J1(e){const t=new Map;for(const s of e){const{turnId:a,agentId:n,rootId:i,label:l,parentId:o}=s.attribution,r=a?`turn:${a}`:n?`root:${i||n}`:"unattributed";t.has(r)||t.set(r,{key:r,title:a?`Turn ${a}`:n?`Agent root ${i||n} (turn unavailable)`:"Unattributed / legacy records",count:0,sections:[],_sections:new Map});const c=t.get(r),d=n?`agent:${n}`:"main";if(!c._sections.has(d)){const u={key:d,agentId:n,label:l,parentId:o,rootId:i,title:n?`${l||"Agent"} (${n})`:"Main thread / turn events",entries:[]};c._sections.set(d,u),c.sections.push(u)}c._sections.get(d).entries.push(s),c.count++}return[...t.values()].map(({_sections:s,...a})=>a)}const Z1={components:{ToolOutput:ec},props:{entry:{type:Object,required:!0}},emits:["copy"],setup(e){const t=z(()=>G1(e.entry)),s=z(()=>{var o;return Xl(((o=e.entry.record)==null?void 0:o.tool_input)??"")}),a=z(()=>{var o,r,c;return Xl(((o=e.entry.record)==null?void 0:o.error)||((c=(r=e.entry.record)==null?void 0:r.metadata)==null?void 0:c.error)||"")}),n=z(()=>q1(e.entry.record)),i=z(()=>Sg(e.entry)),l=z(()=>(e.entry.events||[e.entry.record]).filter(Boolean).map(o=>{var r;return{type:o.type||"execution",timestamp:o.timestamp||"Time not recorded",status:o.status||((r=o.metadata)==null?void 0:r.status)||""}}));return{display:t,argumentsText:s,errorText:a,metadataText:n,rawRecord:i,lifecycle:l}},template:`
    ...
    </div>`,setup(){const e=f("live"),t=f([]);let s=0;const a=f(!1),n=f(!1),i=f(!0),l=f(""),o=f(""),r=f(!1),c=f(!1),d=f(ut.state||"disconnected"),u=z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),p=f(null),m=f(!1),h=f(null),b=2e3,I=Y1,k=Q1,y=Dc,g=f("all"),x=f(""),S=f(!1),_=f([]),E=f(!1),R=f(""),w=f([]);function O(){try{const oe=localStorage.getItem("odin-log-presets");oe&&(_.value=JSON.parse(oe))}catch{}}function U(){try{localStorage.setItem("odin-log-presets",JSON.stringify(_.value))}catch{}}const T=z(()=>l.value!==""||o.value.trim()!==""||x.value!==""||S.value),$=z(()=>{const oe=Dc.find(ke=>ke.value===x.value);return oe?oe.label:""}),te=z(()=>{if(!r.value||!o.value)return null;try{return new RegExp(o.value,"i"),null}catch(oe){return oe.message}}),W=24,M=z(()=>{if(ae.value.length===0)return[];const oe=[],ke=new Date,je=3600*1e3;for(let Ve=W-1;Ve>=0;Ve--){const kt=new Date(ke.getTime()-(Ve+1)*je),St=new Date(ke.getTime()-Ve*je);oe.push({start:kt,end:St,label:ce(kt,St),shortLabel:St.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Ve of ae.value){if(!Ve._time)continue;const kt=Ve._time.getTime();for(const St of oe)if(kt>=St.start.getTime()&&kt<St.end.getTime()){St.total++,Ve.level==="ERROR"?St.errors++:Ve.level==="WARNING"?St.warnings++:St.info++;break}}return oe}),L=z(()=>{let oe=1;for(const ke of M.value)ke.total>oe&&(oe=ke.total);return oe}),P=z(()=>{if(M.value.length===0)return"";const oe=ae.value.map(Ve=>Ve._time&&Ve._time.getTime()).filter(Boolean);if(oe.length===0)return"";const ke=new Date(Math.min(...oe));return`${ae.value.length} shown, oldest ${ke.toLocaleTimeString()}`}),re=z(()=>Math.ceil(W/8));function ce(oe,ke){const je={hour:"2-digit",minute:"2-digit"};return oe.toLocaleTimeString([],je)+" - "+ke.toLocaleTimeString([],je)}function J(oe,ke){return!ke||!oe?"0px":Math.max(2,oe/ke*100)+"%"}function K(oe){const ke=ae.value.findIndex(je=>je._time&&je._time.getTime()>=oe.start.getTime()&&je._time.getTime()<oe.end.getTime());if(ke>=0&&p.value){const je=p.value.querySelector('[data-log-id="'+ae.value[ke].id+'"]');je&&(je.scrollIntoView({behavior:"smooth",block:"center"}),i.value=!1)}}const ae=z(()=>{let oe=t.value;if(S.value&&(oe=oe.filter(ke=>!!ke.tool)),l.value)if(l.value===Df){const ke={INFO:0,WARNING:1,ERROR:2};oe=oe.filter(je=>ke[je.level||"INFO"]>=ke.WARNING)}else oe=oe.filter(ke=>(ke.level||"INFO")===l.value);if(x.value){const ke=Dc.find(je=>je.value===x.value);if(ke&&ke.seconds){const je=new Date(Date.now()-ke.seconds*1e3);oe=oe.filter(Ve=>Ve._time&&Ve._time>=je)}}if(o.value&&!te.value)if(r.value)try{const ke=new RegExp(o.value,"i");oe=oe.filter(je=>{const Ve=je.searchText,kt=je.tool||"";return ke.test(Ve)||ke.test(kt)})}catch{}else{const ke=o.value.toLowerCase();oe=oe.filter(je=>{const Ve=je.searchText.toLowerCase(),kt=(je.tool||"").toLowerCase();return Ve.includes(ke)||kt.includes(ke)})}return oe}),V=z(()=>J1(ae.value));function ve(oe){const ke=Cd(oe,++s);if(n.value){w.value.push(ke);return}Ie(ke)}function Ie(oe){K1(t.value,oe,b),i.value&&zt(()=>ie())}function ie(oe=!1){const ke=p.value;ke&&ke.scrollTo({top:ke.scrollHeight,behavior:oe?"smooth":"instant"})}function le(){i.value=!0,m.value=!1,zt(()=>ie(!0))}const fe=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function me(){const oe=p.value;if(!oe)return;const ke=oe.scrollHeight-oe.scrollTop-oe.clientHeight<40;m.value=!i.value&&!ke&&t.value.length>0,D.value&&ge()}function ge(){const oe=p.value;!oe||!i.value||oe.scrollHeight-oe.scrollTop-oe.clientHeight>=40&&(i.value=!1,m.value=t.value.length>0)}function Ne(){i.value&&requestAnimationFrame(ge)}function A(oe){fe.has(oe.key)&&Ne()}const D=f(!1);function G(){i.value&&(D.value=!0,requestAnimationFrame(ge))}function pe(){D.value&&(D.value=!1,ge())}function B(){i.value&&(m.value=!1,zt(()=>ie()))}function Y(){if(n.value=!n.value,!n.value&&w.value.length>0){for(const oe of w.value)Ie(oe);w.value=[]}}function ue(){t.value=[],w.value=[],m.value=!1}function j(){let oe;e.value==="search"?oe=rt.value.map(kt=>{const St=kt.error?"ERROR":"INFO",cn=kt.tool_name?`[${kt.tool_name}] `:"";return`${kt.timestamp||""} ${St} ${cn}${kt.result_summary||kt.message||""}`}).join(`
`):oe=ae.value.map(Nf).join(`

`);const ke=new Blob([oe],{type:"text/plain"}),je=URL.createObjectURL(ke),Ve=document.createElement("a");Ve.href=je,Ve.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ve.click(),URL.revokeObjectURL(je)}function X(oe){const ke=Nf(oe);navigator.clipboard.writeText(ke).then(()=>{h.value=oe.id,setTimeout(()=>{h.value=null},1500)}).catch(()=>{})}function ee(oe){l.value=l.value===oe?"":oe,g.value="all",S.value=!1}function be(oe){return oe.level==="ERROR"?"log-line-error":oe.level==="WARNING"?"log-line-warning":"text-gray-300"}function he(oe){return oe==="ERROR"?"text-red-500 font-semibold":oe==="WARNING"?"text-yellow-500":"text-blue-500"}function we(oe){return oe==="ERROR"?"log-chip-error":oe==="WARNING"?"log-chip-warning":"log-chip-info"}function _e(oe){g.value=oe.id;const ke=oe.filters;l.value=ke.level||"",x.value=ke.timeRange||"",o.value=ke.text||"",S.value=!!ke.hasToolName,ke.levels&&(l.value=ke.levels.includes("WARNING")&&ke.levels.includes("ERROR")?Df:ke.levels[0]||"")}function ye(oe){g.value=oe.id,l.value=oe.filters.level||"",x.value=oe.filters.timeRange||"",o.value=oe.filters.text||"",S.value=!!oe.filters.hasToolName}function Ke(){if(!R.value.trim())return;const oe={id:"custom-"+Date.now(),name:R.value.trim(),filters:{level:l.value,timeRange:x.value,text:o.value,hasToolName:S.value||void 0}};_.value=[..._.value,oe],U(),E.value=!1,R.value=""}function Je(oe){_.value=_.value.filter(ke=>ke.id!==oe),U(),g.value===oe&&(g.value="all",x.value="",S.value=!1,l.value="",o.value="")}const Fe=f("all"),Ge=f(""),at=f(""),Xe=f(""),Z=f(""),Ee=f(""),Ae=f(100),Me=X1,se=f(!1),Le=f(!1),ze=f(""),rt=f([]),Zt=f(null),lt=f(null);function gt(){e.value="search",Zt.value||Yt()}async function Yt(){try{Zt.value=await H.get("/api/logs/stats")}catch{}}function cs(){const oe=Ee.value;if(!oe){Xe.value="",Z.value="";return}const je={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[oe];if(je){const Ve=new Date(Date.now()-je*1e3);Xe.value=oa(Ve),Z.value=""}}function oa(oe){const ke=je=>String(je).padStart(2,"0");return`${oe.getFullYear()}-${ke(oe.getMonth()+1)}-${ke(oe.getDate())}T${ke(oe.getHours())}:${ke(oe.getMinutes())}`}function js(oe){if(!oe)return"";const ke=new Date(oe);return isNaN(ke.getTime())?"":ke.toISOString()}let Ze=0;async function ra(){if(se.value)return;const oe=++Ze;se.value=!0,ze.value="",Le.value=!0,lt.value=null;try{const ke=new URLSearchParams;Fe.value&&Fe.value!=="all"&&ke.set("level",Fe.value),Ge.value&&ke.set("tool",Ge.value),at.value&&ke.set("q",at.value);const je=js(Xe.value),Ve=js(Z.value);je&&ke.set("start",je),Ve&&ke.set("end",Ve),ke.set("limit",String(Ae.value));const kt=await H.get(`/api/logs/search?${ke.toString()}`);if(oe!==Ze)return;rt.value=kt.entries||[]}catch(ke){if(oe!==Ze)return;ze.value=ke.message||"Search failed",rt.value=[]}finally{oe===Ze&&(se.value=!1)}}function vs(){Ze++,Fe.value="all",Ge.value="",at.value="",Xe.value="",Z.value="",Ee.value="",Ae.value=100,rt.value=[],Le.value=!1,ze.value="",lt.value=null,se.value=!1}function Ms(oe){lt.value=lt.value===oe?null:oe}function gs(oe){if(!oe.timestamp)return"";try{return new Date(oe.timestamp).toLocaleString()}catch{return oe.timestamp}}function En(oe){return oe.type==="web_action"?`${oe.status||""} (${oe.execution_time_ms||0}ms)`:(oe.result_summary||"").slice(0,200)}function Qt(oe){return oe.error?"log-line-error":"text-gray-300"}function _t(oe){try{return JSON.stringify(oe,null,2)}catch{return String(oe)}}let ds=null,ba=!1;function rn(){ba||(ba=!0,ut.subscribe("logs",ve),c.value=ut.connected,d.value=ut.state||"disconnected",ds=ut.onState(oe=>{d.value=oe,c.value=oe==="connected"}))}function ca(){ba&&(ba=!1,ut.unsubscribe("logs",ve),ds&&(ds(),ds=null))}return st(()=>{O(),window.addEventListener("pointerup",pe),window.addEventListener("pointercancel",pe)}),rs(rn),Kt(ca),xt(()=>{ca(),window.removeEventListener("pointerup",pe),window.removeEventListener("pointercancel",pe)}),{mode:e,logs:t,paused:n,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:a,groupedLogs:V,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:ae,pauseBuffer:w,showJumpBottom:m,copiedIndex:h,regexError:te,levels:I,logPresets:k,timeRanges:y,timeRange:x,toolOnly:S,activeLogPreset:g,customLogPresets:_,showSaveLogPreset:E,newLogPresetName:R,hasActiveLogFilters:T,timeRangeLabel:$,timelineBuckets:M,timelineMax:L,timelineSpanLabel:P,timelineLabelSkip:re,togglePause:Y,clearLogs:ue,exportLogs:j,logLineClass:be,levelClass:he,levelChipClass:we,toggleLevel:ee,copyLine:X,jumpToBottom:le,onScroll:me,onUserScrollIntent:Ne,onUserScrollKey:A,onAutoScrollToggle:B,onPointerDown:G,applyLogPreset:_e,applyCustomLogPreset:ye,saveLogCustomPreset:Ke,removeLogCustomPreset:Je,segmentHeight:J,jumpToTimelineBucket:K,searchLevel:Fe,searchTool:Ge,searchKeyword:at,searchStart:Xe,searchEnd:Z,searchTimePreset:Ee,searchLimit:Ae,searchLimits:Me,searching:se,searchRan:Le,searchError:ze,searchResults:rt,searchStats:Zt,expandedSearch:lt,switchToSearch:gt,runSearch:ra,clearSearchFilters:vs,toggleSearchExpand:Ms,formatSearchTs:gs,searchEntryText:En,searchLogLineClass:Qt,formatJson:_t,applySearchTimePreset:cs}}};function Lo(e=[]){const t=[],s=new Set;function a(n){const i=[n.kind,n.label,n.apply_mode||"",n.code||"",n.text||""].join("\0");s.has(i)||(s.add(i),t.push({...n,key:i}))}for(const n of e)for(const i of(n==null?void 0:n.consumers)||[])a({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const n of e)n!=null&&n.apply_handler&&a({kind:"handler",label:"Apply handler",code:n.apply_handler});for(const n of e)n!=null&&n.restart_reason&&a({kind:"restart",label:"Why a restart is required",text:n.restart_reason});for(const n of e)n!=null&&n.activation_policy&&a({kind:"activation",label:"Activation policy",text:n.activation_policy});return t}const tC=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function sC(e,t={}){var n,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),a=Object.hasOwn(t,"fallback")?t.fallback:(n=globalThis.document)==null?void 0:n.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return a&&a.scrollHeight>a.clientHeight?a:e||a||null}const $i=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["grafana_alerts","outbound_webhooks"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],aC={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},No=new Set(["llm_provider","openai_codex","ollama","openai_compatible","kimi","personality","discord","computer"]),nC=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Pf(e){return nC.some(t=>e===t||e.startsWith(`${t}.`))}const Cg="odin_config_center_expanded_v1",Tg="odin_config_center_category_v1",iC=50,lC=650,ml=()=>H.get("/api/config/meta");function Un(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ei(e,t){return JSON.stringify(e)===JSON.stringify(t)}function bi(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function oC(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function rC(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Eg(e,t){if(Ei(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Un(t);const a={};for(const[n,i]of Object.entries(t)){const l=Eg(e[n],i);l!==void 0&&(a[n]=l)}return Object.keys(a).length?a:void 0}function cC(e,t){const s={};for(const[a,n]of Object.entries(t||{})){const i=Eg(e==null?void 0:e[a],n);i!==void 0&&(s[a]=i)}return s}function Ag(e,t,s,a){if(Ei(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Ag(e[l],t[l],s?`${s}.${l}`:l,a);return}a.push({path:s,oldVal:e,newVal:t})}function dC(){try{const e=JSON.parse(localStorage.getItem(Cg)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function uC(){try{const e=localStorage.getItem(Tg);return $i.some(t=>t.key===e)?e:$i[0].key}catch{return $i[0].key}}const pC={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),a=f(null),n=f(!1),i=f(null),l=f(!1),o=f(""),r=f(!1),c=f(""),d=f(""),u=f("");function p(C){i.value=C||null,C&&typeof C.authorized=="boolean"&&(l.value=C.authorized)}async function m(){try{const C=await H.get("/api/setup/status");p(C.listener),u.value=""}catch(C){p(null),u.value=`Listener status could not be loaded: ${C.message||"Unknown error"}`}}async function h(){if(!(!pe.value||!o.value.trim()||r.value||G.value)){r.value=!0,c.value="",d.value="";try{const C=H.setListenerExposure(o.value.trim(),l.value);o.value="";const q=await C;c.value=q.message,p(q.listener)}catch(C){d.value=C.message||"Listener consent could not be saved."}finally{o.value="",r.value=!1}}}const b=f(null),I=["image_model","outer_model"],k=f(null),y=f(null),g=f(null),x=f(!1),S=f(!1),_=f(null),E=f(""),R=f("all"),w=f(uC()),O=f(dC()),U=f({}),T=f({}),$=f(""),te=f({}),W=f({}),M=f([]),L=f([]),P=f(!1),re=f(!1),ce=f(!1);let J=null,K=null,ae={path:null,at:0},V=0;const ve=z(()=>{var C;return(((C=t.value)==null?void 0:C.fields)||[]).filter(q=>!No.has(q.path.split(".")[0])&&!Pf(q.path))}),Ie=z(()=>new Map(ve.value.map(C=>[C.path,C]))),ie=z(()=>Ne.value.reduce((C,q)=>C+q.sections.length,0)),le=z(()=>ve.value.length),fe=z(()=>tC),me=z(()=>M.value.length>0),ge=z(()=>L.value.length>0),Ne=z(()=>{if(!e.value)return[];const C=new Set($i.flatMap(Se=>Se.sections)),q=$i.map(Se=>({...Se,sections:Se.sections.filter(We=>Object.hasOwn(e.value,We)&&!No.has(We))})).filter(Se=>Se.sections.length),ne=Object.keys(e.value).filter(Se=>!C.has(Se)&&!No.has(Se));return ne.length&&q.push({key:"other",label:"Other",icon:"folder",sections:ne}),q}),A=z(()=>e.value?{...e.value,...U.value}:null),D=z(()=>{if(!e.value)return[];const C=[];for(const[q,ne]of Object.entries(U.value))Ag(e.value[q],ne,q,C);return C.filter(q=>!Ei(q.oldVal,q.newVal)).map(q=>{const ne=at(q.path);return{...q,label:(ne==null?void 0:ne.label)||bi(q.path.split(".").at(-1)),apply_mode:(ne==null?void 0:ne.apply_mode)||Le(q.path.split(".")[0])}})}),G=z(()=>D.value.length>0),pe=z(()=>!!i.value&&l.value!==i.value.authorized),B=z(()=>{var q;const C=(q=i.value)==null?void 0:q.state;return C==="active"||C==="authorized_loopback"?"active":["pending_widening","pending_narrowing","active_rebind_pending"].includes(C)?"pending":C==="restricted"?"restricted":"unknown"}),Y=z(()=>{var C;return{active:"Exposure active",authorized_loopback:"Authorized · loopback host",pending_widening:"Authorized · restart pending",pending_narrowing:"Restriction saved · restart pending",active_rebind_pending:"Exposed · restart pending",restricted:"Loopback only",unknown:"Runtime state unavailable"}[(C=i.value)==null?void 0:C.state]||"Loading listener state"}),ue=z(()=>i.value?i.value.authorized?i.value.authorization_source==="explicit"?"Beyond-loopback access is explicitly authorized":"Beyond-loopback access is retained from this installation":"Beyond-loopback access is not authorized":"Unavailable"),j=z(()=>{var C;return{explicit:"saved explicitly in config.yml",default:"schema default; no web.host key is saved",unknown:"source could not be verified"}[(C=i.value)==null?void 0:C.configured_host_source]||"source unavailable"}),X=z(()=>{const C=i.value;return!C||C.running_scope==="unavailable"?"Actual bound address unavailable":`${(C.listening_hosts||[]).map((ne,Se)=>{var Ct;const We=(Ct=C.listening_ports)==null?void 0:Ct[Se];return We?`${ne}:${We}`:ne}).join(", ")} · ${C.running_scope==="loopback"?"loopback only":"accepting beyond loopback"}`}),ee=z(()=>D.value.length),be=z(()=>new Set(D.value.map(C=>C.path.split(".")[0])).size),he=z(()=>!!E.value||R.value!=="all"),we=z(()=>{const C={...W.value};for(const q of D.value){const ne=at(q.path),Se=de(ne,q.newVal);Se&&(C[q.path]=Se)}return C}),_e=z(()=>Object.keys(we.value).length>0),ye=z(()=>e.value?(he.value?Ne.value:Ne.value.filter(q=>q.key===w.value)).map(q=>({...q,sections:q.sections.filter(ne=>Qt(ne))})).filter(q=>q.sections.length):[]),Ke=z(()=>{const C=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],q=new Map(C.map(ne=>[ne,[]]));for(const ne of D.value){const Se=q.has(ne.apply_mode)?ne.apply_mode:"restart";q.get(Se).push(ne)}return C.filter(ne=>q.get(ne).length).map(ne=>({key:ne,label:bs(ne),entries:q.get(ne)}))}),Je=z(()=>D.value.filter(C=>C.apply_mode==="restart").length),Fe=z(()=>ve.value.filter(C=>C.pending_restart)),Ge=z(()=>Fe.value.length);function at(C){const q=Ie.value.get(C);return q?{...q,apply_details:Lo([q])}:null}function Xe(C){const q=`${C}.`;return ve.value.filter(ne=>ne.path===C||ne.path.startsWith(q))}function Z(){return ve.value.some(C=>C.path==="tools.hosts"||C.path.startsWith("tools.hosts."))}function Ee(){var ne,Se;const C=((Se=(ne=e.value)==null?void 0:ne.tools)==null?void 0:Se.hosts)||{},q=Object.keys(C).length;return`${q} host${q===1?"":"s"} configured.`}function Ae(C){return Xe(C).length}function Me(C){return bi(C)}function se(C){const q=Xe(C);if(!q.length)return`${bi(C)} configuration.`;const ne=q.find(Ct=>Ct.sensitivity==="public"&&Ct.description)||q.find(Ct=>Ct.description),Se=(ne==null?void 0:ne.description)||"";return Se.match(/setting for (.+)\.$/i)?`${bi(C)} settings and runtime behaviour.`:Se}function Le(C){const q=[...new Set(Xe(C).map(ne=>ne.apply_mode))];return q.length===1?q[0]:q.includes("restart")?"restart":q.includes("activation_required")?"activation_required":q[0]||"restart"}function ze(C){const q=[...new Set(Xe(C).map(ne=>bs(ne.apply_mode)))];return q.length?q.length===1?q[0]:`Mixed apply behaviour: ${q.join(" · ")}`:""}function rt(C){return Lo(Xe(C))}function Zt(C){var q;return Object.hasOwn(U.value,C)?U.value[C]:(q=e.value)==null?void 0:q[C]}function lt(){const C=Zt("mcp")||{},q=Object.keys(C.servers||{}).length;return`${C.enabled?"Globally enabled":"Globally disabled"} · ${q} configured server${q===1?"":"s"}.`}function gt(C,q){return q.split(".").reduce((ne,Se)=>ne==null?void 0:ne[Se],C)}function Yt(C){const q=A.value;return Xe(C).filter(ne=>Pf(ne.path)?!1:ne.path.split(".").length<=2?!0:!ne.path.includes(".*")).map(ne=>({...ne,key:ne.path.split(".").at(-1),value:gt(q,ne.path),apply_details:Lo([ne]),editor:ne.path==="agents.final_warning_iterations"?"warning-chips":null}))}function cs(C){const q=C.path.split(".");return q.length>2?q.slice(0,2).join("."):null}function oa(C){const q=new Map;for(const ne of Yt(C)){const Se=cs(ne),We=Se||`${C}.__root`;q.has(We)||q.set(We,{key:We,path:Se,entries:[]}),q.get(We).entries.push(ne)}return[...q.values()].map(ne=>{const Se=ne.entries.find(We=>We.group_description);return{...ne,label:ne.path?bi(ne.path.split(".").at(-1)):null,description:(Se==null?void 0:Se.group_description)||null,apply_details:Lo(ne.entries),runtime_summaries:Ze(ne.entries)}})}function js(C){return{save:C.save_effect||(C.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:C.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[C.apply_mode]||"Effective runtime state is not currently observable."}}function Ze(C){const q=new Map;for(const ne of C){const Se=js(ne),We=`${ne.apply_mode}|${Se.save}|${Se.runtime}`;q.has(We)||q.set(We,{key:We,label:bs(ne.apply_mode),save:Se.save,runtime:Se.runtime})}return[...q.values()]}function ra(C){if(vs(C))return C.runtime_effect||C.activation_policy||"";if(C.apply_mode==="activation_required"){const q=C.activation_policy||C.runtime_effect;return q?`Not active after saving. No activation control exists in this release. ${q}`:"Not active after saving; no activation control exists in this release."}return""}function vs(C){return C.action_available===!0&&!!(C.action_label&&C.action_endpoint)}async function Ms(C){if(vs(C))try{if(ca(C.path))throw new Error("Save this setting before applying its action.");const q=String(C.action_method||"POST").toLowerCase(),ne={post:H.post.bind(H),put:H.put.bind(H),delete:H.del.bind(H)}[q];if(!ne)throw new Error("Unsupported configuration action");await ne(C.action_endpoint,C.action_body||void 0),await Xi(),Ma("success",`${C.action_label} completed.`)}catch(q){Ma("error",q.message||`${C.action_label} failed`)}}function gs(C,q){return[C.label,C.path,C.description,...C.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(q)}function En(C){const q=E.value.trim().toLowerCase();return q?Xe(C).filter(ne=>gs(ne,q)):[]}function Qt(C){const q=Xe(C);if(R.value!=="all"&&!q.some(Se=>Se.apply_state===R.value))return!1;const ne=E.value.trim().toLowerCase();return!ne||`${Me(C)} ${C}`.toLowerCase().includes(ne)?!0:q.some(Se=>gs(Se,ne))}function _t(C,q){return Xe(C).filter(ne=>ne.apply_state===q).length}function ds(C){return C==="all"?le.value:ve.value.filter(q=>q.apply_state===C).length}function ba(C){const q=C.sections.flatMap(ne=>Xe(ne));return{fields:q.length,modified:D.value.filter(ne=>C.sections.includes(ne.path.split(".")[0])).length,pending_restart:q.filter(ne=>ne.apply_state==="pending_restart").length,invalid:q.filter(ne=>ne.apply_state==="invalid").length,dormant:q.filter(ne=>ne.apply_state==="dormant").length}}function rn(C){var q;return Object.hasOwn(U.value,C)&&!Ei((q=e.value)==null?void 0:q[C],U.value[C])}function ca(C){return D.value.some(q=>q.path===C||q.path.startsWith(`${C}.`))}function oe(C){w.value=C,E.value="",R.value="all";try{localStorage.setItem(Tg,C)}catch{}}function ke(C){R.value=C}function je(){E.value="",R.value="all"}function Ve(C){var q;return((q=Ne.value.find(ne=>ne.sections.includes(C)))==null?void 0:q.sections)||[]}function kt(C){const q=Ve(C),ne=q.find(Se=>O.value[Se]===!0);return ne||q.find(Se=>O.value[Se]!==!1)||null}function St(C){return E.value&&!ce.value&&Qt(C)?!0:ce.value?kt(C)===C:Object.hasOwn(O.value,C)?O.value[C]===!0:!0}function cn(C){const q=!St(C);if(ce.value){const ne={...O.value};for(const Se of Ve(C))ne[Se]===!0&&(ne[Se]=!1);ne[C]=q,O.value=ne;return}O.value={...O.value,[C]:q}}function An(){M.value.push(Un(U.value)),M.value.length>iC&&M.value.shift(),L.value=[]}function dn(){n.value||G.value&&(An(),U.value={},W.value={},P.value=!1)}function Rn(C,q=!1){const ne=Date.now();if(q&&ae.path===C&&ne-ae.at<lC){ae.at=ne;return}An(),ae={path:C,at:ne}}function da(C,q,ne){if(!q.length)return ne;const Se=Un(C??{});let We=Se;for(let Ct=0;Ct<q.length-1;Ct+=1){const Vs=q[Ct];We[Vs]=Un(We[Vs]??{}),We=We[Vs]}return We[q.at(-1)]=ne,Se}function ya(C){var q;return Object.hasOwn(U.value,C)?U.value[C]:Un((q=e.value)==null?void 0:q[C])}function jt(C,q,ne={}){var pn;if(n.value||No.has(C.path.split(".")[0]))return;const[Se,...We]=C.path.split(".");Rn(C.path,!!ne.coalesce);const Ct=ya(Se),Vs=We.length?da(Ct,We,q):q,qs={...U.value};if(Ei(Vs,(pn=e.value)==null?void 0:pn[Se])?delete qs[Se]:qs[Se]=Vs,U.value=qs,W.value[C.path]){const xa={...W.value};delete xa[C.path],W.value=xa}}function ua(C){ae={path:null,at:0},T.value={...T.value,[C]:String(gt(A.value,C)??"")}}function as(C){if(ae={path:null,at:0},!Object.hasOwn(T.value,C))return;const q={...T.value};delete q[C],T.value=q}function un(C){const q=T.value[C.path];if(ae={path:null,at:0},q===""){if(C.nullable){as(C.path),jt(C,null,{coalesce:!0});return}W.value={...W.value,[C.path]:"Enter a number."};return}const ne=Number(q);if(Number.isNaN(ne)||C.type==="integer"&&!Number.isInteger(ne)){W.value={...W.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Se={...T.value};delete Se[C.path],T.value=Se,jt(C,ne,{coalesce:!0})}function In(C){return Object.hasOwn(T.value,C.path)?T.value[C.path]:C.value??""}function li(C,q){if(T.value={...T.value,[C.path]:q},q===""){if(C.nullable){jt(C,null,{coalesce:!0});return}W.value={...W.value,[C.path]:"Enter a number."};return}const ne=Number(q);if(!Number.isFinite(ne)||C.type==="integer"&&!Number.isInteger(ne)){W.value={...W.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(W.value[C.path]){const Se={...W.value};delete Se[C.path],W.value=Se}jt(C,ne,{coalesce:!0})}function oi(C){const q=Number.parseInt($.value,10);if(!Number.isInteger(q)||q<1){W.value={...W.value,[C.path]:"Warning thresholds must be positive whole numbers."};return}const ne=[...new Set([...C.value||[],q])].sort((Se,We)=>We-Se);$.value="",jt(C,ne)}function ri(C,q){jt(C,(C.value||[]).filter(ne=>ne!==q))}function ns(C){return C.apply_mode==="live_read"?"Odin reads the saved file value on next use.":C.apply_mode==="live_for_new_work"?"New work uses the saved file value.":C.apply_mode==="live_apply"?C.apply_handler?`Apply the saved value through ${C.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":C.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":C.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":C.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function On(C){return C.type==="array"&&Array.isArray(C.value)&&!C.structured_container&&!C.structured_container_child&&C.sensitivity==="public"&&C.value.every(q=>["string","number","boolean"].includes(typeof q))}function Re(C){const q=String(te.value[C.path]??"").trim();if(!q)return;const ne=[...new Set([...C.value||[],q])];te.value={...te.value,[C.path]:""},jt(C,ne)}function N(C,q){jt(C,(C.value||[]).filter(ne=>ne!==q))}function de(C,q){var Se;if(!C)return null;if((Se=C.enum)!=null&&Se.length&&!C.enum.includes(q))return`Choose one of: ${C.enum.join(", ")}`;if(C.path==="agents.final_warning_iterations"&&(!Array.isArray(q)||!q.length))return"Add at least one warning threshold.";const ne=C.constraints||{};if((C.type==="integer"||C.type==="number")&&typeof q=="number"){if(ne.minimum!==void 0&&q<ne.minimum)return`Must be at least ${ne.minimum}${C.unit?` ${C.unit}`:""}`;if(ne.maximum!==void 0&&q>ne.maximum)return`Must be at most ${ne.maximum}${C.unit?` ${C.unit}`:""}`}return null}function xe(C){return we.value[C.path]||null}function Be(C){const q=`${C}.`;return Object.keys(we.value).some(ne=>ne===C||ne.startsWith(q))}function qe(){n.value||M.value.length&&(L.value.push(Un(U.value)),U.value=M.value.pop(),W.value={},T.value={},ae={path:null,at:0})}function Qe(){n.value||L.value.length&&(M.value.push(Un(U.value)),U.value=L.value.pop(),W.value={},T.value={},ae={path:null,at:0})}function Et(){!G.value||_e.value||(P.value=!0,re.value=!1)}function pt(){P.value=!1}function At(){dn()}function bs(C){return aC[C]||bi(C||"unknown")}function Nt(C){return`apply-${String(C||"unknown").replaceAll("_","-")}`}function Na(C){return`cfgc-field-${C.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function ci(C){return`${Na(C)}-input`}function mo(C){const q=document.getElementById(Na(C))||document.getElementById(Na(C.split(".").slice(0,2).join(".")));q==null||q.scrollIntoView({behavior:"smooth",block:"center"})}function Ma(C,q){y.value={type:C,message:q},window.setTimeout(()=>{var ne;((ne=y.value)==null?void 0:ne.message)===q&&(y.value=null)},3500)}function ac(){x.value=!1,R.value="pending_restart",E.value="";const C=sC(a.value);C&&(C.scrollTop=0)}function ho(){x.value=!1}function di(C=1800){K&&window.clearTimeout(K),K=window.setTimeout(nc,C)}async function nc(){if(S.value){if(V+=1,V>45){S.value=!1,_.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await ml(),Ge.value===0){S.value=!1,_.value=null,Ma("success","Odin restarted and the saved startup settings are active.");return}}catch{}di(2e3)}}async function Ln(){if(!S.value){_.value=null;try{await H.post("/api/restart",{}),S.value=!0,V=0,x.value=!1,di()}catch(C){_.value=C.message||"Odin could not schedule a restart."}}}async function ic(){if(!(!G.value||_e.value||n.value)){n.value=!0;try{const C=cC(e.value,U.value),q=await H.put("/api/config",C);e.value=q,U.value={},M.value=[],L.value=[],W.value={},P.value=!1;try{t.value=await ml(),g.value=null,x.value=Ge.value>0,Ma("success",Ge.value?`Configuration saved. ${Ge.value} setting${Ge.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(ne){g.value=ne.message||"Unknown metadata error.",Ma("error",`Configuration saved, but apply status could not be refreshed: ${g.value}`)}}catch(C){Ma("error",C.message||"Configuration could not be saved")}finally{n.value=!1}}}async function Da(){if(!n.value){n.value=!0,b.value=null;try{t.value=await ml(),g.value=null}catch(C){b.value=`Image model status could not be refreshed: ${C.message||"Unknown error"}`}finally{n.value=!1}}}async function lc(C,q){if(n.value||!["follow","pin"].includes(q)||!C.length||C.some(Se=>{var We,Ct;return!I.includes(Se)||!((Ct=(We=t.value)==null?void 0:We.image_model_defaults)!=null&&Ct[Se])}))return;n.value=!0,b.value=null;let ne=!1;try{const Se=await H.post("/api/config/image-models",{operations:Object.fromEntries(C.map(We=>[We,q])),expected_revision:t.value.image_model_revision});ne=!0;for(const We of C){const Ct=`image.openai.${We}`,Vs=gt(e.value,Ct),qs=gt(Se.config,Ct),pn=xa=>!Object.hasOwn(xa,"image")||!Ei(gt(xa,Ct),Vs)?xa:da(xa,Ct.split("."),qs);U.value=pn(U.value),M.value=M.value.map(pn),L.value=L.value.map(pn),e.value=da(e.value,Ct.split("."),qs)}t.value={...t.value,image_model_defaults:Se.image_model_defaults,image_model_revision:Se.image_model_revision},Ma("success","Image model defaults saved. Unrelated drafts were not saved.")}catch(Se){b.value=`Image model operation failed: ${Se.message||"Unknown error"}. Refresh status before retrying if the outcome is uncertain.`}try{t.value=await ml(),g.value=null}catch(Se){const We=`Image model status could not be refreshed: ${Se.message||"Unknown error"}`;g.value=We,b.value=ne?`Image model defaults were saved, but ${We}`:`${b.value} ${We}`}finally{n.value=!1}}async function Xi(){var C,q;if(!(G.value||n.value)){s.value=!0,k.value=null;try{const ne=await H.get("/api/config"),Se=await ml();await m(),e.value=ne,t.value=Se,g.value=null;const We=Ne.value;if(We.some(Ct=>Ct.key===w.value)||(w.value=((C=We[0])==null?void 0:C.key)||$i[0].key),ce.value){const Vs=(((q=We.find(qs=>qs.key===w.value))==null?void 0:q.sections)||[]).find(qs=>O.value[qs]===!0);O.value=Vs?{...O.value,[Vs]:!0}:{}}}catch(ne){k.value=ne.message||"Unknown configuration error"}finally{s.value=!1}}}function Pa(C){if(P.value||!(C.ctrlKey||C.metaKey))return;const q=C.target;q instanceof HTMLElement&&(q.matches("input, textarea, select")||q.isContentEditable)||(!C.shiftKey&&C.key.toLowerCase()==="z"?(C.preventDefault(),qe()):(C.key.toLowerCase()==="y"||C.shiftKey&&C.key.toLowerCase()==="z")&&(C.preventDefault(),Qe()))}function el(C){ce.value=C.matches}Wt(O,C=>{try{localStorage.setItem(Cg,JSON.stringify(C))}catch{}},{deep:!0});let ui=!1;function tl(){ui||(ui=!0,document.addEventListener("keydown",Pa))}function sl(){ui&&(ui=!1,document.removeEventListener("keydown",Pa))}return st(()=>{var C;Xi(),tl(),J=window.matchMedia("(max-width: 760px)"),el(J),(C=J.addEventListener)==null||C.call(J,"change",el)}),rs(tl),Kt(sl),Kt(()=>{o.value=""}),xt(()=>{var C;o.value="",sl(),(C=J==null?void 0:J.removeEventListener)==null||C.call(J,"change",el),K&&window.clearTimeout(K)}),{listenerState:i,listenerConsent:l,listenerCredential:o,listenerSaving:r,listenerMessage:c,listenerError:d,listenerStatusError:u,listenerChoiceChanged:pe,listenerStatusTone:B,listenerStatusLabel:Y,listenerAuthorizationCopy:ue,listenerConfiguredSourceCopy:j,listenerRunningCopy:X,saveListenerConsent:h,armKeydown:tl,disarmKeydown:sl,handleKeydown:Pa,config:e,meta:t,loading:s,saving:n,error:k,toast:y,metaRefreshError:g,restartPromptOpen:x,restartScheduled:S,restartError:_,configMain:a,imageModelError:b,imageModelLeaves:I,setImageModelDefaults:lc,refreshImageModelMetadata:Da,searchQuery:E,healthFilter:R,activeCategory:w,reviewOpen:P,mobileOverflowOpen:re,warningThresholdInput:$,arrayInputs:te,healthFilters:fe,visibleCategories:Ne,displayGroups:ye,reviewGroups:Ke,sectionCount:ie,fieldCount:le,hasChanges:G,changeCount:ee,changedSectionCount:be,hasDraftErrors:_e,canUndo:me,canRedo:ge,globalFilterActive:he,reviewRestartCount:Je,pendingRestartCount:Ge,pendingRestartFields:Fe,healthCount:ds,categoryStats:ba,selectCategory:oe,selectHealthFilter:ke,clearFilters:je,sectionLabel:Me,sectionDescription:se,sectionFieldCount:Ae,sectionHealthCount:_t,sectionApplySummary:ze,sectionApplyDetails:rt,sectionEntries:Yt,fieldGroups:oa,sectionSearchHits:En,mcpConfigSummary:lt,fieldRuntimeCopy:js,fieldSpecificRuntimeNote:ra,hasHonestAction:vs,runFieldAction:Ms,hasHostsCollection:Z,hostsConfigSummary:Ee,sectionChanged:rn,fieldChanged:ca,isSectionExpanded:St,toggleSection:cn,discardAllDrafts:dn,setFieldValue:jt,setNumberFieldValue:li,numberInputValue:In,beginInputEdit:ua,endTextInputEdit:as,endInputEdit:un,addWarningThreshold:oi,removeWarningThreshold:ri,isScalarArray:On,addScalarArrayItem:Re,removeScalarArrayItem:N,fieldError:xe,sectionHasErrors:Be,undo:qe,redo:Qe,openReview:Et,closeReview:pt,mobileCancel:At,applyModeLabel:bs,applyClass:Nt,compactValue:oC,formatValue:rC,structuredApplyCopy:ns,fieldId:Na,fieldInputId:ci,focusField:mo,fetchConfig:Xi,saveConfig:ic,restartOdin:Ln,restartLater:ho,reviewPendingRestart:ac}}},fC=/^\d{15,25}$/;function Rg(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Ig={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1},showAddButton:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),a=f(!1),n=f(0),i=f(null),l=z(()=>new Set((e.excludedIds||[]).map(String))),o=z(()=>{const _=s.value.toLowerCase().trim();return(e.members||[]).filter(E=>l.value.has(String(E.id))?!1:_?p(E).toLowerCase().includes(_)||String(E.username||"").toLowerCase().includes(_)||String(E.id).includes(_):!0)}),r=z(()=>{const _=s.value.trim();return o.value.length===0&&fC.test(_)&&!l.value.has(_)?_:""}),c=z(()=>o.value.length+(r.value?1:0)),d=z(()=>!!s.value.trim()&&!!(o.value[n.value]||r.value&&n.value===o.value.length)),u=z(()=>{if(a.value){if(o.value[n.value])return`${e.optionsId}-${n.value}`;if(r.value&&n.value===o.value.length)return`${e.optionsId}-raw`}});function p(_){return Rg(_)}function m(){a.value=!0,n.value=0}function h(){m()}function b(){const _=Math.max(c.value-1,0);n.value=Math.min(n.value+1,_)}function I(){n.value=Math.max(n.value-1,0)}function k(){const _=o.value[n.value];_?y(_):r.value&&n.value===o.value.length&&g(r.value)}function y(_){g(String(_.id))}function g(_){t("select",_),s.value="",a.value=!1,n.value=0}function x(){a.value=!1}function S(){setTimeout(x,150)}return st(()=>{e.autofocus&&zt(()=>{var _;return(_=i.value)==null?void 0:_.focus()})}),{query:s,open:a,highlightedIndex:n,input:i,filteredMembers:o,rawId:r,activeOptionId:u,selectableValue:d,memberName:p,openOptions:m,onInput:h,highlightNext:b,highlightPrevious:I,selectHighlighted:k,selectMember:y,selectId:g,closeOptions:x,onBlur:S}}};function $f(e,t,s){var a;return((a=e==null?void 0:e.config)==null?void 0:a[t])!=null?e.config[t]:s==null?void 0:s[t]}const mC={components:{DiscordUserCombobox:Ig},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f({persisted:!1,credential_usable:!1,credential_preferred_storage:!1,connection:{state:"unavailable",detail:"Connection status unavailable"}}),s=f(""),a=f(!1),n=f(!1),i=f(null);let l=null;const o=f(!0),r=f(null),c=f({}),d=f(null),u=f(null),p=f(!1),m=f(null),h=f({}),b=f([]);let I=0;const k=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search users",userAutocomplete:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Search channels"},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Bot ID",userAutocomplete:!0}]),y=z(()=>{var ge,Ne,A,D;const le=String(((Ne=(ge=t.value)==null?void 0:ge.connection)==null?void 0:Ne.state)||"").toLowerCase();return{...{connected:{key:"connected",label:"Connected",badgeClass:"badge-success"},connecting:{key:"connecting",label:"Connecting",badgeClass:"badge-warning"},disconnected:{key:"disconnected",label:"Disconnected",badgeClass:""},detached:{key:"disconnected",label:"Disconnected",badgeClass:""},detaching:{key:"disconnected",label:"Disconnected",badgeClass:""},stopped:{key:"unavailable",label:"Unavailable",badgeClass:"badge-warning"},failed:{key:"unavailable",label:"Unavailable",badgeClass:"badge-warning"}}[le]||{key:"unavailable",label:"Unavailable",badgeClass:"badge-warning"},detail:((D=(A=t.value)==null?void 0:A.connection)==null?void 0:D.detail)||"Connection status unavailable"}}),g=z(()=>JSON.stringify(d.value)!==JSON.stringify(u.value)),x=z(()=>new Map(b.value.map(le=>[String(le.id),le])));function S(le){return le.config&&le.config.enabled!==void 0?le.config.enabled:!0}function _(le){return $f(le,"require_mention",d.value)}function E(le){return $f(le,"respond_to_bots",d.value)}function R(le){return le.config&&Object.keys(le.config).length>0}function w(le){c.value[le]=!c.value[le]}function O(le){const fe=le.discord||{};return{allowed_users:[...fe.allowed_users||[]],channels:[...fe.channels||[]],respond_to_bots:!!fe.respond_to_bots,require_mention:!!fe.require_mention,ignore_bot_ids:[...fe.ignore_bot_ids||[]]}}async function U({showLoading:le=!0}={}){const fe=++I;le&&(o.value=!0),r.value=null;try{const me=await H.get("/api/discord/guilds");fe===I&&(e.value=me)}catch(me){fe===I&&(r.value=me.message)}finally{le&&fe===I&&(o.value=!1)}}async function T(){try{t.value=await H.get("/api/discord/connection"),i.value=null}catch(le){i.value=le.message}}async function $(le,fe=null){if(!n.value){n.value=!0,i.value=null;try{const me={operation:le};fe!==null&&(me.token=fe),t.value=await H.post("/api/discord/connection",me),le==="credentials"&&(s.value="",a.value=!1)}catch(me){i.value=me.message||"Connection update failed."}finally{n.value=!1}}}function te(){if(!(!a.value||!s.value))return $("credentials",s.value)}function W(){return $("connect")}function M(){return $("detach")}async function L(){o.value=!0,r.value=null;try{const[le,fe,me]=await Promise.all([H.get("/api/discord/guilds"),H.get("/api/discord/members").catch(()=>[]),H.get("/api/config")]),ge=O(me),Ne=g.value;d.value=ge,Ne||(u.value=JSON.parse(JSON.stringify(ge))),b.value=fe,e.value=le,m.value=null}catch(le){r.value=le.message}finally{o.value=!1}}let P=Promise.resolve();const re=f(new Set);function ce(le,fe){const me=new Set(re.value);me.add(le),re.value=me;const ge=P.then(fe);return P=ge.catch(()=>{}),ge.finally(()=>{const Ne=new Set(re.value);Ne.delete(le),re.value=Ne})}function J(le,fe,me,ge){const Ne=(ge==null?void 0:ge.target)??null;return ce(`guild:${le}:${fe}`,async()=>{try{await H.put("/api/discord/guild/"+le+"/config",{[fe]:me}),await U({showLoading:!1})}catch(A){r.value=A.message,Ne&&typeof me=="boolean"&&(Ne.checked=!me)}})}function K(le,fe,me,ge,Ne){const A=(Ne==null?void 0:Ne.target)??null;return ce(`channel:${le}:${me}`,async()=>{try{await H.put("/api/discord/channel/"+le+"/config",{[me]:ge}),await U({showLoading:!1})}catch(D){r.value=D.message,A&&typeof ge=="boolean"&&(A.checked=!ge)}})}function ae(le,fe){return ce(`channel:${le}:clear`,async()=>{try{await H.put("/api/discord/channel/"+le+"/config",{clear:!0}),await U({showLoading:!1})}catch(me){r.value=me.message}})}function V(le,fe){const me=String(fe);if(!le.userAutocomplete)return me;const ge=x.value.get(me);return ge?Rg(ge):me}function ve(le,fe=null){const me=String(fe??h.value[le]??"").trim();!me||u.value[le].includes(me)||(u.value[le]=[...u.value[le],me],h.value={...h.value,[le]:""})}function Ie(le,fe){u.value[le]=u.value[le].filter(me=>me!==fe)}async function ie(){if(!(!g.value||p.value)){p.value=!0,m.value=null;try{const fe=(await H.put("/api/config",{discord:u.value})).discord||u.value;d.value={allowed_users:[...fe.allowed_users||[]],channels:[...fe.channels||[]],respond_to_bots:!!fe.respond_to_bots,require_mention:!!fe.require_mention,ignore_bot_ids:[...fe.ignore_bot_ids||[]]},u.value=JSON.parse(JSON.stringify(d.value))}catch(le){m.value=le.message||"Global defaults could not be saved."}finally{p.value=!1}}}return st(()=>{L(),T(),l=window.setInterval(T,5e3)}),xt(()=>{l!==null&&window.clearInterval(l),l=null}),{guilds:e,loading:o,error:r,expanded:c,globalDraft:u,globalSaving:p,globalError:m,globalArrayInputs:h,globalMembers:b,globalListEditors:k,globalChanged:g,guildEnabled:S,guildMention:_,guildBots:E,hasOverride:R,toggleGuild:w,fetchAll:L,fetchGuilds:U,setGuildConfig:J,setChannelConfig:K,clearOverride:ae,mutationPending:re,globalItemLabel:V,addGlobalItem:ve,removeGlobalItem:Ie,saveGlobalDefaults:ie,connection:t,connectionState:y,connectionToken:s,connectionTokenDirty:a,connectionBusy:n,connectionError:i,saveDiscordCredentials:te,connectDiscord:W,detachDiscord:M}}},Ws=e=>e==null?e:JSON.parse(JSON.stringify(e));function hC({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:a=()=>{},onDefaultRollback:n=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let m=null;const h=new Map;function b(_){d+=1;const E=c.then(_,_);return c=E.catch(()=>{}),E}function I(_,E){m=Ws(_),h.clear();for(const[R,w]of Object.entries(E||{}))h.set(R,Ws(w))}function k(_){const E=Ws(_),R=++u;return b(async()=>{try{await e(Ws(E)),m=Ws(E),R===u&&a(Ws(E))}catch(w){R===u&&(n(Ws(m)),r(w,{kind:"default"}))}})}function y(_,E){const R=Ws(E),w=(p.get(_)||0)+1;return p.set(_,w),b(async()=>{try{await t(_,Ws(R)),h.set(_,Ws(R)),w===p.get(_)&&i(_,Ws(R))}catch(O){w===p.get(_)&&(l(_,Ws(h.get(_)??null)),r(O,{kind:"user",uid:_}))}})}function g(_){const E=(p.get(_)||0)+1;return p.set(_,E),b(async()=>{try{await s(_),h.delete(_),E===p.get(_)&&o(_)}catch(R){E===p.get(_)&&(l(_,Ws(h.get(_)??null)),r(R,{kind:"delete",uid:_}))}})}async function x(){for(;;){const _=c;if(await _,_===c)return d}}async function S(_){for(;;){const E=await x(),R=await _();if(E===d)return R}}return{seed:I,saveDefault:k,saveUser:y,deleteUser:g,whenIdle:x,readSnapshot:S,get revision(){return d}}}const vC={components:{DiscordUserCombobox:Ig},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=z(()=>{const T={};for(const $ of r.value)T[$.id]=$;return T});function d(T){return c.value[T]||null}function u(T,$){return T?T.allowed_hosts===null||T.allowed_hosts===void 0?{allowed_hosts:[...$],default_host:T.default_host||"",allow_all:!0}:{allowed_hosts:T.allowed_hosts,default_host:T.default_host||"",allow_all:!1}:{allowed_hosts:[...$],default_host:$[0]||"",allow_all:!0}}const p=hC({applyDefault:async T=>{const $=T.allow_all?null:T.allowed_hosts;await H.put("/api/host-access/default-policy",{allowed_hosts:$,default_host:T.default_host})},applyUser:async(T,$)=>{const te=$.allow_all?null:$.allowed_hosts;await H.put(`/api/host-access/user/${T}`,{allowed_hosts:te,default_host:$.default_host})},applyDelete:T=>H.del(`/api/host-access/user/${T}`),onDefaultConfirmed:()=>Te.success("Default policy updated"),onDefaultRollback:T=>{T&&(i.value=T)},onUserConfirmed:T=>{const $=d(T);Te.success(`Updated access for ${$?$.display_name:T}`)},onUserRollback:(T,$)=>{const te={...l.value};$?te[T]=$:delete te[T],l.value=te},onUserDeleted:T=>{const $={...l.value};delete $[T],l.value=$},onError:(T,$)=>{var W;const te=$.uid?` ${((W=d($.uid))==null?void 0:W.display_name)||$.uid}`:"";Te.error(`${T.message||"Failed to save"} — reverted${te}`)}});let m=0;async function h(){const T=++m;e.value=!0,t.value="";try{const $=await p.readSnapshot(()=>H.get("/api/host-access"));if(T!==m)return;s.value=$,a.value=$.available_hosts||[],n.value=$.host_descriptions||{},i.value=u($.default_policy,a.value);const te=$.users||{},W={};for(const[M,L]of Object.entries(te))W[M]=u(L,a.value);l.value=W,p.seed(i.value,W)}catch($){T===m&&(t.value=$.message||"Failed to fetch host access data")}finally{T===m&&(e.value=!1)}try{const $=await H.get("/api/discord/members")||[];T===m&&(r.value=$)}catch{T===m&&(r.value=[])}}const b=500,I=new Map;function k(T,$){const te=I.get(T);te&&clearTimeout(te.timer);const W={run:$,timer:null};W.timer=setTimeout(()=>{I.delete(T),$()},b),I.set(T,W)}function y(T){const $=I.get(T);$&&(clearTimeout($.timer),I.delete(T))}function g(){for(const[T,$]of[...I])clearTimeout($.timer),I.delete(T),$.run()}function x(){k("default",()=>p.saveDefault(i.value))}function S(T,$){i.value.allow_all=!1,$?i.value.allowed_hosts.includes(T)||i.value.allowed_hosts.push(T):(i.value.allowed_hosts=i.value.allowed_hosts.filter(te=>te!==T),i.value.default_host===T&&(i.value.default_host=i.value.allowed_hosts[0]||"")),x()}function _(T){k(`user:${T}`,()=>{const $=l.value[T];$&&p.saveUser(T,$)})}function E(T,$,te){const W=l.value[T];W&&(W.allow_all=!1,te?W.allowed_hosts.includes($)||W.allowed_hosts.push($):(W.allowed_hosts=W.allowed_hosts.filter(M=>M!==$),W.default_host===$&&(W.default_host=W.allowed_hosts[0]||"")),_(T))}function R(T,$){const te=l.value[T];te&&(te.default_host=$,_(T))}function w(){o.value=!0}function O(T){!/^\d{15,25}$/.test(T)||l.value[T]||(l.value[T]={allowed_hosts:[...a.value],default_host:a.value[0]||"",allow_all:!1},p.saveUser(T,l.value[T]),o.value=!1)}async function U(T){const $=d(T);await os({title:"Remove user override",message:`Remove the host access override for ${$?$.display_name:T}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(y(`user:${T}`),await p.deleteUser(T),l.value[T]||Te.success(`Removed override for ${$?$.display_name:T}`))}return st(h),Kt(g),xt(g),{loading:e,error:t,data:s,availableHosts:a,hostDescriptions:n,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:h,saveDefaultPolicy:x,toggleDefaultHost:S,getMember:d,toggleUserHost:E,setUserDefault:R,openAddUser:w,addUserById:O,deleteUser:U,flushPendingSaves:g}}},gC={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=f([]),t=f(!1),s=f(""),a=f([]),n=f(!1),i=f(!1),l=f(1),o=f(""),r=f(!1),c=f(null),d=f(""),u=f([]),p=f(!1),m=f(null),h=f(""),b=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),I=f(b()),k=z(()=>["127.0.0.1","localhost","::1"].includes(I.value.address));async function y(){t.value=!0,s.value="";try{const W=await H.get("/api/hosts");e.value=W.hosts||[],o.value=W.default_host||"",r.value=!!W.tofu_enabled}catch(W){s.value=W.message}finally{t.value=!1}}async function g(){try{await H.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),Te.success("Host settings saved and published live"),await y()}catch(W){Te.error(W.message)}}function x(){d.value="",u.value=[],p.value=!1,m.value=null,c.value=null,h.value="",l.value=1,n.value=!0}function S(){i.value=!1,I.value=b(),x()}function _(W){i.value=!0,I.value={...b(),...W},x()}async function E(){try{c.value=await H.get("/api/hosts/public-key")}catch(W){Te.error(W.message)}}async function R(W){try{const M=await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/import-legacy",{});i.value=!0,I.value={...b(),...W,trust_mode:"pinned"},x(),d.value=M.candidate_token,u.value=M.fingerprints||[],h.value=u.value.join(`
`),l.value=4,Te.info("Imported existing known_hosts trust. Test before activation.")}catch(M){Te.error(M.message)}}async function w(){try{const W=h.value.split(/\s+/).filter(Boolean),M={...I.value,expected_fingerprints:W,candidate_fingerprints:u.value},L=await H.post("/api/hosts/candidates",M);if(d.value=L.candidate_token,u.value=L.fingerprints||[],I.value.trust_mode==="tofu"&&M.candidate_fingerprints.length===0){I.value.confirm_tofu=!1,Te.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(W){Te.error(W.message)}}async function O(){var W,M;p.value=!1,m.value=null;try{const L=await H.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!L.tested,m.value=L.last_test,p.value&&(l.value=5)}catch(L){const P=(W=L.data)==null?void 0:W.last_test;P&&typeof P=="object"&&!Array.isArray(P)&&(m.value=P);const re=(M=m.value)==null?void 0:M.detail;Te.error(typeof re=="string"&&re.trim()?re:L.message)}}async function U(){try{await H.post("/api/hosts/candidates/"+d.value+"/commit",{}),Te.success("Host saved and published live"),n.value=!1,await y()}catch(W){Te.error(W.message)}}async function T(W){try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/enabled",{enabled:!W.enabled}),await y()}catch(M){Te.error(M.message)}}async function $(W){var M;if(await os("Delete host "+W.alias+"? Dependencies will block deletion.")){a.value=[];try{await H.del("/api/hosts/"+encodeURIComponent(W.alias)),await y()}catch(L){a.value=Array.isArray((M=L.data)==null?void 0:M.pending_references)?L.data.pending_references:[],Te.error(L.message)}}}async function te(W){if(await os("Force revoke "+W.alias+"? Remote outcomes may be unknown."))try{await H.post("/api/hosts/"+encodeURIComponent(W.alias)+"/force-revoke",{}),await y()}catch(M){Te.error(M.message)}}return st(y),{hosts:e,loading:t,error:s,pendingReferences:a,wizard:n,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:I,isLocal:k,keyInfo:c,candidate:d,observed:u,tested:p,testResult:m,fingerprintsText:h,load:y,saveSettings:g,beginAdd:S,beginEdit:_,loadKey:E,importLegacy:R,prepare:w,testConnection:O,commit:U,toggle:T,remove:$,forceRevoke:te}}},bC={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=z(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:a.value),p=z(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:a.value);function m(R){return R==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":R==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function h(){e.value=!0,t.value="";try{const R=await H.get("/api/tokens");s.value=R.tokens||[],a.value=R.available_hosts||[]}catch(R){t.value=R.message||"Failed to load tokens"}finally{e.value=!1}}function b(R){return!R||!R.trim()?[]:R.split(",").map(w=>w.trim()).filter(Boolean)}function I(R,w){const O=c.value.allowed_hosts;if(w&&!O.includes(R)&&O.push(R),!w){const U=O.indexOf(R);U>=0&&O.splice(U,1)}}function k(R,w){const O=d.value.allowed_hosts;if(w&&!O.includes(R)&&O.push(R),!w){const U=O.indexOf(R);U>=0&&O.splice(U,1)}}async function y(){var R;i.value=!0;try{const w=b(c.value.allowed_tools_str),O=c.value.host_mode,U=O==="none"?[]:O==="select"?c.value.allowed_hosts:null,T={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:w.length?w:[]};U!==null&&(T.allowed_hosts=U),T.default_host=c.value.default_host||"";const $=await H.post("/api/tokens",T);l.value=$.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},n.value=!1,Te.success("Token created"),await h()}catch(w){Te.error(((R=w.data)==null?void 0:R.error)||w.message||"Failed to create token")}finally{i.value=!1}}function g(R){o.value=R;const w=R.allowed_hosts;let O="default";w==null?O="default":Array.isArray(w)&&w.length===0?O="none":Array.isArray(w)&&(O="select"),d.value={username:R.username||"",tier:R.tier||"admin",label:R.label||"",host_mode:O,allowed_hosts:Array.isArray(w)?[...w]:[],default_host:R.default_host||"",allowed_tools_str:(R.allowed_tools||[]).join(", ")}}async function x(){var R;if(o.value){r.value=!0;try{const w=b(d.value.allowed_tools_str),O=d.value.host_mode,U={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:w};O==="none"?U.allowed_hosts=[]:O==="select"?U.allowed_hosts=d.value.allowed_hosts:U.allowed_hosts=null,U.default_host=d.value.default_host||"",await H.put("/api/tokens/"+encodeURIComponent(o.value.user_id),U),o.value=null,Te.success("Token updated"),await h()}catch(w){Te.error(((R=w.data)==null?void 0:R.error)||w.message||"Failed to update")}finally{r.value=!1}}}async function S(R){var O;if(await os({title:"Regenerate token",message:`Regenerate token for ${R.username||R.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const U=await H.post("/api/tokens/"+encodeURIComponent(R.user_id)+"/regenerate");l.value=U.token,Te.success("Token regenerated")}catch(U){Te.error(((O=U.data)==null?void 0:O.error)||U.message||"Failed to regenerate")}}async function _(R){var O;if(await os({title:"Delete token",message:`Delete token for ${R.username||R.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/tokens/"+encodeURIComponent(R.user_id)),Te.success("Token deleted"),await h()}catch(U){Te.error(((O=U.data)==null?void 0:O.error)||U.message||"Failed to delete")}}async function E(){if(l.value)try{await navigator.clipboard.writeText(l.value),Te.success("Copied to clipboard")}catch{Te.error("Copy failed — select and copy manually")}}return st(h),{loading:e,error:t,tokens:s,availableHosts:a,showCreate:n,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:h,tierBadge:m,toggleCreateHost:I,toggleEditHost:k,createToken:y,startEdit:g,saveEdit:x,confirmRegenerate:S,confirmDelete:_,copyToken:E}}},yC=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort"]),xC=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),_C=Object.freeze(["enabled","base_url","model","max_tokens","num_ctx"]),wC=Object.freeze(["enabled","base_url","model","reasoning_effort"]);function po(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function Mo(e,t={}){const s=po(e,wC);return t.includeApiKey&&(s.api_key=e.api_key),s}function Pc(e){return po(e,["request_timeout_seconds","stream_stall_timeout_seconds","preset","model_profiles","context_utilization","openrouter"])}function Do(e){return po(e,yC)}function Po(e){return po(e,xC)}function $o(e,{includeApiKey:t=!1}={}){const s=po(e,_C);return t&&(s.api_key=e.api_key),s}function $c(e){return{timeout:e.timeout}}function Fo(e,t=500){let s=null;const a=(...n)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...n)},t)};return a.pending=()=>s!==null,a.cancel=()=>{s&&(clearTimeout(s),s=null)},a}const kC={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=15e3;let a=null,n=!1,i=null,l=null;const o={codexBasic:null,codexAdvanced:null,ollamaBasic:null,ollamaAdvanced:null,compatibleBasic:null,compatibleAdvanced:null,auxiliary:null,mainModel:null,agents:null},r=v=>JSON.stringify(v),c=(v,F)=>{o[v]=r(F)},d=(v,F)=>o[v]!==null&&o[v]!==r(F),u=f(null),p=f(!1),m=f({main:"",main_capability:"medium",agent_capability:"adaptive"}),h=f(""),b=["none","low","medium","high","xhigh","max"],I=["none","low","medium","high","xhigh","max"],k=f({enabled:!1,model:"gpt-6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),y=["gpt-6-astra","gpt-6-sol","gpt-6-luna","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna"],g=z(()=>{const v=u.value||{},F=v.model_catalogue||v.model_catalog||{},Q=$e=>{var Xt,De,Ft;return((Xt=ye.value.model_profiles)==null?void 0:Xt[$e])||((Ft=(De=ye.value.openrouter)==null?void 0:De.catalogue_profiles)==null?void 0:Ft[$e])||null},Ce=($e,Xt,De)=>Xt.map(Ft=>{var Yu,Qu;const Bt=typeof Ft=="string"?Ft:Ft.name,Gs=$e==="compat"?Q(Bt):null;return{ref:$e==="codex"?Ft:`${$e}:${Bt}`,name:Bt,provider:$e,available:!!(De!=null&&De.enabled&&($e==="codex"?De.configured:(Yu=De.health)!=null&&Yu.healthy)),unavailable_reason:De!=null&&De.enabled?De!=null&&De.configured?!((Qu=De==null?void 0:De.health)!=null&&Qu.healthy)&&$e!=="codex"?"unreachable":"":"not configured":"disabled",capability:$e==="codex"||Gs!=null&&Gs.supports_reasoning?"reasoning":Gs!=null&&Gs.supports_thinking_mode?"thinking":"none",efforts:Gs==null?void 0:Gs.supported_efforts,profile:Gs}}),Pe=[...F.codex||Ce("codex",y,v.codex),...F.compat||F.openai_compatible||[],...F.ollama||Ce("ollama",se.value,v.ollama)].map($e=>typeof $e=="string"?{ref:$e,name:$e,provider:"codex",available:!0,capability:"reasoning"}:$e),ct=$e=>{const Xt=Pe.findIndex(De=>De.ref===$e.ref);Xt===-1?Pe.push($e):Pe[Xt]={...Pe[Xt],...$e}};for(const $e of Ce("compat",gt.value,v.openai_compatible))ct($e);if(ns.value&&Ve.value.length)for(const $e of Ve.value){const Xt=`compat:${$e.id}`;ct({ref:Xt,name:$e.name||$e.id,provider:"compat",available:!0,unavailable_reason:"",capability:$e.supports_reasoning?"reasoning":"none",efforts:b.filter(De=>{var Ft;return(Ft=$e.supported_efforts)==null?void 0:Ft.includes(De)}),agent_available:$e.agent_eligible&&!!$e.profile,agent_unavailable_reason:$e.agent_unavailable_reason||""})}const Ts=new Set(Pe.map($e=>$e.ref));for(const $e of[m.value.main,Ze.value.model,...Qt.value])$e&&$e!=="auto"&&!Ts.has($e)&&Pe.unshift({ref:$e,name:$e.replace(/^(compat|ollama):/,""),provider:$e.split(":")[0]||"codex",available:!1,unavailable_reason:"unavailable",capability:$e.startsWith("ollama:")||$e.includes(":")?"none":"reasoning"});return Pe.filter($e=>!ns.value||$e.provider!=="compat"||$e.ref.slice(7).includes("/")).map($e=>$e.efforts?{...$e,efforts:b.filter(Xt=>$e.efforts.includes(Xt)&&!V($e.ref,Xt))}:$e)}),x=z(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,F])=>({id:v,label:F,models:g.value.filter(Q=>{if(Q.provider!==v)return!1;const Ce=h.value.trim().toLowerCase();return!Ce||`${Q.name} ${Q.ref}`.toLowerCase().includes(Ce)})})).filter(v=>v.models.length)),S=v=>v.available&&v.agent_available!==!1,_=v=>v.available?`${v.name}${v.agent_available===!1?` (${v.agent_unavailable_reason||"not agent-eligible"})`:""}`:ce(v),E=z(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,F])=>({id:v,label:F,models:g.value.filter(Q=>Q.provider===v&&!(v==="compat"&&ns.value)&&`${Q.ref} ${Q.name}`.toLowerCase().includes(kt.value.trim().toLowerCase()))})).filter(v=>v.models.length)),R=z(()=>g.value.find(v=>v.ref===m.value.main)),w=z(()=>g.value.find(v=>v.ref===Ze.value.model)),O=v=>g.value.find(F=>F.ref===v),U=v=>{const F=O(v);return(F==null?void 0:F.provider)==="codex"?b.filter(Q=>!V(v,Q)):(F==null?void 0:F.efforts)||[]},T=v=>gs.value.find(F=>Ms(F)===v),$=(v,F)=>{const Q=T(v);return typeof Q=="string"?"":(Q==null?void 0:Q[F])||""},te=z(()=>Qt.value.map(v=>O(v)).filter(v=>v&&S(v))),W=z(()=>[...new Set(te.value.map(v=>v.capability!=="reasoning"?v.capability||"none":v.provider==="codex"?"codex_reasoning":"compatible_reasoning"))]),M=z(()=>W.value.length>1),L=z(()=>{var F;if(Ze.value.model!=="auto")return((F=w.value)==null?void 0:F.capability)||"none";if(M.value)return"mixed";const v=W.value[0]||"none";return v.endsWith("_reasoning")?"reasoning":v}),P=z(()=>{var v;return Ze.value.model==="auto"?b:((v=w.value)==null?void 0:v.efforts)||b}),re=z(()=>L.value==="thinking"?Ze.value.thinking_mode??k.value.agent_reasoning_effort??"":k.value.agent_reasoning_effort??""),ce=v=>`${v.name}${v.available?"":` (${v.unavailable_reason||"unavailable"})`}`,J=z(()=>{const v=k.value.model;return v&&!y.includes(v)?[v,...y]:y}),K=z(()=>{const v=Ze.value.model;return v&&v!=="auto"&&!y.includes(v)?[v,...y]:y}),ae={"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},V=(v,F)=>!!v&&!!F&&(ae[v]||[]).includes(F),ve=z(()=>{const v=Ze.value.model;return v&&!v.includes(":")?v:null}),Ie=v=>!V(k.value.model,v)&&!(k.value.agent_reasoning_effort===""&&V(ve.value,v)),ie=v=>{const F=Ze.value.model;return F==="auto"?!0:!V(F||k.value.model,v)},le=z(()=>{const v=k.value.agent_reasoning_effort;return v==="auto"?null:v||k.value.reasoning_effort}),fe=v=>V(v,k.value.reasoning_effort)||Ze.value.model===""&&V(v,le.value),me=v=>V(v,le.value),ge=f({enabled:!1,model:"gpt-6-luna"}),Ne=f({unavailable_reason:null}),A=z(()=>{const v=ge.value.model;return v&&!y.includes(v)?[v,...y]:y});function D(v){const F=v.target.value;ge.value.enabled=F!=="",F!==""&&(ge.value.model=F),F.startsWith("compat:")&&ns.value?Pa(Se(F),We(F)).then(()=>Mn()).catch(Q=>Ue(Q.message||"Failed to prepare OpenRouter model","error")):Mn()}const G=f(!1),pe=f({codex:!1,ollama:!1,compatible:!1}),B=f(null),Y=f(!1),ue=f(""),j=f(null),X=f(!1);let ee=0;const be=z(()=>{var v;return Object.entries(((v=B.value)==null?void 0:v.models)||{}).map(([F,Q])=>{var Ce,Pe,ct;return{model:F,floor:Q.floor,override:Q.override,effectiveBudget:(Ce=Q.effective)==null?void 0:Ce.effective_budget,configuredPrimaryChars:(Pe=Q.configured)==null?void 0:Pe.primary_chars,primaryChars:(ct=Q.effective)==null?void 0:ct.primary_chars,provenance:Q.provenance,clampExpiresAt:Q.clamp_expires_at,densityPriorMilli:Q.density_prior_milli,densityScope:Q.density_scope,workloadCalibration:Q.workload_calibration}})}),he=z(()=>{var v;return((v=B.value)==null?void 0:v.clamps)||[]}),we=z(()=>{var v,F;return((F=(v=B.value)==null?void 0:v.models)==null?void 0:F[k.value.model])||null}),_e=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,num_ctx:32768,timeout:300}),ye=f({enabled:!1,base_url:"https://api.deepseek.com/v1",api_key:"",model:"deepseek-v4-flash",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,preset:"deepseek",reasoning_effort:"medium",model_profiles:{},context_utilization:75,openrouter:{order:[],allow_fallbacks:!0,quantizations:[],sort:null,data_collection:null,reasoning_effort:"medium",model_pins:{},catalogue_profiles:{}}}),Ke=f(!1),Je=f(!1),Fe=f(!1),Ge=f(!1),at=f(!1),Xe=f(!1);function Z(){var F,Q,Ce;return!!(((F=t.value)==null?void 0:F.contains(document.activeElement))&&((Ce=(Q=document.activeElement)==null?void 0:Q.matches)==null?void 0:Ce.call(Q,'input, textarea, select, [contenteditable="true"]'))||ra.value||vo.value!==null||X.value||Ke.value||Je.value||vs.value||Fe.value||Ge.value||at.value||G.value||fi.pending()||mi.pending()||Dn.pending()||Mn.pending()||d("codexBasic",Do(k.value))||d("codexAdvanced",Po(k.value))||d("ollamaBasic",$o(_e.value))||d("ollamaAdvanced",$c(_e.value))||d("compatibleBasic",Mo(ye.value))||d("compatibleAdvanced",Pc(ye.value))||d("auxiliary",ge.value)||d("mainModel",m.value.main)||d("agents",Ze.value))}function Ee(){o.codexBasic=r(Do(k.value)),o.codexAdvanced=r(Po(k.value)),o.ollamaBasic=r($o(_e.value)),o.ollamaAdvanced=r($c(_e.value)),o.compatibleBasic=r(Mo(ye.value)),o.compatibleAdvanced=r(Pc(ye.value)),o.auxiliary=r(ge.value),o.mainModel=r(m.value.main)}const Ae=f({configured:null}),Me=f(!1),se=f([]),Le=f(""),ze=f(!1),rt=f(!1),Zt=f({configured:null}),lt=f(!1),gt=f([]),Yt=z(()=>ns.value?Ve.value.map(v=>v.id):gt.value),cs=f(""),oa=f(!1),js=f(!1),Ze=f({model:"auto",thinking_mode:null,auto_model_allowlist:[]}),ra=f(!1),vs=f(!1),Ms=v=>typeof v=="string"?v:v==null?void 0:v.model,gs=z(()=>(Ze.value.auto_model_allowlist||[]).map(v=>typeof v=="string"?v:{...v}).filter(v=>Ms(v))),En=z(()=>!k.value.enabled&&ye.value.enabled?ye.value.model?[`compat:${ye.value.model}`]:[]:!k.value.enabled&&!ye.value.enabled&&_e.value.enabled?_e.value.model?[`ollama:${_e.value.model}`]:[]:y),Qt=z(()=>gs.value.length?gs.value.map(Ms):En.value),_t=z(()=>{var v;return(v=Ze.value.auto_model_allowlist)!=null&&v.length?`Allowlist: ${Qt.value.length} models`:`Default: ${Qt.value.join(", ")||"no available agent models"}`}),ds=new Map;function ba(){ra.value=!1,q()}const rn=v=>{if(ns.value&&v.startsWith("compat:")&&!v.slice(7).includes("/"))return"OpenRouter requires a namespaced vendor/model ID; this is a direct-endpoint profile.";const F=g.value.find(Q=>Q.ref===v);return F?S(F)?"":F.agent_unavailable_reason||F.unavailable_reason||"Not agent-eligible":"Model is absent from the current endpoint catalogue."},ca=v=>{if(Et.value.has(v))return bs(v);const F=g.value.find(Ce=>Ce.ref===v),Q=(F==null?void 0:F.hint_metadata)||{};return[Q.hint||Q.hint_derived,Q.as_of&&`as of ${Q.as_of}`,Q.scope_note,Q.evidence&&`Evidence: ${Q.evidence}`,F&&qs(F)].filter(Boolean).join(" · ")||"No catalogue hint. Add an operator hint below."},oe=f(null),ke=f(!1),je=f(""),Ve=z(()=>{var v;return(((v=oe.value)==null?void 0:v.models)||[]).map(F=>{var Ce,Pe,ct;const Q=((Ce=ye.value.model_profiles)==null?void 0:Ce[F.id])||F.profile||((ct=(Pe=ye.value.openrouter)==null?void 0:Pe.catalogue_profiles)==null?void 0:ct[F.id])||(F.context_length>0&&F.max_completion_tokens>0?{total_window_tokens:F.context_length,max_output_tokens:F.max_completion_tokens}:null);return{...F,profile:Q}})}),kt=f(""),St=f(""),cn=f(!0),An=f(!0),dn=f(!0),Rn=f(!1),da=f(null),ya=f(""),jt=f(null),ua=f(""),as=f([]),un=f(!1),In=f("throughput"),li=(v,F,Q=null)=>{const Ce=v[F],Pe=Q&&Ce&&typeof Ce=="object"?Ce[Q]:Ce,ct=Number(Pe);return Number.isFinite(ct)?ct:null},oi=z(()=>{const v=[...as.value],F=In.value;return v.sort((Q,Ce)=>{var Bt,Gs;if(F==="quantization")return String(Q.quantization).localeCompare(String(Ce.quantization));const[Pe,ct,Ts]=F==="throughput"?["throughput_last_30m","p50",!0]:F==="latency_p99"?["latency_last_30m","p99",!1]:F==="cache_price"?["cache_read_per_token",null,!1]:["prompt_per_token",null,!1],$e=(Bt=Q.pricing)==null?void 0:Bt[Pe],Xt=(Gs=Ce.pricing)==null?void 0:Gs[Pe],De=ct?li(Q,Pe,ct):$e==null?null:Number($e),Ft=ct?li(Ce,Pe,ct):Xt==null?null:Number(Xt);return Number.isFinite(De)?Number.isFinite(Ft)?Ts?Ft-De:De-Ft:-1:1})}),ri=z(()=>{try{return new URL(ye.value.base_url).hostname}catch{return""}}),ns=z(()=>/(^|\.)openrouter\.ai$/i.test(ri.value)),On=z(()=>{var v,F;return ns.value?ke.value?"OpenRouter recognized · fetching catalogue…":je.value?`OpenRouter recognized · catalogue failed: ${je.value}`:`OpenRouter recognized · ${((F=(v=oe.value)==null?void 0:v.models)==null?void 0:F.length)||0} catalogue models loaded`:gt.value.length?`${gt.value.length} endpoint models loaded`:"Catalogue not loaded"}),Re=z(()=>je.value?"text-red-400":"text-gray-500"),N=z(()=>{var v;return[...new Set((((v=oe.value)==null?void 0:v.models)||[]).map(F=>F.vendor))].sort()}),de=z(()=>{var v;return[...new Set((((v=oe.value)==null?void 0:v.models)||[]).flatMap(F=>(F.endpoints||[]).map(Q=>Q.quantization)).filter(Boolean))].sort()}),xe=v=>{var F;return(((F=oe.value)==null?void 0:F.measured_cache)||[]).some(Q=>Q.model===v.id&&Q.samples>0&&Q.cached_percent>0)},Be=z(()=>{const v=kt.value.trim().toLowerCase();return Ve.value.filter(F=>{var Q;return!(v&&!`${F.id} ${F.name} ${F.vendor}`.toLowerCase().includes(v)||St.value&&F.vendor!==St.value||cn.value&&!F.supports_tools||An.value&&!F.agent_eligible||dn.value&&F.variant!=="standard"||Rn.value&&!xe(F)||da.value!=null&&Number((Q=F.pricing)==null?void 0:Q.prompt_per_token)*1e6>Number(da.value)||ya.value&&!(F.endpoints||[]).some(Ce=>Ce.quantization===ya.value))})}),qe=z(()=>Be.value.slice(0,100)),Qe=z(()=>Be.value.length),Et=z(()=>new Map(Ve.value.map(v=>[`compat:${v.id}`,v]))),pt=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(3)}/M`,At=v=>{var F,Q,Ce,Pe;return[v.vendor,v.context_length?`${Number(v.context_length).toLocaleString()} ctx`:"context unknown",`${pt((F=v.pricing)==null?void 0:F.prompt_per_token)} in`,`${pt((Q=v.pricing)==null?void 0:Q.completion_per_token)} out`,`${pt((Ce=v.pricing)==null?void 0:Ce.cache_read_per_token)} cache read`,`${pt((Pe=v.pricing)==null?void 0:Pe.cache_write_per_token)} cache write`,v.supports_tools?"tools":"no tools",v.supports_reasoning?"reasoning":"no reasoning",v.variant!=="standard"?v.variant:null].filter(Boolean).join(" · ")},bs=v=>{var Pe;const F=Et.value.get(v);if(!F)return"Catalogue facts unavailable";const Q=(((Pe=oe.value)==null?void 0:Pe.measured_cache)||[]).filter(ct=>ct.model===F.id),Ce=Q.length?Q.map(ct=>`${ct.upstream_provider}: ${ct.cached_percent}% cached`).join(" · "):"No measured cache evidence yet";return`${At(F)} · ${Ce}${F.profile_conflict?" · operator profile conflicts with catalogue":""}`},Nt=z(()=>gt.value.map(v=>typeof v=="string"?v:v.name).filter(Boolean)),Na=async()=>{var F,Q,Ce;const v=(Ce=(Q=(F=u.value)==null?void 0:F.openai_compatible)==null?void 0:Q.preset_catalogue)==null?void 0:Ce[ye.value.preset];v&&(ye.value.base_url=v.base_url),Dn.cancel(),await ol()},ci=(v,F)=>{ye.value.openrouter[v]=F.split(",").map(Q=>Q.trim()).filter(Boolean)},mo=z(()=>se.value||[]),Ma=z(()=>{const v=[...y,...Nt.value.map(F=>`compat:${F}`),...mo.value.map(F=>`ollama:${F.name}`)];for(const F of[Ze.value.model,...Qt.value])F&&F!=="auto"&&!v.includes(F)&&v.unshift(F);return v}),ac=v=>v==="codex-auto-review"?"codex-auto-review (Codex alias → gpt-5.6-luna)":v;async function ho({poll:v=!1}={}){try{const F=await H.get("/api/agents/model");if(v&&Z())return;Ze.value={...Ze.value,...F},o.agents=r(Ze.value)}catch{}}async function di(){if(!ns.value){oe.value=null,je.value="";return}ke.value=!0;try{oe.value=await H.get("/api/openrouter/catalogue"),je.value=""}catch(v){je.value=v.message||"Failed to load OpenRouter catalogue"}finally{ke.value=!1}}async function nc(){var v;try{(v=Ze.value.model)!=null&&v.startsWith("compat:")&&ns.value&&await Pa(Se(Ze.value.model),We(Ze.value.model));const F=await H.put("/api/agents/model",{model:Ze.value.model||null});Ze.value={...Ze.value,...F},o.agents=r(Ze.value),Ue("Agent model policy saved")}catch(F){Ue(F.message||"Failed to save agent model policy","error")}}const Ln=()=>[...gs.value.length?gs.value:Qt.value];async function ic(v,F){const Q=Ln(),Ce=Q.findIndex(Ts=>Ms(Ts)===v);let Pe=null;if(F.target.checked&&Ce<0&&Q.push(ds.get(v)||v),!F.target.checked&&Ce>=0&&([Pe]=Q.splice(Ce,1)),!Q.length){F.target.checked=!0,Ue("Keep one model selected. An empty list restores the provider default.","error");return}const ct=await Da(Q,"Agent Auto allowlist saved");ct&&F.target.checked&&ds.delete(v),ct&&!F.target.checked&&typeof Pe=="object"&&ds.set(v,Pe),ct||(F.target.checked=Qt.value.includes(v))}async function Da(v,F){if(vs.value)return!1;vs.value=!0;try{const Q=await H.put("/api/agents/model",{auto_model_allowlist:v});return Ze.value={...Ze.value,...Q},o.agents=r(Ze.value),Ue(F),!0}catch(Q){return Ue(Q.message||"Failed to save agent allowlist","error"),!1}finally{vs.value=!1}}const lc=()=>Da([],"Provider default restored");async function Xi(v,F,Q){const Ce=Qt.value.map(Pe=>{const ct=T(Pe);if(Pe!==v)return ct||Pe;const Ts=typeof ct=="string"?{model:Pe}:{...ct||{model:Pe}};return delete Ts.reasoning_effort,delete Ts.thinking_mode,Q&&(Ts[F]=Q),Object.keys(Ts).length===1?Ts.model:Ts});await Da(Ce,"Model default saved")}async function Pa(v,F=""){const[Q,...Ce]=v.split("/");if(!Q||!Ce.length)throw new Error("OpenRouter model id is not namespaced");return H.post(`/api/openrouter/models/${encodeURIComponent(Q)}/${encodeURIComponent(Ce.join("/"))}/select`,{provider_tag:F})}const el=(v,F)=>{var Ce;const Q=(((Ce=oe.value)==null?void 0:Ce.measured_cache)||[]).find(Pe=>Pe.model===v&&Pe.upstream_provider===F);return Q?`${Q.cached_percent}% cached over ${Q.samples} calls`:"no measured cache evidence"},ui=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(4)}/M`,tl=(v,F)=>{if(v==null)return"n/a";if(typeof v=="number")return Number(v).toLocaleString();const Q=v[F];return Q==null?"n/a":Number(Q).toLocaleString()},sl=v=>{var Pe;const F=[];v.quantization==="fp4"&&F.push("fp4 quantization may change quality");const Q=typeof v.latency_last_30m=="object"?Number((Pe=v.latency_last_30m)==null?void 0:Pe.p99):null,Ce=Number(Ze.value.iteration_timeout_seconds||0)*1e3;return Q&&Ce&&Q>Ce&&F.push("p99 exceeds the agent iteration budget"),F.join("; ")};async function C(v){var F;jt.value=v,ua.value=((F=ye.value.openrouter.model_pins)==null?void 0:F[v.id])||"",un.value=!0;try{const[Q,...Ce]=v.id.split("/"),Pe=await H.get(`/api/openrouter/models/${encodeURIComponent(Q)}/${encodeURIComponent(Ce.join("/"))}/endpoints`);as.value=Pe.endpoints||[]}catch(Q){as.value=[],Ue(Q.message||"Failed to load OpenRouter provider routes","error")}finally{un.value=!1}}function q(){jt.value=null,ua.value="",as.value=[]}async function ne(v,F=""){try{await Pa(v.id,F);const Q=Ln(),Ce=`compat:${v.id}`;if(Q.some(ct=>Ms(ct)===Ce)||Q.push(Ce),!await Da(Q,F?"OpenRouter model added and provider pinned.":"OpenRouter model added unpinned."))return;q(),await _a()}catch(Q){Ue(Q.message||"Failed to add OpenRouter model","error")}}const Se=v=>v.startsWith("compat:")?v.slice(7):v,We=v=>{var F;return((F=ye.value.openrouter.model_pins)==null?void 0:F[Se(v)])||""},Ct=v=>Qt.value.length>1&&Da(Ln().filter(F=>Ms(F)!==v),"Model removed from allowlist");async function Vs(){var v,F;try{const Q=Ln();for(const Ce of((v=oe.value)==null?void 0:v.quick_add)||[])(F=Et.value.get(Ce))!=null&&F.agent_eligible&&(await Pa(Se(Ce),""),Q.some(Pe=>Ms(Pe)===Ce)||Q.push(Ce));await Da(Q,"Curated OpenRouter models added"),await _a()}catch(Q){Ue(Q.message||"Failed to add curated OpenRouter models","error")}}function qs(v){const F=v.hint_metadata||{},Q=[];return F.context_tokens&&Q.push(`context ${Number(F.context_tokens).toLocaleString()}`),F.max_output_tokens&&Q.push(`max output ${Number(F.max_output_tokens).toLocaleString()}`),F.structural_source&&Q.push(`source ${F.structural_source}`),Q.join("; ")}async function pn(v,F){const Q={...Ze.value.model_selection_hints||{}},Ce=F.trim();Ce?Q[v]=Ce:delete Q[v];try{const Pe=await H.put("/api/agents/model",{model_selection_hints:Q});Ze.value={...Ze.value,...Pe},o.agents=r(Ze.value),Ue("Model hint saved")}catch(Pe){Ue(Pe.message||"Failed to save model hint","error")}}function xa(v,F){const Q=Qt.value.indexOf(v);return!vs.value&&Q>=0&&Q+F>=0&&Q+F<Qt.value.length}async function Wg(v,F){const Q=Ln(),Ce=Q.findIndex(Pe=>Ms(Pe)===v);Ce<0||!xa(v,F)||([Q[Ce],Q[Ce+F]]=[Q[Ce+F],Q[Ce]],await Da(Q,"Agent Auto allowlist order saved"))}const oc=f(!0),rc=f(""),ju=f({configured:null,accounts:[]}),cc=f(null),vo=f(null),dc=f(""),al=f(null),uc=f(!1),pc=f(null),Vu=f(null),qu=f("");let pi=null;function Ue(v,F="success"){Te(v,F==="error"?"error":"success")}function Kg(v){if(!v)return"?";const F=v/(1024*1024*1024);return F>=1?F.toFixed(1)+" GB":(v/(1024*1024)).toFixed(0)+" MB"}function Jg(v){return Number.isFinite(Number(v))?Number(v).toLocaleString():"—"}function Zg(v){return v==null?"automatic (model-derived)":Number(v).toLocaleString()+" characters"}function Yg(v){const F=new Date(v);return Number.isNaN(F.getTime())?"unknown":F.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function Qg(v){return typeof v=="string"&&v.length>12?v.slice(0,8)+"…"+v.slice(-4):v}function Xg(v){return typeof v!="number"||!Number.isFinite(v)?"—":(v/1e3).toFixed(2)}function eb(v){return v==="temporary learned clamp"?"is-clamp":v==="override"?"is-override":"is-built-in"}function tb(v){const F=k.value.context_budget_overrides[v.model];return v.floor!=null&&Number.isFinite(Number(F))&&Number(F)>v.floor}function sb(v,F){const Q={...k.value.context_budget_overrides};F.target.value===""?delete Q[v]:Q[v]=Number(F.target.value),k.value.context_budget_overrides=Q,X.value=!0}function ab(v){k.value.context_utilization=v.target.value===""?"":Number(v.target.value),X.value=!0}function nb(v){const F={...k.value.context_budget_overrides};delete F[v],k.value.context_budget_overrides=F,X.value=!0}async function _a({quiet:v=!1,poll:F=!1}={}){if(!(F&&Z())){if(l&&await l,i)return i;v||(e.value=!0),i=(async()=>{await Promise.all([Ds({poll:F}),nl(),il(),ho({poll:F}),pa(),Nn({poll:F})]),await di(),Z()||Ee()})();try{await i}finally{i=null,v||(e.value=!1)}}}async function ib(){if(!(Z()||i)){if(l)return l;l=Promise.all([Ds({poll:!0}),nl({refreshModels:!1}),il({refreshModels:!1}),ho({poll:!0}),pa(),Nn({poll:!0})]).then(()=>{Z()||Ee()});try{await l}finally{l=null}}}async function Ds({preserveBasic:v=!1,preserveAdvanced:F=!1,poll:Q=!1}={}){var Ce,Pe,ct,Ts,$e,Xt;try{const De=await H.get("/api/llm/status"),Ft=Q&&Z();u.value=De,p.value=!1,Ft||(m.value.main=De.main_model||De.active_model||(De.active_provider==="compat"?`compat:${((Ce=De.openai_compatible)==null?void 0:Ce.model)||""}`:De.active_provider==="ollama"?`ollama:${((Pe=De.ollama)==null?void 0:Pe.model)||""}`:((ct=De.codex)==null?void 0:ct.model)||"gpt-6-sol")),!Ft&&De.codex&&!fi.pending()&&(v||(k.value.enabled=De.codex.enabled,k.value.model=De.codex.model||"gpt-6-sol",k.value.reasoning_effort=De.codex.reasoning_effort||"medium",k.value.agent_reasoning_effort=De.codex.agent_reasoning_effort||""),F||(k.value.request_timeout_seconds=De.codex.request_timeout_seconds??k.value.request_timeout_seconds,k.value.stream_stall_timeout_seconds=De.codex.stream_stall_timeout_seconds??k.value.stream_stall_timeout_seconds,k.value.retry={...k.value.retry,...De.codex.retry||{}},k.value.connection_pool={...k.value.connection_pool,...De.codex.connection_pool||{}},k.value.context_compression={...k.value.context_compression,...De.codex.context_compression||{}},!X.value&&!Fe.value&&(k.value.context_budget_overrides={...De.codex.context_budget_overrides||{}},k.value.context_utilization=De.codex.context_utilization??k.value.context_utilization))),!Ft&&De.ollama&&!mi.pending()&&(v||(_e.value.enabled=De.ollama.enabled,_e.value.base_url=De.ollama.base_url||"",_e.value.model=De.ollama.model||"",_e.value.max_tokens=De.ollama.max_tokens||4096,_e.value.num_ctx=De.ollama.num_ctx||32768),F||(_e.value.timeout=De.ollama.timeout??_e.value.timeout));const Bt=De.openai_compatible;!Ft&&Bt&&!Dn.pending()&&(v||(ye.value.enabled=Bt.enabled,ye.value.base_url=Bt.base_url||ye.value.base_url,ye.value.model=Bt.model||ye.value.model,ye.value.preset=Bt.preset||ye.value.preset,ye.value.reasoning_effort=Bt.reasoning_effort||"medium"),F||(ye.value.request_timeout_seconds=Bt.request_timeout_seconds??ye.value.request_timeout_seconds,ye.value.stream_stall_timeout_seconds=Bt.stream_stall_timeout_seconds??ye.value.stream_stall_timeout_seconds,ye.value.model_profiles=Bt.model_profiles||ye.value.model_profiles,ye.value.context_utilization=Bt.context_utilization??ye.value.context_utilization,ye.value.openrouter={...ye.value.openrouter,...Bt.openrouter||{}})),Ft||((Ts=m.value.main)!=null&&Ts.startsWith("compat:")?m.value.main_capability=(Bt==null?void 0:Bt.reasoning_effort)||"medium":($e=m.value.main)!=null&&$e.startsWith("ollama:")||(m.value.main_capability=((Xt=De.codex)==null?void 0:Xt.reasoning_effort)||"medium")),!Ft&&De.auxiliary&&(Ne.value=De.auxiliary,Mn.pending()||(ge.value.enabled=De.auxiliary.enabled,ge.value.model=De.auxiliary.model||"gpt-6-luna"))}catch{u.value||(u.value={active_provider:"",codex:{configured:null},ollama:{configured:null},openai_compatible:{configured:null}}),p.value=!0}}async function Nn({poll:v=!1}={}){const F=++ee;Y.value=!0,ue.value="";try{const Q=await H.get("/api/context/windows");if(F!==ee)return;B.value=Q,!(v&&Z())&&!Fe.value&&!X.value&&(k.value.context_budget_overrides=Object.fromEntries(Object.entries(Q.models||{}).filter(([,Ce])=>Ce.override!=null).map(([Ce,Pe])=>[Ce,Pe.override])),k.value.context_utilization=Q.utilization??k.value.context_utilization)}catch(Q){F===ee&&(ue.value=Q.message||"Failed to load context budgets")}finally{F===ee&&(Y.value=!1)}}async function nl({refreshModels:v=!0}={}){try{if(Ae.value=await H.get("/api/ollama/status"),Me.value=!1,Ae.value.model&&(Le.value=Ae.value.model),v&&Ae.value.configured)try{const F=await H.get("/api/ollama/models");se.value=F.models||[]}catch{se.value=[]}else if(v&&_e.value.base_url)try{const F=await H.post("/api/ollama/probe-models",{base_url:_e.value.base_url});se.value=F.models||[]}catch{se.value=[]}}catch{Me.value=!0}}async function pa(){oc.value=!0,rc.value="";try{ju.value=await H.get("/api/codex/status")}catch(v){rc.value=v.message||"Failed to fetch Codex status"}finally{oc.value=!1}}async function lb(){try{m.value.main.startsWith("compat:")&&ns.value&&await Pa(Se(m.value.main),We(m.value.main));try{await H.put("/api/llm/main-model",{model:m.value.main})}catch(v){if(!/404|not found/i.test(v.message||""))throw v;await H.post("/api/llm/switch",{model:m.value.main})}c("mainModel",m.value.main),Ue("Main model saved"),await _a()}catch(v){Ue(v.message||"Failed to save main model","error"),await Ds()}}async function ob(v){m.value.main_capability=v;const F=R.value;F&&(F.provider==="compat"&&F.capability!=="none"?(ye.value.reasoning_effort=v,await ol()):F.capability==="reasoning"?(k.value.reasoning_effort=v,await ll()):F.capability==="thinking"&&(await H.put("/api/openai-compatible/config",{thinking_mode:v}),Ue("Thinking mode saved")))}async function rb(v){m.value.agent_capability=v;const F=w.value,Q=(F==null?void 0:F.capability)||L.value;if(Q!=="none"){if(v===""||v==="auto"||Q==="reasoning"||Q==="mixed"){if(k.value.agent_reasoning_effort=v,Q==="thinking"){const Ce=await H.put("/api/agents/model",{thinking_mode:null});Ze.value={...Ze.value,...Ce}}await ll()}else if(Q==="thinking"){const Ce=await H.put("/api/agents/model",{thinking_mode:v});Ze.value={...Ze.value,...Ce},Ue("Agent thinking mode saved")}}}async function cb(){ze.value=!0;try{const v=await H.post("/api/ollama/reload");Ue(v.configured?"Ollama reloaded":v.reason||"Ollama not configured",v.configured?"success":"error"),await _a()}catch(v){Ue(v.message||"Reload failed","error")}finally{ze.value=!1}}async function db(){rt.value=!0;try{await H.post("/api/ollama/model",{model:Le.value}),Ue("Model set to "+Le.value),await _a()}catch(v){Ue(v.message||"Failed","error")}finally{rt.value=!1}}async function ub(){const v=_e.value.base_url;if(!v){Ue("Enter a base URL first","error");return}Xe.value=!0;try{const F=await H.post("/api/ollama/probe-models",{base_url:v});se.value=F.models||[],se.value.length?(Ue(se.value.length+" model(s) found"),!_e.value.model&&se.value.length&&(_e.value.model=se.value[0].name)):Ue("No models found at "+v,"error")}catch(F){Ue(F.message||"Could not reach Ollama","error")}finally{Xe.value=!1}}async function il({refreshModels:v=!0}={}){try{if(Zt.value=await H.get("/api/openai-compatible/status"),lt.value=!1,Zt.value.model&&(cs.value=Zt.value.model),v&&Zt.value.configured)try{const F=await H.get("/api/openai-compatible/models");gt.value=F.models||[]}catch{gt.value=[]}}catch{lt.value=!0}}async function pb(){oa.value=!0;try{const v=await H.post("/api/openai-compatible/reload");Ue(v.configured?"OpenAI-compatible reloaded":v.reason||"OpenAI-compatible not configured",v.configured?"success":"error"),await _a()}catch(v){Ue(v.message||"Reload failed","error")}finally{oa.value=!1}}async function fb(){js.value=!0;try{await H.post("/api/openai-compatible/model",{model:cs.value}),Ue("Model set to "+cs.value),await _a()}catch(v){Ue(v.message||"Failed","error")}finally{js.value=!1}}async function ll(){if(Fe.value){fi();return}Fe.value=!0;const v=Do(k.value);try{await H.put("/api/llm/codex/config",v),c("codexBasic",v),Ue("Codex config saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),pa()])}catch(F){Ue(F.message||"Failed","error");const Q=JSON.stringify(Do(k.value))!==JSON.stringify(v);await Promise.all([Ds({preserveBasic:Q,preserveAdvanced:!0}),pa()])}finally{Fe.value=!1}}async function Gu(){if(Fe.value)return;Fe.value=!0;const v=Po(k.value);try{await H.put("/api/llm/codex/config",v),c("codexAdvanced",v),JSON.stringify({context_budget_overrides:k.value.context_budget_overrides,context_utilization:k.value.context_utilization})===JSON.stringify({context_budget_overrides:v.context_budget_overrides,context_utilization:v.context_utilization})&&(X.value=!1),Ue("Codex advanced settings saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),pa(),Nn()])}catch(F){Ue(F.message||"Failed","error");const Q=JSON.stringify(Po(k.value))!==JSON.stringify(v);await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:Q}),pa(),Nn()])}finally{Fe.value=!1}}async function fc(){if(Ge.value){mi();return}Ge.value=!0;try{const v=Ke.value?_e.value.api_key:null,F=$o(_e.value,{includeApiKey:v!==null});await H.put("/api/llm/ollama/config",F),Ue("Ollama config saved"),v!==null&&_e.value.api_key===v&&(_e.value.api_key="",Ke.value=!1),c("ollamaBasic",$o(_e.value)),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){Ue(v.message||"Failed","error")}finally{Ge.value=!1}}async function Wu(){if(!Ge.value){Ge.value=!0;try{const v=$c(_e.value);await H.put("/api/llm/ollama/config",v),c("ollamaAdvanced",v),Ue("Ollama timeout saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){Ue(v.message||"Failed","error")}finally{Ge.value=!1}}}async function ol(){if(at.value){Dn();return}at.value=!0;try{const v=Je.value?ye.value.api_key:null,F=Mo(ye.value,{includeApiKey:v!==null});await H.put("/api/openai-compatible/config",F),Ue("OpenAI-compatible config saved"),v!==null&&ye.value.api_key===v&&(ye.value.api_key="",Je.value=!1),c("compatibleBasic",Mo(ye.value)),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){Ue(v.message||"Failed","error")}finally{at.value=!1}}async function Ku(){if(!at.value){at.value=!0;try{const v=Pc(ye.value);await H.put("/api/openai-compatible/config",v),c("compatibleAdvanced",v),Ue("OpenAI-compatible endpoint settings saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){Ue(v.message||"Failed","error")}finally{at.value=!1}}}async function mb(){if(G.value){Mn();return}G.value=!0;try{const v={...ge.value};await H.put("/api/llm/auxiliary/config",v),c("auxiliary",v),Ue("Auxiliary config saved"),await Ds()}catch(v){Ue(v.message||"Failed","error"),await Ds()}finally{G.value=!1}}const fi=Fo(ll),Mn=Fo(mb),mi=Fo(fc),Dn=Fo(ol),hb=()=>(fi.cancel(),ll()),vb=()=>(mi.cancel(),fc()),gb=()=>(Dn.cancel(),ol()),bb=()=>Gu(),yb=()=>Wu(),xb=()=>Ku();async function _b(v){const F=v.account_key+":"+v.model;j.value=F;try{const Q=await H.post("/api/context/windows/clear",{account_key:v.account_key,model:v.model});Ue(Q.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Nn()}catch(Q){Ue(Q.message||"Failed to clear clamp","error"),await Nn()}finally{j.value=null}}async function wb(v){try{await H.post("/api/codex/account/"+v+"/activate"),Ue("Active account switched"),await pa()}catch(F){Ue(F.message||"Failed","error")}}async function kb(v){cc.value=v;try{await H.post("/api/codex/account/"+v+"/refresh"),Ue("Token refreshed"),await pa()}catch(F){Ue(F.message||"Refresh failed","error")}finally{cc.value=null}}function Sb(v,F){vo.value=v,dc.value=F||""}async function Cb(v){try{await H.put("/api/codex/account/"+v+"/label",{label:dc.value}),Ue("Label updated"),vo.value=null,await pa()}catch(F){Ue(F.message||"Failed","error")}}async function Tb(v,F){if(await os({title:"Delete Codex account",message:`Delete ${F||"account #"+(v+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/codex/account/"+v),Ue("Deleted. Pool reloaded."),await pa()}catch(Ce){Ue(Ce.message||"Failed","error")}}async function Eb(){uc.value=!0;try{const v=await H.post("/api/codex/device-code");pc.value=v,al.value="pending",Ab(v)}catch(v){Ue(v.message||"Failed","error")}finally{uc.value=!1}}async function Ab(v){pi={cancelled:!1};const F=pi;try{const Q=await H.post("/api/codex/device-poll",{device_auth_id:v.device_auth_id,user_code:v.user_code,interval:v.interval});if(F.cancelled)return;Vu.value=Q,al.value="success",await _a()}catch(Q){if(F.cancelled)return;qu.value=Q.message||"Device login failed",al.value="error"}}function Rb(){pi&&(pi.cancelled=!0),al.value=null,pc.value=null}function Ju(){n||(n=!0,_a(),a=window.setInterval(ib,s))}function Zu(){n&&(n=!1,a!==null&&window.clearInterval(a),a=null)}return st(Ju),rs(Ju),Kt(Zu),xt(()=>{Zu(),pi&&(pi.cancelled=!0),fi.cancel(),Mn.cancel(),mi.cancel(),Dn.cancel()}),{pageRoot:t,allowlistModalOpen:ra,closeAllowlistModal:ba,allowlistSaving:vs,effectiveAllowlist:Qt,allowlistSummary:_t,resetAgentAllowlist:lc,selectedUnavailableReason:rn,selectedModelFacts:ca,loading:e,llmStatus:u,llmStatusLoadFailed:p,modelSelection:m,modelSelectorSearch:h,reasoningEfforts:b,neutralReasoningLevels:I,modelCatalog:g,modelGroups:x,selectedMainModel:R,selectedAgentModel:w,selectedAgentCapabilityValue:re,agentCapabilityKind:L,agentCapabilityEfforts:P,autoAllowlistModels:te,allowlistModel:O,allowlistModelEfforts:U,allowlistEntryCapabilityValue:$,modelOptionLabel:ce,agentModelAvailable:S,agentModelOptionLabel:_,advancedOpen:pe,codexForm:k,codexModelOptions:J,codexAgentModelOptions:K,mainEffortAllowed:Ie,agentEffortAllowed:ie,mainModelOptionDisabled:fe,agentModelOptionDisabled:me,auxForm:ge,auxData:Ne,auxModelOptions:A,onAuxModelChange:D,savingAux:G,saveAuxConfigDebounced:Mn,ollamaForm:_e,compatibleForm:ye,savingCodex:Fe,savingOllama:Ge,savingCompatible:at,probingOllama:Xe,ollamaKeyDirty:Ke,compatibleKeyDirty:Je,fetchCodexStatus:pa,ollamaStatus:Ae,ollamaStatusLoadFailed:Me,ollamaModels:se,ollamaSelectedModel:Le,reloading:ze,settingModel:rt,compatibleStatus:Zt,compatibleStatusLoadFailed:lt,compatibleModels:gt,visibleCompatibleModels:Yt,compatibleSelectedModel:cs,reloadingCompatible:oa,settingCompatibleModel:js,applyCompatiblePreset:Na,setOpenRouterList:ci,agentsConfig:Ze,compatibleAgentModels:Nt,ollamaAgentModels:mo,knownAgentModelRefs:Ma,agentModelLabel:ac,saveAgentsModel:nc,toggleAgentAutoAllowlist:ic,saveAllowlistEntryCapability:Xi,autoAllowlistGroups:E,structuralFacts:qs,saveModelHint:pn,canMoveAllowlist:xa,moveAgentAutoAllowlist:Wg,openRouterCatalogue:oe,openRouterCatalogueLoading:ke,openRouterCatalogueError:je,openRouterRecognized:ns,compatibleCatalogueStatus:On,compatibleCatalogueStatusClass:Re,openRouterSearch:kt,openRouterVendor:St,openRouterVendors:N,openRouterToolsOnly:cn,openRouterEligibleOnly:An,openRouterStandardOnly:dn,openRouterMeasuredCacheOnly:Rn,openRouterMaxPromptPrice:da,openRouterQuantization:ya,openRouterQuantizations:de,openRouterResults:qe,openRouterMatchCount:Qe,openRouterInlineFacts:At,openRouterSelectedFacts:bs,prepareOpenRouterModel:C,addOpenRouterModel:ne,removeOpenRouterModel:Ct,quickAddOpenRouter:Vs,openRouterModelMap:Et,openRouterPin:We,openRouterPendingModel:jt,openRouterPendingTag:ua,openRouterPendingEndpoints:as,openRouterPendingLoading:un,openRouterEndpointSort:In,openRouterSortedPendingEndpoints:oi,openRouterEndpointCacheFact:el,openRouterRate:ui,openRouterMetric:tl,openRouterRouteWarning:sl,cancelOpenRouterPending:q,codexLoading:oc,codexError:rc,codexData:ju,refreshing:cc,editingLabel:vo,labelValue:dc,contextWindows:B,contextWindowsLoading:Y,contextWindowsError:ue,contextBudgetRows:be,activeClampRows:he,activeContextBudget:we,clearingClamp:j,contextPolicyDirty:X,deviceState:al,deviceLoading:uc,deviceInfo:pc,deviceResult:Vu,deviceError:qu,fetchAll:_a,fetchLLMStatus:Ds,fetchOllamaStatus:nl,fetchCompatibleStatus:il,saveMainModel:lb,saveMainCapability:ob,saveAgentCapability:rb,reloadOllama:cb,setOllamaModel:db,reloadCompatible:pb,setCompatibleModel:fb,probeOllamaModels:ub,saveCodexConfig:ll,saveOllamaConfig:fc,saveCompatibleConfig:ol,saveCodexAdvancedConfig:Gu,saveOllamaAdvancedConfig:Wu,saveCompatibleAdvancedConfig:Ku,saveCodexConfigDebounced:fi,saveOllamaConfigDebounced:mi,saveCompatibleConfigDebounced:Dn,saveCodexConfigNow:hb,saveOllamaConfigNow:vb,saveCompatibleConfigNow:gb,saveCodexAdvancedConfigNow:bb,saveOllamaAdvancedConfigNow:yb,saveCompatibleAdvancedConfigNow:xb,activateAccount:wb,refreshAccount:kb,startEditLabel:Sb,saveLabel:Cb,deleteAccount:Tb,startDeviceLogin:Eb,cancelDeviceLogin:Rb,formatSize:Kg,fetchContextWindows:Nn,clearContextClamp:_b,setContextOverride:sb,setContextUtilization:ab,resetContextOverride:nb,overrideAboveFloor:tb,formatCount:Jg,formatContextCeiling:Zg,formatExpiry:Yg,shortAccountKey:Qg,provenanceClass:eb,formatDensity:Xg}}},Ff={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function SC(e){return Ff[e]||Ff[(e||"").toLowerCase()]||"text-gray-400"}const CC={template:`
  ...
  `,setup(){const e=f(!0),t=f({}),s=f([]),a=f({}),n=f({}),i=f(null),l=f(null),o=f(null),r=f(null),c=f(null),d=z(()=>{var _;return Object.values(((_=i.value)==null?void 0:_.totals)||{}).reduce((E,R)=>E+Number(R||0),0)}),u=f(""),p=f(0),m=f([]),h=z(()=>m.value.map(_=>`${_.label} (${_.path}${_.reason?`: ${_.reason}`:""})`).join("; ")),b=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let I=null;async function k(){var O;const _=await Promise.allSettled(b.map(U=>H.get(U.path))),E=U=>_[U].status==="fulfilled"?_[U].value:null;t.value=E(0)||{};const R=E(1);s.value=Array.isArray(R)?R:R&&R.subsystems||[],a.value=E(2)||{},n.value=E(3)||{},i.value=E(4),l.value=E(5),o.value=E(6),r.value=E(7),c.value=E(8);const w=_.filter(U=>U.status==="rejected");if(m.value=_.flatMap((U,T)=>{var $;return U.status==="rejected"?[{...b[T],reason:(($=U.reason)==null?void 0:$.message)||"request failed"}]:[]}),p.value=m.value.length,w.length===_.length){const U=(O=w[0])==null?void 0:O.reason;u.value=(U==null?void 0:U.message)||"Failed to load internals"}else u.value="";e.value=!1}function y(){e.value=!0,u.value="",k()}let g=!1;function x(){g||(g=!0,k(),I||(I=setInterval(k,3e4)))}function S(){g&&(g=!1,I&&(clearInterval(I),I=null))}return st(x),rs(x),Kt(S),xt(S),{loading:e,error:u,failedCount:p,failedEndpoints:m,failedEndpointSummary:h,endpoints:b,retry:y,startup:t,subsystems:s,sshPool:a,httpPool:n,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:o,freshnessStats:r,governorStats:c,statusColor:SC,formatAgeSeconds:WS}}},TC=1e4,Bf=3e4;function hl(e,t){return Math.max(0,e-t)}function Fc(e,t){return new Set((e.operations||[]).map(a=>a.state)).has("MANUAL_RESOLUTION_REQUIRED")?0:e.expired_lease||e.status==="ACTIVE"&&(!e.lease_expires_at||e.lease_expires_at<t)?1:e.status==="SUSPENDED"?2:e.status==="ACTIVE"?3:4}const EC=[{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],AC={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(null),t=f(""),s=f(null),a=f(!1),n=f(0),i=f(null),l=f(""),o=f(null),r=f(!1),c=f(0),d=f(Date.now());let u=null,p=0,m=0;async function h(){const L=++p;a.value=!0;try{const P=await H.get("/api/turn-state/turns?limit=100");if(L!==p)return;t.value=P.availability,e.value=P.availability==="available"?P.data:null,s.value=null,n.value=Date.now()}catch(P){if(L!==p)return;s.value=P.message||"Turn-state read failed",P.status===503&&(t.value="unavailable")}L===p&&(a.value=!1)}async function b(){const L=++m;r.value=!0;try{const P=await H.get("/api/turn-state/capacity-breakers");if(L!==m)return;l.value=P.availability,i.value=P.availability==="available"?P.data:null,o.value=null,c.value=Date.now()}catch(P){if(L!==m)return;o.value=P.message||"Breaker read failed",P.status===503&&(l.value="unavailable")}L===m&&(r.value=!1)}function I(){h(),b()}const k=z(()=>e.value!==null&&hl(d.value,n.value)>Bf),y=z(()=>i.value!==null&&hl(d.value,c.value)>Bf),g=z(()=>k.value||y.value),x=z(()=>Math.round(hl(d.value,n.value)/1e3)),S=z(()=>Math.round(hl(d.value,c.value)/1e3));function _(L){return Fc(L,d.value/1e3)}function E(L){return EC[_(L)]}const R=z(()=>{var re;const L=[...((re=e.value)==null?void 0:re.turns)||[]],P=d.value/1e3;return L.sort((ce,J)=>Fc(ce,P)-Fc(J,P)||(J.last_progress_at||0)-(ce.last_progress_at||0))});function w(L){return L.state==="closed"?"badge-success":L.state==="probing"?"badge-warning":"badge-danger"}function O(L){if(L.state==="closed")return"—";const P=hl(d.value,c.value)/1e3,re=Math.max(0,(L.cooldown_remaining_seconds||0)-P);return re>0?`${Math.ceil(re)}s`:L.state==="probing"?"probe in flight":"probe eligible"}function U(L){if(!L)return"";const P=Math.max(0,Math.round(d.value/1e3-L));if(P<90)return`${P}s ago`;const re=Math.round(P/60);return re<90?`${re}m ago`:`${Math.round(re/60)}h ago`}let T=null,$=null,te=!1;function W(){te||(te=!0,I(),T=setInterval(I,TC),u=setInterval(()=>{d.value=Date.now()},1e3),$=ut.onReconnected(I))}function M(){te&&(te=!1,T&&(clearInterval(T),T=null),u&&(clearInterval(u),u=null),$&&($(),$=null))}return st(W),rs(W),Kt(M),xt(M),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:a,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:k,breakersStale:y,anyStale:g,turnsAgeSeconds:x,breakersAgeSeconds:S,sortedTurns:R,priorityOf:_,priorityBadge:E,breakerBadge:w,cooldownLabel:O,ageLabel:U,fetchTurns:h,fetchBreakers:b,refreshAll:I,arm:W,disarm:M}}},RC={setup(){const e=f(""),t=f(""),s=f(!1),a=f(""),n=f(!1),i=f(!1),l=f(!1),o=f(null),r=f(!1);async function c(){n.value=!0,o.value=null,r.value=!1;try{const u=await H.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,a.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{n.value=!1}}async function d(){if(await os({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await H.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return st(c),{current:e,latest:t,updateAvailable:s,changelog:a,checking:n,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},Uf=e=>JSON.parse(JSON.stringify(e)),IC=(e,t)=>JSON.stringify(e)===JSON.stringify(t),OC={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=f([]),a=f({}),n=f({}),i=f(!1),l=f(!1),o=f(!1),r=f(!1),c=f(!1),d=f(""),u=f("");let p=!1,m=0,h=null;const b=(M,L)=>p&&m===M&&H.token===L,I=M=>"computer-provisioning-"+M.key,k=M=>M===null?"Unset":M===""?"Empty":JSON.stringify(M),y=M=>{const L=n.value[M.key];return M.type==="array"?String(L||"").split(/\r?\n/).map(P=>P.trim()).filter(Boolean):["integer","number"].includes(M.type)?L===""||L==null?null:Number(L):L},g=z(()=>s.value.map(M=>({...M,value:y(M)})).filter(M=>!IC(M.value,a.value[M.key]))),x=z(()=>s.value.filter(M=>M.pending_restart).map(M=>M.label)),S=z(()=>s.value.some(M=>M.apply_state==="unknown")),_=z(()=>{const M={};for(const L of s.value){const P=y(L),re=L.constraints||{};["integer","number"].includes(L.type)&&(P===null&&!L.nullable?M[L.key]="A number is required.":P!==null&&(!Number.isFinite(P)||L.type==="integer"&&!Number.isInteger(P)||re.minimum!=null&&P<re.minimum||re.maximum!=null&&P>re.maximum)&&(M[L.key]="Enter a number within the allowed range.")),L.key==="monitor_names"&&(P.length>16||new Set(P).size!==P.length||P.some(ce=>!/^[A-Za-z0-9_.-]{1,64}$/.test(ce)))&&(M[L.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return M}),E=z(()=>Object.keys(_.value).length>0);function R(M,L){n.value[M.key]=L,u.value=""}function w(){n.value=Object.fromEntries(s.value.map(M=>[M.key,M.type==="array"?a.value[M.key].join(`
`):a.value[M.key]])),r.value=!1}async function O(M,L){const[P,re]=await Promise.all([H.get("/api/config"),H.get("/api/config/meta")]);if(!b(M,L))return!1;const ce=(re.fields||[]).filter(J=>/^computer\.[^.]+$/.test(J.path)&&J.path!=="computer.enabled"&&J.sensitivity==="public"&&J.apply_mode==="restart");if(!P.computer||!ce.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=ce.map(J=>({...J,key:J.path.split(".")[1]})),a.value=Object.fromEntries(s.value.map(J=>[J.key,Uf(P.computer[J.key])])),w(),h=L,i.value=!0,c.value=!1,!0}async function U(){if(!p||l.value||o.value)return;const M=++m,L=H.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await O(M,L)}catch(P){b(M,L)&&(c.value=!0,d.value=P.message||"Could not load provisioning. No changes were sent.")}finally{b(M,L)&&(l.value=!1)}}function T(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!E.value&&(r.value=!0)}async function $(){if(!p||!i.value||!r.value||o.value||l.value||c.value||E.value||!g.value.length)return;if(h!==H.token){W(),te();return}const M={computer:Object.fromEntries(g.value.map(ce=>[ce.key,Uf(ce.value)]))},L=m,P=H.token;o.value=!0,d.value="",u.value="";let re=!1;try{if(await H.put("/api/config",M),re=!0,!b(L,P))return;await O(L,P)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(ce){b(L,P)&&(c.value=!0,r.value=!1,d.value=re?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${ce.status===400?": "+ce.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{b(L,P)&&(o.value=!1)}}function te(){p||(p=!0,U())}function W(){p=!1,m++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,h=null,s.value=[],a.value={},n.value={},d.value="",u.value=""}return st(te),rs(te),Kt(W),xt(W),{fields:s,original:a,draft:n,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:x,effectiveUnknown:S,changes:g,validation:_,invalid:E,fieldId:I,format:k,edit:R,discard:w,load:U,openReview:T,save:$}}},LC={components:{ComputerProvisioning:OC},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),a=f(!1),n=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(0),p=f(""),m=f(""),h=f(null),b=f(""),I=f(!1),k=f(Date.now()),y=f(""),g=f(null);let x=0,S=null,_=!1,E=H.token,R=0,w=null,O=null,U=!1;const T=j=>j===!0?"Enabled":j===!1?"Disabled":"Unknown",$=z(()=>{var j;return((j=e.value.backend)==null?void 0:j.environment)==="existing_session"}),te=z(()=>{var X;const j=Date.parse(((X=e.value.accessibility)==null?void 0:X.checked_at)||"");return c.value&&Number.isFinite(j)&&k.value-j<15e3&&k.value>=j-5e3}),W=z(()=>{var j;return te.value?T((j=e.value.accessibility)==null?void 0:j.enabled):"Unknown / not current"}),M=z(()=>{var j;return te.value?((j=e.value.accessibility)==null?void 0:j.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),L=z(()=>Object.entries(e.value.input_limits||{}).filter(([,j])=>typeof j=="number"&&Number.isFinite(j)).map(([j,X])=>`${j}: ${X}`).join(", ")),P=z(()=>{var X;const j=(X=e.value.application_provenance)==null?void 0:X.script_identity;return typeof j=="string"?j:!j||typeof j!="object"?"Not observed":`${j.interpreter_basename||"Unknown interpreter"}; argv digest ${j.argv_digest||"not recorded"}; ${j.verified===!0?"verified":"not verified"}`}),re=z(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(j=>j&&typeof j.id=="string"&&typeof j.label=="string"&&["supported","capture_only"].includes(j.input)).slice(0,16):[]),ce=z(()=>{const j=e.value.restart_required;return Array.isArray(j)?j.length?j.join(", "):"None reported":j===!0?"Pending; restart required":j===!1?"None reported":"Unknown"}),J=z(()=>{var X,ee;const j=Date.parse(((X=h.value)==null?void 0:X.captured_at)||"");return Number.isFinite(j)&&k.value<j+Math.min(1e4,((ee=h.value)==null?void 0:ee.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function K(){b.value&&URL.revokeObjectURL(b.value),b.value="",h.value=null}function ae(){x++,K(),g.value=null,c.value=!1,w==null||w.abort(),w=null,t.value=!1,m.value="",s.value=!1,i.value=!1,l.value=!1}function V(j,X){return _&&j===x&&X===H.token}function ve(){return _&&c.value&&O===H.token&&Date.now()-u.value<15e3}function Ie(j,X="mutation"){var be,he;ae(),U=!0,p.value="";const ee=j.status||(j.name==="AuthError"?401:0);[401,403,404].includes(ee)?(u.value=0,O=null,e.value={available:!1,state:"unknown"}):u.value||(e.value={available:!1,state:ee===503?"unavailable":"unknown"}),o.value=ee===401||ee===403||ee===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":ee===410?"Evidence or artifact expired. Observe or prepare the export again.":X==="read"?"Status refresh failed. Last-known details are not current. No mutation was requested by this read.":X==="acknowledged"?"The mutation was acknowledged, but status refresh failed. Refresh status independently; do not replay the change.":"Request failed; outcome unknown. Refresh status. No action was replayed.",X==="mutation"&&![401,403,404].includes(ee)&&typeof((be=j.data)==null?void 0:be.code)=="string"&&/^[a-z_]{1,64}$/.test(j.data.code)&&typeof((he=j.data)==null?void 0:he.error)=="string"&&(o.value=j.data.error.slice(0,512),j.data.outcome==="not_applied"&&j.data.next_action==="repair_provisioning"&&typeof j.data.remedy=="string"&&(o.value="Not applied (preflight rejection). "+o.value,p.value=j.data.remedy.slice(0,1024)))}async function ie(){if(t.value||r.value||a.value||n.value||d.value||!_)return;const j=x,X=H.token;t.value=!0,R=Date.now();const ee=new AbortController;w=ee;try{const be=await H.get("/api/computer",{signal:ee.signal});if(!V(j,X))return;le(be)}catch(be){V(j,X)&&Ie(be,"read")}finally{w===ee&&(w=null,t.value=!1)}}function le(j,X=""){if(!j||typeof j!="object"||typeof j.state!="string"||typeof j.available!="boolean")throw new Error("Invalid status");(e.value.session_id&&e.value.session_id!==j.session_id||e.value.generation!=null&&e.value.generation!==j.generation||e.value.session_generation!=null&&e.value.session_generation!==j.session_generation)&&ae(),e.value=j,u.value=Date.now(),O=H.token,c.value=!(r.value&&X!=="toggle")&&!(a.value&&X!=="stop")&&!(n.value&&X!=="pause")&&!(d.value&&X!=="recovery"),o.value="",p.value="",U=!c.value}async function fe(j){if(!ve()||r.value||a.value||n.value||d.value)return;ae();const X=x,ee=H.token;r.value=!0;let be=!1;try{if(await H.post("/api/computer/enabled",{enabled:j}),be=!0,!V(X,ee))return;const he=await H.get("/api/computer");V(X,ee)&&le(he,"toggle")}catch(he){V(X,ee)&&Ie(he,be?"acknowledged":"mutation")}finally{r.value=!1}}async function me(j){if(!_||!["pause","stop"].includes(j)||(j==="stop"?a.value:n.value))return;ae();const X=x,ee=H.token,be=j==="stop"?a:n;be.value=!0;let he=!1;try{if(await H.post("/api/computer/"+j,{}),he=!0,V(X,ee)){const we=await H.get("/api/computer");V(X,ee)&&le(we,j)}}catch(we){V(X,ee)&&Ie(we,he?"acknowledged":"mutation")}finally{be.value=!1}}async function ge(){var be;if(!ve()||d.value||((be=e.value.backend)==null?void 0:be.native_backend)!=="hyprland")return;const j={session_id:e.value.session_id,generation:e.value.session_generation};if(!j.session_id||!Number.isInteger(j.generation))return;ae();const X=x,ee=H.token;d.value=!0;try{const he=await H.post("/api/computer/release_owned_input",j);V(X,ee)&&le(he,"recovery")}catch(he){V(X,ee)&&Ie(he,"mutation")}finally{d.value=!1}}async function Ne(){return D(!1)}async function A(){return D(!0)}async function D(j){var _e;if(!ve()||d.value||r.value||a.value||n.value||e.value.state!=="quarantined")return;const X={session_id:e.value.session_id,generation:e.value.session_generation};if(!X.session_id||!Number.isInteger(X.generation))return;if(j){if(m.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+X.session_id)return;X.acknowledgment=m.value}const ee=j?((_e=e.value.recovery)==null?void 0:_e.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";ae();const be=x,he=H.token;d.value=!0;let we=!1;try{const ye=await H.post("/api/computer/"+ee,X);we=!0,V(be,he)&&le(ye,"recovery")}catch(ye){V(be,he)&&Ie(ye,we?"acknowledged":"mutation")}finally{d.value=!1}}async function G(){var ee;if(!ve()||s.value||!e.value.available)return;K(),I.value=!1;const j=x,X=H.token;s.value=!0;try{const be=await H.post("/api/computer/observe",{});if(!V(j,X))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((ee=be.frame)==null?void 0:ee.evidence_id)||""))throw new Error("Invalid evidence");const he=await H.getBlob("/api/computer/evidence/"+be.frame.evidence_id);if(!V(j,X))return;if(!["image/png","image/jpeg"].includes(he.type)||he.size>2097152||!Number.isFinite(Date.parse(be.frame.expires_at))||Date.parse(be.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");h.value=be.frame,b.value=URL.createObjectURL(he),o.value=""}catch(be){V(j,X)&&Ie(be)}finally{j===x&&(s.value=!1)}}async function pe(){if(!ve()||i.value||!e.value.available)return;g.value=null;const j=x,X=H.token;i.value=!0;try{const ee=await H.post("/api/computer/export",{name:y.value});V(j,X)&&(g.value=ee,o.value="")}catch(ee){V(j,X)&&Ie(ee)}finally{j===x&&(i.value=!1)}}async function B(){if(!ve()||l.value||!g.value)return;const j=x,X=H.token,ee=g.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((ee==null?void 0:ee.artifact_id)||""))throw new Error("Invalid export");const be=await H.getBlob("/api/computer/download/"+ee.artifact_id);if(!V(j,X))return;const he=URL.createObjectURL(be),we=document.createElement("a");we.href=he,we.download=ee.name,we.click(),setTimeout(()=>URL.revokeObjectURL(he),1e3)}catch(be){V(j,X)&&Ie(be)}finally{j===x&&(l.value=!1)}}function Y(){_||(E!==H.token&&(E=H.token,ae(),u.value=0,O=null,e.value={state:"unknown",available:!1},o.value="",p.value=""),_=!0,ie(),S=setInterval(()=>{k.value=Date.now(),E!==H.token&&(E=H.token,ae(),u.value=0,O=null,o.value="",p.value="",e.value={state:"unknown",available:!1}),c.value&&k.value-u.value>=15e3&&ae(),h.value&&Date.parse(h.value.expires_at)<=k.value&&(K(),I.value=!0),g.value&&Date.parse(g.value.expires_at)<=k.value&&(g.value=null),!U&&k.value-R>=5e3&&ie()},500))}function ue(){_=!1,clearInterval(S),S=null,ae(),c.value=!1}return st(Y),rs(Y),Kt(ue),xt(ue),{status:e,checkedAt:u,remedy:p,loading:t,observing:s,stopping:a,pausing:n,exporting:i,downloading:l,error:o,frame:h,frameUrl:b,frameExpired:I,freshness:J,name:y,artifact:g,refresh:ie,control:me,observe:G,clearFrame:K,exportFile:pe,download:B,toggling:r,adminReady:c,enabledLabel:T,restartSettings:ce,setEnabled:fe,recovering:d,recover:Ne,reconcile:A,releaseOwnedInput:ge,reconciliationAck:m,applicationProfiles:re,attached:$,scriptIdentity:P,inputLimits:L,accessibilityLabel:W,accessibilityDetail:M}}},Og=[{id:"health",label:"Health",component:z1},{id:"resources",label:"Resources",component:H1},{id:"logs",label:"Logs",component:eC},{id:"config",label:"Config",component:pC},{id:"discord",label:"Discord",component:mC},{id:"hosts",label:"Hosts",component:gC},{id:"host-access",label:"Host Access",component:vC},{id:"api-tokens",label:"API Tokens",component:bC},{id:"llm",label:"LLM Config",component:kC},{id:"internals",label:"Internals",component:CC},{id:"turn-state",label:"Turn State",component:AC},{id:"computer",label:"Computer",component:LC},{id:"update",label:"Update",component:RC}],NC={components:{TabbedPage:Xr},setup(){return{tabs:Og}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Bo=(e,t,s,a)=>a.map(({id:n,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:n}}})),MC=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Bo("Operations","operations","/operations",_g),...Bo("History","history","/history",wg),...Bo("Capabilities","capabilities","/capabilities",kg),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Bo("System","system","/system",Og)],Fs=Tn({open:!1,query:"",selected:0});function zf(){Fs.query="",Fs.selected=0,Fs.open=!0}function Bc(){Fs.open=!1}function DC(e,t){const s=e.label.toLowerCase(),a=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:a.startsWith(t)?80:s.includes(t)?60:a.includes(t)?40:0:1}const PC={setup(){const e=fg(),t=f(null),s=z(()=>{const i=Fs.query.trim().toLowerCase();return MC.map(l=>({...l,_score:DC(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Wt(()=>Fs.open,async i=>{var l;i&&(await zt(),(l=t.value)==null||l.focus())}),Wt(()=>Fs.query,()=>{Fs.selected=0});function a(i){Bc(),e.push(i.to)}function n(i){if(i.key==="Escape"){i.preventDefault(),Bc();return}if(i.key==="ArrowDown")i.preventDefault(),Fs.selected=Math.min(Fs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Fs.selected=Math.max(Fs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Fs.selected];l&&a(l)}}return{state:Fs,results:s,inputEl:t,go:a,onKeydown:n,closePalette:Bc}},template:`
    <transition name="modal">
  ...
  `},Td={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(Td));const $C={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>Ui("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[Ui("path",{d:Td[e.name]||Td.info})])}},FC=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function Hf(e){return[...e.querySelectorAll(FC)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const BC={mounted(e){const t=document.activeElement,s=a=>{if(a.key!=="Tab")return;const n=Hf(e);if(!n.length){a.preventDefault(),e.focus();return}const i=n[0],l=n[n.length-1];a.shiftKey&&document.activeElement===i?(a.preventDefault(),l.focus()):!a.shiftKey&&document.activeElement===l&&(a.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||Hf(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},UC={template:`
    ...
    </div>`,setup(){const e=f({}),t=f(!0),s=f(null),a=f([]),n=f(!1),i=f([]),l=f(!1),o=f(!1),r=f([]),c=f(0),d=f(null),u=f({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const m=z(()=>{const ce=e.value.uptime_seconds||0,J=Math.floor(ce/86400),K=Math.floor(ce%86400/3600),ae=Math.floor(ce%3600/60),V=[];return J>0&&V.push(`${J}d`),K>0&&V.push(`${K}h`),(V.length===0||J===0&&K===0)&&V.push(`${ae}m`),V.join(" ")}),h=z(()=>{const ce=e.value.uptime_seconds||0;return 125.66*(1-Math.min(ce/86400,1))}),b=z(()=>{const ce=e.value;return[{label:"Guilds",value:ce.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:ce.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:ce.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${ce.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:ce.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:ce.loop_count>0?"text-green-400":"",highlight:ce.loop_count>0},{label:"Agents",value:ce.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:ce.agent_count>0?`${ce.agent_count} total`:"",subColor:"text-gray-500",highlight:(ce.agent_running??0)>0},{label:"Processes",value:ce.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:ce.process_count>0?`${ce.process_count} total`:"",subColor:"text-gray-500",highlight:(ce.process_running??0)>0},{label:"Schedules",value:ce.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(ce.schedule_failing>0?`${ce.schedule_failing} failing`:"")+(ce.schedule_failing>0&&ce.schedule_paused>0?", ":"")+(ce.schedule_paused>0?`${ce.schedule_paused} paused`:"")||void 0,subColor:ce.schedule_failing>0?"text-red-400":"text-yellow-400",color:ce.schedule_failing>0?"text-red-400":"",highlight:ce.schedule_failing>0},{label:"Users",value:ce.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),I=z(()=>{const ce=e.value,J=[];return J.push({label:"Bot",status:ce.status==="online"?"ok":"warn",detail:ce.status==="online"?"Online":"Starting"}),(ce.schedule_failing||0)>0?J.push({label:"Schedules",status:"error",detail:`${ce.schedule_failing} failing`}):(ce.schedule_count||0)>0&&J.push({label:"Schedules",status:"ok",detail:`${ce.schedule_count} configured`}),(ce.loop_count||0)>0&&J.push({label:"Loops",status:"ok",detail:`${ce.loop_count} active`}),(ce.agent_running||0)>0&&J.push({label:"Agents",status:"ok",detail:`${ce.agent_running} running`}),(ce.process_running||0)>0&&J.push({label:"Processes",status:"ok",detail:`${ce.process_running} running`}),J});async function k(){try{e.value=await H.get("/api/status"),s.value=null}catch(ce){s.value=ce.message}finally{t.value=!1}}let y=0,g=0,x=0,S=0;function _(ce,J){const K=new Set;return[...J,...ce].filter(ae=>{const V=ae._hmac||JSON.stringify([ae.timestamp,ae.tool_name,ae.user_id,ae.result_summary,ae.error]);return K.has(V)?!1:(K.add(V),!0)})}async function E(){const ce=++y,J=x;n.value=!0;try{const K=await H.get("/api/audit?limit=10");if(ce!==y)return;const ae=J===x?[]:a.value.filter(V=>(V._liveEpoch||0)>J);a.value=_(K,ae).slice(0,10),c.value=ae.length}catch{}ce===y&&(n.value=!1)}async function R(){const ce=++g,J=S;l.value=!0;try{const K=await H.get("/api/audit?error_only=1&limit=5");if(ce!==g)return;const ae=J===S?[]:i.value.filter(V=>(V._liveErrorEpoch||0)>J);i.value=_(K,ae).slice(0,5),o.value=!1}catch{if(ce!==g)return;o.value=J===S||i.value.length===0}ce===g&&(l.value=!1)}async function w(){try{const ce=await H.get("/api/knowledge");d.value=(Array.isArray(ce)?ce:[]).reduce((J,K)=>J+(K.chunks||0),0)}catch{d.value=null}}async function O(){try{const ce=await H.get("/api/agents");r.value=ce.filter(J=>J.status==="running")}catch{}}async function U(){u.value={...u.value,reload:!0};try{await H.post("/api/reload"),Te.success("Config reloaded")}catch(ce){Te.error(ce.message)}u.value={...u.value,reload:!1}}async function T(){if(!await os({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const J=e.value.session_count;e.value={...e.value,session_count:0};try{const K=await H.post("/api/sessions/clear-all");Te.success(`Cleared ${K.count} session${K.count!==1?"s":""}`),await k()}catch(K){e.value={...e.value,session_count:J},Te.error(K.message)}u.value={...u.value,clearSessions:!1}}async function $(){if(!await os({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const J=e.value.loop_count;e.value={...e.value,loop_count:0};try{const K=await H.post("/api/loops/stop-all");Te.success(K.result),await k()}catch(K){e.value={...e.value,loop_count:J},Te.error(K.message)}u.value={...u.value,stopLoops:!1}}function te(){t.value=!0,s.value=null,k(),E(),R(),O()}let W=null,M=null,L=null;function P(ce){if(ce.payload&&ce.payload.tool_name){x+=1;const J={...ce.payload,_isNew:!0,_key:++p,_liveEpoch:x};a.value.unshift(J),a.value.length>10&&a.value.pop(),c.value++,J.error&&(S+=1,J._liveErrorEpoch=S,o.value=!1,i.value.unshift(J),i.value.length>5&&i.value.pop()),setTimeout(()=>{J._isNew=!1},1500),clearTimeout(L),L=setTimeout(()=>{c.value=0},1e4)}}let re=null;return st(async()=>{await Promise.all([k(),E(),R(),O(),w()]),W=setInterval(k,15e3),M=setInterval(O,1e4),ut.subscribe("events",P),re=ut.onReconnected(()=>{E(),R()})}),xt(()=>{W&&clearInterval(W),M&&clearInterval(M),clearTimeout(L),ut.unsubscribe("events",P),re&&(re(),re=null)}),{status:e,loading:t,error:s,uptime:m,uptimeRingOffset:h,stats:b,healthIndicators:I,activity:a,activityLoading:n,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:E,fetchErrors:R,fetchStatus:k,onEvent:P,formatTime:GS,formatDuration:Ji,retry:te,reloadConfig:U,clearSessions:T,stopAllLoops:$}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function jf(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,a=Array(t);s<t;s++)a[s]=e[s];return a}function zC(e){if(Array.isArray(e))return e}function HC(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var a,n,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(a=i.call(s)).done)&&(o.push(a.value),o.length!==t);r=!0);}catch(d){c=!0,n=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw n}}return o}}function jC(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function VC(e,t){return zC(e)||HC(e,t)||qC(e,t)||jC()}function qC(e,t){if(e){if(typeof e=="string")return jf(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?jf(e,t):void 0}}const Lg=Object.entries,Vf=Object.setPrototypeOf,GC=Object.isFrozen,WC=Object.getPrototypeOf,KC=Object.getOwnPropertyDescriptor;let Ns=Object.freeze,la=Object.seal,Si=Object.create,Ng=typeof Reflect<"u"&&Reflect,Ed=Ng.apply,Ad=Ng.construct;Ns||(Ns=function(t){return t});la||(la=function(t){return t});Ed||(Ed=function(t,s){for(var a=arguments.length,n=new Array(a>2?a-2:0),i=2;i<a;i++)n[i-2]=arguments[i];return t.apply(s,n)});Ad||(Ad=function(t){for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return new t(...a)});const Ua=Jt(Array.prototype.forEach),JC=Jt(Array.prototype.lastIndexOf),qf=Jt(Array.prototype.pop),yi=Jt(Array.prototype.push),ZC=Jt(Array.prototype.splice),As=Array.isArray,kl=Jt(String.prototype.toLowerCase),Uc=Jt(String.prototype.toString),Gf=Jt(String.prototype.match),xi=Jt(String.prototype.replace),Wf=Jt(String.prototype.indexOf),YC=Jt(String.prototype.trim),QC=Jt(Number.prototype.toString),XC=Jt(Boolean.prototype.toString),Kf=typeof BigInt>"u"?null:Jt(BigInt.prototype.toString),Jf=typeof Symbol>"u"?null:Jt(Symbol.prototype.toString),Dt=Jt(Object.prototype.hasOwnProperty),vl=Jt(Object.prototype.toString),us=Jt(RegExp.prototype.test),Fn=eT(TypeError);function Jt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return Ed(e,t,a)}}function eT(e){return function(){for(var t=arguments.length,s=new Array(t),a=0;a<t;a++)s[a]=arguments[a];return Ad(e,s)}}function tt(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:kl;if(Vf&&Vf(e,null),!As(t))return e;let a=t.length;for(;a--;){let n=t[a];if(typeof n=="string"){const i=s(n);i!==n&&(GC(t)||(t[a]=i),n=i)}e[n]=!0}return e}function tT(e){for(let t=0;t<e.length;t++)Dt(e,t)||(e[t]=null);return e}function xs(e){const t=Si(null);for(const a of Lg(e)){var s=VC(a,2);const n=s[0],i=s[1];Dt(e,n)&&(As(i)?t[n]=tT(i):i&&typeof i=="object"&&i.constructor===Object?t[n]=xs(i):t[n]=i)}return t}function sT(e){switch(typeof e){case"string":return e;case"number":return QC(e);case"boolean":return XC(e);case"bigint":return Kf?Kf(e):"0";case"symbol":return Jf?Jf(e):"Symbol()";case"undefined":return vl(e);case"function":case"object":{if(e===null)return vl(e);const t=e,s=Sa(t,"toString");if(typeof s=="function"){const a=s(t);return typeof a=="string"?a:vl(a)}return vl(e)}default:return vl(e)}}function Sa(e,t){for(;e!==null;){const a=KC(e,t);if(a){if(a.get)return Jt(a.get);if(typeof a.value=="function")return Jt(a.value)}e=WC(e)}function s(){return null}return s}function aT(e){try{return us(e,""),!0}catch{return!1}}const Zf=Ns(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),zc=Ns(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Hc=Ns(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),nT=Ns(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),jc=Ns(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),iT=Ns(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Yf=Ns(["#text"]),Qf=Ns(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Vc=Ns(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Xf=Ns(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Uo=Ns(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),lT=la(/{{[\w\W]*|^[\w\W]*}}/g),oT=la(/<%[\w\W]*|^[\w\W]*%>/g),rT=la(/\${[\w\W]*/g),cT=la(/^data-[\-\w.\u00B7-\uFFFF]+$/),dT=la(/^aria-[\-\w]+$/),em=la(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),uT=la(/^(?:\w+script|data):/i),pT=la(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),fT=la(/^html$/i),mT=la(/^[a-z][.\w]*(-[.\w]+)+$/i),wa={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},hT=function(){return typeof window>"u"?null:window},vT=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let a=null;const n="data-tt-policy-suffix";s&&s.hasAttribute(n)&&(a=s.getAttribute(n));const i="dompurify"+(a?"#"+a:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},tm=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Mg(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:hT();const t=Re=>Mg(Re);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==wa.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const a=s,n=a.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,m=Sa(p,"cloneNode"),h=Sa(p,"remove"),b=Sa(p,"nextSibling"),I=Sa(p,"childNodes"),k=Sa(p,"parentNode"),y=Sa(p,"shadowRoot"),g=Sa(p,"attributes"),x=l&&l.prototype?Sa(l.prototype,"nodeType"):null,S=l&&l.prototype?Sa(l.prototype,"nodeName"):null;if(typeof i=="function"){const Re=s.createElement("template");Re.content&&Re.content.ownerDocument&&(s=Re.content.ownerDocument)}let _,E="",R,w=!1,O=0;const U=function(){if(O>0)throw Fn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},T=function(N){U(),O++;try{return _.createHTML(N)}finally{O--}},$=function(N){U(),O++;try{return _.createScriptURL(N)}finally{O--}},te=function(){return w||(R=vT(u,n),w=!0),R},W=s,M=W.implementation,L=W.createNodeIterator,P=W.createDocumentFragment,re=W.getElementsByTagName,ce=a.importNode;let J=tm();t.isSupported=typeof Lg=="function"&&typeof k=="function"&&M&&M.createHTMLDocument!==void 0;const K=lT,ae=oT,V=rT,ve=cT,Ie=dT,ie=uT,le=pT,fe=mT;let me=em,ge=null;const Ne=tt({},[...Zf,...zc,...Hc,...jc,...Yf]);let A=null;const D=tt({},[...Qf,...Vc,...Xf,...Uo]);let G=Object.seal(Si(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),pe=null,B=null;const Y=Object.seal(Si(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let ue=!0,j=!0,X=!1,ee=!0,be=!1,he=!0,we=!1,_e=!1,ye=!1,Ke=!1,Je=!1,Fe=!1,Ge=!0,at=!1;const Xe="user-content-";let Z=!0,Ee=!1,Ae={},Me=null;const se=tt({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Le=null;const ze=tt({},["audio","video","img","source","image","track"]);let rt=null;const Zt=tt({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),lt="http://www.w3.org/1998/Math/MathML",gt="http://www.w3.org/2000/svg",Yt="http://www.w3.org/1999/xhtml";let cs=Yt,oa=!1,js=null;const Ze=tt({},[lt,gt,Yt],Uc);let ra=tt({},["mi","mo","mn","ms","mtext"]),vs=tt({},["annotation-xml"]);const Ms=tt({},["title","style","font","a","script"]);let gs=null;const En=["application/xhtml+xml","text/html"],Qt="text/html";let _t=null,ds=null;const ba=s.createElement("form"),rn=function(N){return N instanceof RegExp||N instanceof Function},ca=function(){let N=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(ds&&ds===N)return;(!N||typeof N!="object")&&(N={}),N=xs(N),gs=En.indexOf(N.PARSER_MEDIA_TYPE)===-1?Qt:N.PARSER_MEDIA_TYPE,_t=gs==="application/xhtml+xml"?Uc:kl,ge=Dt(N,"ALLOWED_TAGS")&&As(N.ALLOWED_TAGS)?tt({},N.ALLOWED_TAGS,_t):Ne,A=Dt(N,"ALLOWED_ATTR")&&As(N.ALLOWED_ATTR)?tt({},N.ALLOWED_ATTR,_t):D,js=Dt(N,"ALLOWED_NAMESPACES")&&As(N.ALLOWED_NAMESPACES)?tt({},N.ALLOWED_NAMESPACES,Uc):Ze,rt=Dt(N,"ADD_URI_SAFE_ATTR")&&As(N.ADD_URI_SAFE_ATTR)?tt(xs(Zt),N.ADD_URI_SAFE_ATTR,_t):Zt,Le=Dt(N,"ADD_DATA_URI_TAGS")&&As(N.ADD_DATA_URI_TAGS)?tt(xs(ze),N.ADD_DATA_URI_TAGS,_t):ze,Me=Dt(N,"FORBID_CONTENTS")&&As(N.FORBID_CONTENTS)?tt({},N.FORBID_CONTENTS,_t):se,pe=Dt(N,"FORBID_TAGS")&&As(N.FORBID_TAGS)?tt({},N.FORBID_TAGS,_t):xs({}),B=Dt(N,"FORBID_ATTR")&&As(N.FORBID_ATTR)?tt({},N.FORBID_ATTR,_t):xs({}),Ae=Dt(N,"USE_PROFILES")?N.USE_PROFILES&&typeof N.USE_PROFILES=="object"?xs(N.USE_PROFILES):N.USE_PROFILES:!1,ue=N.ALLOW_ARIA_ATTR!==!1,j=N.ALLOW_DATA_ATTR!==!1,X=N.ALLOW_UNKNOWN_PROTOCOLS||!1,ee=N.ALLOW_SELF_CLOSE_IN_ATTR!==!1,be=N.SAFE_FOR_TEMPLATES||!1,he=N.SAFE_FOR_XML!==!1,we=N.WHOLE_DOCUMENT||!1,Ke=N.RETURN_DOM||!1,Je=N.RETURN_DOM_FRAGMENT||!1,Fe=N.RETURN_TRUSTED_TYPE||!1,ye=N.FORCE_BODY||!1,Ge=N.SANITIZE_DOM!==!1,at=N.SANITIZE_NAMED_PROPS||!1,Z=N.KEEP_CONTENT!==!1,Ee=N.IN_PLACE||!1,me=aT(N.ALLOWED_URI_REGEXP)?N.ALLOWED_URI_REGEXP:em,cs=typeof N.NAMESPACE=="string"?N.NAMESPACE:Yt,ra=Dt(N,"MATHML_TEXT_INTEGRATION_POINTS")&&N.MATHML_TEXT_INTEGRATION_POINTS&&typeof N.MATHML_TEXT_INTEGRATION_POINTS=="object"?xs(N.MATHML_TEXT_INTEGRATION_POINTS):tt({},["mi","mo","mn","ms","mtext"]),vs=Dt(N,"HTML_INTEGRATION_POINTS")&&N.HTML_INTEGRATION_POINTS&&typeof N.HTML_INTEGRATION_POINTS=="object"?xs(N.HTML_INTEGRATION_POINTS):tt({},["annotation-xml"]);const de=Dt(N,"CUSTOM_ELEMENT_HANDLING")&&N.CUSTOM_ELEMENT_HANDLING&&typeof N.CUSTOM_ELEMENT_HANDLING=="object"?xs(N.CUSTOM_ELEMENT_HANDLING):Si(null);if(G=Si(null),Dt(de,"tagNameCheck")&&rn(de.tagNameCheck)&&(G.tagNameCheck=de.tagNameCheck),Dt(de,"attributeNameCheck")&&rn(de.attributeNameCheck)&&(G.attributeNameCheck=de.attributeNameCheck),Dt(de,"allowCustomizedBuiltInElements")&&typeof de.allowCustomizedBuiltInElements=="boolean"&&(G.allowCustomizedBuiltInElements=de.allowCustomizedBuiltInElements),be&&(j=!1),Je&&(Ke=!0),Ae&&(ge=tt({},Yf),A=Si(null),Ae.html===!0&&(tt(ge,Zf),tt(A,Qf)),Ae.svg===!0&&(tt(ge,zc),tt(A,Vc),tt(A,Uo)),Ae.svgFilters===!0&&(tt(ge,Hc),tt(A,Vc),tt(A,Uo)),Ae.mathMl===!0&&(tt(ge,jc),tt(A,Xf),tt(A,Uo))),Y.tagCheck=null,Y.attributeCheck=null,Dt(N,"ADD_TAGS")&&(typeof N.ADD_TAGS=="function"?Y.tagCheck=N.ADD_TAGS:As(N.ADD_TAGS)&&(ge===Ne&&(ge=xs(ge)),tt(ge,N.ADD_TAGS,_t))),Dt(N,"ADD_ATTR")&&(typeof N.ADD_ATTR=="function"?Y.attributeCheck=N.ADD_ATTR:As(N.ADD_ATTR)&&(A===D&&(A=xs(A)),tt(A,N.ADD_ATTR,_t))),Dt(N,"ADD_URI_SAFE_ATTR")&&As(N.ADD_URI_SAFE_ATTR)&&tt(rt,N.ADD_URI_SAFE_ATTR,_t),Dt(N,"FORBID_CONTENTS")&&As(N.FORBID_CONTENTS)&&(Me===se&&(Me=xs(Me)),tt(Me,N.FORBID_CONTENTS,_t)),Dt(N,"ADD_FORBID_CONTENTS")&&As(N.ADD_FORBID_CONTENTS)&&(Me===se&&(Me=xs(Me)),tt(Me,N.ADD_FORBID_CONTENTS,_t)),Z&&(ge["#text"]=!0),we&&tt(ge,["html","head","body"]),ge.table&&(tt(ge,["tbody"]),delete pe.tbody),N.TRUSTED_TYPES_POLICY){if(typeof N.TRUSTED_TYPES_POLICY.createHTML!="function")throw Fn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof N.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Fn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const xe=_;_=N.TRUSTED_TYPES_POLICY;try{E=T("")}catch(Be){throw _=xe,Be}}else N.TRUSTED_TYPES_POLICY===null?(_=void 0,E=""):(_===void 0&&(_=te()),_&&typeof E=="string"&&(E=T("")));(J.uponSanitizeElement.length>0||J.uponSanitizeAttribute.length>0)&&ge===Ne&&(ge=xs(ge)),J.uponSanitizeAttribute.length>0&&A===D&&(A=xs(A)),Ns&&Ns(N),ds=N},oe=tt({},[...zc,...Hc,...nT]),ke=tt({},[...jc,...iT]),je=function(N){let de=k(N);(!de||!de.tagName)&&(de={namespaceURI:cs,tagName:"template"});const xe=kl(N.tagName),Be=kl(de.tagName);return js[N.namespaceURI]?N.namespaceURI===gt?de.namespaceURI===Yt?xe==="svg":de.namespaceURI===lt?xe==="svg"&&(Be==="annotation-xml"||ra[Be]):!!oe[xe]:N.namespaceURI===lt?de.namespaceURI===Yt?xe==="math":de.namespaceURI===gt?xe==="math"&&vs[Be]:!!ke[xe]:N.namespaceURI===Yt?de.namespaceURI===gt&&!vs[Be]||de.namespaceURI===lt&&!ra[Be]?!1:!ke[xe]&&(Ms[xe]||!oe[xe]):!!(gs==="application/xhtml+xml"&&js[N.namespaceURI]):!1},Ve=function(N){yi(t.removed,{element:N});try{k(N).removeChild(N)}catch{if(h(N),!k(N))throw Fn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},kt=function(N){const de=I?I(N):N.childNodes;if(de){const Be=[];Ua(de,qe=>{yi(Be,qe)}),Ua(Be,qe=>{try{h(qe)}catch{}})}const xe=g?g(N):null;if(xe)for(let Be=xe.length-1;Be>=0;--Be){const qe=xe[Be],Qe=qe&&qe.name;if(typeof Qe=="string")try{N.removeAttribute(Qe)}catch{}}},St=function(N,de){try{yi(t.removed,{attribute:de.getAttributeNode(N),from:de})}catch{yi(t.removed,{attribute:null,from:de})}if(de.removeAttribute(N),N==="is")if(Ke||Je)try{Ve(de)}catch{}else try{de.setAttribute(N,"")}catch{}},cn=function(N){const de=g?g(N):N.attributes;if(de)for(let xe=de.length-1;xe>=0;--xe){const Be=de[xe],qe=Be&&Be.name;if(!(typeof qe!="string"||A[_t(qe)]))try{N.removeAttribute(qe)}catch{}}},An=function(N){const de=[N];for(;de.length>0;){const xe=de.pop();(x?x(xe):xe.nodeType)===wa.element&&cn(xe);const qe=I?I(xe):xe.childNodes;if(qe)for(let Qe=qe.length-1;Qe>=0;--Qe)de.push(qe[Qe])}},dn=function(N){let de=null,xe=null;if(ye)N="<remove></remove>"+N;else{const Qe=Gf(N,/^[\r\n\t ]+/);xe=Qe&&Qe[0]}gs==="application/xhtml+xml"&&cs===Yt&&(N='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+N+"</body></html>");const Be=_?T(N):N;if(cs===Yt)try{de=new d().parseFromString(Be,gs)}catch{}if(!de||!de.documentElement){de=M.createDocument(cs,"template",null);try{de.documentElement.innerHTML=oa?E:Be}catch{}}const qe=de.body||de.documentElement;return N&&xe&&qe.insertBefore(s.createTextNode(xe),qe.childNodes[0]||null),cs===Yt?re.call(de,we?"html":"body")[0]:we?de.documentElement:qe},Rn=function(N){return L.call(N.ownerDocument||N,N,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},da=function(N){var de,xe;N.normalize();const Be=L.call(N.ownerDocument||N,N,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let qe=Be.nextNode();for(;qe;){let Et=qe.data;Ua([K,ae,V],pt=>{Et=xi(Et,pt," ")}),qe.data=Et,qe=Be.nextNode()}const Qe=(de=(xe=N.querySelectorAll)===null||xe===void 0?void 0:xe.call(N,"template"))!==null&&de!==void 0?de:[];Ua(Array.from(Qe),Et=>{jt(Et.content)&&da(Et.content)})},ya=function(N){const de=S?S(N):null;return typeof de!="string"||_t(de)!=="form"?!1:typeof N.nodeName!="string"||typeof N.textContent!="string"||typeof N.removeChild!="function"||N.attributes!==g(N)||typeof N.removeAttribute!="function"||typeof N.setAttribute!="function"||typeof N.namespaceURI!="string"||typeof N.insertBefore!="function"||typeof N.hasChildNodes!="function"||N.nodeType!==x(N)||N.childNodes!==I(N)},jt=function(N){if(!x||typeof N!="object"||N===null)return!1;try{return x(N)===wa.documentFragment}catch{return!1}},ua=function(N){if(!x||typeof N!="object"||N===null)return!1;try{return typeof x(N)=="number"}catch{return!1}};function as(Re,N,de){Ua(Re,xe=>{xe.call(t,N,de,ds)})}const un=function(N){let de=null;if(as(J.beforeSanitizeElements,N,null),ya(N))return Ve(N),!0;const xe=_t(S?S(N):N.nodeName);if(as(J.uponSanitizeElement,N,{tagName:xe,allowedTags:ge}),he&&N.hasChildNodes()&&!ua(N.firstElementChild)&&us(/<[/\w!]/g,N.innerHTML)&&us(/<[/\w!]/g,N.textContent)||he&&N.namespaceURI===Yt&&xe==="style"&&ua(N.firstElementChild)||N.nodeType===wa.progressingInstruction||he&&N.nodeType===wa.comment&&us(/<[/\w]/g,N.data))return Ve(N),!0;if(pe[xe]||!(Y.tagCheck instanceof Function&&Y.tagCheck(xe))&&!ge[xe]){if(!pe[xe]&&oi(xe)&&(G.tagNameCheck instanceof RegExp&&us(G.tagNameCheck,xe)||G.tagNameCheck instanceof Function&&G.tagNameCheck(xe)))return!1;if(Z&&!Me[xe]){const qe=k(N),Qe=I(N);if(Qe&&qe){const Et=Qe.length;for(let pt=Et-1;pt>=0;--pt){const At=Ee?Qe[pt]:m(Qe[pt],!0);qe.insertBefore(At,b(N))}}}return Ve(N),!0}return(x?x(N):N.nodeType)===wa.element&&!je(N)||(xe==="noscript"||xe==="noembed"||xe==="noframes")&&us(/<\/no(script|embed|frames)/i,N.innerHTML)?(Ve(N),!0):(be&&N.nodeType===wa.text&&(de=N.textContent,Ua([K,ae,V],qe=>{de=xi(de,qe," ")}),N.textContent!==de&&(yi(t.removed,{element:N.cloneNode()}),N.textContent=de)),as(J.afterSanitizeElements,N,null),!1)},In=function(N,de,xe){if(B[de]||Ge&&(de==="id"||de==="name")&&(xe in s||xe in ba))return!1;const Be=A[de]||Y.attributeCheck instanceof Function&&Y.attributeCheck(de,N);if(!(j&&!B[de]&&us(ve,de))){if(!(ue&&us(Ie,de))){if(!Be||B[de]){if(!(oi(N)&&(G.tagNameCheck instanceof RegExp&&us(G.tagNameCheck,N)||G.tagNameCheck instanceof Function&&G.tagNameCheck(N))&&(G.attributeNameCheck instanceof RegExp&&us(G.attributeNameCheck,de)||G.attributeNameCheck instanceof Function&&G.attributeNameCheck(de,N))||de==="is"&&G.allowCustomizedBuiltInElements&&(G.tagNameCheck instanceof RegExp&&us(G.tagNameCheck,xe)||G.tagNameCheck instanceof Function&&G.tagNameCheck(xe))))return!1}else if(!rt[de]){if(!us(me,xi(xe,le,""))){if(!((de==="src"||de==="xlink:href"||de==="href")&&N!=="script"&&Wf(xe,"data:")===0&&Le[N])){if(!(X&&!us(ie,xi(xe,le,"")))){if(xe)return!1}}}}}}return!0},li=tt({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),oi=function(N){return!li[kl(N)]&&us(fe,N)},ri=function(N){as(J.beforeSanitizeAttributes,N,null);const de=N.attributes;if(!de||ya(N))return;const xe={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:A,forceKeepAttr:void 0};let Be=de.length;for(;Be--;){const qe=de[Be],Qe=qe.name,Et=qe.namespaceURI,pt=qe.value,At=_t(Qe),bs=pt;let Nt=Qe==="value"?bs:YC(bs);if(xe.attrName=At,xe.attrValue=Nt,xe.keepAttr=!0,xe.forceKeepAttr=void 0,as(J.uponSanitizeAttribute,N,xe),Nt=xe.attrValue,at&&(At==="id"||At==="name")&&Wf(Nt,Xe)!==0&&(St(Qe,N),Nt=Xe+Nt),he&&us(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Nt)){St(Qe,N);continue}if(At==="attributename"&&Gf(Nt,"href")){St(Qe,N);continue}if(xe.forceKeepAttr)continue;if(!xe.keepAttr){St(Qe,N);continue}if(!ee&&us(/\/>/i,Nt)){St(Qe,N);continue}be&&Ua([K,ae,V],ci=>{Nt=xi(Nt,ci," ")});const Na=_t(N.nodeName);if(!In(Na,At,Nt)){St(Qe,N);continue}if(_&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!Et)switch(u.getAttributeType(Na,At)){case"TrustedHTML":{Nt=T(Nt);break}case"TrustedScriptURL":{Nt=$(Nt);break}}if(Nt!==bs)try{Et?N.setAttributeNS(Et,Qe,Nt):N.setAttribute(Qe,Nt),ya(N)?Ve(N):qf(t.removed)}catch{St(Qe,N)}}as(J.afterSanitizeAttributes,N,null)},ns=function(N){let de=null;const xe=Rn(N);for(as(J.beforeSanitizeShadowDOM,N,null);de=xe.nextNode();)if(as(J.uponSanitizeShadowNode,de,null),un(de),ri(de),jt(de.content)&&ns(de.content),(x?x(de):de.nodeType)===wa.element){const qe=y?y(de):de.shadowRoot;jt(qe)&&(On(qe),ns(qe))}as(J.afterSanitizeShadowDOM,N,null)},On=function(N){const de=[{node:N,shadow:null}];for(;de.length>0;){const xe=de.pop();if(xe.shadow){ns(xe.shadow);continue}const Be=xe.node,Qe=(x?x(Be):Be.nodeType)===wa.element,Et=I?I(Be):Be.childNodes;if(Et)for(let pt=Et.length-1;pt>=0;--pt)de.push({node:Et[pt],shadow:null});if(Qe){const pt=S?S(Be):null;if(typeof pt=="string"&&_t(pt)==="template"){const At=Be.content;jt(At)&&de.push({node:At,shadow:null})}}if(Qe){const pt=y?y(Be):Be.shadowRoot;jt(pt)&&de.push({node:null,shadow:pt},{node:pt,shadow:null})}}};return t.sanitize=function(Re){let N=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},de=null,xe=null,Be=null,qe=null;if(oa=!Re,oa&&(Re="<!-->"),typeof Re!="string"&&!ua(Re)&&(Re=sT(Re),typeof Re!="string"))throw Fn("dirty is not a string, aborting");if(!t.isSupported)return Re;_e||ca(N),t.removed=[];const Qe=Ee&&typeof Re!="string"&&ua(Re);if(Qe){const At=S?S(Re):Re.nodeName;if(typeof At=="string"){const bs=_t(At);if(!ge[bs]||pe[bs])throw Fn("root node is forbidden and cannot be sanitized in-place")}if(ya(Re))throw Fn("root node is clobbered and cannot be sanitized in-place");try{On(Re)}catch(bs){throw kt(Re),bs}}else if(ua(Re))de=dn("<!---->"),xe=de.ownerDocument.importNode(Re,!0),xe.nodeType===wa.element&&xe.nodeName==="BODY"||xe.nodeName==="HTML"?de=xe:de.appendChild(xe),On(xe);else{if(!Ke&&!be&&!we&&Re.indexOf("<")===-1)return _&&Fe?T(Re):Re;if(de=dn(Re),!de)return Ke?null:Fe?E:""}de&&ye&&Ve(de.firstChild);const Et=Rn(Qe?Re:de);try{for(;Be=Et.nextNode();)un(Be),ri(Be),jt(Be.content)&&ns(Be.content)}catch(At){throw Qe&&kt(Re),At}if(Qe)return Ua(t.removed,At=>{At.element&&An(At.element)}),be&&da(Re),Re;if(Ke){if(be&&da(de),Je)for(qe=P.call(de.ownerDocument);de.firstChild;)qe.appendChild(de.firstChild);else qe=de;return(A.shadowroot||A.shadowrootmode)&&(qe=ce.call(a,qe,!0)),qe}let pt=we?de.outerHTML:de.innerHTML;return we&&ge["!doctype"]&&de.ownerDocument&&de.ownerDocument.doctype&&de.ownerDocument.doctype.name&&us(fT,de.ownerDocument.doctype.name)&&(pt="<!DOCTYPE "+de.ownerDocument.doctype.name+`>
`+pt),be&&Ua([K,ae,V],At=>{pt=xi(pt,At," ")}),_&&Fe?T(pt):pt},t.setConfig=function(){let Re=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ca(Re),_e=!0},t.clearConfig=function(){ds=null,_e=!1,_=R,E=""},t.isValidAttribute=function(Re,N,de){ds||ca({});const xe=_t(Re),Be=_t(N);return In(xe,Be,de)},t.addHook=function(Re,N){typeof N=="function"&&yi(J[Re],N)},t.removeHook=function(Re,N){if(N!==void 0){const de=JC(J[Re],N);return de===-1?void 0:ZC(J[Re],de,1)[0]}return qf(J[Re])},t.removeHooks=function(Re){J[Re]=[]},t.removeAllHooks=function(){J=tm()},t}var sm=Mg();function Mu(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ii=Mu();function Dg(e){ii=e}var Ll={exec:()=>null};function yt(e,t=""){let s=typeof e=="string"?e:e.source;const a={replace:(n,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Os.caret,"$1"),s=s.replace(n,l),a},getRegex:()=>new RegExp(s,t)};return a}var Os={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},gT=/^(?:[ \t]*(?:\n|$))+/,bT=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,yT=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,fo=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,xT=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Du=/(?:[*+-]|\d{1,9}[.)])/,Pg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,$g=yt(Pg).replace(/bull/g,Du).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),_T=yt(Pg).replace(/bull/g,Du).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Pu=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,wT=/^[^\n]+/,$u=/(?!\s*\])(?:\\.|[^\[\]\\])+/,kT=yt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",$u).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ST=yt(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Du).getRegex(),tc="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Fu=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,CT=yt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Fu).replace("tag",tc).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Fg=yt(Pu).replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex(),TT=yt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Fg).getRegex(),Bu={blockquote:TT,code:bT,def:kT,fences:yT,heading:xT,hr:fo,html:CT,lheading:$g,list:ST,newline:gT,paragraph:Fg,table:Ll,text:wT},am=yt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex(),ET={...Bu,lheading:_T,table:am,paragraph:yt(Pu).replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",am).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex()},AT={...Bu,html:yt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Fu).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ll,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:yt(Pu).replace("hr",fo).replace("heading",` *#{1,6} *[^
]`).replace("lheading",$g).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},RT=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,IT=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Bg=/^( {2,}|\\)\n(?!\s*$)/,OT=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,sc=/[\p{P}\p{S}]/u,Uu=/[\s\p{P}\p{S}]/u,Ug=/[^\s\p{P}\p{S}]/u,LT=yt(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Uu).getRegex(),zg=/(?!~)[\p{P}\p{S}]/u,NT=/(?!~)[\s\p{P}\p{S}]/u,MT=/(?:[^\s\p{P}\p{S}]|~)/u,DT=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,Hg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,PT=yt(Hg,"u").replace(/punct/g,sc).getRegex(),$T=yt(Hg,"u").replace(/punct/g,zg).getRegex(),jg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",FT=yt(jg,"gu").replace(/notPunctSpace/g,Ug).replace(/punctSpace/g,Uu).replace(/punct/g,sc).getRegex(),BT=yt(jg,"gu").replace(/notPunctSpace/g,MT).replace(/punctSpace/g,NT).replace(/punct/g,zg).getRegex(),UT=yt("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Ug).replace(/punctSpace/g,Uu).replace(/punct/g,sc).getRegex(),zT=yt(/\\(punct)/,"gu").replace(/punct/g,sc).getRegex(),HT=yt(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),jT=yt(Fu).replace("(?:-->|$)","-->").getRegex(),VT=yt("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",jT).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Sr=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,qT=yt(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Sr).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Vg=yt(/^!?\[(label)\]\[(ref)\]/).replace("label",Sr).replace("ref",$u).getRegex(),qg=yt(/^!?\[(ref)\](?:\[\])?/).replace("ref",$u).getRegex(),GT=yt("reflink|nolink(?!\\()","g").replace("reflink",Vg).replace("nolink",qg).getRegex(),zu={_backpedal:Ll,anyPunctuation:zT,autolink:HT,blockSkip:DT,br:Bg,code:IT,del:Ll,emStrongLDelim:PT,emStrongRDelimAst:FT,emStrongRDelimUnd:UT,escape:RT,link:qT,nolink:qg,punctuation:LT,reflink:Vg,reflinkSearch:GT,tag:VT,text:OT,url:Ll},WT={...zu,link:yt(/^!?\[(label)\]\((.*?)\)/).replace("label",Sr).getRegex(),reflink:yt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Sr).getRegex()},Rd={...zu,emStrongRDelimAst:BT,emStrongLDelim:$T,url:yt(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},KT={...Rd,br:yt(Bg).replace("{2,}","*").getRegex(),text:yt(Rd.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},zo={normal:Bu,gfm:ET,pedantic:AT},gl={normal:zu,gfm:Rd,breaks:KT,pedantic:WT},JT={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},nm=e=>JT[e];function Ca(e,t){if(t){if(Os.escapeTest.test(e))return e.replace(Os.escapeReplace,nm)}else if(Os.escapeTestNoEncode.test(e))return e.replace(Os.escapeReplaceNoEncode,nm);return e}function im(e){try{e=encodeURI(e).replace(Os.percentDecode,"%")}catch{return null}return e}function lm(e,t){var i;const s=e.replace(Os.findPipe,(l,o,r)=>{let c=!1,d=o;for(;--d>=0&&r[d]==="\\";)c=!c;return c?"|":" |"}),a=s.split(Os.splitPipe);let n=0;if(a[0].trim()||a.shift(),a.length>0&&!((i=a.at(-1))!=null&&i.trim())&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;n<a.length;n++)a[n]=a[n].trim().replace(Os.slashPipe,"|");return a}function bl(e,t,s){const a=e.length;if(a===0)return"";let n=0;for(;n<a&&e.charAt(a-n-1)===t;)n++;return e.slice(0,a-n)}function ZT(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let a=0;a<e.length;a++)if(e[a]==="\\")a++;else if(e[a]===t[0])s++;else if(e[a]===t[1]&&(s--,s<0))return a;return s>0?-2:-1}function om(e,t,s,a,n){const i=t.href,l=t.title||null,o=e[1].replace(n.other.outputLinkReplace,"$1");a.state.inLink=!0;const r={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:o,tokens:a.inlineTokens(o)};return a.state.inLink=!1,r}function YT(e,t,s){const a=e.match(s.other.indentCodeCompensation);if(a===null)return t;const n=a[1];return t.split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+Ca(s.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(s);throw s}}},Xn=new QT;function vt(e,t){return Xn.parse(e,t)}vt.options=vt.setOptions=function(e){return Xn.setOptions(e),vt.defaults=Xn.defaults,Dg(vt.defaults),vt};vt.getDefaults=Mu;vt.defaults=ii;vt.use=function(...e){return Xn.use(...e),vt.defaults=Xn.defaults,Dg(vt.defaults),vt};vt.walkTokens=function(e,t){return Xn.walkTokens(e,t)};vt.parseInline=Xn.parseInline;vt.Parser=Ja;vt.parser=Ja.parse;vt.Renderer=Tr;vt.TextRenderer=Hu;vt.Lexer=Ka;vt.lexer=Ka.lex;vt.Tokenizer=Cr;vt.Hooks=Jo;vt.parse=vt;vt.options;vt.setOptions;vt.use;vt.walkTokens;vt.parseInline;Ja.parse;Ka.lex;const XT={breaks:!0,gfm:!0};function rm(e){if(!e)return"";try{if(typeof vt<"u"&&vt.parse){const t=vt.parse(e,XT);return typeof sm<"u"?sm.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function eE(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),a=t.getMinutes().toString().padStart(2,"0");return`${s}:${a}`}const tE={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function sE(e){return tE[e]||"wrench"}const aE=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function cm(e){if(!e)return[];const t=e.match(aE);return t?[...new Set(t)]:[]}const nE={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),a=f(""),n=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=z(()=>t.value.trim().length>0&&!s.value),p=f(ut.state||"disconnected");let m=null;const h=z(()=>{const M=p.value;return M==="connected"?"Connected":M==="reconnecting"?"Reconnecting…":M==="connecting"?"Connecting…":"REST fallback"}),b=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],I=z(()=>{const M=Math.floor(l.value/4)%b.length,L=l.value;return L>3?`${b[M]} (${L}s)`:b[0]});function k(){zt(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!i.value)return;const M=i.value;M.style.height="auto",M.style.height=Math.min(M.scrollHeight,120)+"px"}function g(M,L,P={}){const re={id:++c,role:M,content:L,timestamp:Date.now(),html:M==="bot"?rm(L):"",tools_used:P.tools_used||[],is_error:P.is_error||!1,images:M==="bot"?cm(L):[],files:P.files||[],_showTools:!1};return e.value.push(re),k(),M==="bot"&&zt(()=>x()),re}function x(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(L=>{L.setAttribute("data-copy","true"),L.style.position="relative";const P=document.createElement("button");P.className="chat-code-copy",P.textContent="Copy",P.addEventListener("click",()=>{const re=L.querySelector("code"),ce=re?re.textContent:L.textContent;navigator.clipboard.writeText(ce).then(()=>{P.textContent="Copied!",setTimeout(()=>{P.textContent="Copy"},1500)}).catch(()=>{})}),L.appendChild(P)})}function S(M){if(M===0)return!0;const L=e.value[M-1],P=e.value[M],re=new Date(L.timestamp).toDateString(),ce=new Date(P.timestamp).toDateString();return re!==ce}function _(M){const L=new Date(M),P=new Date;if(L.toDateString()===P.toDateString())return"Today";const re=new Date(P);return re.setDate(re.getDate()-1),L.toDateString()===re.toDateString()?"Yesterday":L.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function E(M){t.value=M,zt(()=>te())}function R(M){window.open(M,"_blank","noopener")}function w(M){M.target.style.display="none"}function O(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function U(){r&&(clearInterval(r),r=null),l.value=0}function T(M){s.value&&(s.value=!1,U(),M.type==="chat_response"?g("bot",M.content,{tools_used:M.tools_used||[],is_error:M.is_error||!1,files:M.files||[]}):M.type==="chat_error"&&g("bot",M.error||"Unknown error",{is_error:!0}),zt(()=>{var L;return(L=i.value)==null?void 0:L.focus()}))}async function $(M){try{const L=await H.post("/api/chat",{content:M,channel_id:o.value});g("bot",L.response,{tools_used:L.tools_used||[],is_error:L.is_error||!1,files:L.files||[]})}catch(L){g("bot",L.message||"Failed to send message",{is_error:!0})}}async function te(){const M=t.value.trim();if(!M||s.value)return;g("user",M),t.value="",s.value=!0,O(),i.value&&(i.value.style.height="auto"),ut.connected&&ut.sendChat(M,{channelId:o.value})||(await $(M),s.value=!1,U()),zt(()=>{var P;return(P=i.value)==null?void 0:P.focus()})}async function W(){a.value="";try{if(!o.value){const L=await H.get("/api/auth/session");o.value=L.channel_id||L.user_id||"web-user"}const M=await H.get("/api/sessions/"+encodeURIComponent(o.value));if(M&&M.messages&&M.messages.length>0){for(const L of M.messages){const P=L.role==="user"?"user":"bot";let re=L.content||"";if(P==="user"){const J=re.match(/^\[.*?\]:\s*/);J&&(re=re.slice(J[0].length))}if(!re.trim())continue;const ce={id:++c,role:P,content:re,timestamp:L.timestamp?L.timestamp*1e3:Date.now(),html:P==="bot"?rm(re):"",tools_used:[],is_error:!1,images:P==="bot"?cm(re):[],files:[],_showTools:!1};e.value.push(ce)}zt(()=>{k(),x()})}}catch(M){M&&M.status!==404&&(a.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",Te.error(a.value))}}return st(()=>{ut.subscribe("chat",T),p.value=ut.state||"disconnected",m=ut.onState(M=>{p.value=M}),W(),zt(()=>{var M;return(M=i.value)==null?void 0:M.focus()})}),xt(()=>{ut.unsubscribe("chat",T),m&&(m(),m=null),U()}),{messages:e,input:t,sending:s,historyError:a,messagesEl:n,inputEl:i,canSend:u,wsStatus:h,typingText:I,suggestions:d,send:te,autoResize:y,formatTime:eE,formatDate:_,showDateSeparator:S,useSuggestion:E,openImage:R,onImageError:w,getToolIcon:sE,loadHistory:W}}},iE={setup(){const e=f("odin"),t=f(""),s=f(""),a=f(""),n=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),m=f(!1),h=z(()=>e.value==="custom"),b=z(()=>[...i.value,...l.value]),I=z(()=>l.value.includes(e.value)),k=z(()=>{var R;return h.value?t.value||"Odin":((R=n.value[e.value])==null?void 0:R.name)||e.value}),y=z(()=>{var R;return h.value?s.value||"(empty — will use Odin default)":((R=n.value[e.value])==null?void 0:R.identity)||""}),g=z(()=>{var R;return h.value?a.value||"(empty — will use Odin default)":((R=n.value[e.value])==null?void 0:R.voice)||""});async function x(){d.value=!0;try{const R=await H.get("/api/personality");e.value=R.preset||"odin",t.value=R.custom_name||"",s.value=R.custom_identity||"",a.value=R.custom_voice||"",n.value=R.presets||{},i.value=R.builtin_presets||[],l.value=R.user_presets||[]}catch(R){c.value=R.message}finally{d.value=!1}}async function S(){o.value=!0,c.value=null,r.value=!1;try{await H.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:a.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(R){c.value=R.message}finally{o.value=!1}}async function _(){const R=u.value.trim();if(R){m.value=!0,c.value=null;try{await H.post("/api/personality/presets",{name:R,display_name:k.value,identity:y.value,voice:g.value}),p.value=!1,u.value="",await x(),e.value=R.toLowerCase().replace(/ /g,"_")}catch(w){c.value=w.message}finally{m.value=!1}}}async function E(){if(await os({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await H.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(w){c.value=w.message}}}return st(x),{preset:e,customName:t,customIdentity:s,customVoice:a,presets:n,presetNames:b,isCustom:h,isUserPreset:I,previewName:k,previewIdentity:y,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:S,showSavePreset:p,newPresetName:u,savingPreset:m,saveAsPreset:_,deletePreset:E,builtinPresets:i,userPresets:l}},template:`
  ...
  `},lE={props:["onComplete"],template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=f(""),s=f(null),a=f(!1),n=f(!1);async function i(){a.value=!0,s.value=null;try{H.setPersist(n.value),await H.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{a.value=!1}}return{token:t,error:s,busy:a,persist:n,login:i}}},rE={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),a=f(!1),n=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let m=null;const h=f("starting"),b=f(""),I=Gg.filter(J=>J.meta),k=z(()=>["Workspace","Operate","Observe","Manage"].map(J=>({name:J,routes:I.filter(K=>K.meta.section===J)})).filter(J=>J.routes.length)),y=z(()=>{var J;return((J=Nl.currentRoute.value.meta)==null?void 0:J.label)||"Odin"}),g=z(()=>{var J;return((J=Nl.currentRoute.value.meta)==null?void 0:J.section)||"Management"}),x=z(()=>{var J;return((J=Nl.currentRoute.value.meta)==null?void 0:J.description)||"Management console"});function S(){ut.disconnect(),M&&(clearInterval(M),M=null)}H.onSessionExpired=()=>{t.value=!0,S(),H.setToken(""),e.value="login"};function _(J){var K;if((J.ctrlKey||J.metaKey)&&J.key.toLowerCase()==="k"){e.value==="ready"&&(J.preventDefault(),zf());return}if(a.value&&J.key==="Tab"){const ae=[...((K=n.value)==null?void 0:K.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(ae.length){const V=ae[0],ve=ae[ae.length-1];if(J.shiftKey&&(document.activeElement===V||!n.value.contains(document.activeElement))){J.preventDefault(),ve.focus();return}if(!J.shiftKey&&(document.activeElement===ve||!n.value.contains(document.activeElement))){J.preventDefault(),V.focus();return}}}if(J.key==="Escape"&&a.value){a.value=!1,J.preventDefault();return}if(J.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(J.target.tagName)){J.preventDefault();const ae=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');ae&&ae.focus()}}function E(){l.value=!!(o!=null&&o.matches),l.value||(a.value=!1)}async function R(){try{const J=await H.get("/api/setup/status");if(J.mode==="pending"||J.needed===!0)return S(),e.value="setup",!0}catch(J){J==null||J.name}return!1}st(async()=>{if(document.addEventListener("keydown",_),o=window.matchMedia("(max-width: 900px)"),E(),o.addEventListener("change",E),await R())return;const J=await H.check();J.ok?(e.value="ready",re()):J.needsAuth?e.value="login":(e.value="ready",re())});function w(){t.value=!1,e.value="ready",re()}async function O(){if(await R())return;const J=await H.check();J.ok?(e.value="ready",re()):J.needsAuth?e.value="login":(e.value="ready",re())}async function U(){S(),e.value="login",await H.logout()}function T(){s.value=!s.value}function $(){a.value=!a.value}Wt(a,async J=>{var K,ae;if(J)r=document.activeElement,await zt(),(ae=(K=n.value)==null?void 0:K.querySelector(".nav-item"))==null||ae.focus();else if(r!=null&&r.isConnected){const V=r;r=null,requestAnimationFrame(()=>V.focus())}});const te=z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function W(J,K="info",ae=3e3){p.value={text:J,level:K},clearTimeout(m),m=setTimeout(()=>{p.value=null},ae)}let M=null,L=!1,P=[];function re(){for(const J of P)J();P=[ut.onStatus(J=>{c.value=J}),ut.onLatencyChange(J=>{u.value=J}),ut.onState((J,K)=>{d.value=J,J==="connected"?(L&&W("Connection restored","success"),L=!0):J==="reconnecting"&&K.attempt===1&&W("Connection lost — reconnecting…","warn")})],ut.connect(),ce(),M&&clearInterval(M),M=setInterval(ce,15e3)}async function ce(){try{const J=await H.get("/api/status");h.value=J.status==="online"?"online":"starting";const K=J.uptime_seconds||0,ae=Math.floor(K/3600),V=Math.floor(K%3600/60);b.value=`${ae}h ${V}m uptime`}catch{h.value="offline",b.value=""}}return xt(()=>{M&&clearInterval(M);for(const J of P)J();P=[],ut.disconnect(),document.removeEventListener("keydown",_),o==null||o.removeEventListener("change",E)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:a,wsConnected:c,wsState:d,wsLatency:u,wsLabel:te,wsToast:p,botStatus:h,botUptime:b,navRoutes:I,navGroups:k,currentPage:y,currentSection:g,currentDescription:x,sidebarEl:n,mobileMenuButton:i,isMobileViewport:l,onLogin:w,onSetupComplete:O,logout:U,toggleSidebar:T,toggleMobileNavigation:$,openPalette:zf}}},on=fr(rE);on.component("odin-icon",$C);on.component("login-screen",oE);on.component("setup-page",lE);on.component("toast-container",Tk);on.component("confirm-host",Ek);on.component("command-palette",PC);on.directive("modal-focus",BC);on.use(Nl);on.mount("#app");
