...
`,e=e.substring(p.length+1),o=!0),!o){const I=this.rules.other.nextBulletRegex(m),y=this.rules.other.hrRegex(m),b=this.rules.other.fencesBeginRegex(m),_=this.rules.other.headingBeginRegex(m),C=this.rules.other.htmlBeginRegex(m);for(;e;){const D=e.split(`
`,1)[0];let L;if(p=D,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),L=p):L=p.replace(this.rules.other.tabCharGlobal,"    "),b.test(p)||_.test(p)||C.test(p)||I.test(p)||y.test(p))break;if(L.search(this.rules.other.nonSpaceChar)>=m||!p.trim())d+=`
`+L.slice(m);else{if(f||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||b.test(u)||_.test(u)||y.test(u))break;d+=`
`+p}!f&&!p.trim()&&(f=!0),c+=D+`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+$s(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Xn=new rw;function Xe(e,t){return Xn.parse(e,t)}Xe.options=Xe.setOptions=function(e){return Xn.setOptions(e),Xe.defaults=Xn.defaults,pg(Xe.defaults),Xe};Xe.getDefaults=Mc;Xe.defaults=ia;Xe.use=function(...e){return Xn.use(...e),Xe.defaults=Xn.defaults,pg(Xe.defaults),Xe};Xe.walkTokens=function(e,t){return Xn.walkTokens(e,t)};Xe.parseInline=Xn.parseInline;Xe.Parser=on;Xe.parser=on.parse;Xe.Renderer=Gl;Xe.TextRenderer=jc;Xe.Lexer=rn;Xe.lexer=rn.lex;Xe.Tokenizer=Kl;Xe.Hooks=vl;Xe.parse=Xe;Xe.options;Xe.setOptions;Xe.use;Xe.walkTokens;Xe.parseInline;on.parse;rn.lex;const ow={breaks:!0,gfm:!0};function Ku(e){if(!e)return"";try{if(typeof Xe<"u"&&Xe.parse){const t=Xe.parse(e,ow);return typeof Bu<"u"?Bu.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function cw(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const dw={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function uw(e){return dw[e]||"wrench"}const pw=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Gu(e){if(!e)return[];const t=e.match(pw);return t?[...new Set(t)]:[]}const fw={template:`
  ...
  `},hw={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(c){var p,f,m;const d=c.payload||c,u=d.type||c.type;if(u==="tool_start"){const g={id:`${d.action}-${Date.now()}`,tool:d.action,actor:d.actor||"",channel:d.channel_id||"",iteration:((p=d.metadata)==null?void 0:p.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(g);return}if(u==="tool_end"){const g=e.value.findIndex(T=>T.tool===d.action&&T.status==="running");if(g>=0){const T=e.value[g];T.status=(f=d.metadata)!=null&&f.error?"error":"success",T.elapsed=((m=d.metadata)==null?void 0:m.elapsed_ms)||Date.now()-T.startTime,T.result=d.detail||"",T.fadingOut=!0,setTimeout(()=>{const I=e.value.indexOf(T);I>=0&&e.value.splice(I,1),t.value.unshift(T),t.value.length>n&&t.value.pop()},5e3)}return}if(u==="tool_stream"){const g=d.tool_name||"unknown";if(d.finished)delete s.value[g];else{const I=((s.value[g]||"")+(d.chunk||"")).split(`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(d=>{d.status==="running"&&(d.elapsed=c-d.startTime)})}Ke(()=>{tt.on("events",a),i=setInterval(l,500)}),yt(()=>{tt.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},wg=Symbol("agent-detail-cancelled"),gw=15e3;function mw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((f,m)=>{o=f,c=m});function u(f,m){r||(r=!0,l!==null&&a(l),l=null,(f?o:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return r||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,wg),i==null||i.abort()}}}function Sg({state:e,requestDetail:t,timeoutMs:s=gw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const p=l;l=null,p==null||p.cancel()}function o(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;r();const g={agentId:p,cancel:null,promise:null};l=g,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const T=mw(I=>t(p,{signal:I}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return g.cancel=T.cancel,g.promise=(async()=>{let I=null,y=null;try{I=await T.promise}catch(b){y=b}I!==wg&&(l!==g||e.detailId!==p||(l=null,!y&&(I===null||typeof I!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=I,e.detailError=null),e.detailLoading=!1))})(),g.promise}function c(p){return e.detailId=p,o(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?o(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function vw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const bw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=Q(()=>e.value.filter(g=>g.status==="running").length),r=Q(()=>e.value.filter(g=>g.status!=="running").length);function o(g){return g==="running"?"loop-status-running":g==="failed"||g==="error"?"loop-status-error":"loop-status-stopped"}function c(g){return g==="running"?"badge-success":g==="completed"||g==="exited"?"badge-info":g==="killed"||g==="error"||g==="failed"?"badge-danger":"badge-warning"}async function d(g=!1){g=g===!0,g||(t.value=!0);try{e.value=await Z.get("/api/processes"),s.value=null}catch(T){g||(s.value=T.message)}g||(t.value=!1)}function u(){p(),n.value&&(a=setInterval(()=>{t.value||d(!0)},5e3))}function p(){a&&(clearInterval(a),a=null)}os(n,g=>{g?u():p()});async function f(g){if(await ms({title:"Kill process",message:`Kill process ${g}?`,confirmLabel:"Kill",danger:!0})){i.value=g;try{await Z.del(`/api/processes/${g}`),Ce.success(`Process ${g} killed`),await d()}catch(I){Ce.error(I.message||"Failed to kill process")}i.value=null}}function m(g){g.payload&&(g.payload.pid||g.payload.type==="process")&&d(!0)}return Ke(()=>{d(),tt.subscribe("events",m),u()}),yt(()=>{tt.unsubscribe("events",m),p()}),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:Ba,fetchProcesses:d,doKill:f}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],d=h(null),u=h(null),p=h(null),f=h(null),m=h(null),g=h([]),T=h(!1),I=Q(()=>e.value.filter(k=>k.cron&&!k.one_time).length),y=Q(()=>e.value.filter(k=>k.one_time).length),b=Q(()=>e.value.filter(k=>k.trigger).length),_=Q(()=>e.value.filter(k=>k.paused).length),C=Q(()=>e.value.filter(k=>k.consecutive_failures>0).length);function D(k){if(!k)return"-";const x=Date.now(),fe=(new Date(k).getTime()-x)/1e3;if(fe<0)return"overdue";if(fe<60)return"in < 1 min";if(fe<3600)return`in ${Math.floor(fe/60)} min`;if(fe<86400){const ie=Math.floor(fe/3600),ge=Math.floor(fe%3600/60);return ge>0?`in ${ie}h ${ge}m`:`in ${ie}h`}const pe=Math.floor(fe/86400);return`in ${pe} day${pe!==1?"s":""}`}function L(k){return k==null?"-":k<1e3?`${k}ms`:k<6e4?`${(k/1e3).toFixed(1)}s`:Ba(k/1e3)}function E(){r.value=null}async function A(){const k=a.value.cron.trim();if(k){o.value=!0;try{r.value=await Z.post("/api/schedules/validate-cron",{expression:k})}catch(x){r.value={valid:!1,error:x.message}}o.value=!1}}async function O(){t.value=!0,s.value=null;try{e.value=await Z.get("/api/schedules")}catch(k){s.value=k.message}t.value=!1}async function U(k){if(m.value===k){m.value=null,g.value=[];return}m.value=k,T.value=!0,g.value=[];try{g.value=await Z.get(`/api/schedules/${encodeURIComponent(k)}/history?limit=10`)}catch{g.value=[]}T.value=!1}async function M(){l.value=null;const k=a.value;if(!k.description.trim()){l.value="Description is required";return}if(!k.channel_id.trim()){l.value="Channel ID is required";return}if(!k.cron.trim()&&!k.run_at.trim()){l.value="Cron expression or run_at time is required";return}const x={description:k.description.trim(),action:k.action,channel_id:k.channel_id.trim()};if(k.cron.trim()&&(x.cron=k.cron.trim()),k.run_at.trim()&&(x.run_at=k.run_at.trim()),k.action==="reminder"&&k.message.trim()&&(x.message=k.message.trim()),k.action==="check"&&(k.tool_name.trim()&&(x.tool_name=k.tool_name.trim()),k.tool_input_str.trim()))try{x.tool_input=JSON.parse(k.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await Z.post("/api/schedules",x),Ce.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await O()}catch(B){l.value=B.message}i.value=!1}async function S(k){d.value=k;try{const x=await Z.post(`/api/schedules/${encodeURIComponent(k)}/run`);if(x.status==="failure")Ce.error(`Execution failed: ${x.error||"unknown error"}`);else{const B=x.warning?`Executed (${x.warning})`:"Executed successfully";Ce.success(B)}await O()}catch(x){Ce.error(x.message||"Failed to trigger")}d.value=null}async function $(k){p.value=k.id;const x=!k.paused;try{await Z.put(`/api/schedules/${encodeURIComponent(k.id)}`,{paused:x}),Ce.success(x?"Schedule paused":"Schedule resumed"),await O()}catch(B){Ce.error(B.message||"Failed to update schedule")}p.value=null}async function W(k){f.value=k;try{await Z.post(`/api/schedules/${encodeURIComponent(k)}/reset-failures`),Ce.success("Failure counters reset"),await O()}catch(x){Ce.error(x.message||"Failed to reset")}f.value=null}async function K(k){const x=e.value.find(fe=>fe.id===k);if(await ms({title:"Delete schedule",message:`Delete "${(x==null?void 0:x.description)||k}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){u.value=k;try{await Z.del(`/api/schedules/${encodeURIComponent(k)}`),Ce.success("Schedule deleted"),await O()}catch(fe){Ce.error(fe.message||"Failed to delete schedule")}u.value=null}}return Ke(()=>{O()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:d,deletingId:u,togglingId:p,resettingId:f,expandedId:m,history:g,historyLoading:T,cronCount:I,oneTimeCount:y,webhookCount:b,pausedCount:_,failingCount:C,formatTs:aa,formatAge:ig,formatFuture:D,formatMs:L,formatDuration:Ba,onCronInput:E,validateCron:A,toggleExpand:U,fetchSchedules:O,doCreate:M,doRunNow:S,doTogglePause:$,doResetFailures:W,doDelete:K}}},kw={components:{TabbedPage:kr},setup(){return{tabs:[{id:"live",label:"Live",component:hw},{id:"agents",label:"Agents",component:bw},{id:"loops",label:"Loops",component:yw},{id:"processes",label:"Processes",component:xw},{id:"schedules",label:"Schedules",component:_w}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},ww={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
`)}const Nw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),d=h(""),u=h(""),p=h(null),f=h(null),m=h(!1),g=h(null),T=h(null),I=h(!1),y=Q(()=>e.value.length),b=Q(()=>e.value.reduce((X,he)=>X+(he.execution_count||0),0)),_=Q(()=>e.value.reduce((X,he)=>X+O(he.code),0)),C=Q(()=>{if(!l.value)return e.value;const X=l.value.toLowerCase();return e.value.filter(he=>he.name.toLowerCase().includes(X)||(he.description||"").toLowerCase().includes(X))}),D=Q(()=>u.value?u.value.split(`
...
`).length:0}function U(X){return Lw(X)}function M(X){n.value={...n.value,[X]:!n.value[X]}}async function S(X){try{await navigator.clipboard.writeText(X);const he=e.value.find(De=>De.code===X);he&&(r.value=he.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function $(X){if(X.key==="Tab"){X.preventDefault();const he=X.target,De=he.selectionStart,j=he.selectionEnd;u.value=u.value.substring(0,De)+"    "+u.value.substring(j),Rt(()=>{he.selectionStart=he.selectionEnd=De+4})}}function W(X){const he=X.target.previousElementSibling;he&&(he.scrollTop=X.target.scrollTop)}async function K(){t.value=!0,s.value=null;try{e.value=await Z.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function k(X){i.value=X,delete a.value[X],a.value={...a.value};try{const he=await Z.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:he}}catch(he){a.value={...a.value,[X]:{result:he.message,is_error:!0}}}i.value=null}function x(){o.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function B(X){o.value=!0,c.value="edit",d.value=X.name,u.value=X.code||"",p.value=null,f.value=null}function fe(){o.value=!1,p.value=null,f.value=null}async function pe(){p.value=null,f.value=null;const X=d.value.trim(),he=u.value.trim();if(!X){p.value="Name is required";return}if(!he){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await Z.post("/api/skills",{name:X,code:he}),f.value="Skill created successfully"):(await Z.put(`/api/skills/${encodeURIComponent(X)}`,{code:he}),f.value="Skill updated successfully"),await K(),setTimeout(()=>{o.value=!1},800)}catch(De){p.value=De.message}m.value=!1}function ie(X){T.value=X}async function ge(){if(T.value){I.value=!0;try{await Z.del(`/api/skills/${encodeURIComponent(T.value)}`),await K()}catch{}I.value=!1,T.value=null}}return Ke(()=>{K()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:g,deleteTarget:T,deleting:I,enabledCount:y,totalExecutions:b,totalLines:_,displayedSkills:C,editLineCount:D,editorLineNums:L,editValidation:E,highlight:A,truncate:Dc,formatTs:aa,countLines:O,getLineNumbers:U,toggleCode:M,copyCode:S,handleEditorKey:$,syncScroll:W,fetchSkills:K,testSkill:k,showCreate:x,editSkill:B,cancelEdit:fe,saveSkill:pe,confirmDelete:ie,doDelete:ge}}};function Dw(e,t){if(!e||!t)return Cu(e);const s=Cu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Mw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),g=h(null);let T=null;const I=h(null),y=h(!1),b=h({}),_=h({}),C=h(null),D=h(null),L=Q(()=>e.value.reduce((x,B)=>x+(B.chunks||0),0)),E=Q(()=>new Set(e.value.map(B=>B.uploader).filter(Boolean)).size);function A(x,B){const fe=_.value[B];if(!fe||fe.length===0)return 0;const pe=Math.max(...fe.map(ie=>ie.char_count||0));return pe===0?0:Math.round(x.char_count/pe*100)}async function O(){t.value=!0,s.value=null;try{const x=await Z.get("/api/knowledge");e.value=Array.isArray(x)?x:[]}catch(x){s.value=x.message}t.value=!1}async function U(x){if(b.value[x]){b.value[x]=!1,D.value=null;return}if(b.value[x]=!0,!(_.value[x]||C.value===x)){C.value=x;try{const B=await Z.get(`/api/knowledge/${encodeURIComponent(x)}/chunks`);_.value[x]=Array.isArray(B)?B:[]}catch(B){_.value[x]=[],Ce.error(`Failed to load chunks: ${B.message}`)}C.value=null}}async function M(){const x=n.value.trim();if(x){i.value=!0,r.value=null,l.value=x;try{const B=await Z.get(`/api/knowledge/search?q=${encodeURIComponent(x)}`);a.value=Array.isArray(B)?B:[]}catch(B){a.value=[],r.value=B.message||"Search failed"}i.value=!1}}function S(){a.value=null,n.value="",r.value=null}async function $(){u.value=null,p.value=null;const x=c.value.trim(),B=d.value.trim();if(!x){u.value="Source name is required";return}if(!B){u.value="Content is required";return}f.value=!0;try{const fe=await Z.post("/api/knowledge",{source:x,content:B});p.value=`Ingested ${fe.chunks||0} chunks from "${x}"`,c.value="",d.value="",_.value={},await O(),setTimeout(()=>{o.value=!1,p.value=null},1500)}catch(fe){u.value=fe.message}f.value=!1}async function W(x){m.value=x,g.value=null,T&&(clearTimeout(T),T=null);try{const B=await Z.post(`/api/knowledge/${encodeURIComponent(x)}/reingest`);g.value={source:x,error:!1,message:`Re-ingested ${B.chunks||0} chunks`},delete _.value[x],await O(),T=setTimeout(()=>{g.value=null,T=null},3e3)}catch(B){g.value={source:x,error:!0,message:B.message}}m.value=null}function K(x){I.value=x}async function k(){if(I.value){y.value=!0;try{await Z.del(`/api/knowledge/${encodeURIComponent(I.value)}`),delete _.value[I.value],await O()}catch{}y.value=!1,I.value=null}}return Ke(()=>{O()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:g,deleteTarget:I,deleting:y,expanded:b,sourceChunks:_,loadingChunks:C,selectedChunk:D,totalChunks:L,uploaderCount:E,truncate:Dc,formatTs:aa,highlightTerms:Dw,chunkBarWidth:A,fetchSources:O,toggleSource:U,doSearch:M,clearSearch:S,doIngest:$,doReingest:W,confirmDelete:K,doDelete:k}}},Pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=Q(()=>[...new Set(e.value.map(T=>T.category))].sort()),o=Q(()=>{const g={};return e.value.forEach(T=>{g[T.category]=(g[T.category]||0)+1}),g}),c=Q(()=>a.value?e.value.filter(g=>g.category===a.value):e.value);function d(g){return g==="correction"?"badge-warning":g==="operational"?"badge-info":g==="preference"?"badge-success":"badge-info"}function u(g){i.value=g.key,l.value=g.content}async function p(g){try{await Z.put("/api/learned/"+encodeURIComponent(g),{content:l.value}),i.value=null,Ce.success("Entry updated"),await m()}catch(T){Ce.error(T.message||"Failed to save entry")}}async function f(g){if(await ms({title:"Delete learned entry",message:`Delete "${g}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await Z.del("/api/learned/"+encodeURIComponent(g)),Ce.success("Entry deleted"),await m()}catch(I){Ce.error(I.message||"Failed to delete entry")}}async function m(){s.value=!0,n.value=null;try{const g=await Z.get("/api/learned");e.value=g.entries||[],t.value={last_reflection:g.last_reflection,count:g.count}}catch(g){n.value=g.message}s.value=!1}return Ke(m),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:d,formatTs:aa,startEdit:u,saveEdit:p,deleteEntry:f,fetchEntries:m}}},$w={components:{TabbedPage:kr},setup(){return{tabs:[{id:"tools",label:"Tools",component:Iw},{id:"skills",label:"Skills",component:Nw},{id:"knowledge",label:"Knowledge",component:Mw},{id:"memory",label:"Memory",component:Pw},{id:"learned",label:"Learned",component:Fw}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Uw={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),m=Q(()=>e.value==="custom"),g=Q(()=>[...i.value,...l.value]),T=Q(()=>l.value.includes(e.value)),I=Q(()=>{var E;return m.value?t.value||"Odin":((E=a.value[e.value])==null?void 0:E.name)||e.value}),y=Q(()=>{var E;return m.value?s.value||"(empty — will use Odin default)":((E=a.value[e.value])==null?void 0:E.identity)||""}),b=Q(()=>{var E;return m.value?n.value||"(empty — will use Odin default)":((E=a.value[e.value])==null?void 0:E.voice)||""});async function _(){d.value=!0;try{const E=await Z.get("/api/personality");e.value=E.preset||"odin",t.value=E.custom_name||"",s.value=E.custom_identity||"",n.value=E.custom_voice||"",a.value=E.presets||{},i.value=E.builtin_presets||[],l.value=E.user_presets||[]}catch(E){c.value=E.message}finally{d.value=!1}}async function C(){r.value=!0,c.value=null,o.value=!1;try{await Z.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(E){c.value=E.message}finally{r.value=!1}}async function D(){const E=u.value.trim();if(E){f.value=!0,c.value=null;try{await Z.post("/api/personality/presets",{name:E,display_name:I.value,identity:y.value,voice:b.value}),p.value=!1,u.value="",await _(),e.value=E.toLowerCase().replace(/ /g,"_")}catch(A){c.value=A.message}finally{f.value=!1}}}async function L(){if(await ms({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await Z.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await _(),e.value="odin"}catch(A){c.value=A.message}}}return Ke(_),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:g,isCustom:m,isUserPreset:T,previewName:I,previewIdentity:y,previewVoice:b,saving:r,saved:o,error:c,loading:d,save:C,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:D,deletePreset:L,builtinPresets:i,userPresets:l}},template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=Q(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=Q(()=>{if(!a.value)return[];const p=a.value,f=p.storage_total_bytes||1;return[{label:"Session Persistence",mb:p.sessions.persist_dir.total_mb,bytes:p.sessions.persist_dir.total_bytes,files:p.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(p.sessions.persist_dir.total_bytes/f*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:p.knowledge.db_file.total_mb,bytes:p.knowledge.db_file.total_bytes,files:p.knowledge.db_file.file_count,pct:Math.min(100,Math.round(p.knowledge.db_file.total_bytes/f*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:p.trajectories.message_dir.total_mb,bytes:p.trajectories.message_dir.total_bytes,files:p.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(p.trajectories.message_dir.total_bytes/f*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:p.trajectories.agent_dir.total_mb,bytes:p.trajectories.agent_dir.total_bytes,files:p.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(p.trajectories.agent_dir.total_bytes/f*100)),color:"res-bar-amber"}]});async function c(){try{const p=await Z.get("/api/resource-usage");a.value=p,t.value=null}catch(p){t.value=p.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function d(){s.value=!0,await c()}function u(){e.value=!0,t.value=null,c()}return Ke(()=>{c(),i=setInterval(c,3e4)}),yt(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:rg,refresh:d,retry:u}}},qw=["INFO","WARNING","ERROR"],Kw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Jr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Gw=[50,100,200,500],Ww={template:`
...
`);const ne=new Blob([F],{type:"text/plain"}),Oe=URL.createObjectURL(ne),at=document.createElement("a");at.href=Oe,at.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,at.click(),URL.revokeObjectURL(Oe)}function J(F,ne){const Oe=`${F.ts} ${F.level} ${F.text||F.raw||""}`;navigator.clipboard.writeText(Oe).then(()=>{p.value=ne,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function oe(F){a.value=a.value===F?"":F,I.value="all"}function ae(F){return F.level==="ERROR"?"log-line-error":F.level==="WARNING"?"log-line-warning":"text-gray-300"}function se(F){return F==="ERROR"?"text-red-500 font-semibold":F==="WARNING"?"text-yellow-500":"text-blue-500"}function ee(F){return F==="ERROR"?"log-chip-error":F==="WARNING"?"log-chip-warning":"log-chip-info"}function xe(F){I.value=F.id;const ne=F.filters;a.value=ne.level||"",y.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function de(F){I.value=F.id,a.value=F.filters.level||"",y.value=F.filters.timeRange||"",i.value=F.filters.text||""}function me(){if(!C.value.trim())return;const F={id:"custom-"+Date.now(),name:C.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};b.value=[...b.value,F],E(),_.value=!1,C.value=""}function we(F){b.value=b.value.filter(ne=>ne.id!==F),E(),I.value===F&&(I.value="all")}const Te=h("all"),Ie=h(""),H=h(""),ce=h(""),ke=h(""),Pe=h(""),je=h(100),Je=Gw,ut=h(!1),Ye=h(!1),Ge=h(""),Dt=h([]),cs=h(null),ys=h(null);function qs(){e.value="search",cs.value||Ls()}async function Ls(){try{cs.value=await Z.get("/api/logs/stats")}catch{}}function Ns(){const F=Pe.value;if(!F){ce.value="",ke.value="";return}const Oe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[F];if(Oe){const at=new Date(Date.now()-Oe*1e3);ce.value=ds(at),ke.value=""}}function ds(F){const ne=Oe=>String(Oe).padStart(2,"0");return`${F.getFullYear()}-${ne(F.getMonth()+1)}-${ne(F.getDate())}T${ne(F.getHours())}:${ne(F.getMinutes())}`}function z(F){if(!F)return"";const ne=new Date(F);return isNaN(ne.getTime())?"":ne.toISOString()}async function Ae(){ut.value=!0,Ge.value="",Ye.value=!0,ys.value=null;try{const F=new URLSearchParams;Te.value&&Te.value!=="all"&&F.set("level",Te.value),Ie.value&&F.set("tool",Ie.value),H.value&&F.set("q",H.value);const ne=z(ce.value),Oe=z(ke.value);ne&&F.set("start",ne),Oe&&F.set("end",Oe),F.set("limit",String(je.value));const at=await Z.get(`/api/logs/search?${F.toString()}`);Dt.value=at.entries||[]}catch(F){Ge.value=F.message||"Search failed",Dt.value=[]}finally{ut.value=!1}}function us(){Te.value="all",Ie.value="",H.value="",ce.value="",ke.value="",Pe.value="",je.value=100,Dt.value=[],Ye.value=!1,Ge.value="",ys.value=null}function Ks(F){ys.value=ys.value===F?null:F}function la(F){if(!F.timestamp)return"";try{return new Date(F.timestamp).toLocaleString()}catch{return F.timestamp}}function yn(F){return F.type==="web_action"?`${F.status||""} (${F.execution_time_ms||0}ms)`:(F.result_summary||"").slice(0,200)}function Gs(F){return F.error?"log-line-error":"text-gray-300"}function N(F){try{return JSON.stringify(F,null,2)}catch{return String(F)}}let V=null,te=null,Se=!1;function Ee(){Se||(Se=!0,tt.subscribe("logs",ie),r.value=tt.connected,o.value=tt.state||"disconnected",V=tt.onStateChange,te=(F,ne)=>{o.value=F,r.value=F==="connected",V&&V(F,ne)},tt.onStateChange=te)}function Tt(){Se&&(Se=!1,tt.unsubscribe("logs",ie),tt.onStateChange===te&&(tt.onStateChange=V),te=null,V=null)}return Ke(()=>{L(),window.addEventListener("pointerup",v),window.addEventListener("pointercancel",v)}),Hi(Ee),Vi(Tt),yt(()=>{Tt(),window.removeEventListener("pointerup",v),window.removeEventListener("pointercancel",v)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:fe,pauseBuffer:D,showJumpBottom:u,copiedIndex:p,regexError:U,levels:m,logPresets:g,timeRanges:T,timeRange:y,activeLogPreset:I,customLogPresets:b,showSaveLogPreset:_,newLogPresetName:C,hasActiveLogFilters:A,timeRangeLabel:O,timelineBuckets:S,timelineMax:$,timelineSpanLabel:W,timelineLabelSkip:K,togglePause:P,clearLogs:Y,exportLogs:q,logLineClass:ae,levelClass:se,levelChipClass:ee,toggleLevel:oe,copyLine:J,jumpToBottom:he,onScroll:j,onUserScrollIntent:re,onUserScrollKey:_e,onAutoScrollToggle:R,onPointerDown:$e,applyLogPreset:xe,applyCustomLogPreset:de,saveLogCustomPreset:me,removeLogCustomPreset:we,segmentHeight:x,jumpToTimelineBucket:B,searchLevel:Te,searchTool:Ie,searchKeyword:H,searchStart:ce,searchEnd:ke,searchTimePreset:Pe,searchLimit:je,searchLimits:Je,searching:ut,searchRan:Ye,searchError:Ge,searchResults:Dt,searchStats:cs,expandedSearch:ys,switchToSearch:qs,runSearch:Ae,clearSearchFilters:us,toggleSearchExpand:Ks,formatSearchTs:la,searchEntryText:yn,searchLogLineClass:Gs,formatJson:N,applySearchTimePreset:Ns}}},Tg="••••••••",Zw={timezone:{apply_mode:"restart",description:"Locale and scheduling defaults used across Odin."},discord:{apply_mode:"live_read",description:"Global Discord defaults. Guild and channel overrides take precedence."},llm_provider:{apply_mode:"live_apply",owner:"llm",description:"Active language-model provider and failover ownership."},openai_codex:{apply_mode:"live_apply",owner:"llm",description:"Codex models, reasoning, transport, and pool behaviour."},ollama:{apply_mode:"restart",owner:"llm",description:"Local or remote Ollama provider settings."},kimi:{apply_mode:"restart",owner:"llm",description:"Kimi provider settings and request limits."},context:{apply_mode:"restart",description:"System-prompt sources and prompt-budget controls."},sessions:{apply_mode:"restart",description:"Conversation persistence, retention, and history limits."},tools:{apply_mode:"restart",description:"Execution policy, hosts, timeouts, pools, and recovery."},logging:{apply_mode:"restart",description:"Runtime log verbosity and storage policy."},usage:{apply_mode:"activation_required",description:"Usage accounting and durable history storage."},webhook:{apply_mode:"restart",description:"Inbound webhook listener and authentication policy."},learning:{apply_mode:"restart",description:"Reflection, consolidation, and learned-context limits."},observability:{apply_mode:"live_read",description:"Metrics, tracing, and failure-classification controls."},email:{apply_mode:"restart",description:"SMTP and IMAP behaviour for email tools."},search:{apply_mode:"restart",description:"Knowledge and history search backends."},browser:{apply_mode:"restart",description:"Browser automation limits and viewport defaults."},permissions:{apply_mode:"restart",description:"Default and per-user execution policy."},comfyui:{apply_mode:"live_read",description:"ComfyUI image backend connection settings."},image:{apply_mode:"live_read",description:"Image routing and native generation policy."},web:{apply_mode:"restart",description:"Management API listener, authentication, and sessions."},attachments:{apply_mode:"live_read",description:"Attachment limits, paths, and cleanup policy."},personality:{apply_mode:"live_read",owner:"personality",description:"Response identity, style, and personality presets."},reaction_triggers:{apply_mode:"activation_required",owner:"reaction_triggers",description:"Discord reaction event automation."},message_triggers:{apply_mode:"activation_required",owner:"message_triggers",description:"Discord message event automation."},mcp:{apply_mode:"activation_required",owner:"mcp",description:"Model Context Protocol servers and tool publication."},slack:{apply_mode:"restart",description:"Slack destinations and internal alert forwarding."},issue_tracker:{apply_mode:"activation_required",owner:"issue_tracker",description:"Issue tracker provider and tool lifecycle."},audit:{apply_mode:"restart",description:"Audit signing, verification, and retention."},agents:{apply_mode:"live_for_new_work",description:"Spawned-agent budgets, inheritance, and tree limits."},grafana_alerts:{apply_mode:"activation_required",owner:"grafana_alerts",description:"Grafana alert intake, routing, and remediation."},outbound_webhooks:{apply_mode:"live_apply",owner:"outbound_webhooks",description:"Outbound event targets, delivery, and safety policy."},graceful_degradation:{apply_mode:"activation_required",description:"Subsystem failure thresholds and request guarding."},llm_recovery:{apply_mode:"restart",description:"Provider recovery, breaker, and retry policy."},turn_state:{apply_mode:"restart",description:"Durable turn checkpoints, expiry, and resume behaviour."}},Zu={timezone:{label:"Timezone",description:"Timezone used in prompts and scheduled-time parsing.",consumers:[{name:"Prompt context",apply_mode:"live_read",detail:"Future prompts read the configured value."},{name:"Time parser",apply_mode:"restart",detail:"The parser currently captures the boot value."}],restart_reason:"The scheduling parser captures timezone during startup."},"discord.token":{owner:"secrets",sensitivity:"sensitive",description:"Write-only Discord bot credential."},"discord.allowed_users":{description:"Global allowlist of Discord user IDs. An empty list allows all users."},"discord.channels":{description:"Global allowlist of Discord channel IDs. An empty list allows all channels."},"discord.require_mention":{description:"Require a mention by default unless a guild or channel override says otherwise."},"discord.respond_to_bots":{description:"Allow replies to bot-authored messages by default."},"llm_provider.active_provider":{enum:["codex","ollama","kimi"],description:"Provider used for new primary requests."},"openai_codex.enabled":{apply_mode:"live_apply",description:"Enable or disable the primary Codex client through the dedicated Codex reload path."},"openai_codex.model":{apply_mode:"live_apply",description:"Primary Codex model. Spawned agents may inherit it directly; chat and loops require a Codex reload.",consumers:[{name:"Spawned agents inheriting the main model",apply_mode:"live_read",detail:"Future agent generations read the configured model at call time."},{name:"Chat and autonomous loops",apply_mode:"live_apply",detail:"The dedicated Codex endpoint reloads the live client."}]},"openai_codex.max_tokens":{apply_mode:"live_apply",constraints:{minimum:1,maximum:128e3},unit:"tokens",description:"Maximum Codex response tokens; requires the dedicated Codex reload path."},"openai_codex.reasoning_effort":{apply_mode:"live_apply",description:"Main Codex reasoning effort; requires the dedicated Codex reload path."},"openai_codex.agent_reasoning_effort":{apply_mode:"live_read",description:"Reasoning policy for spawned-agent generations; future generations read it at call time."},"openai_codex.agent_model":{apply_mode:"live_read",description:"Model policy for spawned-agent generations; future generations read it at call time."},"openai_codex.credentials_path":{owner:"secrets",sensitivity:"sensitive",apply_mode:"restart",description:"Write-only Codex credential-store path; an existing client cannot switch stores live.",restart_reason:"The credential pool is constructed from this path when the Codex client starts."},"openai_codex.request_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Whole-request timeout; requires the dedicated Codex reload path."},"openai_codex.stream_stall_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Maximum silent-stream interval; requires the dedicated Codex reload path."},"openai_codex.retry.max_retries":{apply_mode:"live_apply",description:"Retry-attempt ceiling; requires the dedicated Codex reload path."},"openai_codex.retry.base_delay":{apply_mode:"live_apply",unit:"seconds",description:"Initial retry delay; requires the dedicated Codex reload path."},"openai_codex.retry.max_delay":{apply_mode:"live_apply",unit:"seconds",description:"Maximum retry delay; requires the dedicated Codex reload path."},"openai_codex.connection_pool.max_connections":{apply_mode:"restart",description:"Maximum Codex transport connections.",restart_reason:"Connection-pool sizing is fixed when the live client transport is constructed."},"openai_codex.connection_pool.keepalive_timeout":{apply_mode:"restart",unit:"seconds",description:"Codex connection keepalive timeout.",restart_reason:"Connection-pool keepalive policy is fixed when the live client transport is constructed."},"openai_codex.context_compression.enabled":{apply_mode:"restart",description:"Enable context compression for chat and agent tool loops.",restart_reason:"The context-compressor holder is constructed at startup and has no live apply path."},"openai_codex.context_compression.max_context_chars":{apply_mode:"restart",unit:"characters",description:"Context size at which compression begins.",restart_reason:"The context-compressor holder retains its startup configuration."},"openai_codex.context_compression.keep_recent_iterations":{apply_mode:"restart",unit:"iterations",description:"Recent tool iterations preserved during compression.",restart_reason:"The context-compressor holder retains its startup configuration."},"logging.level":{enum:["DEBUG","INFO","WARNING","ERROR","CRITICAL"],description:"Minimum runtime log level."},"browser.default_timeout_ms":{constraints:{minimum:1e3},unit:"ms",description:"Default browser operation timeout."},"browser.viewport_width":{constraints:{minimum:100,maximum:7680},unit:"px"},"browser.viewport_height":{constraints:{minimum:100,maximum:4320},unit:"px"},"sessions.max_history":{constraints:{minimum:1,maximum:1e4},unit:"messages"},"sessions.max_age_hours":{constraints:{minimum:1},unit:"hours"},"tools.command_timeout_seconds":{constraints:{minimum:10,maximum:3600},unit:"seconds"},"agents.max_children_per_agent":{apply_mode:"activation_required",description:"Child limit adopted by newly spawned parent agents after explicit activation.",activation_policy:"Explicitly apply the configured limit after reviewing worst-case tree breadth."},"context.max_system_prompt_tokens":{apply_mode:"activation_required",description:"Optional hard budget for future assembled system prompts.",activation_policy:"Preview mandatory prompt usage and omissions before applying the budget."},"usage.directory":{apply_mode:"activation_required",description:"Target for durable usage history; currently no durable store is active.",activation_policy:"Validate the path and explicitly enable durable usage history."},"slack.forward_alerts":{apply_mode:"activation_required",description:"Forward normalized internal alerts to tested Slack destinations.",activation_policy:"Requires an effective notifier, tested destination, and activation receipt."},"grafana_alerts.enabled":{apply_mode:"activation_required",description:"Adopt explicit Grafana processing control without changing legacy webhook behaviour on upgrade.",activation_policy:"Explicit adoption preserves working legacy-control installations."},"graceful_degradation.enabled":{apply_mode:"activation_required",description:"Allow subsystem guards to short-circuit calls while a dependency is unhealthy.",activation_policy:"Explicit adoption resolves the legacy always-on behaviour."}},Jw=["tools.enabled","tools.max_tool_iterations_chat","tools.max_tool_iterations_loop","learning.loop_reflection_enabled","turn_state.retention"],Yw=new Set(["token","api_token","api_key","password","secret","credentials_path","ssh_key_path","hmac_key","webhook_urls","headers","env"]);function ei(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Qw(e){return Array.isArray(e)?"array":e===null?"null":Number.isInteger(e)?"integer":typeof e=="number"?"number":typeof e=="boolean"?"boolean":typeof e=="object"?"object":"string"}function Cg(e,t="",s=[]){if(e&&typeof e=="object"&&!Array.isArray(e)){const n=Object.entries(e);n.length===0&&t&&s.push([t,e]);for(const[a,i]of n)Cg(i,t?`${t}.${a}`:a,s);return s}return t&&s.push([t,e]),s}function Xw(e){return e.split(".").some(s=>Yw.has(s))}function e1(e){return Zu[e]?Zu[e]:e.startsWith("mcp.servers.")&&(e.endsWith(".headers")||e.endsWith(".env"))?{owner:"secrets",sensitivity:"secret_container"}:e.startsWith("outbound_webhooks.targets.")&&e.endsWith(".secret")?{owner:"secrets",sensitivity:"sensitive"}:e.startsWith("outbound_webhooks.targets.")&&(e.endsWith(".scrub_secrets")||e.endsWith(".verify_ssl"))?{apply_mode:"activation_required",activation_policy:"Review this target and acknowledge the target-bound safety override."}:{}}function Eg(e){return e==null||e===""?!1:Array.isArray(e)?e.length>0:typeof e=="object"?Object.keys(e).length>0:!0}function Ju(e,t){return t==="public"?e:e&&typeof e=="object"?Array.isArray(e)?[]:{}:Eg(e)?Tg:""}function t1(e){return e.valid===!1?"invalid":e.pending_restart?"pending_restart":e.drift?"drift":e.apply_mode==="activation_required"||e.apply_mode==="dormant"?"dormant":"applied"}function s1(e,t){const s=e.split(".")[0],n=e.split(".").at(-1),a=Zw[s]||{apply_mode:"restart",description:`${ei(s)} configuration.`},i=e1(e),l=i.sensitivity||(Xw(e)?"sensitive":"public");let r=i.apply_mode||a.apply_mode;Jw.some(f=>e===f||e.startsWith(`${f}.`))&&(r="live_read");const o=i.owner||a.owner||(l==="public"?"config":"secrets"),c=Ju(t,l),d=Ju(t,l),u=Eg(t)&&!(l!=="public"&&t===Tg),p={path:e,owner:o,label:i.label||ei(n),description:i.description||`${ei(n)} setting for ${ei(s)}.`,aliases:i.aliases||[],unit:i.unit||null,examples:i.examples||[],type:i.type||Qw(t),enum:i.enum||null,constraints:i.constraints||{},default:i.default??null,sensitivity:l,secret_route:l==="public"?null:`/api/config/secrets/${encodeURIComponent(e)}`,apply_mode:r,apply_handler:i.apply_handler||null,consumers:i.consumers||[],restart_reason:i.restart_reason||(r==="restart"?`${ei(s)} is currently constructed during startup.`:null),activation_policy:i.activation_policy||(r==="activation_required"?"Saving configuration does not enable this feature. Explicit activation is required.":null),desired:c,effective:d,configured:u,provenance:u?"config_file":"unset",valid:!0,validation_errors:[],pending_restart:!1,drift:!1,last_apply:null};return p.apply_state=t1(p),p}function n1(e){const t={applied:0,pending_restart:0,dormant:0,invalid:0,drift:0};for(const s of e)Object.hasOwn(t,s.apply_state)&&(t[s.apply_state]+=1);return t}function a1(e){const t=Cg(e||{}).map(([s,n])=>s1(s,n));return{schema_version:1,revision:"local-fixture",generated_at:null,fields:t,status:{counts:n1(t),persistence_error:null,unsafe_overrides:[],desired_revision:null,effective_revision:null}}}const Aa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["personality","context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],i1=[{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Activation required",short:"Dormant",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"}],l1={live_read:"Applies immediately",live_apply:"Reloads live",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Activation required",legacy_control:"Legacy control",dormant:"Not wired"},Yu={llm:{label:"LLM Config",href:"#/system?tab=llm",description:"This section has one canonical editor so provider changes use the safe switch and reload paths."},personality:{label:"Personality",href:"#/personality",description:"Personality presets and the active profile are managed on the dedicated Personality page."},discord:{label:"Discord overrides",href:"#/system?tab=discord",description:"Guild and channel overrides take precedence over these global defaults."},secrets:{label:"Secret controls",href:"#/system?tab=config",description:"Secret values are write-only and use dedicated set and clear flows."}},Ag="odin_config_center_expanded_v1",Rg="odin_config_center_category_v1",r1=50,Qu=e=>Promise.resolve(a1(e));function Cn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function gi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ms(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function o1(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function c1(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Ig(e,t){if(gi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Cn(t);const n={};for(const[a,i]of Object.entries(t)){const l=Ig(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function d1(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Ig(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Og(e,t,s,n){if(gi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Og(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function u1(){try{const e=JSON.parse(localStorage.getItem(Ag)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function p1(){try{const e=localStorage.getItem(Rg);return Aa.some(t=>t.key===e)?e:Aa[0].key}catch{return Aa[0].key}}const f1={template:`
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),d=h([]),u=h(null),p=Q(()=>{const x={};for(const B of d.value)x[B.id]=B;return x});function f(x){return p.value[x]||null}const m=Q(()=>/^\d{15,25}$/.test(r.value.trim())),g=Q(()=>{if(o.value){if(T.value[c.value])return"host-user-option-"+c.value;if(m.value)return"host-user-option-raw"}}),T=Q(()=>{const x=r.value.toLowerCase().trim();return x?d.value.filter(B=>!i.value[B.id]&&(B.display_name.toLowerCase().includes(x)||B.username.toLowerCase().includes(x)||B.id.includes(x))):d.value.filter(B=>!i.value[B.id])});function I(x,B){return x?x.allowed_hosts===null||x.allowed_hosts===void 0?{allowed_hosts:[...B],default_host:x.default_host||"",allow_all:!0}:{allowed_hosts:x.allowed_hosts,default_host:x.default_host||"",allow_all:!1}:{allowed_hosts:[...B],default_host:B[0]||"",allow_all:!0}}async function y(){e.value=!0,t.value="";try{const x=await Z.get("/api/host-access");s.value=x,n.value=x.available_hosts||[],a.value=I(x.default_policy,n.value);const B=x.users||{},fe={};for(const[pe,ie]of Object.entries(B))fe[pe]=I(ie,n.value);i.value=fe}catch(x){t.value=x.message||"Failed to fetch host access data"}finally{e.value=!1}try{d.value=await Z.get("/api/discord/members")||[]}catch{d.value=[]}}async function b(){try{const x=a.value.allow_all?null:a.value.allowed_hosts;await Z.put("/api/host-access/default-policy",{allowed_hosts:x,default_host:a.value.default_host}),Ce.success("Default policy updated")}catch(x){Ce.error(x.message||"Failed to save")}}function _(x,B){a.value.allow_all=!1,B?a.value.allowed_hosts.includes(x)||a.value.allowed_hosts.push(x):(a.value.allowed_hosts=a.value.allowed_hosts.filter(fe=>fe!==x),a.value.default_host===x&&(a.value.default_host=a.value.allowed_hosts[0]||"")),b()}async function C(x){const B=i.value[x];if(B)try{const fe=B.allow_all?null:B.allowed_hosts;await Z.put(`/api/host-access/user/${x}`,{allowed_hosts:fe,default_host:B.default_host});const pe=f(x);Ce.success(`Updated access for ${pe?pe.display_name:x}`)}catch(fe){Ce.error(fe.message||"Failed to save")}}function D(x,B,fe){const pe=i.value[x];pe&&(pe.allow_all=!1,fe?pe.allowed_hosts.includes(B)||pe.allowed_hosts.push(B):(pe.allowed_hosts=pe.allowed_hosts.filter(ie=>ie!==B),pe.default_host===B&&(pe.default_host=pe.allowed_hosts[0]||"")),C(x))}function L(x,B){const fe=i.value[x];fe&&(fe.default_host=B,C(x))}function E(){l.value=!0,r.value="",c.value=0,Rt(()=>{u.value&&u.value.focus()})}function A(){o.value=!0,c.value=0}function O(){c.value<T.value.length-1&&c.value++}function U(){c.value>0&&c.value--}function M(){const x=T.value[c.value];if(x){$(x);return}m.value&&S()}function S(){const x=r.value.trim();/^\d{15,25}$/.test(x)&&(i.value[x]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(x),r.value="",o.value=!1,l.value=!1)}function $(x){i.value[x.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(x.id),r.value="",o.value=!1,l.value=!1}function W(){o.value=!1}function K(){setTimeout(()=>{o.value=!1},150)}async function k(x){const B=f(x);if(await ms({title:"Remove user override",message:`Remove the host access override for ${B?B.display_name:x}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await Z.del(`/api/host-access/user/${x}`),delete i.value[x],Ce.success(`Removed override for ${B?B.display_name:x}`)}catch(pe){Ce.error(pe.message||"Failed to delete")}}return Ke(y),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:d,filteredMembers:T,isRawId:m,activeOptionId:g,searchInput:u,fetchData:y,saveDefaultPolicy:b,toggleDefaultHost:_,getMember:f,toggleUserHost:D,setUserDefault:L,openAddUser:E,deleteUser:k,onSearchInput:A,highlightNext:O,highlightPrev:U,selectHighlighted:M,selectMember:$,closeDropdown:W,onBlur:K,addRawId:S}}},m1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
