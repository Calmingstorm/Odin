 ...
 */let x_=()=>location.protocol+"//"+location.host;function rm(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),vu(r,"")}return vu(s,e)+n+a}function __(e,t,s,n){let a=[],i=[],l=null;const r=({state:f})=>{const p=rm(e,location),g=s.value,x=t.value;let I=0;if(f){if(s.value=p,t.value=f,l&&l===g){l=null;return}I=x?f.position-x.position:0}else n(p);a.forEach(L=>{L(s.value,g,{delta:I,type:Uo.pop,direction:I?I>0?Xr.forward:Xr.back:Xr.unknown})})};function o(){l=s.value}function c(f){a.push(f);const p=()=>{const g=a.indexOf(f);g>-1&&a.splice(g,1)};return i.push(p),p}function d(){if(document.visibilityState==="hidden"){const{history:f}=window;if(!f.state)return;f.replaceState(tt({},f.state,{scroll:Or()}),"")}}function u(){for(const f of i)f();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:o,listen:c,destroy:u}}function ku(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?Or():null}}function k_(e){const{history:t,location:s}=window,n={value:rm(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,d){const u=e.indexOf("#"),f=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+o:x_()+e+o;try{t[d?"replaceState":"pushState"](c,"",f),a.value=c}catch(p){console.error(p),s[d?"replace":"assign"](f)}}function l(o,c){i(o,tt({},t.state,ku(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const d=tt({},a.value,t.state,{forward:o,scroll:Or()});i(d.current,d,!0),i(o,tt({},ku(n.value,o,null),{position:d.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function w_(e){e=l_(e);const t=k_(e),s=__(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=tt({location:"",base:e,go:n,createHref:o_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function S_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),w_(e)}let Yn=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Tt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Tt||{});const T_={type:Yn.Static,value:""},C_=/[a-zA-Z0-9_]/;function E_(e){if(!e)return[[]];if(e==="/")return[[T_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(p){throw new Error(`ERR (${s})/"${c}": ${p}`)}let s=Tt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",d="";function u(){c&&(s===Tt.Static?i.push({type:Yn.Static,value:c}):s===Tt.Param||s===Tt.ParamRegExp||s===Tt.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Yn.Param,value:c,regexp:d,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function f(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==Tt.ParamRegExp){n=s,s=Tt.EscapeNext;continue}switch(s){case Tt.Static:o==="/"?(c&&u(),l()):o===":"?(u(),s=Tt.Param):f();break;case Tt.EscapeNext:f(),s=n;break;case Tt.Param:o==="("?s=Tt.ParamRegExp:C_.test(o)?f():(u(),s=Tt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case Tt.ParamRegExp:o===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+o:s=Tt.ParamRegExpEnd:d+=o;break;case Tt.ParamRegExpEnd:u(),s=Tt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,d="";break;default:t("Unknown state");break}}return s===Tt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const wu="[^/]+?",A_={sensitive:!1,strict:!1,start:!0,end:!0};var Zt=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Zt||{});const R_=/[.+*?^${}()[\]/\\]/g;function I_(e,t){const s=tt({},A_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[Zt.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const f=c[u];let p=Zt.Segment+(s.sensitive?Zt.BonusCaseSensitive:0);if(f.type===Yn.Static)u||(a+="/"),a+=f.value.replace(R_,"\\$&"),p+=Zt.Static;else if(f.type===Yn.Param){const{value:g,repeatable:x,optional:I,regexp:L}=f;i.push({name:g,repeatable:x,optional:I});const y=L||wu;if(y!==wu){p+=Zt.BonusCustomRegExp;try{`${y}`}catch(_){throw new Error(`Invalid custom RegExp for param "${g}" (${y}): `+_.message)}}let v=x?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;u||(v=I&&c.length<2?`(?:/${v})`:"/"+v),I&&(v+="?"),a+=v,p+=Zt.Dynamic,I&&(p+=Zt.BonusOptional),x&&(p+=Zt.BonusRepeatable),y===".*"&&(p+=Zt.BonusWildcard)}d.push(p)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=Zt.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const d=c.match(l),u={};if(!d)return null;for(let f=1;f<d.length;f++){const p=d[f]||"",g=i[f-1];u[g.name]=p&&g.repeatable?p.split("/"):p}return u}function o(c){let d="",u=!1;for(const f of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const p of f)if(p.type===Yn.Static)d+=p.value;else if(p.type===Yn.Param){const{value:g,repeatable:x,optional:I}=p,L=g in c?c[g]:"";if(Ps(L)&&!x)throw new Error(`Provided param "${g}" is an array but it is not repeatable (* or + modifiers)`);const y=Ps(L)?L.join("/"):L;if(!y)if(I)f.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${g}"`);d+=y}}return d||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function O_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Zt.Static+Zt.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Zt.Static+Zt.Segment?1:-1:0}function om(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=O_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Su(n))return 1;if(Su(a))return-1}return a.length-n.length}function Su(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const L_={strict:!1,end:!0,sensitive:!1};function N_(e,t,s){const n=I_(E_(e.path),s),a=tt(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function D_(e,t){const s=[],n=new Map;t=gu(L_,t);function a(u){return n.get(u)}function i(u,f,p){const g=!p,x=Cu(u);x.aliasOf=p&&p.record;const I=gu(t,u),L=[x];if("alias"in u){const _=typeof u.alias=="string"?[u.alias]:u.alias;for(const w of _)L.push(Cu(tt({},x,{components:p?p.record.components:x.components,path:w,aliasOf:p?p.record:x})))}let y,v;for(const _ of L){const{path:w}=_;if(f&&w[0]!=="/"){const b=f.record.path,S=b[b.length-1]==="/"?"":"/";_.path=f.record.path+(w&&S+w)}if(y=N_(_,f,I),p?p.alias.push(y):(v=v||y,v!==y&&v.alias.push(y),g&&u.name&&!Eu(y)&&l(u.name)),cm(y)&&o(y),x.children){const b=x.children;for(let S=0;S<b.length;S++)i(b[S],y,p&&p.children[S])}p=p||y}return v?()=>{l(v)}:_i}function l(u){if(im(u)){const f=n.get(u);f&&(n.delete(u),s.splice(s.indexOf(f),1),f.children.forEach(l),f.alias.forEach(l))}else{const f=s.indexOf(u);f>-1&&(s.splice(f,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function r(){return s}function o(u){const f=F_(u,s);s.splice(f,0,u),u.record.name&&!Eu(u)&&n.set(u.record.name,u)}function c(u,f){let p,g={},x,I;if("name"in u&&u.name){if(p=n.get(u.name),!p)throw Ga(ht.MATCHER_NOT_FOUND,{location:u});I=p.record.name,g=tt(Tu(f.params,p.keys.filter(v=>!v.optional).concat(p.parent?p.parent.keys.filter(v=>v.optional):[]).map(v=>v.name)),u.params&&Tu(u.params,p.keys.map(v=>v.name))),x=p.stringify(g)}else if(u.path!=null)x=u.path,p=s.find(v=>v.re.test(x)),p&&(g=p.parse(x),I=p.record.name);else{if(p=f.name?n.get(f.name):s.find(v=>v.re.test(f.path)),!p)throw Ga(ht.MATCHER_NOT_FOUND,{location:u,currentLocation:f});I=p.record.name,g=tt({},f.params,u.params),x=p.stringify(g)}const L=[];let y=p;for(;y;)L.unshift(y.record),y=y.parent;return{name:I,path:x,params:g,matched:L,meta:P_(L)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:r,getRecordMatcher:a}}function Tu(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Cu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:M_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function M_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function Eu(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function P_(e){return e.reduce((t,s)=>tt(t,s.meta),{})}function F_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;om(e,t[i])<0?n=i:s=i+1}const a=$_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function $_(e){let t=e;for(;t=t.parent;)if(cm(t)&&om(e,t)===0)return t}function cm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Au(e){const t=Ss(Lr),s=Ss(qc),n=Z(()=>{const o=Gs(e.to);return t.resolve(o)}),a=Z(()=>{const{matched:o}=n.value,{length:c}=o,d=o[c-1],u=s.matched;if(!d||!u.length)return-1;const f=u.findIndex(qa.bind(null,d));if(f>-1)return f;const p=Ru(o[c-2]);return c>1&&Ru(d)===p&&u[u.length-1].path!==p?u.findIndex(qa.bind(null,o[c-2])):f}),i=Z(()=>a.value>-1&&j_(s.params,n.value.params)),l=Z(()=>a.value>-1&&a.value===s.matched.length-1&&am(s.params,n.value.params));function r(o={}){if(V_(o)){const c=t[Gs(e.replace)?"replace":"push"](Gs(e.to)).catch(_i);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:Z(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function U_(e){return e.length===1?e[0]:e}const B_=Ki({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Au,setup(e,{slots:t}){const s=Pn(Au(e)),{options:n}=Ss(Lr),a=Z(()=>({[Iu(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[Iu(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&U_(t.default(s));return e.custom?i:$a("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),H_=B_;function V_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function j_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Ps(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function Ru(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Iu=(e,t,s)=>e??t??s,z_=Ki({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Ss(Ho),a=Z(()=>e.route||n.value),i=Ss(_u,0),l=Z(()=>{let c=Gs(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),r=Z(()=>a.value.matched[l.value]);gi(_u,Z(()=>l.value+1)),gi(b_,r),gi(Ho,a);const o=m();return Qt(()=>[o.value,r.value,e.name],([c,d,u],[f,p,g])=>{d&&(d.instances[u]=c,p&&p!==d&&c&&c===f&&(d.leaveGuards.size||(d.leaveGuards=p.leaveGuards),d.updateGuards.size||(d.updateGuards=p.updateGuards))),c&&d&&(!p||!qa(d,p)||!f)&&(d.enterCallbacks[u]||[]).forEach(x=>x(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=r.value,f=u&&u.components[d];if(!f)return Ou(s.default,{Component:f,route:c});const p=u.props[d],g=p?p===!0?c.params:typeof p=="function"?p(c):p:null,I=$a(f,tt({},g,t,{onVnodeUnmounted:L=>{L.component.isUnmounted&&(u.instances[d]=null)},ref:o}));return Ou(s.default,{Component:I,route:c})||I}}});function Ou(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const q_=z_;function G_(e){const t=D_(e.routes,e),s=e.parseQuery||g_,n=e.stringifyQuery||xu,a=e.history,i=ii(),l=ii(),r=ii(),o=tc(Cn);let c=Cn;ka&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Yr.bind(null,V=>""+V),u=Yr.bind(null,X0),f=Yr.bind(null,Vi);function p(V,ce){let oe,ge;return im(V)?(oe=t.getRecordMatcher(V),ge=ce):ge=V,t.addRoute(ge,oe)}function g(V){const ce=t.getRecordMatcher(V);ce&&t.removeRoute(ce)}function x(){return t.getRoutes().map(V=>V.record)}function I(V){return!!t.getRecordMatcher(V)}function L(V,ce){if(ce=tt({},ce||o.value),typeof V=="string"){const E=Qr(s,V,ce.path),U=t.resolve({path:E.path},ce),Q=a.createHref(E.fullPath);return tt(E,U,{params:f(U.params),hash:Vi(E.hash),redirectedFrom:void 0,href:Q})}let oe;if(V.path!=null)oe=tt({},V,{path:Qr(s,V.path,ce.path).path});else{const E=tt({},V.params);for(const U in E)E[U]==null&&delete E[U];oe=tt({},V,{params:u(E)}),ce.params=u(ce.params)}const ge=t.resolve(oe,ce),pe=V.hash||"";ge.params=d(f(ge.params));const De=s_(n,tt({},V,{hash:J0(pe),path:ge.path})),k=a.createHref(De);return tt({fullPath:De,hash:pe,query:n===xu?v_(V.query):V.query||{}},ge,{redirectedFrom:void 0,href:k})}function y(V){return typeof V=="string"?Qr(s,V,o.value.path):tt({},V)}function v(V,ce){if(c!==V)return Ga(ht.NAVIGATION_CANCELLED,{from:ce,to:V})}function _(V){return S(V)}function w(V){return _(tt(y(V),{replace:!0}))}function b(V,ce){const oe=V.matched[V.matched.length-1];if(oe&&oe.redirect){const{redirect:ge}=oe;let pe=typeof ge=="function"?ge(V,ce):ge;return typeof pe=="string"&&(pe=pe.includes("?")||pe.includes("#")?pe=y(pe):{path:pe},pe.params={}),tt({query:V.query,hash:V.hash,params:pe.path!=null?{}:V.params},pe)}}function S(V,ce){const oe=c=L(V),ge=o.value,pe=V.state,De=V.force,k=V.replace===!0,E=b(oe,ge);if(E)return S(tt(y(E),{state:typeof E=="object"?tt({},pe,E.state):pe,force:De,replace:k}),ce||oe);const U=oe;U.redirectedFrom=ce;let Q;return!De&&n_(n,ge,oe)&&(Q=Ga(ht.NAVIGATION_DUPLICATED,{to:U,from:ge}),be(ge,ge,!0,!1)),(Q?Promise.resolve(Q):C(U,ge)).catch(K=>Qs(K)?Qs(K,ht.NAVIGATION_GUARD_REDIRECT)?K:ke(K):D(K,U,ge)).then(K=>{if(K){if(Qs(K,ht.NAVIGATION_GUARD_REDIRECT))return S(tt({replace:k},y(K.to),{state:typeof K.to=="object"?tt({},pe,K.to.state):pe,force:De}),ce||U)}else K=P(U,ge,!0,k,pe);return B(U,ge,K),K})}function T(V,ce){const oe=v(V,ce);return oe?Promise.reject(oe):Promise.resolve()}function A(V){const ce=F.values().next().value;return ce&&typeof ce.runWithContext=="function"?ce.runWithContext(V):V()}function C(V,ce){let oe;const[ge,pe,De]=y_(V,ce);oe=eo(ge.reverse(),"beforeRouteLeave",V,ce);for(const E of ge)E.leaveGuards.forEach(U=>{oe.push(Ln(U,V,ce))});const k=T.bind(null,V,ce);return oe.push(k),_e(oe).then(()=>{oe=[];for(const E of i.list())oe.push(Ln(E,V,ce));return oe.push(k),_e(oe)}).then(()=>{oe=eo(pe,"beforeRouteUpdate",V,ce);for(const E of pe)E.updateGuards.forEach(U=>{oe.push(Ln(U,V,ce))});return oe.push(k),_e(oe)}).then(()=>{oe=[];for(const E of De)if(E.beforeEnter)if(Ps(E.beforeEnter))for(const U of E.beforeEnter)oe.push(Ln(U,V,ce));else oe.push(Ln(E.beforeEnter,V,ce));return oe.push(k),_e(oe)}).then(()=>(V.matched.forEach(E=>E.enterCallbacks={}),oe=eo(De,"beforeRouteEnter",V,ce,A),oe.push(k),_e(oe))).then(()=>{oe=[];for(const E of l.list())oe.push(Ln(E,V,ce));return oe.push(k),_e(oe)}).catch(E=>Qs(E,ht.NAVIGATION_CANCELLED)?E:Promise.reject(E))}function B(V,ce,oe){r.list().forEach(ge=>A(()=>ge(V,ce,oe)))}function P(V,ce,oe,ge,pe){const De=v(V,ce);if(De)return De;const k=ce===Cn,E=ka?history.state:{};oe&&(ge||k?a.replace(V.fullPath,tt({scroll:k&&E&&E.scroll},pe)):a.push(V.fullPath,pe)),o.value=V,be(V,ce,oe,k),ke()}let M;function J(){M||(M=a.listen((V,ce,oe)=>{if(!ee.listening)return;const ge=L(V),pe=b(ge,ee.currentRoute.value);if(pe){S(tt(pe,{replace:!0,force:!0}),ge).catch(_i);return}c=ge;const De=o.value;ka&&u_(yu(De.fullPath,oe.delta),Or()),C(ge,De).catch(k=>Qs(k,ht.NAVIGATION_ABORTED|ht.NAVIGATION_CANCELLED)?k:Qs(k,ht.NAVIGATION_GUARD_REDIRECT)?(S(tt(y(k.to),{force:!0}),ge).then(E=>{Qs(E,ht.NAVIGATION_ABORTED|ht.NAVIGATION_DUPLICATED)&&!oe.delta&&oe.type===Uo.pop&&a.go(-1,!1)}).catch(_i),Promise.reject()):(oe.delta&&a.go(-oe.delta,!1),D(k,ge,De))).then(k=>{k=k||P(ge,De,!1),k&&(oe.delta&&!Qs(k,ht.NAVIGATION_CANCELLED)?a.go(-oe.delta,!1):oe.type===Uo.pop&&Qs(k,ht.NAVIGATION_ABORTED|ht.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),B(ge,De,k)}).catch(_i)}))}let se=ii(),H=ii(),N;function D(V,ce,oe){ke(V);const ge=H.list();return ge.length?ge.forEach(pe=>pe(V,ce,oe)):console.error(V),Promise.reject(V)}function q(){return N&&o.value!==Cn?Promise.resolve():new Promise((V,ce)=>{se.add([V,ce])})}function ke(V){return N||(N=!V,J(),se.list().forEach(([ce,oe])=>V?oe(V):ce()),se.reset()),V}function be(V,ce,oe,ge){const{scrollBehavior:pe}=e;if(!ka||!pe)return Promise.resolve();const De=!oe&&f_(yu(V.fullPath,0))||(ge||!oe)&&history.state&&history.state.scroll||null;return Et().then(()=>pe(V,ce,De)).then(k=>k&&d_(k)).catch(k=>D(k,V,ce))}const re=V=>a.go(V);let fe;const F=new Set,ee={currentRoute:o,listening:!0,addRoute:p,removeRoute:g,clearRoutes:t.clearRoutes,hasRoute:I,getRoutes:x,resolve:L,options:e,push:_,replace:w,go:re,back:()=>re(-1),forward:()=>re(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:H.add,isReady:q,install(V){V.component("RouterLink",H_),V.component("RouterView",q_),V.config.globalProperties.$router=ee,Object.defineProperty(V.config.globalProperties,"$route",{enumerable:!0,get:()=>Gs(o)}),ka&&!fe&&o.value===Cn&&(fe=!0,_(a.location).catch(ge=>{}));const ce={};for(const ge in Cn)Object.defineProperty(ce,ge,{get:()=>o.value[ge],enumerable:!0});V.provide(Lr,ee),V.provide(qc,ec(ce)),V.provide(Ho,o);const oe=V.unmount;F.add(V),V.unmount=function(){F.delete(V),F.size<1&&(c=Cn,M&&M(),M=null,o.value=Cn,fe=!1,N=!1),oe()}}};function _e(V){return V.reduce((ce,oe)=>ce.then(()=>A(oe)),Promise.resolve())}return ee}function dm(){return Ss(Lr)}function K_(e){return Ss(qc)}const Nr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=K_(),s=dm(),n=Z({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=Z(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=Z(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});Qt(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},W_={setup(){const e=m([]),t=m([]),s=m({}),n=50;function a(f){var x,I,L,y,v;const p=f.payload||f,g=p.type||f.type;if(g==="tool_start"){const _=((x=p.metadata)==null?void 0:x.call_id)||null,w={callId:_,id:_||`${p.action}-${Date.now()}`,tool:p.action,actor:p.actor||"",channel:p.channel_id||"",iteration:((I=p.metadata)==null?void 0:I.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(w);return}if(g==="tool_end"){const _=((L=p.metadata)==null?void 0:L.call_id)||null;let w=-1;if(_&&(w=e.value.findIndex(b=>b.callId===_&&b.status==="running")),w<0&&!_)for(let b=e.value.length-1;b>=0;b--){const S=e.value[b];if(S.tool===p.action&&S.status==="running"){w=b;break}}if(w>=0){const b=e.value[w];b.status=(y=p.metadata)!=null&&y.error?"error":"success",b.elapsed=((v=p.metadata)==null?void 0:v.elapsed_ms)||Date.now()-b.startTime,b.result=p.detail||"",b.fadingOut=!0,setTimeout(()=>{const S=e.value.indexOf(b);S>=0&&e.value.splice(S,1),t.value.unshift(b),t.value.length>n&&t.value.pop()},5e3)}return}if(g==="tool_stream"){const _=p.call_id||p.tool_name||"unknown";if(p.finished){const w={...s.value};delete w[_],s.value=w}else{const b=((s.value[_]||"")+(p.chunk||"")).split(`
...
... (truncated)`:s}function Lu(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function pm(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function hm(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const mm=Symbol("agent-detail-cancelled"),Z_=15e3;function J_(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((p,g)=>{o=p,c=g});function u(p,g){r||(r=!0,l!==null&&a(l),l=null,(p?o:c)(g))}let f;try{f=e(i==null?void 0:i.signal)}catch(p){u(!1,p)}return r||Promise.resolve(f).then(p=>u(!0,p),p=>u(!1,p)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const p=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${p}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,mm),i==null||i.abort()}}}function gm({state:e,requestDetail:t,timeoutMs:s=Z_,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const f=l;l=null,f==null||f.cancel()}function o(f,{initial:p,coalesce:g}){if(!f)return Promise.resolve();if(g&&l&&l.agentId===f&&e.detailId===f)return l.promise;r();const x={agentId:f,cancel:null,promise:null};l=x,p?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const I=J_(L=>t(f,{signal:L}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return x.cancel=I.cancel,x.promise=(async()=>{let L=null,y=null;try{L=await I.promise}catch(v){y=v}L!==mm&&(l!==x||e.detailId!==f||(l=null,!y&&(L===null||typeof L!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=L,e.detailError=null),e.detailLoading=!1))})(),x.promise}function c(f){return e.detailId=f,o(f,{initial:!0,coalesce:!1})}function d(){const f=e.detailId;return f?o(f,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function Y_({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const Q_={template:`
    ...
    </div>`,setup(){const e=m([]),t=m(!0),s=m(null),n=m(null),a=m(!0),i=m("all");let l=!1;const r=Z(()=>e.value.filter(D=>D.status==="running").length),o=Z(()=>e.value.filter(D=>D.status==="completed").length),c=Z(()=>e.value.filter(D=>["failed","timeout","killed"].includes(D.status)).length),d=Z(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),u=Z(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(D=>["failed","timeout","killed"].includes(D.status)):e.value.filter(D=>D.status===i.value));function f(D){const q=Number(D.max_iterations)||0;return q<=0?0:Math.min(100,Math.round(D.iteration_count/q*100))}function p(D){return(Number(D.max_iterations)||0)>0}function g(D,q){return D?D==="N/A"?"N/A":q==="current_inheritance"?`inherit (currently ${D})`:D:"unknown"}function x(D){return g(D.display_model,D.display_model_source||D.display_source)}function I(D){return g(D.display_reasoning_effort,D.display_reasoning_effort_source||D.display_source)}function L(D){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[D]||""}const y=m(null),v=m(null),_=m(!1),w=m(null),b=m(""),T=gm({state:{get detail(){return y.value},set detail(D){y.value=D},get detailId(){return v.value},set detailId(D){v.value=D},get detailLoading(){return _.value},set detailLoading(D){_.value=D},get detailError(){return w.value},set detailError(D){w.value=D}},requestDetail:(D,{signal:q})=>W.get(`/api/agents/${encodeURIComponent(D)}`,{signal:q})});async function A(D){b.value="",await T.open(D.id)}function C(){T.close(),b.value=""}async function B(){await T.refresh()}async function P(D,q){try{await navigator.clipboard.writeText(q||""),b.value=D,setTimeout(()=>{b.value===D&&(b.value="")},1500)}catch{Se.error("Copy failed")}}async function M(D=!1){D=D===!0,D||(t.value=!0);try{const q=await W.get("/api/agents");e.value=Array.isArray(q)?q:[],s.value=null}catch(q){D||(s.value=q.message)}D||(t.value=!1)}async function J(D){const q=e.value.find(be=>be.id===D);if(await ms({title:"Kill agent",message:`Kill agent "${(q==null?void 0:q.label)||D}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=D;try{await W.del(`/api/agents/${encodeURIComponent(D)}`),Se.success("Agent killed"),await M()}catch(be){Se.error(be.message||"Failed to kill agent")}n.value=null}}const se=Y_({isEnabled:()=>a.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!v.value,refreshDetail:B});function H(){se.start()}function N(){se.stop()}return Qt(a,()=>se.sync()),Ge(()=>{l=!0,M(),H()}),Es(()=>{l=!0,M(!0),H()}),As(()=>{l=!1,N()}),yt(()=>{l=!1,N(),T.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ua,formatDuration:Ka,progressPercent:f,hasProgress:p,displayModelText:x,displayEffortText:I,displaySourceLabel:L,detail:y,detailId:v,detailLoading:_,detailError:w,copied:b,openDetail:A,closeDetail:C,copyText:P,fetchAgents:M,killAgent:J,startAutoRefresh:H,stopAutoRefresh:N}}},X_={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=m([]),t=m(!0),s=m(null),n=m(!1),a=m({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=m(!1),l=m(null),r=m(null),o=m(null),c=m(null),d=m(null),u=m(!1),f=m(null),p=m("");let g=!1;const I=gm({state:{get detail(){return c.value},set detail(N){c.value=N},get detailId(){return d.value},set detailId(N){d.value=N},get detailLoading(){return u.value},set detailLoading(N){u.value=N},get detailError(){return f.value},set detailError(N){f.value=N}},detailLabel:"Loop detail",requestDetail:(N,{signal:D})=>W.get(`/api/loops/${encodeURIComponent(N)}?limit=100`,{signal:D})});async function L(N){p.value="",await I.open(N.id)}function y(){I.close(),p.value=""}async function v(N,D){try{await navigator.clipboard.writeText(D||""),p.value=N,setTimeout(()=>{p.value===N&&(p.value="")},1500)}catch{Se.error("Copy failed")}}const _=Z(()=>e.value.reduce((N,D)=>N+(D.iteration_count||0),0)),w=Z(()=>e.value.filter(N=>N.status==="running").length);function b(N){return N==="running"?"loop-status-running":N==="error"?"loop-status-error":"loop-status-stopped"}function S(N){return N==="running"?"badge-success":N==="error"?"badge-danger":N==="completed"?"badge-info":"badge-warning"}function T(N){return N==="act"?"badge-warning":N==="silent"?"badge-info":"badge-success"}async function A(N=!1){N=N===!0,N||(t.value=!0);try{const D=await W.get("/api/loops");e.value=Array.isArray(D)?D:[],s.value=null}catch(D){N||(s.value=D.message)}N||(t.value=!1)}async function C(){l.value=null;const N=a.value;if(!N.goal.trim()){l.value="Goal is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}const D={goal:N.goal.trim(),channel_id:N.channel_id.trim(),interval_seconds:N.interval_seconds||60,mode:N.mode,max_iterations:N.max_iterations||50};N.stop_condition.trim()&&(D.stop_condition=N.stop_condition.trim()),i.value=!0;try{const q=await W.post("/api/loops",D);Se.success(`Loop started: ${q.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await A()}catch(q){l.value=q.message}i.value=!1}async function B(N){if(await ms({title:"Stop loop",message:`Stop loop ${N}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=N;try{await W.del(`/api/loops/${encodeURIComponent(N)}`),Se.success("Loop stopped"),await A()}catch(q){Se.error(q.message||"Failed to stop loop")}r.value=null}}async function P(N){o.value=N;try{await W.post(`/api/loops/${encodeURIComponent(N)}/restart`),Se.success("Loop restarted"),await A()}catch(D){Se.error(D.message||"Failed to restart loop")}o.value=null}function M(N){g&&N.payload&&(N.payload.loop_id||N.payload.type==="loop")&&(A(!0),d.value&&I.refresh())}let J=null;function se(){J!==null&&clearInterval(J),J=null}function H(){se(),g&&(J=setInterval(()=>{A(!0),d.value&&I.refresh()},5e3))}return Ge(()=>{g=!0,A(),qe.subscribe("events",M),H()}),Es(()=>{g=!0,A(!0),H()}),As(()=>{g=!1,se()}),yt(()=>{g=!1,qe.unsubscribe("events",M),se(),I.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:f,copied:p,totalIterations:_,runningCount:w,statusDotClass:b,statusBadge:S,modeBadge:T,formatAge:um,formatDuration:Ka,formatTs:ua,formatTokens:hm,openDetail:L,closeDetail:y,copyText:v,fetchLoops:A,doCreate:C,doStop:B,doRestart:P}}},ek={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=m([]),t=m(!0),s=m(null),n=m(!1),a=m({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=m(!1),l=m(null),r=m(null),o=Z(()=>ak(a.value.run_at));Qt(()=>a.value.run_at,()=>{r.value=null});const c=Z(()=>{var ee;const F=o.value;return F.state==="ok"?F.instant:F.state==="ambiguous"&&r.value!==null&&((ee=F.options[r.value])==null?void 0:ee.instant)||null}),d=Z(()=>{const F=c.value;return F?`${F.toLocaleString()} local — ${F.toISOString()} UTC`:""}),u=m(null),f=m(!1),p=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],g=m(null),x=m(null),I=m(null),L=m(null),y=m(null),v=m([]),_=m(!1),w=m("");let b=0;const S=Z(()=>e.value.filter(F=>F.cron&&!F.one_time).length),T=Z(()=>e.value.filter(F=>F.one_time).length),A=Z(()=>e.value.filter(F=>F.trigger).length),C=Z(()=>e.value.filter(F=>F.paused).length),B=Z(()=>e.value.filter(F=>F.consecutive_failures>0).length);function P(F){if(!F)return"-";const ee=Date.now(),V=(new Date(F).getTime()-ee)/1e3;if(V<0)return"overdue";if(V<60)return"in < 1 min";if(V<3600)return`in ${Math.floor(V/60)} min`;if(V<86400){const oe=Math.floor(V/3600),ge=Math.floor(V%3600/60);return ge>0?`in ${oe}h ${ge}m`:`in ${oe}h`}const ce=Math.floor(V/86400);return`in ${ce} day${ce!==1?"s":""}`}function M(F){return F==null?"-":F<1e3?`${F}ms`:F<6e4?`${(F/1e3).toFixed(1)}s`:Ka(F/1e3)}function J(F=a.value.cron){a.value.cron=F,Nu(a.value,"cron"),u.value=null}function se(F=a.value.run_at){a.value.run_at=F,Nu(a.value,"run_at"),u.value=null}async function H(){const F=a.value.cron.trim();if(F){f.value=!0;try{u.value=await W.post("/api/schedules/validate-cron",{expression:F})}catch(ee){u.value={valid:!1,error:ee.message}}f.value=!1}}async function N(){t.value=!0,s.value=null;try{e.value=await W.get("/api/schedules")}catch(F){s.value=F.message}t.value=!1}async function D(F){if(y.value===F){y.value=null,v.value=[];return}y.value=F,_.value=!0,v.value=[];const ee=++b;try{const _e=await W.get(`/api/schedules/${encodeURIComponent(F)}/history?limit=10`);if(ee!==b||y.value!==F)return;v.value=_e,w.value=""}catch(_e){if(ee!==b||y.value!==F)return;v.value=[],w.value=_e.message||"Failed to load execution history"}ee===b&&(_.value=!1)}async function q(){l.value=null;const F=a.value;if(!F.description.trim()){l.value="Description is required";return}if(!F.channel_id.trim()){l.value="Channel ID is required";return}if(!F.cron.trim()&&!F.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(F.cron.trim()&&F.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const ee={description:F.description.trim(),action:F.action,channel_id:F.channel_id.trim()};if(F.cron.trim()&&(ee.cron=F.cron.trim()),F.run_at.trim()){const _e=o.value;if(_e.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(_e.state==="invalid"){l.value="One-time run time is not a valid date";return}const V=c.value;if(_e.state==="ambiguous"&&r.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!V){l.value="One-time run time could not be resolved";return}ee.run_at=V.toISOString()}if(F.action==="reminder"&&F.message.trim()&&(ee.message=F.message.trim()),F.action==="check"&&(F.tool_name.trim()&&(ee.tool_name=F.tool_name.trim()),F.tool_input_str.trim()))try{ee.tool_input=JSON.parse(F.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await W.post("/api/schedules",ee),Se.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},u.value=null,n.value=!1,await N()}catch(_e){l.value=_e.message}i.value=!1}async function ke(F){g.value=F;try{const ee=await W.post(`/api/schedules/${encodeURIComponent(F)}/run`);if(ee.status==="failure")Se.error(`Execution failed: ${ee.error||"unknown error"}`);else{const _e=ee.warning?`Executed (${ee.warning})`:"Executed successfully";Se.success(_e)}await N()}catch(ee){Se.error(ee.message||"Failed to trigger")}g.value=null}async function be(F){I.value=F.id;const ee=!F.paused;try{await W.put(`/api/schedules/${encodeURIComponent(F.id)}`,{paused:ee}),Se.success(ee?"Schedule paused":"Schedule resumed"),await N()}catch(_e){Se.error(_e.message||"Failed to update schedule")}I.value=null}async function re(F){L.value=F;try{await W.post(`/api/schedules/${encodeURIComponent(F)}/reset-failures`),Se.success("Failure counters reset"),await N()}catch(ee){Se.error(ee.message||"Failed to reset")}L.value=null}async function fe(F){const ee=e.value.find(V=>V.id===F);if(await ms({title:"Delete schedule",message:`Delete "${(ee==null?void 0:ee.description)||F}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){x.value=F;try{await W.del(`/api/schedules/${encodeURIComponent(F)}`),Se.success("Schedule deleted"),await N()}catch(V){Se.error(V.message||"Failed to delete schedule")}x.value=null}}return Ge(()=>{N()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:o,runAtOccurrence:r,cronResult:u,validatingCron:f,cronPresets:p,runningId:g,deletingId:x,togglingId:I,resettingId:L,expandedId:y,history:v,historyLoading:_,historyError:w,cronCount:S,oneTimeCount:T,webhookCount:A,pausedCount:C,failingCount:B,formatTs:ua,formatAge:um,formatFuture:P,formatMs:M,formatDuration:Ka,onCronInput:J,onRunAtInput:se,validateCron:H,toggleExpand:D,fetchSchedules:N,doCreate:q,doRunNow:ke,doTogglePause:be,doResetFailures:re,doDelete:fe}}},vm=[{id:"live",label:"Live",component:W_},{id:"agents",label:"Agents",component:Q_},{id:"loops",label:"Loops",component:X_},{id:"processes",label:"Processes",component:ek},{id:"schedules",label:"Schedules",component:ik}],lk={components:{TabbedPage:Nr},setup(){return{tabs:vm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=m([]),t=m(!0),s=m(null),n=m(null),a=m(null),i=m(!1);let l=0;const r=m(null),o=m(!1),c=m(new Set),d=m(!1),u=m("all"),f=m(""),p=m("last_active"),g=m(!1),x=Du,I=ok,L=m([]),y=m(!1),v=m(""),_=m("flat"),w=m(new Set),b=m(""),S=m(""),T=m(""),A=m(null),C=m(!1);function B(){try{const z=localStorage.getItem("odin-session-presets");z&&(L.value=JSON.parse(z))}catch{}}function P(){try{localStorage.setItem("odin-session-presets",JSON.stringify(L.value))}catch{}}const M=Z(()=>f.value.trim()!==""||u.value!=="all"),J=Z(()=>{let z=[...e.value];const xe=Du.find(Ve=>Ve.id===u.value),Re=xe?xe.filters:{};if(Re.source&&(z=z.filter(Ve=>Ve.source===Re.source)),Re.minMessages&&(z=z.filter(Ve=>Ve.message_count>=Re.minMessages)),Re.hasCompaction&&(z=z.filter(Ve=>Ve.has_summary)),Re.maxAge!=null){const Ve=Date.now()/1e3;z=z.filter(ft=>ft.last_active&&Ve-ft.last_active<=Re.maxAge)}if(f.value.trim()){const Ve=f.value.toLowerCase().trim();z=z.filter(ft=>(ft.channel_id||"").toLowerCase().includes(Ve)||(ft.last_user_id||"").toLowerCase().includes(Ve)||(ft.source||"").toLowerCase().includes(Ve))}const Le=p.value,He=g.value?1:-1;return z.sort((Ve,ft)=>{const ts=Ve[Le]||0,bs=ft[Le]||0;return(ts-bs)*He}),z}),se=Z(()=>{if(!a.value||!a.value.messages)return[];const z=a.value.messages;if(z.length===0)return[];const xe=[];let Re=[];for(const Le of z)Le.role==="user"&&Re.length>0&&(xe.push(Re),Re=[]),Re.push(Le);return Re.length>0&&xe.push(Re),xe}),H=Z(()=>J.value.length>0&&c.value.size===J.value.length);function N(z){const xe=z.find(Re=>Re.role==="user");if(xe&&xe.content){const Re=xe.content.slice(0,120);return Re.length<xe.content.length?Re+"...":Re}return"(no user message)"}function D(z){const xe=new Set(w.value);xe.has(z)?xe.delete(z):xe.add(z),w.value=xe}function q(z){u.value=z}function ke(z){u.value=z.id,z.filters.searchQuery!=null&&(f.value=z.filters.searchQuery),z.filters.sortBy&&(p.value=z.filters.sortBy)}function be(){if(!v.value.trim())return;const z={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:f.value,sortBy:p.value}};L.value=[...L.value,z],P(),y.value=!1,v.value=""}function re(z){L.value=L.value.filter(xe=>xe.id!==z),P(),u.value===z&&(u.value="all")}function fe(){u.value="all",f.value="",p.value="last_active",g.value=!1}function F(z){if(!z)return"—";const xe=Date.now()/1e3-z;if(xe<60)return"just now";if(xe<3600){const Le=Math.floor(xe/60);return`${Le} minute${Le!==1?"s":""} ago`}if(xe<86400){const Le=Math.floor(xe/3600);return`${Le} hour${Le!==1?"s":""} ago`}const Re=Math.floor(xe/86400);return`${Re} day${Re!==1?"s":""} ago`}function ee(z){if(!z)return"";try{return new Date(z*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function _e(z){if(!z)return"";try{return new Date(z*1e3).toLocaleString()}catch{return""}}function V(z){return z==="user"?"bg-gray-900/50 border border-gray-800":z==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ce(z){return z==="user"?"sess-msg-user":z==="assistant"?"sess-msg-assistant":"sess-msg-system"}function oe(z){return z==="user"?"badge-info":z==="assistant"?"badge-success":"badge-warning"}function ge(z){return z==="user"?"sess-dot-user":z==="assistant"?"sess-dot-assistant":"sess-dot-system"}function pe(z){return z==="user"?"text-cyan-400":z==="assistant"?"text-indigo-400":"text-gray-500"}function De(z){return z?z.length>2e3?z.slice(0,2e3)+`
... (truncated)`:z:""}async function k(){const z=b.value.trim();if(z){C.value=!0;try{let xe=`/api/sessions/search?q=${encodeURIComponent(z)}&limit=50`;S.value.trim()&&(xe+=`&channel_id=${encodeURIComponent(S.value.trim())}`),T.value.trim()&&(xe+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Re=await W.get(xe);A.value=Re.results||[]}catch{A.value=[]}C.value=!1}}function E(){b.value="",S.value="",T.value="",A.value=null}function U(z){return z?z.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function Q(z){return z==="user"?"fts-result-user":z==="assistant"?"fts-result-assistant":z==="summary"?"fts-result-summary":z==="fts"?"fts-result-fts":z==="channel"?"fts-result-channel":"fts-result-default"}function K(z){return z==="user"?"badge-info":z==="assistant"?"badge-success":z==="summary"?"badge-warning":z==="fts"?"badge-success":"badge-info"}async function Y(){t.value=!0,s.value=null;try{e.value=await W.get("/api/sessions")}catch(z){s.value=z.message}t.value=!1}function le(){s.value=null,Y()}async function ae(z){if(n.value===z){n.value=null,a.value=null,w.value=new Set;return}n.value=z,a.value=null,i.value=!0,w.value=new Set;const xe=++l;try{const Re=await W.get(`/api/sessions/${encodeURIComponent(z)}`);xe===l&&n.value===z&&(a.value=Re)}catch(Re){xe===l&&n.value===z&&(a.value={messages:[],summary:"",error:Re.message||"Failed to load session"})}finally{xe===l&&(i.value=!1)}}function ne(z){const xe=new Set(c.value);xe.has(z)?xe.delete(z):xe.add(z),c.value=xe}function X(){H.value?c.value=new Set:c.value=new Set(J.value.map(z=>z.channel_id))}function ye(z){r.value=z}async function de(){if(r.value){o.value=!0;try{await W.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await Y()}catch(z){s.value=z.message||"Failed to clear session"}o.value=!1,r.value=null}}function ue(){d.value=!0}async function we(){if(c.value.size!==0){o.value=!0;try{await W.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await Y()}catch(z){s.value=z.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}async function Te(z,xe){const Re=`/api/sessions/${encodeURIComponent(z)}/export?format=${xe}`;try{const Le=await W.getBlob(Re),He=URL.createObjectURL(Le),Ve=document.createElement("a");Ve.href=He,Ve.download=`session-${z}.${xe==="text"?"txt":"json"}`,Ve.click(),URL.revokeObjectURL(He)}catch(Le){s.value=Le.message||"Failed to export session"}}let Ce=null;function Ie(z){z.payload&&z.payload.channel_id&&(clearTimeout(Ce),Ce=setTimeout(()=>{if(Y(),n.value&&z.payload.channel_id===n.value){const xe=n.value,Re=l;W.get(`/api/sessions/${encodeURIComponent(xe)}`).then(Le=>{Re!==l||n.value!==xe||(a.value=Le)}).catch(()=>{})}},2e3))}let Pe=!1;function $e(){Pe||(Pe=!0,Y(),qe.subscribe("events",Ie))}Ge(()=>{B(),$e()}),Es(()=>{$e()});function et(){Pe&&(Pe=!1,qe.unsubscribe("events",Ie),clearTimeout(Ce))}return As(et),yt(et),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:H,bulkClearing:d,activePreset:u,searchQuery:f,sortBy:p,sortAsc:g,filterPresets:x,sortOptions:I,filteredSessions:J,hasActiveFilters:M,customPresets:L,showSavePreset:y,newPresetName:v,threadView:_,threads:se,collapsedThreads:w,ftsQuery:b,ftsChannelId:S,ftsUserId:T,ftsResults:A,ftsSearching:C,formatAge:F,formatTimestamp:ee,formatFullTimestamp:_e,messageClass:V,threadMsgClass:ce,roleBadge:oe,roleDotClass:ge,roleLabelClass:pe,truncateContent:De,threadSummary:N,fetchSessions:Y,retry:le,toggleSession:ae,toggleSelect:ne,toggleSelectAll:X,confirmClear:ye,clearSession:de,confirmBulkClear:ue,doBulkClear:we,exportSession:Te,applyPreset:q,applyCustomPreset:ke,saveCustomPreset:be,removeCustomPreset:re,resetFilters:fe,toggleThread:D,runFtsSearch:k,clearFtsSearch:E,highlightSnippet:U,ftsResultClass:Q,ftsTypeBadge:K}}},dk={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:hm}}},uk={components:{ContextAssemblyPanel:dk},template:`
    ...
    </div>`,setup(){const e=m([]),t=m([]),s=m(!0),n=m(null),a=m(null),i=m(null),l=m(""),r=m(""),o=m(0),c=m({}),d=m({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(S){if(!S)return"—";try{const T=new Date(S);return isNaN(T.getTime())?S:T.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return S}}function f(S){return!S&&S!==0?"—":S<1e3?S+"ms":(S/1e3).toFixed(1)+"s"}function p(S){return!S&&S!==0?"—":S>=1e3?(S/1e3).toFixed(1)+"k":String(S)}function g(S){if(!S)return"";if(typeof S=="string")return S;try{return JSON.stringify(S,null,2)}catch{return String(S)}}function x(S){a.value===S?a.value=null:(a.value=S,c.value={})}function I(S,T){const A=S+"-"+T;c.value={...c.value,[A]:!c.value[A]}}function L(S,T){return!!c.value[S+"-"+T]}function y(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,w()}async function v(){try{const S=await W.get("/api/trajectories");e.value=S.files||[],o.value=S.count||0}catch{}}let _=0;async function w(){const S=++_;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const T=await W.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${d.value.limit}`);if(S!==_)return;let A=T.entries||[];d.value.tool_name&&(A=A.filter(C=>(C.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(A=A.filter(C=>C.is_error)),d.value.channel_id&&(A=A.filter(C=>C.channel_id===d.value.channel_id)),d.value.user_id&&(A=A.filter(C=>C.user_id===d.value.user_id)),t.value=A}else{const T=new URLSearchParams;d.value.channel_id&&T.set("channel_id",d.value.channel_id),d.value.user_id&&T.set("user_id",d.value.user_id),d.value.tool_name&&T.set("tool_name",d.value.tool_name),d.value.errors_only&&T.set("errors_only","true"),T.set("limit",String(d.value.limit));const A=T.toString(),C=await W.get(`/api/trajectories/search/query?${A}`);if(S!==_)return;t.value=C.results||[]}}catch(T){if(S!==_)return;n.value=T.message}S===_&&(s.value=!1)}async function b(){if(!l.value.trim())return;const S=++_;s.value=!0,n.value=null,c.value={};try{const T=await W.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(S!==_)return;i.value=T.entry||null,i.value||(n.value="No trace found for this message ID")}catch(T){if(S!==_)return;T.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=T.message}S===_&&(s.value=!1)}return Ge(async()=>{await v(),await w()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:d,expandedIterations:c,formatTs:u,formatDuration:f,formatTokens:p,formatJSON:g,truncateBlock:fm,toggleExpand:x,toggleIteration:I,isIterationExpanded:L,clearFilters:y,fetchFiles:v,fetchTraces:w,lookupMessage:b}}},fk={template:`
  ...
  `,setup(){const e=m(!0),t=m(null),s=m(!1),n=m({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),a=m({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),i=m("user");let l=null;const r=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],o=Z(()=>[...n.value.recent||[]].reverse()),c=async()=>{try{const g=await W.get("/api/usage");n.value=g,a.value=g.totals||a.value,t.value=null,s.value=!0}catch(g){t.value=g.message}finally{e.value=!1}},d=()=>{e.value=!0,c()};let u=!1;function f(){u||(u=!0,c(),l||(l=setInterval(c,15e3)))}function p(){u&&(u=!1,l&&(clearInterval(l),l=null))}return Ge(f),Es(f),As(p),yt(p),{hasData:s,loading:e,error:t,data:n,totals:a,activeTab:i,tabs:r,recentReversed:o,fmtNum:pm,formatTime:Kc,retry:d}}},bm=[{id:"audit",label:"Audit",component:rk},{id:"sessions",label:"Sessions",component:ck},{id:"traces",label:"Traces",component:uk},{id:"usage",label:"Usage",component:fk}],pk={components:{TabbedPage:Nr},setup(){return{tabs:bm}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},to=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],hk={template:`
    ...
    </div>`,setup(){const e=m([]),t=m(!0),s=m(null),n=m(""),a=m({}),i=m({}),l=m("cards"),r=m(null),o=Z(()=>e.value.filter(y=>y.is_core).length),c=Z(()=>e.value.filter(y=>!y.is_core).length),d=Z(()=>Object.values(a.value).reduce((y,v)=>y+v,0));function u(y){for(const v of to)if(v.id!=="other"&&v.match(y))return v.id;return"other"}const f=Z(()=>{let y=e.value;if(n.value){const v=n.value.toLowerCase();y=y.filter(_=>_.name.toLowerCase().includes(v)||(_.description||"").toLowerCase().includes(v))}return r.value&&(y=y.filter(v=>u(v.name)===r.value)),y}),p=Z(()=>{const y=new Set;for(const v of e.value)y.add(u(v.name));return to.filter(v=>y.has(v.id))}),g=Z(()=>{const y=f.value,v={};for(const w of y){const b=u(w.name);v[b]||(v[b]=[]),v[b].push(w)}const _=[];for(const w of to)v[w.id]&&v[w.id].length>0&&_.push({label:w.label,icon:w.icon,tools:v[w.id].sort((b,S)=>b.name.localeCompare(S.name))});return _});function x(y){i.value={...i.value,[y]:!i.value[y]}}async function I(){t.value=!0,s.value=null;try{const[y,v]=await Promise.all([W.get("/api/tools"),W.get("/api/tools/stats").catch(()=>({}))]);e.value=y,a.value=v||{};const _=Object.values(v||{}).filter(w=>w>0).sort((w,b)=>w-b)}catch(y){s.value=y.message}t.value=!1}function L(){I()}return Ge(()=>{I()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,coreCount:o,skillCount:c,totalUsage:d,filteredTools:f,groupedTools:g,usedCategories:p,truncate:Wc,toggleExpand:x,refresh:L}}};function mk(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function gk(e){if(!e)return"1";const t=e.split(`
...
`)}const vk={template:`
    ...
    </div>`,setup(){const e=m([]),t=m(!0),s=m(null),n=m({}),a=m({}),i=m(null),l=m(""),r=m(null),o=m(!1),c=m("create"),d=m(""),u=m(""),f=m(null),p=m(null),g=m(!1),x=m(null),I=m(null),L=m(!1),y=Z(()=>e.value.length),v=Z(()=>e.value.reduce((F,ee)=>F+(ee.execution_count||0),0)),_=Z(()=>e.value.reduce((F,ee)=>F+C(ee.code),0)),w=Z(()=>{if(!l.value)return e.value;const F=l.value.toLowerCase();return e.value.filter(ee=>ee.name.toLowerCase().includes(F)||(ee.description||"").toLowerCase().includes(F))}),b=Z(()=>u.value?u.value.split(`
`).length:0),S=Z(()=>{const F=Math.max(b.value,1);return Array.from({length:F},(ee,_e)=>_e+1).join(`
`)}),T=Z(()=>{const F=u.value.trim();return F?F.includes("SKILL_DEFINITION")?F.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function A(F){return mk(F)}function C(F){return F?F.split(`
`).length:0}function B(F){return gk(F)}function P(F){n.value={...n.value,[F]:!n.value[F]}}async function M(F){try{await navigator.clipboard.writeText(F);const ee=e.value.find(_e=>_e.code===F);ee&&(r.value=ee.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function J(F){if(F.key==="Tab"){F.preventDefault();const ee=F.target,_e=ee.selectionStart,V=ee.selectionEnd;u.value=u.value.substring(0,_e)+"    "+u.value.substring(V),Et(()=>{ee.selectionStart=ee.selectionEnd=_e+4})}}function se(F){const ee=F.target.previousElementSibling;ee&&(ee.scrollTop=F.target.scrollTop)}async function H(){t.value=!0,s.value=null;try{e.value=await W.get("/api/skills")}catch(F){s.value=F.message}t.value=!1}async function N(F){i.value=F,delete a.value[F],a.value={...a.value};try{const ee=await W.post(`/api/skills/${encodeURIComponent(F)}/test`);a.value={...a.value,[F]:ee}}catch(ee){a.value={...a.value,[F]:{result:ee.message,is_error:!0}}}i.value=null}function D(){o.value=!0,c.value="create",d.value="",u.value="",f.value=null,p.value=null}function q(F){o.value=!0,c.value="edit",d.value=F.name,u.value=F.code||"",f.value=null,p.value=null}function ke(){o.value=!1,f.value=null,p.value=null}async function be(){f.value=null,p.value=null;const F=d.value.trim(),ee=u.value.trim();if(!F){f.value="Name is required";return}if(!ee){f.value="Code is required";return}g.value=!0;try{c.value==="create"?(await W.post("/api/skills",{name:F,code:ee}),p.value="Skill created successfully"):(await W.put(`/api/skills/${encodeURIComponent(F)}`,{code:ee}),p.value="Skill updated successfully"),await H(),setTimeout(()=>{o.value=!1},800)}catch(_e){f.value=_e.message}g.value=!1}function re(F){I.value=F}async function fe(){if(I.value){L.value=!0;try{await W.del(`/api/skills/${encodeURIComponent(I.value)}`),await H()}catch(F){Se.error(`Failed to delete skill: ${F.message||"unknown error"}`)}L.value=!1,I.value=null}}return Ge(()=>{H()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:f,editSuccess:p,saving:g,editorRef:x,deleteTarget:I,deleting:L,enabledCount:y,totalExecutions:v,totalLines:_,displayedSkills:w,editLineCount:b,editorLineNums:S,editValidation:T,highlight:A,truncate:Wc,formatTs:ua,countLines:C,getLineNumbers:B,toggleCode:P,copyCode:M,handleEditorKey:J,syncScroll:se,fetchSkills:H,testSkill:N,showCreate:D,editSkill:q,cancelEdit:ke,saveSkill:be,confirmDelete:re,doDelete:fe}}};function bk(e,t){if(!e||!t)return Lu(e);const s=Lu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=m([]),t=m(!0),s=m(null),n=m(""),a=m(null),i=m(!1),l=m(""),r=m(null),o=m(!1),c=m(""),d=m(""),u=m(null),f=m(null),p=m(!1),g=m(null),x=m(null);let I=null;const L=m(null),y=m(!1),v=m({}),_=m({}),w=m(null),b=m(null),S=Z(()=>e.value.reduce((D,q)=>D+(q.chunks||0),0)),T=Z(()=>new Set(e.value.map(q=>q.uploader).filter(Boolean)).size);function A(D,q){const ke=_.value[q];if(!ke||ke.length===0)return 0;const be=Math.max(...ke.map(re=>re.char_count||0));return be===0?0:Math.round(D.char_count/be*100)}async function C(){t.value=!0,s.value=null;try{const D=await W.get("/api/knowledge");e.value=Array.isArray(D)?D:[]}catch(D){s.value=D.message}t.value=!1}async function B(D){if(v.value[D]){v.value[D]=!1,b.value=null;return}if(v.value[D]=!0,!(_.value[D]||w.value===D)){w.value=D;try{const q=await W.get(`/api/knowledge/${encodeURIComponent(D)}/chunks`);_.value[D]=Array.isArray(q)?q:[]}catch(q){_.value[D]=[],Se.error(`Failed to load chunks: ${q.message}`)}w.value=null}}async function P(){const D=n.value.trim();if(D){i.value=!0,r.value=null,l.value=D;try{const q=await W.get(`/api/knowledge/search?q=${encodeURIComponent(D)}`);a.value=Array.isArray(q)?q:[]}catch(q){a.value=[],r.value=q.message||"Search failed"}i.value=!1}}function M(){a.value=null,n.value="",r.value=null}async function J(){u.value=null,f.value=null;const D=c.value.trim(),q=d.value.trim();if(!D){u.value="Source name is required";return}if(!q){u.value="Content is required";return}p.value=!0;try{const ke=await W.post("/api/knowledge",{source:D,content:q});f.value=`Ingested ${ke.chunks||0} chunks from "${D}"`,c.value="",d.value="",_.value={},await C(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(ke){u.value=ke.message}p.value=!1}async function se(D){g.value=D,x.value=null,I&&(clearTimeout(I),I=null);try{const q=await W.post(`/api/knowledge/${encodeURIComponent(D)}/reingest`);x.value={source:D,error:!1,message:`Re-ingested ${q.chunks||0} chunks`},delete _.value[D],await C(),I=setTimeout(()=>{x.value=null,I=null},3e3)}catch(q){x.value={source:D,error:!0,message:q.message}}g.value=null}function H(D){L.value=D}async function N(){if(L.value){y.value=!0;try{await W.del(`/api/knowledge/${encodeURIComponent(L.value)}`),delete _.value[L.value],await C()}catch(D){Se.error(`Failed to delete source: ${D.message||"unknown error"}`)}y.value=!1,L.value=null}}return Ge(()=>{C()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:f,ingesting:p,reingesting:g,reingestResult:x,deleteTarget:L,deleting:y,expanded:v,sourceChunks:_,loadingChunks:w,selectedChunk:b,totalChunks:S,uploaderCount:T,truncate:Wc,formatTs:ua,highlightTerms:bk,chunkBarWidth:A,fetchSources:C,toggleSource:B,doSearch:P,clearSearch:M,doIngest:J,doReingest:se,confirmDelete:H,doDelete:N}}},xk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=m([]),t=m({}),s=m(!0),n=m(null),a=m({}),i=m(null),l=m(""),r=m(!1),o=m({scope:"global",key:"",value:""}),c=m(!1),d=m(null),u=m(null),f=m(null),p=m(""),g=m(!1),x=m(null),I=m(null),L=m(new Set),y=m(null),v=m(!1),_=m(!1),w=Z(()=>e.value.reduce((re,fe)=>re+fe.count,0)),b=Z(()=>L.value.size);function S(re){const fe=t.value[re];if(!fe)return[];if(!l.value.trim())return fe;const F=l.value.trim().toLowerCase();return fe.filter(ee=>ee.key.toLowerCase().includes(F)||ee.value&&ee.value.toLowerCase().includes(F))}function T(re,fe){return L.value.has(re+"/"+fe)}function A(re,fe){const F=re+"/"+fe,ee=new Set(L.value);ee.has(F)?ee.delete(F):ee.add(F),L.value=ee}function C(re){const fe=t.value[re];return!fe||fe.length===0?!1:fe.every(F=>L.value.has(re+"/"+F.key))}function B(re,fe){const F=t.value[re];if(!F)return;const ee=new Set(L.value);for(const _e of F){const V=re+"/"+_e.key;fe?ee.add(V):ee.delete(V)}L.value=ee}async function P(){s.value=!0,n.value=null;try{const re=await W.get("/api/memory");e.value=Object.entries(re).map(([fe,F])=>({name:fe,keys:F.keys||[],count:F.count||0}))}catch(re){n.value=re.message}s.value=!1}async function M(re){if(a.value[re]){a.value[re]=!1;return}a.value[re]=!0;const fe=e.value.find(ee=>ee.name===re);if(!fe||t.value[re]||i.value===re)return;i.value=re;let F;try{const _e=(await W.get(`/api/memory/${encodeURIComponent(re)}`)).entries||{};F=fe.keys.map(V=>Object.prototype.hasOwnProperty.call(_e,V)?{key:V,value:_e[V]||"",failed:!1}:{key:V,value:"",failed:!0,error:"Not found in scope"})}catch(ee){F=fe.keys.map(_e=>({key:_e,value:"",failed:!0,error:ee.message||"Failed to load"}))}t.value[re]=F,i.value=null}function J(re,fe,F){f.value=re+"/"+fe,p.value=F}async function se(re,fe){g.value=!0,x.value=null;try{await W.put(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(fe)}`,{value:p.value});const F=t.value[re];if(F){const ee=F.find(_e=>_e.key===fe);ee&&(ee.value=p.value)}f.value=null}catch(F){x.value=`Failed to save: ${F.message||"unknown error"}`}g.value=!1}async function H(re,fe){try{await navigator.clipboard.writeText(fe.value),I.value=re+"/"+fe.key,setTimeout(()=>{I.value=null},1500)}catch{}}async function N(){d.value=null,u.value=null;const re=o.value.scope.trim(),fe=o.value.key.trim(),F=o.value.value.trim();if(!re){d.value="Scope is required";return}if(!fe){d.value="Key is required";return}if(!F){d.value="Value is required";return}c.value=!0;try{await W.put(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(fe)}`,{value:F}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(ee){d.value=ee.message}c.value=!1}function D(re,fe){y.value={scope:re,key:fe}}async function q(){if(!y.value)return;v.value=!0,x.value=null;const{scope:re,key:fe}=y.value;try{await W.del(`/api/memory/${encodeURIComponent(re)}/${encodeURIComponent(fe)}`);const F=t.value[re];F&&(t.value[re]=F.filter(V=>V.key!==fe));const ee=e.value.find(V=>V.name===re);ee&&(ee.count--,ee.keys=ee.keys.filter(V=>V!==fe));const _e=new Set(L.value);_e.delete(re+"/"+fe),L.value=_e}catch(F){x.value=`Failed to delete: ${F.message||"unknown error"}`}v.value=!1,y.value=null}function ke(){_.value=!0}async function be(){v.value=!0,x.value=null;const re=[];for(const fe of L.value){const F=fe.indexOf("/");re.push({scope:fe.slice(0,F),key:fe.slice(F+1)})}try{await W.post("/api/memory/bulk-delete",{entries:re}),L.value=new Set,t.value={},await P()}catch(fe){x.value=`Bulk delete failed: ${fe.message||"unknown error"}`}v.value=!1,_.value=!1}return Ge(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:f,editValue:p,saving:g,actionError:x,copied:I,selected:L,selectedCount:b,totalEntries:w,deleteTarget:y,deleting:v,showBulkDelete:_,fetchMemory:P,toggleScope:M,startEdit:J,doEdit:se,copyValue:H,doAdd:N,confirmDelete:D,doDelete:q,confirmBulkDelete:ke,doBulkDelete:be,isSelected:T,toggleSelect:A,isScopeAllSelected:C,toggleSelectAll:B,filteredEntries:S}}},_k={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const ie=new Blob([j],{type:"text/plain"}),Ee=URL.createObjectURL(ie),Ze=document.createElement("a");Ze.href=Ee,Ze.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ze.click(),URL.revokeObjectURL(Ee)}function Y(j,ie){const Ee=`${j.ts} ${j.level} ${j.text||j.raw||""}`;navigator.clipboard.writeText(Ee).then(()=>{f.value=ie,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function le(j){a.value=a.value===j?"":j,L.value="all"}function ae(j){return j.level==="ERROR"?"log-line-error":j.level==="WARNING"?"log-line-warning":"text-gray-300"}function ne(j){return j==="ERROR"?"text-red-500 font-semibold":j==="WARNING"?"text-yellow-500":"text-blue-500"}function X(j){return j==="ERROR"?"log-chip-error":j==="WARNING"?"log-chip-warning":"log-chip-info"}function ye(j){L.value=j.id;const ie=j.filters;a.value=ie.level||"",y.value=ie.timeRange||"",i.value=ie.text||"",ie.levels&&(a.value=ie.levels[0]||""),ie.hasToolName&&(i.value="")}function de(j){L.value=j.id,a.value=j.filters.level||"",y.value=j.filters.timeRange||"",i.value=j.filters.text||""}function ue(){if(!w.value.trim())return;const j={id:"custom-"+Date.now(),name:w.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};v.value=[...v.value,j],T(),_.value=!1,w.value=""}function we(j){v.value=v.value.filter(ie=>ie.id!==j),T(),L.value===j&&(L.value="all")}const Te=m("all"),Ce=m(""),Ie=m(""),Pe=m(""),$e=m(""),et=m(""),z=m(100),xe=Ik,Re=m(!1),Le=m(!1),He=m(""),Ve=m([]),ft=m(null),ts=m(null);function bs(){e.value="search",ft.value||xn()}async function xn(){try{ft.value=await W.get("/api/logs/stats")}catch{}}function Rs(){const j=et.value;if(!j){Pe.value="",$e.value="";return}const Ee={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[j];if(Ee){const Ze=new Date(Date.now()-Ee*1e3);Pe.value=Fs(Ze),$e.value=""}}function Fs(j){const ie=Ee=>String(Ee).padStart(2,"0");return`${j.getFullYear()}-${ie(j.getMonth()+1)}-${ie(j.getDate())}T${ie(j.getHours())}:${ie(j.getMinutes())}`}function Rt(j){if(!j)return"";const ie=new Date(j);return isNaN(ie.getTime())?"":ie.toISOString()}async function G(){Re.value=!0,He.value="",Le.value=!0,ts.value=null;try{const j=new URLSearchParams;Te.value&&Te.value!=="all"&&j.set("level",Te.value),Ce.value&&j.set("tool",Ce.value),Ie.value&&j.set("q",Ie.value);const ie=Rt(Pe.value),Ee=Rt($e.value);ie&&j.set("start",ie),Ee&&j.set("end",Ee),j.set("limit",String(z.value));const Ze=await W.get(`/api/logs/search?${j.toString()}`);Ve.value=Ze.entries||[]}catch(j){He.value=j.message||"Search failed",Ve.value=[]}finally{Re.value=!1}}function Oe(){Te.value="all",Ce.value="",Ie.value="",Pe.value="",$e.value="",et.value="",z.value=100,Ve.value=[],Le.value=!1,He.value="",ts.value=null}function ys(j){ts.value=ts.value===j?null:j}function $n(j){if(!j.timestamp)return"";try{return new Date(j.timestamp).toLocaleString()}catch{return j.timestamp}}function cs(j){return j.type==="web_action"?`${j.status||""} (${j.execution_time_ms||0}ms)`:(j.result_summary||"").slice(0,200)}function Un(j){return j.error?"log-line-error":"text-gray-300"}function Ya(j){try{return JSON.stringify(j,null,2)}catch{return String(j)}}let ds=null,_n=null,kn=!1;function lt(){kn||(kn=!0,qe.subscribe("logs",re),r.value=qe.connected,o.value=qe.state||"disconnected",ds=qe.onStateChange,_n=(j,ie)=>{o.value=j,r.value=j==="connected",ds&&ds(j,ie)},qe.onStateChange=_n)}function Is(){kn&&(kn=!1,qe.unsubscribe("logs",re),qe.onStateChange===_n&&(qe.onStateChange=ds),_n=null,ds=null)}return Ge(()=>{S(),window.addEventListener("pointerup",k),window.addEventListener("pointercancel",k)}),Es(lt),As(Is),yt(()=>{Is(),window.removeEventListener("pointerup",k),window.removeEventListener("pointercancel",k)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:ke,pauseBuffer:b,showJumpBottom:u,copiedIndex:f,regexError:B,levels:g,logPresets:x,timeRanges:I,timeRange:y,activeLogPreset:L,customLogPresets:v,showSaveLogPreset:_,newLogPresetName:w,hasActiveLogFilters:A,timeRangeLabel:C,timelineBuckets:M,timelineMax:J,timelineSpanLabel:se,timelineLabelSkip:H,togglePause:U,clearLogs:Q,exportLogs:K,logLineClass:ae,levelClass:ne,levelChipClass:X,toggleLevel:le,copyLine:Y,jumpToBottom:ee,onScroll:V,onUserScrollIntent:oe,onUserScrollKey:ge,onAutoScrollToggle:E,onPointerDown:De,applyLogPreset:ye,applyCustomLogPreset:de,saveLogCustomPreset:ue,removeLogCustomPreset:we,segmentHeight:D,jumpToTimelineBucket:q,searchLevel:Te,searchTool:Ce,searchKeyword:Ie,searchStart:Pe,searchEnd:$e,searchTimePreset:et,searchLimit:z,searchLimits:xe,searching:Re,searchRan:Le,searchError:He,searchResults:Ve,searchStats:ft,expandedSearch:ts,switchToSearch:bs,runSearch:G,clearSearchFilters:Oe,toggleSearchExpand:ys,formatSearchTs:$n,searchEntryText:cs,searchLogLineClass:Un,formatJson:Ya,applySearchTimePreset:Rs}}};function yl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const Lk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]),Ma=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Nk={live_read:"Applies immediately",live_apply:"Reloads live",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},no=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),Dk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Mu(e){return Dk.some(t=>e===t||e.startsWith(`${t}.`))}const xm="odin_config_center_expanded_v1",_m="odin_config_center_category_v1",Mk=50,Pk=650,ao=()=>W.get("/api/config/meta");function Kn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function ki(e,t){return JSON.stringify(e)===JSON.stringify(t)}function va(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Fk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function $k(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function km(e,t){if(ki(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Kn(t);const n={};for(const[a,i]of Object.entries(t)){const l=km(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function Uk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=km(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function wm(e,t,s,n){if(ki(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)wm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function Bk(){try{const e=JSON.parse(localStorage.getItem(xm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function Hk(){try{const e=localStorage.getItem(_m);return Ma.some(t=>t.key===e)?e:Ma[0].key}catch{return Ma[0].key}}const Vk={template:`
  ...
  `,setup(){const e=m(null),t=m(null),s=m(!0),n=m(!1),a=m(null),i=m(null),l=m(null),r=m(!1),o=m(!1),c=m(null),d=m(""),u=m("all"),f=m(Hk()),p=m(Bk()),g=m({}),x=m({}),I=m(""),L=m({}),y=m({}),v=m([]),_=m([]),w=m(!1),b=m(!1),S=m(!1);let T=null,A=null,C={path:null,at:0},B=0;const P=Z(()=>{var h;return(((h=t.value)==null?void 0:h.fields)||[]).filter(O=>!no.has(O.path.split(".")[0])&&!Mu(O.path))}),M=Z(()=>new Map(P.value.map(h=>[h.path,h]))),J=Z(()=>q.value.reduce((h,O)=>h+O.sections.length,0)),se=Z(()=>P.value.length),H=Z(()=>Lk),N=Z(()=>v.value.length>0),D=Z(()=>_.value.length>0),q=Z(()=>{if(!e.value)return[];const h=new Set(Ma.flatMap(te=>te.sections)),O=Ma.map(te=>({...te,sections:te.sections.filter(ve=>Object.hasOwn(e.value,ve)&&!no.has(ve))})).filter(te=>te.sections.length),$=Object.keys(e.value).filter(te=>!h.has(te)&&!no.has(te));return $.length&&O.push({key:"other",label:"Other",icon:"folder",sections:$}),O}),ke=Z(()=>e.value?{...e.value,...g.value}:null),be=Z(()=>{if(!e.value)return[];const h=[];for(const[O,$]of Object.entries(g.value))wm(e.value[O],$,O,h);return h.filter(O=>!ki(O.oldVal,O.newVal)).map(O=>{const $=k(O.path);return{...O,label:($==null?void 0:$.label)||va(O.path.split(".").at(-1)),apply_mode:($==null?void 0:$.apply_mode)||Y(O.path.split(".")[0])}})}),re=Z(()=>be.value.length>0),fe=Z(()=>be.value.length),F=Z(()=>new Set(be.value.map(h=>h.path.split(".")[0])).size),ee=Z(()=>!!d.value||u.value!=="all"),_e=Z(()=>{const h={...y.value};for(const O of be.value){const $=k(O.path),te=ot($,O.newVal);te&&(h[O.path]=te)}return h}),V=Z(()=>Object.keys(_e.value).length>0),ce=Z(()=>e.value?(ee.value?q.value:q.value.filter(O=>O.key===f.value)).map(O=>({...O,sections:O.sections.filter($=>et($))})).filter(O=>O.sections.length):[]),oe=Z(()=>{const h=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],O=new Map(h.map($=>[$,[]]));for(const $ of be.value){const te=O.has($.apply_mode)?$.apply_mode:"restart";O.get(te).push($)}return h.filter($=>O.get($).length).map($=>({key:$,label:Bn($),entries:O.get($)}))}),ge=Z(()=>be.value.filter(h=>h.apply_mode==="restart").length),pe=Z(()=>P.value.filter(h=>h.pending_restart)),De=Z(()=>pe.value.length);function k(h){const O=M.value.get(h);return O?{...O,apply_details:yl([O])}:null}function E(h){const O=`${h}.`;return P.value.filter($=>$.path===h||$.path.startsWith(O))}function U(h){return E(h).length}function Q(h){return va(h)}function K(h){const O=E(h);if(!O.length)return`${va(h)} configuration.`;const $=O.find(We=>We.sensitivity==="public"&&We.description)||O.find(We=>We.description),te=($==null?void 0:$.description)||"";return te.match(/setting for (.+)\.$/i)?`${va(h)} settings and runtime behaviour.`:te}function Y(h){const O=[...new Set(E(h).map($=>$.apply_mode))];return O.length===1?O[0]:O.includes("restart")?"restart":O.includes("activation_required")?"activation_required":O[0]||"restart"}function le(h){const O=[...new Set(E(h).map($=>Bn($.apply_mode)))];return O.length?O.length===1?O[0]:`Mixed apply behaviour: ${O.join(" · ")}`:""}function ae(h){return yl(E(h))}function ne(h,O){return O.split(".").reduce(($,te)=>$==null?void 0:$[te],h)}function X(h){const O=ke.value;return E(h).filter($=>Mu($.path)?!1:$.path.split(".").length<=2?!0:!$.path.includes(".*")).map($=>({...$,key:$.path.split(".").at(-1),value:ne(O,$.path),apply_details:yl([$]),editor:$.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ye(h){const O=h.path.split(".");return O.length>2?O.slice(0,2).join("."):null}function de(h){const O=new Map;for(const $ of X(h)){const te=ye($),ve=te||`${h}.__root`;O.has(ve)||O.set(ve,{key:ve,path:te,entries:[]}),O.get(ve).entries.push($)}return[...O.values()].map($=>{const te=$.entries.find(ve=>ve.group_description);return{...$,label:$.path?va($.path.split(".").at(-1)):null,description:(te==null?void 0:te.group_description)||null,apply_details:yl($.entries),runtime_summaries:we($.entries)}})}function ue(h){return{save:h.save_effect||(h.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:h.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[h.apply_mode]||"Effective runtime state is not currently observable."}}function we(h){const O=new Map;for(const $ of h){const te=ue($),ve=`${$.apply_mode}|${te.save}|${te.runtime}`;O.has(ve)||O.set(ve,{key:ve,label:Bn($.apply_mode),save:te.save,runtime:te.runtime})}return[...O.values()]}function Te(h){if(Ce(h))return h.runtime_effect||h.activation_policy||"";if(h.apply_mode==="activation_required"){const O=h.activation_policy||h.runtime_effect;return O?`Not active after saving. No activation control exists in this release. ${O}`:"Not active after saving; no activation control exists in this release."}return""}function Ce(h){return h.action_available===!0&&!!(h.action_label&&h.action_endpoint)}async function Ie(h){if(Ce(h))try{if(He(h.path))throw new Error("Save this setting before applying its action.");const O=String(h.action_method||"POST").toLowerCase(),$={post:W.post.bind(W),put:W.put.bind(W),delete:W.del.bind(W)}[O];if(!$)throw new Error("Unsupported configuration action");await $(h.action_endpoint,h.action_body||void 0),await Vn(),$t("success",`${h.action_label} completed.`)}catch(O){$t("error",O.message||`${h.action_label} failed`)}}function Pe(h,O){return[h.label,h.path,h.description,...h.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(O)}function $e(h){const O=d.value.trim().toLowerCase();return O?E(h).filter($=>Pe($,O)):[]}function et(h){const O=E(h);if(u.value!=="all"&&!O.some(te=>te.apply_state===u.value))return!1;const $=d.value.trim().toLowerCase();return!$||`${Q(h)} ${h}`.toLowerCase().includes($)?!0:O.some(te=>Pe(te,$))}function z(h,O){return E(h).filter($=>$.apply_state===O).length}function xe(h){return h==="all"?se.value:P.value.filter(O=>O.apply_state===h).length}function Re(h){const O=h.sections.flatMap($=>E($));return{fields:O.length,modified:be.value.filter($=>h.sections.includes($.path.split(".")[0])).length,pending_restart:O.filter($=>$.apply_state==="pending_restart").length,invalid:O.filter($=>$.apply_state==="invalid").length,dormant:O.filter($=>$.apply_state==="dormant").length}}function Le(h){var O;return Object.hasOwn(g.value,h)&&!ki((O=e.value)==null?void 0:O[h],g.value[h])}function He(h){return be.value.some(O=>O.path===h||O.path.startsWith(`${h}.`))}function Ve(h){f.value=h,d.value="",u.value="all";try{localStorage.setItem(_m,h)}catch{}}function ft(h){u.value=h}function ts(){d.value="",u.value="all"}function bs(h){var O;return((O=q.value.find($=>$.sections.includes(h)))==null?void 0:O.sections)||[]}function xn(h){const O=bs(h),$=O.find(te=>p.value[te]===!0);return $||O.find(te=>p.value[te]!==!1)||null}function Rs(h){return d.value&&!S.value&&et(h)?!0:S.value?xn(h)===h:Object.hasOwn(p.value,h)?p.value[h]===!0:!0}function Fs(h){const O=!Rs(h);if(S.value){const $={...p.value};for(const te of bs(h))$[te]===!0&&($[te]=!1);$[h]=O,p.value=$;return}p.value={...p.value,[h]:O}}function Rt(){v.value.push(Kn(g.value)),v.value.length>Mk&&v.value.shift(),_.value=[]}function G(){re.value&&(Rt(),g.value={},y.value={},w.value=!1)}function Oe(h,O=!1){const $=Date.now();if(O&&C.path===h&&$-C.at<Pk){C.at=$;return}Rt(),C={path:h,at:$}}function ys(h,O,$){if(!O.length)return $;const te=Kn(h??{});let ve=te;for(let We=0;We<O.length-1;We+=1){const je=O[We];ve[je]=Kn(ve[je]??{}),ve=ve[je]}return ve[O.at(-1)]=$,te}function $n(h){var O;return Object.hasOwn(g.value,h)?g.value[h]:Kn((O=e.value)==null?void 0:O[h])}function cs(h,O,$={}){var Os;const[te,...ve]=h.path.split(".");Oe(h.path,!!$.coalesce);const We=$n(te),je=ve.length?ys(We,ve,O):O,nt={...g.value};if(ki(je,(Os=e.value)==null?void 0:Os[te])?delete nt[te]:nt[te]=je,g.value=nt,y.value[h.path]){const gt={...y.value};delete gt[h.path],y.value=gt}}function Un(h){C={path:null,at:0},x.value={...x.value,[h]:String(ne(ke.value,h)??"")}}function Ya(h){if(C={path:null,at:0},!Object.hasOwn(x.value,h))return;const O={...x.value};delete O[h],x.value=O}function ds(h){const O=x.value[h.path];if(C={path:null,at:0},O===""){y.value={...y.value,[h.path]:"Enter a number."};return}const $=Number(O);if(Number.isNaN($)||h.type==="integer"&&!Number.isInteger($)){y.value={...y.value,[h.path]:h.type==="integer"?"Enter a whole number.":"Enter a number."};return}const te={...x.value};delete te[h.path],x.value=te,cs(h,$,{coalesce:!0})}function _n(h){return Object.hasOwn(x.value,h.path)?x.value[h.path]:h.value??""}function kn(h,O){if(x.value={...x.value,[h.path]:O},O===""){y.value={...y.value,[h.path]:"Enter a number."};return}const $=Number(O);if(!Number.isFinite($)||h.type==="integer"&&!Number.isInteger($)){y.value={...y.value,[h.path]:h.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(y.value[h.path]){const te={...y.value};delete te[h.path],y.value=te}cs(h,$,{coalesce:!0})}function lt(h){const O=Number.parseInt(I.value,10);if(!Number.isInteger(O)||O<1){y.value={...y.value,[h.path]:"Warning thresholds must be positive whole numbers."};return}const $=[...new Set([...h.value||[],O])].sort((te,ve)=>ve-te);I.value="",cs(h,$)}function Is(h,O){cs(h,(h.value||[]).filter($=>$!==O))}function j(h){return h.apply_mode==="live_read"?"Odin reads the saved file value on next use.":h.apply_mode==="live_for_new_work"?"New work uses the saved file value.":h.apply_mode==="live_apply"?h.apply_handler?`Apply the saved value through ${h.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":h.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":h.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":h.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ie(h){return h.type==="array"&&Array.isArray(h.value)&&!h.structured_container&&h.sensitivity==="public"&&h.value.every(O=>["string","number","boolean"].includes(typeof O))}function Ee(h){const O=String(L.value[h.path]??"").trim();if(!O)return;const $=[...new Set([...h.value||[],O])];L.value={...L.value,[h.path]:""},cs(h,$)}function Ze(h,O){cs(h,(h.value||[]).filter($=>$!==O))}function ot(h,O){var te;if(!h)return null;if((te=h.enum)!=null&&te.length&&!h.enum.includes(O))return`Choose one of: ${h.enum.join(", ")}`;if(h.path==="agents.final_warning_iterations"&&(!Array.isArray(O)||!O.length))return"Add at least one warning threshold.";const $=h.constraints||{};if((h.type==="integer"||h.type==="number")&&typeof O=="number"){if($.minimum!==void 0&&O<$.minimum)return`Must be at least ${$.minimum}${h.unit?` ${h.unit}`:""}`;if($.maximum!==void 0&&O>$.maximum)return`Must be at most ${$.maximum}${h.unit?` ${h.unit}`:""}`}return null}function Ft(h){return _e.value[h.path]||null}function Gt(h){const O=`${h}.`;return Object.keys(_e.value).some($=>$===h||$.startsWith(O))}function Qa(){v.value.length&&(_.value.push(Kn(g.value)),g.value=v.value.pop(),y.value={},x.value={},C={path:null,at:0})}function $s(){_.value.length&&(v.value.push(Kn(g.value)),g.value=_.value.pop(),y.value={},x.value={},C={path:null,at:0})}function Pr(){!re.value||V.value||(w.value=!0,b.value=!1)}function Fr(){w.value=!1}function el(){G()}function Bn(h){return Nk[h]||va(h||"unknown")}function Xa(h){return`apply-${String(h||"unknown").replaceAll("_","-")}`}function Zs(h){return`cfgc-field-${h.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function wn(h){return`${Zs(h)}-input`}function Hn(h){const O=document.getElementById(Zs(h))||document.getElementById(Zs(h.split(".").slice(0,2).join(".")));O==null||O.scrollIntoView({behavior:"smooth",block:"center"})}function $t(h,O){i.value={type:h,message:O},window.setTimeout(()=>{var $;(($=i.value)==null?void 0:$.message)===O&&(i.value=null)},3500)}function tl(){var h;r.value=!1,u.value="pending_restart",d.value="",(h=window.scrollTo)==null||h.call(window,{top:0,behavior:"smooth"})}function sl(){r.value=!1}function nl(h=1800){A&&window.clearTimeout(A),A=window.setTimeout(al,h)}async function al(){if(o.value){if(B+=1,B>45){o.value=!1,c.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await ao(),De.value===0){o.value=!1,c.value=null,$t("success","Odin restarted and the saved startup settings are active.");return}}catch{}nl(2e3)}}async function il(){if(!o.value){c.value=null;try{await W.post("/api/restart",{}),o.value=!0,B=0,r.value=!1,nl()}catch(h){c.value=h.message||"Odin could not schedule a restart."}}}async function pa(){if(!(!re.value||V.value||n.value)){n.value=!0;try{const h=Uk(e.value,g.value),O=await W.put("/api/config",h);e.value=O,g.value={},v.value=[],_.value=[],y.value={},w.value=!1;try{t.value=await ao(),l.value=null,r.value=De.value>0,$t("success",De.value?`Configuration saved. ${De.value} setting${De.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch($){l.value=$.message||"Unknown metadata error.",$t("error",`Configuration saved, but apply status could not be refreshed: ${l.value}`)}}catch(h){$t("error",h.message||"Configuration could not be saved")}finally{n.value=!1}}}async function Vn(){var h,O;if(!re.value){s.value=!0,a.value=null;try{const $=await W.get("/api/config"),te=await ao();e.value=$,t.value=te,l.value=null;const ve=q.value;if(ve.some(We=>We.key===f.value)||(f.value=((h=ve[0])==null?void 0:h.key)||Ma[0].key),S.value){const je=(((O=ve.find(nt=>nt.key===f.value))==null?void 0:O.sections)||[]).find(nt=>p.value[nt]===!0);p.value=je?{...p.value,[je]:!0}:{}}}catch($){a.value=$.message||"Unknown configuration error"}finally{s.value=!1}}}function he(h){if(w.value||!(h.ctrlKey||h.metaKey))return;const O=h.target;O instanceof HTMLElement&&(O.matches("input, textarea, select")||O.isContentEditable)||(!h.shiftKey&&h.key.toLowerCase()==="z"?(h.preventDefault(),Qa()):(h.key.toLowerCase()==="y"||h.shiftKey&&h.key.toLowerCase()==="z")&&(h.preventDefault(),$s()))}function R(h){S.value=h.matches}return Qt(p,h=>{try{localStorage.setItem(xm,JSON.stringify(h))}catch{}},{deep:!0}),Ge(()=>{var h;Vn(),document.addEventListener("keydown",he),T=window.matchMedia("(max-width: 760px)"),R(T),(h=T.addEventListener)==null||h.call(T,"change",R)}),yt(()=>{var h;document.removeEventListener("keydown",he),(h=T==null?void 0:T.removeEventListener)==null||h.call(T,"change",R),A&&window.clearTimeout(A)}),{config:e,meta:t,loading:s,saving:n,error:a,toast:i,metaRefreshError:l,restartPromptOpen:r,restartScheduled:o,restartError:c,searchQuery:d,healthFilter:u,activeCategory:f,reviewOpen:w,mobileOverflowOpen:b,warningThresholdInput:I,arrayInputs:L,healthFilters:H,visibleCategories:q,displayGroups:ce,reviewGroups:oe,sectionCount:J,fieldCount:se,hasChanges:re,changeCount:fe,changedSectionCount:F,hasDraftErrors:V,canUndo:N,canRedo:D,globalFilterActive:ee,reviewRestartCount:ge,pendingRestartCount:De,pendingRestartFields:pe,healthCount:xe,categoryStats:Re,selectCategory:Ve,selectHealthFilter:ft,clearFilters:ts,sectionLabel:Q,sectionDescription:K,sectionFieldCount:U,sectionHealthCount:z,sectionApplySummary:le,sectionApplyDetails:ae,sectionEntries:X,fieldGroups:de,sectionSearchHits:$e,fieldRuntimeCopy:ue,fieldSpecificRuntimeNote:Te,hasHonestAction:Ce,runFieldAction:Ie,sectionChanged:Le,fieldChanged:He,isSectionExpanded:Rs,toggleSection:Fs,discardAllDrafts:G,setFieldValue:cs,setNumberFieldValue:kn,numberInputValue:_n,beginInputEdit:Un,endTextInputEdit:Ya,endInputEdit:ds,addWarningThreshold:lt,removeWarningThreshold:Is,isScalarArray:ie,addScalarArrayItem:Ee,removeScalarArrayItem:Ze,fieldError:Ft,sectionHasErrors:Gt,undo:Qa,redo:$s,openReview:Pr,closeReview:Fr,mobileCancel:el,applyModeLabel:Bn,applyClass:Xa,compactValue:Fk,formatValue:$k,structuredApplyCopy:j,fieldId:Zs,fieldInputId:wn,focusField:Hn,fetchConfig:Vn,saveConfig:pa,restartOdin:il,restartLater:sl,reviewPendingRestart:tl}}},jk=/^\d{15,25}$/;function Sm(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Tm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=m(""),n=m(!1),a=m(0),i=m(null),l=Z(()=>new Set((e.excludedIds||[]).map(String))),r=Z(()=>{const w=s.value.toLowerCase().trim();return(e.members||[]).filter(b=>l.value.has(String(b.id))?!1:w?u(b).toLowerCase().includes(w)||String(b.username||"").toLowerCase().includes(w)||String(b.id).includes(w):!0)}),o=Z(()=>{const w=s.value.trim();return r.value.length===0&&jk.test(w)&&!l.value.has(w)?w:""}),c=Z(()=>r.value.length+(o.value?1:0)),d=Z(()=>{if(n.value){if(r.value[a.value])return`${e.optionsId}-${a.value}`;if(o.value&&a.value===r.value.length)return`${e.optionsId}-raw`}});function u(w){return Sm(w)}function f(){n.value=!0,a.value=0}function p(){f()}function g(){const w=Math.max(c.value-1,0);a.value=Math.min(a.value+1,w)}function x(){a.value=Math.max(a.value-1,0)}function I(){const w=r.value[a.value];w?L(w):o.value&&a.value===r.value.length&&y(o.value)}function L(w){y(String(w.id))}function y(w){t("select",w),s.value="",n.value=!1,a.value=0}function v(){n.value=!1}function _(){setTimeout(v,150)}return Ge(()=>{e.autofocus&&Et(()=>{var w;return(w=i.value)==null?void 0:w.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:r,rawId:o,activeOptionId:d,memberName:u,openOptions:f,onInput:p,highlightNext:g,highlightPrevious:x,selectHighlighted:I,selectMember:L,selectId:y,closeOptions:v,onBlur:_}}},zk={components:{DiscordUserCombobox:Tm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=m([]),t=m(!0),s=m(null),n=m({}),a=m(null),i=m(null),l=m(!1),r=m(null),o=m({}),c=m([]),d=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Discord user IDs allowed by the global bot policy.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Channel IDs included by the global bot policy.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Bot identities Odin never responds to automatically.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),u=Z(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),f=Z(()=>new Map(c.value.map(C=>[String(C.id),C])));function p(C){return C.config&&C.config.enabled!==void 0?C.config.enabled:!0}function g(C){return C.config&&C.config.require_mention!==void 0?C.config.require_mention:!1}function x(C){return C.config&&C.config.respond_to_bots!==void 0?C.config.respond_to_bots:!1}function I(C){return C.config&&Object.keys(C.config).length>0}function L(C){n.value[C]=!n.value[C]}async function y(){t.value=!0,s.value=null;try{const[C,B]=await Promise.all([W.get("/api/discord/guilds"),W.get("/api/discord/members").catch(()=>[])]);e.value=C,c.value=B;try{const M=(await W.get("/api/config")).discord||{};a.value={allowed_users:[...M.allowed_users||[]],channels:[...M.channels||[]],respond_to_bots:!!M.respond_to_bots,require_mention:!!M.require_mention,ignore_bot_ids:[...M.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value)),r.value=null}catch(P){r.value=P.message||"Global defaults could not be loaded."}}catch(C){s.value=C.message}t.value=!1}async function v(C,B,P){try{await W.put("/api/discord/guild/"+C+"/config",{[B]:P}),await y()}catch(M){s.value=M.message}}async function _(C,B,P,M){try{await W.put("/api/discord/channel/"+C+"/config",{[P]:M}),await y()}catch(J){s.value=J.message}}async function w(C,B){try{await W.put("/api/discord/channel/"+C+"/config",{clear:!0}),await y()}catch(P){s.value=P.message}}function b(C,B){const P=String(B);if(!C.userAutocomplete)return P;const M=f.value.get(P);return M?Sm(M):P}function S(C,B=null){const P=String(B??o.value[C]??"").trim();!P||i.value[C].includes(P)||(i.value[C]=[...i.value[C],P],o.value={...o.value,[C]:""})}function T(C,B){i.value[C]=i.value[C].filter(P=>P!==B)}async function A(){if(!(!u.value||l.value)){l.value=!0,r.value=null;try{const B=(await W.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...B.allowed_users||[]],channels:[...B.channels||[]],respond_to_bots:!!B.respond_to_bots,require_mention:!!B.require_mention,ignore_bot_ids:[...B.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(C){r.value=C.message||"Global defaults could not be saved."}finally{l.value=!1}}}return Ge(y),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:r,globalArrayInputs:o,globalMembers:c,globalListEditors:d,globalChanged:u,guildEnabled:p,guildMention:g,guildBots:x,hasOverride:I,toggleGuild:L,fetchGuilds:y,setGuildConfig:v,setChannelConfig:_,clearOverride:w,globalItemLabel:b,addGlobalItem:S,removeGlobalItem:T,saveGlobalDefaults:A}}},us=e=>e==null?e:JSON.parse(JSON.stringify(e));function qk({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:r=()=>{},onError:o=()=>{}}){let c=Promise.resolve(),d=0,u=0;const f=new Map;let p=null;const g=new Map;function x(b){d+=1;const S=c.then(b,b);return c=S.catch(()=>{}),S}function I(b,S){p=us(b),g.clear();for(const[T,A]of Object.entries(S||{}))g.set(T,us(A))}function L(b){const S=us(b),T=++u;return x(async()=>{try{await e(us(S)),p=us(S),T===u&&n(us(S))}catch(A){T===u&&(a(us(p)),o(A,{kind:"default"}))}})}function y(b,S){const T=us(S),A=(f.get(b)||0)+1;return f.set(b,A),x(async()=>{try{await t(b,us(T)),g.set(b,us(T)),A===f.get(b)&&i(b,us(T))}catch(C){A===f.get(b)&&(l(b,us(g.get(b)??null)),o(C,{kind:"user",uid:b}))}})}function v(b){const S=(f.get(b)||0)+1;return f.set(b,S),x(async()=>{try{await s(b),g.delete(b),S===f.get(b)&&r(b)}catch(T){S===f.get(b)&&(l(b,us(g.get(b)??null)),o(T,{kind:"delete",uid:b}))}})}async function _(){for(;;){const b=c;if(await b,b===c)return d}}async function w(b){for(;;){const S=await _(),T=await b();if(S===d)return T}}return{seed:I,saveDefault:L,saveUser:y,deleteUser:v,whenIdle:_,readSnapshot:w,get revision(){return d}}}const Gk={components:{DiscordUserCombobox:Tm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=m(!0),t=m(""),s=m(null),n=m([]),a=m({allowed_hosts:[],default_host:""}),i=m({}),l=m(!1),r=m([]),o=Z(()=>{const b={};for(const S of r.value)b[S.id]=S;return b});function c(b){return o.value[b]||null}function d(b,S){return b?b.allowed_hosts===null||b.allowed_hosts===void 0?{allowed_hosts:[...S],default_host:b.default_host||"",allow_all:!0}:{allowed_hosts:b.allowed_hosts,default_host:b.default_host||"",allow_all:!1}:{allowed_hosts:[...S],default_host:S[0]||"",allow_all:!0}}const u=qk({applyDefault:async b=>{const S=b.allow_all?null:b.allowed_hosts;await W.put("/api/host-access/default-policy",{allowed_hosts:S,default_host:b.default_host})},applyUser:async(b,S)=>{const T=S.allow_all?null:S.allowed_hosts;await W.put(`/api/host-access/user/${b}`,{allowed_hosts:T,default_host:S.default_host})},applyDelete:b=>W.del(`/api/host-access/user/${b}`),onDefaultConfirmed:()=>Se.success("Default policy updated"),onDefaultRollback:b=>{b&&(a.value=b)},onUserConfirmed:b=>{const S=c(b);Se.success(`Updated access for ${S?S.display_name:b}`)},onUserRollback:(b,S)=>{const T={...i.value};S?T[b]=S:delete T[b],i.value=T},onUserDeleted:b=>{const S={...i.value};delete S[b],i.value=S},onError:(b,S)=>{var A;const T=S.uid?` ${((A=c(S.uid))==null?void 0:A.display_name)||S.uid}`:"";Se.error(`${b.message||"Failed to save"} — reverted${T}`)}});let f=0;async function p(){const b=++f;e.value=!0,t.value="";try{const S=await u.readSnapshot(()=>W.get("/api/host-access"));if(b!==f)return;s.value=S,n.value=S.available_hosts||[],a.value=d(S.default_policy,n.value);const T=S.users||{},A={};for(const[C,B]of Object.entries(T))A[C]=d(B,n.value);i.value=A,u.seed(a.value,A)}catch(S){b===f&&(t.value=S.message||"Failed to fetch host access data")}finally{b===f&&(e.value=!1)}try{const S=await W.get("/api/discord/members")||[];b===f&&(r.value=S)}catch{b===f&&(r.value=[])}}function g(){u.saveDefault(a.value)}function x(b,S){a.value.allow_all=!1,S?a.value.allowed_hosts.includes(b)||a.value.allowed_hosts.push(b):(a.value.allowed_hosts=a.value.allowed_hosts.filter(T=>T!==b),a.value.default_host===b&&(a.value.default_host=a.value.allowed_hosts[0]||"")),g()}function I(b){const S=i.value[b];S&&u.saveUser(b,S)}function L(b,S,T){const A=i.value[b];A&&(A.allow_all=!1,T?A.allowed_hosts.includes(S)||A.allowed_hosts.push(S):(A.allowed_hosts=A.allowed_hosts.filter(C=>C!==S),A.default_host===S&&(A.default_host=A.allowed_hosts[0]||"")),I(b))}function y(b,S){const T=i.value[b];T&&(T.default_host=S,I(b))}function v(){l.value=!0}function _(b){!/^\d{15,25}$/.test(b)||i.value[b]||(i.value[b]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},I(b),l.value=!1)}async function w(b){const S=c(b);await ms({title:"Remove user override",message:`Remove the host access override for ${S?S.display_name:b}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await u.deleteUser(b),i.value[b]||Se.success(`Removed override for ${S?S.display_name:b}`))}return Ge(p),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,members:r,fetchData:p,saveDefaultPolicy:g,toggleDefaultHost:x,getMember:c,toggleUserHost:L,setUserDefault:y,openAddUser:v,addUserById:_,deleteUser:w}}},Kk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=m(!0),t=m(""),s=m(null),n=m([]),a=m(!1),i=m(!1),l=m(null),r=m(null),o=m(!1),c=m({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=m({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=Z(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=Z(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function p(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function g(){e.value=!0,t.value="";try{const T=await W.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function x(T){return!T||!T.trim()?[]:T.split(",").map(A=>A.trim()).filter(Boolean)}function I(T,A){const C=c.value.allowed_hosts;if(A&&!C.includes(T)&&C.push(T),!A){const B=C.indexOf(T);B>=0&&C.splice(B,1)}}function L(T,A){const C=d.value.allowed_hosts;if(A&&!C.includes(T)&&C.push(T),!A){const B=C.indexOf(T);B>=0&&C.splice(B,1)}}async function y(){var T;i.value=!0;try{const A=x(c.value.allowed_tools_str),C=c.value.host_mode,B=C==="none"?[]:C==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:A.length?A:[]};B!==null&&(P.allowed_hosts=B),P.default_host=c.value.default_host||"";const M=await W.post("/api/tokens",P);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Se.success("Token created"),await g()}catch(A){Se.error(((T=A.data)==null?void 0:T.error)||A.message||"Failed to create token")}finally{i.value=!1}}function v(T){r.value=T;const A=T.allowed_hosts;let C="default";A==null?C="default":Array.isArray(A)&&A.length===0?C="none":Array.isArray(A)&&(C="select"),d.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:C,allowed_hosts:Array.isArray(A)?[...A]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function _(){var T;if(r.value){o.value=!0;try{const A=x(d.value.allowed_tools_str),C=d.value.host_mode,B={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:A};C==="none"?B.allowed_hosts=[]:C==="select"?B.allowed_hosts=d.value.allowed_hosts:B.allowed_hosts=null,B.default_host=d.value.default_host||"",await W.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,Se.success("Token updated"),await g()}catch(A){Se.error(((T=A.data)==null?void 0:T.error)||A.message||"Failed to update")}finally{o.value=!1}}}async function w(T){var C;if(await ms({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await W.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=B.token,Se.success("Token regenerated")}catch(B){Se.error(((C=B.data)==null?void 0:C.error)||B.message||"Failed to regenerate")}}async function b(T){var C;if(await ms({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await W.del("/api/tokens/"+encodeURIComponent(T.user_id)),Se.success("Token deleted"),await g()}catch(B){Se.error(((C=B.data)==null?void 0:C.error)||B.message||"Failed to delete")}}async function S(){if(l.value)try{await navigator.clipboard.writeText(l.value),Se.success("Copied to clipboard")}catch{Se.error("Copy failed — select and copy manually")}}return Ge(g),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:f,fetchData:g,tierBadge:p,toggleCreateHost:I,toggleEditHost:L,createToken:y,startEdit:v,saveEdit:_,confirmRegenerate:w,confirmDelete:b,copyToken:S}}};function xl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Wk={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=m(!0),t=m(null),s=m("codex"),n=m({enabled:!1,model:"gpt-5.5",reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:"",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:75e4,keep_recent_iterations:30}}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=Z(()=>{const G=n.value.model;return G&&!a.includes(G)?[G,...a]:a}),l=Z(()=>{const G=n.value.agent_model;return G&&G!=="auto"&&!a.includes(G)?[G,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=Z(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=Z(()=>{const G=n.value.agent_model;return G==="auto"?!0:!r.includes(G||n.value.model)}),d=Z(()=>{const G=n.value.agent_reasoning_effort;return G==="auto"?!1:(G||n.value.reasoning_effort)==="max"}),u=G=>r.includes(G)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),f=G=>r.includes(G)&&d.value,p=m({enabled:!1,model:"gpt-5.6-luna"}),g=m({unavailable_reason:null}),x=Z(()=>{const G=p.value.model;return G&&!a.includes(G)?[G,...a]:a});function I(G){const Oe=G.target.value;p.value.enabled=Oe!=="",Oe!==""&&(p.value.model=Oe),et()}const L=m(!1),y=m({codex:!1,ollama:!1,kimi:!1}),v=m({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),_=m({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),w=m(!1),b=m(!1),S=m(!1),T=m(!1),A=m(!1),C=m(!1),B=m(!1),P=m({configured:!1}),M=m([]),J=m(""),se=m(!1),H=m(!1),N=m({configured:!1}),D=m([]),q=m(""),ke=m(!1),be=m(!1),re=m(!0),fe=m(""),F=m({configured:!1,accounts:[]}),ee=m(null),_e=m(null),V=m(""),ce=m(null),oe=m(!1),ge=m(null),pe=m(null),De=m("");let k=null;function E(G,Oe="success"){Se(G,Oe==="error"?"error":"success")}function U(G){if(!G)return"?";const Oe=G/(1024*1024*1024);return Oe>=1?Oe.toFixed(1)+" GB":(G/(1024*1024)).toFixed(0)+" MB"}async function Q(){e.value=!0,await Promise.all([K(),Y(),de(),le()]),e.value=!1}async function K(){try{const G=await W.get("/api/llm/status");t.value=G,s.value=G.active_provider||"codex",G.codex&&!$e.pending()&&(n.value.enabled=G.codex.enabled,n.value.model=G.codex.model||"gpt-5.5",n.value.reasoning_effort=G.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=G.codex.agent_reasoning_effort||"",n.value.agent_model=G.codex.agent_model||"",n.value.request_timeout_seconds=G.codex.request_timeout_seconds??n.value.request_timeout_seconds,n.value.stream_stall_timeout_seconds=G.codex.stream_stall_timeout_seconds??n.value.stream_stall_timeout_seconds,n.value.retry={...n.value.retry,...G.codex.retry||{}},n.value.connection_pool={...n.value.connection_pool,...G.codex.connection_pool||{}},n.value.context_compression={...n.value.context_compression,...G.codex.context_compression||{}}),G.ollama&&!z.pending()&&(v.value.enabled=G.ollama.enabled,v.value.base_url=G.ollama.base_url||"",v.value.model=G.ollama.model||"",v.value.max_tokens=G.ollama.max_tokens||4096,v.value.timeout=G.ollama.timeout??v.value.timeout),G.kimi&&!xe.pending()&&(_.value.enabled=G.kimi.enabled,_.value.model=G.kimi.model||"",_.value.max_tokens=G.kimi.max_tokens||4096,_.value.timeout=G.kimi.timeout??_.value.timeout),G.auxiliary&&(g.value=G.auxiliary,et.pending()||(p.value.enabled=G.auxiliary.enabled,p.value.model=G.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Y(){try{if(P.value=await W.get("/api/ollama/status"),P.value.model&&(J.value=P.value.model),P.value.configured)try{const G=await W.get("/api/ollama/models");M.value=G.models||[]}catch{M.value=[]}else if(v.value.base_url)try{const G=await W.post("/api/ollama/probe-models",{base_url:v.value.base_url});M.value=G.models||[]}catch{M.value=[]}}catch{P.value={configured:!1}}}async function le(){re.value=!0,fe.value="";try{F.value=await W.get("/api/codex/status")}catch(G){fe.value=G.message||"Failed to fetch Codex status"}finally{re.value=!1}}async function ae(){const G=t.value?t.value.active_provider:"codex";B.value=!0;try{const Oe=await W.post("/api/llm/switch",{provider:s.value});Oe.error?(s.value=G,E(Oe.error,"error")):(E("Switched to "+s.value+" ("+Oe.model+")"),await Q())}catch(Oe){s.value=G,E(Oe.message||"Switch failed","error")}finally{B.value=!1}}async function ne(){se.value=!0;try{const G=await W.post("/api/ollama/reload");E(G.configured?"Ollama reloaded":G.reason||"Ollama not configured",G.configured?"success":"error"),await Q()}catch(G){E(G.message||"Reload failed","error")}finally{se.value=!1}}async function X(){H.value=!0;try{await W.post("/api/ollama/model",{model:J.value}),E("Model set to "+J.value),await Q()}catch(G){E(G.message||"Failed","error")}finally{H.value=!1}}async function ye(){const G=v.value.base_url;if(!G){E("Enter a base URL first","error");return}C.value=!0;try{const Oe=await W.post("/api/ollama/probe-models",{base_url:G});M.value=Oe.models||[],M.value.length?(E(M.value.length+" model(s) found"),!v.value.model&&M.value.length&&(v.value.model=M.value[0].name)):E("No models found at "+G,"error")}catch(Oe){E(Oe.message||"Could not reach Ollama","error")}finally{C.value=!1}}async function de(){try{if(N.value=await W.get("/api/kimi/status"),N.value.model&&(q.value=N.value.model),N.value.configured)try{const G=await W.get("/api/kimi/models");D.value=G.models||[]}catch{D.value=[]}}catch{N.value={configured:!1}}}async function ue(){ke.value=!0;try{const G=await W.post("/api/kimi/reload");E(G.configured?"Kimi reloaded":G.reason||"Kimi not configured",G.configured?"success":"error"),await Q()}catch(G){E(G.message||"Reload failed","error")}finally{ke.value=!1}}async function we(){be.value=!0;try{await W.post("/api/kimi/model",{model:q.value}),E("Model set to "+q.value),await Q()}catch(G){E(G.message||"Failed","error")}finally{be.value=!1}}async function Te(){if(S.value){$e();return}S.value=!0;try{await W.put("/api/llm/codex/config",n.value),E("Codex config saved"),await Promise.all([K(),le()])}catch(G){E(G.message||"Failed","error"),await Promise.all([K(),le()])}finally{S.value=!1}}async function Ce(){if(T.value){z();return}T.value=!0;try{const G={...v.value},Oe=w.value?v.value.api_key:null;Oe===null&&delete G.api_key,await W.put("/api/llm/ollama/config",G),E("Ollama config saved"),Oe!==null&&v.value.api_key===Oe&&(v.value.api_key="",w.value=!1),await Promise.all([K(),Y()])}catch(G){E(G.message||"Failed","error")}finally{T.value=!1}}async function Ie(){if(A.value){xe();return}A.value=!0;try{const G={..._.value},Oe=b.value?_.value.api_key:null;Oe===null&&delete G.api_key,await W.put("/api/llm/kimi/config",G),E("Kimi config saved"),Oe!==null&&_.value.api_key===Oe&&(_.value.api_key="",b.value=!1),await Promise.all([K(),de()])}catch(G){E(G.message||"Failed","error")}finally{A.value=!1}}async function Pe(){if(L.value){et();return}L.value=!0;try{await W.put("/api/llm/auxiliary/config",p.value),E("Auxiliary config saved"),await K()}catch(G){E(G.message||"Failed","error"),await K()}finally{L.value=!1}}const $e=xl(Te),et=xl(Pe),z=xl(Ce),xe=xl(Ie),Re=()=>($e.cancel(),Te()),Le=()=>(z.cancel(),Ce()),He=()=>(xe.cancel(),Ie());async function Ve(G){try{await W.post("/api/codex/account/"+G+"/activate"),E("Active account switched"),await le()}catch(Oe){E(Oe.message||"Failed","error")}}async function ft(G){ee.value=G;try{await W.post("/api/codex/account/"+G+"/refresh"),E("Token refreshed"),await le()}catch(Oe){E(Oe.message||"Refresh failed","error")}finally{ee.value=null}}function ts(G,Oe){_e.value=G,V.value=Oe||""}async function bs(G){try{await W.put("/api/codex/account/"+G+"/label",{label:V.value}),E("Label updated"),_e.value=null,await le()}catch(Oe){E(Oe.message||"Failed","error")}}async function xn(G,Oe){if(await ms({title:"Delete Codex account",message:`Delete ${Oe||"account #"+(G+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await W.del("/api/codex/account/"+G),E("Deleted. Pool reloaded."),await le()}catch($n){E($n.message||"Failed","error")}}async function Rs(){oe.value=!0;try{const G=await W.post("/api/codex/device-code");ge.value=G,ce.value="pending",Fs(G)}catch(G){E(G.message||"Failed","error")}finally{oe.value=!1}}async function Fs(G){k={cancelled:!1};const Oe=k;try{const ys=await W.post("/api/codex/device-poll",{device_auth_id:G.device_auth_id,user_code:G.user_code,interval:G.interval});if(Oe.cancelled)return;pe.value=ys,ce.value="success",await Q()}catch(ys){if(Oe.cancelled)return;De.value=ys.message||"Device login failed",ce.value="error"}}function Rt(){k&&(k.cancelled=!0),ce.value=null,ge.value=null}return Ge(Q),yt(()=>{k&&(k.cancelled=!0),$e.cancel(),et.cancel(),z.cancel(),xe.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:B,advancedOpen:y,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:f,auxForm:p,auxData:g,auxModelOptions:x,onAuxModelChange:I,savingAux:L,saveAuxConfigDebounced:et,ollamaForm:v,kimiForm:_,savingCodex:S,savingOllama:T,savingKimi:A,probingOllama:C,ollamaKeyDirty:w,kimiKeyDirty:b,ollamaStatus:P,ollamaModels:M,ollamaSelectedModel:J,reloading:se,settingModel:H,kimiStatus:N,kimiModels:D,kimiSelectedModel:q,reloadingKimi:ke,settingKimiModel:be,codexLoading:re,codexError:fe,codexData:F,refreshing:ee,editingLabel:_e,labelValue:V,deviceState:ce,deviceLoading:oe,deviceInfo:ge,deviceResult:pe,deviceError:De,fetchAll:Q,switchProvider:ae,reloadOllama:ne,setOllamaModel:X,reloadKimi:ue,setKimiModel:we,probeOllamaModels:ye,saveCodexConfig:Te,saveOllamaConfig:Ce,saveKimiConfig:Ie,saveCodexConfigDebounced:$e,saveOllamaConfigDebounced:z,saveKimiConfigDebounced:xe,saveCodexConfigNow:Re,saveOllamaConfigNow:Le,saveKimiConfigNow:He,activateAccount:Ve,refreshAccount:ft,startEditLabel:ts,saveLabel:bs,deleteAccount:xn,startDeviceLogin:Rs,cancelDeviceLogin:Rt,formatSize:U}}},Pu={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Zk(e){return Pu[e]||Pu[(e||"").toLowerCase()]||"text-gray-400"}const Jk={template:`
...
`+s.join(`
`),x=this.blockquote(g);i[i.length-1]=x,n=n.substring(0,n.length-p.raw.length)+x.raw,a=a.substring(0,a.length-p.text.length)+x.text;break}else if((f==null?void 0:f.type)==="list"){const p=f,g=p.raw+`
`+s.join(`
`),x=this.list(g);i[i.length-1]=x,n=n.substring(0,n.length-f.raw.length)+x.raw,a=a.substring(0,a.length-p.raw.length)+x.raw,s=g.substring(i.at(-1).raw.length).split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Vs(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},la=new vS;function Xe(e,t){return la.parse(e,t)}Xe.options=Xe.setOptions=function(e){return la.setOptions(e),Xe.defaults=la.defaults,Im(Xe.defaults),Xe};Xe.getDefaults=Zc;Xe.defaults=fa;Xe.use=function(...e){return la.use(...e),Xe.defaults=la.defaults,Im(Xe.defaults),Xe};Xe.walkTokens=function(e,t){return la.walkTokens(e,t)};Xe.parseInline=la.parseInline;Xe.Parser=cn;Xe.parser=cn.parse;Xe.Renderer=lr;Xe.TextRenderer=nd;Xe.Lexer=on;Xe.lexer=on.lex;Xe.Tokenizer=ir;Xe.Hooks=Il;Xe.parse=Xe;Xe.options;Xe.setOptions;Xe.use;Xe.walkTokens;Xe.parseInline;cn.parse;on.lex;const bS={breaks:!0,gfm:!0};function af(e){if(!e)return"";try{if(typeof Xe<"u"&&Xe.parse){const t=Xe.parse(e,bS);return typeof Qu<"u"?Qu.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function yS(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const xS={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function _S(e){return xS[e]||"wrench"}const kS=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function lf(e){if(!e)return[];const t=e.match(kS);return t?[...new Set(t)]:[]}const wS={template:`
    ...
    </div>`,setup(){const e=m([]),t=m(""),s=m(!1),n=m(null),a=m(null),i=m(0),l=m("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],d=Z(()=>t.value.trim().length>0&&!s.value),u=m(qe.state||"disconnected");let f=null,p=null;const g=Z(()=>{const H=u.value;return H==="connected"?"Connected":H==="reconnecting"?"Reconnecting…":H==="connecting"?"Connecting…":"REST fallback"}),x=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],I=Z(()=>{const H=Math.floor(i.value/4)%x.length,N=i.value;return N>3?`${x[H]} (${N}s)`:x[0]});function L(){Et(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function y(){if(!a.value)return;const H=a.value;H.style.height="auto",H.style.height=Math.min(H.scrollHeight,120)+"px"}function v(H,N,D={}){const q={id:++o,role:H,content:N,timestamp:Date.now(),html:H==="bot"?af(N):"",tools_used:D.tools_used||[],is_error:D.is_error||!1,images:H==="bot"?lf(N):[],files:D.files||[],_showTools:!1};return e.value.push(q),L(),H==="bot"&&Et(()=>_()),q}function _(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(N=>{N.setAttribute("data-copy","true"),N.style.position="relative";const D=document.createElement("button");D.className="chat-code-copy",D.textContent="Copy",D.addEventListener("click",()=>{const q=N.querySelector("code"),ke=q?q.textContent:N.textContent;navigator.clipboard.writeText(ke).then(()=>{D.textContent="Copied!",setTimeout(()=>{D.textContent="Copy"},1500)}).catch(()=>{})}),N.appendChild(D)})}function w(H){if(H===0)return!0;const N=e.value[H-1],D=e.value[H],q=new Date(N.timestamp).toDateString(),ke=new Date(D.timestamp).toDateString();return q!==ke}function b(H){const N=new Date(H),D=new Date;if(N.toDateString()===D.toDateString())return"Today";const q=new Date(D);return q.setDate(q.getDate()-1),N.toDateString()===q.toDateString()?"Yesterday":N.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function S(H){t.value=H,Et(()=>J())}function T(H){window.open(H,"_blank","noopener")}function A(H){H.target.style.display="none"}function C(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function B(){r&&(clearInterval(r),r=null),i.value=0}function P(H){s.value&&(s.value=!1,B(),H.type==="chat_response"?v("bot",H.content,{tools_used:H.tools_used||[],is_error:H.is_error||!1,files:H.files||[]}):H.type==="chat_error"&&v("bot",H.error||"Unknown error",{is_error:!0}),Et(()=>{var N;return(N=a.value)==null?void 0:N.focus()}))}async function M(H){try{const N=await W.post("/api/chat",{content:H,channel_id:l.value});v("bot",N.response,{tools_used:N.tools_used||[],is_error:N.is_error||!1,files:N.files||[]})}catch(N){v("bot",N.message||"Failed to send message",{is_error:!0})}}async function J(){const H=t.value.trim();if(!H||s.value)return;v("user",H),t.value="",s.value=!0,C(),a.value&&(a.value.style.height="auto"),qe.connected&&qe.sendChat(H,{channelId:l.value})||(await M(H),s.value=!1,B()),Et(()=>{var D;return(D=a.value)==null?void 0:D.focus()})}async function se(){try{if(!l.value){const N=await W.get("/api/auth/session");l.value=N.channel_id||N.user_id||"web-user"}const H=await W.get("/api/sessions/"+encodeURIComponent(l.value));if(H&&H.messages&&H.messages.length>0){for(const N of H.messages){const D=N.role==="user"?"user":"bot";let q=N.content||"";if(D==="user"){const be=q.match(/^\[.*?\]:\s*/);be&&(q=q.slice(be[0].length))}if(!q.trim())continue;const ke={id:++o,role:D,content:q,timestamp:N.timestamp?N.timestamp*1e3:Date.now(),html:D==="bot"?af(q):"",tools_used:[],is_error:!1,images:D==="bot"?lf(q):[],files:[],_showTools:!1};e.value.push(ke)}Et(()=>{L(),_()})}}catch{}}return Ge(()=>{qe.subscribe("chat",P),u.value=qe.state||"disconnected",f=qe.onStateChange,p=(H,N)=>{u.value=H,f&&f(H,N)},qe.onStateChange=p,se(),Et(()=>{var H;return(H=a.value)==null?void 0:H.focus()})}),yt(()=>{qe.unsubscribe("chat",P),qe.onStateChange===p&&(qe.onStateChange=f),B()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:d,wsStatus:g,typingText:I,suggestions:c,send:J,autoResize:y,formatTime:yS,formatDate:b,showDateSeparator:w,useSuggestion:S,openImage:T,onImageError:A,getToolIcon:_S}}},SS={setup(){const e=m("odin"),t=m(""),s=m(""),n=m(""),a=m({}),i=m([]),l=m([]),r=m(!1),o=m(!1),c=m(null),d=m(!0),u=m(""),f=m(!1),p=m(!1),g=Z(()=>e.value==="custom"),x=Z(()=>[...i.value,...l.value]),I=Z(()=>l.value.includes(e.value)),L=Z(()=>{var T;return g.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),y=Z(()=>{var T;return g.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),v=Z(()=>{var T;return g.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function _(){d.value=!0;try{const T=await W.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{d.value=!1}}async function w(){r.value=!0,c.value=null,o.value=!1;try{await W.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(T){c.value=T.message}finally{r.value=!1}}async function b(){const T=u.value.trim();if(T){p.value=!0,c.value=null;try{await W.post("/api/personality/presets",{name:T,display_name:L.value,identity:y.value,voice:v.value}),f.value=!1,u.value="",await _(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(A){c.value=A.message}finally{p.value=!1}}}async function S(){if(await ms({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await W.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await _(),e.value="odin"}catch(A){c.value=A.message}}}return Ge(_),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:x,isCustom:g,isUserPreset:I,previewName:L,previewIdentity:y,previewVoice:v,saving:r,saved:o,error:c,loading:d,save:w,showSavePreset:f,newPresetName:u,savingPreset:p,saveAsPreset:b,deletePreset:S,builtinPresets:i,userPresets:l}},template:`
  ...
  `},xt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Hm=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:iw,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:wS,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lk,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pk,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kk,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:SS,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Qk,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:xt("/operations","live")},{path:"/agents",redirect:xt("/operations","agents")},{path:"/loops",redirect:xt("/operations","loops")},{path:"/processes",redirect:xt("/operations","processes")},{path:"/schedules",redirect:xt("/operations","schedules")},{path:"/audit",redirect:xt("/history","audit")},{path:"/sessions",redirect:xt("/history","sessions")},{path:"/traces",redirect:xt("/history","traces")},{path:"/usage",redirect:xt("/history","usage")},{path:"/tools",redirect:xt("/capabilities","tools")},{path:"/skills",redirect:xt("/capabilities","skills")},{path:"/knowledge",redirect:xt("/capabilities","knowledge")},{path:"/memory",redirect:xt("/capabilities","memory")},{path:"/learned",redirect:xt("/capabilities","learned")},{path:"/health",redirect:xt("/system","health")},{path:"/resources",redirect:xt("/system","resources")},{path:"/logs",redirect:xt("/system","logs")},{path:"/config",redirect:xt("/system","config")},{path:"/host-access",redirect:xt("/system","host-access")},{path:"/internals",redirect:xt("/system","internals")}],Si=G_({history:S_(),routes:Hm});Si.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const TS={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=m("checking"),t=m(!1),s=m(!1),n=m(!1),a=m(null),i=m(null),l=m(!1);let r=null,o=null;const c=m(!1),d=m("disconnected"),u=m(-1),f=m(null);let p=null;const g=m("starting"),x=m(""),I=Hm.filter(N=>N.meta),L=Z(()=>["Workspace","Operate","Observe","Manage"].map(N=>({name:N,routes:I.filter(D=>D.meta.section===N)})).filter(N=>N.routes.length)),y=Z(()=>{var N;return((N=Si.currentRoute.value.meta)==null?void 0:N.label)||"Odin"}),v=Z(()=>{var N;return((N=Si.currentRoute.value.meta)==null?void 0:N.section)||"Management"}),_=Z(()=>{var N;return((N=Si.currentRoute.value.meta)==null?void 0:N.description)||"Management console"});W.onSessionExpired=()=>{t.value=!0,qe.disconnect(),W.setToken(""),e.value="login"};function w(N){var D;if((N.ctrlKey||N.metaKey)&&N.key.toLowerCase()==="k"){e.value==="ready"&&(N.preventDefault(),Fu());return}if(n.value&&N.key==="Tab"){const q=[...((D=a.value)==null?void 0:D.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(q.length){const ke=q[0],be=q[q.length-1];if(N.shiftKey&&(document.activeElement===ke||!a.value.contains(document.activeElement))){N.preventDefault(),be.focus();return}if(!N.shiftKey&&(document.activeElement===be||!a.value.contains(document.activeElement))){N.preventDefault(),ke.focus();return}}}if(N.key==="Escape"&&n.value){n.value=!1,N.preventDefault();return}if(N.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(N.target.tagName)){N.preventDefault();const q=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');q&&q.focus()}}function b(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Ge(async()=>{document.addEventListener("keydown",w),r=window.matchMedia("(max-width: 900px)"),b(),r.addEventListener("change",b);const N=await W.check();N.ok?(e.value="ready",se()):N.needsAuth?e.value="login":(e.value="ready",se())});function S(){t.value=!1,e.value="ready",se()}async function T(){await W.logout(),qe.disconnect(),e.value="login"}function A(){s.value=!s.value}function C(){n.value=!n.value}Qt(n,async N=>{var D,q;if(N)o=document.activeElement,await Et(),(q=(D=a.value)==null?void 0:D.querySelector(".nav-item"))==null||q.focus();else if(o!=null&&o.isConnected){const ke=o;o=null,requestAnimationFrame(()=>ke.focus())}});const B=Z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(N,D="info",q=3e3){f.value={text:N,level:D},clearTimeout(p),p=setTimeout(()=>{f.value=null},q)}let M=null,J=!1;function se(){qe.onStatusChange=N=>{c.value=N},qe.onLatency=N=>{u.value=N},qe.onStateChange=(N,D)=>{d.value=N,N==="connected"?(J&&P("Connection restored","success"),J=!0):N==="reconnecting"&&D.attempt===1&&P("Connection lost — reconnecting…","warn")},qe.connect(),H(),M&&clearInterval(M),M=setInterval(H,15e3)}async function H(){try{const N=await W.get("/api/status");g.value=N.status==="online"?"online":"starting";const D=N.uptime_seconds||0,q=Math.floor(D/3600),ke=Math.floor(D%3600/60);x.value=`${q}h ${ke}m uptime`}catch{g.value="offline",x.value=""}}return yt(()=>{M&&clearInterval(M),qe.disconnect(),document.removeEventListener("keydown",w),r==null||r.removeEventListener("change",b)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:B,wsToast:f,botStatus:g,botUptime:x,navRoutes:I,navGroups:L,currentPage:y,currentSection:v,currentDescription:_,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:S,logout:T,toggleSidebar:A,toggleMobileNavigation:C,openPalette:Fu}}},Fn=Wl(CS);Fn.component("odin-icon",sw);Fn.component("login-screen",TS);Fn.component("toast-container",$0);Fn.component("confirm-host",U0);Fn.component("command-palette",tw);Fn.directive("modal-focus",aw);Fn.use(Si);Fn.mount("#app");
