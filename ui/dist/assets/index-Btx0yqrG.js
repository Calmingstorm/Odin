var $g=Object.defineProperty;var Ug=(e,t,s)=>t in e?$g(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var rt=(e,t,s)=>Ug(e,typeof t!="symbol"?t+"":t,s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();class Bg{constructor(){this._persist=localStorage.getItem("odin_persist")==="1",this._token=this._persist?localStorage.getItem("odin_token")||"":sessionStorage.getItem("odin_token")||"";const t=this._persist?localStorage:sessionStorage;this._sessionTimeout=parseInt(t.getItem("odin_session_timeout")||"0",10),this._lastActivity=Date.now(),this._activityTimer=null,this.onSessionExpired=null,this._token&&this._sessionTimeout>0&&this._startActivityMonitor()}get token(){return this._token}get sessionTimeout(){return this._sessionTimeout}setToken(t,s=0){if(this._token=t,this._sessionTimeout=s,this._lastActivity=Date.now(),t){const n=this._persist?localStorage:sessionStorage;n.setItem("odin_token",t),this._persist&&localStorage.setItem("odin_persist","1"),s>0?n.setItem("odin_session_timeout",String(s)):n.removeItem("odin_session_timeout"),this._startActivityMonitor()}else sessionStorage.removeItem("odin_token"),sessionStorage.removeItem("odin_session_timeout"),localStorage.removeItem("odin_token"),localStorage.removeItem("odin_persist"),localStorage.removeItem("odin_session_timeout"),this._stopActivityMonitor()}setPersist(t){this._persist=t}_startActivityMonitor(){this._stopActivityMonitor(),!(this._sessionTimeout<=0)&&(this._activityTimer=setInterval(()=>{(Date.now()-this._lastActivity)/1e3>=this._sessionTimeout&&(this._stopActivityMonitor(),this.onSessionExpired&&this.onSessionExpired())},1e4))}_stopActivityMonitor(){this._activityTimer&&(clearInterval(this._activityTimer),this._activityTimer=null)}_headers(t={}){const s={"Content-Type":"application/json",...t};return this._token&&(s.Authorization=`Bearer ${this._token}`),s}async _request(t,s,n=null,{signal:a}={}){this._lastActivity=Date.now();const i={method:t,headers:this._headers(),signal:a};n!==null&&(i.body=JSON.stringify(n));const l=await fetch(s,i);if(l.status===401)throw new Yi("Unauthorized");const r=await l.json().catch(()=>null);if(!l.ok){const o=(r==null?void 0:r.error)||`HTTP ${l.status}`;throw new ed(o,l.status,r)}return r}get(t,s={}){return this._request("GET",t,null,s)}async getBlob(t){this._lastActivity=Date.now();const s=await fetch(t,{method:"GET",headers:this._headers()});if(s.status===401)throw new Yi("Unauthorized");if(!s.ok){const n=await s.json().catch(()=>null);throw new ed((n==null?void 0:n.error)||`HTTP ${s.status}`,s.status,n)}return s.blob()}post(t,s){return this._request("POST",t,s)}put(t,s){return this._request("PUT",t,s)}del(t){return this._request("DELETE",t)}async login(t){const s=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})}),n=await s.json().catch(()=>null);if(!s.ok)throw new Yi((n==null?void 0:n.error)||"Login failed");return this.setToken(n.session_id,n.timeout_seconds||0),n}async logout(){try{await this.post("/api/auth/logout",{})}catch{}this.setToken("")}async check(){try{return await this.get("/api/status"),{ok:!0,needsAuth:!1}}catch(t){return t instanceof Yi?{ok:!1,needsAuth:!0}:{ok:!1,needsAuth:!1,error:t.message}}}}class Yi extends Error{constructor(t){super(t),this.name="AuthError"}}class ed extends Error{constructor(t,s,n){super(t),this.name="ApiError",this.status=s,this.data=n}}class Hg{constructor(t){this._api=t,this._ws=null,this._handlers={logs:[],events:[],chat:[]},this._reconnectDelay=1e3,this._maxReconnectDelay=3e4,this._shouldConnect=!1,this._subscriptions=new Set,this._reconnectAttempt=0,this._lastPongTime=0,this._pingInterval=null,this._latency=-1,this._chatPending=!1,this._state="disconnected",this.onStatusChange=null,this.onStateChange=null,this.onLatency=null}get connected(){var t;return((t=this._ws)==null?void 0:t.readyState)===WebSocket.OPEN}get state(){return this._state}get reconnectAttempt(){return this._reconnectAttempt}get latency(){return this._latency}_resetLatency(){if(this._latency=-1,this.onLatency)try{this.onLatency(-1)}catch{}}connect(){this._shouldConnect=!0,this._setState("connecting"),this._open()}disconnect(){this._shouldConnect=!1,this._reconnectAttempt=0,this._resetLatency(),this._stopPing(),this._ws&&(this._ws.close(),this._ws=null),this._setState("disconnected")}_setState(t){this._state!==t&&(this._state=t,this.onStateChange&&this.onStateChange(t,{attempt:this._reconnectAttempt,latency:this._latency}))}_startPing(){this._stopPing(),this._pingInterval=setInterval(()=>{if(this.connected)try{this._ws.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}},15e3)}_stopPing(){this._pingInterval&&(clearInterval(this._pingInterval),this._pingInterval=null)}subscribe(t,s){this._handlers[t]||(this._handlers[t]=[]),this._handlers[t].push(s),t!=="chat"&&(this._subscriptions.add(t),this.connected&&this._ws.send(JSON.stringify({subscribe:t})))}unsubscribe(t,s){const n=this._handlers[t];if(n){const a=n.indexOf(s);a>=0&&n.splice(a,1),n.length===0&&t!=="chat"&&(this._subscriptions.delete(t),this.connected&&this._ws.send(JSON.stringify({unsubscribe:t})))}}on(t,s){return this.subscribe(t,s)}off(t,s){return this.unsubscribe(t,s)}sendChat(t,{channelId:s,userId:n,username:a}={}){return this.connected?(this._ws.send(JSON.stringify({type:"chat",content:t,channel_id:s||"web-default",user_id:n||void 0,username:a||void 0})),this._chatPending=!0,!0):!1}_open(){if(this._ws)return;let s=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/api/ws`;this._api.token&&(s+=`?token=${encodeURIComponent(this._api.token)}`);const n=new WebSocket(s);this._ws=n;const a=()=>this._ws===n;n.onopen=()=>{if(a()){this._reconnectDelay=1e3,this._reconnectAttempt=0;for(const i of this._subscriptions)n.send(JSON.stringify({subscribe:i}));this._startPing(),this._setState("connected"),this.onStatusChange&&this.onStatusChange(!0)}},n.onmessage=i=>{if(!a())return;let l;try{l=JSON.parse(i.data)}catch{return}const r=l.type;if(r==="pong"){if(l.ts&&(this._latency=Date.now()-l.ts,this._lastPongTime=Date.now(),this.onLatency))try{this.onLatency(this._latency)}catch{}return}if(r==="log")for(const o of this._handlers.logs||[])o(l);else if(r==="event")for(const o of this._handlers.events||[])o(l);else if(r==="chat_response"||r==="chat_error"){this._chatPending=!1;for(const o of this._handlers.chat||[])o(l)}},n.onclose=()=>{if(a()){if(this._ws=null,this._stopPing(),this._resetLatency(),this._chatPending){this._chatPending=!1;const i={type:"chat_error",error:"Connection lost — the response may still complete; check session history."};for(const l of this._handlers.chat||[])l(i)}this.onStatusChange&&this.onStatusChange(!1),this._shouldConnect?(this._reconnectAttempt++,this._setState("reconnecting"),setTimeout(()=>this._open(),this._reconnectDelay),this._reconnectDelay=Math.min(this._reconnectDelay*2,this._maxReconnectDelay)):this._setState("disconnected")}},n.onerror=()=>{}}}const Q=new Bg,Ze=new Hg(Q);/**
* @vue/shared v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function ys(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const Ge={},wa=[],Bt=()=>{},xa=()=>!1,na=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Jl=e=>e.startsWith("onUpdate:"),ze=Object.assign,Mo=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Vg=Object.prototype.hasOwnProperty,et=(e,t)=>Vg.call(e,t),ve=Array.isArray,ka=e=>za(e)==="[object Map]",aa=e=>za(e)==="[object Set]",td=e=>za(e)==="[object Date]",jg=e=>za(e)==="[object RegExp]",Ie=e=>typeof e=="function",Pe=e=>typeof e=="string",Kt=e=>typeof e=="symbol",Xe=e=>e!==null&&typeof e=="object",Po=e=>(Xe(e)||Ie(e))&&Ie(e.then)&&Ie(e.catch),sf=Object.prototype.toString,za=e=>sf.call(e),zg=e=>za(e).slice(8,-1),Yl=e=>za(e)==="[object Object]",Ql=e=>Pe(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,fn=ys(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),qg=ys("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),Xl=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Gg=/-\w/g,lt=Xl(e=>e.replace(Gg,t=>t.slice(1).toUpperCase())),Kg=/\B([A-Z])/g,os=Xl(e=>e.replace(Kg,"-$1").toLowerCase()),ia=Xl(e=>e.charAt(0).toUpperCase()+e.slice(1)),Sa=Xl(e=>e?`on${ia(e)}`:""),Dt=(e,t)=>!Object.is(e,t),Ta=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},nf=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},er=e=>{const t=parseFloat(e);return isNaN(t)?e:t},xl=e=>{const t=Pe(e)?Number(e):NaN;return isNaN(t)?e:t};let sd;const tr=()=>sd||(sd=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Wg(e,t){return e+JSON.stringify(t,(s,n)=>typeof n=="function"?n.toString():n)}const Zg="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol",Jg=ys(Zg);function $i(e){if(ve(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],a=Pe(n)?af(n):$i(n);if(a)for(const i in a)t[i]=a[i]}return t}else if(Pe(e)||Xe(e))return e}const Yg=/;(?![^(]*\))/g,Qg=/:([^]+)/,Xg=/\/\*[^]*?\*\//g;function af(e){const t={};return e.replace(Xg,"").split(Yg).forEach(s=>{if(s){const n=s.split(Qg);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function Ui(e){let t="";if(Pe(e))t=e;else if(ve(e))for(let s=0;s<e.length;s++){const n=Ui(e[s]);n&&(t+=n+" ")}else if(Xe(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function em(e){if(!e)return null;let{class:t,style:s}=e;return t&&!Pe(t)&&(e.class=Ui(t)),s&&(e.style=$i(s)),e}const tm="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",sm="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",nm="annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics",am="area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr",im=ys(tm),lm=ys(sm),rm=ys(nm),om=ys(am),cm="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",dm=ys(cm);function lf(e){return!!e||e===""}function um(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=mn(e[n],t[n]);return s}function mn(e,t){if(e===t)return!0;let s=td(e),n=td(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=Kt(e),n=Kt(t),s||n)return e===t;if(s=ve(e),n=ve(t),s||n)return s&&n?um(e,t):!1;if(s=Xe(e),n=Xe(t),s||n){if(!s||!n)return!1;const a=Object.keys(e).length,i=Object.keys(t).length;if(a!==i)return!1;for(const l in e){const r=e.hasOwnProperty(l),o=t.hasOwnProperty(l);if(r&&!o||!r&&o||!mn(e[l],t[l]))return!1}}return String(e)===String(t)}function sr(e,t){return e.findIndex(s=>mn(s,t))}const rf=e=>!!(e&&e.__v_isRef===!0),of=e=>Pe(e)?e:e==null?"":ve(e)||Xe(e)&&(e.toString===sf||!Ie(e.toString))?rf(e)?of(e.value):JSON.stringify(e,cf,2):String(e),cf=(e,t)=>rf(t)?cf(e,t.value):ka(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,a],i)=>(s[Er(n,i)+" =>"]=a,s),{})}:aa(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>Er(s))}:Kt(t)?Er(t):Xe(t)&&!ve(t)&&!Yl(t)?String(t):t,Er=(e,t="")=>{var s;return Kt(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};function fm(e){return e==null?"initial":typeof e=="string"?e===""?" ":e:String(e)}/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let It;class Fo{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&It&&(It.active?(this.parent=It,this.index=(It.scopes||(It.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=It;try{return It=this,t()}finally{It=s}}}on(){++this._on===1&&(this.prevScope=It,It=this)}off(){if(this._on>0&&--this._on===0){if(It===this)It=this.prevScope;else{let t=It;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0}}}function pm(e){return new Fo(e)}function df(){return It}function hm(e,t=!1){It&&It.cleanups.push(e)}let dt;const Ar=new WeakSet;class xi{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,It&&(It.active?It.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Ar.has(this)&&(Ar.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||ff(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,nd(this),pf(this);const t=dt,s=Ls;dt=this,Ls=!0;try{return this.fn()}finally{hf(this),dt=t,Ls=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Bo(t);this.deps=this.depsTail=void 0,nd(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Ar.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Xr(this)&&this.run()}get dirty(){return Xr(this)}}let uf=0,ci,di;function ff(e,t=!1){if(e.flags|=8,t){e.next=di,di=e;return}e.next=ci,ci=e}function $o(){uf++}function Uo(){if(--uf>0)return;if(di){let t=di;for(di=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;ci;){let t=ci;for(ci=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function pf(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function hf(e){let t,s=e.depsTail,n=s;for(;n;){const a=n.prevDep;n.version===-1?(n===s&&(s=a),Bo(n),gm(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=a}e.deps=t,e.depsTail=s}function Xr(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(gf(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function gf(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===_i)||(e.globalVersion=_i,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Xr(e))))return;e.flags|=2;const t=e.dep,s=dt,n=Ls;dt=e,Ls=!0;try{pf(e);const a=e.fn(e._value);(t.version===0||Dt(a,e._value))&&(e.flags|=128,e._value=a,t.version++)}catch(a){throw t.version++,a}finally{dt=s,Ls=n,hf(e),e.flags&=-3}}function Bo(e,t=!1){const{dep:s,prevSub:n,nextSub:a}=e;if(n&&(n.nextSub=a,e.prevSub=void 0),a&&(a.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let i=s.computed.deps;i;i=i.nextDep)Bo(i,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function gm(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}function mm(e,t){e.effect instanceof xi&&(e=e.effect.fn);const s=new xi(e);t&&ze(s,t);try{s.run()}catch(a){throw s.stop(),a}const n=s.run.bind(s);return n.effect=s,n}function vm(e){e.effect.stop()}let Ls=!0;const mf=[];function vn(){mf.push(Ls),Ls=!1}function bn(){const e=mf.pop();Ls=e===void 0?!0:e}function nd(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=dt;dt=void 0;try{t()}finally{dt=s}}}let _i=0;class bm{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class nr{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!dt||!Ls||dt===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==dt)s=this.activeLink=new bm(dt,this),dt.deps?(s.prevDep=dt.depsTail,dt.depsTail.nextDep=s,dt.depsTail=s):dt.deps=dt.depsTail=s,vf(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=dt.depsTail,s.nextDep=void 0,dt.depsTail.nextDep=s,dt.depsTail=s,dt.deps===s&&(dt.deps=n)}return s}trigger(t){this.version++,_i++,this.notify(t)}notify(t){$o();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Uo()}}}function vf(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)vf(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const _l=new WeakMap,Wn=Symbol(""),eo=Symbol(""),wi=Symbol("");function zt(e,t,s){if(Ls&&dt){let n=_l.get(e);n||_l.set(e,n=new Map);let a=n.get(s);a||(n.set(s,a=new nr),a.map=n,a.key=s),a.track()}}function rn(e,t,s,n,a,i){const l=_l.get(e);if(!l){_i++;return}const r=o=>{o&&o.trigger()};if($o(),t==="clear")l.forEach(r);else{const o=ve(e),c=o&&Ql(s);if(o&&s==="length"){const d=Number(n);l.forEach((u,f)=>{(f==="length"||f===wi||!Kt(f)&&f>=d)&&r(u)})}else switch((s!==void 0||l.has(void 0))&&r(l.get(s)),c&&r(l.get(wi)),t){case"add":o?c&&r(l.get("length")):(r(l.get(Wn)),ka(e)&&r(l.get(eo)));break;case"delete":o||(r(l.get(Wn)),ka(e)&&r(l.get(eo)));break;case"set":ka(e)&&r(l.get(Wn));break}}Uo()}function ym(e,t){const s=_l.get(e);return s&&s.get(t)}function ua(e){const t=Je(e);return t===e?t:(zt(t,"iterate",wi),ds(e)?t:t.map(Ds))}function ar(e){return zt(e=Je(e),"iterate",wi),e}function qs(e,t){return Ks(e)?La(pn(e)?Ds(t):t):Ds(t)}const xm={__proto__:null,[Symbol.iterator](){return Rr(this,Symbol.iterator,e=>qs(this,e))},concat(...e){return ua(this).concat(...e.map(t=>ve(t)?ua(t):t))},entries(){return Rr(this,"entries",e=>(e[1]=qs(this,e[1]),e))},every(e,t){return Qs(this,"every",e,t,void 0,arguments)},filter(e,t){return Qs(this,"filter",e,t,s=>s.map(n=>qs(this,n)),arguments)},find(e,t){return Qs(this,"find",e,t,s=>qs(this,s),arguments)},findIndex(e,t){return Qs(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return Qs(this,"findLast",e,t,s=>qs(this,s),arguments)},findLastIndex(e,t){return Qs(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return Qs(this,"forEach",e,t,void 0,arguments)},includes(...e){return Ir(this,"includes",e)},indexOf(...e){return Ir(this,"indexOf",e)},join(e){return ua(this).join(e)},lastIndexOf(...e){return Ir(this,"lastIndexOf",e)},map(e,t){return Qs(this,"map",e,t,void 0,arguments)},pop(){return Wa(this,"pop")},push(...e){return Wa(this,"push",e)},reduce(e,...t){return ad(this,"reduce",e,t)},reduceRight(e,...t){return ad(this,"reduceRight",e,t)},shift(){return Wa(this,"shift")},some(e,t){return Qs(this,"some",e,t,void 0,arguments)},splice(...e){return Wa(this,"splice",e)},toReversed(){return ua(this).toReversed()},toSorted(e){return ua(this).toSorted(e)},toSpliced(...e){return ua(this).toSpliced(...e)},unshift(...e){return Wa(this,"unshift",e)},values(){return Rr(this,"values",e=>qs(this,e))}};function Rr(e,t,s){const n=ar(e),a=n[t]();return n!==e&&!ds(e)&&(a._next=a.next,a.next=()=>{const i=a._next();return i.done||(i.value=s(i.value)),i}),a}const _m=Array.prototype;function Qs(e,t,s,n,a,i){const l=ar(e),r=l!==e&&!ds(e),o=l[t];if(o!==_m[t]){const u=o.apply(e,i);return r?Ds(u):u}let c=s;l!==e&&(r?c=function(u,f){return s.call(this,qs(e,u),f,e)}:s.length>2&&(c=function(u,f){return s.call(this,u,f,e)}));const d=o.call(l,c,n);return r&&a?a(d):d}function ad(e,t,s,n){const a=ar(e),i=a!==e&&!ds(e);let l=s,r=!1;a!==e&&(i?(r=n.length===0,l=function(c,d,u){return r&&(r=!1,c=qs(e,c)),s.call(this,c,qs(e,d),u,e)}):s.length>3&&(l=function(c,d,u){return s.call(this,c,d,u,e)}));const o=a[t](l,...n);return r?qs(e,o):o}function Ir(e,t,s){const n=Je(e);zt(n,"iterate",wi);const a=n[t](...s);return(a===-1||a===!1)&&Bi(s[0])?(s[0]=Je(s[0]),n[t](...s)):a}function Wa(e,t,s=[]){vn(),$o();const n=Je(e)[t].apply(e,s);return Uo(),bn(),n}const wm=ys("__proto__,__v_isRef,__isVue"),bf=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Kt));function km(e){Kt(e)||(e=String(e));const t=Je(this);return zt(t,"has",e),t.hasOwnProperty(e)}class yf{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const a=this._isReadonly,i=this._isShallow;if(s==="__v_isReactive")return!a;if(s==="__v_isReadonly")return a;if(s==="__v_isShallow")return i;if(s==="__v_raw")return n===(a?i?Tf:Sf:i?kf:wf).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const l=ve(t);if(!a){let o;if(l&&(o=xm[s]))return o;if(s==="hasOwnProperty")return km}const r=Reflect.get(t,s,Tt(t)?t:n);if((Kt(s)?bf.has(s):wm(s))||(a||zt(t,"get",s),i))return r;if(Tt(r)){const o=l&&Ql(s)?r:r.value;return a&&Xe(o)?wl(o):o}return Xe(r)?a?wl(r):Fn(r):r}}class xf extends yf{constructor(t=!1){super(!1,t)}set(t,s,n,a){let i=t[s];const l=ve(t)&&Ql(s);if(!this._isShallow){const c=Ks(i);if(!ds(n)&&!Ks(n)&&(i=Je(i),n=Je(n)),!l&&Tt(i)&&!Tt(n))return c||(i.value=n),!0}const r=l?Number(s)<t.length:et(t,s),o=Reflect.set(t,s,n,Tt(t)?t:a);return t===Je(a)&&(r?Dt(n,i)&&rn(t,"set",s,n):rn(t,"add",s,n)),o}deleteProperty(t,s){const n=et(t,s);t[s];const a=Reflect.deleteProperty(t,s);return a&&n&&rn(t,"delete",s,void 0),a}has(t,s){const n=Reflect.has(t,s);return(!Kt(s)||!bf.has(s))&&zt(t,"has",s),n}ownKeys(t){return zt(t,"iterate",ve(t)?"length":Wn),Reflect.ownKeys(t)}}class _f extends yf{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const Sm=new xf,Tm=new _f,Cm=new xf(!0),Em=new _f(!0),to=e=>e,Qi=e=>Reflect.getPrototypeOf(e);function Am(e,t,s){return function(...n){const a=this.__v_raw,i=Je(a),l=ka(i),r=e==="entries"||e===Symbol.iterator&&l,o=e==="keys"&&l,c=a[e](...n),d=s?to:t?La:Ds;return!t&&zt(i,"iterate",o?eo:Wn),ze(Object.create(c),{next(){const{value:u,done:f}=c.next();return f?{value:u,done:f}:{value:r?[d(u[0]),d(u[1])]:d(u),done:f}}})}}function Xi(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function Rm(e,t){const s={get(a){const i=this.__v_raw,l=Je(i),r=Je(a);e||(Dt(a,r)&&zt(l,"get",a),zt(l,"get",r));const{has:o}=Qi(l),c=t?to:e?La:Ds;if(o.call(l,a))return c(i.get(a));if(o.call(l,r))return c(i.get(r));i!==l&&i.get(a)},get size(){const a=this.__v_raw;return!e&&zt(Je(a),"iterate",Wn),a.size},has(a){const i=this.__v_raw,l=Je(i),r=Je(a);return e||(Dt(a,r)&&zt(l,"has",a),zt(l,"has",r)),a===r?i.has(a):i.has(a)||i.has(r)},forEach(a,i){const l=this,r=l.__v_raw,o=Je(r),c=t?to:e?La:Ds;return!e&&zt(o,"iterate",Wn),r.forEach((d,u)=>a.call(i,c(d),c(u),l))}};return ze(s,e?{add:Xi("add"),set:Xi("set"),delete:Xi("delete"),clear:Xi("clear")}:{add(a){const i=Je(this),l=Qi(i),r=Je(a),o=!t&&!ds(a)&&!Ks(a)?r:a;return l.has.call(i,o)||Dt(a,o)&&l.has.call(i,a)||Dt(r,o)&&l.has.call(i,r)||(i.add(o),rn(i,"add",o,o)),this},set(a,i){!t&&!ds(i)&&!Ks(i)&&(i=Je(i));const l=Je(this),{has:r,get:o}=Qi(l);let c=r.call(l,a);c||(a=Je(a),c=r.call(l,a));const d=o.call(l,a);return l.set(a,i),c?Dt(i,d)&&rn(l,"set",a,i):rn(l,"add",a,i),this},delete(a){const i=Je(this),{has:l,get:r}=Qi(i);let o=l.call(i,a);o||(a=Je(a),o=l.call(i,a)),r&&r.call(i,a);const c=i.delete(a);return o&&rn(i,"delete",a,void 0),c},clear(){const a=Je(this),i=a.size!==0,l=a.clear();return i&&rn(a,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(a=>{s[a]=Am(a,e,t)}),s}function ir(e,t){const s=Rm(e,t);return(n,a,i)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?n:Reflect.get(et(s,a)&&a in n?s:n,a,i)}const Im={get:ir(!1,!1)},Om={get:ir(!1,!0)},Lm={get:ir(!0,!1)},Nm={get:ir(!0,!0)},wf=new WeakMap,kf=new WeakMap,Sf=new WeakMap,Tf=new WeakMap;function Dm(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Fn(e){return Ks(e)?e:lr(e,!1,Sm,Im,wf)}function Ho(e){return lr(e,!1,Cm,Om,kf)}function wl(e){return lr(e,!0,Tm,Lm,Sf)}function Mm(e){return lr(e,!0,Em,Nm,Tf)}function lr(e,t,s,n,a){if(!Xe(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const i=a.get(e);if(i)return i;const l=Dm(zg(e));if(l===0)return e;const r=new Proxy(e,l===2?n:s);return a.set(e,r),r}function pn(e){return Ks(e)?pn(e.__v_raw):!!(e&&e.__v_isReactive)}function Ks(e){return!!(e&&e.__v_isReadonly)}function ds(e){return!!(e&&e.__v_isShallow)}function Bi(e){return e?!!e.__v_raw:!1}function Je(e){const t=e&&e.__v_raw;return t?Je(t):e}function Cf(e){return!et(e,"__v_skip")&&Object.isExtensible(e)&&nf(e,"__v_skip",!0),e}const Ds=e=>Xe(e)?Fn(e):e,La=e=>Xe(e)?wl(e):e;function Tt(e){return e?e.__v_isRef===!0:!1}function h(e){return Ef(e,!1)}function Vo(e){return Ef(e,!0)}function Ef(e,t){return Tt(e)?e:new Pm(e,t)}class Pm{constructor(t,s){this.dep=new nr,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:Je(t),this._value=s?t:Ds(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||ds(t)||Ks(t);t=n?t:Je(t),Dt(t,s)&&(this._rawValue=t,this._value=n?t:Ds(t),this.dep.trigger())}}function Fm(e){e.dep&&e.dep.trigger()}function Gs(e){return Tt(e)?e.value:e}function $m(e){return Ie(e)?e():Gs(e)}const Um={get:(e,t,s)=>t==="__v_raw"?e:Gs(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const a=e[t];return Tt(a)&&!Tt(s)?(a.value=s,!0):Reflect.set(e,t,s,n)}};function jo(e){return pn(e)?e:new Proxy(e,Um)}class Bm{constructor(t){this.__v_isRef=!0,this._value=void 0;const s=this.dep=new nr,{get:n,set:a}=t(s.track.bind(s),s.trigger.bind(s));this._get=n,this._set=a}get value(){return this._value=this._get()}set value(t){this._set(t)}}function Af(e){return new Bm(e)}function Hm(e){const t=ve(e)?new Array(e.length):{};for(const s in e)t[s]=Rf(e,s);return t}class Vm{constructor(t,s,n){this._object=t,this._defaultValue=n,this.__v_isRef=!0,this._value=void 0,this._key=Kt(s)?s:String(s),this._raw=Je(t);let a=!0,i=t;if(!ve(t)||Kt(this._key)||!Ql(this._key))do a=!Bi(i)||ds(i);while(a&&(i=i.__v_raw));this._shallow=a}get value(){let t=this._object[this._key];return this._shallow&&(t=Gs(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&Tt(this._raw[this._key])){const s=this._object[this._key];if(Tt(s)){s.value=t;return}}this._object[this._key]=t}get dep(){return ym(this._raw,this._key)}}class jm{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function zm(e,t,s){return Tt(e)?e:Ie(e)?new jm(e):Xe(e)&&arguments.length>1?Rf(e,t,s):h(e)}function Rf(e,t,s){return new Vm(e,t,s)}class qm{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new nr(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=_i-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&dt!==this)return ff(this,!0),!0}get value(){const t=this.dep.track();return gf(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Gm(e,t,s=!1){let n,a;return Ie(e)?n=e:(n=e.get,a=e.set),new qm(n,a,s)}const Km={GET:"get",HAS:"has",ITERATE:"iterate"},Wm={SET:"set",ADD:"add",DELETE:"delete",CLEAR:"clear"},el={},kl=new WeakMap;let In;function Zm(){return In}function If(e,t=!1,s=In){if(s){let n=kl.get(s);n||kl.set(s,n=[]),n.push(e)}}function Jm(e,t,s=Ge){const{immediate:n,deep:a,once:i,scheduler:l,augmentJob:r,call:o}=s,c=x=>a?x:ds(x)||a===!1||a===0?on(x,1):on(x);let d,u,f,p,g=!1,y=!1;if(Tt(e)?(u=()=>e.value,g=ds(e)):pn(e)?(u=()=>c(e),g=!0):ve(e)?(y=!0,g=e.some(x=>pn(x)||ds(x)),u=()=>e.map(x=>{if(Tt(x))return x.value;if(pn(x))return c(x);if(Ie(x))return o?o(x,2):x()})):Ie(e)?t?u=o?()=>o(e,2):e:u=()=>{if(f){vn();try{f()}finally{bn()}}const x=In;In=d;try{return o?o(e,3,[p]):e(p)}finally{In=x}}:u=Bt,t&&a){const x=u,w=a===!0?1/0:a;u=()=>on(x(),w)}const S=df(),R=()=>{d.stop(),S&&S.active&&Mo(S.effects,d)};if(i&&t){const x=t;t=(...w)=>{const _=x(...w);return R(),_}}let v=y?new Array(e.length).fill(el):el;const m=x=>{if(!(!(d.flags&1)||!d.dirty&&!x))if(t){const w=d.run();if(x||a||g||(y?w.some((_,A)=>Dt(_,v[A])):Dt(w,v))){f&&f();const _=In;In=d;try{const A=[w,v===el?void 0:y&&v[0]===el?[]:v,p];v=w,o?o(t,3,A):t(...A)}finally{In=_}}}else d.run()};return r&&r(m),d=new xi(u),d.scheduler=l?()=>l(m,!1):m,p=x=>If(x,!1,d),f=d.onStop=()=>{const x=kl.get(d);if(x){if(o)o(x,4);else for(const w of x)w();kl.delete(d)}},t?n?m(!0):v=d.run():l?l(m.bind(null,!0),!0):d.run(),R.pause=d.pause.bind(d),R.resume=d.resume.bind(d),R.stop=R,R}function on(e,t=1/0,s){if(t<=0||!Xe(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,Tt(e))on(e.value,t,s);else if(ve(e))for(let n=0;n<e.length;n++)on(e[n],t,s);else if(aa(e)||ka(e))e.forEach(n=>{on(n,t,s)});else if(Yl(e)){for(const n in e)on(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&on(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Of=[];function Ym(e){Of.push(e)}function Qm(){Of.pop()}function Xm(e,t){}const ev={SETUP_FUNCTION:0,0:"SETUP_FUNCTION",RENDER_FUNCTION:1,1:"RENDER_FUNCTION",NATIVE_EVENT_HANDLER:5,5:"NATIVE_EVENT_HANDLER",COMPONENT_EVENT_HANDLER:6,6:"COMPONENT_EVENT_HANDLER",VNODE_HOOK:7,7:"VNODE_HOOK",DIRECTIVE_HOOK:8,8:"DIRECTIVE_HOOK",TRANSITION_HOOK:9,9:"TRANSITION_HOOK",APP_ERROR_HANDLER:10,10:"APP_ERROR_HANDLER",APP_WARN_HANDLER:11,11:"APP_WARN_HANDLER",FUNCTION_REF:12,12:"FUNCTION_REF",ASYNC_COMPONENT_LOADER:13,13:"ASYNC_COMPONENT_LOADER",SCHEDULER:14,14:"SCHEDULER",COMPONENT_UPDATE:15,15:"COMPONENT_UPDATE",APP_UNMOUNT_CLEANUP:16,16:"APP_UNMOUNT_CLEANUP"},tv={sp:"serverPrefetch hook",bc:"beforeCreate hook",c:"created hook",bm:"beforeMount hook",m:"mounted hook",bu:"beforeUpdate hook",u:"updated",bum:"beforeUnmount hook",um:"unmounted hook",a:"activated hook",da:"deactivated hook",ec:"errorCaptured hook",rtc:"renderTracked hook",rtg:"renderTriggered hook",0:"setup function",1:"render function",2:"watcher getter",3:"watcher callback",4:"watcher cleanup function",5:"native event handler",6:"component event handler",7:"vnode hook",8:"directive hook",9:"transition hook",10:"app errorHandler",11:"app warnHandler",12:"ref function",13:"async component loader",14:"scheduler flush",15:"component update",16:"app unmount cleanup function"};function qa(e,t,s,n){try{return n?e(...n):e()}catch(a){la(a,t,s)}}function vs(e,t,s,n){if(Ie(e)){const a=qa(e,t,s,n);return a&&Po(a)&&a.catch(i=>{la(i,t,s)}),a}if(ve(e)){const a=[];for(let i=0;i<e.length;i++)a.push(vs(e[i],t,s,n));return a}}function la(e,t,s,n=!0){const a=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=t&&t.appContext.config||Ge;if(t){let r=t.parent;const o=t.proxy,c=`https://vuejs.org/error-reference/#runtime-${s}`;for(;r;){const d=r.ec;if(d){for(let u=0;u<d.length;u++)if(d[u](e,o,c)===!1)return}r=r.parent}if(i){vn(),qa(i,null,10,[e,o,c]),bn();return}}sv(e,s,a,n,l)}function sv(e,t,s,n=!0,a=!1){if(a)throw e;console.error(e)}const Yt=[];let js=-1;const Ca=[];let On=null,ma=0;const Lf=Promise.resolve();let Sl=null;function Ot(e){const t=Sl||Lf;return e?t.then(this?e.bind(this):e):t}function nv(e){let t=js+1,s=Yt.length;for(;t<s;){const n=t+s>>>1,a=Yt[n],i=Si(a);i<e||i===e&&a.flags&2?t=n+1:s=n}return t}function zo(e){if(!(e.flags&1)){const t=Si(e),s=Yt[Yt.length-1];!s||!(e.flags&2)&&t>=Si(s)?Yt.push(e):Yt.splice(nv(t),0,e),e.flags|=1,Nf()}}function Nf(){Sl||(Sl=Lf.then(Df))}function ki(e){ve(e)?Ca.push(...e):On&&e.id===-1?On.splice(ma+1,0,e):e.flags&1||(Ca.push(e),e.flags|=1),Nf()}function id(e,t,s=js+1){for(;s<Yt.length;s++){const n=Yt[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;Yt.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Tl(e){if(Ca.length){const t=[...new Set(Ca)].sort((s,n)=>Si(s)-Si(n));if(Ca.length=0,On){On.push(...t);return}for(On=t,ma=0;ma<On.length;ma++){const s=On[ma];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}On=null,ma=0}}const Si=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Df(e){try{for(js=0;js<Yt.length;js++){const t=Yt[js];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),qa(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;js<Yt.length;js++){const t=Yt[js];t&&(t.flags&=-2)}js=-1,Yt.length=0,Tl(),Sl=null,(Yt.length||Ca.length)&&Df()}}let va,tl=[];function Mf(e,t){var s,n;va=e,va?(va.enabled=!0,tl.forEach(({event:a,args:i})=>va.emit(a,...i)),tl=[]):typeof window<"u"&&window.HTMLElement&&!((n=(s=window.navigator)==null?void 0:s.userAgent)!=null&&n.includes("jsdom"))?((t.__VUE_DEVTOOLS_HOOK_REPLAY__=t.__VUE_DEVTOOLS_HOOK_REPLAY__||[]).push(i=>{Mf(i,t)}),setTimeout(()=>{va||(t.__VUE_DEVTOOLS_HOOK_REPLAY__=null,tl=[])},3e3)):tl=[]}let Ut=null,rr=null;function Ti(e){const t=Ut;return Ut=e,rr=e&&e.type.__scopeId||null,t}function av(e){rr=e}function iv(){rr=null}const lv=e=>qo;function qo(e,t=Ut,s){if(!t||e._n)return e;const n=(...a)=>{n._d&&Ri(-1);const i=Ti(t);let l;try{l=e(...a)}finally{Ti(i),n._d&&Ri(1)}return l};return n._n=!0,n._c=!0,n._d=!0,n}function rv(e,t){if(Ut===null)return e;const s=zi(Ut),n=e.dirs||(e.dirs=[]);for(let a=0;a<t.length;a++){let[i,l,r,o=Ge]=t[a];i&&(Ie(i)&&(i={mounted:i,updated:i}),i.deep&&on(l),n.push({dir:i,instance:s,value:l,oldValue:void 0,arg:r,modifiers:o}))}return e}function zs(e,t,s,n){const a=e.dirs,i=t&&t.dirs;for(let l=0;l<a.length;l++){const r=a[l];i&&(r.oldValue=i[l].value);let o=r.dir[n];o&&(vn(),vs(o,s,8,[e.el,r,e,t]),bn())}}function ui(e,t){if($t){let s=$t.provides;const n=$t.parent&&$t.parent.provides;n===s&&(s=$t.provides=Object.create(n)),s[e]=t}}function Ts(e,t,s=!1){const n=es();if(n||Zn){let a=Zn?Zn._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(a&&e in a)return a[e];if(arguments.length>1)return s&&Ie(t)?t.call(n&&n.proxy):t}}function ov(){return!!(es()||Zn)}const Pf=Symbol.for("v-scx"),Ff=()=>Ts(Pf);function cv(e,t){return Hi(e,null,t)}function dv(e,t){return Hi(e,null,{flush:"post"})}function $f(e,t){return Hi(e,null,{flush:"sync"})}function Xt(e,t,s){return Hi(e,t,s)}function Hi(e,t,s=Ge){const{immediate:n,deep:a,flush:i,once:l}=s,r=ze({},s),o=t&&n||!t&&i!=="post";let c;if(ea){if(i==="sync"){const p=Ff();c=p.__watcherHandles||(p.__watcherHandles=[])}else if(!o){const p=()=>{};return p.stop=Bt,p.resume=Bt,p.pause=Bt,p}}const d=$t;r.call=(p,g,y)=>vs(p,d,g,y);let u=!1;i==="post"?r.scheduler=p=>{kt(p,d&&d.suspense)}:i!=="sync"&&(u=!0,r.scheduler=(p,g)=>{g?p():zo(p)}),r.augmentJob=p=>{t&&(p.flags|=4),u&&(p.flags|=2,d&&(p.id=d.uid,p.i=d))};const f=Jm(e,t,r);return ea&&(c?c.push(f):o&&f()),f}function uv(e,t,s){const n=this.proxy,a=Pe(e)?e.includes(".")?Uf(n,e):()=>n[e]:e.bind(n,n);let i;Ie(t)?i=t:(i=t.handler,s=t);const l=Ga(this),r=Hi(a,i.bind(n),s);return l(),r}function Uf(e,t){const s=t.split(".");return()=>{let n=e;for(let a=0;a<s.length&&n;a++)n=n[s[a]];return n}}const En=new WeakMap,Bf=Symbol("_vte"),Hf=e=>e.__isTeleport,zn=e=>e&&(e.disabled||e.disabled===""),fv=e=>e&&(e.defer||e.defer===""),ld=e=>typeof SVGElement<"u"&&e instanceof SVGElement,rd=e=>typeof MathMLElement=="function"&&e instanceof MathMLElement,so=(e,t)=>{const s=e&&e.to;return Pe(s)?t?t(s):null:s},pv={name:"Teleport",__isTeleport:!0,process(e,t,s,n,a,i,l,r,o,c){const{mc:d,pc:u,pbc:f,o:{insert:p,querySelector:g,createText:y,createComment:S,parentNode:R}}=c,v=zn(t.props);let{dynamicChildren:m}=t;const x=(A,T,C)=>{A.shapeFlag&16&&d(A.children,T,C,a,i,l,r,o)},w=(A=t)=>{const T=zn(A.props),C=A.target=so(A.props,g),L=no(C,A,y,p);C&&(l!=="svg"&&ld(C)?l="svg":l!=="mathml"&&rd(C)&&(l="mathml"),a&&a.isCE&&(a.ce._teleportTargets||(a.ce._teleportTargets=new Set)).add(C),T||(x(A,C,L),ai(A,!1)))},_=A=>{const T=()=>{if(En.get(A)===T){if(En.delete(A),zn(A.props)){const C=R(A.el)||s;x(A,C,A.anchor),ai(A,!0)}w(A)}};En.set(A,T),kt(T,i)};if(e==null){const A=t.el=y(""),T=t.anchor=y("");if(p(A,s,n),p(T,s,n),fv(t.props)||i&&i.pendingBranch){_(t);return}v&&(x(t,s,T),ai(t,!0)),w()}else{t.el=e.el;const A=t.anchor=e.anchor,T=En.get(e);if(T){T.flags|=8,En.delete(e),_(t);return}t.targetStart=e.targetStart;const C=t.target=e.target,L=t.targetAnchor=e.targetAnchor,H=zn(e.props),M=H?s:C,N=H?A:L;if(l==="svg"||ld(C)?l="svg":(l==="mathml"||rd(C))&&(l="mathml"),m?(f(e.dynamicChildren,m,M,a,i,l,r),sc(e,t,!0)):o||u(e,t,M,N,a,i,l,r,!1),v)H?t.props&&e.props&&t.props.to!==e.props.to&&(t.props.to=e.props.to):sl(t,s,A,c,1);else if((t.props&&t.props.to)!==(e.props&&e.props.to)){const Z=t.target=so(t.props,g);Z&&sl(t,Z,null,c,0)}else H&&sl(t,C,L,c,1);ai(t,v)}},remove(e,t,s,{um:n,o:{remove:a}},i){const{shapeFlag:l,children:r,anchor:o,targetStart:c,targetAnchor:d,target:u,props:f}=e,p=i||!zn(f),g=En.get(e);if(g&&(g.flags|=8,En.delete(e)),u&&(a(c),a(d)),i&&a(o),!g&&l&16)for(let y=0;y<r.length;y++){const S=r[y];n(S,t,s,p,!!S.dynamicChildren)}},move:sl,hydrate:hv};function sl(e,t,s,{o:{insert:n},m:a},i=2){i===0&&n(e.targetAnchor,t,s);const{el:l,anchor:r,shapeFlag:o,children:c,props:d}=e,u=i===2;if(u&&n(l,t,s),!En.has(e)&&(!u||zn(d))&&o&16)for(let f=0;f<c.length;f++)a(c[f],t,s,2);u&&n(r,t,s)}function hv(e,t,s,n,a,i,{o:{nextSibling:l,parentNode:r,querySelector:o,insert:c,createText:d}},u){function f(S,R){let v=R;for(;v;){if(v&&v.nodeType===8){if(v.data==="teleport start anchor")t.targetStart=v;else if(v.data==="teleport anchor"){t.targetAnchor=v,S._lpa=t.targetAnchor&&l(t.targetAnchor);break}}v=l(v)}}function p(S,R){R.anchor=u(l(S),R,r(S),s,n,a,i)}const g=t.target=so(t.props,o),y=zn(t.props);if(g){const S=g._lpa||g.firstChild;t.shapeFlag&16&&(y?(p(e,t),f(g,S),t.targetAnchor||no(g,t,d,c,r(e)===g?e:null)):(t.anchor=l(e),f(g,S),t.targetAnchor||no(g,t,d,c),u(S&&l(S),t,g,s,n,a,i))),ai(t,y)}else y&&t.shapeFlag&16&&(p(e,t),t.targetStart=e,t.targetAnchor=l(e));return t.anchor&&l(t.anchor)}const gv=pv;function ai(e,t){const s=e.ctx;if(s&&s.ut){let n,a;for(t?(n=e.el,a=e.anchor):(n=e.targetStart,a=e.targetAnchor);n&&n!==a;)n.nodeType===1&&n.setAttribute("data-v-owner",s.uid),n=n.nextSibling;s.ut()}}function no(e,t,s,n,a=null){const i=t.targetStart=s(""),l=t.targetAnchor=s("");return i[Bf]=l,e&&(n(i,e,a),n(l,e,a)),l}const ws=Symbol("_leaveCb"),Za=Symbol("_enterCb");function Go(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ye(()=>{e.isMounted=!0}),ur(()=>{e.isUnmounting=!0}),e}const _s=[Function,Array],Ko={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:_s,onEnter:_s,onAfterEnter:_s,onEnterCancelled:_s,onBeforeLeave:_s,onLeave:_s,onAfterLeave:_s,onLeaveCancelled:_s,onBeforeAppear:_s,onAppear:_s,onAfterAppear:_s,onAppearCancelled:_s},Vf=e=>{const t=e.subTree;return t.component?Vf(t.component):t},mv={name:"BaseTransition",props:Ko,setup(e,{slots:t}){const s=es(),n=Go();return()=>{const a=t.default&&or(t.default(),!0),i=a&&a.length?jf(a):s.subTree?Tp():void 0;if(!i)return;const l=Je(e),{mode:r}=l;if(n.isLeaving)return Or(i);const o=od(i);if(!o)return Or(i);let c=Na(o,l,n,s,u=>c=u);o.type!==xt&&yn(o,c);let d=s.subTree&&od(s.subTree);if(d&&d.type!==xt&&!Os(d,o)&&Vf(s).type!==xt){let u=Na(d,l,n,s);if(yn(d,u),r==="out-in"&&o.type!==xt)return n.isLeaving=!0,u.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete u.afterLeave,d=void 0},Or(i);r==="in-out"&&o.type!==xt?u.delayLeave=(f,p,g)=>{const y=qf(n,d);y[String(d.key)]=d,f[ws]=()=>{p(),f[ws]=void 0,delete c.delayedLeave,d=void 0},c.delayedLeave=()=>{g(),delete c.delayedLeave,d=void 0}}:d=void 0}else d&&(d=void 0);return i}}};function jf(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==xt){t=s;break}}return t}const zf=mv;function qf(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function Na(e,t,s,n,a){const{appear:i,mode:l,persisted:r=!1,onBeforeEnter:o,onEnter:c,onAfterEnter:d,onEnterCancelled:u,onBeforeLeave:f,onLeave:p,onAfterLeave:g,onLeaveCancelled:y,onBeforeAppear:S,onAppear:R,onAfterAppear:v,onAppearCancelled:m}=t,x=String(e.key),w=qf(s,e),_=(C,L)=>{C&&vs(C,n,9,L)},A=(C,L)=>{const H=L[1];_(C,L),ve(C)?C.every(M=>M.length<=1)&&H():C.length<=1&&H()},T={mode:l,persisted:r,beforeEnter(C){let L=o;if(!s.isMounted)if(i)L=S||o;else return;C[ws]&&C[ws](!0);const H=w[x];H&&Os(e,H)&&H.el[ws]&&H.el[ws](),_(L,[C])},enter(C){if(w[x]===e)return;let L=c,H=d,M=u;if(!s.isMounted)if(i)L=R||c,H=v||d,M=m||u;else return;let N=!1;C[Za]=ne=>{N||(N=!0,ne?_(M,[C]):_(H,[C]),T.delayedLeave&&T.delayedLeave(),C[Za]=void 0)};const Z=C[Za].bind(null,!1);L?A(L,[C,Z]):Z()},leave(C,L){const H=String(e.key);if(C[Za]&&C[Za](!0),s.isUnmounting)return L();_(f,[C]);let M=!1;C[ws]=Z=>{M||(M=!0,L(),Z?_(y,[C]):_(g,[C]),C[ws]=void 0,w[H]===e&&delete w[H])};const N=C[ws].bind(null,!1);w[H]=e,p?A(p,[C,N]):N()},clone(C){const L=Na(C,t,s,n,a);return a&&a(L),L}};return T}function Or(e){if(ji(e))return e=Ws(e),e.children=null,e}function od(e){if(!ji(e))return Hf(e.type)&&e.children?jf(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&Ie(s.default))return s.default()}}function yn(e,t){e.shapeFlag&6&&e.component?(e.transition=t,yn(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function or(e,t=!1,s){let n=[],a=0;for(let i=0;i<e.length;i++){let l=e[i];const r=s==null?l.key:String(s)+String(l.key!=null?l.key:i);l.type===Mt?(l.patchFlag&128&&a++,n=n.concat(or(l.children,t,r))):(t||l.type!==xt)&&n.push(r!=null?Ws(l,{key:r}):l)}if(a>1)for(let i=0;i<n.length;i++)n[i].patchFlag=-2;return n}function Vi(e,t){return Ie(e)?ze({name:e.name},t,{setup:e}):e}function vv(){const e=es();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function Wo(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function bv(e){const t=es(),s=Vo(null);if(t){const a=t.refs===Ge?t.refs={}:t.refs;Object.defineProperty(a,e,{enumerable:!0,get:()=>s.value,set:i=>s.value=i})}return s}function cd(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const Cl=new WeakMap;function Ea(e,t,s,n,a=!1){if(ve(e)){e.forEach((y,S)=>Ea(y,t&&(ve(t)?t[S]:t),s,n,a));return}if(hn(n)&&!a){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&Ea(e,t,s,n.component.subTree);return}const i=n.shapeFlag&4?zi(n.component):n.el,l=a?null:i,{i:r,r:o}=e,c=t&&t.r,d=r.refs===Ge?r.refs={}:r.refs,u=r.setupState,f=Je(u),p=u===Ge?xa:y=>cd(d,y)?!1:et(f,y),g=(y,S)=>!(S&&cd(d,S));if(c!=null&&c!==o){if(dd(t),Pe(c))d[c]=null,p(c)&&(u[c]=null);else if(Tt(c)){const y=t;g(c,y.k)&&(c.value=null),y.k&&(d[y.k]=null)}}if(Ie(o))qa(o,r,12,[l,d]);else{const y=Pe(o),S=Tt(o);if(y||S){const R=()=>{if(e.f){const v=y?p(o)?u[o]:d[o]:g()||!e.k?o.value:d[e.k];if(a)ve(v)&&Mo(v,i);else if(ve(v))v.includes(i)||v.push(i);else if(y)d[o]=[i],p(o)&&(u[o]=d[o]);else{const m=[i];g(o,e.k)&&(o.value=m),e.k&&(d[e.k]=m)}}else y?(d[o]=l,p(o)&&(u[o]=l)):S&&(g(o,e.k)&&(o.value=l),e.k&&(d[e.k]=l))};if(l){const v=()=>{R(),Cl.delete(e)};v.id=-1,Cl.set(e,v),kt(v,s)}else dd(e),R()}}}function dd(e){const t=Cl.get(e);t&&(t.flags|=8,Cl.delete(e))}let ud=!1;const fa=()=>{ud||(console.error("Hydration completed but contains mismatches."),ud=!0)},yv=e=>e.namespaceURI.includes("svg")&&e.tagName!=="foreignObject",xv=e=>e.namespaceURI.includes("MathML"),nl=e=>{if(e.nodeType===1){if(yv(e))return"svg";if(xv(e))return"mathml"}},_a=e=>e.nodeType===8;function _v(e){const{mt:t,p:s,o:{patchProp:n,createText:a,nextSibling:i,parentNode:l,remove:r,insert:o,createComment:c}}=e,d=(m,x)=>{if(!x.hasChildNodes()){s(null,m,x),Tl(),x._vnode=m;return}u(x.firstChild,m,null,null,null),Tl(),x._vnode=m},u=(m,x,w,_,A,T=!1)=>{T=T||!!x.dynamicChildren;const C=_a(m)&&m.data==="[",L=()=>y(m,x,w,_,A,C),{type:H,ref:M,shapeFlag:N,patchFlag:Z}=x;let ne=m.nodeType;x.el=m,Z===-2&&(T=!1,x.dynamicChildren=null);let F=null;switch(H){case Dn:ne!==3?x.children===""?(o(x.el=a(""),l(m),m),F=m):F=L():(m.data!==x.children&&(fa(),m.data=x.children),F=i(m));break;case xt:v(m)?(F=i(m),R(x.el=m.content.firstChild,m,w)):ne!==8||C?F=L():F=i(m);break;case Jn:if(C&&(m=i(m),ne=m.nodeType),ne===1||ne===3){F=m;const O=!x.children.length;for(let E=0;E<x.staticCount;E++)O&&(x.children+=F.nodeType===1?F.outerHTML:F.data),E===x.staticCount-1&&(x.anchor=F),F=i(F);return C?i(F):F}else L();break;case Mt:C?F=g(m,x,w,_,A,T):F=L();break;default:if(N&1)(ne!==1||x.type.toLowerCase()!==m.tagName.toLowerCase())&&!v(m)?F=L():F=f(m,x,w,_,A,T);else if(N&6){x.slotScopeIds=A;const O=l(m);if(C?F=S(m):_a(m)&&m.data==="teleport start"?F=S(m,m.data,"teleport end"):F=i(m),t(x,O,null,w,_,nl(O),T),hn(x)&&!x.type.__asyncResolved){let E;C?(E=pt(Mt),E.anchor=F?F.previousSibling:O.lastChild):E=m.nodeType===3?ac(""):pt("div"),E.el=m,x.component.subTree=E}}else N&64?ne!==8?F=L():F=x.type.hydrate(m,x,w,_,A,T,e,p):N&128&&(F=x.type.hydrate(m,x,w,_,nl(l(m)),A,T,e,u))}return M!=null&&Ea(M,null,_,x),F},f=(m,x,w,_,A,T)=>{T=T||!!x.dynamicChildren;const{type:C,props:L,patchFlag:H,shapeFlag:M,dirs:N,transition:Z}=x,ne=C==="input"||C==="option";if(ne||H!==-1){N&&zs(x,null,w,"created");let F=!1;if(v(m)){F=mp(null,Z)&&w&&w.vnode.props&&w.vnode.props.appear;const E=m.content.firstChild;if(F){const q=E.getAttribute("class");q&&(E.$cls=q),Z.beforeEnter(E)}R(E,m,w),x.el=m=E}if(M&16&&!(L&&(L.innerHTML||L.textContent))){let E=p(m.firstChild,x,m,w,_,A,T);for(E&&!al(m,1)&&fa();E;){const q=E;E=E.nextSibling,r(q)}}else if(M&8){let E=x.children;E[0]===`
`&&(m.tagName==="PRE"||m.tagName==="TEXTAREA")&&(E=E.slice(1));const{textContent:q}=m;q!==E&&q!==E.replace(/\r\n|\r/g,`
`)&&(al(m,0)||fa(),m.textContent=x.children)}if(L){if(ne||!T||H&48){const E=m.tagName.includes("-");for(const q in L)(ne&&(q.endsWith("value")||q==="indeterminate")||na(q)&&!fn(q)||q[0]==="."||E&&!fn(q))&&n(m,q,null,L[q],void 0,w)}else if(L.onClick)n(m,"onClick",null,L.onClick,void 0,w);else if(H&4&&pn(L.style))for(const E in L.style)L.style[E]}let O;(O=L&&L.onVnodeBeforeMount)&&is(O,w,x),N&&zs(x,null,w,"beforeMount"),((O=L&&L.onVnodeMounted)||N||F)&&xp(()=>{O&&is(O,w,x),F&&Z.enter(m),N&&zs(x,null,w,"mounted")},_)}return m.nextSibling},p=(m,x,w,_,A,T,C)=>{C=C||!!x.dynamicChildren;const L=x.children,H=L.length;let M=!1;for(let N=0;N<H;N++){const Z=C?L[N]:L[N]=rs(L[N]),ne=Z.type===Dn;m?(ne&&!C&&N+1<H&&rs(L[N+1]).type===Dn&&(o(a(m.data.slice(Z.children.length)),w,i(m)),m.data=Z.children),m=u(m,Z,_,A,T,C)):ne&&!Z.children?o(Z.el=a(""),w):(M||(M=!0,al(w,1)||fa()),s(null,Z,w,null,_,A,nl(w),T))}return m},g=(m,x,w,_,A,T)=>{const{slotScopeIds:C}=x;C&&(A=A?A.concat(C):C);const L=l(m),H=p(i(m),x,L,w,_,A,T);return H&&_a(H)&&H.data==="]"?i(x.anchor=H):(fa(),o(x.anchor=c("]"),L,H),H)},y=(m,x,w,_,A,T)=>{if(al(m.parentElement,1)||fa(),x.el=null,T){const H=S(m);for(;;){const M=i(m);if(M&&M!==H)r(M);else break}}const C=i(m),L=l(m);return r(m),s(null,x,L,C,w,_,nl(L),A),w&&(w.vnode.el=x.el,pr(w,x.el)),C},S=(m,x="[",w="]")=>{let _=0;for(;m;)if(m=i(m),m&&_a(m)&&(m.data===x&&_++,m.data===w)){if(_===0)return i(m);_--}return m},R=(m,x,w)=>{const _=x.parentNode;_&&_.replaceChild(m,x);let A=w;for(;A;)A.vnode.el===x&&(A.vnode.el=A.subTree.el=m),A=A.parent},v=m=>m.nodeType===1&&m.tagName==="TEMPLATE";return[d,u]}const fd="data-allow-mismatch",wv={0:"text",1:"children",2:"class",3:"style",4:"attribute"};function al(e,t){if(t===0||t===1)for(;e&&!e.hasAttribute(fd);)e=e.parentElement;const s=e&&e.getAttribute(fd);if(s==null)return!1;if(s==="")return!0;{const n=s.split(",");return t===0&&n.includes("children")?!0:n.includes(wv[t])}}const kv=tr().requestIdleCallback||(e=>setTimeout(e,1)),Sv=tr().cancelIdleCallback||(e=>clearTimeout(e)),Tv=(e=1e4)=>t=>{const s=kv(t,{timeout:e});return()=>Sv(s)};function Cv(e){const{top:t,left:s,bottom:n,right:a}=e.getBoundingClientRect(),{innerHeight:i,innerWidth:l}=window;return(t>0&&t<i||n>0&&n<i)&&(s>0&&s<l||a>0&&a<l)}const Ev=e=>(t,s)=>{const n=new IntersectionObserver(a=>{for(const i of a)if(i.isIntersecting){n.disconnect(),t();break}},e);return s(a=>{if(a instanceof Element){if(Cv(a))return t(),n.disconnect(),!1;n.observe(a)}}),()=>n.disconnect()},Av=e=>t=>{if(e){const s=matchMedia(e);if(s.matches)t();else return s.addEventListener("change",t,{once:!0}),()=>s.removeEventListener("change",t)}},Rv=(e=[])=>(t,s)=>{Pe(e)&&(e=[e]);let n=!1;const a=l=>{n||(n=!0,i(),t(),l.target.dispatchEvent(new l.constructor(l.type,l)))},i=()=>{s(l=>{for(const r of e)l.removeEventListener(r,a)})};return s(l=>{for(const r of e)l.addEventListener(r,a,{once:!0})}),i};function Iv(e,t){if(_a(e)&&e.data==="["){let s=1,n=e.nextSibling;for(;n;){if(n.nodeType===1){if(t(n)===!1)break}else if(_a(n))if(n.data==="]"){if(--s===0)break}else n.data==="["&&s++;n=n.nextSibling}}else t(e)}const hn=e=>!!e.type.__asyncLoader;function Ov(e){Ie(e)&&(e={loader:e});const{loader:t,loadingComponent:s,errorComponent:n,delay:a=200,hydrate:i,timeout:l,suspensible:r=!0,onError:o}=e;let c=null,d,u=0;const f=()=>(u++,c=null,p()),p=()=>{let g;return c||(g=c=t().catch(y=>{if(y=y instanceof Error?y:new Error(String(y)),o)return new Promise((S,R)=>{o(y,()=>S(f()),()=>R(y),u+1)});throw y}).then(y=>g!==c&&c?c:(y&&(y.__esModule||y[Symbol.toStringTag]==="Module")&&(y=y.default),d=y,y)))};return Vi({name:"AsyncComponentWrapper",__asyncLoader:p,__asyncHydrate(g,y,S){let R=!1;(y.bu||(y.bu=[])).push(()=>R=!0);const v=()=>{R||S()},m=i?()=>{const x=i(v,w=>Iv(g,w));x&&(y.bum||(y.bum=[])).push(x)}:v;d?m():p().then(()=>!y.isUnmounted&&m())},get __asyncResolved(){return d},setup(){const g=$t;if(Wo(g),d)return()=>il(d,g);const y=w=>{c=null,la(w,g,13,!n)};if(r&&g.suspense||ea)return p().then(w=>()=>il(w,g)).catch(w=>(y(w),()=>n?pt(n,{error:w}):null));const S=h(!1),R=h(),v=h(!!a);let m,x;return _t(()=>{m!=null&&clearTimeout(m),x!=null&&clearTimeout(x)}),a&&(x=setTimeout(()=>{g.isUnmounted||(v.value=!1)},a)),l!=null&&(m=setTimeout(()=>{if(!g.isUnmounted&&!S.value&&!R.value){const w=new Error(`Async component timed out after ${l}ms.`);y(w),R.value=w}},l)),p().then(()=>{g.isUnmounted||(S.value=!0,g.parent&&ji(g.parent.vnode)&&g.parent.update())}).catch(w=>{if(g.isUnmounted){c=null;return}y(w),R.value=w}),()=>{if(S.value&&d)return il(d,g);if(R.value&&n)return pt(n,{error:R.value});if(s&&!v.value)return il(s,g)}}})}function il(e,t){const{ref:s,props:n,children:a,ce:i}=t.vnode,l=pt(e,n,a);return l.ref=s,l.ce=i,delete t.vnode.ce,l}const ji=e=>e.type.__isKeepAlive,Lv={name:"KeepAlive",__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){const s=es(),n=s.ctx;if(!n.renderer)return()=>{const v=t.default&&t.default();return v&&v.length===1?v[0]:v};const a=new Map,i=new Set;let l=null;const r=s.suspense,{renderer:{p:o,m:c,um:d,o:{createElement:u}}}=n,f=u("div");n.activate=(v,m,x,w,_)=>{const A=v.component;c(v,m,x,0,r),o(A.vnode,v,m,x,A,r,w,v.slotScopeIds,_),kt(()=>{A.isDeactivated=!1,A.a&&Ta(A.a);const T=v.props&&v.props.onVnodeMounted;T&&is(T,A.parent,v)},r)},n.deactivate=v=>{const m=v.component;Al(m.m),Al(m.a),c(v,f,null,1,r),kt(()=>{m.da&&Ta(m.da);const x=v.props&&v.props.onVnodeUnmounted;x&&is(x,m.parent,v),m.isDeactivated=!0},r)};function p(v){Lr(v),d(v,s,r,!0)}function g(v){a.forEach((m,x)=>{const w=po(hn(m)?m.type.__asyncResolved||{}:m.type);w&&!v(w)&&y(x)})}function y(v){const m=a.get(v);m&&(!l||!Os(m,l))?p(m):l&&Lr(l),a.delete(v),i.delete(v)}Xt(()=>[e.include,e.exclude],([v,m])=>{v&&g(x=>ii(v,x)),m&&g(x=>!ii(m,x))},{flush:"post",deep:!0});let S=null;const R=()=>{S!=null&&(Rl(s.subTree.type)?kt(()=>{a.set(S,ll(s.subTree))},s.subTree.suspense):a.set(S,ll(s.subTree)))};return Ye(R),dr(R),ur(()=>{a.forEach(v=>{const{subTree:m,suspense:x}=s,w=ll(m);if(v.type===w.type&&v.key===w.key){Lr(w);const _=w.component.da;_&&kt(_,x);return}p(v)})}),()=>{if(S=null,!t.default)return l=null;const v=t.default(),m=v[0];if(v.length>1)return l=null,v;if(!xn(m)||!(m.shapeFlag&4)&&!(m.shapeFlag&128))return l=null,m;let x=ll(m);if(x.type===xt)return l=null,x;const w=x.type,_=po(hn(x)?x.type.__asyncResolved||{}:w),{include:A,exclude:T,max:C}=e;if(A&&(!_||!ii(A,_))||T&&_&&ii(T,_))return x.shapeFlag&=-257,l=x,m;const L=x.key==null?w:x.key,H=a.get(L);return x.el&&(x=Ws(x),m.shapeFlag&128&&(m.ssContent=x)),S=L,H?(x.el=H.el,x.component=H.component,x.transition&&yn(x,x.transition),x.shapeFlag|=512,i.delete(L),i.add(L)):(i.add(L),C&&i.size>parseInt(C,10)&&y(i.values().next().value)),x.shapeFlag|=256,l=x,Rl(m.type)?m:x}}},Nv=Lv;function ii(e,t){return ve(e)?e.some(s=>ii(s,t)):Pe(e)?e.split(",").includes(t):jg(e)?(e.lastIndex=0,e.test(t)):!1}function As(e,t){Gf(e,"a",t)}function Rs(e,t){Gf(e,"da",t)}function Gf(e,t,s=$t){const n=e.__wdc||(e.__wdc=()=>{let a=s;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if(cr(t,n,s),s){let a=s.parent;for(;a&&a.parent;)ji(a.parent.vnode)&&Dv(n,t,s,a),a=a.parent}}function Dv(e,t,s,n){const a=cr(t,e,n,!0);_t(()=>{Mo(n[t],a)},s)}function Lr(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function ll(e){return e.shapeFlag&128?e.ssContent:e}function cr(e,t,s=$t,n=!1){if(s){const a=s[e]||(s[e]=[]),i=t.__weh||(t.__weh=(...l)=>{vn();const r=Ga(s),o=vs(t,s,e,l);return r(),bn(),o});return n?a.unshift(i):a.push(i),i}}const _n=e=>(t,s=$t)=>{(!ea||e==="sp")&&cr(e,(...n)=>t(...n),s)},Kf=_n("bm"),Ye=_n("m"),Zo=_n("bu"),dr=_n("u"),ur=_n("bum"),_t=_n("um"),Wf=_n("sp"),Zf=_n("rtg"),Jf=_n("rtc");function Yf(e,t=$t){cr("ec",e,t)}const Jo="components",Mv="directives";function Pv(e,t){return Yo(Jo,e,!0,t)||e}const Qf=Symbol.for("v-ndc");function Fv(e){return Pe(e)?Yo(Jo,e,!1)||e:e||Qf}function $v(e){return Yo(Mv,e)}function Yo(e,t,s=!0,n=!1){const a=Ut||$t;if(a){const i=a.type;if(e===Jo){const r=po(i,!1);if(r&&(r===t||r===lt(t)||r===ia(lt(t))))return i}const l=pd(a[e]||i[e],t)||pd(a.appContext[e],t);return!l&&n?i:l}}function pd(e,t){return e&&(e[t]||e[lt(t)]||e[ia(lt(t))])}function Uv(e,t,s,n){let a;const i=s&&s[n],l=ve(e);if(l||Pe(e)){const r=l&&pn(e);let o=!1,c=!1;r&&(o=!ds(e),c=Ks(e),e=ar(e)),a=new Array(e.length);for(let d=0,u=e.length;d<u;d++)a[d]=t(o?c?La(Ds(e[d])):Ds(e[d]):e[d],d,void 0,i&&i[d])}else if(typeof e=="number"){a=new Array(e);for(let r=0;r<e;r++)a[r]=t(r+1,r,void 0,i&&i[r])}else if(Xe(e))if(e[Symbol.iterator])a=Array.from(e,(r,o)=>t(r,o,void 0,i&&i[o]));else{const r=Object.keys(e);a=new Array(r.length);for(let o=0,c=r.length;o<c;o++){const d=r[o];a[o]=t(e[d],d,o,i&&i[o])}}else a=[];return s&&(s[n]=a),a}function Bv(e,t){for(let s=0;s<t.length;s++){const n=t[s];if(ve(n))for(let a=0;a<n.length;a++)e[n[a].name]=n[a].fn;else n&&(e[n.name]=n.key?(...a)=>{const i=n.fn(...a);return i&&(i.key=n.key),i}:n.fn)}return e}function Hv(e,t,s={},n,a){if(Ut.ce||Ut.parent&&hn(Ut.parent)&&Ut.parent.ce){const c=Object.keys(s).length>0;return t!=="default"&&(s.name=t),Ai(),Il(Mt,null,[pt("slot",s,n&&n())],c?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),Ai();const l=i&&Qo(i(s)),r=s.key||l&&l.key,o=Il(Mt,{key:(r&&!Kt(r)?r:`_${t}`)+(!l&&n?"_fb":"")},l||(n?n():[]),l&&e._===1?64:-2);return!a&&o.scopeId&&(o.slotScopeIds=[o.scopeId+"-s"]),i&&i._c&&(i._d=!0),o}function Qo(e){return e.some(t=>xn(t)?!(t.type===xt||t.type===Mt&&!Qo(t.children)):!0)?e:null}function Vv(e,t){const s={};for(const n in e)s[t&&/[A-Z]/.test(n)?`on:${n}`:Sa(n)]=e[n];return s}const ao=e=>e?Ap(e)?zi(e):ao(e.parent):null,fi=ze(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>ao(e.parent),$root:e=>ao(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Xo(e),$forceUpdate:e=>e.f||(e.f=()=>{zo(e.update)}),$nextTick:e=>e.n||(e.n=Ot.bind(e.proxy)),$watch:e=>uv.bind(e)}),Nr=(e,t)=>e!==Ge&&!e.__isScriptSetup&&et(e,t),io={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:a,props:i,accessCache:l,type:r,appContext:o}=e;if(t[0]!=="$"){const f=l[t];if(f!==void 0)switch(f){case 1:return n[t];case 2:return a[t];case 4:return s[t];case 3:return i[t]}else{if(Nr(n,t))return l[t]=1,n[t];if(a!==Ge&&et(a,t))return l[t]=2,a[t];if(et(i,t))return l[t]=3,i[t];if(s!==Ge&&et(s,t))return l[t]=4,s[t];lo&&(l[t]=0)}}const c=fi[t];let d,u;if(c)return t==="$attrs"&&zt(e.attrs,"get",""),c(e);if((d=r.__cssModules)&&(d=d[t]))return d;if(s!==Ge&&et(s,t))return l[t]=4,s[t];if(u=o.config.globalProperties,et(u,t))return u[t]},set({_:e},t,s){const{data:n,setupState:a,ctx:i}=e;return Nr(a,t)?(a[t]=s,!0):n!==Ge&&et(n,t)?(n[t]=s,!0):et(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:a,props:i,type:l}},r){let o;return!!(s[r]||e!==Ge&&r[0]!=="$"&&et(e,r)||Nr(t,r)||et(i,r)||et(n,r)||et(fi,r)||et(a.config.globalProperties,r)||(o=l.__cssModules)&&o[r])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:et(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}},jv=ze({},io,{get(e,t){if(t!==Symbol.unscopables)return io.get(e,t,e)},has(e,t){return t[0]!=="_"&&!Jg(t)}});function zv(){return null}function qv(){return null}function Gv(e){}function Kv(e){}function Wv(){return null}function Zv(){}function Jv(e,t){return null}function Yv(){return Xf().slots}function Qv(){return Xf().attrs}function Xf(e){const t=es();return t.setupContext||(t.setupContext=Lp(t))}function Ci(e){return ve(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}function Xv(e,t){const s=Ci(e);for(const n in t){if(n.startsWith("__skip"))continue;let a=s[n];a?ve(a)||Ie(a)?a=s[n]={type:a,default:t[n]}:a.default=t[n]:a===null&&(a=s[n]={default:t[n]}),a&&t[`__skip_${n}`]&&(a.skipFactory=!0)}return s}function eb(e,t){return!e||!t?e||t:ve(e)&&ve(t)?e.concat(t):ze({},Ci(e),Ci(t))}function tb(e,t){const s={};for(const n in e)t.includes(n)||Object.defineProperty(s,n,{enumerable:!0,get:()=>e[n]});return s}function sb(e){const t=es(),s=ea;let n=e();Ii(),s&&Ra(!1);const a=()=>{Ga(t),s&&Ra(!0)},i=()=>{es()!==t&&t.scope.off(),Ii(),s&&Ra(!1)};return Po(n)&&(n=n.catch(l=>{throw a(),Promise.resolve().then(()=>Promise.resolve().then(i)),l})),[n,()=>{a(),Promise.resolve().then(i)}]}let lo=!0;function nb(e){const t=Xo(e),s=e.proxy,n=e.ctx;lo=!1,t.beforeCreate&&hd(t.beforeCreate,e,"bc");const{data:a,computed:i,methods:l,watch:r,provide:o,inject:c,created:d,beforeMount:u,mounted:f,beforeUpdate:p,updated:g,activated:y,deactivated:S,beforeDestroy:R,beforeUnmount:v,destroyed:m,unmounted:x,render:w,renderTracked:_,renderTriggered:A,errorCaptured:T,serverPrefetch:C,expose:L,inheritAttrs:H,components:M,directives:N,filters:Z}=t;if(c&&ab(c,n,null),l)for(const O in l){const E=l[O];Ie(E)&&(n[O]=E.bind(s))}if(a){const O=a.call(s,s);Xe(O)&&(e.data=Fn(O))}if(lo=!0,i)for(const O in i){const E=i[O],q=Ie(E)?E.bind(s,s):Ie(E.get)?E.get.bind(s,s):Bt,K=!Ie(E)&&Ie(E.set)?E.set.bind(s):Bt,ee=te({get:q,set:K});Object.defineProperty(n,O,{enumerable:!0,configurable:!0,get:()=>ee.value,set:ie=>ee.value=ie})}if(r)for(const O in r)ep(r[O],n,s,O);if(o){const O=Ie(o)?o.call(s):o;Reflect.ownKeys(O).forEach(E=>{ui(E,O[E])})}d&&hd(d,e,"c");function F(O,E){ve(E)?E.forEach(q=>O(q.bind(s))):E&&O(E.bind(s))}if(F(Kf,u),F(Ye,f),F(Zo,p),F(dr,g),F(As,y),F(Rs,S),F(Yf,T),F(Jf,_),F(Zf,A),F(ur,v),F(_t,x),F(Wf,C),ve(L))if(L.length){const O=e.exposed||(e.exposed={});L.forEach(E=>{Object.defineProperty(O,E,{get:()=>s[E],set:q=>s[E]=q,enumerable:!0})})}else e.exposed||(e.exposed={});w&&e.render===Bt&&(e.render=w),H!=null&&(e.inheritAttrs=H),M&&(e.components=M),N&&(e.directives=N),C&&Wo(e)}function ab(e,t,s=Bt){ve(e)&&(e=ro(e));for(const n in e){const a=e[n];let i;Xe(a)?"default"in a?i=Ts(a.from||n,a.default,!0):i=Ts(a.from||n):i=Ts(a),Tt(i)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):t[n]=i}}function hd(e,t,s){vs(ve(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function ep(e,t,s,n){let a=n.includes(".")?Uf(s,n):()=>s[n];if(Pe(e)){const i=t[e];Ie(i)&&Xt(a,i)}else if(Ie(e))Xt(a,e.bind(s));else if(Xe(e))if(ve(e))e.forEach(i=>ep(i,t,s,n));else{const i=Ie(e.handler)?e.handler.bind(s):t[e.handler];Ie(i)&&Xt(a,i,e)}}function Xo(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:a,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,r=i.get(t);let o;return r?o=r:!a.length&&!s&&!n?o=t:(o={},a.length&&a.forEach(c=>El(o,c,l,!0)),El(o,t,l)),Xe(t)&&i.set(t,o),o}function El(e,t,s,n=!1){const{mixins:a,extends:i}=t;i&&El(e,i,s,!0),a&&a.forEach(l=>El(e,l,s,!0));for(const l in t)if(!(n&&l==="expose")){const r=ib[l]||s&&s[l];e[l]=r?r(e[l],t[l]):t[l]}return e}const ib={data:gd,props:md,emits:md,methods:li,computed:li,beforeCreate:Wt,created:Wt,beforeMount:Wt,mounted:Wt,beforeUpdate:Wt,updated:Wt,beforeDestroy:Wt,beforeUnmount:Wt,destroyed:Wt,unmounted:Wt,activated:Wt,deactivated:Wt,errorCaptured:Wt,serverPrefetch:Wt,components:li,directives:li,watch:rb,provide:gd,inject:lb};function gd(e,t){return t?e?function(){return ze(Ie(e)?e.call(this,this):e,Ie(t)?t.call(this,this):t)}:t:e}function lb(e,t){return li(ro(e),ro(t))}function ro(e){if(ve(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Wt(e,t){return e?[...new Set([].concat(e,t))]:t}function li(e,t){return e?ze(Object.create(null),e,t):t}function md(e,t){return e?ve(e)&&ve(t)?[...new Set([...e,...t])]:ze(Object.create(null),Ci(e),Ci(t??{})):t}function rb(e,t){if(!e)return t;if(!t)return e;const s=ze(Object.create(null),e);for(const n in t)s[n]=Wt(e[n],t[n]);return s}function tp(){return{app:null,config:{isNativeTag:xa,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let ob=0;function cb(e,t){return function(n,a=null){Ie(n)||(n=ze({},n)),a!=null&&!Xe(a)&&(a=null);const i=tp(),l=new WeakSet,r=[];let o=!1;const c=i.app={_uid:ob++,_component:n,_props:a,_container:null,_context:i,_instance:null,version:Dp,get config(){return i.config},set config(d){},use(d,...u){return l.has(d)||(d&&Ie(d.install)?(l.add(d),d.install(c,...u)):Ie(d)&&(l.add(d),d(c,...u))),c},mixin(d){return i.mixins.includes(d)||i.mixins.push(d),c},component(d,u){return u?(i.components[d]=u,c):i.components[d]},directive(d,u){return u?(i.directives[d]=u,c):i.directives[d]},mount(d,u,f){if(!o){const p=c._ceVNode||pt(n,a);return p.appContext=i,f===!0?f="svg":f===!1&&(f=void 0),u&&t?t(p,d):e(p,d,f),o=!0,c._container=d,d.__vue_app__=c,zi(p.component)}},onUnmount(d){r.push(d)},unmount(){o&&(vs(r,c._instance,16),e(null,c._container),delete c._container.__vue_app__)},provide(d,u){return i.provides[d]=u,c},runWithContext(d){const u=Zn;Zn=c;try{return d()}finally{Zn=u}}};return c}}let Zn=null;function db(e,t,s=Ge){const n=es(),a=lt(t),i=os(t),l=sp(e,a),r=Af((o,c)=>{let d,u=Ge,f;return $f(()=>{const p=e[a];Dt(d,p)&&(d=p,c())}),{get(){return o(),s.get?s.get(d):d},set(p){const g=s.set?s.set(p):p;if(!Dt(g,d)&&!(u!==Ge&&Dt(p,u)))return;const y=n.vnode.props,S=!!(y&&(t in y||a in y||i in y)&&(`onUpdate:${t}`in y||`onUpdate:${a}`in y||`onUpdate:${i}`in y));S||(d=p,c()),n.emit(`update:${t}`,g),Dt(p,u)&&(Dt(p,g)&&!Dt(g,f)||S&&u!==Ge&&!Dt(g,d))&&c(),u=p,f=g}}});return r[Symbol.iterator]=()=>{let o=0;return{next(){return o<2?{value:o++?l||Ge:r,done:!1}:{done:!0}}}},r}const sp=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${lt(t)}Modifiers`]||e[`${os(t)}Modifiers`];function ub(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||Ge;let a=s;const i=t.startsWith("update:"),l=i&&sp(n,t.slice(7));l&&(l.trim&&(a=s.map(d=>Pe(d)?d.trim():d)),l.number&&(a=s.map(er)));let r,o=n[r=Sa(t)]||n[r=Sa(lt(t))];!o&&i&&(o=n[r=Sa(os(t))]),o&&vs(o,e,6,a);const c=n[r+"Once"];if(c){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,vs(c,e,6,a)}}const fb=new WeakMap;function np(e,t,s=!1){const n=s?fb:t.emitsCache,a=n.get(e);if(a!==void 0)return a;const i=e.emits;let l={},r=!1;if(!Ie(e)){const o=c=>{const d=np(c,t,!0);d&&(r=!0,ze(l,d))};!s&&t.mixins.length&&t.mixins.forEach(o),e.extends&&o(e.extends),e.mixins&&e.mixins.forEach(o)}return!i&&!r?(Xe(e)&&n.set(e,null),null):(ve(i)?i.forEach(o=>l[o]=null):ze(l,i),Xe(e)&&n.set(e,l),l)}function fr(e,t){return!e||!na(t)?!1:(t=t.slice(2).replace(/Once$/,""),et(e,t[0].toLowerCase()+t.slice(1))||et(e,os(t))||et(e,t))}function pl(e){const{type:t,vnode:s,proxy:n,withProxy:a,propsOptions:[i],slots:l,attrs:r,emit:o,render:c,renderCache:d,props:u,data:f,setupState:p,ctx:g,inheritAttrs:y}=e,S=Ti(e);let R,v;try{if(s.shapeFlag&4){const x=a||n,w=x;R=rs(c.call(w,x,d,u,p,f,g)),v=r}else{const x=t;R=rs(x.length>1?x(u,{attrs:r,slots:l,emit:o}):x(u,null)),v=t.props?r:hb(r)}}catch(x){pi.length=0,la(x,e,1),R=pt(xt)}let m=R;if(v&&y!==!1){const x=Object.keys(v),{shapeFlag:w}=m;x.length&&w&7&&(i&&x.some(Jl)&&(v=gb(v,i)),m=Ws(m,v,!1,!0))}return s.dirs&&(m=Ws(m,null,!1,!0),m.dirs=m.dirs?m.dirs.concat(s.dirs):s.dirs),s.transition&&yn(m,s.transition),R=m,Ti(S),R}function pb(e,t=!0){let s;for(let n=0;n<e.length;n++){const a=e[n];if(xn(a)){if(a.type!==xt||a.children==="v-if"){if(s)return;s=a}}else return}return s}const hb=e=>{let t;for(const s in e)(s==="class"||s==="style"||na(s))&&((t||(t={}))[s]=e[s]);return t},gb=(e,t)=>{const s={};for(const n in e)(!Jl(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function mb(e,t,s){const{props:n,children:a,component:i}=e,{props:l,children:r,patchFlag:o}=t,c=i.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&o>=0){if(o&1024)return!0;if(o&16)return n?vd(n,l,c):!!l;if(o&8){const d=t.dynamicProps;for(let u=0;u<d.length;u++){const f=d[u];if(ap(l,n,f)&&!fr(c,f))return!0}}}else return(a||r)&&(!r||!r.$stable)?!0:n===l?!1:n?l?vd(n,l,c):!0:!!l;return!1}function vd(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let a=0;a<n.length;a++){const i=n[a];if(ap(t,e,i)&&!fr(s,i))return!0}return!1}function ap(e,t,s){const n=e[s],a=t[s];return s==="style"&&Xe(n)&&Xe(a)?!mn(n,a):n!==a}function pr({vnode:e,parent:t,suspense:s},n){for(;t;){const a=t.subTree;if(a.suspense&&a.suspense.activeBranch===e&&(a.suspense.vnode.el=a.el=n,e=a),a===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const ip={},lp=()=>Object.create(ip),rp=e=>Object.getPrototypeOf(e)===ip;function vb(e,t,s,n=!1){const a={},i=lp();e.propsDefaults=Object.create(null),op(e,t,a,i);for(const l in e.propsOptions[0])l in a||(a[l]=void 0);s?e.props=n?a:Ho(a):e.type.props?e.props=a:e.props=i,e.attrs=i}function bb(e,t,s,n){const{props:a,attrs:i,vnode:{patchFlag:l}}=e,r=Je(a),[o]=e.propsOptions;let c=!1;if((n||l>0)&&!(l&16)){if(l&8){const d=e.vnode.dynamicProps;for(let u=0;u<d.length;u++){let f=d[u];if(fr(e.emitsOptions,f))continue;const p=t[f];if(o)if(et(i,f))p!==i[f]&&(i[f]=p,c=!0);else{const g=lt(f);a[g]=oo(o,r,g,p,e,!1)}else p!==i[f]&&(i[f]=p,c=!0)}}}else{op(e,t,a,i)&&(c=!0);let d;for(const u in r)(!t||!et(t,u)&&((d=os(u))===u||!et(t,d)))&&(o?s&&(s[u]!==void 0||s[d]!==void 0)&&(a[u]=oo(o,r,u,void 0,e,!0)):delete a[u]);if(i!==r)for(const u in i)(!t||!et(t,u))&&(delete i[u],c=!0)}c&&rn(e.attrs,"set","")}function op(e,t,s,n){const[a,i]=e.propsOptions;let l=!1,r;if(t)for(let o in t){if(fn(o))continue;const c=t[o];let d;a&&et(a,d=lt(o))?!i||!i.includes(d)?s[d]=c:(r||(r={}))[d]=c:fr(e.emitsOptions,o)||(!(o in n)||c!==n[o])&&(n[o]=c,l=!0)}if(i){const o=Je(s),c=r||Ge;for(let d=0;d<i.length;d++){const u=i[d];s[u]=oo(a,o,u,c[u],e,!et(c,u))}}return l}function oo(e,t,s,n,a,i){const l=e[s];if(l!=null){const r=et(l,"default");if(r&&n===void 0){const o=l.default;if(l.type!==Function&&!l.skipFactory&&Ie(o)){const{propsDefaults:c}=a;if(s in c)n=c[s];else{const d=Ga(a);n=c[s]=o.call(null,t),d()}}else n=o;a.ce&&a.ce._setProp(s,n)}l[0]&&(i&&!r?n=!1:l[1]&&(n===""||n===os(s))&&(n=!0))}return n}const yb=new WeakMap;function cp(e,t,s=!1){const n=s?yb:t.propsCache,a=n.get(e);if(a)return a;const i=e.props,l={},r=[];let o=!1;if(!Ie(e)){const d=u=>{o=!0;const[f,p]=cp(u,t,!0);ze(l,f),p&&r.push(...p)};!s&&t.mixins.length&&t.mixins.forEach(d),e.extends&&d(e.extends),e.mixins&&e.mixins.forEach(d)}if(!i&&!o)return Xe(e)&&n.set(e,wa),wa;if(ve(i))for(let d=0;d<i.length;d++){const u=lt(i[d]);bd(u)&&(l[u]=Ge)}else if(i)for(const d in i){const u=lt(d);if(bd(u)){const f=i[d],p=l[u]=ve(f)||Ie(f)?{type:f}:ze({},f),g=p.type;let y=!1,S=!0;if(ve(g))for(let R=0;R<g.length;++R){const v=g[R],m=Ie(v)&&v.name;if(m==="Boolean"){y=!0;break}else m==="String"&&(S=!1)}else y=Ie(g)&&g.name==="Boolean";p[0]=y,p[1]=S,(y||et(p,"default"))&&r.push(u)}}const c=[l,r];return Xe(e)&&n.set(e,c),c}function bd(e){return e[0]!=="$"&&!fn(e)}const ec=e=>e==="_"||e==="_ctx"||e==="$stable",tc=e=>ve(e)?e.map(rs):[rs(e)],xb=(e,t,s)=>{if(t._n)return t;const n=qo((...a)=>tc(t(...a)),s);return n._c=!1,n},dp=(e,t,s)=>{const n=e._ctx;for(const a in e){if(ec(a))continue;const i=e[a];if(Ie(i))t[a]=xb(a,i,n);else if(i!=null){const l=tc(i);t[a]=()=>l}}},up=(e,t)=>{const s=tc(t);e.slots.default=()=>s},fp=(e,t,s)=>{for(const n in t)(s||!ec(n))&&(e[n]=t[n])},_b=(e,t,s)=>{const n=e.slots=lp();if(e.vnode.shapeFlag&32){const a=t._;a?(fp(n,t,s),s&&nf(n,"_",a,!0)):dp(t,n)}else t&&up(e,t)},wb=(e,t,s)=>{const{vnode:n,slots:a}=e;let i=!0,l=Ge;if(n.shapeFlag&32){const r=t._;r?s&&r===1?i=!1:fp(a,t,s):(i=!t.$stable,dp(t,a)),l=t}else t&&(up(e,t),l={default:1});if(i)for(const r in a)!ec(r)&&l[r]==null&&delete a[r]},kt=xp;function pp(e){return gp(e)}function hp(e){return gp(e,_v)}function gp(e,t){const s=tr();s.__VUE__=!0;const{insert:n,remove:a,patchProp:i,createElement:l,createText:r,createComment:o,setText:c,setElementText:d,parentNode:u,nextSibling:f,setScopeId:p=Bt,insertStaticContent:g}=e,y=(b,I,P,X=null,J=null,Y=null,pe=void 0,ce=null,re=!!I.dynamicChildren)=>{if(b===I)return;b&&!Os(b,I)&&(X=V(b),ie(b,J,Y,!0),b=null),I.patchFlag===-2&&(re=!1,I.dynamicChildren=null);const{type:se,ref:xe,shapeFlag:he}=I;switch(se){case Dn:S(b,I,P,X);break;case xt:R(b,I,P,X);break;case Jn:b==null&&v(I,P,X,pe);break;case Mt:M(b,I,P,X,J,Y,pe,ce,re);break;default:he&1?w(b,I,P,X,J,Y,pe,ce,re):he&6?N(b,I,P,X,J,Y,pe,ce,re):(he&64||he&128)&&se.process(b,I,P,X,J,Y,pe,ce,re,be)}xe!=null&&J?Ea(xe,b&&b.ref,Y,I||b,!I):xe==null&&b&&b.ref!=null&&Ea(b.ref,null,Y,b,!0)},S=(b,I,P,X)=>{if(b==null)n(I.el=r(I.children),P,X);else{const J=I.el=b.el;I.children!==b.children&&c(J,I.children)}},R=(b,I,P,X)=>{b==null?n(I.el=o(I.children||""),P,X):I.el=b.el},v=(b,I,P,X)=>{[b.el,b.anchor]=g(b.children,I,P,X,b.el,b.anchor)},m=({el:b,anchor:I},P,X)=>{let J;for(;b&&b!==I;)J=f(b),n(b,P,X),b=J;n(I,P,X)},x=({el:b,anchor:I})=>{let P;for(;b&&b!==I;)P=f(b),a(b),b=P;a(I)},w=(b,I,P,X,J,Y,pe,ce,re)=>{if(I.type==="svg"?pe="svg":I.type==="math"&&(pe="mathml"),b==null)_(I,P,X,J,Y,pe,ce,re);else{const se=b.el&&b.el._isVueCE?b.el:null;try{se&&se._beginPatch(),C(b,I,J,Y,pe,ce,re)}finally{se&&se._endPatch()}}},_=(b,I,P,X,J,Y,pe,ce)=>{let re,se;const{props:xe,shapeFlag:he,transition:ge,dirs:ke}=b;if(re=b.el=l(b.type,Y,xe&&xe.is,xe),he&8?d(re,b.children):he&16&&T(b.children,re,null,X,J,Dr(b,Y),pe,ce),ke&&zs(b,null,X,"created"),A(re,b,b.scopeId,pe,X),xe){for(const Oe in xe)Oe!=="value"&&!fn(Oe)&&i(re,Oe,null,xe[Oe],Y,X);"value"in xe&&i(re,"value",null,xe.value,Y),(se=xe.onVnodeBeforeMount)&&is(se,X,b)}ke&&zs(b,null,X,"beforeMount");const Ce=mp(J,ge);Ce&&ge.beforeEnter(re),n(re,I,P),((se=xe&&xe.onVnodeMounted)||Ce||ke)&&kt(()=>{try{se&&is(se,X,b),Ce&&ge.enter(re),ke&&zs(b,null,X,"mounted")}finally{}},J)},A=(b,I,P,X,J)=>{if(P&&p(b,P),X)for(let Y=0;Y<X.length;Y++)p(b,X[Y]);if(J){let Y=J.subTree;if(I===Y||Rl(Y.type)&&(Y.ssContent===I||Y.ssFallback===I)){const pe=J.vnode;A(b,pe,pe.scopeId,pe.slotScopeIds,J.parent)}}},T=(b,I,P,X,J,Y,pe,ce,re=0)=>{for(let se=re;se<b.length;se++){const xe=b[se]=ce?an(b[se]):rs(b[se]);y(null,xe,I,P,X,J,Y,pe,ce)}},C=(b,I,P,X,J,Y,pe)=>{const ce=I.el=b.el;let{patchFlag:re,dynamicChildren:se,dirs:xe}=I;re|=b.patchFlag&16;const he=b.props||Ge,ge=I.props||Ge;let ke;if(P&&Bn(P,!1),(ke=ge.onVnodeBeforeUpdate)&&is(ke,P,I,b),xe&&zs(I,b,P,"beforeUpdate"),P&&Bn(P,!0),(he.innerHTML&&ge.innerHTML==null||he.textContent&&ge.textContent==null)&&d(ce,""),se?L(b.dynamicChildren,se,ce,P,X,Dr(I,J),Y):pe||E(b,I,ce,null,P,X,Dr(I,J),Y,!1),re>0){if(re&16)H(ce,he,ge,P,J);else if(re&2&&he.class!==ge.class&&i(ce,"class",null,ge.class,J),re&4&&i(ce,"style",he.style,ge.style,J),re&8){const Ce=I.dynamicProps;for(let Oe=0;Oe<Ce.length;Oe++){const Me=Ce[Oe],Fe=he[Me],Ve=ge[Me];(Ve!==Fe||Me==="value")&&i(ce,Me,Fe,Ve,J,P)}}re&1&&b.children!==I.children&&d(ce,I.children)}else!pe&&se==null&&H(ce,he,ge,P,J);((ke=ge.onVnodeUpdated)||xe)&&kt(()=>{ke&&is(ke,P,I,b),xe&&zs(I,b,P,"updated")},X)},L=(b,I,P,X,J,Y,pe)=>{for(let ce=0;ce<I.length;ce++){const re=b[ce],se=I[ce],xe=re.el&&(re.type===Mt||!Os(re,se)||re.shapeFlag&198)?u(re.el):P;y(re,se,xe,null,X,J,Y,pe,!0)}},H=(b,I,P,X,J)=>{if(I!==P){if(I!==Ge)for(const Y in I)!fn(Y)&&!(Y in P)&&i(b,Y,I[Y],null,J,X);for(const Y in P){if(fn(Y))continue;const pe=P[Y],ce=I[Y];pe!==ce&&Y!=="value"&&i(b,Y,ce,pe,J,X)}"value"in P&&i(b,"value",I.value,P.value,J)}},M=(b,I,P,X,J,Y,pe,ce,re)=>{const se=I.el=b?b.el:r(""),xe=I.anchor=b?b.anchor:r("");let{patchFlag:he,dynamicChildren:ge,slotScopeIds:ke}=I;ke&&(ce=ce?ce.concat(ke):ke),b==null?(n(se,P,X),n(xe,P,X),T(I.children||[],P,xe,J,Y,pe,ce,re)):he>0&&he&64&&ge&&b.dynamicChildren&&b.dynamicChildren.length===ge.length?(L(b.dynamicChildren,ge,P,J,Y,pe,ce),(I.key!=null||J&&I===J.subTree)&&sc(b,I,!0)):E(b,I,P,xe,J,Y,pe,ce,re)},N=(b,I,P,X,J,Y,pe,ce,re)=>{I.slotScopeIds=ce,b==null?I.shapeFlag&512?J.ctx.activate(I,P,X,pe,re):Z(I,P,X,J,Y,pe,re):ne(b,I,re)},Z=(b,I,P,X,J,Y,pe)=>{const ce=b.component=Ep(b,X,J);if(ji(b)&&(ce.ctx.renderer=be),Rp(ce,!1,pe),ce.asyncDep){if(J&&J.registerDep(ce,F,pe),!b.el){const re=ce.subTree=pt(xt);R(null,re,I,P),b.placeholder=re.el}}else F(ce,b,I,P,J,Y,pe)},ne=(b,I,P)=>{const X=I.component=b.component;if(mb(b,I,P))if(X.asyncDep&&!X.asyncResolved){O(X,I,P);return}else X.next=I,X.update();else I.el=b.el,X.vnode=I},F=(b,I,P,X,J,Y,pe)=>{const ce=()=>{if(b.isMounted){let{next:he,bu:ge,u:ke,parent:Ce,vnode:Oe}=b;{const j=vp(b);if(j){he&&(he.el=Oe.el,O(b,he,pe)),j.asyncDep.then(()=>{kt(()=>{b.isUnmounted||se()},J)});return}}let Me=he,Fe;Bn(b,!1),he?(he.el=Oe.el,O(b,he,pe)):he=Oe,ge&&Ta(ge),(Fe=he.props&&he.props.onVnodeBeforeUpdate)&&is(Fe,Ce,he,Oe),Bn(b,!0);const Ve=pl(b),st=b.subTree;b.subTree=Ve,y(st,Ve,u(st.el),V(st),b,J,Y),he.el=Ve.el,Me===null&&pr(b,Ve.el),ke&&kt(ke,J),(Fe=he.props&&he.props.onVnodeUpdated)&&kt(()=>is(Fe,Ce,he,Oe),J)}else{let he;const{el:ge,props:ke}=I,{bm:Ce,m:Oe,parent:Me,root:Fe,type:Ve}=b,st=hn(I);if(Bn(b,!1),Ce&&Ta(Ce),!st&&(he=ke&&ke.onVnodeBeforeMount)&&is(he,Me,I),Bn(b,!0),ge&&Be){const j=()=>{b.subTree=pl(b),Be(ge,b.subTree,b,J,null)};st&&Ve.__asyncHydrate?Ve.__asyncHydrate(ge,b,j):j()}else{Fe.ce&&Fe.ce._hasShadowRoot()&&Fe.ce._injectChildStyle(Ve,b.parent?b.parent.type:void 0);const j=b.subTree=pl(b);y(null,j,P,X,b,J,Y),I.el=j.el}if(Oe&&kt(Oe,J),!st&&(he=ke&&ke.onVnodeMounted)){const j=I;kt(()=>is(he,Me,j),J)}(I.shapeFlag&256||Me&&hn(Me.vnode)&&Me.vnode.shapeFlag&256)&&b.a&&kt(b.a,J),b.isMounted=!0,I=P=X=null}};b.scope.on();const re=b.effect=new xi(ce);b.scope.off();const se=b.update=re.run.bind(re),xe=b.job=re.runIfDirty.bind(re);xe.i=b,xe.id=b.uid,re.scheduler=()=>zo(xe),Bn(b,!0),se()},O=(b,I,P)=>{I.component=b;const X=b.vnode.props;b.vnode=I,b.next=null,bb(b,I.props,X,P),wb(b,I.children,P),vn(),id(b),bn()},E=(b,I,P,X,J,Y,pe,ce,re=!1)=>{const se=b&&b.children,xe=b?b.shapeFlag:0,he=I.children,{patchFlag:ge,shapeFlag:ke}=I;if(ge>0){if(ge&128){K(se,he,P,X,J,Y,pe,ce,re);return}else if(ge&256){q(se,he,P,X,J,Y,pe,ce,re);return}}ke&8?(xe&16&&_e(se,J,Y),he!==se&&d(P,he)):xe&16?ke&16?K(se,he,P,X,J,Y,pe,ce,re):_e(se,J,Y,!0):(xe&8&&d(P,""),ke&16&&T(he,P,X,J,Y,pe,ce,re))},q=(b,I,P,X,J,Y,pe,ce,re)=>{b=b||wa,I=I||wa;const se=b.length,xe=I.length,he=Math.min(se,xe);let ge;for(ge=0;ge<he;ge++){const ke=I[ge]=re?an(I[ge]):rs(I[ge]);y(b[ge],ke,P,null,J,Y,pe,ce,re)}se>xe?_e(b,J,Y,!0,!1,he):T(I,P,X,J,Y,pe,ce,re,he)},K=(b,I,P,X,J,Y,pe,ce,re)=>{let se=0;const xe=I.length;let he=b.length-1,ge=xe-1;for(;se<=he&&se<=ge;){const ke=b[se],Ce=I[se]=re?an(I[se]):rs(I[se]);if(Os(ke,Ce))y(ke,Ce,P,null,J,Y,pe,ce,re);else break;se++}for(;se<=he&&se<=ge;){const ke=b[he],Ce=I[ge]=re?an(I[ge]):rs(I[ge]);if(Os(ke,Ce))y(ke,Ce,P,null,J,Y,pe,ce,re);else break;he--,ge--}if(se>he){if(se<=ge){const ke=ge+1,Ce=ke<xe?I[ke].el:X;for(;se<=ge;)y(null,I[se]=re?an(I[se]):rs(I[se]),P,Ce,J,Y,pe,ce,re),se++}}else if(se>ge)for(;se<=he;)ie(b[se],J,Y,!0),se++;else{const ke=se,Ce=se,Oe=new Map;for(se=Ce;se<=ge;se++){const De=I[se]=re?an(I[se]):rs(I[se]);De.key!=null&&Oe.set(De.key,se)}let Me,Fe=0;const Ve=ge-Ce+1;let st=!1,j=0;const we=new Array(Ve);for(se=0;se<Ve;se++)we[se]=0;for(se=ke;se<=he;se++){const De=b[se];if(Fe>=Ve){ie(De,J,Y,!0);continue}let Ke;if(De.key!=null)Ke=Oe.get(De.key);else for(Me=Ce;Me<=ge;Me++)if(we[Me-Ce]===0&&Os(De,I[Me])){Ke=Me;break}Ke===void 0?ie(De,J,Y,!0):(we[Ke-Ce]=se+1,Ke>=j?j=Ke:st=!0,y(De,I[Ke],P,null,J,Y,pe,ce,re),Fe++)}const Le=st?kb(we):wa;for(Me=Le.length-1,se=Ve-1;se>=0;se--){const De=Ce+se,Ke=I[De],qe=I[De+1],ht=De+1<xe?qe.el||bp(qe):X;we[se]===0?y(null,Ke,P,ht,J,Y,pe,ce,re):st&&(Me<0||se!==Le[Me]?ee(Ke,P,ht,2):Me--)}}},ee=(b,I,P,X,J=null)=>{const{el:Y,type:pe,transition:ce,children:re,shapeFlag:se}=b;if(se&6){ee(b.component.subTree,I,P,X);return}if(se&128){b.suspense.move(I,P,X);return}if(se&64){pe.move(b,I,P,be);return}if(pe===Mt){n(Y,I,P);for(let he=0;he<re.length;he++)ee(re[he],I,P,X);n(b.anchor,I,P);return}if(pe===Jn){m(b,I,P);return}if(X!==2&&se&1&&ce)if(X===0)ce.persisted&&!Y[ws]?n(Y,I,P):(ce.beforeEnter(Y),n(Y,I,P),kt(()=>ce.enter(Y),J));else{const{leave:he,delayLeave:ge,afterLeave:ke}=ce,Ce=()=>{b.ctx.isUnmounted?a(Y):n(Y,I,P)},Oe=()=>{const Me=Y._isLeaving||!!Y[ws];Y._isLeaving&&Y[ws](!0),ce.persisted&&!Me?Ce():he(Y,()=>{Ce(),ke&&ke()})};ge?ge(Y,Ce,Oe):Oe()}else n(Y,I,P)},ie=(b,I,P,X=!1,J=!1)=>{const{type:Y,props:pe,ref:ce,children:re,dynamicChildren:se,shapeFlag:xe,patchFlag:he,dirs:ge,cacheIndex:ke,memo:Ce}=b;if(he===-2&&(J=!1),ce!=null&&(vn(),Ea(ce,null,P,b,!0),bn()),ke!=null&&(I.renderCache[ke]=void 0),xe&256){I.ctx.deactivate(b);return}const Oe=xe&1&&ge,Me=!hn(b);let Fe;if(Me&&(Fe=pe&&pe.onVnodeBeforeUnmount)&&is(Fe,I,b),xe&6)de(b.component,P,X);else{if(xe&128){b.suspense.unmount(P,X);return}Oe&&zs(b,null,I,"beforeUnmount"),xe&64?b.type.remove(b,I,P,be,X):se&&!se.hasOnce&&(Y!==Mt||he>0&&he&64)?_e(se,I,P,!1,!0):(Y===Mt&&he&384||!J&&xe&16)&&_e(re,I,P),X&&U(b)}const Ve=Ce!=null&&ke==null;(Me&&(Fe=pe&&pe.onVnodeUnmounted)||Oe||Ve)&&kt(()=>{Fe&&is(Fe,I,b),Oe&&zs(b,null,I,"unmounted"),Ve&&(b.el=null)},P)},U=b=>{const{type:I,el:P,anchor:X,transition:J}=b;if(I===Mt){B(P,X);return}if(I===Jn){x(b);return}const Y=()=>{a(P),J&&!J.persisted&&J.afterLeave&&J.afterLeave()};if(b.shapeFlag&1&&J&&!J.persisted){const{leave:pe,delayLeave:ce}=J,re=()=>pe(P,Y);ce?ce(b.el,Y,re):re()}else Y()},B=(b,I)=>{let P;for(;b!==I;)P=f(b),a(b),b=P;a(I)},de=(b,I,P)=>{const{bum:X,scope:J,job:Y,subTree:pe,um:ce,m:re,a:se}=b;Al(re),Al(se),X&&Ta(X),J.stop(),Y&&(Y.flags|=8,ie(pe,b,I,P)),ce&&kt(ce,I),kt(()=>{b.isUnmounted=!0},I)},_e=(b,I,P,X=!1,J=!1,Y=0)=>{for(let pe=Y;pe<b.length;pe++)ie(b[pe],I,P,X,J)},V=b=>{if(b.shapeFlag&6)return V(b.component.subTree);if(b.shapeFlag&128)return b.suspense.next();const I=f(b.anchor||b.el),P=I&&I[Bf];return P?f(P):I};let ue=!1;const oe=(b,I,P)=>{let X;b==null?I._vnode&&(ie(I._vnode,null,null,!0),X=I._vnode.component):y(I._vnode||null,b,I,null,null,null,P),I._vnode=b,ue||(ue=!0,id(X),Tl(),ue=!1)},be={p:y,um:ie,m:ee,r:U,mt:Z,mc:T,pc:E,pbc:L,n:V,o:e};let me,Be;return t&&([me,Be]=t(be)),{render:oe,hydrate:me,createApp:cb(oe,me)}}function Dr({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Bn({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function mp(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function sc(e,t,s=!1){const n=e.children,a=t.children;if(ve(n)&&ve(a))for(let i=0;i<n.length;i++){const l=n[i];let r=a[i];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=a[i]=an(a[i]),r.el=l.el),!s&&r.patchFlag!==-2&&sc(l,r)),r.type===Dn&&(r.patchFlag===-1&&(r=a[i]=an(r)),r.el=l.el),r.type===xt&&!r.el&&(r.el=l.el)}}function kb(e){const t=e.slice(),s=[0];let n,a,i,l,r;const o=e.length;for(n=0;n<o;n++){const c=e[n];if(c!==0){if(a=s[s.length-1],e[a]<c){t[n]=a,s.push(n);continue}for(i=0,l=s.length-1;i<l;)r=i+l>>1,e[s[r]]<c?i=r+1:l=r;c<e[s[i]]&&(i>0&&(t[n]=s[i-1]),s[i]=n)}}for(i=s.length,l=s[i-1];i-- >0;)s[i]=l,l=t[l];return s}function vp(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:vp(t)}function Al(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function bp(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?bp(t.subTree):null}const Rl=e=>e.__isSuspense;let co=0;const Sb={name:"Suspense",__isSuspense:!0,process(e,t,s,n,a,i,l,r,o,c){if(e==null)Cb(t,s,n,a,i,l,r,o,c);else{if(i&&i.deps>0&&!e.suspense.isInFallback){t.suspense=e.suspense,t.suspense.vnode=t,t.el=e.el;return}Eb(e,t,s,n,a,l,r,o,c)}},hydrate:Ab,normalize:Rb},Tb=Sb;function Ei(e,t){const s=e.props&&e.props[t];Ie(s)&&s()}function Cb(e,t,s,n,a,i,l,r,o){const{p:c,o:{createElement:d}}=o,u=d("div"),f=e.suspense=yp(e,a,n,t,u,s,i,l,r,o);c(null,f.pendingBranch=e.ssContent,u,null,n,f,i,l),f.deps>0?(Ei(e,"onPending"),Ei(e,"onFallback"),c(null,e.ssFallback,t,s,n,null,i,l),Aa(f,e.ssFallback)):f.resolve(!1,!0)}function Eb(e,t,s,n,a,i,l,r,{p:o,um:c,o:{createElement:d}}){const u=t.suspense=e.suspense;u.vnode=t,t.el=e.el;const f=t.ssContent,p=t.ssFallback,{activeBranch:g,pendingBranch:y,isInFallback:S,isHydrating:R}=u;if(y)u.pendingBranch=f,Os(y,f)?(o(y,f,u.hiddenContainer,null,a,u,i,l,r),u.deps<=0?u.resolve():S&&(R||(o(g,p,s,n,a,null,i,l,r),Aa(u,p)))):(u.pendingId=co++,R?(u.isHydrating=!1,u.activeBranch=y):c(y,a,u),u.deps=0,u.effects.length=0,u.hiddenContainer=d("div"),S?(o(null,f,u.hiddenContainer,null,a,u,i,l,r),u.deps<=0?u.resolve():(o(g,p,s,n,a,null,i,l,r),Aa(u,p))):g&&Os(g,f)?(o(g,f,s,n,a,u,i,l,r),u.resolve(!0)):(o(null,f,u.hiddenContainer,null,a,u,i,l,r),u.deps<=0&&u.resolve()));else if(g&&Os(g,f))o(g,f,s,n,a,u,i,l,r),Aa(u,f);else if(Ei(t,"onPending"),u.pendingBranch=f,f.shapeFlag&512?u.pendingId=f.component.suspenseId:u.pendingId=co++,o(null,f,u.hiddenContainer,null,a,u,i,l,r),u.deps<=0)u.resolve();else{const{timeout:v,pendingId:m}=u;v>0?setTimeout(()=>{u.pendingId===m&&u.fallback(p)},v):v===0&&u.fallback(p)}}function yp(e,t,s,n,a,i,l,r,o,c,d=!1){const{p:u,m:f,um:p,n:g,o:{parentNode:y,remove:S}}=c;let R;const v=Ib(e);v&&t&&t.pendingBranch&&(R=t.pendingId,t.deps++);const m=e.props?xl(e.props.timeout):void 0,x=i,w={vnode:e,parent:t,parentComponent:s,namespace:l,container:n,hiddenContainer:a,deps:0,pendingId:co++,timeout:typeof m=="number"?m:-1,activeBranch:null,isFallbackMountPending:!1,pendingBranch:null,isInFallback:!d,isHydrating:d,isUnmounted:!1,effects:[],resolve(_=!1,A=!1){const{vnode:T,activeBranch:C,pendingBranch:L,pendingId:H,effects:M,parentComponent:N,container:Z,isInFallback:ne}=w;let F=!1;if(w.isHydrating)w.isHydrating=!1;else if(!_){F=C&&L.transition&&L.transition.mode==="out-in";let q=!1;F&&(C.transition.afterLeave=()=>{H===w.pendingId&&(f(L,Z,i===x&&!q?g(C):i,0),ki(M),ne&&T.ssFallback&&(T.ssFallback.el=null))}),C&&!w.isFallbackMountPending&&(y(C.el)===Z&&(i=g(C),q=!0),p(C,N,w,!0),!F&&ne&&T.ssFallback&&kt(()=>T.ssFallback.el=null,w)),F||f(L,Z,i,0)}w.isFallbackMountPending=!1,Aa(w,L),w.pendingBranch=null,w.isInFallback=!1;let O=w.parent,E=!1;for(;O;){if(O.pendingBranch){O.effects.push(...M),E=!0;break}O=O.parent}!E&&!F&&ki(M),w.effects=[],v&&t&&t.pendingBranch&&R===t.pendingId&&(t.deps--,t.deps===0&&!A&&t.resolve()),Ei(T,"onResolve")},fallback(_){if(!w.pendingBranch)return;const{vnode:A,activeBranch:T,parentComponent:C,container:L,namespace:H}=w;Ei(A,"onFallback");const M=g(T),N=()=>{w.isFallbackMountPending=!1,w.isInFallback&&(u(null,_,L,M,C,null,H,r,o),Aa(w,_))},Z=_.transition&&_.transition.mode==="out-in";Z&&(w.isFallbackMountPending=!0,T.transition.afterLeave=N),w.isInFallback=!0,p(T,C,null,!0),Z||N()},move(_,A,T){w.activeBranch&&f(w.activeBranch,_,A,T),w.container=_},next(){return w.activeBranch&&g(w.activeBranch)},registerDep(_,A,T){const C=!!w.pendingBranch;C&&w.deps++;const L=_.vnode.el;_.asyncDep.catch(H=>{la(H,_,0)}).then(H=>{if(_.isUnmounted||w.isUnmounted||w.pendingId!==_.suspenseId)return;Ii(),_.asyncResolved=!0;const{vnode:M}=_;uo(_,H,!1),L&&(M.el=L);const N=!L&&_.subTree.el;A(_,M,y(L||_.subTree.el),L?null:g(_.subTree),w,l,T),N&&(M.placeholder=null,S(N)),pr(_,M.el),C&&--w.deps===0&&w.resolve()})},unmount(_,A){w.isUnmounted=!0,w.activeBranch&&p(w.activeBranch,s,_,A),w.pendingBranch&&p(w.pendingBranch,s,_,A)}};return w}function Ab(e,t,s,n,a,i,l,r,o){const c=t.suspense=yp(t,n,s,e.parentNode,document.createElement("div"),null,a,i,l,r,!0),d=o(e,c.pendingBranch=t.ssContent,s,c,i,l);return c.deps===0&&c.resolve(!1,!0),d}function Rb(e){const{shapeFlag:t,children:s}=e,n=t&32;e.ssContent=yd(n?s.default:s),e.ssFallback=n?yd(s.fallback):pt(xt)}function yd(e){let t;if(Ie(e)){const s=Xn&&e._c;s&&(e._d=!1,Ai()),e=e(),s&&(e._d=!0,t=qt,_p())}return ve(e)&&(e=pb(e)),e=rs(e),t&&!e.dynamicChildren&&(e.dynamicChildren=t.filter(s=>s!==e)),e}function xp(e,t){t&&t.pendingBranch?ve(e)?t.effects.push(...e):t.effects.push(e):ki(e)}function Aa(e,t){e.activeBranch=t;const{vnode:s,parentComponent:n}=e;let a=t.el;for(;!a&&t.component;)t=t.component.subTree,a=t.el;s.el=a,n&&n.subTree===s&&(n.vnode.el=a,pr(n,a))}function Ib(e){const t=e.props&&e.props.suspensible;return t!=null&&t!==!1}const Mt=Symbol.for("v-fgt"),Dn=Symbol.for("v-txt"),xt=Symbol.for("v-cmt"),Jn=Symbol.for("v-stc"),pi=[];let qt=null;function Ai(e=!1){pi.push(qt=e?null:[])}function _p(){pi.pop(),qt=pi[pi.length-1]||null}let Xn=1;function Ri(e,t=!1){Xn+=e,e<0&&qt&&t&&(qt.hasOnce=!0)}function wp(e){return e.dynamicChildren=Xn>0?qt||wa:null,_p(),Xn>0&&qt&&qt.push(e),e}function Ob(e,t,s,n,a,i){return wp(nc(e,t,s,n,a,i,!0))}function Il(e,t,s,n,a){return wp(pt(e,t,s,n,a,!0))}function xn(e){return e?e.__v_isVNode===!0:!1}function Os(e,t){return e.type===t.type&&e.key===t.key}function Lb(e){}const kp=({key:e})=>e??null,hl=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?Pe(e)||Tt(e)||Ie(e)?{i:Ut,r:e,k:t,f:!!s}:e:null);function nc(e,t=null,s=null,n=0,a=null,i=e===Mt?0:1,l=!1,r=!1){const o={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&kp(t),ref:t&&hl(t),scopeId:rr,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:n,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:Ut};return r?(ic(o,s),i&128&&e.normalize(o)):s&&(o.shapeFlag|=Pe(s)?8:16),Xn>0&&!l&&qt&&(o.patchFlag>0||i&6)&&o.patchFlag!==32&&qt.push(o),o}const pt=Nb;function Nb(e,t=null,s=null,n=0,a=null,i=!1){if((!e||e===Qf)&&(e=xt),xn(e)){const r=Ws(e,t,!0);return s&&ic(r,s),Xn>0&&!i&&qt&&(r.shapeFlag&6?qt[qt.indexOf(e)]=r:qt.push(r)),r.patchFlag=-2,r}if(Bb(e)&&(e=e.__vccOpts),t){t=Sp(t);let{class:r,style:o}=t;r&&!Pe(r)&&(t.class=Ui(r)),Xe(o)&&(Bi(o)&&!ve(o)&&(o=ze({},o)),t.style=$i(o))}const l=Pe(e)?1:Rl(e)?128:Hf(e)?64:Xe(e)?4:Ie(e)?2:0;return nc(e,t,s,n,a,l,i,!0)}function Sp(e){return e?Bi(e)||rp(e)?ze({},e):e:null}function Ws(e,t,s=!1,n=!1){const{props:a,ref:i,patchFlag:l,children:r,transition:o}=e,c=t?Cp(a||{},t):a,d={__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&kp(c),ref:t&&t.ref?s&&i?ve(i)?i.concat(hl(t)):[i,hl(t)]:hl(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:r,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==Mt?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:o,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Ws(e.ssContent),ssFallback:e.ssFallback&&Ws(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return o&&n&&yn(d,o.clone(d)),d}function ac(e=" ",t=0){return pt(Dn,null,e,t)}function Db(e,t){const s=pt(Jn,null,e);return s.staticCount=t,s}function Tp(e="",t=!1){return t?(Ai(),Il(xt,null,e)):pt(xt,null,e)}function rs(e){return e==null||typeof e=="boolean"?pt(xt):ve(e)?pt(Mt,null,e.slice()):xn(e)?an(e):pt(Dn,null,String(e))}function an(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Ws(e)}function ic(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(ve(t))s=16;else if(typeof t=="object")if(n&65){const a=t.default;a&&(a._c&&(a._d=!1),ic(e,a()),a._c&&(a._d=!0));return}else{s=32;const a=t._;!a&&!rp(t)?t._ctx=Ut:a===3&&Ut&&(Ut.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else Ie(t)?(t={default:t,_ctx:Ut},s=32):(t=String(t),n&64?(s=16,t=[ac(t)]):s=8);e.children=t,e.shapeFlag|=s}function Cp(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const a in n)if(a==="class")t.class!==n.class&&(t.class=Ui([t.class,n.class]));else if(a==="style")t.style=$i([t.style,n.style]);else if(na(a)){const i=t[a],l=n[a];l&&i!==l&&!(ve(i)&&i.includes(l))?t[a]=i?[].concat(i,l):l:l==null&&i==null&&!Jl(a)&&(t[a]=l)}else a!==""&&(t[a]=n[a])}return t}function is(e,t,s,n=null){vs(e,t,7,[s,n])}const Mb=tp();let Pb=0;function Ep(e,t,s){const n=e.type,a=(t?t.appContext:e.appContext)||Mb,i={uid:Pb++,vnode:e,type:n,parent:t,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Fo(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(a.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:cp(n,a),emitsOptions:np(n,a),emit:null,emitted:null,propsDefaults:Ge,inheritAttrs:n.inheritAttrs,ctx:Ge,data:Ge,props:Ge,attrs:Ge,slots:Ge,refs:Ge,setupState:Ge,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=ub.bind(null,i),e.ce&&e.ce(i),i}let $t=null;const es=()=>$t||Ut;let Ol,Ra;{const e=tr(),t=(s,n)=>{let a;return(a=e[s])||(a=e[s]=[]),a.push(n),i=>{a.length>1?a.forEach(l=>l(i)):a[0](i)}};Ol=t("__VUE_INSTANCE_SETTERS__",s=>$t=s),Ra=t("__VUE_SSR_SETTERS__",s=>ea=s)}const Ga=e=>{const t=$t;return Ol(e),e.scope.on(),()=>{e.scope.off(),Ol(t)}},Ii=()=>{$t&&$t.scope.off(),Ol(null)};function Ap(e){return e.vnode.shapeFlag&4}let ea=!1;function Rp(e,t=!1,s=!1){t&&Ra(t);const{props:n,children:a}=e.vnode,i=Ap(e);vb(e,n,i,t),_b(e,a,s||t);const l=i?Fb(e,t):void 0;return t&&Ra(!1),l}function Fb(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,io);const{setup:n}=s;if(n){vn();const a=e.setupContext=n.length>1?Lp(e):null,i=Ga(e),l=qa(n,e,0,[e.props,a]),r=Po(l);if(bn(),i(),(r||e.sp)&&!hn(e)&&Wo(e),r){if(l.then(Ii,Ii),t)return l.then(o=>{uo(e,o,t)}).catch(o=>{la(o,e,0)});e.asyncDep=l}else uo(e,l,t)}else Op(e,t)}function uo(e,t,s){Ie(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Xe(t)&&(e.setupState=jo(t)),Op(e,s)}let Ll,fo;function Ip(e){Ll=e,fo=t=>{t.render._rc&&(t.withProxy=new Proxy(t.ctx,jv))}}const $b=()=>!Ll;function Op(e,t,s){const n=e.type;if(!e.render){if(!t&&Ll&&!n.render){const a=n.template||Xo(e).template;if(a){const{isCustomElement:i,compilerOptions:l}=e.appContext.config,{delimiters:r,compilerOptions:o}=n,c=ze(ze({isCustomElement:i,delimiters:r},l),o);n.render=Ll(a,c)}}e.render=n.render||Bt,fo&&fo(e)}{const a=Ga(e);vn();try{nb(e)}finally{bn(),a()}}}const Ub={get(e,t){return zt(e,"get",""),e[t]}};function Lp(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Ub),slots:e.slots,emit:e.emit,expose:t}}function zi(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(jo(Cf(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in fi)return fi[s](e)},has(t,s){return s in t||s in fi}})):e.proxy}function po(e,t=!0){return Ie(e)?e.displayName||e.name:e.name||t&&e.__name}function Bb(e){return Ie(e)&&"__vccOpts"in e}const te=(e,t)=>Gm(e,t,ea);function Da(e,t,s){try{Ri(-1);const n=arguments.length;return n===2?Xe(t)&&!ve(t)?xn(t)?pt(e,null,[t]):pt(e,t):pt(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&xn(s)&&(s=[s]),pt(e,t,s))}finally{Ri(1)}}function Hb(){}function Vb(e,t,s,n){const a=s[n];if(a&&Np(a,e))return a;const i=t();return i.memo=e.slice(),i.cacheIndex=n,s[n]=i}function Np(e,t){const s=e.memo;if(s.length!=t.length)return!1;for(let n=0;n<s.length;n++)if(Dt(s[n],t[n]))return!1;return Xn>0&&qt&&qt.push(e),!0}const Dp="3.5.38",jb=Bt,zb=tv,qb=va,Gb=Mf,Kb={createComponentInstance:Ep,setupComponent:Rp,renderComponentRoot:pl,setCurrentRenderingInstance:Ti,isVNode:xn,normalizeVNode:rs,getComponentPublicInstance:zi,ensureValidVNode:Qo,pushWarningContext:Ym,popWarningContext:Qm},Wb=Kb,Zb=null,Jb=null,Yb=null;/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ho;const xd=typeof window<"u"&&window.trustedTypes;if(xd)try{ho=xd.createPolicy("vue",{createHTML:e=>e})}catch{}const Mp=ho?e=>ho.createHTML(e):e=>e,Qb="http://www.w3.org/2000/svg",Xb="http://www.w3.org/1998/Math/MathML",nn=typeof document<"u"?document:null,_d=nn&&nn.createElement("template"),Pp={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const a=t==="svg"?nn.createElementNS(Qb,e):t==="mathml"?nn.createElementNS(Xb,e):s?nn.createElement(e,{is:s}):nn.createElement(e);return e==="select"&&n&&n.multiple!=null&&a.setAttribute("multiple",n.multiple),a},createText:e=>nn.createTextNode(e),createComment:e=>nn.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>nn.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,a,i){const l=s?s.previousSibling:t.lastChild;if(a&&(a===i||a.nextSibling))for(;t.insertBefore(a.cloneNode(!0),s),!(a===i||!(a=a.nextSibling)););else{_d.innerHTML=Mp(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const r=_d.content;if(n==="svg"||n==="mathml"){const o=r.firstChild;for(;o.firstChild;)r.appendChild(o.firstChild);r.removeChild(o)}t.insertBefore(r,s)}return[l?l.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},Sn="transition",Ja="animation",Ma=Symbol("_vtc"),Fp={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},$p=ze({},Ko,Fp),ey=e=>(e.displayName="Transition",e.props=$p,e),ty=ey((e,{slots:t})=>Da(zf,Up(e),t)),Hn=(e,t=[])=>{ve(e)?e.forEach(s=>s(...t)):e&&e(...t)},wd=e=>e?ve(e)?e.some(t=>t.length>1):e.length>1:!1;function Up(e){const t={};for(const M in e)M in Fp||(t[M]=e[M]);if(e.css===!1)return t;const{name:s="v",type:n,duration:a,enterFromClass:i=`${s}-enter-from`,enterActiveClass:l=`${s}-enter-active`,enterToClass:r=`${s}-enter-to`,appearFromClass:o=i,appearActiveClass:c=l,appearToClass:d=r,leaveFromClass:u=`${s}-leave-from`,leaveActiveClass:f=`${s}-leave-active`,leaveToClass:p=`${s}-leave-to`}=e,g=sy(a),y=g&&g[0],S=g&&g[1],{onBeforeEnter:R,onEnter:v,onEnterCancelled:m,onLeave:x,onLeaveCancelled:w,onBeforeAppear:_=R,onAppear:A=v,onAppearCancelled:T=m}=t,C=(M,N,Z,ne)=>{M._enterCancelled=ne,An(M,N?d:r),An(M,N?c:l),Z&&Z()},L=(M,N)=>{M._isLeaving=!1,An(M,u),An(M,p),An(M,f),N&&N()},H=M=>(N,Z)=>{const ne=M?A:v,F=()=>C(N,M,Z);Hn(ne,[N,F]),kd(()=>{An(N,M?o:i),Bs(N,M?d:r),wd(ne)||Sd(N,n,y,F)})};return ze(t,{onBeforeEnter(M){Hn(R,[M]),Bs(M,i),Bs(M,l)},onBeforeAppear(M){Hn(_,[M]),Bs(M,o),Bs(M,c)},onEnter:H(!1),onAppear:H(!0),onLeave(M,N){M._isLeaving=!0;const Z=()=>L(M,N);Bs(M,u),M._enterCancelled?(Bs(M,f),go(M)):(go(M),Bs(M,f)),kd(()=>{M._isLeaving&&(An(M,u),Bs(M,p),wd(x)||Sd(M,n,S,Z))}),Hn(x,[M,Z])},onEnterCancelled(M){C(M,!1,void 0,!0),Hn(m,[M])},onAppearCancelled(M){C(M,!0,void 0,!0),Hn(T,[M])},onLeaveCancelled(M){L(M),Hn(w,[M])}})}function sy(e){if(e==null)return null;if(Xe(e))return[Mr(e.enter),Mr(e.leave)];{const t=Mr(e);return[t,t]}}function Mr(e){return xl(e)}function Bs(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[Ma]||(e[Ma]=new Set)).add(t)}function An(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[Ma];s&&(s.delete(t),s.size||(e[Ma]=void 0))}function kd(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let ny=0;function Sd(e,t,s,n){const a=e._endId=++ny,i=()=>{a===e._endId&&n()};if(s!=null)return setTimeout(i,s);const{type:l,timeout:r,propCount:o}=Bp(e,t);if(!l)return n();const c=l+"end";let d=0;const u=()=>{e.removeEventListener(c,f),i()},f=p=>{p.target===e&&++d>=o&&u()};setTimeout(()=>{d<o&&u()},r+1),e.addEventListener(c,f)}function Bp(e,t){const s=window.getComputedStyle(e),n=g=>(s[g]||"").split(", "),a=n(`${Sn}Delay`),i=n(`${Sn}Duration`),l=Td(a,i),r=n(`${Ja}Delay`),o=n(`${Ja}Duration`),c=Td(r,o);let d=null,u=0,f=0;t===Sn?l>0&&(d=Sn,u=l,f=i.length):t===Ja?c>0&&(d=Ja,u=c,f=o.length):(u=Math.max(l,c),d=u>0?l>c?Sn:Ja:null,f=d?d===Sn?i.length:o.length:0);const p=d===Sn&&/\b(?:transform|all)(?:,|$)/.test(n(`${Sn}Property`).toString());return{type:d,timeout:u,propCount:f,hasTransform:p}}function Td(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>Cd(s)+Cd(e[n])))}function Cd(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function go(e){return(e?e.ownerDocument:document).body.offsetHeight}function ay(e,t,s){const n=e[Ma];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const Nl=Symbol("_vod"),lc=Symbol("_vsh"),Hp={name:"show",beforeMount(e,{value:t},{transition:s}){e[Nl]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):Ya(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),Ya(e,!0),n.enter(e)):n.leave(e,()=>{Ya(e,!1)}):Ya(e,t))},beforeUnmount(e,{value:t}){Ya(e,t)}};function Ya(e,t){e.style.display=t?e[Nl]:"none",e[lc]=!t}function iy(){Hp.getSSRProps=({value:e})=>{if(!e)return{style:{display:"none"}}}}const Vp=Symbol("");function ly(e){const t=es();if(!t)return;const s=t.ut=(a=e(t.proxy))=>{Array.from(document.querySelectorAll(`[data-v-owner="${t.uid}"]`)).forEach(i=>Dl(i,a))},n=()=>{const a=e(t.proxy);t.ce?Dl(t.ce,a):mo(t.subTree,a),s(a)};Zo(()=>{ki(n)}),Ye(()=>{Xt(n,Bt,{flush:"post"});const a=new MutationObserver(n);a.observe(t.subTree.el.parentNode,{childList:!0}),_t(()=>a.disconnect())})}function mo(e,t){if(e.shapeFlag&128){const s=e.suspense;e=s.activeBranch,s.pendingBranch&&!s.isHydrating&&s.effects.push(()=>{mo(s.activeBranch,t)})}for(;e.component;)e=e.component.subTree;if(e.shapeFlag&1&&e.el)Dl(e.el,t);else if(e.type===Mt)e.children.forEach(s=>mo(s,t));else if(e.type===Jn){let{el:s,anchor:n}=e;for(;s&&(Dl(s,t),s!==n);)s=s.nextSibling}}function Dl(e,t){if(e.nodeType===1){const s=e.style;let n="";for(const a in t){const i=fm(t[a]);s.setProperty(`--${a}`,i),n+=`--${a}: ${i};`}s[Vp]=n}}const ry=/(?:^|;)\s*display\s*:/;function oy(e,t,s){const n=e.style,a=Pe(s);let i=!1;if(s&&!a){if(t)if(Pe(t))for(const l of t.split(";")){const r=l.slice(0,l.indexOf(":")).trim();s[r]==null&&ri(n,r,"")}else for(const l in t)s[l]==null&&ri(n,l,"");for(const l in s){l==="display"&&(i=!0);const r=s[l];r!=null?dy(e,l,!Pe(t)&&t?t[l]:void 0,r)||ri(n,l,r):ri(n,l,"")}}else if(a){if(t!==s){const l=n[Vp];l&&(s+=";"+l),n.cssText=s,i=ry.test(s)}}else t&&e.removeAttribute("style");Nl in e&&(e[Nl]=i?n.display:"",e[lc]&&(n.display="none"))}const Ed=/\s*!important$/;function ri(e,t,s){if(ve(s))s.forEach(n=>ri(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=cy(e,t);Ed.test(s)?e.setProperty(os(n),s.replace(Ed,""),"important"):e[n]=s}}const Ad=["Webkit","Moz","ms"],Pr={};function cy(e,t){const s=Pr[t];if(s)return s;let n=lt(t);if(n!=="filter"&&n in e)return Pr[t]=n;n=ia(n);for(let a=0;a<Ad.length;a++){const i=Ad[a]+n;if(i in e)return Pr[t]=i}return t}function dy(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&Pe(n)&&s===n}const Rd="http://www.w3.org/1999/xlink";function Id(e,t,s,n,a,i=dm(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Rd,t.slice(6,t.length)):e.setAttributeNS(Rd,t,s):s==null||i&&!lf(s)?e.removeAttribute(t):e.setAttribute(t,i?"":Kt(s)?String(s):s)}function Od(e,t,s,n,a){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?Mp(s):s);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const r=i==="OPTION"?e.getAttribute("value")||"":e.value,o=s==null?e.type==="checkbox"?"on":"":String(s);(r!==o||!("_value"in e))&&(e.value=o),s==null&&e.removeAttribute(t),e._value=s;return}let l=!1;if(s===""||s==null){const r=typeof e[t];r==="boolean"?s=lf(s):s==null&&r==="string"?(s="",l=!0):r==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(a||t)}function cn(e,t,s,n){e.addEventListener(t,s,n)}function uy(e,t,s,n){e.removeEventListener(t,s,n)}const Ld=Symbol("_vei");function fy(e,t,s,n,a=null){const i=e[Ld]||(e[Ld]={}),l=i[t];if(n&&l)l.value=n;else{const[r,o]=py(t);if(n){const c=i[t]=my(n,a);cn(e,r,c,o)}else l&&(uy(e,r,l,o),i[t]=void 0)}}const Nd=/(?:Once|Passive|Capture)$/;function py(e){let t;if(Nd.test(e)){t={};let n;for(;n=e.match(Nd);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):os(e.slice(2)),t]}let Fr=0;const hy=Promise.resolve(),gy=()=>Fr||(hy.then(()=>Fr=0),Fr=Date.now());function my(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const a=s.value;if(ve(a)){const i=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{i.call(n),n._stopped=!0};const l=a.slice(),r=[n];for(let o=0;o<l.length&&!n._stopped;o++){const c=l[o];c&&vs(c,t,5,r)}}else vs(a,t,5,[n])};return s.value=e,s.attached=gy(),s}const Dd=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,jp=(e,t,s,n,a,i)=>{const l=a==="svg";t==="class"?ay(e,n,l):t==="style"?oy(e,s,n):na(t)?Jl(t)||fy(e,t,s,n,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):vy(e,t,n,l))?(Od(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Id(e,t,n,l,i,t!=="value")):e._isVueCE&&(by(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!Pe(n)))?Od(e,lt(t),n,i,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Id(e,t,n,l))};function vy(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Dd(t)&&Ie(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const a=e.tagName;if(a==="IMG"||a==="VIDEO"||a==="CANVAS"||a==="SOURCE")return!1}return Dd(t)&&Pe(s)?!1:t in e}function by(e,t){const s=e._def.props;if(!s)return!1;const n=lt(t);return Array.isArray(s)?s.some(a=>lt(a)===n):Object.keys(s).some(a=>lt(a)===n)}const Md={};function zp(e,t,s){let n=Vi(e,t);Yl(n)&&(n=ze({},n,t));class a extends hr{constructor(l){super(n,l,s)}}return a.def=n,a}const yy=((e,t)=>zp(e,t,nh)),xy=typeof HTMLElement<"u"?HTMLElement:class{};class hr extends xy{constructor(t,s={},n=Fl){super(),this._def=t,this._props=s,this._createApp=n,this._isVueCE=!0,this._instance=null,this._app=null,this._nonce=this._def.nonce,this._connected=!1,this._resolved=!1,this._patching=!1,this._dirty=!1,this._numberProps=null,this._styleChildren=new WeakSet,this._styleAnchors=new WeakMap,this._ob=null,this.shadowRoot&&n!==Fl?this._root=this.shadowRoot:t.shadowRoot!==!1?(this.attachShadow(ze({},t.shadowRootOptions,{mode:"open"})),this._root=this.shadowRoot):this._root=this}connectedCallback(){if(!this.isConnected)return;!this.shadowRoot&&!this._resolved&&this._parseSlots(),this._connected=!0;let t=this;for(;t=t&&(t.assignedSlot||t.parentNode||t.host);)if(t instanceof hr){this._parent=t;break}this._instance||(this._resolved?this._mount(this._def):t&&t._pendingResolve?this._pendingResolve=t._pendingResolve.then(()=>{this._pendingResolve=void 0,this._resolveDef()}):this._resolveDef())}_setParent(t=this._parent){t&&(this._instance.parent=t._instance,this._inheritParentContext(t))}_inheritParentContext(t=this._parent){t&&this._app&&Object.setPrototypeOf(this._app._context.provides,t._instance.provides)}disconnectedCallback(){this._connected=!1,Ot(()=>{this._connected||(this._ob&&(this._ob.disconnect(),this._ob=null),this._app&&this._app.unmount(),this._instance&&(this._instance.ce=void 0),this._app=this._instance=null,this._teleportTargets&&(this._teleportTargets.clear(),this._teleportTargets=void 0))})}_processMutations(t){for(const s of t)this._setAttr(s.attributeName)}_resolveDef(){if(this._pendingResolve)return;for(let n=0;n<this.attributes.length;n++)this._setAttr(this.attributes[n].name);this._ob=new MutationObserver(this._processMutations.bind(this)),this._ob.observe(this,{attributes:!0});const t=(n,a=!1)=>{this._resolved=!0,this._pendingResolve=void 0;const{props:i,styles:l}=n;let r;if(i&&!ve(i))for(const o in i){const c=i[o];(c===Number||c&&c.type===Number)&&(o in this._props&&(this._props[o]=xl(this._props[o])),(r||(r=Object.create(null)))[lt(o)]=!0)}this._numberProps=r,this._resolveProps(n),this.shadowRoot&&this._applyStyles(l),this._mount(n)},s=this._def.__asyncLoader;s?this._pendingResolve=s().then(n=>{n.configureApp=this._def.configureApp,t(this._def=n,!0)}):t(this._def)}_mount(t){this._app=this._createApp(t),this._inheritParentContext(),t.configureApp&&t.configureApp(this._app),this._app._ceVNode=this._createVNode(),this._app.mount(this._root);const s=this._instance&&this._instance.exposed;if(s)for(const n in s)et(this,n)||Object.defineProperty(this,n,{get:()=>Gs(s[n])})}_resolveProps(t){const{props:s}=t,n=ve(s)?s:Object.keys(s||{});for(const a of Object.keys(this))a[0]!=="_"&&n.includes(a)&&this._setProp(a,this[a]);for(const a of n.map(lt))Object.defineProperty(this,a,{get(){return this._getProp(a)},set(i){this._setProp(a,i,!0,!this._patching)}})}_setAttr(t){if(t.startsWith("data-v-"))return;const s=this.hasAttribute(t);let n=s?this.getAttribute(t):Md;const a=lt(t);s&&this._numberProps&&this._numberProps[a]&&(n=xl(n)),this._setProp(a,n,!1,!0)}_getProp(t){return this._props[t]}_setProp(t,s,n=!0,a=!1){if(s!==this._props[t]&&(this._dirty=!0,s===Md?delete this._props[t]:(this._props[t]=s,t==="key"&&this._app&&(this._app._ceVNode.key=s)),a&&this._instance&&this._update(),n)){const i=this._ob;i&&(this._processMutations(i.takeRecords()),i.disconnect()),s===!0?this.setAttribute(os(t),""):typeof s=="string"||typeof s=="number"?this.setAttribute(os(t),s+""):s||this.removeAttribute(os(t)),i&&i.observe(this,{attributes:!0})}}_update(){const t=this._createVNode();this._app&&(t.appContext=this._app._context),sh(t,this._root)}_createVNode(){const t={};this.shadowRoot||(t.onVnodeMounted=t.onVnodeUpdated=this._renderSlots.bind(this));const s=pt(this._def,ze(t,this._props));return this._instance||(s.ce=n=>{this._instance=n,n.ce=this,n.isCE=!0;const a=(i,l)=>{this.dispatchEvent(new CustomEvent(i,Yl(l[0])?ze({detail:l},l[0]):{detail:l}))};n.emit=(i,...l)=>{a(i,l),os(i)!==i&&a(os(i),l)},this._setParent()}),s}_applyStyles(t,s,n){if(!t)return;if(s){if(s===this._def||this._styleChildren.has(s))return;this._styleChildren.add(s)}const a=this._nonce,i=this.shadowRoot,l=n?this._getStyleAnchor(n)||this._getStyleAnchor(this._def):this._getRootStyleInsertionAnchor(i);let r=null;for(let o=t.length-1;o>=0;o--){const c=document.createElement("style");a&&c.setAttribute("nonce",a),c.textContent=t[o],i.insertBefore(c,r||l),r=c,o===0&&(n||this._styleAnchors.set(this._def,c),s&&this._styleAnchors.set(s,c))}}_getStyleAnchor(t){if(!t)return null;const s=this._styleAnchors.get(t);return s&&s.parentNode===this.shadowRoot?s:(s&&this._styleAnchors.delete(t),null)}_getRootStyleInsertionAnchor(t){for(let s=0;s<t.childNodes.length;s++){const n=t.childNodes[s];if(!(n instanceof HTMLStyleElement))return n}return null}_parseSlots(){const t=this._slots={};let s;for(;s=this.firstChild;){const n=s.nodeType===1&&s.getAttribute("slot")||"default";(t[n]||(t[n]=[])).push(s),this.removeChild(s)}}_renderSlots(){const t=this._getSlots(),s=this._instance.type.__scopeId;for(let n=0;n<t.length;n++){const a=t[n],i=a.getAttribute("name")||"default",l=this._slots[i],r=a.parentNode;if(l)for(const o of l){if(s&&o.nodeType===1){const c=s+"-s",d=document.createTreeWalker(o,1);o.setAttribute(c,"");let u;for(;u=d.nextNode();)u.setAttribute(c,"")}r.insertBefore(o,a)}else for(;a.firstChild;)r.insertBefore(a.firstChild,a);r.removeChild(a)}}_getSlots(){const t=[this];this._teleportTargets&&t.push(...this._teleportTargets);const s=new Set;for(const n of t){const a=n.querySelectorAll("slot");for(let i=0;i<a.length;i++)s.add(a[i])}return Array.from(s)}_injectChildStyle(t,s){this._applyStyles(t.styles,t,s)}_beginPatch(){this._patching=!0,this._dirty=!1}_endPatch(){this._patching=!1,this._dirty&&this._instance&&this._update()}_hasShadowRoot(){return this._def.shadowRoot!==!1}_removeChildStyle(t){}}function qp(e){const t=es(),s=t&&t.ce;return s||null}function _y(){const e=qp();return e&&e.shadowRoot}function wy(e="$style"){{const t=es();if(!t)return Ge;const s=t.type.__cssModules;if(!s)return Ge;const n=s[e];return n||Ge}}const Gp=new WeakMap,Kp=new WeakMap,Ml=Symbol("_moveCb"),Pd=Symbol("_enterCb"),ky=e=>(delete e.props.mode,e),Sy=ky({name:"TransitionGroup",props:ze({},$p,{tag:String,moveClass:String}),setup(e,{slots:t}){const s=es(),n=Go();let a,i;return dr(()=>{if(!a.length)return;const l=e.moveClass||`${e.name||"v"}-move`;if(!Ry(a[0].el,s.vnode.el,l)){a=[];return}a.forEach(Cy),a.forEach(Ey);const r=a.filter(Ay);go(s.vnode.el),r.forEach(o=>{const c=o.el,d=c.style;Bs(c,l),d.transform=d.webkitTransform=d.transitionDuration="";const u=c[Ml]=f=>{f&&f.target!==c||(!f||f.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",u),c[Ml]=null,An(c,l))};c.addEventListener("transitionend",u)}),a=[]}),()=>{const l=Je(e),r=Up(l);let o=l.tag||Mt;if(a=[],i)for(let c=0;c<i.length;c++){const d=i[c];d.el&&d.el instanceof Element&&!d.el[lc]&&(a.push(d),yn(d,Na(d,r,n,s)),Gp.set(d,Wp(d.el)))}i=t.default?or(t.default()):[];for(let c=0;c<i.length;c++){const d=i[c];d.key!=null&&yn(d,Na(d,r,n,s))}return pt(o,null,i)}}}),Ty=Sy;function Cy(e){const t=e.el;t[Ml]&&t[Ml](),t[Pd]&&t[Pd]()}function Ey(e){Kp.set(e,Wp(e.el))}function Ay(e){const t=Gp.get(e),s=Kp.get(e),n=t.left-s.left,a=t.top-s.top;if(n||a){const i=e.el,l=i.style,r=i.getBoundingClientRect();let o=1,c=1;return i.offsetWidth&&(o=r.width/i.offsetWidth),i.offsetHeight&&(c=r.height/i.offsetHeight),(!Number.isFinite(o)||o===0)&&(o=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(o-1)<.01&&(o=1),Math.abs(c-1)<.01&&(c=1),l.transform=l.webkitTransform=`translate(${n/o}px,${a/c}px)`,l.transitionDuration="0s",e}}function Wp(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function Ry(e,t,s){const n=e.cloneNode(),a=e[Ma];a&&a.forEach(r=>{r.split(/\s+/).forEach(o=>o&&n.classList.remove(o))}),s.split(/\s+/).forEach(r=>r&&n.classList.add(r)),n.style.display="none";const i=t.nodeType===1?t:t.parentNode;i.appendChild(n);const{hasTransform:l}=Bp(n);return i.removeChild(n),l}const Pn=e=>{const t=e.props["onUpdate:modelValue"]||!1;return ve(t)?s=>Ta(t,s):t};function Iy(e){e.target.composing=!0}function Fd(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const Cs=Symbol("_assign");function $d(e,t,s){return t&&(e=e.trim()),s&&(e=er(e)),e}const Pl={created(e,{modifiers:{lazy:t,trim:s,number:n}},a){e[Cs]=Pn(a);const i=n||a.props&&a.props.type==="number";cn(e,t?"change":"input",l=>{l.target.composing||e[Cs]($d(e.value,s,i))}),(s||i)&&cn(e,"change",()=>{e.value=$d(e.value,s,i)}),t||(cn(e,"compositionstart",Iy),cn(e,"compositionend",Fd),cn(e,"change",Fd))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:n,trim:a,number:i}},l){if(e[Cs]=Pn(l),e.composing)return;const r=(i||e.type==="number")&&!/^0\d/.test(e.value)?er(e.value):e.value,o=t??"";if(r===o)return;const c=e.getRootNode();(c instanceof Document||c instanceof ShadowRoot)&&c.activeElement===e&&e.type!=="range"&&(n&&t===s||a&&e.value.trim()===o)||(e.value=o)}},rc={deep:!0,created(e,t,s){e[Cs]=Pn(s),cn(e,"change",()=>{const n=e._modelValue,a=Pa(e),i=e.checked,l=e[Cs];if(ve(n)){const r=sr(n,a),o=r!==-1;if(i&&!o)l(n.concat(a));else if(!i&&o){const c=[...n];c.splice(r,1),l(c)}}else if(aa(n)){const r=new Set(n);i?r.add(a):r.delete(a),l(r)}else l(Jp(e,i))})},mounted:Ud,beforeUpdate(e,t,s){e[Cs]=Pn(s),Ud(e,t,s)}};function Ud(e,{value:t,oldValue:s},n){e._modelValue=t;let a;if(ve(t))a=sr(t,n.props.value)>-1;else if(aa(t))a=t.has(n.props.value);else{if(t===s)return;a=mn(t,Jp(e,!0))}e.checked!==a&&(e.checked=a)}const oc={created(e,{value:t},s){e.checked=mn(t,s.props.value),e[Cs]=Pn(s),cn(e,"change",()=>{e[Cs](Pa(e))})},beforeUpdate(e,{value:t,oldValue:s},n){e[Cs]=Pn(n),t!==s&&(e.checked=mn(t,n.props.value))}},Zp={deep:!0,created(e,{value:t,modifiers:{number:s}},n){const a=aa(t);cn(e,"change",()=>{const i=Array.prototype.filter.call(e.options,l=>l.selected).map(l=>s?er(Pa(l)):Pa(l));e[Cs](e.multiple?a?new Set(i):i:i[0]),e._assigning=!0,Ot(()=>{e._assigning=!1})}),e[Cs]=Pn(n)},mounted(e,{value:t}){Bd(e,t)},beforeUpdate(e,t,s){e[Cs]=Pn(s)},updated(e,{value:t}){e._assigning||Bd(e,t)}};function Bd(e,t){const s=e.multiple,n=ve(t);if(!(s&&!n&&!aa(t))){for(let a=0,i=e.options.length;a<i;a++){const l=e.options[a],r=Pa(l);if(s)if(n){const o=typeof r;o==="string"||o==="number"?l.selected=t.some(c=>String(c)===String(r)):l.selected=sr(t,r)>-1}else l.selected=t.has(r);else if(mn(Pa(l),t)){e.selectedIndex!==a&&(e.selectedIndex=a);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function Pa(e){return"_value"in e?e._value:e.value}function Jp(e,t){const s=t?"_trueValue":"_falseValue";return s in e?e[s]:t}const Yp={created(e,t,s){rl(e,t,s,null,"created")},mounted(e,t,s){rl(e,t,s,null,"mounted")},beforeUpdate(e,t,s,n){rl(e,t,s,n,"beforeUpdate")},updated(e,t,s,n){rl(e,t,s,n,"updated")}};function Qp(e,t){switch(e){case"SELECT":return Zp;case"TEXTAREA":return Pl;default:switch(t){case"checkbox":return rc;case"radio":return oc;default:return Pl}}}function rl(e,t,s,n,a){const l=Qp(e.tagName,s.props&&s.props.type)[a];l&&l(e,t,s,n)}function Oy(){Pl.getSSRProps=({value:e})=>({value:e}),oc.getSSRProps=({value:e},t)=>{if(t.props&&mn(t.props.value,e))return{checked:!0}},rc.getSSRProps=({value:e},t)=>{if(ve(e)){if(t.props&&sr(e,t.props.value)>-1)return{checked:!0}}else if(aa(e)){if(t.props&&e.has(t.props.value))return{checked:!0}}else if(e)return{checked:!0}},Yp.getSSRProps=(e,t)=>{if(typeof t.type!="string")return;const s=Qp(t.type.toUpperCase(),t.props&&t.props.type);if(s.getSSRProps)return s.getSSRProps(e,t)}}const Ly=["ctrl","shift","alt","meta"],Ny={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>Ly.some(s=>e[`${s}Key`]&&!t.includes(s))},Dy=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((a,...i)=>{for(let l=0;l<t.length;l++){const r=Ny[t[l]];if(r&&r(a,t))return}return e(a,...i)}))},My={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},Py=(e,t)=>{const s=e._withKeys||(e._withKeys={}),n=t.join(".");return s[n]||(s[n]=(a=>{if(!("key"in a))return;const i=os(a.key);if(t.some(l=>l===i||My[l]===i))return e(a)}))},Xp=ze({patchProp:jp},Pp);let hi,Hd=!1;function eh(){return hi||(hi=pp(Xp))}function th(){return hi=Hd?hi:hp(Xp),Hd=!0,hi}const sh=((...e)=>{eh().render(...e)}),Fy=((...e)=>{th().hydrate(...e)}),Fl=((...e)=>{const t=eh().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=ih(n);if(!a)return;const i=t._component;!Ie(i)&&!i.render&&!i.template&&(i.template=a.innerHTML),a.nodeType===1&&(a.textContent="");const l=s(a,!1,ah(a));return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),l},t}),nh=((...e)=>{const t=th().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=ih(n);if(a)return s(a,!0,ah(a))},t});function ah(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function ih(e){return Pe(e)?document.querySelector(e):e}let Vd=!1;const $y=()=>{Vd||(Vd=!0,Oy(),iy())},Uy=Object.freeze(Object.defineProperty({__proto__:null,BaseTransition:zf,BaseTransitionPropsValidators:Ko,Comment:xt,DeprecationTypes:Yb,EffectScope:Fo,ErrorCodes:ev,ErrorTypeStrings:zb,Fragment:Mt,KeepAlive:Nv,ReactiveEffect:xi,Static:Jn,Suspense:Tb,Teleport:gv,Text:Dn,TrackOpTypes:Km,Transition:ty,TransitionGroup:Ty,TriggerOpTypes:Wm,VueElement:hr,assertNumber:Xm,callWithAsyncErrorHandling:vs,callWithErrorHandling:qa,camelize:lt,capitalize:ia,cloneVNode:Ws,compatUtils:Jb,computed:te,createApp:Fl,createBlock:Il,createCommentVNode:Tp,createElementBlock:Ob,createElementVNode:nc,createHydrationRenderer:hp,createPropsRestProxy:tb,createRenderer:pp,createSSRApp:nh,createSlots:Bv,createStaticVNode:Db,createTextVNode:ac,createVNode:pt,customRef:Af,defineAsyncComponent:Ov,defineComponent:Vi,defineCustomElement:zp,defineEmits:qv,defineExpose:Gv,defineModel:Zv,defineOptions:Kv,defineProps:zv,defineSSRCustomElement:yy,defineSlots:Wv,devtools:qb,effect:mm,effectScope:pm,getCurrentInstance:es,getCurrentScope:df,getCurrentWatcher:Zm,getTransitionRawChildren:or,guardReactiveProps:Sp,h:Da,handleError:la,hasInjectionContext:ov,hydrate:Fy,hydrateOnIdle:Tv,hydrateOnInteraction:Rv,hydrateOnMediaQuery:Av,hydrateOnVisible:Ev,initCustomFormatter:Hb,initDirectivesForSSR:$y,inject:Ts,isMemoSame:Np,isProxy:Bi,isReactive:pn,isReadonly:Ks,isRef:Tt,isRuntimeOnly:$b,isShallow:ds,isVNode:xn,markRaw:Cf,mergeDefaults:Xv,mergeModels:eb,mergeProps:Cp,nextTick:Ot,nodeOps:Pp,normalizeClass:Ui,normalizeProps:em,normalizeStyle:$i,onActivated:As,onBeforeMount:Kf,onBeforeUnmount:ur,onBeforeUpdate:Zo,onDeactivated:Rs,onErrorCaptured:Yf,onMounted:Ye,onRenderTracked:Jf,onRenderTriggered:Zf,onScopeDispose:hm,onServerPrefetch:Wf,onUnmounted:_t,onUpdated:dr,onWatcherCleanup:If,openBlock:Ai,patchProp:jp,popScopeId:iv,provide:ui,proxyRefs:jo,pushScopeId:av,queuePostFlushCb:ki,reactive:Fn,readonly:wl,ref:h,registerRuntimeCompiler:Ip,render:sh,renderList:Uv,renderSlot:Hv,resolveComponent:Pv,resolveDirective:$v,resolveDynamicComponent:Fv,resolveFilter:Zb,resolveTransitionHooks:Na,setBlockTracking:Ri,setDevtoolsHook:Gb,setTransitionHooks:yn,shallowReactive:Ho,shallowReadonly:Mm,shallowRef:Vo,ssrContextKey:Pf,ssrUtils:Wb,stop:vm,toDisplayString:of,toHandlerKey:Sa,toHandlers:Vv,toRaw:Je,toRef:zm,toRefs:Hm,toValue:$m,transformVNodeArgs:Lb,triggerRef:Fm,unref:Gs,useAttrs:Qv,useCssModule:wy,useCssVars:ly,useHost:qp,useId:vv,useModel:db,useSSRContext:Ff,useShadowRoot:_y,useSlots:Yv,useTemplateRef:bv,useTransitionState:Go,vModelCheckbox:rc,vModelDynamic:Yp,vModelRadio:oc,vModelSelect:Zp,vModelText:Pl,vShow:Hp,version:Dp,warn:jb,watch:Xt,watchEffect:cv,watchPostEffect:dv,watchSyncEffect:$f,withAsyncContext:sb,withCtx:qo,withDefaults:Jv,withDirectives:rv,withKeys:Py,withMemo:Vb,withModifiers:Dy,withScopeId:lv},Symbol.toStringTag,{value:"Module"}));/**
* @vue/compiler-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Oi=Symbol(""),gi=Symbol(""),cc=Symbol(""),$l=Symbol(""),lh=Symbol(""),ta=Symbol(""),rh=Symbol(""),oh=Symbol(""),dc=Symbol(""),uc=Symbol(""),qi=Symbol(""),fc=Symbol(""),ch=Symbol(""),pc=Symbol(""),hc=Symbol(""),gc=Symbol(""),mc=Symbol(""),vc=Symbol(""),bc=Symbol(""),dh=Symbol(""),uh=Symbol(""),gr=Symbol(""),Ul=Symbol(""),yc=Symbol(""),xc=Symbol(""),Li=Symbol(""),Gi=Symbol(""),_c=Symbol(""),vo=Symbol(""),By=Symbol(""),bo=Symbol(""),Bl=Symbol(""),Hy=Symbol(""),Vy=Symbol(""),wc=Symbol(""),jy=Symbol(""),zy=Symbol(""),kc=Symbol(""),fh=Symbol(""),Fa={[Oi]:"Fragment",[gi]:"Teleport",[cc]:"Suspense",[$l]:"KeepAlive",[lh]:"BaseTransition",[ta]:"openBlock",[rh]:"createBlock",[oh]:"createElementBlock",[dc]:"createVNode",[uc]:"createElementVNode",[qi]:"createCommentVNode",[fc]:"createTextVNode",[ch]:"createStaticVNode",[pc]:"resolveComponent",[hc]:"resolveDynamicComponent",[gc]:"resolveDirective",[mc]:"resolveFilter",[vc]:"withDirectives",[bc]:"renderList",[dh]:"renderSlot",[uh]:"createSlots",[gr]:"toDisplayString",[Ul]:"mergeProps",[yc]:"normalizeClass",[xc]:"normalizeStyle",[Li]:"normalizeProps",[Gi]:"guardReactiveProps",[_c]:"toHandlers",[vo]:"camelize",[By]:"capitalize",[bo]:"toHandlerKey",[Bl]:"setBlockTracking",[Hy]:"pushScopeId",[Vy]:"popScopeId",[wc]:"withCtx",[jy]:"unref",[zy]:"isRef",[kc]:"withMemo",[fh]:"isMemoSame"};function qy(e){Object.getOwnPropertySymbols(e).forEach(t=>{Fa[t]=e[t]})}const xs={start:{line:1,column:1,offset:0},end:{line:1,column:1,offset:0},source:""};function Gy(e,t=""){return{type:0,source:t,children:e,helpers:new Set,components:[],directives:[],hoists:[],imports:[],cached:[],temps:0,codegenNode:void 0,loc:xs}}function Ni(e,t,s,n,a,i,l,r=!1,o=!1,c=!1,d=xs){return e&&(r?(e.helper(ta),e.helper(Ba(e.inSSR,c))):e.helper(Ua(e.inSSR,c)),l&&e.helper(vc)),{type:13,tag:t,props:s,children:n,patchFlag:a,dynamicProps:i,directives:l,isBlock:r,disableTracking:o,isComponent:c,loc:d}}function Yn(e,t=xs){return{type:17,loc:t,elements:e}}function Ss(e,t=xs){return{type:15,loc:t,properties:e}}function St(e,t){return{type:16,loc:xs,key:Pe(e)?Ue(e,!0):e,value:t}}function Ue(e,t=!1,s=xs,n=0){return{type:4,loc:s,content:e,isStatic:t,constType:t?3:n}}function Ns(e,t=xs){return{type:8,loc:t,children:e}}function Lt(e,t=[],s=xs){return{type:14,loc:s,callee:e,arguments:t}}function $a(e,t=void 0,s=!1,n=!1,a=xs){return{type:18,params:e,returns:t,newline:s,isSlot:n,loc:a}}function yo(e,t,s,n=!0){return{type:19,test:e,consequent:t,alternate:s,newline:n,loc:xs}}function Ky(e,t,s=!1,n=!1){return{type:20,index:e,value:t,needPauseTracking:s,inVOnce:n,needArraySpread:!1,loc:xs}}function Wy(e){return{type:21,body:e,loc:xs}}function Ua(e,t){return e||t?dc:uc}function Ba(e,t){return e||t?rh:oh}function Sc(e,{helper:t,removeHelper:s,inSSR:n}){e.isBlock||(e.isBlock=!0,s(Ua(n,e.isComponent)),t(ta),t(Ba(n,e.isComponent)))}const jd=new Uint8Array([123,123]),zd=new Uint8Array([125,125]);function qd(e){return e>=97&&e<=122||e>=65&&e<=90}function gs(e){return e===32||e===10||e===9||e===12||e===13}function Tn(e){return e===47||e===62||gs(e)}function Hl(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t}const Ht={Cdata:new Uint8Array([67,68,65,84,65,91]),CdataEnd:new Uint8Array([93,93,62]),CommentEnd:new Uint8Array([45,45,62]),ScriptEnd:new Uint8Array([60,47,115,99,114,105,112,116]),StyleEnd:new Uint8Array([60,47,115,116,121,108,101]),TitleEnd:new Uint8Array([60,47,116,105,116,108,101]),TextareaEnd:new Uint8Array([60,47,116,101,120,116,97,114,101,97])};class Zy{constructor(t,s){this.stack=t,this.cbs=s,this.state=1,this.buffer="",this.sectionStart=0,this.index=0,this.entityStart=0,this.baseState=1,this.inRCDATA=!1,this.inXML=!1,this.inVPre=!1,this.newlines=[],this.mode=0,this.delimiterOpen=jd,this.delimiterClose=zd,this.delimiterIndex=-1,this.currentSequence=void 0,this.sequenceIndex=0}get inSFCRoot(){return this.mode===2&&this.stack.length===0}reset(){this.state=1,this.mode=0,this.buffer="",this.sectionStart=0,this.index=0,this.baseState=1,this.inRCDATA=!1,this.currentSequence=void 0,this.newlines.length=0,this.delimiterOpen=jd,this.delimiterClose=zd}getPos(t){let s=1,n=t+1;const a=this.newlines.length;let i=-1;if(a>100){let l=-1,r=a;for(;l+1<r;){const o=l+r>>>1;this.newlines[o]<t?l=o:r=o}i=l}else for(let l=a-1;l>=0;l--)if(t>this.newlines[l]){i=l;break}return i>=0&&(s=i+2,n=t-this.newlines[i]),{column:n,line:s,offset:t}}peek(){return this.buffer.charCodeAt(this.index+1)}stateText(t){t===60?(this.index>this.sectionStart&&this.cbs.ontext(this.sectionStart,this.index),this.state=5,this.sectionStart=this.index):!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t))}stateInterpolationOpen(t){if(t===this.delimiterOpen[this.delimiterIndex])if(this.delimiterIndex===this.delimiterOpen.length-1){const s=this.index+1-this.delimiterOpen.length;s>this.sectionStart&&this.cbs.ontext(this.sectionStart,s),this.state=3,this.sectionStart=s}else this.delimiterIndex++;else this.inRCDATA?(this.state=32,this.stateInRCDATA(t)):(this.state=1,this.stateText(t))}stateInterpolation(t){t===this.delimiterClose[0]&&(this.state=4,this.delimiterIndex=0,this.stateInterpolationClose(t))}stateInterpolationClose(t){t===this.delimiterClose[this.delimiterIndex]?this.delimiterIndex===this.delimiterClose.length-1?(this.cbs.oninterpolation(this.sectionStart,this.index+1),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):this.delimiterIndex++:(this.state=3,this.stateInterpolation(t))}stateSpecialStartSequence(t){const s=this.sequenceIndex===this.currentSequence.length;if(!(s?Tn(t):(t|32)===this.currentSequence[this.sequenceIndex]))this.inRCDATA=!1;else if(!s){this.sequenceIndex++;return}this.sequenceIndex=0,this.state=6,this.stateInTagName(t)}stateInRCDATA(t){if(this.sequenceIndex===this.currentSequence.length){if(t===62||gs(t)){const s=this.index-this.currentSequence.length;if(this.sectionStart<s){const n=this.index;this.index=s,this.cbs.ontext(this.sectionStart,s),this.index=n}this.sectionStart=s+2,this.stateInClosingTagName(t),this.inRCDATA=!1;return}this.sequenceIndex=0}(t|32)===this.currentSequence[this.sequenceIndex]?this.sequenceIndex+=1:this.sequenceIndex===0?this.currentSequence===Ht.TitleEnd||this.currentSequence===Ht.TextareaEnd&&!this.inSFCRoot?!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t)):this.fastForwardTo(60)&&(this.sequenceIndex=1):this.sequenceIndex=+(t===60)}stateCDATASequence(t){t===Ht.Cdata[this.sequenceIndex]?++this.sequenceIndex===Ht.Cdata.length&&(this.state=28,this.currentSequence=Ht.CdataEnd,this.sequenceIndex=0,this.sectionStart=this.index+1):(this.sequenceIndex=0,this.state=23,this.stateInDeclaration(t))}fastForwardTo(t){for(;++this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);if(s===10&&this.newlines.push(this.index),s===t)return!0}return this.index=this.buffer.length-1,!1}stateInCommentLike(t){t===this.currentSequence[this.sequenceIndex]?++this.sequenceIndex===this.currentSequence.length&&(this.currentSequence===Ht.CdataEnd?this.cbs.oncdata(this.sectionStart,this.index-2):this.cbs.oncomment(this.sectionStart,this.index-2),this.sequenceIndex=0,this.sectionStart=this.index+1,this.state=1):this.sequenceIndex===0?this.fastForwardTo(this.currentSequence[0])&&(this.sequenceIndex=1):t!==this.currentSequence[this.sequenceIndex-1]&&(this.sequenceIndex=0)}startSpecial(t,s){this.enterRCDATA(t,s),this.state=31}enterRCDATA(t,s){this.inRCDATA=!0,this.currentSequence=t,this.sequenceIndex=s}stateBeforeTagName(t){t===33?(this.state=22,this.sectionStart=this.index+1):t===63?(this.state=24,this.sectionStart=this.index+1):qd(t)?(this.sectionStart=this.index,this.mode===0?this.state=6:this.inSFCRoot?this.state=34:this.inXML?this.state=6:t===116?this.state=30:this.state=t===115?29:6):t===47?this.state=8:(this.state=1,this.stateText(t))}stateInTagName(t){Tn(t)&&this.handleTagName(t)}stateInSFCRootTagName(t){if(Tn(t)){const s=this.buffer.slice(this.sectionStart,this.index);s!=="template"&&this.enterRCDATA(Hl("</"+s),0),this.handleTagName(t)}}handleTagName(t){this.cbs.onopentagname(this.sectionStart,this.index),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)}stateBeforeClosingTagName(t){gs(t)||(t===62?(this.state=1,this.sectionStart=this.index+1):(this.state=qd(t)?9:27,this.sectionStart=this.index))}stateInClosingTagName(t){(t===62||gs(t))&&(this.cbs.onclosetag(this.sectionStart,this.index),this.sectionStart=-1,this.state=10,this.stateAfterClosingTagName(t))}stateAfterClosingTagName(t){t===62&&(this.state=1,this.sectionStart=this.index+1)}stateBeforeAttrName(t){t===62?(this.cbs.onopentagend(this.index),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):t===47?this.state=7:t===60&&this.peek()===47?(this.cbs.onopentagend(this.index),this.state=5,this.sectionStart=this.index):gs(t)||this.handleAttrStart(t)}handleAttrStart(t){t===118&&this.peek()===45?(this.state=13,this.sectionStart=this.index):t===46||t===58||t===64||t===35?(this.cbs.ondirname(this.index,this.index+1),this.state=14,this.sectionStart=this.index+1):(this.state=12,this.sectionStart=this.index)}stateInSelfClosingTag(t){t===62?(this.cbs.onselfclosingtag(this.index),this.state=1,this.sectionStart=this.index+1,this.inRCDATA=!1):gs(t)||(this.state=11,this.stateBeforeAttrName(t))}stateInAttrName(t){(t===61||Tn(t))&&(this.cbs.onattribname(this.sectionStart,this.index),this.handleAttrNameEnd(t))}stateInDirName(t){t===61||Tn(t)?(this.cbs.ondirname(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===58?(this.cbs.ondirname(this.sectionStart,this.index),this.state=14,this.sectionStart=this.index+1):t===46&&(this.cbs.ondirname(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDirArg(t){t===61||Tn(t)?(this.cbs.ondirarg(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===91?this.state=15:t===46&&(this.cbs.ondirarg(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDynamicDirArg(t){t===93?this.state=14:(t===61||Tn(t))&&(this.cbs.ondirarg(this.sectionStart,this.index+1),this.handleAttrNameEnd(t))}stateInDirModifier(t){t===61||Tn(t)?(this.cbs.ondirmodifier(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===46&&(this.cbs.ondirmodifier(this.sectionStart,this.index),this.sectionStart=this.index+1)}handleAttrNameEnd(t){this.sectionStart=this.index,this.state=17,this.cbs.onattribnameend(this.index),this.stateAfterAttrName(t)}stateAfterAttrName(t){t===61?this.state=18:t===47||t===62?(this.cbs.onattribend(0,this.sectionStart),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)):gs(t)||(this.cbs.onattribend(0,this.sectionStart),this.handleAttrStart(t))}stateBeforeAttrValue(t){t===34?(this.state=19,this.sectionStart=this.index+1):t===39?(this.state=20,this.sectionStart=this.index+1):gs(t)||(this.sectionStart=this.index,this.state=21,this.stateInAttrValueNoQuotes(t))}handleInAttrValue(t,s){(t===s||this.fastForwardTo(s))&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(s===34?3:2,this.index+1),this.state=11)}stateInAttrValueDoubleQuotes(t){this.handleInAttrValue(t,34)}stateInAttrValueSingleQuotes(t){this.handleInAttrValue(t,39)}stateInAttrValueNoQuotes(t){gs(t)||t===62?(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(1,this.index),this.state=11,this.stateBeforeAttrName(t)):(t===39||t===60||t===61||t===96)&&this.cbs.onerr(18,this.index)}stateBeforeDeclaration(t){t===91?(this.state=26,this.sequenceIndex=0):this.state=t===45?25:23}stateInDeclaration(t){(t===62||this.fastForwardTo(62))&&(this.state=1,this.sectionStart=this.index+1)}stateInProcessingInstruction(t){(t===62||this.fastForwardTo(62))&&(this.cbs.onprocessinginstruction(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeComment(t){t===45?(this.state=28,this.currentSequence=Ht.CommentEnd,this.sequenceIndex=2,this.sectionStart=this.index+1):this.state=23}stateInSpecialComment(t){(t===62||this.fastForwardTo(62))&&(this.cbs.oncomment(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeSpecialS(t){t===Ht.ScriptEnd[3]?this.startSpecial(Ht.ScriptEnd,4):t===Ht.StyleEnd[3]?this.startSpecial(Ht.StyleEnd,4):(this.state=6,this.stateInTagName(t))}stateBeforeSpecialT(t){t===Ht.TitleEnd[3]?this.startSpecial(Ht.TitleEnd,4):t===Ht.TextareaEnd[3]?this.startSpecial(Ht.TextareaEnd,4):(this.state=6,this.stateInTagName(t))}startEntity(){}stateInEntity(){}parse(t){for(this.buffer=t;this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);switch(s===10&&this.state!==33&&this.newlines.push(this.index),this.state){case 1:{this.stateText(s);break}case 2:{this.stateInterpolationOpen(s);break}case 3:{this.stateInterpolation(s);break}case 4:{this.stateInterpolationClose(s);break}case 31:{this.stateSpecialStartSequence(s);break}case 32:{this.stateInRCDATA(s);break}case 26:{this.stateCDATASequence(s);break}case 19:{this.stateInAttrValueDoubleQuotes(s);break}case 12:{this.stateInAttrName(s);break}case 13:{this.stateInDirName(s);break}case 14:{this.stateInDirArg(s);break}case 15:{this.stateInDynamicDirArg(s);break}case 16:{this.stateInDirModifier(s);break}case 28:{this.stateInCommentLike(s);break}case 27:{this.stateInSpecialComment(s);break}case 11:{this.stateBeforeAttrName(s);break}case 6:{this.stateInTagName(s);break}case 34:{this.stateInSFCRootTagName(s);break}case 9:{this.stateInClosingTagName(s);break}case 5:{this.stateBeforeTagName(s);break}case 17:{this.stateAfterAttrName(s);break}case 20:{this.stateInAttrValueSingleQuotes(s);break}case 18:{this.stateBeforeAttrValue(s);break}case 8:{this.stateBeforeClosingTagName(s);break}case 10:{this.stateAfterClosingTagName(s);break}case 29:{this.stateBeforeSpecialS(s);break}case 30:{this.stateBeforeSpecialT(s);break}case 21:{this.stateInAttrValueNoQuotes(s);break}case 7:{this.stateInSelfClosingTag(s);break}case 23:{this.stateInDeclaration(s);break}case 22:{this.stateBeforeDeclaration(s);break}case 25:{this.stateBeforeComment(s);break}case 24:{this.stateInProcessingInstruction(s);break}case 33:{this.stateInEntity();break}}this.index++}this.cleanup(),this.finish()}cleanup(){this.sectionStart!==this.index&&(this.state===1||this.state===32&&this.sequenceIndex===0?(this.cbs.ontext(this.sectionStart,this.index),this.sectionStart=this.index):(this.state===19||this.state===20||this.state===21)&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=this.index))}finish(){this.handleTrailingData(),this.cbs.onend()}handleTrailingData(){const t=this.buffer.length;this.sectionStart>=t||(this.state===28?this.currentSequence===Ht.CdataEnd?this.cbs.oncdata(this.sectionStart,t):this.cbs.oncomment(this.sectionStart,t):this.state===6||this.state===11||this.state===18||this.state===17||this.state===12||this.state===13||this.state===14||this.state===15||this.state===16||this.state===20||this.state===19||this.state===21||this.state===9||this.cbs.ontext(this.sectionStart,t))}emitCodePoint(t,s){}}function Gd(e,{compatConfig:t}){const s=t&&t[e];return e==="MODE"?s||3:s}function Qn(e,t){const s=Gd("MODE",t),n=Gd(e,t);return s===3?n===!0:n!==!1}function Di(e,t,s,...n){return Qn(e,t)}function Tc(e){throw e}function ph(e){}function ft(e,t,s,n){const a=`https://vuejs.org/error-reference/#compiler-${e}`,i=new SyntaxError(String(a));return i.code=e,i.loc=t,i}const cs=e=>e.type===4&&e.isStatic;function hh(e){switch(e){case"Teleport":case"teleport":return gi;case"Suspense":case"suspense":return cc;case"KeepAlive":case"keep-alive":return $l;case"BaseTransition":case"base-transition":return lh}}const Jy=/^$|^\d|[^\$\w\xA0-\uFFFF]/,Cc=e=>!Jy.test(e),gh=/[A-Za-z_$\xA0-\uFFFF]/,Yy=/[\.\?\w$\xA0-\uFFFF]/,Qy=/\s+[.[]\s*|\s*[.[]\s+/g,mh=e=>e.type===4?e.content:e.loc.source,Xy=e=>{const t=mh(e).trim().replace(Qy,r=>r.trim());let s=0,n=[],a=0,i=0,l=null;for(let r=0;r<t.length;r++){const o=t.charAt(r);switch(s){case 0:if(o==="[")n.push(s),s=1,a++;else if(o==="(")n.push(s),s=2,i++;else if(!(r===0?gh:Yy).test(o))return!1;break;case 1:o==="'"||o==='"'||o==="`"?(n.push(s),s=3,l=o):o==="["?a++:o==="]"&&(--a||(s=n.pop()));break;case 2:if(o==="'"||o==='"'||o==="`")n.push(s),s=3,l=o;else if(o==="(")i++;else if(o===")"){if(r===t.length-1)return!1;--i||(s=n.pop())}break;case 3:o===l&&(s=n.pop(),l=null);break}}return!a&&!i},vh=Xy,ex=/^\s*(?:async\s*)?(?:\([^)]*?\)|[\w$_]+)\s*(?::[^=]+)?=>|^\s*(?:async\s+)?function(?:\s+[\w$]+)?\s*\(/,tx=e=>ex.test(mh(e)),sx=tx;function ks(e,t,s=!1){for(let n=0;n<e.props.length;n++){const a=e.props[n];if(a.type===7&&(s||a.exp)&&(Pe(t)?a.name===t:t.test(a.name)))return a}}function mr(e,t,s=!1,n=!1){for(let a=0;a<e.props.length;a++){const i=e.props[a];if(i.type===6){if(s)continue;if(i.name===t&&(i.value||n))return i}else if(i.name==="bind"&&(i.exp||n)&&qn(i.arg,t))return i}}function qn(e,t){return!!(e&&cs(e)&&e.content===t)}function nx(e){return e.props.some(t=>t.type===7&&t.name==="bind"&&(!t.arg||t.arg.type!==4||!t.arg.isStatic))}function $r(e){return e.type===5||e.type===2}function Kd(e){return e.type===7&&e.name==="pre"}function ax(e){return e.type===7&&e.name==="slot"}function Vl(e){return e.type===1&&e.tagType===3}function jl(e){return e.type===1&&e.tagType===2}const ix=new Set([Li,Gi]);function bh(e,t=[]){if(e&&!Pe(e)&&e.type===14){const s=e.callee;if(!Pe(s)&&ix.has(s))return bh(e.arguments[0],t.concat(e))}return[e,t]}function zl(e,t,s){let n,a=e.type===13?e.props:e.arguments[2],i=[],l;if(a&&!Pe(a)&&a.type===14){const r=bh(a);a=r[0],i=r[1],l=i[i.length-1]}if(a==null||Pe(a))n=Ss([t]);else if(a.type===14){const r=a.arguments[0];!Pe(r)&&r.type===15?Wd(t,r)||r.properties.unshift(t):a.callee===_c?n=Lt(s.helper(Ul),[Ss([t]),a]):a.arguments.unshift(Ss([t])),!n&&(n=a)}else a.type===15?(Wd(t,a)||a.properties.unshift(t),n=a):(n=Lt(s.helper(Ul),[Ss([t]),a]),l&&l.callee===Gi&&(l=i[i.length-2]));e.type===13?l?l.arguments[0]=n:e.props=n:l?l.arguments[0]=n:e.arguments[2]=n}function Wd(e,t){let s=!1;if(e.key.type===4){const n=e.key.content;s=t.properties.some(a=>a.key.type===4&&a.key.content===n)}return s}function Mi(e,t){return`_${t}_${e.replace(/[^\w]/g,(s,n)=>s==="-"?"_":e.charCodeAt(n).toString())}`}function lx(e){return e.type===14&&e.callee===kc?e.arguments[1].returns:e}const rx=/([\s\S]*?)\s+(?:in|of)\s+(\S[\s\S]*)/;function yh(e){for(let t=0;t<e.length;t++)if(!gs(e.charCodeAt(t)))return!1;return!0}function Ec(e){return e.type===2&&yh(e.content)||e.type===12&&Ec(e.content)}function xh(e){return e.type===3||Ec(e)}const _h={parseMode:"base",ns:0,delimiters:["{{","}}"],getNamespace:()=>0,isVoidTag:xa,isPreTag:xa,isIgnoreNewlineTag:xa,isCustomElement:xa,onError:Tc,onWarn:ph,comments:!1,prefixIdentifiers:!1};let Qe=_h,Pi=null,gn="",jt=null,We=null,as="",sn=-1,jn=-1,Ac=0,Ln=!1,xo=null;const ut=[],vt=new Zy(ut,{onerr:Xs,ontext(e,t){ol(Ft(e,t),e,t)},ontextentity(e,t,s){ol(e,t,s)},oninterpolation(e,t){if(Ln)return ol(Ft(e,t),e,t);let s=e+vt.delimiterOpen.length,n=t-vt.delimiterClose.length;for(;gs(gn.charCodeAt(s));)s++;for(;gs(gn.charCodeAt(n-1));)n--;let a=Ft(s,n);a.includes("&")&&(a=Qe.decodeEntities(a,!1)),_o({type:5,content:ml(a,!1,yt(s,n)),loc:yt(e,t)})},onopentagname(e,t){const s=Ft(e,t);jt={type:1,tag:s,ns:Qe.getNamespace(s,ut[0],Qe.ns),tagType:0,props:[],children:[],loc:yt(e-1,t),codegenNode:void 0}},onopentagend(e){Jd(e)},onclosetag(e,t){const s=Ft(e,t);if(!Qe.isVoidTag(s)){let n=!1;for(let a=0;a<ut.length;a++)if(ut[a].tag.toLowerCase()===s.toLowerCase()){n=!0,a>0&&Xs(24,ut[0].loc.start.offset);for(let l=0;l<=a;l++){const r=ut.shift();gl(r,t,l<a)}break}n||Xs(23,wh(e,60))}},onselfclosingtag(e){const t=jt.tag;jt.isSelfClosing=!0,Jd(e),ut[0]&&ut[0].tag===t&&gl(ut.shift(),e)},onattribname(e,t){We={type:6,name:Ft(e,t),nameLoc:yt(e,t),value:void 0,loc:yt(e)}},ondirname(e,t){const s=Ft(e,t),n=s==="."||s===":"?"bind":s==="@"?"on":s==="#"?"slot":s.slice(2);if(!Ln&&n===""&&Xs(26,e),Ln||n==="")We={type:6,name:s,nameLoc:yt(e,t),value:void 0,loc:yt(e)};else if(We={type:7,name:n,rawName:s,exp:void 0,arg:void 0,modifiers:s==="."?[Ue("prop")]:[],loc:yt(e)},n==="pre"){Ln=vt.inVPre=!0,xo=jt;const a=jt.props;for(let i=0;i<a.length;i++)a[i].type===7&&(a[i]=vx(a[i]))}},ondirarg(e,t){if(e===t)return;const s=Ft(e,t);if(Ln&&!Kd(We))We.name+=s,Gn(We.nameLoc,t);else{const n=s[0]!=="[";We.arg=ml(n?s:s.slice(1,-1),n,yt(e,t),n?3:0)}},ondirmodifier(e,t){const s=Ft(e,t);if(Ln&&!Kd(We))We.name+="."+s,Gn(We.nameLoc,t);else if(We.name==="slot"){const n=We.arg;n&&(n.content+="."+s,Gn(n.loc,t))}else{const n=Ue(s,!0,yt(e,t));We.modifiers.push(n)}},onattribdata(e,t){as+=Ft(e,t),sn<0&&(sn=e),jn=t},onattribentity(e,t,s){as+=e,sn<0&&(sn=t),jn=s},onattribnameend(e){const t=We.loc.start.offset,s=Ft(t,e);We.type===7&&(We.rawName=s),jt.props.some(n=>(n.type===7?n.rawName:n.name)===s)&&Xs(2,t)},onattribend(e,t){if(jt&&We){if(Gn(We.loc,t),e!==0)if(as.includes("&")&&(as=Qe.decodeEntities(as,!0)),We.type===6)We.name==="class"&&(as=Sh(as).trim()),e===1&&!as&&Xs(13,t),We.value={type:2,content:as,loc:e===1?yt(sn,jn):yt(sn-1,jn+1)},vt.inSFCRoot&&jt.tag==="template"&&We.name==="lang"&&as&&as!=="html"&&vt.enterRCDATA(Hl("</template"),0);else{let s=0;We.exp=ml(as,!1,yt(sn,jn),0,s),We.name==="for"&&(We.forParseResult=cx(We.exp));let n=-1;We.name==="bind"&&(n=We.modifiers.findIndex(a=>a.content==="sync"))>-1&&Di("COMPILER_V_BIND_SYNC",Qe,We.loc,We.arg.loc.source)&&(We.name="model",We.modifiers.splice(n,1))}(We.type!==7||We.name!=="pre")&&jt.props.push(We)}as="",sn=jn=-1},oncomment(e,t){Qe.comments&&_o({type:3,content:Ft(e,t),loc:yt(e-4,t+3)})},onend(){const e=gn.length;for(let t=0;t<ut.length;t++)gl(ut[t],e-1),Xs(24,ut[t].loc.start.offset)},oncdata(e,t){(ut[0]?ut[0].ns:Qe.ns)!==0?ol(Ft(e,t),e,t):Xs(1,e-9)},onprocessinginstruction(e){(ut[0]?ut[0].ns:Qe.ns)===0&&Xs(21,e-1)}}),Zd=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,ox=/^\(|\)$/g;function cx(e){const t=e.loc,s=e.content,n=s.match(rx);if(!n)return;const[,a,i]=n,l=(u,f,p=!1)=>{const g=t.start.offset+f,y=g+u.length;return ml(u,!1,yt(g,y),0,p?1:0)},r={source:l(i.trim(),s.indexOf(i,a.length)),value:void 0,key:void 0,index:void 0,finalized:!1};let o=a.trim().replace(ox,"").trim();const c=a.indexOf(o),d=o.match(Zd);if(d){o=o.replace(Zd,"").trim();const u=d[1].trim();let f;if(u&&(f=s.indexOf(u,c+o.length),r.key=l(u,f,!0)),d[2]){const p=d[2].trim();p&&(r.index=l(p,s.indexOf(p,r.key?f+u.length:c+o.length),!0))}}return o&&(r.value=l(o,c,!0)),r}function Ft(e,t){return gn.slice(e,t)}function Jd(e){vt.inSFCRoot&&(jt.innerLoc=yt(e+1,e+1)),_o(jt);const{tag:t,ns:s}=jt;s===0&&Qe.isPreTag(t)&&Ac++,Qe.isVoidTag(t)?gl(jt,e):(ut.unshift(jt),(s===1||s===2)&&(vt.inXML=!0)),jt=null}function ol(e,t,s){{const i=ut[0]&&ut[0].tag;i!=="script"&&i!=="style"&&e.includes("&")&&(e=Qe.decodeEntities(e,!1))}const n=ut[0]||Pi,a=n.children[n.children.length-1];a&&a.type===2?(a.content+=e,Gn(a.loc,s)):n.children.push({type:2,content:e,loc:yt(t,s)})}function gl(e,t,s=!1){s?Gn(e.loc,wh(t,60)):Gn(e.loc,dx(t,62)+1),vt.inSFCRoot&&(e.children.length?e.innerLoc.end=ze({},e.children[e.children.length-1].loc.end):e.innerLoc.end=ze({},e.innerLoc.start),e.innerLoc.source=Ft(e.innerLoc.start.offset,e.innerLoc.end.offset));const{tag:n,ns:a,children:i}=e;if(Ln||(n==="slot"?e.tagType=2:Yd(e)?e.tagType=3:fx(e)&&(e.tagType=1)),vt.inRCDATA||(e.children=kh(i)),a===0&&Qe.isIgnoreNewlineTag(n)){const l=i[0];l&&l.type===2&&(l.content=l.content.replace(/^\r?\n/,""))}a===0&&Qe.isPreTag(n)&&Ac--,xo===e&&(Ln=vt.inVPre=!1,xo=null),vt.inXML&&(ut[0]?ut[0].ns:Qe.ns)===0&&(vt.inXML=!1);{const l=e.props;if(!vt.inSFCRoot&&Qn("COMPILER_NATIVE_TEMPLATE",Qe)&&e.tag==="template"&&!Yd(e)){const o=ut[0]||Pi,c=o.children.indexOf(e);o.children.splice(c,1,...e.children)}const r=l.find(o=>o.type===6&&o.name==="inline-template");r&&Di("COMPILER_INLINE_TEMPLATE",Qe,r.loc)&&e.children.length&&(r.value={type:2,content:Ft(e.children[0].loc.start.offset,e.children[e.children.length-1].loc.end.offset),loc:r.loc})}}function dx(e,t){let s=e;for(;gn.charCodeAt(s)!==t&&s<gn.length-1;)s++;return s}function wh(e,t){let s=e;for(;gn.charCodeAt(s)!==t&&s>=0;)s--;return s}const ux=new Set(["if","else","else-if","for","slot"]);function Yd({tag:e,props:t}){if(e==="template"){for(let s=0;s<t.length;s++)if(t[s].type===7&&ux.has(t[s].name))return!0}return!1}function fx({tag:e,props:t}){if(Qe.isCustomElement(e))return!1;if(e==="component"||px(e.charCodeAt(0))||hh(e)||Qe.isBuiltInComponent&&Qe.isBuiltInComponent(e)||Qe.isNativeTag&&!Qe.isNativeTag(e))return!0;for(let s=0;s<t.length;s++){const n=t[s];if(n.type===6){if(n.name==="is"&&n.value){if(n.value.content.startsWith("vue:"))return!0;if(Di("COMPILER_IS_ON_ELEMENT",Qe,n.loc))return!0}}else if(n.name==="bind"&&qn(n.arg,"is")&&Di("COMPILER_IS_ON_ELEMENT",Qe,n.loc))return!0}return!1}function px(e){return e>64&&e<91}const hx=/\r\n/g;function kh(e){const t=Qe.whitespace!=="preserve";let s=!1;for(let n=0;n<e.length;n++){const a=e[n];if(a.type===2)if(Ac)a.content=a.content.replace(hx,`
`);else if(yh(a.content)){const i=e[n-1]&&e[n-1].type,l=e[n+1]&&e[n+1].type;!i||!l||t&&(i===3&&(l===3||l===1)||i===1&&(l===3||l===1&&gx(a.content)))?(s=!0,e[n]=null):a.content=" "}else t&&(a.content=Sh(a.content))}return s?e.filter(Boolean):e}function gx(e){for(let t=0;t<e.length;t++){const s=e.charCodeAt(t);if(s===10||s===13)return!0}return!1}function Sh(e){let t="",s=!1;for(let n=0;n<e.length;n++)gs(e.charCodeAt(n))?s||(t+=" ",s=!0):(t+=e[n],s=!1);return t}function _o(e){(ut[0]||Pi).children.push(e)}function yt(e,t){return{start:vt.getPos(e),end:t==null?t:vt.getPos(t),source:t==null?t:Ft(e,t)}}function mx(e){return yt(e.start.offset,e.end.offset)}function Gn(e,t){e.end=vt.getPos(t),e.source=Ft(e.start.offset,t)}function vx(e){const t={type:6,name:e.rawName,nameLoc:yt(e.loc.start.offset,e.loc.start.offset+e.rawName.length),value:void 0,loc:e.loc};if(e.exp){const s=e.exp.loc;s.end.offset<e.loc.end.offset&&(s.start.offset--,s.start.column--,s.end.offset++,s.end.column++),t.value={type:2,content:e.exp.content,loc:s}}return t}function ml(e,t=!1,s,n=0,a=0){return Ue(e,t,s,n)}function Xs(e,t,s){Qe.onError(ft(e,yt(t,t)))}function bx(){vt.reset(),jt=null,We=null,as="",sn=-1,jn=-1,ut.length=0}function yx(e,t){if(bx(),gn=e,Qe=ze({},_h),t){let a;for(a in t)t[a]!=null&&(Qe[a]=t[a])}vt.mode=Qe.parseMode==="html"?1:Qe.parseMode==="sfc"?2:0,vt.inXML=Qe.ns===1||Qe.ns===2;const s=t&&t.delimiters;s&&(vt.delimiterOpen=Hl(s[0]),vt.delimiterClose=Hl(s[1]));const n=Pi=Gy([],e);return vt.parse(gn),n.loc=yt(0,e.length),n.children=kh(n.children),Pi=null,n}function xx(e,t){vl(e,void 0,t,!!Th(e))}function Th(e){const t=e.children.filter(s=>s.type!==3);return t.length===1&&t[0].type===1&&!jl(t[0])?t[0]:null}function vl(e,t,s,n=!1,a=!1){const{children:i}=e,l=[];for(let d=0;d<i.length;d++){const u=i[d];if(u.type===1&&u.tagType===0){const f=n?0:ms(u,s);if(f>0){if(f>=2){u.codegenNode.patchFlag=-1,l.push(u);continue}}else{const p=u.codegenNode;if(p.type===13){const g=p.patchFlag;if((g===void 0||g===512||g===1)&&Eh(u,s)>=2){const y=Ah(u);y&&(p.props=s.hoist(y))}p.dynamicProps&&(p.dynamicProps=s.hoist(p.dynamicProps))}}}else if(u.type===12&&(n?0:ms(u,s))>=2){u.codegenNode.type===14&&u.codegenNode.arguments.length>0&&u.codegenNode.arguments.push("-1"),l.push(u);continue}if(u.type===1){const f=u.tagType===1;f&&s.scopes.vSlot++,vl(u,e,s,!1,a),f&&s.scopes.vSlot--}else if(u.type===11)vl(u,e,s,u.children.length===1,!0);else if(u.type===9)for(let f=0;f<u.branches.length;f++)vl(u.branches[f],e,s,u.branches[f].children.length===1,a)}let r=!1;if(l.length===i.length&&e.type===1){if(e.tagType===0&&e.codegenNode&&e.codegenNode.type===13&&ve(e.codegenNode.children))e.codegenNode.children=o(Yn(e.codegenNode.children)),r=!0;else if(e.tagType===1&&e.codegenNode&&e.codegenNode.type===13&&e.codegenNode.children&&!ve(e.codegenNode.children)&&e.codegenNode.children.type===15){const d=c(e.codegenNode,"default");d&&(d.returns=o(Yn(d.returns)),r=!0)}else if(e.tagType===3&&t&&t.type===1&&t.tagType===1&&t.codegenNode&&t.codegenNode.type===13&&t.codegenNode.children&&!ve(t.codegenNode.children)&&t.codegenNode.children.type===15){const d=ks(e,"slot",!0),u=d&&d.arg&&c(t.codegenNode,d.arg);u&&(u.returns=o(Yn(u.returns)),r=!0)}}if(!r)for(const d of l)d.codegenNode=s.cache(d.codegenNode);function o(d){const u=s.cache(d);return u.needArraySpread=!0,u}function c(d,u){if(d.children&&!ve(d.children)&&d.children.type===15){const f=d.children.properties.find(p=>p.key===u||p.key.content===u);return f&&f.value}}l.length&&s.transformHoist&&s.transformHoist(i,s,e)}function ms(e,t){const{constantCache:s}=t;switch(e.type){case 1:if(e.tagType!==0)return 0;const n=s.get(e);if(n!==void 0)return n;const a=e.codegenNode;if(a.type!==13||a.isBlock&&e.tag!=="svg"&&e.tag!=="foreignObject"&&e.tag!=="math")return 0;if(a.patchFlag===void 0){let l=3;const r=Eh(e,t);if(r===0)return s.set(e,0),0;r<l&&(l=r);for(let o=0;o<e.children.length;o++){const c=ms(e.children[o],t);if(c===0)return s.set(e,0),0;c<l&&(l=c)}if(l>1)for(let o=0;o<e.props.length;o++){const c=e.props[o];if(c.type===7&&c.name==="bind"&&c.exp){const d=ms(c.exp,t);if(d===0)return s.set(e,0),0;d<l&&(l=d)}}if(a.isBlock){for(let o=0;o<e.props.length;o++)if(e.props[o].type===7)return s.set(e,0),0;t.removeHelper(ta),t.removeHelper(Ba(t.inSSR,a.isComponent)),a.isBlock=!1,t.helper(Ua(t.inSSR,a.isComponent))}return s.set(e,l),l}else return s.set(e,0),0;case 2:case 3:return 3;case 9:case 11:case 10:return 0;case 5:case 12:return ms(e.content,t);case 4:return e.constType;case 8:let i=3;for(let l=0;l<e.children.length;l++){const r=e.children[l];if(Pe(r)||Kt(r))continue;const o=ms(r,t);if(o===0)return 0;o<i&&(i=o)}return i;case 20:return 2;default:return 0}}const _x=new Set([yc,xc,Li,Gi]);function Ch(e,t){if(e.type===14&&!Pe(e.callee)&&_x.has(e.callee)){const s=e.arguments[0];if(s.type===4)return ms(s,t);if(s.type===14)return Ch(s,t)}return 0}function Eh(e,t){let s=3;const n=Ah(e);if(n&&n.type===15){const{properties:a}=n;for(let i=0;i<a.length;i++){const{key:l,value:r}=a[i],o=ms(l,t);if(o===0)return o;o<s&&(s=o);let c;if(r.type===4?c=ms(r,t):r.type===14?c=Ch(r,t):c=0,c===0)return c;c<s&&(s=c)}}return s}function Ah(e){const t=e.codegenNode;if(t.type===13)return t.props}function wx(e,{filename:t="",prefixIdentifiers:s=!1,hoistStatic:n=!1,hmr:a=!1,cacheHandlers:i=!1,nodeTransforms:l=[],directiveTransforms:r={},transformHoist:o=null,isBuiltInComponent:c=Bt,isCustomElement:d=Bt,expressionPlugins:u=[],scopeId:f=null,slotted:p=!0,ssr:g=!1,inSSR:y=!1,ssrCssVars:S="",bindingMetadata:R=Ge,inline:v=!1,isTS:m=!1,onError:x=Tc,onWarn:w=ph,compatConfig:_}){const A=t.replace(/\?.*$/,"").match(/([^/\\]+)\.\w+$/),T={filename:t,selfName:A&&ia(lt(A[1])),prefixIdentifiers:s,hoistStatic:n,hmr:a,cacheHandlers:i,nodeTransforms:l,directiveTransforms:r,transformHoist:o,isBuiltInComponent:c,isCustomElement:d,expressionPlugins:u,scopeId:f,slotted:p,ssr:g,inSSR:y,ssrCssVars:S,bindingMetadata:R,inline:v,isTS:m,onError:x,onWarn:w,compatConfig:_,root:e,helpers:new Map,components:new Set,directives:new Set,hoists:[],imports:[],cached:[],constantCache:new WeakMap,vForMemoKeyedNodes:new WeakSet,temps:0,identifiers:Object.create(null),scopes:{vFor:0,vSlot:0,vPre:0,vOnce:0},parent:null,grandParent:null,currentNode:e,childIndex:0,inVOnce:!1,helper(C){const L=T.helpers.get(C)||0;return T.helpers.set(C,L+1),C},removeHelper(C){const L=T.helpers.get(C);if(L){const H=L-1;H?T.helpers.set(C,H):T.helpers.delete(C)}},helperString(C){return`_${Fa[T.helper(C)]}`},replaceNode(C){T.parent.children[T.childIndex]=T.currentNode=C},removeNode(C){const L=T.parent.children,H=C?L.indexOf(C):T.currentNode?T.childIndex:-1;!C||C===T.currentNode?(T.currentNode=null,T.onNodeRemoved()):T.childIndex>H&&(T.childIndex--,T.onNodeRemoved()),T.parent.children.splice(H,1)},onNodeRemoved:Bt,addIdentifiers(C){},removeIdentifiers(C){},hoist(C){Pe(C)&&(C=Ue(C)),T.hoists.push(C);const L=Ue(`_hoisted_${T.hoists.length}`,!1,C.loc,2);return L.hoisted=C,L},cache(C,L=!1,H=!1){const M=Ky(T.cached.length,C,L,H);return T.cached.push(M),M}};return T.filters=new Set,T}function kx(e,t){const s=wx(e,t);vr(e,s),t.hoistStatic&&xx(e,s),t.ssr||Sx(e,s),e.helpers=new Set([...s.helpers.keys()]),e.components=[...s.components],e.directives=[...s.directives],e.imports=s.imports,e.hoists=s.hoists,e.temps=s.temps,e.cached=s.cached,e.transformed=!0,e.filters=[...s.filters]}function Sx(e,t){const{helper:s}=t,{children:n}=e;if(n.length===1){const a=Th(e);if(a&&a.codegenNode){const i=a.codegenNode;i.type===13&&Sc(i,t),e.codegenNode=i}else e.codegenNode=n[0]}else if(n.length>1){let a=64;e.codegenNode=Ni(t,s(Oi),void 0,e.children,a,void 0,void 0,!0,void 0,!1)}}function Tx(e,t){let s=0;const n=()=>{s--};for(;s<e.children.length;s++){const a=e.children[s];Pe(a)||(t.grandParent=t.parent,t.parent=e,t.childIndex=s,t.onNodeRemoved=n,vr(a,t))}}function vr(e,t){t.currentNode=e;const{nodeTransforms:s}=t,n=[];for(let i=0;i<s.length;i++){const l=s[i](e,t);if(l&&(ve(l)?n.push(...l):n.push(l)),t.currentNode)e=t.currentNode;else return}switch(e.type){case 3:t.ssr||t.helper(qi);break;case 5:t.ssr||t.helper(gr);break;case 9:for(let i=0;i<e.branches.length;i++)vr(e.branches[i],t);break;case 10:case 11:case 1:case 0:Tx(e,t);break}t.currentNode=e;let a=n.length;for(;a--;)n[a]()}function Rh(e,t){const s=Pe(e)?n=>n===e:n=>e.test(n);return(n,a)=>{if(n.type===1){const{props:i}=n;if(n.tagType===3&&i.some(ax))return;const l=[];for(let r=0;r<i.length;r++){const o=i[r];if(o.type===7&&s(o.name)){i.splice(r,1),r--;const c=t(n,o,a);c&&l.push(c)}}return l}}}const br="/*@__PURE__*/",Ih=e=>`${Fa[e]}: _${Fa[e]}`;function Cx(e,{mode:t="function",prefixIdentifiers:s=t==="module",sourceMap:n=!1,filename:a="template.vue.html",scopeId:i=null,optimizeImports:l=!1,runtimeGlobalName:r="Vue",runtimeModuleName:o="vue",ssrRuntimeModuleName:c="vue/server-renderer",ssr:d=!1,isTS:u=!1,inSSR:f=!1}){const p={mode:t,prefixIdentifiers:s,sourceMap:n,filename:a,scopeId:i,optimizeImports:l,runtimeGlobalName:r,runtimeModuleName:o,ssrRuntimeModuleName:c,ssr:d,isTS:u,inSSR:f,source:e.source,code:"",column:1,line:1,offset:0,indentLevel:0,pure:!1,map:void 0,helper(y){return`_${Fa[y]}`},push(y,S=-2,R){p.code+=y},indent(){g(++p.indentLevel)},deindent(y=!1){y?--p.indentLevel:g(--p.indentLevel)},newline(){g(p.indentLevel)}};function g(y){p.push(`
...
`,-1),e.hoists.length)){const u=[dc,uc,qi,fc,ch].filter(f=>d.includes(f)).map(Ih).join(", ");a(`const { ${u} } = _Vue
`,-1)}Rx(e.hoists,t),i(),a("return ")}function Ur(e,t,{helper:s,push:n,newline:a,isTS:i}){const l=s(t==="filter"?mc:t==="component"?pc:gc);for(let r=0;r<e.length;r++){let o=e[r];const c=o.endsWith("__self");c&&(o=o.slice(0,-6)),n(`const ${Mi(o,t)} = ${l}(${JSON.stringify(o)}${c?", true":""})${i?"!":""}`),r<e.length-1&&a()}}function Rx(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:n}=t;n();for(let a=0;a<e.length;a++){const i=e[a];i&&(s(`const _hoisted_${a+1} = `),Gt(i,t),n())}t.pure=!1}function Rc(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),Ki(e,t,s),s&&t.deindent(),t.push("]")}function Ki(e,t,s=!1,n=!0){const{push:a,newline:i}=t;for(let l=0;l<e.length;l++){const r=e[l];Pe(r)?a(r,-3):ve(r)?Rc(r,t):Gt(r,t),l<e.length-1&&(s?(n&&a(","),i()):n&&a(", "))}}function Gt(e,t){if(Pe(e)){t.push(e,-3);return}if(Kt(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:Gt(e.codegenNode,t);break;case 2:Ix(e,t);break;case 4:Oh(e,t);break;case 5:Ox(e,t);break;case 12:Gt(e.codegenNode,t);break;case 8:Lh(e,t);break;case 3:Nx(e,t);break;case 13:Dx(e,t);break;case 14:Px(e,t);break;case 15:Fx(e,t);break;case 17:$x(e,t);break;case 18:Ux(e,t);break;case 19:Bx(e,t);break;case 20:Hx(e,t);break;case 21:Ki(e.body,t,!0,!1);break}}function Ix(e,t){t.push(JSON.stringify(e.content),-3,e)}function Oh(e,t){const{content:s,isStatic:n}=e;t.push(n?JSON.stringify(s):s,-3,e)}function Ox(e,t){const{push:s,helper:n,pure:a}=t;a&&s(br),s(`${n(gr)}(`),Gt(e.content,t),s(")")}function Lh(e,t){for(let s=0;s<e.children.length;s++){const n=e.children[s];Pe(n)?t.push(n,-3):Gt(n,t)}}function Lx(e,t){const{push:s}=t;if(e.type===8)s("["),Lh(e,t),s("]");else if(e.isStatic){const n=Cc(e.content)?e.content:JSON.stringify(e.content);s(n,-2,e)}else s(`[${e.content}]`,-3,e)}function Nx(e,t){const{push:s,helper:n,pure:a}=t;a&&s(br),s(`${n(qi)}(${JSON.stringify(e.content)})`,-3,e)}function Dx(e,t){const{push:s,helper:n,pure:a}=t,{tag:i,props:l,children:r,patchFlag:o,dynamicProps:c,directives:d,isBlock:u,disableTracking:f,isComponent:p}=e;let g;o&&(g=String(o)),d&&s(n(vc)+"("),u&&s(`(${n(ta)}(${f?"true":""}), `),a&&s(br);const y=u?Ba(t.inSSR,p):Ua(t.inSSR,p);s(n(y)+"(",-2,e),Ki(Mx([i,l,r,g,c]),t),s(")"),u&&s(")"),d&&(s(", "),Gt(d,t),s(")"))}function Mx(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function Px(e,t){const{push:s,helper:n,pure:a}=t,i=Pe(e.callee)?e.callee:n(e.callee);a&&s(br),s(i+"(",-2,e),Ki(e.arguments,t),s(")")}function Fx(e,t){const{push:s,indent:n,deindent:a,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const r=l.length>1||!1;s(r?"{":"{ "),r&&n();for(let o=0;o<l.length;o++){const{key:c,value:d}=l[o];Lx(c,t),s(": "),Gt(d,t),o<l.length-1&&(s(","),i())}r&&a(),s(r?"}":" }")}function $x(e,t){Rc(e.elements,t)}function Ux(e,t){const{push:s,indent:n,deindent:a}=t,{params:i,returns:l,body:r,newline:o,isSlot:c}=e;c&&s(`_${Fa[wc]}(`),s("(",-2,e),ve(i)?Ki(i,t):i&&Gt(i,t),s(") => "),(o||r)&&(s("{"),n()),l?(o&&s("return "),ve(l)?Rc(l,t):Gt(l,t)):r&&Gt(r,t),(o||r)&&(a(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function Bx(e,t){const{test:s,consequent:n,alternate:a,newline:i}=e,{push:l,indent:r,deindent:o,newline:c}=t;if(s.type===4){const u=!Cc(s.content);u&&l("("),Oh(s,t),u&&l(")")}else l("("),Gt(s,t),l(")");i&&r(),t.indentLevel++,i||l(" "),l("? "),Gt(n,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const d=a.type===19;d||t.indentLevel++,Gt(a,t),d||t.indentLevel--,i&&o(!0)}function Hx(e,t){const{push:s,helper:n,indent:a,deindent:i,newline:l}=t,{needPauseTracking:r,needArraySpread:o}=e;o&&s("[...("),s(`_cache[${e.index}] || (`),r&&(a(),s(`${n(Bl)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),Gt(e.value,t),r&&(s(`).cacheIndex = ${e.index},`),l(),s(`${n(Bl)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),o&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const Vx=Rh(/^(?:if|else|else-if)$/,(e,t,s)=>jx(e,t,s,(n,a,i)=>{const l=s.parent.children;let r=l.indexOf(n),o=0;for(;r-->=0;){const c=l[r];c&&c.type===9&&(o+=c.branches.length)}return()=>{if(i)n.codegenNode=Xd(a,o,s);else{const c=zx(n.codegenNode);c.alternate=Xd(a,o+n.branches.length-1,s)}}}));function jx(e,t,s,n){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const a=t.exp?t.exp.loc:e.loc;s.onError(ft(28,t.loc)),t.exp=Ue("true",!1,a)}if(t.name==="if"){const a=Qd(e,t),i={type:9,loc:mx(e.loc),branches:[a]};if(s.replaceNode(i),n)return n(i,a,!0)}else{const a=s.parent.children;let i=a.indexOf(e);for(;i-->=-1;){const l=a[i];if(l&&xh(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(ft(30,e.loc)),s.removeNode();const r=Qd(e,t);l.branches.push(r);const o=n&&n(l,r,!1);vr(r,s),o&&o(),s.currentNode=null}else s.onError(ft(30,e.loc));break}}}function Qd(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!ks(e,"for")?e.children:[e],userKey:mr(e,"key"),isTemplateIf:s}}function Xd(e,t,s){return e.condition?yo(e.condition,eu(e,t,s),Lt(s.helper(qi),['""',"true"])):eu(e,t,s)}function eu(e,t,s){const{helper:n}=s,a=St("key",Ue(`${t}`,!1,xs,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const o=l.codegenNode;return zl(o,a,s),o}else return Ni(s,n(Oi),Ss([a]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const o=l.codegenNode,c=lx(o);return c.type===13&&Sc(c,s),zl(c,a,s),o}}function zx(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const qx=Rh("for",(e,t,s)=>{const{helper:n,removeHelper:a}=s;return Gx(e,t,s,i=>{const l=Lt(n(bc),[i.source]),r=Vl(e),o=ks(e,"memo"),c=mr(e,"key",!1,!0);c&&c.type;let d=c&&(c.type===6?c.value?Ue(c.value.content,!0):void 0:c.exp);const u=d?St("key",d):null,f=i.source.type===4&&i.source.constType>0,p=f?64:c?128:256;return i.codegenNode=Ni(s,n(Oi),void 0,l,p,void 0,void 0,!0,!f,!1,e.loc),()=>{let g;const{children:y}=i,S=y.length!==1||y[0].type!==1,R=jl(e)?e:r&&e.children.length===1&&jl(e.children[0])?e.children[0]:null;if(R?(g=R.codegenNode,r&&u&&zl(g,u,s)):S?g=Ni(s,n(Oi),u?Ss([u]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(g=y[0].codegenNode,r&&u&&zl(g,u,s),g.isBlock!==!f&&(g.isBlock?(a(ta),a(Ba(s.inSSR,g.isComponent))):a(Ua(s.inSSR,g.isComponent))),g.isBlock=!f,g.isBlock?(n(ta),n(Ba(s.inSSR,g.isComponent))):n(Ua(s.inSSR,g.isComponent))),o){const v=$a(wo(i.parseResult,[Ue("_cached")]));v.body=Wy([Ns(["const _memo = (",o.exp,")"]),Ns(["if (_cached && _cached.el",...d?[" && _cached.key === ",d]:[],` && ${s.helperString(fh)}(_cached, _memo)) return _cached`]),Ns(["const _item = ",g]),Ue("_item.memo = _memo"),Ue("return _item")]),l.arguments.push(v,Ue("_cache"),Ue(String(s.cached.length))),s.cached.push(null)}else l.arguments.push($a(wo(i.parseResult),g,!0))}})});function Gx(e,t,s,n){if(!t.exp){s.onError(ft(31,t.loc));return}const a=t.forParseResult;if(!a){s.onError(ft(32,t.loc));return}Nh(a);const{addIdentifiers:i,removeIdentifiers:l,scopes:r}=s,{source:o,value:c,key:d,index:u}=a,f={type:11,loc:t.loc,source:o,valueAlias:c,keyAlias:d,objectIndexAlias:u,parseResult:a,children:Vl(e)?e.children:[e]};s.replaceNode(f),r.vFor++;const p=n&&n(f);return()=>{r.vFor--,p&&p()}}function Nh(e,t){e.finalized||(e.finalized=!0)}function wo({value:e,key:t,index:s},n=[]){return Kx([e,t,s,...n])}function Kx(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,n)=>s||Ue("_".repeat(n+1),!1))}const tu=Ue("undefined",!1),Wx=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=ks(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},Zx=(e,t,s,n)=>$a(e,s,!1,!0,s.length?s[0].loc:n);function Jx(e,t,s=Zx){t.helper(wc);const{children:n,loc:a}=e,i=[],l=[];let r=t.scopes.vSlot>0||t.scopes.vFor>0;const o=ks(e,"slot",!0);if(o){const{arg:S,exp:R}=o;S&&!cs(S)&&(r=!0),i.push(St(S||Ue("default",!0),s(R,void 0,n,a)))}let c=!1,d=!1;const u=[],f=new Set;let p=0;for(let S=0;S<n.length;S++){const R=n[S];let v;if(!Vl(R)||!(v=ks(R,"slot",!0))){R.type!==3&&u.push(R);continue}if(o){t.onError(ft(37,v.loc));break}c=!0;const{children:m,loc:x}=R,{arg:w=Ue("default",!0),exp:_,loc:A}=v;let T;cs(w)?T=w?w.content:"default":r=!0;const C=ks(R,"for"),L=s(_,C,m,x);let H,M;if(H=ks(R,"if"))r=!0,l.push(yo(H.exp,cl(w,L,p++),tu));else if(M=ks(R,/^else(?:-if)?$/,!0)){let N=S,Z;for(;N--&&(Z=n[N],!!xh(Z)););if(Z&&Vl(Z)&&ks(Z,/^(?:else-)?if$/)){let ne=l[l.length-1];for(;ne.alternate.type===19;)ne=ne.alternate;ne.alternate=M.exp?yo(M.exp,cl(w,L,p++),tu):cl(w,L,p++)}else t.onError(ft(30,M.loc))}else if(C){r=!0;const N=C.forParseResult;N?(Nh(N),l.push(Lt(t.helper(bc),[N.source,$a(wo(N),cl(w,L),!0)]))):t.onError(ft(32,C.loc))}else{if(T){if(f.has(T)){t.onError(ft(38,A));continue}f.add(T),T==="default"&&(d=!0)}i.push(St(w,L))}}if(!o){const S=(R,v)=>{const m=s(R,void 0,v,a);return t.compatConfig&&(m.isNonScopedSlot=!0),St("default",m)};c?u.length&&!u.every(Ec)&&(d?t.onError(ft(39,u[0].loc)):i.push(S(void 0,u))):i.push(S(void 0,n))}const g=r?2:bl(e.children)?3:1;let y=Ss(i.concat(St("_",Ue(g+"",!1))),a);return l.length&&(y=Lt(t.helper(uh),[y,Yn(l)])),{slots:y,hasDynamicSlots:r}}function cl(e,t,s){const n=[St("name",e),St("fn",t)];return s!=null&&n.push(St("key",Ue(String(s),!0))),Ss(n)}function bl(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||bl(s.children))return!0;break;case 9:if(bl(s.branches))return!0;break;case 10:case 11:if(bl(s.children))return!0;break}}return!1}const Dh=new WeakMap,Yx=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:n,props:a}=e,i=e.tagType===1;let l=i?Qx(e,t):`"${n}"`;const r=Xe(l)&&l.callee===hc;let o,c,d=0,u,f,p,g=r||l===gi||l===cc||!i&&(n==="svg"||n==="foreignObject"||n==="math");if(a.length>0){const y=Mh(e,t,void 0,i,r);o=y.props,d=y.patchFlag,f=y.dynamicPropNames;const S=y.directives;p=S&&S.length?Yn(S.map(R=>e0(R,t))):void 0,y.shouldUseBlock&&(g=!0)}if(e.children.length>0)if(l===$l&&(g=!0,d|=1024),i&&l!==gi&&l!==$l){const{slots:S,hasDynamicSlots:R}=Jx(e,t);c=S,R&&(d|=1024)}else if(e.children.length===1&&l!==gi){const S=e.children[0],R=S.type,v=R===5||R===8;v&&ms(S,t)===0&&(d|=1),v||R===2?c=S:c=e.children}else c=e.children;f&&f.length&&(u=t0(f)),e.codegenNode=Ni(t,l,o,c,d===0?void 0:d,u,p,!!g,!1,i,e.loc)};function Qx(e,t,s=!1){let{tag:n}=e;const a=ko(n),i=mr(e,"is",!1,!0);if(i)if(a||Qn("COMPILER_IS_ON_ELEMENT",t)){let r;if(i.type===6?r=i.value&&Ue(i.value.content,!0):(r=i.exp,r||(r=Ue("is",!1,i.arg.loc))),r)return Lt(t.helper(hc),[r])}else i.type===6&&i.value.content.startsWith("vue:")&&(n=i.value.content.slice(4));const l=hh(n)||t.isBuiltInComponent(n);return l?(s||t.helper(l),l):(t.helper(pc),t.components.add(n),Mi(n,"component"))}function Mh(e,t,s=e.props,n,a,i=!1){const{tag:l,loc:r,children:o}=e;let c=[];const d=[],u=[],f=o.length>0;let p=!1,g=0,y=!1,S=!1,R=!1,v=!1,m=!1,x=!1;const w=[],_=L=>{c.length&&(d.push(Ss(su(c),r)),c=[]),L&&d.push(L)},A=()=>{t.scopes.vFor>0&&c.push(St(Ue("ref_for",!0),Ue("true")))},T=({key:L,value:H})=>{if(cs(L)){const M=L.content,N=na(M);if(N&&(!n||a)&&M.toLowerCase()!=="onclick"&&M!=="onUpdate:modelValue"&&!fn(M)&&(v=!0),N&&fn(M)&&(x=!0),N&&H.type===14&&(H=H.arguments[0]),H.type===20||(H.type===4||H.type===8)&&ms(H,t)>0)return;M==="ref"?y=!0:M==="class"?S=!0:M==="style"?R=!0:M!=="key"&&!w.includes(M)&&w.push(M),n&&(M==="class"||M==="style")&&!w.includes(M)&&w.push(M)}else m=!0};for(let L=0;L<s.length;L++){const H=s[L];if(H.type===6){const{loc:M,name:N,nameLoc:Z,value:ne}=H;let F=!0;if(N==="ref"&&(y=!0,A()),N==="is"&&(ko(l)||ne&&ne.content.startsWith("vue:")||Qn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(St(Ue(N,!0,Z),Ue(ne?ne.content:"",F,ne?ne.loc:M)))}else{const{name:M,arg:N,exp:Z,loc:ne,modifiers:F}=H,O=M==="bind",E=M==="on";if(M==="slot"){n||t.onError(ft(40,ne));continue}if(M==="once"||M==="memo"||M==="is"||O&&qn(N,"is")&&(ko(l)||Qn("COMPILER_IS_ON_ELEMENT",t))||E&&i)continue;if((O&&qn(N,"key")||E&&f&&qn(N,"vue:before-update"))&&(p=!0),O&&qn(N,"ref")&&A(),!N&&(O||E)){if(m=!0,Z)if(O){if(_(),Qn("COMPILER_V_BIND_OBJECT_ORDER",t)){d.unshift(Z);continue}A(),_(),d.push(Z)}else _({type:14,loc:ne,callee:t.helper(_c),arguments:n?[Z]:[Z,"true"]});else t.onError(ft(O?34:35,ne));continue}O&&F.some(K=>K.content==="prop")&&(g|=32);const q=t.directiveTransforms[M];if(q){const{props:K,needRuntime:ee}=q(H,e,t);!i&&K.forEach(T),E&&N&&!cs(N)?_(Ss(K,r)):c.push(...K),ee&&(u.push(H),Kt(ee)&&Dh.set(H,ee))}else qg(M)||(u.push(H),f&&(p=!0))}}let C;if(d.length?(_(),d.length>1?C=Lt(t.helper(Ul),d,r):C=d[0]):c.length&&(C=Ss(su(c),r)),m?g|=16:(S&&!n&&(g|=2),R&&!n&&(g|=4),w.length&&(g|=8),v&&(g|=32)),!p&&(g===0||g===32)&&(y||x||u.length>0)&&(g|=512),!t.inSSR&&C)switch(C.type){case 15:let L=-1,H=-1,M=!1;for(let ne=0;ne<C.properties.length;ne++){const F=C.properties[ne].key;cs(F)?F.content==="class"?L=ne:F.content==="style"&&(H=ne):F.isHandlerKey||(M=!0)}const N=C.properties[L],Z=C.properties[H];M?C=Lt(t.helper(Li),[C]):(N&&!cs(N.value)&&(N.value=Lt(t.helper(yc),[N.value])),Z&&(R||Z.value.type===4&&Z.value.content.trim()[0]==="["||Z.value.type===17)&&(Z.value=Lt(t.helper(xc),[Z.value])));break;case 14:break;default:C=Lt(t.helper(Li),[Lt(t.helper(Gi),[C])]);break}return{props:C,directives:u,patchFlag:g,dynamicPropNames:w,shouldUseBlock:p}}function su(e){const t=new Map,s=[];for(let n=0;n<e.length;n++){const a=e[n];if(a.key.type===8||!a.key.isStatic){s.push(a);continue}const i=a.key.content,l=t.get(i);l?(i==="style"||i==="class"||na(i))&&Xx(l,a):(t.set(i,a),s.push(a))}return s}function Xx(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Yn([e.value,t.value],e.loc)}function e0(e,t){const s=[],n=Dh.get(e);n?s.push(t.helperString(n)):(t.helper(gc),t.directives.add(e.name),s.push(Mi(e.name,"directive")));const{loc:a}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=Ue("true",!1,a);s.push(Ss(e.modifiers.map(l=>St(l,i)),a))}return Yn(s,e.loc)}function t0(e){let t="[";for(let s=0,n=e.length;s<n;s++)t+=JSON.stringify(e[s]),s<n-1&&(t+=", ");return t+"]"}function ko(e){return e==="component"||e==="Component"}const s0=(e,t)=>{if(jl(e)){const{children:s,loc:n}=e,{slotName:a,slotProps:i}=n0(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",a,"{}","undefined","true"];let r=2;i&&(l[2]=i,r=3),s.length&&(l[3]=$a([],s,!1,!1,n),r=4),t.scopeId&&!t.slotted&&(r=5),l.splice(r),e.codegenNode=Lt(t.helper(dh),l,n)}};function n0(e,t){let s='"default"',n;const a=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=lt(l.name),a.push(l)));else if(l.name==="bind"&&qn(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const r=lt(l.arg.content);s=l.exp=Ue(r,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&cs(l.arg)&&(l.arg.content=lt(l.arg.content)),a.push(l)}if(a.length>0){const{props:i,directives:l}=Mh(e,t,a,!1,!1);n=i,l.length&&t.onError(ft(36,l[0].loc))}return{slotName:s,slotProps:n}}const Ph=(e,t,s,n)=>{const{loc:a,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(ft(35,a));let r;if(l.type===4)if(l.isStatic){let u=l.content;u.startsWith("vue:")&&(u=`vnode-${u.slice(4)}`);const f=t.tagType!==0||u.startsWith("vnode")||!/[A-Z]/.test(u)?Sa(lt(u)):`on:${u}`;r=Ue(f,!0,l.loc)}else r=Ns([`${s.helperString(bo)}(`,l,")"]);else r=l,r.children.unshift(`${s.helperString(bo)}(`),r.children.push(")");let o=e.exp;o&&!o.content.trim()&&(o=void 0);let c=s.cacheHandlers&&!o&&!s.inVOnce;if(o){const u=vh(o),f=!(u||sx(o)),p=o.content.includes(";");(f||c&&u)&&(o=Ns([`${f?"$event":"(...args)"} => ${p?"{":"("}`,o,p?"}":")"]))}let d={props:[St(r,o||Ue("() => {}",!1,a))]};return n&&(d=n(d)),c&&(d.props[0].value=s.cache(d.props[0].value)),d.props.forEach(u=>u.key.isHandlerKey=!0),d},a0=(e,t,s)=>{const{modifiers:n,loc:a}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),n.some(r=>r.content==="camel")&&(i.type===4?i.isStatic?i.content=lt(i.content):i.content=`${s.helperString(vo)}(${i.content})`:(i.children.unshift(`${s.helperString(vo)}(`),i.children.push(")"))),s.inSSR||(n.some(r=>r.content==="prop")&&nu(i,"."),n.some(r=>r.content==="attr")&&nu(i,"^")),{props:[St(i,l)]}},nu=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},i0=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let n,a=!1;for(let i=0;i<s.length;i++){const l=s[i];if($r(l)){a=!0;for(let r=i+1;r<s.length;r++){const o=s[r];if($r(o))n||(n=s[i]=Ns([l],l.loc)),n.children.push(" + ",o),s.splice(r,1),r--;else{n=void 0;break}}}}if(!(!a||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if($r(l)||l.type===8){const r=[];(l.type!==2||l.content!==" ")&&r.push(l),!t.ssr&&ms(l,t)===0&&r.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:Lt(t.helper(fc),r)}}}}},au=new WeakSet,l0=(e,t)=>{if(e.type===1&&ks(e,"once",!0))return au.has(e)||t.inVOnce||t.inSSR?void 0:(au.add(e),t.inVOnce=!0,t.helper(Bl),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Fh=(e,t,s)=>{const{exp:n,arg:a}=e;if(!n)return s.onError(ft(41,e.loc)),Qa();const i=n.loc.source.trim(),l=n.type===4?n.content:i,r=s.bindingMetadata[i];if(r==="props"||r==="props-aliased")return s.onError(ft(44,n.loc)),Qa();if(r==="literal-const"||r==="setup-const")return s.onError(ft(45,n.loc)),Qa();if(!l.trim()||!vh(n))return s.onError(ft(42,n.loc)),Qa();const o=a||Ue("modelValue",!0),c=a?cs(a)?`onUpdate:${lt(a.content)}`:Ns(['"onUpdate:" + ',a]):"onUpdate:modelValue";let d;const u=s.isTS?"($event: any)":"$event";d=Ns([`${u} => ((`,n,") = $event)"]);const f=[St(o,e.exp),St(c,d)];if(e.modifiers.length&&t.tagType===1){const p=e.modifiers.map(y=>y.content).map(y=>(Cc(y)?y:JSON.stringify(y))+": true").join(", "),g=a?cs(a)?`${a.content}Modifiers`:Ns([a,' + "Modifiers"']):"modelModifiers";f.push(St(g,Ue(`{ ${p} }`,!1,e.loc,2)))}return Qa(f)};function Qa(e=[]){return{props:e}}const r0=/[\w).+\-_$\]]/,o0=(e,t)=>{Qn("COMPILER_FILTERS",t)&&(e.type===5?ql(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&ql(s.exp,t)}))};function ql(e,t){if(e.type===4)iu(e,t);else for(let s=0;s<e.children.length;s++){const n=e.children[s];typeof n=="object"&&(n.type===4?iu(n,t):n.type===8?ql(e,t):n.type===5&&ql(n.content,t))}}function iu(e,t){const s=e.content;let n=!1,a=!1,i=!1,l=!1,r=0,o=0,c=0,d=0,u,f,p,g,y=[];for(p=0;p<s.length;p++)if(f=u,u=s.charCodeAt(p),n)u===39&&f!==92&&(n=!1);else if(a)u===34&&f!==92&&(a=!1);else if(i)u===96&&f!==92&&(i=!1);else if(l)u===47&&f!==92&&(l=!1);else if(u===124&&s.charCodeAt(p+1)!==124&&s.charCodeAt(p-1)!==124&&!r&&!o&&!c)g===void 0?(d=p+1,g=s.slice(0,p).trim()):S();else{switch(u){case 34:a=!0;break;case 39:n=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:o++;break;case 93:o--;break;case 123:r++;break;case 125:r--;break}if(u===47){let R=p-1,v;for(;R>=0&&(v=s.charAt(R),v===" ");R--);(!v||!r0.test(v))&&(l=!0)}}g===void 0?g=s.slice(0,p).trim():d!==0&&S();function S(){y.push(s.slice(d,p).trim()),d=p+1}if(y.length){for(p=0;p<y.length;p++)g=c0(g,y[p],t);e.content=g,e.ast=void 0}}function c0(e,t,s){s.helper(mc);const n=t.indexOf("(");if(n<0)return s.filters.add(t),`${Mi(t,"filter")}(${e})`;{const a=t.slice(0,n),i=t.slice(n+1);return s.filters.add(a),`${Mi(a,"filter")}(${e}${i!==")"?","+i:i}`}}const lu=new WeakSet,d0=(e,t)=>{if(e.type===1){const s=ks(e,"memo");return!s||lu.has(e)||t.inSSR?void 0:(lu.add(e),()=>{const n=e.codegenNode||t.currentNode.codegenNode;n&&n.type===13&&(e.tagType!==1&&Sc(n,t),e.codegenNode=Lt(t.helper(kc),[s.exp,$a(void 0,n),"_cache",String(t.cached.length)]),t.cached.push(null))})}},u0=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const n=s.arg;if(n.type!==4||!n.isStatic)t.onError(ft(53,n.loc)),s.exp=Ue("",!0,n.loc);else{const a=lt(n.content);(gh.test(a[0])||a[0]==="-")&&(s.exp=Ue(a,!1,n.loc))}}}};function f0(e){return[[u0,l0,Vx,d0,qx,o0,s0,Yx,Wx,i0],{on:Ph,bind:a0,model:Fh}]}function p0(e,t={}){const s=t.onError||Tc,n=t.mode==="module";t.prefixIdentifiers===!0?s(ft(48)):n&&s(ft(49));const a=!1;t.cacheHandlers&&s(ft(50)),t.scopeId&&!n&&s(ft(51));const i=ze({},t,{prefixIdentifiers:a}),l=Pe(e)?yx(e,i):e,[r,o]=f0();return kx(l,ze({},i,{nodeTransforms:[...r,...t.nodeTransforms||[]],directiveTransforms:ze({},o,t.directiveTransforms||{})})),Ex(l,i)}const h0=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const $h=Symbol(""),Uh=Symbol(""),Bh=Symbol(""),Hh=Symbol(""),So=Symbol(""),Vh=Symbol(""),jh=Symbol(""),zh=Symbol(""),qh=Symbol(""),Gh=Symbol("");qy({[$h]:"vModelRadio",[Uh]:"vModelCheckbox",[Bh]:"vModelText",[Hh]:"vModelSelect",[So]:"vModelDynamic",[Vh]:"withModifiers",[jh]:"withKeys",[zh]:"vShow",[qh]:"Transition",[Gh]:"TransitionGroup"});let pa;function g0(e,t=!1){return pa||(pa=document.createElement("div")),t?(pa.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,pa.children[0].getAttribute("foo")):(pa.innerHTML=e,pa.textContent)}const m0={parseMode:"html",isVoidTag:om,isNativeTag:e=>im(e)||lm(e)||rm(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:g0,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return qh;if(e==="TransitionGroup"||e==="transition-group")return Gh},getNamespace(e,t,s){let n=t?t.ns:s;if(t&&n===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(a=>a.type===6&&a.name==="encoding"&&a.value!=null&&(a.value.content==="text/html"||a.value.content==="application/xhtml+xml"))&&(n=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(n=0);else t&&n===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(n=0);if(n===0){if(e==="svg")return 1;if(e==="math")return 2}return n}},v0=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:Ue("style",!0,t.loc),exp:b0(t.value.content,t.loc),modifiers:[],loc:t.loc})})},b0=(e,t)=>{const s=af(e);return Ue(JSON.stringify(s),!1,t,3)};function Mn(e,t){return ft(e,t)}const y0=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(Mn(54,a)),t.children.length&&(s.onError(Mn(55,a)),t.children.length=0),{props:[St(Ue("innerHTML",!0,a),n||Ue("",!0))]}},x0=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(Mn(56,a)),t.children.length&&(s.onError(Mn(57,a)),t.children.length=0),{props:[St(Ue("textContent",!0),n?ms(n,s)>0?n:Lt(s.helperString(gr),[n],a):Ue("",!0))]}},_0=(e,t,s)=>{const n=Fh(e,t,s);if(!n.props.length||t.tagType===1)return n;e.arg&&s.onError(Mn(59,e.arg.loc));const{tag:a}=t,i=s.isCustomElement(a);if(a==="input"||a==="textarea"||a==="select"||i){let l=Bh,r=!1;if(a==="input"||i){const o=mr(t,"type");if(o){if(o.type===7)l=So;else if(o.value)switch(o.value.content){case"radio":l=$h;break;case"checkbox":l=Uh;break;case"file":r=!0,s.onError(Mn(60,e.loc));break}}else nx(t)&&(l=So)}else a==="select"&&(l=Hh);r||(n.needRuntime=s.helper(l))}else s.onError(Mn(58,e.loc));return n.props=n.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),n},w0=ys("passive,once,capture"),k0=ys("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),S0=ys("left,right"),Kh=ys("onkeyup,onkeydown,onkeypress"),T0=(e,t,s,n)=>{const a=[],i=[],l=[];for(let r=0;r<t.length;r++){const o=t[r].content;o==="native"&&Di("COMPILER_V_ON_NATIVE",s)||w0(o)?l.push(o):S0(o)?cs(e)?Kh(e.content.toLowerCase())?a.push(o):i.push(o):(a.push(o),i.push(o)):k0(o)?i.push(o):a.push(o)}return{keyModifiers:a,nonKeyModifiers:i,eventOptionModifiers:l}},ru=(e,t)=>cs(e)&&e.content.toLowerCase()==="onclick"?Ue(t,!0):e.type!==4?Ns(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,C0=(e,t,s)=>Ph(e,t,s,n=>{const{modifiers:a}=e;if(!a.length)return n;let{key:i,value:l}=n.props[0];const{keyModifiers:r,nonKeyModifiers:o,eventOptionModifiers:c}=T0(i,a,s,e.loc);if(o.includes("right")&&(i=ru(i,"onContextmenu")),o.includes("middle")&&(i=ru(i,"onMouseup")),o.length&&(l=Lt(s.helper(Vh),[l,JSON.stringify(o)])),r.length&&(!cs(i)||Kh(i.content.toLowerCase()))&&(l=Lt(s.helper(jh),[l,JSON.stringify(r)])),c.length){const d=c.map(ia).join("");i=cs(i)?Ue(`${i.content}${d}`,!0):Ns(["(",i,`) + "${d}"`])}return{props:[St(i,l)]}}),E0=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(Mn(62,a)),{props:[],needRuntime:s.helper(zh)}},A0=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},R0=[v0],I0={cloak:h0,html:y0,text:x0,model:_0,on:C0,show:E0};function O0(e,t={}){return p0(e,ze({},m0,t,{nodeTransforms:[A0,...R0,...t.nodeTransforms||[]],directiveTransforms:ze({},I0,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const ou=Object.create(null);function L0(e,t){if(!Pe(e))if(e.nodeType)e=e.innerHTML;else return Bt;const s=Wg(e,t),n=ou[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=ze({hoistStatic:!0,onError:void 0,onWarn:Bt},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=O0(e,a),l=new Function("Vue",i)(Uy);return l._rc=!0,ou[s]=l}Ip(L0);const Gl=Fn({items:[]});let N0=1;function yr(e,t="info",s=3e3){const n=N0++;return Gl.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>Ic(n),s),n}function Ic(e){const t=Gl.items.findIndex(s=>s.id===e);t>=0&&Gl.items.splice(t,1)}function Te(e,t="info",s=3e3){return yr(e,t,s)}Te.success=(e,t=3e3)=>yr(e,"success",t);Te.error=(e,t=5e3)=>yr(e,"error",t);Te.info=(e,t=3e3)=>yr(e,"info",t);Te.dismiss=Ic;const D0={setup(){return{state:Gl,dismiss:Ic}},template:`
 ...
 * @license MIT
 */const ba=typeof document<"u";function Wh(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function P0(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&Wh(e.default)}const at=Object.assign;function Br(e,t){const s={};for(const n in t){const a=t[n];s[n]=Ms(a)?a.map(e):e(a)}return s}const mi=()=>{},Ms=Array.isArray;function du(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}const Zh=/#/g,F0=/&/g,$0=/\//g,U0=/=/g,B0=/\?/g,Jh=/\+/g,H0=/%5B/g,V0=/%5D/g,Yh=/%5E/g,j0=/%60/g,Qh=/%7B/g,z0=/%7C/g,Xh=/%7D/g,q0=/%20/g;function Oc(e){return e==null?"":encodeURI(""+e).replace(z0,"|").replace(H0,"[").replace(V0,"]")}function G0(e){return Oc(e).replace(Qh,"{").replace(Xh,"}").replace(Yh,"^")}function To(e){return Oc(e).replace(Jh,"%2B").replace(q0,"+").replace(Zh,"%23").replace(F0,"%26").replace(j0,"`").replace(Qh,"{").replace(Xh,"}").replace(Yh,"^")}function K0(e){return To(e).replace(U0,"%3D")}function W0(e){return Oc(e).replace(Zh,"%23").replace(B0,"%3F")}function Z0(e){return W0(e).replace($0,"%2F")}function Fi(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const J0=/\/$/,Y0=e=>e.replace(J0,"");function Hr(e,t,s="/"){let n,a={},i="",l="";const r=t.indexOf("#");let o=t.indexOf("?");return o=r>=0&&o>r?-1:o,o>=0&&(n=t.slice(0,o),i=t.slice(o,r>0?r:t.length),a=e(i.slice(1))),r>=0&&(n=n||t.slice(0,r),l=t.slice(r,t.length)),n=t_(n??t,s),{fullPath:n+i+l,path:n,query:a,hash:Fi(l)}}function Q0(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function uu(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function X0(e,t,s){const n=t.matched.length-1,a=s.matched.length-1;return n>-1&&n===a&&Ha(t.matched[n],s.matched[a])&&eg(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function Ha(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function eg(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!e_(e[s],t[s]))return!1;return!0}function e_(e,t){return Ms(e)?fu(e,t):Ms(t)?fu(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function fu(e,t){return Ms(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function t_(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),a=n[n.length-1];(a===".."||a===".")&&n.push("");let i=s.length-1,l,r;for(l=0;l<n.length;l++)if(r=n[l],r!==".")if(r==="..")i>1&&i--;else break;return s.slice(0,i).join("/")+"/"+n.slice(l).join("/")}const Cn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Co=(function(e){return e.pop="pop",e.push="push",e})({}),Vr=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function s_(e){if(!e)if(ba){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Y0(e)}const n_=/^[^#]+#/;function a_(e,t){return e.replace(n_,"#")+t}function i_(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const xr=()=>({left:window.scrollX,top:window.scrollY});function l_(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),a=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!a)return;t=i_(a,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function pu(e,t){return(history.state?history.state.position-t:-1)+e}const Eo=new Map;function r_(e,t){Eo.set(e,t)}function o_(e){const t=Eo.get(e);return Eo.delete(e),t}function c_(e){return typeof e=="string"||e&&typeof e=="object"}function tg(e){return typeof e=="string"||typeof e=="symbol"}let mt=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const sg=Symbol("");mt.MATCHER_NOT_FOUND+"",mt.NAVIGATION_GUARD_REDIRECT+"",mt.NAVIGATION_ABORTED+"",mt.NAVIGATION_CANCELLED+"",mt.NAVIGATION_DUPLICATED+"";function Va(e,t){return at(new Error,{type:e,[sg]:!0},t)}function en(e,t){return e instanceof Error&&sg in e&&(t==null||!!(e.type&t))}const d_=["params","query","hash"];function u_(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of d_)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}function f_(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const a=s[n].replace(Jh," "),i=a.indexOf("="),l=Fi(i<0?a:a.slice(0,i)),r=i<0?null:Fi(a.slice(i+1));if(l in t){let o=t[l];Ms(o)||(o=t[l]=[o]),o.push(r)}else t[l]=r}return t}function hu(e){let t="";for(let s in e){const n=e[s];if(s=K0(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(Ms(n)?n.map(a=>a&&To(a)):[n&&To(n)]).forEach(a=>{a!==void 0&&(t+=(t.length?"&":"")+s,a!=null&&(t+="="+a))})}return t}function p_(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=Ms(n)?n.map(a=>a==null?null:""+a):n==null?n:""+n)}return t}const h_=Symbol(""),gu=Symbol(""),_r=Symbol(""),Lc=Symbol(""),Ao=Symbol("");function Xa(){let e=[];function t(n){return e.push(n),()=>{const a=e.indexOf(n);a>-1&&e.splice(a,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function Nn(e,t,s,n,a,i=l=>l()){const l=n&&(n.enterCallbacks[a]=n.enterCallbacks[a]||[]);return()=>new Promise((r,o)=>{const c=f=>{f===!1?o(Va(mt.NAVIGATION_ABORTED,{from:s,to:t})):f instanceof Error?o(f):c_(f)?o(Va(mt.NAVIGATION_GUARD_REDIRECT,{from:t,to:f})):(l&&n.enterCallbacks[a]===l&&typeof f=="function"&&l.push(f),r())},d=i(()=>e.call(n&&n.instances[a],t,s,c));let u=Promise.resolve(d);e.length<3&&(u=u.then(c)),u.catch(f=>o(f))})}function jr(e,t,s,n,a=i=>i()){const i=[];for(const l of e)for(const r in l.components){let o=l.components[r];if(!(t!=="beforeRouteEnter"&&!l.instances[r]))if(Wh(o)){const c=(o.__vccOpts||o)[t];c&&i.push(Nn(c,s,n,l,r,a))}else{let c=o();i.push(()=>c.then(d=>{if(!d)throw new Error(`Couldn't resolve component "${r}" at "${l.path}"`);const u=P0(d)?d.default:d;l.mods[r]=d,l.components[r]=u;const f=(u.__vccOpts||u)[t];return f&&Nn(f,s,n,l,r,a)()}))}}return i}function g_(e,t){const s=[],n=[],a=[],i=Math.max(t.matched.length,e.matched.length);for(let l=0;l<i;l++){const r=t.matched[l];r&&(e.matched.find(c=>Ha(c,r))?n.push(r):s.push(r));const o=e.matched[l];o&&(t.matched.find(c=>Ha(c,o))||a.push(o))}return[s,n,a]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let m_=()=>location.protocol+"//"+location.host;function ng(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),uu(r,"")}return uu(s,e)+n+a}function v_(e,t,s,n){let a=[],i=[],l=null;const r=({state:f})=>{const p=ng(e,location),g=s.value,y=t.value;let S=0;if(f){if(s.value=p,t.value=f,l&&l===g){l=null;return}S=y?f.position-y.position:0}else n(p);a.forEach(R=>{R(s.value,g,{delta:S,type:Co.pop,direction:S?S>0?Vr.forward:Vr.back:Vr.unknown})})};function o(){l=s.value}function c(f){a.push(f);const p=()=>{const g=a.indexOf(f);g>-1&&a.splice(g,1)};return i.push(p),p}function d(){if(document.visibilityState==="hidden"){const{history:f}=window;if(!f.state)return;f.replaceState(at({},f.state,{scroll:xr()}),"")}}function u(){for(const f of i)f();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:o,listen:c,destroy:u}}function mu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?xr():null}}function b_(e){const{history:t,location:s}=window,n={value:ng(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,d){const u=e.indexOf("#"),f=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+o:m_()+e+o;try{t[d?"replaceState":"pushState"](c,"",f),a.value=c}catch(p){console.error(p),s[d?"replace":"assign"](f)}}function l(o,c){i(o,at({},t.state,mu(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const d=at({},a.value,t.state,{forward:o,scroll:xr()});i(d.current,d,!0),i(o,at({},mu(n.value,o,null),{position:d.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function y_(e){e=s_(e);const t=b_(e),s=v_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=at({location:"",base:e,go:n,createHref:a_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function x_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),y_(e)}let Kn=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Rt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Rt||{});const __={type:Kn.Static,value:""},w_=/[a-zA-Z0-9_]/;function k_(e){if(!e)return[[]];if(e==="/")return[[__]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(p){throw new Error(`ERR (${s})/"${c}": ${p}`)}let s=Rt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",d="";function u(){c&&(s===Rt.Static?i.push({type:Kn.Static,value:c}):s===Rt.Param||s===Rt.ParamRegExp||s===Rt.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Kn.Param,value:c,regexp:d,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function f(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==Rt.ParamRegExp){n=s,s=Rt.EscapeNext;continue}switch(s){case Rt.Static:o==="/"?(c&&u(),l()):o===":"?(u(),s=Rt.Param):f();break;case Rt.EscapeNext:f(),s=n;break;case Rt.Param:o==="("?s=Rt.ParamRegExp:w_.test(o)?f():(u(),s=Rt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case Rt.ParamRegExp:o===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+o:s=Rt.ParamRegExpEnd:d+=o;break;case Rt.ParamRegExpEnd:u(),s=Rt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,d="";break;default:t("Unknown state");break}}return s===Rt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const vu="[^/]+?",S_={sensitive:!1,strict:!1,start:!0,end:!0};var Jt=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Jt||{});const T_=/[.+*?^${}()[\]/\\]/g;function C_(e,t){const s=at({},S_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[Jt.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const f=c[u];let p=Jt.Segment+(s.sensitive?Jt.BonusCaseSensitive:0);if(f.type===Kn.Static)u||(a+="/"),a+=f.value.replace(T_,"\\$&"),p+=Jt.Static;else if(f.type===Kn.Param){const{value:g,repeatable:y,optional:S,regexp:R}=f;i.push({name:g,repeatable:y,optional:S});const v=R||vu;if(v!==vu){p+=Jt.BonusCustomRegExp;try{`${v}`}catch(x){throw new Error(`Invalid custom RegExp for param "${g}" (${v}): `+x.message)}}let m=y?`((?:${v})(?:/(?:${v}))*)`:`(${v})`;u||(m=S&&c.length<2?`(?:/${m})`:"/"+m),S&&(m+="?"),a+=m,p+=Jt.Dynamic,S&&(p+=Jt.BonusOptional),y&&(p+=Jt.BonusRepeatable),v===".*"&&(p+=Jt.BonusWildcard)}d.push(p)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=Jt.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const d=c.match(l),u={};if(!d)return null;for(let f=1;f<d.length;f++){const p=d[f]||"",g=i[f-1];u[g.name]=p&&g.repeatable?p.split("/"):p}return u}function o(c){let d="",u=!1;for(const f of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const p of f)if(p.type===Kn.Static)d+=p.value;else if(p.type===Kn.Param){const{value:g,repeatable:y,optional:S}=p,R=g in c?c[g]:"";if(Ms(R)&&!y)throw new Error(`Provided param "${g}" is an array but it is not repeatable (* or + modifiers)`);const v=Ms(R)?R.join("/"):R;if(!v)if(S)f.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${g}"`);d+=v}}return d||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function E_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Jt.Static+Jt.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Jt.Static+Jt.Segment?1:-1:0}function ag(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=E_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(bu(n))return 1;if(bu(a))return-1}return a.length-n.length}function bu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const A_={strict:!1,end:!0,sensitive:!1};function R_(e,t,s){const n=C_(k_(e.path),s),a=at(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function I_(e,t){const s=[],n=new Map;t=du(A_,t);function a(u){return n.get(u)}function i(u,f,p){const g=!p,y=xu(u);y.aliasOf=p&&p.record;const S=du(t,u),R=[y];if("alias"in u){const x=typeof u.alias=="string"?[u.alias]:u.alias;for(const w of x)R.push(xu(at({},y,{components:p?p.record.components:y.components,path:w,aliasOf:p?p.record:y})))}let v,m;for(const x of R){const{path:w}=x;if(f&&w[0]!=="/"){const _=f.record.path,A=_[_.length-1]==="/"?"":"/";x.path=f.record.path+(w&&A+w)}if(v=R_(x,f,S),p?p.alias.push(v):(m=m||v,m!==v&&m.alias.push(v),g&&u.name&&!_u(v)&&l(u.name)),ig(v)&&o(v),y.children){const _=y.children;for(let A=0;A<_.length;A++)i(_[A],v,p&&p.children[A])}p=p||v}return m?()=>{l(m)}:mi}function l(u){if(tg(u)){const f=n.get(u);f&&(n.delete(u),s.splice(s.indexOf(f),1),f.children.forEach(l),f.alias.forEach(l))}else{const f=s.indexOf(u);f>-1&&(s.splice(f,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function r(){return s}function o(u){const f=N_(u,s);s.splice(f,0,u),u.record.name&&!_u(u)&&n.set(u.record.name,u)}function c(u,f){let p,g={},y,S;if("name"in u&&u.name){if(p=n.get(u.name),!p)throw Va(mt.MATCHER_NOT_FOUND,{location:u});S=p.record.name,g=at(yu(f.params,p.keys.filter(m=>!m.optional).concat(p.parent?p.parent.keys.filter(m=>m.optional):[]).map(m=>m.name)),u.params&&yu(u.params,p.keys.map(m=>m.name))),y=p.stringify(g)}else if(u.path!=null)y=u.path,p=s.find(m=>m.re.test(y)),p&&(g=p.parse(y),S=p.record.name);else{if(p=f.name?n.get(f.name):s.find(m=>m.re.test(f.path)),!p)throw Va(mt.MATCHER_NOT_FOUND,{location:u,currentLocation:f});S=p.record.name,g=at({},f.params,u.params),y=p.stringify(g)}const R=[];let v=p;for(;v;)R.unshift(v.record),v=v.parent;return{name:S,path:y,params:g,matched:R,meta:L_(R)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:r,getRecordMatcher:a}}function yu(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function xu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:O_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function O_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function _u(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function L_(e){return e.reduce((t,s)=>at(t,s.meta),{})}function N_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;ag(e,t[i])<0?n=i:s=i+1}const a=D_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function D_(e){let t=e;for(;t=t.parent;)if(ig(t)&&ag(e,t)===0)return t}function ig({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function wu(e){const t=Ts(_r),s=Ts(Lc),n=te(()=>{const o=Gs(e.to);return t.resolve(o)}),a=te(()=>{const{matched:o}=n.value,{length:c}=o,d=o[c-1],u=s.matched;if(!d||!u.length)return-1;const f=u.findIndex(Ha.bind(null,d));if(f>-1)return f;const p=ku(o[c-2]);return c>1&&ku(d)===p&&u[u.length-1].path!==p?u.findIndex(Ha.bind(null,o[c-2])):f}),i=te(()=>a.value>-1&&U_(s.params,n.value.params)),l=te(()=>a.value>-1&&a.value===s.matched.length-1&&eg(s.params,n.value.params));function r(o={}){if($_(o)){const c=t[Gs(e.replace)?"replace":"push"](Gs(e.to)).catch(mi);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:te(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function M_(e){return e.length===1?e[0]:e}const P_=Vi({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:wu,setup(e,{slots:t}){const s=Fn(wu(e)),{options:n}=Ts(_r),a=te(()=>({[Su(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[Su(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&M_(t.default(s));return e.custom?i:Da("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),F_=P_;function $_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function U_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Ms(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function ku(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Su=(e,t,s)=>e??t??s,B_=Vi({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=Ts(Ao),a=te(()=>e.route||n.value),i=Ts(gu,0),l=te(()=>{let c=Gs(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),r=te(()=>a.value.matched[l.value]);ui(gu,te(()=>l.value+1)),ui(h_,r),ui(Ao,a);const o=h();return Xt(()=>[o.value,r.value,e.name],([c,d,u],[f,p,g])=>{d&&(d.instances[u]=c,p&&p!==d&&c&&c===f&&(d.leaveGuards.size||(d.leaveGuards=p.leaveGuards),d.updateGuards.size||(d.updateGuards=p.updateGuards))),c&&d&&(!p||!Ha(d,p)||!f)&&(d.enterCallbacks[u]||[]).forEach(y=>y(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=r.value,f=u&&u.components[d];if(!f)return Tu(s.default,{Component:f,route:c});const p=u.props[d],g=p?p===!0?c.params:typeof p=="function"?p(c):p:null,S=Da(f,at({},g,t,{onVnodeUnmounted:R=>{R.component.isUnmounted&&(u.instances[d]=null)},ref:o}));return Tu(s.default,{Component:S,route:c})||S}}});function Tu(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const H_=B_;function V_(e){const t=I_(e.routes,e),s=e.parseQuery||f_,n=e.stringifyQuery||hu,a=e.history,i=Xa(),l=Xa(),r=Xa(),o=Vo(Cn);let c=Cn;ba&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Br.bind(null,V=>""+V),u=Br.bind(null,Z0),f=Br.bind(null,Fi);function p(V,ue){let oe,be;return tg(V)?(oe=t.getRecordMatcher(V),be=ue):be=V,t.addRoute(be,oe)}function g(V){const ue=t.getRecordMatcher(V);ue&&t.removeRoute(ue)}function y(){return t.getRoutes().map(V=>V.record)}function S(V){return!!t.getRecordMatcher(V)}function R(V,ue){if(ue=at({},ue||o.value),typeof V=="string"){const I=Hr(s,V,ue.path),P=t.resolve({path:I.path},ue),X=a.createHref(I.fullPath);return at(I,P,{params:f(P.params),hash:Fi(I.hash),redirectedFrom:void 0,href:X})}let oe;if(V.path!=null)oe=at({},V,{path:Hr(s,V.path,ue.path).path});else{const I=at({},V.params);for(const P in I)I[P]==null&&delete I[P];oe=at({},V,{params:u(I)}),ue.params=u(ue.params)}const be=t.resolve(oe,ue),me=V.hash||"";be.params=d(f(be.params));const Be=Q0(n,at({},V,{hash:G0(me),path:be.path})),b=a.createHref(Be);return at({fullPath:Be,hash:me,query:n===hu?p_(V.query):V.query||{}},be,{redirectedFrom:void 0,href:b})}function v(V){return typeof V=="string"?Hr(s,V,o.value.path):at({},V)}function m(V,ue){if(c!==V)return Va(mt.NAVIGATION_CANCELLED,{from:ue,to:V})}function x(V){return A(V)}function w(V){return x(at(v(V),{replace:!0}))}function _(V,ue){const oe=V.matched[V.matched.length-1];if(oe&&oe.redirect){const{redirect:be}=oe;let me=typeof be=="function"?be(V,ue):be;return typeof me=="string"&&(me=me.includes("?")||me.includes("#")?me=v(me):{path:me},me.params={}),at({query:V.query,hash:V.hash,params:me.path!=null?{}:V.params},me)}}function A(V,ue){const oe=c=R(V),be=o.value,me=V.state,Be=V.force,b=V.replace===!0,I=_(oe,be);if(I)return A(at(v(I),{state:typeof I=="object"?at({},me,I.state):me,force:Be,replace:b}),ue||oe);const P=oe;P.redirectedFrom=ue;let X;return!Be&&X0(n,be,oe)&&(X=Va(mt.NAVIGATION_DUPLICATED,{to:P,from:be}),ee(be,be,!0,!1)),(X?Promise.resolve(X):L(P,be)).catch(J=>en(J)?en(J,mt.NAVIGATION_GUARD_REDIRECT)?J:K(J):E(J,P,be)).then(J=>{if(J){if(en(J,mt.NAVIGATION_GUARD_REDIRECT))return A(at({replace:b},v(J.to),{state:typeof J.to=="object"?at({},me,J.to.state):me,force:Be}),ue||P)}else J=M(P,be,!0,b,me);return H(P,be,J),J})}function T(V,ue){const oe=m(V,ue);return oe?Promise.reject(oe):Promise.resolve()}function C(V){const ue=B.values().next().value;return ue&&typeof ue.runWithContext=="function"?ue.runWithContext(V):V()}function L(V,ue){let oe;const[be,me,Be]=g_(V,ue);oe=jr(be.reverse(),"beforeRouteLeave",V,ue);for(const I of be)I.leaveGuards.forEach(P=>{oe.push(Nn(P,V,ue))});const b=T.bind(null,V,ue);return oe.push(b),_e(oe).then(()=>{oe=[];for(const I of i.list())oe.push(Nn(I,V,ue));return oe.push(b),_e(oe)}).then(()=>{oe=jr(me,"beforeRouteUpdate",V,ue);for(const I of me)I.updateGuards.forEach(P=>{oe.push(Nn(P,V,ue))});return oe.push(b),_e(oe)}).then(()=>{oe=[];for(const I of Be)if(I.beforeEnter)if(Ms(I.beforeEnter))for(const P of I.beforeEnter)oe.push(Nn(P,V,ue));else oe.push(Nn(I.beforeEnter,V,ue));return oe.push(b),_e(oe)}).then(()=>(V.matched.forEach(I=>I.enterCallbacks={}),oe=jr(Be,"beforeRouteEnter",V,ue,C),oe.push(b),_e(oe))).then(()=>{oe=[];for(const I of l.list())oe.push(Nn(I,V,ue));return oe.push(b),_e(oe)}).catch(I=>en(I,mt.NAVIGATION_CANCELLED)?I:Promise.reject(I))}function H(V,ue,oe){r.list().forEach(be=>C(()=>be(V,ue,oe)))}function M(V,ue,oe,be,me){const Be=m(V,ue);if(Be)return Be;const b=ue===Cn,I=ba?history.state:{};oe&&(be||b?a.replace(V.fullPath,at({scroll:b&&I&&I.scroll},me)):a.push(V.fullPath,me)),o.value=V,ee(V,ue,oe,b),K()}let N;function Z(){N||(N=a.listen((V,ue,oe)=>{if(!de.listening)return;const be=R(V),me=_(be,de.currentRoute.value);if(me){A(at(me,{replace:!0,force:!0}),be).catch(mi);return}c=be;const Be=o.value;ba&&r_(pu(Be.fullPath,oe.delta),xr()),L(be,Be).catch(b=>en(b,mt.NAVIGATION_ABORTED|mt.NAVIGATION_CANCELLED)?b:en(b,mt.NAVIGATION_GUARD_REDIRECT)?(A(at(v(b.to),{force:!0}),be).then(I=>{en(I,mt.NAVIGATION_ABORTED|mt.NAVIGATION_DUPLICATED)&&!oe.delta&&oe.type===Co.pop&&a.go(-1,!1)}).catch(mi),Promise.reject()):(oe.delta&&a.go(-oe.delta,!1),E(b,be,Be))).then(b=>{b=b||M(be,Be,!1),b&&(oe.delta&&!en(b,mt.NAVIGATION_CANCELLED)?a.go(-oe.delta,!1):oe.type===Co.pop&&en(b,mt.NAVIGATION_ABORTED|mt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),H(be,Be,b)}).catch(mi)}))}let ne=Xa(),F=Xa(),O;function E(V,ue,oe){K(V);const be=F.list();return be.length?be.forEach(me=>me(V,ue,oe)):console.error(V),Promise.reject(V)}function q(){return O&&o.value!==Cn?Promise.resolve():new Promise((V,ue)=>{ne.add([V,ue])})}function K(V){return O||(O=!V,Z(),ne.list().forEach(([ue,oe])=>V?oe(V):ue()),ne.reset()),V}function ee(V,ue,oe,be){const{scrollBehavior:me}=e;if(!ba||!me)return Promise.resolve();const Be=!oe&&o_(pu(V.fullPath,0))||(be||!oe)&&history.state&&history.state.scroll||null;return Ot().then(()=>me(V,ue,Be)).then(b=>b&&l_(b)).catch(b=>E(b,V,ue))}const ie=V=>a.go(V);let U;const B=new Set,de={currentRoute:o,listening:!0,addRoute:p,removeRoute:g,clearRoutes:t.clearRoutes,hasRoute:S,getRoutes:y,resolve:R,options:e,push:x,replace:w,go:ie,back:()=>ie(-1),forward:()=>ie(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:F.add,isReady:q,install(V){V.component("RouterLink",F_),V.component("RouterView",H_),V.config.globalProperties.$router=de,Object.defineProperty(V.config.globalProperties,"$route",{enumerable:!0,get:()=>Gs(o)}),ba&&!U&&o.value===Cn&&(U=!0,x(a.location).catch(be=>{}));const ue={};for(const be in Cn)Object.defineProperty(ue,be,{get:()=>o.value[be],enumerable:!0});V.provide(_r,de),V.provide(Lc,Ho(ue)),V.provide(Ao,o);const oe=V.unmount;B.add(V),V.unmount=function(){B.delete(V),B.size<1&&(c=Cn,N&&N(),N=null,o.value=Cn,U=!1,O=!1),oe()}}};function _e(V){return V.reduce((ue,oe)=>ue.then(()=>C(oe)),Promise.resolve())}return de}function lg(){return Ts(_r)}function j_(e){return Ts(Lc)}const z_=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...["Live","Agents","Loops","Processes","Schedules"].map(e=>({group:"Operations",label:e,icon:"operations",to:{path:"/operations",query:{tab:e.toLowerCase()}}})),...["Audit","Sessions","Traces","Usage"].map(e=>({group:"History",label:e,icon:"history",to:{path:"/history",query:{tab:e.toLowerCase()}}})),...["Tools","Skills","Knowledge","Memory","Learned"].map(e=>({group:"Capabilities",label:e,icon:"capabilities",to:{path:"/capabilities",query:{tab:e.toLowerCase()}}})),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...[["Health","health"],["Resources","resources"],["Logs","logs"],["Config","config"],["Discord","discord"],["Host Access","host-access"],["API Tokens","api-tokens"],["LLM Config","llm"],["Internals","internals"],["Update","update"]].map(([e,t])=>({group:"System",label:e,icon:"system",to:{path:"/system",query:{tab:t}}}))],ls=Fn({open:!1,query:"",selected:0});function Cu(){ls.query="",ls.selected=0,ls.open=!0}function zr(){ls.open=!1}function q_(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const G_={setup(){const e=lg(),t=h(null),s=te(()=>{const i=ls.query.trim().toLowerCase();return z_.map(l=>({...l,_score:q_(l,i)})).filter(l=>l._score>0).sort((l,r)=>r._score-l._score)});Xt(()=>ls.open,async i=>{var l;i&&(await Ot(),(l=t.value)==null||l.focus())}),Xt(()=>ls.query,()=>{ls.selected=0});function n(i){zr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),zr();return}if(i.key==="ArrowDown")i.preventDefault(),ls.selected=Math.min(ls.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),ls.selected=Math.max(ls.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[ls.selected];l&&n(l)}}return{state:ls,results:s,inputEl:t,go:n,onKeydown:a,closePalette:zr}},template:`
    <transition name="modal">
...
... (truncated)`:s}function Au(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function cg(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function dg(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const J_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),d=h({reload:!1,clearSessions:!1,stopLoops:!1});let u=0;const f=te(()=>{const N=e.value.uptime_seconds||0,Z=Math.floor(N/86400),ne=Math.floor(N%86400/3600),F=Math.floor(N%3600/60),O=[];return Z>0&&O.push(`${Z}d`),ne>0&&O.push(`${ne}h`),(O.length===0||Z===0&&ne===0)&&O.push(`${F}m`),O.join(" ")}),p=te(()=>{const N=e.value.uptime_seconds||0;return 125.66*(1-Math.min(N/86400,1))}),g=te(()=>{const N=e.value;return[{label:"Guilds",value:N.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:N.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:N.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${N.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:N.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:N.loop_count>0?"text-green-400":"",highlight:N.loop_count>0},{label:"Agents",value:N.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:N.agent_count>0?`${N.agent_count} total`:"",subColor:"text-gray-500",highlight:(N.agent_running??0)>0},{label:"Processes",value:N.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:N.process_count>0?`${N.process_count} total`:"",subColor:"text-gray-500",highlight:(N.process_running??0)>0},{label:"Schedules",value:N.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(N.schedule_failing>0?`${N.schedule_failing} failing`:"")+(N.schedule_failing>0&&N.schedule_paused>0?", ":"")+(N.schedule_paused>0?`${N.schedule_paused} paused`:"")||void 0,subColor:N.schedule_failing>0?"text-red-400":"text-yellow-400",color:N.schedule_failing>0?"text-red-400":"",highlight:N.schedule_failing>0},{label:"Users",value:N.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),y=te(()=>{const N=e.value,Z=[];return Z.push({label:"Bot",status:N.status==="online"?"ok":"warn",detail:N.status==="online"?"Online":"Starting"}),(N.schedule_failing||0)>0?Z.push({label:"Schedules",status:"error",detail:`${N.schedule_failing} failing`}):(N.schedule_count||0)>0&&Z.push({label:"Schedules",status:"ok",detail:`${N.schedule_count} configured`}),(N.loop_count||0)>0&&Z.push({label:"Loops",status:"ok",detail:`${N.loop_count} active`}),(N.agent_running||0)>0&&Z.push({label:"Agents",status:"ok",detail:`${N.agent_running} running`}),(N.process_running||0)>0&&Z.push({label:"Processes",status:"ok",detail:`${N.process_running} running`}),Z});async function S(){try{e.value=await Q.get("/api/status"),s.value=null}catch(N){s.value=N.message}finally{t.value=!1}}async function R(){a.value=!0;try{n.value=await Q.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function v(){l.value=!0;try{i.value=await Q.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function m(){try{const N=await Q.get("/api/knowledge");c.value=(Array.isArray(N)?N:[]).reduce((Z,ne)=>Z+(ne.chunks||0),0)}catch{c.value=null}}async function x(){try{const N=await Q.get("/api/agents");r.value=N.filter(Z=>Z.status==="running")}catch{}}async function w(){d.value={...d.value,reload:!0};try{await Q.post("/api/reload"),Te.success("Config reloaded")}catch(N){Te.error(N.message)}d.value={...d.value,reload:!1}}async function _(){if(!await bs({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;d.value={...d.value,clearSessions:!0};const Z=e.value.session_count;e.value={...e.value,session_count:0};try{const ne=await Q.post("/api/sessions/clear-all");Te.success(`Cleared ${ne.count} session${ne.count!==1?"s":""}`),await S()}catch(ne){e.value={...e.value,session_count:Z},Te.error(ne.message)}d.value={...d.value,clearSessions:!1}}async function A(){if(!await bs({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;d.value={...d.value,stopLoops:!0};const Z=e.value.loop_count;e.value={...e.value,loop_count:0};try{const ne=await Q.post("/api/loops/stop-all");Te.success(ne.result),await S()}catch(ne){e.value={...e.value,loop_count:Z},Te.error(ne.message)}d.value={...d.value,stopLoops:!1}}function T(){t.value=!0,s.value=null,S(),R(),v(),x()}let C=null,L=null,H=null;function M(N){if(N.payload&&N.payload.tool_name){const Z={...N.payload,_isNew:!0,_key:++u};n.value.unshift(Z),n.value.length>10&&n.value.pop(),o.value++,Z.error&&(i.value.unshift(Z),i.value.length>5&&i.value.pop()),setTimeout(()=>{Z._isNew=!1},1500),clearTimeout(H),H=setTimeout(()=>{o.value=0},1e4)}}return Ye(async()=>{await Promise.all([S(),R(),v(),x(),m()]),C=setInterval(S,15e3),L=setInterval(x,1e4),Ze.subscribe("events",M)}),_t(()=>{C&&clearInterval(C),L&&clearInterval(L),clearTimeout(H),Ze.unsubscribe("events",M)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:g,healthIndicators:y,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:d,fetchActivity:R,fetchStatus:S,formatTime:Dc,formatDuration:ja,retry:T,reloadConfig:w,clearSessions:_,stopAllLoops:A}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Ru(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function Y_(e){if(Array.isArray(e))return e}function Q_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(d){c=!0,a=d}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function X_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function ew(e,t){return Y_(e)||Q_(e,t)||tw(e,t)||X_()}function tw(e,t){if(e){if(typeof e=="string")return Ru(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Ru(e,t):void 0}}const ug=Object.entries,Iu=Object.setPrototypeOf,sw=Object.isFrozen,nw=Object.getPrototypeOf,aw=Object.getOwnPropertyDescriptor;let ts=Object.freeze,Es=Object.seal,ya=Object.create,fg=typeof Reflect<"u"&&Reflect,Io=fg.apply,Oo=fg.construct;ts||(ts=function(t){return t});Es||(Es=function(t){return t});Io||(Io=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});Oo||(Oo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const tn=Ct(Array.prototype.forEach),iw=Ct(Array.prototype.lastIndexOf),Ou=Ct(Array.prototype.pop),ha=Ct(Array.prototype.push),lw=Ct(Array.prototype.splice),Zt=Array.isArray,oi=Ct(String.prototype.toLowerCase),qr=Ct(String.prototype.toString),Lu=Ct(String.prototype.match),ga=Ct(String.prototype.replace),Nu=Ct(String.prototype.indexOf),rw=Ct(String.prototype.trim),ow=Ct(Number.prototype.toString),cw=Ct(Boolean.prototype.toString),Du=typeof BigInt>"u"?null:Ct(BigInt.prototype.toString),Mu=typeof Symbol>"u"?null:Ct(Symbol.prototype.toString),gt=Ct(Object.prototype.hasOwnProperty),ei=Ct(Object.prototype.toString),Pt=Ct(RegExp.prototype.test),Vn=dw(TypeError);function Ct(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return Io(e,t,n)}}function dw(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return Oo(e,s)}}function He(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:oi;if(Iu&&Iu(e,null),!Zt(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(sw(t)||(t[n]=i),a=i)}e[a]=!0}return e}function uw(e){for(let t=0;t<e.length;t++)gt(e,t)||(e[t]=null);return e}function Vt(e){const t=ya(null);for(const n of ug(e)){var s=ew(n,2);const a=s[0],i=s[1];gt(e,a)&&(Zt(i)?t[a]=uw(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Vt(i):t[a]=i)}return t}function fw(e){switch(typeof e){case"string":return e;case"number":return ow(e);case"boolean":return cw(e);case"bigint":return Du?Du(e):"0";case"symbol":return Mu?Mu(e):"Symbol()";case"undefined":return ei(e);case"function":case"object":{if(e===null)return ei(e);const t=e,s=Hs(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:ei(n)}return ei(e)}default:return ei(e)}}function Hs(e,t){for(;e!==null;){const n=aw(e,t);if(n){if(n.get)return Ct(n.get);if(typeof n.value=="function")return Ct(n.value)}e=nw(e)}function s(){return null}return s}function pw(e){try{return Pt(e,""),!0}catch{return!1}}const Pu=ts(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Gr=ts(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Kr=ts(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),hw=ts(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Wr=ts(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),gw=ts(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Fu=ts(["#text"]),$u=ts(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Zr=ts(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Uu=ts(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),dl=ts(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),mw=Es(/{{[\w\W]*|^[\w\W]*}}/g),vw=Es(/<%[\w\W]*|^[\w\W]*%>/g),bw=Es(/\${[\w\W]*/g),yw=Es(/^data-[\-\w.\u00B7-\uFFFF]+$/),xw=Es(/^aria-[\-\w]+$/),Bu=Es(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),_w=Es(/^(?:\w+script|data):/i),ww=Es(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),kw=Es(/^html$/i),Sw=Es(/^[a-z][.\w]*(-[.\w]+)+$/i),$s={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},Tw=function(){return typeof window>"u"?null:window},Cw=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Hu=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function pg(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Tw();const t=ye=>pg(ye);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==$s.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,f=r.prototype,p=Hs(f,"cloneNode"),g=Hs(f,"remove"),y=Hs(f,"nextSibling"),S=Hs(f,"childNodes"),R=Hs(f,"parentNode"),v=Hs(f,"shadowRoot"),m=Hs(f,"attributes"),x=l&&l.prototype?Hs(l.prototype,"nodeType"):null,w=l&&l.prototype?Hs(l.prototype,"nodeName"):null;if(typeof i=="function"){const ye=s.createElement("template");ye.content&&ye.content.ownerDocument&&(s=ye.content.ownerDocument)}let _,A="",T,C=!1,L=0;const H=function(){if(L>0)throw Vn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},M=function(k){H(),L++;try{return _.createHTML(k)}finally{L--}},N=function(k){H(),L++;try{return _.createScriptURL(k)}finally{L--}},Z=function(){return C||(T=Cw(u,a),C=!0),T},ne=s,F=ne.implementation,O=ne.createNodeIterator,E=ne.createDocumentFragment,q=ne.getElementsByTagName,K=n.importNode;let ee=Hu();t.isSupported=typeof ug=="function"&&typeof R=="function"&&F&&F.createHTMLDocument!==void 0;const ie=mw,U=vw,B=bw,de=yw,_e=xw,V=_w,ue=ww,oe=Sw;let be=Bu,me=null;const Be=He({},[...Pu,...Gr,...Kr,...Wr,...Fu]);let b=null;const I=He({},[...$u,...Zr,...Uu,...dl]);let P=Object.seal(ya(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),X=null,J=null;const Y=Object.seal(ya(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let pe=!0,ce=!0,re=!1,se=!0,xe=!1,he=!0,ge=!1,ke=!1,Ce=!1,Oe=!1,Me=!1,Fe=!1,Ve=!0,st=!1;const j="user-content-";let we=!0,Le=!1,De={},Ke=null;const qe=He({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let ht=null;const ss=He({},["audio","video","img","source","image","track"]);let Is=null;const Ps=He({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Fs="http://www.w3.org/1998/Math/MathML",us="http://www.w3.org/2000/svg",G="http://www.w3.org/1999/xhtml";let Re=G,fs=!1,Zs=null;const ca=He({},[Fs,us,G],qr);let wn=He({},["mi","mo","mn","ms","mtext"]),Js=He({},["annotation-xml"]);const D=He({},["title","style","font","a","script"]);let z=null;const ae=["application/xhtml+xml","text/html"],Se="text/html";let Ae=null,Et=null;const $=s.createElement("form"),le=function(k){return k instanceof RegExp||k instanceof Function},Ee=function(){let k=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Et&&Et===k)return;(!k||typeof k!="object")&&(k={}),k=Vt(k),z=ae.indexOf(k.PARSER_MEDIA_TYPE)===-1?Se:k.PARSER_MEDIA_TYPE,Ae=z==="application/xhtml+xml"?qr:oi,me=gt(k,"ALLOWED_TAGS")&&Zt(k.ALLOWED_TAGS)?He({},k.ALLOWED_TAGS,Ae):Be,b=gt(k,"ALLOWED_ATTR")&&Zt(k.ALLOWED_ATTR)?He({},k.ALLOWED_ATTR,Ae):I,Zs=gt(k,"ALLOWED_NAMESPACES")&&Zt(k.ALLOWED_NAMESPACES)?He({},k.ALLOWED_NAMESPACES,qr):ca,Is=gt(k,"ADD_URI_SAFE_ATTR")&&Zt(k.ADD_URI_SAFE_ATTR)?He(Vt(Ps),k.ADD_URI_SAFE_ATTR,Ae):Ps,ht=gt(k,"ADD_DATA_URI_TAGS")&&Zt(k.ADD_DATA_URI_TAGS)?He(Vt(ss),k.ADD_DATA_URI_TAGS,Ae):ss,Ke=gt(k,"FORBID_CONTENTS")&&Zt(k.FORBID_CONTENTS)?He({},k.FORBID_CONTENTS,Ae):qe,X=gt(k,"FORBID_TAGS")&&Zt(k.FORBID_TAGS)?He({},k.FORBID_TAGS,Ae):Vt({}),J=gt(k,"FORBID_ATTR")&&Zt(k.FORBID_ATTR)?He({},k.FORBID_ATTR,Ae):Vt({}),De=gt(k,"USE_PROFILES")?k.USE_PROFILES&&typeof k.USE_PROFILES=="object"?Vt(k.USE_PROFILES):k.USE_PROFILES:!1,pe=k.ALLOW_ARIA_ATTR!==!1,ce=k.ALLOW_DATA_ATTR!==!1,re=k.ALLOW_UNKNOWN_PROTOCOLS||!1,se=k.ALLOW_SELF_CLOSE_IN_ATTR!==!1,xe=k.SAFE_FOR_TEMPLATES||!1,he=k.SAFE_FOR_XML!==!1,ge=k.WHOLE_DOCUMENT||!1,Oe=k.RETURN_DOM||!1,Me=k.RETURN_DOM_FRAGMENT||!1,Fe=k.RETURN_TRUSTED_TYPE||!1,Ce=k.FORCE_BODY||!1,Ve=k.SANITIZE_DOM!==!1,st=k.SANITIZE_NAMED_PROPS||!1,we=k.KEEP_CONTENT!==!1,Le=k.IN_PLACE||!1,be=pw(k.ALLOWED_URI_REGEXP)?k.ALLOWED_URI_REGEXP:Bu,Re=typeof k.NAMESPACE=="string"?k.NAMESPACE:G,wn=gt(k,"MATHML_TEXT_INTEGRATION_POINTS")&&k.MATHML_TEXT_INTEGRATION_POINTS&&typeof k.MATHML_TEXT_INTEGRATION_POINTS=="object"?Vt(k.MATHML_TEXT_INTEGRATION_POINTS):He({},["mi","mo","mn","ms","mtext"]),Js=gt(k,"HTML_INTEGRATION_POINTS")&&k.HTML_INTEGRATION_POINTS&&typeof k.HTML_INTEGRATION_POINTS=="object"?Vt(k.HTML_INTEGRATION_POINTS):He({},["annotation-xml"]);const W=gt(k,"CUSTOM_ELEMENT_HANDLING")&&k.CUSTOM_ELEMENT_HANDLING&&typeof k.CUSTOM_ELEMENT_HANDLING=="object"?Vt(k.CUSTOM_ELEMENT_HANDLING):ya(null);if(P=ya(null),gt(W,"tagNameCheck")&&le(W.tagNameCheck)&&(P.tagNameCheck=W.tagNameCheck),gt(W,"attributeNameCheck")&&le(W.attributeNameCheck)&&(P.attributeNameCheck=W.attributeNameCheck),gt(W,"allowCustomizedBuiltInElements")&&typeof W.allowCustomizedBuiltInElements=="boolean"&&(P.allowCustomizedBuiltInElements=W.allowCustomizedBuiltInElements),xe&&(ce=!1),Me&&(Oe=!0),De&&(me=He({},Fu),b=ya(null),De.html===!0&&(He(me,Pu),He(b,$u)),De.svg===!0&&(He(me,Gr),He(b,Zr),He(b,dl)),De.svgFilters===!0&&(He(me,Kr),He(b,Zr),He(b,dl)),De.mathMl===!0&&(He(me,Wr),He(b,Uu),He(b,dl))),Y.tagCheck=null,Y.attributeCheck=null,gt(k,"ADD_TAGS")&&(typeof k.ADD_TAGS=="function"?Y.tagCheck=k.ADD_TAGS:Zt(k.ADD_TAGS)&&(me===Be&&(me=Vt(me)),He(me,k.ADD_TAGS,Ae))),gt(k,"ADD_ATTR")&&(typeof k.ADD_ATTR=="function"?Y.attributeCheck=k.ADD_ATTR:Zt(k.ADD_ATTR)&&(b===I&&(b=Vt(b)),He(b,k.ADD_ATTR,Ae))),gt(k,"ADD_URI_SAFE_ATTR")&&Zt(k.ADD_URI_SAFE_ATTR)&&He(Is,k.ADD_URI_SAFE_ATTR,Ae),gt(k,"FORBID_CONTENTS")&&Zt(k.FORBID_CONTENTS)&&(Ke===qe&&(Ke=Vt(Ke)),He(Ke,k.FORBID_CONTENTS,Ae)),gt(k,"ADD_FORBID_CONTENTS")&&Zt(k.ADD_FORBID_CONTENTS)&&(Ke===qe&&(Ke=Vt(Ke)),He(Ke,k.ADD_FORBID_CONTENTS,Ae)),we&&(me["#text"]=!0),ge&&He(me,["html","head","body"]),me.table&&(He(me,["tbody"]),delete X.tbody),k.TRUSTED_TYPES_POLICY){if(typeof k.TRUSTED_TYPES_POLICY.createHTML!="function")throw Vn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof k.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Vn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const fe=_;_=k.TRUSTED_TYPES_POLICY;try{A=M("")}catch(Ne){throw _=fe,Ne}}else k.TRUSTED_TYPES_POLICY===null?(_=void 0,A=""):(_===void 0&&(_=Z()),_&&typeof A=="string"&&(A=M("")));(ee.uponSanitizeElement.length>0||ee.uponSanitizeAttribute.length>0)&&me===Be&&(me=Vt(me)),ee.uponSanitizeAttribute.length>0&&b===I&&(b=Vt(b)),ts&&ts(k),Et=k},nt=He({},[...Gr,...Kr,...hw]),ot=He({},[...Wr,...gw]),ns=function(k){let W=R(k);(!W||!W.tagName)&&(W={namespaceURI:Re,tagName:"template"});const fe=oi(k.tagName),Ne=oi(W.tagName);return Zs[k.namespaceURI]?k.namespaceURI===us?W.namespaceURI===G?fe==="svg":W.namespaceURI===Fs?fe==="svg"&&(Ne==="annotation-xml"||wn[Ne]):!!nt[fe]:k.namespaceURI===Fs?W.namespaceURI===G?fe==="math":W.namespaceURI===us?fe==="math"&&Js[Ne]:!!ot[fe]:k.namespaceURI===G?W.namespaceURI===us&&!Js[Ne]||W.namespaceURI===Fs&&!wn[Ne]?!1:!ot[fe]&&(D[fe]||!nt[fe]):!!(z==="application/xhtml+xml"&&Zs[k.namespaceURI]):!1},ps=function(k){ha(t.removed,{element:k});try{R(k).removeChild(k)}catch{if(g(k),!R(k))throw Vn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},qc=function(k){const W=S?S(k):k.childNodes;if(W){const Ne=[];tn(W,$e=>{ha(Ne,$e)}),tn(Ne,$e=>{try{g($e)}catch{}})}const fe=m?m(k):null;if(fe)for(let Ne=fe.length-1;Ne>=0;--Ne){const $e=fe[Ne],je=$e&&$e.name;if(typeof je=="string")try{k.removeAttribute(je)}catch{}}},Un=function(k,W){try{ha(t.removed,{attribute:W.getAttributeNode(k),from:W})}catch{ha(t.removed,{attribute:null,from:W})}if(W.removeAttribute(k),k==="is")if(Oe||Me)try{ps(W)}catch{}else try{W.setAttribute(k,"")}catch{}},Mg=function(k){const W=m?m(k):k.attributes;if(W)for(let fe=W.length-1;fe>=0;--fe){const Ne=W[fe],$e=Ne&&Ne.name;if(!(typeof $e!="string"||b[Ae($e)]))try{k.removeAttribute($e)}catch{}}},Pg=function(k){const W=[k];for(;W.length>0;){const fe=W.pop();(x?x(fe):fe.nodeType)===$s.element&&Mg(fe);const $e=S?S(fe):fe.childNodes;if($e)for(let je=$e.length-1;je>=0;--je)W.push($e[je])}},Gc=function(k){let W=null,fe=null;if(Ce)k="<remove></remove>"+k;else{const je=Lu(k,/^[\r\n\t ]+/);fe=je&&je[0]}z==="application/xhtml+xml"&&Re===G&&(k='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+k+"</body></html>");const Ne=_?M(k):k;if(Re===G)try{W=new d().parseFromString(Ne,z)}catch{}if(!W||!W.documentElement){W=F.createDocument(Re,"template",null);try{W.documentElement.innerHTML=fs?A:Ne}catch{}}const $e=W.body||W.documentElement;return k&&fe&&$e.insertBefore(s.createTextNode(fe),$e.childNodes[0]||null),Re===G?q.call(W,ge?"html":"body")[0]:ge?W.documentElement:$e},Kc=function(k){return O.call(k.ownerDocument||k,k,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},Tr=function(k){var W,fe;k.normalize();const Ne=O.call(k.ownerDocument||k,k,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let $e=Ne.nextNode();for(;$e;){let At=$e.data;tn([ie,U,B],ct=>{At=ga(At,ct," ")}),$e.data=At,$e=Ne.nextNode()}const je=(W=(fe=k.querySelectorAll)===null||fe===void 0?void 0:fe.call(k,"template"))!==null&&W!==void 0?W:[];tn(Array.from(je),At=>{da(At.content)&&Tr(At.content)})},Zi=function(k){const W=w?w(k):null;return typeof W!="string"||Ae(W)!=="form"?!1:typeof k.nodeName!="string"||typeof k.textContent!="string"||typeof k.removeChild!="function"||k.attributes!==m(k)||typeof k.removeAttribute!="function"||typeof k.setAttribute!="function"||typeof k.namespaceURI!="string"||typeof k.insertBefore!="function"||typeof k.hasChildNodes!="function"||k.nodeType!==x(k)||k.childNodes!==S(k)},da=function(k){if(!x||typeof k!="object"||k===null)return!1;try{return x(k)===$s.documentFragment}catch{return!1}},Ka=function(k){if(!x||typeof k!="object"||k===null)return!1;try{return typeof x(k)=="number"}catch{return!1}};function Ys(ye,k,W){tn(ye,fe=>{fe.call(t,k,W,Et)})}const Wc=function(k){let W=null;if(Ys(ee.beforeSanitizeElements,k,null),Zi(k))return ps(k),!0;const fe=Ae(w?w(k):k.nodeName);if(Ys(ee.uponSanitizeElement,k,{tagName:fe,allowedTags:me}),he&&k.hasChildNodes()&&!Ka(k.firstElementChild)&&Pt(/<[/\w!]/g,k.innerHTML)&&Pt(/<[/\w!]/g,k.textContent)||he&&k.namespaceURI===G&&fe==="style"&&Ka(k.firstElementChild)||k.nodeType===$s.progressingInstruction||he&&k.nodeType===$s.comment&&Pt(/<[/\w]/g,k.data))return ps(k),!0;if(X[fe]||!(Y.tagCheck instanceof Function&&Y.tagCheck(fe))&&!me[fe]){if(!X[fe]&&Jc(fe)&&(P.tagNameCheck instanceof RegExp&&Pt(P.tagNameCheck,fe)||P.tagNameCheck instanceof Function&&P.tagNameCheck(fe)))return!1;if(we&&!Ke[fe]){const $e=R(k),je=S(k);if(je&&$e){const At=je.length;for(let ct=At-1;ct>=0;--ct){const bt=Le?je[ct]:p(je[ct],!0);$e.insertBefore(bt,y(k))}}}return ps(k),!0}return(x?x(k):k.nodeType)===$s.element&&!ns(k)||(fe==="noscript"||fe==="noembed"||fe==="noframes")&&Pt(/<\/no(script|embed|frames)/i,k.innerHTML)?(ps(k),!0):(xe&&k.nodeType===$s.text&&(W=k.textContent,tn([ie,U,B],$e=>{W=ga(W,$e," ")}),k.textContent!==W&&(ha(t.removed,{element:k.cloneNode()}),k.textContent=W)),Ys(ee.afterSanitizeElements,k,null),!1)},Zc=function(k,W,fe){if(J[W]||Ve&&(W==="id"||W==="name")&&(fe in s||fe in $))return!1;const Ne=b[W]||Y.attributeCheck instanceof Function&&Y.attributeCheck(W,k);if(!(ce&&!J[W]&&Pt(de,W))){if(!(pe&&Pt(_e,W))){if(!Ne||J[W]){if(!(Jc(k)&&(P.tagNameCheck instanceof RegExp&&Pt(P.tagNameCheck,k)||P.tagNameCheck instanceof Function&&P.tagNameCheck(k))&&(P.attributeNameCheck instanceof RegExp&&Pt(P.attributeNameCheck,W)||P.attributeNameCheck instanceof Function&&P.attributeNameCheck(W,k))||W==="is"&&P.allowCustomizedBuiltInElements&&(P.tagNameCheck instanceof RegExp&&Pt(P.tagNameCheck,fe)||P.tagNameCheck instanceof Function&&P.tagNameCheck(fe))))return!1}else if(!Is[W]){if(!Pt(be,ga(fe,ue,""))){if(!((W==="src"||W==="xlink:href"||W==="href")&&k!=="script"&&Nu(fe,"data:")===0&&ht[k])){if(!(re&&!Pt(V,ga(fe,ue,"")))){if(fe)return!1}}}}}}return!0},Fg=He({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Jc=function(k){return!Fg[oi(k)]&&Pt(oe,k)},Yc=function(k){Ys(ee.beforeSanitizeAttributes,k,null);const W=k.attributes;if(!W||Zi(k))return;const fe={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:b,forceKeepAttr:void 0};let Ne=W.length;for(;Ne--;){const $e=W[Ne],je=$e.name,At=$e.namespaceURI,ct=$e.value,bt=Ae(je),kn=ct;let Nt=je==="value"?kn:rw(kn);if(fe.attrName=bt,fe.attrValue=Nt,fe.keepAttr=!0,fe.forceKeepAttr=void 0,Ys(ee.uponSanitizeAttribute,k,fe),Nt=fe.attrValue,st&&(bt==="id"||bt==="name")&&Nu(Nt,j)!==0&&(Un(je,k),Nt=j+Nt),he&&Pt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Nt)){Un(je,k);continue}if(bt==="attributename"&&Lu(Nt,"href")){Un(je,k);continue}if(fe.forceKeepAttr)continue;if(!fe.keepAttr){Un(je,k);continue}if(!se&&Pt(/\/>/i,Nt)){Un(je,k);continue}xe&&tn([ie,U,B],Xc=>{Nt=ga(Nt,Xc," ")});const Qc=Ae(k.nodeName);if(!Zc(Qc,bt,Nt)){Un(je,k);continue}if(_&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!At)switch(u.getAttributeType(Qc,bt)){case"TrustedHTML":{Nt=M(Nt);break}case"TrustedScriptURL":{Nt=N(Nt);break}}if(Nt!==kn)try{At?k.setAttributeNS(At,je,Nt):k.setAttribute(je,Nt),Zi(k)?ps(k):Ou(t.removed)}catch{Un(je,k)}}Ys(ee.afterSanitizeAttributes,k,null)},Ji=function(k){let W=null;const fe=Kc(k);for(Ys(ee.beforeSanitizeShadowDOM,k,null);W=fe.nextNode();)if(Ys(ee.uponSanitizeShadowNode,W,null),Wc(W),Yc(W),da(W.content)&&Ji(W.content),(x?x(W):W.nodeType)===$s.element){const $e=v?v(W):W.shadowRoot;da($e)&&(Cr($e),Ji($e))}Ys(ee.afterSanitizeShadowDOM,k,null)},Cr=function(k){const W=[{node:k,shadow:null}];for(;W.length>0;){const fe=W.pop();if(fe.shadow){Ji(fe.shadow);continue}const Ne=fe.node,je=(x?x(Ne):Ne.nodeType)===$s.element,At=S?S(Ne):Ne.childNodes;if(At)for(let ct=At.length-1;ct>=0;--ct)W.push({node:At[ct],shadow:null});if(je){const ct=w?w(Ne):null;if(typeof ct=="string"&&Ae(ct)==="template"){const bt=Ne.content;da(bt)&&W.push({node:bt,shadow:null})}}if(je){const ct=v?v(Ne):Ne.shadowRoot;da(ct)&&W.push({node:null,shadow:ct},{node:ct,shadow:null})}}};return t.sanitize=function(ye){let k=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},W=null,fe=null,Ne=null,$e=null;if(fs=!ye,fs&&(ye="<!-->"),typeof ye!="string"&&!Ka(ye)&&(ye=fw(ye),typeof ye!="string"))throw Vn("dirty is not a string, aborting");if(!t.isSupported)return ye;ke||Ee(k),t.removed=[];const je=Le&&typeof ye!="string"&&Ka(ye);if(je){const bt=w?w(ye):ye.nodeName;if(typeof bt=="string"){const kn=Ae(bt);if(!me[kn]||X[kn])throw Vn("root node is forbidden and cannot be sanitized in-place")}if(Zi(ye))throw Vn("root node is clobbered and cannot be sanitized in-place");try{Cr(ye)}catch(kn){throw qc(ye),kn}}else if(Ka(ye))W=Gc("<!---->"),fe=W.ownerDocument.importNode(ye,!0),fe.nodeType===$s.element&&fe.nodeName==="BODY"||fe.nodeName==="HTML"?W=fe:W.appendChild(fe),Cr(fe);else{if(!Oe&&!xe&&!ge&&ye.indexOf("<")===-1)return _&&Fe?M(ye):ye;if(W=Gc(ye),!W)return Oe?null:Fe?A:""}W&&Ce&&ps(W.firstChild);const At=Kc(je?ye:W);try{for(;Ne=At.nextNode();)Wc(Ne),Yc(Ne),da(Ne.content)&&Ji(Ne.content)}catch(bt){throw je&&qc(ye),bt}if(je)return tn(t.removed,bt=>{bt.element&&Pg(bt.element)}),xe&&Tr(ye),ye;if(Oe){if(xe&&Tr(W),Me)for($e=E.call(W.ownerDocument);W.firstChild;)$e.appendChild(W.firstChild);else $e=W;return(b.shadowroot||b.shadowrootmode)&&($e=K.call(n,$e,!0)),$e}let ct=ge?W.outerHTML:W.innerHTML;return ge&&me["!doctype"]&&W.ownerDocument&&W.ownerDocument.doctype&&W.ownerDocument.doctype.name&&Pt(kw,W.ownerDocument.doctype.name)&&(ct="<!DOCTYPE "+W.ownerDocument.doctype.name+`>
`+ct),xe&&tn([ie,U,B],bt=>{ct=ga(ct,bt," ")}),_&&Fe?M(ct):ct},t.setConfig=function(){let ye=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Ee(ye),ke=!0},t.clearConfig=function(){Et=null,ke=!1,_=T,A=""},t.isValidAttribute=function(ye,k,W){Et||Ee({});const fe=Ae(ye),Ne=Ae(k);return Zc(fe,Ne,W)},t.addHook=function(ye,k){typeof k=="function"&&ha(ee[ye],k)},t.removeHook=function(ye,k){if(k!==void 0){const W=iw(ee[ye],k);return W===-1?void 0:lw(ee[ye],W,1)[0]}return Ou(ee[ye])},t.removeHooks=function(ye){ee[ye]=[]},t.removeAllHooks=function(){ee=Hu()},t}var Vu=pg();function Pc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var oa=Pc();function hg(e){oa=e}var vi={exec:()=>null};function it(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Qt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var Qt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},Ew=/^(?:[ \t]*(?:\n|$))+/,Aw=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Rw=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Wi=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Iw=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Fc=/(?:[*+-]|\d{1,9}[.)])/,gg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,mg=it(gg).replace(/bull/g,Fc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Ow=it(gg).replace(/bull/g,Fc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),$c=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Lw=/^[^\n]+/,Uc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Nw=it(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Uc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Dw=it(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Fc).getRegex(),wr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Bc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Mw=it("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Bc).replace("tag",wr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),vg=it($c).replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",wr).getRegex(),Pw=it(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",vg).getRegex(),Hc={blockquote:Pw,code:Aw,def:Nw,fences:Rw,heading:Iw,hr:Wi,html:Mw,lheading:mg,list:Dw,newline:Ew,paragraph:vg,table:vi,text:Lw},ju=it("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",wr).getRegex(),Fw={...Hc,lheading:Ow,table:ju,paragraph:it($c).replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ju).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",wr).getRegex()},$w={...Hc,html:it(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Bc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:vi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:it($c).replace("hr",Wi).replace("heading",` *#{1,6} *[^
]`).replace("lheading",mg).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Uw=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Bw=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,bg=/^( {2,}|\\)\n(?!\s*$)/,Hw=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,kr=/[\p{P}\p{S}]/u,Vc=/[\s\p{P}\p{S}]/u,yg=/[^\s\p{P}\p{S}]/u,Vw=it(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Vc).getRegex(),xg=/(?!~)[\p{P}\p{S}]/u,jw=/(?!~)[\s\p{P}\p{S}]/u,zw=/(?:[^\s\p{P}\p{S}]|~)/u,qw=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,_g=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Gw=it(_g,"u").replace(/punct/g,kr).getRegex(),Kw=it(_g,"u").replace(/punct/g,xg).getRegex(),wg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Ww=it(wg,"gu").replace(/notPunctSpace/g,yg).replace(/punctSpace/g,Vc).replace(/punct/g,kr).getRegex(),Zw=it(wg,"gu").replace(/notPunctSpace/g,zw).replace(/punctSpace/g,jw).replace(/punct/g,xg).getRegex(),Jw=it("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,yg).replace(/punctSpace/g,Vc).replace(/punct/g,kr).getRegex(),Yw=it(/\\(punct)/,"gu").replace(/punct/g,kr).getRegex(),Qw=it(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Xw=it(Bc).replace("(?:-->|$)","-->").getRegex(),ek=it("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Xw).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Kl=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,tk=it(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Kl).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),kg=it(/^!?\[(label)\]\[(ref)\]/).replace("label",Kl).replace("ref",Uc).getRegex(),Sg=it(/^!?\[(ref)\](?:\[\])?/).replace("ref",Uc).getRegex(),sk=it("reflink|nolink(?!\\()","g").replace("reflink",kg).replace("nolink",Sg).getRegex(),jc={_backpedal:vi,anyPunctuation:Yw,autolink:Qw,blockSkip:qw,br:bg,code:Bw,del:vi,emStrongLDelim:Gw,emStrongRDelimAst:Ww,emStrongRDelimUnd:Jw,escape:Uw,link:tk,nolink:Sg,punctuation:Vw,reflink:kg,reflinkSearch:sk,tag:ek,text:Hw,url:vi},nk={...jc,link:it(/^!?\[(label)\]\((.*?)\)/).replace("label",Kl).getRegex(),reflink:it(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Kl).getRegex()},Lo={...jc,emStrongRDelimAst:Zw,emStrongLDelim:Kw,url:it(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},ak={...Lo,br:it(bg).replace("{2,}","*").getRegex(),text:it(Lo.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ul={normal:Hc,gfm:Fw,pedantic:$w},ti={normal:jc,gfm:Lo,breaks:ak,pedantic:nk},ik={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},zu=e=>ik[e];function Vs(e,t){if(t){if(Qt.escapeTest.test(e))return e.replace(Qt.escapeReplace,zu)}else if(Qt.escapeTestNoEncode.test(e))return e.replace(Qt.escapeReplaceNoEncode,zu);return e}function qu(e){try{e=encodeURI(e).replace(Qt.percentDecode,"%")}catch{return null}return e}function Gu(e,t){var i;const s=e.replace(Qt.findPipe,(l,r,o)=>{let c=!1,d=r;for(;--d>=0&&o[d]==="\\";)c=!c;return c?"|":" |"}),n=s.split(Qt.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(Qt.slashPipe,"|");return n}function si(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function lk(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function Ku(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function rk(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
`)}var Wl=class{constructor(e){rt(this,"options");rt(this,"rules");rt(this,"lexer");this.options=e||oa}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const s=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?s:si(s,`
...
`)}}return}}let i=null;function l(){const f=Date.now();e.value.forEach(p=>{p.status==="running"&&(p.elapsed=f-p.startTime)})}let r=!1;function o(){r||(r=!0,Ze.on("events",a),i||(i=setInterval(l,500)))}function c(){r&&(r=!1,Ze.off("events",a),i&&(clearInterval(i),i=null))}Ye(o),As(o),Rs(c),_t(c);function d(f){return f<1e3?`${f}ms`:`${(f/1e3).toFixed(1)}s`}function u(f){return f==="running"?"clock":f==="success"?"success":f==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
  ...
  `},Tg=Symbol("agent-detail-cancelled"),mk=15e3;function vk(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((p,g)=>{o=p,c=g});function u(p,g){r||(r=!0,l!==null&&a(l),l=null,(p?o:c)(g))}let f;try{f=e(i==null?void 0:i.signal)}catch(p){u(!1,p)}return r||Promise.resolve(f).then(p=>u(!0,p),p=>u(!1,p)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const p=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${p}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Tg),i==null||i.abort()}}}function Cg({state:e,requestDetail:t,timeoutMs:s=mk,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const f=l;l=null,f==null||f.cancel()}function o(f,{initial:p,coalesce:g}){if(!f)return Promise.resolve();if(g&&l&&l.agentId===f&&e.detailId===f)return l.promise;r();const y={agentId:f,cancel:null,promise:null};l=y,p?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const S=vk(R=>t(f,{signal:R}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return y.cancel=S.cancel,y.promise=(async()=>{let R=null,v=null;try{R=await S.promise}catch(m){v=m}R!==Tg&&(l!==y||e.detailId!==f||(l=null,!v&&(R===null||typeof R!="object")&&(v=new Error(`${n} response was empty or invalid`)),v?e.detail===null&&(e.detailError=(v==null?void 0:v.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=R,e.detailError=null),e.detailLoading=!1))})(),y.promise}function c(f){return e.detailId=f,o(f,{initial:!0,coalesce:!1})}function d(){const f=e.detailId;return f?o(f,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function bk({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const yk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h(null),d=h(null),u=h(!1),f=h(null),p=h("");let g=!1;const S=Cg({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return f.value},set detailError(O){f.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:E})=>Q.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:E})});async function R(O){p.value="",await S.open(O.id)}function v(){S.close(),p.value=""}async function m(O,E){try{await navigator.clipboard.writeText(E||""),p.value=O,setTimeout(()=>{p.value===O&&(p.value="")},1500)}catch{Te.error("Copy failed")}}const x=te(()=>e.value.reduce((O,E)=>O+(E.iteration_count||0),0)),w=te(()=>e.value.filter(O=>O.status==="running").length);function _(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function A(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function T(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function C(O=!1){O=O===!0,O||(t.value=!0);try{const E=await Q.get("/api/loops");e.value=Array.isArray(E)?E:[],s.value=null}catch(E){O||(s.value=E.message)}O||(t.value=!1)}async function L(){l.value=null;const O=a.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const E={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&(E.stop_condition=O.stop_condition.trim()),i.value=!0;try{const q=await Q.post("/api/loops",E);Te.success(`Loop started: ${q.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await C()}catch(q){l.value=q.message}i.value=!1}async function H(O){if(await bs({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=O;try{await Q.del(`/api/loops/${encodeURIComponent(O)}`),Te.success("Loop stopped"),await C()}catch(q){Te.error(q.message||"Failed to stop loop")}r.value=null}}async function M(O){o.value=O;try{await Q.post(`/api/loops/${encodeURIComponent(O)}/restart`),Te.success("Loop restarted"),await C()}catch(E){Te.error(E.message||"Failed to restart loop")}o.value=null}function N(O){g&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(C(!0),d.value&&S.refresh())}let Z=null;function ne(){Z!==null&&clearInterval(Z),Z=null}function F(){ne(),g&&(Z=setInterval(()=>{C(!0),d.value&&S.refresh()},5e3))}return Ye(()=>{g=!0,C(),Ze.subscribe("events",N),F()}),As(()=>{g=!0,C(!0),F()}),Rs(()=>{g=!1,ne()}),_t(()=>{g=!1,Ze.unsubscribe("events",N),ne(),S.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:f,copied:p,totalIterations:x,runningCount:w,statusDotClass:_,statusBadge:A,modeBadge:T,formatAge:rg,formatDuration:ja,formatTs:ra,formatTokens:dg,openDetail:R,closeDetail:v,copyText:m,fetchLoops:C,doCreate:L,doStop:H,doRestart:M}}},_k={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=te(()=>Tk(a.value.run_at));Xt(()=>a.value.run_at,()=>{r.value=null});const c=te(()=>{var B;const U=o.value;return U.state==="ok"?U.instant:U.state==="ambiguous"&&r.value!==null&&((B=U.options[r.value])==null?void 0:B.instant)||null}),d=te(()=>{const U=c.value;return U?`${U.toLocaleString()} local — ${U.toISOString()} UTC`:""}),u=h(null),f=h(!1),p=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],g=h(null),y=h(null),S=h(null),R=h(null),v=h(null),m=h([]),x=h(!1),w=h("");let _=0;const A=te(()=>e.value.filter(U=>U.cron&&!U.one_time).length),T=te(()=>e.value.filter(U=>U.one_time).length),C=te(()=>e.value.filter(U=>U.trigger).length),L=te(()=>e.value.filter(U=>U.paused).length),H=te(()=>e.value.filter(U=>U.consecutive_failures>0).length);function M(U){if(!U)return"-";const B=Date.now(),_e=(new Date(U).getTime()-B)/1e3;if(_e<0)return"overdue";if(_e<60)return"in < 1 min";if(_e<3600)return`in ${Math.floor(_e/60)} min`;if(_e<86400){const ue=Math.floor(_e/3600),oe=Math.floor(_e%3600/60);return oe>0?`in ${ue}h ${oe}m`:`in ${ue}h`}const V=Math.floor(_e/86400);return`in ${V} day${V!==1?"s":""}`}function N(U){return U==null?"-":U<1e3?`${U}ms`:U<6e4?`${(U/1e3).toFixed(1)}s`:ja(U/1e3)}function Z(){u.value=null}async function ne(){const U=a.value.cron.trim();if(U){f.value=!0;try{u.value=await Q.post("/api/schedules/validate-cron",{expression:U})}catch(B){u.value={valid:!1,error:B.message}}f.value=!1}}async function F(){t.value=!0,s.value=null;try{e.value=await Q.get("/api/schedules")}catch(U){s.value=U.message}t.value=!1}async function O(U){if(v.value===U){v.value=null,m.value=[];return}v.value=U,x.value=!0,m.value=[];const B=++_;try{const de=await Q.get(`/api/schedules/${encodeURIComponent(U)}/history?limit=10`);if(B!==_||v.value!==U)return;m.value=de,w.value=""}catch(de){if(B!==_||v.value!==U)return;m.value=[],w.value=de.message||"Failed to load execution history"}B===_&&(x.value=!1)}async function E(){l.value=null;const U=a.value;if(!U.description.trim()){l.value="Description is required";return}if(!U.channel_id.trim()){l.value="Channel ID is required";return}if(!U.cron.trim()&&!U.run_at.trim()){l.value="Cron expression or run_at time is required";return}const B={description:U.description.trim(),action:U.action,channel_id:U.channel_id.trim()};if(U.cron.trim()&&(B.cron=U.cron.trim()),U.run_at.trim()){const de=o.value;if(de.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(de.state==="invalid"){l.value="One-time run time is not a valid date";return}const _e=c.value;if(de.state==="ambiguous"&&r.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!_e){l.value="One-time run time could not be resolved";return}B.run_at=_e.toISOString()}if(U.action==="reminder"&&U.message.trim()&&(B.message=U.message.trim()),U.action==="check"&&(U.tool_name.trim()&&(B.tool_name=U.tool_name.trim()),U.tool_input_str.trim()))try{B.tool_input=JSON.parse(U.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await Q.post("/api/schedules",B),Te.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},u.value=null,n.value=!1,await F()}catch(de){l.value=de.message}i.value=!1}async function q(U){g.value=U;try{const B=await Q.post(`/api/schedules/${encodeURIComponent(U)}/run`);if(B.status==="failure")Te.error(`Execution failed: ${B.error||"unknown error"}`);else{const de=B.warning?`Executed (${B.warning})`:"Executed successfully";Te.success(de)}await F()}catch(B){Te.error(B.message||"Failed to trigger")}g.value=null}async function K(U){S.value=U.id;const B=!U.paused;try{await Q.put(`/api/schedules/${encodeURIComponent(U.id)}`,{paused:B}),Te.success(B?"Schedule paused":"Schedule resumed"),await F()}catch(de){Te.error(de.message||"Failed to update schedule")}S.value=null}async function ee(U){R.value=U;try{await Q.post(`/api/schedules/${encodeURIComponent(U)}/reset-failures`),Te.success("Failure counters reset"),await F()}catch(B){Te.error(B.message||"Failed to reset")}R.value=null}async function ie(U){const B=e.value.find(_e=>_e.id===U);if(await bs({title:"Delete schedule",message:`Delete "${(B==null?void 0:B.description)||U}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){y.value=U;try{await Q.del(`/api/schedules/${encodeURIComponent(U)}`),Te.success("Schedule deleted"),await F()}catch(_e){Te.error(_e.message||"Failed to delete schedule")}y.value=null}}return Ye(()=>{F()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:o,runAtOccurrence:r,cronResult:u,validatingCron:f,cronPresets:p,runningId:g,deletingId:y,togglingId:S,resettingId:R,expandedId:v,history:m,historyLoading:x,historyError:w,cronCount:A,oneTimeCount:T,webhookCount:C,pausedCount:L,failingCount:H,formatTs:ra,formatAge:rg,formatFuture:M,formatMs:N,formatDuration:ja,onCronInput:Z,validateCron:ne,toggleExpand:O,fetchSchedules:F,doCreate:E,doRunNow:q,doTogglePause:K,doResetFailures:ee,doDelete:ie}}},Ek={components:{TabbedPage:Sr},setup(){return{tabs:[{id:"live",label:"Live",component:gk},{id:"agents",label:"Agents",component:yk},{id:"loops",label:"Loops",component:xk},{id:"processes",label:"Processes",component:_k},{id:"schedules",label:"Schedules",component:Ck}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Ak={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const r=h(null),o=h(!1),c=h(new Set),d=h(!1),u=h("all"),f=h(""),p=h("last_active"),g=h(!1),y=Ju,S=Rk,R=h([]),v=h(!1),m=h(""),x=h("flat"),w=h(new Set),_=h(""),A=h(""),T=h(""),C=h(null),L=h(!1);function H(){try{const j=localStorage.getItem("odin-session-presets");j&&(R.value=JSON.parse(j))}catch{}}function M(){try{localStorage.setItem("odin-session-presets",JSON.stringify(R.value))}catch{}}const N=te(()=>f.value.trim()!==""||u.value!=="all"),Z=te(()=>{let j=[...e.value];const we=Ju.find(qe=>qe.id===u.value),Le=we?we.filters:{};if(Le.source&&(j=j.filter(qe=>qe.source===Le.source)),Le.minMessages&&(j=j.filter(qe=>qe.message_count>=Le.minMessages)),Le.hasCompaction&&(j=j.filter(qe=>qe.has_summary)),Le.maxAge!=null){const qe=Date.now()/1e3;j=j.filter(ht=>ht.last_active&&qe-ht.last_active<=Le.maxAge)}if(f.value.trim()){const qe=f.value.toLowerCase().trim();j=j.filter(ht=>(ht.channel_id||"").toLowerCase().includes(qe)||(ht.last_user_id||"").toLowerCase().includes(qe)||(ht.source||"").toLowerCase().includes(qe))}const De=p.value,Ke=g.value?1:-1;return j.sort((qe,ht)=>{const ss=qe[De]||0,Is=ht[De]||0;return(ss-Is)*Ke}),j}),ne=te(()=>{if(!a.value||!a.value.messages)return[];const j=a.value.messages;if(j.length===0)return[];const we=[];let Le=[];for(const De of j)De.role==="user"&&Le.length>0&&(we.push(Le),Le=[]),Le.push(De);return Le.length>0&&we.push(Le),we}),F=te(()=>Z.value.length>0&&c.value.size===Z.value.length);function O(j){const we=j.find(Le=>Le.role==="user");if(we&&we.content){const Le=we.content.slice(0,120);return Le.length<we.content.length?Le+"...":Le}return"(no user message)"}function E(j){const we=new Set(w.value);we.has(j)?we.delete(j):we.add(j),w.value=we}function q(j){u.value=j}function K(j){u.value=j.id,j.filters.searchQuery!=null&&(f.value=j.filters.searchQuery),j.filters.sortBy&&(p.value=j.filters.sortBy)}function ee(){if(!m.value.trim())return;const j={id:"custom-"+Date.now(),name:m.value.trim(),filters:{searchQuery:f.value,sortBy:p.value}};R.value=[...R.value,j],M(),v.value=!1,m.value=""}function ie(j){R.value=R.value.filter(we=>we.id!==j),M(),u.value===j&&(u.value="all")}function U(){u.value="all",f.value="",p.value="last_active",g.value=!1}function B(j){if(!j)return"—";const we=Date.now()/1e3-j;if(we<60)return"just now";if(we<3600){const De=Math.floor(we/60);return`${De} minute${De!==1?"s":""} ago`}if(we<86400){const De=Math.floor(we/3600);return`${De} hour${De!==1?"s":""} ago`}const Le=Math.floor(we/86400);return`${Le} day${Le!==1?"s":""} ago`}function de(j){if(!j)return"";try{return new Date(j*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function _e(j){if(!j)return"";try{return new Date(j*1e3).toLocaleString()}catch{return""}}function V(j){return j==="user"?"bg-gray-900/50 border border-gray-800":j==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ue(j){return j==="user"?"sess-msg-user":j==="assistant"?"sess-msg-assistant":"sess-msg-system"}function oe(j){return j==="user"?"badge-info":j==="assistant"?"badge-success":"badge-warning"}function be(j){return j==="user"?"sess-dot-user":j==="assistant"?"sess-dot-assistant":"sess-dot-system"}function me(j){return j==="user"?"text-cyan-400":j==="assistant"?"text-indigo-400":"text-gray-500"}function Be(j){return j?j.length>2e3?j.slice(0,2e3)+`
... (truncated)`:j:""}async function b(){const j=_.value.trim();if(j){L.value=!0;try{let we=`/api/sessions/search?q=${encodeURIComponent(j)}&limit=50`;A.value.trim()&&(we+=`&channel_id=${encodeURIComponent(A.value.trim())}`),T.value.trim()&&(we+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Le=await Q.get(we);C.value=Le.results||[]}catch{C.value=[]}L.value=!1}}function I(){_.value="",A.value="",T.value="",C.value=null}function P(j){return j?j.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function X(j){return j==="user"?"fts-result-user":j==="assistant"?"fts-result-assistant":j==="summary"?"fts-result-summary":j==="fts"?"fts-result-fts":j==="channel"?"fts-result-channel":"fts-result-default"}function J(j){return j==="user"?"badge-info":j==="assistant"?"badge-success":j==="summary"?"badge-warning":j==="fts"?"badge-success":"badge-info"}async function Y(){t.value=!0,s.value=null;try{e.value=await Q.get("/api/sessions")}catch(j){s.value=j.message}t.value=!1}function pe(){s.value=null,Y()}async function ce(j){if(n.value===j){n.value=null,a.value=null,w.value=new Set;return}n.value=j,a.value=null,i.value=!0,w.value=new Set;const we=++l;try{const Le=await Q.get(`/api/sessions/${encodeURIComponent(j)}`);we===l&&n.value===j&&(a.value=Le)}catch(Le){we===l&&n.value===j&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{we===l&&(i.value=!1)}}function re(j){const we=new Set(c.value);we.has(j)?we.delete(j):we.add(j),c.value=we}function se(){F.value?c.value=new Set:c.value=new Set(Z.value.map(j=>j.channel_id))}function xe(j){r.value=j}async function he(){if(r.value){o.value=!0;try{await Q.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await Y()}catch(j){s.value=j.message||"Failed to clear session"}o.value=!1,r.value=null}}function ge(){d.value=!0}async function ke(){if(c.value.size!==0){o.value=!0;try{await Q.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await Y()}catch(j){s.value=j.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}async function Ce(j,we){const Le=`/api/sessions/${encodeURIComponent(j)}/export?format=${we}`;try{const De=await Q.getBlob(Le),Ke=URL.createObjectURL(De),qe=document.createElement("a");qe.href=Ke,qe.download=`session-${j}.${we==="text"?"txt":"json"}`,qe.click(),URL.revokeObjectURL(Ke)}catch(De){s.value=De.message||"Failed to export session"}}let Oe=null;function Me(j){j.payload&&j.payload.channel_id&&(clearTimeout(Oe),Oe=setTimeout(()=>{if(Y(),n.value&&j.payload.channel_id===n.value){const we=n.value,Le=l;Q.get(`/api/sessions/${encodeURIComponent(we)}`).then(De=>{Le!==l||n.value!==we||(a.value=De)}).catch(()=>{})}},2e3))}let Fe=!1;function Ve(){Fe||(Fe=!0,Y(),Ze.subscribe("events",Me))}Ye(()=>{H(),Ve()}),As(()=>{Ve()});function st(){Fe&&(Fe=!1,Ze.unsubscribe("events",Me),clearTimeout(Oe))}return Rs(st),_t(st),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:F,bulkClearing:d,activePreset:u,searchQuery:f,sortBy:p,sortAsc:g,filterPresets:y,sortOptions:S,filteredSessions:Z,hasActiveFilters:N,customPresets:R,showSavePreset:v,newPresetName:m,threadView:x,threads:ne,collapsedThreads:w,ftsQuery:_,ftsChannelId:A,ftsUserId:T,ftsResults:C,ftsSearching:L,formatAge:B,formatTimestamp:de,formatFullTimestamp:_e,messageClass:V,threadMsgClass:ue,roleBadge:oe,roleDotClass:be,roleLabelClass:me,truncateContent:Be,threadSummary:O,fetchSessions:Y,retry:pe,toggleSession:ce,toggleSelect:re,toggleSelectAll:se,confirmClear:xe,clearSession:he,confirmBulkClear:ge,doBulkClear:ke,exportSession:Ce,applyPreset:q,applyCustomPreset:K,saveCustomPreset:ee,removeCustomPreset:ie,resetFilters:U,toggleThread:E,runFtsSearch:b,clearFtsSearch:I,highlightSnippet:P,ftsResultClass:X,ftsTypeBadge:J}}},Ok={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:dg}}},Lk={components:{ContextAssemblyPanel:Ok},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
`)}const $k={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),d=h(""),u=h(""),f=h(null),p=h(null),g=h(!1),y=h(null),S=h(null),R=h(!1),v=te(()=>e.value.length),m=te(()=>e.value.reduce((B,de)=>B+(de.execution_count||0),0)),x=te(()=>e.value.reduce((B,de)=>B+L(de.code),0)),w=te(()=>{if(!l.value)return e.value;const B=l.value.toLowerCase();return e.value.filter(de=>de.name.toLowerCase().includes(B)||(de.description||"").toLowerCase().includes(B))}),_=te(()=>u.value?u.value.split(`
`).length:0),A=te(()=>{const B=Math.max(_.value,1);return Array.from({length:B},(de,_e)=>_e+1).join(`
...
`).length:0}function H(B){return Fk(B)}function M(B){n.value={...n.value,[B]:!n.value[B]}}async function N(B){try{await navigator.clipboard.writeText(B);const de=e.value.find(_e=>_e.code===B);de&&(r.value=de.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function Z(B){if(B.key==="Tab"){B.preventDefault();const de=B.target,_e=de.selectionStart,V=de.selectionEnd;u.value=u.value.substring(0,_e)+"    "+u.value.substring(V),Ot(()=>{de.selectionStart=de.selectionEnd=_e+4})}}function ne(B){const de=B.target.previousElementSibling;de&&(de.scrollTop=B.target.scrollTop)}async function F(){t.value=!0,s.value=null;try{e.value=await Q.get("/api/skills")}catch(B){s.value=B.message}t.value=!1}async function O(B){i.value=B,delete a.value[B],a.value={...a.value};try{const de=await Q.post(`/api/skills/${encodeURIComponent(B)}/test`);a.value={...a.value,[B]:de}}catch(de){a.value={...a.value,[B]:{result:de.message,is_error:!0}}}i.value=null}function E(){o.value=!0,c.value="create",d.value="",u.value="",f.value=null,p.value=null}function q(B){o.value=!0,c.value="edit",d.value=B.name,u.value=B.code||"",f.value=null,p.value=null}function K(){o.value=!1,f.value=null,p.value=null}async function ee(){f.value=null,p.value=null;const B=d.value.trim(),de=u.value.trim();if(!B){f.value="Name is required";return}if(!de){f.value="Code is required";return}g.value=!0;try{c.value==="create"?(await Q.post("/api/skills",{name:B,code:de}),p.value="Skill created successfully"):(await Q.put(`/api/skills/${encodeURIComponent(B)}`,{code:de}),p.value="Skill updated successfully"),await F(),setTimeout(()=>{o.value=!1},800)}catch(_e){f.value=_e.message}g.value=!1}function ie(B){S.value=B}async function U(){if(S.value){R.value=!0;try{await Q.del(`/api/skills/${encodeURIComponent(S.value)}`),await F()}catch(B){Te.error(`Failed to delete skill: ${B.message||"unknown error"}`)}R.value=!1,S.value=null}}return Ye(()=>{F()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:f,editSuccess:p,saving:g,editorRef:y,deleteTarget:S,deleting:R,enabledCount:v,totalExecutions:m,totalLines:x,displayedSkills:w,editLineCount:_,editorLineNums:A,editValidation:T,highlight:C,truncate:Mc,formatTs:ra,countLines:L,getLineNumbers:H,toggleCode:M,copyCode:N,handleEditorKey:Z,syncScroll:ne,fetchSkills:F,testSkill:O,showCreate:E,editSkill:q,cancelEdit:K,saveSkill:ee,confirmDelete:ie,doDelete:U}}};function Uk(e,t){if(!e||!t)return Au(e);const s=Au(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Bk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),f=h(null),p=h(!1),g=h(null),y=h(null);let S=null;const R=h(null),v=h(!1),m=h({}),x=h({}),w=h(null),_=h(null),A=te(()=>e.value.reduce((E,q)=>E+(q.chunks||0),0)),T=te(()=>new Set(e.value.map(q=>q.uploader).filter(Boolean)).size);function C(E,q){const K=x.value[q];if(!K||K.length===0)return 0;const ee=Math.max(...K.map(ie=>ie.char_count||0));return ee===0?0:Math.round(E.char_count/ee*100)}async function L(){t.value=!0,s.value=null;try{const E=await Q.get("/api/knowledge");e.value=Array.isArray(E)?E:[]}catch(E){s.value=E.message}t.value=!1}async function H(E){if(m.value[E]){m.value[E]=!1,_.value=null;return}if(m.value[E]=!0,!(x.value[E]||w.value===E)){w.value=E;try{const q=await Q.get(`/api/knowledge/${encodeURIComponent(E)}/chunks`);x.value[E]=Array.isArray(q)?q:[]}catch(q){x.value[E]=[],Te.error(`Failed to load chunks: ${q.message}`)}w.value=null}}async function M(){const E=n.value.trim();if(E){i.value=!0,r.value=null,l.value=E;try{const q=await Q.get(`/api/knowledge/search?q=${encodeURIComponent(E)}`);a.value=Array.isArray(q)?q:[]}catch(q){a.value=[],r.value=q.message||"Search failed"}i.value=!1}}function N(){a.value=null,n.value="",r.value=null}async function Z(){u.value=null,f.value=null;const E=c.value.trim(),q=d.value.trim();if(!E){u.value="Source name is required";return}if(!q){u.value="Content is required";return}p.value=!0;try{const K=await Q.post("/api/knowledge",{source:E,content:q});f.value=`Ingested ${K.chunks||0} chunks from "${E}"`,c.value="",d.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(K){u.value=K.message}p.value=!1}async function ne(E){g.value=E,y.value=null,S&&(clearTimeout(S),S=null);try{const q=await Q.post(`/api/knowledge/${encodeURIComponent(E)}/reingest`);y.value={source:E,error:!1,message:`Re-ingested ${q.chunks||0} chunks`},delete x.value[E],await L(),S=setTimeout(()=>{y.value=null,S=null},3e3)}catch(q){y.value={source:E,error:!0,message:q.message}}g.value=null}function F(E){R.value=E}async function O(){if(R.value){v.value=!0;try{await Q.del(`/api/knowledge/${encodeURIComponent(R.value)}`),delete x.value[R.value],await L()}catch(E){Te.error(`Failed to delete source: ${E.message||"unknown error"}`)}v.value=!1,R.value=null}}return Ye(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:f,ingesting:p,reingesting:g,reingestResult:y,deleteTarget:R,deleting:v,expanded:m,sourceChunks:x,loadingChunks:w,selectedChunk:_,totalChunks:A,uploaderCount:T,truncate:Mc,formatTs:ra,highlightTerms:Uk,chunkBarWidth:C,fetchSources:L,toggleSource:H,doSearch:M,clearSearch:N,doIngest:Z,doReingest:ne,confirmDelete:F,doDelete:O}}},Hk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),f=h(null),p=h(""),g=h(!1),y=h(null),S=h(null),R=h(new Set),v=h(null),m=h(!1),x=h(!1),w=te(()=>e.value.reduce((ie,U)=>ie+U.count,0)),_=te(()=>R.value.size);function A(ie){const U=t.value[ie];if(!U)return[];if(!l.value.trim())return U;const B=l.value.trim().toLowerCase();return U.filter(de=>de.key.toLowerCase().includes(B)||de.value&&de.value.toLowerCase().includes(B))}function T(ie,U){return R.value.has(ie+"/"+U)}function C(ie,U){const B=ie+"/"+U,de=new Set(R.value);de.has(B)?de.delete(B):de.add(B),R.value=de}function L(ie){const U=t.value[ie];return!U||U.length===0?!1:U.every(B=>R.value.has(ie+"/"+B.key))}function H(ie,U){const B=t.value[ie];if(!B)return;const de=new Set(R.value);for(const _e of B){const V=ie+"/"+_e.key;U?de.add(V):de.delete(V)}R.value=de}async function M(){s.value=!0,n.value=null;try{const ie=await Q.get("/api/memory");e.value=Object.entries(ie).map(([U,B])=>({name:U,keys:B.keys||[],count:B.count||0}))}catch(ie){n.value=ie.message}s.value=!1}async function N(ie){if(a.value[ie]){a.value[ie]=!1;return}a.value[ie]=!0;const U=e.value.find(_e=>_e.name===ie);if(!U||t.value[ie]||i.value===ie)return;i.value=ie;const B=8,de=[];for(let _e=0;_e<U.keys.length;_e+=B){const V=U.keys.slice(_e,_e+B),ue=await Promise.all(V.map(async oe=>{try{const be=await Q.get(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(oe)}`);return{key:oe,value:be.value||"",failed:!1}}catch(be){return{key:oe,value:"",failed:!0,error:be.message||"Failed to load"}}}));de.push(...ue)}t.value[ie]=de,i.value=null}function Z(ie,U,B){f.value=ie+"/"+U,p.value=B}async function ne(ie,U){g.value=!0,y.value=null;try{await Q.put(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(U)}`,{value:p.value});const B=t.value[ie];if(B){const de=B.find(_e=>_e.key===U);de&&(de.value=p.value)}f.value=null}catch(B){y.value=`Failed to save: ${B.message||"unknown error"}`}g.value=!1}async function F(ie,U){try{await navigator.clipboard.writeText(U.value),S.value=ie+"/"+U.key,setTimeout(()=>{S.value=null},1500)}catch{}}async function O(){d.value=null,u.value=null;const ie=o.value.scope.trim(),U=o.value.key.trim(),B=o.value.value.trim();if(!ie){d.value="Scope is required";return}if(!U){d.value="Key is required";return}if(!B){d.value="Value is required";return}c.value=!0;try{await Q.put(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(U)}`,{value:B}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await M(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(de){d.value=de.message}c.value=!1}function E(ie,U){v.value={scope:ie,key:U}}async function q(){if(!v.value)return;m.value=!0,y.value=null;const{scope:ie,key:U}=v.value;try{await Q.del(`/api/memory/${encodeURIComponent(ie)}/${encodeURIComponent(U)}`);const B=t.value[ie];B&&(t.value[ie]=B.filter(V=>V.key!==U));const de=e.value.find(V=>V.name===ie);de&&(de.count--,de.keys=de.keys.filter(V=>V!==U));const _e=new Set(R.value);_e.delete(ie+"/"+U),R.value=_e}catch(B){y.value=`Failed to delete: ${B.message||"unknown error"}`}m.value=!1,v.value=null}function K(){x.value=!0}async function ee(){m.value=!0,y.value=null;const ie=[];for(const U of R.value){const B=U.indexOf("/");ie.push({scope:U.slice(0,B),key:U.slice(B+1)})}try{await Q.post("/api/memory/bulk-delete",{entries:ie}),R.value=new Set,t.value={},await M()}catch(U){y.value=`Bulk delete failed: ${U.message||"unknown error"}`}m.value=!1,x.value=!1}return Ye(()=>{M()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:f,editValue:p,saving:g,actionError:y,copied:S,selected:R,selectedCount:_,totalEntries:w,deleteTarget:v,deleting:m,showBulkDelete:x,fetchMemory:M,toggleScope:N,startEdit:Z,doEdit:ne,copyValue:F,doAdd:O,confirmDelete:E,doDelete:q,confirmBulkDelete:K,doBulkDelete:ee,isSelected:T,toggleSelect:C,isScopeAllSelected:L,toggleSelectAll:H,filteredEntries:A}}},Vk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=te(()=>[...new Set(e.value.map(S=>S.category))].sort()),o=te(()=>{const y={};return e.value.forEach(S=>{y[S.category]=(y[S.category]||0)+1}),y}),c=te(()=>a.value?e.value.filter(y=>y.category===a.value):e.value);function d(y){return y==="correction"?"badge-warning":y==="operational"?"badge-info":y==="preference"?"badge-success":"badge-info"}function u(y){i.value=y.key,l.value=y.content}async function f(y){try{await Q.put("/api/learned/"+encodeURIComponent(y),{content:l.value}),i.value=null,Te.success("Entry updated"),await g()}catch(S){Te.error(S.message||"Failed to save entry")}}async function p(y){if(await bs({title:"Delete learned entry",message:`Delete "${y}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await Q.del("/api/learned/"+encodeURIComponent(y)),Te.success("Entry deleted"),await g()}catch(R){Te.error(R.message||"Failed to delete entry")}}async function g(){s.value=!0,n.value=null;try{const y=await Q.get("/api/learned");e.value=y.entries||[],t.value={last_reflection:y.last_reflection,count:y.count}}catch(y){n.value=y.message}s.value=!1}return Ye(g),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:d,formatTs:ra,startEdit:u,saveEdit:f,deleteEntry:p,fetchEntries:g}}},jk={components:{TabbedPage:Sr},setup(){return{tabs:[{id:"tools",label:"Tools",component:Mk},{id:"skills",label:"Skills",component:$k},{id:"knowledge",label:"Knowledge",component:Bk},{id:"memory",label:"Memory",component:Hk},{id:"learned",label:"Learned",component:Vk}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},zk={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),d=h(!0),u=h(""),f=h(!1),p=h(!1),g=te(()=>e.value==="custom"),y=te(()=>[...i.value,...l.value]),S=te(()=>l.value.includes(e.value)),R=te(()=>{var T;return g.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),v=te(()=>{var T;return g.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),m=te(()=>{var T;return g.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function x(){d.value=!0;try{const T=await Q.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{d.value=!1}}async function w(){r.value=!0,c.value=null,o.value=!1;try{await Q.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(T){c.value=T.message}finally{r.value=!1}}async function _(){const T=u.value.trim();if(T){p.value=!0,c.value=null;try{await Q.post("/api/personality/presets",{name:T,display_name:R.value,identity:v.value,voice:m.value}),f.value=!1,u.value="",await x(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(C){c.value=C.message}finally{p.value=!1}}}async function A(){if(await bs({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await Q.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(C){c.value=C.message}}}return Ye(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:y,isCustom:g,isUserPreset:S,previewName:R,previewIdentity:v,previewVoice:m,saving:r,saved:o,error:c,loading:d,save:w,showSavePreset:f,newPresetName:u,savingPreset:p,saveAsPreset:_,deletePreset:A,builtinPresets:i,userPresets:l}},template:`
...
`);const le=new Blob([$],{type:"text/plain"}),Ee=URL.createObjectURL(le),nt=document.createElement("a");nt.href=Ee,nt.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,nt.click(),URL.revokeObjectURL(Ee)}function Y($,le){const Ee=`${$.ts} ${$.level} ${$.text||$.raw||""}`;navigator.clipboard.writeText(Ee).then(()=>{f.value=le,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function pe($){a.value=a.value===$?"":$,R.value="all"}function ce($){return $.level==="ERROR"?"log-line-error":$.level==="WARNING"?"log-line-warning":"text-gray-300"}function re($){return $==="ERROR"?"text-red-500 font-semibold":$==="WARNING"?"text-yellow-500":"text-blue-500"}function se($){return $==="ERROR"?"log-chip-error":$==="WARNING"?"log-chip-warning":"log-chip-info"}function xe($){R.value=$.id;const le=$.filters;a.value=le.level||"",v.value=le.timeRange||"",i.value=le.text||"",le.levels&&(a.value=le.levels[0]||""),le.hasToolName&&(i.value="")}function he($){R.value=$.id,a.value=$.filters.level||"",v.value=$.filters.timeRange||"",i.value=$.filters.text||""}function ge(){if(!w.value.trim())return;const $={id:"custom-"+Date.now(),name:w.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};m.value=[...m.value,$],T(),x.value=!1,w.value=""}function ke($){m.value=m.value.filter(le=>le.id!==$),T(),R.value===$&&(R.value="all")}const Ce=h("all"),Oe=h(""),Me=h(""),Fe=h(""),Ve=h(""),st=h(""),j=h(100),we=Qk,Le=h(!1),De=h(!1),Ke=h(""),qe=h([]),ht=h(null),ss=h(null);function Is(){e.value="search",ht.value||Ps()}async function Ps(){try{ht.value=await Q.get("/api/logs/stats")}catch{}}function Fs(){const $=st.value;if(!$){Fe.value="",Ve.value="";return}const Ee={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[$];if(Ee){const nt=new Date(Date.now()-Ee*1e3);Fe.value=us(nt),Ve.value=""}}function us($){const le=Ee=>String(Ee).padStart(2,"0");return`${$.getFullYear()}-${le($.getMonth()+1)}-${le($.getDate())}T${le($.getHours())}:${le($.getMinutes())}`}function G($){if(!$)return"";const le=new Date($);return isNaN(le.getTime())?"":le.toISOString()}async function Re(){Le.value=!0,Ke.value="",De.value=!0,ss.value=null;try{const $=new URLSearchParams;Ce.value&&Ce.value!=="all"&&$.set("level",Ce.value),Oe.value&&$.set("tool",Oe.value),Me.value&&$.set("q",Me.value);const le=G(Fe.value),Ee=G(Ve.value);le&&$.set("start",le),Ee&&$.set("end",Ee),$.set("limit",String(j.value));const nt=await Q.get(`/api/logs/search?${$.toString()}`);qe.value=nt.entries||[]}catch($){Ke.value=$.message||"Search failed",qe.value=[]}finally{Le.value=!1}}function fs(){Ce.value="all",Oe.value="",Me.value="",Fe.value="",Ve.value="",st.value="",j.value=100,qe.value=[],De.value=!1,Ke.value="",ss.value=null}function Zs($){ss.value=ss.value===$?null:$}function ca($){if(!$.timestamp)return"";try{return new Date($.timestamp).toLocaleString()}catch{return $.timestamp}}function wn($){return $.type==="web_action"?`${$.status||""} (${$.execution_time_ms||0}ms)`:($.result_summary||"").slice(0,200)}function Js($){return $.error?"log-line-error":"text-gray-300"}function D($){try{return JSON.stringify($,null,2)}catch{return String($)}}let z=null,ae=null,Se=!1;function Ae(){Se||(Se=!0,Ze.subscribe("logs",ie),r.value=Ze.connected,o.value=Ze.state||"disconnected",z=Ze.onStateChange,ae=($,le)=>{o.value=$,r.value=$==="connected",z&&z($,le)},Ze.onStateChange=ae)}function Et(){Se&&(Se=!1,Ze.unsubscribe("logs",ie),Ze.onStateChange===ae&&(Ze.onStateChange=z),ae=null,z=null)}return Ye(()=>{A(),window.addEventListener("pointerup",b),window.addEventListener("pointercancel",b)}),As(Ae),Rs(Et),_t(()=>{Et(),window.removeEventListener("pointerup",b),window.removeEventListener("pointercancel",b)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:K,pauseBuffer:_,showJumpBottom:u,copiedIndex:f,regexError:H,levels:g,logPresets:y,timeRanges:S,timeRange:v,activeLogPreset:R,customLogPresets:m,showSaveLogPreset:x,newLogPresetName:w,hasActiveLogFilters:C,timeRangeLabel:L,timelineBuckets:N,timelineMax:Z,timelineSpanLabel:ne,timelineLabelSkip:F,togglePause:P,clearLogs:X,exportLogs:J,logLineClass:ce,levelClass:re,levelChipClass:se,toggleLevel:pe,copyLine:Y,jumpToBottom:de,onScroll:V,onUserScrollIntent:oe,onUserScrollKey:be,onAutoScrollToggle:I,onPointerDown:Be,applyLogPreset:xe,applyCustomLogPreset:he,saveLogCustomPreset:ge,removeLogCustomPreset:ke,segmentHeight:E,jumpToTimelineBucket:q,searchLevel:Ce,searchTool:Oe,searchKeyword:Me,searchStart:Fe,searchEnd:Ve,searchTimePreset:st,searchLimit:j,searchLimits:we,searching:Le,searchRan:De,searchError:Ke,searchResults:qe,searchStats:ht,expandedSearch:ss,switchToSearch:Is,runSearch:Re,clearSearchFilters:fs,toggleSearchExpand:Zs,formatSearchTs:ca,searchEntryText:wn,searchLogLineClass:Js,formatJson:D,applySearchTimePreset:Fs}}},Eg="••••••••",e1={timezone:{apply_mode:"restart",description:"Locale and scheduling defaults used across Odin."},discord:{apply_mode:"live_read",description:"Global Discord defaults. Guild and channel overrides take precedence."},llm_provider:{apply_mode:"live_apply",owner:"llm",description:"Active language-model provider and failover ownership."},openai_codex:{apply_mode:"live_apply",owner:"llm",description:"Codex models, reasoning, transport, and pool behaviour."},ollama:{apply_mode:"restart",owner:"llm",description:"Local or remote Ollama provider settings."},kimi:{apply_mode:"restart",owner:"llm",description:"Kimi provider settings and request limits."},context:{apply_mode:"restart",description:"System-prompt sources and prompt-budget controls."},sessions:{apply_mode:"restart",description:"Conversation persistence, retention, and history limits."},tools:{apply_mode:"restart",description:"Execution policy, hosts, timeouts, pools, and recovery."},logging:{apply_mode:"restart",description:"Runtime log verbosity and storage policy."},usage:{apply_mode:"activation_required",description:"Usage accounting and durable history storage."},webhook:{apply_mode:"restart",description:"Inbound webhook listener and authentication policy."},learning:{apply_mode:"restart",description:"Reflection, consolidation, and learned-context limits."},observability:{apply_mode:"live_read",description:"Metrics, tracing, and failure-classification controls."},email:{apply_mode:"restart",description:"SMTP and IMAP behaviour for email tools."},search:{apply_mode:"restart",description:"Knowledge and history search backends."},browser:{apply_mode:"restart",description:"Browser automation limits and viewport defaults."},permissions:{apply_mode:"restart",description:"Default and per-user execution policy."},comfyui:{apply_mode:"live_read",description:"ComfyUI image backend connection settings."},image:{apply_mode:"live_read",description:"Image routing and native generation policy."},web:{apply_mode:"restart",description:"Management API listener, authentication, and sessions."},attachments:{apply_mode:"live_read",description:"Attachment limits, paths, and cleanup policy."},personality:{apply_mode:"live_read",owner:"personality",description:"Response identity, style, and personality presets."},reaction_triggers:{apply_mode:"activation_required",owner:"reaction_triggers",description:"Discord reaction event automation."},message_triggers:{apply_mode:"activation_required",owner:"message_triggers",description:"Discord message event automation."},mcp:{apply_mode:"activation_required",owner:"mcp",description:"Model Context Protocol servers and tool publication."},slack:{apply_mode:"restart",description:"Slack destinations and internal alert forwarding."},issue_tracker:{apply_mode:"activation_required",owner:"issue_tracker",description:"Issue tracker provider and tool lifecycle."},audit:{apply_mode:"restart",description:"Audit signing, verification, and retention."},agents:{apply_mode:"live_for_new_work",description:"Spawned-agent budgets, inheritance, and tree limits."},grafana_alerts:{apply_mode:"activation_required",owner:"grafana_alerts",description:"Grafana alert intake, routing, and remediation."},outbound_webhooks:{apply_mode:"live_apply",owner:"outbound_webhooks",description:"Outbound event targets, delivery, and safety policy."},graceful_degradation:{apply_mode:"activation_required",description:"Subsystem failure thresholds and request guarding."},llm_recovery:{apply_mode:"restart",description:"Provider recovery, breaker, and retry policy."},turn_state:{apply_mode:"restart",description:"Durable turn checkpoints, expiry, and resume behaviour."}},Yu={timezone:{label:"Timezone",description:"Timezone used in prompts and scheduled-time parsing.",consumers:[{name:"Prompt context",apply_mode:"live_read",detail:"Future prompts read the configured value."},{name:"Time parser",apply_mode:"restart",detail:"The parser currently captures the boot value."}],restart_reason:"The scheduling parser captures timezone during startup."},"discord.token":{owner:"secrets",sensitivity:"sensitive",description:"Write-only Discord bot credential."},"discord.allowed_users":{description:"Global allowlist of Discord user IDs. An empty list allows all users."},"discord.channels":{description:"Global allowlist of Discord channel IDs. An empty list allows all channels."},"discord.require_mention":{description:"Require a mention by default unless a guild or channel override says otherwise."},"discord.respond_to_bots":{description:"Allow replies to bot-authored messages by default."},"llm_provider.active_provider":{enum:["codex","ollama","kimi"],description:"Provider used for new primary requests."},"openai_codex.enabled":{apply_mode:"live_apply",description:"Enable or disable the primary Codex client through the dedicated Codex reload path."},"openai_codex.model":{apply_mode:"live_apply",description:"Primary Codex model. Spawned agents may inherit it directly; chat and loops require a Codex reload.",consumers:[{name:"Spawned agents inheriting the main model",apply_mode:"live_read",detail:"Future agent generations read the configured model at call time."},{name:"Chat and autonomous loops",apply_mode:"live_apply",detail:"The dedicated Codex endpoint reloads the live client."}]},"openai_codex.max_tokens":{apply_mode:"live_apply",constraints:{minimum:1,maximum:128e3},unit:"tokens",description:"Maximum Codex response tokens; requires the dedicated Codex reload path."},"openai_codex.reasoning_effort":{apply_mode:"live_apply",description:"Main Codex reasoning effort; requires the dedicated Codex reload path."},"openai_codex.agent_reasoning_effort":{apply_mode:"live_read",description:"Reasoning policy for spawned-agent generations; future generations read it at call time."},"openai_codex.agent_model":{apply_mode:"live_read",description:"Model policy for spawned-agent generations; future generations read it at call time."},"openai_codex.credentials_path":{owner:"secrets",sensitivity:"sensitive",apply_mode:"restart",description:"Write-only Codex credential-store path; an existing client cannot switch stores live.",restart_reason:"The credential pool is constructed from this path when the Codex client starts."},"openai_codex.request_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Whole-request timeout; requires the dedicated Codex reload path."},"openai_codex.stream_stall_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Maximum silent-stream interval; requires the dedicated Codex reload path."},"openai_codex.retry.max_retries":{apply_mode:"live_apply",description:"Retry-attempt ceiling; requires the dedicated Codex reload path."},"openai_codex.retry.base_delay":{apply_mode:"live_apply",unit:"seconds",description:"Initial retry delay; requires the dedicated Codex reload path."},"openai_codex.retry.max_delay":{apply_mode:"live_apply",unit:"seconds",description:"Maximum retry delay; requires the dedicated Codex reload path."},"openai_codex.connection_pool.max_connections":{apply_mode:"restart",description:"Maximum Codex transport connections.",restart_reason:"Connection-pool sizing is fixed when the live client transport is constructed."},"openai_codex.connection_pool.keepalive_timeout":{apply_mode:"restart",unit:"seconds",description:"Codex connection keepalive timeout.",restart_reason:"Connection-pool keepalive policy is fixed when the live client transport is constructed."},"openai_codex.context_compression.enabled":{apply_mode:"restart",description:"Enable context compression for chat and agent tool loops.",restart_reason:"The context-compressor holder is constructed at startup and has no live apply path."},"openai_codex.context_compression.max_context_chars":{apply_mode:"restart",unit:"characters",description:"Context size at which compression begins.",restart_reason:"The context-compressor holder retains its startup configuration."},"openai_codex.context_compression.keep_recent_iterations":{apply_mode:"restart",unit:"iterations",description:"Recent tool iterations preserved during compression.",restart_reason:"The context-compressor holder retains its startup configuration."},"logging.level":{enum:["DEBUG","INFO","WARNING","ERROR","CRITICAL"],description:"Minimum runtime log level."},"browser.default_timeout_ms":{constraints:{minimum:1e3},unit:"ms",description:"Default browser operation timeout."},"browser.viewport_width":{constraints:{minimum:100,maximum:7680},unit:"px"},"browser.viewport_height":{constraints:{minimum:100,maximum:4320},unit:"px"},"sessions.max_history":{constraints:{minimum:1,maximum:1e4},unit:"messages"},"sessions.max_age_hours":{constraints:{minimum:1},unit:"hours"},"tools.command_timeout_seconds":{constraints:{minimum:10,maximum:3600},unit:"seconds"},"agents.max_children_per_agent":{apply_mode:"activation_required",description:"Child limit adopted by newly spawned parent agents after explicit activation.",activation_policy:"Explicitly apply the configured limit after reviewing worst-case tree breadth."},"context.max_system_prompt_tokens":{apply_mode:"activation_required",description:"Optional hard budget for future assembled system prompts.",activation_policy:"Preview mandatory prompt usage and omissions before applying the budget."},"usage.directory":{apply_mode:"activation_required",description:"Target for durable usage history; currently no durable store is active.",activation_policy:"Validate the path and explicitly enable durable usage history."},"slack.forward_alerts":{apply_mode:"activation_required",description:"Forward normalized internal alerts to tested Slack destinations.",activation_policy:"Requires an effective notifier, tested destination, and activation receipt."},"grafana_alerts.enabled":{apply_mode:"activation_required",description:"Adopt explicit Grafana processing control without changing legacy webhook behaviour on upgrade.",activation_policy:"Explicit adoption preserves working legacy-control installations."},"graceful_degradation.enabled":{apply_mode:"activation_required",description:"Allow subsystem guards to short-circuit calls while a dependency is unhealthy.",activation_policy:"Explicit adoption resolves the legacy always-on behaviour."}},t1=["tools.enabled","tools.max_tool_iterations_chat","tools.max_tool_iterations_loop","learning.loop_reflection_enabled","turn_state.retention"],s1=new Set(["token","api_token","api_key","password","secret","credentials_path","ssh_key_path","hmac_key","webhook_urls","headers","env"]);function ni(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function n1(e){return Array.isArray(e)?"array":e===null?"null":Number.isInteger(e)?"integer":typeof e=="number"?"number":typeof e=="boolean"?"boolean":typeof e=="object"?"object":"string"}function Ag(e,t="",s=[]){if(e&&typeof e=="object"&&!Array.isArray(e)){const n=Object.entries(e);n.length===0&&t&&s.push([t,e]);for(const[a,i]of n)Ag(i,t?`${t}.${a}`:a,s);return s}return t&&s.push([t,e]),s}function a1(e){return e.split(".").some(s=>s1.has(s))}function i1(e){return Yu[e]?Yu[e]:e.startsWith("mcp.servers.")&&(e.endsWith(".headers")||e.endsWith(".env"))?{owner:"secrets",sensitivity:"secret_container"}:e.startsWith("outbound_webhooks.targets.")&&e.endsWith(".secret")?{owner:"secrets",sensitivity:"sensitive"}:e.startsWith("outbound_webhooks.targets.")&&(e.endsWith(".scrub_secrets")||e.endsWith(".verify_ssl"))?{apply_mode:"activation_required",activation_policy:"Review this target and acknowledge the target-bound safety override."}:{}}function Rg(e){return e==null||e===""?!1:Array.isArray(e)?e.length>0:typeof e=="object"?Object.keys(e).length>0:!0}function Qu(e,t){return t==="public"?e:e&&typeof e=="object"?Array.isArray(e)?[]:{}:Rg(e)?Eg:""}function l1(e){return e.valid===!1?"invalid":e.pending_restart?"pending_restart":e.drift?"drift":e.apply_mode==="activation_required"||e.apply_mode==="dormant"?"dormant":"applied"}function r1(e,t){const s=e.split(".")[0],n=e.split(".").at(-1),a=e1[s]||{apply_mode:"restart",description:`${ni(s)} configuration.`},i=i1(e),l=i.sensitivity||(a1(e)?"sensitive":"public");let r=i.apply_mode||a.apply_mode;t1.some(p=>e===p||e.startsWith(`${p}.`))&&(r="live_read");const o=i.owner||a.owner||(l==="public"?"config":"secrets"),c=Qu(t,l),d=Qu(t,l),u=Rg(t)&&!(l!=="public"&&t===Eg),f={path:e,owner:o,label:i.label||ni(n),description:i.description||`${ni(n)} setting for ${ni(s)}.`,aliases:i.aliases||[],unit:i.unit||null,examples:i.examples||[],type:i.type||n1(t),enum:i.enum||null,constraints:i.constraints||{},default:i.default??null,sensitivity:l,secret_route:l==="public"?null:`/api/config/secrets/${encodeURIComponent(e)}`,apply_mode:r,apply_handler:i.apply_handler||null,consumers:i.consumers||[],restart_reason:i.restart_reason||(r==="restart"?`${ni(s)} is currently constructed during startup.`:null),activation_policy:i.activation_policy||(r==="activation_required"?"Saving configuration does not enable this feature. Explicit activation is required.":null),desired:c,effective:d,configured:u,provenance:u?"config_file":"unset",valid:!0,validation_errors:[],pending_restart:!1,drift:!1,last_apply:null};return f.apply_state=l1(f),f}function o1(e){const t={applied:0,pending_restart:0,dormant:0,invalid:0,drift:0};for(const s of e)Object.hasOwn(t,s.apply_state)&&(t[s.apply_state]+=1);return t}function c1(e){const t=Ag(e||{}).map(([s,n])=>r1(s,n));return{schema_version:1,revision:"local-fixture",generated_at:null,fields:t,status:{counts:o1(t),persistence_error:null,unsafe_overrides:[],desired_revision:null,effective_revision:null}}}const Oa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["personality","context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],d1=[{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Activation required",short:"Dormant",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"}],u1={live_read:"Applies immediately",live_apply:"Reloads live",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Activation required",legacy_control:"Legacy control",dormant:"Not wired"},Xu={llm:{label:"LLM Config",href:"#/system?tab=llm",description:"This section has one canonical editor so provider changes use the safe switch and reload paths."},personality:{label:"Personality",href:"#/personality",description:"Personality presets and the active profile are managed on the dedicated Personality page."},discord:{label:"Discord overrides",href:"#/system?tab=discord",description:"Guild and channel overrides take precedence over these global defaults."},secrets:{label:"Secret controls",href:"#/system?tab=config",description:"Secret values are write-only and use dedicated set and clear flows."}},Ig="odin_config_center_expanded_v1",Og="odin_config_center_category_v1",f1=50,ef=e=>Promise.resolve(c1(e));function Rn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function bi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Us(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function p1(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function h1(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Lg(e,t){if(bi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Rn(t);const n={};for(const[a,i]of Object.entries(t)){const l=Lg(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function g1(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Lg(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Ng(e,t,s,n){if(bi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Ng(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function m1(){try{const e=JSON.parse(localStorage.getItem(Ig)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function v1(){try{const e=localStorage.getItem(Og);return Oa.some(t=>t.key===e)?e:Oa[0].key}catch{return Oa[0].key}}const b1={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(!1),a=h(null),i=h(null),l=h(""),r=h("all"),o=h(v1()),c=h(m1()),d=h({}),u=h(null),f=h(void 0),p=h(!1),g=h({}),y=h([]),S=h([]),R=h(!1),v=h(!1),m=h(!1);let x=null;const w=te(()=>{var D;return((D=t.value)==null?void 0:D.fields)||[]}),_=te(()=>new Map(w.value.map(D=>[D.path,D]))),A=te(()=>e.value?Object.keys(e.value).length:0),T=te(()=>w.value.length),C=te(()=>d1),L=te(()=>y.value.length>0),H=te(()=>S.value.length>0),M=te(()=>{if(!e.value)return[];const D=new Set(Oa.flatMap(Se=>Se.sections)),z=Oa.map(Se=>({...Se,sections:Se.sections.filter(Ae=>Object.hasOwn(e.value,Ae))})).filter(Se=>Se.sections.length),ae=Object.keys(e.value).filter(Se=>!D.has(Se));return ae.length&&z.push({key:"other",label:"Other",icon:"folder",sections:ae}),z}),N=te(()=>{if(!e.value)return[];const D=[];for(const[z,ae]of Object.entries(d.value))Ng(e.value[z],ae,z,D);return D.filter(z=>!bi(z.oldVal,z.newVal)).map(z=>{const ae=U(z.path);return{...z,label:(ae==null?void 0:ae.label)||Us(z.path.split(".").at(-1)),apply_mode:(ae==null?void 0:ae.apply_mode)||ue(z.path.split(".")[0])}})}),Z=te(()=>N.value.length>0),ne=te(()=>N.value.length),F=te(()=>new Set(N.value.map(D=>D.path.split(".")[0])).size),O=te(()=>!!l.value||r.value!=="all"),E=te(()=>{const D={...g.value};for(const z of N.value){const ae=U(z.path),Se=we(ae,z.newVal);Se&&(D[z.path]=Se)}return D}),q=te(()=>Object.keys(E.value).length>0),K=te(()=>e.value?(O.value?M.value:M.value.filter(z=>z.key===o.value)).map(z=>({...z,sections:z.sections.filter(ae=>X(ae))})).filter(z=>z.sections.length):[]),ee=te(()=>{const D=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],z=new Map(D.map(ae=>[ae,[]]));for(const ae of N.value){const Se=z.has(ae.apply_mode)?ae.apply_mode:"restart";z.get(Se).push(ae)}return D.filter(ae=>z.get(ae).length).map(ae=>({key:ae,label:Ps(ae),entries:z.get(ae)}))}),ie=te(()=>N.value.filter(D=>D.apply_mode==="restart").length);function U(D){var Et;if(_.value.has(D))return _.value.get(D);const z=`${D}.`,ae=w.value.filter($=>$.path.startsWith(z));if(!ae.length)return null;const Se=ae.some($=>$.sensitivity!=="public")?"secret_container":"public",Ae=[...new Set(ae.map($=>$.apply_mode))];return{path:D,label:Us(D.split(".").at(-1)),description:ae[0].description,type:"object",sensitivity:Se,configured:ae.some($=>$.configured),provenance:((Et=ae.find($=>$.provenance!=="unset"))==null?void 0:Et.provenance)||"unset",apply_mode:Ae.length===1?Ae[0]:ue(D.split(".")[0]),constraints:{},enum:null}}function B(D){const z=`${D}.`;return w.value.filter(ae=>ae.path===D||ae.path.startsWith(z))}function de(D){return B(D).length}function _e(D){return Us(D)}function V(D){const z=B(D);if(!z.length)return`${Us(D)} configuration.`;const ae=z.find(Et=>Et.sensitivity==="public"&&Et.description)||z.find(Et=>Et.description),Se=(ae==null?void 0:ae.description)||"";return Se.match(/setting for (.+)\.$/i)?`${Us(D)} settings and runtime behaviour.`:Se}function ue(D){const z=[...new Set(B(D).map(ae=>ae.apply_mode))];return z.length===1?z[0]:z.includes("restart")?"restart":z.includes("activation_required")?"activation_required":z[0]||"restart"}function oe(D){const z=[...new Set(B(D).map(ae=>Ps(ae.apply_mode)))];return z.length?z.length===1?z[0]:`Mixed apply behaviour: ${z.join(" · ")}`:""}function be(D){const z=B(D),ae=z.map($=>$.owner).filter($=>$&&$!=="config"&&$!=="secrets");if(!ae.length)return null;const Se=ae.reduce(($,le)=>({...$,[le]:($[le]||0)+1}),{}),[Ae,Et]=Object.entries(Se).sort(($,le)=>le[1]-$[1])[0];return Et>=Math.max(1,z.length-1)&&Xu[Ae]?Ae:null}function me(D){return Xu[D]||{label:Us(D),href:"#/system?tab=config",description:"This feature uses a dedicated configuration and activation panel."}}function Be(D){var z;return Object.hasOwn(d.value,D)?d.value[D]:(z=e.value)==null?void 0:z[D]}function b(D){const z=Be(D);return(z&&typeof z=="object"&&!Array.isArray(z)?Object.entries(z).map(([Se,Ae])=>({key:Se,path:`${D}.${Se}`,value:Ae})):[{key:null,path:D,value:z}]).map(Se=>{const Ae=U(Se.path)||{};return{...Ae,...Se,label:Ae.label||(Se.key===null?_e(D):Us(Se.key)),description:Ae.description||`${Us(Se.key||D)} setting for ${Us(D)}.`,apply_mode:Ae.apply_mode||ue(D),sensitivity:Ae.sensitivity||"public",constraints:Ae.constraints||{},configured:Ae.configured??!0,provenance:Ae.provenance||"config_file"}})}function I(D,z){return[D.label,D.path,D.description,...D.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(z)}function P(D){const z=l.value.trim().toLowerCase();return z?B(D).filter(ae=>I(ae,z)):[]}function X(D){const z=B(D);if(r.value!=="all"&&!z.some(Se=>Se.apply_state===r.value))return!1;const ae=l.value.trim().toLowerCase();return!ae||`${_e(D)} ${D}`.toLowerCase().includes(ae)?!0:z.some(Se=>I(Se,ae))}function J(D,z){return B(D).filter(ae=>ae.apply_state===z).length}function Y(D){var z,ae,Se;return D==="all"?T.value:((Se=(ae=(z=t.value)==null?void 0:z.status)==null?void 0:ae.counts)==null?void 0:Se[D])??w.value.filter(Ae=>Ae.apply_state===D).length}function pe(D){const z=D.sections.flatMap(ae=>B(ae));return{fields:z.length,modified:N.value.filter(ae=>D.sections.includes(ae.path.split(".")[0])).length,pending_restart:z.filter(ae=>ae.apply_state==="pending_restart").length,invalid:z.filter(ae=>ae.apply_state==="invalid").length,dormant:z.filter(ae=>ae.apply_state==="dormant").length}}function ce(D){var z;return Object.hasOwn(d.value,D)&&!bi((z=e.value)==null?void 0:z[D],d.value[D])}function re(D){return N.value.some(z=>z.path===D||z.path.startsWith(`${D}.`))}function se(D){o.value=D,l.value="",r.value="all";try{localStorage.setItem(Og,D)}catch{}}function xe(D){r.value=D}function he(){l.value="",r.value="all"}function ge(D){return c.value[D]?!0:!!(l.value&&!m.value&&X(D))}function ke(D){const z=!ge(D);m.value&&z?c.value={[D]:!0}:c.value={...c.value,[D]:z}}function Ce(){y.value.push(Rn(d.value)),y.value.length>f1&&y.value.shift(),S.value=[]}function Oe(D){u.value!==D&&(u.value=D,p.value=Object.hasOwn(d.value,D),f.value=p.value?Rn(d.value[D]):void 0,p.value||(d.value={...d.value,[D]:Rn(e.value[D])}),c.value=m.value?{[D]:!0}:{...c.value,[D]:!0})}function Me(D){if(!De(D)){if(bi(d.value[D],e.value[D])){const z={...d.value};delete z[D],d.value=z}u.value=null,f.value=void 0,p.value=!1}}function Fe(D){const z={...d.value};p.value?z[D]=Rn(f.value):delete z[D],d.value=z,u.value=null,f.value=void 0,p.value=!1;const ae=`${D}.`;g.value=Object.fromEntries(Object.entries(g.value).filter(([Se])=>Se!==D&&!Se.startsWith(ae)))}function Ve(){!Z.value&&!u.value||(Ce(),d.value={},u.value=null,f.value=void 0,p.value=!1,g.value={},R.value=!1)}function st(D,z){const ae=D.path.split(".")[0];if(u.value!==ae)return;Ce();const Se=Rn(d.value[ae]);if(D.key===null?d.value={...d.value,[ae]:z}:(Se[D.key]=z,d.value={...d.value,[ae]:Se}),g.value[D.path]){const Ae={...g.value};delete Ae[D.path],g.value=Ae}}function j(D,z){try{const ae=JSON.parse(z),Se={...g.value};delete Se[D.path],g.value=Se,st(D,ae)}catch(ae){g.value={...g.value,[D.path]:`Invalid JSON: ${ae.message}`}}}function we(D,z){var Se;if(!D)return null;if((Se=D.enum)!=null&&Se.length&&!D.enum.includes(z))return`Choose one of: ${D.enum.join(", ")}`;const ae=D.constraints||{};if((D.type==="integer"||D.type==="number")&&typeof z=="number"){if(ae.minimum!==void 0&&z<ae.minimum)return`Must be at least ${ae.minimum}${D.unit?` ${D.unit}`:""}`;if(ae.maximum!==void 0&&z>ae.maximum)return`Must be at most ${ae.maximum}${D.unit?` ${D.unit}`:""}`}return null}function Le(D){return E.value[D.path]||null}function De(D){const z=`${D}.`;return Object.keys(E.value).some(ae=>ae===D||ae.startsWith(z))}function Ke(){y.value.length&&(S.value.push(Rn(d.value)),d.value=y.value.pop(),g.value={})}function qe(){S.value.length&&(y.value.push(Rn(d.value)),d.value=S.value.pop(),g.value={})}function ht(){!Z.value||q.value||(u.value&&Me(u.value),R.value=!0,v.value=!1)}function ss(){R.value=!1}function Is(){u.value?Fe(u.value):Ve()}function Ps(D){return u1[D]||Us(D||"unknown")}function Fs(D){return`apply-${String(D||"unknown").replaceAll("_","-")}`}function us(D){return`cfgc-field-${D.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function G(D){return`${us(D)}-input`}function Re(D){const z=document.getElementById(us(D))||document.getElementById(us(D.split(".").slice(0,2).join(".")));z==null||z.scrollIntoView({behavior:"smooth",block:"center"})}function fs(D,z){i.value={type:D,message:z},window.setTimeout(()=>{var ae;((ae=i.value)==null?void 0:ae.message)===z&&(i.value=null)},3500)}async function Zs(){if(!(!Z.value||q.value||n.value)){n.value=!0;try{const D=g1(e.value,d.value),z=await Q.put("/api/config",D);e.value=z,t.value=await ef(z),d.value={},u.value=null,f.value=void 0,p.value=!1,y.value=[],S.value=[],g.value={},R.value=!1,fs("success","Configuration saved. Apply status has been refreshed.")}catch(D){fs("error",D.message||"Configuration could not be saved")}finally{n.value=!1}}}async function ca(){var D;if(!Z.value){s.value=!0,a.value=null;try{const z=await Q.get("/api/config"),ae=await ef(z);e.value=z,t.value=ae;const Se=M.value;Se.some(Ae=>Ae.key===o.value)||(o.value=((D=Se[0])==null?void 0:D.key)||Oa[0].key)}catch(z){a.value=z.message||"Unknown configuration error"}finally{s.value=!1}}}function wn(D){if(R.value||!(D.ctrlKey||D.metaKey))return;const z=D.target;z instanceof HTMLElement&&(z.matches("input, textarea, select")||z.isContentEditable)||(!D.shiftKey&&D.key.toLowerCase()==="z"?(D.preventDefault(),Ke()):(D.key.toLowerCase()==="y"||D.shiftKey&&D.key.toLowerCase()==="z")&&(D.preventDefault(),qe()))}function Js(D){if(m.value=D.matches,D.matches){const z=Object.keys(c.value).find(ae=>c.value[ae]);c.value=z?{[z]:!0}:{}}}return Xt(c,D=>{try{localStorage.setItem(Ig,JSON.stringify(D))}catch{}},{deep:!0}),Ye(()=>{var D;ca(),document.addEventListener("keydown",wn),x=window.matchMedia("(max-width: 760px)"),Js(x),(D=x.addEventListener)==null||D.call(x,"change",Js)}),_t(()=>{var D;document.removeEventListener("keydown",wn),(D=x==null?void 0:x.removeEventListener)==null||D.call(x,"change",Js)}),{config:e,meta:t,loading:s,saving:n,error:a,toast:i,searchQuery:l,healthFilter:r,activeCategory:o,editingSection:u,reviewOpen:R,mobileOverflowOpen:v,healthFilters:C,visibleCategories:M,displayGroups:K,reviewGroups:ee,sectionCount:A,fieldCount:T,hasChanges:Z,changeCount:ne,changedSectionCount:F,hasDraftErrors:q,canUndo:L,canRedo:H,globalFilterActive:O,reviewRestartCount:ie,healthCount:Y,categoryStats:pe,selectCategory:se,selectHealthFilter:xe,clearFilters:he,sectionLabel:_e,sectionDescription:V,sectionFieldCount:de,sectionHealthCount:J,sectionApplySummary:oe,sectionOwner:be,ownerInfo:me,sectionEntries:b,sectionSearchHits:P,sectionChanged:ce,fieldChanged:re,isSectionExpanded:ge,toggleSection:ke,startSectionDraft:Oe,finishSectionDraft:Me,cancelSectionDraft:Fe,discardAllDrafts:Ve,setFieldValue:st,setJsonFieldValue:j,fieldError:Le,sectionHasErrors:De,undo:Ke,redo:qe,openReview:ht,closeReview:ss,mobileCancel:Is,applyModeLabel:Ps,applyClass:Fs,compactValue:p1,formatValue:h1,fieldId:us,fieldInputId:G,focusField:Re,fetchConfig:ca,saveConfig:Zs}}},y1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),d=h([]),u=h(null),f=te(()=>{const K={};for(const ee of d.value)K[ee.id]=ee;return K});function p(K){return f.value[K]||null}const g=te(()=>/^\d{15,25}$/.test(r.value.trim())),y=te(()=>{if(o.value){if(S.value[c.value])return"host-user-option-"+c.value;if(g.value)return"host-user-option-raw"}}),S=te(()=>{const K=r.value.toLowerCase().trim();return K?d.value.filter(ee=>!i.value[ee.id]&&(ee.display_name.toLowerCase().includes(K)||ee.username.toLowerCase().includes(K)||ee.id.includes(K))):d.value.filter(ee=>!i.value[ee.id])});function R(K,ee){return K?K.allowed_hosts===null||K.allowed_hosts===void 0?{allowed_hosts:[...ee],default_host:K.default_host||"",allow_all:!0}:{allowed_hosts:K.allowed_hosts,default_host:K.default_host||"",allow_all:!1}:{allowed_hosts:[...ee],default_host:ee[0]||"",allow_all:!0}}const v=x1({applyDefault:async K=>{const ee=K.allow_all?null:K.allowed_hosts;await Q.put("/api/host-access/default-policy",{allowed_hosts:ee,default_host:K.default_host})},applyUser:async(K,ee)=>{const ie=ee.allow_all?null:ee.allowed_hosts;await Q.put(`/api/host-access/user/${K}`,{allowed_hosts:ie,default_host:ee.default_host})},applyDelete:K=>Q.del(`/api/host-access/user/${K}`),onDefaultConfirmed:()=>Te.success("Default policy updated"),onDefaultRollback:K=>{K&&(a.value=K)},onUserConfirmed:K=>{const ee=p(K);Te.success(`Updated access for ${ee?ee.display_name:K}`)},onUserRollback:(K,ee)=>{const ie={...i.value};ee?ie[K]=ee:delete ie[K],i.value=ie},onUserDeleted:K=>{const ee={...i.value};delete ee[K],i.value=ee},onError:(K,ee)=>{var U;const ie=ee.uid?` ${((U=p(ee.uid))==null?void 0:U.display_name)||ee.uid}`:"";Te.error(`${K.message||"Failed to save"} — reverted${ie}`)}});let m=0;async function x(){const K=++m;e.value=!0,t.value="";try{const ee=await v.readSnapshot(()=>Q.get("/api/host-access"));if(K!==m)return;s.value=ee,n.value=ee.available_hosts||[],a.value=R(ee.default_policy,n.value);const ie=ee.users||{},U={};for(const[B,de]of Object.entries(ie))U[B]=R(de,n.value);i.value=U,v.seed(a.value,U)}catch(ee){K===m&&(t.value=ee.message||"Failed to fetch host access data")}finally{K===m&&(e.value=!1)}try{const ee=await Q.get("/api/discord/members")||[];K===m&&(d.value=ee)}catch{K===m&&(d.value=[])}}function w(){v.saveDefault(a.value)}function _(K,ee){a.value.allow_all=!1,ee?a.value.allowed_hosts.includes(K)||a.value.allowed_hosts.push(K):(a.value.allowed_hosts=a.value.allowed_hosts.filter(ie=>ie!==K),a.value.default_host===K&&(a.value.default_host=a.value.allowed_hosts[0]||"")),w()}function A(K){const ee=i.value[K];ee&&v.saveUser(K,ee)}function T(K,ee,ie){const U=i.value[K];U&&(U.allow_all=!1,ie?U.allowed_hosts.includes(ee)||U.allowed_hosts.push(ee):(U.allowed_hosts=U.allowed_hosts.filter(B=>B!==ee),U.default_host===ee&&(U.default_host=U.allowed_hosts[0]||"")),A(K))}function C(K,ee){const ie=i.value[K];ie&&(ie.default_host=ee,A(K))}function L(){l.value=!0,r.value="",c.value=0,Ot(()=>{u.value&&u.value.focus()})}function H(){o.value=!0,c.value=0}function M(){c.value<S.value.length-1&&c.value++}function N(){c.value>0&&c.value--}function Z(){const K=S.value[c.value];if(K){F(K);return}g.value&&ne()}function ne(){const K=r.value.trim();/^\d{15,25}$/.test(K)&&(i.value[K]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},A(K),r.value="",o.value=!1,l.value=!1)}function F(K){i.value[K.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},A(K.id),r.value="",o.value=!1,l.value=!1}function O(){o.value=!1}function E(){setTimeout(()=>{o.value=!1},150)}async function q(K){const ee=p(K);await bs({title:"Remove user override",message:`Remove the host access override for ${ee?ee.display_name:K}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await v.deleteUser(K),i.value[K]||Te.success(`Removed override for ${ee?ee.display_name:K}`))}return Ye(x),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:d,filteredMembers:S,isRawId:g,activeOptionId:y,searchInput:u,fetchData:x,saveDefaultPolicy:w,toggleDefaultHost:_,getMember:p,toggleUserHost:T,setUserDefault:C,openAddUser:L,deleteUser:q,onSearchInput:H,highlightNext:M,highlightPrev:N,selectHighlighted:Z,selectMember:F,closeDropdown:O,onBlur:E,addRawId:ne}}},w1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=te(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=te(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function p(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function g(){e.value=!0,t.value="";try{const T=await Q.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function y(T){return!T||!T.trim()?[]:T.split(",").map(C=>C.trim()).filter(Boolean)}function S(T,C){const L=c.value.allowed_hosts;if(C&&!L.includes(T)&&L.push(T),!C){const H=L.indexOf(T);H>=0&&L.splice(H,1)}}function R(T,C){const L=d.value.allowed_hosts;if(C&&!L.includes(T)&&L.push(T),!C){const H=L.indexOf(T);H>=0&&L.splice(H,1)}}async function v(){var T;i.value=!0;try{const C=y(c.value.allowed_tools_str),L=c.value.host_mode,H=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,M={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:C.length?C:[]};H!==null&&(M.allowed_hosts=H),M.default_host=c.value.default_host||"";const N=await Q.post("/api/tokens",M);l.value=N.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Te.success("Token created"),await g()}catch(C){Te.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to create token")}finally{i.value=!1}}function m(T){r.value=T;const C=T.allowed_hosts;let L="default";C==null?L="default":Array.isArray(C)&&C.length===0?L="none":Array.isArray(C)&&(L="select"),d.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:L,allowed_hosts:Array.isArray(C)?[...C]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const C=y(d.value.allowed_tools_str),L=d.value.host_mode,H={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:C};L==="none"?H.allowed_hosts=[]:L==="select"?H.allowed_hosts=d.value.allowed_hosts:H.allowed_hosts=null,H.default_host=d.value.default_host||"",await Q.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,Te.success("Token updated"),await g()}catch(C){Te.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to update")}finally{o.value=!1}}}async function w(T){var L;if(await bs({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await Q.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=H.token,Te.success("Token regenerated")}catch(H){Te.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to regenerate")}}async function _(T){var L;if(await bs({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await Q.del("/api/tokens/"+encodeURIComponent(T.user_id)),Te.success("Token deleted"),await g()}catch(H){Te.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to delete")}}async function A(){if(l.value)try{await navigator.clipboard.writeText(l.value),Te.success("Copied to clipboard")}catch{Te.error("Copy failed — select and copy manually")}}return Ye(g),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:f,fetchData:g,tierBadge:p,toggleCreateHost:S,toggleEditHost:R,createToken:v,startEdit:m,saveEdit:x,confirmRegenerate:w,confirmDelete:_,copyToken:A}}};function fl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const k1={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=te(()=>{const G=n.value.model;return G&&!a.includes(G)?[G,...a]:a}),l=te(()=>{const G=n.value.agent_model;return G&&G!=="auto"&&!a.includes(G)?[G,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=te(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=te(()=>{const G=n.value.agent_model;return G==="auto"?!0:!r.includes(G||n.value.model)}),d=te(()=>{const G=n.value.agent_reasoning_effort;return G==="auto"?!1:(G||n.value.reasoning_effort)==="max"}),u=G=>r.includes(G)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),f=G=>r.includes(G)&&d.value,p=h({enabled:!1,model:"gpt-5.6-luna"}),g=h({unavailable_reason:null}),y=te(()=>{const G=p.value.model;return G&&!a.includes(G)?[G,...a]:a});function S(G){const Re=G.target.value;p.value.enabled=Re!=="",Re!==""&&(p.value.model=Re),Ve()}const R=h(!1),v=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),m=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),x=h(!1),w=h(!1),_=h(!1),A=h(!1),T=h(!1),C=h(!1),L=h(!1),H=h({configured:!1}),M=h([]),N=h(""),Z=h(!1),ne=h(!1),F=h({configured:!1}),O=h([]),E=h(""),q=h(!1),K=h(!1),ee=h(!0),ie=h(""),U=h({configured:!1,accounts:[]}),B=h(null),de=h(null),_e=h(""),V=h(null),ue=h(!1),oe=h(null),be=h(null),me=h("");let Be=null;function b(G,Re="success"){Te(G,Re==="error"?"error":"success")}function I(G){if(!G)return"?";const Re=G/(1024*1024*1024);return Re>=1?Re.toFixed(1)+" GB":(G/(1024*1024)).toFixed(0)+" MB"}async function P(){e.value=!0,await Promise.all([X(),J(),xe(),Y()]),e.value=!1}async function X(){try{const G=await Q.get("/api/llm/status");t.value=G,s.value=G.active_provider||"codex",G.codex&&!Fe.pending()&&(n.value.enabled=G.codex.enabled,n.value.model=G.codex.model||"gpt-5.5",n.value.reasoning_effort=G.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=G.codex.agent_reasoning_effort||"",n.value.agent_model=G.codex.agent_model||"",n.value.max_tokens=G.codex.max_tokens||4096),G.ollama&&!st.pending()&&(v.value.enabled=G.ollama.enabled,v.value.base_url=G.ollama.base_url||"",v.value.model=G.ollama.model||"",v.value.max_tokens=G.ollama.max_tokens||4096),G.kimi&&!j.pending()&&(m.value.enabled=G.kimi.enabled,m.value.model=G.kimi.model||"",m.value.max_tokens=G.kimi.max_tokens||4096),G.auxiliary&&(g.value=G.auxiliary,Ve.pending()||(p.value.enabled=G.auxiliary.enabled,p.value.model=G.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function J(){try{if(H.value=await Q.get("/api/ollama/status"),H.value.model&&(N.value=H.value.model),H.value.configured)try{const G=await Q.get("/api/ollama/models");M.value=G.models||[]}catch{M.value=[]}else if(v.value.base_url)try{const G=await Q.post("/api/ollama/probe-models",{base_url:v.value.base_url});M.value=G.models||[]}catch{M.value=[]}}catch{H.value={configured:!1}}}async function Y(){ee.value=!0,ie.value="";try{U.value=await Q.get("/api/codex/status")}catch(G){ie.value=G.message||"Failed to fetch Codex status"}finally{ee.value=!1}}async function pe(){const G=t.value?t.value.active_provider:"codex";L.value=!0;try{const Re=await Q.post("/api/llm/switch",{provider:s.value});Re.error?(s.value=G,b(Re.error,"error")):(b("Switched to "+s.value+" ("+Re.model+")"),await P())}catch(Re){s.value=G,b(Re.message||"Switch failed","error")}finally{L.value=!1}}async function ce(){Z.value=!0;try{const G=await Q.post("/api/ollama/reload");b(G.configured?"Ollama reloaded":G.reason||"Ollama not configured",G.configured?"success":"error"),await P()}catch(G){b(G.message||"Reload failed","error")}finally{Z.value=!1}}async function re(){ne.value=!0;try{await Q.post("/api/ollama/model",{model:N.value}),b("Model set to "+N.value),await P()}catch(G){b(G.message||"Failed","error")}finally{ne.value=!1}}async function se(){const G=v.value.base_url;if(!G){b("Enter a base URL first","error");return}C.value=!0;try{const Re=await Q.post("/api/ollama/probe-models",{base_url:G});M.value=Re.models||[],M.value.length?(b(M.value.length+" model(s) found"),!v.value.model&&M.value.length&&(v.value.model=M.value[0].name)):b("No models found at "+G,"error")}catch(Re){b(Re.message||"Could not reach Ollama","error")}finally{C.value=!1}}async function xe(){try{if(F.value=await Q.get("/api/kimi/status"),F.value.model&&(E.value=F.value.model),F.value.configured)try{const G=await Q.get("/api/kimi/models");O.value=G.models||[]}catch{O.value=[]}}catch{F.value={configured:!1}}}async function he(){q.value=!0;try{const G=await Q.post("/api/kimi/reload");b(G.configured?"Kimi reloaded":G.reason||"Kimi not configured",G.configured?"success":"error"),await P()}catch(G){b(G.message||"Reload failed","error")}finally{q.value=!1}}async function ge(){K.value=!0;try{await Q.post("/api/kimi/model",{model:E.value}),b("Model set to "+E.value),await P()}catch(G){b(G.message||"Failed","error")}finally{K.value=!1}}async function ke(){if(_.value){Fe();return}_.value=!0;try{await Q.put("/api/llm/codex/config",n.value),b("Codex config saved"),await Promise.all([X(),Y()])}catch(G){b(G.message||"Failed","error"),await Promise.all([X(),Y()])}finally{_.value=!1}}async function Ce(){if(A.value){st();return}A.value=!0;try{const G={...v.value},Re=x.value?v.value.api_key:null;Re===null&&delete G.api_key,await Q.put("/api/llm/ollama/config",G),b("Ollama config saved"),Re!==null&&v.value.api_key===Re&&(v.value.api_key="",x.value=!1),await Promise.all([X(),J()])}catch(G){b(G.message||"Failed","error")}finally{A.value=!1}}async function Oe(){if(T.value){j();return}T.value=!0;try{const G={...m.value},Re=w.value?m.value.api_key:null;Re===null&&delete G.api_key,await Q.put("/api/llm/kimi/config",G),b("Kimi config saved"),Re!==null&&m.value.api_key===Re&&(m.value.api_key="",w.value=!1),await Promise.all([X(),xe()])}catch(G){b(G.message||"Failed","error")}finally{T.value=!1}}async function Me(){if(R.value){Ve();return}R.value=!0;try{await Q.put("/api/llm/auxiliary/config",p.value),b("Auxiliary config saved"),await X()}catch(G){b(G.message||"Failed","error"),await X()}finally{R.value=!1}}const Fe=fl(ke),Ve=fl(Me),st=fl(Ce),j=fl(Oe),we=()=>(Fe.cancel(),ke()),Le=()=>(st.cancel(),Ce()),De=()=>(j.cancel(),Oe());async function Ke(G){try{await Q.post("/api/codex/account/"+G+"/activate"),b("Active account switched"),await Y()}catch(Re){b(Re.message||"Failed","error")}}async function qe(G){B.value=G;try{await Q.post("/api/codex/account/"+G+"/refresh"),b("Token refreshed"),await Y()}catch(Re){b(Re.message||"Refresh failed","error")}finally{B.value=null}}function ht(G,Re){de.value=G,_e.value=Re||""}async function ss(G){try{await Q.put("/api/codex/account/"+G+"/label",{label:_e.value}),b("Label updated"),de.value=null,await Y()}catch(Re){b(Re.message||"Failed","error")}}async function Is(G,Re){if(await bs({title:"Delete Codex account",message:`Delete ${Re||"account #"+(G+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await Q.del("/api/codex/account/"+G),b("Deleted. Pool reloaded."),await Y()}catch(Zs){b(Zs.message||"Failed","error")}}async function Ps(){ue.value=!0;try{const G=await Q.post("/api/codex/device-code");oe.value=G,V.value="pending",Fs(G)}catch(G){b(G.message||"Failed","error")}finally{ue.value=!1}}async function Fs(G){Be={cancelled:!1};const Re=Be;try{const fs=await Q.post("/api/codex/device-poll",{device_auth_id:G.device_auth_id,user_code:G.user_code,interval:G.interval});if(Re.cancelled)return;be.value=fs,V.value="success",await P()}catch(fs){if(Re.cancelled)return;me.value=fs.message||"Device login failed",V.value="error"}}function us(){Be&&(Be.cancelled=!0),V.value=null,oe.value=null}return Ye(P),_t(()=>{Be&&(Be.cancelled=!0),Fe.cancel(),Ve.cancel(),st.cancel(),j.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:L,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:f,auxForm:p,auxData:g,auxModelOptions:y,onAuxModelChange:S,savingAux:R,saveAuxConfigDebounced:Ve,ollamaForm:v,kimiForm:m,savingCodex:_,savingOllama:A,savingKimi:T,probingOllama:C,ollamaKeyDirty:x,kimiKeyDirty:w,ollamaStatus:H,ollamaModels:M,ollamaSelectedModel:N,reloading:Z,settingModel:ne,kimiStatus:F,kimiModels:O,kimiSelectedModel:E,reloadingKimi:q,settingKimiModel:K,codexLoading:ee,codexError:ie,codexData:U,refreshing:B,editingLabel:de,labelValue:_e,deviceState:V,deviceLoading:ue,deviceInfo:oe,deviceResult:be,deviceError:me,fetchAll:P,switchProvider:pe,reloadOllama:ce,setOllamaModel:re,reloadKimi:he,setKimiModel:ge,probeOllamaModels:se,saveCodexConfig:ke,saveOllamaConfig:Ce,saveKimiConfig:Oe,saveCodexConfigDebounced:Fe,saveOllamaConfigDebounced:st,saveKimiConfigDebounced:j,saveCodexConfigNow:we,saveOllamaConfigNow:Le,saveKimiConfigNow:De,activateAccount:Ke,refreshAccount:qe,startEditLabel:ht,saveLabel:ss,deleteAccount:Is,startDeviceLogin:Ps,cancelDeviceLogin:us,formatSize:I}}},tf={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function S1(e){return tf[e]||tf[(e||"").toLowerCase()]||"text-gray-400"}const T1={template:`
