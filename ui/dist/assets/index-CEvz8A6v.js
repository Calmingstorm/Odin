...
`).replace(/\n$/,""),d=Wm(c,xr.previewLines,xr.previewChars),u=t.kind==="audit_preview"?(f=t.metadata)==null?void 0:f.source:t.metadata,p=u&&(t.kind==="process_output"||u.kind==="process_output")?`PID ${u.pid??"?"} ${u.status??""}${Number.isInteger(u.exit_code)?` exit ${u.exit_code}`:""}`.trim():t.kind==="agent_result"&&(u!=null&&u.status)?`agent ${u.status}`:"";return{promoted:r,chars:i,lines:l,envelope:o,kind:t.kind,formatted:c,preview:d,outcome:p,header:t.header,summary:a.replace(/\n/g," "),warnings:$w(t)}}const Bw={name:"CompactOutput",props:{value:{default:""},rawValue:{default:void 0},label:{type:String,default:"Output"},hasContext:{type:Boolean,default:!1},recordId:{default:null}},setup(e){const t=h(!1),s=h(!0),n=h(!1),a=h(""),i=h(null),l=h(null),o=h(!1),r=G(()=>Uw(e.value)),c=G(()=>{const b=e.rawValue===void 0?e.value:e.rawValue;return typeof b=="string"?b:JSON.stringify(b,null,2)??""}),d=G(()=>n.value?c.value:r.value.formatted),u=G(()=>r.value.promoted&&r.value.preview.folded||o.value),p=G(()=>t.value?!!d.value:r.value.promoted),f=G(()=>p.value?"":r.value.summary);let m;function v(){if(t.value)return;const b=r.value.promoted?i.value:l.value;o.value=!!(b&&(b.scrollHeight>b.clientHeight+1||b.scrollWidth>b.clientWidth+1))}function w(){m==null||m.disconnect();for(const b of[i.value,l.value])b&&(m==null||m.observe(b));v()}function L(){t.value=!t.value,t.value||(n.value=!1)}function y(){n.value=!n.value,t.value=!0,a.value=""}async function g(){const b=e.value;try{await navigator.clipboard.writeText(d.value),b===e.value&&(a.value="Copied")}catch{b===e.value&&(a.value="Copy unavailable — select text manually")}}return Mt([()=>e.value,()=>e.rawValue,()=>e.recordId],(b,C)=>{(e.recordId===null||b[2]!==C[2])&&(t.value=!1,n.value=!1),a.value=""}),Mt([i,l,t,s,r],()=>Rt(w),{flush:"post"}),je(()=>{m=new ResizeObserver(v),w()}),ft(()=>m==null?void 0:m.disconnect()),{expanded:t,wrapped:s,rawMode:n,copyStatus:a,previewElement:i,summaryElement:l,model:r,body:d,canExpand:u,showBody:p,headerSummary:f,toggleExpanded:L,toggleRaw:y,copyOutput:g}},template:`
    ...
    </section>`},Xo={name:"ToolOutput",components:{CompactOutput:Bw},props:{value:{default:""},label:{type:String,default:"Output"},presentation:{type:String,default:"inspector"},rawValue:{default:void 0},hasContext:{type:Boolean,default:!1},recordId:{default:null}},setup(e){const t=h(!1),s=h(!0),n=h(!1),a=h(""),i=G(()=>Km(e.value)),l=G(()=>n.value?[{label:"Raw received value",text:i.value.raw}]:i.value.sections),o=G(()=>{let u=30,p=6e3;return l.value.map(f=>{const m=Wm(f.text,u,p);return u=Math.max(0,u-m.lines),p=Math.max(0,p-m.chars),{...f,display:t.value?f.text:m.text,folded:m.folded}})}),r=G(()=>o.value.some(u=>u.folded)),c=G(()=>n.value?i.value.raw:l.value.map(u=>u.label?`${u.label}
${u.text}`:u.text).join(`
...
... (truncated)`:s}function ip(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function xd(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Ym(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Qm=Symbol("agent-detail-cancelled"),Vw=15e3;function qw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((f,m)=>{r=f,c=m});function u(f,m){o||(o=!0,l!==null&&a(l),l=null,(f?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return o||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Qm),i==null||i.abort()}}}function Xm({state:e,requestDetail:t,timeoutMs:s=Vw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const w=qw(L=>t(p,{signal:L}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=w.cancel,v.promise=(async()=>{let L=null,y=null;try{L=await w.promise}catch(g){y=g}L!==Qm&&(l!==v||e.detailId!==p||(l=null,!y&&(L===null||typeof L!="object")&&(y=new Error(`${n} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=L,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function Gw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const Kw={components:{ToolOutput:Xo},template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const o=G(()=>e.value.filter(I=>I.status==="running").length),r=G(()=>e.value.filter(I=>I.status==="completed").length),c=G(()=>e.value.filter(I=>["failed","timeout","killed"].includes(I.status)).length),d=G(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=G(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(I=>["failed","timeout","killed"].includes(I.status)):e.value.filter(I=>I.status===i.value));function p(I){const U=Number(I.max_iterations)||0;return U<=0?0:Math.min(100,Math.round(I.iteration_count/U*100))}function f(I){return(Number(I.max_iterations)||0)>0}function m(I,U){return I?I==="N/A"?"N/A":U==="current_inheritance"?`inherit (currently ${I})`:I:"unknown"}function v(I){return m(I.display_model,I.display_model_source||I.display_source)}function w(I){return m(I.display_reasoning_effort,I.display_reasoning_effort_source||I.display_source)}function L(I){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[I]||""}const y=h(null),g=h(null),b=h(!1),C=h(null),k=h(""),A=Xm({state:{get detail(){return y.value},set detail(I){y.value=I},get detailId(){return g.value},set detailId(I){g.value=I},get detailLoading(){return b.value},set detailLoading(I){b.value=I},get detailError(){return C.value},set detailError(I){C.value=I}},requestDetail:(I,{signal:U})=>H.get(`/api/agents/${encodeURIComponent(I)}`,{signal:U})});async function x(I){k.value="",await A.open(I.id)}function N(){A.close(),k.value=""}async function $(){await A.refresh()}async function T(I,U){try{await navigator.clipboard.writeText(U||""),k.value=I,setTimeout(()=>{k.value===I&&(k.value="")},1500)}catch{_e.error("Copy failed")}}async function P(I=!1){I=I===!0,I||(t.value=!0);try{const U=await H.get("/api/agents");e.value=Array.isArray(U)?U:[],s.value=null}catch(U){I||(s.value=U.message)}I||(t.value=!1)}async function V(I){const U=e.value.find(W=>W.id===I);if(await qt({title:"Kill agent",message:`Kill agent "${(U==null?void 0:U.label)||I}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=I;try{await H.del(`/api/agents/${encodeURIComponent(I)}`),_e.success("Agent killed"),await P()}catch(W){_e.error(W.message||"Failed to kill agent")}n.value=null}}const J=Gw({isEnabled:()=>a.value&&l,refreshList:()=>P(!0),hasOpenDetail:()=>!!g.value,refreshDetail:$});function E(){J.start()}function S(){J.stop()}return Mt(a,()=>J.sync()),je(()=>{l=!0,P(),E()}),Qt(()=>{l=!0,P(!0),E()}),Gt(()=>{l=!1,S()}),ft(()=>{l=!1,S(),A.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:Aa,formatDuration:ui,progressPercent:p,hasProgress:f,displayModelText:v,displayEffortText:w,displaySourceLabel:L,detail:y,detailId:g,detailLoading:b,detailError:C,copied:k,openDetail:x,closeDetail:N,copyText:T,fetchAgents:P,killAgent:V,startAutoRefresh:E,stopAutoRefresh:S}}},Ww={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),o=h(null),r=h(null),c=h(null),d=h(null),u=h(!1),p=h(null),f=h("");let m=!1;const w=Xm({state:{get detail(){return c.value},set detail(S){c.value=S},get detailId(){return d.value},set detailId(S){d.value=S},get detailLoading(){return u.value},set detailLoading(S){u.value=S},get detailError(){return p.value},set detailError(S){p.value=S}},detailLabel:"Loop detail",requestDetail:(S,{signal:I})=>H.get(`/api/loops/${encodeURIComponent(S)}?limit=100`,{signal:I})});async function L(S){f.value="",await w.open(S.id)}function y(){w.close(),f.value=""}async function g(S,I){try{await navigator.clipboard.writeText(I||""),f.value=S,setTimeout(()=>{f.value===S&&(f.value="")},1500)}catch{_e.error("Copy failed")}}const b=G(()=>e.value.reduce((S,I)=>S+(I.iteration_count||0),0)),C=G(()=>e.value.filter(S=>S.status==="running").length);function k(S){return S==="running"?"loop-status-running":S==="error"?"loop-status-error":"loop-status-stopped"}function O(S){return S==="running"?"badge-success":S==="error"?"badge-danger":S==="completed"?"badge-info":"badge-warning"}function A(S){return S==="act"?"badge-warning":S==="silent"?"badge-info":"badge-success"}async function x(S=!1){S=S===!0,S||(t.value=!0);try{const I=await H.get("/api/loops");e.value=Array.isArray(I)?I:[],s.value=null}catch(I){S||(s.value=I.message)}S||(t.value=!1)}async function N(){l.value=null;const S=a.value;if(!S.goal.trim()){l.value="Goal is required";return}if(!S.channel_id.trim()){l.value="Channel ID is required";return}const I={goal:S.goal.trim(),channel_id:S.channel_id.trim(),interval_seconds:S.interval_seconds||60,mode:S.mode,max_iterations:S.max_iterations||50};S.stop_condition.trim()&&(I.stop_condition=S.stop_condition.trim()),i.value=!0;try{const U=await H.post("/api/loops",I);_e.success(`Loop started: ${U.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await x()}catch(U){l.value=U.message}i.value=!1}async function $(S){if(await qt({title:"Stop loop",message:`Stop loop ${S}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=S;try{await H.del(`/api/loops/${encodeURIComponent(S)}`),_e.success("Loop stopped"),await x()}catch(U){_e.error(U.message||"Failed to stop loop")}o.value=null}}async function T(S){r.value=S;try{await H.post(`/api/loops/${encodeURIComponent(S)}/restart`),_e.success("Loop restarted"),await x()}catch(I){_e.error(I.message||"Failed to restart loop")}r.value=null}function P(S){m&&S.payload&&(S.payload.loop_id||S.payload.type==="loop")&&(x(!0),d.value&&w.refresh())}let V=null;function J(){V!==null&&clearInterval(V),V=null}function E(){J(),m&&(V=setInterval(()=>{x(!0),d.value&&w.refresh()},5e3))}return je(()=>{m=!0,x(),Ye.subscribe("events",P),E()}),Qt(()=>{m=!0,x(!0),E()}),Gt(()=>{m=!1,J()}),ft(()=>{m=!1,Ye.unsubscribe("events",P),J(),w.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:f,totalIterations:b,runningCount:C,statusDotClass:k,statusBadge:O,modeBadge:A,formatAge:Jm,formatDuration:ui,formatTs:Aa,formatTokens:Ym,openDetail:L,closeDetail:y,copyText:g,fetchLoops:x,doCreate:N,doStop:$,doRestart:T}}},Jw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),o=h(null),r=G(()=>Xw(a.value.run_at));Mt(()=>a.value.run_at,()=>{o.value=null});const c=G(()=>{var de;const q=r.value;return q.state==="ok"?q.instant:q.state==="ambiguous"&&o.value!==null&&((de=q.options[o.value])==null?void 0:de.instant)||null}),d=G(()=>{const q=c.value;return q?`${q.toLocaleString()} local — ${q.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=h(null),v=h(null),w=h(null),L=h(null),y=h(null),g=h(null),b=h([]),C=h(!1),k=h("");let O=0;const A=G(()=>e.value.filter(q=>q.cron&&!q.one_time).length),x=G(()=>e.value.filter(q=>q.one_time).length),N=G(()=>e.value.filter(q=>q.trigger).length),$=G(()=>e.value.filter(q=>q.paused).length),T=G(()=>e.value.filter(q=>q.consecutive_failures>0).length);function P(q){if(!q)return"-";const de=Date.now(),Ie=(new Date(q).getTime()-de)/1e3;if(Ie<0)return"overdue";if(Ie<60)return"in < 1 min";if(Ie<3600)return`in ${Math.floor(Ie/60)} min`;if(Ie<86400){const M=Math.floor(Ie/3600),z=Math.floor(Ie%3600/60);return z>0?`in ${M}h ${z}m`:`in ${M}h`}const _=Math.floor(Ie/86400);return`in ${_} day${_!==1?"s":""}`}function V(q){return q==null?"-":q<1e3?`${q}ms`:q<6e4?`${(q/1e3).toFixed(1)}s`:ui(q/1e3)}function J(q=a.value.cron){a.value.cron=q,lp(a.value,"cron"),u.value=null}function E(q=a.value.run_at){a.value.run_at=q,lp(a.value,"run_at"),u.value=null}async function S(){const q=a.value.cron.trim();if(q){p.value=!0;try{u.value=await H.post("/api/schedules/validate-cron",{expression:q})}catch(de){u.value={valid:!1,error:de.message}}p.value=!1}}async function I(){t.value=!0,s.value=null;try{e.value=await H.get("/api/schedules")}catch(q){s.value=q.message}t.value=!1}async function U(q){if(g.value===q){g.value=null,b.value=[];return}g.value=q,C.value=!0,b.value=[];const de=++O;try{const he=await H.get(`/api/schedules/${encodeURIComponent(q)}/history?limit=10`);if(de!==O||g.value!==q)return;b.value=he,k.value=""}catch(he){if(de!==O||g.value!==q)return;b.value=[],k.value=he.message||"Failed to load execution history"}de===O&&(C.value=!1)}async function Z(){l.value=null;const q=a.value;if(!q.description.trim()){l.value="Description is required";return}if(!q.channel_id.trim()){l.value="Channel ID is required";return}if(!q.cron.trim()&&!q.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(q.cron.trim()&&q.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const de={description:q.description.trim(),action:q.action,channel_id:q.channel_id.trim()};if(q.cron.trim()&&(de.cron=q.cron.trim()),q.run_at.trim()){const he=r.value;if(he.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(he.state==="invalid"){l.value="One-time run time is not a valid date";return}const Ie=c.value;if(he.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Ie){l.value="One-time run time could not be resolved";return}de.run_at=Ie.toISOString()}if(q.action==="reminder"&&q.message.trim()&&(de.message=q.message.trim()),q.action==="check"&&(q.tool_name.trim()&&(de.tool_name=q.tool_name.trim()),q.report_format&&(de.report_format=q.report_format),q.tool_input_str.trim()))try{de.tool_input=JSON.parse(q.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await H.post("/api/schedules",de),_e.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await I()}catch(he){l.value=he.message}i.value=!1}async function W(q){m.value=q;try{const de=await H.post(`/api/schedules/${encodeURIComponent(q)}/run`);if(de.status==="failure")_e.error(`Execution failed: ${de.error||"unknown error"}`);else{const he=de.warning?`Executed (${de.warning})`:"Executed successfully";_e.success(he)}await I()}catch(de){_e.error(de.message||"Failed to trigger")}m.value=null}async function X(q){w.value=q.id;const de=!q.paused;try{await H.put(`/api/schedules/${encodeURIComponent(q.id)}`,{paused:de}),_e.success(de?"Schedule paused":"Schedule resumed"),await I()}catch(he){_e.error(he.message||"Failed to update schedule")}w.value=null}const oe=new Map;function Q(q,de){const he=oe.get(q.id);he&&clearTimeout(he.timer);const Ie={run:()=>pe(q,de),timer:null};Ie.timer=setTimeout(()=>{oe.delete(q.id),Ie.run()},500),oe.set(q.id,Ie)}async function pe(q,de){y.value=q.id;try{await H.put(`/api/schedules/${encodeURIComponent(q.id)}`,{report_format:de}),_e.success(de?"Structured report enabled":"Plain-text report enabled")}catch(he){_e.error(`Update failed: ${he.message}`)}finally{await I(),y.value=null}}function Oe(){for(const[q,de]of[...oe])clearTimeout(de.timer),oe.delete(q),de.run()}async function te(q){L.value=q;try{await H.post(`/api/schedules/${encodeURIComponent(q)}/reset-failures`),_e.success("Failure counters reset"),await I()}catch(de){_e.error(de.message||"Failed to reset")}L.value=null}async function ve(q){const de=e.value.find(Ie=>Ie.id===q);if(await qt({title:"Delete schedule",message:`Delete "${(de==null?void 0:de.description)||q}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=q;try{await H.del(`/api/schedules/${encodeURIComponent(q)}`),_e.success("Schedule deleted"),await I()}catch(Ie){_e.error(Ie.message||"Failed to delete schedule")}v.value=null}}return je(()=>{I()}),ft(Oe),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:f,runningId:m,deletingId:v,togglingId:w,resettingId:L,reportUpdatingId:y,flushReportFormatTimers:Oe,expandedId:g,history:b,historyLoading:C,historyError:k,cronCount:A,oneTimeCount:x,webhookCount:N,pausedCount:$,failingCount:T,formatTs:Aa,formatAge:Jm,formatFuture:P,formatMs:V,formatDuration:ui,onCronInput:J,onRunAtInput:E,validateCron:S,toggleExpand:U,fetchSchedules:I,doCreate:Z,doRunNow:W,doTogglePause:X,doUpdateReportFormat:Q,doResetFailures:te,doDelete:ve}}},ev=[{id:"live",label:"Live",component:Hw},{id:"agents",label:"Agents",component:Kw},{id:"loops",label:"Loops",component:Ww},{id:"processes",label:"Processes",component:Jw},{id:"schedules",label:"Schedules",component:ek}],tk={components:{TabbedPage:Qo},setup(){return{tabs:ev}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const o=h(null),r=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),m=h(!1),v=op,w=nk,L=h([]),y=h(!1),g=h(""),b=h("flat"),C=h(new Set),k=h(""),O=h(""),A=h(""),x=h(null),N=h(!1),$=h(""),T=h(!1);let P=0;Mt([k,O,A],()=>{P++,N.value=!1,$.value="",T.value=x.value!==null},{flush:"sync"});function V(){try{const le=localStorage.getItem("odin-session-presets");le&&(L.value=JSON.parse(le))}catch{}}function J(){try{localStorage.setItem("odin-session-presets",JSON.stringify(L.value))}catch{}}const E=G(()=>p.value.trim()!==""||u.value!=="all"),S=G(()=>{let le=[...e.value];const Se=op.find(Ve=>Ve.id===u.value),Ne=Se?Se.filters:{};if(Ne.source&&(le=le.filter(Ve=>Ve.source===Ne.source)),Ne.minMessages&&(le=le.filter(Ve=>Ve.message_count>=Ne.minMessages)),Ne.hasCompaction&&(le=le.filter(Ve=>Ve.has_summary)),Ne.maxAge!=null){const Ve=Date.now()/1e3;le=le.filter($t=>$t.last_active&&Ve-$t.last_active<=Ne.maxAge)}if(p.value.trim()){const Ve=p.value.toLowerCase().trim();le=le.filter($t=>($t.channel_id||"").toLowerCase().includes(Ve)||($t.last_user_id||"").toLowerCase().includes(Ve)||($t.source||"").toLowerCase().includes(Ve))}const Ke=f.value,Et=m.value?1:-1;return le.sort((Ve,$t)=>{const zt=Ve[Ke]||0,rs=$t[Ke]||0;return(zt-rs)*Et}),le}),I=G(()=>{if(!a.value||!a.value.messages)return[];const le=a.value.messages;if(le.length===0)return[];const Se=[];let Ne=[];for(const Ke of le)Ke.role==="user"&&Ne.length>0&&(Se.push(Ne),Ne=[]),Ne.push(Ke);return Ne.length>0&&Se.push(Ne),Se}),U=G(()=>S.value.length>0&&c.value.size===S.value.length);function Z(le){const Se=le.find(Ne=>Ne.role==="user");if(Se&&Se.content){const Ne=Se.content.slice(0,120);return Ne.length<Se.content.length?Ne+"...":Ne}return"(no user message)"}function W(le){const Se=new Set(C.value);Se.has(le)?Se.delete(le):Se.add(le),C.value=Se}function X(le){u.value=le}function oe(le){u.value=le.id,le.filters.searchQuery!=null&&(p.value=le.filters.searchQuery),le.filters.sortBy&&(f.value=le.filters.sortBy)}function Q(){if(!g.value.trim())return;const le={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};L.value=[...L.value,le],J(),y.value=!1,g.value=""}function pe(le){L.value=L.value.filter(Se=>Se.id!==le),J(),u.value===le&&(u.value="all")}function Oe(){u.value="all",p.value="",f.value="last_active",m.value=!1}function te(le){if(!le)return"—";const Se=Date.now()/1e3-le;if(Se<60)return"just now";if(Se<3600){const Ke=Math.floor(Se/60);return`${Ke} minute${Ke!==1?"s":""} ago`}if(Se<86400){const Ke=Math.floor(Se/3600);return`${Ke} hour${Ke!==1?"s":""} ago`}const Ne=Math.floor(Se/86400);return`${Ne} day${Ne!==1?"s":""} ago`}function ve(le){if(!le)return"";try{return new Date(le*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function q(le){if(!le)return"";try{return new Date(le*1e3).toLocaleString()}catch{return""}}function de(le){return le==="user"?"bg-gray-900/50 border border-gray-800":le==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function he(le){return le==="user"?"sess-msg-user":le==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Ie(le){return le==="user"?"badge-info":le==="assistant"?"badge-success":"badge-warning"}function _(le){return le==="user"?"sess-dot-user":le==="assistant"?"sess-dot-assistant":"sess-dot-system"}function M(le){return le==="user"?"text-cyan-400":le==="assistant"?"text-indigo-400":"text-gray-500"}function z(le){return le?le.length>2e3?le.slice(0,2e3)+`
... (truncated)`:le:""}async function ce(){const le=k.value.trim();if(!le)return;const Se=++P;N.value=!0,$.value="",T.value=x.value!==null;try{let Ne=`/api/sessions/search?q=${encodeURIComponent(le)}&limit=50`;O.value.trim()&&(Ne+=`&channel_id=${encodeURIComponent(O.value.trim())}`),A.value.trim()&&(Ne+=`&user_id=${encodeURIComponent(A.value.trim())}`);const Ke=await H.get(Ne);if(Se!==P)return;x.value=Ke.results||[],T.value=!1}catch(Ne){if(Se!==P)return;$.value=Ne.message||"Search failed. Please retry."}finally{Se===P&&(N.value=!1)}}function ae(){P++,k.value="",O.value="",A.value="",x.value=null,$.value="",T.value=!1,N.value=!1}function re(le){return le?le.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function me(le){return le==="user"?"fts-result-user":le==="assistant"?"fts-result-assistant":le==="summary"?"fts-result-summary":le==="fts"?"fts-result-fts":le==="channel"?"fts-result-channel":"fts-result-default"}function j(le){return le==="user"?"badge-info":le==="assistant"?"badge-success":le==="summary"?"badge-warning":le==="fts"?"badge-success":"badge-info"}let ee=0;async function Y(){const le=++ee;t.value=!0,s.value=null;try{const Se=await H.get("/api/sessions");if(le!==ee)return;e.value=Se}catch(Se){if(le!==ee)return;s.value=Se.message}le===ee&&(t.value=!1)}function fe(){s.value=null,Y()}async function ue(le){if(n.value===le){n.value=null,a.value=null,C.value=new Set;return}n.value=le,a.value=null,i.value=!0,C.value=new Set;const Se=++l;try{const Ne=await H.get(`/api/sessions/${encodeURIComponent(le)}`);Se===l&&n.value===le&&(a.value=Ne)}catch(Ne){Se===l&&n.value===le&&(a.value={messages:[],summary:"",error:Ne.message||"Failed to load session"})}finally{Se===l&&(i.value=!1)}}function be(le){const Se=new Set(c.value);Se.has(le)?Se.delete(le):Se.add(le),c.value=Se}function Ee(){U.value?c.value=new Set:c.value=new Set(S.value.map(le=>le.channel_id))}function F(le){o.value=le}async function ye(){if(o.value){r.value=!0;try{await H.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await Y()}catch(le){s.value=le.message||"Failed to clear session"}r.value=!1,o.value=null}}function ke(){d.value=!0}async function Le(){if(c.value.size!==0){r.value=!0;try{await H.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await Y()}catch(le){s.value=le.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function Me(le,Se){const Ne=`/api/sessions/${encodeURIComponent(le)}/export?format=${Se}`;try{const Ke=await H.getBlob(Ne),Et=URL.createObjectURL(Ke),Ve=document.createElement("a");Ve.href=Et,Ve.download=`session-${le}.${Se==="text"?"txt":"json"}`,Ve.click(),URL.revokeObjectURL(Et)}catch(Ke){s.value=Ke.message||"Failed to export session"}}let dt=null;function st(le){le.payload&&le.payload.channel_id&&(clearTimeout(dt),dt=setTimeout(()=>{if(Y(),n.value&&le.payload.channel_id===n.value){const Se=n.value,Ne=l;H.get(`/api/sessions/${encodeURIComponent(Se)}`).then(Ke=>{Ne!==l||n.value!==Se||(a.value=Ke)}).catch(()=>{})}},2e3))}let _t=!1,Ot=null;function rt(){_t||(_t=!0,Y(),Ye.subscribe("events",st),Ot=Ye.onReconnected(()=>Y()))}je(()=>{V(),rt()}),Qt(()=>{rt()});function Qe(){_t&&(_t=!1,Ye.unsubscribe("events",st),Ot&&(Ot(),Ot=null),clearTimeout(dt))}return Gt(Qe),ft(Qe),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:U,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:m,filterPresets:v,sortOptions:w,filteredSessions:S,hasActiveFilters:E,customPresets:L,showSavePreset:y,newPresetName:g,threadView:b,threads:I,collapsedThreads:C,ftsQuery:k,ftsChannelId:O,ftsUserId:A,ftsResults:x,ftsSearching:N,ftsError:$,ftsStale:T,formatAge:te,formatTimestamp:ve,formatFullTimestamp:q,messageClass:de,threadMsgClass:he,roleBadge:Ie,roleDotClass:_,roleLabelClass:M,truncateContent:z,threadSummary:Z,fetchSessions:Y,retry:fe,toggleSession:ue,toggleSelect:be,toggleSelectAll:Ee,confirmClear:F,clearSession:ye,confirmBulkClear:ke,doBulkClear:Le,exportSession:Me,applyPreset:X,applyCustomPreset:oe,saveCustomPreset:Q,removeCustomPreset:pe,resetFilters:Oe,toggleThread:W,runFtsSearch:ce,clearFtsSearch:ae,highlightSnippet:re,ftsResultClass:me,ftsTypeBadge:j}}},ik={props:["trace"],template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=h("7d"),i=h(0),l=h(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=G(()=>n.value.work||{}),f=G(()=>Math.max(1,...(n.value.activity_over_time||[]).map(k=>Number(k.count||0)))),m=G(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),v=k=>({height:`${Math.max(4,Math.round(Number(k||0)/f.value*100))}%`}),w=G(()=>s.value&&l.value-i.value>3e4);async function L(){const k=++d,O=a.value;try{const A=await H.get(`/api/usage?range=${encodeURIComponent(O)}`);if(k!==d||O!==a.value)return;n.value=A,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(A){k===d&&(t.value=A.message)}finally{k===d&&(e.value=!1)}}function y(k){a.value=k,e.value=!s.value,L()}function g(){e.value=!0,L()}function b(){c||(c=!0,L(),o=setInterval(L,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function C(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return je(b),Qt(b),Gt(C),ft(C),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:w,fmtNum:xd,fmtDuration:ok,tokenLabel:rk,activityTrackStyle:m,activityBar:v,selectRange:y,retry:g}}},tv=[{id:"audit",label:"Audit",component:sk},{id:"sessions",label:"Sessions",component:ak},{id:"traces",label:"Traces",component:lk},{id:"usage",label:"Usage & Activity",component:ck}],dk={components:{TabbedPage:Qo},setup(){return{tabs:tv}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},_r=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],uk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),o=h(null),r=h(null),c=h(!1),d=h(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(x){return x.source!=="builtin"?"":u[x.state]||""}function f(x,N){const $=x&&Array.isArray(x.tools)?x.tools:null;if(c.value=!!$,r.value=$?!!x.global_enabled:null,!$){e.value=N.map(V=>({...V,source:"unknown",enabled:void 0,state:null}));return}const T=new Set($.map(V=>V.name)),P=N.filter(V=>!T.has(V.name)).map(V=>({...V,source:V.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...$.map(V=>({...V,source:"builtin"})),...P]}async function m(x,N){if(d.value.has(x.name))return;const $=!!N.target.checked,T=new Set(d.value);T.add(x.name),d.value=T;try{const P=await H.post(`/api/tools/builtins/${encodeURIComponent(x.name)}/enabled`,{enabled:$});f(P,e.value),s.value=null;try{const V=await H.get("/api/tools");f(P,V)}catch(V){console.warn("Built-in toggle committed; visible catalog refresh failed",V)}}catch(P){N.target.checked=!!x.enabled,s.value=P.message||`Failed to toggle ${x.name}`}finally{const P=new Set(d.value);P.delete(x.name),d.value=P}}const v=G(()=>e.value.filter(x=>x.source==="builtin"&&x.is_core).length),w=G(()=>e.value.filter(x=>x.source==="skill").length),L=G(()=>Object.values(a.value).reduce((x,N)=>x+N,0));function y(x){for(const N of _r)if(N.id!=="other"&&N.match(x))return N.id;return"other"}const g=G(()=>{let x=e.value;if(n.value){const N=n.value.toLowerCase();x=x.filter($=>$.name.toLowerCase().includes(N)||($.description||"").toLowerCase().includes(N))}return o.value&&(x=x.filter(N=>y(N.name)===o.value)),x}),b=G(()=>{const x=new Set;for(const N of e.value)x.add(y(N.name));return _r.filter(N=>x.has(N.id))}),C=G(()=>{const x=g.value,N={};for(const T of x){const P=y(T.name);N[P]||(N[P]=[]),N[P].push(T)}const $=[];for(const T of _r)N[T.id]&&N[T.id].length>0&&$.push({label:T.label,icon:T.icon,tools:N[T.id].sort((P,V)=>P.name.localeCompare(V.name))});return $});function k(x){i.value={...i.value,[x]:!i.value[x]}}async function O(){t.value=!0,s.value=null;try{const[x,N,$]=await Promise.all([H.get("/api/tools"),H.get("/api/tools/stats").catch(()=>({})),H.get("/api/tools/builtins").catch(()=>null)]);f($,x),a.value=N||{}}catch(x){s.value=x.message}t.value=!1}function A(){O()}return je(()=>{O()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:w,totalUsage:L,filteredTools:g,groupedTools:C,usedCategories:b,stateBadge:p,applyInventory:f,toggleBuiltinTool:m,truncate:yd,toggleExpand:k,refresh:A}}};function pk(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function fk(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function $(Q){return fk(Q)}function T(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function P(Q){try{await navigator.clipboard.writeText(Q);const pe=e.value.find(Oe=>Oe.code===Q);pe&&(o.value=pe.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function V(Q){if(Q.key==="Tab"){Q.preventDefault();const pe=Q.target,Oe=pe.selectionStart,te=pe.selectionEnd;u.value=u.value.substring(0,Oe)+"    "+u.value.substring(te),Rt(()=>{pe.selectionStart=pe.selectionEnd=Oe+4})}}function J(Q){const pe=Q.target.previousElementSibling;pe&&(pe.scrollTop=Q.target.scrollTop)}async function E(){t.value=!0,s.value=null;try{e.value=await H.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function S(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const pe=await H.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:pe}}catch(pe){a.value={...a.value,[Q]:{result:pe.message,is_error:!0}}}i.value=null}function I(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function U(Q){r.value=!0,c.value="edit",d.value=Q.name,u.value=Q.code||"",p.value=null,f.value=null}function Z(){r.value=!1,p.value=null,f.value=null}async function W(){p.value=null,f.value=null;const Q=d.value.trim(),pe=u.value.trim();if(!Q){p.value="Name is required";return}if(!pe){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await H.post("/api/skills",{name:Q,code:pe}),f.value="Skill created successfully"):(await H.put(`/api/skills/${encodeURIComponent(Q)}`,{code:pe}),f.value="Skill updated successfully"),await E(),setTimeout(()=>{r.value=!1},800)}catch(Oe){p.value=Oe.message}m.value=!1}function X(Q){w.value=Q}async function oe(){if(w.value){L.value=!0;try{await H.del(`/api/skills/${encodeURIComponent(w.value)}`),await E()}catch(Q){_e.error(`Failed to delete skill: ${Q.message||"unknown error"}`)}L.value=!1,w.value=null}}return je(()=>{E()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:v,deleteTarget:w,deleting:L,enabledCount:y,totalExecutions:g,totalLines:b,displayedSkills:C,editLineCount:k,editorLineNums:O,editValidation:A,highlight:x,truncate:yd,formatTs:Aa,countLines:N,getLineNumbers:$,toggleCode:T,copyCode:P,handleEditorKey:V,syncScroll:J,fetchSkills:E,testSkill:S,showCreate:I,editSkill:U,cancelEdit:Z,saveSkill:W,confirmDelete:X,doDelete:oe}}};class Fs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const mk=/^[A-Za-z_][A-Za-z0-9_]*$/;function rp(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function cp(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Fs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Fs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Fs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Fs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function vk(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function gk(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Fs("Server name is required.","name");if(a.length>128||!mk.test(a))throw new Fs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Fs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=rp(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Fs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Fs("An HTTP endpoint is required for this connection.","url");if(d&&!vk(d))throw new Fs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Fs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=rp(e.allowlistText));const r=cp(e.headerRows,e.headersRemove,"Header"),c=cp(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function bk(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function yk(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function xk(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const _k=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function wk(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const kk=1e4,Sk=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function wr(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function Tk(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Ck={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),o=h({}),r=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),m=h(wr()),v=h(""),w=h(!1);let L=null,y=0,g=!1,b=!1;const C=_k,k=G(()=>{var F;return((F=e.value)==null?void 0:F.servers)||[]}),O=G(()=>{var F;return!!((F=e.value)!=null&&F.enabled)}),A=G(()=>{var F,ye,ke,Le;return{serverCount:((F=e.value)==null?void 0:F.server_count)||0,enabledCount:((ye=e.value)==null?void 0:ye.enabled_server_count)||0,connectedCount:((ke=e.value)==null?void 0:ke.connected_count)||0,toolCount:((Le=e.value)==null?void 0:Le.published_tool_count)||0}}),x=G(()=>{var F;return((F=f.value)==null?void 0:F.header_keys)||[]}),N=G(()=>{var F;return((F=f.value)==null?void 0:F.env_keys)||[]}),$=G(()=>{var F;return u.value==="edit"&&((F=f.value)==null?void 0:F.transport)==="http"}),T=G(()=>u.value==="add"||!$.value),P=G(()=>$.value?"Replace endpoint URL":"Endpoint URL"),V=G(()=>$.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function J(){E(),L=window.setInterval(()=>S({quiet:!0}),kk)}function E(){L&&window.clearInterval(L),L=null}async function S({quiet:F=!1}={}){const ye=++y;F||(t.value=!0);try{const ke=await H.get("/api/mcp/status");if(ye!==y||!g)return;e.value=ke,n.value="";const Le=new Set((ke.servers||[]).map(Me=>Me.name));i.value=new Set([...i.value].filter(Me=>Le.has(Me)))}catch(ke){ye===y&&g&&(n.value=ke.message||"Failed to load MCP status")}finally{ye===y&&(t.value=!1)}}function I(F){return s.value||a.value.has(F)}function U(F,ye){const ke=new Set(a.value);ye?ke.add(F):ke.delete(F),a.value=ke}function Z(F){return yk(F.state)}function W(F){if(Z(F)==="disabled"){if(!F.enabled)return"Disabled — server switch off";if(!O.value)return"Disabled — global MCP is off"}return Sk[Z(F)]}function X(F){return F.transport==="http"?"Streamable HTTP":"stdio"}function oe(F){return F.negotiated_version?`${F.era?`${String(F.era).charAt(0).toUpperCase()}${String(F.era).slice(1)}`:"Protocol"} · ${F.negotiated_version}`:"Not negotiated"}function Q(F){return F.discovered_count?`${F.published_count||0} published · ${F.excluded_count||0} excluded`:"No tools discovered"}const pe=h(new Set);async function Oe(F,ye){if(pe.value.has(F.name))return;const ke=!!ye.target.checked,Le=new Set(pe.value);Le.add(F.name),pe.value=Le;try{const Me=await H.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/enabled`,{enabled:ke});Me&&Array.isArray(Me.servers)?e.value=Me:await S({quiet:!0})}catch(Me){ye.target.checked=!!F.enabled,_e.error(Me.message||`Failed to toggle ${F.name}`)}finally{const Me=new Set(pe.value);Me.delete(F.name),pe.value=Me}}async function te(F){if(F!==O.value&&!(!F&&!await qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await H.post("/api/mcp/enabled",{enabled:F}),_e.success(F?"MCP enabled":"MCP disabled"),await S({quiet:!0})}catch(ye){_e.error(ye.message||"Failed to update MCP state"),await S({quiet:!0})}finally{s.value=!1}}}async function ve(F){U(F.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/reconnect`,{}),_e.success(`Reconnected ${F.name}`)}catch(ye){_e.error(ye.message||`Failed to reconnect ${F.name}`)}finally{U(F.name,!1),await S({quiet:!0})}}async function q(F){U(F.name,!0);try{await H.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/refresh-tools`,{}),_e.success(`Refreshed tools from ${F.name}`),await Ie(F.name,!0)}catch(ye){_e.error(ye.message||`Failed to refresh ${F.name}`)}finally{U(F.name,!1),await S({quiet:!0})}}async function de(F){if(await qt({title:`Remove ${F.name}`,message:`Remove this saved MCP server? Its ${F.published_count||0} published tool${F.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){U(F.name,!0);try{await H.del(`/api/mcp/servers/${encodeURIComponent(F.name)}`),_e.success(`Removed ${F.name}`),delete o.value[F.name]}catch(ke){_e.error(ke.message||`Failed to remove ${F.name}`)}finally{U(F.name,!1),await S({quiet:!0})}}}async function he(F){const ye=new Set(i.value);if(ye.has(F.name)){ye.delete(F.name),i.value=ye;return}ye.add(F.name),i.value=ye,Object.hasOwn(o.value,F.name)||await Ie(F.name)}async function Ie(F,ye=!1){if(!ye&&Object.hasOwn(o.value,F))return;const ke=new Set(c.value);ke.add(F),c.value=ke,r.value={...r.value,[F]:""};try{const Le=await H.get(`/api/mcp/servers/${encodeURIComponent(F)}/tools`);o.value={...o.value,[F]:Le.tools||[]}}catch(Le){r.value={...r.value,[F]:Le.message||"Failed to load tools"}}finally{const Le=new Set(c.value);Le.delete(F),c.value=Le}}function _(F){return(o.value[F]||[]).filter(ye=>xk(ye,l.value[F]))}function M(F,ye){l.value={...l.value,[F]:ye}}function z(){u.value="add",p.value="",f.value=null,m.value=wr(),v.value="",d.value=!0}function ce(F){u.value="edit",p.value=F.name,f.value=F,m.value={...wr(),name:F.name,enabled:!!F.enabled,transport:F.transport||"stdio"},v.value="",d.value=!0}function ae(){w.value||(d.value=!1)}function re(F){d.value&&wk(F)}function me(F){const ye=F==="headers"?"headerRows":"envRows";m.value[ye].push({key:"",value:""})}function j(F,ye){const ke=F==="headers"?"headerRows":"envRows";m.value[ke].splice(ye,1)}function ee(F,ye){const ke=F==="headers"?"headersRemove":"envRemove",Le=m.value[ke];m.value[ke]=Le.includes(ye)?Le.filter(Me=>Me!==ye):[...Le,ye]}async function Y(){var ye,ke;v.value="";let F;try{F=gk(m.value,{mode:u.value,originalTransport:((ye=f.value)==null?void 0:ye.transport)||""})}catch(Le){v.value=Le instanceof Fs?Le.message:"Invalid MCP server configuration",await Rt(),(ke=document.querySelector(".mcp-editor"))==null||ke.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&bk(F,f.value)&&!await qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){w.value=!0;try{u.value==="add"?await H.post("/api/mcp/servers",F):await H.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,F),_e.success(u.value==="add"?`Saved ${F.name}`:`Updated ${p.value}`),d.value=!1,await S({quiet:!0})}catch(Le){v.value=Le.message||"Failed to save MCP server"}finally{w.value=!1}}}let fe=null;function ue(F){`${(F==null?void 0:F.event)||""} ${(F==null?void 0:F.type)||""} ${(F==null?void 0:F.tool)||""} ${(F==null?void 0:F.message)||""}`.toLowerCase().includes("mcp")&&(fe&&window.clearTimeout(fe),fe=window.setTimeout(()=>S({quiet:!0}),200))}function be(){g||(g=!0,b||(Ye.subscribe("events",ue),b=!0),S(),J())}function Ee(){g=!1,E(),fe&&window.clearTimeout(fe),fe=null,b&&(Ye.unsubscribe("events",ue),b=!1)}return je(be),Qt(be),Gt(Ee),ft(Ee),{status:e,loading:t,mutating:s,pageError:n,servers:k,masterEnabled:O,aggregate:A,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:m,formError:v,saving:w,editorGroups:C,configuredHeaderKeys:x,configuredEnvKeys:N,savedHttpEndpoint:$,endpointRequired:T,endpointFieldLabel:P,endpointPlaceholder:V,refreshAll:S,busy:I,serverState:Z,stateLabel:W,transportLabel:X,protocolLabel:oe,toolSummary:Q,formatAge:Tk,setMasterEnabled:te,togglePending:pe,toggleServerEnabled:Oe,reconnect:ve,refreshTools:q,removeServer:de,toggleTools:he,filteredTools:_,setToolQuery:M,openAdd:z,openEdit:ce,closeEditor:ae,jumpToEditorGroup:re,addSecretRow:me,removeSecretRow:j,toggleSecretRemoval:ee,saveServer:Y}}};function Ek(e,t){if(!e||!t)return ip(e);const s=ip(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Ak={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),o=h(null),r=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),v=h(null);let w=null;const L=h(null),y=h(!1),g=h({}),b=h({}),C=h({}),k=h({}),O=new Map,A=h(null),x=G(()=>e.value.reduce((W,X)=>W+(X.chunks||0),0)),N=G(()=>new Set(e.value.map(X=>X.uploader).filter(Boolean)).size);function $(W,X){const oe=b.value[X];if(!oe||oe.length===0)return 0;const Q=Math.max(...oe.map(pe=>pe.char_count||0));return Q===0?0:Math.round(W.char_count/Q*100)}async function T(){t.value=!0,s.value=null;try{const W=await H.get("/api/knowledge");e.value=Array.isArray(W)?W:[]}catch(W){s.value=W.message}t.value=!1}async function P(W){if(g.value[W]){g.value[W]=!1,A.value=null;return}if(g.value[W]=!0,Object.prototype.hasOwnProperty.call(b.value,W))return;if(O.has(W))return O.get(W);const X={...k.value,[W]:!0};k.value=X;const oe={...C.value};delete oe[W],C.value=oe;const Q=H.get(`/api/knowledge/${encodeURIComponent(W)}/chunks`).then(pe=>{b.value={...b.value,[W]:Array.isArray(pe)?pe:[]}}).catch(pe=>{C.value={...C.value,[W]:pe.message||"load failed"}}).finally(()=>{if(O.get(W)!==Q)return;O.delete(W);const pe={...k.value};delete pe[W],k.value=pe});return O.set(W,Q),Q}let V=0;async function J(){const W=n.value.trim();if(!W)return;const X=++V;i.value=!0,o.value=null,l.value=W;try{const oe=await H.get(`/api/knowledge/search?q=${encodeURIComponent(W)}`);if(X!==V)return;a.value=Array.isArray(oe)?oe:[]}catch(oe){if(X!==V)return;a.value=[],o.value=oe.message||"Search failed"}X===V&&(i.value=!1)}function E(){V+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function S(){u.value=null,p.value=null;const W=c.value.trim(),X=d.value.trim();if(!W){u.value="Source name is required";return}if(!X){u.value="Content is required";return}f.value=!0;try{const oe=await H.post("/api/knowledge",{source:W,content:X});p.value=`Ingested ${oe.chunks||0} chunks from "${W}"`,c.value="",d.value="",b.value={},await T(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(oe){u.value=oe.message}f.value=!1}async function I(W){m.value=W,v.value=null,w&&(clearTimeout(w),w=null);try{const X=await H.post(`/api/knowledge/${encodeURIComponent(W)}/reingest`);v.value={source:W,error:!1,message:`Re-ingested ${X.chunks||0} chunks`},delete b.value[W],await T(),w=setTimeout(()=>{v.value=null,w=null},3e3)}catch(X){v.value={source:W,error:!0,message:X.message}}m.value=null}function U(W){L.value=W}async function Z(){if(L.value){y.value=!0;try{await H.del(`/api/knowledge/${encodeURIComponent(L.value)}`),delete b.value[L.value],await T()}catch(W){_e.error(`Failed to delete source: ${W.message||"unknown error"}`)}y.value=!1,L.value=null}}return je(()=>{T()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:v,deleteTarget:L,deleting:y,expanded:g,sourceChunks:b,chunkErrors:C,loadingChunks:k,selectedChunk:A,totalChunks:x,uploaderCount:N,truncate:yd,formatTs:Aa,highlightTerms:Ek,chunkBarWidth:$,fetchSources:T,toggleSource:P,doSearch:J,clearSearch:E,doIngest:S,doReingest:I,confirmDelete:U,doDelete:Z}}},Rk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),o=h(!1),r=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),m=h(!1),v=h(null),w=h(null),L=h(new Set),y=h(null),g=h(!1),b=h(!1),C=G(()=>e.value.reduce((X,oe)=>X+oe.count,0)),k=G(()=>L.value.size);function O(X){const oe=t.value[X];if(!oe)return[];if(!l.value.trim())return oe;const Q=l.value.trim().toLowerCase();return oe.filter(pe=>pe.key.toLowerCase().includes(Q)||pe.value&&pe.value.toLowerCase().includes(Q))}function A(X,oe){return L.value.has(X+"/"+oe)}function x(X,oe){const Q=X+"/"+oe,pe=new Set(L.value);pe.has(Q)?pe.delete(Q):pe.add(Q),L.value=pe}function N(X){const oe=t.value[X];return!oe||oe.length===0?!1:oe.every(Q=>L.value.has(X+"/"+Q.key))}function $(X,oe){const Q=t.value[X];if(!Q)return;const pe=new Set(L.value);for(const Oe of Q){const te=X+"/"+Oe.key;oe?pe.add(te):pe.delete(te)}L.value=pe}async function T(){s.value=!0,n.value=null;try{const X=await H.get("/api/memory");e.value=Object.entries(X).map(([oe,Q])=>({name:oe,keys:Q.keys||[],count:Q.count||0}))}catch(X){n.value=X.message}s.value=!1}async function P(X){if(a.value[X]){a.value[X]=!1;return}a.value[X]=!0;const oe=e.value.find(pe=>pe.name===X);if(!oe||t.value[X]||i.value===X)return;i.value=X;let Q;try{const Oe=(await H.get(`/api/memory/${encodeURIComponent(X)}`)).entries||{};Q=oe.keys.map(te=>Object.prototype.hasOwnProperty.call(Oe,te)?{key:te,value:Oe[te]||"",failed:!1}:{key:te,value:"",failed:!0,error:"Not found in scope"})}catch(pe){Q=oe.keys.map(Oe=>({key:Oe,value:"",failed:!0,error:pe.message||"Failed to load"}))}t.value[X]=Q,i.value=null}function V(X,oe,Q){p.value=X+"/"+oe,f.value=Q}async function J(X,oe){m.value=!0,v.value=null;try{await H.put(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(oe)}`,{value:f.value});const Q=t.value[X];if(Q){const pe=Q.find(Oe=>Oe.key===oe);pe&&(pe.value=f.value)}p.value=null}catch(Q){v.value=`Failed to save: ${Q.message||"unknown error"}`}m.value=!1}async function E(X,oe){try{await navigator.clipboard.writeText(oe.value),w.value=X+"/"+oe.key,setTimeout(()=>{w.value=null},1500)}catch{}}async function S(){d.value=null,u.value=null;const X=r.value.scope.trim(),oe=r.value.key.trim(),Q=r.value.value.trim();if(!X){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!Q){d.value="Value is required";return}c.value=!0;try{await H.put(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(oe)}`,{value:Q}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await T(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(pe){d.value=pe.message}c.value=!1}function I(X,oe){y.value={scope:X,key:oe}}async function U(){if(!y.value)return;g.value=!0,v.value=null;const{scope:X,key:oe}=y.value;try{await H.del(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(oe)}`);const Q=t.value[X];Q&&(t.value[X]=Q.filter(te=>te.key!==oe));const pe=e.value.find(te=>te.name===X);pe&&(pe.count--,pe.keys=pe.keys.filter(te=>te!==oe));const Oe=new Set(L.value);Oe.delete(X+"/"+oe),L.value=Oe}catch(Q){v.value=`Failed to delete: ${Q.message||"unknown error"}`}g.value=!1,y.value=null}function Z(){b.value=!0}async function W(){g.value=!0,v.value=null;const X=[];for(const oe of L.value){const Q=oe.indexOf("/");X.push({scope:oe.slice(0,Q),key:oe.slice(Q+1)})}try{await H.post("/api/memory/bulk-delete",{entries:X}),L.value=new Set,t.value={},await T()}catch(oe){v.value=`Bulk delete failed: ${oe.message||"unknown error"}`}g.value=!1,b.value=!1}return je(()=>{T()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:m,actionError:v,copied:w,selected:L,selectedCount:k,totalEntries:C,deleteTarget:y,deleting:g,showBulkDelete:b,fetchMemory:T,toggleScope:P,startEdit:V,doEdit:J,copyValue:E,doAdd:S,confirmDelete:I,doDelete:U,confirmBulkDelete:Z,doBulkDelete:W,isSelected:A,toggleSelect:x,isScopeAllSelected:N,toggleSelectAll:$,filteredEntries:O}}},Ik={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),o=G(()=>[...new Set(e.value.map(w=>w.category))].sort()),r=G(()=>{const v={};return e.value.forEach(w=>{v[w.category]=(v[w.category]||0)+1}),v}),c=G(()=>a.value?e.value.filter(v=>v.category===a.value):e.value);function d(v){return v==="correction"?"badge-warning":v==="operational"?"badge-info":v==="preference"?"badge-success":"badge-info"}function u(v){i.value=v.key,l.value=v.content}async function p(v){try{await H.put("/api/learned/"+encodeURIComponent(v),{content:l.value}),i.value=null,_e.success("Entry updated"),await m()}catch(w){_e.error(w.message||"Failed to save entry")}}async function f(v){if(await qt({title:"Delete learned entry",message:`Delete "${v}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/learned/"+encodeURIComponent(v)),_e.success("Entry deleted"),await m()}catch(L){_e.error(L.message||"Failed to delete entry")}}async function m(){s.value=!0,n.value=null;try{const v=await H.get("/api/learned");e.value=v.entries||[],t.value={last_reflection:v.last_reflection,count:v.count}}catch(v){n.value=v.message}s.value=!1}return je(m),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:o,catCounts:r,filtered:c,catBadge:d,formatTs:Aa,startEdit:u,saveEdit:p,deleteEntry:f,fetchEntries:m}}},sv=[{id:"tools",label:"Tools",component:uk},{id:"skills",label:"Skills",component:hk},{id:"mcp-servers",label:"MCP Servers",component:Ck},{id:"knowledge",label:"Knowledge",component:Ak},{id:"memory",label:"Memory",component:Rk},{id:"learned",label:"Learned",component:Ik}],Ok={components:{TabbedPage:Qo},setup(){return{tabs:sv}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Lk={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Nk={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},Dk={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},Pk={template:`
...
`)}),e.splice(a,1,L)}e.length>s&&e.splice(0,e.length-s)}function pc(e,t,s=new Date){var u,p;let n=e;if(Yn(e)&&e.type==="log"&&"line"in e?n=e.line:Yn(e)&&"payload"in e&&(n=e.payload),typeof n=="string")try{n=JSON.parse(n)}catch{}const a=Yn(n)?n:null,i=a!=null&&a.timestamp?new Date(a.timestamp):s,l=Number.isNaN(i.getTime())?s:i,o=a?a.result_summary??a.detail??a.message??JSON.stringify(a):typeof n=="string"?n:JSON.stringify(n)??"",c=(a==null?void 0:a.error)||((u=a==null?void 0:a.metadata)==null?void 0:u.error)||(a==null?void 0:a.success)===!1||[a==null?void 0:a.status,(p=a==null?void 0:a.metadata)==null?void 0:p.status].some(f=>["failed","error","cancelled","denied","outcome_unknown"].includes(f))?"ERROR":cl(a==null?void 0:a.level).toUpperCase()||"INFO",d={id:t,record:a,ts:l.toLocaleTimeString(),_time:l,level:c,text:typeof o=="string"?o:JSON.stringify(o),tool:cl(a==null?void 0:a.tool_name),raw:a?null:o,attribution:Hk(a)};return d.searchText=a?JSON.stringify(a):d.text,d}function jk(e){const t=new Map;for(const s of e){const{turnId:n,agentId:a,rootId:i,label:l,parentId:o}=s.attribution,r=n?`turn:${n}`:a?`root:${i||a}`:"unattributed";t.has(r)||t.set(r,{key:r,title:n?`Turn ${n}`:a?`Agent root ${i||a} (turn unavailable)`:"Unattributed / legacy records",count:0,sections:[],_sections:new Map});const c=t.get(r),d=a?`agent:${a}`:"main";if(!c._sections.has(d)){const u={key:d,agentId:a,label:l,parentId:o,rootId:i,title:a?`${l||"Agent"} (${a})`:"Main thread / turn events",entries:[]};c._sections.set(d,u),c.sections.push(u)}c._sections.get(d).entries.push(s),c.count++}return[...t.values()].map(({_sections:s,...n})=>n)}const Vk={components:{ToolOutput:Xo},props:{entry:{type:Object,required:!0}},emits:["copy"],setup(e){const t=G(()=>Bk(e.entry)),s=G(()=>{var o;return rl(((o=e.entry.record)==null?void 0:o.tool_input)??"")}),n=G(()=>{var o,r,c;return rl(((o=e.entry.record)==null?void 0:o.error)||((c=(r=e.entry.record)==null?void 0:r.metadata)==null?void 0:c.error)||"")}),a=G(()=>Uk(e.entry.record)),i=G(()=>nv(e.entry)),l=G(()=>(e.entry.events||[e.entry.record]).filter(Boolean).map(o=>{var r;return{type:o.type||"execution",timestamp:o.timestamp||"Time not recorded",status:o.status||((r=o.metadata)==null?void 0:r.status)||""}}));return{display:t,argumentsText:s,errorText:n,metadataText:a,rawRecord:i,lifecycle:l}},template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]);let s=0;const n=h(!1),a=h(!1),i=h(!0),l=h(""),o=h(""),r=h(!1),c=h(!1),d=h(Ye.state||"disconnected"),u=G(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),p=h(null),f=h(!1),m=h(null),v=2e3,w=qk,L=Gk,y=kr,g=h("all"),b=h(""),C=h([]),k=h(!1),O=h(""),A=h([]);function x(){try{const ne=localStorage.getItem("odin-log-presets");ne&&(C.value=JSON.parse(ne))}catch{}}function N(){try{localStorage.setItem("odin-log-presets",JSON.stringify(C.value))}catch{}}const $=G(()=>l.value!==""||o.value.trim()!==""||b.value!==""),T=G(()=>{const ne=kr.find(we=>we.value===b.value);return ne?ne.label:""}),P=G(()=>{if(!r.value||!o.value)return null;try{return new RegExp(o.value,"i"),null}catch(ne){return ne.message}}),V=24,J=G(()=>{if(X.value.length===0)return[];const ne=[],we=new Date,$e=3600*1e3;for(let Je=V-1;Je>=0;Je--){const wt=new Date(we.getTime()-(Je+1)*$e),ut=new Date(we.getTime()-Je*$e);ne.push({start:wt,end:ut,label:U(wt,ut),shortLabel:ut.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Je of X.value){if(!Je._time)continue;const wt=Je._time.getTime();for(const ut of ne)if(wt>=ut.start.getTime()&&wt<ut.end.getTime()){ut.total++,Je.level==="ERROR"?ut.errors++:Je.level==="WARNING"?ut.warnings++:ut.info++;break}}return ne}),E=G(()=>{let ne=1;for(const we of J.value)we.total>ne&&(ne=we.total);return ne}),S=G(()=>{if(J.value.length===0)return"";const ne=X.value.map(Je=>Je._time&&Je._time.getTime()).filter(Boolean);if(ne.length===0)return"";const we=new Date(Math.min(...ne));return`${X.value.length} shown, oldest ${we.toLocaleTimeString()}`}),I=G(()=>Math.ceil(V/8));function U(ne,we){const $e={hour:"2-digit",minute:"2-digit"};return ne.toLocaleTimeString([],$e)+" - "+we.toLocaleTimeString([],$e)}function Z(ne,we){return!we||!ne?"0px":Math.max(2,ne/we*100)+"%"}function W(ne){const we=X.value.findIndex($e=>$e._time&&$e._time.getTime()>=ne.start.getTime()&&$e._time.getTime()<ne.end.getTime());if(we>=0&&p.value){const $e=p.value.querySelector('[data-log-id="'+X.value[we].id+'"]');$e&&($e.scrollIntoView({behavior:"smooth",block:"center"}),i.value=!1)}}const X=G(()=>{let ne=t.value;if(l.value&&(ne=ne.filter(we=>(we.level||"INFO")===l.value)),b.value){const we=kr.find($e=>$e.value===b.value);if(we&&we.seconds){const $e=new Date(Date.now()-we.seconds*1e3);ne=ne.filter(Je=>Je._time&&Je._time>=$e)}}if(o.value&&!P.value)if(r.value)try{const we=new RegExp(o.value,"i");ne=ne.filter($e=>{const Je=$e.searchText,wt=$e.tool||"";return we.test(Je)||we.test(wt)})}catch{}else{const we=o.value.toLowerCase();ne=ne.filter($e=>{const Je=$e.searchText.toLowerCase(),wt=($e.tool||"").toLowerCase();return Je.includes(we)||wt.includes(we)})}return ne}),oe=G(()=>jk(X.value));function Q(ne){const we=pc(ne,++s);if(a.value){A.value.push(we);return}pe(we)}function pe(ne){zk(t.value,ne,v),i.value&&Rt(()=>Oe())}function Oe(ne=!1){const we=p.value;we&&we.scrollTo({top:we.scrollHeight,behavior:ne?"smooth":"instant"})}function te(){i.value=!0,f.value=!1,Rt(()=>Oe(!0))}const ve=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function q(){const ne=p.value;if(!ne)return;const we=ne.scrollHeight-ne.scrollTop-ne.clientHeight<40;f.value=!i.value&&!we&&t.value.length>0,_.value&&de()}function de(){const ne=p.value;!ne||!i.value||ne.scrollHeight-ne.scrollTop-ne.clientHeight>=40&&(i.value=!1,f.value=t.value.length>0)}function he(){i.value&&requestAnimationFrame(de)}function Ie(ne){ve.has(ne.key)&&he()}const _=h(!1);function M(){i.value&&(_.value=!0,requestAnimationFrame(de))}function z(){_.value&&(_.value=!1,de())}function ce(){i.value&&(f.value=!1,Rt(()=>Oe()))}function ae(){if(a.value=!a.value,!a.value&&A.value.length>0){for(const ne of A.value)pe(ne);A.value=[]}}function re(){t.value=[],A.value=[],f.value=!1}function me(){let ne;e.value==="search"?ne=Ne.value.map(wt=>{const ut=wt.error?"ERROR":"INFO",$n=wt.tool_name?`[${wt.tool_name}] `:"";return`${wt.timestamp||""} ${ut} ${$n}${wt.result_summary||wt.message||""}`}).join(`
`):ne=X.value.map(dp).join(`

`);const we=new Blob([ne],{type:"text/plain"}),$e=URL.createObjectURL(we),Je=document.createElement("a");Je.href=$e,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL($e)}function j(ne){const we=dp(ne);navigator.clipboard.writeText(we).then(()=>{m.value=ne.id,setTimeout(()=>{m.value=null},1500)}).catch(()=>{})}function ee(ne){l.value=l.value===ne?"":ne,g.value="all"}function Y(ne){return ne.level==="ERROR"?"log-line-error":ne.level==="WARNING"?"log-line-warning":"text-gray-300"}function fe(ne){return ne==="ERROR"?"text-red-500 font-semibold":ne==="WARNING"?"text-yellow-500":"text-blue-500"}function ue(ne){return ne==="ERROR"?"log-chip-error":ne==="WARNING"?"log-chip-warning":"log-chip-info"}function be(ne){g.value=ne.id;const we=ne.filters;l.value=we.level||"",b.value=we.timeRange||"",o.value=we.text||"",we.levels&&(l.value=we.levels[0]||""),we.hasToolName&&(o.value="")}function Ee(ne){g.value=ne.id,l.value=ne.filters.level||"",b.value=ne.filters.timeRange||"",o.value=ne.filters.text||""}function F(){if(!O.value.trim())return;const ne={id:"custom-"+Date.now(),name:O.value.trim(),filters:{level:l.value,timeRange:b.value,text:o.value}};C.value=[...C.value,ne],N(),k.value=!1,O.value=""}function ye(ne){C.value=C.value.filter(we=>we.id!==ne),N(),g.value===ne&&(g.value="all")}const ke=h("all"),Le=h(""),Me=h(""),dt=h(""),st=h(""),_t=h(""),Ot=h(100),rt=Kk,Qe=h(!1),le=h(!1),Se=h(""),Ne=h([]),Ke=h(null),Et=h(null);function Ve(){e.value="search",Ke.value||$t()}async function $t(){try{Ke.value=await H.get("/api/logs/stats")}catch{}}function zt(){const ne=_t.value;if(!ne){dt.value="",st.value="";return}const $e={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[ne];if($e){const Je=new Date(Date.now()-$e*1e3);dt.value=rs(Je),st.value=""}}function rs(ne){const we=$e=>String($e).padStart(2,"0");return`${ne.getFullYear()}-${we(ne.getMonth()+1)}-${we(ne.getDate())}T${we(ne.getHours())}:${we(ne.getMinutes())}`}function Js(ne){if(!ne)return"";const we=new Date(ne);return isNaN(we.getTime())?"":we.toISOString()}async function ks(){Qe.value=!0,Se.value="",le.value=!0,Et.value=null;try{const ne=new URLSearchParams;ke.value&&ke.value!=="all"&&ne.set("level",ke.value),Le.value&&ne.set("tool",Le.value),Me.value&&ne.set("q",Me.value);const we=Js(dt.value),$e=Js(st.value);we&&ne.set("start",we),$e&&ne.set("end",$e),ne.set("limit",String(Ot.value));const Je=await H.get(`/api/logs/search?${ne.toString()}`);Ne.value=Je.entries||[]}catch(ne){Se.value=ne.message||"Search failed",Ne.value=[]}finally{Qe.value=!1}}function na(){ke.value="all",Le.value="",Me.value="",dt.value="",st.value="",_t.value="",Ot.value=100,Ne.value=[],le.value=!1,Se.value="",Et.value=null}function Zs(ne){Et.value=Et.value===ne?null:ne}function Ns(ne){if(!ne.timestamp)return"";try{return new Date(ne.timestamp).toLocaleString()}catch{return ne.timestamp}}function Mn(ne){return ne.type==="web_action"?`${ne.status||""} (${ne.execution_time_ms||0}ms)`:(ne.result_summary||"").slice(0,200)}function Ss(ne){return ne.error?"log-line-error":"text-gray-300"}function Fn(ne){try{return JSON.stringify(ne,null,2)}catch{return String(ne)}}let Lt=null,Xe=!1;function Ts(){Xe||(Xe=!0,Ye.subscribe("logs",Q),c.value=Ye.connected,d.value=Ye.state||"disconnected",Lt=Ye.onState(ne=>{d.value=ne,c.value=ne==="connected"}))}function Ds(){Xe&&(Xe=!1,Ye.unsubscribe("logs",Q),Lt&&(Lt(),Lt=null))}return je(()=>{x(),window.addEventListener("pointerup",z),window.addEventListener("pointercancel",z)}),Qt(Ts),Gt(Ds),ft(()=>{Ds(),window.removeEventListener("pointerup",z),window.removeEventListener("pointercancel",z)}),{mode:e,logs:t,paused:a,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:n,groupedLogs:oe,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:X,pauseBuffer:A,showJumpBottom:f,copiedIndex:m,regexError:P,levels:w,logPresets:L,timeRanges:y,timeRange:b,activeLogPreset:g,customLogPresets:C,showSaveLogPreset:k,newLogPresetName:O,hasActiveLogFilters:$,timeRangeLabel:T,timelineBuckets:J,timelineMax:E,timelineSpanLabel:S,timelineLabelSkip:I,togglePause:ae,clearLogs:re,exportLogs:me,logLineClass:Y,levelClass:fe,levelChipClass:ue,toggleLevel:ee,copyLine:j,jumpToBottom:te,onScroll:q,onUserScrollIntent:he,onUserScrollKey:Ie,onAutoScrollToggle:ce,onPointerDown:M,applyLogPreset:be,applyCustomLogPreset:Ee,saveLogCustomPreset:F,removeLogCustomPreset:ye,segmentHeight:Z,jumpToTimelineBucket:W,searchLevel:ke,searchTool:Le,searchKeyword:Me,searchStart:dt,searchEnd:st,searchTimePreset:_t,searchLimit:Ot,searchLimits:rt,searching:Qe,searchRan:le,searchError:Se,searchResults:Ne,searchStats:Ke,expandedSearch:Et,switchToSearch:Ve,runSearch:ks,clearSearchFilters:na,toggleSearchExpand:Zs,formatSearchTs:Ns,searchEntryText:Mn,searchLogLineClass:Ss,formatJson:Fn,applySearchTimePreset:zt}}};function Pl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const Jk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function Zk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Xa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],Yk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},Ml=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord","computer"]),Qk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function pp(e){return Qk.some(t=>e===t||e.startsWith(`${t}.`))}const av="odin_config_center_expanded_v1",iv="odin_config_center_category_v1",Xk=50,eS=650,Sr=()=>H.get("/api/config/meta");function da(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Bi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Pa(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function tS(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function sS(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function lv(e,t){if(Bi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return da(t);const n={};for(const[a,i]of Object.entries(t)){const l=lv(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function nS(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=lv(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function ov(e,t,s,n){if(Bi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)ov(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function aS(){try{const e=JSON.parse(localStorage.getItem(av)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function iS(){try{const e=localStorage.getItem(iv);return Xa.some(t=>t.key===e)?e:Xa[0].key}catch{return Xa[0].key}}const lS={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),o=h(null),r=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(iS()),m=h(aS()),v=h({}),w=h({}),L=h(""),y=h({}),g=h({}),b=h([]),C=h([]),k=h(!1),O=h(!1),A=h(!1);let x=null,N=null,$={path:null,at:0},T=0;const P=G(()=>{var R;return(((R=t.value)==null?void 0:R.fields)||[]).filter(B=>!Ml.has(B.path.split(".")[0])&&!pp(B.path))}),V=G(()=>new Map(P.value.map(R=>[R.path,R]))),J=G(()=>Z.value.reduce((R,B)=>R+B.sections.length,0)),E=G(()=>P.value.length),S=G(()=>Jk),I=G(()=>b.value.length>0),U=G(()=>C.value.length>0),Z=G(()=>{if(!e.value)return[];const R=new Set(Xa.flatMap(Ae=>Ae.sections)),B=Xa.map(Ae=>({...Ae,sections:Ae.sections.filter(ct=>Object.hasOwn(e.value,ct)&&!Ml.has(ct))})).filter(Ae=>Ae.sections.length),se=Object.keys(e.value).filter(Ae=>!R.has(Ae)&&!Ml.has(Ae));return se.length&&B.push({key:"other",label:"Other",icon:"folder",sections:se}),B}),W=G(()=>e.value?{...e.value,...v.value}:null),X=G(()=>{if(!e.value)return[];const R=[];for(const[B,se]of Object.entries(v.value))ov(e.value[B],se,B,R);return R.filter(B=>!Bi(B.oldVal,B.newVal)).map(B=>{const se=M(B.path);return{...B,label:(se==null?void 0:se.label)||Pa(B.path.split(".").at(-1)),apply_mode:(se==null?void 0:se.apply_mode)||ee(B.path.split(".")[0])}})}),oe=G(()=>X.value.length>0),Q=G(()=>X.value.length),pe=G(()=>new Set(X.value.map(R=>R.path.split(".")[0])).size),Oe=G(()=>!!u.value||p.value!=="all"),te=G(()=>{const R={...g.value};for(const B of X.value){const se=M(B.path),Ae=mi(se,B.newVal);Ae&&(R[B.path]=Ae)}return R}),ve=G(()=>Object.keys(te.value).length>0),q=G(()=>e.value?(Oe.value?Z.value:Z.value.filter(B=>B.key===f.value)).map(B=>({...B,sections:B.sections.filter(se=>Qe(se))})).filter(B=>B.sections.length):[]),de=G(()=>{const R=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],B=new Map(R.map(se=>[se,[]]));for(const se of X.value){const Ae=B.has(se.apply_mode)?se.apply_mode:"restart";B.get(Ae).push(se)}return R.filter(se=>B.get(se).length).map(se=>({key:se,label:Xt(se),entries:B.get(se)}))}),he=G(()=>X.value.filter(R=>R.apply_mode==="restart").length),Ie=G(()=>P.value.filter(R=>R.pending_restart)),_=G(()=>Ie.value.length);function M(R){const B=V.value.get(R);return B?{...B,apply_details:Pl([B])}:null}function z(R){const B=`${R}.`;return P.value.filter(se=>se.path===R||se.path.startsWith(B))}function ce(){return P.value.some(R=>R.path==="tools.hosts"||R.path.startsWith("tools.hosts."))}function ae(){var se,Ae;const R=((Ae=(se=e.value)==null?void 0:se.tools)==null?void 0:Ae.hosts)||{},B=Object.keys(R).length;return`${B} host${B===1?"":"s"} configured.`}function re(R){return z(R).length}function me(R){return Pa(R)}function j(R){const B=z(R);if(!B.length)return`${Pa(R)} configuration.`;const se=B.find(Cs=>Cs.sensitivity==="public"&&Cs.description)||B.find(Cs=>Cs.description),Ae=(se==null?void 0:se.description)||"";return Ae.match(/setting for (.+)\.$/i)?`${Pa(R)} settings and runtime behaviour.`:Ae}function ee(R){const B=[...new Set(z(R).map(se=>se.apply_mode))];return B.length===1?B[0]:B.includes("restart")?"restart":B.includes("activation_required")?"activation_required":B[0]||"restart"}function Y(R){const B=[...new Set(z(R).map(se=>Xt(se.apply_mode)))];return B.length?B.length===1?B[0]:`Mixed apply behaviour: ${B.join(" · ")}`:""}function fe(R){return Pl(z(R))}function ue(R){var B;return Object.hasOwn(v.value,R)?v.value[R]:(B=e.value)==null?void 0:B[R]}function be(){const R=ue("mcp")||{},B=Object.keys(R.servers||{}).length;return`${R.enabled?"Globally enabled":"Globally disabled"} · ${B} configured server${B===1?"":"s"}.`}function Ee(R,B){return B.split(".").reduce((se,Ae)=>se==null?void 0:se[Ae],R)}function F(R){const B=W.value;return z(R).filter(se=>pp(se.path)?!1:se.path.split(".").length<=2?!0:!se.path.includes(".*")).map(se=>({...se,key:se.path.split(".").at(-1),value:Ee(B,se.path),apply_details:Pl([se]),editor:se.path==="agents.final_warning_iterations"?"warning-chips":null}))}function ye(R){const B=R.path.split(".");return B.length>2?B.slice(0,2).join("."):null}function ke(R){const B=new Map;for(const se of F(R)){const Ae=ye(se),ct=Ae||`${R}.__root`;B.has(ct)||B.set(ct,{key:ct,path:Ae,entries:[]}),B.get(ct).entries.push(se)}return[...B.values()].map(se=>{const Ae=se.entries.find(ct=>ct.group_description);return{...se,label:se.path?Pa(se.path.split(".").at(-1)):null,description:(Ae==null?void 0:Ae.group_description)||null,apply_details:Pl(se.entries),runtime_summaries:Me(se.entries)}})}function Le(R){return{save:R.save_effect||(R.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:R.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[R.apply_mode]||"Effective runtime state is not currently observable."}}function Me(R){const B=new Map;for(const se of R){const Ae=Le(se),ct=`${se.apply_mode}|${Ae.save}|${Ae.runtime}`;B.has(ct)||B.set(ct,{key:ct,label:Xt(se.apply_mode),save:Ae.save,runtime:Ae.runtime})}return[...B.values()]}function dt(R){if(st(R))return R.runtime_effect||R.activation_policy||"";if(R.apply_mode==="activation_required"){const B=R.activation_policy||R.runtime_effect;return B?`Not active after saving. No activation control exists in this release. ${B}`:"Not active after saving; no activation control exists in this release."}return""}function st(R){return R.action_available===!0&&!!(R.action_label&&R.action_endpoint)}async function _t(R){if(st(R))try{if(Et(R.path))throw new Error("Save this setting before applying its action.");const B=String(R.action_method||"POST").toLowerCase(),se={post:H.post.bind(H),put:H.put.bind(H),delete:H.del.bind(H)}[B];if(!se)throw new Error("Unsupported configuration action");await se(R.action_endpoint,R.action_body||void 0),await De(),es("success",`${R.action_label} completed.`)}catch(B){es("error",B.message||`${R.action_label} failed`)}}function Ot(R,B){return[R.label,R.path,R.description,...R.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(B)}function rt(R){const B=u.value.trim().toLowerCase();return B?z(R).filter(se=>Ot(se,B)):[]}function Qe(R){const B=z(R);if(p.value!=="all"&&!B.some(Ae=>Ae.apply_state===p.value))return!1;const se=u.value.trim().toLowerCase();return!se||`${me(R)} ${R}`.toLowerCase().includes(se)?!0:B.some(Ae=>Ot(Ae,se))}function le(R,B){return z(R).filter(se=>se.apply_state===B).length}function Se(R){return R==="all"?E.value:P.value.filter(B=>B.apply_state===R).length}function Ne(R){const B=R.sections.flatMap(se=>z(se));return{fields:B.length,modified:X.value.filter(se=>R.sections.includes(se.path.split(".")[0])).length,pending_restart:B.filter(se=>se.apply_state==="pending_restart").length,invalid:B.filter(se=>se.apply_state==="invalid").length,dormant:B.filter(se=>se.apply_state==="dormant").length}}function Ke(R){var B;return Object.hasOwn(v.value,R)&&!Bi((B=e.value)==null?void 0:B[R],v.value[R])}function Et(R){return X.value.some(B=>B.path===R||B.path.startsWith(`${R}.`))}function Ve(R){f.value=R,u.value="",p.value="all";try{localStorage.setItem(iv,R)}catch{}}function $t(R){p.value=R}function zt(){u.value="",p.value="all"}function rs(R){var B;return((B=Z.value.find(se=>se.sections.includes(R)))==null?void 0:B.sections)||[]}function Js(R){const B=rs(R),se=B.find(Ae=>m.value[Ae]===!0);return se||B.find(Ae=>m.value[Ae]!==!1)||null}function ks(R){return u.value&&!A.value&&Qe(R)?!0:A.value?Js(R)===R:Object.hasOwn(m.value,R)?m.value[R]===!0:!0}function na(R){const B=!ks(R);if(A.value){const se={...m.value};for(const Ae of rs(R))se[Ae]===!0&&(se[Ae]=!1);se[R]=B,m.value=se;return}m.value={...m.value,[R]:B}}function Zs(){b.value.push(da(v.value)),b.value.length>Xk&&b.value.shift(),C.value=[]}function Ns(){oe.value&&(Zs(),v.value={},g.value={},k.value=!1)}function Mn(R,B=!1){const se=Date.now();if(B&&$.path===R&&se-$.at<eS){$.at=se;return}Zs(),$={path:R,at:se}}function Ss(R,B,se){if(!B.length)return se;const Ae=da(R??{});let ct=Ae;for(let Cs=0;Cs<B.length-1;Cs+=1){const pn=B[Cs];ct[pn]=da(ct[pn]??{}),ct=ct[pn]}return ct[B.at(-1)]=se,Ae}function Fn(R){var B;return Object.hasOwn(v.value,R)?v.value[R]:da((B=e.value)==null?void 0:B[R])}function Lt(R,B,se={}){var Id;if(Ml.has(R.path.split(".")[0]))return;const[Ae,...ct]=R.path.split(".");Mn(R.path,!!se.coalesce);const Cs=Fn(Ae),pn=ct.length?Ss(Cs,ct,B):B,ia={...v.value};if(Bi(pn,(Id=e.value)==null?void 0:Id[Ae])?delete ia[Ae]:ia[Ae]=pn,v.value=ia,g.value[R.path]){const Od={...g.value};delete Od[R.path],g.value=Od}}function Xe(R){$={path:null,at:0},w.value={...w.value,[R]:String(Ee(W.value,R)??"")}}function Ts(R){if($={path:null,at:0},!Object.hasOwn(w.value,R))return;const B={...w.value};delete B[R],w.value=B}function Ds(R){const B=w.value[R.path];if($={path:null,at:0},B===""){if(R.nullable){Ts(R.path),Lt(R,null,{coalesce:!0});return}g.value={...g.value,[R.path]:"Enter a number."};return}const se=Number(B);if(Number.isNaN(se)||R.type==="integer"&&!Number.isInteger(se)){g.value={...g.value,[R.path]:R.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ae={...w.value};delete Ae[R.path],w.value=Ae,Lt(R,se,{coalesce:!0})}function ne(R){return Object.hasOwn(w.value,R.path)?w.value[R.path]:R.value??""}function we(R,B){if(w.value={...w.value,[R.path]:B},B===""){if(R.nullable){Lt(R,null,{coalesce:!0});return}g.value={...g.value,[R.path]:"Enter a number."};return}const se=Number(B);if(!Number.isFinite(se)||R.type==="integer"&&!Number.isInteger(se)){g.value={...g.value,[R.path]:R.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[R.path]){const Ae={...g.value};delete Ae[R.path],g.value=Ae}Lt(R,se,{coalesce:!0})}function $e(R){const B=Number.parseInt(L.value,10);if(!Number.isInteger(B)||B<1){g.value={...g.value,[R.path]:"Warning thresholds must be positive whole numbers."};return}const se=[...new Set([...R.value||[],B])].sort((Ae,ct)=>ct-Ae);L.value="",Lt(R,se)}function Je(R,B){Lt(R,(R.value||[]).filter(se=>se!==B))}function wt(R){return R.apply_mode==="live_read"?"Odin reads the saved file value on next use.":R.apply_mode==="live_for_new_work"?"New work uses the saved file value.":R.apply_mode==="live_apply"?R.apply_handler?`Apply the saved value through ${R.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":R.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":R.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":R.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ut(R){return R.type==="array"&&Array.isArray(R.value)&&!R.structured_container&&!R.structured_container_child&&R.sensitivity==="public"&&R.value.every(B=>["string","number","boolean"].includes(typeof B))}function $n(R){const B=String(y.value[R.path]??"").trim();if(!B)return;const se=[...new Set([...R.value||[],B])];y.value={...y.value,[R.path]:""},Lt(R,se)}function js(R,B){Lt(R,(R.value||[]).filter(se=>se!==B))}function mi(R,B){var Ae;if(!R)return null;if((Ae=R.enum)!=null&&Ae.length&&!R.enum.includes(B))return`Choose one of: ${R.enum.join(", ")}`;if(R.path==="agents.final_warning_iterations"&&(!Array.isArray(B)||!B.length))return"Add at least one warning threshold.";const se=R.constraints||{};if((R.type==="integer"||R.type==="number")&&typeof B=="number"){if(se.minimum!==void 0&&B<se.minimum)return`Must be at least ${se.minimum}${R.unit?` ${R.unit}`:""}`;if(se.maximum!==void 0&&B>se.maximum)return`Must be at most ${se.maximum}${R.unit?` ${R.unit}`:""}`}return null}function vi(R){return te.value[R.path]||null}function Ia(R){const B=`${R}.`;return Object.keys(te.value).some(se=>se===R||se.startsWith(B))}function aa(){b.value.length&&(C.value.push(da(v.value)),v.value=b.value.pop(),g.value={},w.value={},$={path:null,at:0})}function Un(){C.value.length&&(b.value.push(da(v.value)),v.value=C.value.pop(),g.value={},w.value={},$={path:null,at:0})}function Bn(){!oe.value||ve.value||(k.value=!0,O.value=!1)}function Ys(){k.value=!1}function dn(){Ns()}function Xt(R){return Yk[R]||Pa(R||"unknown")}function Oa(R){return`apply-${String(R||"unknown").replaceAll("_","-")}`}function K(R){return`cfgc-field-${R.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function xe(R){return`${K(R)}-input`}function Re(R){const B=document.getElementById(K(R))||document.getElementById(K(R.split(".").slice(0,2).join(".")));B==null||B.scrollIntoView({behavior:"smooth",block:"center"})}function es(R,B){l.value={type:R,message:B},window.setTimeout(()=>{var se;((se=l.value)==null?void 0:se.message)===B&&(l.value=null)},3500)}function un(){r.value=!1,p.value="pending_restart",u.value="";const R=Zk(n.value);R&&(R.scrollTop=0)}function Hn(){r.value=!1}function Te(R=1800){N&&window.clearTimeout(N),N=window.setTimeout(D,R)}async function D(){if(c.value){if(T+=1,T>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await Sr(),_.value===0){c.value=!1,d.value=null,es("success","Odin restarted and the saved startup settings are active.");return}}catch{}Te(2e3)}}async function ie(){if(!c.value){d.value=null;try{await H.post("/api/restart",{}),c.value=!0,T=0,r.value=!1,Te()}catch(R){d.value=R.message||"Odin could not schedule a restart."}}}async function ge(){if(!(!oe.value||ve.value||a.value)){a.value=!0;try{const R=nS(e.value,v.value),B=await H.put("/api/config",R);e.value=B,v.value={},b.value=[],C.value=[],g.value={},k.value=!1;try{t.value=await Sr(),o.value=null,r.value=_.value>0,es("success",_.value?`Configuration saved. ${_.value} setting${_.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(se){o.value=se.message||"Unknown metadata error.",es("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(R){es("error",R.message||"Configuration could not be saved")}finally{a.value=!1}}}async function De(){var R,B;if(!oe.value){s.value=!0,i.value=null;try{const se=await H.get("/api/config"),Ae=await Sr();e.value=se,t.value=Ae,o.value=null;const ct=Z.value;if(ct.some(Cs=>Cs.key===f.value)||(f.value=((R=ct[0])==null?void 0:R.key)||Xa[0].key),A.value){const pn=(((B=ct.find(ia=>ia.key===f.value))==null?void 0:B.sections)||[]).find(ia=>m.value[ia]===!0);m.value=pn?{...m.value,[pn]:!0}:{}}}catch(se){i.value=se.message||"Unknown configuration error"}finally{s.value=!1}}}function Fe(R){if(k.value||!(R.ctrlKey||R.metaKey))return;const B=R.target;B instanceof HTMLElement&&(B.matches("input, textarea, select")||B.isContentEditable)||(!R.shiftKey&&R.key.toLowerCase()==="z"?(R.preventDefault(),aa()):(R.key.toLowerCase()==="y"||R.shiftKey&&R.key.toLowerCase()==="z")&&(R.preventDefault(),Un()))}function Be(R){A.value=R.matches}Mt(m,R=>{try{localStorage.setItem(av,JSON.stringify(R))}catch{}},{deep:!0});let yt=!1;function it(){yt||(yt=!0,document.addEventListener("keydown",Fe))}function vt(){yt&&(yt=!1,document.removeEventListener("keydown",Fe))}return je(()=>{var R;De(),it(),x=window.matchMedia("(max-width: 760px)"),Be(x),(R=x.addEventListener)==null||R.call(x,"change",Be)}),Qt(it),Gt(vt),ft(()=>{var R;vt(),(R=x==null?void 0:x.removeEventListener)==null||R.call(x,"change",Be),N&&window.clearTimeout(N)}),{armKeydown:it,disarmKeydown:vt,handleKeydown:Fe,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:k,mobileOverflowOpen:O,warningThresholdInput:L,arrayInputs:y,healthFilters:S,visibleCategories:Z,displayGroups:q,reviewGroups:de,sectionCount:J,fieldCount:E,hasChanges:oe,changeCount:Q,changedSectionCount:pe,hasDraftErrors:ve,canUndo:I,canRedo:U,globalFilterActive:Oe,reviewRestartCount:he,pendingRestartCount:_,pendingRestartFields:Ie,healthCount:Se,categoryStats:Ne,selectCategory:Ve,selectHealthFilter:$t,clearFilters:zt,sectionLabel:me,sectionDescription:j,sectionFieldCount:re,sectionHealthCount:le,sectionApplySummary:Y,sectionApplyDetails:fe,sectionEntries:F,fieldGroups:ke,sectionSearchHits:rt,mcpConfigSummary:be,fieldRuntimeCopy:Le,fieldSpecificRuntimeNote:dt,hasHonestAction:st,runFieldAction:_t,hasHostsCollection:ce,hostsConfigSummary:ae,sectionChanged:Ke,fieldChanged:Et,isSectionExpanded:ks,toggleSection:na,discardAllDrafts:Ns,setFieldValue:Lt,setNumberFieldValue:we,numberInputValue:ne,beginInputEdit:Xe,endTextInputEdit:Ts,endInputEdit:Ds,addWarningThreshold:$e,removeWarningThreshold:Je,isScalarArray:ut,addScalarArrayItem:$n,removeScalarArrayItem:js,fieldError:vi,sectionHasErrors:Ia,undo:aa,redo:Un,openReview:Bn,closeReview:Ys,mobileCancel:dn,applyModeLabel:Xt,applyClass:Oa,compactValue:tS,formatValue:sS,structuredApplyCopy:wt,fieldId:K,fieldInputId:xe,focusField:Re,fetchConfig:De,saveConfig:ge,restartOdin:ie,restartLater:Hn,reviewPendingRestart:un}}},oS=/^\d{15,25}$/;function rv(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const cv={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=h(""),n=h(!1),a=h(0),i=h(null),l=G(()=>new Set((e.excludedIds||[]).map(String))),o=G(()=>{const C=s.value.toLowerCase().trim();return(e.members||[]).filter(k=>l.value.has(String(k.id))?!1:C?u(k).toLowerCase().includes(C)||String(k.username||"").toLowerCase().includes(C)||String(k.id).includes(C):!0)}),r=G(()=>{const C=s.value.trim();return o.value.length===0&&oS.test(C)&&!l.value.has(C)?C:""}),c=G(()=>o.value.length+(r.value?1:0)),d=G(()=>{if(n.value){if(o.value[a.value])return`${e.optionsId}-${a.value}`;if(r.value&&a.value===o.value.length)return`${e.optionsId}-raw`}});function u(C){return rv(C)}function p(){n.value=!0,a.value=0}function f(){p()}function m(){const C=Math.max(c.value-1,0);a.value=Math.min(a.value+1,C)}function v(){a.value=Math.max(a.value-1,0)}function w(){const C=o.value[a.value];C?L(C):r.value&&a.value===o.value.length&&y(r.value)}function L(C){y(String(C.id))}function y(C){t("select",C),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function b(){setTimeout(g,150)}return je(()=>{e.autofocus&&Rt(()=>{var C;return(C=i.value)==null?void 0:C.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:f,highlightNext:m,highlightPrevious:v,selectHighlighted:w,selectMember:L,selectId:y,closeOptions:g,onBlur:b}}};function fp(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const rS={components:{DiscordUserCombobox:cv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h(null),i=h(null),l=h(!1),o=h(null),r=h({}),c=h([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=G(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),f=G(()=>new Map(c.value.map(E=>[String(E.id),E])));function m(E){return E.config&&E.config.enabled!==void 0?E.config.enabled:!0}function v(E){return fp(E,"require_mention",a.value)}function w(E){return fp(E,"respond_to_bots",a.value)}function L(E){return E.config&&Object.keys(E.config).length>0}function y(E){n.value[E]=!n.value[E]}function g(E){const S=E.discord||{};return{allowed_users:[...S.allowed_users||[]],channels:[...S.channels||[]],respond_to_bots:!!S.respond_to_bots,require_mention:!!S.require_mention,ignore_bot_ids:[...S.ignore_bot_ids||[]]}}async function b({showLoading:E=!0}={}){const S=++d;E&&(t.value=!0),s.value=null;try{const I=await H.get("/api/discord/guilds");S===d&&(e.value=I)}catch(I){S===d&&(s.value=I.message)}finally{E&&S===d&&(t.value=!1)}}async function C(){t.value=!0,s.value=null;try{const[E,S,I]=await Promise.all([H.get("/api/discord/guilds"),H.get("/api/discord/members").catch(()=>[]),H.get("/api/config")]),U=g(I),Z=p.value;a.value=U,Z||(i.value=JSON.parse(JSON.stringify(U))),c.value=S,e.value=E,o.value=null}catch(E){s.value=E.message}finally{t.value=!1}}let k=Promise.resolve();const O=h(new Set);function A(E,S){const I=new Set(O.value);I.add(E),O.value=I;const U=k.then(S);return k=U.catch(()=>{}),U.finally(()=>{const Z=new Set(O.value);Z.delete(E),O.value=Z})}function x(E,S,I,U){const Z=(U==null?void 0:U.target)??null;return A(`guild:${E}:${S}`,async()=>{try{await H.put("/api/discord/guild/"+E+"/config",{[S]:I}),await b({showLoading:!1})}catch(W){s.value=W.message,Z&&typeof I=="boolean"&&(Z.checked=!I)}})}function N(E,S,I,U,Z){const W=(Z==null?void 0:Z.target)??null;return A(`channel:${E}:${I}`,async()=>{try{await H.put("/api/discord/channel/"+E+"/config",{[I]:U}),await b({showLoading:!1})}catch(X){s.value=X.message,W&&typeof U=="boolean"&&(W.checked=!U)}})}function $(E,S){return A(`channel:${E}:clear`,async()=>{try{await H.put("/api/discord/channel/"+E+"/config",{clear:!0}),await b({showLoading:!1})}catch(I){s.value=I.message}})}function T(E,S){const I=String(S);if(!E.userAutocomplete)return I;const U=f.value.get(I);return U?rv(U):I}function P(E,S=null){const I=String(S??r.value[E]??"").trim();!I||i.value[E].includes(I)||(i.value[E]=[...i.value[E],I],r.value={...r.value,[E]:""})}function V(E,S){i.value[E]=i.value[E].filter(I=>I!==S)}async function J(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const S=(await H.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...S.allowed_users||[]],channels:[...S.channels||[]],respond_to_bots:!!S.respond_to_bots,require_mention:!!S.require_mention,ignore_bot_ids:[...S.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(E){o.value=E.message||"Global defaults could not be saved."}finally{l.value=!1}}}return je(C),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:w,hasOverride:L,toggleGuild:y,fetchAll:C,fetchGuilds:b,setGuildConfig:x,setChannelConfig:N,clearOverride:$,mutationPending:O,globalItemLabel:T,addGlobalItem:P,removeGlobalItem:V,saveGlobalDefaults:J}}},Es=e=>e==null?e:JSON.parse(JSON.stringify(e));function cS({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let f=null;const m=new Map;function v(k){d+=1;const O=c.then(k,k);return c=O.catch(()=>{}),O}function w(k,O){f=Es(k),m.clear();for(const[A,x]of Object.entries(O||{}))m.set(A,Es(x))}function L(k){const O=Es(k),A=++u;return v(async()=>{try{await e(Es(O)),f=Es(O),A===u&&n(Es(O))}catch(x){A===u&&(a(Es(f)),r(x,{kind:"default"}))}})}function y(k,O){const A=Es(O),x=(p.get(k)||0)+1;return p.set(k,x),v(async()=>{try{await t(k,Es(A)),m.set(k,Es(A)),x===p.get(k)&&i(k,Es(A))}catch(N){x===p.get(k)&&(l(k,Es(m.get(k)??null)),r(N,{kind:"user",uid:k}))}})}function g(k){const O=(p.get(k)||0)+1;return p.set(k,O),v(async()=>{try{await s(k),m.delete(k),O===p.get(k)&&o(k)}catch(A){O===p.get(k)&&(l(k,Es(m.get(k)??null)),r(A,{kind:"delete",uid:k}))}})}async function b(){for(;;){const k=c;if(await k,k===c)return d}}async function C(k){for(;;){const O=await b(),A=await k();if(O===d)return A}}return{seed:w,saveDefault:L,saveUser:y,deleteUser:g,whenIdle:b,readSnapshot:C,get revision(){return d}}}const dS={components:{DiscordUserCombobox:cv},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({}),i=h({allowed_hosts:[],default_host:""}),l=h({}),o=h(!1),r=h([]),c=G(()=>{const T={};for(const P of r.value)T[P.id]=P;return T});function d(T){return c.value[T]||null}function u(T,P){return T?T.allowed_hosts===null||T.allowed_hosts===void 0?{allowed_hosts:[...P],default_host:T.default_host||"",allow_all:!0}:{allowed_hosts:T.allowed_hosts,default_host:T.default_host||"",allow_all:!1}:{allowed_hosts:[...P],default_host:P[0]||"",allow_all:!0}}const p=cS({applyDefault:async T=>{const P=T.allow_all?null:T.allowed_hosts;await H.put("/api/host-access/default-policy",{allowed_hosts:P,default_host:T.default_host})},applyUser:async(T,P)=>{const V=P.allow_all?null:P.allowed_hosts;await H.put(`/api/host-access/user/${T}`,{allowed_hosts:V,default_host:P.default_host})},applyDelete:T=>H.del(`/api/host-access/user/${T}`),onDefaultConfirmed:()=>_e.success("Default policy updated"),onDefaultRollback:T=>{T&&(i.value=T)},onUserConfirmed:T=>{const P=d(T);_e.success(`Updated access for ${P?P.display_name:T}`)},onUserRollback:(T,P)=>{const V={...l.value};P?V[T]=P:delete V[T],l.value=V},onUserDeleted:T=>{const P={...l.value};delete P[T],l.value=P},onError:(T,P)=>{var J;const V=P.uid?` ${((J=d(P.uid))==null?void 0:J.display_name)||P.uid}`:"";_e.error(`${T.message||"Failed to save"} — reverted${V}`)}});let f=0;async function m(){const T=++f;e.value=!0,t.value="";try{const P=await p.readSnapshot(()=>H.get("/api/host-access"));if(T!==f)return;s.value=P,n.value=P.available_hosts||[],a.value=P.host_descriptions||{},i.value=u(P.default_policy,n.value);const V=P.users||{},J={};for(const[E,S]of Object.entries(V))J[E]=u(S,n.value);l.value=J,p.seed(i.value,J)}catch(P){T===f&&(t.value=P.message||"Failed to fetch host access data")}finally{T===f&&(e.value=!1)}try{const P=await H.get("/api/discord/members")||[];T===f&&(r.value=P)}catch{T===f&&(r.value=[])}}const v=500,w=new Map;function L(T,P){const V=w.get(T);V&&clearTimeout(V.timer);const J={run:P,timer:null};J.timer=setTimeout(()=>{w.delete(T),P()},v),w.set(T,J)}function y(T){const P=w.get(T);P&&(clearTimeout(P.timer),w.delete(T))}function g(){for(const[T,P]of[...w])clearTimeout(P.timer),w.delete(T),P.run()}function b(){L("default",()=>p.saveDefault(i.value))}function C(T,P){i.value.allow_all=!1,P?i.value.allowed_hosts.includes(T)||i.value.allowed_hosts.push(T):(i.value.allowed_hosts=i.value.allowed_hosts.filter(V=>V!==T),i.value.default_host===T&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function k(T){L(`user:${T}`,()=>{const P=l.value[T];P&&p.saveUser(T,P)})}function O(T,P,V){const J=l.value[T];J&&(J.allow_all=!1,V?J.allowed_hosts.includes(P)||J.allowed_hosts.push(P):(J.allowed_hosts=J.allowed_hosts.filter(E=>E!==P),J.default_host===P&&(J.default_host=J.allowed_hosts[0]||"")),k(T))}function A(T,P){const V=l.value[T];V&&(V.default_host=P,k(T))}function x(){o.value=!0}function N(T){!/^\d{15,25}$/.test(T)||l.value[T]||(l.value[T]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},p.saveUser(T,l.value[T]),o.value=!1)}async function $(T){const P=d(T);await qt({title:"Remove user override",message:`Remove the host access override for ${P?P.display_name:T}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(y(`user:${T}`),await p.deleteUser(T),l.value[T]||_e.success(`Removed override for ${P?P.display_name:T}`))}return je(m),Gt(g),ft(g),{loading:e,error:t,data:s,availableHosts:n,hostDescriptions:a,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:b,toggleDefaultHost:C,getMember:d,toggleUserHost:O,setUserDefault:A,openAddUser:x,addUserById:N,deleteUser:$,flushPendingSaves:g}}},uS={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=h([]),t=h(!1),s=h(""),n=h([]),a=h(!1),i=h(!1),l=h(1),o=h(""),r=h(!1),c=h(null),d=h(""),u=h([]),p=h(!1),f=h(null),m=h(""),v=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),w=h(v()),L=G(()=>["127.0.0.1","localhost","::1"].includes(w.value.address));async function y(){t.value=!0,s.value="";try{const J=await H.get("/api/hosts");e.value=J.hosts||[],o.value=J.default_host||"",r.value=!!J.tofu_enabled}catch(J){s.value=J.message}finally{t.value=!1}}async function g(){try{await H.post("/api/hosts/settings",{default_host:o.value,allow_host_tofu:r.value}),_e.success("Host settings saved and published live"),await y()}catch(J){_e.error(J.message)}}function b(){d.value="",u.value=[],p.value=!1,f.value=null,c.value=null,m.value="",l.value=1,a.value=!0}function C(){i.value=!1,w.value=v(),b()}function k(J){i.value=!0,w.value={...v(),...J},b()}async function O(){try{c.value=await H.get("/api/hosts/public-key")}catch(J){_e.error(J.message)}}async function A(J){try{const E=await H.post("/api/hosts/"+encodeURIComponent(J.alias)+"/import-legacy",{});i.value=!0,w.value={...v(),...J,trust_mode:"pinned"},b(),d.value=E.candidate_token,u.value=E.fingerprints||[],m.value=u.value.join(`
`),l.value=4,_e.info("Imported existing known_hosts trust. Test before activation.")}catch(E){_e.error(E.message)}}async function x(){try{const J=m.value.split(/\s+/).filter(Boolean),E={...w.value,expected_fingerprints:J,candidate_fingerprints:u.value},S=await H.post("/api/hosts/candidates",E);if(d.value=S.candidate_token,u.value=S.fingerprints||[],w.value.trust_mode==="tofu"&&E.candidate_fingerprints.length===0){w.value.confirm_tofu=!1,_e.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(J){_e.error(J.message)}}async function N(){var J,E;p.value=!1,f.value=null;try{const S=await H.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!S.tested,f.value=S.last_test,p.value&&(l.value=5)}catch(S){const I=(J=S.data)==null?void 0:J.last_test;I&&typeof I=="object"&&!Array.isArray(I)&&(f.value=I);const U=(E=f.value)==null?void 0:E.detail;_e.error(typeof U=="string"&&U.trim()?U:S.message)}}async function $(){try{await H.post("/api/hosts/candidates/"+d.value+"/commit",{}),_e.success("Host saved and published live"),a.value=!1,await y()}catch(J){_e.error(J.message)}}async function T(J){try{await H.post("/api/hosts/"+encodeURIComponent(J.alias)+"/enabled",{enabled:!J.enabled}),await y()}catch(E){_e.error(E.message)}}async function P(J){var E;if(await qt("Delete host "+J.alias+"? Dependencies will block deletion.")){n.value=[];try{await H.del("/api/hosts/"+encodeURIComponent(J.alias)),await y()}catch(S){n.value=Array.isArray((E=S.data)==null?void 0:E.pending_references)?S.data.pending_references:[],_e.error(S.message)}}}async function V(J){if(await qt("Force revoke "+J.alias+"? Remote outcomes may be unknown."))try{await H.post("/api/hosts/"+encodeURIComponent(J.alias)+"/force-revoke",{}),await y()}catch(E){_e.error(E.message)}}return je(y),{hosts:e,loading:t,error:s,pendingReferences:n,wizard:a,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:w,isLocal:L,keyInfo:c,candidate:d,observed:u,tested:p,testResult:f,fingerprintsText:m,load:y,saveSettings:g,beginAdd:C,beginEdit:k,loadKey:O,importLegacy:A,prepare:x,testConnection:N,commit:$,toggle:T,remove:P,forceRevoke:V}}},pS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),o=h(null),r=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=G(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=G(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(A){return A==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":A==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const A=await H.get("/api/tokens");s.value=A.tokens||[],n.value=A.available_hosts||[]}catch(A){t.value=A.message||"Failed to load tokens"}finally{e.value=!1}}function v(A){return!A||!A.trim()?[]:A.split(",").map(x=>x.trim()).filter(Boolean)}function w(A,x){const N=c.value.allowed_hosts;if(x&&!N.includes(A)&&N.push(A),!x){const $=N.indexOf(A);$>=0&&N.splice($,1)}}function L(A,x){const N=d.value.allowed_hosts;if(x&&!N.includes(A)&&N.push(A),!x){const $=N.indexOf(A);$>=0&&N.splice($,1)}}async function y(){var A;i.value=!0;try{const x=v(c.value.allowed_tools_str),N=c.value.host_mode,$=N==="none"?[]:N==="select"?c.value.allowed_hosts:null,T={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:x.length?x:[]};$!==null&&(T.allowed_hosts=$),T.default_host=c.value.default_host||"";const P=await H.post("/api/tokens",T);l.value=P.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,_e.success("Token created"),await m()}catch(x){_e.error(((A=x.data)==null?void 0:A.error)||x.message||"Failed to create token")}finally{i.value=!1}}function g(A){o.value=A;const x=A.allowed_hosts;let N="default";x==null?N="default":Array.isArray(x)&&x.length===0?N="none":Array.isArray(x)&&(N="select"),d.value={username:A.username||"",tier:A.tier||"admin",label:A.label||"",host_mode:N,allowed_hosts:Array.isArray(x)?[...x]:[],default_host:A.default_host||"",allowed_tools_str:(A.allowed_tools||[]).join(", ")}}async function b(){var A;if(o.value){r.value=!0;try{const x=v(d.value.allowed_tools_str),N=d.value.host_mode,$={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:x};N==="none"?$.allowed_hosts=[]:N==="select"?$.allowed_hosts=d.value.allowed_hosts:$.allowed_hosts=null,$.default_host=d.value.default_host||"",await H.put("/api/tokens/"+encodeURIComponent(o.value.user_id),$),o.value=null,_e.success("Token updated"),await m()}catch(x){_e.error(((A=x.data)==null?void 0:A.error)||x.message||"Failed to update")}finally{r.value=!1}}}async function C(A){var N;if(await qt({title:"Regenerate token",message:`Regenerate token for ${A.username||A.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const $=await H.post("/api/tokens/"+encodeURIComponent(A.user_id)+"/regenerate");l.value=$.token,_e.success("Token regenerated")}catch($){_e.error(((N=$.data)==null?void 0:N.error)||$.message||"Failed to regenerate")}}async function k(A){var N;if(await qt({title:"Delete token",message:`Delete token for ${A.username||A.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/tokens/"+encodeURIComponent(A.user_id)),_e.success("Token deleted"),await m()}catch($){_e.error(((N=$.data)==null?void 0:N.error)||$.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),_e.success("Copied to clipboard")}catch{_e.error("Copy failed — select and copy manually")}}return je(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:f,toggleCreateHost:w,toggleEditHost:L,createToken:y,startEdit:g,saveEdit:b,confirmRegenerate:C,confirmDelete:k,copyToken:O}}},fS=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),hS=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),mS=Object.freeze(["enabled","base_url","model","max_tokens"]),vS=Object.freeze(["enabled","model","max_tokens"]);function er(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function hp(e){return er(e,fS)}function mp(e){return er(e,hS)}function gS(e,{includeApiKey:t=!1}={}){const s=er(e,mS);return t&&(s.api_key=e.api_key),s}function bS(e){return{timeout:e.timeout}}function yS(e,{includeApiKey:t=!1}={}){const s=er(e,vS);return t&&(s.api_key=e.api_key),s}function xS(e){return{timeout:e.timeout}}function Fl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const _S={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("codex"),a=h({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],l=G(()=>{const K=a.value.model;return K&&!i.includes(K)?[K,...i]:i}),o=G(()=>{const K=a.value.agent_model;return K&&K!=="auto"&&!i.includes(K)?[K,...i]:i}),r={"gpt-5.5":["max"],"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},c=(K,xe)=>!!K&&!!xe&&(r[K]||[]).includes(xe),d=K=>!c(a.value.model,K)&&!(a.value.agent_reasoning_effort===""&&c(a.value.agent_model,K)),u=K=>{const xe=a.value.agent_model;return xe==="auto"?!0:!c(xe||a.value.model,K)},p=G(()=>{const K=a.value.agent_reasoning_effort;return K==="auto"?null:K||a.value.reasoning_effort}),f=K=>c(K,a.value.reasoning_effort)||a.value.agent_model===""&&c(K,p.value),m=K=>c(K,p.value),v=h({enabled:!1,model:"gpt-5.6-luna"}),w=h({unavailable_reason:null}),L=G(()=>{const K=v.value.model;return K&&!i.includes(K)?[K,...i]:i});function y(K){const xe=K.target.value;v.value.enabled=xe!=="",xe!==""&&(v.value.model=xe),ne()}const g=h(!1),b=h({codex:!1,ollama:!1,kimi:!1}),C=h(null),k=h(!1),O=h(""),A=h(null),x=h(!1);let N=0;const $=G(()=>{var K;return Object.entries(((K=C.value)==null?void 0:K.models)||{}).map(([xe,Re])=>{var es,un,Hn;return{model:xe,floor:Re.floor,override:Re.override,effectiveBudget:(es=Re.effective)==null?void 0:es.effective_budget,configuredPrimaryChars:(un=Re.configured)==null?void 0:un.primary_chars,primaryChars:(Hn=Re.effective)==null?void 0:Hn.primary_chars,provenance:Re.provenance,clampExpiresAt:Re.clamp_expires_at,densityPriorMilli:Re.density_prior_milli,densityScope:Re.density_scope,workloadCalibration:Re.workload_calibration}})}),T=G(()=>{var K;return((K=C.value)==null?void 0:K.clamps)||[]}),P=G(()=>{var K,xe;return((xe=(K=C.value)==null?void 0:K.models)==null?void 0:xe[a.value.model])||null}),V=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),J=h({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),E=h(!1),S=h(!1),I=h(!1),U=h(!1),Z=h(!1),W=h(!1),X=h(!1),oe=h({configured:null}),Q=h(!1),pe=h([]),Oe=h(""),te=h(!1),ve=h(!1),q=h({configured:null}),de=h(!1),he=h([]),Ie=h(""),_=h(!1),M=h(!1),z=h(!0),ce=h(""),ae=h({configured:null,accounts:[]}),re=h(null),me=h(null),j=h(""),ee=h(null),Y=h(!1),fe=h(null),ue=h(null),be=h("");let Ee=null;function F(K,xe="success"){_e(K,xe==="error"?"error":"success")}function ye(K){if(!K)return"?";const xe=K/(1024*1024*1024);return xe>=1?xe.toFixed(1)+" GB":(K/(1024*1024)).toFixed(0)+" MB"}function ke(K){return Number.isFinite(Number(K))?Number(K).toLocaleString():"—"}function Le(K){return K==null?"automatic (model-derived)":Number(K).toLocaleString()+" characters"}function Me(K){const xe=new Date(K);return Number.isNaN(xe.getTime())?"unknown":xe.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function dt(K){return typeof K=="string"&&K.length>12?K.slice(0,8)+"…"+K.slice(-4):K}function st(K){return typeof K!="number"||!Number.isFinite(K)?"—":(K/1e3).toFixed(2)}function _t(K){return K==="temporary learned clamp"?"is-clamp":K==="override"?"is-override":"is-built-in"}function Ot(K){const xe=a.value.context_budget_overrides[K.model];return K.floor!=null&&Number.isFinite(Number(xe))&&Number(xe)>K.floor}function rt(K,xe){const Re={...a.value.context_budget_overrides};xe.target.value===""?delete Re[K]:Re[K]=Number(xe.target.value),a.value.context_budget_overrides=Re,x.value=!0}function Qe(K){a.value.context_utilization=K.target.value===""?"":Number(K.target.value),x.value=!0}function le(K){const xe={...a.value.context_budget_overrides};delete xe[K],a.value.context_budget_overrides=xe,x.value=!0}async function Se(){e.value=!0,await Promise.all([Ne(),Et(),ks(),Ve(),Ke()]),e.value=!1}async function Ne({preserveBasic:K=!1,preserveAdvanced:xe=!1}={}){try{const Re=await H.get("/api/llm/status");t.value=Re,s.value=!1,n.value=Re.active_provider||"codex",Re.codex&&!Ds.pending()&&(K||(a.value.enabled=Re.codex.enabled,a.value.model=Re.codex.model||"gpt-5.6-sol",a.value.reasoning_effort=Re.codex.reasoning_effort||"medium",a.value.agent_reasoning_effort=Re.codex.agent_reasoning_effort||"",a.value.agent_model=Re.codex.agent_model||""),xe||(a.value.request_timeout_seconds=Re.codex.request_timeout_seconds??a.value.request_timeout_seconds,a.value.stream_stall_timeout_seconds=Re.codex.stream_stall_timeout_seconds??a.value.stream_stall_timeout_seconds,a.value.retry={...a.value.retry,...Re.codex.retry||{}},a.value.connection_pool={...a.value.connection_pool,...Re.codex.connection_pool||{}},a.value.context_compression={...a.value.context_compression,...Re.codex.context_compression||{}},!x.value&&!I.value&&(a.value.context_budget_overrides={...Re.codex.context_budget_overrides||{}},a.value.context_utilization=Re.codex.context_utilization??a.value.context_utilization))),Re.ollama&&!we.pending()&&(K||(V.value.enabled=Re.ollama.enabled,V.value.base_url=Re.ollama.base_url||"",V.value.model=Re.ollama.model||"",V.value.max_tokens=Re.ollama.max_tokens||4096),xe||(V.value.timeout=Re.ollama.timeout??V.value.timeout)),Re.kimi&&!$e.pending()&&(K||(J.value.enabled=Re.kimi.enabled,J.value.model=Re.kimi.model||"",J.value.max_tokens=Re.kimi.max_tokens||4096),xe||(J.value.timeout=Re.kimi.timeout??J.value.timeout)),Re.auxiliary&&(w.value=Re.auxiliary,ne.pending()||(v.value.enabled=Re.auxiliary.enabled,v.value.model=Re.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function Ke(){const K=++N;k.value=!0,O.value="";try{const xe=await H.get("/api/context/windows");if(K!==N)return;C.value=xe,!I.value&&!x.value&&(a.value.context_budget_overrides=Object.fromEntries(Object.entries(xe.models||{}).filter(([,Re])=>Re.override!=null).map(([Re,es])=>[Re,es.override])),a.value.context_utilization=xe.utilization??a.value.context_utilization)}catch(xe){K===N&&(O.value=xe.message||"Failed to load context budgets")}finally{K===N&&(k.value=!1)}}async function Et(){try{if(oe.value=await H.get("/api/ollama/status"),Q.value=!1,oe.value.model&&(Oe.value=oe.value.model),oe.value.configured)try{const K=await H.get("/api/ollama/models");pe.value=K.models||[]}catch{pe.value=[]}else if(V.value.base_url)try{const K=await H.post("/api/ollama/probe-models",{base_url:V.value.base_url});pe.value=K.models||[]}catch{pe.value=[]}}catch{Q.value=!0}}async function Ve(){z.value=!0,ce.value="";try{ae.value=await H.get("/api/codex/status")}catch(K){ce.value=K.message||"Failed to fetch Codex status"}finally{z.value=!1}}async function $t(){const K=t.value?t.value.active_provider:"codex";X.value=!0;try{const xe=await H.post("/api/llm/switch",{provider:n.value});xe.error?(n.value=K,F(xe.error,"error")):(F("Switched to "+n.value+" ("+xe.model+")"),await Se())}catch(xe){n.value=K,F(xe.message||"Switch failed","error")}finally{X.value=!1}}async function zt(){te.value=!0;try{const K=await H.post("/api/ollama/reload");F(K.configured?"Ollama reloaded":K.reason||"Ollama not configured",K.configured?"success":"error"),await Se()}catch(K){F(K.message||"Reload failed","error")}finally{te.value=!1}}async function rs(){ve.value=!0;try{await H.post("/api/ollama/model",{model:Oe.value}),F("Model set to "+Oe.value),await Se()}catch(K){F(K.message||"Failed","error")}finally{ve.value=!1}}async function Js(){const K=V.value.base_url;if(!K){F("Enter a base URL first","error");return}W.value=!0;try{const xe=await H.post("/api/ollama/probe-models",{base_url:K});pe.value=xe.models||[],pe.value.length?(F(pe.value.length+" model(s) found"),!V.value.model&&pe.value.length&&(V.value.model=pe.value[0].name)):F("No models found at "+K,"error")}catch(xe){F(xe.message||"Could not reach Ollama","error")}finally{W.value=!1}}async function ks(){try{if(q.value=await H.get("/api/kimi/status"),de.value=!1,q.value.model&&(Ie.value=q.value.model),q.value.configured)try{const K=await H.get("/api/kimi/models");he.value=K.models||[]}catch{he.value=[]}}catch{de.value=!0}}async function na(){_.value=!0;try{const K=await H.post("/api/kimi/reload");F(K.configured?"Kimi reloaded":K.reason||"Kimi not configured",K.configured?"success":"error"),await Se()}catch(K){F(K.message||"Reload failed","error")}finally{_.value=!1}}async function Zs(){M.value=!0;try{await H.post("/api/kimi/model",{model:Ie.value}),F("Model set to "+Ie.value),await Se()}catch(K){F(K.message||"Failed","error")}finally{M.value=!1}}async function Ns(){if(I.value){Ds();return}I.value=!0;const K=hp(a.value);try{await H.put("/api/llm/codex/config",K),F("Codex config saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Ve()])}catch(xe){F(xe.message||"Failed","error");const Re=JSON.stringify(hp(a.value))!==JSON.stringify(K);await Promise.all([Ne({preserveBasic:Re,preserveAdvanced:!0}),Ve()])}finally{I.value=!1}}async function Mn(){if(I.value)return;I.value=!0;const K=mp(a.value);try{await H.put("/api/llm/codex/config",K),JSON.stringify({context_budget_overrides:a.value.context_budget_overrides,context_utilization:a.value.context_utilization})===JSON.stringify({context_budget_overrides:K.context_budget_overrides,context_utilization:K.context_utilization})&&(x.value=!1),F("Codex advanced settings saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Ve(),Ke()])}catch(xe){F(xe.message||"Failed","error");const Re=JSON.stringify(mp(a.value))!==JSON.stringify(K);await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:Re}),Ve(),Ke()])}finally{I.value=!1}}async function Ss(){if(U.value){we();return}U.value=!0;try{const K=E.value?V.value.api_key:null,xe=gS(V.value,{includeApiKey:K!==null});await H.put("/api/llm/ollama/config",xe),F("Ollama config saved"),K!==null&&V.value.api_key===K&&(V.value.api_key="",E.value=!1),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(K){F(K.message||"Failed","error")}finally{U.value=!1}}async function Fn(){if(!U.value){U.value=!0;try{await H.put("/api/llm/ollama/config",bS(V.value)),F("Ollama timeout saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),Et()])}catch(K){F(K.message||"Failed","error")}finally{U.value=!1}}}async function Lt(){if(Z.value){$e();return}Z.value=!0;try{const K=S.value?J.value.api_key:null,xe=yS(J.value,{includeApiKey:K!==null});await H.put("/api/llm/kimi/config",xe),F("Kimi config saved"),K!==null&&J.value.api_key===K&&(J.value.api_key="",S.value=!1),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(K){F(K.message||"Failed","error")}finally{Z.value=!1}}async function Xe(){if(!Z.value){Z.value=!0;try{await H.put("/api/llm/kimi/config",xS(J.value)),F("Kimi timeout saved"),await Promise.all([Ne({preserveBasic:!0,preserveAdvanced:!0}),ks()])}catch(K){F(K.message||"Failed","error")}finally{Z.value=!1}}}async function Ts(){if(g.value){ne();return}g.value=!0;try{await H.put("/api/llm/auxiliary/config",v.value),F("Auxiliary config saved"),await Ne()}catch(K){F(K.message||"Failed","error"),await Ne()}finally{g.value=!1}}const Ds=Fl(Ns),ne=Fl(Ts),we=Fl(Ss),$e=Fl(Lt),Je=()=>(Ds.cancel(),Ns()),wt=()=>(we.cancel(),Ss()),ut=()=>($e.cancel(),Lt()),$n=()=>Mn(),js=()=>Fn(),mi=()=>Xe();async function vi(K){const xe=K.account_key+":"+K.model;A.value=xe;try{const Re=await H.post("/api/context/windows/clear",{account_key:K.account_key,model:K.model});F(Re.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Ke()}catch(Re){F(Re.message||"Failed to clear clamp","error"),await Ke()}finally{A.value=null}}async function Ia(K){try{await H.post("/api/codex/account/"+K+"/activate"),F("Active account switched"),await Ve()}catch(xe){F(xe.message||"Failed","error")}}async function aa(K){re.value=K;try{await H.post("/api/codex/account/"+K+"/refresh"),F("Token refreshed"),await Ve()}catch(xe){F(xe.message||"Refresh failed","error")}finally{re.value=null}}function Un(K,xe){me.value=K,j.value=xe||""}async function Bn(K){try{await H.put("/api/codex/account/"+K+"/label",{label:j.value}),F("Label updated"),me.value=null,await Ve()}catch(xe){F(xe.message||"Failed","error")}}async function Ys(K,xe){if(await qt({title:"Delete Codex account",message:`Delete ${xe||"account #"+(K+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await H.del("/api/codex/account/"+K),F("Deleted. Pool reloaded."),await Ve()}catch(es){F(es.message||"Failed","error")}}async function dn(){Y.value=!0;try{const K=await H.post("/api/codex/device-code");fe.value=K,ee.value="pending",Xt(K)}catch(K){F(K.message||"Failed","error")}finally{Y.value=!1}}async function Xt(K){Ee={cancelled:!1};const xe=Ee;try{const Re=await H.post("/api/codex/device-poll",{device_auth_id:K.device_auth_id,user_code:K.user_code,interval:K.interval});if(xe.cancelled)return;ue.value=Re,ee.value="success",await Se()}catch(Re){if(xe.cancelled)return;be.value=Re.message||"Device login failed",ee.value="error"}}function Oa(){Ee&&(Ee.cancelled=!0),ee.value=null,fe.value=null}return je(Se),ft(()=>{Ee&&(Ee.cancelled=!0),Ds.cancel(),ne.cancel(),we.cancel(),$e.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:n,switching:X,advancedOpen:b,codexForm:a,codexModelOptions:l,codexAgentModelOptions:o,mainEffortAllowed:d,agentEffortAllowed:u,mainModelOptionDisabled:f,agentModelOptionDisabled:m,auxForm:v,auxData:w,auxModelOptions:L,onAuxModelChange:y,savingAux:g,saveAuxConfigDebounced:ne,ollamaForm:V,kimiForm:J,savingCodex:I,savingOllama:U,savingKimi:Z,probingOllama:W,ollamaKeyDirty:E,kimiKeyDirty:S,fetchCodexStatus:Ve,ollamaStatus:oe,ollamaStatusLoadFailed:Q,ollamaModels:pe,ollamaSelectedModel:Oe,reloading:te,settingModel:ve,kimiStatus:q,kimiStatusLoadFailed:de,kimiModels:he,kimiSelectedModel:Ie,reloadingKimi:_,settingKimiModel:M,codexLoading:z,codexError:ce,codexData:ae,refreshing:re,editingLabel:me,labelValue:j,contextWindows:C,contextWindowsLoading:k,contextWindowsError:O,contextBudgetRows:$,activeClampRows:T,activeContextBudget:P,clearingClamp:A,contextPolicyDirty:x,deviceState:ee,deviceLoading:Y,deviceInfo:fe,deviceResult:ue,deviceError:be,fetchAll:Se,fetchLLMStatus:Ne,fetchOllamaStatus:Et,fetchKimiStatus:ks,switchProvider:$t,reloadOllama:zt,setOllamaModel:rs,reloadKimi:na,setKimiModel:Zs,probeOllamaModels:Js,saveCodexConfig:Ns,saveOllamaConfig:Ss,saveKimiConfig:Lt,saveCodexAdvancedConfig:Mn,saveOllamaAdvancedConfig:Fn,saveKimiAdvancedConfig:Xe,saveCodexConfigDebounced:Ds,saveOllamaConfigDebounced:we,saveKimiConfigDebounced:$e,saveCodexConfigNow:Je,saveOllamaConfigNow:wt,saveKimiConfigNow:ut,saveCodexAdvancedConfigNow:$n,saveOllamaAdvancedConfigNow:js,saveKimiAdvancedConfigNow:mi,activateAccount:Ia,refreshAccount:aa,startEditLabel:Un,saveLabel:Bn,deleteAccount:Ys,startDeviceLogin:dn,cancelDeviceLogin:Oa,formatSize:ye,fetchContextWindows:Ke,clearContextClamp:vi,setContextOverride:rt,setContextUtilization:Qe,resetContextOverride:le,overrideAboveFloor:Ot,formatCount:ke,formatContextCeiling:Le,formatExpiry:Me,shortAccountKey:dt,provenanceClass:_t,formatDensity:st}}},vp={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function wS(e){return vp[e]||vp[(e||"").toLowerCase()]||"text-gray-400"}const kS={template:`
  ...
  `,setup(){const e=h(null),t=h(""),s=h(null),n=h(!1),a=h(0),i=h(null),l=h(""),o=h(null),r=h(!1),c=h(0),d=h(Date.now());let u=null,p=0,f=0;async function m(){const S=++p;n.value=!0;try{const I=await H.get("/api/turn-state/turns?limit=100");if(S!==p)return;t.value=I.availability,e.value=I.availability==="available"?I.data:null,s.value=null,a.value=Date.now()}catch(I){if(S!==p)return;s.value=I.message||"Turn-state read failed",I.status===503&&(t.value="unavailable")}S===p&&(n.value=!1)}async function v(){const S=++f;r.value=!0;try{const I=await H.get("/api/turn-state/capacity-breakers");if(S!==f)return;l.value=I.availability,i.value=I.availability==="available"?I.data:null,o.value=null,c.value=Date.now()}catch(I){if(S!==f)return;o.value=I.message||"Breaker read failed",I.status===503&&(l.value="unavailable")}S===f&&(r.value=!1)}function w(){m(),v()}const L=G(()=>e.value!==null&&ki(d.value,a.value)>gp),y=G(()=>i.value!==null&&ki(d.value,c.value)>gp),g=G(()=>L.value||y.value),b=G(()=>Math.round(ki(d.value,a.value)/1e3)),C=G(()=>Math.round(ki(d.value,c.value)/1e3));function k(S){return Tr(S,d.value/1e3)}function O(S){return TS[k(S)]}const A=G(()=>{var U;const S=[...((U=e.value)==null?void 0:U.turns)||[]],I=d.value/1e3;return S.sort((Z,W)=>Tr(Z,I)-Tr(W,I)||(W.last_progress_at||0)-(Z.last_progress_at||0))});function x(S){return S.state==="closed"?"badge-success":S.state==="probing"?"badge-warning":"badge-danger"}function N(S){if(S.state==="closed")return"—";const I=ki(d.value,c.value)/1e3,U=Math.max(0,(S.cooldown_remaining_seconds||0)-I);return U>0?`${Math.ceil(U)}s`:S.state==="probing"?"probe in flight":"probe eligible"}function $(S){if(!S)return"";const I=Math.max(0,Math.round(d.value/1e3-S));if(I<90)return`${I}s ago`;const U=Math.round(I/60);return U<90?`${U}m ago`:`${Math.round(U/60)}h ago`}let T=null,P=null,V=!1;function J(){V||(V=!0,w(),T=setInterval(w,SS),u=setInterval(()=>{d.value=Date.now()},1e3),P=Ye.onReconnected(w))}function E(){V&&(V=!1,T&&(clearInterval(T),T=null),u&&(clearInterval(u),u=null),P&&(P(),P=null))}return je(J),Qt(J),Gt(E),ft(E),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:L,breakersStale:y,anyStale:g,turnsAgeSeconds:b,breakersAgeSeconds:C,sortedTurns:A,priorityOf:k,priorityBadge:O,breakerBadge:x,cooldownLabel:N,ageLabel:$,fetchTurns:m,fetchBreakers:v,refreshAll:w,arm:J,disarm:E}}},ES={setup(){const e=h(""),t=h(""),s=h(!1),n=h(""),a=h(!1),i=h(!1),l=h(!1),o=h(null),r=h(!1);async function c(){a.value=!0,o.value=null,r.value=!1;try{const u=await H.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{a.value=!1}}async function d(){if(await qt({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await H.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return je(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
  ...
  `},bp=e=>JSON.parse(JSON.stringify(e)),AS=(e,t)=>JSON.stringify(e)===JSON.stringify(t),RS={emits:["saved"],template:`
    ...
    </section>`,setup(e,{emit:t}){const s=h([]),n=h({}),a=h({}),i=h(!1),l=h(!1),o=h(!1),r=h(!1),c=h(!1),d=h(""),u=h("");let p=!1,f=0,m=null;const v=(E,S)=>p&&f===E&&H.token===S,w=E=>"computer-provisioning-"+E.key,L=E=>E===null?"Unset":E===""?"Empty":JSON.stringify(E),y=E=>{const S=a.value[E.key];return E.type==="array"?String(S||"").split(/\r?\n/).map(I=>I.trim()).filter(Boolean):["integer","number"].includes(E.type)?S===""||S==null?null:Number(S):S},g=G(()=>s.value.map(E=>({...E,value:y(E)})).filter(E=>!AS(E.value,n.value[E.key]))),b=G(()=>s.value.filter(E=>E.pending_restart).map(E=>E.label)),C=G(()=>s.value.some(E=>E.apply_state==="unknown")),k=G(()=>{const E={};for(const S of s.value){const I=y(S),U=S.constraints||{};["integer","number"].includes(S.type)&&(I===null&&!S.nullable?E[S.key]="A number is required.":I!==null&&(!Number.isFinite(I)||S.type==="integer"&&!Number.isInteger(I)||U.minimum!=null&&I<U.minimum||U.maximum!=null&&I>U.maximum)&&(E[S.key]="Enter a number within the allowed range.")),S.key==="monitor_names"&&(I.length>16||new Set(I).size!==I.length||I.some(Z=>!/^[A-Za-z0-9_.-]{1,64}$/.test(Z)))&&(E[S.key]="Use up to 16 unique monitor names, one per line (letters, digits, dot, underscore or hyphen).")}return E}),O=G(()=>Object.keys(k.value).length>0);function A(E,S){a.value[E.key]=S,u.value=""}function x(){a.value=Object.fromEntries(s.value.map(E=>[E.key,E.type==="array"?n.value[E.key].join(`
`):n.value[E.key]])),r.value=!1}async function N(E,S){const[I,U]=await Promise.all([H.get("/api/config"),H.get("/api/config/meta")]);if(!v(E,S))return!1;const Z=(U.fields||[]).filter(W=>/^computer\.[^.]+$/.test(W.path)&&W.path!=="computer.enabled"&&W.sensitivity==="public"&&W.apply_mode==="restart");if(!I.computer||!Z.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=Z.map(W=>({...W,key:W.path.split(".")[1]})),n.value=Object.fromEntries(s.value.map(W=>[W.key,bp(I.computer[W.key])])),x(),m=S,i.value=!0,c.value=!1,!0}async function $(){if(!p||l.value||o.value)return;const E=++f,S=H.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await N(E,S)}catch(I){v(E,S)&&(c.value=!0,d.value=I.message||"Could not load provisioning. No changes were sent.")}finally{v(E,S)&&(l.value=!1)}}function T(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!O.value&&(r.value=!0)}async function P(){if(!p||!i.value||!r.value||o.value||l.value||c.value||O.value||!g.value.length)return;if(m!==H.token){J(),V();return}const E={computer:Object.fromEntries(g.value.map(Z=>[Z.key,bp(Z.value)]))},S=f,I=H.token;o.value=!0,d.value="",u.value="";let U=!1;try{if(await H.put("/api/config",E),U=!0,!v(S,I))return;await N(S,I)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(Z){v(S,I)&&(c.value=!0,r.value=!1,d.value=U?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${Z.status===400?": "+Z.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{v(S,I)&&(o.value=!1)}}function V(){p||(p=!0,$())}function J(){p=!1,f++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,m=null,s.value=[],n.value={},a.value={},d.value="",u.value=""}return je(V),Qt(V),Gt(J),ft(J),{fields:s,original:n,draft:a,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:b,effectiveUnknown:C,changes:g,validation:k,invalid:O,fieldId:w,format:L,edit:A,discard:x,load:$,openReview:T,save:P}}},IS={components:{ComputerProvisioning:RS},template:`
    ...
    </div>`,setup(){const e=h({state:"unknown",available:!1}),t=h(!1),s=h(!1),n=h(!1),a=h(!1),i=h(!1),l=h(!1),o=h(""),r=h(!1),c=h(!1),d=h(!1),u=h(0),p=h(""),f=h(""),m=h(null),v=h(""),w=h(!1),L=h(Date.now()),y=h(""),g=h(null);let b=0,C=null,k=!1,O=H.token,A=0,x=null,N=null,$=!1;const T=j=>j===!0?"Enabled":j===!1?"Disabled":"Unknown",P=G(()=>{var j;return((j=e.value.backend)==null?void 0:j.environment)==="existing_session"}),V=G(()=>{var ee;const j=Date.parse(((ee=e.value.accessibility)==null?void 0:ee.checked_at)||"");return c.value&&Number.isFinite(j)&&L.value-j<15e3&&L.value>=j-5e3}),J=G(()=>{var j;return V.value?T((j=e.value.accessibility)==null?void 0:j.enabled):"Unknown / not current"}),E=G(()=>{var j;return V.value?((j=e.value.accessibility)==null?void 0:j.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),S=G(()=>Object.entries(e.value.input_limits||{}).filter(([,j])=>typeof j=="number"&&Number.isFinite(j)).map(([j,ee])=>`${j}: ${ee}`).join(", ")),I=G(()=>{var ee;const j=(ee=e.value.application_provenance)==null?void 0:ee.script_identity;return typeof j=="string"?j:!j||typeof j!="object"?"Not observed":`${j.interpreter_basename||"Unknown interpreter"}; argv digest ${j.argv_digest||"not recorded"}; ${j.verified===!0?"verified":"not verified"}`}),U=G(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(j=>j&&typeof j.id=="string"&&typeof j.label=="string"&&["supported","capture_only"].includes(j.input)).slice(0,16):[]),Z=G(()=>{const j=e.value.restart_required;return Array.isArray(j)?j.length?j.join(", "):"None reported":j===!0?"Pending; restart required":j===!1?"None reported":"Unknown"}),W=G(()=>{var ee,Y;const j=Date.parse(((ee=m.value)==null?void 0:ee.captured_at)||"");return Number.isFinite(j)&&L.value<j+Math.min(1e4,((Y=m.value)==null?void 0:Y.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function X(){v.value&&URL.revokeObjectURL(v.value),v.value="",m.value=null}function oe(){b++,X(),g.value=null,c.value=!1,x==null||x.abort(),x=null,t.value=!1,f.value="",s.value=!1,i.value=!1,l.value=!1}function Q(j,ee){return k&&j===b&&ee===H.token}function pe(){return k&&c.value&&N===H.token&&Date.now()-u.value<15e3}function Oe(j,ee="mutation"){var fe,ue;oe(),$=!0,p.value="";const Y=j.status||(j.name==="AuthError"?401:0);[401,403,404].includes(Y)?(u.value=0,N=null,e.value={available:!1,state:"unknown"}):u.value||(e.value={available:!1,state:Y===503?"unavailable":"unknown"}),o.value=Y===401||Y===403||Y===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":Y===410?"Evidence or artifact expired. Observe or prepare the export again.":ee==="read"?"Status refresh failed. Last-known details are not current. No mutation was requested by this read.":ee==="acknowledged"?"The mutation was acknowledged, but status refresh failed. Refresh status independently; do not replay the change.":"Request failed; outcome unknown. Refresh status. No action was replayed.",ee==="mutation"&&![401,403,404].includes(Y)&&typeof((fe=j.data)==null?void 0:fe.code)=="string"&&/^[a-z_]{1,64}$/.test(j.data.code)&&typeof((ue=j.data)==null?void 0:ue.error)=="string"&&(o.value=j.data.error.slice(0,512),j.data.outcome==="not_applied"&&j.data.next_action==="repair_provisioning"&&typeof j.data.remedy=="string"&&(o.value="Not applied (preflight rejection). "+o.value,p.value=j.data.remedy.slice(0,1024)))}async function te(){if(t.value||r.value||n.value||a.value||d.value||!k)return;const j=b,ee=H.token;t.value=!0,A=Date.now();const Y=new AbortController;x=Y;try{const fe=await H.get("/api/computer",{signal:Y.signal});if(!Q(j,ee))return;ve(fe)}catch(fe){Q(j,ee)&&Oe(fe,"read")}finally{x===Y&&(x=null,t.value=!1)}}function ve(j,ee=""){if(!j||typeof j!="object"||typeof j.state!="string"||typeof j.available!="boolean")throw new Error("Invalid status");(e.value.session_id&&e.value.session_id!==j.session_id||e.value.generation!=null&&e.value.generation!==j.generation||e.value.session_generation!=null&&e.value.session_generation!==j.session_generation)&&oe(),e.value=j,u.value=Date.now(),N=H.token,c.value=!(r.value&&ee!=="toggle")&&!(n.value&&ee!=="stop")&&!(a.value&&ee!=="pause")&&!(d.value&&ee!=="recovery"),o.value="",p.value="",$=!c.value}async function q(j){if(!pe()||r.value||n.value||a.value||d.value)return;oe();const ee=b,Y=H.token;r.value=!0;let fe=!1;try{if(await H.post("/api/computer/enabled",{enabled:j}),fe=!0,!Q(ee,Y))return;const ue=await H.get("/api/computer");Q(ee,Y)&&ve(ue,"toggle")}catch(ue){Q(ee,Y)&&Oe(ue,fe?"acknowledged":"mutation")}finally{r.value=!1}}async function de(j){if(!k||!["pause","stop"].includes(j)||(j==="stop"?n.value:a.value))return;oe();const ee=b,Y=H.token,fe=j==="stop"?n:a;fe.value=!0;let ue=!1;try{if(await H.post("/api/computer/"+j,{}),ue=!0,Q(ee,Y)){const be=await H.get("/api/computer");Q(ee,Y)&&ve(be,j)}}catch(be){Q(ee,Y)&&Oe(be,ue?"acknowledged":"mutation")}finally{fe.value=!1}}async function he(){var fe;if(!pe()||d.value||((fe=e.value.backend)==null?void 0:fe.native_backend)!=="hyprland")return;const j={session_id:e.value.session_id,generation:e.value.session_generation};if(!j.session_id||!Number.isInteger(j.generation))return;oe();const ee=b,Y=H.token;d.value=!0;try{const ue=await H.post("/api/computer/release_owned_input",j);Q(ee,Y)&&ve(ue,"recovery")}catch(ue){Q(ee,Y)&&Oe(ue,"mutation")}finally{d.value=!1}}async function Ie(){return M(!1)}async function _(){return M(!0)}async function M(j){var Ee;if(!pe()||d.value||r.value||n.value||a.value||e.value.state!=="quarantined")return;const ee={session_id:e.value.session_id,generation:e.value.session_generation};if(!ee.session_id||!Number.isInteger(ee.generation))return;if(j){if(f.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+ee.session_id)return;ee.acknowledgment=f.value}const Y=j?((Ee=e.value.recovery)==null?void 0:Ee.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";oe();const fe=b,ue=H.token;d.value=!0;let be=!1;try{const F=await H.post("/api/computer/"+Y,ee);be=!0,Q(fe,ue)&&ve(F,"recovery")}catch(F){Q(fe,ue)&&Oe(F,be?"acknowledged":"mutation")}finally{d.value=!1}}async function z(){var Y;if(!pe()||s.value||!e.value.available)return;X(),w.value=!1;const j=b,ee=H.token;s.value=!0;try{const fe=await H.post("/api/computer/observe",{});if(!Q(j,ee))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((Y=fe.frame)==null?void 0:Y.evidence_id)||""))throw new Error("Invalid evidence");const ue=await H.getBlob("/api/computer/evidence/"+fe.frame.evidence_id);if(!Q(j,ee))return;if(!["image/png","image/jpeg"].includes(ue.type)||ue.size>2097152||!Number.isFinite(Date.parse(fe.frame.expires_at))||Date.parse(fe.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");m.value=fe.frame,v.value=URL.createObjectURL(ue),o.value=""}catch(fe){Q(j,ee)&&Oe(fe)}finally{j===b&&(s.value=!1)}}async function ce(){if(!pe()||i.value||!e.value.available)return;g.value=null;const j=b,ee=H.token;i.value=!0;try{const Y=await H.post("/api/computer/export",{name:y.value});Q(j,ee)&&(g.value=Y,o.value="")}catch(Y){Q(j,ee)&&Oe(Y)}finally{j===b&&(i.value=!1)}}async function ae(){if(!pe()||l.value||!g.value)return;const j=b,ee=H.token,Y=g.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((Y==null?void 0:Y.artifact_id)||""))throw new Error("Invalid export");const fe=await H.getBlob("/api/computer/download/"+Y.artifact_id);if(!Q(j,ee))return;const ue=URL.createObjectURL(fe),be=document.createElement("a");be.href=ue,be.download=Y.name,be.click(),setTimeout(()=>URL.revokeObjectURL(ue),1e3)}catch(fe){Q(j,ee)&&Oe(fe)}finally{j===b&&(l.value=!1)}}function re(){k||(O!==H.token&&(O=H.token,oe(),u.value=0,N=null,e.value={state:"unknown",available:!1},o.value="",p.value=""),k=!0,te(),C=setInterval(()=>{L.value=Date.now(),O!==H.token&&(O=H.token,oe(),u.value=0,N=null,o.value="",p.value="",e.value={state:"unknown",available:!1}),c.value&&L.value-u.value>=15e3&&oe(),m.value&&Date.parse(m.value.expires_at)<=L.value&&(X(),w.value=!0),g.value&&Date.parse(g.value.expires_at)<=L.value&&(g.value=null),!$&&L.value-A>=5e3&&te()},500))}function me(){k=!1,clearInterval(C),C=null,oe(),c.value=!1}return je(re),Qt(re),Gt(me),ft(me),{status:e,checkedAt:u,remedy:p,loading:t,observing:s,stopping:n,pausing:a,exporting:i,downloading:l,error:o,frame:m,frameUrl:v,frameExpired:w,freshness:W,name:y,artifact:g,refresh:te,control:de,observe:z,clearFrame:X,exportFile:ce,download:ae,toggling:r,adminReady:c,enabledLabel:T,restartSettings:Z,setEnabled:q,recovering:d,recover:Ie,reconcile:_,releaseOwnedInput:he,reconciliationAck:f,applicationProfiles:U,attached:P,scriptIdentity:I,inputLimits:S,accessibilityLabel:J,accessibilityDetail:E}}},dv=[{id:"health",label:"Health",component:Pk},{id:"resources",label:"Resources",component:Mk},{id:"logs",label:"Logs",component:Wk},{id:"config",label:"Config",component:lS},{id:"discord",label:"Discord",component:rS},{id:"hosts",label:"Hosts",component:uS},{id:"host-access",label:"Host Access",component:dS},{id:"api-tokens",label:"API Tokens",component:pS},{id:"llm",label:"LLM Config",component:_S},{id:"internals",label:"Internals",component:kS},{id:"turn-state",label:"Turn State",component:CS},{id:"computer",label:"Computer",component:IS},{id:"update",label:"Update",component:ES}],OS={components:{TabbedPage:Qo},setup(){return{tabs:dv}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},$l=(e,t,s,n)=>n.map(({id:a,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:a}}})),LS=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...$l("Operations","operations","/operations",ev),...$l("History","history","/history",tv),...$l("Capabilities","capabilities","/capabilities",sv),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...$l("System","system","/system",dv)],bs=ta({open:!1,query:"",selected:0});function yp(){bs.query="",bs.selected=0,bs.open=!0}function Cr(){bs.open=!1}function NS(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const DS={setup(){const e=Gm(),t=h(null),s=G(()=>{const i=bs.query.trim().toLowerCase();return LS.map(l=>({...l,_score:NS(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Mt(()=>bs.open,async i=>{var l;i&&(await Rt(),(l=t.value)==null||l.focus())}),Mt(()=>bs.query,()=>{bs.selected=0});function n(i){Cr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Cr();return}if(i.key==="ArrowDown")i.preventDefault(),bs.selected=Math.min(bs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),bs.selected=Math.max(bs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[bs.selected];l&&n(l)}}return{state:bs,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Cr}},template:`
    <transition name="modal">
  ...
  `},fc={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(fc));const PS={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>si("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[si("path",{d:fc[e.name]||fc.info})])}},MS=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function xp(e){return[...e.querySelectorAll(MS)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const FS={mounted(e){const t=document.activeElement,s=n=>{if(n.key!=="Tab")return;const a=xp(e);if(!a.length){n.preventDefault(),e.focus();return}const i=a[0],l=a[a.length-1];n.shiftKey&&document.activeElement===i?(n.preventDefault(),l.focus()):!n.shiftKey&&document.activeElement===l&&(n.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||xp(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},$S={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),o=h(!1),r=h([]),c=h(0),d=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const f=G(()=>{const Z=e.value.uptime_seconds||0,W=Math.floor(Z/86400),X=Math.floor(Z%86400/3600),oe=Math.floor(Z%3600/60),Q=[];return W>0&&Q.push(`${W}d`),X>0&&Q.push(`${X}h`),(Q.length===0||W===0&&X===0)&&Q.push(`${oe}m`),Q.join(" ")}),m=G(()=>{const Z=e.value.uptime_seconds||0;return 125.66*(1-Math.min(Z/86400,1))}),v=G(()=>{const Z=e.value;return[{label:"Guilds",value:Z.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:Z.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:Z.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${Z.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:Z.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:Z.loop_count>0?"text-green-400":"",highlight:Z.loop_count>0},{label:"Agents",value:Z.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:Z.agent_count>0?`${Z.agent_count} total`:"",subColor:"text-gray-500",highlight:(Z.agent_running??0)>0},{label:"Processes",value:Z.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:Z.process_count>0?`${Z.process_count} total`:"",subColor:"text-gray-500",highlight:(Z.process_running??0)>0},{label:"Schedules",value:Z.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(Z.schedule_failing>0?`${Z.schedule_failing} failing`:"")+(Z.schedule_failing>0&&Z.schedule_paused>0?", ":"")+(Z.schedule_paused>0?`${Z.schedule_paused} paused`:"")||void 0,subColor:Z.schedule_failing>0?"text-red-400":"text-yellow-400",color:Z.schedule_failing>0?"text-red-400":"",highlight:Z.schedule_failing>0},{label:"Users",value:Z.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),w=G(()=>{const Z=e.value,W=[];return W.push({label:"Bot",status:Z.status==="online"?"ok":"warn",detail:Z.status==="online"?"Online":"Starting"}),(Z.schedule_failing||0)>0?W.push({label:"Schedules",status:"error",detail:`${Z.schedule_failing} failing`}):(Z.schedule_count||0)>0&&W.push({label:"Schedules",status:"ok",detail:`${Z.schedule_count} configured`}),(Z.loop_count||0)>0&&W.push({label:"Loops",status:"ok",detail:`${Z.loop_count} active`}),(Z.agent_running||0)>0&&W.push({label:"Agents",status:"ok",detail:`${Z.agent_running} running`}),(Z.process_running||0)>0&&W.push({label:"Processes",status:"ok",detail:`${Z.process_running} running`}),W});async function L(){try{e.value=await H.get("/api/status"),s.value=null}catch(Z){s.value=Z.message}finally{t.value=!1}}let y=0,g=0,b=0,C=0;function k(Z,W){const X=new Set;return[...W,...Z].filter(oe=>{const Q=oe._hmac||JSON.stringify([oe.timestamp,oe.tool_name,oe.user_id,oe.result_summary,oe.error]);return X.has(Q)?!1:(X.add(Q),!0)})}async function O(){const Z=++y,W=b;a.value=!0;try{const X=await H.get("/api/audit?limit=10");if(Z!==y)return;const oe=W===b?[]:n.value.filter(Q=>(Q._liveEpoch||0)>W);n.value=k(X,oe).slice(0,10),c.value=oe.length}catch{}Z===y&&(a.value=!1)}async function A(){const Z=++g,W=C;l.value=!0;try{const X=await H.get("/api/audit?error_only=1&limit=5");if(Z!==g)return;const oe=W===C?[]:i.value.filter(Q=>(Q._liveErrorEpoch||0)>W);i.value=k(X,oe).slice(0,5),o.value=!1}catch{if(Z!==g)return;o.value=W===C||i.value.length===0}Z===g&&(l.value=!1)}async function x(){try{const Z=await H.get("/api/knowledge");d.value=(Array.isArray(Z)?Z:[]).reduce((W,X)=>W+(X.chunks||0),0)}catch{d.value=null}}async function N(){try{const Z=await H.get("/api/agents");r.value=Z.filter(W=>W.status==="running")}catch{}}async function $(){u.value={...u.value,reload:!0};try{await H.post("/api/reload"),_e.success("Config reloaded")}catch(Z){_e.error(Z.message)}u.value={...u.value,reload:!1}}async function T(){if(!await qt({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const W=e.value.session_count;e.value={...e.value,session_count:0};try{const X=await H.post("/api/sessions/clear-all");_e.success(`Cleared ${X.count} session${X.count!==1?"s":""}`),await L()}catch(X){e.value={...e.value,session_count:W},_e.error(X.message)}u.value={...u.value,clearSessions:!1}}async function P(){if(!await qt({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const W=e.value.loop_count;e.value={...e.value,loop_count:0};try{const X=await H.post("/api/loops/stop-all");_e.success(X.result),await L()}catch(X){e.value={...e.value,loop_count:W},_e.error(X.message)}u.value={...u.value,stopLoops:!1}}function V(){t.value=!0,s.value=null,L(),O(),A(),N()}let J=null,E=null,S=null;function I(Z){if(Z.payload&&Z.payload.tool_name){b+=1;const W={...Z.payload,_isNew:!0,_key:++p,_liveEpoch:b};n.value.unshift(W),n.value.length>10&&n.value.pop(),c.value++,W.error&&(C+=1,W._liveErrorEpoch=C,o.value=!1,i.value.unshift(W),i.value.length>5&&i.value.pop()),setTimeout(()=>{W._isNew=!1},1500),clearTimeout(S),S=setTimeout(()=>{c.value=0},1e4)}}let U=null;return je(async()=>{await Promise.all([L(),O(),A(),N(),x()]),J=setInterval(L,15e3),E=setInterval(N,1e4),Ye.subscribe("events",I),U=Ye.onReconnected(()=>{O(),A()})}),ft(()=>{J&&clearInterval(J),E&&clearInterval(E),clearTimeout(S),Ye.unsubscribe("events",I),U&&(U(),U=null)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:m,stats:v,healthIndicators:w,activity:n,activityLoading:a,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:O,fetchErrors:A,fetchStatus:L,onEvent:I,formatTime:zw,formatDuration:ui,retry:V,reloadConfig:$,clearSessions:T,stopAllLoops:P}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function _p(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function US(e){if(Array.isArray(e))return e}function BS(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(n=i.call(s)).done)&&(o.push(n.value),o.length!==t);r=!0);}catch(d){c=!0,a=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return o}}function HS(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function zS(e,t){return US(e)||BS(e,t)||jS(e,t)||HS()}function jS(e,t){if(e){if(typeof e=="string")return _p(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?_p(e,t):void 0}}const uv=Object.entries,wp=Object.setPrototypeOf,VS=Object.isFrozen,qS=Object.getPrototypeOf,GS=Object.getOwnPropertyDescriptor;let ms=Object.freeze,zs=Object.seal,Ha=Object.create,pv=typeof Reflect<"u"&&Reflect,hc=pv.apply,mc=pv.construct;ms||(ms=function(t){return t});zs||(zs=function(t){return t});hc||(hc=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});mc||(mc=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const vn=Ft(Array.prototype.forEach),KS=Ft(Array.prototype.lastIndexOf),kp=Ft(Array.prototype.pop),Ma=Ft(Array.prototype.push),WS=Ft(Array.prototype.splice),ds=Array.isArray,Oi=Ft(String.prototype.toLowerCase),Er=Ft(String.prototype.toString),Sp=Ft(String.prototype.match),Fa=Ft(String.prototype.replace),Tp=Ft(String.prototype.indexOf),JS=Ft(String.prototype.trim),ZS=Ft(Number.prototype.toString),YS=Ft(Boolean.prototype.toString),Cp=typeof BigInt>"u"?null:Ft(BigInt.prototype.toString),Ep=typeof Symbol>"u"?null:Ft(Symbol.prototype.toString),St=Ft(Object.prototype.hasOwnProperty),Si=Ft(Object.prototype.toString),Kt=Ft(RegExp.prototype.test),ra=QS(TypeError);function Ft(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return hc(e,t,n)}}function QS(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return mc(e,s)}}function ze(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Oi;if(wp&&wp(e,null),!ds(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(VS(t)||(t[n]=i),a=i)}e[a]=!0}return e}function XS(e){for(let t=0;t<e.length;t++)St(e,t)||(e[t]=null);return e}function ss(e){const t=Ha(null);for(const n of uv(e)){var s=zS(n,2);const a=s[0],i=s[1];St(e,a)&&(ds(i)?t[a]=XS(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=ss(i):t[a]=i)}return t}function e1(e){switch(typeof e){case"string":return e;case"number":return ZS(e);case"boolean":return YS(e);case"bigint":return Cp?Cp(e):"0";case"symbol":return Ep?Ep(e):"Symbol()";case"undefined":return Si(e);case"function":case"object":{if(e===null)return Si(e);const t=e,s=en(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Si(n)}return Si(e)}default:return Si(e)}}function en(e,t){for(;e!==null;){const n=GS(e,t);if(n){if(n.get)return Ft(n.get);if(typeof n.value=="function")return Ft(n.value)}e=qS(e)}function s(){return null}return s}function t1(e){try{return Kt(e,""),!0}catch{return!1}}const Ap=ms(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Ar=ms(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Rr=ms(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),s1=ms(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ir=ms(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),n1=ms(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Rp=ms(["#text"]),Ip=ms(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Or=ms(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Op=ms(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ul=ms(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),a1=zs(/{{[\w\W]*|^[\w\W]*}}/g),i1=zs(/<%[\w\W]*|^[\w\W]*%>/g),l1=zs(/\${[\w\W]*/g),o1=zs(/^data-[\-\w.\u00B7-\uFFFF]+$/),r1=zs(/^aria-[\-\w]+$/),Lp=zs(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),c1=zs(/^(?:\w+script|data):/i),d1=zs(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),u1=zs(/^html$/i),p1=zs(/^[a-z][.\w]*(-[.\w]+)+$/i),Qs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},f1=function(){return typeof window>"u"?null:window},h1=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Np=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function fv(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:f1();const t=Te=>fv(Te);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Qs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,f=en(p,"cloneNode"),m=en(p,"remove"),v=en(p,"nextSibling"),w=en(p,"childNodes"),L=en(p,"parentNode"),y=en(p,"shadowRoot"),g=en(p,"attributes"),b=l&&l.prototype?en(l.prototype,"nodeType"):null,C=l&&l.prototype?en(l.prototype,"nodeName"):null;if(typeof i=="function"){const Te=s.createElement("template");Te.content&&Te.content.ownerDocument&&(s=Te.content.ownerDocument)}let k,O="",A,x=!1,N=0;const $=function(){if(N>0)throw ra('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},T=function(D){$(),N++;try{return k.createHTML(D)}finally{N--}},P=function(D){$(),N++;try{return k.createScriptURL(D)}finally{N--}},V=function(){return x||(A=h1(u,a),x=!0),A},J=s,E=J.implementation,S=J.createNodeIterator,I=J.createDocumentFragment,U=J.getElementsByTagName,Z=n.importNode;let W=Np();t.isSupported=typeof uv=="function"&&typeof L=="function"&&E&&E.createHTMLDocument!==void 0;const X=a1,oe=i1,Q=l1,pe=o1,Oe=r1,te=c1,ve=d1,q=p1;let de=Lp,he=null;const Ie=ze({},[...Ap,...Ar,...Rr,...Ir,...Rp]);let _=null;const M=ze({},[...Ip,...Or,...Op,...Ul]);let z=Object.seal(Ha(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ce=null,ae=null;const re=Object.seal(Ha(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let me=!0,j=!0,ee=!1,Y=!0,fe=!1,ue=!0,be=!1,Ee=!1,F=!1,ye=!1,ke=!1,Le=!1,Me=!0,dt=!1;const st="user-content-";let _t=!0,Ot=!1,rt={},Qe=null;const le=ze({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Se=null;const Ne=ze({},["audio","video","img","source","image","track"]);let Ke=null;const Et=ze({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ve="http://www.w3.org/1998/Math/MathML",$t="http://www.w3.org/2000/svg",zt="http://www.w3.org/1999/xhtml";let rs=zt,Js=!1,ks=null;const na=ze({},[Ve,$t,zt],Er);let Zs=ze({},["mi","mo","mn","ms","mtext"]),Ns=ze({},["annotation-xml"]);const Mn=ze({},["title","style","font","a","script"]);let Ss=null;const Fn=["application/xhtml+xml","text/html"],Lt="text/html";let Xe=null,Ts=null;const Ds=s.createElement("form"),ne=function(D){return D instanceof RegExp||D instanceof Function},we=function(){let D=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ts&&Ts===D)return;(!D||typeof D!="object")&&(D={}),D=ss(D),Ss=Fn.indexOf(D.PARSER_MEDIA_TYPE)===-1?Lt:D.PARSER_MEDIA_TYPE,Xe=Ss==="application/xhtml+xml"?Er:Oi,he=St(D,"ALLOWED_TAGS")&&ds(D.ALLOWED_TAGS)?ze({},D.ALLOWED_TAGS,Xe):Ie,_=St(D,"ALLOWED_ATTR")&&ds(D.ALLOWED_ATTR)?ze({},D.ALLOWED_ATTR,Xe):M,ks=St(D,"ALLOWED_NAMESPACES")&&ds(D.ALLOWED_NAMESPACES)?ze({},D.ALLOWED_NAMESPACES,Er):na,Ke=St(D,"ADD_URI_SAFE_ATTR")&&ds(D.ADD_URI_SAFE_ATTR)?ze(ss(Et),D.ADD_URI_SAFE_ATTR,Xe):Et,Se=St(D,"ADD_DATA_URI_TAGS")&&ds(D.ADD_DATA_URI_TAGS)?ze(ss(Ne),D.ADD_DATA_URI_TAGS,Xe):Ne,Qe=St(D,"FORBID_CONTENTS")&&ds(D.FORBID_CONTENTS)?ze({},D.FORBID_CONTENTS,Xe):le,ce=St(D,"FORBID_TAGS")&&ds(D.FORBID_TAGS)?ze({},D.FORBID_TAGS,Xe):ss({}),ae=St(D,"FORBID_ATTR")&&ds(D.FORBID_ATTR)?ze({},D.FORBID_ATTR,Xe):ss({}),rt=St(D,"USE_PROFILES")?D.USE_PROFILES&&typeof D.USE_PROFILES=="object"?ss(D.USE_PROFILES):D.USE_PROFILES:!1,me=D.ALLOW_ARIA_ATTR!==!1,j=D.ALLOW_DATA_ATTR!==!1,ee=D.ALLOW_UNKNOWN_PROTOCOLS||!1,Y=D.ALLOW_SELF_CLOSE_IN_ATTR!==!1,fe=D.SAFE_FOR_TEMPLATES||!1,ue=D.SAFE_FOR_XML!==!1,be=D.WHOLE_DOCUMENT||!1,ye=D.RETURN_DOM||!1,ke=D.RETURN_DOM_FRAGMENT||!1,Le=D.RETURN_TRUSTED_TYPE||!1,F=D.FORCE_BODY||!1,Me=D.SANITIZE_DOM!==!1,dt=D.SANITIZE_NAMED_PROPS||!1,_t=D.KEEP_CONTENT!==!1,Ot=D.IN_PLACE||!1,de=t1(D.ALLOWED_URI_REGEXP)?D.ALLOWED_URI_REGEXP:Lp,rs=typeof D.NAMESPACE=="string"?D.NAMESPACE:zt,Zs=St(D,"MATHML_TEXT_INTEGRATION_POINTS")&&D.MATHML_TEXT_INTEGRATION_POINTS&&typeof D.MATHML_TEXT_INTEGRATION_POINTS=="object"?ss(D.MATHML_TEXT_INTEGRATION_POINTS):ze({},["mi","mo","mn","ms","mtext"]),Ns=St(D,"HTML_INTEGRATION_POINTS")&&D.HTML_INTEGRATION_POINTS&&typeof D.HTML_INTEGRATION_POINTS=="object"?ss(D.HTML_INTEGRATION_POINTS):ze({},["annotation-xml"]);const ie=St(D,"CUSTOM_ELEMENT_HANDLING")&&D.CUSTOM_ELEMENT_HANDLING&&typeof D.CUSTOM_ELEMENT_HANDLING=="object"?ss(D.CUSTOM_ELEMENT_HANDLING):Ha(null);if(z=Ha(null),St(ie,"tagNameCheck")&&ne(ie.tagNameCheck)&&(z.tagNameCheck=ie.tagNameCheck),St(ie,"attributeNameCheck")&&ne(ie.attributeNameCheck)&&(z.attributeNameCheck=ie.attributeNameCheck),St(ie,"allowCustomizedBuiltInElements")&&typeof ie.allowCustomizedBuiltInElements=="boolean"&&(z.allowCustomizedBuiltInElements=ie.allowCustomizedBuiltInElements),fe&&(j=!1),ke&&(ye=!0),rt&&(he=ze({},Rp),_=Ha(null),rt.html===!0&&(ze(he,Ap),ze(_,Ip)),rt.svg===!0&&(ze(he,Ar),ze(_,Or),ze(_,Ul)),rt.svgFilters===!0&&(ze(he,Rr),ze(_,Or),ze(_,Ul)),rt.mathMl===!0&&(ze(he,Ir),ze(_,Op),ze(_,Ul))),re.tagCheck=null,re.attributeCheck=null,St(D,"ADD_TAGS")&&(typeof D.ADD_TAGS=="function"?re.tagCheck=D.ADD_TAGS:ds(D.ADD_TAGS)&&(he===Ie&&(he=ss(he)),ze(he,D.ADD_TAGS,Xe))),St(D,"ADD_ATTR")&&(typeof D.ADD_ATTR=="function"?re.attributeCheck=D.ADD_ATTR:ds(D.ADD_ATTR)&&(_===M&&(_=ss(_)),ze(_,D.ADD_ATTR,Xe))),St(D,"ADD_URI_SAFE_ATTR")&&ds(D.ADD_URI_SAFE_ATTR)&&ze(Ke,D.ADD_URI_SAFE_ATTR,Xe),St(D,"FORBID_CONTENTS")&&ds(D.FORBID_CONTENTS)&&(Qe===le&&(Qe=ss(Qe)),ze(Qe,D.FORBID_CONTENTS,Xe)),St(D,"ADD_FORBID_CONTENTS")&&ds(D.ADD_FORBID_CONTENTS)&&(Qe===le&&(Qe=ss(Qe)),ze(Qe,D.ADD_FORBID_CONTENTS,Xe)),_t&&(he["#text"]=!0),be&&ze(he,["html","head","body"]),he.table&&(ze(he,["tbody"]),delete ce.tbody),D.TRUSTED_TYPES_POLICY){if(typeof D.TRUSTED_TYPES_POLICY.createHTML!="function")throw ra('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof D.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw ra('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ge=k;k=D.TRUSTED_TYPES_POLICY;try{O=T("")}catch(De){throw k=ge,De}}else D.TRUSTED_TYPES_POLICY===null?(k=void 0,O=""):(k===void 0&&(k=V()),k&&typeof O=="string"&&(O=T("")));(W.uponSanitizeElement.length>0||W.uponSanitizeAttribute.length>0)&&he===Ie&&(he=ss(he)),W.uponSanitizeAttribute.length>0&&_===M&&(_=ss(_)),ms&&ms(D),Ts=D},$e=ze({},[...Ar,...Rr,...s1]),Je=ze({},[...Ir,...n1]),wt=function(D){let ie=L(D);(!ie||!ie.tagName)&&(ie={namespaceURI:rs,tagName:"template"});const ge=Oi(D.tagName),De=Oi(ie.tagName);return ks[D.namespaceURI]?D.namespaceURI===$t?ie.namespaceURI===zt?ge==="svg":ie.namespaceURI===Ve?ge==="svg"&&(De==="annotation-xml"||Zs[De]):!!$e[ge]:D.namespaceURI===Ve?ie.namespaceURI===zt?ge==="math":ie.namespaceURI===$t?ge==="math"&&Ns[De]:!!Je[ge]:D.namespaceURI===zt?ie.namespaceURI===$t&&!Ns[De]||ie.namespaceURI===Ve&&!Zs[De]?!1:!Je[ge]&&(Mn[ge]||!$e[ge]):!!(Ss==="application/xhtml+xml"&&ks[D.namespaceURI]):!1},ut=function(D){Ma(t.removed,{element:D});try{L(D).removeChild(D)}catch{if(m(D),!L(D))throw ra("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},$n=function(D){const ie=w?w(D):D.childNodes;if(ie){const De=[];vn(ie,Fe=>{Ma(De,Fe)}),vn(De,Fe=>{try{m(Fe)}catch{}})}const ge=g?g(D):null;if(ge)for(let De=ge.length-1;De>=0;--De){const Fe=ge[De],Be=Fe&&Fe.name;if(typeof Be=="string")try{D.removeAttribute(Be)}catch{}}},js=function(D,ie){try{Ma(t.removed,{attribute:ie.getAttributeNode(D),from:ie})}catch{Ma(t.removed,{attribute:null,from:ie})}if(ie.removeAttribute(D),D==="is")if(ye||ke)try{ut(ie)}catch{}else try{ie.setAttribute(D,"")}catch{}},mi=function(D){const ie=g?g(D):D.attributes;if(ie)for(let ge=ie.length-1;ge>=0;--ge){const De=ie[ge],Fe=De&&De.name;if(!(typeof Fe!="string"||_[Xe(Fe)]))try{D.removeAttribute(Fe)}catch{}}},vi=function(D){const ie=[D];for(;ie.length>0;){const ge=ie.pop();(b?b(ge):ge.nodeType)===Qs.element&&mi(ge);const Fe=w?w(ge):ge.childNodes;if(Fe)for(let Be=Fe.length-1;Be>=0;--Be)ie.push(Fe[Be])}},Ia=function(D){let ie=null,ge=null;if(F)D="<remove></remove>"+D;else{const Be=Sp(D,/^[\r\n\t ]+/);ge=Be&&Be[0]}Ss==="application/xhtml+xml"&&rs===zt&&(D='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+D+"</body></html>");const De=k?T(D):D;if(rs===zt)try{ie=new d().parseFromString(De,Ss)}catch{}if(!ie||!ie.documentElement){ie=E.createDocument(rs,"template",null);try{ie.documentElement.innerHTML=Js?O:De}catch{}}const Fe=ie.body||ie.documentElement;return D&&ge&&Fe.insertBefore(s.createTextNode(ge),Fe.childNodes[0]||null),rs===zt?U.call(ie,be?"html":"body")[0]:be?ie.documentElement:Fe},aa=function(D){return S.call(D.ownerDocument||D,D,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},Un=function(D){var ie,ge;D.normalize();const De=S.call(D.ownerDocument||D,D,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let Fe=De.nextNode();for(;Fe;){let yt=Fe.data;vn([X,oe,Q],it=>{yt=Fa(yt,it," ")}),Fe.data=yt,Fe=De.nextNode()}const Be=(ie=(ge=D.querySelectorAll)===null||ge===void 0?void 0:ge.call(D,"template"))!==null&&ie!==void 0?ie:[];vn(Array.from(Be),yt=>{Ys(yt.content)&&Un(yt.content)})},Bn=function(D){const ie=C?C(D):null;return typeof ie!="string"||Xe(ie)!=="form"?!1:typeof D.nodeName!="string"||typeof D.textContent!="string"||typeof D.removeChild!="function"||D.attributes!==g(D)||typeof D.removeAttribute!="function"||typeof D.setAttribute!="function"||typeof D.namespaceURI!="string"||typeof D.insertBefore!="function"||typeof D.hasChildNodes!="function"||D.nodeType!==b(D)||D.childNodes!==w(D)},Ys=function(D){if(!b||typeof D!="object"||D===null)return!1;try{return b(D)===Qs.documentFragment}catch{return!1}},dn=function(D){if(!b||typeof D!="object"||D===null)return!1;try{return typeof b(D)=="number"}catch{return!1}};function Xt(Te,D,ie){vn(Te,ge=>{ge.call(t,D,ie,Ts)})}const Oa=function(D){let ie=null;if(Xt(W.beforeSanitizeElements,D,null),Bn(D))return ut(D),!0;const ge=Xe(C?C(D):D.nodeName);if(Xt(W.uponSanitizeElement,D,{tagName:ge,allowedTags:he}),ue&&D.hasChildNodes()&&!dn(D.firstElementChild)&&Kt(/<[/\w!]/g,D.innerHTML)&&Kt(/<[/\w!]/g,D.textContent)||ue&&D.namespaceURI===zt&&ge==="style"&&dn(D.firstElementChild)||D.nodeType===Qs.progressingInstruction||ue&&D.nodeType===Qs.comment&&Kt(/<[/\w]/g,D.data))return ut(D),!0;if(ce[ge]||!(re.tagCheck instanceof Function&&re.tagCheck(ge))&&!he[ge]){if(!ce[ge]&&Re(ge)&&(z.tagNameCheck instanceof RegExp&&Kt(z.tagNameCheck,ge)||z.tagNameCheck instanceof Function&&z.tagNameCheck(ge)))return!1;if(_t&&!Qe[ge]){const Fe=L(D),Be=w(D);if(Be&&Fe){const yt=Be.length;for(let it=yt-1;it>=0;--it){const vt=Ot?Be[it]:f(Be[it],!0);Fe.insertBefore(vt,v(D))}}}return ut(D),!0}return(b?b(D):D.nodeType)===Qs.element&&!wt(D)||(ge==="noscript"||ge==="noembed"||ge==="noframes")&&Kt(/<\/no(script|embed|frames)/i,D.innerHTML)?(ut(D),!0):(fe&&D.nodeType===Qs.text&&(ie=D.textContent,vn([X,oe,Q],Fe=>{ie=Fa(ie,Fe," ")}),D.textContent!==ie&&(Ma(t.removed,{element:D.cloneNode()}),D.textContent=ie)),Xt(W.afterSanitizeElements,D,null),!1)},K=function(D,ie,ge){if(ae[ie]||Me&&(ie==="id"||ie==="name")&&(ge in s||ge in Ds))return!1;const De=_[ie]||re.attributeCheck instanceof Function&&re.attributeCheck(ie,D);if(!(j&&!ae[ie]&&Kt(pe,ie))){if(!(me&&Kt(Oe,ie))){if(!De||ae[ie]){if(!(Re(D)&&(z.tagNameCheck instanceof RegExp&&Kt(z.tagNameCheck,D)||z.tagNameCheck instanceof Function&&z.tagNameCheck(D))&&(z.attributeNameCheck instanceof RegExp&&Kt(z.attributeNameCheck,ie)||z.attributeNameCheck instanceof Function&&z.attributeNameCheck(ie,D))||ie==="is"&&z.allowCustomizedBuiltInElements&&(z.tagNameCheck instanceof RegExp&&Kt(z.tagNameCheck,ge)||z.tagNameCheck instanceof Function&&z.tagNameCheck(ge))))return!1}else if(!Ke[ie]){if(!Kt(de,Fa(ge,ve,""))){if(!((ie==="src"||ie==="xlink:href"||ie==="href")&&D!=="script"&&Tp(ge,"data:")===0&&Se[D])){if(!(ee&&!Kt(te,Fa(ge,ve,"")))){if(ge)return!1}}}}}}return!0},xe=ze({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Re=function(D){return!xe[Oi(D)]&&Kt(q,D)},es=function(D){Xt(W.beforeSanitizeAttributes,D,null);const ie=D.attributes;if(!ie||Bn(D))return;const ge={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:_,forceKeepAttr:void 0};let De=ie.length;for(;De--;){const Fe=ie[De],Be=Fe.name,yt=Fe.namespaceURI,it=Fe.value,vt=Xe(Be),R=it;let B=Be==="value"?R:JS(R);if(ge.attrName=vt,ge.attrValue=B,ge.keepAttr=!0,ge.forceKeepAttr=void 0,Xt(W.uponSanitizeAttribute,D,ge),B=ge.attrValue,dt&&(vt==="id"||vt==="name")&&Tp(B,st)!==0&&(js(Be,D),B=st+B),ue&&Kt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,B)){js(Be,D);continue}if(vt==="attributename"&&Sp(B,"href")){js(Be,D);continue}if(ge.forceKeepAttr)continue;if(!ge.keepAttr){js(Be,D);continue}if(!Y&&Kt(/\/>/i,B)){js(Be,D);continue}fe&&vn([X,oe,Q],Ae=>{B=Fa(B,Ae," ")});const se=Xe(D.nodeName);if(!K(se,vt,B)){js(Be,D);continue}if(k&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!yt)switch(u.getAttributeType(se,vt)){case"TrustedHTML":{B=T(B);break}case"TrustedScriptURL":{B=P(B);break}}if(B!==R)try{yt?D.setAttributeNS(yt,Be,B):D.setAttribute(Be,B),Bn(D)?ut(D):kp(t.removed)}catch{js(Be,D)}}Xt(W.afterSanitizeAttributes,D,null)},un=function(D){let ie=null;const ge=aa(D);for(Xt(W.beforeSanitizeShadowDOM,D,null);ie=ge.nextNode();)if(Xt(W.uponSanitizeShadowNode,ie,null),Oa(ie),es(ie),Ys(ie.content)&&un(ie.content),(b?b(ie):ie.nodeType)===Qs.element){const Fe=y?y(ie):ie.shadowRoot;Ys(Fe)&&(Hn(Fe),un(Fe))}Xt(W.afterSanitizeShadowDOM,D,null)},Hn=function(D){const ie=[{node:D,shadow:null}];for(;ie.length>0;){const ge=ie.pop();if(ge.shadow){un(ge.shadow);continue}const De=ge.node,Be=(b?b(De):De.nodeType)===Qs.element,yt=w?w(De):De.childNodes;if(yt)for(let it=yt.length-1;it>=0;--it)ie.push({node:yt[it],shadow:null});if(Be){const it=C?C(De):null;if(typeof it=="string"&&Xe(it)==="template"){const vt=De.content;Ys(vt)&&ie.push({node:vt,shadow:null})}}if(Be){const it=y?y(De):De.shadowRoot;Ys(it)&&ie.push({node:null,shadow:it},{node:it,shadow:null})}}};return t.sanitize=function(Te){let D=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},ie=null,ge=null,De=null,Fe=null;if(Js=!Te,Js&&(Te="<!-->"),typeof Te!="string"&&!dn(Te)&&(Te=e1(Te),typeof Te!="string"))throw ra("dirty is not a string, aborting");if(!t.isSupported)return Te;Ee||we(D),t.removed=[];const Be=Ot&&typeof Te!="string"&&dn(Te);if(Be){const vt=C?C(Te):Te.nodeName;if(typeof vt=="string"){const R=Xe(vt);if(!he[R]||ce[R])throw ra("root node is forbidden and cannot be sanitized in-place")}if(Bn(Te))throw ra("root node is clobbered and cannot be sanitized in-place");try{Hn(Te)}catch(R){throw $n(Te),R}}else if(dn(Te))ie=Ia("<!---->"),ge=ie.ownerDocument.importNode(Te,!0),ge.nodeType===Qs.element&&ge.nodeName==="BODY"||ge.nodeName==="HTML"?ie=ge:ie.appendChild(ge),Hn(ge);else{if(!ye&&!fe&&!be&&Te.indexOf("<")===-1)return k&&Le?T(Te):Te;if(ie=Ia(Te),!ie)return ye?null:Le?O:""}ie&&F&&ut(ie.firstChild);const yt=aa(Be?Te:ie);try{for(;De=yt.nextNode();)Oa(De),es(De),Ys(De.content)&&un(De.content)}catch(vt){throw Be&&$n(Te),vt}if(Be)return vn(t.removed,vt=>{vt.element&&vi(vt.element)}),fe&&Un(Te),Te;if(ye){if(fe&&Un(ie),ke)for(Fe=I.call(ie.ownerDocument);ie.firstChild;)Fe.appendChild(ie.firstChild);else Fe=ie;return(_.shadowroot||_.shadowrootmode)&&(Fe=Z.call(n,Fe,!0)),Fe}let it=be?ie.outerHTML:ie.innerHTML;return be&&he["!doctype"]&&ie.ownerDocument&&ie.ownerDocument.doctype&&ie.ownerDocument.doctype.name&&Kt(u1,ie.ownerDocument.doctype.name)&&(it="<!DOCTYPE "+ie.ownerDocument.doctype.name+`>
`+it),fe&&vn([X,oe,Q],vt=>{it=Fa(it,vt," ")}),k&&Le?T(it):it},t.setConfig=function(){let Te=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};we(Te),Ee=!0},t.clearConfig=function(){Ts=null,Ee=!1,k=A,O=""},t.isValidAttribute=function(Te,D,ie){Ts||we({});const ge=Xe(Te),De=Xe(D);return K(ge,De,ie)},t.addHook=function(Te,D){typeof D=="function"&&Ma(W[Te],D)},t.removeHook=function(Te,D){if(D!==void 0){const ie=KS(W[Te],D);return ie===-1?void 0:WS(W[Te],ie,1)[0]}return kp(W[Te])},t.removeHooks=function(Te){W[Te]=[]},t.removeAllHooks=function(){W=Np()},t}var Dp=fv();function _d(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ra=_d();function hv(e){Ra=e}var Hi={exec:()=>null};function ot(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(fs.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var fs={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},m1=/^(?:[ \t]*(?:\n|$))+/,v1=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,g1=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,xl=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,b1=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,wd=/(?:[*+-]|\d{1,9}[.)])/,mv=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,vv=ot(mv).replace(/bull/g,wd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),y1=ot(mv).replace(/bull/g,wd).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),kd=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,x1=/^[^\n]+/,Sd=/(?!\s*\])(?:\\.|[^\[\]\\])+/,_1=ot(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Sd).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),w1=ot(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,wd).getRegex(),tr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Td=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,k1=ot("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Td).replace("tag",tr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),gv=ot(kd).replace("hr",xl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tr).getRegex(),S1=ot(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",gv).getRegex(),Cd={blockquote:S1,code:v1,def:_1,fences:g1,heading:b1,hr:xl,html:k1,lheading:vv,list:w1,newline:m1,paragraph:gv,table:Hi,text:x1},Pp=ot("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",xl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tr).getRegex(),T1={...Cd,lheading:y1,table:Pp,paragraph:ot(kd).replace("hr",xl).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Pp).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tr).getRegex()},C1={...Cd,html:ot(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Td).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Hi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ot(kd).replace("hr",xl).replace("heading",` *#{1,6} *[^
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+tn(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},ka=new Z1;function at(e,t){return ka.parse(e,t)}at.options=at.setOptions=function(e){return ka.setOptions(e),at.defaults=ka.defaults,hv(at.defaults),at};at.getDefaults=_d;at.defaults=Ra;at.use=function(...e){return ka.use(...e),at.defaults=ka.defaults,hv(at.defaults),at};at.walkTokens=function(e,t){return ka.walkTokens(e,t)};at.parseInline=ka.parseInline;at.Parser=Tn;at.parser=Tn.parse;at.Renderer=To;at.TextRenderer=Rd;at.Lexer=Sn;at.lexer=Sn.lex;at.Tokenizer=So;at.Hooks=Kl;at.parse=at;at.options;at.setOptions;at.use;at.walkTokens;at.parseInline;Tn.parse;Sn.lex;const Y1={breaks:!0,gfm:!0};function Bp(e){if(!e)return"";try{if(typeof at<"u"&&at.parse){const t=at.parse(e,Y1);return typeof Dp<"u"?Dp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Q1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const X1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function eT(e){return X1[e]||"wrench"}const tT=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Hp(e){if(!e)return[];const t=e.match(tT);return t?[...new Set(t)]:[]}const sT={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(""),a=h(null),i=h(null),l=h(0),o=h("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=G(()=>t.value.trim().length>0&&!s.value),p=h(Ye.state||"disconnected");let f=null;const m=G(()=>{const E=p.value;return E==="connected"?"Connected":E==="reconnecting"?"Reconnecting…":E==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],w=G(()=>{const E=Math.floor(l.value/4)%v.length,S=l.value;return S>3?`${v[E]} (${S}s)`:v[0]});function L(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function y(){if(!i.value)return;const E=i.value;E.style.height="auto",E.style.height=Math.min(E.scrollHeight,120)+"px"}function g(E,S,I={}){const U={id:++c,role:E,content:S,timestamp:Date.now(),html:E==="bot"?Bp(S):"",tools_used:I.tools_used||[],is_error:I.is_error||!1,images:E==="bot"?Hp(S):[],files:I.files||[],_showTools:!1};return e.value.push(U),L(),E==="bot"&&Rt(()=>b()),U}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(S=>{S.setAttribute("data-copy","true"),S.style.position="relative";const I=document.createElement("button");I.className="chat-code-copy",I.textContent="Copy",I.addEventListener("click",()=>{const U=S.querySelector("code"),Z=U?U.textContent:S.textContent;navigator.clipboard.writeText(Z).then(()=>{I.textContent="Copied!",setTimeout(()=>{I.textContent="Copy"},1500)}).catch(()=>{})}),S.appendChild(I)})}function C(E){if(E===0)return!0;const S=e.value[E-1],I=e.value[E],U=new Date(S.timestamp).toDateString(),Z=new Date(I.timestamp).toDateString();return U!==Z}function k(E){const S=new Date(E),I=new Date;if(S.toDateString()===I.toDateString())return"Today";const U=new Date(I);return U.setDate(U.getDate()-1),S.toDateString()===U.toDateString()?"Yesterday":S.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function O(E){t.value=E,Rt(()=>V())}function A(E){window.open(E,"_blank","noopener")}function x(E){E.target.style.display="none"}function N(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function $(){r&&(clearInterval(r),r=null),l.value=0}function T(E){s.value&&(s.value=!1,$(),E.type==="chat_response"?g("bot",E.content,{tools_used:E.tools_used||[],is_error:E.is_error||!1,files:E.files||[]}):E.type==="chat_error"&&g("bot",E.error||"Unknown error",{is_error:!0}),Rt(()=>{var S;return(S=i.value)==null?void 0:S.focus()}))}async function P(E){try{const S=await H.post("/api/chat",{content:E,channel_id:o.value});g("bot",S.response,{tools_used:S.tools_used||[],is_error:S.is_error||!1,files:S.files||[]})}catch(S){g("bot",S.message||"Failed to send message",{is_error:!0})}}async function V(){const E=t.value.trim();if(!E||s.value)return;g("user",E),t.value="",s.value=!0,N(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(E,{channelId:o.value})||(await P(E),s.value=!1,$()),Rt(()=>{var I;return(I=i.value)==null?void 0:I.focus()})}async function J(){n.value="";try{if(!o.value){const S=await H.get("/api/auth/session");o.value=S.channel_id||S.user_id||"web-user"}const E=await H.get("/api/sessions/"+encodeURIComponent(o.value));if(E&&E.messages&&E.messages.length>0){for(const S of E.messages){const I=S.role==="user"?"user":"bot";let U=S.content||"";if(I==="user"){const W=U.match(/^\[.*?\]:\s*/);W&&(U=U.slice(W[0].length))}if(!U.trim())continue;const Z={id:++c,role:I,content:U,timestamp:S.timestamp?S.timestamp*1e3:Date.now(),html:I==="bot"?Bp(U):"",tools_used:[],is_error:!1,images:I==="bot"?Hp(U):[],files:[],_showTools:!1};e.value.push(Z)}Rt(()=>{L(),b()})}}catch(E){E&&E.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",_e.error(n.value))}}return je(()=>{Ye.subscribe("chat",T),p.value=Ye.state||"disconnected",f=Ye.onState(E=>{p.value=E}),J(),Rt(()=>{var E;return(E=i.value)==null?void 0:E.focus()})}),ft(()=>{Ye.unsubscribe("chat",T),f&&(f(),f=null),$()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:w,suggestions:d,send:V,autoResize:y,formatTime:Q1,formatDate:k,showDateSeparator:C,useSuggestion:O,openImage:A,onImageError:x,getToolIcon:eT,loadHistory:J}}},nT={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),o=h(!1),r=h(!1),c=h(null),d=h(!0),u=h(""),p=h(!1),f=h(!1),m=G(()=>e.value==="custom"),v=G(()=>[...i.value,...l.value]),w=G(()=>l.value.includes(e.value)),L=G(()=>{var A;return m.value?t.value||"Odin":((A=a.value[e.value])==null?void 0:A.name)||e.value}),y=G(()=>{var A;return m.value?s.value||"(empty — will use Odin default)":((A=a.value[e.value])==null?void 0:A.identity)||""}),g=G(()=>{var A;return m.value?n.value||"(empty — will use Odin default)":((A=a.value[e.value])==null?void 0:A.voice)||""});async function b(){d.value=!0;try{const A=await H.get("/api/personality");e.value=A.preset||"odin",t.value=A.custom_name||"",s.value=A.custom_identity||"",n.value=A.custom_voice||"",a.value=A.presets||{},i.value=A.builtin_presets||[],l.value=A.user_presets||[]}catch(A){c.value=A.message}finally{d.value=!1}}async function C(){o.value=!0,c.value=null,r.value=!1;try{await H.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(A){c.value=A.message}finally{o.value=!1}}async function k(){const A=u.value.trim();if(A){f.value=!0,c.value=null;try{await H.post("/api/personality/presets",{name:A,display_name:L.value,identity:y.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=A.toLowerCase().replace(/ /g,"_")}catch(x){c.value=x.message}finally{f.value=!1}}}async function O(){if(await qt({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await H.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(x){c.value=x.message}}}return je(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:w,previewName:L,previewIdentity:y,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:C,showSavePreset:p,newPresetName:u,savingPreset:f,saveAsPreset:k,deletePreset:O,builtinPresets:i,userPresets:l}},template:`
  ...
  `},kt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Tv=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:$S,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:sT,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:tk,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:dk,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Ok,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:nT,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:OS,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:kt("/operations","live")},{path:"/agents",redirect:kt("/operations","agents")},{path:"/loops",redirect:kt("/operations","loops")},{path:"/processes",redirect:kt("/operations","processes")},{path:"/schedules",redirect:kt("/operations","schedules")},{path:"/audit",redirect:kt("/history","audit")},{path:"/sessions",redirect:kt("/history","sessions")},{path:"/traces",redirect:kt("/history","traces")},{path:"/usage",redirect:kt("/history","usage")},{path:"/tools",redirect:kt("/capabilities","tools")},{path:"/skills",redirect:kt("/capabilities","skills")},{path:"/mcp",redirect:kt("/capabilities","mcp-servers")},{path:"/knowledge",redirect:kt("/capabilities","knowledge")},{path:"/memory",redirect:kt("/capabilities","memory")},{path:"/learned",redirect:kt("/capabilities","learned")},{path:"/health",redirect:kt("/system","health")},{path:"/resources",redirect:kt("/system","resources")},{path:"/logs",redirect:kt("/system","logs")},{path:"/config",redirect:kt("/system","config")},{path:"/host-access",redirect:kt("/system","host-access")},{path:"/hosts",redirect:kt("/system","hosts")},{path:"/internals",redirect:kt("/system","internals")}],zi=Iw({history:rw(),routes:Tv});zi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const aT={template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=h(""),s=h(null),n=h(!1),a=h(!1);async function i(){n.value=!0,s.value=null;try{H.setPersist(a.value),await H.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{n.value=!1}}return{token:t,error:s,busy:n,persist:a,login:i}}},iT={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let o=null,r=null;const c=h(!1),d=h("disconnected"),u=h(-1),p=h(null);let f=null;const m=h("starting"),v=h(""),w=Tv.filter(U=>U.meta),L=G(()=>["Workspace","Operate","Observe","Manage"].map(U=>({name:U,routes:w.filter(Z=>Z.meta.section===U)})).filter(U=>U.routes.length)),y=G(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.label)||"Odin"}),g=G(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.section)||"Management"}),b=G(()=>{var U;return((U=zi.currentRoute.value.meta)==null?void 0:U.description)||"Management console"});function C(){Ye.disconnect(),V&&(clearInterval(V),V=null)}H.onSessionExpired=()=>{t.value=!0,C(),H.setToken(""),e.value="login"};function k(U){var Z;if((U.ctrlKey||U.metaKey)&&U.key.toLowerCase()==="k"){e.value==="ready"&&(U.preventDefault(),yp());return}if(n.value&&U.key==="Tab"){const W=[...((Z=a.value)==null?void 0:Z.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(W.length){const X=W[0],oe=W[W.length-1];if(U.shiftKey&&(document.activeElement===X||!a.value.contains(document.activeElement))){U.preventDefault(),oe.focus();return}if(!U.shiftKey&&(document.activeElement===oe||!a.value.contains(document.activeElement))){U.preventDefault(),X.focus();return}}}if(U.key==="Escape"&&n.value){n.value=!1,U.preventDefault();return}if(U.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(U.target.tagName)){U.preventDefault();const W=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');W&&W.focus()}}function O(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}je(async()=>{document.addEventListener("keydown",k),o=window.matchMedia("(max-width: 900px)"),O(),o.addEventListener("change",O);const U=await H.check();U.ok?(e.value="ready",S()):U.needsAuth?e.value="login":(e.value="ready",S())});function A(){t.value=!1,e.value="ready",S()}async function x(){C(),e.value="login",await H.logout()}function N(){s.value=!s.value}function $(){n.value=!n.value}Mt(n,async U=>{var Z,W;if(U)r=document.activeElement,await Rt(),(W=(Z=a.value)==null?void 0:Z.querySelector(".nav-item"))==null||W.focus();else if(r!=null&&r.isConnected){const X=r;r=null,requestAnimationFrame(()=>X.focus())}});const T=G(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(U,Z="info",W=3e3){p.value={text:U,level:Z},clearTimeout(f),f=setTimeout(()=>{p.value=null},W)}let V=null,J=!1,E=[];function S(){for(const U of E)U();E=[Ye.onStatus(U=>{c.value=U}),Ye.onLatencyChange(U=>{u.value=U}),Ye.onState((U,Z)=>{d.value=U,U==="connected"?(J&&P("Connection restored","success"),J=!0):U==="reconnecting"&&Z.attempt===1&&P("Connection lost — reconnecting…","warn")})],Ye.connect(),I(),V&&clearInterval(V),V=setInterval(I,15e3)}async function I(){try{const U=await H.get("/api/status");m.value=U.status==="online"?"online":"starting";const Z=U.uptime_seconds||0,W=Math.floor(Z/3600),X=Math.floor(Z%3600/60);v.value=`${W}h ${X}m uptime`}catch{m.value="offline",v.value=""}}return ft(()=>{V&&clearInterval(V);for(const U of E)U();E=[],Ye.disconnect(),document.removeEventListener("keydown",k),o==null||o.removeEventListener("change",O)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:T,wsToast:p,botStatus:m,botUptime:v,navRoutes:w,navGroups:L,currentPage:y,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:A,logout:x,toggleSidebar:N,toggleMobileNavigation:$,openPalette:yp}}},sa=po(iT);sa.component("odin-icon",PS);sa.component("login-screen",aT);sa.component("toast-container",w_);sa.component("confirm-host",k_);sa.component("command-palette",DS);sa.directive("modal-focus",FS);sa.use(zi);sa.mount("#app");
