...
`,0),r()),d||n("return "),e.codegenNode?Ss(e.codegenNode,s):n("null"),m&&(o(),n("}")),o(),n("}"),{ast:e,code:s.code,preamble:"",map:s.map?s.map.toJSON():void 0}}function yw(e,t){const{ssr:s,prefixIdentifiers:a,push:n,newline:i,runtimeModuleName:l,runtimeGlobalName:o,ssrRuntimeModuleName:r}=t,c=o,d=Array.from(e.helpers);if(d.length>0&&(n(`const _Vue = ${c}
`,-1),e.hoists.length)){const u=[ou,ru,ro,cu,hv].filter(p=>d.includes(p)).map(Pv).join(", ");n(`const { ${u} } = _Vue
`,-1)}xw(e.hoists,t),i(),n("return ")}function Ec(e,t,{helper:s,push:a,newline:n,isTS:i}){const l=s(t==="filter"?fu:t==="component"?du:pu);for(let o=0;o<e.length;o++){let r=e[o];const c=r.endsWith("__self");c&&(r=r.slice(0,-6)),a(`const ${Jl(r,t)} = ${l}(${JSON.stringify(r)}${c?", true":""})${i?"!":""}`),o<e.length-1&&n()}}function xw(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:a}=t;a();for(let n=0;n<e.length;n++){const i=e[n];i&&(s(`const _hoisted_${n+1} = `),Ss(i,t),a())}t.pure=!1}function Tu(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),uo(e,t,s),s&&t.deindent(),t.push("]")}function uo(e,t,s=!1,a=!0){const{push:n,newline:i}=t;for(let l=0;l<e.length;l++){const o=e[l];Ye(o)?n(o,-3):Ie(o)?Tu(o,t):Ss(o,t),l<e.length-1&&(s?(a&&n(","),i()):a&&n(", "))}}function Ss(e,t){if(Ye(e)){t.push(e,-3);return}if(Cs(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:Ss(e.codegenNode,t);break;case 2:_w(e,t);break;case 4:$v(e,t);break;case 5:ww(e,t);break;case 12:Ss(e.codegenNode,t);break;case 8:Fv(e,t);break;case 3:Sw(e,t);break;case 13:Cw(e,t);break;case 14:Ew(e,t);break;case 15:Aw(e,t);break;case 17:Rw(e,t);break;case 18:Iw(e,t);break;case 19:Ow(e,t);break;case 20:Lw(e,t);break;case 21:uo(e.body,t,!0,!1);break}}function _w(e,t){t.push(JSON.stringify(e.content),-3,e)}function $v(e,t){const{content:s,isStatic:a}=e;t.push(a?JSON.stringify(s):s,-3,e)}function ww(e,t){const{push:s,helper:a,pure:n}=t;n&&s(Jr),s(`${a(Gr)}(`),Ss(e.content,t),s(")")}function Fv(e,t){for(let s=0;s<e.children.length;s++){const a=e.children[s];Ye(a)?t.push(a,-3):Ss(a,t)}}function kw(e,t){const{push:s}=t;if(e.type===8)s("["),Fv(e,t),s("]");else if(e.isStatic){const a=ku(e.content)?e.content:JSON.stringify(e.content);s(a,-2,e)}else s(`[${e.content}]`,-3,e)}function Sw(e,t){const{push:s,helper:a,pure:n}=t;n&&s(Jr),s(`${a(ro)}(${JSON.stringify(e.content)})`,-3,e)}function Cw(e,t){const{push:s,helper:a,pure:n}=t,{tag:i,props:l,children:o,patchFlag:r,dynamicProps:c,directives:d,isBlock:u,disableTracking:p,isComponent:m}=e;let h;r&&(h=String(r)),d&&s(a(mu)+"("),u&&s(`(${a(Qn)}(${p?"true":""}), `),n&&s(Jr);const b=u?Gi(t.inSSR,m):qi(t.inSSR,m);s(a(b)+"(",-2,e),uo(Tw([i,l,o,h,c]),t),s(")"),u&&s(")"),d&&(s(", "),Ss(d,t),s(")"))}function Tw(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function Ew(e,t){const{push:s,helper:a,pure:n}=t,i=Ye(e.callee)?e.callee:a(e.callee);n&&s(Jr),s(i+"(",-2,e),uo(e.arguments,t),s(")")}function Aw(e,t){const{push:s,indent:a,deindent:n,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const o=l.length>1||!1;s(o?"{":"{ "),o&&a();for(let r=0;r<l.length;r++){const{key:c,value:d}=l[r];kw(c,t),s(": "),Ss(d,t),r<l.length-1&&(s(","),i())}o&&n(),s(o?"}":" }")}function Rw(e,t){Tu(e.elements,t)}function Iw(e,t){const{push:s,indent:a,deindent:n}=t,{params:i,returns:l,body:o,newline:r,isSlot:c}=e;c&&s(`_${ji[yu]}(`),s("(",-2,e),Ie(i)?uo(i,t):i&&Ss(i,t),s(") => "),(r||o)&&(s("{"),a()),l?(r&&s("return "),Ie(l)?Tu(l,t):Ss(l,t)):o&&Ss(o,t),(r||o)&&(n(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function Ow(e,t){const{test:s,consequent:a,alternate:n,newline:i}=e,{push:l,indent:o,deindent:r,newline:c}=t;if(s.type===4){const u=!ku(s.content);u&&l("("),$v(s,t),u&&l(")")}else l("("),Ss(s,t),l(")");i&&o(),t.indentLevel++,i||l(" "),l("? "),Ss(a,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const d=n.type===19;d||t.indentLevel++,Ss(n,t),d||t.indentLevel--,i&&r(!0)}function Lw(e,t){const{push:s,helper:a,indent:n,deindent:i,newline:l}=t,{needPauseTracking:o,needArraySpread:r}=e;r&&s("[...("),s(`_cache[${e.index}] || (`),o&&(n(),s(`${a(vr)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),Ss(e.value,t),o&&(s(`).cacheIndex = ${e.index},`),l(),s(`${a(vr)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),r&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const Nw=Dv(/^(?:if|else|else-if)$/,(e,t,s)=>Mw(e,t,s,(a,n,i)=>{const l=s.parent.children;let o=l.indexOf(a),r=0;for(;o-->=0;){const c=l[o];c&&c.type===9&&(r+=c.branches.length)}return()=>{if(i)a.codegenNode=Yp(n,r,s);else{const c=Dw(a.codegenNode);c.alternate=Yp(n,r+a.branches.length-1,s)}}}));function Mw(e,t,s,a){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const n=t.exp?t.exp.loc:e.loc;s.onError(Ot(28,t.loc)),t.exp=et("true",!1,n)}if(t.name==="if"){const n=Zp(e,t),i={type:9,loc:ow(e.loc),branches:[n]};if(s.replaceNode(i),a)return a(i,n,!0)}else{const n=s.parent.children;let i=n.indexOf(e);for(;i-->=-1;){const l=n[i];if(l&&Tv(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(Ot(30,e.loc)),s.removeNode();const o=Zp(e,t);l.branches.push(o);const r=a&&a(l,o,!1);Kr(o,s),r&&r(),s.currentNode=null}else s.onError(Ot(30,e.loc));break}}}function Zp(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!sa(e,"for")?e.children:[e],userKey:Wr(e,"key"),isTemplateIf:s}}function Yp(e,t,s){return e.condition?ud(e.condition,Qp(e,t,s),ss(s.helper(ro),['""',"true"])):Qp(e,t,s)}function Qp(e,t,s){const{helper:a}=s,n=qt("key",et(`${t}`,!1,Qs,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const r=l.codegenNode;return xr(r,n,s),r}else return Wl(s,a(ql),aa([n]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const r=l.codegenNode,c=Y_(r);return c.type===13&&_u(c,s),xr(c,n,s),r}}function Dw(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const Pw=Dv("for",(e,t,s)=>{const{helper:a,removeHelper:n}=s;return $w(e,t,s,i=>{const l=ss(a(hu),[i.source]),o=br(e),r=sa(e,"memo"),c=Wr(e,"key",!1,!0);c&&c.type;let d=c&&(c.type===6?c.value?et(c.value.content,!0):void 0:c.exp);const u=d?qt("key",d):null,p=i.source.type===4&&i.source.constType>0,m=p?64:c?128:256;return i.codegenNode=Wl(s,a(ql),void 0,l,m,void 0,void 0,!0,!p,!1,e.loc),()=>{let h;const{children:b}=i,I=b.length!==1||b[0].type!==1,k=yr(e)?e:o&&e.children.length===1&&yr(e.children[0])?e.children[0]:null;if(k?(h=k.codegenNode,o&&u&&xr(h,u,s)):I?h=Wl(s,a(ql),u?aa([u]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(h=b[0].codegenNode,o&&u&&xr(h,u,s),h.isBlock!==!p&&(h.isBlock?(n(Qn),n(Gi(s.inSSR,h.isComponent))):n(qi(s.inSSR,h.isComponent))),h.isBlock=!p,h.isBlock?(a(Qn),a(Gi(s.inSSR,h.isComponent))):a(qi(s.inSSR,h.isComponent))),r){const y=Vi(md(i.parseResult,[et("_cached")]));y.body=B_([ha(["const _memo = (",r.exp,")"]),ha(["if (_cached && _cached.el",...d?[" && _cached.key === ",d]:[],` && ${s.helperString(bv)}(_cached, _memo)) return _cached`]),ha(["const _item = ",h]),et("_item.memo = _memo"),et("return _item")]),l.arguments.push(y,et("_cache"),et(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(Vi(md(i.parseResult),h,!0))}})});function $w(e,t,s,a){if(!t.exp){s.onError(Ot(31,t.loc));return}const n=t.forParseResult;if(!n){s.onError(Ot(32,t.loc));return}Bv(n);const{addIdentifiers:i,removeIdentifiers:l,scopes:o}=s,{source:r,value:c,key:d,index:u}=n,p={type:11,loc:t.loc,source:r,valueAlias:c,keyAlias:d,objectIndexAlias:u,parseResult:n,children:br(e)?e.children:[e]};s.replaceNode(p),o.vFor++;const m=a&&a(p);return()=>{o.vFor--,m&&m()}}function Bv(e,t){e.finalized||(e.finalized=!0)}function md({value:e,key:t,index:s},a=[]){return Fw([e,t,s,...a])}function Fw(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,a)=>s||et("_".repeat(a+1),!1))}const Xp=et("undefined",!1),Bw=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=sa(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},Uw=(e,t,s,a)=>Vi(e,s,!1,!0,s.length?s[0].loc:a);function zw(e,t,s=Uw){t.helper(yu);const{children:a,loc:n}=e,i=[],l=[];let o=t.scopes.vSlot>0||t.scopes.vFor>0;const r=sa(e,"slot",!0);if(r){const{arg:I,exp:k}=r;I&&!zs(I)&&(o=!0),i.push(qt(I||et("default",!0),s(k,void 0,a,n)))}let c=!1,d=!1;const u=[],p=new Set;let m=0;for(let I=0;I<a.length;I++){const k=a[I];let y;if(!br(k)||!(y=sa(k,"slot",!0))){k.type!==3&&u.push(k);continue}if(r){t.onError(Ot(37,y.loc));break}c=!0;const{children:g,loc:x}=k,{arg:S=et("default",!0),exp:_,loc:E}=y;let R;zs(S)?R=S?S.content:"default":o=!0;const w=sa(k,"for"),O=s(_,w,g,x);let U,T;if(U=sa(k,"if"))o=!0,l.push(ud(U.exp,Ro(S,O,m++),Xp));else if(T=sa(k,/^else(?:-if)?$/,!0)){let $=I,Y;for(;$--&&(Y=a[$],!!Tv(Y)););if(Y&&br(Y)&&sa(Y,/^(?:else-)?if$/)){let W=l[l.length-1];for(;W.alternate.type===19;)W=W.alternate;W.alternate=T.exp?ud(T.exp,Ro(S,O,m++),Xp):Ro(S,O,m++)}else t.onError(Ot(30,T.loc))}else if(w){o=!0;const $=w.forParseResult;$?(Bv($),l.push(ss(t.helper(hu),[$.source,Vi(md($),Ro(S,O),!0)]))):t.onError(Ot(32,w.loc))}else{if(R){if(p.has(R)){t.onError(Ot(38,E));continue}p.add(R),R==="default"&&(d=!0)}i.push(qt(S,O))}}if(!r){const I=(k,y)=>{const g=s(k,void 0,y,n);return t.compatConfig&&(g.isNonScopedSlot=!0),qt("default",g)};c?u.length&&!u.every(Su)&&(d?t.onError(Ot(39,u[0].loc)):i.push(I(void 0,u))):i.push(I(void 0,a))}const h=o?2:Wo(e.children)?3:1;let b=aa(i.concat(qt("_",et(h+"",!1))),n);return l.length&&(b=ss(t.helper(gv),[b,Kn(l)])),{slots:b,hasDynamicSlots:o}}function Ro(e,t,s){const a=[qt("name",e),qt("fn",t)];return s!=null&&a.push(qt("key",et(String(s),!0))),aa(a)}function Wo(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||Wo(s.children))return!0;break;case 9:if(Wo(s.branches))return!0;break;case 10:case 11:if(Wo(s.children))return!0;break}}return!1}const Uv=new WeakMap,Hw=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:a,props:n}=e,i=e.tagType===1;let l=i?jw(e,t):`"${a}"`;const o=mt(l)&&l.callee===uu;let r,c,d=0,u,p,m,h=o||l===Il||l===lu||!i&&(a==="svg"||a==="foreignObject"||a==="math");if(n.length>0){const b=zv(e,t,void 0,i,o);r=b.props,d=b.patchFlag,p=b.dynamicPropNames;const I=b.directives;m=I&&I.length?Kn(I.map(k=>qw(k,t))):void 0,b.shouldUseBlock&&(h=!0)}if(e.children.length>0)if(l===mr&&(h=!0,d|=1024),i&&l!==Il&&l!==mr){const{slots:I,hasDynamicSlots:k}=zw(e,t);c=I,k&&(d|=1024)}else if(e.children.length===1&&l!==Il){const I=e.children[0],k=I.type,y=k===5||k===8;y&&Js(I,t)===0&&(d|=1),y||k===2?c=I:c=e.children}else c=e.children;p&&p.length&&(u=Gw(p)),e.codegenNode=Wl(t,l,r,c,d===0?void 0:d,u,m,!!h,!1,i,e.loc)};function jw(e,t,s=!1){let{tag:a}=e;const n=hd(a),i=Wr(e,"is",!1,!0);if(i)if(n||Jn("COMPILER_IS_ON_ELEMENT",t)){let o;if(i.type===6?o=i.value&&et(i.value.content,!0):(o=i.exp,o||(o=et("is",!1,i.arg.loc))),o)return ss(t.helper(uu),[o])}else i.type===6&&i.value.content.startsWith("vue:")&&(a=i.value.content.slice(4));const l=xv(a)||t.isBuiltInComponent(a);return l?(s||t.helper(l),l):(t.helper(du),t.components.add(a),Jl(a,"component"))}function zv(e,t,s=e.props,a,n,i=!1){const{tag:l,loc:o,children:r}=e;let c=[];const d=[],u=[],p=r.length>0;let m=!1,h=0,b=!1,I=!1,k=!1,y=!1,g=!1,x=!1;const S=[],_=O=>{c.length&&(d.push(aa(ef(c),o)),c=[]),O&&d.push(O)},E=()=>{t.scopes.vFor>0&&c.push(qt(et("ref_for",!0),et("true")))},R=({key:O,value:U})=>{if(zs(O)){const T=O.content,$=ei(T);if($&&(!a||n)&&T.toLowerCase()!=="onclick"&&T!=="onUpdate:modelValue"&&!Za(T)&&(y=!0),$&&Za(T)&&(x=!0),$&&U.type===14&&(U=U.arguments[0]),U.type===20||(U.type===4||U.type===8)&&Js(U,t)>0)return;T==="ref"?b=!0:T==="class"?I=!0:T==="style"?k=!0:T!=="key"&&!S.includes(T)&&S.push(T),a&&(T==="class"||T==="style")&&!S.includes(T)&&S.push(T)}else g=!0};for(let O=0;O<s.length;O++){const U=s[O];if(U.type===6){const{loc:T,name:$,nameLoc:Y,value:W}=U;let M=!0;if($==="ref"&&(b=!0,E()),$==="is"&&(hd(l)||W&&W.content.startsWith("vue:")||Jn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(qt(et($,!0,Y),et(W?W.content:"",M,W?W.loc:T)))}else{const{name:T,arg:$,exp:Y,loc:W,modifiers:M}=U,L=T==="bind",P=T==="on";if(T==="slot"){a||t.onError(Ot(40,W));continue}if(T==="once"||T==="memo"||T==="is"||L&&Hn($,"is")&&(hd(l)||Jn("COMPILER_IS_ON_ELEMENT",t))||P&&i)continue;if((L&&Hn($,"key")||P&&p&&Hn($,"vue:before-update"))&&(m=!0),L&&Hn($,"ref")&&E(),!$&&(L||P)){if(g=!0,Y)if(L){if(_(),Jn("COMPILER_V_BIND_OBJECT_ORDER",t)){d.unshift(Y);continue}E(),_(),d.push(Y)}else _({type:14,loc:W,callee:t.helper(bu),arguments:a?[Y]:[Y,"true"]});else t.onError(Ot(L?34:35,W));continue}L&&M.some(ce=>ce.content==="prop")&&(h|=32);const re=t.directiveTransforms[T];if(re){const{props:ce,needRuntime:z}=re(U,e,t);!i&&ce.forEach(R),P&&$&&!zs($)?_(aa(ce,o)):c.push(...ce),z&&(u.push(U),Cs(z)&&Uv.set(U,z))}else Pb(T)||(u.push(U),p&&(m=!0))}}let w;if(d.length?(_(),d.length>1?w=ss(t.helper(hr),d,o):w=d[0]):c.length&&(w=aa(ef(c),o)),g?h|=16:(I&&!a&&(h|=2),k&&!a&&(h|=4),S.length&&(h|=8),y&&(h|=32)),!m&&(h===0||h===32)&&(b||x||u.length>0)&&(h|=512),!t.inSSR&&w)switch(w.type){case 15:let O=-1,U=-1,T=!1;for(let W=0;W<w.properties.length;W++){const M=w.properties[W].key;zs(M)?M.content==="class"?O=W:M.content==="style"&&(U=W):M.isHandlerKey||(T=!0)}const $=w.properties[O],Y=w.properties[U];T?w=ss(t.helper(Gl),[w]):($&&!zs($.value)&&($.value=ss(t.helper(vu),[$.value])),Y&&(k||Y.value.type===4&&Y.value.content.trim()[0]==="["||Y.value.type===17)&&(Y.value=ss(t.helper(gu),[Y.value])));break;case 14:break;default:w=ss(t.helper(Gl),[ss(t.helper(co),[w])]);break}return{props:w,directives:u,patchFlag:h,dynamicPropNames:S,shouldUseBlock:m}}function ef(e){const t=new Map,s=[];for(let a=0;a<e.length;a++){const n=e[a];if(n.key.type===8||!n.key.isStatic){s.push(n);continue}const i=n.key.content,l=t.get(i);l?(i==="style"||i==="class"||ei(i))&&Vw(l,n):(t.set(i,n),s.push(n))}return s}function Vw(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Kn([e.value,t.value],e.loc)}function qw(e,t){const s=[],a=Uv.get(e);a?s.push(t.helperString(a)):(t.helper(pu),t.directives.add(e.name),s.push(Jl(e.name,"directive")));const{loc:n}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=et("true",!1,n);s.push(aa(e.modifiers.map(l=>qt(l,i)),n))}return Kn(s,e.loc)}function Gw(e){let t="[";for(let s=0,a=e.length;s<a;s++)t+=JSON.stringify(e[s]),s<a-1&&(t+=", ");return t+"]"}function hd(e){return e==="component"||e==="Component"}const Ww=(e,t)=>{if(yr(e)){const{children:s,loc:a}=e,{slotName:n,slotProps:i}=Kw(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",n,"{}","undefined","true"];let o=2;i&&(l[2]=i,o=3),s.length&&(l[3]=Vi([],s,!1,!1,a),o=4),t.scopeId&&!t.slotted&&(o=5),l.splice(o),e.codegenNode=ss(t.helper(vv),l,a)}};function Kw(e,t){let s='"default"',a;const n=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=wt(l.name),n.push(l)));else if(l.name==="bind"&&Hn(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const o=wt(l.arg.content);s=l.exp=et(o,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&zs(l.arg)&&(l.arg.content=wt(l.arg.content)),n.push(l)}if(n.length>0){const{props:i,directives:l}=zv(e,t,n,!1,!1);a=i,l.length&&t.onError(Ot(36,l[0].loc))}return{slotName:s,slotProps:a}}const Hv=(e,t,s,a)=>{const{loc:n,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(Ot(35,n));let o;if(l.type===4)if(l.isStatic){let u=l.content;u.startsWith("vue:")&&(u=`vnode-${u.slice(4)}`);const p=t.tagType!==0||u.startsWith("vnode")||!/[A-Z]/.test(u)?Ii(wt(u)):`on:${u}`;o=et(p,!0,l.loc)}else o=ha([`${s.helperString(dd)}(`,l,")"]);else o=l,o.children.unshift(`${s.helperString(dd)}(`),o.children.push(")");let r=e.exp;r&&!r.content.trim()&&(r=void 0);let c=s.cacheHandlers&&!r&&!s.inVOnce;if(r){const u=kv(r),p=!(u||W_(r)),m=r.content.includes(";");(p||c&&u)&&(r=ha([`${p?"$event":"(...args)"} => ${m?"{":"("}`,r,m?"}":")"]))}let d={props:[qt(o,r||et("() => {}",!1,n))]};return a&&(d=a(d)),c&&(d.props[0].value=s.cache(d.props[0].value)),d.props.forEach(u=>u.key.isHandlerKey=!0),d},Jw=(e,t,s)=>{const{modifiers:a,loc:n}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),a.some(o=>o.content==="camel")&&(i.type===4?i.isStatic?i.content=wt(i.content):i.content=`${s.helperString(cd)}(${i.content})`:(i.children.unshift(`${s.helperString(cd)}(`),i.children.push(")"))),s.inSSR||(a.some(o=>o.content==="prop")&&tf(i,"."),a.some(o=>o.content==="attr")&&tf(i,"^")),{props:[qt(i,l)]}},tf=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},Zw=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let a,n=!1;for(let i=0;i<s.length;i++){const l=s[i];if(Tc(l)){n=!0;for(let o=i+1;o<s.length;o++){const r=s[o];if(Tc(r))a||(a=s[i]=ha([l],l.loc)),a.children.push(" + ",r),s.splice(o,1),o--;else{a=void 0;break}}}}if(!(!n||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(Tc(l)||l.type===8){const o=[];(l.type!==2||l.content!==" ")&&o.push(l),!t.ssr&&Js(l,t)===0&&o.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:ss(t.helper(cu),o)}}}}},sf=new WeakSet,Yw=(e,t)=>{if(e.type===1&&sa(e,"once",!0))return sf.has(e)||t.inVOnce||t.inSSR?void 0:(sf.add(e),t.inVOnce=!0,t.helper(vr),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},jv=(e,t,s)=>{const{exp:a,arg:n}=e;if(!a)return s.onError(Ot(41,e.loc)),pl();const i=a.loc.source.trim(),l=a.type===4?a.content:i,o=s.bindingMetadata[i];if(o==="props"||o==="props-aliased")return s.onError(Ot(44,a.loc)),pl();if(o==="literal-const"||o==="setup-const")return s.onError(Ot(45,a.loc)),pl();if(!l.trim()||!kv(a))return s.onError(Ot(42,a.loc)),pl();const r=n||et("modelValue",!0),c=n?zs(n)?`onUpdate:${wt(n.content)}`:ha(['"onUpdate:" + ',n]):"onUpdate:modelValue";let d;const u=s.isTS?"($event: any)":"$event";d=ha([`${u} => ((`,a,") = $event)"]);const p=[qt(r,e.exp),qt(c,d)];if(e.modifiers.length&&t.tagType===1){const m=e.modifiers.map(b=>b.content).map(b=>(ku(b)?b:JSON.stringify(b))+": true").join(", "),h=n?zs(n)?`${n.content}Modifiers`:ha([n,' + "Modifiers"']):"modelModifiers";p.push(qt(h,et(`{ ${m} }`,!1,e.loc,2)))}return pl(p)};function pl(e=[]){return{props:e}}const Qw=/[\w).+\-_$\]]/,Xw=(e,t)=>{Jn("COMPILER_FILTERS",t)&&(e.type===5?_r(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&_r(s.exp,t)}))};function _r(e,t){if(e.type===4)af(e,t);else for(let s=0;s<e.children.length;s++){const a=e.children[s];typeof a=="object"&&(a.type===4?af(a,t):a.type===8?_r(e,t):a.type===5&&_r(a.content,t))}}function af(e,t){const s=e.content;let a=!1,n=!1,i=!1,l=!1,o=0,r=0,c=0,d=0,u,p,m,h,b=[];for(m=0;m<s.length;m++)if(p=u,u=s.charCodeAt(m),a)u===39&&p!==92&&(a=!1);else if(n)u===34&&p!==92&&(n=!1);else if(i)u===96&&p!==92&&(i=!1);else if(l)u===47&&p!==92&&(l=!1);else if(u===124&&s.charCodeAt(m+1)!==124&&s.charCodeAt(m-1)!==124&&!o&&!r&&!c)h===void 0?(d=m+1,h=s.slice(0,m).trim()):I();else{switch(u){case 34:n=!0;break;case 39:a=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:r++;break;case 93:r--;break;case 123:o++;break;case 125:o--;break}if(u===47){let k=m-1,y;for(;k>=0&&(y=s.charAt(k),y===" ");k--);(!y||!Qw.test(y))&&(l=!0)}}h===void 0?h=s.slice(0,m).trim():d!==0&&I();function I(){b.push(s.slice(d,m).trim()),d=m+1}if(b.length){for(m=0;m<b.length;m++)h=ek(h,b[m],t);e.content=h,e.ast=void 0}}function ek(e,t,s){s.helper(fu);const a=t.indexOf("(");if(a<0)return s.filters.add(t),`${Jl(t,"filter")}(${e})`;{const n=t.slice(0,a),i=t.slice(a+1);return s.filters.add(n),`${Jl(n,"filter")}(${e}${i!==")"?","+i:i}`}}const nf=new WeakSet,tk=(e,t)=>{if(e.type===1){const s=sa(e,"memo");return!s||nf.has(e)||t.inSSR?void 0:(nf.add(e),()=>{const a=e.codegenNode||t.currentNode.codegenNode;a&&a.type===13&&(e.tagType!==1&&_u(a,t),e.codegenNode=ss(t.helper(xu),[s.exp,Vi(void 0,a),"_cache",String(t.cached.length)]),t.cached.push(null))})}},sk=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const a=s.arg;if(a.type!==4||!a.isStatic)t.onError(Ot(53,a.loc)),s.exp=et("",!0,a.loc);else{const n=wt(a.content);(_v.test(n[0])||n[0]==="-")&&(s.exp=et(n,!1,a.loc))}}}};function ak(e){return[[sk,Yw,Nw,tk,Pw,Xw,Ww,Hw,Bw,Zw],{on:Hv,bind:Jw,model:jv}]}function nk(e,t={}){const s=t.onError||wu,a=t.mode==="module";t.prefixIdentifiers===!0?s(Ot(48)):a&&s(Ot(49));const n=!1;t.cacheHandlers&&s(Ot(50)),t.scopeId&&!a&&s(Ot(51));const i=nt({},t,{prefixIdentifiers:n}),l=Ye(e)?dw(e,i):e,[o,r]=ak();return mw(l,nt({},i,{nodeTransforms:[...o,...t.nodeTransforms||[]],directiveTransforms:nt({},r,t.directiveTransforms||{})})),bw(l,i)}const ik=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Vv=Symbol(""),qv=Symbol(""),Gv=Symbol(""),Wv=Symbol(""),vd=Symbol(""),Kv=Symbol(""),Jv=Symbol(""),Zv=Symbol(""),Yv=Symbol(""),Qv=Symbol("");P_({[Vv]:"vModelRadio",[qv]:"vModelCheckbox",[Gv]:"vModelText",[Wv]:"vModelSelect",[vd]:"vModelDynamic",[Kv]:"withModifiers",[Jv]:"withKeys",[Zv]:"vShow",[Yv]:"Transition",[Qv]:"TransitionGroup"});let gi;function lk(e,t=!1){return gi||(gi=document.createElement("div")),t?(gi.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,gi.children[0].getAttribute("foo")):(gi.innerHTML=e,gi.textContent)}const ok={parseMode:"html",isVoidTag:Xb,isNativeTag:e=>Zb(e)||Yb(e)||Qb(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:lk,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return Yv;if(e==="TransitionGroup"||e==="transition-group")return Qv},getNamespace(e,t,s){let a=t?t.ns:s;if(t&&a===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(n=>n.type===6&&n.name==="encoding"&&n.value!=null&&(n.value.content==="text/html"||n.value.content==="application/xhtml+xml"))&&(a=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(a=0);else t&&a===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(a=0);if(a===0){if(e==="svg")return 1;if(e==="math")return 2}return a}},rk=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:et("style",!0,t.loc),exp:ck(t.value.content,t.loc),modifiers:[],loc:t.loc})})},ck=(e,t)=>{const s=um(e);return et(JSON.stringify(s),!1,t,3)};function Sn(e,t){return Ot(e,t)}const dk=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(Sn(54,n)),t.children.length&&(s.onError(Sn(55,n)),t.children.length=0),{props:[qt(et("innerHTML",!0,n),a||et("",!0))]}},uk=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(Sn(56,n)),t.children.length&&(s.onError(Sn(57,n)),t.children.length=0),{props:[qt(et("textContent",!0),a?Js(a,s)>0?a:ss(s.helperString(Gr),[a],n):et("",!0))]}},pk=(e,t,s)=>{const a=jv(e,t,s);if(!a.props.length||t.tagType===1)return a;e.arg&&s.onError(Sn(59,e.arg.loc));const{tag:n}=t,i=s.isCustomElement(n);if(n==="input"||n==="textarea"||n==="select"||i){let l=Gv,o=!1;if(n==="input"||i){const r=Wr(t,"type");if(r){if(r.type===7)l=vd;else if(r.value)switch(r.value.content){case"radio":l=Vv;break;case"checkbox":l=qv;break;case"file":o=!0,s.onError(Sn(60,e.loc));break}}else K_(t)&&(l=vd)}else n==="select"&&(l=Wv);o||(a.needRuntime=s.helper(l))}else s.onError(Sn(58,e.loc));return a.props=a.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),a},fk=Ys("passive,once,capture"),mk=Ys("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),hk=Ys("left,right"),Xv=Ys("onkeyup,onkeydown,onkeypress"),vk=(e,t,s,a)=>{const n=[],i=[],l=[];for(let o=0;o<t.length;o++){const r=t[o].content;r==="native"&&Kl("COMPILER_V_ON_NATIVE",s)||fk(r)?l.push(r):hk(r)?zs(e)?Xv(e.content.toLowerCase())?n.push(r):i.push(r):(n.push(r),i.push(r)):mk(r)?i.push(r):n.push(r)}return{keyModifiers:n,nonKeyModifiers:i,eventOptionModifiers:l}},lf=(e,t)=>zs(e)&&e.content.toLowerCase()==="onclick"?et(t,!0):e.type!==4?ha(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,gk=(e,t,s)=>Hv(e,t,s,a=>{const{modifiers:n}=e;if(!n.length)return a;let{key:i,value:l}=a.props[0];const{keyModifiers:o,nonKeyModifiers:r,eventOptionModifiers:c}=vk(i,n,s,e.loc);if(r.includes("right")&&(i=lf(i,"onContextmenu")),r.includes("middle")&&(i=lf(i,"onMouseup")),r.length&&(l=ss(s.helper(Kv),[l,JSON.stringify(r)])),o.length&&(!zs(i)||Xv(i.content.toLowerCase()))&&(l=ss(s.helper(Jv),[l,JSON.stringify(o)])),c.length){const d=c.map(si).join("");i=zs(i)?et(`${i.content}${d}`,!0):ha(["(",i,`) + "${d}"`])}return{props:[qt(i,l)]}}),bk=(e,t,s)=>{const{exp:a,loc:n}=e;return a||s.onError(Sn(62,n)),{props:[],needRuntime:s.helper(Zv)}},yk=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},xk=[rk],_k={cloak:ik,html:dk,text:uk,model:pk,on:gk,show:bk};function wk(e,t={}){return nk(e,nt({},ok,t,{nodeTransforms:[yk,...xk,...t.nodeTransforms||[]],directiveTransforms:nt({},_k,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const of=Object.create(null);function kk(e,t){if(!Ye(e))if(e.nodeType)e=e.innerHTML;else return hs;const s=Bb(e,t),a=of[s];if(a)return a;if(e[0]==="#"){const o=document.querySelector(e);e=o?o.innerHTML:""}const n=nt({hoistStatic:!0,onError:void 0,onWarn:hs},t);!n.isCustomElement&&typeof customElements<"u"&&(n.isCustomElement=o=>!!customElements.get(o));const{code:i}=wk(e,n),l=new Function("Vue",i)(I_);return l._rc=!0,of[s]=l}Ph(kk);const wr=Tn({items:[]});let Sk=1;function Zr(e,t="info",s=3e3){const a=Sk++;return wr.items.push({id:a,message:String(e),type:t}),s>0&&setTimeout(()=>Eu(a),s),a}function Eu(e){const t=wr.items.findIndex(s=>s.id===e);t>=0&&wr.items.splice(t,1)}function Te(e,t="info",s=3e3){return Zr(e,t,s)}Te.success=(e,t=3e3)=>Zr(e,"success",t);Te.error=(e,t=5e3)=>Zr(e,"error",t);Te.info=(e,t=3e3)=>Zr(e,"info",t);Te.dismiss=Eu;const Ck={setup(){return{state:wr,dismiss:Eu}},template:`
...
... (truncated)`:s}function Tf(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Nu(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function gg(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const bg=Symbol("agent-detail-cancelled"),WS=15e3;function KS(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:a,cancelTimeout:n}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((m,h)=>{r=m,c=h});function u(m,h){o||(o=!0,l!==null&&n(l),l=null,(m?r:c)(h))}let p;try{p=e(i==null?void 0:i.signal)}catch(m){u(!1,m)}return o||Promise.resolve(p).then(m=>u(!0,m),m=>u(!1,m)),!o&&Number.isFinite(t)&&t>0&&(l=a(()=>{const m=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${m}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,bg),i==null||i.abort()}}}function yg({state:e,requestDetail:t,timeoutMs:s=WS,detailLabel:a="Agent detail",scheduleTimeout:n=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:m,coalesce:h}){if(!p)return Promise.resolve();if(h&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const b={agentId:p,cancel:null,promise:null};l=b,m?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const I=KS(k=>t(p,{signal:k}),{timeoutMs:s,timeoutLabel:a,scheduleTimeout:n,cancelTimeout:i});return b.cancel=I.cancel,b.promise=(async()=>{let k=null,y=null;try{k=await I.promise}catch(g){y=g}k!==bg&&(l!==b||e.detailId!==p||(l=null,!y&&(k===null||typeof k!="object")&&(y=new Error(`${a} response was empty or invalid`)),y?e.detail===null&&(e.detailError=(y==null?void 0:y.message)||`Failed to load ${a.toLowerCase()}`):(e.detail=k,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function JS({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:a,intervalMs:n=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&a())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,n))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const ZS={components:{ToolOutput:ec},template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(!0),i=f("all");let l=!1;const o=H(()=>e.value.filter(P=>P.status==="running").length),r=H(()=>e.value.filter(P=>P.status==="completed").length),c=H(()=>e.value.filter(P=>["failed","timeout","killed"].includes(P.status)).length),d=H(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=H(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(P=>["failed","timeout","killed"].includes(P.status)):e.value.filter(P=>P.status===i.value));function p(P){const re=Number(P.max_iterations)||0;return re<=0?0:Math.min(100,Math.round(P.iteration_count/re*100))}function m(P){return(Number(P.max_iterations)||0)>0}function h(P,re){return P?P==="N/A"?"N/A":re==="current_inheritance"?`inherit (currently ${P})`:P:"unknown"}function b(P){return h(P.display_model,P.display_model_source||P.display_source)}function I(P){return h(P.display_reasoning_effort,P.display_reasoning_effort_source||P.display_source)}function k(P){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[P]||""}const y=f(null),g=f(null),x=f(!1),S=f(null),_=f(""),R=yg({state:{get detail(){return y.value},set detail(P){y.value=P},get detailId(){return g.value},set detailId(P){g.value=P},get detailLoading(){return x.value},set detailLoading(P){x.value=P},get detailError(){return S.value},set detailError(P){S.value=P}},requestDetail:(P,{signal:re})=>j.get(`/api/agents/${encodeURIComponent(P)}`,{signal:re})});async function w(P){_.value="",await R.open(P.id)}function O(){R.close(),_.value=""}async function U(){await R.refresh()}async function T(P,re){try{await navigator.clipboard.writeText(re||""),_.value=P,setTimeout(()=>{_.value===P&&(_.value="")},1500)}catch{Te.error("Copy failed")}}async function $(P=!1){P=P===!0,P||(t.value=!0);try{const re=await j.get("/api/agents");e.value=Array.isArray(re)?re:[],s.value=null}catch(re){P||(s.value=re.message)}P||(t.value=!1)}async function Y(P){const re=e.value.find(z=>z.id===P);if(await os({title:"Kill agent",message:`Kill agent "${(re==null?void 0:re.label)||P}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){a.value=P;try{await j.del(`/api/agents/${encodeURIComponent(P)}`),Te.success("Agent killed"),await $()}catch(z){Te.error(z.message||"Failed to kill agent")}a.value=null}}const W=JS({isEnabled:()=>n.value&&l,refreshList:()=>$(!0),hasOpenDetail:()=>!!g.value,refreshDetail:U});function M(){W.start()}function L(){W.stop()}return Wt(n,()=>W.sync()),st(()=>{l=!0,$(),M()}),rs(()=>{l=!0,$(!0),M()}),Kt(()=>{l=!1,L()}),xt(()=>{l=!1,L(),R.close()}),{agents:e,loading:t,error:s,killing:a,autoRefresh:n,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ni,formatDuration:Ji,progressPercent:p,hasProgress:m,displayModelText:b,displayEffortText:I,displaySourceLabel:k,detail:y,detailId:g,detailLoading:x,detailError:S,copied:_,openDetail:w,closeDetail:O,copyText:T,fetchAgents:$,killAgent:Y,startAutoRefresh:M,stopAutoRefresh:L}}},YS={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(!1),n=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),m=f("");let h=!1;const I=yg({state:{get detail(){return c.value},set detail(L){c.value=L},get detailId(){return d.value},set detailId(L){d.value=L},get detailLoading(){return u.value},set detailLoading(L){u.value=L},get detailError(){return p.value},set detailError(L){p.value=L}},detailLabel:"Loop detail",requestDetail:(L,{signal:P})=>j.get(`/api/loops/${encodeURIComponent(L)}?limit=100`,{signal:P})});async function k(L){m.value="",await I.open(L.id)}function y(){I.close(),m.value=""}async function g(L,P){try{await navigator.clipboard.writeText(P||""),m.value=L,setTimeout(()=>{m.value===L&&(m.value="")},1500)}catch{Te.error("Copy failed")}}const x=H(()=>e.value.reduce((L,P)=>L+(P.iteration_count||0),0)),S=H(()=>e.value.filter(L=>L.status==="running").length);function _(L){return L==="running"?"loop-status-running":L==="error"?"loop-status-error":"loop-status-stopped"}function E(L){return L==="running"?"badge-success":L==="error"?"badge-danger":L==="completed"?"badge-info":"badge-warning"}function R(L){return L==="act"?"badge-warning":L==="silent"?"badge-info":"badge-success"}async function w(L=!1){L=L===!0,L||(t.value=!0);try{const P=await j.get("/api/loops");e.value=Array.isArray(P)?P:[],s.value=null}catch(P){L||(s.value=P.message)}L||(t.value=!1)}async function O(){l.value=null;const L=n.value;if(!L.goal.trim()){l.value="Goal is required";return}if(!L.channel_id.trim()){l.value="Channel ID is required";return}const P={goal:L.goal.trim(),channel_id:L.channel_id.trim(),interval_seconds:L.interval_seconds||60,mode:L.mode,max_iterations:L.max_iterations||50};L.stop_condition.trim()&&(P.stop_condition=L.stop_condition.trim()),i.value=!0;try{const re=await j.post("/api/loops",P);Te.success(`Loop started: ${re.loop_id}`),n.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},a.value=!1,await w()}catch(re){l.value=re.message}i.value=!1}async function U(L){if(await os({title:"Stop loop",message:`Stop loop ${L}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=L;try{await j.del(`/api/loops/${encodeURIComponent(L)}`),Te.success("Loop stopped"),await w()}catch(re){Te.error(re.message||"Failed to stop loop")}o.value=null}}async function T(L){r.value=L;try{await j.post(`/api/loops/${encodeURIComponent(L)}/restart`),Te.success("Loop restarted"),await w()}catch(P){Te.error(P.message||"Failed to restart loop")}r.value=null}function $(L){h&&L.payload&&(L.payload.loop_id||L.payload.type==="loop")&&(w(!0),d.value&&I.refresh())}let Y=null;function W(){Y!==null&&clearInterval(Y),Y=null}function M(){W(),h&&(Y=setInterval(()=>{w(!0),d.value&&I.refresh()},5e3))}return st(()=>{h=!0,w(),ut.subscribe("events",$),M()}),rs(()=>{h=!0,w(!0),M()}),Kt(()=>{h=!1,W()}),xt(()=>{h=!1,ut.unsubscribe("events",$),W(),I.close()}),{loops:e,loading:t,error:s,showCreate:a,form:n,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:m,totalIterations:x,runningCount:S,statusDotClass:_,statusBadge:E,modeBadge:R,formatAge:hg,formatDuration:Ji,formatTs:ni,formatTokens:gg,openDetail:k,closeDetail:y,copyText:g,fetchLoops:w,doCreate:O,doStop:U,doRestart:T}}},QS={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(Ko(null)),n=H(()=>a.value.available),i=H(()=>Oo(a.value));let l=null;const o=f(!1),r=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""}),c=f(!1),d=f(null),u=H(()=>Rf(a.value,r.value.action));function p(B){return Rf(a.value,B)}const m=f(null),h=H(()=>s1(r.value.run_at));Wt(()=>r.value.run_at,()=>{m.value=null});const b=H(()=>{var Z;const B=h.value;return B.state==="ok"?B.instant:B.state==="ambiguous"&&m.value!==null&&((Z=B.options[m.value])==null?void 0:Z.instant)||null}),I=H(()=>{const B=b.value;return B?`${B.toLocaleString()} local — ${B.toISOString()} UTC`:""}),k=f(null),y=f(!1),g=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],x=f(null),S=f(null),_=f(null),E=f(null),R=f(null),w=f(null),O=f([]),U=f(!1),T=f("");let $=0;const Y=H(()=>e.value.filter(B=>B.cron&&!B.one_time).length),W=H(()=>e.value.filter(B=>B.one_time).length),M=H(()=>e.value.filter(B=>B.trigger).length),L=H(()=>e.value.filter(B=>B.paused).length),P=H(()=>e.value.filter(B=>B.consecutive_failures>0).length);function re(B){if(!B)return"-";const Z=Date.now(),V=(new Date(B).getTime()-Z)/1e3;if(V<0)return"overdue";if(V<60)return"in < 1 min";if(V<3600)return`in ${Math.floor(V/60)} min`;if(V<86400){const ee=Math.floor(V/3600),be=Math.floor(V%3600/60);return be>0?`in ${ee}h ${be}m`:`in ${ee}h`}const X=Math.floor(V/86400);return`in ${X} day${X!==1?"s":""}`}function ce(B){return B==null?"-":B<1e3?`${B}ms`:B<6e4?`${(B/1e3).toFixed(1)}s`:Ji(B/1e3)}function z(B=r.value.cron){r.value.cron=B,Ef(r.value,"cron"),k.value=null}function se(B=r.value.run_at){r.value.run_at=B,Ef(r.value,"run_at"),k.value=null}async function le(){const B=r.value.cron.trim();if(B){y.value=!0;try{k.value=await j.post("/api/schedules/validate-cron",{expression:B})}catch(Z){k.value={valid:!1,error:Z.message}}y.value=!1}}async function K(){t.value=!0,s.value=null;try{e.value=await j.get("/api/schedules")}catch(B){s.value=B.message}t.value=!1}async function ve(){try{a.value=Ko(await j.get("/api/schedules/status"))}catch(B){a.value=Af(B)||Ko(null)}}function Me(B){const Z=Af(B);Z&&(a.value=Z)}async function ne(B){if(w.value===B){w.value=null,O.value=[];return}w.value=B,U.value=!0,O.value=[];const Z=++$;try{const ue=await j.get(`/api/schedules/${encodeURIComponent(B)}/history?limit=10`);if(Z!==$||w.value!==B)return;O.value=ue,T.value=""}catch(ue){if(Z!==$||w.value!==B)return;O.value=[],T.value=ue.message||"Failed to load execution history"}Z===$&&(U.value=!1)}async function ie(){if(d.value=null,!p(r.value.action)){d.value=Oo(a.value);return}const B=r.value;if(!B.description.trim()){d.value="Description is required";return}if(B.action!=="webhook"&&!B.channel_id.trim()){d.value="Channel ID is required";return}if(!B.cron.trim()&&!B.run_at.trim()){d.value="Cron expression or run_at time is required";return}if(B.cron.trim()&&B.run_at.trim()){d.value="Choose either Cron or One-Time, not both";return}const Z={description:B.description.trim(),action:B.action,channel_id:B.channel_id.trim()};if(B.cron.trim()&&(Z.cron=B.cron.trim()),B.run_at.trim()){const ue=h.value;if(ue.state==="nonexistent"){d.value="That local time does not exist (daylight saving gap)";return}if(ue.state==="invalid"){d.value="One-time run time is not a valid date";return}const V=b.value;if(ue.state==="ambiguous"&&m.value===null){d.value="That local time happens twice — choose which occurrence to use";return}if(!V){d.value="One-time run time could not be resolved";return}Z.run_at=V.toISOString()}if(B.action==="reminder"&&B.message.trim()&&(Z.message=B.message.trim()),B.action==="check"&&(B.tool_name.trim()&&(Z.tool_name=B.tool_name.trim()),B.report_format&&(Z.report_format=B.report_format),B.tool_input_str.trim()))try{Z.tool_input=JSON.parse(B.tool_input_str.trim())}catch{d.value="Tool input must be valid JSON";return}if(B.action==="webhook"){if(!B.webhook_url.trim()){d.value="Webhook URL is required";return}const ue={url:B.webhook_url.trim(),method:B.webhook_method};if(B.webhook_headers_str.trim())try{const V=JSON.parse(B.webhook_headers_str.trim());if(!V||Array.isArray(V)||typeof V!="object")throw new Error("not an object");ue.headers=V}catch{d.value="Webhook headers must be a valid JSON object";return}if(B.webhook_body&&(ue.body=B.webhook_body),B.webhook_expected_status_str.trim()){const V=B.webhook_expected_status_str.split(",").map(X=>Number(X.trim()));if(V.some(X=>!Number.isInteger(X)||X<100||X>599)){d.value="Expected status codes must be comma-separated HTTP codes";return}ue.expected_status_codes=V}Z.webhook_config=ue}c.value=!0;try{await j.post("/api/schedules",Z),Te.success("Schedule created"),r.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:"",webhook_url:"",webhook_method:"POST",webhook_headers_str:"",webhook_body:"",webhook_expected_status_str:""},k.value=null,o.value=!1,await K()}catch(ue){Me(ue),d.value=ue.message}c.value=!1}async function fe(B){if(!p(B.action)){Te.error(Oo(a.value));return}const Z=B.id;x.value=Z;try{const ue=await j.post(`/api/schedules/${encodeURIComponent(Z)}/run`);if(ue.status==="failure")Te.error(`Execution failed: ${ue.error||"unknown error"}`);else{const V=ue.warning?`Executed (${ue.warning})`:"Executed successfully";Te.success(V)}await K()}catch(ue){Me(ue),Te.error(ue.message||"Failed to trigger")}x.value=null}async function me(B){if(B.paused&&!p(B.action)){Te.error(Oo(a.value));return}_.value=B.id;const Z=!B.paused;try{await j.put(`/api/schedules/${encodeURIComponent(B.id)}`,{paused:Z}),Te.success(Z?"Schedule paused":"Schedule resumed"),await K()}catch(ue){Me(ue),Te.error(ue.message||"Failed to update schedule")}_.value=null}const ge=new Map;function Le(B,Z){const ue=ge.get(B.id);ue&&clearTimeout(ue.timer);const V={run:()=>A(B,Z),timer:null};V.timer=setTimeout(()=>{ge.delete(B.id),V.run()},500),ge.set(B.id,V)}async function A(B,Z){R.value=B.id;try{await j.put(`/api/schedules/${encodeURIComponent(B.id)}`,{report_format:Z}),Te.success(Z?"Structured report enabled":"Plain-text report enabled")}catch(ue){Te.error(`Update failed: ${ue.message}`)}finally{await K(),R.value=null}}function D(){for(const[B,Z]of[...ge])clearTimeout(Z.timer),ge.delete(B),Z.run()}async function G(B){E.value=B;try{await j.post(`/api/schedules/${encodeURIComponent(B)}/reset-failures`),Te.success("Failure counters reset"),await K()}catch(Z){Te.error(Z.message||"Failed to reset")}E.value=null}async function pe(B){const Z=e.value.find(V=>V.id===B);if(await os({title:"Delete schedule",message:`Delete "${(Z==null?void 0:Z.description)||B}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){S.value=B;try{await j.del(`/api/schedules/${encodeURIComponent(B)}`),Te.success("Schedule deleted"),await K()}catch(V){Te.error(V.message||"Failed to delete schedule")}S.value=null}}return st(()=>{K(),ve(),l=setInterval(ve,a1)}),xt(()=>{D(),l&&clearInterval(l)}),{schedules:e,loading:t,error:s,schedulingAvailable:n,schedulingAvailabilityMessage:i,selectedActionAvailable:u,actionAvailable:p,showCreate:o,form:r,creating:c,createError:d,runAtUtcPreview:I,runAtAnalysis:h,runAtOccurrence:m,cronResult:k,validatingCron:y,cronPresets:g,runningId:x,deletingId:S,togglingId:_,resettingId:E,reportUpdatingId:R,flushReportFormatTimers:D,expandedId:w,history:O,historyLoading:U,historyError:T,cronCount:Y,oneTimeCount:W,webhookCount:M,pausedCount:L,failingCount:P,formatTs:ni,formatAge:hg,formatFuture:re,formatMs:ce,formatDuration:Ji,onCronInput:z,onRunAtInput:se,validateCron:le,toggleExpand:ne,fetchSchedules:K,fetchSchedulingAvailability:ve,doCreate:ie,doRunNow:fe,doTogglePause:me,doUpdateReportFormat:Le,doResetFailures:G,doDelete:pe}}},xg=[{id:"live",label:"Live",component:VS},{id:"agents",label:"Agents",component:ZS},{id:"loops",label:"Loops",component:YS},{id:"processes",label:"Processes",component:QS},{id:"schedules",label:"Schedules",component:i1}],l1={components:{TabbedPage:Xr},setup(){return{tabs:xg}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},o1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(null),n=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),m=f("last_active"),h=f(!1),b=If,I=r1,k=f([]),y=f(!1),g=f(""),x=f("flat"),S=f(new Set),_=f(""),E=f(""),R=f(""),w=f(null),O=f(!1),U=f(""),T=f(!1);let $=0;Wt([_,E,R],()=>{$++,O.value=!1,U.value="",T.value=w.value!==null},{flush:"sync"});function Y(){try{const te=localStorage.getItem("odin-session-presets");te&&(k.value=JSON.parse(te))}catch{}}function W(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const M=H(()=>p.value.trim()!==""||u.value!=="all"),L=H(()=>{let te=[...e.value];const Oe=If.find(lt=>lt.id===u.value),ze=Oe?Oe.filters:{};if(ze.source&&(te=te.filter(lt=>lt.source===ze.source)),ze.minMessages&&(te=te.filter(lt=>lt.message_count>=ze.minMessages)),ze.hasCompaction&&(te=te.filter(lt=>lt.has_summary)),ze.maxAge!=null){const lt=Date.now()/1e3;te=te.filter(gt=>gt.last_active&&lt-gt.last_active<=ze.maxAge)}if(p.value.trim()){const lt=p.value.toLowerCase().trim();te=te.filter(gt=>(gt.channel_id||"").toLowerCase().includes(lt)||(gt.last_user_id||"").toLowerCase().includes(lt)||(gt.source||"").toLowerCase().includes(lt))}const rt=m.value,Zt=h.value?1:-1;return te.sort((lt,gt)=>{const Yt=lt[rt]||0,cs=gt[rt]||0;return(Yt-cs)*Zt}),te}),P=H(()=>{if(!n.value||!n.value.messages)return[];const te=n.value.messages;if(te.length===0)return[];const Oe=[];let ze=[];for(const rt of te)rt.role==="user"&&ze.length>0&&(Oe.push(ze),ze=[]),ze.push(rt);return ze.length>0&&Oe.push(ze),Oe}),re=H(()=>L.value.length>0&&c.value.size===L.value.length);function ce(te){const Oe=te.find(ze=>ze.role==="user");if(Oe&&Oe.content){const ze=Oe.content.slice(0,120);return ze.length<Oe.content.length?ze+"...":ze}return"(no user message)"}function z(te){const Oe=new Set(S.value);Oe.has(te)?Oe.delete(te):Oe.add(te),S.value=Oe}function se(te){u.value=te}function le(te){u.value=te.id,te.filters.searchQuery!=null&&(p.value=te.filters.searchQuery),te.filters.sortBy&&(m.value=te.filters.sortBy)}function K(){if(!g.value.trim())return;const te={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:m.value}};k.value=[...k.value,te],W(),y.value=!1,g.value=""}function ve(te){k.value=k.value.filter(Oe=>Oe.id!==te),W(),u.value===te&&(u.value="all")}function Me(){u.value="all",p.value="",m.value="last_active",h.value=!1}function ne(te){if(!te)return"—";const Oe=Date.now()/1e3-te;if(Oe<60)return"just now";if(Oe<3600){const rt=Math.floor(Oe/60);return`${rt} minute${rt!==1?"s":""} ago`}if(Oe<86400){const rt=Math.floor(Oe/3600);return`${rt} hour${rt!==1?"s":""} ago`}const ze=Math.floor(Oe/86400);return`${ze} day${ze!==1?"s":""} ago`}function ie(te){if(!te)return"";try{return new Date(te*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function fe(te){if(!te)return"";try{return new Date(te*1e3).toLocaleString()}catch{return""}}function me(te){return te==="user"?"bg-gray-900/50 border border-gray-800":te==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ge(te){return te==="user"?"sess-msg-user":te==="assistant"?"sess-msg-assistant":"sess-msg-system"}function Le(te){return te==="user"?"badge-info":te==="assistant"?"badge-success":"badge-warning"}function A(te){return te==="user"?"sess-dot-user":te==="assistant"?"sess-dot-assistant":"sess-dot-system"}function D(te){return te==="user"?"text-cyan-400":te==="assistant"?"text-indigo-400":"text-gray-500"}function G(te){return te?te.length>2e3?te.slice(0,2e3)+`
... (truncated)`:te:""}async function pe(){const te=_.value.trim();if(!te)return;const Oe=++$;O.value=!0,U.value="",T.value=w.value!==null;try{let ze=`/api/sessions/search?q=${encodeURIComponent(te)}&limit=50`;E.value.trim()&&(ze+=`&channel_id=${encodeURIComponent(E.value.trim())}`),R.value.trim()&&(ze+=`&user_id=${encodeURIComponent(R.value.trim())}`);const rt=await j.get(ze);if(Oe!==$)return;w.value=rt.results||[],T.value=!1}catch(ze){if(Oe!==$)return;U.value=ze.message||"Search failed. Please retry."}finally{Oe===$&&(O.value=!1)}}function B(){$++,_.value="",E.value="",R.value="",w.value=null,U.value="",T.value=!1,O.value=!1}function Z(te){return te?te.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function ue(te){return te==="user"?"fts-result-user":te==="assistant"?"fts-result-assistant":te==="summary"?"fts-result-summary":te==="fts"?"fts-result-fts":te==="channel"?"fts-result-channel":"fts-result-default"}function V(te){return te==="user"?"badge-info":te==="assistant"?"badge-success":te==="summary"?"badge-warning":te==="fts"?"badge-success":"badge-info"}let X=0;async function ee(){const te=++X;t.value=!0,s.value=null;try{const Oe=await j.get("/api/sessions");if(te!==X)return;e.value=Oe}catch(Oe){if(te!==X)return;s.value=Oe.message}te===X&&(t.value=!1)}function be(){s.value=null,ee()}async function he(te){if(a.value===te){a.value=null,n.value=null,S.value=new Set;return}a.value=te,n.value=null,i.value=!0,S.value=new Set;const Oe=++l;try{const ze=await j.get(`/api/sessions/${encodeURIComponent(te)}`);Oe===l&&a.value===te&&(n.value=ze)}catch(ze){Oe===l&&a.value===te&&(n.value={messages:[],summary:"",error:ze.message||"Failed to load session"})}finally{Oe===l&&(i.value=!1)}}function we(te){const Oe=new Set(c.value);Oe.has(te)?Oe.delete(te):Oe.add(te),c.value=Oe}function _e(){re.value?c.value=new Set:c.value=new Set(L.value.map(te=>te.channel_id))}function ye(te){o.value=te}async function We(){if(o.value){r.value=!0;try{await j.del(`/api/sessions/${encodeURIComponent(o.value)}`),a.value===o.value&&(a.value=null,n.value=null),c.value.delete(o.value),await ee()}catch(te){s.value=te.message||"Failed to clear session"}r.value=!1,o.value=null}}function Je(){d.value=!0}async function Fe(){if(c.value.size!==0){r.value=!0;try{await j.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(a.value)&&(a.value=null,n.value=null),c.value=new Set,await ee()}catch(te){s.value=te.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function qe(te,Oe){const ze=`/api/sessions/${encodeURIComponent(te)}/export?format=${Oe}`;try{const rt=await j.getBlob(ze),Zt=URL.createObjectURL(rt),lt=document.createElement("a");lt.href=Zt,lt.download=`session-${te}.${Oe==="text"?"txt":"json"}`,lt.click(),URL.revokeObjectURL(Zt)}catch(rt){s.value=rt.message||"Failed to export session"}}let at=null;function Xe(te){te.payload&&te.payload.channel_id&&(clearTimeout(at),at=setTimeout(()=>{if(ee(),a.value&&te.payload.channel_id===a.value){const Oe=a.value,ze=l;j.get(`/api/sessions/${encodeURIComponent(Oe)}`).then(rt=>{ze!==l||a.value!==Oe||(n.value=rt)}).catch(()=>{})}},2e3))}let J=!1,Ee=null;function Ae(){J||(J=!0,ee(),ut.subscribe("events",Xe),Ee=ut.onReconnected(()=>ee()))}st(()=>{Y(),Ae()}),rs(()=>{Ae()});function Ne(){J&&(J=!1,ut.unsubscribe("events",Xe),Ee&&(Ee(),Ee=null),clearTimeout(at))}return Kt(Ne),xt(Ne),{sessions:e,loading:t,error:s,expandedId:a,detail:n,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:re,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:m,sortAsc:h,filterPresets:b,sortOptions:I,filteredSessions:L,hasActiveFilters:M,customPresets:k,showSavePreset:y,newPresetName:g,threadView:x,threads:P,collapsedThreads:S,ftsQuery:_,ftsChannelId:E,ftsUserId:R,ftsResults:w,ftsSearching:O,ftsError:U,ftsStale:T,formatAge:ne,formatTimestamp:ie,formatFullTimestamp:fe,messageClass:me,threadMsgClass:ge,roleBadge:Le,roleDotClass:A,roleLabelClass:D,truncateContent:G,threadSummary:ce,fetchSessions:ee,retry:be,toggleSession:he,toggleSelect:we,toggleSelectAll:_e,confirmClear:ye,clearSession:We,confirmBulkClear:Je,doBulkClear:Fe,exportSession:qe,applyPreset:se,applyCustomPreset:le,saveCustomPreset:K,removeCustomPreset:ve,resetFilters:Me,toggleThread:z,runFtsSearch:pe,clearFtsSearch:B,highlightSnippet:Z,ftsResultClass:ue,ftsTypeBadge:V}}},d1={props:["trace"],template:`
...
`).length:0}function U(K){return b1(K)}function T(K){a.value={...a.value,[K]:!a.value[K]}}async function $(K){try{await navigator.clipboard.writeText(K);const ve=e.value.find(Me=>Me.code===K);ve&&(o.value=ve.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function Y(K){if(K.key==="Tab"){K.preventDefault();const ve=K.target,Me=ve.selectionStart,ne=ve.selectionEnd;u.value=u.value.substring(0,Me)+"    "+u.value.substring(ne),zt(()=>{ve.selectionStart=ve.selectionEnd=Me+4})}}function W(K){const ve=K.target.previousElementSibling;ve&&(ve.scrollTop=K.target.scrollTop)}async function M(){t.value=!0,s.value=null;try{e.value=await j.get("/api/skills")}catch(K){s.value=K.message}t.value=!1}async function L(K){i.value=K,delete n.value[K],n.value={...n.value};try{const ve=await j.post(`/api/skills/${encodeURIComponent(K)}/test`);n.value={...n.value,[K]:ve}}catch(ve){n.value={...n.value,[K]:{result:ve.message,is_error:!0}}}i.value=null}function P(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,m.value=null}function re(K){r.value=!0,c.value="edit",d.value=K.name,u.value=K.code||"",p.value=null,m.value=null}function ce(){r.value=!1,p.value=null,m.value=null}async function z(){p.value=null,m.value=null;const K=d.value.trim(),ve=u.value.trim();if(!K){p.value="Name is required";return}if(!ve){p.value="Code is required";return}h.value=!0;try{c.value==="create"?(await j.post("/api/skills",{name:K,code:ve}),m.value="Skill created successfully"):(await j.put(`/api/skills/${encodeURIComponent(K)}`,{code:ve}),m.value="Skill updated successfully"),await M(),setTimeout(()=>{r.value=!1},800)}catch(Me){p.value=Me.message}h.value=!1}function se(K){I.value=K}async function le(){if(I.value){k.value=!0;try{await j.del(`/api/skills/${encodeURIComponent(I.value)}`),await M()}catch(K){Te.error(`Failed to delete skill: ${K.message||"unknown error"}`)}k.value=!1,I.value=null}}return st(()=>{M()}),{skills:e,loading:t,error:s,showCode:a,testResults:n,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:m,saving:h,editorRef:b,deleteTarget:I,deleting:k,enabledCount:y,totalExecutions:g,totalLines:x,displayedSkills:S,editLineCount:_,editorLineNums:E,editValidation:R,highlight:w,truncate:Lu,formatTs:ni,countLines:O,getLineNumbers:U,toggleCode:T,copyCode:$,handleEditorKey:Y,syncScroll:W,fetchSkills:M,testSkill:L,showCreate:P,editSkill:re,cancelEdit:ce,saveSkill:z,confirmDelete:se,doDelete:le}}};class ta extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const x1=/^[A-Za-z_][A-Za-z0-9_]*$/;function Of(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Lf(e,t,s){const a={},n=[...new Set((t||[]).map(l=>String(l)))],i=new Set(n);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new ta(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new ta(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(a,o))throw new ta(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new ta(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");a[o]=r}}return{set:a,remove:n}}function _1(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function w1(e,{mode:t="add",originalTransport:s=""}={}){const a=t==="add",n=String(e.name||"").trim();if(!n)throw new ta("Server name is required.","name");if(n.length>128||!x1.test(n))throw new ta("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!a&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(a&&(o.name=n),i==="stdio"){const d=String(e.command||"").trim();if((a||l)&&!d)throw new ta("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(a||e.replaceArgs)&&(o.args=Of(e.argsText)),a||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new ta("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((a||l)&&!d)throw new ta("An HTTP endpoint is required for this connection.","url");if(d&&!_1(d))throw new ta("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(a||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new ta("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(a||e.replaceAllowlist)&&(o.tool_allowlist=Of(e.allowlistText));const r=Lf(e.headerRows,e.headersRemove,"Header"),c=Lf(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function k1(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function S1(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function C1(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(a=>String(a).toLowerCase().includes(s)):!0}const T1=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function E1(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(a=>(a=window.matchMedia)==null?void 0:a.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const n=t.querySelector(".mcp-editor-groups"),i=n==null?void 0:n.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const A1=1e4,R1=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function Mc(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function I1(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const O1={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),a=f(!1),n=f(""),i=f({max_published_tools_per_server:"",max_published_tools_global:""}),l=f(new Set),o=H(()=>Object.keys(i.value).every(J=>{var Ee;return Number.isInteger((Ee=e.value)==null?void 0:Ee[J])})),r=f(""),c=f(new Set),d=f(new Set),u=f({}),p=f({}),m=f({}),h=f(new Set),b=f(!1),I=f("add"),k=f(""),y=f(null),g=f(Mc()),x=f(""),S=f(!1);let _=null,E=0,R=!1,w=!1;const O=T1,U=H(()=>{var J;return((J=e.value)==null?void 0:J.servers)||[]}),T=H(()=>{var J;return!!((J=e.value)!=null&&J.enabled)}),$=H(()=>{var J,Ee,Ae,Ne;return{serverCount:((J=e.value)==null?void 0:J.server_count)||0,enabledCount:((Ee=e.value)==null?void 0:Ee.enabled_server_count)||0,connectedCount:((Ae=e.value)==null?void 0:Ae.connected_count)||0,toolCount:((Ne=e.value)==null?void 0:Ne.published_tool_count)||0}}),Y=H(()=>{var J;return((J=y.value)==null?void 0:J.header_keys)||[]}),W=H(()=>{var J;return((J=y.value)==null?void 0:J.env_keys)||[]}),M=H(()=>{var J;return I.value==="edit"&&((J=y.value)==null?void 0:J.transport)==="http"}),L=H(()=>I.value==="add"||!M.value),P=H(()=>M.value?"Replace endpoint URL":"Endpoint URL"),re=H(()=>M.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function ce(){z(),_=window.setInterval(()=>se({quiet:!0}),A1)}function z(){_&&window.clearInterval(_),_=null}async function se({quiet:J=!1}={}){if(a.value)return;const Ee=++E;J||(t.value=!0);try{const Ae=await j.get("/api/mcp/status");if(Ee!==E||!R)return;e.value=Ae;for(const te of Object.keys(i.value))!l.value.has(te)&&Number.isInteger(Ae[te])&&(i.value[te]=String(Ae[te]));r.value="";const Ne=new Set((Ae.servers||[]).map(te=>te.name));d.value=new Set([...d.value].filter(te=>Ne.has(te)))}catch(Ae){Ee===E&&R&&(r.value=Ae.message||"Failed to load MCP status")}finally{Ee===E&&(t.value=!1)}}function le(J){return s.value||c.value.has(J)}function K(J,Ee){const Ae=new Set(c.value);Ee?Ae.add(J):Ae.delete(J),c.value=Ae}function ve(J){return S1(J.state)}function Me(J){if(ve(J)==="disabled"){if(!J.enabled)return"Disabled — server switch off";if(!T.value)return"Disabled — global MCP is off"}return R1[ve(J)]}function ne(J){return J.transport==="http"?"Streamable HTTP":"stdio"}function ie(J){return J.negotiated_version?`${J.era?`${String(J.era).charAt(0).toUpperCase()}${String(J.era).slice(1)}`:"Protocol"} · ${J.negotiated_version}`:"Not negotiated"}function fe(J){return J.discovered_count?`${J.published_count||0} published · ${J.excluded_count||0} excluded`:"No tools discovered"}const me=f(new Set);async function ge(J,Ee){if(me.value.has(J.name))return;const Ae=!!Ee.target.checked,Ne=new Set(me.value);Ne.add(J.name),me.value=Ne;try{const te=await j.post(`/api/mcp/servers/${encodeURIComponent(J.name)}/enabled`,{enabled:Ae});te&&Array.isArray(te.servers)?e.value=te:await se({quiet:!0})}catch(te){Ee.target.checked=!!J.enabled,Te.error(te.message||`Failed to toggle ${J.name}`)}finally{const te=new Set(me.value);te.delete(J.name),me.value=te}}function Le(J,Ee){var Ne;i.value[J]=Ee;const Ae=new Set(l.value);Ee===String((Ne=e.value)==null?void 0:Ne[J])?Ae.delete(J):Ae.add(J),l.value=Ae,n.value=""}async function A(){if(s.value||!o.value||!l.value.size)return;const J={};for(const Ee of l.value){const Ae=Number(i.value[Ee]),Ne=Ee==="max_published_tools_per_server"?128:256;if(!Number.isInteger(Ae)||Ae<1||Ae>Ne){n.value=`Enter a whole number between 1 and ${Ne}.`;return}J[Ee]=Ae}a.value=!0,s.value=!0,n.value="",++E,t.value=!1;try{const Ee=await j.post("/api/mcp/limits",J);e.value=Ee;for(const Ae of Object.keys(i.value))Number.isInteger(Ee[Ae])&&(i.value[Ae]=String(Ee[Ae]));l.value=new Set,Te.success("MCP limits saved. Applied at the next publication or tools refresh.")}catch(Ee){n.value=Ee.message||"Failed to save MCP publication limits"}finally{a.value=!1,s.value=!1,await se({quiet:!0})}}async function D(J){if(J!==T.value&&!(!J&&!await os({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await j.post("/api/mcp/enabled",{enabled:J}),Te.success(J?"MCP enabled":"MCP disabled"),await se({quiet:!0})}catch(Ee){Te.error(Ee.message||"Failed to update MCP state"),await se({quiet:!0})}finally{s.value=!1}}}async function G(J){K(J.name,!0);try{await j.post(`/api/mcp/servers/${encodeURIComponent(J.name)}/reconnect`,{}),Te.success(`Reconnected ${J.name}`)}catch(Ee){Te.error(Ee.message||`Failed to reconnect ${J.name}`)}finally{K(J.name,!1),await se({quiet:!0})}}async function pe(J){K(J.name,!0);try{await j.post(`/api/mcp/servers/${encodeURIComponent(J.name)}/refresh-tools`,{}),Te.success(`Refreshed tools from ${J.name}`),await ue(J.name,!0)}catch(Ee){Te.error(Ee.message||`Failed to refresh ${J.name}`)}finally{K(J.name,!1),await se({quiet:!0})}}async function B(J){if(await os({title:`Remove ${J.name}`,message:`Remove this saved MCP server? Its ${J.published_count||0} published tool${J.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){K(J.name,!0);try{await j.del(`/api/mcp/servers/${encodeURIComponent(J.name)}`),Te.success(`Removed ${J.name}`),delete p.value[J.name]}catch(Ae){Te.error(Ae.message||`Failed to remove ${J.name}`)}finally{K(J.name,!1),await se({quiet:!0})}}}async function Z(J){const Ee=new Set(d.value);if(Ee.has(J.name)){Ee.delete(J.name),d.value=Ee;return}Ee.add(J.name),d.value=Ee,Object.hasOwn(p.value,J.name)||await ue(J.name)}async function ue(J,Ee=!1){if(!Ee&&Object.hasOwn(p.value,J))return;const Ae=new Set(h.value);Ae.add(J),h.value=Ae,m.value={...m.value,[J]:""};try{const Ne=await j.get(`/api/mcp/servers/${encodeURIComponent(J)}/tools`);p.value={...p.value,[J]:Ne.tools||[]}}catch(Ne){m.value={...m.value,[J]:Ne.message||"Failed to load tools"}}finally{const Ne=new Set(h.value);Ne.delete(J),h.value=Ne}}function V(J){return(p.value[J]||[]).filter(Ee=>C1(Ee,u.value[J]))}function X(J,Ee){u.value={...u.value,[J]:Ee}}function ee(){I.value="add",k.value="",y.value=null,g.value=Mc(),x.value="",b.value=!0}function be(J){I.value="edit",k.value=J.name,y.value=J,g.value={...Mc(),name:J.name,enabled:!!J.enabled,transport:J.transport||"stdio"},x.value="",b.value=!0}function he(){S.value||(b.value=!1)}function we(J){b.value&&E1(J)}function _e(J){const Ee=J==="headers"?"headerRows":"envRows";g.value[Ee].push({key:"",value:""})}function ye(J,Ee){const Ae=J==="headers"?"headerRows":"envRows";g.value[Ae].splice(Ee,1)}function We(J,Ee){const Ae=J==="headers"?"headersRemove":"envRemove",Ne=g.value[Ae];g.value[Ae]=Ne.includes(Ee)?Ne.filter(te=>te!==Ee):[...Ne,Ee]}async function Je(){var Ee,Ae;x.value="";let J;try{J=w1(g.value,{mode:I.value,originalTransport:((Ee=y.value)==null?void 0:Ee.transport)||""})}catch(Ne){x.value=Ne instanceof ta?Ne.message:"Invalid MCP server configuration",await zt(),(Ae=document.querySelector(".mcp-editor"))==null||Ae.scrollTo({top:0,behavior:"smooth"});return}if(!(I.value==="edit"&&k1(J,y.value)&&!await os({title:`Change ${k.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){S.value=!0;try{I.value==="add"?await j.post("/api/mcp/servers",J):await j.put(`/api/mcp/servers/${encodeURIComponent(k.value)}`,J),Te.success(I.value==="add"?`Saved ${J.name}`:`Updated ${k.value}`),b.value=!1,await se({quiet:!0})}catch(Ne){x.value=Ne.message||"Failed to save MCP server"}finally{S.value=!1}}}let Fe=null;function qe(J){`${(J==null?void 0:J.event)||""} ${(J==null?void 0:J.type)||""} ${(J==null?void 0:J.tool)||""} ${(J==null?void 0:J.message)||""}`.toLowerCase().includes("mcp")&&(Fe&&window.clearTimeout(Fe),Fe=window.setTimeout(()=>se({quiet:!0}),200))}function at(){R||(R=!0,w||(ut.subscribe("events",qe),w=!0),se(),ce())}function Xe(){R=!1,z(),Fe&&window.clearTimeout(Fe),Fe=null,w&&(ut.unsubscribe("events",qe),w=!1)}return st(at),rs(at),Kt(Xe),xt(Xe),{status:e,loading:t,mutating:s,pageError:r,servers:U,masterEnabled:T,aggregate:$,limitsSaving:a,limitsError:n,limitsAvailable:o,limitDraft:i,limitDirty:l,editLimit:Le,saveLimits:A,expandedServers:d,toolQueries:u,toolErrors:m,toolsLoading:h,editorOpen:b,editorMode:I,editingName:k,editingServer:y,form:g,formError:x,saving:S,editorGroups:O,configuredHeaderKeys:Y,configuredEnvKeys:W,savedHttpEndpoint:M,endpointRequired:L,endpointFieldLabel:P,endpointPlaceholder:re,refreshAll:se,busy:le,serverState:ve,stateLabel:Me,transportLabel:ne,protocolLabel:ie,toolSummary:fe,formatAge:I1,setMasterEnabled:D,togglePending:me,toggleServerEnabled:ge,reconnect:G,refreshTools:pe,removeServer:B,toggleTools:Z,filteredTools:V,setToolQuery:X,openAdd:ee,openEdit:be,closeEditor:he,jumpToEditorGroup:we,addSecretRow:_e,removeSecretRow:ye,toggleSecretRemoval:We,saveServer:Je}}};function L1(e,t){if(!e||!t)return Tf(e);const s=Tf(e),a=t.trim().split(/\s+/).filter(Boolean);if(!a.length)return s;const n=a.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${n})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const N1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),a=f(""),n=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),m=f(!1),h=f(null),b=f(null);let I=null;const k=f(null),y=f(!1),g=f({}),x=f({}),S=f({}),_=f({}),E=new Map,R=f(null),w=H(()=>e.value.reduce((z,se)=>z+(se.chunks||0),0)),O=H(()=>new Set(e.value.map(se=>se.uploader).filter(Boolean)).size);function U(z,se){const le=x.value[se];if(!le||le.length===0)return 0;const K=Math.max(...le.map(ve=>ve.char_count||0));return K===0?0:Math.round(z.char_count/K*100)}async function T(){t.value=!0,s.value=null;try{const z=await j.get("/api/knowledge");e.value=Array.isArray(z)?z:[]}catch(z){s.value=z.message}t.value=!1}async function $(z){if(g.value[z]){g.value[z]=!1,R.value=null;return}if(g.value[z]=!0,Object.prototype.hasOwnProperty.call(x.value,z))return;if(E.has(z))return E.get(z);const se={..._.value,[z]:!0};_.value=se;const le={...S.value};delete le[z],S.value=le;const K=j.get(`/api/knowledge/${encodeURIComponent(z)}/chunks`).then(ve=>{x.value={...x.value,[z]:Array.isArray(ve)?ve:[]}}).catch(ve=>{S.value={...S.value,[z]:ve.message||"load failed"}}).finally(()=>{if(E.get(z)!==K)return;E.delete(z);const ve={..._.value};delete ve[z],_.value=ve});return E.set(z,K),K}let Y=0;async function W(){const z=a.value.trim();if(!z)return;const se=++Y;i.value=!0,o.value=null,l.value=z;try{const le=await j.get(`/api/knowledge/search?q=${encodeURIComponent(z)}`);if(se!==Y)return;n.value=Array.isArray(le)?le:[]}catch(le){if(se!==Y)return;n.value=[],o.value=le.message||"Search failed"}se===Y&&(i.value=!1)}function M(){Y+=1,i.value=!1,n.value=null,a.value="",o.value=null}async function L(){u.value=null,p.value=null;const z=c.value.trim(),se=d.value.trim();if(!z){u.value="Source name is required";return}if(!se){u.value="Content is required";return}m.value=!0;try{const le=await j.post("/api/knowledge",{source:z,content:se});p.value=`Ingested ${le.chunks||0} chunks from "${z}"`,c.value="",d.value="",x.value={},await T(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(le){u.value=le.message}m.value=!1}async function P(z){h.value=z,b.value=null,I&&(clearTimeout(I),I=null);try{const se=await j.post(`/api/knowledge/${encodeURIComponent(z)}/reingest`);b.value={source:z,error:!1,message:`Re-ingested ${se.chunks||0} chunks`},delete x.value[z],await T(),I=setTimeout(()=>{b.value=null,I=null},3e3)}catch(se){b.value={source:z,error:!0,message:se.message}}h.value=null}function re(z){k.value=z}async function ce(){if(k.value){y.value=!0;try{await j.del(`/api/knowledge/${encodeURIComponent(k.value)}`),delete x.value[k.value],await T()}catch(z){Te.error(`Failed to delete source: ${z.message||"unknown error"}`)}y.value=!1,k.value=null}}return st(()=>{T()}),{sources:e,loading:t,error:s,searchQuery:a,searchResults:n,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:m,reingesting:h,reingestResult:b,deleteTarget:k,deleting:y,expanded:g,sourceChunks:x,chunkErrors:S,loadingChunks:_,selectedChunk:R,totalChunks:w,uploaderCount:O,truncate:Lu,formatTs:ni,highlightTerms:L1,chunkBarWidth:U,fetchSources:T,toggleSource:$,doSearch:W,clearSearch:M,doIngest:L,doReingest:P,confirmDelete:re,doDelete:ce}}},M1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),a=f(null),n=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),m=f(""),h=f(!1),b=f(null),I=f(null),k=f(new Set),y=f(null),g=f(!1),x=f(!1),S=H(()=>e.value.reduce((se,le)=>se+le.count,0)),_=H(()=>k.value.size);function E(se){const le=t.value[se];if(!le)return[];if(!l.value.trim())return le;const K=l.value.trim().toLowerCase();return le.filter(ve=>ve.key.toLowerCase().includes(K)||ve.value&&ve.value.toLowerCase().includes(K))}function R(se,le){return k.value.has(se+"/"+le)}function w(se,le){const K=se+"/"+le,ve=new Set(k.value);ve.has(K)?ve.delete(K):ve.add(K),k.value=ve}function O(se){const le=t.value[se];return!le||le.length===0?!1:le.every(K=>k.value.has(se+"/"+K.key))}function U(se,le){const K=t.value[se];if(!K)return;const ve=new Set(k.value);for(const Me of K){const ne=se+"/"+Me.key;le?ve.add(ne):ve.delete(ne)}k.value=ve}async function T(){s.value=!0,a.value=null;try{const se=await j.get("/api/memory");e.value=Object.entries(se).map(([le,K])=>({name:le,keys:K.keys||[],count:K.count||0}))}catch(se){a.value=se.message}s.value=!1}async function $(se){if(n.value[se]){n.value[se]=!1;return}n.value[se]=!0;const le=e.value.find(ve=>ve.name===se);if(!le||t.value[se]||i.value===se)return;i.value=se;let K;try{const Me=(await j.get(`/api/memory/${encodeURIComponent(se)}`)).entries||{};K=le.keys.map(ne=>Object.prototype.hasOwnProperty.call(Me,ne)?{key:ne,value:Me[ne]||"",failed:!1}:{key:ne,value:"",failed:!0,error:"Not found in scope"})}catch(ve){K=le.keys.map(Me=>({key:Me,value:"",failed:!0,error:ve.message||"Failed to load"}))}t.value[se]=K,i.value=null}function Y(se,le,K){p.value=se+"/"+le,m.value=K}async function W(se,le){h.value=!0,b.value=null;try{await j.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(le)}`,{value:m.value});const K=t.value[se];if(K){const ve=K.find(Me=>Me.key===le);ve&&(ve.value=m.value)}p.value=null}catch(K){b.value=`Failed to save: ${K.message||"unknown error"}`}h.value=!1}async function M(se,le){try{await navigator.clipboard.writeText(le.value),I.value=se+"/"+le.key,setTimeout(()=>{I.value=null},1500)}catch{}}async function L(){d.value=null,u.value=null;const se=r.value.scope.trim(),le=r.value.key.trim(),K=r.value.value.trim();if(!se){d.value="Scope is required";return}if(!le){d.value="Key is required";return}if(!K){d.value="Value is required";return}c.value=!0;try{await j.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(le)}`,{value:K}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await T(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ve){d.value=ve.message}c.value=!1}function P(se,le){y.value={scope:se,key:le}}async function re(){if(!y.value)return;g.value=!0,b.value=null;const{scope:se,key:le}=y.value;try{await j.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(le)}`);const K=t.value[se];K&&(t.value[se]=K.filter(ne=>ne.key!==le));const ve=e.value.find(ne=>ne.name===se);ve&&(ve.count--,ve.keys=ve.keys.filter(ne=>ne!==le));const Me=new Set(k.value);Me.delete(se+"/"+le),k.value=Me}catch(K){b.value=`Failed to delete: ${K.message||"unknown error"}`}g.value=!1,y.value=null}function ce(){x.value=!0}async function z(){g.value=!0,b.value=null;const se=[];for(const le of k.value){const K=le.indexOf("/");se.push({scope:le.slice(0,K),key:le.slice(K+1)})}try{await j.post("/api/memory/bulk-delete",{entries:se}),k.value=new Set,t.value={},await T()}catch(le){b.value=`Bulk delete failed: ${le.message||"unknown error"}`}g.value=!1,x.value=!1}return st(()=>{T()}),{scopes:e,scopeEntries:t,loading:s,error:a,expanded:n,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:m,saving:h,actionError:b,copied:I,selected:k,selectedCount:_,totalEntries:S,deleteTarget:y,deleting:g,showBulkDelete:x,fetchMemory:T,toggleScope:$,startEdit:Y,doEdit:W,copyValue:M,doAdd:L,confirmDelete:P,doDelete:re,confirmBulkDelete:ce,doBulkDelete:z,isSelected:R,toggleSelect:w,isScopeAllSelected:O,toggleSelectAll:U,filteredEntries:E}}},D1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`)}),e.splice(n,1,k)}e.length>s&&e.splice(0,e.length-s)}function Cd(e,t,s=new Date){var u,p;let a=e;if(wn(e)&&e.type==="log"&&"line"in e?a=e.line:wn(e)&&"payload"in e&&(a=e.payload),typeof a=="string")try{a=JSON.parse(a)}catch{}const n=wn(a)?a:null,i=n!=null&&n.timestamp?new Date(n.timestamp):s,l=Number.isNaN(i.getTime())?s:i,o=n?n.result_summary??n.detail??n.message??JSON.stringify(n):typeof a=="string"?a:JSON.stringify(a)??"",c=(n==null?void 0:n.error)||((u=n==null?void 0:n.metadata)==null?void 0:u.error)||(n==null?void 0:n.success)===!1||[n==null?void 0:n.status,(p=n==null?void 0:n.metadata)==null?void 0:p.status].some(m=>["failed","error","cancelled","denied","outcome_unknown"].includes(m))?"ERROR":eo(n==null?void 0:n.level).toUpperCase()||"INFO",d={id:t,record:n,ts:l.toLocaleTimeString(),_time:l,level:c,text:typeof o=="string"?o:JSON.stringify(o),tool:eo(n==null?void 0:n.tool_name),raw:n?null:o,attribution:G1(n)};return d.searchText=n?JSON.stringify(n):d.text,d}function K1(e){const t=new Map;for(const s of e){const{turnId:a,agentId:n,rootId:i,label:l,parentId:o}=s.attribution,r=a?`turn:${a}`:n?`root:${i||n}`:"unattributed";t.has(r)||t.set(r,{key:r,title:a?`Turn ${a}`:n?`Agent root ${i||n} (turn unavailable)`:"Unattributed / legacy records",count:0,sections:[],_sections:new Map});const c=t.get(r),d=n?`agent:${n}`:"main";if(!c._sections.has(d)){const u={key:d,agentId:n,label:l,parentId:o,rootId:i,title:n?`${l||"Agent"} (${n})`:"Main thread / turn events",entries:[]};c._sections.set(d,u),c.sections.push(u)}c._sections.get(d).entries.push(s),c.count++}return[...t.values()].map(({_sections:s,...a})=>a)}const J1={components:{ToolOutput:ec},props:{entry:{type:Object,required:!0}},emits:["copy"],setup(e){const t=H(()=>q1(e.entry)),s=H(()=>{var o;return Xl(((o=e.entry.record)==null?void 0:o.tool_input)??"")}),a=H(()=>{var o,r,c;return Xl(((o=e.entry.record)==null?void 0:o.error)||((c=(r=e.entry.record)==null?void 0:r.metadata)==null?void 0:c.error)||"")}),n=H(()=>V1(e.entry.record)),i=H(()=>kg(e.entry)),l=H(()=>(e.entry.events||[e.entry.record]).filter(Boolean).map(o=>{var r;return{type:o.type||"execution",timestamp:o.timestamp||"Time not recorded",status:o.status||((r=o.metadata)==null?void 0:r.status)||""}}));return{display:t,argumentsText:s,errorText:a,metadataText:n,rawRecord:i,lifecycle:l}},template:`
    ...
    </div>`,setup(){const e=f("live"),t=f([]);let s=0;const a=f(!1),n=f(!1),i=f(!0),l=f(""),o=f(""),r=f(!1),c=f(!1),d=f(ut.state||"disconnected"),u=H(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),p=f(null),m=f(!1),h=f(null),b=2e3,I=Z1,k=Y1,y=Dc,g=f("all"),x=f(""),S=f(!1),_=f([]),E=f(!1),R=f(""),w=f([]);function O(){try{const oe=localStorage.getItem("odin-log-presets");oe&&(_.value=JSON.parse(oe))}catch{}}function U(){try{localStorage.setItem("odin-log-presets",JSON.stringify(_.value))}catch{}}const T=H(()=>l.value!==""||o.value.trim()!==""||x.value!==""||S.value),$=H(()=>{const oe=Dc.find(Ce=>Ce.value===x.value);return oe?oe.label:""}),Y=H(()=>{if(!r.value||!o.value)return null;try{return new RegExp(o.value,"i"),null}catch(oe){return oe.message}}),W=24,M=H(()=>{if(le.value.length===0)return[];const oe=[],Ce=new Date,Ke=3600*1e3;for(let je=W-1;je>=0;je--){const kt=new Date(Ce.getTime()-(je+1)*Ke),St=new Date(Ce.getTime()-je*Ke);oe.push({start:kt,end:St,label:ce(kt,St),shortLabel:St.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const je of le.value){if(!je._time)continue;const kt=je._time.getTime();for(const St of oe)if(kt>=St.start.getTime()&&kt<St.end.getTime()){St.total++,je.level==="ERROR"?St.errors++:je.level==="WARNING"?St.warnings++:St.info++;break}}return oe}),L=H(()=>{let oe=1;for(const Ce of M.value)Ce.total>oe&&(oe=Ce.total);return oe}),P=H(()=>{if(M.value.length===0)return"";const oe=le.value.map(je=>je._time&&je._time.getTime()).filter(Boolean);if(oe.length===0)return"";const Ce=new Date(Math.min(...oe));return`${le.value.length} shown, oldest ${Ce.toLocaleTimeString()}`}),re=H(()=>Math.ceil(W/8));function ce(oe,Ce){const Ke={hour:"2-digit",minute:"2-digit"};return oe.toLocaleTimeString([],Ke)+" - "+Ce.toLocaleTimeString([],Ke)}function z(oe,Ce){return!Ce||!oe?"0px":Math.max(2,oe/Ce*100)+"%"}function se(oe){const Ce=le.value.findIndex(Ke=>Ke._time&&Ke._time.getTime()>=oe.start.getTime()&&Ke._time.getTime()<oe.end.getTime());if(Ce>=0&&p.value){const Ke=p.value.querySelector('[data-log-id="'+le.value[Ce].id+'"]');Ke&&(Ke.scrollIntoView({behavior:"smooth",block:"center"}),i.value=!1)}}const le=H(()=>{let oe=t.value;if(S.value&&(oe=oe.filter(Ce=>!!Ce.tool)),l.value&&(oe=oe.filter(Ce=>(Ce.level||"INFO")===l.value)),x.value){const Ce=Dc.find(Ke=>Ke.value===x.value);if(Ce&&Ce.seconds){const Ke=new Date(Date.now()-Ce.seconds*1e3);oe=oe.filter(je=>je._time&&je._time>=Ke)}}if(o.value&&!Y.value)if(r.value)try{const Ce=new RegExp(o.value,"i");oe=oe.filter(Ke=>{const je=Ke.searchText,kt=Ke.tool||"";return Ce.test(je)||Ce.test(kt)})}catch{}else{const Ce=o.value.toLowerCase();oe=oe.filter(Ke=>{const je=Ke.searchText.toLowerCase(),kt=(Ke.tool||"").toLowerCase();return je.includes(Ce)||kt.includes(Ce)})}return oe}),K=H(()=>K1(le.value));function ve(oe){const Ce=Cd(oe,++s);if(n.value){w.value.push(Ce);return}Me(Ce)}function Me(oe){W1(t.value,oe,b),i.value&&zt(()=>ne())}function ne(oe=!1){const Ce=p.value;Ce&&Ce.scrollTo({top:Ce.scrollHeight,behavior:oe?"smooth":"instant"})}function ie(){i.value=!0,m.value=!1,zt(()=>ne(!0))}const fe=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function me(){const oe=p.value;if(!oe)return;const Ce=oe.scrollHeight-oe.scrollTop-oe.clientHeight<40;m.value=!i.value&&!Ce&&t.value.length>0,D.value&&ge()}function ge(){const oe=p.value;!oe||!i.value||oe.scrollHeight-oe.scrollTop-oe.clientHeight>=40&&(i.value=!1,m.value=t.value.length>0)}function Le(){i.value&&requestAnimationFrame(ge)}function A(oe){fe.has(oe.key)&&Le()}const D=f(!1);function G(){i.value&&(D.value=!0,requestAnimationFrame(ge))}function pe(){D.value&&(D.value=!1,ge())}function B(){i.value&&(m.value=!1,zt(()=>ne()))}function Z(){if(n.value=!n.value,!n.value&&w.value.length>0){for(const oe of w.value)Me(oe);w.value=[]}}function ue(){t.value=[],w.value=[],m.value=!1}function V(){let oe;e.value==="search"?oe=rt.value.map(kt=>{const St=kt.error?"ERROR":"INFO",cn=kt.tool_name?`[${kt.tool_name}] `:"";return`${kt.timestamp||""} ${St} ${cn}${kt.result_summary||kt.message||""}`}).join(`
`):oe=le.value.map(Nf).join(`

`);const Ce=new Blob([oe],{type:"text/plain"}),Ke=URL.createObjectURL(Ce),je=document.createElement("a");je.href=Ke,je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,je.click(),URL.revokeObjectURL(Ke)}function X(oe){const Ce=Nf(oe);navigator.clipboard.writeText(Ce).then(()=>{h.value=oe.id,setTimeout(()=>{h.value=null},1500)}).catch(()=>{})}function ee(oe){l.value=l.value===oe?"":oe,g.value="all",S.value=!1}function be(oe){return oe.level==="ERROR"?"log-line-error":oe.level==="WARNING"?"log-line-warning":"text-gray-300"}function he(oe){return oe==="ERROR"?"text-red-500 font-semibold":oe==="WARNING"?"text-yellow-500":"text-blue-500"}function we(oe){return oe==="ERROR"?"log-chip-error":oe==="WARNING"?"log-chip-warning":"log-chip-info"}function _e(oe){g.value=oe.id;const Ce=oe.filters;l.value=Ce.level||"",x.value=Ce.timeRange||"",o.value=Ce.text||"",S.value=!!Ce.hasToolName,Ce.levels&&(l.value=Ce.levels[0]||"")}function ye(oe){g.value=oe.id,l.value=oe.filters.level||"",x.value=oe.filters.timeRange||"",o.value=oe.filters.text||"",S.value=!!oe.filters.hasToolName}function We(){if(!R.value.trim())return;const oe={id:"custom-"+Date.now(),name:R.value.trim(),filters:{level:l.value,timeRange:x.value,text:o.value,hasToolName:S.value||void 0}};_.value=[..._.value,oe],U(),E.value=!1,R.value=""}function Je(oe){_.value=_.value.filter(Ce=>Ce.id!==oe),U(),g.value===oe&&(g.value="all")}const Fe=f("all"),qe=f(""),at=f(""),Xe=f(""),J=f(""),Ee=f(""),Ae=f(100),Ne=Q1,te=f(!1),Oe=f(!1),ze=f(""),rt=f([]),Zt=f(null),lt=f(null);function gt(){e.value="search",Zt.value||Yt()}async function Yt(){try{Zt.value=await j.get("/api/logs/stats")}catch{}}function cs(){const oe=Ee.value;if(!oe){Xe.value="",J.value="";return}const Ke={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[oe];if(Ke){const je=new Date(Date.now()-Ke*1e3);Xe.value=oa(je),J.value=""}}function oa(oe){const Ce=Ke=>String(Ke).padStart(2,"0");return`${oe.getFullYear()}-${Ce(oe.getMonth()+1)}-${Ce(oe.getDate())}T${Ce(oe.getHours())}:${Ce(oe.getMinutes())}`}function js(oe){if(!oe)return"";const Ce=new Date(oe);return isNaN(Ce.getTime())?"":Ce.toISOString()}let Ze=0;async function ra(){if(te.value)return;const oe=++Ze;te.value=!0,ze.value="",Oe.value=!0,lt.value=null;try{const Ce=new URLSearchParams;Fe.value&&Fe.value!=="all"&&Ce.set("level",Fe.value),qe.value&&Ce.set("tool",qe.value),at.value&&Ce.set("q",at.value);const Ke=js(Xe.value),je=js(J.value);Ke&&Ce.set("start",Ke),je&&Ce.set("end",je),Ce.set("limit",String(Ae.value));const kt=await j.get(`/api/logs/search?${Ce.toString()}`);if(oe!==Ze)return;rt.value=kt.entries||[]}catch(Ce){if(oe!==Ze)return;ze.value=Ce.message||"Search failed",rt.value=[]}finally{oe===Ze&&(te.value=!1)}}function vs(){Ze++,Fe.value="all",qe.value="",at.value="",Xe.value="",J.value="",Ee.value="",Ae.value=100,rt.value=[],Oe.value=!1,ze.value="",lt.value=null,te.value=!1}function Ms(oe){lt.value=lt.value===oe?null:oe}function gs(oe){if(!oe.timestamp)return"";try{return new Date(oe.timestamp).toLocaleString()}catch{return oe.timestamp}}function En(oe){return oe.type==="web_action"?`${oe.status||""} (${oe.execution_time_ms||0}ms)`:(oe.result_summary||"").slice(0,200)}function Qt(oe){return oe.error?"log-line-error":"text-gray-300"}function _t(oe){try{return JSON.stringify(oe,null,2)}catch{return String(oe)}}let ds=null,ba=!1;function rn(){ba||(ba=!0,ut.subscribe("logs",ve),c.value=ut.connected,d.value=ut.state||"disconnected",ds=ut.onState(oe=>{d.value=oe,c.value=oe==="connected"}))}function ca(){ba&&(ba=!1,ut.unsubscribe("logs",ve),ds&&(ds(),ds=null))}return st(()=>{O(),window.addEventListener("pointerup",pe),window.addEventListener("pointercancel",pe)}),rs(rn),Kt(ca),xt(()=>{ca(),window.removeEventListener("pointerup",pe),window.removeEventListener("pointercancel",pe)}),{mode:e,logs:t,paused:n,autoScroll:i,levelFilter:l,textFilter:o,useRegex:r,groupByTurn:a,groupedLogs:K,subscribed:c,wsState:d,wsStateLabel:u,logContainer:p,filteredLogs:le,pauseBuffer:w,showJumpBottom:m,copiedIndex:h,regexError:Y,levels:I,logPresets:k,timeRanges:y,timeRange:x,toolOnly:S,activeLogPreset:g,customLogPresets:_,showSaveLogPreset:E,newLogPresetName:R,hasActiveLogFilters:T,timeRangeLabel:$,timelineBuckets:M,timelineMax:L,timelineSpanLabel:P,timelineLabelSkip:re,togglePause:Z,clearLogs:ue,exportLogs:V,logLineClass:be,levelClass:he,levelChipClass:we,toggleLevel:ee,copyLine:X,jumpToBottom:ie,onScroll:me,onUserScrollIntent:Le,onUserScrollKey:A,onAutoScrollToggle:B,onPointerDown:G,applyLogPreset:_e,applyCustomLogPreset:ye,saveLogCustomPreset:We,removeLogCustomPreset:Je,segmentHeight:z,jumpToTimelineBucket:se,searchLevel:Fe,searchTool:qe,searchKeyword:at,searchStart:Xe,searchEnd:J,searchTimePreset:Ee,searchLimit:Ae,searchLimits:Ne,searching:te,searchRan:Oe,searchError:ze,searchResults:rt,searchStats:Zt,expandedSearch:lt,switchToSearch:gt,runSearch:ra,clearSearchFilters:vs,toggleSearchExpand:Ms,formatSearchTs:gs,searchEntryText:En,searchLogLineClass:Qt,formatJson:_t,applySearchTimePreset:cs}}};function Lo(e=[]){const t=[],s=new Set;function a(n){const i=[n.kind,n.label,n.apply_mode||"",n.code||"",n.text||""].join("\0");s.has(i)||(s.add(i),t.push({...n,key:i}))}for(const n of e)for(const i of(n==null?void 0:n.consumers)||[])a({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const n of e)n!=null&&n.apply_handler&&a({kind:"handler",label:"Apply handler",code:n.apply_handler});for(const n of e)n!=null&&n.restart_reason&&a({kind:"restart",label:"Why a restart is required",text:n.restart_reason});for(const n of e)n!=null&&n.activation_policy&&a({kind:"activation",label:"Activation policy",text:n.activation_policy});return t}const eC=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function tC(e,t={}){var n,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),a=Object.hasOwn(t,"fallback")?t.fallback:(n=globalThis.document)==null?void 0:n.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return a&&a.scrollHeight>a.clientHeight?a:e||a||null}const $i=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["grafana_alerts","outbound_webhooks"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],sC={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},No=new Set(["llm_provider","openai_codex","ollama","openai_compatible","kimi","personality","discord","computer"]),aC=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Df(e){return aC.some(t=>e===t||e.startsWith(`${t}.`))}const Sg="odin_config_center_expanded_v1",Cg="odin_config_center_category_v1",nC=50,iC=650,ml=()=>j.get("/api/config/meta");function Un(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ei(e,t){return JSON.stringify(e)===JSON.stringify(t)}function bi(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function lC(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function oC(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Tg(e,t){if(Ei(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Un(t);const a={};for(const[n,i]of Object.entries(t)){const l=Tg(e[n],i);l!==void 0&&(a[n]=l)}return Object.keys(a).length?a:void 0}function rC(e,t){const s={};for(const[a,n]of Object.entries(t||{})){const i=Tg(e==null?void 0:e[a],n);i!==void 0&&(s[a]=i)}return s}function Eg(e,t,s,a){if(Ei(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Eg(e[l],t[l],s?`${s}.${l}`:l,a);return}a.push({path:s,oldVal:e,newVal:t})}function cC(){try{const e=JSON.parse(localStorage.getItem(Sg)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function dC(){try{const e=localStorage.getItem(Cg);return $i.some(t=>t.key===e)?e:$i[0].key}catch{return $i[0].key}}const uC={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),a=f(null),n=f(!1),i=f(null),l=f(!1),o=f(""),r=f(!1),c=f(""),d=f(""),u=f("");function p(C){i.value=C||null,C&&typeof C.authorized=="boolean"&&(l.value=C.authorized)}async function m(){try{const C=await j.get("/api/setup/status");p(C.listener),u.value=""}catch(C){p(null),u.value=`Listener status could not be loaded: ${C.message||"Unknown error"}`}}async function h(){if(!(!pe.value||!o.value.trim()||r.value||G.value)){r.value=!0,c.value="",d.value="";try{const C=j.setListenerExposure(o.value.trim(),l.value);o.value="";const q=await C;c.value=q.message,p(q.listener)}catch(C){d.value=C.message||"Listener consent could not be saved."}finally{o.value="",r.value=!1}}}const b=f(null),I=["image_model","outer_model"],k=f(null),y=f(null),g=f(null),x=f(!1),S=f(!1),_=f(null),E=f(""),R=f("all"),w=f(dC()),O=f(cC()),U=f({}),T=f({}),$=f(""),Y=f({}),W=f({}),M=f([]),L=f([]),P=f(!1),re=f(!1),ce=f(!1);let z=null,se=null,le={path:null,at:0},K=0;const ve=H(()=>{var C;return(((C=t.value)==null?void 0:C.fields)||[]).filter(q=>!No.has(q.path.split(".")[0])&&!Df(q.path))}),Me=H(()=>new Map(ve.value.map(C=>[C.path,C]))),ne=H(()=>Le.value.reduce((C,q)=>C+q.sections.length,0)),ie=H(()=>ve.value.length),fe=H(()=>eC),me=H(()=>M.value.length>0),ge=H(()=>L.value.length>0),Le=H(()=>{if(!e.value)return[];const C=new Set($i.flatMap(ke=>ke.sections)),q=$i.map(ke=>({...ke,sections:ke.sections.filter(Ge=>Object.hasOwn(e.value,Ge)&&!No.has(Ge))})).filter(ke=>ke.sections.length),ae=Object.keys(e.value).filter(ke=>!C.has(ke)&&!No.has(ke));return ae.length&&q.push({key:"other",label:"Other",icon:"folder",sections:ae}),q}),A=H(()=>e.value?{...e.value,...U.value}:null),D=H(()=>{if(!e.value)return[];const C=[];for(const[q,ae]of Object.entries(U.value))Eg(e.value[q],ae,q,C);return C.filter(q=>!Ei(q.oldVal,q.newVal)).map(q=>{const ae=at(q.path);return{...q,label:(ae==null?void 0:ae.label)||bi(q.path.split(".").at(-1)),apply_mode:(ae==null?void 0:ae.apply_mode)||Oe(q.path.split(".")[0])}})}),G=H(()=>D.value.length>0),pe=H(()=>!!i.value&&l.value!==i.value.authorized),B=H(()=>{var q;const C=(q=i.value)==null?void 0:q.state;return C==="active"||C==="authorized_loopback"?"active":["pending_widening","pending_narrowing","active_rebind_pending"].includes(C)?"pending":C==="restricted"?"restricted":"unknown"}),Z=H(()=>{var C;return{active:"Exposure active",authorized_loopback:"Authorized · loopback host",pending_widening:"Authorized · restart pending",pending_narrowing:"Restriction saved · restart pending",active_rebind_pending:"Exposed · restart pending",restricted:"Loopback only",unknown:"Runtime state unavailable"}[(C=i.value)==null?void 0:C.state]||"Loading listener state"}),ue=H(()=>i.value?i.value.authorized?i.value.authorization_source==="explicit"?"Beyond-loopback access is explicitly authorized":"Beyond-loopback access is retained from this installation":"Beyond-loopback access is not authorized":"Unavailable"),V=H(()=>{var C;return{explicit:"saved explicitly in config.yml",default:"schema default; no web.host key is saved",unknown:"source could not be verified"}[(C=i.value)==null?void 0:C.configured_host_source]||"source unavailable"}),X=H(()=>{const C=i.value;return!C||C.running_scope==="unavailable"?"Actual bound address unavailable":`${(C.listening_hosts||[]).map((ae,ke)=>{var Ct;const Ge=(Ct=C.listening_ports)==null?void 0:Ct[ke];return Ge?`${ae}:${Ge}`:ae}).join(", ")} · ${C.running_scope==="loopback"?"loopback only":"accepting beyond loopback"}`}),ee=H(()=>D.value.length),be=H(()=>new Set(D.value.map(C=>C.path.split(".")[0])).size),he=H(()=>!!E.value||R.value!=="all"),we=H(()=>{const C={...W.value};for(const q of D.value){const ae=at(q.path),ke=de(ae,q.newVal);ke&&(C[q.path]=ke)}return C}),_e=H(()=>Object.keys(we.value).length>0),ye=H(()=>e.value?(he.value?Le.value:Le.value.filter(q=>q.key===w.value)).map(q=>({...q,sections:q.sections.filter(ae=>Qt(ae))})).filter(q=>q.sections.length):[]),We=H(()=>{const C=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],q=new Map(C.map(ae=>[ae,[]]));for(const ae of D.value){const ke=q.has(ae.apply_mode)?ae.apply_mode:"restart";q.get(ke).push(ae)}return C.filter(ae=>q.get(ae).length).map(ae=>({key:ae,label:bs(ae),entries:q.get(ae)}))}),Je=H(()=>D.value.filter(C=>C.apply_mode==="restart").length),Fe=H(()=>ve.value.filter(C=>C.pending_restart)),qe=H(()=>Fe.value.length);function at(C){const q=Me.value.get(C);return q?{...q,apply_details:Lo([q])}:null}function Xe(C){const q=`${C}.`;return ve.value.filter(ae=>ae.path===C||ae.path.startsWith(q))}function J(){return ve.value.some(C=>C.path==="tools.hosts"||C.path.startsWith("tools.hosts."))}function Ee(){var ae,ke;const C=((ke=(ae=e.value)==null?void 0:ae.tools)==null?void 0:ke.hosts)||{},q=Object.keys(C).length;return`${q} host${q===1?"":"s"} configured.`}function Ae(C){return Xe(C).length}function Ne(C){return bi(C)}function te(C){const q=Xe(C);if(!q.length)return`${bi(C)} configuration.`;const ae=q.find(Ct=>Ct.sensitivity==="public"&&Ct.description)||q.find(Ct=>Ct.description),ke=(ae==null?void 0:ae.description)||"";return ke.match(/setting for (.+)\.$/i)?`${bi(C)} settings and runtime behaviour.`:ke}function Oe(C){const q=[...new Set(Xe(C).map(ae=>ae.apply_mode))];return q.length===1?q[0]:q.includes("restart")?"restart":q.includes("activation_required")?"activation_required":q[0]||"restart"}function ze(C){const q=[...new Set(Xe(C).map(ae=>bs(ae.apply_mode)))];return q.length?q.length===1?q[0]:`Mixed apply behaviour: ${q.join(" · ")}`:""}function rt(C){return Lo(Xe(C))}function Zt(C){var q;return Object.hasOwn(U.value,C)?U.value[C]:(q=e.value)==null?void 0:q[C]}function lt(){const C=Zt("mcp")||{},q=Object.keys(C.servers||{}).length;return`${C.enabled?"Globally enabled":"Globally disabled"} · ${q} configured server${q===1?"":"s"}.`}function gt(C,q){return q.split(".").reduce((ae,ke)=>ae==null?void 0:ae[ke],C)}function Yt(C){const q=A.value;return Xe(C).filter(ae=>Df(ae.path)?!1:ae.path.split(".").length<=2?!0:!ae.path.includes(".*")).map(ae=>({...ae,key:ae.path.split(".").at(-1),value:gt(q,ae.path),apply_details:Lo([ae]),editor:ae.path==="agents.final_warning_iterations"?"warning-chips":null}))}function cs(C){const q=C.path.split(".");return q.length>2?q.slice(0,2).join("."):null}function oa(C){const q=new Map;for(const ae of Yt(C)){const ke=cs(ae),Ge=ke||`${C}.__root`;q.has(Ge)||q.set(Ge,{key:Ge,path:ke,entries:[]}),q.get(Ge).entries.push(ae)}return[...q.values()].map(ae=>{const ke=ae.entries.find(Ge=>Ge.group_description);return{...ae,label:ae.path?bi(ae.path.split(".").at(-1)):null,description:(ke==null?void 0:ke.group_description)||null,apply_details:Lo(ae.entries),runtime_summaries:Ze(ae.entries)}})}function js(C){return{save:C.save_effect||(C.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:C.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[C.apply_mode]||"Effective runtime state is not currently observable."}}function Ze(C){const q=new Map;for(const ae of C){const ke=js(ae),Ge=`${ae.apply_mode}|${ke.save}|${ke.runtime}`;q.has(Ge)||q.set(Ge,{key:Ge,label:bs(ae.apply_mode),save:ke.save,runtime:ke.runtime})}return[...q.values()]}function ra(C){if(vs(C))return C.runtime_effect||C.activation_policy||"";if(C.apply_mode==="activation_required"){const q=C.activation_policy||C.runtime_effect;return q?`Not active after saving. No activation control exists in this release. ${q}`:"Not active after saving; no activation control exists in this release."}return""}function vs(C){return C.action_available===!0&&!!(C.action_label&&C.action_endpoint)}async function Ms(C){if(vs(C))try{if(ca(C.path))throw new Error("Save this setting before applying its action.");const q=String(C.action_method||"POST").toLowerCase(),ae={post:j.post.bind(j),put:j.put.bind(j),delete:j.del.bind(j)}[q];if(!ae)throw new Error("Unsupported configuration action");await ae(C.action_endpoint,C.action_body||void 0),await Xi(),Ma("success",`${C.action_label} completed.`)}catch(q){Ma("error",q.message||`${C.action_label} failed`)}}function gs(C,q){return[C.label,C.path,C.description,...C.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(q)}function En(C){const q=E.value.trim().toLowerCase();return q?Xe(C).filter(ae=>gs(ae,q)):[]}function Qt(C){const q=Xe(C);if(R.value!=="all"&&!q.some(ke=>ke.apply_state===R.value))return!1;const ae=E.value.trim().toLowerCase();return!ae||`${Ne(C)} ${C}`.toLowerCase().includes(ae)?!0:q.some(ke=>gs(ke,ae))}function _t(C,q){return Xe(C).filter(ae=>ae.apply_state===q).length}function ds(C){return C==="all"?ie.value:ve.value.filter(q=>q.apply_state===C).length}function ba(C){const q=C.sections.flatMap(ae=>Xe(ae));return{fields:q.length,modified:D.value.filter(ae=>C.sections.includes(ae.path.split(".")[0])).length,pending_restart:q.filter(ae=>ae.apply_state==="pending_restart").length,invalid:q.filter(ae=>ae.apply_state==="invalid").length,dormant:q.filter(ae=>ae.apply_state==="dormant").length}}function rn(C){var q;return Object.hasOwn(U.value,C)&&!Ei((q=e.value)==null?void 0:q[C],U.value[C])}function ca(C){return D.value.some(q=>q.path===C||q.path.startsWith(`${C}.`))}function oe(C){w.value=C,E.value="",R.value="all";try{localStorage.setItem(Cg,C)}catch{}}function Ce(C){R.value=C}function Ke(){E.value="",R.value="all"}function je(C){var q;return((q=Le.value.find(ae=>ae.sections.includes(C)))==null?void 0:q.sections)||[]}function kt(C){const q=je(C),ae=q.find(ke=>O.value[ke]===!0);return ae||q.find(ke=>O.value[ke]!==!1)||null}function St(C){return E.value&&!ce.value&&Qt(C)?!0:ce.value?kt(C)===C:Object.hasOwn(O.value,C)?O.value[C]===!0:!0}function cn(C){const q=!St(C);if(ce.value){const ae={...O.value};for(const ke of je(C))ae[ke]===!0&&(ae[ke]=!1);ae[C]=q,O.value=ae;return}O.value={...O.value,[C]:q}}function An(){M.value.push(Un(U.value)),M.value.length>nC&&M.value.shift(),L.value=[]}function dn(){n.value||G.value&&(An(),U.value={},W.value={},P.value=!1)}function Rn(C,q=!1){const ae=Date.now();if(q&&le.path===C&&ae-le.at<iC){le.at=ae;return}An(),le={path:C,at:ae}}function da(C,q,ae){if(!q.length)return ae;const ke=Un(C??{});let Ge=ke;for(let Ct=0;Ct<q.length-1;Ct+=1){const Vs=q[Ct];Ge[Vs]=Un(Ge[Vs]??{}),Ge=Ge[Vs]}return Ge[q.at(-1)]=ae,ke}function ya(C){var q;return Object.hasOwn(U.value,C)?U.value[C]:Un((q=e.value)==null?void 0:q[C])}function jt(C,q,ae={}){var pn;if(n.value||No.has(C.path.split(".")[0]))return;const[ke,...Ge]=C.path.split(".");Rn(C.path,!!ae.coalesce);const Ct=ya(ke),Vs=Ge.length?da(Ct,Ge,q):q,qs={...U.value};if(Ei(Vs,(pn=e.value)==null?void 0:pn[ke])?delete qs[ke]:qs[ke]=Vs,U.value=qs,W.value[C.path]){const xa={...W.value};delete xa[C.path],W.value=xa}}function ua(C){le={path:null,at:0},T.value={...T.value,[C]:String(gt(A.value,C)??"")}}function as(C){if(le={path:null,at:0},!Object.hasOwn(T.value,C))return;const q={...T.value};delete q[C],T.value=q}function un(C){const q=T.value[C.path];if(le={path:null,at:0},q===""){if(C.nullable){as(C.path),jt(C,null,{coalesce:!0});return}W.value={...W.value,[C.path]:"Enter a number."};return}const ae=Number(q);if(Number.isNaN(ae)||C.type==="integer"&&!Number.isInteger(ae)){W.value={...W.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a number."};return}const ke={...T.value};delete ke[C.path],T.value=ke,jt(C,ae,{coalesce:!0})}function In(C){return Object.hasOwn(T.value,C.path)?T.value[C.path]:C.value??""}function li(C,q){if(T.value={...T.value,[C.path]:q},q===""){if(C.nullable){jt(C,null,{coalesce:!0});return}W.value={...W.value,[C.path]:"Enter a number."};return}const ae=Number(q);if(!Number.isFinite(ae)||C.type==="integer"&&!Number.isInteger(ae)){W.value={...W.value,[C.path]:C.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(W.value[C.path]){const ke={...W.value};delete ke[C.path],W.value=ke}jt(C,ae,{coalesce:!0})}function oi(C){const q=Number.parseInt($.value,10);if(!Number.isInteger(q)||q<1){W.value={...W.value,[C.path]:"Warning thresholds must be positive whole numbers."};return}const ae=[...new Set([...C.value||[],q])].sort((ke,Ge)=>Ge-ke);$.value="",jt(C,ae)}function ri(C,q){jt(C,(C.value||[]).filter(ae=>ae!==q))}function ns(C){return C.apply_mode==="live_read"?"Odin reads the saved file value on next use.":C.apply_mode==="live_for_new_work"?"New work uses the saved file value.":C.apply_mode==="live_apply"?C.apply_handler?`Apply the saved value through ${C.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":C.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":C.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":C.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function On(C){return C.type==="array"&&Array.isArray(C.value)&&!C.structured_container&&!C.structured_container_child&&C.sensitivity==="public"&&C.value.every(q=>["string","number","boolean"].includes(typeof q))}function Re(C){const q=String(Y.value[C.path]??"").trim();if(!q)return;const ae=[...new Set([...C.value||[],q])];Y.value={...Y.value,[C.path]:""},jt(C,ae)}function N(C,q){jt(C,(C.value||[]).filter(ae=>ae!==q))}function de(C,q){var ke;if(!C)return null;if((ke=C.enum)!=null&&ke.length&&!C.enum.includes(q))return`Choose one of: ${C.enum.join(", ")}`;if(C.path==="agents.final_warning_iterations"&&(!Array.isArray(q)||!q.length))return"Add at least one warning threshold.";const ae=C.constraints||{};if((C.type==="integer"||C.type==="number")&&typeof q=="number"){if(ae.minimum!==void 0&&q<ae.minimum)return`Must be at least ${ae.minimum}${C.unit?` ${C.unit}`:""}`;if(ae.maximum!==void 0&&q>ae.maximum)return`Must be at most ${ae.maximum}${C.unit?` ${C.unit}`:""}`}return null}function xe(C){return we.value[C.path]||null}function Be(C){const q=`${C}.`;return Object.keys(we.value).some(ae=>ae===C||ae.startsWith(q))}function Ve(){n.value||M.value.length&&(L.value.push(Un(U.value)),U.value=M.value.pop(),W.value={},T.value={},le={path:null,at:0})}function Qe(){n.value||L.value.length&&(M.value.push(Un(U.value)),U.value=L.value.pop(),W.value={},T.value={},le={path:null,at:0})}function Et(){!G.value||_e.value||(P.value=!0,re.value=!1)}function pt(){P.value=!1}function At(){dn()}function bs(C){return sC[C]||bi(C||"unknown")}function Nt(C){return`apply-${String(C||"unknown").replaceAll("_","-")}`}function Na(C){return`cfgc-field-${C.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function ci(C){return`${Na(C)}-input`}function mo(C){const q=document.getElementById(Na(C))||document.getElementById(Na(C.split(".").slice(0,2).join(".")));q==null||q.scrollIntoView({behavior:"smooth",block:"center"})}function Ma(C,q){y.value={type:C,message:q},window.setTimeout(()=>{var ae;((ae=y.value)==null?void 0:ae.message)===q&&(y.value=null)},3500)}function ac(){x.value=!1,R.value="pending_restart",E.value="";const C=tC(a.value);C&&(C.scrollTop=0)}function ho(){x.value=!1}function di(C=1800){se&&window.clearTimeout(se),se=window.setTimeout(nc,C)}async function nc(){if(S.value){if(K+=1,K>45){S.value=!1,_.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await ml(),qe.value===0){S.value=!1,_.value=null,Ma("success","Odin restarted and the saved startup settings are active.");return}}catch{}di(2e3)}}async function Ln(){if(!S.value){_.value=null;try{await j.post("/api/restart",{}),S.value=!0,K=0,x.value=!1,di()}catch(C){_.value=C.message||"Odin could not schedule a restart."}}}async function ic(){if(!(!G.value||_e.value||n.value)){n.value=!0;try{const C=rC(e.value,U.value),q=await j.put("/api/config",C);e.value=q,U.value={},M.value=[],L.value=[],W.value={},P.value=!1;try{t.value=await ml(),g.value=null,x.value=qe.value>0,Ma("success",qe.value?`Configuration saved. ${qe.value} setting${qe.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(ae){g.value=ae.message||"Unknown metadata error.",Ma("error",`Configuration saved, but apply status could not be refreshed: ${g.value}`)}}catch(C){Ma("error",C.message||"Configuration could not be saved")}finally{n.value=!1}}}async function Da(){if(!n.value){n.value=!0,b.value=null;try{t.value=await ml(),g.value=null}catch(C){b.value=`Image model status could not be refreshed: ${C.message||"Unknown error"}`}finally{n.value=!1}}}async function lc(C,q){if(n.value||!["follow","pin"].includes(q)||!C.length||C.some(ke=>{var Ge,Ct;return!I.includes(ke)||!((Ct=(Ge=t.value)==null?void 0:Ge.image_model_defaults)!=null&&Ct[ke])}))return;n.value=!0,b.value=null;let ae=!1;try{const ke=await j.post("/api/config/image-models",{operations:Object.fromEntries(C.map(Ge=>[Ge,q])),expected_revision:t.value.image_model_revision});ae=!0;for(const Ge of C){const Ct=`image.openai.${Ge}`,Vs=gt(e.value,Ct),qs=gt(ke.config,Ct),pn=xa=>!Object.hasOwn(xa,"image")||!Ei(gt(xa,Ct),Vs)?xa:da(xa,Ct.split("."),qs);U.value=pn(U.value),M.value=M.value.map(pn),L.value=L.value.map(pn),e.value=da(e.value,Ct.split("."),qs)}t.value={...t.value,image_model_defaults:ke.image_model_defaults,image_model_revision:ke.image_model_revision},Ma("success","Image model defaults saved. Unrelated drafts were not saved.")}catch(ke){b.value=`Image model operation failed: ${ke.message||"Unknown error"}. Refresh status before retrying if the outcome is uncertain.`}try{t.value=await ml(),g.value=null}catch(ke){const Ge=`Image model status could not be refreshed: ${ke.message||"Unknown error"}`;g.value=Ge,b.value=ae?`Image model defaults were saved, but ${Ge}`:`${b.value} ${Ge}`}finally{n.value=!1}}async function Xi(){var C,q;if(!(G.value||n.value)){s.value=!0,k.value=null;try{const ae=await j.get("/api/config"),ke=await ml();await m(),e.value=ae,t.value=ke,g.value=null;const Ge=Le.value;if(Ge.some(Ct=>Ct.key===w.value)||(w.value=((C=Ge[0])==null?void 0:C.key)||$i[0].key),ce.value){const Vs=(((q=Ge.find(qs=>qs.key===w.value))==null?void 0:q.sections)||[]).find(qs=>O.value[qs]===!0);O.value=Vs?{...O.value,[Vs]:!0}:{}}}catch(ae){k.value=ae.message||"Unknown configuration error"}finally{s.value=!1}}}function Pa(C){if(P.value||!(C.ctrlKey||C.metaKey))return;const q=C.target;q instanceof HTMLElement&&(q.matches("input, textarea, select")||q.isContentEditable)||(!C.shiftKey&&C.key.toLowerCase()==="z"?(C.preventDefault(),Ve()):(C.key.toLowerCase()==="y"||C.shiftKey&&C.key.toLowerCase()==="z")&&(C.preventDefault(),Qe()))}function el(C){ce.value=C.matches}Wt(O,C=>{try{localStorage.setItem(Sg,JSON.stringify(C))}catch{}},{deep:!0});let ui=!1;function tl(){ui||(ui=!0,document.addEventListener("keydown",Pa))}function sl(){ui&&(ui=!1,document.removeEventListener("keydown",Pa))}return st(()=>{var C;Xi(),tl(),z=window.matchMedia("(max-width: 760px)"),el(z),(C=z.addEventListener)==null||C.call(z,"change",el)}),rs(tl),Kt(sl),Kt(()=>{o.value=""}),xt(()=>{var C;o.value="",sl(),(C=z==null?void 0:z.removeEventListener)==null||C.call(z,"change",el),se&&window.clearTimeout(se)}),{listenerState:i,listenerConsent:l,listenerCredential:o,listenerSaving:r,listenerMessage:c,listenerError:d,listenerStatusError:u,listenerChoiceChanged:pe,listenerStatusTone:B,listenerStatusLabel:Z,listenerAuthorizationCopy:ue,listenerConfiguredSourceCopy:V,listenerRunningCopy:X,saveListenerConsent:h,armKeydown:tl,disarmKeydown:sl,handleKeydown:Pa,config:e,meta:t,loading:s,saving:n,error:k,toast:y,metaRefreshError:g,restartPromptOpen:x,restartScheduled:S,restartError:_,configMain:a,imageModelError:b,imageModelLeaves:I,setImageModelDefaults:lc,refreshImageModelMetadata:Da,searchQuery:E,healthFilter:R,activeCategory:w,reviewOpen:P,mobileOverflowOpen:re,warningThresholdInput:$,arrayInputs:Y,healthFilters:fe,visibleCategories:Le,displayGroups:ye,reviewGroups:We,sectionCount:ne,fieldCount:ie,hasChanges:G,changeCount:ee,changedSectionCount:be,hasDraftErrors:_e,canUndo:me,canRedo:ge,globalFilterActive:he,reviewRestartCount:Je,pendingRestartCount:qe,pendingRestartFields:Fe,healthCount:ds,categoryStats:ba,selectCategory:oe,selectHealthFilter:Ce,clearFilters:Ke,sectionLabel:Ne,sectionDescription:te,sectionFieldCount:Ae,sectionHealthCount:_t,sectionApplySummary:ze,sectionApplyDetails:rt,sectionEntries:Yt,fieldGroups:oa,sectionSearchHits:En,mcpConfigSummary:lt,fieldRuntimeCopy:js,fieldSpecificRuntimeNote:ra,hasHonestAction:vs,runFieldAction:Ms,hasHostsCollection:J,hostsConfigSummary:Ee,sectionChanged:rn,fieldChanged:ca,isSectionExpanded:St,toggleSection:cn,discardAllDrafts:dn,setFieldValue:jt,setNumberFieldValue:li,numberInputValue:In,beginInputEdit:ua,endTextInputEdit:as,endInputEdit:un,addWarningThreshold:oi,removeWarningThreshold:ri,isScalarArray:On,addScalarArrayItem:Re,removeScalarArrayItem:N,fieldError:xe,sectionHasErrors:Be,undo:Ve,redo:Qe,openReview:Et,closeReview:pt,mobileCancel:At,applyModeLabel:bs,applyClass:Nt,compactValue:lC,formatValue:oC,structuredApplyCopy:ns,fieldId:Na,fieldInputId:ci,focusField:mo,fetchConfig:Xi,saveConfig:ic,restartOdin:Ln,restartLater:ho,reviewPendingRestart:ac}}},pC=/^\d{15,25}$/;function Ag(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Rg={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1},showAddButton:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),a=f(!1),n=f(0),i=f(null),l=H(()=>new Set((e.excludedIds||[]).map(String))),o=H(()=>{const _=s.value.toLowerCase().trim();return(e.members||[]).filter(E=>l.value.has(String(E.id))?!1:_?p(E).toLowerCase().includes(_)||String(E.username||"").toLowerCase().includes(_)||String(E.id).includes(_):!0)}),r=H(()=>{const _=s.value.trim();return o.value.length===0&&pC.test(_)&&!l.value.has(_)?_:""}),c=H(()=>o.value.length+(r.value?1:0)),d=H(()=>!!s.value.trim()&&!!(o.value[n.value]||r.value&&n.value===o.value.length)),u=H(()=>{if(a.value){if(o.value[n.value])return`${e.optionsId}-${n.value}`;if(r.value&&n.value===o.value.length)return`${e.optionsId}-raw`}});function p(_){return Ag(_)}function m(){a.value=!0,n.value=0}function h(){m()}function b(){const _=Math.max(c.value-1,0);n.value=Math.min(n.value+1,_)}function I(){n.value=Math.max(n.value-1,0)}function k(){const _=o.value[n.value];_?y(_):r.value&&n.value===o.value.length&&g(r.value)}function y(_){g(String(_.id))}function g(_){t("select",_),s.value="",a.value=!1,n.value=0}function x(){a.value=!1}function S(){setTimeout(x,150)}return st(()=>{e.autofocus&&zt(()=>{var _;return(_=i.value)==null?void 0:_.focus()})}),{query:s,open:a,highlightedIndex:n,input:i,filteredMembers:o,rawId:r,activeOptionId:u,selectableValue:d,memberName:p,openOptions:m,onInput:h,highlightNext:b,highlightPrevious:I,selectHighlighted:k,selectMember:y,selectId:g,closeOptions:x,onBlur:S}}};function Pf(e,t,s){var a;return((a=e==null?void 0:e.config)==null?void 0:a[t])!=null?e.config[t]:s==null?void 0:s[t]}const fC={components:{DiscordUserCombobox:Rg},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f({persisted:!1,credential_usable:!1,credential_preferred_storage:!1,connection:{state:"unavailable",detail:"Connection status unavailable"}}),s=f(""),a=f(!1),n=f(!1),i=f(null);let l=null;const o=f(!0),r=f(null),c=f({}),d=f(null),u=f(null),p=f(!1),m=f(null),h=f({}),b=f([]);let I=0;const k=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search users",userAutocomplete:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Search channels"},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Bot ID",userAutocomplete:!0}]),y=H(()=>{var ge,Le,A,D;const ie=String(((Le=(ge=t.value)==null?void 0:ge.connection)==null?void 0:Le.state)||"").toLowerCase();return{...{connected:{key:"connected",label:"Connected",badgeClass:"badge-success"},connecting:{key:"connecting",label:"Connecting",badgeClass:"badge-warning"},disconnected:{key:"disconnected",label:"Disconnected",badgeClass:""},detached:{key:"disconnected",label:"Disconnected",badgeClass:""},detaching:{key:"disconnected",label:"Disconnected",badgeClass:""},stopped:{key:"unavailable",label:"Unavailable",badgeClass:"badge-warning"},failed:{key:"unavailable",label:"Unavailable",badgeClass:"badge-warning"}}[ie]||{key:"unavailable",label:"Unavailable",badgeClass:"badge-warning"},detail:((D=(A=t.value)==null?void 0:A.connection)==null?void 0:D.detail)||"Connection status unavailable"}}),g=H(()=>JSON.stringify(d.value)!==JSON.stringify(u.value)),x=H(()=>new Map(b.value.map(ie=>[String(ie.id),ie])));function S(ie){return ie.config&&ie.config.enabled!==void 0?ie.config.enabled:!0}function _(ie){return Pf(ie,"require_mention",d.value)}function E(ie){return Pf(ie,"respond_to_bots",d.value)}function R(ie){return ie.config&&Object.keys(ie.config).length>0}function w(ie){c.value[ie]=!c.value[ie]}function O(ie){const fe=ie.discord||{};return{allowed_users:[...fe.allowed_users||[]],channels:[...fe.channels||[]],respond_to_bots:!!fe.respond_to_bots,require_mention:!!fe.require_mention,ignore_bot_ids:[...fe.ignore_bot_ids||[]]}}async function U({showLoading:ie=!0}={}){const fe=++I;ie&&(o.value=!0),r.value=null;try{const me=await j.get("/api/discord/guilds");fe===I&&(e.value=me)}catch(me){fe===I&&(r.value=me.message)}finally{ie&&fe===I&&(o.value=!1)}}async function T(){try{t.value=await j.get("/api/discord/connection"),i.value=null}catch(ie){i.value=ie.message}}async function $(ie,fe=null){if(!n.value){n.value=!0,i.value=null;try{const me={operation:ie};fe!==null&&(me.token=fe),t.value=await j.post("/api/discord/connection",me),ie==="credentials"&&(s.value="",a.value=!1)}catch(me){i.value=me.message||"Connection update failed."}finally{n.value=!1}}}function Y(){if(!(!a.value||!s.value))return $("credentials",s.value)}function W(){return $("connect")}function M(){return $("detach")}async function L(){o.value=!0,r.value=null;try{const[ie,fe,me]=await Promise.all([j.get("/api/discord/guilds"),j.get("/api/discord/members").catch(()=>[]),j.get("/api/config")]),ge=O(me),Le=g.value;d.value=ge,Le||(u.value=JSON.parse(JSON.stringify(ge))),b.value=fe,e.value=ie,m.value=null}catch(ie){r.value=ie.message}finally{o.value=!1}}let P=Promise.resolve();const re=f(new Set);function ce(ie,fe){const me=new Set(re.value);me.add(ie),re.value=me;const ge=P.then(fe);return P=ge.catch(()=>{}),ge.finally(()=>{const Le=new Set(re.value);Le.delete(ie),re.value=Le})}function z(ie,fe,me,ge){const Le=(ge==null?void 0:ge.target)??null;return ce(`guild:${ie}:${fe}`,async()=>{try{await j.put("/api/discord/guild/"+ie+"/config",{[fe]:me}),await U({showLoading:!1})}catch(A){r.value=A.message,Le&&typeof me=="boolean"&&(Le.checked=!me)}})}function se(ie,fe,me,ge,Le){const A=(Le==null?void 0:Le.target)??null;return ce(`channel:${ie}:${me}`,async()=>{try{await j.put("/api/discord/channel/"+ie+"/config",{[me]:ge}),await U({showLoading:!1})}catch(D){r.value=D.message,A&&typeof ge=="boolean"&&(A.checked=!ge)}})}function le(ie,fe){return ce(`channel:${ie}:clear`,async()=>{try{await j.put("/api/discord/channel/"+ie+"/config",{clear:!0}),await U({showLoading:!1})}catch(me){r.value=me.message}})}function K(ie,fe){const me=String(fe);if(!ie.userAutocomplete)return me;const ge=x.value.get(me);return ge?Ag(ge):me}function ve(ie,fe=null){const me=String(fe??h.value[ie]??"").trim();!me||u.value[ie].includes(me)||(u.value[ie]=[...u.value[ie],me],h.value={...h.value,[ie]:""})}function Me(ie,fe){u.value[ie]=u.value[ie].filter(me=>me!==fe)}async function ne(){if(!(!g.value||p.value)){p.value=!0,m.value=null;try{const fe=(await j.put("/api/config",{discord:u.value})).discord||u.value;d.value={allowed_users:[...fe.allowed_users||[]],channels:[...fe.channels||[]],respond_to_bots:!!fe.respond_to_bots,require_mention:!!fe.require_mention,ignore_bot_ids:[...fe.ignore_bot_ids||[]]},u.value=JSON.parse(JSON.stringify(d.value))}catch(ie){m.value=ie.message||"Global defaults could not be saved."}finally{p.value=!1}}}return st(()=>{L(),T(),l=window.setInterval(T,5e3)}),xt(()=>{l!==null&&window.clearInterval(l),l=null}),{guilds:e,loading:o,error:r,expanded:c,globalDraft:u,globalSaving:p,globalError:m,globalArrayInputs:h,globalMembers:b,globalListEditors:k,globalChanged:g,guildEnabled:S,guildMention:_,guildBots:E,hasOverride:R,toggleGuild:w,fetchAll:L,fetchGuilds:U,setGuildConfig:z,setChannelConfig:se,clearOverride:le,mutationPending:re,globalItemLabel:K,addGlobalItem:ve,removeGlobalItem:Me,saveGlobalDefaults:ne,connection:t,connectionState:y,connectionToken:s,connectionTokenDirty:a,connectionBusy:n,connectionError:i,saveDiscordCredentials:Y,connectDiscord:W,detachDiscord:M}}},Ws=e=>e==null?e:JSON.parse(JSON.stringify(e));function mC({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:a=()=>{},onDefaultRollback:n=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let m=null;const h=new Map;function b(_){d+=1;const E=c.then(_,_);return c=E.catch(()=>{}),E}function I(_,E){m=Ws(_),h.clear();for(const[R,w]of Object.entries(E||{}))h.set(R,Ws(w))}function k(_){const E=Ws(_),R=++u;return b(async()=>{try{await e(Ws(E)),m=Ws(E),R===u&&a(Ws(E))}catch(w){R===u&&(n(Ws(m)),r(w,{kind:"default"}))}})}function y(_,E){const R=Ws(E),w=(p.get(_)||0)+1;return p.set(_,w),b(async()=>{try{await t(_,Ws(R)),h.set(_,Ws(R)),w===p.get(_)&&i(_,Ws(R))}catch(O){w===p.get(_)&&(l(_,Ws(h.get(_)??null)),r(O,{kind:"user",uid:_}))}})}function g(_){const E=(p.get(_)||0)+1;return p.set(_,E),b(async()=>{try{await s(_),h.delete(_),E===p.get(_)&&o(_)}catch(R){E===p.get(_)&&(l(_,Ws(h.get(_)??null)),r(R,{kind:"delete",uid:_}))}})}async function x(){for(;;){const _=c;if(await _,_===c)return d}}async function S(_){for(;;){const E=await x(),R=await _();if(E===d)return R}}return{seed:I,saveDefault:k,saveUser:y,deleteUser:g,whenIdle:x,readSnapshot:S,get revision(){return d}}}const hC={components:{DiscordUserCombobox:Rg},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),a=f([]),n=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=H(()=>{const T={};for(const $ of r.value)T[$.id]=$;return T});function d(T){return c.value[T]||null}function u(T,$){return T?T.allowed_hosts===null||T.allowed_hosts===void 0?{allowed_hosts:[...$],default_host:T.default_host||"",allow_all:!0}:{allowed_hosts:T.allowed_hosts,default_host:T.default_host||"",allow_all:!1}:{allowed_hosts:[...$],default_host:$[0]||"",allow_all:!0}}const p=mC({applyDefault:async T=>{const $=T.allow_all?null:T.allowed_hosts;await j.put("/api/host-access/default-policy",{allowed_hosts:$,default_host:T.default_host})},applyUser:async(T,$)=>{const Y=$.allow_all?null:$.allowed_hosts;await j.put(`/api/host-access/user/${T}`,{allowed_hosts:Y,default_host:$.default_host})},applyDelete:T=>j.del(`/api/host-access/user/${T}`),onDefaultConfirmed:()=>Te.success("Default policy updated"),onDefaultRollback:T=>{T&&(i.value=T)},onUserConfirmed:T=>{const $=d(T);Te.success(`Updated access for ${$?$.display_name:T}`)},onUserRollback:(T,$)=>{const Y={...l.value};$?Y[T]=$:delete Y[T],l.value=Y},onUserDeleted:T=>{const $={...l.value};delete $[T],l.value=$},onError:(T,$)=>{var W;const Y=$.uid?` ${((W=d($.uid))==null?void 0:W.display_name)||$.uid}`:"";Te.error(`${T.message||"Failed to save"} — reverted${Y}`)}});let m=0;async function h(){const T=++m;e.value=!0,t.value="";try{const $=await p.readSnapshot(()=>j.get("/api/host-access"));if(T!==m)return;s.value=$,a.value=$.available_hosts||[],n.value=$.host_descriptions||{},i.value=u($.default_policy,a.value);const Y=$.users||{},W={};for(const[M,L]of Object.entries(Y))W[M]=u(L,a.value);l.value=W,p.seed(i.value,W)}catch($){T===m&&(t.value=$.message||"Failed to fetch host access data")}finally{T===m&&(e.value=!1)}try{const $=await j.get("/api/discord/members")||[];T===m&&(r.value=$)}catch{T===m&&(r.value=[])}}const b=500,I=new Map;function k(T,$){const Y=I.get(T);Y&&clearTimeout(Y.timer);const W={run:$,timer:null};W.timer=setTimeout(()=>{I.delete(T),$()},b),I.set(T,W)}function y(T){const $=I.get(T);$&&(clearTimeout($.timer),I.delete(T))}function g(){for(const[T,$]of[...I])clearTimeout($.timer),I.delete(T),$.run()}function x(){k("default",()=>p.saveDefault(i.value))}function S(T,$){i.value.allow_all=!1,$?i.value.allowed_hosts.includes(T)||i.value.allowed_hosts.push(T):(i.value.allowed_hosts=i.value.allowed_hosts.filter(Y=>Y!==T),i.value.default_host===T&&(i.value.default_host=i.value.allowed_hosts[0]||"")),x()}function _(T){k(`user:${T}`,()=>{const $=l.value[T];$&&p.saveUser(T,$)})}function E(T,$,Y){const W=l.value[T];W&&(W.allow_all=!1,Y?W.allowed_hosts.includes($)||W.allowed_hosts.push($):(W.allowed_hosts=W.allowed_hosts.filter(M=>M!==$),W.default_host===$&&(W.default_host=W.allowed_hosts[0]||"")),_(T))}function R(T,$){const Y=l.value[T];Y&&(Y.default_host=$,_(T))}function w(){o.value=!0}function O(T){!/^\d{15,25}$/.test(T)||l.value[T]||(l.value[T]={allowed_hosts:[...a.value],default_host:a.value[0]||"",allow_all:!1},p.saveUser(T,l.value[T]),o.value=!1)}async function U(T){const $=d(T);await os({title:"Remove user override",message:`Remove the host access override for ${$?$.display_name:T}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(y(`user:${T}`),await p.deleteUser(T),l.value[T]||Te.success(`Removed override for ${$?$.display_name:T}`))}return st(h),Kt(g),xt(g),{loading:e,error:t,data:s,availableHosts:a,hostDescriptions:n,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:h,saveDefaultPolicy:x,toggleDefaultHost:S,getMember:d,toggleUserHost:E,setUserDefault:R,openAddUser:w,addUserById:O,deleteUser:U,flushPendingSaves:g}}},vC={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
...
`),l.value=4,Te.info("Imported existing known_hosts trust. Test before activation.")}catch(M){Te.error(M.message)}}async function w(){try{const W=h.value.split(/\s+/).filter(Boolean),M={...I.value,expected_fingerprints:W,candidate_fingerprints:u.value},L=await j.post("/api/hosts/candidates",M);if(d.value=L.candidate_token,u.value=L.fingerprints||[],I.value.trust_mode==="tofu"&&M.candidate_fingerprints.length===0){I.value.confirm_tofu=!1,Te.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}l.value=4}catch(W){Te.error(W.message)}}async function O(){var W,M;p.value=!1,m.value=null;try{const L=await j.post("/api/hosts/candidates/"+d.value+"/test",{});p.value=!!L.tested,m.value=L.last_test,p.value&&(l.value=5)}catch(L){const P=(W=L.data)==null?void 0:W.last_test;P&&typeof P=="object"&&!Array.isArray(P)&&(m.value=P);const re=(M=m.value)==null?void 0:M.detail;Te.error(typeof re=="string"&&re.trim()?re:L.message)}}async function U(){try{await j.post("/api/hosts/candidates/"+d.value+"/commit",{}),Te.success("Host saved and published live"),n.value=!1,await y()}catch(W){Te.error(W.message)}}async function T(W){try{await j.post("/api/hosts/"+encodeURIComponent(W.alias)+"/enabled",{enabled:!W.enabled}),await y()}catch(M){Te.error(M.message)}}async function $(W){var M;if(await os("Delete host "+W.alias+"? Dependencies will block deletion.")){a.value=[];try{await j.del("/api/hosts/"+encodeURIComponent(W.alias)),await y()}catch(L){a.value=Array.isArray((M=L.data)==null?void 0:M.pending_references)?L.data.pending_references:[],Te.error(L.message)}}}async function Y(W){if(await os("Force revoke "+W.alias+"? Remote outcomes may be unknown."))try{await j.post("/api/hosts/"+encodeURIComponent(W.alias)+"/force-revoke",{}),await y()}catch(M){Te.error(M.message)}}return st(y),{hosts:e,loading:t,error:s,pendingReferences:a,wizard:n,editing:i,step:l,defaultHost:o,tofuEnabled:r,form:I,isLocal:k,keyInfo:c,candidate:d,observed:u,tested:p,testResult:m,fingerprintsText:h,load:y,saveSettings:g,beginAdd:S,beginEdit:_,loadKey:E,importLegacy:R,prepare:w,testConnection:O,commit:U,toggle:T,remove:$,forceRevoke:Y}}},gC={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=15e3;let a=null,n=!1,i=null,l=null;const o={codexBasic:null,codexAdvanced:null,ollamaBasic:null,ollamaAdvanced:null,compatibleBasic:null,compatibleAdvanced:null,auxiliary:null,mainModel:null,agents:null},r=v=>JSON.stringify(v),c=(v,F)=>{o[v]=r(F)},d=(v,F)=>o[v]!==null&&o[v]!==r(F),u=f(null),p=f(!1),m=f({main:"",main_capability:"medium",agent_capability:"adaptive"}),h=f(""),b=["none","low","medium","high","xhigh","max"],I=["none","low","medium","high","xhigh","max"],k=f({enabled:!1,model:"gpt-6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),y=["gpt-6-astra","gpt-6-sol","gpt-6-luna","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna"],g=H(()=>{const v=u.value||{},F=v.model_catalogue||v.model_catalog||{},Q=$e=>{var Xt,De,Ft;return((Xt=ye.value.model_profiles)==null?void 0:Xt[$e])||((Ft=(De=ye.value.openrouter)==null?void 0:De.catalogue_profiles)==null?void 0:Ft[$e])||null},Se=($e,Xt,De)=>Xt.map(Ft=>{var Yu,Qu;const Bt=typeof Ft=="string"?Ft:Ft.name,Gs=$e==="compat"?Q(Bt):null;return{ref:$e==="codex"?Ft:`${$e}:${Bt}`,name:Bt,provider:$e,available:!!(De!=null&&De.enabled&&($e==="codex"?De.configured:(Yu=De.health)!=null&&Yu.healthy)),unavailable_reason:De!=null&&De.enabled?De!=null&&De.configured?!((Qu=De==null?void 0:De.health)!=null&&Qu.healthy)&&$e!=="codex"?"unreachable":"":"not configured":"disabled",capability:$e==="codex"||Gs!=null&&Gs.supports_reasoning?"reasoning":Gs!=null&&Gs.supports_thinking_mode?"thinking":"none",efforts:Gs==null?void 0:Gs.supported_efforts,profile:Gs}}),Pe=[...F.codex||Se("codex",y,v.codex),...F.compat||F.openai_compatible||[],...F.ollama||Se("ollama",te.value,v.ollama)].map($e=>typeof $e=="string"?{ref:$e,name:$e,provider:"codex",available:!0,capability:"reasoning"}:$e),ct=$e=>{const Xt=Pe.findIndex(De=>De.ref===$e.ref);Xt===-1?Pe.push($e):Pe[Xt]={...Pe[Xt],...$e}};for(const $e of Se("compat",gt.value,v.openai_compatible))ct($e);if(ns.value&&je.value.length)for(const $e of je.value){const Xt=`compat:${$e.id}`;ct({ref:Xt,name:$e.name||$e.id,provider:"compat",available:!0,unavailable_reason:"",capability:$e.supports_reasoning?"reasoning":"none",efforts:b.filter(De=>{var Ft;return(Ft=$e.supported_efforts)==null?void 0:Ft.includes(De)}),agent_available:$e.agent_eligible&&!!$e.profile,agent_unavailable_reason:$e.agent_unavailable_reason||""})}const Ts=new Set(Pe.map($e=>$e.ref));for(const $e of[m.value.main,Ze.value.model,...Qt.value])$e&&$e!=="auto"&&!Ts.has($e)&&Pe.unshift({ref:$e,name:$e.replace(/^(compat|ollama):/,""),provider:$e.split(":")[0]||"codex",available:!1,unavailable_reason:"unavailable",capability:$e.startsWith("ollama:")||$e.includes(":")?"none":"reasoning"});return Pe.filter($e=>!ns.value||$e.provider!=="compat"||$e.ref.slice(7).includes("/")).map($e=>$e.efforts?{...$e,efforts:b.filter(Xt=>$e.efforts.includes(Xt)&&!K($e.ref,Xt))}:$e)}),x=H(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,F])=>({id:v,label:F,models:g.value.filter(Q=>{if(Q.provider!==v)return!1;const Se=h.value.trim().toLowerCase();return!Se||`${Q.name} ${Q.ref}`.toLowerCase().includes(Se)})})).filter(v=>v.models.length)),S=v=>v.available&&v.agent_available!==!1,_=v=>v.available?`${v.name}${v.agent_available===!1?` (${v.agent_unavailable_reason||"not agent-eligible"})`:""}`:ce(v),E=H(()=>[["codex","Codex"],["compat","OpenAI-compatible"],["ollama","Ollama"]].map(([v,F])=>({id:v,label:F,models:g.value.filter(Q=>Q.provider===v&&!(v==="compat"&&ns.value)&&`${Q.ref} ${Q.name}`.toLowerCase().includes(kt.value.trim().toLowerCase()))})).filter(v=>v.models.length)),R=H(()=>g.value.find(v=>v.ref===m.value.main)),w=H(()=>g.value.find(v=>v.ref===Ze.value.model)),O=v=>g.value.find(F=>F.ref===v),U=v=>{const F=O(v);return(F==null?void 0:F.provider)==="codex"?b.filter(Q=>!K(v,Q)):(F==null?void 0:F.efforts)||[]},T=v=>gs.value.find(F=>Ms(F)===v),$=(v,F)=>{const Q=T(v);return typeof Q=="string"?"":(Q==null?void 0:Q[F])||""},Y=H(()=>Qt.value.map(v=>O(v)).filter(v=>v&&S(v))),W=H(()=>[...new Set(Y.value.map(v=>v.capability!=="reasoning"?v.capability||"none":v.provider==="codex"?"codex_reasoning":"compatible_reasoning"))]),M=H(()=>W.value.length>1),L=H(()=>{var F;if(Ze.value.model!=="auto")return((F=w.value)==null?void 0:F.capability)||"none";if(M.value)return"mixed";const v=W.value[0]||"none";return v.endsWith("_reasoning")?"reasoning":v}),P=H(()=>{var v;return Ze.value.model==="auto"?b:((v=w.value)==null?void 0:v.efforts)||b}),re=H(()=>L.value==="thinking"?Ze.value.thinking_mode??k.value.agent_reasoning_effort??"":k.value.agent_reasoning_effort??""),ce=v=>`${v.name}${v.available?"":` (${v.unavailable_reason||"unavailable"})`}`,z=H(()=>{const v=k.value.model;return v&&!y.includes(v)?[v,...y]:y}),se=H(()=>{const v=Ze.value.model;return v&&v!=="auto"&&!y.includes(v)?[v,...y]:y}),le={"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},K=(v,F)=>!!v&&!!F&&(le[v]||[]).includes(F),ve=H(()=>{const v=Ze.value.model;return v&&!v.includes(":")?v:null}),Me=v=>!K(k.value.model,v)&&!(k.value.agent_reasoning_effort===""&&K(ve.value,v)),ne=v=>{const F=Ze.value.model;return F==="auto"?!0:!K(F||k.value.model,v)},ie=H(()=>{const v=k.value.agent_reasoning_effort;return v==="auto"?null:v||k.value.reasoning_effort}),fe=v=>K(v,k.value.reasoning_effort)||Ze.value.model===""&&K(v,ie.value),me=v=>K(v,ie.value),ge=f({enabled:!1,model:"gpt-6-luna"}),Le=f({unavailable_reason:null}),A=H(()=>{const v=ge.value.model;return v&&!y.includes(v)?[v,...y]:y});function D(v){const F=v.target.value;ge.value.enabled=F!=="",F!==""&&(ge.value.model=F),F.startsWith("compat:")&&ns.value?Pa(ke(F),Ge(F)).then(()=>Mn()).catch(Q=>Ue(Q.message||"Failed to prepare OpenRouter model","error")):Mn()}const G=f(!1),pe=f({codex:!1,ollama:!1,compatible:!1}),B=f(null),Z=f(!1),ue=f(""),V=f(null),X=f(!1);let ee=0;const be=H(()=>{var v;return Object.entries(((v=B.value)==null?void 0:v.models)||{}).map(([F,Q])=>{var Se,Pe,ct;return{model:F,floor:Q.floor,override:Q.override,effectiveBudget:(Se=Q.effective)==null?void 0:Se.effective_budget,configuredPrimaryChars:(Pe=Q.configured)==null?void 0:Pe.primary_chars,primaryChars:(ct=Q.effective)==null?void 0:ct.primary_chars,provenance:Q.provenance,clampExpiresAt:Q.clamp_expires_at,densityPriorMilli:Q.density_prior_milli,densityScope:Q.density_scope,workloadCalibration:Q.workload_calibration}})}),he=H(()=>{var v;return((v=B.value)==null?void 0:v.clamps)||[]}),we=H(()=>{var v,F;return((F=(v=B.value)==null?void 0:v.models)==null?void 0:F[k.value.model])||null}),_e=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,num_ctx:32768,timeout:300}),ye=f({enabled:!1,base_url:"https://api.deepseek.com/v1",api_key:"",model:"deepseek-v4-flash",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,preset:"deepseek",reasoning_effort:"medium",model_profiles:{},context_utilization:75,openrouter:{order:[],allow_fallbacks:!0,quantizations:[],sort:null,data_collection:null,reasoning_effort:"medium",model_pins:{},catalogue_profiles:{}}}),We=f(!1),Je=f(!1),Fe=f(!1),qe=f(!1),at=f(!1),Xe=f(!1);function J(){var F,Q,Se;return!!(((F=t.value)==null?void 0:F.contains(document.activeElement))&&((Se=(Q=document.activeElement)==null?void 0:Q.matches)==null?void 0:Se.call(Q,'input, textarea, select, [contenteditable="true"]'))||ra.value||vo.value!==null||X.value||We.value||Je.value||vs.value||Fe.value||qe.value||at.value||G.value||fi.pending()||mi.pending()||Dn.pending()||Mn.pending()||d("codexBasic",Do(k.value))||d("codexAdvanced",Po(k.value))||d("ollamaBasic",$o(_e.value))||d("ollamaAdvanced",$c(_e.value))||d("compatibleBasic",Mo(ye.value))||d("compatibleAdvanced",Pc(ye.value))||d("auxiliary",ge.value)||d("mainModel",m.value.main)||d("agents",Ze.value))}function Ee(){o.codexBasic=r(Do(k.value)),o.codexAdvanced=r(Po(k.value)),o.ollamaBasic=r($o(_e.value)),o.ollamaAdvanced=r($c(_e.value)),o.compatibleBasic=r(Mo(ye.value)),o.compatibleAdvanced=r(Pc(ye.value)),o.auxiliary=r(ge.value),o.mainModel=r(m.value.main)}const Ae=f({configured:null}),Ne=f(!1),te=f([]),Oe=f(""),ze=f(!1),rt=f(!1),Zt=f({configured:null}),lt=f(!1),gt=f([]),Yt=H(()=>ns.value?je.value.map(v=>v.id):gt.value),cs=f(""),oa=f(!1),js=f(!1),Ze=f({model:"auto",thinking_mode:null,auto_model_allowlist:[]}),ra=f(!1),vs=f(!1),Ms=v=>typeof v=="string"?v:v==null?void 0:v.model,gs=H(()=>(Ze.value.auto_model_allowlist||[]).map(v=>typeof v=="string"?v:{...v}).filter(v=>Ms(v))),En=H(()=>!k.value.enabled&&ye.value.enabled?ye.value.model?[`compat:${ye.value.model}`]:[]:!k.value.enabled&&!ye.value.enabled&&_e.value.enabled?_e.value.model?[`ollama:${_e.value.model}`]:[]:y),Qt=H(()=>gs.value.length?gs.value.map(Ms):En.value),_t=H(()=>{var v;return(v=Ze.value.auto_model_allowlist)!=null&&v.length?`Allowlist: ${Qt.value.length} models`:`Default: ${Qt.value.join(", ")||"no available agent models"}`}),ds=new Map;function ba(){ra.value=!1,q()}const rn=v=>{if(ns.value&&v.startsWith("compat:")&&!v.slice(7).includes("/"))return"OpenRouter requires a namespaced vendor/model ID; this is a direct-endpoint profile.";const F=g.value.find(Q=>Q.ref===v);return F?S(F)?"":F.agent_unavailable_reason||F.unavailable_reason||"Not agent-eligible":"Model is absent from the current endpoint catalogue."},ca=v=>{if(Et.value.has(v))return bs(v);const F=g.value.find(Se=>Se.ref===v),Q=(F==null?void 0:F.hint_metadata)||{};return[Q.hint||Q.hint_derived,Q.as_of&&`as of ${Q.as_of}`,Q.scope_note,Q.evidence&&`Evidence: ${Q.evidence}`,F&&qs(F)].filter(Boolean).join(" · ")||"No catalogue hint. Add an operator hint below."},oe=f(null),Ce=f(!1),Ke=f(""),je=H(()=>{var v;return(((v=oe.value)==null?void 0:v.models)||[]).map(F=>{var Se,Pe,ct;const Q=((Se=ye.value.model_profiles)==null?void 0:Se[F.id])||F.profile||((ct=(Pe=ye.value.openrouter)==null?void 0:Pe.catalogue_profiles)==null?void 0:ct[F.id])||(F.context_length>0&&F.max_completion_tokens>0?{total_window_tokens:F.context_length,max_output_tokens:F.max_completion_tokens}:null);return{...F,profile:Q}})}),kt=f(""),St=f(""),cn=f(!0),An=f(!0),dn=f(!0),Rn=f(!1),da=f(null),ya=f(""),jt=f(null),ua=f(""),as=f([]),un=f(!1),In=f("throughput"),li=(v,F,Q=null)=>{const Se=v[F],Pe=Q&&Se&&typeof Se=="object"?Se[Q]:Se,ct=Number(Pe);return Number.isFinite(ct)?ct:null},oi=H(()=>{const v=[...as.value],F=In.value;return v.sort((Q,Se)=>{var Bt,Gs;if(F==="quantization")return String(Q.quantization).localeCompare(String(Se.quantization));const[Pe,ct,Ts]=F==="throughput"?["throughput_last_30m","p50",!0]:F==="latency_p99"?["latency_last_30m","p99",!1]:F==="cache_price"?["cache_read_per_token",null,!1]:["prompt_per_token",null,!1],$e=(Bt=Q.pricing)==null?void 0:Bt[Pe],Xt=(Gs=Se.pricing)==null?void 0:Gs[Pe],De=ct?li(Q,Pe,ct):$e==null?null:Number($e),Ft=ct?li(Se,Pe,ct):Xt==null?null:Number(Xt);return Number.isFinite(De)?Number.isFinite(Ft)?Ts?Ft-De:De-Ft:-1:1})}),ri=H(()=>{try{return new URL(ye.value.base_url).hostname}catch{return""}}),ns=H(()=>/(^|\.)openrouter\.ai$/i.test(ri.value)),On=H(()=>{var v,F;return ns.value?Ce.value?"OpenRouter recognized · fetching catalogue…":Ke.value?`OpenRouter recognized · catalogue failed: ${Ke.value}`:`OpenRouter recognized · ${((F=(v=oe.value)==null?void 0:v.models)==null?void 0:F.length)||0} catalogue models loaded`:gt.value.length?`${gt.value.length} endpoint models loaded`:"Catalogue not loaded"}),Re=H(()=>Ke.value?"text-red-400":"text-gray-500"),N=H(()=>{var v;return[...new Set((((v=oe.value)==null?void 0:v.models)||[]).map(F=>F.vendor))].sort()}),de=H(()=>{var v;return[...new Set((((v=oe.value)==null?void 0:v.models)||[]).flatMap(F=>(F.endpoints||[]).map(Q=>Q.quantization)).filter(Boolean))].sort()}),xe=v=>{var F;return(((F=oe.value)==null?void 0:F.measured_cache)||[]).some(Q=>Q.model===v.id&&Q.samples>0&&Q.cached_percent>0)},Be=H(()=>{const v=kt.value.trim().toLowerCase();return je.value.filter(F=>{var Q;return!(v&&!`${F.id} ${F.name} ${F.vendor}`.toLowerCase().includes(v)||St.value&&F.vendor!==St.value||cn.value&&!F.supports_tools||An.value&&!F.agent_eligible||dn.value&&F.variant!=="standard"||Rn.value&&!xe(F)||da.value!=null&&Number((Q=F.pricing)==null?void 0:Q.prompt_per_token)*1e6>Number(da.value)||ya.value&&!(F.endpoints||[]).some(Se=>Se.quantization===ya.value))})}),Ve=H(()=>Be.value.slice(0,100)),Qe=H(()=>Be.value.length),Et=H(()=>new Map(je.value.map(v=>[`compat:${v.id}`,v]))),pt=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(3)}/M`,At=v=>{var F,Q,Se,Pe;return[v.vendor,v.context_length?`${Number(v.context_length).toLocaleString()} ctx`:"context unknown",`${pt((F=v.pricing)==null?void 0:F.prompt_per_token)} in`,`${pt((Q=v.pricing)==null?void 0:Q.completion_per_token)} out`,`${pt((Se=v.pricing)==null?void 0:Se.cache_read_per_token)} cache read`,`${pt((Pe=v.pricing)==null?void 0:Pe.cache_write_per_token)} cache write`,v.supports_tools?"tools":"no tools",v.supports_reasoning?"reasoning":"no reasoning",v.variant!=="standard"?v.variant:null].filter(Boolean).join(" · ")},bs=v=>{var Pe;const F=Et.value.get(v);if(!F)return"Catalogue facts unavailable";const Q=(((Pe=oe.value)==null?void 0:Pe.measured_cache)||[]).filter(ct=>ct.model===F.id),Se=Q.length?Q.map(ct=>`${ct.upstream_provider}: ${ct.cached_percent}% cached`).join(" · "):"No measured cache evidence yet";return`${At(F)} · ${Se}${F.profile_conflict?" · operator profile conflicts with catalogue":""}`},Nt=H(()=>gt.value.map(v=>typeof v=="string"?v:v.name).filter(Boolean)),Na=async()=>{var F,Q,Se;const v=(Se=(Q=(F=u.value)==null?void 0:F.openai_compatible)==null?void 0:Q.preset_catalogue)==null?void 0:Se[ye.value.preset];v&&(ye.value.base_url=v.base_url),Dn.cancel(),await ol()},ci=(v,F)=>{ye.value.openrouter[v]=F.split(",").map(Q=>Q.trim()).filter(Boolean)},mo=H(()=>te.value||[]),Ma=H(()=>{const v=[...y,...Nt.value.map(F=>`compat:${F}`),...mo.value.map(F=>`ollama:${F.name}`)];for(const F of[Ze.value.model,...Qt.value])F&&F!=="auto"&&!v.includes(F)&&v.unshift(F);return v}),ac=v=>v==="codex-auto-review"?"codex-auto-review (Codex alias → gpt-5.6-luna)":v;async function ho({poll:v=!1}={}){try{const F=await j.get("/api/agents/model");if(v&&J())return;Ze.value={...Ze.value,...F},o.agents=r(Ze.value)}catch{}}async function di(){if(!ns.value){oe.value=null,Ke.value="";return}Ce.value=!0;try{oe.value=await j.get("/api/openrouter/catalogue"),Ke.value=""}catch(v){Ke.value=v.message||"Failed to load OpenRouter catalogue"}finally{Ce.value=!1}}async function nc(){var v;try{(v=Ze.value.model)!=null&&v.startsWith("compat:")&&ns.value&&await Pa(ke(Ze.value.model),Ge(Ze.value.model));const F=await j.put("/api/agents/model",{model:Ze.value.model||null});Ze.value={...Ze.value,...F},o.agents=r(Ze.value),Ue("Agent model policy saved")}catch(F){Ue(F.message||"Failed to save agent model policy","error")}}const Ln=()=>[...gs.value.length?gs.value:Qt.value];async function ic(v,F){const Q=Ln(),Se=Q.findIndex(Ts=>Ms(Ts)===v);let Pe=null;if(F.target.checked&&Se<0&&Q.push(ds.get(v)||v),!F.target.checked&&Se>=0&&([Pe]=Q.splice(Se,1)),!Q.length){F.target.checked=!0,Ue("Keep one model selected. An empty list restores the provider default.","error");return}const ct=await Da(Q,"Agent Auto allowlist saved");ct&&F.target.checked&&ds.delete(v),ct&&!F.target.checked&&typeof Pe=="object"&&ds.set(v,Pe),ct||(F.target.checked=Qt.value.includes(v))}async function Da(v,F){if(vs.value)return!1;vs.value=!0;try{const Q=await j.put("/api/agents/model",{auto_model_allowlist:v});return Ze.value={...Ze.value,...Q},o.agents=r(Ze.value),Ue(F),!0}catch(Q){return Ue(Q.message||"Failed to save agent allowlist","error"),!1}finally{vs.value=!1}}const lc=()=>Da([],"Provider default restored");async function Xi(v,F,Q){const Se=Qt.value.map(Pe=>{const ct=T(Pe);if(Pe!==v)return ct||Pe;const Ts=typeof ct=="string"?{model:Pe}:{...ct||{model:Pe}};return delete Ts.reasoning_effort,delete Ts.thinking_mode,Q&&(Ts[F]=Q),Object.keys(Ts).length===1?Ts.model:Ts});await Da(Se,"Model default saved")}async function Pa(v,F=""){const[Q,...Se]=v.split("/");if(!Q||!Se.length)throw new Error("OpenRouter model id is not namespaced");return j.post(`/api/openrouter/models/${encodeURIComponent(Q)}/${encodeURIComponent(Se.join("/"))}/select`,{provider_tag:F})}const el=(v,F)=>{var Se;const Q=(((Se=oe.value)==null?void 0:Se.measured_cache)||[]).find(Pe=>Pe.model===v&&Pe.upstream_provider===F);return Q?`${Q.cached_percent}% cached over ${Q.samples} calls`:"no measured cache evidence"},ui=v=>v==null?"n/a":`$${(Number(v)*1e6).toFixed(4)}/M`,tl=(v,F)=>{if(v==null)return"n/a";if(typeof v=="number")return Number(v).toLocaleString();const Q=v[F];return Q==null?"n/a":Number(Q).toLocaleString()},sl=v=>{var Pe;const F=[];v.quantization==="fp4"&&F.push("fp4 quantization may change quality");const Q=typeof v.latency_last_30m=="object"?Number((Pe=v.latency_last_30m)==null?void 0:Pe.p99):null,Se=Number(Ze.value.iteration_timeout_seconds||0)*1e3;return Q&&Se&&Q>Se&&F.push("p99 exceeds the agent iteration budget"),F.join("; ")};async function C(v){var F;jt.value=v,ua.value=((F=ye.value.openrouter.model_pins)==null?void 0:F[v.id])||"",un.value=!0;try{const[Q,...Se]=v.id.split("/"),Pe=await j.get(`/api/openrouter/models/${encodeURIComponent(Q)}/${encodeURIComponent(Se.join("/"))}/endpoints`);as.value=Pe.endpoints||[]}catch(Q){as.value=[],Ue(Q.message||"Failed to load OpenRouter provider routes","error")}finally{un.value=!1}}function q(){jt.value=null,ua.value="",as.value=[]}async function ae(v,F=""){try{await Pa(v.id,F);const Q=Ln(),Se=`compat:${v.id}`;if(Q.some(ct=>Ms(ct)===Se)||Q.push(Se),!await Da(Q,F?"OpenRouter model added and provider pinned.":"OpenRouter model added unpinned."))return;q(),await _a()}catch(Q){Ue(Q.message||"Failed to add OpenRouter model","error")}}const ke=v=>v.startsWith("compat:")?v.slice(7):v,Ge=v=>{var F;return((F=ye.value.openrouter.model_pins)==null?void 0:F[ke(v)])||""},Ct=v=>Qt.value.length>1&&Da(Ln().filter(F=>Ms(F)!==v),"Model removed from allowlist");async function Vs(){var v,F;try{const Q=Ln();for(const Se of((v=oe.value)==null?void 0:v.quick_add)||[])(F=Et.value.get(Se))!=null&&F.agent_eligible&&(await Pa(ke(Se),""),Q.some(Pe=>Ms(Pe)===Se)||Q.push(Se));await Da(Q,"Curated OpenRouter models added"),await _a()}catch(Q){Ue(Q.message||"Failed to add curated OpenRouter models","error")}}function qs(v){const F=v.hint_metadata||{},Q=[];return F.context_tokens&&Q.push(`context ${Number(F.context_tokens).toLocaleString()}`),F.max_output_tokens&&Q.push(`max output ${Number(F.max_output_tokens).toLocaleString()}`),F.structural_source&&Q.push(`source ${F.structural_source}`),Q.join("; ")}async function pn(v,F){const Q={...Ze.value.model_selection_hints||{}},Se=F.trim();Se?Q[v]=Se:delete Q[v];try{const Pe=await j.put("/api/agents/model",{model_selection_hints:Q});Ze.value={...Ze.value,...Pe},o.agents=r(Ze.value),Ue("Model hint saved")}catch(Pe){Ue(Pe.message||"Failed to save model hint","error")}}function xa(v,F){const Q=Qt.value.indexOf(v);return!vs.value&&Q>=0&&Q+F>=0&&Q+F<Qt.value.length}async function Gg(v,F){const Q=Ln(),Se=Q.findIndex(Pe=>Ms(Pe)===v);Se<0||!xa(v,F)||([Q[Se],Q[Se+F]]=[Q[Se+F],Q[Se]],await Da(Q,"Agent Auto allowlist order saved"))}const oc=f(!0),rc=f(""),ju=f({configured:null,accounts:[]}),cc=f(null),vo=f(null),dc=f(""),al=f(null),uc=f(!1),pc=f(null),Vu=f(null),qu=f("");let pi=null;function Ue(v,F="success"){Te(v,F==="error"?"error":"success")}function Wg(v){if(!v)return"?";const F=v/(1024*1024*1024);return F>=1?F.toFixed(1)+" GB":(v/(1024*1024)).toFixed(0)+" MB"}function Kg(v){return Number.isFinite(Number(v))?Number(v).toLocaleString():"—"}function Jg(v){return v==null?"automatic (model-derived)":Number(v).toLocaleString()+" characters"}function Zg(v){const F=new Date(v);return Number.isNaN(F.getTime())?"unknown":F.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function Yg(v){return typeof v=="string"&&v.length>12?v.slice(0,8)+"…"+v.slice(-4):v}function Qg(v){return typeof v!="number"||!Number.isFinite(v)?"—":(v/1e3).toFixed(2)}function Xg(v){return v==="temporary learned clamp"?"is-clamp":v==="override"?"is-override":"is-built-in"}function eb(v){const F=k.value.context_budget_overrides[v.model];return v.floor!=null&&Number.isFinite(Number(F))&&Number(F)>v.floor}function tb(v,F){const Q={...k.value.context_budget_overrides};F.target.value===""?delete Q[v]:Q[v]=Number(F.target.value),k.value.context_budget_overrides=Q,X.value=!0}function sb(v){k.value.context_utilization=v.target.value===""?"":Number(v.target.value),X.value=!0}function ab(v){const F={...k.value.context_budget_overrides};delete F[v],k.value.context_budget_overrides=F,X.value=!0}async function _a({quiet:v=!1,poll:F=!1}={}){if(!(F&&J())){if(l&&await l,i)return i;v||(e.value=!0),i=(async()=>{await Promise.all([Ds({poll:F}),nl(),il(),ho({poll:F}),pa(),Nn({poll:F})]),await di(),J()||Ee()})();try{await i}finally{i=null,v||(e.value=!1)}}}async function nb(){if(!(J()||i)){if(l)return l;l=Promise.all([Ds({poll:!0}),nl({refreshModels:!1}),il({refreshModels:!1}),ho({poll:!0}),pa(),Nn({poll:!0})]).then(()=>{J()||Ee()});try{await l}finally{l=null}}}async function Ds({preserveBasic:v=!1,preserveAdvanced:F=!1,poll:Q=!1}={}){var Se,Pe,ct,Ts,$e,Xt;try{const De=await j.get("/api/llm/status"),Ft=Q&&J();u.value=De,p.value=!1,Ft||(m.value.main=De.main_model||De.active_model||(De.active_provider==="compat"?`compat:${((Se=De.openai_compatible)==null?void 0:Se.model)||""}`:De.active_provider==="ollama"?`ollama:${((Pe=De.ollama)==null?void 0:Pe.model)||""}`:((ct=De.codex)==null?void 0:ct.model)||"gpt-6-sol")),!Ft&&De.codex&&!fi.pending()&&(v||(k.value.enabled=De.codex.enabled,k.value.model=De.codex.model||"gpt-6-sol",k.value.reasoning_effort=De.codex.reasoning_effort||"medium",k.value.agent_reasoning_effort=De.codex.agent_reasoning_effort||""),F||(k.value.request_timeout_seconds=De.codex.request_timeout_seconds??k.value.request_timeout_seconds,k.value.stream_stall_timeout_seconds=De.codex.stream_stall_timeout_seconds??k.value.stream_stall_timeout_seconds,k.value.retry={...k.value.retry,...De.codex.retry||{}},k.value.connection_pool={...k.value.connection_pool,...De.codex.connection_pool||{}},k.value.context_compression={...k.value.context_compression,...De.codex.context_compression||{}},!X.value&&!Fe.value&&(k.value.context_budget_overrides={...De.codex.context_budget_overrides||{}},k.value.context_utilization=De.codex.context_utilization??k.value.context_utilization))),!Ft&&De.ollama&&!mi.pending()&&(v||(_e.value.enabled=De.ollama.enabled,_e.value.base_url=De.ollama.base_url||"",_e.value.model=De.ollama.model||"",_e.value.max_tokens=De.ollama.max_tokens||4096,_e.value.num_ctx=De.ollama.num_ctx||32768),F||(_e.value.timeout=De.ollama.timeout??_e.value.timeout));const Bt=De.openai_compatible;!Ft&&Bt&&!Dn.pending()&&(v||(ye.value.enabled=Bt.enabled,ye.value.base_url=Bt.base_url||ye.value.base_url,ye.value.model=Bt.model||ye.value.model,ye.value.preset=Bt.preset||ye.value.preset,ye.value.reasoning_effort=Bt.reasoning_effort||"medium"),F||(ye.value.request_timeout_seconds=Bt.request_timeout_seconds??ye.value.request_timeout_seconds,ye.value.stream_stall_timeout_seconds=Bt.stream_stall_timeout_seconds??ye.value.stream_stall_timeout_seconds,ye.value.model_profiles=Bt.model_profiles||ye.value.model_profiles,ye.value.context_utilization=Bt.context_utilization??ye.value.context_utilization,ye.value.openrouter={...ye.value.openrouter,...Bt.openrouter||{}})),Ft||((Ts=m.value.main)!=null&&Ts.startsWith("compat:")?m.value.main_capability=(Bt==null?void 0:Bt.reasoning_effort)||"medium":($e=m.value.main)!=null&&$e.startsWith("ollama:")||(m.value.main_capability=((Xt=De.codex)==null?void 0:Xt.reasoning_effort)||"medium")),!Ft&&De.auxiliary&&(Le.value=De.auxiliary,Mn.pending()||(ge.value.enabled=De.auxiliary.enabled,ge.value.model=De.auxiliary.model||"gpt-6-luna"))}catch{u.value||(u.value={active_provider:"",codex:{configured:null},ollama:{configured:null},openai_compatible:{configured:null}}),p.value=!0}}async function Nn({poll:v=!1}={}){const F=++ee;Z.value=!0,ue.value="";try{const Q=await j.get("/api/context/windows");if(F!==ee)return;B.value=Q,!(v&&J())&&!Fe.value&&!X.value&&(k.value.context_budget_overrides=Object.fromEntries(Object.entries(Q.models||{}).filter(([,Se])=>Se.override!=null).map(([Se,Pe])=>[Se,Pe.override])),k.value.context_utilization=Q.utilization??k.value.context_utilization)}catch(Q){F===ee&&(ue.value=Q.message||"Failed to load context budgets")}finally{F===ee&&(Z.value=!1)}}async function nl({refreshModels:v=!0}={}){try{if(Ae.value=await j.get("/api/ollama/status"),Ne.value=!1,Ae.value.model&&(Oe.value=Ae.value.model),v&&Ae.value.configured)try{const F=await j.get("/api/ollama/models");te.value=F.models||[]}catch{te.value=[]}else if(v&&_e.value.base_url)try{const F=await j.post("/api/ollama/probe-models",{base_url:_e.value.base_url});te.value=F.models||[]}catch{te.value=[]}}catch{Ne.value=!0}}async function pa(){oc.value=!0,rc.value="";try{ju.value=await j.get("/api/codex/status")}catch(v){rc.value=v.message||"Failed to fetch Codex status"}finally{oc.value=!1}}async function ib(){try{m.value.main.startsWith("compat:")&&ns.value&&await Pa(ke(m.value.main),Ge(m.value.main));try{await j.put("/api/llm/main-model",{model:m.value.main})}catch(v){if(!/404|not found/i.test(v.message||""))throw v;await j.post("/api/llm/switch",{model:m.value.main})}c("mainModel",m.value.main),Ue("Main model saved"),await _a()}catch(v){Ue(v.message||"Failed to save main model","error"),await Ds()}}async function lb(v){m.value.main_capability=v;const F=R.value;F&&(F.provider==="compat"&&F.capability!=="none"?(ye.value.reasoning_effort=v,await ol()):F.capability==="reasoning"?(k.value.reasoning_effort=v,await ll()):F.capability==="thinking"&&(await j.put("/api/openai-compatible/config",{thinking_mode:v}),Ue("Thinking mode saved")))}async function ob(v){m.value.agent_capability=v;const F=w.value,Q=(F==null?void 0:F.capability)||L.value;if(Q!=="none"){if(v===""||v==="auto"||Q==="reasoning"||Q==="mixed"){if(k.value.agent_reasoning_effort=v,Q==="thinking"){const Se=await j.put("/api/agents/model",{thinking_mode:null});Ze.value={...Ze.value,...Se}}await ll()}else if(Q==="thinking"){const Se=await j.put("/api/agents/model",{thinking_mode:v});Ze.value={...Ze.value,...Se},Ue("Agent thinking mode saved")}}}async function rb(){ze.value=!0;try{const v=await j.post("/api/ollama/reload");Ue(v.configured?"Ollama reloaded":v.reason||"Ollama not configured",v.configured?"success":"error"),await _a()}catch(v){Ue(v.message||"Reload failed","error")}finally{ze.value=!1}}async function cb(){rt.value=!0;try{await j.post("/api/ollama/model",{model:Oe.value}),Ue("Model set to "+Oe.value),await _a()}catch(v){Ue(v.message||"Failed","error")}finally{rt.value=!1}}async function db(){const v=_e.value.base_url;if(!v){Ue("Enter a base URL first","error");return}Xe.value=!0;try{const F=await j.post("/api/ollama/probe-models",{base_url:v});te.value=F.models||[],te.value.length?(Ue(te.value.length+" model(s) found"),!_e.value.model&&te.value.length&&(_e.value.model=te.value[0].name)):Ue("No models found at "+v,"error")}catch(F){Ue(F.message||"Could not reach Ollama","error")}finally{Xe.value=!1}}async function il({refreshModels:v=!0}={}){try{if(Zt.value=await j.get("/api/openai-compatible/status"),lt.value=!1,Zt.value.model&&(cs.value=Zt.value.model),v&&Zt.value.configured)try{const F=await j.get("/api/openai-compatible/models");gt.value=F.models||[]}catch{gt.value=[]}}catch{lt.value=!0}}async function ub(){oa.value=!0;try{const v=await j.post("/api/openai-compatible/reload");Ue(v.configured?"OpenAI-compatible reloaded":v.reason||"OpenAI-compatible not configured",v.configured?"success":"error"),await _a()}catch(v){Ue(v.message||"Reload failed","error")}finally{oa.value=!1}}async function pb(){js.value=!0;try{await j.post("/api/openai-compatible/model",{model:cs.value}),Ue("Model set to "+cs.value),await _a()}catch(v){Ue(v.message||"Failed","error")}finally{js.value=!1}}async function ll(){if(Fe.value){fi();return}Fe.value=!0;const v=Do(k.value);try{await j.put("/api/llm/codex/config",v),c("codexBasic",v),Ue("Codex config saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),pa()])}catch(F){Ue(F.message||"Failed","error");const Q=JSON.stringify(Do(k.value))!==JSON.stringify(v);await Promise.all([Ds({preserveBasic:Q,preserveAdvanced:!0}),pa()])}finally{Fe.value=!1}}async function Gu(){if(Fe.value)return;Fe.value=!0;const v=Po(k.value);try{await j.put("/api/llm/codex/config",v),c("codexAdvanced",v),JSON.stringify({context_budget_overrides:k.value.context_budget_overrides,context_utilization:k.value.context_utilization})===JSON.stringify({context_budget_overrides:v.context_budget_overrides,context_utilization:v.context_utilization})&&(X.value=!1),Ue("Codex advanced settings saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),pa(),Nn()])}catch(F){Ue(F.message||"Failed","error");const Q=JSON.stringify(Po(k.value))!==JSON.stringify(v);await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:Q}),pa(),Nn()])}finally{Fe.value=!1}}async function fc(){if(qe.value){mi();return}qe.value=!0;try{const v=We.value?_e.value.api_key:null,F=$o(_e.value,{includeApiKey:v!==null});await j.put("/api/llm/ollama/config",F),Ue("Ollama config saved"),v!==null&&_e.value.api_key===v&&(_e.value.api_key="",We.value=!1),c("ollamaBasic",$o(_e.value)),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){Ue(v.message||"Failed","error")}finally{qe.value=!1}}async function Wu(){if(!qe.value){qe.value=!0;try{const v=$c(_e.value);await j.put("/api/llm/ollama/config",v),c("ollamaAdvanced",v),Ue("Ollama timeout saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),nl()])}catch(v){Ue(v.message||"Failed","error")}finally{qe.value=!1}}}async function ol(){if(at.value){Dn();return}at.value=!0;try{const v=Je.value?ye.value.api_key:null,F=Mo(ye.value,{includeApiKey:v!==null});await j.put("/api/openai-compatible/config",F),Ue("OpenAI-compatible config saved"),v!==null&&ye.value.api_key===v&&(ye.value.api_key="",Je.value=!1),c("compatibleBasic",Mo(ye.value)),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){Ue(v.message||"Failed","error")}finally{at.value=!1}}async function Ku(){if(!at.value){at.value=!0;try{const v=Pc(ye.value);await j.put("/api/openai-compatible/config",v),c("compatibleAdvanced",v),Ue("OpenAI-compatible endpoint settings saved"),await Promise.all([Ds({preserveBasic:!0,preserveAdvanced:!0}),il()]),await di()}catch(v){Ue(v.message||"Failed","error")}finally{at.value=!1}}}async function fb(){if(G.value){Mn();return}G.value=!0;try{const v={...ge.value};await j.put("/api/llm/auxiliary/config",v),c("auxiliary",v),Ue("Auxiliary config saved"),await Ds()}catch(v){Ue(v.message||"Failed","error"),await Ds()}finally{G.value=!1}}const fi=Fo(ll),Mn=Fo(fb),mi=Fo(fc),Dn=Fo(ol),mb=()=>(fi.cancel(),ll()),hb=()=>(mi.cancel(),fc()),vb=()=>(Dn.cancel(),ol()),gb=()=>Gu(),bb=()=>Wu(),yb=()=>Ku();async function xb(v){const F=v.account_key+":"+v.model;V.value=F;try{const Q=await j.post("/api/context/windows/clear",{account_key:v.account_key,model:v.model});Ue(Q.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await Nn()}catch(Q){Ue(Q.message||"Failed to clear clamp","error"),await Nn()}finally{V.value=null}}async function _b(v){try{await j.post("/api/codex/account/"+v+"/activate"),Ue("Active account switched"),await pa()}catch(F){Ue(F.message||"Failed","error")}}async function wb(v){cc.value=v;try{await j.post("/api/codex/account/"+v+"/refresh"),Ue("Token refreshed"),await pa()}catch(F){Ue(F.message||"Refresh failed","error")}finally{cc.value=null}}function kb(v,F){vo.value=v,dc.value=F||""}async function Sb(v){try{await j.put("/api/codex/account/"+v+"/label",{label:dc.value}),Ue("Label updated"),vo.value=null,await pa()}catch(F){Ue(F.message||"Failed","error")}}async function Cb(v,F){if(await os({title:"Delete Codex account",message:`Delete ${F||"account #"+(v+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await j.del("/api/codex/account/"+v),Ue("Deleted. Pool reloaded."),await pa()}catch(Se){Ue(Se.message||"Failed","error")}}async function Tb(){uc.value=!0;try{const v=await j.post("/api/codex/device-code");pc.value=v,al.value="pending",Eb(v)}catch(v){Ue(v.message||"Failed","error")}finally{uc.value=!1}}async function Eb(v){pi={cancelled:!1};const F=pi;try{const Q=await j.post("/api/codex/device-poll",{device_auth_id:v.device_auth_id,user_code:v.user_code,interval:v.interval});if(F.cancelled)return;Vu.value=Q,al.value="success",await _a()}catch(Q){if(F.cancelled)return;qu.value=Q.message||"Device login failed",al.value="error"}}function Ab(){pi&&(pi.cancelled=!0),al.value=null,pc.value=null}function Ju(){n||(n=!0,_a(),a=window.setInterval(nb,s))}function Zu(){n&&(n=!1,a!==null&&window.clearInterval(a),a=null)}return st(Ju),rs(Ju),Kt(Zu),xt(()=>{Zu(),pi&&(pi.cancelled=!0),fi.cancel(),Mn.cancel(),mi.cancel(),Dn.cancel()}),{pageRoot:t,allowlistModalOpen:ra,closeAllowlistModal:ba,allowlistSaving:vs,effectiveAllowlist:Qt,allowlistSummary:_t,resetAgentAllowlist:lc,selectedUnavailableReason:rn,selectedModelFacts:ca,loading:e,llmStatus:u,llmStatusLoadFailed:p,modelSelection:m,modelSelectorSearch:h,reasoningEfforts:b,neutralReasoningLevels:I,modelCatalog:g,modelGroups:x,selectedMainModel:R,selectedAgentModel:w,selectedAgentCapabilityValue:re,agentCapabilityKind:L,agentCapabilityEfforts:P,autoAllowlistModels:Y,allowlistModel:O,allowlistModelEfforts:U,allowlistEntryCapabilityValue:$,modelOptionLabel:ce,agentModelAvailable:S,agentModelOptionLabel:_,advancedOpen:pe,codexForm:k,codexModelOptions:z,codexAgentModelOptions:se,mainEffortAllowed:Me,agentEffortAllowed:ne,mainModelOptionDisabled:fe,agentModelOptionDisabled:me,auxForm:ge,auxData:Le,auxModelOptions:A,onAuxModelChange:D,savingAux:G,saveAuxConfigDebounced:Mn,ollamaForm:_e,compatibleForm:ye,savingCodex:Fe,savingOllama:qe,savingCompatible:at,probingOllama:Xe,ollamaKeyDirty:We,compatibleKeyDirty:Je,fetchCodexStatus:pa,ollamaStatus:Ae,ollamaStatusLoadFailed:Ne,ollamaModels:te,ollamaSelectedModel:Oe,reloading:ze,settingModel:rt,compatibleStatus:Zt,compatibleStatusLoadFailed:lt,compatibleModels:gt,visibleCompatibleModels:Yt,compatibleSelectedModel:cs,reloadingCompatible:oa,settingCompatibleModel:js,applyCompatiblePreset:Na,setOpenRouterList:ci,agentsConfig:Ze,compatibleAgentModels:Nt,ollamaAgentModels:mo,knownAgentModelRefs:Ma,agentModelLabel:ac,saveAgentsModel:nc,toggleAgentAutoAllowlist:ic,saveAllowlistEntryCapability:Xi,autoAllowlistGroups:E,structuralFacts:qs,saveModelHint:pn,canMoveAllowlist:xa,moveAgentAutoAllowlist:Gg,openRouterCatalogue:oe,openRouterCatalogueLoading:Ce,openRouterCatalogueError:Ke,openRouterRecognized:ns,compatibleCatalogueStatus:On,compatibleCatalogueStatusClass:Re,openRouterSearch:kt,openRouterVendor:St,openRouterVendors:N,openRouterToolsOnly:cn,openRouterEligibleOnly:An,openRouterStandardOnly:dn,openRouterMeasuredCacheOnly:Rn,openRouterMaxPromptPrice:da,openRouterQuantization:ya,openRouterQuantizations:de,openRouterResults:Ve,openRouterMatchCount:Qe,openRouterInlineFacts:At,openRouterSelectedFacts:bs,prepareOpenRouterModel:C,addOpenRouterModel:ae,removeOpenRouterModel:Ct,quickAddOpenRouter:Vs,openRouterModelMap:Et,openRouterPin:Ge,openRouterPendingModel:jt,openRouterPendingTag:ua,openRouterPendingEndpoints:as,openRouterPendingLoading:un,openRouterEndpointSort:In,openRouterSortedPendingEndpoints:oi,openRouterEndpointCacheFact:el,openRouterRate:ui,openRouterMetric:tl,openRouterRouteWarning:sl,cancelOpenRouterPending:q,codexLoading:oc,codexError:rc,codexData:ju,refreshing:cc,editingLabel:vo,labelValue:dc,contextWindows:B,contextWindowsLoading:Z,contextWindowsError:ue,contextBudgetRows:be,activeClampRows:he,activeContextBudget:we,clearingClamp:V,contextPolicyDirty:X,deviceState:al,deviceLoading:uc,deviceInfo:pc,deviceResult:Vu,deviceError:qu,fetchAll:_a,fetchLLMStatus:Ds,fetchOllamaStatus:nl,fetchCompatibleStatus:il,saveMainModel:ib,saveMainCapability:lb,saveAgentCapability:ob,reloadOllama:rb,setOllamaModel:cb,reloadCompatible:ub,setCompatibleModel:pb,probeOllamaModels:db,saveCodexConfig:ll,saveOllamaConfig:fc,saveCompatibleConfig:ol,saveCodexAdvancedConfig:Gu,saveOllamaAdvancedConfig:Wu,saveCompatibleAdvancedConfig:Ku,saveCodexConfigDebounced:fi,saveOllamaConfigDebounced:mi,saveCompatibleConfigDebounced:Dn,saveCodexConfigNow:mb,saveOllamaConfigNow:hb,saveCompatibleConfigNow:vb,saveCodexAdvancedConfigNow:gb,saveOllamaAdvancedConfigNow:bb,saveCompatibleAdvancedConfigNow:yb,activateAccount:_b,refreshAccount:wb,startEditLabel:kb,saveLabel:Sb,deleteAccount:Cb,startDeviceLogin:Tb,cancelDeviceLogin:Ab,formatSize:Wg,fetchContextWindows:Nn,clearContextClamp:xb,setContextOverride:tb,setContextUtilization:sb,resetContextOverride:ab,overrideAboveFloor:eb,formatCount:Kg,formatContextCeiling:Jg,formatExpiry:Zg,shortAccountKey:Yg,provenanceClass:Xg,formatDensity:Qg}}},$f={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function kC(e){return $f[e]||$f[(e||"").toLowerCase()]||"text-gray-400"}const SC={template:`
...
`):a.value[M.key]])),r.value=!1}async function O(M,L){const[P,re]=await Promise.all([j.get("/api/config"),j.get("/api/config/meta")]);if(!b(M,L))return!1;const ce=(re.fields||[]).filter(z=>/^computer\.[^.]+$/.test(z.path)&&z.path!=="computer.enabled"&&z.sensitivity==="public"&&z.apply_mode==="restart");if(!P.computer||!ce.length)throw new Error("Provisioning metadata is unavailable. Reload before editing.");return s.value=ce.map(z=>({...z,key:z.path.split(".")[1]})),a.value=Object.fromEntries(s.value.map(z=>[z.key,Bf(P.computer[z.key])])),w(),h=L,i.value=!0,c.value=!1,!0}async function U(){if(!p||l.value||o.value)return;const M=++m,L=j.token;l.value=!0,i.value=!1,d.value="",u.value="",r.value=!1;try{await O(M,L)}catch(P){b(M,L)&&(c.value=!0,d.value=P.message||"Could not load provisioning. No changes were sent.")}finally{b(M,L)&&(l.value=!1)}}function T(){i.value&&!l.value&&!o.value&&!c.value&&g.value.length&&!E.value&&(r.value=!0)}async function $(){if(!p||!i.value||!r.value||o.value||l.value||c.value||E.value||!g.value.length)return;if(h!==j.token){W(),Y();return}const M={computer:Object.fromEntries(g.value.map(ce=>[ce.key,Bf(ce.value)]))},L=m,P=j.token;o.value=!0,d.value="",u.value="";let re=!1;try{if(await j.put("/api/config",M),re=!0,!b(L,P))return;await O(L,P)&&(u.value="Provisioning saved and configuration reloaded. Startup settings remain pinned until Odin restarts; no lifecycle action was requested.",t("saved"))}catch(ce){b(L,P)&&(c.value=!0,r.value=!1,d.value=re?"Provisioning was saved, but configuration refresh failed. Reload saved values before editing again.":`Save failed or its outcome is unknown${ce.status===400?": "+ce.message:"."} Reload saved values before editing or retrying. No request was replayed.`)}finally{b(L,P)&&(o.value=!1)}}function Y(){p||(p=!0,U())}function W(){p=!1,m++,i.value=!1,l.value=!1,o.value=!1,r.value=!1,h=null,s.value=[],a.value={},n.value={},d.value="",u.value=""}return st(Y),rs(Y),Kt(W),xt(W),{fields:s,original:a,draft:n,ready:i,loading:l,saving:o,reviewing:r,uncertain:c,error:d,message:u,pending:x,effectiveUnknown:S,changes:g,validation:_,invalid:E,fieldId:I,format:k,edit:R,discard:w,load:U,openReview:T,save:$}}},OC={components:{ComputerProvisioning:IC},template:`
    ...
    </div>`,setup(){const e=f({state:"unknown",available:!1}),t=f(!1),s=f(!1),a=f(!1),n=f(!1),i=f(!1),l=f(!1),o=f(""),r=f(!1),c=f(!1),d=f(!1),u=f(0),p=f(""),m=f(""),h=f(null),b=f(""),I=f(!1),k=f(Date.now()),y=f(""),g=f(null);let x=0,S=null,_=!1,E=j.token,R=0,w=null,O=null,U=!1;const T=V=>V===!0?"Enabled":V===!1?"Disabled":"Unknown",$=H(()=>{var V;return((V=e.value.backend)==null?void 0:V.environment)==="existing_session"}),Y=H(()=>{var X;const V=Date.parse(((X=e.value.accessibility)==null?void 0:X.checked_at)||"");return c.value&&Number.isFinite(V)&&k.value-V<15e3&&k.value>=V-5e3}),W=H(()=>{var V;return Y.value?T((V=e.value.accessibility)==null?void 0:V.enabled):"Unknown / not current"}),M=H(()=>{var V;return Y.value?((V=e.value.accessibility)==null?void 0:V.reason)==="property_read"?"Last checked: "+e.value.accessibility.checked_at:"Property unavailable for this target. Isolated sessions, an unbound operator identity, an inactive accessibility service or an inaccessible session bus may prevent this read. Unknown does not mean disabled.":"No current property read; unknown does not mean disabled."}),L=H(()=>Object.entries(e.value.input_limits||{}).filter(([,V])=>typeof V=="number"&&Number.isFinite(V)).map(([V,X])=>`${V}: ${X}`).join(", ")),P=H(()=>{var X;const V=(X=e.value.application_provenance)==null?void 0:X.script_identity;return typeof V=="string"?V:!V||typeof V!="object"?"Not observed":`${V.interpreter_basename||"Unknown interpreter"}; argv digest ${V.argv_digest||"not recorded"}; ${V.verified===!0?"verified":"not verified"}`}),re=H(()=>Array.isArray(e.value.application_profiles)?e.value.application_profiles.filter(V=>V&&typeof V.id=="string"&&typeof V.label=="string"&&["supported","capture_only"].includes(V.input)).slice(0,16):[]),ce=H(()=>{const V=e.value.restart_required;return Array.isArray(V)?V.length?V.join(", "):"None reported":V===!0?"Pending; restart required":V===!1?"None reported":"Unknown"}),z=H(()=>{var X,ee;const V=Date.parse(((X=h.value)==null?void 0:X.captured_at)||"");return Number.isFinite(V)&&k.value<V+Math.min(1e4,((ee=h.value)==null?void 0:ee.fresh_for_ms)||0)?"Fresh frame":"Stale frame — observe again before acting"});function se(){b.value&&URL.revokeObjectURL(b.value),b.value="",h.value=null}function le(){x++,se(),g.value=null,c.value=!1,w==null||w.abort(),w=null,t.value=!1,m.value="",s.value=!1,i.value=!1,l.value=!1}function K(V,X){return _&&V===x&&X===j.token}function ve(){return _&&c.value&&O===j.token&&Date.now()-u.value<15e3}function Me(V,X="mutation"){var be,he;le(),U=!0,p.value="";const ee=V.status||(V.name==="AuthError"?401:0);[401,403,404].includes(ee)?(u.value=0,O=null,e.value={available:!1,state:"unknown"}):u.value||(e.value={available:!1,state:ee===503?"unavailable":"unknown"}),o.value=ee===401||ee===403||ee===404?"Access unavailable or revoked. Authenticate as the session owner, then refresh.":ee===410?"Evidence or artifact expired. Observe or prepare the export again.":X==="read"?"Status refresh failed. Last-known details are not current. No mutation was requested by this read.":X==="acknowledged"?"The mutation was acknowledged, but status refresh failed. Refresh status independently; do not replay the change.":"Request failed; outcome unknown. Refresh status. No action was replayed.",X==="mutation"&&![401,403,404].includes(ee)&&typeof((be=V.data)==null?void 0:be.code)=="string"&&/^[a-z_]{1,64}$/.test(V.data.code)&&typeof((he=V.data)==null?void 0:he.error)=="string"&&(o.value=V.data.error.slice(0,512),V.data.outcome==="not_applied"&&V.data.next_action==="repair_provisioning"&&typeof V.data.remedy=="string"&&(o.value="Not applied (preflight rejection). "+o.value,p.value=V.data.remedy.slice(0,1024)))}async function ne(){if(t.value||r.value||a.value||n.value||d.value||!_)return;const V=x,X=j.token;t.value=!0,R=Date.now();const ee=new AbortController;w=ee;try{const be=await j.get("/api/computer",{signal:ee.signal});if(!K(V,X))return;ie(be)}catch(be){K(V,X)&&Me(be,"read")}finally{w===ee&&(w=null,t.value=!1)}}function ie(V,X=""){if(!V||typeof V!="object"||typeof V.state!="string"||typeof V.available!="boolean")throw new Error("Invalid status");(e.value.session_id&&e.value.session_id!==V.session_id||e.value.generation!=null&&e.value.generation!==V.generation||e.value.session_generation!=null&&e.value.session_generation!==V.session_generation)&&le(),e.value=V,u.value=Date.now(),O=j.token,c.value=!(r.value&&X!=="toggle")&&!(a.value&&X!=="stop")&&!(n.value&&X!=="pause")&&!(d.value&&X!=="recovery"),o.value="",p.value="",U=!c.value}async function fe(V){if(!ve()||r.value||a.value||n.value||d.value)return;le();const X=x,ee=j.token;r.value=!0;let be=!1;try{if(await j.post("/api/computer/enabled",{enabled:V}),be=!0,!K(X,ee))return;const he=await j.get("/api/computer");K(X,ee)&&ie(he,"toggle")}catch(he){K(X,ee)&&Me(he,be?"acknowledged":"mutation")}finally{r.value=!1}}async function me(V){if(!_||!["pause","stop"].includes(V)||(V==="stop"?a.value:n.value))return;le();const X=x,ee=j.token,be=V==="stop"?a:n;be.value=!0;let he=!1;try{if(await j.post("/api/computer/"+V,{}),he=!0,K(X,ee)){const we=await j.get("/api/computer");K(X,ee)&&ie(we,V)}}catch(we){K(X,ee)&&Me(we,he?"acknowledged":"mutation")}finally{be.value=!1}}async function ge(){var be;if(!ve()||d.value||((be=e.value.backend)==null?void 0:be.native_backend)!=="hyprland")return;const V={session_id:e.value.session_id,generation:e.value.session_generation};if(!V.session_id||!Number.isInteger(V.generation))return;le();const X=x,ee=j.token;d.value=!0;try{const he=await j.post("/api/computer/release_owned_input",V);K(X,ee)&&ie(he,"recovery")}catch(he){K(X,ee)&&Me(he,"mutation")}finally{d.value=!1}}async function Le(){return D(!1)}async function A(){return D(!0)}async function D(V){var _e;if(!ve()||d.value||r.value||a.value||n.value||e.value.state!=="quarantined")return;const X={session_id:e.value.session_id,generation:e.value.session_generation};if(!X.session_id||!Number.isInteger(X.generation))return;if(V){if(m.value!=="ACKNOWLEDGE UNVERIFIED CLEANUP "+X.session_id)return;X.acknowledgment=m.value}const ee=V?((_e=e.value.recovery)==null?void 0:_e.reason)==="legacy_runtime_identity_missing"?"acknowledge_legacy":"reconcile":"recover";le();const be=x,he=j.token;d.value=!0;let we=!1;try{const ye=await j.post("/api/computer/"+ee,X);we=!0,K(be,he)&&ie(ye,"recovery")}catch(ye){K(be,he)&&Me(ye,we?"acknowledged":"mutation")}finally{d.value=!1}}async function G(){var ee;if(!ve()||s.value||!e.value.available)return;se(),I.value=!1;const V=x,X=j.token;s.value=!0;try{const be=await j.post("/api/computer/observe",{});if(!K(V,X))return;if(!/^[A-Za-z0-9_-]{8,128}$/.test(((ee=be.frame)==null?void 0:ee.evidence_id)||""))throw new Error("Invalid evidence");const he=await j.getBlob("/api/computer/evidence/"+be.frame.evidence_id);if(!K(V,X))return;if(!["image/png","image/jpeg"].includes(he.type)||he.size>2097152||!Number.isFinite(Date.parse(be.frame.expires_at))||Date.parse(be.frame.expires_at)<=Date.now())throw new Error("Invalid evidence");h.value=be.frame,b.value=URL.createObjectURL(he),o.value=""}catch(be){K(V,X)&&Me(be)}finally{V===x&&(s.value=!1)}}async function pe(){if(!ve()||i.value||!e.value.available)return;g.value=null;const V=x,X=j.token;i.value=!0;try{const ee=await j.post("/api/computer/export",{name:y.value});K(V,X)&&(g.value=ee,o.value="")}catch(ee){K(V,X)&&Me(ee)}finally{V===x&&(i.value=!1)}}async function B(){if(!ve()||l.value||!g.value)return;const V=x,X=j.token,ee=g.value;l.value=!0;try{if(!/^[A-Za-z0-9_-]{8,128}$/.test((ee==null?void 0:ee.artifact_id)||""))throw new Error("Invalid export");const be=await j.getBlob("/api/computer/download/"+ee.artifact_id);if(!K(V,X))return;const he=URL.createObjectURL(be),we=document.createElement("a");we.href=he,we.download=ee.name,we.click(),setTimeout(()=>URL.revokeObjectURL(he),1e3)}catch(be){K(V,X)&&Me(be)}finally{V===x&&(l.value=!1)}}function Z(){_||(E!==j.token&&(E=j.token,le(),u.value=0,O=null,e.value={state:"unknown",available:!1},o.value="",p.value=""),_=!0,ne(),S=setInterval(()=>{k.value=Date.now(),E!==j.token&&(E=j.token,le(),u.value=0,O=null,o.value="",p.value="",e.value={state:"unknown",available:!1}),c.value&&k.value-u.value>=15e3&&le(),h.value&&Date.parse(h.value.expires_at)<=k.value&&(se(),I.value=!0),g.value&&Date.parse(g.value.expires_at)<=k.value&&(g.value=null),!U&&k.value-R>=5e3&&ne()},500))}function ue(){_=!1,clearInterval(S),S=null,le(),c.value=!1}return st(Z),rs(Z),Kt(ue),xt(ue),{status:e,checkedAt:u,remedy:p,loading:t,observing:s,stopping:a,pausing:n,exporting:i,downloading:l,error:o,frame:h,frameUrl:b,frameExpired:I,freshness:z,name:y,artifact:g,refresh:ne,control:me,observe:G,clearFrame:se,exportFile:pe,download:B,toggling:r,adminReady:c,enabledLabel:T,restartSettings:ce,setEnabled:fe,recovering:d,recover:Le,reconcile:A,releaseOwnedInput:ge,reconciliationAck:m,applicationProfiles:re,attached:$,scriptIdentity:P,inputLimits:L,accessibilityLabel:W,accessibilityDetail:M}}},Ig=[{id:"health",label:"Health",component:U1},{id:"resources",label:"Resources",component:z1},{id:"logs",label:"Logs",component:X1},{id:"config",label:"Config",component:uC},{id:"discord",label:"Discord",component:fC},{id:"hosts",label:"Hosts",component:vC},{id:"host-access",label:"Host Access",component:hC},{id:"api-tokens",label:"API Tokens",component:gC},{id:"llm",label:"LLM Config",component:wC},{id:"internals",label:"Internals",component:SC},{id:"turn-state",label:"Turn State",component:EC},{id:"computer",label:"Computer",component:OC},{id:"update",label:"Update",component:AC}],LC={components:{TabbedPage:Xr},setup(){return{tabs:Ig}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},Bo=(e,t,s,a)=>a.map(({id:n,label:i})=>({group:e,label:i,icon:t,to:{path:s,query:{tab:n}}})),NC=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...Bo("Operations","operations","/operations",xg),...Bo("History","history","/history",_g),...Bo("Capabilities","capabilities","/capabilities",wg),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...Bo("System","system","/system",Ig)],Fs=Tn({open:!1,query:"",selected:0});function Uf(){Fs.query="",Fs.selected=0,Fs.open=!0}function Bc(){Fs.open=!1}function MC(e,t){const s=e.label.toLowerCase(),a=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:a.startsWith(t)?80:s.includes(t)?60:a.includes(t)?40:0:1}const DC={setup(){const e=pg(),t=f(null),s=H(()=>{const i=Fs.query.trim().toLowerCase();return NC.map(l=>({...l,_score:MC(l,i)})).filter(l=>l._score>0).sort((l,o)=>o._score-l._score)});Wt(()=>Fs.open,async i=>{var l;i&&(await zt(),(l=t.value)==null||l.focus())}),Wt(()=>Fs.query,()=>{Fs.selected=0});function a(i){Bc(),e.push(i.to)}function n(i){if(i.key==="Escape"){i.preventDefault(),Bc();return}if(i.key==="ArrowDown")i.preventDefault(),Fs.selected=Math.min(Fs.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Fs.selected=Math.max(Fs.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Fs.selected];l&&a(l)}}return{state:Fs,results:s,inputEl:t,go:a,onKeydown:n,closePalette:Bc}},template:`
    <transition name="modal">
  ...
  `},Td={brand:"M12 3 4.5 8v8L12 21l7.5-5V8L12 3Zm0 4.2 4.6 3.1L12 16.8l-4.6-6.5L12 7.2Zm0 3.3v3.7",dashboard:"M4 13h6V4H4v9Zm0 7h6v-4H4v4Zm10 0h6v-9h-6v9Zm0-16v4h6V4h-6Z",chat:"M20 15a3 3 0 0 1-3 3H9l-5 3v-6a3 3 0 0 1-1-2.2V7a3 3 0 0 1 3-3h11a3 3 0 0 1 3 3v8Z",operations:"M5 12h3l2-6 4 12 2-6h3M4 4v16h16",history:"M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5M12 7v5l3 2",home:"M3 11.5 12 4l9 7.5M5.5 10v10h13V10M9 20v-6h6v6",users:"M16 20v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.9m-2-11.8a4 4 0 0 1 0 7.7",capabilities:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",personality:"M12 3a8 8 0 0 0-8 8c0 4 3 7 7 7v3h3v-3c3 0 6-3 6-7a8 8 0 0 0-8-8ZM8.5 10h.01M15.5 10h.01M9 14c1.7 1.2 4.3 1.2 6 0",system:"M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v2m0 14v2M3 12h2m14 0h2M5.6 5.6 7 7m10 10 1.4 1.4M18.4 5.6 17 7M7 17l-1.4 1.4",menu:"M4 7h16M4 12h16M4 17h16",panelLeft:"M9 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4V4Zm0 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H9M6 8h.01M6 12h.01",chevronLeft:"m15 18-6-6 6-6",chevronRight:"m9 18 6-6-6-6",chevronDown:"m6 9 6 6 6-6",chevronUp:"m18 15-6-6-6 6",search:"m21 21-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 0 1 16 0Z",logout:"M10 17l5-5-5-5m5 5H3m10-8h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5",success:"m5 12 4 4L19 6",warning:"M12 3 2.8 20h18.4L12 3Zm0 6v4m0 3h.01",info:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-8v4m0-8h.01",error:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm-3-12 6 6m0-6-6 6",edit:"M4 20h4l11-11-4-4L4 16v4Zm9-13 4 4",trash:"M4 7h16m-10 4v5m4-5v5M9 4h6l1 3H8l1-3Zm-3 3 1 13h10l1-13",brain:"M9 5a3 3 0 0 0-5 2.2A3.5 3.5 0 0 0 4 14a3 3 0 0 0 5 2.2V5Zm6 0a3 3 0 0 1 5 2.2 3.5 3.5 0 0 1 0 6.8 3 3 0 0 1-5 2.2V5ZM9 9H7m2 4H6m9-4h2m-2 4h3M12 4v16",refresh:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",close:"M6 6l12 12M18 6 6 18",command:"M7 8a3 3 0 1 1-3-3h3v14a3 3 0 1 1-3-3h13a3 3 0 1 1-3 3V5a3 3 0 1 1 3 3H7Z",external:"M14 4h6v6m0-6-9 9M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6",activity:"M4 12h4l2-5 4 10 2-5h4",shield:"M12 3 5 6v5c0 4.5 2.8 7.7 7 10 4.2-2.3 7-5.5 7-10V6l-7-3Z",database:"M20 6c0 1.7-3.6 3-8 3S4 7.7 4 6s3.6-3 8-3 8 1.3 8 3Zm0 0v6c0 1.7-3.6 3-8 3s-8-1.3-8-3V6m16 6v6c0 1.7-3.6 3-8 3s-8-1.3-8-3v-6",server:"M4 4h16v6H4V4Zm0 10h16v6H4v-6Zm3-7h.01M7 17h.01",terminal:"M5 7l4 4-4 4m6 1h8M3 4h18v16H3V4Z",wrench:"M14.7 6.3a4 4 0 0 0-5.6 5.6L4 17v3h3v-2h2v-2h2l1.1-1.1a4 4 0 0 0 5.6-5.6l-3 3-3-3 3-3Z",bot:"M8 4h8m-4-2v2M5 8h14a2 2 0 0 1 2 2v8H3v-8a2 2 0 0 1 2-2Zm3 4h.01M16 12h.01M8 16h8M3 13H1m22 0h-2",workflow:"M5 5h5v5H5V5Zm9 9h5v5h-5v-5ZM10 7.5h4a3 3 0 0 1 3 3V14M7.5 10v4a3 3 0 0 0 3 3H14",globe:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-18c2.2 2.5 3.3 5.5 3.3 9S14.2 18.5 12 21m0-18C9.8 5.5 8.7 8.5 8.7 12s1.1 6.5 3.3 9M3 12h18",book:"M4 5a3 3 0 0 1 3-2h5v17H7a3 3 0 0 0-3 1V5Zm16 0a3 3 0 0 0-3-2h-5v17h5a3 3 0 0 1 3 1V5Z",message:"M4 4h16v13H8l-4 4V4Zm4 5h8m-8 4h5",puzzle:"M9 4h3a2 2 0 1 1 4 0h4v5a2 2 0 1 0 0 4v7h-7a2 2 0 1 1-4 0H4v-7a2 2 0 1 0 0-4V4h5",sparkles:"m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Zm6 10 .8 2.2L21 16l-2.2.8L18 19l-.8-2.2L15 16l2.2-.8L18 13ZM5 14l1 2.8L9 18l-3 1.2L5 22l-1-2.8L1 18l3-1.2L5 14Z",link:"M9.5 14.5 14.5 9m-7 8H6a4 4 0 0 1 0-8h3m6 0h3a4 4 0 0 1 0 8h-3",file:"M6 3h8l4 4v14H6V3Zm8 0v5h5M9 13h6m-6 4h6",folder:"M3 6h7l2 2h9v11H3V6Z",image:"M4 4h16v16H4V4Zm3 12 4-4 3 3 2-2 4 4M9 9h.01",attachment:"m8 12 5-5a3 3 0 1 1 4 4l-7 7a5 5 0 0 1-7-7l7-7",clock:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-13v5l3 2",calendar:"M5 5h14v15H5V5Zm3-2v4m8-4v4M5 10h14",chart:"M4 20V10m5 10V4m5 16v-7m5 7V7M2 20h20",sliders:"M4 7h10m4 0h2M4 17h2m4 0h10M16 4v6M8 14v6",code:"m9 6-6 6 6 6m6-12 6 6-6 6",copy:"M8 8h11v12H8V8Zm-3 8H4V4h11v1",play:"m8 5 11 7-11 7V5Z",grid:"M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z",list:"M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01",target:"M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-4h.01",rotate:"M20 6v5h-5M4 18v-5h5M18.5 10A7 7 0 0 0 6 7.5L4 11m16 2-2 3.5A7 7 0 0 1 5.5 14",archive:"M4 8h16v12H4V8Zm-1-4h18v4H3V4Zm6 8h6",flame:"M12 22c4 0 7-3 7-7 0-5-4-7-4-11-3 2-5 5-5 8-1-1-2-3-1-5-3 2-5 5-5 8 0 4 3 7 8 7Z",eye:"M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",upload:"M12 16V4m-5 5 5-5 5 5M5 20h14",download:"M12 4v12m-5-5 5 5 5-5M5 20h14",undo:"M9 7 4 12l5 5m-5-5h10a6 6 0 0 1 6 6",redo:"m15 7 5 5-5 5m5-5H10a6 6 0 0 0-6 6",minus:"M5 12h14",plus:"M12 5v14M5 12h14",network:"M12 3v4m0 10v4M3 12h4m10 0h4M7.8 7.8l2.1 2.1m4.2 4.2 2.1 2.1m0-8.4-2.1 2.1m-4.2 4.2-2.1 2.1M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z",more:"M6 12h.01M12 12h.01M18 12h.01",pause:"M9 5v14m6-14v14",sort:"M8 5v14m0 0-3-3m3 3 3-3M16 19V5m0 0-3 3m3-3 3 3"};Object.freeze(Object.keys(Td));const PC={name:"OdinIcon",props:{name:{type:String,required:!0},size:{type:[Number,String],default:18},strokeWidth:{type:[Number,String],default:1.8}},setup(e,{attrs:t}){return()=>Ui("svg",{...t,class:["odin-icon",t.class],width:e.size,height:e.size,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":e.strokeWidth,"stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":t["aria-label"]?void 0:"true",focusable:"false"},[Ui("path",{d:Td[e.name]||Td.info})])}},$C=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(",");function zf(e){return[...e.querySelectorAll($C)].filter(t=>!t.hasAttribute("hidden")&&t.getAttribute("aria-hidden")!=="true")}const FC={mounted(e){const t=document.activeElement,s=a=>{if(a.key!=="Tab")return;const n=zf(e);if(!n.length){a.preventDefault(),e.focus();return}const i=n[0],l=n[n.length-1];a.shiftKey&&document.activeElement===i?(a.preventDefault(),l.focus()):!a.shiftKey&&document.activeElement===l&&(a.preventDefault(),i.focus())};e.__odinModalFocus={previous:t,onKeydown:s},e.addEventListener("keydown",s),requestAnimationFrame(()=>{(e.querySelector("[autofocus]")||zf(e)[0]||e).focus()})},unmounted(e){var s;const t=e.__odinModalFocus;t&&(e.removeEventListener("keydown",t.onKeydown),(s=t.previous)!=null&&s.isConnected&&typeof t.previous.focus=="function"&&requestAnimationFrame(()=>t.previous.focus()),delete e.__odinModalFocus)}},BC={template:`
    ...
    </div>`,setup(){const e=f({}),t=f(!0),s=f(null),a=f([]),n=f(!1),i=f([]),l=f(!1),o=f(!1),r=f([]),c=f(0),d=f(null),u=f({reload:!1,clearSessions:!1,stopLoops:!1});let p=0;const m=H(()=>{const ce=e.value.uptime_seconds||0,z=Math.floor(ce/86400),se=Math.floor(ce%86400/3600),le=Math.floor(ce%3600/60),K=[];return z>0&&K.push(`${z}d`),se>0&&K.push(`${se}h`),(K.length===0||z===0&&se===0)&&K.push(`${le}m`),K.join(" ")}),h=H(()=>{const ce=e.value.uptime_seconds||0;return 125.66*(1-Math.min(ce/86400,1))}),b=H(()=>{const ce=e.value;return[{label:"Guilds",value:ce.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:ce.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:ce.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${ce.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:ce.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:ce.loop_count>0?"text-green-400":"",highlight:ce.loop_count>0},{label:"Agents",value:ce.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:ce.agent_count>0?`${ce.agent_count} total`:"",subColor:"text-gray-500",highlight:(ce.agent_running??0)>0},{label:"Processes",value:ce.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:ce.process_count>0?`${ce.process_count} total`:"",subColor:"text-gray-500",highlight:(ce.process_running??0)>0},{label:"Schedules",value:ce.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(ce.schedule_failing>0?`${ce.schedule_failing} failing`:"")+(ce.schedule_failing>0&&ce.schedule_paused>0?", ":"")+(ce.schedule_paused>0?`${ce.schedule_paused} paused`:"")||void 0,subColor:ce.schedule_failing>0?"text-red-400":"text-yellow-400",color:ce.schedule_failing>0?"text-red-400":"",highlight:ce.schedule_failing>0},{label:"Users",value:ce.user_count??0,icon:"users",iconColor:"text-indigo-400"},...d.value!==null?[{label:"Knowledge",value:d.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),I=H(()=>{const ce=e.value,z=[];return z.push({label:"Bot",status:ce.status==="online"?"ok":"warn",detail:ce.status==="online"?"Online":"Starting"}),(ce.schedule_failing||0)>0?z.push({label:"Schedules",status:"error",detail:`${ce.schedule_failing} failing`}):(ce.schedule_count||0)>0&&z.push({label:"Schedules",status:"ok",detail:`${ce.schedule_count} configured`}),(ce.loop_count||0)>0&&z.push({label:"Loops",status:"ok",detail:`${ce.loop_count} active`}),(ce.agent_running||0)>0&&z.push({label:"Agents",status:"ok",detail:`${ce.agent_running} running`}),(ce.process_running||0)>0&&z.push({label:"Processes",status:"ok",detail:`${ce.process_running} running`}),z});async function k(){try{e.value=await j.get("/api/status"),s.value=null}catch(ce){s.value=ce.message}finally{t.value=!1}}let y=0,g=0,x=0,S=0;function _(ce,z){const se=new Set;return[...z,...ce].filter(le=>{const K=le._hmac||JSON.stringify([le.timestamp,le.tool_name,le.user_id,le.result_summary,le.error]);return se.has(K)?!1:(se.add(K),!0)})}async function E(){const ce=++y,z=x;n.value=!0;try{const se=await j.get("/api/audit?limit=10");if(ce!==y)return;const le=z===x?[]:a.value.filter(K=>(K._liveEpoch||0)>z);a.value=_(se,le).slice(0,10),c.value=le.length}catch{}ce===y&&(n.value=!1)}async function R(){const ce=++g,z=S;l.value=!0;try{const se=await j.get("/api/audit?error_only=1&limit=5");if(ce!==g)return;const le=z===S?[]:i.value.filter(K=>(K._liveErrorEpoch||0)>z);i.value=_(se,le).slice(0,5),o.value=!1}catch{if(ce!==g)return;o.value=z===S||i.value.length===0}ce===g&&(l.value=!1)}async function w(){try{const ce=await j.get("/api/knowledge");d.value=(Array.isArray(ce)?ce:[]).reduce((z,se)=>z+(se.chunks||0),0)}catch{d.value=null}}async function O(){try{const ce=await j.get("/api/agents");r.value=ce.filter(z=>z.status==="running")}catch{}}async function U(){u.value={...u.value,reload:!0};try{await j.post("/api/reload"),Te.success("Config reloaded")}catch(ce){Te.error(ce.message)}u.value={...u.value,reload:!1}}async function T(){if(!await os({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const z=e.value.session_count;e.value={...e.value,session_count:0};try{const se=await j.post("/api/sessions/clear-all");Te.success(`Cleared ${se.count} session${se.count!==1?"s":""}`),await k()}catch(se){e.value={...e.value,session_count:z},Te.error(se.message)}u.value={...u.value,clearSessions:!1}}async function $(){if(!await os({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const z=e.value.loop_count;e.value={...e.value,loop_count:0};try{const se=await j.post("/api/loops/stop-all");Te.success(se.result),await k()}catch(se){e.value={...e.value,loop_count:z},Te.error(se.message)}u.value={...u.value,stopLoops:!1}}function Y(){t.value=!0,s.value=null,k(),E(),R(),O()}let W=null,M=null,L=null;function P(ce){if(ce.payload&&ce.payload.tool_name){x+=1;const z={...ce.payload,_isNew:!0,_key:++p,_liveEpoch:x};a.value.unshift(z),a.value.length>10&&a.value.pop(),c.value++,z.error&&(S+=1,z._liveErrorEpoch=S,o.value=!1,i.value.unshift(z),i.value.length>5&&i.value.pop()),setTimeout(()=>{z._isNew=!1},1500),clearTimeout(L),L=setTimeout(()=>{c.value=0},1e4)}}let re=null;return st(async()=>{await Promise.all([k(),E(),R(),O(),w()]),W=setInterval(k,15e3),M=setInterval(O,1e4),ut.subscribe("events",P),re=ut.onReconnected(()=>{E(),R()})}),xt(()=>{W&&clearInterval(W),M&&clearInterval(M),clearTimeout(L),ut.unsubscribe("events",P),re&&(re(),re=null)}),{status:e,loading:t,error:s,uptime:m,uptimeRingOffset:h,stats:b,healthIndicators:I,activity:a,activityLoading:n,newEventCount:c,errors:i,errorsLoading:l,errorsError:o,agents:r,actionLoading:u,fetchActivity:E,fetchErrors:R,fetchStatus:k,onEvent:P,formatTime:qS,formatDuration:Ji,retry:Y,reloadConfig:U,clearSessions:T,stopAllLoops:$}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Hf(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,a=Array(t);s<t;s++)a[s]=e[s];return a}function UC(e){if(Array.isArray(e))return e}function zC(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var a,n,i,l,o=[],r=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(r=(a=i.call(s)).done)&&(o.push(a.value),o.length!==t);r=!0);}catch(d){c=!0,n=d}finally{try{if(!r&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw n}}return o}}function HC(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function jC(e,t){return UC(e)||zC(e,t)||VC(e,t)||HC()}function VC(e,t){if(e){if(typeof e=="string")return Hf(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Hf(e,t):void 0}}const Og=Object.entries,jf=Object.setPrototypeOf,qC=Object.isFrozen,GC=Object.getPrototypeOf,WC=Object.getOwnPropertyDescriptor;let Ns=Object.freeze,la=Object.seal,Si=Object.create,Lg=typeof Reflect<"u"&&Reflect,Ed=Lg.apply,Ad=Lg.construct;Ns||(Ns=function(t){return t});la||(la=function(t){return t});Ed||(Ed=function(t,s){for(var a=arguments.length,n=new Array(a>2?a-2:0),i=2;i<a;i++)n[i-2]=arguments[i];return t.apply(s,n)});Ad||(Ad=function(t){for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return new t(...a)});const Ua=Jt(Array.prototype.forEach),KC=Jt(Array.prototype.lastIndexOf),Vf=Jt(Array.prototype.pop),yi=Jt(Array.prototype.push),JC=Jt(Array.prototype.splice),As=Array.isArray,kl=Jt(String.prototype.toLowerCase),Uc=Jt(String.prototype.toString),qf=Jt(String.prototype.match),xi=Jt(String.prototype.replace),Gf=Jt(String.prototype.indexOf),ZC=Jt(String.prototype.trim),YC=Jt(Number.prototype.toString),QC=Jt(Boolean.prototype.toString),Wf=typeof BigInt>"u"?null:Jt(BigInt.prototype.toString),Kf=typeof Symbol>"u"?null:Jt(Symbol.prototype.toString),Dt=Jt(Object.prototype.hasOwnProperty),vl=Jt(Object.prototype.toString),us=Jt(RegExp.prototype.test),Fn=XC(TypeError);function Jt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,a=new Array(s>1?s-1:0),n=1;n<s;n++)a[n-1]=arguments[n];return Ed(e,t,a)}}function XC(e){return function(){for(var t=arguments.length,s=new Array(t),a=0;a<t;a++)s[a]=arguments[a];return Ad(e,s)}}function tt(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:kl;if(jf&&jf(e,null),!As(t))return e;let a=t.length;for(;a--;){let n=t[a];if(typeof n=="string"){const i=s(n);i!==n&&(qC(t)||(t[a]=i),n=i)}e[n]=!0}return e}function eT(e){for(let t=0;t<e.length;t++)Dt(e,t)||(e[t]=null);return e}function xs(e){const t=Si(null);for(const a of Og(e)){var s=jC(a,2);const n=s[0],i=s[1];Dt(e,n)&&(As(i)?t[n]=eT(i):i&&typeof i=="object"&&i.constructor===Object?t[n]=xs(i):t[n]=i)}return t}function tT(e){switch(typeof e){case"string":return e;case"number":return YC(e);case"boolean":return QC(e);case"bigint":return Wf?Wf(e):"0";case"symbol":return Kf?Kf(e):"Symbol()";case"undefined":return vl(e);case"function":case"object":{if(e===null)return vl(e);const t=e,s=Sa(t,"toString");if(typeof s=="function"){const a=s(t);return typeof a=="string"?a:vl(a)}return vl(e)}default:return vl(e)}}function Sa(e,t){for(;e!==null;){const a=WC(e,t);if(a){if(a.get)return Jt(a.get);if(typeof a.value=="function")return Jt(a.value)}e=GC(e)}function s(){return null}return s}function sT(e){try{return us(e,""),!0}catch{return!1}}const Jf=Ns(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),zc=Ns(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Hc=Ns(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),aT=Ns(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),jc=Ns(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),nT=Ns(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Zf=Ns(["#text"]),Yf=Ns(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Vc=Ns(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Qf=Ns(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Uo=Ns(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),iT=la(/{{[\w\W]*|^[\w\W]*}}/g),lT=la(/<%[\w\W]*|^[\w\W]*%>/g),oT=la(/\${[\w\W]*/g),rT=la(/^data-[\-\w.\u00B7-\uFFFF]+$/),cT=la(/^aria-[\-\w]+$/),Xf=la(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),dT=la(/^(?:\w+script|data):/i),uT=la(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),pT=la(/^html$/i),fT=la(/^[a-z][.\w]*(-[.\w]+)+$/i),wa={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},mT=function(){return typeof window>"u"?null:window},hT=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let a=null;const n="data-tt-policy-suffix";s&&s.hasAttribute(n)&&(a=s.getAttribute(n));const i="dompurify"+(a?"#"+a:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},em=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Ng(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:mT();const t=Re=>Ng(Re);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==wa.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const a=s,n=a.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,o=e.Element,r=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,p=o.prototype,m=Sa(p,"cloneNode"),h=Sa(p,"remove"),b=Sa(p,"nextSibling"),I=Sa(p,"childNodes"),k=Sa(p,"parentNode"),y=Sa(p,"shadowRoot"),g=Sa(p,"attributes"),x=l&&l.prototype?Sa(l.prototype,"nodeType"):null,S=l&&l.prototype?Sa(l.prototype,"nodeName"):null;if(typeof i=="function"){const Re=s.createElement("template");Re.content&&Re.content.ownerDocument&&(s=Re.content.ownerDocument)}let _,E="",R,w=!1,O=0;const U=function(){if(O>0)throw Fn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},T=function(N){U(),O++;try{return _.createHTML(N)}finally{O--}},$=function(N){U(),O++;try{return _.createScriptURL(N)}finally{O--}},Y=function(){return w||(R=hT(u,n),w=!0),R},W=s,M=W.implementation,L=W.createNodeIterator,P=W.createDocumentFragment,re=W.getElementsByTagName,ce=a.importNode;let z=em();t.isSupported=typeof Og=="function"&&typeof k=="function"&&M&&M.createHTMLDocument!==void 0;const se=iT,le=lT,K=oT,ve=rT,Me=cT,ne=dT,ie=uT,fe=fT;let me=Xf,ge=null;const Le=tt({},[...Jf,...zc,...Hc,...jc,...Zf]);let A=null;const D=tt({},[...Yf,...Vc,...Qf,...Uo]);let G=Object.seal(Si(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),pe=null,B=null;const Z=Object.seal(Si(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let ue=!0,V=!0,X=!1,ee=!0,be=!1,he=!0,we=!1,_e=!1,ye=!1,We=!1,Je=!1,Fe=!1,qe=!0,at=!1;const Xe="user-content-";let J=!0,Ee=!1,Ae={},Ne=null;const te=tt({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Oe=null;const ze=tt({},["audio","video","img","source","image","track"]);let rt=null;const Zt=tt({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),lt="http://www.w3.org/1998/Math/MathML",gt="http://www.w3.org/2000/svg",Yt="http://www.w3.org/1999/xhtml";let cs=Yt,oa=!1,js=null;const Ze=tt({},[lt,gt,Yt],Uc);let ra=tt({},["mi","mo","mn","ms","mtext"]),vs=tt({},["annotation-xml"]);const Ms=tt({},["title","style","font","a","script"]);let gs=null;const En=["application/xhtml+xml","text/html"],Qt="text/html";let _t=null,ds=null;const ba=s.createElement("form"),rn=function(N){return N instanceof RegExp||N instanceof Function},ca=function(){let N=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(ds&&ds===N)return;(!N||typeof N!="object")&&(N={}),N=xs(N),gs=En.indexOf(N.PARSER_MEDIA_TYPE)===-1?Qt:N.PARSER_MEDIA_TYPE,_t=gs==="application/xhtml+xml"?Uc:kl,ge=Dt(N,"ALLOWED_TAGS")&&As(N.ALLOWED_TAGS)?tt({},N.ALLOWED_TAGS,_t):Le,A=Dt(N,"ALLOWED_ATTR")&&As(N.ALLOWED_ATTR)?tt({},N.ALLOWED_ATTR,_t):D,js=Dt(N,"ALLOWED_NAMESPACES")&&As(N.ALLOWED_NAMESPACES)?tt({},N.ALLOWED_NAMESPACES,Uc):Ze,rt=Dt(N,"ADD_URI_SAFE_ATTR")&&As(N.ADD_URI_SAFE_ATTR)?tt(xs(Zt),N.ADD_URI_SAFE_ATTR,_t):Zt,Oe=Dt(N,"ADD_DATA_URI_TAGS")&&As(N.ADD_DATA_URI_TAGS)?tt(xs(ze),N.ADD_DATA_URI_TAGS,_t):ze,Ne=Dt(N,"FORBID_CONTENTS")&&As(N.FORBID_CONTENTS)?tt({},N.FORBID_CONTENTS,_t):te,pe=Dt(N,"FORBID_TAGS")&&As(N.FORBID_TAGS)?tt({},N.FORBID_TAGS,_t):xs({}),B=Dt(N,"FORBID_ATTR")&&As(N.FORBID_ATTR)?tt({},N.FORBID_ATTR,_t):xs({}),Ae=Dt(N,"USE_PROFILES")?N.USE_PROFILES&&typeof N.USE_PROFILES=="object"?xs(N.USE_PROFILES):N.USE_PROFILES:!1,ue=N.ALLOW_ARIA_ATTR!==!1,V=N.ALLOW_DATA_ATTR!==!1,X=N.ALLOW_UNKNOWN_PROTOCOLS||!1,ee=N.ALLOW_SELF_CLOSE_IN_ATTR!==!1,be=N.SAFE_FOR_TEMPLATES||!1,he=N.SAFE_FOR_XML!==!1,we=N.WHOLE_DOCUMENT||!1,We=N.RETURN_DOM||!1,Je=N.RETURN_DOM_FRAGMENT||!1,Fe=N.RETURN_TRUSTED_TYPE||!1,ye=N.FORCE_BODY||!1,qe=N.SANITIZE_DOM!==!1,at=N.SANITIZE_NAMED_PROPS||!1,J=N.KEEP_CONTENT!==!1,Ee=N.IN_PLACE||!1,me=sT(N.ALLOWED_URI_REGEXP)?N.ALLOWED_URI_REGEXP:Xf,cs=typeof N.NAMESPACE=="string"?N.NAMESPACE:Yt,ra=Dt(N,"MATHML_TEXT_INTEGRATION_POINTS")&&N.MATHML_TEXT_INTEGRATION_POINTS&&typeof N.MATHML_TEXT_INTEGRATION_POINTS=="object"?xs(N.MATHML_TEXT_INTEGRATION_POINTS):tt({},["mi","mo","mn","ms","mtext"]),vs=Dt(N,"HTML_INTEGRATION_POINTS")&&N.HTML_INTEGRATION_POINTS&&typeof N.HTML_INTEGRATION_POINTS=="object"?xs(N.HTML_INTEGRATION_POINTS):tt({},["annotation-xml"]);const de=Dt(N,"CUSTOM_ELEMENT_HANDLING")&&N.CUSTOM_ELEMENT_HANDLING&&typeof N.CUSTOM_ELEMENT_HANDLING=="object"?xs(N.CUSTOM_ELEMENT_HANDLING):Si(null);if(G=Si(null),Dt(de,"tagNameCheck")&&rn(de.tagNameCheck)&&(G.tagNameCheck=de.tagNameCheck),Dt(de,"attributeNameCheck")&&rn(de.attributeNameCheck)&&(G.attributeNameCheck=de.attributeNameCheck),Dt(de,"allowCustomizedBuiltInElements")&&typeof de.allowCustomizedBuiltInElements=="boolean"&&(G.allowCustomizedBuiltInElements=de.allowCustomizedBuiltInElements),be&&(V=!1),Je&&(We=!0),Ae&&(ge=tt({},Zf),A=Si(null),Ae.html===!0&&(tt(ge,Jf),tt(A,Yf)),Ae.svg===!0&&(tt(ge,zc),tt(A,Vc),tt(A,Uo)),Ae.svgFilters===!0&&(tt(ge,Hc),tt(A,Vc),tt(A,Uo)),Ae.mathMl===!0&&(tt(ge,jc),tt(A,Qf),tt(A,Uo))),Z.tagCheck=null,Z.attributeCheck=null,Dt(N,"ADD_TAGS")&&(typeof N.ADD_TAGS=="function"?Z.tagCheck=N.ADD_TAGS:As(N.ADD_TAGS)&&(ge===Le&&(ge=xs(ge)),tt(ge,N.ADD_TAGS,_t))),Dt(N,"ADD_ATTR")&&(typeof N.ADD_ATTR=="function"?Z.attributeCheck=N.ADD_ATTR:As(N.ADD_ATTR)&&(A===D&&(A=xs(A)),tt(A,N.ADD_ATTR,_t))),Dt(N,"ADD_URI_SAFE_ATTR")&&As(N.ADD_URI_SAFE_ATTR)&&tt(rt,N.ADD_URI_SAFE_ATTR,_t),Dt(N,"FORBID_CONTENTS")&&As(N.FORBID_CONTENTS)&&(Ne===te&&(Ne=xs(Ne)),tt(Ne,N.FORBID_CONTENTS,_t)),Dt(N,"ADD_FORBID_CONTENTS")&&As(N.ADD_FORBID_CONTENTS)&&(Ne===te&&(Ne=xs(Ne)),tt(Ne,N.ADD_FORBID_CONTENTS,_t)),J&&(ge["#text"]=!0),we&&tt(ge,["html","head","body"]),ge.table&&(tt(ge,["tbody"]),delete pe.tbody),N.TRUSTED_TYPES_POLICY){if(typeof N.TRUSTED_TYPES_POLICY.createHTML!="function")throw Fn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof N.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Fn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const xe=_;_=N.TRUSTED_TYPES_POLICY;try{E=T("")}catch(Be){throw _=xe,Be}}else N.TRUSTED_TYPES_POLICY===null?(_=void 0,E=""):(_===void 0&&(_=Y()),_&&typeof E=="string"&&(E=T("")));(z.uponSanitizeElement.length>0||z.uponSanitizeAttribute.length>0)&&ge===Le&&(ge=xs(ge)),z.uponSanitizeAttribute.length>0&&A===D&&(A=xs(A)),Ns&&Ns(N),ds=N},oe=tt({},[...zc,...Hc,...aT]),Ce=tt({},[...jc,...nT]),Ke=function(N){let de=k(N);(!de||!de.tagName)&&(de={namespaceURI:cs,tagName:"template"});const xe=kl(N.tagName),Be=kl(de.tagName);return js[N.namespaceURI]?N.namespaceURI===gt?de.namespaceURI===Yt?xe==="svg":de.namespaceURI===lt?xe==="svg"&&(Be==="annotation-xml"||ra[Be]):!!oe[xe]:N.namespaceURI===lt?de.namespaceURI===Yt?xe==="math":de.namespaceURI===gt?xe==="math"&&vs[Be]:!!Ce[xe]:N.namespaceURI===Yt?de.namespaceURI===gt&&!vs[Be]||de.namespaceURI===lt&&!ra[Be]?!1:!Ce[xe]&&(Ms[xe]||!oe[xe]):!!(gs==="application/xhtml+xml"&&js[N.namespaceURI]):!1},je=function(N){yi(t.removed,{element:N});try{k(N).removeChild(N)}catch{if(h(N),!k(N))throw Fn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},kt=function(N){const de=I?I(N):N.childNodes;if(de){const Be=[];Ua(de,Ve=>{yi(Be,Ve)}),Ua(Be,Ve=>{try{h(Ve)}catch{}})}const xe=g?g(N):null;if(xe)for(let Be=xe.length-1;Be>=0;--Be){const Ve=xe[Be],Qe=Ve&&Ve.name;if(typeof Qe=="string")try{N.removeAttribute(Qe)}catch{}}},St=function(N,de){try{yi(t.removed,{attribute:de.getAttributeNode(N),from:de})}catch{yi(t.removed,{attribute:null,from:de})}if(de.removeAttribute(N),N==="is")if(We||Je)try{je(de)}catch{}else try{de.setAttribute(N,"")}catch{}},cn=function(N){const de=g?g(N):N.attributes;if(de)for(let xe=de.length-1;xe>=0;--xe){const Be=de[xe],Ve=Be&&Be.name;if(!(typeof Ve!="string"||A[_t(Ve)]))try{N.removeAttribute(Ve)}catch{}}},An=function(N){const de=[N];for(;de.length>0;){const xe=de.pop();(x?x(xe):xe.nodeType)===wa.element&&cn(xe);const Ve=I?I(xe):xe.childNodes;if(Ve)for(let Qe=Ve.length-1;Qe>=0;--Qe)de.push(Ve[Qe])}},dn=function(N){let de=null,xe=null;if(ye)N="<remove></remove>"+N;else{const Qe=qf(N,/^[\r\n\t ]+/);xe=Qe&&Qe[0]}gs==="application/xhtml+xml"&&cs===Yt&&(N='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+N+"</body></html>");const Be=_?T(N):N;if(cs===Yt)try{de=new d().parseFromString(Be,gs)}catch{}if(!de||!de.documentElement){de=M.createDocument(cs,"template",null);try{de.documentElement.innerHTML=oa?E:Be}catch{}}const Ve=de.body||de.documentElement;return N&&xe&&Ve.insertBefore(s.createTextNode(xe),Ve.childNodes[0]||null),cs===Yt?re.call(de,we?"html":"body")[0]:we?de.documentElement:Ve},Rn=function(N){return L.call(N.ownerDocument||N,N,r.SHOW_ELEMENT|r.SHOW_COMMENT|r.SHOW_TEXT|r.SHOW_PROCESSING_INSTRUCTION|r.SHOW_CDATA_SECTION,null)},da=function(N){var de,xe;N.normalize();const Be=L.call(N.ownerDocument||N,N,r.SHOW_TEXT|r.SHOW_COMMENT|r.SHOW_CDATA_SECTION|r.SHOW_PROCESSING_INSTRUCTION,null);let Ve=Be.nextNode();for(;Ve;){let Et=Ve.data;Ua([se,le,K],pt=>{Et=xi(Et,pt," ")}),Ve.data=Et,Ve=Be.nextNode()}const Qe=(de=(xe=N.querySelectorAll)===null||xe===void 0?void 0:xe.call(N,"template"))!==null&&de!==void 0?de:[];Ua(Array.from(Qe),Et=>{jt(Et.content)&&da(Et.content)})},ya=function(N){const de=S?S(N):null;return typeof de!="string"||_t(de)!=="form"?!1:typeof N.nodeName!="string"||typeof N.textContent!="string"||typeof N.removeChild!="function"||N.attributes!==g(N)||typeof N.removeAttribute!="function"||typeof N.setAttribute!="function"||typeof N.namespaceURI!="string"||typeof N.insertBefore!="function"||typeof N.hasChildNodes!="function"||N.nodeType!==x(N)||N.childNodes!==I(N)},jt=function(N){if(!x||typeof N!="object"||N===null)return!1;try{return x(N)===wa.documentFragment}catch{return!1}},ua=function(N){if(!x||typeof N!="object"||N===null)return!1;try{return typeof x(N)=="number"}catch{return!1}};function as(Re,N,de){Ua(Re,xe=>{xe.call(t,N,de,ds)})}const un=function(N){let de=null;if(as(z.beforeSanitizeElements,N,null),ya(N))return je(N),!0;const xe=_t(S?S(N):N.nodeName);if(as(z.uponSanitizeElement,N,{tagName:xe,allowedTags:ge}),he&&N.hasChildNodes()&&!ua(N.firstElementChild)&&us(/<[/\w!]/g,N.innerHTML)&&us(/<[/\w!]/g,N.textContent)||he&&N.namespaceURI===Yt&&xe==="style"&&ua(N.firstElementChild)||N.nodeType===wa.progressingInstruction||he&&N.nodeType===wa.comment&&us(/<[/\w]/g,N.data))return je(N),!0;if(pe[xe]||!(Z.tagCheck instanceof Function&&Z.tagCheck(xe))&&!ge[xe]){if(!pe[xe]&&oi(xe)&&(G.tagNameCheck instanceof RegExp&&us(G.tagNameCheck,xe)||G.tagNameCheck instanceof Function&&G.tagNameCheck(xe)))return!1;if(J&&!Ne[xe]){const Ve=k(N),Qe=I(N);if(Qe&&Ve){const Et=Qe.length;for(let pt=Et-1;pt>=0;--pt){const At=Ee?Qe[pt]:m(Qe[pt],!0);Ve.insertBefore(At,b(N))}}}return je(N),!0}return(x?x(N):N.nodeType)===wa.element&&!Ke(N)||(xe==="noscript"||xe==="noembed"||xe==="noframes")&&us(/<\/no(script|embed|frames)/i,N.innerHTML)?(je(N),!0):(be&&N.nodeType===wa.text&&(de=N.textContent,Ua([se,le,K],Ve=>{de=xi(de,Ve," ")}),N.textContent!==de&&(yi(t.removed,{element:N.cloneNode()}),N.textContent=de)),as(z.afterSanitizeElements,N,null),!1)},In=function(N,de,xe){if(B[de]||qe&&(de==="id"||de==="name")&&(xe in s||xe in ba))return!1;const Be=A[de]||Z.attributeCheck instanceof Function&&Z.attributeCheck(de,N);if(!(V&&!B[de]&&us(ve,de))){if(!(ue&&us(Me,de))){if(!Be||B[de]){if(!(oi(N)&&(G.tagNameCheck instanceof RegExp&&us(G.tagNameCheck,N)||G.tagNameCheck instanceof Function&&G.tagNameCheck(N))&&(G.attributeNameCheck instanceof RegExp&&us(G.attributeNameCheck,de)||G.attributeNameCheck instanceof Function&&G.attributeNameCheck(de,N))||de==="is"&&G.allowCustomizedBuiltInElements&&(G.tagNameCheck instanceof RegExp&&us(G.tagNameCheck,xe)||G.tagNameCheck instanceof Function&&G.tagNameCheck(xe))))return!1}else if(!rt[de]){if(!us(me,xi(xe,ie,""))){if(!((de==="src"||de==="xlink:href"||de==="href")&&N!=="script"&&Gf(xe,"data:")===0&&Oe[N])){if(!(X&&!us(ne,xi(xe,ie,"")))){if(xe)return!1}}}}}}return!0},li=tt({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),oi=function(N){return!li[kl(N)]&&us(fe,N)},ri=function(N){as(z.beforeSanitizeAttributes,N,null);const de=N.attributes;if(!de||ya(N))return;const xe={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:A,forceKeepAttr:void 0};let Be=de.length;for(;Be--;){const Ve=de[Be],Qe=Ve.name,Et=Ve.namespaceURI,pt=Ve.value,At=_t(Qe),bs=pt;let Nt=Qe==="value"?bs:ZC(bs);if(xe.attrName=At,xe.attrValue=Nt,xe.keepAttr=!0,xe.forceKeepAttr=void 0,as(z.uponSanitizeAttribute,N,xe),Nt=xe.attrValue,at&&(At==="id"||At==="name")&&Gf(Nt,Xe)!==0&&(St(Qe,N),Nt=Xe+Nt),he&&us(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Nt)){St(Qe,N);continue}if(At==="attributename"&&qf(Nt,"href")){St(Qe,N);continue}if(xe.forceKeepAttr)continue;if(!xe.keepAttr){St(Qe,N);continue}if(!ee&&us(/\/>/i,Nt)){St(Qe,N);continue}be&&Ua([se,le,K],ci=>{Nt=xi(Nt,ci," ")});const Na=_t(N.nodeName);if(!In(Na,At,Nt)){St(Qe,N);continue}if(_&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!Et)switch(u.getAttributeType(Na,At)){case"TrustedHTML":{Nt=T(Nt);break}case"TrustedScriptURL":{Nt=$(Nt);break}}if(Nt!==bs)try{Et?N.setAttributeNS(Et,Qe,Nt):N.setAttribute(Qe,Nt),ya(N)?je(N):Vf(t.removed)}catch{St(Qe,N)}}as(z.afterSanitizeAttributes,N,null)},ns=function(N){let de=null;const xe=Rn(N);for(as(z.beforeSanitizeShadowDOM,N,null);de=xe.nextNode();)if(as(z.uponSanitizeShadowNode,de,null),un(de),ri(de),jt(de.content)&&ns(de.content),(x?x(de):de.nodeType)===wa.element){const Ve=y?y(de):de.shadowRoot;jt(Ve)&&(On(Ve),ns(Ve))}as(z.afterSanitizeShadowDOM,N,null)},On=function(N){const de=[{node:N,shadow:null}];for(;de.length>0;){const xe=de.pop();if(xe.shadow){ns(xe.shadow);continue}const Be=xe.node,Qe=(x?x(Be):Be.nodeType)===wa.element,Et=I?I(Be):Be.childNodes;if(Et)for(let pt=Et.length-1;pt>=0;--pt)de.push({node:Et[pt],shadow:null});if(Qe){const pt=S?S(Be):null;if(typeof pt=="string"&&_t(pt)==="template"){const At=Be.content;jt(At)&&de.push({node:At,shadow:null})}}if(Qe){const pt=y?y(Be):Be.shadowRoot;jt(pt)&&de.push({node:null,shadow:pt},{node:pt,shadow:null})}}};return t.sanitize=function(Re){let N=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},de=null,xe=null,Be=null,Ve=null;if(oa=!Re,oa&&(Re="<!-->"),typeof Re!="string"&&!ua(Re)&&(Re=tT(Re),typeof Re!="string"))throw Fn("dirty is not a string, aborting");if(!t.isSupported)return Re;_e||ca(N),t.removed=[];const Qe=Ee&&typeof Re!="string"&&ua(Re);if(Qe){const At=S?S(Re):Re.nodeName;if(typeof At=="string"){const bs=_t(At);if(!ge[bs]||pe[bs])throw Fn("root node is forbidden and cannot be sanitized in-place")}if(ya(Re))throw Fn("root node is clobbered and cannot be sanitized in-place");try{On(Re)}catch(bs){throw kt(Re),bs}}else if(ua(Re))de=dn("<!---->"),xe=de.ownerDocument.importNode(Re,!0),xe.nodeType===wa.element&&xe.nodeName==="BODY"||xe.nodeName==="HTML"?de=xe:de.appendChild(xe),On(xe);else{if(!We&&!be&&!we&&Re.indexOf("<")===-1)return _&&Fe?T(Re):Re;if(de=dn(Re),!de)return We?null:Fe?E:""}de&&ye&&je(de.firstChild);const Et=Rn(Qe?Re:de);try{for(;Be=Et.nextNode();)un(Be),ri(Be),jt(Be.content)&&ns(Be.content)}catch(At){throw Qe&&kt(Re),At}if(Qe)return Ua(t.removed,At=>{At.element&&An(At.element)}),be&&da(Re),Re;if(We){if(be&&da(de),Je)for(Ve=P.call(de.ownerDocument);de.firstChild;)Ve.appendChild(de.firstChild);else Ve=de;return(A.shadowroot||A.shadowrootmode)&&(Ve=ce.call(a,Ve,!0)),Ve}let pt=we?de.outerHTML:de.innerHTML;return we&&ge["!doctype"]&&de.ownerDocument&&de.ownerDocument.doctype&&de.ownerDocument.doctype.name&&us(pT,de.ownerDocument.doctype.name)&&(pt="<!DOCTYPE "+de.ownerDocument.doctype.name+`>
`+pt),be&&Ua([se,le,K],At=>{pt=xi(pt,At," ")}),_&&Fe?T(pt):pt},t.setConfig=function(){let Re=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};ca(Re),_e=!0},t.clearConfig=function(){ds=null,_e=!1,_=R,E=""},t.isValidAttribute=function(Re,N,de){ds||ca({});const xe=_t(Re),Be=_t(N);return In(xe,Be,de)},t.addHook=function(Re,N){typeof N=="function"&&yi(z[Re],N)},t.removeHook=function(Re,N){if(N!==void 0){const de=KC(z[Re],N);return de===-1?void 0:JC(z[Re],de,1)[0]}return Vf(z[Re])},t.removeHooks=function(Re){z[Re]=[]},t.removeAllHooks=function(){z=em()},t}var tm=Ng();function Mu(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ii=Mu();function Mg(e){ii=e}var Ll={exec:()=>null};function yt(e,t=""){let s=typeof e=="string"?e:e.source;const a={replace:(n,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Os.caret,"$1"),s=s.replace(n,l),a},getRegex:()=>new RegExp(s,t)};return a}var Os={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},vT=/^(?:[ \t]*(?:\n|$))+/,gT=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,bT=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,fo=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,yT=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Du=/(?:[*+-]|\d{1,9}[.)])/,Dg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Pg=yt(Dg).replace(/bull/g,Du).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),xT=yt(Dg).replace(/bull/g,Du).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Pu=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,_T=/^[^\n]+/,$u=/(?!\s*\])(?:\\.|[^\[\]\\])+/,wT=yt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",$u).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),kT=yt(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Du).getRegex(),tc="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Fu=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ST=yt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Fu).replace("tag",tc).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),$g=yt(Pu).replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex(),CT=yt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",$g).getRegex(),Bu={blockquote:CT,code:gT,def:wT,fences:bT,heading:yT,hr:fo,html:ST,lheading:Pg,list:kT,newline:vT,paragraph:$g,table:Ll,text:_T},sm=yt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex(),TT={...Bu,lheading:xT,table:sm,paragraph:yt(Pu).replace("hr",fo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",sm).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tc).getRegex()},ET={...Bu,html:yt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Fu).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ll,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:yt(Pu).replace("hr",fo).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Pg).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},AT=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,RT=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Fg=/^( {2,}|\\)\n(?!\s*$)/,IT=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,sc=/[\p{P}\p{S}]/u,Uu=/[\s\p{P}\p{S}]/u,Bg=/[^\s\p{P}\p{S}]/u,OT=yt(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Uu).getRegex(),Ug=/(?!~)[\p{P}\p{S}]/u,LT=/(?!~)[\s\p{P}\p{S}]/u,NT=/(?:[^\s\p{P}\p{S}]|~)/u,MT=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,zg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,DT=yt(zg,"u").replace(/punct/g,sc).getRegex(),PT=yt(zg,"u").replace(/punct/g,Ug).getRegex(),Hg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",$T=yt(Hg,"gu").replace(/notPunctSpace/g,Bg).replace(/punctSpace/g,Uu).replace(/punct/g,sc).getRegex(),FT=yt(Hg,"gu").replace(/notPunctSpace/g,NT).replace(/punctSpace/g,LT).replace(/punct/g,Ug).getRegex(),BT=yt("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Bg).replace(/punctSpace/g,Uu).replace(/punct/g,sc).getRegex(),UT=yt(/\\(punct)/,"gu").replace(/punct/g,sc).getRegex(),zT=yt(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),HT=yt(Fu).replace("(?:-->|$)","-->").getRegex(),jT=yt("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",HT).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Sr=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,VT=yt(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Sr).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),jg=yt(/^!?\[(label)\]\[(ref)\]/).replace("label",Sr).replace("ref",$u).getRegex(),Vg=yt(/^!?\[(ref)\](?:\[\])?/).replace("ref",$u).getRegex(),qT=yt("reflink|nolink(?!\\()","g").replace("reflink",jg).replace("nolink",Vg).getRegex(),zu={_backpedal:Ll,anyPunctuation:UT,autolink:zT,blockSkip:MT,br:Fg,code:RT,del:Ll,emStrongLDelim:DT,emStrongRDelimAst:$T,emStrongRDelimUnd:BT,escape:AT,link:VT,nolink:Vg,punctuation:OT,reflink:jg,reflinkSearch:qT,tag:jT,text:IT,url:Ll},GT={...zu,link:yt(/^!?\[(label)\]\((.*?)\)/).replace("label",Sr).getRegex(),reflink:yt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Sr).getRegex()},Rd={...zu,emStrongRDelimAst:FT,emStrongLDelim:PT,url:yt(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},WT={...Rd,br:yt(Fg).replace("{2,}","*").getRegex(),text:yt(Rd.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},zo={normal:Bu,gfm:TT,pedantic:ET},gl={normal:zu,gfm:Rd,breaks:WT,pedantic:GT},KT={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},am=e=>KT[e];function Ca(e,t){if(t){if(Os.escapeTest.test(e))return e.replace(Os.escapeReplace,am)}else if(Os.escapeTestNoEncode.test(e))return e.replace(Os.escapeReplaceNoEncode,am);return e}function nm(e){try{e=encodeURI(e).replace(Os.percentDecode,"%")}catch{return null}return e}function im(e,t){var i;const s=e.replace(Os.findPipe,(l,o,r)=>{let c=!1,d=o;for(;--d>=0&&r[d]==="\\";)c=!c;return c?"|":" |"}),a=s.split(Os.splitPipe);let n=0;if(a[0].trim()||a.shift(),a.length>0&&!((i=a.at(-1))!=null&&i.trim())&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;n<a.length;n++)a[n]=a[n].trim().replace(Os.slashPipe,"|");return a}function bl(e,t,s){const a=e.length;if(a===0)return"";let n=0;for(;n<a&&e.charAt(a-n-1)===t;)n++;return e.slice(0,a-n)}function JT(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let a=0;a<e.length;a++)if(e[a]==="\\")a++;else if(e[a]===t[0])s++;else if(e[a]===t[1]&&(s--,s<0))return a;return s>0?-2:-1}function lm(e,t,s,a,n){const i=t.href,l=t.title||null,o=e[1].replace(n.other.outputLinkReplace,"$1");a.state.inLink=!0;const r={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:o,tokens:a.inlineTokens(o)};return a.state.inLink=!1,r}function ZT(e,t,s){const a=e.match(s.other.indentCodeCompensation);if(a===null)return t;const n=a[1];return t.split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+Ca(s.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(s);throw s}}},Xn=new YT;function vt(e,t){return Xn.parse(e,t)}vt.options=vt.setOptions=function(e){return Xn.setOptions(e),vt.defaults=Xn.defaults,Mg(vt.defaults),vt};vt.getDefaults=Mu;vt.defaults=ii;vt.use=function(...e){return Xn.use(...e),vt.defaults=Xn.defaults,Mg(vt.defaults),vt};vt.walkTokens=function(e,t){return Xn.walkTokens(e,t)};vt.parseInline=Xn.parseInline;vt.Parser=Ja;vt.parser=Ja.parse;vt.Renderer=Tr;vt.TextRenderer=Hu;vt.Lexer=Ka;vt.lexer=Ka.lex;vt.Tokenizer=Cr;vt.Hooks=Jo;vt.parse=vt;vt.options;vt.setOptions;vt.use;vt.walkTokens;vt.parseInline;Ja.parse;Ka.lex;const QT={breaks:!0,gfm:!0};function om(e){if(!e)return"";try{if(typeof vt<"u"&&vt.parse){const t=vt.parse(e,QT);return typeof tm<"u"?tm.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function XT(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),a=t.getMinutes().toString().padStart(2,"0");return`${s}:${a}`}const eE={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function tE(e){return eE[e]||"wrench"}const sE=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function rm(e){if(!e)return[];const t=e.match(sE);return t?[...new Set(t)]:[]}const aE={template:`
  ...
  `},iE={props:["onComplete"],template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),a=f(!1),n=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let m=null;const h=f("starting"),b=f(""),I=qg.filter(z=>z.meta),k=H(()=>["Workspace","Operate","Observe","Manage"].map(z=>({name:z,routes:I.filter(se=>se.meta.section===z)})).filter(z=>z.routes.length)),y=H(()=>{var z;return((z=Nl.currentRoute.value.meta)==null?void 0:z.label)||"Odin"}),g=H(()=>{var z;return((z=Nl.currentRoute.value.meta)==null?void 0:z.section)||"Management"}),x=H(()=>{var z;return((z=Nl.currentRoute.value.meta)==null?void 0:z.description)||"Management console"});function S(){ut.disconnect(),M&&(clearInterval(M),M=null)}j.onSessionExpired=()=>{t.value=!0,S(),j.setToken(""),e.value="login"};function _(z){var se;if((z.ctrlKey||z.metaKey)&&z.key.toLowerCase()==="k"){e.value==="ready"&&(z.preventDefault(),Uf());return}if(a.value&&z.key==="Tab"){const le=[...((se=n.value)==null?void 0:se.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(le.length){const K=le[0],ve=le[le.length-1];if(z.shiftKey&&(document.activeElement===K||!n.value.contains(document.activeElement))){z.preventDefault(),ve.focus();return}if(!z.shiftKey&&(document.activeElement===ve||!n.value.contains(document.activeElement))){z.preventDefault(),K.focus();return}}}if(z.key==="Escape"&&a.value){a.value=!1,z.preventDefault();return}if(z.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(z.target.tagName)){z.preventDefault();const le=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');le&&le.focus()}}function E(){l.value=!!(o!=null&&o.matches),l.value||(a.value=!1)}async function R(){try{const z=await j.get("/api/setup/status");if(z.mode==="pending"||z.needed===!0)return S(),e.value="setup",!0}catch(z){z==null||z.name}return!1}st(async()=>{if(document.addEventListener("keydown",_),o=window.matchMedia("(max-width: 900px)"),E(),o.addEventListener("change",E),await R())return;const z=await j.check();z.ok?(e.value="ready",re()):z.needsAuth?e.value="login":(e.value="ready",re())});function w(){t.value=!1,e.value="ready",re()}async function O(){if(await R())return;const z=await j.check();z.ok?(e.value="ready",re()):z.needsAuth?e.value="login":(e.value="ready",re())}async function U(){S(),e.value="login",await j.logout()}function T(){s.value=!s.value}function $(){a.value=!a.value}Wt(a,async z=>{var se,le;if(z)r=document.activeElement,await zt(),(le=(se=n.value)==null?void 0:se.querySelector(".nav-item"))==null||le.focus();else if(r!=null&&r.isConnected){const K=r;r=null,requestAnimationFrame(()=>K.focus())}});const Y=H(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function W(z,se="info",le=3e3){p.value={text:z,level:se},clearTimeout(m),m=setTimeout(()=>{p.value=null},le)}let M=null,L=!1,P=[];function re(){for(const z of P)z();P=[ut.onStatus(z=>{c.value=z}),ut.onLatencyChange(z=>{u.value=z}),ut.onState((z,se)=>{d.value=z,z==="connected"?(L&&W("Connection restored","success"),L=!0):z==="reconnecting"&&se.attempt===1&&W("Connection lost — reconnecting…","warn")})],ut.connect(),ce(),M&&clearInterval(M),M=setInterval(ce,15e3)}async function ce(){try{const z=await j.get("/api/status");h.value=z.status==="online"?"online":"starting";const se=z.uptime_seconds||0,le=Math.floor(se/3600),K=Math.floor(se%3600/60);b.value=`${le}h ${K}m uptime`}catch{h.value="offline",b.value=""}}return xt(()=>{M&&clearInterval(M);for(const z of P)z();P=[],ut.disconnect(),document.removeEventListener("keydown",_),o==null||o.removeEventListener("change",E)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:a,wsConnected:c,wsState:d,wsLatency:u,wsLabel:Y,wsToast:p,botStatus:h,botUptime:b,navRoutes:I,navGroups:k,currentPage:y,currentSection:g,currentDescription:x,sidebarEl:n,mobileMenuButton:i,isMobileViewport:l,onLogin:w,onSetupComplete:O,logout:U,toggleSidebar:T,toggleMobileNavigation:$,openPalette:Uf}}},on=fr(oE);on.component("odin-icon",PC);on.component("login-screen",lE);on.component("setup-page",iE);on.component("toast-container",Ck);on.component("confirm-host",Tk);on.component("command-palette",DC);on.directive("modal-focus",FC);on.use(Nl);on.mount("#app");
