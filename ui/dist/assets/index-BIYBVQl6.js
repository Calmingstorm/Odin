...
... (truncated)`:s}function Eu(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function og(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function cg(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const J_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),d=h({reload:!1,clearSessions:!1,stopLoops:!1});let u=0;const f=ee(()=>{const D=e.value.uptime_seconds||0,K=Math.floor(D/86400),ne=Math.floor(D%86400/3600),$=Math.floor(D%3600/60),O=[];return K>0&&O.push(`${K}d`),ne>0&&O.push(`${ne}h`),(O.length===0||K===0&&ne===0)&&O.push(`${$}m`),O.join(" ")}),p=ee(()=>{const D=e.value.uptime_seconds||0;return 125.66*(1-Math.min(D/86400,1))}),v=ee(()=>{const D=e.value;return[{label:"Guilds",value:D.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:D.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:D.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${D.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:D.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:D.loop_count>0?"text-green-400":"",highlight:D.loop_count>0},{label:"Agents",value:D.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:D.agent_count>0?`${D.agent_count} total`:"",subColor:"text-gray-500",highlight:(D.agent_running??0)>0},{label:"Processes",value:D.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:D.process_count>0?`${D.process_count} total`:"",subColor:"text-gray-500",highlight:(D.process_running??0)>0},{label:"Schedules",value:D.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(D.schedule_failing>0?`${D.schedule_failing} failing`:"")+(D.schedule_failing>0&&D.schedule_paused>0?", ":"")+(D.schedule_paused>0?`${D.schedule_paused} paused`:"")||void 0,subColor:D.schedule_failing>0?"text-red-400":"text-yellow-400",color:D.schedule_failing>0?"text-red-400":"",highlight:D.schedule_failing>0},{label:"Users",value:D.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=ee(()=>{const D=e.value,K=[];return K.push({label:"Bot",status:D.status==="online"?"ok":"warn",detail:D.status==="online"?"Online":"Starting"}),(D.schedule_failing||0)>0?K.push({label:"Schedules",status:"error",detail:`${D.schedule_failing} failing`}):(D.schedule_count||0)>0&&K.push({label:"Schedules",status:"ok",detail:`${D.schedule_count} configured`}),(D.loop_count||0)>0&&K.push({label:"Loops",status:"ok",detail:`${D.loop_count} active`}),(D.agent_running||0)>0&&K.push({label:"Agents",status:"ok",detail:`${D.agent_running} running`}),(D.process_running||0)>0&&K.push({label:"Processes",status:"ok",detail:`${D.process_running} running`}),K});async function I(){try{e.value=await Y.get("/api/status"),s.value=null}catch(D){s.value=D.message}finally{t.value=!1}}async function A(){a.value=!0;try{n.value=await Y.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function b(){l.value=!0;try{i.value=await Y.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function m(){try{const D=await Y.get("/api/knowledge");c.value=(Array.isArray(D)?D:[]).reduce((K,ne)=>K+(ne.chunks||0),0)}catch{c.value=null}}async function x(){try{const D=await Y.get("/api/agents");r.value=D.filter(K=>K.status==="running")}catch{}}async function _(){d.value={...d.value,reload:!0};try{await Y.post("/api/reload"),Se.success("Config reloaded")}catch(D){Se.error(D.message)}d.value={...d.value,reload:!1}}async function C(){if(!await bs({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;d.value={...d.value,clearSessions:!0};const K=e.value.session_count;e.value={...e.value,session_count:0};try{const ne=await Y.post("/api/sessions/clear-all");Se.success(`Cleared ${ne.count} session${ne.count!==1?"s":""}`),await I()}catch(ne){e.value={...e.value,session_count:K},Se.error(ne.message)}d.value={...d.value,clearSessions:!1}}async function E(){if(!await bs({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;d.value={...d.value,stopLoops:!0};const K=e.value.loop_count;e.value={...e.value,loop_count:0};try{const ne=await Y.post("/api/loops/stop-all");Se.success(ne.result),await I()}catch(ne){e.value={...e.value,loop_count:K},Se.error(ne.message)}d.value={...d.value,stopLoops:!1}}function k(){t.value=!0,s.value=null,I(),A(),b(),x()}let S=null,L=null,H=null;function M(D){if(D.payload&&D.payload.tool_name){const K={...D.payload,_isNew:!0,_key:++u};n.value.unshift(K),n.value.length>10&&n.value.pop(),o.value++,K.error&&(i.value.unshift(K),i.value.length>5&&i.value.pop()),setTimeout(()=>{K._isNew=!1},1500),clearTimeout(H),H=setTimeout(()=>{o.value=0},1e4)}}return Je(async()=>{await Promise.all([I(),A(),b(),x(),m()]),S=setInterval(I,15e3),L=setInterval(x,1e4),We.subscribe("events",M)}),_t(()=>{S&&clearInterval(S),L&&clearInterval(L),clearTimeout(H),We.unsubscribe("events",M)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:v,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:d,fetchActivity:A,fetchStatus:I,formatTime:Dc,formatDuration:ja,retry:k,reloadConfig:_,clearSessions:C,stopAllLoops:E}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function Au(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function Y_(e){if(Array.isArray(e))return e}function Q_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(d){c=!0,a=d}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function X_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function ew(e,t){return Y_(e)||Q_(e,t)||tw(e,t)||X_()}function tw(e,t){if(e){if(typeof e=="string")return Au(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?Au(e,t):void 0}}const dg=Object.entries,Ru=Object.setPrototypeOf,sw=Object.isFrozen,nw=Object.getPrototypeOf,aw=Object.getOwnPropertyDescriptor;let es=Object.freeze,Es=Object.seal,ya=Object.create,ug=typeof Reflect<"u"&&Reflect,Io=ug.apply,Oo=ug.construct;es||(es=function(t){return t});Es||(Es=function(t){return t});Io||(Io=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});Oo||(Oo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const tn=Ct(Array.prototype.forEach),iw=Ct(Array.prototype.lastIndexOf),Iu=Ct(Array.prototype.pop),ha=Ct(Array.prototype.push),lw=Ct(Array.prototype.splice),Zt=Array.isArray,oi=Ct(String.prototype.toLowerCase),qr=Ct(String.prototype.toString),Ou=Ct(String.prototype.match),ga=Ct(String.prototype.replace),Lu=Ct(String.prototype.indexOf),rw=Ct(String.prototype.trim),ow=Ct(Number.prototype.toString),cw=Ct(Boolean.prototype.toString),Nu=typeof BigInt>"u"?null:Ct(BigInt.prototype.toString),Du=typeof Symbol>"u"?null:Ct(Symbol.prototype.toString),gt=Ct(Object.prototype.hasOwnProperty),ei=Ct(Object.prototype.toString),Pt=Ct(RegExp.prototype.test),Vn=dw(TypeError);function Ct(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return Io(e,t,n)}}function dw(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return Oo(e,s)}}function He(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:oi;if(Ru&&Ru(e,null),!Zt(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(sw(t)||(t[n]=i),a=i)}e[a]=!0}return e}function uw(e){for(let t=0;t<e.length;t++)gt(e,t)||(e[t]=null);return e}function Vt(e){const t=ya(null);for(const n of dg(e)){var s=ew(n,2);const a=s[0],i=s[1];gt(e,a)&&(Zt(i)?t[a]=uw(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Vt(i):t[a]=i)}return t}function fw(e){switch(typeof e){case"string":return e;case"number":return ow(e);case"boolean":return cw(e);case"bigint":return Nu?Nu(e):"0";case"symbol":return Du?Du(e):"Symbol()";case"undefined":return ei(e);case"function":case"object":{if(e===null)return ei(e);const t=e,s=Hs(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:ei(n)}return ei(e)}default:return ei(e)}}function Hs(e,t){for(;e!==null;){const n=aw(e,t);if(n){if(n.get)return Ct(n.get);if(typeof n.value=="function")return Ct(n.value)}e=nw(e)}function s(){return null}return s}function pw(e){try{return Pt(e,""),!0}catch{return!1}}const Mu=es(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Gr=es(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Kr=es(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),hw=es(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Wr=es(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),gw=es(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Pu=es(["#text"]),Fu=es(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Zr=es(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),$u=es(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),cl=es(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),mw=Es(/{{[\w\W]*|^[\w\W]*}}/g),vw=Es(/<%[\w\W]*|^[\w\W]*%>/g),bw=Es(/\${[\w\W]*/g),yw=Es(/^data-[\-\w.\u00B7-\uFFFF]+$/),xw=Es(/^aria-[\-\w]+$/),Uu=Es(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),_w=Es(/^(?:\w+script|data):/i),ww=Es(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),kw=Es(/^html$/i),Sw=Es(/^[a-z][.\w]*(-[.\w]+)+$/i),$s={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},Tw=function(){return typeof window>"u"?null:window},Cw=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Bu=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function fg(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Tw();const t=be=>fg(be);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==$s.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const d=e.DOMParser,u=e.trustedTypes,f=r.prototype,p=Hs(f,"cloneNode"),v=Hs(f,"remove"),g=Hs(f,"nextSibling"),I=Hs(f,"childNodes"),A=Hs(f,"parentNode"),b=Hs(f,"shadowRoot"),m=Hs(f,"attributes"),x=l&&l.prototype?Hs(l.prototype,"nodeType"):null,_=l&&l.prototype?Hs(l.prototype,"nodeName"):null;if(typeof i=="function"){const be=s.createElement("template");be.content&&be.content.ownerDocument&&(s=be.content.ownerDocument)}let C,E="",k,S=!1,L=0;const H=function(){if(L>0)throw Vn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},M=function(w){H(),L++;try{return C.createHTML(w)}finally{L--}},D=function(w){H(),L++;try{return C.createScriptURL(w)}finally{L--}},K=function(){return S||(k=Cw(u,a),S=!0),k},ne=s,$=ne.implementation,O=ne.createNodeIterator,T=ne.createDocumentFragment,N=ne.getElementsByTagName,B=n.importNode;let W=Bu();t.isSupported=typeof dg=="function"&&typeof A=="function"&&$&&$.createHTMLDocument!==void 0;const te=mw,oe=vw,Q=bw,he=yw,Fe=xw,z=_w,pe=ww,de=Sw;let xe=Uu,me=null;const Be=He({},[...Mu,...Gr,...Kr,...Wr,...Pu]);let y=null;const R=He({},[...Fu,...Zr,...$u,...cl]);let F=Object.seal(ya(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),X=null,Z=null;const J=Object.seal(ya(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let ue=!0,re=!0,ie=!1,se=!0,ye=!1,fe=!0,ge=!1,we=!1,Te=!1,Re=!1,Ne=!1,Pe=!1,Ve=!0,st=!1;const V="user-content-";let _e=!0,Ie=!1,De={},ze=null;const Ye=He({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let ht=null;const ts=He({},["audio","video","img","source","image","track"]);let Is=null;const Ps=He({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Fs="http://www.w3.org/1998/Math/MathML",us="http://www.w3.org/2000/svg",q="http://www.w3.org/1999/xhtml";let Ee=q,fs=!1,Zs=null;const ca=He({},[Fs,us,q],qr);let wn=He({},["mi","mo","mn","ms","mtext"]),Js=He({},["annotation-xml"]);const P=He({},["title","style","font","a","script"]);let j=null;const ae=["application/xhtml+xml","text/html"],ke="text/html";let Ce=null,Et=null;const U=s.createElement("form"),le=function(w){return w instanceof RegExp||w instanceof Function},Oe=function(){let w=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Et&&Et===w)return;(!w||typeof w!="object")&&(w={}),w=Vt(w),j=ae.indexOf(w.PARSER_MEDIA_TYPE)===-1?ke:w.PARSER_MEDIA_TYPE,Ce=j==="application/xhtml+xml"?qr:oi,me=gt(w,"ALLOWED_TAGS")&&Zt(w.ALLOWED_TAGS)?He({},w.ALLOWED_TAGS,Ce):Be,y=gt(w,"ALLOWED_ATTR")&&Zt(w.ALLOWED_ATTR)?He({},w.ALLOWED_ATTR,Ce):R,Zs=gt(w,"ALLOWED_NAMESPACES")&&Zt(w.ALLOWED_NAMESPACES)?He({},w.ALLOWED_NAMESPACES,qr):ca,Is=gt(w,"ADD_URI_SAFE_ATTR")&&Zt(w.ADD_URI_SAFE_ATTR)?He(Vt(Ps),w.ADD_URI_SAFE_ATTR,Ce):Ps,ht=gt(w,"ADD_DATA_URI_TAGS")&&Zt(w.ADD_DATA_URI_TAGS)?He(Vt(ts),w.ADD_DATA_URI_TAGS,Ce):ts,ze=gt(w,"FORBID_CONTENTS")&&Zt(w.FORBID_CONTENTS)?He({},w.FORBID_CONTENTS,Ce):Ye,X=gt(w,"FORBID_TAGS")&&Zt(w.FORBID_TAGS)?He({},w.FORBID_TAGS,Ce):Vt({}),Z=gt(w,"FORBID_ATTR")&&Zt(w.FORBID_ATTR)?He({},w.FORBID_ATTR,Ce):Vt({}),De=gt(w,"USE_PROFILES")?w.USE_PROFILES&&typeof w.USE_PROFILES=="object"?Vt(w.USE_PROFILES):w.USE_PROFILES:!1,ue=w.ALLOW_ARIA_ATTR!==!1,re=w.ALLOW_DATA_ATTR!==!1,ie=w.ALLOW_UNKNOWN_PROTOCOLS||!1,se=w.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ye=w.SAFE_FOR_TEMPLATES||!1,fe=w.SAFE_FOR_XML!==!1,ge=w.WHOLE_DOCUMENT||!1,Re=w.RETURN_DOM||!1,Ne=w.RETURN_DOM_FRAGMENT||!1,Pe=w.RETURN_TRUSTED_TYPE||!1,Te=w.FORCE_BODY||!1,Ve=w.SANITIZE_DOM!==!1,st=w.SANITIZE_NAMED_PROPS||!1,_e=w.KEEP_CONTENT!==!1,Ie=w.IN_PLACE||!1,xe=pw(w.ALLOWED_URI_REGEXP)?w.ALLOWED_URI_REGEXP:Uu,Ee=typeof w.NAMESPACE=="string"?w.NAMESPACE:q,wn=gt(w,"MATHML_TEXT_INTEGRATION_POINTS")&&w.MATHML_TEXT_INTEGRATION_POINTS&&typeof w.MATHML_TEXT_INTEGRATION_POINTS=="object"?Vt(w.MATHML_TEXT_INTEGRATION_POINTS):He({},["mi","mo","mn","ms","mtext"]),Js=gt(w,"HTML_INTEGRATION_POINTS")&&w.HTML_INTEGRATION_POINTS&&typeof w.HTML_INTEGRATION_POINTS=="object"?Vt(w.HTML_INTEGRATION_POINTS):He({},["annotation-xml"]);const G=gt(w,"CUSTOM_ELEMENT_HANDLING")&&w.CUSTOM_ELEMENT_HANDLING&&typeof w.CUSTOM_ELEMENT_HANDLING=="object"?Vt(w.CUSTOM_ELEMENT_HANDLING):ya(null);if(F=ya(null),gt(G,"tagNameCheck")&&le(G.tagNameCheck)&&(F.tagNameCheck=G.tagNameCheck),gt(G,"attributeNameCheck")&&le(G.attributeNameCheck)&&(F.attributeNameCheck=G.attributeNameCheck),gt(G,"allowCustomizedBuiltInElements")&&typeof G.allowCustomizedBuiltInElements=="boolean"&&(F.allowCustomizedBuiltInElements=G.allowCustomizedBuiltInElements),ye&&(re=!1),Ne&&(Re=!0),De&&(me=He({},Pu),y=ya(null),De.html===!0&&(He(me,Mu),He(y,Fu)),De.svg===!0&&(He(me,Gr),He(y,Zr),He(y,cl)),De.svgFilters===!0&&(He(me,Kr),He(y,Zr),He(y,cl)),De.mathMl===!0&&(He(me,Wr),He(y,$u),He(y,cl))),J.tagCheck=null,J.attributeCheck=null,gt(w,"ADD_TAGS")&&(typeof w.ADD_TAGS=="function"?J.tagCheck=w.ADD_TAGS:Zt(w.ADD_TAGS)&&(me===Be&&(me=Vt(me)),He(me,w.ADD_TAGS,Ce))),gt(w,"ADD_ATTR")&&(typeof w.ADD_ATTR=="function"?J.attributeCheck=w.ADD_ATTR:Zt(w.ADD_ATTR)&&(y===R&&(y=Vt(y)),He(y,w.ADD_ATTR,Ce))),gt(w,"ADD_URI_SAFE_ATTR")&&Zt(w.ADD_URI_SAFE_ATTR)&&He(Is,w.ADD_URI_SAFE_ATTR,Ce),gt(w,"FORBID_CONTENTS")&&Zt(w.FORBID_CONTENTS)&&(ze===Ye&&(ze=Vt(ze)),He(ze,w.FORBID_CONTENTS,Ce)),gt(w,"ADD_FORBID_CONTENTS")&&Zt(w.ADD_FORBID_CONTENTS)&&(ze===Ye&&(ze=Vt(ze)),He(ze,w.ADD_FORBID_CONTENTS,Ce)),_e&&(me["#text"]=!0),ge&&He(me,["html","head","body"]),me.table&&(He(me,["tbody"]),delete X.tbody),w.TRUSTED_TYPES_POLICY){if(typeof w.TRUSTED_TYPES_POLICY.createHTML!="function")throw Vn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof w.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Vn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ce=C;C=w.TRUSTED_TYPES_POLICY;try{E=M("")}catch(Le){throw C=ce,Le}}else w.TRUSTED_TYPES_POLICY===null?(C=void 0,E=""):(C===void 0&&(C=K()),C&&typeof E=="string"&&(E=M("")));(W.uponSanitizeElement.length>0||W.uponSanitizeAttribute.length>0)&&me===Be&&(me=Vt(me)),W.uponSanitizeAttribute.length>0&&y===R&&(y=Vt(y)),es&&es(w),Et=w},lt=He({},[...Gr,...Kr,...hw]),pt=He({},[...Wr,...gw]),ss=function(w){let G=A(w);(!G||!G.tagName)&&(G={namespaceURI:Ee,tagName:"template"});const ce=oi(w.tagName),Le=oi(G.tagName);return Zs[w.namespaceURI]?w.namespaceURI===us?G.namespaceURI===q?ce==="svg":G.namespaceURI===Fs?ce==="svg"&&(Le==="annotation-xml"||wn[Le]):!!lt[ce]:w.namespaceURI===Fs?G.namespaceURI===q?ce==="math":G.namespaceURI===us?ce==="math"&&Js[Le]:!!pt[ce]:w.namespaceURI===q?G.namespaceURI===us&&!Js[Le]||G.namespaceURI===Fs&&!wn[Le]?!1:!pt[ce]&&(P[ce]||!lt[ce]):!!(j==="application/xhtml+xml"&&Zs[w.namespaceURI]):!1},ps=function(w){ha(t.removed,{element:w});try{A(w).removeChild(w)}catch{if(v(w),!A(w))throw Vn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},qc=function(w){const G=I?I(w):w.childNodes;if(G){const Le=[];tn(G,$e=>{ha(Le,$e)}),tn(Le,$e=>{try{v($e)}catch{}})}const ce=m?m(w):null;if(ce)for(let Le=ce.length-1;Le>=0;--Le){const $e=ce[Le],je=$e&&$e.name;if(typeof je=="string")try{w.removeAttribute(je)}catch{}}},Un=function(w,G){try{ha(t.removed,{attribute:G.getAttributeNode(w),from:G})}catch{ha(t.removed,{attribute:null,from:G})}if(G.removeAttribute(w),w==="is")if(Re||Ne)try{ps(G)}catch{}else try{G.setAttribute(w,"")}catch{}},Dg=function(w){const G=m?m(w):w.attributes;if(G)for(let ce=G.length-1;ce>=0;--ce){const Le=G[ce],$e=Le&&Le.name;if(!(typeof $e!="string"||y[Ce($e)]))try{w.removeAttribute($e)}catch{}}},Mg=function(w){const G=[w];for(;G.length>0;){const ce=G.pop();(x?x(ce):ce.nodeType)===$s.element&&Dg(ce);const $e=I?I(ce):ce.childNodes;if($e)for(let je=$e.length-1;je>=0;--je)G.push($e[je])}},Gc=function(w){let G=null,ce=null;if(Te)w="<remove></remove>"+w;else{const je=Ou(w,/^[\r\n\t ]+/);ce=je&&je[0]}j==="application/xhtml+xml"&&Ee===q&&(w='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+w+"</body></html>");const Le=C?M(w):w;if(Ee===q)try{G=new d().parseFromString(Le,j)}catch{}if(!G||!G.documentElement){G=$.createDocument(Ee,"template",null);try{G.documentElement.innerHTML=fs?E:Le}catch{}}const $e=G.body||G.documentElement;return w&&ce&&$e.insertBefore(s.createTextNode(ce),$e.childNodes[0]||null),Ee===q?N.call(G,ge?"html":"body")[0]:ge?G.documentElement:$e},Kc=function(w){return O.call(w.ownerDocument||w,w,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},Sr=function(w){var G,ce;w.normalize();const Le=O.call(w.ownerDocument||w,w,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let $e=Le.nextNode();for(;$e;){let At=$e.data;tn([te,oe,Q],ot=>{At=ga(At,ot," ")}),$e.data=At,$e=Le.nextNode()}const je=(G=(ce=w.querySelectorAll)===null||ce===void 0?void 0:ce.call(w,"template"))!==null&&G!==void 0?G:[];tn(Array.from(je),At=>{da(At.content)&&Sr(At.content)})},Zi=function(w){const G=_?_(w):null;return typeof G!="string"||Ce(G)!=="form"?!1:typeof w.nodeName!="string"||typeof w.textContent!="string"||typeof w.removeChild!="function"||w.attributes!==m(w)||typeof w.removeAttribute!="function"||typeof w.setAttribute!="function"||typeof w.namespaceURI!="string"||typeof w.insertBefore!="function"||typeof w.hasChildNodes!="function"||w.nodeType!==x(w)||w.childNodes!==I(w)},da=function(w){if(!x||typeof w!="object"||w===null)return!1;try{return x(w)===$s.documentFragment}catch{return!1}},Ka=function(w){if(!x||typeof w!="object"||w===null)return!1;try{return typeof x(w)=="number"}catch{return!1}};function Ys(be,w,G){tn(be,ce=>{ce.call(t,w,G,Et)})}const Wc=function(w){let G=null;if(Ys(W.beforeSanitizeElements,w,null),Zi(w))return ps(w),!0;const ce=Ce(_?_(w):w.nodeName);if(Ys(W.uponSanitizeElement,w,{tagName:ce,allowedTags:me}),fe&&w.hasChildNodes()&&!Ka(w.firstElementChild)&&Pt(/<[/\w!]/g,w.innerHTML)&&Pt(/<[/\w!]/g,w.textContent)||fe&&w.namespaceURI===q&&ce==="style"&&Ka(w.firstElementChild)||w.nodeType===$s.progressingInstruction||fe&&w.nodeType===$s.comment&&Pt(/<[/\w]/g,w.data))return ps(w),!0;if(X[ce]||!(J.tagCheck instanceof Function&&J.tagCheck(ce))&&!me[ce]){if(!X[ce]&&Jc(ce)&&(F.tagNameCheck instanceof RegExp&&Pt(F.tagNameCheck,ce)||F.tagNameCheck instanceof Function&&F.tagNameCheck(ce)))return!1;if(_e&&!ze[ce]){const $e=A(w),je=I(w);if(je&&$e){const At=je.length;for(let ot=At-1;ot>=0;--ot){const bt=Ie?je[ot]:p(je[ot],!0);$e.insertBefore(bt,g(w))}}}return ps(w),!0}return(x?x(w):w.nodeType)===$s.element&&!ss(w)||(ce==="noscript"||ce==="noembed"||ce==="noframes")&&Pt(/<\/no(script|embed|frames)/i,w.innerHTML)?(ps(w),!0):(ye&&w.nodeType===$s.text&&(G=w.textContent,tn([te,oe,Q],$e=>{G=ga(G,$e," ")}),w.textContent!==G&&(ha(t.removed,{element:w.cloneNode()}),w.textContent=G)),Ys(W.afterSanitizeElements,w,null),!1)},Zc=function(w,G,ce){if(Z[G]||Ve&&(G==="id"||G==="name")&&(ce in s||ce in U))return!1;const Le=y[G]||J.attributeCheck instanceof Function&&J.attributeCheck(G,w);if(!(re&&!Z[G]&&Pt(he,G))){if(!(ue&&Pt(Fe,G))){if(!Le||Z[G]){if(!(Jc(w)&&(F.tagNameCheck instanceof RegExp&&Pt(F.tagNameCheck,w)||F.tagNameCheck instanceof Function&&F.tagNameCheck(w))&&(F.attributeNameCheck instanceof RegExp&&Pt(F.attributeNameCheck,G)||F.attributeNameCheck instanceof Function&&F.attributeNameCheck(G,w))||G==="is"&&F.allowCustomizedBuiltInElements&&(F.tagNameCheck instanceof RegExp&&Pt(F.tagNameCheck,ce)||F.tagNameCheck instanceof Function&&F.tagNameCheck(ce))))return!1}else if(!Is[G]){if(!Pt(xe,ga(ce,pe,""))){if(!((G==="src"||G==="xlink:href"||G==="href")&&w!=="script"&&Lu(ce,"data:")===0&&ht[w])){if(!(ie&&!Pt(z,ga(ce,pe,"")))){if(ce)return!1}}}}}}return!0},Pg=He({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Jc=function(w){return!Pg[oi(w)]&&Pt(de,w)},Yc=function(w){Ys(W.beforeSanitizeAttributes,w,null);const G=w.attributes;if(!G||Zi(w))return;const ce={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let Le=G.length;for(;Le--;){const $e=G[Le],je=$e.name,At=$e.namespaceURI,ot=$e.value,bt=Ce(je),kn=ot;let Nt=je==="value"?kn:rw(kn);if(ce.attrName=bt,ce.attrValue=Nt,ce.keepAttr=!0,ce.forceKeepAttr=void 0,Ys(W.uponSanitizeAttribute,w,ce),Nt=ce.attrValue,st&&(bt==="id"||bt==="name")&&Lu(Nt,V)!==0&&(Un(je,w),Nt=V+Nt),fe&&Pt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Nt)){Un(je,w);continue}if(bt==="attributename"&&Ou(Nt,"href")){Un(je,w);continue}if(ce.forceKeepAttr)continue;if(!ce.keepAttr){Un(je,w);continue}if(!se&&Pt(/\/>/i,Nt)){Un(je,w);continue}ye&&tn([te,oe,Q],Xc=>{Nt=ga(Nt,Xc," ")});const Qc=Ce(w.nodeName);if(!Zc(Qc,bt,Nt)){Un(je,w);continue}if(C&&typeof u=="object"&&typeof u.getAttributeType=="function"&&!At)switch(u.getAttributeType(Qc,bt)){case"TrustedHTML":{Nt=M(Nt);break}case"TrustedScriptURL":{Nt=D(Nt);break}}if(Nt!==kn)try{At?w.setAttributeNS(At,je,Nt):w.setAttribute(je,Nt),Zi(w)?ps(w):Iu(t.removed)}catch{Un(je,w)}}Ys(W.afterSanitizeAttributes,w,null)},Ji=function(w){let G=null;const ce=Kc(w);for(Ys(W.beforeSanitizeShadowDOM,w,null);G=ce.nextNode();)if(Ys(W.uponSanitizeShadowNode,G,null),Wc(G),Yc(G),da(G.content)&&Ji(G.content),(x?x(G):G.nodeType)===$s.element){const $e=b?b(G):G.shadowRoot;da($e)&&(Tr($e),Ji($e))}Ys(W.afterSanitizeShadowDOM,w,null)},Tr=function(w){const G=[{node:w,shadow:null}];for(;G.length>0;){const ce=G.pop();if(ce.shadow){Ji(ce.shadow);continue}const Le=ce.node,je=(x?x(Le):Le.nodeType)===$s.element,At=I?I(Le):Le.childNodes;if(At)for(let ot=At.length-1;ot>=0;--ot)G.push({node:At[ot],shadow:null});if(je){const ot=_?_(Le):null;if(typeof ot=="string"&&Ce(ot)==="template"){const bt=Le.content;da(bt)&&G.push({node:bt,shadow:null})}}if(je){const ot=b?b(Le):Le.shadowRoot;da(ot)&&G.push({node:null,shadow:ot},{node:ot,shadow:null})}}};return t.sanitize=function(be){let w=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},G=null,ce=null,Le=null,$e=null;if(fs=!be,fs&&(be="<!-->"),typeof be!="string"&&!Ka(be)&&(be=fw(be),typeof be!="string"))throw Vn("dirty is not a string, aborting");if(!t.isSupported)return be;we||Oe(w),t.removed=[];const je=Ie&&typeof be!="string"&&Ka(be);if(je){const bt=_?_(be):be.nodeName;if(typeof bt=="string"){const kn=Ce(bt);if(!me[kn]||X[kn])throw Vn("root node is forbidden and cannot be sanitized in-place")}if(Zi(be))throw Vn("root node is clobbered and cannot be sanitized in-place");try{Tr(be)}catch(kn){throw qc(be),kn}}else if(Ka(be))G=Gc("<!---->"),ce=G.ownerDocument.importNode(be,!0),ce.nodeType===$s.element&&ce.nodeName==="BODY"||ce.nodeName==="HTML"?G=ce:G.appendChild(ce),Tr(ce);else{if(!Re&&!ye&&!ge&&be.indexOf("<")===-1)return C&&Pe?M(be):be;if(G=Gc(be),!G)return Re?null:Pe?E:""}G&&Te&&ps(G.firstChild);const At=Kc(je?be:G);try{for(;Le=At.nextNode();)Wc(Le),Yc(Le),da(Le.content)&&Ji(Le.content)}catch(bt){throw je&&qc(be),bt}if(je)return tn(t.removed,bt=>{bt.element&&Mg(bt.element)}),ye&&Sr(be),be;if(Re){if(ye&&Sr(G),Ne)for($e=T.call(G.ownerDocument);G.firstChild;)$e.appendChild(G.firstChild);else $e=G;return(y.shadowroot||y.shadowrootmode)&&($e=B.call(n,$e,!0)),$e}let ot=ge?G.outerHTML:G.innerHTML;return ge&&me["!doctype"]&&G.ownerDocument&&G.ownerDocument.doctype&&G.ownerDocument.doctype.name&&Pt(kw,G.ownerDocument.doctype.name)&&(ot="<!DOCTYPE "+G.ownerDocument.doctype.name+`>
`+ot),ye&&tn([te,oe,Q],bt=>{ot=ga(ot,bt," ")}),C&&Pe?M(ot):ot},t.setConfig=function(){let be=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Oe(be),we=!0},t.clearConfig=function(){Et=null,we=!1,C=k,E=""},t.isValidAttribute=function(be,w,G){Et||Oe({});const ce=Ce(be),Le=Ce(w);return Zc(ce,Le,G)},t.addHook=function(be,w){typeof w=="function"&&ha(W[be],w)},t.removeHook=function(be,w){if(w!==void 0){const G=iw(W[be],w);return G===-1?void 0:lw(W[be],G,1)[0]}return Iu(W[be])},t.removeHooks=function(be){W[be]=[]},t.removeAllHooks=function(){W=Bu()},t}var Hu=fg();function Pc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var oa=Pc();function pg(e){oa=e}var vi={exec:()=>null};function at(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Qt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var Qt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},Ew=/^(?:[ \t]*(?:\n|$))+/,Aw=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Rw=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Wi=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Iw=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Fc=/(?:[*+-]|\d{1,9}[.)])/,hg=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,gg=at(hg).replace(/bull/g,Fc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Ow=at(hg).replace(/bull/g,Fc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),$c=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Lw=/^[^\n]+/,Uc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Nw=at(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Uc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Dw=at(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Fc).getRegex(),_r="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Bc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Mw=at("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Bc).replace("tag",_r).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),mg=at($c).replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_r).getRegex(),Pw=at(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",mg).getRegex(),Hc={blockquote:Pw,code:Aw,def:Nw,fences:Rw,heading:Iw,hr:Wi,html:Mw,lheading:gg,list:Dw,newline:Ew,paragraph:mg,table:vi,text:Lw},Vu=at("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_r).getRegex(),Fw={...Hc,lheading:Ow,table:Vu,paragraph:at($c).replace("hr",Wi).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Vu).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_r).getRegex()},$w={...Hc,html:at(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Bc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:vi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:at($c).replace("hr",Wi).replace("heading",` *#{1,6} *[^
...
`,e=e.substring(f.length+1),o=!0),!o){const A=this.rules.other.nextBulletRegex(v),b=this.rules.other.hrRegex(v),m=this.rules.other.fencesBeginRegex(v),x=this.rules.other.headingBeginRegex(v),_=this.rules.other.htmlBeginRegex(v);for(;e;){const C=e.split(`
`,1)[0];let E;if(f=C,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),E=f):E=f.replace(this.rules.other.tabCharGlobal,"    "),m.test(f)||x.test(f)||_.test(f)||A.test(f)||b.test(f))break;if(E.search(this.rules.other.nonSpaceChar)>=v||!f.trim())d+=`
`+E.slice(v);else{if(p||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||m.test(u)||x.test(u)||b.test(u))break;d+=`
`+f}!p&&!f.trim()&&(p=!0),c+=C+`
`,e=e.substring(C.length+1),u=E.slice(v)}}a.loose||(l?a.loose=!0:this.rules.other.doubleBlankLine.test(c)&&(l=!0));let g=null,I;this.options.gfm&&(g=this.rules.other.listIsTask.exec(d),g&&(I=g[0]!=="[ ] ",d=d.replace(this.rules.other.listReplaceTask,""))),a.items.push({type:"list_item",raw:c,task:!!g,checked:I,loose:!1,text:d,tokens:[]}),a.raw+=c}const r=a.items.at(-1);if(r)r.raw=r.raw.trimEnd(),r.text=r.text.trimEnd();else return;a.raw=a.raw.trimEnd();for(let o=0;o<a.items.length;o++)if(this.lexer.state.top=!1,a.items[o].tokens=this.lexer.blockTokens(a.items[o].text,[]),!a.loose){const c=a.items[o].tokens.filter(u=>u.type==="space"),d=c.length>0&&c.some(u=>this.rules.other.anyLine.test(u.raw));a.loose=d}if(a.loose)for(let o=0;o<a.items.length;o++)a.items[o].loose=!0;return a}}html(e){const t=this.rules.block.html.exec(e);if(t)return{type:"html",block:!0,raw:t[0],pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:t[0]}}def(e){const t=this.rules.block.def.exec(e);if(t){const s=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),n=t[2]?t[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",a=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:s,raw:t[0],href:n,title:a}}}table(e){var l;const t=this.rules.block.table.exec(e);if(!t||!this.rules.other.tableDelimiter.test(t[2]))return;const s=qu(t[1]),n=t[2].replace(this.rules.other.tableAlignChars,"").split("|"),a=(l=t[3])!=null&&l.trim()?t[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Vs(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},sa=new ok;function tt(e,t){return sa.parse(e,t)}tt.options=tt.setOptions=function(e){return sa.setOptions(e),tt.defaults=sa.defaults,pg(tt.defaults),tt};tt.getDefaults=Pc;tt.defaults=oa;tt.use=function(...e){return sa.use(...e),tt.defaults=sa.defaults,pg(tt.defaults),tt};tt.walkTokens=function(e,t){return sa.walkTokens(e,t)};tt.parseInline=sa.parseInline;tt.Parser=un;tt.parser=un.parse;tt.Renderer=Wl;tt.TextRenderer=zc;tt.Lexer=dn;tt.lexer=dn.lex;tt.Tokenizer=Kl;tt.Hooks=bl;tt.parse=tt;tt.options;tt.setOptions;tt.use;tt.walkTokens;tt.parseInline;un.parse;dn.lex;const ck={breaks:!0,gfm:!0};function Ku(e){if(!e)return"";try{if(typeof tt<"u"&&tt.parse){const t=tt.parse(e,ck);return typeof Hu<"u"?Hu.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function dk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const uk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function fk(e){return uk[e]||"wrench"}const pk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Wu(e){if(!e)return[];const t=e.match(pk);return t?[...new Set(t)]:[]}const hk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],d=ee(()=>t.value.trim().length>0&&!s.value),u=h(We.state||"disconnected");let f=null,p=null;const v=ee(()=>{const $=u.value;return $==="connected"?"Connected":$==="reconnecting"?"Reconnecting…":$==="connecting"?"Connecting…":"REST fallback"}),g=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],I=ee(()=>{const $=Math.floor(i.value/4)%g.length,O=i.value;return O>3?`${g[$]} (${O}s)`:g[0]});function A(){Ot(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function b(){if(!a.value)return;const $=a.value;$.style.height="auto",$.style.height=Math.min($.scrollHeight,120)+"px"}function m($,O,T={}){const N={id:++o,role:$,content:O,timestamp:Date.now(),html:$==="bot"?Ku(O):"",tools_used:T.tools_used||[],is_error:T.is_error||!1,images:$==="bot"?Wu(O):[],files:T.files||[],_showTools:!1};return e.value.push(N),A(),$==="bot"&&Ot(()=>x()),N}function x(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(O=>{O.setAttribute("data-copy","true"),O.style.position="relative";const T=document.createElement("button");T.className="chat-code-copy",T.textContent="Copy",T.addEventListener("click",()=>{const N=O.querySelector("code"),B=N?N.textContent:O.textContent;navigator.clipboard.writeText(B).then(()=>{T.textContent="Copied!",setTimeout(()=>{T.textContent="Copy"},1500)}).catch(()=>{})}),O.appendChild(T)})}function _($){if($===0)return!0;const O=e.value[$-1],T=e.value[$],N=new Date(O.timestamp).toDateString(),B=new Date(T.timestamp).toDateString();return N!==B}function C($){const O=new Date($),T=new Date;if(O.toDateString()===T.toDateString())return"Today";const N=new Date(T);return N.setDate(N.getDate()-1),O.toDateString()===N.toDateString()?"Yesterday":O.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function E($){t.value=$,Ot(()=>K())}function k($){window.open($,"_blank","noopener")}function S($){$.target.style.display="none"}function L(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function H(){r&&(clearInterval(r),r=null),i.value=0}function M($){s.value&&(s.value=!1,H(),$.type==="chat_response"?m("bot",$.content,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]}):$.type==="chat_error"&&m("bot",$.error||"Unknown error",{is_error:!0}),Ot(()=>{var O;return(O=a.value)==null?void 0:O.focus()}))}async function D($){try{const O=await Y.post("/api/chat",{content:$,channel_id:l.value});m("bot",O.response,{tools_used:O.tools_used||[],is_error:O.is_error||!1,files:O.files||[]})}catch(O){m("bot",O.message||"Failed to send message",{is_error:!0})}}async function K(){const $=t.value.trim();if(!$||s.value)return;m("user",$),t.value="",s.value=!0,L(),a.value&&(a.value.style.height="auto"),We.connected&&We.sendChat($,{channelId:l.value})||(await D($),s.value=!1,H()),Ot(()=>{var T;return(T=a.value)==null?void 0:T.focus()})}async function ne(){try{if(!l.value){const O=await Y.get("/api/auth/session");l.value=O.channel_id||O.user_id||"web-user"}const $=await Y.get("/api/sessions/"+encodeURIComponent(l.value));if($&&$.messages&&$.messages.length>0){for(const O of $.messages){const T=O.role==="user"?"user":"bot";let N=O.content||"";if(T==="user"){const W=N.match(/^\[.*?\]:\s*/);W&&(N=N.slice(W[0].length))}if(!N.trim())continue;const B={id:++o,role:T,content:N,timestamp:O.timestamp?O.timestamp*1e3:Date.now(),html:T==="bot"?Ku(N):"",tools_used:[],is_error:!1,images:T==="bot"?Wu(N):[],files:[],_showTools:!1};e.value.push(B)}Ot(()=>{A(),x()})}}catch{}}return Je(()=>{We.subscribe("chat",M),u.value=We.state||"disconnected",f=We.onStateChange,p=($,O)=>{u.value=$,f&&f($,O)},We.onStateChange=p,ne(),Ot(()=>{var $;return($=a.value)==null?void 0:$.focus()})}),_t(()=>{We.unsubscribe("chat",M),We.onStateChange===p&&(We.onStateChange=f),H()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:d,wsStatus:v,typingText:I,suggestions:c,send:K,autoResize:b,formatTime:dk,formatDate:C,showDateSeparator:_,useSuggestion:E,openImage:k,onImageError:S,getToolIcon:fk}}},kr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=j_(),s=ig(),n=ee({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});ds(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},gk={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(f){var g,I,A,b,m;const p=f.payload||f,v=p.type||f.type;if(v==="tool_start"){const x=((g=p.metadata)==null?void 0:g.call_id)||null,_={callId:x,id:x||`${p.action}-${Date.now()}`,tool:p.action,actor:p.actor||"",channel:p.channel_id||"",iteration:((I=p.metadata)==null?void 0:I.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(_);return}if(v==="tool_end"){const x=((A=p.metadata)==null?void 0:A.call_id)||null;let _=-1;if(x&&(_=e.value.findIndex(C=>C.callId===x&&C.status==="running")),_<0&&!x)for(let C=e.value.length-1;C>=0;C--){const E=e.value[C];if(E.tool===p.action&&E.status==="running"){_=C;break}}if(_>=0){const C=e.value[_];C.status=(b=p.metadata)!=null&&b.error?"error":"success",C.elapsed=((m=p.metadata)==null?void 0:m.elapsed_ms)||Date.now()-C.startTime,C.result=p.detail||"",C.fadingOut=!0,setTimeout(()=>{const E=e.value.indexOf(C);E>=0&&e.value.splice(E,1),t.value.unshift(C),t.value.length>n&&t.value.pop()},5e3)}return}if(v==="tool_stream"){const x=p.call_id||p.tool_name||"unknown";if(p.finished){const _={...s.value};delete _[x],s.value=_}else{const C=((s.value[x]||"")+(p.chunk||"")).split(`
`);s.value={...s.value,[x]:C.slice(-30).join(`
`)}}return}}let i=null;function l(){const f=Date.now();e.value.forEach(p=>{p.status==="running"&&(p.elapsed=f-p.startTime)})}let r=!1;function o(){r||(r=!0,We.on("events",a),i||(i=setInterval(l,500)))}function c(){r&&(r=!1,We.off("events",a),i&&(clearInterval(i),i=null))}Je(o),As(o),Rs(c),_t(c);function d(f){return f<1e3?`${f}ms`:`${(f/1e3).toFixed(1)}s`}function u(f){return f==="running"?"clock":f==="success"?"success":f==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
  ...
  `},Sg=Symbol("agent-detail-cancelled"),mk=15e3;function vk(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((p,v)=>{o=p,c=v});function u(p,v){r||(r=!0,l!==null&&a(l),l=null,(p?o:c)(v))}let f;try{f=e(i==null?void 0:i.signal)}catch(p){u(!1,p)}return r||Promise.resolve(f).then(p=>u(!0,p),p=>u(!1,p)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const p=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${p}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sg),i==null||i.abort()}}}function Tg({state:e,requestDetail:t,timeoutMs:s=mk,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const f=l;l=null,f==null||f.cancel()}function o(f,{initial:p,coalesce:v}){if(!f)return Promise.resolve();if(v&&l&&l.agentId===f&&e.detailId===f)return l.promise;r();const g={agentId:f,cancel:null,promise:null};l=g,p?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const I=vk(A=>t(f,{signal:A}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return g.cancel=I.cancel,g.promise=(async()=>{let A=null,b=null;try{A=await I.promise}catch(m){b=m}A!==Sg&&(l!==g||e.detailId!==f||(l=null,!b&&(A===null||typeof A!="object")&&(b=new Error(`${n} response was empty or invalid`)),b?e.detail===null&&(e.detailError=(b==null?void 0:b.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=A,e.detailError=null),e.detailLoading=!1))})(),g.promise}function c(f){return e.detailId=f,o(f,{initial:!0,coalesce:!1})}function d(){const f=e.detailId;return f?o(f,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function bk({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const yk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const r=ee(()=>e.value.filter(T=>T.status==="running").length),o=ee(()=>e.value.filter(T=>T.status==="completed").length),c=ee(()=>e.value.filter(T=>["failed","timeout","killed"].includes(T.status)).length),d=ee(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),u=ee(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(T=>["failed","timeout","killed"].includes(T.status)):e.value.filter(T=>T.status===i.value));function f(T){const N=Number(T.max_iterations)||0;return N<=0?0:Math.min(100,Math.round(T.iteration_count/N*100))}function p(T){return(Number(T.max_iterations)||0)>0}function v(T,N){return T?T==="N/A"?"N/A":N==="current_inheritance"?`inherit (currently ${T})`:T:"unknown"}function g(T){return v(T.display_model,T.display_model_source||T.display_source)}function I(T){return v(T.display_reasoning_effort,T.display_reasoning_effort_source||T.display_source)}function A(T){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[T]||""}const b=h(null),m=h(null),x=h(!1),_=h(null),C=h(""),k=Tg({state:{get detail(){return b.value},set detail(T){b.value=T},get detailId(){return m.value},set detailId(T){m.value=T},get detailLoading(){return x.value},set detailLoading(T){x.value=T},get detailError(){return _.value},set detailError(T){_.value=T}},requestDetail:(T,{signal:N})=>Y.get(`/api/agents/${encodeURIComponent(T)}`,{signal:N})});async function S(T){C.value="",await k.open(T.id)}function L(){k.close(),C.value=""}async function H(){await k.refresh()}async function M(T,N){try{await navigator.clipboard.writeText(N||""),C.value=T,setTimeout(()=>{C.value===T&&(C.value="")},1500)}catch{Se.error("Copy failed")}}async function D(T=!1){T=T===!0,T||(t.value=!0);try{const N=await Y.get("/api/agents");e.value=Array.isArray(N)?N:[],s.value=null}catch(N){T||(s.value=N.message)}T||(t.value=!1)}async function K(T){const N=e.value.find(W=>W.id===T);if(await bs({title:"Kill agent",message:`Kill agent "${(N==null?void 0:N.label)||T}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=T;try{await Y.del(`/api/agents/${encodeURIComponent(T)}`),Se.success("Agent killed"),await D()}catch(W){Se.error(W.message||"Failed to kill agent")}n.value=null}}const ne=bk({isEnabled:()=>a.value&&l,refreshList:()=>D(!0),hasOpenDetail:()=>!!m.value,refreshDetail:H});function $(){ne.start()}function O(){ne.stop()}return ds(a,()=>ne.sync()),Je(()=>{l=!0,D(),$()}),As(()=>{l=!0,D(!0),$()}),Rs(()=>{l=!1,O()}),_t(()=>{l=!1,O(),k.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ra,formatDuration:ja,progressPercent:f,hasProgress:p,displayModelText:g,displayEffortText:I,displaySourceLabel:A,detail:b,detailId:m,detailLoading:x,detailError:_,copied:C,openDetail:S,closeDetail:L,copyText:M,fetchAgents:D,killAgent:K,startAutoRefresh:$,stopAutoRefresh:O}}},xk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h(null),d=h(null),u=h(!1),f=h(null),p=h("");let v=!1;const I=Tg({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return f.value},set detailError(O){f.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:T})=>Y.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:T})});async function A(O){p.value="",await I.open(O.id)}function b(){I.close(),p.value=""}async function m(O,T){try{await navigator.clipboard.writeText(T||""),p.value=O,setTimeout(()=>{p.value===O&&(p.value="")},1500)}catch{Se.error("Copy failed")}}const x=ee(()=>e.value.reduce((O,T)=>O+(T.iteration_count||0),0)),_=ee(()=>e.value.filter(O=>O.status==="running").length);function C(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function E(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function k(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function S(O=!1){O=O===!0,O||(t.value=!0);try{const T=await Y.get("/api/loops");e.value=Array.isArray(T)?T:[],s.value=null}catch(T){O||(s.value=T.message)}O||(t.value=!1)}async function L(){l.value=null;const O=a.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const T={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&(T.stop_condition=O.stop_condition.trim()),i.value=!0;try{const N=await Y.post("/api/loops",T);Se.success(`Loop started: ${N.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await S()}catch(N){l.value=N.message}i.value=!1}async function H(O){if(await bs({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=O;try{await Y.del(`/api/loops/${encodeURIComponent(O)}`),Se.success("Loop stopped"),await S()}catch(N){Se.error(N.message||"Failed to stop loop")}r.value=null}}async function M(O){o.value=O;try{await Y.post(`/api/loops/${encodeURIComponent(O)}/restart`),Se.success("Loop restarted"),await S()}catch(T){Se.error(T.message||"Failed to restart loop")}o.value=null}function D(O){v&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(S(!0),d.value&&I.refresh())}let K=null;function ne(){K!==null&&clearInterval(K),K=null}function $(){ne(),v&&(K=setInterval(()=>{S(!0),d.value&&I.refresh()},5e3))}return Je(()=>{v=!0,S(),We.subscribe("events",D),$()}),As(()=>{v=!0,S(!0),$()}),Rs(()=>{v=!1,ne()}),_t(()=>{v=!1,We.unsubscribe("events",D),ne(),I.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:f,copied:p,totalIterations:x,runningCount:_,statusDotClass:C,statusBadge:E,modeBadge:k,formatAge:lg,formatDuration:ja,formatTs:ra,formatTokens:cg,openDetail:A,closeDetail:b,copyText:m,fetchLoops:S,doCreate:L,doStop:H,doRestart:M}}},_k={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=ee(()=>e.value.filter(b=>b.status==="running").length),r=ee(()=>e.value.filter(b=>b.status!=="running").length);function o(b){return b==="running"?"loop-status-running":b==="failed"||b==="error"?"loop-status-error":"loop-status-stopped"}function c(b){return b==="running"?"badge-success":b==="completed"||b==="exited"?"badge-info":b==="killed"||b==="error"||b==="failed"?"badge-danger":"badge-warning"}async function d(b=!1){b=b===!0,b||(t.value=!0);try{e.value=await Y.get("/api/processes"),s.value=null}catch(m){b||(s.value=m.message)}b||(t.value=!1)}function u(){f(),n.value&&(a=setInterval(()=>{t.value||d(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}ds(n,b=>{b?u():f()});async function p(b){if(await bs({title:"Kill process",message:`Kill process ${b}?`,confirmLabel:"Kill",danger:!0})){i.value=b;try{await Y.del(`/api/processes/${b}`),Se.success(`Process ${b} killed`),await d()}catch(x){Se.error(x.message||"Failed to kill process")}i.value=null}}function v(b){b.payload&&(b.payload.pid||b.payload.type==="process")&&d(!0)}let g=!1;function I(){g||(g=!0,d(),We.subscribe("events",v),u())}function A(){g&&(g=!1,We.unsubscribe("events",v),f())}return Je(I),As(I),Rs(A),_t(A),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:ja,fetchProcesses:d,doKill:p}}},wk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
...
... (truncated)`:V:""}async function y(){const V=C.value.trim();if(V){L.value=!0;try{let _e=`/api/sessions/search?q=${encodeURIComponent(V)}&limit=50`;E.value.trim()&&(_e+=`&channel_id=${encodeURIComponent(E.value.trim())}`),k.value.trim()&&(_e+=`&user_id=${encodeURIComponent(k.value.trim())}`);const Ie=await Y.get(_e);S.value=Ie.results||[]}catch{S.value=[]}L.value=!1}}function R(){C.value="",E.value="",k.value="",S.value=null}function F(V){return V?V.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function X(V){return V==="user"?"fts-result-user":V==="assistant"?"fts-result-assistant":V==="summary"?"fts-result-summary":V==="fts"?"fts-result-fts":V==="channel"?"fts-result-channel":"fts-result-default"}function Z(V){return V==="user"?"badge-info":V==="assistant"?"badge-success":V==="summary"?"badge-warning":V==="fts"?"badge-success":"badge-info"}async function J(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/sessions")}catch(V){s.value=V.message}t.value=!1}function ue(){s.value=null,J()}async function re(V){if(n.value===V){n.value=null,a.value=null,_.value=new Set;return}n.value=V,a.value=null,i.value=!0,_.value=new Set;const _e=++l;try{const Ie=await Y.get(`/api/sessions/${encodeURIComponent(V)}`);_e===l&&n.value===V&&(a.value=Ie)}catch(Ie){_e===l&&n.value===V&&(a.value={messages:[],summary:"",error:Ie.message||"Failed to load session"})}finally{_e===l&&(i.value=!1)}}function ie(V){const _e=new Set(c.value);_e.has(V)?_e.delete(V):_e.add(V),c.value=_e}function se(){$.value?c.value=new Set:c.value=new Set(K.value.map(V=>V.channel_id))}function ye(V){r.value=V}async function fe(){if(r.value){o.value=!0;try{await Y.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await J()}catch(V){s.value=V.message||"Failed to clear session"}o.value=!1,r.value=null}}function ge(){d.value=!0}async function we(){if(c.value.size!==0){o.value=!0;try{await Y.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await J()}catch(V){s.value=V.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}function Te(V,_e){const Ie=Y._token;let De=`/api/sessions/${encodeURIComponent(V)}/export?format=${_e}`;Ie&&(De+=`&token=${encodeURIComponent(Ie)}`);const ze=document.createElement("a");ze.href=De,ze.download=`session-${V}.${_e==="text"?"txt":"json"}`,document.body.appendChild(ze),ze.click(),document.body.removeChild(ze)}let Re=null;function Ne(V){V.payload&&V.payload.channel_id&&(clearTimeout(Re),Re=setTimeout(()=>{if(J(),n.value&&V.payload.channel_id===n.value){const _e=n.value,Ie=l;Y.get(`/api/sessions/${encodeURIComponent(_e)}`).then(De=>{Ie!==l||n.value!==_e||(a.value=De)}).catch(()=>{})}},2e3))}let Pe=!1;function Ve(){Pe||(Pe=!0,J(),We.subscribe("events",Ne))}Je(()=>{H(),Ve()}),As(()=>{Ve()});function st(){Pe&&(Pe=!1,We.unsubscribe("events",Ne),clearTimeout(Re))}return Rs(st),_t(st),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:$,bulkClearing:d,activePreset:u,searchQuery:f,sortBy:p,sortAsc:v,filterPresets:g,sortOptions:I,filteredSessions:K,hasActiveFilters:D,customPresets:A,showSavePreset:b,newPresetName:m,threadView:x,threads:ne,collapsedThreads:_,ftsQuery:C,ftsChannelId:E,ftsUserId:k,ftsResults:S,ftsSearching:L,formatAge:Q,formatTimestamp:he,formatFullTimestamp:Fe,messageClass:z,threadMsgClass:pe,roleBadge:de,roleDotClass:xe,roleLabelClass:me,truncateContent:Be,threadSummary:O,fetchSessions:J,retry:ue,toggleSession:re,toggleSelect:ie,toggleSelectAll:se,confirmClear:ye,clearSession:fe,confirmBulkClear:ge,doBulkClear:we,exportSession:Te,applyPreset:N,applyCustomPreset:B,saveCustomPreset:W,removeCustomPreset:te,resetFilters:oe,toggleThread:T,runFtsSearch:y,clearFtsSearch:R,highlightSnippet:F,ftsResultClass:X,ftsTypeBadge:Z}}},Ek={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:cg}}},Ak={components:{ContextAssemblyPanel:Ek},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),d=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(E){if(!E)return"—";try{const k=new Date(E);return isNaN(k.getTime())?E:k.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return E}}function f(E){return!E&&E!==0?"—":E<1e3?E+"ms":(E/1e3).toFixed(1)+"s"}function p(E){return!E&&E!==0?"—":E>=1e3?(E/1e3).toFixed(1)+"k":String(E)}function v(E){if(!E)return"";if(typeof E=="string")return E;try{return JSON.stringify(E,null,2)}catch{return String(E)}}function g(E){a.value===E?a.value=null:(a.value=E,c.value={})}function I(E,k){const S=E+"-"+k;c.value={...c.value,[S]:!c.value[S]}}function A(E,k){return!!c.value[E+"-"+k]}function b(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,_()}async function m(){try{const E=await Y.get("/api/trajectories");e.value=E.files||[],o.value=E.count||0}catch{}}let x=0;async function _(){const E=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const k=await Y.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${d.value.limit}`);if(E!==x)return;let S=k.entries||[];d.value.tool_name&&(S=S.filter(L=>(L.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(S=S.filter(L=>L.is_error)),d.value.channel_id&&(S=S.filter(L=>L.channel_id===d.value.channel_id)),d.value.user_id&&(S=S.filter(L=>L.user_id===d.value.user_id)),t.value=S}else{const k=new URLSearchParams;d.value.channel_id&&k.set("channel_id",d.value.channel_id),d.value.user_id&&k.set("user_id",d.value.user_id),d.value.tool_name&&k.set("tool_name",d.value.tool_name),d.value.errors_only&&k.set("errors_only","true"),k.set("limit",String(d.value.limit));const S=k.toString(),L=await Y.get(`/api/trajectories/search/query?${S}`);if(E!==x)return;t.value=L.results||[]}}catch(k){if(E!==x)return;n.value=k.message}E===x&&(s.value=!1)}async function C(){if(!l.value.trim())return;const E=++x;s.value=!0,n.value=null,c.value={};try{const k=await Y.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(E!==x)return;i.value=k.entry||null,i.value||(n.value="No trace found for this message ID")}catch(k){if(E!==x)return;k.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=k.message}E===x&&(s.value=!1)}return Je(async()=>{await m(),await _()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:d,expandedIterations:c,formatTs:u,formatDuration:f,formatTokens:p,formatJSON:v,truncateBlock:rg,toggleExpand:g,toggleIteration:I,isIterationExpanded:A,clearFilters:b,fetchFiles:m,fetchTraces:_,lookupMessage:C}}},Rk={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),n=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),a=h("user");let i=null;const l=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],r=ee(()=>[...s.value.recent||[]].reverse()),o=async()=>{try{const p=await Y.get("/api/usage");s.value=p,n.value=p.totals||n.value,t.value=null}catch(p){t.value=p.message}finally{e.value=!1}},c=()=>{e.value=!0,o()};let d=!1;function u(){d||(d=!0,o(),i||(i=setInterval(o,15e3)))}function f(){d&&(d=!1,i&&(clearInterval(i),i=null))}return Je(u),As(u),Rs(f),_t(f),{loading:e,error:t,data:s,totals:n,activeTab:a,tabs:l,recentReversed:r,fmtNum:og,formatTime:Dc,retry:c}}},Ik={components:{TabbedPage:kr},setup(){return{tabs:[{id:"audit",label:"Audit",component:Sk},{id:"sessions",label:"Sessions",component:Ck},{id:"traces",label:"Traces",component:Ak},{id:"usage",label:"Usage",component:Rk}]}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Jr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Ok={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),r=h(null),o=ee(()=>e.value.filter(b=>b.is_core).length),c=ee(()=>e.value.filter(b=>!b.is_core).length),d=ee(()=>Object.values(a.value).reduce((b,m)=>b+m,0));function u(b){for(const m of Jr)if(m.id!=="other"&&m.match(b))return m.id;return"other"}const f=ee(()=>{let b=e.value;if(n.value){const m=n.value.toLowerCase();b=b.filter(x=>x.name.toLowerCase().includes(m)||(x.description||"").toLowerCase().includes(m))}return r.value&&(b=b.filter(m=>u(m.name)===r.value)),b}),p=ee(()=>{const b=new Set;for(const m of e.value)b.add(u(m.name));return Jr.filter(m=>b.has(m.id))}),v=ee(()=>{const b=f.value,m={};for(const _ of b){const C=u(_.name);m[C]||(m[C]=[]),m[C].push(_)}const x=[];for(const _ of Jr)m[_.id]&&m[_.id].length>0&&x.push({label:_.label,icon:_.icon,tools:m[_.id].sort((C,E)=>C.name.localeCompare(E.name))});return x});function g(b){i.value={...i.value,[b]:!i.value[b]}}async function I(){t.value=!0,s.value=null;try{const[b,m]=await Promise.all([Y.get("/api/tools"),Y.get("/api/tools/stats").catch(()=>({}))]);e.value=b,a.value=m||{};const x=Object.values(m||{}).filter(_=>_>0).sort((_,C)=>_-C)}catch(b){s.value=b.message}t.value=!1}function A(){I()}return Je(()=>{I()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,coreCount:o,skillCount:c,totalUsage:d,filteredTools:f,groupedTools:v,usedCategories:p,truncate:Mc,toggleExpand:g,refresh:A}}};function Lk(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Nk(e){if(!e)return"1";const t=e.split(`
...
`)}const Dk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),d=h(""),u=h(""),f=h(null),p=h(null),v=h(!1),g=h(null),I=h(null),A=h(!1),b=ee(()=>e.value.length),m=ee(()=>e.value.reduce((Q,he)=>Q+(he.execution_count||0),0)),x=ee(()=>e.value.reduce((Q,he)=>Q+L(he.code),0)),_=ee(()=>{if(!l.value)return e.value;const Q=l.value.toLowerCase();return e.value.filter(he=>he.name.toLowerCase().includes(Q)||(he.description||"").toLowerCase().includes(Q))}),C=ee(()=>u.value?u.value.split(`
`).length:0),E=ee(()=>{const Q=Math.max(C.value,1);return Array.from({length:Q},(he,Fe)=>Fe+1).join(`
`)}),k=ee(()=>{const Q=u.value.trim();return Q?Q.includes("SKILL_DEFINITION")?Q.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function S(Q){return Lk(Q)}function L(Q){return Q?Q.split(`
`).length:0}function H(Q){return Nk(Q)}function M(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function D(Q){try{await navigator.clipboard.writeText(Q);const he=e.value.find(Fe=>Fe.code===Q);he&&(r.value=he.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function K(Q){if(Q.key==="Tab"){Q.preventDefault();const he=Q.target,Fe=he.selectionStart,z=he.selectionEnd;u.value=u.value.substring(0,Fe)+"    "+u.value.substring(z),Ot(()=>{he.selectionStart=he.selectionEnd=Fe+4})}}function ne(Q){const he=Q.target.previousElementSibling;he&&(he.scrollTop=Q.target.scrollTop)}async function $(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function O(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const he=await Y.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:he}}catch(he){a.value={...a.value,[Q]:{result:he.message,is_error:!0}}}i.value=null}function T(){o.value=!0,c.value="create",d.value="",u.value="",f.value=null,p.value=null}function N(Q){o.value=!0,c.value="edit",d.value=Q.name,u.value=Q.code||"",f.value=null,p.value=null}function B(){o.value=!1,f.value=null,p.value=null}async function W(){f.value=null,p.value=null;const Q=d.value.trim(),he=u.value.trim();if(!Q){f.value="Name is required";return}if(!he){f.value="Code is required";return}v.value=!0;try{c.value==="create"?(await Y.post("/api/skills",{name:Q,code:he}),p.value="Skill created successfully"):(await Y.put(`/api/skills/${encodeURIComponent(Q)}`,{code:he}),p.value="Skill updated successfully"),await $(),setTimeout(()=>{o.value=!1},800)}catch(Fe){f.value=Fe.message}v.value=!1}function te(Q){I.value=Q}async function oe(){if(I.value){A.value=!0;try{await Y.del(`/api/skills/${encodeURIComponent(I.value)}`),await $()}catch(Q){Se.error(`Failed to delete skill: ${Q.message||"unknown error"}`)}A.value=!1,I.value=null}}return Je(()=>{$()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:f,editSuccess:p,saving:v,editorRef:g,deleteTarget:I,deleting:A,enabledCount:b,totalExecutions:m,totalLines:x,displayedSkills:_,editLineCount:C,editorLineNums:E,editValidation:k,highlight:S,truncate:Mc,formatTs:ra,countLines:L,getLineNumbers:H,toggleCode:M,copyCode:D,handleEditorKey:K,syncScroll:ne,fetchSkills:$,testSkill:O,showCreate:T,editSkill:N,cancelEdit:B,saveSkill:W,confirmDelete:te,doDelete:oe}}};function Mk(e,t){if(!e||!t)return Eu(e);const s=Eu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Pk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),f=h(null),p=h(!1),v=h(null),g=h(null);let I=null;const A=h(null),b=h(!1),m=h({}),x=h({}),_=h(null),C=h(null),E=ee(()=>e.value.reduce((T,N)=>T+(N.chunks||0),0)),k=ee(()=>new Set(e.value.map(N=>N.uploader).filter(Boolean)).size);function S(T,N){const B=x.value[N];if(!B||B.length===0)return 0;const W=Math.max(...B.map(te=>te.char_count||0));return W===0?0:Math.round(T.char_count/W*100)}async function L(){t.value=!0,s.value=null;try{const T=await Y.get("/api/knowledge");e.value=Array.isArray(T)?T:[]}catch(T){s.value=T.message}t.value=!1}async function H(T){if(m.value[T]){m.value[T]=!1,C.value=null;return}if(m.value[T]=!0,!(x.value[T]||_.value===T)){_.value=T;try{const N=await Y.get(`/api/knowledge/${encodeURIComponent(T)}/chunks`);x.value[T]=Array.isArray(N)?N:[]}catch(N){x.value[T]=[],Se.error(`Failed to load chunks: ${N.message}`)}_.value=null}}async function M(){const T=n.value.trim();if(T){i.value=!0,r.value=null,l.value=T;try{const N=await Y.get(`/api/knowledge/search?q=${encodeURIComponent(T)}`);a.value=Array.isArray(N)?N:[]}catch(N){a.value=[],r.value=N.message||"Search failed"}i.value=!1}}function D(){a.value=null,n.value="",r.value=null}async function K(){u.value=null,f.value=null;const T=c.value.trim(),N=d.value.trim();if(!T){u.value="Source name is required";return}if(!N){u.value="Content is required";return}p.value=!0;try{const B=await Y.post("/api/knowledge",{source:T,content:N});f.value=`Ingested ${B.chunks||0} chunks from "${T}"`,c.value="",d.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(B){u.value=B.message}p.value=!1}async function ne(T){v.value=T,g.value=null,I&&(clearTimeout(I),I=null);try{const N=await Y.post(`/api/knowledge/${encodeURIComponent(T)}/reingest`);g.value={source:T,error:!1,message:`Re-ingested ${N.chunks||0} chunks`},delete x.value[T],await L(),I=setTimeout(()=>{g.value=null,I=null},3e3)}catch(N){g.value={source:T,error:!0,message:N.message}}v.value=null}function $(T){A.value=T}async function O(){if(A.value){b.value=!0;try{await Y.del(`/api/knowledge/${encodeURIComponent(A.value)}`),delete x.value[A.value],await L()}catch(T){Se.error(`Failed to delete source: ${T.message||"unknown error"}`)}b.value=!1,A.value=null}}return Je(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:f,ingesting:p,reingesting:v,reingestResult:g,deleteTarget:A,deleting:b,expanded:m,sourceChunks:x,loadingChunks:_,selectedChunk:C,totalChunks:E,uploaderCount:k,truncate:Mc,formatTs:ra,highlightTerms:Mk,chunkBarWidth:S,fetchSources:L,toggleSource:H,doSearch:M,clearSearch:D,doIngest:K,doReingest:ne,confirmDelete:$,doDelete:O}}},Fk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),f=h(null),p=h(""),v=h(!1),g=h(null),I=h(null),A=h(new Set),b=h(null),m=h(!1),x=h(!1),_=ee(()=>e.value.reduce((te,oe)=>te+oe.count,0)),C=ee(()=>A.value.size);function E(te){const oe=t.value[te];if(!oe)return[];if(!l.value.trim())return oe;const Q=l.value.trim().toLowerCase();return oe.filter(he=>he.key.toLowerCase().includes(Q)||he.value&&he.value.toLowerCase().includes(Q))}function k(te,oe){return A.value.has(te+"/"+oe)}function S(te,oe){const Q=te+"/"+oe,he=new Set(A.value);he.has(Q)?he.delete(Q):he.add(Q),A.value=he}function L(te){const oe=t.value[te];return!oe||oe.length===0?!1:oe.every(Q=>A.value.has(te+"/"+Q.key))}function H(te,oe){const Q=t.value[te];if(!Q)return;const he=new Set(A.value);for(const Fe of Q){const z=te+"/"+Fe.key;oe?he.add(z):he.delete(z)}A.value=he}async function M(){s.value=!0,n.value=null;try{const te=await Y.get("/api/memory");e.value=Object.entries(te).map(([oe,Q])=>({name:oe,keys:Q.keys||[],count:Q.count||0}))}catch(te){n.value=te.message}s.value=!1}async function D(te){if(a.value[te]){a.value[te]=!1;return}a.value[te]=!0;const oe=e.value.find(he=>he.name===te);if(!oe||t.value[te]||i.value===te)return;i.value=te;const Q=await Promise.all(oe.keys.map(async he=>{try{const Fe=await Y.get(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(he)}`);return{key:he,value:Fe.value||""}}catch{return{key:he,value:"(error loading)"}}}));t.value[te]=Q,i.value=null}function K(te,oe,Q){f.value=te+"/"+oe,p.value=Q}async function ne(te,oe){v.value=!0,g.value=null;try{await Y.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`,{value:p.value});const Q=t.value[te];if(Q){const he=Q.find(Fe=>Fe.key===oe);he&&(he.value=p.value)}f.value=null}catch(Q){g.value=`Failed to save: ${Q.message||"unknown error"}`}v.value=!1}async function $(te,oe){try{await navigator.clipboard.writeText(oe.value),I.value=te+"/"+oe.key,setTimeout(()=>{I.value=null},1500)}catch{}}async function O(){d.value=null,u.value=null;const te=o.value.scope.trim(),oe=o.value.key.trim(),Q=o.value.value.trim();if(!te){d.value="Scope is required";return}if(!oe){d.value="Key is required";return}if(!Q){d.value="Value is required";return}c.value=!0;try{await Y.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`,{value:Q}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await M(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(he){d.value=he.message}c.value=!1}function T(te,oe){b.value={scope:te,key:oe}}async function N(){if(!b.value)return;m.value=!0,g.value=null;const{scope:te,key:oe}=b.value;try{await Y.del(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(oe)}`);const Q=t.value[te];Q&&(t.value[te]=Q.filter(z=>z.key!==oe));const he=e.value.find(z=>z.name===te);he&&(he.count--,he.keys=he.keys.filter(z=>z!==oe));const Fe=new Set(A.value);Fe.delete(te+"/"+oe),A.value=Fe}catch(Q){g.value=`Failed to delete: ${Q.message||"unknown error"}`}m.value=!1,b.value=null}function B(){x.value=!0}async function W(){m.value=!0,g.value=null;const te=[];for(const oe of A.value){const Q=oe.indexOf("/");te.push({scope:oe.slice(0,Q),key:oe.slice(Q+1)})}try{await Y.post("/api/memory/bulk-delete",{entries:te}),A.value=new Set,t.value={},await M()}catch(oe){g.value=`Bulk delete failed: ${oe.message||"unknown error"}`}m.value=!1,x.value=!1}return Je(()=>{M()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:f,editValue:p,saving:v,actionError:g,copied:I,selected:A,selectedCount:C,totalEntries:_,deleteTarget:b,deleting:m,showBulkDelete:x,fetchMemory:M,toggleScope:D,startEdit:K,doEdit:ne,copyValue:$,doAdd:O,confirmDelete:T,doDelete:N,confirmBulkDelete:B,doBulkDelete:W,isSelected:k,toggleSelect:S,isScopeAllSelected:L,toggleSelectAll:H,filteredEntries:E}}},$k={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=ee(()=>[...new Set(e.value.map(I=>I.category))].sort()),o=ee(()=>{const g={};return e.value.forEach(I=>{g[I.category]=(g[I.category]||0)+1}),g}),c=ee(()=>a.value?e.value.filter(g=>g.category===a.value):e.value);function d(g){return g==="correction"?"badge-warning":g==="operational"?"badge-info":g==="preference"?"badge-success":"badge-info"}function u(g){i.value=g.key,l.value=g.content}async function f(g){try{await Y.put("/api/learned/"+encodeURIComponent(g),{content:l.value}),i.value=null,Se.success("Entry updated"),await v()}catch(I){Se.error(I.message||"Failed to save entry")}}async function p(g){if(await bs({title:"Delete learned entry",message:`Delete "${g}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/learned/"+encodeURIComponent(g)),Se.success("Entry deleted"),await v()}catch(A){Se.error(A.message||"Failed to delete entry")}}async function v(){s.value=!0,n.value=null;try{const g=await Y.get("/api/learned");e.value=g.entries||[],t.value={last_reflection:g.last_reflection,count:g.count}}catch(g){n.value=g.message}s.value=!1}return Je(v),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:d,formatTs:ra,startEdit:u,saveEdit:f,deleteEntry:p,fetchEntries:v}}},Uk={components:{TabbedPage:kr},setup(){return{tabs:[{id:"tools",label:"Tools",component:Ok},{id:"skills",label:"Skills",component:Dk},{id:"knowledge",label:"Knowledge",component:Pk},{id:"memory",label:"Memory",component:Fk},{id:"learned",label:"Learned",component:$k}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},Bk={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),d=h(!0),u=h(""),f=h(!1),p=h(!1),v=ee(()=>e.value==="custom"),g=ee(()=>[...i.value,...l.value]),I=ee(()=>l.value.includes(e.value)),A=ee(()=>{var k;return v.value?t.value||"Odin":((k=a.value[e.value])==null?void 0:k.name)||e.value}),b=ee(()=>{var k;return v.value?s.value||"(empty — will use Odin default)":((k=a.value[e.value])==null?void 0:k.identity)||""}),m=ee(()=>{var k;return v.value?n.value||"(empty — will use Odin default)":((k=a.value[e.value])==null?void 0:k.voice)||""});async function x(){d.value=!0;try{const k=await Y.get("/api/personality");e.value=k.preset||"odin",t.value=k.custom_name||"",s.value=k.custom_identity||"",n.value=k.custom_voice||"",a.value=k.presets||{},i.value=k.builtin_presets||[],l.value=k.user_presets||[]}catch(k){c.value=k.message}finally{d.value=!1}}async function _(){r.value=!0,c.value=null,o.value=!1;try{await Y.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(k){c.value=k.message}finally{r.value=!1}}async function C(){const k=u.value.trim();if(k){p.value=!0,c.value=null;try{await Y.post("/api/personality/presets",{name:k,display_name:A.value,identity:b.value,voice:m.value}),f.value=!1,u.value="",await x(),e.value=k.toLowerCase().replace(/ /g,"_")}catch(S){c.value=S.message}finally{p.value=!1}}}async function E(){if(await bs({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await Y.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(S){c.value=S.message}}}return Je(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:g,isCustom:v,isUserPreset:I,previewName:A,previewIdentity:b,previewVoice:m,saving:r,saved:o,error:c,loading:d,save:_,showSavePreset:f,newPresetName:u,savingPreset:p,saveAsPreset:C,deletePreset:E,builtinPresets:i,userPresets:l}},template:`
  ...
  `},Hk={ok:"text-green-400",degraded:"text-yellow-400",down:"text-red-400",unconfigured:"text-gray-500"},Vk={ok:"success",degraded:"warning",down:"error",unconfigured:"minus"},jk={healthy:"text-green-400",degraded:"text-yellow-400",unhealthy:"text-red-400"},zk={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h(!1),a=ee(()=>e.value.components||[]),i=ee(()=>jk[e.value.overall]||"text-gray-400"),l=ee(()=>e.value.overall==="healthy"?"success":e.value.overall==="degraded"?"warning":e.value.overall==="unhealthy"?"error":"minus"),r=ee(()=>{const _=e.value.overall;return _==="healthy"?"All Systems Healthy":_==="degraded"?"Some Systems Degraded":_==="unhealthy"?"System Issues Detected":"Unknown"});function o(_){return Hk[_]||"text-gray-400"}function c(_){return Vk[_]||"info"}function d(_){return _==="ok"?"badge-success":_==="degraded"?"badge-warning":_==="down"?"badge-danger":"badge-info"}function u(_){return _==="closed"?"text-green-400":_==="half_open"?"text-yellow-400":_==="open"?"text-red-400":"text-gray-400"}function f(_){return _.replace(/_/g," ").replace(/\b\w/g,C=>C.toUpperCase())}function p(_){if(!_)return"—";try{return new Date(_).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return _}}function v(_){return _>=1e6?(_/1e6).toFixed(1)+"M":_>=1e3?(_/1e3).toFixed(1)+"K":String(_)}async function g(){n.value=!0;try{e.value=await Y.get("/api/health/components"),s.value=null}catch(_){s.value=_.message}finally{t.value=!1,n.value=!1}}function I(){t.value=!0,s.value=null,g()}let A=null,b=!1;function m(){b||(b=!0,g(),A||(A=setInterval(g,3e4)))}function x(){b&&(b=!1,A&&(clearInterval(A),A=null))}return Je(m),As(m),Rs(x),_t(x),{data:e,loading:t,error:s,refreshing:n,components:a,overallColor:i,overallIcon:l,overallLabel:r,statusColor:o,statusIcon:c,badgeClass:d,circuitColor:u,formatName:f,formatTime:p,formatNumber:v,fetchHealth:g,retry:I}}},qk={template:`
...
`);const le=new Blob([U],{type:"text/plain"}),Oe=URL.createObjectURL(le),lt=document.createElement("a");lt.href=Oe,lt.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,lt.click(),URL.revokeObjectURL(Oe)}function J(U,le){const Oe=`${U.ts} ${U.level} ${U.text||U.raw||""}`;navigator.clipboard.writeText(Oe).then(()=>{f.value=le,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function ue(U){a.value=a.value===U?"":U,A.value="all"}function re(U){return U.level==="ERROR"?"log-line-error":U.level==="WARNING"?"log-line-warning":"text-gray-300"}function ie(U){return U==="ERROR"?"text-red-500 font-semibold":U==="WARNING"?"text-yellow-500":"text-blue-500"}function se(U){return U==="ERROR"?"log-chip-error":U==="WARNING"?"log-chip-warning":"log-chip-info"}function ye(U){A.value=U.id;const le=U.filters;a.value=le.level||"",b.value=le.timeRange||"",i.value=le.text||"",le.levels&&(a.value=le.levels[0]||""),le.hasToolName&&(i.value="")}function fe(U){A.value=U.id,a.value=U.filters.level||"",b.value=U.filters.timeRange||"",i.value=U.filters.text||""}function ge(){if(!_.value.trim())return;const U={id:"custom-"+Date.now(),name:_.value.trim(),filters:{level:a.value,timeRange:b.value,text:i.value}};m.value=[...m.value,U],k(),x.value=!1,_.value=""}function we(U){m.value=m.value.filter(le=>le.id!==U),k(),A.value===U&&(A.value="all")}const Te=h("all"),Re=h(""),Ne=h(""),Pe=h(""),Ve=h(""),st=h(""),V=h(100),_e=Wk,Ie=h(!1),De=h(!1),ze=h(""),Ye=h([]),ht=h(null),ts=h(null);function Is(){e.value="search",ht.value||Ps()}async function Ps(){try{ht.value=await Y.get("/api/logs/stats")}catch{}}function Fs(){const U=st.value;if(!U){Pe.value="",Ve.value="";return}const Oe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[U];if(Oe){const lt=new Date(Date.now()-Oe*1e3);Pe.value=us(lt),Ve.value=""}}function us(U){const le=Oe=>String(Oe).padStart(2,"0");return`${U.getFullYear()}-${le(U.getMonth()+1)}-${le(U.getDate())}T${le(U.getHours())}:${le(U.getMinutes())}`}function q(U){if(!U)return"";const le=new Date(U);return isNaN(le.getTime())?"":le.toISOString()}async function Ee(){Ie.value=!0,ze.value="",De.value=!0,ts.value=null;try{const U=new URLSearchParams;Te.value&&Te.value!=="all"&&U.set("level",Te.value),Re.value&&U.set("tool",Re.value),Ne.value&&U.set("q",Ne.value);const le=q(Pe.value),Oe=q(Ve.value);le&&U.set("start",le),Oe&&U.set("end",Oe),U.set("limit",String(V.value));const lt=await Y.get(`/api/logs/search?${U.toString()}`);Ye.value=lt.entries||[]}catch(U){ze.value=U.message||"Search failed",Ye.value=[]}finally{Ie.value=!1}}function fs(){Te.value="all",Re.value="",Ne.value="",Pe.value="",Ve.value="",st.value="",V.value=100,Ye.value=[],De.value=!1,ze.value="",ts.value=null}function Zs(U){ts.value=ts.value===U?null:U}function ca(U){if(!U.timestamp)return"";try{return new Date(U.timestamp).toLocaleString()}catch{return U.timestamp}}function wn(U){return U.type==="web_action"?`${U.status||""} (${U.execution_time_ms||0}ms)`:(U.result_summary||"").slice(0,200)}function Js(U){return U.error?"log-line-error":"text-gray-300"}function P(U){try{return JSON.stringify(U,null,2)}catch{return String(U)}}let j=null,ae=null,ke=!1;function Ce(){ke||(ke=!0,We.subscribe("logs",te),r.value=We.connected,o.value=We.state||"disconnected",j=We.onStateChange,ae=(U,le)=>{o.value=U,r.value=U==="connected",j&&j(U,le)},We.onStateChange=ae)}function Et(){ke&&(ke=!1,We.unsubscribe("logs",te),We.onStateChange===ae&&(We.onStateChange=j),ae=null,j=null)}return Je(()=>{E(),window.addEventListener("pointerup",y),window.addEventListener("pointercancel",y)}),As(Ce),Rs(Et),_t(()=>{Et(),window.removeEventListener("pointerup",y),window.removeEventListener("pointercancel",y)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:B,pauseBuffer:C,showJumpBottom:u,copiedIndex:f,regexError:H,levels:v,logPresets:g,timeRanges:I,timeRange:b,activeLogPreset:A,customLogPresets:m,showSaveLogPreset:x,newLogPresetName:_,hasActiveLogFilters:S,timeRangeLabel:L,timelineBuckets:D,timelineMax:K,timelineSpanLabel:ne,timelineLabelSkip:$,togglePause:F,clearLogs:X,exportLogs:Z,logLineClass:re,levelClass:ie,levelChipClass:se,toggleLevel:ue,copyLine:J,jumpToBottom:he,onScroll:z,onUserScrollIntent:de,onUserScrollKey:xe,onAutoScrollToggle:R,onPointerDown:Be,applyLogPreset:ye,applyCustomLogPreset:fe,saveLogCustomPreset:ge,removeLogCustomPreset:we,segmentHeight:T,jumpToTimelineBucket:N,searchLevel:Te,searchTool:Re,searchKeyword:Ne,searchStart:Pe,searchEnd:Ve,searchTimePreset:st,searchLimit:V,searchLimits:_e,searching:Ie,searchRan:De,searchError:ze,searchResults:Ye,searchStats:ht,expandedSearch:ts,switchToSearch:Is,runSearch:Ee,clearSearchFilters:fs,toggleSearchExpand:Zs,formatSearchTs:ca,searchEntryText:wn,searchLogLineClass:Js,formatJson:P,applySearchTimePreset:Fs}}},Cg="••••••••",Jk={timezone:{apply_mode:"restart",description:"Locale and scheduling defaults used across Odin."},discord:{apply_mode:"live_read",description:"Global Discord defaults. Guild and channel overrides take precedence."},llm_provider:{apply_mode:"live_apply",owner:"llm",description:"Active language-model provider and failover ownership."},openai_codex:{apply_mode:"live_apply",owner:"llm",description:"Codex models, reasoning, transport, and pool behaviour."},ollama:{apply_mode:"restart",owner:"llm",description:"Local or remote Ollama provider settings."},kimi:{apply_mode:"restart",owner:"llm",description:"Kimi provider settings and request limits."},context:{apply_mode:"restart",description:"System-prompt sources and prompt-budget controls."},sessions:{apply_mode:"restart",description:"Conversation persistence, retention, and history limits."},tools:{apply_mode:"restart",description:"Execution policy, hosts, timeouts, pools, and recovery."},logging:{apply_mode:"restart",description:"Runtime log verbosity and storage policy."},usage:{apply_mode:"activation_required",description:"Usage accounting and durable history storage."},webhook:{apply_mode:"restart",description:"Inbound webhook listener and authentication policy."},learning:{apply_mode:"restart",description:"Reflection, consolidation, and learned-context limits."},observability:{apply_mode:"live_read",description:"Metrics, tracing, and failure-classification controls."},email:{apply_mode:"restart",description:"SMTP and IMAP behaviour for email tools."},search:{apply_mode:"restart",description:"Knowledge and history search backends."},browser:{apply_mode:"restart",description:"Browser automation limits and viewport defaults."},permissions:{apply_mode:"restart",description:"Default and per-user execution policy."},comfyui:{apply_mode:"live_read",description:"ComfyUI image backend connection settings."},image:{apply_mode:"live_read",description:"Image routing and native generation policy."},web:{apply_mode:"restart",description:"Management API listener, authentication, and sessions."},attachments:{apply_mode:"live_read",description:"Attachment limits, paths, and cleanup policy."},personality:{apply_mode:"live_read",owner:"personality",description:"Response identity, style, and personality presets."},reaction_triggers:{apply_mode:"activation_required",owner:"reaction_triggers",description:"Discord reaction event automation."},message_triggers:{apply_mode:"activation_required",owner:"message_triggers",description:"Discord message event automation."},mcp:{apply_mode:"activation_required",owner:"mcp",description:"Model Context Protocol servers and tool publication."},slack:{apply_mode:"restart",description:"Slack destinations and internal alert forwarding."},issue_tracker:{apply_mode:"activation_required",owner:"issue_tracker",description:"Issue tracker provider and tool lifecycle."},audit:{apply_mode:"restart",description:"Audit signing, verification, and retention."},agents:{apply_mode:"live_for_new_work",description:"Spawned-agent budgets, inheritance, and tree limits."},grafana_alerts:{apply_mode:"activation_required",owner:"grafana_alerts",description:"Grafana alert intake, routing, and remediation."},outbound_webhooks:{apply_mode:"live_apply",owner:"outbound_webhooks",description:"Outbound event targets, delivery, and safety policy."},graceful_degradation:{apply_mode:"activation_required",description:"Subsystem failure thresholds and request guarding."},llm_recovery:{apply_mode:"restart",description:"Provider recovery, breaker, and retry policy."},turn_state:{apply_mode:"restart",description:"Durable turn checkpoints, expiry, and resume behaviour."}},Ju={timezone:{label:"Timezone",description:"Timezone used in prompts and scheduled-time parsing.",consumers:[{name:"Prompt context",apply_mode:"live_read",detail:"Future prompts read the configured value."},{name:"Time parser",apply_mode:"restart",detail:"The parser currently captures the boot value."}],restart_reason:"The scheduling parser captures timezone during startup."},"discord.token":{owner:"secrets",sensitivity:"sensitive",description:"Write-only Discord bot credential."},"discord.allowed_users":{description:"Global allowlist of Discord user IDs. An empty list allows all users."},"discord.channels":{description:"Global allowlist of Discord channel IDs. An empty list allows all channels."},"discord.require_mention":{description:"Require a mention by default unless a guild or channel override says otherwise."},"discord.respond_to_bots":{description:"Allow replies to bot-authored messages by default."},"llm_provider.active_provider":{enum:["codex","ollama","kimi"],description:"Provider used for new primary requests."},"openai_codex.enabled":{apply_mode:"live_apply",description:"Enable or disable the primary Codex client through the dedicated Codex reload path."},"openai_codex.model":{apply_mode:"live_apply",description:"Primary Codex model. Spawned agents may inherit it directly; chat and loops require a Codex reload.",consumers:[{name:"Spawned agents inheriting the main model",apply_mode:"live_read",detail:"Future agent generations read the configured model at call time."},{name:"Chat and autonomous loops",apply_mode:"live_apply",detail:"The dedicated Codex endpoint reloads the live client."}]},"openai_codex.max_tokens":{apply_mode:"live_apply",constraints:{minimum:1,maximum:128e3},unit:"tokens",description:"Maximum Codex response tokens; requires the dedicated Codex reload path."},"openai_codex.reasoning_effort":{apply_mode:"live_apply",description:"Main Codex reasoning effort; requires the dedicated Codex reload path."},"openai_codex.agent_reasoning_effort":{apply_mode:"live_read",description:"Reasoning policy for spawned-agent generations; future generations read it at call time."},"openai_codex.agent_model":{apply_mode:"live_read",description:"Model policy for spawned-agent generations; future generations read it at call time."},"openai_codex.credentials_path":{owner:"secrets",sensitivity:"sensitive",apply_mode:"restart",description:"Write-only Codex credential-store path; an existing client cannot switch stores live.",restart_reason:"The credential pool is constructed from this path when the Codex client starts."},"openai_codex.request_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Whole-request timeout; requires the dedicated Codex reload path."},"openai_codex.stream_stall_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Maximum silent-stream interval; requires the dedicated Codex reload path."},"openai_codex.retry.max_retries":{apply_mode:"live_apply",description:"Retry-attempt ceiling; requires the dedicated Codex reload path."},"openai_codex.retry.base_delay":{apply_mode:"live_apply",unit:"seconds",description:"Initial retry delay; requires the dedicated Codex reload path."},"openai_codex.retry.max_delay":{apply_mode:"live_apply",unit:"seconds",description:"Maximum retry delay; requires the dedicated Codex reload path."},"openai_codex.connection_pool.max_connections":{apply_mode:"restart",description:"Maximum Codex transport connections.",restart_reason:"Connection-pool sizing is fixed when the live client transport is constructed."},"openai_codex.connection_pool.keepalive_timeout":{apply_mode:"restart",unit:"seconds",description:"Codex connection keepalive timeout.",restart_reason:"Connection-pool keepalive policy is fixed when the live client transport is constructed."},"openai_codex.context_compression.enabled":{apply_mode:"restart",description:"Enable context compression for chat and agent tool loops.",restart_reason:"The context-compressor holder is constructed at startup and has no live apply path."},"openai_codex.context_compression.max_context_chars":{apply_mode:"restart",unit:"characters",description:"Context size at which compression begins.",restart_reason:"The context-compressor holder retains its startup configuration."},"openai_codex.context_compression.keep_recent_iterations":{apply_mode:"restart",unit:"iterations",description:"Recent tool iterations preserved during compression.",restart_reason:"The context-compressor holder retains its startup configuration."},"logging.level":{enum:["DEBUG","INFO","WARNING","ERROR","CRITICAL"],description:"Minimum runtime log level."},"browser.default_timeout_ms":{constraints:{minimum:1e3},unit:"ms",description:"Default browser operation timeout."},"browser.viewport_width":{constraints:{minimum:100,maximum:7680},unit:"px"},"browser.viewport_height":{constraints:{minimum:100,maximum:4320},unit:"px"},"sessions.max_history":{constraints:{minimum:1,maximum:1e4},unit:"messages"},"sessions.max_age_hours":{constraints:{minimum:1},unit:"hours"},"tools.command_timeout_seconds":{constraints:{minimum:10,maximum:3600},unit:"seconds"},"agents.max_children_per_agent":{apply_mode:"activation_required",description:"Child limit adopted by newly spawned parent agents after explicit activation.",activation_policy:"Explicitly apply the configured limit after reviewing worst-case tree breadth."},"context.max_system_prompt_tokens":{apply_mode:"activation_required",description:"Optional hard budget for future assembled system prompts.",activation_policy:"Preview mandatory prompt usage and omissions before applying the budget."},"usage.directory":{apply_mode:"activation_required",description:"Target for durable usage history; currently no durable store is active.",activation_policy:"Validate the path and explicitly enable durable usage history."},"slack.forward_alerts":{apply_mode:"activation_required",description:"Forward normalized internal alerts to tested Slack destinations.",activation_policy:"Requires an effective notifier, tested destination, and activation receipt."},"grafana_alerts.enabled":{apply_mode:"activation_required",description:"Adopt explicit Grafana processing control without changing legacy webhook behaviour on upgrade.",activation_policy:"Explicit adoption preserves working legacy-control installations."},"graceful_degradation.enabled":{apply_mode:"activation_required",description:"Allow subsystem guards to short-circuit calls while a dependency is unhealthy.",activation_policy:"Explicit adoption resolves the legacy always-on behaviour."}},Yk=["tools.enabled","tools.max_tool_iterations_chat","tools.max_tool_iterations_loop","learning.loop_reflection_enabled","turn_state.retention"],Qk=new Set(["token","api_token","api_key","password","secret","credentials_path","ssh_key_path","hmac_key","webhook_urls","headers","env"]);function ni(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Xk(e){return Array.isArray(e)?"array":e===null?"null":Number.isInteger(e)?"integer":typeof e=="number"?"number":typeof e=="boolean"?"boolean":typeof e=="object"?"object":"string"}function Eg(e,t="",s=[]){if(e&&typeof e=="object"&&!Array.isArray(e)){const n=Object.entries(e);n.length===0&&t&&s.push([t,e]);for(const[a,i]of n)Eg(i,t?`${t}.${a}`:a,s);return s}return t&&s.push([t,e]),s}function e1(e){return e.split(".").some(s=>Qk.has(s))}function t1(e){return Ju[e]?Ju[e]:e.startsWith("mcp.servers.")&&(e.endsWith(".headers")||e.endsWith(".env"))?{owner:"secrets",sensitivity:"secret_container"}:e.startsWith("outbound_webhooks.targets.")&&e.endsWith(".secret")?{owner:"secrets",sensitivity:"sensitive"}:e.startsWith("outbound_webhooks.targets.")&&(e.endsWith(".scrub_secrets")||e.endsWith(".verify_ssl"))?{apply_mode:"activation_required",activation_policy:"Review this target and acknowledge the target-bound safety override."}:{}}function Ag(e){return e==null||e===""?!1:Array.isArray(e)?e.length>0:typeof e=="object"?Object.keys(e).length>0:!0}function Yu(e,t){return t==="public"?e:e&&typeof e=="object"?Array.isArray(e)?[]:{}:Ag(e)?Cg:""}function s1(e){return e.valid===!1?"invalid":e.pending_restart?"pending_restart":e.drift?"drift":e.apply_mode==="activation_required"||e.apply_mode==="dormant"?"dormant":"applied"}function n1(e,t){const s=e.split(".")[0],n=e.split(".").at(-1),a=Jk[s]||{apply_mode:"restart",description:`${ni(s)} configuration.`},i=t1(e),l=i.sensitivity||(e1(e)?"sensitive":"public");let r=i.apply_mode||a.apply_mode;Yk.some(p=>e===p||e.startsWith(`${p}.`))&&(r="live_read");const o=i.owner||a.owner||(l==="public"?"config":"secrets"),c=Yu(t,l),d=Yu(t,l),u=Ag(t)&&!(l!=="public"&&t===Cg),f={path:e,owner:o,label:i.label||ni(n),description:i.description||`${ni(n)} setting for ${ni(s)}.`,aliases:i.aliases||[],unit:i.unit||null,examples:i.examples||[],type:i.type||Xk(t),enum:i.enum||null,constraints:i.constraints||{},default:i.default??null,sensitivity:l,secret_route:l==="public"?null:`/api/config/secrets/${encodeURIComponent(e)}`,apply_mode:r,apply_handler:i.apply_handler||null,consumers:i.consumers||[],restart_reason:i.restart_reason||(r==="restart"?`${ni(s)} is currently constructed during startup.`:null),activation_policy:i.activation_policy||(r==="activation_required"?"Saving configuration does not enable this feature. Explicit activation is required.":null),desired:c,effective:d,configured:u,provenance:u?"config_file":"unset",valid:!0,validation_errors:[],pending_restart:!1,drift:!1,last_apply:null};return f.apply_state=s1(f),f}function a1(e){const t={applied:0,pending_restart:0,dormant:0,invalid:0,drift:0};for(const s of e)Object.hasOwn(t,s.apply_state)&&(t[s.apply_state]+=1);return t}function i1(e){const t=Eg(e||{}).map(([s,n])=>n1(s,n));return{schema_version:1,revision:"local-fixture",generated_at:null,fields:t,status:{counts:a1(t),persistence_error:null,unsafe_overrides:[],desired_revision:null,effective_revision:null}}}const Oa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["personality","context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],l1=[{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Activation required",short:"Dormant",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"}],r1={live_read:"Applies immediately",live_apply:"Reloads live",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Activation required",legacy_control:"Legacy control",dormant:"Not wired"},Qu={llm:{label:"LLM Config",href:"#/system?tab=llm",description:"This section has one canonical editor so provider changes use the safe switch and reload paths."},personality:{label:"Personality",href:"#/personality",description:"Personality presets and the active profile are managed on the dedicated Personality page."},discord:{label:"Discord overrides",href:"#/system?tab=discord",description:"Guild and channel overrides take precedence over these global defaults."},secrets:{label:"Secret controls",href:"#/system?tab=config",description:"Secret values are write-only and use dedicated set and clear flows."}},Rg="odin_config_center_expanded_v1",Ig="odin_config_center_category_v1",o1=50,Xu=e=>Promise.resolve(i1(e));function Rn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function bi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Us(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function c1(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function d1(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Og(e,t){if(bi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Rn(t);const n={};for(const[a,i]of Object.entries(t)){const l=Og(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function u1(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Og(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Lg(e,t,s,n){if(bi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Lg(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function f1(){try{const e=JSON.parse(localStorage.getItem(Rg)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function p1(){try{const e=localStorage.getItem(Ig);return Oa.some(t=>t.key===e)?e:Oa[0].key}catch{return Oa[0].key}}const h1={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(!1),a=h(null),i=h(null),l=h(""),r=h("all"),o=h(p1()),c=h(f1()),d=h({}),u=h(null),f=h(void 0),p=h(!1),v=h({}),g=h([]),I=h([]),A=h(!1),b=h(!1),m=h(!1);let x=null;const _=ee(()=>{var P;return((P=t.value)==null?void 0:P.fields)||[]}),C=ee(()=>new Map(_.value.map(P=>[P.path,P]))),E=ee(()=>e.value?Object.keys(e.value).length:0),k=ee(()=>_.value.length),S=ee(()=>l1),L=ee(()=>g.value.length>0),H=ee(()=>I.value.length>0),M=ee(()=>{if(!e.value)return[];const P=new Set(Oa.flatMap(ke=>ke.sections)),j=Oa.map(ke=>({...ke,sections:ke.sections.filter(Ce=>Object.hasOwn(e.value,Ce))})).filter(ke=>ke.sections.length),ae=Object.keys(e.value).filter(ke=>!P.has(ke));return ae.length&&j.push({key:"other",label:"Other",icon:"folder",sections:ae}),j}),D=ee(()=>{if(!e.value)return[];const P=[];for(const[j,ae]of Object.entries(d.value))Lg(e.value[j],ae,j,P);return P.filter(j=>!bi(j.oldVal,j.newVal)).map(j=>{const ae=oe(j.path);return{...j,label:(ae==null?void 0:ae.label)||Us(j.path.split(".").at(-1)),apply_mode:(ae==null?void 0:ae.apply_mode)||pe(j.path.split(".")[0])}})}),K=ee(()=>D.value.length>0),ne=ee(()=>D.value.length),$=ee(()=>new Set(D.value.map(P=>P.path.split(".")[0])).size),O=ee(()=>!!l.value||r.value!=="all"),T=ee(()=>{const P={...v.value};for(const j of D.value){const ae=oe(j.path),ke=_e(ae,j.newVal);ke&&(P[j.path]=ke)}return P}),N=ee(()=>Object.keys(T.value).length>0),B=ee(()=>e.value?(O.value?M.value:M.value.filter(j=>j.key===o.value)).map(j=>({...j,sections:j.sections.filter(ae=>X(ae))})).filter(j=>j.sections.length):[]),W=ee(()=>{const P=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],j=new Map(P.map(ae=>[ae,[]]));for(const ae of D.value){const ke=j.has(ae.apply_mode)?ae.apply_mode:"restart";j.get(ke).push(ae)}return P.filter(ae=>j.get(ae).length).map(ae=>({key:ae,label:Ps(ae),entries:j.get(ae)}))}),te=ee(()=>D.value.filter(P=>P.apply_mode==="restart").length);function oe(P){var Et;if(C.value.has(P))return C.value.get(P);const j=`${P}.`,ae=_.value.filter(U=>U.path.startsWith(j));if(!ae.length)return null;const ke=ae.some(U=>U.sensitivity!=="public")?"secret_container":"public",Ce=[...new Set(ae.map(U=>U.apply_mode))];return{path:P,label:Us(P.split(".").at(-1)),description:ae[0].description,type:"object",sensitivity:ke,configured:ae.some(U=>U.configured),provenance:((Et=ae.find(U=>U.provenance!=="unset"))==null?void 0:Et.provenance)||"unset",apply_mode:Ce.length===1?Ce[0]:pe(P.split(".")[0]),constraints:{},enum:null}}function Q(P){const j=`${P}.`;return _.value.filter(ae=>ae.path===P||ae.path.startsWith(j))}function he(P){return Q(P).length}function Fe(P){return Us(P)}function z(P){const j=Q(P);if(!j.length)return`${Us(P)} configuration.`;const ae=j.find(Et=>Et.sensitivity==="public"&&Et.description)||j.find(Et=>Et.description),ke=(ae==null?void 0:ae.description)||"";return ke.match(/setting for (.+)\.$/i)?`${Us(P)} settings and runtime behaviour.`:ke}function pe(P){const j=[...new Set(Q(P).map(ae=>ae.apply_mode))];return j.length===1?j[0]:j.includes("restart")?"restart":j.includes("activation_required")?"activation_required":j[0]||"restart"}function de(P){const j=[...new Set(Q(P).map(ae=>Ps(ae.apply_mode)))];return j.length?j.length===1?j[0]:`Mixed apply behaviour: ${j.join(" · ")}`:""}function xe(P){const j=Q(P),ae=j.map(U=>U.owner).filter(U=>U&&U!=="config"&&U!=="secrets");if(!ae.length)return null;const ke=ae.reduce((U,le)=>({...U,[le]:(U[le]||0)+1}),{}),[Ce,Et]=Object.entries(ke).sort((U,le)=>le[1]-U[1])[0];return Et>=Math.max(1,j.length-1)&&Qu[Ce]?Ce:null}function me(P){return Qu[P]||{label:Us(P),href:"#/system?tab=config",description:"This feature uses a dedicated configuration and activation panel."}}function Be(P){var j;return Object.hasOwn(d.value,P)?d.value[P]:(j=e.value)==null?void 0:j[P]}function y(P){const j=Be(P);return(j&&typeof j=="object"&&!Array.isArray(j)?Object.entries(j).map(([ke,Ce])=>({key:ke,path:`${P}.${ke}`,value:Ce})):[{key:null,path:P,value:j}]).map(ke=>{const Ce=oe(ke.path)||{};return{...Ce,...ke,label:Ce.label||(ke.key===null?Fe(P):Us(ke.key)),description:Ce.description||`${Us(ke.key||P)} setting for ${Us(P)}.`,apply_mode:Ce.apply_mode||pe(P),sensitivity:Ce.sensitivity||"public",constraints:Ce.constraints||{},configured:Ce.configured??!0,provenance:Ce.provenance||"config_file"}})}function R(P,j){return[P.label,P.path,P.description,...P.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(j)}function F(P){const j=l.value.trim().toLowerCase();return j?Q(P).filter(ae=>R(ae,j)):[]}function X(P){const j=Q(P);if(r.value!=="all"&&!j.some(ke=>ke.apply_state===r.value))return!1;const ae=l.value.trim().toLowerCase();return!ae||`${Fe(P)} ${P}`.toLowerCase().includes(ae)?!0:j.some(ke=>R(ke,ae))}function Z(P,j){return Q(P).filter(ae=>ae.apply_state===j).length}function J(P){var j,ae,ke;return P==="all"?k.value:((ke=(ae=(j=t.value)==null?void 0:j.status)==null?void 0:ae.counts)==null?void 0:ke[P])??_.value.filter(Ce=>Ce.apply_state===P).length}function ue(P){const j=P.sections.flatMap(ae=>Q(ae));return{fields:j.length,modified:D.value.filter(ae=>P.sections.includes(ae.path.split(".")[0])).length,pending_restart:j.filter(ae=>ae.apply_state==="pending_restart").length,invalid:j.filter(ae=>ae.apply_state==="invalid").length,dormant:j.filter(ae=>ae.apply_state==="dormant").length}}function re(P){var j;return Object.hasOwn(d.value,P)&&!bi((j=e.value)==null?void 0:j[P],d.value[P])}function ie(P){return D.value.some(j=>j.path===P||j.path.startsWith(`${P}.`))}function se(P){o.value=P,l.value="",r.value="all";try{localStorage.setItem(Ig,P)}catch{}}function ye(P){r.value=P}function fe(){l.value="",r.value="all"}function ge(P){return c.value[P]?!0:!!(l.value&&!m.value&&X(P))}function we(P){const j=!ge(P);m.value&&j?c.value={[P]:!0}:c.value={...c.value,[P]:j}}function Te(){g.value.push(Rn(d.value)),g.value.length>o1&&g.value.shift(),I.value=[]}function Re(P){u.value!==P&&(u.value=P,p.value=Object.hasOwn(d.value,P),f.value=p.value?Rn(d.value[P]):void 0,p.value||(d.value={...d.value,[P]:Rn(e.value[P])}),c.value=m.value?{[P]:!0}:{...c.value,[P]:!0})}function Ne(P){if(!De(P)){if(bi(d.value[P],e.value[P])){const j={...d.value};delete j[P],d.value=j}u.value=null,f.value=void 0,p.value=!1}}function Pe(P){const j={...d.value};p.value?j[P]=Rn(f.value):delete j[P],d.value=j,u.value=null,f.value=void 0,p.value=!1;const ae=`${P}.`;v.value=Object.fromEntries(Object.entries(v.value).filter(([ke])=>ke!==P&&!ke.startsWith(ae)))}function Ve(){!K.value&&!u.value||(Te(),d.value={},u.value=null,f.value=void 0,p.value=!1,v.value={},A.value=!1)}function st(P,j){const ae=P.path.split(".")[0];if(u.value!==ae)return;Te();const ke=Rn(d.value[ae]);if(P.key===null?d.value={...d.value,[ae]:j}:(ke[P.key]=j,d.value={...d.value,[ae]:ke}),v.value[P.path]){const Ce={...v.value};delete Ce[P.path],v.value=Ce}}function V(P,j){try{const ae=JSON.parse(j),ke={...v.value};delete ke[P.path],v.value=ke,st(P,ae)}catch(ae){v.value={...v.value,[P.path]:`Invalid JSON: ${ae.message}`}}}function _e(P,j){var ke;if(!P)return null;if((ke=P.enum)!=null&&ke.length&&!P.enum.includes(j))return`Choose one of: ${P.enum.join(", ")}`;const ae=P.constraints||{};if((P.type==="integer"||P.type==="number")&&typeof j=="number"){if(ae.minimum!==void 0&&j<ae.minimum)return`Must be at least ${ae.minimum}${P.unit?` ${P.unit}`:""}`;if(ae.maximum!==void 0&&j>ae.maximum)return`Must be at most ${ae.maximum}${P.unit?` ${P.unit}`:""}`}return null}function Ie(P){return T.value[P.path]||null}function De(P){const j=`${P}.`;return Object.keys(T.value).some(ae=>ae===P||ae.startsWith(j))}function ze(){g.value.length&&(I.value.push(Rn(d.value)),d.value=g.value.pop(),v.value={})}function Ye(){I.value.length&&(g.value.push(Rn(d.value)),d.value=I.value.pop(),v.value={})}function ht(){!K.value||N.value||(u.value&&Ne(u.value),A.value=!0,b.value=!1)}function ts(){A.value=!1}function Is(){u.value?Pe(u.value):Ve()}function Ps(P){return r1[P]||Us(P||"unknown")}function Fs(P){return`apply-${String(P||"unknown").replaceAll("_","-")}`}function us(P){return`cfgc-field-${P.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function q(P){return`${us(P)}-input`}function Ee(P){const j=document.getElementById(us(P))||document.getElementById(us(P.split(".").slice(0,2).join(".")));j==null||j.scrollIntoView({behavior:"smooth",block:"center"})}function fs(P,j){i.value={type:P,message:j},window.setTimeout(()=>{var ae;((ae=i.value)==null?void 0:ae.message)===j&&(i.value=null)},3500)}async function Zs(){if(!(!K.value||N.value||n.value)){n.value=!0;try{const P=u1(e.value,d.value),j=await Y.put("/api/config",P);e.value=j,t.value=await Xu(j),d.value={},u.value=null,f.value=void 0,p.value=!1,g.value=[],I.value=[],v.value={},A.value=!1,fs("success","Configuration saved. Apply status has been refreshed.")}catch(P){fs("error",P.message||"Configuration could not be saved")}finally{n.value=!1}}}async function ca(){var P;if(!K.value){s.value=!0,a.value=null;try{const j=await Y.get("/api/config"),ae=await Xu(j);e.value=j,t.value=ae;const ke=M.value;ke.some(Ce=>Ce.key===o.value)||(o.value=((P=ke[0])==null?void 0:P.key)||Oa[0].key)}catch(j){a.value=j.message||"Unknown configuration error"}finally{s.value=!1}}}function wn(P){if(A.value||!(P.ctrlKey||P.metaKey))return;const j=P.target;j instanceof HTMLElement&&(j.matches("input, textarea, select")||j.isContentEditable)||(!P.shiftKey&&P.key.toLowerCase()==="z"?(P.preventDefault(),ze()):(P.key.toLowerCase()==="y"||P.shiftKey&&P.key.toLowerCase()==="z")&&(P.preventDefault(),Ye()))}function Js(P){if(m.value=P.matches,P.matches){const j=Object.keys(c.value).find(ae=>c.value[ae]);c.value=j?{[j]:!0}:{}}}return ds(c,P=>{try{localStorage.setItem(Rg,JSON.stringify(P))}catch{}},{deep:!0}),Je(()=>{var P;ca(),document.addEventListener("keydown",wn),x=window.matchMedia("(max-width: 760px)"),Js(x),(P=x.addEventListener)==null||P.call(x,"change",Js)}),_t(()=>{var P;document.removeEventListener("keydown",wn),(P=x==null?void 0:x.removeEventListener)==null||P.call(x,"change",Js)}),{config:e,meta:t,loading:s,saving:n,error:a,toast:i,searchQuery:l,healthFilter:r,activeCategory:o,editingSection:u,reviewOpen:A,mobileOverflowOpen:b,healthFilters:S,visibleCategories:M,displayGroups:B,reviewGroups:W,sectionCount:E,fieldCount:k,hasChanges:K,changeCount:ne,changedSectionCount:$,hasDraftErrors:N,canUndo:L,canRedo:H,globalFilterActive:O,reviewRestartCount:te,healthCount:J,categoryStats:ue,selectCategory:se,selectHealthFilter:ye,clearFilters:fe,sectionLabel:Fe,sectionDescription:z,sectionFieldCount:he,sectionHealthCount:Z,sectionApplySummary:de,sectionOwner:xe,ownerInfo:me,sectionEntries:y,sectionSearchHits:F,sectionChanged:re,fieldChanged:ie,isSectionExpanded:ge,toggleSection:we,startSectionDraft:Re,finishSectionDraft:Ne,cancelSectionDraft:Pe,discardAllDrafts:Ve,setFieldValue:st,setJsonFieldValue:V,fieldError:Ie,sectionHasErrors:De,undo:ze,redo:Ye,openReview:ht,closeReview:ts,mobileCancel:Is,applyModeLabel:Ps,applyClass:Fs,compactValue:c1,formatValue:d1,fieldId:us,fieldInputId:q,focusField:Ee,fetchConfig:ca,saveConfig:Zs}}},g1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h([]),t=h(!0),s=h(null),n=h({});function a(p){return p.config&&p.config.enabled!==void 0?p.config.enabled:!0}function i(p){return p.config&&p.config.require_mention!==void 0?p.config.require_mention:!1}function l(p){return p.config&&p.config.respond_to_bots!==void 0?p.config.respond_to_bots:!1}function r(p){return p.config&&Object.keys(p.config).length>0}function o(p){n.value[p]=!n.value[p]}async function c(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/discord/guilds")}catch(p){s.value=p.message}t.value=!1}async function d(p,v,g){try{await Y.put("/api/discord/guild/"+p+"/config",{[v]:g}),await c()}catch(I){s.value=I.message}}async function u(p,v,g,I){try{await Y.put("/api/discord/channel/"+p+"/config",{[g]:I}),await c()}catch(A){s.value=A.message}}async function f(p,v){try{await Y.put("/api/discord/channel/"+p+"/config",{clear:!0}),await c()}catch(g){s.value=g.message}}return Je(c),{guilds:e,loading:t,error:s,expanded:n,guildEnabled:a,guildMention:i,guildBots:l,hasOverride:r,toggleGuild:o,fetchGuilds:c,setGuildConfig:d,setChannelConfig:u,clearOverride:f}}},hs=e=>e==null?e:JSON.parse(JSON.stringify(e));function m1({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:r=()=>{},onError:o=()=>{}}){let c=Promise.resolve(),d=0,u=0;const f=new Map;let p=null;const v=new Map;function g(C){d+=1;const E=c.then(C,C);return c=E.catch(()=>{}),E}function I(C,E){p=hs(C),v.clear();for(const[k,S]of Object.entries(E||{}))v.set(k,hs(S))}function A(C){const E=hs(C),k=++u;return g(async()=>{try{await e(hs(E)),p=hs(E),k===u&&n(hs(E))}catch(S){k===u&&(a(hs(p)),o(S,{kind:"default"}))}})}function b(C,E){const k=hs(E),S=(f.get(C)||0)+1;return f.set(C,S),g(async()=>{try{await t(C,hs(k)),v.set(C,hs(k)),S===f.get(C)&&i(C,hs(k))}catch(L){S===f.get(C)&&(l(C,hs(v.get(C)??null)),o(L,{kind:"user",uid:C}))}})}function m(C){const E=(f.get(C)||0)+1;return f.set(C,E),g(async()=>{try{await s(C),v.delete(C),E===f.get(C)&&r(C)}catch(k){E===f.get(C)&&(l(C,hs(v.get(C)??null)),o(k,{kind:"delete",uid:C}))}})}async function x(){for(;;){const C=c;if(await C,C===c)return d}}async function _(C){for(;;){const E=await x(),k=await C();if(E===d)return k}}return{seed:I,saveDefault:A,saveUser:b,deleteUser:m,whenIdle:x,readSnapshot:_,get revision(){return d}}}const v1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),d=h([]),u=h(null),f=ee(()=>{const B={};for(const W of d.value)B[W.id]=W;return B});function p(B){return f.value[B]||null}const v=ee(()=>/^\d{15,25}$/.test(r.value.trim())),g=ee(()=>{if(o.value){if(I.value[c.value])return"host-user-option-"+c.value;if(v.value)return"host-user-option-raw"}}),I=ee(()=>{const B=r.value.toLowerCase().trim();return B?d.value.filter(W=>!i.value[W.id]&&(W.display_name.toLowerCase().includes(B)||W.username.toLowerCase().includes(B)||W.id.includes(B))):d.value.filter(W=>!i.value[W.id])});function A(B,W){return B?B.allowed_hosts===null||B.allowed_hosts===void 0?{allowed_hosts:[...W],default_host:B.default_host||"",allow_all:!0}:{allowed_hosts:B.allowed_hosts,default_host:B.default_host||"",allow_all:!1}:{allowed_hosts:[...W],default_host:W[0]||"",allow_all:!0}}const b=m1({applyDefault:async B=>{const W=B.allow_all?null:B.allowed_hosts;await Y.put("/api/host-access/default-policy",{allowed_hosts:W,default_host:B.default_host})},applyUser:async(B,W)=>{const te=W.allow_all?null:W.allowed_hosts;await Y.put(`/api/host-access/user/${B}`,{allowed_hosts:te,default_host:W.default_host})},applyDelete:B=>Y.del(`/api/host-access/user/${B}`),onDefaultConfirmed:()=>Se.success("Default policy updated"),onDefaultRollback:B=>{B&&(a.value=B)},onUserConfirmed:B=>{const W=p(B);Se.success(`Updated access for ${W?W.display_name:B}`)},onUserRollback:(B,W)=>{const te={...i.value};W?te[B]=W:delete te[B],i.value=te},onUserDeleted:B=>{const W={...i.value};delete W[B],i.value=W},onError:(B,W)=>{var oe;const te=W.uid?` ${((oe=p(W.uid))==null?void 0:oe.display_name)||W.uid}`:"";Se.error(`${B.message||"Failed to save"} — reverted${te}`)}});let m=0;async function x(){const B=++m;e.value=!0,t.value="";try{const W=await b.readSnapshot(()=>Y.get("/api/host-access"));if(B!==m)return;s.value=W,n.value=W.available_hosts||[],a.value=A(W.default_policy,n.value);const te=W.users||{},oe={};for(const[Q,he]of Object.entries(te))oe[Q]=A(he,n.value);i.value=oe,b.seed(a.value,oe)}catch(W){B===m&&(t.value=W.message||"Failed to fetch host access data")}finally{B===m&&(e.value=!1)}try{const W=await Y.get("/api/discord/members")||[];B===m&&(d.value=W)}catch{B===m&&(d.value=[])}}function _(){b.saveDefault(a.value)}function C(B,W){a.value.allow_all=!1,W?a.value.allowed_hosts.includes(B)||a.value.allowed_hosts.push(B):(a.value.allowed_hosts=a.value.allowed_hosts.filter(te=>te!==B),a.value.default_host===B&&(a.value.default_host=a.value.allowed_hosts[0]||"")),_()}function E(B){const W=i.value[B];W&&b.saveUser(B,W)}function k(B,W,te){const oe=i.value[B];oe&&(oe.allow_all=!1,te?oe.allowed_hosts.includes(W)||oe.allowed_hosts.push(W):(oe.allowed_hosts=oe.allowed_hosts.filter(Q=>Q!==W),oe.default_host===W&&(oe.default_host=oe.allowed_hosts[0]||"")),E(B))}function S(B,W){const te=i.value[B];te&&(te.default_host=W,E(B))}function L(){l.value=!0,r.value="",c.value=0,Ot(()=>{u.value&&u.value.focus()})}function H(){o.value=!0,c.value=0}function M(){c.value<I.value.length-1&&c.value++}function D(){c.value>0&&c.value--}function K(){const B=I.value[c.value];if(B){$(B);return}v.value&&ne()}function ne(){const B=r.value.trim();/^\d{15,25}$/.test(B)&&(i.value[B]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},E(B),r.value="",o.value=!1,l.value=!1)}function $(B){i.value[B.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},E(B.id),r.value="",o.value=!1,l.value=!1}function O(){o.value=!1}function T(){setTimeout(()=>{o.value=!1},150)}async function N(B){const W=p(B);await bs({title:"Remove user override",message:`Remove the host access override for ${W?W.display_name:B}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await b.deleteUser(B),i.value[B]||Se.success(`Removed override for ${W?W.display_name:B}`))}return Je(x),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:d,filteredMembers:I,isRawId:v,activeOptionId:g,searchInput:u,fetchData:x,saveDefaultPolicy:_,toggleDefaultHost:C,getMember:p,toggleUserHost:k,setUserDefault:S,openAddUser:L,deleteUser:N,onSearchInput:H,highlightNext:M,highlightPrev:D,selectHighlighted:K,selectMember:$,closeDropdown:O,onBlur:T,addRawId:ne}}},b1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=ee(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=ee(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function p(k){return k==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":k==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function v(){e.value=!0,t.value="";try{const k=await Y.get("/api/tokens");s.value=k.tokens||[],n.value=k.available_hosts||[]}catch(k){t.value=k.message||"Failed to load tokens"}finally{e.value=!1}}function g(k){return!k||!k.trim()?[]:k.split(",").map(S=>S.trim()).filter(Boolean)}function I(k,S){const L=c.value.allowed_hosts;if(S&&!L.includes(k)&&L.push(k),!S){const H=L.indexOf(k);H>=0&&L.splice(H,1)}}function A(k,S){const L=d.value.allowed_hosts;if(S&&!L.includes(k)&&L.push(k),!S){const H=L.indexOf(k);H>=0&&L.splice(H,1)}}async function b(){var k;i.value=!0;try{const S=g(c.value.allowed_tools_str),L=c.value.host_mode,H=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,M={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:S.length?S:[]};H!==null&&(M.allowed_hosts=H),M.default_host=c.value.default_host||"";const D=await Y.post("/api/tokens",M);l.value=D.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Se.success("Token created"),await v()}catch(S){Se.error(((k=S.data)==null?void 0:k.error)||S.message||"Failed to create token")}finally{i.value=!1}}function m(k){r.value=k;const S=k.allowed_hosts;let L="default";S==null?L="default":Array.isArray(S)&&S.length===0?L="none":Array.isArray(S)&&(L="select"),d.value={username:k.username||"",tier:k.tier||"admin",label:k.label||"",host_mode:L,allowed_hosts:Array.isArray(S)?[...S]:[],default_host:k.default_host||"",allowed_tools_str:(k.allowed_tools||[]).join(", ")}}async function x(){var k;if(r.value){o.value=!0;try{const S=g(d.value.allowed_tools_str),L=d.value.host_mode,H={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:S};L==="none"?H.allowed_hosts=[]:L==="select"?H.allowed_hosts=d.value.allowed_hosts:H.allowed_hosts=null,H.default_host=d.value.default_host||"",await Y.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,Se.success("Token updated"),await v()}catch(S){Se.error(((k=S.data)==null?void 0:k.error)||S.message||"Failed to update")}finally{o.value=!1}}}async function _(k){var L;if(await bs({title:"Regenerate token",message:`Regenerate token for ${k.username||k.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await Y.post("/api/tokens/"+encodeURIComponent(k.user_id)+"/regenerate");l.value=H.token,Se.success("Token regenerated")}catch(H){Se.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to regenerate")}}async function C(k){var L;if(await bs({title:"Delete token",message:`Delete token for ${k.username||k.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/tokens/"+encodeURIComponent(k.user_id)),Se.success("Token deleted"),await v()}catch(H){Se.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to delete")}}async function E(){if(l.value)try{await navigator.clipboard.writeText(l.value),Se.success("Copied to clipboard")}catch{Se.error("Copy failed — select and copy manually")}}return Je(v),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:f,fetchData:v,tierBadge:p,toggleCreateHost:I,toggleEditHost:A,createToken:b,startEdit:m,saveEdit:x,confirmRegenerate:_,confirmDelete:C,copyToken:E}}};function ul(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const y1={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=ee(()=>{const q=n.value.model;return q&&!a.includes(q)?[q,...a]:a}),l=ee(()=>{const q=n.value.agent_model;return q&&q!=="auto"&&!a.includes(q)?[q,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=ee(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=ee(()=>{const q=n.value.agent_model;return q==="auto"?!0:!r.includes(q||n.value.model)}),d=ee(()=>{const q=n.value.agent_reasoning_effort;return q==="auto"?!1:(q||n.value.reasoning_effort)==="max"}),u=q=>r.includes(q)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),f=q=>r.includes(q)&&d.value,p=h({enabled:!1,model:"gpt-5.6-luna"}),v=h({unavailable_reason:null}),g=ee(()=>{const q=p.value.model;return q&&!a.includes(q)?[q,...a]:a});function I(q){const Ee=q.target.value;p.value.enabled=Ee!=="",Ee!==""&&(p.value.model=Ee),Ve()}const A=h(!1),b=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),m=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),x=h(!1),_=h(!1),C=h(!1),E=h(!1),k=h(!1),S=h(!1),L=h(!1),H=h({configured:!1}),M=h([]),D=h(""),K=h(!1),ne=h(!1),$=h({configured:!1}),O=h([]),T=h(""),N=h(!1),B=h(!1),W=h(!0),te=h(""),oe=h({configured:!1,accounts:[]}),Q=h(null),he=h(null),Fe=h(""),z=h(null),pe=h(!1),de=h(null),xe=h(null),me=h("");let Be=null;function y(q,Ee="success"){Se(q,Ee==="error"?"error":"success")}function R(q){if(!q)return"?";const Ee=q/(1024*1024*1024);return Ee>=1?Ee.toFixed(1)+" GB":(q/(1024*1024)).toFixed(0)+" MB"}async function F(){e.value=!0,await Promise.all([X(),Z(),ye(),J()]),e.value=!1}async function X(){try{const q=await Y.get("/api/llm/status");t.value=q,s.value=q.active_provider||"codex",q.codex&&!Pe.pending()&&(n.value.enabled=q.codex.enabled,n.value.model=q.codex.model||"gpt-5.5",n.value.reasoning_effort=q.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=q.codex.agent_reasoning_effort||"",n.value.agent_model=q.codex.agent_model||"",n.value.max_tokens=q.codex.max_tokens||4096),q.ollama&&!st.pending()&&(b.value.enabled=q.ollama.enabled,b.value.base_url=q.ollama.base_url||"",b.value.model=q.ollama.model||"",b.value.max_tokens=q.ollama.max_tokens||4096),q.kimi&&!V.pending()&&(m.value.enabled=q.kimi.enabled,m.value.model=q.kimi.model||"",m.value.max_tokens=q.kimi.max_tokens||4096),q.auxiliary&&(v.value=q.auxiliary,Ve.pending()||(p.value.enabled=q.auxiliary.enabled,p.value.model=q.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Z(){try{if(H.value=await Y.get("/api/ollama/status"),H.value.model&&(D.value=H.value.model),H.value.configured)try{const q=await Y.get("/api/ollama/models");M.value=q.models||[]}catch{M.value=[]}else if(b.value.base_url)try{const q=await Y.post("/api/ollama/probe-models",{base_url:b.value.base_url});M.value=q.models||[]}catch{M.value=[]}}catch{H.value={configured:!1}}}async function J(){W.value=!0,te.value="";try{oe.value=await Y.get("/api/codex/status")}catch(q){te.value=q.message||"Failed to fetch Codex status"}finally{W.value=!1}}async function ue(){const q=t.value?t.value.active_provider:"codex";L.value=!0;try{const Ee=await Y.post("/api/llm/switch",{provider:s.value});Ee.error?(s.value=q,y(Ee.error,"error")):(y("Switched to "+s.value+" ("+Ee.model+")"),await F())}catch(Ee){s.value=q,y(Ee.message||"Switch failed","error")}finally{L.value=!1}}async function re(){K.value=!0;try{const q=await Y.post("/api/ollama/reload");y(q.configured?"Ollama reloaded":q.reason||"Ollama not configured",q.configured?"success":"error"),await F()}catch(q){y(q.message||"Reload failed","error")}finally{K.value=!1}}async function ie(){ne.value=!0;try{await Y.post("/api/ollama/model",{model:D.value}),y("Model set to "+D.value),await F()}catch(q){y(q.message||"Failed","error")}finally{ne.value=!1}}async function se(){const q=b.value.base_url;if(!q){y("Enter a base URL first","error");return}S.value=!0;try{const Ee=await Y.post("/api/ollama/probe-models",{base_url:q});M.value=Ee.models||[],M.value.length?(y(M.value.length+" model(s) found"),!b.value.model&&M.value.length&&(b.value.model=M.value[0].name)):y("No models found at "+q,"error")}catch(Ee){y(Ee.message||"Could not reach Ollama","error")}finally{S.value=!1}}async function ye(){try{if($.value=await Y.get("/api/kimi/status"),$.value.model&&(T.value=$.value.model),$.value.configured)try{const q=await Y.get("/api/kimi/models");O.value=q.models||[]}catch{O.value=[]}}catch{$.value={configured:!1}}}async function fe(){N.value=!0;try{const q=await Y.post("/api/kimi/reload");y(q.configured?"Kimi reloaded":q.reason||"Kimi not configured",q.configured?"success":"error"),await F()}catch(q){y(q.message||"Reload failed","error")}finally{N.value=!1}}async function ge(){B.value=!0;try{await Y.post("/api/kimi/model",{model:T.value}),y("Model set to "+T.value),await F()}catch(q){y(q.message||"Failed","error")}finally{B.value=!1}}async function we(){if(C.value){Pe();return}C.value=!0;try{await Y.put("/api/llm/codex/config",n.value),y("Codex config saved"),await Promise.all([X(),J()])}catch(q){y(q.message||"Failed","error"),await Promise.all([X(),J()])}finally{C.value=!1}}async function Te(){if(E.value){st();return}E.value=!0;try{const q={...b.value},Ee=x.value?b.value.api_key:null;Ee===null&&delete q.api_key,await Y.put("/api/llm/ollama/config",q),y("Ollama config saved"),Ee!==null&&b.value.api_key===Ee&&(b.value.api_key="",x.value=!1),await Promise.all([X(),Z()])}catch(q){y(q.message||"Failed","error")}finally{E.value=!1}}async function Re(){if(k.value){V();return}k.value=!0;try{const q={...m.value},Ee=_.value?m.value.api_key:null;Ee===null&&delete q.api_key,await Y.put("/api/llm/kimi/config",q),y("Kimi config saved"),Ee!==null&&m.value.api_key===Ee&&(m.value.api_key="",_.value=!1),await Promise.all([X(),ye()])}catch(q){y(q.message||"Failed","error")}finally{k.value=!1}}async function Ne(){if(A.value){Ve();return}A.value=!0;try{await Y.put("/api/llm/auxiliary/config",p.value),y("Auxiliary config saved"),await X()}catch(q){y(q.message||"Failed","error"),await X()}finally{A.value=!1}}const Pe=ul(we),Ve=ul(Ne),st=ul(Te),V=ul(Re),_e=()=>(Pe.cancel(),we()),Ie=()=>(st.cancel(),Te()),De=()=>(V.cancel(),Re());async function ze(q){try{await Y.post("/api/codex/account/"+q+"/activate"),y("Active account switched"),await J()}catch(Ee){y(Ee.message||"Failed","error")}}async function Ye(q){Q.value=q;try{await Y.post("/api/codex/account/"+q+"/refresh"),y("Token refreshed"),await J()}catch(Ee){y(Ee.message||"Refresh failed","error")}finally{Q.value=null}}function ht(q,Ee){he.value=q,Fe.value=Ee||""}async function ts(q){try{await Y.put("/api/codex/account/"+q+"/label",{label:Fe.value}),y("Label updated"),he.value=null,await J()}catch(Ee){y(Ee.message||"Failed","error")}}async function Is(q,Ee){if(await bs({title:"Delete Codex account",message:`Delete ${Ee||"account #"+(q+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/codex/account/"+q),y("Deleted. Pool reloaded."),await J()}catch(Zs){y(Zs.message||"Failed","error")}}async function Ps(){pe.value=!0;try{const q=await Y.post("/api/codex/device-code");de.value=q,z.value="pending",Fs(q)}catch(q){y(q.message||"Failed","error")}finally{pe.value=!1}}async function Fs(q){Be={cancelled:!1};const Ee=Be;try{const fs=await Y.post("/api/codex/device-poll",{device_auth_id:q.device_auth_id,user_code:q.user_code,interval:q.interval});if(Ee.cancelled)return;xe.value=fs,z.value="success",await F()}catch(fs){if(Ee.cancelled)return;me.value=fs.message||"Device login failed",z.value="error"}}function us(){Be&&(Be.cancelled=!0),z.value=null,de.value=null}return Je(F),_t(()=>{Be&&(Be.cancelled=!0),Pe.cancel(),Ve.cancel(),st.cancel(),V.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:L,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:f,auxForm:p,auxData:v,auxModelOptions:g,onAuxModelChange:I,savingAux:A,saveAuxConfigDebounced:Ve,ollamaForm:b,kimiForm:m,savingCodex:C,savingOllama:E,savingKimi:k,probingOllama:S,ollamaKeyDirty:x,kimiKeyDirty:_,ollamaStatus:H,ollamaModels:M,ollamaSelectedModel:D,reloading:K,settingModel:ne,kimiStatus:$,kimiModels:O,kimiSelectedModel:T,reloadingKimi:N,settingKimiModel:B,codexLoading:W,codexError:te,codexData:oe,refreshing:Q,editingLabel:he,labelValue:Fe,deviceState:z,deviceLoading:pe,deviceInfo:de,deviceResult:xe,deviceError:me,fetchAll:F,switchProvider:ue,reloadOllama:re,setOllamaModel:ie,reloadKimi:fe,setKimiModel:ge,probeOllamaModels:se,saveCodexConfig:we,saveOllamaConfig:Te,saveKimiConfig:Re,saveCodexConfigDebounced:Pe,saveOllamaConfigDebounced:st,saveKimiConfigDebounced:V,saveCodexConfigNow:_e,saveOllamaConfigNow:Ie,saveKimiConfigNow:De,activateAccount:ze,refreshAccount:Ye,startEditLabel:ht,saveLabel:ts,deleteAccount:Is,startDeviceLogin:Ps,cancelDeviceLogin:us,formatSize:R}}},ef={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function x1(e){return ef[e]||ef[(e||"").toLowerCase()]||"text-gray-400"}const _1={template:`
  ...
  `},k1={components:{TabbedPage:kr},setup(){return{tabs:[{id:"health",label:"Health",component:zk},{id:"resources",label:"Resources",component:qk},{id:"logs",label:"Logs",component:Zk},{id:"config",label:"Config",component:h1},{id:"discord",label:"Discord",component:g1},{id:"host-access",label:"Host Access",component:v1},{id:"api-tokens",label:"API Tokens",component:b1},{id:"llm",label:"LLM Config",component:y1},{id:"internals",label:"Internals",component:_1},{id:"update",label:"Update",component:w1}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},wt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Ng=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:J_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:hk,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:kk,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:Ik,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Uk,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:Bk,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:k1,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:wt("/operations","live")},{path:"/agents",redirect:wt("/operations","agents")},{path:"/loops",redirect:wt("/operations","loops")},{path:"/processes",redirect:wt("/operations","processes")},{path:"/schedules",redirect:wt("/operations","schedules")},{path:"/audit",redirect:wt("/history","audit")},{path:"/sessions",redirect:wt("/history","sessions")},{path:"/traces",redirect:wt("/history","traces")},{path:"/usage",redirect:wt("/history","usage")},{path:"/tools",redirect:wt("/capabilities","tools")},{path:"/skills",redirect:wt("/capabilities","skills")},{path:"/knowledge",redirect:wt("/capabilities","knowledge")},{path:"/memory",redirect:wt("/capabilities","memory")},{path:"/learned",redirect:wt("/capabilities","learned")},{path:"/health",redirect:wt("/system","health")},{path:"/resources",redirect:wt("/system","resources")},{path:"/logs",redirect:wt("/system","logs")},{path:"/config",redirect:wt("/system","config")},{path:"/host-access",redirect:wt("/system","host-access")},{path:"/internals",redirect:wt("/system","internals")}],yi=V_({history:x_(),routes:Ng});yi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const S1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),d=h("disconnected"),u=h(-1),f=h(null);let p=null;const v=h("starting"),g=h(""),I=Ng.filter(O=>O.meta),A=ee(()=>["Workspace","Operate","Observe","Manage"].map(O=>({name:O,routes:I.filter(T=>T.meta.section===O)})).filter(O=>O.routes.length)),b=ee(()=>{var O;return((O=yi.currentRoute.value.meta)==null?void 0:O.label)||"Odin"}),m=ee(()=>{var O;return((O=yi.currentRoute.value.meta)==null?void 0:O.section)||"Management"}),x=ee(()=>{var O;return((O=yi.currentRoute.value.meta)==null?void 0:O.description)||"Management console"});Y.onSessionExpired=()=>{t.value=!0,We.disconnect(),Y.setToken(""),e.value="login"};function _(O){var T;if((O.ctrlKey||O.metaKey)&&O.key.toLowerCase()==="k"){e.value==="ready"&&(O.preventDefault(),Tu());return}if(n.value&&O.key==="Tab"){const N=[...((T=a.value)==null?void 0:T.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(N.length){const B=N[0],W=N[N.length-1];if(O.shiftKey&&(document.activeElement===B||!a.value.contains(document.activeElement))){O.preventDefault(),W.focus();return}if(!O.shiftKey&&(document.activeElement===W||!a.value.contains(document.activeElement))){O.preventDefault(),B.focus();return}}}if(O.key==="Escape"&&n.value){n.value=!1,O.preventDefault();return}if(O.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(O.target.tagName)){O.preventDefault();const N=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');N&&N.focus()}}function C(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Je(async()=>{document.addEventListener("keydown",_),r=window.matchMedia("(max-width: 900px)"),C(),r.addEventListener("change",C);const O=await Y.check();O.ok?(e.value="ready",ne()):O.needsAuth?e.value="login":(e.value="ready",ne())});function E(){t.value=!1,e.value="ready",ne()}async function k(){await Y.logout(),We.disconnect(),e.value="login"}function S(){s.value=!s.value}function L(){n.value=!n.value}ds(n,async O=>{var T,N;if(O)o=document.activeElement,await Ot(),(N=(T=a.value)==null?void 0:T.querySelector(".nav-item"))==null||N.focus();else if(o!=null&&o.isConnected){const B=o;o=null,requestAnimationFrame(()=>B.focus())}});const H=ee(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(O,T="info",N=3e3){f.value={text:O,level:T},clearTimeout(p),p=setTimeout(()=>{f.value=null},N)}let D=null,K=!1;function ne(){We.onStatusChange=O=>{c.value=O},We.onLatency=O=>{u.value=O},We.onStateChange=(O,T)=>{d.value=O,(T.latency??-1)>=0&&(u.value=T.latency),O==="connected"?(K&&M("Connection restored","success"),K=!0):O==="reconnecting"&&T.attempt===1&&M("Connection lost — reconnecting…","warn")},We.connect(),$(),D&&clearInterval(D),D=setInterval($,15e3)}async function $(){try{const O=await Y.get("/api/status");v.value=O.status==="online"?"online":"starting";const T=O.uptime_seconds||0,N=Math.floor(T/3600),B=Math.floor(T%3600/60);g.value=`${N}h ${B}m uptime`}catch{v.value="offline",g.value=""}}return _t(()=>{D&&clearInterval(D),We.disconnect(),document.removeEventListener("keydown",_),r==null||r.removeEventListener("change",C)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:H,wsToast:f,botStatus:v,botUptime:g,navRoutes:I,navGroups:A,currentPage:b,currentSection:m,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:E,logout:k,toggleSidebar:S,toggleMobileNavigation:L,openPalette:Tu}}},$n=Pl(T1);$n.component("odin-icon",K_);$n.component("login-screen",S1);$n.component("toast-container",D0);$n.component("confirm-host",M0);$n.component("command-palette",G_);$n.directive("modal-focus",Z_);$n.use(yi);$n.mount("#app");
