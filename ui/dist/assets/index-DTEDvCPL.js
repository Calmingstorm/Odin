...
`,-1),r())),e.components.length&&(lr(e.components,"component",s),(e.directives.length||e.temps>0)&&r()),e.directives.length&&(lr(e.directives,"directive",s),e.temps>0&&r()),e.filters&&e.filters.length&&(r(),lr(e.filters,"filter",s),r()),e.temps>0){a("let ");for(let x=0;x<e.temps;x++)a(`${x>0?", ":""}_temp${x}`)}return(e.components.length||e.directives.length||e.temps)&&(a(`
 ...
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let M_=()=>location.protocol+"//"+location.host;function Sm(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,o=a.slice(l);return o[0]!=="/"&&(o="/"+o),Au(o,"")}return Au(s,e)+n+a}function F_(e,t,s,n){let a=[],i=[],l=null;const o=({state:p})=>{const h=Sm(e,location),m=s.value,v=t.value;let S=0;if(p){if(s.value=h,t.value=p,l&&l===m){l=null;return}S=v?p.position-v.position:0}else n(h);a.forEach(R=>{R(s.value,m,{delta:S,type:Jr.pop,direction:S?S>0?cr.forward:cr.back:cr.unknown})})};function r(){l=s.value}function c(p){a.push(p);const h=()=>{const m=a.indexOf(p);m>-1&&a.splice(m,1)};return i.push(h),h}function d(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(it({},p.state,{scroll:zo()}),"")}}function u(){for(const p of i)p();i=[],window.removeEventListener("popstate",o),window.removeEventListener("pagehide",d),document.removeEventListener("visibilitychange",d)}return window.addEventListener("popstate",o),window.addEventListener("pagehide",d),document.addEventListener("visibilitychange",d),{pauseListeners:r,listen:c,destroy:u}}function Nu(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?zo():null}}function $_(e){const{history:t,location:s}=window,n={value:Sm(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(r,c,d){const u=e.indexOf("#"),p=u>-1?(s.host&&document.querySelector("base")?e:e.slice(u))+r:M_()+e+r;try{t[d?"replaceState":"pushState"](c,"",p),a.value=c}catch(h){console.error(h),s[d?"replace":"assign"](p)}}function l(r,c){i(r,it({},t.state,Nu(a.value.back,r,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=r}function o(r,c){const d=it({},a.value,t.state,{forward:r,scroll:zo()});i(d.current,d,!0),i(r,it({},Nu(n.value,r,null),{position:d.position+1},c),!1),n.value=r}return{location:n,state:a,push:o,replace:l}}function B_(e){e=w_(e);const t=$_(e),s=F_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=it({location:"",base:e,go:n,createHref:S_.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function U_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),B_(e)}let ua=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var Dt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(Dt||{});const H_={type:ua.Static,value:""},z_=/[a-zA-Z0-9_]/;function j_(e){if(!e)return[[]];if(e==="/")return[[H_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(h){throw new Error(`ERR (${s})/"${c}": ${h}`)}let s=Dt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let o=0,r,c="",d="";function u(){c&&(s===Dt.Static?i.push({type:ua.Static,value:c}):s===Dt.Param||s===Dt.ParamRegExp||s===Dt.ParamRegExpEnd?(i.length>1&&(r==="*"||r==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:ua.Param,value:c,regexp:d,repeatable:r==="*"||r==="+",optional:r==="*"||r==="?"})):t("Invalid state to consume buffer"),c="")}function p(){c+=r}for(;o<e.length;){if(r=e[o++],r==="\\"&&s!==Dt.ParamRegExp){n=s,s=Dt.EscapeNext;continue}switch(s){case Dt.Static:r==="/"?(c&&u(),l()):r===":"?(u(),s=Dt.Param):p();break;case Dt.EscapeNext:p(),s=n;break;case Dt.Param:r==="("?s=Dt.ParamRegExp:z_.test(r)?p():(u(),s=Dt.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--);break;case Dt.ParamRegExp:r===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+r:s=Dt.ParamRegExpEnd:d+=r;break;case Dt.ParamRegExpEnd:u(),s=Dt.Static,r!=="*"&&r!=="?"&&r!=="+"&&o--,d="";break;default:t("Unknown state");break}}return s===Dt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),u(),l(),a}const Du="[^/]+?",V_={sensitive:!1,strict:!1,start:!0,end:!0};var rs=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(rs||{});const q_=/[.+*?^${}()[\]/\\]/g;function G_(e,t){const s=it({},V_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const d=c.length?[]:[rs.Root];s.strict&&!c.length&&(a+="/");for(let u=0;u<c.length;u++){const p=c[u];let h=rs.Segment+(s.sensitive?rs.BonusCaseSensitive:0);if(p.type===ua.Static)u||(a+="/"),a+=p.value.replace(q_,"\\$&"),h+=rs.Static;else if(p.type===ua.Param){const{value:m,repeatable:v,optional:S,regexp:R}=p;i.push({name:m,repeatable:v,optional:S});const x=R||Du;if(x!==Du){h+=rs.BonusCustomRegExp;try{`${x}`}catch(b){throw new Error(`Invalid custom RegExp for param "${m}" (${x}): `+b.message)}}let g=v?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;u||(g=S&&c.length<2?`(?:/${g})`:"/"+g),S&&(g+="?"),a+=g,h+=rs.Dynamic,S&&(h+=rs.BonusOptional),v&&(h+=rs.BonusRepeatable),x===".*"&&(h+=rs.BonusWildcard)}d.push(h)}n.push(d)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=rs.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function o(c){const d=c.match(l),u={};if(!d)return null;for(let p=1;p<d.length;p++){const h=d[p]||"",m=i[p-1];u[m.name]=h&&m.repeatable?h.split("/"):h}return u}function r(c){let d="",u=!1;for(const p of e){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const h of p)if(h.type===ua.Static)d+=h.value;else if(h.type===ua.Param){const{value:m,repeatable:v,optional:S}=h,R=m in c?c[m]:"";if(Ks(R)&&!v)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const x=Ks(R)?R.join("/"):R;if(!x)if(S)p.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${m}"`);d+=x}}return d||"/"}return{re:l,score:n,keys:i,parse:o,stringify:r}}function K_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===rs.Static+rs.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===rs.Static+rs.Segment?1:-1:0}function Tm(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=K_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(Pu(n))return 1;if(Pu(a))return-1}return a.length-n.length}function Pu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const W_={strict:!1,end:!0,sensitive:!1};function Z_(e,t,s){const n=G_(j_(e.path),s),a=it(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function J_(e,t){const s=[],n=new Map;t=Eu(W_,t);function a(u){return n.get(u)}function i(u,p,h){const m=!h,v=Fu(u);v.aliasOf=h&&h.record;const S=Eu(t,u),R=[v];if("alias"in u){const b=typeof u.alias=="string"?[u.alias]:u.alias;for(const k of b)R.push(Fu(it({},v,{components:h?h.record.components:v.components,path:k,aliasOf:h?h.record:v})))}let x,g;for(const b of R){const{path:k}=b;if(p&&k[0]!=="/"){const w=p.record.path,A=w[w.length-1]==="/"?"":"/";b.path=p.record.path+(k&&A+k)}if(x=Z_(b,p,S),h?h.alias.push(x):(g=g||x,g!==x&&g.alias.push(x),m&&u.name&&!$u(x)&&l(u.name)),Cm(x)&&r(x),v.children){const w=v.children;for(let A=0;A<w.length;A++)i(w[A],x,h&&h.children[A])}h=h||x}return g?()=>{l(g)}:Fi}function l(u){if(wm(u)){const p=n.get(u);p&&(n.delete(u),s.splice(s.indexOf(p),1),p.children.forEach(l),p.alias.forEach(l))}else{const p=s.indexOf(u);p>-1&&(s.splice(p,1),u.record.name&&n.delete(u.record.name),u.children.forEach(l),u.alias.forEach(l))}}function o(){return s}function r(u){const p=X_(u,s);s.splice(p,0,u),u.record.name&&!$u(u)&&n.set(u.record.name,u)}function c(u,p){let h,m={},v,S;if("name"in u&&u.name){if(h=n.get(u.name),!h)throw ri(kt.MATCHER_NOT_FOUND,{location:u});S=h.record.name,m=it(Mu(p.params,h.keys.filter(g=>!g.optional).concat(h.parent?h.parent.keys.filter(g=>g.optional):[]).map(g=>g.name)),u.params&&Mu(u.params,h.keys.map(g=>g.name))),v=h.stringify(m)}else if(u.path!=null)v=u.path,h=s.find(g=>g.re.test(v)),h&&(m=h.parse(v),S=h.record.name);else{if(h=p.name?n.get(p.name):s.find(g=>g.re.test(p.path)),!h)throw ri(kt.MATCHER_NOT_FOUND,{location:u,currentLocation:p});S=h.record.name,m=it({},p.params,u.params),v=h.stringify(m)}const R=[];let x=h;for(;x;)R.unshift(x.record),x=x.parent;return{name:S,path:v,params:m,matched:R,meta:Q_(R)}}e.forEach(u=>i(u));function d(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:d,getRoutes:o,getRecordMatcher:a}}function Mu(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function Fu(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:Y_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function Y_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function $u(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function Q_(e){return e.reduce((t,s)=>it(t,s.meta),{})}function X_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;Tm(e,t[i])<0?n=i:s=i+1}const a=ew(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function ew(e){let t=e;for(;t=t.parent;)if(Cm(t)&&Tm(e,t)===0)return t}function Cm({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Bu(e){const t=$s(jo),s=$s(sd),n=Z(()=>{const r=an(e.to);return t.resolve(r)}),a=Z(()=>{const{matched:r}=n.value,{length:c}=r,d=r[c-1],u=s.matched;if(!d||!u.length)return-1;const p=u.findIndex(oi.bind(null,d));if(p>-1)return p;const h=Uu(r[c-2]);return c>1&&Uu(d)===h&&u[u.length-1].path!==h?u.findIndex(oi.bind(null,r[c-2])):p}),i=Z(()=>a.value>-1&&iw(s.params,n.value.params)),l=Z(()=>a.value>-1&&a.value===s.matched.length-1&&_m(s.params,n.value.params));function o(r={}){if(aw(r)){const c=t[an(e.replace)?"replace":"push"](an(e.to)).catch(Fi);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:Z(()=>n.value.href),isActive:i,isExactActive:l,navigate:o}}function tw(e){return e.length===1?e[0]:e}const sw=cl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Bu,setup(e,{slots:t}){const s=Yn(Bu(e)),{options:n}=$s(jo),a=Z(()=>({[Hu(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[Hu(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&tw(t.default(s));return e.custom?i:ei("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),nw=sw;function aw(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function iw(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!Ks(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function Uu(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Hu=(e,t,s)=>e??t??s,lw=cl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=$s(Qr),a=Z(()=>e.route||n.value),i=$s(Lu,0),l=Z(()=>{let c=an(i);const{matched:d}=a.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),o=Z(()=>a.value.matched[l.value]);Li(Lu,Z(()=>l.value+1)),Li(D_,o),Li(Qr,a);const r=f();return us(()=>[r.value,o.value,e.name],([c,d,u],[p,h,m])=>{d&&(d.instances[u]=c,h&&h!==d&&c&&c===p&&(d.leaveGuards.size||(d.leaveGuards=h.leaveGuards),d.updateGuards.size||(d.updateGuards=h.updateGuards))),c&&d&&(!h||!oi(d,h)||!p)&&(d.enterCallbacks[u]||[]).forEach(v=>v(c))},{flush:"post"}),()=>{const c=a.value,d=e.name,u=o.value,p=u&&u.components[d];if(!p)return zu(s.default,{Component:p,route:c});const h=u.props[d],m=h?h===!0?c.params:typeof h=="function"?h(c):h:null,S=ei(p,it({},m,t,{onVnodeUnmounted:R=>{R.component.isUnmounted&&(u.instances[d]=null)},ref:r}));return zu(s.default,{Component:S,route:c})||S}}});function zu(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const ow=lw;function rw(e){const t=J_(e.routes,e),s=e.parseQuery||L_,n=e.stringifyQuery||Ou,a=e.history,i=xi(),l=xi(),o=xi(),r=pc(Hn);let c=Hn;$a&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=or.bind(null,Y=>""+Y),u=or.bind(null,m_),p=or.bind(null,al);function h(Y,be){let j,re;return wm(Y)?(j=t.getRecordMatcher(Y),re=be):re=Y,t.addRoute(re,j)}function m(Y){const be=t.getRecordMatcher(Y);be&&t.removeRoute(be)}function v(){return t.getRoutes().map(Y=>Y.record)}function S(Y){return!!t.getRecordMatcher(Y)}function R(Y,be){if(be=it({},be||r.value),typeof Y=="string"){const D=rr(s,Y,be.path),z=t.resolve({path:D.path},be),ie=a.createHref(D.fullPath);return it(D,z,{params:p(z.params),hash:al(D.hash),redirectedFrom:void 0,href:ie})}let j;if(Y.path!=null)j=it({},Y,{path:rr(s,Y.path,be.path).path});else{const D=it({},Y.params);for(const z in D)D[z]==null&&delete D[z];j=it({},Y,{params:u(D)}),be.params=u(be.params)}const re=t.resolve(j,be),ue=Y.hash||"";re.params=d(p(re.params));const Le=b_(n,it({},Y,{hash:p_(ue),path:re.path})),_=a.createHref(Le);return it({fullPath:Le,hash:ue,query:n===Ou?N_(Y.query):Y.query||{}},re,{redirectedFrom:void 0,href:_})}function x(Y){return typeof Y=="string"?rr(s,Y,r.value.path):it({},Y)}function g(Y,be){if(c!==Y)return ri(kt.NAVIGATION_CANCELLED,{from:be,to:Y})}function b(Y){return A(Y)}function k(Y){return b(it(x(Y),{replace:!0}))}function w(Y,be){const j=Y.matched[Y.matched.length-1];if(j&&j.redirect){const{redirect:re}=j;let ue=typeof re=="function"?re(Y,be):re;return typeof ue=="string"&&(ue=ue.includes("?")||ue.includes("#")?ue=x(ue):{path:ue},ue.params={}),it({query:Y.query,hash:Y.hash,params:ue.path!=null?{}:Y.params},ue)}}function A(Y,be){const j=c=R(Y),re=r.value,ue=Y.state,Le=Y.force,_=Y.replace===!0,D=w(j,re);if(D)return A(it(x(D),{state:typeof D=="object"?it({},ue,D.state):ue,force:Le,replace:_}),be||j);const z=j;z.redirectedFrom=be;let ie;return!Le&&y_(n,re,j)&&(ie=ri(kt.NAVIGATION_DUPLICATED,{to:z,from:re}),G(re,re,!0,!1)),(ie?Promise.resolve(ie):N(z,re)).catch(se=>hn(se)?hn(se,kt.NAVIGATION_GUARD_REDIRECT)?se:K(se):I(se,z,re)).then(se=>{if(se){if(hn(se,kt.NAVIGATION_GUARD_REDIRECT))return A(it({replace:_},x(se.to),{state:typeof se.to=="object"?it({},ue,se.to.state):ue,force:Le}),be||z)}else se=E(z,re,!0,_,ue);return U(z,re,se),se})}function C(Y,be){const j=g(Y,be);return j?Promise.reject(j):Promise.resolve()}function y(Y){const be=ee.values().next().value;return be&&typeof be.runWithContext=="function"?be.runWithContext(Y):Y()}function N(Y,be){let j;const[re,ue,Le]=P_(Y,be);j=dr(re.reverse(),"beforeRouteLeave",Y,be);for(const D of re)D.leaveGuards.forEach(z=>{j.push(Kn(z,Y,be))});const _=C.bind(null,Y,be);return j.push(_),De(j).then(()=>{j=[];for(const D of i.list())j.push(Kn(D,Y,be));return j.push(_),De(j)}).then(()=>{j=dr(ue,"beforeRouteUpdate",Y,be);for(const D of ue)D.updateGuards.forEach(z=>{j.push(Kn(z,Y,be))});return j.push(_),De(j)}).then(()=>{j=[];for(const D of Le)if(D.beforeEnter)if(Ks(D.beforeEnter))for(const z of D.beforeEnter)j.push(Kn(z,Y,be));else j.push(Kn(D.beforeEnter,Y,be));return j.push(_),De(j)}).then(()=>(Y.matched.forEach(D=>D.enterCallbacks={}),j=dr(Le,"beforeRouteEnter",Y,be,y),j.push(_),De(j))).then(()=>{j=[];for(const D of l.list())j.push(Kn(D,Y,be));return j.push(_),De(j)}).catch(D=>hn(D,kt.NAVIGATION_CANCELLED)?D:Promise.reject(D))}function U(Y,be,j){o.list().forEach(re=>y(()=>re(Y,be,j)))}function E(Y,be,j,re,ue){const Le=g(Y,be);if(Le)return Le;const _=be===Hn,D=$a?history.state:{};j&&(re||_?a.replace(Y.fullPath,it({scroll:_&&D&&D.scroll},ue)):a.push(Y.fullPath,ue)),r.value=Y,G(Y,be,j,_),K()}let M;function $(){M||(M=a.listen((Y,be,j)=>{if(!ce.listening)return;const re=R(Y),ue=w(re,ce.currentRoute.value);if(ue){A(it(ue,{replace:!0,force:!0}),re).catch(Fi);return}c=re;const Le=r.value;$a&&E_(Iu(Le.fullPath,j.delta),zo()),N(re,Le).catch(_=>hn(_,kt.NAVIGATION_ABORTED|kt.NAVIGATION_CANCELLED)?_:hn(_,kt.NAVIGATION_GUARD_REDIRECT)?(A(it(x(_.to),{force:!0}),re).then(D=>{hn(D,kt.NAVIGATION_ABORTED|kt.NAVIGATION_DUPLICATED)&&!j.delta&&j.type===Jr.pop&&a.go(-1,!1)}).catch(Fi),Promise.reject()):(j.delta&&a.go(-j.delta,!1),I(_,re,Le))).then(_=>{_=_||E(re,Le,!1),_&&(j.delta&&!hn(_,kt.NAVIGATION_CANCELLED)?a.go(-j.delta,!1):j.type===Jr.pop&&hn(_,kt.NAVIGATION_ABORTED|kt.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),U(re,Le,_)}).catch(Fi)}))}let Q=xi(),P=xi(),L;function I(Y,be,j){K(Y);const re=P.list();return re.length?re.forEach(ue=>ue(Y,be,j)):console.error(Y),Promise.reject(Y)}function H(){return L&&r.value!==Hn?Promise.resolve():new Promise((Y,be)=>{Q.add([Y,be])})}function K(Y){return L||(L=!Y,$(),Q.list().forEach(([be,j])=>Y?j(Y):be()),Q.reset()),Y}function G(Y,be,j,re){const{scrollBehavior:ue}=e;if(!$a||!ue)return Promise.resolve();const Le=!j&&A_(Iu(Y.fullPath,0))||(re||!j)&&history.state&&history.state.scroll||null;return Rt().then(()=>ue(Y,be,Le)).then(_=>_&&C_(_)).catch(_=>I(_,Y,be))}const X=Y=>a.go(Y);let le;const ee=new Set,ce={currentRoute:r,listening:!0,addRoute:h,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:S,getRoutes:v,resolve:R,options:e,push:b,replace:k,go:X,back:()=>X(-1),forward:()=>X(1),beforeEach:i.add,beforeResolve:l.add,afterEach:o.add,onError:P.add,isReady:H,install(Y){Y.component("RouterLink",nw),Y.component("RouterView",ow),Y.config.globalProperties.$router=ce,Object.defineProperty(Y.config.globalProperties,"$route",{enumerable:!0,get:()=>an(r)}),$a&&!le&&r.value===Hn&&(le=!0,b(a.location).catch(re=>{}));const be={};for(const re in Hn)Object.defineProperty(be,re,{get:()=>r.value[re],enumerable:!0});Y.provide(jo,ce),Y.provide(sd,uc(be)),Y.provide(Qr,r);const j=Y.unmount;ee.add(Y),Y.unmount=function(){ee.delete(Y),ee.size<1&&(c=Hn,M&&M(),M=null,r.value=Hn,le=!1,L=!1),j()}}};function De(Y){return Y.reduce((be,j)=>be.then(()=>y(j)),Promise.resolve())}return ce}function Em(){return $s(jo)}function cw(e){return $s(sd)}const Vo={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=cw(),s=Em(),n=Z({get(){var r;const o=t.query.tab;return o&&e.tabs.some(c=>c.id===o)?o:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(o){s.replace({query:{...t.query,tab:o}})}}),a=Z(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.component)||null}),i=Z(()=>{var o;return((o=e.tabs.find(r=>r.id===n.value))==null?void 0:o.label)||""});us(i,o=>{e.groupLabel&&o&&(document.title=`Odin — ${e.groupLabel} › ${o}`)},{immediate:!0});function l(o,r){if(!["ArrowLeft","ArrowRight","Home","End"].includes(o.key))return;o.preventDefault();let c=r;o.key==="ArrowRight"&&(c=(r+1)%e.tabs.length),o.key==="ArrowLeft"&&(c=(r-1+e.tabs.length)%e.tabs.length),o.key==="Home"&&(c=0),o.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
... (truncated)`:s}function ju(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function id(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function Im(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Om=Symbol("agent-detail-cancelled"),fw=15e3;function hw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((h,m)=>{r=h,c=m});function u(h,m){o||(o=!0,l!==null&&a(l),l=null,(h?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(h){u(!1,h)}return o||Promise.resolve(p).then(h=>u(!0,h),h=>u(!1,h)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const h=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${h}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Om),i==null||i.abort()}}}function Lm({state:e,requestDetail:t,timeoutMs:s=fw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:h,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,h?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const S=hw(R=>t(p,{signal:R}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=S.cancel,v.promise=(async()=>{let R=null,x=null;try{R=await S.promise}catch(g){x=g}R!==Om&&(l!==v||e.detailId!==p||(l=null,!x&&(R===null||typeof R!="object")&&(x=new Error(`${n} response was empty or invalid`)),x?e.detail===null&&(e.detailError=(x==null?void 0:x.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=R,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function mw({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const vw={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(null),a=f(!0),i=f("all");let l=!1;const o=Z(()=>e.value.filter(I=>I.status==="running").length),r=Z(()=>e.value.filter(I=>I.status==="completed").length),c=Z(()=>e.value.filter(I=>["failed","timeout","killed"].includes(I.status)).length),d=Z(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:o.value},{value:"completed",label:"Completed",count:r.value},{value:"failed",label:"Failed",count:c.value}]),u=Z(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(I=>["failed","timeout","killed"].includes(I.status)):e.value.filter(I=>I.status===i.value));function p(I){const H=Number(I.max_iterations)||0;return H<=0?0:Math.min(100,Math.round(I.iteration_count/H*100))}function h(I){return(Number(I.max_iterations)||0)>0}function m(I,H){return I?I==="N/A"?"N/A":H==="current_inheritance"?`inherit (currently ${I})`:I:"unknown"}function v(I){return m(I.display_model,I.display_model_source||I.display_source)}function S(I){return m(I.display_reasoning_effort,I.display_reasoning_effort_source||I.display_source)}function R(I){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[I]||""}const x=f(null),g=f(null),b=f(!1),k=f(null),w=f(""),C=Lm({state:{get detail(){return x.value},set detail(I){x.value=I},get detailId(){return g.value},set detailId(I){g.value=I},get detailLoading(){return b.value},set detailLoading(I){b.value=I},get detailError(){return k.value},set detailError(I){k.value=I}},requestDetail:(I,{signal:H})=>q.get(`/api/agents/${encodeURIComponent(I)}`,{signal:H})});async function y(I){w.value="",await C.open(I.id)}function N(){C.close(),w.value=""}async function U(){await C.refresh()}async function E(I,H){try{await navigator.clipboard.writeText(H||""),w.value=I,setTimeout(()=>{w.value===I&&(w.value="")},1500)}catch{_e.error("Copy failed")}}async function M(I=!1){I=I===!0,I||(t.value=!0);try{const H=await q.get("/api/agents");e.value=Array.isArray(H)?H:[],s.value=null}catch(H){I||(s.value=H.message)}I||(t.value=!1)}async function $(I){const H=e.value.find(G=>G.id===I);if(await Ut({title:"Kill agent",message:`Kill agent "${(H==null?void 0:H.label)||I}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=I;try{await q.del(`/api/agents/${encodeURIComponent(I)}`),_e.success("Agent killed"),await M()}catch(G){_e.error(G.message||"Failed to kill agent")}n.value=null}}const Q=mw({isEnabled:()=>a.value&&l,refreshList:()=>M(!0),hasOpenDetail:()=>!!g.value,refreshDetail:U});function P(){Q.start()}function L(){Q.stop()}return us(a,()=>Q.sync()),Ge(()=>{l=!0,M(),P()}),hs(()=>{l=!0,M(!0),P()}),ns(()=>{l=!1,L()}),gt(()=>{l=!1,L(),C.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:o,completedCount:r,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:Ta,formatDuration:ci,progressPercent:p,hasProgress:h,displayModelText:v,displayEffortText:S,displaySourceLabel:R,detail:x,detailId:g,detailLoading:b,detailError:k,copied:w,openDetail:y,closeDetail:N,copyText:E,fetchAgents:M,killAgent:$,startAutoRefresh:P,stopAutoRefresh:L}}},gw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=f(!1),l=f(null),o=f(null),r=f(null),c=f(null),d=f(null),u=f(!1),p=f(null),h=f("");let m=!1;const S=Lm({state:{get detail(){return c.value},set detail(L){c.value=L},get detailId(){return d.value},set detailId(L){d.value=L},get detailLoading(){return u.value},set detailLoading(L){u.value=L},get detailError(){return p.value},set detailError(L){p.value=L}},detailLabel:"Loop detail",requestDetail:(L,{signal:I})=>q.get(`/api/loops/${encodeURIComponent(L)}?limit=100`,{signal:I})});async function R(L){h.value="",await S.open(L.id)}function x(){S.close(),h.value=""}async function g(L,I){try{await navigator.clipboard.writeText(I||""),h.value=L,setTimeout(()=>{h.value===L&&(h.value="")},1500)}catch{_e.error("Copy failed")}}const b=Z(()=>e.value.reduce((L,I)=>L+(I.iteration_count||0),0)),k=Z(()=>e.value.filter(L=>L.status==="running").length);function w(L){return L==="running"?"loop-status-running":L==="error"?"loop-status-error":"loop-status-stopped"}function A(L){return L==="running"?"badge-success":L==="error"?"badge-danger":L==="completed"?"badge-info":"badge-warning"}function C(L){return L==="act"?"badge-warning":L==="silent"?"badge-info":"badge-success"}async function y(L=!1){L=L===!0,L||(t.value=!0);try{const I=await q.get("/api/loops");e.value=Array.isArray(I)?I:[],s.value=null}catch(I){L||(s.value=I.message)}L||(t.value=!1)}async function N(){l.value=null;const L=a.value;if(!L.goal.trim()){l.value="Goal is required";return}if(!L.channel_id.trim()){l.value="Channel ID is required";return}const I={goal:L.goal.trim(),channel_id:L.channel_id.trim(),interval_seconds:L.interval_seconds||60,mode:L.mode,max_iterations:L.max_iterations||50};L.stop_condition.trim()&&(I.stop_condition=L.stop_condition.trim()),i.value=!0;try{const H=await q.post("/api/loops",I);_e.success(`Loop started: ${H.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await y()}catch(H){l.value=H.message}i.value=!1}async function U(L){if(await Ut({title:"Stop loop",message:`Stop loop ${L}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){o.value=L;try{await q.del(`/api/loops/${encodeURIComponent(L)}`),_e.success("Loop stopped"),await y()}catch(H){_e.error(H.message||"Failed to stop loop")}o.value=null}}async function E(L){r.value=L;try{await q.post(`/api/loops/${encodeURIComponent(L)}/restart`),_e.success("Loop restarted"),await y()}catch(I){_e.error(I.message||"Failed to restart loop")}r.value=null}function M(L){m&&L.payload&&(L.payload.loop_id||L.payload.type==="loop")&&(y(!0),d.value&&S.refresh())}let $=null;function Q(){$!==null&&clearInterval($),$=null}function P(){Q(),m&&($=setInterval(()=>{y(!0),d.value&&S.refresh()},5e3))}return Ge(()=>{m=!0,y(),Ye.subscribe("events",M),P()}),hs(()=>{m=!0,y(!0),P()}),ns(()=>{m=!1,Q()}),gt(()=>{m=!1,Ye.unsubscribe("events",M),Q(),S.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:o,restartingId:r,detail:c,detailId:d,detailLoading:u,detailError:p,copied:h,totalIterations:b,runningCount:k,statusDotClass:w,statusBadge:A,modeBadge:C,formatAge:Am,formatDuration:ci,formatTs:Ta,formatTokens:Im,openDetail:R,closeDetail:x,copyText:g,fetchLoops:y,doCreate:N,doStop:U,doRestart:E}}},bw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(!1),a=f({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=f(!1),l=f(null),o=f(null),r=Z(()=>ww(a.value.run_at));us(()=>a.value.run_at,()=>{o.value=null});const c=Z(()=>{var re;const j=r.value;return j.state==="ok"?j.instant:j.state==="ambiguous"&&o.value!==null&&((re=j.options[o.value])==null?void 0:re.instant)||null}),d=Z(()=>{const j=c.value;return j?`${j.toLocaleString()} local — ${j.toISOString()} UTC`:""}),u=f(null),p=f(!1),h=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=f(null),v=f(null),S=f(null),R=f(null),x=f(null),g=f(null),b=f([]),k=f(!1),w=f("");let A=0;const C=Z(()=>e.value.filter(j=>j.cron&&!j.one_time).length),y=Z(()=>e.value.filter(j=>j.one_time).length),N=Z(()=>e.value.filter(j=>j.trigger).length),U=Z(()=>e.value.filter(j=>j.paused).length),E=Z(()=>e.value.filter(j=>j.consecutive_failures>0).length);function M(j){if(!j)return"-";const re=Date.now(),Le=(new Date(j).getTime()-re)/1e3;if(Le<0)return"overdue";if(Le<60)return"in < 1 min";if(Le<3600)return`in ${Math.floor(Le/60)} min`;if(Le<86400){const D=Math.floor(Le/3600),z=Math.floor(Le%3600/60);return z>0?`in ${D}h ${z}m`:`in ${D}h`}const _=Math.floor(Le/86400);return`in ${_} day${_!==1?"s":""}`}function $(j){return j==null?"-":j<1e3?`${j}ms`:j<6e4?`${(j/1e3).toFixed(1)}s`:ci(j/1e3)}function Q(j=a.value.cron){a.value.cron=j,Vu(a.value,"cron"),u.value=null}function P(j=a.value.run_at){a.value.run_at=j,Vu(a.value,"run_at"),u.value=null}async function L(){const j=a.value.cron.trim();if(j){p.value=!0;try{u.value=await q.post("/api/schedules/validate-cron",{expression:j})}catch(re){u.value={valid:!1,error:re.message}}p.value=!1}}async function I(){t.value=!0,s.value=null;try{e.value=await q.get("/api/schedules")}catch(j){s.value=j.message}t.value=!1}async function H(j){if(g.value===j){g.value=null,b.value=[];return}g.value=j,k.value=!0,b.value=[];const re=++A;try{const ue=await q.get(`/api/schedules/${encodeURIComponent(j)}/history?limit=10`);if(re!==A||g.value!==j)return;b.value=ue,w.value=""}catch(ue){if(re!==A||g.value!==j)return;b.value=[],w.value=ue.message||"Failed to load execution history"}re===A&&(k.value=!1)}async function K(){l.value=null;const j=a.value;if(!j.description.trim()){l.value="Description is required";return}if(!j.channel_id.trim()){l.value="Channel ID is required";return}if(!j.cron.trim()&&!j.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(j.cron.trim()&&j.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const re={description:j.description.trim(),action:j.action,channel_id:j.channel_id.trim()};if(j.cron.trim()&&(re.cron=j.cron.trim()),j.run_at.trim()){const ue=r.value;if(ue.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(ue.state==="invalid"){l.value="One-time run time is not a valid date";return}const Le=c.value;if(ue.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Le){l.value="One-time run time could not be resolved";return}re.run_at=Le.toISOString()}if(j.action==="reminder"&&j.message.trim()&&(re.message=j.message.trim()),j.action==="check"&&(j.tool_name.trim()&&(re.tool_name=j.tool_name.trim()),j.report_format&&(re.report_format=j.report_format),j.tool_input_str.trim()))try{re.tool_input=JSON.parse(j.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await q.post("/api/schedules",re),_e.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await I()}catch(ue){l.value=ue.message}i.value=!1}async function G(j){m.value=j;try{const re=await q.post(`/api/schedules/${encodeURIComponent(j)}/run`);if(re.status==="failure")_e.error(`Execution failed: ${re.error||"unknown error"}`);else{const ue=re.warning?`Executed (${re.warning})`:"Executed successfully";_e.success(ue)}await I()}catch(re){_e.error(re.message||"Failed to trigger")}m.value=null}async function X(j){S.value=j.id;const re=!j.paused;try{await q.put(`/api/schedules/${encodeURIComponent(j.id)}`,{paused:re}),_e.success(re?"Schedule paused":"Schedule resumed"),await I()}catch(ue){_e.error(ue.message||"Failed to update schedule")}S.value=null}const le=new Map;function ee(j,re){const ue=le.get(j.id);ue&&clearTimeout(ue.timer);const Le={run:()=>ce(j,re),timer:null};Le.timer=setTimeout(()=>{le.delete(j.id),Le.run()},500),le.set(j.id,Le)}async function ce(j,re){x.value=j.id;try{await q.put(`/api/schedules/${encodeURIComponent(j.id)}`,{report_format:re}),_e.success(re?"Structured report enabled":"Plain-text report enabled")}catch(ue){_e.error(`Update failed: ${ue.message}`)}finally{await I(),x.value=null}}function De(){for(const[j,re]of[...le])clearTimeout(re.timer),le.delete(j),re.run()}async function Y(j){R.value=j;try{await q.post(`/api/schedules/${encodeURIComponent(j)}/reset-failures`),_e.success("Failure counters reset"),await I()}catch(re){_e.error(re.message||"Failed to reset")}R.value=null}async function be(j){const re=e.value.find(Le=>Le.id===j);if(await Ut({title:"Delete schedule",message:`Delete "${(re==null?void 0:re.description)||j}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=j;try{await q.del(`/api/schedules/${encodeURIComponent(j)}`),_e.success("Schedule deleted"),await I()}catch(Le){_e.error(Le.message||"Failed to delete schedule")}v.value=null}}return Ge(()=>{I()}),gt(De),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:h,runningId:m,deletingId:v,togglingId:S,resettingId:R,reportUpdatingId:x,flushReportFormatTimers:De,expandedId:g,history:b,historyLoading:k,historyError:w,cronCount:C,oneTimeCount:y,webhookCount:N,pausedCount:U,failingCount:E,formatTs:Ta,formatAge:Am,formatFuture:M,formatMs:$,formatDuration:ci,onCronInput:Q,onRunAtInput:P,validateCron:L,toggleExpand:H,fetchSchedules:I,doCreate:K,doRunNow:G,doTogglePause:X,doUpdateReportFormat:ee,doResetFailures:Y,doDelete:be}}},Nm=[{id:"live",label:"Live",component:dw},{id:"agents",label:"Agents",component:vw},{id:"loops",label:"Loops",component:gw},{id:"processes",label:"Processes",component:bw},{id:"schedules",label:"Schedules",component:kw}],Sw={components:{TabbedPage:Vo},setup(){return{tabs:Nm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Tw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(null),a=f(null),i=f(!1);let l=0;const o=f(null),r=f(!1),c=f(new Set),d=f(!1),u=f("all"),p=f(""),h=f("last_active"),m=f(!1),v=qu,S=Cw,R=f([]),x=f(!1),g=f(""),b=f("flat"),k=f(new Set),w=f(""),A=f(""),C=f(""),y=f(null),N=f(!1);function U(){try{const ne=localStorage.getItem("odin-session-presets");ne&&(R.value=JSON.parse(ne))}catch{}}function E(){try{localStorage.setItem("odin-session-presets",JSON.stringify(R.value))}catch{}}const M=Z(()=>p.value.trim()!==""||u.value!=="all"),$=Z(()=>{let ne=[...e.value];const ye=qu.find(He=>He.id===u.value),Ie=ye?ye.filters:{};if(Ie.source&&(ne=ne.filter(He=>He.source===Ie.source)),Ie.minMessages&&(ne=ne.filter(He=>He.message_count>=Ie.minMessages)),Ie.hasCompaction&&(ne=ne.filter(He=>He.has_summary)),Ie.maxAge!=null){const He=Date.now()/1e3;ne=ne.filter(xt=>xt.last_active&&He-xt.last_active<=Ie.maxAge)}if(p.value.trim()){const He=p.value.toLowerCase().trim();ne=ne.filter(xt=>(xt.channel_id||"").toLowerCase().includes(He)||(xt.last_user_id||"").toLowerCase().includes(He)||(xt.source||"").toLowerCase().includes(He))}const Ze=h.value,ft=m.value?1:-1;return ne.sort((He,xt)=>{const ms=He[Ze]||0,Tt=xt[Ze]||0;return(ms-Tt)*ft}),ne}),Q=Z(()=>{if(!a.value||!a.value.messages)return[];const ne=a.value.messages;if(ne.length===0)return[];const ye=[];let Ie=[];for(const Ze of ne)Ze.role==="user"&&Ie.length>0&&(ye.push(Ie),Ie=[]),Ie.push(Ze);return Ie.length>0&&ye.push(Ie),ye}),P=Z(()=>$.value.length>0&&c.value.size===$.value.length);function L(ne){const ye=ne.find(Ie=>Ie.role==="user");if(ye&&ye.content){const Ie=ye.content.slice(0,120);return Ie.length<ye.content.length?Ie+"...":Ie}return"(no user message)"}function I(ne){const ye=new Set(k.value);ye.has(ne)?ye.delete(ne):ye.add(ne),k.value=ye}function H(ne){u.value=ne}function K(ne){u.value=ne.id,ne.filters.searchQuery!=null&&(p.value=ne.filters.searchQuery),ne.filters.sortBy&&(h.value=ne.filters.sortBy)}function G(){if(!g.value.trim())return;const ne={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:h.value}};R.value=[...R.value,ne],E(),x.value=!1,g.value=""}function X(ne){R.value=R.value.filter(ye=>ye.id!==ne),E(),u.value===ne&&(u.value="all")}function le(){u.value="all",p.value="",h.value="last_active",m.value=!1}function ee(ne){if(!ne)return"—";const ye=Date.now()/1e3-ne;if(ye<60)return"just now";if(ye<3600){const Ze=Math.floor(ye/60);return`${Ze} minute${Ze!==1?"s":""} ago`}if(ye<86400){const Ze=Math.floor(ye/3600);return`${Ze} hour${Ze!==1?"s":""} ago`}const Ie=Math.floor(ye/86400);return`${Ie} day${Ie!==1?"s":""} ago`}function ce(ne){if(!ne)return"";try{return new Date(ne*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function De(ne){if(!ne)return"";try{return new Date(ne*1e3).toLocaleString()}catch{return""}}function Y(ne){return ne==="user"?"bg-gray-900/50 border border-gray-800":ne==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function be(ne){return ne==="user"?"sess-msg-user":ne==="assistant"?"sess-msg-assistant":"sess-msg-system"}function j(ne){return ne==="user"?"badge-info":ne==="assistant"?"badge-success":"badge-warning"}function re(ne){return ne==="user"?"sess-dot-user":ne==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ue(ne){return ne==="user"?"text-cyan-400":ne==="assistant"?"text-indigo-400":"text-gray-500"}function Le(ne){return ne?ne.length>2e3?ne.slice(0,2e3)+`
... (truncated)`:ne:""}async function _(){const ne=w.value.trim();if(ne){N.value=!0;try{let ye=`/api/sessions/search?q=${encodeURIComponent(ne)}&limit=50`;A.value.trim()&&(ye+=`&channel_id=${encodeURIComponent(A.value.trim())}`),C.value.trim()&&(ye+=`&user_id=${encodeURIComponent(C.value.trim())}`);const Ie=await q.get(ye);y.value=Ie.results||[]}catch{y.value=[]}N.value=!1}}function D(){w.value="",A.value="",C.value="",y.value=null}function z(ne){return ne?ne.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function ie(ne){return ne==="user"?"fts-result-user":ne==="assistant"?"fts-result-assistant":ne==="summary"?"fts-result-summary":ne==="fts"?"fts-result-fts":ne==="channel"?"fts-result-channel":"fts-result-default"}function se(ne){return ne==="user"?"badge-info":ne==="assistant"?"badge-success":ne==="summary"?"badge-warning":ne==="fts"?"badge-success":"badge-info"}let ae=0;async function pe(){const ne=++ae;t.value=!0,s.value=null;try{const ye=await q.get("/api/sessions");if(ne!==ae)return;e.value=ye}catch(ye){if(ne!==ae)return;s.value=ye.message}ne===ae&&(t.value=!1)}function fe(){s.value=null,pe()}async function de(ne){if(n.value===ne){n.value=null,a.value=null,k.value=new Set;return}n.value=ne,a.value=null,i.value=!0,k.value=new Set;const ye=++l;try{const Ie=await q.get(`/api/sessions/${encodeURIComponent(ne)}`);ye===l&&n.value===ne&&(a.value=Ie)}catch(Ie){ye===l&&n.value===ne&&(a.value={messages:[],summary:"",error:Ie.message||"Failed to load session"})}finally{ye===l&&(i.value=!1)}}function oe(ne){const ye=new Set(c.value);ye.has(ne)?ye.delete(ne):ye.add(ne),c.value=ye}function we(){P.value?c.value=new Set:c.value=new Set($.value.map(ne=>ne.channel_id))}function ge(ne){o.value=ne}async function ke(){if(o.value){r.value=!0;try{await q.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await pe()}catch(ne){s.value=ne.message||"Failed to clear session"}r.value=!1,o.value=null}}function Re(){d.value=!0}async function F(){if(c.value.size!==0){r.value=!0;try{await q.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await pe()}catch(ne){s.value=ne.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function me(ne,ye){const Ie=`/api/sessions/${encodeURIComponent(ne)}/export?format=${ye}`;try{const Ze=await q.getBlob(Ie),ft=URL.createObjectURL(Ze),He=document.createElement("a");He.href=ft,He.download=`session-${ne}.${ye==="text"?"txt":"json"}`,He.click(),URL.revokeObjectURL(ft)}catch(Ze){s.value=Ze.message||"Failed to export session"}}let Se=null;function Oe(ne){ne.payload&&ne.payload.channel_id&&(clearTimeout(Se),Se=setTimeout(()=>{if(pe(),n.value&&ne.payload.channel_id===n.value){const ye=n.value,Ie=l;q.get(`/api/sessions/${encodeURIComponent(ye)}`).then(Ze=>{Ie!==l||n.value!==ye||(a.value=Ze)}).catch(()=>{})}},2e3))}let Pe=!1,dt=null;function ot(){Pe||(Pe=!0,pe(),Ye.subscribe("events",Oe),dt=Ye.onReconnected(()=>pe()))}Ge(()=>{U(),ot()}),hs(()=>{ot()});function Ft(){Pe&&(Pe=!1,Ye.unsubscribe("events",Oe),dt&&(dt(),dt=null),clearTimeout(Se))}return ns(Ft),gt(Ft),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:P,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:h,sortAsc:m,filterPresets:v,sortOptions:S,filteredSessions:$,hasActiveFilters:M,customPresets:R,showSavePreset:x,newPresetName:g,threadView:b,threads:Q,collapsedThreads:k,ftsQuery:w,ftsChannelId:A,ftsUserId:C,ftsResults:y,ftsSearching:N,formatAge:ee,formatTimestamp:ce,formatFullTimestamp:De,messageClass:Y,threadMsgClass:be,roleBadge:j,roleDotClass:re,roleLabelClass:ue,truncateContent:Le,threadSummary:L,fetchSessions:pe,retry:fe,toggleSession:de,toggleSelect:oe,toggleSelectAll:we,confirmClear:ge,clearSession:ke,confirmBulkClear:Re,doBulkClear:F,exportSession:me,applyPreset:H,applyCustomPreset:K,saveCustomPreset:G,removeCustomPreset:X,resetFilters:le,toggleThread:I,runFtsSearch:_,clearFtsSearch:D,highlightSnippet:z,ftsResultClass:ie,ftsTypeBadge:se}}},Aw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:Im}}},Rw={components:{ContextAssemblyPanel:Aw},template:`
    ...
    </div>`,setup(){const e=f([]),t=f([]),s=f(!0),n=f(null),a=f(null),i=f(null),l=f(""),o=f(""),r=f(0),c=f({}),d=f({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function u(A){if(!A)return"—";try{const C=new Date(A);return isNaN(C.getTime())?A:C.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return A}}function p(A){return!A&&A!==0?"—":A<1e3?A+"ms":(A/1e3).toFixed(1)+"s"}function h(A){return!A&&A!==0?"—":A>=1e3?(A/1e3).toFixed(1)+"k":String(A)}function m(A){if(!A)return"";if(typeof A=="string")return A;try{return JSON.stringify(A,null,2)}catch{return String(A)}}function v(A){a.value===A?a.value=null:(a.value=A,c.value={})}function S(A,C){const y=A+"-"+C;c.value={...c.value,[y]:!c.value[y]}}function R(A,C){return!!c.value[A+"-"+C]}function x(){d.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},o.value="",l.value="",i.value=null,k()}async function g(){try{const A=await q.get("/api/trajectories");e.value=A.files||[],r.value=A.count||0}catch{}}let b=0;async function k(){const A=++b;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(o.value){const C=await q.get(`/api/trajectories/${encodeURIComponent(o.value)}?limit=${d.value.limit}`);if(A!==b)return;let y=C.entries||[];d.value.tool_name&&(y=y.filter(N=>(N.tools_used||[]).includes(d.value.tool_name))),d.value.errors_only&&(y=y.filter(N=>N.is_error)),d.value.channel_id&&(y=y.filter(N=>N.channel_id===d.value.channel_id)),d.value.user_id&&(y=y.filter(N=>N.user_id===d.value.user_id)),t.value=y}else{const C=new URLSearchParams;d.value.channel_id&&C.set("channel_id",d.value.channel_id),d.value.user_id&&C.set("user_id",d.value.user_id),d.value.tool_name&&C.set("tool_name",d.value.tool_name),d.value.errors_only&&C.set("errors_only","true"),C.set("limit",String(d.value.limit));const y=C.toString(),N=await q.get(`/api/trajectories/search/query?${y}`);if(A!==b)return;t.value=N.results||[]}}catch(C){if(A!==b)return;n.value=C.message}A===b&&(s.value=!1)}async function w(){if(!l.value.trim())return;const A=++b;s.value=!0,n.value=null,c.value={};try{const C=await q.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(A!==b)return;i.value=C.entry||null,i.value||(n.value="No trace found for this message ID")}catch(C){if(A!==b)return;C.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=C.message}A===b&&(s.value=!1)}return Ge(async()=>{await g(),await k()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:o,totalSaved:r,filters:d,expandedIterations:c,formatTs:u,formatDuration:p,formatTokens:h,formatJSON:m,truncateBlock:Rm,toggleExpand:v,toggleIteration:S,isIterationExpanded:R,clearFilters:x,fetchFiles:g,fetchTraces:k,lookupMessage:w}}};function Iw(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"—":t<1e3?`${Math.round(t)} ms`:t<6e4?`${(t/1e3).toFixed(1)} s`:t<36e5?`${(t/6e4).toFixed(1)} min`:`${(t/36e5).toFixed(1)} h`}function Ow(e){return e?`${e.approximate?"~":""}${id(e.total||0)}`:"0"}const Lw={template:`
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f({available:!0,coverage:{},work:{},activity:[],serving:[],tools:[],automation:[]}),a=f("7d"),i=f(0),l=f(Date.now());let o=null,r=null,c=!1,d=0;const u=[{key:"24h",label:"24 hours"},{key:"7d",label:"7 days"},{key:"30d",label:"30 days"},{key:"all",label:"All time"}],p=Z(()=>n.value.work||{}),h=Z(()=>Math.max(1,...(n.value.activity_over_time||[]).map(w=>Number(w.count||0)))),m=Z(()=>({minWidth:`max(100%, ${(n.value.activity_over_time||[]).length*5}px)`})),v=w=>({height:`${Math.max(4,Math.round(Number(w||0)/h.value*100))}%`}),S=Z(()=>s.value&&l.value-i.value>3e4);async function R(){const w=++d,A=a.value;try{const C=await q.get(`/api/usage?range=${encodeURIComponent(A)}`);if(w!==d||A!==a.value)return;n.value=C,i.value=Date.now(),l.value=i.value,s.value=!0,t.value=null}catch(C){w===d&&(t.value=C.message)}finally{w===d&&(e.value=!1)}}function x(w){a.value=w,e.value=!s.value,R()}function g(){e.value=!0,R()}function b(){c||(c=!0,R(),o=setInterval(R,15e3),r=setInterval(()=>{l.value=Date.now()},1e3))}function k(){c&&(c=!1,d+=1,o&&clearInterval(o),r&&clearInterval(r),o=null,r=null)}return Ge(b),hs(b),ns(k),gt(k),{data:n,work:p,loading:e,error:t,hasData:s,range:a,ranges:u,isStale:S,fmtNum:id,fmtDuration:Iw,tokenLabel:Ow,activityTrackStyle:m,activityBar:v,selectRange:x,retry:g}}},Dm=[{id:"audit",label:"Audit",component:Tw},{id:"sessions",label:"Sessions",component:Ew},{id:"traces",label:"Traces",component:Rw},{id:"usage",label:"Usage & Activity",component:Lw}],Nw={components:{TabbedPage:Vo},setup(){return{tabs:Dm}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},ur=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|apply_patch|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Dw={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f({}),i=f({}),l=f("cards"),o=f(null),r=f(null),c=f(!1),d=f(new Set),u={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function p(y){return y.source!=="builtin"?"":u[y.state]||""}function h(y,N){const U=y&&Array.isArray(y.tools)?y.tools:null;if(c.value=!!U,r.value=U?!!y.global_enabled:null,!U){e.value=N.map($=>({...$,source:"unknown",enabled:void 0,state:null}));return}const E=new Set(U.map($=>$.name)),M=N.filter($=>!E.has($.name)).map($=>({...$,source:$.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...U.map($=>({...$,source:"builtin"})),...M]}async function m(y,N){if(d.value.has(y.name))return;const U=!!N.target.checked,E=new Set(d.value);E.add(y.name),d.value=E;try{const M=await q.post(`/api/tools/builtins/${encodeURIComponent(y.name)}/enabled`,{enabled:U});h(M,e.value),s.value=null;try{const $=await q.get("/api/tools");h(M,$)}catch($){console.warn("Built-in toggle committed; visible catalog refresh failed",$)}}catch(M){N.target.checked=!!y.enabled,s.value=M.message||`Failed to toggle ${y.name}`}finally{const M=new Set(d.value);M.delete(y.name),d.value=M}}const v=Z(()=>e.value.filter(y=>y.source==="builtin"&&y.is_core).length),S=Z(()=>e.value.filter(y=>y.source==="skill").length),R=Z(()=>Object.values(a.value).reduce((y,N)=>y+N,0));function x(y){for(const N of ur)if(N.id!=="other"&&N.match(y))return N.id;return"other"}const g=Z(()=>{let y=e.value;if(n.value){const N=n.value.toLowerCase();y=y.filter(U=>U.name.toLowerCase().includes(N)||(U.description||"").toLowerCase().includes(N))}return o.value&&(y=y.filter(N=>x(N.name)===o.value)),y}),b=Z(()=>{const y=new Set;for(const N of e.value)y.add(x(N.name));return ur.filter(N=>y.has(N.id))}),k=Z(()=>{const y=g.value,N={};for(const E of y){const M=x(E.name);N[M]||(N[M]=[]),N[M].push(E)}const U=[];for(const E of ur)N[E.id]&&N[E.id].length>0&&U.push({label:E.label,icon:E.icon,tools:N[E.id].sort((M,$)=>M.name.localeCompare($.name))});return U});function w(y){i.value={...i.value,[y]:!i.value[y]}}async function A(){t.value=!0,s.value=null;try{const[y,N,U]=await Promise.all([q.get("/api/tools"),q.get("/api/tools/stats").catch(()=>({})),q.get("/api/tools/builtins").catch(()=>null)]);h(U,y),a.value=N||{}}catch(y){s.value=y.message}t.value=!1}function C(){A()}return Ge(()=>{A()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,inventoryAvailable:c,togglePending:d,coreCount:v,skillCount:S,totalUsage:R,filteredTools:g,groupedTools:k,usedCategories:b,stateBadge:p,applyInventory:h,toggleBuiltinTool:m,truncate:ad,toggleExpand:w,refresh:C}}};function Pw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Mw(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function U(ee){return Mw(ee)}function E(ee){n.value={...n.value,[ee]:!n.value[ee]}}async function M(ee){try{await navigator.clipboard.writeText(ee);const ce=e.value.find(De=>De.code===ee);ce&&(o.value=ce.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function $(ee){if(ee.key==="Tab"){ee.preventDefault();const ce=ee.target,De=ce.selectionStart,Y=ce.selectionEnd;u.value=u.value.substring(0,De)+"    "+u.value.substring(Y),Rt(()=>{ce.selectionStart=ce.selectionEnd=De+4})}}function Q(ee){const ce=ee.target.previousElementSibling;ce&&(ce.scrollTop=ee.target.scrollTop)}async function P(){t.value=!0,s.value=null;try{e.value=await q.get("/api/skills")}catch(ee){s.value=ee.message}t.value=!1}async function L(ee){i.value=ee,delete a.value[ee],a.value={...a.value};try{const ce=await q.post(`/api/skills/${encodeURIComponent(ee)}/test`);a.value={...a.value,[ee]:ce}}catch(ce){a.value={...a.value,[ee]:{result:ce.message,is_error:!0}}}i.value=null}function I(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,h.value=null}function H(ee){r.value=!0,c.value="edit",d.value=ee.name,u.value=ee.code||"",p.value=null,h.value=null}function K(){r.value=!1,p.value=null,h.value=null}async function G(){p.value=null,h.value=null;const ee=d.value.trim(),ce=u.value.trim();if(!ee){p.value="Name is required";return}if(!ce){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await q.post("/api/skills",{name:ee,code:ce}),h.value="Skill created successfully"):(await q.put(`/api/skills/${encodeURIComponent(ee)}`,{code:ce}),h.value="Skill updated successfully"),await P(),setTimeout(()=>{r.value=!1},800)}catch(De){p.value=De.message}m.value=!1}function X(ee){S.value=ee}async function le(){if(S.value){R.value=!0;try{await q.del(`/api/skills/${encodeURIComponent(S.value)}`),await P()}catch(ee){_e.error(`Failed to delete skill: ${ee.message||"unknown error"}`)}R.value=!1,S.value=null}}return Ge(()=>{P()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:h,saving:m,editorRef:v,deleteTarget:S,deleting:R,enabledCount:x,totalExecutions:g,totalLines:b,displayedSkills:k,editLineCount:w,editorLineNums:A,editValidation:C,highlight:y,truncate:ad,formatTs:Ta,countLines:N,getLineNumbers:U,toggleCode:E,copyCode:M,handleEditorKey:$,syncScroll:Q,fetchSkills:P,testSkill:L,showCreate:I,editSkill:H,cancelEdit:K,saveSkill:G,confirmDelete:X,doDelete:le}}};class Ps extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const $w=/^[A-Za-z_][A-Za-z0-9_]*$/;function Gu(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Ku(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Ps(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Ps(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Ps(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Ps(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function Bw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Uw(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Ps("Server name is required.","name");if(a.length>128||!$w.test(a))throw new Ps("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Ps("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=Gu(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Ps("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Ps("An HTTP endpoint is required for this connection.","url");if(d&&!Bw(d))throw new Ps("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Ps("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=Gu(e.allowlistText));const r=Ku(e.headerRows,e.headersRemove,"Header"),c=Ku(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function Hw(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function zw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function jw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const Vw=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function qw(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Gw=1e4,Kw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function pr(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function Ww(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Zw={template:`
  ...
  `,setup(){const e=f(null),t=f(!1),s=f(!1),n=f(""),a=f(new Set),i=f(new Set),l=f({}),o=f({}),r=f({}),c=f(new Set),d=f(!1),u=f("add"),p=f(""),h=f(null),m=f(pr()),v=f(""),S=f(!1);let R=null,x=0,g=!1,b=!1;const k=Vw,w=Z(()=>{var F;return((F=e.value)==null?void 0:F.servers)||[]}),A=Z(()=>{var F;return!!((F=e.value)!=null&&F.enabled)}),C=Z(()=>{var F,me,Se,Oe;return{serverCount:((F=e.value)==null?void 0:F.server_count)||0,enabledCount:((me=e.value)==null?void 0:me.enabled_server_count)||0,connectedCount:((Se=e.value)==null?void 0:Se.connected_count)||0,toolCount:((Oe=e.value)==null?void 0:Oe.published_tool_count)||0}}),y=Z(()=>{var F;return((F=h.value)==null?void 0:F.header_keys)||[]}),N=Z(()=>{var F;return((F=h.value)==null?void 0:F.env_keys)||[]}),U=Z(()=>{var F;return u.value==="edit"&&((F=h.value)==null?void 0:F.transport)==="http"}),E=Z(()=>u.value==="add"||!U.value),M=Z(()=>U.value?"Replace endpoint URL":"Endpoint URL"),$=Z(()=>U.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function Q(){P(),R=window.setInterval(()=>L({quiet:!0}),Gw)}function P(){R&&window.clearInterval(R),R=null}async function L({quiet:F=!1}={}){const me=++x;F||(t.value=!0);try{const Se=await q.get("/api/mcp/status");if(me!==x||!g)return;e.value=Se,n.value="";const Oe=new Set((Se.servers||[]).map(Pe=>Pe.name));i.value=new Set([...i.value].filter(Pe=>Oe.has(Pe)))}catch(Se){me===x&&g&&(n.value=Se.message||"Failed to load MCP status")}finally{me===x&&(t.value=!1)}}function I(F){return s.value||a.value.has(F)}function H(F,me){const Se=new Set(a.value);me?Se.add(F):Se.delete(F),a.value=Se}function K(F){return zw(F.state)}function G(F){if(K(F)==="disabled"){if(!F.enabled)return"Disabled — server switch off";if(!A.value)return"Disabled — global MCP is off"}return Kw[K(F)]}function X(F){return F.transport==="http"?"Streamable HTTP":"stdio"}function le(F){return F.negotiated_version?`${F.era?`${String(F.era).charAt(0).toUpperCase()}${String(F.era).slice(1)}`:"Protocol"} · ${F.negotiated_version}`:"Not negotiated"}function ee(F){return F.discovered_count?`${F.published_count||0} published · ${F.excluded_count||0} excluded`:"No tools discovered"}const ce=f(new Set);async function De(F,me){if(ce.value.has(F.name))return;const Se=!!me.target.checked,Oe=new Set(ce.value);Oe.add(F.name),ce.value=Oe;try{const Pe=await q.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/enabled`,{enabled:Se});Pe&&Array.isArray(Pe.servers)?e.value=Pe:await L({quiet:!0})}catch(Pe){me.target.checked=!!F.enabled,_e.error(Pe.message||`Failed to toggle ${F.name}`)}finally{const Pe=new Set(ce.value);Pe.delete(F.name),ce.value=Pe}}async function Y(F){if(F!==A.value&&!(!F&&!await Ut({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await q.post("/api/mcp/enabled",{enabled:F}),_e.success(F?"MCP enabled":"MCP disabled"),await L({quiet:!0})}catch(me){_e.error(me.message||"Failed to update MCP state"),await L({quiet:!0})}finally{s.value=!1}}}async function be(F){H(F.name,!0);try{await q.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/reconnect`,{}),_e.success(`Reconnected ${F.name}`)}catch(me){_e.error(me.message||`Failed to reconnect ${F.name}`)}finally{H(F.name,!1),await L({quiet:!0})}}async function j(F){H(F.name,!0);try{await q.post(`/api/mcp/servers/${encodeURIComponent(F.name)}/refresh-tools`,{}),_e.success(`Refreshed tools from ${F.name}`),await Le(F.name,!0)}catch(me){_e.error(me.message||`Failed to refresh ${F.name}`)}finally{H(F.name,!1),await L({quiet:!0})}}async function re(F){if(await Ut({title:`Remove ${F.name}`,message:`Remove this saved MCP server? Its ${F.published_count||0} published tool${F.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){H(F.name,!0);try{await q.del(`/api/mcp/servers/${encodeURIComponent(F.name)}`),_e.success(`Removed ${F.name}`),delete o.value[F.name]}catch(Se){_e.error(Se.message||`Failed to remove ${F.name}`)}finally{H(F.name,!1),await L({quiet:!0})}}}async function ue(F){const me=new Set(i.value);if(me.has(F.name)){me.delete(F.name),i.value=me;return}me.add(F.name),i.value=me,Object.hasOwn(o.value,F.name)||await Le(F.name)}async function Le(F,me=!1){if(!me&&Object.hasOwn(o.value,F))return;const Se=new Set(c.value);Se.add(F),c.value=Se,r.value={...r.value,[F]:""};try{const Oe=await q.get(`/api/mcp/servers/${encodeURIComponent(F)}/tools`);o.value={...o.value,[F]:Oe.tools||[]}}catch(Oe){r.value={...r.value,[F]:Oe.message||"Failed to load tools"}}finally{const Oe=new Set(c.value);Oe.delete(F),c.value=Oe}}function _(F){return(o.value[F]||[]).filter(me=>jw(me,l.value[F]))}function D(F,me){l.value={...l.value,[F]:me}}function z(){u.value="add",p.value="",h.value=null,m.value=pr(),v.value="",d.value=!0}function ie(F){u.value="edit",p.value=F.name,h.value=F,m.value={...pr(),name:F.name,enabled:!!F.enabled,transport:F.transport||"stdio"},v.value="",d.value=!0}function se(){S.value||(d.value=!1)}function ae(F){d.value&&qw(F)}function pe(F){const me=F==="headers"?"headerRows":"envRows";m.value[me].push({key:"",value:""})}function fe(F,me){const Se=F==="headers"?"headerRows":"envRows";m.value[Se].splice(me,1)}function de(F,me){const Se=F==="headers"?"headersRemove":"envRemove",Oe=m.value[Se];m.value[Se]=Oe.includes(me)?Oe.filter(Pe=>Pe!==me):[...Oe,me]}async function oe(){var me,Se;v.value="";let F;try{F=Uw(m.value,{mode:u.value,originalTransport:((me=h.value)==null?void 0:me.transport)||""})}catch(Oe){v.value=Oe instanceof Ps?Oe.message:"Invalid MCP server configuration",await Rt(),(Se=document.querySelector(".mcp-editor"))==null||Se.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Hw(F,h.value)&&!await Ut({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){S.value=!0;try{u.value==="add"?await q.post("/api/mcp/servers",F):await q.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,F),_e.success(u.value==="add"?`Saved ${F.name}`:`Updated ${p.value}`),d.value=!1,await L({quiet:!0})}catch(Oe){v.value=Oe.message||"Failed to save MCP server"}finally{S.value=!1}}}let we=null;function ge(F){`${(F==null?void 0:F.event)||""} ${(F==null?void 0:F.type)||""} ${(F==null?void 0:F.tool)||""} ${(F==null?void 0:F.message)||""}`.toLowerCase().includes("mcp")&&(we&&window.clearTimeout(we),we=window.setTimeout(()=>L({quiet:!0}),200))}function ke(){g||(g=!0,b||(Ye.subscribe("events",ge),b=!0),L(),Q())}function Re(){g=!1,P(),we&&window.clearTimeout(we),we=null,b&&(Ye.unsubscribe("events",ge),b=!1)}return Ge(ke),hs(ke),ns(Re),gt(Re),{status:e,loading:t,mutating:s,pageError:n,servers:w,masterEnabled:A,aggregate:C,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:h,form:m,formError:v,saving:S,editorGroups:k,configuredHeaderKeys:y,configuredEnvKeys:N,savedHttpEndpoint:U,endpointRequired:E,endpointFieldLabel:M,endpointPlaceholder:$,refreshAll:L,busy:I,serverState:K,stateLabel:G,transportLabel:X,protocolLabel:le,toolSummary:ee,formatAge:Ww,setMasterEnabled:Y,togglePending:ce,toggleServerEnabled:De,reconnect:be,refreshTools:j,removeServer:re,toggleTools:ue,filteredTools:_,setToolQuery:D,openAdd:z,openEdit:ie,closeEditor:se,jumpToEditorGroup:ae,addSecretRow:pe,removeSecretRow:fe,toggleSecretRemoval:de,saveServer:oe}}};function Jw(e,t){if(!e||!t)return ju(e);const s=ju(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f(!0),s=f(null),n=f(""),a=f(null),i=f(!1),l=f(""),o=f(null),r=f(!1),c=f(""),d=f(""),u=f(null),p=f(null),h=f(!1),m=f(null),v=f(null);let S=null;const R=f(null),x=f(!1),g=f({}),b=f({}),k=f({}),w=f({}),A=new Map,C=f(null),y=Z(()=>e.value.reduce((G,X)=>G+(X.chunks||0),0)),N=Z(()=>new Set(e.value.map(X=>X.uploader).filter(Boolean)).size);function U(G,X){const le=b.value[X];if(!le||le.length===0)return 0;const ee=Math.max(...le.map(ce=>ce.char_count||0));return ee===0?0:Math.round(G.char_count/ee*100)}async function E(){t.value=!0,s.value=null;try{const G=await q.get("/api/knowledge");e.value=Array.isArray(G)?G:[]}catch(G){s.value=G.message}t.value=!1}async function M(G){if(g.value[G]){g.value[G]=!1,C.value=null;return}if(g.value[G]=!0,Object.prototype.hasOwnProperty.call(b.value,G))return;if(A.has(G))return A.get(G);const X={...w.value,[G]:!0};w.value=X;const le={...k.value};delete le[G],k.value=le;const ee=q.get(`/api/knowledge/${encodeURIComponent(G)}/chunks`).then(ce=>{b.value={...b.value,[G]:Array.isArray(ce)?ce:[]}}).catch(ce=>{k.value={...k.value,[G]:ce.message||"load failed"}}).finally(()=>{if(A.get(G)!==ee)return;A.delete(G);const ce={...w.value};delete ce[G],w.value=ce});return A.set(G,ee),ee}let $=0;async function Q(){const G=n.value.trim();if(!G)return;const X=++$;i.value=!0,o.value=null,l.value=G;try{const le=await q.get(`/api/knowledge/search?q=${encodeURIComponent(G)}`);if(X!==$)return;a.value=Array.isArray(le)?le:[]}catch(le){if(X!==$)return;a.value=[],o.value=le.message||"Search failed"}X===$&&(i.value=!1)}function P(){$+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function L(){u.value=null,p.value=null;const G=c.value.trim(),X=d.value.trim();if(!G){u.value="Source name is required";return}if(!X){u.value="Content is required";return}h.value=!0;try{const le=await q.post("/api/knowledge",{source:G,content:X});p.value=`Ingested ${le.chunks||0} chunks from "${G}"`,c.value="",d.value="",b.value={},await E(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(le){u.value=le.message}h.value=!1}async function I(G){m.value=G,v.value=null,S&&(clearTimeout(S),S=null);try{const X=await q.post(`/api/knowledge/${encodeURIComponent(G)}/reingest`);v.value={source:G,error:!1,message:`Re-ingested ${X.chunks||0} chunks`},delete b.value[G],await E(),S=setTimeout(()=>{v.value=null,S=null},3e3)}catch(X){v.value={source:G,error:!0,message:X.message}}m.value=null}function H(G){R.value=G}async function K(){if(R.value){x.value=!0;try{await q.del(`/api/knowledge/${encodeURIComponent(R.value)}`),delete b.value[R.value],await E()}catch(G){_e.error(`Failed to delete source: ${G.message||"unknown error"}`)}x.value=!1,R.value=null}}return Ge(()=>{E()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:h,reingesting:m,reingestResult:v,deleteTarget:R,deleting:x,expanded:g,sourceChunks:b,chunkErrors:k,loadingChunks:w,selectedChunk:C,totalChunks:y,uploaderCount:N,truncate:ad,formatTs:Ta,highlightTerms:Jw,chunkBarWidth:U,fetchSources:E,toggleSource:M,doSearch:Q,clearSearch:P,doIngest:L,doReingest:I,confirmDelete:H,doDelete:K}}},Qw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=f([]),t=f({}),s=f(!0),n=f(null),a=f({}),i=f(null),l=f(""),o=f(!1),r=f({scope:"global",key:"",value:""}),c=f(!1),d=f(null),u=f(null),p=f(null),h=f(""),m=f(!1),v=f(null),S=f(null),R=f(new Set),x=f(null),g=f(!1),b=f(!1),k=Z(()=>e.value.reduce((X,le)=>X+le.count,0)),w=Z(()=>R.value.size);function A(X){const le=t.value[X];if(!le)return[];if(!l.value.trim())return le;const ee=l.value.trim().toLowerCase();return le.filter(ce=>ce.key.toLowerCase().includes(ee)||ce.value&&ce.value.toLowerCase().includes(ee))}function C(X,le){return R.value.has(X+"/"+le)}function y(X,le){const ee=X+"/"+le,ce=new Set(R.value);ce.has(ee)?ce.delete(ee):ce.add(ee),R.value=ce}function N(X){const le=t.value[X];return!le||le.length===0?!1:le.every(ee=>R.value.has(X+"/"+ee.key))}function U(X,le){const ee=t.value[X];if(!ee)return;const ce=new Set(R.value);for(const De of ee){const Y=X+"/"+De.key;le?ce.add(Y):ce.delete(Y)}R.value=ce}async function E(){s.value=!0,n.value=null;try{const X=await q.get("/api/memory");e.value=Object.entries(X).map(([le,ee])=>({name:le,keys:ee.keys||[],count:ee.count||0}))}catch(X){n.value=X.message}s.value=!1}async function M(X){if(a.value[X]){a.value[X]=!1;return}a.value[X]=!0;const le=e.value.find(ce=>ce.name===X);if(!le||t.value[X]||i.value===X)return;i.value=X;let ee;try{const De=(await q.get(`/api/memory/${encodeURIComponent(X)}`)).entries||{};ee=le.keys.map(Y=>Object.prototype.hasOwnProperty.call(De,Y)?{key:Y,value:De[Y]||"",failed:!1}:{key:Y,value:"",failed:!0,error:"Not found in scope"})}catch(ce){ee=le.keys.map(De=>({key:De,value:"",failed:!0,error:ce.message||"Failed to load"}))}t.value[X]=ee,i.value=null}function $(X,le,ee){p.value=X+"/"+le,h.value=ee}async function Q(X,le){m.value=!0,v.value=null;try{await q.put(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(le)}`,{value:h.value});const ee=t.value[X];if(ee){const ce=ee.find(De=>De.key===le);ce&&(ce.value=h.value)}p.value=null}catch(ee){v.value=`Failed to save: ${ee.message||"unknown error"}`}m.value=!1}async function P(X,le){try{await navigator.clipboard.writeText(le.value),S.value=X+"/"+le.key,setTimeout(()=>{S.value=null},1500)}catch{}}async function L(){d.value=null,u.value=null;const X=r.value.scope.trim(),le=r.value.key.trim(),ee=r.value.value.trim();if(!X){d.value="Scope is required";return}if(!le){d.value="Key is required";return}if(!ee){d.value="Value is required";return}c.value=!0;try{await q.put(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(le)}`,{value:ee}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await E(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ce){d.value=ce.message}c.value=!1}function I(X,le){x.value={scope:X,key:le}}async function H(){if(!x.value)return;g.value=!0,v.value=null;const{scope:X,key:le}=x.value;try{await q.del(`/api/memory/${encodeURIComponent(X)}/${encodeURIComponent(le)}`);const ee=t.value[X];ee&&(t.value[X]=ee.filter(Y=>Y.key!==le));const ce=e.value.find(Y=>Y.name===X);ce&&(ce.count--,ce.keys=ce.keys.filter(Y=>Y!==le));const De=new Set(R.value);De.delete(X+"/"+le),R.value=De}catch(ee){v.value=`Failed to delete: ${ee.message||"unknown error"}`}g.value=!1,x.value=null}function K(){b.value=!0}async function G(){g.value=!0,v.value=null;const X=[];for(const le of R.value){const ee=le.indexOf("/");X.push({scope:le.slice(0,ee),key:le.slice(ee+1)})}try{await q.post("/api/memory/bulk-delete",{entries:X}),R.value=new Set,t.value={},await E()}catch(le){v.value=`Bulk delete failed: ${le.message||"unknown error"}`}g.value=!1,b.value=!1}return Ge(()=>{E()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:h,saving:m,actionError:v,copied:S,selected:R,selectedCount:w,totalEntries:k,deleteTarget:x,deleting:g,showBulkDelete:b,fetchMemory:E,toggleScope:M,startEdit:$,doEdit:Q,copyValue:P,doAdd:L,confirmDelete:I,doDelete:H,confirmBulkDelete:K,doBulkDelete:G,isSelected:C,toggleSelect:y,isScopeAllSelected:N,toggleSelectAll:U,filteredEntries:A}}},Xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f(!1),a=f("sessions"),i=f(null);let l=null;const o=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=Z(()=>{if(!i.value||!i.value.collected_at)return"";try{return new Date(i.value.collected_at).toLocaleTimeString()}catch{return""}}),c=Z(()=>{if(!i.value)return[];const S=i.value,R=S.storage_total_bytes||1;return[{label:"Session Persistence",mb:S.sessions.persist_dir.total_mb,bytes:S.sessions.persist_dir.total_bytes,files:S.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(S.sessions.persist_dir.total_bytes/R*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:S.knowledge.db_file.total_mb,bytes:S.knowledge.db_file.total_bytes,files:S.knowledge.db_file.file_count,pct:Math.min(100,Math.round(S.knowledge.db_file.total_bytes/R*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:S.trajectories.message_dir.total_mb,bytes:S.trajectories.message_dir.total_bytes,files:S.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(S.trajectories.message_dir.total_bytes/R*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:S.trajectories.agent_dir.total_mb,bytes:S.trajectories.agent_dir.total_bytes,files:S.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(S.trajectories.agent_dir.total_bytes/R*100)),color:"res-bar-amber"}]});async function d(){try{const S=await q.get("/api/resource-usage");i.value=S,t.value=null,s.value=!0}catch(S){t.value=S.message||"Failed to load resource usage"}finally{e.value=!1,n.value=!1}}async function u(){n.value=!0,await d()}function p(){e.value=!0,t.value=null,d()}let h=!1;function m(){h||(h=!0,d(),l||(l=setInterval(d,3e4)))}function v(){h&&(h=!1,l&&(clearInterval(l),l=null))}return Ge(m),hs(m),ns(v),gt(v),{hasData:s,loading:e,error:t,refreshing:n,data:i,activeTab:a,tabs:o,collectedAt:r,storageItems:c,fmtNum:id,refresh:u,retry:p}}},lk=["INFO","WARNING","ERROR"],ok=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],fr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],rk=[50,100,200,500],ck={template:`
    ...
    </div>`,setup(){const e=f("live"),t=f([]),s=f(!1),n=f(!0),a=f(""),i=f(""),l=f(!1),o=f(!1),r=f(Ye.state||"disconnected"),c=Z(()=>{switch(r.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),d=f(null),u=f(!1),p=f(null),h=2e3,m=lk,v=ok,S=fr,R=f("all"),x=f(""),g=f([]),b=f(!1),k=f(""),w=f([]);function A(){try{const W=localStorage.getItem("odin-log-presets");W&&(g.value=JSON.parse(W))}catch{}}function C(){try{localStorage.setItem("odin-log-presets",JSON.stringify(g.value))}catch{}}const y=Z(()=>a.value!==""||i.value.trim()!==""||x.value!==""),N=Z(()=>{const W=fr.find(he=>he.value===x.value);return W?W.label:""}),U=Z(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(W){return W.message}}),E=24,M=Z(()=>{if(K.value.length===0)return[];const W=[],he=new Date,Ne=3600*1e3;for(let Ve=E-1;Ve>=0;Ve--){const et=new Date(he.getTime()-(Ve+1)*Ne),Nt=new Date(he.getTime()-Ve*Ne);W.push({start:et,end:Nt,label:L(et,Nt),shortLabel:Nt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Ve of K.value){if(!Ve._time)continue;const et=Ve._time.getTime();for(const Nt of W)if(et>=Nt.start.getTime()&&et<Nt.end.getTime()){Nt.total++,Ve.level==="ERROR"?Nt.errors++:Ve.level==="WARNING"?Nt.warnings++:Nt.info++;break}}return W}),$=Z(()=>{let W=1;for(const he of M.value)he.total>W&&(W=he.total);return W}),Q=Z(()=>{if(M.value.length===0)return"";const W=K.value.map(Ve=>Ve._time&&Ve._time.getTime()).filter(Boolean);if(W.length===0)return"";const he=new Date(Math.min(...W));return`${K.value.length} shown, oldest ${he.toLocaleTimeString()}`}),P=Z(()=>Math.ceil(E/8));function L(W,he){const Ne={hour:"2-digit",minute:"2-digit"};return W.toLocaleTimeString([],Ne)+" - "+he.toLocaleTimeString([],Ne)}function I(W,he){return!he||!W?"0px":Math.max(2,W/he*100)+"%"}function H(W){const he=K.value.findIndex(Ne=>Ne._time&&Ne._time.getTime()>=W.start.getTime()&&Ne._time.getTime()<W.end.getTime());if(he>=0&&d.value){const Ne=d.value.querySelectorAll(".log-line");Ne[he]&&(Ne[he].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const K=Z(()=>{let W=t.value;if(a.value&&(W=W.filter(he=>(he.level||"INFO")===a.value)),x.value){const he=fr.find(Ne=>Ne.value===x.value);if(he&&he.seconds){const Ne=new Date(Date.now()-he.seconds*1e3);W=W.filter(Ve=>Ve._time&&Ve._time>=Ne)}}if(i.value&&!U.value)if(l.value)try{const he=new RegExp(i.value,"i");W=W.filter(Ne=>{const Ve=Ne.text||Ne.raw||"",et=Ne.tool||"";return he.test(Ve)||he.test(et)})}catch{}else{const he=i.value.toLowerCase();W=W.filter(Ne=>{const Ve=(Ne.text||Ne.raw||"").toLowerCase(),et=(Ne.tool||"").toLowerCase();return Ve.includes(he)||et.includes(he)})}return W});function G(W){if(W.type==="log"&&W.line)try{const he=typeof W.line=="string"?JSON.parse(W.line):W.line,Ne=he.timestamp?new Date(he.timestamp):new Date;return{ts:Ne.toLocaleTimeString(),_time:Ne,level:he.error?"ERROR":"INFO",text:he.tool_name?`[${he.tool_name}] ${he.result_summary||""}`.trim():he.message||JSON.stringify(he),tool:he.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(W.line),tool:"",raw:String(W.line)}}if(W.payload){const he=W.payload,Ne=he.timestamp?new Date(he.timestamp):new Date;return{ts:Ne.toLocaleTimeString(),_time:Ne,level:he.error?"ERROR":"INFO",text:he.tool_name?`[${he.tool_name}] ${he.result_summary||""}`.trim():he.message||JSON.stringify(he),tool:he.tool_name||"",raw:null}}return typeof W=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:W,tool:"",raw:W}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(W),tool:"",raw:null}}function X(W){const he=G(W);if(s.value){w.value.push(he);return}le(he)}function le(W){t.value.push(W),t.value.length>h&&(t.value=t.value.slice(-h)),n.value&&Rt(()=>ee())}function ee(W=!1){const he=d.value;he&&he.scrollTo({top:he.scrollHeight,behavior:W?"smooth":"instant"})}function ce(){n.value=!0,u.value=!1,Rt(()=>ee(!0))}const De=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function Y(){const W=d.value;if(!W)return;const he=W.scrollHeight-W.scrollTop-W.clientHeight<40;u.value=!n.value&&!he&&t.value.length>0,ue.value&&be()}function be(){const W=d.value;!W||!n.value||W.scrollHeight-W.scrollTop-W.clientHeight>=40&&(n.value=!1,u.value=t.value.length>0)}function j(){n.value&&requestAnimationFrame(be)}function re(W){De.has(W.key)&&j()}const ue=f(!1);function Le(){n.value&&(ue.value=!0,requestAnimationFrame(be))}function _(){ue.value&&(ue.value=!1,be())}function D(){n.value&&(u.value=!1,Rt(()=>ee()))}function z(){if(s.value=!s.value,!s.value&&w.value.length>0){for(const W of w.value)le(W);w.value=[]}}function ie(){t.value=[],w.value=[],u.value=!1}function se(){let W;e.value==="search"?W=Ze.value.map(et=>{const Nt=et.error?"ERROR":"INFO",ea=et.tool_name?`[${et.tool_name}] `:"";return`${et.timestamp||""} ${Nt} ${ea}${et.result_summary||et.message||""}`}).join(`
`):W=K.value.map(et=>`${et.ts} ${et.level} ${et.text}`).join(`
`);const he=new Blob([W],{type:"text/plain"}),Ne=URL.createObjectURL(he),Ve=document.createElement("a");Ve.href=Ne,Ve.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Ve.click(),URL.revokeObjectURL(Ne)}function ae(W,he){const Ne=`${W.ts} ${W.level} ${W.text||W.raw||""}`;navigator.clipboard.writeText(Ne).then(()=>{p.value=he,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function pe(W){a.value=a.value===W?"":W,R.value="all"}function fe(W){return W.level==="ERROR"?"log-line-error":W.level==="WARNING"?"log-line-warning":"text-gray-300"}function de(W){return W==="ERROR"?"text-red-500 font-semibold":W==="WARNING"?"text-yellow-500":"text-blue-500"}function oe(W){return W==="ERROR"?"log-chip-error":W==="WARNING"?"log-chip-warning":"log-chip-info"}function we(W){R.value=W.id;const he=W.filters;a.value=he.level||"",x.value=he.timeRange||"",i.value=he.text||"",he.levels&&(a.value=he.levels[0]||""),he.hasToolName&&(i.value="")}function ge(W){R.value=W.id,a.value=W.filters.level||"",x.value=W.filters.timeRange||"",i.value=W.filters.text||""}function ke(){if(!k.value.trim())return;const W={id:"custom-"+Date.now(),name:k.value.trim(),filters:{level:a.value,timeRange:x.value,text:i.value}};g.value=[...g.value,W],C(),b.value=!1,k.value=""}function Re(W){g.value=g.value.filter(he=>he.id!==W),C(),R.value===W&&(R.value="all")}const F=f("all"),me=f(""),Se=f(""),Oe=f(""),Pe=f(""),dt=f(""),ot=f(100),Ft=rk,ne=f(!1),ye=f(!1),Ie=f(""),Ze=f([]),ft=f(null),He=f(null);function xt(){e.value="search",ft.value||ms()}async function ms(){try{ft.value=await q.get("/api/logs/stats")}catch{}}function Tt(){const W=dt.value;if(!W){Oe.value="",Pe.value="";return}const Ne={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[W];if(Ne){const Ve=new Date(Date.now()-Ne*1e3);Oe.value=Ws(Ve),Pe.value=""}}function Ws(W){const he=Ne=>String(Ne).padStart(2,"0");return`${W.getFullYear()}-${he(W.getMonth()+1)}-${he(W.getDate())}T${he(W.getHours())}:${he(W.getMinutes())}`}function Ht(W){if(!W)return"";const he=new Date(W);return isNaN(he.getTime())?"":he.toISOString()}async function ks(){ne.value=!0,Ie.value="",ye.value=!0,He.value=null;try{const W=new URLSearchParams;F.value&&F.value!=="all"&&W.set("level",F.value),me.value&&W.set("tool",me.value),Se.value&&W.set("q",Se.value);const he=Ht(Oe.value),Ne=Ht(Pe.value);he&&W.set("start",he),Ne&&W.set("end",Ne),W.set("limit",String(ot.value));const Ve=await q.get(`/api/logs/search?${W.toString()}`);Ze.value=Ve.entries||[]}catch(W){Ie.value=W.message||"Search failed",Ze.value=[]}finally{ne.value=!1}}function rn(){F.value="all",me.value="",Se.value="",Oe.value="",Pe.value="",dt.value="",ot.value=100,Ze.value=[],ye.value=!1,Ie.value="",He.value=null}function Ss(W){He.value=He.value===W?null:W}function Xn(W){if(!W.timestamp)return"";try{return new Date(W.timestamp).toLocaleString()}catch{return W.timestamp}}function Zs(W){return W.type==="web_action"?`${W.status||""} (${W.execution_time_ms||0}ms)`:(W.result_summary||"").slice(0,200)}function Ls(W){return W.error?"log-line-error":"text-gray-300"}function Pn(W){try{return JSON.stringify(W,null,2)}catch{return String(W)}}let Kt=null,Hs=!1;function as(){Hs||(Hs=!0,Ye.subscribe("logs",X),o.value=Ye.connected,r.value=Ye.state||"disconnected",Kt=Ye.onState(W=>{r.value=W,o.value=W==="connected"}))}function nt(){Hs&&(Hs=!1,Ye.unsubscribe("logs",X),Kt&&(Kt(),Kt=null))}return Ge(()=>{A(),window.addEventListener("pointerup",_),window.addEventListener("pointercancel",_)}),hs(as),ns(nt),gt(()=>{nt(),window.removeEventListener("pointerup",_),window.removeEventListener("pointercancel",_)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:o,wsState:r,wsStateLabel:c,logContainer:d,filteredLogs:K,pauseBuffer:w,showJumpBottom:u,copiedIndex:p,regexError:U,levels:m,logPresets:v,timeRanges:S,timeRange:x,activeLogPreset:R,customLogPresets:g,showSaveLogPreset:b,newLogPresetName:k,hasActiveLogFilters:y,timeRangeLabel:N,timelineBuckets:M,timelineMax:$,timelineSpanLabel:Q,timelineLabelSkip:P,togglePause:z,clearLogs:ie,exportLogs:se,logLineClass:fe,levelClass:de,levelChipClass:oe,toggleLevel:pe,copyLine:ae,jumpToBottom:ce,onScroll:Y,onUserScrollIntent:j,onUserScrollKey:re,onAutoScrollToggle:D,onPointerDown:Le,applyLogPreset:we,applyCustomLogPreset:ge,saveLogCustomPreset:ke,removeLogCustomPreset:Re,segmentHeight:I,jumpToTimelineBucket:H,searchLevel:F,searchTool:me,searchKeyword:Se,searchStart:Oe,searchEnd:Pe,searchTimePreset:dt,searchLimit:ot,searchLimits:Ft,searching:ne,searchRan:ye,searchError:Ie,searchResults:Ze,searchStats:ft,expandedSearch:He,switchToSearch:xt,runSearch:ks,clearSearchFilters:rn,toggleSearchExpand:Ss,formatSearchTs:Xn,searchEntryText:Zs,searchLogLineClass:Ls,formatJson:Pn,applySearchTimePreset:Tt}}};function Rl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const dk=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function uk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Ya=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],pk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},hr=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),fk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Wu(e){return fk.some(t=>e===t||e.startsWith(`${t}.`))}const Mm="odin_config_center_expanded_v1",Fm="odin_config_center_category_v1",hk=50,mk=650,mr=()=>q.get("/api/config/meta");function oa(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function $i(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Na(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function vk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function gk(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function $m(e,t){if($i(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return oa(t);const n={};for(const[a,i]of Object.entries(t)){const l=$m(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function bk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=$m(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Bm(e,t,s,n){if($i(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Bm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function yk(){try{const e=JSON.parse(localStorage.getItem(Mm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function xk(){try{const e=localStorage.getItem(Fm);return Ya.some(t=>t.key===e)?e:Ya[0].key}catch{return Ya[0].key}}const _k={template:`
  ...
  `,setup(){const e=f(null),t=f(null),s=f(!0),n=f(null),a=f(!1),i=f(null),l=f(null),o=f(null),r=f(!1),c=f(!1),d=f(null),u=f(""),p=f("all"),h=f(xk()),m=f(yk()),v=f({}),S=f({}),R=f(""),x=f({}),g=f({}),b=f([]),k=f([]),w=f(!1),A=f(!1),C=f(!1);let y=null,N=null,U={path:null,at:0},E=0;const M=Z(()=>{var T;return(((T=t.value)==null?void 0:T.fields)||[]).filter(B=>!hr.has(B.path.split(".")[0])&&!Wu(B.path))}),$=Z(()=>new Map(M.value.map(T=>[T.path,T]))),Q=Z(()=>K.value.reduce((T,B)=>T+B.sections.length,0)),P=Z(()=>M.value.length),L=Z(()=>dk),I=Z(()=>b.value.length>0),H=Z(()=>k.value.length>0),K=Z(()=>{if(!e.value)return[];const T=new Set(Ya.flatMap(Ee=>Ee.sections)),B=Ya.map(Ee=>({...Ee,sections:Ee.sections.filter(rt=>Object.hasOwn(e.value,rt)&&!hr.has(rt))})).filter(Ee=>Ee.sections.length),J=Object.keys(e.value).filter(Ee=>!T.has(Ee)&&!hr.has(Ee));return J.length&&B.push({key:"other",label:"Other",icon:"folder",sections:J}),B}),G=Z(()=>e.value?{...e.value,...v.value}:null),X=Z(()=>{if(!e.value)return[];const T=[];for(const[B,J]of Object.entries(v.value))Bm(e.value[B],J,B,T);return T.filter(B=>!$i(B.oldVal,B.newVal)).map(B=>{const J=D(B.path);return{...B,label:(J==null?void 0:J.label)||Na(B.path.split(".").at(-1)),apply_mode:(J==null?void 0:J.apply_mode)||de(B.path.split(".")[0])}})}),le=Z(()=>X.value.length>0),ee=Z(()=>X.value.length),ce=Z(()=>new Set(X.value.map(T=>T.path.split(".")[0])).size),De=Z(()=>!!u.value||p.value!=="all"),Y=Z(()=>{const T={...g.value};for(const B of X.value){const J=D(B.path),Ee=fi(J,B.newVal);Ee&&(T[B.path]=Ee)}return T}),be=Z(()=>Object.keys(Y.value).length>0),j=Z(()=>e.value?(De.value?K.value:K.value.filter(B=>B.key===h.value)).map(B=>({...B,sections:B.sections.filter(J=>Ie(J))})).filter(B=>B.sections.length):[]),re=Z(()=>{const T=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],B=new Map(T.map(J=>[J,[]]));for(const J of X.value){const Ee=B.has(J.apply_mode)?J.apply_mode:"restart";B.get(Ee).push(J)}return T.filter(J=>B.get(J).length).map(J=>({key:J,label:Wt(J),entries:B.get(J)}))}),ue=Z(()=>X.value.filter(T=>T.apply_mode==="restart").length),Le=Z(()=>M.value.filter(T=>T.pending_restart)),_=Z(()=>Le.value.length);function D(T){const B=$.value.get(T);return B?{...B,apply_details:Rl([B])}:null}function z(T){const B=`${T}.`;return M.value.filter(J=>J.path===T||J.path.startsWith(B))}function ie(){return M.value.some(T=>T.path==="tools.hosts"||T.path.startsWith("tools.hosts."))}function se(){var J,Ee;const T=((Ee=(J=e.value)==null?void 0:J.tools)==null?void 0:Ee.hosts)||{},B=Object.keys(T).length;return`${B} host${B===1?"":"s"} configured.`}function ae(T){return z(T).length}function pe(T){return Na(T)}function fe(T){const B=z(T);if(!B.length)return`${Na(T)} configuration.`;const J=B.find(Ts=>Ts.sensitivity==="public"&&Ts.description)||B.find(Ts=>Ts.description),Ee=(J==null?void 0:J.description)||"";return Ee.match(/setting for (.+)\.$/i)?`${Na(T)} settings and runtime behaviour.`:Ee}function de(T){const B=[...new Set(z(T).map(J=>J.apply_mode))];return B.length===1?B[0]:B.includes("restart")?"restart":B.includes("activation_required")?"activation_required":B[0]||"restart"}function oe(T){const B=[...new Set(z(T).map(J=>Wt(J.apply_mode)))];return B.length?B.length===1?B[0]:`Mixed apply behaviour: ${B.join(" · ")}`:""}function we(T){return Rl(z(T))}function ge(T){var B;return Object.hasOwn(v.value,T)?v.value[T]:(B=e.value)==null?void 0:B[T]}function ke(){const T=ge("mcp")||{},B=Object.keys(T.servers||{}).length;return`${T.enabled?"Globally enabled":"Globally disabled"} · ${B} configured server${B===1?"":"s"}.`}function Re(T,B){return B.split(".").reduce((J,Ee)=>J==null?void 0:J[Ee],T)}function F(T){const B=G.value;return z(T).filter(J=>Wu(J.path)?!1:J.path.split(".").length<=2?!0:!J.path.includes(".*")).map(J=>({...J,key:J.path.split(".").at(-1),value:Re(B,J.path),apply_details:Rl([J]),editor:J.path==="agents.final_warning_iterations"?"warning-chips":null}))}function me(T){const B=T.path.split(".");return B.length>2?B.slice(0,2).join("."):null}function Se(T){const B=new Map;for(const J of F(T)){const Ee=me(J),rt=Ee||`${T}.__root`;B.has(rt)||B.set(rt,{key:rt,path:Ee,entries:[]}),B.get(rt).entries.push(J)}return[...B.values()].map(J=>{const Ee=J.entries.find(rt=>rt.group_description);return{...J,label:J.path?Na(J.path.split(".").at(-1)):null,description:(Ee==null?void 0:Ee.group_description)||null,apply_details:Rl(J.entries),runtime_summaries:Pe(J.entries)}})}function Oe(T){return{save:T.save_effect||(T.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:T.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[T.apply_mode]||"Effective runtime state is not currently observable."}}function Pe(T){const B=new Map;for(const J of T){const Ee=Oe(J),rt=`${J.apply_mode}|${Ee.save}|${Ee.runtime}`;B.has(rt)||B.set(rt,{key:rt,label:Wt(J.apply_mode),save:Ee.save,runtime:Ee.runtime})}return[...B.values()]}function dt(T){if(ot(T))return T.runtime_effect||T.activation_policy||"";if(T.apply_mode==="activation_required"){const B=T.activation_policy||T.runtime_effect;return B?`Not active after saving. No activation control exists in this release. ${B}`:"Not active after saving; no activation control exists in this release."}return""}function ot(T){return T.action_available===!0&&!!(T.action_label&&T.action_endpoint)}async function Ft(T){if(ot(T))try{if(ms(T.path))throw new Error("Save this setting before applying its action.");const B=String(T.action_method||"POST").toLowerCase(),J={post:q.post.bind(q),put:q.put.bind(q),delete:q.del.bind(q)}[B];if(!J)throw new Error("Unsupported configuration action");await J(T.action_endpoint,T.action_body||void 0),await Me(),Zt("success",`${T.action_label} completed.`)}catch(B){Zt("error",B.message||`${T.action_label} failed`)}}function ne(T,B){return[T.label,T.path,T.description,...T.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(B)}function ye(T){const B=u.value.trim().toLowerCase();return B?z(T).filter(J=>ne(J,B)):[]}function Ie(T){const B=z(T);if(p.value!=="all"&&!B.some(Ee=>Ee.apply_state===p.value))return!1;const J=u.value.trim().toLowerCase();return!J||`${pe(T)} ${T}`.toLowerCase().includes(J)?!0:B.some(Ee=>ne(Ee,J))}function Ze(T,B){return z(T).filter(J=>J.apply_state===B).length}function ft(T){return T==="all"?P.value:M.value.filter(B=>B.apply_state===T).length}function He(T){const B=T.sections.flatMap(J=>z(J));return{fields:B.length,modified:X.value.filter(J=>T.sections.includes(J.path.split(".")[0])).length,pending_restart:B.filter(J=>J.apply_state==="pending_restart").length,invalid:B.filter(J=>J.apply_state==="invalid").length,dormant:B.filter(J=>J.apply_state==="dormant").length}}function xt(T){var B;return Object.hasOwn(v.value,T)&&!$i((B=e.value)==null?void 0:B[T],v.value[T])}function ms(T){return X.value.some(B=>B.path===T||B.path.startsWith(`${T}.`))}function Tt(T){h.value=T,u.value="",p.value="all";try{localStorage.setItem(Fm,T)}catch{}}function Ws(T){p.value=T}function Ht(){u.value="",p.value="all"}function ks(T){var B;return((B=K.value.find(J=>J.sections.includes(T)))==null?void 0:B.sections)||[]}function rn(T){const B=ks(T),J=B.find(Ee=>m.value[Ee]===!0);return J||B.find(Ee=>m.value[Ee]!==!1)||null}function Ss(T){return u.value&&!C.value&&Ie(T)?!0:C.value?rn(T)===T:Object.hasOwn(m.value,T)?m.value[T]===!0:!0}function Xn(T){const B=!Ss(T);if(C.value){const J={...m.value};for(const Ee of ks(T))J[Ee]===!0&&(J[Ee]=!1);J[T]=B,m.value=J;return}m.value={...m.value,[T]:B}}function Zs(){b.value.push(oa(v.value)),b.value.length>hk&&b.value.shift(),k.value=[]}function Ls(){le.value&&(Zs(),v.value={},g.value={},w.value=!1)}function Pn(T,B=!1){const J=Date.now();if(B&&U.path===T&&J-U.at<mk){U.at=J;return}Zs(),U={path:T,at:J}}function Kt(T,B,J){if(!B.length)return J;const Ee=oa(T??{});let rt=Ee;for(let Ts=0;Ts<B.length-1;Ts+=1){const un=B[Ts];rt[un]=oa(rt[un]??{}),rt=rt[un]}return rt[B.at(-1)]=J,Ee}function Hs(T){var B;return Object.hasOwn(v.value,T)?v.value[T]:oa((B=e.value)==null?void 0:B[T])}function as(T,B,J={}){var md;const[Ee,...rt]=T.path.split(".");Pn(T.path,!!J.coalesce);const Ts=Hs(Ee),un=rt.length?Kt(Ts,rt,B):B,sa={...v.value};if($i(un,(md=e.value)==null?void 0:md[Ee])?delete sa[Ee]:sa[Ee]=un,v.value=sa,g.value[T.path]){const vd={...g.value};delete vd[T.path],g.value=vd}}function nt(T){U={path:null,at:0},S.value={...S.value,[T]:String(Re(G.value,T)??"")}}function W(T){if(U={path:null,at:0},!Object.hasOwn(S.value,T))return;const B={...S.value};delete B[T],S.value=B}function he(T){const B=S.value[T.path];if(U={path:null,at:0},B===""){g.value={...g.value,[T.path]:"Enter a number."};return}const J=Number(B);if(Number.isNaN(J)||T.type==="integer"&&!Number.isInteger(J)){g.value={...g.value,[T.path]:T.type==="integer"?"Enter a whole number.":"Enter a number."};return}const Ee={...S.value};delete Ee[T.path],S.value=Ee,as(T,J,{coalesce:!0})}function Ne(T){return Object.hasOwn(S.value,T.path)?S.value[T.path]:T.value??""}function Ve(T,B){if(S.value={...S.value,[T.path]:B},B===""){g.value={...g.value,[T.path]:"Enter a number."};return}const J=Number(B);if(!Number.isFinite(J)||T.type==="integer"&&!Number.isInteger(J)){g.value={...g.value,[T.path]:T.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[T.path]){const Ee={...g.value};delete Ee[T.path],g.value=Ee}as(T,J,{coalesce:!0})}function et(T){const B=Number.parseInt(R.value,10);if(!Number.isInteger(B)||B<1){g.value={...g.value,[T.path]:"Warning thresholds must be positive whole numbers."};return}const J=[...new Set([...T.value||[],B])].sort((Ee,rt)=>rt-Ee);R.value="",as(T,J)}function Nt(T,B){as(T,(T.value||[]).filter(J=>J!==B))}function ea(T){return T.apply_mode==="live_read"?"Odin reads the saved file value on next use.":T.apply_mode==="live_for_new_work"?"New work uses the saved file value.":T.apply_mode==="live_apply"?T.apply_handler?`Apply the saved value through ${T.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":T.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":T.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":T.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function is(T){return T.type==="array"&&Array.isArray(T.value)&&!T.structured_container&&!T.structured_container_child&&T.sensitivity==="public"&&T.value.every(B=>["string","number","boolean"].includes(typeof B))}function Ea(T){const B=String(x.value[T.path]??"").trim();if(!B)return;const J=[...new Set([...T.value||[],B])];x.value={...x.value,[T.path]:""},as(T,J)}function zs(T,B){as(T,(T.value||[]).filter(J=>J!==B))}function fi(T,B){var Ee;if(!T)return null;if((Ee=T.enum)!=null&&Ee.length&&!T.enum.includes(B))return`Choose one of: ${T.enum.join(", ")}`;if(T.path==="agents.final_warning_iterations"&&(!Array.isArray(B)||!B.length))return"Add at least one warning threshold.";const J=T.constraints||{};if((T.type==="integer"||T.type==="number")&&typeof B=="number"){if(J.minimum!==void 0&&B<J.minimum)return`Must be at least ${J.minimum}${T.unit?` ${T.unit}`:""}`;if(J.maximum!==void 0&&B>J.maximum)return`Must be at most ${J.maximum}${T.unit?` ${T.unit}`:""}`}return null}function hi(T){return Y.value[T.path]||null}function Aa(T){const B=`${T}.`;return Object.keys(Y.value).some(J=>J===T||J.startsWith(B))}function ta(){b.value.length&&(k.value.push(oa(v.value)),v.value=b.value.pop(),g.value={},S.value={},U={path:null,at:0})}function Mn(){k.value.length&&(b.value.push(oa(v.value)),v.value=k.value.pop(),g.value={},S.value={},U={path:null,at:0})}function Fn(){!le.value||be.value||(w.value=!0,A.value=!1)}function Js(){w.value=!1}function cn(){Ls()}function Wt(T){return pk[T]||Na(T||"unknown")}function Ra(T){return`apply-${String(T||"unknown").replaceAll("_","-")}`}function V(T){return`cfgc-field-${T.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function xe(T){return`${V(T)}-input`}function Ae(T){const B=document.getElementById(V(T))||document.getElementById(V(T.split(".").slice(0,2).join(".")));B==null||B.scrollIntoView({behavior:"smooth",block:"center"})}function Zt(T,B){l.value={type:T,message:B},window.setTimeout(()=>{var J;((J=l.value)==null?void 0:J.message)===B&&(l.value=null)},3500)}function dn(){r.value=!1,p.value="pending_restart",u.value="";const T=uk(n.value);T&&(T.scrollTop=0)}function $n(){r.value=!1}function Te(T=1800){N&&window.clearTimeout(N),N=window.setTimeout(O,T)}async function O(){if(c.value){if(E+=1,E>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await mr(),_.value===0){c.value=!1,d.value=null,Zt("success","Odin restarted and the saved startup settings are active.");return}}catch{}Te(2e3)}}async function te(){if(!c.value){d.value=null;try{await q.post("/api/restart",{}),c.value=!0,E=0,r.value=!1,Te()}catch(T){d.value=T.message||"Odin could not schedule a restart."}}}async function ve(){if(!(!le.value||be.value||a.value)){a.value=!0;try{const T=bk(e.value,v.value),B=await q.put("/api/config",T);e.value=B,v.value={},b.value=[],k.value=[],g.value={},w.value=!1;try{t.value=await mr(),o.value=null,r.value=_.value>0,Zt("success",_.value?`Configuration saved. ${_.value} setting${_.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(J){o.value=J.message||"Unknown metadata error.",Zt("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(T){Zt("error",T.message||"Configuration could not be saved")}finally{a.value=!1}}}async function Me(){var T,B;if(!le.value){s.value=!0,i.value=null;try{const J=await q.get("/api/config"),Ee=await mr();e.value=J,t.value=Ee,o.value=null;const rt=K.value;if(rt.some(Ts=>Ts.key===h.value)||(h.value=((T=rt[0])==null?void 0:T.key)||Ya[0].key),C.value){const un=(((B=rt.find(sa=>sa.key===h.value))==null?void 0:B.sections)||[]).find(sa=>m.value[sa]===!0);m.value=un?{...m.value,[un]:!0}:{}}}catch(J){i.value=J.message||"Unknown configuration error"}finally{s.value=!1}}}function $e(T){if(w.value||!(T.ctrlKey||T.metaKey))return;const B=T.target;B instanceof HTMLElement&&(B.matches("input, textarea, select")||B.isContentEditable)||(!T.shiftKey&&T.key.toLowerCase()==="z"?(T.preventDefault(),ta()):(T.key.toLowerCase()==="y"||T.shiftKey&&T.key.toLowerCase()==="z")&&(T.preventDefault(),Mn()))}function Ue(T){C.value=T.matches}us(m,T=>{try{localStorage.setItem(Mm,JSON.stringify(T))}catch{}},{deep:!0});let bt=!1;function at(){bt||(bt=!0,document.addEventListener("keydown",$e))}function ht(){bt&&(bt=!1,document.removeEventListener("keydown",$e))}return Ge(()=>{var T;Me(),at(),y=window.matchMedia("(max-width: 760px)"),Ue(y),(T=y.addEventListener)==null||T.call(y,"change",Ue)}),hs(at),ns(ht),gt(()=>{var T;ht(),(T=y==null?void 0:y.removeEventListener)==null||T.call(y,"change",Ue),N&&window.clearTimeout(N)}),{armKeydown:at,disarmKeydown:ht,handleKeydown:$e,config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:h,reviewOpen:w,mobileOverflowOpen:A,warningThresholdInput:R,arrayInputs:x,healthFilters:L,visibleCategories:K,displayGroups:j,reviewGroups:re,sectionCount:Q,fieldCount:P,hasChanges:le,changeCount:ee,changedSectionCount:ce,hasDraftErrors:be,canUndo:I,canRedo:H,globalFilterActive:De,reviewRestartCount:ue,pendingRestartCount:_,pendingRestartFields:Le,healthCount:ft,categoryStats:He,selectCategory:Tt,selectHealthFilter:Ws,clearFilters:Ht,sectionLabel:pe,sectionDescription:fe,sectionFieldCount:ae,sectionHealthCount:Ze,sectionApplySummary:oe,sectionApplyDetails:we,sectionEntries:F,fieldGroups:Se,sectionSearchHits:ye,mcpConfigSummary:ke,fieldRuntimeCopy:Oe,fieldSpecificRuntimeNote:dt,hasHonestAction:ot,runFieldAction:Ft,hasHostsCollection:ie,hostsConfigSummary:se,sectionChanged:xt,fieldChanged:ms,isSectionExpanded:Ss,toggleSection:Xn,discardAllDrafts:Ls,setFieldValue:as,setNumberFieldValue:Ve,numberInputValue:Ne,beginInputEdit:nt,endTextInputEdit:W,endInputEdit:he,addWarningThreshold:et,removeWarningThreshold:Nt,isScalarArray:is,addScalarArrayItem:Ea,removeScalarArrayItem:zs,fieldError:hi,sectionHasErrors:Aa,undo:ta,redo:Mn,openReview:Fn,closeReview:Js,mobileCancel:cn,applyModeLabel:Wt,applyClass:Ra,compactValue:vk,formatValue:gk,structuredApplyCopy:ea,fieldId:V,fieldInputId:xe,focusField:Ae,fetchConfig:Me,saveConfig:ve,restartOdin:te,restartLater:$n,reviewPendingRestart:dn}}},wk=/^\d{15,25}$/;function Um(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Hm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(e,{emit:t}){const s=f(""),n=f(!1),a=f(0),i=f(null),l=Z(()=>new Set((e.excludedIds||[]).map(String))),o=Z(()=>{const k=s.value.toLowerCase().trim();return(e.members||[]).filter(w=>l.value.has(String(w.id))?!1:k?u(w).toLowerCase().includes(k)||String(w.username||"").toLowerCase().includes(k)||String(w.id).includes(k):!0)}),r=Z(()=>{const k=s.value.trim();return o.value.length===0&&wk.test(k)&&!l.value.has(k)?k:""}),c=Z(()=>o.value.length+(r.value?1:0)),d=Z(()=>{if(n.value){if(o.value[a.value])return`${e.optionsId}-${a.value}`;if(r.value&&a.value===o.value.length)return`${e.optionsId}-raw`}});function u(k){return Um(k)}function p(){n.value=!0,a.value=0}function h(){p()}function m(){const k=Math.max(c.value-1,0);a.value=Math.min(a.value+1,k)}function v(){a.value=Math.max(a.value-1,0)}function S(){const k=o.value[a.value];k?R(k):r.value&&a.value===o.value.length&&x(r.value)}function R(k){x(String(k.id))}function x(k){t("select",k),s.value="",n.value=!1,a.value=0}function g(){n.value=!1}function b(){setTimeout(g,150)}return Ge(()=>{e.autofocus&&Rt(()=>{var k;return(k=i.value)==null?void 0:k.focus()})}),{query:s,open:n,highlightedIndex:a,input:i,filteredMembers:o,rawId:r,activeOptionId:d,memberName:u,openOptions:p,onInput:h,highlightNext:m,highlightPrevious:v,selectHighlighted:S,selectMember:R,selectId:x,closeOptions:g,onBlur:b}}};function Zu(e,t,s){var n;return((n=e==null?void 0:e.config)==null?void 0:n[t])!=null?e.config[t]:s==null?void 0:s[t]}const kk={components:{DiscordUserCombobox:Hm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f([]),t=f(!0),s=f(null),n=f({}),a=f(null),i=f(null),l=f(!1),o=f(null),r=f({}),c=f([]);let d=0;const u=Object.freeze([{key:"allowed_users",label:"Allowed users",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked users; prefix commands use separate authorization and allowed test webhooks bypass this gate.",placeholder:"Search Discord users…",userAutocomplete:!0,fullWidth:!0},{key:"channels",label:"Allowed channels",description:"Absolute gate for ordinary conversational intake. Guild/channel settings cannot readmit blocked channels; prefix commands use separate authorization.",placeholder:"Discord channel ID",fullWidth:!0},{key:"ignore_bot_ids",label:"Ignored bot IDs",description:"Ignored unless the bot explicitly mentions Odin; the effective respond-to-bots policy still applies.",placeholder:"Search Discord users or bots…",userAutocomplete:!0,fullWidth:!0}]),p=Z(()=>JSON.stringify(a.value)!==JSON.stringify(i.value)),h=Z(()=>new Map(c.value.map(P=>[String(P.id),P])));function m(P){return P.config&&P.config.enabled!==void 0?P.config.enabled:!0}function v(P){return Zu(P,"require_mention",a.value)}function S(P){return Zu(P,"respond_to_bots",a.value)}function R(P){return P.config&&Object.keys(P.config).length>0}function x(P){n.value[P]=!n.value[P]}function g(P){const L=P.discord||{};return{allowed_users:[...L.allowed_users||[]],channels:[...L.channels||[]],respond_to_bots:!!L.respond_to_bots,require_mention:!!L.require_mention,ignore_bot_ids:[...L.ignore_bot_ids||[]]}}async function b({showLoading:P=!0}={}){const L=++d;P&&(t.value=!0),s.value=null;try{const I=await q.get("/api/discord/guilds");L===d&&(e.value=I)}catch(I){L===d&&(s.value=I.message)}finally{P&&L===d&&(t.value=!1)}}async function k(){t.value=!0,s.value=null;try{const[P,L,I]=await Promise.all([q.get("/api/discord/guilds"),q.get("/api/discord/members").catch(()=>[]),q.get("/api/config")]),H=g(I),K=p.value;a.value=H,K||(i.value=JSON.parse(JSON.stringify(H))),c.value=L,e.value=P,o.value=null}catch(P){s.value=P.message}finally{t.value=!1}}let w=Promise.resolve();const A=f(new Set);function C(P,L){const I=new Set(A.value);I.add(P),A.value=I;const H=w.then(L);return w=H.catch(()=>{}),H.finally(()=>{const K=new Set(A.value);K.delete(P),A.value=K})}function y(P,L,I,H){const K=(H==null?void 0:H.target)??null;return C(`guild:${P}:${L}`,async()=>{try{await q.put("/api/discord/guild/"+P+"/config",{[L]:I}),await b({showLoading:!1})}catch(G){s.value=G.message,K&&typeof I=="boolean"&&(K.checked=!I)}})}function N(P,L,I,H,K){const G=(K==null?void 0:K.target)??null;return C(`channel:${P}:${I}`,async()=>{try{await q.put("/api/discord/channel/"+P+"/config",{[I]:H}),await b({showLoading:!1})}catch(X){s.value=X.message,G&&typeof H=="boolean"&&(G.checked=!H)}})}function U(P,L){return C(`channel:${P}:clear`,async()=>{try{await q.put("/api/discord/channel/"+P+"/config",{clear:!0}),await b({showLoading:!1})}catch(I){s.value=I.message}})}function E(P,L){const I=String(L);if(!P.userAutocomplete)return I;const H=h.value.get(I);return H?Um(H):I}function M(P,L=null){const I=String(L??r.value[P]??"").trim();!I||i.value[P].includes(I)||(i.value[P]=[...i.value[P],I],r.value={...r.value,[P]:""})}function $(P,L){i.value[P]=i.value[P].filter(I=>I!==L)}async function Q(){if(!(!p.value||l.value)){l.value=!0,o.value=null;try{const L=(await q.put("/api/config",{discord:i.value})).discord||i.value;a.value={allowed_users:[...L.allowed_users||[]],channels:[...L.channels||[]],respond_to_bots:!!L.respond_to_bots,require_mention:!!L.require_mention,ignore_bot_ids:[...L.ignore_bot_ids||[]]},i.value=JSON.parse(JSON.stringify(a.value))}catch(P){o.value=P.message||"Global defaults could not be saved."}finally{l.value=!1}}}return Ge(k),{guilds:e,loading:t,error:s,expanded:n,globalDraft:i,globalSaving:l,globalError:o,globalArrayInputs:r,globalMembers:c,globalListEditors:u,globalChanged:p,guildEnabled:m,guildMention:v,guildBots:S,hasOverride:R,toggleGuild:x,fetchAll:k,fetchGuilds:b,setGuildConfig:y,setChannelConfig:N,clearOverride:U,mutationPending:A,globalItemLabel:E,addGlobalItem:M,removeGlobalItem:$,saveGlobalDefaults:Q}}},Cs=e=>e==null?e:JSON.parse(JSON.stringify(e));function Sk({applyDefault:e,applyUser:t,applyDelete:s,onDefaultConfirmed:n=()=>{},onDefaultRollback:a=()=>{},onUserConfirmed:i=()=>{},onUserRollback:l=()=>{},onUserDeleted:o=()=>{},onError:r=()=>{}}){let c=Promise.resolve(),d=0,u=0;const p=new Map;let h=null;const m=new Map;function v(w){d+=1;const A=c.then(w,w);return c=A.catch(()=>{}),A}function S(w,A){h=Cs(w),m.clear();for(const[C,y]of Object.entries(A||{}))m.set(C,Cs(y))}function R(w){const A=Cs(w),C=++u;return v(async()=>{try{await e(Cs(A)),h=Cs(A),C===u&&n(Cs(A))}catch(y){C===u&&(a(Cs(h)),r(y,{kind:"default"}))}})}function x(w,A){const C=Cs(A),y=(p.get(w)||0)+1;return p.set(w,y),v(async()=>{try{await t(w,Cs(C)),m.set(w,Cs(C)),y===p.get(w)&&i(w,Cs(C))}catch(N){y===p.get(w)&&(l(w,Cs(m.get(w)??null)),r(N,{kind:"user",uid:w}))}})}function g(w){const A=(p.get(w)||0)+1;return p.set(w,A),v(async()=>{try{await s(w),m.delete(w),A===p.get(w)&&o(w)}catch(C){A===p.get(w)&&(l(w,Cs(m.get(w)??null)),r(C,{kind:"delete",uid:w}))}})}async function b(){for(;;){const w=c;if(await w,w===c)return d}}async function k(w){for(;;){const A=await b(),C=await w();if(A===d)return C}}return{seed:S,saveDefault:R,saveUser:x,deleteUser:g,whenIdle:b,readSnapshot:k,get revision(){return d}}}const Tk={components:{DiscordUserCombobox:Hm},template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f({}),i=f({allowed_hosts:[],default_host:""}),l=f({}),o=f(!1),r=f([]),c=Z(()=>{const E={};for(const M of r.value)E[M.id]=M;return E});function d(E){return c.value[E]||null}function u(E,M){return E?E.allowed_hosts===null||E.allowed_hosts===void 0?{allowed_hosts:[...M],default_host:E.default_host||"",allow_all:!0}:{allowed_hosts:E.allowed_hosts,default_host:E.default_host||"",allow_all:!1}:{allowed_hosts:[...M],default_host:M[0]||"",allow_all:!0}}const p=Sk({applyDefault:async E=>{const M=E.allow_all?null:E.allowed_hosts;await q.put("/api/host-access/default-policy",{allowed_hosts:M,default_host:E.default_host})},applyUser:async(E,M)=>{const $=M.allow_all?null:M.allowed_hosts;await q.put(`/api/host-access/user/${E}`,{allowed_hosts:$,default_host:M.default_host})},applyDelete:E=>q.del(`/api/host-access/user/${E}`),onDefaultConfirmed:()=>_e.success("Default policy updated"),onDefaultRollback:E=>{E&&(i.value=E)},onUserConfirmed:E=>{const M=d(E);_e.success(`Updated access for ${M?M.display_name:E}`)},onUserRollback:(E,M)=>{const $={...l.value};M?$[E]=M:delete $[E],l.value=$},onUserDeleted:E=>{const M={...l.value};delete M[E],l.value=M},onError:(E,M)=>{var Q;const $=M.uid?` ${((Q=d(M.uid))==null?void 0:Q.display_name)||M.uid}`:"";_e.error(`${E.message||"Failed to save"} — reverted${$}`)}});let h=0;async function m(){const E=++h;e.value=!0,t.value="";try{const M=await p.readSnapshot(()=>q.get("/api/host-access"));if(E!==h)return;s.value=M,n.value=M.available_hosts||[],a.value=M.host_descriptions||{},i.value=u(M.default_policy,n.value);const $=M.users||{},Q={};for(const[P,L]of Object.entries($))Q[P]=u(L,n.value);l.value=Q,p.seed(i.value,Q)}catch(M){E===h&&(t.value=M.message||"Failed to fetch host access data")}finally{E===h&&(e.value=!1)}try{const M=await q.get("/api/discord/members")||[];E===h&&(r.value=M)}catch{E===h&&(r.value=[])}}const v=500,S=new Map;function R(E,M){const $=S.get(E);$&&clearTimeout($.timer);const Q={run:M,timer:null};Q.timer=setTimeout(()=>{S.delete(E),M()},v),S.set(E,Q)}function x(E){const M=S.get(E);M&&(clearTimeout(M.timer),S.delete(E))}function g(){for(const[E,M]of[...S])clearTimeout(M.timer),S.delete(E),M.run()}function b(){R("default",()=>p.saveDefault(i.value))}function k(E,M){i.value.allow_all=!1,M?i.value.allowed_hosts.includes(E)||i.value.allowed_hosts.push(E):(i.value.allowed_hosts=i.value.allowed_hosts.filter($=>$!==E),i.value.default_host===E&&(i.value.default_host=i.value.allowed_hosts[0]||"")),b()}function w(E){R(`user:${E}`,()=>{const M=l.value[E];M&&p.saveUser(E,M)})}function A(E,M,$){const Q=l.value[E];Q&&(Q.allow_all=!1,$?Q.allowed_hosts.includes(M)||Q.allowed_hosts.push(M):(Q.allowed_hosts=Q.allowed_hosts.filter(P=>P!==M),Q.default_host===M&&(Q.default_host=Q.allowed_hosts[0]||"")),w(E))}function C(E,M){const $=l.value[E];$&&($.default_host=M,w(E))}function y(){o.value=!0}function N(E){!/^\d{15,25}$/.test(E)||l.value[E]||(l.value[E]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},p.saveUser(E,l.value[E]),o.value=!1)}async function U(E){const M=d(E);await Ut({title:"Remove user override",message:`Remove the host access override for ${M?M.display_name:E}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(x(`user:${E}`),await p.deleteUser(E),l.value[E]||_e.success(`Removed override for ${M?M.display_name:E}`))}return Ge(m),ns(g),gt(g),{loading:e,error:t,data:s,availableHosts:n,hostDescriptions:a,defaultPolicy:i,users:l,showAddUser:o,members:r,fetchData:m,saveDefaultPolicy:b,toggleDefaultHost:k,getMember:d,toggleUserHost:A,setUserDefault:C,openAddUser:y,addUserById:N,deleteUser:U,flushPendingSaves:g}}},Ck={template:`
    <div class="p-6 page-fade-in space-y-6">
      <div class="flex items-center justify-between">
    ...
    </div>`,setup(){const e=f([]),t=f(!1),s=f(""),n=f(!1),a=f(!1),i=f(1),l=f(""),o=f(!1),r=f(null),c=f(""),d=f([]),u=f(!1),p=f(null),h=f(""),m=()=>({alias:"",address:"",port:22,ssh_user:"root",os:"linux",description:"",trust_mode:"pinned",enabled:!0,confirm_local:!1,confirm_tofu:!1}),v=f(m()),S=Z(()=>["127.0.0.1","localhost","::1"].includes(v.value.address));async function R(){t.value=!0,s.value="";try{const $=await q.get("/api/hosts");e.value=$.hosts||[],l.value=$.default_host||"",o.value=!!$.tofu_enabled}catch($){s.value=$.message}finally{t.value=!1}}async function x(){try{await q.post("/api/hosts/settings",{default_host:l.value,allow_host_tofu:o.value}),_e.success("Host settings saved and published live"),await R()}catch($){_e.error($.message)}}function g(){c.value="",d.value=[],u.value=!1,p.value=null,r.value=null,h.value="",i.value=1,n.value=!0}function b(){a.value=!1,v.value=m(),g()}function k($){a.value=!0,v.value={...m(),...$},g()}async function w(){try{r.value=await q.get("/api/hosts/public-key")}catch($){_e.error($.message)}}async function A($){try{const Q=await q.post("/api/hosts/"+encodeURIComponent($.alias)+"/import-legacy",{});a.value=!0,v.value={...m(),...$,trust_mode:"pinned"},g(),c.value=Q.candidate_token,d.value=Q.fingerprints||[],h.value=d.value.join(`
`),i.value=4,_e.info("Imported existing known_hosts trust. Test before activation.")}catch(Q){_e.error(Q.message)}}async function C(){try{const $=h.value.split(/\s+/).filter(Boolean),Q={...v.value,expected_fingerprints:$,candidate_fingerprints:d.value},P=await q.post("/api/hosts/candidates",Q);if(c.value=P.candidate_token,d.value=P.fingerprints||[],v.value.trust_mode==="tofu"&&Q.candidate_fingerprints.length===0){v.value.confirm_tofu=!1,_e.info("Fingerprint scanned. Review it, tick confirmation, then scan again.");return}i.value=4}catch($){_e.error($.message)}}async function y(){try{const $=await q.post("/api/hosts/candidates/"+c.value+"/test",{});u.value=!!$.tested,p.value=$.last_test,u.value&&(i.value=5)}catch($){_e.error($.message)}}async function N(){try{await q.post("/api/hosts/candidates/"+c.value+"/commit",{}),_e.success("Host saved and published live"),n.value=!1,await R()}catch($){_e.error($.message)}}async function U($){try{await q.post("/api/hosts/"+encodeURIComponent($.alias)+"/enabled",{enabled:!$.enabled}),await R()}catch(Q){_e.error(Q.message)}}async function E($){if(await Ut("Delete host "+$.alias+"? Dependencies will block deletion."))try{await q.del("/api/hosts/"+encodeURIComponent($.alias)),await R()}catch(Q){_e.error(Q.message)}}async function M($){if(await Ut("Force revoke "+$.alias+"? Remote outcomes may be unknown."))try{await q.post("/api/hosts/"+encodeURIComponent($.alias)+"/force-revoke",{}),await R()}catch(Q){_e.error(Q.message)}}return Ge(R),{hosts:e,loading:t,error:s,wizard:n,editing:a,step:i,defaultHost:l,tofuEnabled:o,form:v,isLocal:S,keyInfo:r,candidate:c,observed:d,tested:u,testResult:p,fingerprintsText:h,load:R,saveSettings:x,beginAdd:b,beginEdit:k,loadKey:w,importLegacy:A,prepare:C,testConnection:y,commit:N,toggle:U,remove:E,forceRevoke:M}}},Ek={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=f(!0),t=f(""),s=f(null),n=f([]),a=f(!1),i=f(!1),l=f(null),o=f(null),r=f(!1),c=f({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=f({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=Z(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=Z(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function h(C){return C==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":C==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const C=await q.get("/api/tokens");s.value=C.tokens||[],n.value=C.available_hosts||[]}catch(C){t.value=C.message||"Failed to load tokens"}finally{e.value=!1}}function v(C){return!C||!C.trim()?[]:C.split(",").map(y=>y.trim()).filter(Boolean)}function S(C,y){const N=c.value.allowed_hosts;if(y&&!N.includes(C)&&N.push(C),!y){const U=N.indexOf(C);U>=0&&N.splice(U,1)}}function R(C,y){const N=d.value.allowed_hosts;if(y&&!N.includes(C)&&N.push(C),!y){const U=N.indexOf(C);U>=0&&N.splice(U,1)}}async function x(){var C;i.value=!0;try{const y=v(c.value.allowed_tools_str),N=c.value.host_mode,U=N==="none"?[]:N==="select"?c.value.allowed_hosts:null,E={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:y.length?y:[]};U!==null&&(E.allowed_hosts=U),E.default_host=c.value.default_host||"";const M=await q.post("/api/tokens",E);l.value=M.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,_e.success("Token created"),await m()}catch(y){_e.error(((C=y.data)==null?void 0:C.error)||y.message||"Failed to create token")}finally{i.value=!1}}function g(C){o.value=C;const y=C.allowed_hosts;let N="default";y==null?N="default":Array.isArray(y)&&y.length===0?N="none":Array.isArray(y)&&(N="select"),d.value={username:C.username||"",tier:C.tier||"admin",label:C.label||"",host_mode:N,allowed_hosts:Array.isArray(y)?[...y]:[],default_host:C.default_host||"",allowed_tools_str:(C.allowed_tools||[]).join(", ")}}async function b(){var C;if(o.value){r.value=!0;try{const y=v(d.value.allowed_tools_str),N=d.value.host_mode,U={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:y};N==="none"?U.allowed_hosts=[]:N==="select"?U.allowed_hosts=d.value.allowed_hosts:U.allowed_hosts=null,U.default_host=d.value.default_host||"",await q.put("/api/tokens/"+encodeURIComponent(o.value.user_id),U),o.value=null,_e.success("Token updated"),await m()}catch(y){_e.error(((C=y.data)==null?void 0:C.error)||y.message||"Failed to update")}finally{r.value=!1}}}async function k(C){var N;if(await Ut({title:"Regenerate token",message:`Regenerate token for ${C.username||C.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const U=await q.post("/api/tokens/"+encodeURIComponent(C.user_id)+"/regenerate");l.value=U.token,_e.success("Token regenerated")}catch(U){_e.error(((N=U.data)==null?void 0:N.error)||U.message||"Failed to regenerate")}}async function w(C){var N;if(await Ut({title:"Delete token",message:`Delete token for ${C.username||C.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/tokens/"+encodeURIComponent(C.user_id)),_e.success("Token deleted"),await m()}catch(U){_e.error(((N=U.data)==null?void 0:N.error)||U.message||"Failed to delete")}}async function A(){if(l.value)try{await navigator.clipboard.writeText(l.value),_e.success("Copied to clipboard")}catch{_e.error("Copy failed — select and copy manually")}}return Ge(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:h,toggleCreateHost:S,toggleEditHost:R,createToken:x,startEdit:g,saveEdit:b,confirmRegenerate:k,confirmDelete:w,copyToken:A}}},Ak=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),Rk=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),Ik=Object.freeze(["enabled","base_url","model","max_tokens"]),Ok=Object.freeze(["enabled","model","max_tokens"]);function qo(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function Ju(e){return qo(e,Ak)}function Yu(e){return qo(e,Rk)}function Lk(e,{includeApiKey:t=!1}={}){const s=qo(e,Ik);return t&&(s.api_key=e.api_key),s}function Nk(e){return{timeout:e.timeout}}function Dk(e,{includeApiKey:t=!1}={}){const s=qo(e,Ok);return t&&(s.api_key=e.api_key),s}function Pk(e){return{timeout:e.timeout}}function Il(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Mk={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(!0),t=f(null),s=f(!1),n=f("codex"),a=f({enabled:!1,model:"gpt-5.6-sol",reasoning_effort:"xhigh",agent_reasoning_effort:"auto",agent_model:"auto",request_timeout_seconds:3600,stream_stall_timeout_seconds:180,retry:{max_retries:3,base_delay:1,max_delay:30},connection_pool:{max_connections:10,keepalive_timeout:30},context_compression:{enabled:!0,max_context_chars:null,keep_recent_iterations:30},context_budget_overrides:{},context_utilization:60}),i=["gpt-6-astra","gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],l=Z(()=>{const V=a.value.model;return V&&!i.includes(V)?[V,...i]:i}),o=Z(()=>{const V=a.value.agent_model;return V&&V!=="auto"&&!i.includes(V)?[V,...i]:i}),r={"gpt-5.5":["max"],"gpt-5.4":["max"],"gpt-5.4-mini":["max"],"gpt-6-astra":["none"]},c=(V,xe)=>!!V&&!!xe&&(r[V]||[]).includes(xe),d=V=>!c(a.value.model,V)&&!(a.value.agent_reasoning_effort===""&&c(a.value.agent_model,V)),u=V=>{const xe=a.value.agent_model;return xe==="auto"?!0:!c(xe||a.value.model,V)},p=Z(()=>{const V=a.value.agent_reasoning_effort;return V==="auto"?null:V||a.value.reasoning_effort}),h=V=>c(V,a.value.reasoning_effort)||a.value.agent_model===""&&c(V,p.value),m=V=>c(V,p.value),v=f({enabled:!1,model:"gpt-5.6-luna"}),S=f({unavailable_reason:null}),R=Z(()=>{const V=v.value.model;return V&&!i.includes(V)?[V,...i]:i});function x(V){const xe=V.target.value;v.value.enabled=xe!=="",xe!==""&&(v.value.model=xe),Ne()}const g=f(!1),b=f({codex:!1,ollama:!1,kimi:!1}),k=f(null),w=f(!1),A=f(""),C=f(null),y=f(!1);let N=0;const U=Z(()=>{var V;return Object.entries(((V=k.value)==null?void 0:V.models)||{}).map(([xe,Ae])=>{var Zt,dn,$n;return{model:xe,floor:Ae.floor,override:Ae.override,effectiveBudget:(Zt=Ae.effective)==null?void 0:Zt.effective_budget,configuredPrimaryChars:(dn=Ae.configured)==null?void 0:dn.primary_chars,primaryChars:($n=Ae.effective)==null?void 0:$n.primary_chars,provenance:Ae.provenance,clampExpiresAt:Ae.clamp_expires_at,densityPriorMilli:Ae.density_prior_milli,densityScope:Ae.density_scope,workloadCalibration:Ae.workload_calibration}})}),E=Z(()=>{var V;return((V=k.value)==null?void 0:V.clamps)||[]}),M=Z(()=>{var V,xe;return((xe=(V=k.value)==null?void 0:V.models)==null?void 0:xe[a.value.model])||null}),$=f({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096,timeout:300}),Q=f({enabled:!1,api_key:"",model:"",max_tokens:4096,timeout:300}),P=f(!1),L=f(!1),I=f(!1),H=f(!1),K=f(!1),G=f(!1),X=f(!1),le=f({configured:null}),ee=f(!1),ce=f([]),De=f(""),Y=f(!1),be=f(!1),j=f({configured:null}),re=f(!1),ue=f([]),Le=f(""),_=f(!1),D=f(!1),z=f(!0),ie=f(""),se=f({configured:null,accounts:[]}),ae=f(null),pe=f(null),fe=f(""),de=f(null),oe=f(!1),we=f(null),ge=f(null),ke=f("");let Re=null;function F(V,xe="success"){_e(V,xe==="error"?"error":"success")}function me(V){if(!V)return"?";const xe=V/(1024*1024*1024);return xe>=1?xe.toFixed(1)+" GB":(V/(1024*1024)).toFixed(0)+" MB"}function Se(V){return Number.isFinite(Number(V))?Number(V).toLocaleString():"—"}function Oe(V){return V==null?"automatic (model-derived)":Number(V).toLocaleString()+" characters"}function Pe(V){const xe=new Date(V);return Number.isNaN(xe.getTime())?"unknown":xe.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function dt(V){return typeof V=="string"&&V.length>12?V.slice(0,8)+"…"+V.slice(-4):V}function ot(V){return typeof V!="number"||!Number.isFinite(V)?"—":(V/1e3).toFixed(2)}function Ft(V){return V==="temporary learned clamp"?"is-clamp":V==="override"?"is-override":"is-built-in"}function ne(V){const xe=a.value.context_budget_overrides[V.model];return V.floor!=null&&Number.isFinite(Number(xe))&&Number(xe)>V.floor}function ye(V,xe){const Ae={...a.value.context_budget_overrides};xe.target.value===""?delete Ae[V]:Ae[V]=Number(xe.target.value),a.value.context_budget_overrides=Ae,y.value=!0}function Ie(V){a.value.context_utilization=V.target.value===""?"":Number(V.target.value),y.value=!0}function Ze(V){const xe={...a.value.context_budget_overrides};delete xe[V],a.value.context_budget_overrides=xe,y.value=!0}async function ft(){e.value=!0,await Promise.all([He(),ms(),Ss(),Tt(),xt()]),e.value=!1}async function He({preserveBasic:V=!1,preserveAdvanced:xe=!1}={}){try{const Ae=await q.get("/api/llm/status");t.value=Ae,s.value=!1,n.value=Ae.active_provider||"codex",Ae.codex&&!he.pending()&&(V||(a.value.enabled=Ae.codex.enabled,a.value.model=Ae.codex.model||"gpt-5.6-sol",a.value.reasoning_effort=Ae.codex.reasoning_effort||"medium",a.value.agent_reasoning_effort=Ae.codex.agent_reasoning_effort||"",a.value.agent_model=Ae.codex.agent_model||""),xe||(a.value.request_timeout_seconds=Ae.codex.request_timeout_seconds??a.value.request_timeout_seconds,a.value.stream_stall_timeout_seconds=Ae.codex.stream_stall_timeout_seconds??a.value.stream_stall_timeout_seconds,a.value.retry={...a.value.retry,...Ae.codex.retry||{}},a.value.connection_pool={...a.value.connection_pool,...Ae.codex.connection_pool||{}},a.value.context_compression={...a.value.context_compression,...Ae.codex.context_compression||{}},!y.value&&!I.value&&(a.value.context_budget_overrides={...Ae.codex.context_budget_overrides||{}},a.value.context_utilization=Ae.codex.context_utilization??a.value.context_utilization))),Ae.ollama&&!Ve.pending()&&(V||($.value.enabled=Ae.ollama.enabled,$.value.base_url=Ae.ollama.base_url||"",$.value.model=Ae.ollama.model||"",$.value.max_tokens=Ae.ollama.max_tokens||4096),xe||($.value.timeout=Ae.ollama.timeout??$.value.timeout)),Ae.kimi&&!et.pending()&&(V||(Q.value.enabled=Ae.kimi.enabled,Q.value.model=Ae.kimi.model||"",Q.value.max_tokens=Ae.kimi.max_tokens||4096),xe||(Q.value.timeout=Ae.kimi.timeout??Q.value.timeout)),Ae.auxiliary&&(S.value=Ae.auxiliary,Ne.pending()||(v.value.enabled=Ae.auxiliary.enabled,v.value.model=Ae.auxiliary.model||"gpt-5.6-luna"))}catch{t.value||(t.value={active_provider:"",codex:{configured:null},ollama:{configured:null},kimi:{configured:null}}),s.value=!0}}async function xt(){const V=++N;w.value=!0,A.value="";try{const xe=await q.get("/api/context/windows");if(V!==N)return;k.value=xe,!I.value&&!y.value&&(a.value.context_budget_overrides=Object.fromEntries(Object.entries(xe.models||{}).filter(([,Ae])=>Ae.override!=null).map(([Ae,Zt])=>[Ae,Zt.override])),a.value.context_utilization=xe.utilization??a.value.context_utilization)}catch(xe){V===N&&(A.value=xe.message||"Failed to load context budgets")}finally{V===N&&(w.value=!1)}}async function ms(){try{if(le.value=await q.get("/api/ollama/status"),ee.value=!1,le.value.model&&(De.value=le.value.model),le.value.configured)try{const V=await q.get("/api/ollama/models");ce.value=V.models||[]}catch{ce.value=[]}else if($.value.base_url)try{const V=await q.post("/api/ollama/probe-models",{base_url:$.value.base_url});ce.value=V.models||[]}catch{ce.value=[]}}catch{ee.value=!0}}async function Tt(){z.value=!0,ie.value="";try{se.value=await q.get("/api/codex/status")}catch(V){ie.value=V.message||"Failed to fetch Codex status"}finally{z.value=!1}}async function Ws(){const V=t.value?t.value.active_provider:"codex";X.value=!0;try{const xe=await q.post("/api/llm/switch",{provider:n.value});xe.error?(n.value=V,F(xe.error,"error")):(F("Switched to "+n.value+" ("+xe.model+")"),await ft())}catch(xe){n.value=V,F(xe.message||"Switch failed","error")}finally{X.value=!1}}async function Ht(){Y.value=!0;try{const V=await q.post("/api/ollama/reload");F(V.configured?"Ollama reloaded":V.reason||"Ollama not configured",V.configured?"success":"error"),await ft()}catch(V){F(V.message||"Reload failed","error")}finally{Y.value=!1}}async function ks(){be.value=!0;try{await q.post("/api/ollama/model",{model:De.value}),F("Model set to "+De.value),await ft()}catch(V){F(V.message||"Failed","error")}finally{be.value=!1}}async function rn(){const V=$.value.base_url;if(!V){F("Enter a base URL first","error");return}G.value=!0;try{const xe=await q.post("/api/ollama/probe-models",{base_url:V});ce.value=xe.models||[],ce.value.length?(F(ce.value.length+" model(s) found"),!$.value.model&&ce.value.length&&($.value.model=ce.value[0].name)):F("No models found at "+V,"error")}catch(xe){F(xe.message||"Could not reach Ollama","error")}finally{G.value=!1}}async function Ss(){try{if(j.value=await q.get("/api/kimi/status"),re.value=!1,j.value.model&&(Le.value=j.value.model),j.value.configured)try{const V=await q.get("/api/kimi/models");ue.value=V.models||[]}catch{ue.value=[]}}catch{re.value=!0}}async function Xn(){_.value=!0;try{const V=await q.post("/api/kimi/reload");F(V.configured?"Kimi reloaded":V.reason||"Kimi not configured",V.configured?"success":"error"),await ft()}catch(V){F(V.message||"Reload failed","error")}finally{_.value=!1}}async function Zs(){D.value=!0;try{await q.post("/api/kimi/model",{model:Le.value}),F("Model set to "+Le.value),await ft()}catch(V){F(V.message||"Failed","error")}finally{D.value=!1}}async function Ls(){if(I.value){he();return}I.value=!0;const V=Ju(a.value);try{await q.put("/api/llm/codex/config",V),F("Codex config saved"),await Promise.all([He({preserveBasic:!0,preserveAdvanced:!0}),Tt()])}catch(xe){F(xe.message||"Failed","error");const Ae=JSON.stringify(Ju(a.value))!==JSON.stringify(V);await Promise.all([He({preserveBasic:Ae,preserveAdvanced:!0}),Tt()])}finally{I.value=!1}}async function Pn(){if(I.value)return;I.value=!0;const V=Yu(a.value);try{await q.put("/api/llm/codex/config",V),JSON.stringify({context_budget_overrides:a.value.context_budget_overrides,context_utilization:a.value.context_utilization})===JSON.stringify({context_budget_overrides:V.context_budget_overrides,context_utilization:V.context_utilization})&&(y.value=!1),F("Codex advanced settings saved"),await Promise.all([He({preserveBasic:!0,preserveAdvanced:!0}),Tt(),xt()])}catch(xe){F(xe.message||"Failed","error");const Ae=JSON.stringify(Yu(a.value))!==JSON.stringify(V);await Promise.all([He({preserveBasic:!0,preserveAdvanced:Ae}),Tt(),xt()])}finally{I.value=!1}}async function Kt(){if(H.value){Ve();return}H.value=!0;try{const V=P.value?$.value.api_key:null,xe=Lk($.value,{includeApiKey:V!==null});await q.put("/api/llm/ollama/config",xe),F("Ollama config saved"),V!==null&&$.value.api_key===V&&($.value.api_key="",P.value=!1),await Promise.all([He({preserveBasic:!0,preserveAdvanced:!0}),ms()])}catch(V){F(V.message||"Failed","error")}finally{H.value=!1}}async function Hs(){if(!H.value){H.value=!0;try{await q.put("/api/llm/ollama/config",Nk($.value)),F("Ollama timeout saved"),await Promise.all([He({preserveBasic:!0,preserveAdvanced:!0}),ms()])}catch(V){F(V.message||"Failed","error")}finally{H.value=!1}}}async function as(){if(K.value){et();return}K.value=!0;try{const V=L.value?Q.value.api_key:null,xe=Dk(Q.value,{includeApiKey:V!==null});await q.put("/api/llm/kimi/config",xe),F("Kimi config saved"),V!==null&&Q.value.api_key===V&&(Q.value.api_key="",L.value=!1),await Promise.all([He({preserveBasic:!0,preserveAdvanced:!0}),Ss()])}catch(V){F(V.message||"Failed","error")}finally{K.value=!1}}async function nt(){if(!K.value){K.value=!0;try{await q.put("/api/llm/kimi/config",Pk(Q.value)),F("Kimi timeout saved"),await Promise.all([He({preserveBasic:!0,preserveAdvanced:!0}),Ss()])}catch(V){F(V.message||"Failed","error")}finally{K.value=!1}}}async function W(){if(g.value){Ne();return}g.value=!0;try{await q.put("/api/llm/auxiliary/config",v.value),F("Auxiliary config saved"),await He()}catch(V){F(V.message||"Failed","error"),await He()}finally{g.value=!1}}const he=Il(Ls),Ne=Il(W),Ve=Il(Kt),et=Il(as),Nt=()=>(he.cancel(),Ls()),ea=()=>(Ve.cancel(),Kt()),is=()=>(et.cancel(),as()),Ea=()=>Pn(),zs=()=>Hs(),fi=()=>nt();async function hi(V){const xe=V.account_key+":"+V.model;C.value=xe;try{const Ae=await q.post("/api/context/windows/clear",{account_key:V.account_key,model:V.model});F(Ae.cleared?"Temporary clamp cleared":"Clamp was already inactive"),await xt()}catch(Ae){F(Ae.message||"Failed to clear clamp","error"),await xt()}finally{C.value=null}}async function Aa(V){try{await q.post("/api/codex/account/"+V+"/activate"),F("Active account switched"),await Tt()}catch(xe){F(xe.message||"Failed","error")}}async function ta(V){ae.value=V;try{await q.post("/api/codex/account/"+V+"/refresh"),F("Token refreshed"),await Tt()}catch(xe){F(xe.message||"Refresh failed","error")}finally{ae.value=null}}function Mn(V,xe){pe.value=V,fe.value=xe||""}async function Fn(V){try{await q.put("/api/codex/account/"+V+"/label",{label:fe.value}),F("Label updated"),pe.value=null,await Tt()}catch(xe){F(xe.message||"Failed","error")}}async function Js(V,xe){if(await Ut({title:"Delete Codex account",message:`Delete ${xe||"account #"+(V+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/codex/account/"+V),F("Deleted. Pool reloaded."),await Tt()}catch(Zt){F(Zt.message||"Failed","error")}}async function cn(){oe.value=!0;try{const V=await q.post("/api/codex/device-code");we.value=V,de.value="pending",Wt(V)}catch(V){F(V.message||"Failed","error")}finally{oe.value=!1}}async function Wt(V){Re={cancelled:!1};const xe=Re;try{const Ae=await q.post("/api/codex/device-poll",{device_auth_id:V.device_auth_id,user_code:V.user_code,interval:V.interval});if(xe.cancelled)return;ge.value=Ae,de.value="success",await ft()}catch(Ae){if(xe.cancelled)return;ke.value=Ae.message||"Device login failed",de.value="error"}}function Ra(){Re&&(Re.cancelled=!0),de.value=null,we.value=null}return Ge(ft),gt(()=>{Re&&(Re.cancelled=!0),he.cancel(),Ne.cancel(),Ve.cancel(),et.cancel()}),{loading:e,llmStatus:t,llmStatusLoadFailed:s,selectedProvider:n,switching:X,advancedOpen:b,codexForm:a,codexModelOptions:l,codexAgentModelOptions:o,mainEffortAllowed:d,agentEffortAllowed:u,mainModelOptionDisabled:h,agentModelOptionDisabled:m,auxForm:v,auxData:S,auxModelOptions:R,onAuxModelChange:x,savingAux:g,saveAuxConfigDebounced:Ne,ollamaForm:$,kimiForm:Q,savingCodex:I,savingOllama:H,savingKimi:K,probingOllama:G,ollamaKeyDirty:P,kimiKeyDirty:L,fetchCodexStatus:Tt,ollamaStatus:le,ollamaStatusLoadFailed:ee,ollamaModels:ce,ollamaSelectedModel:De,reloading:Y,settingModel:be,kimiStatus:j,kimiStatusLoadFailed:re,kimiModels:ue,kimiSelectedModel:Le,reloadingKimi:_,settingKimiModel:D,codexLoading:z,codexError:ie,codexData:se,refreshing:ae,editingLabel:pe,labelValue:fe,contextWindows:k,contextWindowsLoading:w,contextWindowsError:A,contextBudgetRows:U,activeClampRows:E,activeContextBudget:M,clearingClamp:C,contextPolicyDirty:y,deviceState:de,deviceLoading:oe,deviceInfo:we,deviceResult:ge,deviceError:ke,fetchAll:ft,fetchLLMStatus:He,fetchOllamaStatus:ms,fetchKimiStatus:Ss,switchProvider:Ws,reloadOllama:Ht,setOllamaModel:ks,reloadKimi:Xn,setKimiModel:Zs,probeOllamaModels:rn,saveCodexConfig:Ls,saveOllamaConfig:Kt,saveKimiConfig:as,saveCodexAdvancedConfig:Pn,saveOllamaAdvancedConfig:Hs,saveKimiAdvancedConfig:nt,saveCodexConfigDebounced:he,saveOllamaConfigDebounced:Ve,saveKimiConfigDebounced:et,saveCodexConfigNow:Nt,saveOllamaConfigNow:ea,saveKimiConfigNow:is,saveCodexAdvancedConfigNow:Ea,saveOllamaAdvancedConfigNow:zs,saveKimiAdvancedConfigNow:fi,activateAccount:Aa,refreshAccount:ta,startEditLabel:Mn,saveLabel:Fn,deleteAccount:Js,startDeviceLogin:cn,cancelDeviceLogin:Ra,formatSize:me,fetchContextWindows:xt,clearContextClamp:hi,setContextOverride:ye,setContextUtilization:Ie,resetContextOverride:Ze,overrideAboveFloor:ne,formatCount:Se,formatContextCeiling:Oe,formatExpiry:Pe,shortAccountKey:dt,provenanceClass:Ft,formatDensity:ot}}},Qu={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Fk(e){return Qu[e]||Qu[(e||"").toLowerCase()]||"text-gray-400"}const $k={template:`
  ...
  `,setup(){const e=f(!0),t=f({}),s=f([]),n=f({}),a=f({}),i=f(null),l=f(null),o=f(null),r=f(null),c=f(null),d=Z(()=>{var w;return Object.values(((w=i.value)==null?void 0:w.totals)||{}).reduce((A,C)=>A+Number(C||0),0)}),u=f(""),p=f(0),h=f([]),m=Z(()=>h.value.map(w=>`${w.label} (${w.path}${w.reason?`: ${w.reason}`:""})`).join("; ")),v=Object.freeze([{key:"startup",label:"Startup diagnostics",path:"/api/startup/diagnostics"},{key:"subsystems",label:"Subsystem status",path:"/api/subsystems/status"},{key:"sshPool",label:"SSH pool",path:"/api/pools/ssh"},{key:"httpPool",label:"HTTP pool",path:"/api/pools/http"},{key:"riskStats",label:"Risk stats",path:"/api/risk/stats"},{key:"recoveryStats",label:"Recovery stats",path:"/api/recovery/stats"},{key:"compressionStats",label:"Compression stats",path:"/api/compression/stats"},{key:"freshnessStats",label:"Freshness stats",path:"/api/freshness/stats"},{key:"governorStats",label:"Governor stats",path:"/api/governor/stats"}]);let S=null;async function R(){var N;const w=await Promise.allSettled(v.map(U=>q.get(U.path))),A=U=>w[U].status==="fulfilled"?w[U].value:null;t.value=A(0)||{};const C=A(1);s.value=Array.isArray(C)?C:C&&C.subsystems||[],n.value=A(2)||{},a.value=A(3)||{},i.value=A(4),l.value=A(5),o.value=A(6),r.value=A(7),c.value=A(8);const y=w.filter(U=>U.status==="rejected");if(h.value=w.flatMap((U,E)=>{var M;return U.status==="rejected"?[{...v[E],reason:((M=U.reason)==null?void 0:M.message)||"request failed"}]:[]}),p.value=h.value.length,y.length===w.length){const U=(N=y[0])==null?void 0:N.reason;u.value=(U==null?void 0:U.message)||"Failed to load internals"}else u.value="";e.value=!1}function x(){e.value=!0,u.value="",R()}let g=!1;function b(){g||(g=!0,R(),S||(S=setInterval(R,3e4)))}function k(){g&&(g=!1,S&&(clearInterval(S),S=null))}return Ge(b),hs(b),ns(k),gt(k),{loading:e,error:u,failedCount:p,failedEndpoints:h,failedEndpointSummary:m,endpoints:v,retry:x,startup:t,subsystems:s,sshPool:n,httpPool:a,riskStats:i,riskTotal:d,recoveryStats:l,compressionStats:o,freshnessStats:r,governorStats:c,statusColor:Fk,formatAgeSeconds:pw}}},Bk=1e4,Xu=3e4;function _i(e,t){return Math.max(0,e-t)}function vr(e,t){return new Set((e.operations||[]).map(n=>n.state)).has("MANUAL_RESOLUTION_REQUIRED")?0:e.expired_lease||e.status==="ACTIVE"&&(!e.lease_expires_at||e.lease_expires_at<t)?1:e.status==="SUSPENDED"?2:e.status==="ACTIVE"?3:4}const Uk=[{label:"Manual resolution required",cls:"badge-danger"},{label:"Lease expired",cls:"badge-warning"},{label:"Suspended",cls:"badge-warning"},{label:"Active",cls:"badge-success"},{label:"Terminal",cls:"badge-info"}],Hk={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=f(null),t=f(""),s=f(null),n=f(!1),a=f(0),i=f(null),l=f(""),o=f(null),r=f(!1),c=f(0),d=f(Date.now());let u=null,p=0,h=0;async function m(){const L=++p;n.value=!0;try{const I=await q.get("/api/turn-state/turns?limit=100");if(L!==p)return;t.value=I.availability,e.value=I.availability==="available"?I.data:null,s.value=null,a.value=Date.now()}catch(I){if(L!==p)return;s.value=I.message||"Turn-state read failed",I.status===503&&(t.value="unavailable")}L===p&&(n.value=!1)}async function v(){const L=++h;r.value=!0;try{const I=await q.get("/api/turn-state/capacity-breakers");if(L!==h)return;l.value=I.availability,i.value=I.availability==="available"?I.data:null,o.value=null,c.value=Date.now()}catch(I){if(L!==h)return;o.value=I.message||"Breaker read failed",I.status===503&&(l.value="unavailable")}L===h&&(r.value=!1)}function S(){m(),v()}const R=Z(()=>e.value!==null&&_i(d.value,a.value)>Xu),x=Z(()=>i.value!==null&&_i(d.value,c.value)>Xu),g=Z(()=>R.value||x.value),b=Z(()=>Math.round(_i(d.value,a.value)/1e3)),k=Z(()=>Math.round(_i(d.value,c.value)/1e3));function w(L){return vr(L,d.value/1e3)}function A(L){return Uk[w(L)]}const C=Z(()=>{var H;const L=[...((H=e.value)==null?void 0:H.turns)||[]],I=d.value/1e3;return L.sort((K,G)=>vr(K,I)-vr(G,I)||(G.last_progress_at||0)-(K.last_progress_at||0))});function y(L){return L.state==="closed"?"badge-success":L.state==="probing"?"badge-warning":"badge-danger"}function N(L){if(L.state==="closed")return"—";const I=_i(d.value,c.value)/1e3,H=Math.max(0,(L.cooldown_remaining_seconds||0)-I);return H>0?`${Math.ceil(H)}s`:L.state==="probing"?"probe in flight":"probe eligible"}function U(L){if(!L)return"";const I=Math.max(0,Math.round(d.value/1e3-L));if(I<90)return`${I}s ago`;const H=Math.round(I/60);return H<90?`${H}m ago`:`${Math.round(H/60)}h ago`}let E=null,M=null,$=!1;function Q(){$||($=!0,S(),E=setInterval(S,Bk),u=setInterval(()=>{d.value=Date.now()},1e3),M=Ye.onReconnected(S))}function P(){$&&($=!1,E&&(clearInterval(E),E=null),u&&(clearInterval(u),u=null),M&&(M(),M=null))}return Ge(Q),hs(Q),ns(P),gt(P),{turnsData:e,turnsAvailability:t,turnsError:s,turnsLoading:n,breakersData:i,breakersAvailability:l,breakersError:o,breakersLoading:r,turnsStale:R,breakersStale:x,anyStale:g,turnsAgeSeconds:b,breakersAgeSeconds:k,sortedTurns:C,priorityOf:w,priorityBadge:A,breakerBadge:y,cooldownLabel:N,ageLabel:U,fetchTurns:m,fetchBreakers:v,refreshAll:S,arm:Q,disarm:P}}},zk={setup(){const e=f(""),t=f(""),s=f(!1),n=f(""),a=f(!1),i=f(!1),l=f(!1),o=f(null),r=f(!1);async function c(){a.value=!0,o.value=null,r.value=!1;try{const u=await q.get("/api/update/check");e.value=u.current||"",t.value=u.latest||"",s.value=u.update_available||!1,n.value=u.changelog||"",u.error&&(o.value=u.error),r.value=!0}catch(u){o.value=u.message}finally{a.value=!1}}async function d(){if(await Ut({title:"Update & restart",message:"Update Odin and restart? Active tasks will be interrupted.",confirmLabel:"Update & Restart",danger:!0})){i.value=!0,o.value=null;try{await q.post("/api/update/apply",{version:"latest"}),l.value=!0,setTimeout(()=>location.reload(),8e3)}catch(p){o.value=p.message}finally{i.value=!1}}}return Ge(c),{current:e,latest:t,updateAvailable:s,changelog:n,checking:a,applying:i,applied:l,error:o,checkDone:r,checkUpdate:c,applyUpdate:d}},template:`
...
`,e=e.substring(p.length+1),r=!0),!r){const R=this.rules.other.nextBulletRegex(m),x=this.rules.other.hrRegex(m),g=this.rules.other.fencesBeginRegex(m),b=this.rules.other.headingBeginRegex(m),k=this.rules.other.htmlBeginRegex(m);for(;e;){const w=e.split(`
`,1)[0];let A;if(p=w,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),A=p):A=p.replace(this.rules.other.tabCharGlobal,"    "),g.test(p)||b.test(p)||k.test(p)||R.test(p)||x.test(p))break;if(A.search(this.rules.other.nonSpaceChar)>=m||!p.trim())d+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+en(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},xa=new r1;function st(e,t){return xa.parse(e,t)}st.options=st.setOptions=function(e){return xa.setOptions(e),st.defaults=xa.defaults,Gm(st.defaults),st};st.getDefaults=ld;st.defaults=Ca;st.use=function(...e){return xa.use(...e),st.defaults=xa.defaults,Gm(st.defaults),st};st.walkTokens=function(e,t){return xa.walkTokens(e,t)};st.parseInline=xa.parseInline;st.Parser=Sn;st.parser=Sn.parse;st.Renderer=go;st.TextRenderer=hd;st.Lexer=kn;st.lexer=kn.lex;st.Tokenizer=vo;st.Hooks=Ul;st.parse=st;st.options;st.setOptions;st.use;st.walkTokens;st.parseInline;Sn.parse;kn.lex;const c1={breaks:!0,gfm:!0};function _p(e){if(!e)return"";try{if(typeof st<"u"&&st.parse){const t=st.parse(e,c1);return typeof mp<"u"?mp.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function d1(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const u1={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",apply_patch:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function p1(e){return u1[e]||"wrench"}const f1=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function wp(e){if(!e)return[];const t=e.match(f1);return t?[...new Set(t)]:[]}const h1={template:`
    ...
    </div>`,setup(){const e=f([]),t=f(""),s=f(!1),n=f(""),a=f(null),i=f(null),l=f(0),o=f("");let r=null,c=0;const d=["Check system health","List running services","Show disk usage","What can you do?"],u=Z(()=>t.value.trim().length>0&&!s.value),p=f(Ye.state||"disconnected");let h=null;const m=Z(()=>{const P=p.value;return P==="connected"?"Connected":P==="reconnecting"?"Reconnecting…":P==="connecting"?"Connecting…":"REST fallback"}),v=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],S=Z(()=>{const P=Math.floor(l.value/4)%v.length,L=l.value;return L>3?`${v[P]} (${L}s)`:v[0]});function R(){Rt(()=>{a.value&&(a.value.scrollTop=a.value.scrollHeight)})}function x(){if(!i.value)return;const P=i.value;P.style.height="auto",P.style.height=Math.min(P.scrollHeight,120)+"px"}function g(P,L,I={}){const H={id:++c,role:P,content:L,timestamp:Date.now(),html:P==="bot"?_p(L):"",tools_used:I.tools_used||[],is_error:I.is_error||!1,images:P==="bot"?wp(L):[],files:I.files||[],_showTools:!1};return e.value.push(H),R(),P==="bot"&&Rt(()=>b()),H}function b(){if(!a.value)return;a.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(L=>{L.setAttribute("data-copy","true"),L.style.position="relative";const I=document.createElement("button");I.className="chat-code-copy",I.textContent="Copy",I.addEventListener("click",()=>{const H=L.querySelector("code"),K=H?H.textContent:L.textContent;navigator.clipboard.writeText(K).then(()=>{I.textContent="Copied!",setTimeout(()=>{I.textContent="Copy"},1500)}).catch(()=>{})}),L.appendChild(I)})}function k(P){if(P===0)return!0;const L=e.value[P-1],I=e.value[P],H=new Date(L.timestamp).toDateString(),K=new Date(I.timestamp).toDateString();return H!==K}function w(P){const L=new Date(P),I=new Date;if(L.toDateString()===I.toDateString())return"Today";const H=new Date(I);return H.setDate(H.getDate()-1),L.toDateString()===H.toDateString()?"Yesterday":L.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function A(P){t.value=P,Rt(()=>$())}function C(P){window.open(P,"_blank","noopener")}function y(P){P.target.style.display="none"}function N(){l.value=0,r=setInterval(()=>{l.value++},1e3)}function U(){r&&(clearInterval(r),r=null),l.value=0}function E(P){s.value&&(s.value=!1,U(),P.type==="chat_response"?g("bot",P.content,{tools_used:P.tools_used||[],is_error:P.is_error||!1,files:P.files||[]}):P.type==="chat_error"&&g("bot",P.error||"Unknown error",{is_error:!0}),Rt(()=>{var L;return(L=i.value)==null?void 0:L.focus()}))}async function M(P){try{const L=await q.post("/api/chat",{content:P,channel_id:o.value});g("bot",L.response,{tools_used:L.tools_used||[],is_error:L.is_error||!1,files:L.files||[]})}catch(L){g("bot",L.message||"Failed to send message",{is_error:!0})}}async function $(){const P=t.value.trim();if(!P||s.value)return;g("user",P),t.value="",s.value=!0,N(),i.value&&(i.value.style.height="auto"),Ye.connected&&Ye.sendChat(P,{channelId:o.value})||(await M(P),s.value=!1,U()),Rt(()=>{var I;return(I=i.value)==null?void 0:I.focus()})}async function Q(){n.value="";try{if(!o.value){const L=await q.get("/api/auth/session");o.value=L.channel_id||L.user_id||"web-user"}const P=await q.get("/api/sessions/"+encodeURIComponent(o.value));if(P&&P.messages&&P.messages.length>0){for(const L of P.messages){const I=L.role==="user"?"user":"bot";let H=L.content||"";if(I==="user"){const G=H.match(/^\[.*?\]:\s*/);G&&(H=H.slice(G[0].length))}if(!H.trim())continue;const K={id:++c,role:I,content:H,timestamp:L.timestamp?L.timestamp*1e3:Date.now(),html:I==="bot"?_p(H):"",tools_used:[],is_error:!1,images:I==="bot"?wp(H):[],files:[],_showTools:!1};e.value.push(K)}Rt(()=>{R(),b()})}}catch(P){P&&P.status!==404&&(n.value="Couldn't load chat history — earlier messages may be missing. Refresh to retry.",_e.error(n.value))}}return Ge(()=>{Ye.subscribe("chat",E),p.value=Ye.state||"disconnected",h=Ye.onState(P=>{p.value=P}),Q(),Rt(()=>{var P;return(P=i.value)==null?void 0:P.focus()})}),gt(()=>{Ye.unsubscribe("chat",E),h&&(h(),h=null),U()}),{messages:e,input:t,sending:s,historyError:n,messagesEl:a,inputEl:i,canSend:u,wsStatus:m,typingText:S,suggestions:d,send:$,autoResize:x,formatTime:d1,formatDate:w,showDateSeparator:k,useSuggestion:A,openImage:C,onImageError:y,getToolIcon:p1,loadHistory:Q}}},m1={setup(){const e=f("odin"),t=f(""),s=f(""),n=f(""),a=f({}),i=f([]),l=f([]),o=f(!1),r=f(!1),c=f(null),d=f(!0),u=f(""),p=f(!1),h=f(!1),m=Z(()=>e.value==="custom"),v=Z(()=>[...i.value,...l.value]),S=Z(()=>l.value.includes(e.value)),R=Z(()=>{var C;return m.value?t.value||"Odin":((C=a.value[e.value])==null?void 0:C.name)||e.value}),x=Z(()=>{var C;return m.value?s.value||"(empty — will use Odin default)":((C=a.value[e.value])==null?void 0:C.identity)||""}),g=Z(()=>{var C;return m.value?n.value||"(empty — will use Odin default)":((C=a.value[e.value])==null?void 0:C.voice)||""});async function b(){d.value=!0;try{const C=await q.get("/api/personality");e.value=C.preset||"odin",t.value=C.custom_name||"",s.value=C.custom_identity||"",n.value=C.custom_voice||"",a.value=C.presets||{},i.value=C.builtin_presets||[],l.value=C.user_presets||[]}catch(C){c.value=C.message}finally{d.value=!1}}async function k(){o.value=!0,c.value=null,r.value=!1;try{await q.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),r.value=!0,setTimeout(()=>r.value=!1,3e3)}catch(C){c.value=C.message}finally{o.value=!1}}async function w(){const C=u.value.trim();if(C){h.value=!0,c.value=null;try{await q.post("/api/personality/presets",{name:C,display_name:R.value,identity:x.value,voice:g.value}),p.value=!1,u.value="",await b(),e.value=C.toLowerCase().replace(/ /g,"_")}catch(y){c.value=y.message}finally{h.value=!1}}}async function A(){if(await Ut({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await q.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await b(),e.value="odin"}catch(y){c.value=y.message}}}return Ge(b),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:v,isCustom:m,isUserPreset:S,previewName:R,previewIdentity:x,previewVoice:g,saving:o,saved:r,error:c,loading:d,save:k,showSavePreset:p,newPresetName:u,savingPreset:h,saveAsPreset:w,deletePreset:A,builtinPresets:i,userPresets:l}},template:`
  ...
  `},_t=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),nv=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:Jk,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:h1,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:Sw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:Nw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:ek,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:m1,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:jk,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:_t("/operations","live")},{path:"/agents",redirect:_t("/operations","agents")},{path:"/loops",redirect:_t("/operations","loops")},{path:"/processes",redirect:_t("/operations","processes")},{path:"/schedules",redirect:_t("/operations","schedules")},{path:"/audit",redirect:_t("/history","audit")},{path:"/sessions",redirect:_t("/history","sessions")},{path:"/traces",redirect:_t("/history","traces")},{path:"/usage",redirect:_t("/history","usage")},{path:"/tools",redirect:_t("/capabilities","tools")},{path:"/skills",redirect:_t("/capabilities","skills")},{path:"/mcp",redirect:_t("/capabilities","mcp-servers")},{path:"/knowledge",redirect:_t("/capabilities","knowledge")},{path:"/memory",redirect:_t("/capabilities","memory")},{path:"/learned",redirect:_t("/capabilities","learned")},{path:"/health",redirect:_t("/system","health")},{path:"/resources",redirect:_t("/system","resources")},{path:"/logs",redirect:_t("/system","logs")},{path:"/config",redirect:_t("/system","config")},{path:"/host-access",redirect:_t("/system","host-access")},{path:"/hosts",redirect:_t("/system","hosts")},{path:"/internals",redirect:_t("/system","internals")}],Ui=rw({history:U_(),routes:nv});Ui.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const v1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=f("checking"),t=f(!1),s=f(!1),n=f(!1),a=f(null),i=f(null),l=f(!1);let o=null,r=null;const c=f(!1),d=f("disconnected"),u=f(-1),p=f(null);let h=null;const m=f("starting"),v=f(""),S=nv.filter(H=>H.meta),R=Z(()=>["Workspace","Operate","Observe","Manage"].map(H=>({name:H,routes:S.filter(K=>K.meta.section===H)})).filter(H=>H.routes.length)),x=Z(()=>{var H;return((H=Ui.currentRoute.value.meta)==null?void 0:H.label)||"Odin"}),g=Z(()=>{var H;return((H=Ui.currentRoute.value.meta)==null?void 0:H.section)||"Management"}),b=Z(()=>{var H;return((H=Ui.currentRoute.value.meta)==null?void 0:H.description)||"Management console"});function k(){Ye.disconnect(),$&&(clearInterval($),$=null)}q.onSessionExpired=()=>{t.value=!0,k(),q.setToken(""),e.value="login"};function w(H){var K;if((H.ctrlKey||H.metaKey)&&H.key.toLowerCase()==="k"){e.value==="ready"&&(H.preventDefault(),ep());return}if(n.value&&H.key==="Tab"){const G=[...((K=a.value)==null?void 0:K.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(G.length){const X=G[0],le=G[G.length-1];if(H.shiftKey&&(document.activeElement===X||!a.value.contains(document.activeElement))){H.preventDefault(),le.focus();return}if(!H.shiftKey&&(document.activeElement===le||!a.value.contains(document.activeElement))){H.preventDefault(),X.focus();return}}}if(H.key==="Escape"&&n.value){n.value=!1,H.preventDefault();return}if(H.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(H.target.tagName)){H.preventDefault();const G=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');G&&G.focus()}}function A(){l.value=!!(o!=null&&o.matches),l.value||(n.value=!1)}Ge(async()=>{document.addEventListener("keydown",w),o=window.matchMedia("(max-width: 900px)"),A(),o.addEventListener("change",A);const H=await q.check();H.ok?(e.value="ready",L()):H.needsAuth?e.value="login":(e.value="ready",L())});function C(){t.value=!1,e.value="ready",L()}async function y(){k(),e.value="login",await q.logout()}function N(){s.value=!s.value}function U(){n.value=!n.value}us(n,async H=>{var K,G;if(H)r=document.activeElement,await Rt(),(G=(K=a.value)==null?void 0:K.querySelector(".nav-item"))==null||G.focus();else if(r!=null&&r.isConnected){const X=r;r=null,requestAnimationFrame(()=>X.focus())}});const E=Z(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function M(H,K="info",G=3e3){p.value={text:H,level:K},clearTimeout(h),h=setTimeout(()=>{p.value=null},G)}let $=null,Q=!1,P=[];function L(){for(const H of P)H();P=[Ye.onStatus(H=>{c.value=H}),Ye.onLatencyChange(H=>{u.value=H}),Ye.onState((H,K)=>{d.value=H,H==="connected"?(Q&&M("Connection restored","success"),Q=!0):H==="reconnecting"&&K.attempt===1&&M("Connection lost — reconnecting…","warn")})],Ye.connect(),I(),$&&clearInterval($),$=setInterval(I,15e3)}async function I(){try{const H=await q.get("/api/status");m.value=H.status==="online"?"online":"starting";const K=H.uptime_seconds||0,G=Math.floor(K/3600),X=Math.floor(K%3600/60);v.value=`${G}h ${X}m uptime`}catch{m.value="offline",v.value=""}}return gt(()=>{$&&clearInterval($);for(const H of P)H();P=[],Ye.disconnect(),document.removeEventListener("keydown",w),o==null||o.removeEventListener("change",A)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:E,wsToast:p,botStatus:m,botUptime:v,navRoutes:S,navGroups:R,currentPage:x,currentSection:g,currentDescription:b,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:C,logout:y,toggleSidebar:N,toggleMobileNavigation:U,openPalette:ep}}},Qn=ao(g1);Qn.component("odin-icon",Kk);Qn.component("login-screen",v1);Qn.component("toast-container",e_);Qn.component("confirm-host",t_);Qn.component("command-palette",Gk);Qn.directive("modal-focus",Zk);Qn.use(Ui);Qn.mount("#app");
