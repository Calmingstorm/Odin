...
`,e=e.substring(f.length+1),o=!0),!o){const O=this.rules.other.nextBulletRegex(b),y=this.rules.other.hrRegex(b),v=this.rules.other.fencesBeginRegex(b),x=this.rules.other.headingBeginRegex(b),C=this.rules.other.htmlBeginRegex(b);for(;e;){const N=e.split(`
`,1)[0];let L;if(f=N,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),L=f):L=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||C.test(f)||O.test(f)||y.test(f))break;if(L.search(this.rules.other.nonSpaceChar)>=b||!f.trim())u+=`
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Is(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Kn=new Wk;function qe(e,t){return Kn.parse(e,t)}qe.options=qe.setOptions=function(e){return Kn.setOptions(e),qe.defaults=Kn.defaults,lg(qe.defaults),qe};qe.getDefaults=Oc;qe.defaults=Yn;qe.use=function(...e){return Kn.use(...e),qe.defaults=Kn.defaults,lg(qe.defaults),qe};qe.walkTokens=function(e,t){return Kn.walkTokens(e,t)};qe.parseInline=Kn.parseInline;qe.Parser=Ys;qe.parser=Ys.parse;qe.Renderer=Bl;qe.TextRenderer=Hc;qe.Lexer=Js;qe.lexer=Js.lex;qe.Tokenizer=Ul;qe.Hooks=ul;qe.parse=qe;qe.options;qe.setOptions;qe.use;qe.walkTokens;qe.parseInline;Ys.parse;Js.lex;const Zk={breaks:!0,gfm:!0};function zd(e){if(!e)return"";try{if(typeof qe<"u"&&qe.parse){const t=qe.parse(e,Zk);return typeof $d<"u"?$d.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Jk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Yk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Qk(e){return Yk[e]||"wrench"}const Xk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function qd(e){if(!e)return[];const t=e.match(Xk);return t?[...new Set(t)]:[]}const ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=J(()=>t.value.trim().length>0&&!s.value),d=J(()=>{const S=We.state;return S==="connected"?"Connected":S==="reconnecting"?"Reconnecting…":S==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=J(()=>{const S=Math.floor(i.value/4)%f.length,$=i.value;return $>3?`${f[S]} (${$}s)`:f[0]});function b(){St(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const S=a.value;S.style.height="auto",S.style.height=Math.min(S.scrollHeight,120)+"px"}function E(S,$,W={}){const K={id:++o,role:S,content:$,timestamp:Date.now(),html:S==="bot"?zd($):"",tools_used:W.tools_used||[],is_error:W.is_error||!1,images:S==="bot"?qd($):[],files:W.files||[],_showTools:!1};return e.value.push(K),b(),S==="bot"&&St(()=>O()),K}function O(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach($=>{$.setAttribute("data-copy","true"),$.style.position="relative";const W=document.createElement("button");W.className="chat-code-copy",W.textContent="Copy",W.addEventListener("click",()=>{const K=$.querySelector("code"),w=K?K.textContent:$.textContent;navigator.clipboard.writeText(w).then(()=>{W.textContent="Copied!",setTimeout(()=>{W.textContent="Copy"},1500)}).catch(()=>{})}),$.appendChild(W)})}function y(S){if(S===0)return!0;const $=e.value[S-1],W=e.value[S],K=new Date($.timestamp).toDateString(),w=new Date(W.timestamp).toDateString();return K!==w}function v(S){const $=new Date(S),W=new Date;if($.toDateString()===W.toDateString())return"Today";const K=new Date(W);return K.setDate(K.getDate()-1),$.toDateString()===K.toDateString()?"Yesterday":$.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(S){t.value=S,St(()=>U())}function C(S){window.open(S,"_blank","noopener")}function N(S){S.target.style.display="none"}function L(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function T(){r&&(clearInterval(r),r=null),i.value=0}function R(S){s.value&&(s.value=!1,T(),S.type==="chat_response"?E("bot",S.content,{tools_used:S.tools_used||[],is_error:S.is_error||!1,files:S.files||[]}):S.type==="chat_error"&&E("bot",S.error||"Unknown error",{is_error:!0}),St(()=>{var $;return($=a.value)==null?void 0:$.focus()}))}async function D(S){try{const $=await G.post("/api/chat",{content:S,channel_id:l.value});E("bot",$.response,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]})}catch($){E("bot",$.message||"Failed to send message",{is_error:!0})}}async function U(){const S=t.value.trim();if(!S||s.value)return;E("user",S),t.value="",s.value=!0,L(),a.value&&(a.value.style.height="auto"),We.connected&&We.sendChat(S,{channelId:l.value})||(await D(S),s.value=!1,T()),St(()=>{var W;return(W=a.value)==null?void 0:W.focus()})}async function P(){try{if(!l.value){const $=await G.get("/api/auth/session");l.value=$.channel_id||$.user_id||"web-user"}const S=await G.get("/api/sessions/"+encodeURIComponent(l.value));if(S&&S.messages&&S.messages.length>0){for(const $ of S.messages){const W=$.role==="user"?"user":"bot";let K=$.content||"";if(W==="user"){const k=K.match(/^\[.*?\]:\s*/);k&&(K=K.slice(k[0].length))}if(!K.trim())continue;const w={id:++o,role:W,content:K,timestamp:$.timestamp?$.timestamp*1e3:Date.now(),html:W==="bot"?zd(K):"",tools_used:[],is_error:!1,images:W==="bot"?qd(K):[],files:[],_showTools:!1};e.value.push(w)}St(()=>{b(),O()})}}catch{}}return He(()=>{We.subscribe("chat",R),P(),St(()=>{var S;return(S=a.value)==null?void 0:S.focus()})}),gt(()=>{We.unsubscribe("chat",R),T()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:U,autoResize:g,formatTime:Jk,formatDate:v,showDateSeparator:y,useSuggestion:x,openImage:C,onImageError:N,getToolIcon:Qk}}},vr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=A_(),s=Xh(),n=J({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=J(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=J(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});gs(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var u;return(u=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:u.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
  ...
  `},tw={setup(){const e=h([]),t=h([]),s=h({}),n=50;function a(c){var f,p,b;const u=c.payload||c,d=u.type||c.type;if(d==="tool_start"){const g={id:`${u.action}-${Date.now()}`,tool:u.action,actor:u.actor||"",channel:u.channel_id||"",iteration:((f=u.metadata)==null?void 0:f.iteration)??0,startTime:Date.now(),elapsed:0,status:"running",output:"",result:""};e.value.unshift(g);return}if(d==="tool_end"){const g=e.value.findIndex(E=>E.tool===u.action&&E.status==="running");if(g>=0){const E=e.value[g];E.status=(p=u.metadata)!=null&&p.error?"error":"success",E.elapsed=((b=u.metadata)==null?void 0:b.elapsed_ms)||Date.now()-E.startTime,E.result=u.detail||"",E.fadingOut=!0,setTimeout(()=>{const O=e.value.indexOf(E);O>=0&&e.value.splice(O,1),t.value.unshift(E),t.value.length>n&&t.value.pop()},5e3)}return}if(d==="tool_stream"){const g=u.tool_name||"unknown";if(u.finished)delete s.value[g];else{const O=((s.value[g]||"")+(u.chunk||"")).split(`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}He(()=>{We.on("events",a),i=setInterval(l,500)}),gt(()=>{We.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=null;const r=J(()=>e.value.filter(w=>w.status==="running").length),o=J(()=>e.value.filter(w=>w.status==="completed").length),c=J(()=>e.value.filter(w=>["failed","timeout","killed"].includes(w.status)).length),u=J(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),d=J(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(w=>["failed","timeout","killed"].includes(w.status)):e.value.filter(w=>w.status===i.value));function f(w){const k=Number(w.max_iterations)||0;return k<=0?0:Math.min(100,Math.round(w.iteration_count/k*100))}function p(w){return(Number(w.max_iterations)||0)>0}function b(w,k){return w?w==="N/A"?"N/A":k==="current_inheritance"?`inherit (currently ${w})`:w:"unknown"}function g(w){return b(w.display_model,w.display_model_source||w.display_source)}function E(w){return b(w.display_reasoning_effort,w.display_reasoning_effort_source||w.display_source)}function O(w){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[w]||""}const y=h(null),v=h(null),x=h(!1),C=h(null),N=h("");let L=null;async function T(w,{initial:k}){const V={};L=V,k&&(y.value=null,C.value=null,x.value=!0);let le=null,ue=null;try{le=await G.get(`/api/agents/${encodeURIComponent(w)}`)}catch(te){ue=te}L===V&&(L=null,ue?k&&(C.value=ue.message||"Failed to load agent detail"):(y.value=le,C.value=null),x.value=!1)}async function R(w){v.value=w.id,N.value="",await T(w.id,{initial:!0})}function D(){L=null,v.value=null,y.value=null,C.value=null,x.value=!1,N.value=""}async function U(){v.value&&await T(v.value,{initial:!1})}async function P(w,k){try{await navigator.clipboard.writeText(k||""),N.value=w,setTimeout(()=>{N.value===w&&(N.value="")},1500)}catch{_e.error("Copy failed")}}async function S(w=!1){w=w===!0,w||(t.value=!0);try{const k=await G.get("/api/agents");e.value=Array.isArray(k)?k:[],s.value=null}catch(k){w||(s.value=k.message)}w||(t.value=!1)}async function $(w){const k=e.value.find(le=>le.id===w);if(await rs({title:"Kill agent",message:`Kill agent "${(k==null?void 0:k.label)||w}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=w;try{await G.del(`/api/agents/${encodeURIComponent(w)}`),_e.success("Agent killed"),await S()}catch(le){_e.error(le.message||"Failed to kill agent")}n.value=null}}function W(){K(),a.value&&(l=setInterval(()=>{a.value&&(S(!0),v.value&&U())},5e3))}function K(){l&&(clearInterval(l),l=null)}return He(()=>{S(),W()}),er(()=>{S(!0),W()}),tr(K),gt(K),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:u,filteredAgents:d,formatTs:Fa,formatDuration:Oa,progressPercent:f,hasProgress:p,displayModelText:g,displayEffortText:E,displaySourceLabel:O,detail:y,detailId:v,detailLoading:x,detailError:C,copied:N,openDetail:R,closeDetail:D,copyText:P,fetchAgents:S,killAgent:$,startAutoRefresh:W,stopAutoRefresh:K}}},nw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=J(()=>e.value.reduce((N,L)=>N+(L.iteration_count||0),0)),d=J(()=>e.value.filter(N=>N.status==="running").length);function f(N){return N==="running"?"loop-status-running":N==="error"?"loop-status-error":"loop-status-stopped"}function p(N){return N==="running"?"badge-success":N==="error"?"badge-danger":N==="completed"?"badge-info":"badge-warning"}function b(N){return N==="act"?"badge-warning":N==="silent"?"badge-info":"badge-success"}function g(N){c.value={...c.value,[N]:!c.value[N]}}async function E(N=!1){N=N===!0,N||(t.value=!0);try{e.value=await G.get("/api/loops"),s.value=null}catch(L){N||(s.value=L.message)}N||(t.value=!1)}async function O(){l.value=null;const N=a.value;if(!N.goal.trim()){l.value="Goal is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}const L={goal:N.goal.trim(),channel_id:N.channel_id.trim(),interval_seconds:N.interval_seconds||60,mode:N.mode,max_iterations:N.max_iterations||50};N.stop_condition.trim()&&(L.stop_condition=N.stop_condition.trim()),i.value=!0;try{const T=await G.post("/api/loops",L);_e.success(`Loop started: ${T.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await E()}catch(T){l.value=T.message}i.value=!1}async function y(N){if(await rs({title:"Stop loop",message:`Stop loop ${N}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=N;try{await G.del(`/api/loops/${encodeURIComponent(N)}`),_e.success("Loop stopped"),await E()}catch(T){_e.error(T.message||"Failed to stop loop")}r.value=null}}async function v(N){o.value=N;try{await G.post(`/api/loops/${encodeURIComponent(N)}/restart`),_e.success("Loop restarted"),await E()}catch(L){_e.error(L.message||"Failed to restart loop")}o.value=null}function x(N){N.payload&&(N.payload.loop_id||N.payload.type==="loop")&&E(!0)}let C=null;return He(()=>{E(),We.subscribe("events",x),C=setInterval(()=>{E(!0)},5e3)}),gt(()=>{We.unsubscribe("events",x),C&&clearInterval(C)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:b,formatDuration:Oa,formatAge:eg,toggleHistory:g,fetchLoops:E,doCreate:O,doStop:y,doRestart:v}}},aw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=J(()=>e.value.filter(g=>g.status==="running").length),r=J(()=>e.value.filter(g=>g.status!=="running").length);function o(g){return g==="running"?"loop-status-running":g==="failed"||g==="error"?"loop-status-error":"loop-status-stopped"}function c(g){return g==="running"?"badge-success":g==="completed"||g==="exited"?"badge-info":g==="killed"||g==="error"||g==="failed"?"badge-danger":"badge-warning"}async function u(g=!1){g=g===!0,g||(t.value=!0);try{e.value=await G.get("/api/processes"),s.value=null}catch(E){g||(s.value=E.message)}g||(t.value=!1)}function d(){f(),n.value&&(a=setInterval(()=>{t.value||u(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}gs(n,g=>{g?d():f()});async function p(g){if(await rs({title:"Kill process",message:`Kill process ${g}?`,confirmLabel:"Kill",danger:!0})){i.value=g;try{await G.del(`/api/processes/${g}`),_e.success(`Process ${g} killed`),await u()}catch(O){_e.error(O.message||"Failed to kill process")}i.value=null}}function b(g){g.payload&&(g.payload.pid||g.payload.type==="process")&&u(!0)}return He(()=>{u(),We.subscribe("events",b),d()}),gt(()=>{We.unsubscribe("events",b),f()}),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:Oa,fetchProcesses:u,doKill:p}}},iw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),b=h(null),g=h([]),E=h(!1),O=J(()=>e.value.filter(w=>w.cron&&!w.one_time).length),y=J(()=>e.value.filter(w=>w.one_time).length),v=J(()=>e.value.filter(w=>w.trigger).length),x=J(()=>e.value.filter(w=>w.paused).length),C=J(()=>e.value.filter(w=>w.consecutive_failures>0).length);function N(w){if(!w)return"-";const k=Date.now(),le=(new Date(w).getTime()-k)/1e3;if(le<0)return"overdue";if(le<60)return"in < 1 min";if(le<3600)return`in ${Math.floor(le/60)} min`;if(le<86400){const te=Math.floor(le/3600),fe=Math.floor(le%3600/60);return fe>0?`in ${te}h ${fe}m`:`in ${te}h`}const ue=Math.floor(le/86400);return`in ${ue} day${ue!==1?"s":""}`}function L(w){return w==null?"-":w<1e3?`${w}ms`:w<6e4?`${(w/1e3).toFixed(1)}s`:Oa(w/1e3)}function T(){r.value=null}async function R(){const w=a.value.cron.trim();if(w){o.value=!0;try{r.value=await G.post("/api/schedules/validate-cron",{expression:w})}catch(k){r.value={valid:!1,error:k.message}}o.value=!1}}async function D(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(w){s.value=w.message}t.value=!1}async function U(w){if(b.value===w){b.value=null,g.value=[];return}b.value=w,E.value=!0,g.value=[];try{g.value=await G.get(`/api/schedules/${encodeURIComponent(w)}/history?limit=10`)}catch{g.value=[]}E.value=!1}async function P(){l.value=null;const w=a.value;if(!w.description.trim()){l.value="Description is required";return}if(!w.channel_id.trim()){l.value="Channel ID is required";return}if(!w.cron.trim()&&!w.run_at.trim()){l.value="Cron expression or run_at time is required";return}const k={description:w.description.trim(),action:w.action,channel_id:w.channel_id.trim()};if(w.cron.trim()&&(k.cron=w.cron.trim()),w.run_at.trim()&&(k.run_at=w.run_at.trim()),w.action==="reminder"&&w.message.trim()&&(k.message=w.message.trim()),w.action==="check"&&(w.tool_name.trim()&&(k.tool_name=w.tool_name.trim()),w.tool_input_str.trim()))try{k.tool_input=JSON.parse(w.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",k),_e.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await D()}catch(V){l.value=V.message}i.value=!1}async function S(w){u.value=w;try{const k=await G.post(`/api/schedules/${encodeURIComponent(w)}/run`);if(k.status==="failure")_e.error(`Execution failed: ${k.error||"unknown error"}`);else{const V=k.warning?`Executed (${k.warning})`:"Executed successfully";_e.success(V)}await D()}catch(k){_e.error(k.message||"Failed to trigger")}u.value=null}async function $(w){f.value=w.id;const k=!w.paused;try{await G.put(`/api/schedules/${encodeURIComponent(w.id)}`,{paused:k}),_e.success(k?"Schedule paused":"Schedule resumed"),await D()}catch(V){_e.error(V.message||"Failed to update schedule")}f.value=null}async function W(w){p.value=w;try{await G.post(`/api/schedules/${encodeURIComponent(w)}/reset-failures`),_e.success("Failure counters reset"),await D()}catch(k){_e.error(k.message||"Failed to reset")}p.value=null}async function K(w){const k=e.value.find(le=>le.id===w);if(await rs({title:"Delete schedule",message:`Delete "${(k==null?void 0:k.description)||w}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=w;try{await G.del(`/api/schedules/${encodeURIComponent(w)}`),_e.success("Schedule deleted"),await D()}catch(le){_e.error(le.message||"Failed to delete schedule")}d.value=null}}return He(()=>{D()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:b,history:g,historyLoading:E,cronCount:O,oneTimeCount:y,webhookCount:v,pausedCount:x,failingCount:C,formatTs:Fa,formatAge:eg,formatFuture:N,formatMs:L,formatDuration:Oa,onCronInput:T,validateCron:R,toggleExpand:U,fetchSchedules:D,doCreate:P,doRunNow:S,doTogglePause:$,doResetFailures:W,doDelete:K}}},lw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),b=Kd,g=ow,E=h([]),O=h(!1),y=h(""),v=h("flat"),x=h(new Set),C=h(""),N=h(""),L=h(""),T=h(null),R=h(!1);function D(){try{const B=localStorage.getItem("odin-session-presets");B&&(E.value=JSON.parse(B))}catch{}}function U(){try{localStorage.setItem("odin-session-presets",JSON.stringify(E.value))}catch{}}const P=J(()=>d.value.trim()!==""||u.value!=="all"),S=J(()=>{let B=[...e.value];const oe=Kd.find(Je=>Je.id===u.value),ye=oe?oe.filters:{};if(ye.source&&(B=B.filter(Je=>Je.source===ye.source)),ye.minMessages&&(B=B.filter(Je=>Je.message_count>=ye.minMessages)),ye.hasCompaction&&(B=B.filter(Je=>Je.has_summary)),ye.maxAge!=null){const Je=Date.now()/1e3;B=B.filter(dt=>dt.last_active&&Je-dt.last_active<=ye.maxAge)}if(d.value.trim()){const Je=d.value.toLowerCase().trim();B=B.filter(dt=>(dt.channel_id||"").toLowerCase().includes(Je)||(dt.last_user_id||"").toLowerCase().includes(Je)||(dt.source||"").toLowerCase().includes(Je))}const Me=f.value,Ue=p.value?1:-1;return B.sort((Je,dt)=>{const Ye=Je[Me]||0,Ke=dt[Me]||0;return(Ye-Ke)*Ue}),B}),$=J(()=>{if(!a.value||!a.value.messages)return[];const B=a.value.messages;if(B.length===0)return[];const oe=[];let ye=[];for(const Me of B)Me.role==="user"&&ye.length>0&&(oe.push(ye),ye=[]),ye.push(Me);return ye.length>0&&oe.push(ye),oe}),W=J(()=>S.value.length>0&&o.value.size===S.value.length);function K(B){const oe=B.find(ye=>ye.role==="user");if(oe&&oe.content){const ye=oe.content.slice(0,120);return ye.length<oe.content.length?ye+"...":ye}return"(no user message)"}function w(B){const oe=new Set(x.value);oe.has(B)?oe.delete(B):oe.add(B),x.value=oe}function k(B){u.value=B}function V(B){u.value=B.id,B.filters.searchQuery!=null&&(d.value=B.filters.searchQuery),B.filters.sortBy&&(f.value=B.filters.sortBy)}function le(){if(!y.value.trim())return;const B={id:"custom-"+Date.now(),name:y.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};E.value=[...E.value,B],U(),O.value=!1,y.value=""}function ue(B){E.value=E.value.filter(oe=>oe.id!==B),U(),u.value===B&&(u.value="all")}function te(){u.value="all",d.value="",f.value="last_active",p.value=!1}function fe(B){if(!B)return"—";const oe=Date.now()/1e3-B;if(oe<60)return"just now";if(oe<3600){const Me=Math.floor(oe/60);return`${Me} minute${Me!==1?"s":""} ago`}if(oe<86400){const Me=Math.floor(oe/3600);return`${Me} hour${Me!==1?"s":""} ago`}const ye=Math.floor(oe/86400);return`${ye} day${ye!==1?"s":""} ago`}function Q(B){if(!B)return"";try{return new Date(B*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function de(B){if(!B)return"";try{return new Date(B*1e3).toLocaleString()}catch{return""}}function Ie(B){return B==="user"?"bg-gray-900/50 border border-gray-800":B==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function j(B){return B==="user"?"sess-msg-user":B==="assistant"?"sess-msg-assistant":"sess-msg-system"}function ce(B){return B==="user"?"badge-info":B==="assistant"?"badge-success":"badge-warning"}function ie(B){return B==="user"?"sess-dot-user":B==="assistant"?"sess-dot-assistant":"sess-dot-system"}function me(B){return B==="user"?"text-cyan-400":B==="assistant"?"text-indigo-400":"text-gray-500"}function pe(B){return B?B.length>2e3?B.slice(0,2e3)+`
... (truncated)`:B:""}async function Le(){const B=C.value.trim();if(B){R.value=!0;try{let oe=`/api/sessions/search?q=${encodeURIComponent(B)}&limit=50`;N.value.trim()&&(oe+=`&channel_id=${encodeURIComponent(N.value.trim())}`),L.value.trim()&&(oe+=`&user_id=${encodeURIComponent(L.value.trim())}`);const ye=await G.get(oe);T.value=ye.results||[]}catch{T.value=[]}R.value=!1}}function m(){C.value="",N.value="",L.value="",T.value=null}function A(B){return B?B.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(B){return B==="user"?"fts-result-user":B==="assistant"?"fts-result-assistant":B==="summary"?"fts-result-summary":B==="fts"?"fts-result-fts":B==="channel"?"fts-result-channel":"fts-result-default"}function Z(B){return B==="user"?"badge-info":B==="assistant"?"badge-success":B==="summary"?"badge-warning":B==="fts"?"badge-success":"badge-info"}async function I(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(B){s.value=B.message}t.value=!1}function F(){s.value=null,I()}async function Y(B){if(n.value===B){n.value=null,a.value=null,x.value=new Set;return}n.value=B,a.value=null,i.value=!0,x.value=new Set;try{a.value=await G.get(`/api/sessions/${encodeURIComponent(B)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function ee(B){const oe=new Set(o.value);oe.has(B)?oe.delete(B):oe.add(B),o.value=oe}function se(){W.value?o.value=new Set:o.value=new Set(S.value.map(B=>B.channel_id))}function X(B){l.value=B}async function be(){if(l.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await I()}catch(B){s.value=B.message||"Failed to clear session"}r.value=!1,l.value=null}}function re(){c.value=!0}async function ge(){if(o.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await I()}catch(B){s.value=B.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function xe(B,oe){const ye=G._token;let Me=`/api/sessions/${encodeURIComponent(B)}/export?format=${oe}`;ye&&(Me+=`&token=${encodeURIComponent(ye)}`);const Ue=document.createElement("a");Ue.href=Me,Ue.download=`session-${B}.${oe==="text"?"txt":"json"}`,document.body.appendChild(Ue),Ue.click(),document.body.removeChild(Ue)}let ke=null;function Ee(B){B.payload&&B.payload.channel_id&&(clearTimeout(ke),ke=setTimeout(()=>{I(),n.value&&B.payload.channel_id===n.value&&G.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(oe=>{a.value=oe}).catch(()=>{})},2e3))}return He(()=>{D(),I(),We.subscribe("events",Ee)}),gt(()=>{We.unsubscribe("events",Ee),clearTimeout(ke)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:W,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:b,sortOptions:g,filteredSessions:S,hasActiveFilters:P,customPresets:E,showSavePreset:O,newPresetName:y,threadView:v,threads:$,collapsedThreads:x,ftsQuery:C,ftsChannelId:N,ftsUserId:L,ftsResults:T,ftsSearching:R,formatAge:fe,formatTimestamp:Q,formatFullTimestamp:de,messageClass:Ie,threadMsgClass:j,roleBadge:ce,roleDotClass:ie,roleLabelClass:me,truncateContent:pe,threadSummary:K,fetchSessions:I,retry:F,toggleSession:Y,toggleSelect:ee,toggleSelectAll:se,confirmClear:X,clearSession:be,confirmBulkClear:re,doBulkClear:ge,exportSession:xe,applyPreset:k,applyCustomPreset:V,saveCustomPreset:le,removeCustomPreset:ue,resetFilters:te,toggleThread:w,runFtsSearch:Le,clearFtsSearch:m,highlightSnippet:A,ftsResultClass:M,ftsTypeBadge:Z}}},uw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:M_}}},dw={components:{ContextAssemblyPanel:uw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(L){if(!L)return"—";try{const T=new Date(L);return isNaN(T.getTime())?L:T.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return L}}function f(L){return!L&&L!==0?"—":L<1e3?L+"ms":(L/1e3).toFixed(1)+"s"}function p(L){return!L&&L!==0?"—":L>=1e3?(L/1e3).toFixed(1)+"k":String(L)}function b(L){if(!L)return"";if(typeof L=="string")return L;try{return JSON.stringify(L,null,2)}catch{return String(L)}}function g(L){a.value===L?a.value=null:(a.value=L,c.value={})}function E(L,T){const R=L+"-"+T;c.value={...c.value,[R]:!c.value[R]}}function O(L,T){return!!c.value[L+"-"+T]}function y(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,C()}async function v(){try{const L=await G.get("/api/trajectories");e.value=L.files||[],o.value=L.count||0}catch{}}let x=0;async function C(){const L=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const T=await G.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(L!==x)return;let R=T.entries||[];u.value.tool_name&&(R=R.filter(D=>(D.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(R=R.filter(D=>D.is_error)),u.value.channel_id&&(R=R.filter(D=>D.channel_id===u.value.channel_id)),u.value.user_id&&(R=R.filter(D=>D.user_id===u.value.user_id)),t.value=R}else{const T=new URLSearchParams;u.value.channel_id&&T.set("channel_id",u.value.channel_id),u.value.user_id&&T.set("user_id",u.value.user_id),u.value.tool_name&&T.set("tool_name",u.value.tool_name),u.value.errors_only&&T.set("errors_only","true"),T.set("limit",String(u.value.limit));const R=T.toString(),D=await G.get(`/api/trajectories/search/query?${R}`);if(L!==x)return;t.value=D.results||[]}}catch(T){if(L!==x)return;n.value=T.message}L===x&&(s.value=!1)}async function N(){if(!l.value.trim())return;const L=++x;s.value=!0,n.value=null,c.value={};try{const T=await G.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(L!==x)return;i.value=T.entry||null,i.value||(n.value="No trace found for this message ID")}catch(T){if(L!==x)return;T.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=T.message}L===x&&(s.value=!1)}return He(async()=>{await v(),await C()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:b,truncateBlock:tg,toggleExpand:g,toggleIteration:E,isIterationExpanded:O,clearFilters:y,fetchFiles:v,fetchTraces:C,lookupMessage:N}}},fw={template:`
...
`)}const vw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),b=h(!1),g=h(null),E=h(null),O=h(!1),y=J(()=>e.value.length),v=J(()=>e.value.reduce((Q,de)=>Q+(de.execution_count||0),0)),x=J(()=>e.value.reduce((Q,de)=>Q+D(de.code),0)),C=J(()=>{if(!l.value)return e.value;const Q=l.value.toLowerCase();return e.value.filter(de=>de.name.toLowerCase().includes(Q)||(de.description||"").toLowerCase().includes(Q))}),N=J(()=>d.value?d.value.split(`
`).length:0),L=J(()=>{const Q=Math.max(N.value,1);return Array.from({length:Q},(de,Ie)=>Ie+1).join(`
`)}),T=J(()=>{const Q=d.value.trim();return Q?Q.includes("SKILL_DEFINITION")?Q.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function R(Q){return gw(Q)}function D(Q){return Q?Q.split(`
`).length:0}function U(Q){return mw(Q)}function P(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function S(Q){try{await navigator.clipboard.writeText(Q);const de=e.value.find(Ie=>Ie.code===Q);de&&(r.value=de.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function $(Q){if(Q.key==="Tab"){Q.preventDefault();const de=Q.target,Ie=de.selectionStart,j=de.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(j),St(()=>{de.selectionStart=de.selectionEnd=Ie+4})}}function W(Q){const de=Q.target.previousElementSibling;de&&(de.scrollTop=Q.target.scrollTop)}async function K(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function w(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const de=await G.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:de}}catch(de){a.value={...a.value,[Q]:{result:de.message,is_error:!0}}}i.value=null}function k(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function V(Q){o.value=!0,c.value="edit",u.value=Q.name,d.value=Q.code||"",f.value=null,p.value=null}function le(){o.value=!1,f.value=null,p.value=null}async function ue(){f.value=null,p.value=null;const Q=u.value.trim(),de=d.value.trim();if(!Q){f.value="Name is required";return}if(!de){f.value="Code is required";return}b.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:Q,code:de}),p.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(Q)}`,{code:de}),p.value="Skill updated successfully"),await K(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}b.value=!1}function te(Q){E.value=Q}async function fe(){if(E.value){O.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(E.value)}`),await K()}catch{}O.value=!1,E.value=null}}return He(()=>{K()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:b,editorRef:g,deleteTarget:E,deleting:O,enabledCount:y,totalExecutions:v,totalLines:x,displayedSkills:C,editLineCount:N,editorLineNums:L,editValidation:T,highlight:R,truncate:Lc,formatTs:Fa,countLines:D,getLineNumbers:U,toggleCode:P,copyCode:S,handleEditorKey:$,syncScroll:W,fetchSkills:K,testSkill:w,showCreate:k,editSkill:V,cancelEdit:le,saveSkill:ue,confirmDelete:te,doDelete:fe}}};function bw(e,t){if(!e||!t)return Sd(e);const s=Sd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),b=h(null),g=h(null);let E=null;const O=h(null),y=h(!1),v=h({}),x=h({}),C=h(null),N=h(null),L=J(()=>e.value.reduce((k,V)=>k+(V.chunks||0),0)),T=J(()=>new Set(e.value.map(V=>V.uploader).filter(Boolean)).size);function R(k,V){const le=x.value[V];if(!le||le.length===0)return 0;const ue=Math.max(...le.map(te=>te.char_count||0));return ue===0?0:Math.round(k.char_count/ue*100)}async function D(){t.value=!0,s.value=null;try{const k=await G.get("/api/knowledge");e.value=Array.isArray(k)?k:[]}catch(k){s.value=k.message}t.value=!1}async function U(k){if(v.value[k]){v.value[k]=!1,N.value=null;return}if(v.value[k]=!0,!(x.value[k]||C.value===k)){C.value=k;try{const V=await G.get(`/api/knowledge/${encodeURIComponent(k)}/chunks`);x.value[k]=Array.isArray(V)?V:[]}catch(V){x.value[k]=[],_e.error(`Failed to load chunks: ${V.message}`)}C.value=null}}async function P(){const k=n.value.trim();if(k){i.value=!0,r.value=null,l.value=k;try{const V=await G.get(`/api/knowledge/search?q=${encodeURIComponent(k)}`);a.value=Array.isArray(V)?V:[]}catch(V){a.value=[],r.value=V.message||"Search failed"}i.value=!1}}function S(){a.value=null,n.value="",r.value=null}async function $(){d.value=null,f.value=null;const k=c.value.trim(),V=u.value.trim();if(!k){d.value="Source name is required";return}if(!V){d.value="Content is required";return}p.value=!0;try{const le=await G.post("/api/knowledge",{source:k,content:V});f.value=`Ingested ${le.chunks||0} chunks from "${k}"`,c.value="",u.value="",x.value={},await D(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(le){d.value=le.message}p.value=!1}async function W(k){b.value=k,g.value=null,E&&(clearTimeout(E),E=null);try{const V=await G.post(`/api/knowledge/${encodeURIComponent(k)}/reingest`);g.value={source:k,error:!1,message:`Re-ingested ${V.chunks||0} chunks`},delete x.value[k],await D(),E=setTimeout(()=>{g.value=null,E=null},3e3)}catch(V){g.value={source:k,error:!0,message:V.message}}b.value=null}function K(k){O.value=k}async function w(){if(O.value){y.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(O.value)}`),delete x.value[O.value],await D()}catch{}y.value=!1,O.value=null}}return He(()=>{D()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:b,reingestResult:g,deleteTarget:O,deleting:y,expanded:v,sourceChunks:x,loadingChunks:C,selectedChunk:N,totalChunks:L,uploaderCount:T,truncate:Lc,formatTs:Fa,highlightTerms:bw,chunkBarWidth:R,fetchSources:D,toggleSource:U,doSearch:P,clearSearch:S,doIngest:$,doReingest:W,confirmDelete:K,doDelete:w}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),b=h(!1),g=h(null),E=h(null),O=h(new Set),y=h(null),v=h(!1),x=h(!1),C=J(()=>e.value.reduce((te,fe)=>te+fe.count,0)),N=J(()=>O.value.size);function L(te){const fe=t.value[te];if(!fe)return[];if(!l.value.trim())return fe;const Q=l.value.trim().toLowerCase();return fe.filter(de=>de.key.toLowerCase().includes(Q)||de.value&&de.value.toLowerCase().includes(Q))}function T(te,fe){return O.value.has(te+"/"+fe)}function R(te,fe){const Q=te+"/"+fe,de=new Set(O.value);de.has(Q)?de.delete(Q):de.add(Q),O.value=de}function D(te){const fe=t.value[te];return!fe||fe.length===0?!1:fe.every(Q=>O.value.has(te+"/"+Q.key))}function U(te,fe){const Q=t.value[te];if(!Q)return;const de=new Set(O.value);for(const Ie of Q){const j=te+"/"+Ie.key;fe?de.add(j):de.delete(j)}O.value=de}async function P(){s.value=!0,n.value=null;try{const te=await G.get("/api/memory");e.value=Object.entries(te).map(([fe,Q])=>({name:fe,keys:Q.keys||[],count:Q.count||0}))}catch(te){n.value=te.message}s.value=!1}async function S(te){if(a.value[te]){a.value[te]=!1;return}a.value[te]=!0;const fe=e.value.find(de=>de.name===te);if(!fe||t.value[te]||i.value===te)return;i.value=te;const Q=await Promise.all(fe.keys.map(async de=>{try{const Ie=await G.get(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(de)}`);return{key:de,value:Ie.value||""}}catch{return{key:de,value:"(error loading)"}}}));t.value[te]=Q,i.value=null}function $(te,fe,Q){f.value=te+"/"+fe,p.value=Q}async function W(te,fe){b.value=!0,g.value=null;try{await G.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(fe)}`,{value:p.value});const Q=t.value[te];if(Q){const de=Q.find(Ie=>Ie.key===fe);de&&(de.value=p.value)}f.value=null}catch(Q){g.value=`Failed to save: ${Q.message||"unknown error"}`}b.value=!1}async function K(te,fe){try{await navigator.clipboard.writeText(fe.value),E.value=te+"/"+fe.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function w(){u.value=null,d.value=null;const te=o.value.scope.trim(),fe=o.value.key.trim(),Q=o.value.value.trim();if(!te){u.value="Scope is required";return}if(!fe){u.value="Key is required";return}if(!Q){u.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(fe)}`,{value:Q}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(de){u.value=de.message}c.value=!1}function k(te,fe){y.value={scope:te,key:fe}}async function V(){if(!y.value)return;v.value=!0,g.value=null;const{scope:te,key:fe}=y.value;try{await G.del(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(fe)}`);const Q=t.value[te];Q&&(t.value[te]=Q.filter(j=>j.key!==fe));const de=e.value.find(j=>j.name===te);de&&(de.count--,de.keys=de.keys.filter(j=>j!==fe));const Ie=new Set(O.value);Ie.delete(te+"/"+fe),O.value=Ie}catch(Q){g.value=`Failed to delete: ${Q.message||"unknown error"}`}v.value=!1,y.value=null}function le(){x.value=!0}async function ue(){v.value=!0,g.value=null;const te=[];for(const fe of O.value){const Q=fe.indexOf("/");te.push({scope:fe.slice(0,Q),key:fe.slice(Q+1)})}try{await G.post("/api/memory/bulk-delete",{entries:te}),O.value=new Set,t.value={},await P()}catch(fe){g.value=`Bulk delete failed: ${fe.message||"unknown error"}`}v.value=!1,x.value=!1}return He(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:b,actionError:g,copied:E,selected:O,selectedCount:N,totalEntries:C,deleteTarget:y,deleting:v,showBulkDelete:x,fetchMemory:P,toggleScope:S,startEdit:$,doEdit:W,copyValue:K,doAdd:w,confirmDelete:k,doDelete:V,confirmBulkDelete:le,doBulkDelete:ue,isSelected:T,toggleSelect:R,isScopeAllSelected:D,toggleSelectAll:U,filteredEntries:L}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=J(()=>[...new Set(e.value.map(E=>E.category))].sort()),o=J(()=>{const g={};return e.value.forEach(E=>{g[E.category]=(g[E.category]||0)+1}),g}),c=J(()=>a.value?e.value.filter(g=>g.category===a.value):e.value);function u(g){return g==="correction"?"badge-warning":g==="operational"?"badge-info":g==="preference"?"badge-success":"badge-info"}function d(g){i.value=g.key,l.value=g.content}async function f(g){try{await G.put("/api/learned/"+encodeURIComponent(g),{content:l.value}),i.value=null,_e.success("Entry updated"),await b()}catch(E){_e.error(E.message||"Failed to save entry")}}async function p(g){if(await rs({title:"Delete learned entry",message:`Delete "${g}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/learned/"+encodeURIComponent(g)),_e.success("Entry deleted"),await b()}catch(O){_e.error(O.message||"Failed to delete entry")}}async function b(){s.value=!0,n.value=null;try{const g=await G.get("/api/learned");e.value=g.entries||[],t.value={last_reflection:g.last_reflection,count:g.count}}catch(g){n.value=g.message}s.value=!1}return He(b),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:u,formatTs:Fa,startEdit:d,saveEdit:f,deleteEntry:p,fetchEntries:b}}},kw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"tools",label:"Tools",component:hw},{id:"skills",label:"Skills",component:vw},{id:"knowledge",label:"Knowledge",component:yw},{id:"memory",label:"Memory",component:xw},{id:"learned",label:"Learned",component:_w}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},ww={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),u=h(!0),d=h(""),f=h(!1),p=h(!1),b=J(()=>e.value==="custom"),g=J(()=>[...i.value,...l.value]),E=J(()=>l.value.includes(e.value)),O=J(()=>{var T;return b.value?t.value||"Odin":((T=a.value[e.value])==null?void 0:T.name)||e.value}),y=J(()=>{var T;return b.value?s.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.identity)||""}),v=J(()=>{var T;return b.value?n.value||"(empty — will use Odin default)":((T=a.value[e.value])==null?void 0:T.voice)||""});async function x(){u.value=!0;try{const T=await G.get("/api/personality");e.value=T.preset||"odin",t.value=T.custom_name||"",s.value=T.custom_identity||"",n.value=T.custom_voice||"",a.value=T.presets||{},i.value=T.builtin_presets||[],l.value=T.user_presets||[]}catch(T){c.value=T.message}finally{u.value=!1}}async function C(){r.value=!0,c.value=null,o.value=!1;try{await G.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(T){c.value=T.message}finally{r.value=!1}}async function N(){const T=d.value.trim();if(T){p.value=!0,c.value=null;try{await G.post("/api/personality/presets",{name:T,display_name:O.value,identity:y.value,voice:v.value}),f.value=!1,d.value="",await x(),e.value=T.toLowerCase().replace(/ /g,"_")}catch(R){c.value=R.message}finally{p.value=!1}}}async function L(){if(await rs({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await G.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(R){c.value=R.message}}}return He(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:g,isCustom:b,isUserPreset:E,previewName:O,previewIdentity:y,previewVoice:v,saving:r,saved:o,error:c,loading:u,save:C,showSavePreset:f,newPresetName:d,savingPreset:p,saveAsPreset:N,deletePreset:L,builtinPresets:i,userPresets:l}},template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=J(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=J(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await G.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return He(()=>{c(),i=setInterval(c,3e4)}),gt(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:sg,refresh:u,retry:d}}},Rw=["INFO","WARNING","ERROR"],Iw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Gr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Nw=[50,100,200,500],Lw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(We.state||"disconnected"),c=J(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,b=Rw,g=Iw,E=Gr,O=h("all"),y=h(""),v=h([]),x=h(!1),C=h(""),N=h([]);function L(){try{const H=localStorage.getItem("odin-log-presets");H&&(v.value=JSON.parse(H))}catch{}}function T(){try{localStorage.setItem("odin-log-presets",JSON.stringify(v.value))}catch{}}const R=J(()=>a.value!==""||i.value.trim()!==""||y.value!==""),D=J(()=>{const H=Gr.find(ne=>ne.value===y.value);return H?H.label:""}),U=J(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(H){return H.message}}),P=24,S=J(()=>{if(t.value.length===0)return[];const H=[],ne=new Date,Te=3600*1e3;for(let Xe=P-1;Xe>=0;Xe--){const rt=new Date(ne.getTime()-(Xe+1)*Te),Zt=new Date(ne.getTime()-Xe*Te);H.push({start:rt,end:Zt,label:w(rt,Zt),shortLabel:Zt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Xe of t.value){if(!Xe._time)continue;const rt=Xe._time.getTime();for(const Zt of H)if(rt>=Zt.start.getTime()&&rt<Zt.end.getTime()){Zt.total++,Xe.level==="ERROR"?Zt.errors++:Xe.level==="WARNING"?Zt.warnings++:Zt.info++;break}}return H}),$=J(()=>{let H=1;for(const ne of S.value)ne.total>H&&(H=ne.total);return H}),W=J(()=>S.value.length===0?"":"Last 24 hours"),K=J(()=>Math.ceil(P/8));function w(H,ne){const Te={hour:"2-digit",minute:"2-digit"};return H.toLocaleTimeString([],Te)+" - "+ne.toLocaleTimeString([],Te)}function k(H,ne){return!ne||!H?"0px":Math.max(2,H/ne*100)+"%"}function V(H){const ne=le.value.findIndex(Te=>Te._time&&Te._time.getTime()>=H.start.getTime()&&Te._time.getTime()<H.end.getTime());if(ne>=0&&u.value){const Te=u.value.querySelectorAll(".log-line");Te[ne]&&(Te[ne].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const le=J(()=>{let H=t.value;if(a.value&&(H=H.filter(ne=>(ne.level||"INFO")===a.value)),y.value){const ne=Gr.find(Te=>Te.value===y.value);if(ne&&ne.seconds){const Te=new Date(Date.now()-ne.seconds*1e3);H=H.filter(Xe=>Xe._time&&Xe._time>=Te)}}if(i.value&&!U.value)if(l.value)try{const ne=new RegExp(i.value,"i");H=H.filter(Te=>{const Xe=Te.text||Te.raw||"",rt=Te.tool||"";return ne.test(Xe)||ne.test(rt)})}catch{}else{const ne=i.value.toLowerCase();H=H.filter(Te=>{const Xe=(Te.text||Te.raw||"").toLowerCase(),rt=(Te.tool||"").toLowerCase();return Xe.includes(ne)||rt.includes(ne)})}return H});function ue(H){if(H.type==="log"&&H.line)try{const ne=typeof H.line=="string"?JSON.parse(H.line):H.line,Te=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(H.line),tool:"",raw:String(H.line)}}if(H.payload){const ne=H.payload,Te=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}return typeof H=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:H,tool:"",raw:H}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(H),tool:"",raw:null}}function te(H){const ne=ue(H);if(s.value){N.value.push(ne);return}fe(ne)}function fe(H){t.value.push(H),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&St(()=>Q())}function Q(H=!1){const ne=u.value;ne&&ne.scrollTo({top:ne.scrollHeight,behavior:H?"smooth":"instant"})}function de(){n.value=!0,d.value=!1,St(()=>Q(!0))}const Ie=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function j(){const H=u.value;if(!H)return;const ne=H.scrollHeight-H.scrollTop-H.clientHeight<40;d.value=!n.value&&!ne&&t.value.length>0,pe.value&&ce()}function ce(){const H=u.value;!H||!n.value||H.scrollHeight-H.scrollTop-H.clientHeight>=40&&(n.value=!1,d.value=t.value.length>0)}function ie(){n.value&&requestAnimationFrame(ce)}function me(H){Ie.has(H.key)&&ie()}const pe=h(!1);function Le(){n.value&&(pe.value=!0,requestAnimationFrame(ce))}function m(){pe.value&&(pe.value=!1,ce())}function A(){n.value&&(d.value=!1,St(()=>Q()))}function M(){if(s.value=!s.value,!s.value&&N.value.length>0){for(const H of N.value)fe(H);N.value=[]}}function Z(){t.value=[],N.value=[],d.value=!1}function I(){let H;e.value==="search"?H=Wt.value.map(rt=>{const Zt=rt.error?"ERROR":"INFO",ns=rt.tool_name?`[${rt.tool_name}] `:"";return`${rt.timestamp||""} ${Zt} ${ns}${rt.result_summary||rt.message||""}`}).join(`
`):H=le.value.map(rt=>`${rt.ts} ${rt.level} ${rt.text}`).join(`
`);const ne=new Blob([H],{type:"text/plain"}),Te=URL.createObjectURL(ne),Xe=document.createElement("a");Xe.href=Te,Xe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Xe.click(),URL.revokeObjectURL(Te)}function F(H,ne){const Te=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(Te).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function Y(H){a.value=a.value===H?"":H,O.value="all"}function ee(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function se(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function X(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function be(H){O.value=H.id;const ne=H.filters;a.value=ne.level||"",y.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function re(H){O.value=H.id,a.value=H.filters.level||"",y.value=H.filters.timeRange||"",i.value=H.filters.text||""}function ge(){if(!C.value.trim())return;const H={id:"custom-"+Date.now(),name:C.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};v.value=[...v.value,H],T(),x.value=!1,C.value=""}function xe(H){v.value=v.value.filter(ne=>ne.id!==H),T(),O.value===H&&(O.value="all")}const ke=h("all"),Ee=h(""),B=h(""),oe=h(""),ye=h(""),Me=h(""),Ue=h(100),Je=Nw,dt=h(!1),Ye=h(!1),Ke=h(""),Wt=h([]),bs=h(null),Ts=h(null);function Cn(){e.value="search",bs.value||Qn()}async function Qn(){try{bs.value=await G.get("/api/logs/stats")}catch{}}function cn(){const H=Me.value;if(!H){oe.value="",ye.value="";return}const Te={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(Te){const Xe=new Date(Date.now()-Te*1e3);oe.value=un(Xe),ye.value=""}}function un(H){const ne=Te=>String(Te).padStart(2,"0");return`${H.getFullYear()}-${ne(H.getMonth()+1)}-${ne(H.getDate())}T${ne(H.getHours())}:${ne(H.getMinutes())}`}function z(H){if(!H)return"";const ne=new Date(H);return isNaN(ne.getTime())?"":ne.toISOString()}async function Se(){dt.value=!0,Ke.value="",Ye.value=!0,Ts.value=null;try{const H=new URLSearchParams;ke.value&&ke.value!=="all"&&H.set("level",ke.value),Ee.value&&H.set("tool",Ee.value),B.value&&H.set("q",B.value);const ne=z(oe.value),Te=z(ye.value);ne&&H.set("start",ne),Te&&H.set("end",Te),H.set("limit",String(Ue.value));const Xe=await G.get(`/api/logs/search?${H.toString()}`);Wt.value=Xe.entries||[]}catch(H){Ke.value=H.message||"Search failed",Wt.value=[]}finally{dt.value=!1}}function Cs(){ke.value="all",Ee.value="",B.value="",oe.value="",ye.value="",Me.value="",Ue.value=100,Wt.value=[],Ye.value=!1,Ke.value="",Ts.value=null}function En(H){Ts.value=Ts.value===H?null:H}function br(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function $a(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function Ua(H){return H.error?"log-line-error":"text-gray-300"}function yr(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let ys=null,Xn=null,ea=!1;function it(){ea||(ea=!0,We.subscribe("logs",te),r.value=We.connected,o.value=We.state||"disconnected",ys=We.onStateChange,Xn=(H,ne)=>{o.value=H,r.value=H==="connected",ys&&ys(H,ne)},We.onStateChange=Xn)}function Fs(){ea&&(ea=!1,We.unsubscribe("logs",te),We.onStateChange===Xn&&(We.onStateChange=ys),Xn=null,ys=null)}return He(()=>{L(),window.addEventListener("pointerup",m),window.addEventListener("pointercancel",m)}),er(it),tr(Fs),gt(()=>{Fs(),window.removeEventListener("pointerup",m),window.removeEventListener("pointercancel",m)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:le,pauseBuffer:N,showJumpBottom:d,copiedIndex:f,regexError:U,levels:b,logPresets:g,timeRanges:E,timeRange:y,activeLogPreset:O,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:C,hasActiveLogFilters:R,timeRangeLabel:D,timelineBuckets:S,timelineMax:$,timelineSpanLabel:W,timelineLabelSkip:K,togglePause:M,clearLogs:Z,exportLogs:I,logLineClass:ee,levelClass:se,levelChipClass:X,toggleLevel:Y,copyLine:F,jumpToBottom:de,onScroll:j,onUserScrollIntent:ie,onUserScrollKey:me,onAutoScrollToggle:A,onPointerDown:Le,applyLogPreset:be,applyCustomLogPreset:re,saveLogCustomPreset:ge,removeLogCustomPreset:xe,segmentHeight:k,jumpToTimelineBucket:V,searchLevel:ke,searchTool:Ee,searchKeyword:B,searchStart:oe,searchEnd:ye,searchTimePreset:Me,searchLimit:Ue,searchLimits:Je,searching:dt,searchRan:Ye,searchError:Ke,searchResults:Wt,searchStats:bs,expandedSearch:Ts,switchToSearch:Cn,runSearch:Se,clearSearchFilters:Cs,toggleSearchExpand:En,formatSearchTs:br,searchEntryText:$a,searchLogLineClass:Ua,formatJson:yr,applySearchTimePreset:cn}}},Ow=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Wr=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],vg="••••••••",Pw=50;function Fw(e){return Ow.has(e)}function $w(e){return e===vg}function sl(e){return JSON.parse(JSON.stringify(e))}function Vn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Vn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Vn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Gd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Vn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Vn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=J(()=>d.value.length>0),b=J(()=>f.value.length>0),g=J(()=>r.value&&t.value?t.value:e.value),E=J(()=>!e.value||!t.value?!1:!Vn(e.value,t.value)),O=J(()=>!e.value||!t.value?0:Gd(e.value,t.value).length),y=J(()=>{if(!r.value||!t.value)return{};const I={};for(const F of Object.keys(t.value)){const Y=t.value[F];if(typeof Y=="object"&&Y!==null&&!Array.isArray(Y))for(const ee of Object.keys(Y)){const se=Bw(F,ee,Y[ee]);se&&(I[F+"."+ee]=se)}}return I}),v=J(()=>Object.keys(y.value).length>0),x=J(()=>e.value?Object.keys(e.value).length:0),C=J(()=>L.value.length),N=J(()=>!e.value||!t.value?[]:Gd(e.value,t.value)),L=J(()=>e.value?Wr.map(I=>({...I,sections:I.sections.filter(F=>F in e.value)})).filter(I=>I.sections.length>0):[]),T=J(()=>{if(!e.value)return[];const I=new Set(Wr.flatMap(F=>F.sections));return Object.keys(e.value).filter(F=>!I.has(F))});function R(I){return g.value?g.value[I]:null}function D(I){return!e.value||!t.value?!1:!Vn(e.value[I],t.value[I])}function U(I){return I.sections.some(F=>D(F))}function P(I,F){if(!e.value||!t.value)return!1;const Y=e.value[I],ee=t.value[I];return!Y||!ee?!1:!Vn(Y[F],ee[F])}function S(I){return t.value?t.value[I]:e.value[I]}function $(I,F){const Y=t.value||e.value;return Y[I]?Y[I][F]:void 0}function W(I,F){const Y=r.value&&t.value?t.value:e.value;return Y[I]?Y[I][F]:!1}function K(I,F){return y.value[I+"."+F]||null}function w(I,F){return Dw[I+"."+F]||null}function k(I,F,Y){t.value&&(F===null?t.value[I]=Y:(t.value[I]||(t.value[I]={}),t.value[I][F]=Y),t.value={...t.value})}function V(I,F,Y){if(!t.value)return;const ee=sl(t.value);k(I,F,Y),d.value.push(ee),d.value.length>Pw&&d.value.shift(),f.value=[]}function le(I,F,Y){try{const ee=JSON.parse(Y);V(I,F,ee)}catch{}}function ue(){d.value.length!==0&&(f.value.push(sl(t.value)),t.value=d.value.pop())}function te(){f.value.length!==0&&(d.value.push(sl(t.value)),t.value=f.value.pop())}function fe(I,F,Y){if(!t.value||!t.value[I])return;const ee=[...t.value[I][F]];ee.splice(Y,1),V(I,F,ee)}function Q(I,F){if(!t.value||!t.value[I])return;const Y=[...t.value[I][F]||[]],ee=prompt("Enter new value:");ee!==null&&(Y.push(ee),V(I,F,Y))}function de(I){a.value={...a.value,[I]:!a.value[I]}}function Ie(I){l.value={...l.value,[I]:!l.value[I]}}function j(I){i.value={...i.value,[I]:!i.value[I]}}function ce(I){try{return JSON.stringify(I,null,2)}catch{return String(I)}}function ie(I){return I==null?"null":typeof I=="object"?JSON.stringify(I,null,2):String(I)}function me(I,F){c.value={type:I,message:F},setTimeout(()=>{c.value=null},3e3)}function pe(){t.value=sl(e.value),r.value=!0,d.value=[],f.value=[]}function Le(){r.value=!1,t.value=null,d.value=[],f.value=[]}function m(){u.value=!0}async function A(){if(!(!E.value||v.value)){o.value=!0;try{const I=Uw(e.value,t.value);if(Object.keys(I).length===0){me("success","No changes to save."),o.value=!1;return}const F=await G.put("/api/config",I);e.value=F,r.value=!1,t.value=null,d.value=[],f.value=[],me("success","Config saved successfully.")}catch(I){me("error",I.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await G.get("/api/config");for(const I of Object.keys(e.value))a.value[I]===void 0&&(a.value[I]=!0);for(const I of Wr)l.value[I.key]===void 0&&(l.value[I.key]=!0)}catch(I){n.value=I.message}s.value=!1}function Z(I){if(!r.value)return;const F=I.target;F instanceof HTMLElement&&(F.matches("input, textarea, select")||F.isContentEditable)||((I.ctrlKey||I.metaKey)&&!I.shiftKey&&I.key.toLowerCase()==="z"?(I.preventDefault(),ue()):(I.ctrlKey||I.metaKey)&&(I.key==="y"||I.shiftKey&&I.key==="z"||I.shiftKey&&I.key==="Z")&&(I.preventDefault(),te()))}return He(()=>{M(),document.addEventListener("keydown",Z)}),gt(()=>{document.removeEventListener("keydown",Z)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:E,hasErrors:v,changeCount:O,REDACTED:vg,showDiffModal:u,diffEntries:N,canUndo:p,canRedo:b,sectionCount:x,groupCount:C,visibleGroups:L,ungroupedSections:T,validationErrors:y,isSensitiveKey:Fw,isRedacted:$w,sectionChanged:D,groupChanged:U,fieldChanged:P,getDisplay:R,getEdited:S,getEditedField:$,getDisplayBool:W,pushEdit:V,pushEditJson:le,getValidationError:K,getEnumOptions:w,removeArrayItem:fe,addArrayItem:Q,toggleSection:de,toggleGroup:Ie,toggleNested:j,formatJson:ce,formatDiffVal:ie,showToast:me,showDiff:m,fetchConfig:M,startEdit:pe,cancelEdit:Le,saveConfig:A,undo:ue,redo:te}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=J(()=>{const k={};for(const V of u.value)k[V.id]=V;return k});function p(k){return f.value[k]||null}const b=J(()=>/^\d{15,25}$/.test(r.value.trim())),g=J(()=>{if(o.value){if(E.value[c.value])return"host-user-option-"+c.value;if(b.value)return"host-user-option-raw"}}),E=J(()=>{const k=r.value.toLowerCase().trim();return k?u.value.filter(V=>!i.value[V.id]&&(V.display_name.toLowerCase().includes(k)||V.username.toLowerCase().includes(k)||V.id.includes(k))):u.value.filter(V=>!i.value[V.id])});function O(k,V){return k?k.allowed_hosts===null||k.allowed_hosts===void 0?{allowed_hosts:[...V],default_host:k.default_host||"",allow_all:!0}:{allowed_hosts:k.allowed_hosts,default_host:k.default_host||"",allow_all:!1}:{allowed_hosts:[...V],default_host:V[0]||"",allow_all:!0}}async function y(){e.value=!0,t.value="";try{const k=await G.get("/api/host-access");s.value=k,n.value=k.available_hosts||[],a.value=O(k.default_policy,n.value);const V=k.users||{},le={};for(const[ue,te]of Object.entries(V))le[ue]=O(te,n.value);i.value=le}catch(k){t.value=k.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await G.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const k=a.value.allow_all?null:a.value.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:k,default_host:a.value.default_host}),_e.success("Default policy updated")}catch(k){_e.error(k.message||"Failed to save")}}function x(k,V){a.value.allow_all=!1,V?a.value.allowed_hosts.includes(k)||a.value.allowed_hosts.push(k):(a.value.allowed_hosts=a.value.allowed_hosts.filter(le=>le!==k),a.value.default_host===k&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function C(k){const V=i.value[k];if(V)try{const le=V.allow_all?null:V.allowed_hosts;await G.put(`/api/host-access/user/${k}`,{allowed_hosts:le,default_host:V.default_host});const ue=p(k);_e.success(`Updated access for ${ue?ue.display_name:k}`)}catch(le){_e.error(le.message||"Failed to save")}}function N(k,V,le){const ue=i.value[k];ue&&(ue.allow_all=!1,le?ue.allowed_hosts.includes(V)||ue.allowed_hosts.push(V):(ue.allowed_hosts=ue.allowed_hosts.filter(te=>te!==V),ue.default_host===V&&(ue.default_host=ue.allowed_hosts[0]||"")),C(k))}function L(k,V){const le=i.value[k];le&&(le.default_host=V,C(k))}function T(){l.value=!0,r.value="",c.value=0,St(()=>{d.value&&d.value.focus()})}function R(){o.value=!0,c.value=0}function D(){c.value<E.value.length-1&&c.value++}function U(){c.value>0&&c.value--}function P(){const k=E.value[c.value];if(k){$(k);return}b.value&&S()}function S(){const k=r.value.trim();/^\d{15,25}$/.test(k)&&(i.value[k]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(k),r.value="",o.value=!1,l.value=!1)}function $(k){i.value[k.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(k.id),r.value="",o.value=!1,l.value=!1}function W(){o.value=!1}function K(){setTimeout(()=>{o.value=!1},150)}async function w(k){const V=p(k);if(await rs({title:"Remove user override",message:`Remove the host access override for ${V?V.display_name:k}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await G.del(`/api/host-access/user/${k}`),delete i.value[k],_e.success(`Removed override for ${V?V.display_name:k}`)}catch(ue){_e.error(ue.message||"Failed to delete")}}return He(y),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:E,isRawId:b,activeOptionId:g,searchInput:d,fetchData:y,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:N,setUserDefault:L,openAddUser:T,deleteUser:w,onSearchInput:R,highlightNext:D,highlightPrev:U,selectHighlighted:P,selectMember:$,closeDropdown:W,onBlur:K,addRawId:S}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=J(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=J(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function b(){e.value=!0,t.value="";try{const T=await G.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function g(T){return!T||!T.trim()?[]:T.split(",").map(R=>R.trim()).filter(Boolean)}function E(T,R){const D=c.value.allowed_hosts;if(R&&!D.includes(T)&&D.push(T),!R){const U=D.indexOf(T);U>=0&&D.splice(U,1)}}function O(T,R){const D=u.value.allowed_hosts;if(R&&!D.includes(T)&&D.push(T),!R){const U=D.indexOf(T);U>=0&&D.splice(U,1)}}async function y(){var T;i.value=!0;try{const R=g(c.value.allowed_tools_str),D=c.value.host_mode,U=D==="none"?[]:D==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:R.length?R:[]};U!==null&&(P.allowed_hosts=U),P.default_host=c.value.default_host||"";const S=await G.post("/api/tokens",P);l.value=S.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,_e.success("Token created"),await b()}catch(R){_e.error(((T=R.data)==null?void 0:T.error)||R.message||"Failed to create token")}finally{i.value=!1}}function v(T){r.value=T;const R=T.allowed_hosts;let D="default";R==null?D="default":Array.isArray(R)&&R.length===0?D="none":Array.isArray(R)&&(D="select"),u.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:D,allowed_hosts:Array.isArray(R)?[...R]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const R=g(u.value.allowed_tools_str),D=u.value.host_mode,U={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:R};D==="none"?U.allowed_hosts=[]:D==="select"?U.allowed_hosts=u.value.allowed_hosts:U.allowed_hosts=null,U.default_host=u.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),U),r.value=null,_e.success("Token updated"),await b()}catch(R){_e.error(((T=R.data)==null?void 0:T.error)||R.message||"Failed to update")}finally{o.value=!1}}}async function C(T){var D;if(await rs({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const U=await G.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=U.token,_e.success("Token regenerated")}catch(U){_e.error(((D=U.data)==null?void 0:D.error)||U.message||"Failed to regenerate")}}async function N(T){var D;if(await rs({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(T.user_id)),_e.success("Token deleted"),await b()}catch(U){_e.error(((D=U.data)==null?void 0:D.error)||U.message||"Failed to delete")}}async function L(){if(l.value)try{await navigator.clipboard.writeText(l.value),_e.success("Copied to clipboard")}catch{_e.error("Copy failed — select and copy manually")}}return He(b),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:b,tierBadge:p,toggleCreateHost:E,toggleEditHost:O,createToken:y,startEdit:v,saveEdit:x,confirmRegenerate:C,confirmDelete:N,copyToken:L}}};function nl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const qw={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=J(()=>{const z=n.value.model;return z&&!a.includes(z)?[z,...a]:a}),l=J(()=>{const z=n.value.agent_model;return z&&z!=="auto"&&!a.includes(z)?[z,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=J(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=J(()=>{const z=n.value.agent_model;return z==="auto"?!0:!r.includes(z||n.value.model)}),u=J(()=>{const z=n.value.agent_reasoning_effort;return z==="auto"?!1:(z||n.value.reasoning_effort)==="max"}),d=z=>r.includes(z)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&u.value),f=z=>r.includes(z)&&u.value,p=h({enabled:!1,model:"gpt-5.6-luna"}),b=h({unavailable_reason:null}),g=J(()=>{const z=p.value.model;return z&&!a.includes(z)?[z,...a]:a});function E(z){const Se=z.target.value;p.value.enabled=Se!=="",Se!==""&&(p.value.model=Se),ye()}const O=h(!1),y=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),v=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),x=h(!1),C=h(!1),N=h(!1),L=h(!1),T=h(!1),R=h(!1),D=h(!1),U=h({configured:!1}),P=h([]),S=h(""),$=h(!1),W=h(!1),K=h({configured:!1}),w=h([]),k=h(""),V=h(!1),le=h(!1),ue=h(!0),te=h(""),fe=h({configured:!1,accounts:[]}),Q=h(null),de=h(null),Ie=h(""),j=h(null),ce=h(!1),ie=h(null),me=h(null),pe=h("");let Le=null;function m(z,Se="success"){_e(z,Se==="error"?"error":"success")}function A(z){if(!z)return"?";const Se=z/(1024*1024*1024);return Se>=1?Se.toFixed(1)+" GB":(z/(1024*1024)).toFixed(0)+" MB"}async function M(){e.value=!0,await Promise.all([Z(),I(),be(),F()]),e.value=!1}async function Z(){try{const z=await G.get("/api/llm/status");t.value=z,s.value=z.active_provider||"codex",z.codex&&!oe.pending()&&(n.value.enabled=z.codex.enabled,n.value.model=z.codex.model||"gpt-5.5",n.value.reasoning_effort=z.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=z.codex.agent_reasoning_effort||"",n.value.agent_model=z.codex.agent_model||"",n.value.max_tokens=z.codex.max_tokens||4096),z.ollama&&!Me.pending()&&(y.value.enabled=z.ollama.enabled,y.value.base_url=z.ollama.base_url||"",y.value.model=z.ollama.model||"",y.value.max_tokens=z.ollama.max_tokens||4096),z.kimi&&!Ue.pending()&&(v.value.enabled=z.kimi.enabled,v.value.model=z.kimi.model||"",v.value.max_tokens=z.kimi.max_tokens||4096),z.auxiliary&&(b.value=z.auxiliary,ye.pending()||(p.value.enabled=z.auxiliary.enabled,p.value.model=z.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function I(){try{if(U.value=await G.get("/api/ollama/status"),U.value.model&&(S.value=U.value.model),U.value.configured)try{const z=await G.get("/api/ollama/models");P.value=z.models||[]}catch{P.value=[]}else if(y.value.base_url)try{const z=await G.post("/api/ollama/probe-models",{base_url:y.value.base_url});P.value=z.models||[]}catch{P.value=[]}}catch{U.value={configured:!1}}}async function F(){ue.value=!0,te.value="";try{fe.value=await G.get("/api/codex/status")}catch(z){te.value=z.message||"Failed to fetch Codex status"}finally{ue.value=!1}}async function Y(){const z=t.value?t.value.active_provider:"codex";D.value=!0;try{const Se=await G.post("/api/llm/switch",{provider:s.value});Se.error?(s.value=z,m(Se.error,"error")):(m("Switched to "+s.value+" ("+Se.model+")"),await M())}catch(Se){s.value=z,m(Se.message||"Switch failed","error")}finally{D.value=!1}}async function ee(){$.value=!0;try{const z=await G.post("/api/ollama/reload");m(z.configured?"Ollama reloaded":z.reason||"Ollama not configured",z.configured?"success":"error"),await M()}catch(z){m(z.message||"Reload failed","error")}finally{$.value=!1}}async function se(){W.value=!0;try{await G.post("/api/ollama/model",{model:S.value}),m("Model set to "+S.value),await M()}catch(z){m(z.message||"Failed","error")}finally{W.value=!1}}async function X(){const z=y.value.base_url;if(!z){m("Enter a base URL first","error");return}R.value=!0;try{const Se=await G.post("/api/ollama/probe-models",{base_url:z});P.value=Se.models||[],P.value.length?(m(P.value.length+" model(s) found"),!y.value.model&&P.value.length&&(y.value.model=P.value[0].name)):m("No models found at "+z,"error")}catch(Se){m(Se.message||"Could not reach Ollama","error")}finally{R.value=!1}}async function be(){try{if(K.value=await G.get("/api/kimi/status"),K.value.model&&(k.value=K.value.model),K.value.configured)try{const z=await G.get("/api/kimi/models");w.value=z.models||[]}catch{w.value=[]}}catch{K.value={configured:!1}}}async function re(){V.value=!0;try{const z=await G.post("/api/kimi/reload");m(z.configured?"Kimi reloaded":z.reason||"Kimi not configured",z.configured?"success":"error"),await M()}catch(z){m(z.message||"Reload failed","error")}finally{V.value=!1}}async function ge(){le.value=!0;try{await G.post("/api/kimi/model",{model:k.value}),m("Model set to "+k.value),await M()}catch(z){m(z.message||"Failed","error")}finally{le.value=!1}}async function xe(){if(N.value){oe();return}N.value=!0;try{await G.put("/api/llm/codex/config",n.value),m("Codex config saved"),await Promise.all([Z(),F()])}catch(z){m(z.message||"Failed","error"),await Promise.all([Z(),F()])}finally{N.value=!1}}async function ke(){if(L.value){Me();return}L.value=!0;try{const z={...y.value},Se=x.value?y.value.api_key:null;Se===null&&delete z.api_key,await G.put("/api/llm/ollama/config",z),m("Ollama config saved"),Se!==null&&y.value.api_key===Se&&(y.value.api_key="",x.value=!1),await Promise.all([Z(),I()])}catch(z){m(z.message||"Failed","error")}finally{L.value=!1}}async function Ee(){if(T.value){Ue();return}T.value=!0;try{const z={...v.value},Se=C.value?v.value.api_key:null;Se===null&&delete z.api_key,await G.put("/api/llm/kimi/config",z),m("Kimi config saved"),Se!==null&&v.value.api_key===Se&&(v.value.api_key="",C.value=!1),await Promise.all([Z(),be()])}catch(z){m(z.message||"Failed","error")}finally{T.value=!1}}async function B(){if(O.value){ye();return}O.value=!0;try{await G.put("/api/llm/auxiliary/config",p.value),m("Auxiliary config saved"),await Z()}catch(z){m(z.message||"Failed","error"),await Z()}finally{O.value=!1}}const oe=nl(xe),ye=nl(B),Me=nl(ke),Ue=nl(Ee),Je=()=>(oe.cancel(),xe()),dt=()=>(Me.cancel(),ke()),Ye=()=>(Ue.cancel(),Ee());async function Ke(z){try{await G.post("/api/codex/account/"+z+"/activate"),m("Active account switched"),await F()}catch(Se){m(Se.message||"Failed","error")}}async function Wt(z){Q.value=z;try{await G.post("/api/codex/account/"+z+"/refresh"),m("Token refreshed"),await F()}catch(Se){m(Se.message||"Refresh failed","error")}finally{Q.value=null}}function bs(z,Se){de.value=z,Ie.value=Se||""}async function Ts(z){try{await G.put("/api/codex/account/"+z+"/label",{label:Ie.value}),m("Label updated"),de.value=null,await F()}catch(Se){m(Se.message||"Failed","error")}}async function Cn(z,Se){if(await rs({title:"Delete Codex account",message:`Delete ${Se||"account #"+(z+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/codex/account/"+z),m("Deleted. Pool reloaded."),await F()}catch(En){m(En.message||"Failed","error")}}async function Qn(){ce.value=!0;try{const z=await G.post("/api/codex/device-code");ie.value=z,j.value="pending",cn(z)}catch(z){m(z.message||"Failed","error")}finally{ce.value=!1}}async function cn(z){Le={cancelled:!1};const Se=Le;try{const Cs=await G.post("/api/codex/device-poll",{device_auth_id:z.device_auth_id,user_code:z.user_code,interval:z.interval});if(Se.cancelled)return;me.value=Cs,j.value="success",await M()}catch(Cs){if(Se.cancelled)return;pe.value=Cs.message||"Device login failed",j.value="error"}}function un(){Le&&(Le.cancelled=!0),j.value=null,ie.value=null}return He(M),gt(()=>{Le&&(Le.cancelled=!0),oe.cancel(),ye.cancel(),Me.cancel(),Ue.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:D,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:d,agentModelOptionDisabled:f,auxForm:p,auxData:b,auxModelOptions:g,onAuxModelChange:E,savingAux:O,saveAuxConfigDebounced:ye,ollamaForm:y,kimiForm:v,savingCodex:N,savingOllama:L,savingKimi:T,probingOllama:R,ollamaKeyDirty:x,kimiKeyDirty:C,ollamaStatus:U,ollamaModels:P,ollamaSelectedModel:S,reloading:$,settingModel:W,kimiStatus:K,kimiModels:w,kimiSelectedModel:k,reloadingKimi:V,settingKimiModel:le,codexLoading:ue,codexError:te,codexData:fe,refreshing:Q,editingLabel:de,labelValue:Ie,deviceState:j,deviceLoading:ce,deviceInfo:ie,deviceResult:me,deviceError:pe,fetchAll:M,switchProvider:Y,reloadOllama:ee,setOllamaModel:se,reloadKimi:re,setKimiModel:ge,probeOllamaModels:X,saveCodexConfig:xe,saveOllamaConfig:ke,saveKimiConfig:Ee,saveCodexConfigDebounced:oe,saveOllamaConfigDebounced:Me,saveKimiConfigDebounced:Ue,saveCodexConfigNow:Je,saveOllamaConfigNow:dt,saveKimiConfigNow:Ye,activateAccount:Ke,refreshAccount:Wt,startEditLabel:bs,saveLabel:Ts,deleteAccount:Cn,startDeviceLogin:Qn,cancelDeviceLogin:un,formatSize:A}}},Wd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Kw(e){return Wd[e]||Wd[(e||"").toLowerCase()]||"text-gray-400"}const Gw={template:`
  ...
  `},Zw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Lw},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:qw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},mt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),bg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:mt("/operations","live")},{path:"/agents",redirect:mt("/operations","agents")},{path:"/loops",redirect:mt("/operations","loops")},{path:"/processes",redirect:mt("/operations","processes")},{path:"/schedules",redirect:mt("/operations","schedules")},{path:"/audit",redirect:mt("/history","audit")},{path:"/sessions",redirect:mt("/history","sessions")},{path:"/traces",redirect:mt("/history","traces")},{path:"/usage",redirect:mt("/history","usage")},{path:"/tools",redirect:mt("/capabilities","tools")},{path:"/skills",redirect:mt("/capabilities","skills")},{path:"/knowledge",redirect:mt("/capabilities","knowledge")},{path:"/memory",redirect:mt("/capabilities","memory")},{path:"/learned",redirect:mt("/capabilities","learned")},{path:"/health",redirect:mt("/system","health")},{path:"/resources",redirect:mt("/system","resources")},{path:"/logs",redirect:mt("/system","logs")},{path:"/config",redirect:mt("/system","config")},{path:"/host-access",redirect:mt("/system","host-access")},{path:"/internals",redirect:mt("/system","internals")}],ui=E_({history:i_(),routes:bg});ui.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const b=h("starting"),g=h(""),E=bg.filter(w=>w.meta),O=J(()=>["Workspace","Operate","Observe","Manage"].map(w=>({name:w,routes:E.filter(k=>k.meta.section===w)})).filter(w=>w.routes.length)),y=J(()=>{var w;return((w=ui.currentRoute.value.meta)==null?void 0:w.label)||"Odin"}),v=J(()=>{var w;return((w=ui.currentRoute.value.meta)==null?void 0:w.section)||"Management"}),x=J(()=>{var w;return((w=ui.currentRoute.value.meta)==null?void 0:w.description)||"Management console"});G.onSessionExpired=()=>{t.value=!0,We.disconnect(),G.setToken(""),e.value="login"};function C(w){var k;if((w.ctrlKey||w.metaKey)&&w.key.toLowerCase()==="k"){e.value==="ready"&&(w.preventDefault(),kd());return}if(n.value&&w.key==="Tab"){const V=[...((k=a.value)==null?void 0:k.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(V.length){const le=V[0],ue=V[V.length-1];if(w.shiftKey&&(document.activeElement===le||!a.value.contains(document.activeElement))){w.preventDefault(),ue.focus();return}if(!w.shiftKey&&(document.activeElement===ue||!a.value.contains(document.activeElement))){w.preventDefault(),le.focus();return}}}if(w.key==="Escape"&&n.value){n.value=!1,w.preventDefault();return}if(w.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(w.target.tagName)){w.preventDefault();const V=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');V&&V.focus()}}function N(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}He(async()=>{document.addEventListener("keydown",C),r=window.matchMedia("(max-width: 900px)"),N(),r.addEventListener("change",N);const w=await G.check();w.ok?(e.value="ready",W()):w.needsAuth?e.value="login":(e.value="ready",W())});function L(){t.value=!1,e.value="ready",W()}async function T(){await G.logout(),We.disconnect(),e.value="login"}function R(){s.value=!s.value}function D(){n.value=!n.value}gs(n,async w=>{var k,V;if(w)o=document.activeElement,await St(),(V=(k=a.value)==null?void 0:k.querySelector(".nav-item"))==null||V.focus();else if(o!=null&&o.isConnected){const le=o;o=null,requestAnimationFrame(()=>le.focus())}});const U=J(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(w,k="info",V=3e3){f.value={text:w,level:k},clearTimeout(p),p=setTimeout(()=>{f.value=null},V)}let S=null,$=!1;function W(){We.onStatusChange=w=>{c.value=w},We.onStateChange=(w,k)=>{u.value=w,d.value=k.latency??-1,w==="connected"?($&&P("Connection restored","success"),$=!0):w==="reconnecting"&&k.attempt===1&&P("Connection lost — reconnecting…","warn")},We.connect(),K(),S&&clearInterval(S),S=setInterval(K,15e3)}async function K(){try{const w=await G.get("/api/status");b.value=w.status==="online"?"online":"starting";const k=w.uptime_seconds||0,V=Math.floor(k/3600),le=Math.floor(k%3600/60);g.value=`${V}h ${le}m uptime`}catch{b.value="offline",g.value=""}}return gt(()=>{S&&clearInterval(S),We.disconnect(),document.removeEventListener("keydown",C),r==null||r.removeEventListener("change",N)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:U,wsToast:f,botStatus:b,botUptime:g,navRoutes:E,navGroups:O,currentPage:y,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:L,logout:T,toggleSidebar:R,toggleMobileNavigation:D,openPalette:kd}}},Tn=Al(Yw);Tn.component("odin-icon",L_);Tn.component("login-screen",Jw);Tn.component("toast-container",yx);Tn.component("confirm-host",xx);Tn.component("command-palette",N_);Tn.directive("modal-focus",D_);Tn.use(ui);Tn.mount("#app");
