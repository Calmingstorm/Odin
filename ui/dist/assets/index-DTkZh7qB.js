...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Vs(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},sa=new ok;function tt(e,t){return sa.parse(e,t)}tt.options=tt.setOptions=function(e){return sa.setOptions(e),tt.defaults=sa.defaults,pg(tt.defaults),tt};tt.getDefaults=Pc;tt.defaults=oa;tt.use=function(...e){return sa.use(...e),tt.defaults=sa.defaults,pg(tt.defaults),tt};tt.walkTokens=function(e,t){return sa.walkTokens(e,t)};tt.parseInline=sa.parseInline;tt.Parser=un;tt.parser=un.parse;tt.Renderer=Wl;tt.TextRenderer=zc;tt.Lexer=dn;tt.lexer=dn.lex;tt.Tokenizer=Kl;tt.Hooks=bl;tt.parse=tt;tt.options;tt.setOptions;tt.use;tt.walkTokens;tt.parseInline;un.parse;dn.lex;const ck={breaks:!0,gfm:!0};function Ku(e){if(!e)return"";try{if(typeof tt<"u"&&tt.parse){const t=tt.parse(e,ck);return typeof Hu<"u"?Hu.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function dk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const uk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function fk(e){return uk[e]||"wrench"}const pk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Wu(e){if(!e)return[];const t=e.match(pk);return t?[...new Set(t)]:[]}const hk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],d=ee(()=>t.value.trim().length>0&&!s.value),u=h(We.state||"disconnected");let f=null,p=null;const m=ee(()=>{const $=u.value;return $==="connected"?"Connected":$==="reconnecting"?"Reconnecting…":$==="connecting"?"Connecting…":"REST fallback"}),y=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],S=ee(()=>{const $=Math.floor(i.value/4)%y.length,O=i.value;return O>3?`${y[$]} (${O}s)`:y[0]});function R(){Ot(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function v(){if(!a.value)return;const $=a.value;$.style.height="auto",$.style.height=Math.min($.scrollHeight,120)+"px"}function g($,O,E={}){const z={id:++o,role:$,content:O,timestamp:Date.now(),html:$==="bot"?Ku(O):"",tools_used:E.tools_used||[],is_error:E.is_error||!1,images:$==="bot"?Wu(O):[],files:E.files||[],_showTools:!1};return e.value.push(z),R(),$==="bot"&&Ot(()=>x()),z}function x(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(O=>{O.setAttribute("data-copy","true"),O.style.position="relative";const E=document.createElement("button");E.className="chat-code-copy",E.textContent="Copy",E.addEventListener("click",()=>{const z=O.querySelector("code"),D=z?z.textContent:O.textContent;navigator.clipboard.writeText(D).then(()=>{E.textContent="Copied!",setTimeout(()=>{E.textContent="Copy"},1500)}).catch(()=>{})}),O.appendChild(E)})}function w($){if($===0)return!0;const O=e.value[$-1],E=e.value[$],z=new Date(O.timestamp).toDateString(),D=new Date(E.timestamp).toDateString();return z!==D}function _($){const O=new Date($),E=new Date;if(O.toDateString()===E.toDateString())return"Today";const z=new Date(E);return z.setDate(z.getDate()-1),O.toDateString()===z.toDateString()?"Yesterday":O.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function A($){t.value=$,Ot(()=>W())}function T($){window.open($,"_blank","noopener")}function C($){$.target.style.display="none"}function L(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function B(){r&&(clearInterval(r),r=null),i.value=0}function P($){s.value&&(s.value=!1,B(),$.type==="chat_response"?g("bot",$.content,{tools_used:$.tools_used||[],is_error:$.is_error||!1,files:$.files||[]}):$.type==="chat_error"&&g("bot",$.error||"Unknown error",{is_error:!0}),Ot(()=>{var O;return(O=a.value)==null?void 0:O.focus()}))}async function N($){try{const O=await Y.post("/api/chat",{content:$,channel_id:l.value});g("bot",O.response,{tools_used:O.tools_used||[],is_error:O.is_error||!1,files:O.files||[]})}catch(O){g("bot",O.message||"Failed to send message",{is_error:!0})}}async function W(){const $=t.value.trim();if(!$||s.value)return;g("user",$),t.value="",s.value=!0,L(),a.value&&(a.value.style.height="auto"),We.connected&&We.sendChat($,{channelId:l.value})||(await N($),s.value=!1,B()),Ot(()=>{var E;return(E=a.value)==null?void 0:E.focus()})}async function ne(){try{if(!l.value){const O=await Y.get("/api/auth/session");l.value=O.channel_id||O.user_id||"web-user"}const $=await Y.get("/api/sessions/"+encodeURIComponent(l.value));if($&&$.messages&&$.messages.length>0){for(const O of $.messages){const E=O.role==="user"?"user":"bot";let z=O.content||"";if(E==="user"){const H=z.match(/^\[.*?\]:\s*/);H&&(z=z.slice(H[0].length))}if(!z.trim())continue;const D={id:++o,role:E,content:z,timestamp:O.timestamp?O.timestamp*1e3:Date.now(),html:E==="bot"?Ku(z):"",tools_used:[],is_error:!1,images:E==="bot"?Wu(z):[],files:[],_showTools:!1};e.value.push(D)}Ot(()=>{R(),x()})}}catch{}}return Je(()=>{We.subscribe("chat",P),u.value=We.state||"disconnected",f=We.onStateChange,p=($,O)=>{u.value=$,f&&f($,O)},We.onStateChange=p,ne(),Ot(()=>{var $;return($=a.value)==null?void 0:$.focus()})}),_t(()=>{We.unsubscribe("chat",P),We.onStateChange===p&&(We.onStateChange=f),B()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:d,wsStatus:m,typingText:S,suggestions:c,send:W,autoResize:v,formatTime:dk,formatDate:_,showDateSeparator:w,useSuggestion:A,openImage:T,onImageError:C,getToolIcon:fk}}},kr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=j_(),s=ig(),n=ee({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=ee(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});ds(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var d;return(d=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:d.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`)}}return}}let i=null;function l(){const f=Date.now();e.value.forEach(p=>{p.status==="running"&&(p.elapsed=f-p.startTime)})}let r=!1;function o(){r||(r=!0,We.on("events",a),i||(i=setInterval(l,500)))}function c(){r&&(r=!1,We.off("events",a),i&&(clearInterval(i),i=null))}Je(o),As(o),Rs(c),_t(c);function d(f){return f<1e3?`${f}ms`:`${(f/1e3).toFixed(1)}s`}function u(f){return f==="running"?"clock":f==="success"?"success":f==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:d,statusIcon:u}},template:`
  ...
  `},Sg=Symbol("agent-detail-cancelled"),mk=15e3;function vk(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,r=!1,o,c;const d=new Promise((p,m)=>{o=p,c=m});function u(p,m){r||(r=!0,l!==null&&a(l),l=null,(p?o:c)(m))}let f;try{f=e(i==null?void 0:i.signal)}catch(p){u(!1,p)}return r||Promise.resolve(f).then(p=>u(!0,p),p=>u(!1,p)),!r&&Number.isFinite(t)&&t>0&&(l=n(()=>{const p=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${p}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sg),i==null||i.abort()}}}function Tg({state:e,requestDetail:t,timeoutMs:s=mk,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function r(){const f=l;l=null,f==null||f.cancel()}function o(f,{initial:p,coalesce:m}){if(!f)return Promise.resolve();if(m&&l&&l.agentId===f&&e.detailId===f)return l.promise;r();const y={agentId:f,cancel:null,promise:null};l=y,p?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const S=vk(R=>t(f,{signal:R}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return y.cancel=S.cancel,y.promise=(async()=>{let R=null,v=null;try{R=await S.promise}catch(g){v=g}R!==Sg&&(l!==y||e.detailId!==f||(l=null,!v&&(R===null||typeof R!="object")&&(v=new Error(`${n} response was empty or invalid`)),v?e.detail===null&&(e.detailError=(v==null?void 0:v.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=R,e.detailError=null),e.detailLoading=!1))})(),y.promise}function c(f){return e.detailId=f,o(f,{initial:!0,coalesce:!1})}function d(){const f=e.detailId;return f?o(f,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){r(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function bk({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let r=null;function o(){e()&&(t(),s()&&n())}function c(){r!==null&&(l(r),r=null)}function d(){c(),e()&&(r=i(o,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>r!==null}}const yk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=!1;const r=ee(()=>e.value.filter(E=>E.status==="running").length),o=ee(()=>e.value.filter(E=>E.status==="completed").length),c=ee(()=>e.value.filter(E=>["failed","timeout","killed"].includes(E.status)).length),d=ee(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),u=ee(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(E=>["failed","timeout","killed"].includes(E.status)):e.value.filter(E=>E.status===i.value));function f(E){const z=Number(E.max_iterations)||0;return z<=0?0:Math.min(100,Math.round(E.iteration_count/z*100))}function p(E){return(Number(E.max_iterations)||0)>0}function m(E,z){return E?E==="N/A"?"N/A":z==="current_inheritance"?`inherit (currently ${E})`:E:"unknown"}function y(E){return m(E.display_model,E.display_model_source||E.display_source)}function S(E){return m(E.display_reasoning_effort,E.display_reasoning_effort_source||E.display_source)}function R(E){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[E]||""}const v=h(null),g=h(null),x=h(!1),w=h(null),_=h(""),T=Tg({state:{get detail(){return v.value},set detail(E){v.value=E},get detailId(){return g.value},set detailId(E){g.value=E},get detailLoading(){return x.value},set detailLoading(E){x.value=E},get detailError(){return w.value},set detailError(E){w.value=E}},requestDetail:(E,{signal:z})=>Y.get(`/api/agents/${encodeURIComponent(E)}`,{signal:z})});async function C(E){_.value="",await T.open(E.id)}function L(){T.close(),_.value=""}async function B(){await T.refresh()}async function P(E,z){try{await navigator.clipboard.writeText(z||""),_.value=E,setTimeout(()=>{_.value===E&&(_.value="")},1500)}catch{Se.error("Copy failed")}}async function N(E=!1){E=E===!0,E||(t.value=!0);try{const z=await Y.get("/api/agents");e.value=Array.isArray(z)?z:[],s.value=null}catch(z){E||(s.value=z.message)}E||(t.value=!1)}async function W(E){const z=e.value.find(H=>H.id===E);if(await bs({title:"Kill agent",message:`Kill agent "${(z==null?void 0:z.label)||E}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=E;try{await Y.del(`/api/agents/${encodeURIComponent(E)}`),Se.success("Agent killed"),await N()}catch(H){Se.error(H.message||"Failed to kill agent")}n.value=null}}const ne=bk({isEnabled:()=>a.value&&l,refreshList:()=>N(!0),hasOpenDetail:()=>!!g.value,refreshDetail:B});function $(){ne.start()}function O(){ne.stop()}return ds(a,()=>ne.sync()),Je(()=>{l=!0,N(),$()}),As(()=>{l=!0,N(!0),$()}),Rs(()=>{l=!1,O()}),_t(()=>{l=!1,O(),T.close()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:d,filteredAgents:u,formatTs:ra,formatDuration:ja,progressPercent:f,hasProgress:p,displayModelText:y,displayEffortText:S,displaySourceLabel:R,detail:v,detailId:g,detailLoading:x,detailError:w,copied:_,openDetail:C,closeDetail:L,copyText:P,fetchAgents:N,killAgent:W,startAutoRefresh:$,stopAutoRefresh:O}}},xk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h(null),d=h(null),u=h(!1),f=h(null),p=h("");let m=!1;const S=Tg({state:{get detail(){return c.value},set detail(O){c.value=O},get detailId(){return d.value},set detailId(O){d.value=O},get detailLoading(){return u.value},set detailLoading(O){u.value=O},get detailError(){return f.value},set detailError(O){f.value=O}},detailLabel:"Loop detail",requestDetail:(O,{signal:E})=>Y.get(`/api/loops/${encodeURIComponent(O)}?limit=100`,{signal:E})});async function R(O){p.value="",await S.open(O.id)}function v(){S.close(),p.value=""}async function g(O,E){try{await navigator.clipboard.writeText(E||""),p.value=O,setTimeout(()=>{p.value===O&&(p.value="")},1500)}catch{Se.error("Copy failed")}}const x=ee(()=>e.value.reduce((O,E)=>O+(E.iteration_count||0),0)),w=ee(()=>e.value.filter(O=>O.status==="running").length);function _(O){return O==="running"?"loop-status-running":O==="error"?"loop-status-error":"loop-status-stopped"}function A(O){return O==="running"?"badge-success":O==="error"?"badge-danger":O==="completed"?"badge-info":"badge-warning"}function T(O){return O==="act"?"badge-warning":O==="silent"?"badge-info":"badge-success"}async function C(O=!1){O=O===!0,O||(t.value=!0);try{const E=await Y.get("/api/loops");e.value=Array.isArray(E)?E:[],s.value=null}catch(E){O||(s.value=E.message)}O||(t.value=!1)}async function L(){l.value=null;const O=a.value;if(!O.goal.trim()){l.value="Goal is required";return}if(!O.channel_id.trim()){l.value="Channel ID is required";return}const E={goal:O.goal.trim(),channel_id:O.channel_id.trim(),interval_seconds:O.interval_seconds||60,mode:O.mode,max_iterations:O.max_iterations||50};O.stop_condition.trim()&&(E.stop_condition=O.stop_condition.trim()),i.value=!0;try{const z=await Y.post("/api/loops",E);Se.success(`Loop started: ${z.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await C()}catch(z){l.value=z.message}i.value=!1}async function B(O){if(await bs({title:"Stop loop",message:`Stop loop ${O}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=O;try{await Y.del(`/api/loops/${encodeURIComponent(O)}`),Se.success("Loop stopped"),await C()}catch(z){Se.error(z.message||"Failed to stop loop")}r.value=null}}async function P(O){o.value=O;try{await Y.post(`/api/loops/${encodeURIComponent(O)}/restart`),Se.success("Loop restarted"),await C()}catch(E){Se.error(E.message||"Failed to restart loop")}o.value=null}function N(O){m&&O.payload&&(O.payload.loop_id||O.payload.type==="loop")&&(C(!0),d.value&&S.refresh())}let W=null;function ne(){W!==null&&clearInterval(W),W=null}function $(){ne(),m&&(W=setInterval(()=>{C(!0),d.value&&S.refresh()},5e3))}return Je(()=>{m=!0,C(),We.subscribe("events",N),$()}),As(()=>{m=!0,C(!0),$()}),Rs(()=>{m=!1,ne()}),_t(()=>{m=!1,We.unsubscribe("events",N),ne(),S.close()}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,detail:c,detailId:d,detailLoading:u,detailError:f,copied:p,totalIterations:x,runningCount:w,statusDotClass:_,statusBadge:A,modeBadge:T,formatAge:lg,formatDuration:ja,formatTs:ra,formatTokens:cg,openDetail:R,closeDetail:v,copyText:g,fetchLoops:C,doCreate:L,doStop:B,doRestart:P}}},_k={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=ee(()=>e.value.filter(v=>v.status==="running").length),r=ee(()=>e.value.filter(v=>v.status!=="running").length);function o(v){return v==="running"?"loop-status-running":v==="failed"||v==="error"?"loop-status-error":"loop-status-stopped"}function c(v){return v==="running"?"badge-success":v==="completed"||v==="exited"?"badge-info":v==="killed"||v==="error"||v==="failed"?"badge-danger":"badge-warning"}async function d(v=!1){v=v===!0,v||(t.value=!0);try{e.value=await Y.get("/api/processes"),s.value=null}catch(g){v||(s.value=g.message)}v||(t.value=!1)}function u(){f(),n.value&&(a=setInterval(()=>{t.value||d(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}ds(n,v=>{v?u():f()});async function p(v){if(await bs({title:"Kill process",message:`Kill process ${v}?`,confirmLabel:"Kill",danger:!0})){i.value=v;try{await Y.del(`/api/processes/${v}`),Se.success(`Process ${v} killed`),await d()}catch(x){Se.error(x.message||"Failed to kill process")}i.value=null}}function m(v){v.payload&&(v.payload.pid||v.payload.type==="process")&&d(!0)}let y=!1;function S(){y||(y=!0,d(),We.subscribe("events",m),u())}function R(){y&&(y=!1,We.unsubscribe("events",m),f())}return Je(S),As(S),Rs(R),_t(R),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:ja,fetchProcesses:d,doKill:p}}},wk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=ee(()=>{const D=(a.value.run_at||"").trim();if(!D)return"";const H=new Date(D);return Number.isNaN(H.getTime())?"":`${H.toLocaleString()} (${H.toISOString()})`}),o=h(null),c=h(!1),d=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),f=h(null),p=h(null),m=h(null),y=h(null),S=h([]),R=h(!1),v=h("");let g=0;const x=ee(()=>e.value.filter(D=>D.cron&&!D.one_time).length),w=ee(()=>e.value.filter(D=>D.one_time).length),_=ee(()=>e.value.filter(D=>D.trigger).length),A=ee(()=>e.value.filter(D=>D.paused).length),T=ee(()=>e.value.filter(D=>D.consecutive_failures>0).length);function C(D){if(!D)return"-";const H=Date.now(),ie=(new Date(D).getTime()-H)/1e3;if(ie<0)return"overdue";if(ie<60)return"in < 1 min";if(ie<3600)return`in ${Math.floor(ie/60)} min`;if(ie<86400){const he=Math.floor(ie/3600),Ne=Math.floor(ie%3600/60);return Ne>0?`in ${he}h ${Ne}m`:`in ${he}h`}const Q=Math.floor(ie/86400);return`in ${Q} day${Q!==1?"s":""}`}function L(D){return D==null?"-":D<1e3?`${D}ms`:D<6e4?`${(D/1e3).toFixed(1)}s`:ja(D/1e3)}function B(){o.value=null}async function P(){const D=a.value.cron.trim();if(D){c.value=!0;try{o.value=await Y.post("/api/schedules/validate-cron",{expression:D})}catch(H){o.value={valid:!1,error:H.message}}c.value=!1}}async function N(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/schedules")}catch(D){s.value=D.message}t.value=!1}async function W(D){if(y.value===D){y.value=null,S.value=[];return}y.value=D,R.value=!0,S.value=[];const H=++g;try{const te=await Y.get(`/api/schedules/${encodeURIComponent(D)}/history?limit=10`);if(H!==g||y.value!==D)return;S.value=te,v.value=""}catch(te){if(H!==g||y.value!==D)return;S.value=[],v.value=te.message||"Failed to load execution history"}H===g&&(R.value=!1)}async function ne(){l.value=null;const D=a.value;if(!D.description.trim()){l.value="Description is required";return}if(!D.channel_id.trim()){l.value="Channel ID is required";return}if(!D.cron.trim()&&!D.run_at.trim()){l.value="Cron expression or run_at time is required";return}const H={description:D.description.trim(),action:D.action,channel_id:D.channel_id.trim()};if(D.cron.trim()&&(H.cron=D.cron.trim()),D.run_at.trim()){const te=new Date(D.run_at.trim());if(Number.isNaN(te.getTime())){l.value="One-time run time is not a valid date";return}H.run_at=te.toISOString()}if(D.action==="reminder"&&D.message.trim()&&(H.message=D.message.trim()),D.action==="check"&&(D.tool_name.trim()&&(H.tool_name=D.tool_name.trim()),D.tool_input_str.trim()))try{H.tool_input=JSON.parse(D.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await Y.post("/api/schedules",H),Se.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},o.value=null,n.value=!1,await N()}catch(te){l.value=te.message}i.value=!1}async function $(D){u.value=D;try{const H=await Y.post(`/api/schedules/${encodeURIComponent(D)}/run`);if(H.status==="failure")Se.error(`Execution failed: ${H.error||"unknown error"}`);else{const te=H.warning?`Executed (${H.warning})`:"Executed successfully";Se.success(te)}await N()}catch(H){Se.error(H.message||"Failed to trigger")}u.value=null}async function O(D){p.value=D.id;const H=!D.paused;try{await Y.put(`/api/schedules/${encodeURIComponent(D.id)}`,{paused:H}),Se.success(H?"Schedule paused":"Schedule resumed"),await N()}catch(te){Se.error(te.message||"Failed to update schedule")}p.value=null}async function E(D){m.value=D;try{await Y.post(`/api/schedules/${encodeURIComponent(D)}/reset-failures`),Se.success("Failure counters reset"),await N()}catch(H){Se.error(H.message||"Failed to reset")}m.value=null}async function z(D){const H=e.value.find(ie=>ie.id===D);if(await bs({title:"Delete schedule",message:`Delete "${(H==null?void 0:H.description)||D}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){f.value=D;try{await Y.del(`/api/schedules/${encodeURIComponent(D)}`),Se.success("Schedule deleted"),await N()}catch(ie){Se.error(ie.message||"Failed to delete schedule")}f.value=null}}return Je(()=>{N()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:r,cronResult:o,validatingCron:c,cronPresets:d,runningId:u,deletingId:f,togglingId:p,resettingId:m,expandedId:y,history:S,historyLoading:R,historyError:v,cronCount:x,oneTimeCount:w,webhookCount:_,pausedCount:A,failingCount:T,formatTs:ra,formatAge:lg,formatFuture:C,formatMs:L,formatDuration:ja,onCronInput:B,validateCron:P,toggleExpand:W,fetchSchedules:N,doCreate:ne,doRunNow:$,doTogglePause:O,doResetFailures:E,doDelete:z}}},kk={components:{TabbedPage:kr},setup(){return{tabs:[{id:"live",label:"Live",component:gk},{id:"agents",label:"Agents",component:yk},{id:"loops",label:"Loops",component:xk},{id:"processes",label:"Processes",component:_k},{id:"schedules",label:"Schedules",component:wk}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},Sk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const r=h(null),o=h(!1),c=h(new Set),d=h(!1),u=h("all"),f=h(""),p=h("last_active"),m=h(!1),y=Zu,S=Tk,R=h([]),v=h(!1),g=h(""),x=h("flat"),w=h(new Set),_=h(""),A=h(""),T=h(""),C=h(null),L=h(!1);function B(){try{const V=localStorage.getItem("odin-session-presets");V&&(R.value=JSON.parse(V))}catch{}}function P(){try{localStorage.setItem("odin-session-presets",JSON.stringify(R.value))}catch{}}const N=ee(()=>f.value.trim()!==""||u.value!=="all"),W=ee(()=>{let V=[...e.value];const _e=Zu.find(Ye=>Ye.id===u.value),Ie=_e?_e.filters:{};if(Ie.source&&(V=V.filter(Ye=>Ye.source===Ie.source)),Ie.minMessages&&(V=V.filter(Ye=>Ye.message_count>=Ie.minMessages)),Ie.hasCompaction&&(V=V.filter(Ye=>Ye.has_summary)),Ie.maxAge!=null){const Ye=Date.now()/1e3;V=V.filter(ht=>ht.last_active&&Ye-ht.last_active<=Ie.maxAge)}if(f.value.trim()){const Ye=f.value.toLowerCase().trim();V=V.filter(ht=>(ht.channel_id||"").toLowerCase().includes(Ye)||(ht.last_user_id||"").toLowerCase().includes(Ye)||(ht.source||"").toLowerCase().includes(Ye))}const Me=p.value,ze=m.value?1:-1;return V.sort((Ye,ht)=>{const ts=Ye[Me]||0,Is=ht[Me]||0;return(ts-Is)*ze}),V}),ne=ee(()=>{if(!a.value||!a.value.messages)return[];const V=a.value.messages;if(V.length===0)return[];const _e=[];let Ie=[];for(const Me of V)Me.role==="user"&&Ie.length>0&&(_e.push(Ie),Ie=[]),Ie.push(Me);return Ie.length>0&&_e.push(Ie),_e}),$=ee(()=>W.value.length>0&&c.value.size===W.value.length);function O(V){const _e=V.find(Ie=>Ie.role==="user");if(_e&&_e.content){const Ie=_e.content.slice(0,120);return Ie.length<_e.content.length?Ie+"...":Ie}return"(no user message)"}function E(V){const _e=new Set(w.value);_e.has(V)?_e.delete(V):_e.add(V),w.value=_e}function z(V){u.value=V}function D(V){u.value=V.id,V.filters.searchQuery!=null&&(f.value=V.filters.searchQuery),V.filters.sortBy&&(p.value=V.filters.sortBy)}function H(){if(!g.value.trim())return;const V={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:f.value,sortBy:p.value}};R.value=[...R.value,V],P(),v.value=!1,g.value=""}function te(V){R.value=R.value.filter(_e=>_e.id!==V),P(),u.value===V&&(u.value="all")}function ie(){u.value="all",f.value="",p.value="last_active",m.value=!1}function Q(V){if(!V)return"—";const _e=Date.now()/1e3-V;if(_e<60)return"just now";if(_e<3600){const Me=Math.floor(_e/60);return`${Me} minute${Me!==1?"s":""} ago`}if(_e<86400){const Me=Math.floor(_e/3600);return`${Me} hour${Me!==1?"s":""} ago`}const Ie=Math.floor(_e/86400);return`${Ie} day${Ie!==1?"s":""} ago`}function he(V){if(!V)return"";try{return new Date(V*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Ne(V){if(!V)return"";try{return new Date(V*1e3).toLocaleString()}catch{return""}}function q(V){return V==="user"?"bg-gray-900/50 border border-gray-800":V==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function pe(V){return V==="user"?"sess-msg-user":V==="assistant"?"sess-msg-assistant":"sess-msg-system"}function de(V){return V==="user"?"badge-info":V==="assistant"?"badge-success":"badge-warning"}function xe(V){return V==="user"?"sess-dot-user":V==="assistant"?"sess-dot-assistant":"sess-dot-system"}function me(V){return V==="user"?"text-cyan-400":V==="assistant"?"text-indigo-400":"text-gray-500"}function Be(V){return V?V.length>2e3?V.slice(0,2e3)+`
... (truncated)`:V:""}async function b(){const V=_.value.trim();if(V){L.value=!0;try{let _e=`/api/sessions/search?q=${encodeURIComponent(V)}&limit=50`;A.value.trim()&&(_e+=`&channel_id=${encodeURIComponent(A.value.trim())}`),T.value.trim()&&(_e+=`&user_id=${encodeURIComponent(T.value.trim())}`);const Ie=await Y.get(_e);C.value=Ie.results||[]}catch{C.value=[]}L.value=!1}}function I(){_.value="",A.value="",T.value="",C.value=null}function F(V){return V?V.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function X(V){return V==="user"?"fts-result-user":V==="assistant"?"fts-result-assistant":V==="summary"?"fts-result-summary":V==="fts"?"fts-result-fts":V==="channel"?"fts-result-channel":"fts-result-default"}function Z(V){return V==="user"?"badge-info":V==="assistant"?"badge-success":V==="summary"?"badge-warning":V==="fts"?"badge-success":"badge-info"}async function J(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/sessions")}catch(V){s.value=V.message}t.value=!1}function ue(){s.value=null,J()}async function oe(V){if(n.value===V){n.value=null,a.value=null,w.value=new Set;return}n.value=V,a.value=null,i.value=!0,w.value=new Set;const _e=++l;try{const Ie=await Y.get(`/api/sessions/${encodeURIComponent(V)}`);_e===l&&n.value===V&&(a.value=Ie)}catch(Ie){_e===l&&n.value===V&&(a.value={messages:[],summary:"",error:Ie.message||"Failed to load session"})}finally{_e===l&&(i.value=!1)}}function le(V){const _e=new Set(c.value);_e.has(V)?_e.delete(V):_e.add(V),c.value=_e}function se(){$.value?c.value=new Set:c.value=new Set(W.value.map(V=>V.channel_id))}function ye(V){r.value=V}async function fe(){if(r.value){o.value=!0;try{await Y.del(`/api/sessions/${encodeURIComponent(r.value)}`),n.value===r.value&&(n.value=null,a.value=null),c.value.delete(r.value),await J()}catch(V){s.value=V.message||"Failed to clear session"}o.value=!1,r.value=null}}function ge(){d.value=!0}async function we(){if(c.value.size!==0){o.value=!0;try{await Y.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await J()}catch(V){s.value=V.message||"Failed to clear sessions"}o.value=!1,d.value=!1}}function Te(V,_e){const Ie=Y._token;let Me=`/api/sessions/${encodeURIComponent(V)}/export?format=${_e}`;Ie&&(Me+=`&token=${encodeURIComponent(Ie)}`);const ze=document.createElement("a");ze.href=Me,ze.download=`session-${V}.${_e==="text"?"txt":"json"}`,document.body.appendChild(ze),ze.click(),document.body.removeChild(ze)}let Re=null;function De(V){V.payload&&V.payload.channel_id&&(clearTimeout(Re),Re=setTimeout(()=>{if(J(),n.value&&V.payload.channel_id===n.value){const _e=n.value,Ie=l;Y.get(`/api/sessions/${encodeURIComponent(_e)}`).then(Me=>{Ie!==l||n.value!==_e||(a.value=Me)}).catch(()=>{})}},2e3))}let Fe=!1;function Ve(){Fe||(Fe=!0,J(),We.subscribe("events",De))}Je(()=>{B(),Ve()}),As(()=>{Ve()});function st(){Fe&&(Fe=!1,We.unsubscribe("events",De),clearTimeout(Re))}return Rs(st),_t(st),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:r,clearing:o,selected:c,allSelected:$,bulkClearing:d,activePreset:u,searchQuery:f,sortBy:p,sortAsc:m,filterPresets:y,sortOptions:S,filteredSessions:W,hasActiveFilters:N,customPresets:R,showSavePreset:v,newPresetName:g,threadView:x,threads:ne,collapsedThreads:w,ftsQuery:_,ftsChannelId:A,ftsUserId:T,ftsResults:C,ftsSearching:L,formatAge:Q,formatTimestamp:he,formatFullTimestamp:Ne,messageClass:q,threadMsgClass:pe,roleBadge:de,roleDotClass:xe,roleLabelClass:me,truncateContent:Be,threadSummary:O,fetchSessions:J,retry:ue,toggleSession:oe,toggleSelect:le,toggleSelectAll:se,confirmClear:ye,clearSession:fe,confirmBulkClear:ge,doBulkClear:we,exportSession:Te,applyPreset:z,applyCustomPreset:D,saveCustomPreset:H,removeCustomPreset:te,resetFilters:ie,toggleThread:E,runFtsSearch:b,clearFtsSearch:I,highlightSnippet:F,ftsResultClass:X,ftsTypeBadge:Z}}},Ek={props:["trace"],template:`
...
`)}const Dk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),d=h(""),u=h(""),f=h(null),p=h(null),m=h(!1),y=h(null),S=h(null),R=h(!1),v=ee(()=>e.value.length),g=ee(()=>e.value.reduce((Q,he)=>Q+(he.execution_count||0),0)),x=ee(()=>e.value.reduce((Q,he)=>Q+L(he.code),0)),w=ee(()=>{if(!l.value)return e.value;const Q=l.value.toLowerCase();return e.value.filter(he=>he.name.toLowerCase().includes(Q)||(he.description||"").toLowerCase().includes(Q))}),_=ee(()=>u.value?u.value.split(`
`).length:0),A=ee(()=>{const Q=Math.max(_.value,1);return Array.from({length:Q},(he,Ne)=>Ne+1).join(`
...
`).length:0}function B(Q){return Nk(Q)}function P(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function N(Q){try{await navigator.clipboard.writeText(Q);const he=e.value.find(Ne=>Ne.code===Q);he&&(r.value=he.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function W(Q){if(Q.key==="Tab"){Q.preventDefault();const he=Q.target,Ne=he.selectionStart,q=he.selectionEnd;u.value=u.value.substring(0,Ne)+"    "+u.value.substring(q),Ot(()=>{he.selectionStart=he.selectionEnd=Ne+4})}}function ne(Q){const he=Q.target.previousElementSibling;he&&(he.scrollTop=Q.target.scrollTop)}async function $(){t.value=!0,s.value=null;try{e.value=await Y.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function O(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const he=await Y.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:he}}catch(he){a.value={...a.value,[Q]:{result:he.message,is_error:!0}}}i.value=null}function E(){o.value=!0,c.value="create",d.value="",u.value="",f.value=null,p.value=null}function z(Q){o.value=!0,c.value="edit",d.value=Q.name,u.value=Q.code||"",f.value=null,p.value=null}function D(){o.value=!1,f.value=null,p.value=null}async function H(){f.value=null,p.value=null;const Q=d.value.trim(),he=u.value.trim();if(!Q){f.value="Name is required";return}if(!he){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await Y.post("/api/skills",{name:Q,code:he}),p.value="Skill created successfully"):(await Y.put(`/api/skills/${encodeURIComponent(Q)}`,{code:he}),p.value="Skill updated successfully"),await $(),setTimeout(()=>{o.value=!1},800)}catch(Ne){f.value=Ne.message}m.value=!1}function te(Q){S.value=Q}async function ie(){if(S.value){R.value=!0;try{await Y.del(`/api/skills/${encodeURIComponent(S.value)}`),await $()}catch(Q){Se.error(`Failed to delete skill: ${Q.message||"unknown error"}`)}R.value=!1,S.value=null}}return Je(()=>{$()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:d,editCode:u,editError:f,editSuccess:p,saving:m,editorRef:y,deleteTarget:S,deleting:R,enabledCount:v,totalExecutions:g,totalLines:x,displayedSkills:w,editLineCount:_,editorLineNums:A,editValidation:T,highlight:C,truncate:Mc,formatTs:ra,countLines:L,getLineNumbers:B,toggleCode:P,copyCode:N,handleEditorKey:W,syncScroll:ne,fetchSkills:$,testSkill:O,showCreate:E,editSkill:z,cancelEdit:D,saveSkill:H,confirmDelete:te,doDelete:ie}}};function Mk(e,t){if(!e||!t)return Eu(e);const s=Eu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Pk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),d=h(""),u=h(null),f=h(null),p=h(!1),m=h(null),y=h(null);let S=null;const R=h(null),v=h(!1),g=h({}),x=h({}),w=h(null),_=h(null),A=ee(()=>e.value.reduce((E,z)=>E+(z.chunks||0),0)),T=ee(()=>new Set(e.value.map(z=>z.uploader).filter(Boolean)).size);function C(E,z){const D=x.value[z];if(!D||D.length===0)return 0;const H=Math.max(...D.map(te=>te.char_count||0));return H===0?0:Math.round(E.char_count/H*100)}async function L(){t.value=!0,s.value=null;try{const E=await Y.get("/api/knowledge");e.value=Array.isArray(E)?E:[]}catch(E){s.value=E.message}t.value=!1}async function B(E){if(g.value[E]){g.value[E]=!1,_.value=null;return}if(g.value[E]=!0,!(x.value[E]||w.value===E)){w.value=E;try{const z=await Y.get(`/api/knowledge/${encodeURIComponent(E)}/chunks`);x.value[E]=Array.isArray(z)?z:[]}catch(z){x.value[E]=[],Se.error(`Failed to load chunks: ${z.message}`)}w.value=null}}async function P(){const E=n.value.trim();if(E){i.value=!0,r.value=null,l.value=E;try{const z=await Y.get(`/api/knowledge/search?q=${encodeURIComponent(E)}`);a.value=Array.isArray(z)?z:[]}catch(z){a.value=[],r.value=z.message||"Search failed"}i.value=!1}}function N(){a.value=null,n.value="",r.value=null}async function W(){u.value=null,f.value=null;const E=c.value.trim(),z=d.value.trim();if(!E){u.value="Source name is required";return}if(!z){u.value="Content is required";return}p.value=!0;try{const D=await Y.post("/api/knowledge",{source:E,content:z});f.value=`Ingested ${D.chunks||0} chunks from "${E}"`,c.value="",d.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(D){u.value=D.message}p.value=!1}async function ne(E){m.value=E,y.value=null,S&&(clearTimeout(S),S=null);try{const z=await Y.post(`/api/knowledge/${encodeURIComponent(E)}/reingest`);y.value={source:E,error:!1,message:`Re-ingested ${z.chunks||0} chunks`},delete x.value[E],await L(),S=setTimeout(()=>{y.value=null,S=null},3e3)}catch(z){y.value={source:E,error:!0,message:z.message}}m.value=null}function $(E){R.value=E}async function O(){if(R.value){v.value=!0;try{await Y.del(`/api/knowledge/${encodeURIComponent(R.value)}`),delete x.value[R.value],await L()}catch(E){Se.error(`Failed to delete source: ${E.message||"unknown error"}`)}v.value=!1,R.value=null}}return Je(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:y,deleteTarget:R,deleting:v,expanded:g,sourceChunks:x,loadingChunks:w,selectedChunk:_,totalChunks:A,uploaderCount:T,truncate:Mc,formatTs:ra,highlightTerms:Mk,chunkBarWidth:C,fetchSources:L,toggleSource:B,doSearch:P,clearSearch:N,doIngest:W,doReingest:ne,confirmDelete:$,doDelete:O}}},Fk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),f=h(null),p=h(""),m=h(!1),y=h(null),S=h(null),R=h(new Set),v=h(null),g=h(!1),x=h(!1),w=ee(()=>e.value.reduce((te,ie)=>te+ie.count,0)),_=ee(()=>R.value.size);function A(te){const ie=t.value[te];if(!ie)return[];if(!l.value.trim())return ie;const Q=l.value.trim().toLowerCase();return ie.filter(he=>he.key.toLowerCase().includes(Q)||he.value&&he.value.toLowerCase().includes(Q))}function T(te,ie){return R.value.has(te+"/"+ie)}function C(te,ie){const Q=te+"/"+ie,he=new Set(R.value);he.has(Q)?he.delete(Q):he.add(Q),R.value=he}function L(te){const ie=t.value[te];return!ie||ie.length===0?!1:ie.every(Q=>R.value.has(te+"/"+Q.key))}function B(te,ie){const Q=t.value[te];if(!Q)return;const he=new Set(R.value);for(const Ne of Q){const q=te+"/"+Ne.key;ie?he.add(q):he.delete(q)}R.value=he}async function P(){s.value=!0,n.value=null;try{const te=await Y.get("/api/memory");e.value=Object.entries(te).map(([ie,Q])=>({name:ie,keys:Q.keys||[],count:Q.count||0}))}catch(te){n.value=te.message}s.value=!1}async function N(te){if(a.value[te]){a.value[te]=!1;return}a.value[te]=!0;const ie=e.value.find(he=>he.name===te);if(!ie||t.value[te]||i.value===te)return;i.value=te;const Q=await Promise.all(ie.keys.map(async he=>{try{const Ne=await Y.get(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(he)}`);return{key:he,value:Ne.value||""}}catch{return{key:he,value:"(error loading)"}}}));t.value[te]=Q,i.value=null}function W(te,ie,Q){f.value=te+"/"+ie,p.value=Q}async function ne(te,ie){m.value=!0,y.value=null;try{await Y.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(ie)}`,{value:p.value});const Q=t.value[te];if(Q){const he=Q.find(Ne=>Ne.key===ie);he&&(he.value=p.value)}f.value=null}catch(Q){y.value=`Failed to save: ${Q.message||"unknown error"}`}m.value=!1}async function $(te,ie){try{await navigator.clipboard.writeText(ie.value),S.value=te+"/"+ie.key,setTimeout(()=>{S.value=null},1500)}catch{}}async function O(){d.value=null,u.value=null;const te=o.value.scope.trim(),ie=o.value.key.trim(),Q=o.value.value.trim();if(!te){d.value="Scope is required";return}if(!ie){d.value="Key is required";return}if(!Q){d.value="Value is required";return}c.value=!0;try{await Y.put(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(ie)}`,{value:Q}),u.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,u.value=null},800)}catch(he){d.value=he.message}c.value=!1}function E(te,ie){v.value={scope:te,key:ie}}async function z(){if(!v.value)return;g.value=!0,y.value=null;const{scope:te,key:ie}=v.value;try{await Y.del(`/api/memory/${encodeURIComponent(te)}/${encodeURIComponent(ie)}`);const Q=t.value[te];Q&&(t.value[te]=Q.filter(q=>q.key!==ie));const he=e.value.find(q=>q.name===te);he&&(he.count--,he.keys=he.keys.filter(q=>q!==ie));const Ne=new Set(R.value);Ne.delete(te+"/"+ie),R.value=Ne}catch(Q){y.value=`Failed to delete: ${Q.message||"unknown error"}`}g.value=!1,v.value=null}function D(){x.value=!0}async function H(){g.value=!0,y.value=null;const te=[];for(const ie of R.value){const Q=ie.indexOf("/");te.push({scope:ie.slice(0,Q),key:ie.slice(Q+1)})}try{await Y.post("/api/memory/bulk-delete",{entries:te}),R.value=new Set,t.value={},await P()}catch(ie){y.value=`Bulk delete failed: ${ie.message||"unknown error"}`}g.value=!1,x.value=!1}return Je(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:d,addSuccess:u,editingKey:f,editValue:p,saving:m,actionError:y,copied:S,selected:R,selectedCount:_,totalEntries:w,deleteTarget:v,deleting:g,showBulkDelete:x,fetchMemory:P,toggleScope:N,startEdit:W,doEdit:ne,copyValue:$,doAdd:O,confirmDelete:E,doDelete:z,confirmBulkDelete:D,doBulkDelete:H,isSelected:T,toggleSelect:C,isScopeAllSelected:L,toggleSelectAll:B,filteredEntries:A}}},$k={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const re=new Blob([U],{type:"text/plain"}),Oe=URL.createObjectURL(re),lt=document.createElement("a");lt.href=Oe,lt.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,lt.click(),URL.revokeObjectURL(Oe)}function J(U,re){const Oe=`${U.ts} ${U.level} ${U.text||U.raw||""}`;navigator.clipboard.writeText(Oe).then(()=>{f.value=re,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function ue(U){a.value=a.value===U?"":U,R.value="all"}function oe(U){return U.level==="ERROR"?"log-line-error":U.level==="WARNING"?"log-line-warning":"text-gray-300"}function le(U){return U==="ERROR"?"text-red-500 font-semibold":U==="WARNING"?"text-yellow-500":"text-blue-500"}function se(U){return U==="ERROR"?"log-chip-error":U==="WARNING"?"log-chip-warning":"log-chip-info"}function ye(U){R.value=U.id;const re=U.filters;a.value=re.level||"",v.value=re.timeRange||"",i.value=re.text||"",re.levels&&(a.value=re.levels[0]||""),re.hasToolName&&(i.value="")}function fe(U){R.value=U.id,a.value=U.filters.level||"",v.value=U.filters.timeRange||"",i.value=U.filters.text||""}function ge(){if(!w.value.trim())return;const U={id:"custom-"+Date.now(),name:w.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};g.value=[...g.value,U],T(),x.value=!1,w.value=""}function we(U){g.value=g.value.filter(re=>re.id!==U),T(),R.value===U&&(R.value="all")}const Te=h("all"),Re=h(""),De=h(""),Fe=h(""),Ve=h(""),st=h(""),V=h(100),_e=Wk,Ie=h(!1),Me=h(!1),ze=h(""),Ye=h([]),ht=h(null),ts=h(null);function Is(){e.value="search",ht.value||Ps()}async function Ps(){try{ht.value=await Y.get("/api/logs/stats")}catch{}}function Fs(){const U=st.value;if(!U){Fe.value="",Ve.value="";return}const Oe={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[U];if(Oe){const lt=new Date(Date.now()-Oe*1e3);Fe.value=us(lt),Ve.value=""}}function us(U){const re=Oe=>String(Oe).padStart(2,"0");return`${U.getFullYear()}-${re(U.getMonth()+1)}-${re(U.getDate())}T${re(U.getHours())}:${re(U.getMinutes())}`}function G(U){if(!U)return"";const re=new Date(U);return isNaN(re.getTime())?"":re.toISOString()}async function Ee(){Ie.value=!0,ze.value="",Me.value=!0,ts.value=null;try{const U=new URLSearchParams;Te.value&&Te.value!=="all"&&U.set("level",Te.value),Re.value&&U.set("tool",Re.value),De.value&&U.set("q",De.value);const re=G(Fe.value),Oe=G(Ve.value);re&&U.set("start",re),Oe&&U.set("end",Oe),U.set("limit",String(V.value));const lt=await Y.get(`/api/logs/search?${U.toString()}`);Ye.value=lt.entries||[]}catch(U){ze.value=U.message||"Search failed",Ye.value=[]}finally{Ie.value=!1}}function fs(){Te.value="all",Re.value="",De.value="",Fe.value="",Ve.value="",st.value="",V.value=100,Ye.value=[],Me.value=!1,ze.value="",ts.value=null}function Zs(U){ts.value=ts.value===U?null:U}function ca(U){if(!U.timestamp)return"";try{return new Date(U.timestamp).toLocaleString()}catch{return U.timestamp}}function wn(U){return U.type==="web_action"?`${U.status||""} (${U.execution_time_ms||0}ms)`:(U.result_summary||"").slice(0,200)}function Js(U){return U.error?"log-line-error":"text-gray-300"}function M(U){try{return JSON.stringify(U,null,2)}catch{return String(U)}}let j=null,ae=null,ke=!1;function Ce(){ke||(ke=!0,We.subscribe("logs",te),r.value=We.connected,o.value=We.state||"disconnected",j=We.onStateChange,ae=(U,re)=>{o.value=U,r.value=U==="connected",j&&j(U,re)},We.onStateChange=ae)}function Et(){ke&&(ke=!1,We.unsubscribe("logs",te),We.onStateChange===ae&&(We.onStateChange=j),ae=null,j=null)}return Je(()=>{A(),window.addEventListener("pointerup",b),window.addEventListener("pointercancel",b)}),As(Ce),Rs(Et),_t(()=>{Et(),window.removeEventListener("pointerup",b),window.removeEventListener("pointercancel",b)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:d,filteredLogs:D,pauseBuffer:_,showJumpBottom:u,copiedIndex:f,regexError:B,levels:m,logPresets:y,timeRanges:S,timeRange:v,activeLogPreset:R,customLogPresets:g,showSaveLogPreset:x,newLogPresetName:w,hasActiveLogFilters:C,timeRangeLabel:L,timelineBuckets:N,timelineMax:W,timelineSpanLabel:ne,timelineLabelSkip:$,togglePause:F,clearLogs:X,exportLogs:Z,logLineClass:oe,levelClass:le,levelChipClass:se,toggleLevel:ue,copyLine:J,jumpToBottom:he,onScroll:q,onUserScrollIntent:de,onUserScrollKey:xe,onAutoScrollToggle:I,onPointerDown:Be,applyLogPreset:ye,applyCustomLogPreset:fe,saveLogCustomPreset:ge,removeLogCustomPreset:we,segmentHeight:E,jumpToTimelineBucket:z,searchLevel:Te,searchTool:Re,searchKeyword:De,searchStart:Fe,searchEnd:Ve,searchTimePreset:st,searchLimit:V,searchLimits:_e,searching:Ie,searchRan:Me,searchError:ze,searchResults:Ye,searchStats:ht,expandedSearch:ts,switchToSearch:Is,runSearch:Ee,clearSearchFilters:fs,toggleSearchExpand:Zs,formatSearchTs:ca,searchEntryText:wn,searchLogLineClass:Js,formatJson:M,applySearchTimePreset:Fs}}},Cg="••••••••",Jk={timezone:{apply_mode:"restart",description:"Locale and scheduling defaults used across Odin."},discord:{apply_mode:"live_read",description:"Global Discord defaults. Guild and channel overrides take precedence."},llm_provider:{apply_mode:"live_apply",owner:"llm",description:"Active language-model provider and failover ownership."},openai_codex:{apply_mode:"live_apply",owner:"llm",description:"Codex models, reasoning, transport, and pool behaviour."},ollama:{apply_mode:"restart",owner:"llm",description:"Local or remote Ollama provider settings."},kimi:{apply_mode:"restart",owner:"llm",description:"Kimi provider settings and request limits."},context:{apply_mode:"restart",description:"System-prompt sources and prompt-budget controls."},sessions:{apply_mode:"restart",description:"Conversation persistence, retention, and history limits."},tools:{apply_mode:"restart",description:"Execution policy, hosts, timeouts, pools, and recovery."},logging:{apply_mode:"restart",description:"Runtime log verbosity and storage policy."},usage:{apply_mode:"activation_required",description:"Usage accounting and durable history storage."},webhook:{apply_mode:"restart",description:"Inbound webhook listener and authentication policy."},learning:{apply_mode:"restart",description:"Reflection, consolidation, and learned-context limits."},observability:{apply_mode:"live_read",description:"Metrics, tracing, and failure-classification controls."},email:{apply_mode:"restart",description:"SMTP and IMAP behaviour for email tools."},search:{apply_mode:"restart",description:"Knowledge and history search backends."},browser:{apply_mode:"restart",description:"Browser automation limits and viewport defaults."},permissions:{apply_mode:"restart",description:"Default and per-user execution policy."},comfyui:{apply_mode:"live_read",description:"ComfyUI image backend connection settings."},image:{apply_mode:"live_read",description:"Image routing and native generation policy."},web:{apply_mode:"restart",description:"Management API listener, authentication, and sessions."},attachments:{apply_mode:"live_read",description:"Attachment limits, paths, and cleanup policy."},personality:{apply_mode:"live_read",owner:"personality",description:"Response identity, style, and personality presets."},reaction_triggers:{apply_mode:"activation_required",owner:"reaction_triggers",description:"Discord reaction event automation."},message_triggers:{apply_mode:"activation_required",owner:"message_triggers",description:"Discord message event automation."},mcp:{apply_mode:"activation_required",owner:"mcp",description:"Model Context Protocol servers and tool publication."},slack:{apply_mode:"restart",description:"Slack destinations and internal alert forwarding."},issue_tracker:{apply_mode:"activation_required",owner:"issue_tracker",description:"Issue tracker provider and tool lifecycle."},audit:{apply_mode:"restart",description:"Audit signing, verification, and retention."},agents:{apply_mode:"live_for_new_work",description:"Spawned-agent budgets, inheritance, and tree limits."},grafana_alerts:{apply_mode:"activation_required",owner:"grafana_alerts",description:"Grafana alert intake, routing, and remediation."},outbound_webhooks:{apply_mode:"live_apply",owner:"outbound_webhooks",description:"Outbound event targets, delivery, and safety policy."},graceful_degradation:{apply_mode:"activation_required",description:"Subsystem failure thresholds and request guarding."},llm_recovery:{apply_mode:"restart",description:"Provider recovery, breaker, and retry policy."},turn_state:{apply_mode:"restart",description:"Durable turn checkpoints, expiry, and resume behaviour."}},Ju={timezone:{label:"Timezone",description:"Timezone used in prompts and scheduled-time parsing.",consumers:[{name:"Prompt context",apply_mode:"live_read",detail:"Future prompts read the configured value."},{name:"Time parser",apply_mode:"restart",detail:"The parser currently captures the boot value."}],restart_reason:"The scheduling parser captures timezone during startup."},"discord.token":{owner:"secrets",sensitivity:"sensitive",description:"Write-only Discord bot credential."},"discord.allowed_users":{description:"Global allowlist of Discord user IDs. An empty list allows all users."},"discord.channels":{description:"Global allowlist of Discord channel IDs. An empty list allows all channels."},"discord.require_mention":{description:"Require a mention by default unless a guild or channel override says otherwise."},"discord.respond_to_bots":{description:"Allow replies to bot-authored messages by default."},"llm_provider.active_provider":{enum:["codex","ollama","kimi"],description:"Provider used for new primary requests."},"openai_codex.enabled":{apply_mode:"live_apply",description:"Enable or disable the primary Codex client through the dedicated Codex reload path."},"openai_codex.model":{apply_mode:"live_apply",description:"Primary Codex model. Spawned agents may inherit it directly; chat and loops require a Codex reload.",consumers:[{name:"Spawned agents inheriting the main model",apply_mode:"live_read",detail:"Future agent generations read the configured model at call time."},{name:"Chat and autonomous loops",apply_mode:"live_apply",detail:"The dedicated Codex endpoint reloads the live client."}]},"openai_codex.max_tokens":{apply_mode:"live_apply",constraints:{minimum:1,maximum:128e3},unit:"tokens",description:"Maximum Codex response tokens; requires the dedicated Codex reload path."},"openai_codex.reasoning_effort":{apply_mode:"live_apply",description:"Main Codex reasoning effort; requires the dedicated Codex reload path."},"openai_codex.agent_reasoning_effort":{apply_mode:"live_read",description:"Reasoning policy for spawned-agent generations; future generations read it at call time."},"openai_codex.agent_model":{apply_mode:"live_read",description:"Model policy for spawned-agent generations; future generations read it at call time."},"openai_codex.credentials_path":{owner:"secrets",sensitivity:"sensitive",apply_mode:"restart",description:"Write-only Codex credential-store path; an existing client cannot switch stores live.",restart_reason:"The credential pool is constructed from this path when the Codex client starts."},"openai_codex.request_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Whole-request timeout; requires the dedicated Codex reload path."},"openai_codex.stream_stall_timeout_seconds":{apply_mode:"live_apply",unit:"seconds",description:"Maximum silent-stream interval; requires the dedicated Codex reload path."},"openai_codex.retry.max_retries":{apply_mode:"live_apply",description:"Retry-attempt ceiling; requires the dedicated Codex reload path."},"openai_codex.retry.base_delay":{apply_mode:"live_apply",unit:"seconds",description:"Initial retry delay; requires the dedicated Codex reload path."},"openai_codex.retry.max_delay":{apply_mode:"live_apply",unit:"seconds",description:"Maximum retry delay; requires the dedicated Codex reload path."},"openai_codex.connection_pool.max_connections":{apply_mode:"restart",description:"Maximum Codex transport connections.",restart_reason:"Connection-pool sizing is fixed when the live client transport is constructed."},"openai_codex.connection_pool.keepalive_timeout":{apply_mode:"restart",unit:"seconds",description:"Codex connection keepalive timeout.",restart_reason:"Connection-pool keepalive policy is fixed when the live client transport is constructed."},"openai_codex.context_compression.enabled":{apply_mode:"restart",description:"Enable context compression for chat and agent tool loops.",restart_reason:"The context-compressor holder is constructed at startup and has no live apply path."},"openai_codex.context_compression.max_context_chars":{apply_mode:"restart",unit:"characters",description:"Context size at which compression begins.",restart_reason:"The context-compressor holder retains its startup configuration."},"openai_codex.context_compression.keep_recent_iterations":{apply_mode:"restart",unit:"iterations",description:"Recent tool iterations preserved during compression.",restart_reason:"The context-compressor holder retains its startup configuration."},"logging.level":{enum:["DEBUG","INFO","WARNING","ERROR","CRITICAL"],description:"Minimum runtime log level."},"browser.default_timeout_ms":{constraints:{minimum:1e3},unit:"ms",description:"Default browser operation timeout."},"browser.viewport_width":{constraints:{minimum:100,maximum:7680},unit:"px"},"browser.viewport_height":{constraints:{minimum:100,maximum:4320},unit:"px"},"sessions.max_history":{constraints:{minimum:1,maximum:1e4},unit:"messages"},"sessions.max_age_hours":{constraints:{minimum:1},unit:"hours"},"tools.command_timeout_seconds":{constraints:{minimum:10,maximum:3600},unit:"seconds"},"agents.max_children_per_agent":{apply_mode:"activation_required",description:"Child limit adopted by newly spawned parent agents after explicit activation.",activation_policy:"Explicitly apply the configured limit after reviewing worst-case tree breadth."},"context.max_system_prompt_tokens":{apply_mode:"activation_required",description:"Optional hard budget for future assembled system prompts.",activation_policy:"Preview mandatory prompt usage and omissions before applying the budget."},"usage.directory":{apply_mode:"activation_required",description:"Target for durable usage history; currently no durable store is active.",activation_policy:"Validate the path and explicitly enable durable usage history."},"slack.forward_alerts":{apply_mode:"activation_required",description:"Forward normalized internal alerts to tested Slack destinations.",activation_policy:"Requires an effective notifier, tested destination, and activation receipt."},"grafana_alerts.enabled":{apply_mode:"activation_required",description:"Adopt explicit Grafana processing control without changing legacy webhook behaviour on upgrade.",activation_policy:"Explicit adoption preserves working legacy-control installations."},"graceful_degradation.enabled":{apply_mode:"activation_required",description:"Allow subsystem guards to short-circuit calls while a dependency is unhealthy.",activation_policy:"Explicit adoption resolves the legacy always-on behaviour."}},Yk=["tools.enabled","tools.max_tool_iterations_chat","tools.max_tool_iterations_loop","learning.loop_reflection_enabled","turn_state.retention"],Qk=new Set(["token","api_token","api_key","password","secret","credentials_path","ssh_key_path","hmac_key","webhook_urls","headers","env"]);function ni(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function Xk(e){return Array.isArray(e)?"array":e===null?"null":Number.isInteger(e)?"integer":typeof e=="number"?"number":typeof e=="boolean"?"boolean":typeof e=="object"?"object":"string"}function Eg(e,t="",s=[]){if(e&&typeof e=="object"&&!Array.isArray(e)){const n=Object.entries(e);n.length===0&&t&&s.push([t,e]);for(const[a,i]of n)Eg(i,t?`${t}.${a}`:a,s);return s}return t&&s.push([t,e]),s}function e1(e){return e.split(".").some(s=>Qk.has(s))}function t1(e){return Ju[e]?Ju[e]:e.startsWith("mcp.servers.")&&(e.endsWith(".headers")||e.endsWith(".env"))?{owner:"secrets",sensitivity:"secret_container"}:e.startsWith("outbound_webhooks.targets.")&&e.endsWith(".secret")?{owner:"secrets",sensitivity:"sensitive"}:e.startsWith("outbound_webhooks.targets.")&&(e.endsWith(".scrub_secrets")||e.endsWith(".verify_ssl"))?{apply_mode:"activation_required",activation_policy:"Review this target and acknowledge the target-bound safety override."}:{}}function Ag(e){return e==null||e===""?!1:Array.isArray(e)?e.length>0:typeof e=="object"?Object.keys(e).length>0:!0}function Yu(e,t){return t==="public"?e:e&&typeof e=="object"?Array.isArray(e)?[]:{}:Ag(e)?Cg:""}function s1(e){return e.valid===!1?"invalid":e.pending_restart?"pending_restart":e.drift?"drift":e.apply_mode==="activation_required"||e.apply_mode==="dormant"?"dormant":"applied"}function n1(e,t){const s=e.split(".")[0],n=e.split(".").at(-1),a=Jk[s]||{apply_mode:"restart",description:`${ni(s)} configuration.`},i=t1(e),l=i.sensitivity||(e1(e)?"sensitive":"public");let r=i.apply_mode||a.apply_mode;Yk.some(p=>e===p||e.startsWith(`${p}.`))&&(r="live_read");const o=i.owner||a.owner||(l==="public"?"config":"secrets"),c=Yu(t,l),d=Yu(t,l),u=Ag(t)&&!(l!=="public"&&t===Cg),f={path:e,owner:o,label:i.label||ni(n),description:i.description||`${ni(n)} setting for ${ni(s)}.`,aliases:i.aliases||[],unit:i.unit||null,examples:i.examples||[],type:i.type||Xk(t),enum:i.enum||null,constraints:i.constraints||{},default:i.default??null,sensitivity:l,secret_route:l==="public"?null:`/api/config/secrets/${encodeURIComponent(e)}`,apply_mode:r,apply_handler:i.apply_handler||null,consumers:i.consumers||[],restart_reason:i.restart_reason||(r==="restart"?`${ni(s)} is currently constructed during startup.`:null),activation_policy:i.activation_policy||(r==="activation_required"?"Saving configuration does not enable this feature. Explicit activation is required.":null),desired:c,effective:d,configured:u,provenance:u?"config_file":"unset",valid:!0,validation_errors:[],pending_restart:!1,drift:!1,last_apply:null};return f.apply_state=s1(f),f}function a1(e){const t={applied:0,pending_restart:0,dormant:0,invalid:0,drift:0};for(const s of e)Object.hasOwn(t,s.apply_state)&&(t[s.apply_state]+=1);return t}function i1(e){const t=Eg(e||{}).map(([s,n])=>n1(s,n));return{schema_version:1,revision:"local-fixture",generated_at:null,fields:t,status:{counts:a1(t),persistence_error:null,unsafe_overrides:[],desired_revision:null,effective_revision:null}}}const Oa=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["personality","context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],l1=[{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Activation required",short:"Dormant",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"}],r1={live_read:"Applies immediately",live_apply:"Reloads live",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Activation required",legacy_control:"Legacy control",dormant:"Not wired"},Qu={llm:{label:"LLM Config",href:"#/system?tab=llm",description:"This section has one canonical editor so provider changes use the safe switch and reload paths."},personality:{label:"Personality",href:"#/personality",description:"Personality presets and the active profile are managed on the dedicated Personality page."},discord:{label:"Discord overrides",href:"#/system?tab=discord",description:"Guild and channel overrides take precedence over these global defaults."},secrets:{label:"Secret controls",href:"#/system?tab=config",description:"Secret values are write-only and use dedicated set and clear flows."}},Rg="odin_config_center_expanded_v1",Ig="odin_config_center_category_v1",o1=50,Xu=e=>Promise.resolve(i1(e));function Rn(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function bi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Us(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function c1(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function d1(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Og(e,t){if(bi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return Rn(t);const n={};for(const[a,i]of Object.entries(t)){const l=Og(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function u1(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Og(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Lg(e,t,s,n){if(bi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Lg(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function f1(){try{const e=JSON.parse(localStorage.getItem(Rg)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function p1(){try{const e=localStorage.getItem(Ig);return Oa.some(t=>t.key===e)?e:Oa[0].key}catch{return Oa[0].key}}const h1={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(!1),a=h(null),i=h(null),l=h(""),r=h("all"),o=h(p1()),c=h(f1()),d=h({}),u=h(null),f=h(void 0),p=h(!1),m=h({}),y=h([]),S=h([]),R=h(!1),v=h(!1),g=h(!1);let x=null;const w=ee(()=>{var M;return((M=t.value)==null?void 0:M.fields)||[]}),_=ee(()=>new Map(w.value.map(M=>[M.path,M]))),A=ee(()=>e.value?Object.keys(e.value).length:0),T=ee(()=>w.value.length),C=ee(()=>l1),L=ee(()=>y.value.length>0),B=ee(()=>S.value.length>0),P=ee(()=>{if(!e.value)return[];const M=new Set(Oa.flatMap(ke=>ke.sections)),j=Oa.map(ke=>({...ke,sections:ke.sections.filter(Ce=>Object.hasOwn(e.value,Ce))})).filter(ke=>ke.sections.length),ae=Object.keys(e.value).filter(ke=>!M.has(ke));return ae.length&&j.push({key:"other",label:"Other",icon:"folder",sections:ae}),j}),N=ee(()=>{if(!e.value)return[];const M=[];for(const[j,ae]of Object.entries(d.value))Lg(e.value[j],ae,j,M);return M.filter(j=>!bi(j.oldVal,j.newVal)).map(j=>{const ae=ie(j.path);return{...j,label:(ae==null?void 0:ae.label)||Us(j.path.split(".").at(-1)),apply_mode:(ae==null?void 0:ae.apply_mode)||pe(j.path.split(".")[0])}})}),W=ee(()=>N.value.length>0),ne=ee(()=>N.value.length),$=ee(()=>new Set(N.value.map(M=>M.path.split(".")[0])).size),O=ee(()=>!!l.value||r.value!=="all"),E=ee(()=>{const M={...m.value};for(const j of N.value){const ae=ie(j.path),ke=_e(ae,j.newVal);ke&&(M[j.path]=ke)}return M}),z=ee(()=>Object.keys(E.value).length>0),D=ee(()=>e.value?(O.value?P.value:P.value.filter(j=>j.key===o.value)).map(j=>({...j,sections:j.sections.filter(ae=>X(ae))})).filter(j=>j.sections.length):[]),H=ee(()=>{const M=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],j=new Map(M.map(ae=>[ae,[]]));for(const ae of N.value){const ke=j.has(ae.apply_mode)?ae.apply_mode:"restart";j.get(ke).push(ae)}return M.filter(ae=>j.get(ae).length).map(ae=>({key:ae,label:Ps(ae),entries:j.get(ae)}))}),te=ee(()=>N.value.filter(M=>M.apply_mode==="restart").length);function ie(M){var Et;if(_.value.has(M))return _.value.get(M);const j=`${M}.`,ae=w.value.filter(U=>U.path.startsWith(j));if(!ae.length)return null;const ke=ae.some(U=>U.sensitivity!=="public")?"secret_container":"public",Ce=[...new Set(ae.map(U=>U.apply_mode))];return{path:M,label:Us(M.split(".").at(-1)),description:ae[0].description,type:"object",sensitivity:ke,configured:ae.some(U=>U.configured),provenance:((Et=ae.find(U=>U.provenance!=="unset"))==null?void 0:Et.provenance)||"unset",apply_mode:Ce.length===1?Ce[0]:pe(M.split(".")[0]),constraints:{},enum:null}}function Q(M){const j=`${M}.`;return w.value.filter(ae=>ae.path===M||ae.path.startsWith(j))}function he(M){return Q(M).length}function Ne(M){return Us(M)}function q(M){const j=Q(M);if(!j.length)return`${Us(M)} configuration.`;const ae=j.find(Et=>Et.sensitivity==="public"&&Et.description)||j.find(Et=>Et.description),ke=(ae==null?void 0:ae.description)||"";return ke.match(/setting for (.+)\.$/i)?`${Us(M)} settings and runtime behaviour.`:ke}function pe(M){const j=[...new Set(Q(M).map(ae=>ae.apply_mode))];return j.length===1?j[0]:j.includes("restart")?"restart":j.includes("activation_required")?"activation_required":j[0]||"restart"}function de(M){const j=[...new Set(Q(M).map(ae=>Ps(ae.apply_mode)))];return j.length?j.length===1?j[0]:`Mixed apply behaviour: ${j.join(" · ")}`:""}function xe(M){const j=Q(M),ae=j.map(U=>U.owner).filter(U=>U&&U!=="config"&&U!=="secrets");if(!ae.length)return null;const ke=ae.reduce((U,re)=>({...U,[re]:(U[re]||0)+1}),{}),[Ce,Et]=Object.entries(ke).sort((U,re)=>re[1]-U[1])[0];return Et>=Math.max(1,j.length-1)&&Qu[Ce]?Ce:null}function me(M){return Qu[M]||{label:Us(M),href:"#/system?tab=config",description:"This feature uses a dedicated configuration and activation panel."}}function Be(M){var j;return Object.hasOwn(d.value,M)?d.value[M]:(j=e.value)==null?void 0:j[M]}function b(M){const j=Be(M);return(j&&typeof j=="object"&&!Array.isArray(j)?Object.entries(j).map(([ke,Ce])=>({key:ke,path:`${M}.${ke}`,value:Ce})):[{key:null,path:M,value:j}]).map(ke=>{const Ce=ie(ke.path)||{};return{...Ce,...ke,label:Ce.label||(ke.key===null?Ne(M):Us(ke.key)),description:Ce.description||`${Us(ke.key||M)} setting for ${Us(M)}.`,apply_mode:Ce.apply_mode||pe(M),sensitivity:Ce.sensitivity||"public",constraints:Ce.constraints||{},configured:Ce.configured??!0,provenance:Ce.provenance||"config_file"}})}function I(M,j){return[M.label,M.path,M.description,...M.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(j)}function F(M){const j=l.value.trim().toLowerCase();return j?Q(M).filter(ae=>I(ae,j)):[]}function X(M){const j=Q(M);if(r.value!=="all"&&!j.some(ke=>ke.apply_state===r.value))return!1;const ae=l.value.trim().toLowerCase();return!ae||`${Ne(M)} ${M}`.toLowerCase().includes(ae)?!0:j.some(ke=>I(ke,ae))}function Z(M,j){return Q(M).filter(ae=>ae.apply_state===j).length}function J(M){var j,ae,ke;return M==="all"?T.value:((ke=(ae=(j=t.value)==null?void 0:j.status)==null?void 0:ae.counts)==null?void 0:ke[M])??w.value.filter(Ce=>Ce.apply_state===M).length}function ue(M){const j=M.sections.flatMap(ae=>Q(ae));return{fields:j.length,modified:N.value.filter(ae=>M.sections.includes(ae.path.split(".")[0])).length,pending_restart:j.filter(ae=>ae.apply_state==="pending_restart").length,invalid:j.filter(ae=>ae.apply_state==="invalid").length,dormant:j.filter(ae=>ae.apply_state==="dormant").length}}function oe(M){var j;return Object.hasOwn(d.value,M)&&!bi((j=e.value)==null?void 0:j[M],d.value[M])}function le(M){return N.value.some(j=>j.path===M||j.path.startsWith(`${M}.`))}function se(M){o.value=M,l.value="",r.value="all";try{localStorage.setItem(Ig,M)}catch{}}function ye(M){r.value=M}function fe(){l.value="",r.value="all"}function ge(M){return c.value[M]?!0:!!(l.value&&!g.value&&X(M))}function we(M){const j=!ge(M);g.value&&j?c.value={[M]:!0}:c.value={...c.value,[M]:j}}function Te(){y.value.push(Rn(d.value)),y.value.length>o1&&y.value.shift(),S.value=[]}function Re(M){u.value!==M&&(u.value=M,p.value=Object.hasOwn(d.value,M),f.value=p.value?Rn(d.value[M]):void 0,p.value||(d.value={...d.value,[M]:Rn(e.value[M])}),c.value=g.value?{[M]:!0}:{...c.value,[M]:!0})}function De(M){if(!Me(M)){if(bi(d.value[M],e.value[M])){const j={...d.value};delete j[M],d.value=j}u.value=null,f.value=void 0,p.value=!1}}function Fe(M){const j={...d.value};p.value?j[M]=Rn(f.value):delete j[M],d.value=j,u.value=null,f.value=void 0,p.value=!1;const ae=`${M}.`;m.value=Object.fromEntries(Object.entries(m.value).filter(([ke])=>ke!==M&&!ke.startsWith(ae)))}function Ve(){!W.value&&!u.value||(Te(),d.value={},u.value=null,f.value=void 0,p.value=!1,m.value={},R.value=!1)}function st(M,j){const ae=M.path.split(".")[0];if(u.value!==ae)return;Te();const ke=Rn(d.value[ae]);if(M.key===null?d.value={...d.value,[ae]:j}:(ke[M.key]=j,d.value={...d.value,[ae]:ke}),m.value[M.path]){const Ce={...m.value};delete Ce[M.path],m.value=Ce}}function V(M,j){try{const ae=JSON.parse(j),ke={...m.value};delete ke[M.path],m.value=ke,st(M,ae)}catch(ae){m.value={...m.value,[M.path]:`Invalid JSON: ${ae.message}`}}}function _e(M,j){var ke;if(!M)return null;if((ke=M.enum)!=null&&ke.length&&!M.enum.includes(j))return`Choose one of: ${M.enum.join(", ")}`;const ae=M.constraints||{};if((M.type==="integer"||M.type==="number")&&typeof j=="number"){if(ae.minimum!==void 0&&j<ae.minimum)return`Must be at least ${ae.minimum}${M.unit?` ${M.unit}`:""}`;if(ae.maximum!==void 0&&j>ae.maximum)return`Must be at most ${ae.maximum}${M.unit?` ${M.unit}`:""}`}return null}function Ie(M){return E.value[M.path]||null}function Me(M){const j=`${M}.`;return Object.keys(E.value).some(ae=>ae===M||ae.startsWith(j))}function ze(){y.value.length&&(S.value.push(Rn(d.value)),d.value=y.value.pop(),m.value={})}function Ye(){S.value.length&&(y.value.push(Rn(d.value)),d.value=S.value.pop(),m.value={})}function ht(){!W.value||z.value||(u.value&&De(u.value),R.value=!0,v.value=!1)}function ts(){R.value=!1}function Is(){u.value?Fe(u.value):Ve()}function Ps(M){return r1[M]||Us(M||"unknown")}function Fs(M){return`apply-${String(M||"unknown").replaceAll("_","-")}`}function us(M){return`cfgc-field-${M.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function G(M){return`${us(M)}-input`}function Ee(M){const j=document.getElementById(us(M))||document.getElementById(us(M.split(".").slice(0,2).join(".")));j==null||j.scrollIntoView({behavior:"smooth",block:"center"})}function fs(M,j){i.value={type:M,message:j},window.setTimeout(()=>{var ae;((ae=i.value)==null?void 0:ae.message)===j&&(i.value=null)},3500)}async function Zs(){if(!(!W.value||z.value||n.value)){n.value=!0;try{const M=u1(e.value,d.value),j=await Y.put("/api/config",M);e.value=j,t.value=await Xu(j),d.value={},u.value=null,f.value=void 0,p.value=!1,y.value=[],S.value=[],m.value={},R.value=!1,fs("success","Configuration saved. Apply status has been refreshed.")}catch(M){fs("error",M.message||"Configuration could not be saved")}finally{n.value=!1}}}async function ca(){var M;if(!W.value){s.value=!0,a.value=null;try{const j=await Y.get("/api/config"),ae=await Xu(j);e.value=j,t.value=ae;const ke=P.value;ke.some(Ce=>Ce.key===o.value)||(o.value=((M=ke[0])==null?void 0:M.key)||Oa[0].key)}catch(j){a.value=j.message||"Unknown configuration error"}finally{s.value=!1}}}function wn(M){if(R.value||!(M.ctrlKey||M.metaKey))return;const j=M.target;j instanceof HTMLElement&&(j.matches("input, textarea, select")||j.isContentEditable)||(!M.shiftKey&&M.key.toLowerCase()==="z"?(M.preventDefault(),ze()):(M.key.toLowerCase()==="y"||M.shiftKey&&M.key.toLowerCase()==="z")&&(M.preventDefault(),Ye()))}function Js(M){if(g.value=M.matches,M.matches){const j=Object.keys(c.value).find(ae=>c.value[ae]);c.value=j?{[j]:!0}:{}}}return ds(c,M=>{try{localStorage.setItem(Rg,JSON.stringify(M))}catch{}},{deep:!0}),Je(()=>{var M;ca(),document.addEventListener("keydown",wn),x=window.matchMedia("(max-width: 760px)"),Js(x),(M=x.addEventListener)==null||M.call(x,"change",Js)}),_t(()=>{var M;document.removeEventListener("keydown",wn),(M=x==null?void 0:x.removeEventListener)==null||M.call(x,"change",Js)}),{config:e,meta:t,loading:s,saving:n,error:a,toast:i,searchQuery:l,healthFilter:r,activeCategory:o,editingSection:u,reviewOpen:R,mobileOverflowOpen:v,healthFilters:C,visibleCategories:P,displayGroups:D,reviewGroups:H,sectionCount:A,fieldCount:T,hasChanges:W,changeCount:ne,changedSectionCount:$,hasDraftErrors:z,canUndo:L,canRedo:B,globalFilterActive:O,reviewRestartCount:te,healthCount:J,categoryStats:ue,selectCategory:se,selectHealthFilter:ye,clearFilters:fe,sectionLabel:Ne,sectionDescription:q,sectionFieldCount:he,sectionHealthCount:Z,sectionApplySummary:de,sectionOwner:xe,ownerInfo:me,sectionEntries:b,sectionSearchHits:F,sectionChanged:oe,fieldChanged:le,isSectionExpanded:ge,toggleSection:we,startSectionDraft:Re,finishSectionDraft:De,cancelSectionDraft:Fe,discardAllDrafts:Ve,setFieldValue:st,setJsonFieldValue:V,fieldError:Ie,sectionHasErrors:Me,undo:ze,redo:Ye,openReview:ht,closeReview:ts,mobileCancel:Is,applyModeLabel:Ps,applyClass:Fs,compactValue:c1,formatValue:d1,fieldId:us,fieldInputId:G,focusField:Ee,fetchConfig:ca,saveConfig:Zs}}},g1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),d=h([]),u=h(null),f=ee(()=>{const D={};for(const H of d.value)D[H.id]=H;return D});function p(D){return f.value[D]||null}const m=ee(()=>/^\d{15,25}$/.test(r.value.trim())),y=ee(()=>{if(o.value){if(S.value[c.value])return"host-user-option-"+c.value;if(m.value)return"host-user-option-raw"}}),S=ee(()=>{const D=r.value.toLowerCase().trim();return D?d.value.filter(H=>!i.value[H.id]&&(H.display_name.toLowerCase().includes(D)||H.username.toLowerCase().includes(D)||H.id.includes(D))):d.value.filter(H=>!i.value[H.id])});function R(D,H){return D?D.allowed_hosts===null||D.allowed_hosts===void 0?{allowed_hosts:[...H],default_host:D.default_host||"",allow_all:!0}:{allowed_hosts:D.allowed_hosts,default_host:D.default_host||"",allow_all:!1}:{allowed_hosts:[...H],default_host:H[0]||"",allow_all:!0}}const v=m1({applyDefault:async D=>{const H=D.allow_all?null:D.allowed_hosts;await Y.put("/api/host-access/default-policy",{allowed_hosts:H,default_host:D.default_host})},applyUser:async(D,H)=>{const te=H.allow_all?null:H.allowed_hosts;await Y.put(`/api/host-access/user/${D}`,{allowed_hosts:te,default_host:H.default_host})},applyDelete:D=>Y.del(`/api/host-access/user/${D}`),onDefaultConfirmed:()=>Se.success("Default policy updated"),onDefaultRollback:D=>{D&&(a.value=D)},onUserConfirmed:D=>{const H=p(D);Se.success(`Updated access for ${H?H.display_name:D}`)},onUserRollback:(D,H)=>{const te={...i.value};H?te[D]=H:delete te[D],i.value=te},onUserDeleted:D=>{const H={...i.value};delete H[D],i.value=H},onError:(D,H)=>{var ie;const te=H.uid?` ${((ie=p(H.uid))==null?void 0:ie.display_name)||H.uid}`:"";Se.error(`${D.message||"Failed to save"} — reverted${te}`)}});let g=0;async function x(){const D=++g;e.value=!0,t.value="";try{const H=await v.readSnapshot(()=>Y.get("/api/host-access"));if(D!==g)return;s.value=H,n.value=H.available_hosts||[],a.value=R(H.default_policy,n.value);const te=H.users||{},ie={};for(const[Q,he]of Object.entries(te))ie[Q]=R(he,n.value);i.value=ie,v.seed(a.value,ie)}catch(H){D===g&&(t.value=H.message||"Failed to fetch host access data")}finally{D===g&&(e.value=!1)}try{const H=await Y.get("/api/discord/members")||[];D===g&&(d.value=H)}catch{D===g&&(d.value=[])}}function w(){v.saveDefault(a.value)}function _(D,H){a.value.allow_all=!1,H?a.value.allowed_hosts.includes(D)||a.value.allowed_hosts.push(D):(a.value.allowed_hosts=a.value.allowed_hosts.filter(te=>te!==D),a.value.default_host===D&&(a.value.default_host=a.value.allowed_hosts[0]||"")),w()}function A(D){const H=i.value[D];H&&v.saveUser(D,H)}function T(D,H,te){const ie=i.value[D];ie&&(ie.allow_all=!1,te?ie.allowed_hosts.includes(H)||ie.allowed_hosts.push(H):(ie.allowed_hosts=ie.allowed_hosts.filter(Q=>Q!==H),ie.default_host===H&&(ie.default_host=ie.allowed_hosts[0]||"")),A(D))}function C(D,H){const te=i.value[D];te&&(te.default_host=H,A(D))}function L(){l.value=!0,r.value="",c.value=0,Ot(()=>{u.value&&u.value.focus()})}function B(){o.value=!0,c.value=0}function P(){c.value<S.value.length-1&&c.value++}function N(){c.value>0&&c.value--}function W(){const D=S.value[c.value];if(D){$(D);return}m.value&&ne()}function ne(){const D=r.value.trim();/^\d{15,25}$/.test(D)&&(i.value[D]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},A(D),r.value="",o.value=!1,l.value=!1)}function $(D){i.value[D.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},A(D.id),r.value="",o.value=!1,l.value=!1}function O(){o.value=!1}function E(){setTimeout(()=>{o.value=!1},150)}async function z(D){const H=p(D);await bs({title:"Remove user override",message:`Remove the host access override for ${H?H.display_name:D}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0})&&(await v.deleteUser(D),i.value[D]||Se.success(`Removed override for ${H?H.display_name:D}`))}return Je(x),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:d,filteredMembers:S,isRawId:m,activeOptionId:y,searchInput:u,fetchData:x,saveDefaultPolicy:w,toggleDefaultHost:_,getMember:p,toggleUserHost:T,setUserDefault:C,openAddUser:L,deleteUser:z,onSearchInput:B,highlightNext:P,highlightPrev:N,selectHighlighted:W,selectMember:$,closeDropdown:O,onBlur:E,addRawId:ne}}},b1={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=ee(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=ee(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function p(T){return T==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":T==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const T=await Y.get("/api/tokens");s.value=T.tokens||[],n.value=T.available_hosts||[]}catch(T){t.value=T.message||"Failed to load tokens"}finally{e.value=!1}}function y(T){return!T||!T.trim()?[]:T.split(",").map(C=>C.trim()).filter(Boolean)}function S(T,C){const L=c.value.allowed_hosts;if(C&&!L.includes(T)&&L.push(T),!C){const B=L.indexOf(T);B>=0&&L.splice(B,1)}}function R(T,C){const L=d.value.allowed_hosts;if(C&&!L.includes(T)&&L.push(T),!C){const B=L.indexOf(T);B>=0&&L.splice(B,1)}}async function v(){var T;i.value=!0;try{const C=y(c.value.allowed_tools_str),L=c.value.host_mode,B=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:C.length?C:[]};B!==null&&(P.allowed_hosts=B),P.default_host=c.value.default_host||"";const N=await Y.post("/api/tokens",P);l.value=N.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Se.success("Token created"),await m()}catch(C){Se.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to create token")}finally{i.value=!1}}function g(T){r.value=T;const C=T.allowed_hosts;let L="default";C==null?L="default":Array.isArray(C)&&C.length===0?L="none":Array.isArray(C)&&(L="select"),d.value={username:T.username||"",tier:T.tier||"admin",label:T.label||"",host_mode:L,allowed_hosts:Array.isArray(C)?[...C]:[],default_host:T.default_host||"",allowed_tools_str:(T.allowed_tools||[]).join(", ")}}async function x(){var T;if(r.value){o.value=!0;try{const C=y(d.value.allowed_tools_str),L=d.value.host_mode,B={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:C};L==="none"?B.allowed_hosts=[]:L==="select"?B.allowed_hosts=d.value.allowed_hosts:B.allowed_hosts=null,B.default_host=d.value.default_host||"",await Y.put("/api/tokens/"+encodeURIComponent(r.value.user_id),B),r.value=null,Se.success("Token updated"),await m()}catch(C){Se.error(((T=C.data)==null?void 0:T.error)||C.message||"Failed to update")}finally{o.value=!1}}}async function w(T){var L;if(await bs({title:"Regenerate token",message:`Regenerate token for ${T.username||T.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const B=await Y.post("/api/tokens/"+encodeURIComponent(T.user_id)+"/regenerate");l.value=B.token,Se.success("Token regenerated")}catch(B){Se.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to regenerate")}}async function _(T){var L;if(await bs({title:"Delete token",message:`Delete token for ${T.username||T.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/tokens/"+encodeURIComponent(T.user_id)),Se.success("Token deleted"),await m()}catch(B){Se.error(((L=B.data)==null?void 0:L.error)||B.message||"Failed to delete")}}async function A(){if(l.value)try{await navigator.clipboard.writeText(l.value),Se.success("Copied to clipboard")}catch{Se.error("Copy failed — select and copy manually")}}return Je(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:S,toggleEditHost:R,createToken:v,startEdit:g,saveEdit:x,confirmRegenerate:w,confirmDelete:_,copyToken:A}}};function ul(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const y1={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=ee(()=>{const G=n.value.model;return G&&!a.includes(G)?[G,...a]:a}),l=ee(()=>{const G=n.value.agent_model;return G&&G!=="auto"&&!a.includes(G)?[G,...a]:a}),r=["gpt-5.5","gpt-5.4","gpt-5.4-mini"],o=ee(()=>!r.includes(n.value.model)&&!(r.includes(n.value.agent_model)&&n.value.agent_reasoning_effort==="")),c=ee(()=>{const G=n.value.agent_model;return G==="auto"?!0:!r.includes(G||n.value.model)}),d=ee(()=>{const G=n.value.agent_reasoning_effort;return G==="auto"?!1:(G||n.value.reasoning_effort)==="max"}),u=G=>r.includes(G)&&(n.value.reasoning_effort==="max"||n.value.agent_model===""&&d.value),f=G=>r.includes(G)&&d.value,p=h({enabled:!1,model:"gpt-5.6-luna"}),m=h({unavailable_reason:null}),y=ee(()=>{const G=p.value.model;return G&&!a.includes(G)?[G,...a]:a});function S(G){const Ee=G.target.value;p.value.enabled=Ee!=="",Ee!==""&&(p.value.model=Ee),Ve()}const R=h(!1),v=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),g=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),x=h(!1),w=h(!1),_=h(!1),A=h(!1),T=h(!1),C=h(!1),L=h(!1),B=h({configured:!1}),P=h([]),N=h(""),W=h(!1),ne=h(!1),$=h({configured:!1}),O=h([]),E=h(""),z=h(!1),D=h(!1),H=h(!0),te=h(""),ie=h({configured:!1,accounts:[]}),Q=h(null),he=h(null),Ne=h(""),q=h(null),pe=h(!1),de=h(null),xe=h(null),me=h("");let Be=null;function b(G,Ee="success"){Se(G,Ee==="error"?"error":"success")}function I(G){if(!G)return"?";const Ee=G/(1024*1024*1024);return Ee>=1?Ee.toFixed(1)+" GB":(G/(1024*1024)).toFixed(0)+" MB"}async function F(){e.value=!0,await Promise.all([X(),Z(),ye(),J()]),e.value=!1}async function X(){try{const G=await Y.get("/api/llm/status");t.value=G,s.value=G.active_provider||"codex",G.codex&&!Fe.pending()&&(n.value.enabled=G.codex.enabled,n.value.model=G.codex.model||"gpt-5.5",n.value.reasoning_effort=G.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=G.codex.agent_reasoning_effort||"",n.value.agent_model=G.codex.agent_model||"",n.value.max_tokens=G.codex.max_tokens||4096),G.ollama&&!st.pending()&&(v.value.enabled=G.ollama.enabled,v.value.base_url=G.ollama.base_url||"",v.value.model=G.ollama.model||"",v.value.max_tokens=G.ollama.max_tokens||4096),G.kimi&&!V.pending()&&(g.value.enabled=G.kimi.enabled,g.value.model=G.kimi.model||"",g.value.max_tokens=G.kimi.max_tokens||4096),G.auxiliary&&(m.value=G.auxiliary,Ve.pending()||(p.value.enabled=G.auxiliary.enabled,p.value.model=G.auxiliary.model||"gpt-5.6-luna"))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function Z(){try{if(B.value=await Y.get("/api/ollama/status"),B.value.model&&(N.value=B.value.model),B.value.configured)try{const G=await Y.get("/api/ollama/models");P.value=G.models||[]}catch{P.value=[]}else if(v.value.base_url)try{const G=await Y.post("/api/ollama/probe-models",{base_url:v.value.base_url});P.value=G.models||[]}catch{P.value=[]}}catch{B.value={configured:!1}}}async function J(){H.value=!0,te.value="";try{ie.value=await Y.get("/api/codex/status")}catch(G){te.value=G.message||"Failed to fetch Codex status"}finally{H.value=!1}}async function ue(){const G=t.value?t.value.active_provider:"codex";L.value=!0;try{const Ee=await Y.post("/api/llm/switch",{provider:s.value});Ee.error?(s.value=G,b(Ee.error,"error")):(b("Switched to "+s.value+" ("+Ee.model+")"),await F())}catch(Ee){s.value=G,b(Ee.message||"Switch failed","error")}finally{L.value=!1}}async function oe(){W.value=!0;try{const G=await Y.post("/api/ollama/reload");b(G.configured?"Ollama reloaded":G.reason||"Ollama not configured",G.configured?"success":"error"),await F()}catch(G){b(G.message||"Reload failed","error")}finally{W.value=!1}}async function le(){ne.value=!0;try{await Y.post("/api/ollama/model",{model:N.value}),b("Model set to "+N.value),await F()}catch(G){b(G.message||"Failed","error")}finally{ne.value=!1}}async function se(){const G=v.value.base_url;if(!G){b("Enter a base URL first","error");return}C.value=!0;try{const Ee=await Y.post("/api/ollama/probe-models",{base_url:G});P.value=Ee.models||[],P.value.length?(b(P.value.length+" model(s) found"),!v.value.model&&P.value.length&&(v.value.model=P.value[0].name)):b("No models found at "+G,"error")}catch(Ee){b(Ee.message||"Could not reach Ollama","error")}finally{C.value=!1}}async function ye(){try{if($.value=await Y.get("/api/kimi/status"),$.value.model&&(E.value=$.value.model),$.value.configured)try{const G=await Y.get("/api/kimi/models");O.value=G.models||[]}catch{O.value=[]}}catch{$.value={configured:!1}}}async function fe(){z.value=!0;try{const G=await Y.post("/api/kimi/reload");b(G.configured?"Kimi reloaded":G.reason||"Kimi not configured",G.configured?"success":"error"),await F()}catch(G){b(G.message||"Reload failed","error")}finally{z.value=!1}}async function ge(){D.value=!0;try{await Y.post("/api/kimi/model",{model:E.value}),b("Model set to "+E.value),await F()}catch(G){b(G.message||"Failed","error")}finally{D.value=!1}}async function we(){if(_.value){Fe();return}_.value=!0;try{await Y.put("/api/llm/codex/config",n.value),b("Codex config saved"),await Promise.all([X(),J()])}catch(G){b(G.message||"Failed","error"),await Promise.all([X(),J()])}finally{_.value=!1}}async function Te(){if(A.value){st();return}A.value=!0;try{const G={...v.value},Ee=x.value?v.value.api_key:null;Ee===null&&delete G.api_key,await Y.put("/api/llm/ollama/config",G),b("Ollama config saved"),Ee!==null&&v.value.api_key===Ee&&(v.value.api_key="",x.value=!1),await Promise.all([X(),Z()])}catch(G){b(G.message||"Failed","error")}finally{A.value=!1}}async function Re(){if(T.value){V();return}T.value=!0;try{const G={...g.value},Ee=w.value?g.value.api_key:null;Ee===null&&delete G.api_key,await Y.put("/api/llm/kimi/config",G),b("Kimi config saved"),Ee!==null&&g.value.api_key===Ee&&(g.value.api_key="",w.value=!1),await Promise.all([X(),ye()])}catch(G){b(G.message||"Failed","error")}finally{T.value=!1}}async function De(){if(R.value){Ve();return}R.value=!0;try{await Y.put("/api/llm/auxiliary/config",p.value),b("Auxiliary config saved"),await X()}catch(G){b(G.message||"Failed","error"),await X()}finally{R.value=!1}}const Fe=ul(we),Ve=ul(De),st=ul(Te),V=ul(Re),_e=()=>(Fe.cancel(),we()),Ie=()=>(st.cancel(),Te()),Me=()=>(V.cancel(),Re());async function ze(G){try{await Y.post("/api/codex/account/"+G+"/activate"),b("Active account switched"),await J()}catch(Ee){b(Ee.message||"Failed","error")}}async function Ye(G){Q.value=G;try{await Y.post("/api/codex/account/"+G+"/refresh"),b("Token refreshed"),await J()}catch(Ee){b(Ee.message||"Refresh failed","error")}finally{Q.value=null}}function ht(G,Ee){he.value=G,Ne.value=Ee||""}async function ts(G){try{await Y.put("/api/codex/account/"+G+"/label",{label:Ne.value}),b("Label updated"),he.value=null,await J()}catch(Ee){b(Ee.message||"Failed","error")}}async function Is(G,Ee){if(await bs({title:"Delete Codex account",message:`Delete ${Ee||"account #"+(G+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await Y.del("/api/codex/account/"+G),b("Deleted. Pool reloaded."),await J()}catch(Zs){b(Zs.message||"Failed","error")}}async function Ps(){pe.value=!0;try{const G=await Y.post("/api/codex/device-code");de.value=G,q.value="pending",Fs(G)}catch(G){b(G.message||"Failed","error")}finally{pe.value=!1}}async function Fs(G){Be={cancelled:!1};const Ee=Be;try{const fs=await Y.post("/api/codex/device-poll",{device_auth_id:G.device_auth_id,user_code:G.user_code,interval:G.interval});if(Ee.cancelled)return;xe.value=fs,q.value="success",await F()}catch(fs){if(Ee.cancelled)return;me.value=fs.message||"Device login failed",q.value="error"}}function us(){Be&&(Be.cancelled=!0),q.value=null,de.value=null}return Je(F),_t(()=>{Be&&(Be.cancelled=!0),Fe.cancel(),Ve.cancel(),st.cancel(),V.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:L,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,mainMaxAllowed:o,agentMaxAllowed:c,mainModelOptionDisabled:u,agentModelOptionDisabled:f,auxForm:p,auxData:m,auxModelOptions:y,onAuxModelChange:S,savingAux:R,saveAuxConfigDebounced:Ve,ollamaForm:v,kimiForm:g,savingCodex:_,savingOllama:A,savingKimi:T,probingOllama:C,ollamaKeyDirty:x,kimiKeyDirty:w,ollamaStatus:B,ollamaModels:P,ollamaSelectedModel:N,reloading:W,settingModel:ne,kimiStatus:$,kimiModels:O,kimiSelectedModel:E,reloadingKimi:z,settingKimiModel:D,codexLoading:H,codexError:te,codexData:ie,refreshing:Q,editingLabel:he,labelValue:Ne,deviceState:q,deviceLoading:pe,deviceInfo:de,deviceResult:xe,deviceError:me,fetchAll:F,switchProvider:ue,reloadOllama:oe,setOllamaModel:le,reloadKimi:fe,setKimiModel:ge,probeOllamaModels:se,saveCodexConfig:we,saveOllamaConfig:Te,saveKimiConfig:Re,saveCodexConfigDebounced:Fe,saveOllamaConfigDebounced:st,saveKimiConfigDebounced:V,saveCodexConfigNow:_e,saveOllamaConfigNow:Ie,saveKimiConfigNow:Me,activateAccount:ze,refreshAccount:Ye,startEditLabel:ht,saveLabel:ts,deleteAccount:Is,startDeviceLogin:Ps,cancelDeviceLogin:us,formatSize:I}}},ef={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function x1(e){return ef[e]||ef[(e||"").toLowerCase()]||"text-gray-400"}const _1={template:`
  ...
  `},k1={components:{TabbedPage:kr},setup(){return{tabs:[{id:"health",label:"Health",component:zk},{id:"resources",label:"Resources",component:qk},{id:"logs",label:"Logs",component:Zk},{id:"config",label:"Config",component:h1},{id:"discord",label:"Discord",component:g1},{id:"host-access",label:"Host Access",component:v1},{id:"api-tokens",label:"API Tokens",component:b1},{id:"llm",label:"LLM Config",component:y1},{id:"internals",label:"Internals",component:_1},{id:"update",label:"Update",component:w1}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},wt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),Ng=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:J_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:hk,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:kk,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:Ik,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:Uk,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:Bk,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:k1,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:wt("/operations","live")},{path:"/agents",redirect:wt("/operations","agents")},{path:"/loops",redirect:wt("/operations","loops")},{path:"/processes",redirect:wt("/operations","processes")},{path:"/schedules",redirect:wt("/operations","schedules")},{path:"/audit",redirect:wt("/history","audit")},{path:"/sessions",redirect:wt("/history","sessions")},{path:"/traces",redirect:wt("/history","traces")},{path:"/usage",redirect:wt("/history","usage")},{path:"/tools",redirect:wt("/capabilities","tools")},{path:"/skills",redirect:wt("/capabilities","skills")},{path:"/knowledge",redirect:wt("/capabilities","knowledge")},{path:"/memory",redirect:wt("/capabilities","memory")},{path:"/learned",redirect:wt("/capabilities","learned")},{path:"/health",redirect:wt("/system","health")},{path:"/resources",redirect:wt("/system","resources")},{path:"/logs",redirect:wt("/system","logs")},{path:"/config",redirect:wt("/system","config")},{path:"/host-access",redirect:wt("/system","host-access")},{path:"/internals",redirect:wt("/system","internals")}],yi=V_({history:x_(),routes:Ng});yi.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const S1={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),d=h("disconnected"),u=h(-1),f=h(null);let p=null;const m=h("starting"),y=h(""),S=Ng.filter(O=>O.meta),R=ee(()=>["Workspace","Operate","Observe","Manage"].map(O=>({name:O,routes:S.filter(E=>E.meta.section===O)})).filter(O=>O.routes.length)),v=ee(()=>{var O;return((O=yi.currentRoute.value.meta)==null?void 0:O.label)||"Odin"}),g=ee(()=>{var O;return((O=yi.currentRoute.value.meta)==null?void 0:O.section)||"Management"}),x=ee(()=>{var O;return((O=yi.currentRoute.value.meta)==null?void 0:O.description)||"Management console"});Y.onSessionExpired=()=>{t.value=!0,We.disconnect(),Y.setToken(""),e.value="login"};function w(O){var E;if((O.ctrlKey||O.metaKey)&&O.key.toLowerCase()==="k"){e.value==="ready"&&(O.preventDefault(),Tu());return}if(n.value&&O.key==="Tab"){const z=[...((E=a.value)==null?void 0:E.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(z.length){const D=z[0],H=z[z.length-1];if(O.shiftKey&&(document.activeElement===D||!a.value.contains(document.activeElement))){O.preventDefault(),H.focus();return}if(!O.shiftKey&&(document.activeElement===H||!a.value.contains(document.activeElement))){O.preventDefault(),D.focus();return}}}if(O.key==="Escape"&&n.value){n.value=!1,O.preventDefault();return}if(O.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(O.target.tagName)){O.preventDefault();const z=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');z&&z.focus()}}function _(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Je(async()=>{document.addEventListener("keydown",w),r=window.matchMedia("(max-width: 900px)"),_(),r.addEventListener("change",_);const O=await Y.check();O.ok?(e.value="ready",ne()):O.needsAuth?e.value="login":(e.value="ready",ne())});function A(){t.value=!1,e.value="ready",ne()}async function T(){await Y.logout(),We.disconnect(),e.value="login"}function C(){s.value=!s.value}function L(){n.value=!n.value}ds(n,async O=>{var E,z;if(O)o=document.activeElement,await Ot(),(z=(E=a.value)==null?void 0:E.querySelector(".nav-item"))==null||z.focus();else if(o!=null&&o.isConnected){const D=o;o=null,requestAnimationFrame(()=>D.focus())}});const B=ee(()=>{switch(d.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(O,E="info",z=3e3){f.value={text:O,level:E},clearTimeout(p),p=setTimeout(()=>{f.value=null},z)}let N=null,W=!1;function ne(){We.onStatusChange=O=>{c.value=O},We.onLatency=O=>{u.value=O},We.onStateChange=(O,E)=>{d.value=O,O==="connected"?(W&&P("Connection restored","success"),W=!0):O==="reconnecting"&&E.attempt===1&&P("Connection lost — reconnecting…","warn")},We.connect(),$(),N&&clearInterval(N),N=setInterval($,15e3)}async function $(){try{const O=await Y.get("/api/status");m.value=O.status==="online"?"online":"starting";const E=O.uptime_seconds||0,z=Math.floor(E/3600),D=Math.floor(E%3600/60);y.value=`${z}h ${D}m uptime`}catch{m.value="offline",y.value=""}}return _t(()=>{N&&clearInterval(N),We.disconnect(),document.removeEventListener("keydown",w),r==null||r.removeEventListener("change",_)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:d,wsLatency:u,wsLabel:B,wsToast:f,botStatus:m,botUptime:y,navRoutes:S,navGroups:R,currentPage:v,currentSection:g,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:A,logout:T,toggleSidebar:C,toggleMobileNavigation:L,openPalette:Tu}}},$n=Pl(T1);$n.component("odin-icon",K_);$n.component("login-screen",S1);$n.component("toast-container",D0);$n.component("confirm-host",M0);$n.component("command-palette",G_);$n.directive("modal-focus",Z_);$n.use(yi);$n.mount("#app");
