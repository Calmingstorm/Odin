...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}He(()=>{We.on("events",a),i=setInterval(l,500)}),gt(()=>{We.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=null;const r=J(()=>e.value.filter(k=>k.status==="running").length),o=J(()=>e.value.filter(k=>k.status==="completed").length),c=J(()=>e.value.filter(k=>["failed","timeout","killed"].includes(k.status)).length),u=J(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),d=J(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(k=>["failed","timeout","killed"].includes(k.status)):e.value.filter(k=>k.status===i.value));function f(k){const w=Number(k.max_iterations)||0;return w<=0?0:Math.min(100,Math.round(k.iteration_count/w*100))}function p(k){return(Number(k.max_iterations)||0)>0}function b(k,w){return k?k==="N/A"?"N/A":w==="current_inheritance"?`inherit (currently ${k})`:k:"unknown"}function g(k){return b(k.display_model,k.display_model_source||k.display_source)}function E(k){return b(k.display_reasoning_effort,k.display_reasoning_effort_source||k.display_source)}function O(k){return{last_execution:"last executed",current_inheritance:"inherited from current config — not yet executed",spawn_override_pending:"requested at spawn — not yet executed",unknown:"no execution data"}[k]||""}const y=h(null),v=h(null),x=h(!1),C=h(null),N=h("");let L=null;async function T(k,{initial:w}){const V={};L=V,w&&(y.value=null,C.value=null,x.value=!0);let le=null,ue=null;try{le=await G.get(`/api/agents/${encodeURIComponent(k)}`)}catch(te){ue=te}L===V&&(L=null,ue?y.value===null&&(C.value=ue.message||"Failed to load agent detail"):(y.value=le,C.value=null),x.value=!1)}async function R(k){v.value=k.id,N.value="",await T(k.id,{initial:!0})}function D(){L=null,v.value=null,y.value=null,C.value=null,x.value=!1,N.value=""}async function U(){v.value&&await T(v.value,{initial:!1})}async function P(k,w){try{await navigator.clipboard.writeText(w||""),N.value=k,setTimeout(()=>{N.value===k&&(N.value="")},1500)}catch{_e.error("Copy failed")}}async function S(k=!1){k=k===!0,k||(t.value=!0);try{const w=await G.get("/api/agents");e.value=Array.isArray(w)?w:[],s.value=null}catch(w){k||(s.value=w.message)}k||(t.value=!1)}async function $(k){const w=e.value.find(le=>le.id===k);if(await rs({title:"Kill agent",message:`Kill agent "${(w==null?void 0:w.label)||k}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=k;try{await G.del(`/api/agents/${encodeURIComponent(k)}`),_e.success("Agent killed"),await S()}catch(le){_e.error(le.message||"Failed to kill agent")}n.value=null}}function W(){K(),a.value&&(l=setInterval(()=>{a.value&&(S(!0),v.value&&U())},5e3))}function K(){l&&(clearInterval(l),l=null)}return He(()=>{S(),W()}),er(()=>{S(!0),W()}),tr(K),gt(K),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:u,filteredAgents:d,formatTs:Fa,formatDuration:Oa,progressPercent:f,hasProgress:p,displayModelText:g,displayEffortText:E,displaySourceLabel:O,detail:y,detailId:v,detailLoading:x,detailError:C,copied:N,openDetail:R,closeDetail:D,copyText:P,fetchAgents:S,killAgent:$,startAutoRefresh:W,stopAutoRefresh:K}}},nw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),b=h(null),g=h([]),E=h(!1),O=J(()=>e.value.filter(k=>k.cron&&!k.one_time).length),y=J(()=>e.value.filter(k=>k.one_time).length),v=J(()=>e.value.filter(k=>k.trigger).length),x=J(()=>e.value.filter(k=>k.paused).length),C=J(()=>e.value.filter(k=>k.consecutive_failures>0).length);function N(k){if(!k)return"-";const w=Date.now(),le=(new Date(k).getTime()-w)/1e3;if(le<0)return"overdue";if(le<60)return"in < 1 min";if(le<3600)return`in ${Math.floor(le/60)} min`;if(le<86400){const te=Math.floor(le/3600),fe=Math.floor(le%3600/60);return fe>0?`in ${te}h ${fe}m`:`in ${te}h`}const ue=Math.floor(le/86400);return`in ${ue} day${ue!==1?"s":""}`}function L(k){return k==null?"-":k<1e3?`${k}ms`:k<6e4?`${(k/1e3).toFixed(1)}s`:Oa(k/1e3)}function T(){r.value=null}async function R(){const k=a.value.cron.trim();if(k){o.value=!0;try{r.value=await G.post("/api/schedules/validate-cron",{expression:k})}catch(w){r.value={valid:!1,error:w.message}}o.value=!1}}async function D(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(k){s.value=k.message}t.value=!1}async function U(k){if(b.value===k){b.value=null,g.value=[];return}b.value=k,E.value=!0,g.value=[];try{g.value=await G.get(`/api/schedules/${encodeURIComponent(k)}/history?limit=10`)}catch{g.value=[]}E.value=!1}async function P(){l.value=null;const k=a.value;if(!k.description.trim()){l.value="Description is required";return}if(!k.channel_id.trim()){l.value="Channel ID is required";return}if(!k.cron.trim()&&!k.run_at.trim()){l.value="Cron expression or run_at time is required";return}const w={description:k.description.trim(),action:k.action,channel_id:k.channel_id.trim()};if(k.cron.trim()&&(w.cron=k.cron.trim()),k.run_at.trim()&&(w.run_at=k.run_at.trim()),k.action==="reminder"&&k.message.trim()&&(w.message=k.message.trim()),k.action==="check"&&(k.tool_name.trim()&&(w.tool_name=k.tool_name.trim()),k.tool_input_str.trim()))try{w.tool_input=JSON.parse(k.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",w),_e.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await D()}catch(V){l.value=V.message}i.value=!1}async function S(k){u.value=k;try{const w=await G.post(`/api/schedules/${encodeURIComponent(k)}/run`);if(w.status==="failure")_e.error(`Execution failed: ${w.error||"unknown error"}`);else{const V=w.warning?`Executed (${w.warning})`:"Executed successfully";_e.success(V)}await D()}catch(w){_e.error(w.message||"Failed to trigger")}u.value=null}async function $(k){f.value=k.id;const w=!k.paused;try{await G.put(`/api/schedules/${encodeURIComponent(k.id)}`,{paused:w}),_e.success(w?"Schedule paused":"Schedule resumed"),await D()}catch(V){_e.error(V.message||"Failed to update schedule")}f.value=null}async function W(k){p.value=k;try{await G.post(`/api/schedules/${encodeURIComponent(k)}/reset-failures`),_e.success("Failure counters reset"),await D()}catch(w){_e.error(w.message||"Failed to reset")}p.value=null}async function K(k){const w=e.value.find(le=>le.id===k);if(await rs({title:"Delete schedule",message:`Delete "${(w==null?void 0:w.description)||k}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=k;try{await G.del(`/api/schedules/${encodeURIComponent(k)}`),_e.success("Schedule deleted"),await D()}catch(le){_e.error(le.message||"Failed to delete schedule")}d.value=null}}return He(()=>{D()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:b,history:g,historyLoading:E,cronCount:O,oneTimeCount:y,webhookCount:v,pausedCount:x,failingCount:C,formatTs:Fa,formatAge:eg,formatFuture:N,formatMs:L,formatDuration:Oa,onCronInput:T,validateCron:R,toggleExpand:U,fetchSchedules:D,doCreate:P,doRunNow:S,doTogglePause:$,doResetFailures:W,doDelete:K}}},lw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
`).length:0}function U(Q){return mw(Q)}function P(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function S(Q){try{await navigator.clipboard.writeText(Q);const de=e.value.find(Ie=>Ie.code===Q);de&&(r.value=de.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function $(Q){if(Q.key==="Tab"){Q.preventDefault();const de=Q.target,Ie=de.selectionStart,j=de.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(j),St(()=>{de.selectionStart=de.selectionEnd=Ie+4})}}function W(Q){const de=Q.target.previousElementSibling;de&&(de.scrollTop=Q.target.scrollTop)}async function K(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function k(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const de=await G.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:de}}catch(de){a.value={...a.value,[Q]:{result:de.message,is_error:!0}}}i.value=null}function w(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function V(Q){o.value=!0,c.value="edit",u.value=Q.name,d.value=Q.code||"",f.value=null,p.value=null}function le(){o.value=!1,f.value=null,p.value=null}async function ue(){f.value=null,p.value=null;const Q=u.value.trim(),de=d.value.trim();if(!Q){f.value="Name is required";return}if(!de){f.value="Code is required";return}b.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:Q,code:de}),p.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(Q)}`,{code:de}),p.value="Skill updated successfully"),await K(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}b.value=!1}function te(Q){E.value=Q}async function fe(){if(E.value){O.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(E.value)}`),await K()}catch{}O.value=!1,E.value=null}}return He(()=>{K()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:b,editorRef:g,deleteTarget:E,deleting:O,enabledCount:y,totalExecutions:v,totalLines:x,displayedSkills:C,editLineCount:N,editorLineNums:L,editValidation:T,highlight:R,truncate:Lc,formatTs:Fa,countLines:D,getLineNumbers:U,toggleCode:P,copyCode:S,handleEditorKey:$,syncScroll:W,fetchSkills:K,testSkill:k,showCreate:w,editSkill:V,cancelEdit:le,saveSkill:ue,confirmDelete:te,doDelete:fe}}};function bw(e,t){if(!e||!t)return Sd(e);const s=Sd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),b=h(null),g=h(null);let E=null;const O=h(null),y=h(!1),v=h({}),x=h({}),C=h(null),N=h(null),L=J(()=>e.value.reduce((w,V)=>w+(V.chunks||0),0)),T=J(()=>new Set(e.value.map(V=>V.uploader).filter(Boolean)).size);function R(w,V){const le=x.value[V];if(!le||le.length===0)return 0;const ue=Math.max(...le.map(te=>te.char_count||0));return ue===0?0:Math.round(w.char_count/ue*100)}async function D(){t.value=!0,s.value=null;try{const w=await G.get("/api/knowledge");e.value=Array.isArray(w)?w:[]}catch(w){s.value=w.message}t.value=!1}async function U(w){if(v.value[w]){v.value[w]=!1,N.value=null;return}if(v.value[w]=!0,!(x.value[w]||C.value===w)){C.value=w;try{const V=await G.get(`/api/knowledge/${encodeURIComponent(w)}/chunks`);x.value[w]=Array.isArray(V)?V:[]}catch(V){x.value[w]=[],_e.error(`Failed to load chunks: ${V.message}`)}C.value=null}}async function P(){const w=n.value.trim();if(w){i.value=!0,r.value=null,l.value=w;try{const V=await G.get(`/api/knowledge/search?q=${encodeURIComponent(w)}`);a.value=Array.isArray(V)?V:[]}catch(V){a.value=[],r.value=V.message||"Search failed"}i.value=!1}}function S(){a.value=null,n.value="",r.value=null}async function $(){d.value=null,f.value=null;const w=c.value.trim(),V=u.value.trim();if(!w){d.value="Source name is required";return}if(!V){d.value="Content is required";return}p.value=!0;try{const le=await G.post("/api/knowledge",{source:w,content:V});f.value=`Ingested ${le.chunks||0} chunks from "${w}"`,c.value="",u.value="",x.value={},await D(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(le){d.value=le.message}p.value=!1}async function W(w){b.value=w,g.value=null,E&&(clearTimeout(E),E=null);try{const V=await G.post(`/api/knowledge/${encodeURIComponent(w)}/reingest`);g.value={source:w,error:!1,message:`Re-ingested ${V.chunks||0} chunks`},delete x.value[w],await D(),E=setTimeout(()=>{g.value=null,E=null},3e3)}catch(V){g.value={source:w,error:!0,message:V.message}}b.value=null}function K(w){O.value=w}async function k(){if(O.value){y.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(O.value)}`),delete x.value[O.value],await D()}catch{}y.value=!1,O.value=null}}return He(()=>{D()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:b,reingestResult:g,deleteTarget:O,deleting:y,expanded:v,sourceChunks:x,loadingChunks:C,selectedChunk:N,totalChunks:L,uploaderCount:T,truncate:Lc,formatTs:Fa,highlightTerms:bw,chunkBarWidth:R,fetchSources:D,toggleSource:U,doSearch:P,clearSearch:S,doIngest:$,doReingest:W,confirmDelete:K,doDelete:k}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
...
`);const ne=new Blob([H],{type:"text/plain"}),Te=URL.createObjectURL(ne),Xe=document.createElement("a");Xe.href=Te,Xe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Xe.click(),URL.revokeObjectURL(Te)}function F(H,ne){const Te=`${H.ts} ${H.level} ${H.text||H.raw||""}`;navigator.clipboard.writeText(Te).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function Y(H){a.value=a.value===H?"":H,O.value="all"}function ee(H){return H.level==="ERROR"?"log-line-error":H.level==="WARNING"?"log-line-warning":"text-gray-300"}function se(H){return H==="ERROR"?"text-red-500 font-semibold":H==="WARNING"?"text-yellow-500":"text-blue-500"}function X(H){return H==="ERROR"?"log-chip-error":H==="WARNING"?"log-chip-warning":"log-chip-info"}function be(H){O.value=H.id;const ne=H.filters;a.value=ne.level||"",y.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function re(H){O.value=H.id,a.value=H.filters.level||"",y.value=H.filters.timeRange||"",i.value=H.filters.text||""}function ge(){if(!C.value.trim())return;const H={id:"custom-"+Date.now(),name:C.value.trim(),filters:{level:a.value,timeRange:y.value,text:i.value}};v.value=[...v.value,H],T(),x.value=!1,C.value=""}function xe(H){v.value=v.value.filter(ne=>ne.id!==H),T(),O.value===H&&(O.value="all")}const ke=h("all"),Ee=h(""),B=h(""),oe=h(""),ye=h(""),Me=h(""),Ue=h(100),Je=Nw,dt=h(!1),Ye=h(!1),Ke=h(""),Wt=h([]),bs=h(null),Ts=h(null);function Cn(){e.value="search",bs.value||Qn()}async function Qn(){try{bs.value=await G.get("/api/logs/stats")}catch{}}function cn(){const H=Me.value;if(!H){oe.value="",ye.value="";return}const Te={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[H];if(Te){const Xe=new Date(Date.now()-Te*1e3);oe.value=un(Xe),ye.value=""}}function un(H){const ne=Te=>String(Te).padStart(2,"0");return`${H.getFullYear()}-${ne(H.getMonth()+1)}-${ne(H.getDate())}T${ne(H.getHours())}:${ne(H.getMinutes())}`}function z(H){if(!H)return"";const ne=new Date(H);return isNaN(ne.getTime())?"":ne.toISOString()}async function Se(){dt.value=!0,Ke.value="",Ye.value=!0,Ts.value=null;try{const H=new URLSearchParams;ke.value&&ke.value!=="all"&&H.set("level",ke.value),Ee.value&&H.set("tool",Ee.value),B.value&&H.set("q",B.value);const ne=z(oe.value),Te=z(ye.value);ne&&H.set("start",ne),Te&&H.set("end",Te),H.set("limit",String(Ue.value));const Xe=await G.get(`/api/logs/search?${H.toString()}`);Wt.value=Xe.entries||[]}catch(H){Ke.value=H.message||"Search failed",Wt.value=[]}finally{dt.value=!1}}function Cs(){ke.value="all",Ee.value="",B.value="",oe.value="",ye.value="",Me.value="",Ue.value=100,Wt.value=[],Ye.value=!1,Ke.value="",Ts.value=null}function En(H){Ts.value=Ts.value===H?null:H}function br(H){if(!H.timestamp)return"";try{return new Date(H.timestamp).toLocaleString()}catch{return H.timestamp}}function $a(H){return H.type==="web_action"?`${H.status||""} (${H.execution_time_ms||0}ms)`:(H.result_summary||"").slice(0,200)}function Ua(H){return H.error?"log-line-error":"text-gray-300"}function yr(H){try{return JSON.stringify(H,null,2)}catch{return String(H)}}let ys=null,Xn=null,ea=!1;function it(){ea||(ea=!0,We.subscribe("logs",te),r.value=We.connected,o.value=We.state||"disconnected",ys=We.onStateChange,Xn=(H,ne)=>{o.value=H,r.value=H==="connected",ys&&ys(H,ne)},We.onStateChange=Xn)}function Fs(){ea&&(ea=!1,We.unsubscribe("logs",te),We.onStateChange===Xn&&(We.onStateChange=ys),Xn=null,ys=null)}return He(()=>{L(),window.addEventListener("pointerup",m),window.addEventListener("pointercancel",m)}),er(it),tr(Fs),gt(()=>{Fs(),window.removeEventListener("pointerup",m),window.removeEventListener("pointercancel",m)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:le,pauseBuffer:N,showJumpBottom:d,copiedIndex:f,regexError:U,levels:b,logPresets:g,timeRanges:E,timeRange:y,activeLogPreset:O,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:C,hasActiveLogFilters:R,timeRangeLabel:D,timelineBuckets:S,timelineMax:$,timelineSpanLabel:W,timelineLabelSkip:K,togglePause:M,clearLogs:Z,exportLogs:I,logLineClass:ee,levelClass:se,levelChipClass:X,toggleLevel:Y,copyLine:F,jumpToBottom:de,onScroll:j,onUserScrollIntent:ie,onUserScrollKey:me,onAutoScrollToggle:A,onPointerDown:Le,applyLogPreset:be,applyCustomLogPreset:re,saveLogCustomPreset:ge,removeLogCustomPreset:xe,segmentHeight:w,jumpToTimelineBucket:V,searchLevel:ke,searchTool:Ee,searchKeyword:B,searchStart:oe,searchEnd:ye,searchTimePreset:Me,searchLimit:Ue,searchLimits:Je,searching:dt,searchRan:Ye,searchError:Ke,searchResults:Wt,searchStats:bs,expandedSearch:Ts,switchToSearch:Cn,runSearch:Se,clearSearchFilters:Cs,toggleSearchExpand:En,formatSearchTs:br,searchEntryText:$a,searchLogLineClass:Ua,formatJson:yr,applySearchTimePreset:cn}}},Ow=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Wr=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],vg="••••••••",Pw=50;function Fw(e){return Ow.has(e)}function $w(e){return e===vg}function sl(e){return JSON.parse(JSON.stringify(e))}function Vn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Vn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Vn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Gd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Vn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Vn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=J(()=>{const w={};for(const V of u.value)w[V.id]=V;return w});function p(w){return f.value[w]||null}const b=J(()=>/^\d{15,25}$/.test(r.value.trim())),g=J(()=>{if(o.value){if(E.value[c.value])return"host-user-option-"+c.value;if(b.value)return"host-user-option-raw"}}),E=J(()=>{const w=r.value.toLowerCase().trim();return w?u.value.filter(V=>!i.value[V.id]&&(V.display_name.toLowerCase().includes(w)||V.username.toLowerCase().includes(w)||V.id.includes(w))):u.value.filter(V=>!i.value[V.id])});function O(w,V){return w?w.allowed_hosts===null||w.allowed_hosts===void 0?{allowed_hosts:[...V],default_host:w.default_host||"",allow_all:!0}:{allowed_hosts:w.allowed_hosts,default_host:w.default_host||"",allow_all:!1}:{allowed_hosts:[...V],default_host:V[0]||"",allow_all:!0}}async function y(){e.value=!0,t.value="";try{const w=await G.get("/api/host-access");s.value=w,n.value=w.available_hosts||[],a.value=O(w.default_policy,n.value);const V=w.users||{},le={};for(const[ue,te]of Object.entries(V))le[ue]=O(te,n.value);i.value=le}catch(w){t.value=w.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await G.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const w=a.value.allow_all?null:a.value.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:w,default_host:a.value.default_host}),_e.success("Default policy updated")}catch(w){_e.error(w.message||"Failed to save")}}function x(w,V){a.value.allow_all=!1,V?a.value.allowed_hosts.includes(w)||a.value.allowed_hosts.push(w):(a.value.allowed_hosts=a.value.allowed_hosts.filter(le=>le!==w),a.value.default_host===w&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function C(w){const V=i.value[w];if(V)try{const le=V.allow_all?null:V.allowed_hosts;await G.put(`/api/host-access/user/${w}`,{allowed_hosts:le,default_host:V.default_host});const ue=p(w);_e.success(`Updated access for ${ue?ue.display_name:w}`)}catch(le){_e.error(le.message||"Failed to save")}}function N(w,V,le){const ue=i.value[w];ue&&(ue.allow_all=!1,le?ue.allowed_hosts.includes(V)||ue.allowed_hosts.push(V):(ue.allowed_hosts=ue.allowed_hosts.filter(te=>te!==V),ue.default_host===V&&(ue.default_host=ue.allowed_hosts[0]||"")),C(w))}function L(w,V){const le=i.value[w];le&&(le.default_host=V,C(w))}function T(){l.value=!0,r.value="",c.value=0,St(()=>{d.value&&d.value.focus()})}function R(){o.value=!0,c.value=0}function D(){c.value<E.value.length-1&&c.value++}function U(){c.value>0&&c.value--}function P(){const w=E.value[c.value];if(w){$(w);return}b.value&&S()}function S(){const w=r.value.trim();/^\d{15,25}$/.test(w)&&(i.value[w]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(w),r.value="",o.value=!1,l.value=!1)}function $(w){i.value[w.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},C(w.id),r.value="",o.value=!1,l.value=!1}function W(){o.value=!1}function K(){setTimeout(()=>{o.value=!1},150)}async function k(w){const V=p(w);if(await rs({title:"Remove user override",message:`Remove the host access override for ${V?V.display_name:w}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await G.del(`/api/host-access/user/${w}`),delete i.value[w],_e.success(`Removed override for ${V?V.display_name:w}`)}catch(ue){_e.error(ue.message||"Failed to delete")}}return He(y),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:E,isRawId:b,activeOptionId:g,searchInput:d,fetchData:y,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:N,setUserDefault:L,openAddUser:T,deleteUser:k,onSearchInput:R,highlightNext:D,highlightPrev:U,selectHighlighted:P,selectMember:$,closeDropdown:W,onBlur:K,addRawId:S}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `},Zw={components:{TabbedPage:vr},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Lw},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:qw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},mt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),bg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:mt("/operations","live")},{path:"/agents",redirect:mt("/operations","agents")},{path:"/loops",redirect:mt("/operations","loops")},{path:"/processes",redirect:mt("/operations","processes")},{path:"/schedules",redirect:mt("/operations","schedules")},{path:"/audit",redirect:mt("/history","audit")},{path:"/sessions",redirect:mt("/history","sessions")},{path:"/traces",redirect:mt("/history","traces")},{path:"/usage",redirect:mt("/history","usage")},{path:"/tools",redirect:mt("/capabilities","tools")},{path:"/skills",redirect:mt("/capabilities","skills")},{path:"/knowledge",redirect:mt("/capabilities","knowledge")},{path:"/memory",redirect:mt("/capabilities","memory")},{path:"/learned",redirect:mt("/capabilities","learned")},{path:"/health",redirect:mt("/system","health")},{path:"/resources",redirect:mt("/system","resources")},{path:"/logs",redirect:mt("/system","logs")},{path:"/config",redirect:mt("/system","config")},{path:"/host-access",redirect:mt("/system","host-access")},{path:"/internals",redirect:mt("/system","internals")}],ui=E_({history:i_(),routes:bg});ui.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const b=h("starting"),g=h(""),E=bg.filter(k=>k.meta),O=J(()=>["Workspace","Operate","Observe","Manage"].map(k=>({name:k,routes:E.filter(w=>w.meta.section===k)})).filter(k=>k.routes.length)),y=J(()=>{var k;return((k=ui.currentRoute.value.meta)==null?void 0:k.label)||"Odin"}),v=J(()=>{var k;return((k=ui.currentRoute.value.meta)==null?void 0:k.section)||"Management"}),x=J(()=>{var k;return((k=ui.currentRoute.value.meta)==null?void 0:k.description)||"Management console"});G.onSessionExpired=()=>{t.value=!0,We.disconnect(),G.setToken(""),e.value="login"};function C(k){var w;if((k.ctrlKey||k.metaKey)&&k.key.toLowerCase()==="k"){e.value==="ready"&&(k.preventDefault(),kd());return}if(n.value&&k.key==="Tab"){const V=[...((w=a.value)==null?void 0:w.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(V.length){const le=V[0],ue=V[V.length-1];if(k.shiftKey&&(document.activeElement===le||!a.value.contains(document.activeElement))){k.preventDefault(),ue.focus();return}if(!k.shiftKey&&(document.activeElement===ue||!a.value.contains(document.activeElement))){k.preventDefault(),le.focus();return}}}if(k.key==="Escape"&&n.value){n.value=!1,k.preventDefault();return}if(k.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(k.target.tagName)){k.preventDefault();const V=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');V&&V.focus()}}function N(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}He(async()=>{document.addEventListener("keydown",C),r=window.matchMedia("(max-width: 900px)"),N(),r.addEventListener("change",N);const k=await G.check();k.ok?(e.value="ready",W()):k.needsAuth?e.value="login":(e.value="ready",W())});function L(){t.value=!1,e.value="ready",W()}async function T(){await G.logout(),We.disconnect(),e.value="login"}function R(){s.value=!s.value}function D(){n.value=!n.value}gs(n,async k=>{var w,V;if(k)o=document.activeElement,await St(),(V=(w=a.value)==null?void 0:w.querySelector(".nav-item"))==null||V.focus();else if(o!=null&&o.isConnected){const le=o;o=null,requestAnimationFrame(()=>le.focus())}});const U=J(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(k,w="info",V=3e3){f.value={text:k,level:w},clearTimeout(p),p=setTimeout(()=>{f.value=null},V)}let S=null,$=!1;function W(){We.onStatusChange=k=>{c.value=k},We.onStateChange=(k,w)=>{u.value=k,d.value=w.latency??-1,k==="connected"?($&&P("Connection restored","success"),$=!0):k==="reconnecting"&&w.attempt===1&&P("Connection lost — reconnecting…","warn")},We.connect(),K(),S&&clearInterval(S),S=setInterval(K,15e3)}async function K(){try{const k=await G.get("/api/status");b.value=k.status==="online"?"online":"starting";const w=k.uptime_seconds||0,V=Math.floor(w/3600),le=Math.floor(w%3600/60);g.value=`${V}h ${le}m uptime`}catch{b.value="offline",g.value=""}}return gt(()=>{S&&clearInterval(S),We.disconnect(),document.removeEventListener("keydown",C),r==null||r.removeEventListener("change",N)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:U,wsToast:f,botStatus:b,botUptime:g,navRoutes:E,navGroups:O,currentPage:y,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:L,logout:T,toggleSidebar:R,toggleMobileNavigation:D,openPalette:kd}}},Tn=Al(Yw);Tn.component("odin-icon",L_);Tn.component("login-screen",Jw);Tn.component("toast-container",yx);Tn.component("confirm-host",xx);Tn.component("command-palette",N_);Tn.directive("modal-focus",D_);Tn.use(ui);Tn.mount("#app");
