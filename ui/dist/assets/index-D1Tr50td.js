...
... (truncated)`:s}function pd(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Wh(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function I_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const N_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=ee(()=>{const L=e.value.uptime_seconds||0,J=Math.floor(L/86400),B=Math.floor(L%86400/3600),V=Math.floor(L%3600/60),I=[];return J>0&&I.push(`${J}d`),B>0&&I.push(`${B}h`),(I.length===0||J===0&&B===0)&&I.push(`${V}m`),I.join(" ")}),p=ee(()=>{const L=e.value.uptime_seconds||0;return 125.66*(1-Math.min(L/86400,1))}),m=ee(()=>{const L=e.value;return[{label:"Guilds",value:L.guild_count??0,icon:"⌂",iconColor:"text-blue-400"},{label:"Sessions",value:L.session_count??0,icon:"☰",iconColor:"text-yellow-400"},{label:"Tools",value:L.tool_count??0,icon:"⚒",iconColor:"text-purple-400",sub:`${L.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:L.loop_count??0,icon:"⟳",iconColor:"text-green-400",color:L.loop_count>0?"text-green-400":"",highlight:L.loop_count>0},{label:"Agents",value:L.agent_running??0,icon:"⚓",iconColor:"text-cyan-400",sub:L.agent_count>0?`${L.agent_count} total`:"",subColor:"text-gray-500",highlight:(L.agent_running??0)>0},{label:"Processes",value:L.process_running??0,icon:"⚙",iconColor:"text-orange-400",sub:L.process_count>0?`${L.process_count} total`:"",subColor:"text-gray-500",highlight:(L.process_running??0)>0},{label:"Schedules",value:L.schedule_count??0,icon:"⏰",iconColor:"text-amber-400",sub:(L.schedule_failing>0?`${L.schedule_failing} failing`:"")+(L.schedule_failing>0&&L.schedule_paused>0?", ":"")+(L.schedule_paused>0?`${L.schedule_paused} paused`:"")||void 0,subColor:L.schedule_failing>0?"text-red-400":"text-yellow-400",color:L.schedule_failing>0?"text-red-400":"",highlight:L.schedule_failing>0},{label:"Users",value:L.user_count??0,icon:"☺",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"≡",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=ee(()=>{const L=e.value,J=[];return J.push({label:"Bot",status:L.status==="online"?"ok":"warn",detail:L.status==="online"?"Online":"Starting"}),(L.schedule_failing||0)>0?J.push({label:"Schedules",status:"error",detail:`${L.schedule_failing} failing`}):(L.schedule_count||0)>0&&J.push({label:"Schedules",status:"ok",detail:`${L.schedule_count} configured`}),(L.loop_count||0)>0&&J.push({label:"Loops",status:"ok",detail:`${L.loop_count} active`}),(L.agent_running||0)>0&&J.push({label:"Agents",status:"ok",detail:`${L.agent_running} running`}),(L.process_running||0)>0&&J.push({label:"Processes",status:"ok",detail:`${L.process_running} running`}),J});async function k(){try{e.value=await G.get("/api/status"),s.value=null}catch(L){s.value=L.message}finally{t.value=!1}}async function C(){a.value=!0;try{n.value=await G.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function v(){l.value=!0;try{i.value=await G.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function b(){try{const L=await G.get("/api/knowledge");c.value=(Array.isArray(L)?L:[]).reduce((J,B)=>J+(B.chunks||0),0)}catch{c.value=null}}async function x(){try{const L=await G.get("/api/agents");r.value=L.filter(J=>J.status==="running")}catch{}}async function E(){u.value={...u.value,reload:!0};try{await G.post("/api/reload"),_e.success("Config reloaded")}catch(L){_e.error(L.message)}u.value={...u.value,reload:!1}}async function S(){if(!await ns({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const J=e.value.session_count;e.value={...e.value,session_count:0};try{const B=await G.post("/api/sessions/clear-all");_e.success(`Cleared ${B.count} session${B.count!==1?"s":""}`),await k()}catch(B){e.value={...e.value,session_count:J},_e.error(B.message)}u.value={...u.value,clearSessions:!1}}async function N(){if(!await ns({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const J=e.value.loop_count;e.value={...e.value,loop_count:0};try{const B=await G.post("/api/loops/stop-all");_e.success(B.result),await k()}catch(B){e.value={...e.value,loop_count:J},_e.error(B.message)}u.value={...u.value,stopLoops:!1}}function w(){t.value=!0,s.value=null,k(),C(),v(),x()}let A=null,O=null,H=null;function M(L){if(L.payload&&L.payload.tool_name){const J={...L.payload,_isNew:!0,_key:++d};n.value.unshift(J),n.value.length>10&&n.value.pop(),o.value++,J.error&&(i.value.unshift(J),i.value.length>5&&i.value.pop()),setTimeout(()=>{J._isNew=!1},1500),clearTimeout(H),H=setTimeout(()=>{o.value=0},1e4)}}return $e(async()=>{await Promise.all([k(),C(),v(),x(),b()]),A=setInterval(k,15e3),O=setInterval(x,1e4),qe.subscribe("events",M)}),ft(()=>{A&&clearInterval(A),O&&clearInterval(O),clearTimeout(H),qe.unsubscribe("events",M)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:m,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:C,fetchStatus:k,formatTime:xc,formatDuration:_a,retry:w,reloadConfig:E,clearSessions:S,stopAllLoops:N}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function hd(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function D_(e){if(Array.isArray(e))return e}function O_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function L_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function P_(e,t){return D_(e)||O_(e,t)||M_(e,t)||L_()}function M_(e,t){if(e){if(typeof e=="string")return hd(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?hd(e,t):void 0}}const Jh=Object.entries,gd=Object.setPrototypeOf,F_=Object.isFrozen,$_=Object.getPrototypeOf,B_=Object.getOwnPropertyDescriptor;let zt=Object.freeze,ps=Object.seal,Zn=Object.create,Yh=typeof Reflect<"u"&&Reflect,mo=Yh.apply,vo=Yh.construct;zt||(zt=function(t){return t});ps||(ps=function(t){return t});mo||(mo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});vo||(vo=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Ls=mt(Array.prototype.forEach),U_=mt(Array.prototype.lastIndexOf),md=mt(Array.prototype.pop),Wn=mt(Array.prototype.push),H_=mt(Array.prototype.splice),Ut=Array.isArray,Va=mt(String.prototype.toLowerCase),Ir=mt(String.prototype.toString),vd=mt(String.prototype.match),Jn=mt(String.prototype.replace),bd=mt(String.prototype.indexOf),j_=mt(String.prototype.trim),V_=mt(Number.prototype.toString),q_=mt(Boolean.prototype.toString),yd=typeof BigInt>"u"?null:mt(BigInt.prototype.toString),xd=typeof Symbol>"u"?null:mt(Symbol.prototype.toString),lt=mt(Object.prototype.hasOwnProperty),Ma=mt(Object.prototype.toString),Tt=mt(RegExp.prototype.test),xn=z_(TypeError);function mt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return mo(e,t,n)}}function z_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return vo(e,s)}}function Re(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Va;if(gd&&gd(e,null),!Ut(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(F_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function K_(e){for(let t=0;t<e.length;t++)lt(e,t)||(e[t]=null);return e}function Ot(e){const t=Zn(null);for(const n of Jh(e)){var s=P_(n,2);const a=s[0],i=s[1];lt(e,a)&&(Ut(i)?t[a]=K_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Ot(i):t[a]=i)}return t}function G_(e){switch(typeof e){case"string":return e;case"number":return V_(e);case"boolean":return q_(e);case"bigint":return yd?yd(e):"0";case"symbol":return xd?xd(e):"Symbol()";case"undefined":return Ma(e);case"function":case"object":{if(e===null)return Ma(e);const t=e,s=ks(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Ma(n)}return Ma(e)}default:return Ma(e)}}function ks(e,t){for(;e!==null;){const n=B_(e,t);if(n){if(n.get)return mt(n.get);if(typeof n.value=="function")return mt(n.value)}e=$_(e)}function s(){return null}return s}function W_(e){try{return Tt(e,""),!0}catch{return!1}}const _d=zt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Nr=zt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Dr=zt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),J_=zt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Or=zt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Y_=zt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),kd=zt(["#text"]),wd=zt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),Lr=zt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Sd=zt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),qi=zt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Q_=ps(/{{[\w\W]*|^[\w\W]*}}/g),X_=ps(/<%[\w\W]*|^[\w\W]*%>/g),Z_=ps(/\${[\w\W]*/g),ek=ps(/^data-[\-\w.\u00B7-\uFFFF]+$/),tk=ps(/^aria-[\-\w]+$/),Td=ps(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),sk=ps(/^(?:\w+script|data):/i),nk=ps(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ak=ps(/^html$/i),ik=ps(/^[a-z][.\w]*(-[.\w]+)+$/i),xs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},lk=function(){return typeof window>"u"?null:window},rk=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Cd=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Qh(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:lk();const t=me=>Qh(me);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==xs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=ks(f,"cloneNode"),m=ks(f,"remove"),g=ks(f,"nextSibling"),k=ks(f,"childNodes"),C=ks(f,"parentNode"),v=ks(f,"shadowRoot"),b=ks(f,"attributes"),x=l&&l.prototype?ks(l.prototype,"nodeType"):null,E=l&&l.prototype?ks(l.prototype,"nodeName"):null;if(typeof i=="function"){const me=s.createElement("template");me.content&&me.content.ownerDocument&&(s=me.content.ownerDocument)}let S,N="",w,A=!1,O=0;const H=function(){if(O>0)throw xn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},M=function(_){H(),O++;try{return S.createHTML(_)}finally{O--}},L=function(_){H(),O++;try{return S.createScriptURL(_)}finally{O--}},J=function(){return A||(w=rk(d,a),A=!0),w},B=s,V=B.implementation,I=B.createNodeIterator,D=B.createDocumentFragment,K=B.getElementsByTagName,fe=n.importNode;let ye=Cd();t.isSupported=typeof Jh=="function"&&typeof C=="function"&&V&&V.createHTMLDocument!==void 0;const se=Q_,pe=X_,Q=Z_,ce=ek,Ie=tk,q=sk,re=nk,le=ik;let ve=Td,be=null;const Oe=Re({},[..._d,...Nr,...Dr,...Or,...kd]);let y=null;const T=Re({},[...wd,...Lr,...Sd,...qi]);let P=Object.seal(Zn(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),W=null,R=null;const F=Object.seal(Zn(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Y=!0,Z=!0,te=!1,X=!0,ge=!1,ie=!0,de=!1,j=!1,ue=!1,Te=!1,$=!1,oe=!1,xe=!0,Me=!1;const Je="user-content-";let Ge=!0,St=!1,st={},Ye=null;const en=Re({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let mn=null;const Ai=Re({},["audio","video","img","source","image","track"]);let Ea=null;const Ri=Re({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Hn="http://www.w3.org/1998/Math/MathML",jn="http://www.w3.org/2000/svg",Kt="http://www.w3.org/1999/xhtml";let U=Kt,ne=!1,ke=null;const Qe=Re({},[Hn,jn,Kt],Ir);let nt=Re({},["mi","mo","mn","ms","mtext"]),Nt=Re({},["annotation-xml"]);const lr=Re({},["title","style","font","a","script"]);let Aa=null;const fg=["application/xhtml+xml","text/html"],pg="text/html";let it=null,Vn=null;const hg=s.createElement("form"),Nc=function(_){return _ instanceof RegExp||_ instanceof Function},rr=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Vn&&Vn===_)return;(!_||typeof _!="object")&&(_={}),_=Ot(_),Aa=fg.indexOf(_.PARSER_MEDIA_TYPE)===-1?pg:_.PARSER_MEDIA_TYPE,it=Aa==="application/xhtml+xml"?Ir:Va,be=lt(_,"ALLOWED_TAGS")&&Ut(_.ALLOWED_TAGS)?Re({},_.ALLOWED_TAGS,it):Oe,y=lt(_,"ALLOWED_ATTR")&&Ut(_.ALLOWED_ATTR)?Re({},_.ALLOWED_ATTR,it):T,ke=lt(_,"ALLOWED_NAMESPACES")&&Ut(_.ALLOWED_NAMESPACES)?Re({},_.ALLOWED_NAMESPACES,Ir):Qe,Ea=lt(_,"ADD_URI_SAFE_ATTR")&&Ut(_.ADD_URI_SAFE_ATTR)?Re(Ot(Ri),_.ADD_URI_SAFE_ATTR,it):Ri,mn=lt(_,"ADD_DATA_URI_TAGS")&&Ut(_.ADD_DATA_URI_TAGS)?Re(Ot(Ai),_.ADD_DATA_URI_TAGS,it):Ai,Ye=lt(_,"FORBID_CONTENTS")&&Ut(_.FORBID_CONTENTS)?Re({},_.FORBID_CONTENTS,it):en,W=lt(_,"FORBID_TAGS")&&Ut(_.FORBID_TAGS)?Re({},_.FORBID_TAGS,it):Ot({}),R=lt(_,"FORBID_ATTR")&&Ut(_.FORBID_ATTR)?Re({},_.FORBID_ATTR,it):Ot({}),st=lt(_,"USE_PROFILES")?_.USE_PROFILES&&typeof _.USE_PROFILES=="object"?Ot(_.USE_PROFILES):_.USE_PROFILES:!1,Y=_.ALLOW_ARIA_ATTR!==!1,Z=_.ALLOW_DATA_ATTR!==!1,te=_.ALLOW_UNKNOWN_PROTOCOLS||!1,X=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ge=_.SAFE_FOR_TEMPLATES||!1,ie=_.SAFE_FOR_XML!==!1,de=_.WHOLE_DOCUMENT||!1,Te=_.RETURN_DOM||!1,$=_.RETURN_DOM_FRAGMENT||!1,oe=_.RETURN_TRUSTED_TYPE||!1,ue=_.FORCE_BODY||!1,xe=_.SANITIZE_DOM!==!1,Me=_.SANITIZE_NAMED_PROPS||!1,Ge=_.KEEP_CONTENT!==!1,St=_.IN_PLACE||!1,ve=W_(_.ALLOWED_URI_REGEXP)?_.ALLOWED_URI_REGEXP:Td,U=typeof _.NAMESPACE=="string"?_.NAMESPACE:Kt,nt=lt(_,"MATHML_TEXT_INTEGRATION_POINTS")&&_.MATHML_TEXT_INTEGRATION_POINTS&&typeof _.MATHML_TEXT_INTEGRATION_POINTS=="object"?Ot(_.MATHML_TEXT_INTEGRATION_POINTS):Re({},["mi","mo","mn","ms","mtext"]),Nt=lt(_,"HTML_INTEGRATION_POINTS")&&_.HTML_INTEGRATION_POINTS&&typeof _.HTML_INTEGRATION_POINTS=="object"?Ot(_.HTML_INTEGRATION_POINTS):Re({},["annotation-xml"]);const z=lt(_,"CUSTOM_ELEMENT_HANDLING")&&_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING=="object"?Ot(_.CUSTOM_ELEMENT_HANDLING):Zn(null);if(P=Zn(null),lt(z,"tagNameCheck")&&Nc(z.tagNameCheck)&&(P.tagNameCheck=z.tagNameCheck),lt(z,"attributeNameCheck")&&Nc(z.attributeNameCheck)&&(P.attributeNameCheck=z.attributeNameCheck),lt(z,"allowCustomizedBuiltInElements")&&typeof z.allowCustomizedBuiltInElements=="boolean"&&(P.allowCustomizedBuiltInElements=z.allowCustomizedBuiltInElements),ge&&(Z=!1),$&&(Te=!0),st&&(be=Re({},kd),y=Zn(null),st.html===!0&&(Re(be,_d),Re(y,wd)),st.svg===!0&&(Re(be,Nr),Re(y,Lr),Re(y,qi)),st.svgFilters===!0&&(Re(be,Dr),Re(y,Lr),Re(y,qi)),st.mathMl===!0&&(Re(be,Or),Re(y,Sd),Re(y,qi))),F.tagCheck=null,F.attributeCheck=null,lt(_,"ADD_TAGS")&&(typeof _.ADD_TAGS=="function"?F.tagCheck=_.ADD_TAGS:Ut(_.ADD_TAGS)&&(be===Oe&&(be=Ot(be)),Re(be,_.ADD_TAGS,it))),lt(_,"ADD_ATTR")&&(typeof _.ADD_ATTR=="function"?F.attributeCheck=_.ADD_ATTR:Ut(_.ADD_ATTR)&&(y===T&&(y=Ot(y)),Re(y,_.ADD_ATTR,it))),lt(_,"ADD_URI_SAFE_ATTR")&&Ut(_.ADD_URI_SAFE_ATTR)&&Re(Ea,_.ADD_URI_SAFE_ATTR,it),lt(_,"FORBID_CONTENTS")&&Ut(_.FORBID_CONTENTS)&&(Ye===en&&(Ye=Ot(Ye)),Re(Ye,_.FORBID_CONTENTS,it)),lt(_,"ADD_FORBID_CONTENTS")&&Ut(_.ADD_FORBID_CONTENTS)&&(Ye===en&&(Ye=Ot(Ye)),Re(Ye,_.ADD_FORBID_CONTENTS,it)),Ge&&(be["#text"]=!0),de&&Re(be,["html","head","body"]),be.table&&(Re(be,["tbody"]),delete W.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw xn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw xn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const ae=S;S=_.TRUSTED_TYPES_POLICY;try{N=M("")}catch(Se){throw S=ae,Se}}else _.TRUSTED_TYPES_POLICY===null?(S=void 0,N=""):(S===void 0&&(S=J()),S&&typeof N=="string"&&(N=M("")));(ye.uponSanitizeElement.length>0||ye.uponSanitizeAttribute.length>0)&&be===Oe&&(be=Ot(be)),ye.uponSanitizeAttribute.length>0&&y===T&&(y=Ot(y)),zt&&zt(_),Vn=_},Dc=Re({},[...Nr,...Dr,...J_]),Oc=Re({},[...Or,...Y_]),gg=function(_){let z=C(_);(!z||!z.tagName)&&(z={namespaceURI:U,tagName:"template"});const ae=Va(_.tagName),Se=Va(z.tagName);return ke[_.namespaceURI]?_.namespaceURI===jn?z.namespaceURI===Kt?ae==="svg":z.namespaceURI===Hn?ae==="svg"&&(Se==="annotation-xml"||nt[Se]):!!Dc[ae]:_.namespaceURI===Hn?z.namespaceURI===Kt?ae==="math":z.namespaceURI===jn?ae==="math"&&Nt[Se]:!!Oc[ae]:_.namespaceURI===Kt?z.namespaceURI===jn&&!Nt[Se]||z.namespaceURI===Hn&&!nt[Se]?!1:!Oc[ae]&&(lr[ae]||!Dc[ae]):!!(Aa==="application/xhtml+xml"&&ke[_.namespaceURI]):!1},hs=function(_){Wn(t.removed,{element:_});try{C(_).removeChild(_)}catch{if(m(_),!C(_))throw xn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Lc=function(_){const z=k?k(_):_.childNodes;if(z){const Se=[];Ls(z,Ee=>{Wn(Se,Ee)}),Ls(Se,Ee=>{try{m(Ee)}catch{}})}const ae=b?b(_):null;if(ae)for(let Se=ae.length-1;Se>=0;--Se){const Ee=ae[Se],Ne=Ee&&Ee.name;if(typeof Ne=="string")try{_.removeAttribute(Ne)}catch{}}},vn=function(_,z){try{Wn(t.removed,{attribute:z.getAttributeNode(_),from:z})}catch{Wn(t.removed,{attribute:null,from:z})}if(z.removeAttribute(_),_==="is")if(Te||$)try{hs(z)}catch{}else try{z.setAttribute(_,"")}catch{}},mg=function(_){const z=b?b(_):_.attributes;if(z)for(let ae=z.length-1;ae>=0;--ae){const Se=z[ae],Ee=Se&&Se.name;if(!(typeof Ee!="string"||y[it(Ee)]))try{_.removeAttribute(Ee)}catch{}}},vg=function(_){const z=[_];for(;z.length>0;){const ae=z.pop();(x?x(ae):ae.nodeType)===xs.element&&mg(ae);const Ee=k?k(ae):ae.childNodes;if(Ee)for(let Ne=Ee.length-1;Ne>=0;--Ne)z.push(Ee[Ne])}},Pc=function(_){let z=null,ae=null;if(ue)_="<remove></remove>"+_;else{const Ne=vd(_,/^[\r\n\t ]+/);ae=Ne&&Ne[0]}Aa==="application/xhtml+xml"&&U===Kt&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const Se=S?M(_):_;if(U===Kt)try{z=new u().parseFromString(Se,Aa)}catch{}if(!z||!z.documentElement){z=V.createDocument(U,"template",null);try{z.documentElement.innerHTML=ne?N:Se}catch{}}const Ee=z.body||z.documentElement;return _&&ae&&Ee.insertBefore(s.createTextNode(ae),Ee.childNodes[0]||null),U===Kt?K.call(z,de?"html":"body")[0]:de?z.documentElement:Ee},Mc=function(_){return I.call(_.ownerDocument||_,_,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},or=function(_){var z,ae;_.normalize();const Se=I.call(_.ownerDocument||_,_,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Ee=Se.nextNode();for(;Ee;){let vt=Ee.data;Ls([se,pe,Q],Xe=>{vt=Jn(vt,Xe," ")}),Ee.data=vt,Ee=Se.nextNode()}const Ne=(z=(ae=_.querySelectorAll)===null||ae===void 0?void 0:ae.call(_,"template"))!==null&&z!==void 0?z:[];Ls(Array.from(Ne),vt=>{qn(vt.content)&&or(vt.content)})},Ii=function(_){const z=E?E(_):null;return typeof z!="string"||it(z)!=="form"?!1:typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||_.attributes!==b(_)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function"||_.nodeType!==x(_)||_.childNodes!==k(_)},qn=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return x(_)===xs.documentFragment}catch{return!1}},Ra=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return typeof x(_)=="number"}catch{return!1}};function Is(me,_,z){Ls(me,ae=>{ae.call(t,_,z,Vn)})}const Fc=function(_){let z=null;if(Is(ye.beforeSanitizeElements,_,null),Ii(_))return hs(_),!0;const ae=it(E?E(_):_.nodeName);if(Is(ye.uponSanitizeElement,_,{tagName:ae,allowedTags:be}),ie&&_.hasChildNodes()&&!Ra(_.firstElementChild)&&Tt(/<[/\w!]/g,_.innerHTML)&&Tt(/<[/\w!]/g,_.textContent)||ie&&_.namespaceURI===Kt&&ae==="style"&&Ra(_.firstElementChild)||_.nodeType===xs.progressingInstruction||ie&&_.nodeType===xs.comment&&Tt(/<[/\w]/g,_.data))return hs(_),!0;if(W[ae]||!(F.tagCheck instanceof Function&&F.tagCheck(ae))&&!be[ae]){if(!W[ae]&&Bc(ae)&&(P.tagNameCheck instanceof RegExp&&Tt(P.tagNameCheck,ae)||P.tagNameCheck instanceof Function&&P.tagNameCheck(ae)))return!1;if(Ge&&!Ye[ae]){const Ee=C(_),Ne=k(_);if(Ne&&Ee){const vt=Ne.length;for(let Xe=vt-1;Xe>=0;--Xe){const ct=St?Ne[Xe]:p(Ne[Xe],!0);Ee.insertBefore(ct,g(_))}}}return hs(_),!0}return(x?x(_):_.nodeType)===xs.element&&!gg(_)||(ae==="noscript"||ae==="noembed"||ae==="noframes")&&Tt(/<\/no(script|embed|frames)/i,_.innerHTML)?(hs(_),!0):(ge&&_.nodeType===xs.text&&(z=_.textContent,Ls([se,pe,Q],Ee=>{z=Jn(z,Ee," ")}),_.textContent!==z&&(Wn(t.removed,{element:_.cloneNode()}),_.textContent=z)),Is(ye.afterSanitizeElements,_,null),!1)},$c=function(_,z,ae){if(R[z]||xe&&(z==="id"||z==="name")&&(ae in s||ae in hg))return!1;const Se=y[z]||F.attributeCheck instanceof Function&&F.attributeCheck(z,_);if(!(Z&&!R[z]&&Tt(ce,z))){if(!(Y&&Tt(Ie,z))){if(!Se||R[z]){if(!(Bc(_)&&(P.tagNameCheck instanceof RegExp&&Tt(P.tagNameCheck,_)||P.tagNameCheck instanceof Function&&P.tagNameCheck(_))&&(P.attributeNameCheck instanceof RegExp&&Tt(P.attributeNameCheck,z)||P.attributeNameCheck instanceof Function&&P.attributeNameCheck(z,_))||z==="is"&&P.allowCustomizedBuiltInElements&&(P.tagNameCheck instanceof RegExp&&Tt(P.tagNameCheck,ae)||P.tagNameCheck instanceof Function&&P.tagNameCheck(ae))))return!1}else if(!Ea[z]){if(!Tt(ve,Jn(ae,re,""))){if(!((z==="src"||z==="xlink:href"||z==="href")&&_!=="script"&&bd(ae,"data:")===0&&mn[_])){if(!(te&&!Tt(q,Jn(ae,re,"")))){if(ae)return!1}}}}}}return!0},bg=Re({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),Bc=function(_){return!bg[Va(_)]&&Tt(le,_)},Uc=function(_){Is(ye.beforeSanitizeAttributes,_,null);const z=_.attributes;if(!z||Ii(_))return;const ae={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let Se=z.length;for(;Se--;){const Ee=z[Se],Ne=Ee.name,vt=Ee.namespaceURI,Xe=Ee.value,ct=it(Ne),tn=Xe;let _t=Ne==="value"?tn:j_(tn);if(ae.attrName=ct,ae.attrValue=_t,ae.keepAttr=!0,ae.forceKeepAttr=void 0,Is(ye.uponSanitizeAttribute,_,ae),_t=ae.attrValue,Me&&(ct==="id"||ct==="name")&&bd(_t,Je)!==0&&(vn(Ne,_),_t=Je+_t),ie&&Tt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,_t)){vn(Ne,_);continue}if(ct==="attributename"&&vd(_t,"href")){vn(Ne,_);continue}if(ae.forceKeepAttr)continue;if(!ae.keepAttr){vn(Ne,_);continue}if(!X&&Tt(/\/>/i,_t)){vn(Ne,_);continue}ge&&Ls([se,pe,Q],jc=>{_t=Jn(_t,jc," ")});const Hc=it(_.nodeName);if(!$c(Hc,ct,_t)){vn(Ne,_);continue}if(S&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!vt)switch(d.getAttributeType(Hc,ct)){case"TrustedHTML":{_t=M(_t);break}case"TrustedScriptURL":{_t=L(_t);break}}if(_t!==tn)try{vt?_.setAttributeNS(vt,Ne,_t):_.setAttribute(Ne,_t),Ii(_)?hs(_):md(t.removed)}catch{vn(Ne,_)}}Is(ye.afterSanitizeAttributes,_,null)},Ni=function(_){let z=null;const ae=Mc(_);for(Is(ye.beforeSanitizeShadowDOM,_,null);z=ae.nextNode();)if(Is(ye.uponSanitizeShadowNode,z,null),Fc(z),Uc(z),qn(z.content)&&Ni(z.content),(x?x(z):z.nodeType)===xs.element){const Ee=v?v(z):z.shadowRoot;qn(Ee)&&(cr(Ee),Ni(Ee))}Is(ye.afterSanitizeShadowDOM,_,null)},cr=function(_){const z=[{node:_,shadow:null}];for(;z.length>0;){const ae=z.pop();if(ae.shadow){Ni(ae.shadow);continue}const Se=ae.node,Ne=(x?x(Se):Se.nodeType)===xs.element,vt=k?k(Se):Se.childNodes;if(vt)for(let Xe=vt.length-1;Xe>=0;--Xe)z.push({node:vt[Xe],shadow:null});if(Ne){const Xe=E?E(Se):null;if(typeof Xe=="string"&&it(Xe)==="template"){const ct=Se.content;qn(ct)&&z.push({node:ct,shadow:null})}}if(Ne){const Xe=v?v(Se):Se.shadowRoot;qn(Xe)&&z.push({node:null,shadow:Xe},{node:Xe,shadow:null})}}};return t.sanitize=function(me){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},z=null,ae=null,Se=null,Ee=null;if(ne=!me,ne&&(me="<!-->"),typeof me!="string"&&!Ra(me)&&(me=G_(me),typeof me!="string"))throw xn("dirty is not a string, aborting");if(!t.isSupported)return me;j||rr(_),t.removed=[];const Ne=St&&typeof me!="string"&&Ra(me);if(Ne){const ct=E?E(me):me.nodeName;if(typeof ct=="string"){const tn=it(ct);if(!be[tn]||W[tn])throw xn("root node is forbidden and cannot be sanitized in-place")}if(Ii(me))throw xn("root node is clobbered and cannot be sanitized in-place");try{cr(me)}catch(tn){throw Lc(me),tn}}else if(Ra(me))z=Pc("<!---->"),ae=z.ownerDocument.importNode(me,!0),ae.nodeType===xs.element&&ae.nodeName==="BODY"||ae.nodeName==="HTML"?z=ae:z.appendChild(ae),cr(ae);else{if(!Te&&!ge&&!de&&me.indexOf("<")===-1)return S&&oe?M(me):me;if(z=Pc(me),!z)return Te?null:oe?N:""}z&&ue&&hs(z.firstChild);const vt=Mc(Ne?me:z);try{for(;Se=vt.nextNode();)Fc(Se),Uc(Se),qn(Se.content)&&Ni(Se.content)}catch(ct){throw Ne&&Lc(me),ct}if(Ne)return Ls(t.removed,ct=>{ct.element&&vg(ct.element)}),ge&&or(me),me;if(Te){if(ge&&or(z),$)for(Ee=D.call(z.ownerDocument);z.firstChild;)Ee.appendChild(z.firstChild);else Ee=z;return(y.shadowroot||y.shadowrootmode)&&(Ee=fe.call(n,Ee,!0)),Ee}let Xe=de?z.outerHTML:z.innerHTML;return de&&be["!doctype"]&&z.ownerDocument&&z.ownerDocument.doctype&&z.ownerDocument.doctype.name&&Tt(ak,z.ownerDocument.doctype.name)&&(Xe="<!DOCTYPE "+z.ownerDocument.doctype.name+`>
`+Xe),ge&&Ls([se,pe,Q],ct=>{Xe=Jn(Xe,ct," ")}),S&&oe?M(Xe):Xe},t.setConfig=function(){let me=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};rr(me),j=!0},t.clearConfig=function(){Vn=null,j=!1,S=w,N=""},t.isValidAttribute=function(me,_,z){Vn||rr({});const ae=it(me),Se=it(_);return $c(ae,Se,z)},t.addHook=function(me,_){typeof _=="function"&&Wn(ye[me],_)},t.removeHook=function(me,_){if(_!==void 0){const z=U_(ye[me],_);return z===-1?void 0:H_(ye[me],z,1)[0]}return md(ye[me])},t.removeHooks=function(me){ye[me]=[]},t.removeAllHooks=function(){ye=Cd()},t}var Ed=Qh();function kc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Un=kc();function Xh(e){Un=e}var Xa={exec:()=>null};function ze(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Vt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var Vt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},ok=/^(?:[ \t]*(?:\n|$))+/,ck=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,uk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ei=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,dk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,wc=/(?:[*+-]|\d{1,9}[.)])/,Zh=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,eg=ze(Zh).replace(/bull/g,wc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),fk=ze(Zh).replace(/bull/g,wc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Sc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,pk=/^[^\n]+/,Tc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,hk=ze(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Tc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),gk=ze(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,wc).getRegex(),nr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Cc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,mk=ze("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Cc).replace("tag",nr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),tg=ze(Sc).replace("hr",Ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex(),vk=ze(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",tg).getRegex(),Ec={blockquote:vk,code:ck,def:hk,fences:uk,heading:dk,hr:Ei,html:mk,lheading:eg,list:gk,newline:ok,paragraph:tg,table:Xa,text:pk},Ad=ze("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex(),bk={...Ec,lheading:fk,table:Ad,paragraph:ze(Sc).replace("hr",Ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ad).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nr).getRegex()},yk={...Ec,html:ze(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Cc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Xa,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ze(Sc).replace("hr",Ei).replace("heading",` *#{1,6} *[^
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+ws(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Pn=new Vk;function je(e,t){return Pn.parse(e,t)}je.options=je.setOptions=function(e){return Pn.setOptions(e),je.defaults=Pn.defaults,Xh(je.defaults),je};je.getDefaults=kc;je.defaults=Un;je.use=function(...e){return Pn.use(...e),je.defaults=Pn.defaults,Xh(je.defaults),je};je.walkTokens=function(e,t){return Pn.walkTokens(e,t)};je.parseInline=Pn.parseInline;je.Parser=Vs;je.parser=Vs.parse;je.Renderer=Rl;je.TextRenderer=Ic;je.Lexer=js;je.lexer=js.lex;je.Tokenizer=Al;je.Hooks=Zi;je.parse=je;je.options;je.setOptions;je.use;je.walkTokens;je.parseInline;Vs.parse;js.lex;const qk={breaks:!0,gfm:!0};function Od(e){if(!e)return"";try{if(typeof je<"u"&&je.parse){const t=je.parse(e,qk);return typeof Ed<"u"?Ed.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function zk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Ld={run_command:"⌘",ssh_command:"⌘",run_script:"⌘",read_file:"📄",write_file:"✏️",list_directory:"📂",search_knowledge:"🔍",ingest_document:"📚",generate_image:"🎨",analyze_image:"🖼️",analyze_pdf:"📃",browser_screenshot:"🌐",manage_process:"⚙️"};function Kk(e){return Ld[e]?Ld[e]:"🔧"}const Gk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function Pd(e){if(!e)return[];const t=e.match(Gk);return t?[...new Set(t)]:[]}const Wk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=ee(()=>t.value.trim().length>0&&!s.value),d=ee(()=>{const B=qe.state;return B==="connected"?"Connected":B==="reconnecting"?"Reconnecting…":B==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=ee(()=>{const B=Math.floor(i.value/4)%f.length,V=i.value;return V>3?`${f[B]} (${V}s)`:f[0]});function m(){Et(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const B=a.value;B.style.height="auto",B.style.height=Math.min(B.scrollHeight,120)+"px"}function k(B,V,I={}){const D={id:++o,role:B,content:V,timestamp:Date.now(),html:B==="bot"?Od(V):"",tools_used:I.tools_used||[],is_error:I.is_error||!1,images:B==="bot"?Pd(V):[],files:I.files||[],_showTools:!1};return e.value.push(D),m(),B==="bot"&&Et(()=>C()),D}function C(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(V=>{V.setAttribute("data-copy","true"),V.style.position="relative";const I=document.createElement("button");I.className="chat-code-copy",I.textContent="Copy",I.addEventListener("click",()=>{const D=V.querySelector("code"),K=D?D.textContent:V.textContent;navigator.clipboard.writeText(K).then(()=>{I.textContent="Copied!",setTimeout(()=>{I.textContent="Copy"},1500)}).catch(()=>{})}),V.appendChild(I)})}function v(B){if(B===0)return!0;const V=e.value[B-1],I=e.value[B],D=new Date(V.timestamp).toDateString(),K=new Date(I.timestamp).toDateString();return D!==K}function b(B){const V=new Date(B),I=new Date;if(V.toDateString()===I.toDateString())return"Today";const D=new Date(I);return D.setDate(D.getDate()-1),V.toDateString()===D.toDateString()?"Yesterday":V.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(B){t.value=B,Et(()=>H())}function E(B){window.open(B,"_blank","noopener")}function S(B){B.target.style.display="none"}function N(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function w(){r&&(clearInterval(r),r=null),i.value=0}function A(B){s.value&&(s.value=!1,w(),B.type==="chat_response"?k("bot",B.content,{tools_used:B.tools_used||[],is_error:B.is_error||!1,files:B.files||[]}):B.type==="chat_error"&&k("bot",B.error||"Unknown error",{is_error:!0}),Et(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}async function O(B){try{const V=await G.post("/api/chat",{content:B,channel_id:l.value});k("bot",V.response,{tools_used:V.tools_used||[],is_error:V.is_error||!1,files:V.files||[]})}catch(V){k("bot",V.message||"Failed to send message",{is_error:!0})}}async function H(){const B=t.value.trim();!B||s.value||(k("user",B),t.value="",s.value=!0,N(),a.value&&(a.value.style.height="auto"),qe.connected?qe.sendChat(B,{channelId:l.value})?L():(await O(B),s.value=!1,w()):(await O(B),s.value=!1,w()),Et(()=>{var V;return(V=a.value)==null?void 0:V.focus()}))}let M=null;ds(s,B=>{B||M&&(clearTimeout(M),M=null)});function L(){M=setTimeout(()=>{s.value&&(s.value=!1,w(),k("bot","Response timed out. Try again.",{is_error:!0}))},12e4)}async function J(){try{if(!l.value){const V=await G.get("/api/auth/session");l.value=V.channel_id||V.user_id||"web-user"}const B=await G.get("/api/sessions/"+encodeURIComponent(l.value));if(B&&B.messages&&B.messages.length>0){for(const V of B.messages){const I=V.role==="user"?"user":"bot";let D=V.content||"";if(I==="user"){const fe=D.match(/^\[.*?\]:\s*/);fe&&(D=D.slice(fe[0].length))}if(!D.trim())continue;const K={id:++o,role:I,content:D,timestamp:V.timestamp?V.timestamp*1e3:Date.now(),html:I==="bot"?Od(D):"",tools_used:[],is_error:!1,images:I==="bot"?Pd(D):[],files:[],_showTools:!1};e.value.push(K)}Et(()=>{m(),C()})}}catch{}}return $e(()=>{qe.subscribe("chat",A),J(),Et(()=>{var B;return(B=a.value)==null?void 0:B.focus()})}),ft(()=>{qe.unsubscribe("chat",A),M&&clearTimeout(M),w()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:H,autoResize:g,formatTime:zk,formatDate:b,showDateSeparator:v,useSuggestion:x,openImage:E,onImageError:S,getToolIcon:Kk}}},ir={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=T_(),s=zh(),n=ee({get(){var r;const l=t.query.tab;return l&&e.tabs.some(o=>o.id===l)?l:e.defaultTab||((r=e.tabs[0])==null?void 0:r.id)||""},set(l){s.replace({query:{...t.query,tab:l}})}}),a=ee(()=>{const l=e.tabs.find(r=>r.id===n.value);return(l==null?void 0:l.component)||null}),i=ee(()=>{const l=e.tabs.find(r=>r.id===n.value);return(l==null?void 0:l.label)||""});return ds(i,l=>{e.groupLabel&&l&&(document.title=`Odin — ${e.groupLabel} › ${l}`)},{immediate:!0}),{activeTab:n,activeComponent:a,activeLabel:i}},template:`
    <div>
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}$e(()=>{qe.on("events",a),i=setInterval(l,500)}),ft(()=>{qe.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"⏳":c==="success"?"✅":c==="error"?"❌":"⭕"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},Yk={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=null;const r=ee(()=>e.value.filter(C=>C.status==="running").length),o=ee(()=>e.value.filter(C=>C.status==="completed").length),c=ee(()=>e.value.filter(C=>["failed","timeout","killed"].includes(C.status)).length),u=ee(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),d=ee(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(C=>["failed","timeout","killed"].includes(C.status)):e.value.filter(C=>C.status===i.value));function f(C){return Math.min(100,Math.round(C.iteration_count/30*100))}async function p(C=!1){C=C===!0,C||(t.value=!0);try{const v=await G.get("/api/agents");e.value=Array.isArray(v)?v:[],s.value=null}catch(v){C||(s.value=v.message)}C||(t.value=!1)}async function m(C){const v=e.value.find(x=>x.id===C);if(await ns({title:"Kill agent",message:`Kill agent "${(v==null?void 0:v.label)||C}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=C;try{await G.del(`/api/agents/${encodeURIComponent(C)}`),_e.success("Agent killed"),await p()}catch(x){_e.error(x.message||"Failed to kill agent")}n.value=null}}function g(){k(),a.value&&(l=setInterval(()=>{a.value&&p(!0)},5e3))}function k(){l&&(clearInterval(l),l=null)}return $e(()=>{p(),g()}),ft(()=>{k()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:u,filteredAgents:d,formatTs:Ta,formatDuration:_a,progressPercent:f,fetchAgents:p,killAgent:m,startAutoRefresh:g,stopAutoRefresh:k}}},Qk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=ee(()=>e.value.reduce((S,N)=>S+(N.iteration_count||0),0)),d=ee(()=>e.value.filter(S=>S.status==="running").length);function f(S){return S==="running"?"loop-status-running":S==="error"?"loop-status-error":"loop-status-stopped"}function p(S){return S==="running"?"badge-success":S==="error"?"badge-danger":S==="completed"?"badge-info":"badge-warning"}function m(S){return S==="act"?"badge-warning":S==="silent"?"badge-info":"badge-success"}function g(S){c.value={...c.value,[S]:!c.value[S]}}async function k(S=!1){S=S===!0,S||(t.value=!0);try{e.value=await G.get("/api/loops"),s.value=null}catch(N){S||(s.value=N.message)}S||(t.value=!1)}async function C(){l.value=null;const S=a.value;if(!S.goal.trim()){l.value="Goal is required";return}if(!S.channel_id.trim()){l.value="Channel ID is required";return}const N={goal:S.goal.trim(),channel_id:S.channel_id.trim(),interval_seconds:S.interval_seconds||60,mode:S.mode,max_iterations:S.max_iterations||50};S.stop_condition.trim()&&(N.stop_condition=S.stop_condition.trim()),i.value=!0;try{const w=await G.post("/api/loops",N);_e.success(`Loop started: ${w.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await k()}catch(w){l.value=w.message}i.value=!1}async function v(S){if(await ns({title:"Stop loop",message:`Stop loop ${S}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=S;try{await G.del(`/api/loops/${encodeURIComponent(S)}`),_e.success("Loop stopped"),await k()}catch(w){_e.error(w.message||"Failed to stop loop")}r.value=null}}async function b(S){o.value=S;try{await G.post(`/api/loops/${encodeURIComponent(S)}/restart`),_e.success("Loop restarted"),await k()}catch(N){_e.error(N.message||"Failed to restart loop")}o.value=null}function x(S){S.payload&&(S.payload.loop_id||S.payload.type==="loop")&&k(!0)}let E=null;return $e(()=>{k(),qe.subscribe("events",x),E=setInterval(()=>{k(!0)},5e3)}),ft(()=>{qe.unsubscribe("events",x),E&&clearInterval(E)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:_a,formatAge:Kh,toggleHistory:g,fetchLoops:k,doCreate:C,doStop:v,doRestart:b}}},Xk={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),m=h(null),g=h([]),k=h(!1),C=ee(()=>e.value.filter(I=>I.cron&&!I.one_time).length),v=ee(()=>e.value.filter(I=>I.one_time).length),b=ee(()=>e.value.filter(I=>I.trigger).length),x=ee(()=>e.value.filter(I=>I.paused).length),E=ee(()=>e.value.filter(I=>I.consecutive_failures>0).length);function S(I){if(!I)return"-";const D=Date.now(),fe=(new Date(I).getTime()-D)/1e3;if(fe<0)return"overdue";if(fe<60)return"in < 1 min";if(fe<3600)return`in ${Math.floor(fe/60)} min`;if(fe<86400){const se=Math.floor(fe/3600),pe=Math.floor(fe%3600/60);return pe>0?`in ${se}h ${pe}m`:`in ${se}h`}const ye=Math.floor(fe/86400);return`in ${ye} day${ye!==1?"s":""}`}function N(I){return I==null?"-":I<1e3?`${I}ms`:I<6e4?`${(I/1e3).toFixed(1)}s`:_a(I/1e3)}function w(){r.value=null}async function A(){const I=a.value.cron.trim();if(I){o.value=!0;try{r.value=await G.post("/api/schedules/validate-cron",{expression:I})}catch(D){r.value={valid:!1,error:D.message}}o.value=!1}}async function O(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(I){s.value=I.message}t.value=!1}async function H(I){if(m.value===I){m.value=null,g.value=[];return}m.value=I,k.value=!0,g.value=[];try{g.value=await G.get(`/api/schedules/${encodeURIComponent(I)}/history?limit=10`)}catch{g.value=[]}k.value=!1}async function M(){l.value=null;const I=a.value;if(!I.description.trim()){l.value="Description is required";return}if(!I.channel_id.trim()){l.value="Channel ID is required";return}if(!I.cron.trim()&&!I.run_at.trim()){l.value="Cron expression or run_at time is required";return}const D={description:I.description.trim(),action:I.action,channel_id:I.channel_id.trim()};if(I.cron.trim()&&(D.cron=I.cron.trim()),I.run_at.trim()&&(D.run_at=I.run_at.trim()),I.action==="reminder"&&I.message.trim()&&(D.message=I.message.trim()),I.action==="check"&&(I.tool_name.trim()&&(D.tool_name=I.tool_name.trim()),I.tool_input_str.trim()))try{D.tool_input=JSON.parse(I.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",D),_e.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await O()}catch(K){l.value=K.message}i.value=!1}async function L(I){u.value=I;try{const D=await G.post(`/api/schedules/${encodeURIComponent(I)}/run`);if(D.status==="failure")_e.error(`Execution failed: ${D.error||"unknown error"}`);else{const K=D.warning?`Executed (${D.warning})`:"Executed successfully";_e.success(K)}await O()}catch(D){_e.error(D.message||"Failed to trigger")}u.value=null}async function J(I){f.value=I.id;const D=!I.paused;try{await G.put(`/api/schedules/${encodeURIComponent(I.id)}`,{paused:D}),_e.success(D?"Schedule paused":"Schedule resumed"),await O()}catch(K){_e.error(K.message||"Failed to update schedule")}f.value=null}async function B(I){p.value=I;try{await G.post(`/api/schedules/${encodeURIComponent(I)}/reset-failures`),_e.success("Failure counters reset"),await O()}catch(D){_e.error(D.message||"Failed to reset")}p.value=null}async function V(I){const D=e.value.find(fe=>fe.id===I);if(await ns({title:"Delete schedule",message:`Delete "${(D==null?void 0:D.description)||I}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=I;try{await G.del(`/api/schedules/${encodeURIComponent(I)}`),_e.success("Schedule deleted"),await O()}catch(fe){_e.error(fe.message||"Failed to delete schedule")}d.value=null}}return $e(()=>{O()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:m,history:g,historyLoading:k,cronCount:C,oneTimeCount:v,webhookCount:b,pausedCount:x,failingCount:E,formatTs:Ta,formatAge:Kh,formatFuture:S,formatMs:N,formatDuration:_a,onCronInput:w,validateCron:A,toggleExpand:H,fetchSchedules:O,doCreate:M,doRunNow:L,doTogglePause:J,doResetFailures:B,doDelete:V}}},ew={components:{TabbedPage:ir},setup(){return{tabs:[{id:"live",label:"Live",component:Jk},{id:"agents",label:"Agents",component:Yk},{id:"loops",label:"Loops",component:Qk},{id:"processes",label:"Processes",component:Xk},{id:"schedules",label:"Schedules",component:Zk}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},tw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=Md,g=sw,k=h([]),C=h(!1),v=h(""),b=h("flat"),x=h(new Set),E=h(""),S=h(""),N=h(""),w=h(null),A=h(!1);function O(){try{const $=localStorage.getItem("odin-session-presets");$&&(k.value=JSON.parse($))}catch{}}function H(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const M=ee(()=>d.value.trim()!==""||u.value!=="all"),L=ee(()=>{let $=[...e.value];const oe=Md.find(Ge=>Ge.id===u.value),xe=oe?oe.filters:{};if(xe.source&&($=$.filter(Ge=>Ge.source===xe.source)),xe.minMessages&&($=$.filter(Ge=>Ge.message_count>=xe.minMessages)),xe.hasCompaction&&($=$.filter(Ge=>Ge.has_summary)),xe.maxAge!=null){const Ge=Date.now()/1e3;$=$.filter(St=>St.last_active&&Ge-St.last_active<=xe.maxAge)}if(d.value.trim()){const Ge=d.value.toLowerCase().trim();$=$.filter(St=>(St.channel_id||"").toLowerCase().includes(Ge)||(St.last_user_id||"").toLowerCase().includes(Ge)||(St.source||"").toLowerCase().includes(Ge))}const Me=f.value,Je=p.value?1:-1;return $.sort((Ge,St)=>{const st=Ge[Me]||0,Ye=St[Me]||0;return(st-Ye)*Je}),$}),J=ee(()=>{if(!a.value||!a.value.messages)return[];const $=a.value.messages;if($.length===0)return[];const oe=[];let xe=[];for(const Me of $)Me.role==="user"&&xe.length>0&&(oe.push(xe),xe=[]),xe.push(Me);return xe.length>0&&oe.push(xe),oe}),B=ee(()=>L.value.length>0&&o.value.size===L.value.length);function V($){const oe=$.find(xe=>xe.role==="user");if(oe&&oe.content){const xe=oe.content.slice(0,120);return xe.length<oe.content.length?xe+"...":xe}return"(no user message)"}function I($){const oe=new Set(x.value);oe.has($)?oe.delete($):oe.add($),x.value=oe}function D($){u.value=$}function K($){u.value=$.id,$.filters.searchQuery!=null&&(d.value=$.filters.searchQuery),$.filters.sortBy&&(f.value=$.filters.sortBy)}function fe(){if(!v.value.trim())return;const $={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,$],H(),C.value=!1,v.value=""}function ye($){k.value=k.value.filter(oe=>oe.id!==$),H(),u.value===$&&(u.value="all")}function se(){u.value="all",d.value="",f.value="last_active",p.value=!1}function pe($){if(!$)return"—";const oe=Date.now()/1e3-$;if(oe<60)return"just now";if(oe<3600){const Me=Math.floor(oe/60);return`${Me} minute${Me!==1?"s":""} ago`}if(oe<86400){const Me=Math.floor(oe/3600);return`${Me} hour${Me!==1?"s":""} ago`}const xe=Math.floor(oe/86400);return`${xe} day${xe!==1?"s":""} ago`}function Q($){if(!$)return"";try{return new Date($*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ce($){if(!$)return"";try{return new Date($*1e3).toLocaleString()}catch{return""}}function Ie($){return $==="user"?"bg-gray-900/50 border border-gray-800":$==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function q($){return $==="user"?"sess-msg-user":$==="assistant"?"sess-msg-assistant":"sess-msg-system"}function re($){return $==="user"?"badge-info":$==="assistant"?"badge-success":"badge-warning"}function le($){return $==="user"?"sess-dot-user":$==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ve($){return $==="user"?"text-cyan-400":$==="assistant"?"text-indigo-400":"text-gray-500"}function be($){return $?$.length>2e3?$.slice(0,2e3)+`
... (truncated)`:$:""}async function Oe(){const $=E.value.trim();if($){A.value=!0;try{let oe=`/api/sessions/search?q=${encodeURIComponent($)}&limit=50`;S.value.trim()&&(oe+=`&channel_id=${encodeURIComponent(S.value.trim())}`),N.value.trim()&&(oe+=`&user_id=${encodeURIComponent(N.value.trim())}`);const xe=await G.get(oe);w.value=xe.results||[]}catch{w.value=[]}A.value=!1}}function y(){E.value="",S.value="",N.value="",w.value=null}function T($){return $?$.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function P($){return $==="user"?"bg-gray-900/50 border-gray-800":$==="assistant"?"bg-indigo-950/30 border-indigo-900/30":$==="summary"?"bg-amber-950/20 border-amber-900/30":$==="fts"?"bg-emerald-950/20 border-emerald-900/30":$==="channel"?"bg-purple-950/20 border-purple-900/30":"bg-gray-900/30 border-gray-800/50"}function W($){return $==="user"?"badge-info":$==="assistant"?"badge-success":$==="summary"?"badge-warning":$==="fts"?"badge-success":"badge-info"}async function R(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch($){s.value=$.message}t.value=!1}function F(){s.value=null,R()}async function Y($){if(n.value===$){n.value=null,a.value=null,x.value=new Set;return}n.value=$,a.value=null,i.value=!0,x.value=new Set;try{a.value=await G.get(`/api/sessions/${encodeURIComponent($)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Z($){const oe=new Set(o.value);oe.has($)?oe.delete($):oe.add($),o.value=oe}function te(){B.value?o.value=new Set:o.value=new Set(L.value.map($=>$.channel_id))}function X($){l.value=$}async function ge(){if(l.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await R()}catch($){s.value=$.message||"Failed to clear session"}r.value=!1,l.value=null}}function ie(){c.value=!0}async function de(){if(o.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await R()}catch($){s.value=$.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function j($,oe){const xe=G._token;let Me=`/api/sessions/${encodeURIComponent($)}/export?format=${oe}`;xe&&(Me+=`&token=${encodeURIComponent(xe)}`);const Je=document.createElement("a");Je.href=Me,Je.download=`session-${$}.${oe==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let ue=null;function Te($){$.payload&&$.payload.channel_id&&(clearTimeout(ue),ue=setTimeout(()=>{R(),n.value&&$.payload.channel_id===n.value&&G.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(oe=>{a.value=oe}).catch(()=>{})},2e3))}return $e(()=>{O(),R(),qe.subscribe("events",Te)}),ft(()=>{qe.unsubscribe("events",Te),clearTimeout(ue)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:B,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:L,hasActiveFilters:M,customPresets:k,showSavePreset:C,newPresetName:v,threadView:b,threads:J,collapsedThreads:x,ftsQuery:E,ftsChannelId:S,ftsUserId:N,ftsResults:w,ftsSearching:A,formatAge:pe,formatTimestamp:Q,formatFullTimestamp:ce,messageClass:Ie,threadMsgClass:q,roleBadge:re,roleDotClass:le,roleLabelClass:ve,truncateContent:be,threadSummary:V,fetchSessions:R,retry:F,toggleSession:Y,toggleSelect:Z,toggleSelectAll:te,confirmClear:X,clearSession:ge,confirmBulkClear:ie,doBulkClear:de,exportSession:j,applyPreset:D,applyCustomPreset:K,saveCustomPreset:fe,removeCustomPreset:ye,resetFilters:se,toggleThread:I,runFtsSearch:Oe,clearFtsSearch:y,highlightSnippet:T,ftsResultClass:P,ftsTypeBadge:W}}},aw={props:["trace"],template:`
...
`)}const dw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),k=h(null),C=h(!1),v=ee(()=>e.value.length),b=ee(()=>e.value.reduce((Q,ce)=>Q+(ce.execution_count||0),0)),x=ee(()=>e.value.reduce((Q,ce)=>Q+O(ce.code),0)),E=ee(()=>{if(!l.value)return e.value;const Q=l.value.toLowerCase();return e.value.filter(ce=>ce.name.toLowerCase().includes(Q)||(ce.description||"").toLowerCase().includes(Q))}),S=ee(()=>d.value?d.value.split(`
`).length:0),N=ee(()=>{const Q=Math.max(S.value,1);return Array.from({length:Q},(ce,Ie)=>Ie+1).join(`
`)}),w=ee(()=>{const Q=d.value.trim();return Q?Q.includes("SKILL_DEFINITION")?Q.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function A(Q){return cw(Q)}function O(Q){return Q?Q.split(`
`).length:0}function H(Q){return uw(Q)}function M(Q){n.value={...n.value,[Q]:!n.value[Q]}}async function L(Q){try{await navigator.clipboard.writeText(Q);const ce=e.value.find(Ie=>Ie.code===Q);ce&&(r.value=ce.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function J(Q){if(Q.key==="Tab"){Q.preventDefault();const ce=Q.target,Ie=ce.selectionStart,q=ce.selectionEnd;d.value=d.value.substring(0,Ie)+"    "+d.value.substring(q),Et(()=>{ce.selectionStart=ce.selectionEnd=Ie+4})}}function B(Q){const ce=Q.target.previousElementSibling;ce&&(ce.scrollTop=Q.target.scrollTop)}async function V(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(Q){s.value=Q.message}t.value=!1}async function I(Q){i.value=Q,delete a.value[Q],a.value={...a.value};try{const ce=await G.post(`/api/skills/${encodeURIComponent(Q)}/test`);a.value={...a.value,[Q]:ce}}catch(ce){a.value={...a.value,[Q]:{result:ce.message,is_error:!0}}}i.value=null}function D(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function K(Q){o.value=!0,c.value="edit",u.value=Q.name,d.value=Q.code||"",f.value=null,p.value=null}function fe(){o.value=!1,f.value=null,p.value=null}async function ye(){f.value=null,p.value=null;const Q=u.value.trim(),ce=d.value.trim();if(!Q){f.value="Name is required";return}if(!ce){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:Q,code:ce}),p.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(Q)}`,{code:ce}),p.value="Skill updated successfully"),await V(),setTimeout(()=>{o.value=!1},800)}catch(Ie){f.value=Ie.message}m.value=!1}function se(Q){k.value=Q}async function pe(){if(k.value){C.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(k.value)}`),await V()}catch{}C.value=!1,k.value=null}}return $e(()=>{V()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:k,deleting:C,enabledCount:v,totalExecutions:b,totalLines:x,displayedSkills:E,editLineCount:S,editorLineNums:N,editValidation:w,highlight:A,truncate:_c,formatTs:Ta,countLines:O,getLineNumbers:H,toggleCode:M,copyCode:L,handleEditorKey:J,syncScroll:B,fetchSkills:V,testSkill:I,showCreate:D,editSkill:K,cancelEdit:fe,saveSkill:ye,confirmDelete:se,doDelete:pe}}};function fw(e,t){if(!e||!t)return pd(e);const s=pd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const pw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let k=null;const C=h(null),v=h(!1),b=h({}),x=h({}),E=h(null),S=h(null),N=ee(()=>e.value.reduce((D,K)=>D+(K.chunks||0),0)),w=ee(()=>new Set(e.value.map(K=>K.uploader).filter(Boolean)).size);function A(D,K){const fe=x.value[K];if(!fe||fe.length===0)return 0;const ye=Math.max(...fe.map(se=>se.char_count||0));return ye===0?0:Math.round(D.char_count/ye*100)}async function O(){t.value=!0,s.value=null;try{const D=await G.get("/api/knowledge");e.value=Array.isArray(D)?D:[]}catch(D){s.value=D.message}t.value=!1}async function H(D){if(b.value[D]){b.value[D]=!1,S.value=null;return}if(b.value[D]=!0,!(x.value[D]||E.value===D)){E.value=D;try{const K=await G.get(`/api/knowledge/${encodeURIComponent(D)}/chunks`);x.value[D]=Array.isArray(K)?K:[]}catch(K){x.value[D]=[],_e.error(`Failed to load chunks: ${K.message}`)}E.value=null}}async function M(){const D=n.value.trim();if(D){i.value=!0,r.value=null,l.value=D;try{const K=await G.get(`/api/knowledge/search?q=${encodeURIComponent(D)}`);a.value=Array.isArray(K)?K:[]}catch(K){a.value=[],r.value=K.message||"Search failed"}i.value=!1}}function L(){a.value=null,n.value="",r.value=null}async function J(){d.value=null,f.value=null;const D=c.value.trim(),K=u.value.trim();if(!D){d.value="Source name is required";return}if(!K){d.value="Content is required";return}p.value=!0;try{const fe=await G.post("/api/knowledge",{source:D,content:K});f.value=`Ingested ${fe.chunks||0} chunks from "${D}"`,c.value="",u.value="",x.value={},await O(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(fe){d.value=fe.message}p.value=!1}async function B(D){m.value=D,g.value=null,k&&(clearTimeout(k),k=null);try{const K=await G.post(`/api/knowledge/${encodeURIComponent(D)}/reingest`);g.value={source:D,error:!1,message:`Re-ingested ${K.chunks||0} chunks`},delete x.value[D],await O(),k=setTimeout(()=>{g.value=null,k=null},3e3)}catch(K){g.value={source:D,error:!0,message:K.message}}m.value=null}function V(D){C.value=D}async function I(){if(C.value){v.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(C.value)}`),delete x.value[C.value],await O()}catch{}v.value=!1,C.value=null}}return $e(()=>{O()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:C,deleting:v,expanded:b,sourceChunks:x,loadingChunks:E,selectedChunk:S,totalChunks:N,uploaderCount:w,truncate:_c,formatTs:Ta,highlightTerms:fw,chunkBarWidth:A,fetchSources:O,toggleSource:H,doSearch:M,clearSearch:L,doIngest:J,doReingest:B,confirmDelete:V,doDelete:I}}},hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),k=h(null),C=h(new Set),v=h(null),b=h(!1),x=h(!1),E=ee(()=>e.value.reduce((se,pe)=>se+pe.count,0)),S=ee(()=>C.value.size);function N(se){const pe=t.value[se];if(!pe)return[];if(!l.value.trim())return pe;const Q=l.value.trim().toLowerCase();return pe.filter(ce=>ce.key.toLowerCase().includes(Q)||ce.value&&ce.value.toLowerCase().includes(Q))}function w(se,pe){return C.value.has(se+"/"+pe)}function A(se,pe){const Q=se+"/"+pe,ce=new Set(C.value);ce.has(Q)?ce.delete(Q):ce.add(Q),C.value=ce}function O(se){const pe=t.value[se];return!pe||pe.length===0?!1:pe.every(Q=>C.value.has(se+"/"+Q.key))}function H(se,pe){const Q=t.value[se];if(!Q)return;const ce=new Set(C.value);for(const Ie of Q){const q=se+"/"+Ie.key;pe?ce.add(q):ce.delete(q)}C.value=ce}async function M(){s.value=!0,n.value=null;try{const se=await G.get("/api/memory");e.value=Object.entries(se).map(([pe,Q])=>({name:pe,keys:Q.keys||[],count:Q.count||0}))}catch(se){n.value=se.message}s.value=!1}async function L(se){if(a.value[se]){a.value[se]=!1;return}a.value[se]=!0;const pe=e.value.find(ce=>ce.name===se);if(!pe||t.value[se]||i.value===se)return;i.value=se;const Q=await Promise.all(pe.keys.map(async ce=>{try{const Ie=await G.get(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(ce)}`);return{key:ce,value:Ie.value||""}}catch{return{key:ce,value:"(error loading)"}}}));t.value[se]=Q,i.value=null}function J(se,pe,Q){f.value=se+"/"+pe,p.value=Q}async function B(se,pe){m.value=!0,g.value=null;try{await G.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(pe)}`,{value:p.value});const Q=t.value[se];if(Q){const ce=Q.find(Ie=>Ie.key===pe);ce&&(ce.value=p.value)}f.value=null}catch(Q){g.value=`Failed to save: ${Q.message||"unknown error"}`}m.value=!1}async function V(se,pe){try{await navigator.clipboard.writeText(pe.value),k.value=se+"/"+pe.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function I(){u.value=null,d.value=null;const se=o.value.scope.trim(),pe=o.value.key.trim(),Q=o.value.value.trim();if(!se){u.value="Scope is required";return}if(!pe){u.value="Key is required";return}if(!Q){u.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(pe)}`,{value:Q}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await M(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(ce){u.value=ce.message}c.value=!1}function D(se,pe){v.value={scope:se,key:pe}}async function K(){if(!v.value)return;b.value=!0,g.value=null;const{scope:se,key:pe}=v.value;try{await G.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(pe)}`);const Q=t.value[se];Q&&(t.value[se]=Q.filter(q=>q.key!==pe));const ce=e.value.find(q=>q.name===se);ce&&(ce.count--,ce.keys=ce.keys.filter(q=>q!==pe));const Ie=new Set(C.value);Ie.delete(se+"/"+pe),C.value=Ie}catch(Q){g.value=`Failed to delete: ${Q.message||"unknown error"}`}b.value=!1,v.value=null}function fe(){x.value=!0}async function ye(){b.value=!0,g.value=null;const se=[];for(const pe of C.value){const Q=pe.indexOf("/");se.push({scope:pe.slice(0,Q),key:pe.slice(Q+1)})}try{await G.post("/api/memory/bulk-delete",{entries:se}),C.value=new Set,t.value={},await M()}catch(pe){g.value=`Bulk delete failed: ${pe.message||"unknown error"}`}b.value=!1,x.value=!1}return $e(()=>{M()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:k,selected:C,selectedCount:S,totalEntries:E,deleteTarget:v,deleting:b,showBulkDelete:x,fetchMemory:M,toggleScope:L,startEdit:J,doEdit:B,copyValue:V,doAdd:I,confirmDelete:D,doDelete:K,confirmBulkDelete:fe,doBulkDelete:ye,isSelected:w,toggleSelect:A,isScopeAllSelected:O,toggleSelectAll:H,filteredEntries:N}}},gw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=ee(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=ee(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await G.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return $e(()=>{c(),i=setInterval(c,3e4)}),ft(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:Wh,refresh:u,retry:d}}},ww=["INFO","WARNING","ERROR"],Sw=[{id:"all",name:"All Logs",icon:"☰",filters:{}},{id:"errors",name:"Errors Only",icon:"❌",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"⚠",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"🔧",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"🔥",filters:{level:"ERROR",timeRange:"last_1h"}}],Mr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Tw=[50,100,200,500],Cw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(qe.state||"disconnected"),c=ee(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,m=ww,g=Sw,k=Mr,C=h("all"),v=h(""),b=h([]),x=h(!1),E=h(""),S=h([]);function N(){try{const U=localStorage.getItem("odin-log-presets");U&&(b.value=JSON.parse(U))}catch{}}function w(){try{localStorage.setItem("odin-log-presets",JSON.stringify(b.value))}catch{}}const A=ee(()=>a.value!==""||i.value.trim()!==""||v.value!==""),O=ee(()=>{const U=Mr.find(ne=>ne.value===v.value);return U?U.label:""}),H=ee(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(U){return U.message}}),M=24,L=ee(()=>{if(t.value.length===0)return[];const U=[],ne=new Date,ke=3600*1e3;for(let Qe=M-1;Qe>=0;Qe--){const nt=new Date(ne.getTime()-(Qe+1)*ke),Nt=new Date(ne.getTime()-Qe*ke);U.push({start:nt,end:Nt,label:I(nt,Nt),shortLabel:Nt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Qe of t.value){if(!Qe._time)continue;const nt=Qe._time.getTime();for(const Nt of U)if(nt>=Nt.start.getTime()&&nt<Nt.end.getTime()){Nt.total++,Qe.level==="ERROR"?Nt.errors++:Qe.level==="WARNING"?Nt.warnings++:Nt.info++;break}}return U}),J=ee(()=>{let U=1;for(const ne of L.value)ne.total>U&&(U=ne.total);return U}),B=ee(()=>L.value.length===0?"":"Last 24 hours"),V=ee(()=>Math.ceil(M/8));function I(U,ne){const ke={hour:"2-digit",minute:"2-digit"};return U.toLocaleTimeString([],ke)+" - "+ne.toLocaleTimeString([],ke)}function D(U,ne){return!ne||!U?"0px":Math.max(2,U/ne*100)+"%"}function K(U){const ne=fe.value.findIndex(ke=>ke._time&&ke._time.getTime()>=U.start.getTime()&&ke._time.getTime()<U.end.getTime());if(ne>=0&&u.value){const ke=u.value.querySelectorAll(".log-line");ke[ne]&&(ke[ne].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const fe=ee(()=>{let U=t.value;if(a.value&&(U=U.filter(ne=>(ne.level||"INFO")===a.value)),v.value){const ne=Mr.find(ke=>ke.value===v.value);if(ne&&ne.seconds){const ke=new Date(Date.now()-ne.seconds*1e3);U=U.filter(Qe=>Qe._time&&Qe._time>=ke)}}if(i.value&&!H.value)if(l.value)try{const ne=new RegExp(i.value,"i");U=U.filter(ke=>{const Qe=ke.text||ke.raw||"",nt=ke.tool||"";return ne.test(Qe)||ne.test(nt)})}catch{}else{const ne=i.value.toLowerCase();U=U.filter(ke=>{const Qe=(ke.text||ke.raw||"").toLowerCase(),nt=(ke.tool||"").toLowerCase();return Qe.includes(ne)||nt.includes(ne)})}return U});function ye(U){if(U.type==="log"&&U.line)try{const ne=typeof U.line=="string"?JSON.parse(U.line):U.line,ke=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:ke.toLocaleTimeString(),_time:ke,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(U.line),tool:"",raw:String(U.line)}}if(U.payload){const ne=U.payload,ke=ne.timestamp?new Date(ne.timestamp):new Date;return{ts:ke.toLocaleTimeString(),_time:ke,level:ne.error?"ERROR":"INFO",text:ne.tool_name?`[${ne.tool_name}] ${ne.result_summary||""}`.trim():ne.message||JSON.stringify(ne),tool:ne.tool_name||"",raw:null}}return typeof U=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:U,tool:"",raw:U}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(U),tool:"",raw:null}}function se(U){const ne=ye(U);if(s.value){S.value.push(ne);return}pe(ne)}function pe(U){t.value.push(U),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&Et(()=>Q())}function Q(){const U=u.value;if(U){const ne=U.scrollHeight-U.scrollTop-U.clientHeight;U.scrollTo({top:U.scrollHeight,behavior:ne<500?"smooth":"instant"})}}function ce(){n.value=!0,d.value=!1,Et(()=>Q())}function Ie(){const U=u.value;if(!U)return;const ne=U.scrollHeight-U.scrollTop-U.clientHeight<40;d.value=!ne&&t.value.length>0,!ne&&n.value&&(n.value=!1)}function q(){if(s.value=!s.value,!s.value&&S.value.length>0){for(const U of S.value)pe(U);S.value=[]}}function re(){t.value=[],S.value=[],d.value=!1}function le(){let U;e.value==="search"?U=oe.value.map(nt=>{const Nt=nt.error?"ERROR":"INFO",lr=nt.tool_name?`[${nt.tool_name}] `:"";return`${nt.timestamp||""} ${Nt} ${lr}${nt.result_summary||nt.message||""}`}).join(`
`):U=fe.value.map(nt=>`${nt.ts} ${nt.level} ${nt.text}`).join(`
`);const ne=new Blob([U],{type:"text/plain"}),ke=URL.createObjectURL(ne),Qe=document.createElement("a");Qe.href=ke,Qe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Qe.click(),URL.revokeObjectURL(ke)}function ve(U,ne){const ke=`${U.ts} ${U.level} ${U.text||U.raw||""}`;navigator.clipboard.writeText(ke).then(()=>{f.value=ne,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function be(U){a.value=a.value===U?"":U,C.value="all"}function Oe(U){return U.level==="ERROR"?"log-line-error":U.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(U){return U==="ERROR"?"text-red-500 font-semibold":U==="WARNING"?"text-yellow-500":"text-blue-500"}function T(U){return U==="ERROR"?"log-chip-error":U==="WARNING"?"log-chip-warning":"log-chip-info"}function P(U){C.value=U.id;const ne=U.filters;a.value=ne.level||"",v.value=ne.timeRange||"",i.value=ne.text||"",ne.levels&&(a.value=ne.levels[0]||""),ne.hasToolName&&(i.value="")}function W(U){C.value=U.id,a.value=U.filters.level||"",v.value=U.filters.timeRange||"",i.value=U.filters.text||""}function R(){if(!E.value.trim())return;const U={id:"custom-"+Date.now(),name:E.value.trim(),filters:{level:a.value,timeRange:v.value,text:i.value}};b.value=[...b.value,U],w(),x.value=!1,E.value=""}function F(U){b.value=b.value.filter(ne=>ne.id!==U),w(),C.value===U&&(C.value="all")}const Y=h("all"),Z=h(""),te=h(""),X=h(""),ge=h(""),ie=h(""),de=h(100),j=Tw,ue=h(!1),Te=h(!1),$=h(""),oe=h([]),xe=h(null),Me=h(null);function Je(){e.value="search",xe.value||Ge()}async function Ge(){try{xe.value=await G.get("/api/logs/stats")}catch{}}function St(){const U=ie.value;if(!U){X.value="",ge.value="";return}const ke={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[U];if(ke){const Qe=new Date(Date.now()-ke*1e3);X.value=st(Qe),ge.value=""}}function st(U){const ne=ke=>String(ke).padStart(2,"0");return`${U.getFullYear()}-${ne(U.getMonth()+1)}-${ne(U.getDate())}T${ne(U.getHours())}:${ne(U.getMinutes())}`}function Ye(U){if(!U)return"";const ne=new Date(U);return isNaN(ne.getTime())?"":ne.toISOString()}async function en(){ue.value=!0,$.value="",Te.value=!0,Me.value=null;try{const U=new URLSearchParams;Y.value&&Y.value!=="all"&&U.set("level",Y.value),Z.value&&U.set("tool",Z.value),te.value&&U.set("q",te.value);const ne=Ye(X.value),ke=Ye(ge.value);ne&&U.set("start",ne),ke&&U.set("end",ke),U.set("limit",String(de.value));const Qe=await G.get(`/api/logs/search?${U.toString()}`);oe.value=Qe.entries||[]}catch(U){$.value=U.message||"Search failed",oe.value=[]}finally{ue.value=!1}}function mn(){Y.value="all",Z.value="",te.value="",X.value="",ge.value="",ie.value="",de.value=100,oe.value=[],Te.value=!1,$.value="",Me.value=null}function Ai(U){Me.value=Me.value===U?null:U}function Ea(U){if(!U.timestamp)return"";try{return new Date(U.timestamp).toLocaleString()}catch{return U.timestamp}}function Ri(U){return U.type==="web_action"?`${U.status||""} (${U.execution_time_ms||0}ms)`:(U.result_summary||"").slice(0,200)}function Hn(U){return U.error?"log-line-error":"text-gray-300"}function jn(U){try{return JSON.stringify(U,null,2)}catch{return String(U)}}let Kt=null;return $e(()=>{N(),qe.subscribe("logs",se),r.value=qe.connected,o.value=qe.state||"disconnected",Kt=qe.onStateChange;const U=qe.onStateChange;qe.onStateChange=(ne,ke)=>{o.value=ne,r.value=ne==="connected",U&&U(ne,ke)}}),ft(()=>{qe.unsubscribe("logs",se),Kt!==void 0&&(qe.onStateChange=Kt)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:fe,pauseBuffer:S,showJumpBottom:d,copiedIndex:f,regexError:H,levels:m,logPresets:g,timeRanges:k,timeRange:v,activeLogPreset:C,customLogPresets:b,showSaveLogPreset:x,newLogPresetName:E,hasActiveLogFilters:A,timeRangeLabel:O,timelineBuckets:L,timelineMax:J,timelineSpanLabel:B,timelineLabelSkip:V,togglePause:q,clearLogs:re,exportLogs:le,logLineClass:Oe,levelClass:y,levelChipClass:T,toggleLevel:be,copyLine:ve,jumpToBottom:ce,onScroll:Ie,applyLogPreset:P,applyCustomLogPreset:W,saveLogCustomPreset:R,removeLogCustomPreset:F,segmentHeight:D,jumpToTimelineBucket:K,searchLevel:Y,searchTool:Z,searchKeyword:te,searchStart:X,searchEnd:ge,searchTimePreset:ie,searchLimit:de,searchLimits:j,searching:ue,searchRan:Te,searchError:$,searchResults:oe,searchStats:xe,expandedSearch:Me,switchToSearch:Je,runSearch:en,clearSearchFilters:mn,toggleSearchExpand:Ai,formatSearchTs:Ea,searchEntryText:Ri,searchLogLineClass:Hn,formatJson:jn,applySearchTimePreset:St}}},Ew=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Aw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Rw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1“128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Fr=[{key:"core",label:"Core",icon:"⚙",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"🧠",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"💾",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"🔗",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"🛠",sections:["tools"]},{key:"ui",label:"Web UI",icon:"🌐",sections:["web"]},{key:"automation",label:"Automation",icon:"🔄",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"🔌",sections:["issue_tracker"]}],cg="••••••••",Iw=50;function Nw(e){return Ew.has(e)}function Dw(e){return e===cg}function Ki(e){return JSON.parse(JSON.stringify(e))}function Nn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ow(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Nn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Lw(e,t,s){const n=Rw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function Fd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Nn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Nn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Pw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=ee(()=>d.value.length>0),m=ee(()=>f.value.length>0),g=ee(()=>r.value&&t.value?t.value:e.value),k=ee(()=>!e.value||!t.value?!1:!Nn(e.value,t.value)),C=ee(()=>!e.value||!t.value?0:Fd(e.value,t.value).length),v=ee(()=>{if(!r.value||!t.value)return{};const R={};for(const F of Object.keys(t.value)){const Y=t.value[F];if(typeof Y=="object"&&Y!==null&&!Array.isArray(Y))for(const Z of Object.keys(Y)){const te=Lw(F,Z,Y[Z]);te&&(R[F+"."+Z]=te)}}return R}),b=ee(()=>Object.keys(v.value).length>0),x=ee(()=>e.value?Object.keys(e.value).length:0),E=ee(()=>N.value.length),S=ee(()=>!e.value||!t.value?[]:Fd(e.value,t.value)),N=ee(()=>e.value?Fr.map(R=>({...R,sections:R.sections.filter(F=>F in e.value)})).filter(R=>R.sections.length>0):[]),w=ee(()=>{if(!e.value)return[];const R=new Set(Fr.flatMap(F=>F.sections));return Object.keys(e.value).filter(F=>!R.has(F))});function A(R){return g.value?g.value[R]:null}function O(R){return!e.value||!t.value?!1:!Nn(e.value[R],t.value[R])}function H(R){return R.sections.some(F=>O(F))}function M(R,F){if(!e.value||!t.value)return!1;const Y=e.value[R],Z=t.value[R];return!Y||!Z?!1:!Nn(Y[F],Z[F])}function L(R){return t.value?t.value[R]:e.value[R]}function J(R,F){const Y=t.value||e.value;return Y[R]?Y[R][F]:void 0}function B(R,F){const Y=r.value&&t.value?t.value:e.value;return Y[R]?Y[R][F]:!1}function V(R,F){return v.value[R+"."+F]||null}function I(R,F){return Aw[R+"."+F]||null}function D(R,F,Y){t.value&&(F===null?t.value[R]=Y:(t.value[R]||(t.value[R]={}),t.value[R][F]=Y),t.value={...t.value})}function K(R,F,Y){if(!t.value)return;const Z=Ki(t.value);D(R,F,Y),d.value.push(Z),d.value.length>Iw&&d.value.shift(),f.value=[]}function fe(R,F,Y){try{const Z=JSON.parse(Y);K(R,F,Z)}catch{}}function ye(){d.value.length!==0&&(f.value.push(Ki(t.value)),t.value=d.value.pop())}function se(){f.value.length!==0&&(d.value.push(Ki(t.value)),t.value=f.value.pop())}function pe(R,F,Y){if(!t.value||!t.value[R])return;const Z=[...t.value[R][F]];Z.splice(Y,1),K(R,F,Z)}function Q(R,F){if(!t.value||!t.value[R])return;const Y=[...t.value[R][F]||[]],Z=prompt("Enter new value:");Z!==null&&(Y.push(Z),K(R,F,Y))}function ce(R){a.value={...a.value,[R]:!a.value[R]}}function Ie(R){l.value={...l.value,[R]:!l.value[R]}}function q(R){i.value={...i.value,[R]:!i.value[R]}}function re(R){try{return JSON.stringify(R,null,2)}catch{return String(R)}}function le(R){return R==null?"null":typeof R=="object"?JSON.stringify(R,null,2):String(R)}function ve(R,F){c.value={type:R,message:F},setTimeout(()=>{c.value=null},3e3)}function be(){t.value=Ki(e.value),r.value=!0,d.value=[],f.value=[]}function Oe(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function T(){if(!(!k.value||b.value)){o.value=!0;try{const R=Ow(e.value,t.value);if(Object.keys(R).length===0){ve("success","No changes to save."),o.value=!1;return}const F=await G.put("/api/config",R);e.value=F,r.value=!1,t.value=null,d.value=[],f.value=[],ve("success","Config saved successfully.")}catch(R){ve("error",R.message||"Failed to save config")}o.value=!1}}async function P(){s.value=!0,n.value=null;try{e.value=await G.get("/api/config");for(const R of Object.keys(e.value))a.value[R]===void 0&&(a.value[R]=!0);for(const R of Fr)l.value[R.key]===void 0&&(l.value[R.key]=!0)}catch(R){n.value=R.message}s.value=!1}function W(R){r.value&&((R.ctrlKey||R.metaKey)&&!R.shiftKey&&R.key==="z"?(R.preventDefault(),ye()):(R.ctrlKey||R.metaKey)&&(R.key==="y"||R.shiftKey&&R.key==="z"||R.shiftKey&&R.key==="Z")&&(R.preventDefault(),se()))}return $e(()=>{P(),document.addEventListener("keydown",W)}),ft(()=>{document.removeEventListener("keydown",W)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:b,changeCount:C,REDACTED:cg,showDiffModal:u,diffEntries:S,canUndo:p,canRedo:m,sectionCount:x,groupCount:E,visibleGroups:N,ungroupedSections:w,validationErrors:v,isSensitiveKey:Nw,isRedacted:Dw,sectionChanged:O,groupChanged:H,fieldChanged:M,getDisplay:A,getEdited:L,getEditedField:J,getDisplayBool:B,pushEdit:K,pushEditJson:fe,getValidationError:V,getEnumOptions:I,removeArrayItem:pe,addArrayItem:Q,toggleSection:ce,toggleGroup:Ie,toggleNested:q,formatJson:re,formatDiffVal:le,showToast:ve,showDiff:y,fetchConfig:P,startEdit:be,cancelEdit:Oe,saveConfig:T,undo:ye,redo:se}}},Mw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=ee(()=>{const I={};for(const D of u.value)I[D.id]=D;return I});function p(I){return f.value[I]||null}const m=ee(()=>/^\d{15,25}$/.test(r.value.trim())),g=ee(()=>{const I=r.value.toLowerCase().trim();return I?u.value.filter(D=>!i.value[D.id]&&(D.display_name.toLowerCase().includes(I)||D.username.toLowerCase().includes(I)||D.id.includes(I))):u.value.filter(D=>!i.value[D.id])});function k(I,D){return I?I.allowed_hosts===null||I.allowed_hosts===void 0?{allowed_hosts:[...D],default_host:I.default_host||"",allow_all:!0}:{allowed_hosts:I.allowed_hosts,default_host:I.default_host||"",allow_all:!1}:{allowed_hosts:[...D],default_host:D[0]||"",allow_all:!0}}async function C(){e.value=!0,t.value="";try{const I=await G.get("/api/host-access");s.value=I,n.value=I.available_hosts||[],a.value=k(I.default_policy,n.value);const D=I.users||{},K={};for(const[fe,ye]of Object.entries(D))K[fe]=k(ye,n.value);i.value=K}catch(I){t.value=I.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await G.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const I=a.value.allow_all?null:a.value.allowed_hosts;await G.put("/api/host-access/default-policy",{allowed_hosts:I,default_host:a.value.default_host}),_e.success("Default policy updated")}catch(I){_e.error(I.message||"Failed to save")}}function b(I,D){a.value.allow_all=!1,D?a.value.allowed_hosts.includes(I)||a.value.allowed_hosts.push(I):(a.value.allowed_hosts=a.value.allowed_hosts.filter(K=>K!==I),a.value.default_host===I&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function x(I){const D=i.value[I];if(D)try{const K=D.allow_all?null:D.allowed_hosts;await G.put(`/api/host-access/user/${I}`,{allowed_hosts:K,default_host:D.default_host});const fe=p(I);_e.success(`Updated access for ${fe?fe.display_name:I}`)}catch(K){_e.error(K.message||"Failed to save")}}function E(I,D,K){const fe=i.value[I];fe&&(fe.allow_all=!1,K?fe.allowed_hosts.includes(D)||fe.allowed_hosts.push(D):(fe.allowed_hosts=fe.allowed_hosts.filter(ye=>ye!==D),fe.default_host===D&&(fe.default_host=fe.allowed_hosts[0]||"")),x(I))}function S(I,D){const K=i.value[I];K&&(K.default_host=D,x(I))}function N(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function w(){o.value=!0,c.value=0}function A(){c.value<g.value.length-1&&c.value++}function O(){c.value>0&&c.value--}function H(){const I=g.value[c.value];if(I){L(I);return}m.value&&M()}function M(){const I=r.value.trim();/^\d{15,25}$/.test(I)&&(i.value[I]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(I),r.value="",o.value=!1,l.value=!1)}function L(I){i.value[I.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},x(I.id),r.value="",o.value=!1,l.value=!1}function J(){o.value=!1}function B(){setTimeout(()=>{o.value=!1},150)}async function V(I){const D=p(I);if(await ns({title:"Remove user override",message:`Remove the host access override for ${D?D.display_name:I}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await G.del(`/api/host-access/user/${I}`),delete i.value[I],_e.success(`Removed override for ${D?D.display_name:I}`)}catch(fe){_e.error(fe.message||"Failed to delete")}}return $e(C),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:g,isRawId:m,searchInput:d,fetchData:C,saveDefaultPolicy:v,toggleDefaultHost:b,getMember:p,toggleUserHost:E,setUserDefault:S,openAddUser:N,deleteUser:V,onSearchInput:w,highlightNext:A,highlightPrev:O,selectHighlighted:H,selectMember:L,closeDropdown:J,onBlur:B,addRawId:M}}},$w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=ee(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=ee(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(w){return w==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":w==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const w=await G.get("/api/tokens");s.value=w.tokens||[],n.value=w.available_hosts||[]}catch(w){t.value=w.message||"Failed to load tokens"}finally{e.value=!1}}function g(w){return!w||!w.trim()?[]:w.split(",").map(A=>A.trim()).filter(Boolean)}function k(w,A){const O=c.value.allowed_hosts;if(A&&!O.includes(w)&&O.push(w),!A){const H=O.indexOf(w);H>=0&&O.splice(H,1)}}function C(w,A){const O=u.value.allowed_hosts;if(A&&!O.includes(w)&&O.push(w),!A){const H=O.indexOf(w);H>=0&&O.splice(H,1)}}async function v(){var w;i.value=!0;try{const A=g(c.value.allowed_tools_str),O=c.value.host_mode,H=O==="none"?[]:O==="select"?c.value.allowed_hosts:null,M={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:A.length?A:[]};H!==null&&(M.allowed_hosts=H),M.default_host=c.value.default_host||"";const L=await G.post("/api/tokens",M);l.value=L.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,_e.success("Token created"),await m()}catch(A){_e.error(((w=A.data)==null?void 0:w.error)||A.message||"Failed to create token")}finally{i.value=!1}}function b(w){r.value=w;const A=w.allowed_hosts;let O="default";A==null?O="default":Array.isArray(A)&&A.length===0?O="none":Array.isArray(A)&&(O="select"),u.value={username:w.username||"",tier:w.tier||"admin",label:w.label||"",host_mode:O,allowed_hosts:Array.isArray(A)?[...A]:[],default_host:w.default_host||"",allowed_tools_str:(w.allowed_tools||[]).join(", ")}}async function x(){var w;if(r.value){o.value=!0;try{const A=g(u.value.allowed_tools_str),O=u.value.host_mode,H={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:A};O==="none"?H.allowed_hosts=[]:O==="select"?H.allowed_hosts=u.value.allowed_hosts:H.allowed_hosts=null,H.default_host=u.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,_e.success("Token updated"),await m()}catch(A){_e.error(((w=A.data)==null?void 0:w.error)||A.message||"Failed to update")}finally{o.value=!1}}}async function E(w){var O;if(await ns({title:"Regenerate token",message:`Regenerate token for ${w.username||w.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await G.post("/api/tokens/"+encodeURIComponent(w.user_id)+"/regenerate");l.value=H.token,_e.success("Token regenerated")}catch(H){_e.error(((O=H.data)==null?void 0:O.error)||H.message||"Failed to regenerate")}}async function S(w){var O;if(await ns({title:"Delete token",message:`Delete token for ${w.username||w.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(w.user_id)),_e.success("Token deleted"),await m()}catch(H){_e.error(((O=H.data)==null?void 0:O.error)||H.message||"Failed to delete")}}async function N(){if(l.value)try{await navigator.clipboard.writeText(l.value),_e.success("Copied to clipboard")}catch{_e.error("Copy failed — select and copy manually")}}return $e(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:k,toggleEditHost:C,createToken:v,startEdit:b,saveEdit:x,confirmRegenerate:E,confirmDelete:S,copyToken:N}}};function $r(e,t=500){let s=null;return(...n)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...n)},t)}}const Bw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium"}),a=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),i=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),l=h(!1),r=h(!1),o=h(!1),c=h(!1),u=h(!1),d=h(!1),f=h(!1),p=h({configured:!1}),m=h([]),g=h(""),k=h(!1),C=h(!1),v=h({configured:!1}),b=h([]),x=h(""),E=h(!1),S=h(!1),N=h(!0),w=h(""),A=h({configured:!1,accounts:[]}),O=h(null),H=h(null),M=h(""),L=h(null),J=h(!1),B=h(null),V=h(null),I=h("");let D=null;function K(j,ue="success"){_e(j,ue==="error"?"error":"success")}function fe(j){if(!j)return"?";const ue=j/(1024*1024*1024);return ue>=1?ue.toFixed(1)+" GB":(j/(1024*1024)).toFixed(0)+" MB"}async function ye(){e.value=!0,await Promise.all([se(),pe(),le(),Q()]),e.value=!1}async function se(){try{const j=await G.get("/api/llm/status");t.value=j,s.value=j.active_provider||"codex",j.codex&&(n.value.enabled=j.codex.enabled,n.value.model=j.codex.model||"gpt-5.5",n.value.reasoning_effort=j.codex.reasoning_effort||"medium",n.value.max_tokens=j.codex.max_tokens||4096),j.ollama&&(a.value.enabled=j.ollama.enabled,a.value.base_url=j.ollama.base_url||"",a.value.model=j.ollama.model||"",a.value.max_tokens=j.ollama.max_tokens||4096),j.kimi&&(i.value.enabled=j.kimi.enabled,i.value.model=j.kimi.model||"",i.value.max_tokens=j.kimi.max_tokens||4096)}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function pe(){try{if(p.value=await G.get("/api/ollama/status"),p.value.model&&(g.value=p.value.model),p.value.configured)try{const j=await G.get("/api/ollama/models");m.value=j.models||[]}catch{m.value=[]}else if(a.value.base_url)try{const j=await G.post("/api/ollama/probe-models",{base_url:a.value.base_url});m.value=j.models||[]}catch{m.value=[]}}catch{p.value={configured:!1}}}async function Q(){N.value=!0,w.value="";try{A.value=await G.get("/api/codex/status")}catch(j){w.value=j.message||"Failed to fetch Codex status"}finally{N.value=!1}}async function ce(){const j=t.value?t.value.active_provider:"codex";f.value=!0;try{const ue=await G.post("/api/llm/switch",{provider:s.value});ue.error?(s.value=j,K(ue.error,"error")):(K("Switched to "+s.value+" ("+ue.model+")"),await ye())}catch(ue){s.value=j,K(ue.message||"Switch failed","error")}finally{f.value=!1}}async function Ie(){k.value=!0;try{const j=await G.post("/api/ollama/reload");K(j.configured?"Ollama reloaded":j.reason||"Ollama not configured",j.configured?"success":"error"),await ye()}catch(j){K(j.message||"Reload failed","error")}finally{k.value=!1}}async function q(){C.value=!0;try{await G.post("/api/ollama/model",{model:g.value}),K("Model set to "+g.value),await ye()}catch(j){K(j.message||"Failed","error")}finally{C.value=!1}}async function re(){const j=a.value.base_url;if(!j){K("Enter a base URL first","error");return}d.value=!0;try{const ue=await G.post("/api/ollama/probe-models",{base_url:j});m.value=ue.models||[],m.value.length?(K(m.value.length+" model(s) found"),!a.value.model&&m.value.length&&(a.value.model=m.value[0].name)):K("No models found at "+j,"error")}catch(ue){K(ue.message||"Could not reach Ollama","error")}finally{d.value=!1}}async function le(){try{if(v.value=await G.get("/api/kimi/status"),v.value.model&&(x.value=v.value.model),v.value.configured)try{const j=await G.get("/api/kimi/models");b.value=j.models||[]}catch{b.value=[]}}catch{v.value={configured:!1}}}async function ve(){E.value=!0;try{const j=await G.post("/api/kimi/reload");K(j.configured?"Kimi reloaded":j.reason||"Kimi not configured",j.configured?"success":"error"),await ye()}catch(j){K(j.message||"Reload failed","error")}finally{E.value=!1}}async function be(){S.value=!0;try{await G.post("/api/kimi/model",{model:x.value}),K("Model set to "+x.value),await ye()}catch(j){K(j.message||"Failed","error")}finally{S.value=!1}}async function Oe(){o.value=!0;try{await G.put("/api/llm/codex/config",n.value),K("Codex config saved"),await Promise.all([se(),Q()])}catch(j){K(j.message||"Failed","error"),await Promise.all([se(),Q()])}finally{o.value=!1}}async function y(){c.value=!0;try{const j={...a.value};l.value||delete j.api_key,await G.put("/api/llm/ollama/config",j),K("Ollama config saved"),a.value.api_key="",l.value=!1,await Promise.all([se(),pe()])}catch(j){K(j.message||"Failed","error")}finally{c.value=!1}}async function T(){u.value=!0;try{const j={...i.value};r.value||delete j.api_key,await G.put("/api/llm/kimi/config",j),K("Kimi config saved"),i.value.api_key="",r.value=!1,await Promise.all([se(),le()])}catch(j){K(j.message||"Failed","error")}finally{u.value=!1}}const P=$r(Oe),W=$r(y),R=$r(T);async function F(j){try{await G.post("/api/codex/account/"+j+"/activate"),K("Active account switched"),await Q()}catch(ue){K(ue.message||"Failed","error")}}async function Y(j){O.value=j;try{await G.post("/api/codex/account/"+j+"/refresh"),K("Token refreshed"),await Q()}catch(ue){K(ue.message||"Refresh failed","error")}finally{O.value=null}}function Z(j,ue){H.value=j,M.value=ue||""}async function te(j){try{await G.put("/api/codex/account/"+j+"/label",{label:M.value}),K("Label updated"),H.value=null,await Q()}catch(ue){K(ue.message||"Failed","error")}}async function X(j,ue){if(await ns({title:"Delete Codex account",message:`Delete ${ue||"account #"+(j+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/codex/account/"+j),K("Deleted. Pool reloaded."),await Q()}catch($){K($.message||"Failed","error")}}async function ge(){J.value=!0;try{const j=await G.post("/api/codex/device-code");B.value=j,L.value="pending",ie(j)}catch(j){K(j.message||"Failed","error")}finally{J.value=!1}}async function ie(j){D={cancelled:!1};const ue=D;try{const Te=await G.post("/api/codex/device-poll",{device_auth_id:j.device_auth_id,user_code:j.user_code,interval:j.interval});if(ue.cancelled)return;V.value=Te,L.value="success",await ye()}catch(Te){if(ue.cancelled)return;I.value=Te.message||"Device login failed",L.value="error"}}function de(){D&&(D.cancelled=!0),L.value=null,B.value=null}return $e(ye),ft(()=>{D&&(D.cancelled=!0)}),{loading:e,llmStatus:t,selectedProvider:s,switching:f,codexForm:n,ollamaForm:a,kimiForm:i,savingCodex:o,savingOllama:c,savingKimi:u,probingOllama:d,ollamaKeyDirty:l,kimiKeyDirty:r,ollamaStatus:p,ollamaModels:m,ollamaSelectedModel:g,reloading:k,settingModel:C,kimiStatus:v,kimiModels:b,kimiSelectedModel:x,reloadingKimi:E,settingKimiModel:S,codexLoading:N,codexError:w,codexData:A,refreshing:O,editingLabel:H,labelValue:M,deviceState:L,deviceLoading:J,deviceInfo:B,deviceResult:V,deviceError:I,fetchAll:ye,switchProvider:ce,reloadOllama:Ie,setOllamaModel:q,reloadKimi:ve,setKimiModel:be,probeOllamaModels:re,saveCodexConfig:Oe,saveOllamaConfig:y,saveKimiConfig:T,saveCodexConfigDebounced:P,saveOllamaConfigDebounced:W,saveKimiConfigDebounced:R,activateAccount:F,refreshAccount:Y,startEditLabel:Z,saveLabel:te,deleteAccount:X,startDeviceLogin:ge,cancelDeviceLogin:de,formatSize:fe}}},$d={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Uw(e){return $d[e]||$d[(e||"").toLowerCase()]||"text-gray-400"}const Hw={template:`
  ...
  `},Vw={components:{TabbedPage:ir},setup(){return{tabs:[{id:"health",label:"Health",component:_w},{id:"resources",label:"Resources",component:kw},{id:"logs",label:"Logs",component:Cw},{id:"config",label:"Config",component:Pw},{id:"discord",label:"Discord",component:Mw},{id:"host-access",label:"Host Access",component:Fw},{id:"api-tokens",label:"API Tokens",component:$w},{id:"llm",label:"LLM Config",component:Bw},{id:"internals",label:"Internals",component:Hw},{id:"update",label:"Update",component:jw}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},ug=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:N_,meta:{label:"Dashboard",icon:"📊"}},{path:"/chat",component:Wk,meta:{label:"Chat",icon:"💭"}},{path:"/operations",component:ew,meta:{label:"Operations",icon:"🎯"}},{path:"/history",component:rw,meta:{label:"History",icon:"📝"}},{path:"/capabilities",component:mw,meta:{label:"Capabilities",icon:"🔧"}},{path:"/personality",component:vw,meta:{label:"Personality",icon:"🎭"}},{path:"/system",component:Vw,meta:{label:"System",icon:"⚙️"}},{path:"/execution",redirect:{path:"/operations",query:{tab:"live"}}},{path:"/agents",redirect:{path:"/operations",query:{tab:"agents"}}},{path:"/loops",redirect:{path:"/operations",query:{tab:"loops"}}},{path:"/processes",redirect:{path:"/operations",query:{tab:"processes"}}},{path:"/schedules",redirect:{path:"/operations",query:{tab:"schedules"}}},{path:"/audit",redirect:{path:"/history",query:{tab:"audit"}}},{path:"/sessions",redirect:{path:"/history",query:{tab:"sessions"}}},{path:"/traces",redirect:{path:"/history",query:{tab:"traces"}}},{path:"/usage",redirect:{path:"/history",query:{tab:"usage"}}},{path:"/tools",redirect:{path:"/capabilities",query:{tab:"tools"}}},{path:"/skills",redirect:{path:"/capabilities",query:{tab:"skills"}}},{path:"/knowledge",redirect:{path:"/capabilities",query:{tab:"knowledge"}}},{path:"/memory",redirect:{path:"/capabilities",query:{tab:"memory"}}},{path:"/health",redirect:{path:"/system",query:{tab:"health"}}},{path:"/resources",redirect:{path:"/system",query:{tab:"resources"}}},{path:"/logs",redirect:{path:"/system",query:{tab:"logs"}}},{path:"/config",redirect:{path:"/system",query:{tab:"config"}}},{path:"/host-access",redirect:{path:"/system",query:{tab:"host-access"}}},{path:"/internals",redirect:{path:"/system",query:{tab:"internals"}}}],dg=S_({history:s_(),routes:ug});dg.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const qw={template:`
    ...
    </div>`,props:["onLogin","sessionExpired"],setup(e){const t=h(""),s=h(null),n=h(!1),a=h(!1);async function i(){n.value=!0,s.value=null;try{G.setPersist(a.value),await G.login(t.value),e.onLogin()}catch(l){s.value=l.message||"Login failed"}finally{n.value=!1}}return{token:t,error:s,busy:n,persist:a,login:i}}},zw={template:`
