var kg=Object.defineProperty;var wg=(e,t,s)=>t in e?kg(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var Xe=(e,t,s)=>wg(e,typeof t!="symbol"?t+"":t,s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();class Sg{constructor(){this._persist=localStorage.getItem("odin_persist")==="1",this._token=this._persist?localStorage.getItem("odin_token")||"":sessionStorage.getItem("odin_token")||"";const t=this._persist?localStorage:sessionStorage;this._sessionTimeout=parseInt(t.getItem("odin_session_timeout")||"0",10),this._lastActivity=Date.now(),this._activityTimer=null,this.onSessionExpired=null,this._token&&this._sessionTimeout>0&&this._startActivityMonitor()}get token(){return this._token}get sessionTimeout(){return this._sessionTimeout}setToken(t,s=0){if(this._token=t,this._sessionTimeout=s,this._lastActivity=Date.now(),t){const n=this._persist?localStorage:sessionStorage;n.setItem("odin_token",t),this._persist&&localStorage.setItem("odin_persist","1"),s>0?n.setItem("odin_session_timeout",String(s)):n.removeItem("odin_session_timeout"),this._startActivityMonitor()}else sessionStorage.removeItem("odin_token"),sessionStorage.removeItem("odin_session_timeout"),localStorage.removeItem("odin_token"),localStorage.removeItem("odin_persist"),localStorage.removeItem("odin_session_timeout"),this._stopActivityMonitor()}setPersist(t){this._persist=t}_startActivityMonitor(){this._stopActivityMonitor(),!(this._sessionTimeout<=0)&&(this._activityTimer=setInterval(()=>{(Date.now()-this._lastActivity)/1e3>=this._sessionTimeout&&(this._stopActivityMonitor(),this.onSessionExpired&&this.onSessionExpired())},1e4))}_stopActivityMonitor(){this._activityTimer&&(clearInterval(this._activityTimer),this._activityTimer=null)}_headers(t={}){const s={"Content-Type":"application/json",...t};return this._token&&(s.Authorization=`Bearer ${this._token}`),s}async _request(t,s,n=null){this._lastActivity=Date.now();const a={method:t,headers:this._headers()};n!==null&&(a.body=JSON.stringify(n));const i=await fetch(s,a);if(i.status===401)throw new gr("Unauthorized");const l=await i.json().catch(()=>null);if(!i.ok){const r=(l==null?void 0:l.error)||`HTTP ${i.status}`;throw new Tg(r,i.status,l)}return l}get(t){return this._request("GET",t)}post(t,s){return this._request("POST",t,s)}put(t,s){return this._request("PUT",t,s)}del(t){return this._request("DELETE",t)}async login(t){const s=await fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t})}),n=await s.json().catch(()=>null);if(!s.ok)throw new gr((n==null?void 0:n.error)||"Login failed");return this.setToken(n.session_id,n.timeout_seconds||0),n}async logout(){try{await this.post("/api/auth/logout",{})}catch{}this.setToken("")}async check(){try{return await this.get("/api/status"),{ok:!0,needsAuth:!1}}catch(t){return t instanceof gr?{ok:!1,needsAuth:!0}:{ok:!1,needsAuth:!1,error:t.message}}}}class gr extends Error{constructor(t){super(t),this.name="AuthError"}}class Tg extends Error{constructor(t,s,n){super(t),this.name="ApiError",this.status=s,this.data=n}}class Cg{constructor(t){this._api=t,this._ws=null,this._handlers={logs:[],events:[],chat:[]},this._reconnectDelay=1e3,this._maxReconnectDelay=3e4,this._shouldConnect=!1,this._subscriptions=new Set,this._reconnectAttempt=0,this._lastPongTime=0,this._pingInterval=null,this._latency=-1,this._chatPending=!1,this._state="disconnected",this.onStatusChange=null,this.onStateChange=null}get connected(){var t;return((t=this._ws)==null?void 0:t.readyState)===WebSocket.OPEN}get state(){return this._state}get reconnectAttempt(){return this._reconnectAttempt}get latency(){return this._latency}connect(){this._shouldConnect=!0,this._setState("connecting"),this._open()}disconnect(){this._shouldConnect=!1,this._reconnectAttempt=0,this._latency=-1,this._stopPing(),this._ws&&(this._ws.close(),this._ws=null),this._setState("disconnected")}_setState(t){this._state!==t&&(this._state=t,this.onStateChange&&this.onStateChange(t,{attempt:this._reconnectAttempt,latency:this._latency}))}_startPing(){this._stopPing(),this._pingInterval=setInterval(()=>{if(this.connected)try{this._ws.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}},15e3)}_stopPing(){this._pingInterval&&(clearInterval(this._pingInterval),this._pingInterval=null)}subscribe(t,s){this._handlers[t]||(this._handlers[t]=[]),this._handlers[t].push(s),t!=="chat"&&(this._subscriptions.add(t),this.connected&&this._ws.send(JSON.stringify({subscribe:t})))}unsubscribe(t,s){const n=this._handlers[t];if(n){const a=n.indexOf(s);a>=0&&n.splice(a,1),n.length===0&&t!=="chat"&&(this._subscriptions.delete(t),this.connected&&this._ws.send(JSON.stringify({unsubscribe:t})))}}on(t,s){return this.subscribe(t,s)}off(t,s){return this.unsubscribe(t,s)}sendChat(t,{channelId:s,userId:n,username:a}={}){return this.connected?(this._ws.send(JSON.stringify({type:"chat",content:t,channel_id:s||"web-default",user_id:n||void 0,username:a||void 0})),this._chatPending=!0,!0):!1}_open(){if(this._ws)return;let s=`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}/api/ws`;this._api.token&&(s+=`?token=${encodeURIComponent(this._api.token)}`),this._ws=new WebSocket(s),this._ws.onopen=()=>{this._reconnectDelay=1e3,this._reconnectAttempt=0;for(const n of this._subscriptions)this._ws.send(JSON.stringify({subscribe:n}));this._startPing(),this._setState("connected"),this.onStatusChange&&this.onStatusChange(!0)},this._ws.onmessage=n=>{let a;try{a=JSON.parse(n.data)}catch{return}const i=a.type;if(i==="pong"){a.ts&&(this._latency=Date.now()-a.ts,this._lastPongTime=Date.now());return}if(i==="log")for(const l of this._handlers.logs||[])l(a);else if(i==="event")for(const l of this._handlers.events||[])l(a);else if(i==="chat_response"||i==="chat_error"){this._chatPending=!1;for(const l of this._handlers.chat||[])l(a)}},this._ws.onclose=()=>{if(this._ws=null,this._stopPing(),this._latency=-1,this._chatPending){this._chatPending=!1;const n={type:"chat_error",error:"Connection lost — the response may still complete; check session history."};for(const a of this._handlers.chat||[])a(n)}this.onStatusChange&&this.onStatusChange(!1),this._shouldConnect?(this._reconnectAttempt++,this._setState("reconnecting"),setTimeout(()=>this._open(),this._reconnectDelay),this._reconnectDelay=Math.min(this._reconnectDelay*2,this._maxReconnectDelay)):this._setState("disconnected")},this._ws.onerror=()=>{}}}const q=new Sg,Ge=new Cg(q);/**
* @vue/shared v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function rs(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const Fe={},ca=[],Lt=()=>{},ra=()=>!1,Vn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Fl=e=>e.startsWith("onUpdate:"),Me=Object.assign,To=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Eg=Object.prototype.hasOwnProperty,je=(e,t)=>Eg.call(e,t),ge=Array.isArray,ua=e=>Ia(e)==="[object Map]",jn=e=>Ia(e)==="[object Set]",Zc=e=>Ia(e)==="[object Date]",Ag=e=>Ia(e)==="[object RegExp]",we=e=>typeof e=="function",Ce=e=>typeof e=="string",Ht=e=>typeof e=="symbol",Ve=e=>e!==null&&typeof e=="object",Co=e=>(Ve(e)||we(e))&&we(e.then)&&we(e.catch),Gd=Object.prototype.toString,Ia=e=>Gd.call(e),Rg=e=>Ia(e).slice(8,-1),$l=e=>Ia(e)==="[object Object]",Ul=e=>Ce(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Js=rs(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ig=rs("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),Bl=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Ng=/-\w/g,Qe=Bl(e=>e.replace(Ng,t=>t.slice(1).toUpperCase())),Og=/\B([A-Z])/g,es=Bl(e=>e.replace(Og,"-$1").toLowerCase()),zn=Bl(e=>e.charAt(0).toUpperCase()+e.slice(1)),da=Bl(e=>e?`on${zn(e)}`:""),Ct=(e,t)=>!Object.is(e,t),fa=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},Wd=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Hl=e=>{const t=parseFloat(e);return isNaN(t)?e:t},rl=e=>{const t=Ce(e)?Number(e):NaN;return isNaN(t)?e:t};let Jc;const Vl=()=>Jc||(Jc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Lg(e,t){return e+JSON.stringify(t,(s,n)=>typeof n=="function"?n.toString():n)}const Dg="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol",Mg=rs(Dg);function Si(e){if(ge(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],a=Ce(n)?Zd(n):Si(n);if(a)for(const i in a)t[i]=a[i]}return t}else if(Ce(e)||Ve(e))return e}const Pg=/;(?![^(]*\))/g,Fg=/:([^]+)/,$g=/\/\*[^]*?\*\//g;function Zd(e){const t={};return e.replace($g,"").split(Pg).forEach(s=>{if(s){const n=s.split(Fg);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function Ti(e){let t="";if(Ce(e))t=e;else if(ge(e))for(let s=0;s<e.length;s++){const n=Ti(e[s]);n&&(t+=n+" ")}else if(Ve(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function Ug(e){if(!e)return null;let{class:t,style:s}=e;return t&&!Ce(t)&&(e.class=Ti(t)),s&&(e.style=Si(s)),e}const Bg="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",Hg="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",Vg="annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics",jg="area,base,br,col,embed,hr,img,input,link,meta,param,source,track,wbr",zg=rs(Bg),qg=rs(Hg),Kg=rs(Vg),Gg=rs(jg),Wg="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Zg=rs(Wg);function Jd(e){return!!e||e===""}function Jg(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=en(e[n],t[n]);return s}function en(e,t){if(e===t)return!0;let s=Zc(e),n=Zc(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=Ht(e),n=Ht(t),s||n)return e===t;if(s=ge(e),n=ge(t),s||n)return s&&n?Jg(e,t):!1;if(s=Ve(e),n=Ve(t),s||n){if(!s||!n)return!1;const a=Object.keys(e).length,i=Object.keys(t).length;if(a!==i)return!1;for(const l in e){const r=e.hasOwnProperty(l),o=t.hasOwnProperty(l);if(r&&!o||!r&&o||!en(e[l],t[l]))return!1}}return String(e)===String(t)}function jl(e,t){return e.findIndex(s=>en(s,t))}const Yd=e=>!!(e&&e.__v_isRef===!0),Qd=e=>Ce(e)?e:e==null?"":ge(e)||Ve(e)&&(e.toString===Gd||!we(e.toString))?Yd(e)?Qd(e.value):JSON.stringify(e,Xd,2):String(e),Xd=(e,t)=>Yd(t)?Xd(e,t.value):ua(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,a],i)=>(s[mr(n,i)+" =>"]=a,s),{})}:jn(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>mr(s))}:Ht(t)?mr(t):Ve(t)&&!ge(t)&&!$l(t)?String(t):t,mr=(e,t="")=>{var s;return Ht(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};function Yg(e){return e==null?"initial":typeof e=="string"?e===""?" ":e:String(e)}/**
* @vue/reactivity v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let wt;class Eo{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&wt&&(wt.active?(this.parent=wt,this.index=(wt.scopes||(wt.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=wt;try{return wt=this,t()}finally{wt=s}}}on(){++this._on===1&&(this.prevScope=wt,wt=this)}off(){if(this._on>0&&--this._on===0){if(wt===this)wt=this.prevScope;else{let t=wt;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0}}}function Qg(e){return new Eo(e)}function ef(){return wt}function Xg(e,t=!1){wt&&wt.cleanups.push(e)}let st;const vr=new WeakSet;class li{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,wt&&(wt.active?wt.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,vr.has(this)&&(vr.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||sf(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Yc(this),nf(this);const t=st,s=xs;st=this,xs=!0;try{return this.fn()}finally{af(this),st=t,xs=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Io(t);this.deps=this.depsTail=void 0,Yc(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?vr.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){jr(this)&&this.run()}get dirty(){return jr(this)}}let tf=0,Ja,Ya;function sf(e,t=!1){if(e.flags|=8,t){e.next=Ya,Ya=e;return}e.next=Ja,Ja=e}function Ao(){tf++}function Ro(){if(--tf>0)return;if(Ya){let t=Ya;for(Ya=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;Ja;){let t=Ja;for(Ja=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function nf(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function af(e){let t,s=e.depsTail,n=s;for(;n;){const a=n.prevDep;n.version===-1?(n===s&&(s=a),Io(n),em(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=a}e.deps=t,e.depsTail=s}function jr(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(lf(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function lf(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===ri)||(e.globalVersion=ri,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!jr(e))))return;e.flags|=2;const t=e.dep,s=st,n=xs;st=e,xs=!0;try{nf(e);const a=e.fn(e._value);(t.version===0||Ct(a,e._value))&&(e.flags|=128,e._value=a,t.version++)}catch(a){throw t.version++,a}finally{st=s,xs=n,af(e),e.flags&=-3}}function Io(e,t=!1){const{dep:s,prevSub:n,nextSub:a}=e;if(n&&(n.nextSub=a,e.prevSub=void 0),a&&(a.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let i=s.computed.deps;i;i=i.nextDep)Io(i,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function em(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}function tm(e,t){e.effect instanceof li&&(e=e.effect.fn);const s=new li(e);t&&Me(s,t);try{s.run()}catch(a){throw s.stop(),a}const n=s.run.bind(s);return n.effect=s,n}function sm(e){e.effect.stop()}let xs=!0;const rf=[];function tn(){rf.push(xs),xs=!1}function sn(){const e=rf.pop();xs=e===void 0?!0:e}function Yc(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=st;st=void 0;try{t()}finally{st=s}}}let ri=0;class nm{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class zl{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!st||!xs||st===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==st)s=this.activeLink=new nm(st,this),st.deps?(s.prevDep=st.depsTail,st.depsTail.nextDep=s,st.depsTail=s):st.deps=st.depsTail=s,of(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=st.depsTail,s.nextDep=void 0,st.depsTail.nextDep=s,st.depsTail=s,st.deps===s&&(st.deps=n)}return s}trigger(t){this.version++,ri++,this.notify(t)}notify(t){Ao();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Ro()}}}function of(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)of(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const ol=new WeakMap,On=Symbol(""),zr=Symbol(""),oi=Symbol("");function $t(e,t,s){if(xs&&st){let n=ol.get(e);n||ol.set(e,n=new Map);let a=n.get(s);a||(n.set(s,a=new zl),a.map=n,a.key=s),a.track()}}function qs(e,t,s,n,a,i){const l=ol.get(e);if(!l){ri++;return}const r=o=>{o&&o.trigger()};if(Ao(),t==="clear")l.forEach(r);else{const o=ge(e),c=o&&Ul(s);if(o&&s==="length"){const u=Number(n);l.forEach((d,f)=>{(f==="length"||f===oi||!Ht(f)&&f>=u)&&r(d)})}else switch((s!==void 0||l.has(void 0))&&r(l.get(s)),c&&r(l.get(oi)),t){case"add":o?c&&r(l.get("length")):(r(l.get(On)),ua(e)&&r(l.get(zr)));break;case"delete":o||(r(l.get(On)),ua(e)&&r(l.get(zr)));break;case"set":ua(e)&&r(l.get(On));break}}Ro()}function am(e,t){const s=ol.get(e);return s&&s.get(t)}function Qn(e){const t=Ue(e);return t===e?t:($t(t,"iterate",oi),ss(e)?t:t.map(ks))}function ql(e){return $t(e=Ue(e),"iterate",oi),e}function Os(e,t){return Ds(e)?ba(Ys(e)?ks(t):t):ks(t)}const im={__proto__:null,[Symbol.iterator](){return br(this,Symbol.iterator,e=>Os(this,e))},concat(...e){return Qn(this).concat(...e.map(t=>ge(t)?Qn(t):t))},entries(){return br(this,"entries",e=>(e[1]=Os(this,e[1]),e))},every(e,t){return Fs(this,"every",e,t,void 0,arguments)},filter(e,t){return Fs(this,"filter",e,t,s=>s.map(n=>Os(this,n)),arguments)},find(e,t){return Fs(this,"find",e,t,s=>Os(this,s),arguments)},findIndex(e,t){return Fs(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return Fs(this,"findLast",e,t,s=>Os(this,s),arguments)},findLastIndex(e,t){return Fs(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return Fs(this,"forEach",e,t,void 0,arguments)},includes(...e){return yr(this,"includes",e)},indexOf(...e){return yr(this,"indexOf",e)},join(e){return Qn(this).join(e)},lastIndexOf(...e){return yr(this,"lastIndexOf",e)},map(e,t){return Fs(this,"map",e,t,void 0,arguments)},pop(){return Pa(this,"pop")},push(...e){return Pa(this,"push",e)},reduce(e,...t){return Qc(this,"reduce",e,t)},reduceRight(e,...t){return Qc(this,"reduceRight",e,t)},shift(){return Pa(this,"shift")},some(e,t){return Fs(this,"some",e,t,void 0,arguments)},splice(...e){return Pa(this,"splice",e)},toReversed(){return Qn(this).toReversed()},toSorted(e){return Qn(this).toSorted(e)},toSpliced(...e){return Qn(this).toSpliced(...e)},unshift(...e){return Pa(this,"unshift",e)},values(){return br(this,"values",e=>Os(this,e))}};function br(e,t,s){const n=ql(e),a=n[t]();return n!==e&&!ss(e)&&(a._next=a.next,a.next=()=>{const i=a._next();return i.done||(i.value=s(i.value)),i}),a}const lm=Array.prototype;function Fs(e,t,s,n,a,i){const l=ql(e),r=l!==e&&!ss(e),o=l[t];if(o!==lm[t]){const d=o.apply(e,i);return r?ks(d):d}let c=s;l!==e&&(r?c=function(d,f){return s.call(this,Os(e,d),f,e)}:s.length>2&&(c=function(d,f){return s.call(this,d,f,e)}));const u=o.call(l,c,n);return r&&a?a(u):u}function Qc(e,t,s,n){const a=ql(e),i=a!==e&&!ss(e);let l=s,r=!1;a!==e&&(i?(r=n.length===0,l=function(c,u,d){return r&&(r=!1,c=Os(e,c)),s.call(this,c,Os(e,u),d,e)}):s.length>3&&(l=function(c,u,d){return s.call(this,c,u,d,e)}));const o=a[t](l,...n);return r?Os(e,o):o}function yr(e,t,s){const n=Ue(e);$t(n,"iterate",oi);const a=n[t](...s);return(a===-1||a===!1)&&Ci(s[0])?(s[0]=Ue(s[0]),n[t](...s)):a}function Pa(e,t,s=[]){tn(),Ao();const n=Ue(e)[t].apply(e,s);return Ro(),sn(),n}const rm=rs("__proto__,__v_isRef,__isVue"),cf=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Ht));function om(e){Ht(e)||(e=String(e));const t=Ue(this);return $t(t,"has",e),t.hasOwnProperty(e)}class uf{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const a=this._isReadonly,i=this._isShallow;if(s==="__v_isReactive")return!a;if(s==="__v_isReadonly")return a;if(s==="__v_isShallow")return i;if(s==="__v_raw")return n===(a?i?mf:gf:i?hf:pf).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const l=ge(t);if(!a){let o;if(l&&(o=im[s]))return o;if(s==="hasOwnProperty")return om}const r=Reflect.get(t,s,bt(t)?t:n);if((Ht(s)?cf.has(s):rm(s))||(a||$t(t,"get",s),i))return r;if(bt(r)){const o=l&&Ul(s)?r:r.value;return a&&Ve(o)?cl(o):o}return Ve(r)?a?cl(r):_n(r):r}}class df extends uf{constructor(t=!1){super(!1,t)}set(t,s,n,a){let i=t[s];const l=ge(t)&&Ul(s);if(!this._isShallow){const c=Ds(i);if(!ss(n)&&!Ds(n)&&(i=Ue(i),n=Ue(n)),!l&&bt(i)&&!bt(n))return c||(i.value=n),!0}const r=l?Number(s)<t.length:je(t,s),o=Reflect.set(t,s,n,bt(t)?t:a);return t===Ue(a)&&(r?Ct(n,i)&&qs(t,"set",s,n):qs(t,"add",s,n)),o}deleteProperty(t,s){const n=je(t,s);t[s];const a=Reflect.deleteProperty(t,s);return a&&n&&qs(t,"delete",s,void 0),a}has(t,s){const n=Reflect.has(t,s);return(!Ht(s)||!cf.has(s))&&$t(t,"has",s),n}ownKeys(t){return $t(t,"iterate",ge(t)?"length":On),Reflect.ownKeys(t)}}class ff extends uf{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const cm=new df,um=new ff,dm=new df(!0),fm=new ff(!0),qr=e=>e,$i=e=>Reflect.getPrototypeOf(e);function pm(e,t,s){return function(...n){const a=this.__v_raw,i=Ue(a),l=ua(i),r=e==="entries"||e===Symbol.iterator&&l,o=e==="keys"&&l,c=a[e](...n),u=s?qr:t?ba:ks;return!t&&$t(i,"iterate",o?zr:On),Me(Object.create(c),{next(){const{value:d,done:f}=c.next();return f?{value:d,done:f}:{value:r?[u(d[0]),u(d[1])]:u(d),done:f}}})}}function Ui(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function hm(e,t){const s={get(a){const i=this.__v_raw,l=Ue(i),r=Ue(a);e||(Ct(a,r)&&$t(l,"get",a),$t(l,"get",r));const{has:o}=$i(l),c=t?qr:e?ba:ks;if(o.call(l,a))return c(i.get(a));if(o.call(l,r))return c(i.get(r));i!==l&&i.get(a)},get size(){const a=this.__v_raw;return!e&&$t(Ue(a),"iterate",On),a.size},has(a){const i=this.__v_raw,l=Ue(i),r=Ue(a);return e||(Ct(a,r)&&$t(l,"has",a),$t(l,"has",r)),a===r?i.has(a):i.has(a)||i.has(r)},forEach(a,i){const l=this,r=l.__v_raw,o=Ue(r),c=t?qr:e?ba:ks;return!e&&$t(o,"iterate",On),r.forEach((u,d)=>a.call(i,c(u),c(d),l))}};return Me(s,e?{add:Ui("add"),set:Ui("set"),delete:Ui("delete"),clear:Ui("clear")}:{add(a){const i=Ue(this),l=$i(i),r=Ue(a),o=!t&&!ss(a)&&!Ds(a)?r:a;return l.has.call(i,o)||Ct(a,o)&&l.has.call(i,a)||Ct(r,o)&&l.has.call(i,r)||(i.add(o),qs(i,"add",o,o)),this},set(a,i){!t&&!ss(i)&&!Ds(i)&&(i=Ue(i));const l=Ue(this),{has:r,get:o}=$i(l);let c=r.call(l,a);c||(a=Ue(a),c=r.call(l,a));const u=o.call(l,a);return l.set(a,i),c?Ct(i,u)&&qs(l,"set",a,i):qs(l,"add",a,i),this},delete(a){const i=Ue(this),{has:l,get:r}=$i(i);let o=l.call(i,a);o||(a=Ue(a),o=l.call(i,a)),r&&r.call(i,a);const c=i.delete(a);return o&&qs(i,"delete",a,void 0),c},clear(){const a=Ue(this),i=a.size!==0,l=a.clear();return i&&qs(a,"clear",void 0,void 0),l}}),["keys","values","entries",Symbol.iterator].forEach(a=>{s[a]=pm(a,e,t)}),s}function Kl(e,t){const s=hm(e,t);return(n,a,i)=>a==="__v_isReactive"?!e:a==="__v_isReadonly"?e:a==="__v_raw"?n:Reflect.get(je(s,a)&&a in n?s:n,a,i)}const gm={get:Kl(!1,!1)},mm={get:Kl(!1,!0)},vm={get:Kl(!0,!1)},bm={get:Kl(!0,!0)},pf=new WeakMap,hf=new WeakMap,gf=new WeakMap,mf=new WeakMap;function ym(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function _n(e){return Ds(e)?e:Gl(e,!1,cm,gm,pf)}function No(e){return Gl(e,!1,dm,mm,hf)}function cl(e){return Gl(e,!0,um,vm,gf)}function xm(e){return Gl(e,!0,fm,bm,mf)}function Gl(e,t,s,n,a){if(!Ve(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const i=a.get(e);if(i)return i;const l=ym(Rg(e));if(l===0)return e;const r=new Proxy(e,l===2?n:s);return a.set(e,r),r}function Ys(e){return Ds(e)?Ys(e.__v_raw):!!(e&&e.__v_isReactive)}function Ds(e){return!!(e&&e.__v_isReadonly)}function ss(e){return!!(e&&e.__v_isShallow)}function Ci(e){return e?!!e.__v_raw:!1}function Ue(e){const t=e&&e.__v_raw;return t?Ue(t):e}function vf(e){return!je(e,"__v_skip")&&Object.isExtensible(e)&&Wd(e,"__v_skip",!0),e}const ks=e=>Ve(e)?_n(e):e,ba=e=>Ve(e)?cl(e):e;function bt(e){return e?e.__v_isRef===!0:!1}function h(e){return bf(e,!1)}function Oo(e){return bf(e,!0)}function bf(e,t){return bt(e)?e:new _m(e,t)}class _m{constructor(t,s){this.dep=new zl,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:Ue(t),this._value=s?t:ks(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||ss(t)||Ds(t);t=n?t:Ue(t),Ct(t,s)&&(this._rawValue=t,this._value=n?t:ks(t),this.dep.trigger())}}function km(e){e.dep&&e.dep.trigger()}function Ls(e){return bt(e)?e.value:e}function wm(e){return we(e)?e():Ls(e)}const Sm={get:(e,t,s)=>t==="__v_raw"?e:Ls(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const a=e[t];return bt(a)&&!bt(s)?(a.value=s,!0):Reflect.set(e,t,s,n)}};function Lo(e){return Ys(e)?e:new Proxy(e,Sm)}class Tm{constructor(t){this.__v_isRef=!0,this._value=void 0;const s=this.dep=new zl,{get:n,set:a}=t(s.track.bind(s),s.trigger.bind(s));this._get=n,this._set=a}get value(){return this._value=this._get()}set value(t){this._set(t)}}function yf(e){return new Tm(e)}function Cm(e){const t=ge(e)?new Array(e.length):{};for(const s in e)t[s]=xf(e,s);return t}class Em{constructor(t,s,n){this._object=t,this._defaultValue=n,this.__v_isRef=!0,this._value=void 0,this._key=Ht(s)?s:String(s),this._raw=Ue(t);let a=!0,i=t;if(!ge(t)||Ht(this._key)||!Ul(this._key))do a=!Ci(i)||ss(i);while(a&&(i=i.__v_raw));this._shallow=a}get value(){let t=this._object[this._key];return this._shallow&&(t=Ls(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&bt(this._raw[this._key])){const s=this._object[this._key];if(bt(s)){s.value=t;return}}this._object[this._key]=t}get dep(){return am(this._raw,this._key)}}class Am{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function Rm(e,t,s){return bt(e)?e:we(e)?new Am(e):Ve(e)&&arguments.length>1?xf(e,t,s):h(e)}function xf(e,t,s){return new Em(e,t,s)}class Im{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new zl(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=ri-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&st!==this)return sf(this,!0),!0}get value(){const t=this.dep.track();return lf(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Nm(e,t,s=!1){let n,a;return we(e)?n=e:(n=e.get,a=e.set),new Im(n,a,s)}const Om={GET:"get",HAS:"has",ITERATE:"iterate"},Lm={SET:"set",ADD:"add",DELETE:"delete",CLEAR:"clear"},Bi={},ul=new WeakMap;let hn;function Dm(){return hn}function _f(e,t=!1,s=hn){if(s){let n=ul.get(s);n||ul.set(s,n=[]),n.push(e)}}function Mm(e,t,s=Fe){const{immediate:n,deep:a,once:i,scheduler:l,augmentJob:r,call:o}=s,c=x=>a?x:ss(x)||a===!1||a===0?Ks(x,1):Ks(x);let u,d,f,p,m=!1,g=!1;if(bt(e)?(d=()=>e.value,m=ss(e)):Ys(e)?(d=()=>c(e),m=!0):ge(e)?(g=!0,m=e.some(x=>Ys(x)||ss(x)),d=()=>e.map(x=>{if(bt(x))return x.value;if(Ys(x))return c(x);if(we(x))return o?o(x,2):x()})):we(e)?t?d=o?()=>o(e,2):e:d=()=>{if(f){tn();try{f()}finally{sn()}}const x=hn;hn=u;try{return o?o(e,3,[p]):e(p)}finally{hn=x}}:d=Lt,t&&a){const x=d,w=a===!0?1/0:a;d=()=>Ks(x(),w)}const k=ef(),E=()=>{u.stop(),k&&k.active&&To(k.effects,u)};if(i&&t){const x=t;t=(...w)=>{const N=x(...w);return E(),N}}let b=g?new Array(e.length).fill(Bi):Bi;const v=x=>{if(!(!(u.flags&1)||!u.dirty&&!x))if(t){const w=u.run();if(x||a||m||(g?w.some((N,O)=>Ct(N,b[O])):Ct(w,b))){f&&f();const N=hn;hn=u;try{const O=[w,b===Bi?void 0:g&&b[0]===Bi?[]:b,p];b=w,o?o(t,3,O):t(...O)}finally{hn=N}}}else u.run()};return r&&r(v),u=new li(d),u.scheduler=l?()=>l(v,!1):v,p=x=>_f(x,!1,u),f=u.onStop=()=>{const x=ul.get(u);if(x){if(o)o(x,4);else for(const w of x)w();ul.delete(u)}},t?n?v(!0):b=u.run():l?l(v.bind(null,!0),!0):u.run(),E.pause=u.pause.bind(u),E.resume=u.resume.bind(u),E.stop=E,E}function Ks(e,t=1/0,s){if(t<=0||!Ve(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,bt(e))Ks(e.value,t,s);else if(ge(e))for(let n=0;n<e.length;n++)Ks(e[n],t,s);else if(jn(e)||ua(e))e.forEach(n=>{Ks(n,t,s)});else if($l(e)){for(const n in e)Ks(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&Ks(e[n],t,s)}return e}/**
* @vue/runtime-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const kf=[];function Pm(e){kf.push(e)}function Fm(){kf.pop()}function $m(e,t){}const Um={SETUP_FUNCTION:0,0:"SETUP_FUNCTION",RENDER_FUNCTION:1,1:"RENDER_FUNCTION",NATIVE_EVENT_HANDLER:5,5:"NATIVE_EVENT_HANDLER",COMPONENT_EVENT_HANDLER:6,6:"COMPONENT_EVENT_HANDLER",VNODE_HOOK:7,7:"VNODE_HOOK",DIRECTIVE_HOOK:8,8:"DIRECTIVE_HOOK",TRANSITION_HOOK:9,9:"TRANSITION_HOOK",APP_ERROR_HANDLER:10,10:"APP_ERROR_HANDLER",APP_WARN_HANDLER:11,11:"APP_WARN_HANDLER",FUNCTION_REF:12,12:"FUNCTION_REF",ASYNC_COMPONENT_LOADER:13,13:"ASYNC_COMPONENT_LOADER",SCHEDULER:14,14:"SCHEDULER",COMPONENT_UPDATE:15,15:"COMPONENT_UPDATE",APP_UNMOUNT_CLEANUP:16,16:"APP_UNMOUNT_CLEANUP"},Bm={sp:"serverPrefetch hook",bc:"beforeCreate hook",c:"created hook",bm:"beforeMount hook",m:"mounted hook",bu:"beforeUpdate hook",u:"updated",bum:"beforeUnmount hook",um:"unmounted hook",a:"activated hook",da:"deactivated hook",ec:"errorCaptured hook",rtc:"renderTracked hook",rtg:"renderTriggered hook",0:"setup function",1:"render function",2:"watcher getter",3:"watcher callback",4:"watcher cleanup function",5:"native event handler",6:"component event handler",7:"vnode hook",8:"directive hook",9:"transition hook",10:"app errorHandler",11:"app warnHandler",12:"ref function",13:"async component loader",14:"scheduler flush",15:"component update",16:"app unmount cleanup function"};function Na(e,t,s,n){try{return n?e(...n):e()}catch(a){qn(a,t,s)}}function is(e,t,s,n){if(we(e)){const a=Na(e,t,s,n);return a&&Co(a)&&a.catch(i=>{qn(i,t,s)}),a}if(ge(e)){const a=[];for(let i=0;i<e.length;i++)a.push(is(e[i],t,s,n));return a}}function qn(e,t,s,n=!0){const a=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:l}=t&&t.appContext.config||Fe;if(t){let r=t.parent;const o=t.proxy,c=`https://vuejs.org/error-reference/#runtime-${s}`;for(;r;){const u=r.ec;if(u){for(let d=0;d<u.length;d++)if(u[d](e,o,c)===!1)return}r=r.parent}if(i){tn(),Na(i,null,10,[e,o,c]),sn();return}}Hm(e,s,a,n,l)}function Hm(e,t,s,n=!0,a=!1){if(a)throw e;console.error(e)}const qt=[];let Is=-1;const pa=[];let gn=null,na=0;const wf=Promise.resolve();let dl=null;function Et(e){const t=dl||wf;return e?t.then(this?e.bind(this):e):t}function Vm(e){let t=Is+1,s=qt.length;for(;t<s;){const n=t+s>>>1,a=qt[n],i=ui(a);i<e||i===e&&a.flags&2?t=n+1:s=n}return t}function Do(e){if(!(e.flags&1)){const t=ui(e),s=qt[qt.length-1];!s||!(e.flags&2)&&t>=ui(s)?qt.push(e):qt.splice(Vm(t),0,e),e.flags|=1,Sf()}}function Sf(){dl||(dl=wf.then(Tf))}function ci(e){ge(e)?pa.push(...e):gn&&e.id===-1?gn.splice(na+1,0,e):e.flags&1||(pa.push(e),e.flags|=1),Sf()}function Xc(e,t,s=Is+1){for(;s<qt.length;s++){const n=qt[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;qt.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function fl(e){if(pa.length){const t=[...new Set(pa)].sort((s,n)=>ui(s)-ui(n));if(pa.length=0,gn){gn.push(...t);return}for(gn=t,na=0;na<gn.length;na++){const s=gn[na];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}gn=null,na=0}}const ui=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Tf(e){try{for(Is=0;Is<qt.length;Is++){const t=qt[Is];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Na(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Is<qt.length;Is++){const t=qt[Is];t&&(t.flags&=-2)}Is=-1,qt.length=0,fl(),dl=null,(qt.length||pa.length)&&Tf()}}let aa,Hi=[];function Cf(e,t){var s,n;aa=e,aa?(aa.enabled=!0,Hi.forEach(({event:a,args:i})=>aa.emit(a,...i)),Hi=[]):typeof window<"u"&&window.HTMLElement&&!((n=(s=window.navigator)==null?void 0:s.userAgent)!=null&&n.includes("jsdom"))?((t.__VUE_DEVTOOLS_HOOK_REPLAY__=t.__VUE_DEVTOOLS_HOOK_REPLAY__||[]).push(i=>{Cf(i,t)}),setTimeout(()=>{aa||(t.__VUE_DEVTOOLS_HOOK_REPLAY__=null,Hi=[])},3e3)):Hi=[]}let Ot=null,Wl=null;function di(e){const t=Ot;return Ot=e,Wl=e&&e.type.__scopeId||null,t}function jm(e){Wl=e}function zm(){Wl=null}const qm=e=>Mo;function Mo(e,t=Ot,s){if(!t||e._n)return e;const n=(...a)=>{n._d&&gi(-1);const i=di(t);let l;try{l=e(...a)}finally{di(i),n._d&&gi(1)}return l};return n._n=!0,n._c=!0,n._d=!0,n}function Km(e,t){if(Ot===null)return e;const s=Ii(Ot),n=e.dirs||(e.dirs=[]);for(let a=0;a<t.length;a++){let[i,l,r,o=Fe]=t[a];i&&(we(i)&&(i={mounted:i,updated:i}),i.deep&&Ks(l),n.push({dir:i,instance:s,value:l,oldValue:void 0,arg:r,modifiers:o}))}return e}function Ns(e,t,s,n){const a=e.dirs,i=t&&t.dirs;for(let l=0;l<a.length;l++){const r=a[l];i&&(r.oldValue=i[l].value);let o=r.dir[n];o&&(tn(),is(o,s,8,[e.el,r,e,t]),sn())}}function Qa(e,t){if(Nt){let s=Nt.provides;const n=Nt.parent&&Nt.parent.provides;n===s&&(s=Nt.provides=Object.create(n)),s[e]=t}}function ps(e,t,s=!1){const n=Gt();if(n||Ln){let a=Ln?Ln._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(a&&e in a)return a[e];if(arguments.length>1)return s&&we(t)?t.call(n&&n.proxy):t}}function Gm(){return!!(Gt()||Ln)}const Ef=Symbol.for("v-scx"),Af=()=>ps(Ef);function Wm(e,t){return Ei(e,null,t)}function Zm(e,t){return Ei(e,null,{flush:"post"})}function Rf(e,t){return Ei(e,null,{flush:"sync"})}function hs(e,t,s){return Ei(e,t,s)}function Ei(e,t,s=Fe){const{immediate:n,deep:a,flush:i,once:l}=s,r=Me({},s),o=t&&n||!t&&i!=="post";let c;if(Un){if(i==="sync"){const p=Af();c=p.__watcherHandles||(p.__watcherHandles=[])}else if(!o){const p=()=>{};return p.stop=Lt,p.resume=Lt,p.pause=Lt,p}}const u=Nt;r.call=(p,m,g)=>is(p,u,m,g);let d=!1;i==="post"?r.scheduler=p=>{mt(p,u&&u.suspense)}:i!=="sync"&&(d=!0,r.scheduler=(p,m)=>{m?p():Do(p)}),r.augmentJob=p=>{t&&(p.flags|=4),d&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const f=Mm(e,t,r);return Un&&(c?c.push(f):o&&f()),f}function Jm(e,t,s){const n=this.proxy,a=Ce(e)?e.includes(".")?If(n,e):()=>n[e]:e.bind(n,n);let i;we(t)?i=t:(i=t.handler,s=t);const l=Oa(this),r=Ei(a,i.bind(n),s);return l(),r}function If(e,t){const s=t.split(".");return()=>{let n=e;for(let a=0;a<s.length&&n;a++)n=n[s[a]];return n}}const fn=new WeakMap,Nf=Symbol("_vte"),Of=e=>e.__isTeleport,An=e=>e&&(e.disabled||e.disabled===""),Ym=e=>e&&(e.defer||e.defer===""),eu=e=>typeof SVGElement<"u"&&e instanceof SVGElement,tu=e=>typeof MathMLElement=="function"&&e instanceof MathMLElement,Kr=(e,t)=>{const s=e&&e.to;return Ce(s)?t?t(s):null:s},Qm={name:"Teleport",__isTeleport:!0,process(e,t,s,n,a,i,l,r,o,c){const{mc:u,pc:d,pbc:f,o:{insert:p,querySelector:m,createText:g,createComment:k,parentNode:E}}=c,b=An(t.props);let{dynamicChildren:v}=t;const x=(O,S,R)=>{O.shapeFlag&16&&u(O.children,S,R,a,i,l,r,o)},w=(O=t)=>{const S=An(O.props),R=O.target=Kr(O.props,m),L=Gr(R,O,g,p);R&&(l!=="svg"&&eu(R)?l="svg":l!=="mathml"&&tu(R)&&(l="mathml"),a&&a.isCE&&(a.ce._teleportTargets||(a.ce._teleportTargets=new Set)).add(R),S||(x(O,R,L),qa(O,!1)))},N=O=>{const S=()=>{if(fn.get(O)===S){if(fn.delete(O),An(O.props)){const R=E(O.el)||s;x(O,R,O.anchor),qa(O,!0)}w(O)}};fn.set(O,S),mt(S,i)};if(e==null){const O=t.el=g(""),S=t.anchor=g("");if(p(O,s,n),p(S,s,n),Ym(t.props)||i&&i.pendingBranch){N(t);return}b&&(x(t,s,S),qa(t,!0)),w()}else{t.el=e.el;const O=t.anchor=e.anchor,S=fn.get(e);if(S){S.flags|=8,fn.delete(e),N(t);return}t.targetStart=e.targetStart;const R=t.target=e.target,L=t.targetAnchor=e.targetAnchor,H=An(e.props),P=H?s:R,T=H?O:L;if(l==="svg"||eu(R)?l="svg":(l==="mathml"||tu(R))&&(l="mathml"),v?(f(e.dynamicChildren,v,P,a,i,l,r),Wo(e,t,!0)):o||d(e,t,P,T,a,i,l,r,!1),b)H?t.props&&e.props&&t.props.to!==e.props.to&&(t.props.to=e.props.to):Vi(t,s,O,c,1);else if((t.props&&t.props.to)!==(e.props&&e.props.to)){const U=t.target=Kr(t.props,m);U&&Vi(t,U,null,c,0)}else H&&Vi(t,R,L,c,1);qa(t,b)}},remove(e,t,s,{um:n,o:{remove:a}},i){const{shapeFlag:l,children:r,anchor:o,targetStart:c,targetAnchor:u,target:d,props:f}=e,p=i||!An(f),m=fn.get(e);if(m&&(m.flags|=8,fn.delete(e)),d&&(a(c),a(u)),i&&a(o),!m&&l&16)for(let g=0;g<r.length;g++){const k=r[g];n(k,t,s,p,!!k.dynamicChildren)}},move:Vi,hydrate:Xm};function Vi(e,t,s,{o:{insert:n},m:a},i=2){i===0&&n(e.targetAnchor,t,s);const{el:l,anchor:r,shapeFlag:o,children:c,props:u}=e,d=i===2;if(d&&n(l,t,s),!fn.has(e)&&(!d||An(u))&&o&16)for(let f=0;f<c.length;f++)a(c[f],t,s,2);d&&n(r,t,s)}function Xm(e,t,s,n,a,i,{o:{nextSibling:l,parentNode:r,querySelector:o,insert:c,createText:u}},d){function f(k,E){let b=E;for(;b;){if(b&&b.nodeType===8){if(b.data==="teleport start anchor")t.targetStart=b;else if(b.data==="teleport anchor"){t.targetAnchor=b,k._lpa=t.targetAnchor&&l(t.targetAnchor);break}}b=l(b)}}function p(k,E){E.anchor=d(l(k),E,r(k),s,n,a,i)}const m=t.target=Kr(t.props,o),g=An(t.props);if(m){const k=m._lpa||m.firstChild;t.shapeFlag&16&&(g?(p(e,t),f(m,k),t.targetAnchor||Gr(m,t,u,c,r(e)===m?e:null)):(t.anchor=l(e),f(m,k),t.targetAnchor||Gr(m,t,u,c),d(k&&l(k),t,m,s,n,a,i))),qa(t,g)}else g&&t.shapeFlag&16&&(p(e,t),t.targetStart=e,t.targetAnchor=l(e));return t.anchor&&l(t.anchor)}const ev=Qm;function qa(e,t){const s=e.ctx;if(s&&s.ut){let n,a;for(t?(n=e.el,a=e.anchor):(n=e.targetStart,a=e.targetAnchor);n&&n!==a;)n.nodeType===1&&n.setAttribute("data-v-owner",s.uid),n=n.nextSibling;s.ut()}}function Gr(e,t,s,n,a=null){const i=t.targetStart=s(""),l=t.targetAnchor=s("");return i[Nf]=l,e&&(n(i,e,a),n(l,e,a)),l}const us=Symbol("_leaveCb"),Fa=Symbol("_enterCb");function Po(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Be(()=>{e.isMounted=!0}),Ql(()=>{e.isUnmounting=!0}),e}const cs=[Function,Array],Fo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:cs,onEnter:cs,onAfterEnter:cs,onEnterCancelled:cs,onBeforeLeave:cs,onLeave:cs,onAfterLeave:cs,onLeaveCancelled:cs,onBeforeAppear:cs,onAppear:cs,onAfterAppear:cs,onAppearCancelled:cs},Lf=e=>{const t=e.subTree;return t.component?Lf(t.component):t},tv={name:"BaseTransition",props:Fo,setup(e,{slots:t}){const s=Gt(),n=Po();return()=>{const a=t.default&&Zl(t.default(),!0),i=a&&a.length?Df(a):s.subTree?mp():void 0;if(!i)return;const l=Ue(e),{mode:r}=l;if(n.isLeaving)return xr(i);const o=su(i);if(!o)return xr(i);let c=ya(o,l,n,s,d=>c=d);o.type!==pt&&nn(o,c);let u=s.subTree&&su(s.subTree);if(u&&u.type!==pt&&!ys(u,o)&&Lf(s).type!==pt){let d=ya(u,l,n,s);if(nn(u,d),r==="out-in"&&o.type!==pt)return n.isLeaving=!0,d.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete d.afterLeave,u=void 0},xr(i);r==="in-out"&&o.type!==pt?d.delayLeave=(f,p,m)=>{const g=Pf(n,u);g[String(u.key)]=u,f[us]=()=>{p(),f[us]=void 0,delete c.delayedLeave,u=void 0},c.delayedLeave=()=>{m(),delete c.delayedLeave,u=void 0}}:u=void 0}else u&&(u=void 0);return i}}};function Df(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==pt){t=s;break}}return t}const Mf=tv;function Pf(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function ya(e,t,s,n,a){const{appear:i,mode:l,persisted:r=!1,onBeforeEnter:o,onEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:f,onLeave:p,onAfterLeave:m,onLeaveCancelled:g,onBeforeAppear:k,onAppear:E,onAfterAppear:b,onAppearCancelled:v}=t,x=String(e.key),w=Pf(s,e),N=(R,L)=>{R&&is(R,n,9,L)},O=(R,L)=>{const H=L[1];N(R,L),ge(R)?R.every(P=>P.length<=1)&&H():R.length<=1&&H()},S={mode:l,persisted:r,beforeEnter(R){let L=o;if(!s.isMounted)if(i)L=k||o;else return;R[us]&&R[us](!0);const H=w[x];H&&ys(e,H)&&H.el[us]&&H.el[us](),N(L,[R])},enter(R){if(w[x]===e)return;let L=c,H=u,P=d;if(!s.isMounted)if(i)L=E||c,H=b||u,P=v||d;else return;let T=!1;R[Fa]=K=>{T||(T=!0,K?N(P,[R]):N(H,[R]),S.delayedLeave&&S.delayedLeave(),R[Fa]=void 0)};const U=R[Fa].bind(null,!1);L?O(L,[R,U]):U()},leave(R,L){const H=String(e.key);if(R[Fa]&&R[Fa](!0),s.isUnmounting)return L();N(f,[R]);let P=!1;R[us]=U=>{P||(P=!0,L(),U?N(g,[R]):N(m,[R]),R[us]=void 0,w[H]===e&&delete w[H])};const T=R[us].bind(null,!1);w[H]=e,p?O(p,[R,T]):T()},clone(R){const L=ya(R,t,s,n,a);return a&&a(L),L}};return S}function xr(e){if(Ri(e))return e=Ms(e),e.children=null,e}function su(e){if(!Ri(e))return Of(e.type)&&e.children?Df(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&we(s.default))return s.default()}}function nn(e,t){e.shapeFlag&6&&e.component?(e.transition=t,nn(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Zl(e,t=!1,s){let n=[],a=0;for(let i=0;i<e.length;i++){let l=e[i];const r=s==null?l.key:String(s)+String(l.key!=null?l.key:i);l.type===At?(l.patchFlag&128&&a++,n=n.concat(Zl(l.children,t,r))):(t||l.type!==pt)&&n.push(r!=null?Ms(l,{key:r}):l)}if(a>1)for(let i=0;i<n.length;i++)n[i].patchFlag=-2;return n}function Ai(e,t){return we(e)?Me({name:e.name},t,{setup:e}):e}function sv(){const e=Gt();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function $o(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function nv(e){const t=Gt(),s=Oo(null);if(t){const a=t.refs===Fe?t.refs={}:t.refs;Object.defineProperty(a,e,{enumerable:!0,get:()=>s.value,set:i=>s.value=i})}return s}function nu(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const pl=new WeakMap;function ha(e,t,s,n,a=!1){if(ge(e)){e.forEach((g,k)=>ha(g,t&&(ge(t)?t[k]:t),s,n,a));return}if(Qs(n)&&!a){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&ha(e,t,s,n.component.subTree);return}const i=n.shapeFlag&4?Ii(n.component):n.el,l=a?null:i,{i:r,r:o}=e,c=t&&t.r,u=r.refs===Fe?r.refs={}:r.refs,d=r.setupState,f=Ue(d),p=d===Fe?ra:g=>nu(u,g)?!1:je(f,g),m=(g,k)=>!(k&&nu(u,k));if(c!=null&&c!==o){if(au(t),Ce(c))u[c]=null,p(c)&&(d[c]=null);else if(bt(c)){const g=t;m(c,g.k)&&(c.value=null),g.k&&(u[g.k]=null)}}if(we(o))Na(o,r,12,[l,u]);else{const g=Ce(o),k=bt(o);if(g||k){const E=()=>{if(e.f){const b=g?p(o)?d[o]:u[o]:m()||!e.k?o.value:u[e.k];if(a)ge(b)&&To(b,i);else if(ge(b))b.includes(i)||b.push(i);else if(g)u[o]=[i],p(o)&&(d[o]=u[o]);else{const v=[i];m(o,e.k)&&(o.value=v),e.k&&(u[e.k]=v)}}else g?(u[o]=l,p(o)&&(d[o]=l)):k&&(m(o,e.k)&&(o.value=l),e.k&&(u[e.k]=l))};if(l){const b=()=>{E(),pl.delete(e)};b.id=-1,pl.set(e,b),mt(b,s)}else au(e),E()}}}function au(e){const t=pl.get(e);t&&(t.flags|=8,pl.delete(e))}let iu=!1;const Xn=()=>{iu||(console.error("Hydration completed but contains mismatches."),iu=!0)},av=e=>e.namespaceURI.includes("svg")&&e.tagName!=="foreignObject",iv=e=>e.namespaceURI.includes("MathML"),ji=e=>{if(e.nodeType===1){if(av(e))return"svg";if(iv(e))return"mathml"}},oa=e=>e.nodeType===8;function lv(e){const{mt:t,p:s,o:{patchProp:n,createText:a,nextSibling:i,parentNode:l,remove:r,insert:o,createComment:c}}=e,u=(v,x)=>{if(!x.hasChildNodes()){s(null,v,x),fl(),x._vnode=v;return}d(x.firstChild,v,null,null,null),fl(),x._vnode=v},d=(v,x,w,N,O,S=!1)=>{S=S||!!x.dynamicChildren;const R=oa(v)&&v.data==="[",L=()=>g(v,x,w,N,O,R),{type:H,ref:P,shapeFlag:T,patchFlag:U}=x;let K=v.nodeType;x.el=v,U===-2&&(S=!1,x.dynamicChildren=null);let G=null;switch(H){case bn:K!==3?x.children===""?(o(x.el=a(""),l(v),v),G=v):G=L():(v.data!==x.children&&(Xn(),v.data=x.children),G=i(v));break;case pt:b(v)?(G=i(v),E(x.el=v.content.firstChild,v,w)):K!==8||R?G=L():G=i(v);break;case Dn:if(R&&(v=i(v),K=v.nodeType),K===1||K===3){G=v;const D=!x.children.length;for(let I=0;I<x.staticCount;I++)D&&(x.children+=G.nodeType===1?G.outerHTML:G.data),I===x.staticCount-1&&(x.anchor=G),G=i(G);return R?i(G):G}else L();break;case At:R?G=m(v,x,w,N,O,S):G=L();break;default:if(T&1)(K!==1||x.type.toLowerCase()!==v.tagName.toLowerCase())&&!b(v)?G=L():G=f(v,x,w,N,O,S);else if(T&6){x.slotScopeIds=O;const D=l(v);if(R?G=k(v):oa(v)&&v.data==="teleport start"?G=k(v,v.data,"teleport end"):G=i(v),t(x,D,null,w,N,ji(D),S),Qs(x)&&!x.type.__asyncResolved){let I;R?(I=lt(At),I.anchor=G?G.previousSibling:D.lastChild):I=v.nodeType===3?Jo(""):lt("div"),I.el=v,x.component.subTree=I}}else T&64?K!==8?G=L():G=x.type.hydrate(v,x,w,N,O,S,e,p):T&128&&(G=x.type.hydrate(v,x,w,N,ji(l(v)),O,S,e,d))}return P!=null&&ha(P,null,N,x),G},f=(v,x,w,N,O,S)=>{S=S||!!x.dynamicChildren;const{type:R,props:L,patchFlag:H,shapeFlag:P,dirs:T,transition:U}=x,K=R==="input"||R==="option";if(K||H!==-1){T&&Ns(x,null,w,"created");let G=!1;if(b(v)){G=rp(null,U)&&w&&w.vnode.props&&w.vnode.props.appear;const I=v.content.firstChild;if(G){const j=I.getAttribute("class");j&&(I.$cls=j),U.beforeEnter(I)}E(I,v,w),x.el=v=I}if(P&16&&!(L&&(L.innerHTML||L.textContent))){let I=p(v.firstChild,x,v,w,N,O,S);for(I&&!zi(v,1)&&Xn();I;){const j=I;I=I.nextSibling,r(j)}}else if(P&8){let I=x.children;I[0]===`
`&&(v.tagName==="PRE"||v.tagName==="TEXTAREA")&&(I=I.slice(1));const{textContent:j}=v;j!==I&&j!==I.replace(/\r\n|\r/g,`
`)&&(zi(v,0)||Xn(),v.textContent=x.children)}if(L){if(K||!S||H&48){const I=v.tagName.includes("-");for(const j in L)(K&&(j.endsWith("value")||j==="indeterminate")||Vn(j)&&!Js(j)||j[0]==="."||I&&!Js(j))&&n(v,j,null,L[j],void 0,w)}else if(L.onClick)n(v,"onClick",null,L.onClick,void 0,w);else if(H&4&&Ys(L.style))for(const I in L.style)L.style[I]}let D;(D=L&&L.onVnodeBeforeMount)&&Yt(D,w,x),T&&Ns(x,null,w,"beforeMount"),((D=L&&L.onVnodeMounted)||T||G)&&dp(()=>{D&&Yt(D,w,x),G&&U.enter(v),T&&Ns(x,null,w,"mounted")},N)}return v.nextSibling},p=(v,x,w,N,O,S,R)=>{R=R||!!x.dynamicChildren;const L=x.children,H=L.length;let P=!1;for(let T=0;T<H;T++){const U=R?L[T]:L[T]=Xt(L[T]),K=U.type===bn;v?(K&&!R&&T+1<H&&Xt(L[T+1]).type===bn&&(o(a(v.data.slice(U.children.length)),w,i(v)),v.data=U.children),v=d(v,U,N,O,S,R)):K&&!U.children?o(U.el=a(""),w):(P||(P=!0,zi(w,1)||Xn()),s(null,U,w,null,N,O,ji(w),S))}return v},m=(v,x,w,N,O,S)=>{const{slotScopeIds:R}=x;R&&(O=O?O.concat(R):R);const L=l(v),H=p(i(v),x,L,w,N,O,S);return H&&oa(H)&&H.data==="]"?i(x.anchor=H):(Xn(),o(x.anchor=c("]"),L,H),H)},g=(v,x,w,N,O,S)=>{if(zi(v.parentElement,1)||Xn(),x.el=null,S){const H=k(v);for(;;){const P=i(v);if(P&&P!==H)r(P);else break}}const R=i(v),L=l(v);return r(v),s(null,x,L,R,w,N,ji(L),O),w&&(w.vnode.el=x.el,er(w,x.el)),R},k=(v,x="[",w="]")=>{let N=0;for(;v;)if(v=i(v),v&&oa(v)&&(v.data===x&&N++,v.data===w)){if(N===0)return i(v);N--}return v},E=(v,x,w)=>{const N=x.parentNode;N&&N.replaceChild(v,x);let O=w;for(;O;)O.vnode.el===x&&(O.vnode.el=O.subTree.el=v),O=O.parent},b=v=>v.nodeType===1&&v.tagName==="TEMPLATE";return[u,d]}const lu="data-allow-mismatch",rv={0:"text",1:"children",2:"class",3:"style",4:"attribute"};function zi(e,t){if(t===0||t===1)for(;e&&!e.hasAttribute(lu);)e=e.parentElement;const s=e&&e.getAttribute(lu);if(s==null)return!1;if(s==="")return!0;{const n=s.split(",");return t===0&&n.includes("children")?!0:n.includes(rv[t])}}const ov=Vl().requestIdleCallback||(e=>setTimeout(e,1)),cv=Vl().cancelIdleCallback||(e=>clearTimeout(e)),uv=(e=1e4)=>t=>{const s=ov(t,{timeout:e});return()=>cv(s)};function dv(e){const{top:t,left:s,bottom:n,right:a}=e.getBoundingClientRect(),{innerHeight:i,innerWidth:l}=window;return(t>0&&t<i||n>0&&n<i)&&(s>0&&s<l||a>0&&a<l)}const fv=e=>(t,s)=>{const n=new IntersectionObserver(a=>{for(const i of a)if(i.isIntersecting){n.disconnect(),t();break}},e);return s(a=>{if(a instanceof Element){if(dv(a))return t(),n.disconnect(),!1;n.observe(a)}}),()=>n.disconnect()},pv=e=>t=>{if(e){const s=matchMedia(e);if(s.matches)t();else return s.addEventListener("change",t,{once:!0}),()=>s.removeEventListener("change",t)}},hv=(e=[])=>(t,s)=>{Ce(e)&&(e=[e]);let n=!1;const a=l=>{n||(n=!0,i(),t(),l.target.dispatchEvent(new l.constructor(l.type,l)))},i=()=>{s(l=>{for(const r of e)l.removeEventListener(r,a)})};return s(l=>{for(const r of e)l.addEventListener(r,a,{once:!0})}),i};function gv(e,t){if(oa(e)&&e.data==="["){let s=1,n=e.nextSibling;for(;n;){if(n.nodeType===1){if(t(n)===!1)break}else if(oa(n))if(n.data==="]"){if(--s===0)break}else n.data==="["&&s++;n=n.nextSibling}}else t(e)}const Qs=e=>!!e.type.__asyncLoader;function mv(e){we(e)&&(e={loader:e});const{loader:t,loadingComponent:s,errorComponent:n,delay:a=200,hydrate:i,timeout:l,suspensible:r=!0,onError:o}=e;let c=null,u,d=0;const f=()=>(d++,c=null,p()),p=()=>{let m;return c||(m=c=t().catch(g=>{if(g=g instanceof Error?g:new Error(String(g)),o)return new Promise((k,E)=>{o(g,()=>k(f()),()=>E(g),d+1)});throw g}).then(g=>m!==c&&c?c:(g&&(g.__esModule||g[Symbol.toStringTag]==="Module")&&(g=g.default),u=g,g)))};return Ai({name:"AsyncComponentWrapper",__asyncLoader:p,__asyncHydrate(m,g,k){let E=!1;(g.bu||(g.bu=[])).push(()=>E=!0);const b=()=>{E||k()},v=i?()=>{const x=i(b,w=>gv(m,w));x&&(g.bum||(g.bum=[])).push(x)}:b;u?v():p().then(()=>!g.isUnmounted&&v())},get __asyncResolved(){return u},setup(){const m=Nt;if($o(m),u)return()=>qi(u,m);const g=w=>{c=null,qn(w,m,13,!n)};if(r&&m.suspense||Un)return p().then(w=>()=>qi(w,m)).catch(w=>(g(w),()=>n?lt(n,{error:w}):null));const k=h(!1),E=h(),b=h(!!a);let v,x;return ht(()=>{v!=null&&clearTimeout(v),x!=null&&clearTimeout(x)}),a&&(x=setTimeout(()=>{m.isUnmounted||(b.value=!1)},a)),l!=null&&(v=setTimeout(()=>{if(!m.isUnmounted&&!k.value&&!E.value){const w=new Error(`Async component timed out after ${l}ms.`);g(w),E.value=w}},l)),p().then(()=>{m.isUnmounted||(k.value=!0,m.parent&&Ri(m.parent.vnode)&&m.parent.update())}).catch(w=>{if(m.isUnmounted){c=null;return}g(w),E.value=w}),()=>{if(k.value&&u)return qi(u,m);if(E.value&&n)return lt(n,{error:E.value});if(s&&!b.value)return qi(s,m)}}})}function qi(e,t){const{ref:s,props:n,children:a,ce:i}=t.vnode,l=lt(e,n,a);return l.ref=s,l.ce=i,delete t.vnode.ce,l}const Ri=e=>e.type.__isKeepAlive,vv={name:"KeepAlive",__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){const s=Gt(),n=s.ctx;if(!n.renderer)return()=>{const b=t.default&&t.default();return b&&b.length===1?b[0]:b};const a=new Map,i=new Set;let l=null;const r=s.suspense,{renderer:{p:o,m:c,um:u,o:{createElement:d}}}=n,f=d("div");n.activate=(b,v,x,w,N)=>{const O=b.component;c(b,v,x,0,r),o(O.vnode,b,v,x,O,r,w,b.slotScopeIds,N),mt(()=>{O.isDeactivated=!1,O.a&&fa(O.a);const S=b.props&&b.props.onVnodeMounted;S&&Yt(S,O.parent,b)},r)},n.deactivate=b=>{const v=b.component;gl(v.m),gl(v.a),c(b,f,null,1,r),mt(()=>{v.da&&fa(v.da);const x=b.props&&b.props.onVnodeUnmounted;x&&Yt(x,v.parent,b),v.isDeactivated=!0},r)};function p(b){_r(b),u(b,s,r,!0)}function m(b){a.forEach((v,x)=>{const w=so(Qs(v)?v.type.__asyncResolved||{}:v.type);w&&!b(w)&&g(x)})}function g(b){const v=a.get(b);v&&(!l||!ys(v,l))?p(v):l&&_r(l),a.delete(b),i.delete(b)}hs(()=>[e.include,e.exclude],([b,v])=>{b&&m(x=>Ka(b,x)),v&&m(x=>!Ka(v,x))},{flush:"post",deep:!0});let k=null;const E=()=>{k!=null&&(ml(s.subTree.type)?mt(()=>{a.set(k,Ki(s.subTree))},s.subTree.suspense):a.set(k,Ki(s.subTree)))};return Be(E),Yl(E),Ql(()=>{a.forEach(b=>{const{subTree:v,suspense:x}=s,w=Ki(v);if(b.type===w.type&&b.key===w.key){_r(w);const N=w.component.da;N&&mt(N,x);return}p(b)})}),()=>{if(k=null,!t.default)return l=null;const b=t.default(),v=b[0];if(b.length>1)return l=null,b;if(!an(v)||!(v.shapeFlag&4)&&!(v.shapeFlag&128))return l=null,v;let x=Ki(v);if(x.type===pt)return l=null,x;const w=x.type,N=so(Qs(x)?x.type.__asyncResolved||{}:w),{include:O,exclude:S,max:R}=e;if(O&&(!N||!Ka(O,N))||S&&N&&Ka(S,N))return x.shapeFlag&=-257,l=x,v;const L=x.key==null?w:x.key,H=a.get(L);return x.el&&(x=Ms(x),v.shapeFlag&128&&(v.ssContent=x)),k=L,H?(x.el=H.el,x.component=H.component,x.transition&&nn(x,x.transition),x.shapeFlag|=512,i.delete(L),i.add(L)):(i.add(L),R&&i.size>parseInt(R,10)&&g(i.values().next().value)),x.shapeFlag|=256,l=x,ml(v.type)?v:x}}},bv=vv;function Ka(e,t){return ge(e)?e.some(s=>Ka(s,t)):Ce(e)?e.split(",").includes(t):Ag(e)?(e.lastIndex=0,e.test(t)):!1}function Uo(e,t){Ff(e,"a",t)}function Bo(e,t){Ff(e,"da",t)}function Ff(e,t,s=Nt){const n=e.__wdc||(e.__wdc=()=>{let a=s;for(;a;){if(a.isDeactivated)return;a=a.parent}return e()});if(Jl(t,n,s),s){let a=s.parent;for(;a&&a.parent;)Ri(a.parent.vnode)&&yv(n,t,s,a),a=a.parent}}function yv(e,t,s,n){const a=Jl(t,e,n,!0);ht(()=>{To(n[t],a)},s)}function _r(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function Ki(e){return e.shapeFlag&128?e.ssContent:e}function Jl(e,t,s=Nt,n=!1){if(s){const a=s[e]||(s[e]=[]),i=t.__weh||(t.__weh=(...l)=>{tn();const r=Oa(s),o=is(t,s,e,l);return r(),sn(),o});return n?a.unshift(i):a.push(i),i}}const ln=e=>(t,s=Nt)=>{(!Un||e==="sp")&&Jl(e,(...n)=>t(...n),s)},$f=ln("bm"),Be=ln("m"),Ho=ln("bu"),Yl=ln("u"),Ql=ln("bum"),ht=ln("um"),Uf=ln("sp"),Bf=ln("rtg"),Hf=ln("rtc");function Vf(e,t=Nt){Jl("ec",e,t)}const Vo="components",xv="directives";function _v(e,t){return jo(Vo,e,!0,t)||e}const jf=Symbol.for("v-ndc");function kv(e){return Ce(e)?jo(Vo,e,!1)||e:e||jf}function wv(e){return jo(xv,e)}function jo(e,t,s=!0,n=!1){const a=Ot||Nt;if(a){const i=a.type;if(e===Vo){const r=so(i,!1);if(r&&(r===t||r===Qe(t)||r===zn(Qe(t))))return i}const l=ru(a[e]||i[e],t)||ru(a.appContext[e],t);return!l&&n?i:l}}function ru(e,t){return e&&(e[t]||e[Qe(t)]||e[zn(Qe(t))])}function Sv(e,t,s,n){let a;const i=s&&s[n],l=ge(e);if(l||Ce(e)){const r=l&&Ys(e);let o=!1,c=!1;r&&(o=!ss(e),c=Ds(e),e=ql(e)),a=new Array(e.length);for(let u=0,d=e.length;u<d;u++)a[u]=t(o?c?ba(ks(e[u])):ks(e[u]):e[u],u,void 0,i&&i[u])}else if(typeof e=="number"){a=new Array(e);for(let r=0;r<e;r++)a[r]=t(r+1,r,void 0,i&&i[r])}else if(Ve(e))if(e[Symbol.iterator])a=Array.from(e,(r,o)=>t(r,o,void 0,i&&i[o]));else{const r=Object.keys(e);a=new Array(r.length);for(let o=0,c=r.length;o<c;o++){const u=r[o];a[o]=t(e[u],u,o,i&&i[o])}}else a=[];return s&&(s[n]=a),a}function Tv(e,t){for(let s=0;s<t.length;s++){const n=t[s];if(ge(n))for(let a=0;a<n.length;a++)e[n[a].name]=n[a].fn;else n&&(e[n.name]=n.key?(...a)=>{const i=n.fn(...a);return i&&(i.key=n.key),i}:n.fn)}return e}function Cv(e,t,s={},n,a){if(Ot.ce||Ot.parent&&Qs(Ot.parent)&&Ot.parent.ce){const c=Object.keys(s).length>0;return t!=="default"&&(s.name=t),hi(),vl(At,null,[lt("slot",s,n&&n())],c?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),hi();const l=i&&zo(i(s)),r=s.key||l&&l.key,o=vl(At,{key:(r&&!Ht(r)?r:`_${t}`)+(!l&&n?"_fb":"")},l||(n?n():[]),l&&e._===1?64:-2);return!a&&o.scopeId&&(o.slotScopeIds=[o.scopeId+"-s"]),i&&i._c&&(i._d=!0),o}function zo(e){return e.some(t=>an(t)?!(t.type===pt||t.type===At&&!zo(t.children)):!0)?e:null}function Ev(e,t){const s={};for(const n in e)s[t&&/[A-Z]/.test(n)?`on:${n}`:da(n)]=e[n];return s}const Wr=e=>e?yp(e)?Ii(e):Wr(e.parent):null,Xa=Me(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Wr(e.parent),$root:e=>Wr(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>qo(e),$forceUpdate:e=>e.f||(e.f=()=>{Do(e.update)}),$nextTick:e=>e.n||(e.n=Et.bind(e.proxy)),$watch:e=>Jm.bind(e)}),kr=(e,t)=>e!==Fe&&!e.__isScriptSetup&&je(e,t),Zr={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:a,props:i,accessCache:l,type:r,appContext:o}=e;if(t[0]!=="$"){const f=l[t];if(f!==void 0)switch(f){case 1:return n[t];case 2:return a[t];case 4:return s[t];case 3:return i[t]}else{if(kr(n,t))return l[t]=1,n[t];if(a!==Fe&&je(a,t))return l[t]=2,a[t];if(je(i,t))return l[t]=3,i[t];if(s!==Fe&&je(s,t))return l[t]=4,s[t];Jr&&(l[t]=0)}}const c=Xa[t];let u,d;if(c)return t==="$attrs"&&$t(e.attrs,"get",""),c(e);if((u=r.__cssModules)&&(u=u[t]))return u;if(s!==Fe&&je(s,t))return l[t]=4,s[t];if(d=o.config.globalProperties,je(d,t))return d[t]},set({_:e},t,s){const{data:n,setupState:a,ctx:i}=e;return kr(a,t)?(a[t]=s,!0):n!==Fe&&je(n,t)?(n[t]=s,!0):je(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:a,props:i,type:l}},r){let o;return!!(s[r]||e!==Fe&&r[0]!=="$"&&je(e,r)||kr(t,r)||je(i,r)||je(n,r)||je(Xa,r)||je(a.config.globalProperties,r)||(o=l.__cssModules)&&o[r])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:je(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}},Av=Me({},Zr,{get(e,t){if(t!==Symbol.unscopables)return Zr.get(e,t,e)},has(e,t){return t[0]!=="_"&&!Mg(t)}});function Rv(){return null}function Iv(){return null}function Nv(e){}function Ov(e){}function Lv(){return null}function Dv(){}function Mv(e,t){return null}function Pv(){return zf().slots}function Fv(){return zf().attrs}function zf(e){const t=Gt();return t.setupContext||(t.setupContext=wp(t))}function fi(e){return ge(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}function $v(e,t){const s=fi(e);for(const n in t){if(n.startsWith("__skip"))continue;let a=s[n];a?ge(a)||we(a)?a=s[n]={type:a,default:t[n]}:a.default=t[n]:a===null&&(a=s[n]={default:t[n]}),a&&t[`__skip_${n}`]&&(a.skipFactory=!0)}return s}function Uv(e,t){return!e||!t?e||t:ge(e)&&ge(t)?e.concat(t):Me({},fi(e),fi(t))}function Bv(e,t){const s={};for(const n in e)t.includes(n)||Object.defineProperty(s,n,{enumerable:!0,get:()=>e[n]});return s}function Hv(e){const t=Gt(),s=Un;let n=e();mi(),s&&ma(!1);const a=()=>{Oa(t),s&&ma(!0)},i=()=>{Gt()!==t&&t.scope.off(),mi(),s&&ma(!1)};return Co(n)&&(n=n.catch(l=>{throw a(),Promise.resolve().then(()=>Promise.resolve().then(i)),l})),[n,()=>{a(),Promise.resolve().then(i)}]}let Jr=!0;function Vv(e){const t=qo(e),s=e.proxy,n=e.ctx;Jr=!1,t.beforeCreate&&ou(t.beforeCreate,e,"bc");const{data:a,computed:i,methods:l,watch:r,provide:o,inject:c,created:u,beforeMount:d,mounted:f,beforeUpdate:p,updated:m,activated:g,deactivated:k,beforeDestroy:E,beforeUnmount:b,destroyed:v,unmounted:x,render:w,renderTracked:N,renderTriggered:O,errorCaptured:S,serverPrefetch:R,expose:L,inheritAttrs:H,components:P,directives:T,filters:U}=t;if(c&&jv(c,n,null),l)for(const D in l){const I=l[D];we(I)&&(n[D]=I.bind(s))}if(a){const D=a.call(s,s);Ve(D)&&(e.data=_n(D))}if(Jr=!0,i)for(const D in i){const I=i[D],j=we(I)?I.bind(s,s):we(I.get)?I.get.bind(s,s):Lt,ce=!we(I)&&we(I.set)?I.set.bind(s):Lt,oe=X({get:j,set:ce});Object.defineProperty(n,D,{enumerable:!0,configurable:!0,get:()=>oe.value,set:se=>oe.value=se})}if(r)for(const D in r)qf(r[D],n,s,D);if(o){const D=we(o)?o.call(s):o;Reflect.ownKeys(D).forEach(I=>{Qa(I,D[I])})}u&&ou(u,e,"c");function G(D,I){ge(I)?I.forEach(j=>D(j.bind(s))):I&&D(I.bind(s))}if(G($f,d),G(Be,f),G(Ho,p),G(Yl,m),G(Uo,g),G(Bo,k),G(Vf,S),G(Hf,N),G(Bf,O),G(Ql,b),G(ht,x),G(Uf,R),ge(L))if(L.length){const D=e.exposed||(e.exposed={});L.forEach(I=>{Object.defineProperty(D,I,{get:()=>s[I],set:j=>s[I]=j,enumerable:!0})})}else e.exposed||(e.exposed={});w&&e.render===Lt&&(e.render=w),H!=null&&(e.inheritAttrs=H),P&&(e.components=P),T&&(e.directives=T),R&&$o(e)}function jv(e,t,s=Lt){ge(e)&&(e=Yr(e));for(const n in e){const a=e[n];let i;Ve(a)?"default"in a?i=ps(a.from||n,a.default,!0):i=ps(a.from||n):i=ps(a),bt(i)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>i.value,set:l=>i.value=l}):t[n]=i}}function ou(e,t,s){is(ge(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function qf(e,t,s,n){let a=n.includes(".")?If(s,n):()=>s[n];if(Ce(e)){const i=t[e];we(i)&&hs(a,i)}else if(we(e))hs(a,e.bind(s));else if(Ve(e))if(ge(e))e.forEach(i=>qf(i,t,s,n));else{const i=we(e.handler)?e.handler.bind(s):t[e.handler];we(i)&&hs(a,i,e)}}function qo(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:a,optionsCache:i,config:{optionMergeStrategies:l}}=e.appContext,r=i.get(t);let o;return r?o=r:!a.length&&!s&&!n?o=t:(o={},a.length&&a.forEach(c=>hl(o,c,l,!0)),hl(o,t,l)),Ve(t)&&i.set(t,o),o}function hl(e,t,s,n=!1){const{mixins:a,extends:i}=t;i&&hl(e,i,s,!0),a&&a.forEach(l=>hl(e,l,s,!0));for(const l in t)if(!(n&&l==="expose")){const r=zv[l]||s&&s[l];e[l]=r?r(e[l],t[l]):t[l]}return e}const zv={data:cu,props:uu,emits:uu,methods:Ga,computed:Ga,beforeCreate:Vt,created:Vt,beforeMount:Vt,mounted:Vt,beforeUpdate:Vt,updated:Vt,beforeDestroy:Vt,beforeUnmount:Vt,destroyed:Vt,unmounted:Vt,activated:Vt,deactivated:Vt,errorCaptured:Vt,serverPrefetch:Vt,components:Ga,directives:Ga,watch:Kv,provide:cu,inject:qv};function cu(e,t){return t?e?function(){return Me(we(e)?e.call(this,this):e,we(t)?t.call(this,this):t)}:t:e}function qv(e,t){return Ga(Yr(e),Yr(t))}function Yr(e){if(ge(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Vt(e,t){return e?[...new Set([].concat(e,t))]:t}function Ga(e,t){return e?Me(Object.create(null),e,t):t}function uu(e,t){return e?ge(e)&&ge(t)?[...new Set([...e,...t])]:Me(Object.create(null),fi(e),fi(t??{})):t}function Kv(e,t){if(!e)return t;if(!t)return e;const s=Me(Object.create(null),e);for(const n in t)s[n]=Vt(e[n],t[n]);return s}function Kf(){return{app:null,config:{isNativeTag:ra,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Gv=0;function Wv(e,t){return function(n,a=null){we(n)||(n=Me({},n)),a!=null&&!Ve(a)&&(a=null);const i=Kf(),l=new WeakSet,r=[];let o=!1;const c=i.app={_uid:Gv++,_component:n,_props:a,_container:null,_context:i,_instance:null,version:Tp,get config(){return i.config},set config(u){},use(u,...d){return l.has(u)||(u&&we(u.install)?(l.add(u),u.install(c,...d)):we(u)&&(l.add(u),u(c,...d))),c},mixin(u){return i.mixins.includes(u)||i.mixins.push(u),c},component(u,d){return d?(i.components[u]=d,c):i.components[u]},directive(u,d){return d?(i.directives[u]=d,c):i.directives[u]},mount(u,d,f){if(!o){const p=c._ceVNode||lt(n,a);return p.appContext=i,f===!0?f="svg":f===!1&&(f=void 0),d&&t?t(p,u):e(p,u,f),o=!0,c._container=u,u.__vue_app__=c,Ii(p.component)}},onUnmount(u){r.push(u)},unmount(){o&&(is(r,c._instance,16),e(null,c._container),delete c._container.__vue_app__)},provide(u,d){return i.provides[u]=d,c},runWithContext(u){const d=Ln;Ln=c;try{return u()}finally{Ln=d}}};return c}}let Ln=null;function Zv(e,t,s=Fe){const n=Gt(),a=Qe(t),i=es(t),l=Gf(e,a),r=yf((o,c)=>{let u,d=Fe,f;return Rf(()=>{const p=e[a];Ct(u,p)&&(u=p,c())}),{get(){return o(),s.get?s.get(u):u},set(p){const m=s.set?s.set(p):p;if(!Ct(m,u)&&!(d!==Fe&&Ct(p,d)))return;const g=n.vnode.props,k=!!(g&&(t in g||a in g||i in g)&&(`onUpdate:${t}`in g||`onUpdate:${a}`in g||`onUpdate:${i}`in g));k||(u=p,c()),n.emit(`update:${t}`,m),Ct(p,d)&&(Ct(p,m)&&!Ct(m,f)||k&&d!==Fe&&!Ct(m,u))&&c(),d=p,f=m}}});return r[Symbol.iterator]=()=>{let o=0;return{next(){return o<2?{value:o++?l||Fe:r,done:!1}:{done:!0}}}},r}const Gf=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Qe(t)}Modifiers`]||e[`${es(t)}Modifiers`];function Jv(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||Fe;let a=s;const i=t.startsWith("update:"),l=i&&Gf(n,t.slice(7));l&&(l.trim&&(a=s.map(u=>Ce(u)?u.trim():u)),l.number&&(a=s.map(Hl)));let r,o=n[r=da(t)]||n[r=da(Qe(t))];!o&&i&&(o=n[r=da(es(t))]),o&&is(o,e,6,a);const c=n[r+"Once"];if(c){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,is(c,e,6,a)}}const Yv=new WeakMap;function Wf(e,t,s=!1){const n=s?Yv:t.emitsCache,a=n.get(e);if(a!==void 0)return a;const i=e.emits;let l={},r=!1;if(!we(e)){const o=c=>{const u=Wf(c,t,!0);u&&(r=!0,Me(l,u))};!s&&t.mixins.length&&t.mixins.forEach(o),e.extends&&o(e.extends),e.mixins&&e.mixins.forEach(o)}return!i&&!r?(Ve(e)&&n.set(e,null),null):(ge(i)?i.forEach(o=>l[o]=null):Me(l,i),Ve(e)&&n.set(e,l),l)}function Xl(e,t){return!e||!Vn(t)?!1:(t=t.slice(2).replace(/Once$/,""),je(e,t[0].toLowerCase()+t.slice(1))||je(e,es(t))||je(e,t))}function el(e){const{type:t,vnode:s,proxy:n,withProxy:a,propsOptions:[i],slots:l,attrs:r,emit:o,render:c,renderCache:u,props:d,data:f,setupState:p,ctx:m,inheritAttrs:g}=e,k=di(e);let E,b;try{if(s.shapeFlag&4){const x=a||n,w=x;E=Xt(c.call(w,x,u,d,p,f,m)),b=r}else{const x=t;E=Xt(x.length>1?x(d,{attrs:r,slots:l,emit:o}):x(d,null)),b=t.props?r:Xv(r)}}catch(x){ei.length=0,qn(x,e,1),E=lt(pt)}let v=E;if(b&&g!==!1){const x=Object.keys(b),{shapeFlag:w}=v;x.length&&w&7&&(i&&x.some(Fl)&&(b=eb(b,i)),v=Ms(v,b,!1,!0))}return s.dirs&&(v=Ms(v,null,!1,!0),v.dirs=v.dirs?v.dirs.concat(s.dirs):s.dirs),s.transition&&nn(v,s.transition),E=v,di(k),E}function Qv(e,t=!0){let s;for(let n=0;n<e.length;n++){const a=e[n];if(an(a)){if(a.type!==pt||a.children==="v-if"){if(s)return;s=a}}else return}return s}const Xv=e=>{let t;for(const s in e)(s==="class"||s==="style"||Vn(s))&&((t||(t={}))[s]=e[s]);return t},eb=(e,t)=>{const s={};for(const n in e)(!Fl(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function tb(e,t,s){const{props:n,children:a,component:i}=e,{props:l,children:r,patchFlag:o}=t,c=i.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&o>=0){if(o&1024)return!0;if(o&16)return n?du(n,l,c):!!l;if(o&8){const u=t.dynamicProps;for(let d=0;d<u.length;d++){const f=u[d];if(Zf(l,n,f)&&!Xl(c,f))return!0}}}else return(a||r)&&(!r||!r.$stable)?!0:n===l?!1:n?l?du(n,l,c):!0:!!l;return!1}function du(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let a=0;a<n.length;a++){const i=n[a];if(Zf(t,e,i)&&!Xl(s,i))return!0}return!1}function Zf(e,t,s){const n=e[s],a=t[s];return s==="style"&&Ve(n)&&Ve(a)?!en(n,a):n!==a}function er({vnode:e,parent:t,suspense:s},n){for(;t;){const a=t.subTree;if(a.suspense&&a.suspense.activeBranch===e&&(a.suspense.vnode.el=a.el=n,e=a),a===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const Jf={},Yf=()=>Object.create(Jf),Qf=e=>Object.getPrototypeOf(e)===Jf;function sb(e,t,s,n=!1){const a={},i=Yf();e.propsDefaults=Object.create(null),Xf(e,t,a,i);for(const l in e.propsOptions[0])l in a||(a[l]=void 0);s?e.props=n?a:No(a):e.type.props?e.props=a:e.props=i,e.attrs=i}function nb(e,t,s,n){const{props:a,attrs:i,vnode:{patchFlag:l}}=e,r=Ue(a),[o]=e.propsOptions;let c=!1;if((n||l>0)&&!(l&16)){if(l&8){const u=e.vnode.dynamicProps;for(let d=0;d<u.length;d++){let f=u[d];if(Xl(e.emitsOptions,f))continue;const p=t[f];if(o)if(je(i,f))p!==i[f]&&(i[f]=p,c=!0);else{const m=Qe(f);a[m]=Qr(o,r,m,p,e,!1)}else p!==i[f]&&(i[f]=p,c=!0)}}}else{Xf(e,t,a,i)&&(c=!0);let u;for(const d in r)(!t||!je(t,d)&&((u=es(d))===d||!je(t,u)))&&(o?s&&(s[d]!==void 0||s[u]!==void 0)&&(a[d]=Qr(o,r,d,void 0,e,!0)):delete a[d]);if(i!==r)for(const d in i)(!t||!je(t,d))&&(delete i[d],c=!0)}c&&qs(e.attrs,"set","")}function Xf(e,t,s,n){const[a,i]=e.propsOptions;let l=!1,r;if(t)for(let o in t){if(Js(o))continue;const c=t[o];let u;a&&je(a,u=Qe(o))?!i||!i.includes(u)?s[u]=c:(r||(r={}))[u]=c:Xl(e.emitsOptions,o)||(!(o in n)||c!==n[o])&&(n[o]=c,l=!0)}if(i){const o=Ue(s),c=r||Fe;for(let u=0;u<i.length;u++){const d=i[u];s[d]=Qr(a,o,d,c[d],e,!je(c,d))}}return l}function Qr(e,t,s,n,a,i){const l=e[s];if(l!=null){const r=je(l,"default");if(r&&n===void 0){const o=l.default;if(l.type!==Function&&!l.skipFactory&&we(o)){const{propsDefaults:c}=a;if(s in c)n=c[s];else{const u=Oa(a);n=c[s]=o.call(null,t),u()}}else n=o;a.ce&&a.ce._setProp(s,n)}l[0]&&(i&&!r?n=!1:l[1]&&(n===""||n===es(s))&&(n=!0))}return n}const ab=new WeakMap;function ep(e,t,s=!1){const n=s?ab:t.propsCache,a=n.get(e);if(a)return a;const i=e.props,l={},r=[];let o=!1;if(!we(e)){const u=d=>{o=!0;const[f,p]=ep(d,t,!0);Me(l,f),p&&r.push(...p)};!s&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!i&&!o)return Ve(e)&&n.set(e,ca),ca;if(ge(i))for(let u=0;u<i.length;u++){const d=Qe(i[u]);fu(d)&&(l[d]=Fe)}else if(i)for(const u in i){const d=Qe(u);if(fu(d)){const f=i[u],p=l[d]=ge(f)||we(f)?{type:f}:Me({},f),m=p.type;let g=!1,k=!0;if(ge(m))for(let E=0;E<m.length;++E){const b=m[E],v=we(b)&&b.name;if(v==="Boolean"){g=!0;break}else v==="String"&&(k=!1)}else g=we(m)&&m.name==="Boolean";p[0]=g,p[1]=k,(g||je(p,"default"))&&r.push(d)}}const c=[l,r];return Ve(e)&&n.set(e,c),c}function fu(e){return e[0]!=="$"&&!Js(e)}const Ko=e=>e==="_"||e==="_ctx"||e==="$stable",Go=e=>ge(e)?e.map(Xt):[Xt(e)],ib=(e,t,s)=>{if(t._n)return t;const n=Mo((...a)=>Go(t(...a)),s);return n._c=!1,n},tp=(e,t,s)=>{const n=e._ctx;for(const a in e){if(Ko(a))continue;const i=e[a];if(we(i))t[a]=ib(a,i,n);else if(i!=null){const l=Go(i);t[a]=()=>l}}},sp=(e,t)=>{const s=Go(t);e.slots.default=()=>s},np=(e,t,s)=>{for(const n in t)(s||!Ko(n))&&(e[n]=t[n])},lb=(e,t,s)=>{const n=e.slots=Yf();if(e.vnode.shapeFlag&32){const a=t._;a?(np(n,t,s),s&&Wd(n,"_",a,!0)):tp(t,n)}else t&&sp(e,t)},rb=(e,t,s)=>{const{vnode:n,slots:a}=e;let i=!0,l=Fe;if(n.shapeFlag&32){const r=t._;r?s&&r===1?i=!1:np(a,t,s):(i=!t.$stable,tp(t,a)),l=t}else t&&(sp(e,t),l={default:1});if(i)for(const r in a)!Ko(r)&&l[r]==null&&delete a[r]},mt=dp;function ap(e){return lp(e)}function ip(e){return lp(e,lv)}function lp(e,t){const s=Vl();s.__VUE__=!0;const{insert:n,remove:a,patchProp:i,createElement:l,createText:r,createComment:o,setText:c,setElementText:u,parentNode:d,nextSibling:f,setScopeId:p=Lt,insertStaticContent:m}=e,g=(y,C,M,W=null,A=null,$=null,J=void 0,Q=null,te=!!C.dynamicChildren)=>{if(y===C)return;y&&!ys(y,C)&&(W=F(y),se(y,A,$,!0),y=null),C.patchFlag===-2&&(te=!1,C.dynamicChildren=null);const{type:Y,ref:me,shapeFlag:ae}=C;switch(Y){case bn:k(y,C,M,W);break;case pt:E(y,C,M,W);break;case Dn:y==null&&b(C,M,W,J);break;case At:P(y,C,M,W,A,$,J,Q,te);break;default:ae&1?w(y,C,M,W,A,$,J,Q,te):ae&6?T(y,C,M,W,A,$,J,Q,te):(ae&64||ae&128)&&Y.process(y,C,M,W,A,$,J,Q,te,pe)}me!=null&&A?ha(me,y&&y.ref,$,C||y,!C):me==null&&y&&y.ref!=null&&ha(y.ref,null,$,y,!0)},k=(y,C,M,W)=>{if(y==null)n(C.el=r(C.children),M,W);else{const A=C.el=y.el;C.children!==y.children&&c(A,C.children)}},E=(y,C,M,W)=>{y==null?n(C.el=o(C.children||""),M,W):C.el=y.el},b=(y,C,M,W)=>{[y.el,y.anchor]=m(y.children,C,M,W,y.el,y.anchor)},v=({el:y,anchor:C},M,W)=>{let A;for(;y&&y!==C;)A=f(y),n(y,M,W),y=A;n(C,M,W)},x=({el:y,anchor:C})=>{let M;for(;y&&y!==C;)M=f(y),a(y),y=M;a(C)},w=(y,C,M,W,A,$,J,Q,te)=>{if(C.type==="svg"?J="svg":C.type==="math"&&(J="mathml"),y==null)N(C,M,W,A,$,J,Q,te);else{const Y=y.el&&y.el._isVueCE?y.el:null;try{Y&&Y._beginPatch(),R(y,C,A,$,J,Q,te)}finally{Y&&Y._endPatch()}}},N=(y,C,M,W,A,$,J,Q)=>{let te,Y;const{props:me,shapeFlag:ae,transition:de,dirs:ye}=y;if(te=y.el=l(y.type,$,me&&me.is,me),ae&8?u(te,y.children):ae&16&&S(y.children,te,null,W,A,wr(y,$),J,Q),ye&&Ns(y,null,W,"created"),O(te,y,y.scopeId,J,W),me){for(const Re in me)Re!=="value"&&!Js(Re)&&i(te,Re,null,me[Re],$,W);"value"in me&&i(te,"value",null,me.value,$),(Y=me.onVnodeBeforeMount)&&Yt(Y,W,y)}ye&&Ns(y,null,W,"beforeMount");const _e=rp(A,de);_e&&de.beforeEnter(te),n(te,C,M),((Y=me&&me.onVnodeMounted)||_e||ye)&&mt(()=>{try{Y&&Yt(Y,W,y),_e&&de.enter(te),ye&&Ns(y,null,W,"mounted")}finally{}},A)},O=(y,C,M,W,A)=>{if(M&&p(y,M),W)for(let $=0;$<W.length;$++)p(y,W[$]);if(A){let $=A.subTree;if(C===$||ml($.type)&&($.ssContent===C||$.ssFallback===C)){const J=A.vnode;O(y,J,J.scopeId,J.slotScopeIds,A.parent)}}},S=(y,C,M,W,A,$,J,Q,te=0)=>{for(let Y=te;Y<y.length;Y++){const me=y[Y]=Q?js(y[Y]):Xt(y[Y]);g(null,me,C,M,W,A,$,J,Q)}},R=(y,C,M,W,A,$,J)=>{const Q=C.el=y.el;let{patchFlag:te,dynamicChildren:Y,dirs:me}=C;te|=y.patchFlag&16;const ae=y.props||Fe,de=C.props||Fe;let ye;if(M&&Sn(M,!1),(ye=de.onVnodeBeforeUpdate)&&Yt(ye,M,C,y),me&&Ns(C,y,M,"beforeUpdate"),M&&Sn(M,!0),(ae.innerHTML&&de.innerHTML==null||ae.textContent&&de.textContent==null)&&u(Q,""),Y?L(y.dynamicChildren,Y,Q,M,W,wr(C,A),$):J||I(y,C,Q,null,M,W,wr(C,A),$,!1),te>0){if(te&16)H(Q,ae,de,M,A);else if(te&2&&ae.class!==de.class&&i(Q,"class",null,de.class,A),te&4&&i(Q,"style",ae.style,de.style,A),te&8){const _e=C.dynamicProps;for(let Re=0;Re<_e.length;Re++){const B=_e[Re],re=ae[B],xe=de[B];(xe!==re||B==="value")&&i(Q,B,re,xe,A,M)}}te&1&&y.children!==C.children&&u(Q,C.children)}else!J&&Y==null&&H(Q,ae,de,M,A);((ye=de.onVnodeUpdated)||me)&&mt(()=>{ye&&Yt(ye,M,C,y),me&&Ns(C,y,M,"updated")},W)},L=(y,C,M,W,A,$,J)=>{for(let Q=0;Q<C.length;Q++){const te=y[Q],Y=C[Q],me=te.el&&(te.type===At||!ys(te,Y)||te.shapeFlag&198)?d(te.el):M;g(te,Y,me,null,W,A,$,J,!0)}},H=(y,C,M,W,A)=>{if(C!==M){if(C!==Fe)for(const $ in C)!Js($)&&!($ in M)&&i(y,$,C[$],null,A,W);for(const $ in M){if(Js($))continue;const J=M[$],Q=C[$];J!==Q&&$!=="value"&&i(y,$,Q,J,A,W)}"value"in M&&i(y,"value",C.value,M.value,A)}},P=(y,C,M,W,A,$,J,Q,te)=>{const Y=C.el=y?y.el:r(""),me=C.anchor=y?y.anchor:r("");let{patchFlag:ae,dynamicChildren:de,slotScopeIds:ye}=C;ye&&(Q=Q?Q.concat(ye):ye),y==null?(n(Y,M,W),n(me,M,W),S(C.children||[],M,me,A,$,J,Q,te)):ae>0&&ae&64&&de&&y.dynamicChildren&&y.dynamicChildren.length===de.length?(L(y.dynamicChildren,de,M,A,$,J,Q),(C.key!=null||A&&C===A.subTree)&&Wo(y,C,!0)):I(y,C,M,me,A,$,J,Q,te)},T=(y,C,M,W,A,$,J,Q,te)=>{C.slotScopeIds=Q,y==null?C.shapeFlag&512?A.ctx.activate(C,M,W,J,te):U(C,M,W,A,$,J,te):K(y,C,te)},U=(y,C,M,W,A,$,J)=>{const Q=y.component=bp(y,W,A);if(Ri(y)&&(Q.ctx.renderer=pe),xp(Q,!1,J),Q.asyncDep){if(A&&A.registerDep(Q,G,J),!y.el){const te=Q.subTree=lt(pt);E(null,te,C,M),y.placeholder=te.el}}else G(Q,y,C,M,A,$,J)},K=(y,C,M)=>{const W=C.component=y.component;if(tb(y,C,M))if(W.asyncDep&&!W.asyncResolved){D(W,C,M);return}else W.next=C,W.update();else C.el=y.el,W.vnode=C},G=(y,C,M,W,A,$,J)=>{const Q=()=>{if(y.isMounted){let{next:ae,bu:de,u:ye,parent:_e,vnode:Re}=y;{const Je=op(y);if(Je){ae&&(ae.el=Re.el,D(y,ae,J)),Je.asyncDep.then(()=>{mt(()=>{y.isUnmounted||Y()},A)});return}}let B=ae,re;Sn(y,!1),ae?(ae.el=Re.el,D(y,ae,J)):ae=Re,de&&fa(de),(re=ae.props&&ae.props.onVnodeBeforeUpdate)&&Yt(re,_e,ae,Re),Sn(y,!0);const xe=el(y),Pe=y.subTree;y.subTree=xe,g(Pe,xe,d(Pe.el),F(Pe),y,A,$),ae.el=xe.el,B===null&&er(y,xe.el),ye&&mt(ye,A),(re=ae.props&&ae.props.onVnodeUpdated)&&mt(()=>Yt(re,_e,ae,Re),A)}else{let ae;const{el:de,props:ye}=C,{bm:_e,m:Re,parent:B,root:re,type:xe}=y,Pe=Qs(C);if(Sn(y,!1),_e&&fa(_e),!Pe&&(ae=ye&&ye.onVnodeBeforeMount)&&Yt(ae,B,C),Sn(y,!0),de&&Ie){const Je=()=>{y.subTree=el(y),Ie(de,y.subTree,y,A,null)};Pe&&xe.__asyncHydrate?xe.__asyncHydrate(de,y,Je):Je()}else{re.ce&&re.ce._hasShadowRoot()&&re.ce._injectChildStyle(xe,y.parent?y.parent.type:void 0);const Je=y.subTree=el(y);g(null,Je,M,W,y,A,$),C.el=Je.el}if(Re&&mt(Re,A),!Pe&&(ae=ye&&ye.onVnodeMounted)){const Je=C;mt(()=>Yt(ae,B,Je),A)}(C.shapeFlag&256||B&&Qs(B.vnode)&&B.vnode.shapeFlag&256)&&y.a&&mt(y.a,A),y.isMounted=!0,C=M=W=null}};y.scope.on();const te=y.effect=new li(Q);y.scope.off();const Y=y.update=te.run.bind(te),me=y.job=te.runIfDirty.bind(te);me.i=y,me.id=y.uid,te.scheduler=()=>Do(me),Sn(y,!0),Y()},D=(y,C,M)=>{C.component=y;const W=y.vnode.props;y.vnode=C,y.next=null,nb(y,C.props,W,M),rb(y,C.children,M),tn(),Xc(y),sn()},I=(y,C,M,W,A,$,J,Q,te=!1)=>{const Y=y&&y.children,me=y?y.shapeFlag:0,ae=C.children,{patchFlag:de,shapeFlag:ye}=C;if(de>0){if(de&128){ce(Y,ae,M,W,A,$,J,Q,te);return}else if(de&256){j(Y,ae,M,W,A,$,J,Q,te);return}}ye&8?(me&16&&Ee(Y,A,$),ae!==Y&&u(M,ae)):me&16?ye&16?ce(Y,ae,M,W,A,$,J,Q,te):Ee(Y,A,$,!0):(me&8&&u(M,""),ye&16&&S(ae,M,W,A,$,J,Q,te))},j=(y,C,M,W,A,$,J,Q,te)=>{y=y||ca,C=C||ca;const Y=y.length,me=C.length,ae=Math.min(Y,me);let de;for(de=0;de<ae;de++){const ye=C[de]=te?js(C[de]):Xt(C[de]);g(y[de],ye,M,null,A,$,J,Q,te)}Y>me?Ee(y,A,$,!0,!1,ae):S(C,M,W,A,$,J,Q,te,ae)},ce=(y,C,M,W,A,$,J,Q,te)=>{let Y=0;const me=C.length;let ae=y.length-1,de=me-1;for(;Y<=ae&&Y<=de;){const ye=y[Y],_e=C[Y]=te?js(C[Y]):Xt(C[Y]);if(ys(ye,_e))g(ye,_e,M,null,A,$,J,Q,te);else break;Y++}for(;Y<=ae&&Y<=de;){const ye=y[ae],_e=C[de]=te?js(C[de]):Xt(C[de]);if(ys(ye,_e))g(ye,_e,M,null,A,$,J,Q,te);else break;ae--,de--}if(Y>ae){if(Y<=de){const ye=de+1,_e=ye<me?C[ye].el:W;for(;Y<=de;)g(null,C[Y]=te?js(C[Y]):Xt(C[Y]),M,_e,A,$,J,Q,te),Y++}}else if(Y>de)for(;Y<=ae;)se(y[Y],A,$,!0),Y++;else{const ye=Y,_e=Y,Re=new Map;for(Y=_e;Y<=de;Y++){const et=C[Y]=te?js(C[Y]):Xt(C[Y]);et.key!=null&&Re.set(et.key,Y)}let B,re=0;const xe=de-_e+1;let Pe=!1,Je=0;const Ze=new Array(xe);for(Y=0;Y<xe;Y++)Ze[Y]=0;for(Y=ye;Y<=ae;Y++){const et=y[Y];if(re>=xe){se(et,A,$,!0);continue}let Ye;if(et.key!=null)Ye=Re.get(et.key);else for(B=_e;B<=de;B++)if(Ze[B-_e]===0&&ys(et,C[B])){Ye=B;break}Ye===void 0?se(et,A,$,!0):(Ze[Ye-_e]=Y+1,Ye>=Je?Je=Ye:Pe=!0,g(et,C[Ye],M,null,A,$,J,Q,te),re++)}const xt=Pe?ob(Ze):ca;for(B=xt.length-1,Y=xe-1;Y>=0;Y--){const et=_e+Y,Ye=C[et],Ss=C[et+1],Z=et+1<me?Ss.el||cp(Ss):W;Ze[Y]===0?g(null,Ye,M,Z,A,$,J,Q,te):Pe&&(B<0||Y!==xt[B]?oe(Ye,M,Z,2):B--)}}},oe=(y,C,M,W,A=null)=>{const{el:$,type:J,transition:Q,children:te,shapeFlag:Y}=y;if(Y&6){oe(y.component.subTree,C,M,W);return}if(Y&128){y.suspense.move(C,M,W);return}if(Y&64){J.move(y,C,M,pe);return}if(J===At){n($,C,M);for(let ae=0;ae<te.length;ae++)oe(te[ae],C,M,W);n(y.anchor,C,M);return}if(J===Dn){v(y,C,M);return}if(W!==2&&Y&1&&Q)if(W===0)Q.persisted&&!$[us]?n($,C,M):(Q.beforeEnter($),n($,C,M),mt(()=>Q.enter($),A));else{const{leave:ae,delayLeave:de,afterLeave:ye}=Q,_e=()=>{y.ctx.isUnmounted?a($):n($,C,M)},Re=()=>{const B=$._isLeaving||!!$[us];$._isLeaving&&$[us](!0),Q.persisted&&!B?_e():ae($,()=>{_e(),ye&&ye()})};de?de($,_e,Re):Re()}else n($,C,M)},se=(y,C,M,W=!1,A=!1)=>{const{type:$,props:J,ref:Q,children:te,dynamicChildren:Y,shapeFlag:me,patchFlag:ae,dirs:de,cacheIndex:ye,memo:_e}=y;if(ae===-2&&(A=!1),Q!=null&&(tn(),ha(Q,null,M,y,!0),sn()),ye!=null&&(C.renderCache[ye]=void 0),me&256){C.ctx.deactivate(y);return}const Re=me&1&&de,B=!Qs(y);let re;if(B&&(re=J&&J.onVnodeBeforeUnmount)&&Yt(re,C,y),me&6)fe(y.component,M,W);else{if(me&128){y.suspense.unmount(M,W);return}Re&&Ns(y,null,C,"beforeUnmount"),me&64?y.type.remove(y,C,M,pe,W):Y&&!Y.hasOnce&&($!==At||ae>0&&ae&64)?Ee(Y,C,M,!1,!0):($===At&&ae&384||!A&&me&16)&&Ee(te,C,M),W&&he(y)}const xe=_e!=null&&ye==null;(B&&(re=J&&J.onVnodeUnmounted)||Re||xe)&&mt(()=>{re&&Yt(re,C,y),Re&&Ns(y,null,C,"unmounted"),xe&&(y.el=null)},M)},he=y=>{const{type:C,el:M,anchor:W,transition:A}=y;if(C===At){ee(M,W);return}if(C===Dn){x(y);return}const $=()=>{a(M),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(y.shapeFlag&1&&A&&!A.persisted){const{leave:J,delayLeave:Q}=A,te=()=>J(M,$);Q?Q(y.el,$,te):te()}else $()},ee=(y,C)=>{let M;for(;y!==C;)M=f(y),a(y),y=M;a(C)},fe=(y,C,M)=>{const{bum:W,scope:A,job:$,subTree:J,um:Q,m:te,a:Y}=y;gl(te),gl(Y),W&&fa(W),A.stop(),$&&($.flags|=8,se(J,y,C,M)),Q&&mt(Q,C),mt(()=>{y.isUnmounted=!0},C)},Ee=(y,C,M,W=!1,A=!1,$=0)=>{for(let J=$;J<y.length;J++)se(y[J],C,M,W,A)},F=y=>{if(y.shapeFlag&6)return F(y.component.subTree);if(y.shapeFlag&128)return y.suspense.next();const C=f(y.anchor||y.el),M=C&&C[Nf];return M?f(M):C};let ue=!1;const ne=(y,C,M)=>{let W;y==null?C._vnode&&(se(C._vnode,null,null,!0),W=C._vnode.component):g(C._vnode||null,y,C,null,null,null,M),C._vnode=y,ue||(ue=!0,Xc(W),fl(),ue=!1)},pe={p:g,um:se,m:oe,r:he,mt:U,mc:S,pc:I,pbc:L,n:F,o:e};let be,Ie;return t&&([be,Ie]=t(pe)),{render:ne,hydrate:be,createApp:Wv(ne,be)}}function wr({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Sn({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function rp(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function Wo(e,t,s=!1){const n=e.children,a=t.children;if(ge(n)&&ge(a))for(let i=0;i<n.length;i++){const l=n[i];let r=a[i];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=a[i]=js(a[i]),r.el=l.el),!s&&r.patchFlag!==-2&&Wo(l,r)),r.type===bn&&(r.patchFlag===-1&&(r=a[i]=js(r)),r.el=l.el),r.type===pt&&!r.el&&(r.el=l.el)}}function ob(e){const t=e.slice(),s=[0];let n,a,i,l,r;const o=e.length;for(n=0;n<o;n++){const c=e[n];if(c!==0){if(a=s[s.length-1],e[a]<c){t[n]=a,s.push(n);continue}for(i=0,l=s.length-1;i<l;)r=i+l>>1,e[s[r]]<c?i=r+1:l=r;c<e[s[i]]&&(i>0&&(t[n]=s[i-1]),s[i]=n)}}for(i=s.length,l=s[i-1];i-- >0;)s[i]=l,l=t[l];return s}function op(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:op(t)}function gl(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function cp(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?cp(t.subTree):null}const ml=e=>e.__isSuspense;let Xr=0;const cb={name:"Suspense",__isSuspense:!0,process(e,t,s,n,a,i,l,r,o,c){if(e==null)db(t,s,n,a,i,l,r,o,c);else{if(i&&i.deps>0&&!e.suspense.isInFallback){t.suspense=e.suspense,t.suspense.vnode=t,t.el=e.el;return}fb(e,t,s,n,a,l,r,o,c)}},hydrate:pb,normalize:hb},ub=cb;function pi(e,t){const s=e.props&&e.props[t];we(s)&&s()}function db(e,t,s,n,a,i,l,r,o){const{p:c,o:{createElement:u}}=o,d=u("div"),f=e.suspense=up(e,a,n,t,d,s,i,l,r,o);c(null,f.pendingBranch=e.ssContent,d,null,n,f,i,l),f.deps>0?(pi(e,"onPending"),pi(e,"onFallback"),c(null,e.ssFallback,t,s,n,null,i,l),ga(f,e.ssFallback)):f.resolve(!1,!0)}function fb(e,t,s,n,a,i,l,r,{p:o,um:c,o:{createElement:u}}){const d=t.suspense=e.suspense;d.vnode=t,t.el=e.el;const f=t.ssContent,p=t.ssFallback,{activeBranch:m,pendingBranch:g,isInFallback:k,isHydrating:E}=d;if(g)d.pendingBranch=f,ys(g,f)?(o(g,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():k&&(E||(o(m,p,s,n,a,null,i,l,r),ga(d,p)))):(d.pendingId=Xr++,E?(d.isHydrating=!1,d.activeBranch=g):c(g,a,d),d.deps=0,d.effects.length=0,d.hiddenContainer=u("div"),k?(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0?d.resolve():(o(m,p,s,n,a,null,i,l,r),ga(d,p))):m&&ys(m,f)?(o(m,f,s,n,a,d,i,l,r),d.resolve(!0)):(o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0&&d.resolve()));else if(m&&ys(m,f))o(m,f,s,n,a,d,i,l,r),ga(d,f);else if(pi(t,"onPending"),d.pendingBranch=f,f.shapeFlag&512?d.pendingId=f.component.suspenseId:d.pendingId=Xr++,o(null,f,d.hiddenContainer,null,a,d,i,l,r),d.deps<=0)d.resolve();else{const{timeout:b,pendingId:v}=d;b>0?setTimeout(()=>{d.pendingId===v&&d.fallback(p)},b):b===0&&d.fallback(p)}}function up(e,t,s,n,a,i,l,r,o,c,u=!1){const{p:d,m:f,um:p,n:m,o:{parentNode:g,remove:k}}=c;let E;const b=gb(e);b&&t&&t.pendingBranch&&(E=t.pendingId,t.deps++);const v=e.props?rl(e.props.timeout):void 0,x=i,w={vnode:e,parent:t,parentComponent:s,namespace:l,container:n,hiddenContainer:a,deps:0,pendingId:Xr++,timeout:typeof v=="number"?v:-1,activeBranch:null,isFallbackMountPending:!1,pendingBranch:null,isInFallback:!u,isHydrating:u,isUnmounted:!1,effects:[],resolve(N=!1,O=!1){const{vnode:S,activeBranch:R,pendingBranch:L,pendingId:H,effects:P,parentComponent:T,container:U,isInFallback:K}=w;let G=!1;if(w.isHydrating)w.isHydrating=!1;else if(!N){G=R&&L.transition&&L.transition.mode==="out-in";let j=!1;G&&(R.transition.afterLeave=()=>{H===w.pendingId&&(f(L,U,i===x&&!j?m(R):i,0),ci(P),K&&S.ssFallback&&(S.ssFallback.el=null))}),R&&!w.isFallbackMountPending&&(g(R.el)===U&&(i=m(R),j=!0),p(R,T,w,!0),!G&&K&&S.ssFallback&&mt(()=>S.ssFallback.el=null,w)),G||f(L,U,i,0)}w.isFallbackMountPending=!1,ga(w,L),w.pendingBranch=null,w.isInFallback=!1;let D=w.parent,I=!1;for(;D;){if(D.pendingBranch){D.effects.push(...P),I=!0;break}D=D.parent}!I&&!G&&ci(P),w.effects=[],b&&t&&t.pendingBranch&&E===t.pendingId&&(t.deps--,t.deps===0&&!O&&t.resolve()),pi(S,"onResolve")},fallback(N){if(!w.pendingBranch)return;const{vnode:O,activeBranch:S,parentComponent:R,container:L,namespace:H}=w;pi(O,"onFallback");const P=m(S),T=()=>{w.isFallbackMountPending=!1,w.isInFallback&&(d(null,N,L,P,R,null,H,r,o),ga(w,N))},U=N.transition&&N.transition.mode==="out-in";U&&(w.isFallbackMountPending=!0,S.transition.afterLeave=T),w.isInFallback=!0,p(S,R,null,!0),U||T()},move(N,O,S){w.activeBranch&&f(w.activeBranch,N,O,S),w.container=N},next(){return w.activeBranch&&m(w.activeBranch)},registerDep(N,O,S){const R=!!w.pendingBranch;R&&w.deps++;const L=N.vnode.el;N.asyncDep.catch(H=>{qn(H,N,0)}).then(H=>{if(N.isUnmounted||w.isUnmounted||w.pendingId!==N.suspenseId)return;mi(),N.asyncResolved=!0;const{vnode:P}=N;eo(N,H,!1),L&&(P.el=L);const T=!L&&N.subTree.el;O(N,P,g(L||N.subTree.el),L?null:m(N.subTree),w,l,S),T&&(P.placeholder=null,k(T)),er(N,P.el),R&&--w.deps===0&&w.resolve()})},unmount(N,O){w.isUnmounted=!0,w.activeBranch&&p(w.activeBranch,s,N,O),w.pendingBranch&&p(w.pendingBranch,s,N,O)}};return w}function pb(e,t,s,n,a,i,l,r,o){const c=t.suspense=up(t,n,s,e.parentNode,document.createElement("div"),null,a,i,l,r,!0),u=o(e,c.pendingBranch=t.ssContent,s,c,i,l);return c.deps===0&&c.resolve(!1,!0),u}function hb(e){const{shapeFlag:t,children:s}=e,n=t&32;e.ssContent=pu(n?s.default:s),e.ssFallback=n?pu(s.fallback):lt(pt)}function pu(e){let t;if(we(e)){const s=$n&&e._c;s&&(e._d=!1,hi()),e=e(),s&&(e._d=!0,t=Ut,fp())}return ge(e)&&(e=Qv(e)),e=Xt(e),t&&!e.dynamicChildren&&(e.dynamicChildren=t.filter(s=>s!==e)),e}function dp(e,t){t&&t.pendingBranch?ge(e)?t.effects.push(...e):t.effects.push(e):ci(e)}function ga(e,t){e.activeBranch=t;const{vnode:s,parentComponent:n}=e;let a=t.el;for(;!a&&t.component;)t=t.component.subTree,a=t.el;s.el=a,n&&n.subTree===s&&(n.vnode.el=a,er(n,a))}function gb(e){const t=e.props&&e.props.suspensible;return t!=null&&t!==!1}const At=Symbol.for("v-fgt"),bn=Symbol.for("v-txt"),pt=Symbol.for("v-cmt"),Dn=Symbol.for("v-stc"),ei=[];let Ut=null;function hi(e=!1){ei.push(Ut=e?null:[])}function fp(){ei.pop(),Ut=ei[ei.length-1]||null}let $n=1;function gi(e,t=!1){$n+=e,e<0&&Ut&&t&&(Ut.hasOnce=!0)}function pp(e){return e.dynamicChildren=$n>0?Ut||ca:null,fp(),$n>0&&Ut&&Ut.push(e),e}function mb(e,t,s,n,a,i){return pp(Zo(e,t,s,n,a,i,!0))}function vl(e,t,s,n,a){return pp(lt(e,t,s,n,a,!0))}function an(e){return e?e.__v_isVNode===!0:!1}function ys(e,t){return e.type===t.type&&e.key===t.key}function vb(e){}const hp=({key:e})=>e??null,tl=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?Ce(e)||bt(e)||we(e)?{i:Ot,r:e,k:t,f:!!s}:e:null);function Zo(e,t=null,s=null,n=0,a=null,i=e===At?0:1,l=!1,r=!1){const o={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&hp(t),ref:t&&tl(t),scopeId:Wl,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:n,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:Ot};return r?(Yo(o,s),i&128&&e.normalize(o)):s&&(o.shapeFlag|=Ce(s)?8:16),$n>0&&!l&&Ut&&(o.patchFlag>0||i&6)&&o.patchFlag!==32&&Ut.push(o),o}const lt=bb;function bb(e,t=null,s=null,n=0,a=null,i=!1){if((!e||e===jf)&&(e=pt),an(e)){const r=Ms(e,t,!0);return s&&Yo(r,s),$n>0&&!i&&Ut&&(r.shapeFlag&6?Ut[Ut.indexOf(e)]=r:Ut.push(r)),r.patchFlag=-2,r}if(Tb(e)&&(e=e.__vccOpts),t){t=gp(t);let{class:r,style:o}=t;r&&!Ce(r)&&(t.class=Ti(r)),Ve(o)&&(Ci(o)&&!ge(o)&&(o=Me({},o)),t.style=Si(o))}const l=Ce(e)?1:ml(e)?128:Of(e)?64:Ve(e)?4:we(e)?2:0;return Zo(e,t,s,n,a,l,i,!0)}function gp(e){return e?Ci(e)||Qf(e)?Me({},e):e:null}function Ms(e,t,s=!1,n=!1){const{props:a,ref:i,patchFlag:l,children:r,transition:o}=e,c=t?vp(a||{},t):a,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:c,key:c&&hp(c),ref:t&&t.ref?s&&i?ge(i)?i.concat(tl(t)):[i,tl(t)]:tl(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:r,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==At?l===-1?16:l|16:l,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:o,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Ms(e.ssContent),ssFallback:e.ssFallback&&Ms(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return o&&n&&nn(u,o.clone(u)),u}function Jo(e=" ",t=0){return lt(bn,null,e,t)}function yb(e,t){const s=lt(Dn,null,e);return s.staticCount=t,s}function mp(e="",t=!1){return t?(hi(),vl(pt,null,e)):lt(pt,null,e)}function Xt(e){return e==null||typeof e=="boolean"?lt(pt):ge(e)?lt(At,null,e.slice()):an(e)?js(e):lt(bn,null,String(e))}function js(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Ms(e)}function Yo(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(ge(t))s=16;else if(typeof t=="object")if(n&65){const a=t.default;a&&(a._c&&(a._d=!1),Yo(e,a()),a._c&&(a._d=!0));return}else{s=32;const a=t._;!a&&!Qf(t)?t._ctx=Ot:a===3&&Ot&&(Ot.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else we(t)?(t={default:t,_ctx:Ot},s=32):(t=String(t),n&64?(s=16,t=[Jo(t)]):s=8);e.children=t,e.shapeFlag|=s}function vp(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const a in n)if(a==="class")t.class!==n.class&&(t.class=Ti([t.class,n.class]));else if(a==="style")t.style=Si([t.style,n.style]);else if(Vn(a)){const i=t[a],l=n[a];l&&i!==l&&!(ge(i)&&i.includes(l))?t[a]=i?[].concat(i,l):l:l==null&&i==null&&!Fl(a)&&(t[a]=l)}else a!==""&&(t[a]=n[a])}return t}function Yt(e,t,s,n=null){is(e,t,7,[s,n])}const xb=Kf();let _b=0;function bp(e,t,s){const n=e.type,a=(t?t.appContext:e.appContext)||xb,i={uid:_b++,vnode:e,type:n,parent:t,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Eo(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(a.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:ep(n,a),emitsOptions:Wf(n,a),emit:null,emitted:null,propsDefaults:Fe,inheritAttrs:n.inheritAttrs,ctx:Fe,data:Fe,props:Fe,attrs:Fe,slots:Fe,refs:Fe,setupState:Fe,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=Jv.bind(null,i),e.ce&&e.ce(i),i}let Nt=null;const Gt=()=>Nt||Ot;let bl,ma;{const e=Vl(),t=(s,n)=>{let a;return(a=e[s])||(a=e[s]=[]),a.push(n),i=>{a.length>1?a.forEach(l=>l(i)):a[0](i)}};bl=t("__VUE_INSTANCE_SETTERS__",s=>Nt=s),ma=t("__VUE_SSR_SETTERS__",s=>Un=s)}const Oa=e=>{const t=Nt;return bl(e),e.scope.on(),()=>{e.scope.off(),bl(t)}},mi=()=>{Nt&&Nt.scope.off(),bl(null)};function yp(e){return e.vnode.shapeFlag&4}let Un=!1;function xp(e,t=!1,s=!1){t&&ma(t);const{props:n,children:a}=e.vnode,i=yp(e);sb(e,n,i,t),lb(e,a,s||t);const l=i?kb(e,t):void 0;return t&&ma(!1),l}function kb(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Zr);const{setup:n}=s;if(n){tn();const a=e.setupContext=n.length>1?wp(e):null,i=Oa(e),l=Na(n,e,0,[e.props,a]),r=Co(l);if(sn(),i(),(r||e.sp)&&!Qs(e)&&$o(e),r){if(l.then(mi,mi),t)return l.then(o=>{eo(e,o,t)}).catch(o=>{qn(o,e,0)});e.asyncDep=l}else eo(e,l,t)}else kp(e,t)}function eo(e,t,s){we(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Ve(t)&&(e.setupState=Lo(t)),kp(e,s)}let yl,to;function _p(e){yl=e,to=t=>{t.render._rc&&(t.withProxy=new Proxy(t.ctx,Av))}}const wb=()=>!yl;function kp(e,t,s){const n=e.type;if(!e.render){if(!t&&yl&&!n.render){const a=n.template||qo(e).template;if(a){const{isCustomElement:i,compilerOptions:l}=e.appContext.config,{delimiters:r,compilerOptions:o}=n,c=Me(Me({isCustomElement:i,delimiters:r},l),o);n.render=yl(a,c)}}e.render=n.render||Lt,to&&to(e)}{const a=Oa(e);tn();try{Vv(e)}finally{sn(),a()}}}const Sb={get(e,t){return $t(e,"get",""),e[t]}};function wp(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Sb),slots:e.slots,emit:e.emit,expose:t}}function Ii(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Lo(vf(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Xa)return Xa[s](e)},has(t,s){return s in t||s in Xa}})):e.proxy}function so(e,t=!0){return we(e)?e.displayName||e.name:e.name||t&&e.__name}function Tb(e){return we(e)&&"__vccOpts"in e}const X=(e,t)=>Nm(e,t,Un);function xa(e,t,s){try{gi(-1);const n=arguments.length;return n===2?Ve(t)&&!ge(t)?an(t)?lt(e,null,[t]):lt(e,t):lt(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&an(s)&&(s=[s]),lt(e,t,s))}finally{gi(1)}}function Cb(){}function Eb(e,t,s,n){const a=s[n];if(a&&Sp(a,e))return a;const i=t();return i.memo=e.slice(),i.cacheIndex=n,s[n]=i}function Sp(e,t){const s=e.memo;if(s.length!=t.length)return!1;for(let n=0;n<s.length;n++)if(Ct(s[n],t[n]))return!1;return $n>0&&Ut&&Ut.push(e),!0}const Tp="3.5.38",Ab=Lt,Rb=Bm,Ib=aa,Nb=Cf,Ob={createComponentInstance:bp,setupComponent:xp,renderComponentRoot:el,setCurrentRenderingInstance:di,isVNode:an,normalizeVNode:Xt,getComponentPublicInstance:Ii,ensureValidVNode:zo,pushWarningContext:Pm,popWarningContext:Fm},Lb=Ob,Db=null,Mb=null,Pb=null;/**
* @vue/runtime-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let no;const hu=typeof window<"u"&&window.trustedTypes;if(hu)try{no=hu.createPolicy("vue",{createHTML:e=>e})}catch{}const Cp=no?e=>no.createHTML(e):e=>e,Fb="http://www.w3.org/2000/svg",$b="http://www.w3.org/1998/Math/MathML",Vs=typeof document<"u"?document:null,gu=Vs&&Vs.createElement("template"),Ep={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const a=t==="svg"?Vs.createElementNS(Fb,e):t==="mathml"?Vs.createElementNS($b,e):s?Vs.createElement(e,{is:s}):Vs.createElement(e);return e==="select"&&n&&n.multiple!=null&&a.setAttribute("multiple",n.multiple),a},createText:e=>Vs.createTextNode(e),createComment:e=>Vs.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Vs.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,a,i){const l=s?s.previousSibling:t.lastChild;if(a&&(a===i||a.nextSibling))for(;t.insertBefore(a.cloneNode(!0),s),!(a===i||!(a=a.nextSibling)););else{gu.innerHTML=Cp(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const r=gu.content;if(n==="svg"||n==="mathml"){const o=r.firstChild;for(;o.firstChild;)r.appendChild(o.firstChild);r.removeChild(o)}t.insertBefore(r,s)}return[l?l.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},cn="transition",$a="animation",_a=Symbol("_vtc"),Ap={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Rp=Me({},Fo,Ap),Ub=e=>(e.displayName="Transition",e.props=Rp,e),Bb=Ub((e,{slots:t})=>xa(Mf,Ip(e),t)),Tn=(e,t=[])=>{ge(e)?e.forEach(s=>s(...t)):e&&e(...t)},mu=e=>e?ge(e)?e.some(t=>t.length>1):e.length>1:!1;function Ip(e){const t={};for(const P in e)P in Ap||(t[P]=e[P]);if(e.css===!1)return t;const{name:s="v",type:n,duration:a,enterFromClass:i=`${s}-enter-from`,enterActiveClass:l=`${s}-enter-active`,enterToClass:r=`${s}-enter-to`,appearFromClass:o=i,appearActiveClass:c=l,appearToClass:u=r,leaveFromClass:d=`${s}-leave-from`,leaveActiveClass:f=`${s}-leave-active`,leaveToClass:p=`${s}-leave-to`}=e,m=Hb(a),g=m&&m[0],k=m&&m[1],{onBeforeEnter:E,onEnter:b,onEnterCancelled:v,onLeave:x,onLeaveCancelled:w,onBeforeAppear:N=E,onAppear:O=b,onAppearCancelled:S=v}=t,R=(P,T,U,K)=>{P._enterCancelled=K,pn(P,T?u:r),pn(P,T?c:l),U&&U()},L=(P,T)=>{P._isLeaving=!1,pn(P,d),pn(P,p),pn(P,f),T&&T()},H=P=>(T,U)=>{const K=P?O:b,G=()=>R(T,P,U);Tn(K,[T,G]),vu(()=>{pn(T,P?o:i),Es(T,P?u:r),mu(K)||bu(T,n,g,G)})};return Me(t,{onBeforeEnter(P){Tn(E,[P]),Es(P,i),Es(P,l)},onBeforeAppear(P){Tn(N,[P]),Es(P,o),Es(P,c)},onEnter:H(!1),onAppear:H(!0),onLeave(P,T){P._isLeaving=!0;const U=()=>L(P,T);Es(P,d),P._enterCancelled?(Es(P,f),ao(P)):(ao(P),Es(P,f)),vu(()=>{P._isLeaving&&(pn(P,d),Es(P,p),mu(x)||bu(P,n,k,U))}),Tn(x,[P,U])},onEnterCancelled(P){R(P,!1,void 0,!0),Tn(v,[P])},onAppearCancelled(P){R(P,!0,void 0,!0),Tn(S,[P])},onLeaveCancelled(P){L(P),Tn(w,[P])}})}function Hb(e){if(e==null)return null;if(Ve(e))return[Sr(e.enter),Sr(e.leave)];{const t=Sr(e);return[t,t]}}function Sr(e){return rl(e)}function Es(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[_a]||(e[_a]=new Set)).add(t)}function pn(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[_a];s&&(s.delete(t),s.size||(e[_a]=void 0))}function vu(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Vb=0;function bu(e,t,s,n){const a=e._endId=++Vb,i=()=>{a===e._endId&&n()};if(s!=null)return setTimeout(i,s);const{type:l,timeout:r,propCount:o}=Np(e,t);if(!l)return n();const c=l+"end";let u=0;const d=()=>{e.removeEventListener(c,f),i()},f=p=>{p.target===e&&++u>=o&&d()};setTimeout(()=>{u<o&&d()},r+1),e.addEventListener(c,f)}function Np(e,t){const s=window.getComputedStyle(e),n=m=>(s[m]||"").split(", "),a=n(`${cn}Delay`),i=n(`${cn}Duration`),l=yu(a,i),r=n(`${$a}Delay`),o=n(`${$a}Duration`),c=yu(r,o);let u=null,d=0,f=0;t===cn?l>0&&(u=cn,d=l,f=i.length):t===$a?c>0&&(u=$a,d=c,f=o.length):(d=Math.max(l,c),u=d>0?l>c?cn:$a:null,f=u?u===cn?i.length:o.length:0);const p=u===cn&&/\b(?:transform|all)(?:,|$)/.test(n(`${cn}Property`).toString());return{type:u,timeout:d,propCount:f,hasTransform:p}}function yu(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>xu(s)+xu(e[n])))}function xu(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function ao(e){return(e?e.ownerDocument:document).body.offsetHeight}function jb(e,t,s){const n=e[_a];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const xl=Symbol("_vod"),Qo=Symbol("_vsh"),Op={name:"show",beforeMount(e,{value:t},{transition:s}){e[xl]=e.style.display==="none"?"":e.style.display,s&&t?s.beforeEnter(e):Ua(e,t)},mounted(e,{value:t},{transition:s}){s&&t&&s.enter(e)},updated(e,{value:t,oldValue:s},{transition:n}){!t!=!s&&(n?t?(n.beforeEnter(e),Ua(e,!0),n.enter(e)):n.leave(e,()=>{Ua(e,!1)}):Ua(e,t))},beforeUnmount(e,{value:t}){Ua(e,t)}};function Ua(e,t){e.style.display=t?e[xl]:"none",e[Qo]=!t}function zb(){Op.getSSRProps=({value:e})=>{if(!e)return{style:{display:"none"}}}}const Lp=Symbol("");function qb(e){const t=Gt();if(!t)return;const s=t.ut=(a=e(t.proxy))=>{Array.from(document.querySelectorAll(`[data-v-owner="${t.uid}"]`)).forEach(i=>_l(i,a))},n=()=>{const a=e(t.proxy);t.ce?_l(t.ce,a):io(t.subTree,a),s(a)};Ho(()=>{ci(n)}),Be(()=>{hs(n,Lt,{flush:"post"});const a=new MutationObserver(n);a.observe(t.subTree.el.parentNode,{childList:!0}),ht(()=>a.disconnect())})}function io(e,t){if(e.shapeFlag&128){const s=e.suspense;e=s.activeBranch,s.pendingBranch&&!s.isHydrating&&s.effects.push(()=>{io(s.activeBranch,t)})}for(;e.component;)e=e.component.subTree;if(e.shapeFlag&1&&e.el)_l(e.el,t);else if(e.type===At)e.children.forEach(s=>io(s,t));else if(e.type===Dn){let{el:s,anchor:n}=e;for(;s&&(_l(s,t),s!==n);)s=s.nextSibling}}function _l(e,t){if(e.nodeType===1){const s=e.style;let n="";for(const a in t){const i=Yg(t[a]);s.setProperty(`--${a}`,i),n+=`--${a}: ${i};`}s[Lp]=n}}const Kb=/(?:^|;)\s*display\s*:/;function Gb(e,t,s){const n=e.style,a=Ce(s);let i=!1;if(s&&!a){if(t)if(Ce(t))for(const l of t.split(";")){const r=l.slice(0,l.indexOf(":")).trim();s[r]==null&&Wa(n,r,"")}else for(const l in t)s[l]==null&&Wa(n,l,"");for(const l in s){l==="display"&&(i=!0);const r=s[l];r!=null?Zb(e,l,!Ce(t)&&t?t[l]:void 0,r)||Wa(n,l,r):Wa(n,l,"")}}else if(a){if(t!==s){const l=n[Lp];l&&(s+=";"+l),n.cssText=s,i=Kb.test(s)}}else t&&e.removeAttribute("style");xl in e&&(e[xl]=i?n.display:"",e[Qo]&&(n.display="none"))}const _u=/\s*!important$/;function Wa(e,t,s){if(ge(s))s.forEach(n=>Wa(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Wb(e,t);_u.test(s)?e.setProperty(es(n),s.replace(_u,""),"important"):e[n]=s}}const ku=["Webkit","Moz","ms"],Tr={};function Wb(e,t){const s=Tr[t];if(s)return s;let n=Qe(t);if(n!=="filter"&&n in e)return Tr[t]=n;n=zn(n);for(let a=0;a<ku.length;a++){const i=ku[a]+n;if(i in e)return Tr[t]=i}return t}function Zb(e,t,s,n){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&Ce(n)&&s===n}const wu="http://www.w3.org/1999/xlink";function Su(e,t,s,n,a,i=Zg(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(wu,t.slice(6,t.length)):e.setAttributeNS(wu,t,s):s==null||i&&!Jd(s)?e.removeAttribute(t):e.setAttribute(t,i?"":Ht(s)?String(s):s)}function Tu(e,t,s,n,a){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?Cp(s):s);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const r=i==="OPTION"?e.getAttribute("value")||"":e.value,o=s==null?e.type==="checkbox"?"on":"":String(s);(r!==o||!("_value"in e))&&(e.value=o),s==null&&e.removeAttribute(t),e._value=s;return}let l=!1;if(s===""||s==null){const r=typeof e[t];r==="boolean"?s=Jd(s):s==null&&r==="string"?(s="",l=!0):r==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(a||t)}function Gs(e,t,s,n){e.addEventListener(t,s,n)}function Jb(e,t,s,n){e.removeEventListener(t,s,n)}const Cu=Symbol("_vei");function Yb(e,t,s,n,a=null){const i=e[Cu]||(e[Cu]={}),l=i[t];if(n&&l)l.value=n;else{const[r,o]=Qb(t);if(n){const c=i[t]=ty(n,a);Gs(e,r,c,o)}else l&&(Jb(e,r,l,o),i[t]=void 0)}}const Eu=/(?:Once|Passive|Capture)$/;function Qb(e){let t;if(Eu.test(e)){t={};let n;for(;n=e.match(Eu);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):es(e.slice(2)),t]}let Cr=0;const Xb=Promise.resolve(),ey=()=>Cr||(Xb.then(()=>Cr=0),Cr=Date.now());function ty(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;const a=s.value;if(ge(a)){const i=n.stopImmediatePropagation;n.stopImmediatePropagation=()=>{i.call(n),n._stopped=!0};const l=a.slice(),r=[n];for(let o=0;o<l.length&&!n._stopped;o++){const c=l[o];c&&is(c,t,5,r)}}else is(a,t,5,[n])};return s.value=e,s.attached=ey(),s}const Au=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Dp=(e,t,s,n,a,i)=>{const l=a==="svg";t==="class"?jb(e,n,l):t==="style"?Gb(e,s,n):Vn(t)?Fl(t)||Yb(e,t,s,n,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):sy(e,t,n,l))?(Tu(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Su(e,t,n,l,i,t!=="value")):e._isVueCE&&(ny(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!Ce(n)))?Tu(e,Qe(t),n,i,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Su(e,t,n,l))};function sy(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Au(t)&&we(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const a=e.tagName;if(a==="IMG"||a==="VIDEO"||a==="CANVAS"||a==="SOURCE")return!1}return Au(t)&&Ce(s)?!1:t in e}function ny(e,t){const s=e._def.props;if(!s)return!1;const n=Qe(t);return Array.isArray(s)?s.some(a=>Qe(a)===n):Object.keys(s).some(a=>Qe(a)===n)}const Ru={};function Mp(e,t,s){let n=Ai(e,t);$l(n)&&(n=Me({},n,t));class a extends tr{constructor(l){super(n,l,s)}}return a.def=n,a}const ay=((e,t)=>Mp(e,t,Wp)),iy=typeof HTMLElement<"u"?HTMLElement:class{};class tr extends iy{constructor(t,s={},n=Sl){super(),this._def=t,this._props=s,this._createApp=n,this._isVueCE=!0,this._instance=null,this._app=null,this._nonce=this._def.nonce,this._connected=!1,this._resolved=!1,this._patching=!1,this._dirty=!1,this._numberProps=null,this._styleChildren=new WeakSet,this._styleAnchors=new WeakMap,this._ob=null,this.shadowRoot&&n!==Sl?this._root=this.shadowRoot:t.shadowRoot!==!1?(this.attachShadow(Me({},t.shadowRootOptions,{mode:"open"})),this._root=this.shadowRoot):this._root=this}connectedCallback(){if(!this.isConnected)return;!this.shadowRoot&&!this._resolved&&this._parseSlots(),this._connected=!0;let t=this;for(;t=t&&(t.assignedSlot||t.parentNode||t.host);)if(t instanceof tr){this._parent=t;break}this._instance||(this._resolved?this._mount(this._def):t&&t._pendingResolve?this._pendingResolve=t._pendingResolve.then(()=>{this._pendingResolve=void 0,this._resolveDef()}):this._resolveDef())}_setParent(t=this._parent){t&&(this._instance.parent=t._instance,this._inheritParentContext(t))}_inheritParentContext(t=this._parent){t&&this._app&&Object.setPrototypeOf(this._app._context.provides,t._instance.provides)}disconnectedCallback(){this._connected=!1,Et(()=>{this._connected||(this._ob&&(this._ob.disconnect(),this._ob=null),this._app&&this._app.unmount(),this._instance&&(this._instance.ce=void 0),this._app=this._instance=null,this._teleportTargets&&(this._teleportTargets.clear(),this._teleportTargets=void 0))})}_processMutations(t){for(const s of t)this._setAttr(s.attributeName)}_resolveDef(){if(this._pendingResolve)return;for(let n=0;n<this.attributes.length;n++)this._setAttr(this.attributes[n].name);this._ob=new MutationObserver(this._processMutations.bind(this)),this._ob.observe(this,{attributes:!0});const t=(n,a=!1)=>{this._resolved=!0,this._pendingResolve=void 0;const{props:i,styles:l}=n;let r;if(i&&!ge(i))for(const o in i){const c=i[o];(c===Number||c&&c.type===Number)&&(o in this._props&&(this._props[o]=rl(this._props[o])),(r||(r=Object.create(null)))[Qe(o)]=!0)}this._numberProps=r,this._resolveProps(n),this.shadowRoot&&this._applyStyles(l),this._mount(n)},s=this._def.__asyncLoader;s?this._pendingResolve=s().then(n=>{n.configureApp=this._def.configureApp,t(this._def=n,!0)}):t(this._def)}_mount(t){this._app=this._createApp(t),this._inheritParentContext(),t.configureApp&&t.configureApp(this._app),this._app._ceVNode=this._createVNode(),this._app.mount(this._root);const s=this._instance&&this._instance.exposed;if(s)for(const n in s)je(this,n)||Object.defineProperty(this,n,{get:()=>Ls(s[n])})}_resolveProps(t){const{props:s}=t,n=ge(s)?s:Object.keys(s||{});for(const a of Object.keys(this))a[0]!=="_"&&n.includes(a)&&this._setProp(a,this[a]);for(const a of n.map(Qe))Object.defineProperty(this,a,{get(){return this._getProp(a)},set(i){this._setProp(a,i,!0,!this._patching)}})}_setAttr(t){if(t.startsWith("data-v-"))return;const s=this.hasAttribute(t);let n=s?this.getAttribute(t):Ru;const a=Qe(t);s&&this._numberProps&&this._numberProps[a]&&(n=rl(n)),this._setProp(a,n,!1,!0)}_getProp(t){return this._props[t]}_setProp(t,s,n=!0,a=!1){if(s!==this._props[t]&&(this._dirty=!0,s===Ru?delete this._props[t]:(this._props[t]=s,t==="key"&&this._app&&(this._app._ceVNode.key=s)),a&&this._instance&&this._update(),n)){const i=this._ob;i&&(this._processMutations(i.takeRecords()),i.disconnect()),s===!0?this.setAttribute(es(t),""):typeof s=="string"||typeof s=="number"?this.setAttribute(es(t),s+""):s||this.removeAttribute(es(t)),i&&i.observe(this,{attributes:!0})}}_update(){const t=this._createVNode();this._app&&(t.appContext=this._app._context),Gp(t,this._root)}_createVNode(){const t={};this.shadowRoot||(t.onVnodeMounted=t.onVnodeUpdated=this._renderSlots.bind(this));const s=lt(this._def,Me(t,this._props));return this._instance||(s.ce=n=>{this._instance=n,n.ce=this,n.isCE=!0;const a=(i,l)=>{this.dispatchEvent(new CustomEvent(i,$l(l[0])?Me({detail:l},l[0]):{detail:l}))};n.emit=(i,...l)=>{a(i,l),es(i)!==i&&a(es(i),l)},this._setParent()}),s}_applyStyles(t,s,n){if(!t)return;if(s){if(s===this._def||this._styleChildren.has(s))return;this._styleChildren.add(s)}const a=this._nonce,i=this.shadowRoot,l=n?this._getStyleAnchor(n)||this._getStyleAnchor(this._def):this._getRootStyleInsertionAnchor(i);let r=null;for(let o=t.length-1;o>=0;o--){const c=document.createElement("style");a&&c.setAttribute("nonce",a),c.textContent=t[o],i.insertBefore(c,r||l),r=c,o===0&&(n||this._styleAnchors.set(this._def,c),s&&this._styleAnchors.set(s,c))}}_getStyleAnchor(t){if(!t)return null;const s=this._styleAnchors.get(t);return s&&s.parentNode===this.shadowRoot?s:(s&&this._styleAnchors.delete(t),null)}_getRootStyleInsertionAnchor(t){for(let s=0;s<t.childNodes.length;s++){const n=t.childNodes[s];if(!(n instanceof HTMLStyleElement))return n}return null}_parseSlots(){const t=this._slots={};let s;for(;s=this.firstChild;){const n=s.nodeType===1&&s.getAttribute("slot")||"default";(t[n]||(t[n]=[])).push(s),this.removeChild(s)}}_renderSlots(){const t=this._getSlots(),s=this._instance.type.__scopeId;for(let n=0;n<t.length;n++){const a=t[n],i=a.getAttribute("name")||"default",l=this._slots[i],r=a.parentNode;if(l)for(const o of l){if(s&&o.nodeType===1){const c=s+"-s",u=document.createTreeWalker(o,1);o.setAttribute(c,"");let d;for(;d=u.nextNode();)d.setAttribute(c,"")}r.insertBefore(o,a)}else for(;a.firstChild;)r.insertBefore(a.firstChild,a);r.removeChild(a)}}_getSlots(){const t=[this];this._teleportTargets&&t.push(...this._teleportTargets);const s=new Set;for(const n of t){const a=n.querySelectorAll("slot");for(let i=0;i<a.length;i++)s.add(a[i])}return Array.from(s)}_injectChildStyle(t,s){this._applyStyles(t.styles,t,s)}_beginPatch(){this._patching=!0,this._dirty=!1}_endPatch(){this._patching=!1,this._dirty&&this._instance&&this._update()}_hasShadowRoot(){return this._def.shadowRoot!==!1}_removeChildStyle(t){}}function Pp(e){const t=Gt(),s=t&&t.ce;return s||null}function ly(){const e=Pp();return e&&e.shadowRoot}function ry(e="$style"){{const t=Gt();if(!t)return Fe;const s=t.type.__cssModules;if(!s)return Fe;const n=s[e];return n||Fe}}const Fp=new WeakMap,$p=new WeakMap,kl=Symbol("_moveCb"),Iu=Symbol("_enterCb"),oy=e=>(delete e.props.mode,e),cy=oy({name:"TransitionGroup",props:Me({},Rp,{tag:String,moveClass:String}),setup(e,{slots:t}){const s=Gt(),n=Po();let a,i;return Yl(()=>{if(!a.length)return;const l=e.moveClass||`${e.name||"v"}-move`;if(!hy(a[0].el,s.vnode.el,l)){a=[];return}a.forEach(dy),a.forEach(fy);const r=a.filter(py);ao(s.vnode.el),r.forEach(o=>{const c=o.el,u=c.style;Es(c,l),u.transform=u.webkitTransform=u.transitionDuration="";const d=c[kl]=f=>{f&&f.target!==c||(!f||f.propertyName.endsWith("transform"))&&(c.removeEventListener("transitionend",d),c[kl]=null,pn(c,l))};c.addEventListener("transitionend",d)}),a=[]}),()=>{const l=Ue(e),r=Ip(l);let o=l.tag||At;if(a=[],i)for(let c=0;c<i.length;c++){const u=i[c];u.el&&u.el instanceof Element&&!u.el[Qo]&&(a.push(u),nn(u,ya(u,r,n,s)),Fp.set(u,Up(u.el)))}i=t.default?Zl(t.default()):[];for(let c=0;c<i.length;c++){const u=i[c];u.key!=null&&nn(u,ya(u,r,n,s))}return lt(o,null,i)}}}),uy=cy;function dy(e){const t=e.el;t[kl]&&t[kl](),t[Iu]&&t[Iu]()}function fy(e){$p.set(e,Up(e.el))}function py(e){const t=Fp.get(e),s=$p.get(e),n=t.left-s.left,a=t.top-s.top;if(n||a){const i=e.el,l=i.style,r=i.getBoundingClientRect();let o=1,c=1;return i.offsetWidth&&(o=r.width/i.offsetWidth),i.offsetHeight&&(c=r.height/i.offsetHeight),(!Number.isFinite(o)||o===0)&&(o=1),(!Number.isFinite(c)||c===0)&&(c=1),Math.abs(o-1)<.01&&(o=1),Math.abs(c-1)<.01&&(c=1),l.transform=l.webkitTransform=`translate(${n/o}px,${a/c}px)`,l.transitionDuration="0s",e}}function Up(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function hy(e,t,s){const n=e.cloneNode(),a=e[_a];a&&a.forEach(r=>{r.split(/\s+/).forEach(o=>o&&n.classList.remove(o))}),s.split(/\s+/).forEach(r=>r&&n.classList.add(r)),n.style.display="none";const i=t.nodeType===1?t:t.parentNode;i.appendChild(n);const{hasTransform:l}=Np(n);return i.removeChild(n),l}const xn=e=>{const t=e.props["onUpdate:modelValue"]||!1;return ge(t)?s=>fa(t,s):t};function gy(e){e.target.composing=!0}function Nu(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const gs=Symbol("_assign");function Ou(e,t,s){return t&&(e=e.trim()),s&&(e=Hl(e)),e}const wl={created(e,{modifiers:{lazy:t,trim:s,number:n}},a){e[gs]=xn(a);const i=n||a.props&&a.props.type==="number";Gs(e,t?"change":"input",l=>{l.target.composing||e[gs](Ou(e.value,s,i))}),(s||i)&&Gs(e,"change",()=>{e.value=Ou(e.value,s,i)}),t||(Gs(e,"compositionstart",gy),Gs(e,"compositionend",Nu),Gs(e,"change",Nu))},mounted(e,{value:t}){e.value=t??""},beforeUpdate(e,{value:t,oldValue:s,modifiers:{lazy:n,trim:a,number:i}},l){if(e[gs]=xn(l),e.composing)return;const r=(i||e.type==="number")&&!/^0\d/.test(e.value)?Hl(e.value):e.value,o=t??"";if(r===o)return;const c=e.getRootNode();(c instanceof Document||c instanceof ShadowRoot)&&c.activeElement===e&&e.type!=="range"&&(n&&t===s||a&&e.value.trim()===o)||(e.value=o)}},Xo={deep:!0,created(e,t,s){e[gs]=xn(s),Gs(e,"change",()=>{const n=e._modelValue,a=ka(e),i=e.checked,l=e[gs];if(ge(n)){const r=jl(n,a),o=r!==-1;if(i&&!o)l(n.concat(a));else if(!i&&o){const c=[...n];c.splice(r,1),l(c)}}else if(jn(n)){const r=new Set(n);i?r.add(a):r.delete(a),l(r)}else l(Hp(e,i))})},mounted:Lu,beforeUpdate(e,t,s){e[gs]=xn(s),Lu(e,t,s)}};function Lu(e,{value:t,oldValue:s},n){e._modelValue=t;let a;if(ge(t))a=jl(t,n.props.value)>-1;else if(jn(t))a=t.has(n.props.value);else{if(t===s)return;a=en(t,Hp(e,!0))}e.checked!==a&&(e.checked=a)}const ec={created(e,{value:t},s){e.checked=en(t,s.props.value),e[gs]=xn(s),Gs(e,"change",()=>{e[gs](ka(e))})},beforeUpdate(e,{value:t,oldValue:s},n){e[gs]=xn(n),t!==s&&(e.checked=en(t,n.props.value))}},Bp={deep:!0,created(e,{value:t,modifiers:{number:s}},n){const a=jn(t);Gs(e,"change",()=>{const i=Array.prototype.filter.call(e.options,l=>l.selected).map(l=>s?Hl(ka(l)):ka(l));e[gs](e.multiple?a?new Set(i):i:i[0]),e._assigning=!0,Et(()=>{e._assigning=!1})}),e[gs]=xn(n)},mounted(e,{value:t}){Du(e,t)},beforeUpdate(e,t,s){e[gs]=xn(s)},updated(e,{value:t}){e._assigning||Du(e,t)}};function Du(e,t){const s=e.multiple,n=ge(t);if(!(s&&!n&&!jn(t))){for(let a=0,i=e.options.length;a<i;a++){const l=e.options[a],r=ka(l);if(s)if(n){const o=typeof r;o==="string"||o==="number"?l.selected=t.some(c=>String(c)===String(r)):l.selected=jl(t,r)>-1}else l.selected=t.has(r);else if(en(ka(l),t)){e.selectedIndex!==a&&(e.selectedIndex=a);return}}!s&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function ka(e){return"_value"in e?e._value:e.value}function Hp(e,t){const s=t?"_trueValue":"_falseValue";return s in e?e[s]:t}const Vp={created(e,t,s){Gi(e,t,s,null,"created")},mounted(e,t,s){Gi(e,t,s,null,"mounted")},beforeUpdate(e,t,s,n){Gi(e,t,s,n,"beforeUpdate")},updated(e,t,s,n){Gi(e,t,s,n,"updated")}};function jp(e,t){switch(e){case"SELECT":return Bp;case"TEXTAREA":return wl;default:switch(t){case"checkbox":return Xo;case"radio":return ec;default:return wl}}}function Gi(e,t,s,n,a){const l=jp(e.tagName,s.props&&s.props.type)[a];l&&l(e,t,s,n)}function my(){wl.getSSRProps=({value:e})=>({value:e}),ec.getSSRProps=({value:e},t)=>{if(t.props&&en(t.props.value,e))return{checked:!0}},Xo.getSSRProps=({value:e},t)=>{if(ge(e)){if(t.props&&jl(e,t.props.value)>-1)return{checked:!0}}else if(jn(e)){if(t.props&&e.has(t.props.value))return{checked:!0}}else if(e)return{checked:!0}},Vp.getSSRProps=(e,t)=>{if(typeof t.type!="string")return;const s=jp(t.type.toUpperCase(),t.props&&t.props.type);if(s.getSSRProps)return s.getSSRProps(e,t)}}const vy=["ctrl","shift","alt","meta"],by={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>vy.some(s=>e[`${s}Key`]&&!t.includes(s))},yy=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((a,...i)=>{for(let l=0;l<t.length;l++){const r=by[t[l]];if(r&&r(a,t))return}return e(a,...i)}))},xy={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},_y=(e,t)=>{const s=e._withKeys||(e._withKeys={}),n=t.join(".");return s[n]||(s[n]=(a=>{if(!("key"in a))return;const i=es(a.key);if(t.some(l=>l===i||xy[l]===i))return e(a)}))},zp=Me({patchProp:Dp},Ep);let ti,Mu=!1;function qp(){return ti||(ti=ap(zp))}function Kp(){return ti=Mu?ti:ip(zp),Mu=!0,ti}const Gp=((...e)=>{qp().render(...e)}),ky=((...e)=>{Kp().hydrate(...e)}),Sl=((...e)=>{const t=qp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Jp(n);if(!a)return;const i=t._component;!we(i)&&!i.render&&!i.template&&(i.template=a.innerHTML),a.nodeType===1&&(a.textContent="");const l=s(a,!1,Zp(a));return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),l},t}),Wp=((...e)=>{const t=Kp().createApp(...e),{mount:s}=t;return t.mount=n=>{const a=Jp(n);if(a)return s(a,!0,Zp(a))},t});function Zp(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Jp(e){return Ce(e)?document.querySelector(e):e}let Pu=!1;const wy=()=>{Pu||(Pu=!0,my(),zb())},Sy=Object.freeze(Object.defineProperty({__proto__:null,BaseTransition:Mf,BaseTransitionPropsValidators:Fo,Comment:pt,DeprecationTypes:Pb,EffectScope:Eo,ErrorCodes:Um,ErrorTypeStrings:Rb,Fragment:At,KeepAlive:bv,ReactiveEffect:li,Static:Dn,Suspense:ub,Teleport:ev,Text:bn,TrackOpTypes:Om,Transition:Bb,TransitionGroup:uy,TriggerOpTypes:Lm,VueElement:tr,assertNumber:$m,callWithAsyncErrorHandling:is,callWithErrorHandling:Na,camelize:Qe,capitalize:zn,cloneVNode:Ms,compatUtils:Mb,computed:X,createApp:Sl,createBlock:vl,createCommentVNode:mp,createElementBlock:mb,createElementVNode:Zo,createHydrationRenderer:ip,createPropsRestProxy:Bv,createRenderer:ap,createSSRApp:Wp,createSlots:Tv,createStaticVNode:yb,createTextVNode:Jo,createVNode:lt,customRef:yf,defineAsyncComponent:mv,defineComponent:Ai,defineCustomElement:Mp,defineEmits:Iv,defineExpose:Nv,defineModel:Dv,defineOptions:Ov,defineProps:Rv,defineSSRCustomElement:ay,defineSlots:Lv,devtools:Ib,effect:tm,effectScope:Qg,getCurrentInstance:Gt,getCurrentScope:ef,getCurrentWatcher:Dm,getTransitionRawChildren:Zl,guardReactiveProps:gp,h:xa,handleError:qn,hasInjectionContext:Gm,hydrate:ky,hydrateOnIdle:uv,hydrateOnInteraction:hv,hydrateOnMediaQuery:pv,hydrateOnVisible:fv,initCustomFormatter:Cb,initDirectivesForSSR:wy,inject:ps,isMemoSame:Sp,isProxy:Ci,isReactive:Ys,isReadonly:Ds,isRef:bt,isRuntimeOnly:wb,isShallow:ss,isVNode:an,markRaw:vf,mergeDefaults:$v,mergeModels:Uv,mergeProps:vp,nextTick:Et,nodeOps:Ep,normalizeClass:Ti,normalizeProps:Ug,normalizeStyle:Si,onActivated:Uo,onBeforeMount:$f,onBeforeUnmount:Ql,onBeforeUpdate:Ho,onDeactivated:Bo,onErrorCaptured:Vf,onMounted:Be,onRenderTracked:Hf,onRenderTriggered:Bf,onScopeDispose:Xg,onServerPrefetch:Uf,onUnmounted:ht,onUpdated:Yl,onWatcherCleanup:_f,openBlock:hi,patchProp:Dp,popScopeId:zm,provide:Qa,proxyRefs:Lo,pushScopeId:jm,queuePostFlushCb:ci,reactive:_n,readonly:cl,ref:h,registerRuntimeCompiler:_p,render:Gp,renderList:Sv,renderSlot:Cv,resolveComponent:_v,resolveDirective:wv,resolveDynamicComponent:kv,resolveFilter:Db,resolveTransitionHooks:ya,setBlockTracking:gi,setDevtoolsHook:Nb,setTransitionHooks:nn,shallowReactive:No,shallowReadonly:xm,shallowRef:Oo,ssrContextKey:Ef,ssrUtils:Lb,stop:sm,toDisplayString:Qd,toHandlerKey:da,toHandlers:Ev,toRaw:Ue,toRef:Rm,toRefs:Cm,toValue:wm,transformVNodeArgs:vb,triggerRef:km,unref:Ls,useAttrs:Fv,useCssModule:ry,useCssVars:qb,useHost:Pp,useId:sv,useModel:Zv,useSSRContext:Af,useShadowRoot:ly,useSlots:Pv,useTemplateRef:nv,useTransitionState:Po,vModelCheckbox:Xo,vModelDynamic:Vp,vModelRadio:ec,vModelSelect:Bp,vModelText:wl,vShow:Op,version:Tp,warn:Ab,watch:hs,watchEffect:Wm,watchPostEffect:Zm,watchSyncEffect:Rf,withAsyncContext:Hv,withCtx:Mo,withDefaults:Mv,withDirectives:Km,withKeys:_y,withMemo:Eb,withModifiers:yy,withScopeId:qm},Symbol.toStringTag,{value:"Module"}));/**
* @vue/compiler-core v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const vi=Symbol(""),si=Symbol(""),tc=Symbol(""),Tl=Symbol(""),Yp=Symbol(""),Bn=Symbol(""),Qp=Symbol(""),Xp=Symbol(""),sc=Symbol(""),nc=Symbol(""),Ni=Symbol(""),ac=Symbol(""),eh=Symbol(""),ic=Symbol(""),lc=Symbol(""),rc=Symbol(""),oc=Symbol(""),cc=Symbol(""),uc=Symbol(""),th=Symbol(""),sh=Symbol(""),sr=Symbol(""),Cl=Symbol(""),dc=Symbol(""),fc=Symbol(""),bi=Symbol(""),Oi=Symbol(""),pc=Symbol(""),lo=Symbol(""),Ty=Symbol(""),ro=Symbol(""),El=Symbol(""),Cy=Symbol(""),Ey=Symbol(""),hc=Symbol(""),Ay=Symbol(""),Ry=Symbol(""),gc=Symbol(""),nh=Symbol(""),wa={[vi]:"Fragment",[si]:"Teleport",[tc]:"Suspense",[Tl]:"KeepAlive",[Yp]:"BaseTransition",[Bn]:"openBlock",[Qp]:"createBlock",[Xp]:"createElementBlock",[sc]:"createVNode",[nc]:"createElementVNode",[Ni]:"createCommentVNode",[ac]:"createTextVNode",[eh]:"createStaticVNode",[ic]:"resolveComponent",[lc]:"resolveDynamicComponent",[rc]:"resolveDirective",[oc]:"resolveFilter",[cc]:"withDirectives",[uc]:"renderList",[th]:"renderSlot",[sh]:"createSlots",[sr]:"toDisplayString",[Cl]:"mergeProps",[dc]:"normalizeClass",[fc]:"normalizeStyle",[bi]:"normalizeProps",[Oi]:"guardReactiveProps",[pc]:"toHandlers",[lo]:"camelize",[Ty]:"capitalize",[ro]:"toHandlerKey",[El]:"setBlockTracking",[Cy]:"pushScopeId",[Ey]:"popScopeId",[hc]:"withCtx",[Ay]:"unref",[Ry]:"isRef",[gc]:"withMemo",[nh]:"isMemoSame"};function Iy(e){Object.getOwnPropertySymbols(e).forEach(t=>{wa[t]=e[t]})}const os={start:{line:1,column:1,offset:0},end:{line:1,column:1,offset:0},source:""};function Ny(e,t=""){return{type:0,source:t,children:e,helpers:new Set,components:[],directives:[],hoists:[],imports:[],cached:[],temps:0,codegenNode:void 0,loc:os}}function yi(e,t,s,n,a,i,l,r=!1,o=!1,c=!1,u=os){return e&&(r?(e.helper(Bn),e.helper(Ca(e.inSSR,c))):e.helper(Ta(e.inSSR,c)),l&&e.helper(cc)),{type:13,tag:t,props:s,children:n,patchFlag:a,dynamicProps:i,directives:l,isBlock:r,disableTracking:o,isComponent:c,loc:u}}function Mn(e,t=os){return{type:17,loc:t,elements:e}}function fs(e,t=os){return{type:15,loc:t,properties:e}}function vt(e,t){return{type:16,loc:os,key:Ce(e)?Ne(e,!0):e,value:t}}function Ne(e,t=!1,s=os,n=0){return{type:4,loc:s,content:e,isStatic:t,constType:t?3:n}}function _s(e,t=os){return{type:8,loc:t,children:e}}function St(e,t=[],s=os){return{type:14,loc:s,callee:e,arguments:t}}function Sa(e,t=void 0,s=!1,n=!1,a=os){return{type:18,params:e,returns:t,newline:s,isSlot:n,loc:a}}function oo(e,t,s,n=!0){return{type:19,test:e,consequent:t,alternate:s,newline:n,loc:os}}function Oy(e,t,s=!1,n=!1){return{type:20,index:e,value:t,needPauseTracking:s,inVOnce:n,needArraySpread:!1,loc:os}}function Ly(e){return{type:21,body:e,loc:os}}function Ta(e,t){return e||t?sc:nc}function Ca(e,t){return e||t?Qp:Xp}function mc(e,{helper:t,removeHelper:s,inSSR:n}){e.isBlock||(e.isBlock=!0,s(Ta(n,e.isComponent)),t(Bn),t(Ca(n,e.isComponent)))}const Fu=new Uint8Array([123,123]),$u=new Uint8Array([125,125]);function Uu(e){return e>=97&&e<=122||e>=65&&e<=90}function ns(e){return e===32||e===10||e===9||e===12||e===13}function un(e){return e===47||e===62||ns(e)}function Al(e){const t=new Uint8Array(e.length);for(let s=0;s<e.length;s++)t[s]=e.charCodeAt(s);return t}const Mt={Cdata:new Uint8Array([67,68,65,84,65,91]),CdataEnd:new Uint8Array([93,93,62]),CommentEnd:new Uint8Array([45,45,62]),ScriptEnd:new Uint8Array([60,47,115,99,114,105,112,116]),StyleEnd:new Uint8Array([60,47,115,116,121,108,101]),TitleEnd:new Uint8Array([60,47,116,105,116,108,101]),TextareaEnd:new Uint8Array([60,47,116,101,120,116,97,114,101,97])};class Dy{constructor(t,s){this.stack=t,this.cbs=s,this.state=1,this.buffer="",this.sectionStart=0,this.index=0,this.entityStart=0,this.baseState=1,this.inRCDATA=!1,this.inXML=!1,this.inVPre=!1,this.newlines=[],this.mode=0,this.delimiterOpen=Fu,this.delimiterClose=$u,this.delimiterIndex=-1,this.currentSequence=void 0,this.sequenceIndex=0}get inSFCRoot(){return this.mode===2&&this.stack.length===0}reset(){this.state=1,this.mode=0,this.buffer="",this.sectionStart=0,this.index=0,this.baseState=1,this.inRCDATA=!1,this.currentSequence=void 0,this.newlines.length=0,this.delimiterOpen=Fu,this.delimiterClose=$u}getPos(t){let s=1,n=t+1;const a=this.newlines.length;let i=-1;if(a>100){let l=-1,r=a;for(;l+1<r;){const o=l+r>>>1;this.newlines[o]<t?l=o:r=o}i=l}else for(let l=a-1;l>=0;l--)if(t>this.newlines[l]){i=l;break}return i>=0&&(s=i+2,n=t-this.newlines[i]),{column:n,line:s,offset:t}}peek(){return this.buffer.charCodeAt(this.index+1)}stateText(t){t===60?(this.index>this.sectionStart&&this.cbs.ontext(this.sectionStart,this.index),this.state=5,this.sectionStart=this.index):!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t))}stateInterpolationOpen(t){if(t===this.delimiterOpen[this.delimiterIndex])if(this.delimiterIndex===this.delimiterOpen.length-1){const s=this.index+1-this.delimiterOpen.length;s>this.sectionStart&&this.cbs.ontext(this.sectionStart,s),this.state=3,this.sectionStart=s}else this.delimiterIndex++;else this.inRCDATA?(this.state=32,this.stateInRCDATA(t)):(this.state=1,this.stateText(t))}stateInterpolation(t){t===this.delimiterClose[0]&&(this.state=4,this.delimiterIndex=0,this.stateInterpolationClose(t))}stateInterpolationClose(t){t===this.delimiterClose[this.delimiterIndex]?this.delimiterIndex===this.delimiterClose.length-1?(this.cbs.oninterpolation(this.sectionStart,this.index+1),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):this.delimiterIndex++:(this.state=3,this.stateInterpolation(t))}stateSpecialStartSequence(t){const s=this.sequenceIndex===this.currentSequence.length;if(!(s?un(t):(t|32)===this.currentSequence[this.sequenceIndex]))this.inRCDATA=!1;else if(!s){this.sequenceIndex++;return}this.sequenceIndex=0,this.state=6,this.stateInTagName(t)}stateInRCDATA(t){if(this.sequenceIndex===this.currentSequence.length){if(t===62||ns(t)){const s=this.index-this.currentSequence.length;if(this.sectionStart<s){const n=this.index;this.index=s,this.cbs.ontext(this.sectionStart,s),this.index=n}this.sectionStart=s+2,this.stateInClosingTagName(t),this.inRCDATA=!1;return}this.sequenceIndex=0}(t|32)===this.currentSequence[this.sequenceIndex]?this.sequenceIndex+=1:this.sequenceIndex===0?this.currentSequence===Mt.TitleEnd||this.currentSequence===Mt.TextareaEnd&&!this.inSFCRoot?!this.inVPre&&t===this.delimiterOpen[0]&&(this.state=2,this.delimiterIndex=0,this.stateInterpolationOpen(t)):this.fastForwardTo(60)&&(this.sequenceIndex=1):this.sequenceIndex=+(t===60)}stateCDATASequence(t){t===Mt.Cdata[this.sequenceIndex]?++this.sequenceIndex===Mt.Cdata.length&&(this.state=28,this.currentSequence=Mt.CdataEnd,this.sequenceIndex=0,this.sectionStart=this.index+1):(this.sequenceIndex=0,this.state=23,this.stateInDeclaration(t))}fastForwardTo(t){for(;++this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);if(s===10&&this.newlines.push(this.index),s===t)return!0}return this.index=this.buffer.length-1,!1}stateInCommentLike(t){t===this.currentSequence[this.sequenceIndex]?++this.sequenceIndex===this.currentSequence.length&&(this.currentSequence===Mt.CdataEnd?this.cbs.oncdata(this.sectionStart,this.index-2):this.cbs.oncomment(this.sectionStart,this.index-2),this.sequenceIndex=0,this.sectionStart=this.index+1,this.state=1):this.sequenceIndex===0?this.fastForwardTo(this.currentSequence[0])&&(this.sequenceIndex=1):t!==this.currentSequence[this.sequenceIndex-1]&&(this.sequenceIndex=0)}startSpecial(t,s){this.enterRCDATA(t,s),this.state=31}enterRCDATA(t,s){this.inRCDATA=!0,this.currentSequence=t,this.sequenceIndex=s}stateBeforeTagName(t){t===33?(this.state=22,this.sectionStart=this.index+1):t===63?(this.state=24,this.sectionStart=this.index+1):Uu(t)?(this.sectionStart=this.index,this.mode===0?this.state=6:this.inSFCRoot?this.state=34:this.inXML?this.state=6:t===116?this.state=30:this.state=t===115?29:6):t===47?this.state=8:(this.state=1,this.stateText(t))}stateInTagName(t){un(t)&&this.handleTagName(t)}stateInSFCRootTagName(t){if(un(t)){const s=this.buffer.slice(this.sectionStart,this.index);s!=="template"&&this.enterRCDATA(Al("</"+s),0),this.handleTagName(t)}}handleTagName(t){this.cbs.onopentagname(this.sectionStart,this.index),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)}stateBeforeClosingTagName(t){ns(t)||(t===62?(this.state=1,this.sectionStart=this.index+1):(this.state=Uu(t)?9:27,this.sectionStart=this.index))}stateInClosingTagName(t){(t===62||ns(t))&&(this.cbs.onclosetag(this.sectionStart,this.index),this.sectionStart=-1,this.state=10,this.stateAfterClosingTagName(t))}stateAfterClosingTagName(t){t===62&&(this.state=1,this.sectionStart=this.index+1)}stateBeforeAttrName(t){t===62?(this.cbs.onopentagend(this.index),this.inRCDATA?this.state=32:this.state=1,this.sectionStart=this.index+1):t===47?this.state=7:t===60&&this.peek()===47?(this.cbs.onopentagend(this.index),this.state=5,this.sectionStart=this.index):ns(t)||this.handleAttrStart(t)}handleAttrStart(t){t===118&&this.peek()===45?(this.state=13,this.sectionStart=this.index):t===46||t===58||t===64||t===35?(this.cbs.ondirname(this.index,this.index+1),this.state=14,this.sectionStart=this.index+1):(this.state=12,this.sectionStart=this.index)}stateInSelfClosingTag(t){t===62?(this.cbs.onselfclosingtag(this.index),this.state=1,this.sectionStart=this.index+1,this.inRCDATA=!1):ns(t)||(this.state=11,this.stateBeforeAttrName(t))}stateInAttrName(t){(t===61||un(t))&&(this.cbs.onattribname(this.sectionStart,this.index),this.handleAttrNameEnd(t))}stateInDirName(t){t===61||un(t)?(this.cbs.ondirname(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===58?(this.cbs.ondirname(this.sectionStart,this.index),this.state=14,this.sectionStart=this.index+1):t===46&&(this.cbs.ondirname(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDirArg(t){t===61||un(t)?(this.cbs.ondirarg(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===91?this.state=15:t===46&&(this.cbs.ondirarg(this.sectionStart,this.index),this.state=16,this.sectionStart=this.index+1)}stateInDynamicDirArg(t){t===93?this.state=14:(t===61||un(t))&&(this.cbs.ondirarg(this.sectionStart,this.index+1),this.handleAttrNameEnd(t))}stateInDirModifier(t){t===61||un(t)?(this.cbs.ondirmodifier(this.sectionStart,this.index),this.handleAttrNameEnd(t)):t===46&&(this.cbs.ondirmodifier(this.sectionStart,this.index),this.sectionStart=this.index+1)}handleAttrNameEnd(t){this.sectionStart=this.index,this.state=17,this.cbs.onattribnameend(this.index),this.stateAfterAttrName(t)}stateAfterAttrName(t){t===61?this.state=18:t===47||t===62?(this.cbs.onattribend(0,this.sectionStart),this.sectionStart=-1,this.state=11,this.stateBeforeAttrName(t)):ns(t)||(this.cbs.onattribend(0,this.sectionStart),this.handleAttrStart(t))}stateBeforeAttrValue(t){t===34?(this.state=19,this.sectionStart=this.index+1):t===39?(this.state=20,this.sectionStart=this.index+1):ns(t)||(this.sectionStart=this.index,this.state=21,this.stateInAttrValueNoQuotes(t))}handleInAttrValue(t,s){(t===s||this.fastForwardTo(s))&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(s===34?3:2,this.index+1),this.state=11)}stateInAttrValueDoubleQuotes(t){this.handleInAttrValue(t,34)}stateInAttrValueSingleQuotes(t){this.handleInAttrValue(t,39)}stateInAttrValueNoQuotes(t){ns(t)||t===62?(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=-1,this.cbs.onattribend(1,this.index),this.state=11,this.stateBeforeAttrName(t)):(t===39||t===60||t===61||t===96)&&this.cbs.onerr(18,this.index)}stateBeforeDeclaration(t){t===91?(this.state=26,this.sequenceIndex=0):this.state=t===45?25:23}stateInDeclaration(t){(t===62||this.fastForwardTo(62))&&(this.state=1,this.sectionStart=this.index+1)}stateInProcessingInstruction(t){(t===62||this.fastForwardTo(62))&&(this.cbs.onprocessinginstruction(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeComment(t){t===45?(this.state=28,this.currentSequence=Mt.CommentEnd,this.sequenceIndex=2,this.sectionStart=this.index+1):this.state=23}stateInSpecialComment(t){(t===62||this.fastForwardTo(62))&&(this.cbs.oncomment(this.sectionStart,this.index),this.state=1,this.sectionStart=this.index+1)}stateBeforeSpecialS(t){t===Mt.ScriptEnd[3]?this.startSpecial(Mt.ScriptEnd,4):t===Mt.StyleEnd[3]?this.startSpecial(Mt.StyleEnd,4):(this.state=6,this.stateInTagName(t))}stateBeforeSpecialT(t){t===Mt.TitleEnd[3]?this.startSpecial(Mt.TitleEnd,4):t===Mt.TextareaEnd[3]?this.startSpecial(Mt.TextareaEnd,4):(this.state=6,this.stateInTagName(t))}startEntity(){}stateInEntity(){}parse(t){for(this.buffer=t;this.index<this.buffer.length;){const s=this.buffer.charCodeAt(this.index);switch(s===10&&this.state!==33&&this.newlines.push(this.index),this.state){case 1:{this.stateText(s);break}case 2:{this.stateInterpolationOpen(s);break}case 3:{this.stateInterpolation(s);break}case 4:{this.stateInterpolationClose(s);break}case 31:{this.stateSpecialStartSequence(s);break}case 32:{this.stateInRCDATA(s);break}case 26:{this.stateCDATASequence(s);break}case 19:{this.stateInAttrValueDoubleQuotes(s);break}case 12:{this.stateInAttrName(s);break}case 13:{this.stateInDirName(s);break}case 14:{this.stateInDirArg(s);break}case 15:{this.stateInDynamicDirArg(s);break}case 16:{this.stateInDirModifier(s);break}case 28:{this.stateInCommentLike(s);break}case 27:{this.stateInSpecialComment(s);break}case 11:{this.stateBeforeAttrName(s);break}case 6:{this.stateInTagName(s);break}case 34:{this.stateInSFCRootTagName(s);break}case 9:{this.stateInClosingTagName(s);break}case 5:{this.stateBeforeTagName(s);break}case 17:{this.stateAfterAttrName(s);break}case 20:{this.stateInAttrValueSingleQuotes(s);break}case 18:{this.stateBeforeAttrValue(s);break}case 8:{this.stateBeforeClosingTagName(s);break}case 10:{this.stateAfterClosingTagName(s);break}case 29:{this.stateBeforeSpecialS(s);break}case 30:{this.stateBeforeSpecialT(s);break}case 21:{this.stateInAttrValueNoQuotes(s);break}case 7:{this.stateInSelfClosingTag(s);break}case 23:{this.stateInDeclaration(s);break}case 22:{this.stateBeforeDeclaration(s);break}case 25:{this.stateBeforeComment(s);break}case 24:{this.stateInProcessingInstruction(s);break}case 33:{this.stateInEntity();break}}this.index++}this.cleanup(),this.finish()}cleanup(){this.sectionStart!==this.index&&(this.state===1||this.state===32&&this.sequenceIndex===0?(this.cbs.ontext(this.sectionStart,this.index),this.sectionStart=this.index):(this.state===19||this.state===20||this.state===21)&&(this.cbs.onattribdata(this.sectionStart,this.index),this.sectionStart=this.index))}finish(){this.handleTrailingData(),this.cbs.onend()}handleTrailingData(){const t=this.buffer.length;this.sectionStart>=t||(this.state===28?this.currentSequence===Mt.CdataEnd?this.cbs.oncdata(this.sectionStart,t):this.cbs.oncomment(this.sectionStart,t):this.state===6||this.state===11||this.state===18||this.state===17||this.state===12||this.state===13||this.state===14||this.state===15||this.state===16||this.state===20||this.state===19||this.state===21||this.state===9||this.cbs.ontext(this.sectionStart,t))}emitCodePoint(t,s){}}function Bu(e,{compatConfig:t}){const s=t&&t[e];return e==="MODE"?s||3:s}function Pn(e,t){const s=Bu("MODE",t),n=Bu(e,t);return s===3?n===!0:n!==!1}function xi(e,t,s,...n){return Pn(e,t)}function vc(e){throw e}function ah(e){}function at(e,t,s,n){const a=`https://vuejs.org/error-reference/#compiler-${e}`,i=new SyntaxError(String(a));return i.code=e,i.loc=t,i}const ts=e=>e.type===4&&e.isStatic;function ih(e){switch(e){case"Teleport":case"teleport":return si;case"Suspense":case"suspense":return tc;case"KeepAlive":case"keep-alive":return Tl;case"BaseTransition":case"base-transition":return Yp}}const My=/^$|^\d|[^\$\w\xA0-\uFFFF]/,bc=e=>!My.test(e),lh=/[A-Za-z_$\xA0-\uFFFF]/,Py=/[\.\?\w$\xA0-\uFFFF]/,Fy=/\s+[.[]\s*|\s*[.[]\s+/g,rh=e=>e.type===4?e.content:e.loc.source,$y=e=>{const t=rh(e).trim().replace(Fy,r=>r.trim());let s=0,n=[],a=0,i=0,l=null;for(let r=0;r<t.length;r++){const o=t.charAt(r);switch(s){case 0:if(o==="[")n.push(s),s=1,a++;else if(o==="(")n.push(s),s=2,i++;else if(!(r===0?lh:Py).test(o))return!1;break;case 1:o==="'"||o==='"'||o==="`"?(n.push(s),s=3,l=o):o==="["?a++:o==="]"&&(--a||(s=n.pop()));break;case 2:if(o==="'"||o==='"'||o==="`")n.push(s),s=3,l=o;else if(o==="(")i++;else if(o===")"){if(r===t.length-1)return!1;--i||(s=n.pop())}break;case 3:o===l&&(s=n.pop(),l=null);break}}return!a&&!i},oh=$y,Uy=/^\s*(?:async\s*)?(?:\([^)]*?\)|[\w$_]+)\s*(?::[^=]+)?=>|^\s*(?:async\s+)?function(?:\s+[\w$]+)?\s*\(/,By=e=>Uy.test(rh(e)),Hy=By;function ds(e,t,s=!1){for(let n=0;n<e.props.length;n++){const a=e.props[n];if(a.type===7&&(s||a.exp)&&(Ce(t)?a.name===t:t.test(a.name)))return a}}function nr(e,t,s=!1,n=!1){for(let a=0;a<e.props.length;a++){const i=e.props[a];if(i.type===6){if(s)continue;if(i.name===t&&(i.value||n))return i}else if(i.name==="bind"&&(i.exp||n)&&Rn(i.arg,t))return i}}function Rn(e,t){return!!(e&&ts(e)&&e.content===t)}function Vy(e){return e.props.some(t=>t.type===7&&t.name==="bind"&&(!t.arg||t.arg.type!==4||!t.arg.isStatic))}function Er(e){return e.type===5||e.type===2}function Hu(e){return e.type===7&&e.name==="pre"}function jy(e){return e.type===7&&e.name==="slot"}function Rl(e){return e.type===1&&e.tagType===3}function Il(e){return e.type===1&&e.tagType===2}const zy=new Set([bi,Oi]);function ch(e,t=[]){if(e&&!Ce(e)&&e.type===14){const s=e.callee;if(!Ce(s)&&zy.has(s))return ch(e.arguments[0],t.concat(e))}return[e,t]}function Nl(e,t,s){let n,a=e.type===13?e.props:e.arguments[2],i=[],l;if(a&&!Ce(a)&&a.type===14){const r=ch(a);a=r[0],i=r[1],l=i[i.length-1]}if(a==null||Ce(a))n=fs([t]);else if(a.type===14){const r=a.arguments[0];!Ce(r)&&r.type===15?Vu(t,r)||r.properties.unshift(t):a.callee===pc?n=St(s.helper(Cl),[fs([t]),a]):a.arguments.unshift(fs([t])),!n&&(n=a)}else a.type===15?(Vu(t,a)||a.properties.unshift(t),n=a):(n=St(s.helper(Cl),[fs([t]),a]),l&&l.callee===Oi&&(l=i[i.length-2]));e.type===13?l?l.arguments[0]=n:e.props=n:l?l.arguments[0]=n:e.arguments[2]=n}function Vu(e,t){let s=!1;if(e.key.type===4){const n=e.key.content;s=t.properties.some(a=>a.key.type===4&&a.key.content===n)}return s}function _i(e,t){return`_${t}_${e.replace(/[^\w]/g,(s,n)=>s==="-"?"_":e.charCodeAt(n).toString())}`}function qy(e){return e.type===14&&e.callee===gc?e.arguments[1].returns:e}const Ky=/([\s\S]*?)\s+(?:in|of)\s+(\S[\s\S]*)/;function uh(e){for(let t=0;t<e.length;t++)if(!ns(e.charCodeAt(t)))return!1;return!0}function yc(e){return e.type===2&&uh(e.content)||e.type===12&&yc(e.content)}function dh(e){return e.type===3||yc(e)}const fh={parseMode:"base",ns:0,delimiters:["{{","}}"],getNamespace:()=>0,isVoidTag:ra,isPreTag:ra,isIgnoreNewlineTag:ra,isCustomElement:ra,onError:vc,onWarn:ah,comments:!1,prefixIdentifiers:!1};let He=fh,ki=null,Xs="",Ft=null,$e=null,Jt="",Hs=-1,En=-1,xc=0,mn=!1,co=null;const nt=[],ut=new Dy(nt,{onerr:$s,ontext(e,t){Wi(It(e,t),e,t)},ontextentity(e,t,s){Wi(e,t,s)},oninterpolation(e,t){if(mn)return Wi(It(e,t),e,t);let s=e+ut.delimiterOpen.length,n=t-ut.delimiterClose.length;for(;ns(Xs.charCodeAt(s));)s++;for(;ns(Xs.charCodeAt(n-1));)n--;let a=It(s,n);a.includes("&")&&(a=He.decodeEntities(a,!1)),uo({type:5,content:nl(a,!1,ft(s,n)),loc:ft(e,t)})},onopentagname(e,t){const s=It(e,t);Ft={type:1,tag:s,ns:He.getNamespace(s,nt[0],He.ns),tagType:0,props:[],children:[],loc:ft(e-1,t),codegenNode:void 0}},onopentagend(e){zu(e)},onclosetag(e,t){const s=It(e,t);if(!He.isVoidTag(s)){let n=!1;for(let a=0;a<nt.length;a++)if(nt[a].tag.toLowerCase()===s.toLowerCase()){n=!0,a>0&&$s(24,nt[0].loc.start.offset);for(let l=0;l<=a;l++){const r=nt.shift();sl(r,t,l<a)}break}n||$s(23,ph(e,60))}},onselfclosingtag(e){const t=Ft.tag;Ft.isSelfClosing=!0,zu(e),nt[0]&&nt[0].tag===t&&sl(nt.shift(),e)},onattribname(e,t){$e={type:6,name:It(e,t),nameLoc:ft(e,t),value:void 0,loc:ft(e)}},ondirname(e,t){const s=It(e,t),n=s==="."||s===":"?"bind":s==="@"?"on":s==="#"?"slot":s.slice(2);if(!mn&&n===""&&$s(26,e),mn||n==="")$e={type:6,name:s,nameLoc:ft(e,t),value:void 0,loc:ft(e)};else if($e={type:7,name:n,rawName:s,exp:void 0,arg:void 0,modifiers:s==="."?[Ne("prop")]:[],loc:ft(e)},n==="pre"){mn=ut.inVPre=!0,co=Ft;const a=Ft.props;for(let i=0;i<a.length;i++)a[i].type===7&&(a[i]=s0(a[i]))}},ondirarg(e,t){if(e===t)return;const s=It(e,t);if(mn&&!Hu($e))$e.name+=s,In($e.nameLoc,t);else{const n=s[0]!=="[";$e.arg=nl(n?s:s.slice(1,-1),n,ft(e,t),n?3:0)}},ondirmodifier(e,t){const s=It(e,t);if(mn&&!Hu($e))$e.name+="."+s,In($e.nameLoc,t);else if($e.name==="slot"){const n=$e.arg;n&&(n.content+="."+s,In(n.loc,t))}else{const n=Ne(s,!0,ft(e,t));$e.modifiers.push(n)}},onattribdata(e,t){Jt+=It(e,t),Hs<0&&(Hs=e),En=t},onattribentity(e,t,s){Jt+=e,Hs<0&&(Hs=t),En=s},onattribnameend(e){const t=$e.loc.start.offset,s=It(t,e);$e.type===7&&($e.rawName=s),Ft.props.some(n=>(n.type===7?n.rawName:n.name)===s)&&$s(2,t)},onattribend(e,t){if(Ft&&$e){if(In($e.loc,t),e!==0)if(Jt.includes("&")&&(Jt=He.decodeEntities(Jt,!0)),$e.type===6)$e.name==="class"&&(Jt=gh(Jt).trim()),e===1&&!Jt&&$s(13,t),$e.value={type:2,content:Jt,loc:e===1?ft(Hs,En):ft(Hs-1,En+1)},ut.inSFCRoot&&Ft.tag==="template"&&$e.name==="lang"&&Jt&&Jt!=="html"&&ut.enterRCDATA(Al("</template"),0);else{let s=0;$e.exp=nl(Jt,!1,ft(Hs,En),0,s),$e.name==="for"&&($e.forParseResult=Wy($e.exp));let n=-1;$e.name==="bind"&&(n=$e.modifiers.findIndex(a=>a.content==="sync"))>-1&&xi("COMPILER_V_BIND_SYNC",He,$e.loc,$e.arg.loc.source)&&($e.name="model",$e.modifiers.splice(n,1))}($e.type!==7||$e.name!=="pre")&&Ft.props.push($e)}Jt="",Hs=En=-1},oncomment(e,t){He.comments&&uo({type:3,content:It(e,t),loc:ft(e-4,t+3)})},onend(){const e=Xs.length;for(let t=0;t<nt.length;t++)sl(nt[t],e-1),$s(24,nt[t].loc.start.offset)},oncdata(e,t){(nt[0]?nt[0].ns:He.ns)!==0?Wi(It(e,t),e,t):$s(1,e-9)},onprocessinginstruction(e){(nt[0]?nt[0].ns:He.ns)===0&&$s(21,e-1)}}),ju=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,Gy=/^\(|\)$/g;function Wy(e){const t=e.loc,s=e.content,n=s.match(Ky);if(!n)return;const[,a,i]=n,l=(d,f,p=!1)=>{const m=t.start.offset+f,g=m+d.length;return nl(d,!1,ft(m,g),0,p?1:0)},r={source:l(i.trim(),s.indexOf(i,a.length)),value:void 0,key:void 0,index:void 0,finalized:!1};let o=a.trim().replace(Gy,"").trim();const c=a.indexOf(o),u=o.match(ju);if(u){o=o.replace(ju,"").trim();const d=u[1].trim();let f;if(d&&(f=s.indexOf(d,c+o.length),r.key=l(d,f,!0)),u[2]){const p=u[2].trim();p&&(r.index=l(p,s.indexOf(p,r.key?f+d.length:c+o.length),!0))}}return o&&(r.value=l(o,c,!0)),r}function It(e,t){return Xs.slice(e,t)}function zu(e){ut.inSFCRoot&&(Ft.innerLoc=ft(e+1,e+1)),uo(Ft);const{tag:t,ns:s}=Ft;s===0&&He.isPreTag(t)&&xc++,He.isVoidTag(t)?sl(Ft,e):(nt.unshift(Ft),(s===1||s===2)&&(ut.inXML=!0)),Ft=null}function Wi(e,t,s){{const i=nt[0]&&nt[0].tag;i!=="script"&&i!=="style"&&e.includes("&")&&(e=He.decodeEntities(e,!1))}const n=nt[0]||ki,a=n.children[n.children.length-1];a&&a.type===2?(a.content+=e,In(a.loc,s)):n.children.push({type:2,content:e,loc:ft(t,s)})}function sl(e,t,s=!1){s?In(e.loc,ph(t,60)):In(e.loc,Zy(t,62)+1),ut.inSFCRoot&&(e.children.length?e.innerLoc.end=Me({},e.children[e.children.length-1].loc.end):e.innerLoc.end=Me({},e.innerLoc.start),e.innerLoc.source=It(e.innerLoc.start.offset,e.innerLoc.end.offset));const{tag:n,ns:a,children:i}=e;if(mn||(n==="slot"?e.tagType=2:qu(e)?e.tagType=3:Yy(e)&&(e.tagType=1)),ut.inRCDATA||(e.children=hh(i)),a===0&&He.isIgnoreNewlineTag(n)){const l=i[0];l&&l.type===2&&(l.content=l.content.replace(/^\r?\n/,""))}a===0&&He.isPreTag(n)&&xc--,co===e&&(mn=ut.inVPre=!1,co=null),ut.inXML&&(nt[0]?nt[0].ns:He.ns)===0&&(ut.inXML=!1);{const l=e.props;if(!ut.inSFCRoot&&Pn("COMPILER_NATIVE_TEMPLATE",He)&&e.tag==="template"&&!qu(e)){const o=nt[0]||ki,c=o.children.indexOf(e);o.children.splice(c,1,...e.children)}const r=l.find(o=>o.type===6&&o.name==="inline-template");r&&xi("COMPILER_INLINE_TEMPLATE",He,r.loc)&&e.children.length&&(r.value={type:2,content:It(e.children[0].loc.start.offset,e.children[e.children.length-1].loc.end.offset),loc:r.loc})}}function Zy(e,t){let s=e;for(;Xs.charCodeAt(s)!==t&&s<Xs.length-1;)s++;return s}function ph(e,t){let s=e;for(;Xs.charCodeAt(s)!==t&&s>=0;)s--;return s}const Jy=new Set(["if","else","else-if","for","slot"]);function qu({tag:e,props:t}){if(e==="template"){for(let s=0;s<t.length;s++)if(t[s].type===7&&Jy.has(t[s].name))return!0}return!1}function Yy({tag:e,props:t}){if(He.isCustomElement(e))return!1;if(e==="component"||Qy(e.charCodeAt(0))||ih(e)||He.isBuiltInComponent&&He.isBuiltInComponent(e)||He.isNativeTag&&!He.isNativeTag(e))return!0;for(let s=0;s<t.length;s++){const n=t[s];if(n.type===6){if(n.name==="is"&&n.value){if(n.value.content.startsWith("vue:"))return!0;if(xi("COMPILER_IS_ON_ELEMENT",He,n.loc))return!0}}else if(n.name==="bind"&&Rn(n.arg,"is")&&xi("COMPILER_IS_ON_ELEMENT",He,n.loc))return!0}return!1}function Qy(e){return e>64&&e<91}const Xy=/\r\n/g;function hh(e){const t=He.whitespace!=="preserve";let s=!1;for(let n=0;n<e.length;n++){const a=e[n];if(a.type===2)if(xc)a.content=a.content.replace(Xy,`
`);else if(uh(a.content)){const i=e[n-1]&&e[n-1].type,l=e[n+1]&&e[n+1].type;!i||!l||t&&(i===3&&(l===3||l===1)||i===1&&(l===3||l===1&&e0(a.content)))?(s=!0,e[n]=null):a.content=" "}else t&&(a.content=gh(a.content))}return s?e.filter(Boolean):e}function e0(e){for(let t=0;t<e.length;t++){const s=e.charCodeAt(t);if(s===10||s===13)return!0}return!1}function gh(e){let t="",s=!1;for(let n=0;n<e.length;n++)ns(e.charCodeAt(n))?s||(t+=" ",s=!0):(t+=e[n],s=!1);return t}function uo(e){(nt[0]||ki).children.push(e)}function ft(e,t){return{start:ut.getPos(e),end:t==null?t:ut.getPos(t),source:t==null?t:It(e,t)}}function t0(e){return ft(e.start.offset,e.end.offset)}function In(e,t){e.end=ut.getPos(t),e.source=It(e.start.offset,t)}function s0(e){const t={type:6,name:e.rawName,nameLoc:ft(e.loc.start.offset,e.loc.start.offset+e.rawName.length),value:void 0,loc:e.loc};if(e.exp){const s=e.exp.loc;s.end.offset<e.loc.end.offset&&(s.start.offset--,s.start.column--,s.end.offset++,s.end.column++),t.value={type:2,content:e.exp.content,loc:s}}return t}function nl(e,t=!1,s,n=0,a=0){return Ne(e,t,s,n)}function $s(e,t,s){He.onError(at(e,ft(t,t)))}function n0(){ut.reset(),Ft=null,$e=null,Jt="",Hs=-1,En=-1,nt.length=0}function a0(e,t){if(n0(),Xs=e,He=Me({},fh),t){let a;for(a in t)t[a]!=null&&(He[a]=t[a])}ut.mode=He.parseMode==="html"?1:He.parseMode==="sfc"?2:0,ut.inXML=He.ns===1||He.ns===2;const s=t&&t.delimiters;s&&(ut.delimiterOpen=Al(s[0]),ut.delimiterClose=Al(s[1]));const n=ki=Ny([],e);return ut.parse(Xs),n.loc=ft(0,e.length),n.children=hh(n.children),ki=null,n}function i0(e,t){al(e,void 0,t,!!mh(e))}function mh(e){const t=e.children.filter(s=>s.type!==3);return t.length===1&&t[0].type===1&&!Il(t[0])?t[0]:null}function al(e,t,s,n=!1,a=!1){const{children:i}=e,l=[];for(let u=0;u<i.length;u++){const d=i[u];if(d.type===1&&d.tagType===0){const f=n?0:as(d,s);if(f>0){if(f>=2){d.codegenNode.patchFlag=-1,l.push(d);continue}}else{const p=d.codegenNode;if(p.type===13){const m=p.patchFlag;if((m===void 0||m===512||m===1)&&bh(d,s)>=2){const g=yh(d);g&&(p.props=s.hoist(g))}p.dynamicProps&&(p.dynamicProps=s.hoist(p.dynamicProps))}}}else if(d.type===12&&(n?0:as(d,s))>=2){d.codegenNode.type===14&&d.codegenNode.arguments.length>0&&d.codegenNode.arguments.push("-1"),l.push(d);continue}if(d.type===1){const f=d.tagType===1;f&&s.scopes.vSlot++,al(d,e,s,!1,a),f&&s.scopes.vSlot--}else if(d.type===11)al(d,e,s,d.children.length===1,!0);else if(d.type===9)for(let f=0;f<d.branches.length;f++)al(d.branches[f],e,s,d.branches[f].children.length===1,a)}let r=!1;if(l.length===i.length&&e.type===1){if(e.tagType===0&&e.codegenNode&&e.codegenNode.type===13&&ge(e.codegenNode.children))e.codegenNode.children=o(Mn(e.codegenNode.children)),r=!0;else if(e.tagType===1&&e.codegenNode&&e.codegenNode.type===13&&e.codegenNode.children&&!ge(e.codegenNode.children)&&e.codegenNode.children.type===15){const u=c(e.codegenNode,"default");u&&(u.returns=o(Mn(u.returns)),r=!0)}else if(e.tagType===3&&t&&t.type===1&&t.tagType===1&&t.codegenNode&&t.codegenNode.type===13&&t.codegenNode.children&&!ge(t.codegenNode.children)&&t.codegenNode.children.type===15){const u=ds(e,"slot",!0),d=u&&u.arg&&c(t.codegenNode,u.arg);d&&(d.returns=o(Mn(d.returns)),r=!0)}}if(!r)for(const u of l)u.codegenNode=s.cache(u.codegenNode);function o(u){const d=s.cache(u);return d.needArraySpread=!0,d}function c(u,d){if(u.children&&!ge(u.children)&&u.children.type===15){const f=u.children.properties.find(p=>p.key===d||p.key.content===d);return f&&f.value}}l.length&&s.transformHoist&&s.transformHoist(i,s,e)}function as(e,t){const{constantCache:s}=t;switch(e.type){case 1:if(e.tagType!==0)return 0;const n=s.get(e);if(n!==void 0)return n;const a=e.codegenNode;if(a.type!==13||a.isBlock&&e.tag!=="svg"&&e.tag!=="foreignObject"&&e.tag!=="math")return 0;if(a.patchFlag===void 0){let l=3;const r=bh(e,t);if(r===0)return s.set(e,0),0;r<l&&(l=r);for(let o=0;o<e.children.length;o++){const c=as(e.children[o],t);if(c===0)return s.set(e,0),0;c<l&&(l=c)}if(l>1)for(let o=0;o<e.props.length;o++){const c=e.props[o];if(c.type===7&&c.name==="bind"&&c.exp){const u=as(c.exp,t);if(u===0)return s.set(e,0),0;u<l&&(l=u)}}if(a.isBlock){for(let o=0;o<e.props.length;o++)if(e.props[o].type===7)return s.set(e,0),0;t.removeHelper(Bn),t.removeHelper(Ca(t.inSSR,a.isComponent)),a.isBlock=!1,t.helper(Ta(t.inSSR,a.isComponent))}return s.set(e,l),l}else return s.set(e,0),0;case 2:case 3:return 3;case 9:case 11:case 10:return 0;case 5:case 12:return as(e.content,t);case 4:return e.constType;case 8:let i=3;for(let l=0;l<e.children.length;l++){const r=e.children[l];if(Ce(r)||Ht(r))continue;const o=as(r,t);if(o===0)return 0;o<i&&(i=o)}return i;case 20:return 2;default:return 0}}const l0=new Set([dc,fc,bi,Oi]);function vh(e,t){if(e.type===14&&!Ce(e.callee)&&l0.has(e.callee)){const s=e.arguments[0];if(s.type===4)return as(s,t);if(s.type===14)return vh(s,t)}return 0}function bh(e,t){let s=3;const n=yh(e);if(n&&n.type===15){const{properties:a}=n;for(let i=0;i<a.length;i++){const{key:l,value:r}=a[i],o=as(l,t);if(o===0)return o;o<s&&(s=o);let c;if(r.type===4?c=as(r,t):r.type===14?c=vh(r,t):c=0,c===0)return c;c<s&&(s=c)}}return s}function yh(e){const t=e.codegenNode;if(t.type===13)return t.props}function r0(e,{filename:t="",prefixIdentifiers:s=!1,hoistStatic:n=!1,hmr:a=!1,cacheHandlers:i=!1,nodeTransforms:l=[],directiveTransforms:r={},transformHoist:o=null,isBuiltInComponent:c=Lt,isCustomElement:u=Lt,expressionPlugins:d=[],scopeId:f=null,slotted:p=!0,ssr:m=!1,inSSR:g=!1,ssrCssVars:k="",bindingMetadata:E=Fe,inline:b=!1,isTS:v=!1,onError:x=vc,onWarn:w=ah,compatConfig:N}){const O=t.replace(/\?.*$/,"").match(/([^/\\]+)\.\w+$/),S={filename:t,selfName:O&&zn(Qe(O[1])),prefixIdentifiers:s,hoistStatic:n,hmr:a,cacheHandlers:i,nodeTransforms:l,directiveTransforms:r,transformHoist:o,isBuiltInComponent:c,isCustomElement:u,expressionPlugins:d,scopeId:f,slotted:p,ssr:m,inSSR:g,ssrCssVars:k,bindingMetadata:E,inline:b,isTS:v,onError:x,onWarn:w,compatConfig:N,root:e,helpers:new Map,components:new Set,directives:new Set,hoists:[],imports:[],cached:[],constantCache:new WeakMap,vForMemoKeyedNodes:new WeakSet,temps:0,identifiers:Object.create(null),scopes:{vFor:0,vSlot:0,vPre:0,vOnce:0},parent:null,grandParent:null,currentNode:e,childIndex:0,inVOnce:!1,helper(R){const L=S.helpers.get(R)||0;return S.helpers.set(R,L+1),R},removeHelper(R){const L=S.helpers.get(R);if(L){const H=L-1;H?S.helpers.set(R,H):S.helpers.delete(R)}},helperString(R){return`_${wa[S.helper(R)]}`},replaceNode(R){S.parent.children[S.childIndex]=S.currentNode=R},removeNode(R){const L=S.parent.children,H=R?L.indexOf(R):S.currentNode?S.childIndex:-1;!R||R===S.currentNode?(S.currentNode=null,S.onNodeRemoved()):S.childIndex>H&&(S.childIndex--,S.onNodeRemoved()),S.parent.children.splice(H,1)},onNodeRemoved:Lt,addIdentifiers(R){},removeIdentifiers(R){},hoist(R){Ce(R)&&(R=Ne(R)),S.hoists.push(R);const L=Ne(`_hoisted_${S.hoists.length}`,!1,R.loc,2);return L.hoisted=R,L},cache(R,L=!1,H=!1){const P=Oy(S.cached.length,R,L,H);return S.cached.push(P),P}};return S.filters=new Set,S}function o0(e,t){const s=r0(e,t);ar(e,s),t.hoistStatic&&i0(e,s),t.ssr||c0(e,s),e.helpers=new Set([...s.helpers.keys()]),e.components=[...s.components],e.directives=[...s.directives],e.imports=s.imports,e.hoists=s.hoists,e.temps=s.temps,e.cached=s.cached,e.transformed=!0,e.filters=[...s.filters]}function c0(e,t){const{helper:s}=t,{children:n}=e;if(n.length===1){const a=mh(e);if(a&&a.codegenNode){const i=a.codegenNode;i.type===13&&mc(i,t),e.codegenNode=i}else e.codegenNode=n[0]}else if(n.length>1){let a=64;e.codegenNode=yi(t,s(vi),void 0,e.children,a,void 0,void 0,!0,void 0,!1)}}function u0(e,t){let s=0;const n=()=>{s--};for(;s<e.children.length;s++){const a=e.children[s];Ce(a)||(t.grandParent=t.parent,t.parent=e,t.childIndex=s,t.onNodeRemoved=n,ar(a,t))}}function ar(e,t){t.currentNode=e;const{nodeTransforms:s}=t,n=[];for(let i=0;i<s.length;i++){const l=s[i](e,t);if(l&&(ge(l)?n.push(...l):n.push(l)),t.currentNode)e=t.currentNode;else return}switch(e.type){case 3:t.ssr||t.helper(Ni);break;case 5:t.ssr||t.helper(sr);break;case 9:for(let i=0;i<e.branches.length;i++)ar(e.branches[i],t);break;case 10:case 11:case 1:case 0:u0(e,t);break}t.currentNode=e;let a=n.length;for(;a--;)n[a]()}function xh(e,t){const s=Ce(e)?n=>n===e:n=>e.test(n);return(n,a)=>{if(n.type===1){const{props:i}=n;if(n.tagType===3&&i.some(jy))return;const l=[];for(let r=0;r<i.length;r++){const o=i[r];if(o.type===7&&s(o.name)){i.splice(r,1),r--;const c=t(n,o,a);c&&l.push(c)}}return l}}}const ir="/*@__PURE__*/",_h=e=>`${wa[e]}: _${wa[e]}`;function d0(e,{mode:t="function",prefixIdentifiers:s=t==="module",sourceMap:n=!1,filename:a="template.vue.html",scopeId:i=null,optimizeImports:l=!1,runtimeGlobalName:r="Vue",runtimeModuleName:o="vue",ssrRuntimeModuleName:c="vue/server-renderer",ssr:u=!1,isTS:d=!1,inSSR:f=!1}){const p={mode:t,prefixIdentifiers:s,sourceMap:n,filename:a,scopeId:i,optimizeImports:l,runtimeGlobalName:r,runtimeModuleName:o,ssrRuntimeModuleName:c,ssr:u,isTS:d,inSSR:f,source:e.source,code:"",column:1,line:1,offset:0,indentLevel:0,pure:!1,map:void 0,helper(g){return`_${wa[g]}`},push(g,k=-2,E){p.code+=g},indent(){m(++p.indentLevel)},deindent(g=!1){g?--p.indentLevel:m(--p.indentLevel)},newline(){m(p.indentLevel)}};function m(g){p.push(`
`+"  ".repeat(g),0)}return p}function f0(e,t={}){const s=d0(e,t);t.onContextCreated&&t.onContextCreated(s);const{mode:n,push:a,prefixIdentifiers:i,indent:l,deindent:r,newline:o,scopeId:c,ssr:u}=s,d=Array.from(e.helpers),f=d.length>0,p=!i&&n!=="module";p0(e,s);const g=u?"ssrRender":"render",E=(u?["_ctx","_push","_parent","_attrs"]:["_ctx","_cache"]).join(", ");if(a(`function ${g}(${E}) {`),l(),p&&(a("with (_ctx) {"),l(),f&&(a(`const { ${d.map(_h).join(", ")} } = _Vue
`,-1),o())),e.components.length&&(Ar(e.components,"component",s),(e.directives.length||e.temps>0)&&o()),e.directives.length&&(Ar(e.directives,"directive",s),e.temps>0&&o()),e.filters&&e.filters.length&&(o(),Ar(e.filters,"filter",s),o()),e.temps>0){a("let ");for(let b=0;b<e.temps;b++)a(`${b>0?", ":""}_temp${b}`)}return(e.components.length||e.directives.length||e.temps)&&(a(`
`,0),o()),u||a("return "),e.codegenNode?Bt(e.codegenNode,s):a("null"),p&&(r(),a("}")),r(),a("}"),{ast:e,code:s.code,preamble:"",map:s.map?s.map.toJSON():void 0}}function p0(e,t){const{ssr:s,prefixIdentifiers:n,push:a,newline:i,runtimeModuleName:l,runtimeGlobalName:r,ssrRuntimeModuleName:o}=t,c=r,u=Array.from(e.helpers);if(u.length>0&&(a(`const _Vue = ${c}
`,-1),e.hoists.length)){const d=[sc,nc,Ni,ac,eh].filter(f=>u.includes(f)).map(_h).join(", ");a(`const { ${d} } = _Vue
`,-1)}h0(e.hoists,t),i(),a("return ")}function Ar(e,t,{helper:s,push:n,newline:a,isTS:i}){const l=s(t==="filter"?oc:t==="component"?ic:rc);for(let r=0;r<e.length;r++){let o=e[r];const c=o.endsWith("__self");c&&(o=o.slice(0,-6)),n(`const ${_i(o,t)} = ${l}(${JSON.stringify(o)}${c?", true":""})${i?"!":""}`),r<e.length-1&&a()}}function h0(e,t){if(!e.length)return;t.pure=!0;const{push:s,newline:n}=t;n();for(let a=0;a<e.length;a++){const i=e[a];i&&(s(`const _hoisted_${a+1} = `),Bt(i,t),n())}t.pure=!1}function _c(e,t){const s=e.length>3||!1;t.push("["),s&&t.indent(),Li(e,t,s),s&&t.deindent(),t.push("]")}function Li(e,t,s=!1,n=!0){const{push:a,newline:i}=t;for(let l=0;l<e.length;l++){const r=e[l];Ce(r)?a(r,-3):ge(r)?_c(r,t):Bt(r,t),l<e.length-1&&(s?(n&&a(","),i()):n&&a(", "))}}function Bt(e,t){if(Ce(e)){t.push(e,-3);return}if(Ht(e)){t.push(t.helper(e));return}switch(e.type){case 1:case 9:case 11:Bt(e.codegenNode,t);break;case 2:g0(e,t);break;case 4:kh(e,t);break;case 5:m0(e,t);break;case 12:Bt(e.codegenNode,t);break;case 8:wh(e,t);break;case 3:b0(e,t);break;case 13:y0(e,t);break;case 14:_0(e,t);break;case 15:k0(e,t);break;case 17:w0(e,t);break;case 18:S0(e,t);break;case 19:T0(e,t);break;case 20:C0(e,t);break;case 21:Li(e.body,t,!0,!1);break}}function g0(e,t){t.push(JSON.stringify(e.content),-3,e)}function kh(e,t){const{content:s,isStatic:n}=e;t.push(n?JSON.stringify(s):s,-3,e)}function m0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ir),s(`${n(sr)}(`),Bt(e.content,t),s(")")}function wh(e,t){for(let s=0;s<e.children.length;s++){const n=e.children[s];Ce(n)?t.push(n,-3):Bt(n,t)}}function v0(e,t){const{push:s}=t;if(e.type===8)s("["),wh(e,t),s("]");else if(e.isStatic){const n=bc(e.content)?e.content:JSON.stringify(e.content);s(n,-2,e)}else s(`[${e.content}]`,-3,e)}function b0(e,t){const{push:s,helper:n,pure:a}=t;a&&s(ir),s(`${n(Ni)}(${JSON.stringify(e.content)})`,-3,e)}function y0(e,t){const{push:s,helper:n,pure:a}=t,{tag:i,props:l,children:r,patchFlag:o,dynamicProps:c,directives:u,isBlock:d,disableTracking:f,isComponent:p}=e;let m;o&&(m=String(o)),u&&s(n(cc)+"("),d&&s(`(${n(Bn)}(${f?"true":""}), `),a&&s(ir);const g=d?Ca(t.inSSR,p):Ta(t.inSSR,p);s(n(g)+"(",-2,e),Li(x0([i,l,r,m,c]),t),s(")"),d&&s(")"),u&&(s(", "),Bt(u,t),s(")"))}function x0(e){let t=e.length;for(;t--&&e[t]==null;);return e.slice(0,t+1).map(s=>s||"null")}function _0(e,t){const{push:s,helper:n,pure:a}=t,i=Ce(e.callee)?e.callee:n(e.callee);a&&s(ir),s(i+"(",-2,e),Li(e.arguments,t),s(")")}function k0(e,t){const{push:s,indent:n,deindent:a,newline:i}=t,{properties:l}=e;if(!l.length){s("{}",-2,e);return}const r=l.length>1||!1;s(r?"{":"{ "),r&&n();for(let o=0;o<l.length;o++){const{key:c,value:u}=l[o];v0(c,t),s(": "),Bt(u,t),o<l.length-1&&(s(","),i())}r&&a(),s(r?"}":" }")}function w0(e,t){_c(e.elements,t)}function S0(e,t){const{push:s,indent:n,deindent:a}=t,{params:i,returns:l,body:r,newline:o,isSlot:c}=e;c&&s(`_${wa[hc]}(`),s("(",-2,e),ge(i)?Li(i,t):i&&Bt(i,t),s(") => "),(o||r)&&(s("{"),n()),l?(o&&s("return "),ge(l)?_c(l,t):Bt(l,t)):r&&Bt(r,t),(o||r)&&(a(),s("}")),c&&(e.isNonScopedSlot&&s(", undefined, true"),s(")"))}function T0(e,t){const{test:s,consequent:n,alternate:a,newline:i}=e,{push:l,indent:r,deindent:o,newline:c}=t;if(s.type===4){const d=!bc(s.content);d&&l("("),kh(s,t),d&&l(")")}else l("("),Bt(s,t),l(")");i&&r(),t.indentLevel++,i||l(" "),l("? "),Bt(n,t),t.indentLevel--,i&&c(),i||l(" "),l(": ");const u=a.type===19;u||t.indentLevel++,Bt(a,t),u||t.indentLevel--,i&&o(!0)}function C0(e,t){const{push:s,helper:n,indent:a,deindent:i,newline:l}=t,{needPauseTracking:r,needArraySpread:o}=e;o&&s("[...("),s(`_cache[${e.index}] || (`),r&&(a(),s(`${n(El)}(-1`),e.inVOnce&&s(", true"),s("),"),l(),s("(")),s(`_cache[${e.index}] = `),Bt(e.value,t),r&&(s(`).cacheIndex = ${e.index},`),l(),s(`${n(El)}(1),`),l(),s(`_cache[${e.index}]`),i()),s(")"),o&&s(")]")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const E0=xh(/^(?:if|else|else-if)$/,(e,t,s)=>A0(e,t,s,(n,a,i)=>{const l=s.parent.children;let r=l.indexOf(n),o=0;for(;r-->=0;){const c=l[r];c&&c.type===9&&(o+=c.branches.length)}return()=>{if(i)n.codegenNode=Gu(a,o,s);else{const c=R0(n.codegenNode);c.alternate=Gu(a,o+n.branches.length-1,s)}}}));function A0(e,t,s,n){if(t.name!=="else"&&(!t.exp||!t.exp.content.trim())){const a=t.exp?t.exp.loc:e.loc;s.onError(at(28,t.loc)),t.exp=Ne("true",!1,a)}if(t.name==="if"){const a=Ku(e,t),i={type:9,loc:t0(e.loc),branches:[a]};if(s.replaceNode(i),n)return n(i,a,!0)}else{const a=s.parent.children;let i=a.indexOf(e);for(;i-->=-1;){const l=a[i];if(l&&dh(l)){s.removeNode(l);continue}if(l&&l.type===9){(t.name==="else-if"||t.name==="else")&&l.branches[l.branches.length-1].condition===void 0&&s.onError(at(30,e.loc)),s.removeNode();const r=Ku(e,t);l.branches.push(r);const o=n&&n(l,r,!1);ar(r,s),o&&o(),s.currentNode=null}else s.onError(at(30,e.loc));break}}}function Ku(e,t){const s=e.tagType===3;return{type:10,loc:e.loc,condition:t.name==="else"?void 0:t.exp,children:s&&!ds(e,"for")?e.children:[e],userKey:nr(e,"key"),isTemplateIf:s}}function Gu(e,t,s){return e.condition?oo(e.condition,Wu(e,t,s),St(s.helper(Ni),['""',"true"])):Wu(e,t,s)}function Wu(e,t,s){const{helper:n}=s,a=vt("key",Ne(`${t}`,!1,os,2)),{children:i}=e,l=i[0];if(i.length!==1||l.type!==1)if(i.length===1&&l.type===11){const o=l.codegenNode;return Nl(o,a,s),o}else return yi(s,n(vi),fs([a]),i,64,void 0,void 0,!0,!1,!1,e.loc);else{const o=l.codegenNode,c=qy(o);return c.type===13&&mc(c,s),Nl(c,a,s),o}}function R0(e){for(;;)if(e.type===19)if(e.alternate.type===19)e=e.alternate;else return e;else e.type===20&&(e=e.value)}const I0=xh("for",(e,t,s)=>{const{helper:n,removeHelper:a}=s;return N0(e,t,s,i=>{const l=St(n(uc),[i.source]),r=Rl(e),o=ds(e,"memo"),c=nr(e,"key",!1,!0);c&&c.type;let u=c&&(c.type===6?c.value?Ne(c.value.content,!0):void 0:c.exp);const d=u?vt("key",u):null,f=i.source.type===4&&i.source.constType>0,p=f?64:c?128:256;return i.codegenNode=yi(s,n(vi),void 0,l,p,void 0,void 0,!0,!f,!1,e.loc),()=>{let m;const{children:g}=i,k=g.length!==1||g[0].type!==1,E=Il(e)?e:r&&e.children.length===1&&Il(e.children[0])?e.children[0]:null;if(E?(m=E.codegenNode,r&&d&&Nl(m,d,s)):k?m=yi(s,n(vi),d?fs([d]):void 0,e.children,64,void 0,void 0,!0,void 0,!1):(m=g[0].codegenNode,r&&d&&Nl(m,d,s),m.isBlock!==!f&&(m.isBlock?(a(Bn),a(Ca(s.inSSR,m.isComponent))):a(Ta(s.inSSR,m.isComponent))),m.isBlock=!f,m.isBlock?(n(Bn),n(Ca(s.inSSR,m.isComponent))):n(Ta(s.inSSR,m.isComponent))),o){const b=Sa(fo(i.parseResult,[Ne("_cached")]));b.body=Ly([_s(["const _memo = (",o.exp,")"]),_s(["if (_cached && _cached.el",...u?[" && _cached.key === ",u]:[],` && ${s.helperString(nh)}(_cached, _memo)) return _cached`]),_s(["const _item = ",m]),Ne("_item.memo = _memo"),Ne("return _item")]),l.arguments.push(b,Ne("_cache"),Ne(String(s.cached.length))),s.cached.push(null)}else l.arguments.push(Sa(fo(i.parseResult),m,!0))}})});function N0(e,t,s,n){if(!t.exp){s.onError(at(31,t.loc));return}const a=t.forParseResult;if(!a){s.onError(at(32,t.loc));return}Sh(a);const{addIdentifiers:i,removeIdentifiers:l,scopes:r}=s,{source:o,value:c,key:u,index:d}=a,f={type:11,loc:t.loc,source:o,valueAlias:c,keyAlias:u,objectIndexAlias:d,parseResult:a,children:Rl(e)?e.children:[e]};s.replaceNode(f),r.vFor++;const p=n&&n(f);return()=>{r.vFor--,p&&p()}}function Sh(e,t){e.finalized||(e.finalized=!0)}function fo({value:e,key:t,index:s},n=[]){return O0([e,t,s,...n])}function O0(e){let t=e.length;for(;t--&&!e[t];);return e.slice(0,t+1).map((s,n)=>s||Ne("_".repeat(n+1),!1))}const Zu=Ne("undefined",!1),L0=(e,t)=>{if(e.type===1&&(e.tagType===1||e.tagType===3)){const s=ds(e,"slot");if(s)return s.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},D0=(e,t,s,n)=>Sa(e,s,!1,!0,s.length?s[0].loc:n);function M0(e,t,s=D0){t.helper(hc);const{children:n,loc:a}=e,i=[],l=[];let r=t.scopes.vSlot>0||t.scopes.vFor>0;const o=ds(e,"slot",!0);if(o){const{arg:k,exp:E}=o;k&&!ts(k)&&(r=!0),i.push(vt(k||Ne("default",!0),s(E,void 0,n,a)))}let c=!1,u=!1;const d=[],f=new Set;let p=0;for(let k=0;k<n.length;k++){const E=n[k];let b;if(!Rl(E)||!(b=ds(E,"slot",!0))){E.type!==3&&d.push(E);continue}if(o){t.onError(at(37,b.loc));break}c=!0;const{children:v,loc:x}=E,{arg:w=Ne("default",!0),exp:N,loc:O}=b;let S;ts(w)?S=w?w.content:"default":r=!0;const R=ds(E,"for"),L=s(N,R,v,x);let H,P;if(H=ds(E,"if"))r=!0,l.push(oo(H.exp,Zi(w,L,p++),Zu));else if(P=ds(E,/^else(?:-if)?$/,!0)){let T=k,U;for(;T--&&(U=n[T],!!dh(U)););if(U&&Rl(U)&&ds(U,/^(?:else-)?if$/)){let K=l[l.length-1];for(;K.alternate.type===19;)K=K.alternate;K.alternate=P.exp?oo(P.exp,Zi(w,L,p++),Zu):Zi(w,L,p++)}else t.onError(at(30,P.loc))}else if(R){r=!0;const T=R.forParseResult;T?(Sh(T),l.push(St(t.helper(uc),[T.source,Sa(fo(T),Zi(w,L),!0)]))):t.onError(at(32,R.loc))}else{if(S){if(f.has(S)){t.onError(at(38,O));continue}f.add(S),S==="default"&&(u=!0)}i.push(vt(w,L))}}if(!o){const k=(E,b)=>{const v=s(E,void 0,b,a);return t.compatConfig&&(v.isNonScopedSlot=!0),vt("default",v)};c?d.length&&!d.every(yc)&&(u?t.onError(at(39,d[0].loc)):i.push(k(void 0,d))):i.push(k(void 0,n))}const m=r?2:il(e.children)?3:1;let g=fs(i.concat(vt("_",Ne(m+"",!1))),a);return l.length&&(g=St(t.helper(sh),[g,Mn(l)])),{slots:g,hasDynamicSlots:r}}function Zi(e,t,s){const n=[vt("name",e),vt("fn",t)];return s!=null&&n.push(vt("key",Ne(String(s),!0))),fs(n)}function il(e){for(let t=0;t<e.length;t++){const s=e[t];switch(s.type){case 1:if(s.tagType===2||il(s.children))return!0;break;case 9:if(il(s.branches))return!0;break;case 10:case 11:if(il(s.children))return!0;break}}return!1}const Th=new WeakMap,P0=(e,t)=>function(){if(e=t.currentNode,!(e.type===1&&(e.tagType===0||e.tagType===1)))return;const{tag:n,props:a}=e,i=e.tagType===1;let l=i?F0(e,t):`"${n}"`;const r=Ve(l)&&l.callee===lc;let o,c,u=0,d,f,p,m=r||l===si||l===tc||!i&&(n==="svg"||n==="foreignObject"||n==="math");if(a.length>0){const g=Ch(e,t,void 0,i,r);o=g.props,u=g.patchFlag,f=g.dynamicPropNames;const k=g.directives;p=k&&k.length?Mn(k.map(E=>U0(E,t))):void 0,g.shouldUseBlock&&(m=!0)}if(e.children.length>0)if(l===Tl&&(m=!0,u|=1024),i&&l!==si&&l!==Tl){const{slots:k,hasDynamicSlots:E}=M0(e,t);c=k,E&&(u|=1024)}else if(e.children.length===1&&l!==si){const k=e.children[0],E=k.type,b=E===5||E===8;b&&as(k,t)===0&&(u|=1),b||E===2?c=k:c=e.children}else c=e.children;f&&f.length&&(d=B0(f)),e.codegenNode=yi(t,l,o,c,u===0?void 0:u,d,p,!!m,!1,i,e.loc)};function F0(e,t,s=!1){let{tag:n}=e;const a=po(n),i=nr(e,"is",!1,!0);if(i)if(a||Pn("COMPILER_IS_ON_ELEMENT",t)){let r;if(i.type===6?r=i.value&&Ne(i.value.content,!0):(r=i.exp,r||(r=Ne("is",!1,i.arg.loc))),r)return St(t.helper(lc),[r])}else i.type===6&&i.value.content.startsWith("vue:")&&(n=i.value.content.slice(4));const l=ih(n)||t.isBuiltInComponent(n);return l?(s||t.helper(l),l):(t.helper(ic),t.components.add(n),_i(n,"component"))}function Ch(e,t,s=e.props,n,a,i=!1){const{tag:l,loc:r,children:o}=e;let c=[];const u=[],d=[],f=o.length>0;let p=!1,m=0,g=!1,k=!1,E=!1,b=!1,v=!1,x=!1;const w=[],N=L=>{c.length&&(u.push(fs(Ju(c),r)),c=[]),L&&u.push(L)},O=()=>{t.scopes.vFor>0&&c.push(vt(Ne("ref_for",!0),Ne("true")))},S=({key:L,value:H})=>{if(ts(L)){const P=L.content,T=Vn(P);if(T&&(!n||a)&&P.toLowerCase()!=="onclick"&&P!=="onUpdate:modelValue"&&!Js(P)&&(b=!0),T&&Js(P)&&(x=!0),T&&H.type===14&&(H=H.arguments[0]),H.type===20||(H.type===4||H.type===8)&&as(H,t)>0)return;P==="ref"?g=!0:P==="class"?k=!0:P==="style"?E=!0:P!=="key"&&!w.includes(P)&&w.push(P),n&&(P==="class"||P==="style")&&!w.includes(P)&&w.push(P)}else v=!0};for(let L=0;L<s.length;L++){const H=s[L];if(H.type===6){const{loc:P,name:T,nameLoc:U,value:K}=H;let G=!0;if(T==="ref"&&(g=!0,O()),T==="is"&&(po(l)||K&&K.content.startsWith("vue:")||Pn("COMPILER_IS_ON_ELEMENT",t)))continue;c.push(vt(Ne(T,!0,U),Ne(K?K.content:"",G,K?K.loc:P)))}else{const{name:P,arg:T,exp:U,loc:K,modifiers:G}=H,D=P==="bind",I=P==="on";if(P==="slot"){n||t.onError(at(40,K));continue}if(P==="once"||P==="memo"||P==="is"||D&&Rn(T,"is")&&(po(l)||Pn("COMPILER_IS_ON_ELEMENT",t))||I&&i)continue;if((D&&Rn(T,"key")||I&&f&&Rn(T,"vue:before-update"))&&(p=!0),D&&Rn(T,"ref")&&O(),!T&&(D||I)){if(v=!0,U)if(D){if(N(),Pn("COMPILER_V_BIND_OBJECT_ORDER",t)){u.unshift(U);continue}O(),N(),u.push(U)}else N({type:14,loc:K,callee:t.helper(pc),arguments:n?[U]:[U,"true"]});else t.onError(at(D?34:35,K));continue}D&&G.some(ce=>ce.content==="prop")&&(m|=32);const j=t.directiveTransforms[P];if(j){const{props:ce,needRuntime:oe}=j(H,e,t);!i&&ce.forEach(S),I&&T&&!ts(T)?N(fs(ce,r)):c.push(...ce),oe&&(d.push(H),Ht(oe)&&Th.set(H,oe))}else Ig(P)||(d.push(H),f&&(p=!0))}}let R;if(u.length?(N(),u.length>1?R=St(t.helper(Cl),u,r):R=u[0]):c.length&&(R=fs(Ju(c),r)),v?m|=16:(k&&!n&&(m|=2),E&&!n&&(m|=4),w.length&&(m|=8),b&&(m|=32)),!p&&(m===0||m===32)&&(g||x||d.length>0)&&(m|=512),!t.inSSR&&R)switch(R.type){case 15:let L=-1,H=-1,P=!1;for(let K=0;K<R.properties.length;K++){const G=R.properties[K].key;ts(G)?G.content==="class"?L=K:G.content==="style"&&(H=K):G.isHandlerKey||(P=!0)}const T=R.properties[L],U=R.properties[H];P?R=St(t.helper(bi),[R]):(T&&!ts(T.value)&&(T.value=St(t.helper(dc),[T.value])),U&&(E||U.value.type===4&&U.value.content.trim()[0]==="["||U.value.type===17)&&(U.value=St(t.helper(fc),[U.value])));break;case 14:break;default:R=St(t.helper(bi),[St(t.helper(Oi),[R])]);break}return{props:R,directives:d,patchFlag:m,dynamicPropNames:w,shouldUseBlock:p}}function Ju(e){const t=new Map,s=[];for(let n=0;n<e.length;n++){const a=e[n];if(a.key.type===8||!a.key.isStatic){s.push(a);continue}const i=a.key.content,l=t.get(i);l?(i==="style"||i==="class"||Vn(i))&&$0(l,a):(t.set(i,a),s.push(a))}return s}function $0(e,t){e.value.type===17?e.value.elements.push(t.value):e.value=Mn([e.value,t.value],e.loc)}function U0(e,t){const s=[],n=Th.get(e);n?s.push(t.helperString(n)):(t.helper(rc),t.directives.add(e.name),s.push(_i(e.name,"directive")));const{loc:a}=e;if(e.exp&&s.push(e.exp),e.arg&&(e.exp||s.push("void 0"),s.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||s.push("void 0"),s.push("void 0"));const i=Ne("true",!1,a);s.push(fs(e.modifiers.map(l=>vt(l,i)),a))}return Mn(s,e.loc)}function B0(e){let t="[";for(let s=0,n=e.length;s<n;s++)t+=JSON.stringify(e[s]),s<n-1&&(t+=", ");return t+"]"}function po(e){return e==="component"||e==="Component"}const H0=(e,t)=>{if(Il(e)){const{children:s,loc:n}=e,{slotName:a,slotProps:i}=V0(e,t),l=[t.prefixIdentifiers?"_ctx.$slots":"$slots",a,"{}","undefined","true"];let r=2;i&&(l[2]=i,r=3),s.length&&(l[3]=Sa([],s,!1,!1,n),r=4),t.scopeId&&!t.slotted&&(r=5),l.splice(r),e.codegenNode=St(t.helper(th),l,n)}};function V0(e,t){let s='"default"',n;const a=[];for(let i=0;i<e.props.length;i++){const l=e.props[i];if(l.type===6)l.value&&(l.name==="name"?s=JSON.stringify(l.value.content):(l.name=Qe(l.name),a.push(l)));else if(l.name==="bind"&&Rn(l.arg,"name")){if(l.exp)s=l.exp;else if(l.arg&&l.arg.type===4){const r=Qe(l.arg.content);s=l.exp=Ne(r,!1,l.arg.loc)}}else l.name==="bind"&&l.arg&&ts(l.arg)&&(l.arg.content=Qe(l.arg.content)),a.push(l)}if(a.length>0){const{props:i,directives:l}=Ch(e,t,a,!1,!1);n=i,l.length&&t.onError(at(36,l[0].loc))}return{slotName:s,slotProps:n}}const Eh=(e,t,s,n)=>{const{loc:a,modifiers:i,arg:l}=e;!e.exp&&!i.length&&s.onError(at(35,a));let r;if(l.type===4)if(l.isStatic){let d=l.content;d.startsWith("vue:")&&(d=`vnode-${d.slice(4)}`);const f=t.tagType!==0||d.startsWith("vnode")||!/[A-Z]/.test(d)?da(Qe(d)):`on:${d}`;r=Ne(f,!0,l.loc)}else r=_s([`${s.helperString(ro)}(`,l,")"]);else r=l,r.children.unshift(`${s.helperString(ro)}(`),r.children.push(")");let o=e.exp;o&&!o.content.trim()&&(o=void 0);let c=s.cacheHandlers&&!o&&!s.inVOnce;if(o){const d=oh(o),f=!(d||Hy(o)),p=o.content.includes(";");(f||c&&d)&&(o=_s([`${f?"$event":"(...args)"} => ${p?"{":"("}`,o,p?"}":")"]))}let u={props:[vt(r,o||Ne("() => {}",!1,a))]};return n&&(u=n(u)),c&&(u.props[0].value=s.cache(u.props[0].value)),u.props.forEach(d=>d.key.isHandlerKey=!0),u},j0=(e,t,s)=>{const{modifiers:n,loc:a}=e,i=e.arg;let{exp:l}=e;return l&&l.type===4&&!l.content.trim()&&(l=void 0),i.type!==4?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content?`${i.content} || ""`:'""'),n.some(r=>r.content==="camel")&&(i.type===4?i.isStatic?i.content=Qe(i.content):i.content=`${s.helperString(lo)}(${i.content})`:(i.children.unshift(`${s.helperString(lo)}(`),i.children.push(")"))),s.inSSR||(n.some(r=>r.content==="prop")&&Yu(i,"."),n.some(r=>r.content==="attr")&&Yu(i,"^")),{props:[vt(i,l)]}},Yu=(e,t)=>{e.type===4?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},z0=(e,t)=>{if(e.type===0||e.type===1||e.type===11||e.type===10)return()=>{const s=e.children;let n,a=!1;for(let i=0;i<s.length;i++){const l=s[i];if(Er(l)){a=!0;for(let r=i+1;r<s.length;r++){const o=s[r];if(Er(o))n||(n=s[i]=_s([l],l.loc)),n.children.push(" + ",o),s.splice(r,1),r--;else{n=void 0;break}}}}if(!(!a||s.length===1&&(e.type===0||e.type===1&&e.tagType===0&&!e.props.find(i=>i.type===7&&!t.directiveTransforms[i.name])&&e.tag!=="template")))for(let i=0;i<s.length;i++){const l=s[i];if(Er(l)||l.type===8){const r=[];(l.type!==2||l.content!==" ")&&r.push(l),!t.ssr&&as(l,t)===0&&r.push("1"),s[i]={type:12,content:l,loc:l.loc,codegenNode:St(t.helper(ac),r)}}}}},Qu=new WeakSet,q0=(e,t)=>{if(e.type===1&&ds(e,"once",!0))return Qu.has(e)||t.inVOnce||t.inSSR?void 0:(Qu.add(e),t.inVOnce=!0,t.helper(El),()=>{t.inVOnce=!1;const s=t.currentNode;s.codegenNode&&(s.codegenNode=t.cache(s.codegenNode,!0,!0))})},Ah=(e,t,s)=>{const{exp:n,arg:a}=e;if(!n)return s.onError(at(41,e.loc)),Ba();const i=n.loc.source.trim(),l=n.type===4?n.content:i,r=s.bindingMetadata[i];if(r==="props"||r==="props-aliased")return s.onError(at(44,n.loc)),Ba();if(r==="literal-const"||r==="setup-const")return s.onError(at(45,n.loc)),Ba();if(!l.trim()||!oh(n))return s.onError(at(42,n.loc)),Ba();const o=a||Ne("modelValue",!0),c=a?ts(a)?`onUpdate:${Qe(a.content)}`:_s(['"onUpdate:" + ',a]):"onUpdate:modelValue";let u;const d=s.isTS?"($event: any)":"$event";u=_s([`${d} => ((`,n,") = $event)"]);const f=[vt(o,e.exp),vt(c,u)];if(e.modifiers.length&&t.tagType===1){const p=e.modifiers.map(g=>g.content).map(g=>(bc(g)?g:JSON.stringify(g))+": true").join(", "),m=a?ts(a)?`${a.content}Modifiers`:_s([a,' + "Modifiers"']):"modelModifiers";f.push(vt(m,Ne(`{ ${p} }`,!1,e.loc,2)))}return Ba(f)};function Ba(e=[]){return{props:e}}const K0=/[\w).+\-_$\]]/,G0=(e,t)=>{Pn("COMPILER_FILTERS",t)&&(e.type===5?Ol(e.content,t):e.type===1&&e.props.forEach(s=>{s.type===7&&s.name!=="for"&&s.exp&&Ol(s.exp,t)}))};function Ol(e,t){if(e.type===4)Xu(e,t);else for(let s=0;s<e.children.length;s++){const n=e.children[s];typeof n=="object"&&(n.type===4?Xu(n,t):n.type===8?Ol(e,t):n.type===5&&Ol(n.content,t))}}function Xu(e,t){const s=e.content;let n=!1,a=!1,i=!1,l=!1,r=0,o=0,c=0,u=0,d,f,p,m,g=[];for(p=0;p<s.length;p++)if(f=d,d=s.charCodeAt(p),n)d===39&&f!==92&&(n=!1);else if(a)d===34&&f!==92&&(a=!1);else if(i)d===96&&f!==92&&(i=!1);else if(l)d===47&&f!==92&&(l=!1);else if(d===124&&s.charCodeAt(p+1)!==124&&s.charCodeAt(p-1)!==124&&!r&&!o&&!c)m===void 0?(u=p+1,m=s.slice(0,p).trim()):k();else{switch(d){case 34:a=!0;break;case 39:n=!0;break;case 96:i=!0;break;case 40:c++;break;case 41:c--;break;case 91:o++;break;case 93:o--;break;case 123:r++;break;case 125:r--;break}if(d===47){let E=p-1,b;for(;E>=0&&(b=s.charAt(E),b===" ");E--);(!b||!K0.test(b))&&(l=!0)}}m===void 0?m=s.slice(0,p).trim():u!==0&&k();function k(){g.push(s.slice(u,p).trim()),u=p+1}if(g.length){for(p=0;p<g.length;p++)m=W0(m,g[p],t);e.content=m,e.ast=void 0}}function W0(e,t,s){s.helper(oc);const n=t.indexOf("(");if(n<0)return s.filters.add(t),`${_i(t,"filter")}(${e})`;{const a=t.slice(0,n),i=t.slice(n+1);return s.filters.add(a),`${_i(a,"filter")}(${e}${i!==")"?","+i:i}`}}const ed=new WeakSet,Z0=(e,t)=>{if(e.type===1){const s=ds(e,"memo");return!s||ed.has(e)||t.inSSR?void 0:(ed.add(e),()=>{const n=e.codegenNode||t.currentNode.codegenNode;n&&n.type===13&&(e.tagType!==1&&mc(n,t),e.codegenNode=St(t.helper(gc),[s.exp,Sa(void 0,n),"_cache",String(t.cached.length)]),t.cached.push(null))})}},J0=(e,t)=>{if(e.type===1){for(const s of e.props)if(s.type===7&&s.name==="bind"&&(!s.exp||s.exp.type===4&&!s.exp.content.trim())&&s.arg){const n=s.arg;if(n.type!==4||!n.isStatic)t.onError(at(53,n.loc)),s.exp=Ne("",!0,n.loc);else{const a=Qe(n.content);(lh.test(a[0])||a[0]==="-")&&(s.exp=Ne(a,!1,n.loc))}}}};function Y0(e){return[[J0,q0,E0,Z0,I0,G0,H0,P0,L0,z0],{on:Eh,bind:j0,model:Ah}]}function Q0(e,t={}){const s=t.onError||vc,n=t.mode==="module";t.prefixIdentifiers===!0?s(at(48)):n&&s(at(49));const a=!1;t.cacheHandlers&&s(at(50)),t.scopeId&&!n&&s(at(51));const i=Me({},t,{prefixIdentifiers:a}),l=Ce(e)?a0(e,i):e,[r,o]=Y0();return o0(l,Me({},i,{nodeTransforms:[...r,...t.nodeTransforms||[]],directiveTransforms:Me({},o,t.directiveTransforms||{})})),f0(l,i)}const X0=()=>({props:[]});/**
* @vue/compiler-dom v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Rh=Symbol(""),Ih=Symbol(""),Nh=Symbol(""),Oh=Symbol(""),ho=Symbol(""),Lh=Symbol(""),Dh=Symbol(""),Mh=Symbol(""),Ph=Symbol(""),Fh=Symbol("");Iy({[Rh]:"vModelRadio",[Ih]:"vModelCheckbox",[Nh]:"vModelText",[Oh]:"vModelSelect",[ho]:"vModelDynamic",[Lh]:"withModifiers",[Dh]:"withKeys",[Mh]:"vShow",[Ph]:"Transition",[Fh]:"TransitionGroup"});let ea;function ex(e,t=!1){return ea||(ea=document.createElement("div")),t?(ea.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,ea.children[0].getAttribute("foo")):(ea.innerHTML=e,ea.textContent)}const tx={parseMode:"html",isVoidTag:Gg,isNativeTag:e=>zg(e)||qg(e)||Kg(e),isPreTag:e=>e==="pre",isIgnoreNewlineTag:e=>e==="pre"||e==="textarea",decodeEntities:ex,isBuiltInComponent:e=>{if(e==="Transition"||e==="transition")return Ph;if(e==="TransitionGroup"||e==="transition-group")return Fh},getNamespace(e,t,s){let n=t?t.ns:s;if(t&&n===2)if(t.tag==="annotation-xml"){if(e==="svg")return 1;t.props.some(a=>a.type===6&&a.name==="encoding"&&a.value!=null&&(a.value.content==="text/html"||a.value.content==="application/xhtml+xml"))&&(n=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&e!=="mglyph"&&e!=="malignmark"&&(n=0);else t&&n===1&&(t.tag==="foreignObject"||t.tag==="desc"||t.tag==="title")&&(n=0);if(n===0){if(e==="svg")return 1;if(e==="math")return 2}return n}},sx=e=>{e.type===1&&e.props.forEach((t,s)=>{t.type===6&&t.name==="style"&&t.value&&(e.props[s]={type:7,name:"bind",arg:Ne("style",!0,t.loc),exp:nx(t.value.content,t.loc),modifiers:[],loc:t.loc})})},nx=(e,t)=>{const s=Zd(e);return Ne(JSON.stringify(s),!1,t,3)};function yn(e,t){return at(e,t)}const ax=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(yn(54,a)),t.children.length&&(s.onError(yn(55,a)),t.children.length=0),{props:[vt(Ne("innerHTML",!0,a),n||Ne("",!0))]}},ix=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(yn(56,a)),t.children.length&&(s.onError(yn(57,a)),t.children.length=0),{props:[vt(Ne("textContent",!0),n?as(n,s)>0?n:St(s.helperString(sr),[n],a):Ne("",!0))]}},lx=(e,t,s)=>{const n=Ah(e,t,s);if(!n.props.length||t.tagType===1)return n;e.arg&&s.onError(yn(59,e.arg.loc));const{tag:a}=t,i=s.isCustomElement(a);if(a==="input"||a==="textarea"||a==="select"||i){let l=Nh,r=!1;if(a==="input"||i){const o=nr(t,"type");if(o){if(o.type===7)l=ho;else if(o.value)switch(o.value.content){case"radio":l=Rh;break;case"checkbox":l=Ih;break;case"file":r=!0,s.onError(yn(60,e.loc));break}}else Vy(t)&&(l=ho)}else a==="select"&&(l=Oh);r||(n.needRuntime=s.helper(l))}else s.onError(yn(58,e.loc));return n.props=n.props.filter(l=>!(l.key.type===4&&l.key.content==="modelValue")),n},rx=rs("passive,once,capture"),ox=rs("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),cx=rs("left,right"),$h=rs("onkeyup,onkeydown,onkeypress"),ux=(e,t,s,n)=>{const a=[],i=[],l=[];for(let r=0;r<t.length;r++){const o=t[r].content;o==="native"&&xi("COMPILER_V_ON_NATIVE",s)||rx(o)?l.push(o):cx(o)?ts(e)?$h(e.content.toLowerCase())?a.push(o):i.push(o):(a.push(o),i.push(o)):ox(o)?i.push(o):a.push(o)}return{keyModifiers:a,nonKeyModifiers:i,eventOptionModifiers:l}},td=(e,t)=>ts(e)&&e.content.toLowerCase()==="onclick"?Ne(t,!0):e.type!==4?_s(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e,dx=(e,t,s)=>Eh(e,t,s,n=>{const{modifiers:a}=e;if(!a.length)return n;let{key:i,value:l}=n.props[0];const{keyModifiers:r,nonKeyModifiers:o,eventOptionModifiers:c}=ux(i,a,s,e.loc);if(o.includes("right")&&(i=td(i,"onContextmenu")),o.includes("middle")&&(i=td(i,"onMouseup")),o.length&&(l=St(s.helper(Lh),[l,JSON.stringify(o)])),r.length&&(!ts(i)||$h(i.content.toLowerCase()))&&(l=St(s.helper(Dh),[l,JSON.stringify(r)])),c.length){const u=c.map(zn).join("");i=ts(i)?Ne(`${i.content}${u}`,!0):_s(["(",i,`) + "${u}"`])}return{props:[vt(i,l)]}}),fx=(e,t,s)=>{const{exp:n,loc:a}=e;return n||s.onError(yn(62,a)),{props:[],needRuntime:s.helper(Mh)}},px=(e,t)=>{e.type===1&&e.tagType===0&&(e.tag==="script"||e.tag==="style")&&t.removeNode()},hx=[sx],gx={cloak:X0,html:ax,text:ix,model:lx,on:dx,show:fx};function mx(e,t={}){return Q0(e,Me({},tx,t,{nodeTransforms:[px,...hx,...t.nodeTransforms||[]],directiveTransforms:Me({},gx,t.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.5.38
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const sd=Object.create(null);function vx(e,t){if(!Ce(e))if(e.nodeType)e=e.innerHTML;else return Lt;const s=Lg(e,t),n=sd[s];if(n)return n;if(e[0]==="#"){const r=document.querySelector(e);e=r?r.innerHTML:""}const a=Me({hoistStatic:!0,onError:void 0,onWarn:Lt},t);!a.isCustomElement&&typeof customElements<"u"&&(a.isCustomElement=r=>!!customElements.get(r));const{code:i}=mx(e,a),l=new Function("Vue",i)(Sy);return l._rc=!0,sd[s]=l}_p(vx);const Ll=_n({items:[]});let bx=1;function lr(e,t="info",s=3e3){const n=bx++;return Ll.items.push({id:n,message:String(e),type:t}),s>0&&setTimeout(()=>kc(n),s),n}function kc(e){const t=Ll.items.findIndex(s=>s.id===e);t>=0&&Ll.items.splice(t,1)}function ke(e,t="info",s=3e3){return lr(e,t,s)}ke.success=(e,t=3e3)=>lr(e,"success",t);ke.error=(e,t=5e3)=>lr(e,"error",t);ke.info=(e,t=3e3)=>lr(e,"info",t);ke.dismiss=kc;const yx={setup(){return{state:Ll,dismiss:kc}},template:`
  ...
  `},zs=_n({open:!1,title:"Confirm",message:"",confirmLabel:"Confirm",cancelLabel:"Cancel",danger:!1});let va=null;function ls({title:e="Confirm",message:t="",confirmLabel:s="Confirm",cancelLabel:n="Cancel",danger:a=!1}={}){return va&&va(!1),zs.title=e,zs.message=t,zs.confirmLabel=s,zs.cancelLabel=n,zs.danger=a,zs.open=!0,new Promise(i=>{va=i})}function nd(e){zs.open=!1,va&&(va(e),va=null)}const xx={setup(){function e(t){zs.open&&t.key==="Escape"&&(t.stopPropagation(),nd(!1))}return Be(()=>document.addEventListener("keydown",e,!0)),ht(()=>document.removeEventListener("keydown",e,!0)),{state:zs,settle:nd}},template:`
 ...
 * @license MIT
 */const ia=typeof document<"u";function Uh(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function _x(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&Uh(e.default)}const Ke=Object.assign;function Rr(e,t){const s={};for(const n in t){const a=t[n];s[n]=ws(a)?a.map(e):e(a)}return s}const ni=()=>{},ws=Array.isArray;function ad(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}const Bh=/#/g,kx=/&/g,wx=/\//g,Sx=/=/g,Tx=/\?/g,Hh=/\+/g,Cx=/%5B/g,Ex=/%5D/g,Vh=/%5E/g,Ax=/%60/g,jh=/%7B/g,Rx=/%7C/g,zh=/%7D/g,Ix=/%20/g;function wc(e){return e==null?"":encodeURI(""+e).replace(Rx,"|").replace(Cx,"[").replace(Ex,"]")}function Nx(e){return wc(e).replace(jh,"{").replace(zh,"}").replace(Vh,"^")}function go(e){return wc(e).replace(Hh,"%2B").replace(Ix,"+").replace(Bh,"%23").replace(kx,"%26").replace(Ax,"`").replace(jh,"{").replace(zh,"}").replace(Vh,"^")}function Ox(e){return go(e).replace(Sx,"%3D")}function Lx(e){return wc(e).replace(Bh,"%23").replace(Tx,"%3F")}function Dx(e){return Lx(e).replace(wx,"%2F")}function wi(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const Mx=/\/$/,Px=e=>e.replace(Mx,"");function Ir(e,t,s="/"){let n,a={},i="",l="";const r=t.indexOf("#");let o=t.indexOf("?");return o=r>=0&&o>r?-1:o,o>=0&&(n=t.slice(0,o),i=t.slice(o,r>0?r:t.length),a=e(i.slice(1))),r>=0&&(n=n||t.slice(0,r),l=t.slice(r,t.length)),n=Bx(n??t,s),{fullPath:n+i+l,path:n,query:a,hash:wi(l)}}function Fx(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function id(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function $x(e,t,s){const n=t.matched.length-1,a=s.matched.length-1;return n>-1&&n===a&&Ea(t.matched[n],s.matched[a])&&qh(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function Ea(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function qh(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!Ux(e[s],t[s]))return!1;return!0}function Ux(e,t){return ws(e)?ld(e,t):ws(t)?ld(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function ld(e,t){return ws(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function Bx(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),a=n[n.length-1];(a===".."||a===".")&&n.push("");let i=s.length-1,l,r;for(l=0;l<n.length;l++)if(r=n[l],r!==".")if(r==="..")i>1&&i--;else break;return s.slice(0,i).join("/")+"/"+n.slice(l).join("/")}const dn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let mo=(function(e){return e.pop="pop",e.push="push",e})({}),Nr=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Hx(e){if(!e)if(ia){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Px(e)}const Vx=/^[^#]+#/;function jx(e,t){return e.replace(Vx,"#")+t}function zx(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const rr=()=>({left:window.scrollX,top:window.scrollY});function qx(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),a=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!a)return;t=zx(a,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function rd(e,t){return(history.state?history.state.position-t:-1)+e}const vo=new Map;function Kx(e,t){vo.set(e,t)}function Gx(e){const t=vo.get(e);return vo.delete(e),t}function Wx(e){return typeof e=="string"||e&&typeof e=="object"}function Kh(e){return typeof e=="string"||typeof e=="symbol"}let ct=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const Gh=Symbol("");ct.MATCHER_NOT_FOUND+"",ct.NAVIGATION_GUARD_REDIRECT+"",ct.NAVIGATION_ABORTED+"",ct.NAVIGATION_CANCELLED+"",ct.NAVIGATION_DUPLICATED+"";function Aa(e,t){return Ke(new Error,{type:e,[Gh]:!0},t)}function Us(e,t){return e instanceof Error&&Gh in e&&(t==null||!!(e.type&t))}const Zx=["params","query","hash"];function Jx(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of Zx)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}function Yx(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const a=s[n].replace(Hh," "),i=a.indexOf("="),l=wi(i<0?a:a.slice(0,i)),r=i<0?null:wi(a.slice(i+1));if(l in t){let o=t[l];ws(o)||(o=t[l]=[o]),o.push(r)}else t[l]=r}return t}function od(e){let t="";for(let s in e){const n=e[s];if(s=Ox(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(ws(n)?n.map(a=>a&&go(a)):[n&&go(n)]).forEach(a=>{a!==void 0&&(t+=(t.length?"&":"")+s,a!=null&&(t+="="+a))})}return t}function Qx(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=ws(n)?n.map(a=>a==null?null:""+a):n==null?n:""+n)}return t}const Xx=Symbol(""),cd=Symbol(""),or=Symbol(""),Sc=Symbol(""),bo=Symbol("");function Ha(){let e=[];function t(n){return e.push(n),()=>{const a=e.indexOf(n);a>-1&&e.splice(a,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function vn(e,t,s,n,a,i=l=>l()){const l=n&&(n.enterCallbacks[a]=n.enterCallbacks[a]||[]);return()=>new Promise((r,o)=>{const c=f=>{f===!1?o(Aa(ct.NAVIGATION_ABORTED,{from:s,to:t})):f instanceof Error?o(f):Wx(f)?o(Aa(ct.NAVIGATION_GUARD_REDIRECT,{from:t,to:f})):(l&&n.enterCallbacks[a]===l&&typeof f=="function"&&l.push(f),r())},u=i(()=>e.call(n&&n.instances[a],t,s,c));let d=Promise.resolve(u);e.length<3&&(d=d.then(c)),d.catch(f=>o(f))})}function Or(e,t,s,n,a=i=>i()){const i=[];for(const l of e)for(const r in l.components){let o=l.components[r];if(!(t!=="beforeRouteEnter"&&!l.instances[r]))if(Uh(o)){const c=(o.__vccOpts||o)[t];c&&i.push(vn(c,s,n,l,r,a))}else{let c=o();i.push(()=>c.then(u=>{if(!u)throw new Error(`Couldn't resolve component "${r}" at "${l.path}"`);const d=_x(u)?u.default:u;l.mods[r]=u,l.components[r]=d;const f=(d.__vccOpts||d)[t];return f&&vn(f,s,n,l,r,a)()}))}}return i}function e_(e,t){const s=[],n=[],a=[],i=Math.max(t.matched.length,e.matched.length);for(let l=0;l<i;l++){const r=t.matched[l];r&&(e.matched.find(c=>Ea(c,r))?n.push(r):s.push(r));const o=e.matched[l];o&&(t.matched.find(c=>Ea(c,o))||a.push(o))}return[s,n,a]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let t_=()=>location.protocol+"//"+location.host;function Wh(e,t){const{pathname:s,search:n,hash:a}=t,i=e.indexOf("#");if(i>-1){let l=a.includes(e.slice(i))?e.slice(i).length:1,r=a.slice(l);return r[0]!=="/"&&(r="/"+r),id(r,"")}return id(s,e)+n+a}function s_(e,t,s,n){let a=[],i=[],l=null;const r=({state:f})=>{const p=Wh(e,location),m=s.value,g=t.value;let k=0;if(f){if(s.value=p,t.value=f,l&&l===m){l=null;return}k=g?f.position-g.position:0}else n(p);a.forEach(E=>{E(s.value,m,{delta:k,type:mo.pop,direction:k?k>0?Nr.forward:Nr.back:Nr.unknown})})};function o(){l=s.value}function c(f){a.push(f);const p=()=>{const m=a.indexOf(f);m>-1&&a.splice(m,1)};return i.push(p),p}function u(){if(document.visibilityState==="hidden"){const{history:f}=window;if(!f.state)return;f.replaceState(Ke({},f.state,{scroll:rr()}),"")}}function d(){for(const f of i)f();i=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",u),document.removeEventListener("visibilitychange",u)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",u),document.addEventListener("visibilitychange",u),{pauseListeners:o,listen:c,destroy:d}}function ud(e,t,s,n=!1,a=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:a?rr():null}}function n_(e){const{history:t,location:s}=window,n={value:Wh(e,s)},a={value:t.state};a.value||i(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(o,c,u){const d=e.indexOf("#"),f=d>-1?(s.host&&document.querySelector("base")?e:e.slice(d))+o:t_()+e+o;try{t[u?"replaceState":"pushState"](c,"",f),a.value=c}catch(p){console.error(p),s[u?"replace":"assign"](f)}}function l(o,c){i(o,Ke({},t.state,ud(a.value.back,o,a.value.forward,!0),c,{position:a.value.position}),!0),n.value=o}function r(o,c){const u=Ke({},a.value,t.state,{forward:o,scroll:rr()});i(u.current,u,!0),i(o,Ke({},ud(n.value,o,null),{position:u.position+1},c),!1),n.value=o}return{location:n,state:a,push:r,replace:l}}function a_(e){e=Hx(e);const t=n_(e),s=s_(e,t.state,t.location,t.replace);function n(i,l=!0){l||s.pauseListeners(),history.go(i)}const a=Ke({location:"",base:e,go:n,createHref:jx.bind(null,e)},t,s);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>t.state.value}),a}function i_(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),a_(e)}let Nn=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var kt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(kt||{});const l_={type:Nn.Static,value:""},r_=/[a-zA-Z0-9_]/;function o_(e){if(!e)return[[]];if(e==="/")return[[l_]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(p){throw new Error(`ERR (${s})/"${c}": ${p}`)}let s=kt.Static,n=s;const a=[];let i;function l(){i&&a.push(i),i=[]}let r=0,o,c="",u="";function d(){c&&(s===kt.Static?i.push({type:Nn.Static,value:c}):s===kt.Param||s===kt.ParamRegExp||s===kt.ParamRegExpEnd?(i.length>1&&(o==="*"||o==="+")&&t(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Nn.Param,value:c,regexp:u,repeatable:o==="*"||o==="+",optional:o==="*"||o==="?"})):t("Invalid state to consume buffer"),c="")}function f(){c+=o}for(;r<e.length;){if(o=e[r++],o==="\\"&&s!==kt.ParamRegExp){n=s,s=kt.EscapeNext;continue}switch(s){case kt.Static:o==="/"?(c&&d(),l()):o===":"?(d(),s=kt.Param):f();break;case kt.EscapeNext:f(),s=n;break;case kt.Param:o==="("?s=kt.ParamRegExp:r_.test(o)?f():(d(),s=kt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--);break;case kt.ParamRegExp:o===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+o:s=kt.ParamRegExpEnd:u+=o;break;case kt.ParamRegExpEnd:d(),s=kt.Static,o!=="*"&&o!=="?"&&o!=="+"&&r--,u="";break;default:t("Unknown state");break}}return s===kt.ParamRegExp&&t(`Unfinished custom RegExp for param "${c}"`),d(),l(),a}const dd="[^/]+?",c_={sensitive:!1,strict:!1,start:!0,end:!0};var zt=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(zt||{});const u_=/[.+*?^${}()[\]/\\]/g;function d_(e,t){const s=Ke({},c_,t),n=[];let a=s.start?"^":"";const i=[];for(const c of e){const u=c.length?[]:[zt.Root];s.strict&&!c.length&&(a+="/");for(let d=0;d<c.length;d++){const f=c[d];let p=zt.Segment+(s.sensitive?zt.BonusCaseSensitive:0);if(f.type===Nn.Static)d||(a+="/"),a+=f.value.replace(u_,"\\$&"),p+=zt.Static;else if(f.type===Nn.Param){const{value:m,repeatable:g,optional:k,regexp:E}=f;i.push({name:m,repeatable:g,optional:k});const b=E||dd;if(b!==dd){p+=zt.BonusCustomRegExp;try{`${b}`}catch(x){throw new Error(`Invalid custom RegExp for param "${m}" (${b}): `+x.message)}}let v=g?`((?:${b})(?:/(?:${b}))*)`:`(${b})`;d||(v=k&&c.length<2?`(?:/${v})`:"/"+v),k&&(v+="?"),a+=v,p+=zt.Dynamic,k&&(p+=zt.BonusOptional),g&&(p+=zt.BonusRepeatable),b===".*"&&(p+=zt.BonusWildcard)}u.push(p)}n.push(u)}if(s.strict&&s.end){const c=n.length-1;n[c][n[c].length-1]+=zt.BonusStrict}s.strict||(a+="/?"),s.end?a+="$":s.strict&&!a.endsWith("/")&&(a+="(?:/|$)");const l=new RegExp(a,s.sensitive?"":"i");function r(c){const u=c.match(l),d={};if(!u)return null;for(let f=1;f<u.length;f++){const p=u[f]||"",m=i[f-1];d[m.name]=p&&m.repeatable?p.split("/"):p}return d}function o(c){let u="",d=!1;for(const f of e){(!d||!u.endsWith("/"))&&(u+="/"),d=!1;for(const p of f)if(p.type===Nn.Static)u+=p.value;else if(p.type===Nn.Param){const{value:m,repeatable:g,optional:k}=p,E=m in c?c[m]:"";if(ws(E)&&!g)throw new Error(`Provided param "${m}" is an array but it is not repeatable (* or + modifiers)`);const b=ws(E)?E.join("/"):E;if(!b)if(k)f.length<2&&(u.endsWith("/")?u=u.slice(0,-1):d=!0);else throw new Error(`Missing required param "${m}"`);u+=b}}return u||"/"}return{re:l,score:n,keys:i,parse:r,stringify:o}}function f_(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===zt.Static+zt.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===zt.Static+zt.Segment?1:-1:0}function Zh(e,t){let s=0;const n=e.score,a=t.score;for(;s<n.length&&s<a.length;){const i=f_(n[s],a[s]);if(i)return i;s++}if(Math.abs(a.length-n.length)===1){if(fd(n))return 1;if(fd(a))return-1}return a.length-n.length}function fd(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const p_={strict:!1,end:!0,sensitive:!1};function h_(e,t,s){const n=d_(o_(e.path),s),a=Ke(n,{record:e,parent:t,children:[],alias:[]});return t&&!a.record.aliasOf==!t.record.aliasOf&&t.children.push(a),a}function g_(e,t){const s=[],n=new Map;t=ad(p_,t);function a(d){return n.get(d)}function i(d,f,p){const m=!p,g=hd(d);g.aliasOf=p&&p.record;const k=ad(t,d),E=[g];if("alias"in d){const x=typeof d.alias=="string"?[d.alias]:d.alias;for(const w of x)E.push(hd(Ke({},g,{components:p?p.record.components:g.components,path:w,aliasOf:p?p.record:g})))}let b,v;for(const x of E){const{path:w}=x;if(f&&w[0]!=="/"){const N=f.record.path,O=N[N.length-1]==="/"?"":"/";x.path=f.record.path+(w&&O+w)}if(b=h_(x,f,k),p?p.alias.push(b):(v=v||b,v!==b&&v.alias.push(b),m&&d.name&&!gd(b)&&l(d.name)),Jh(b)&&o(b),g.children){const N=g.children;for(let O=0;O<N.length;O++)i(N[O],b,p&&p.children[O])}p=p||b}return v?()=>{l(v)}:ni}function l(d){if(Kh(d)){const f=n.get(d);f&&(n.delete(d),s.splice(s.indexOf(f),1),f.children.forEach(l),f.alias.forEach(l))}else{const f=s.indexOf(d);f>-1&&(s.splice(f,1),d.record.name&&n.delete(d.record.name),d.children.forEach(l),d.alias.forEach(l))}}function r(){return s}function o(d){const f=b_(d,s);s.splice(f,0,d),d.record.name&&!gd(d)&&n.set(d.record.name,d)}function c(d,f){let p,m={},g,k;if("name"in d&&d.name){if(p=n.get(d.name),!p)throw Aa(ct.MATCHER_NOT_FOUND,{location:d});k=p.record.name,m=Ke(pd(f.params,p.keys.filter(v=>!v.optional).concat(p.parent?p.parent.keys.filter(v=>v.optional):[]).map(v=>v.name)),d.params&&pd(d.params,p.keys.map(v=>v.name))),g=p.stringify(m)}else if(d.path!=null)g=d.path,p=s.find(v=>v.re.test(g)),p&&(m=p.parse(g),k=p.record.name);else{if(p=f.name?n.get(f.name):s.find(v=>v.re.test(f.path)),!p)throw Aa(ct.MATCHER_NOT_FOUND,{location:d,currentLocation:f});k=p.record.name,m=Ke({},f.params,d.params),g=p.stringify(m)}const E=[];let b=p;for(;b;)E.unshift(b.record),b=b.parent;return{name:k,path:g,params:m,matched:E,meta:v_(E)}}e.forEach(d=>i(d));function u(){s.length=0,n.clear()}return{addRoute:i,resolve:c,removeRoute:l,clearRoutes:u,getRoutes:r,getRecordMatcher:a}}function pd(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function hd(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:m_(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function m_(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function gd(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function v_(e){return e.reduce((t,s)=>Ke(t,s.meta),{})}function b_(e,t){let s=0,n=t.length;for(;s!==n;){const i=s+n>>1;Zh(e,t[i])<0?n=i:s=i+1}const a=y_(e);return a&&(n=t.lastIndexOf(a,n-1)),n}function y_(e){let t=e;for(;t=t.parent;)if(Jh(t)&&Zh(e,t)===0)return t}function Jh({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function md(e){const t=ps(or),s=ps(Sc),n=X(()=>{const o=Ls(e.to);return t.resolve(o)}),a=X(()=>{const{matched:o}=n.value,{length:c}=o,u=o[c-1],d=s.matched;if(!u||!d.length)return-1;const f=d.findIndex(Ea.bind(null,u));if(f>-1)return f;const p=vd(o[c-2]);return c>1&&vd(u)===p&&d[d.length-1].path!==p?d.findIndex(Ea.bind(null,o[c-2])):f}),i=X(()=>a.value>-1&&S_(s.params,n.value.params)),l=X(()=>a.value>-1&&a.value===s.matched.length-1&&qh(s.params,n.value.params));function r(o={}){if(w_(o)){const c=t[Ls(e.replace)?"replace":"push"](Ls(e.to)).catch(ni);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>c),c}return Promise.resolve()}return{route:n,href:X(()=>n.value.href),isActive:i,isExactActive:l,navigate:r}}function x_(e){return e.length===1?e[0]:e}const __=Ai({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:md,setup(e,{slots:t}){const s=_n(md(e)),{options:n}=ps(or),a=X(()=>({[bd(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[bd(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const i=t.default&&x_(t.default(s));return e.custom?i:xa("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:a.value},i)}}}),k_=__;function w_(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function S_(e,t){for(const s in t){const n=t[s],a=e[s];if(typeof n=="string"){if(n!==a)return!1}else if(!ws(a)||a.length!==n.length||n.some((i,l)=>i.valueOf()!==a[l].valueOf()))return!1}return!0}function vd(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const bd=(e,t,s)=>e??t??s,T_=Ai({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=ps(bo),a=X(()=>e.route||n.value),i=ps(cd,0),l=X(()=>{let c=Ls(i);const{matched:u}=a.value;let d;for(;(d=u[c])&&!d.components;)c++;return c}),r=X(()=>a.value.matched[l.value]);Qa(cd,X(()=>l.value+1)),Qa(Xx,r),Qa(bo,a);const o=h();return hs(()=>[o.value,r.value,e.name],([c,u,d],[f,p,m])=>{u&&(u.instances[d]=c,p&&p!==u&&c&&c===f&&(u.leaveGuards.size||(u.leaveGuards=p.leaveGuards),u.updateGuards.size||(u.updateGuards=p.updateGuards))),c&&u&&(!p||!Ea(u,p)||!f)&&(u.enterCallbacks[d]||[]).forEach(g=>g(c))},{flush:"post"}),()=>{const c=a.value,u=e.name,d=r.value,f=d&&d.components[u];if(!f)return yd(s.default,{Component:f,route:c});const p=d.props[u],m=p?p===!0?c.params:typeof p=="function"?p(c):p:null,k=xa(f,Ke({},m,t,{onVnodeUnmounted:E=>{E.component.isUnmounted&&(d.instances[u]=null)},ref:o}));return yd(s.default,{Component:k,route:c})||k}}});function yd(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const C_=T_;function E_(e){const t=g_(e.routes,e),s=e.parseQuery||Yx,n=e.stringifyQuery||od,a=e.history,i=Ha(),l=Ha(),r=Ha(),o=Oo(dn);let c=dn;ia&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Rr.bind(null,F=>""+F),d=Rr.bind(null,Dx),f=Rr.bind(null,wi);function p(F,ue){let ne,pe;return Kh(F)?(ne=t.getRecordMatcher(F),pe=ue):pe=F,t.addRoute(pe,ne)}function m(F){const ue=t.getRecordMatcher(F);ue&&t.removeRoute(ue)}function g(){return t.getRoutes().map(F=>F.record)}function k(F){return!!t.getRecordMatcher(F)}function E(F,ue){if(ue=Ke({},ue||o.value),typeof F=="string"){const C=Ir(s,F,ue.path),M=t.resolve({path:C.path},ue),W=a.createHref(C.fullPath);return Ke(C,M,{params:f(M.params),hash:wi(C.hash),redirectedFrom:void 0,href:W})}let ne;if(F.path!=null)ne=Ke({},F,{path:Ir(s,F.path,ue.path).path});else{const C=Ke({},F.params);for(const M in C)C[M]==null&&delete C[M];ne=Ke({},F,{params:d(C)}),ue.params=d(ue.params)}const pe=t.resolve(ne,ue),be=F.hash||"";pe.params=u(f(pe.params));const Ie=Fx(n,Ke({},F,{hash:Nx(be),path:pe.path})),y=a.createHref(Ie);return Ke({fullPath:Ie,hash:be,query:n===od?Qx(F.query):F.query||{}},pe,{redirectedFrom:void 0,href:y})}function b(F){return typeof F=="string"?Ir(s,F,o.value.path):Ke({},F)}function v(F,ue){if(c!==F)return Aa(ct.NAVIGATION_CANCELLED,{from:ue,to:F})}function x(F){return O(F)}function w(F){return x(Ke(b(F),{replace:!0}))}function N(F,ue){const ne=F.matched[F.matched.length-1];if(ne&&ne.redirect){const{redirect:pe}=ne;let be=typeof pe=="function"?pe(F,ue):pe;return typeof be=="string"&&(be=be.includes("?")||be.includes("#")?be=b(be):{path:be},be.params={}),Ke({query:F.query,hash:F.hash,params:be.path!=null?{}:F.params},be)}}function O(F,ue){const ne=c=E(F),pe=o.value,be=F.state,Ie=F.force,y=F.replace===!0,C=N(ne,pe);if(C)return O(Ke(b(C),{state:typeof C=="object"?Ke({},be,C.state):be,force:Ie,replace:y}),ue||ne);const M=ne;M.redirectedFrom=ue;let W;return!Ie&&$x(n,pe,ne)&&(W=Aa(ct.NAVIGATION_DUPLICATED,{to:M,from:pe}),oe(pe,pe,!0,!1)),(W?Promise.resolve(W):L(M,pe)).catch(A=>Us(A)?Us(A,ct.NAVIGATION_GUARD_REDIRECT)?A:ce(A):I(A,M,pe)).then(A=>{if(A){if(Us(A,ct.NAVIGATION_GUARD_REDIRECT))return O(Ke({replace:y},b(A.to),{state:typeof A.to=="object"?Ke({},be,A.to.state):be,force:Ie}),ue||M)}else A=P(M,pe,!0,y,be);return H(M,pe,A),A})}function S(F,ue){const ne=v(F,ue);return ne?Promise.reject(ne):Promise.resolve()}function R(F){const ue=ee.values().next().value;return ue&&typeof ue.runWithContext=="function"?ue.runWithContext(F):F()}function L(F,ue){let ne;const[pe,be,Ie]=e_(F,ue);ne=Or(pe.reverse(),"beforeRouteLeave",F,ue);for(const C of pe)C.leaveGuards.forEach(M=>{ne.push(vn(M,F,ue))});const y=S.bind(null,F,ue);return ne.push(y),Ee(ne).then(()=>{ne=[];for(const C of i.list())ne.push(vn(C,F,ue));return ne.push(y),Ee(ne)}).then(()=>{ne=Or(be,"beforeRouteUpdate",F,ue);for(const C of be)C.updateGuards.forEach(M=>{ne.push(vn(M,F,ue))});return ne.push(y),Ee(ne)}).then(()=>{ne=[];for(const C of Ie)if(C.beforeEnter)if(ws(C.beforeEnter))for(const M of C.beforeEnter)ne.push(vn(M,F,ue));else ne.push(vn(C.beforeEnter,F,ue));return ne.push(y),Ee(ne)}).then(()=>(F.matched.forEach(C=>C.enterCallbacks={}),ne=Or(Ie,"beforeRouteEnter",F,ue,R),ne.push(y),Ee(ne))).then(()=>{ne=[];for(const C of l.list())ne.push(vn(C,F,ue));return ne.push(y),Ee(ne)}).catch(C=>Us(C,ct.NAVIGATION_CANCELLED)?C:Promise.reject(C))}function H(F,ue,ne){r.list().forEach(pe=>R(()=>pe(F,ue,ne)))}function P(F,ue,ne,pe,be){const Ie=v(F,ue);if(Ie)return Ie;const y=ue===dn,C=ia?history.state:{};ne&&(pe||y?a.replace(F.fullPath,Ke({scroll:y&&C&&C.scroll},be)):a.push(F.fullPath,be)),o.value=F,oe(F,ue,ne,y),ce()}let T;function U(){T||(T=a.listen((F,ue,ne)=>{if(!fe.listening)return;const pe=E(F),be=N(pe,fe.currentRoute.value);if(be){O(Ke(be,{replace:!0,force:!0}),pe).catch(ni);return}c=pe;const Ie=o.value;ia&&Kx(rd(Ie.fullPath,ne.delta),rr()),L(pe,Ie).catch(y=>Us(y,ct.NAVIGATION_ABORTED|ct.NAVIGATION_CANCELLED)?y:Us(y,ct.NAVIGATION_GUARD_REDIRECT)?(O(Ke(b(y.to),{force:!0}),pe).then(C=>{Us(C,ct.NAVIGATION_ABORTED|ct.NAVIGATION_DUPLICATED)&&!ne.delta&&ne.type===mo.pop&&a.go(-1,!1)}).catch(ni),Promise.reject()):(ne.delta&&a.go(-ne.delta,!1),I(y,pe,Ie))).then(y=>{y=y||P(pe,Ie,!1),y&&(ne.delta&&!Us(y,ct.NAVIGATION_CANCELLED)?a.go(-ne.delta,!1):ne.type===mo.pop&&Us(y,ct.NAVIGATION_ABORTED|ct.NAVIGATION_DUPLICATED)&&a.go(-1,!1)),H(pe,Ie,y)}).catch(ni)}))}let K=Ha(),G=Ha(),D;function I(F,ue,ne){ce(F);const pe=G.list();return pe.length?pe.forEach(be=>be(F,ue,ne)):console.error(F),Promise.reject(F)}function j(){return D&&o.value!==dn?Promise.resolve():new Promise((F,ue)=>{K.add([F,ue])})}function ce(F){return D||(D=!F,U(),K.list().forEach(([ue,ne])=>F?ne(F):ue()),K.reset()),F}function oe(F,ue,ne,pe){const{scrollBehavior:be}=e;if(!ia||!be)return Promise.resolve();const Ie=!ne&&Gx(rd(F.fullPath,0))||(pe||!ne)&&history.state&&history.state.scroll||null;return Et().then(()=>be(F,ue,Ie)).then(y=>y&&qx(y)).catch(y=>I(y,F,ue))}const se=F=>a.go(F);let he;const ee=new Set,fe={currentRoute:o,listening:!0,addRoute:p,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:k,getRoutes:g,resolve:E,options:e,push:x,replace:w,go:se,back:()=>se(-1),forward:()=>se(1),beforeEach:i.add,beforeResolve:l.add,afterEach:r.add,onError:G.add,isReady:j,install(F){F.component("RouterLink",k_),F.component("RouterView",C_),F.config.globalProperties.$router=fe,Object.defineProperty(F.config.globalProperties,"$route",{enumerable:!0,get:()=>Ls(o)}),ia&&!he&&o.value===dn&&(he=!0,x(a.location).catch(pe=>{}));const ue={};for(const pe in dn)Object.defineProperty(ue,pe,{get:()=>o.value[pe],enumerable:!0});F.provide(or,fe),F.provide(Sc,No(ue)),F.provide(bo,o);const ne=F.unmount;ee.add(F),F.unmount=function(){ee.delete(F),ee.size<1&&(c=dn,T&&T(),T=null,o.value=dn,he=!1,D=!1),ne()}}};function Ee(F){return F.reduce((ue,ne)=>ue.then(()=>R(ne)),Promise.resolve())}return fe}function Yh(){return ps(or)}function A_(e){return ps(Sc)}const R_=[{group:"Workspace",label:"Dashboard",icon:"dashboard",to:{path:"/dashboard"}},{group:"Workspace",label:"Chat",icon:"chat",to:{path:"/chat"}},...["Live","Agents","Loops","Processes","Schedules"].map(e=>({group:"Operations",label:e,icon:"operations",to:{path:"/operations",query:{tab:e.toLowerCase()}}})),...["Audit","Sessions","Traces","Usage"].map(e=>({group:"History",label:e,icon:"history",to:{path:"/history",query:{tab:e.toLowerCase()}}})),...["Tools","Skills","Knowledge","Memory","Learned"].map(e=>({group:"Capabilities",label:e,icon:"capabilities",to:{path:"/capabilities",query:{tab:e.toLowerCase()}}})),{group:"Manage",label:"Personality",icon:"personality",to:{path:"/personality"}},...[["Health","health"],["Resources","resources"],["Logs","logs"],["Config","config"],["Discord","discord"],["Host Access","host-access"],["API Tokens","api-tokens"],["LLM Config","llm"],["Internals","internals"],["Update","update"]].map(([e,t])=>({group:"System",label:e,icon:"system",to:{path:"/system",query:{tab:t}}}))],Qt=_n({open:!1,query:"",selected:0});function xd(){Qt.query="",Qt.selected=0,Qt.open=!0}function Lr(){Qt.open=!1}function I_(e,t){const s=e.label.toLowerCase(),n=`${e.group} ${e.label}`.toLowerCase();return t?s.startsWith(t)?100:n.startsWith(t)?80:s.includes(t)?60:n.includes(t)?40:0:1}const N_={setup(){const e=Yh(),t=h(null),s=X(()=>{const i=Qt.query.trim().toLowerCase();return R_.map(l=>({...l,_score:I_(l,i)})).filter(l=>l._score>0).sort((l,r)=>r._score-l._score)});hs(()=>Qt.open,async i=>{var l;i&&(await Et(),(l=t.value)==null||l.focus())}),hs(()=>Qt.query,()=>{Qt.selected=0});function n(i){Lr(),e.push(i.to)}function a(i){if(i.key==="Escape"){i.preventDefault(),Lr();return}if(i.key==="ArrowDown")i.preventDefault(),Qt.selected=Math.min(Qt.selected+1,s.value.length-1);else if(i.key==="ArrowUp")i.preventDefault(),Qt.selected=Math.max(Qt.selected-1,0);else if(i.key==="Enter"){i.preventDefault();const l=s.value[Qt.selected];l&&n(l)}}return{state:Qt,results:s,inputEl:t,go:n,onKeydown:a,closePalette:Lr}},template:`
    <transition name="modal">
...
... (truncated)`:s}function kd(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function eg(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function M_(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const P_={template:`
    ...
    </div>`,setup(){const e=h({}),t=h(!0),s=h(null),n=h([]),a=h(!1),i=h([]),l=h(!1),r=h([]),o=h(0),c=h(null),u=h({reload:!1,clearSessions:!1,stopLoops:!1});let d=0;const f=X(()=>{const T=e.value.uptime_seconds||0,U=Math.floor(T/86400),K=Math.floor(T%86400/3600),G=Math.floor(T%3600/60),D=[];return U>0&&D.push(`${U}d`),K>0&&D.push(`${K}h`),(D.length===0||U===0&&K===0)&&D.push(`${G}m`),D.join(" ")}),p=X(()=>{const T=e.value.uptime_seconds||0;return 125.66*(1-Math.min(T/86400,1))}),m=X(()=>{const T=e.value;return[{label:"Guilds",value:T.guild_count??0,icon:"home",iconColor:"text-blue-400"},{label:"Sessions",value:T.session_count??0,icon:"message",iconColor:"text-yellow-400"},{label:"Tools",value:T.tool_count??0,icon:"wrench",iconColor:"text-purple-400",sub:`${T.skill_count??0} skills`,subColor:"text-gray-500"},{label:"Loops",value:T.loop_count??0,icon:"rotate",iconColor:"text-green-400",color:T.loop_count>0?"text-green-400":"",highlight:T.loop_count>0},{label:"Agents",value:T.agent_running??0,icon:"bot",iconColor:"text-cyan-400",sub:T.agent_count>0?`${T.agent_count} total`:"",subColor:"text-gray-500",highlight:(T.agent_running??0)>0},{label:"Processes",value:T.process_running??0,icon:"sliders",iconColor:"text-orange-400",sub:T.process_count>0?`${T.process_count} total`:"",subColor:"text-gray-500",highlight:(T.process_running??0)>0},{label:"Schedules",value:T.schedule_count??0,icon:"clock",iconColor:"text-amber-400",sub:(T.schedule_failing>0?`${T.schedule_failing} failing`:"")+(T.schedule_failing>0&&T.schedule_paused>0?", ":"")+(T.schedule_paused>0?`${T.schedule_paused} paused`:"")||void 0,subColor:T.schedule_failing>0?"text-red-400":"text-yellow-400",color:T.schedule_failing>0?"text-red-400":"",highlight:T.schedule_failing>0},{label:"Users",value:T.user_count??0,icon:"users",iconColor:"text-indigo-400"},...c.value!==null?[{label:"Knowledge",value:c.value,icon:"book",iconColor:"text-teal-400",sub:"chunks",subColor:"text-gray-500"}]:[]]}),g=X(()=>{const T=e.value,U=[];return U.push({label:"Bot",status:T.status==="online"?"ok":"warn",detail:T.status==="online"?"Online":"Starting"}),(T.schedule_failing||0)>0?U.push({label:"Schedules",status:"error",detail:`${T.schedule_failing} failing`}):(T.schedule_count||0)>0&&U.push({label:"Schedules",status:"ok",detail:`${T.schedule_count} configured`}),(T.loop_count||0)>0&&U.push({label:"Loops",status:"ok",detail:`${T.loop_count} active`}),(T.agent_running||0)>0&&U.push({label:"Agents",status:"ok",detail:`${T.agent_running} running`}),(T.process_running||0)>0&&U.push({label:"Processes",status:"ok",detail:`${T.process_running} running`}),U});async function k(){try{e.value=await q.get("/api/status"),s.value=null}catch(T){s.value=T.message}finally{t.value=!1}}async function E(){a.value=!0;try{n.value=await q.get("/api/audit?limit=10"),o.value=0}catch{}a.value=!1}async function b(){l.value=!0;try{i.value=await q.get("/api/audit?error_only=1&limit=5")}catch{}l.value=!1}async function v(){try{const T=await q.get("/api/knowledge");c.value=(Array.isArray(T)?T:[]).reduce((U,K)=>U+(K.chunks||0),0)}catch{c.value=null}}async function x(){try{const T=await q.get("/api/agents");r.value=T.filter(U=>U.status==="running")}catch{}}async function w(){u.value={...u.value,reload:!0};try{await q.post("/api/reload"),ke.success("Config reloaded")}catch(T){ke.error(T.message)}u.value={...u.value,reload:!1}}async function N(){if(!await ls({title:"Clear all sessions",message:"Clear all conversation sessions? This cannot be undone.",confirmLabel:"Clear All",danger:!0}))return;u.value={...u.value,clearSessions:!0};const U=e.value.session_count;e.value={...e.value,session_count:0};try{const K=await q.post("/api/sessions/clear-all");ke.success(`Cleared ${K.count} session${K.count!==1?"s":""}`),await k()}catch(K){e.value={...e.value,session_count:U},ke.error(K.message)}u.value={...u.value,clearSessions:!1}}async function O(){if(!await ls({title:"Stop all loops",message:"Stop all running loops?",confirmLabel:"Stop Loops",danger:!0}))return;u.value={...u.value,stopLoops:!0};const U=e.value.loop_count;e.value={...e.value,loop_count:0};try{const K=await q.post("/api/loops/stop-all");ke.success(K.result),await k()}catch(K){e.value={...e.value,loop_count:U},ke.error(K.message)}u.value={...u.value,stopLoops:!1}}function S(){t.value=!0,s.value=null,k(),E(),b(),x()}let R=null,L=null,H=null;function P(T){if(T.payload&&T.payload.tool_name){const U={...T.payload,_isNew:!0,_key:++d};n.value.unshift(U),n.value.length>10&&n.value.pop(),o.value++,U.error&&(i.value.unshift(U),i.value.length>5&&i.value.pop()),setTimeout(()=>{U._isNew=!1},1500),clearTimeout(H),H=setTimeout(()=>{o.value=0},1e4)}}return Be(async()=>{await Promise.all([k(),E(),b(),x(),v()]),R=setInterval(k,15e3),L=setInterval(x,1e4),Ge.subscribe("events",P)}),ht(()=>{R&&clearInterval(R),L&&clearInterval(L),clearTimeout(H),Ge.unsubscribe("events",P)}),{status:e,loading:t,error:s,uptime:f,uptimeRingOffset:p,stats:m,healthIndicators:g,activity:n,activityLoading:a,newEventCount:o,errors:i,errorsLoading:l,agents:r,actionLoading:u,fetchActivity:E,fetchStatus:k,formatTime:Cc,formatDuration:Ra,retry:S,reloadConfig:w,clearSessions:N,stopAllLoops:O}}};/*! @license DOMPurify 3.4.9 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.4.9/LICENSE */function wd(e,t){(t==null||t>e.length)&&(t=e.length);for(var s=0,n=Array(t);s<t;s++)n[s]=e[s];return n}function F_(e){if(Array.isArray(e))return e}function $_(e,t){var s=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(s!=null){var n,a,i,l,r=[],o=!0,c=!1;try{if(i=(s=s.call(e)).next,t!==0)for(;!(o=(n=i.call(s)).done)&&(r.push(n.value),r.length!==t);o=!0);}catch(u){c=!0,a=u}finally{try{if(!o&&s.return!=null&&(l=s.return(),Object(l)!==l))return}finally{if(c)throw a}}return r}}function U_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function B_(e,t){return F_(e)||$_(e,t)||H_(e,t)||U_()}function H_(e,t){if(e){if(typeof e=="string")return wd(e,t);var s={}.toString.call(e).slice(8,-1);return s==="Object"&&e.constructor&&(s=e.constructor.name),s==="Map"||s==="Set"?Array.from(e):s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?wd(e,t):void 0}}const tg=Object.entries,Sd=Object.setPrototypeOf,V_=Object.isFrozen,j_=Object.getPrototypeOf,z_=Object.getOwnPropertyDescriptor;let Wt=Object.freeze,ms=Object.seal,la=Object.create,sg=typeof Reflect<"u"&&Reflect,xo=sg.apply,_o=sg.construct;Wt||(Wt=function(t){return t});ms||(ms=function(t){return t});xo||(xo=function(t,s){for(var n=arguments.length,a=new Array(n>2?n-2:0),i=2;i<n;i++)a[i-2]=arguments[i];return t.apply(s,a)});_o||(_o=function(t){for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return new t(...n)});const Bs=yt(Array.prototype.forEach),q_=yt(Array.prototype.lastIndexOf),Td=yt(Array.prototype.pop),ta=yt(Array.prototype.push),K_=yt(Array.prototype.splice),jt=Array.isArray,Za=yt(String.prototype.toLowerCase),Dr=yt(String.prototype.toString),Cd=yt(String.prototype.match),sa=yt(String.prototype.replace),Ed=yt(String.prototype.indexOf),G_=yt(String.prototype.trim),W_=yt(Number.prototype.toString),Z_=yt(Boolean.prototype.toString),Ad=typeof BigInt>"u"?null:yt(BigInt.prototype.toString),Rd=typeof Symbol>"u"?null:yt(Symbol.prototype.toString),ot=yt(Object.prototype.hasOwnProperty),Va=yt(Object.prototype.toString),Rt=yt(RegExp.prototype.test),Cn=J_(TypeError);function yt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var s=arguments.length,n=new Array(s>1?s-1:0),a=1;a<s;a++)n[a-1]=arguments[a];return xo(e,t,n)}}function J_(e){return function(){for(var t=arguments.length,s=new Array(t),n=0;n<t;n++)s[n]=arguments[n];return _o(e,s)}}function Oe(e,t){let s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Za;if(Sd&&Sd(e,null),!jt(t))return e;let n=t.length;for(;n--;){let a=t[n];if(typeof a=="string"){const i=s(a);i!==a&&(V_(t)||(t[n]=i),a=i)}e[a]=!0}return e}function Y_(e){for(let t=0;t<e.length;t++)ot(e,t)||(e[t]=null);return e}function Pt(e){const t=la(null);for(const n of tg(e)){var s=B_(n,2);const a=s[0],i=s[1];ot(e,a)&&(jt(i)?t[a]=Y_(i):i&&typeof i=="object"&&i.constructor===Object?t[a]=Pt(i):t[a]=i)}return t}function Q_(e){switch(typeof e){case"string":return e;case"number":return W_(e);case"boolean":return Z_(e);case"bigint":return Ad?Ad(e):"0";case"symbol":return Rd?Rd(e):"Symbol()";case"undefined":return Va(e);case"function":case"object":{if(e===null)return Va(e);const t=e,s=As(t,"toString");if(typeof s=="function"){const n=s(t);return typeof n=="string"?n:Va(n)}return Va(e)}default:return Va(e)}}function As(e,t){for(;e!==null;){const n=z_(e,t);if(n){if(n.get)return yt(n.get);if(typeof n.value=="function")return yt(n.value)}e=j_(e)}function s(){return null}return s}function X_(e){try{return Rt(e,""),!0}catch{return!1}}const Id=Wt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Mr=Wt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Pr=Wt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ek=Wt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Fr=Wt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),tk=Wt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Nd=Wt(["#text"]),Od=Wt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","command","commandfor","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns"]),$r=Wt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Ld=Wt(["accent","accentunder","align","bevelled","close","columnalign","columnlines","columnspacing","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lquote","lspace","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ji=Wt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),sk=ms(/{{[\w\W]*|^[\w\W]*}}/g),nk=ms(/<%[\w\W]*|^[\w\W]*%>/g),ak=ms(/\${[\w\W]*/g),ik=ms(/^data-[\-\w.\u00B7-\uFFFF]+$/),lk=ms(/^aria-[\-\w]+$/),Dd=ms(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),rk=ms(/^(?:\w+script|data):/i),ok=ms(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),ck=ms(/^html$/i),uk=ms(/^[a-z][.\w]*(-[.\w]+)+$/i),Cs={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},dk=function(){return typeof window>"u"?null:window},fk=function(t,s){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null;const a="data-tt-policy-suffix";s&&s.hasAttribute(a)&&(n=s.getAttribute(a));const i="dompurify"+(n?"#"+n:"");try{return t.createPolicy(i,{createHTML(l){return l},createScriptURL(l){return l}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Md=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function ng(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:dk();const t=ve=>ng(ve);if(t.version="3.4.9",t.removed=[],!e||!e.document||e.document.nodeType!==Cs.document||!e.Element)return t.isSupported=!1,t;let s=e.document;const n=s,a=n.currentScript;e.DocumentFragment;const i=e.HTMLTemplateElement,l=e.Node,r=e.Element,o=e.NodeFilter,c=e.NamedNodeMap;c===void 0&&(e.NamedNodeMap||e.MozNamedAttrMap),e.HTMLFormElement;const u=e.DOMParser,d=e.trustedTypes,f=r.prototype,p=As(f,"cloneNode"),m=As(f,"remove"),g=As(f,"nextSibling"),k=As(f,"childNodes"),E=As(f,"parentNode"),b=As(f,"shadowRoot"),v=As(f,"attributes"),x=l&&l.prototype?As(l.prototype,"nodeType"):null,w=l&&l.prototype?As(l.prototype,"nodeName"):null;if(typeof i=="function"){const ve=s.createElement("template");ve.content&&ve.content.ownerDocument&&(s=ve.content.ownerDocument)}let N,O="",S,R=!1,L=0;const H=function(){if(L>0)throw Cn('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.')},P=function(_){H(),L++;try{return N.createHTML(_)}finally{L--}},T=function(_){H(),L++;try{return N.createScriptURL(_)}finally{L--}},U=function(){return R||(S=fk(d,a),R=!0),S},K=s,G=K.implementation,D=K.createNodeIterator,I=K.createDocumentFragment,j=K.getElementsByTagName,ce=n.importNode;let oe=Md();t.isSupported=typeof tg=="function"&&typeof E=="function"&&G&&G.createHTMLDocument!==void 0;const se=sk,he=nk,ee=ak,fe=ik,Ee=lk,F=rk,ue=ok,ne=uk;let pe=Dd,be=null;const Ie=Oe({},[...Id,...Mr,...Pr,...Fr,...Nd]);let y=null;const C=Oe({},[...Od,...$r,...Ld,...Ji]);let M=Object.seal(la(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),W=null,A=null;const $=Object.seal(la(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let J=!0,Q=!0,te=!1,Y=!0,me=!1,ae=!0,de=!1,ye=!1,_e=!1,Re=!1,B=!1,re=!1,xe=!0,Pe=!1;const Je="user-content-";let Ze=!0,xt=!1,et={},Ye=null;const Ss=Oe({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","selectedcontent","style","svg","template","thead","title","video","xmp"]);let Z=null;const Le=Oe({},["audio","video","img","source","image","track"]);let Ts=null;const Gn=Oe({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Wn="http://www.w3.org/1998/Math/MathML",Zn="http://www.w3.org/2000/svg",Dt="http://www.w3.org/1999/xhtml";let vs=Dt,rn=!1,Da=null;const Mi=Oe({},[Wn,Zn,Dt],Dr);let V=Oe({},["mi","mo","mn","ms","mtext"]),ie=Oe({},["annotation-xml"]);const Te=Oe({},["title","style","font","a","script"]);let qe=null;const rt=["application/xhtml+xml","text/html"],Zt="text/html";let it=null,Jn=null;const vg=s.createElement("form"),Fc=function(_){return _ instanceof RegExp||_ instanceof Function},fr=function(){let _=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Jn&&Jn===_)return;(!_||typeof _!="object")&&(_={}),_=Pt(_),qe=rt.indexOf(_.PARSER_MEDIA_TYPE)===-1?Zt:_.PARSER_MEDIA_TYPE,it=qe==="application/xhtml+xml"?Dr:Za,be=ot(_,"ALLOWED_TAGS")&&jt(_.ALLOWED_TAGS)?Oe({},_.ALLOWED_TAGS,it):Ie,y=ot(_,"ALLOWED_ATTR")&&jt(_.ALLOWED_ATTR)?Oe({},_.ALLOWED_ATTR,it):C,Da=ot(_,"ALLOWED_NAMESPACES")&&jt(_.ALLOWED_NAMESPACES)?Oe({},_.ALLOWED_NAMESPACES,Dr):Mi,Ts=ot(_,"ADD_URI_SAFE_ATTR")&&jt(_.ADD_URI_SAFE_ATTR)?Oe(Pt(Gn),_.ADD_URI_SAFE_ATTR,it):Gn,Z=ot(_,"ADD_DATA_URI_TAGS")&&jt(_.ADD_DATA_URI_TAGS)?Oe(Pt(Le),_.ADD_DATA_URI_TAGS,it):Le,Ye=ot(_,"FORBID_CONTENTS")&&jt(_.FORBID_CONTENTS)?Oe({},_.FORBID_CONTENTS,it):Ss,W=ot(_,"FORBID_TAGS")&&jt(_.FORBID_TAGS)?Oe({},_.FORBID_TAGS,it):Pt({}),A=ot(_,"FORBID_ATTR")&&jt(_.FORBID_ATTR)?Oe({},_.FORBID_ATTR,it):Pt({}),et=ot(_,"USE_PROFILES")?_.USE_PROFILES&&typeof _.USE_PROFILES=="object"?Pt(_.USE_PROFILES):_.USE_PROFILES:!1,J=_.ALLOW_ARIA_ATTR!==!1,Q=_.ALLOW_DATA_ATTR!==!1,te=_.ALLOW_UNKNOWN_PROTOCOLS||!1,Y=_.ALLOW_SELF_CLOSE_IN_ATTR!==!1,me=_.SAFE_FOR_TEMPLATES||!1,ae=_.SAFE_FOR_XML!==!1,de=_.WHOLE_DOCUMENT||!1,Re=_.RETURN_DOM||!1,B=_.RETURN_DOM_FRAGMENT||!1,re=_.RETURN_TRUSTED_TYPE||!1,_e=_.FORCE_BODY||!1,xe=_.SANITIZE_DOM!==!1,Pe=_.SANITIZE_NAMED_PROPS||!1,Ze=_.KEEP_CONTENT!==!1,xt=_.IN_PLACE||!1,pe=X_(_.ALLOWED_URI_REGEXP)?_.ALLOWED_URI_REGEXP:Dd,vs=typeof _.NAMESPACE=="string"?_.NAMESPACE:Dt,V=ot(_,"MATHML_TEXT_INTEGRATION_POINTS")&&_.MATHML_TEXT_INTEGRATION_POINTS&&typeof _.MATHML_TEXT_INTEGRATION_POINTS=="object"?Pt(_.MATHML_TEXT_INTEGRATION_POINTS):Oe({},["mi","mo","mn","ms","mtext"]),ie=ot(_,"HTML_INTEGRATION_POINTS")&&_.HTML_INTEGRATION_POINTS&&typeof _.HTML_INTEGRATION_POINTS=="object"?Pt(_.HTML_INTEGRATION_POINTS):Oe({},["annotation-xml"]);const z=ot(_,"CUSTOM_ELEMENT_HANDLING")&&_.CUSTOM_ELEMENT_HANDLING&&typeof _.CUSTOM_ELEMENT_HANDLING=="object"?Pt(_.CUSTOM_ELEMENT_HANDLING):la(null);if(M=la(null),ot(z,"tagNameCheck")&&Fc(z.tagNameCheck)&&(M.tagNameCheck=z.tagNameCheck),ot(z,"attributeNameCheck")&&Fc(z.attributeNameCheck)&&(M.attributeNameCheck=z.attributeNameCheck),ot(z,"allowCustomizedBuiltInElements")&&typeof z.allowCustomizedBuiltInElements=="boolean"&&(M.allowCustomizedBuiltInElements=z.allowCustomizedBuiltInElements),me&&(Q=!1),B&&(Re=!0),et&&(be=Oe({},Nd),y=la(null),et.html===!0&&(Oe(be,Id),Oe(y,Od)),et.svg===!0&&(Oe(be,Mr),Oe(y,$r),Oe(y,Ji)),et.svgFilters===!0&&(Oe(be,Pr),Oe(y,$r),Oe(y,Ji)),et.mathMl===!0&&(Oe(be,Fr),Oe(y,Ld),Oe(y,Ji))),$.tagCheck=null,$.attributeCheck=null,ot(_,"ADD_TAGS")&&(typeof _.ADD_TAGS=="function"?$.tagCheck=_.ADD_TAGS:jt(_.ADD_TAGS)&&(be===Ie&&(be=Pt(be)),Oe(be,_.ADD_TAGS,it))),ot(_,"ADD_ATTR")&&(typeof _.ADD_ATTR=="function"?$.attributeCheck=_.ADD_ATTR:jt(_.ADD_ATTR)&&(y===C&&(y=Pt(y)),Oe(y,_.ADD_ATTR,it))),ot(_,"ADD_URI_SAFE_ATTR")&&jt(_.ADD_URI_SAFE_ATTR)&&Oe(Ts,_.ADD_URI_SAFE_ATTR,it),ot(_,"FORBID_CONTENTS")&&jt(_.FORBID_CONTENTS)&&(Ye===Ss&&(Ye=Pt(Ye)),Oe(Ye,_.FORBID_CONTENTS,it)),ot(_,"ADD_FORBID_CONTENTS")&&jt(_.ADD_FORBID_CONTENTS)&&(Ye===Ss&&(Ye=Pt(Ye)),Oe(Ye,_.ADD_FORBID_CONTENTS,it)),Ze&&(be["#text"]=!0),de&&Oe(be,["html","head","body"]),be.table&&(Oe(be,["tbody"]),delete W.tbody),_.TRUSTED_TYPES_POLICY){if(typeof _.TRUSTED_TYPES_POLICY.createHTML!="function")throw Cn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof _.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Cn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');const le=N;N=_.TRUSTED_TYPES_POLICY;try{O=P("")}catch(Se){throw N=le,Se}}else _.TRUSTED_TYPES_POLICY===null?(N=void 0,O=""):(N===void 0&&(N=U()),N&&typeof O=="string"&&(O=P("")));(oe.uponSanitizeElement.length>0||oe.uponSanitizeAttribute.length>0)&&be===Ie&&(be=Pt(be)),oe.uponSanitizeAttribute.length>0&&y===C&&(y=Pt(y)),Wt&&Wt(_),Jn=_},$c=Oe({},[...Mr,...Pr,...ek]),Uc=Oe({},[...Fr,...tk]),bg=function(_){let z=E(_);(!z||!z.tagName)&&(z={namespaceURI:vs,tagName:"template"});const le=Za(_.tagName),Se=Za(z.tagName);return Da[_.namespaceURI]?_.namespaceURI===Zn?z.namespaceURI===Dt?le==="svg":z.namespaceURI===Wn?le==="svg"&&(Se==="annotation-xml"||V[Se]):!!$c[le]:_.namespaceURI===Wn?z.namespaceURI===Dt?le==="math":z.namespaceURI===Zn?le==="math"&&ie[Se]:!!Uc[le]:_.namespaceURI===Dt?z.namespaceURI===Zn&&!ie[Se]||z.namespaceURI===Wn&&!V[Se]?!1:!Uc[le]&&(Te[le]||!$c[le]):!!(qe==="application/xhtml+xml"&&Da[_.namespaceURI]):!1},bs=function(_){ta(t.removed,{element:_});try{E(_).removeChild(_)}catch{if(m(_),!E(_))throw Cn("a node selected for removal could not be detached from its tree and cannot be safely returned; refusing to sanitize in place")}},Bc=function(_){const z=k?k(_):_.childNodes;if(z){const Se=[];Bs(z,Ae=>{ta(Se,Ae)}),Bs(Se,Ae=>{try{m(Ae)}catch{}})}const le=v?v(_):null;if(le)for(let Se=le.length-1;Se>=0;--Se){const Ae=le[Se],De=Ae&&Ae.name;if(typeof De=="string")try{_.removeAttribute(De)}catch{}}},wn=function(_,z){try{ta(t.removed,{attribute:z.getAttributeNode(_),from:z})}catch{ta(t.removed,{attribute:null,from:z})}if(z.removeAttribute(_),_==="is")if(Re||B)try{bs(z)}catch{}else try{z.setAttribute(_,"")}catch{}},yg=function(_){const z=v?v(_):_.attributes;if(z)for(let le=z.length-1;le>=0;--le){const Se=z[le],Ae=Se&&Se.name;if(!(typeof Ae!="string"||y[it(Ae)]))try{_.removeAttribute(Ae)}catch{}}},xg=function(_){const z=[_];for(;z.length>0;){const le=z.pop();(x?x(le):le.nodeType)===Cs.element&&yg(le);const Ae=k?k(le):le.childNodes;if(Ae)for(let De=Ae.length-1;De>=0;--De)z.push(Ae[De])}},Hc=function(_){let z=null,le=null;if(_e)_="<remove></remove>"+_;else{const De=Cd(_,/^[\r\n\t ]+/);le=De&&De[0]}qe==="application/xhtml+xml"&&vs===Dt&&(_='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+_+"</body></html>");const Se=N?P(_):_;if(vs===Dt)try{z=new u().parseFromString(Se,qe)}catch{}if(!z||!z.documentElement){z=G.createDocument(vs,"template",null);try{z.documentElement.innerHTML=rn?O:Se}catch{}}const Ae=z.body||z.documentElement;return _&&le&&Ae.insertBefore(s.createTextNode(le),Ae.childNodes[0]||null),vs===Dt?j.call(z,de?"html":"body")[0]:de?z.documentElement:Ae},Vc=function(_){return D.call(_.ownerDocument||_,_,o.SHOW_ELEMENT|o.SHOW_COMMENT|o.SHOW_TEXT|o.SHOW_PROCESSING_INSTRUCTION|o.SHOW_CDATA_SECTION,null)},pr=function(_){var z,le;_.normalize();const Se=D.call(_.ownerDocument||_,_,o.SHOW_TEXT|o.SHOW_COMMENT|o.SHOW_CDATA_SECTION|o.SHOW_PROCESSING_INSTRUCTION,null);let Ae=Se.nextNode();for(;Ae;){let _t=Ae.data;Bs([se,he,ee],tt=>{_t=sa(_t,tt," ")}),Ae.data=_t,Ae=Se.nextNode()}const De=(z=(le=_.querySelectorAll)===null||le===void 0?void 0:le.call(_,"template"))!==null&&z!==void 0?z:[];Bs(Array.from(De),_t=>{Yn(_t.content)&&pr(_t.content)})},Pi=function(_){const z=w?w(_):null;return typeof z!="string"||it(z)!=="form"?!1:typeof _.nodeName!="string"||typeof _.textContent!="string"||typeof _.removeChild!="function"||_.attributes!==v(_)||typeof _.removeAttribute!="function"||typeof _.setAttribute!="function"||typeof _.namespaceURI!="string"||typeof _.insertBefore!="function"||typeof _.hasChildNodes!="function"||_.nodeType!==x(_)||_.childNodes!==k(_)},Yn=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return x(_)===Cs.documentFragment}catch{return!1}},Ma=function(_){if(!x||typeof _!="object"||_===null)return!1;try{return typeof x(_)=="number"}catch{return!1}};function Ps(ve,_,z){Bs(ve,le=>{le.call(t,_,z,Jn)})}const jc=function(_){let z=null;if(Ps(oe.beforeSanitizeElements,_,null),Pi(_))return bs(_),!0;const le=it(w?w(_):_.nodeName);if(Ps(oe.uponSanitizeElement,_,{tagName:le,allowedTags:be}),ae&&_.hasChildNodes()&&!Ma(_.firstElementChild)&&Rt(/<[/\w!]/g,_.innerHTML)&&Rt(/<[/\w!]/g,_.textContent)||ae&&_.namespaceURI===Dt&&le==="style"&&Ma(_.firstElementChild)||_.nodeType===Cs.progressingInstruction||ae&&_.nodeType===Cs.comment&&Rt(/<[/\w]/g,_.data))return bs(_),!0;if(W[le]||!($.tagCheck instanceof Function&&$.tagCheck(le))&&!be[le]){if(!W[le]&&qc(le)&&(M.tagNameCheck instanceof RegExp&&Rt(M.tagNameCheck,le)||M.tagNameCheck instanceof Function&&M.tagNameCheck(le)))return!1;if(Ze&&!Ye[le]){const Ae=E(_),De=k(_);if(De&&Ae){const _t=De.length;for(let tt=_t-1;tt>=0;--tt){const dt=xt?De[tt]:p(De[tt],!0);Ae.insertBefore(dt,g(_))}}}return bs(_),!0}return(x?x(_):_.nodeType)===Cs.element&&!bg(_)||(le==="noscript"||le==="noembed"||le==="noframes")&&Rt(/<\/no(script|embed|frames)/i,_.innerHTML)?(bs(_),!0):(me&&_.nodeType===Cs.text&&(z=_.textContent,Bs([se,he,ee],Ae=>{z=sa(z,Ae," ")}),_.textContent!==z&&(ta(t.removed,{element:_.cloneNode()}),_.textContent=z)),Ps(oe.afterSanitizeElements,_,null),!1)},zc=function(_,z,le){if(A[z]||xe&&(z==="id"||z==="name")&&(le in s||le in vg))return!1;const Se=y[z]||$.attributeCheck instanceof Function&&$.attributeCheck(z,_);if(!(Q&&!A[z]&&Rt(fe,z))){if(!(J&&Rt(Ee,z))){if(!Se||A[z]){if(!(qc(_)&&(M.tagNameCheck instanceof RegExp&&Rt(M.tagNameCheck,_)||M.tagNameCheck instanceof Function&&M.tagNameCheck(_))&&(M.attributeNameCheck instanceof RegExp&&Rt(M.attributeNameCheck,z)||M.attributeNameCheck instanceof Function&&M.attributeNameCheck(z,_))||z==="is"&&M.allowCustomizedBuiltInElements&&(M.tagNameCheck instanceof RegExp&&Rt(M.tagNameCheck,le)||M.tagNameCheck instanceof Function&&M.tagNameCheck(le))))return!1}else if(!Ts[z]){if(!Rt(pe,sa(le,ue,""))){if(!((z==="src"||z==="xlink:href"||z==="href")&&_!=="script"&&Ed(le,"data:")===0&&Z[_])){if(!(te&&!Rt(F,sa(le,ue,"")))){if(le)return!1}}}}}}return!0},_g=Oe({},["annotation-xml","color-profile","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","missing-glyph"]),qc=function(_){return!_g[Za(_)]&&Rt(ne,_)},Kc=function(_){Ps(oe.beforeSanitizeAttributes,_,null);const z=_.attributes;if(!z||Pi(_))return;const le={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:y,forceKeepAttr:void 0};let Se=z.length;for(;Se--;){const Ae=z[Se],De=Ae.name,_t=Ae.namespaceURI,tt=Ae.value,dt=it(De),on=tt;let Tt=De==="value"?on:G_(on);if(le.attrName=dt,le.attrValue=Tt,le.keepAttr=!0,le.forceKeepAttr=void 0,Ps(oe.uponSanitizeAttribute,_,le),Tt=le.attrValue,Pe&&(dt==="id"||dt==="name")&&Ed(Tt,Je)!==0&&(wn(De,_),Tt=Je+Tt),ae&&Rt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,Tt)){wn(De,_);continue}if(dt==="attributename"&&Cd(Tt,"href")){wn(De,_);continue}if(le.forceKeepAttr)continue;if(!le.keepAttr){wn(De,_);continue}if(!Y&&Rt(/\/>/i,Tt)){wn(De,_);continue}me&&Bs([se,he,ee],Wc=>{Tt=sa(Tt,Wc," ")});const Gc=it(_.nodeName);if(!zc(Gc,dt,Tt)){wn(De,_);continue}if(N&&typeof d=="object"&&typeof d.getAttributeType=="function"&&!_t)switch(d.getAttributeType(Gc,dt)){case"TrustedHTML":{Tt=P(Tt);break}case"TrustedScriptURL":{Tt=T(Tt);break}}if(Tt!==on)try{_t?_.setAttributeNS(_t,De,Tt):_.setAttribute(De,Tt),Pi(_)?bs(_):Td(t.removed)}catch{wn(De,_)}}Ps(oe.afterSanitizeAttributes,_,null)},Fi=function(_){let z=null;const le=Vc(_);for(Ps(oe.beforeSanitizeShadowDOM,_,null);z=le.nextNode();)if(Ps(oe.uponSanitizeShadowNode,z,null),jc(z),Kc(z),Yn(z.content)&&Fi(z.content),(x?x(z):z.nodeType)===Cs.element){const Ae=b?b(z):z.shadowRoot;Yn(Ae)&&(hr(Ae),Fi(Ae))}Ps(oe.afterSanitizeShadowDOM,_,null)},hr=function(_){const z=[{node:_,shadow:null}];for(;z.length>0;){const le=z.pop();if(le.shadow){Fi(le.shadow);continue}const Se=le.node,De=(x?x(Se):Se.nodeType)===Cs.element,_t=k?k(Se):Se.childNodes;if(_t)for(let tt=_t.length-1;tt>=0;--tt)z.push({node:_t[tt],shadow:null});if(De){const tt=w?w(Se):null;if(typeof tt=="string"&&it(tt)==="template"){const dt=Se.content;Yn(dt)&&z.push({node:dt,shadow:null})}}if(De){const tt=b?b(Se):Se.shadowRoot;Yn(tt)&&z.push({node:null,shadow:tt},{node:tt,shadow:null})}}};return t.sanitize=function(ve){let _=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},z=null,le=null,Se=null,Ae=null;if(rn=!ve,rn&&(ve="<!-->"),typeof ve!="string"&&!Ma(ve)&&(ve=Q_(ve),typeof ve!="string"))throw Cn("dirty is not a string, aborting");if(!t.isSupported)return ve;ye||fr(_),t.removed=[];const De=xt&&typeof ve!="string"&&Ma(ve);if(De){const dt=w?w(ve):ve.nodeName;if(typeof dt=="string"){const on=it(dt);if(!be[on]||W[on])throw Cn("root node is forbidden and cannot be sanitized in-place")}if(Pi(ve))throw Cn("root node is clobbered and cannot be sanitized in-place");try{hr(ve)}catch(on){throw Bc(ve),on}}else if(Ma(ve))z=Hc("<!---->"),le=z.ownerDocument.importNode(ve,!0),le.nodeType===Cs.element&&le.nodeName==="BODY"||le.nodeName==="HTML"?z=le:z.appendChild(le),hr(le);else{if(!Re&&!me&&!de&&ve.indexOf("<")===-1)return N&&re?P(ve):ve;if(z=Hc(ve),!z)return Re?null:re?O:""}z&&_e&&bs(z.firstChild);const _t=Vc(De?ve:z);try{for(;Se=_t.nextNode();)jc(Se),Kc(Se),Yn(Se.content)&&Fi(Se.content)}catch(dt){throw De&&Bc(ve),dt}if(De)return Bs(t.removed,dt=>{dt.element&&xg(dt.element)}),me&&pr(ve),ve;if(Re){if(me&&pr(z),B)for(Ae=I.call(z.ownerDocument);z.firstChild;)Ae.appendChild(z.firstChild);else Ae=z;return(y.shadowroot||y.shadowrootmode)&&(Ae=ce.call(n,Ae,!0)),Ae}let tt=de?z.outerHTML:z.innerHTML;return de&&be["!doctype"]&&z.ownerDocument&&z.ownerDocument.doctype&&z.ownerDocument.doctype.name&&Rt(ck,z.ownerDocument.doctype.name)&&(tt="<!DOCTYPE "+z.ownerDocument.doctype.name+`>
`+tt),me&&Bs([se,he,ee],dt=>{tt=sa(tt,dt," ")}),N&&re?P(tt):tt},t.setConfig=function(){let ve=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};fr(ve),ye=!0},t.clearConfig=function(){Jn=null,ye=!1,N=S,O=""},t.isValidAttribute=function(ve,_,z){Jn||fr({});const le=it(ve),Se=it(_);return zc(le,Se,z)},t.addHook=function(ve,_){typeof _=="function"&&ta(oe[ve],_)},t.removeHook=function(ve,_){if(_!==void 0){const z=q_(oe[ve],_);return z===-1?void 0:K_(oe[ve],z,1)[0]}return Td(oe[ve])},t.removeHooks=function(ve){oe[ve]=[]},t.removeAllHooks=function(){oe=Md()},t}var Pd=ng();function Ac(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Kn=Ac();function ag(e){Kn=e}var ai={exec:()=>null};function We(e,t=""){let s=typeof e=="string"?e:e.source;const n={replace:(a,i)=>{let l=typeof i=="string"?i:i.source;return l=l.replace(Kt.caret,"$1"),s=s.replace(a,l),n},getRegex:()=>new RegExp(s,t)};return n}var Kt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},pk=/^(?:[ \t]*(?:\n|$))+/,hk=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,gk=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Di=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,mk=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Rc=/(?:[*+-]|\d{1,9}[.)])/,ig=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,lg=We(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),vk=We(ig).replace(/bull/g,Rc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ic=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,bk=/^[^\n]+/,Nc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,yk=We(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Nc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),xk=We(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Rc).getRegex(),cr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Oc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_k=We("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Oc).replace("tag",cr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),rg=We(Ic).replace("hr",Di).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",cr).getRegex(),kk=We(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",rg).getRegex(),Lc={blockquote:kk,code:hk,def:yk,fences:gk,heading:mk,hr:Di,html:_k,lheading:lg,list:xk,newline:pk,paragraph:rg,table:ai,text:bk},Fd=We("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Di).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",cr).getRegex(),wk={...Lc,lheading:vk,table:Fd,paragraph:We(Ic).replace("hr",Di).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Fd).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",cr).getRegex()},Sk={...Lc,html:We(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Oc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ai,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:We(Ic).replace("hr",Di).replace("heading",` *#{1,6} *[^
]`).replace("lheading",lg).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Tk=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ck=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,og=/^( {2,}|\\)\n(?!\s*$)/,Ek=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ur=/[\p{P}\p{S}]/u,Dc=/[\s\p{P}\p{S}]/u,cg=/[^\s\p{P}\p{S}]/u,Ak=We(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Dc).getRegex(),ug=/(?!~)[\p{P}\p{S}]/u,Rk=/(?!~)[\s\p{P}\p{S}]/u,Ik=/(?:[^\s\p{P}\p{S}]|~)/u,Nk=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,dg=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ok=We(dg,"u").replace(/punct/g,ur).getRegex(),Lk=We(dg,"u").replace(/punct/g,ug).getRegex(),fg="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Dk=We(fg,"gu").replace(/notPunctSpace/g,cg).replace(/punctSpace/g,Dc).replace(/punct/g,ur).getRegex(),Mk=We(fg,"gu").replace(/notPunctSpace/g,Ik).replace(/punctSpace/g,Rk).replace(/punct/g,ug).getRegex(),Pk=We("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,cg).replace(/punctSpace/g,Dc).replace(/punct/g,ur).getRegex(),Fk=We(/\\(punct)/,"gu").replace(/punct/g,ur).getRegex(),$k=We(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Uk=We(Oc).replace("(?:-->|$)","-->").getRegex(),Bk=We("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Uk).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Dl=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Hk=We(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Dl).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),pg=We(/^!?\[(label)\]\[(ref)\]/).replace("label",Dl).replace("ref",Nc).getRegex(),hg=We(/^!?\[(ref)\](?:\[\])?/).replace("ref",Nc).getRegex(),Vk=We("reflink|nolink(?!\\()","g").replace("reflink",pg).replace("nolink",hg).getRegex(),Mc={_backpedal:ai,anyPunctuation:Fk,autolink:$k,blockSkip:Nk,br:og,code:Ck,del:ai,emStrongLDelim:Ok,emStrongRDelimAst:Dk,emStrongRDelimUnd:Pk,escape:Tk,link:Hk,nolink:hg,punctuation:Ak,reflink:pg,reflinkSearch:Vk,tag:Bk,text:Ek,url:ai},jk={...Mc,link:We(/^!?\[(label)\]\((.*?)\)/).replace("label",Dl).getRegex(),reflink:We(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Dl).getRegex()},ko={...Mc,emStrongRDelimAst:Mk,emStrongLDelim:Lk,url:We(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},zk={...ko,br:We(og).replace("{2,}","*").getRegex(),text:We(ko.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Yi={normal:Lc,gfm:wk,pedantic:Sk},ja={normal:Mc,gfm:ko,breaks:zk,pedantic:jk},qk={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},$d=e=>qk[e];function Rs(e,t){if(t){if(Kt.escapeTest.test(e))return e.replace(Kt.escapeReplace,$d)}else if(Kt.escapeTestNoEncode.test(e))return e.replace(Kt.escapeReplaceNoEncode,$d);return e}function Ud(e){try{e=encodeURI(e).replace(Kt.percentDecode,"%")}catch{return null}return e}function Bd(e,t){var i;const s=e.replace(Kt.findPipe,(l,r,o)=>{let c=!1,u=r;for(;--u>=0&&o[u]==="\\";)c=!c;return c?"|":" |"}),n=s.split(Kt.splitPipe);let a=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;a<n.length;a++)n[a]=n[a].trim().replace(Kt.slashPipe,"|");return n}function za(e,t,s){const n=e.length;if(n===0)return"";let a=0;for(;a<n&&e.charAt(n-a-1)===t;)a++;return e.slice(0,n-a)}function Kk(e,t){if(e.indexOf(t[1])===-1)return-1;let s=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])s++;else if(e[n]===t[1]&&(s--,s<0))return n;return s>0?-2:-1}function Hd(e,t,s,n,a){const i=t.href,l=t.title||null,r=e[1].replace(a.other.outputLinkReplace,"$1");n.state.inLink=!0;const o={type:e[0].charAt(0)==="!"?"image":"link",raw:s,href:i,title:l,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=!1,o}function Gk(e,t,s){const n=e.match(s.other.indentCodeCompensation);if(n===null)return t;const a=n[1];return t.split(`
...
`)}var Ml=class{constructor(e){Xe(this,"options");Xe(this,"rules");Xe(this,"lexer");this.options=e||Kn}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const s=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?s:za(s,`
...
`,e=e.substring(f.length+1),o=!0),!o){const E=this.rules.other.nextBulletRegex(m),b=this.rules.other.hrRegex(m),v=this.rules.other.fencesBeginRegex(m),x=this.rules.other.headingBeginRegex(m),w=this.rules.other.htmlBeginRegex(m);for(;e;){const N=e.split(`
`,1)[0];let O;if(f=N,this.options.pedantic?(f=f.replace(this.rules.other.listReplaceNesting,"  "),O=f):O=f.replace(this.rules.other.tabCharGlobal,"    "),v.test(f)||x.test(f)||w.test(f)||E.test(f)||b.test(f))break;if(O.search(this.rules.other.nonSpaceChar)>=m||!f.trim())u+=`
...
`+n+"</"+a+`>
`}listitem(e){var s;let t="";if(e.task){const n=this.checkbox({checked:!!e.checked});e.loose?((s=e.tokens[0])==null?void 0:s.type)==="paragraph"?(e.tokens[0].text=n+" "+e.tokens[0].text,e.tokens[0].tokens&&e.tokens[0].tokens.length>0&&e.tokens[0].tokens[0].type==="text"&&(e.tokens[0].tokens[0].text=n+" "+Rs(e.tokens[0].tokens[0].text),e.tokens[0].tokens[0].escaped=!0)):e.tokens.unshift({type:"text",raw:n+" ",text:n+" ",escaped:!0}):t+=n+" "}return t+=this.parser.parse(e.tokens,!!e.loose),`<li>${t}</li>
...
Please report this to https://github.com/markedjs/marked.`,e){const n="<p>An error occurred:</p><pre>"+Rs(s.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(s);throw s}}},Hn=new Wk;function ze(e,t){return Hn.parse(e,t)}ze.options=ze.setOptions=function(e){return Hn.setOptions(e),ze.defaults=Hn.defaults,ag(ze.defaults),ze};ze.getDefaults=Ac;ze.defaults=Kn;ze.use=function(...e){return Hn.use(...e),ze.defaults=Hn.defaults,ag(ze.defaults),ze};ze.walkTokens=function(e,t){return Hn.walkTokens(e,t)};ze.parseInline=Hn.parseInline;ze.Parser=Zs;ze.parser=Zs.parse;ze.Renderer=Pl;ze.TextRenderer=Pc;ze.Lexer=Ws;ze.lexer=Ws.lex;ze.Tokenizer=Ml;ze.Hooks=ll;ze.parse=ze;ze.options;ze.setOptions;ze.use;ze.walkTokens;ze.parseInline;Zs.parse;Ws.lex;const Zk={breaks:!0,gfm:!0};function Vd(e){if(!e)return"";try{if(typeof ze<"u"&&ze.parse){const t=ze.parse(e,Zk);return typeof Pd<"u"?Pd.sanitize(t):t}}catch{}return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}function Jk(e){const t=new Date(e),s=t.getHours().toString().padStart(2,"0"),n=t.getMinutes().toString().padStart(2,"0");return`${s}:${n}`}const Yk={run_command:"terminal",ssh_command:"terminal",run_script:"terminal",read_file:"file",write_file:"edit",list_directory:"folder",search_knowledge:"search",ingest_document:"book",generate_image:"image",analyze_image:"eye",analyze_pdf:"file",browser_screenshot:"globe",manage_process:"sliders"};function Qk(e){return Yk[e]||"wrench"}const Xk=/https?:\/\/\S+\.(?:png|jpg|jpeg|gif|webp|svg)(?:\?\S*)?/gi;function jd(e){if(!e)return[];const t=e.match(Xk);return t?[...new Set(t)]:[]}const ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(""),s=h(!1),n=h(null),a=h(null),i=h(0),l=h("");let r=null,o=0;const c=["Check system health","List running services","Show disk usage","What can you do?"],u=X(()=>t.value.trim().length>0&&!s.value),d=X(()=>{const T=Ge.state;return T==="connected"?"Connected":T==="reconnecting"?"Reconnecting…":T==="connecting"?"Connecting…":"REST fallback"}),f=["Watching across all realms...","Processing...","Consulting the bifrost...","Observing..."],p=X(()=>{const T=Math.floor(i.value/4)%f.length,U=i.value;return U>3?`${f[T]} (${U}s)`:f[0]});function m(){Et(()=>{n.value&&(n.value.scrollTop=n.value.scrollHeight)})}function g(){if(!a.value)return;const T=a.value;T.style.height="auto",T.style.height=Math.min(T.scrollHeight,120)+"px"}function k(T,U,K={}){const G={id:++o,role:T,content:U,timestamp:Date.now(),html:T==="bot"?Vd(U):"",tools_used:K.tools_used||[],is_error:K.is_error||!1,images:T==="bot"?jd(U):[],files:K.files||[],_showTools:!1};return e.value.push(G),m(),T==="bot"&&Et(()=>E()),G}function E(){if(!n.value)return;n.value.querySelectorAll(".chat-markdown pre:not([data-copy])").forEach(U=>{U.setAttribute("data-copy","true"),U.style.position="relative";const K=document.createElement("button");K.className="chat-code-copy",K.textContent="Copy",K.addEventListener("click",()=>{const G=U.querySelector("code"),D=G?G.textContent:U.textContent;navigator.clipboard.writeText(D).then(()=>{K.textContent="Copied!",setTimeout(()=>{K.textContent="Copy"},1500)}).catch(()=>{})}),U.appendChild(K)})}function b(T){if(T===0)return!0;const U=e.value[T-1],K=e.value[T],G=new Date(U.timestamp).toDateString(),D=new Date(K.timestamp).toDateString();return G!==D}function v(T){const U=new Date(T),K=new Date;if(U.toDateString()===K.toDateString())return"Today";const G=new Date(K);return G.setDate(G.getDate()-1),U.toDateString()===G.toDateString()?"Yesterday":U.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function x(T){t.value=T,Et(()=>H())}function w(T){window.open(T,"_blank","noopener")}function N(T){T.target.style.display="none"}function O(){i.value=0,r=setInterval(()=>{i.value++},1e3)}function S(){r&&(clearInterval(r),r=null),i.value=0}function R(T){s.value&&(s.value=!1,S(),T.type==="chat_response"?k("bot",T.content,{tools_used:T.tools_used||[],is_error:T.is_error||!1,files:T.files||[]}):T.type==="chat_error"&&k("bot",T.error||"Unknown error",{is_error:!0}),Et(()=>{var U;return(U=a.value)==null?void 0:U.focus()}))}async function L(T){try{const U=await q.post("/api/chat",{content:T,channel_id:l.value});k("bot",U.response,{tools_used:U.tools_used||[],is_error:U.is_error||!1,files:U.files||[]})}catch(U){k("bot",U.message||"Failed to send message",{is_error:!0})}}async function H(){const T=t.value.trim();if(!T||s.value)return;k("user",T),t.value="",s.value=!0,O(),a.value&&(a.value.style.height="auto"),Ge.connected&&Ge.sendChat(T,{channelId:l.value})||(await L(T),s.value=!1,S()),Et(()=>{var K;return(K=a.value)==null?void 0:K.focus()})}async function P(){try{if(!l.value){const U=await q.get("/api/auth/session");l.value=U.channel_id||U.user_id||"web-user"}const T=await q.get("/api/sessions/"+encodeURIComponent(l.value));if(T&&T.messages&&T.messages.length>0){for(const U of T.messages){const K=U.role==="user"?"user":"bot";let G=U.content||"";if(K==="user"){const I=G.match(/^\[.*?\]:\s*/);I&&(G=G.slice(I[0].length))}if(!G.trim())continue;const D={id:++o,role:K,content:G,timestamp:U.timestamp?U.timestamp*1e3:Date.now(),html:K==="bot"?Vd(G):"",tools_used:[],is_error:!1,images:K==="bot"?jd(G):[],files:[],_showTools:!1};e.value.push(D)}Et(()=>{m(),E()})}}catch{}}return Be(()=>{Ge.subscribe("chat",R),P(),Et(()=>{var T;return(T=a.value)==null?void 0:T.focus()})}),ht(()=>{Ge.unsubscribe("chat",R),S()}),{messages:e,input:t,sending:s,messagesEl:n,inputEl:a,canSend:u,wsStatus:d,typingText:p,suggestions:c,send:H,autoResize:g,formatTime:Jk,formatDate:v,showDateSeparator:b,useSuggestion:x,openImage:w,onImageError:N,getToolIcon:Qk}}},dr={props:{tabs:{type:Array,required:!0},defaultTab:{type:String,default:""},groupLabel:{type:String,default:""}},setup(e){const t=A_(),s=Yh(),n=X({get(){var o;const r=t.query.tab;return r&&e.tabs.some(c=>c.id===r)?r:e.defaultTab||((o=e.tabs[0])==null?void 0:o.id)||""},set(r){s.replace({query:{...t.query,tab:r}})}}),a=X(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.component)||null}),i=X(()=>{var r;return((r=e.tabs.find(o=>o.id===n.value))==null?void 0:r.label)||""});hs(i,r=>{e.groupLabel&&r&&(document.title=`Odin — ${e.groupLabel} › ${r}`)},{immediate:!0});function l(r,o){if(!["ArrowLeft","ArrowRight","Home","End"].includes(r.key))return;r.preventDefault();let c=o;r.key==="ArrowRight"&&(c=(o+1)%e.tabs.length),r.key==="ArrowLeft"&&(c=(o-1+e.tabs.length)%e.tabs.length),r.key==="Home"&&(c=0),r.key==="End"&&(c=e.tabs.length-1),n.value=e.tabs[c].id,requestAnimationFrame(()=>{var u;return(u=document.getElementById("tab-"+e.tabs[c].id))==null?void 0:u.focus()})}return{activeTab:n,activeComponent:a,activeLabel:i,onTabKeydown:l}},template:`
...
`)}return}}let i=null;function l(){const c=Date.now();e.value.forEach(u=>{u.status==="running"&&(u.elapsed=c-u.startTime)})}Be(()=>{Ge.on("events",a),i=setInterval(l,500)}),ht(()=>{Ge.off("events",a),i&&clearInterval(i)});function r(c){return c<1e3?`${c}ms`:`${(c/1e3).toFixed(1)}s`}function o(c){return c==="running"?"clock":c==="success"?"success":c==="error"?"error":"info"}return{activeTasks:e,recentHistory:t,streamOutput:s,formatMs:r,statusIcon:o}},template:`
  ...
  `},sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(!0),i=h("all");let l=null;const r=X(()=>e.value.filter(E=>E.status==="running").length),o=X(()=>e.value.filter(E=>E.status==="completed").length),c=X(()=>e.value.filter(E=>["failed","timeout","killed"].includes(E.status)).length),u=X(()=>[{value:"all",label:"All",count:e.value.length},{value:"running",label:"Running",count:r.value},{value:"completed",label:"Completed",count:o.value},{value:"failed",label:"Failed",count:c.value}]),d=X(()=>i.value==="all"?e.value:i.value==="failed"?e.value.filter(E=>["failed","timeout","killed"].includes(E.status)):e.value.filter(E=>E.status===i.value));function f(E){return Math.min(100,Math.round(E.iteration_count/30*100))}async function p(E=!1){E=E===!0,E||(t.value=!0);try{const b=await q.get("/api/agents");e.value=Array.isArray(b)?b:[],s.value=null}catch(b){E||(s.value=b.message)}E||(t.value=!1)}async function m(E){const b=e.value.find(x=>x.id===E);if(await ls({title:"Kill agent",message:`Kill agent "${(b==null?void 0:b.label)||E}"? Its current work will be lost.`,confirmLabel:"Kill",danger:!0})){n.value=E;try{await q.del(`/api/agents/${encodeURIComponent(E)}`),ke.success("Agent killed"),await p()}catch(x){ke.error(x.message||"Failed to kill agent")}n.value=null}}function g(){k(),a.value&&(l=setInterval(()=>{a.value&&p(!0)},5e3))}function k(){l&&(clearInterval(l),l=null)}return Be(()=>{p(),g()}),ht(()=>{k()}),{agents:e,loading:t,error:s,killing:n,autoRefresh:a,statusFilter:i,runningCount:r,completedCount:o,failedCount:c,statusFilters:u,filteredAgents:d,formatTs:La,formatDuration:Ra,progressPercent:f,fetchAgents:p,killAgent:m,startAutoRefresh:g,stopAutoRefresh:k}}},nw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""}),i=h(!1),l=h(null),r=h(null),o=h(null),c=h({}),u=X(()=>e.value.reduce((N,O)=>N+(O.iteration_count||0),0)),d=X(()=>e.value.filter(N=>N.status==="running").length);function f(N){return N==="running"?"loop-status-running":N==="error"?"loop-status-error":"loop-status-stopped"}function p(N){return N==="running"?"badge-success":N==="error"?"badge-danger":N==="completed"?"badge-info":"badge-warning"}function m(N){return N==="act"?"badge-warning":N==="silent"?"badge-info":"badge-success"}function g(N){c.value={...c.value,[N]:!c.value[N]}}async function k(N=!1){N=N===!0,N||(t.value=!0);try{e.value=await q.get("/api/loops"),s.value=null}catch(O){N||(s.value=O.message)}N||(t.value=!1)}async function E(){l.value=null;const N=a.value;if(!N.goal.trim()){l.value="Goal is required";return}if(!N.channel_id.trim()){l.value="Channel ID is required";return}const O={goal:N.goal.trim(),channel_id:N.channel_id.trim(),interval_seconds:N.interval_seconds||60,mode:N.mode,max_iterations:N.max_iterations||50};N.stop_condition.trim()&&(O.stop_condition=N.stop_condition.trim()),i.value=!0;try{const S=await q.post("/api/loops",O);ke.success(`Loop started: ${S.loop_id}`),a.value={goal:"",interval_seconds:60,mode:"notify",max_iterations:50,stop_condition:"",channel_id:""},n.value=!1,await k()}catch(S){l.value=S.message}i.value=!1}async function b(N){if(await ls({title:"Stop loop",message:`Stop loop ${N}? The current iteration will finish before stopping.`,confirmLabel:"Stop Loop",danger:!0})){r.value=N;try{await q.del(`/api/loops/${encodeURIComponent(N)}`),ke.success("Loop stopped"),await k()}catch(S){ke.error(S.message||"Failed to stop loop")}r.value=null}}async function v(N){o.value=N;try{await q.post(`/api/loops/${encodeURIComponent(N)}/restart`),ke.success("Loop restarted"),await k()}catch(O){ke.error(O.message||"Failed to restart loop")}o.value=null}function x(N){N.payload&&(N.payload.loop_id||N.payload.type==="loop")&&k(!0)}let w=null;return Be(()=>{k(),Ge.subscribe("events",x),w=setInterval(()=>{k(!0)},5e3)}),ht(()=>{Ge.unsubscribe("events",x),w&&clearInterval(w)}),{loops:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,stoppingId:r,restartingId:o,expandedHistory:c,totalIterations:u,runningCount:d,statusDotClass:f,statusBadge:p,modeBadge:m,formatDuration:Ra,formatAge:Qh,toggleHistory:g,fetchLoops:k,doCreate:E,doStop:b,doRestart:v}}},aw={template:`
    <div class="p-6 page-fade-in">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!0);let a=null;const i=h(null),l=X(()=>e.value.filter(g=>g.status==="running").length),r=X(()=>e.value.filter(g=>g.status!=="running").length);function o(g){return g==="running"?"loop-status-running":g==="failed"||g==="error"?"loop-status-error":"loop-status-stopped"}function c(g){return g==="running"?"badge-success":g==="completed"||g==="exited"?"badge-info":g==="killed"||g==="error"||g==="failed"?"badge-danger":"badge-warning"}async function u(g=!1){g=g===!0,g||(t.value=!0);try{e.value=await q.get("/api/processes"),s.value=null}catch(k){g||(s.value=k.message)}g||(t.value=!1)}function d(){f(),n.value&&(a=setInterval(()=>{t.value||u(!0)},5e3))}function f(){a&&(clearInterval(a),a=null)}hs(n,g=>{g?d():f()});async function p(g){if(await ls({title:"Kill process",message:`Kill process ${g}?`,confirmLabel:"Kill",danger:!0})){i.value=g;try{await q.del(`/api/processes/${g}`),ke.success(`Process ${g} killed`),await u()}catch(E){ke.error(E.message||"Failed to kill process")}i.value=null}}function m(g){g.payload&&(g.payload.pid||g.payload.type==="process")&&u(!0)}return Be(()=>{u(),Ge.subscribe("events",m),d()}),ht(()=>{Ge.unsubscribe("events",m),f()}),{processes:e,loading:t,error:s,autoRefresh:n,killingPid:i,runningCount:l,completedCount:r,procStatusDot:o,statusBadge:c,formatDuration:Ra,fetchProcesses:u,doKill:p}}},iw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-start justify-between mb-4 flex-wrap gap-3">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""}),i=h(!1),l=h(null),r=h(null),o=h(!1),c=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],u=h(null),d=h(null),f=h(null),p=h(null),m=h(null),g=h([]),k=h(!1),E=X(()=>e.value.filter(D=>D.cron&&!D.one_time).length),b=X(()=>e.value.filter(D=>D.one_time).length),v=X(()=>e.value.filter(D=>D.trigger).length),x=X(()=>e.value.filter(D=>D.paused).length),w=X(()=>e.value.filter(D=>D.consecutive_failures>0).length);function N(D){if(!D)return"-";const I=Date.now(),ce=(new Date(D).getTime()-I)/1e3;if(ce<0)return"overdue";if(ce<60)return"in < 1 min";if(ce<3600)return`in ${Math.floor(ce/60)} min`;if(ce<86400){const se=Math.floor(ce/3600),he=Math.floor(ce%3600/60);return he>0?`in ${se}h ${he}m`:`in ${se}h`}const oe=Math.floor(ce/86400);return`in ${oe} day${oe!==1?"s":""}`}function O(D){return D==null?"-":D<1e3?`${D}ms`:D<6e4?`${(D/1e3).toFixed(1)}s`:Ra(D/1e3)}function S(){r.value=null}async function R(){const D=a.value.cron.trim();if(D){o.value=!0;try{r.value=await q.post("/api/schedules/validate-cron",{expression:D})}catch(I){r.value={valid:!1,error:I.message}}o.value=!1}}async function L(){t.value=!0,s.value=null;try{e.value=await q.get("/api/schedules")}catch(D){s.value=D.message}t.value=!1}async function H(D){if(m.value===D){m.value=null,g.value=[];return}m.value=D,k.value=!0,g.value=[];try{g.value=await q.get(`/api/schedules/${encodeURIComponent(D)}/history?limit=10`)}catch{g.value=[]}k.value=!1}async function P(){l.value=null;const D=a.value;if(!D.description.trim()){l.value="Description is required";return}if(!D.channel_id.trim()){l.value="Channel ID is required";return}if(!D.cron.trim()&&!D.run_at.trim()){l.value="Cron expression or run_at time is required";return}const I={description:D.description.trim(),action:D.action,channel_id:D.channel_id.trim()};if(D.cron.trim()&&(I.cron=D.cron.trim()),D.run_at.trim()&&(I.run_at=D.run_at.trim()),D.action==="reminder"&&D.message.trim()&&(I.message=D.message.trim()),D.action==="check"&&(D.tool_name.trim()&&(I.tool_name=D.tool_name.trim()),D.tool_input_str.trim()))try{I.tool_input=JSON.parse(D.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await q.post("/api/schedules",I),ke.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:""},r.value=null,n.value=!1,await L()}catch(j){l.value=j.message}i.value=!1}async function T(D){u.value=D;try{const I=await q.post(`/api/schedules/${encodeURIComponent(D)}/run`);if(I.status==="failure")ke.error(`Execution failed: ${I.error||"unknown error"}`);else{const j=I.warning?`Executed (${I.warning})`:"Executed successfully";ke.success(j)}await L()}catch(I){ke.error(I.message||"Failed to trigger")}u.value=null}async function U(D){f.value=D.id;const I=!D.paused;try{await q.put(`/api/schedules/${encodeURIComponent(D.id)}`,{paused:I}),ke.success(I?"Schedule paused":"Schedule resumed"),await L()}catch(j){ke.error(j.message||"Failed to update schedule")}f.value=null}async function K(D){p.value=D;try{await q.post(`/api/schedules/${encodeURIComponent(D)}/reset-failures`),ke.success("Failure counters reset"),await L()}catch(I){ke.error(I.message||"Failed to reset")}p.value=null}async function G(D){const I=e.value.find(ce=>ce.id===D);if(await ls({title:"Delete schedule",message:`Delete "${(I==null?void 0:I.description)||D}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){d.value=D;try{await q.del(`/api/schedules/${encodeURIComponent(D)}`),ke.success("Schedule deleted"),await L()}catch(ce){ke.error(ce.message||"Failed to delete schedule")}d.value=null}}return Be(()=>{L()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,cronResult:r,validatingCron:o,cronPresets:c,runningId:u,deletingId:d,togglingId:f,resettingId:p,expandedId:m,history:g,historyLoading:k,cronCount:E,oneTimeCount:b,webhookCount:v,pausedCount:x,failingCount:w,formatTs:La,formatAge:Qh,formatFuture:N,formatMs:O,formatDuration:Ra,onCronInput:S,validateCron:R,toggleExpand:H,fetchSchedules:L,doCreate:P,doRunNow:T,doTogglePause:U,doResetFailures:K,doDelete:G}}},lw={components:{TabbedPage:dr},setup(){return{tabs:[{id:"live",label:"Live",component:tw},{id:"agents",label:"Agents",component:sw},{id:"loops",label:"Loops",component:nw},{id:"processes",label:"Processes",component:aw},{id:"schedules",label:"Schedules",component:iw}]}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},rw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1),l=h(null),r=h(!1),o=h(new Set),c=h(!1),u=h("all"),d=h(""),f=h("last_active"),p=h(!1),m=zd,g=ow,k=h([]),E=h(!1),b=h(""),v=h("flat"),x=h(new Set),w=h(""),N=h(""),O=h(""),S=h(null),R=h(!1);function L(){try{const B=localStorage.getItem("odin-session-presets");B&&(k.value=JSON.parse(B))}catch{}}function H(){try{localStorage.setItem("odin-session-presets",JSON.stringify(k.value))}catch{}}const P=X(()=>d.value.trim()!==""||u.value!=="all"),T=X(()=>{let B=[...e.value];const re=zd.find(Ze=>Ze.id===u.value),xe=re?re.filters:{};if(xe.source&&(B=B.filter(Ze=>Ze.source===xe.source)),xe.minMessages&&(B=B.filter(Ze=>Ze.message_count>=xe.minMessages)),xe.hasCompaction&&(B=B.filter(Ze=>Ze.has_summary)),xe.maxAge!=null){const Ze=Date.now()/1e3;B=B.filter(xt=>xt.last_active&&Ze-xt.last_active<=xe.maxAge)}if(d.value.trim()){const Ze=d.value.toLowerCase().trim();B=B.filter(xt=>(xt.channel_id||"").toLowerCase().includes(Ze)||(xt.last_user_id||"").toLowerCase().includes(Ze)||(xt.source||"").toLowerCase().includes(Ze))}const Pe=f.value,Je=p.value?1:-1;return B.sort((Ze,xt)=>{const et=Ze[Pe]||0,Ye=xt[Pe]||0;return(et-Ye)*Je}),B}),U=X(()=>{if(!a.value||!a.value.messages)return[];const B=a.value.messages;if(B.length===0)return[];const re=[];let xe=[];for(const Pe of B)Pe.role==="user"&&xe.length>0&&(re.push(xe),xe=[]),xe.push(Pe);return xe.length>0&&re.push(xe),re}),K=X(()=>T.value.length>0&&o.value.size===T.value.length);function G(B){const re=B.find(xe=>xe.role==="user");if(re&&re.content){const xe=re.content.slice(0,120);return xe.length<re.content.length?xe+"...":xe}return"(no user message)"}function D(B){const re=new Set(x.value);re.has(B)?re.delete(B):re.add(B),x.value=re}function I(B){u.value=B}function j(B){u.value=B.id,B.filters.searchQuery!=null&&(d.value=B.filters.searchQuery),B.filters.sortBy&&(f.value=B.filters.sortBy)}function ce(){if(!b.value.trim())return;const B={id:"custom-"+Date.now(),name:b.value.trim(),filters:{searchQuery:d.value,sortBy:f.value}};k.value=[...k.value,B],H(),E.value=!1,b.value=""}function oe(B){k.value=k.value.filter(re=>re.id!==B),H(),u.value===B&&(u.value="all")}function se(){u.value="all",d.value="",f.value="last_active",p.value=!1}function he(B){if(!B)return"—";const re=Date.now()/1e3-B;if(re<60)return"just now";if(re<3600){const Pe=Math.floor(re/60);return`${Pe} minute${Pe!==1?"s":""} ago`}if(re<86400){const Pe=Math.floor(re/3600);return`${Pe} hour${Pe!==1?"s":""} ago`}const xe=Math.floor(re/86400);return`${xe} day${xe!==1?"s":""} ago`}function ee(B){if(!B)return"";try{return new Date(B*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function fe(B){if(!B)return"";try{return new Date(B*1e3).toLocaleString()}catch{return""}}function Ee(B){return B==="user"?"bg-gray-900/50 border border-gray-800":B==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function F(B){return B==="user"?"sess-msg-user":B==="assistant"?"sess-msg-assistant":"sess-msg-system"}function ue(B){return B==="user"?"badge-info":B==="assistant"?"badge-success":"badge-warning"}function ne(B){return B==="user"?"sess-dot-user":B==="assistant"?"sess-dot-assistant":"sess-dot-system"}function pe(B){return B==="user"?"text-cyan-400":B==="assistant"?"text-indigo-400":"text-gray-500"}function be(B){return B?B.length>2e3?B.slice(0,2e3)+`
... (truncated)`:B:""}async function Ie(){const B=w.value.trim();if(B){R.value=!0;try{let re=`/api/sessions/search?q=${encodeURIComponent(B)}&limit=50`;N.value.trim()&&(re+=`&channel_id=${encodeURIComponent(N.value.trim())}`),O.value.trim()&&(re+=`&user_id=${encodeURIComponent(O.value.trim())}`);const xe=await q.get(re);S.value=xe.results||[]}catch{S.value=[]}R.value=!1}}function y(){w.value="",N.value="",O.value="",S.value=null}function C(B){return B?B.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function M(B){return B==="user"?"fts-result-user":B==="assistant"?"fts-result-assistant":B==="summary"?"fts-result-summary":B==="fts"?"fts-result-fts":B==="channel"?"fts-result-channel":"fts-result-default"}function W(B){return B==="user"?"badge-info":B==="assistant"?"badge-success":B==="summary"?"badge-warning":B==="fts"?"badge-success":"badge-info"}async function A(){t.value=!0,s.value=null;try{e.value=await q.get("/api/sessions")}catch(B){s.value=B.message}t.value=!1}function $(){s.value=null,A()}async function J(B){if(n.value===B){n.value=null,a.value=null,x.value=new Set;return}n.value=B,a.value=null,i.value=!0,x.value=new Set;try{a.value=await q.get(`/api/sessions/${encodeURIComponent(B)}`)}catch{a.value={messages:[],summary:""}}i.value=!1}function Q(B){const re=new Set(o.value);re.has(B)?re.delete(B):re.add(B),o.value=re}function te(){K.value?o.value=new Set:o.value=new Set(T.value.map(B=>B.channel_id))}function Y(B){l.value=B}async function me(){if(l.value){r.value=!0;try{await q.del(`/api/sessions/${encodeURIComponent(l.value)}`),n.value===l.value&&(n.value=null,a.value=null),o.value.delete(l.value),await A()}catch(B){s.value=B.message||"Failed to clear session"}r.value=!1,l.value=null}}function ae(){c.value=!0}async function de(){if(o.value.size!==0){r.value=!0;try{await q.post("/api/sessions/clear-bulk",{channel_ids:[...o.value]}),o.value.has(n.value)&&(n.value=null,a.value=null),o.value=new Set,await A()}catch(B){s.value=B.message||"Failed to clear sessions"}r.value=!1,c.value=!1}}function ye(B,re){const xe=q._token;let Pe=`/api/sessions/${encodeURIComponent(B)}/export?format=${re}`;xe&&(Pe+=`&token=${encodeURIComponent(xe)}`);const Je=document.createElement("a");Je.href=Pe,Je.download=`session-${B}.${re==="text"?"txt":"json"}`,document.body.appendChild(Je),Je.click(),document.body.removeChild(Je)}let _e=null;function Re(B){B.payload&&B.payload.channel_id&&(clearTimeout(_e),_e=setTimeout(()=>{A(),n.value&&B.payload.channel_id===n.value&&q.get(`/api/sessions/${encodeURIComponent(n.value)}`).then(re=>{a.value=re}).catch(()=>{})},2e3))}return Be(()=>{L(),A(),Ge.subscribe("events",Re)}),ht(()=>{Ge.unsubscribe("events",Re),clearTimeout(_e)}),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:l,clearing:r,selected:o,allSelected:K,bulkClearing:c,activePreset:u,searchQuery:d,sortBy:f,sortAsc:p,filterPresets:m,sortOptions:g,filteredSessions:T,hasActiveFilters:P,customPresets:k,showSavePreset:E,newPresetName:b,threadView:v,threads:U,collapsedThreads:x,ftsQuery:w,ftsChannelId:N,ftsUserId:O,ftsResults:S,ftsSearching:R,formatAge:he,formatTimestamp:ee,formatFullTimestamp:fe,messageClass:Ee,threadMsgClass:F,roleBadge:ue,roleDotClass:ne,roleLabelClass:pe,truncateContent:be,threadSummary:G,fetchSessions:A,retry:$,toggleSession:J,toggleSelect:Q,toggleSelectAll:te,confirmClear:Y,clearSession:me,confirmBulkClear:ae,doBulkClear:de,exportSession:ye,applyPreset:I,applyCustomPreset:j,saveCustomPreset:ce,removeCustomPreset:oe,resetFilters:se,toggleThread:D,runFtsSearch:Ie,clearFtsSearch:y,highlightSnippet:C,ftsResultClass:M,ftsTypeBadge:W}}},uw={props:["trace"],template:`
  ...
  `,setup(){return{formatTokens:M_}}},dw={components:{ContextAssemblyPanel:uw},template:`
    ...
    </div>`,setup(){const e=h([]),t=h([]),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=h(""),o=h(0),c=h({}),u=h({channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50});function d(O){if(!O)return"—";try{const S=new Date(O);return isNaN(S.getTime())?O:S.toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return O}}function f(O){return!O&&O!==0?"—":O<1e3?O+"ms":(O/1e3).toFixed(1)+"s"}function p(O){return!O&&O!==0?"—":O>=1e3?(O/1e3).toFixed(1)+"k":String(O)}function m(O){if(!O)return"";if(typeof O=="string")return O;try{return JSON.stringify(O,null,2)}catch{return String(O)}}function g(O){a.value===O?a.value=null:(a.value=O,c.value={})}function k(O,S){const R=O+"-"+S;c.value={...c.value,[R]:!c.value[R]}}function E(O,S){return!!c.value[O+"-"+S]}function b(){u.value={channel_id:"",user_id:"",tool_name:"",errors_only:!1,limit:50},r.value="",l.value="",i.value=null,w()}async function v(){try{const O=await q.get("/api/trajectories");e.value=O.files||[],o.value=O.count||0}catch{}}let x=0;async function w(){const O=++x;s.value=!0,n.value=null,a.value=null,i.value=null,c.value={};try{if(r.value){const S=await q.get(`/api/trajectories/${encodeURIComponent(r.value)}?limit=${u.value.limit}`);if(O!==x)return;let R=S.entries||[];u.value.tool_name&&(R=R.filter(L=>(L.tools_used||[]).includes(u.value.tool_name))),u.value.errors_only&&(R=R.filter(L=>L.is_error)),u.value.channel_id&&(R=R.filter(L=>L.channel_id===u.value.channel_id)),u.value.user_id&&(R=R.filter(L=>L.user_id===u.value.user_id)),t.value=R}else{const S=new URLSearchParams;u.value.channel_id&&S.set("channel_id",u.value.channel_id),u.value.user_id&&S.set("user_id",u.value.user_id),u.value.tool_name&&S.set("tool_name",u.value.tool_name),u.value.errors_only&&S.set("errors_only","true"),S.set("limit",String(u.value.limit));const R=S.toString(),L=await q.get(`/api/trajectories/search/query?${R}`);if(O!==x)return;t.value=L.results||[]}}catch(S){if(O!==x)return;n.value=S.message}O===x&&(s.value=!1)}async function N(){if(!l.value.trim())return;const O=++x;s.value=!0,n.value=null,c.value={};try{const S=await q.get(`/api/trajectories/message/${encodeURIComponent(l.value.trim())}`);if(O!==x)return;i.value=S.entry||null,i.value||(n.value="No trace found for this message ID")}catch(S){if(O!==x)return;S.status===404?(i.value=null,n.value="No trace found for message ID: "+l.value):n.value=S.message}O===x&&(s.value=!1)}return Be(async()=>{await v(),await w()}),{files:e,entries:t,loading:s,error:n,expandedIdx:a,singleTrace:i,messageIdQuery:l,selectedFile:r,totalSaved:o,filters:u,expandedIterations:c,formatTs:d,formatDuration:f,formatTokens:p,formatJSON:m,truncateBlock:Xh,toggleExpand:g,toggleIteration:k,isIterationExpanded:E,clearFilters:b,fetchFiles:v,fetchTraces:w,lookupMessage:N}}},fw={template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),n=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),a=h("user");let i=null;const l=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],r=X(()=>[...s.value.recent||[]].reverse()),o=async()=>{try{const u=await q.get("/api/usage");s.value=u,n.value=u.totals||n.value,t.value=null}catch(u){t.value=u.message}finally{e.value=!1}},c=()=>{e.value=!0,o()};return Be(()=>{o(),i=setInterval(o,15e3)}),ht(()=>{i&&clearInterval(i)}),{loading:e,error:t,data:s,totals:n,activeTab:a,tabs:l,recentReversed:r,fmtNum:eg,formatTime:Cc,retry:c}}},pw={components:{TabbedPage:dr},setup(){return{tabs:[{id:"audit",label:"Audit",component:rw},{id:"sessions",label:"Sessions",component:cw},{id:"traces",label:"Traces",component:dw},{id:"usage",label:"Usage",component:fw}]}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},Ur=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],hw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),r=h(null),o=X(()=>e.value.filter(b=>b.is_core).length),c=X(()=>e.value.filter(b=>!b.is_core).length),u=X(()=>Object.values(a.value).reduce((b,v)=>b+v,0));function d(b){for(const v of Ur)if(v.id!=="other"&&v.match(b))return v.id;return"other"}const f=X(()=>{let b=e.value;if(n.value){const v=n.value.toLowerCase();b=b.filter(x=>x.name.toLowerCase().includes(v)||(x.description||"").toLowerCase().includes(v))}return r.value&&(b=b.filter(v=>d(v.name)===r.value)),b}),p=X(()=>{const b=new Set;for(const v of e.value)b.add(d(v.name));return Ur.filter(v=>b.has(v.id))}),m=X(()=>{const b=f.value,v={};for(const w of b){const N=d(w.name);v[N]||(v[N]=[]),v[N].push(w)}const x=[];for(const w of Ur)v[w.id]&&v[w.id].length>0&&x.push({label:w.label,icon:w.icon,tools:v[w.id].sort((N,O)=>N.name.localeCompare(O.name))});return x});function g(b){i.value={...i.value,[b]:!i.value[b]}}async function k(){t.value=!0,s.value=null;try{const[b,v]=await Promise.all([q.get("/api/tools"),q.get("/api/tools/stats").catch(()=>({}))]);e.value=b,a.value=v||{};const x=Object.values(v||{}).filter(w=>w>0).sort((w,N)=>w-N)}catch(b){s.value=b.message}t.value=!1}function E(){k()}return Be(()=>{k()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:r,coreCount:o,skillCount:c,totalUsage:u,filteredTools:f,groupedTools:m,usedCategories:p,truncate:Ec,toggleExpand:g,refresh:E}}};function gw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function mw(e){if(!e)return"1";const t=e.split(`
...
`)}const vw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),r=h(null),o=h(!1),c=h("create"),u=h(""),d=h(""),f=h(null),p=h(null),m=h(!1),g=h(null),k=h(null),E=h(!1),b=X(()=>e.value.length),v=X(()=>e.value.reduce((ee,fe)=>ee+(fe.execution_count||0),0)),x=X(()=>e.value.reduce((ee,fe)=>ee+L(fe.code),0)),w=X(()=>{if(!l.value)return e.value;const ee=l.value.toLowerCase();return e.value.filter(fe=>fe.name.toLowerCase().includes(ee)||(fe.description||"").toLowerCase().includes(ee))}),N=X(()=>d.value?d.value.split(`
`).length:0),O=X(()=>{const ee=Math.max(N.value,1);return Array.from({length:ee},(fe,Ee)=>Ee+1).join(`
`)}),S=X(()=>{const ee=d.value.trim();return ee?ee.includes("SKILL_DEFINITION")?ee.includes("async def execute")?{valid:!0,message:""}:{valid:!1,message:"Missing async def execute function"}:{valid:!1,message:"Missing SKILL_DEFINITION dict"}:null});function R(ee){return gw(ee)}function L(ee){return ee?ee.split(`
`).length:0}function H(ee){return mw(ee)}function P(ee){n.value={...n.value,[ee]:!n.value[ee]}}async function T(ee){try{await navigator.clipboard.writeText(ee);const fe=e.value.find(Ee=>Ee.code===ee);fe&&(r.value=fe.name,setTimeout(()=>{r.value=null},2e3))}catch{}}function U(ee){if(ee.key==="Tab"){ee.preventDefault();const fe=ee.target,Ee=fe.selectionStart,F=fe.selectionEnd;d.value=d.value.substring(0,Ee)+"    "+d.value.substring(F),Et(()=>{fe.selectionStart=fe.selectionEnd=Ee+4})}}function K(ee){const fe=ee.target.previousElementSibling;fe&&(fe.scrollTop=ee.target.scrollTop)}async function G(){t.value=!0,s.value=null;try{e.value=await q.get("/api/skills")}catch(ee){s.value=ee.message}t.value=!1}async function D(ee){i.value=ee,delete a.value[ee],a.value={...a.value};try{const fe=await q.post(`/api/skills/${encodeURIComponent(ee)}/test`);a.value={...a.value,[ee]:fe}}catch(fe){a.value={...a.value,[ee]:{result:fe.message,is_error:!0}}}i.value=null}function I(){o.value=!0,c.value="create",u.value="",d.value="",f.value=null,p.value=null}function j(ee){o.value=!0,c.value="edit",u.value=ee.name,d.value=ee.code||"",f.value=null,p.value=null}function ce(){o.value=!1,f.value=null,p.value=null}async function oe(){f.value=null,p.value=null;const ee=u.value.trim(),fe=d.value.trim();if(!ee){f.value="Name is required";return}if(!fe){f.value="Code is required";return}m.value=!0;try{c.value==="create"?(await q.post("/api/skills",{name:ee,code:fe}),p.value="Skill created successfully"):(await q.put(`/api/skills/${encodeURIComponent(ee)}`,{code:fe}),p.value="Skill updated successfully"),await G(),setTimeout(()=>{o.value=!1},800)}catch(Ee){f.value=Ee.message}m.value=!1}function se(ee){k.value=ee}async function he(){if(k.value){E.value=!0;try{await q.del(`/api/skills/${encodeURIComponent(k.value)}`),await G()}catch{}E.value=!1,k.value=null}}return Be(()=>{G()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:r,editing:o,editMode:c,editName:u,editCode:d,editError:f,editSuccess:p,saving:m,editorRef:g,deleteTarget:k,deleting:E,enabledCount:b,totalExecutions:v,totalLines:x,displayedSkills:w,editLineCount:N,editorLineNums:O,editValidation:S,highlight:R,truncate:Ec,formatTs:La,countLines:L,getLineNumbers:H,toggleCode:P,copyCode:T,handleEditorKey:U,syncScroll:K,fetchSkills:G,testSkill:D,showCreate:I,editSkill:j,cancelEdit:ce,saveSkill:oe,confirmDelete:se,doDelete:he}}};function bw(e,t){if(!e||!t)return kd(e);const s=kd(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const yw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),r=h(null),o=h(!1),c=h(""),u=h(""),d=h(null),f=h(null),p=h(!1),m=h(null),g=h(null);let k=null;const E=h(null),b=h(!1),v=h({}),x=h({}),w=h(null),N=h(null),O=X(()=>e.value.reduce((I,j)=>I+(j.chunks||0),0)),S=X(()=>new Set(e.value.map(j=>j.uploader).filter(Boolean)).size);function R(I,j){const ce=x.value[j];if(!ce||ce.length===0)return 0;const oe=Math.max(...ce.map(se=>se.char_count||0));return oe===0?0:Math.round(I.char_count/oe*100)}async function L(){t.value=!0,s.value=null;try{const I=await q.get("/api/knowledge");e.value=Array.isArray(I)?I:[]}catch(I){s.value=I.message}t.value=!1}async function H(I){if(v.value[I]){v.value[I]=!1,N.value=null;return}if(v.value[I]=!0,!(x.value[I]||w.value===I)){w.value=I;try{const j=await q.get(`/api/knowledge/${encodeURIComponent(I)}/chunks`);x.value[I]=Array.isArray(j)?j:[]}catch(j){x.value[I]=[],ke.error(`Failed to load chunks: ${j.message}`)}w.value=null}}async function P(){const I=n.value.trim();if(I){i.value=!0,r.value=null,l.value=I;try{const j=await q.get(`/api/knowledge/search?q=${encodeURIComponent(I)}`);a.value=Array.isArray(j)?j:[]}catch(j){a.value=[],r.value=j.message||"Search failed"}i.value=!1}}function T(){a.value=null,n.value="",r.value=null}async function U(){d.value=null,f.value=null;const I=c.value.trim(),j=u.value.trim();if(!I){d.value="Source name is required";return}if(!j){d.value="Content is required";return}p.value=!0;try{const ce=await q.post("/api/knowledge",{source:I,content:j});f.value=`Ingested ${ce.chunks||0} chunks from "${I}"`,c.value="",u.value="",x.value={},await L(),setTimeout(()=>{o.value=!1,f.value=null},1500)}catch(ce){d.value=ce.message}p.value=!1}async function K(I){m.value=I,g.value=null,k&&(clearTimeout(k),k=null);try{const j=await q.post(`/api/knowledge/${encodeURIComponent(I)}/reingest`);g.value={source:I,error:!1,message:`Re-ingested ${j.chunks||0} chunks`},delete x.value[I],await L(),k=setTimeout(()=>{g.value=null,k=null},3e3)}catch(j){g.value={source:I,error:!0,message:j.message}}m.value=null}function G(I){E.value=I}async function D(){if(E.value){b.value=!0;try{await q.del(`/api/knowledge/${encodeURIComponent(E.value)}`),delete x.value[E.value],await L()}catch{}b.value=!1,E.value=null}}return Be(()=>{L()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:r,showIngest:o,ingestSource:c,ingestContent:u,ingestError:d,ingestSuccess:f,ingesting:p,reingesting:m,reingestResult:g,deleteTarget:E,deleting:b,expanded:v,sourceChunks:x,loadingChunks:w,selectedChunk:N,totalChunks:O,uploaderCount:S,truncate:Ec,formatTs:La,highlightTerms:bw,chunkBarWidth:R,fetchSources:L,toggleSource:H,doSearch:P,clearSearch:T,doIngest:U,doReingest:K,confirmDelete:G,doDelete:D}}},xw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),r=h(!1),o=h({scope:"global",key:"",value:""}),c=h(!1),u=h(null),d=h(null),f=h(null),p=h(""),m=h(!1),g=h(null),k=h(null),E=h(new Set),b=h(null),v=h(!1),x=h(!1),w=X(()=>e.value.reduce((se,he)=>se+he.count,0)),N=X(()=>E.value.size);function O(se){const he=t.value[se];if(!he)return[];if(!l.value.trim())return he;const ee=l.value.trim().toLowerCase();return he.filter(fe=>fe.key.toLowerCase().includes(ee)||fe.value&&fe.value.toLowerCase().includes(ee))}function S(se,he){return E.value.has(se+"/"+he)}function R(se,he){const ee=se+"/"+he,fe=new Set(E.value);fe.has(ee)?fe.delete(ee):fe.add(ee),E.value=fe}function L(se){const he=t.value[se];return!he||he.length===0?!1:he.every(ee=>E.value.has(se+"/"+ee.key))}function H(se,he){const ee=t.value[se];if(!ee)return;const fe=new Set(E.value);for(const Ee of ee){const F=se+"/"+Ee.key;he?fe.add(F):fe.delete(F)}E.value=fe}async function P(){s.value=!0,n.value=null;try{const se=await q.get("/api/memory");e.value=Object.entries(se).map(([he,ee])=>({name:he,keys:ee.keys||[],count:ee.count||0}))}catch(se){n.value=se.message}s.value=!1}async function T(se){if(a.value[se]){a.value[se]=!1;return}a.value[se]=!0;const he=e.value.find(fe=>fe.name===se);if(!he||t.value[se]||i.value===se)return;i.value=se;const ee=await Promise.all(he.keys.map(async fe=>{try{const Ee=await q.get(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(fe)}`);return{key:fe,value:Ee.value||""}}catch{return{key:fe,value:"(error loading)"}}}));t.value[se]=ee,i.value=null}function U(se,he,ee){f.value=se+"/"+he,p.value=ee}async function K(se,he){m.value=!0,g.value=null;try{await q.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(he)}`,{value:p.value});const ee=t.value[se];if(ee){const fe=ee.find(Ee=>Ee.key===he);fe&&(fe.value=p.value)}f.value=null}catch(ee){g.value=`Failed to save: ${ee.message||"unknown error"}`}m.value=!1}async function G(se,he){try{await navigator.clipboard.writeText(he.value),k.value=se+"/"+he.key,setTimeout(()=>{k.value=null},1500)}catch{}}async function D(){u.value=null,d.value=null;const se=o.value.scope.trim(),he=o.value.key.trim(),ee=o.value.value.trim();if(!se){u.value="Scope is required";return}if(!he){u.value="Key is required";return}if(!ee){u.value="Value is required";return}c.value=!0;try{await q.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(he)}`,{value:ee}),d.value="Entry saved",o.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{r.value=!1,d.value=null},800)}catch(fe){u.value=fe.message}c.value=!1}function I(se,he){b.value={scope:se,key:he}}async function j(){if(!b.value)return;v.value=!0,g.value=null;const{scope:se,key:he}=b.value;try{await q.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(he)}`);const ee=t.value[se];ee&&(t.value[se]=ee.filter(F=>F.key!==he));const fe=e.value.find(F=>F.name===se);fe&&(fe.count--,fe.keys=fe.keys.filter(F=>F!==he));const Ee=new Set(E.value);Ee.delete(se+"/"+he),E.value=Ee}catch(ee){g.value=`Failed to delete: ${ee.message||"unknown error"}`}v.value=!1,b.value=null}function ce(){x.value=!0}async function oe(){v.value=!0,g.value=null;const se=[];for(const he of E.value){const ee=he.indexOf("/");se.push({scope:he.slice(0,ee),key:he.slice(ee+1)})}try{await q.post("/api/memory/bulk-delete",{entries:se}),E.value=new Set,t.value={},await P()}catch(he){g.value=`Bulk delete failed: ${he.message||"unknown error"}`}v.value=!1,x.value=!1}return Be(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:r,addForm:o,adding:c,addError:u,addSuccess:d,editingKey:f,editValue:p,saving:m,actionError:g,copied:k,selected:E,selectedCount:N,totalEntries:w,deleteTarget:b,deleting:v,showBulkDelete:x,fetchMemory:P,toggleScope:T,startEdit:U,doEdit:K,copyValue:G,doAdd:D,confirmDelete:I,doDelete:j,confirmBulkDelete:ce,doBulkDelete:oe,isSelected:S,toggleSelect:R,isScopeAllSelected:L,toggleSelectAll:H,filteredEntries:O}}},_w={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h([]),t=h(null),s=h(!0),n=h(null),a=h(null),i=h(null),l=h(""),r=X(()=>[...new Set(e.value.map(k=>k.category))].sort()),o=X(()=>{const g={};return e.value.forEach(k=>{g[k.category]=(g[k.category]||0)+1}),g}),c=X(()=>a.value?e.value.filter(g=>g.category===a.value):e.value);function u(g){return g==="correction"?"badge-warning":g==="operational"?"badge-info":g==="preference"?"badge-success":"badge-info"}function d(g){i.value=g.key,l.value=g.content}async function f(g){try{await q.put("/api/learned/"+encodeURIComponent(g),{content:l.value}),i.value=null,ke.success("Entry updated"),await m()}catch(k){ke.error(k.message||"Failed to save entry")}}async function p(g){if(await ls({title:"Delete learned entry",message:`Delete "${g}"? Odin will no longer apply this learned context.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/learned/"+encodeURIComponent(g)),ke.success("Entry deleted"),await m()}catch(E){ke.error(E.message||"Failed to delete entry")}}async function m(){s.value=!0,n.value=null;try{const g=await q.get("/api/learned");e.value=g.entries||[],t.value={last_reflection:g.last_reflection,count:g.count}}catch(g){n.value=g.message}s.value=!1}return Be(m),{entries:e,meta:t,loading:s,error:n,filterCat:a,editing:i,editContent:l,categories:r,catCounts:o,filtered:c,catBadge:u,formatTs:La,startEdit:d,saveEdit:f,deleteEntry:p,fetchEntries:m}}},kw={components:{TabbedPage:dr},setup(){return{tabs:[{id:"tools",label:"Tools",component:hw},{id:"skills",label:"Skills",component:vw},{id:"knowledge",label:"Knowledge",component:yw},{id:"memory",label:"Memory",component:xw},{id:"learned",label:"Learned",component:_w}]}},template:'<tabbed-page :tabs="tabs" default-tab="tools" group-label="Capabilities" />'},ww={setup(){const e=h("odin"),t=h(""),s=h(""),n=h(""),a=h({}),i=h([]),l=h([]),r=h(!1),o=h(!1),c=h(null),u=h(!0),d=h(""),f=h(!1),p=h(!1),m=X(()=>e.value==="custom"),g=X(()=>[...i.value,...l.value]),k=X(()=>l.value.includes(e.value)),E=X(()=>{var S;return m.value?t.value||"Odin":((S=a.value[e.value])==null?void 0:S.name)||e.value}),b=X(()=>{var S;return m.value?s.value||"(empty — will use Odin default)":((S=a.value[e.value])==null?void 0:S.identity)||""}),v=X(()=>{var S;return m.value?n.value||"(empty — will use Odin default)":((S=a.value[e.value])==null?void 0:S.voice)||""});async function x(){u.value=!0;try{const S=await q.get("/api/personality");e.value=S.preset||"odin",t.value=S.custom_name||"",s.value=S.custom_identity||"",n.value=S.custom_voice||"",a.value=S.presets||{},i.value=S.builtin_presets||[],l.value=S.user_presets||[]}catch(S){c.value=S.message}finally{u.value=!1}}async function w(){r.value=!0,c.value=null,o.value=!1;try{await q.put("/api/personality",{preset:e.value,custom_name:t.value,custom_identity:s.value,custom_voice:n.value}),o.value=!0,setTimeout(()=>o.value=!1,3e3)}catch(S){c.value=S.message}finally{r.value=!1}}async function N(){const S=d.value.trim();if(S){p.value=!0,c.value=null;try{await q.post("/api/personality/presets",{name:S,display_name:E.value,identity:b.value,voice:v.value}),f.value=!1,d.value="",await x(),e.value=S.toLowerCase().replace(/ /g,"_")}catch(R){c.value=R.message}finally{p.value=!1}}}async function O(){if(await ls({title:"Delete preset",message:`Delete preset "${e.value}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){c.value=null;try{await q.del(`/api/personality/presets/${encodeURIComponent(e.value)}`),await x(),e.value="odin"}catch(R){c.value=R.message}}}return Be(x),{preset:e,customName:t,customIdentity:s,customVoice:n,presets:a,presetNames:g,isCustom:m,isUserPreset:k,previewName:E,previewIdentity:b,previewVoice:v,saving:r,saved:o,error:c,loading:u,save:w,showSavePreset:f,newPresetName:d,savingPreset:p,saveAsPreset:N,deletePreset:O,builtinPresets:i,userPresets:l}},template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h("sessions"),a=h(null);let i=null;const l=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=X(()=>{if(!a.value||!a.value.collected_at)return"";try{return new Date(a.value.collected_at).toLocaleTimeString()}catch{return""}}),o=X(()=>{if(!a.value)return[];const f=a.value,p=f.storage_total_bytes||1;return[{label:"Session Persistence",mb:f.sessions.persist_dir.total_mb,bytes:f.sessions.persist_dir.total_bytes,files:f.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(f.sessions.persist_dir.total_bytes/p*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:f.knowledge.db_file.total_mb,bytes:f.knowledge.db_file.total_bytes,files:f.knowledge.db_file.file_count,pct:Math.min(100,Math.round(f.knowledge.db_file.total_bytes/p*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:f.trajectories.message_dir.total_mb,bytes:f.trajectories.message_dir.total_bytes,files:f.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.message_dir.total_bytes/p*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:f.trajectories.agent_dir.total_mb,bytes:f.trajectories.agent_dir.total_bytes,files:f.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(f.trajectories.agent_dir.total_bytes/p*100)),color:"res-bar-amber"}]});async function c(){try{const f=await q.get("/api/resource-usage");a.value=f,t.value=null}catch(f){t.value=f.message||"Failed to load resource usage"}finally{e.value=!1,s.value=!1}}async function u(){s.value=!0,await c()}function d(){e.value=!0,t.value=null,c()}return Be(()=>{c(),i=setInterval(c,3e4)}),ht(()=>{i&&clearInterval(i)}),{loading:e,error:t,refreshing:s,data:a,activeTab:n,tabs:l,collectedAt:r,storageItems:o,fmtNum:eg,refresh:u,retry:d}}},Rw=["INFO","WARNING","ERROR"],Iw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],Br=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Nw=[50,100,200,500],Ow={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),r=h(!1),o=h(Ge.state||"disconnected"),c=X(()=>{switch(o.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),u=h(null),d=h(!1),f=h(null),p=2e3,m=Rw,g=Iw,k=Br,E=h("all"),b=h(""),v=h([]),x=h(!1),w=h(""),N=h([]);function O(){try{const V=localStorage.getItem("odin-log-presets");V&&(v.value=JSON.parse(V))}catch{}}function S(){try{localStorage.setItem("odin-log-presets",JSON.stringify(v.value))}catch{}}const R=X(()=>a.value!==""||i.value.trim()!==""||b.value!==""),L=X(()=>{const V=Br.find(ie=>ie.value===b.value);return V?V.label:""}),H=X(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(V){return V.message}}),P=24,T=X(()=>{if(t.value.length===0)return[];const V=[],ie=new Date,Te=3600*1e3;for(let qe=P-1;qe>=0;qe--){const rt=new Date(ie.getTime()-(qe+1)*Te),Zt=new Date(ie.getTime()-qe*Te);V.push({start:rt,end:Zt,label:D(rt,Zt),shortLabel:Zt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const qe of t.value){if(!qe._time)continue;const rt=qe._time.getTime();for(const Zt of V)if(rt>=Zt.start.getTime()&&rt<Zt.end.getTime()){Zt.total++,qe.level==="ERROR"?Zt.errors++:qe.level==="WARNING"?Zt.warnings++:Zt.info++;break}}return V}),U=X(()=>{let V=1;for(const ie of T.value)ie.total>V&&(V=ie.total);return V}),K=X(()=>T.value.length===0?"":"Last 24 hours"),G=X(()=>Math.ceil(P/8));function D(V,ie){const Te={hour:"2-digit",minute:"2-digit"};return V.toLocaleTimeString([],Te)+" - "+ie.toLocaleTimeString([],Te)}function I(V,ie){return!ie||!V?"0px":Math.max(2,V/ie*100)+"%"}function j(V){const ie=ce.value.findIndex(Te=>Te._time&&Te._time.getTime()>=V.start.getTime()&&Te._time.getTime()<V.end.getTime());if(ie>=0&&u.value){const Te=u.value.querySelectorAll(".log-line");Te[ie]&&(Te[ie].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const ce=X(()=>{let V=t.value;if(a.value&&(V=V.filter(ie=>(ie.level||"INFO")===a.value)),b.value){const ie=Br.find(Te=>Te.value===b.value);if(ie&&ie.seconds){const Te=new Date(Date.now()-ie.seconds*1e3);V=V.filter(qe=>qe._time&&qe._time>=Te)}}if(i.value&&!H.value)if(l.value)try{const ie=new RegExp(i.value,"i");V=V.filter(Te=>{const qe=Te.text||Te.raw||"",rt=Te.tool||"";return ie.test(qe)||ie.test(rt)})}catch{}else{const ie=i.value.toLowerCase();V=V.filter(Te=>{const qe=(Te.text||Te.raw||"").toLowerCase(),rt=(Te.tool||"").toLowerCase();return qe.includes(ie)||rt.includes(ie)})}return V});function oe(V){if(V.type==="log"&&V.line)try{const ie=typeof V.line=="string"?JSON.parse(V.line):V.line,Te=ie.timestamp?new Date(ie.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ie.error?"ERROR":"INFO",text:ie.tool_name?`[${ie.tool_name}] ${ie.result_summary||""}`.trim():ie.message||JSON.stringify(ie),tool:ie.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(V.line),tool:"",raw:String(V.line)}}if(V.payload){const ie=V.payload,Te=ie.timestamp?new Date(ie.timestamp):new Date;return{ts:Te.toLocaleTimeString(),_time:Te,level:ie.error?"ERROR":"INFO",text:ie.tool_name?`[${ie.tool_name}] ${ie.result_summary||""}`.trim():ie.message||JSON.stringify(ie),tool:ie.tool_name||"",raw:null}}return typeof V=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:V,tool:"",raw:V}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(V),tool:"",raw:null}}function se(V){const ie=oe(V);if(s.value){N.value.push(ie);return}he(ie)}function he(V){t.value.push(V),t.value.length>p&&(t.value=t.value.slice(-p)),n.value&&Et(()=>ee())}function ee(){const V=u.value;if(V){const ie=V.scrollHeight-V.scrollTop-V.clientHeight;V.scrollTo({top:V.scrollHeight,behavior:ie<500?"smooth":"instant"})}}function fe(){n.value=!0,d.value=!1,Et(()=>ee())}function Ee(){const V=u.value;if(!V)return;const ie=V.scrollHeight-V.scrollTop-V.clientHeight<40;d.value=!ie&&t.value.length>0,!ie&&n.value&&(n.value=!1)}function F(){if(s.value=!s.value,!s.value&&N.value.length>0){for(const V of N.value)he(V);N.value=[]}}function ue(){t.value=[],N.value=[],d.value=!1}function ne(){let V;e.value==="search"?V=re.value.map(rt=>{const Zt=rt.error?"ERROR":"INFO",it=rt.tool_name?`[${rt.tool_name}] `:"";return`${rt.timestamp||""} ${Zt} ${it}${rt.result_summary||rt.message||""}`}).join(`
`):V=ce.value.map(rt=>`${rt.ts} ${rt.level} ${rt.text}`).join(`
`);const ie=new Blob([V],{type:"text/plain"}),Te=URL.createObjectURL(ie),qe=document.createElement("a");qe.href=Te,qe.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,qe.click(),URL.revokeObjectURL(Te)}function pe(V,ie){const Te=`${V.ts} ${V.level} ${V.text||V.raw||""}`;navigator.clipboard.writeText(Te).then(()=>{f.value=ie,setTimeout(()=>{f.value=null},1500)}).catch(()=>{})}function be(V){a.value=a.value===V?"":V,E.value="all"}function Ie(V){return V.level==="ERROR"?"log-line-error":V.level==="WARNING"?"log-line-warning":"text-gray-300"}function y(V){return V==="ERROR"?"text-red-500 font-semibold":V==="WARNING"?"text-yellow-500":"text-blue-500"}function C(V){return V==="ERROR"?"log-chip-error":V==="WARNING"?"log-chip-warning":"log-chip-info"}function M(V){E.value=V.id;const ie=V.filters;a.value=ie.level||"",b.value=ie.timeRange||"",i.value=ie.text||"",ie.levels&&(a.value=ie.levels[0]||""),ie.hasToolName&&(i.value="")}function W(V){E.value=V.id,a.value=V.filters.level||"",b.value=V.filters.timeRange||"",i.value=V.filters.text||""}function A(){if(!w.value.trim())return;const V={id:"custom-"+Date.now(),name:w.value.trim(),filters:{level:a.value,timeRange:b.value,text:i.value}};v.value=[...v.value,V],S(),x.value=!1,w.value=""}function $(V){v.value=v.value.filter(ie=>ie.id!==V),S(),E.value===V&&(E.value="all")}const J=h("all"),Q=h(""),te=h(""),Y=h(""),me=h(""),ae=h(""),de=h(100),ye=Nw,_e=h(!1),Re=h(!1),B=h(""),re=h([]),xe=h(null),Pe=h(null);function Je(){e.value="search",xe.value||Ze()}async function Ze(){try{xe.value=await q.get("/api/logs/stats")}catch{}}function xt(){const V=ae.value;if(!V){Y.value="",me.value="";return}const Te={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[V];if(Te){const qe=new Date(Date.now()-Te*1e3);Y.value=et(qe),me.value=""}}function et(V){const ie=Te=>String(Te).padStart(2,"0");return`${V.getFullYear()}-${ie(V.getMonth()+1)}-${ie(V.getDate())}T${ie(V.getHours())}:${ie(V.getMinutes())}`}function Ye(V){if(!V)return"";const ie=new Date(V);return isNaN(ie.getTime())?"":ie.toISOString()}async function Ss(){_e.value=!0,B.value="",Re.value=!0,Pe.value=null;try{const V=new URLSearchParams;J.value&&J.value!=="all"&&V.set("level",J.value),Q.value&&V.set("tool",Q.value),te.value&&V.set("q",te.value);const ie=Ye(Y.value),Te=Ye(me.value);ie&&V.set("start",ie),Te&&V.set("end",Te),V.set("limit",String(de.value));const qe=await q.get(`/api/logs/search?${V.toString()}`);re.value=qe.entries||[]}catch(V){B.value=V.message||"Search failed",re.value=[]}finally{_e.value=!1}}function Z(){J.value="all",Q.value="",te.value="",Y.value="",me.value="",ae.value="",de.value=100,re.value=[],Re.value=!1,B.value="",Pe.value=null}function Le(V){Pe.value=Pe.value===V?null:V}function Ts(V){if(!V.timestamp)return"";try{return new Date(V.timestamp).toLocaleString()}catch{return V.timestamp}}function Gn(V){return V.type==="web_action"?`${V.status||""} (${V.execution_time_ms||0}ms)`:(V.result_summary||"").slice(0,200)}function Wn(V){return V.error?"log-line-error":"text-gray-300"}function Zn(V){try{return JSON.stringify(V,null,2)}catch{return String(V)}}let Dt=null,vs=null,rn=!1;function Da(){rn||(rn=!0,Ge.subscribe("logs",se),r.value=Ge.connected,o.value=Ge.state||"disconnected",Dt=Ge.onStateChange,vs=(V,ie)=>{o.value=V,r.value=V==="connected",Dt&&Dt(V,ie)},Ge.onStateChange=vs)}function Mi(){rn&&(rn=!1,Ge.unsubscribe("logs",se),Ge.onStateChange===vs&&(Ge.onStateChange=Dt),vs=null,Dt=null)}return Be(O),Uo(Da),Bo(Mi),ht(Mi),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:r,wsState:o,wsStateLabel:c,logContainer:u,filteredLogs:ce,pauseBuffer:N,showJumpBottom:d,copiedIndex:f,regexError:H,levels:m,logPresets:g,timeRanges:k,timeRange:b,activeLogPreset:E,customLogPresets:v,showSaveLogPreset:x,newLogPresetName:w,hasActiveLogFilters:R,timeRangeLabel:L,timelineBuckets:T,timelineMax:U,timelineSpanLabel:K,timelineLabelSkip:G,togglePause:F,clearLogs:ue,exportLogs:ne,logLineClass:Ie,levelClass:y,levelChipClass:C,toggleLevel:be,copyLine:pe,jumpToBottom:fe,onScroll:Ee,applyLogPreset:M,applyCustomLogPreset:W,saveLogCustomPreset:A,removeLogCustomPreset:$,segmentHeight:I,jumpToTimelineBucket:j,searchLevel:J,searchTool:Q,searchKeyword:te,searchStart:Y,searchEnd:me,searchTimePreset:ae,searchLimit:de,searchLimits:ye,searching:_e,searchRan:Re,searchError:B,searchResults:re,searchStats:xe,expandedSearch:Pe,switchToSearch:Je,runSearch:Ss,clearSearchFilters:Z,toggleSearchExpand:Le,formatSearchTs:Ts,searchEntryText:Gn,searchLogLineClass:Wn,formatJson:Zn,applySearchTimePreset:xt}}},Lw=new Set(["token","api_token","secret","ssh_key_path","credentials_path","api_key","password"]),Dw={"logging.level":["DEBUG","INFO","WARNING","ERROR","CRITICAL"]},Mw={"discord.allowed_users":{type:"array",itemType:"string",message:"Must be a list of user IDs"},"discord.channels":{type:"array",itemType:"string",message:"Must be a list of channel IDs"},"openai_codex.max_tokens":{type:"number",min:1,max:128e3,message:"Must be 1–128000"},"sessions.max_history":{type:"number",min:1,max:1e4,message:"Must be 1–10000"},"sessions.max_age_hours":{type:"number",min:1,message:"Must be at least 1"},"learning.max_entries":{type:"number",min:1,message:"Must be at least 1"},"learning.consolidation_target":{type:"number",min:1,message:"Must be at least 1"},"browser.default_timeout_ms":{type:"number",min:100,message:"Must be at least 100ms"},"browser.viewport_width":{type:"number",min:100,max:7680,message:"Must be 100–7680"},"browser.viewport_height":{type:"number",min:100,max:4320,message:"Must be 100–4320"},"tools.command_timeout_seconds":{type:"number",min:10,max:3600,message:"Must be 10–3600 seconds"}},Hr=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","discord","logging","permissions","personality","graceful_degradation"]},{key:"llm",label:"LLM & AI",icon:"brain",sections:["llm_provider","openai_codex","ollama","kimi","context","agents"]},{key:"data",label:"Data & Storage",icon:"database",sections:["sessions","learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","mcp","slack"]},{key:"infra",label:"Infrastructure",icon:"server",sections:["tools"]},{key:"ui",label:"Web UI",icon:"globe",sections:["web"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks"]},{key:"integrations",label:"Integrations",icon:"puzzle",sections:["issue_tracker"]}],gg="••••••••",Pw=50;function Fw(e){return Lw.has(e)}function $w(e){return e===gg}function Qi(e){return JSON.parse(JSON.stringify(e))}function Fn(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Uw(e,t){const s={};for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Fn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i)){const l={};for(const r of Object.keys(i))Fn(a[r],i[r])||(l[r]=i[r]);Object.keys(l).length>0&&(s[n]=l)}else s[n]=i}return s}function Bw(e,t,s){const n=Mw[e+"."+t];if(!n)return null;if(n.type==="number"){const a=Number(s);if(isNaN(a))return"Must be a number";if(n.min!==void 0&&a<n.min)return n.message||"Value too low";if(n.max!==void 0&&a>n.max)return n.message||"Value too high"}return n.type==="array"&&!Array.isArray(s)?n.message||"Must be an array":null}function qd(e,t){const s=[];for(const n of Object.keys(t)){if(!(n in e))continue;const a=e[n],i=t[n];if(!Fn(a,i))if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&typeof i=="object"&&i!==null&&!Array.isArray(i))for(const l of Object.keys(i))Fn(a[l],i[l])||s.push({section:n,key:l,oldVal:a[l],newVal:i[l]});else s.push({section:n,key:null,oldVal:a,newVal:i})}return s}const Hw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h({}),i=h({}),l=h({}),r=h(!1),o=h(!1),c=h(null),u=h(!1),d=h([]),f=h([]),p=X(()=>d.value.length>0),m=X(()=>f.value.length>0),g=X(()=>r.value&&t.value?t.value:e.value),k=X(()=>!e.value||!t.value?!1:!Fn(e.value,t.value)),E=X(()=>!e.value||!t.value?0:qd(e.value,t.value).length),b=X(()=>{if(!r.value||!t.value)return{};const A={};for(const $ of Object.keys(t.value)){const J=t.value[$];if(typeof J=="object"&&J!==null&&!Array.isArray(J))for(const Q of Object.keys(J)){const te=Bw($,Q,J[Q]);te&&(A[$+"."+Q]=te)}}return A}),v=X(()=>Object.keys(b.value).length>0),x=X(()=>e.value?Object.keys(e.value).length:0),w=X(()=>O.value.length),N=X(()=>!e.value||!t.value?[]:qd(e.value,t.value)),O=X(()=>e.value?Hr.map(A=>({...A,sections:A.sections.filter($=>$ in e.value)})).filter(A=>A.sections.length>0):[]),S=X(()=>{if(!e.value)return[];const A=new Set(Hr.flatMap($=>$.sections));return Object.keys(e.value).filter($=>!A.has($))});function R(A){return g.value?g.value[A]:null}function L(A){return!e.value||!t.value?!1:!Fn(e.value[A],t.value[A])}function H(A){return A.sections.some($=>L($))}function P(A,$){if(!e.value||!t.value)return!1;const J=e.value[A],Q=t.value[A];return!J||!Q?!1:!Fn(J[$],Q[$])}function T(A){return t.value?t.value[A]:e.value[A]}function U(A,$){const J=t.value||e.value;return J[A]?J[A][$]:void 0}function K(A,$){const J=r.value&&t.value?t.value:e.value;return J[A]?J[A][$]:!1}function G(A,$){return b.value[A+"."+$]||null}function D(A,$){return Dw[A+"."+$]||null}function I(A,$,J){t.value&&($===null?t.value[A]=J:(t.value[A]||(t.value[A]={}),t.value[A][$]=J),t.value={...t.value})}function j(A,$,J){if(!t.value)return;const Q=Qi(t.value);I(A,$,J),d.value.push(Q),d.value.length>Pw&&d.value.shift(),f.value=[]}function ce(A,$,J){try{const Q=JSON.parse(J);j(A,$,Q)}catch{}}function oe(){d.value.length!==0&&(f.value.push(Qi(t.value)),t.value=d.value.pop())}function se(){f.value.length!==0&&(d.value.push(Qi(t.value)),t.value=f.value.pop())}function he(A,$,J){if(!t.value||!t.value[A])return;const Q=[...t.value[A][$]];Q.splice(J,1),j(A,$,Q)}function ee(A,$){if(!t.value||!t.value[A])return;const J=[...t.value[A][$]||[]],Q=prompt("Enter new value:");Q!==null&&(J.push(Q),j(A,$,J))}function fe(A){a.value={...a.value,[A]:!a.value[A]}}function Ee(A){l.value={...l.value,[A]:!l.value[A]}}function F(A){i.value={...i.value,[A]:!i.value[A]}}function ue(A){try{return JSON.stringify(A,null,2)}catch{return String(A)}}function ne(A){return A==null?"null":typeof A=="object"?JSON.stringify(A,null,2):String(A)}function pe(A,$){c.value={type:A,message:$},setTimeout(()=>{c.value=null},3e3)}function be(){t.value=Qi(e.value),r.value=!0,d.value=[],f.value=[]}function Ie(){r.value=!1,t.value=null,d.value=[],f.value=[]}function y(){u.value=!0}async function C(){if(!(!k.value||v.value)){o.value=!0;try{const A=Uw(e.value,t.value);if(Object.keys(A).length===0){pe("success","No changes to save."),o.value=!1;return}const $=await q.put("/api/config",A);e.value=$,r.value=!1,t.value=null,d.value=[],f.value=[],pe("success","Config saved successfully.")}catch(A){pe("error",A.message||"Failed to save config")}o.value=!1}}async function M(){s.value=!0,n.value=null;try{e.value=await q.get("/api/config");for(const A of Object.keys(e.value))a.value[A]===void 0&&(a.value[A]=!0);for(const A of Hr)l.value[A.key]===void 0&&(l.value[A.key]=!0)}catch(A){n.value=A.message}s.value=!1}function W(A){if(!r.value)return;const $=A.target;$ instanceof HTMLElement&&($.matches("input, textarea, select")||$.isContentEditable)||((A.ctrlKey||A.metaKey)&&!A.shiftKey&&A.key.toLowerCase()==="z"?(A.preventDefault(),oe()):(A.ctrlKey||A.metaKey)&&(A.key==="y"||A.shiftKey&&A.key==="z"||A.shiftKey&&A.key==="Z")&&(A.preventDefault(),se()))}return Be(()=>{M(),document.addEventListener("keydown",W)}),ht(()=>{document.removeEventListener("keydown",W)}),{config:e,displayConfig:g,editValues:t,loading:s,error:n,expanded:a,expandedNested:i,expandedGroups:l,editing:r,saving:o,toast:c,hasChanges:k,hasErrors:v,changeCount:E,REDACTED:gg,showDiffModal:u,diffEntries:N,canUndo:p,canRedo:m,sectionCount:x,groupCount:w,visibleGroups:O,ungroupedSections:S,validationErrors:b,isSensitiveKey:Fw,isRedacted:$w,sectionChanged:L,groupChanged:H,fieldChanged:P,getDisplay:R,getEdited:T,getEditedField:U,getDisplayBool:K,pushEdit:j,pushEditJson:ce,getValidationError:G,getEnumOptions:D,removeArrayItem:he,addArrayItem:ee,toggleSection:fe,toggleGroup:Ee,toggleNested:F,formatJson:ue,formatDiffVal:ne,showToast:pe,showDiff:y,fetchConfig:M,startEdit:be,cancelEdit:Ie,saveConfig:C,undo:oe,redo:se}}},Vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h({allowed_hosts:[],default_host:""}),i=h({}),l=h(!1),r=h(""),o=h(!1),c=h(0),u=h([]),d=h(null),f=X(()=>{const I={};for(const j of u.value)I[j.id]=j;return I});function p(I){return f.value[I]||null}const m=X(()=>/^\d{15,25}$/.test(r.value.trim())),g=X(()=>{if(o.value){if(k.value[c.value])return"host-user-option-"+c.value;if(m.value)return"host-user-option-raw"}}),k=X(()=>{const I=r.value.toLowerCase().trim();return I?u.value.filter(j=>!i.value[j.id]&&(j.display_name.toLowerCase().includes(I)||j.username.toLowerCase().includes(I)||j.id.includes(I))):u.value.filter(j=>!i.value[j.id])});function E(I,j){return I?I.allowed_hosts===null||I.allowed_hosts===void 0?{allowed_hosts:[...j],default_host:I.default_host||"",allow_all:!0}:{allowed_hosts:I.allowed_hosts,default_host:I.default_host||"",allow_all:!1}:{allowed_hosts:[...j],default_host:j[0]||"",allow_all:!0}}async function b(){e.value=!0,t.value="";try{const I=await q.get("/api/host-access");s.value=I,n.value=I.available_hosts||[],a.value=E(I.default_policy,n.value);const j=I.users||{},ce={};for(const[oe,se]of Object.entries(j))ce[oe]=E(se,n.value);i.value=ce}catch(I){t.value=I.message||"Failed to fetch host access data"}finally{e.value=!1}try{u.value=await q.get("/api/discord/members")||[]}catch{u.value=[]}}async function v(){try{const I=a.value.allow_all?null:a.value.allowed_hosts;await q.put("/api/host-access/default-policy",{allowed_hosts:I,default_host:a.value.default_host}),ke.success("Default policy updated")}catch(I){ke.error(I.message||"Failed to save")}}function x(I,j){a.value.allow_all=!1,j?a.value.allowed_hosts.includes(I)||a.value.allowed_hosts.push(I):(a.value.allowed_hosts=a.value.allowed_hosts.filter(ce=>ce!==I),a.value.default_host===I&&(a.value.default_host=a.value.allowed_hosts[0]||"")),v()}async function w(I){const j=i.value[I];if(j)try{const ce=j.allow_all?null:j.allowed_hosts;await q.put(`/api/host-access/user/${I}`,{allowed_hosts:ce,default_host:j.default_host});const oe=p(I);ke.success(`Updated access for ${oe?oe.display_name:I}`)}catch(ce){ke.error(ce.message||"Failed to save")}}function N(I,j,ce){const oe=i.value[I];oe&&(oe.allow_all=!1,ce?oe.allowed_hosts.includes(j)||oe.allowed_hosts.push(j):(oe.allowed_hosts=oe.allowed_hosts.filter(se=>se!==j),oe.default_host===j&&(oe.default_host=oe.allowed_hosts[0]||"")),w(I))}function O(I,j){const ce=i.value[I];ce&&(ce.default_host=j,w(I))}function S(){l.value=!0,r.value="",c.value=0,Et(()=>{d.value&&d.value.focus()})}function R(){o.value=!0,c.value=0}function L(){c.value<k.value.length-1&&c.value++}function H(){c.value>0&&c.value--}function P(){const I=k.value[c.value];if(I){U(I);return}m.value&&T()}function T(){const I=r.value.trim();/^\d{15,25}$/.test(I)&&(i.value[I]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},w(I),r.value="",o.value=!1,l.value=!1)}function U(I){i.value[I.id]={allowed_hosts:[...n.value],default_host:n.value[0]||"",allow_all:!1},w(I.id),r.value="",o.value=!1,l.value=!1}function K(){o.value=!1}function G(){setTimeout(()=>{o.value=!1},150)}async function D(I){const j=p(I);if(await ls({title:"Remove user override",message:`Remove the host access override for ${j?j.display_name:I}? They will fall back to the default policy.`,confirmLabel:"Remove",danger:!0}))try{await q.del(`/api/host-access/user/${I}`),delete i.value[I],ke.success(`Removed override for ${j?j.display_name:I}`)}catch(oe){ke.error(oe.message||"Failed to delete")}}return Be(b),{loading:e,error:t,data:s,availableHosts:n,defaultPolicy:a,users:i,showAddUser:l,searchQuery:r,showDropdown:o,highlightIdx:c,members:u,filteredMembers:k,isRawId:m,activeOptionId:g,searchInput:d,fetchData:b,saveDefaultPolicy:v,toggleDefaultHost:x,getMember:p,toggleUserHost:N,setUserDefault:O,openAddUser:S,deleteUser:D,onSearchInput:R,highlightNext:L,highlightPrev:H,selectHighlighted:P,selectMember:U,closeDropdown:K,onBlur:G,addRawId:T}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),r=h(null),o=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=X(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),f=X(()=>u.value.host_mode==="select"?u.value.allowed_hosts:u.value.host_mode==="none"?[]:n.value);function p(S){return S==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":S==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const S=await q.get("/api/tokens");s.value=S.tokens||[],n.value=S.available_hosts||[]}catch(S){t.value=S.message||"Failed to load tokens"}finally{e.value=!1}}function g(S){return!S||!S.trim()?[]:S.split(",").map(R=>R.trim()).filter(Boolean)}function k(S,R){const L=c.value.allowed_hosts;if(R&&!L.includes(S)&&L.push(S),!R){const H=L.indexOf(S);H>=0&&L.splice(H,1)}}function E(S,R){const L=u.value.allowed_hosts;if(R&&!L.includes(S)&&L.push(S),!R){const H=L.indexOf(S);H>=0&&L.splice(H,1)}}async function b(){var S;i.value=!0;try{const R=g(c.value.allowed_tools_str),L=c.value.host_mode,H=L==="none"?[]:L==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:R.length?R:[]};H!==null&&(P.allowed_hosts=H),P.default_host=c.value.default_host||"";const T=await q.post("/api/tokens",P);l.value=T.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,ke.success("Token created"),await m()}catch(R){ke.error(((S=R.data)==null?void 0:S.error)||R.message||"Failed to create token")}finally{i.value=!1}}function v(S){r.value=S;const R=S.allowed_hosts;let L="default";R==null?L="default":Array.isArray(R)&&R.length===0?L="none":Array.isArray(R)&&(L="select"),u.value={username:S.username||"",tier:S.tier||"admin",label:S.label||"",host_mode:L,allowed_hosts:Array.isArray(R)?[...R]:[],default_host:S.default_host||"",allowed_tools_str:(S.allowed_tools||[]).join(", ")}}async function x(){var S;if(r.value){o.value=!0;try{const R=g(u.value.allowed_tools_str),L=u.value.host_mode,H={username:u.value.username,tier:u.value.tier,label:u.value.label,allowed_tools:R};L==="none"?H.allowed_hosts=[]:L==="select"?H.allowed_hosts=u.value.allowed_hosts:H.allowed_hosts=null,H.default_host=u.value.default_host||"",await q.put("/api/tokens/"+encodeURIComponent(r.value.user_id),H),r.value=null,ke.success("Token updated"),await m()}catch(R){ke.error(((S=R.data)==null?void 0:S.error)||R.message||"Failed to update")}finally{o.value=!1}}}async function w(S){var L;if(await ls({title:"Regenerate token",message:`Regenerate token for ${S.username||S.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const H=await q.post("/api/tokens/"+encodeURIComponent(S.user_id)+"/regenerate");l.value=H.token,ke.success("Token regenerated")}catch(H){ke.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to regenerate")}}async function N(S){var L;if(await ls({title:"Delete token",message:`Delete token for ${S.username||S.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/tokens/"+encodeURIComponent(S.user_id)),ke.success("Token deleted"),await m()}catch(H){ke.error(((L=H.data)==null?void 0:L.error)||H.message||"Failed to delete")}}async function O(){if(l.value)try{await navigator.clipboard.writeText(l.value),ke.success("Copied to clipboard")}catch{ke.error("Copy failed — select and copy manually")}}return Be(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:r,saving:o,createForm:c,editForm:u,createDefaultHostOptions:d,editDefaultHostOptions:f,fetchData:m,tierBadge:p,toggleCreateHost:k,toggleEditHost:E,createToken:b,startEdit:v,saveEdit:x,confirmRegenerate:w,confirmDelete:N,copyToken:O}}};function Xi(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const qw={template:`
    <div class="p-6 page-fade-in">
  ...
  `,setup(){const e=h(!0),t=h(null),s=h("codex"),n=h({enabled:!1,model:"gpt-5.5",max_tokens:4096,reasoning_effort:"medium",agent_reasoning_effort:"",agent_model:""}),a=["gpt-5.6-sol","gpt-5.6-terra","gpt-5.6-luna","gpt-5.5"],i=X(()=>{const Z=n.value.model;return Z&&!a.includes(Z)?[Z,...a]:a}),l=X(()=>{const Z=n.value.agent_model;return Z&&!a.includes(Z)?[Z,...a]:a}),r=h({enabled:!1,model:"gpt-5.6-luna",tasks:[]}),o=h({known_tasks:[],unavailable_reason:null}),c=X(()=>o.value.known_tasks||[]),u=X(()=>{const Z=r.value.model;return Z&&!a.includes(Z)?[Z,...a]:a}),d=h(!1),f=h({enabled:!1,base_url:"",model:"",api_key:"",max_tokens:4096}),p=h({enabled:!1,api_key:"",model:"",max_tokens:4096}),m=h(!1),g=h(!1),k=h(!1),E=h(!1),b=h(!1),v=h(!1),x=h(!1),w=h({configured:!1}),N=h([]),O=h(""),S=h(!1),R=h(!1),L=h({configured:!1}),H=h([]),P=h(""),T=h(!1),U=h(!1),K=h(!0),G=h(""),D=h({configured:!1,accounts:[]}),I=h(null),j=h(null),ce=h(""),oe=h(null),se=h(!1),he=h(null),ee=h(null),fe=h("");let Ee=null;function F(Z,Le="success"){ke(Z,Le==="error"?"error":"success")}function ue(Z){if(!Z)return"?";const Le=Z/(1024*1024*1024);return Le>=1?Le.toFixed(1)+" GB":(Z/(1024*1024)).toFixed(0)+" MB"}async function ne(){e.value=!0,await Promise.all([pe(),be(),A(),Ie()]),e.value=!1}async function pe(){try{const Z=await q.get("/api/llm/status");t.value=Z,s.value=Z.active_provider||"codex",Z.codex&&!ae.pending()&&(n.value.enabled=Z.codex.enabled,n.value.model=Z.codex.model||"gpt-5.5",n.value.reasoning_effort=Z.codex.reasoning_effort||"medium",n.value.agent_reasoning_effort=Z.codex.agent_reasoning_effort||"",n.value.agent_model=Z.codex.agent_model||"",n.value.max_tokens=Z.codex.max_tokens||4096),Z.ollama&&!ye.pending()&&(f.value.enabled=Z.ollama.enabled,f.value.base_url=Z.ollama.base_url||"",f.value.model=Z.ollama.model||"",f.value.max_tokens=Z.ollama.max_tokens||4096),Z.kimi&&!_e.pending()&&(p.value.enabled=Z.kimi.enabled,p.value.model=Z.kimi.model||"",p.value.max_tokens=Z.kimi.max_tokens||4096),Z.auxiliary&&(o.value=Z.auxiliary,de.pending()||(r.value.enabled=Z.auxiliary.enabled,r.value.model=Z.auxiliary.model||"gpt-5.6-luna",r.value.tasks=[...Z.auxiliary.tasks||[]]))}catch{t.value={active_provider:"codex",codex:{configured:!1},ollama:{configured:!1},kimi:{configured:!1}}}}async function be(){try{if(w.value=await q.get("/api/ollama/status"),w.value.model&&(O.value=w.value.model),w.value.configured)try{const Z=await q.get("/api/ollama/models");N.value=Z.models||[]}catch{N.value=[]}else if(f.value.base_url)try{const Z=await q.post("/api/ollama/probe-models",{base_url:f.value.base_url});N.value=Z.models||[]}catch{N.value=[]}}catch{w.value={configured:!1}}}async function Ie(){K.value=!0,G.value="";try{D.value=await q.get("/api/codex/status")}catch(Z){G.value=Z.message||"Failed to fetch Codex status"}finally{K.value=!1}}async function y(){const Z=t.value?t.value.active_provider:"codex";x.value=!0;try{const Le=await q.post("/api/llm/switch",{provider:s.value});Le.error?(s.value=Z,F(Le.error,"error")):(F("Switched to "+s.value+" ("+Le.model+")"),await ne())}catch(Le){s.value=Z,F(Le.message||"Switch failed","error")}finally{x.value=!1}}async function C(){S.value=!0;try{const Z=await q.post("/api/ollama/reload");F(Z.configured?"Ollama reloaded":Z.reason||"Ollama not configured",Z.configured?"success":"error"),await ne()}catch(Z){F(Z.message||"Reload failed","error")}finally{S.value=!1}}async function M(){R.value=!0;try{await q.post("/api/ollama/model",{model:O.value}),F("Model set to "+O.value),await ne()}catch(Z){F(Z.message||"Failed","error")}finally{R.value=!1}}async function W(){const Z=f.value.base_url;if(!Z){F("Enter a base URL first","error");return}v.value=!0;try{const Le=await q.post("/api/ollama/probe-models",{base_url:Z});N.value=Le.models||[],N.value.length?(F(N.value.length+" model(s) found"),!f.value.model&&N.value.length&&(f.value.model=N.value[0].name)):F("No models found at "+Z,"error")}catch(Le){F(Le.message||"Could not reach Ollama","error")}finally{v.value=!1}}async function A(){try{if(L.value=await q.get("/api/kimi/status"),L.value.model&&(P.value=L.value.model),L.value.configured)try{const Z=await q.get("/api/kimi/models");H.value=Z.models||[]}catch{H.value=[]}}catch{L.value={configured:!1}}}async function $(){T.value=!0;try{const Z=await q.post("/api/kimi/reload");F(Z.configured?"Kimi reloaded":Z.reason||"Kimi not configured",Z.configured?"success":"error"),await ne()}catch(Z){F(Z.message||"Reload failed","error")}finally{T.value=!1}}async function J(){U.value=!0;try{await q.post("/api/kimi/model",{model:P.value}),F("Model set to "+P.value),await ne()}catch(Z){F(Z.message||"Failed","error")}finally{U.value=!1}}async function Q(){if(k.value){ae();return}k.value=!0;try{await q.put("/api/llm/codex/config",n.value),F("Codex config saved"),await Promise.all([pe(),Ie()])}catch(Z){F(Z.message||"Failed","error"),await Promise.all([pe(),Ie()])}finally{k.value=!1}}async function te(){if(E.value){ye();return}E.value=!0;try{const Z={...f.value},Le=m.value?f.value.api_key:null;Le===null&&delete Z.api_key,await q.put("/api/llm/ollama/config",Z),F("Ollama config saved"),Le!==null&&f.value.api_key===Le&&(f.value.api_key="",m.value=!1),await Promise.all([pe(),be()])}catch(Z){F(Z.message||"Failed","error")}finally{E.value=!1}}async function Y(){if(b.value){_e();return}b.value=!0;try{const Z={...p.value},Le=g.value?p.value.api_key:null;Le===null&&delete Z.api_key,await q.put("/api/llm/kimi/config",Z),F("Kimi config saved"),Le!==null&&p.value.api_key===Le&&(p.value.api_key="",g.value=!1),await Promise.all([pe(),A()])}catch(Z){F(Z.message||"Failed","error")}finally{b.value=!1}}async function me(){if(d.value){de();return}d.value=!0;try{await q.put("/api/llm/auxiliary/config",r.value),F("Auxiliary config saved"),await pe()}catch(Z){F(Z.message||"Failed","error"),await pe()}finally{d.value=!1}}const ae=Xi(Q),de=Xi(me),ye=Xi(te),_e=Xi(Y),Re=()=>(ae.cancel(),Q()),B=()=>(ye.cancel(),te()),re=()=>(_e.cancel(),Y());async function xe(Z){try{await q.post("/api/codex/account/"+Z+"/activate"),F("Active account switched"),await Ie()}catch(Le){F(Le.message||"Failed","error")}}async function Pe(Z){I.value=Z;try{await q.post("/api/codex/account/"+Z+"/refresh"),F("Token refreshed"),await Ie()}catch(Le){F(Le.message||"Refresh failed","error")}finally{I.value=null}}function Je(Z,Le){j.value=Z,ce.value=Le||""}async function Ze(Z){try{await q.put("/api/codex/account/"+Z+"/label",{label:ce.value}),F("Label updated"),j.value=null,await Ie()}catch(Le){F(Le.message||"Failed","error")}}async function xt(Z,Le){if(await ls({title:"Delete Codex account",message:`Delete ${Le||"account #"+(Z+1)}? The pool will reload without it.`,confirmLabel:"Delete",danger:!0}))try{await q.del("/api/codex/account/"+Z),F("Deleted. Pool reloaded."),await Ie()}catch(Gn){F(Gn.message||"Failed","error")}}async function et(){se.value=!0;try{const Z=await q.post("/api/codex/device-code");he.value=Z,oe.value="pending",Ye(Z)}catch(Z){F(Z.message||"Failed","error")}finally{se.value=!1}}async function Ye(Z){Ee={cancelled:!1};const Le=Ee;try{const Ts=await q.post("/api/codex/device-poll",{device_auth_id:Z.device_auth_id,user_code:Z.user_code,interval:Z.interval});if(Le.cancelled)return;ee.value=Ts,oe.value="success",await ne()}catch(Ts){if(Le.cancelled)return;fe.value=Ts.message||"Device login failed",oe.value="error"}}function Ss(){Ee&&(Ee.cancelled=!0),oe.value=null,he.value=null}return Be(ne),ht(()=>{Ee&&(Ee.cancelled=!0),ae.cancel(),de.cancel(),ye.cancel(),_e.cancel()}),{loading:e,llmStatus:t,selectedProvider:s,switching:x,codexForm:n,codexModelOptions:i,codexAgentModelOptions:l,auxForm:r,auxData:o,auxKnownTasks:c,auxModelOptions:u,savingAux:d,saveAuxConfigDebounced:de,ollamaForm:f,kimiForm:p,savingCodex:k,savingOllama:E,savingKimi:b,probingOllama:v,ollamaKeyDirty:m,kimiKeyDirty:g,ollamaStatus:w,ollamaModels:N,ollamaSelectedModel:O,reloading:S,settingModel:R,kimiStatus:L,kimiModels:H,kimiSelectedModel:P,reloadingKimi:T,settingKimiModel:U,codexLoading:K,codexError:G,codexData:D,refreshing:I,editingLabel:j,labelValue:ce,deviceState:oe,deviceLoading:se,deviceInfo:he,deviceResult:ee,deviceError:fe,fetchAll:ne,switchProvider:y,reloadOllama:C,setOllamaModel:M,reloadKimi:$,setKimiModel:J,probeOllamaModels:W,saveCodexConfig:Q,saveOllamaConfig:te,saveKimiConfig:Y,saveCodexConfigDebounced:ae,saveOllamaConfigDebounced:ye,saveKimiConfigDebounced:_e,saveCodexConfigNow:Re,saveOllamaConfigNow:B,saveKimiConfigNow:re,activateAccount:xe,refreshAccount:Pe,startEditLabel:Je,saveLabel:Ze,deleteAccount:xt,startDeviceLogin:et,cancelDeviceLogin:Ss,formatSize:ue}}},Kd={ok:"text-green-400",pass:"text-green-400",degraded:"text-yellow-400",warn:"text-yellow-400",down:"text-red-400",fail:"text-red-400",unconfigured:"text-gray-500",skipped:"text-gray-500"};function Kw(e){return Kd[e]||Kd[(e||"").toLowerCase()]||"text-gray-400"}const Gw={template:`
  ...
  `},Zw={components:{TabbedPage:dr},setup(){return{tabs:[{id:"health",label:"Health",component:Ew},{id:"resources",label:"Resources",component:Aw},{id:"logs",label:"Logs",component:Ow},{id:"config",label:"Config",component:Hw},{id:"discord",label:"Discord",component:Vw},{id:"host-access",label:"Host Access",component:jw},{id:"api-tokens",label:"API Tokens",component:zw},{id:"llm",label:"LLM Config",component:qw},{id:"internals",label:"Internals",component:Gw},{id:"update",label:"Update",component:Ww}]}},template:'<tabbed-page :tabs="tabs" default-tab="health" group-label="System" />'},gt=(e,t)=>s=>({path:e,query:{...s.query,tab:t}}),mg=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",component:P_,meta:{label:"Dashboard",icon:"dashboard",section:"Workspace",description:"System posture and recent activity"}},{path:"/chat",component:ew,meta:{label:"Chat",icon:"chat",section:"Workspace",description:"Direct operator conversation"}},{path:"/operations",component:lw,meta:{label:"Operations",icon:"operations",section:"Operate",description:"Execution, agents, loops, processes, and schedules"}},{path:"/history",component:pw,meta:{label:"History",icon:"history",section:"Observe",description:"Audit trail, sessions, traces, and usage"}},{path:"/capabilities",component:kw,meta:{label:"Capabilities",icon:"capabilities",section:"Manage",description:"Tools, skills, knowledge, and memory"}},{path:"/personality",component:ww,meta:{label:"Personality",icon:"personality",section:"Manage",description:"Behavior and response profile"}},{path:"/system",component:Zw,meta:{label:"System",icon:"system",section:"Manage",description:"Health, configuration, access, and updates"}},{path:"/execution",redirect:gt("/operations","live")},{path:"/agents",redirect:gt("/operations","agents")},{path:"/loops",redirect:gt("/operations","loops")},{path:"/processes",redirect:gt("/operations","processes")},{path:"/schedules",redirect:gt("/operations","schedules")},{path:"/audit",redirect:gt("/history","audit")},{path:"/sessions",redirect:gt("/history","sessions")},{path:"/traces",redirect:gt("/history","traces")},{path:"/usage",redirect:gt("/history","usage")},{path:"/tools",redirect:gt("/capabilities","tools")},{path:"/skills",redirect:gt("/capabilities","skills")},{path:"/knowledge",redirect:gt("/capabilities","knowledge")},{path:"/memory",redirect:gt("/capabilities","memory")},{path:"/learned",redirect:gt("/capabilities","learned")},{path:"/health",redirect:gt("/system","health")},{path:"/resources",redirect:gt("/system","resources")},{path:"/logs",redirect:gt("/system","logs")},{path:"/config",redirect:gt("/system","config")},{path:"/host-access",redirect:gt("/system","host-access")},{path:"/internals",redirect:gt("/system","internals")}],ii=E_({history:i_(),routes:mg});ii.afterEach(e=>{var s;const t=(s=e.meta)==null?void 0:s.label;document.title=t?`Odin — ${t}`:"Odin — Management"});const Jw={template:`
    ...
    <toast-container />
    <confirm-host />
    <command-palette />`,setup(){const e=h("checking"),t=h(!1),s=h(!1),n=h(!1),a=h(null),i=h(null),l=h(!1);let r=null,o=null;const c=h(!1),u=h("disconnected"),d=h(-1),f=h(null);let p=null;const m=h("starting"),g=h(""),k=mg.filter(D=>D.meta),E=X(()=>["Workspace","Operate","Observe","Manage"].map(D=>({name:D,routes:k.filter(I=>I.meta.section===D)})).filter(D=>D.routes.length)),b=X(()=>{var D;return((D=ii.currentRoute.value.meta)==null?void 0:D.label)||"Odin"}),v=X(()=>{var D;return((D=ii.currentRoute.value.meta)==null?void 0:D.section)||"Management"}),x=X(()=>{var D;return((D=ii.currentRoute.value.meta)==null?void 0:D.description)||"Management console"});q.onSessionExpired=()=>{t.value=!0,Ge.disconnect(),q.setToken(""),e.value="login"};function w(D){var I;if((D.ctrlKey||D.metaKey)&&D.key.toLowerCase()==="k"){e.value==="ready"&&(D.preventDefault(),xd());return}if(n.value&&D.key==="Tab"){const j=[...((I=a.value)==null?void 0:I.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])'))||[]];if(j.length){const ce=j[0],oe=j[j.length-1];if(D.shiftKey&&(document.activeElement===ce||!a.value.contains(document.activeElement))){D.preventDefault(),oe.focus();return}if(!D.shiftKey&&(document.activeElement===oe||!a.value.contains(document.activeElement))){D.preventDefault(),ce.focus();return}}}if(D.key==="Escape"&&n.value){n.value=!1,D.preventDefault();return}if(D.key==="/"&&!["INPUT","TEXTAREA","SELECT"].includes(D.target.tagName)){D.preventDefault();const j=document.querySelector('.hm-main input[type="text"], .hm-main .hm-input:not(textarea):not(select)');j&&j.focus()}}function N(){l.value=!!(r!=null&&r.matches),l.value||(n.value=!1)}Be(async()=>{document.addEventListener("keydown",w),r=window.matchMedia("(max-width: 900px)"),N(),r.addEventListener("change",N);const D=await q.check();D.ok?(e.value="ready",K()):D.needsAuth?e.value="login":(e.value="ready",K())});function O(){t.value=!1,e.value="ready",K()}async function S(){await q.logout(),Ge.disconnect(),e.value="login"}function R(){s.value=!s.value}function L(){n.value=!n.value}hs(n,async D=>{var I,j;if(D)o=document.activeElement,await Et(),(j=(I=a.value)==null?void 0:I.querySelector(".nav-item"))==null||j.focus();else if(o!=null&&o.isConnected){const ce=o;o=null,requestAnimationFrame(()=>ce.focus())}});const H=X(()=>{switch(u.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}});function P(D,I="info",j=3e3){f.value={text:D,level:I},clearTimeout(p),p=setTimeout(()=>{f.value=null},j)}let T=null,U=!1;function K(){Ge.onStatusChange=D=>{c.value=D},Ge.onStateChange=(D,I)=>{u.value=D,d.value=I.latency??-1,D==="connected"?(U&&P("Connection restored","success"),U=!0):D==="reconnecting"&&I.attempt===1&&P("Connection lost — reconnecting…","warn")},Ge.connect(),G(),T&&clearInterval(T),T=setInterval(G,15e3)}async function G(){try{const D=await q.get("/api/status");m.value=D.status==="online"?"online":"starting";const I=D.uptime_seconds||0,j=Math.floor(I/3600),ce=Math.floor(I%3600/60);g.value=`${j}h ${ce}m uptime`}catch{m.value="offline",g.value=""}}return ht(()=>{T&&clearInterval(T),Ge.disconnect(),document.removeEventListener("keydown",w),r==null||r.removeEventListener("change",N)}),{authState:e,sessionExpired:t,sidebarCollapsed:s,mobileOpen:n,wsConnected:c,wsState:u,wsLatency:d,wsLabel:H,wsToast:f,botStatus:m,botUptime:g,navRoutes:k,navGroups:E,currentPage:b,currentSection:v,currentDescription:x,sidebarEl:a,mobileMenuButton:i,isMobileViewport:l,onLogin:O,logout:S,toggleSidebar:R,toggleMobileNavigation:L,openPalette:xd}}},kn=Sl(Yw);kn.component("odin-icon",O_);kn.component("login-screen",Jw);kn.component("toast-container",yx);kn.component("confirm-host",xx);kn.component("command-palette",N_);kn.directive("modal-focus",D_);kn.use(ii);kn.mount("#app");
