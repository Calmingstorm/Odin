...
... (truncated)`:s}function Mu(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function wm(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Sm=Symbol("agent-detail-cancelled"),iw=15e3;function lw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((f,m)=>{r=f,c=m});function u(f,m){o||(o=!0,l!==null&&a(l),l=null,(f?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return o||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sm),i==null||i.abort()}}}function Tm({state:e,requestDetail:t,timeoutMs:s=iw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const v={agentId:p,cancel:null,promise:null};l=v,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const E=lw(N=>t(p,{signal:N}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return v.cancel=E.cancel,v.promise=(async()=>{let N=null,_=null;try{N=await E.promise}catch(g){_=g}N!==Sm&&(l!==v||e.detailId!==p||(l=null,!_&&(N===null||typeof N!="object")&&(_=new Error(`${n} response was empty or invalid`)),_?e.detail===null&&(e.detailError=(_==null?void 0:_.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=N,e.detailError=null),e.detailLoading=!1))})(),v.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function ow({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const rw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),o=h(null),r=Z(()=>hw(a.value.run_at));ls(()=>a.value.run_at,()=>{o.value=null});const c=Z(()=>{var le;const H=r.value;return H.state==="ok"?H.instant:H.state==="ambiguous"&&o.value!==null&&((le=H.options[o.value])==null?void 0:le.instant)||null}),d=Z(()=>{const H=c.value;return H?`${H.toLocaleString()} local — ${H.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=h(null),v=h(null),E=h(null),N=h(null),_=h(null),g=h(null),y=h([]),T=h(!1),k=h("");let O=0;const C=Z(()=>e.value.filter(H=>H.cron&&!H.one_time).length),w=Z(()=>e.value.filter(H=>H.one_time).length),M=Z(()=>e.value.filter(H=>H.trigger).length),A=Z(()=>e.value.filter(H=>H.paused).length),I=Z(()=>e.value.filter(H=>H.consecutive_failures>0).length);function $(H){if(!H)return"-";const le=Date.now(),Oe=(new Date(H).getTime()-le)/1e3;if(Oe<0)return"overdue";if(Oe<60)return"in < 1 min";if(Oe<3600)return`in ${Math.floor(Oe/60)} min`;if(Oe<86400){const P=Math.floor(Oe/3600),U=Math.floor(Oe%3600/60);return U>0?`in ${P}h ${U}m`:`in ${P}h`}const x=Math.floor(Oe/86400);return`in ${x} day${x!==1?"s":""}`}function F(H){return H==null?"-":H<1e3?`${H}ms`:H<6e4?`${(H/1e3).toFixed(1)}s`:ai(H/1e3)}function te(H=a.value.cron){a.value.cron=H,Du(a.value,"cron"),u.value=null}function B(H=a.value.run_at){a.value.run_at=H,Du(a.value,"run_at"),u.value=null}async function S(){const H=a.value.cron.trim();if(H){p.value=!0;try{u.value=await G.post("/api/schedules/validate-cron",{expression:H})}catch(le){u.value={valid:!1,error:le.message}}p.value=!1}}async function R(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(H){s.value=H.message}t.value=!1}async function W(H){if(g.value===H){g.value=null,y.value=[];return}g.value=H,T.value=!0,y.value=[];const le=++O;try{const ue=await G.get(`/api/schedules/${encodeURIComponent(H)}/history?limit=10`);if(le!==O||g.value!==H)return;y.value=ue,k.value=""}catch(ue){if(le!==O||g.value!==H)return;y.value=[],k.value=ue.message||"Failed to load execution history"}le===O&&(T.value=!1)}async function ge(){l.value=null;const H=a.value;if(!H.description.trim()){l.value="Description is required";return}if(!H.channel_id.trim()){l.value="Channel ID is required";return}if(!H.cron.trim()&&!H.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(H.cron.trim()&&H.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const le={description:H.description.trim(),action:H.action,channel_id:H.channel_id.trim()};if(H.cron.trim()&&(le.cron=H.cron.trim()),H.run_at.trim()){const ue=r.value;if(ue.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(ue.state==="invalid"){l.value="One-time run time is not a valid date";return}const Oe=c.value;if(ue.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!Oe){l.value="One-time run time could not be resolved";return}le.run_at=Oe.toISOString()}if(H.action==="reminder"&&H.message.trim()&&(le.message=H.message.trim()),H.action==="check"&&(H.tool_name.trim()&&(le.tool_name=H.tool_name.trim()),H.report_format&&(le.report_format=H.report_format),H.tool_input_str.trim()))try{le.tool_input=JSON.parse(H.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",le),Re.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await R()}catch(ue){l.value=ue.message}i.value=!1}async function ae(H){m.value=H;try{const le=await G.post(`/api/schedules/${encodeURIComponent(H)}/run`);if(le.status==="failure")Re.error(`Execution failed: ${le.error||"unknown error"}`);else{const ue=le.warning?`Executed (${le.warning})`:"Executed successfully";Re.success(ue)}await R()}catch(le){Re.error(le.message||"Failed to trigger")}m.value=null}async function se(H){E.value=H.id;const le=!H.paused;try{await G.put(`/api/schedules/${encodeURIComponent(H.id)}`,{paused:le}),Re.success(le?"Schedule paused":"Schedule resumed"),await R()}catch(ue){Re.error(ue.message||"Failed to update schedule")}E.value=null}const re=new Map;function X(H,le){const ue=re.get(H.id);ue&&clearTimeout(ue.timer);const Oe={run:()=>fe(H,le),timer:null};Oe.timer=setTimeout(()=>{re.delete(H.id),Oe.run()},500),re.set(H.id,Oe)}async function fe(H,le){_.value=H.id;try{await G.put(`/api/schedules/${encodeURIComponent(H.id)}`,{report_format:le}),Re.success(le?"Structured report enabled":"Plain-text report enabled")}catch(ue){Re.error(`Update failed: ${ue.message}`)}finally{await R(),_.value=null}}function Me(){for(const[H,le]of[...re])clearTimeout(le.timer),re.delete(H),le.run()}async function K(H){N.value=H;try{await G.post(`/api/schedules/${encodeURIComponent(H)}/reset-failures`),Re.success("Failure counters reset"),await R()}catch(le){Re.error(le.message||"Failed to reset")}N.value=null}async function be(H){const le=e.value.find(Oe=>Oe.id===H);if(await Qt({title:"Delete schedule",message:`Delete "${(le==null?void 0:le.description)||H}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){v.value=H;try{await G.del(`/api/schedules/${encodeURIComponent(H)}`),Re.success("Schedule deleted"),await R()}catch(Oe){Re.error(Oe.message||"Failed to delete schedule")}v.value=null}}return Ze(()=>{R()}),mt(Me),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:f,runningId:m,deletingId:v,togglingId:E,resettingId:N,reportUpdatingId:_,flushReportFormatTimers:Me,expandedId:g,history:y,historyLoading:T,historyError:k,cronCount:C,oneTimeCount:w,webhookCount:M,pausedCount:A,failingCount:I,formatTs:xa,formatAge:xm,formatFuture:$,formatMs:F,formatDuration:ai,onCronInput:te,onRunAtInput:B,validateCron:S,toggleExpand:W,fetchSchedules:R,doCreate:ge,doRunNow:ae,doTogglePause:se,doUpdateReportFormat:X,doResetFailures:K,doDelete:be}}},Cm=[{id:"live",label:"Live",component:nw},{id:"agents",label:"Agents",component:rw},{id:"loops",label:"Loops",component:cw},{id:"processes",label:"Processes",component:dw},{id:"schedules",label:"Schedules",component:mw}],vw={components:{TabbedPage:Uo},setup(){return{tabs:Cm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},gw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h({tool:"",user:"",keyword:"",date:"",limit:50});function i(d){if(!d)return"";if(typeof d=="string")return d;try{return JSON.stringify(d,null,2)}catch{return String(d)}}function l(d){n.value=n.value===d?null:d}function o(){a.value={tool:"",user:"",keyword:"",date:"",limit:50},c()}let r=0;async function c(){const d=++r;t.value=!0,s.value=null,n.value=null;try{const u=new URLSearchParams;a.value.tool&&u.set("tool",a.value.tool),a.value.user&&u.set("user",a.value.user),a.value.keyword&&u.set("q",a.value.keyword),a.value.date&&u.set("date",a.value.date),u.set("limit",String(a.value.limit));const p=u.toString(),f=await G.get(`/api/audit${p?"?"+p:""}`);if(d!==r)return;e.value=Array.isArray(f)?f:[]}catch(u){if(d!==r)return;s.value=u.message}d===r&&(t.value=!1)}return Ze(()=>{c()}),{entries:e,loading:t,error:s,expandedIdx:n,filters:a,formatTs:xa,formatDetail:i,truncateBlock:_m,toggleExpand:l,clearFilters:o,fetchAudit:c}}},Fu=[{id:"all",name:"All Sessions",icon:"list",filters:{}},{id:"active",name:"Recently Active",icon:"activity",filters:{minAge:0,maxAge:3600}},{id:"discord",name:"Discord Only",icon:"message",filters:{source:"discord"}},{id:"web",name:"Web Only",icon:"globe",filters:{source:"web"}},{id:"long",name:"Long Conversations",icon:"book",filters:{minMessages:10}},{id:"compacted",name:"Compacted",icon:"archive",filters:{hasCompaction:!0}}],bw=[{value:"last_active",label:"Last Active"},{value:"created_at",label:"Created"},{value:"message_count",label:"Message Count"}],yw={template:`
    <div class="p-6 page-fade-in">
      <!-- Header -->
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const o=h(null),r=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),m=h(!1),v=Fu,E=bw,N=h([]),_=h(!1),g=h(""),y=h("flat"),T=h(new Set),k=h(""),O=h(""),C=h(""),w=h(null),M=h(!1);function A(){try{const J=localStorage.getItem("odin-session-presets");J&&(N.value=JSON.parse(J))}catch{}}function I(){try{localStorage.setItem("odin-session-presets",JSON.stringify(N.value))}catch{}}const $=Z(()=>p.value.trim()!==""||u.value!=="all"),F=Z(()=>{let J=[...e.value];const Ie=Fu.find(Ue=>Ue.id===u.value),$e=Ie?Ie.filters:{};if($e.source&&(J=J.filter(Ue=>Ue.source===$e.source)),$e.minMessages&&(J=J.filter(Ue=>Ue.message_count>=$e.minMessages)),$e.hasCompaction&&(J=J.filter(Ue=>Ue.has_summary)),$e.maxAge!=null){const Ue=Date.now()/1e3;J=J.filter(ot=>ot.last_active&&Ue-ot.last_active<=$e.maxAge)}if(p.value.trim()){const Ue=p.value.toLowerCase().trim();J=J.filter(ot=>(ot.channel_id||"").toLowerCase().includes(Ue)||(ot.last_user_id||"").toLowerCase().includes(Ue)||(ot.source||"").toLowerCase().includes(Ue))}const Be=f.value,ze=m.value?1:-1;return J.sort((Ue,ot)=>{const Nt=Ue[Be]||0,St=ot[Be]||0;return(Nt-St)*ze}),J}),te=Z(()=>{if(!a.value||!a.value.messages)return[];const J=a.value.messages;if(J.length===0)return[];const Ie=[];let $e=[];for(const Be of J)Be.role==="user"&&$e.length>0&&(Ie.push($e),$e=[]),$e.push(Be);return $e.length>0&&Ie.push($e),Ie}),B=Z(()=>F.value.length>0&&c.value.size===F.value.length);function S(J){const Ie=J.find($e=>$e.role==="user");if(Ie&&Ie.content){const $e=Ie.content.slice(0,120);return $e.length<Ie.content.length?$e+"...":$e}return"(no user message)"}function R(J){const Ie=new Set(T.value);Ie.has(J)?Ie.delete(J):Ie.add(J),T.value=Ie}function W(J){u.value=J}function ge(J){u.value=J.id,J.filters.searchQuery!=null&&(p.value=J.filters.searchQuery),J.filters.sortBy&&(f.value=J.filters.sortBy)}function ae(){if(!g.value.trim())return;const J={id:"custom-"+Date.now(),name:g.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};N.value=[...N.value,J],I(),_.value=!1,g.value=""}function se(J){N.value=N.value.filter(Ie=>Ie.id!==J),I(),u.value===J&&(u.value="all")}function re(){u.value="all",p.value="",f.value="last_active",m.value=!1}function X(J){if(!J)return"—";const Ie=Date.now()/1e3-J;if(Ie<60)return"just now";if(Ie<3600){const Be=Math.floor(Ie/60);return`${Be} minute${Be!==1?"s":""} ago`}if(Ie<86400){const Be=Math.floor(Ie/3600);return`${Be} hour${Be!==1?"s":""} ago`}const $e=Math.floor(Ie/86400);return`${$e} day${$e!==1?"s":""} ago`}function fe(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Me(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString()}catch{return""}}function K(J){return J==="user"?"bg-gray-900/50 border border-gray-800":J==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function be(J){return J==="user"?"sess-msg-user":J==="assistant"?"sess-msg-assistant":"sess-msg-system"}function H(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":"badge-warning"}function le(J){return J==="user"?"sess-dot-user":J==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ue(J){return J==="user"?"text-cyan-400":J==="assistant"?"text-indigo-400":"text-gray-500"}function Oe(J){return J?J.length>2e3?J.slice(0,2e3)+`
... (truncated)`:J:""}async function x(){const J=k.value.trim();if(J){M.value=!0;try{let Ie=`/api/sessions/search?q=${encodeURIComponent(J)}&limit=50`;O.value.trim()&&(Ie+=`&channel_id=${encodeURIComponent(O.value.trim())}`),C.value.trim()&&(Ie+=`&user_id=${encodeURIComponent(C.value.trim())}`);const $e=await G.get(Ie);w.value=$e.results||[]}catch{w.value=[]}M.value=!1}}function P(){k.value="",O.value="",C.value="",w.value=null}function U(J){return J?J.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function ne(J){return J==="user"?"fts-result-user":J==="assistant"?"fts-result-assistant":J==="summary"?"fts-result-summary":J==="fts"?"fts-result-fts":J==="channel"?"fts-result-channel":"fts-result-default"}function Q(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":J==="summary"?"badge-warning":J==="fts"?"badge-success":"badge-info"}async function ee(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(J){s.value=J.message}t.value=!1}function ye(){s.value=null,ee()}async function ce(J){if(n.value===J){n.value=null,a.value=null,T.value=new Set;return}n.value=J,a.value=null,i.value=!0,T.value=new Set;const Ie=++l;try{const $e=await G.get(`/api/sessions/${encodeURIComponent(J)}`);Ie===l&&n.value===J&&(a.value=$e)}catch($e){Ie===l&&n.value===J&&(a.value={messages:[],summary:"",error:$e.message||"Failed to load session"})}finally{Ie===l&&(i.value=!1)}}function pe(J){const Ie=new Set(c.value);Ie.has(J)?Ie.delete(J):Ie.add(J),c.value=Ie}function ie(){B.value?c.value=new Set:c.value=new Set(F.value.map(J=>J.channel_id))}function we(J){o.value=J}async function xe(){if(o.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await ee()}catch(J){s.value=J.message||"Failed to clear session"}r.value=!1,o.value=null}}function _e(){d.value=!0}async function oe(){if(c.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await ee()}catch(J){s.value=J.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function z(J,Ie){const $e=`/api/sessions/${encodeURIComponent(J)}/export?format=${Ie}`;try{const Be=await G.getBlob($e),ze=URL.createObjectURL(Be),Ue=document.createElement("a");Ue.href=ze,Ue.download=`session-${J}.${Ie==="text"?"txt":"json"}`,Ue.click(),URL.revokeObjectURL(ze)}catch(Be){s.value=Be.message||"Failed to export session"}}let he=null;function Se(J){J.payload&&J.payload.channel_id&&(clearTimeout(he),he=setTimeout(()=>{if(ee(),n.value&&J.payload.channel_id===n.value){const Ie=n.value,$e=l;G.get(`/api/sessions/${encodeURIComponent(Ie)}`).then(Be=>{$e!==l||n.value!==Ie||(a.value=Be)}).catch(()=>{})}},2e3))}let Ee=!1;function Ne(){Ee||(Ee=!0,ee(),qe.subscribe("events",Se))}Ze(()=>{A(),Ne()}),ks(()=>{Ne()});function ut(){Ee&&(Ee=!1,qe.unsubscribe("events",Se),clearTimeout(he))}return vs(ut),mt(ut),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:B,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:m,filterPresets:v,sortOptions:E,filteredSessions:F,hasActiveFilters:$,customPresets:N,showSavePreset:_,newPresetName:g,threadView:y,threads:te,collapsedThreads:T,ftsQuery:k,ftsChannelId:O,ftsUserId:C,ftsResults:w,ftsSearching:M,formatAge:X,formatTimestamp:fe,formatFullTimestamp:Me,messageClass:K,threadMsgClass:be,roleBadge:H,roleDotClass:le,roleLabelClass:ue,truncateContent:Oe,threadSummary:S,fetchSessions:ee,retry:ye,toggleSession:ce,toggleSelect:pe,toggleSelectAll:ie,confirmClear:we,clearSession:xe,confirmBulkClear:_e,doBulkClear:oe,exportSession:z,applyPreset:W,applyCustomPreset:ge,saveCustomPreset:ae,removeCustomPreset:se,resetFilters:re,toggleThread:R,runFtsSearch:x,clearFtsSearch:P,highlightSnippet:U,ftsResultClass:ne,ftsTypeBadge:Q}}},xw={props:["trace"],template:`
...
`)}const Ew={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h({}),a=h({}),i=h(null),l=h(""),o=h(null),r=h(!1),c=h("create"),d=h(""),u=h(""),p=h(null),f=h(null),m=h(!1),v=h(null),E=h(null),N=h(!1),_=Z(()=>e.value.length),g=Z(()=>e.value.reduce((X,fe)=>X+(fe.execution_count||0),0)),y=Z(()=>e.value.reduce((X,fe)=>X+M(fe.code),0)),T=Z(()=>{if(!l.value)return e.value;const X=l.value.toLowerCase();return e.value.filter(fe=>fe.name.toLowerCase().includes(X)||(fe.description||"").toLowerCase().includes(X))}),k=Z(()=>u.value?u.value.split(`
...
`).length:0}function A(X){return Cw(X)}function I(X){n.value={...n.value,[X]:!n.value[X]}}async function $(X){try{await navigator.clipboard.writeText(X);const fe=e.value.find(Me=>Me.code===X);fe&&(o.value=fe.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function F(X){if(X.key==="Tab"){X.preventDefault();const fe=X.target,Me=fe.selectionStart,K=fe.selectionEnd;u.value=u.value.substring(0,Me)+"    "+u.value.substring(K),Ct(()=>{fe.selectionStart=fe.selectionEnd=Me+4})}}function te(X){const fe=X.target.previousElementSibling;fe&&(fe.scrollTop=X.target.scrollTop)}async function B(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(X){s.value=X.message}t.value=!1}async function S(X){i.value=X,delete a.value[X],a.value={...a.value};try{const fe=await G.post(`/api/skills/${encodeURIComponent(X)}/test`);a.value={...a.value,[X]:fe}}catch(fe){a.value={...a.value,[X]:{result:fe.message,is_error:!0}}}i.value=null}function R(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function W(X){r.value=!0,c.value="edit",d.value=X.name,u.value=X.code||"",p.value=null,f.value=null}function ge(){r.value=!1,p.value=null,f.value=null}async function ae(){p.value=null,f.value=null;const X=d.value.trim(),fe=u.value.trim();if(!X){p.value="Name is required";return}if(!fe){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:X,code:fe}),f.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(X)}`,{code:fe}),f.value="Skill updated successfully"),await B(),setTimeout(()=>{r.value=!1},800)}catch(Me){p.value=Me.message}m.value=!1}function se(X){E.value=X}async function re(){if(E.value){N.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(E.value)}`),await B()}catch(X){Re.error(`Failed to delete skill: ${X.message||"unknown error"}`)}N.value=!1,E.value=null}}return Ze(()=>{B()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:v,deleteTarget:E,deleting:N,enabledCount:_,totalExecutions:g,totalLines:y,displayedSkills:T,editLineCount:k,editorLineNums:O,editValidation:C,highlight:w,truncate:Qc,formatTs:xa,countLines:M,getLineNumbers:A,toggleCode:I,copyCode:$,handleEditorKey:F,syncScroll:te,fetchSkills:B,testSkill:S,showCreate:R,editSkill:W,cancelEdit:ge,saveSkill:ae,confirmDelete:se,doDelete:re}}};class Es extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Aw=/^[A-Za-z_][A-Za-z0-9_]*$/;function $u(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Uu(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Es(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Es(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Es(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Es(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function Rw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Iw(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Es("Server name is required.","name");if(a.length>128||!Aw.test(a))throw new Es("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Es("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=$u(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Es("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Es("An HTTP endpoint is required for this connection.","url");if(d&&!Rw(d))throw new Es("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Es("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=$u(e.allowlistText));const r=Uu(e.headerRows,e.headersRemove,"Header"),c=Uu(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function Ow(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function Lw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Nw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const Pw=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function Mw(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Dw=1e4,Fw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function or(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function $w(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Uw={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),o=h({}),r=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),m=h(or()),v=h(""),E=h(!1);let N=null,_=0,g=!1,y=!1;const T=Pw,k=Z(()=>{var z;return((z=e.value)==null?void 0:z.servers)||[]}),O=Z(()=>{var z;return!!((z=e.value)!=null&&z.enabled)}),C=Z(()=>{var z,he,Se,Ee;return{serverCount:((z=e.value)==null?void 0:z.server_count)||0,enabledCount:((he=e.value)==null?void 0:he.enabled_server_count)||0,connectedCount:((Se=e.value)==null?void 0:Se.connected_count)||0,toolCount:((Ee=e.value)==null?void 0:Ee.published_tool_count)||0}}),w=Z(()=>{var z;return((z=f.value)==null?void 0:z.header_keys)||[]}),M=Z(()=>{var z;return((z=f.value)==null?void 0:z.env_keys)||[]}),A=Z(()=>{var z;return u.value==="edit"&&((z=f.value)==null?void 0:z.transport)==="http"}),I=Z(()=>u.value==="add"||!A.value),$=Z(()=>A.value?"Replace endpoint URL":"Endpoint URL"),F=Z(()=>A.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function te(){B(),N=window.setInterval(()=>S({quiet:!0}),Dw)}function B(){N&&window.clearInterval(N),N=null}async function S({quiet:z=!1}={}){const he=++_;z||(t.value=!0);try{const Se=await G.get("/api/mcp/status");if(he!==_||!g)return;e.value=Se,n.value="";const Ee=new Set((Se.servers||[]).map(Ne=>Ne.name));i.value=new Set([...i.value].filter(Ne=>Ee.has(Ne)))}catch(Se){he===_&&g&&(n.value=Se.message||"Failed to load MCP status")}finally{he===_&&(t.value=!1)}}function R(z){return s.value||a.value.has(z)}function W(z,he){const Se=new Set(a.value);he?Se.add(z):Se.delete(z),a.value=Se}function ge(z){return Lw(z.state)}function ae(z){if(ge(z)==="disabled"){if(!z.enabled)return"Disabled — server switch off";if(!O.value)return"Disabled — global MCP is off"}return Fw[ge(z)]}function se(z){return z.transport==="http"?"Streamable HTTP":"stdio"}function re(z){return z.negotiated_version?`${z.era?`${String(z.era).charAt(0).toUpperCase()}${String(z.era).slice(1)}`:"Protocol"} · ${z.negotiated_version}`:"Not negotiated"}function X(z){return z.discovered_count?`${z.published_count||0} published · ${z.excluded_count||0} excluded`:"No tools discovered"}const fe=h(new Set);async function Me(z,he){if(fe.value.has(z.name))return;const Se=!!he.target.checked,Ee=new Set(fe.value);Ee.add(z.name),fe.value=Ee;try{const Ne=await G.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/enabled`,{enabled:Se});Ne&&Array.isArray(Ne.servers)?e.value=Ne:await S({quiet:!0})}catch(Ne){he.target.checked=!!z.enabled,Re.error(Ne.message||`Failed to toggle ${z.name}`)}finally{const Ne=new Set(fe.value);Ne.delete(z.name),fe.value=Ne}}async function K(z){if(z!==O.value&&!(!z&&!await Qt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await G.post("/api/mcp/enabled",{enabled:z}),Re.success(z?"MCP enabled":"MCP disabled"),await S({quiet:!0})}catch(he){Re.error(he.message||"Failed to update MCP state"),await S({quiet:!0})}finally{s.value=!1}}}async function be(z){W(z.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/reconnect`,{}),Re.success(`Reconnected ${z.name}`)}catch(he){Re.error(he.message||`Failed to reconnect ${z.name}`)}finally{W(z.name,!1),await S({quiet:!0})}}async function H(z){W(z.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(z.name)}/refresh-tools`,{}),Re.success(`Refreshed tools from ${z.name}`),await Oe(z.name,!0)}catch(he){Re.error(he.message||`Failed to refresh ${z.name}`)}finally{W(z.name,!1),await S({quiet:!0})}}async function le(z){if(await Qt({title:`Remove ${z.name}`,message:`Remove this saved MCP server? Its ${z.published_count||0} published tool${z.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){W(z.name,!0);try{await G.del(`/api/mcp/servers/${encodeURIComponent(z.name)}`),Re.success(`Removed ${z.name}`),delete o.value[z.name]}catch(Se){Re.error(Se.message||`Failed to remove ${z.name}`)}finally{W(z.name,!1),await S({quiet:!0})}}}async function ue(z){const he=new Set(i.value);if(he.has(z.name)){he.delete(z.name),i.value=he;return}he.add(z.name),i.value=he,Object.hasOwn(o.value,z.name)||await Oe(z.name)}async function Oe(z,he=!1){if(!he&&Object.hasOwn(o.value,z))return;const Se=new Set(c.value);Se.add(z),c.value=Se,r.value={...r.value,[z]:""};try{const Ee=await G.get(`/api/mcp/servers/${encodeURIComponent(z)}/tools`);o.value={...o.value,[z]:Ee.tools||[]}}catch(Ee){r.value={...r.value,[z]:Ee.message||"Failed to load tools"}}finally{const Ee=new Set(c.value);Ee.delete(z),c.value=Ee}}function x(z){return(o.value[z]||[]).filter(he=>Nw(he,l.value[z]))}function P(z,he){l.value={...l.value,[z]:he}}function U(){u.value="add",p.value="",f.value=null,m.value=or(),v.value="",d.value=!0}function ne(z){u.value="edit",p.value=z.name,f.value=z,m.value={...or(),name:z.name,enabled:!!z.enabled,transport:z.transport||"stdio"},v.value="",d.value=!0}function Q(){E.value||(d.value=!1)}function ee(z){d.value&&Mw(z)}function ye(z){const he=z==="headers"?"headerRows":"envRows";m.value[he].push({key:"",value:""})}function ce(z,he){const Se=z==="headers"?"headerRows":"envRows";m.value[Se].splice(he,1)}function pe(z,he){const Se=z==="headers"?"headersRemove":"envRemove",Ee=m.value[Se];m.value[Se]=Ee.includes(he)?Ee.filter(Ne=>Ne!==he):[...Ee,he]}async function ie(){var he,Se;v.value="";let z;try{z=Iw(m.value,{mode:u.value,originalTransport:((he=f.value)==null?void 0:he.transport)||""})}catch(Ee){v.value=Ee instanceof Es?Ee.message:"Invalid MCP server configuration",await Ct(),(Se=document.querySelector(".mcp-editor"))==null||Se.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Ow(z,f.value)&&!await Qt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){E.value=!0;try{u.value==="add"?await G.post("/api/mcp/servers",z):await G.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,z),Re.success(u.value==="add"?`Saved ${z.name}`:`Updated ${p.value}`),d.value=!1,await S({quiet:!0})}catch(Ee){v.value=Ee.message||"Failed to save MCP server"}finally{E.value=!1}}}let we=null;function xe(z){`${(z==null?void 0:z.event)||""} ${(z==null?void 0:z.type)||""} ${(z==null?void 0:z.tool)||""} ${(z==null?void 0:z.message)||""}`.toLowerCase().includes("mcp")&&(we&&window.clearTimeout(we),we=window.setTimeout(()=>S({quiet:!0}),200))}function _e(){g||(g=!0,y||(qe.subscribe("events",xe),y=!0),S(),te())}function oe(){g=!1,B(),we&&window.clearTimeout(we),we=null,y&&(qe.unsubscribe("events",xe),y=!1)}return Ze(_e),ks(_e),vs(oe),mt(oe),{status:e,loading:t,mutating:s,pageError:n,servers:k,masterEnabled:O,aggregate:C,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:m,formError:v,saving:E,editorGroups:T,configuredHeaderKeys:w,configuredEnvKeys:M,savedHttpEndpoint:A,endpointRequired:I,endpointFieldLabel:$,endpointPlaceholder:F,refreshAll:S,busy:R,serverState:ge,stateLabel:ae,transportLabel:se,protocolLabel:re,toolSummary:X,formatAge:$w,setMasterEnabled:K,togglePending:fe,toggleServerEnabled:Me,reconnect:be,refreshTools:H,removeServer:le,toggleTools:ue,filteredTools:x,setToolQuery:P,openAdd:U,openEdit:ne,closeEditor:Q,jumpToEditorGroup:ee,addSecretRow:ye,removeSecretRow:ce,toggleSecretRemoval:pe,saveServer:ie}}};function Bw(e,t){if(!e||!t)return Mu(e);const s=Mu(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),o=h(null),r=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),v=h(null);let E=null;const N=h(null),_=h(!1),g=h({}),y=h({}),T=h({}),k=h({}),O=new Map,C=h(null),w=Z(()=>e.value.reduce((ae,se)=>ae+(se.chunks||0),0)),M=Z(()=>new Set(e.value.map(se=>se.uploader).filter(Boolean)).size);function A(ae,se){const re=y.value[se];if(!re||re.length===0)return 0;const X=Math.max(...re.map(fe=>fe.char_count||0));return X===0?0:Math.round(ae.char_count/X*100)}async function I(){t.value=!0,s.value=null;try{const ae=await G.get("/api/knowledge");e.value=Array.isArray(ae)?ae:[]}catch(ae){s.value=ae.message}t.value=!1}async function $(ae){if(g.value[ae]){g.value[ae]=!1,C.value=null;return}if(g.value[ae]=!0,Object.prototype.hasOwnProperty.call(y.value,ae))return;if(O.has(ae))return O.get(ae);const se={...k.value,[ae]:!0};k.value=se;const re={...T.value};delete re[ae],T.value=re;const X=G.get(`/api/knowledge/${encodeURIComponent(ae)}/chunks`).then(fe=>{y.value={...y.value,[ae]:Array.isArray(fe)?fe:[]}}).catch(fe=>{T.value={...T.value,[ae]:fe.message||"load failed"}}).finally(()=>{if(O.get(ae)!==X)return;O.delete(ae);const fe={...k.value};delete fe[ae],k.value=fe});return O.set(ae,X),X}let F=0;async function te(){const ae=n.value.trim();if(!ae)return;const se=++F;i.value=!0,o.value=null,l.value=ae;try{const re=await G.get(`/api/knowledge/search?q=${encodeURIComponent(ae)}`);if(se!==F)return;a.value=Array.isArray(re)?re:[]}catch(re){if(se!==F)return;a.value=[],o.value=re.message||"Search failed"}se===F&&(i.value=!1)}function B(){F+=1,i.value=!1,a.value=null,n.value="",o.value=null}async function S(){u.value=null,p.value=null;const ae=c.value.trim(),se=d.value.trim();if(!ae){u.value="Source name is required";return}if(!se){u.value="Content is required";return}f.value=!0;try{const re=await G.post("/api/knowledge",{source:ae,content:se});p.value=`Ingested ${re.chunks||0} chunks from "${ae}"`,c.value="",d.value="",y.value={},await I(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(re){u.value=re.message}f.value=!1}async function R(ae){m.value=ae,v.value=null,E&&(clearTimeout(E),E=null);try{const se=await G.post(`/api/knowledge/${encodeURIComponent(ae)}/reingest`);v.value={source:ae,error:!1,message:`Re-ingested ${se.chunks||0} chunks`},delete y.value[ae],await I(),E=setTimeout(()=>{v.value=null,E=null},3e3)}catch(se){v.value={source:ae,error:!0,message:se.message}}m.value=null}function W(ae){N.value=ae}async function ge(){if(N.value){_.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(N.value)}`),delete y.value[N.value],await I()}catch(ae){Re.error(`Failed to delete source: ${ae.message||"unknown error"}`)}_.value=!1,N.value=null}}return Ze(()=>{I()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:v,deleteTarget:N,deleting:_,expanded:g,sourceChunks:y,chunkErrors:T,loadingChunks:k,selectedChunk:C,totalChunks:w,uploaderCount:M,truncate:Qc,formatTs:xa,highlightTerms:Bw,chunkBarWidth:A,fetchSources:I,toggleSource:$,doSearch:te,clearSearch:B,doIngest:S,doReingest:R,confirmDelete:W,doDelete:ge}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),o=h(!1),r=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),m=h(!1),v=h(null),E=h(null),N=h(new Set),_=h(null),g=h(!1),y=h(!1),T=Z(()=>e.value.reduce((se,re)=>se+re.count,0)),k=Z(()=>N.value.size);function O(se){const re=t.value[se];if(!re)return[];if(!l.value.trim())return re;const X=l.value.trim().toLowerCase();return re.filter(fe=>fe.key.toLowerCase().includes(X)||fe.value&&fe.value.toLowerCase().includes(X))}function C(se,re){return N.value.has(se+"/"+re)}function w(se,re){const X=se+"/"+re,fe=new Set(N.value);fe.has(X)?fe.delete(X):fe.add(X),N.value=fe}function M(se){const re=t.value[se];return!re||re.length===0?!1:re.every(X=>N.value.has(se+"/"+X.key))}function A(se,re){const X=t.value[se];if(!X)return;const fe=new Set(N.value);for(const Me of X){const K=se+"/"+Me.key;re?fe.add(K):fe.delete(K)}N.value=fe}async function I(){s.value=!0,n.value=null;try{const se=await G.get("/api/memory");e.value=Object.entries(se).map(([re,X])=>({name:re,keys:X.keys||[],count:X.count||0}))}catch(se){n.value=se.message}s.value=!1}async function $(se){if(a.value[se]){a.value[se]=!1;return}a.value[se]=!0;const re=e.value.find(fe=>fe.name===se);if(!re||t.value[se]||i.value===se)return;i.value=se;let X;try{const Me=(await G.get(`/api/memory/${encodeURIComponent(se)}`)).entries||{};X=re.keys.map(K=>Object.prototype.hasOwnProperty.call(Me,K)?{key:K,value:Me[K]||"",failed:!1}:{key:K,value:"",failed:!0,error:"Not found in scope"})}catch(fe){X=re.keys.map(Me=>({key:Me,value:"",failed:!0,error:fe.message||"Failed to load"}))}t.value[se]=X,i.value=null}function F(se,re,X){p.value=se+"/"+re,f.value=X}async function te(se,re){m.value=!0,v.value=null;try{await G.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(re)}`,{value:f.value});const X=t.value[se];if(X){const fe=X.find(Me=>Me.key===re);fe&&(fe.value=f.value)}p.value=null}catch(X){v.value=`Failed to save: ${X.message||"unknown error"}`}m.value=!1}async function B(se,re){try{await navigator.clipboard.writeText(re.value),E.value=se+"/"+re.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function S(){d.value=null,u.value=null;const se=r.value.scope.trim(),re=r.value.key.trim(),X=r.value.value.trim();if(!se){d.value="Scope is required";return}if(!re){d.value="Key is required";return}if(!X){d.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(re)}`,{value:X}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await I(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(fe){d.value=fe.message}c.value=!1}function R(se,re){_.value={scope:se,key:re}}async function W(){if(!_.value)return;g.value=!0,v.value=null;const{scope:se,key:re}=_.value;try{await G.del(`/api/memory/${encodeURIComponent(se)}/${encodeURIComponent(re)}`);const X=t.value[se];X&&(t.value[se]=X.filter(K=>K.key!==re));const fe=e.value.find(K=>K.name===se);fe&&(fe.count--,fe.keys=fe.keys.filter(K=>K!==re));const Me=new Set(N.value);Me.delete(se+"/"+re),N.value=Me}catch(X){v.value=`Failed to delete: ${X.message||"unknown error"}`}g.value=!1,_.value=null}function ge(){y.value=!0}async function ae(){g.value=!0,v.value=null;const se=[];for(const re of N.value){const X=re.indexOf("/");se.push({scope:re.slice(0,X),key:re.slice(X+1)})}try{await G.post("/api/memory/bulk-delete",{entries:se}),N.value=new Set,t.value={},await I()}catch(re){v.value=`Bulk delete failed: ${re.message||"unknown error"}`}g.value=!1,y.value=!1}return Ze(()=>{I()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:m,actionError:v,copied:E,selected:N,selectedCount:k,totalEntries:T,deleteTarget:_,deleting:g,showBulkDelete:y,fetchMemory:I,toggleScope:$,startEdit:F,doEdit:te,copyValue:B,doAdd:S,confirmDelete:R,doDelete:W,confirmBulkDelete:ge,doBulkDelete:ae,isSelected:C,toggleSelect:w,isScopeAllSelected:M,toggleSelectAll:A,filteredEntries:O}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h(!1),a=h("sessions"),i=h(null);let l=null;const o=[{key:"sessions",label:"Sessions"},{key:"knowledge",label:"Knowledge"},{key:"trajectories",label:"Trajectories"},{key:"storage",label:"Storage"}],r=Z(()=>{if(!i.value||!i.value.collected_at)return"";try{return new Date(i.value.collected_at).toLocaleTimeString()}catch{return""}}),c=Z(()=>{if(!i.value)return[];const E=i.value,N=E.storage_total_bytes||1;return[{label:"Session Persistence",mb:E.sessions.persist_dir.total_mb,bytes:E.sessions.persist_dir.total_bytes,files:E.sessions.persist_dir.file_count,pct:Math.min(100,Math.round(E.sessions.persist_dir.total_bytes/N*100)),color:"res-bar-blue"},{label:"Knowledge Database",mb:E.knowledge.db_file.total_mb,bytes:E.knowledge.db_file.total_bytes,files:E.knowledge.db_file.file_count,pct:Math.min(100,Math.round(E.knowledge.db_file.total_bytes/N*100)),color:"res-bar-purple"},{label:"Message Trajectories",mb:E.trajectories.message_dir.total_mb,bytes:E.trajectories.message_dir.total_bytes,files:E.trajectories.message_dir.file_count,pct:Math.min(100,Math.round(E.trajectories.message_dir.total_bytes/N*100)),color:"res-bar-emerald"},{label:"Agent Trajectories",mb:E.trajectories.agent_dir.total_mb,bytes:E.trajectories.agent_dir.total_bytes,files:E.trajectories.agent_dir.file_count,pct:Math.min(100,Math.round(E.trajectories.agent_dir.total_bytes/N*100)),color:"res-bar-amber"}]});async function d(){try{const E=await G.get("/api/resource-usage");i.value=E,t.value=null,s.value=!0}catch(E){t.value=E.message||"Failed to load resource usage"}finally{e.value=!1,n.value=!1}}async function u(){n.value=!0,await d()}function p(){e.value=!0,t.value=null,d()}let f=!1;function m(){f||(f=!0,d(),l||(l=setInterval(d,3e4)))}function v(){f&&(f=!1,l&&(clearInterval(l),l=null))}return Ze(m),ks(m),vs(v),mt(v),{hasData:s,loading:e,error:t,refreshing:n,data:i,activeTab:a,tabs:o,collectedAt:r,storageItems:c,fmtNum:wm,refresh:u,retry:p}}},Jw=["INFO","WARNING","ERROR"],Yw=[{id:"all",name:"All Logs",icon:"list",filters:{}},{id:"errors",name:"Errors Only",icon:"error",filters:{level:"ERROR"}},{id:"warnings",name:"Warnings+",icon:"warning",filters:{levels:["WARNING","ERROR"]}},{id:"tools",name:"Tool Activity",icon:"wrench",filters:{hasToolName:!0}},{id:"recent-errors",name:"Recent Errors",icon:"flame",filters:{level:"ERROR",timeRange:"last_1h"}}],rr=[{value:"",label:"All Time"},{value:"last_5m",label:"Last 5 min",seconds:300},{value:"last_15m",label:"Last 15 min",seconds:900},{value:"last_1h",label:"Last 1 hour",seconds:3600},{value:"last_4h",label:"Last 4 hours",seconds:14400},{value:"last_24h",label:"Last 24 hours",seconds:86400}],Qw=[50,100,200,500],Xw={template:`
    ...
    </div>`,setup(){const e=h("live"),t=h([]),s=h(!1),n=h(!0),a=h(""),i=h(""),l=h(!1),o=h(!1),r=h(qe.state||"disconnected"),c=Z(()=>{switch(r.value){case"connected":return"Live";case"connecting":return"Connecting…";case"reconnecting":return"Reconnecting…";default:return"Disconnected"}}),d=h(null),u=h(!1),p=h(null),f=2e3,m=Jw,v=Yw,E=rr,N=h("all"),_=h(""),g=h([]),y=h(!1),T=h(""),k=h([]);function O(){try{const q=localStorage.getItem("odin-log-presets");q&&(g.value=JSON.parse(q))}catch{}}function C(){try{localStorage.setItem("odin-log-presets",JSON.stringify(g.value))}catch{}}const w=Z(()=>a.value!==""||i.value.trim()!==""||_.value!==""),M=Z(()=>{const q=rr.find(de=>de.value===_.value);return q?q.label:""}),A=Z(()=>{if(!l.value||!i.value)return null;try{return new RegExp(i.value,"i"),null}catch(q){return q.message}}),I=24,$=Z(()=>{if(ge.value.length===0)return[];const q=[],de=new Date,Le=3600*1e3;for(let Je=I-1;Je>=0;Je--){const rt=new Date(de.getTime()-(Je+1)*Le),Pt=new Date(de.getTime()-Je*Le);q.push({start:rt,end:Pt,label:S(rt,Pt),shortLabel:Pt.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),total:0,info:0,warnings:0,errors:0})}for(const Je of ge.value){if(!Je._time)continue;const rt=Je._time.getTime();for(const Pt of q)if(rt>=Pt.start.getTime()&&rt<Pt.end.getTime()){Pt.total++,Je.level==="ERROR"?Pt.errors++:Je.level==="WARNING"?Pt.warnings++:Pt.info++;break}}return q}),F=Z(()=>{let q=1;for(const de of $.value)de.total>q&&(q=de.total);return q}),te=Z(()=>{if($.value.length===0)return"";const q=ge.value.map(Je=>Je._time&&Je._time.getTime()).filter(Boolean);if(q.length===0)return"";const de=new Date(Math.min(...q));return`${ge.value.length} shown, oldest ${de.toLocaleTimeString()}`}),B=Z(()=>Math.ceil(I/8));function S(q,de){const Le={hour:"2-digit",minute:"2-digit"};return q.toLocaleTimeString([],Le)+" - "+de.toLocaleTimeString([],Le)}function R(q,de){return!de||!q?"0px":Math.max(2,q/de*100)+"%"}function W(q){const de=ge.value.findIndex(Le=>Le._time&&Le._time.getTime()>=q.start.getTime()&&Le._time.getTime()<q.end.getTime());if(de>=0&&d.value){const Le=d.value.querySelectorAll(".log-line");Le[de]&&(Le[de].scrollIntoView({behavior:"smooth",block:"center"}),n.value=!1)}}const ge=Z(()=>{let q=t.value;if(a.value&&(q=q.filter(de=>(de.level||"INFO")===a.value)),_.value){const de=rr.find(Le=>Le.value===_.value);if(de&&de.seconds){const Le=new Date(Date.now()-de.seconds*1e3);q=q.filter(Je=>Je._time&&Je._time>=Le)}}if(i.value&&!A.value)if(l.value)try{const de=new RegExp(i.value,"i");q=q.filter(Le=>{const Je=Le.text||Le.raw||"",rt=Le.tool||"";return de.test(Je)||de.test(rt)})}catch{}else{const de=i.value.toLowerCase();q=q.filter(Le=>{const Je=(Le.text||Le.raw||"").toLowerCase(),rt=(Le.tool||"").toLowerCase();return Je.includes(de)||rt.includes(de)})}return q});function ae(q){if(q.type==="log"&&q.line)try{const de=typeof q.line=="string"?JSON.parse(q.line):q.line,Le=de.timestamp?new Date(de.timestamp):new Date;return{ts:Le.toLocaleTimeString(),_time:Le,level:de.error?"ERROR":"INFO",text:de.tool_name?`[${de.tool_name}] ${de.result_summary||""}`.trim():de.message||JSON.stringify(de),tool:de.tool_name||"",raw:null}}catch{return{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:String(q.line),tool:"",raw:String(q.line)}}if(q.payload){const de=q.payload,Le=de.timestamp?new Date(de.timestamp):new Date;return{ts:Le.toLocaleTimeString(),_time:Le,level:de.error?"ERROR":"INFO",text:de.tool_name?`[${de.tool_name}] ${de.result_summary||""}`.trim():de.message||JSON.stringify(de),tool:de.tool_name||"",raw:null}}return typeof q=="string"?{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:q,tool:"",raw:q}:{ts:new Date().toLocaleTimeString(),_time:new Date,level:"INFO",text:JSON.stringify(q),tool:"",raw:null}}function se(q){const de=ae(q);if(s.value){k.value.push(de);return}re(de)}function re(q){t.value.push(q),t.value.length>f&&(t.value=t.value.slice(-f)),n.value&&Ct(()=>X())}function X(q=!1){const de=d.value;de&&de.scrollTo({top:de.scrollHeight,behavior:q?"smooth":"instant"})}function fe(){n.value=!0,u.value=!1,Ct(()=>X(!0))}const Me=new Set(["PageUp","PageDown","ArrowUp","ArrowDown","Home","End"," "]);function K(){const q=d.value;if(!q)return;const de=q.scrollHeight-q.scrollTop-q.clientHeight<40;u.value=!n.value&&!de&&t.value.length>0,ue.value&&be()}function be(){const q=d.value;!q||!n.value||q.scrollHeight-q.scrollTop-q.clientHeight>=40&&(n.value=!1,u.value=t.value.length>0)}function H(){n.value&&requestAnimationFrame(be)}function le(q){Me.has(q.key)&&H()}const ue=h(!1);function Oe(){n.value&&(ue.value=!0,requestAnimationFrame(be))}function x(){ue.value&&(ue.value=!1,be())}function P(){n.value&&(u.value=!1,Ct(()=>X()))}function U(){if(s.value=!s.value,!s.value&&k.value.length>0){for(const q of k.value)re(q);k.value=[]}}function ne(){t.value=[],k.value=[],u.value=!1}function Q(){let q;e.value==="search"?q=Ue.value.map(rt=>{const Pt=rt.error?"ERROR":"INFO",Ut=rt.tool_name?`[${rt.tool_name}] `:"";return`${rt.timestamp||""} ${Pt} ${Ut}${rt.result_summary||rt.message||""}`}).join(`
`):q=ge.value.map(rt=>`${rt.ts} ${rt.level} ${rt.text}`).join(`
`);const de=new Blob([q],{type:"text/plain"}),Le=URL.createObjectURL(de),Je=document.createElement("a");Je.href=Le,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL(Le)}function ee(q,de){const Le=`${q.ts} ${q.level} ${q.text||q.raw||""}`;navigator.clipboard.writeText(Le).then(()=>{p.value=de,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function ye(q){a.value=a.value===q?"":q,N.value="all"}function ce(q){return q.level==="ERROR"?"log-line-error":q.level==="WARNING"?"log-line-warning":"text-gray-300"}function pe(q){return q==="ERROR"?"text-red-500 font-semibold":q==="WARNING"?"text-yellow-500":"text-blue-500"}function ie(q){return q==="ERROR"?"log-chip-error":q==="WARNING"?"log-chip-warning":"log-chip-info"}function we(q){N.value=q.id;const de=q.filters;a.value=de.level||"",_.value=de.timeRange||"",i.value=de.text||"",de.levels&&(a.value=de.levels[0]||""),de.hasToolName&&(i.value="")}function xe(q){N.value=q.id,a.value=q.filters.level||"",_.value=q.filters.timeRange||"",i.value=q.filters.text||""}function _e(){if(!T.value.trim())return;const q={id:"custom-"+Date.now(),name:T.value.trim(),filters:{level:a.value,timeRange:_.value,text:i.value}};g.value=[...g.value,q],C(),y.value=!1,T.value=""}function oe(q){g.value=g.value.filter(de=>de.id!==q),C(),N.value===q&&(N.value="all")}const z=h("all"),he=h(""),Se=h(""),Ee=h(""),Ne=h(""),ut=h(""),J=h(100),Ie=Qw,$e=h(!1),Be=h(!1),ze=h(""),Ue=h([]),ot=h(null),Nt=h(null);function St(){e.value="search",ot.value||In()}async function In(){try{ot.value=await G.get("/api/logs/stats")}catch{}}function zs(){const q=ut.value;if(!q){Ee.value="",Ne.value="";return}const Le={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[q];if(Le){const Je=new Date(Date.now()-Le*1e3);Ee.value=Ns(Je),Ne.value=""}}function Ns(q){const de=Le=>String(Le).padStart(2,"0");return`${q.getFullYear()}-${de(q.getMonth()+1)}-${de(q.getDate())}T${de(q.getHours())}:${de(q.getMinutes())}`}function Ft(q){if(!q)return"";const de=new Date(q);return isNaN(de.getTime())?"":de.toISOString()}async function qt(){$e.value=!0,ze.value="",Be.value=!0,Nt.value=null;try{const q=new URLSearchParams;z.value&&z.value!=="all"&&q.set("level",z.value),he.value&&q.set("tool",he.value),Se.value&&q.set("q",Se.value);const de=Ft(Ee.value),Le=Ft(Ne.value);de&&q.set("start",de),Le&&q.set("end",Le),q.set("limit",String(J.value));const Je=await G.get(`/api/logs/search?${q.toString()}`);Ue.value=Je.entries||[]}catch(q){ze.value=q.message||"Search failed",Ue.value=[]}finally{$e.value=!1}}function an(){z.value="all",he.value="",Se.value="",Ee.value="",Ne.value="",ut.value="",J.value=100,Ue.value=[],Be.value=!1,ze.value="",Nt.value=null}function js(q){Nt.value=Nt.value===q?null:q}function Vs(q){if(!q.timestamp)return"";try{return new Date(q.timestamp).toLocaleString()}catch{return q.timestamp}}function qs(q){return q.type==="web_action"?`${q.status||""} (${q.execution_time_ms||0}ms)`:(q.result_summary||"").slice(0,200)}function Ps(q){return q.error?"log-line-error":"text-gray-300"}function On(q){try{return JSON.stringify(q,null,2)}catch{return String(q)}}let vt=null,Ms=null,Gs=!1;function Qe(){Gs||(Gs=!0,qe.subscribe("logs",se),o.value=qe.connected,r.value=qe.state||"disconnected",vt=qe.onStateChange,Ms=(q,de)=>{r.value=q,o.value=q==="connected",vt&&vt(q,de)},qe.onStateChange=Ms)}function $t(){Gs&&(Gs=!1,qe.unsubscribe("logs",se),qe.onStateChange===Ms&&(qe.onStateChange=vt),Ms=null,vt=null)}return Ze(()=>{O(),window.addEventListener("pointerup",x),window.addEventListener("pointercancel",x)}),ks(Qe),vs($t),mt(()=>{$t(),window.removeEventListener("pointerup",x),window.removeEventListener("pointercancel",x)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:o,wsState:r,wsStateLabel:c,logContainer:d,filteredLogs:ge,pauseBuffer:k,showJumpBottom:u,copiedIndex:p,regexError:A,levels:m,logPresets:v,timeRanges:E,timeRange:_,activeLogPreset:N,customLogPresets:g,showSaveLogPreset:y,newLogPresetName:T,hasActiveLogFilters:w,timeRangeLabel:M,timelineBuckets:$,timelineMax:F,timelineSpanLabel:te,timelineLabelSkip:B,togglePause:U,clearLogs:ne,exportLogs:Q,logLineClass:ce,levelClass:pe,levelChipClass:ie,toggleLevel:ye,copyLine:ee,jumpToBottom:fe,onScroll:K,onUserScrollIntent:H,onUserScrollKey:le,onAutoScrollToggle:P,onPointerDown:Oe,applyLogPreset:we,applyCustomLogPreset:xe,saveLogCustomPreset:_e,removeLogCustomPreset:oe,segmentHeight:R,jumpToTimelineBucket:W,searchLevel:z,searchTool:he,searchKeyword:Se,searchStart:Ee,searchEnd:Ne,searchTimePreset:ut,searchLimit:J,searchLimits:Ie,searching:$e,searchRan:Be,searchError:ze,searchResults:Ue,searchStats:ot,expandedSearch:Nt,switchToSearch:St,runSearch:qt,clearSearchFilters:an,toggleSearchExpand:js,formatSearchTs:Vs,searchEntryText:qs,searchLogLineClass:Ps,formatJson:On,applySearchTimePreset:zs}}};function Sl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const ek=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function tk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Ga=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],sk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},cr=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),nk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Bu(e){return nk.some(t=>e===t||e.startsWith(`${t}.`))}const Rm="odin_config_center_expanded_v1",Im="odin_config_center_category_v1",ak=50,ik=650,dr=()=>G.get("/api/config/meta");function sa(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Ni(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Aa(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function lk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function ok(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Om(e,t){if(Ni(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return sa(t);const n={};for(const[a,i]of Object.entries(t)){const l=Om(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function rk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Om(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Lm(e,t,s,n){if(Ni(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Lm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function ck(){try{const e=JSON.parse(localStorage.getItem(Rm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function dk(){try{const e=localStorage.getItem(Im);return Ga.some(t=>t.key===e)?e:Ga[0].key}catch{return Ga[0].key}}const uk={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),o=h(null),r=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(dk()),m=h(ck()),v=h({}),E=h({}),N=h(""),_=h({}),g=h({}),y=h([]),T=h([]),k=h(!1),O=h(!1),C=h(!1);let w=null,M=null,A={path:null,at:0},I=0;const $=Z(()=>{var b;return(((b=t.value)==null?void 0:b.fields)||[]).filter(D=>!cr.has(D.path.split(".")[0])&&!Bu(D.path))}),F=Z(()=>new Map($.value.map(b=>[b.path,b]))),te=Z(()=>ge.value.reduce((b,D)=>b+D.sections.length,0)),B=Z(()=>$.value.length),S=Z(()=>ek),R=Z(()=>y.value.length>0),W=Z(()=>T.value.length>0),ge=Z(()=>{if(!e.value)return[];const b=new Set(Ga.flatMap(me=>me.sections)),D=Ga.map(me=>({...me,sections:me.sections.filter(De=>Object.hasOwn(e.value,De)&&!cr.has(De))})).filter(me=>me.sections.length),V=Object.keys(e.value).filter(me=>!b.has(me)&&!cr.has(me));return V.length&&D.push({key:"other",label:"Other",icon:"folder",sections:V}),D}),ae=Z(()=>e.value?{...e.value,...v.value}:null),se=Z(()=>{if(!e.value)return[];const b=[];for(const[D,V]of Object.entries(v.value))Lm(e.value[D],V,D,b);return b.filter(D=>!Ni(D.oldVal,D.newVal)).map(D=>{const V=P(D.path);return{...D,label:(V==null?void 0:V.label)||Aa(D.path.split(".").at(-1)),apply_mode:(V==null?void 0:V.apply_mode)||ye(D.path.split(".")[0])}})}),re=Z(()=>se.value.length>0),X=Z(()=>se.value.length),fe=Z(()=>new Set(se.value.map(b=>b.path.split(".")[0])).size),Me=Z(()=>!!u.value||p.value!=="all"),K=Z(()=>{const b={...g.value};for(const D of se.value){const V=P(D.path),me=wa(V,D.newVal);me&&(b[D.path]=me)}return b}),be=Z(()=>Object.keys(K.value).length>0),H=Z(()=>e.value?(Me.value?ge.value:ge.value.filter(D=>D.key===f.value)).map(D=>({...D,sections:D.sections.filter(V=>$e(V))})).filter(D=>D.sections.length):[]),le=Z(()=>{const b=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],D=new Map(b.map(V=>[V,[]]));for(const V of se.value){const me=D.has(V.apply_mode)?V.apply_mode:"restart";D.get(me).push(V)}return b.filter(V=>D.get(V).length).map(V=>({key:V,label:gs(V),entries:D.get(V)}))}),ue=Z(()=>se.value.filter(b=>b.apply_mode==="restart").length),Oe=Z(()=>$.value.filter(b=>b.pending_restart)),x=Z(()=>Oe.value.length);function P(b){const D=F.value.get(b);return D?{...D,apply_details:Sl([D])}:null}function U(b){const D=`${b}.`;return $.value.filter(V=>V.path===b||V.path.startsWith(D))}function ne(b){return U(b).length}function Q(b){return Aa(b)}function ee(b){const D=U(b);if(!D.length)return`${Aa(b)} configuration.`;const V=D.find(gt=>gt.sensitivity==="public"&&gt.description)||D.find(gt=>gt.description),me=(V==null?void 0:V.description)||"";return me.match(/setting for (.+)\.$/i)?`${Aa(b)} settings and runtime behaviour.`:me}function ye(b){const D=[...new Set(U(b).map(V=>V.apply_mode))];return D.length===1?D[0]:D.includes("restart")?"restart":D.includes("activation_required")?"activation_required":D[0]||"restart"}function ce(b){const D=[...new Set(U(b).map(V=>gs(V.apply_mode)))];return D.length?D.length===1?D[0]:`Mixed apply behaviour: ${D.join(" · ")}`:""}function pe(b){return Sl(U(b))}function ie(b){var D;return Object.hasOwn(v.value,b)?v.value[b]:(D=e.value)==null?void 0:D[b]}function we(){const b=ie("mcp")||{},D=Object.keys(b.servers||{}).length;return`${b.enabled?"Globally enabled":"Globally disabled"} · ${D} configured server${D===1?"":"s"}.`}function xe(b,D){return D.split(".").reduce((V,me)=>V==null?void 0:V[me],b)}function _e(b){const D=ae.value;return U(b).filter(V=>Bu(V.path)?!1:V.path.split(".").length<=2?!0:!V.path.includes(".*")).map(V=>({...V,key:V.path.split(".").at(-1),value:xe(D,V.path),apply_details:Sl([V]),editor:V.path==="agents.final_warning_iterations"?"warning-chips":null}))}function oe(b){const D=b.path.split(".");return D.length>2?D.slice(0,2).join("."):null}function z(b){const D=new Map;for(const V of _e(b)){const me=oe(V),De=me||`${b}.__root`;D.has(De)||D.set(De,{key:De,path:me,entries:[]}),D.get(De).entries.push(V)}return[...D.values()].map(V=>{const me=V.entries.find(De=>De.group_description);return{...V,label:V.path?Aa(V.path.split(".").at(-1)):null,description:(me==null?void 0:me.group_description)||null,apply_details:Sl(V.entries),runtime_summaries:Se(V.entries)}})}function he(b){return{save:b.save_effect||(b.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:b.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[b.apply_mode]||"Effective runtime state is not currently observable."}}function Se(b){const D=new Map;for(const V of b){const me=he(V),De=`${V.apply_mode}|${me.save}|${me.runtime}`;D.has(De)||D.set(De,{key:De,label:gs(V.apply_mode),save:me.save,runtime:me.runtime})}return[...D.values()]}function Ee(b){if(Ne(b))return b.runtime_effect||b.activation_policy||"";if(b.apply_mode==="activation_required"){const D=b.activation_policy||b.runtime_effect;return D?`Not active after saving. No activation control exists in this release. ${D}`:"Not active after saving; no activation control exists in this release."}return""}function Ne(b){return b.action_available===!0&&!!(b.action_label&&b.action_endpoint)}async function ut(b){if(Ne(b))try{if(Nt(b.path))throw new Error("Save this setting before applying its action.");const D=String(b.action_method||"POST").toLowerCase(),V={post:G.post.bind(G),put:G.put.bind(G),delete:G.del.bind(G)}[D];if(!V)throw new Error("Unsupported configuration action");await V(b.action_endpoint,b.action_body||void 0),await Y(),es("success",`${b.action_label} completed.`)}catch(D){es("error",D.message||`${b.action_label} failed`)}}function J(b,D){return[b.label,b.path,b.description,...b.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(D)}function Ie(b){const D=u.value.trim().toLowerCase();return D?U(b).filter(V=>J(V,D)):[]}function $e(b){const D=U(b);if(p.value!=="all"&&!D.some(me=>me.apply_state===p.value))return!1;const V=u.value.trim().toLowerCase();return!V||`${Q(b)} ${b}`.toLowerCase().includes(V)?!0:D.some(me=>J(me,V))}function Be(b,D){return U(b).filter(V=>V.apply_state===D).length}function ze(b){return b==="all"?B.value:$.value.filter(D=>D.apply_state===b).length}function Ue(b){const D=b.sections.flatMap(V=>U(V));return{fields:D.length,modified:se.value.filter(V=>b.sections.includes(V.path.split(".")[0])).length,pending_restart:D.filter(V=>V.apply_state==="pending_restart").length,invalid:D.filter(V=>V.apply_state==="invalid").length,dormant:D.filter(V=>V.apply_state==="dormant").length}}function ot(b){var D;return Object.hasOwn(v.value,b)&&!Ni((D=e.value)==null?void 0:D[b],v.value[b])}function Nt(b){return se.value.some(D=>D.path===b||D.path.startsWith(`${b}.`))}function St(b){f.value=b,u.value="",p.value="all";try{localStorage.setItem(Im,b)}catch{}}function In(b){p.value=b}function zs(){u.value="",p.value="all"}function Ns(b){var D;return((D=ge.value.find(V=>V.sections.includes(b)))==null?void 0:D.sections)||[]}function Ft(b){const D=Ns(b),V=D.find(me=>m.value[me]===!0);return V||D.find(me=>m.value[me]!==!1)||null}function qt(b){return u.value&&!C.value&&$e(b)?!0:C.value?Ft(b)===b:Object.hasOwn(m.value,b)?m.value[b]===!0:!0}function an(b){const D=!qt(b);if(C.value){const V={...m.value};for(const me of Ns(b))V[me]===!0&&(V[me]=!1);V[b]=D,m.value=V;return}m.value={...m.value,[b]:D}}function js(){y.value.push(sa(v.value)),y.value.length>ak&&y.value.shift(),T.value=[]}function Vs(){re.value&&(js(),v.value={},g.value={},k.value=!1)}function qs(b,D=!1){const V=Date.now();if(D&&A.path===b&&V-A.at<ik){A.at=V;return}js(),A={path:b,at:V}}function Ps(b,D,V){if(!D.length)return V;const me=sa(b??{});let De=me;for(let gt=0;gt<D.length-1;gt+=1){const it=D[gt];De[it]=sa(De[it]??{}),De=De[it]}return De[D.at(-1)]=V,me}function On(b){var D;return Object.hasOwn(v.value,b)?v.value[b]:sa((D=e.value)==null?void 0:D[b])}function vt(b,D,V={}){var di;const[me,...De]=b.path.split(".");qs(b.path,!!V.coalesce);const gt=On(me),it=De.length?Ps(gt,De,D):D,Ks={...v.value};if(Ni(it,(di=e.value)==null?void 0:di[me])?delete Ks[me]:Ks[me]=it,v.value=Ks,g.value[b.path]){const rd={...g.value};delete rd[b.path],g.value=rd}}function Ms(b){A={path:null,at:0},E.value={...E.value,[b]:String(xe(ae.value,b)??"")}}function Gs(b){if(A={path:null,at:0},!Object.hasOwn(E.value,b))return;const D={...E.value};delete D[b],E.value=D}function Qe(b){const D=E.value[b.path];if(A={path:null,at:0},D===""){g.value={...g.value,[b.path]:"Enter a number."};return}const V=Number(D);if(Number.isNaN(V)||b.type==="integer"&&!Number.isInteger(V)){g.value={...g.value,[b.path]:b.type==="integer"?"Enter a whole number.":"Enter a number."};return}const me={...E.value};delete me[b.path],E.value=me,vt(b,V,{coalesce:!0})}function $t(b){return Object.hasOwn(E.value,b.path)?E.value[b.path]:b.value??""}function q(b,D){if(E.value={...E.value,[b.path]:D},D===""){g.value={...g.value,[b.path]:"Enter a number."};return}const V=Number(D);if(!Number.isFinite(V)||b.type==="integer"&&!Number.isInteger(V)){g.value={...g.value,[b.path]:b.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(g.value[b.path]){const me={...g.value};delete me[b.path],g.value=me}vt(b,V,{coalesce:!0})}function de(b){const D=Number.parseInt(N.value,10);if(!Number.isInteger(D)||D<1){g.value={...g.value,[b.path]:"Warning thresholds must be positive whole numbers."};return}const V=[...new Set([...b.value||[],D])].sort((me,De)=>De-me);N.value="",vt(b,V)}function Le(b,D){vt(b,(b.value||[]).filter(V=>V!==D))}function Je(b){return b.apply_mode==="live_read"?"Odin reads the saved file value on next use.":b.apply_mode==="live_for_new_work"?"New work uses the saved file value.":b.apply_mode==="live_apply"?b.apply_handler?`Apply the saved value through ${b.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":b.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":b.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":b.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function rt(b){return b.type==="array"&&Array.isArray(b.value)&&!b.structured_container&&!b.structured_container_child&&b.sensitivity==="public"&&b.value.every(D=>["string","number","boolean"].includes(typeof D))}function Pt(b){const D=String(_.value[b.path]??"").trim();if(!D)return;const V=[...new Set([...b.value||[],D])];_.value={..._.value,[b.path]:""},vt(b,V)}function Ut(b,D){vt(b,(b.value||[]).filter(V=>V!==D))}function wa(b,D){var me;if(!b)return null;if((me=b.enum)!=null&&me.length&&!b.enum.includes(D))return`Choose one of: ${b.enum.join(", ")}`;if(b.path==="agents.final_warning_iterations"&&(!Array.isArray(D)||!D.length))return"Add at least one warning threshold.";const V=b.constraints||{};if((b.type==="integer"||b.type==="number")&&typeof D=="number"){if(V.minimum!==void 0&&D<V.minimum)return`Must be at least ${V.minimum}${b.unit?` ${b.unit}`:""}`;if(V.maximum!==void 0&&D>V.maximum)return`Must be at most ${V.maximum}${b.unit?` ${b.unit}`:""}`}return null}function Ds(b){return K.value[b.path]||null}function ri(b){const D=`${b}.`;return Object.keys(K.value).some(V=>V===b||V.startsWith(D))}function ka(){y.value.length&&(T.value.push(sa(v.value)),v.value=y.value.pop(),g.value={},E.value={},A={path:null,at:0})}function Kn(){T.value.length&&(y.value.push(sa(v.value)),v.value=T.value.pop(),g.value={},E.value={},A={path:null,at:0})}function Sa(){!re.value||be.value||(k.value=!0,O.value=!1)}function Wn(){k.value=!1}function Ln(){Vs()}function gs(b){return sk[b]||Aa(b||"unknown")}function ln(b){return`apply-${String(b||"unknown").replaceAll("_","-")}`}function j(b){return`cfgc-field-${b.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function ke(b){return`${j(b)}-input`}function Ae(b){const D=document.getElementById(j(b))||document.getElementById(j(b.split(".").slice(0,2).join(".")));D==null||D.scrollIntoView({behavior:"smooth",block:"center"})}function es(b,D){l.value={type:b,message:D},window.setTimeout(()=>{var V;((V=l.value)==null?void 0:V.message)===D&&(l.value=null)},3500)}function Zn(){r.value=!1,p.value="pending_restart",u.value="";const b=tk(n.value);b&&(b.scrollTop=0)}function Jn(){r.value=!1}function Yn(b=1800){M&&window.clearTimeout(M),M=window.setTimeout(ci,b)}async function ci(){if(c.value){if(I+=1,I>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await dr(),x.value===0){c.value=!1,d.value=null,es("success","Odin restarted and the saved startup settings are active.");return}}catch{}Yn(2e3)}}async function Te(){if(!c.value){d.value=null;try{await G.post("/api/restart",{}),c.value=!0,I=0,r.value=!1,Yn()}catch(b){d.value=b.message||"Odin could not schedule a restart."}}}async function L(){if(!(!re.value||be.value||a.value)){a.value=!0;try{const b=rk(e.value,v.value),D=await G.put("/api/config",b);e.value=D,v.value={},y.value=[],T.value=[],g.value={},k.value=!1;try{t.value=await dr(),o.value=null,r.value=x.value>0,es("success",x.value?`Configuration saved. ${x.value} setting${x.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(V){o.value=V.message||"Unknown metadata error.",es("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(b){es("error",b.message||"Configuration could not be saved")}finally{a.value=!1}}}async function Y(){var b,D;if(!re.value){s.value=!0,i.value=null;try{const V=await G.get("/api/config"),me=await dr();e.value=V,t.value=me,o.value=null;const De=ge.value;if(De.some(gt=>gt.key===f.value)||(f.value=((b=De[0])==null?void 0:b.key)||Ga[0].key),C.value){const it=(((D=De.find(Ks=>Ks.key===f.value))==null?void 0:D.sections)||[]).find(Ks=>m.value[Ks]===!0);m.value=it?{...m.value,[it]:!0}:{}}}catch(V){i.value=V.message||"Unknown configuration error"}finally{s.value=!1}}}function ve(b){if(k.value||!(b.ctrlKey||b.metaKey))return;const D=b.target;D instanceof HTMLElement&&(D.matches("input, textarea, select")||D.isContentEditable)||(!b.shiftKey&&b.key.toLowerCase()==="z"?(b.preventDefault(),ka()):(b.key.toLowerCase()==="y"||b.shiftKey&&b.key.toLowerCase()==="z")&&(b.preventDefault(),Kn()))}function Pe(b){C.value=b.matches}return ls(m,b=>{try{localStorage.setItem(Rm,JSON.stringify(b))}catch{}},{deep:!0}),Ze(()=>{var b;Y(),document.addEventListener("keydown",ve),w=window.matchMedia("(max-width: 760px)"),Pe(w),(b=w.addEventListener)==null||b.call(w,"change",Pe)}),mt(()=>{var b;document.removeEventListener("keydown",ve),(b=w==null?void 0:w.removeEventListener)==null||b.call(w,"change",Pe),M&&window.clearTimeout(M)}),{config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:k,mobileOverflowOpen:O,warningThresholdInput:N,arrayInputs:_,healthFilters:S,visibleCategories:ge,displayGroups:H,reviewGroups:le,sectionCount:te,fieldCount:B,hasChanges:re,changeCount:X,changedSectionCount:fe,hasDraftErrors:be,canUndo:R,canRedo:W,globalFilterActive:Me,reviewRestartCount:ue,pendingRestartCount:x,pendingRestartFields:Oe,healthCount:ze,categoryStats:Ue,selectCategory:St,selectHealthFilter:In,clearFilters:zs,sectionLabel:Q,sectionDescription:ee,sectionFieldCount:ne,sectionHealthCount:Be,sectionApplySummary:ce,sectionApplyDetails:pe,sectionEntries:_e,fieldGroups:z,sectionSearchHits:Ie,mcpConfigSummary:we,fieldRuntimeCopy:he,fieldSpecificRuntimeNote:Ee,hasHonestAction:Ne,runFieldAction:ut,sectionChanged:ot,fieldChanged:Nt,isSectionExpanded:qt,toggleSection:an,discardAllDrafts:Vs,setFieldValue:vt,setNumberFieldValue:q,numberInputValue:$t,beginInputEdit:Ms,endTextInputEdit:Gs,endInputEdit:Qe,addWarningThreshold:de,removeWarningThreshold:Le,isScalarArray:rt,addScalarArrayItem:Pt,removeScalarArrayItem:Ut,fieldError:Ds,sectionHasErrors:ri,undo:ka,redo:Kn,openReview:Sa,closeReview:Wn,mobileCancel:Ln,applyModeLabel:gs,applyClass:ln,compactValue:lk,formatValue:ok,structuredApplyCopy:Je,fieldId:j,fieldInputId:ke,focusField:Ae,fetchConfig:Y,saveConfig:L,restartOdin:Te,restartLater:Jn,reviewPendingRestart:Zn}}},pk=/^\d{15,25}$/;function Nm(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Pm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
