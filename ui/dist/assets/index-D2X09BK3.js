...
... (truncated)`:s}function Du(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function wm(e){return e==null||!isFinite(e)?"—":Number(e).toLocaleString()}function km(e){return e==null||!isFinite(e)?"—":e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}const Sm=Symbol("agent-detail-cancelled"),iw=15e3;function lw(e,{timeoutMs:t,timeoutLabel:s,scheduleTimeout:n,cancelTimeout:a}){const i=typeof AbortController=="function"?new AbortController:null;let l=null,o=!1,r,c;const d=new Promise((f,m)=>{r=f,c=m});function u(f,m){o||(o=!0,l!==null&&a(l),l=null,(f?r:c)(m))}let p;try{p=e(i==null?void 0:i.signal)}catch(f){u(!1,f)}return o||Promise.resolve(p).then(f=>u(!0,f),f=>u(!1,f)),!o&&Number.isFinite(t)&&t>0&&(l=n(()=>{const f=Math.max(1,Math.round(t/1e3));u(!1,new Error(`${s} request timed out after ${f}s`)),i==null||i.abort()},t)),{promise:d,cancel(){u(!0,Sm),i==null||i.abort()}}}function Tm({state:e,requestDetail:t,timeoutMs:s=iw,detailLabel:n="Agent detail",scheduleTimeout:a=globalThis.setTimeout.bind(globalThis),cancelTimeout:i=globalThis.clearTimeout.bind(globalThis)}){if(!e||typeof e!="object")throw new TypeError("agent detail state is required");if(typeof t!="function")throw new TypeError("requestDetail must be a function");let l=null;function o(){const p=l;l=null,p==null||p.cancel()}function r(p,{initial:f,coalesce:m}){if(!p)return Promise.resolve();if(m&&l&&l.agentId===p&&e.detailId===p)return l.promise;o();const b={agentId:p,cancel:null,promise:null};l=b,f?(e.detail=null,e.detailError=null,e.detailLoading=!0):e.detail===null&&e.detailError===null&&(e.detailLoading=!0);const E=lw(I=>t(p,{signal:I}),{timeoutMs:s,timeoutLabel:n,scheduleTimeout:a,cancelTimeout:i});return b.cancel=E.cancel,b.promise=(async()=>{let I=null,T=null;try{I=await E.promise}catch(v){T=v}I!==Sm&&(l!==b||e.detailId!==p||(l=null,!T&&(I===null||typeof I!="object")&&(T=new Error(`${n} response was empty or invalid`)),T?e.detail===null&&(e.detailError=(T==null?void 0:T.message)||`Failed to load ${n.toLowerCase()}`):(e.detail=I,e.detailError=null),e.detailLoading=!1))})(),b.promise}function c(p){return e.detailId=p,r(p,{initial:!0,coalesce:!1})}function d(){const p=e.detailId;return p?r(p,{initial:!1,coalesce:!0}):Promise.resolve()}function u(){o(),e.detailId=null,e.detail=null,e.detailError=null,e.detailLoading=!1}return{open:c,refresh:d,close:u,hasInFlight:()=>l!==null}}function ow({isEnabled:e,refreshList:t,hasOpenDetail:s,refreshDetail:n,intervalMs:a=5e3,scheduleInterval:i=globalThis.setInterval.bind(globalThis),cancelInterval:l=globalThis.clearInterval.bind(globalThis)}){let o=null;function r(){e()&&(t(),s()&&n())}function c(){o!==null&&(l(o),o=null)}function d(){c(),e()&&(o=i(r,a))}function u(){e()?d():c()}return{start:d,stop:c,sync:u,isRunning:()=>o!==null}}const rw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(!1),a=h({description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""}),i=h(!1),l=h(null),o=h(null),r=K(()=>hw(a.value.run_at));as(()=>a.value.run_at,()=>{o.value=null});const c=K(()=>{var B;const Z=r.value;return Z.state==="ok"?Z.instant:Z.state==="ambiguous"&&o.value!==null&&((B=Z.options[o.value])==null?void 0:B.instant)||null}),d=K(()=>{const Z=c.value;return Z?`${Z.toLocaleString()} local — ${Z.toISOString()} UTC`:""}),u=h(null),p=h(!1),f=[{label:"Every hour",expr:"0 * * * *"},{label:"Every 6h",expr:"0 */6 * * *"},{label:"Daily 9am",expr:"0 9 * * *"},{label:"Weekly Mon",expr:"0 9 * * 1"},{label:"Every 30m",expr:"*/30 * * * *"}],m=h(null),b=h(null),E=h(null),I=h(null),T=h(null),v=h(null),_=h([]),C=h(!1),g=h("");let S=0;const y=K(()=>e.value.filter(Z=>Z.cron&&!Z.one_time).length),w=K(()=>e.value.filter(Z=>Z.one_time).length),M=K(()=>e.value.filter(Z=>Z.trigger).length),F=K(()=>e.value.filter(Z=>Z.paused).length),P=K(()=>e.value.filter(Z=>Z.consecutive_failures>0).length);function A(Z){if(!Z)return"-";const B=Date.now(),le=(new Date(Z).getTime()-B)/1e3;if(le<0)return"overdue";if(le<60)return"in < 1 min";if(le<3600)return`in ${Math.floor(le/60)} min`;if(le<86400){const ye=Math.floor(le/3600),Be=Math.floor(le%3600/60);return Be>0?`in ${ye}h ${Be}m`:`in ${ye}h`}const _e=Math.floor(le/86400);return`in ${_e} day${_e!==1?"s":""}`}function V(Z){return Z==null?"-":Z<1e3?`${Z}ms`:Z<6e4?`${(Z/1e3).toFixed(1)}s`:si(Z/1e3)}function X(Z=a.value.cron){a.value.cron=Z,Pu(a.value,"cron"),u.value=null}function U(Z=a.value.run_at){a.value.run_at=Z,Pu(a.value,"run_at"),u.value=null}async function L(){const Z=a.value.cron.trim();if(Z){p.value=!0;try{u.value=await G.post("/api/schedules/validate-cron",{expression:Z})}catch(B){u.value={valid:!1,error:B.message}}p.value=!1}}async function O(){t.value=!0,s.value=null;try{e.value=await G.get("/api/schedules")}catch(Z){s.value=Z.message}t.value=!1}async function W(Z){if(v.value===Z){v.value=null,_.value=[];return}v.value=Z,C.value=!0,_.value=[];const B=++S;try{const ie=await G.get(`/api/schedules/${encodeURIComponent(Z)}/history?limit=10`);if(B!==S||v.value!==Z)return;_.value=ie,g.value=""}catch(ie){if(B!==S||v.value!==Z)return;_.value=[],g.value=ie.message||"Failed to load execution history"}B===S&&(C.value=!1)}async function Ce(){l.value=null;const Z=a.value;if(!Z.description.trim()){l.value="Description is required";return}if(!Z.channel_id.trim()){l.value="Channel ID is required";return}if(!Z.cron.trim()&&!Z.run_at.trim()){l.value="Cron expression or run_at time is required";return}if(Z.cron.trim()&&Z.run_at.trim()){l.value="Choose either Cron or One-Time, not both";return}const B={description:Z.description.trim(),action:Z.action,channel_id:Z.channel_id.trim()};if(Z.cron.trim()&&(B.cron=Z.cron.trim()),Z.run_at.trim()){const ie=r.value;if(ie.state==="nonexistent"){l.value="That local time does not exist (daylight saving gap)";return}if(ie.state==="invalid"){l.value="One-time run time is not a valid date";return}const le=c.value;if(ie.state==="ambiguous"&&o.value===null){l.value="That local time happens twice — choose which occurrence to use";return}if(!le){l.value="One-time run time could not be resolved";return}B.run_at=le.toISOString()}if(Z.action==="reminder"&&Z.message.trim()&&(B.message=Z.message.trim()),Z.action==="check"&&(Z.tool_name.trim()&&(B.tool_name=Z.tool_name.trim()),Z.report_format&&(B.report_format=Z.report_format),Z.tool_input_str.trim()))try{B.tool_input=JSON.parse(Z.tool_input_str.trim())}catch{l.value="Tool input must be valid JSON";return}i.value=!0;try{await G.post("/api/schedules",B),Ie.success("Schedule created"),a.value={description:"",action:"reminder",channel_id:"",cron:"",run_at:"",message:"",tool_name:"",tool_input_str:"",report_format:""},u.value=null,n.value=!1,await O()}catch(ie){l.value=ie.message}i.value=!1}async function Ee(Z){m.value=Z;try{const B=await G.post(`/api/schedules/${encodeURIComponent(Z)}/run`);if(B.status==="failure")Ie.error(`Execution failed: ${B.error||"unknown error"}`);else{const ie=B.warning?`Executed (${B.warning})`:"Executed successfully";Ie.success(ie)}await O()}catch(B){Ie.error(B.message||"Failed to trigger")}m.value=null}async function oe(Z){E.value=Z.id;const B=!Z.paused;try{await G.put(`/api/schedules/${encodeURIComponent(Z.id)}`,{paused:B}),Ie.success(B?"Schedule paused":"Schedule resumed"),await O()}catch(ie){Ie.error(ie.message||"Failed to update schedule")}E.value=null}async function be(Z,B){T.value=Z.id;try{await G.put(`/api/schedules/${encodeURIComponent(Z.id)}`,{report_format:B}),Ie.success(B?"Structured report enabled":"Plain-text report enabled")}catch(ie){Ie.error(`Update failed: ${ie.message}`)}finally{await O(),T.value=null}}async function se(Z){I.value=Z;try{await G.post(`/api/schedules/${encodeURIComponent(Z)}/reset-failures`),Ie.success("Failure counters reset"),await O()}catch(B){Ie.error(B.message||"Failed to reset")}I.value=null}async function ge(Z){const B=e.value.find(le=>le.id===Z);if(await Zt({title:"Delete schedule",message:`Delete "${(B==null?void 0:B.description)||Z}"? This cannot be undone.`,confirmLabel:"Delete",danger:!0})){b.value=Z;try{await G.del(`/api/schedules/${encodeURIComponent(Z)}`),Ie.success("Schedule deleted"),await O()}catch(le){Ie.error(le.message||"Failed to delete schedule")}b.value=null}}return Ze(()=>{O()}),{schedules:e,loading:t,error:s,showCreate:n,form:a,creating:i,createError:l,runAtUtcPreview:d,runAtAnalysis:r,runAtOccurrence:o,cronResult:u,validatingCron:p,cronPresets:f,runningId:m,deletingId:b,togglingId:E,resettingId:I,reportUpdatingId:T,expandedId:v,history:_,historyLoading:C,historyError:g,cronCount:y,oneTimeCount:w,webhookCount:M,pausedCount:F,failingCount:P,formatTs:ba,formatAge:xm,formatFuture:A,formatMs:V,formatDuration:si,onCronInput:X,onRunAtInput:U,validateCron:L,toggleExpand:W,fetchSchedules:O,doCreate:Ce,doRunNow:Ee,doTogglePause:oe,doUpdateReportFormat:be,doResetFailures:se,doDelete:ge}}},Cm=[{id:"live",label:"Live",component:nw},{id:"agents",label:"Agents",component:rw},{id:"loops",label:"Loops",component:cw},{id:"processes",label:"Processes",component:dw},{id:"schedules",label:"Schedules",component:mw}],gw={components:{TabbedPage:Uo},setup(){return{tabs:Cm}},template:'<tabbed-page :tabs="tabs" default-tab="live" group-label="Operations" />'},vw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(null),a=h(null),i=h(!1);let l=0;const o=h(null),r=h(!1),c=h(new Set),d=h(!1),u=h("all"),p=h(""),f=h("last_active"),m=h(!1),b=Fu,E=bw,I=h([]),T=h(!1),v=h(""),_=h("flat"),C=h(new Set),g=h(""),S=h(""),y=h(""),w=h(null),M=h(!1);function F(){try{const J=localStorage.getItem("odin-session-presets");J&&(I.value=JSON.parse(J))}catch{}}function P(){try{localStorage.setItem("odin-session-presets",JSON.stringify(I.value))}catch{}}const A=K(()=>p.value.trim()!==""||u.value!=="all"),V=K(()=>{let J=[...e.value];const Te=Fu.find(He=>He.id===u.value),Le=Te?Te.filters:{};if(Le.source&&(J=J.filter(He=>He.source===Le.source)),Le.minMessages&&(J=J.filter(He=>He.message_count>=Le.minMessages)),Le.hasCompaction&&(J=J.filter(He=>He.has_summary)),Le.maxAge!=null){const He=Date.now()/1e3;J=J.filter(mt=>mt.last_active&&He-mt.last_active<=Le.maxAge)}if(p.value.trim()){const He=p.value.toLowerCase().trim();J=J.filter(mt=>(mt.channel_id||"").toLowerCase().includes(He)||(mt.last_user_id||"").toLowerCase().includes(He)||(mt.source||"").toLowerCase().includes(He))}const Pe=f.value,Ge=m.value?1:-1;return J.sort((He,mt)=>{const Yt=He[Pe]||0,Ds=mt[Pe]||0;return(Yt-Ds)*Ge}),J}),X=K(()=>{if(!a.value||!a.value.messages)return[];const J=a.value.messages;if(J.length===0)return[];const Te=[];let Le=[];for(const Pe of J)Pe.role==="user"&&Le.length>0&&(Te.push(Le),Le=[]),Le.push(Pe);return Le.length>0&&Te.push(Le),Te}),U=K(()=>V.value.length>0&&c.value.size===V.value.length);function L(J){const Te=J.find(Le=>Le.role==="user");if(Te&&Te.content){const Le=Te.content.slice(0,120);return Le.length<Te.content.length?Le+"...":Le}return"(no user message)"}function O(J){const Te=new Set(C.value);Te.has(J)?Te.delete(J):Te.add(J),C.value=Te}function W(J){u.value=J}function Ce(J){u.value=J.id,J.filters.searchQuery!=null&&(p.value=J.filters.searchQuery),J.filters.sortBy&&(f.value=J.filters.sortBy)}function Ee(){if(!v.value.trim())return;const J={id:"custom-"+Date.now(),name:v.value.trim(),filters:{searchQuery:p.value,sortBy:f.value}};I.value=[...I.value,J],P(),T.value=!1,v.value=""}function oe(J){I.value=I.value.filter(Te=>Te.id!==J),P(),u.value===J&&(u.value="all")}function be(){u.value="all",p.value="",f.value="last_active",m.value=!1}function se(J){if(!J)return"—";const Te=Date.now()/1e3-J;if(Te<60)return"just now";if(Te<3600){const Pe=Math.floor(Te/60);return`${Pe} minute${Pe!==1?"s":""} ago`}if(Te<86400){const Pe=Math.floor(Te/3600);return`${Pe} hour${Pe!==1?"s":""} ago`}const Le=Math.floor(Te/86400);return`${Le} day${Le!==1?"s":""} ago`}function ge(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Z(J){if(!J)return"";try{return new Date(J*1e3).toLocaleString()}catch{return""}}function B(J){return J==="user"?"bg-gray-900/50 border border-gray-800":J==="assistant"?"bg-indigo-950/30 border border-indigo-900/30":"bg-gray-900/30 border border-gray-800/50"}function ie(J){return J==="user"?"sess-msg-user":J==="assistant"?"sess-msg-assistant":"sess-msg-system"}function le(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":"badge-warning"}function _e(J){return J==="user"?"sess-dot-user":J==="assistant"?"sess-dot-assistant":"sess-dot-system"}function ye(J){return J==="user"?"text-cyan-400":J==="assistant"?"text-indigo-400":"text-gray-500"}function Be(J){return J?J.length>2e3?J.slice(0,2e3)+`
... (truncated)`:J:""}async function k(){const J=g.value.trim();if(J){M.value=!0;try{let Te=`/api/sessions/search?q=${encodeURIComponent(J)}&limit=50`;S.value.trim()&&(Te+=`&channel_id=${encodeURIComponent(S.value.trim())}`),y.value.trim()&&(Te+=`&user_id=${encodeURIComponent(y.value.trim())}`);const Le=await G.get(Te);w.value=Le.results||[]}catch{w.value=[]}M.value=!1}}function N(){g.value="",S.value="",y.value="",w.value=null}function $(J){return J?J.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&gt;&gt;&gt;/g,'<mark class="fts-highlight">').replace(/&lt;&lt;&lt;/g,"</mark>"):""}function te(J){return J==="user"?"fts-result-user":J==="assistant"?"fts-result-assistant":J==="summary"?"fts-result-summary":J==="fts"?"fts-result-fts":J==="channel"?"fts-result-channel":"fts-result-default"}function Y(J){return J==="user"?"badge-info":J==="assistant"?"badge-success":J==="summary"?"badge-warning":J==="fts"?"badge-success":"badge-info"}async function ee(){t.value=!0,s.value=null;try{e.value=await G.get("/api/sessions")}catch(J){s.value=J.message}t.value=!1}function he(){s.value=null,ee()}async function ce(J){if(n.value===J){n.value=null,a.value=null,C.value=new Set;return}n.value=J,a.value=null,i.value=!0,C.value=new Set;const Te=++l;try{const Le=await G.get(`/api/sessions/${encodeURIComponent(J)}`);Te===l&&n.value===J&&(a.value=Le)}catch(Le){Te===l&&n.value===J&&(a.value={messages:[],summary:"",error:Le.message||"Failed to load session"})}finally{Te===l&&(i.value=!1)}}function re(J){const Te=new Set(c.value);Te.has(J)?Te.delete(J):Te.add(J),c.value=Te}function ne(){U.value?c.value=new Set:c.value=new Set(V.value.map(J=>J.channel_id))}function ae(J){o.value=J}async function me(){if(o.value){r.value=!0;try{await G.del(`/api/sessions/${encodeURIComponent(o.value)}`),n.value===o.value&&(n.value=null,a.value=null),c.value.delete(o.value),await ee()}catch(J){s.value=J.message||"Failed to clear session"}r.value=!1,o.value=null}}function xe(){d.value=!0}async function Oe(){if(c.value.size!==0){r.value=!0;try{await G.post("/api/sessions/clear-bulk",{channel_ids:[...c.value]}),c.value.has(n.value)&&(n.value=null,a.value=null),c.value=new Set,await ee()}catch(J){s.value=J.message||"Failed to clear sessions"}r.value=!1,d.value=!1}}async function H(J,Te){const Le=`/api/sessions/${encodeURIComponent(J)}/export?format=${Te}`;try{const Pe=await G.getBlob(Le),Ge=URL.createObjectURL(Pe),He=document.createElement("a");He.href=Ge,He.download=`session-${J}.${Te==="text"?"txt":"json"}`,He.click(),URL.revokeObjectURL(Ge)}catch(Pe){s.value=Pe.message||"Failed to export session"}}let de=null;function we(J){J.payload&&J.payload.channel_id&&(clearTimeout(de),de=setTimeout(()=>{if(ee(),n.value&&J.payload.channel_id===n.value){const Te=n.value,Le=l;G.get(`/api/sessions/${encodeURIComponent(Te)}`).then(Pe=>{Le!==l||n.value!==Te||(a.value=Pe)}).catch(()=>{})}},2e3))}let Re=!1;function Me(){Re||(Re=!0,ee(),Ve.subscribe("events",we))}Ze(()=>{F(),Me()}),ws(()=>{Me()});function dt(){Re&&(Re=!1,Ve.unsubscribe("events",we),clearTimeout(de))}return ks(dt),xt(dt),{sessions:e,loading:t,error:s,expandedId:n,detail:a,detailLoading:i,clearTarget:o,clearing:r,selected:c,allSelected:U,bulkClearing:d,activePreset:u,searchQuery:p,sortBy:f,sortAsc:m,filterPresets:b,sortOptions:E,filteredSessions:V,hasActiveFilters:A,customPresets:I,showSavePreset:T,newPresetName:v,threadView:_,threads:X,collapsedThreads:C,ftsQuery:g,ftsChannelId:S,ftsUserId:y,ftsResults:w,ftsSearching:M,formatAge:se,formatTimestamp:ge,formatFullTimestamp:Z,messageClass:B,threadMsgClass:ie,roleBadge:le,roleDotClass:_e,roleLabelClass:ye,truncateContent:Be,threadSummary:L,fetchSessions:ee,retry:he,toggleSession:ce,toggleSelect:re,toggleSelectAll:ne,confirmClear:ae,clearSession:me,confirmBulkClear:xe,doBulkClear:Oe,exportSession:H,applyPreset:W,applyCustomPreset:Ce,saveCustomPreset:Ee,removeCustomPreset:oe,resetFilters:be,toggleThread:O,runFtsSearch:k,clearFtsSearch:N,highlightSnippet:$,ftsResultClass:te,ftsTypeBadge:Y}}},xw={props:["trace"],template:`
  ...
  `,setup(){const e=h(!0),t=h(null),s=h(!1),n=h({by_user:{},by_channel:{},by_tool:{},recent:[],pricing:{}}),a=h({requests:0,input_tokens:0,output_tokens:0,total_tokens:0,cost_usd:0}),i=h("user");let l=null;const o=[{key:"user",label:"By User"},{key:"channel",label:"By Channel"},{key:"tool",label:"By Tool"},{key:"recent",label:"Recent"}],r=K(()=>[...n.value.recent||[]].reverse()),c=async()=>{try{const m=await G.get("/api/usage");n.value=m,a.value=m.totals||a.value,t.value=null,s.value=!0}catch(m){t.value=m.message}finally{e.value=!1}},d=()=>{e.value=!0,c()};let u=!1;function p(){u||(u=!0,c(),l||(l=setInterval(c,15e3)))}function f(){u&&(u=!1,l&&(clearInterval(l),l=null))}return Ze(p),ws(p),ks(f),xt(f),{hasData:s,loading:e,error:t,data:n,totals:a,activeTab:i,tabs:o,recentReversed:r,fmtNum:wm,formatTime:ym,retry:d}}},Em=[{id:"audit",label:"Audit",component:vw},{id:"sessions",label:"Sessions",component:yw},{id:"traces",label:"Traces",component:_w},{id:"usage",label:"Usage",component:ww}],kw={components:{TabbedPage:Uo},setup(){return{tabs:Em}},template:'<tabbed-page :tabs="tabs" default-tab="audit" group-label="History" />'},lr=[{id:"system",label:"System & Commands",icon:"terminal",match:e=>/^(run_command|run_script|read_file|write_file|list_directory|search_files|manage_process|file_|post_file)/.test(e)},{id:"devops",label:"DevOps & Infrastructure",icon:"server",match:e=>/^(git_ops|docker_ops|kubectl|terraform_ops|http_probe)/.test(e)},{id:"agents",label:"Agents & Orchestration",icon:"bot",match:e=>/^(spawn_agent|send_to_agent|wait_for_agents|get_agent_results|kill_agent|list_agents|spawn_loop_agents|collect_loop_agents)/.test(e)},{id:"workflow",label:"Workflows & Tasks",icon:"workflow",match:e=>/^(delegate_task|cancel_task|list_tasks|schedule_|start_loop|stop_loop|list_loops|delete_schedule|list_schedules|update_schedule|parse_time)/.test(e)},{id:"network",label:"Network & Web",icon:"globe",match:e=>/^(web_|browser_|search_web|fetch_url|http_)/.test(e)},{id:"knowledge",label:"Knowledge & Search",icon:"book",match:e=>/^(search_knowledge|ingest_|knowledge_|search_history|search_audit|bulk_ingest|delete_knowledge|list_knowledge)/.test(e)},{id:"discord",label:"Discord & Admin",icon:"message",match:e=>/^(send_|add_reaction|create_poll|purge_|discord_|embed_|read_channel|set_permission)/.test(e)},{id:"skills",label:"Skills",icon:"puzzle",match:e=>/^(create_skill|edit_skill|delete_skill|enable_skill|disable_skill|install_skill|export_skill|skill_status|invoke_skill|list_skills)/.test(e)},{id:"memory",label:"Memory & State",icon:"brain",match:e=>/^(memory_manage|list_manage)/.test(e)},{id:"ai",label:"AI & Generation",icon:"sparkles",match:e=>/^(generate_|analyze_|claude_|vision_|comfyui_)/.test(e)},{id:"integrations",label:"Integrations",icon:"link",match:e=>/^(issue_tracker|slack_|grafana_|mcp_)/.test(e)},{id:"other",label:"Other Tools",icon:"wrench",match:()=>!0}],Sw={template:`
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h({}),i=h({}),l=h("cards"),o=h(null),r=h(!0),c=h(new Set),d={disabled:"Disabled by operator",unavailable:"Unavailable — required backend is not configured",global_disabled:"Global tools disabled"};function u(y){return y.source!=="builtin"?"":d[y.state]||""}function p(y,w){const M=y&&Array.isArray(y.tools)?y.tools:null;if(r.value=y?!!y.global_enabled:!0,!M){e.value=w.map(A=>({...A,source:A.name.startsWith("mcp_")?"mcp":A.is_core?"builtin":"skill"}));return}const F=new Set(M.map(A=>A.name)),P=w.filter(A=>!F.has(A.name)).map(A=>({...A,source:A.name.startsWith("mcp_")?"mcp":"skill",enabled:!0,state:null}));e.value=[...M.map(A=>({...A,source:"builtin"})),...P]}async function f(y,w){if(c.value.has(y.name))return;const M=!!w.target.checked,F=new Set(c.value);F.add(y.name),c.value=F;try{const P=await G.post(`/api/tools/builtins/${encodeURIComponent(y.name)}/enabled`,{enabled:M});p(P,e.value),s.value=null;try{const A=await G.get("/api/tools");p(P,A)}catch(A){console.warn("Built-in toggle committed; visible catalog refresh failed",A)}}catch(P){w.target.checked=!!y.enabled,s.value=P.message||`Failed to toggle ${y.name}`}finally{const P=new Set(c.value);P.delete(y.name),c.value=P}}const m=K(()=>e.value.filter(y=>y.source==="builtin"&&y.is_core).length),b=K(()=>e.value.filter(y=>y.source==="skill").length),E=K(()=>Object.values(a.value).reduce((y,w)=>y+w,0));function I(y){for(const w of lr)if(w.id!=="other"&&w.match(y))return w.id;return"other"}const T=K(()=>{let y=e.value;if(n.value){const w=n.value.toLowerCase();y=y.filter(M=>M.name.toLowerCase().includes(w)||(M.description||"").toLowerCase().includes(w))}return o.value&&(y=y.filter(w=>I(w.name)===o.value)),y}),v=K(()=>{const y=new Set;for(const w of e.value)y.add(I(w.name));return lr.filter(w=>y.has(w.id))}),_=K(()=>{const y=T.value,w={};for(const F of y){const P=I(F.name);w[P]||(w[P]=[]),w[P].push(F)}const M=[];for(const F of lr)w[F.id]&&w[F.id].length>0&&M.push({label:F.label,icon:F.icon,tools:w[F.id].sort((P,A)=>P.name.localeCompare(A.name))});return M});function C(y){i.value={...i.value,[y]:!i.value[y]}}async function g(){t.value=!0,s.value=null;try{const[y,w,M]=await Promise.all([G.get("/api/tools"),G.get("/api/tools/stats").catch(()=>({})),G.get("/api/tools/builtins").catch(()=>null)]);p(M,y),a.value=w||{}}catch(y){s.value=y.message}t.value=!1}function S(){g()}return Ze(()=>{g()}),{tools:e,loading:t,error:s,search:n,stats:a,expanded:i,viewMode:l,activeCategory:o,globalEnabled:r,togglePending:c,coreCount:m,skillCount:b,totalUsage:E,filteredTools:T,groupedTools:_,usedCategories:v,stateBadge:u,toggleBuiltinTool:f,truncate:Qc,toggleExpand:C,refresh:S}}};function Tw(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");t=t.replace(/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,'<span class="sk-str">$1</span>'),t=t.replace(/(#[^\n]*)/g,'<span class="sk-cmt">$1</span>');const s="\\b(def|class|return|if|elif|else|for|while|import|from|as|try|except|finally|raise|with|async|await|yield|pass|break|continue|and|or|not|in|is|None|True|False|self|lambda)\\b";t=t.replace(new RegExp(s,"g"),'<span class="sk-kw">$1</span>');const n="\\b(print|len|range|str|int|float|list|dict|set|tuple|type|isinstance|hasattr|getattr|setattr|super|property|staticmethod|classmethod|enumerate|zip|map|filter|sorted|reversed|any|all|min|max|sum|abs|round|open|format)\\b";return t=t.replace(new RegExp(n,"g"),'<span class="sk-builtin">$1</span>'),t=t.replace(/(@\w+)/g,'<span class="sk-dec">$1</span>'),t=t.replace(/\b(\d+\.?\d*)\b/g,'<span class="sk-num">$1</span>'),t}function Cw(e){if(!e)return"1";const t=e.split(`
...
`).length:0}function F(se){return Cw(se)}function P(se){n.value={...n.value,[se]:!n.value[se]}}async function A(se){try{await navigator.clipboard.writeText(se);const ge=e.value.find(Z=>Z.code===se);ge&&(o.value=ge.name,setTimeout(()=>{o.value=null},2e3))}catch{}}function V(se){if(se.key==="Tab"){se.preventDefault();const ge=se.target,Z=ge.selectionStart,B=ge.selectionEnd;u.value=u.value.substring(0,Z)+"    "+u.value.substring(B),Ct(()=>{ge.selectionStart=ge.selectionEnd=Z+4})}}function X(se){const ge=se.target.previousElementSibling;ge&&(ge.scrollTop=se.target.scrollTop)}async function U(){t.value=!0,s.value=null;try{e.value=await G.get("/api/skills")}catch(se){s.value=se.message}t.value=!1}async function L(se){i.value=se,delete a.value[se],a.value={...a.value};try{const ge=await G.post(`/api/skills/${encodeURIComponent(se)}/test`);a.value={...a.value,[se]:ge}}catch(ge){a.value={...a.value,[se]:{result:ge.message,is_error:!0}}}i.value=null}function O(){r.value=!0,c.value="create",d.value="",u.value="",p.value=null,f.value=null}function W(se){r.value=!0,c.value="edit",d.value=se.name,u.value=se.code||"",p.value=null,f.value=null}function Ce(){r.value=!1,p.value=null,f.value=null}async function Ee(){p.value=null,f.value=null;const se=d.value.trim(),ge=u.value.trim();if(!se){p.value="Name is required";return}if(!ge){p.value="Code is required";return}m.value=!0;try{c.value==="create"?(await G.post("/api/skills",{name:se,code:ge}),f.value="Skill created successfully"):(await G.put(`/api/skills/${encodeURIComponent(se)}`,{code:ge}),f.value="Skill updated successfully"),await U(),setTimeout(()=>{r.value=!1},800)}catch(Z){p.value=Z.message}m.value=!1}function oe(se){E.value=se}async function be(){if(E.value){I.value=!0;try{await G.del(`/api/skills/${encodeURIComponent(E.value)}`),await U()}catch(se){Ie.error(`Failed to delete skill: ${se.message||"unknown error"}`)}I.value=!1,E.value=null}}return Ze(()=>{U()}),{skills:e,loading:t,error:s,showCode:n,testResults:a,testing:i,search:l,copied:o,editing:r,editMode:c,editName:d,editCode:u,editError:p,editSuccess:f,saving:m,editorRef:b,deleteTarget:E,deleting:I,enabledCount:T,totalExecutions:v,totalLines:_,displayedSkills:C,editLineCount:g,editorLineNums:S,editValidation:y,highlight:w,truncate:Qc,formatTs:ba,countLines:M,getLineNumbers:F,toggleCode:P,copyCode:A,handleEditorKey:V,syncScroll:X,fetchSkills:U,testSkill:L,showCreate:O,editSkill:W,cancelEdit:Ce,saveSkill:Ee,confirmDelete:oe,doDelete:be}}};class Rs extends Error{constructor(t,s=""){super(t),this.name="MCPFormError",this.field=s}}const Aw=/^[A-Za-z_][A-Za-z0-9_]*$/;function $u(e){return String(e||"").split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function Uu(e,t,s){const n={},a=[...new Set((t||[]).map(l=>String(l)))],i=new Set(a);for(const l of e||[]){const o=String((l==null?void 0:l.key)||"").trim(),r=String((l==null?void 0:l.value)??"");if(!(!o&&!r)){if(!o)throw new Rs(`${s} key is required when a value is entered.`,"authentication");if(/[\r\n\0]/.test(o))throw new Rs(`${s} keys cannot contain line breaks or NUL bytes.`,"authentication");if(Object.hasOwn(n,o))throw new Rs(`${s} key “${o}” appears more than once.`,"authentication");if(i.has(o))throw new Rs(`${s} key “${o}” cannot be replaced and removed in the same save.`,"authentication");n[o]=r}}return{set:n,remove:a}}function Rw(e){try{const t=new URL(e);return(t.protocol==="http:"||t.protocol==="https:")&&!!t.hostname}catch{return!1}}function Iw(e,{mode:t="add",originalTransport:s=""}={}){const n=t==="add",a=String(e.name||"").trim();if(!a)throw new Rs("Server name is required.","name");if(a.length>128||!Aw.test(a))throw new Rs("Use at most 128 letters, digits, or underscores, with no leading digit.","name");const i=e.transport==="http"?"http":"stdio",l=!n&&!!s&&i!==s,o={enabled:!!e.enabled,transport:i};if(n&&(o.name=a),i==="stdio"){const d=String(e.command||"").trim();if((n||l)&&!d)throw new Rs("An executable path is required for a new stdio connection.","command");if(d&&(o.command=d),(n||e.replaceArgs)&&(o.args=$u(e.argsText)),n||e.replaceCwd){const u=String(e.cwd||"").trim();if(u&&(!u.startsWith("/")||u.includes("\0")))throw new Rs("Working directory must be an absolute path.","cwd");o.cwd=u}}else{const d=String(e.url||"").trim();if((n||l)&&!d)throw new Rs("An HTTP endpoint is required for this connection.","url");if(d&&!Rw(d))throw new Rs("Endpoint must be a valid http:// or https:// URL.","url");d&&(o.url=d)}if(n||e.replaceTimeout){const d=Number(e.timeoutSeconds);if(!Number.isInteger(d)||d<1||d>3600)throw new Rs("Timeout must be a whole number from 1 to 3600 seconds.","timeout");o.timeout_seconds=d}(n||e.replaceAllowlist)&&(o.tool_allowlist=$u(e.allowlistText));const r=Uu(e.headerRows,e.headersRemove,"Header"),c=Uu(e.envRows,e.envRemove,"Environment variable");return Object.keys(r.set).length&&(o.headers_set=r.set),r.remove.length&&(o.headers_remove=r.remove),Object.keys(c.set).length&&(o.env_set=c.set),c.remove.length&&(o.env_remove=c.remove),o}function Ow(e,t){return t?e.transport!==t.transport||!!e.enabled!=!!t.enabled?!0:Object.keys(e).some(s=>!["enabled","transport"].includes(s)):!1}function Lw(e){const t=String(e||"").toLowerCase();return["disabled","connecting","connected","stale","error","blocked"].includes(t)?t:"error"}function Nw(e,t){const s=String(t||"").trim().toLowerCase();return s?[e==null?void 0:e.original_name,e==null?void 0:e.published_name,e==null?void 0:e.description,e==null?void 0:e.exclusion_reason].filter(Boolean).some(n=>String(n).toLowerCase().includes(s)):!0}const Mw=Object.freeze([{id:"identity",label:"Identity"},{id:"transport",label:"Transport"},{id:"authentication",label:"Authentication"},{id:"limits",label:"Limits"}]);function Dw(e,{root:t=document,reducedMotion:s=typeof window<"u"&&(n=>(n=window.matchMedia)==null?void 0:n.call(window,"(prefers-reduced-motion: reduce)").matches)()}={}){var l;const a=t.querySelector(".mcp-editor-groups"),i=a==null?void 0:a.querySelector(`#mcp-form-${e}`);return i?(i.scrollIntoView({behavior:s?"auto":"smooth",block:"start",inline:"nearest"}),(l=i.querySelector("[data-mcp-form-heading]"))==null||l.focus({preventScroll:!0}),!0):!1}const Pw=1e4,Fw=Object.freeze({disabled:"Disabled",connecting:"Connecting",connected:"Connected",stale:"Stale",error:"Error",blocked:"Blocked"});function or(){return{name:"",enabled:!0,transport:"stdio",command:"",argsText:"",cwd:"",url:"",timeoutSeconds:120,allowlistText:"",replaceArgs:!1,replaceCwd:!1,replaceTimeout:!1,replaceAllowlist:!1,headerRows:[],envRows:[],headersRemove:[],envRemove:[]}}function $w(e){if(e==null)return"Never";const t=Math.max(0,Number(e)||0);return t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:t<86400?`${Math.round(t/3600)}h ago`:`${Math.round(t/86400)}d ago`}const Uw={template:`
  ...
  `,setup(){const e=h(null),t=h(!1),s=h(!1),n=h(""),a=h(new Set),i=h(new Set),l=h({}),o=h({}),r=h({}),c=h(new Set),d=h(!1),u=h("add"),p=h(""),f=h(null),m=h(or()),b=h(""),E=h(!1);let I=null,T=0,v=!1,_=!1;const C=Mw,g=K(()=>{var H;return((H=e.value)==null?void 0:H.servers)||[]}),S=K(()=>{var H;return!!((H=e.value)!=null&&H.enabled)}),y=K(()=>{var H,de,we,Re;return{serverCount:((H=e.value)==null?void 0:H.server_count)||0,enabledCount:((de=e.value)==null?void 0:de.enabled_server_count)||0,connectedCount:((we=e.value)==null?void 0:we.connected_count)||0,toolCount:((Re=e.value)==null?void 0:Re.published_tool_count)||0}}),w=K(()=>{var H;return((H=f.value)==null?void 0:H.header_keys)||[]}),M=K(()=>{var H;return((H=f.value)==null?void 0:H.env_keys)||[]}),F=K(()=>{var H;return u.value==="edit"&&((H=f.value)==null?void 0:H.transport)==="http"}),P=K(()=>u.value==="add"||!F.value),A=K(()=>F.value?"Replace endpoint URL":"Endpoint URL"),V=K(()=>F.value?"Leave blank to keep the saved endpoint":"https://mcp.example.com/mcp");function X(){U(),I=window.setInterval(()=>L({quiet:!0}),Pw)}function U(){I&&window.clearInterval(I),I=null}async function L({quiet:H=!1}={}){const de=++T;H||(t.value=!0);try{const we=await G.get("/api/mcp/status");if(de!==T||!v)return;e.value=we,n.value="";const Re=new Set((we.servers||[]).map(Me=>Me.name));i.value=new Set([...i.value].filter(Me=>Re.has(Me)))}catch(we){de===T&&v&&(n.value=we.message||"Failed to load MCP status")}finally{de===T&&(t.value=!1)}}function O(H){return s.value||a.value.has(H)}function W(H,de){const we=new Set(a.value);de?we.add(H):we.delete(H),a.value=we}function Ce(H){return Lw(H.state)}function Ee(H){if(Ce(H)==="disabled"){if(!H.enabled)return"Disabled — server switch off";if(!S.value)return"Disabled — global MCP is off"}return Fw[Ce(H)]}function oe(H){return H.transport==="http"?"Streamable HTTP":"stdio"}function be(H){return H.negotiated_version?`${H.era?`${String(H.era).charAt(0).toUpperCase()}${String(H.era).slice(1)}`:"Protocol"} · ${H.negotiated_version}`:"Not negotiated"}function se(H){return H.discovered_count?`${H.published_count||0} published · ${H.excluded_count||0} excluded`:"No tools discovered"}const ge=h(new Set);async function Z(H,de){if(ge.value.has(H.name))return;const we=!!de.target.checked,Re=new Set(ge.value);Re.add(H.name),ge.value=Re;try{const Me=await G.post(`/api/mcp/servers/${encodeURIComponent(H.name)}/enabled`,{enabled:we});Me&&Array.isArray(Me.servers)?e.value=Me:await L({quiet:!0})}catch(Me){de.target.checked=!!H.enabled,Ie.error(Me.message||`Failed to toggle ${H.name}`)}finally{const Me=new Set(ge.value);Me.delete(H.name),ge.value=Me}}async function B(H){if(H!==S.value&&!(!H&&!await Zt({title:"Disable MCP tool publication",message:"Disable MCP globally? All MCP tools will be unpublished immediately and active transports will be stopped. Saved server configuration remains.",confirmLabel:"Disable MCP",danger:!0}))){s.value=!0;try{await G.post("/api/mcp/enabled",{enabled:H}),Ie.success(H?"MCP enabled":"MCP disabled"),await L({quiet:!0})}catch(de){Ie.error(de.message||"Failed to update MCP state"),await L({quiet:!0})}finally{s.value=!1}}}async function ie(H){W(H.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(H.name)}/reconnect`,{}),Ie.success(`Reconnected ${H.name}`)}catch(de){Ie.error(de.message||`Failed to reconnect ${H.name}`)}finally{W(H.name,!1),await L({quiet:!0})}}async function le(H){W(H.name,!0);try{await G.post(`/api/mcp/servers/${encodeURIComponent(H.name)}/refresh-tools`,{}),Ie.success(`Refreshed tools from ${H.name}`),await Be(H.name,!0)}catch(de){Ie.error(de.message||`Failed to refresh ${H.name}`)}finally{W(H.name,!1),await L({quiet:!0})}}async function _e(H){if(await Zt({title:`Remove ${H.name}`,message:`Remove this saved MCP server? Its ${H.published_count||0} published tool${H.published_count===1?"":"s"} will disappear immediately and configured authentication keys will be deleted. This cannot be undone.`,confirmLabel:"Remove server",danger:!0})){W(H.name,!0);try{await G.del(`/api/mcp/servers/${encodeURIComponent(H.name)}`),Ie.success(`Removed ${H.name}`),delete o.value[H.name]}catch(we){Ie.error(we.message||`Failed to remove ${H.name}`)}finally{W(H.name,!1),await L({quiet:!0})}}}async function ye(H){const de=new Set(i.value);if(de.has(H.name)){de.delete(H.name),i.value=de;return}de.add(H.name),i.value=de,Object.hasOwn(o.value,H.name)||await Be(H.name)}async function Be(H,de=!1){if(!de&&Object.hasOwn(o.value,H))return;const we=new Set(c.value);we.add(H),c.value=we,r.value={...r.value,[H]:""};try{const Re=await G.get(`/api/mcp/servers/${encodeURIComponent(H)}/tools`);o.value={...o.value,[H]:Re.tools||[]}}catch(Re){r.value={...r.value,[H]:Re.message||"Failed to load tools"}}finally{const Re=new Set(c.value);Re.delete(H),c.value=Re}}function k(H){return(o.value[H]||[]).filter(de=>Nw(de,l.value[H]))}function N(H,de){l.value={...l.value,[H]:de}}function $(){u.value="add",p.value="",f.value=null,m.value=or(),b.value="",d.value=!0}function te(H){u.value="edit",p.value=H.name,f.value=H,m.value={...or(),name:H.name,enabled:!!H.enabled,transport:H.transport||"stdio"},b.value="",d.value=!0}function Y(){E.value||(d.value=!1)}function ee(H){d.value&&Dw(H)}function he(H){const de=H==="headers"?"headerRows":"envRows";m.value[de].push({key:"",value:""})}function ce(H,de){const we=H==="headers"?"headerRows":"envRows";m.value[we].splice(de,1)}function re(H,de){const we=H==="headers"?"headersRemove":"envRemove",Re=m.value[we];m.value[we]=Re.includes(de)?Re.filter(Me=>Me!==de):[...Re,de]}async function ne(){var de,we;b.value="";let H;try{H=Iw(m.value,{mode:u.value,originalTransport:((de=f.value)==null?void 0:de.transport)||""})}catch(Re){b.value=Re instanceof Rs?Re.message:"Invalid MCP server configuration",await Ct(),(we=document.querySelector(".mcp-editor"))==null||we.scrollTo({top:0,behavior:"smooth"});return}if(!(u.value==="edit"&&Ow(H,f.value)&&!await Zt({title:`Change ${p.value} connection`,message:"Saving this configuration replaces the server runtime. Any current connection will be retired and its tools unpublished; enabled servers reconnect after the change.",confirmLabel:"Save and reconnect",danger:!0}))){E.value=!0;try{u.value==="add"?await G.post("/api/mcp/servers",H):await G.put(`/api/mcp/servers/${encodeURIComponent(p.value)}`,H),Ie.success(u.value==="add"?`Saved ${H.name}`:`Updated ${p.value}`),d.value=!1,await L({quiet:!0})}catch(Re){b.value=Re.message||"Failed to save MCP server"}finally{E.value=!1}}}let ae=null;function me(H){`${(H==null?void 0:H.event)||""} ${(H==null?void 0:H.type)||""} ${(H==null?void 0:H.tool)||""} ${(H==null?void 0:H.message)||""}`.toLowerCase().includes("mcp")&&(ae&&window.clearTimeout(ae),ae=window.setTimeout(()=>L({quiet:!0}),200))}function xe(){v||(v=!0,_||(Ve.subscribe("events",me),_=!0),L(),X())}function Oe(){v=!1,U(),ae&&window.clearTimeout(ae),ae=null,_&&(Ve.unsubscribe("events",me),_=!1)}return Ze(xe),ws(xe),ks(Oe),xt(Oe),{status:e,loading:t,mutating:s,pageError:n,servers:g,masterEnabled:S,aggregate:y,expandedServers:i,toolQueries:l,toolErrors:r,toolsLoading:c,editorOpen:d,editorMode:u,editingName:p,editingServer:f,form:m,formError:b,saving:E,editorGroups:C,configuredHeaderKeys:w,configuredEnvKeys:M,savedHttpEndpoint:F,endpointRequired:P,endpointFieldLabel:A,endpointPlaceholder:V,refreshAll:L,busy:O,serverState:Ce,stateLabel:Ee,transportLabel:oe,protocolLabel:be,toolSummary:se,formatAge:$w,setMasterEnabled:B,togglePending:ge,toggleServerEnabled:Z,reconnect:ie,refreshTools:le,removeServer:_e,toggleTools:ye,filteredTools:k,setToolQuery:N,openAdd:$,openEdit:te,closeEditor:Y,jumpToEditorGroup:ee,addSecretRow:he,removeSecretRow:ce,toggleSecretRemoval:re,saveServer:ne}}};function Bw(e,t){if(!e||!t)return Du(e);const s=Du(e),n=t.trim().split(/\s+/).filter(Boolean);if(!n.length)return s;const a=n.map(i=>i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|");try{return s.replace(new RegExp(`(${a})`,"gi"),'<mark class="knowledge-highlight">$1</mark>')}catch{return s}}const Hw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h(!0),s=h(null),n=h(""),a=h(null),i=h(!1),l=h(""),o=h(null),r=h(!1),c=h(""),d=h(""),u=h(null),p=h(null),f=h(!1),m=h(null),b=h(null);let E=null;const I=h(null),T=h(!1),v=h({}),_=h({}),C=h(null),g=h(null),S=K(()=>e.value.reduce((O,W)=>O+(W.chunks||0),0)),y=K(()=>new Set(e.value.map(W=>W.uploader).filter(Boolean)).size);function w(O,W){const Ce=_.value[W];if(!Ce||Ce.length===0)return 0;const Ee=Math.max(...Ce.map(oe=>oe.char_count||0));return Ee===0?0:Math.round(O.char_count/Ee*100)}async function M(){t.value=!0,s.value=null;try{const O=await G.get("/api/knowledge");e.value=Array.isArray(O)?O:[]}catch(O){s.value=O.message}t.value=!1}async function F(O){if(v.value[O]){v.value[O]=!1,g.value=null;return}if(v.value[O]=!0,!(_.value[O]||C.value===O)){C.value=O;try{const W=await G.get(`/api/knowledge/${encodeURIComponent(O)}/chunks`);_.value[O]=Array.isArray(W)?W:[]}catch(W){_.value[O]=[],Ie.error(`Failed to load chunks: ${W.message}`)}C.value=null}}async function P(){const O=n.value.trim();if(O){i.value=!0,o.value=null,l.value=O;try{const W=await G.get(`/api/knowledge/search?q=${encodeURIComponent(O)}`);a.value=Array.isArray(W)?W:[]}catch(W){a.value=[],o.value=W.message||"Search failed"}i.value=!1}}function A(){a.value=null,n.value="",o.value=null}async function V(){u.value=null,p.value=null;const O=c.value.trim(),W=d.value.trim();if(!O){u.value="Source name is required";return}if(!W){u.value="Content is required";return}f.value=!0;try{const Ce=await G.post("/api/knowledge",{source:O,content:W});p.value=`Ingested ${Ce.chunks||0} chunks from "${O}"`,c.value="",d.value="",_.value={},await M(),setTimeout(()=>{r.value=!1,p.value=null},1500)}catch(Ce){u.value=Ce.message}f.value=!1}async function X(O){m.value=O,b.value=null,E&&(clearTimeout(E),E=null);try{const W=await G.post(`/api/knowledge/${encodeURIComponent(O)}/reingest`);b.value={source:O,error:!1,message:`Re-ingested ${W.chunks||0} chunks`},delete _.value[O],await M(),E=setTimeout(()=>{b.value=null,E=null},3e3)}catch(W){b.value={source:O,error:!0,message:W.message}}m.value=null}function U(O){I.value=O}async function L(){if(I.value){T.value=!0;try{await G.del(`/api/knowledge/${encodeURIComponent(I.value)}`),delete _.value[I.value],await M()}catch(O){Ie.error(`Failed to delete source: ${O.message||"unknown error"}`)}T.value=!1,I.value=null}}return Ze(()=>{M()}),{sources:e,loading:t,error:s,searchQuery:n,searchResults:a,searching:i,lastQuery:l,searchError:o,showIngest:r,ingestSource:c,ingestContent:d,ingestError:u,ingestSuccess:p,ingesting:f,reingesting:m,reingestResult:b,deleteTarget:I,deleting:T,expanded:v,sourceChunks:_,loadingChunks:C,selectedChunk:g,totalChunks:S,uploaderCount:y,truncate:Qc,formatTs:ba,highlightTerms:Bw,chunkBarWidth:w,fetchSources:M,toggleSource:F,doSearch:P,clearSearch:A,doIngest:V,doReingest:X,confirmDelete:U,doDelete:L}}},zw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    </div>`,setup(){const e=h([]),t=h({}),s=h(!0),n=h(null),a=h({}),i=h(null),l=h(""),o=h(!1),r=h({scope:"global",key:"",value:""}),c=h(!1),d=h(null),u=h(null),p=h(null),f=h(""),m=h(!1),b=h(null),E=h(null),I=h(new Set),T=h(null),v=h(!1),_=h(!1),C=K(()=>e.value.reduce((oe,be)=>oe+be.count,0)),g=K(()=>I.value.size);function S(oe){const be=t.value[oe];if(!be)return[];if(!l.value.trim())return be;const se=l.value.trim().toLowerCase();return be.filter(ge=>ge.key.toLowerCase().includes(se)||ge.value&&ge.value.toLowerCase().includes(se))}function y(oe,be){return I.value.has(oe+"/"+be)}function w(oe,be){const se=oe+"/"+be,ge=new Set(I.value);ge.has(se)?ge.delete(se):ge.add(se),I.value=ge}function M(oe){const be=t.value[oe];return!be||be.length===0?!1:be.every(se=>I.value.has(oe+"/"+se.key))}function F(oe,be){const se=t.value[oe];if(!se)return;const ge=new Set(I.value);for(const Z of se){const B=oe+"/"+Z.key;be?ge.add(B):ge.delete(B)}I.value=ge}async function P(){s.value=!0,n.value=null;try{const oe=await G.get("/api/memory");e.value=Object.entries(oe).map(([be,se])=>({name:be,keys:se.keys||[],count:se.count||0}))}catch(oe){n.value=oe.message}s.value=!1}async function A(oe){if(a.value[oe]){a.value[oe]=!1;return}a.value[oe]=!0;const be=e.value.find(ge=>ge.name===oe);if(!be||t.value[oe]||i.value===oe)return;i.value=oe;let se;try{const Z=(await G.get(`/api/memory/${encodeURIComponent(oe)}`)).entries||{};se=be.keys.map(B=>Object.prototype.hasOwnProperty.call(Z,B)?{key:B,value:Z[B]||"",failed:!1}:{key:B,value:"",failed:!0,error:"Not found in scope"})}catch(ge){se=be.keys.map(Z=>({key:Z,value:"",failed:!0,error:ge.message||"Failed to load"}))}t.value[oe]=se,i.value=null}function V(oe,be,se){p.value=oe+"/"+be,f.value=se}async function X(oe,be){m.value=!0,b.value=null;try{await G.put(`/api/memory/${encodeURIComponent(oe)}/${encodeURIComponent(be)}`,{value:f.value});const se=t.value[oe];if(se){const ge=se.find(Z=>Z.key===be);ge&&(ge.value=f.value)}p.value=null}catch(se){b.value=`Failed to save: ${se.message||"unknown error"}`}m.value=!1}async function U(oe,be){try{await navigator.clipboard.writeText(be.value),E.value=oe+"/"+be.key,setTimeout(()=>{E.value=null},1500)}catch{}}async function L(){d.value=null,u.value=null;const oe=r.value.scope.trim(),be=r.value.key.trim(),se=r.value.value.trim();if(!oe){d.value="Scope is required";return}if(!be){d.value="Key is required";return}if(!se){d.value="Value is required";return}c.value=!0;try{await G.put(`/api/memory/${encodeURIComponent(oe)}/${encodeURIComponent(be)}`,{value:se}),u.value="Entry saved",r.value={scope:"global",key:"",value:""},t.value={},await P(),setTimeout(()=>{o.value=!1,u.value=null},800)}catch(ge){d.value=ge.message}c.value=!1}function O(oe,be){T.value={scope:oe,key:be}}async function W(){if(!T.value)return;v.value=!0,b.value=null;const{scope:oe,key:be}=T.value;try{await G.del(`/api/memory/${encodeURIComponent(oe)}/${encodeURIComponent(be)}`);const se=t.value[oe];se&&(t.value[oe]=se.filter(B=>B.key!==be));const ge=e.value.find(B=>B.name===oe);ge&&(ge.count--,ge.keys=ge.keys.filter(B=>B!==be));const Z=new Set(I.value);Z.delete(oe+"/"+be),I.value=Z}catch(se){b.value=`Failed to delete: ${se.message||"unknown error"}`}v.value=!1,T.value=null}function Ce(){_.value=!0}async function Ee(){v.value=!0,b.value=null;const oe=[];for(const be of I.value){const se=be.indexOf("/");oe.push({scope:be.slice(0,se),key:be.slice(se+1)})}try{await G.post("/api/memory/bulk-delete",{entries:oe}),I.value=new Set,t.value={},await P()}catch(be){b.value=`Bulk delete failed: ${be.message||"unknown error"}`}v.value=!1,_.value=!1}return Ze(()=>{P()}),{scopes:e,scopeEntries:t,loading:s,error:n,expanded:a,loadingScope:i,filterQuery:l,showAdd:o,addForm:r,adding:c,addError:d,addSuccess:u,editingKey:p,editValue:f,saving:m,actionError:b,copied:E,selected:I,selectedCount:g,totalEntries:C,deleteTarget:T,deleting:v,showBulkDelete:_,fetchMemory:P,toggleScope:A,startEdit:V,doEdit:X,copyValue:U,doAdd:L,confirmDelete:O,doDelete:W,confirmBulkDelete:Ce,doBulkDelete:Ee,isSelected:y,toggleSelect:w,isScopeAllSelected:M,toggleSelectAll:F,filteredEntries:S}}},jw={template:`
    <div class="p-6 page-fade-in">
      <div class="flex items-center justify-between mb-4">
        <div>
...
`);const ue=new Blob([q],{type:"text/plain"}),Ne=URL.createObjectURL(ue),Je=document.createElement("a");Je.href=Ne,Je.download=`odin-logs-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.txt`,Je.click(),URL.revokeObjectURL(Ne)}function ee(q,ue){const Ne=`${q.ts} ${q.level} ${q.text||q.raw||""}`;navigator.clipboard.writeText(Ne).then(()=>{p.value=ue,setTimeout(()=>{p.value=null},1500)}).catch(()=>{})}function he(q){a.value=a.value===q?"":q,I.value="all"}function ce(q){return q.level==="ERROR"?"log-line-error":q.level==="WARNING"?"log-line-warning":"text-gray-300"}function re(q){return q==="ERROR"?"text-red-500 font-semibold":q==="WARNING"?"text-yellow-500":"text-blue-500"}function ne(q){return q==="ERROR"?"log-chip-error":q==="WARNING"?"log-chip-warning":"log-chip-info"}function ae(q){I.value=q.id;const ue=q.filters;a.value=ue.level||"",T.value=ue.timeRange||"",i.value=ue.text||"",ue.levels&&(a.value=ue.levels[0]||""),ue.hasToolName&&(i.value="")}function me(q){I.value=q.id,a.value=q.filters.level||"",T.value=q.filters.timeRange||"",i.value=q.filters.text||""}function xe(){if(!C.value.trim())return;const q={id:"custom-"+Date.now(),name:C.value.trim(),filters:{level:a.value,timeRange:T.value,text:i.value}};v.value=[...v.value,q],y(),_.value=!1,C.value=""}function Oe(q){v.value=v.value.filter(ue=>ue.id!==q),y(),I.value===q&&(I.value="all")}const H=h("all"),de=h(""),we=h(""),Re=h(""),Me=h(""),dt=h(""),J=h(100),Te=Qw,Le=h(!1),Pe=h(!1),Ge=h(""),He=h([]),mt=h(null),Yt=h(null);function Ds(){e.value="search",mt.value||An()}async function An(){try{mt.value=await G.get("/api/logs/stats")}catch{}}function Ts(){const q=dt.value;if(!q){Re.value="",Me.value="";return}const Ne={last_5m:300,last_15m:900,last_1h:3600,last_4h:14400,last_24h:86400,last_7d:604800}[q];if(Ne){const Je=new Date(Date.now()-Ne*1e3);Re.value=Ps(Je),Me.value=""}}function Ps(q){const ue=Ne=>String(Ne).padStart(2,"0");return`${q.getFullYear()}-${ue(q.getMonth()+1)}-${ue(q.getDate())}T${ue(q.getHours())}:${ue(q.getMinutes())}`}function Pt(q){if(!q)return"";const ue=new Date(q);return isNaN(ue.getTime())?"":ue.toISOString()}async function Qt(){Le.value=!0,Ge.value="",Pe.value=!0,Yt.value=null;try{const q=new URLSearchParams;H.value&&H.value!=="all"&&q.set("level",H.value),de.value&&q.set("tool",de.value),we.value&&q.set("q",we.value);const ue=Pt(Re.value),Ne=Pt(Me.value);ue&&q.set("start",ue),Ne&&q.set("end",Ne),q.set("limit",String(J.value));const Je=await G.get(`/api/logs/search?${q.toString()}`);He.value=Je.entries||[]}catch(q){Ge.value=q.message||"Search failed",He.value=[]}finally{Le.value=!1}}function Vs(){H.value="all",de.value="",we.value="",Re.value="",Me.value="",dt.value="",J.value=100,He.value=[],Pe.value=!1,Ge.value="",Yt.value=null}function Cs(q){Yt.value=Yt.value===q?null:q}function nn(q){if(!q.timestamp)return"";try{return new Date(q.timestamp).toLocaleString()}catch{return q.timestamp}}function Fs(q){return q.type==="web_action"?`${q.status||""} (${q.execution_time_ms||0}ms)`:(q.result_summary||"").slice(0,200)}function qs(q){return q.error?"log-line-error":"text-gray-300"}function Vn(q){try{return JSON.stringify(q,null,2)}catch{return String(q)}}let ut=null,os=null,rs=!1;function Qe(){rs||(rs=!0,Ve.subscribe("logs",oe),o.value=Ve.connected,r.value=Ve.state||"disconnected",ut=Ve.onStateChange,os=(q,ue)=>{r.value=q,o.value=q==="connected",ut&&ut(q,ue)},Ve.onStateChange=os)}function gs(){rs&&(rs=!1,Ve.unsubscribe("logs",oe),Ve.onStateChange===os&&(Ve.onStateChange=ut),os=null,ut=null)}return Ze(()=>{S(),window.addEventListener("pointerup",k),window.addEventListener("pointercancel",k)}),ws(Qe),ks(gs),xt(()=>{gs(),window.removeEventListener("pointerup",k),window.removeEventListener("pointercancel",k)}),{mode:e,logs:t,paused:s,autoScroll:n,levelFilter:a,textFilter:i,useRegex:l,subscribed:o,wsState:r,wsStateLabel:c,logContainer:d,filteredLogs:Ce,pauseBuffer:g,showJumpBottom:u,copiedIndex:p,regexError:F,levels:m,logPresets:b,timeRanges:E,timeRange:T,activeLogPreset:I,customLogPresets:v,showSaveLogPreset:_,newLogPresetName:C,hasActiveLogFilters:w,timeRangeLabel:M,timelineBuckets:A,timelineMax:V,timelineSpanLabel:X,timelineLabelSkip:U,togglePause:$,clearLogs:te,exportLogs:Y,logLineClass:ce,levelClass:re,levelChipClass:ne,toggleLevel:he,copyLine:ee,jumpToBottom:ge,onScroll:B,onUserScrollIntent:le,onUserScrollKey:_e,onAutoScrollToggle:N,onPointerDown:Be,applyLogPreset:ae,applyCustomLogPreset:me,saveLogCustomPreset:xe,removeLogCustomPreset:Oe,segmentHeight:O,jumpToTimelineBucket:W,searchLevel:H,searchTool:de,searchKeyword:we,searchStart:Re,searchEnd:Me,searchTimePreset:dt,searchLimit:J,searchLimits:Te,searching:Le,searchRan:Pe,searchError:Ge,searchResults:He,searchStats:mt,expandedSearch:Yt,switchToSearch:Ds,runSearch:Qt,clearSearchFilters:Vs,toggleSearchExpand:Cs,formatSearchTs:nn,searchEntryText:Fs,searchLogLineClass:qs,formatJson:Vn,applySearchTimePreset:Ts}}};function Sl(e=[]){const t=[],s=new Set;function n(a){const i=[a.kind,a.label,a.apply_mode||"",a.code||"",a.text||""].join("\0");s.has(i)||(s.add(i),t.push({...a,key:i}))}for(const a of e)for(const i of(a==null?void 0:a.consumers)||[])n({kind:"consumer",label:i.name,apply_mode:i.apply_mode,text:i.detail});for(const a of e)a!=null&&a.apply_handler&&n({kind:"handler",label:"Apply handler",code:a.apply_handler});for(const a of e)a!=null&&a.restart_reason&&n({kind:"restart",label:"Why a restart is required",text:a.restart_reason});for(const a of e)a!=null&&a.activation_policy&&n({kind:"activation",label:"Activation policy",text:a.activation_policy});return t}const ek=Object.freeze([{key:"all",label:"All fields",short:"All",icon:"grid"},{key:"applied",label:"Applied",short:"Applied",icon:"success"},{key:"pending_restart",label:"Pending restart",short:"Restart",icon:"refresh"},{key:"dormant",label:"Saved, not active",short:"Saved only",icon:"pause"},{key:"invalid",label:"Invalid",short:"Invalid",icon:"error"},{key:"drift",label:"Drift",short:"Drift",icon:"warning"},{key:"unknown",label:"Effective state unknown",short:"Unknown",icon:"info"}]);function tk(e,t={}){var a,i;const s=t.getStyle||(l=>globalThis.getComputedStyle(l)),n=Object.hasOwn(t,"fallback")?t.fallback:(a=globalThis.document)==null?void 0:a.scrollingElement;for(let l=e;l;l=l.parentElement){const o=((i=s(l))==null?void 0:i.overflowY)||"";if(/^(auto|scroll|overlay)$/.test(o)&&l.scrollHeight>l.clientHeight)return l}return n&&n.scrollHeight>n.clientHeight?n:e||n||null}const Va=[{key:"core",label:"Core",icon:"sliders",sections:["timezone","logging","permissions","graceful_degradation"]},{key:"models",label:"Models & AI",icon:"brain",sections:["image","llm_recovery"]},{key:"runtime",label:"Runtime",icon:"activity",sections:["context","sessions","agents","turn_state"]},{key:"data",label:"Data & Storage",icon:"database",sections:["learning","search","usage","audit","attachments"]},{key:"services",label:"Services",icon:"link",sections:["webhook","observability","email","browser","comfyui","slack","mcp"]},{key:"automation",label:"Automation",icon:"workflow",sections:["message_triggers","reaction_triggers","grafana_alerts","outbound_webhooks","issue_tracker"]},{key:"infrastructure",label:"Infrastructure",icon:"server",sections:["tools","web"]}],sk={live_read:"Applies immediately",live_apply:"Dedicated live apply",live_for_new_work:"Applies to new work",restart:"Restart required",activation_required:"Saved only — see activation note",legacy_control:"Controlled elsewhere",dormant:"Saved for future support"},cr=new Set(["llm_provider","openai_codex","ollama","kimi","personality","discord"]),nk=Object.freeze(["web.api_tokens","outbound_webhooks.targets"]);function Bu(e){return nk.some(t=>e===t||e.startsWith(`${t}.`))}const Rm="odin_config_center_expanded_v1",Im="odin_config_center_category_v1",ak=50,ik=650,dr=()=>G.get("/api/config/meta");function ea(e){return e===void 0?void 0:JSON.parse(JSON.stringify(e))}function Oi(e,t){return JSON.stringify(e)===JSON.stringify(t)}function Ca(e){return String(e).replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function lk(e){return e===void 0?"unset":e===null?"null":typeof e=="boolean"?e?"Enabled":"Disabled":Array.isArray(e)?e.length?`${e.length} item${e.length===1?"":"s"}`:"Empty list":typeof e=="object"?Object.keys(e).length?`${Object.keys(e).length} field${Object.keys(e).length===1?"":"s"}`:"Empty object":e===""?"Empty":String(e)}function ok(e){if(e===void 0)return"unset";if(e===null)return"null";if(typeof e=="object")try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)}function Om(e,t){if(Oi(e,t))return;if(!(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)))return ea(t);const n={};for(const[a,i]of Object.entries(t)){const l=Om(e[a],i);l!==void 0&&(n[a]=l)}return Object.keys(n).length?n:void 0}function rk(e,t){const s={};for(const[n,a]of Object.entries(t||{})){const i=Om(e==null?void 0:e[n],a);i!==void 0&&(s[n]=i)}return s}function Lm(e,t,s,n){if(Oi(e,t))return;if(e&&t&&typeof e=="object"&&typeof t=="object"&&!Array.isArray(e)&&!Array.isArray(t)){const i=new Set([...Object.keys(e),...Object.keys(t)]);for(const l of i)Lm(e[l],t[l],s?`${s}.${l}`:l,n);return}n.push({path:s,oldVal:e,newVal:t})}function ck(){try{const e=JSON.parse(localStorage.getItem(Rm)||"{}");return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}catch{return{}}}function dk(){try{const e=localStorage.getItem(Im);return Va.some(t=>t.key===e)?e:Va[0].key}catch{return Va[0].key}}const uk={template:`
  ...
  `,setup(){const e=h(null),t=h(null),s=h(!0),n=h(null),a=h(!1),i=h(null),l=h(null),o=h(null),r=h(!1),c=h(!1),d=h(null),u=h(""),p=h("all"),f=h(dk()),m=h(ck()),b=h({}),E=h({}),I=h(""),T=h({}),v=h({}),_=h([]),C=h([]),g=h(!1),S=h(!1),y=h(!1);let w=null,M=null,F={path:null,at:0},P=0;const A=K(()=>{var x;return(((x=t.value)==null?void 0:x.fields)||[]).filter(D=>!cr.has(D.path.split(".")[0])&&!Bu(D.path))}),V=K(()=>new Map(A.value.map(x=>[x.path,x]))),X=K(()=>Ce.value.reduce((x,D)=>x+D.sections.length,0)),U=K(()=>A.value.length),L=K(()=>ek),O=K(()=>_.value.length>0),W=K(()=>C.value.length>0),Ce=K(()=>{if(!e.value)return[];const x=new Set(Va.flatMap(pe=>pe.sections)),D=Va.map(pe=>({...pe,sections:pe.sections.filter(Fe=>Object.hasOwn(e.value,Fe)&&!cr.has(Fe))})).filter(pe=>pe.sections.length),j=Object.keys(e.value).filter(pe=>!x.has(pe)&&!cr.has(pe));return j.length&&D.push({key:"other",label:"Other",icon:"folder",sections:j}),D}),Ee=K(()=>e.value?{...e.value,...b.value}:null),oe=K(()=>{if(!e.value)return[];const x=[];for(const[D,j]of Object.entries(b.value))Lm(e.value[D],j,D,x);return x.filter(D=>!Oi(D.oldVal,D.newVal)).map(D=>{const j=N(D.path);return{...D,label:(j==null?void 0:j.label)||Ca(D.path.split(".").at(-1)),apply_mode:(j==null?void 0:j.apply_mode)||he(D.path.split(".")[0])}})}),be=K(()=>oe.value.length>0),se=K(()=>oe.value.length),ge=K(()=>new Set(oe.value.map(x=>x.path.split(".")[0])).size),Z=K(()=>!!u.value||p.value!=="all"),B=K(()=>{const x={...v.value};for(const D of oe.value){const j=N(D.path),pe=xa(j,D.newVal);pe&&(x[D.path]=pe)}return x}),ie=K(()=>Object.keys(B.value).length>0),le=K(()=>e.value?(Z.value?Ce.value:Ce.value.filter(D=>D.key===f.value)).map(D=>({...D,sections:D.sections.filter(j=>Le(j))})).filter(D=>D.sections.length):[]),_e=K(()=>{const x=["live_read","live_apply","live_for_new_work","restart","activation_required","legacy_control","dormant"],D=new Map(x.map(j=>[j,[]]));for(const j of oe.value){const pe=D.has(j.apply_mode)?j.apply_mode:"restart";D.get(pe).push(j)}return x.filter(j=>D.get(j).length).map(j=>({key:j,label:ve(j),entries:D.get(j)}))}),ye=K(()=>oe.value.filter(x=>x.apply_mode==="restart").length),Be=K(()=>A.value.filter(x=>x.pending_restart)),k=K(()=>Be.value.length);function N(x){const D=V.value.get(x);return D?{...D,apply_details:Sl([D])}:null}function $(x){const D=`${x}.`;return A.value.filter(j=>j.path===x||j.path.startsWith(D))}function te(x){return $(x).length}function Y(x){return Ca(x)}function ee(x){const D=$(x);if(!D.length)return`${Ca(x)} configuration.`;const j=D.find(gt=>gt.sensitivity==="public"&&gt.description)||D.find(gt=>gt.description),pe=(j==null?void 0:j.description)||"";return pe.match(/setting for (.+)\.$/i)?`${Ca(x)} settings and runtime behaviour.`:pe}function he(x){const D=[...new Set($(x).map(j=>j.apply_mode))];return D.length===1?D[0]:D.includes("restart")?"restart":D.includes("activation_required")?"activation_required":D[0]||"restart"}function ce(x){const D=[...new Set($(x).map(j=>ve(j.apply_mode)))];return D.length?D.length===1?D[0]:`Mixed apply behaviour: ${D.join(" · ")}`:""}function re(x){return Sl($(x))}function ne(x){var D;return Object.hasOwn(b.value,x)?b.value[x]:(D=e.value)==null?void 0:D[x]}function ae(){const x=ne("mcp")||{},D=Object.keys(x.servers||{}).length;return`${x.enabled?"Globally enabled":"Globally disabled"} · ${D} configured server${D===1?"":"s"}.`}function me(x,D){return D.split(".").reduce((j,pe)=>j==null?void 0:j[pe],x)}function xe(x){const D=Ee.value;return $(x).filter(j=>Bu(j.path)?!1:j.path.split(".").length<=2?!0:!j.path.includes(".*")).map(j=>({...j,key:j.path.split(".").at(-1),value:me(D,j.path),apply_details:Sl([j]),editor:j.path==="agents.final_warning_iterations"?"warning-chips":null}))}function Oe(x){const D=x.path.split(".");return D.length>2?D.slice(0,2).join("."):null}function H(x){const D=new Map;for(const j of xe(x)){const pe=Oe(j),Fe=pe||`${x}.__root`;D.has(Fe)||D.set(Fe,{key:Fe,path:pe,entries:[]}),D.get(Fe).entries.push(j)}return[...D.values()].map(j=>{const pe=j.entries.find(Fe=>Fe.group_description);return{...j,label:j.path?Ca(j.path.split(".").at(-1)):null,description:(pe==null?void 0:pe.group_description)||null,apply_details:Sl(j.entries),runtime_summaries:we(j.entries)}})}function de(x){return{save:x.save_effect||(x.apply_mode==="dormant"?"Saving records this value in config.yml.":"Saving records this value and validates the section."),runtime:x.runtime_effect||{live_read:"Odin reads the saved value during current work.",live_apply:"Odin reloads this setting without a restart.",live_for_new_work:"New work uses the saved value; existing work keeps its snapshot.",restart:"Odin keeps using its startup value until a clean restart.",activation_required:"Odin keeps the current behavior until you enable this feature separately.",legacy_control:"Odin keeps the existing compatibility behavior until you apply this choice.",dormant:"This version of Odin does not use the saved value. Restarting will not activate it."}[x.apply_mode]||"Effective runtime state is not currently observable."}}function we(x){const D=new Map;for(const j of x){const pe=de(j),Fe=`${j.apply_mode}|${pe.save}|${pe.runtime}`;D.has(Fe)||D.set(Fe,{key:Fe,label:ve(j.apply_mode),save:pe.save,runtime:pe.runtime})}return[...D.values()]}function Re(x){if(Me(x))return x.runtime_effect||x.activation_policy||"";if(x.apply_mode==="activation_required"){const D=x.activation_policy||x.runtime_effect;return D?`Not active after saving. No activation control exists in this release. ${D}`:"Not active after saving; no activation control exists in this release."}return""}function Me(x){return x.action_available===!0&&!!(x.action_label&&x.action_endpoint)}async function dt(x){if(Me(x))try{if(Yt(x.path))throw new Error("Save this setting before applying its action.");const D=String(x.action_method||"POST").toLowerCase(),j={post:G.post.bind(G),put:G.put.bind(G),delete:G.del.bind(G)}[D];if(!j)throw new Error("Unsupported configuration action");await j(x.action_endpoint,x.action_body||void 0),await Q(),Rn("success",`${x.action_label} completed.`)}catch(D){Rn("error",D.message||`${x.action_label} failed`)}}function J(x,D){return[x.label,x.path,x.description,...x.aliases||[]].filter(Boolean).join(" ").toLowerCase().includes(D)}function Te(x){const D=u.value.trim().toLowerCase();return D?$(x).filter(j=>J(j,D)):[]}function Le(x){const D=$(x);if(p.value!=="all"&&!D.some(pe=>pe.apply_state===p.value))return!1;const j=u.value.trim().toLowerCase();return!j||`${Y(x)} ${x}`.toLowerCase().includes(j)?!0:D.some(pe=>J(pe,j))}function Pe(x,D){return $(x).filter(j=>j.apply_state===D).length}function Ge(x){return x==="all"?U.value:A.value.filter(D=>D.apply_state===x).length}function He(x){const D=x.sections.flatMap(j=>$(j));return{fields:D.length,modified:oe.value.filter(j=>x.sections.includes(j.path.split(".")[0])).length,pending_restart:D.filter(j=>j.apply_state==="pending_restart").length,invalid:D.filter(j=>j.apply_state==="invalid").length,dormant:D.filter(j=>j.apply_state==="dormant").length}}function mt(x){var D;return Object.hasOwn(b.value,x)&&!Oi((D=e.value)==null?void 0:D[x],b.value[x])}function Yt(x){return oe.value.some(D=>D.path===x||D.path.startsWith(`${x}.`))}function Ds(x){f.value=x,u.value="",p.value="all";try{localStorage.setItem(Im,x)}catch{}}function An(x){p.value=x}function Ts(){u.value="",p.value="all"}function Ps(x){var D;return((D=Ce.value.find(j=>j.sections.includes(x)))==null?void 0:D.sections)||[]}function Pt(x){const D=Ps(x),j=D.find(pe=>m.value[pe]===!0);return j||D.find(pe=>m.value[pe]!==!1)||null}function Qt(x){return u.value&&!y.value&&Le(x)?!0:y.value?Pt(x)===x:Object.hasOwn(m.value,x)?m.value[x]===!0:!0}function Vs(x){const D=!Qt(x);if(y.value){const j={...m.value};for(const pe of Ps(x))j[pe]===!0&&(j[pe]=!1);j[x]=D,m.value=j;return}m.value={...m.value,[x]:D}}function Cs(){_.value.push(ea(b.value)),_.value.length>ak&&_.value.shift(),C.value=[]}function nn(){be.value&&(Cs(),b.value={},v.value={},g.value=!1)}function Fs(x,D=!1){const j=Date.now();if(D&&F.path===x&&j-F.at<ik){F.at=j;return}Cs(),F={path:x,at:j}}function qs(x,D,j){if(!D.length)return j;const pe=ea(x??{});let Fe=pe;for(let gt=0;gt<D.length-1;gt+=1){const it=D[gt];Fe[it]=ea(Fe[it]??{}),Fe=Fe[it]}return Fe[D.at(-1)]=j,pe}function Vn(x){var D;return Object.hasOwn(b.value,x)?b.value[x]:ea((D=e.value)==null?void 0:D[x])}function ut(x,D,j={}){var ri;const[pe,...Fe]=x.path.split(".");Fs(x.path,!!j.coalesce);const gt=Vn(pe),it=Fe.length?qs(gt,Fe,D):D,Gs={...b.value};if(Oi(it,(ri=e.value)==null?void 0:ri[pe])?delete Gs[pe]:Gs[pe]=it,b.value=Gs,v.value[x.path]){const rd={...v.value};delete rd[x.path],v.value=rd}}function os(x){F={path:null,at:0},E.value={...E.value,[x]:String(me(Ee.value,x)??"")}}function rs(x){if(F={path:null,at:0},!Object.hasOwn(E.value,x))return;const D={...E.value};delete D[x],E.value=D}function Qe(x){const D=E.value[x.path];if(F={path:null,at:0},D===""){v.value={...v.value,[x.path]:"Enter a number."};return}const j=Number(D);if(Number.isNaN(j)||x.type==="integer"&&!Number.isInteger(j)){v.value={...v.value,[x.path]:x.type==="integer"?"Enter a whole number.":"Enter a number."};return}const pe={...E.value};delete pe[x.path],E.value=pe,ut(x,j,{coalesce:!0})}function gs(x){return Object.hasOwn(E.value,x.path)?E.value[x.path]:x.value??""}function q(x,D){if(E.value={...E.value,[x.path]:D},D===""){v.value={...v.value,[x.path]:"Enter a number."};return}const j=Number(D);if(!Number.isFinite(j)||x.type==="integer"&&!Number.isInteger(j)){v.value={...v.value,[x.path]:x.type==="integer"?"Enter a whole number.":"Enter a valid number."};return}if(v.value[x.path]){const pe={...v.value};delete pe[x.path],v.value=pe}ut(x,j,{coalesce:!0})}function ue(x){const D=Number.parseInt(I.value,10);if(!Number.isInteger(D)||D<1){v.value={...v.value,[x.path]:"Warning thresholds must be positive whole numbers."};return}const j=[...new Set([...x.value||[],D])].sort((pe,Fe)=>Fe-pe);I.value="",ut(x,j)}function Ne(x,D){ut(x,(x.value||[]).filter(j=>j!==D))}function Je(x){return x.apply_mode==="live_read"?"Odin reads the saved file value on next use.":x.apply_mode==="live_for_new_work"?"New work uses the saved file value.":x.apply_mode==="live_apply"?x.apply_handler?`Apply the saved value through ${x.apply_handler}.`:"Apply it through its dedicated owner page or endpoint.":x.apply_mode==="restart"?"Restart Odin for the saved collection to take effect.":x.apply_mode==="activation_required"?"Saving does not enable it. No activation control exists in this release.":x.apply_mode==="dormant"?"This release does not use the saved collection.":"Follow the runtime details shown for this setting."}function ot(x){return x.type==="array"&&Array.isArray(x.value)&&!x.structured_container&&!x.structured_container_child&&x.sensitivity==="public"&&x.value.every(D=>["string","number","boolean"].includes(typeof D))}function Nt(x){const D=String(T.value[x.path]??"").trim();if(!D)return;const j=[...new Set([...x.value||[],D])];T.value={...T.value,[x.path]:""},ut(x,j)}function Ft(x,D){ut(x,(x.value||[]).filter(j=>j!==D))}function xa(x,D){var pe;if(!x)return null;if((pe=x.enum)!=null&&pe.length&&!x.enum.includes(D))return`Choose one of: ${x.enum.join(", ")}`;if(x.path==="agents.final_warning_iterations"&&(!Array.isArray(D)||!D.length))return"Add at least one warning threshold.";const j=x.constraints||{};if((x.type==="integer"||x.type==="number")&&typeof D=="number"){if(j.minimum!==void 0&&D<j.minimum)return`Must be at least ${j.minimum}${x.unit?` ${x.unit}`:""}`;if(j.maximum!==void 0&&D>j.maximum)return`Must be at most ${j.maximum}${x.unit?` ${x.unit}`:""}`}return null}function $s(x){return B.value[x.path]||null}function li(x){const D=`${x}.`;return Object.keys(B.value).some(j=>j===x||j.startsWith(D))}function _a(){_.value.length&&(C.value.push(ea(b.value)),b.value=_.value.pop(),v.value={},E.value={},F={path:null,at:0})}function qn(){C.value.length&&(_.value.push(ea(b.value)),b.value=C.value.pop(),v.value={},E.value={},F={path:null,at:0})}function wa(){!be.value||ie.value||(g.value=!0,S.value=!1)}function Gn(){g.value=!1}function z(){nn()}function ve(x){return sk[x]||Ca(x||"unknown")}function Ae(x){return`apply-${String(x||"unknown").replaceAll("_","-")}`}function _t(x){return`cfgc-field-${x.replace(/[^a-zA-Z0-9_-]/g,"-")}`}function Kn(x){return`${_t(x)}-input`}function Wn(x){const D=document.getElementById(_t(x))||document.getElementById(_t(x.split(".").slice(0,2).join(".")));D==null||D.scrollIntoView({behavior:"smooth",block:"center"})}function Rn(x,D){l.value={type:x,message:D},window.setTimeout(()=>{var j;((j=l.value)==null?void 0:j.message)===D&&(l.value=null)},3500)}function cl(){r.value=!1,p.value="pending_restart",u.value="";const x=tk(n.value);x&&(x.scrollTop=0)}function dl(){r.value=!1}function Zn(x=1800){M&&window.clearTimeout(M),M=window.setTimeout(oi,x)}async function oi(){if(c.value){if(P+=1,P>45){c.value=!1,d.value="Odin did not return with the new startup settings within 90 seconds.";return}try{if(t.value=await dr(),k.value===0){c.value=!1,d.value=null,Rn("success","Odin restarted and the saved startup settings are active.");return}}catch{}Zn(2e3)}}async function ke(){if(!c.value){d.value=null;try{await G.post("/api/restart",{}),c.value=!0,P=0,r.value=!1,Zn()}catch(x){d.value=x.message||"Odin could not schedule a restart."}}}async function R(){if(!(!be.value||ie.value||a.value)){a.value=!0;try{const x=rk(e.value,b.value),D=await G.put("/api/config",x);e.value=D,b.value={},_.value=[],C.value=[],v.value={},g.value=!1;try{t.value=await dr(),o.value=null,r.value=k.value>0,Rn("success",k.value?`Configuration saved. ${k.value} setting${k.value===1?"":"s"} still use startup values.`:"Configuration saved. Apply status has been refreshed.")}catch(j){o.value=j.message||"Unknown metadata error.",Rn("error",`Configuration saved, but apply status could not be refreshed: ${o.value}`)}}catch(x){Rn("error",x.message||"Configuration could not be saved")}finally{a.value=!1}}}async function Q(){var x,D;if(!be.value){s.value=!0,i.value=null;try{const j=await G.get("/api/config"),pe=await dr();e.value=j,t.value=pe,o.value=null;const Fe=Ce.value;if(Fe.some(gt=>gt.key===f.value)||(f.value=((x=Fe[0])==null?void 0:x.key)||Va[0].key),y.value){const it=(((D=Fe.find(Gs=>Gs.key===f.value))==null?void 0:D.sections)||[]).find(Gs=>m.value[Gs]===!0);m.value=it?{...m.value,[it]:!0}:{}}}catch(j){i.value=j.message||"Unknown configuration error"}finally{s.value=!1}}}function fe(x){if(g.value||!(x.ctrlKey||x.metaKey))return;const D=x.target;D instanceof HTMLElement&&(D.matches("input, textarea, select")||D.isContentEditable)||(!x.shiftKey&&x.key.toLowerCase()==="z"?(x.preventDefault(),_a()):(x.key.toLowerCase()==="y"||x.shiftKey&&x.key.toLowerCase()==="z")&&(x.preventDefault(),qn()))}function De(x){y.value=x.matches}return as(m,x=>{try{localStorage.setItem(Rm,JSON.stringify(x))}catch{}},{deep:!0}),Ze(()=>{var x;Q(),document.addEventListener("keydown",fe),w=window.matchMedia("(max-width: 760px)"),De(w),(x=w.addEventListener)==null||x.call(w,"change",De)}),xt(()=>{var x;document.removeEventListener("keydown",fe),(x=w==null?void 0:w.removeEventListener)==null||x.call(w,"change",De),M&&window.clearTimeout(M)}),{config:e,meta:t,loading:s,saving:a,error:i,toast:l,metaRefreshError:o,restartPromptOpen:r,restartScheduled:c,restartError:d,configMain:n,searchQuery:u,healthFilter:p,activeCategory:f,reviewOpen:g,mobileOverflowOpen:S,warningThresholdInput:I,arrayInputs:T,healthFilters:L,visibleCategories:Ce,displayGroups:le,reviewGroups:_e,sectionCount:X,fieldCount:U,hasChanges:be,changeCount:se,changedSectionCount:ge,hasDraftErrors:ie,canUndo:O,canRedo:W,globalFilterActive:Z,reviewRestartCount:ye,pendingRestartCount:k,pendingRestartFields:Be,healthCount:Ge,categoryStats:He,selectCategory:Ds,selectHealthFilter:An,clearFilters:Ts,sectionLabel:Y,sectionDescription:ee,sectionFieldCount:te,sectionHealthCount:Pe,sectionApplySummary:ce,sectionApplyDetails:re,sectionEntries:xe,fieldGroups:H,sectionSearchHits:Te,mcpConfigSummary:ae,fieldRuntimeCopy:de,fieldSpecificRuntimeNote:Re,hasHonestAction:Me,runFieldAction:dt,sectionChanged:mt,fieldChanged:Yt,isSectionExpanded:Qt,toggleSection:Vs,discardAllDrafts:nn,setFieldValue:ut,setNumberFieldValue:q,numberInputValue:gs,beginInputEdit:os,endTextInputEdit:rs,endInputEdit:Qe,addWarningThreshold:ue,removeWarningThreshold:Ne,isScalarArray:ot,addScalarArrayItem:Nt,removeScalarArrayItem:Ft,fieldError:$s,sectionHasErrors:li,undo:_a,redo:qn,openReview:wa,closeReview:Gn,mobileCancel:z,applyModeLabel:ve,applyClass:Ae,compactValue:lk,formatValue:ok,structuredApplyCopy:Je,fieldId:_t,fieldInputId:Kn,focusField:Wn,fetchConfig:Q,saveConfig:R,restartOdin:ke,restartLater:dl,reviewPendingRestart:cl}}},pk=/^\d{15,25}$/;function Nm(e){return String((e==null?void 0:e.display_name)||(e==null?void 0:e.username)||(e==null?void 0:e.id)||"Unknown user")}const Mm={props:{members:{type:Array,default:()=>[]},excludedIds:{type:Array,default:()=>[]},placeholder:{type:String,default:"Search Discord users…"},ariaLabel:{type:String,default:"Search Discord users"},optionsId:{type:String,required:!0},autofocus:{type:Boolean,default:!1}},emits:["select"],template:`
  ...
  `,setup(){const e=h(!0),t=h(""),s=h(null),n=h([]),a=h(!1),i=h(!1),l=h(null),o=h(null),r=h(!1),c=h({user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),d=h({username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""}),u=K(()=>c.value.host_mode==="select"?c.value.allowed_hosts:c.value.host_mode==="none"?[]:n.value),p=K(()=>d.value.host_mode==="select"?d.value.allowed_hosts:d.value.host_mode==="none"?[]:n.value);function f(y){return y==="admin"?"text-xs px-1.5 py-0.5 rounded bg-red-900/50 text-red-400":y==="user"?"text-xs px-1.5 py-0.5 rounded bg-blue-900/50 text-blue-400":"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400"}async function m(){e.value=!0,t.value="";try{const y=await G.get("/api/tokens");s.value=y.tokens||[],n.value=y.available_hosts||[]}catch(y){t.value=y.message||"Failed to load tokens"}finally{e.value=!1}}function b(y){return!y||!y.trim()?[]:y.split(",").map(w=>w.trim()).filter(Boolean)}function E(y,w){const M=c.value.allowed_hosts;if(w&&!M.includes(y)&&M.push(y),!w){const F=M.indexOf(y);F>=0&&M.splice(F,1)}}function I(y,w){const M=d.value.allowed_hosts;if(w&&!M.includes(y)&&M.push(y),!w){const F=M.indexOf(y);F>=0&&M.splice(F,1)}}async function T(){var y;i.value=!0;try{const w=b(c.value.allowed_tools_str),M=c.value.host_mode,F=M==="none"?[]:M==="select"?c.value.allowed_hosts:null,P={user_id:c.value.user_id.trim(),username:c.value.username.trim()||"API",tier:c.value.tier,label:c.value.label.trim(),allowed_tools:w.length?w:[]};F!==null&&(P.allowed_hosts=F),P.default_host=c.value.default_host||"";const A=await G.post("/api/tokens",P);l.value=A.token,c.value={user_id:"",username:"",tier:"admin",label:"",host_mode:"default",allowed_hosts:[],default_host:"",allowed_tools_str:""},a.value=!1,Ie.success("Token created"),await m()}catch(w){Ie.error(((y=w.data)==null?void 0:y.error)||w.message||"Failed to create token")}finally{i.value=!1}}function v(y){o.value=y;const w=y.allowed_hosts;let M="default";w==null?M="default":Array.isArray(w)&&w.length===0?M="none":Array.isArray(w)&&(M="select"),d.value={username:y.username||"",tier:y.tier||"admin",label:y.label||"",host_mode:M,allowed_hosts:Array.isArray(w)?[...w]:[],default_host:y.default_host||"",allowed_tools_str:(y.allowed_tools||[]).join(", ")}}async function _(){var y;if(o.value){r.value=!0;try{const w=b(d.value.allowed_tools_str),M=d.value.host_mode,F={username:d.value.username,tier:d.value.tier,label:d.value.label,allowed_tools:w};M==="none"?F.allowed_hosts=[]:M==="select"?F.allowed_hosts=d.value.allowed_hosts:F.allowed_hosts=null,F.default_host=d.value.default_host||"",await G.put("/api/tokens/"+encodeURIComponent(o.value.user_id),F),o.value=null,Ie.success("Token updated"),await m()}catch(w){Ie.error(((y=w.data)==null?void 0:y.error)||w.message||"Failed to update")}finally{r.value=!1}}}async function C(y){var M;if(await Zt({title:"Regenerate token",message:`Regenerate token for ${y.username||y.user_id}? The old token will stop working immediately.`,confirmLabel:"Regenerate",danger:!0}))try{const F=await G.post("/api/tokens/"+encodeURIComponent(y.user_id)+"/regenerate");l.value=F.token,Ie.success("Token regenerated")}catch(F){Ie.error(((M=F.data)==null?void 0:M.error)||F.message||"Failed to regenerate")}}async function g(y){var M;if(await Zt({title:"Delete token",message:`Delete token for ${y.username||y.user_id}? This cannot be undone.`,confirmLabel:"Delete",danger:!0}))try{await G.del("/api/tokens/"+encodeURIComponent(y.user_id)),Ie.success("Token deleted"),await m()}catch(F){Ie.error(((M=F.data)==null?void 0:M.error)||F.message||"Failed to delete")}}async function S(){if(l.value)try{await navigator.clipboard.writeText(l.value),Ie.success("Copied to clipboard")}catch{Ie.error("Copy failed — select and copy manually")}}return Ze(m),{loading:e,error:t,tokens:s,availableHosts:n,showCreate:a,creating:i,newToken:l,editing:o,saving:r,createForm:c,editForm:d,createDefaultHostOptions:u,editDefaultHostOptions:p,fetchData:m,tierBadge:f,toggleCreateHost:E,toggleEditHost:I,createToken:T,startEdit:v,saveEdit:_,confirmRegenerate:C,confirmDelete:g,copyToken:S}}},vk=Object.freeze(["enabled","model","reasoning_effort","agent_reasoning_effort","agent_model"]),bk=Object.freeze(["request_timeout_seconds","stream_stall_timeout_seconds","retry","connection_pool","context_compression","context_budget_overrides","context_utilization"]),yk=Object.freeze(["enabled","base_url","model","max_tokens"]),xk=Object.freeze(["enabled","model","max_tokens"]);function Bo(e,t){return Object.fromEntries(t.map(s=>[s,e[s]]))}function zu(e){return Bo(e,vk)}function ju(e){return Bo(e,bk)}function _k(e,{includeApiKey:t=!1}={}){const s=Bo(e,yk);return t&&(s.api_key=e.api_key),s}function wk(e){return{timeout:e.timeout}}function kk(e,{includeApiKey:t=!1}={}){const s=Bo(e,xk);return t&&(s.api_key=e.api_key),s}function Sk(e){return{timeout:e.timeout}}function Tl(e,t=500){let s=null;const n=(...a)=>{s&&clearTimeout(s),s=setTimeout(()=>{s=null,e(...a)},t)};return n.pending=()=>s!==null,n.cancel=()=>{s&&(clearTimeout(s),s=null)},n}const Tk={template:`
    <div class="p-6 page-fade-in">
