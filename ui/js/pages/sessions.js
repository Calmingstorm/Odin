/**
 * Odin Management UI — Sessions Page (Redesigned)
...
export default {
  ...
  setup() {
    ...
    function loadCustomPresets() {
      try {
        const saved = localStorage.getItem('odin-session-presets');
    ...
    function saveCustomPresetsToStorage() {
      try {
        localStorage.setItem('odin-session-presets', JSON.stringify(customPresets.value));
      } catch { /* ignore */ }
    }
