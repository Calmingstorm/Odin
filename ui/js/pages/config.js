/**
 * Odin Management UI — Config Page (Round 37 redesign)
...
const SECTION_GROUPS = [
  ...
  { key: 'services', label: 'Services', icon: '\uD83D\uDD17', sections: ['webhook', 'monitoring', 'observability', 'email', 'voice', 'browser', 'comfyui', 'mcp', 'slack'] },
