...
const SECTION_DEFAULTS = {
  ...
  discord: { apply_mode: 'live_read', description: 'Allowed users and channels are absolute gates for ordinary conversational intake; guild and channel settings cannot bypass them. Explicitly allowed test webhooks bypass the user gate. Guild and channel settings may override mention and bot-response behavior; an explicit mention bypasses the ignored-bot check.' },
  ...
  image: { apply_mode: 'live_read', description: 'Native image-generation policy.' },
