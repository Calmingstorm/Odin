...
Source baseline commit: [`e1318eca83a40b9418d873ad85c31686ea6b57d0`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/registry.py).
...
Source: [`src/tools/defs/system_files.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/system_files.py).
...
Source: [`src/tools/defs/media_scheduling.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/media_scheduling.py).
...
Source: [`src/tools/defs/memory_skills.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/memory_skills.py).
...
Source: [`src/tools/defs/tasks_knowledge.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/tasks_knowledge.py).
...
Source: [`src/tools/defs/browser_web.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/browser_web.py).
...
Source: [`src/tools/defs/channel_process_loops.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/channel_process_loops.py).
...
Source: [`src/tools/defs/agents.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/agents.py).

### spawn_agent

**Core:** No

<pre v-pre style="white-space: pre-wrap; overflow-wrap: anywhere; font: inherit;">Spawns an autonomous agent for a sub-task. Runs silently in background with isolated context; it may spawn its own sub-agents up to the nesting limit. Results are NOT posted to Discord — use wait_for_agents to collect results, then deliver a cohesive summary yourself. Max 5/channel; lifetime limit for NEW agents: 14400 seconds. Budget warnings injected near iteration limit. Set &#x27;model&#x27; to run THIS agent on a specific Codex model — gpt-6-astra (GPT-6 generation: the strongest reasoning tier, for the hardest multi-step work; rejects effort &#x27;none&#x27;), gpt-6-sol (complex coding and agentic workflows), gpt-6-luna (focused, high-volume tasks with a clear goal), gpt-5.6-sol (deepest 5.6 reasoning, for hard/ambiguous work), gpt-5.6-terra (balanced default), gpt-5.6-luna (fastest, for simple/mechanical work); match the tier to the task. A model selection is required. Set &#x27;reasoning_effort&#x27; (none/low/medium/high/xhigh/max) for THIS agent — higher is more thorough but slower/costlier. Omit to use the configured agent effort.</pre>
...
| <code>model</code> | string | Yes | Required Codex model for this agent. gpt-6-astra = GPT-6 generation, the strongest reasoning tier, for the hardest multi-step work (rejects effort &#x27;none&#x27;); gpt-6-sol = complex coding and agentic workflows; gpt-6-luna = focused, high-volume tasks with a clear goal; gpt-5.6-sol = deepest 5.6 reasoning, best for hard multi-step or ambiguous work; gpt-5.6-terra = balanced, a solid default for most tasks; gpt-5.6-luna = fastest/cheapest, good for simple lookups and mechanical work. Choose a model explicitly. |
...
Source: [`src/tools/defs/integrations_email.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/integrations_email.py).
...
Source: [`src/tools/defs/output_delivery.py`](https://github.com/Calmingstorm/Odin/blob/e1318eca83a40b9418d873ad85c31686ea6b57d0/src/tools/defs/output_delivery.py).
