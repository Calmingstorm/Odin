...
const providerCases = [
  ...
  },
  {
    ...
    draft: () => { llm.compatibleForm.value.stream_stall_timeout_seconds = 666; },
    ...
    advancedKeys: ['request_timeout_seconds', 'stream_stall_timeout_seconds', 'preset', 'model_profiles', 'context_utilization', 'openrouter'],
    serverAdvanced: () => llmState.openai_compatible.stream_stall_timeout_seconds,
    draftAdvanced: () => llm.compatibleForm.value.stream_stall_timeout_seconds,
    oldValue: 300,
    draftValue: 666,
  },
];
...
const midFlightCases = [
  ...
  },
  {
    ...
    editAdvanced: () => { llm.compatibleForm.value.stream_stall_timeout_seconds = 432; },
    basicValue: () => llm.compatibleForm.value.base_url,
    advancedValue: () => llm.compatibleForm.value.stream_stall_timeout_seconds,
