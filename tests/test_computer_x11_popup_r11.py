...
def popup(display, checker, *, pid=1234, transient=True):
    ...
    menu.props = {"_NET_WM_PID": [999999], "WM_CLASS": b"xed\0Xed\0",
...
@pytest.mark.parametrize("mutation", ["foreign", "terminal", "family", "leaf", "unmapped",
                                     "cycle", "outside", "source", "type", "pid"])
...
def test_owned_popup_callback_and_final_target_revalidation(app):
    ...
    def query(identity):
        ...
        return NS(same_screen=True, root_x=450, root_y=200,
