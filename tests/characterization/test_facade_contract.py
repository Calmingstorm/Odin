...
RETIRED_BOT_ATTRS = [
    ...
    "_send_with_retry",
    "_send_chunked",
    "_record_user_content",
    "_new_context_trace",
    "_save_turn_trajectory",
    "_emit_lifecycle_event",
    "_operational_reflection",
    "_should_reflect_on_operation",
    "_maybe_loop_reflect",
    "_classify_completion",
    "_parse_classifier_response",
    "_CLASSIFIER_SYSTEM_PROMPT",
    "_ensure_failure_visible",
    "_TOOL_STATUS_LABELS",
    ...
    "_invoke_skill_missing_required",
    ...
    "_on_scheduled_digest",
    "_execute_scheduled_tool",
    ...
    "_handle_generate_file",
    "_handle_post_file",
    "_handle_schedule_task",
    "_handle_delegate_task",
    "_handle_start_loop",
    "_handle_read_channel",
    "_handle_add_reaction",
    "_handle_create_poll",
    "_handle_analyze_image",
    "_handle_generate_image",
    "_handle_spawn_agent",
    "_handle_spawn_loop_agents",
    "_handle_update_schedule",
    "_handle_delete_schedule",
    "_handle_parse_time",
    "_handle_search_history",
    "_handle_list_tasks",
    "_handle_cancel_task",
    "_handle_stop_loop",
    "_handle_search_knowledge",
    "_handle_delete_knowledge",
    "_handle_search_audit",
    "_handle_send_to_agent",
    "_handle_kill_agent",
    "_handle_get_agent_results",
    "_handle_wait_for_agents",
    "_handle_collect_loop_agents",
    "_handle_list_schedules",
    "_handle_list_loops",
    "_handle_list_knowledge",
    "_handle_list_agents",
    "_handle_ingest_document",
    "_handle_bulk_ingest",
    "_handle_set_permission",
    "_validate_schedule_payload",
    "_collect_agent_result",
]
