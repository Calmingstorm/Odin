...
- **Read a file** → `read_file`. Use its one-based `start_line` plus `lines` count for contiguous ranges and follow the returned continuation cursor. Never use run_command with inline Python to read files.
