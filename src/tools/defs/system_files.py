...
TOOLS_SECTION: list[dict] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "complete monotonic anchor-chain plus body must match exactly once; the hunk "
            "body follows the final named @@ anchor directly, while a bare @@ always opens "
            "a new hunk (so one after a named chain would be an empty hunk). "
