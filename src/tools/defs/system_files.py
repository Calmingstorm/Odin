...
TOOLS_SECTION: list[dict] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "complete monotonic anchor-chain plus body must match exactly once. Every hunk "
            "must contain at least one + or - line. To narrow a location, chain named "
            "@@ anchors. A context-only bare @@ block immediately followed by another @@ is "
            "treated as locating context for that following edit hunk. "
